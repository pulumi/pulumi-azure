...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/pulumi/pulumi-azure/sdk/v7/go)](https://pkg.go.dev/github.com/pulumi/pulumi-azure/sdk/v7/go)
...
To use from Go, use `go get` to grab the latest version of the library
    ...
    go get github.com/pulumi/pulumi-azure/sdk/v7
