...
namespace Pulumi.Azure.Authorization
{
    public static partial class Invokes
    {
        ...
        public static Task<GetBuiltinRoleDefinitionResult> GetBuiltinRoleDefinition(GetBuiltinRoleDefinitionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetBuiltinRoleDefinitionResult>("azure:authorization/getBuiltinRoleDefinition:getBuiltinRoleDefinition", args ?? InvokeArgs.Empty, options.WithVersion());
    }

    public sealed class GetBuiltinRoleDefinitionArgs : Pulumi.InvokeArgs
    {
        /// <summary>
