...
namespace Pulumi.Azure.Network
{
    public static partial class Invokes
    {
        ...
        public static Task<GetVirtualHubResult> GetVirtualHub(GetVirtualHubArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetVirtualHubResult>("azure:network/getVirtualHub:getVirtualHub", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetVirtualHubArgs : Pulumi.ResourceArgs
    {
        /// <summary>
