...
namespace Pulumi.Azure.Network
{
    ...
    ///     });
    /// 
    ///     var example_1 = new Azure.Network.VirtualNetwork.VirtualNetwork("example-1", new()
    ///     {
    ///         Name = "peternetwork1",
    ...
    ///     });
    /// 
    ///     var example_2 = new Azure.Network.VirtualNetwork.VirtualNetwork("example-2", new()
    ///     {
    ///         Name = "peternetwork2",
    ///         ResourceGroupName = example.Name,
    ///         AddressSpaces = new[]
    ...
    ///     });
    /// 
    ///     var example_1VirtualNetworkPeering = new Azure.Network.VirtualNetworkPeering.VirtualNetworkPeering("example-1", new()
    ///     {
    ///         Name = "peer1to2",
    ///         ResourceGroupName = example.Name,
    ...
    ///     });
    /// 
    ///     var example_2VirtualNetworkPeering = new Azure.Network.VirtualNetworkPeering.VirtualNetworkPeering("example-2", new()
    ///     {
    ///         Name = "peer2to1",
    ///         ResourceGroupName = example.Name,
