...
namespace Pulumi.Azure.Consumption.Inputs
{
    ...
    public sealed class BudgetResourceGroupFilterNotGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dimension")]
        public Input<Inputs.BudgetResourceGroupFilterNotDimensionGetArgs>? Dimension { get; set; }

        /// <summary>
        /// One `tag` block as defined below to filter the budget on. Conflicts with `dimension`.
        /// </summary>
        [Input("tag")]
        public Input<Inputs.BudgetResourceGroupFilterNotTagGetArgs>? Tag { get; set; }
