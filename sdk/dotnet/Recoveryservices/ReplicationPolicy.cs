...
namespace Pulumi.Azure.RecoveryServices
{
    ...
    public partial class ReplicationPolicy : Pulumi.CustomResource
    {
        ...
        public ReplicationPolicy(string name, ReplicationPolicyArgs args, CustomResourceOptions? options = null)
            : base("azure:recoveryservices/replicationPolicy:ReplicationPolicy", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
        ...
        private ReplicationPolicy(string name, Input<string> id, ReplicationPolicyState? state = null, CustomResourceOptions? options = null)
            : base("azure:recoveryservices/replicationPolicy:ReplicationPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
