...
namespace Pulumi.Azure.Batch.Inputs
{
    ...
    public sealed class PoolNetworkConfigurationEndpointConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _networkSecurityGroupRules ?? (_networkSecurityGroupRules = new InputList<Inputs.PoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRuleArgs>());
        ...
        public PoolNetworkConfigurationEndpointConfigurationArgs()
        {
        }
        public static new PoolNetworkConfigurationEndpointConfigurationArgs Empty => new PoolNetworkConfigurationEndpointConfigurationArgs();
    }
}
