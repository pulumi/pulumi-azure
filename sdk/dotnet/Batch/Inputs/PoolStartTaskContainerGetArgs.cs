...
namespace Pulumi.Azure.Batch.Inputs
{
    ...
    public sealed class PoolStartTaskContainerGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _registries ?? (_registries = new InputList<Inputs.PoolStartTaskContainerRegistryGetArgs>());
        ...
        public PoolStartTaskContainerGetArgs()
        {
        }
        public static new PoolStartTaskContainerGetArgs Empty => new PoolStartTaskContainerGetArgs();
    }
}
