...
namespace Pulumi.Azure.ContainerApp.Inputs
{
    ...
    public sealed class AppTemplateContainerArgs : global::Pulumi.ResourceArgs
    {
        [Input("args")]
        ...
        {
            get => _envs ?? (_envs = new InputList<Inputs.AppTemplateContainerEnvArgs>());
            set => _envs = value;
        }
        ...
        {
            get => _livenessProbes ?? (_livenessProbes = new InputList<Inputs.AppTemplateContainerLivenessProbeArgs>());
        ...
        {
            get => _readinessProbes ?? (_readinessProbes = new InputList<Inputs.AppTemplateContainerReadinessProbeArgs>());
        ...
        {
            get => _startupProbes ?? (_startupProbes = new InputList<Inputs.AppTemplateContainerStartupProbeArgs>());
        ...
        {
            get => _volumeMounts ?? (_volumeMounts = new InputList<Inputs.AppTemplateContainerVolumeMountArgs>());
        ...
        public static new AppTemplateContainerArgs Empty => new AppTemplateContainerArgs();
    }
}
