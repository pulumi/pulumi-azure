...
namespace Pulumi.Azure.ContainerApp.Inputs
{
    ...
    public sealed class AppTemplateContainerLivenessProbeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("headers")]
        private InputList<Inputs.AppTemplateContainerLivenessProbeHeaderArgs>? _headers;

        /// <summary>
        /// A `header` block as detailed below.
        /// </summary>
        public InputList<Inputs.AppTemplateContainerLivenessProbeHeaderArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.AppTemplateContainerLivenessProbeHeaderArgs>());
            set => _headers = value;
        }
        ...
        public AppTemplateContainerLivenessProbeArgs()
        {
        }
        public static new AppTemplateContainerLivenessProbeArgs Empty => new AppTemplateContainerLivenessProbeArgs();
    }
}
