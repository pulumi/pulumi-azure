...
namespace Pulumi.Azure.ContainerApp.Inputs
{
    ...
    public sealed class AppTemplateContainerLivenessProbeGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("headers")]
        private InputList<Inputs.AppTemplateContainerLivenessProbeHeaderGetArgs>? _headers;

        /// <summary>
        /// A `header` block as detailed below.
        /// </summary>
        public InputList<Inputs.AppTemplateContainerLivenessProbeHeaderGetArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.AppTemplateContainerLivenessProbeHeaderGetArgs>());
            set => _headers = value;
        }
        ...
        public AppTemplateContainerLivenessProbeGetArgs()
        {
        }
        public static new AppTemplateContainerLivenessProbeGetArgs Empty => new AppTemplateContainerLivenessProbeGetArgs();
    }
}
