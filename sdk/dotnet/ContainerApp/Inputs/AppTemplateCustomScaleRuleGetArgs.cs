...
namespace Pulumi.Azure.ContainerApp.Inputs
{
    ...
    public sealed class AppTemplateCustomScaleRuleGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("authentications")]
        private InputList<Inputs.AppTemplateCustomScaleRuleAuthenticationGetArgs>? _authentications;
        ...
        {
            get => _authentications ?? (_authentications = new InputList<Inputs.AppTemplateCustomScaleRuleAuthenticationGetArgs>());
        ...
        public AppTemplateCustomScaleRuleGetArgs()
        {
        }
        public static new AppTemplateCustomScaleRuleGetArgs Empty => new AppTemplateCustomScaleRuleGetArgs();
    }
}
