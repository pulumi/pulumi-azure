...
namespace Pulumi.Azure.ContainerApp.Inputs
{
    ...
    public sealed class EnvironmentIdentityArgs : global::Pulumi.ResourceArgs
    {
        [Input("identityIds")]
        ...
        public EnvironmentIdentityArgs()
        {
        }
        public static new EnvironmentIdentityArgs Empty => new EnvironmentIdentityArgs();
    }
}
