...
namespace Pulumi.Azure.MediaServices.Inputs
{
    ...
    public sealed class AccountEncryptionManagedIdentityArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public AccountEncryptionManagedIdentityArgs()
        {
        }
        public static new AccountEncryptionManagedIdentityArgs Empty => new AccountEncryptionManagedIdentityArgs();
    }
}
