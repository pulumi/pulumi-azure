...
namespace Pulumi.Azure.Mobile.Inputs
{
    ...
    public sealed class NetworkServiceServiceQosPolicyGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.NetworkServiceServiceQosPolicyMaximumBitRateGetArgs> MaximumBitRate { get; set; } = null!;
        ...
        /// </summary>
        [Input("qosIndicator")]
        public Input<int>? QosIndicator { get; set; }

        public NetworkServiceServiceQosPolicyGetArgs()
        {
        }
        public static new NetworkServiceServiceQosPolicyGetArgs Empty => new NetworkServiceServiceQosPolicyGetArgs();
    }
}
