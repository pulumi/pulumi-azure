...
namespace Pulumi.Azure.Mobile.Outputs
{
    ...
    [OutputType]
    public sealed class GetNetworkServicePccRuleQosPolicyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetNetworkServicePccRuleQosPolicyResult(
            int allocationAndRetentionPriorityLevel,

            ImmutableArray<Outputs.GetNetworkServicePccRuleQosPolicyGuaranteedBitRateResult> guaranteedBitRates,

            ImmutableArray<Outputs.GetNetworkServicePccRuleQosPolicyMaximumBitRateResult> maximumBitRates,
            ...
            int qosIndicator)
        {
            ...
            GuaranteedBitRates = guaranteedBitRates;
