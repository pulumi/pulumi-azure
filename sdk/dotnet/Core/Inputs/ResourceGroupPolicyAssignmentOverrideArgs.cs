...
namespace Pulumi.Azure.Core.Inputs
{
    ...
    public sealed class ResourceGroupPolicyAssignmentOverrideArgs : global::Pulumi.ResourceArgs
    {
        [Input("selectors")]
        ...
        {
            get => _selectors ?? (_selectors = new InputList<Inputs.ResourceGroupPolicyAssignmentOverrideSelectorArgs>());
        ...
        public ResourceGroupPolicyAssignmentOverrideArgs()
        {
        }
        public static new ResourceGroupPolicyAssignmentOverrideArgs Empty => new ResourceGroupPolicyAssignmentOverrideArgs();
    }
}
