...
namespace Pulumi.Azure.AppService.Inputs
{
    ...
    public sealed class WindowsFunctionAppSlotAuthSettingsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// an `active_directory` block as detailed below.
        /// </summary>
        [Input("activeDirectory")]
        public Input<Inputs.WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs>? ActiveDirectory { get; set; }
        ...
        /// </summary>
        [Input("facebook")]
        public Input<Inputs.WindowsFunctionAppSlotAuthSettingsFacebookArgs>? Facebook { get; set; }

        /// <summary>
        /// a `github` block as detailed below.
        /// </summary>
        [Input("github")]
        public Input<Inputs.WindowsFunctionAppSlotAuthSettingsGithubArgs>? Github { get; set; }

        /// <summary>
        /// a `google` block as detailed below.
        /// </summary>
        [Input("google")]
        public Input<Inputs.WindowsFunctionAppSlotAuthSettingsGoogleArgs>? Google { get; set; }
        ...
        /// </summary>
        [Input("twitter")]
        public Input<Inputs.WindowsFunctionAppSlotAuthSettingsTwitterArgs>? Twitter { get; set; }
        ...
        public WindowsFunctionAppSlotAuthSettingsArgs()
        {
        }
        public static new WindowsFunctionAppSlotAuthSettingsArgs Empty => new WindowsFunctionAppSlotAuthSettingsArgs();
    }
}
