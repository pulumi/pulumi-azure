...
namespace Pulumi.Azure.AppService.Inputs
{
    ...
    public sealed class AppFlexConsumptionAuthSettingsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An `ActiveDirectory` block as defined above.
        /// </summary>
        [Input("activeDirectory")]
        public Input<Inputs.AppFlexConsumptionAuthSettingsActiveDirectoryGetArgs>? ActiveDirectory { get; set; }
        ...
        /// </summary>
        [Input("facebook")]
        public Input<Inputs.AppFlexConsumptionAuthSettingsFacebookGetArgs>? Facebook { get; set; }

        /// <summary>
        /// A `Github` block as defined below.
        /// </summary>
        [Input("github")]
        public Input<Inputs.AppFlexConsumptionAuthSettingsGithubGetArgs>? Github { get; set; }

        /// <summary>
        /// A `Google` block as defined below.
        /// </summary>
        [Input("google")]
        public Input<Inputs.AppFlexConsumptionAuthSettingsGoogleGetArgs>? Google { get; set; }
        ...
        /// </summary>
        [Input("microsoft")]
        public Input<Inputs.AppFlexConsumptionAuthSettingsMicrosoftGetArgs>? Microsoft { get; set; }
        ...
        /// </summary>
        [Input("twitter")]
        public Input<Inputs.AppFlexConsumptionAuthSettingsTwitterGetArgs>? Twitter { get; set; }
        ...
        public AppFlexConsumptionAuthSettingsGetArgs()
        {
        }
        public static new AppFlexConsumptionAuthSettingsGetArgs Empty => new AppFlexConsumptionAuthSettingsGetArgs();
    }
}
