...
namespace Pulumi.Azure.AppService.Inputs
{
    ...
    public sealed class WindowsWebAppAuthSettingsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An `ActiveDirectory` block as defined above.
        /// </summary>
        [Input("activeDirectory")]
        public Input<Inputs.WindowsWebAppAuthSettingsActiveDirectoryArgs>? ActiveDirectory { get; set; }
        ...
        /// </summary>
        [Input("facebook")]
        public Input<Inputs.WindowsWebAppAuthSettingsFacebookArgs>? Facebook { get; set; }

        /// <summary>
        /// A `Github` block as defined below.
        /// </summary>
        [Input("github")]
        public Input<Inputs.WindowsWebAppAuthSettingsGithubArgs>? Github { get; set; }

        /// <summary>
        /// A `Google` block as defined below.
        /// </summary>
        [Input("google")]
        public Input<Inputs.WindowsWebAppAuthSettingsGoogleArgs>? Google { get; set; }
        ...
        /// </summary>
        [Input("microsoft")]
        public Input<Inputs.WindowsWebAppAuthSettingsMicrosoftArgs>? Microsoft { get; set; }
        ...
        /// </summary>
        [Input("twitter")]
        public Input<Inputs.WindowsWebAppAuthSettingsTwitterArgs>? Twitter { get; set; }
        ...
        public WindowsWebAppAuthSettingsArgs()
        {
        }
        public static new WindowsWebAppAuthSettingsArgs Empty => new WindowsWebAppAuthSettingsArgs();
    }
}
