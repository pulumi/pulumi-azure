...
namespace Pulumi.Azure.AppService.Inputs
{
    ...
    public sealed class LinuxFunctionAppAuthSettingsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An `ActiveDirectory` block as defined above.
        /// </summary>
        [Input("activeDirectory")]
        public Input<Inputs.LinuxFunctionAppAuthSettingsActiveDirectoryGetArgs>? ActiveDirectory { get; set; }
        ...
        /// </summary>
        [Input("facebook")]
        public Input<Inputs.LinuxFunctionAppAuthSettingsFacebookGetArgs>? Facebook { get; set; }

        /// <summary>
        /// A `Github` block as defined below.
        /// </summary>
        [Input("github")]
        public Input<Inputs.LinuxFunctionAppAuthSettingsGithubGetArgs>? Github { get; set; }

        /// <summary>
        /// A `Google` block as defined below.
        /// </summary>
        [Input("google")]
        public Input<Inputs.LinuxFunctionAppAuthSettingsGoogleGetArgs>? Google { get; set; }
        ...
        /// </summary>
        [Input("microsoft")]
        public Input<Inputs.LinuxFunctionAppAuthSettingsMicrosoftGetArgs>? Microsoft { get; set; }
        ...
        /// </summary>
        [Input("twitter")]
        public Input<Inputs.LinuxFunctionAppAuthSettingsTwitterGetArgs>? Twitter { get; set; }
        ...
        public LinuxFunctionAppAuthSettingsGetArgs()
        {
        }
        public static new LinuxFunctionAppAuthSettingsGetArgs Empty => new LinuxFunctionAppAuthSettingsGetArgs();
    }
}
