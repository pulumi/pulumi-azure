...
namespace Pulumi.Azure.AppService.Inputs
{
    ...
    public sealed class LinuxWebAppAuthSettingsV2GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An `ActiveDirectoryV2` block as defined below.
        /// </summary>
        [Input("activeDirectoryV2")]
        public Input<Inputs.LinuxWebAppAuthSettingsV2ActiveDirectoryV2GetArgs>? ActiveDirectoryV2 { get; set; }

        /// <summary>
        /// An `AppleV2` block as defined below.
        /// </summary>
        [Input("appleV2")]
        public Input<Inputs.LinuxWebAppAuthSettingsV2AppleV2GetArgs>? AppleV2 { get; set; }
        ...
        [Input("customOidcV2s")]
        private InputList<Inputs.LinuxWebAppAuthSettingsV2CustomOidcV2GetArgs>? _customOidcV2s;

        /// <summary>
        /// Zero or more `CustomOidcV2` blocks as defined below.
        /// </summary>
        public InputList<Inputs.LinuxWebAppAuthSettingsV2CustomOidcV2GetArgs> CustomOidcV2s
        {
            get => _customOidcV2s ?? (_customOidcV2s = new InputList<Inputs.LinuxWebAppAuthSettingsV2CustomOidcV2GetArgs>());
        ...
        /// </summary>
        [Input("githubV2")]
        public Input<Inputs.LinuxWebAppAuthSettingsV2GithubV2GetArgs>? GithubV2 { get; set; }

        /// <summary>
        /// A `GoogleV2` block as defined below.
        /// </summary>
        [Input("googleV2")]
        public Input<Inputs.LinuxWebAppAuthSettingsV2GoogleV2GetArgs>? GoogleV2 { get; set; }
        ...
        public Input<Inputs.LinuxWebAppAuthSettingsV2LoginGetArgs> Login { get; set; } = null!;

        /// <summary>
        /// A `MicrosoftV2` block as defined below.
        /// </summary>
        [Input("microsoftV2")]
        public Input<Inputs.LinuxWebAppAuthSettingsV2MicrosoftV2GetArgs>? MicrosoftV2 { get; set; }
        ...
        /// </summary>
        [Input("twitterV2")]
        public Input<Inputs.LinuxWebAppAuthSettingsV2TwitterV2GetArgs>? TwitterV2 { get; set; }
        ...
        public LinuxWebAppAuthSettingsV2GetArgs()
        {
        }
        public static new LinuxWebAppAuthSettingsV2GetArgs Empty => new LinuxWebAppAuthSettingsV2GetArgs();
    }
}
