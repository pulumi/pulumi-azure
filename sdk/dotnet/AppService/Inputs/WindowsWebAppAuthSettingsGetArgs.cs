...
namespace Pulumi.Azure.AppService.Inputs
{
    ...
    public sealed class WindowsWebAppAuthSettingsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An `ActiveDirectory` block as defined above.
        /// </summary>
        [Input("activeDirectory")]
        public Input<Inputs.WindowsWebAppAuthSettingsActiveDirectoryGetArgs>? ActiveDirectory { get; set; }
        ...
        /// </summary>
        [Input("facebook")]
        public Input<Inputs.WindowsWebAppAuthSettingsFacebookGetArgs>? Facebook { get; set; }

        /// <summary>
        /// A `Github` block as defined below.
        /// </summary>
        [Input("github")]
        public Input<Inputs.WindowsWebAppAuthSettingsGithubGetArgs>? Github { get; set; }

        /// <summary>
        /// A `Google` block as defined below.
        /// </summary>
        [Input("google")]
        public Input<Inputs.WindowsWebAppAuthSettingsGoogleGetArgs>? Google { get; set; }
        ...
        /// </summary>
        [Input("microsoft")]
        public Input<Inputs.WindowsWebAppAuthSettingsMicrosoftGetArgs>? Microsoft { get; set; }
        ...
        /// </summary>
        [Input("twitter")]
        public Input<Inputs.WindowsWebAppAuthSettingsTwitterGetArgs>? Twitter { get; set; }
        ...
        public WindowsWebAppAuthSettingsGetArgs()
        {
        }
        public static new WindowsWebAppAuthSettingsGetArgs Empty => new WindowsWebAppAuthSettingsGetArgs();
    }
}
