...
namespace Pulumi.Azure.Media.Outputs
{
    ...
    [OutputType]
    public sealed class TransformOutputCustomPresetFormatMp4
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.TransformOutputCustomPresetFormatMp4OutputFile> OutputFiles;

        [OutputConstructor]
        private TransformOutputCustomPresetFormatMp4(
            string filenamePattern,

            ImmutableArray<Outputs.TransformOutputCustomPresetFormatMp4OutputFile> outputFiles)
        {
