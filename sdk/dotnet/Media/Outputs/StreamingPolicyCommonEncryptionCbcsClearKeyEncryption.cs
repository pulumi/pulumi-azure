...
namespace Pulumi.Azure.Media.Outputs
{
    ...
    [OutputType]
    public sealed class StreamingPolicyCommonEncryptionCbcsClearKeyEncryption
    {
        /// <summary>
        ...
        [OutputConstructor]
        private StreamingPolicyCommonEncryptionCbcsClearKeyEncryption(string customKeysAcquisitionUrlTemplate)
        {
