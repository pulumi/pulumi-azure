...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class LiveEventPreviewArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("endpoints")]
        private InputList<Inputs.LiveEventPreviewEndpointArgs>? _endpoints;
        public InputList<Inputs.LiveEventPreviewEndpointArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.LiveEventPreviewEndpointArgs>());
            set => _endpoints = value;
        }

        [Input("ipAccessControlAllows")]
        private InputList<Inputs.LiveEventPreviewIpAccessControlAllowArgs>? _ipAccessControlAllows;

        /// <summary>
        /// One or more `ip_access_control_allow` blocks as defined above.
        /// </summary>
        public InputList<Inputs.LiveEventPreviewIpAccessControlAllowArgs> IpAccessControlAllows
        {
            get => _ipAccessControlAllows ?? (_ipAccessControlAllows = new InputList<Inputs.LiveEventPreviewIpAccessControlAllowArgs>());
