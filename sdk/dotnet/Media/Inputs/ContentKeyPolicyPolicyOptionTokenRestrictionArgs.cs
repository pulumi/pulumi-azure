...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class ContentKeyPolicyPolicyOptionTokenRestrictionArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.ContentKeyPolicyPolicyOptionTokenRestrictionRequiredClaimArgs>? _requiredClaims;

        /// <summary>
        /// One or more `required_claim` blocks as defined above.
        /// </summary>
        public InputList<Inputs.ContentKeyPolicyPolicyOptionTokenRestrictionRequiredClaimArgs> RequiredClaims
        {
            get => _requiredClaims ?? (_requiredClaims = new InputList<Inputs.ContentKeyPolicyPolicyOptionTokenRestrictionRequiredClaimArgs>());
        ...
        public ContentKeyPolicyPolicyOptionTokenRestrictionArgs()
        {
        }
        public static new ContentKeyPolicyPolicyOptionTokenRestrictionArgs Empty => new ContentKeyPolicyPolicyOptionTokenRestrictionArgs();
    }
}
