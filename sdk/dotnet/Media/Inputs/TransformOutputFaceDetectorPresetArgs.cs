...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class TransformOutputFaceDetectorPresetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("faceRedactorMode")]
        public Input<string>? FaceRedactorMode { get; set; }

        public TransformOutputFaceDetectorPresetArgs()
        {
        }
        public static new TransformOutputFaceDetectorPresetArgs Empty => new TransformOutputFaceDetectorPresetArgs();
    }
}
