...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    {
        [Input("alternateKeys")]
        private InputList<Inputs.ContentKeyPolicyPolicyOptionTokenRestrictionAlternateKeyGetArgs>? _alternateKeys;

        /// <summary>
        /// One or more `alternate_key` block as defined above.
        /// </summary>
        public InputList<Inputs.ContentKeyPolicyPolicyOptionTokenRestrictionAlternateKeyGetArgs> AlternateKeys
        {
            get => _alternateKeys ?? (_alternateKeys = new InputList<Inputs.ContentKeyPolicyPolicyOptionTokenRestrictionAlternateKeyGetArgs>());
