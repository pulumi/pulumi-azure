...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class TransformOutputGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// An `audio_analyzer_preset` block as defined above.
        /// </summary>
        [Input("audioAnalyzerPreset")]
        public Input<Inputs.TransformOutputAudioAnalyzerPresetGetArgs>? AudioAnalyzerPreset { get; set; }

        /// <summary>
        /// A `builtin_preset` block as defined above.
        /// </summary>
        [Input("builtinPreset")]
        public Input<Inputs.TransformOutputBuiltinPresetGetArgs>? BuiltinPreset { get; set; }

        /// <summary>
        /// A `custom_preset` block as defined above.
        /// </summary>
        [Input("customPreset")]
        public Input<Inputs.TransformOutputCustomPresetGetArgs>? CustomPreset { get; set; }

        /// <summary>
        /// A `face_detector_preset` block as defined above.
        /// </summary>
        [Input("faceDetectorPreset")]
        public Input<Inputs.TransformOutputFaceDetectorPresetGetArgs>? FaceDetectorPreset { get; set; }
        ...
        public Input<Inputs.TransformOutputVideoAnalyzerPresetGetArgs>? VideoAnalyzerPreset { get; set; }

        public TransformOutputGetArgs()
        {
        }
        public static new TransformOutputGetArgs Empty => new TransformOutputGetArgs();
    }
}
