...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class LiveEventInputArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("endpoints")]
        private InputList<Inputs.LiveEventInputEndpointArgs>? _endpoints;
        public InputList<Inputs.LiveEventInputEndpointArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.LiveEventInputEndpointArgs>());
            set => _endpoints = value;
        }

        [Input("ipAccessControlAllows")]
        private InputList<Inputs.LiveEventInputIpAccessControlAllowArgs>? _ipAccessControlAllows;

        /// <summary>
        /// One or more `ip_access_control_allow` blocks as defined below.
        /// </summary>
        public InputList<Inputs.LiveEventInputIpAccessControlAllowArgs> IpAccessControlAllows
        {
            get => _ipAccessControlAllows ?? (_ipAccessControlAllows = new InputList<Inputs.LiveEventInputIpAccessControlAllowArgs>());
