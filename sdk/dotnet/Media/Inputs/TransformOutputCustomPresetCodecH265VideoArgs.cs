...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class TransformOutputCustomPresetCodecH265VideoArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("layers")]
        private InputList<Inputs.TransformOutputCustomPresetCodecH265VideoLayerArgs>? _layers;

        /// <summary>
        /// One or more `layer` blocks as defined below.
        /// </summary>
        public InputList<Inputs.TransformOutputCustomPresetCodecH265VideoLayerArgs> Layers
        {
            get => _layers ?? (_layers = new InputList<Inputs.TransformOutputCustomPresetCodecH265VideoLayerArgs>());
            set => _layers = value;
        }
        ...
        public TransformOutputCustomPresetCodecH265VideoArgs()
        {
        }
        public static new TransformOutputCustomPresetCodecH265VideoArgs Empty => new TransformOutputCustomPresetCodecH265VideoArgs();
    }
}
