...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class TransformOutputCustomPresetCodecH264VideoGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("layers")]
        private InputList<Inputs.TransformOutputCustomPresetCodecH264VideoLayerGetArgs>? _layers;

        /// <summary>
        /// One or more `layer` blocks as defined below.
        /// </summary>
        public InputList<Inputs.TransformOutputCustomPresetCodecH264VideoLayerGetArgs> Layers
        {
            get => _layers ?? (_layers = new InputList<Inputs.TransformOutputCustomPresetCodecH264VideoLayerGetArgs>());
            set => _layers = value;
        }
        ...
        public TransformOutputCustomPresetCodecH264VideoGetArgs()
        {
        }
        public static new TransformOutputCustomPresetCodecH264VideoGetArgs Empty => new TransformOutputCustomPresetCodecH264VideoGetArgs();
    }
}
