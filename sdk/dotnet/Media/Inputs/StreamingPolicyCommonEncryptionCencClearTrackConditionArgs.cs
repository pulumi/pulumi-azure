...
namespace Pulumi.Azure.Media.Inputs
{
    ...
    public sealed class StreamingPolicyCommonEncryptionCencClearTrackConditionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public StreamingPolicyCommonEncryptionCencClearTrackConditionArgs()
        {
        }
        public static new StreamingPolicyCommonEncryptionCencClearTrackConditionArgs Empty => new StreamingPolicyCommonEncryptionCencClearTrackConditionArgs();
    }
}
