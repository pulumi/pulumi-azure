...
namespace Pulumi.Azure.Maintenance.Inputs
{
    ...
    public sealed class AssignmentDynamicScopeFilterGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("locations")]
        ...
        [Input("tags")]
        private InputList<Inputs.AssignmentDynamicScopeFilterTagGetArgs>? _tags;

        /// <summary>
        /// One or more `Tags` blocks as defined below.
        /// </summary>
        public InputList<Inputs.AssignmentDynamicScopeFilterTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.AssignmentDynamicScopeFilterTagGetArgs>());
            set => _tags = value;
        }

        public AssignmentDynamicScopeFilterGetArgs()
        {
        }
        public static new AssignmentDynamicScopeFilterGetArgs Empty => new AssignmentDynamicScopeFilterGetArgs();
    }
}
