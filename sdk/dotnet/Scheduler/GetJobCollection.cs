...
namespace Pulumi.Azure.Scheduler
{
    public static partial class Invokes
    {
        ...
        public static Task<GetJobCollectionResult> GetJobCollection(GetJobCollectionArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetJobCollectionResult>("azure:scheduler/getJobCollection:getJobCollection", args ?? InvokeArgs.Empty, options.WithVersion());
    }
