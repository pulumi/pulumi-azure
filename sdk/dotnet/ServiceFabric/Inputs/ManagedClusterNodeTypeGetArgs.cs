...
namespace Pulumi.Azure.ServiceFabric.Inputs
{
    ...
    public sealed class ManagedClusterNodeTypeGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("vmSecrets")]
        private InputList<Inputs.ManagedClusterNodeTypeVmSecretGetArgs>? _vmSecrets;

        /// <summary>
        /// One or more `VmSecrets` blocks as defined below.
        /// </summary>
        public InputList<Inputs.ManagedClusterNodeTypeVmSecretGetArgs> VmSecrets
        {
            get => _vmSecrets ?? (_vmSecrets = new InputList<Inputs.ManagedClusterNodeTypeVmSecretGetArgs>());
        ...
        public ManagedClusterNodeTypeGetArgs()
        {
        }
        public static new ManagedClusterNodeTypeGetArgs Empty => new ManagedClusterNodeTypeGetArgs();
    }
}
