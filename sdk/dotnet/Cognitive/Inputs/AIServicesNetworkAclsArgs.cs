...
namespace Pulumi.Azure.Cognitive.Inputs
{
    ...
    public sealed class AIServicesNetworkAclsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _virtualNetworkRules ?? (_virtualNetworkRules = new InputList<Inputs.AIServicesNetworkAclsVirtualNetworkRuleArgs>());
            set => _virtualNetworkRules = value;
        }

        public AIServicesNetworkAclsArgs()
        {
        }
        public static new AIServicesNetworkAclsArgs Empty => new AIServicesNetworkAclsArgs();
    }
}
