...
namespace Pulumi.Azure.Cognitive
{
    ...
    /// ```
    /// </summary>
    [AzureResourceType("azure:cognitive/accountConnectionApiKey:AccountConnectionApiKey")]
    public partial class AccountConnectionApiKey : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AccountConnectionApiKey(string name, AccountConnectionApiKeyArgs args, CustomResourceOptions? options = null)
            : base("azure:cognitive/accountConnectionApiKey:AccountConnectionApiKey", name, args ?? new AccountConnectionApiKeyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccountConnectionApiKey(string name, Input<string> id, AccountConnectionApiKeyState? state = null, CustomResourceOptions? options = null)
            : base("azure:cognitive/accountConnectionApiKey:AccountConnectionApiKey", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccountConnectionApiKey Get(string name, Input<string> id, AccountConnectionApiKeyState? state = null, CustomResourceOptions? options = null)
        {
            return new AccountConnectionApiKey(name, id, state, options);
        }
    }

    public sealed class AccountConnectionApiKeyArgs : global::Pulumi.ResourceArgs
    {
        ...
        public AccountConnectionApiKeyArgs()
        {
        }
        public static new AccountConnectionApiKeyArgs Empty => new AccountConnectionApiKeyArgs();
    }

    public sealed class AccountConnectionApiKeyState : global::Pulumi.ResourceArgs
    {
        [Input("apiKey")]
        private Input<string>? _apiKey;
        ...
        public AccountConnectionApiKeyState()
        {
        }
        public static new AccountConnectionApiKeyState Empty => new AccountConnectionApiKeyState();
    }
}
