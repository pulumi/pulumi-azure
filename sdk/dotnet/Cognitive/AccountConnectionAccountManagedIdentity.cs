...
namespace Pulumi.Azure.Cognitive
{
    ...
    /// ```
    /// </summary>
    [AzureResourceType("azure:cognitive/accountConnectionAccountManagedIdentity:AccountConnectionAccountManagedIdentity")]
    public partial class AccountConnectionAccountManagedIdentity : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public AccountConnectionAccountManagedIdentity(string name, AccountConnectionAccountManagedIdentityArgs args, CustomResourceOptions? options = null)
            : base("azure:cognitive/accountConnectionAccountManagedIdentity:AccountConnectionAccountManagedIdentity", name, args ?? new AccountConnectionAccountManagedIdentityArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AccountConnectionAccountManagedIdentity(string name, Input<string> id, AccountConnectionAccountManagedIdentityState? state = null, CustomResourceOptions? options = null)
            : base("azure:cognitive/accountConnectionAccountManagedIdentity:AccountConnectionAccountManagedIdentity", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AccountConnectionAccountManagedIdentity Get(string name, Input<string> id, AccountConnectionAccountManagedIdentityState? state = null, CustomResourceOptions? options = null)
        {
            return new AccountConnectionAccountManagedIdentity(name, id, state, options);
        }
    }

    public sealed class AccountConnectionAccountManagedIdentityArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The category of the connection. Possible values are `AIServices`, `AzureKeyVault`, `AzureOpenAI`, and `AzureStorageAccount`. Changing this forces a new resource to be created.
        /// 
        ...
        public AccountConnectionAccountManagedIdentityArgs()
        {
        }
        public static new AccountConnectionAccountManagedIdentityArgs Empty => new AccountConnectionAccountManagedIdentityArgs();
    }

    public sealed class AccountConnectionAccountManagedIdentityState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The category of the connection. Possible values are `AIServices`, `AzureKeyVault`, `AzureOpenAI`, and `AzureStorageAccount`. Changing this forces a new resource to be created.
        /// 
        ...
        public AccountConnectionAccountManagedIdentityState()
        {
        }
        public static new AccountConnectionAccountManagedIdentityState Empty => new AccountConnectionAccountManagedIdentityState();
    }
}
