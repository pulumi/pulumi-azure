...
namespace Pulumi.Azure.Healthcare.Inputs
{
    ...
    public sealed class DicomServiceStorageArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public DicomServiceStorageArgs()
        {
        }
        public static new DicomServiceStorageArgs Empty => new DicomServiceStorageArgs();
    }
}
