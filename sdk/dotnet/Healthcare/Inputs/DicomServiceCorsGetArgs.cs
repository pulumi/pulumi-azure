...
namespace Pulumi.Azure.Healthcare.Inputs
{
    ...
    public sealed class DicomServiceCorsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public DicomServiceCorsGetArgs()
        {
        }
        public static new DicomServiceCorsGetArgs Empty => new DicomServiceCorsGetArgs();
    }
}
