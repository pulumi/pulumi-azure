...
namespace Pulumi.Azure.Relay
{
    ...
    ///     });
    /// 
    ///     var exampleNamespaceAuthorizationRule = new Azure.Relay.NamespaceAuthorizationRule.NamespaceAuthorizationRule("example", new()
    ///     {
    ///         Name = "example",
    ///         ResourceGroupName = example.Name,
    ...
    public partial class NamespaceAuthorizationRule : global::Pulumi.CustomResource
    {
        ...
        public NamespaceAuthorizationRule(string name, NamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure:relay/namespaceAuthorizationRule:NamespaceAuthorizationRule", name, args ?? new NamespaceAuthorizationRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private NamespaceAuthorizationRule(string name, Input<string> id, NamespaceAuthorizationRuleState? state = null, CustomResourceOptions? options = null)
            : base("azure:relay/namespaceAuthorizationRule:NamespaceAuthorizationRule", name, state, MakeResourceOptions(options, id))
        {
        }
