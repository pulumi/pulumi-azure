...
namespace Pulumi.Azure.Monitoring
{
    ...
    /// </summary>
    public partial class MetricAlertRule : Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("emailAction")]
        public Output<Outputs.MetricAlertRuleEmailAction> EmailAction { get; private set; } = null!;
        ...
        public Output<Outputs.MetricAlertRuleWebhookAction> WebhookAction { get; private set; } = null!;
        ...
        private MetricAlertRule(string name, Input<string> id, MetricAlertRuleState? state = null, CustomResourceOptions? options = null)
            : base("azure:monitoring/metricAlertRule:MetricAlertRule", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MetricAlertRule Get(string name, Input<string> id, MetricAlertRuleState? state = null, CustomResourceOptions? options = null)
        {
            return new MetricAlertRule(name, id, state, options);
        }
    }

    public sealed class MetricAlertRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Defines how the metric data is combined over time. Possible values are `Average`, `Minimum`, `Maximum`, `Total`, and `Last`.
        /// </summary>
        ...
        /// </summary>
        [Input("emailAction")]
        public Input<Inputs.MetricAlertRuleEmailActionArgs>? EmailAction { get; set; }
        ...
        /// </summary>
        [Input("webhookAction")]
        public Input<Inputs.MetricAlertRuleWebhookActionArgs>? WebhookAction { get; set; }

        public MetricAlertRuleArgs()
        {
        }
    }

    public sealed class MetricAlertRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Defines how the metric data is combined over time. Possible values are `Average`, `Minimum`, `Maximum`, `Total`, and `Last`.
        /// </summary>
        ...
        /// </summary>
        [Input("emailAction")]
        public Input<Inputs.MetricAlertRuleEmailActionGetArgs>? EmailAction { get; set; }
        ...
        /// </summary>
        [Input("webhookAction")]
        public Input<Inputs.MetricAlertRuleWebhookActionGetArgs>? WebhookAction { get; set; }

        public MetricAlertRuleState()
        {
        }
    }
    ...
    public sealed class MetricAlertRuleEmailActionArgs : Pulumi.ResourceArgs
    {
        [Input("customEmails")]
        ...
        public MetricAlertRuleEmailActionArgs()
        {
        }
    }

    public sealed class MetricAlertRuleEmailActionGetArgs : Pulumi.ResourceArgs
    {
        [Input("customEmails")]
        private InputList<string>? _customEmails;
        ...
        public MetricAlertRuleEmailActionGetArgs()
        {
        }
    }

    public sealed class MetricAlertRuleWebhookActionArgs : Pulumi.ResourceArgs
    {
        [Input("properties")]
        ...
        public MetricAlertRuleWebhookActionArgs()
        {
        }
    }

    public sealed class MetricAlertRuleWebhookActionGetArgs : Pulumi.ResourceArgs
    {
        [Input("properties")]
        private InputMap<string>? _properties;
        ...
        public MetricAlertRuleWebhookActionGetArgs()
        {
        }
    }
    }
    ...
    [OutputType]
    public sealed class MetricAlertRuleEmailAction
    {
        /// <summary>
        /// A list of email addresses to be notified when the alert is triggered.
        /// </summary>
        ...
        [OutputConstructor]
        private MetricAlertRuleEmailAction(
    ...
    [OutputType]
    public sealed class MetricAlertRuleWebhookAction
    {
        /// <summary>
        /// A dictionary of custom properties to include with the webhook POST operation payload.
        /// </summary>
        ...
        [OutputConstructor]
        private MetricAlertRuleWebhookAction(
