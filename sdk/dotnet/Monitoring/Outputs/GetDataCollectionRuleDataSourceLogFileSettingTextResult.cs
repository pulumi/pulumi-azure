...
namespace Pulumi.Azure.Monitoring.Outputs
{
    ...
    [OutputType]
    public sealed class GetDataCollectionRuleDataSourceLogFileSettingTextResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDataCollectionRuleDataSourceLogFileSettingTextResult(string recordStartTimestampFormat)
        {
