...
namespace Pulumi.Azure.Monitoring.Inputs
{
    ...
    public sealed class AlertPrometheusRuleGroupRuleGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions")]
        private InputList<Inputs.AlertPrometheusRuleGroupRuleActionGetArgs>? _actions;

        /// <summary>
        /// An `Action` block as defined below.
        /// </summary>
        public InputList<Inputs.AlertPrometheusRuleGroupRuleActionGetArgs> Actions
        {
            get => _actions ?? (_actions = new InputList<Inputs.AlertPrometheusRuleGroupRuleActionGetArgs>());
            set => _actions = value;
        }
        ...
        public Input<Inputs.AlertPrometheusRuleGroupRuleAlertResolutionGetArgs>? AlertResolution { get; set; }
        ...
        public AlertPrometheusRuleGroupRuleGetArgs()
        {
        }
        public static new AlertPrometheusRuleGroupRuleGetArgs Empty => new AlertPrometheusRuleGroupRuleGetArgs();
    }
}
