...
namespace Pulumi.Azure.EventHub
{
    ...
    public partial class EventHubNamespaceAuthorizationRule : Pulumi.CustomResource
    {
        ...
        public EventHubNamespaceAuthorizationRule(string name, EventHubNamespaceAuthorizationRuleArgs args, CustomResourceOptions? options = null)
            : base("azure:eventhub/eventHubNamespaceAuthorizationRule:EventHubNamespaceAuthorizationRule", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class EventHubNamespaceAuthorizationRuleArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Grants listen access to this this Authorization Rule. Defaults to `false`.
        /// </summary>
    ...
    public sealed class EventHubNamespaceAuthorizationRuleState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Grants listen access to this this Authorization Rule. Defaults to `false`.
        /// </summary>
