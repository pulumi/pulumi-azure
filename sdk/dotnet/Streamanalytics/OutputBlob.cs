...
namespace Pulumi.Azure.StreamAnalytics
{
    ...
    public partial class OutputBlob : Pulumi.CustomResource
    {
        ...
        public OutputBlob(string name, OutputBlobArgs args, CustomResourceOptions? options = null)
            : base("azure:streamanalytics/outputBlob:OutputBlob", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
    ...
    public sealed class OutputBlobSerializationArgs : Pulumi.ResourceArgs
    {
        [Input("encoding")]
        ...
        public OutputBlobSerializationArgs()
        {
        }
    }

    public sealed class OutputBlobSerializationGetArgs : Pulumi.ResourceArgs
    {
        [Input("encoding")]
        public Input<string>? Encoding { get; set; }
