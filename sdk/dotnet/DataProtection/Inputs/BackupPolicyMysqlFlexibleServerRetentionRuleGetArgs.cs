...
namespace Pulumi.Azure.DataProtection.Inputs
{
    ...
    public sealed class BackupPolicyMysqlFlexibleServerRetentionRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaGetArgs> Criteria { get; set; } = null!;

        [Input("lifeCycles", required: true)]
        private InputList<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleGetArgs>? _lifeCycles;

        /// <summary>
        /// A `LifeCycle` block as defined below. Changing this forces a new resource to be created.
        /// </summary>
        public InputList<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleGetArgs> LifeCycles
        {
            get => _lifeCycles ?? (_lifeCycles = new InputList<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleGetArgs>());
