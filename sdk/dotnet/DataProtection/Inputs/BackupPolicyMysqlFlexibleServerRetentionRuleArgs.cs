...
namespace Pulumi.Azure.DataProtection.Inputs
{
    ...
    public sealed class BackupPolicyMysqlFlexibleServerRetentionRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaArgs> Criteria { get; set; } = null!;

        [Input("lifeCycles", required: true)]
        private InputList<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs>? _lifeCycles;

        /// <summary>
        /// A `LifeCycle` block as defined below. Changing this forces a new resource to be created.
        /// </summary>
        public InputList<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs> LifeCycles
        {
            get => _lifeCycles ?? (_lifeCycles = new InputList<Inputs.BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs>());
