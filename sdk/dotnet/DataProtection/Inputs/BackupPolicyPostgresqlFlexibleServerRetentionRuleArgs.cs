...
namespace Pulumi.Azure.DataProtection.Inputs
{
    ...
    public sealed class BackupPolicyPostgresqlFlexibleServerRetentionRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _lifeCycles ?? (_lifeCycles = new InputList<Inputs.BackupPolicyPostgresqlFlexibleServerRetentionRuleLifeCycleArgs>());
        ...
        public BackupPolicyPostgresqlFlexibleServerRetentionRuleArgs()
        {
        }
        public static new BackupPolicyPostgresqlFlexibleServerRetentionRuleArgs Empty => new BackupPolicyPostgresqlFlexibleServerRetentionRuleArgs();
    }
}
