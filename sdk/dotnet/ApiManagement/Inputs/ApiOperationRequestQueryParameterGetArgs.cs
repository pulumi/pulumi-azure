...
namespace Pulumi.Azure.ApiManagement.Inputs
{
    ...
    public sealed class ApiOperationRequestQueryParameterGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("examples")]
        private InputList<Inputs.ApiOperationRequestQueryParameterExampleGetArgs>? _examples;

        /// <summary>
        /// One or more `Example` blocks as defined above.
        /// </summary>
        public InputList<Inputs.ApiOperationRequestQueryParameterExampleGetArgs> Examples
        {
            get => _examples ?? (_examples = new InputList<Inputs.ApiOperationRequestQueryParameterExampleGetArgs>());
            set => _examples = value;
        }
