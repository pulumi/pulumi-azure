...
namespace Pulumi.Azure.ApiManagement.Inputs
{
    ...
    public sealed class ApiOperationTemplateParameterGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("examples")]
        private InputList<Inputs.ApiOperationTemplateParameterExampleGetArgs>? _examples;

        /// <summary>
        /// One or more `Example` blocks as defined above.
        /// </summary>
        public InputList<Inputs.ApiOperationTemplateParameterExampleGetArgs> Examples
        {
            get => _examples ?? (_examples = new InputList<Inputs.ApiOperationTemplateParameterExampleGetArgs>());
            set => _examples = value;
        }
