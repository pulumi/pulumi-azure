...
namespace Pulumi.Azure.EventGrid.Inputs
{
    ...
    public sealed class SystemTopicIdentityArgs : global::Pulumi.ResourceArgs
    {
        [Input("identityIds")]
        ...
        public SystemTopicIdentityArgs()
        {
        }
        public static new SystemTopicIdentityArgs Empty => new SystemTopicIdentityArgs();
    }
}
