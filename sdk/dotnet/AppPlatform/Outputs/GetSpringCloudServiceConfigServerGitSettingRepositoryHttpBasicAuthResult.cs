...
namespace Pulumi.Azure.AppPlatform.Outputs
{
    ...
    [OutputType]
    public sealed class GetSpringCloudServiceConfigServerGitSettingRepositoryHttpBasicAuthResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSpringCloudServiceConfigServerGitSettingRepositoryHttpBasicAuthResult(
            string password,
