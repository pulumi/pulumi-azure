...
namespace Pulumi.Azure.ContainerService.Inputs
{
    ...
    public sealed class KubernetesClusterIngressApplicationGatewayArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityArgs>? _ingressApplicationGatewayIdentities;

        /// <summary>
        /// An `ingress_application_gateway_identity` block is exported. The exported attributes are defined below.
        /// </summary>
        public InputList<Inputs.KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityArgs> IngressApplicationGatewayIdentities
        {
            get => _ingressApplicationGatewayIdentities ?? (_ingressApplicationGatewayIdentities = new InputList<Inputs.KubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityArgs>());
        ...
        public KubernetesClusterIngressApplicationGatewayArgs()
        {
        }
        public static new KubernetesClusterIngressApplicationGatewayArgs Empty => new KubernetesClusterIngressApplicationGatewayArgs();
    }
}
