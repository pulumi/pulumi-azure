...
namespace Pulumi.Azure.ContainerService.Inputs
{
    ...
    public sealed class AutomaticClusterWebAppRoutingIngressGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityGetArgs>? _webAppRoutingIdentities;
        public InputList<Inputs.AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityGetArgs> WebAppRoutingIdentities
        {
            get => _webAppRoutingIdentities ?? (_webAppRoutingIdentities = new InputList<Inputs.AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityGetArgs>());
            set => _webAppRoutingIdentities = value;
        }

        public AutomaticClusterWebAppRoutingIngressGetArgs()
        {
        }
        public static new AutomaticClusterWebAppRoutingIngressGetArgs Empty => new AutomaticClusterWebAppRoutingIngressGetArgs();
    }
}
