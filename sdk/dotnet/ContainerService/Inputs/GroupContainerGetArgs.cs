...
namespace Pulumi.Azure.ContainerService.Inputs
{
    ...
    public sealed class GroupContainerGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("commands")]
        ...
        {
            get => _ports ?? (_ports = new InputList<Inputs.GroupContainerPortGetArgs>());
            set => _ports = value;
        }
        ...
        {
            get => _securities ?? (_securities = new InputList<Inputs.GroupContainerSecurityGetArgs>());
        ...
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.GroupContainerVolumeGetArgs>());
            set => _volumes = value;
        }

        public GroupContainerGetArgs()
        {
        }
        public static new GroupContainerGetArgs Empty => new GroupContainerGetArgs();
    }
}
