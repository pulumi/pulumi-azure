...
namespace Pulumi.Azure.Orbital.Inputs
{
    ...
    public sealed class ContactProfileLinkChannelGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Bandwidth in MHz.
        /// </summary>
        ...
        private InputList<Inputs.ContactProfileLinkChannelEndPointGetArgs>? _endPoints;

        /// <summary>
        /// Customer End point to store/retrieve data during a contact. An `end_point` block as defined below.
        /// </summary>
        public InputList<Inputs.ContactProfileLinkChannelEndPointGetArgs> EndPoints
        {
            get => _endPoints ?? (_endPoints = new InputList<Inputs.ContactProfileLinkChannelEndPointGetArgs>());
        ...
        public ContactProfileLinkChannelGetArgs()
        {
        }
        public static new ContactProfileLinkChannelGetArgs Empty => new ContactProfileLinkChannelGetArgs();
    }
}
