...
namespace Pulumi.Azure.Dns
{
    ...
    public partial class CaaRecord : Pulumi.CustomResource
    {
        ...
        public CaaRecord(string name, CaaRecordArgs args, CustomResourceOptions? options = null)
            : base("azure:dns/caaRecord:CaaRecord", name, args, MakeResourceOptions(options, ""))
        {
        }

        private CaaRecord(string name, Input<string> id, CaaRecordState? state = null, CustomResourceOptions? options = null)
            : base("azure:dns/caaRecord:CaaRecord", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CaaRecord Get(string name, Input<string> id, CaaRecordState? state = null, CustomResourceOptions? options = null)
        {
