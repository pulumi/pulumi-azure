...
namespace Pulumi.Azure.ManagedApplication.Inputs
{
    ...
    public sealed class ApplicationIdentityArgs : global::Pulumi.ResourceArgs
    {
        [Input("identityIds")]
        ...
        public ApplicationIdentityArgs()
        {
        }
        public static new ApplicationIdentityArgs Empty => new ApplicationIdentityArgs();
    }
}
