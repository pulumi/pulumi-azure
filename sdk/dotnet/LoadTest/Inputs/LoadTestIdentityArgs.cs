...
namespace Pulumi.Azure.LoadTest.Inputs
{
    ...
    public sealed class LoadTestIdentityArgs : global::Pulumi.ResourceArgs
    {
        [Input("identityIds")]
        ...
        public LoadTestIdentityArgs()
        {
        }
        public static new LoadTestIdentityArgs Empty => new LoadTestIdentityArgs();
    }
}
