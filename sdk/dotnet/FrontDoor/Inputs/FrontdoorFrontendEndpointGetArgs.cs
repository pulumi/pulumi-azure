...
namespace Pulumi.Azure.FrontDoor.Inputs
{
    ...
    public sealed class FrontdoorFrontendEndpointGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A `custom_https_configuration` block as defined below.
        /// </summary>
        [Input("customHttpsConfiguration")]
        public Input<Inputs.FrontdoorFrontendEndpointCustomHttpsConfigurationGetArgs>? CustomHttpsConfiguration { get; set; }
