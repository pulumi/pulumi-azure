...
namespace Pulumi.Azure.KeyVault
{
    ...
    public partial class Certificate : Pulumi.CustomResource
    {
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            ...
            {
                Version = Utilities.Version,                Aliases = { new Alias { Type = "azure:keyvault/certifiate:Certifiate" } },
            };
    ...
    public sealed class CertificateCertificateArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public CertificateCertificateArgs()
        {
        }
    }
    ...
    public sealed class CertificateCertificatePolicyArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<CertificateCertificatePolicyIssuerParametersArgs> IssuerParameters { get; set; } = null!;

        /// <summary>
        /// A `key_properties` block as defined below.
        /// </summary>
        [Input("keyProperties", required: true)]
        public Input<CertificateCertificatePolicyKeyPropertiesArgs> KeyProperties { get; set; } = null!;

        [Input("lifetimeActions")]
        private InputList<CertificateCertificatePolicyLifetimeActionsArgs>? _lifetimeActions;

        /// <summary>
        /// A `lifetime_action` block as defined below.
        /// </summary>
        public InputList<CertificateCertificatePolicyLifetimeActionsArgs> LifetimeActions
        {
            get => _lifetimeActions ?? (_lifetimeActions = new InputList<CertificateCertificatePolicyLifetimeActionsArgs>());
        ...
        public Input<CertificateCertificatePolicySecretPropertiesArgs> SecretProperties { get; set; } = null!;
    ...
    public sealed class CertificateCertificatePolicyGetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("issuerParameters", required: true)]
        public Input<CertificateCertificatePolicyIssuerParametersGetArgs> IssuerParameters { get; set; } = null!;

        /// <summary>
        /// A `key_properties` block as defined below.
        /// </summary>
        [Input("keyProperties", required: true)]
        public Input<CertificateCertificatePolicyKeyPropertiesGetArgs> KeyProperties { get; set; } = null!;

        [Input("lifetimeActions")]
        private InputList<CertificateCertificatePolicyLifetimeActionsGetArgs>? _lifetimeActions;

        /// <summary>
        /// A `lifetime_action` block as defined below.
        /// </summary>
        public InputList<CertificateCertificatePolicyLifetimeActionsGetArgs> LifetimeActions
        {
            get => _lifetimeActions ?? (_lifetimeActions = new InputList<CertificateCertificatePolicyLifetimeActionsGetArgs>());
            set => _lifetimeActions = value;
        }
        ...
        /// </summary>
        [Input("secretProperties", required: true)]
        public Input<CertificateCertificatePolicySecretPropertiesGetArgs> SecretProperties { get; set; } = null!;
    ...
    public sealed class CertificateCertificatePolicyKeyPropertiesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
    ...
    public sealed class CertificateCertificatePolicyLifetimeActionsActionArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public CertificateCertificatePolicyLifetimeActionsActionArgs()
        {
        }
    }

    public sealed class CertificateCertificatePolicyLifetimeActionsActionGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Type of action to be performed when the lifetime trigger is triggerec. Possible values include `AutoRenew` and `EmailContacts`. Changing this forces a new resource to be created.
        /// </summary>
        ...
        public CertificateCertificatePolicyLifetimeActionsActionGetArgs()
        {
        }
    }

    public sealed class CertificateCertificatePolicyLifetimeActionsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A `action` block as defined below.
        /// </summary>
        [Input("action", required: true)]
        public Input<CertificateCertificatePolicyLifetimeActionsActionArgs> Action { get; set; } = null!;

        /// <summary>
        /// A `trigger` block as defined below.
        /// </summary>
        [Input("trigger", required: true)]
        public Input<CertificateCertificatePolicyLifetimeActionsTriggerArgs> Trigger { get; set; } = null!;

        public CertificateCertificatePolicyLifetimeActionsArgs()
        {
        }
    }

    public sealed class CertificateCertificatePolicyLifetimeActionsGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// A `action` block as defined below.
        /// </summary>
        [Input("action", required: true)]
        public Input<CertificateCertificatePolicyLifetimeActionsActionGetArgs> Action { get; set; } = null!;

        /// <summary>
        /// A `trigger` block as defined below.
        /// </summary>
        [Input("trigger", required: true)]
        public Input<CertificateCertificatePolicyLifetimeActionsTriggerGetArgs> Trigger { get; set; } = null!;

        public CertificateCertificatePolicyLifetimeActionsGetArgs()
        {
        }
    }

    public sealed class CertificateCertificatePolicyLifetimeActionsTriggerArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public CertificateCertificatePolicyLifetimeActionsTriggerArgs()
        {
        }
    }

    public sealed class CertificateCertificatePolicyLifetimeActionsTriggerGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The number of days before the Certificate expires that the action associated with this Trigger should run. Changing this forces a new resource to be created. Conflicts with `lifetime_percentage`.
        /// </summary>
        ...
        public CertificateCertificatePolicyLifetimeActionsTriggerGetArgs()
        {
        }
    }

    public sealed class CertificateCertificatePolicySecretPropertiesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
    ...
    public sealed class CertificateCertificatePolicySecretPropertiesGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Content-Type of the Certificate, such as `application/x-pkcs12` for a PFX or `application/x-pem-file` for a PEM. Changing this forces a new resource to be created.
        /// </summary>
    ...
    public sealed class CertificateCertificatePolicyX509CertificatePropertiesArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<CertificateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNamesArgs>? SubjectAlternativeNames { get; set; }
    ...
    public sealed class CertificateCertificatePolicyX509CertificatePropertiesGetArgs : Pulumi.ResourceArgs
    {
        [Input("extendedKeyUsages")]
        private InputList<string>? _extendedKeyUsages;
        ...
        /// </summary>
        [Input("subjectAlternativeNames")]
        public Input<CertificateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNamesGetArgs>? SubjectAlternativeNames { get; set; }
        ...
        public CertificateCertificatePolicyX509CertificatePropertiesGetArgs()
        {
        }
    }
    ...
    public sealed class CertificateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNamesGetArgs : Pulumi.ResourceArgs
    {
        [Input("dnsNames")]
        private InputList<string>? _dnsNames;
    ...
    public sealed class CertificateCertificatePolicy
    {
        ...
        /// A `issuer_parameters` block as defined below.
        /// </summary>
        public readonly CertificateCertificatePolicyIssuerParameters IssuerParameters;
        /// <summary>
        /// A `key_properties` block as defined below.
        /// </summary>
        public readonly CertificateCertificatePolicyKeyProperties KeyProperties;
        /// <summary>
        /// A `lifetime_action` block as defined below.
        /// </summary>
        public readonly ImmutableArray<CertificateCertificatePolicyLifetimeActions> LifetimeActions;
        /// <summary>
        /// A `secret_properties` block as defined below.
        /// </summary>
        public readonly CertificateCertificatePolicySecretProperties SecretProperties;
        /// <summary>
        /// A `x509_certificate_properties` block as defined below.
        /// </summary>
        public readonly CertificateCertificatePolicyX509CertificateProperties X509CertificateProperties;

        [OutputConstructor]
        private CertificateCertificatePolicy(
            CertificateCertificatePolicyIssuerParameters issuerParameters,
            CertificateCertificatePolicyKeyProperties keyProperties,
            ImmutableArray<CertificateCertificatePolicyLifetimeActions> lifetimeActions,
            CertificateCertificatePolicySecretProperties secretProperties,
            CertificateCertificatePolicyX509CertificateProperties x509CertificateProperties)
        {
    ...
    public sealed class CertificateCertificatePolicyIssuerParameters
    {
        ...
        [OutputConstructor]
        private CertificateCertificatePolicyIssuerParameters(string name)
        {
            Name = name;
        }
    }
    ...
    [OutputType]
    public sealed class CertificateCertificatePolicyLifetimeActions
    {
        /// <summary>
        /// A `action` block as defined below.
        /// </summary>
        public readonly CertificateCertificatePolicyLifetimeActionsAction Action;
        /// <summary>
        /// A `trigger` block as defined below.
        /// </summary>
        public readonly CertificateCertificatePolicyLifetimeActionsTrigger Trigger;

        [OutputConstructor]
        private CertificateCertificatePolicyLifetimeActions(
            CertificateCertificatePolicyLifetimeActionsAction action,
            CertificateCertificatePolicyLifetimeActionsTrigger trigger)
        {
            Action = action;
            Trigger = trigger;
        }
    ...
    [OutputType]
    public sealed class CertificateCertificatePolicyLifetimeActionsAction
    {
        /// <summary>
        /// The Type of action to be performed when the lifetime trigger is triggerec. Possible values include `AutoRenew` and `EmailContacts`. Changing this forces a new resource to be created.
        /// </summary>
        ...
        [OutputConstructor]
        private CertificateCertificatePolicyLifetimeActionsAction(string actionType)
        {
    ...
    [OutputType]
    public sealed class CertificateCertificatePolicyLifetimeActionsTrigger
    {
        /// <summary>
        /// The number of days before the Certificate expires that the action associated with this Trigger should run. Changing this forces a new resource to be created. Conflicts with `lifetime_percentage`.
        /// </summary>
        ...
        [OutputConstructor]
        private CertificateCertificatePolicyLifetimeActionsTrigger(
    ...
    public sealed class CertificateCertificatePolicyX509CertificateProperties
    {
        ...
        private CertificateCertificatePolicyX509CertificateProperties(
            ...
            string subject,
            CertificateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNames subjectAlternativeNames,
