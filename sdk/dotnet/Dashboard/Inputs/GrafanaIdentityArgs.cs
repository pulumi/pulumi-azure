...
namespace Pulumi.Azure.Dashboard.Inputs
{
    ...
    public sealed class GrafanaIdentityArgs : global::Pulumi.ResourceArgs
    {
        [Input("identityIds")]
        ...
        public GrafanaIdentityArgs()
        {
        }
        public static new GrafanaIdentityArgs Empty => new GrafanaIdentityArgs();
    }
}
