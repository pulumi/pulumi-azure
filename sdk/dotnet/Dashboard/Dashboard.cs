...
namespace Pulumi.Azure.Dashboard
{
    ...
    ///     public MyStack()
    ///     {
    /// "TODO: // TODO config""TODO: // TODO config"        var current = Output.Create(Azure.Core.GetSubscription.InvokeAsync());
    ///         var my-group = new Azure.Core.ResourceGroup("my-group", new Azure.Core.ResourceGroupArgs
    ///         {
    ///             Location = "uksouth",
    ///         });
    ///         var my-board = new Azure.Dashboard.Dashboard("my-board", new Azure.Dashboard.DashboardArgs
    ///         {
