...
namespace Pulumi.Azure.Sentinel
{
    ...
    ///     });
    /// 
    ///     var exampleDataConnectorOfficeAtp = new Azure.Sentinel.DataConnectorOfficeAtp.DataConnectorOfficeAtp("example", new()
    ///     {
    ///         Name = "example",
    ...
    /// ```
    /// </summary>
    [AzureResourceType("azure:sentinel/dataConnectorOfficeAtp:DataConnectorOfficeAtp")]
    public partial class DataConnectorOfficeAtp : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DataConnectorOfficeAtp(string name, DataConnectorOfficeAtpArgs args, CustomResourceOptions? options = null)
            : base("azure:sentinel/dataConnectorOfficeAtp:DataConnectorOfficeAtp", name, args ?? new DataConnectorOfficeAtpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnectorOfficeAtp(string name, Input<string> id, DataConnectorOfficeAtpState? state = null, CustomResourceOptions? options = null)
            : base("azure:sentinel/dataConnectorOfficeAtp:DataConnectorOfficeAtp", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataConnectorOfficeAtp Get(string name, Input<string> id, DataConnectorOfficeAtpState? state = null, CustomResourceOptions? options = null)
        {
            return new DataConnectorOfficeAtp(name, id, state, options);
        }
    }

    public sealed class DataConnectorOfficeAtpArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the Log Analytics Workspace that this Office ATP Data Connector resides in. Changing this forces a new Office ATP Data Connector to be created.
        /// </summary>
        ...
        public DataConnectorOfficeAtpArgs()
        {
        }
        public static new DataConnectorOfficeAtpArgs Empty => new DataConnectorOfficeAtpArgs();
    }

    public sealed class DataConnectorOfficeAtpState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the Log Analytics Workspace that this Office ATP Data Connector resides in. Changing this forces a new Office ATP Data Connector to be created.
        /// </summary>
        ...
        public DataConnectorOfficeAtpState()
        {
        }
        public static new DataConnectorOfficeAtpState Empty => new DataConnectorOfficeAtpState();
    }
}
