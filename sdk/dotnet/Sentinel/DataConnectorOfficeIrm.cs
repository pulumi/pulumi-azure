...
namespace Pulumi.Azure.Sentinel
{
    ...
    ///     });
    /// 
    ///     var exampleDataConnectorOfficeIrm = new Azure.Sentinel.DataConnectorOfficeIrm.DataConnectorOfficeIrm("example", new()
    ///     {
    ///         Name = "example",
    ...
    /// ```
    /// </summary>
    [AzureResourceType("azure:sentinel/dataConnectorOfficeIrm:DataConnectorOfficeIrm")]
    public partial class DataConnectorOfficeIrm : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public DataConnectorOfficeIrm(string name, DataConnectorOfficeIrmArgs args, CustomResourceOptions? options = null)
            : base("azure:sentinel/dataConnectorOfficeIrm:DataConnectorOfficeIrm", name, args ?? new DataConnectorOfficeIrmArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DataConnectorOfficeIrm(string name, Input<string> id, DataConnectorOfficeIrmState? state = null, CustomResourceOptions? options = null)
            : base("azure:sentinel/dataConnectorOfficeIrm:DataConnectorOfficeIrm", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DataConnectorOfficeIrm Get(string name, Input<string> id, DataConnectorOfficeIrmState? state = null, CustomResourceOptions? options = null)
        {
            return new DataConnectorOfficeIrm(name, id, state, options);
        }
    }

    public sealed class DataConnectorOfficeIrmArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the Log Analytics Workspace that this Office IRM Data Connector resides in. Changing this forces a new Office IRM Data Connector to be created.
        /// </summary>
        ...
        public DataConnectorOfficeIrmArgs()
        {
        }
        public static new DataConnectorOfficeIrmArgs Empty => new DataConnectorOfficeIrmArgs();
    }

    public sealed class DataConnectorOfficeIrmState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The ID of the Log Analytics Workspace that this Office IRM Data Connector resides in. Changing this forces a new Office IRM Data Connector to be created.
        /// </summary>
        ...
        public DataConnectorOfficeIrmState()
        {
        }
        public static new DataConnectorOfficeIrmState Empty => new DataConnectorOfficeIrmState();
    }
}
