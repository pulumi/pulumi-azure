...
namespace Pulumi.Azure.Sentinel.Inputs
{
    ...
    public sealed class AlertRuleNrtEntityMappingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _fieldMappings ?? (_fieldMappings = new InputList<Inputs.AlertRuleNrtEntityMappingFieldMappingArgs>());
            set => _fieldMappings = value;
        }

        public AlertRuleNrtEntityMappingArgs()
        {
        }
        public static new AlertRuleNrtEntityMappingArgs Empty => new AlertRuleNrtEntityMappingArgs();
    }
}
