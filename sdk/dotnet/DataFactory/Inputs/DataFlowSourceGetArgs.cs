...
namespace Pulumi.Azure.DataFactory.Inputs
{
    ...
    public sealed class DataFlowSourceGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dataset")]
        public Input<Inputs.DataFlowSourceDatasetGetArgs>? Dataset { get; set; }
        ...
        /// </summary>
        [Input("flowlet")]
        public Input<Inputs.DataFlowSourceFlowletGetArgs>? Flowlet { get; set; }

        /// <summary>
        /// A `LinkedService` block as defined below.
        /// </summary>
        [Input("linkedService")]
        public Input<Inputs.DataFlowSourceLinkedServiceGetArgs>? LinkedService { get; set; }
        ...
        public Input<Inputs.DataFlowSourceRejectedLinkedServiceGetArgs>? RejectedLinkedService { get; set; }

        /// <summary>
        /// A `SchemaLinkedService` block as defined below.
        /// </summary>
        [Input("schemaLinkedService")]
        public Input<Inputs.DataFlowSourceSchemaLinkedServiceGetArgs>? SchemaLinkedService { get; set; }
