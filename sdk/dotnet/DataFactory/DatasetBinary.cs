...
namespace Pulumi.Azure.DataFactory
{
    ...
    public partial class DatasetBinary : global::Pulumi.CustomResource
    {
        ...
        public DatasetBinary(string name, DatasetBinaryArgs args, CustomResourceOptions? options = null)
            : base("azure:datafactory/datasetBinary:DatasetBinary", name, args ?? new DatasetBinaryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatasetBinary(string name, Input<string> id, DatasetBinaryState? state = null, CustomResourceOptions? options = null)
            : base("azure:datafactory/datasetBinary:DatasetBinary", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DatasetBinary Get(string name, Input<string> id, DatasetBinaryState? state = null, CustomResourceOptions? options = null)
        {
