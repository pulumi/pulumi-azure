...
namespace Pulumi.Azure.Cdn.Inputs
{
    ...
    public sealed class FrontdoorProfileIdentityArgs : global::Pulumi.ResourceArgs
    {
        [Input("identityIds")]
        ...
        public FrontdoorProfileIdentityArgs()
        {
        }
        public static new FrontdoorProfileIdentityArgs Empty => new FrontdoorProfileIdentityArgs();
    }
}
