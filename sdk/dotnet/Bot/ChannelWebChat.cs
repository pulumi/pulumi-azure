...
namespace Pulumi.Azure.Bot
{
    ...
    public partial class ChannelWebChat : Pulumi.CustomResource
    {
        /// <summary>
    ...
    public sealed class ChannelWebChatArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the Bot Resource this channel will be associated with. Changing this forces a new resource to be created.
        /// </summary>
    ...
    public sealed class ChannelWebChatState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the Bot Resource this channel will be associated with. Changing this forces a new resource to be created.
        /// </summary>
