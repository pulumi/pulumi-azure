...
namespace Pulumi.Azure.WorkloadsSAP.Inputs
{
    ...
    public sealed class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("dataDisks")]
        private InputList<Inputs.SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDiskGetArgs>? _dataDisks;

        /// <summary>
        /// (Optional) One or more `data_disk` blocks as defined below. Changing this forces a new resource to be created.
        /// </summary>
        public InputList<Inputs.SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDiskGetArgs> DataDisks
        {
            get => _dataDisks ?? (_dataDisks = new InputList<Inputs.SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDiskGetArgs>());
        ...
        public SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesGetArgs()
        {
        }
        public static new SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesGetArgs Empty => new SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesGetArgs();
    }
}
