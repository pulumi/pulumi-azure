...
namespace Pulumi.Azure.Compute
{
    ...
    public partial class VirtualMachineRestorePointCollection : global::Pulumi.CustomResource
    {
        ...
        /// <summary>
        /// Create a VirtualMachineRestorePointCollection resource with the given unique name, arguments, and options.
        /// </summary>
        ///
        /// <param name="name">The unique name of the resource</param>
        /// <param name="args">The arguments used to populate this resource's properties</param>
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public VirtualMachineRestorePointCollection(string name, VirtualMachineRestorePointCollectionArgs args, CustomResourceOptions? options = null)
            : base("azure:compute/virtualMachineRestorePointCollection:VirtualMachineRestorePointCollection", name, args ?? new VirtualMachineRestorePointCollectionArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VirtualMachineRestorePointCollection(string name, Input<string> id, VirtualMachineRestorePointCollectionState? state = null, CustomResourceOptions? options = null)
            : base("azure:compute/virtualMachineRestorePointCollection:VirtualMachineRestorePointCollection", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static VirtualMachineRestorePointCollection Get(string name, Input<string> id, VirtualMachineRestorePointCollectionState? state = null, CustomResourceOptions? options = null)
        {
            return new VirtualMachineRestorePointCollection(name, id, state, options);
        }
    }

    public sealed class VirtualMachineRestorePointCollectionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Azure location where the Virtual Machine Restore Point Collection should exist. Changing this forces a new resource to be created.
        /// </summary>
        ...
        public VirtualMachineRestorePointCollectionArgs()
        {
        }
        public static new VirtualMachineRestorePointCollectionArgs Empty => new VirtualMachineRestorePointCollectionArgs();
    }

    public sealed class VirtualMachineRestorePointCollectionState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Azure location where the Virtual Machine Restore Point Collection should exist. Changing this forces a new resource to be created.
        /// </summary>
        ...
        public VirtualMachineRestorePointCollectionState()
        {
        }
        public static new VirtualMachineRestorePointCollectionState Empty => new VirtualMachineRestorePointCollectionState();
    }
}
