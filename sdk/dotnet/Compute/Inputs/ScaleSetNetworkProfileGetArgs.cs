...
namespace Pulumi.Azure.Compute.Inputs
{
    ...
    public sealed class ScaleSetNetworkProfileGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("dnsSettings")]
        public Input<Inputs.ScaleSetNetworkProfileDnsSettingsGetArgs>? DnsSettings { get; set; }

        [Input("ipConfigurations", required: true)]
        private InputList<Inputs.ScaleSetNetworkProfileIpConfigurationGetArgs>? _ipConfigurations;

        /// <summary>
        /// An `ip_configuration` block as documented below.
        /// </summary>
        public InputList<Inputs.ScaleSetNetworkProfileIpConfigurationGetArgs> IpConfigurations
        {
            get => _ipConfigurations ?? (_ipConfigurations = new InputList<Inputs.ScaleSetNetworkProfileIpConfigurationGetArgs>());
