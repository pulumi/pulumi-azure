...
namespace Pulumi.Azure.Synapse
{
    ...
    ///     });
    /// 
    ///     var exampleIntegrationRuntimeAzure = new Azure.Synapse.IntegrationRuntimeAzure.IntegrationRuntimeAzure("example", new()
    ///     {
    ///         Name = "example",
    ///         SynapseWorkspaceId = exampleWorkspace.Id,
    ///         Location = example.Location,
    ///     });
    /// 
    ///     var exampleLinkedService = new Azure.Synapse.LinkedService.LinkedService("example", new()
    ///     {
    ///         Name = "example",
    ///         SynapseWorkspaceId = exampleWorkspace.Id,
