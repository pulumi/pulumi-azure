...
namespace Pulumi.Azure.Synapse
{
    ...
    ///     });
    /// 
    ///     var exampleConnect = new Azure.Storage.Account.Account("example_connect", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var exampleManagedPrivateEndpoint = new Azure.Synapse.ManagedPrivateEndpoint.ManagedPrivateEndpoint("example", new()
    ///     {
