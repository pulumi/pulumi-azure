...
namespace Pulumi.Azure.LogicApps
{
    ...
    ///     });
    /// 
    ///     var exampleWorkflow = new Azure.Logicapps.Workflow.Workflow("example", new()
    ///     {
    ///         Name = "workflow1",
    ...
    ///     });
    /// 
    ///     var exampleTriggerRecurrence = new Azure.Logicapps.TriggerRecurrence.TriggerRecurrence("example", new()
    ///     {
    ///         Name = "run-every-day",
