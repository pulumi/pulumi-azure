...
namespace Pulumi.Azure.LogicApps.Inputs
{
    ...
    public sealed class IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleArgs : global::Pulumi.ResourceArgs
    {
        [Input("hours")]
        ...
        [Input("monthlies")]
        private InputList<Inputs.IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleMonthlyArgs>? _monthlies;

        /// <summary>
        /// A `Monthly` block as documented below.
        /// </summary>
        public InputList<Inputs.IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleMonthlyArgs> Monthlies
        {
            get => _monthlies ?? (_monthlies = new InputList<Inputs.IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleMonthlyArgs>());
        ...
        public IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleArgs()
        {
        }
        public static new IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleArgs Empty => new IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleArgs();
    }
}
