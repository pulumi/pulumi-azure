...
/**
 * Manages a HyperV site recovery network mapping on Azure. A network mapping decides how to translate connected networks when a VM is migrated from HyperV VMM Center to Azure.
 *
 * ## Import
 *
...
export class HypervNetworkMapping extends pulumi.CustomResource {
    ...
    /**
     * The ID of the Recovery Services Vault where the network mapping should be created. Changing this forces a new resource to be created.
     */
