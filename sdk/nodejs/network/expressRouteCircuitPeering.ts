...
export class ExpressRouteCircuitPeering extends pulumi.CustomResource {
     ...
     */
    public readonly microsoftPeeringConfig!: pulumi.Output<outputApi.network.ExpressRouteCircuitPeeringMicrosoftPeeringConfig | undefined>;
    /**
...
export interface ExpressRouteCircuitPeeringState {
     ...
     * A `microsoftPeeringConfig` block as defined below. Required when `peeringType` is set to `MicrosoftPeering`.
     */
    readonly microsoftPeeringConfig?: pulumi.Input<inputApi.network.ExpressRouteCircuitPeeringMicrosoftPeeringConfig>;
    /**
     * The Either a 16-bit or a 32-bit ASN. Can either be public or private..
     */
