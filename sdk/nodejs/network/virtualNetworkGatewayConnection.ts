...
export class VirtualNetworkGatewayConnection extends pulumi.CustomResource {
     ...
     */
    public readonly ipsecPolicy!: pulumi.Output<outputApi.network.VirtualNetworkGatewayConnectionIpsecPolicy | undefined>;
    /**
...
export interface VirtualNetworkGatewayConnectionState {
     ...
     * custom policies refer to [the relevant section in the Azure documentation](https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-ipsecikepolicy-rm-powershell).
     */
    readonly ipsecPolicy?: pulumi.Input<inputApi.network.VirtualNetworkGatewayConnectionIpsecPolicy>;
    /**
     * The ID of the local network gateway
     * when creating Site-to-Site connection (i.e. when `type` is `IPsec`).
     */
