 ...
 * });
 * const exampleVirtualHubIp = new azure.network/virtualHubIp.VirtualHubIp("example", {
 *     name: "example-vhubip",
 ...
 * });
 * const exampleBgpConnection = new azure.network/bgpConnection.BgpConnection("example", {
