...
export interface GetExpressRouteCircuitResult {
     ...
     */
    readonly peerings: outputApi.network.GetExpressRouteCircuitPeering[];
    readonly resourceGroupName: string;
    /**
     ...
     */
    readonly serviceProviderProperties: outputApi.network.GetExpressRouteCircuitServiceProviderProperty[];
    /**
     ...
     */
    readonly sku: outputApi.network.GetExpressRouteCircuitSku;
    /**
