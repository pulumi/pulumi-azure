...
export class PublicIp extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: PublicIpArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PublicIpArgs | PublicIpState, opts?: pulumi.ResourceOptions) {
