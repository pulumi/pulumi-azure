 ...
 * });
 * const exampleConnectionMonitor = new azure.network.ConnectionMonitor("example", {
 *     destination: {
 *         address: "exmaple.com",
 *         port: 80,
 *     },
...
export class ConnectionMonitor extends pulumi.CustomResource {
     ...
     */
    public readonly destination!: pulumi.Output<outputs.network.ConnectionMonitorDestination>;
    /**
     ...
     */
    public readonly source!: pulumi.Output<outputs.network.ConnectionMonitorSource>;
    /**
