...
export class ExpressRouteCircuitAuthorization extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExpressRouteCircuitAuthorizationState): ExpressRouteCircuitAuthorization {
        return new ExpressRouteCircuitAuthorization(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ExpressRouteCircuitAuthorizationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ExpressRouteCircuitAuthorizationArgs | ExpressRouteCircuitAuthorizationState, opts?: pulumi.ResourceOptions) {
