...
export class NetworkSecurityGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkSecurityGroupState): NetworkSecurityGroup {
        return new NetworkSecurityGroup(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: NetworkSecurityGroupArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NetworkSecurityGroupArgs | NetworkSecurityGroupState, opts?: pulumi.ResourceOptions) {
...
export interface NetworkSecurityGroupState {
     ...
     * One or more `security_rule` blocks as defined below.
     */
    readonly securityRules?: pulumi.Input<{ access: pulumi.Input<string>, description?: pulumi.Input<string>, destinationAddressPrefix?: pulumi.Input<string>, destinationAddressPrefixes?: pulumi.Input<pulumi.Input<string>[]>, destinationApplicationSecurityGroupIds?: pulumi.Input<pulumi.Input<string>[]>, destinationPortRange?: pulumi.Input<string>, destinationPortRanges?: pulumi.Input<pulumi.Input<string>[]>, direction: pulumi.Input<string>, name: pulumi.Input<string>, priority: pulumi.Input<number>, protocol: pulumi.Input<string>, sourceAddressPrefix?: pulumi.Input<string>, sourceAddressPrefixes?: pulumi.Input<pulumi.Input<string>[]>, sourceApplicationSecurityGroupIds?: pulumi.Input<pulumi.Input<string>[]>, sourcePortRange?: pulumi.Input<string>, sourcePortRanges?: pulumi.Input<pulumi.Input<string>[]> }[]>;
    /**
     * A mapping of tags to assign to the resource.
     */
