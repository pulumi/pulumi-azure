...
export class LocalNetworkGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocalNetworkGatewayState): LocalNetworkGateway {
        return new LocalNetworkGateway(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: LocalNetworkGatewayArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: LocalNetworkGatewayArgs | LocalNetworkGatewayState, opts?: pulumi.ResourceOptions) {
