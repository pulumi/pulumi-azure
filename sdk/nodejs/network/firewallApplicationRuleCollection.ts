...
export class FirewallApplicationRuleCollection extends pulumi.CustomResource {
     ...
     */
    declare public readonly rules: pulumi.Output<outputs.network.FirewallApplicationRuleCollectionRule[]>;
...
export interface FirewallApplicationRuleCollectionState {
     ...
     * One or more `rule` blocks as defined below.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.network.FirewallApplicationRuleCollectionRule>[] | undefined>;
}
