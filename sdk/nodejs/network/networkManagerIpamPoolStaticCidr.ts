...
export class NetworkManagerIpamPoolStaticCidr extends pulumi.CustomResource {
     ...
     * > **Note:** Exactly one of `addressPrefixes` or `numberOfIpAddressesToAllocate` must be specified.
     */
    public readonly numberOfIpAddressesToAllocate!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: NetworkManagerIpamPoolStaticCidrArgs | NetworkManagerIpamPoolStaticCidrState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["numberOfIpAddressesToAllocate"] = state ? state.numberOfIpAddressesToAllocate : undefined;
        } else {
            ...
            resourceInputs["numberOfIpAddressesToAllocate"] = args ? args.numberOfIpAddressesToAllocate : undefined;
        }
