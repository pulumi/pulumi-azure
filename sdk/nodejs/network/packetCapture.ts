...
export class PacketCapture extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PacketCaptureState): PacketCapture {
        return new PacketCapture(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: PacketCaptureArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PacketCaptureArgs | PacketCaptureState, opts?: pulumi.ResourceOptions) {
