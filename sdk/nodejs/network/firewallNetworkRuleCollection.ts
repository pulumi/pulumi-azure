...
export class FirewallNetworkRuleCollection extends pulumi.CustomResource {
     ...
     */
    public readonly rules!: pulumi.Output<outputApi.network.FirewallNetworkRuleCollectionRule[]>;
...
export interface FirewallNetworkRuleCollectionState {
     ...
     * One or more `rule` blocks as defined below.
     */
    readonly rules?: pulumi.Input<pulumi.Input<inputApi.network.FirewallNetworkRuleCollectionRule>[]>;
}
