...
export class ExpressRouteCircuit extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExpressRouteCircuitState): ExpressRouteCircuit {
        return new ExpressRouteCircuit(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ExpressRouteCircuitArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ExpressRouteCircuitArgs | ExpressRouteCircuitState, opts?: pulumi.ResourceOptions) {
