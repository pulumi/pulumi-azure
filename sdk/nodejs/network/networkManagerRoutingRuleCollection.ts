...
export class NetworkManagerRoutingRuleCollection extends pulumi.CustomResource {
     ...
     */
    public readonly routingConfigurationId!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: NetworkManagerRoutingRuleCollectionArgs | NetworkManagerRoutingRuleCollectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["routingConfigurationId"] = state ? state.routingConfigurationId : undefined;
        } else {
            ...
            if ((!args || args.routingConfigurationId === undefined) && !opts.urn) {
            ...
            resourceInputs["routingConfigurationId"] = args ? args.routingConfigurationId : undefined;
        }
