...
export class ApplicationSecurityGroup extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ApplicationSecurityGroupArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ApplicationSecurityGroupArgs | ApplicationSecurityGroupState, opts?: pulumi.ResourceOptions) {
