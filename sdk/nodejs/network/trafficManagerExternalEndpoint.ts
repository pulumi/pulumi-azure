...
export interface TrafficManagerExternalEndpointState {
     ...
     * One or more `customHeader` blocks as defined below.
     */
    customHeaders?: pulumi.Input<pulumi.Input<inputs.network.TrafficManagerExternalEndpointCustomHeader>[] | undefined>;
    /**
     * Is the endpoint enabled? Defaults to `true`.
     */
     ...
     * One or more `subnet` blocks as defined below. Changing this forces a new resource to be created.
     */
    subnets?: pulumi.Input<pulumi.Input<inputs.network.TrafficManagerExternalEndpointSubnet>[] | undefined>;
    /**
     * The FQDN DNS name of the target.
     */
