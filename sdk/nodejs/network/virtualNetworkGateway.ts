...
export class VirtualNetworkGateway extends pulumi.CustomResource {
    ...
    public readonly bgpSettings!: pulumi.Output<outputApi.network.VirtualNetworkGatewayBgpSettings>;
    /**
     ...
     */
    public readonly ipConfigurations!: pulumi.Output<outputApi.network.VirtualNetworkGatewayIpConfiguration[]>;
    /**
     ...
     */
    public readonly vpnClientConfiguration!: pulumi.Output<outputApi.network.VirtualNetworkGatewayVpnClientConfiguration | undefined>;
    /**
...
export interface VirtualNetworkGatewayState {
    ...
    readonly bgpSettings?: pulumi.Input<inputApi.network.VirtualNetworkGatewayBgpSettings>;
    /**
     * The ID of the local network gateway
     * through which outbound Internet traffic from the virtual network in which the
     * gateway is created will be routed (*forced tunneling*). Refer to the
     ...
     * an active-active gateway requires exactly two `ipConfiguration` blocks.
     */
    readonly ipConfigurations?: pulumi.Input<pulumi.Input<inputApi.network.VirtualNetworkGatewayIpConfiguration>[]>;
    /**
     * The location/region where the Virtual Network Gateway is
     * located. Changing the location/region forces a new resource to be created.
     */
     ...
     * to accept IPSec point-to-site connections.
     */
    readonly vpnClientConfiguration?: pulumi.Input<inputApi.network.VirtualNetworkGatewayVpnClientConfiguration>;
    /**
     * The routing type of the Virtual Network Gateway. Valid
     * options are `RouteBased` or `PolicyBased`. Defaults to `RouteBased`.
     */
