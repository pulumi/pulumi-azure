...
export class NetworkWatcher extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkWatcherState): NetworkWatcher {
        return new NetworkWatcher(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: NetworkWatcherArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NetworkWatcherArgs | NetworkWatcherState, opts?: pulumi.ResourceOptions) {
