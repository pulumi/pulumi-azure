...
export class NetworkSecurityRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkSecurityRuleState): NetworkSecurityRule {
        return new NetworkSecurityRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: NetworkSecurityRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NetworkSecurityRuleArgs | NetworkSecurityRuleState, opts?: pulumi.ResourceOptions) {
