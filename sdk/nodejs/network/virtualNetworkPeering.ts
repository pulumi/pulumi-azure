...
export class VirtualNetworkPeering extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualNetworkPeeringState): VirtualNetworkPeering {
        return new VirtualNetworkPeering(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: VirtualNetworkPeeringArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VirtualNetworkPeeringArgs | VirtualNetworkPeeringState, opts?: pulumi.ResourceOptions) {
