...
export class SrvRecord extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: SrvRecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SrvRecordArgs | SrvRecordState, opts?: pulumi.ResourceOptions) {
