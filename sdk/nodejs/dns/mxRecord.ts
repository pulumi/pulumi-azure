...
export class MxRecord extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MxRecordState): MxRecord {
        return new MxRecord(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: MxRecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: MxRecordArgs | MxRecordState, opts?: pulumi.ResourceOptions) {
