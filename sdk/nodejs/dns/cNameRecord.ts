...
export class CNameRecord extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: CNameRecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: CNameRecordArgs | CNameRecordState, opts?: pulumi.ResourceOptions) {
