...
export class TxtRecord extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TxtRecordState): TxtRecord {
        return new TxtRecord(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: TxtRecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TxtRecordArgs | TxtRecordState, opts?: pulumi.ResourceOptions) {
...
export interface TxtRecordState {
     ...
     * A list of values that make up the txt record. Each `record` block supports fields documented below.
     */
    readonly records?: pulumi.Input<{ value: pulumi.Input<string> }[]>;
    /**
     * Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
     */
