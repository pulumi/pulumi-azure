...
export class ARecord extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ARecordState): ARecord {
        return new ARecord(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ARecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ARecordArgs | ARecordState, opts?: pulumi.ResourceOptions) {
