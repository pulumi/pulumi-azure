...
export class CaaRecord extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CaaRecordState): CaaRecord {
        return new CaaRecord(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: CaaRecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: CaaRecordArgs | CaaRecordState, opts?: pulumi.ResourceOptions) {
