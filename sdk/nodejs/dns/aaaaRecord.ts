...
export class AaaaRecord extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AaaaRecordState): AaaaRecord {
        return new AaaaRecord(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AaaaRecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AaaaRecordArgs | AaaaRecordState, opts?: pulumi.ResourceOptions) {
