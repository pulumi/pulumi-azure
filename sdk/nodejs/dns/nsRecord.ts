...
export class NsRecord extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: NsRecordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NsRecordArgs | NsRecordState, opts?: pulumi.ResourceOptions) {
