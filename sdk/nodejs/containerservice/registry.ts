...
export class Registry extends pulumi.CustomResource {
    ...
    public readonly storageAccount!: pulumi.Output<outputApi.containerservice.RegistryStorageAccount | undefined>;
    /**
...
export interface RegistryState {
    ...
    readonly storageAccount?: pulumi.Input<inputApi.containerservice.RegistryStorageAccount>;
    /**
     * The ID of a Storage Account which must be located in the same Azure Region as the Container Registry.
     */
