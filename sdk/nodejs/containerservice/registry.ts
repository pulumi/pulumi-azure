...
export class Registry extends pulumi.CustomResource {
     ...
     */
    public readonly networkRuleSet!: pulumi.Output<{ defaultAction?: string, ipRules?: { action: string, ipRange: string }[] }>;
    /**
...
export interface RegistryState {
     ...
     * A `network_rule_set` block as documented below.
     */
    readonly networkRuleSet?: pulumi.Input<{ defaultAction?: pulumi.Input<string>, ipRules?: pulumi.Input<pulumi.Input<{ action: pulumi.Input<string>, ipRange: pulumi.Input<string> }>[]> }>;
    /**
     * The name of the resource group in which to create the Container Registry. Changing this forces a new resource to be created.
     */
