 ...
 * });
 * const exampleFluxConfiguration = new azure.containerservice/fluxConfiguration.FluxConfiguration("example", {
 *     name: "example-fc",
 *     clusterId: test.id,
 *     namespace: "flux",
 *     gitRepository: {
...
export class FluxConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly blobStorage!: pulumi.Output<outputs.containerservice.FluxConfigurationBlobStorage | undefined>;
    /**
     * A `bucket` block as defined below.
     */
    public readonly bucket!: pulumi.Output<outputs.containerservice.FluxConfigurationBucket | undefined>;
    /**
     ...
     */
    public readonly gitRepository!: pulumi.Output<outputs.containerservice.FluxConfigurationGitRepository | undefined>;
    /**
     * A `kustomizations` block as defined below.
     */
    public readonly kustomizations!: pulumi.Output<outputs.containerservice.FluxConfigurationKustomization[]>;
    /**
