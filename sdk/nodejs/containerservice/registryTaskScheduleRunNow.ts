 ...
 *     },
 * });
 * const exampleRegistryTaskScheduleRunNow = new azure.containerservice/registryTaskScheduleRunNow.RegistryTaskScheduleRunNow("example", {containerRegistryTaskId: exampleRegistryTask.id});
 * ```
 */
