 ...
 *     networkSecurityGroupId: exampleNetworkSecurityGroup.id,
 * });
 * const exampleNextGenerationFirewallVirtualNetworkPanorama = new azure.paloalto/nextGenerationFirewallVirtualNetworkPanorama.NextGenerationFirewallVirtualNetworkPanorama("example", {
 *     name: "example-ngfwvh",
 *     resourceGroupName: example.name,
 *     location: example.location,
