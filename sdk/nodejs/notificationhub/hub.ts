...
export class Hub extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HubState): Hub {
        return new Hub(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: HubArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: HubArgs | HubState, opts?: pulumi.ResourceOptions) {
