...
export class WindowsVirtualMachine extends pulumi.CustomResource {
     ...
     */
    public readonly galleryImageReference!: pulumi.Output<outputApi.devtest.WindowsVirtualMachineGalleryImageReference>;
    /**
     * One or more `inboundNatRule` blocks as defined below. Changing this forces a new resource to be created.
     */
    public readonly inboundNatRules!: pulumi.Output<outputApi.devtest.WindowsVirtualMachineInboundNatRule[] | undefined>;
    /**
...
export interface WindowsVirtualMachineState {
     ...
     * A `galleryImageReference` block as defined below.
     */
    readonly galleryImageReference?: pulumi.Input<inputApi.devtest.WindowsVirtualMachineGalleryImageReference>;
    /**
     * One or more `inboundNatRule` blocks as defined below. Changing this forces a new resource to be created.
     */
    readonly inboundNatRules?: pulumi.Input<pulumi.Input<inputApi.devtest.WindowsVirtualMachineInboundNatRule>[]>;
    /**
     * Specifies the name of the Dev Test Lab in which the Virtual Machine should be created. Changing this forces a new resource to be created.
     */
