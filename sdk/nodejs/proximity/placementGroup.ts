...
export class PlacementGroup extends pulumi.CustomResource {
     ...
     */
    declare public readonly allowedVmSizes: pulumi.Output<string[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: PlacementGroupArgs | PlacementGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["allowedVmSizes"] = state?.allowedVmSizes;
            ...
            resourceInputs["allowedVmSizes"] = args?.allowedVmSizes;
