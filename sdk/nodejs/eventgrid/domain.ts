...
export class Domain extends pulumi.CustomResource {
     ...
     */
    declare public readonly identity: pulumi.Output<outputs.eventgrid.DomainIdentity | undefined>;
    /**
     * One or more `inboundIpRule` blocks as defined below.
     */
    declare public readonly inboundIpRules: pulumi.Output<outputs.eventgrid.DomainInboundIpRule[] | undefined>;
    /**
     * A `inputMappingDefaultValues` block as defined below. Changing this forces a new resource to be created.
     */
    declare public readonly inputMappingDefaultValues: pulumi.Output<outputs.eventgrid.DomainInputMappingDefaultValues | undefined>;
    /**
     * A `inputMappingFields` block as defined below. Changing this forces a new resource to be created.
     */
    declare public readonly inputMappingFields: pulumi.Output<outputs.eventgrid.DomainInputMappingFields | undefined>;
    /**
...
export interface DomainState {
     ...
     * An `identity` block as defined below.
     */
    identity?: pulumi.Input<inputs.eventgrid.DomainIdentity | undefined>;
    /**
     * One or more `inboundIpRule` blocks as defined below.
     */
    inboundIpRules?: pulumi.Input<pulumi.Input<inputs.eventgrid.DomainInboundIpRule>[] | undefined>;
    /**
     * A `inputMappingDefaultValues` block as defined below. Changing this forces a new resource to be created.
     */
    inputMappingDefaultValues?: pulumi.Input<inputs.eventgrid.DomainInputMappingDefaultValues | undefined>;
    /**
     * A `inputMappingFields` block as defined below. Changing this forces a new resource to be created.
     */
    inputMappingFields?: pulumi.Input<inputs.eventgrid.DomainInputMappingFields | undefined>;
    /**
     * Specifies the schema in which incoming events will be published to this domain. Allowed values are `CloudEventSchemaV1_0`, `CustomEventSchema`, or `EventGridSchema`. Defaults to `EventGridSchema`. Changing this forces a new resource to be created.
     */
