...
export class Endpoint extends pulumi.CustomResource {
     ...
     */
    public readonly customHeaders!: pulumi.Output<{ name: string, value: string }[] | undefined>;
    /**
     ...
     */
    public readonly subnets!: pulumi.Output<{ first: string, last?: string, scope?: number }[] | undefined>;
    /**
...
export interface EndpointState {
     ...
     * One or more `custom_header` blocks as defined below
     */
    readonly customHeaders?: pulumi.Input<pulumi.Input<{ name: pulumi.Input<string>, value: pulumi.Input<string> }>[]>;
    /**
     * Specifies the Azure location of the Endpoint,
     * this must be specified for Profiles using the `Performance` routing method
     * if the Endpoint is of either type `nestedEndpoints` or `externalEndpoints`.
     ...
     * One or more `subnet` blocks as defined below
     */
    readonly subnets?: pulumi.Input<pulumi.Input<{ first: pulumi.Input<string>, last?: pulumi.Input<string>, scope?: pulumi.Input<number> }>[]>;
    /**
     * The FQDN DNS name of the target. This argument must be
     * provided for an endpoint of type `externalEndpoints`, for other types it
     * will be computed.
