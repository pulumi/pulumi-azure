 ...
 * });
 * const exampleResourceGroupCostManagementExport = new azure.core/resourceGroupCostManagementExport.ResourceGroupCostManagementExport("example", {
 *     name: "example",
...
export class ResourceGroupCostManagementExport extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure:core/resourceGroupCostManagementExport:ResourceGroupCostManagementExport';
     ...
     */
    public readonly exportDataOptions!: pulumi.Output<outputs.core.ResourceGroupCostManagementExportExportDataOptions>;
    /**
     * A `exportDataStorageLocation` block as defined below.
     */
    public readonly exportDataStorageLocation!: pulumi.Output<outputs.core.ResourceGroupCostManagementExportExportDataStorageLocation>;
    /**
