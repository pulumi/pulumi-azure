...
export class ManangementLock extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManangementLockState): ManangementLock {
        return new ManangementLock(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ManangementLockArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ManangementLockArgs | ManangementLockState, opts?: pulumi.ResourceOptions) {
