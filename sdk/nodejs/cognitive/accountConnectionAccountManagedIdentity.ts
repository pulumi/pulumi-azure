 ...
 * ```
 */
export class AccountConnectionAccountManagedIdentity extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccountConnectionAccountManagedIdentityState, opts?: pulumi.CustomResourceOptions): AccountConnectionAccountManagedIdentity {
        return new AccountConnectionAccountManagedIdentity(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure:cognitive/accountConnectionAccountManagedIdentity:AccountConnectionAccountManagedIdentity';

    /**
     * Returns true if the given object is an instance of AccountConnectionAccountManagedIdentity.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AccountConnectionAccountManagedIdentity {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AccountConnectionAccountManagedIdentity.__pulumiType;
    }
    ...
    /**
     * Create a AccountConnectionAccountManagedIdentity resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AccountConnectionAccountManagedIdentityArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AccountConnectionAccountManagedIdentityArgs | AccountConnectionAccountManagedIdentityState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AccountConnectionAccountManagedIdentityState | undefined;
            ...
            const args = argsOrState as AccountConnectionAccountManagedIdentityArgs | undefined;
        ...
        super(AccountConnectionAccountManagedIdentity.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AccountConnectionAccountManagedIdentityState {
    /**
     * The category of the connection. Possible values are `AIServices`, `AzureKeyVault`, `AzureOpenAI`, and `AzureStorageAccount`. Changing this forces a new resource to be created.
     *
     * > **Note:** Only one Account Managed Identity connection with the `AzureKeyVault` category can exist per Cognitive Services Account.
 ...
 */
export interface AccountConnectionAccountManagedIdentityArgs {
    /**
     * The category of the connection. Possible values are `AIServices`, `AzureKeyVault`, `AzureOpenAI`, and `AzureStorageAccount`. Changing this forces a new resource to be created.
     *
     * > **Note:** Only one Account Managed Identity connection with the `AzureKeyVault` category can exist per Cognitive Services Account.
