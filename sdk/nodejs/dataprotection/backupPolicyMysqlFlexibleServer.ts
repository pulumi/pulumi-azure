 ...
 * ```
 */
export class BackupPolicyMysqlFlexibleServer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackupPolicyMysqlFlexibleServerState, opts?: pulumi.CustomResourceOptions): BackupPolicyMysqlFlexibleServer {
        return new BackupPolicyMysqlFlexibleServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure:dataprotection/backupPolicyMysqlFlexibleServer:BackupPolicyMysqlFlexibleServer';
     ...
     */
    public static isInstance(obj: any): obj is BackupPolicyMysqlFlexibleServer {
     ...
     */
    declare public readonly defaultRetentionRule: pulumi.Output<outputs.dataprotection.BackupPolicyMysqlFlexibleServerDefaultRetentionRule>;
    /**
     ...
     */
    declare public readonly retentionRules: pulumi.Output<outputs.dataprotection.BackupPolicyMysqlFlexibleServerRetentionRule[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: BackupPolicyMysqlFlexibleServerArgs | BackupPolicyMysqlFlexibleServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as BackupPolicyMysqlFlexibleServerState | undefined;
            ...
            const args = argsOrState as BackupPolicyMysqlFlexibleServerArgs | undefined;
