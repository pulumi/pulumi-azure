 ...
 * 
 * const azurerm_scheduler_job_collection_test = pulumi.output(azure.scheduler.getJobCollection({
 *     name: "tfex-job-collection",
 *     resourceGroupName: "tfex-job-collection-rg",
 * }));
 * 
 * export const jobCollectionState = azurerm_scheduler_job_collection_jobs.state.apply(__arg0 => __arg0%!v(PANIC=interface conversion: il.Node is nil, not *il.ResourceNode));
 * ```
 */
