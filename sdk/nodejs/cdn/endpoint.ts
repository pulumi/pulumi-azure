...
export class Endpoint extends pulumi.CustomResource {
     ...
     */
    public readonly geoFilters!: pulumi.Output<outputApi.cdn.EndpointGeoFilter[] | undefined>;
     ...
     */
    public readonly origins!: pulumi.Output<outputApi.cdn.EndpointOrigin[]>;
    /**
...
export interface EndpointState {
     ...
     * A set of Geo Filters for this CDN Endpoint. Each `geoFilter` block supports fields documented below.
     */
    readonly geoFilters?: pulumi.Input<pulumi.Input<inputApi.cdn.EndpointGeoFilter>[]>;
     ...
     * The set of origins of the CDN endpoint. When multiple origins exist, the first origin will be used as primary and rest will be used as failover options. Each `origin` block supports fields documented below.
     */
    readonly origins?: pulumi.Input<pulumi.Input<inputApi.cdn.EndpointOrigin>[]>;
    /**
     * The host header CDN provider will send along with content requests to origins. Defaults to the host name of the origin.
     */
