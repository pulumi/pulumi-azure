...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    public readonly azureActiveDirectory!: pulumi.Output<outputApi.servicefabric.ClusterAzureActiveDirectory | undefined>;
    /**
     * A `certificate` block as defined below. Conflicts with `certificateCommonNames`.
     */
    public readonly certificate!: pulumi.Output<outputApi.servicefabric.ClusterCertificate | undefined>;
    /**
     * A `certificateCommonNames` block as defined below. Conflicts with `certificate`.
     */
    public readonly certificateCommonNames!: pulumi.Output<outputApi.servicefabric.ClusterCertificateCommonNames | undefined>;
    /**
     * One or two `clientCertificateThumbprint` blocks as defined below.
     */
    public readonly clientCertificateThumbprints!: pulumi.Output<outputApi.servicefabric.ClusterClientCertificateThumbprint[] | undefined>;
    /**
     ...
     */
    public readonly diagnosticsConfig!: pulumi.Output<outputApi.servicefabric.ClusterDiagnosticsConfig | undefined>;
    /**
     * One or more `fabricSettings` blocks as defined below.
     */
    public readonly fabricSettings!: pulumi.Output<outputApi.servicefabric.ClusterFabricSetting[] | undefined>;
    /**
     ...
     */
    public readonly nodeTypes!: pulumi.Output<outputApi.servicefabric.ClusterNodeType[]>;
    /**
     ...
     */
    public readonly reverseProxyCertificate!: pulumi.Output<outputApi.servicefabric.ClusterReverseProxyCertificate | undefined>;
    /**
...
export interface ClusterState {
     ...
     * An `azureActiveDirectory` block as defined below.
     */
    readonly azureActiveDirectory?: pulumi.Input<inputApi.servicefabric.ClusterAzureActiveDirectory>;
    /**
     * A `certificate` block as defined below. Conflicts with `certificateCommonNames`.
     */
    readonly certificate?: pulumi.Input<inputApi.servicefabric.ClusterCertificate>;
    /**
     * A `certificateCommonNames` block as defined below. Conflicts with `certificate`.
     */
    readonly certificateCommonNames?: pulumi.Input<inputApi.servicefabric.ClusterCertificateCommonNames>;
    /**
     * One or two `clientCertificateThumbprint` blocks as defined below.
     */
    readonly clientCertificateThumbprints?: pulumi.Input<pulumi.Input<inputApi.servicefabric.ClusterClientCertificateThumbprint>[]>;
    /**
     * Required if Upgrade Mode set to `Manual`, Specifies the Version of the Cluster Code of the cluster.
     */
     ...
     * A `diagnosticsConfig` block as defined below. Changing this forces a new resource to be created.
     */
    readonly diagnosticsConfig?: pulumi.Input<inputApi.servicefabric.ClusterDiagnosticsConfig>;
    /**
     * One or more `fabricSettings` blocks as defined below.
     */
    readonly fabricSettings?: pulumi.Input<pulumi.Input<inputApi.servicefabric.ClusterFabricSetting>[]>;
    /**
     * Specifies the Azure Region where the Service Fabric Cluster should exist. Changing this forces a new resource to be created.
     */
     ...
     * One or more `nodeType` blocks as defined below.
     */
    readonly nodeTypes?: pulumi.Input<pulumi.Input<inputApi.servicefabric.ClusterNodeType>[]>;
    /**
     * Specifies the Reliability Level of the Cluster. Possible values include `None`, `Bronze`, `Silver`, `Gold` and `Platinum`.
     */
     ...
     * A `reverseProxyCertificate` block as defined below.
     */
    readonly reverseProxyCertificate?: pulumi.Input<inputApi.servicefabric.ClusterReverseProxyCertificate>;
    /**
     * A mapping of tags to assign to the resource.
     */
