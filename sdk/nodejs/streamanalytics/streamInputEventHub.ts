...
export class StreamInputEventHub extends pulumi.CustomResource {
     ...
     */
    public readonly serialization!: pulumi.Output<outputApi.streamanalytics.StreamInputEventHubSerialization>;
    /**
...
export interface StreamInputEventHubState {
     ...
     * A `serialization` block as defined below.
     */
    readonly serialization?: pulumi.Input<inputApi.streamanalytics.StreamInputEventHubSerialization>;
    /**
     * The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
     */
