...
export class OutputServiceBusQueue extends pulumi.CustomResource {
     ...
     */
    public readonly serialization!: pulumi.Output<outputApi.streamanalytics.OutputServiceBusQueueSerialization>;
    /**
...
export interface OutputServiceBusQueueState {
     ...
     * A `serialization` block as defined below.
     */
    readonly serialization?: pulumi.Input<inputApi.streamanalytics.OutputServiceBusQueueSerialization>;
    /**
     * The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
     */
