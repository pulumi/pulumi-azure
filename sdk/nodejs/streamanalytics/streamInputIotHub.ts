...
export class StreamInputIotHub extends pulumi.CustomResource {
     ...
     */
    public readonly serialization!: pulumi.Output<outputApi.streamanalytics.StreamInputIotHubSerialization>;
    /**
...
export interface StreamInputIotHubState {
     ...
     * A `serialization` block as defined below.
     */
    readonly serialization?: pulumi.Input<inputApi.streamanalytics.StreamInputIotHubSerialization>;
    /**
     * The shared access policy key for the specified shared access policy.
     */
