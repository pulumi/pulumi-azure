...
export class StreamInputBlob extends pulumi.CustomResource {
     ...
     */
    declare public readonly serialization: pulumi.Output<outputs.streamanalytics.StreamInputBlobSerialization>;
    /**
...
export interface StreamInputBlobState {
     ...
     * A `serialization` block as defined below.
     */
    serialization?: pulumi.Input<inputs.streamanalytics.StreamInputBlobSerialization | undefined>;
    /**
     * The Access Key which should be used to connect to this Storage Account.
     */
