 ...
 * });
 * const examplePrivateLink = new azure.management/privateLink.PrivateLink("example", {
 *     name: "example",
...
export class PrivateLink extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure:management/privateLink:PrivateLink';
