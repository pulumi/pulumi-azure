...
export class Insights extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InsightsState): Insights {
        return new Insights(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: InsightsArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: InsightsArgs | InsightsState, opts?: pulumi.ResourceOptions) {
