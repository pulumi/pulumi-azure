...
export class ServicePrincipalPassword extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServicePrincipalPasswordState): ServicePrincipalPassword {
        return new ServicePrincipalPassword(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ServicePrincipalPasswordArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ServicePrincipalPasswordArgs | ServicePrincipalPasswordState, opts?: pulumi.ResourceOptions) {
