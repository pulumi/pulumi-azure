...
export class ServicePrincipal extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ServicePrincipalArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ServicePrincipalArgs | ServicePrincipalState, opts?: pulumi.ResourceOptions) {
