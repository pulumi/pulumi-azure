...
export class TriggerCustom extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TriggerCustomState): TriggerCustom {
        return new TriggerCustom(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: TriggerCustomArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TriggerCustomArgs | TriggerCustomState, opts?: pulumi.ResourceOptions) {
