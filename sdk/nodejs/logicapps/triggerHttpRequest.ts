...
export class TriggerHttpRequest extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TriggerHttpRequestState): TriggerHttpRequest {
        return new TriggerHttpRequest(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: TriggerHttpRequestArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TriggerHttpRequestArgs | TriggerHttpRequestState, opts?: pulumi.ResourceOptions) {
