...
export class ActionCustom extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ActionCustomArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ActionCustomArgs | ActionCustomState, opts?: pulumi.ResourceOptions) {
