...
export class Assignment extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: AssignmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AssignmentArgs | AssignmentState, opts?: pulumi.ResourceOptions) {
