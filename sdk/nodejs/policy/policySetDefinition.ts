...
export class PolicySetDefinition extends pulumi.CustomResource {
     ...
     */
    declare public readonly policyDefinitionGroups: pulumi.Output<outputs.policy.PolicySetDefinitionPolicyDefinitionGroup[] | undefined>;
    /**
     * One or more `policyDefinitionReference` blocks as defined below.
     */
    declare public readonly policyDefinitionReferences: pulumi.Output<outputs.policy.PolicySetDefinitionPolicyDefinitionReference[]>;
    /**
