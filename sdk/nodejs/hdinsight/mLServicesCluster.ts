...
export class MLServicesCluster extends pulumi.CustomResource {
     ...
     */
    public readonly gateway!: pulumi.Output<outputApi.hdinsight.MLServicesClusterGateway>;
    /**
     ...
     */
    public readonly roles!: pulumi.Output<outputApi.hdinsight.MLServicesClusterRoles>;
    /**
     ...
     */
    public readonly storageAccounts!: pulumi.Output<outputApi.hdinsight.MLServicesClusterStorageAccount[]>;
    /**
...
export interface MLServicesClusterState {
     ...
     * A `gateway` block as defined below.
     */
    readonly gateway?: pulumi.Input<inputApi.hdinsight.MLServicesClusterGateway>;
    /**
     * The HTTPS Connectivity Endpoint for this HDInsight ML Services Cluster.
     */
     ...
     * A `roles` block as defined below.
     */
    readonly roles?: pulumi.Input<inputApi.hdinsight.MLServicesClusterRoles>;
    /**
     * Should R Studio community edition for ML Services be installed? Changing this forces a new resource to be created.
     */
     ...
     * One or more `storageAccount` block as defined below.
     */
    readonly storageAccounts?: pulumi.Input<pulumi.Input<inputApi.hdinsight.MLServicesClusterStorageAccount>[]>;
    /**
     * A map of Tags which should be assigned to this HDInsight ML Services Cluster.
     */
