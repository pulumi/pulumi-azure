...
export interface SparkClusterState {
     ...
     * A `componentVersion` block as defined below.
     */
    componentVersion?: pulumi.Input<inputs.hdinsight.SparkClusterComponentVersion | undefined>;
    /**
     * A `computeIsolation` block as defined below.
     */
    computeIsolation?: pulumi.Input<inputs.hdinsight.SparkClusterComputeIsolation | undefined>;
    /**
     * One or more `diskEncryption` block as defined below.
     */
    diskEncryptions?: pulumi.Input<pulumi.Input<inputs.hdinsight.SparkClusterDiskEncryption>[] | undefined>;
    /**
     * Whether encryption in transit is enabled for this Cluster. Changing this forces a new resource to be created.
     */
     ...
     * An `extension` block as defined below.
     */
    extension?: pulumi.Input<inputs.hdinsight.SparkClusterExtension | undefined>;
    /**
     * A `gateway` block as defined below.
     */
    gateway?: pulumi.Input<inputs.hdinsight.SparkClusterGateway | undefined>;
    /**
     * The HTTPS Connectivity Endpoint for this HDInsight Spark Cluster.
     */
     ...
     * A `metastores` block as defined below.
     */
    metastores?: pulumi.Input<inputs.hdinsight.SparkClusterMetastores | undefined>;
    /**
     * A `monitor` block as defined below.
     */
    monitor?: pulumi.Input<inputs.hdinsight.SparkClusterMonitor | undefined>;
    /**
     * Specifies the name for this HDInsight Spark Cluster. Changing this forces a new resource to be created.
     */
     ...
     * A `network` block as defined below.
     */
    network?: pulumi.Input<inputs.hdinsight.SparkClusterNetwork | undefined>;
    /**
     * A `privateLinkConfiguration` block as defined below.
     */
    privateLinkConfiguration?: pulumi.Input<inputs.hdinsight.SparkClusterPrivateLinkConfiguration | undefined>;
    /**
     * Specifies the name of the Resource Group in which this HDInsight Spark Cluster should exist. Changing this forces a new resource to be created.
     */
     ...
     * A `roles` block as defined below.
     */
    roles?: pulumi.Input<inputs.hdinsight.SparkClusterRoles | undefined>;
    /**
     * A `securityProfile` block as defined below. Changing this forces a new resource to be created.
     */
    securityProfile?: pulumi.Input<inputs.hdinsight.SparkClusterSecurityProfile | undefined>;
    /**
     * The SSH Connectivity Endpoint for this HDInsight Spark Cluster.
     */
     ...
     * A `storageAccountGen2` block as defined below.
     */
    storageAccountGen2?: pulumi.Input<inputs.hdinsight.SparkClusterStorageAccountGen2 | undefined>;
    /**
     * One or more `storageAccount` block as defined below.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.hdinsight.SparkClusterStorageAccount>[] | undefined>;
    /**
     * A map of Tags which should be assigned to this HDInsight Spark Cluster.
     */
