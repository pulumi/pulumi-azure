...
export class KafkaCluster extends pulumi.CustomResource {
     ...
     */
    declare public readonly componentVersion: pulumi.Output<outputs.hdinsight.KafkaClusterComponentVersion>;
    /**
     ...
     */
    declare public readonly extension: pulumi.Output<outputs.hdinsight.KafkaClusterExtension | undefined>;
    /**
     * A `gateway` block as defined below.
     */
    declare public readonly gateway: pulumi.Output<outputs.hdinsight.KafkaClusterGateway>;
    /**
     ...
     */
    declare public /*out*/ readonly kafkaRestProxyEndpoint: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly metastores: pulumi.Output<outputs.hdinsight.KafkaClusterMetastores | undefined>;
    /**
     * A `monitor` block as defined below.
     */
    declare public readonly monitor: pulumi.Output<outputs.hdinsight.KafkaClusterMonitor | undefined>;
    /**
     ...
     */
    declare public readonly network: pulumi.Output<outputs.hdinsight.KafkaClusterNetwork | undefined>;
    /**
     * A `privateLinkConfiguration` block as defined below.
     */
    declare public readonly privateLinkConfiguration: pulumi.Output<outputs.hdinsight.KafkaClusterPrivateLinkConfiguration | undefined>;
    /**
     ...
     */
    declare public readonly restProxy: pulumi.Output<outputs.hdinsight.KafkaClusterRestProxy | undefined>;
    /**
     * A `roles` block as defined below.
     */
    declare public readonly roles: pulumi.Output<outputs.hdinsight.KafkaClusterRoles>;
    /**
     * A `securityProfile` block as defined below. Changing this forces a new resource to be created.
     */
    declare public readonly securityProfile: pulumi.Output<outputs.hdinsight.KafkaClusterSecurityProfile | undefined>;
    /**
     ...
     */
    declare public readonly storageAccountGen2: pulumi.Output<outputs.hdinsight.KafkaClusterStorageAccountGen2 | undefined>;
    /**
     * One or more `storageAccount` block as defined below.
     */
    declare public readonly storageAccounts: pulumi.Output<outputs.hdinsight.KafkaClusterStorageAccount[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: KafkaClusterArgs | KafkaClusterState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["kafkaRestProxyEndpoint"] = state?.kafkaRestProxyEndpoint;
            ...
            resourceInputs["restProxy"] = state?.restProxy;
            ...
            resourceInputs["restProxy"] = args?.restProxy;
...
export interface KafkaClusterState {
     ...
     * A `componentVersion` block as defined below.
     */
    componentVersion?: pulumi.Input<inputs.hdinsight.KafkaClusterComponentVersion | undefined>;
    /**
     * A `computeIsolation` block as defined below.
     */
     ...
     * An `extension` block as defined below.
     */
    extension?: pulumi.Input<inputs.hdinsight.KafkaClusterExtension | undefined>;
    /**
     * A `gateway` block as defined below.
     */
    gateway?: pulumi.Input<inputs.hdinsight.KafkaClusterGateway | undefined>;
    /**
     * The HTTPS Connectivity Endpoint for this HDInsight Kafka Cluster.
     */
     ...
     * The Kafka Rest Proxy Endpoint for this HDInsight Kafka Cluster.
     */
    kafkaRestProxyEndpoint?: pulumi.Input<string | undefined>;
    /**
     * Specifies the Azure Region which this HDInsight Kafka Cluster should exist. Changing this forces a new resource to be created.
     */
     ...
     * A `metastores` block as defined below.
     */
    metastores?: pulumi.Input<inputs.hdinsight.KafkaClusterMetastores | undefined>;
    /**
     * A `monitor` block as defined below.
     */
    monitor?: pulumi.Input<inputs.hdinsight.KafkaClusterMonitor | undefined>;
    /**
     * Specifies the name for this HDInsight Kafka Cluster. Changing this forces a new resource to be created.
     */
     ...
     * A `network` block as defined below.
     */
    network?: pulumi.Input<inputs.hdinsight.KafkaClusterNetwork | undefined>;
    /**
     * A `privateLinkConfiguration` block as defined below.
     */
    privateLinkConfiguration?: pulumi.Input<inputs.hdinsight.KafkaClusterPrivateLinkConfiguration | undefined>;
    /**
     * Specifies the name of the Resource Group in which this HDInsight Kafka Cluster should exist. Changing this forces a new resource to be created.
     */
     ...
     * A `restProxy` block as defined below.
     */
    restProxy?: pulumi.Input<inputs.hdinsight.KafkaClusterRestProxy | undefined>;
    /**
     * A `roles` block as defined below.
     */
    roles?: pulumi.Input<inputs.hdinsight.KafkaClusterRoles | undefined>;
    /**
     * A `securityProfile` block as defined below. Changing this forces a new resource to be created.
     */
    securityProfile?: pulumi.Input<inputs.hdinsight.KafkaClusterSecurityProfile | undefined>;
    /**
     * The SSH Connectivity Endpoint for this HDInsight Kafka Cluster.
     */
     ...
     * A `storageAccountGen2` block as defined below.
     */
    storageAccountGen2?: pulumi.Input<inputs.hdinsight.KafkaClusterStorageAccountGen2 | undefined>;
    /**
     * One or more `storageAccount` block as defined below.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.hdinsight.KafkaClusterStorageAccount>[] | undefined>;
    /**
     * A map of Tags which should be assigned to this HDInsight Kafka Cluster.
     */
