...
export class IoTHub extends pulumi.CustomResource {
     ...
     */
    public readonly endpoints!: pulumi.Output<outputApi.iot.IoTHubEndpoint[] | undefined>;
    /**
     ...
     */
    public readonly fallbackRoute!: pulumi.Output<outputApi.iot.IoTHubFallbackRoute>;
    /**
     ...
     */
    public readonly ipFilterRules!: pulumi.Output<outputApi.iot.IoTHubIpFilterRule[] | undefined>;
    /**
     ...
     */
    public readonly routes!: pulumi.Output<outputApi.iot.IoTHubRoute[] | undefined>;
    /**
     * One or more `sharedAccessPolicy` blocks as defined below.
     */
    public /*out*/ readonly sharedAccessPolicies!: pulumi.Output<outputApi.iot.IoTHubSharedAccessPolicy[]>;
    /**
     * A `sku` block as defined below.
     */
    public readonly sku!: pulumi.Output<outputApi.iot.IoTHubSku>;
    /**
...
export interface IoTHubState {
     ...
     * An `endpoint` block as defined below.
     */
    readonly endpoints?: pulumi.Input<pulumi.Input<inputApi.iot.IoTHubEndpoint>[]>;
    /**
     * The EventHub compatible endpoint for events data
     */
     ...
     * A `fallbackRoute` block as defined below. If the fallback route is enabled, messages that don't match any of the supplied routes are automatically sent to this route. Defaults to messages/events.
     */
    readonly fallbackRoute?: pulumi.Input<inputApi.iot.IoTHubFallbackRoute>;
    /**
     * The hostname of the IotHub Resource.
     */
     ...
     * One or more `ipFilterRule` blocks as defined below.
     */
    readonly ipFilterRules?: pulumi.Input<pulumi.Input<inputApi.iot.IoTHubIpFilterRule>[]>;
    /**
     * Specifies the supported Azure location where the resource has to be createc. Changing this forces a new resource to be created.
     */
     ...
     * A `route` block as defined below.
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputApi.iot.IoTHubRoute>[]>;
    /**
     * One or more `sharedAccessPolicy` blocks as defined below.
     */
    readonly sharedAccessPolicies?: pulumi.Input<pulumi.Input<inputApi.iot.IoTHubSharedAccessPolicy>[]>;
    /**
     * A `sku` block as defined below.
     */
    readonly sku?: pulumi.Input<inputApi.iot.IoTHubSku>;
    /**
     * A mapping of tags to assign to the resource.
     */
