...
export class RunBook extends pulumi.CustomResource {
     ...
     */
    public readonly publishContentLink!: pulumi.Output<outputApi.automation.RunBookPublishContentLink>;
    /**
...
export interface RunBookState {
     ...
     * The published runbook content link.
     */
    readonly publishContentLink?: pulumi.Input<inputApi.automation.RunBookPublishContentLink>;
    /**
     * The name of the resource group in which the Runbook is created. Changing this forces a new resource to be created.
     */
