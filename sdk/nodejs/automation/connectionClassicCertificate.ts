...
export class ConnectionClassicCertificate extends pulumi.CustomResource {
     ...
     */
    declare public readonly certificateAssetName: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: ConnectionClassicCertificateArgs | ConnectionClassicCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["certificateAssetName"] = state?.certificateAssetName;
            ...
            if (args?.certificateAssetName === undefined && !opts.urn) {
            ...
            resourceInputs["certificateAssetName"] = args?.certificateAssetName;
