...
export class AnalyticsFirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AnalyticsFirewallRuleState): AnalyticsFirewallRule {
        return new AnalyticsFirewallRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AnalyticsFirewallRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AnalyticsFirewallRuleArgs | AnalyticsFirewallRuleState, opts?: pulumi.ResourceOptions) {
