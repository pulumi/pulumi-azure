...
export class StoreFile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StoreFileState): StoreFile {
        return new StoreFile(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: StoreFileArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: StoreFileArgs | StoreFileState, opts?: pulumi.ResourceOptions) {
