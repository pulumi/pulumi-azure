...
export class AnalyticsAccount extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AnalyticsAccountState): AnalyticsAccount {
        return new AnalyticsAccount(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AnalyticsAccountArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AnalyticsAccountArgs | AnalyticsAccountState, opts?: pulumi.ResourceOptions) {
