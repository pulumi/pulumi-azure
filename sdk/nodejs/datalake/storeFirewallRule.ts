...
export class StoreFirewallRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StoreFirewallRuleState): StoreFirewallRule {
        return new StoreFirewallRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: StoreFirewallRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: StoreFirewallRuleArgs | StoreFirewallRuleState, opts?: pulumi.ResourceOptions) {
