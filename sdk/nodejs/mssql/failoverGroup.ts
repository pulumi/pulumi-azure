 ...
 * });
 * const primary = new azure.mssql/server.Server("primary", {
 ...
 * });
 * const secondary = new azure.mssql/server.Server("secondary", {
 ...
 *     maxSizeGb: "200",
 * });
 * const exampleFailoverGroup = new azure.mssql/failoverGroup.FailoverGroup("example", {
 *     name: "example",
 *     serverId: primary.id,
