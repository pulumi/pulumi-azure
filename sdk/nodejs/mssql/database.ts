...
export class Database extends pulumi.CustomResource {
     ...
     */
    declare public readonly autoPauseDelayInMinutes: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly creationSourceDatabaseId: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly geoBackupEnabled: pulumi.Output<boolean | undefined>;
    /**
     * An `identity` block as defined below.
     */
    declare public readonly identity: pulumi.Output<outputs.mssql.DatabaseIdentity | undefined>;
    /**
     * A `import` block as documented below. Mutually exclusive with `createMode`.
     */
    declare public readonly import: pulumi.Output<outputs.mssql.DatabaseImport | undefined>;
    /**
     ...
     */
    declare public readonly ledgerEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly longTermRetentionPolicy: pulumi.Output<outputs.mssql.DatabaseLongTermRetentionPolicy>;
    /**
     ...
     */
    declare public readonly maintenanceConfigurationName: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly readReplicaCount: pulumi.Output<number>;
    /**
     * If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica. This property is only settable for Premium and Business Critical databases.
     */
    declare public readonly readScale: pulumi.Output<boolean>;
    /**
     * The ID of the database to be recovered. This property is only applicable when the `createMode` is `Recovery`.
     */
    declare public readonly recoverDatabaseId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly restoreDroppedDatabaseId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly restoreLongTermRetentionBackupId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly restorePointInTime: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly secondaryType: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly shortTermRetentionPolicy: pulumi.Output<outputs.mssql.DatabaseShortTermRetentionPolicy>;
    /**
     ...
     */
    declare public readonly threatDetectionPolicy: pulumi.Output<outputs.mssql.DatabaseThreatDetectionPolicy>;
    /**
     ...
     */
    declare public readonly transparentDataEncryptionEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly transparentDataEncryptionKeyAutomaticRotationEnabled: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    declare public readonly zoneRedundant: pulumi.Output<boolean>;
    ...
    constructor(name: string, argsOrState?: DatabaseArgs | DatabaseState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["autoPauseDelayInMinutes"] = state?.autoPauseDelayInMinutes;
            resourceInputs["collation"] = state?.collation;
            resourceInputs["createMode"] = state?.createMode;
            resourceInputs["creationSourceDatabaseId"] = state?.creationSourceDatabaseId;
            resourceInputs["elasticPoolId"] = state?.elasticPoolId;
            resourceInputs["enclaveType"] = state?.enclaveType;
            resourceInputs["geoBackupEnabled"] = state?.geoBackupEnabled;
            resourceInputs["identity"] = state?.identity;
            resourceInputs["import"] = state?.import;
            resourceInputs["ledgerEnabled"] = state?.ledgerEnabled;
            ...
            resourceInputs["readScale"] = state?.readScale;
            resourceInputs["recoverDatabaseId"] = state?.recoverDatabaseId;
            resourceInputs["recoveryPointId"] = state?.recoveryPointId;
            resourceInputs["restoreDroppedDatabaseId"] = state?.restoreDroppedDatabaseId;
            resourceInputs["restoreLongTermRetentionBackupId"] = state?.restoreLongTermRetentionBackupId;
            ...
            resourceInputs["shortTermRetentionPolicy"] = state?.shortTermRetentionPolicy;
            ...
            resourceInputs["transparentDataEncryptionEnabled"] = state?.transparentDataEncryptionEnabled;
            resourceInputs["transparentDataEncryptionKeyAutomaticRotationEnabled"] = state?.transparentDataEncryptionKeyAutomaticRotationEnabled;
            ...
            resourceInputs["autoPauseDelayInMinutes"] = args?.autoPauseDelayInMinutes;
            resourceInputs["collation"] = args?.collation;
            resourceInputs["createMode"] = args?.createMode;
            resourceInputs["creationSourceDatabaseId"] = args?.creationSourceDatabaseId;
            resourceInputs["elasticPoolId"] = args?.elasticPoolId;
            resourceInputs["enclaveType"] = args?.enclaveType;
            resourceInputs["geoBackupEnabled"] = args?.geoBackupEnabled;
            resourceInputs["identity"] = args?.identity;
            resourceInputs["import"] = args?.import;
            resourceInputs["ledgerEnabled"] = args?.ledgerEnabled;
            ...
            resourceInputs["recoverDatabaseId"] = args?.recoverDatabaseId;
            resourceInputs["recoveryPointId"] = args?.recoveryPointId;
            resourceInputs["restoreDroppedDatabaseId"] = args?.restoreDroppedDatabaseId;
            resourceInputs["restoreLongTermRetentionBackupId"] = args?.restoreLongTermRetentionBackupId;
            ...
            resourceInputs["shortTermRetentionPolicy"] = args?.shortTermRetentionPolicy;
            ...
            resourceInputs["transparentDataEncryptionEnabled"] = args?.transparentDataEncryptionEnabled;
            resourceInputs["transparentDataEncryptionKeyAutomaticRotationEnabled"] = args?.transparentDataEncryptionKeyAutomaticRotationEnabled;
...
export interface DatabaseState {
     ...
     * Time in minutes after which database is automatically paused. A value of `-1` means that automatic pause is disabled. This property is only settable for Serverless databases.
     */
    autoPauseDelayInMinutes?: pulumi.Input<number | undefined>;
    /**
     * Specifies the collation of the database. Changing this forces a new resource to be created.
     */
     ...
     * > **Note:** When configuring a secondary database, please be aware of the constraints for the `skuName` property, as noted below, for both the primary and secondary databases. The `skuName` of the secondary database may be inadvertently changed to match that of the primary when an incompatible combination of SKUs is detected by the provider.
     */
    creationSourceDatabaseId?: pulumi.Input<string | undefined>;
    /**
     * Specifies the ID of the elastic pool containing this database.
     */
     ...
     * > **Note:** `geoBackupEnabled` is only applicable for DataWarehouse SKUs (DW*). This setting is ignored for all other SKUs.
     */
    geoBackupEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * An `identity` block as defined below.
     */
    identity?: pulumi.Input<inputs.mssql.DatabaseIdentity | undefined>;
    /**
     * A `import` block as documented below. Mutually exclusive with `createMode`.
     */
    import?: pulumi.Input<inputs.mssql.DatabaseImport | undefined>;
    /**
     * A boolean that specifies if this is a ledger database. Defaults to `false`. Changing this forces a new resource to be created.
     */
    ledgerEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * Specifies the license type applied to this database. Possible values are `LicenseIncluded` and `BasePrice`.
     */
     ...
     * A `longTermRetentionPolicy` block as defined below.
     */
    longTermRetentionPolicy?: pulumi.Input<inputs.mssql.DatabaseLongTermRetentionPolicy | undefined>;
    /**
     * The name of the Public Maintenance Configuration window to apply to the database. Valid values include `SQL_Default`, `SQL_EastUS_DB_1`, `SQL_EastUS2_DB_1`, `SQL_SoutheastAsia_DB_1`, `SQL_AustraliaEast_DB_1`, `SQL_NorthEurope_DB_1`, `SQL_SouthCentralUS_DB_1`, `SQL_WestUS2_DB_1`, `SQL_UKSouth_DB_1`, `SQL_WestEurope_DB_1`, `SQL_EastUS_DB_2`, `SQL_EastUS2_DB_2`, `SQL_WestUS2_DB_2`, `SQL_SoutheastAsia_DB_2`, `SQL_AustraliaEast_DB_2`, `SQL_NorthEurope_DB_2`, `SQL_SouthCentralUS_DB_2`, `SQL_UKSouth_DB_2`, `SQL_WestEurope_DB_2`, `SQL_AustraliaSoutheast_DB_1`, `SQL_BrazilSouth_DB_1`, `SQL_CanadaCentral_DB_1`, `SQL_CanadaEast_DB_1`, `SQL_CentralUS_DB_1`, `SQL_EastAsia_DB_1`, `SQL_FranceCentral_DB_1`, `SQL_GermanyWestCentral_DB_1`, `SQL_CentralIndia_DB_1`, `SQL_SouthIndia_DB_1`, `SQL_JapanEast_DB_1`, `SQL_JapanWest_DB_1`, `SQL_NorthCentralUS_DB_1`, `SQL_UKWest_DB_1`, `SQL_WestUS_DB_1`, `SQL_AustraliaSoutheast_DB_2`, `SQL_BrazilSouth_DB_2`, `SQL_CanadaCentral_DB_2`, `SQL_CanadaEast_DB_2`, `SQL_CentralUS_DB_2`, `SQL_EastAsia_DB_2`, `SQL_FranceCentral_DB_2`, `SQL_GermanyWestCentral_DB_2`, `SQL_CentralIndia_DB_2`, `SQL_SouthIndia_DB_2`, `SQL_JapanEast_DB_2`, `SQL_JapanWest_DB_2`, `SQL_NorthCentralUS_DB_2`, `SQL_UKWest_DB_2`, `SQL_WestUS_DB_2`, `SQL_WestCentralUS_DB_1`, `SQL_FranceSouth_DB_1`, `SQL_WestCentralUS_DB_2`, `SQL_FranceSouth_DB_2`, `SQL_SwitzerlandNorth_DB_1`, `SQL_SwitzerlandNorth_DB_2`, `SQL_BrazilSoutheast_DB_1`, `SQL_UAENorth_DB_1`, `SQL_BrazilSoutheast_DB_2`, `SQL_UAENorth_DB_2`, `SQL_SouthAfricaNorth_DB_1`, `SQL_SouthAfricaNorth_DB_2`, `SQL_WestUS3_DB_1`, `SQL_WestUS3_DB_2`, `SQL_SwedenCentral_DB_1`, `SQL_SwedenCentral_DB_2`. Defaults to `SQL_Default`.
     *
     * > **Note:** `maintenanceConfigurationName` is only applicable if `elasticPoolId` is not set.
     ...
     * If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica. This property is only settable for Premium and Business Critical databases.
     */
    readScale?: pulumi.Input<boolean | undefined>;
    /**
     * The ID of the database to be recovered. This property is only applicable when the `createMode` is `Recovery`.
     */
    recoverDatabaseId?: pulumi.Input<string | undefined>;
    /**
     * The ID of the Recovery Services Recovery Point Id to be restored. This property is only applicable when the `createMode` is `Recovery`.
     */
     ...
     * The ID of the database to be restored. This property is only applicable when the `createMode` is `Restore`.
     */
    restoreDroppedDatabaseId?: pulumi.Input<string | undefined>;
    /**
     * The ID of the long term retention backup to be restored. This property is only applicable when the `createMode` is `RestoreLongTermRetentionBackup`.
     */
    restoreLongTermRetentionBackupId?: pulumi.Input<string | undefined>;
    /**
     * Specifies the point in time (ISO8601 format) of the source database that will be restored to create the new database. This property is only settable for `createMode`= `PointInTimeRestore` databases.
     */
     ...
     * A `shortTermRetentionPolicy` block as defined below.
     */
    shortTermRetentionPolicy?: pulumi.Input<inputs.mssql.DatabaseShortTermRetentionPolicy | undefined>;
    /**
     * Specifies the name of the SKU used by the database. For example, `GP_S_Gen5_2`,`HS_Gen4_1`,`BC_Gen5_2`, `ElasticPool`, `Basic`,`S0`, `P2` ,`DW100c`, `DS100`. Changing this from the HyperScale service tier to another service tier will create a new resource.
     *
     * > **Note:** A full list of supported SKU names by region can be retrieved using the Azure CLI: `az sql db list-editions -l <region> -o table`
     ...
     * Threat detection policy configuration. The `threatDetectionPolicy` block supports fields documented below.
     */
    threatDetectionPolicy?: pulumi.Input<inputs.mssql.DatabaseThreatDetectionPolicy | undefined>;
    /**
     * If set to true, Transparent Data Encryption will be enabled on the database. Defaults to `true`.
     *
     * > **Note:** `transparentDataEncryptionEnabled` can only be set to `false` on DW (e.g, DataWarehouse) server SKUs.
     */
    transparentDataEncryptionEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * Boolean flag to specify whether TDE automatically rotates the encryption Key to latest version or not. Possible values are `true` or `false`. Defaults to `false`.
     *
     * > **Note:** When the `skuName` is `DW100c`, the `transparentDataEncryptionKeyAutomaticRotationEnabled` and the `transparentDataEncryptionKeyVaultKeyId` properties should not be specified, as database-level CMK is not supported for Data Warehouse SKUs.
     */
    transparentDataEncryptionKeyAutomaticRotationEnabled?: pulumi.Input<boolean | undefined>;
    /**
     * The fully versioned `Key Vault` `Key` URL (e.g. `'https://<YourVaultName>.vault.azure.net/keys/<YourKeyName>/<YourKeyVersion>`) to be used as the `Customer Managed Key`(CMK/BYOK) for the `Transparent Data Encryption`(TDE) layer.
     *
     * > **Note:** To successfully deploy a `Microsoft SQL Database` in CMK/BYOK TDE the `Key Vault` must have `Soft-delete` and `purge protection` enabled to protect from data loss due to accidental key and/or key vault deletion. The `Key Vault` and the `Microsoft SQL Server` `User Managed Identity Instance` must belong to the same `Azure Active Directory` `tenant`.
