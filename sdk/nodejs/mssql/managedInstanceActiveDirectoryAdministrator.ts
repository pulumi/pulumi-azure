 ...
 *     },
 * });
 * const reader = new azuread.index/directoryRole.DirectoryRole("reader", {displayName: "Directory Readers"});
 * const exampleDirectoryRoleMember = new azuread.index/directoryRoleMember.DirectoryRoleMember("example", {
