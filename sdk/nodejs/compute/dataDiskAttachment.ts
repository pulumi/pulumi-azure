...
export class DataDiskAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataDiskAttachmentState): DataDiskAttachment {
        return new DataDiskAttachment(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: DataDiskAttachmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DataDiskAttachmentArgs | DataDiskAttachmentState, opts?: pulumi.ResourceOptions) {
