...
export class Extension extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExtensionState): Extension {
        return new Extension(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ExtensionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ExtensionArgs | ExtensionState, opts?: pulumi.ResourceOptions) {
