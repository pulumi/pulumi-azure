...
export class VirtualMachineRestorePointCollection extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure:compute/virtualMachineRestorePointCollection:VirtualMachineRestorePointCollection';

    /**
     * Returns true if the given object is an instance of VirtualMachineRestorePointCollection.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualMachineRestorePointCollection {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualMachineRestorePointCollection.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: VirtualMachineRestorePointCollectionArgs | VirtualMachineRestorePointCollectionState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualMachineRestorePointCollectionState | undefined;
            ...
            const args = argsOrState as VirtualMachineRestorePointCollectionArgs | undefined;
 ...
 */
export interface VirtualMachineRestorePointCollectionState {
    /**
     * The Azure location where the Virtual Machine Restore Point Collection should exist. Changing this forces a new resource to be created.
     */
 ...
 */
export interface VirtualMachineRestorePointCollectionArgs {
    /**
     * The Azure location where the Virtual Machine Restore Point Collection should exist. Changing this forces a new resource to be created.
     */
    location?: pulumi.Input<string>;
