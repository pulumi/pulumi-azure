...
export class ManagedDisk extends pulumi.CustomResource {
     ...
     */
    public readonly encryptionSettings!: pulumi.Output<outputApi.compute.ManagedDiskEncryptionSettings | undefined>;
    /**
...
export interface ManagedDiskState {
     ...
     * an `encryptionSettings` block as defined below.
     */
    readonly encryptionSettings?: pulumi.Input<inputApi.compute.ManagedDiskEncryptionSettings>;
    /**
     * ID of an existing platform/marketplace disk image to copy when `createOption` is `FromImage`.
     */
