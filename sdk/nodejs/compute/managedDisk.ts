...
export class ManagedDisk extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ManagedDiskArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ManagedDiskArgs | ManagedDiskState, opts?: pulumi.ResourceOptions) {
