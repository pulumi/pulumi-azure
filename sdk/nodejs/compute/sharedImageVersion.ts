...
export class SharedImageVersion extends pulumi.CustomResource {
     ...
     */
    public readonly targetRegions!: pulumi.Output<outputApi.compute.SharedImageVersionTargetRegion[]>;
...
export interface SharedImageVersionState {
     ...
     * One or more `targetRegion` blocks as documented below.
     */
    readonly targetRegions?: pulumi.Input<pulumi.Input<inputApi.compute.SharedImageVersionTargetRegion>[]>;
}
