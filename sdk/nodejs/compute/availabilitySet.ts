...
export class AvailabilitySet extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: AvailabilitySetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AvailabilitySetArgs | AvailabilitySetState, opts?: pulumi.ResourceOptions) {
