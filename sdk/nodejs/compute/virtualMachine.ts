...
export class VirtualMachine extends pulumi.CustomResource {
     ...
     */
    public readonly bootDiagnostics!: pulumi.Output<outputApi.compute.VirtualMachineBootDiagnostics | undefined>;
    /**
     ...
     * A `identity` block.
     */
    public readonly identity!: pulumi.Output<outputApi.compute.VirtualMachineIdentity>;
    /**
     ...
     */
    public readonly osProfile!: pulumi.Output<outputApi.compute.VirtualMachineOsProfile | undefined>;
    /**
     * A `osProfileLinuxConfig` block.
     */
    public readonly osProfileLinuxConfig!: pulumi.Output<outputApi.compute.VirtualMachineOsProfileLinuxConfig | undefined>;
    /**
     * One or more `osProfileSecrets` blocks.
     */
    public readonly osProfileSecrets!: pulumi.Output<outputApi.compute.VirtualMachineOsProfileSecret[] | undefined>;
    /**
     * A `osProfileWindowsConfig` block.
     */
    public readonly osProfileWindowsConfig!: pulumi.Output<outputApi.compute.VirtualMachineOsProfileWindowsConfig | undefined>;
    /**
     * A `plan` block.
     */
    public readonly plan!: pulumi.Output<outputApi.compute.VirtualMachinePlan | undefined>;
    /**
     ...
     */
    public readonly storageDataDisks!: pulumi.Output<outputApi.compute.VirtualMachineStorageDataDisk[]>;
    /**
     * A `storageImageReference` block.
     */
    public readonly storageImageReference!: pulumi.Output<outputApi.compute.VirtualMachineStorageImageReference>;
    /**
     * A `storageOsDisk` block.
     */
    public readonly storageOsDisk!: pulumi.Output<outputApi.compute.VirtualMachineStorageOsDisk>;
    /**
...
export interface VirtualMachineState {
     ...
     * A `bootDiagnostics` block.
     */
    readonly bootDiagnostics?: pulumi.Input<inputApi.compute.VirtualMachineBootDiagnostics>;
    /**
     * Should the Data Disks (either the Managed Disks / VHD Blobs) be deleted when the Virtual Machine is destroyed? Defaults to `false`.
     */
     ...
     * A `identity` block.
     */
    readonly identity?: pulumi.Input<inputApi.compute.VirtualMachineIdentity>;
    /**
     * Specifies the BYOL Type for this Virtual Machine. This is only applicable to Windows Virtual Machines. Possible values are `Windows_Client` and `Windows_Server`.
     */
     ...
     * An `osProfile` block. Required when `createOption` in the `storageOsDisk` block is set to `FromImage`.
     */
    readonly osProfile?: pulumi.Input<inputApi.compute.VirtualMachineOsProfile>;
    /**
     * A `osProfileLinuxConfig` block.
     */
    readonly osProfileLinuxConfig?: pulumi.Input<inputApi.compute.VirtualMachineOsProfileLinuxConfig>;
    /**
     * One or more `osProfileSecrets` blocks.
     */
    readonly osProfileSecrets?: pulumi.Input<pulumi.Input<inputApi.compute.VirtualMachineOsProfileSecret>[]>;
    /**
     * A `osProfileWindowsConfig` block.
     */
    readonly osProfileWindowsConfig?: pulumi.Input<inputApi.compute.VirtualMachineOsProfileWindowsConfig>;
    /**
     * A `plan` block.
     */
    readonly plan?: pulumi.Input<inputApi.compute.VirtualMachinePlan>;
    /**
     * The ID of the Network Interface (which must be attached to the Virtual Machine) which should be the Primary Network Interface for this Virtual Machine.
     */
     ...
     * One or more `storageDataDisk` blocks.
     */
    readonly storageDataDisks?: pulumi.Input<pulumi.Input<inputApi.compute.VirtualMachineStorageDataDisk>[]>;
    /**
     * A `storageImageReference` block.
     */
    readonly storageImageReference?: pulumi.Input<inputApi.compute.VirtualMachineStorageImageReference>;
    /**
     * A `storageOsDisk` block.
     */
    readonly storageOsDisk?: pulumi.Input<inputApi.compute.VirtualMachineStorageOsDisk>;
    /**
     * A mapping of tags to assign to the Virtual Machine.
     */
