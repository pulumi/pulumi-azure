 ...
 * const exampleAlertRuleMachineLearningBehaviorAnalytics = new azure.sentinel/alertRuleMachineLearningBehaviorAnalytics.AlertRuleMachineLearningBehaviorAnalytics("example", {
...
export class AlertRuleMachineLearningBehaviorAnalytics extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertRuleMachineLearningBehaviorAnalyticsState, opts?: pulumi.CustomResourceOptions): AlertRuleMachineLearningBehaviorAnalytics {
        return new AlertRuleMachineLearningBehaviorAnalytics(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure:sentinel/alertRuleMachineLearningBehaviorAnalytics:AlertRuleMachineLearningBehaviorAnalytics';
     ...
     */
    public static isInstance(obj: any): obj is AlertRuleMachineLearningBehaviorAnalytics {
    ...
    constructor(name: string, argsOrState?: AlertRuleMachineLearningBehaviorAnalyticsArgs | AlertRuleMachineLearningBehaviorAnalyticsState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AlertRuleMachineLearningBehaviorAnalyticsState | undefined;
            resourceInputs["alertRuleTemplateGuid"] = state ? state.alertRuleTemplateGuid : undefined;
            resourceInputs["enabled"] = state ? state.enabled : undefined;
            resourceInputs["logAnalyticsWorkspaceId"] = state ? state.logAnalyticsWorkspaceId : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
        } else {
            const args = argsOrState as AlertRuleMachineLearningBehaviorAnalyticsArgs | undefined;
