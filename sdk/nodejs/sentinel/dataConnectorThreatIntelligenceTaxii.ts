 ...
 * const exampleDataConnectorThreatIntelligenceTaxii = new azure.sentinel/dataConnectorThreatIntelligenceTaxii.DataConnectorThreatIntelligenceTaxii("example", {
 *     name: "example",
