 ...
 * const exampleDataConnectorIot = new azure.sentinel.DataConnectorIot("exampleDataConnectorIot", {logAnalyticsWorkspaceId: exampleLogAnalyticsWorkspaceOnboarding.workspaceId});
 * ```
 *
 * ## Import
 *
