 ...
 * const exampleDataConnectorAzureSecurityCenter = new azure.sentinel.DataConnectorAzureSecurityCenter("exampleDataConnectorAzureSecurityCenter", {logAnalyticsWorkspaceId: exampleLogAnalyticsWorkspaceOnboarding.workspaceId});
 * ```
 *
 * ## Import
 *
