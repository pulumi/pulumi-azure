 ...
 * const exampleDataConnectorOfficeAtp = new azure.sentinel.DataConnectorOfficeAtp("exampleDataConnectorOfficeAtp", {logAnalyticsWorkspaceId: exampleLogAnalyticsWorkspaceOnboarding.workspaceId});
 * ```
 *
 * ## Import
 *
