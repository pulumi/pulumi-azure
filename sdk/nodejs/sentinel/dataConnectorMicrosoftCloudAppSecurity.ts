 ...
 * const exampleDataConnectorMicrosoftCloudAppSecurity = new azure.sentinel/dataConnectorMicrosoftCloudAppSecurity.DataConnectorMicrosoftCloudAppSecurity("example", {
 *     name: "example",
