 ...
 *     },
 * });
 * const exampleDataConnectorDynamics365 = new azure.sentinel.DataConnectorDynamics365("exampleDataConnectorDynamics365", {logAnalyticsWorkspaceId: exampleAnalyticsSolution.workspaceResourceId});
 * ```
 *
 * ## Import
 *
 ...
 * ```
 */
export class DataConnectorDynamics365 extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectorDynamics365State, opts?: pulumi.CustomResourceOptions): DataConnectorDynamics365 {
        return new DataConnectorDynamics365(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure:sentinel/dataConnectorDynamics365:DataConnectorDynamics365';

    /**
     * Returns true if the given object is an instance of DataConnectorDynamics365.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DataConnectorDynamics365 {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DataConnectorDynamics365.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DataConnectorDynamics365Args, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DataConnectorDynamics365Args | DataConnectorDynamics365State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DataConnectorDynamics365State | undefined;
            resourceInputs["logAnalyticsWorkspaceId"] = state ? state.logAnalyticsWorkspaceId : undefined;
            resourceInputs["name"] = state ? state.name : undefined;
            resourceInputs["tenantId"] = state ? state.tenantId : undefined;
        } else {
            const args = argsOrState as DataConnectorDynamics365Args | undefined;
 ...
 */
export interface DataConnectorDynamics365State {
    /**
     * The ID of the Log Analytics Workspace that this Dynamics 365 Data Connector resides in. Changing this forces a new Dynamics 365 Data Connector to be created.
     */
 ...
 */
export interface DataConnectorDynamics365Args {
    /**
     * The ID of the Log Analytics Workspace that this Dynamics 365 Data Connector resides in. Changing this forces a new Dynamics 365 Data Connector to be created.
     */
    logAnalyticsWorkspaceId: pulumi.Input<string>;
