 ...
 * const exampleDataConnectorMicrosoftThreatProtection = new azure.sentinel/dataConnectorMicrosoftThreatProtection.DataConnectorMicrosoftThreatProtection("example", {
 *     name: "example",
