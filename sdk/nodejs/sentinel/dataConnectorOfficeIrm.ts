 ...
 *     },
 * });
 * const exampleDataConnectorOfficeIrm = new azure.sentinel.DataConnectorOfficeIrm("exampleDataConnectorOfficeIrm", {logAnalyticsWorkspaceId: exampleAnalyticsSolution.workspaceResourceId});
 * ```
 *
 * ## Import
 *
