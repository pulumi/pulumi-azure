 ...
 * const exampleDataConnectorAzureAdvancedThreadProtection = new azure.sentinel/dataConnectorAzureAdvancedThreadProtection.DataConnectorAzureAdvancedThreadProtection("example", {
 *     name: "example",
