...
export class Setting extends pulumi.CustomResource {
     ...
     */
    public readonly notification!: pulumi.Output<outputApi.autoscale.SettingNotification | undefined>;
    /**
     * Specifies one or more (up to 20) `profile` blocks as defined below.
     */
    public readonly profiles!: pulumi.Output<outputApi.autoscale.SettingProfile[]>;
    /**
...
export interface SettingState {
     ...
     * Specifies a `notification` block as defined below.
     */
    readonly notification?: pulumi.Input<inputApi.autoscale.SettingNotification>;
    /**
     * Specifies one or more (up to 20) `profile` blocks as defined below.
     */
    readonly profiles?: pulumi.Input<pulumi.Input<inputApi.autoscale.SettingProfile>[]>;
    /**
     * The name of the Resource Group in the AutoScale Setting should be created. Changing this forces a new resource to be created.
     */
