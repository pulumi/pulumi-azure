 ...
 * 
 * const test = pulumi.output(azure.servicebus.getServiceBusNamespace({
...
export function getServiceBusNamespace(args: GetServiceBusNamespaceArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceBusNamespaceResult> & GetServiceBusNamespaceResult {
    ...
    const promise: Promise<GetServiceBusNamespaceResult> = pulumi.runtime.invoke("azure:servicebus/getServiceBusNamespace:getServiceBusNamespace", {
        "name": args.name,
