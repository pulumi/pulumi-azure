 ...
 * });
 * const exampleSubscription = new azure.servicebus/subscription.Subscription("example", {
 *     name: "tfex_servicebus_subscription",
 *     topicId: exampleTopic.id,
 *     maxDeliveryCount: 1,
 * });
 * const exampleSubscriptionRule = new azure.servicebus/subscriptionRule.SubscriptionRule("example", {
