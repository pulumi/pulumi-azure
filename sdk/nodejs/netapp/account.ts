...
export class Account extends pulumi.CustomResource {
     ...
     */
    declare public readonly activeDirectory: pulumi.Output<outputs.netapp.AccountActiveDirectory | undefined>;
    /**
     * The `identity` block where it is used when customer managed keys based encryption will be enabled as defined below.
     */
    declare public readonly identity: pulumi.Output<outputs.netapp.AccountIdentity | undefined>;
    /**
