...
export class AccountEncryption extends pulumi.CustomResource {
     ...
     */
    public readonly crossTenantKeyVaultResourceId!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: AccountEncryptionArgs | AccountEncryptionState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["crossTenantKeyVaultResourceId"] = state ? state.crossTenantKeyVaultResourceId : undefined;
            ...
            resourceInputs["crossTenantKeyVaultResourceId"] = args ? args.crossTenantKeyVaultResourceId : undefined;
