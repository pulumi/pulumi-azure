 ...
 */
export function getVolumeBucketWithServer(args: GetVolumeBucketWithServerArgs, opts?: pulumi.InvokeOptions): Promise<GetVolumeBucketWithServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure:netapp/getVolumeBucketWithServer:getVolumeBucketWithServer", {
        "name": args.name,
 ...
 */
export interface GetVolumeBucketWithServerArgs {
    /**
 ...
 */
export interface GetVolumeBucketWithServerResult {
    /**
     ...
     */
    readonly fileSystemNfsUsers: outputs.netapp.GetVolumeBucketWithServerFileSystemNfsUser[];
    /**
     ...
     */
    readonly keyVaults: outputs.netapp.GetVolumeBucketWithServerKeyVault[];
     ...
     */
    readonly servers: outputs.netapp.GetVolumeBucketWithServerServer[];
    /**
 ...
 * * `Microsoft.NetApp` - 2026-01-01
 */
export function getVolumeBucketWithServerOutput(args: GetVolumeBucketWithServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetVolumeBucketWithServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure:netapp/getVolumeBucketWithServer:getVolumeBucketWithServer", {
        "name": args.name,
        "netappVolumeId": args.netappVolumeId,
    }, opts);
}
 ...
 * A collection of arguments for invoking getVolumeBucketWithServer.
 */
export interface GetVolumeBucketWithServerOutputArgs {
    /**
     * The name of the NetApp Volume Bucket.
     */
