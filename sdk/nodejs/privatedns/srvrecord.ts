...
export class SRVRecord extends pulumi.CustomResource {
     ...
     */
    declare public readonly records: pulumi.Output<outputs.privatedns.SRVRecordRecord[]>;
    /**
...
export interface SRVRecordState {
     ...
     * One or more `record` blocks as defined below.
     */
    records?: pulumi.Input<pulumi.Input<inputs.privatedns.SRVRecordRecord>[] | undefined>;
    /**
     * Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
     */
