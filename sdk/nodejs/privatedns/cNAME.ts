 ...
 * });
 * const testCNAME = new azure.privatedns.CNAME("test", {
 *     name: "test",
 *     record: "contoso.com",
 *     resourceGroupName: testResourceGroup.name,
 *     ttl: 300,
...
export class CNAME extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure:privatedns/cNAME:CNAME';
    ...
    constructor(name: string, argsOrState?: CNAMEArgs | CNAMEState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CNAME.__pulumiType, name, inputs, opts);
    }
}
