 ...
 */
export class LinkEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkEndpointState, opts?: pulumi.CustomResourceOptions): LinkEndpoint {
        return new LinkEndpoint(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure:privatedns/linkEndpoint:LinkEndpoint';

    /**
     * Returns true if the given object is an instance of LinkEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is LinkEndpoint {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LinkEndpoint.__pulumiType;
    }
     ...
     */
    public readonly privateServiceConnection!: pulumi.Output<outputs.privatedns.LinkEndpointPrivateServiceConnection>;
    /**
     ...
     */
    constructor(name: string, args: LinkEndpointArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: LinkEndpointArgs | LinkEndpointState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        if (opts && opts.id) {
            const state = argsOrState as LinkEndpointState | undefined;
            ...
            const args = argsOrState as LinkEndpointArgs | undefined;
        ...
        super(LinkEndpoint.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface LinkEndpointState {
    /**
     * The supported Azure location where the resource exists. Changing this forces a new resource to be created.
     */
     ...
     * A `privateServiceConnection` block as defined below.
     */
    readonly privateServiceConnection?: pulumi.Input<inputs.privatedns.LinkEndpointPrivateServiceConnection>;
    /**
     * Specifies the Name of the Resource Group within which the Private Link Endpoint should exist. Changing this forces a new resource to be created.
     */
 ...
 */
export interface LinkEndpointArgs {
    /**
     * The supported Azure location where the resource exists. Changing this forces a new resource to be created.
     */
    readonly location?: pulumi.Input<string>;
