 ...
 */
export function getAutonomousDatabaseCloneFromDatabase(args: GetAutonomousDatabaseCloneFromDatabaseArgs, opts?: pulumi.InvokeOptions): Promise<GetAutonomousDatabaseCloneFromDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("azure:oracle/getAutonomousDatabaseCloneFromDatabase:getAutonomousDatabaseCloneFromDatabase", {
        "name": args.name,
 ...
 */
export interface GetAutonomousDatabaseCloneFromDatabaseArgs {
    /**
 ...
 */
export interface GetAutonomousDatabaseCloneFromDatabaseResult {
    /**
     ...
     */
    readonly longTermBackupSchedules: outputs.oracle.GetAutonomousDatabaseCloneFromDatabaseLongTermBackupSchedule[];
    /**
     ...
     */
    readonly reconnectCloneEnabled: boolean;
    /**
     * Indicates whether the clone is a refreshable clone.
     */
    readonly refreshableClone: boolean;
    /**
     ...
     */
    readonly timeUntilReconnectInUtc: string;
    /**
 ...
 * * `Oracle.Database` - 2025-09-01
 */
export function getAutonomousDatabaseCloneFromDatabaseOutput(args: GetAutonomousDatabaseCloneFromDatabaseOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAutonomousDatabaseCloneFromDatabaseResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("azure:oracle/getAutonomousDatabaseCloneFromDatabase:getAutonomousDatabaseCloneFromDatabase", {
        "name": args.name,
        "resourceGroupName": args.resourceGroupName,
    }, opts);
}
 ...
 * A collection of arguments for invoking getAutonomousDatabaseCloneFromDatabase.
 */
export interface GetAutonomousDatabaseCloneFromDatabaseOutputArgs {
    /**
     * The name of this autonomous database clone from database.
     */
