 ...
 * ```
 */
export class AutonomousDatabaseCloneFromDatabase extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutonomousDatabaseCloneFromDatabaseState, opts?: pulumi.CustomResourceOptions): AutonomousDatabaseCloneFromDatabase {
        return new AutonomousDatabaseCloneFromDatabase(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure:oracle/autonomousDatabaseCloneFromDatabase:AutonomousDatabaseCloneFromDatabase';

    /**
     * Returns true if the given object is an instance of AutonomousDatabaseCloneFromDatabase.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is AutonomousDatabaseCloneFromDatabase {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === AutonomousDatabaseCloneFromDatabase.__pulumiType;
    }
     ...
     */
    declare public readonly refreshableModel: pulumi.Output<string | undefined>;
    /**
     ...
     */
    constructor(name: string, args: AutonomousDatabaseCloneFromDatabaseArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: AutonomousDatabaseCloneFromDatabaseArgs | AutonomousDatabaseCloneFromDatabaseState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AutonomousDatabaseCloneFromDatabaseState | undefined;
            ...
            resourceInputs["refreshableModel"] = state?.refreshableModel;
            ...
            const args = argsOrState as AutonomousDatabaseCloneFromDatabaseArgs | undefined;
            ...
            resourceInputs["refreshableModel"] = args?.refreshableModel;
        ...
        super(AutonomousDatabaseCloneFromDatabase.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface AutonomousDatabaseCloneFromDatabaseState {
    /**
     * The password for the SYS, SYSTEM, and PDB Admin users. The password must be at least 12 characters long, and contain at least 1 uppercase, 1 lowercase, and 1 numeric character. It cannot contain the double quote symbol (`"`) or the username "admin", regardless of casing. Changing this forces a new Autonomous Database Clone to be created.
     */
 ...
 */
export interface AutonomousDatabaseCloneFromDatabaseArgs {
    /**
     * The password for the SYS, SYSTEM, and PDB Admin users. The password must be at least 12 characters long, and contain at least 1 uppercase, 1 lowercase, and 1 numeric character. It cannot contain the double quote symbol (`"`) or the username "admin", regardless of casing. Changing this forces a new Autonomous Database Clone to be created.
     */
    adminPassword: pulumi.Input<string>;
