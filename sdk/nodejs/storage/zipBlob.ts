...
export class ZipBlob extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZipBlobState): ZipBlob {
        return new ZipBlob(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ZipBlobArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ZipBlobArgs | ZipBlobState, opts?: pulumi.ResourceOptions) {
