 ...
 * ```
 */
export class MoverAgent extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MoverAgentState, opts?: pulumi.CustomResourceOptions): MoverAgent {
        return new MoverAgent(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'azure:storage/moverAgent:MoverAgent';

    /**
     * Returns true if the given object is an instance of MoverAgent.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is MoverAgent {
    ...
    constructor(name: string, argsOrState?: MoverAgentArgs | MoverAgentState, opts?: pulumi.CustomResourceOptions) {
