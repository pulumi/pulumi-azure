...
export class NatRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NatRuleState): NatRule {
        return new NatRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: NatRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NatRuleArgs | NatRuleState, opts?: pulumi.ResourceOptions) {
