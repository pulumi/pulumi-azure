...
export class LoadBalancer extends pulumi.CustomResource {
     ...
     */
    public readonly frontendIpConfigurations!: pulumi.Output<outputApi.lb.LoadBalancerFrontendIpConfiguration[] | undefined>;
    /**
...
export interface LoadBalancerState {
     ...
     * One or multiple `frontendIpConfiguration` blocks as documented below.
     */
    readonly frontendIpConfigurations?: pulumi.Input<pulumi.Input<inputApi.lb.LoadBalancerFrontendIpConfiguration>[]>;
    /**
     * Specifies the supported Azure Region where the Load Balancer should be created.
     */
