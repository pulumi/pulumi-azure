...
export class Probe extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProbeState): Probe {
        return new Probe(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ProbeArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ProbeArgs | ProbeState, opts?: pulumi.ResourceOptions) {
