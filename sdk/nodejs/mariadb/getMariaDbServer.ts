 ...
 * 
 * const dbServer = azurerm_mariadb_server_example.resourceGroupName.apply(resourceGroupName => azure.mariadb.getMariaDbServer({
 *     name: "mariadb-server",
 *     resourceGroupName: resourceGroupName,
 * }));
 * 
 * export const mariadbServerId = azurerm_mariadb_server_example.id;
 * ```
 *
