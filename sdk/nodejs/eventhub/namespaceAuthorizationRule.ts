...
export class NamespaceAuthorizationRule extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: NamespaceAuthorizationRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NamespaceAuthorizationRuleArgs | NamespaceAuthorizationRuleState, opts?: pulumi.ResourceOptions) {
