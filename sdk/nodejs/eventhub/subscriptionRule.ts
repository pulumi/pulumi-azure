...
export class SubscriptionRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SubscriptionRuleState): SubscriptionRule {
        return new SubscriptionRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: SubscriptionRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SubscriptionRuleArgs | SubscriptionRuleState, opts?: pulumi.ResourceOptions) {
