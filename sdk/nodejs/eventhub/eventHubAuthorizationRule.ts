...
export class EventHubAuthorizationRule extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: EventHubAuthorizationRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: EventHubAuthorizationRuleArgs | EventHubAuthorizationRuleState, opts?: pulumi.ResourceOptions) {
