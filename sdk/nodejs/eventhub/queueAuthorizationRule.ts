...
export class QueueAuthorizationRule extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: QueueAuthorizationRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: QueueAuthorizationRuleArgs | QueueAuthorizationRuleState, opts?: pulumi.ResourceOptions) {
