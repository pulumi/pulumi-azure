...
export class DatasetMysql extends pulumi.CustomResource {
     ...
     */
    public readonly schemaColumns!: pulumi.Output<outputApi.datafactory.DatasetMysqlSchemaColumn[] | undefined>;
    /**
...
export interface DatasetMysqlState {
     ...
     * A `schemaColumn` block as defined below.
     */
    readonly schemaColumns?: pulumi.Input<pulumi.Input<inputApi.datafactory.DatasetMysqlSchemaColumn>[]>;
    /**
     * The table name of the Data Factory Dataset MySQL.
     */
