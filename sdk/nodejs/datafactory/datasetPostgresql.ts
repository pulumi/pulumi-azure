 ...
 * });
 * const exampleLinkedServicePostgresql = new azure.datafactory/linkedServicePostgresql.LinkedServicePostgresql("example", {
 *     name: "example",
 *     dataFactoryId: exampleFactory.id,
 *     connectionString: "Host=example;Port=5432;Database=example;UID=example;EncryptionMethod=0;Password=example",
 * });
 * const exampleDatasetPostgresql = new azure.datafactory/datasetPostgresql.DatasetPostgresql("example", {
 *     name: "example",
 *     dataFactoryId: exampleFactory.id,
