...
export class DatasetCosmosDBApi extends pulumi.CustomResource {
     ...
     */
    declare public readonly schemaColumns: pulumi.Output<outputs.datafactory.DatasetCosmosDBApiSchemaColumn[] | undefined>;
...
export interface DatasetCosmosDBApiState {
     ...
     * A `schemaColumn` block as defined below.
     */
    schemaColumns?: pulumi.Input<pulumi.Input<inputs.datafactory.DatasetCosmosDBApiSchemaColumn>[] | undefined>;
}
