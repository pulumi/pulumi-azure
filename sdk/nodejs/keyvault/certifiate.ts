...
export class Certifiate extends pulumi.CustomResource {
     ...
     */
    declare public readonly certificate: pulumi.Output<outputs.keyvault.CertifiateCertificate | undefined>;
    /**
     * A `certificateAttribute` block as defined below.
     */
    declare public /*out*/ readonly certificateAttributes: pulumi.Output<outputs.keyvault.CertifiateCertificateAttribute[]>;
    /**
     ...
     */
    declare public readonly certificatePolicy: pulumi.Output<outputs.keyvault.CertifiateCertificatePolicy>;
    /**
...
export interface CertifiateState {
     ...
     * A `certificate` block as defined below, used to Import an existing certificate. Changing this will create a new version of the Key Vault Certificate.
     */
    certificate?: pulumi.Input<inputs.keyvault.CertifiateCertificate | undefined>;
    /**
     * A `certificateAttribute` block as defined below.
     */
    certificateAttributes?: pulumi.Input<pulumi.Input<inputs.keyvault.CertifiateCertificateAttribute>[] | undefined>;
    /**
     * The raw Key Vault Certificate data represented as a hexadecimal string.
     */
     ...
     * > **NOTE:** When creating a Key Vault Certificate, at least one of `certificate` or `certificatePolicy` is required. Provide `certificate` to import an existing certificate, `certificatePolicy` to generate a new certificate.
     */
    certificatePolicy?: pulumi.Input<inputs.keyvault.CertifiateCertificatePolicy | undefined>;
    /**
     * The ID of the Key Vault where the Certificate should be created. Changing this forces a new resource to be created.
     */
