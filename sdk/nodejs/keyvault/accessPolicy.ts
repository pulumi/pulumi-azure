...
export class AccessPolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: AccessPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AccessPolicyArgs | AccessPolicyState, opts?: pulumi.ResourceOptions) {
