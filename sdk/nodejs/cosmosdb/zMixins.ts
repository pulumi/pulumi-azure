 ...
 */
export interface CosmosChangeFeedContext
  extends appservice.Context<appservice.FunctionDefaultResponse> {
  invocationId: string
  executionContext: {
    invocationId: string
    functionName: string
 ...
 */
export type CosmosChangeFeedCallback = appservice.Callback<
  CosmosChangeFeedContext,
  any[],
  appservice.FunctionDefaultResponse
>

export interface GetCosmosDBFunctionArgs
  extends appservice.CallbackFunctionArgs<
    CosmosChangeFeedContext,
    any[],
    appservice.FunctionDefaultResponse
  > {
...
export interface CosmosChangeFeedSubscriptionArgs
...
declare module './account' {
  interface Account {
    ...
    onChange(
      name: string,
      args: CosmosChangeFeedSubscriptionArgs,
      opts?: pulumi.ComponentResourceOptions
    ): CosmosChangeFeedSubscription
     ...
     * Function.
     */
    getChangeFeedFunction(
      name: string,
      args: GetCosmosDBFunctionArgs
    ): CosmosDBFunction
  }
}
...
export class CosmosChangeFeedSubscription extends appservice.EventSubscription<
  CosmosChangeFeedContext,
  any[],
  appservice.FunctionDefaultResponse
> {
  ...
  constructor (
    ...
    super(
      'azure:eventhub:CosmosChangeFeedSubscription',
      name,
 ...
 */
export class CosmosDBFunction extends appservice.Function<
  CosmosChangeFeedContext,
  any[],
  appservice.FunctionDefaultResponse
> {
  constructor (name: string, args: CosmosDBFunctionArgs) {
    ...
    const appSettings = pulumi
      .all([args.account.connectionStrings, bindingConnectionKey])
      .apply(([connectionStrings, key]) => ({ [key]: connectionStrings[0] }))
