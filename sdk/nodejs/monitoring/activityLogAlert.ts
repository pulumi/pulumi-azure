...
export class ActivityLogAlert extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<outputApi.monitoring.ActivityLogAlertAction[] | undefined>;
    /**
     * A `criteria` block as defined below.
     */
    public readonly criteria!: pulumi.Output<outputApi.monitoring.ActivityLogAlertCriteria>;
    /**
...
export interface ActivityLogAlertState {
     ...
     * One or more `action` blocks as defined below.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputApi.monitoring.ActivityLogAlertAction>[]>;
    /**
     * A `criteria` block as defined below.
     */
    readonly criteria?: pulumi.Input<inputApi.monitoring.ActivityLogAlertCriteria>;
    /**
     * The description of this activity log alert.
     */
