...
export class MetricAlert extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<outputApi.monitoring.MetricAlertAction[] | undefined>;
    /**
     ...
     */
    public readonly criterias!: pulumi.Output<outputApi.monitoring.MetricAlertCriteria[]>;
    /**
...
export interface MetricAlertState {
     ...
     * One or more `action` blocks as defined below.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputApi.monitoring.MetricAlertAction>[]>;
    /**
     * Should the alerts in this Metric Alert be auto resolved? Defaults to `false`.
     */
     ...
     * One or more `criteria` blocks as defined below.
     */
    readonly criterias?: pulumi.Input<pulumi.Input<inputApi.monitoring.MetricAlertCriteria>[]>;
    /**
     * The description of this Metric Alert.
     */
