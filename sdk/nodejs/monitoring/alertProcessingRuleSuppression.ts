...
export interface AlertProcessingRuleSuppressionState {
     ...
     * A `condition` block as defined below.
     */
    condition?: pulumi.Input<inputs.monitoring.AlertProcessingRuleSuppressionCondition | undefined>;
    /**
     * Specifies a description for the Alert Processing Rule.
     */
     ...
     * A `schedule` block as defined below.
     */
    schedule?: pulumi.Input<inputs.monitoring.AlertProcessingRuleSuppressionSchedule | undefined>;
    /**
     * A list of resource IDs which will be the target of Alert Processing Rule.
     */
