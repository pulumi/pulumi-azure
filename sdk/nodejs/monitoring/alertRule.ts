...
export class AlertRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AlertRuleState): AlertRule {
        return new AlertRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AlertRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AlertRuleArgs | AlertRuleState, opts?: pulumi.ResourceOptions) {
