...
export class AutoscaleSetting extends pulumi.CustomResource {
     ...
     */
    public readonly notification!: pulumi.Output<outputApi.monitoring.AutoscaleSettingNotification | undefined>;
    /**
     * Specifies one or more (up to 20) `profile` blocks as defined below.
     */
    public readonly profiles!: pulumi.Output<outputApi.monitoring.AutoscaleSettingProfile[]>;
    /**
...
export interface AutoscaleSettingState {
     ...
     * Specifies a `notification` block as defined below.
     */
    readonly notification?: pulumi.Input<inputApi.monitoring.AutoscaleSettingNotification>;
    /**
     * Specifies one or more (up to 20) `profile` blocks as defined below.
     */
    readonly profiles?: pulumi.Input<pulumi.Input<inputApi.monitoring.AutoscaleSettingProfile>[]>;
    /**
     * The name of the Resource Group in the AutoScale Setting should be created. Changing this forces a new resource to be created.
     */
