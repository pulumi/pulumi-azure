...
export class Logger extends pulumi.CustomResource {
     ...
     */
    public readonly applicationInsights!: pulumi.Output<outputApi.apimanagement.LoggerApplicationInsights | undefined>;
    /**
     ...
     */
    public readonly eventhub!: pulumi.Output<outputApi.apimanagement.LoggerEventhub | undefined>;
    /**
...
export interface LoggerState {
     ...
     * An `applicationInsights` block as documented below.
     */
    readonly applicationInsights?: pulumi.Input<inputApi.apimanagement.LoggerApplicationInsights>;
    /**
     * Specifies whether records should be buffered in the Logger prior to publishing. Defaults to `true`.
     */
     ...
     * An `eventhub` block as documented below.
     */
    readonly eventhub?: pulumi.Input<inputApi.apimanagement.LoggerEventhub>;
    /**
     * The name of this Logger, which must be unique within the API Management Service. Changing this forces a new resource to be created.
     */
