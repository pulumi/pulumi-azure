...
export class ElasticPool extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ElasticPoolArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ElasticPoolArgs | ElasticPoolState, opts?: pulumi.ResourceOptions) {
