...
export class VirtualNetworkRule extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: VirtualNetworkRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VirtualNetworkRuleArgs | VirtualNetworkRuleState, opts?: pulumi.ResourceOptions) {
