...
export class ActiveDirectoryAdministrator extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ActiveDirectoryAdministratorState): ActiveDirectoryAdministrator {
        return new ActiveDirectoryAdministrator(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ActiveDirectoryAdministratorArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ActiveDirectoryAdministratorArgs | ActiveDirectoryAdministratorState, opts?: pulumi.ResourceOptions) {
