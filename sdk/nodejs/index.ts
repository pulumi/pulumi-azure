...
export {ad, apimanagement, appinsights, appservice, authorization, automation, autoscale, batch, cdn, cognitive, compute, config, containerservice, core, cosmosdb, databricks, datafactory, datalake, ddosprotection, devspace, devtest, dns, eventgrid, eventhub, hdinsight, iot, keyvault, lb, loganalytics, logicapps, managementgroups, managementresource, mariadb, mediaservices, monitoring, msi, mssql, mysql, network, notificationhub, operationalinsights, policy, postgresql, privatedns, recoveryservices, redis, relay, role, scheduler, search, securitycenter, servicebus, servicefabric, signalr, sql, storage, streamanalytics, trafficmanager};
