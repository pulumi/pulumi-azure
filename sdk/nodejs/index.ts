...
export {analysisservices, apimanagement, appconfiguration, appinsights, appservice, authorization, automation, backup, batch, bot, cdn, cognitive, compute, config, containerservice, core, cosmosdb, costmanagement, dashboard, databasemigration, databricks, datafactory, datalake, devspace, devtest, dns, eventgrid, eventhub, frontdoor, hdinsight, healthcare, hpc, iot, iotcentral, keyvault, kusto, lb, loganalytics, logicapps, machinelearning, management, managementgroups, managementresource, maps, mariadb, marketplace, mediaservices, mixedreality, monitoring, msi, mssql, mysql, netapp, network, notificationhub, operationalinsights, policy, postgresql, powerbi, privatedns, privatelink, proximity, recoveryservices, redis, relay, role, search, securitycenter, servicebus, servicefabric, signalr, siterecovery, sql, storage, streamanalytics, trafficmanager, types, waf};
