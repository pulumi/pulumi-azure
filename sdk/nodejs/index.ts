...
export {advisor, analysisservices, apimanagement, appconfiguration, appinsights, appplatform, appservice, attestation, authorization, automation, backup, batch, blueprint, bot, cdn, cognitive, compute, config, containerservice, core, cosmosdb, costmanagement, dashboard, databasemigration, databricks, datafactory, datalake, datashare, devspace, devtest, dns, eventgrid, eventhub, frontdoor, hdinsight, healthcare, hpc, hsm, iot, iotcentral, keyvault, kusto, lb, lighthouse, loganalytics, logicapps, machinelearning, maintenance, managedapplication, management, managementgroups, managementresource, maps, mariadb, marketplace, mediaservices, mixedreality, monitoring, msi, mssql, mysql, netapp, network, notificationhub, operationalinsights, policy, postgresql, powerbi, privatedns, privatelink, proximity, recoveryservices, redis, relay, role, search, securitycenter, sentinel, servicebus, servicefabric, signalr, siterecovery, sql, storage, streamanalytics, synapse, trafficmanager, types, waf};
