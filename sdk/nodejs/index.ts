...
export {ad, apimanagement, appinsights, appservice, automation, autoscale, cdn, cognitive, compute, config, containerservice, core, cosmosdb, databricks, datalake, devspace, devtest, dns, eventhub, iot, keyvault, lb, logicapps, managementgroups, managementresource, mariadb, monitoring, msi, mssql, mysql, network, notificationhub, operationalinsights, policy, postgresql, recoveryservices, redis, relay, role, scheduler, search, securitycenter, servicefabric, sql, storage, trafficmanager};
