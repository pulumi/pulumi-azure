...
export {appinsights, appservice, automation, cdn, compute, config, containerservice, core, cosmosdb, datalake, dns, eventhub, iot, keyvault, lb, managementresource, monitoring, mysql, network, operationalinsights, policy, postgresql, recoveryservices, redis, relay, role, scheduler, search, sql, storage, trafficmanager};
