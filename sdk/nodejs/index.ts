...
export {ad, apimanagement, appinsights, appservice, automation, autoscale, batch, cdn, cognitive, compute, config, containerservice, core, cosmosdb, databricks, datalake, ddosprotection, devspace, devtest, dns, eventhub, iot, keyvault, lb, loganalytics, logicapps, managementgroups, managementresource, mariadb, mediaservices, monitoring, msi, mssql, mysql, network, notificationhub, operationalinsights, policy, postgresql, recoveryservices, redis, relay, role, scheduler, search, securitycenter, servicefabric, signalr, sql, storage, trafficmanager};
