...
export {ad, analysisservices, apimanagement, appinsights, appservice, authorization, automation, autoscale, batch, bot, cdn, cognitive, compute, config, containerservice, core, cosmosdb, dashboard, databricks, datafactory, datalake, ddosprotection, devspace, devtest, dns, eventgrid, eventhub, frontdoor, hdinsight, healthcare, iot, keyvault, kusto, lb, loganalytics, logicapps, management, managementgroups, managementresource, maps, mariadb, marketplace, mediaservices, monitoring, msi, mssql, mysql, network, notificationhub, operationalinsights, policy, postgresql, privatedns, proximity, recoveryservices, redis, relay, role, scheduler, search, securitycenter, servicebus, servicefabric, signalr, sql, storage, streamanalytics, trafficmanager, types, waf};
