 ...
 * });
 * const examplePrivateLinkScope = new azure.arc/privateLinkScope.PrivateLinkScope("example", {
 *     name: "plsexample",
...
export class PrivateLinkScope extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure:arc/privateLinkScope:PrivateLinkScope';
