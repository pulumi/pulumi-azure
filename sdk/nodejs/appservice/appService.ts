...
export class AppService extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppServiceState): AppService {
        return new AppService(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AppServiceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AppServiceArgs | AppServiceState, opts?: pulumi.ResourceOptions) {
