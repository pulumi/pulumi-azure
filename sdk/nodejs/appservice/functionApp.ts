...
export class FunctionApp extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FunctionAppState): FunctionApp {
        return new FunctionApp(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: FunctionAppArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: FunctionAppArgs | FunctionAppState, opts?: pulumi.ResourceOptions) {
