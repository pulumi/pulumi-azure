...
export class Plan extends pulumi.CustomResource {
    ...
    public readonly properties!: pulumi.Output<outputApi.appservice.PlanProperties>;
    /**
     ...
     */
    public readonly sku!: pulumi.Output<outputApi.appservice.PlanSku>;
    /**
...
export interface PlanState {
    ...
    readonly properties?: pulumi.Input<inputApi.appservice.PlanProperties>;
    /**
     * Is this App Service Plan `Reserved`. Defaults to `false`.
     */
     ...
     * A `sku` block as documented below.
     */
    readonly sku?: pulumi.Input<inputApi.appservice.PlanSku>;
    /**
     * A mapping of tags to assign to the resource.
     */
