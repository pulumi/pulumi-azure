...
export class CustomHostnameBinding extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: CustomHostnameBindingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: CustomHostnameBindingArgs | CustomHostnameBindingState, opts?: pulumi.ResourceOptions) {
