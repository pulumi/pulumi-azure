...
export interface GetAppServiceResult {
     ...
     */
    readonly connectionStrings: outputApi.appservice.GetAppServiceConnectionString[];
     ...
     */
    readonly siteConfigs: outputApi.appservice.GetAppServiceSiteConfig[];
    readonly siteCredentials: outputApi.appservice.GetAppServiceSiteCredential[];
    readonly sourceControls: outputApi.appservice.GetAppServiceSourceControl[];
    /**
