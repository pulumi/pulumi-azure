...
export class ActiveSlot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ActiveSlotState): ActiveSlot {
        return new ActiveSlot(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ActiveSlotArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ActiveSlotArgs | ActiveSlotState, opts?: pulumi.ResourceOptions) {
