...
export class WindowsFunctionAppSlot extends pulumi.CustomResource {
     ...
     */
    declare public readonly authSettings: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotAuthSettings | undefined>;
    /**
     * an `authSettingsV2` block as detailed below.
     */
    declare public readonly authSettingsV2: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotAuthSettingsV2 | undefined>;
    /**
     * a `backup` block as detailed below.
     */
    declare public readonly backup: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotBackup | undefined>;
    /**
     ...
     */
    declare public readonly connectionStrings: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotConnectionString[] | undefined>;
    /**
     ...
     */
    declare public readonly identity: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotIdentity | undefined>;
    /**
     ...
     */
    declare public readonly siteConfig: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotSiteConfig>;
    /**
     * A `siteCredential` block as defined below.
     */
    declare public /*out*/ readonly siteCredentials: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotSiteCredential[]>;
    /**
     ...
     */
    declare public readonly storageAccounts: pulumi.Output<outputs.appservice.WindowsFunctionAppSlotStorageAccount[] | undefined>;
    /**
