...
export interface LinuxWebAppState {
     ...
     * A `authSettings` block as defined below.
     */
    authSettings?: pulumi.Input<inputs.appservice.LinuxWebAppAuthSettings | undefined>;
    /**
     * An `authSettingsV2` block as defined below.
     */
    authSettingsV2?: pulumi.Input<inputs.appservice.LinuxWebAppAuthSettingsV2 | undefined>;
    /**
     * A `backup` block as defined below.
     */
    backup?: pulumi.Input<inputs.appservice.LinuxWebAppBackup | undefined>;
    /**
     * Should Client Affinity be enabled?
     */
     ...
     * One or more `connectionString` blocks as defined below.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxWebAppConnectionString>[] | undefined>;
    /**
     * The identifier used by App Service to perform domain ownership verification via DNS TXT record.
     */
     ...
     * An `identity` block as defined below.
     */
    identity?: pulumi.Input<inputs.appservice.LinuxWebAppIdentity | undefined>;
    /**
     * The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity).
     */
     ...
     * A `logs` block as defined below.
     */
    logs?: pulumi.Input<inputs.appservice.LinuxWebAppLogs | undefined>;
    /**
     * The name which should be used for this Linux Web App. Changing this forces a new Linux Web App to be created.
     *
     * > **Note:** Terraform will perform a name availability check as part of the creation progress, if this Web App is part of an App Service Environment terraform will require Read permission on the ASE for this to complete reliably.
     ...
     * A `siteConfig` block as defined below.
     */
    siteConfig?: pulumi.Input<inputs.appservice.LinuxWebAppSiteConfig | undefined>;
    /**
     * A `siteCredential` block as defined below.
     */
    siteCredentials?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxWebAppSiteCredential>[] | undefined>;
    /**
     * A `stickySettings` block as defined below.
     */
    stickySettings?: pulumi.Input<inputs.appservice.LinuxWebAppStickySettings | undefined>;
    /**
     * One or more `storageAccount` blocks as defined below.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxWebAppStorageAccount>[] | undefined>;
    /**
     * A mapping of tags which should be assigned to the Linux Web App.
     */
