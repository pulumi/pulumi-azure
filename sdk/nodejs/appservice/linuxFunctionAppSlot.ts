...
export class LinuxFunctionAppSlot extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure:appservice/linuxFunctionAppSlot:LinuxFunctionAppSlot';
...
export interface LinuxFunctionAppSlotState {
     ...
     * an `authSettings` block as detailed below.
     */
    authSettings?: pulumi.Input<inputs.appservice.LinuxFunctionAppSlotAuthSettings | undefined>;
    /**
     * an `authSettingsV2` block as detailed below.
     */
    authSettingsV2?: pulumi.Input<inputs.appservice.LinuxFunctionAppSlotAuthSettingsV2 | undefined>;
    /**
     * a `backup` block as detailed below.
     */
    backup?: pulumi.Input<inputs.appservice.LinuxFunctionAppSlotBackup | undefined>;
    /**
     * Should built in logging be enabled. Configures `AzureWebJobsDashboard` app setting based on the configured storage setting. Defaults to `true`.
     */
     ...
     * a `connectionString` block as detailed below.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxFunctionAppSlotConnectionString>[] | undefined>;
    /**
     * Force disable the content share settings.
     */
     ...
     * An `identity` block as detailed below.
     */
    identity?: pulumi.Input<inputs.appservice.LinuxFunctionAppSlotIdentity | undefined>;
    /**
     * The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
     */
     ...
     * a `siteConfig` block as detailed below.
     */
    siteConfig?: pulumi.Input<inputs.appservice.LinuxFunctionAppSlotSiteConfig | undefined>;
    /**
     * A `siteCredential` block as defined below.
     */
    siteCredentials?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxFunctionAppSlotSiteCredential>[] | undefined>;
    /**
     * The access key which will be used to access the storage account for the Function App Slot.
     */
     ...
     * One or more `storageAccount` blocks as defined below.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxFunctionAppSlotStorageAccount>[] | undefined>;
    /**
     * The Key Vault Secret ID, optionally including version, that contains the Connection String to connect to the storage account for this Function App.
     *
     * > **Note:** `storageKeyVaultSecretId` cannot be used with `storageAccountName`.
