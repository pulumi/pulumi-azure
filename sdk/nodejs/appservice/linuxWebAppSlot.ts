...
export class LinuxWebAppSlot extends pulumi.CustomResource {
     ...
     */
    public readonly authSettings!: pulumi.Output<outputs.appservice.LinuxWebAppSlotAuthSettings | undefined>;
    /**
     * An `authSettingsV2` block as defined below.
     */
    public readonly authSettingsV2!: pulumi.Output<outputs.appservice.LinuxWebAppSlotAuthSettingsV2 | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: LinuxWebAppSlotArgs | LinuxWebAppSlotState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LinuxWebAppSlot.__pulumiType, name, resourceInputs, opts, false /*remote*/);
    }
}
