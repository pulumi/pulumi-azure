...
export class LinuxFunctionApp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'azure:appservice/linuxFunctionApp:LinuxFunctionApp';
     ...
     */
    declare public readonly authSettings: pulumi.Output<outputs.appservice.LinuxFunctionAppAuthSettings | undefined>;
    /**
     * An `authSettingsV2` block as defined below.
     */
    declare public readonly authSettingsV2: pulumi.Output<outputs.appservice.LinuxFunctionAppAuthSettingsV2 | undefined>;
    /**
     * A `backup` block as defined below.
     */
    declare public readonly backup: pulumi.Output<outputs.appservice.LinuxFunctionAppBackup | undefined>;
    /**
     ...
     */
    declare public readonly connectionStrings: pulumi.Output<outputs.appservice.LinuxFunctionAppConnectionString[] | undefined>;
    /**
     ...
     */
    declare public readonly identity: pulumi.Output<outputs.appservice.LinuxFunctionAppIdentity | undefined>;
    /**
     ...
     */
    declare public readonly siteConfig: pulumi.Output<outputs.appservice.LinuxFunctionAppSiteConfig>;
    /**
     * A `siteCredential` block as defined below.
     */
    declare public /*out*/ readonly siteCredentials: pulumi.Output<outputs.appservice.LinuxFunctionAppSiteCredential[]>;
    /**
     * A `stickySettings` block as defined below.
     */
    declare public readonly stickySettings: pulumi.Output<outputs.appservice.LinuxFunctionAppStickySettings | undefined>;
    /**
     ...
     */
    declare public readonly storageAccounts: pulumi.Output<outputs.appservice.LinuxFunctionAppStorageAccount[] | undefined>;
    /**
...
export interface LinuxFunctionAppState {
     ...
     * A `authSettings` block as defined below.
     */
    authSettings?: pulumi.Input<inputs.appservice.LinuxFunctionAppAuthSettings | undefined>;
    /**
     * An `authSettingsV2` block as defined below.
     */
    authSettingsV2?: pulumi.Input<inputs.appservice.LinuxFunctionAppAuthSettingsV2 | undefined>;
    /**
     * A `backup` block as defined below.
     */
    backup?: pulumi.Input<inputs.appservice.LinuxFunctionAppBackup | undefined>;
    /**
     * Should built in logging be enabled. Configures `AzureWebJobsDashboard` app setting based on the configured storage setting. Defaults to `true`.
     *
     * > **Note:** `builtinLoggingEnabled` is only supported for function app whose function runtime is running on version 1.x.
     ...
     * One or more `connectionString` blocks as defined below.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxFunctionAppConnectionString>[] | undefined>;
    /**
     * Should the settings for linking the Function App to storage be suppressed.
     */
     ...
     * A `identity` block as defined below.
     */
    identity?: pulumi.Input<inputs.appservice.LinuxFunctionAppIdentity | undefined>;
    /**
     * The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
     */
     ...
     * A `siteConfig` block as defined below.
     */
    siteConfig?: pulumi.Input<inputs.appservice.LinuxFunctionAppSiteConfig | undefined>;
    /**
     * A `siteCredential` block as defined below.
     */
    siteCredentials?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxFunctionAppSiteCredential>[] | undefined>;
    /**
     * A `stickySettings` block as defined below.
     */
    stickySettings?: pulumi.Input<inputs.appservice.LinuxFunctionAppStickySettings | undefined>;
    /**
     * The access key which will be used to access the backend storage account for the Function App. Conflicts with `storageUsesManagedIdentity`.
     */
     ...
     * One or more `storageAccount` blocks as defined below.
     */
    storageAccounts?: pulumi.Input<pulumi.Input<inputs.appservice.LinuxFunctionAppStorageAccount>[] | undefined>;
    /**
     * The Key Vault Secret ID, optionally including version, that contains the Connection String to connect to the storage account for this Function App.
     *
     * > **Note:** `storageKeyVaultSecretId` cannot be used with `storageAccountName`.
