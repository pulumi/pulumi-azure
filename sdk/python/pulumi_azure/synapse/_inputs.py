...
__all__ = [
    ...
    'LinkedServiceIntegrationRuntimeArgsDict',
    'SparkPoolAutoPauseArgs',
    'SparkPoolAutoPauseArgsDict',
    'SparkPoolAutoScaleArgs',
    'SparkPoolAutoScaleArgsDict',
    'SparkPoolLibraryRequirementArgs',
    'SparkPoolLibraryRequirementArgsDict',
    'SparkPoolSparkConfigArgs',
    'SparkPoolSparkConfigArgsDict',
    'SqlPoolRestoreArgs',
    'SqlPoolRestoreArgsDict',
    ...
    'WorkspaceCustomerManagedKeyArgsDict',
...
class LinkedServiceIntegrationRuntimeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The integration runtime reference to associate with the Synapse Linked Service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the integration runtime.
        """
...
if not MYPY:
    class SparkPoolAutoPauseArgsDict(TypedDict):
        delay_in_minutes: pulumi.Input[builtins.int]
        """
...
class SparkPoolAutoPauseArgs:
    def __init__(__self__, *,
                 delay_in_minutes: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] delay_in_minutes: Number of minutes of idle time before the Spark Pool is automatically paused. Must be between `5` and `10080`.
        """
        pulumi.set(__self__, "delay_in_minutes", delay_in_minutes)

    @property
    @pulumi.getter(name="delayInMinutes")
    def delay_in_minutes(self) -> pulumi.Input[builtins.int]:
        """
        Number of minutes of idle time before the Spark Pool is automatically paused. Must be between `5` and `10080`.
        """
    ...
    def delay_in_minutes(self, value: pulumi.Input[builtins.int]):
...
class SparkPoolAutoScaleArgs:
    def __init__(__self__, *,
                 ...
                 min_node_count: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_node_count: The maximum number of nodes the Spark Pool can support. Must be between `3` and `200`.
        :param pulumi.Input[builtins.int] min_node_count: The minimum number of nodes the Spark Pool can support. Must be between `3` and `200`.
        """
...
class SparkPoolLibraryRequirementArgs:
    def __init__(__self__, *,
                 ...
                 filename: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] content: The content of library requirements.
        :param pulumi.Input[builtins.str] filename: The name of the library requirements file.
        """
...
class SparkPoolSparkConfigArgs:
    def __init__(__self__, *,
                 ...
                 filename: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] content: The contents of a spark configuration.
        :param pulumi.Input[builtins.str] filename: The name of the file where the spark configuration `content` will be stored.
        """
        pulumi.set(__self__, "content", content)
        pulumi.set(__self__, "filename", filename)
...
if not MYPY:
    class SqlPoolRestoreArgsDict(TypedDict):
        ...
        """
        source_database_id: pulumi.Input[builtins.str]
        """
...
class SqlPoolRestoreArgs:
    def __init__(__self__, *,
                 ...
                 source_database_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] point_in_time: Specifies the Snapshot time to restore formatted as an RFC3339 date string. Changing this forces a new Synapse SQL Pool to be created.
        :param pulumi.Input[builtins.str] source_database_id: The ID of the Synapse SQL Pool or SQL Database which is to restore. Changing this forces a new Synapse SQL Pool to be created.
        """
    ...
    def source_database_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Synapse SQL Pool or SQL Database which is to restore. Changing this forces a new Synapse SQL Pool to be created.
        """
    ...
    def source_database_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_database_id", value)


if not MYPY:
    class SqlPoolVulnerabilityAssessmentBaselineBaselineArgsDict(TypedDict):
        results: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class SqlPoolVulnerabilityAssessmentBaselineBaselineArgs:
    def __init__(__self__, *,
                 results: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] results: Specifies a list of rule baseline result.
        """
        pulumi.set(__self__, "results", results)

    @property
    @pulumi.getter
    def results(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of rule baseline result.
        """
    ...
    @results.setter
    def results(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "results", value)


if not MYPY:
    class SqlPoolVulnerabilityAssessmentRecurringScansArgsDict(TypedDict):
        email_subscription_admins_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SqlPoolVulnerabilityAssessmentRecurringScansArgs:
    def __init__(__self__, *,
                 email_subscription_admins_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 emails: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] email_subscription_admins_enabled: Boolean flag which specifies if the schedule scan notification will be sent to the subscription administrators. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] emails: Specifies an array of email addresses to which the scan notification is sent.
        :param pulumi.Input[builtins.bool] enabled: Boolean flag which specifies if recurring scans is enabled or disabled. Defaults to `false`.
        """
    ...
    def email_subscription_admins_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Boolean flag which specifies if the schedule scan notification will be sent to the subscription administrators. Defaults to `true`.
        """
    ...
    def email_subscription_admins_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class WorkspaceAzureDevopsRepoArgsDict(TypedDict):
        ...
        """
        root_folder: pulumi.Input[builtins.str]
        """
...
class WorkspaceAzureDevopsRepoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] account_name: Specifies the Azure DevOps account name.
        :param pulumi.Input[builtins.str] branch_name: Specifies the collaboration branch of the repository to get code from.
        :param pulumi.Input[builtins.str] project_name: Specifies the name of the Azure DevOps project.
        :param pulumi.Input[builtins.str] repository_name: Specifies the name of the git repository.
        :param pulumi.Input[builtins.str] root_folder: Specifies the root folder within the repository. Set to `/` for the top level.
        :param pulumi.Input[builtins.str] last_commit_id: The last commit ID.
        :param pulumi.Input[builtins.str] tenant_id: the ID of the tenant for the Azure DevOps account.
        """
    ...
    def root_folder(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the root folder within the repository. Set to `/` for the top level.
        """
    ...
    @root_folder.setter
    def root_folder(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class WorkspaceCustomerManagedKeyArgsDict(TypedDict):
        key_versionless_id: pulumi.Input[builtins.str]
        """
...
class WorkspaceCustomerManagedKeyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key_versionless_id: The Azure Key Vault Key Versionless ID to be used as the Customer Managed Key (CMK) for double encryption (e.g. `https://example-keyvault.vault.azure.net/type/cmk/`).
        :param pulumi.Input[builtins.str] key_name: An identifier for the key. Name needs to match the name of the key used with the `synapse.WorkspaceKey` resource. Defaults to "cmk" if not specified.
        :param pulumi.Input[builtins.str] user_assigned_identity_id: The User Assigned Identity ID to be used for accessing the Customer Managed Key for encryption.
        """
    ...
    def key_versionless_id(self) -> pulumi.Input[builtins.str]:
        """
        The Azure Key Vault Key Versionless ID to be used as the Customer Managed Key (CMK) for double encryption (e.g. `https://example-keyvault.vault.azure.net/type/cmk/`).
        """
    ...
    def key_versionless_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class WorkspaceGithubRepoArgsDict(TypedDict):
        ...
        Specifies the root folder within the repository. Set to `/` for the top level.
        """
        git_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkspaceGithubRepoArgs:
    def __init__(__self__, *,
                 ...
                 last_commit_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] account_name: Specifies the GitHub account name.
        :param pulumi.Input[builtins.str] branch_name: Specifies the collaboration branch of the repository to get code from.
        :param pulumi.Input[builtins.str] repository_name: Specifies the name of the git repository.
        :param pulumi.Input[builtins.str] root_folder: Specifies the root folder within the repository. Set to `/` for the top level.
        :param pulumi.Input[builtins.str] git_url: Specifies the GitHub Enterprise host name. For example: <https://github.mydomain.com>.
...
class WorkspaceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be associated with this Synapse Workspace. Possible values are `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Synapse Workspace.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Synapse Workspace.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Synapse Workspace.
        """
