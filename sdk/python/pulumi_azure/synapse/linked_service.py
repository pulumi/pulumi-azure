...
class LinkedServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] synapse_workspace_id: The Synapse Workspace ID in which to associate the Linked Service with. Changing this forces a new Synapse Linked Service to be created.
        :param pulumi.Input[builtins.str] type: The type of data stores that will be connected to Synapse. Valid Values include `AmazonMWS`, `AmazonRdsForOracle`, `AmazonRdsForSqlServer`, `AmazonRedshift`, `AmazonS3`, `AzureBatch`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] type_properties_json: A JSON object that contains the properties of the Synapse Linked Service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_properties: A map of additional properties to associate with the Synapse Linked Service.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] annotations: List of tags that can be used for describing the Synapse Linked Service.
        :param pulumi.Input[builtins.str] description: The description for the Synapse Linked Service.
        :param pulumi.Input['LinkedServiceIntegrationRuntimeArgs'] integration_runtime: A `integration_runtime` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Synapse Linked Service. Changing this forces a new Synapse Linked Service to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the Synapse Linked Service.
        """
...
class LinkedService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            synapse_workspace_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            type_properties_json: Optional[pulumi.Input[builtins.str]] = None) -> 'LinkedService':
        """
