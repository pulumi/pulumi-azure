...
def get_workspace(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of this Synapse Workspace.
    :param _builtins.str resource_group_name: The name of the Resource Group where the Synapse Workspace exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_workspace_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:synapse/getWorkspace:getWorkspace', __args__, opts=opts, typ=GetWorkspaceResult)
