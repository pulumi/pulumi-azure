...
def get_workspace(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of this Synapse Workspace.
    :param builtins.str resource_group_name: The name of the Resource Group where the Synapse Workspace exists.
    """
    __args__ = dict()
    __args__['name'] = name
