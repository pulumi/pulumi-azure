...
class SqlPoolSecurityAlertPolicyArgs:
    ...
    def sql_pool_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @sql_pool_id.setter
    def sql_pool_id(self, value: pulumi.Input[_builtins.str]):
...
class SqlPoolSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sql_pool_id: Optional[pulumi.Input[_builtins.str]] = None,
            storage_account_access_key: Optional[pulumi.Input[_builtins.str]] = None,
            storage_endpoint: Optional[pulumi.Input[_builtins.str]] = None) -> 'SqlPoolSecurityAlertPolicy':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sqlPoolId")
    def sql_pool_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the ID of the Synapse SQL Pool. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sql_pool_id")
