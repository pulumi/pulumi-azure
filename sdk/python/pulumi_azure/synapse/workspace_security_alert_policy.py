...
class WorkspaceSecurityAlertPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy_state: Specifies the state of the policy, whether it is enabled or disabled or a policy has not been applied yet on the specific workspace. Possible values are `Disabled`, `Enabled` and `New`.
        :param pulumi.Input[_builtins.str] synapse_workspace_id: Specifies the ID of the Synapse Workspace. Changing this forces a new resource to be created.
    ...
    def policy_state(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @policy_state.setter
    def policy_state(self, value: pulumi.Input[_builtins.str]):
...
class WorkspaceSecurityAlertPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="policyState")
    def policy_state(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the state of the policy, whether it is enabled or disabled or a policy has not been applied yet on the specific workspace. Possible values are `Disabled`, `Enabled` and `New`.
        """
        return pulumi.get(self, "policy_state")
