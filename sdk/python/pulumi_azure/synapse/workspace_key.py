...
class WorkspaceKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] customer_managed_key_name: Specifies the name of the workspace key. Should match the name of the key in the synapse workspace.
        :param pulumi.Input[_builtins.str] synapse_workspace_id: The ID of the Synapse Workspace where the encryption key should be configured.
        :param pulumi.Input[_builtins.str] customer_managed_key_versionless_id: The Azure Key Vault Key Versionless ID to be used as the Customer Managed Key (CMK) for double encryption
        """
    ...
    def customer_managed_key_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def customer_managed_key_name(self, value: pulumi.Input[_builtins.str]):
...
class WorkspaceKey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="customerManagedKeyName")
    def customer_managed_key_name(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the name of the workspace key. Should match the name of the key in the synapse workspace.
        """
        return pulumi.get(self, "customer_managed_key_name")
    ...
    @_builtins.property
    @pulumi.getter(name="customerManagedKeyVersionlessId")
    def customer_managed_key_versionless_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The Azure Key Vault Key Versionless ID to be used as the Customer Managed Key (CMK) for double encryption
        """
        return pulumi.get(self, "customer_managed_key_versionless_id")
