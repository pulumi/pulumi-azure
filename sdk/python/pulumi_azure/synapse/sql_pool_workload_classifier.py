...
class SqlPoolWorkloadClassifierArgs:
    def __init__(__self__, *,
                 ...
                 workload_group_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] member_name: The workload classifier member name used to classified against.
        :param pulumi.Input[builtins.str] workload_group_id: The ID of the Synapse SQL Pool Workload Group. Changing this forces a new Synapse SQL Pool Workload Classifier to be created.
        :param pulumi.Input[builtins.str] context: Specifies the session context value that a request can be classified against.
        :param pulumi.Input[builtins.str] end_time: The workload classifier end time for classification. It's of the `HH:MM` format in UTC time zone.
        :param pulumi.Input[builtins.str] importance: The workload classifier importance. The allowed values are `low`, `below_normal`, `normal`, `above_normal` and `high`.
        :param pulumi.Input[builtins.str] label: Specifies the label value that a request can be classified against.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Synapse SQL Pool Workload Classifier. Changing this forces a new Synapse SQL Pool Workload Classifier to be created.
        :param pulumi.Input[builtins.str] start_time: The workload classifier start time for classification. It's of the `HH:MM` format in UTC time zone.
        """
    ...
    def workload_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def workload_group_id(self, value: pulumi.Input[builtins.str]):
...
class _SqlPoolWorkloadClassifierState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 start_time: Optional[pulumi.Input[builtins.str]] = None,
                 workload_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="workloadGroupId")
    def workload_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Synapse SQL Pool Workload Group. Changing this forces a new Synapse SQL Pool Workload Classifier to be created.
        """
        return pulumi.get(self, "workload_group_id")
    ...
    @workload_group_id.setter
    def workload_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "workload_group_id", value)
...
class SqlPoolWorkloadClassifier(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            start_time: Optional[pulumi.Input[builtins.str]] = None,
            workload_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlPoolWorkloadClassifier':
        """
    ...
    @property
    @pulumi.getter(name="workloadGroupId")
    def workload_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Synapse SQL Pool Workload Group. Changing this forces a new Synapse SQL Pool Workload Classifier to be created.
        """
        return pulumi.get(self, "workload_group_id")
