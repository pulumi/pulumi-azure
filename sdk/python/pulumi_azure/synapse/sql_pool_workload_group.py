...
class SqlPoolWorkloadGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Synapse SQL Pool Workload Group. Changing this forces a new Synapse SQL Pool Workload Group to be created.
        :param pulumi.Input[_builtins.int] query_execution_timeout_in_seconds: The workload group query execution timeout.
        """
...
class SqlPoolWorkloadGroup(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="minResourcePercentPerRequest")
    def min_resource_percent_per_request(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The workload group request minimum grant percentage.
        """
        return pulumi.get(self, "min_resource_percent_per_request")
    ...
    @_builtins.property
    @pulumi.getter(name="queryExecutionTimeoutInSeconds")
    def query_execution_timeout_in_seconds(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The workload group query execution timeout.
        """
        return pulumi.get(self, "query_execution_timeout_in_seconds")
