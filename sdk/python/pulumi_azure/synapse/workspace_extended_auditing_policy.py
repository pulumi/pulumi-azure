...
class WorkspaceExtendedAuditingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] synapse_workspace_id: The ID of the Synapse workspace to set the extended auditing policy. Changing this forces a new resource to be created.
...
class WorkspaceExtendedAuditingPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_access_key_is_secondary: Optional[pulumi.Input[builtins.bool]] = None,
            storage_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            synapse_workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceExtendedAuditingPolicy':
        """
