...
class WorkspaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: Specifies the name of the Resource Group where the synapse Workspace should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] storage_data_lake_gen2_filesystem_id: Specifies the ID of storage data lake gen2 filesystem resource. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.bool] managed_virtual_network_enabled: Is Virtual Network enabled for all computes in this workspace? Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: Specifies the name which should be used for this synapse Workspace. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] purview_id: The ID of purview account.
        :param pulumi.Input[_builtins.str] sql_administrator_login: Specifies The login name of the SQL administrator. Changing this forces a new resource to be created. If this is not provided `customer_managed_key` must be provided.
        :param pulumi.Input[_builtins.str] sql_administrator_login_password: The Password associated with the `sql_administrator_login` for the SQL administrator. If this is not provided `customer_managed_key` must be provided.
        :param pulumi.Input[_builtins.bool] sql_identity_control_enabled: Are pipelines (running as workspace's system assigned identity) allowed to access SQL pools?
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Synapse Workspace.
        """
    ...
    def storage_data_lake_gen2_filesystem_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def storage_data_lake_gen2_filesystem_id(self, value: pulumi.Input[_builtins.str]):
...
class Workspace(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="computeSubnetId")
    def compute_subnet_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Subnet ID used for computes in workspace Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "compute_subnet_id")
    ...
    @_builtins.property
    @pulumi.getter(name="dataExfiltrationProtectionEnabled")
    def data_exfiltration_protection_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Is data exfiltration protection enabled in this workspace? If set to `true`, `managed_virtual_network_enabled` must also be set to `true`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "data_exfiltration_protection_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="linkingAllowedForAadTenantIds")
    def linking_allowed_for_aad_tenant_ids(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        Allowed AAD Tenant Ids For Linking.
        """
        return pulumi.get(self, "linking_allowed_for_aad_tenant_ids")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlIdentityControlEnabled")
    def sql_identity_control_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Are pipelines (running as workspace's system assigned identity) allowed to access SQL pools?
        """
        return pulumi.get(self, "sql_identity_control_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="storageDataLakeGen2FilesystemId")
    def storage_data_lake_gen2_filesystem_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the ID of storage data lake gen2 filesystem resource. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "storage_data_lake_gen2_filesystem_id")
