...
class SqlPoolArgs:
    def __init__(__self__, *,
                 ...
                 data_encrypted: Optional[pulumi.Input[builtins.bool]] = None,
                 geo_backup_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_database_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] sku_name: Specifies the SKU Name for this Synapse SQL Pool. Possible values are `DW100c`, `DW200c`, `DW300c`, `DW400c`, `DW500c`, `DW1000c`, `DW1500c`, `DW2000c`, `DW2500c`, `DW3000c`, `DW5000c`, `DW6000c`, `DW7500c`, `DW10000c`, `DW15000c` or `DW30000c`.
        :param pulumi.Input[builtins.str] storage_account_type: The storage account type that will be used to store backups for this Synapse SQL Pool. Possible values are `LRS` or `GRS`. Changing this forces a new Synapse SQL Pool to be created.
        :param pulumi.Input[builtins.str] synapse_workspace_id: The ID of Synapse Workspace within which this SQL Pool should be created. Changing this forces a new Synapse SQL Pool to be created.
        :param pulumi.Input[builtins.str] collation: The name of the collation to use with this pool, only applicable when `create_mode` is set to `Default`. Azure default is `SQL_LATIN1_GENERAL_CP1_CI_AS`. Changing this forces a new Synapse SQL Pool to be created.
        :param pulumi.Input[builtins.str] create_mode: Specifies how to create the SQL Pool. Valid values are: `Default`, `Recovery` or `PointInTimeRestore`. Must be `Default` to create a new database. Defaults to `Default`. Changing this forces a new Synapse SQL Pool to be created.
        :param pulumi.Input[builtins.bool] data_encrypted: Is transparent data encryption enabled?
        :param pulumi.Input[builtins.bool] geo_backup_policy_enabled: Is geo-backup policy enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Synapse SQL Pool. Changing this forces a new Synapse SQL Pool to be created.
        :param pulumi.Input[builtins.str] recovery_database_id: The ID of the Synapse SQL Pool or SQL Database which is to back up, only applicable when `create_mode` is set to `Recovery`. Changing this forces a new Synapse SQL Pool to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Synapse SQL Pool.
        """
    ...
    def data_encrypted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def data_encrypted(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "data_encrypted", value)

    @property
    @pulumi.getter(name="geoBackupPolicyEnabled")
    def geo_backup_policy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def geo_backup_policy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def recovery_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def recovery_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SqlPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_type: Optional[pulumi.Input[builtins.str]] = None,
            synapse_workspace_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'SqlPool':
        """
    ...
    @property
    @pulumi.getter(name="dataEncrypted")
    def data_encrypted(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is transparent data encryption enabled?
        """
        return pulumi.get(self, "data_encrypted")
    ...
    @property
    @pulumi.getter(name="geoBackupPolicyEnabled")
    def geo_backup_policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is geo-backup policy enabled? Defaults to `true`.
        """
        return pulumi.get(self, "geo_backup_policy_enabled")
    ...
    @property
    @pulumi.getter(name="recoveryDatabaseId")
    def recovery_database_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Synapse SQL Pool or SQL Database which is to back up, only applicable when `create_mode` is set to `Recovery`. Changing this forces a new Synapse SQL Pool to be created.
        """
        return pulumi.get(self, "recovery_database_id")
