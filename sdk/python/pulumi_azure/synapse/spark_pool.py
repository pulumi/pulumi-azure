...
class SparkPool(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            auto_pause = _utilities.configure(auto_pause, SparkPoolAutoPauseArgs, True)
            __props__.__dict__["auto_pause"] = auto_pause
            auto_scale = _utilities.configure(auto_scale, SparkPoolAutoScaleArgs, True)
            ...
            library_requirement = _utilities.configure(library_requirement, SparkPoolLibraryRequirementArgs, True)
            ...
            spark_config = _utilities.configure(spark_config, SparkPoolSparkConfigArgs, True)
