...
class _ReplicaSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The Azure location where this Replica Set should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] service_status: The current service status for the replica set.
        :param pulumi.Input[_builtins.str] subnet_id: The ID of the subnet in which to place this Replica Set. Changing this forces a new resource to be created.
        """
...
class ReplicaSet(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="domainControllerIpAddresses")
    def domain_controller_ip_addresses(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        A list of subnet IP addresses for the domain controllers in this Replica Set, typically two.
        """
        return pulumi.get(self, "domain_controller_ip_addresses")
    ...
    @_builtins.property
    @pulumi.getter(name="externalAccessIpAddress")
    def external_access_ip_address(self) -> pulumi.Output[_builtins.str]:
        """
        The publicly routable IP address for the domain controllers in this Replica Set.
        """
        return pulumi.get(self, "external_access_ip_address")
