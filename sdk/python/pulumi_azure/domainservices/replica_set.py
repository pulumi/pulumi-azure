...
class ReplicaSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        primary_network_security_group = azure.network.network_security_group.NetworkSecurityGroup("primary",
        ...
        primary_subnet_network_security_group_association = azure.network.subnet_network_security_group_association.SubnetNetworkSecurityGroupAssociation("primary",
        ...
        replica = azure.core.resource_group.ResourceGroup("replica",
            name=aadds-replica-rg,
            location=North Europe)
        replica_virtual_network = azure.network.virtual_network.VirtualNetwork("replica",
            name=aadds-replica-vnet,
            location=replica.location,
            resource_group_name=replica.name,
            address_spaces=[10.20.0.0/16])
        aadds_replica = azure.network.subnet.Subnet("aadds_replica",
            name=aadds-replica-subnet,
            resource_group_name=replica.name,
            virtual_network_name=replica_virtual_network.name,
            address_prefixes=[10.20.0.0/24])
        aadds_replica_network_security_group = azure.network.network_security_group.NetworkSecurityGroup("aadds_replica",
        ...
        replica_subnet_network_security_group_association = azure.network.subnet_network_security_group_association.SubnetNetworkSecurityGroupAssociation("replica",
            subnet_id=aadds_replica.id,
            network_security_group_id=aadds_replica_network_security_group.id)
        primary_replica = azure.network.virtual_network_peering.VirtualNetworkPeering("primary_replica",
        ...
        replica_primary = azure.network.virtual_network_peering.VirtualNetworkPeering("replica_primary",
            ...
            allow_virtual_network_access=True,
            use_remote_gateways=False)
        replica_virtual_network_dns_servers = azure.network.virtual_network_dns_servers.VirtualNetworkDnsServers("replica",
        ...
        replica_replica_set = azure.domainservices.replica_set.ReplicaSet("replica",
