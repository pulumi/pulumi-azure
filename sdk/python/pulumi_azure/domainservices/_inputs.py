...
if not MYPY:
    class ServiceInitialReplicaSetArgsDict(TypedDict):
        ...
        """
        domain_controller_ip_addresses: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of subnet IP addresses for the domain controllers in the initial replica set, typically two.
        """
        external_access_ip_address: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceInitialReplicaSetArgs:
    def __init__(__self__, *,
                 subnet_id: pulumi.Input[builtins.str],
                 domain_controller_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 external_access_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 service_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet in which to place the initial replica set. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_controller_ip_addresses: A list of subnet IP addresses for the domain controllers in the initial replica set, typically two.
        :param pulumi.Input[builtins.str] external_access_ip_address: The publicly routable IP address for the domain controllers in the initial replica set.
        :param pulumi.Input[builtins.str] id: A unique ID for the replica set.
        :param pulumi.Input[builtins.str] location: The Azure location where the Domain Service exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] service_status: The current service status for the initial replica set.
        """
    ...
    def domain_controller_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of subnet IP addresses for the domain controllers in the initial replica set, typically two.
        """
    ...
    def domain_controller_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "domain_controller_ip_addresses", value)

    @property
    @pulumi.getter(name="externalAccessIpAddress")
    def external_access_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The publicly routable IP address for the domain controllers in the initial replica set.
        """
    ...
    def external_access_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServiceNotificationsArgsDict(TypedDict):
        ...
        """
        notify_dc_admins: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to notify members of the _AAD DC Administrators_ group when there are alerts in the managed domain.
        """
        notify_global_admins: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServiceNotificationsArgs:
    def __init__(__self__, *,
                 ...
                 notify_dc_admins: Optional[pulumi.Input[builtins.bool]] = None,
                 notify_global_admins: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_recipients: A list of additional email addresses to notify when there are alerts in the managed domain.
        :param pulumi.Input[builtins.bool] notify_dc_admins: Whether to notify members of the _AAD DC Administrators_ group when there are alerts in the managed domain.
        :param pulumi.Input[builtins.bool] notify_global_admins: Whether to notify all Global Administrators when there are alerts in the managed domain.
        """
    ...
    def notify_dc_admins(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to notify members of the _AAD DC Administrators_ group when there are alerts in the managed domain.
        """
    ...
    def notify_dc_admins(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "notify_dc_admins", value)

    @property
    @pulumi.getter(name="notifyGlobalAdmins")
    def notify_global_admins(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to notify all Global Administrators when there are alerts in the managed domain.
        """
    ...
    def notify_global_admins(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ServiceSecureLdapArgsDict(TypedDict):
        ...
        """
        external_access_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServiceSecureLdapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pfx_certificate: The certificate/private key to use for LDAPS, as a base64-encoded TripleDES-SHA1 encrypted PKCS#12 bundle (PFX file).
        :param pulumi.Input[builtins.str] pfx_certificate_password: The password to use for decrypting the PKCS#12 bundle (PFX file).
        :param pulumi.Input[builtins.str] certificate_expiry: The expiry time of the certificate.
        :param pulumi.Input[builtins.str] certificate_thumbprint: The thumbprint of the certificate.
        :param pulumi.Input[builtins.bool] external_access_enabled: Whether to enable external access to LDAPS over the Internet. Defaults to `false`.
    ...
    def pfx_certificate(self) -> pulumi.Input[builtins.str]:
        """
        The certificate/private key to use for LDAPS, as a base64-encoded TripleDES-SHA1 encrypted PKCS#12 bundle (PFX file).
        """
    ...
    def pfx_certificate(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "pfx_certificate", value)

    @property
    @pulumi.getter(name="pfxCertificatePassword")
    def pfx_certificate_password(self) -> pulumi.Input[builtins.str]:
        """
        The password to use for decrypting the PKCS#12 bundle (PFX file).
        """
    ...
    def pfx_certificate_password(self, value: pulumi.Input[builtins.str]):
...
class ServiceSecurityArgs:
    def __init__(__self__, *,
                 kerberos_armoring_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kerberos_rc4_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ntlm_v1_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_kerberos_passwords: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_ntlm_passwords: Optional[pulumi.Input[builtins.bool]] = None,
                 sync_on_prem_passwords: Optional[pulumi.Input[builtins.bool]] = None,
                 tls_v1_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] kerberos_armoring_enabled: Whether to enable Kerberos Armoring. Defaults to `false`.
        :param pulumi.Input[builtins.bool] kerberos_rc4_encryption_enabled: Whether to enable Kerberos RC4 Encryption. Defaults to `false`.
        :param pulumi.Input[builtins.bool] ntlm_v1_enabled: Whether to enable legacy NTLM v1 support. Defaults to `false`.
        :param pulumi.Input[builtins.bool] sync_kerberos_passwords: Whether to synchronize Kerberos password hashes to the managed domain. Defaults to `false`.
        :param pulumi.Input[builtins.bool] sync_ntlm_passwords: Whether to synchronize NTLM password hashes to the managed domain. Defaults to `false`.
        :param pulumi.Input[builtins.bool] sync_on_prem_passwords: Whether to synchronize on-premises password hashes to the managed domain. Defaults to `false`.
        :param pulumi.Input[builtins.bool] tls_v1_enabled: Whether to enable legacy TLS v1 support. Defaults to `false`.
        """
    ...
    def kerberos_armoring_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable Kerberos Armoring. Defaults to `false`.
        """
    ...
    def kerberos_armoring_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "kerberos_armoring_enabled", value)

    @property
    @pulumi.getter(name="kerberosRc4EncryptionEnabled")
    def kerberos_rc4_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable Kerberos RC4 Encryption. Defaults to `false`.
        """
    ...
    def kerberos_rc4_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "kerberos_rc4_encryption_enabled", value)

    @property
    @pulumi.getter(name="ntlmV1Enabled")
    def ntlm_v1_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable legacy NTLM v1 support. Defaults to `false`.
        """
    ...
    def ntlm_v1_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ntlm_v1_enabled", value)

    @property
    @pulumi.getter(name="syncKerberosPasswords")
    def sync_kerberos_passwords(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to synchronize Kerberos password hashes to the managed domain. Defaults to `false`.
        """
    ...
    def sync_kerberos_passwords(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sync_kerberos_passwords", value)

    @property
    @pulumi.getter(name="syncNtlmPasswords")
    def sync_ntlm_passwords(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to synchronize NTLM password hashes to the managed domain. Defaults to `false`.
        """
    ...
    def sync_ntlm_passwords(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sync_ntlm_passwords", value)

    @property
    @pulumi.getter(name="syncOnPremPasswords")
    def sync_on_prem_passwords(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to synchronize on-premises password hashes to the managed domain. Defaults to `false`.
        """
    ...
    def sync_on_prem_passwords(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "sync_on_prem_passwords", value)

    @property
    @pulumi.getter(name="tlsV1Enabled")
    def tls_v1_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable legacy TLS v1 support. Defaults to `false`.
        """
    ...
    def tls_v1_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
