...
class NamespaceAuthorizationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] namespace_name: Name of the Azure Relay Namespace for which this Azure Relay Namespace Authorization Rule will be created. Changing this forces a new Azure Relay Namespace Authorization Rule to be created.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Azure Relay Namespace Authorization Rule should exist. Changing this forces a new Azure Relay Namespace Authorization Rule to be created.
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Azure Relay Namespace Authorization Rule. Changing this forces a new Azure Relay Namespace Authorization Rule to be created.
...
class _NamespaceAuthorizationRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Azure Relay Namespace Authorization Rule. Changing this forces a new Azure Relay Namespace Authorization Rule to be created.
        :param pulumi.Input[_builtins.str] namespace_name: Name of the Azure Relay Namespace for which this Azure Relay Namespace Authorization Rule will be created. Changing this forces a new Azure Relay Namespace Authorization Rule to be created.
        :param pulumi.Input[_builtins.str] primary_connection_string: The Primary Connection String for the Azure Relay Namespace Authorization Rule.
        :param pulumi.Input[_builtins.str] primary_key: The Primary Key for the Azure Relay Namespace Authorization Rule.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Azure Relay Namespace Authorization Rule should exist. Changing this forces a new Azure Relay Namespace Authorization Rule to be created.
        :param pulumi.Input[_builtins.str] secondary_connection_string: The Secondary Connection String for the Azure Relay Namespace Authorization Rule.
        :param pulumi.Input[_builtins.str] secondary_key: The Secondary Key for the Azure Relay Namespace Authorization Rule.
        :param pulumi.Input[_builtins.bool] send: Grants send access to this Authorization Rule. Defaults to `false`.
        """
        if listen is not None:
            pulumi.set(__self__, "listen", listen)
