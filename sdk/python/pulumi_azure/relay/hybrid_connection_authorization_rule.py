...
class HybridConnectionAuthorizationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Azure Relay Hybrid Connection Authorization Rule. Changing this forces a new Azure Relay Hybrid Connection Authorization Rule to be created.
...
class _HybridConnectionAuthorizationRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Azure Relay Hybrid Connection Authorization Rule. Changing this forces a new Azure Relay Hybrid Connection Authorization Rule to be created.
        :param pulumi.Input[_builtins.str] namespace_name: Name of the Azure Relay Namespace for which this Azure Relay Hybrid Connection Authorization Rule will be created. Changing this forces a new Azure Relay Hybrid Connection Authorization Rule to be created.
        :param pulumi.Input[_builtins.str] primary_connection_string: The Primary Connection String for the Azure Relay Hybrid Connection Authorization Rule.
        :param pulumi.Input[_builtins.str] primary_key: The Primary Key for the Azure Relay Hybrid Connection Authorization Rule.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Azure Relay Hybrid Connection Authorization Rule should exist. Changing this forces a new Azure Relay Hybrid Connection Authorization Rule to be created.
        :param pulumi.Input[_builtins.str] secondary_connection_string: The Secondary Connection String for the Azure Relay Hybrid Connection Authorization Rule.
        :param pulumi.Input[_builtins.str] secondary_key: The Secondary Key for the Azure Relay Hybrid Connection Authorization Rule.
        :param pulumi.Input[_builtins.bool] send: Grants send access to this Authorization Rule. Defaults to `false`.
        """
...
class HybridConnectionAuthorizationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_connection_string: Optional[pulumi.Input[_builtins.str]] = None,
            secondary_key: Optional[pulumi.Input[_builtins.str]] = None,
            send: Optional[pulumi.Input[_builtins.bool]] = None) -> 'HybridConnectionAuthorizationRule':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="hybridConnectionName")
    def hybrid_connection_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the Azure Relay Hybrid Connection for which this Azure Relay Hybrid Connection Authorization Rule will be created. Changing this forces a new Azure Relay Hybrid Connection Authorization Rule to be created.
        """
        return pulumi.get(self, "hybrid_connection_name")
