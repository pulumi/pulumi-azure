...
class CollectorPolicyIpfxEmission(dict):
    ...
    def __init__(__self__, *,
                 destination_types: builtins.str):
        """
        :param builtins.str destination_types: A list of emission destination types. The only possible value is `AzureMonitor`. Changing this forces a new Network Function Collector Policy to be created.
    ...
    def destination_types(self) -> builtins.str:
        """
...
class CollectorPolicyIpfxIngestion(dict):
    ...
    def __init__(__self__, *,
                 source_resource_ids: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] source_resource_ids: A list of ingestion source resource IDs. Changing this forces a new Network Function Collector Policy to be created.
        """
        pulumi.set(__self__, "source_resource_ids", source_resource_ids)

    @property
    @pulumi.getter(name="sourceResourceIds")
    def source_resource_ids(self) -> Sequence[builtins.str]:
        """
