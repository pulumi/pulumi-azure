...
if not MYPY:
    class CollectorPolicyIpfxEmissionArgsDict(TypedDict):
        destination_types: pulumi.Input[builtins.str]
        """
...
class CollectorPolicyIpfxEmissionArgs:
    def __init__(__self__, *,
                 destination_types: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] destination_types: A list of emission destination types. The only possible value is `AzureMonitor`. Changing this forces a new Network Function Collector Policy to be created.
    ...
    def destination_types(self) -> pulumi.Input[builtins.str]:
        """
        A list of emission destination types. The only possible value is `AzureMonitor`. Changing this forces a new Network Function Collector Policy to be created.
    ...
    def destination_types(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_types", value)


if not MYPY:
    class CollectorPolicyIpfxIngestionArgsDict(TypedDict):
        source_resource_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class CollectorPolicyIpfxIngestionArgs:
    def __init__(__self__, *,
                 source_resource_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_resource_ids: A list of ingestion source resource IDs. Changing this forces a new Network Function Collector Policy to be created.
        """
        pulumi.set(__self__, "source_resource_ids", source_resource_ids)

    @property
    @pulumi.getter(name="sourceResourceIds")
    def source_resource_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of ingestion source resource IDs. Changing this forces a new Network Function Collector Policy to be created.
        """
    ...
    def source_resource_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
