...
class AzureTrafficCollectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Network Function Azure Traffic Collector should exist. Changing this forces a new Network Function Azure Traffic Collector to be created.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Network Function Azure Traffic Collector should exist. Changing this forces a new Network Function Azure Traffic Collector to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Function Azure Traffic Collector. Changing this forces a new Network Function Azure Traffic Collector to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Network Function Azure Traffic Collector.
        """
...
class _AzureTrafficCollectorState:
    def __init__(__self__, *,
                 collector_policy_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 virtual_hub_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering AzureTrafficCollector resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] collector_policy_ids: The list of Resource IDs of collector policies.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Network Function Azure Traffic Collector should exist. Changing this forces a new Network Function Azure Traffic Collector to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Function Azure Traffic Collector. Changing this forces a new Network Function Azure Traffic Collector to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Network Function Azure Traffic Collector should exist. Changing this forces a new Network Function Azure Traffic Collector to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Network Function Azure Traffic Collector.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] virtual_hub_ids: The Resource ID of virtual hub.
        """
    ...
    def collector_policy_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def collector_policy_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def virtual_hub_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def virtual_hub_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AzureTrafficCollector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_hub_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AzureTrafficCollector':
        """
    ...
    @property
    @pulumi.getter(name="collectorPolicyIds")
    def collector_policy_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of Resource IDs of collector policies.
        """
        return pulumi.get(self, "collector_policy_ids")
    ...
    @property
    @pulumi.getter(name="virtualHubIds")
    def virtual_hub_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The Resource ID of virtual hub.
        """
        return pulumi.get(self, "virtual_hub_ids")
