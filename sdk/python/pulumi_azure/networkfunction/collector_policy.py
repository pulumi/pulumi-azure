...
class CollectorPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] traffic_collector_id: Specifies the Azure Traffic Collector ID of the Network Function Collector Policy. Changing this forces a new Network Function Collector Policy to be created.
    ...
    def traffic_collector_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def traffic_collector_id(self, value: pulumi.Input[_builtins.str]):
...
class CollectorPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="trafficCollectorId")
    def traffic_collector_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the Azure Traffic Collector ID of the Network Function Collector Policy. Changing this forces a new Network Function Collector Policy to be created.
        """
        return pulumi.get(self, "traffic_collector_id")
