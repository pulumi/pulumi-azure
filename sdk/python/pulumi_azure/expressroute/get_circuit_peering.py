...
class GetCircuitPeeringResult:
    ...
    def express_route_circuit_name(self) -> _builtins.str:
        return pulumi.get(self, "express_route_circuit_name")

    @_builtins.property
    @pulumi.getter(name="gatewayManagerEtag")
    def gateway_manager_etag(self) -> _builtins.str:
    ...
    def primary_peer_address_prefix(self) -> _builtins.str:
        """
    ...
    def secondary_peer_address_prefix(self) -> _builtins.str:
        """
...
def get_circuit_peering(express_route_circuit_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str peering_type: The type of the ExpressRoute Circuit Peering. Acceptable values include `AzurePrivatePeering`, `AzurePublicPeering` and `MicrosoftPeering`.
    :param _builtins.str resource_group_name: The name of the resource group in which to create the Express Route Circuit Peering. Changing this forces a new resource to be created.
    """
    __args__ = dict()
