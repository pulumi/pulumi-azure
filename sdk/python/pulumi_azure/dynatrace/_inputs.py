...
class MonitorIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of identity used for the resource. Only possible value is `SystemAssigned`.
        """
...
if not MYPY:
    class MonitorPlanArgsDict(TypedDict):
        ...
        """
        effective_date: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MonitorPlanArgs:
    def __init__(__self__, *,
                 ...
                 effective_date: Optional[pulumi.Input[builtins.str]] = None,
                 usage_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] plan: Plan id as published by Dynatrace.
        :param pulumi.Input[builtins.str] billing_cycle: Different billing cycles. Possible values are `MONTHLY` and `WEEKLY`.
        :param pulumi.Input[builtins.str] effective_date: Date when plan was applied.
        :param pulumi.Input[builtins.str] usage_type: Different usage type. Possible values are `PAYG` and `COMMITTED`.
        """
    ...
    def effective_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Date when plan was applied.
        """
    ...
    def effective_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MonitorUserArgs:
    def __init__(__self__, *,
                 ...
                 phone_number: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] country: Country of the user.
        :param pulumi.Input[builtins.str] email: Email of the user used by Dynatrace for contacting them if needed.
        ...
        :param pulumi.Input[builtins.str] phone_number: phone number of the user by Dynatrace for contacting them if needed.
        """
...
class TagRulesLogRuleArgs:
    def __init__(__self__, *,
                 ...
                 send_activity_logs_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def send_activity_logs_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def send_azure_active_directory_logs_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def send_subscription_logs_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
