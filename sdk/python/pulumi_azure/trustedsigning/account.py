...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Trusted Signing Account should exist. Changing this forces a new Trusted Signing Account to be created.
        :param pulumi.Input[builtins.str] sku_name: The sku name of this Trusted Signing Account. Possible values are `Basic` and `Premium`.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Trusted Signing Account should exist. Changing this forces a new Trusted Signing Account to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Trusted Signing Account. Changing this forces a new Trusted Signing Account to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Trusted Signing Account.
        """
...
class _AccountState:
    def __init__(__self__, *,
                 account_uri: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] account_uri: The URI of the Trusted Signing Account which is used during signing files.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Trusted Signing Account should exist. Changing this forces a new Trusted Signing Account to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Trusted Signing Account. Changing this forces a new Trusted Signing Account to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Trusted Signing Account should exist. Changing this forces a new Trusted Signing Account to be created.
        :param pulumi.Input[builtins.str] sku_name: The sku name of this Trusted Signing Account. Possible values are `Basic` and `Premium`.
    ...
    def account_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @account_uri.setter
    def account_uri(self, value: Optional[pulumi.Input[builtins.str]]):
