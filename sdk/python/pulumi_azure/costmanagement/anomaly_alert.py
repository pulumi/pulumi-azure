...
class AnomalyAlertArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name which should be used for this Cost Anomaly Alert.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] email_addresses: Specifies a list of email addresses which the Anomaly Alerts are send to.
        :param pulumi.Input[builtins.str] email_subject: The email subject of the Cost Anomaly Alerts. Maximum length of the subject is 70.
        :param pulumi.Input[builtins.str] message: The message of the Cost Anomaly Alert. Maximum length of the message is 250.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Cost Anomaly Alert. Changing this forces a new resource to be created. The name can contain only lowercase letters, numbers and hyphens.
        :param pulumi.Input[builtins.str] notification_email: The email address of the point of contact that should get the unsubscribe requests and notification emails.
        :param pulumi.Input[builtins.str] subscription_id: The ID of the Subscription this Cost Anomaly Alert is scoped to. Changing this forces a new resource to be created. When not supplied this defaults to the subscription configured in the provider.
        """
...
class AnomalyAlert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            notification_email: Optional[pulumi.Input[builtins.str]] = None,
            subscription_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AnomalyAlert':
        """
