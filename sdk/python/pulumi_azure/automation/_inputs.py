...
if not MYPY:
    class AccountEncryptionArgsDict(TypedDict):
        ...
        """
        key_source: NotRequired[pulumi.Input[builtins.str]]
...
class AccountEncryptionArgs:
    def __init__(__self__, *,
                 key_vault_key_id: pulumi.Input[builtins.str],
                 key_source: Optional[pulumi.Input[builtins.str]] = None,
                 user_assigned_identity_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key_vault_key_id: The ID of the Key Vault Key which should be used to Encrypt the data in this Automation Account.
        :param pulumi.Input[builtins.str] user_assigned_identity_id: The User Assigned Managed Identity ID to be used for accessing the Customer Managed Key for encryption.
        """
    ...
    @key_source.setter
    def key_source(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AccountIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of identity used for this Automation Account. Possible values are `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: The ID of the User Assigned Identity which should be assigned to this Automation Account.
...
class AccountPrivateEndpointConnectionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of the Automation Account.
...
class ConnectionTypeFieldArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this connection field definition.
        :param pulumi.Input[builtins.str] type: The type of the connection field definition.
        :param pulumi.Input[builtins.bool] is_encrypted: Whether to set the isEncrypted flag of the connection field definition.
        :param pulumi.Input[builtins.bool] is_optional: Whether to set the isOptional flag of the connection field definition.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ModuleModuleLinkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] uri: The URI of the module content (zip or nupkg).
...
class ModuleModuleLinkHashArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] algorithm: Specifies the algorithm used for the hash content.
        :param pulumi.Input[builtins.str] value: The hash value of the content.
        """
...
if not MYPY:
    class RunBookDraftArgsDict(TypedDict):
        ...
        edit_mode_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class RunBookDraftArgs:
    def __init__(__self__, *,
                 ...
                 edit_mode_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] edit_mode_enabled: Whether the draft in edit mode.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] output_types: Specifies the output types of the runbook.
    ...
    def edit_mode_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the draft in edit mode.
        """
    ...
    def edit_mode_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class RunBookDraftContentLinkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] uri: The URI of the runbook content.
        :param pulumi.Input['RunBookDraftContentLinkHashArgs'] hash: A `hash` block as defined below.
        :param pulumi.Input[builtins.str] version: Specifies the version of the content
        """
        pulumi.set(__self__, "uri", uri)
        if hash is not None:
            pulumi.set(__self__, "hash", hash)
...
class RunBookDraftContentLinkHashArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] algorithm: Specifies the hash algorithm used to hash the content.
        :param pulumi.Input[builtins.str] value: Specifies the expected hash value of the content.
        """
        pulumi.set(__self__, "algorithm", algorithm)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class RunBookDraftParameterArgsDict(TypedDict):
        ...
        """
        mandatory: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class RunBookDraftParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Specifies the type of this parameter.
        :param pulumi.Input[builtins.str] default_value: Specifies the default value of the parameter.
        :param pulumi.Input[builtins.bool] mandatory: Whether this parameter is mandatory.
        :param pulumi.Input[builtins.int] position: Specifies the position of the parameter.
        """
...
if not MYPY:
    class RunBookJobScheduleArgsDict(TypedDict):
        ...
        """
        job_schedule_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        run_on: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RunBookJobScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] schedule_name: The name of the Schedule.
        :param pulumi.Input[builtins.str] job_schedule_id: The UUID of automation runbook job schedule ID.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of key/value pairs corresponding to the arguments that can be passed to the Runbook.
               
               > **Note:** The parameter keys/names must strictly be in lowercase, even if this is not the case in the runbook. This is due to a limitation in Azure Automation where the parameter names are normalized. The values specified don't have this limitation.
        :param pulumi.Input[builtins.str] run_on: Name of a Hybrid Worker Group the Runbook will be executed on.
        """
...
if not MYPY:
    class ScheduleMonthlyOccurrenceArgsDict(TypedDict):
        ...
        """
        occurrence: pulumi.Input[builtins.int]
        """
...
class ScheduleMonthlyOccurrenceArgs:
    def __init__(__self__, *,
                 ...
                 occurrence: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] day: Day of the occurrence. Must be one of `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, `Sunday`.
        :param pulumi.Input[builtins.int] occurrence: Occurrence of the week within the month. Must be between `1` and `5`. `-1` for last week within the month.
        """
    ...
    @property
    @pulumi.getter
    def occurrence(self) -> pulumi.Input[builtins.int]:
        """
        Occurrence of the week within the month. Must be between `1` and `5`. `-1` for last week within the month.
        """
    ...
    @occurrence.setter
    def occurrence(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "occurrence", value)


if not MYPY:
    class SoftwareUpdateConfigurationLinuxArgsDict(TypedDict):
        classifications_includeds: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        excluded_packages: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies a list of packages to excluded from the Software Update Configuration.
        """
        included_packages: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies a list of packages to included from the Software Update Configuration.
        """
        reboot: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SoftwareUpdateConfigurationLinuxArgs:
    def __init__(__self__, *,
                 classifications_includeds: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 excluded_packages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_packages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 reboot: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] classifications_includeds: Specifies the list of update classifications included in the Software Update Configuration. Possible values are `Unclassified`, `Critical`, `Security` and `Other`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_packages: Specifies a list of packages to excluded from the Software Update Configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_packages: Specifies a list of packages to included from the Software Update Configuration.
        :param pulumi.Input[builtins.str] reboot: Specifies the reboot settings after software update, possible values are `IfRequired`, `Never`, `RebootOnly` and `Always`. Defaults to `IfRequired`.
        """
    ...
    def classifications_includeds(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies the list of update classifications included in the Software Update Configuration. Possible values are `Unclassified`, `Critical`, `Security` and `Other`.
        """
    ...
    def classifications_includeds(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "classifications_includeds", value)

    @property
    @pulumi.getter(name="excludedPackages")
    def excluded_packages(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of packages to excluded from the Software Update Configuration.
        """
    ...
    def excluded_packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_packages", value)

    @property
    @pulumi.getter(name="includedPackages")
    def included_packages(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of packages to included from the Software Update Configuration.
        """
    ...
    def included_packages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "included_packages", value)

    @property
    @pulumi.getter
    def reboot(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the reboot settings after software update, possible values are `IfRequired`, `Never`, `RebootOnly` and `Always`. Defaults to `IfRequired`.
        """
    ...
    @reboot.setter
    def reboot(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SoftwareUpdateConfigurationPostTaskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Specifies a map of parameters for the task.
        :param pulumi.Input[builtins.str] source: The name of the runbook for the post task.
        """
        if parameters is not None:
            pulumi.set(__self__, "parameters", parameters)
...
class SoftwareUpdateConfigurationPreTaskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Specifies a map of parameters for the task.
        :param pulumi.Input[builtins.str] source: The name of the runbook for the pre task.
        """
        if parameters is not None:
            pulumi.set(__self__, "parameters", parameters)
        if source is not None:
...
if not MYPY:
    class SoftwareUpdateConfigurationScheduleArgsDict(TypedDict):
        ...
        """
        advanced_month_days: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
        List of days of the month that the job should execute on. Must be between `1` and `31`. `-1` for last day of the month. Only valid when frequency is `Month`.
        """
        advanced_week_days: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        start_time_offset_minutes: NotRequired[pulumi.Input[builtins.float]]
...
class SoftwareUpdateConfigurationScheduleArgs:
    def __init__(__self__, *,
                 frequency: pulumi.Input[builtins.str],
                 advanced_month_days: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 advanced_week_days: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 creation_time: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 start_time_offset_minutes: Optional[pulumi.Input[builtins.float]] = None,
                 time_zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] frequency: The frequency of the schedule. - can be either `OneTime`, `Day`, `Hour`, `Week`, or `Month`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] advanced_month_days: List of days of the month that the job should execute on. Must be between `1` and `31`. `-1` for last day of the month. Only valid when frequency is `Month`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] advanced_week_days: List of days of the week that the job should execute on. Only valid when frequency is `Week`. Possible values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`.
        :param pulumi.Input[builtins.str] description: A description for this Schedule.
        :param pulumi.Input[builtins.str] expiry_time: The end time of the schedule.
        :param pulumi.Input[builtins.int] interval: The number of `frequency`s between runs. Only valid when frequency is `Day`, `Hour`, `Week`, or `Month`.
        :param pulumi.Input[builtins.bool] is_enabled: Whether the schedule is enabled. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] start_time: Start time of the schedule. Must be at least five minutes in the future. Defaults to seven minutes in the future from the time the resource is created.
        :param pulumi.Input[builtins.str] time_zone: The timezone of the start time. Defaults to `Etc/UTC`. For possible values see: <https://docs.microsoft.com/en-us/rest/api/maps/timezone/gettimezoneenumwindows>
        """
    ...
    def advanced_month_days(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        List of days of the month that the job should execute on. Must be between `1` and `31`. `-1` for last day of the month. Only valid when frequency is `Month`.
        """
    ...
    def advanced_month_days(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "advanced_month_days", value)

    @property
    @pulumi.getter(name="advancedWeekDays")
    def advanced_week_days(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of days of the week that the job should execute on. Only valid when frequency is `Week`. Possible values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`.
        """
    ...
    def advanced_week_days(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def start_time_offset_minutes(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "start_time_offset_minutes")

    @start_time_offset_minutes.setter
    def start_time_offset_minutes(self, value: Optional[pulumi.Input[builtins.float]]):
...
class SoftwareUpdateConfigurationScheduleMonthlyOccurrenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] day: Day of the occurrence. Must be one of `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, `Sunday`.
        :param pulumi.Input[builtins.int] occurrence: Occurrence of the week within the month. Must be between `1` and `4`. `-1` for last week within the month.
        """
        pulumi.set(__self__, "day", day)
        pulumi.set(__self__, "occurrence", occurrence)
...
if not MYPY:
    class SoftwareUpdateConfigurationTargetAzureQueryArgsDict(TypedDict):
        ...
        """
        tag_filter: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SoftwareUpdateConfigurationTargetAzureQueryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: Specifies a list of locations to scope the query to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Specifies a list of Subscription or Resource Group ARM Ids to query.
        :param pulumi.Input[builtins.str] tag_filter: Specifies how the specified tags to filter VMs. Possible values are `Any` and `All`.
...
class SoftwareUpdateConfigurationTargetAzureQueryTagArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] tag: Specifies the name of the tag to filter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies a list of values for this tag key.
        """
...
class SoftwareUpdateConfigurationTargetNonAzureQueryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] function_alias: Specifies the Log Analytics save search name.
        :param pulumi.Input[builtins.str] workspace_id: The workspace id for Log Analytics in which the saved search in.
        """
...
if not MYPY:
    class SoftwareUpdateConfigurationWindowsArgsDict(TypedDict):
        ...
        """
        excluded_knowledge_base_numbers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies a list of knowledge base numbers excluded.
        """
        included_knowledge_base_numbers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SoftwareUpdateConfigurationWindowsArgs:
    def __init__(__self__, *,
                 classifications_includeds: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 excluded_knowledge_base_numbers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 included_knowledge_base_numbers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 reboot: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] classifications_includeds: Specifies the list of update classification. Possible values are `Unclassified`, `Critical`, `Security`, `UpdateRollup`, `FeaturePack`, `ServicePack`, `Definition`, `Tools` and `Updates`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_knowledge_base_numbers: Specifies a list of knowledge base numbers excluded.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_knowledge_base_numbers: Specifies a list of knowledge base numbers included.
        :param pulumi.Input[builtins.str] reboot: Specifies the reboot settings after software update, possible values are `IfRequired`, `Never`, `RebootOnly` and `Always`. Defaults to `IfRequired`.
        """
        pulumi.set(__self__, "classifications_includeds", classifications_includeds)
    ...
    def excluded_knowledge_base_numbers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of knowledge base numbers excluded.
        """
    ...
    def excluded_knowledge_base_numbers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "excluded_knowledge_base_numbers", value)

    @property
    @pulumi.getter(name="includedKnowledgeBaseNumbers")
    def included_knowledge_base_numbers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of knowledge base numbers included.
        """
    ...
    def included_knowledge_base_numbers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class SourceControlSecurityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] token: The access token of specified repo.
        :param pulumi.Input[builtins.str] token_type: Specify the token type, possible values are `PersonalAccessToken` and `Oauth`.
        :param pulumi.Input[builtins.str] refresh_token: The refresh token of specified rpeo.
        """
