...
def get_variables(automation_account_id: Optional[builtins.str] = None,
...
def get_variables_output(automation_account_id: Optional[pulumi.Input[builtins.str]] = None,
