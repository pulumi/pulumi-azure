...
class HybridRunbookWorkerArgs:
    def __init__(__self__, *,
                 ...
                 vm_resource_id: pulumi.Input[builtins.str],
                 worker_group_name: pulumi.Input[builtins.str],
                 worker_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a HybridRunbookWorker resource.
        :param pulumi.Input[builtins.str] automation_account_name: The name of the automation account in which the Hybrid Worker is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Automation should exist. Changing this forces a new Automation to be created.
        :param pulumi.Input[builtins.str] vm_resource_id: The ID of the virtual machine used for this HybridWorker. Changing this forces a new Automation to be created.
        :param pulumi.Input[builtins.str] worker_group_name: The name of the HybridWorker Group. Changing this forces a new Automation to be created.
        :param pulumi.Input[builtins.str] worker_id: Specify the ID of this HybridWorker in UUID notation. Changing this forces a new Automation to be created.
        """
    ...
    def vm_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vm_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vm_resource_id", value)

    @property
    @pulumi.getter(name="workerGroupName")
    def worker_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def worker_group_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "worker_group_name", value)

    @property
    @pulumi.getter(name="workerId")
    def worker_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @worker_id.setter
    def worker_id(self, value: pulumi.Input[builtins.str]):
...
class _HybridRunbookWorkerState:
    def __init__(__self__, *,
                 ...
                 last_seen_date_time: Optional[pulumi.Input[builtins.str]] = None,
                 registration_date_time: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 vm_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 worker_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 worker_id: Optional[pulumi.Input[builtins.str]] = None,
                 worker_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] automation_account_name: The name of the automation account in which the Hybrid Worker is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] ip: The IP address of assigned machine.
        :param pulumi.Input[builtins.str] last_seen_date_time: Last Heartbeat from the Worker.
        :param pulumi.Input[builtins.str] registration_date_time: The registration time of the worker machine.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Automation should exist. Changing this forces a new Automation to be created.
        :param pulumi.Input[builtins.str] vm_resource_id: The ID of the virtual machine used for this HybridWorker. Changing this forces a new Automation to be created.
        :param pulumi.Input[builtins.str] worker_group_name: The name of the HybridWorker Group. Changing this forces a new Automation to be created.
        :param pulumi.Input[builtins.str] worker_id: Specify the ID of this HybridWorker in UUID notation. Changing this forces a new Automation to be created.
        :param pulumi.Input[builtins.str] worker_name: The name of HybridWorker.
        :param pulumi.Input[builtins.str] worker_type: The type of the HybridWorker, the possible values are `HybridV1` and `HybridV2`.
        """
    ...
    def last_seen_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_seen_date_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_seen_date_time", value)

    @property
    @pulumi.getter(name="registrationDateTime")
    def registration_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def registration_date_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="workerGroupName")
    def worker_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the HybridWorker Group. Changing this forces a new Automation to be created.
        """
        return pulumi.get(self, "worker_group_name")
    ...
    @worker_group_name.setter
    def worker_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "worker_group_name", value)
    ...
    def worker_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @worker_name.setter
    def worker_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HybridRunbookWorker(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            worker_id: Optional[pulumi.Input[builtins.str]] = None,
            worker_name: Optional[pulumi.Input[builtins.str]] = None,
            worker_type: Optional[pulumi.Input[builtins.str]] = None) -> 'HybridRunbookWorker':
        """
    ...
    @property
    @pulumi.getter(name="lastSeenDateTime")
    def last_seen_date_time(self) -> pulumi.Output[builtins.str]:
        """
        Last Heartbeat from the Worker.
        """
        return pulumi.get(self, "last_seen_date_time")
    ...
    @property
    @pulumi.getter(name="registrationDateTime")
    def registration_date_time(self) -> pulumi.Output[builtins.str]:
        """
        The registration time of the worker machine.
        """
        return pulumi.get(self, "registration_date_time")
    ...
    @property
    @pulumi.getter(name="vmResourceId")
    def vm_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the virtual machine used for this HybridWorker. Changing this forces a new Automation to be created.
        """
        return pulumi.get(self, "vm_resource_id")
    ...
    @property
    @pulumi.getter(name="workerGroupName")
    def worker_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the HybridWorker Group. Changing this forces a new Automation to be created.
        """
        return pulumi.get(self, "worker_group_name")
    ...
    @property
    @pulumi.getter(name="workerId")
    def worker_id(self) -> pulumi.Output[builtins.str]:
        """
        Specify the ID of this HybridWorker in UUID notation. Changing this forces a new Automation to be created.
        """
        return pulumi.get(self, "worker_id")
    ...
    @property
    @pulumi.getter(name="workerName")
    def worker_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of HybridWorker.
        """
        return pulumi.get(self, "worker_name")
