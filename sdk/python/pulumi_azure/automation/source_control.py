...
class SourceControlArgs:
    def __init__(__self__, *,
                 ...
                 source_control_type: pulumi.Input[builtins.str],
                 automatic_sync: Optional[pulumi.Input[builtins.bool]] = None,
                 branch: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 publish_runbook_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SourceControl resource.
        :param pulumi.Input[builtins.str] automation_account_id: The ID of Automation Account to manage this Source Control. Changing this forces a new Automation Source Control to be created.
        :param pulumi.Input[builtins.str] folder_path: The folder path of the source control. This Path must be relative.
        :param pulumi.Input[builtins.str] repository_url: The Repository URL of the source control.
        :param pulumi.Input['SourceControlSecurityArgs'] security: A `security` block as defined below.
        :param pulumi.Input[builtins.str] source_control_type: The source type of Source Control, possible vaules are `VsoGit`, `VsoTfvc` and `GitHub`, and the value is case sensitive.
        :param pulumi.Input[builtins.bool] automatic_sync: Whether auto async the Source Control.
        :param pulumi.Input[builtins.str] branch: Specify the repo branch of the Source Control. Empty value is valid only for `VsoTfvc`.
        :param pulumi.Input[builtins.str] description: A short description of the Source Control.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Automation Source Control. Changing this forces a new Automation Source Control to be created.
        :param pulumi.Input[builtins.bool] publish_runbook_enabled: Whether auto publish the Source Control. Defaults to `true`.
        """
    ...
    def source_control_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_control_type(self, value: pulumi.Input[builtins.str]):
    ...
    def publish_runbook_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def publish_runbook_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SourceControlState:
    def __init__(__self__, *,
                 ...
                 source_control_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sourceControlType")
    def source_control_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The source type of Source Control, possible vaules are `VsoGit`, `VsoTfvc` and `GitHub`, and the value is case sensitive.
        """
        return pulumi.get(self, "source_control_type")
    ...
    @source_control_type.setter
    def source_control_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_control_type", value)
...
class SourceControl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repository_url: Optional[pulumi.Input[builtins.str]] = None,
            security: Optional[pulumi.Input[Union['SourceControlSecurityArgs', 'SourceControlSecurityArgsDict']]] = None,
            source_control_type: Optional[pulumi.Input[builtins.str]] = None) -> 'SourceControl':
        """
    ...
    @property
    @pulumi.getter(name="automaticSync")
    def automatic_sync(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether auto async the Source Control.
        """
        return pulumi.get(self, "automatic_sync")
    ...
    @property
    @pulumi.getter(name="publishRunbookEnabled")
    def publish_runbook_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether auto publish the Source Control. Defaults to `true`.
        """
        return pulumi.get(self, "publish_runbook_enabled")
    ...
    @property
    @pulumi.getter(name="sourceControlType")
    def source_control_type(self) -> pulumi.Output[builtins.str]:
        """
        The source type of Source Control, possible vaules are `VsoGit`, `VsoTfvc` and `GitHub`, and the value is case sensitive.
        """
        return pulumi.get(self, "source_control_type")
