...
class SoftwareUpdateConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] duration: Maximum time allowed for the software update configuration run. using format `PT[n]H[n]M[n]S` as per ISO8601. Defaults to `PT2H`.
        :param pulumi.Input['SoftwareUpdateConfigurationLinuxArgs'] linux: A `linux` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Automation. Changing this forces a new Automation to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] non_azure_computer_names: Specifies a list of names of non-Azure machines for the software update configuration.
...
class _SoftwareUpdateConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] automation_account_id: The ID of Automation Account to manage this Source Control. Changing this forces a new Automation Source Control to be created.
        :param pulumi.Input[builtins.str] duration: Maximum time allowed for the software update configuration run. using format `PT[n]H[n]M[n]S` as per ISO8601. Defaults to `PT2H`.
        :param pulumi.Input[builtins.str] error_code: The Error code when failed.
        :param pulumi.Input[builtins.str] error_message: The Error message indicating why the operation failed.
        :param pulumi.Input['SoftwareUpdateConfigurationLinuxArgs'] linux: A `linux` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Automation. Changing this forces a new Automation to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] non_azure_computer_names: Specifies a list of names of non-Azure machines for the software update configuration.
        :param pulumi.Input['SoftwareUpdateConfigurationPostTaskArgs'] post_task: A `post_task` blocks as defined below.
...
class SoftwareUpdateConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="nonAzureComputerNames")
    def non_azure_computer_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a list of names of non-Azure machines for the software update configuration.
        """
        return pulumi.get(self, "non_azure_computer_names")
