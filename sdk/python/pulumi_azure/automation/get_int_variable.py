...
def get_int_variable(automation_account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str automation_account_name: The name of the automation account in which the Automation Variable exists.
    :param _builtins.str name: The name of the Automation Variable.
    :param _builtins.str resource_group_name: The Name of the Resource Group where the automation account exists.
    """
    __args__ = dict()
...
def get_int_variable_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
