...
def get_int_variable(automation_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str automation_account_name: The name of the automation account in which the Automation Variable exists.
    :param builtins.str name: The name of the Automation Variable.
    :param builtins.str resource_group_name: The Name of the Resource Group where the automation account exists.
    """
    __args__ = dict()
...
def get_int_variable_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
                            name: Optional[pulumi.Input[builtins.str]] = None,
                            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetIntVariableResult]:
    """
    Use this data source to access information about an existing Automation Int Variable.
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:automation/getIntVariable:getIntVariable', __args__, opts=opts, typ=GetIntVariableResult)
    return __ret__.apply(lambda __response__: GetIntVariableResult(
