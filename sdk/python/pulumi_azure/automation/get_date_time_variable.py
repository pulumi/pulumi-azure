...
def get_date_time_variable(automation_account_name: Optional[_builtins.str] = None,
...
def get_date_time_variable_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
