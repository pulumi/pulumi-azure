...
def get_bool_variable(automation_account_name: Optional[builtins.str] = None,
...
def get_bool_variable_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
