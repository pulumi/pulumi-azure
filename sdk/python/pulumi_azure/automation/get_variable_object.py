...
def get_variable_object(automation_account_name: Optional[builtins.str] = None,
...
def get_variable_object_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
