...
def get_variable_object(automation_account_name: Optional[_builtins.str] = None,
...
def get_variable_object_output(automation_account_name: Optional[pulumi.Input[_builtins.str]] = None,
