...
class Powershell72ModuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] automation_account_id: The ID of Automation Account to manage this Watcher. Changing this forces a new Watcher to be created.
        :param pulumi.Input['Powershell72ModuleModuleLinkArgs'] module_link: A `module_link` block as defined below.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Module. Changing this forces a new resource to be created.
...
class _Powershell72ModuleState:
    def __init__(__self__, *,
                 automation_account_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="automationAccountId")
    def automation_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of Automation Account to manage this Watcher. Changing this forces a new Watcher to be created.
        """
        return pulumi.get(self, "automation_account_id")
    ...
    @automation_account_id.setter
    def automation_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "automation_account_id", value)
...
class Powershell72Module(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            module_link: Optional[pulumi.Input[Union['Powershell72ModuleModuleLinkArgs', 'Powershell72ModuleModuleLinkArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Powershell72Module':
        """
    ...
    @property
    @pulumi.getter(name="automationAccountId")
    def automation_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of Automation Account to manage this Watcher. Changing this forces a new Watcher to be created.
        """
        return pulumi.get(self, "automation_account_id")
