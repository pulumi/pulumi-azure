...
class GetRunbookResult:
    ...
    def log_activity_trace_level(self) -> builtins.int:
        """
    ...
    def log_progress(self) -> builtins.bool:
        """
    ...
    def log_verbose(self) -> builtins.bool:
        """
...
def get_runbook(automation_account_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Automation`: 2023-11-01
    ...
    :param builtins.str resource_group_name: The name of the Resource Group where the Automation exists.
    """
    __args__ = dict()
...
def get_runbook_output(automation_account_name: Optional[pulumi.Input[builtins.str]] = None,
