...
class StringVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Automation Variable. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] value: The value of the Automation Variable as a `string`.
        """
...
class StringVariable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
            value: Optional[pulumi.Input[_builtins.str]] = None) -> 'StringVariable':
        """
