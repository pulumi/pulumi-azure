...
class DateTimeVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value: The value of the Automation Variable in the [RFC3339 Section 5.6 Internet Date/Time Format](https://tools.ietf.org/html/rfc3339#section-5.6).
        """
...
@pulumi.type_token("azure:automation/dateTimeVariable:DateTimeVariable")
class DateTimeVariable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
            value: Optional[pulumi.Input[_builtins.str]] = None) -> 'DateTimeVariable':
        """
