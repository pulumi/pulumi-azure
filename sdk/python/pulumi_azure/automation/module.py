...
class ModuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] automation_account_name: The name of the automation account in which the Module is created. Changing this forces a new resource to be created.
        :param pulumi.Input['ModuleModuleLinkArgs'] module_link: A `module_link` block as defined below.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Module is created. Changing this forces a new resource to be created.
...
class Module(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            module_link: Optional[pulumi.Input[Union['ModuleModuleLinkArgs', 'ModuleModuleLinkArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Module':
        """
