...
class AccountEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_vault_key_id: The ID of the Key Vault Key which should be used to Encrypt the data in this Automation Account.
...
class AccountIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of identity used for this Automation Account. Possible values are `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned`.
        :param Sequence[builtins.str] identity_ids: The ID of the User Assigned Identity which should be assigned to this Automation Account.
...
class AccountPrivateEndpointConnection(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of the Automation Account.
        :param builtins.str name: Specifies the name of the Automation Account. Changing this forces a new resource to be created.
        """
        if id is not None:
...
class ConnectionTypeField(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name which should be used for this connection field definition.
        :param builtins.str type: The type of the connection field definition.
        :param builtins.bool is_encrypted: Whether to set the isEncrypted flag of the connection field definition.
        :param builtins.bool is_optional: Whether to set the isOptional flag of the connection field definition.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ModuleModuleLink(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str uri: The URI of the module content (zip or nupkg).
...
class ModuleModuleLinkHash(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str algorithm: Specifies the algorithm used for the hash content.
        :param builtins.str value: The hash value of the content.
        """
...
class RunBookDraft(dict):
    ...
    def __init__(__self__, *,
                 ...
                 edit_mode_enabled: Optional[builtins.bool] = None,
        ...
        :param builtins.bool edit_mode_enabled: Whether the draft in edit mode.
        :param Sequence[builtins.str] output_types: Specifies the output types of the runbook.
    ...
    def edit_mode_enabled(self) -> Optional[builtins.bool]:
        """
...
class RunBookDraftContentLink(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str uri: The URI of the runbook content.
        :param 'RunBookDraftContentLinkHashArgs' hash: A `hash` block as defined below.
        :param builtins.str version: Specifies the version of the content
        """
        pulumi.set(__self__, "uri", uri)
        if hash is not None:
            pulumi.set(__self__, "hash", hash)
...
class RunBookDraftContentLinkHash(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str algorithm: Specifies the hash algorithm used to hash the content.
        :param builtins.str value: Specifies the expected hash value of the content.
        """
        pulumi.set(__self__, "algorithm", algorithm)
        pulumi.set(__self__, "value", value)
...
class RunBookDraftParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: Specifies the type of this parameter.
        :param builtins.str default_value: Specifies the default value of the parameter.
        :param builtins.bool mandatory: Whether this parameter is mandatory.
        :param builtins.int position: Specifies the position of the parameter.
        """
...
class RunBookJobSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str schedule_name: The name of the Schedule.
...
class ScheduleMonthlyOccurrence(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int occurrence: Occurrence of the week within the month. Must be between `1` and `5`. `-1` for last week within the month.
        """
    ...
    @property
    @pulumi.getter
    def occurrence(self) -> builtins.int:
        """
...
class SoftwareUpdateConfigurationLinux(dict):
    ...
    def __init__(__self__, *,
                 classifications_includeds: Sequence[builtins.str],
                 excluded_packages: Optional[Sequence[builtins.str]] = None,
                 included_packages: Optional[Sequence[builtins.str]] = None,
                 reboot: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] classifications_includeds: Specifies the list of update classifications included in the Software Update Configuration. Possible values are `Unclassified`, `Critical`, `Security` and `Other`.
        :param Sequence[builtins.str] excluded_packages: Specifies a list of packages to excluded from the Software Update Configuration.
        :param Sequence[builtins.str] included_packages: Specifies a list of packages to included from the Software Update Configuration.
        :param builtins.str reboot: Specifies the reboot settings after software update, possible values are `IfRequired`, `Never`, `RebootOnly` and `Always`. Defaults to `IfRequired`.
        """
    ...
    def classifications_includeds(self) -> Sequence[builtins.str]:
        """
    ...
    def included_packages(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SoftwareUpdateConfigurationPostTask(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] parameters: Specifies a map of parameters for the task.
        :param builtins.str source: The name of the runbook for the post task.
        """
        if parameters is not None:
            pulumi.set(__self__, "parameters", parameters)
...
class SoftwareUpdateConfigurationPreTask(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] parameters: Specifies a map of parameters for the task.
        :param builtins.str source: The name of the runbook for the pre task.
        """
        if parameters is not None:
            pulumi.set(__self__, "parameters", parameters)
        if source is not None:
...
class SoftwareUpdateConfigurationSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 advanced_month_days: Optional[Sequence[builtins.int]] = None,
                 advanced_week_days: Optional[Sequence[builtins.str]] = None,
                 creation_time: Optional[builtins.str] = None,
                 ...
                 start_time_offset_minutes: Optional[builtins.float] = None,
                 time_zone: Optional[builtins.str] = None):
        """
        :param builtins.str frequency: The frequency of the schedule. - can be either `OneTime`, `Day`, `Hour`, `Week`, or `Month`.
        :param Sequence[builtins.int] advanced_month_days: List of days of the month that the job should execute on. Must be between `1` and `31`. `-1` for last day of the month. Only valid when frequency is `Month`.
        :param Sequence[builtins.str] advanced_week_days: List of days of the week that the job should execute on. Only valid when frequency is `Week`. Possible values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`.
        :param builtins.str description: A description for this Schedule.
        :param builtins.str expiry_time: The end time of the schedule.
        :param builtins.int interval: The number of `frequency`s between runs. Only valid when frequency is `Day`, `Hour`, `Week`, or `Month`.
        :param builtins.bool is_enabled: Whether the schedule is enabled. Defaults to `true`.
        ...
        :param builtins.str start_time: Start time of the schedule. Must be at least five minutes in the future. Defaults to seven minutes in the future from the time the resource is created.
        :param builtins.str time_zone: The timezone of the start time. Defaults to `Etc/UTC`. For possible values see: <https://docs.microsoft.com/en-us/rest/api/maps/timezone/gettimezoneenumwindows>
        """
    ...
    def advanced_month_days(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    def advanced_week_days(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def start_time_offset_minutes(self) -> Optional[builtins.float]:
...
class SoftwareUpdateConfigurationScheduleMonthlyOccurrence(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day: Day of the occurrence. Must be one of `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, `Sunday`.
        :param builtins.int occurrence: Occurrence of the week within the month. Must be between `1` and `4`. `-1` for last week within the month.
        """
        pulumi.set(__self__, "day", day)
        pulumi.set(__self__, "occurrence", occurrence)
...
class SoftwareUpdateConfigurationTargetAzureQuery(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] scopes: Specifies a list of Subscription or Resource Group ARM Ids to query.
        :param builtins.str tag_filter: Specifies how the specified tags to filter VMs. Possible values are `Any` and `All`.
...
class SoftwareUpdateConfigurationTargetAzureQueryTag(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str tag: Specifies the name of the tag to filter.
        :param Sequence[builtins.str] values: Specifies a list of values for this tag key.
        """
...
class SoftwareUpdateConfigurationTargetNonAzureQuery(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str function_alias: Specifies the Log Analytics save search name.
        :param builtins.str workspace_id: The workspace id for Log Analytics in which the saved search in.
        """
...
class SoftwareUpdateConfigurationWindows(dict):
    ...
    def __init__(__self__, *,
                 classifications_includeds: Sequence[builtins.str],
                 excluded_knowledge_base_numbers: Optional[Sequence[builtins.str]] = None,
                 included_knowledge_base_numbers: Optional[Sequence[builtins.str]] = None,
                 reboot: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] classifications_includeds: Specifies the list of update classification. Possible values are `Unclassified`, `Critical`, `Security`, `UpdateRollup`, `FeaturePack`, `ServicePack`, `Definition`, `Tools` and `Updates`.
        :param Sequence[builtins.str] excluded_knowledge_base_numbers: Specifies a list of knowledge base numbers excluded.
        :param Sequence[builtins.str] included_knowledge_base_numbers: Specifies a list of knowledge base numbers included.
        :param builtins.str reboot: Specifies the reboot settings after software update, possible values are `IfRequired`, `Never`, `RebootOnly` and `Always`. Defaults to `IfRequired`.
        """
        pulumi.set(__self__, "classifications_includeds", classifications_includeds)
    ...
    def excluded_knowledge_base_numbers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_knowledge_base_numbers(self) -> Optional[Sequence[builtins.str]]:
        """
...
class SourceControlSecurity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str token: The access token of specified repo.
        :param builtins.str token_type: Specify the token type, possible values are `PersonalAccessToken` and `Oauth`.
        :param builtins.str refresh_token: The refresh token of specified rpeo.
        """
...
class GetAccountIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Automation Account.
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Automation Account.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Automation Account.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Automation Account.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetVariablesBoolResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.bool):
        """
        :param builtins.str description: The description of the Automation Variable.
        :param builtins.bool encrypted: Specifies if the Automation Variable is encrypted.
        :param builtins.str name: The name of the Automation Variable.
        :param builtins.bool value: The value of the Automation Variable.
        """
        pulumi.set(__self__, "description", description)
...
class GetVariablesDatetimeResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool encrypted: Specifies if the Automation Variable is encrypted.
        :param builtins.str name: The name of the Automation Variable.
        :param builtins.str value: The value of the Automation Variable.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "encrypted", encrypted)
        pulumi.set(__self__, "id", id)
...
class GetVariablesIntResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool encrypted: Specifies if the Automation Variable is encrypted.
        :param builtins.str name: The name of the Automation Variable.
        :param builtins.int value: The value of the Automation Variable.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "encrypted", encrypted)
        pulumi.set(__self__, "id", id)
