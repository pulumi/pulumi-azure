...
class SyncGroupArgs:
    def __init__(__self__, *,
                 storage_sync_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SyncGroup resource.
        :param pulumi.Input[builtins.str] storage_sync_id: The resource ID of the Storage Sync where this Storage Sync Group is. Changing this forces a new Storage Sync Group to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Storage Sync Group. Changing this forces a new Storage Sync Group to be created.
        """
    ...
    def storage_sync_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_sync_id(self, value: pulumi.Input[builtins.str]):
...
class _SyncGroupState:
    ...
    @property
    @pulumi.getter(name="storageSyncId")
    def storage_sync_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource ID of the Storage Sync where this Storage Sync Group is. Changing this forces a new Storage Sync Group to be created.
        """
        return pulumi.get(self, "storage_sync_id")
    ...
    @storage_sync_id.setter
    def storage_sync_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_sync_id", value)
...
class SyncGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            storage_sync_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SyncGroup':
        """
    ...
    @property
    @pulumi.getter(name="storageSyncId")
    def storage_sync_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the Storage Sync where this Storage Sync Group is. Changing this forces a new Storage Sync Group to be created.
        """
        return pulumi.get(self, "storage_sync_id")
