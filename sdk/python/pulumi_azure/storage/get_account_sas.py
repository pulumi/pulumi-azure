...
class GetAccountSASResult:
    ...
    def signed_version(self) -> Optional[_builtins.str]:
...
def get_account_sas(connection_string: Optional[_builtins.str] = None,
...
def get_account_sas_output(connection_string: Optional[pulumi.Input[_builtins.str]] = None,
