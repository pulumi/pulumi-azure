...
def get_blob(metadata: Optional[Mapping[str, builtins.str]] = None,
    ...
    :param Mapping[str, builtins.str] metadata: A map of custom blob metadata.
    :param builtins.str name: The name of the Blob.
    :param builtins.str storage_account_name: The name of the Storage Account where the Container exists.
    :param builtins.str storage_container_name: The name of the Storage Container where the Blob exists.
    """
    __args__ = dict()
...
def get_blob_output(metadata: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
