...
class GetBlobResult:
    ...
    """
    def __init__(__self__, access_tier=None, content_md5=None, content_type=None, encryption_scope=None, id=None, metadata=None, name=None, storage_container_id=None, type=None, url=None):
