...
def get_account_blob_container_sas(cache_control: Optional[_builtins.str] = None,
    ...
    :param Union['GetAccountBlobContainerSASPermissionsArgs', 'GetAccountBlobContainerSASPermissionsArgsDict'] permissions: Should Permissions permissions be enabled for this SAS?
...
def get_account_blob_container_sas_output(cache_control: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                          ...
                                          permissions: pulumi.Input[Optional[Optional[Union['GetAccountBlobContainerSASPermissionsArgs', 'GetAccountBlobContainerSASPermissionsArgsDict']]]] = None,
