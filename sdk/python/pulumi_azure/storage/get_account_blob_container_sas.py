...
class GetAccountBlobContainerSASResult:
    ...
    @_builtins.property
    @pulumi.getter
    def permissions(self) -> Optional['outputs.GetAccountBlobContainerSASPermissionsResult']:
...
def get_account_blob_container_sas(cache_control: Optional[_builtins.str] = None,
                                   ...
                                   permissions: Optional[Union['GetAccountBlobContainerSASPermissionsArgs', 'GetAccountBlobContainerSASPermissionsArgsDict', 'outputs.GetAccountBlobContainerSASPermissionsResult']] = None,
    ...
    example = azure.storage.get_account_blob_container_sas_output(permissions={
        ...
        connection_string=storage.primary_connection_string,
    ...
    :param Union['GetAccountBlobContainerSASPermissionsArgs', 'GetAccountBlobContainerSASPermissionsArgsDict', 'outputs.GetAccountBlobContainerSASPermissionsResult'] permissions: Should Permissions permissions be enabled for this SAS?
...
def get_account_blob_container_sas_output(cache_control: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                          ...
                                          permissions: pulumi.Input[Optional[Optional[Union['GetAccountBlobContainerSASPermissionsArgs', 'GetAccountBlobContainerSASPermissionsArgsDict', 'outputs.GetAccountBlobContainerSASPermissionsResult']]]] = None,
