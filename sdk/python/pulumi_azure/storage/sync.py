...
class SyncArgs:
    def __init__(__self__, *,
                 ...
                 incoming_traffic_policy: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Sync resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Storage Sync should exist. Changing this forces a new Storage Sync to be created.
        :param pulumi.Input[builtins.str] incoming_traffic_policy: Incoming traffic policy. Possible values are `AllowAllTraffic` and `AllowVirtualNetworksOnly`. Defaults to `AllowAllTraffic`.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Storage Sync should exist. Changing this forces a new Storage Sync to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Storage Sync. Changing this forces a new Storage Sync to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Storage Sync.
        """
    ...
    def incoming_traffic_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def incoming_traffic_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SyncState:
    def __init__(__self__, *,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 registered_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Storage Sync should exist. Changing this forces a new Storage Sync to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Storage Sync. Changing this forces a new Storage Sync to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] registered_servers: A list of registered servers owned by this Storage Sync.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Storage Sync should exist. Changing this forces a new Storage Sync to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Storage Sync.
        """
        if incoming_traffic_policy is not None:
    ...
    def registered_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def registered_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Sync(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            registered_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Sync':
        """
    ...
    @property
    @pulumi.getter(name="registeredServers")
    def registered_servers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of registered servers owned by this Storage Sync.
        """
        return pulumi.get(self, "registered_servers")
