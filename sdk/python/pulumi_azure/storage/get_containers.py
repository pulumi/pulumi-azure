...
def get_containers(name_prefix: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name_prefix: A prefix match used for the Storage Container `name` field.
    :param _builtins.str storage_account_id: The ID of the Storage Account that the Storage Containers reside in.
    """
    __args__ = dict()
