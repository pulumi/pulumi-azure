...
class MoverSourceEndpointArgs:
    def __init__(__self__, *,
                 ...
                 nfs_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MoverSourceEndpoint resource.
        :param pulumi.Input[builtins.str] host: Specifies the host name or IP address of the server exporting the file system. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_mover_id: Specifies the ID of the Storage Mover for this Storage Mover Source Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] description: Specifies a description for the Storage Mover Source Endpoint.
        :param pulumi.Input[builtins.str] export: Specifies the directory being exported from the server. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Storage Mover Source Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] nfs_version: Specifies the NFS protocol version. Possible values are `NFSauto`, `NFSv3` and `NFSv4`. Defaults to `NFSauto`. Changing this forces a new resource to be created.
        """
    ...
    def nfs_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @nfs_version.setter
    def nfs_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MoverSourceEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            nfs_version: Optional[pulumi.Input[builtins.str]] = None,
            storage_mover_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MoverSourceEndpoint':
        """
    ...
    @property
    @pulumi.getter
    def export(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the directory being exported from the server. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "export")
    ...
    @property
    @pulumi.getter(name="nfsVersion")
    def nfs_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the NFS protocol version. Possible values are `NFSauto`, `NFSv3` and `NFSv4`. Defaults to `NFSauto`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "nfs_version")
