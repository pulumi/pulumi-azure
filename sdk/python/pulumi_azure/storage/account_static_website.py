...
class AccountStaticWebsiteInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account to set Static Website on. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] index_document: The webpage that Azure Storage serves for requests to the root of a website or any subfolder. For example, index.html.
        """
...
class AccountStaticWebsite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            error404_document: Optional[pulumi.Input[builtins.str]] = None,
            index_document: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccountStaticWebsite':
        """
