...
class TableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_account_name: Specifies the storage account in which to create the storage table. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input['TableAclArgs']]] acls: One or more `acl` blocks as defined below.
        :param pulumi.Input[builtins.str] name: The name of the storage table. Only Alphanumeric characters allowed, starting with a letter. Must be unique within the storage account the table is located. Changing this forces a new resource to be created.
        """
...
class _TableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TableAclArgs']]] acls: One or more `acl` blocks as defined below.
        :param pulumi.Input[builtins.str] name: The name of the storage table. Only Alphanumeric characters allowed, starting with a letter. Must be unique within the storage account the table is located. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_manager_id: The Resource Manager ID of this Storage Table.
        :param pulumi.Input[builtins.str] storage_account_name: Specifies the storage account in which to create the storage table. Changing this forces a new resource to be created.
        """
        if acls is not None:
            pulumi.set(__self__, "acls", acls)
...
class Table(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_manager_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Table':
        """
