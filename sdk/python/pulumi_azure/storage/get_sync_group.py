...
class GetSyncGroupResult:
    ...
    def storage_sync_id(self) -> _builtins.str:
...
def get_sync_group(name: Optional[_builtins.str] = None,
                   storage_sync_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.StorageSync` - 2020-03-01
    ...
    :param _builtins.str name: The name of this Storage Sync Group.
    :param _builtins.str storage_sync_id: The resource ID of the Storage Sync where this Storage Sync Group is.
    """
    __args__ = dict()
    __args__['name'] = name
