...
class ManagementPolicyRuleActionsBaseBlob(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int tier_to_archive_after_days_since_last_tier_change_greater_than: The age in days after last tier change to the blobs to skip to be archived. Must be between `0` and `99999`. Defaults to `-1`.
