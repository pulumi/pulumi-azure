...
class ManagementPolicyRuleActionsBaseBlob(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param int delete_after_days_since_creation_greater_than: The age in days after creation to delete the blob. Must be between `0` and `99999`.
        ...
        :param int tier_to_archive_after_days_since_creation_greater_than: The age in days after creation to archive storage. Supports blob currently at Hot or Cool tier. Must be between `0` and`99999`.
        ...
        :param int tier_to_archive_after_days_since_last_tier_change_greater_than: The age in days after last tier change to the blobs to skip to be archved. Must be between 0 and 99999.
        ...
        :param int tier_to_cool_after_days_since_creation_greater_than: The age in days after creation to cool storage. Supports blob currently at Hot tier. Must be between `0` and `99999`.
