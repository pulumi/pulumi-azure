...
class GetTableEntityResult:
    ...
    @property
    @pulumi.getter
    def entity(self) -> Mapping[str, builtins.str]:
        """
...
def get_table_entity(partition_key: Optional[builtins.str] = None,
    ...
    :param builtins.str partition_key: The key for the partition where the entity will be retrieved.
    :param builtins.str row_key: The key for the row where the entity will be retrieved.
    :param builtins.str storage_table_id: The Storage Table ID where the entity exists.
    """
    __args__ = dict()
...
def get_table_entity_output(partition_key: Optional[pulumi.Input[builtins.str]] = None,
