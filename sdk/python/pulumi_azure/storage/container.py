...
class ContainerArgs:
    def __init__(__self__, *,
                 container_access_type: Optional[pulumi.Input[builtins.str]] = None,
                 default_encryption_scope: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_scope_override_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def container_access_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_access_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def encryption_scope_override_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def encryption_scope_override_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ContainerState:
    def __init__(__self__, *,
                 ...
                 default_encryption_scope: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_scope_override_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 has_immutability_policy: Optional[pulumi.Input[builtins.bool]] = None,
                 has_legal_hold: Optional[pulumi.Input[builtins.bool]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] has_legal_hold: Is there a Legal Hold configured on this Storage Container?
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: A mapping of MetaData for this Container. All metadata keys should be lowercase.
        :param pulumi.Input[builtins.str] name: The name of the Container which should be created within the Storage Account. Changing this forces a new resource to be created.
    ...
    def has_immutability_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_immutability_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "has_immutability_policy", value)

    @property
    @pulumi.getter(name="hasLegalHold")
    def has_legal_hold(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_legal_hold(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Container(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_manager_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Container':
        """
    ...
    @property
    @pulumi.getter(name="containerAccessType")
    def container_access_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Access Level configured for this Container. Possible values are `blob`, `container` or `private`. Defaults to `private`.
    ...
    @property
    @pulumi.getter(name="encryptionScopeOverrideEnabled")
    def encryption_scope_override_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to allow blobs to override the default encryption scope for this container. Can only be set when specifying `default_encryption_scope`. Defaults to `true`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "encryption_scope_override_enabled")
