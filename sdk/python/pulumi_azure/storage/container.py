...
class Container(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, container_access_type=None, metadata=None, name=None, resource_group_name=None, storage_account_name=None, __name__=None, __opts__=None):
        """
