...
class QueueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_account_name: Specifies the Storage Account in which the Storage Queue should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: A mapping of MetaData which should be assigned to this Storage Queue.
        :param pulumi.Input[builtins.str] name: The name of the Queue which should be created within the Storage Account. Must be unique within the storage account the queue is located. Changing this forces a new resource to be created.
        """
...
class _QueueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: A mapping of MetaData which should be assigned to this Storage Queue.
        :param pulumi.Input[builtins.str] name: The name of the Queue which should be created within the Storage Account. Must be unique within the storage account the queue is located. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_manager_id: The Resource Manager ID of this Storage Queue.
        :param pulumi.Input[builtins.str] storage_account_name: Specifies the Storage Account in which the Storage Queue should exist. Changing this forces a new resource to be created.
        """
        if metadata is not None:
            pulumi.set(__self__, "metadata", metadata)
...
class Queue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_manager_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Queue':
        """
