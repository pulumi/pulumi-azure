...
class DataLakeGen2PathArgs:
    def __init__(__self__, *,
                 filesystem_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] filesystem_name: The name of the Data Lake Gen2 File System which should be created within the Storage Account. Must be unique within the storage account the queue is located. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] path: The path which should be created within the Data Lake Gen2 File System in the Storage Account. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] resource: Specifies the type for path to create. Currently only `directory` is supported. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] group: Specifies the Object ID of the Azure Active Directory Group to make the owning group. Possible values also include `$superuser`.
        :param pulumi.Input[_builtins.str] owner: Specifies the Object ID of the Azure Active Directory User to make the owning user. Possible values also include `$superuser`.
        """
    ...
    def filesystem_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def filesystem_name(self, value: pulumi.Input[_builtins.str]):
...
class DataLakeGen2Path(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 aces: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DataLakeGen2PathAceArgs', 'DataLakeGen2PathAceArgsDict', 'outputs.DataLakeGen2PathAce']]]]] = None,
                 filesystem_name: pulumi.Input[Optional[_builtins.str]] = None,
                 group: pulumi.Input[Optional[_builtins.str]] = None,
                 owner: pulumi.Input[Optional[_builtins.str]] = None,
                 path: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['DataLakeGen2PathAceArgs', 'DataLakeGen2PathAceArgsDict', 'outputs.DataLakeGen2PathAce']]]] aces: One or more `ace` blocks as defined below to specify the entries for the ACL for the path.
        :param pulumi.Input[_builtins.str] filesystem_name: The name of the Data Lake Gen2 File System which should be created within the Storage Account. Must be unique within the storage account the queue is located. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] group: Specifies the Object ID of the Azure Active Directory Group to make the owning group. Possible values also include `$superuser`.
        :param pulumi.Input[_builtins.str] owner: Specifies the Object ID of the Azure Active Directory User to make the owning user. Possible values also include `$superuser`.
        :param pulumi.Input[_builtins.str] path: The path which should be created within the Data Lake Gen2 File System in the Storage Account. Changing this forces a new resource to be created.
    ...
    @_builtins.property
    @pulumi.getter(name="filesystemName")
    def filesystem_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Data Lake Gen2 File System which should be created within the Storage Account. Must be unique within the storage account the queue is located. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "filesystem_name")
