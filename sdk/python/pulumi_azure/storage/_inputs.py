...
class AccountAzureFilesAuthenticationActiveDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] domain_sid: Specifies the security identifier (SID). This is required when `directory_type` is set to `AD`.
        :param pulumi.Input[_builtins.str] forest_name: Specifies the Active Directory forest. This is required when `directory_type` is set to `AD`.
        :param pulumi.Input[_builtins.str] netbios_domain_name: Specifies the NetBIOS domain name. This is required when `directory_type` is set to `AD`.
        :param pulumi.Input[_builtins.str] storage_sid: Specifies the security identifier (SID) for Azure Storage. This is required when `directory_type` is set to `AD`.
        """
...
class AccountBlobPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] change_feed_enabled: Is the blob service properties for change feed events enabled? Default to `false`.
               ...
               > **Note:** This field cannot be configured when `kind` is set to `Storage` (V1).
        :param pulumi.Input[_builtins.int] change_feed_retention_in_days: The duration of change feed events retention in days. The possible values are between 1 and 146000 days (400 years). Setting this to null (or omit this in the configuration file) indicates an infinite retention of the change feed.
        ...
        :param pulumi.Input[_builtins.str] default_service_version: The API Version which should be used by default for requests to the Data Plane API if an incoming request doesn't specify an API Version.
        ...
        :param pulumi.Input[_builtins.bool] last_access_time_enabled: Is the last access time based tracking enabled? Default to `false`.
        ...
        :param pulumi.Input['AccountBlobPropertiesRestorePolicyArgs'] restore_policy: A `restore_policy` block as defined below. This must be used together with `delete_retention_policy` set, `versioning_enabled` and `change_feed_enabled` set to `true`.
               ...
               > **Note:** `restore_policy` can not be configured when `dns_endpoint_type` is `AzureDnsZone`.
        :param pulumi.Input[_builtins.bool] versioning_enabled: Is versioning enabled? Default to `false`.
...
class AccountBlobPropertiesRestorePolicyArgs:
    def __init__(__self__, *,
                 days: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] days: Specifies the number of days that the blob can be restored, between `1` and `365` days. This must be less than the `days` specified for `delete_retention_policy`.
        """
        pulumi.set(__self__, "days", days)
...
class AccountIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Storage Account.
               ...
               > **Note:** The assigned `principal_id` and `tenant_id` can be retrieved after the identity `type` has been set to `SystemAssigned`  and Storage Account has been created. More details are available below.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID for the Service Principal associated with the Identity of this Storage Account.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Storage Account.
        """
...
if not MYPY:
    class AccountImmutabilityPolicyArgsDict(TypedDict):
        allow_protected_append_writes: pulumi.Input[_builtins.bool]
        """
        ...
        """
        period_since_creation_in_days: pulumi.Input[_builtins.int]
        """
...
class AccountImmutabilityPolicyArgs:
    ...
    def allow_protected_append_writes(self) -> pulumi.Input[_builtins.bool]:
        """
        When enabled, new blocks can be written to an append blob while maintaining immutability protection and compliance. Only new blocks can be added and any existing blocks cannot be modified or deleted.
        """
    ...
    def allow_protected_append_writes(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "allow_protected_append_writes", value)

    @_builtins.property
    @pulumi.getter(name="periodSinceCreationInDays")
    def period_since_creation_in_days(self) -> pulumi.Input[_builtins.int]:
        """
        The immutability period for the blobs in the container since the policy creation, in days.
        """
    ...
    def period_since_creation_in_days(self, value: pulumi.Input[_builtins.int]):
...
class AccountNetworkRulesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_rules: List of public IP or IP ranges in CIDR Format. Only IPv4 addresses are allowed. /31 CIDRs, /32 CIDRs, and Private IP address ranges (as defined in [RFC 1918](https://tools.ietf.org/html/rfc1918#section-3)), are not allowed.
...
class AccountNetworkRulesPrivateLinkAccessArgs:
    ...
    def endpoint_resource_id(self) -> pulumi.Input[_builtins.str]:
        """
        The ID of the Azure resource that should be allowed access to the target storage account.
        """
    ...
    def endpoint_resource_id(self, value: pulumi.Input[_builtins.str]):
...
class AccountRoutingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] publish_microsoft_endpoints: Should Microsoft routing storage endpoints be published? Defaults to `false`.
        """
...
class AccountSasPolicyArgs:
    ...
    def expiration_period(self) -> pulumi.Input[_builtins.str]:
        """
        The SAS expiration period in format of `DD.HH:MM:SS`.
        """
    ...
    def expiration_period(self, value: pulumi.Input[_builtins.str]):
...
class AccountSharePropertiesSmbArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] kerberos_ticket_encryption_types: A set of Kerberos ticket encryption. Possible values are `RC4-HMAC`, and `AES-256`.
        :param pulumi.Input[_builtins.bool] multichannel_enabled: Indicates whether multichannel is enabled. Defaults to `false`. This is only supported on Premium storage accounts.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] versions: A set of SMB protocol versions. Possible values are `SMB2.1`, `SMB3.0`, and `SMB3.1.1`.
        """
...
class BlobInventoryPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] schedule: The inventory schedule applied by this rule. Possible values are `Daily` and `Weekly`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] schema_fields: A list of fields to be included in the inventory. See the [Azure API reference](https://docs.microsoft.com/rest/api/storagerp/blob-inventory-policies/create-or-update#blobinventorypolicydefinition) for all the supported fields.
        :param pulumi.Input[_builtins.str] scope: The scope of the inventory for this rule. Possible values are `Blob` and `Container`.
        :param pulumi.Input[_builtins.str] storage_container_name: The storage container name to store the blob inventory files for this rule.
    ...
    def schema_fields(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class BlobInventoryPolicyRuleFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] blob_types: A set of blob types. Possible values are `blockBlob`, `appendBlob`, and `pageBlob`. The storage account with `is_hns_enabled` is `true` doesn't support `pageBlob`.
               ...
               > **Note:** The `rules.*.schema_fields` for this rule has to include `BlobType` so that you can specify the `blob_types`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] exclude_prefixes: A set of strings for blob prefixes to be excluded. Maximum of 10 blob prefixes.
        :param pulumi.Input[_builtins.bool] include_blob_versions: Includes blob versions in blob inventory or not? Defaults to `false`.
               
               > **Note:** The `rules.*.schema_fields` for this rule has to include `IsCurrentVersion` and `VersionId` so that you can specify the `include_blob_versions`.
        :param pulumi.Input[_builtins.bool] include_deleted: Includes deleted blobs in blob inventory or not? Defaults to `false`.
               
               > **Note:** If `rules.*.scope` is `Container`, the `rules.*.schema_fields` for this rule must include `Deleted`, `Version`, `DeletedTime`, and `RemainingRetentionDays` so that you can specify the `include_deleted`. If `rules.*.scope` is `Blob`, the `rules.*.schema_fields` must include `Deleted` and `RemainingRetentionDays` so that you can specify the `include_deleted`. If `rules.*.scope` is `Blob` and the storage account specified by `storage_account_id` has hierarchical namespaces enabled (`is_hns_enabled` is `true` on the storage account), the `rules.*.schema_fields` for this rule must include `Deleted`, `Version`, `DeletedTime`, and `RemainingRetentionDays` so that you can specify the `include_deleted`.
        :param pulumi.Input[_builtins.bool] include_snapshots: Includes blob snapshots in blob inventory or not? Defaults to `false`.
               
               > **Note:** The `rules.*.schema_fields` for this rule has to include `Snapshot` so that you can specify the `include_snapshots`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] prefix_matches: A set of strings for blob prefixes to be matched. Maximum of 10 blob prefixes.
        """
    ...
    @blob_types.setter
    def blob_types(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class DataLakeGen2FilesystemAceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] permissions: Specifies the permissions for the entry in `rwx` form. For example, `rwx` gives full permissions but `r--` only gives read permissions.
               ...
               More details on ACLs can be found here: <https://docs.microsoft.com/azure/storage/blobs/data-lake-storage-access-control#access-control-lists-on-files-and-directories>
        :param pulumi.Input[_builtins.str] type: Specifies the type of entry. Can be `user`, `group`, `mask` or `other`.
        :param pulumi.Input[_builtins.str] id: Specifies the Object ID of the Azure Active Directory User or Group that the entry relates to. Only valid for `user` or `group` entries.
        :param pulumi.Input[_builtins.str] scope: Specifies whether the ACE represents an `access` entry or a `default` entry. Default value is `access`.
        """
...
class LocalUserPermissionScopeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_name: The container name (when `service` is set to `blob`) or the file share name (when `service` is set to `file`), used by the Storage Account Local User.
        :param pulumi.Input[_builtins.str] service: The storage service used by this Storage Account Local User. Possible values are `blob` and `file`.
        """
        pulumi.set(__self__, "permissions", permissions)
...
class LocalUserPermissionScopePermissionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] list: Specifies if the Local User has the list permission for this scope. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] read: Specifies if the Local User has the read permission for this scope. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] write: Specifies if the Local User has the write permission for this scope. Defaults to `false`.
        """
...
class ManagementPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Boolean to specify whether the rule is enabled.
        :param pulumi.Input['ManagementPolicyRuleFiltersArgs'] filters: A `filters` block as documented below.
        :param pulumi.Input[_builtins.str] name: The name of the rule. Rule name is case-sensitive. It must be unique within a policy.
        """
...
class ManagementPolicyRuleActionsBaseBlobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] auto_tier_to_hot_from_cool_enabled: Whether a blob should automatically be tiered from cool back to hot if it's accessed again after being tiered to cool. Defaults to `false`.
               ...
               > **Note:** The `auto_tier_to_hot_from_cool_enabled` must be used together with `tier_to_cool_after_days_since_last_access_time_greater_than`.
        :param pulumi.Input[_builtins.int] delete_after_days_since_creation_greater_than: The age in days after creation to delete the blob. Must be between `0` and `99999`. Defaults to `-1`.
               
               > **Note:** The `delete_after_days_since_modification_greater_than`, `delete_after_days_since_last_access_time_greater_than` and `delete_after_days_since_creation_greater_than` can not be set at the same time.
               
               > **Note:** The `last_access_time_enabled` must be set to `true` in the `storage.Account` in order to use `tier_to_cool_after_days_since_last_access_time_greater_than`, `tier_to_archive_after_days_since_last_access_time_greater_than` and `delete_after_days_since_last_access_time_greater_than`.
        :param pulumi.Input[_builtins.int] delete_after_days_since_last_access_time_greater_than: The age in days after last access time to delete the blob. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] delete_after_days_since_modification_greater_than: The age in days after last modification to delete the blob. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_archive_after_days_since_creation_greater_than: The age in days after creation to archive storage. Supports blob currently at Hot or Cool tier. Must be between `0` and `99999`. Defaults to `-1`.
               
               > **Note:** The `tier_to_archive_after_days_since_modification_greater_than`, `tier_to_archive_after_days_since_last_access_time_greater_than` and `tier_to_archive_after_days_since_creation_greater_than` can not be set at the same time.
        :param pulumi.Input[_builtins.int] tier_to_archive_after_days_since_last_access_time_greater_than: The age in days after last access time to tier blobs to archive storage. Supports blob currently at Hot or Cool tier. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_archive_after_days_since_last_tier_change_greater_than: The age in days after last tier change to the blobs to skip to be archived. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_archive_after_days_since_modification_greater_than: The age in days after last modification to tier blobs to archive storage. Supports blob currently at Hot or Cool tier. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_cold_after_days_since_creation_greater_than: The age in days after creation to cold storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
               
               > **Note:** The `tier_to_cool_after_days_since_modification_greater_than`, `tier_to_cool_after_days_since_last_access_time_greater_than` and `tier_to_cool_after_days_since_creation_greater_than` can not be set at the same time.
        :param pulumi.Input[_builtins.int] tier_to_cold_after_days_since_last_access_time_greater_than: The age in days after last access time to tier blobs to cold storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_cold_after_days_since_modification_greater_than: The age in days after last modification to tier blobs to cold storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_cool_after_days_since_creation_greater_than: The age in days after creation to cool storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
               
               > **Note:** The `tier_to_cool_after_days_since_modification_greater_than`, `tier_to_cool_after_days_since_last_access_time_greater_than` and `tier_to_cool_after_days_since_creation_greater_than` can not be set at the same time.
        :param pulumi.Input[_builtins.int] tier_to_cool_after_days_since_last_access_time_greater_than: The age in days after last access time to tier blobs to cool storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_cool_after_days_since_modification_greater_than: The age in days after last modification to tier blobs to cool storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
        """
...
class ManagementPolicyRuleActionsSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] delete_after_days_since_creation_greater_than: The age in days after creation to delete the blob snapshot. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_archive_after_days_since_last_tier_change_greater_than: The age in days after last tier change to the blobs to skip to be archived. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_cold_after_days_since_creation_greater_than: The age in days after creation to cold storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
        """
...
class ManagementPolicyRuleActionsVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] delete_after_days_since_creation: The age in days after creation to delete the blob version. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_archive_after_days_since_last_tier_change_greater_than: The age in days after last tier change to the blobs to skip to be archived. Must be between `0` and `99999`. Defaults to `-1`.
        :param pulumi.Input[_builtins.int] tier_to_cold_after_days_since_creation_greater_than: The age in days after creation to cold storage. Supports blob currently at Hot tier. Must be between `0` and `99999`. Defaults to `-1`.
        """
        if change_tier_to_archive_after_days_since_creation is not None:
...
class ManagementPolicyRuleFiltersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ManagementPolicyRuleFiltersMatchBlobIndexTagArgs']]] match_blob_index_tags: A `match_blob_index_tag` block as defined below. The block defines the blob index tag based filtering for blob objects.
               ...
               > **Note:** The `match_blob_index_tag` property requires enabling the `blobIndex` feature with [PSH or CLI commands](https://azure.microsoft.com/en-us/blog/manage-and-find-data-with-blob-index-for-azure-storage-now-in-preview/).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] prefix_matches: An array of strings for prefixes to be matched.
        """
        pulumi.set(__self__, "blob_types", blob_types)
...
class ManagementPolicyRuleFiltersMatchBlobIndexTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] operation: The comparison operator which is used for object comparison and filtering. Possible value is `==`. Defaults to `==`.
        """
        pulumi.set(__self__, "name", name)
...
class ObjectReplicationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] copy_blobs_created_after: The time after which the Block Blobs created will be copies to the destination. Possible values are `OnlyNewObjects`, `Everything` and time in RFC3339 format: `2006-01-02T15:04:00Z`. Defaults to `OnlyNewObjects`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] filter_out_blobs_with_prefixes: Specifies a list of filters prefixes, the blobs whose names begin with which will be replicated.
        """
    ...
    def destination_container_name(self) -> pulumi.Input[_builtins.str]:
        """
        The destination storage container name.
        """
    ...
    def destination_container_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "destination_container_name", value)

    @_builtins.property
    @pulumi.getter(name="sourceContainerName")
    def source_container_name(self) -> pulumi.Input[_builtins.str]:
        """
        The source storage container name.
        """
    ...
    def source_container_name(self, value: pulumi.Input[_builtins.str]):
...
class ShareAclAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] permissions: The permissions which should be associated with this Shared Identifier. Possible value is combination of `r` (read), `w` (write), `d` (delete), and `l` (list).
               ...
               > **Note:** Permission order is strict at the service side, and permissions need to be listed in the order above.
        :param pulumi.Input[_builtins.str] expiry: The time at which this Access Policy should be valid untilWhen using `storage_account_id` this should be in RFC3339 format. If using the deprecated `storage_account_name` property, this uses the [ISO8601](https://en.wikipedia.org/wiki/ISO_8601) format.
        :param pulumi.Input[_builtins.str] start: The time at which this Access Policy should be valid from. When using `storage_account_id` this should be in RFC3339 format. If using the deprecated `storage_account_name` property, this uses the [ISO8601](https://en.wikipedia.org/wiki/ISO_8601) format.
        """
        pulumi.set(__self__, "permissions", permissions)
...
class TableAclAccessPolicyArgs:
    def __init__(__self__, *,
                 ...
                 start: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] expiry: The ISO8061 UTC time at which this Access Policy should be valid until.
        :param pulumi.Input[_builtins.str] permissions: The permissions which should associated with this Shared Identifier.
        :param pulumi.Input[_builtins.str] start: The ISO8061 UTC time at which this Access Policy should be valid from.
        """
        pulumi.set(__self__, "expiry", expiry)
        pulumi.set(__self__, "permissions", permissions)
        pulumi.set(__self__, "start", start)
...
class GetAccountSASResourceTypesArgs:
    ...
    @container.setter
    def container(self, value: _builtins.bool):
    ...
    @object.setter
    def object(self, value: _builtins.bool):
    ...
    @service.setter
    def service(self, value: _builtins.bool):
        pulumi.set(self, "service", value)
...
class GetAccountSASServicesArgs:
    ...
    @blob.setter
    def blob(self, value: _builtins.bool):
    ...
    @file.setter
    def file(self, value: _builtins.bool):
    ...
    @queue.setter
    def queue(self, value: _builtins.bool):
    ...
    @table.setter
    def table(self, value: _builtins.bool):
