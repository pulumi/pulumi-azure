...
class TableEntity(pulumi.CustomResource):
    ...
    Changing this forces a new resource to be created.
    """
    def __init__(__self__, resource_name, opts=None, entity=None, partition_key=None, row_key=None, storage_account_name=None, table_name=None, __name__=None, __opts__=None):
        """
