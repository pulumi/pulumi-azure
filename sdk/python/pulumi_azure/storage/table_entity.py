...
class TableEntityArgs:
    def __init__(__self__, *,
                 entity: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]],
                 partition_key: pulumi.Input[builtins.str],
                 row_key: pulumi.Input[builtins.str],
                 storage_table_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a TableEntity resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] entity: A map of key/value pairs that describe the entity to be inserted/merged in to the storage table.
        :param pulumi.Input[builtins.str] partition_key: The key for the partition where the entity will be inserted/merged. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] row_key: The key for the row where the entity will be inserted/merged. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_table_id: The Storage Share ID in which this file will be placed into. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def entity(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
    ...
    @entity.setter
    def entity(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
    ...
    def row_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @row_key.setter
    def row_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "row_key", value)

    @property
    @pulumi.getter(name="storageTableId")
    def storage_table_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_table_id(self, value: pulumi.Input[builtins.str]):
...
class _TableEntityState:
    def __init__(__self__, *,
                 entity: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 partition_key: Optional[pulumi.Input[builtins.str]] = None,
                 row_key: Optional[pulumi.Input[builtins.str]] = None,
                 storage_table_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter
    def entity(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A map of key/value pairs that describe the entity to be inserted/merged in to the storage table.
        """
        return pulumi.get(self, "entity")
    ...
    @entity.setter
    def entity(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "entity", value)
    ...
    @property
    @pulumi.getter(name="rowKey")
    def row_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The key for the row where the entity will be inserted/merged. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "row_key")
    ...
    @row_key.setter
    def row_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "row_key", value)

    @property
    @pulumi.getter(name="storageTableId")
    def storage_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Storage Share ID in which this file will be placed into. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "storage_table_id")
    ...
    @storage_table_id.setter
    def storage_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_table_id", value)
...
class TableEntity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            partition_key: Optional[pulumi.Input[builtins.str]] = None,
            row_key: Optional[pulumi.Input[builtins.str]] = None,
            storage_table_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TableEntity':
        """
    ...
    @property
    @pulumi.getter
    def entity(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        A map of key/value pairs that describe the entity to be inserted/merged in to the storage table.
        """
        return pulumi.get(self, "entity")
    ...
    @property
    @pulumi.getter(name="partitionKey")
    def partition_key(self) -> pulumi.Output[builtins.str]:
        """
        The key for the partition where the entity will be inserted/merged. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "partition_key")
    ...
    @property
    @pulumi.getter(name="rowKey")
    def row_key(self) -> pulumi.Output[builtins.str]:
        """
        The key for the row where the entity will be inserted/merged. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "row_key")
    ...
    @property
    @pulumi.getter(name="storageTableId")
    def storage_table_id(self) -> pulumi.Output[builtins.str]:
        """
        The Storage Share ID in which this file will be placed into. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "storage_table_id")
