...
class GetTableEntitiesResult:
    ...
    @property
    @pulumi.getter
    def selects(self) -> Optional[Sequence[builtins.str]]:
...
def get_table_entities(filter: Optional[builtins.str] = None,
                       selects: Optional[Sequence[builtins.str]] = None,
                       storage_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: The filter used to retrieve the entities.
    :param Sequence[builtins.str] selects: A list of properties to select from the returned Storage Table Entities.
    :param builtins.str storage_table_id: The Storage Table ID where the entities exist.
    """
    __args__ = dict()
...
def get_table_entities_output(filter: Optional[pulumi.Input[builtins.str]] = None,
                              selects: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
