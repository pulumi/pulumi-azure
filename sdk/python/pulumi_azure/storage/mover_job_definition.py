...
class MoverJobDefinition(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_mover_agent = azure.storage.mover_agent.MoverAgent("example",
            name=example-agent,
            storage_mover_id=example_mover.id,
            arc_virtual_machine_id=f{example.id}/providers/Microsoft.HybridCompute/machines/examples-hybridComputeName,
        ...
        example_mover_project = azure.storage.mover_project.MoverProject("example",
            name=example-sp,
            storage_mover_id=example_mover.id)
        example_mover_job_definition = azure.storage.mover_job_definition.MoverJobDefinition("example",
            name=example-sjd,
