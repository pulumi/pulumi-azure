...
class EncryptionScopeArgs:
    def __init__(__self__, *,
                 ...
                 infrastructure_encryption_required: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] source: The source of the Storage Encryption Scope. Possible values are `Microsoft.KeyVault` and `Microsoft.Storage`.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account where this Storage Encryption Scope is created. Changing this forces a new Storage Encryption Scope to be created.
        :param pulumi.Input[builtins.bool] infrastructure_encryption_required: Is a secondary layer of encryption with Platform Managed Keys for data applied? Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] key_vault_key_id: The ID of the Key Vault Key. Required when `source` is `Microsoft.KeyVault`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Storage Encryption Scope. Changing this forces a new Storage Encryption Scope to be created.
        """
    ...
    def infrastructure_encryption_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def infrastructure_encryption_required(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EncryptionScope(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EncryptionScope':
        """
    ...
    @property
    @pulumi.getter(name="infrastructureEncryptionRequired")
    def infrastructure_encryption_required(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is a secondary layer of encryption with Platform Managed Keys for data applied? Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "infrastructure_encryption_required")
