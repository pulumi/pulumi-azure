...
class MoverTargetEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_account_id: Specifies the ID of the storage account for this Storage Mover Target Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_container_name: Specifies the name of the storage blob container for this Storage Mover Target Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_mover_id: Specifies the ID of the storage mover for this Storage Mover Target Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] description: Specifies a description for the Storage Mover Target Endpoint.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Storage Mover Target Endpoint. Changing this forces a new resource to be created.
        """
...
class MoverTargetEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_container_name: Optional[pulumi.Input[builtins.str]] = None,
            storage_mover_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MoverTargetEndpoint':
        """
