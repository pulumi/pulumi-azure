...
class ContainerImmutabilityPolicyArgs:
    def __init__(__self__, *,
                 immutability_period_in_days: pulumi.Input[builtins.int],
                 storage_container_resource_manager_id: pulumi.Input[builtins.str],
                 locked: Optional[pulumi.Input[builtins.bool]] = None,
                 protected_append_writes_all_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 protected_append_writes_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ContainerImmutabilityPolicy resource.
        :param pulumi.Input[builtins.int] immutability_period_in_days: The time interval in days that the data needs to be kept in a non-erasable and non-modifiable state.
        :param pulumi.Input[builtins.str] storage_container_resource_manager_id: The Resource Manager ID of the Storage Container where this Immutability Policy should be applied. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] locked: Whether to lock this immutability policy. Cannot be set to `false` once the policy has been locked.
        ...
        :param pulumi.Input[builtins.bool] protected_append_writes_all_enabled: Whether to allow protected append writes to block and append blobs to the container. Defaults to `false`. Cannot be set with `protected_append_writes_enabled`.
        :param pulumi.Input[builtins.bool] protected_append_writes_enabled: Whether to allow protected append writes to append blobs to the container. Defaults to `false`. Cannot be set with `protected_append_writes_all_enabled`.
        """
    ...
    def immutability_period_in_days(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def immutability_period_in_days(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "immutability_period_in_days", value)

    @property
    @pulumi.getter(name="storageContainerResourceManagerId")
    def storage_container_resource_manager_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_container_resource_manager_id(self, value: pulumi.Input[builtins.str]):
    ...
    def protected_append_writes_all_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def protected_append_writes_all_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "protected_append_writes_all_enabled", value)

    @property
    @pulumi.getter(name="protectedAppendWritesEnabled")
    def protected_append_writes_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def protected_append_writes_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ContainerImmutabilityPolicyState:
    def __init__(__self__, *,
                 immutability_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 locked: Optional[pulumi.Input[builtins.bool]] = None,
                 protected_append_writes_all_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 protected_append_writes_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 storage_container_resource_manager_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="immutabilityPeriodInDays")
    def immutability_period_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The time interval in days that the data needs to be kept in a non-erasable and non-modifiable state.
        """
        return pulumi.get(self, "immutability_period_in_days")
    ...
    @immutability_period_in_days.setter
    def immutability_period_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "immutability_period_in_days", value)
    ...
    @property
    @pulumi.getter(name="storageContainerResourceManagerId")
    def storage_container_resource_manager_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Resource Manager ID of the Storage Container where this Immutability Policy should be applied. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "storage_container_resource_manager_id")
    ...
    @storage_container_resource_manager_id.setter
    def storage_container_resource_manager_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_container_resource_manager_id", value)
...
class ContainerImmutabilityPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protected_append_writes_all_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            protected_append_writes_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            storage_container_resource_manager_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerImmutabilityPolicy':
        """
    ...
    @property
    @pulumi.getter(name="immutabilityPeriodInDays")
    def immutability_period_in_days(self) -> pulumi.Output[builtins.int]:
        """
        The time interval in days that the data needs to be kept in a non-erasable and non-modifiable state.
        """
        return pulumi.get(self, "immutability_period_in_days")
    ...
    @property
    @pulumi.getter(name="protectedAppendWritesAllEnabled")
    def protected_append_writes_all_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to allow protected append writes to block and append blobs to the container. Defaults to `false`. Cannot be set with `protected_append_writes_enabled`.
        """
        return pulumi.get(self, "protected_append_writes_all_enabled")
    ...
    @property
    @pulumi.getter(name="protectedAppendWritesEnabled")
    def protected_append_writes_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to allow protected append writes to append blobs to the container. Defaults to `false`. Cannot be set with `protected_append_writes_all_enabled`.
        """
        return pulumi.get(self, "protected_append_writes_enabled")
    ...
    @property
    @pulumi.getter(name="storageContainerResourceManagerId")
    def storage_container_resource_manager_id(self) -> pulumi.Output[builtins.str]:
        """
        The Resource Manager ID of the Storage Container where this Immutability Policy should be applied. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "storage_container_resource_manager_id")
