...
class LocalUserArgs:
    def __init__(__self__, *,
                 ...
                 ssh_key_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ssh_password_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a LocalUser resource.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account that this Storage Account Local User resides in. Changing this forces a new Storage Account Local User to be created.
        :param pulumi.Input[builtins.str] home_directory: The home directory of the Storage Account Local User.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Storage Account Local User. Changing this forces a new Storage Account Local User to be created.
        ...
        :param pulumi.Input[builtins.bool] ssh_key_enabled: Specifies whether SSH Key Authentication is enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] ssh_password_enabled: Specifies whether SSH Password Authentication is enabled. Defaults to `false`.
        """
    ...
    def ssh_key_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ssh_key_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ssh_key_enabled", value)

    @property
    @pulumi.getter(name="sshPasswordEnabled")
    def ssh_password_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ssh_password_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _LocalUserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] home_directory: The home directory of the Storage Account Local User.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Storage Account Local User. Changing this forces a new Storage Account Local User to be created.
        :param pulumi.Input[builtins.str] password: The value of the password, which is only available when `ssh_password_enabled` is set to `true`.
        :param pulumi.Input[Sequence[pulumi.Input['LocalUserPermissionScopeArgs']]] permission_scopes: One or more `permission_scope` blocks as defined below.
        :param pulumi.Input[builtins.str] sid: The unique Security Identifier of this Storage Account Local User.
        :param pulumi.Input[Sequence[pulumi.Input['LocalUserSshAuthorizedKeyArgs']]] ssh_authorized_keys: One or more `ssh_authorized_key` blocks as defined below.
        :param pulumi.Input[builtins.bool] ssh_key_enabled: Specifies whether SSH Key Authentication is enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] ssh_password_enabled: Specifies whether SSH Password Authentication is enabled. Defaults to `false`.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account that this Storage Account Local User resides in. Changing this forces a new Storage Account Local User to be created.
...
class LocalUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssh_key_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            ssh_password_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LocalUser':
        """
    ...
    @property
    @pulumi.getter(name="sshKeyEnabled")
    def ssh_key_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether SSH Key Authentication is enabled. Defaults to `false`.
        """
        return pulumi.get(self, "ssh_key_enabled")
    ...
    @property
    @pulumi.getter(name="sshPasswordEnabled")
    def ssh_password_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether SSH Password Authentication is enabled. Defaults to `false`.
        """
        return pulumi.get(self, "ssh_password_enabled")
