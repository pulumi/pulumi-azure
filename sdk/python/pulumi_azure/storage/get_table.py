...
class GetTableResult:
    ...
    """
    def __init__(__self__, acls=None, id=None, name=None, resource_manager_id=None, storage_account_id=None):
...
def get_table(name: Optional[_builtins.str] = None,
    ...
    example_get_table = azure.storage.get_table(name="example-table-name",
