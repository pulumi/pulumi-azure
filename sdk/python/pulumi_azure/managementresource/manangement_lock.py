...
class ManangementLockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lock_level: Specifies the Level to be used for this Lock. Possible values are `CanNotDelete` and `ReadOnly`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] scope: Specifies the scope at which the Management Lock should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Management Lock. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] notes: Specifies some notes about the lock. Maximum of 512 characters. Changing this forces a new resource to be created.
        """
...
class ManangementLock(pulumi.CustomResource):
    ...
    pulumi_type = "azure:managementresource/manangementLock:ManangementLock"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            notes: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'ManangementLock':
        """
