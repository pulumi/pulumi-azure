...
class OutputMssqlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] table: Table in the database that the output points to. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.float] max_writer_count: The max writer count for the SQL Database. Defaults to `1`. Possible values are `0` which bases the writer count on the query partition and `1` which corresponds to a single writer.
        :param pulumi.Input[_builtins.str] name: The name of the Stream Output. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] password: Password used together with username, to login to the Microsoft SQL Server. Required if `authentication_mode` is `ConnectionString`.
        :param pulumi.Input[_builtins.str] user: Username used to login to the Microsoft SQL Server. Changing this forces a new resource to be created. Required if `authentication_mode` is `ConnectionString`.
        """
...
class OutputMssql(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="maxBatchCount")
    def max_batch_count(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The max batch count to write to the SQL Database. Defaults to `10000`. Possible values are between `1` and `1073741824`.
        """
        return pulumi.get(self, "max_batch_count")
    ...
    @_builtins.property
    @pulumi.getter(name="maxWriterCount")
    def max_writer_count(self) -> pulumi.Output[Optional[_builtins.float]]:
        """
        The max writer count for the SQL Database. Defaults to `1`. Possible values are `0` which bases the writer count on the query partition and `1` which corresponds to a single writer.
        """
        return pulumi.get(self, "max_writer_count")
