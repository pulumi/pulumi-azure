...
class JobArgs:
    def __init__(__self__, *,
                 ...
                 transformation_query: pulumi.Input[builtins.str],
                 compatibility_level: Optional[pulumi.Input[builtins.str]] = None,
                 content_storage_policy: Optional[pulumi.Input[builtins.str]] = None,
                 data_locale: Optional[pulumi.Input[builtins.str]] = None,
                 events_late_arrival_max_delay_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 events_out_of_order_max_delay_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 events_out_of_order_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 output_error_policy: Optional[pulumi.Input[builtins.str]] = None,
                 sku_name: Optional[pulumi.Input[builtins.str]] = None,
                 stream_analytics_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 streaming_units: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] events_out_of_order_max_delay_in_seconds: Specifies the maximum tolerable delay in seconds where out-of-order events can be adjusted to be back in order. Supported range is `0` to `599` (9m 59s). Default is `0`.
        :param pulumi.Input[builtins.str] events_out_of_order_policy: Specifies the policy which should be applied to events which arrive out of order in the input event stream. Possible values are `Adjust` and `Drop`. Default is `Adjust`.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region in which the Resource Group exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Stream Analytics Job. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] output_error_policy: Specifies the policy which should be applied to events which arrive at the output and cannot be written to the external storage due to being malformed (such as missing column values, column values of wrong type or size). Possible values are `Drop` and `Stop`. Default is `Drop`.
        :param pulumi.Input[builtins.str] sku_name: The SKU Name to use for the Stream Analytics Job. Possible values are `Standard`, `StandardV2`. Defaults to `Standard`.
    ...
    def transformation_query(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "transformation_query")

    @transformation_query.setter
    def transformation_query(self, value: pulumi.Input[builtins.str]):
    ...
    def content_storage_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_storage_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "content_storage_policy", value)

    @property
    @pulumi.getter(name="dataLocale")
    def data_locale(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @data_locale.setter
    def data_locale(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_locale", value)

    @property
    @pulumi.getter(name="eventsLateArrivalMaxDelayInSeconds")
    def events_late_arrival_max_delay_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def events_late_arrival_max_delay_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "events_late_arrival_max_delay_in_seconds", value)

    @property
    @pulumi.getter(name="eventsOutOfOrderMaxDelayInSeconds")
    def events_out_of_order_max_delay_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def events_out_of_order_max_delay_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "events_out_of_order_max_delay_in_seconds", value)

    @property
    @pulumi.getter(name="eventsOutOfOrderPolicy")
    def events_out_of_order_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def events_out_of_order_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def output_error_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def output_error_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stream_analytics_cluster_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def stream_analytics_cluster_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stream_analytics_cluster_id", value)

    @property
    @pulumi.getter(name="streamingUnits")
    def streaming_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def streaming_units(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _JobState:
    def __init__(__self__, *,
                 ...
                 streaming_units: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 transformation_query: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] events_out_of_order_policy: Specifies the policy which should be applied to events which arrive out of order in the input event stream. Possible values are `Adjust` and `Drop`. Default is `Adjust`.
        :param pulumi.Input['JobIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] job_id: The Job ID assigned by the Stream Analytics Job.
        :param pulumi.Input[Sequence[pulumi.Input['JobJobStorageAccountArgs']]] job_storage_accounts: The details of the job storage account. A `job_storage_account` block as defined below.
    ...
    @property
    @pulumi.getter(name="transformationQuery")
    def transformation_query(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "transformation_query")

    @transformation_query.setter
    def transformation_query(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transformation_query", value)
...
class Job(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="compatibilityLevel")
    def compatibility_level(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the compatibility level for this job - which controls certain runtime behaviours of the streaming job. Possible values are `1.0`, `1.1` and `1.2`.
    ...
    @property
    @pulumi.getter(name="contentStoragePolicy")
    def content_storage_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The policy for storing stream analytics content. Possible values are `JobStorageAccount`, `SystemAccount`. Defaults to `SystemAccount`.
        """
        return pulumi.get(self, "content_storage_policy")
    ...
    @property
    @pulumi.getter(name="dataLocale")
    def data_locale(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the Data Locale of the Job, which [should be a supported .NET Culture](https://msdn.microsoft.com/en-us/library/system.globalization.culturetypes(v=vs.110).aspx). Defaults to `en-US`.
        """
        return pulumi.get(self, "data_locale")
    ...
    @property
    @pulumi.getter(name="eventsLateArrivalMaxDelayInSeconds")
    def events_late_arrival_max_delay_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the maximum tolerable delay in seconds where events arriving late could be included. Supported range is `-1` (indefinite) to `1814399` (20d 23h 59m 59s). Default is `5`.
        """
        return pulumi.get(self, "events_late_arrival_max_delay_in_seconds")
    ...
    @property
    @pulumi.getter(name="eventsOutOfOrderMaxDelayInSeconds")
    def events_out_of_order_max_delay_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the maximum tolerable delay in seconds where out-of-order events can be adjusted to be back in order. Supported range is `0` to `599` (9m 59s). Default is `0`.
        """
        return pulumi.get(self, "events_out_of_order_max_delay_in_seconds")
    ...
    @property
    @pulumi.getter(name="eventsOutOfOrderPolicy")
    def events_out_of_order_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the policy which should be applied to events which arrive out of order in the input event stream. Possible values are `Adjust` and `Drop`. Default is `Adjust`.
        """
        return pulumi.get(self, "events_out_of_order_policy")
    ...
    @property
    @pulumi.getter(name="outputErrorPolicy")
    def output_error_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the policy which should be applied to events which arrive at the output and cannot be written to the external storage due to being malformed (such as missing column values, column values of wrong type or size). Possible values are `Drop` and `Stop`. Default is `Drop`.
        """
        return pulumi.get(self, "output_error_policy")
    ...
    @property
    @pulumi.getter(name="streamAnalyticsClusterId")
    def stream_analytics_cluster_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of an existing Stream Analytics Cluster where the Stream Analytics Job should run.
        """
        return pulumi.get(self, "stream_analytics_cluster_id")
    ...
    @property
    @pulumi.getter(name="streamingUnits")
    def streaming_units(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the number of streaming units that the streaming job uses. Supported values are `1`, `3`, `6` and multiples of `6` up to `120`. A conversion table for V2 streaming units can be found [here](https://learn.microsoft.com/azure/stream-analytics/stream-analytics-streaming-unit-consumption#understand-streaming-unit-conversions-and-where-they-apply)
    ...
    @property
    @pulumi.getter(name="transformationQuery")
    def transformation_query(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "transformation_query")
