...
class FunctionJavaScriptUDFInput(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 configuration_parameter: Optional[builtins.bool] = None):
        """
        :param builtins.str type: The Data Type for the Input Argument of this JavaScript Function. Possible values include `array`, `any`, `bigint`, `datetime`, `float`, `nvarchar(max)` and `record`.
        :param builtins.bool configuration_parameter: Is this input parameter a configuration parameter? Defaults to `false`.
        """
    ...
    def configuration_parameter(self) -> Optional[builtins.bool]:
        """
...
class FunctionJavaScriptUDFOutput(dict):
    def __init__(__self__, *,
                 type: builtins.str):
        """
        :param builtins.str type: The Data Type output from this JavaScript Function. Possible values include `array`, `any`, `bigint`, `datetime`, `float`, `nvarchar(max)` and `record`.
        """
        pulumi.set(__self__, "type", type)
...
class FunctionJavascriptUdaInput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 configuration_parameter: Optional[builtins.bool] = None):
        """
        :param builtins.str type: The input data type of this JavaScript Function. Possible values include `any`, `array`, `bigint`, `datetime`, `float`, `nvarchar(max)` and `record`.
        :param builtins.bool configuration_parameter: Is this input parameter a configuration parameter? Defaults to `false`.
        """
        pulumi.set(__self__, "type", type)
        if configuration_parameter is not None:
...
class FunctionJavascriptUdaOutput(dict):
    def __init__(__self__, *,
                 type: builtins.str):
        """
        :param builtins.str type: The output data type from this JavaScript Function. Possible values include `any`, `array`, `bigint`, `datetime`, `float`, `nvarchar(max)` and `record`.
        """
        pulumi.set(__self__, "type", type)
...
class JobIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Stream Analytics Job. Possible values are `SystemAssigned` and `UserAssigned`.
...
class JobJobStorageAccount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_key: The account key for the Azure storage account.
        :param builtins.str account_name: The name of the Azure storage account.
        :param builtins.str authentication_mode: The authentication mode of the storage account. The only supported value is `ConnectionString`. Defaults to `ConnectionString`.
        """
...
class OutputBlobSerialization(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The serialization format used for outgoing data streams. Possible values are `Avro`, `Csv`, `Json` and `Parquet`.
               
               > **Note:** `batch_max_wait_time` and `batch_min_rows` are required when `type` is set to `Parquet`
        :param builtins.str encoding: The encoding of the incoming data in the case of input and the encoding of outgoing data in the case of output. It currently can only be set to `UTF8`.
               
               > **Note:** This is required when `type` is set to `Csv` or `Json`.
        :param builtins.str field_delimiter: The delimiter that will be used to separate comma-separated value (CSV) records. Possible values are ` ` (space), `,` (comma), `	` (tab), `|` (pipe) and `;`.
               
               > **Note:** This is required when `type` is set to `Csv`.
        :param builtins.str format: Specifies the format of the JSON the output will be written in. Possible values are `Array` and `LineSeparated`.
...
class ReferenceInputBlobSerialization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field_delimiter: Optional[builtins.str] = None):
        """
        :param builtins.str type: The serialization format used for the reference data. Possible values are `Avro`, `Csv` and `Json`.
        :param builtins.str encoding: The encoding of the incoming data in the case of input and the encoding of outgoing data in the case of output. It currently can only be set to `UTF8`.
...
class StreamInputBlobSerialization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field_delimiter: Optional[builtins.str] = None):
        """
        :param builtins.str type: The serialization format used for incoming data streams. Possible values are `Avro`, `Csv` and `Json`.
        :param builtins.str encoding: The encoding of the incoming data in the case of input and the encoding of outgoing data in the case of output. It currently can only be set to `UTF8`.
