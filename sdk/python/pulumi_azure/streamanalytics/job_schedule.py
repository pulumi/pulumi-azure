...
class JobScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] stream_analytics_job_id: The ID of the Stream Analytics Job that should be scheduled or started. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] start_time: The time in ISO8601 format at which the Stream Analytics Job should be started e.g. `2022-04-01T00:00:00Z`. This property can only be specified if `start_mode` is set to `CustomTime`
        """
    ...
    def start_mode(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @start_mode.setter
    def start_mode(self, value: pulumi.Input[_builtins.str]):
...
class JobSchedule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="lastOutputTime")
    def last_output_time(self) -> pulumi.Output[_builtins.str]:
        """
        The time at which the Stream Analytics job last produced an output.
        """
        return pulumi.get(self, "last_output_time")
    ...
    @_builtins.property
    @pulumi.getter(name="startMode")
    def start_mode(self) -> pulumi.Output[_builtins.str]:
        """
        The starting mode of the Stream Analytics Job. Possible values are `JobStartTime`, `CustomTime` and `LastOutputEventTime`.
