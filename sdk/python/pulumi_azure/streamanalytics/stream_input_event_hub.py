...
class StreamInputEventHubArgs:
    def __init__(__self__, *,
                 ...
                 servicebus_namespace: pulumi.Input[builtins.str],
                 ...
                 partition_key: Optional[pulumi.Input[builtins.str]] = None,
                 shared_access_policy_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] eventhub_name: The name of the Event Hub.
        ...
        :param pulumi.Input[builtins.str] servicebus_namespace: The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
        ...
        :param pulumi.Input[builtins.str] eventhub_consumer_group_name: The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub. If not set the input will use the Event Hub's default consumer group.
        :param pulumi.Input[builtins.str] name: The name of the Stream Input EventHub. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] partition_key: The property the input Event Hub has been partitioned by.
        :param pulumi.Input[builtins.str] shared_access_policy_key: The shared access policy key for the specified shared access policy.
        :param pulumi.Input[builtins.str] shared_access_policy_name: The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc.
        """
    ...
    def servicebus_namespace(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def servicebus_namespace(self, value: pulumi.Input[builtins.str]):
    ...
    def partition_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partition_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partition_key", value)

    @property
    @pulumi.getter(name="sharedAccessPolicyKey")
    def shared_access_policy_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_access_policy_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "shared_access_policy_key", value)

    @property
    @pulumi.getter(name="sharedAccessPolicyName")
    def shared_access_policy_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_access_policy_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StreamInputEventHubState:
    def __init__(__self__, *,
                 authentication_mode: Optional[pulumi.Input[builtins.str]] = None,
                 eventhub_consumer_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 eventhub_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 partition_key: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 serialization: Optional[pulumi.Input['StreamInputEventHubSerializationArgs']] = None,
                 servicebus_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 shared_access_policy_key: Optional[pulumi.Input[builtins.str]] = None,
                 shared_access_policy_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="eventhubName")
    def eventhub_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Event Hub.
        """
        return pulumi.get(self, "eventhub_name")
    ...
    @eventhub_name.setter
    def eventhub_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "eventhub_name", value)
    ...
    @property
    @pulumi.getter
    def serialization(self) -> Optional[pulumi.Input['StreamInputEventHubSerializationArgs']]:
        """
        A `serialization` block as defined below.
        """
        return pulumi.get(self, "serialization")
    ...
    @serialization.setter
    def serialization(self, value: Optional[pulumi.Input['StreamInputEventHubSerializationArgs']]):
        pulumi.set(self, "serialization", value)

    @property
    @pulumi.getter(name="servicebusNamespace")
    def servicebus_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
        """
        return pulumi.get(self, "servicebus_namespace")
    ...
    @servicebus_namespace.setter
    def servicebus_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "servicebus_namespace", value)
...
class StreamInputEventHub(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 partition_key: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 serialization: Optional[pulumi.Input[Union['StreamInputEventHubSerializationArgs', 'StreamInputEventHubSerializationArgsDict']]] = None,
                 servicebus_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 shared_access_policy_key: Optional[pulumi.Input[builtins.str]] = None,
                 shared_access_policy_name: Optional[pulumi.Input[builtins.str]] = None,
                 stream_analytics_job_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        * `Microsoft.StreamAnalytics`: 2020-03-01
        ...
        :param pulumi.Input[builtins.str] partition_key: The property the input Event Hub has been partitioned by.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Stream Analytics Job exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['StreamInputEventHubSerializationArgs', 'StreamInputEventHubSerializationArgsDict']] serialization: A `serialization` block as defined below.
        :param pulumi.Input[builtins.str] servicebus_namespace: The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
        :param pulumi.Input[builtins.str] shared_access_policy_key: The shared access policy key for the specified shared access policy.
        :param pulumi.Input[builtins.str] shared_access_policy_name: The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc.
        :param pulumi.Input[builtins.str] stream_analytics_job_name: The name of the Stream Analytics Job. Changing this forces a new resource to be created.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = StreamInputEventHubArgs.__new__(StreamInputEventHubArgs)
    ...
    def get(resource_name: str,
            ...
            shared_access_policy_key: Optional[pulumi.Input[builtins.str]] = None,
            shared_access_policy_name: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_name: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamInputEventHub':
        """
        ...
        __props__ = _StreamInputEventHubState.__new__(_StreamInputEventHubState)
    ...
    @property
    @pulumi.getter(name="eventhubConsumerGroupName")
    def eventhub_consumer_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of an Event Hub Consumer Group that should be used to read events from the Event Hub. Specifying distinct consumer group names for multiple inputs allows each of those inputs to receive the same events from the Event Hub. If not set the input will use the Event Hub's default consumer group.
        """
        return pulumi.get(self, "eventhub_consumer_group_name")
    ...
    @property
    @pulumi.getter(name="eventhubName")
    def eventhub_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Event Hub.
        """
        return pulumi.get(self, "eventhub_name")
    ...
    @property
    @pulumi.getter(name="partitionKey")
    def partition_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The property the input Event Hub has been partitioned by.
        """
        return pulumi.get(self, "partition_key")
    ...
    @property
    @pulumi.getter(name="servicebusNamespace")
    def servicebus_namespace(self) -> pulumi.Output[builtins.str]:
        """
        The namespace that is associated with the desired Event Hub, Service Bus Queue, Service Bus Topic, etc.
        """
        return pulumi.get(self, "servicebus_namespace")
    ...
    @property
    @pulumi.getter(name="sharedAccessPolicyKey")
    def shared_access_policy_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The shared access policy key for the specified shared access policy.
        """
        return pulumi.get(self, "shared_access_policy_key")
    ...
    @property
    @pulumi.getter(name="sharedAccessPolicyName")
    def shared_access_policy_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc.
        """
        return pulumi.get(self, "shared_access_policy_name")
