...
class StreamInputEventHubArgs:
    def __init__(__self__, *,
        ...
        """
        StreamInputEventHubArgs._configure(
...
class _StreamInputEventHubState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] stream_analytics_job_name: The name of the Stream Analytics Job. Changing this forces a new resource to be created.
        """
        _StreamInputEventHubState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            authentication_mode=authentication_mode,
            eventhub_consumer_group_name=eventhub_consumer_group_name,
            eventhub_name=eventhub_name,
...
class StreamInputEventHub(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            StreamInputEventHubArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if serialization is not None and not isinstance(serialization, StreamInputEventHubSerializationArgs):
                serialization = serialization or {}
                def _setter(key, value):
                    serialization[key] = value
                StreamInputEventHubSerializationArgs._configure(_setter, **serialization)
