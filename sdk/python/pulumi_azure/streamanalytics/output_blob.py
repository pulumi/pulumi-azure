...
class OutputBlobArgs:
    ...
    def _configure(
        ...
        if batch_max_wait_time is None and 'batchMaxWaitTime' in kwargs:
            batch_max_wait_time = kwargs['batchMaxWaitTime']
        if batch_min_rows is None and 'batchMinRows' in kwargs:
            batch_min_rows = kwargs['batchMinRows']
        ...
        if batch_min_rows is not None:
            _setter("batch_min_rows", batch_min_rows)
        if name is not None:
            _setter("name", name)
...
class OutputBlob(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OutputBlobArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if serialization is not None and not isinstance(serialization, OutputBlobSerializationArgs):
                serialization = serialization or {}
                def _setter(key, value):
                    serialization[key] = value
                OutputBlobSerializationArgs._configure(_setter, **serialization)
