...
class OutputBlobArgs:
    def __init__(__self__, *,
                 date_format: pulumi.Input[builtins.str],
                 ...
                 time_format: pulumi.Input[builtins.str],
                 authentication_mode: Optional[pulumi.Input[builtins.str]] = None,
                 batch_max_wait_time: Optional[pulumi.Input[builtins.str]] = None,
                 batch_min_rows: Optional[pulumi.Input[builtins.int]] = None,
                 blob_write_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] date_format: The date format. Wherever `{date}` appears in `path_pattern`, the value of this property is used as the date format instead.
        :param pulumi.Input[builtins.str] path_pattern: The blob path pattern. Not a regular expression. It represents a pattern against which blob names will be matched to determine whether or not they should be included as input or output to the job.
        ...
        :param pulumi.Input[builtins.str] storage_account_name: The name of the Storage Account.
        :param pulumi.Input[builtins.str] storage_container_name: The name of the Container within the Storage Account.
        ...
        :param pulumi.Input[builtins.str] time_format: The time format. Wherever `{time}` appears in `path_pattern`, the value of this property is used as the time format instead.
        ...
        :param pulumi.Input[builtins.str] batch_max_wait_time: The maximum wait time per batch in `hh:mm:ss` e.g. `00:02:00` for two minutes.
        :param pulumi.Input[builtins.int] batch_min_rows: The minimum number of rows per batch (must be between `0` and `1000000`).
        :param pulumi.Input[builtins.str] blob_write_mode: Determines whether blob blocks are either committed automatically or appended. Possible values are `Append` and `Once`. Defaults to `Append`.
        :param pulumi.Input[builtins.str] name: The name of the Stream Output. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_key: The Access Key which should be used to connect to this Storage Account.
        """
    ...
    def date_format(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @date_format.setter
    def date_format(self, value: pulumi.Input[builtins.str]):
    ...
    def time_format(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @time_format.setter
    def time_format(self, value: pulumi.Input[builtins.str]):
    ...
    def batch_max_wait_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def batch_max_wait_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "batch_max_wait_time", value)

    @property
    @pulumi.getter(name="batchMinRows")
    def batch_min_rows(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def batch_min_rows(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "batch_min_rows", value)

    @property
    @pulumi.getter(name="blobWriteMode")
    def blob_write_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blob_write_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OutputBlobState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 path_pattern: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="pathPattern")
    def path_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The blob path pattern. Not a regular expression. It represents a pattern against which blob names will be matched to determine whether or not they should be included as input or output to the job.
        """
        return pulumi.get(self, "path_pattern")
    ...
    @path_pattern.setter
    def path_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "path_pattern", value)
...
class OutputBlob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 path_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 serialization: Optional[pulumi.Input[Union['OutputBlobSerializationArgs', 'OutputBlobSerializationArgsDict']]] = None,
                 storage_account_key: Optional[pulumi.Input[builtins.str]] = None,
                 storage_account_name: Optional[pulumi.Input[builtins.str]] = None,
                 storage_container_name: Optional[pulumi.Input[builtins.str]] = None,
                 stream_analytics_job_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        * `Microsoft.StreamAnalytics`: 2021-10-01-preview
        ...
        :param pulumi.Input[builtins.str] path_pattern: The blob path pattern. Not a regular expression. It represents a pattern against which blob names will be matched to determine whether or not they should be included as input or output to the job.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Stream Analytics Job exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['OutputBlobSerializationArgs', 'OutputBlobSerializationArgsDict']] serialization: A `serialization` block as defined below.
        :param pulumi.Input[builtins.str] storage_account_key: The Access Key which should be used to connect to this Storage Account.
        :param pulumi.Input[builtins.str] storage_account_name: The name of the Storage Account.
        :param pulumi.Input[builtins.str] storage_container_name: The name of the Container within the Storage Account.
        :param pulumi.Input[builtins.str] stream_analytics_job_name: The name of the Stream Analytics Job. Changing this forces a new resource to be created.
    ...
    def get(resource_name: str,
            ...
            storage_container_name: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_name: Optional[pulumi.Input[builtins.str]] = None,
            time_format: Optional[pulumi.Input[builtins.str]] = None) -> 'OutputBlob':
        """
    ...
    @property
    @pulumi.getter(name="batchMaxWaitTime")
    def batch_max_wait_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The maximum wait time per batch in `hh:mm:ss` e.g. `00:02:00` for two minutes.
        """
        return pulumi.get(self, "batch_max_wait_time")
    ...
    @property
    @pulumi.getter(name="batchMinRows")
    def batch_min_rows(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The minimum number of rows per batch (must be between `0` and `1000000`).
        """
        return pulumi.get(self, "batch_min_rows")
    ...
    @property
    @pulumi.getter(name="blobWriteMode")
    def blob_write_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Determines whether blob blocks are either committed automatically or appended. Possible values are `Append` and `Once`. Defaults to `Append`.
        """
        return pulumi.get(self, "blob_write_mode")
    ...
    @property
    @pulumi.getter(name="pathPattern")
    def path_pattern(self) -> pulumi.Output[builtins.str]:
        """
        The blob path pattern. Not a regular expression. It represents a pattern against which blob names will be matched to determine whether or not they should be included as input or output to the job.
        """
        return pulumi.get(self, "path_pattern")
    ...
    @property
    @pulumi.getter(name="storageAccountKey")
    def storage_account_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Access Key which should be used to connect to this Storage Account.
        """
        return pulumi.get(self, "storage_account_key")
