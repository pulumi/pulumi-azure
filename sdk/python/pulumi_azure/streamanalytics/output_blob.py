...
class OutputBlobArgs:
    def __init__(__self__, *,
                 ...
                 batch_max_wait_time: pulumi.Input[Optional[_builtins.str]] = None,
                 batch_min_rows: pulumi.Input[Optional[_builtins.int]] = None,
                 blob_write_mode: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] blob_write_mode: Determines whether blob blocks are either committed automatically or appended. Possible values are `Append` and `Once`. Defaults to `Append`.
    ...
    def batch_max_wait_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def batch_max_wait_time(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "batch_max_wait_time", value)

    @_builtins.property
    @pulumi.getter(name="batchMinRows")
    def batch_min_rows(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def batch_min_rows(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "batch_min_rows", value)

    @_builtins.property
    @pulumi.getter(name="blobWriteMode")
    def blob_write_mode(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def blob_write_mode(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _OutputBlobState:
    def __init__(__self__, *,
                 ...
                 serialization: pulumi.Input[Optional['OutputBlobSerializationArgs']] = None,
                 storage_account_key: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def serialization(self) -> pulumi.Input[Optional['OutputBlobSerializationArgs']]:
        """
        A `serialization` block as defined below.
        """
        return pulumi.get(self, "serialization")
    ...
    @serialization.setter
    def serialization(self, value: pulumi.Input[Optional['OutputBlobSerializationArgs']]):
        pulumi.set(self, "serialization", value)
...
class OutputBlob(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 path_pattern: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 serialization: pulumi.Input[Optional[Union['OutputBlobSerializationArgs', 'OutputBlobSerializationArgsDict', 'outputs.OutputBlobSerialization']]] = None,
                 storage_account_key: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_container_name: pulumi.Input[Optional[_builtins.str]] = None,
                 stream_analytics_job_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `Microsoft.StreamAnalytics` - 2021-10-01-preview
        ...
        :param pulumi.Input[_builtins.str] path_pattern: The blob path pattern. Not a regular expression. It represents a pattern against which blob names will be matched to determine whether or not they should be included as input or output to the job.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Stream Analytics Job exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['OutputBlobSerializationArgs', 'OutputBlobSerializationArgsDict', 'outputs.OutputBlobSerialization']] serialization: A `serialization` block as defined below.
        :param pulumi.Input[_builtins.str] storage_account_key: The Access Key which should be used to connect to this Storage Account.
        :param pulumi.Input[_builtins.str] storage_account_name: The name of the Storage Account.
        :param pulumi.Input[_builtins.str] storage_container_name: The name of the Container within the Storage Account.
        :param pulumi.Input[_builtins.str] stream_analytics_job_name: The name of the Stream Analytics Job. Changing this forces a new resource to be created.
    ...
    def get(resource_name: str,
            ...
            storage_container_name: pulumi.Input[Optional[_builtins.str]] = None,
            stream_analytics_job_name: pulumi.Input[Optional[_builtins.str]] = None,
            time_format: pulumi.Input[Optional[_builtins.str]] = None) -> 'OutputBlob':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="batchMaxWaitTime")
    def batch_max_wait_time(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The maximum wait time per batch in `hh:mm:ss` e.g. `00:02:00` for two minutes.
        """
        return pulumi.get(self, "batch_max_wait_time")
    ...
    @_builtins.property
    @pulumi.getter(name="batchMinRows")
    def batch_min_rows(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The minimum number of rows per batch (must be between `0` and `1000000`).
        """
        return pulumi.get(self, "batch_min_rows")
    ...
    @_builtins.property
    @pulumi.getter(name="blobWriteMode")
    def blob_write_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Determines whether blob blocks are either committed automatically or appended. Possible values are `Append` and `Once`. Defaults to `Append`.
        """
        return pulumi.get(self, "blob_write_mode")
