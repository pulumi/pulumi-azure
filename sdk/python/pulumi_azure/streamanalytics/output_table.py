...
class OutputTableArgs:
    def __init__(__self__, *,
                 ...
                 columns_to_removes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a OutputTable resource.
        :param pulumi.Input[builtins.int] batch_size: The number of records for a batch operation. Must be between `1` and `100`.
        :param pulumi.Input[builtins.str] partition_key: The name of the output column that contains the partition key.
        ...
        :param pulumi.Input[builtins.str] row_key: The name of the output column that contains the row key.
        ...
        :param pulumi.Input[builtins.str] table: The name of the table where the stream should be output to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] columns_to_removes: A list of the column names to be removed from output event entities.
    ...
    def columns_to_removes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def columns_to_removes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class OutputTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_name: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_name: Optional[pulumi.Input[builtins.str]] = None,
            table: Optional[pulumi.Input[builtins.str]] = None) -> 'OutputTable':
        """
    ...
    @property
    @pulumi.getter(name="columnsToRemoves")
    def columns_to_removes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of the column names to be removed from output event entities.
        """
        return pulumi.get(self, "columns_to_removes")
