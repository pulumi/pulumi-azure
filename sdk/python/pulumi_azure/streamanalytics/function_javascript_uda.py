...
class FunctionJavascriptUdaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] script: The JavaScript of this UDA Function.
        :param pulumi.Input[builtins.str] stream_analytics_job_id: The resource ID of the Stream Analytics Job where this Function should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the JavaScript UDA Function. Changing this forces a new resource to be created.
        """
...
@pulumi.type_token("azure:streamanalytics/functionJavascriptUda:FunctionJavascriptUda")
class FunctionJavascriptUda(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            output: Optional[pulumi.Input[Union['FunctionJavascriptUdaOutputArgs', 'FunctionJavascriptUdaOutputArgsDict']]] = None,
            script: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FunctionJavascriptUda':
        """
