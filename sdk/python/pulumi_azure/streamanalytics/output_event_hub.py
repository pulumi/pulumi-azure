...
class OutputEventHubArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] partition_key: The column that is used for the Event Hub partition key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] property_columns: A list of property columns to add to the Event Hub output.
        :param pulumi.Input[builtins.str] shared_access_policy_key: The shared access policy key for the specified shared access policy. Required when `authentication_mode` is set to `ConnectionString`.
        :param pulumi.Input[builtins.str] shared_access_policy_name: The shared access policy name for the Event Hub, Service Bus Queue, Service Bus Topic, etc. Required when `authentication_mode` is set to `ConnectionString`.
        """
...
class OutputEventHub(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            shared_access_policy_key: Optional[pulumi.Input[builtins.str]] = None,
            shared_access_policy_name: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_name: Optional[pulumi.Input[builtins.str]] = None) -> 'OutputEventHub':
        """
