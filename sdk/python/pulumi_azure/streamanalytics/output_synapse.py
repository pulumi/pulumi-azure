...
class OutputSynapseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database: The name of the Azure SQL database. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] password: The password that will be used to connect to the Azure SQL database.
        ...
        :param pulumi.Input[_builtins.str] server: The name of the SQL server containing the Azure SQL database. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] table: The name of the table in the Azure SQL database. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] user: The user name that will be used to connect to the Azure SQL database. Changing this forces a new resource to be created.
