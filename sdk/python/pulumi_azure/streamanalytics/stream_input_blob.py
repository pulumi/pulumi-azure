...
class StreamInputBlobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] authentication_mode: The authentication mode for the Stream Analytics Input. Possible values are `Msi` and `ConnectionString`. Defaults to `ConnectionString`.
