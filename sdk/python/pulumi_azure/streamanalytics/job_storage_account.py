...
class JobStorageAccountArgs:
    def __init__(__self__, *,
                 authentication_mode: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] authentication_mode: The authentication mode for the Stream Analytics Job's Storage Account. Possible values are `ConnectionString`, and `Msi`.
    ...
    def authentication_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authentication_mode(self, value: pulumi.Input[builtins.str]):
...
class JobStorageAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_key: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_name: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_id: Optional[pulumi.Input[builtins.str]] = None) -> 'JobStorageAccount':
        """
