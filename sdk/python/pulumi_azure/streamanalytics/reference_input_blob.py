...
class ReferenceInputBlobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_account_name: The name of the Storage Account that has the blob container with reference data.
        ...
        :param pulumi.Input[builtins.str] authentication_mode: The authentication mode for the Stream Analytics Reference Input. Possible values are `Msi` and `ConnectionString`. Defaults to `ConnectionString`.
        :param pulumi.Input[builtins.str] name: The name of the Reference Input Blob. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_key: The Access Key which should be used to connect to this Storage Account. Required if `authentication_mode` is `ConnectionString`.
        """
...
class ReferenceInputBlob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_container_name: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_name: Optional[pulumi.Input[builtins.str]] = None,
            time_format: Optional[pulumi.Input[builtins.str]] = None) -> 'ReferenceInputBlob':
        """
