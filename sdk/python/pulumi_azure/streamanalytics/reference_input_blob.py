...
class _ReferenceInputBlobState:
    def __init__(__self__, *,
                 ...
                 serialization: pulumi.Input[Optional['ReferenceInputBlobSerializationArgs']] = None,
                 storage_account_key: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def serialization(self) -> pulumi.Input[Optional['ReferenceInputBlobSerializationArgs']]:
        """
        A `serialization` block as defined below.
        """
        return pulumi.get(self, "serialization")
    ...
    @serialization.setter
    def serialization(self, value: pulumi.Input[Optional['ReferenceInputBlobSerializationArgs']]):
        pulumi.set(self, "serialization", value)
...
class ReferenceInputBlob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_container_name: pulumi.Input[Optional[_builtins.str]] = None,
            stream_analytics_job_name: pulumi.Input[Optional[_builtins.str]] = None,
            time_format: pulumi.Input[Optional[_builtins.str]] = None) -> 'ReferenceInputBlob':
        """
