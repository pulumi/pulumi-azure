...
class OutputCosmosdbArgs:
    def __init__(__self__, *,
                 ...
                 cosmosdb_account_key: pulumi.Input[builtins.str],
                 cosmosdb_sql_database_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] container_name: The name of the CosmosDB container.
        :param pulumi.Input[builtins.str] cosmosdb_account_key: The account key for the CosmosDB database.
        :param pulumi.Input[builtins.str] cosmosdb_sql_database_id: The ID of the CosmosDB database.
        :param pulumi.Input[builtins.str] stream_analytics_job_id: The ID of the Stream Analytics Job. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] authentication_mode: The authentication mode for the CosmosDB database. Possible values are `ConnectionString` and `Msi`. Defaults to `ConnectionString`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Stream Analytics Output. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] partition_key: The name of the field in output events used to specify the key for partitioning output across collections. If `container_name` contains `{partition}` token, this property is required to be specified.
        """
    ...
    def cosmosdb_account_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cosmosdb_account_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cosmosdb_account_key", value)

    @property
    @pulumi.getter(name="cosmosdbSqlDatabaseId")
    def cosmosdb_sql_database_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cosmosdb_sql_database_id(self, value: pulumi.Input[builtins.str]):
...
class _OutputCosmosdbState:
    def __init__(__self__, *,
                 ...
                 cosmosdb_account_key: Optional[pulumi.Input[builtins.str]] = None,
                 cosmosdb_sql_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 document_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 partition_key: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="cosmosdbAccountKey")
    def cosmosdb_account_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The account key for the CosmosDB database.
        """
        return pulumi.get(self, "cosmosdb_account_key")
    ...
    @cosmosdb_account_key.setter
    def cosmosdb_account_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cosmosdb_account_key", value)

    @property
    @pulumi.getter(name="cosmosdbSqlDatabaseId")
    def cosmosdb_sql_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the CosmosDB database.
        """
        return pulumi.get(self, "cosmosdb_sql_database_id")
    ...
    @cosmosdb_sql_database_id.setter
    def cosmosdb_sql_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cosmosdb_sql_database_id", value)
...
class OutputCosmosdb(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            partition_key: Optional[pulumi.Input[builtins.str]] = None,
            stream_analytics_job_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OutputCosmosdb':
        """
    ...
    @property
    @pulumi.getter(name="cosmosdbAccountKey")
    def cosmosdb_account_key(self) -> pulumi.Output[builtins.str]:
        """
        The account key for the CosmosDB database.
        """
        return pulumi.get(self, "cosmosdb_account_key")
    ...
    @property
    @pulumi.getter(name="cosmosdbSqlDatabaseId")
    def cosmosdb_sql_database_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the CosmosDB database.
        """
        return pulumi.get(self, "cosmosdb_sql_database_id")
    ...
    @property
    @pulumi.getter(name="documentId")
    def document_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the field in output events used to specify the primary key which insert or update operations are based on.
        """
        return pulumi.get(self, "document_id")
