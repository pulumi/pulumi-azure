...
class ReferenceInputMssqlArgs:
    def __init__(__self__, *,
                 ...
                 full_snapshot_query: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] refresh_type: Defines whether and how the reference data should be refreshed. Accepted values are `Static`, `RefreshPeriodicallyWithFull` and `RefreshPeriodicallyWithDelta`.
        ...
        :param pulumi.Input[_builtins.str] server: The fully qualified domain name of the MS SQL server.
        ...
        :param pulumi.Input[_builtins.str] username: The username to connect to the MS SQL database.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Reference Input MS SQL data. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] refresh_interval_duration: The frequency in `hh:mm:ss` with which the reference data should be retrieved from the MS SQL database e.g. `00:20:00` for every 20 minutes. Must be set when `refresh_type` is `RefreshPeriodicallyWithFull` or `RefreshPeriodicallyWithDelta`.
        :param pulumi.Input[_builtins.str] table: The name of the table in the Azure SQL database.
        """
    ...
    def full_snapshot_query(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def full_snapshot_query(self, value: pulumi.Input[_builtins.str]):
...
class ReferenceInputMssql(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="deltaSnapshotQuery")
    def delta_snapshot_query(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The query used to retrieve incremental changes in the reference data from the MS SQL database. Cannot be set when `refresh_type` is `Static`.
        """
        return pulumi.get(self, "delta_snapshot_query")
    ...
    @_builtins.property
    @pulumi.getter(name="fullSnapshotQuery")
    def full_snapshot_query(self) -> pulumi.Output[_builtins.str]:
        """
        The query used to retrieve the reference data from the MS SQL database.
        """
        return pulumi.get(self, "full_snapshot_query")
    ...
    @_builtins.property
    @pulumi.getter(name="refreshIntervalDuration")
    def refresh_interval_duration(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The frequency in `hh:mm:ss` with which the reference data should be retrieved from the MS SQL database e.g. `00:20:00` for every 20 minutes. Must be set when `refresh_type` is `RefreshPeriodicallyWithFull` or `RefreshPeriodicallyWithDelta`.
        """
        return pulumi.get(self, "refresh_interval_duration")
    ...
    @_builtins.property
    @pulumi.getter(name="refreshType")
    def refresh_type(self) -> pulumi.Output[_builtins.str]:
        """
        Defines whether and how the reference data should be refreshed. Accepted values are `Static`, `RefreshPeriodicallyWithFull` and `RefreshPeriodicallyWithDelta`.
        """
        return pulumi.get(self, "refresh_type")
