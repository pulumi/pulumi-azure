...
class OutputFunctionArgs:
    def __init__(__self__, *,
                 ...
                 function_app: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Stream Analytics Output should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Stream Analytics Output. Changing this forces a new resource to be created.
        """
    ...
    def function_app(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @function_app.setter
    def function_app(self, value: pulumi.Input[_builtins.str]):
...
class OutputFunction(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="batchMaxCount")
    def batch_max_count(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The maximum number of events in each batch that's sent to the function. Defaults to `100`.
        """
        return pulumi.get(self, "batch_max_count")
    ...
    @_builtins.property
    @pulumi.getter(name="batchMaxInBytes")
    def batch_max_in_bytes(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The maximum batch size in bytes that's sent to the function. Defaults to `262144` (256 kB).
        """
        return pulumi.get(self, "batch_max_in_bytes")
    ...
    @_builtins.property
    @pulumi.getter(name="functionApp")
    def function_app(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Function App.
        """
        return pulumi.get(self, "function_app")
