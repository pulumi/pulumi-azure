...
class DatasetKustoDatabaseArgs:
    def __init__(__self__, *,
                 kusto_database_id: pulumi.Input[builtins.str],
                 share_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DatasetKustoDatabase resource.
        :param pulumi.Input[builtins.str] kusto_database_id: The resource ID of the Kusto Cluster Database to be shared with the receiver. Changing this forces a new Data Share Kusto Database Dataset to be created.
        :param pulumi.Input[builtins.str] share_id: The resource ID of the Data Share where this Data Share Kusto Database Dataset should be created. Changing this forces a new Data Share Kusto Database Dataset to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Data Share Kusto Database Dataset. Changing this forces a new Data Share Kusto Database Dataset to be created.
        """
    ...
    def kusto_database_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def kusto_database_id(self, value: pulumi.Input[builtins.str]):
...
class _DatasetKustoDatabaseState:
    def __init__(__self__, *,
                 ...
                 kusto_cluster_location: Optional[pulumi.Input[builtins.str]] = None,
                 kusto_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The name of the Data Share Dataset.
        :param pulumi.Input[builtins.str] kusto_cluster_location: The location of the Kusto Cluster.
        :param pulumi.Input[builtins.str] kusto_database_id: The resource ID of the Kusto Cluster Database to be shared with the receiver. Changing this forces a new Data Share Kusto Database Dataset to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Data Share Kusto Database Dataset. Changing this forces a new Data Share Kusto Database Dataset to be created.
        :param pulumi.Input[builtins.str] share_id: The resource ID of the Data Share where this Data Share Kusto Database Dataset should be created. Changing this forces a new Data Share Kusto Database Dataset to be created.
        """
    ...
    def kusto_cluster_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kusto_cluster_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kusto_cluster_location", value)

    @property
    @pulumi.getter(name="kustoDatabaseId")
    def kusto_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource ID of the Kusto Cluster Database to be shared with the receiver. Changing this forces a new Data Share Kusto Database Dataset to be created.
        """
        return pulumi.get(self, "kusto_database_id")
    ...
    @kusto_database_id.setter
    def kusto_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kusto_database_id", value)
...
class DatasetKustoDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            kusto_database_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            share_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DatasetKustoDatabase':
        """
    ...
    @property
    @pulumi.getter(name="kustoClusterLocation")
    def kusto_cluster_location(self) -> pulumi.Output[builtins.str]:
        """
        The location of the Kusto Cluster.
        """
        return pulumi.get(self, "kusto_cluster_location")
    ...
    @property
    @pulumi.getter(name="kustoDatabaseId")
    def kusto_database_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the Kusto Cluster Database to be shared with the receiver. Changing this forces a new Data Share Kusto Database Dataset to be created.
        """
        return pulumi.get(self, "kusto_database_id")
