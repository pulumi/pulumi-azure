...
class DatasetBlobStorageStorageAccountArgs:
    def __init__(__self__, *,
                 ...
                 subscription_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the storage account to be shared with the receiver. Changing this forces a new Data Share Blob Storage Dataset to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The resource group name of the storage account to be shared with the receiver. Changing this forces a new Data Share Blob Storage Dataset to be created.
        :param pulumi.Input[builtins.str] subscription_id: The subscription id of the storage account to be shared with the receiver. Changing this forces a new Data Share Blob Storage Dataset to be created.
        """
...
class ShareSnapshotScheduleArgs:
    def __init__(__self__, *,
                 ...
                 start_time: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the snapshot schedule.
        :param pulumi.Input[builtins.str] recurrence: The interval of the synchronization with the source data. Possible values are `Hour` and `Day`.
        :param pulumi.Input[builtins.str] start_time: The synchronization with the source data's start time.
        """
        pulumi.set(__self__, "name", name)
