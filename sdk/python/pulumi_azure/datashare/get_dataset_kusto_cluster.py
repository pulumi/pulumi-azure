...
def get_dataset_kusto_cluster(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.DataShare`: 2019-11-01
    ...
    :param builtins.str name: The name of this Data Share Kusto Cluster Dataset.
    :param builtins.str share_id: The resource ID of the Data Share where this Data Share Kusto Cluster Dataset should be created.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_dataset_kusto_cluster_output(name: Optional[pulumi.Input[builtins.str]] = None,
