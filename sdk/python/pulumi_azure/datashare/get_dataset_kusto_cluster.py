...
class GetDatasetKustoClusterResult:
    ...
    def kusto_cluster_id(self) -> _builtins.str:
        """
...
def get_dataset_kusto_cluster(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.DataShare` - 2019-11-01
    ...
    :param _builtins.str share_id: The resource ID of the Data Share where this Data Share Kusto Cluster Dataset should be created.
    """
    __args__ = dict()
    __args__['name'] = name
