...
class GetDatasetKustoDatabaseResult:
    ...
    def kusto_cluster_location(self) -> _builtins.str:
        """
    ...
    def kusto_database_id(self) -> _builtins.str:
        """
...
def get_dataset_kusto_database(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.DataShare` - 2019-11-01
    ...
    :param _builtins.str name: The name of this Data Share Kusto Database Dataset.
    :param _builtins.str share_id: The resource ID of the Data Share where this Data Share Kusto Database Dataset should be created.
    """
    __args__ = dict()
    __args__['name'] = name
