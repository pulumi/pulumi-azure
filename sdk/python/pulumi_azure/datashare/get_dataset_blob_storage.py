...
class GetDatasetBlobStorageResult:
    ...
    def data_share_id(self) -> _builtins.str:
...
def get_dataset_blob_storage(data_share_id: Optional[_builtins.str] = None,
...
def get_dataset_blob_storage_output(data_share_id: Optional[pulumi.Input[_builtins.str]] = None,
