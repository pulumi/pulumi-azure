...
class DatasetKustoClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kusto_cluster_id: The resource ID of the Kusto Cluster to be shared with the receiver. Changing this forces a new Data Share Kusto Cluster Dataset to be created.
        :param pulumi.Input[_builtins.str] share_id: The resource ID of the Data Share where this Data Share Kusto Cluster Dataset should be created. Changing this forces a new Data Share Kusto Cluster Dataset to be created.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Data Share Kusto Cluster Dataset. Changing this forces a new Data Share Kusto Cluster Dataset to be created.
        """
    ...
    def kusto_cluster_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def kusto_cluster_id(self, value: pulumi.Input[_builtins.str]):
...
class DatasetKustoCluster(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="kustoClusterId")
    def kusto_cluster_id(self) -> pulumi.Output[_builtins.str]:
        """
        The resource ID of the Kusto Cluster to be shared with the receiver. Changing this forces a new Data Share Kusto Cluster Dataset to be created.
        """
        return pulumi.get(self, "kusto_cluster_id")
