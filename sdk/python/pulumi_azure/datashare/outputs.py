...
class AccountIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Data Share Account. The only possible value is `SystemAssigned`. Changing this forces a new resource to be created.
        ...
        :param builtins.str principal_id: The Principal ID for the Service Principal associated with the Identity of this Data Share Account.
        :param builtins.str tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Data Share Account.
        """
...
class DatasetBlobStorageStorageAccount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the storage account to be shared with the receiver. Changing this forces a new Data Share Blob Storage Dataset to be created.
        :param builtins.str resource_group_name: The resource group name of the storage account to be shared with the receiver. Changing this forces a new Data Share Blob Storage Dataset to be created.
        :param builtins.str subscription_id: The subscription id of the storage account to be shared with the receiver. Changing this forces a new Data Share Blob Storage Dataset to be created.
        """
...
class ShareSnapshotSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the snapshot schedule.
        :param builtins.str recurrence: The interval of the synchronization with the source data. Possible values are `Hour` and `Day`.
        :param builtins.str start_time: The synchronization with the source data's start time.
        """
        pulumi.set(__self__, "name", name)
...
class GetDatasetBlobStorageStorageAccountResult(dict):
    def __init__(__self__, *,
                 ...
                 subscription_id: builtins.str):
        """
        :param builtins.str name: The name of this Data Share Blob Storage Dataset.
        :param builtins.str resource_group_name: The resource group name of the storage account to be shared with the receiver.
        :param builtins.str subscription_id: The subscription id of the storage account to be shared with the receiver.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "resource_group_name", resource_group_name)
        pulumi.set(__self__, "subscription_id", subscription_id)
...
class GetShareSnapshotScheduleResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str recurrence: The interval of the synchronization with the source data.
        :param builtins.str start_time: The synchronization with the source data's start time.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "recurrence", recurrence)
