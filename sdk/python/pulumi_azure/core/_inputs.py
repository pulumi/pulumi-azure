...
class CustomProviderActionArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] endpoint: Specifies the endpoint of the action.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the action.
        """
...
class CustomProviderResourceTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] routing_type: The routing type that is supported for the resource request. Valid values are `Proxy` and `Proxy,Cache`. Defaults to `Proxy`.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "name", name)
...
class CustomProviderValidationArgs:
    def __init__(__self__, *,
                 specification: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] specification: The endpoint where the validation specification is located.
        """
...
class ResourceDeploymentScriptAzureCliIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: Specifies the list of user-assigned managed identity IDs associated with the resource. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] type: Type of the managed identity. The only possible value is `UserAssigned`. Changing this forces a new resource to be created.
        """
...
class ResourceDeploymentScriptAzureCliStorageAccountArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] key: Specifies the storage account access key.
        :param pulumi.Input[_builtins.str] name: Specifies the storage account name.
        """
...
class ResourceGroupCostManagementExportExportDataOptionsArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] time_frame: The time frame for pulling data for the query. If custom, then a specific time period must be provided. Possible values include: `WeekToDate`, `MonthToDate`, `BillingMonthToDate`, `TheLast7Days`, `TheLastMonth`, `TheLastBillingMonth`, `Custom`.
        :param pulumi.Input[_builtins.str] type: The type of the query. Possible values are `ActualCost`, `AmortizedCost` and `Usage`.
        """
    ...
    def time_frame(self) -> pulumi.Input[_builtins.str]:
        """
        The time frame for pulling data for the query. If custom, then a specific time period must be provided. Possible values include: `WeekToDate`, `MonthToDate`, `BillingMonthToDate`, `TheLast7Days`, `TheLastMonth`, `TheLastBillingMonth`, `Custom`.
        """
    ...
    @time_frame.setter
    def time_frame(self, value: pulumi.Input[_builtins.str]):
...
class ResourceGroupCostManagementExportExportDataStorageLocationArgs:
    def __init__(__self__, *,
                 ...
                 root_folder_path: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] container_id: The Resource Manager ID of the container where exports will be uploaded. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] root_folder_path: The path of the directory where exports will be uploaded. Changing this forces a new resource to be created.
    ...
    def root_folder_path(self) -> pulumi.Input[_builtins.str]:
        """
        The path of the directory where exports will be uploaded. Changing this forces a new resource to be created.
    ...
    def root_folder_path(self, value: pulumi.Input[_builtins.str]):
...
class ResourceGroupCostManagementViewDatasetAggregationArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Resource Group to be created.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Resource Group to be created.
        """
...
class ResourceGroupCostManagementViewDatasetGroupingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The type of the column. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewDatasetSortingArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] direction: Direction of sort. Possible values are `Ascending` and `Descending`.
...
class ResourceGroupCostManagementViewKpiArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] type: KPI type. Possible values are `Budget` and `Forecast`.
        """
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewPivotArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The name of the column which should be used for this sub-view in the Cost Analysis UI.
        :param pulumi.Input[_builtins.str] type: The data type to show in this sub-view. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceGroupPolicyAssignmentIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Managed Identity IDs which should be assigned to the Policy Definition.
               ...
               > **Note:** This is required when `type` is set to `UserAssigned`.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID of the Policy Assignment for this Resource Group.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID of the Policy Assignment for this Resource Group.
        """
        pulumi.set(__self__, "type", type)
...
class ResourcePolicyAssignmentIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Managed Identity IDs which should be assigned to the Policy Definition.
               ...
               > **Note:** This is required when `type` is set to `UserAssigned`.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID of the Policy Assignment for this Resource.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID of the Policy Assignment for this Resource.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ResourceProviderRegistrationFeatureArgsDict(TypedDict):
    ...
    """
    registered: pulumi.Input[_builtins.bool]
    """
...
class ResourceProviderRegistrationFeatureArgs:
    def __init__(__self__, *,
                 ...
                 registered: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.str] name: Specifies the name of the feature to register.
               
               > **Note:** Only Preview Features which have an `ApprovalType` of `AutoApproval` can be managed in Terraform, features which require manual approval by Service Teams are unsupported. [More information on Resource Provider Preview Features can be found in this document](https://docs.microsoft.com/rest/api/resources/features)
        :param pulumi.Input[_builtins.bool] registered: Should this feature be Registered or Unregistered?
        """
        pulumi.set(__self__, "name", name)
    ...
    @_builtins.property
    @pulumi.getter
    def registered(self) -> pulumi.Input[_builtins.bool]:
        """
        Should this feature be Registered or Unregistered?
        """
    ...
    @registered.setter
    def registered(self, value: pulumi.Input[_builtins.bool]):
...
class SubscriptionCostManagementViewDatasetAggregationArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Subscription to be created.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Subscription to be created.
        """
        pulumi.set(__self__, "column_name", column_name)
        pulumi.set(__self__, "name", name)
...
class SubscriptionPolicyAssignmentIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Managed Identity IDs which should be assigned to the Policy Definition.
               ...
               > **Note:** This is required when `type` is set to `UserAssigned`.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID of the Policy Assignment for this Subscription.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID of the Policy Assignment for this Subscription.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
