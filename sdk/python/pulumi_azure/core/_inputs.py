...
class CustomProviderActionArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] endpoint: Specifies the endpoint of the action.
        :param pulumi.Input[builtins.str] name: Specifies the name of the action.
        """
...
if not MYPY:
    class CustomProviderResourceTypeArgsDict(TypedDict):
        ...
        """
        routing_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CustomProviderResourceTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] endpoint: Specifies the endpoint of the route definition.
        :param pulumi.Input[builtins.str] name: Specifies the name of the route definition.
        :param pulumi.Input[builtins.str] routing_type: The routing type that is supported for the resource request. Valid values are `Proxy` and `Proxy,Cache`. Defaults to `Proxy`.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "name", name)
...
class CustomProviderValidationArgs:
    def __init__(__self__, *,
                 specification: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] specification: The endpoint where the validation specification is located.
        """
...
class ResourceDeploymentScriptAzureCliContainerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] container_group_name: Container group name, if not specified then the name will get auto-generated. For more information, please refer to the [Container Configuration](https://learn.microsoft.com/en-us/rest/api/resources/deployment-scripts/create?tabs=HTTP#containerconfiguration) documentation.
        """
...
class ResourceDeploymentScriptAzureCliEnvironmentVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secure_value: Specifies the value of the secure environment variable.
...
class ResourceDeploymentScriptAzureCliIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies the list of user-assigned managed identity IDs associated with the resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] type: Type of the managed identity. The only possible value is `UserAssigned`. Changing this forces a new resource to be created.
        """
...
class ResourceDeploymentScriptAzureCliStorageAccountArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Specifies the storage account access key.
        :param pulumi.Input[builtins.str] name: Specifies the storage account name.
        """
...
if not MYPY:
    class ResourceGroupCostManagementExportExportDataOptionsArgsDict(TypedDict):
        time_frame: pulumi.Input[builtins.str]
        """
...
class ResourceGroupCostManagementExportExportDataOptionsArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] time_frame: The time frame for pulling data for the query. If custom, then a specific time period must be provided. Possible values include: `WeekToDate`, `MonthToDate`, `BillingMonthToDate`, `TheLast7Days`, `TheLastMonth`, `TheLastBillingMonth`, `Custom`.
        :param pulumi.Input[builtins.str] type: The type of the query. Possible values are `ActualCost`, `AmortizedCost` and `Usage`.
        """
    ...
    def time_frame(self) -> pulumi.Input[builtins.str]:
        """
        The time frame for pulling data for the query. If custom, then a specific time period must be provided. Possible values include: `WeekToDate`, `MonthToDate`, `BillingMonthToDate`, `TheLast7Days`, `TheLastMonth`, `TheLastBillingMonth`, `Custom`.
        """
    ...
    @time_frame.setter
    def time_frame(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ResourceGroupCostManagementExportExportDataStorageLocationArgsDict(TypedDict):
        ...
        """
        root_folder_path: pulumi.Input[builtins.str]
        """
...
class ResourceGroupCostManagementExportExportDataStorageLocationArgs:
    def __init__(__self__, *,
                 ...
                 root_folder_path: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] container_id: The Resource Manager ID of the container where exports will be uploaded. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] root_folder_path: The path of the directory where exports will be uploaded. Changing this forces a new resource to be created.
    ...
    def root_folder_path(self) -> pulumi.Input[builtins.str]:
        """
        The path of the directory where exports will be uploaded. Changing this forces a new resource to be created.
    ...
    def root_folder_path(self, value: pulumi.Input[builtins.str]):
...
class ResourceGroupCostManagementViewDatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] granularity: The granularity of rows in the report. Possible values are `Daily` and `Monthly`.
...
class ResourceGroupCostManagementViewDatasetAggregationArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Resource Group to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Resource Group to be created.
        """
...
class ResourceGroupCostManagementViewDatasetGroupingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of the column. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewDatasetSortingArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] direction: Direction of sort. Possible values are `Ascending` and `Descending`.
...
class ResourceGroupCostManagementViewKpiArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: KPI type. Possible values are `Budget` and `Forecast`.
        """
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewPivotArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the column which should be used for this sub-view in the Cost Analysis UI.
        :param pulumi.Input[builtins.str] type: The data type to show in this sub-view. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceGroupPolicyAssignmentIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Managed Identity IDs which should be assigned to the Policy Definition.
               ...
               > **Note:** This is required when `type` is set to `UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID of the Policy Assignment for this Resource Group.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID of the Policy Assignment for this Resource Group.
        """
        pulumi.set(__self__, "type", type)
...
class ResourcePolicyAssignmentIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Managed Identity IDs which should be assigned to the Policy Definition.
               ...
               > **Note:** This is required when `type` is set to `UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID of the Policy Assignment for this Resource.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID of the Policy Assignment for this Resource.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
if not MYPY:
    class ResourceProviderRegistrationFeatureArgsDict(TypedDict):
        name: pulumi.Input[builtins.str]
        registered: pulumi.Input[builtins.bool]
        """
...
class ResourceProviderRegistrationFeatureArgs:
    def __init__(__self__, *,
                 ...
                 registered: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] registered: Should this feature be Registered or Unregistered?
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def registered(self) -> pulumi.Input[builtins.bool]:
        """
        Should this feature be Registered or Unregistered?
        """
    ...
    @registered.setter
    def registered(self, value: pulumi.Input[builtins.bool]):
...
class SubscriptionCostManagementViewDatasetAggregationArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Subscription to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Subscription to be created.
        """
        pulumi.set(__self__, "column_name", column_name)
        pulumi.set(__self__, "name", name)
...
class SubscriptionPolicyAssignmentIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The Type of Managed Identity which should be added to this Policy Definition. Possible values are `SystemAssigned` or `UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Managed Identity IDs which should be assigned to the Policy Definition.
               
               > **Note:** This is required when `type` is set to `UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID of the Policy Assignment for this Subscription.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID of the Policy Assignment for this Subscription.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
