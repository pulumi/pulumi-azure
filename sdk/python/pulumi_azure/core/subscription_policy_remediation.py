...
class SubscriptionPolicyRemediationArgs:
    def __init__(__self__, *,
                 ...
                 failure_percentage: Optional[pulumi.Input[builtins.float]] = None,
                 location_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 resource_discovery_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SubscriptionPolicyRemediation resource.
        :param pulumi.Input[builtins.str] policy_assignment_id: The ID of the Policy Assignment that should be remediated.
        :param pulumi.Input[builtins.str] subscription_id: The Subscription ID at which the Policy Remediation should be applied. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.float] failure_percentage: A number between 0.0 to 1.0 representing the percentage failure threshold. The remediation will fail if the percentage of failed remediation operations (i.e. failed deployments) exceeds this threshold.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] location_filters: A list of the resource locations that will be remediated.
        :param pulumi.Input[builtins.str] name: The name of the Policy Remediation. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] policy_definition_reference_id: The unique ID for the policy definition reference within the policy set definition that should be remediated. Required when the policy assignment being remediated assigns a policy set definition.
        ...
        :param pulumi.Input[builtins.str] resource_discovery_mode: The way that resources to remediate are discovered. Possible values are `ExistingNonCompliant`, `ReEvaluateCompliance`. Defaults to `ExistingNonCompliant`.
        """
    ...
    def failure_percentage(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def failure_percentage(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "failure_percentage", value)

    @property
    @pulumi.getter(name="locationFilters")
    def location_filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def location_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def resource_discovery_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_discovery_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SubscriptionPolicyRemediation(pulumi.CustomResource):
    ...
    pulumi_type = "azure:core/subscriptionPolicyRemediation:SubscriptionPolicyRemediation"
    ...
    def get(resource_name: str,
            ...
            resource_count: Optional[pulumi.Input[builtins.int]] = None,
            resource_discovery_mode: Optional[pulumi.Input[builtins.str]] = None,
            subscription_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SubscriptionPolicyRemediation':
        """
    ...
    @property
    @pulumi.getter(name="failurePercentage")
    def failure_percentage(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        A number between 0.0 to 1.0 representing the percentage failure threshold. The remediation will fail if the percentage of failed remediation operations (i.e. failed deployments) exceeds this threshold.
        """
        return pulumi.get(self, "failure_percentage")
    ...
    @property
    @pulumi.getter(name="locationFilters")
    def location_filters(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of the resource locations that will be remediated.
        """
        return pulumi.get(self, "location_filters")
