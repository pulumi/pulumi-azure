...
class ResourcePolicyRemediationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_id: The Resource ID at which the Policy Remediation should be applied. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:core/resourcePolicyRemediation:ResourcePolicyRemediation")
class ResourcePolicyRemediation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_count: Optional[pulumi.Input[_builtins.int]] = None,
            resource_discovery_mode: Optional[pulumi.Input[_builtins.str]] = None,
            resource_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'ResourcePolicyRemediation':
        """
