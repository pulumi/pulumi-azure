...
def get_location(location: Optional[builtins.str] = None,
    ...
    :param builtins.str location: Specifies the supported Azure location where the resource exists.
    """
    __args__ = dict()
...
def get_location_output(location: Optional[pulumi.Input[builtins.str]] = None,
