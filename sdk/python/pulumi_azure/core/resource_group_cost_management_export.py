...
class ResourceGroupCostManagementExportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_group_id: The id of the resource group on which to create an export. Changing this forces a new resource to be created.
...
class _ResourceGroupCostManagementExportState:
    def __init__(__self__, *,
                 active: pulumi.Input[Optional[_builtins.bool]] = None,
                 export_data_options: pulumi.Input[Optional['ResourceGroupCostManagementExportExportDataOptionsArgs']] = None,
                 export_data_storage_location: pulumi.Input[Optional['ResourceGroupCostManagementExportExportDataStorageLocationArgs']] = None,
                 file_format: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="exportDataOptions")
    def export_data_options(self) -> pulumi.Input[Optional['ResourceGroupCostManagementExportExportDataOptionsArgs']]:
        """
        A `export_data_options` block as defined below.
        """
        return pulumi.get(self, "export_data_options")
    ...
    @export_data_options.setter
    def export_data_options(self, value: pulumi.Input[Optional['ResourceGroupCostManagementExportExportDataOptionsArgs']]):
        pulumi.set(self, "export_data_options", value)

    @_builtins.property
    @pulumi.getter(name="exportDataStorageLocation")
    def export_data_storage_location(self) -> pulumi.Input[Optional['ResourceGroupCostManagementExportExportDataStorageLocationArgs']]:
        """
        A `export_data_storage_location` block as defined below.
        """
        return pulumi.get(self, "export_data_storage_location")
    ...
    @export_data_storage_location.setter
    def export_data_storage_location(self, value: pulumi.Input[Optional['ResourceGroupCostManagementExportExportDataStorageLocationArgs']]):
        pulumi.set(self, "export_data_storage_location", value)
...
@pulumi.type_token("azure:core/resourceGroupCostManagementExport:ResourceGroupCostManagementExport")
class ResourceGroupCostManagementExport(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 active: pulumi.Input[Optional[_builtins.bool]] = None,
                 export_data_options: pulumi.Input[Optional[Union['ResourceGroupCostManagementExportExportDataOptionsArgs', 'ResourceGroupCostManagementExportExportDataOptionsArgsDict', 'outputs.ResourceGroupCostManagementExportExportDataOptions']]] = None,
                 export_data_storage_location: pulumi.Input[Optional[Union['ResourceGroupCostManagementExportExportDataStorageLocationArgs', 'ResourceGroupCostManagementExportExportDataStorageLocationArgsDict', 'outputs.ResourceGroupCostManagementExportExportDataStorageLocation']]] = None,
                 file_format: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 recurrence_period_end_date: pulumi.Input[Optional[_builtins.str]] = None,
                 recurrence_period_start_date: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `Microsoft.CostManagement` - 2023-08-01
        ...
        :param pulumi.Input[_builtins.bool] active: Is the cost management export active? Default is `true`.
        :param pulumi.Input[Union['ResourceGroupCostManagementExportExportDataOptionsArgs', 'ResourceGroupCostManagementExportExportDataOptionsArgsDict', 'outputs.ResourceGroupCostManagementExportExportDataOptions']] export_data_options: A `export_data_options` block as defined below.
        :param pulumi.Input[Union['ResourceGroupCostManagementExportExportDataStorageLocationArgs', 'ResourceGroupCostManagementExportExportDataStorageLocationArgsDict', 'outputs.ResourceGroupCostManagementExportExportDataStorageLocation']] export_data_storage_location: A `export_data_storage_location` block as defined below.
        :param pulumi.Input[_builtins.str] file_format: Format for export. Valid values are `Csv` only. Default is `Csv`.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Cost Management Export. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] recurrence_period_end_date: The date the export will stop capturing information.
        :param pulumi.Input[_builtins.str] recurrence_period_start_date: The date the export will start capturing information.
    ...
    def get(resource_name: str,
            ...
            recurrence_period_start_date: pulumi.Input[Optional[_builtins.str]] = None,
            recurrence_type: pulumi.Input[Optional[_builtins.str]] = None,
            resource_group_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ResourceGroupCostManagementExport':
        """
