...
class ResourceGroupCostManagementExportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_id: The id of the resource group on which to create an export. Changing this forces a new resource to be created.
...
class ResourceGroupCostManagementExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            recurrence_period_start_date: Optional[pulumi.Input[builtins.str]] = None,
            recurrence_type: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceGroupCostManagementExport':
        """
