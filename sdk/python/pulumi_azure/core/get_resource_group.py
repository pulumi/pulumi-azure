...
def get_resource_group(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The Name of this Resource Group.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_resource_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
