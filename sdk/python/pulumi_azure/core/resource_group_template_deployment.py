...
class ResourceGroupTemplateDeploymentArgs:
    def __init__(__self__, *,
                 deployment_mode: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] deployment_mode: The Deployment Mode for this Resource Group Template Deployment. Possible values are `Complete` (where resources in the Resource Group not specified in the ARM Template will be destroyed) and `Incremental` (where resources are additive only).
    ...
    def deployment_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def deployment_mode(self, value: pulumi.Input[builtins.str]):
...
class ResourceGroupTemplateDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            template_content: Optional[pulumi.Input[builtins.str]] = None,
            template_spec_version_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceGroupTemplateDeployment':
        """
