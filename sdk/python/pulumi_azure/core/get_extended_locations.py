...
class GetExtendedLocationsResult:
    ...
    def extended_locations(self) -> Sequence[_builtins.str]:
        """
...
def get_extended_locations(location: Optional[_builtins.str] = None,
    ...
    :param _builtins.str location: The Azure location to retrieve the Extended Locations for.
    """
    __args__ = dict()
