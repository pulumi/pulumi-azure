...
class CustomProviderAction(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str endpoint: Specifies the endpoint of the action.
        :param builtins.str name: Specifies the name of the action.
        """
...
class CustomProviderResourceType(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str endpoint: Specifies the endpoint of the route definition.
        :param builtins.str name: Specifies the name of the route definition.
        :param builtins.str routing_type: The routing type that is supported for the resource request. Valid values are `Proxy` and `Proxy,Cache`. Defaults to `Proxy`.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "name", name)
...
class CustomProviderValidation(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str specification: The endpoint where the validation specification is located.
        """
...
class ResourceDeploymentScriptAzureCliContainer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str container_group_name: Container group name, if not specified then the name will get auto-generated. For more information, please refer to the [Container Configuration](https://learn.microsoft.com/en-us/rest/api/resources/deployment-scripts/create?tabs=HTTP#containerconfiguration) documentation.
        """
...
class ResourceDeploymentScriptAzureCliEnvironmentVariable(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies the name of the environment variable.
        :param builtins.str secure_value: Specifies the value of the secure environment variable.
        :param builtins.str value: Specifies the value of the environment variable.
        """
        pulumi.set(__self__, "name", name)
...
class ResourceDeploymentScriptAzureCliIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: Specifies the list of user-assigned managed identity IDs associated with the resource. Changing this forces a new resource to be created.
        :param builtins.str type: Type of the managed identity. The only possible value is `UserAssigned`. Changing this forces a new resource to be created.
        """
...
class ResourceDeploymentScriptAzureCliStorageAccount(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str key: Specifies the storage account access key.
        :param builtins.str name: Specifies the storage account name.
        """
...
class ResourceGroupCostManagementExportExportDataOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str time_frame: The time frame for pulling data for the query. If custom, then a specific time period must be provided. Possible values include: `WeekToDate`, `MonthToDate`, `BillingMonthToDate`, `TheLast7Days`, `TheLastMonth`, `TheLastBillingMonth`, `Custom`.
        :param builtins.str type: The type of the query. Possible values are `ActualCost`, `AmortizedCost` and `Usage`.
        """
...
class ResourceGroupCostManagementExportExportDataStorageLocation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str container_id: The Resource Manager ID of the container where exports will be uploaded. Changing this forces a new resource to be created.
        :param builtins.str root_folder_path: The path of the directory where exports will be uploaded. Changing this forces a new resource to be created.
...
class ResourceGroupCostManagementViewDataset(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str granularity: The granularity of rows in the report. Possible values are `Daily` and `Monthly`.
...
class ResourceGroupCostManagementViewDatasetAggregation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Resource Group to be created.
        :param builtins.str name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Resource Group to be created.
        """
...
class ResourceGroupCostManagementViewDatasetGrouping(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: The type of the column. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewDatasetSorting(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str direction: Direction of sort. Possible values are `Ascending` and `Descending`.
...
class ResourceGroupCostManagementViewKpi(dict):
    def __init__(__self__, *,
                 type: builtins.str):
        """
        :param builtins.str type: KPI type. Possible values are `Budget` and `Forecast`.
        """
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewPivot(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str name: The name of the column which should be used for this sub-view in the Cost Analysis UI.
        :param builtins.str type: The data type to show in this sub-view. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceProviderRegistrationFeature(dict):
    def __init__(__self__, *,
                 name: builtins.str,
                 registered: builtins.bool):
        """
        :param builtins.bool registered: Should this feature be Registered or Unregistered?
        """
        pulumi.set(__self__, "name", name)
...
class SubscriptionCostManagementViewDatasetAggregation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Subscription to be created.
        :param builtins.str name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Subscription to be created.
        """
        pulumi.set(__self__, "column_name", column_name)
        pulumi.set(__self__, "name", name)
...
class GetLocationZoneMappingResult(dict):
    def __init__(__self__, *,
                 logical_zone: builtins.str,
                 physical_zone: builtins.str):
        """
        :param builtins.str logical_zone: The logical zone id for the availability zone
        :param builtins.str physical_zone: The fully qualified physical zone id of availability zone to which logical zone id is mapped to
        """
...
class GetResourcesResourceResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str location: The Azure Region in which this Resource exists.
        ...
        :param Mapping[str, builtins.str] tags: A map of tags assigned to this Resource.
...
class GetSubscriptionsSubscriptionResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 location_placement_id: builtins.str,
        ...
        """
        :param builtins.str display_name: The subscription display name.
        :param builtins.str id: The ID of this subscription.
        :param builtins.str location_placement_id: The subscription location placement ID.
        :param builtins.str quota_id: The subscription quota ID.
        :param builtins.str spending_limit: The subscription spending limit.
        :param builtins.str state: The subscription state. Possible values are Enabled, Warned, PastDue, Disabled, and Deleted.
        :param builtins.str subscription_id: The subscription GUID.
        :param Mapping[str, builtins.str] tags: A mapping of tags assigned to the resource.
        :param builtins.str tenant_id: The subscription tenant ID.
        """
