...
class CustomProviderAction(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str endpoint: Specifies the endpoint of the action.
        :param _builtins.str name: Specifies the name of the action.
        """
...
class CustomProviderResourceType(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str endpoint: Specifies the endpoint of the route definition.
        :param _builtins.str name: Specifies the name of the route definition.
        :param _builtins.str routing_type: The routing type that is supported for the resource request. Valid values are `Proxy` and `Proxy,Cache`. Defaults to `Proxy`.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "name", name)
...
class CustomProviderValidation(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str specification: The endpoint where the validation specification is located.
        """
...
class ResourceDeploymentScriptAzureCliContainer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str container_group_name: Container group name, if not specified then the name will get auto-generated. For more information, please refer to the [Container Configuration](https://learn.microsoft.com/en-us/rest/api/resources/deployment-scripts/create?tabs=HTTP#containerconfiguration) documentation.
        """
...
class ResourceDeploymentScriptAzureCliEnvironmentVariable(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str secure_value: Specifies the value of the secure environment variable.
...
class ResourceDeploymentScriptAzureCliIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param Sequence[_builtins.str] identity_ids: Specifies the list of user-assigned managed identity IDs associated with the resource. Changing this forces a new resource to be created.
        :param _builtins.str type: Type of the managed identity. The only possible value is `UserAssigned`. Changing this forces a new resource to be created.
        """
...
class ResourceDeploymentScriptAzureCliStorageAccount(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str key: Specifies the storage account access key.
        :param _builtins.str name: Specifies the storage account name.
        """
...
class ResourceGroupCostManagementExportExportDataOptions(dict):
    ...
    def __init__(__self__, *,
                 time_frame: _builtins.str,
                 type: _builtins.str):
        """
        :param _builtins.str time_frame: The time frame for pulling data for the query. If custom, then a specific time period must be provided. Possible values include: `WeekToDate`, `MonthToDate`, `BillingMonthToDate`, `TheLast7Days`, `TheLastMonth`, `TheLastBillingMonth`, `Custom`.
        :param _builtins.str type: The type of the query. Possible values are `ActualCost`, `AmortizedCost` and `Usage`.
        """
    ...
    def time_frame(self) -> _builtins.str:
        """
...
class ResourceGroupCostManagementExportExportDataStorageLocation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 root_folder_path: _builtins.str):
        """
        :param _builtins.str container_id: The Resource Manager ID of the container where exports will be uploaded. Changing this forces a new resource to be created.
        :param _builtins.str root_folder_path: The path of the directory where exports will be uploaded. Changing this forces a new resource to be created.
    ...
    def root_folder_path(self) -> _builtins.str:
        """
...
class ResourceGroupCostManagementViewDataset(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str granularity: The granularity of rows in the report. Possible values are `Daily` and `Monthly`.
...
class ResourceGroupCostManagementViewDatasetAggregation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Resource Group to be created.
        :param _builtins.str name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Resource Group to be created.
        """
...
class ResourceGroupCostManagementViewDatasetGrouping(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The type of the column. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewDatasetSorting(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str direction: Direction of sort. Possible values are `Ascending` and `Descending`.
...
class ResourceGroupCostManagementViewKpi(dict):
    def __init__(__self__, *,
                 type: _builtins.str):
        """
        :param _builtins.str type: KPI type. Possible values are `Budget` and `Forecast`.
        """
        pulumi.set(__self__, "type", type)
...
class ResourceGroupCostManagementViewPivot(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.str name: The name of the column which should be used for this sub-view in the Cost Analysis UI.
        :param _builtins.str type: The data type to show in this sub-view. Possible values are `Dimension` and `TagKey`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class ResourceGroupPolicyAssignmentIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str principal_id: The Principal ID of the Policy Assignment for this Resource Group.
        :param _builtins.str tenant_id: The Tenant ID of the Policy Assignment for this Resource Group.
        """
        pulumi.set(__self__, "type", type)
...
class SubscriptionCostManagementViewDatasetAggregation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str column_name: The name of the column to aggregate. Changing this forces a new Cost Management View for a Subscription to be created.
        :param _builtins.str name: The name which should be used for this aggregation. Changing this forces a new Cost Management View for a Subscription to be created.
        """
        pulumi.set(__self__, "column_name", column_name)
        pulumi.set(__self__, "name", name)
...
class SubscriptionPolicyAssignmentIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str type: The Type of Managed Identity which should be added to this Policy Definition. Possible values are `SystemAssigned` or `UserAssigned`.
        :param Sequence[_builtins.str] identity_ids: A list of User Managed Identity IDs which should be assigned to the Policy Definition.
               
               > **Note:** This is required when `type` is set to `UserAssigned`.
        :param _builtins.str principal_id: The Principal ID of the Policy Assignment for this Subscription.
        :param _builtins.str tenant_id: The Tenant ID of the Policy Assignment for this Subscription.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class GetLocationZoneMappingResult(dict):
    def __init__(__self__, *,
                 logical_zone: _builtins.str,
                 physical_zone: _builtins.str):
        """
        :param _builtins.str logical_zone: The logical zone id for the availability zone
        :param _builtins.str physical_zone: The fully qualified physical zone id of availability zone to which logical zone id is mapped to
        """
    ...
    def logical_zone(self) -> _builtins.str:
        """
...
class GetResourcesResourceResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str location: The Azure Region in which this Resource exists.
        :param _builtins.str name: The name of the Resource.
        :param _builtins.str resource_group_name: The name of the Resource group where the Resources are located.
        :param Mapping[str, _builtins.str] tags: A map of tags assigned to this Resource.
...
class GetSubscriptionsSubscriptionResult(dict):
    def __init__(__self__, *,
                 ...
                 id: _builtins.str,
                 location_placement_id: _builtins.str,
        ...
        :param _builtins.str id: The ID of this subscription.
        ...
        :param _builtins.str subscription_id: The subscription GUID.
    ...
    def location_placement_id(self) -> _builtins.str:
        """
