...
def get_resource_group_template_deployment(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of this Resource Group Template Deployment.
    :param builtins.str resource_group_name: The name of the Resource Group to which the Resource Group Template Deployment was applied.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_resource_group_template_deployment_output(name: Optional[pulumi.Input[builtins.str]] = None,
