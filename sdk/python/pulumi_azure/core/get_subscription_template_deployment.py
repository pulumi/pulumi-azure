...
def get_subscription_template_deployment(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of this Subscription Template Deployment.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_subscription_template_deployment_output(name: Optional[pulumi.Input[builtins.str]] = None,
