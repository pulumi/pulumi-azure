...
class ResourcePolicyAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 identity: pulumi.Input[Optional['ResourcePolicyAssignmentIdentityArgs']] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 metadata: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 non_compliance_messages: pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentNonComplianceMessageArgs']]]] = None,
                 not_scopes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 overrides: pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentOverrideArgs']]]] = None,
                 parameters: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_selectors: pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentResourceSelectorArgs']]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Policy Assignment. Changing this forces a new Resource Policy Assignment to be created. Cannot exceed 64 characters in length.
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['ResourcePolicyAssignmentIdentityArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['ResourcePolicyAssignmentIdentityArgs']]):
    ...
    def non_compliance_messages(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentNonComplianceMessageArgs']]]]:
        """
    ...
    def non_compliance_messages(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentNonComplianceMessageArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def overrides(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentOverrideArgs']]]]:
        """
    ...
    @overrides.setter
    def overrides(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentOverrideArgs']]]]):
    ...
    def resource_selectors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentResourceSelectorArgs']]]]:
        """
    ...
    def resource_selectors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ResourcePolicyAssignmentResourceSelectorArgs']]]]):
...
@pulumi.type_token("azure:core/resourcePolicyAssignment:ResourcePolicyAssignment")
class ResourcePolicyAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 enforce: pulumi.Input[Optional[_builtins.bool]] = None,
                 identity: pulumi.Input[Optional[Union['ResourcePolicyAssignmentIdentityArgs', 'ResourcePolicyAssignmentIdentityArgsDict', 'outputs.ResourcePolicyAssignmentIdentity']]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 metadata: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 non_compliance_messages: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ResourcePolicyAssignmentNonComplianceMessageArgs', 'ResourcePolicyAssignmentNonComplianceMessageArgsDict', 'outputs.ResourcePolicyAssignmentNonComplianceMessage']]]]] = None,
                 not_scopes: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 overrides: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ResourcePolicyAssignmentOverrideArgs', 'ResourcePolicyAssignmentOverrideArgsDict', 'outputs.ResourcePolicyAssignmentOverride']]]]] = None,
                 parameters: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_definition_id: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_id: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_selectors: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ResourcePolicyAssignmentResourceSelectorArgs', 'ResourcePolicyAssignmentResourceSelectorArgsDict', 'outputs.ResourcePolicyAssignmentResourceSelector']]]]] = None,
                 __props__=None):
        """
        ...
        * `Microsoft.Authorization` - 2022-06-01
        ...
        :param pulumi.Input[_builtins.str] display_name: The Display Name for this Policy Assignment.
        :param pulumi.Input[_builtins.bool] enforce: Specifies if this Policy should be enforced or not? Defaults to `true`.
        :param pulumi.Input[Union['ResourcePolicyAssignmentIdentityArgs', 'ResourcePolicyAssignmentIdentityArgsDict', 'outputs.ResourcePolicyAssignmentIdentity']] identity: An `identity` block as defined below.
               
               > **Note:** The `location` field must also be specified when `identity` is specified.
        :param pulumi.Input[_builtins.str] location: The Azure Region where the Policy Assignment should exist. Changing this forces a new Policy Assignment to be created.
        :param pulumi.Input[_builtins.str] metadata: A JSON mapping of any Metadata for this Policy.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Policy Assignment. Changing this forces a new Resource Policy Assignment to be created. Cannot exceed 64 characters in length.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ResourcePolicyAssignmentNonComplianceMessageArgs', 'ResourcePolicyAssignmentNonComplianceMessageArgsDict', 'outputs.ResourcePolicyAssignmentNonComplianceMessage']]]] non_compliance_messages: One or more `non_compliance_message` blocks as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] not_scopes: Specifies a list of Resource Scopes (for example a Subscription, or a Resource Group) within this Management Group which are excluded from this Policy.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ResourcePolicyAssignmentOverrideArgs', 'ResourcePolicyAssignmentOverrideArgsDict', 'outputs.ResourcePolicyAssignmentOverride']]]] overrides: One or more `overrides` blocks as defined below. More detail about `overrides` and `resource_selectors` see [policy assignment structure](https://learn.microsoft.com/en-us/azure/governance/policy/concepts/assignment-structure)
        :param pulumi.Input[_builtins.str] parameters: A JSON mapping of any Parameters for this Policy.
        :param pulumi.Input[_builtins.str] policy_definition_id: The ID of the Policy Definition or Policy Definition Set. Changing this forces a new Policy Assignment to be created.
        :param pulumi.Input[_builtins.str] resource_id: The ID of the Resource (or Resource Scope) where this should be applied. Changing this forces a new Resource Policy Assignment to be created.
               
               > **Note:** To create a Policy Assignment at a Management Group use the `management.GroupPolicyAssignment` resource, for a Resource Group use the `core.ResourceGroupPolicyAssignment` and for a Subscription use the `core.SubscriptionPolicyAssignment` resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ResourcePolicyAssignmentResourceSelectorArgs', 'ResourcePolicyAssignmentResourceSelectorArgsDict', 'outputs.ResourcePolicyAssignmentResourceSelector']]]] resource_selectors: One or more `resource_selectors` blocks as defined below to filter polices by resource properties.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            policy_definition_id: pulumi.Input[Optional[_builtins.str]] = None,
            resource_id: pulumi.Input[Optional[_builtins.str]] = None,
            resource_selectors: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ResourcePolicyAssignmentResourceSelectorArgs', 'ResourcePolicyAssignmentResourceSelectorArgsDict', 'outputs.ResourcePolicyAssignmentResourceSelector']]]]] = None) -> 'ResourcePolicyAssignment':
        """
