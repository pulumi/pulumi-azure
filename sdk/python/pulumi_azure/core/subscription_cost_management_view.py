...
class SubscriptionCostManagementViewArgs:
    def __init__(__self__, *,
                 accumulated: pulumi.Input[builtins.bool],
                 chart_type: pulumi.Input[builtins.str],
                 dataset: pulumi.Input['SubscriptionCostManagementViewDatasetArgs'],
                 display_name: pulumi.Input[builtins.str],
                 report_type: pulumi.Input[builtins.str],
                 subscription_id: pulumi.Input[builtins.str],
                 timeframe: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.bool] accumulated: Whether the costs data in the Cost Management View are accumulated over time. Changing this forces a new Cost Management View for a Subscription to be created.
        :param pulumi.Input[builtins.str] chart_type: Chart type of the main view in Cost Analysis. Possible values are `Area`, `GroupedColumn`, `Line`, `StackedColumn` and `Table`.
        :param pulumi.Input['SubscriptionCostManagementViewDatasetArgs'] dataset: A `dataset` block as defined below.
        :param pulumi.Input[builtins.str] display_name: User visible input name of the Cost Management View.
        :param pulumi.Input[builtins.str] report_type: The type of the report. The only possible value is `Usage`.
        :param pulumi.Input[builtins.str] subscription_id: The ID of the Subscription this View is scoped to. Changing this forces a new Cost Management View for a Subscription to be created.
        :param pulumi.Input[builtins.str] timeframe: The time frame for pulling data for the report. Possible values are `Custom`, `MonthToDate`, `WeekToDate` and `YearToDate`.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Cost Management View for a Subscription. Changing this forces a new Cost Management View for a Subscription to be created.
    ...
    @property
    @pulumi.getter
    def accumulated(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @accumulated.setter
    def accumulated(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "accumulated", value)

    @property
    @pulumi.getter(name="chartType")
    def chart_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @chart_type.setter
    def chart_type(self, value: pulumi.Input[builtins.str]):
    ...
    def report_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @report_type.setter
    def report_type(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter
    def timeframe(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @timeframe.setter
    def timeframe(self, value: pulumi.Input[builtins.str]):
...
class _SubscriptionCostManagementViewState:
    def __init__(__self__, *,
                 accumulated: Optional[pulumi.Input[builtins.bool]] = None,
                 chart_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 timeframe: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter
    def accumulated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the costs data in the Cost Management View are accumulated over time. Changing this forces a new Cost Management View for a Subscription to be created.
        """
        return pulumi.get(self, "accumulated")
    ...
    @accumulated.setter
    def accumulated(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "accumulated", value)

    @property
    @pulumi.getter(name="chartType")
    def chart_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Chart type of the main view in Cost Analysis. Possible values are `Area`, `GroupedColumn`, `Line`, `StackedColumn` and `Table`.
        """
        return pulumi.get(self, "chart_type")
    ...
    @chart_type.setter
    def chart_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chart_type", value)
    ...
    @property
    @pulumi.getter
    def timeframe(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time frame for pulling data for the report. Possible values are `Custom`, `MonthToDate`, `WeekToDate` and `YearToDate`.
        """
        return pulumi.get(self, "timeframe")
    ...
    @timeframe.setter
    def timeframe(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "timeframe", value)
...
class SubscriptionCostManagementView(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            report_type: Optional[pulumi.Input[builtins.str]] = None,
            subscription_id: Optional[pulumi.Input[builtins.str]] = None,
            timeframe: Optional[pulumi.Input[builtins.str]] = None) -> 'SubscriptionCostManagementView':
        """
    ...
    @property
    @pulumi.getter
    def accumulated(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the costs data in the Cost Management View are accumulated over time. Changing this forces a new Cost Management View for a Subscription to be created.
        """
        return pulumi.get(self, "accumulated")
    ...
    @property
    @pulumi.getter(name="chartType")
    def chart_type(self) -> pulumi.Output[builtins.str]:
        """
        Chart type of the main view in Cost Analysis. Possible values are `Area`, `GroupedColumn`, `Line`, `StackedColumn` and `Table`.
        """
        return pulumi.get(self, "chart_type")
