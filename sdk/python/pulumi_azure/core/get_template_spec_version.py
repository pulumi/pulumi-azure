...
def get_template_spec_version(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Resources`: 2022-02-01
    ...
    :param builtins.str version: The Version Name of the Template Spec.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_template_spec_version_output(name: Optional[pulumi.Input[builtins.str]] = None,
