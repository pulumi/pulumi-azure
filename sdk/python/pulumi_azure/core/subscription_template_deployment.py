...
class SubscriptionTemplateDeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] debug_level: The Debug Level which should be used for this Subscription Template Deployment. Possible values are `none`, `requestContent`, `responseContent` and `requestContent, responseContent`.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Subscription Template Deployment should exist. Changing this forces a new Subscription Template Deployment to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Subscription Template Deployment. Changing this forces a new Subscription Template Deployment to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Subscription Template Deployment.
        :param pulumi.Input[builtins.str] template_content: The contents of the ARM Template which should be deployed into this Subscription.
        :param pulumi.Input[builtins.str] template_spec_version_id: The ID of the Template Spec Version to deploy into the Subscription. Cannot be specified with `template_content`.
        """
...
class SubscriptionTemplateDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            template_content: Optional[pulumi.Input[builtins.str]] = None,
            template_spec_version_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SubscriptionTemplateDeployment':
        """
