...
class GetSubscriptionsResult:
    ...
    def display_name_prefix(self) -> Optional[_builtins.str]:
...
def get_subscriptions(display_name_contains: Optional[_builtins.str] = None,
                      display_name_prefix: Optional[_builtins.str] = None,
    ...
    :param _builtins.str display_name_contains: A case-insensitive value which must be contained within the `display_name` field, used to filter the results
    :param _builtins.str display_name_prefix: A case-insensitive prefix which can be used to filter on the `display_name` field
    """
    __args__ = dict()
