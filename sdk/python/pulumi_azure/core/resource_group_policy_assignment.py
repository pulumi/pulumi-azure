...
class ResourceGroupPolicyAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 not_scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] policy_definition_id: The ID of the Policy Definition or Policy Definition Set. Changing this forces a new Policy Assignment to be created.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the Resource Group where this Policy Assignment should be created. Changing this forces a new Policy Assignment to be created.
        :param pulumi.Input[builtins.str] description: A description which should be used for this Policy Assignment.
        :param pulumi.Input[builtins.str] display_name: The Display Name for this Policy Assignment.
        :param pulumi.Input[builtins.bool] enforce: Specifies if this Policy should be enforced or not? Defaults to `true`.
        :param pulumi.Input['ResourceGroupPolicyAssignmentIdentityArgs'] identity: An `identity` block as defined below.
               
               > **Note:** The `location` field must also be specified when `identity` is specified.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Policy Assignment should exist. Changing this forces a new Policy Assignment to be created.
        :param pulumi.Input[builtins.str] metadata: A JSON mapping of any Metadata for this Policy.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Policy Assignment. Changing this forces a new Policy Assignment to be created. Cannot exceed 64 characters in length.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_scopes: Specifies a list of Resource Scopes (for example a Subscription, or a Resource Group) within this Management Group which are excluded from this Policy.
        ...
        :param pulumi.Input[builtins.str] parameters: A JSON mapping of any Parameters for this Policy.
    ...
    def not_scopes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @not_scopes.setter
    def not_scopes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ResourceGroupPolicyAssignment(pulumi.CustomResource):
    ...
    pulumi_type = "azure:core/resourceGroupPolicyAssignment:ResourceGroupPolicyAssignment"
    ...
    @property
    @pulumi.getter(name="notScopes")
    def not_scopes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a list of Resource Scopes (for example a Subscription, or a Resource Group) within this Management Group which are excluded from this Policy.
        """
        return pulumi.get(self, "not_scopes")
