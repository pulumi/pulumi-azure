...
class SubscriptionCostManagementExportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subscription_id: The id of the subscription on which to create an export. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] active: Is the cost management export active? Default is `true`.
        :param pulumi.Input[builtins.str] file_format: Format for export. Valid values are `Csv` only. Default is `Csv`.
...
class SubscriptionCostManagementExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            recurrence_period_start_date: Optional[pulumi.Input[builtins.str]] = None,
            recurrence_type: Optional[pulumi.Input[builtins.str]] = None,
            subscription_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SubscriptionCostManagementExport':
        """
