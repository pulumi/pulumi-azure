...
class ManagedClusterArgs:
    def __init__(__self__, *,
                 client_connection_port: pulumi.Input[builtins.int],
                 http_gateway_port: pulumi.Input[builtins.int],
                 ...
                 backup_service_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 dns_service_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] client_connection_port: Port to use when connecting to the cluster.
        :param pulumi.Input[builtins.int] http_gateway_port: Port that should be used by the Service Fabric Explorer to visualize applications and cluster status.
        ...
        :param pulumi.Input[builtins.bool] backup_service_enabled: If true, backup service is enabled.
        ...
        :param pulumi.Input[builtins.str] dns_name: Hostname for the cluster. If unset the cluster's name will be used..
        :param pulumi.Input[builtins.bool] dns_service_enabled: If true, DNS service is enabled.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Resource Group should exist. Changing this forces a new Resource Group to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Resource Group. Changing this forces a new Resource Group to be created.
    ...
    def client_connection_port(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def client_connection_port(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "client_connection_port", value)

    @property
    @pulumi.getter(name="httpGatewayPort")
    def http_gateway_port(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def http_gateway_port(self, value: pulumi.Input[builtins.int]):
    ...
    def backup_service_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def backup_service_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def dns_service_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def dns_service_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def upgrade_wave(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @upgrade_wave.setter
    def upgrade_wave(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ManagedClusterState:
    def __init__(__self__, *,
                 authentication: Optional[pulumi.Input['ManagedClusterAuthenticationArgs']] = None,
                 backup_service_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 client_connection_port: Optional[pulumi.Input[builtins.int]] = None,
                 custom_fabric_settings: Optional[pulumi.Input[Sequence[pulumi.Input['ManagedClusterCustomFabricSettingArgs']]]] = None,
                 dns_name: Optional[pulumi.Input[builtins.str]] = None,
                 dns_service_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 http_gateway_port: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="clientConnectionPort")
    def client_connection_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Port to use when connecting to the cluster.
        """
        return pulumi.get(self, "client_connection_port")
    ...
    @client_connection_port.setter
    def client_connection_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "client_connection_port", value)
    ...
    @property
    @pulumi.getter(name="httpGatewayPort")
    def http_gateway_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Port that should be used by the Service Fabric Explorer to visualize applications and cluster status.
        """
        return pulumi.get(self, "http_gateway_port")
    ...
    @http_gateway_port.setter
    def http_gateway_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "http_gateway_port", value)
...
class ManagedCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="backupServiceEnabled")
    def backup_service_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, backup service is enabled.
        """
        return pulumi.get(self, "backup_service_enabled")
    ...
    @property
    @pulumi.getter(name="clientConnectionPort")
    def client_connection_port(self) -> pulumi.Output[builtins.int]:
        """
        Port to use when connecting to the cluster.
        """
        return pulumi.get(self, "client_connection_port")
    ...
    @property
    @pulumi.getter(name="dnsServiceEnabled")
    def dns_service_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, DNS service is enabled.
        """
        return pulumi.get(self, "dns_service_enabled")
    ...
    @property
    @pulumi.getter(name="httpGatewayPort")
    def http_gateway_port(self) -> pulumi.Output[builtins.int]:
        """
        Port that should be used by the Service Fabric Explorer to visualize applications and cluster status.
        """
        return pulumi.get(self, "http_gateway_port")
    ...
    @property
    @pulumi.getter(name="upgradeWave")
    def upgrade_wave(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Upgrade wave for the fabric runtime. Default is `Wave0`, allowed value must be one of `Wave0`, `Wave1`, or `Wave2`.
        """
        return pulumi.get(self, "upgrade_wave")
