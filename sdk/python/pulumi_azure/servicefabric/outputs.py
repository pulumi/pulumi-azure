...
class ClusterAzureActiveDirectory(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_application_id: The Azure Active Directory Client ID which should be used for the Client Application.
        :param builtins.str cluster_application_id: The Azure Active Directory Cluster Application ID.
...
class ClusterCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 thumbprint_secondary: Optional[builtins.str] = None):
        """
        :param builtins.str thumbprint: The Thumbprint of the Certificate.
        :param builtins.str x509_store_name: The X509 Store where the Certificate Exists, such as `My`.
        :param builtins.str thumbprint_secondary: The Secondary Thumbprint of the Certificate.
        """
    ...
    def thumbprint_secondary(self) -> Optional[builtins.str]:
        """
...
class ClusterCertificateCommonNamesCommonName(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_issuer_thumbprint: Optional[builtins.str] = None):
        """
        :param builtins.str certificate_common_name: The common or subject name of the certificate.
        :param builtins.str certificate_issuer_thumbprint: The Issuer Thumbprint of the Certificate.
    ...
    def certificate_issuer_thumbprint(self) -> Optional[builtins.str]:
        """
...
class ClusterClientCertificateCommonName(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str common_name: The common or subject name of the certificate.
        :param builtins.bool is_admin: Does the Client Certificate have Admin Access to the cluster? Non-admin clients can only perform read only operations on the cluster.
        :param builtins.str issuer_thumbprint: The Issuer Thumbprint of the Certificate.
...
class ClusterClientCertificateThumbprint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_admin: Does the Client Certificate have Admin Access to the cluster? Non-admin clients can only perform read only operations on the cluster.
        :param builtins.str thumbprint: The Thumbprint associated with the Client Certificate.
        """
        pulumi.set(__self__, "is_admin", is_admin)
        pulumi.set(__self__, "thumbprint", thumbprint)
...
class ClusterDiagnosticsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str blob_endpoint: The Blob Endpoint of the Storage Account.
        :param builtins.str protected_account_key_name: The protected diagnostics storage key name, such as `StorageAccountKey1`.
        :param builtins.str queue_endpoint: The Queue Endpoint of the Storage Account.
        :param builtins.str storage_account_name: The name of the Storage Account where the Diagnostics should be sent to.
        :param builtins.str table_endpoint: The Table Endpoint of the Storage Account.
        """
...
class ClusterFabricSetting(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the Fabric Setting, such as `Security` or `Federation`.
        :param Mapping[str, builtins.str] parameters: A map containing settings for the specified Fabric Setting.
        """
...
class ClusterNodeType(dict):
    ...
    def __init__(__self__, *,
                 client_endpoint_port: builtins.int,
                 http_endpoint_port: builtins.int,
                 ...
                 capacities: Optional[Mapping[str, builtins.str]] = None,
                 durability_level: Optional[builtins.str] = None,
                 ephemeral_ports: Optional['outputs.ClusterNodeTypeEphemeralPorts'] = None,
                 is_stateless: Optional[builtins.bool] = None,
                 multiple_availability_zones: Optional[builtins.bool] = None,
                 placement_properties: Optional[Mapping[str, builtins.str]] = None,
                 reverse_proxy_endpoint_port: Optional[builtins.int] = None):
        """
        :param builtins.int client_endpoint_port: The Port used for the Client Endpoint for this Node Type.
        :param builtins.int http_endpoint_port: The Port used for the HTTP Endpoint for this Node Type.
        :param builtins.int instance_count: The number of nodes for this Node Type.
        :param builtins.bool is_primary: Is this the Primary Node Type?
        :param builtins.str name: The name of the Node Type.
        :param 'ClusterNodeTypeApplicationPortsArgs' application_ports: A `application_ports` block as defined below.
        :param Mapping[str, builtins.str] capacities: The capacity tags applied to the nodes in the node type, the cluster resource manager uses these tags to understand how much resource a node has.
        :param builtins.str durability_level: The Durability Level for this Node Type. Possible values include `Bronze`, `Gold` and `Silver`. Defaults to `Bronze`.
        :param 'ClusterNodeTypeEphemeralPortsArgs' ephemeral_ports: A `ephemeral_ports` block as defined below.
        :param builtins.bool is_stateless: Should this node type run only stateless services?
        :param builtins.bool multiple_availability_zones: Does this node type span availability zones?
        :param Mapping[str, builtins.str] placement_properties: The placement tags applied to nodes in the node type, which can be used to indicate where certain services (workload) should run.
        :param builtins.int reverse_proxy_endpoint_port: The Port used for the Reverse Proxy Endpoint for this Node Type. Changing this will upgrade the cluster.
        """
    ...
    def client_endpoint_port(self) -> builtins.int:
        """
    ...
    def http_endpoint_port(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter
    def capacities(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def durability_level(self) -> Optional[builtins.str]:
        """
    ...
    def is_stateless(self) -> Optional[builtins.bool]:
        """
    ...
    def multiple_availability_zones(self) -> Optional[builtins.bool]:
        """
    ...
    def placement_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def reverse_proxy_endpoint_port(self) -> Optional[builtins.int]:
        """
...
class ClusterNodeTypeApplicationPorts(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int end_port: The end of the Application Port Range on this Node Type.
        :param builtins.int start_port: The start of the Application Port Range on this Node Type.
        """
...
class ClusterNodeTypeEphemeralPorts(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_port: builtins.int):
        """
        :param builtins.int end_port: The end of the Ephemeral Port Range on this Node Type.
        :param builtins.int start_port: The start of the Ephemeral Port Range on this Node Type.
        """
        pulumi.set(__self__, "end_port", end_port)
        pulumi.set(__self__, "start_port", start_port)
...
class ClusterUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 force_restart_enabled: Optional[builtins.bool] = None,
                 health_check_retry_timeout: Optional[builtins.str] = None,
                 health_check_stable_duration: Optional[builtins.str] = None,
                 health_check_wait_duration: Optional[builtins.str] = None,
                 health_policy: Optional['outputs.ClusterUpgradePolicyHealthPolicy'] = None,
                 upgrade_domain_timeout: Optional[builtins.str] = None,
                 upgrade_replica_set_check_timeout: Optional[builtins.str] = None,
                 upgrade_timeout: Optional[builtins.str] = None):
        """
        :param 'ClusterUpgradePolicyDeltaHealthPolicyArgs' delta_health_policy: A `delta_health_policy` block as defined below
        :param builtins.bool force_restart_enabled: Indicates whether to restart the Service Fabric node even if only dynamic configurations have changed.
        :param builtins.str health_check_retry_timeout: Specifies the duration, in "hh:mm:ss" string format, after which Service Fabric retries the health check if the previous health check fails. Defaults to `00:45:00`.
        :param builtins.str health_check_stable_duration: Specifies the duration, in "hh:mm:ss" string format, that Service Fabric waits in order to verify that the cluster is stable before it continues to the next upgrade domain or completes the upgrade. This wait duration prevents undetected changes of health right after the health check is performed. Defaults to `00:01:00`.
        :param builtins.str health_check_wait_duration: Specifies the duration, in "hh:mm:ss" string format, that Service Fabric waits before it performs the initial health check after it finishes the upgrade on the upgrade domain. Defaults to `00:00:30`.
        :param 'ClusterUpgradePolicyHealthPolicyArgs' health_policy: A `health_policy` block as defined below
        :param builtins.str upgrade_domain_timeout: Specifies the duration, in "hh:mm:ss" string format, that Service Fabric takes to upgrade a single upgrade domain. After this period, the upgrade fails. Defaults to `02:00:00`.
        :param builtins.str upgrade_replica_set_check_timeout: Specifies the duration, in "hh:mm:ss" string format, that Service Fabric waits for a replica set to reconfigure into a safe state, if it is not already in a safe state, before Service Fabric proceeds with the upgrade. Defaults to `10675199.02:48:05.4775807`.
        :param builtins.str upgrade_timeout: Specifies the duration, in "hh:mm:ss" string format, that Service Fabric takes for the entire upgrade. After this period, the upgrade fails. Defaults to `12:00:00`.
        """
    ...
    def force_restart_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def health_check_retry_timeout(self) -> Optional[builtins.str]:
        """
    ...
    def health_check_stable_duration(self) -> Optional[builtins.str]:
        """
    ...
    def health_check_wait_duration(self) -> Optional[builtins.str]:
        """
    ...
    def upgrade_domain_timeout(self) -> Optional[builtins.str]:
        """
    ...
    def upgrade_timeout(self) -> Optional[builtins.str]:
        """
...
class ClusterUpgradePolicyDeltaHealthPolicy(dict):
    ...
    def __init__(__self__, *,
                 max_delta_unhealthy_applications_percent: Optional[builtins.int] = None,
                 max_delta_unhealthy_nodes_percent: Optional[builtins.int] = None,
                 max_upgrade_domain_delta_unhealthy_nodes_percent: Optional[builtins.int] = None):
        """
        :param builtins.int max_delta_unhealthy_applications_percent: Specifies the maximum tolerated percentage of delta unhealthy applications that can have aggregated health states of error. If the current unhealthy applications do not respect the percentage relative to the state at the beginning of the upgrade, the cluster is unhealthy. Defaults to `0`.
        :param builtins.int max_delta_unhealthy_nodes_percent: Specifies the maximum tolerated percentage of delta unhealthy nodes that can have aggregated health states of error. If the current unhealthy nodes do not respect the percentage relative to the state at the beginning of the upgrade, the cluster is unhealthy. Defaults to `0`.
        :param builtins.int max_upgrade_domain_delta_unhealthy_nodes_percent: Specifies the maximum tolerated percentage of upgrade domain delta unhealthy nodes that can have aggregated health state of error. If there is any upgrade domain where the current unhealthy nodes do not respect the percentage relative to the state at the beginning of the upgrade, the cluster is unhealthy. Defaults to `0`.
        """
    ...
    def max_delta_unhealthy_applications_percent(self) -> Optional[builtins.int]:
        """
    ...
    def max_delta_unhealthy_nodes_percent(self) -> Optional[builtins.int]:
        """
    ...
    def max_upgrade_domain_delta_unhealthy_nodes_percent(self) -> Optional[builtins.int]:
        """
...
class ClusterUpgradePolicyHealthPolicy(dict):
    ...
    def __init__(__self__, *,
                 max_unhealthy_applications_percent: Optional[builtins.int] = None,
                 max_unhealthy_nodes_percent: Optional[builtins.int] = None):
        """
        :param builtins.int max_unhealthy_applications_percent: Specifies the maximum tolerated percentage of applications that can have aggregated health state of error. If the upgrade exceeds this percentage, the cluster is unhealthy. Defaults to `0`.
        :param builtins.int max_unhealthy_nodes_percent: Specifies the maximum tolerated percentage of nodes that can have aggregated health states of error. If an upgrade exceeds this percentage, the cluster is unhealthy. Defaults to `0`.
        """
    ...
    def max_unhealthy_applications_percent(self) -> Optional[builtins.int]:
        """
    ...
    def max_unhealthy_nodes_percent(self) -> Optional[builtins.int]:
        """
...
class ManagedClusterAuthenticationActiveDirectory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: builtins.str):
        """
        :param builtins.str client_application_id: The ID of the Client Application.
        :param builtins.str cluster_application_id: The ID of the Cluster Application.
        :param builtins.str tenant_id: The ID of the Tenant.
        """
        pulumi.set(__self__, "client_application_id", client_application_id)
        pulumi.set(__self__, "cluster_application_id", cluster_application_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class ManagedClusterAuthenticationCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str thumbprint: The thumbprint of the certificate.
        :param builtins.str type: The type of the certificate. Can be `AdminClient` or `ReadOnlyClient`.
        :param builtins.str common_name: The certificate's CN.
        """
        pulumi.set(__self__, "thumbprint", thumbprint)
...
class ManagedClusterCustomFabricSetting(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str parameter: Parameter name.
        :param builtins.str section: Section name.
...
class ManagedClusterLbRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int backend_port: LB Backend port.
        :param builtins.int frontend_port: LB Frontend port.
        :param builtins.str probe_protocol: Protocol for the probe. Can be one of `tcp`, `udp`, `http`, or `https`.
        :param builtins.str protocol: The transport protocol used in this rule. Can be one of `tcp` or `udp`.
        :param builtins.str probe_request_path: Path for the probe to check, when probe protocol is set to `http`.
        """
...
class ManagedClusterNodeType(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vm_instance_count: builtins.int,
                 vm_size: builtins.str,
                 capacities: Optional[Mapping[str, builtins.str]] = None,
                 data_disk_type: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 multiple_placement_groups_enabled: Optional[builtins.bool] = None,
                 placement_properties: Optional[Mapping[str, builtins.str]] = None,
                 primary: Optional[builtins.bool] = None,
                 stateless: Optional[builtins.bool] = None,
                 vm_secrets: Optional[Sequence['outputs.ManagedClusterNodeTypeVmSecret']] = None):
        """
        :param builtins.str application_port_range: Sets the port range available for applications. Format is `<from_port>-<to_port>`, for example `10000-20000`.
        :param builtins.int data_disk_size_gb: The size of the data disk in gigabytes..
        :param builtins.str ephemeral_port_range: Sets the port range available for the OS. Format is `<from_port>-<to_port>`, for example `10000-20000`. There has to be at least 255 ports available and cannot overlap with `application_port_range`..
        :param builtins.str name: The name which should be used for this node type.
        :param builtins.str vm_image_offer: The offer type of the marketplace image cluster VMs will use.
        :param builtins.str vm_image_publisher: The publisher of the marketplace image cluster VMs will use.
        :param builtins.str vm_image_sku: The SKU of the marketplace image cluster VMs will use.
        :param builtins.str vm_image_version: The version of the marketplace image cluster VMs will use.
        :param builtins.int vm_instance_count: The number of instances this node type will launch.
        :param builtins.str vm_size: The size of the instances in this node type.
        :param Mapping[str, builtins.str] capacities: Specifies a list of key/value pairs used to set capacity tags for this node type.
        :param builtins.str data_disk_type: The type of the disk to use for storing data. It can be one of `Premium_LRS`, `Standard_LRS`, or `StandardSSD_LRS`. Defaults to `Standard_LRS`.
        :param builtins.str id: The ID of the Resource Group.
        :param builtins.bool multiple_placement_groups_enabled: If set the node type can be composed of multiple placement groups.
        :param Mapping[str, builtins.str] placement_properties: Specifies a list of placement tags that can be used to indicate where services should run..
        :param builtins.bool primary: If set to true, system services will run on this node type. Only one node type should be marked as primary. Primary node type cannot be deleted or changed once they're created.
        :param builtins.bool stateless: If set to true, only stateless workloads can run on this node type.
    ...
    def data_disk_size_gb(self) -> builtins.int:
        """
    ...
    def vm_instance_count(self) -> builtins.int:
        """
    ...
    def multiple_placement_groups_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def stateless(self) -> Optional[builtins.bool]:
        """
...
class ManagedClusterNodeTypeVmSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str vault_id: The ID of the Vault that contain the certificates.
        """
        pulumi.set(__self__, "certificates", certificates)
...
class ManagedClusterNodeTypeVmSecretCertificate(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str store: The certificate store on the Virtual Machine to which the certificate should be added.
        :param builtins.str url: The URL of a certificate that has been uploaded to Key Vault as a secret
        """
