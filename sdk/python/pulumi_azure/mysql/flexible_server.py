...
class FlexibleServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] administrator_login: The Administrator login for the MySQL Flexible Server. Required when `create_mode` is `Default`. Changing this forces a new MySQL Flexible Server to be created.
        :param pulumi.Input[builtins.str] administrator_password: The Password associated with the `administrator_login` for the MySQL Flexible Server.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the MySQL Flexible Server should exist. Changing this forces a new MySQL Flexible Server to be created.
        :param pulumi.Input['FlexibleServerMaintenanceWindowArgs'] maintenance_window: A `maintenance_window` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this MySQL Flexible Server. Changing this forces a new MySQL Flexible Server to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the MySQL Flexible Server.
        :param pulumi.Input[builtins.str] version: The version of the MySQL Flexible Server to use. Possible values are `5.7`, and `8.0.21`. Changing this forces a new MySQL Flexible Server to be created.
        """
...
class _FlexibleServerState:
    ...
    def replica_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def replica_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FlexibleServer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="backupRetentionDays")
    def backup_retention_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The backup retention days for the MySQL Flexible Server. Possible values are between `1` and `35` days. Defaults to `7`.
        """
        return pulumi.get(self, "backup_retention_days")
    ...
    @property
    @pulumi.getter(name="privateDnsZoneId")
    def private_dns_zone_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the private DNS zone to create the MySQL Flexible Server. Changing this forces a new MySQL Flexible Server to be created.
