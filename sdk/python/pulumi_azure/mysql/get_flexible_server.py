...
class GetFlexibleServerResult:
    ...
    def geo_redundant_backup_enabled(self) -> builtins.bool:
        """
...
def get_flexible_server(name: Optional[builtins.str] = None,
...
def get_flexible_server_output(name: Optional[pulumi.Input[builtins.str]] = None,
