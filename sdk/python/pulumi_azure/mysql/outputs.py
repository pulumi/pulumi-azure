...
class FlexibleServerHighAvailability(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str standby_availability_zone: Specifies the Availability Zone in which the standby Flexible Server should be located. Possible values are `1`, `2` and `3`.
