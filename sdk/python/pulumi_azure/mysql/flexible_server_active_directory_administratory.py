...
class FlexibleServerActiveDirectoryAdministratoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] identity_id: The resource ID of the identity used for AAD Authentication.
        :param pulumi.Input[builtins.str] login: The login name of the principal to set as the server administrator
        :param pulumi.Input[builtins.str] object_id: The ID of the principal to set as the server administrator. For a managed identity this should be the Client ID of the identity.
        :param pulumi.Input[builtins.str] server_id: The resource ID of the MySQL Flexible Server. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] tenant_id: The Azure Tenant ID.
        """
...
class FlexibleServerActiveDirectoryAdministratory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            object_id: Optional[pulumi.Input[builtins.str]] = None,
            server_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FlexibleServerActiveDirectoryAdministratory':
        """
