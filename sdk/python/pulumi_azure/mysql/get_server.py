...
def get_server(name: Optional[str] = None,
    ...
    return AwaitableGetServerResult(
        ...
        ssl_enforcement_enabled=pulumi.get(__ret__, 'ssl_enforcement_enabled'),
        ssl_minimal_tls_version_enforced=pulumi.get(__ret__, 'ssl_minimal_tls_version_enforced'),
