...
class ServerIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] type: The Type of Identity which should be used for this MySQL Server. At this time the only possible value is `SystemAssigned`.
        :param pulumi.Input[str] principal_id: The Client ID of the Service Principal assigned to this MySQL Server.
