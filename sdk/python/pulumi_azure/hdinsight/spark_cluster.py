...
class SparkCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            component_version = _utilities.configure(component_version, SparkClusterComponentVersionArgs, True)
            ...
            compute_isolation = _utilities.configure(compute_isolation, SparkClusterComputeIsolationArgs, True)
            ...
            extension = _utilities.configure(extension, SparkClusterExtensionArgs, True)
            __props__.__dict__["extension"] = extension
            gateway = _utilities.configure(gateway, SparkClusterGatewayArgs, True)
            if gateway is None and not opts.urn:
                raise TypeError("Missing required property 'gateway'")
            __props__.__dict__["gateway"] = gateway
            __props__.__dict__["location"] = location
            metastores = _utilities.configure(metastores, SparkClusterMetastoresArgs, True)
            __props__.__dict__["metastores"] = metastores
            monitor = _utilities.configure(monitor, SparkClusterMonitorArgs, True)
            __props__.__dict__["monitor"] = monitor
            __props__.__dict__["name"] = name
            network = _utilities.configure(network, SparkClusterNetworkArgs, True)
            __props__.__dict__["network"] = network
            if resource_group_name is None and not opts.urn:
                raise TypeError("Missing required property 'resource_group_name'")
            __props__.__dict__["resource_group_name"] = resource_group_name
            roles = _utilities.configure(roles, SparkClusterRolesArgs, True)
            if roles is None and not opts.urn:
                raise TypeError("Missing required property 'roles'")
            __props__.__dict__["roles"] = roles
            security_profile = _utilities.configure(security_profile, SparkClusterSecurityProfileArgs, True)
            __props__.__dict__["security_profile"] = security_profile
            storage_account_gen2 = _utilities.configure(storage_account_gen2, SparkClusterStorageAccountGen2Args, True)
