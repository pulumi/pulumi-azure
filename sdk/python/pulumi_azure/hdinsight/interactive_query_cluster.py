...
class InteractiveQueryClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group in which this HDInsight Interactive Query Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input['InteractiveQueryClusterRolesArgs'] roles: A `roles` block as defined below.
        :param pulumi.Input[builtins.str] tier: Specifies the Tier which should be used for this HDInsight Interactive Query Cluster. Possible values are `Standard` or `Premium`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region which this HDInsight Interactive Query Cluster should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name for this HDInsight Interactive Query Cluster. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of Tags which should be assigned to this HDInsight Interactive Query Cluster.
...
class _InteractiveQueryClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['InteractiveQueryClusterExtensionArgs'] extension: An `extension` block as defined below.
        :param pulumi.Input['InteractiveQueryClusterGatewayArgs'] gateway: A `gateway` block as defined below.
        :param pulumi.Input[builtins.str] https_endpoint: The HTTPS Connectivity Endpoint for this HDInsight Interactive Query Cluster.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region which this HDInsight Interactive Query Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input['InteractiveQueryClusterMetastoresArgs'] metastores: A `metastores` block as defined below.
        :param pulumi.Input['InteractiveQueryClusterMonitorArgs'] monitor: A `monitor` block as defined below.
        :param pulumi.Input[builtins.str] name: Specifies the name for this HDInsight Interactive Query Cluster. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input['InteractiveQueryClusterRolesArgs'] roles: A `roles` block as defined below.
        :param pulumi.Input['InteractiveQueryClusterSecurityProfileArgs'] security_profile: A `security_profile` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] ssh_endpoint: The SSH Connectivity Endpoint for this HDInsight Interactive Query Cluster.
        :param pulumi.Input['InteractiveQueryClusterStorageAccountGen2Args'] storage_account_gen2: A `storage_account_gen2` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input['InteractiveQueryClusterStorageAccountArgs']]] storage_accounts: One or more `storage_account` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of Tags which should be assigned to this HDInsight Interactive Query Cluster.
        :param pulumi.Input[builtins.str] tier: Specifies the Tier which should be used for this HDInsight Interactive Query Cluster. Possible values are `Standard` or `Premium`. Changing this forces a new resource to be created.
...
class InteractiveQueryCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tier: Optional[pulumi.Input[builtins.str]] = None,
            tls_min_version: Optional[pulumi.Input[builtins.str]] = None) -> 'InteractiveQueryCluster':
        """
