...
__all__ = [
    ...
    'HBaseClusterComponentVersionArgsDict',
    'HBaseClusterComputeIsolationArgs',
    'HBaseClusterComputeIsolationArgsDict',
    'HBaseClusterDiskEncryptionArgs',
    'HBaseClusterDiskEncryptionArgsDict',
    'HBaseClusterExtensionArgs',
    'HBaseClusterExtensionArgsDict',
    'HBaseClusterGatewayArgs',
    'HBaseClusterGatewayArgsDict',
    'HBaseClusterMetastoresArgs',
    'HBaseClusterMetastoresArgsDict',
    'HBaseClusterMetastoresAmbariArgs',
    'HBaseClusterMetastoresAmbariArgsDict',
    'HBaseClusterMetastoresHiveArgs',
    'HBaseClusterMetastoresHiveArgsDict',
    'HBaseClusterMetastoresOozieArgs',
    'HBaseClusterMetastoresOozieArgsDict',
    'HBaseClusterMonitorArgs',
    'HBaseClusterMonitorArgsDict',
    'HBaseClusterNetworkArgs',
    'HBaseClusterNetworkArgsDict',
    'HBaseClusterPrivateLinkConfigurationArgs',
    'HBaseClusterPrivateLinkConfigurationArgsDict',
    'HBaseClusterPrivateLinkConfigurationIpConfigurationArgs',
    'HBaseClusterPrivateLinkConfigurationIpConfigurationArgsDict',
    'HBaseClusterRolesArgs',
    'HBaseClusterRolesArgsDict',
    'HBaseClusterRolesHeadNodeArgs',
    'HBaseClusterRolesHeadNodeArgsDict',
    'HBaseClusterRolesHeadNodeScriptActionArgs',
    'HBaseClusterRolesHeadNodeScriptActionArgsDict',
    'HBaseClusterRolesWorkerNodeArgs',
    'HBaseClusterRolesWorkerNodeArgsDict',
    'HBaseClusterRolesWorkerNodeAutoscaleArgs',
    'HBaseClusterRolesWorkerNodeAutoscaleArgsDict',
    'HBaseClusterRolesWorkerNodeAutoscaleRecurrenceArgs',
    'HBaseClusterRolesWorkerNodeAutoscaleRecurrenceArgsDict',
    'HBaseClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs',
    'HBaseClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgsDict',
    'HBaseClusterRolesWorkerNodeScriptActionArgs',
    'HBaseClusterRolesWorkerNodeScriptActionArgsDict',
    'HBaseClusterRolesZookeeperNodeArgs',
    'HBaseClusterRolesZookeeperNodeArgsDict',
    'HBaseClusterRolesZookeeperNodeScriptActionArgs',
    'HBaseClusterRolesZookeeperNodeScriptActionArgsDict',
    'HBaseClusterSecurityProfileArgs',
    'HBaseClusterSecurityProfileArgsDict',
    'HBaseClusterStorageAccountArgs',
    'HBaseClusterStorageAccountArgsDict',
    'HBaseClusterStorageAccountGen2Args',
    'HBaseClusterStorageAccountGen2ArgsDict',
    'HadoopClusterComponentVersionArgs',
    'HadoopClusterComponentVersionArgsDict',
    'HadoopClusterComputeIsolationArgs',
    'HadoopClusterComputeIsolationArgsDict',
    'HadoopClusterDiskEncryptionArgs',
    'HadoopClusterDiskEncryptionArgsDict',
    'HadoopClusterExtensionArgs',
    'HadoopClusterExtensionArgsDict',
    'HadoopClusterGatewayArgs',
    'HadoopClusterGatewayArgsDict',
    'HadoopClusterMetastoresArgs',
    'HadoopClusterMetastoresArgsDict',
    'HadoopClusterMetastoresAmbariArgs',
    'HadoopClusterMetastoresAmbariArgsDict',
    'HadoopClusterMetastoresHiveArgs',
    'HadoopClusterMetastoresHiveArgsDict',
    'HadoopClusterMetastoresOozieArgs',
    'HadoopClusterMetastoresOozieArgsDict',
    'HadoopClusterMonitorArgs',
    'HadoopClusterMonitorArgsDict',
    'HadoopClusterNetworkArgs',
    'HadoopClusterNetworkArgsDict',
    'HadoopClusterPrivateLinkConfigurationArgs',
    'HadoopClusterPrivateLinkConfigurationArgsDict',
    'HadoopClusterPrivateLinkConfigurationIpConfigurationArgs',
    'HadoopClusterPrivateLinkConfigurationIpConfigurationArgsDict',
    'HadoopClusterRolesArgs',
    'HadoopClusterRolesArgsDict',
    'HadoopClusterRolesEdgeNodeArgs',
    'HadoopClusterRolesEdgeNodeArgsDict',
    'HadoopClusterRolesEdgeNodeHttpsEndpointArgs',
    'HadoopClusterRolesEdgeNodeHttpsEndpointArgsDict',
    'HadoopClusterRolesEdgeNodeInstallScriptActionArgs',
    'HadoopClusterRolesEdgeNodeInstallScriptActionArgsDict',
    'HadoopClusterRolesEdgeNodeUninstallScriptActionArgs',
    'HadoopClusterRolesEdgeNodeUninstallScriptActionArgsDict',
    'HadoopClusterRolesHeadNodeArgs',
    'HadoopClusterRolesHeadNodeArgsDict',
    'HadoopClusterRolesHeadNodeScriptActionArgs',
    'HadoopClusterRolesHeadNodeScriptActionArgsDict',
    'HadoopClusterRolesWorkerNodeArgs',
    'HadoopClusterRolesWorkerNodeArgsDict',
    'HadoopClusterRolesWorkerNodeAutoscaleArgs',
    'HadoopClusterRolesWorkerNodeAutoscaleArgsDict',
    'HadoopClusterRolesWorkerNodeAutoscaleCapacityArgs',
    'HadoopClusterRolesWorkerNodeAutoscaleCapacityArgsDict',
    'HadoopClusterRolesWorkerNodeAutoscaleRecurrenceArgs',
    'HadoopClusterRolesWorkerNodeAutoscaleRecurrenceArgsDict',
    'HadoopClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs',
    'HadoopClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgsDict',
    'HadoopClusterRolesWorkerNodeScriptActionArgs',
    'HadoopClusterRolesWorkerNodeScriptActionArgsDict',
    'HadoopClusterRolesZookeeperNodeArgs',
    'HadoopClusterRolesZookeeperNodeArgsDict',
    'HadoopClusterRolesZookeeperNodeScriptActionArgs',
    'HadoopClusterRolesZookeeperNodeScriptActionArgsDict',
    'HadoopClusterSecurityProfileArgs',
    'HadoopClusterSecurityProfileArgsDict',
    'HadoopClusterStorageAccountArgs',
    'HadoopClusterStorageAccountArgsDict',
    'HadoopClusterStorageAccountGen2Args',
    'HadoopClusterStorageAccountGen2ArgsDict',
    'InteractiveQueryClusterComponentVersionArgs',
    'InteractiveQueryClusterComponentVersionArgsDict',
    'InteractiveQueryClusterComputeIsolationArgs',
    'InteractiveQueryClusterComputeIsolationArgsDict',
    'InteractiveQueryClusterDiskEncryptionArgs',
    'InteractiveQueryClusterDiskEncryptionArgsDict',
    'InteractiveQueryClusterExtensionArgs',
    'InteractiveQueryClusterExtensionArgsDict',
    'InteractiveQueryClusterGatewayArgs',
    'InteractiveQueryClusterGatewayArgsDict',
    'InteractiveQueryClusterMetastoresArgs',
    'InteractiveQueryClusterMetastoresArgsDict',
    'InteractiveQueryClusterMetastoresAmbariArgs',
    'InteractiveQueryClusterMetastoresAmbariArgsDict',
    'InteractiveQueryClusterMetastoresHiveArgs',
    'InteractiveQueryClusterMetastoresHiveArgsDict',
    'InteractiveQueryClusterMetastoresOozieArgs',
    'InteractiveQueryClusterMetastoresOozieArgsDict',
    'InteractiveQueryClusterMonitorArgs',
    'InteractiveQueryClusterMonitorArgsDict',
    'InteractiveQueryClusterNetworkArgs',
    'InteractiveQueryClusterNetworkArgsDict',
    'InteractiveQueryClusterPrivateLinkConfigurationArgs',
    'InteractiveQueryClusterPrivateLinkConfigurationArgsDict',
    'InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs',
    'InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgsDict',
    'InteractiveQueryClusterRolesArgs',
    'InteractiveQueryClusterRolesArgsDict',
    'InteractiveQueryClusterRolesHeadNodeArgs',
    'InteractiveQueryClusterRolesHeadNodeArgsDict',
    'InteractiveQueryClusterRolesHeadNodeScriptActionArgs',
    'InteractiveQueryClusterRolesHeadNodeScriptActionArgsDict',
    'InteractiveQueryClusterRolesWorkerNodeArgs',
    'InteractiveQueryClusterRolesWorkerNodeArgsDict',
    'InteractiveQueryClusterRolesWorkerNodeAutoscaleArgs',
    'InteractiveQueryClusterRolesWorkerNodeAutoscaleArgsDict',
    'InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceArgs',
    'InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceArgsDict',
    'InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs',
    'InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgsDict',
    'InteractiveQueryClusterRolesWorkerNodeScriptActionArgs',
    'InteractiveQueryClusterRolesWorkerNodeScriptActionArgsDict',
    'InteractiveQueryClusterRolesZookeeperNodeArgs',
    'InteractiveQueryClusterRolesZookeeperNodeArgsDict',
    'InteractiveQueryClusterRolesZookeeperNodeScriptActionArgs',
    'InteractiveQueryClusterRolesZookeeperNodeScriptActionArgsDict',
    'InteractiveQueryClusterSecurityProfileArgs',
    'InteractiveQueryClusterSecurityProfileArgsDict',
    'InteractiveQueryClusterStorageAccountArgs',
    'InteractiveQueryClusterStorageAccountArgsDict',
    'InteractiveQueryClusterStorageAccountGen2Args',
    'InteractiveQueryClusterStorageAccountGen2ArgsDict',
    'KafkaClusterComponentVersionArgs',
    'KafkaClusterComponentVersionArgsDict',
    'KafkaClusterComputeIsolationArgs',
    'KafkaClusterComputeIsolationArgsDict',
    'KafkaClusterDiskEncryptionArgs',
    'KafkaClusterDiskEncryptionArgsDict',
    'KafkaClusterExtensionArgs',
    'KafkaClusterExtensionArgsDict',
    'KafkaClusterGatewayArgs',
    'KafkaClusterGatewayArgsDict',
    'KafkaClusterMetastoresArgs',
    'KafkaClusterMetastoresArgsDict',
    'KafkaClusterMetastoresAmbariArgs',
    'KafkaClusterMetastoresAmbariArgsDict',
    'KafkaClusterMetastoresHiveArgs',
    'KafkaClusterMetastoresHiveArgsDict',
    'KafkaClusterMetastoresOozieArgs',
    'KafkaClusterMetastoresOozieArgsDict',
    'KafkaClusterMonitorArgs',
    'KafkaClusterMonitorArgsDict',
    'KafkaClusterNetworkArgs',
    'KafkaClusterNetworkArgsDict',
    'KafkaClusterPrivateLinkConfigurationArgs',
    'KafkaClusterPrivateLinkConfigurationArgsDict',
    'KafkaClusterPrivateLinkConfigurationIpConfigurationArgs',
    'KafkaClusterPrivateLinkConfigurationIpConfigurationArgsDict',
    'KafkaClusterRestProxyArgs',
    'KafkaClusterRestProxyArgsDict',
    'KafkaClusterRolesArgs',
    'KafkaClusterRolesArgsDict',
    'KafkaClusterRolesHeadNodeArgs',
    'KafkaClusterRolesHeadNodeArgsDict',
    'KafkaClusterRolesHeadNodeScriptActionArgs',
    'KafkaClusterRolesHeadNodeScriptActionArgsDict',
    'KafkaClusterRolesKafkaManagementNodeArgs',
    'KafkaClusterRolesKafkaManagementNodeArgsDict',
    'KafkaClusterRolesKafkaManagementNodeScriptActionArgs',
    'KafkaClusterRolesKafkaManagementNodeScriptActionArgsDict',
    'KafkaClusterRolesWorkerNodeArgs',
    'KafkaClusterRolesWorkerNodeArgsDict',
    'KafkaClusterRolesWorkerNodeScriptActionArgs',
    'KafkaClusterRolesWorkerNodeScriptActionArgsDict',
    'KafkaClusterRolesZookeeperNodeArgs',
    'KafkaClusterRolesZookeeperNodeArgsDict',
    'KafkaClusterRolesZookeeperNodeScriptActionArgs',
    'KafkaClusterRolesZookeeperNodeScriptActionArgsDict',
    'KafkaClusterSecurityProfileArgs',
    'KafkaClusterSecurityProfileArgsDict',
    'KafkaClusterStorageAccountArgs',
    'KafkaClusterStorageAccountArgsDict',
    'KafkaClusterStorageAccountGen2Args',
    'KafkaClusterStorageAccountGen2ArgsDict',
    'SparkClusterComponentVersionArgs',
    'SparkClusterComponentVersionArgsDict',
    'SparkClusterComputeIsolationArgs',
    'SparkClusterComputeIsolationArgsDict',
    'SparkClusterDiskEncryptionArgs',
    'SparkClusterDiskEncryptionArgsDict',
    'SparkClusterExtensionArgs',
    'SparkClusterExtensionArgsDict',
    'SparkClusterGatewayArgs',
    'SparkClusterGatewayArgsDict',
    'SparkClusterMetastoresArgs',
    'SparkClusterMetastoresArgsDict',
    'SparkClusterMetastoresAmbariArgs',
    'SparkClusterMetastoresAmbariArgsDict',
    'SparkClusterMetastoresHiveArgs',
    'SparkClusterMetastoresHiveArgsDict',
    'SparkClusterMetastoresOozieArgs',
    'SparkClusterMetastoresOozieArgsDict',
    'SparkClusterMonitorArgs',
    'SparkClusterMonitorArgsDict',
    'SparkClusterNetworkArgs',
    'SparkClusterNetworkArgsDict',
    'SparkClusterPrivateLinkConfigurationArgs',
    'SparkClusterPrivateLinkConfigurationArgsDict',
    'SparkClusterPrivateLinkConfigurationIpConfigurationArgs',
    'SparkClusterPrivateLinkConfigurationIpConfigurationArgsDict',
    'SparkClusterRolesArgs',
    'SparkClusterRolesArgsDict',
    'SparkClusterRolesHeadNodeArgs',
    'SparkClusterRolesHeadNodeArgsDict',
    'SparkClusterRolesHeadNodeScriptActionArgs',
    'SparkClusterRolesHeadNodeScriptActionArgsDict',
    'SparkClusterRolesWorkerNodeArgs',
    'SparkClusterRolesWorkerNodeArgsDict',
    'SparkClusterRolesWorkerNodeAutoscaleArgs',
    'SparkClusterRolesWorkerNodeAutoscaleArgsDict',
    'SparkClusterRolesWorkerNodeAutoscaleCapacityArgs',
    'SparkClusterRolesWorkerNodeAutoscaleCapacityArgsDict',
    'SparkClusterRolesWorkerNodeAutoscaleRecurrenceArgs',
    'SparkClusterRolesWorkerNodeAutoscaleRecurrenceArgsDict',
    'SparkClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs',
    'SparkClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgsDict',
    'SparkClusterRolesWorkerNodeScriptActionArgs',
    'SparkClusterRolesWorkerNodeScriptActionArgsDict',
    'SparkClusterRolesZookeeperNodeArgs',
    'SparkClusterRolesZookeeperNodeArgsDict',
    'SparkClusterRolesZookeeperNodeScriptActionArgs',
    'SparkClusterRolesZookeeperNodeScriptActionArgsDict',
    'SparkClusterSecurityProfileArgs',
    'SparkClusterSecurityProfileArgsDict',
    'SparkClusterStorageAccountArgs',
    'SparkClusterStorageAccountArgsDict',
...
if not MYPY:
    class HBaseClusterComponentVersionArgsDict(TypedDict):
        hbase: pulumi.Input[builtins.str]
        """
...
class HBaseClusterComponentVersionArgs:
    def __init__(__self__, *,
                 hbase: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] hbase: The version of HBase which should be used for this HDInsight HBase Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "hbase", hbase)

    @property
    @pulumi.getter
    def hbase(self) -> pulumi.Input[builtins.str]:
        """
        The version of HBase which should be used for this HDInsight HBase Cluster. Changing this forces a new resource to be created.
        """
    ...
    @hbase.setter
    def hbase(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "hbase", value)


if not MYPY:
    class HBaseClusterComputeIsolationArgsDict(TypedDict):
        compute_isolation_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class HBaseClusterComputeIsolationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] compute_isolation_enabled: This field indicates whether enable compute isolation or not. Possible values are `true` or `false`.
        :param pulumi.Input[builtins.str] host_sku: The name of the host SKU.
        """
...
if not MYPY:
    class HBaseClusterDiskEncryptionArgsDict(TypedDict):
        ...
        """
        key_vault_managed_identity_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class HBaseClusterDiskEncryptionArgs:
    def __init__(__self__, *,
                 ...
                 key_vault_managed_identity_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] encryption_algorithm: This is an algorithm identifier for encryption. Possible values are `RSA1_5`, `RSA-OAEP`, `RSA-OAEP-256`.
        :param pulumi.Input[builtins.bool] encryption_at_host_enabled: This is indicator to show whether resource disk encryption is enabled.
        :param pulumi.Input[builtins.str] key_vault_key_id: The ID of the key vault key.
        :param pulumi.Input[builtins.str] key_vault_managed_identity_id: This is the resource ID of Managed Identity used to access the key vault.
        """
    ...
    def key_vault_managed_identity_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This is the resource ID of Managed Identity used to access the key vault.
        """
    ...
    def key_vault_managed_identity_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HBaseClusterExtensionArgs:
    def __init__(__self__, *,
                 ...
                 primary_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The workspace ID of the log analytics extension.
        :param pulumi.Input[builtins.str] primary_key: The workspace key of the log analytics extension.
        """
...
class HBaseClusterGatewayArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] password: The password used for the Ambari Portal.
               
               > **Note:** This password must be different from the one used for the `head_node`, `worker_node` and `zookeeper_node` roles.
        :param pulumi.Input[builtins.str] username: The username used for the Ambari Portal. Changing this forces a new resource to be created.
        """
...
class HBaseClusterMetastoresAmbariArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] database_name: The external Hive metastore's existing SQL database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The external Ambari metastore's existing SQL server admin password. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] server: The fully-qualified domain name (FQDN) of the SQL server to use for the external Ambari metastore. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] username: The external Ambari metastore's existing SQL server admin username. Changing this forces a new resource to be created.
        """
...
class HBaseClusterMetastoresHiveArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] database_name: The external Hive metastore's existing SQL database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The external Hive metastore's existing SQL server admin password. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] server: The fully-qualified domain name (FQDN) of the SQL server to use for the external Hive metastore. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] username: The external Hive metastore's existing SQL server admin username. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "server", server)
...
class HBaseClusterMetastoresOozieArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] database_name: The external Oozie metastore's existing SQL database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The external Oozie metastore's existing SQL server admin password. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] server: The fully-qualified domain name (FQDN) of the SQL server to use for the external Oozie metastore. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] username: The external Oozie metastore's existing SQL server admin username. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "server", server)
...
class HBaseClusterMonitorArgs:
    def __init__(__self__, *,
                 ...
                 primary_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The Operations Management Suite (OMS) workspace ID.
        :param pulumi.Input[builtins.str] primary_key: The Operations Management Suite (OMS) workspace key.
        """
        pulumi.set(__self__, "log_analytics_workspace_id", log_analytics_workspace_id)
        pulumi.set(__self__, "primary_key", primary_key)
...
if not MYPY:
    class HBaseClusterNetworkArgsDict(TypedDict):
        connection_direction: NotRequired[pulumi.Input[builtins.str]]
        """
        The direction of the resource provider connection. Possible values include `Inbound` or `Outbound`. Defaults to `Inbound`. Changing this forces a new resource to be created.

        > **Note:** To enable the private link the `connection_direction` must be set to `Outbound`.
        """
        private_link_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class HBaseClusterNetworkArgs:
    def __init__(__self__, *,
                 connection_direction: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] connection_direction: The direction of the resource provider connection. Possible values include `Inbound` or `Outbound`. Defaults to `Inbound`. Changing this forces a new resource to be created.
               
               > **Note:** To enable the private link the `connection_direction` must be set to `Outbound`.
        :param pulumi.Input[builtins.bool] private_link_enabled: Is the private link enabled? Possible values include `true` or `false`. Defaults to `false`. Changing this forces a new resource to be created.
        """
    ...
    def connection_direction(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The direction of the resource provider connection. Possible values include `Inbound` or `Outbound`. Defaults to `Inbound`. Changing this forces a new resource to be created.
    ...
    def connection_direction(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HBaseClusterPrivateLinkConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] group_id: The ID of the private link service group.
...
class HBaseClusterPrivateLinkConfigurationIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] primary: Indicates whether this IP configuration is primary.
        :param pulumi.Input[builtins.str] private_ip_address: The private IP address of the IP configuration.
        :param pulumi.Input[builtins.str] private_ip_allocation_method: The private IP allocation method. The only possible value now is `Dynamic`.
        """
        pulumi.set(__self__, "name", name)
...
class HBaseClusterRolesHeadNodeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] username: The Username of the local administrator for the Head Nodes. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vm_size: The Size of the Virtual Machine which should be used as the Head Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_E96a_V4`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Head Nodes. Changing this forces a new resource to be created.
               
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['HBaseClusterRolesHeadNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Head Nodes. Changing this forces a new resource to be created.
               
               > **Note:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet within the Virtual Network where the Head Nodes should be provisioned within. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] virtual_network_id: The ID of the Virtual Network where the Head Nodes should be provisioned within. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "username", username)
...
if not MYPY:
    class HBaseClusterRolesWorkerNodeArgsDict(TypedDict):
        target_instance_count: pulumi.Input[builtins.int]
        """
...
class HBaseClusterRolesWorkerNodeArgs:
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] target_instance_count: The number of instances which should be run for the Worker Nodes.
        :param pulumi.Input[builtins.str] username: The Username of the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vm_size: The Size of the Virtual Machine which should be used as the Worker Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param pulumi.Input['HBaseClusterRolesWorkerNodeAutoscaleArgs'] autoscale: A `autoscale` block as defined below.
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
               
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['HBaseClusterRolesWorkerNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Worker Nodes. Changing this forces a new resource to be created.
               
               > **Note:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet within the Virtual Network where the Worker Nodes should be provisioned within. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] virtual_network_id: The ID of the Virtual Network where the Worker Nodes should be provisioned within. Changing this forces a new resource to be created.
        """
    ...
    def target_instance_count(self) -> pulumi.Input[builtins.int]:
        """
        The number of instances which should be run for the Worker Nodes.
        """
    ...
    def target_instance_count(self, value: pulumi.Input[builtins.int]):
...
class HBaseClusterRolesWorkerNodeAutoscaleRecurrenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] timezone: The time zone for the autoscale schedule times.
        """
...
class HBaseClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs:
    def __init__(__self__, *,
                 ...
                 time: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days: The days of the week to perform autoscale. Possible values are `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`.
        :param pulumi.Input[builtins.int] target_instance_count: The number of worker nodes to autoscale at the specified time.
        :param pulumi.Input[builtins.str] time: The time of day to perform the autoscale in 24hour format.
        """
...
class HBaseClusterRolesZookeeperNodeArgs:
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] username: The Username of the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vm_size: The Size of the Virtual Machine which should be used as the Zookeeper Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
               
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['HBaseClusterRolesZookeeperNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Zookeeper Nodes. Changing this forces a new resource to be created.
               
               > **Note:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet within the Virtual Network where the Zookeeper Nodes should be provisioned within. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] virtual_network_id: The ID of the Virtual Network where the Zookeeper Nodes should be provisioned within. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "username", username)
        pulumi.set(__self__, "vm_size", vm_size)
        if password is not None:
...
if not MYPY:
    class HBaseClusterSecurityProfileArgsDict(TypedDict):
        aadds_resource_id: pulumi.Input[builtins.str]
        """
...
class HBaseClusterSecurityProfileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] aadds_resource_id: The resource ID of the Azure Active Directory Domain Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] domain_name: The name of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] domain_user_password: The user password of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] domain_username: The username of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ldaps_urls: A list of the LDAPS URLs to communicate with the Azure Active Directory. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] msi_resource_id: The User Assigned Identity for the HDInsight Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cluster_users_group_dns: A list of the distinguished names for the cluster user groups. Changing this forces a new resource to be created.
        """
    ...
    def aadds_resource_id(self) -> pulumi.Input[builtins.str]:
        """
        The resource ID of the Azure Active Directory Domain Service. Changing this forces a new resource to be created.
        """
    ...
    def aadds_resource_id(self, value: pulumi.Input[builtins.str]):
    ...
    def domain_user_password(self) -> pulumi.Input[builtins.str]:
        """
        The user password of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        """
    ...
    def domain_user_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "domain_user_password", value)

    @property
    @pulumi.getter(name="domainUsername")
    def domain_username(self) -> pulumi.Input[builtins.str]:
        """
        The username of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        """
    ...
    def domain_username(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "domain_username", value)

    @property
    @pulumi.getter(name="ldapsUrls")
    def ldaps_urls(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of the LDAPS URLs to communicate with the Azure Active Directory. Changing this forces a new resource to be created.
        """
    ...
    @ldaps_urls.setter
    def ldaps_urls(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class HBaseClusterStorageAccountArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] is_default: Is this the Default Storage Account for the HDInsight Hadoop Cluster? Changing this forces a new resource to be created.
               
               > **Note:** One of the `storage_account` or `storage_account_gen2` blocks must be marked as the default.
        :param pulumi.Input[builtins.str] storage_account_key: The Access Key which should be used to connect to the Storage Account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_container_id: The ID of the Storage Container. Changing this forces a new resource to be created.
               
               > **Note:** When the `storage.Container` resource is created with `storage_account_name`, this can be obtained from the `id` of the `storage.Container` resource. When the `storage.Container` resource is created with `storage_account_id`, please use `storage_get_containers` data source to get the `data_plane_id` of the `storage.Container` resource for this field.
        :param pulumi.Input[builtins.str] storage_resource_id: The ID of the Storage Account. Changing this forces a new resource to be created.
        """
...
class HBaseClusterStorageAccountGen2Args:
    def __init__(__self__, *,
                 ...
                 storage_resource_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] filesystem_id: The ID of the Gen2 Filesystem. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] is_default: Is this the Default Storage Account for the HDInsight Hadoop Cluster? Changing this forces a new resource to be created.
               
               > **Note:** One of the `storage_account` or `storage_account_gen2` blocks must be marked as the default.
        :param pulumi.Input[builtins.str] managed_identity_resource_id: The ID of Managed Identity to use for accessing the Gen2 filesystem. Changing this forces a new resource to be created.
...
if not MYPY:
    class HadoopClusterComponentVersionArgsDict(TypedDict):
        hadoop: pulumi.Input[builtins.str]
        """
...
class HadoopClusterComponentVersionArgs:
    def __init__(__self__, *,
                 hadoop: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] hadoop: The version of Hadoop which should be used for this HDInsight Hadoop Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "hadoop", hadoop)

    @property
    @pulumi.getter
    def hadoop(self) -> pulumi.Input[builtins.str]:
        """
        The version of Hadoop which should be used for this HDInsight Hadoop Cluster. Changing this forces a new resource to be created.
        """
    ...
    @hadoop.setter
    def hadoop(self, value: pulumi.Input[builtins.str]):
...
class HadoopClusterRolesEdgeNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] target_instance_count: The number of instances which should be run for the Worker Nodes.
        :param pulumi.Input[builtins.str] vm_size: The Size of the Virtual Machine which should be used as the Edge Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`.
...
class HadoopClusterRolesEdgeNodeHttpsEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] access_modes: A list of access modes for the application.
        :param pulumi.Input[builtins.int] destination_port: The destination port to connect to.
        :param pulumi.Input[builtins.bool] disable_gateway_auth: The value indicates whether the gateway authentication is enabled or not.
        :param pulumi.Input[builtins.str] private_ip_address: The private ip address of the endpoint.
        :param pulumi.Input[builtins.str] sub_domain_suffix: The application's subdomain suffix.
        """
...
class HadoopClusterRolesEdgeNodeInstallScriptActionArgs:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the install script action.
        :param pulumi.Input[builtins.str] uri: The URI pointing to the script to run during the installation of the edge node.
...
class HadoopClusterRolesEdgeNodeUninstallScriptActionArgs:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the uninstall script action.
        :param pulumi.Input[builtins.str] uri: The URI pointing to the script to run during the installation of the edge node.
        :param pulumi.Input[builtins.str] parameters: The parameters for the script.
        """
        pulumi.set(__self__, "name", name)
...
class HadoopClusterRolesHeadNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Head Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['HadoopClusterRolesHeadNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Head Nodes. Changing this forces a new resource to be created.
...
class HadoopClusterRolesWorkerNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['HadoopClusterRolesWorkerNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Worker Nodes. Changing this forces a new resource to be created.
...
class HadoopClusterRolesWorkerNodeAutoscaleCapacityArgs:
    def __init__(__self__, *,
                 ...
                 min_instance_count: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_instance_count: The maximum number of worker nodes to autoscale to based on the cluster's activity.
        :param pulumi.Input[builtins.int] min_instance_count: The minimum number of worker nodes to autoscale to based on the cluster's activity.
        """
...
class HadoopClusterRolesZookeeperNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['HadoopClusterRolesZookeeperNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Zookeeper Nodes. Changing this forces a new resource to be created.
...
if not MYPY:
    class InteractiveQueryClusterComponentVersionArgsDict(TypedDict):
        interactive_hive: pulumi.Input[builtins.str]
        """
...
class InteractiveQueryClusterComponentVersionArgs:
    def __init__(__self__, *,
                 interactive_hive: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] interactive_hive: The version of Interactive Query which should be used for this HDInsight Interactive Query Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "interactive_hive", interactive_hive)

    @property
    @pulumi.getter(name="interactiveHive")
    def interactive_hive(self) -> pulumi.Input[builtins.str]:
        """
        The version of Interactive Query which should be used for this HDInsight Interactive Query Cluster. Changing this forces a new resource to be created.
        """
    ...
    def interactive_hive(self, value: pulumi.Input[builtins.str]):
...
class InteractiveQueryClusterRolesHeadNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Head Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['InteractiveQueryClusterRolesHeadNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Head Nodes. Changing this forces a new resource to be created.
...
class InteractiveQueryClusterRolesWorkerNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['InteractiveQueryClusterRolesWorkerNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Worker Nodes. Changing this forces a new resource to be created.
...
class InteractiveQueryClusterRolesZookeeperNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['InteractiveQueryClusterRolesZookeeperNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Zookeeper Nodes. Changing this forces a new resource to be created.
...
if not MYPY:
    class KafkaClusterComponentVersionArgsDict(TypedDict):
        kafka: pulumi.Input[builtins.str]
        """
...
class KafkaClusterComponentVersionArgs:
    def __init__(__self__, *,
                 kafka: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kafka: The version of Kafka which should be used for this HDInsight Kafka Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "kafka", kafka)

    @property
    @pulumi.getter
    def kafka(self) -> pulumi.Input[builtins.str]:
        """
        The version of Kafka which should be used for this HDInsight Kafka Cluster. Changing this forces a new resource to be created.
        """
    ...
    @kafka.setter
    def kafka(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class KafkaClusterRestProxyArgsDict(TypedDict):
        ...
        """
        security_group_name: pulumi.Input[builtins.str]
        """
...
class KafkaClusterRestProxyArgs:
    def __init__(__self__, *,
                 ...
                 security_group_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] security_group_id: The Azure Active Directory Security Group ID. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] security_group_name: The Azure Active Directory Security Group name. Changing this forces a new resource to be created.
    ...
    def security_group_name(self) -> pulumi.Input[builtins.str]:
        """
        The Azure Active Directory Security Group name. Changing this forces a new resource to be created.
    ...
    def security_group_name(self, value: pulumi.Input[builtins.str]):
...
class KafkaClusterRolesHeadNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Head Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['KafkaClusterRolesHeadNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Head Nodes. Changing this forces a new resource to be created.
...
class KafkaClusterRolesKafkaManagementNodeArgs:
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] vm_size: The Size of the Virtual Machine which should be used as the Kafka Management Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Kafka Management Nodes. Changing this forces a new resource to be created.
               
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['KafkaClusterRolesKafkaManagementNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Kafka Management Nodes. Changing this forces a new resource to be created.
               
               > **Note:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet within the Virtual Network where the Kafka Management Nodes should be provisioned within. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] username: The Username of the local administrator for the Kafka Management Nodes.
               
               > **Note:** The `username` value is automatically generated by the service and cannot be user specified. This property will become `Computed` only in 4.0 of the provider.
        :param pulumi.Input[builtins.str] virtual_network_id: The ID of the Virtual Network where the Kafka Management Nodes should be provisioned within. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "vm_size", vm_size)
        if password is not None:
            pulumi.set(__self__, "password", password)
...
if not MYPY:
    class KafkaClusterRolesWorkerNodeArgsDict(TypedDict):
        number_of_disks_per_node: pulumi.Input[builtins.int]
        """
...
class KafkaClusterRolesWorkerNodeArgs:
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] number_of_disks_per_node: The number of Data Disks which should be assigned to each Worker Node, which can be between 1 and 8. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] target_instance_count: The number of instances which should be run for the Worker Nodes.
        :param pulumi.Input[builtins.str] username: The Username of the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vm_size: The Size of the Virtual Machine which should be used as the Worker Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['KafkaClusterRolesWorkerNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Worker Nodes. Changing this forces a new resource to be created.
    ...
    def number_of_disks_per_node(self) -> pulumi.Input[builtins.int]:
        """
        The number of Data Disks which should be assigned to each Worker Node, which can be between 1 and 8. Changing this forces a new resource to be created.
        """
    ...
    def number_of_disks_per_node(self, value: pulumi.Input[builtins.int]):
...
class KafkaClusterRolesZookeeperNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['KafkaClusterRolesZookeeperNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Zookeeper Nodes. Changing this forces a new resource to be created.
...
if not MYPY:
    class SparkClusterComponentVersionArgsDict(TypedDict):
        spark: pulumi.Input[builtins.str]
        """
...
class SparkClusterComponentVersionArgs:
    def __init__(__self__, *,
                 spark: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] spark: The version of Spark which should be used for this HDInsight Spark Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "spark", spark)

    @property
    @pulumi.getter
    def spark(self) -> pulumi.Input[builtins.str]:
        """
        The version of Spark which should be used for this HDInsight Spark Cluster. Changing this forces a new resource to be created.
        """
    ...
    @spark.setter
    def spark(self, value: pulumi.Input[builtins.str]):
...
class SparkClusterRolesHeadNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Head Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['SparkClusterRolesHeadNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Head Nodes. Changing this forces a new resource to be created.
...
class SparkClusterRolesWorkerNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['SparkClusterRolesWorkerNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Worker Nodes. Changing this forces a new resource to be created.
...
class SparkClusterRolesZookeeperNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
               ...
               > **Note:** If specified, this password must be at least 10 characters in length and must contain at least one digit, one uppercase and one lower case letter, one non-alphanumeric character (except characters ' " ` \\).
        :param pulumi.Input[Sequence[pulumi.Input['SparkClusterRolesZookeeperNodeScriptActionArgs']]] script_actions: The script action which will run on the cluster. One or more `script_actions` blocks as defined above. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Zookeeper Nodes. Changing this forces a new resource to be created.
