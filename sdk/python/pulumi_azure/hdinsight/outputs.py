...
class HBaseClusterComponentVersion(dict):
    def __init__(__self__, *,
                 hbase: _builtins.str):
        """
        :param _builtins.str hbase: The version of HBase which should be used for this HDInsight HBase Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "hbase", hbase)

    @_builtins.property
    @pulumi.getter
    def hbase(self) -> _builtins.str:
        """
...
class HBaseClusterComputeIsolation(dict):
    ...
    def __init__(__self__, *,
                 compute_isolation_enabled: Optional[_builtins.bool] = None,
                 host_sku: Optional[_builtins.str] = None):
        """
        :param _builtins.bool compute_isolation_enabled: This field indicates whether enable compute isolation or not. Possible values are `true` or `false`.
        :param _builtins.str host_sku: The name of the host SKU.
        """
    ...
    def compute_isolation_enabled(self) -> Optional[_builtins.bool]:
        """
...
class HBaseClusterDiskEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_vault_managed_identity_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str encryption_algorithm: This is an algorithm identifier for encryption. Possible values are `RSA1_5`, `RSA-OAEP`, `RSA-OAEP-256`.
        :param _builtins.bool encryption_at_host_enabled: This is indicator to show whether resource disk encryption is enabled.
        :param _builtins.str key_vault_key_id: The ID of the key vault key.
        :param _builtins.str key_vault_managed_identity_id: This is the resource ID of Managed Identity used to access the key vault.
        """
    ...
    def key_vault_managed_identity_id(self) -> Optional[_builtins.str]:
        """
...
class HBaseClusterExtension(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str log_analytics_workspace_id: The workspace ID of the log analytics extension.
        :param _builtins.str primary_key: The workspace key of the log analytics extension.
        """
...
class HBaseClusterGateway(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str password: The password used for the Ambari Portal.
               
               > **Note:** This password must be different from the one used for the `head_node`, `worker_node` and `zookeeper_node` roles.
        :param _builtins.str username: The username used for the Ambari Portal. Changing this forces a new resource to be created.
        """
...
class HBaseClusterMetastoresAmbari(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username: _builtins.str):
        """
        :param _builtins.str database_name: The external Hive metastore's existing SQL database. Changing this forces a new resource to be created.
        :param _builtins.str password: The external Ambari metastore's existing SQL server admin password. Changing this forces a new resource to be created.
        :param _builtins.str server: The fully-qualified domain name (FQDN) of the SQL server to use for the external Ambari metastore. Changing this forces a new resource to be created.
        :param _builtins.str username: The external Ambari metastore's existing SQL server admin username. Changing this forces a new resource to be created.
        """
...
class HBaseClusterMetastoresHive(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str database_name: The external Hive metastore's existing SQL database. Changing this forces a new resource to be created.
        :param _builtins.str password: The external Hive metastore's existing SQL server admin password. Changing this forces a new resource to be created.
        :param _builtins.str server: The fully-qualified domain name (FQDN) of the SQL server to use for the external Hive metastore. Changing this forces a new resource to be created.
        :param _builtins.str username: The external Hive metastore's existing SQL server admin username. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "server", server)
...
class HBaseClusterMetastoresOozie(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username: _builtins.str):
        """
        :param _builtins.str database_name: The external Oozie metastore's existing SQL database. Changing this forces a new resource to be created.
        :param _builtins.str password: The external Oozie metastore's existing SQL server admin password. Changing this forces a new resource to be created.
        :param _builtins.str server: The fully-qualified domain name (FQDN) of the SQL server to use for the external Oozie metastore. Changing this forces a new resource to be created.
        :param _builtins.str username: The external Oozie metastore's existing SQL server admin username. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "server", server)
...
class HBaseClusterMonitor(dict):
    ...
    def __init__(__self__, *,
                 ...
                 primary_key: _builtins.str):
        """
        :param _builtins.str log_analytics_workspace_id: The Operations Management Suite (OMS) workspace ID.
        :param _builtins.str primary_key: The Operations Management Suite (OMS) workspace key.
        """
        pulumi.set(__self__, "log_analytics_workspace_id", log_analytics_workspace_id)
        pulumi.set(__self__, "primary_key", primary_key)
...
class HBaseClusterNetwork(dict):
    ...
    def __init__(__self__, *,
                 connection_direction: Optional[_builtins.str] = None,
                 private_link_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.str connection_direction: The direction of the resource provider connection. Possible values include `Inbound` or `Outbound`. Defaults to `Inbound`. Changing this forces a new resource to be created.
               
               > **Note:** To enable the private link the `connection_direction` must be set to `Outbound`.
        :param _builtins.bool private_link_enabled: Is the private link enabled? Possible values include `true` or `false`. Defaults to `false`. Changing this forces a new resource to be created.
        """
    ...
    def connection_direction(self) -> Optional[_builtins.str]:
        """
    ...
    def private_link_enabled(self) -> Optional[_builtins.bool]:
        """
...
class HBaseClusterRolesHeadNode(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Head Nodes. Changing this forces a new resource to be created.
               
               > **Note:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
        :param _builtins.str subnet_id: The ID of the Subnet within the Virtual Network where the Head Nodes should be provisioned within. Changing this forces a new resource to be created.
        :param _builtins.str virtual_network_id: The ID of the Virtual Network where the Head Nodes should be provisioned within. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "username", username)
...
class HBaseClusterRolesWorkerNode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[_builtins.str] = None):
        """
        :param _builtins.int target_instance_count: The number of instances which should be run for the Worker Nodes.
        :param _builtins.str username: The Username of the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
        :param _builtins.str vm_size: The Size of the Virtual Machine which should be used as the Worker Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param 'HBaseClusterRolesWorkerNodeAutoscaleArgs' autoscale: A `autoscale` block as defined below.
        :param _builtins.str password: The Password associated with the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
        ...
        :param Sequence[_builtins.str] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Worker Nodes. Changing this forces a new resource to be created.
               
               > **Note:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
        :param _builtins.str subnet_id: The ID of the Subnet within the Virtual Network where the Worker Nodes should be provisioned within. Changing this forces a new resource to be created.
        :param _builtins.str virtual_network_id: The ID of the Virtual Network where the Worker Nodes should be provisioned within. Changing this forces a new resource to be created.
        """
...
class HBaseClusterRolesWorkerNodeAutoscaleRecurrence(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str timezone: The time zone for the autoscale schedule times.
        """
...
class HBaseClusterRolesWorkerNodeAutoscaleRecurrenceSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time: _builtins.str):
        """
        :param Sequence[_builtins.str] days: The days of the week to perform autoscale. Possible values are `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`.
        :param _builtins.int target_instance_count: The number of worker nodes to autoscale at the specified time.
        :param _builtins.str time: The time of day to perform the autoscale in 24hour format.
        """
...
class HBaseClusterRolesZookeeperNode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str username: The Username of the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
        :param _builtins.str vm_size: The Size of the Virtual Machine which should be used as the Zookeeper Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param _builtins.str password: The Password associated with the local administrator for the Zookeeper Nodes. Changing this forces a new resource to be created.
        ...
        :param Sequence[_builtins.str] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Zookeeper Nodes. Changing this forces a new resource to be created.
               
               > **Note:** Either a `password` or one or more `ssh_keys` must be specified - but not both.
        :param _builtins.str subnet_id: The ID of the Subnet within the Virtual Network where the Zookeeper Nodes should be provisioned within. Changing this forces a new resource to be created.
        :param _builtins.str virtual_network_id: The ID of the Virtual Network where the Zookeeper Nodes should be provisioned within. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "username", username)
        pulumi.set(__self__, "vm_size", vm_size)
        if password is not None:
...
class HBaseClusterSecurityProfile(dict):
    ...
    def __init__(__self__, *,
                 aadds_resource_id: _builtins.str,
                 domain_name: _builtins.str,
                 domain_user_password: _builtins.str,
                 domain_username: _builtins.str,
                 ldaps_urls: Sequence[_builtins.str],
                 msi_resource_id: _builtins.str,
                 cluster_users_group_dns: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str aadds_resource_id: The resource ID of the Azure Active Directory Domain Service. Changing this forces a new resource to be created.
        :param _builtins.str domain_name: The name of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        :param _builtins.str domain_user_password: The user password of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        :param _builtins.str domain_username: The username of the Azure Active Directory Domain. Changing this forces a new resource to be created.
        :param Sequence[_builtins.str] ldaps_urls: A list of the LDAPS URLs to communicate with the Azure Active Directory. Changing this forces a new resource to be created.
        :param _builtins.str msi_resource_id: The User Assigned Identity for the HDInsight Cluster. Changing this forces a new resource to be created.
        :param Sequence[_builtins.str] cluster_users_group_dns: A list of the distinguished names for the cluster user groups. Changing this forces a new resource to be created.
        """
    ...
    def aadds_resource_id(self) -> _builtins.str:
        """
    ...
    def domain_user_password(self) -> _builtins.str:
        """
    ...
    def ldaps_urls(self) -> Sequence[_builtins.str]:
        """
    ...
    def msi_resource_id(self) -> _builtins.str:
        """
...
class HBaseClusterStorageAccount(dict):
    ...
    def storage_account_key(self) -> _builtins.str:
        """
...
class HadoopClusterComponentVersion(dict):
    def __init__(__self__, *,
                 hadoop: _builtins.str):
        """
        :param _builtins.str hadoop: The version of Hadoop which should be used for this HDInsight Hadoop Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "hadoop", hadoop)

    @_builtins.property
    @pulumi.getter
    def hadoop(self) -> _builtins.str:
        """
...
class HadoopClusterRolesEdgeNode(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int target_instance_count: The number of instances which should be run for the Worker Nodes.
        :param _builtins.str vm_size: The Size of the Virtual Machine which should be used as the Edge Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`.
...
class HadoopClusterRolesEdgeNodeHttpsEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_ip_address: Optional[_builtins.str] = None,
                 sub_domain_suffix: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] access_modes: A list of access modes for the application.
        :param _builtins.int destination_port: The destination port to connect to.
        :param _builtins.bool disable_gateway_auth: The value indicates whether the gateway authentication is enabled or not.
        :param _builtins.str private_ip_address: The private ip address of the endpoint.
        :param _builtins.str sub_domain_suffix: The application's subdomain suffix.
        """
    ...
    def sub_domain_suffix(self) -> Optional[_builtins.str]:
        """
...
class HadoopClusterRolesEdgeNodeInstallScriptAction(dict):
    def __init__(__self__, *,
                 ...
                 parameters: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name of the install script action.
        :param _builtins.str uri: The URI pointing to the script to run during the installation of the edge node.
...
class HadoopClusterRolesEdgeNodeUninstallScriptAction(dict):
    def __init__(__self__, *,
                 ...
                 parameters: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name of the uninstall script action.
        :param _builtins.str uri: The URI pointing to the script to run during the installation of the edge node.
        :param _builtins.str parameters: The parameters for the script.
        """
        pulumi.set(__self__, "name", name)
...
class HadoopClusterRolesWorkerNodeAutoscaleCapacity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int max_instance_count: The maximum number of worker nodes to autoscale to based on the cluster's activity.
        :param _builtins.int min_instance_count: The minimum number of worker nodes to autoscale to based on the cluster's activity.
        """
...
class InteractiveQueryClusterComponentVersion(dict):
    ...
    def __init__(__self__, *,
                 interactive_hive: _builtins.str):
        """
        :param _builtins.str interactive_hive: The version of Interactive Query which should be used for this HDInsight Interactive Query Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "interactive_hive", interactive_hive)

    @_builtins.property
    @pulumi.getter(name="interactiveHive")
    def interactive_hive(self) -> _builtins.str:
        """
...
class KafkaClusterComponentVersion(dict):
    def __init__(__self__, *,
                 kafka: _builtins.str):
        """
        :param _builtins.str kafka: The version of Kafka which should be used for this HDInsight Kafka Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "kafka", kafka)

    @_builtins.property
    @pulumi.getter
    def kafka(self) -> _builtins.str:
        """
...
class KafkaClusterRestProxy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str security_group_id: The Azure Active Directory Security Group ID. Changing this forces a new resource to be created.
        :param _builtins.str security_group_name: The Azure Active Directory Security Group name. Changing this forces a new resource to be created.
...
class KafkaClusterRolesKafkaManagementNode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str vm_size: The Size of the Virtual Machine which should be used as the Kafka Management Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param _builtins.str password: The Password associated with the local administrator for the Kafka Management Nodes. Changing this forces a new resource to be created.
        ...
        :param Sequence[_builtins.str] ssh_keys: A list of SSH Keys which should be used for the local administrator on the Kafka Management Nodes. Changing this forces a new resource to be created.
...
class KafkaClusterRolesWorkerNode(dict):
    ...
    def __init__(__self__, *,
                 number_of_disks_per_node: _builtins.int,
                 target_instance_count: _builtins.int,
                 username: _builtins.str,
                 vm_size: _builtins.str,
                 password: Optional[_builtins.str] = None,
                 ...
                 virtual_network_id: Optional[_builtins.str] = None):
        """
        :param _builtins.int number_of_disks_per_node: The number of Data Disks which should be assigned to each Worker Node, which can be between 1 and 8. Changing this forces a new resource to be created.
        :param _builtins.int target_instance_count: The number of instances which should be run for the Worker Nodes.
        :param _builtins.str username: The Username of the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
        :param _builtins.str vm_size: The Size of the Virtual Machine which should be used as the Worker Nodes. Possible values are `ExtraSmall`, `Small`, `Medium`, `Large`, `ExtraLarge`, `A5`, `A6`, `A7`, `A8`, `A9`, `A10`, `A11`, `Standard_A1_V2`, `Standard_A2_V2`, `Standard_A2m_V2`, `Standard_A3`, `Standard_A4_V2`, `Standard_A4m_V2`, `Standard_A8_V2`, `Standard_A8m_V2`, `Standard_D1`, `Standard_D2`, `Standard_D3`, `Standard_D4`, `Standard_D11`, `Standard_D12`, `Standard_D13`, `Standard_D14`, `Standard_D1_V2`, `Standard_D2_V2`, `Standard_D3_V2`, `Standard_D4_V2`, `Standard_D5_V2`, `Standard_D11_V2`, `Standard_D12_V2`, `Standard_D13_V2`, `Standard_D14_V2`, `Standard_DS1_V2`, `Standard_DS2_V2`, `Standard_DS3_V2`, `Standard_DS4_V2`, `Standard_DS5_V2`, `Standard_DS11_V2`, `Standard_DS12_V2`, `Standard_DS13_V2`, `Standard_DS14_V2`, `Standard_E2_V3`, `Standard_E4_V3`, `Standard_E8_V3`, `Standard_E16_V3`, `Standard_E20_V3`, `Standard_E32_V3`, `Standard_E64_V3`, `Standard_E64i_V3`, `Standard_E2s_V3`, `Standard_E4s_V3`, `Standard_E8s_V3`, `Standard_E16s_V3`, `Standard_E20s_V3`, `Standard_E32s_V3`, `Standard_E64s_V3`, `Standard_E64is_V3`, `Standard_D2a_V4`, `Standard_D4a_V4`, `Standard_D8a_V4`, `Standard_D16a_V4`, `Standard_D32a_V4`, `Standard_D48a_V4`, `Standard_D64a_V4`, `Standard_D96a_V4`, `Standard_E2a_V4`, `Standard_E4a_V4`, `Standard_E8a_V4`, `Standard_E16a_V4`, `Standard_E20a_V4`, `Standard_E32a_V4`, `Standard_E48a_V4`, `Standard_E64a_V4`, `Standard_E96a_V4`, `Standard_D2ads_V5`, `Standard_D4ads_V5`, `Standard_D8ads_V5`, `Standard_D16ads_V5`, `Standard_D32ads_V5`, `Standard_D48ads_V5`, `Standard_D64ads_V5`, `Standard_D96ads_V5`, `Standard_E2ads_V5`, `Standard_E4ads_V5`, `Standard_E8ads_V5`, `Standard_E16ads_V5`, `Standard_E20ads_V5`, `Standard_E32ads_V5`, `Standard_E48ads_V5`, `Standard_E64ads_V5`, `Standard_E96ads_V5`, `Standard_G1`, `Standard_G2`, `Standard_G3`, `Standard_G4`, `Standard_G5`, `Standard_F2s_V2`, `Standard_F4s_V2`, `Standard_F8s_V2`, `Standard_F16s_V2`, `Standard_F32s_V2`, `Standard_F64s_V2`, `Standard_F72s_V2`, `Standard_GS1`, `Standard_GS2`, `Standard_GS3`, `Standard_GS4`, `Standard_GS5` and `Standard_NC24`. Changing this forces a new resource to be created.
        :param _builtins.str password: The Password associated with the local administrator for the Worker Nodes. Changing this forces a new resource to be created.
    ...
    def number_of_disks_per_node(self) -> _builtins.int:
        """
...
class SparkClusterComponentVersion(dict):
    def __init__(__self__, *,
                 spark: _builtins.str):
        """
        :param _builtins.str spark: The version of Spark which should be used for this HDInsight Spark Cluster. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "spark", spark)

    @_builtins.property
    @pulumi.getter
    def spark(self) -> _builtins.str:
        """
...
class GetClusterGatewayResult(dict):
    def __init__(__self__, *,
                 ...
                 username: _builtins.str):
        """
        :param _builtins.bool enabled: Is the Ambari Portal enabled?
        :param _builtins.str password: The password used for the Ambari Portal.
        :param _builtins.str username: The username used for the Ambari Portal.
        """
