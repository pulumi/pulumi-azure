...
class KafkaClusterRolesKafkaManagementNode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtual_network_id: Optional[str] = None):
        """
        :param str username: The Username of the local administrator for the Kafka Management Nodes.
    ...
    @property
    @pulumi.getter
    @_utilities.deprecated("""`username` will become Computed only in version 4.0 of the AzureRM Provider as the service auto-generates a value for this property""")
    def username(self) -> str:
        """
