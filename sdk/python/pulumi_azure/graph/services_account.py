...
__all__ = ['ServicesAccountArgs', 'ServicesAccount']
...
class ServicesAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: Customer owned application ID. Changing this forces a new Account to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group within which this Account should exist. Changing this forces a new Account to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Account. Changing this forces a new Account to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Account.
        """
...
@pulumi.input_type
class _ServicesAccountState:
    def __init__(__self__, *,
                 application_id: Optional[pulumi.Input[builtins.str]] = None,
                 billing_plan_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] application_id: Customer owned application ID. Changing this forces a new Account to be created.
        :param pulumi.Input[builtins.str] billing_plan_id: Billing Plan Id.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Account. Changing this forces a new Account to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group within which this Account should exist. Changing this forces a new Account to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Account.
        """
    ...
    def billing_plan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Billing Plan Id.
        """
    ...
    def billing_plan_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServicesAccount(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ServicesAccountArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ServicesAccountArgs.__new__(ServicesAccountArgs)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ServicesAccount':
        """
        ...
        __props__ = _ServicesAccountState.__new__(_ServicesAccountState)
        ...
        __props__.__dict__["resource_group_name"] = resource_group_name
        __props__.__dict__["tags"] = tags
        return ServicesAccount(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="billingPlanId")
    def billing_plan_id(self) -> pulumi.Output[builtins.str]:
        """
        Billing Plan Id.
        """
        return pulumi.get(self, "billing_plan_id")
