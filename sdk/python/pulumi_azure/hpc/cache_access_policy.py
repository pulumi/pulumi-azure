...
class CacheAccessPolicyArgs:
    def __init__(__self__, *,
                 ...
                 hpc_cache_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] hpc_cache_id: The ID of the HPC Cache that this HPC Cache Access Policy resides in. Changing this forces a new HPC Cache Access Policy to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this HPC Cache Access Policy. Changing this forces a new HPC Cache Access Policy to be created.
        """
    ...
    def hpc_cache_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @hpc_cache_id.setter
    def hpc_cache_id(self, value: pulumi.Input[builtins.str]):
...
class _CacheAccessPolicyState:
    def __init__(__self__, *,
                 ...
                 hpc_cache_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="hpcCacheId")
    def hpc_cache_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the HPC Cache that this HPC Cache Access Policy resides in. Changing this forces a new HPC Cache Access Policy to be created.
        """
        return pulumi.get(self, "hpc_cache_id")
    ...
    @hpc_cache_id.setter
    def hpc_cache_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hpc_cache_id", value)
...
class CacheAccessPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "azure:hpc/cacheAccessPolicy:CacheAccessPolicy"
    ...
    def get(resource_name: str,
            ...
            access_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['CacheAccessPolicyAccessRuleArgs', 'CacheAccessPolicyAccessRuleArgsDict']]]]] = None,
            hpc_cache_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'CacheAccessPolicy':
        """
    ...
    @property
    @pulumi.getter(name="hpcCacheId")
    def hpc_cache_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the HPC Cache that this HPC Cache Access Policy resides in. Changing this forces a new HPC Cache Access Policy to be created.
        """
        return pulumi.get(self, "hpc_cache_id")
