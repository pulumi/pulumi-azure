...
class CacheBlobNfsTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cache_name: The name of the HPC Cache, which the HPC Cache Blob NFS Target will be added to. Changing this forces a new HPC Cache Blob NFS Target to be created.
        :param pulumi.Input[builtins.str] namespace_path: The client-facing file path of the HPC Cache Blob NFS Target.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the HPC Cache Blob NFS Target should exist. Changing this forces a new HPC Cache Blob NFS Target to be created.
        :param pulumi.Input[builtins.str] storage_container_id: The Resource Manager ID of the Storage Container used as the HPC Cache Blob NFS Target. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] usage_model: The type of usage of the HPC Cache Blob NFS Target. Possible values are: `READ_HEAVY_INFREQ`, `READ_HEAVY_CHECK_180`, `READ_ONLY`, `READ_WRITE`, `WRITE_WORKLOAD_15`, `WRITE_AROUND`, `WRITE_WORKLOAD_CHECK_30`, `WRITE_WORKLOAD_CHECK_60` and `WRITE_WORKLOAD_CLOUDWS`.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this HPC Cache Blob NFS Target. Changing this forces a new HPC Cache Blob NFS Target to be created.
...
class CacheBlobNfsTarget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            usage_model: Optional[pulumi.Input[builtins.str]] = None,
            verification_timer_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
            write_back_timer_in_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'CacheBlobNfsTarget':
        """
