...
class CacheNfsTargetArgs:
    def __init__(__self__, *,
                 ...
                 target_host_name: pulumi.Input[builtins.str],
                 usage_model: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 verification_timer_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 write_back_timer_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a CacheNfsTarget resource.
        :param pulumi.Input[builtins.str] cache_name: The name HPC Cache, which the HPC Cache NFS Target will be added to. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which to create the HPC Cache NFS Target. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_host_name: The IP address or fully qualified domain name (FQDN) of the HPC Cache NFS target. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] usage_model: The type of usage of the HPC Cache NFS Target. Possible values are: `READ_HEAVY_INFREQ`, `READ_HEAVY_CHECK_180`, `READ_ONLY`, `READ_WRITE`, `WRITE_WORKLOAD_15`, `WRITE_AROUND`, `WRITE_WORKLOAD_CHECK_30`, `WRITE_WORKLOAD_CHECK_60` and `WRITE_WORKLOAD_CLOUDWS`.
        :param pulumi.Input[builtins.str] name: The name of the HPC Cache NFS Target. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] verification_timer_in_seconds: The amount of time the cache waits before it checks the back-end storage for file updates. Possible values are between `1` and `31536000`.
        :param pulumi.Input[builtins.int] write_back_timer_in_seconds: The amount of time the cache waits after the last file change before it copies the changed file to back-end storage. Possible values are between `1` and `31536000`.
        """
    ...
    def target_host_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_host_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_host_name", value)

    @property
    @pulumi.getter(name="usageModel")
    def usage_model(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @usage_model.setter
    def usage_model(self, value: pulumi.Input[builtins.str]):
    ...
    def verification_timer_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def verification_timer_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "verification_timer_in_seconds", value)

    @property
    @pulumi.getter(name="writeBackTimerInSeconds")
    def write_back_timer_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def write_back_timer_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _CacheNfsTargetState:
    def __init__(__self__, *,
                 ...
                 target_host_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="targetHostName")
    def target_host_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address or fully qualified domain name (FQDN) of the HPC Cache NFS target. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "target_host_name")
    ...
    @target_host_name.setter
    def target_host_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_host_name", value)
...
class CacheNfsTarget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            usage_model: Optional[pulumi.Input[builtins.str]] = None,
            verification_timer_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
            write_back_timer_in_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'CacheNfsTarget':
        """
    ...
    @property
    @pulumi.getter(name="targetHostName")
    def target_host_name(self) -> pulumi.Output[builtins.str]:
        """
        The IP address or fully qualified domain name (FQDN) of the HPC Cache NFS target. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "target_host_name")
    ...
    @property
    @pulumi.getter(name="verificationTimerInSeconds")
    def verification_timer_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The amount of time the cache waits before it checks the back-end storage for file updates. Possible values are between `1` and `31536000`.
        """
        return pulumi.get(self, "verification_timer_in_seconds")
    ...
    @property
    @pulumi.getter(name="writeBackTimerInSeconds")
    def write_back_timer_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The amount of time the cache waits after the last file change before it copies the changed file to back-end storage. Possible values are between `1` and `31536000`.
        """
        return pulumi.get(self, "write_back_timer_in_seconds")
