...
class CacheAccessPolicyAccessRule(dict):
    ...
    def __init__(__self__, *,
                 access: builtins.str,
                 scope: builtins.str,
                 anonymous_gid: Optional[builtins.int] = None,
                 anonymous_uid: Optional[builtins.int] = None,
                 filter: Optional[builtins.str] = None,
                 root_squash_enabled: Optional[builtins.bool] = None,
                 submount_access_enabled: Optional[builtins.bool] = None,
                 suid_enabled: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.bool root_squash_enabled: Whether to enable [root squash](https://docs.microsoft.com/azure/hpc-cache/access-policies#root-squash)?
        :param builtins.bool submount_access_enabled: Whether allow access to subdirectories under the root export?
        :param builtins.bool suid_enabled: Whether [SUID](https://docs.microsoft.com/azure/hpc-cache/access-policies#suid) is allowed?
        """
    ...
    def anonymous_gid(self) -> Optional[builtins.int]:
        """
    ...
    def anonymous_uid(self) -> Optional[builtins.int]:
        """
    ...
    def root_squash_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def submount_access_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def suid_enabled(self) -> Optional[builtins.bool]:
        """
...
class CacheDirectoryActiveDirectory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dns_secondary_ip: Optional[builtins.str] = None):
        """
        :param builtins.str cache_netbios_name: The NetBIOS name to assign to the HPC Cache when it joins the Active Directory domain as a server.
        :param builtins.str dns_primary_ip: The primary DNS IP address used to resolve the Active Directory domain controller's FQDN.
        :param builtins.str domain_name: The fully qualified domain name of the Active Directory domain controller.
        :param builtins.str domain_netbios_name: The Active Directory domain's NetBIOS name.
        :param builtins.str password: The password of the Active Directory domain administrator.
        :param builtins.str username: The username of the Active Directory domain administrator.
        :param builtins.str dns_secondary_ip: The secondary DNS IP address used to resolve the Active Directory domain controller's FQDN.
        """
    ...
    def dns_secondary_ip(self) -> Optional[builtins.str]:
        """
...
class CacheDirectoryFlatFile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str group_file_uri: The URI of the file containing group information (`/etc/group` file format in Unix-like OS).
        :param builtins.str password_file_uri: The URI of the file containing user information (`/etc/passwd` file format in Unix-like OS).
        """
...
class CacheDirectoryLdap(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_validation_uri: Optional[builtins.str] = None,
                 download_certificate_automatically: Optional[builtins.bool] = None,
                 encrypted: Optional[builtins.bool] = None):
        """
        :param builtins.str base_dn: The base distinguished name (DN) for the LDAP domain.
        :param builtins.str server: The FQDN or IP address of the LDAP server.
        :param 'CacheDirectoryLdapBindArgs' bind: A `bind` block as defined above.
        :param builtins.str certificate_validation_uri: The URI of the CA certificate to validate the LDAP secure connection.
        :param builtins.bool download_certificate_automatically: Whether the certificate should be automatically downloaded. This can be set to `true` only when `certificate_validation_uri` is provided.
        :param builtins.bool encrypted: Whether the LDAP connection should be encrypted?
        """
    ...
    def certificate_validation_uri(self) -> Optional[builtins.str]:
        """
    ...
    def download_certificate_automatically(self) -> Optional[builtins.bool]:
        """
...
class CacheDirectoryLdapBind(dict):
    def __init__(__self__, *,
                 ...
                 password: builtins.str):
        """
        :param builtins.str dn: The Bind Distinguished Name (DN) identity to be used in the secure LDAP connection.
        :param builtins.str password: The Bind password to be used in the secure LDAP connection.
        """
...
class CacheDns(dict):
    ...
    def __init__(__self__, *,
                 ...
                 search_domain: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] servers: A list of DNS servers for the HPC Cache. At most three IP(s) are allowed to set.
        :param builtins.str search_domain: The DNS search domain for the HPC Cache.
        """
    ...
    def search_domain(self) -> Optional[builtins.str]:
        """
...
class CacheNfsTargetNamespaceJunction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 access_policy_name: Optional[builtins.str] = None,
                 target_path: Optional[builtins.str] = None):
        """
        :param builtins.str namespace_path: The client-facing file path of this NFS target within the HPC Cache NFS Target.
        :param builtins.str nfs_export: The NFS export of this NFS target within the HPC Cache NFS Target.
        :param builtins.str access_policy_name: The name of the access policy applied to this target. Defaults to `default`.
        :param builtins.str target_path: The relative subdirectory path from the `nfs_export` to map to the `namespace_path`. Defaults to `""`, in which case the whole `nfs_export` is exported.
        """
    ...
    def access_policy_name(self) -> Optional[builtins.str]:
        """
