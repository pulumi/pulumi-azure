...
class CacheAccessPolicyAccessRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] scope: The scope of this rule. The `scope` and (potentially) the `filter` determine which clients match the rule. Possible values are: `default`, `network`, `host`.
               ...
               > **Note:** Each `access_rule` should set a unique `scope`.
        :param pulumi.Input[_builtins.int] anonymous_gid: The anonymous GID used when `root_squash_enabled` is `true`.
        :param pulumi.Input[_builtins.int] anonymous_uid: The anonymous UID used when `root_squash_enabled` is `true`.
        :param pulumi.Input[_builtins.str] filter: The filter applied to the `scope` for this rule. The filter's format depends on its scope: `default` scope matches all clients and has no filter value; `network` scope takes a CIDR format; `host` takes an IP address or fully qualified domain name. If a client does not match any filter rule and there is no default rule, access is denied.
        :param pulumi.Input[_builtins.bool] root_squash_enabled: Whether to enable [root squash](https://docs.microsoft.com/azure/hpc-cache/access-policies#root-squash)?
        :param pulumi.Input[_builtins.bool] submount_access_enabled: Whether allow access to subdirectories under the root export?
        :param pulumi.Input[_builtins.bool] suid_enabled: Whether [SUID](https://docs.microsoft.com/azure/hpc-cache/access-policies#suid) is allowed?
        """
...
class CacheDirectoryActiveDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] domain_name: The fully qualified domain name of the Active Directory domain controller.
        :param pulumi.Input[_builtins.str] domain_netbios_name: The Active Directory domain's NetBIOS name.
        :param pulumi.Input[_builtins.str] password: The password of the Active Directory domain administrator.
        :param pulumi.Input[_builtins.str] username: The username of the Active Directory domain administrator.
        :param pulumi.Input[_builtins.str] dns_secondary_ip: The secondary DNS IP address used to resolve the Active Directory domain controller's FQDN.
        """
    ...
    def cache_netbios_name(self) -> pulumi.Input[_builtins.str]:
        """
        The NetBIOS name to assign to the HPC Cache when it joins the Active Directory domain as a server.
        """
    ...
    def cache_netbios_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "cache_netbios_name", value)

    @_builtins.property
    @pulumi.getter(name="dnsPrimaryIp")
    def dns_primary_ip(self) -> pulumi.Input[_builtins.str]:
        """
        The primary DNS IP address used to resolve the Active Directory domain controller's FQDN.
        """
    ...
    def dns_primary_ip(self, value: pulumi.Input[_builtins.str]):
    ...
    def domain_netbios_name(self) -> pulumi.Input[_builtins.str]:
        """
        The Active Directory domain's NetBIOS name.
        """
    ...
    def domain_netbios_name(self, value: pulumi.Input[_builtins.str]):
...
class CacheDirectoryFlatFileArgs:
    def __init__(__self__, *,
                 ...
                 password_file_uri: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] group_file_uri: The URI of the file containing group information (`/etc/group` file format in Unix-like OS).
        :param pulumi.Input[_builtins.str] password_file_uri: The URI of the file containing user information (`/etc/passwd` file format in Unix-like OS).
        """
    ...
    def group_file_uri(self) -> pulumi.Input[_builtins.str]:
        """
        The URI of the file containing group information (`/etc/group` file format in Unix-like OS).
        """
    ...
    def group_file_uri(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "group_file_uri", value)

    @_builtins.property
    @pulumi.getter(name="passwordFileUri")
    def password_file_uri(self) -> pulumi.Input[_builtins.str]:
        """
        The URI of the file containing user information (`/etc/passwd` file format in Unix-like OS).
        """
    ...
    def password_file_uri(self, value: pulumi.Input[_builtins.str]):
...
class CacheDirectoryLdapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] certificate_validation_uri: The URI of the CA certificate to validate the LDAP secure connection.
        :param pulumi.Input[_builtins.bool] download_certificate_automatically: Whether the certificate should be automatically downloaded. This can be set to `true` only when `certificate_validation_uri` is provided.
        :param pulumi.Input[_builtins.bool] encrypted: Whether the LDAP connection should be encrypted?
        """
...
class CacheDirectoryLdapBindArgs:
    def __init__(__self__, *,
                 ...
                 password: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] dn: The Bind Distinguished Name (DN) identity to be used in the secure LDAP connection.
        :param pulumi.Input[_builtins.str] password: The Bind password to be used in the secure LDAP connection.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def dn(self) -> pulumi.Input[_builtins.str]:
        """
        The Bind Distinguished Name (DN) identity to be used in the secure LDAP connection.
        """
    ...
    @dn.setter
    def dn(self, value: pulumi.Input[_builtins.str]):
...
class CacheNfsTargetNamespaceJunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_path: The relative subdirectory path from the `nfs_export` to map to the `namespace_path`. Defaults to `""`, in which case the whole `nfs_export` is exported.
        """
    ...
    def nfs_export(self) -> pulumi.Input[_builtins.str]:
        """
        The NFS export of this NFS target within the HPC Cache NFS Target.
        """
    ...
    @nfs_export.setter
    def nfs_export(self, value: pulumi.Input[_builtins.str]):
