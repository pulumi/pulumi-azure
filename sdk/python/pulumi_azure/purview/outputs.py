...
class AccountManagedResource(dict):
    ...
    def __init__(__self__, *,
                 event_hub_namespace_id: Optional[_builtins.str] = None,
                 resource_group_id: Optional[_builtins.str] = None,
                 storage_account_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str event_hub_namespace_id: The ID of the managed event hub namespace.
        :param _builtins.str resource_group_id: The ID of the managed resource group.
        :param _builtins.str storage_account_id: The ID of the managed storage account.
        """
    ...
    def event_hub_namespace_id(self) -> Optional[_builtins.str]:
        """
