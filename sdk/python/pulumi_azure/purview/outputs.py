...
class AccountIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Purview Account. Possible values are `UserAssigned` and `SystemAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Purview Account.
...
class AccountManagedResource(dict):
    ...
    def __init__(__self__, *,
                 event_hub_namespace_id: Optional[builtins.str] = None,
                 resource_group_id: Optional[builtins.str] = None,
                 storage_account_id: Optional[builtins.str] = None):
        """
        :param builtins.str event_hub_namespace_id: The ID of the managed event hub namespace.
        :param builtins.str resource_group_id: The ID of the managed resource group.
        :param builtins.str storage_account_id: The ID of the managed storage account.
        """
    ...
    def event_hub_namespace_id(self) -> Optional[builtins.str]:
        """
