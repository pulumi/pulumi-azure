...
class _AccountState:
    def __init__(__self__, *,
                 atlas_kafka_endpoint_primary_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 atlas_kafka_endpoint_secondary_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 catalog_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 guardian_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 scan_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering Account resources.
        :param pulumi.Input[builtins.str] atlas_kafka_endpoint_primary_connection_string: Atlas Kafka endpoint primary connection string.
        :param pulumi.Input[builtins.str] atlas_kafka_endpoint_secondary_connection_string: Atlas Kafka endpoint secondary connection string.
        :param pulumi.Input[builtins.str] catalog_endpoint: Catalog endpoint.
        :param pulumi.Input[builtins.str] guardian_endpoint: Guardian endpoint.
        :param pulumi.Input['AccountIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Purview Account should exist. Changing this forces a new Purview Account to be created.
        :param pulumi.Input[builtins.str] managed_resource_group_name: The name which should be used for the new Resource Group where Purview Account creates the managed resources. Changing this forces a new Purview Account to be created.
        ...
        :param pulumi.Input[builtins.bool] public_network_enabled: Should the Purview Account be visible to the public network? Defaults to `true`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Purview Account should exist. Changing this forces a new Purview Account to be created.
        :param pulumi.Input[builtins.str] scan_endpoint: Scan endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Purview Account.
        """
    ...
    def atlas_kafka_endpoint_primary_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def atlas_kafka_endpoint_primary_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def atlas_kafka_endpoint_secondary_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def atlas_kafka_endpoint_secondary_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "atlas_kafka_endpoint_secondary_connection_string", value)

    @property
    @pulumi.getter(name="catalogEndpoint")
    def catalog_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Catalog endpoint.
        """
    ...
    def catalog_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "catalog_endpoint", value)

    @property
    @pulumi.getter(name="guardianEndpoint")
    def guardian_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Guardian endpoint.
        """
    ...
    def guardian_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scan_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Scan endpoint.
        """
    ...
    def scan_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Account(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="atlasKafkaEndpointPrimaryConnectionString")
    def atlas_kafka_endpoint_primary_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        Atlas Kafka endpoint primary connection string.
        """
        return pulumi.get(self, "atlas_kafka_endpoint_primary_connection_string")
    ...
    @property
    @pulumi.getter(name="atlasKafkaEndpointSecondaryConnectionString")
    def atlas_kafka_endpoint_secondary_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        Atlas Kafka endpoint secondary connection string.
        """
        return pulumi.get(self, "atlas_kafka_endpoint_secondary_connection_string")
    ...
    @property
    @pulumi.getter(name="catalogEndpoint")
    def catalog_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        Catalog endpoint.
        """
        return pulumi.get(self, "catalog_endpoint")
    ...
    @property
    @pulumi.getter(name="guardianEndpoint")
    def guardian_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        Guardian endpoint.
        """
        return pulumi.get(self, "guardian_endpoint")
    ...
    @property
    @pulumi.getter(name="scanEndpoint")
    def scan_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        Scan endpoint.
        """
        return pulumi.get(self, "scan_endpoint")
