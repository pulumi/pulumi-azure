...
class AccountIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Purview Account. Possible values are `UserAssigned` and `SystemAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Purview Account.
...
if not MYPY:
    class AccountManagedResourceArgsDict(TypedDict):
        event_hub_namespace_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AccountManagedResourceArgs:
    def __init__(__self__, *,
                 event_hub_namespace_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 storage_account_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] event_hub_namespace_id: The ID of the managed event hub namespace.
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the managed resource group.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the managed storage account.
        """
    ...
    def event_hub_namespace_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the managed event hub namespace.
        """
    ...
    def event_hub_namespace_id(self, value: Optional[pulumi.Input[builtins.str]]):
