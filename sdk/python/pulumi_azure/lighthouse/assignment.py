...
class AssignmentArgs:
    def __init__(__self__, *,
                 lighthouse_definition_id: pulumi.Input[_builtins.str],
                 scope: pulumi.Input[_builtins.str],
                 name: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a Assignment resource.

        :param pulumi.Input[_builtins.str] lighthouse_definition_id: A Fully qualified path of the lighthouse definition, such as `/subscriptions/0afefe50-734e-4610-8c82-a144aff49dea/providers/Microsoft.ManagedServices/registrationDefinitions/26c128c2-fefa-4340-9bb1-8e081c90ada2`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] scope: The scope at which the Lighthouse Assignment applies too, such as `/subscriptions/0b1f6471-1bf0-4dda-aec3-111122223333` or `/subscriptions/0b1f6471-1bf0-4dda-aec3-111122223333/resourceGroups/myGroup`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: A unique UUID/GUID which identifies this lighthouse assignment- one will be generated if not specified. Changing this forces a new resource to be created.
        """
    ...
    def lighthouse_definition_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def lighthouse_definition_id(self, value: pulumi.Input[_builtins.str]):
...
class _AssignmentState:
    def __init__(__self__, *,
                 lighthouse_definition_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="lighthouseDefinitionId")
    def lighthouse_definition_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        A Fully qualified path of the lighthouse definition, such as `/subscriptions/0afefe50-734e-4610-8c82-a144aff49dea/providers/Microsoft.ManagedServices/registrationDefinitions/26c128c2-fefa-4340-9bb1-8e081c90ada2`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "lighthouse_definition_id")
    ...
    @lighthouse_definition_id.setter
    def lighthouse_definition_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "lighthouse_definition_id", value)
...
class Assignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            lighthouse_definition_id: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            scope: pulumi.Input[Optional[_builtins.str]] = None) -> 'Assignment':
        """
