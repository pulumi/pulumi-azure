...
class DefinitionAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] delegated_role_definition_ids: The set of role definition ids which define all the permissions that the principal id can assign.
        :param pulumi.Input[_builtins.str] principal_display_name: The display name of the security group/service principal/user that would be assigned permissions to the projected subscription.
        """
...
class DefinitionEligibleAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] principal_display_name: The display name of the Azure Active Directory Principal.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "role_definition_id", role_definition_id)
...
class DefinitionEligibleAuthorizationJustInTimeAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] multi_factor_auth_provider: The multi-factor authorization provider to be used for just-in-time access requests. Possible value is `Azure`.
...
class DefinitionPlanArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The plan name of the marketplace offer.
        :param pulumi.Input[_builtins.str] product: The product code of the plan.
        :param pulumi.Input[_builtins.str] publisher: The publisher ID of the plan.
        :param pulumi.Input[_builtins.str] version: The version of the plan.
        """
