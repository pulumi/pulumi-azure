...
class DefinitionAuthorization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 principal_display_name: Optional[builtins.str] = None):
        """
        :param builtins.str principal_id: Principal ID of the security group/service principal/user that would be assigned permissions to the projected subscription.
        :param builtins.str role_definition_id: The role definition identifier. This role will define the permissions that are granted to the principal. This cannot be an `Owner` role.
        :param Sequence[builtins.str] delegated_role_definition_ids: The set of role definition ids which define all the permissions that the principal id can assign.
        :param builtins.str principal_display_name: The display name of the security group/service principal/user that would be assigned permissions to the projected subscription.
        """
    ...
    def principal_display_name(self) -> Optional[builtins.str]:
        """
...
class DefinitionEligibleAuthorization(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str principal_id: Principal ID of the security group/service principal/user that would be assigned permissions to the projected subscription.
        :param builtins.str role_definition_id: The Principal ID of the Azure built-in role that defines the permissions that the Azure Active Directory will have on the projected scope.
        ...
        :param builtins.str principal_display_name: The display name of the Azure Active Directory Principal.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "role_definition_id", role_definition_id)
...
class DefinitionEligibleAuthorizationJustInTimeAccessPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str maximum_activation_duration: The maximum access duration in ISO 8601 format for just-in-time access requests. Defaults to `PT8H`.
        :param builtins.str multi_factor_auth_provider: The multi-factor authorization provider to be used for just-in-time access requests. Possible value is `Azure`.
    ...
    def multi_factor_auth_provider(self) -> Optional[builtins.str]:
        """
...
class DefinitionEligibleAuthorizationJustInTimeAccessPolicyApprover(dict):
    ...
    def __init__(__self__, *,
                 ...
                 principal_display_name: Optional[builtins.str] = None):
        """
        :param builtins.str principal_id: The Principal ID of the Azure Active Directory principal for the approver.
        :param builtins.str principal_display_name: The display name of the Azure Active Directory Principal for the approver.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        if principal_display_name is not None:
            pulumi.set(__self__, "principal_display_name", principal_display_name)
...
class DefinitionPlan(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The plan name of the marketplace offer.
        :param builtins.str product: The product code of the plan.
        :param builtins.str publisher: The publisher ID of the plan.
        :param builtins.str version: The version of the plan.
        """
