...
def azurerm_portal_dashboard(dashboard_properties: Optional[builtins.str] = None,
    ...
    * `Microsoft.Portal`: 2019-01-01-preview
    ...
    :param builtins.str name: Specifies the name of the shared Azure Portal Dashboard.
    :param builtins.str resource_group_name: Specifies the name of the resource group the shared Azure Portal Dashboard is located in.
    """
    __args__ = dict()
...
def azurerm_portal_dashboard_output(dashboard_properties: Optional[pulumi.Input[Optional[builtins.str]]] = None,
