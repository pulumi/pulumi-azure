...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agent_public_key_certificate: Specifies the base64-encoded public certificate used by the agent to do the initial handshake to the backend services in Azure. Changing this forces a new Arc Kubernetes Cluster to be created.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Arc Kubernetes Cluster should exist. Changing this forces a new Arc Kubernetes Cluster to be created.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Arc Kubernetes Cluster should exist. Changing this forces a new Arc Kubernetes Cluster to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Arc Kubernetes Cluster. Changing this forces a new Arc Kubernetes Cluster to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Arc Kubernetes Cluster.
        """
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agent_public_key_certificate: Specifies the base64-encoded public certificate used by the agent to do the initial handshake to the backend services in Azure. Changing this forces a new Arc Kubernetes Cluster to be created.
        :param pulumi.Input[builtins.str] agent_version: Version of the agent running on the cluster resource.
        :param pulumi.Input[builtins.str] distribution: The distribution running on this Arc Kubernetes Cluster.
        :param pulumi.Input['ClusterIdentityArgs'] identity: An `identity` block as defined below. Changing this forces a new Arc Kubernetes Cluster to be created.
        :param pulumi.Input[builtins.str] infrastructure: The infrastructure on which the Arc Kubernetes Cluster is running on.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Arc Kubernetes Cluster should exist. Changing this forces a new Arc Kubernetes Cluster to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Arc Kubernetes Cluster.
        :param pulumi.Input[builtins.int] total_core_count: Number of CPU cores present in the cluster resource.
        :param pulumi.Input[builtins.int] total_node_count: Number of nodes present in the cluster resource.
        """
    ...
    @property
    @pulumi.getter(name="agentPublicKeyCertificate")
    def agent_public_key_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the base64-encoded public certificate used by the agent to do the initial handshake to the backend services in Azure. Changing this forces a new Arc Kubernetes Cluster to be created.
        """
        return pulumi.get(self, "agent_public_key_certificate")
    ...
    @agent_public_key_certificate.setter
    def agent_public_key_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agent_public_key_certificate", value)
...
class Cluster(pulumi.CustomResource):
    ...
    pulumi_type = "azure:arckubernetes/cluster:Cluster"
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            total_core_count: Optional[pulumi.Input[builtins.int]] = None,
            total_node_count: Optional[pulumi.Input[builtins.int]] = None) -> 'Cluster':
        """
