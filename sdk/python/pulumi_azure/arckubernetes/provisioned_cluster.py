...
class ProvisionedClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Arc Kubernetes Provisioned Cluster.
        """
...
class _ProvisionedClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Arc Kubernetes Provisioned Cluster should exist. Changing this forces a new Arc Kubernetes Provisioned Cluster to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Arc Kubernetes Provisioned Cluster.
        :param pulumi.Input[_builtins.int] total_core_count: The number of CPU cores present in the cluster resource.
        :param pulumi.Input[_builtins.int] total_node_count: The number of nodes present in the cluster resource.
        """
...
class ProvisionedCluster(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="arcAgentAutoUpgradeEnabled")
    def arc_agent_auto_upgrade_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Whether the Arc agents will be upgraded automatically to the latest version. Defaults to `true`.
        """
        return pulumi.get(self, "arc_agent_auto_upgrade_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="arcAgentDesiredVersion")
    def arc_agent_desired_version(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The version of the Arc agents to be installed on the cluster.
        """
        return pulumi.get(self, "arc_agent_desired_version")
