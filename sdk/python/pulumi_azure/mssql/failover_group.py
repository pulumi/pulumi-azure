...
class FailoverGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_id: The ID of the primary SQL Server on which to create the failover group. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] databases: A set of database names to include in the failover group.
        :param pulumi.Input[builtins.str] name: The name of the Failover Group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] readonly_endpoint_failover_policy_enabled: Whether failover is enabled for the readonly endpoint. Defaults to `false`.
...
class FailoverGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            readonly_endpoint_failover_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            server_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'FailoverGroup':
        """
    ...
    @property
    @pulumi.getter(name="readonlyEndpointFailoverPolicyEnabled")
    def readonly_endpoint_failover_policy_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether failover is enabled for the readonly endpoint. Defaults to `false`.
        """
        return pulumi.get(self, "readonly_endpoint_failover_policy_enabled")
