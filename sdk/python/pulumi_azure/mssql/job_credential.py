...
class JobCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] password_wo_version: An integer value used to trigger an update for `password_wo`. This property should be incremented when updating `password_wo`.
        """
...
class JobCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[_builtins.str]] = None,
            password_wo_version: Optional[pulumi.Input[_builtins.int]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None) -> 'JobCredential':
        """
