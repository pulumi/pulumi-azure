...
class JobTargetGroupArgs:
    def __init__(__self__, *,
                 job_agent_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] job_agent_id: The ID of the Elastic Job Agent. Changing this forces a new Job Target Group to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Job Target Group. Changing this forces a new Job Target Group to be created.
        """
    ...
    def job_agent_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @job_agent_id.setter
    def job_agent_id(self, value: pulumi.Input[builtins.str]):
...
class _JobTargetGroupState:
    def __init__(__self__, *,
                 job_agent_id: Optional[pulumi.Input[builtins.str]] = None,
                 job_targets: Optional[pulumi.Input[Sequence[pulumi.Input['JobTargetGroupJobTargetArgs']]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="jobAgentId")
    def job_agent_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Elastic Job Agent. Changing this forces a new Job Target Group to be created.
        """
        return pulumi.get(self, "job_agent_id")
    ...
    @job_agent_id.setter
    def job_agent_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "job_agent_id", value)
...
@pulumi.type_token("azure:mssql/jobTargetGroup:JobTargetGroup")
class JobTargetGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            job_agent_id: Optional[pulumi.Input[builtins.str]] = None,
            job_targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['JobTargetGroupJobTargetArgs', 'JobTargetGroupJobTargetArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'JobTargetGroup':
        """
    ...
    @property
    @pulumi.getter(name="jobAgentId")
    def job_agent_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Elastic Job Agent. Changing this forces a new Job Target Group to be created.
        """
        return pulumi.get(self, "job_agent_id")
