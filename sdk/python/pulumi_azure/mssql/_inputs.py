...
class DatabaseIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this SQL Database.
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this SQL Database. Possible value is `UserAssigned`.
        """
...
if not MYPY:
    class DatabaseImportArgsDict(TypedDict):
        ...
        """
        storage_key: pulumi.Input[builtins.str]
        """
        Specifies the access key for the storage account.
        """
        storage_key_type: pulumi.Input[builtins.str]
        """
...
class DatabaseImportArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] administrator_login: Specifies the name of the SQL administrator.
        :param pulumi.Input[builtins.str] administrator_login_password: Specifies the password of the SQL administrator.
        :param pulumi.Input[builtins.str] authentication_type: Specifies the type of authentication used to access the server. Valid values are `SQL` or `ADPassword`.
        :param pulumi.Input[builtins.str] storage_key: Specifies the access key for the storage account.
        :param pulumi.Input[builtins.str] storage_key_type: Specifies the type of access key for the storage account. Valid values are `StorageAccessKey` or `SharedAccessKey`.
        :param pulumi.Input[builtins.str] storage_uri: Specifies the blob URI of the .bacpac file.
        :param pulumi.Input[builtins.str] storage_account_id: The resource id for the storage account used to store BACPAC file. If set, private endpoint connection will be created for the storage account. Must match storage account used for storage_uri parameter.
        """
    ...
    def storage_key(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the access key for the storage account.
        """
    ...
    @storage_key.setter
    def storage_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "storage_key", value)

    @property
    @pulumi.getter(name="storageKeyType")
    def storage_key_type(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the type of access key for the storage account. Valid values are `StorageAccessKey` or `SharedAccessKey`.
        """
    ...
    def storage_key_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DatabaseLongTermRetentionPolicyArgsDict(TypedDict):
        immutable_backups_enabled: NotRequired[pulumi.Input[builtins.bool]]
        monthly_retention: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        week_of_year: NotRequired[pulumi.Input[builtins.int]]
        """
        The week of year to take the yearly backup. Value has to be between `1` and `52`.
        """
        weekly_retention: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        yearly_retention: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatabaseLongTermRetentionPolicyArgs:
    def __init__(__self__, *,
                 immutable_backups_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] monthly_retention: The monthly retention policy for an LTR backup in an ISO 8601 format. Valid value is between 1 to 120 months. e.g. `P1Y`, `P1M`, `P4W` or `P30D`. Defaults to `PT0S`.
        :param pulumi.Input[builtins.int] week_of_year: The week of year to take the yearly backup. Value has to be between `1` and `52`.
        :param pulumi.Input[builtins.str] weekly_retention: The weekly retention policy for an LTR backup in an ISO 8601 format. Valid value is between 1 to 520 weeks. e.g. `P1Y`, `P1M`, `P1W` or `P7D`. Defaults to `PT0S`.
        :param pulumi.Input[builtins.str] yearly_retention: The yearly retention policy for an LTR backup in an ISO 8601 format. Valid value is between 1 to 10 years. e.g. `P1Y`, `P12M`, `P52W` or `P365D`. Defaults to `PT0S`.
        """
    ...
    def immutable_backups_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "immutable_backups_enabled")

    @immutable_backups_enabled.setter
    def immutable_backups_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DatabaseShortTermRetentionPolicyArgsDict(TypedDict):
        ...
        """
        backup_interval_in_hours: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DatabaseShortTermRetentionPolicyArgs:
    def __init__(__self__, *,
                 retention_days: pulumi.Input[builtins.int],
                 backup_interval_in_hours: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] retention_days: Point In Time Restore configuration. Value has to be between `1` and `35`.
        :param pulumi.Input[builtins.int] backup_interval_in_hours: The hours between each differential backup. This is only applicable to live databases but not dropped databases. Value has to be `12` or `24`. Defaults to `12` hours.
        """
    ...
    def backup_interval_in_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The hours between each differential backup. This is only applicable to live databases but not dropped databases. Value has to be `12` or `24`. Defaults to `12` hours.
        """
    ...
    def backup_interval_in_hours(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class DatabaseThreatDetectionPolicyArgsDict(TypedDict):
        ...
        """
        email_account_admins: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatabaseThreatDetectionPolicyArgs:
    def __init__(__self__, *,
                 ...
                 email_account_admins: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disabled_alerts: Specifies a list of alerts which should be disabled. Possible values include `Access_Anomaly`, `Sql_Injection` and `Sql_Injection_Vulnerability`.
        :param pulumi.Input[builtins.str] email_account_admins: Should the account administrators be emailed when this alert is triggered? Possible values are `Enabled` or `Disabled`. Defaults to `Disabled`.
        ...
        :param pulumi.Input[builtins.str] state: The State of the Policy. Possible values are `Enabled` or `Disabled`. Defaults to `Disabled`.
        :param pulumi.Input[builtins.str] storage_account_access_key: Specifies the identifier key of the Threat Detection audit storage account. Required if `state` is `Enabled`.
        :param pulumi.Input[builtins.str] storage_endpoint: Specifies the blob storage endpoint (e.g. <https://example.blob.core.windows.net>). This blob storage will hold all Threat Detection audit logs. Required if `state` is `Enabled`.
        """
    ...
    def email_account_admins(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Should the account administrators be emailed when this alert is triggered? Possible values are `Enabled` or `Disabled`. Defaults to `Disabled`.
        """
    ...
    def email_account_admins(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatabaseVulnerabilityAssessmentRuleBaselineBaselineResultArgs:
    def __init__(__self__, *,
                 results: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] results: A list representing a result of the baseline.
        """
...
class ElasticPoolSkuArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] capacity: The scale up/out capacity, representing server's compute units. For more information see the documentation for your Elasticpool configuration: [vCore-based](https://docs.microsoft.com/azure/sql-database/sql-database-vcore-resource-limits-elastic-pools) or [DTU-based](https://docs.microsoft.com/azure/sql-database/sql-database-dtu-resource-limits-elastic-pools).
        :param pulumi.Input[builtins.str] name: Specifies the SKU Name for this Elasticpool. The name of the SKU, will be either `vCore` based or `DTU` based. Possible `DTU` based values are `BasicPool`, `StandardPool`, `PremiumPool` while possible `vCore` based values are `GP_Gen4`, `GP_Gen5`, `GP_Fsv2`, `GP_DC`, `BC_Gen4`, `BC_Gen5`, `BC_DC`, `HS_PRMS`, `HS_MOPRMS`, or `HS_Gen5`.
        :param pulumi.Input[builtins.str] tier: The tier of the particular SKU. Possible values are `GeneralPurpose`, `BusinessCritical`, `Basic`, `Standard`, `Premium`, or `HyperScale`. For more information see the documentation for your Elasticpool configuration: [vCore-based](https://docs.microsoft.com/azure/sql-database/sql-database-vcore-resource-limits-elastic-pools) or [DTU-based](https://docs.microsoft.com/azure/sql-database/sql-database-dtu-resource-limits-elastic-pools).
        :param pulumi.Input[builtins.str] family: The `family` of hardware `Gen4`, `Gen5`, `Fsv2`, `MOPRMS`, `PRMS`, or `DC`.
        """
...
class FailoverGroupPartnerServerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of a partner SQL server to include in the failover group.
        :param pulumi.Input[builtins.str] location: The location of the partner server.
        :param pulumi.Input[builtins.str] role: The replication role of the partner server. Possible values include `Primary` or `Secondary`.
        """
...
if not MYPY:
    class FailoverGroupReadWriteEndpointFailoverPolicyArgsDict(TypedDict):
        ...
        """
        grace_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FailoverGroupReadWriteEndpointFailoverPolicyArgs:
    def __init__(__self__, *,
                 mode: pulumi.Input[builtins.str],
                 grace_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] mode: The failover policy of the read-write endpoint for the failover group. Possible values are `Automatic` or `Manual`.
        :param pulumi.Input[builtins.int] grace_minutes: The grace period in minutes, before failover with data loss is attempted for the read-write endpoint. Required when `mode` is `Automatic`.
        """
    ...
    def grace_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The grace period in minutes, before failover with data loss is attempted for the read-write endpoint. Required when `mode` is `Automatic`.
        """
    ...
    def grace_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class JobAgentIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to assign to this Elastic Job Agent.
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Elastic Job Agent. Currently only `UserAssigned` is supported.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class JobStepOutputTargetArgsDict(TypedDict):
        ...
        """
        mssql_database_id: pulumi.Input[builtins.str]
        """
...
class JobStepOutputTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] job_credential_id: The ID of the Elastic Job Credential to use when connecting to the output destination.
        :param pulumi.Input[builtins.str] mssql_database_id: The ID of the output database.
        :param pulumi.Input[builtins.str] table_name: The name of the output table.
        :param pulumi.Input[builtins.str] schema_name: The name of the output schema. Defaults to `dbo`.
        """
    ...
    def mssql_database_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the output database.
        """
    ...
    def mssql_database_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class JobTargetGroupJobTargetArgsDict(TypedDict):
        ...
        """
        job_credential_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        membership_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobTargetGroupJobTargetArgs:
    def __init__(__self__, *,
                 ...
                 membership_type: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] server_name: The name of the MS SQL Server.
        :param pulumi.Input[builtins.str] database_name: The name of the MS SQL Database.
               
               > **Note:** This cannot be set in combination with `elastic_pool_name`.
        :param pulumi.Input[builtins.str] elastic_pool_name: The name of the MS SQL Elastic Pool.
               
               > **Note:** This cannot be set in combination with `database_name`.
        :param pulumi.Input[builtins.str] job_credential_id: The ID of the job credential to use during execution of jobs.
               
               > **Note:** This is required when `membership_type` is `Include`, unless `database_name` is set.
        :param pulumi.Input[builtins.str] membership_type: The membership type for this job target. Possible values are `Include` and `Exclude`. Defaults to `Include`.
        :param pulumi.Input[builtins.str] type: The job target type. This value is computed based on `server_name`, `database_name`, and `elastic_pool_name`.
        """
    ...
    def membership_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The membership type for this job target. Possible values are `Include` and `Exclude`. Defaults to `Include`.
        """
    ...
    def membership_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedDatabasePointInTimeRestoreArgs:
    def __init__(__self__, *,
                 ...
                 source_database_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] restore_point_in_time: The point in time for the restore from `source_database_id`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_database_id: The source database id that will be used to restore from. Changing this forces a new resource to be created.
        """
...
if not MYPY:
    class ManagedInstanceAzureActiveDirectoryAdministratorArgsDict(TypedDict):
        login_username: pulumi.Input[builtins.str]
        """
        ...
        """
        azuread_authentication_only_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ManagedInstanceAzureActiveDirectoryAdministratorArgs:
    def __init__(__self__, *,
                 ...
                 object_id: pulumi.Input[builtins.str],
                 principal_type: pulumi.Input[builtins.str],
                 azuread_authentication_only_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] login_username: The login username of the Azure AD Administrator of this SQL Managed Instance.
        :param pulumi.Input[builtins.str] object_id: The object id of the Azure AD Administrator of this SQL Managed Instance.
        :param pulumi.Input[builtins.str] principal_type: The principal type of the Azure AD Administrator of this SQL Managed Instance. Possible values are `Application`, `Group`, `User`.
        :param pulumi.Input[builtins.bool] azuread_authentication_only_enabled: Specifies whether only Azure AD authentication can be used to log in to this SQL Managed Instance. When `true`, the `administrator_login` and `administrator_login_password` properties can be omitted. Defaults to `false`.
        :param pulumi.Input[builtins.str] tenant_id: The tenant id of the Azure AD Administrator of this SQL Managed Instance. Should be specified if the Azure AD Administrator is homed in a different tenant to the SQL Managed Instance.
        """
    ...
    def login_username(self) -> pulumi.Input[builtins.str]:
        """
        The login username of the Azure AD Administrator of this SQL Managed Instance.
        """
    ...
    def login_username(self, value: pulumi.Input[builtins.str]):
    ...
    def azuread_authentication_only_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether only Azure AD authentication can be used to log in to this SQL Managed Instance. When `true`, the `administrator_login` and `administrator_login_password` properties can be omitted. Defaults to `false`.
        """
    ...
    def azuread_authentication_only_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ManagedInstanceFailoverGroupReadWriteEndpointFailoverPolicyArgs:
    def __init__(__self__, *,
                 ...
                 grace_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] mode: The failover mode. Possible values are `Automatic` or `Manual`.
        :param pulumi.Input[builtins.int] grace_minutes: Applies only if `mode` is `Automatic`. The grace period in minutes before failover with data loss is attempted.
        """
        pulumi.set(__self__, "mode", mode)
        if grace_minutes is not None:
            pulumi.set(__self__, "grace_minutes", grace_minutes)
...
class ManagedInstanceVulnerabilityAssessmentRecurringScansArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] email_subscription_admins: Boolean flag which specifies if the schedule scan notification will be sent to the subscription administrators. Defaults to `true`.
...
if not MYPY:
    class ServerAzureadAdministratorArgsDict(TypedDict):
        ...
        """
        azuread_authentication_only: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServerAzureadAdministratorArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] login_username: The login username of the Azure AD Administrator of this SQL Server.
        :param pulumi.Input[builtins.str] object_id: The object id of the Azure AD Administrator of this SQL Server.
        :param pulumi.Input[builtins.bool] azuread_authentication_only: Specifies whether only AD Users and administrators (e.g. `azuread_administrator[0].login_username`) can be used to login, or also local database users (e.g. `administrator_login`). When `true`, the `administrator_login` and `administrator_login_password` properties can be omitted.
        :param pulumi.Input[builtins.str] tenant_id: The tenant id of the Azure AD Administrator of this SQL Server.
        """
        pulumi.set(__self__, "login_username", login_username)
        pulumi.set(__self__, "object_id", object_id)
...
class ServerVulnerabilityAssessmentRecurringScansArgs:
    def __init__(__self__, *,
                 ...
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] email_subscription_admins: Boolean flag which specifies if the schedule scan notification will be sent to the subscription administrators. Defaults to `false`.
...
class VirtualMachineAssessmentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Should Assessment be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] run_immediately: Should Assessment be run immediately? Defaults to `false`.
...
class VirtualMachineAssessmentScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] day_of_week: What day of the week the assessment will be run. Possible values are `Friday`, `Monday`, `Saturday`, `Sunday`, `Thursday`, `Tuesday` and `Wednesday`.
...
if not MYPY:
    class VirtualMachineAutoBackupArgsDict(TypedDict):
        ...
        """
        storage_blob_endpoint: pulumi.Input[builtins.str]
        """
        Blob endpoint for the storage account where backups will be kept.
        """
        encryption_enabled: NotRequired[pulumi.Input[builtins.bool]]
        ...
        """
        system_databases_backup_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VirtualMachineAutoBackupArgs:
    def __init__(__self__, *,
                 ...
                 storage_account_access_key: pulumi.Input[builtins.str],
                 storage_blob_endpoint: pulumi.Input[builtins.str],
                 encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 system_databases_backup_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.int] retention_period_in_days: Retention period of backups, in days. Valid values are from `1` to `30`.
        :param pulumi.Input[builtins.str] storage_account_access_key: Access key for the storage account where backups will be kept.
        :param pulumi.Input[builtins.str] storage_blob_endpoint: Blob endpoint for the storage account where backups will be kept.
        :param pulumi.Input[builtins.str] encryption_password: Encryption password to use. Setting a password will enable encryption.
        ...
        :param pulumi.Input[builtins.bool] system_databases_backup_enabled: Include or exclude system databases from auto backup.
        """
    ...
    def storage_blob_endpoint(self) -> pulumi.Input[builtins.str]:
        """
        Blob endpoint for the storage account where backups will be kept.
        """
    ...
    def storage_blob_endpoint(self, value: pulumi.Input[builtins.str]):
    ...
    def encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "encryption_enabled")

    @encryption_enabled.setter
    def encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def system_databases_backup_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Include or exclude system databases from auto backup.
        """
...
if not MYPY:
    class VirtualMachineAutoBackupManualScheduleArgsDict(TypedDict):
        ...
        """
        log_backup_frequency_in_minutes: pulumi.Input[builtins.int]
        """
...
class VirtualMachineAutoBackupManualScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] full_backup_frequency: Frequency of full backups. Valid values include `Daily` or `Weekly`.
        :param pulumi.Input[builtins.int] full_backup_start_hour: Start hour of a given day during which full backups can take place. Valid values are from `0` to `23`.
        :param pulumi.Input[builtins.int] full_backup_window_in_hours: Duration of the time window of a given day during which full backups can take place, in hours. Valid values are between `1` and `23`.
    ...
    def full_backup_frequency(self) -> pulumi.Input[builtins.str]:
        """
        Frequency of full backups. Valid values include `Daily` or `Weekly`.
        """
    ...
    def full_backup_frequency(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "full_backup_frequency", value)

    @property
    @pulumi.getter(name="fullBackupStartHour")
    def full_backup_start_hour(self) -> pulumi.Input[builtins.int]:
        """
        Start hour of a given day during which full backups can take place. Valid values are from `0` to `23`.
        """
    ...
    def full_backup_start_hour(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "full_backup_start_hour", value)

    @property
    @pulumi.getter(name="fullBackupWindowInHours")
    def full_backup_window_in_hours(self) -> pulumi.Input[builtins.int]:
        """
        Duration of the time window of a given day during which full backups can take place, in hours. Valid values are between `1` and `23`.
        """
    ...
    def full_backup_window_in_hours(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "full_backup_window_in_hours", value)

    @property
    @pulumi.getter(name="logBackupFrequencyInMinutes")
    def log_backup_frequency_in_minutes(self) -> pulumi.Input[builtins.int]:
        """
        Frequency of log backups, in minutes. Valid values are from `5` to `60`.
        """
    ...
    def log_backup_frequency_in_minutes(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class VirtualMachineAutoPatchingArgsDict(TypedDict):
        ...
        """
        maintenance_window_duration_in_minutes: pulumi.Input[builtins.int]
        """
        The size of the Maintenance Window in minutes.
        """
        maintenance_window_starting_hour: pulumi.Input[builtins.int]
        """
...
class VirtualMachineAutoPatchingArgs:
    def __init__(__self__, *,
                 ...
                 maintenance_window_starting_hour: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] day_of_week: The day of week to apply the patch on. Possible values are `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`.
        :param pulumi.Input[builtins.int] maintenance_window_duration_in_minutes: The size of the Maintenance Window in minutes.
        :param pulumi.Input[builtins.int] maintenance_window_starting_hour: The Hour, in the Virtual Machine Time-Zone when the patching maintenance window should begin.
        """
        pulumi.set(__self__, "day_of_week", day_of_week)
    ...
    def maintenance_window_duration_in_minutes(self) -> pulumi.Input[builtins.int]:
        """
        The size of the Maintenance Window in minutes.
        """
    ...
    def maintenance_window_duration_in_minutes(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "maintenance_window_duration_in_minutes", value)

    @property
    @pulumi.getter(name="maintenanceWindowStartingHour")
    def maintenance_window_starting_hour(self) -> pulumi.Input[builtins.int]:
        """
        The Hour, in the Virtual Machine Time-Zone when the patching maintenance window should begin.
        """
    ...
    def maintenance_window_starting_hour(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class VirtualMachineAvailabilityGroupListenerLoadBalancerConfigurationArgsDict(TypedDict):
        ...
        """
        probe_port: pulumi.Input[builtins.int]
        """
        The probe port of the listener. Changing this forces a new resource to be created.
        """
        sql_virtual_machine_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class VirtualMachineAvailabilityGroupListenerLoadBalancerConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 subnet_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] load_balancer_id: The ID of the Load Balancer. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_ip_address: The private IP Address of the listener. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] probe_port: The probe port of the listener. Changing this forces a new resource to be created.
    ...
    def probe_port(self) -> pulumi.Input[builtins.int]:
        """
        The probe port of the listener. Changing this forces a new resource to be created.
        """
    ...
    @probe_port.setter
    def probe_port(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "probe_port", value)

    @property
    @pulumi.getter(name="sqlVirtualMachineIds")
    def sql_virtual_machine_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of SQL Virtual Machine IDs. Changing this forces a new resource to be created.
        """
    ...
    def sql_virtual_machine_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class VirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationArgsDict(TypedDict):
        ...
        The private IP Address of the listener. Changing this forces a new resource to be created.
        """
        sql_virtual_machine_id: pulumi.Input[builtins.str]
        """
...
class VirtualMachineAvailabilityGroupListenerMultiSubnetIpConfigurationArgs:
    ...
    def sql_virtual_machine_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Sql Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def sql_virtual_machine_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class VirtualMachineAvailabilityGroupListenerReplicaArgsDict(TypedDict):
        commit: pulumi.Input[builtins.str]
        """
        ...
        """
        failover_mode: pulumi.Input[builtins.str]
        """
        ...
        """
        readable_secondary: pulumi.Input[builtins.str]
        """
...
class VirtualMachineAvailabilityGroupListenerReplicaArgs:
    def __init__(__self__, *,
                 ...
                 sql_virtual_machine_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] commit: The replica commit mode for the availability group. Possible values are `Synchronous_Commit` and `Asynchronous_Commit`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] failover_mode: The replica failover mode for the availability group. Possible values are `Manual` and `Automatic`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] readable_secondary: The replica readable secondary mode for the availability group. Possible values are `No`, `Read_Only` and `All`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] role: The replica role for the availability group. Possible values are `Primary` and `Secondary`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sql_virtual_machine_id: The ID of the SQL Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def commit(self) -> pulumi.Input[builtins.str]:
        """
        The replica commit mode for the availability group. Possible values are `Synchronous_Commit` and `Asynchronous_Commit`. Changing this forces a new resource to be created.
        """
    ...
    @commit.setter
    def commit(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "commit", value)

    @property
    @pulumi.getter(name="failoverMode")
    def failover_mode(self) -> pulumi.Input[builtins.str]:
        """
        The replica failover mode for the availability group. Possible values are `Manual` and `Automatic`. Changing this forces a new resource to be created.
        """
    ...
    def failover_mode(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "failover_mode", value)

    @property
    @pulumi.getter(name="readableSecondary")
    def readable_secondary(self) -> pulumi.Input[builtins.str]:
        """
        The replica readable secondary mode for the availability group. Possible values are `No`, `Read_Only` and `All`. Changing this forces a new resource to be created.
        """
    ...
    def readable_secondary(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class VirtualMachineGroupWsfcDomainProfileArgsDict(TypedDict):
        cluster_subnet_type: pulumi.Input[builtins.str]
        """
        ...
        """
        cluster_bootstrap_account_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The account name used for creating cluster. Changing this forces a new resource to be created.
        """
        cluster_operator_account_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The account name used for operating cluster. Changing this forces a new resource to be created.
        """
        organizational_unit_path: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        sql_service_account_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualMachineGroupWsfcDomainProfileArgs:
    def __init__(__self__, *,
                 cluster_subnet_type: pulumi.Input[builtins.str],
                 fqdn: pulumi.Input[builtins.str],
                 cluster_bootstrap_account_name: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_operator_account_name: Optional[pulumi.Input[builtins.str]] = None,
                 organizational_unit_path: Optional[pulumi.Input[builtins.str]] = None,
                 sql_service_account_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] cluster_subnet_type: The subnet type of the SQL Virtual Machine cluster. Possible values are `MultiSubnet` and `SingleSubnet`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] fqdn: The fully qualified name of the domain. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] cluster_bootstrap_account_name: The account name used for creating cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] cluster_operator_account_name: The account name used for operating cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] organizational_unit_path: The organizational Unit path in which the nodes and cluster will be present. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sql_service_account_name: The account name under which SQL service will run on all participating SQL virtual machines in the cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_primary_key: The primary key of the Storage Account.
        :param pulumi.Input[builtins.str] storage_account_url: The SAS URL to the Storage Container of the witness storage account. Changing this forces a new resource to be created.
        """
    ...
    def cluster_subnet_type(self) -> pulumi.Input[builtins.str]:
        """
        The subnet type of the SQL Virtual Machine cluster. Possible values are `MultiSubnet` and `SingleSubnet`. Changing this forces a new resource to be created.
        """
    ...
    def cluster_subnet_type(self, value: pulumi.Input[builtins.str]):
    ...
    def cluster_bootstrap_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The account name used for creating cluster. Changing this forces a new resource to be created.
        """
    ...
    def cluster_bootstrap_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_bootstrap_account_name", value)

    @property
    @pulumi.getter(name="clusterOperatorAccountName")
    def cluster_operator_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The account name used for operating cluster. Changing this forces a new resource to be created.
        """
    ...
    def cluster_operator_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_operator_account_name", value)

    @property
    @pulumi.getter(name="organizationalUnitPath")
    def organizational_unit_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The organizational Unit path in which the nodes and cluster will be present. Changing this forces a new resource to be created.
        """
    ...
    def organizational_unit_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "organizational_unit_path", value)

    @property
    @pulumi.getter(name="sqlServiceAccountName")
    def sql_service_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The account name under which SQL service will run on all participating SQL virtual machines in the cluster. Changing this forces a new resource to be created.
        """
    ...
    def sql_service_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class VirtualMachineKeyVaultCredentialArgsDict(TypedDict):
        key_vault_url: pulumi.Input[builtins.str]
        """
        ...
        The credential name.
        """
        service_principal_name: pulumi.Input[builtins.str]
        """
        The service principal name to access key vault. Changing this forces a new resource to be created.
        """
        service_principal_secret: pulumi.Input[builtins.str]
        """
...
class VirtualMachineKeyVaultCredentialArgs:
    def __init__(__self__, *,
                 ...
                 service_principal_secret: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_vault_url: The Azure Key Vault url. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The credential name.
        :param pulumi.Input[builtins.str] service_principal_name: The service principal name to access key vault. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] service_principal_secret: The service principal name secret to access key vault. Changing this forces a new resource to be created.
        """
    ...
    def key_vault_url(self) -> pulumi.Input[builtins.str]:
        """
        The Azure Key Vault url. Changing this forces a new resource to be created.
        """
    ...
    def key_vault_url(self, value: pulumi.Input[builtins.str]):
    ...
    def service_principal_name(self) -> pulumi.Input[builtins.str]:
        """
        The service principal name to access key vault. Changing this forces a new resource to be created.
        """
    ...
    def service_principal_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_principal_name", value)

    @property
    @pulumi.getter(name="servicePrincipalSecret")
    def service_principal_secret(self) -> pulumi.Input[builtins.str]:
        """
        The service principal name secret to access key vault. Changing this forces a new resource to be created.
        """
    ...
    def service_principal_secret(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_principal_secret", value)


if not MYPY:
    class VirtualMachineSqlInstanceArgsDict(TypedDict):
        adhoc_workloads_optimization_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        instant_file_initialization_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        lock_pages_in_memory_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VirtualMachineSqlInstanceArgs:
    def __init__(__self__, *,
                 adhoc_workloads_optimization_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 collation: Optional[pulumi.Input[builtins.str]] = None,
                 instant_file_initialization_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 lock_pages_in_memory_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] adhoc_workloads_optimization_enabled: Specifies if the SQL Server is optimized for adhoc workloads. Possible values are `true` and `false`. Defaults to `false`.
        :param pulumi.Input[builtins.str] collation: Collation of the SQL Server. Defaults to `SQL_Latin1_General_CP1_CI_AS`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] instant_file_initialization_enabled: Specifies if Instant File Initialization is enabled for the SQL Server. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] lock_pages_in_memory_enabled: Specifies if Lock Pages in Memory is enabled for the SQL Server. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] max_dop: Maximum Degree of Parallelism of the SQL Server. Possible values are between `0` and `32767`. Defaults to `0`.
    ...
    def adhoc_workloads_optimization_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies if the SQL Server is optimized for adhoc workloads. Possible values are `true` and `false`. Defaults to `false`.
        """
    ...
    def adhoc_workloads_optimization_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def instant_file_initialization_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies if Instant File Initialization is enabled for the SQL Server. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new resource to be created.
        """
    ...
    def instant_file_initialization_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "instant_file_initialization_enabled", value)

    @property
    @pulumi.getter(name="lockPagesInMemoryEnabled")
    def lock_pages_in_memory_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies if Lock Pages in Memory is enabled for the SQL Server. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new resource to be created.
        """
    ...
    def lock_pages_in_memory_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class VirtualMachineStorageConfigurationArgsDict(TypedDict):
        ...
        """
        storage_workload_type: pulumi.Input[builtins.str]
        """
        ...
        A `storage_settings` block as defined below.
        """
        system_db_on_data_disk_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VirtualMachineStorageConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 system_db_on_data_disk_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 temp_db_settings: Optional[pulumi.Input['VirtualMachineStorageConfigurationTempDbSettingsArgs']] = None):
        """
        :param pulumi.Input[builtins.str] disk_type: The type of disk configuration to apply to the SQL Server. Valid values include `NEW`, `EXTEND`, or `ADD`.
        :param pulumi.Input[builtins.str] storage_workload_type: The type of storage workload. Valid values include `GENERAL`, `OLTP`, or `DW`.
        ...
        :param pulumi.Input[builtins.bool] system_db_on_data_disk_enabled: Specifies whether to set system databases (except tempDb) location to newly created data storage. Possible values are `true` and `false`. Defaults to `false`.
    ...
    def storage_workload_type(self) -> pulumi.Input[builtins.str]:
        """
        The type of storage workload. Valid values include `GENERAL`, `OLTP`, or `DW`.
        """
    ...
    def storage_workload_type(self, value: pulumi.Input[builtins.str]):
    ...
    def system_db_on_data_disk_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to set system databases (except tempDb) location to newly created data storage. Possible values are `true` and `false`. Defaults to `false`.
        """
    ...
    def system_db_on_data_disk_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class VirtualMachineStorageConfigurationDataSettingsArgsDict(TypedDict):
        default_file_path: pulumi.Input[builtins.str]
        luns: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]
elif False:
...
class VirtualMachineStorageConfigurationDataSettingsArgs:
    ...
    def default_file_path(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "default_file_path")

    @default_file_path.setter
    def default_file_path(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "default_file_path", value)

    @property
    @pulumi.getter
    def luns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        return pulumi.get(self, "luns")

    @luns.setter
    def luns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
...
if not MYPY:
    class VirtualMachineStorageConfigurationTempDbSettingsArgsDict(TypedDict):
        ...
        """
        data_file_growth_in_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The SQL Server default file size - This value defaults to `512`
        """
        data_file_size_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The SQL Server default file size - This value defaults to `256`
        """
        log_file_growth_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The SQL Server default file size - This value defaults to `512`
        """
        log_file_size_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The SQL Server default file size - This value defaults to `256`
        """
elif False:
...
class VirtualMachineStorageConfigurationTempDbSettingsArgs:
    def __init__(__self__, *,
                 ...
                 data_file_growth_in_mb: Optional[pulumi.Input[builtins.int]] = None,
                 data_file_size_mb: Optional[pulumi.Input[builtins.int]] = None,
                 log_file_growth_mb: Optional[pulumi.Input[builtins.int]] = None,
                 log_file_size_mb: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] default_file_path: The SQL Server default path
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] luns: A list of Logical Unit Numbers for the disks.
        :param pulumi.Input[builtins.int] data_file_count: The SQL Server default file count. This value defaults to `8`
        :param pulumi.Input[builtins.int] data_file_growth_in_mb: The SQL Server default file size - This value defaults to `512`
        :param pulumi.Input[builtins.int] data_file_size_mb: The SQL Server default file size - This value defaults to `256`
        :param pulumi.Input[builtins.int] log_file_growth_mb: The SQL Server default file size - This value defaults to `512`
        :param pulumi.Input[builtins.int] log_file_size_mb: The SQL Server default file size - This value defaults to `256`
        """
        pulumi.set(__self__, "default_file_path", default_file_path)
        pulumi.set(__self__, "luns", luns)
    ...
    def data_file_growth_in_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The SQL Server default file size - This value defaults to `512`
        """
    ...
    def data_file_growth_in_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_file_growth_in_mb", value)

    @property
    @pulumi.getter(name="dataFileSizeMb")
    def data_file_size_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The SQL Server default file size - This value defaults to `256`
        """
    ...
    def data_file_size_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_file_size_mb", value)

    @property
    @pulumi.getter(name="logFileGrowthMb")
    def log_file_growth_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The SQL Server default file size - This value defaults to `512`
        """
    ...
    def log_file_growth_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "log_file_growth_mb", value)

    @property
    @pulumi.getter(name="logFileSizeMb")
    def log_file_size_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The SQL Server default file size - This value defaults to `256`
        """
    ...
    def log_file_size_mb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "log_file_size_mb", value)


if not MYPY:
    class VirtualMachineWsfcDomainCredentialArgsDict(TypedDict):
        cluster_bootstrap_account_password: pulumi.Input[builtins.str]
        """
        The account password used for creating cluster.
        """
        cluster_operator_account_password: pulumi.Input[builtins.str]
        """
        The account password used for operating cluster.
        """
        sql_service_account_password: pulumi.Input[builtins.str]
        """
...
class VirtualMachineWsfcDomainCredentialArgs:
    def __init__(__self__, *,
                 ...
                 sql_service_account_password: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] cluster_bootstrap_account_password: The account password used for creating cluster.
        :param pulumi.Input[builtins.str] cluster_operator_account_password: The account password used for operating cluster.
        :param pulumi.Input[builtins.str] sql_service_account_password: The account password under which SQL service will run on all participating SQL virtual machines in the cluster.
        """
    ...
    def cluster_bootstrap_account_password(self) -> pulumi.Input[builtins.str]:
        """
        The account password used for creating cluster.
        """
    ...
    def cluster_bootstrap_account_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cluster_bootstrap_account_password", value)

    @property
    @pulumi.getter(name="clusterOperatorAccountPassword")
    def cluster_operator_account_password(self) -> pulumi.Input[builtins.str]:
        """
        The account password used for operating cluster.
        """
    ...
    def cluster_operator_account_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cluster_operator_account_password", value)

    @property
    @pulumi.getter(name="sqlServiceAccountPassword")
    def sql_service_account_password(self) -> pulumi.Input[builtins.str]:
        """
        The account password under which SQL service will run on all participating SQL virtual machines in the cluster.
        """
    ...
    def sql_service_account_password(self, value: pulumi.Input[builtins.str]):
