...
class GetManagedDatabaseResult:
    ...
    def short_term_retention_days(self) -> builtins.int:
        """
...
def get_managed_database(managed_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_instance_id: The SQL Managed Instance ID.
    :param builtins.str name: The name of this Azure SQL Azure Managed Database.
    """
    __args__ = dict()
...
def get_managed_database_output(managed_instance_id: Optional[pulumi.Input[builtins.str]] = None,
