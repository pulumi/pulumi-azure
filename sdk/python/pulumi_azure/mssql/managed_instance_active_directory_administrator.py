...
class ManagedInstanceActiveDirectoryAdministratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] login_username: The login name of the principal to set as the Managed Instance Administrator.
        :param pulumi.Input[builtins.str] managed_instance_id: The ID of the Azure SQL Managed Instance for which to set the administrator. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] object_id: The Object ID of the principal to set as the Managed Instance Administrator.
        :param pulumi.Input[builtins.str] tenant_id: The Azure Active Directory Tenant ID.
        :param pulumi.Input[builtins.bool] azuread_authentication_only: When `true`, only permit logins from AAD users and administrators. When `false`, also allow local database users.
        """
...
class _ManagedInstanceActiveDirectoryAdministratorState:
    def __init__(__self__, *,
                 azuread_authentication_only: Optional[pulumi.Input[builtins.bool]] = None,
                 login_username: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="loginUsername")
    def login_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The login name of the principal to set as the Managed Instance Administrator.
        """
        return pulumi.get(self, "login_username")
    ...
    @login_username.setter
    def login_username(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "login_username", value)
...
class ManagedInstanceActiveDirectoryAdministrator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            managed_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            object_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedInstanceActiveDirectoryAdministrator':
        """
    ...
    @property
    @pulumi.getter(name="loginUsername")
    def login_username(self) -> pulumi.Output[builtins.str]:
        """
        The login name of the principal to set as the Managed Instance Administrator.
        """
        return pulumi.get(self, "login_username")
