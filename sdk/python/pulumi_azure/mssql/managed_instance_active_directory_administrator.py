...
class ManagedInstanceActiveDirectoryAdministrator(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        reader = azuread.index.directory_role.DirectoryRole("reader", display_name=Directory Readers)
        example_directory_role_member = azuread.index.directory_role_member.DirectoryRoleMember("example",
