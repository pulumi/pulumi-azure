...
class VirtualMachineAvailabilityGroupListenerArgs:
    def __init__(__self__, *,
                 ...
                 sql_virtual_machine_group_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] sql_virtual_machine_group_id: The ID of the SQL Virtual Machine Group to create the listener. Changing this forces a new resource to be created.
    ...
    def sql_virtual_machine_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sql_virtual_machine_group_id(self, value: pulumi.Input[builtins.str]):
...
class _VirtualMachineAvailabilityGroupListenerState:
    def __init__(__self__, *,
                 ...
                 sql_virtual_machine_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="sqlVirtualMachineGroupId")
    def sql_virtual_machine_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the SQL Virtual Machine Group to create the listener. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sql_virtual_machine_group_id")
    ...
    @sql_virtual_machine_group_id.setter
    def sql_virtual_machine_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sql_virtual_machine_group_id", value)
...
class VirtualMachineAvailabilityGroupListener(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[builtins.int]] = None,
            replicas: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VirtualMachineAvailabilityGroupListenerReplicaArgs', 'VirtualMachineAvailabilityGroupListenerReplicaArgsDict']]]]] = None,
            sql_virtual_machine_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualMachineAvailabilityGroupListener':
        """
    ...
    @property
    @pulumi.getter(name="availabilityGroupName")
    def availability_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Availability Group. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "availability_group_name")
    ...
    @property
    @pulumi.getter(name="sqlVirtualMachineGroupId")
    def sql_virtual_machine_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the SQL Virtual Machine Group to create the listener. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sql_virtual_machine_group_id")
