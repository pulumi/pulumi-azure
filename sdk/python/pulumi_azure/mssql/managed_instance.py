...
class ManagedInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        allow_management_inbound = azure.network.network_security_rule.NetworkSecurityRule("allow_management_inbound",
        ...
        allow_misubnet_inbound = azure.network.network_security_rule.NetworkSecurityRule("allow_misubnet_inbound",
            ...
            resource_group_name=example.name,
            network_security_group_name=example_network_security_group.name)
        allow_health_probe_inbound = azure.network.network_security_rule.NetworkSecurityRule("allow_health_probe_inbound",
            ...
            resource_group_name=example.name,
            network_security_group_name=example_network_security_group.name)
        allow_tds_inbound = azure.network.network_security_rule.NetworkSecurityRule("allow_tds_inbound",
            ...
            resource_group_name=example.name,
            network_security_group_name=example_network_security_group.name)
        deny_all_inbound = azure.network.network_security_rule.NetworkSecurityRule("deny_all_inbound",
            ...
            resource_group_name=example.name,
            network_security_group_name=example_network_security_group.name)
        allow_management_outbound = azure.network.network_security_rule.NetworkSecurityRule("allow_management_outbound",
            ...
            resource_group_name=example.name,
            network_security_group_name=example_network_security_group.name)
        allow_misubnet_outbound = azure.network.network_security_rule.NetworkSecurityRule("allow_misubnet_outbound",
            ...
            resource_group_name=example.name,
            network_security_group_name=example_network_security_group.name)
        deny_all_outbound = azure.network.network_security_rule.NetworkSecurityRule("deny_all_outbound",
