...
class ManagedInstanceArgs:
    def __init__(__self__, *,
                 ...
                 storage_size_in_gb: pulumi.Input[builtins.int],
                 subnet_id: pulumi.Input[builtins.str],
                 vcores: pulumi.Input[builtins.int],
                 ...
                 database_format: Optional[pulumi.Input[builtins.str]] = None,
                 dns_zone_partner_id: Optional[pulumi.Input[builtins.str]] = None,
                 hybrid_secondary_usage: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['ManagedInstanceIdentityArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
                 minimum_tls_version: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 proxy_override: Optional[pulumi.Input[builtins.str]] = None,
                 public_data_endpoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 service_principal_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 zone_redundant_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ManagedInstance resource.
        :param pulumi.Input[builtins.str] license_type: What type of license the Managed Instance will use. Possible values are `LicenseIncluded` and `BasePrice`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the SQL Managed Instance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: Specifies the SKU Name for the SQL Managed Instance. Valid values include `GP_Gen4`, `GP_Gen5`, `GP_Gen8IM`, `GP_Gen8IH`, `BC_Gen4`, `BC_Gen5`, `BC_Gen8IM` or `BC_Gen8IH`.
        :param pulumi.Input[builtins.int] storage_size_in_gb: Maximum storage space for the SQL Managed instance. This should be a multiple of 32 (GB).
        :param pulumi.Input[builtins.str] subnet_id: The subnet resource id that the SQL Managed Instance will be associated with.
        :param pulumi.Input[builtins.int] vcores: Number of cores that should be assigned to the SQL Managed Instance. Values can be `8`, `16`, or `24` for Gen4 SKUs, or `4`, `6`, `8`, `10`, `12`, `16`, `20`, `24`, `32`, `40`, `48`, `56`, `64`, `80`, `96` or `128` for Gen5 SKUs.
        :param pulumi.Input[builtins.str] administrator_login: The administrator login name for the new SQL Managed Instance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] administrator_login_password: The password associated with the `administrator_login` user. Needs to comply with Azure's [Password Policy](https://msdn.microsoft.com/library/ms161959.aspx)
        ...
        :param pulumi.Input[builtins.str] collation: Specifies how the SQL Managed Instance will be collated. Default value is `SQL_Latin1_General_CP1_CI_AS`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] database_format: Specifies the internal format of the SQL Managed Instance databases specific to the SQL engine version. Possible values are `AlwaysUpToDate` and `SQLServer2022`. Defaults to `SQLServer2022`.
               
               > **Note:** Changing `database_format` from `AlwaysUpToDate` to `SQLServer2022` forces a new SQL Managed Instance to be created.
        :param pulumi.Input[builtins.str] dns_zone_partner_id: The ID of the SQL Managed Instance which will share the DNS zone. This is a prerequisite for creating an `azurerm_sql_managed_instance_failover_group`. Setting this after creation forces a new resource to be created.
        :param pulumi.Input[builtins.str] hybrid_secondary_usage: Specifies the hybrid secondary usage for disaster recovery of the SQL Managed Instance. Possible values are `Active` and `Passive`. Defaults to `Active`.
        ...
        :param pulumi.Input[builtins.str] service_principal_type: The service principal type. The only possible value is `SystemAssigned`.
        :param pulumi.Input[builtins.str] storage_account_type: Specifies the storage account type used to store backups for this database. Possible values are `GRS`, `GZRS`, `LRS`, and `ZRS`. Defaults to `GRS`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] timezone_id: The TimeZone ID that the SQL Managed Instance will be operating in. Default value is `UTC`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] zone_redundant_enabled: Specifies whether or not the SQL Managed Instance is zone redundant. Defaults to `false`.
        """
    ...
    def storage_size_in_gb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def storage_size_in_gb(self, value: pulumi.Input[builtins.int]):
    ...
    @property
    @pulumi.getter
    def vcores(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @vcores.setter
    def vcores(self, value: pulumi.Input[builtins.int]):
    ...
    def database_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_format", value)

    @property
    @pulumi.getter(name="dnsZonePartnerId")
    def dns_zone_partner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_zone_partner_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_zone_partner_id", value)

    @property
    @pulumi.getter(name="hybridSecondaryUsage")
    def hybrid_secondary_usage(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hybrid_secondary_usage(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def maintenance_configuration_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def maintenance_configuration_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "maintenance_configuration_name", value)

    @property
    @pulumi.getter(name="minimumTlsVersion")
    def minimum_tls_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def minimum_tls_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def proxy_override(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def proxy_override(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_principal_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_principal_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def zone_redundant_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def zone_redundant_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ManagedInstanceState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 timezone_id: Optional[pulumi.Input[builtins.str]] = None,
                 vcores: Optional[pulumi.Input[builtins.int]] = None,
                 zone_redundant_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] database_format: Specifies the internal format of the SQL Managed Instance databases specific to the SQL engine version. Possible values are `AlwaysUpToDate` and `SQLServer2022`. Defaults to `SQLServer2022`.
               ...
               > **Note:** Changing `database_format` from `AlwaysUpToDate` to `SQLServer2022` forces a new SQL Managed Instance to be created.
        :param pulumi.Input[builtins.str] dns_zone: The Dns Zone where the SQL Managed Instance is located.
        :param pulumi.Input[builtins.str] dns_zone_partner_id: The ID of the SQL Managed Instance which will share the DNS zone. This is a prerequisite for creating an `azurerm_sql_managed_instance_failover_group`. Setting this after creation forces a new resource to be created.
        :param pulumi.Input[builtins.str] fqdn: The fully qualified domain name of the Azure Managed SQL Instance
        :param pulumi.Input[builtins.str] hybrid_secondary_usage: Specifies the hybrid secondary usage for disaster recovery of the SQL Managed Instance. Possible values are `Active` and `Passive`. Defaults to `Active`.
        :param pulumi.Input['ManagedInstanceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] license_type: What type of license the Managed Instance will use. Possible values are `LicenseIncluded` and `BasePrice`.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
    ...
    def dns_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dns_zone.setter
    def dns_zone(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def vcores(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of cores that should be assigned to the SQL Managed Instance. Values can be `8`, `16`, or `24` for Gen4 SKUs, or `4`, `6`, `8`, `10`, `12`, `16`, `20`, `24`, `32`, `40`, `48`, `56`, `64`, `80`, `96` or `128` for Gen5 SKUs.
        """
        return pulumi.get(self, "vcores")
    ...
    @vcores.setter
    def vcores(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "vcores", value)
...
class ManagedInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timezone_id: Optional[pulumi.Input[builtins.str]] = None,
            vcores: Optional[pulumi.Input[builtins.int]] = None,
            zone_redundant_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'ManagedInstance':
        """
    ...
    @property
    @pulumi.getter(name="dnsZonePartnerId")
    def dns_zone_partner_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the SQL Managed Instance which will share the DNS zone. This is a prerequisite for creating an `azurerm_sql_managed_instance_failover_group`. Setting this after creation forces a new resource to be created.
        """
        return pulumi.get(self, "dns_zone_partner_id")
    ...
    @property
    @pulumi.getter(name="maintenanceConfigurationName")
    def maintenance_configuration_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Public Maintenance Configuration window to apply to the SQL Managed Instance. Valid values include `SQL_Default` or an Azure Location in the format `SQL_{Location}_MI_{Size}`(for example `SQL_EastUS_MI_1`). Defaults to `SQL_Default`.
        """
        return pulumi.get(self, "maintenance_configuration_name")
    ...
    @property
    @pulumi.getter(name="servicePrincipalType")
    def service_principal_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The service principal type. The only possible value is `SystemAssigned`.
        """
        return pulumi.get(self, "service_principal_type")
    ...
    @property
    @pulumi.getter(name="storageAccountType")
    def storage_account_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the storage account type used to store backups for this database. Possible values are `GRS`, `GZRS`, `LRS`, and `ZRS`. Defaults to `GRS`.
        """
        return pulumi.get(self, "storage_account_type")
    ...
    @property
    @pulumi.getter(name="storageSizeInGb")
    def storage_size_in_gb(self) -> pulumi.Output[builtins.int]:
        """
        Maximum storage space for the SQL Managed instance. This should be a multiple of 32 (GB).
        """
        return pulumi.get(self, "storage_size_in_gb")
    ...
    @property
    @pulumi.getter
    def vcores(self) -> pulumi.Output[builtins.int]:
        """
        Number of cores that should be assigned to the SQL Managed Instance. Values can be `8`, `16`, or `24` for Gen4 SKUs, or `4`, `6`, `8`, `10`, `12`, `16`, `20`, `24`, `32`, `40`, `48`, `56`, `64`, `80`, `96` or `128` for Gen5 SKUs.
        """
        return pulumi.get(self, "vcores")
    ...
    @property
    @pulumi.getter(name="zoneRedundantEnabled")
    def zone_redundant_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether or not the SQL Managed Instance is zone redundant. Defaults to `false`.
        """
        return pulumi.get(self, "zone_redundant_enabled")
