...
class ServerArgs:
    def __init__(__self__, *,
                 ...
                 outbound_network_restriction_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Microsoft SQL Server. Changing this forces a new resource to be created.
    ...
    def connection_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def outbound_network_restriction_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def outbound_network_restriction_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ServerState:
    def __init__(__self__, *,
                 ...
                 restorable_dropped_database_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 transparent_data_encryption_key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether public network access is allowed for this server. Defaults to `true`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Microsoft SQL Server. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] restorable_dropped_database_ids: A list of dropped restorable database IDs on the server.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] transparent_data_encryption_key_vault_key_id: The fully versioned `Key Vault` `Key` URL (e.g. `'https://<YourVaultName>.vault.azure.net/keys/<YourKeyName>/<YourKeyVersion>`) to be used as the `Customer Managed Key`(CMK/BYOK) for the `Transparent Data Encryption`(TDE) layer.
    ...
    def restorable_dropped_database_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def restorable_dropped_database_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Server(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="connectionPolicy")
    def connection_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The connection policy the server will use. Possible values are `Default`, `Proxy`, and `Redirect`. Defaults to `Default`.
        """
        return pulumi.get(self, "connection_policy")
    ...
    @property
    @pulumi.getter(name="outboundNetworkRestrictionEnabled")
    def outbound_network_restriction_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether outbound network traffic is restricted for this server. Defaults to `false`.
        """
        return pulumi.get(self, "outbound_network_restriction_enabled")
    ...
    @property
    @pulumi.getter(name="primaryUserAssignedIdentityId")
    def primary_user_assigned_identity_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the primary user managed identity id. Required if `type` within the `identity` block is set to either `SystemAssigned, UserAssigned` or `UserAssigned` and should be set at same time as setting `identity_ids`.
        """
        return pulumi.get(self, "primary_user_assigned_identity_id")
    ...
    @property
    @pulumi.getter(name="restorableDroppedDatabaseIds")
    def restorable_dropped_database_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of dropped restorable database IDs on the server.
        """
        return pulumi.get(self, "restorable_dropped_database_ids")
