...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 auto_pause_delay_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 collation: Optional[pulumi.Input[builtins.str]] = None,
                 create_mode: Optional[pulumi.Input[builtins.str]] = None,
                 creation_source_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 elastic_pool_id: Optional[pulumi.Input[builtins.str]] = None,
                 enclave_type: Optional[pulumi.Input[builtins.str]] = None,
                 geo_backup_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 identity: Optional[pulumi.Input['DatabaseIdentityArgs']] = None,
                 import_: Optional[pulumi.Input['DatabaseImportArgs']] = None,
                 ledger_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 max_size_gb: Optional[pulumi.Input[builtins.int]] = None,
                 min_capacity: Optional[pulumi.Input[builtins.float]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 read_replica_count: Optional[pulumi.Input[builtins.int]] = None,
                 read_scale: Optional[pulumi.Input[builtins.bool]] = None,
                 recover_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_point_id: Optional[pulumi.Input[builtins.str]] = None,
                 restore_dropped_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 restore_long_term_retention_backup_id: Optional[pulumi.Input[builtins.str]] = None,
                 restore_point_in_time: Optional[pulumi.Input[builtins.str]] = None,
                 sample_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 transparent_data_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 transparent_data_encryption_key_automatic_rotation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 transparent_data_encryption_key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 zone_redundant: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Database resource.
        :param pulumi.Input[builtins.str] server_id: The id of the MS SQL Server on which to create the database. Changing this forces a new resource to be created.
               
               > **Note:** This setting is still required for "Serverless" SKUs
        :param pulumi.Input[builtins.int] auto_pause_delay_in_minutes: Time in minutes after which database is automatically paused. A value of `-1` means that automatic pause is disabled. This property is only settable for Serverless databases.
        :param pulumi.Input[builtins.str] collation: Specifies the collation of the database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] create_mode: The create mode of the database. Possible values are `Copy`, `Default`, `OnlineSecondary`, `PointInTimeRestore`, `Recovery`, `Restore`, `RestoreExternalBackup`, `RestoreExternalBackupSecondary`, `RestoreLongTermRetentionBackup` and `Secondary`. Mutually exclusive with `import`. Changing this forces a new resource to be created. Defaults to `Default`.
        :param pulumi.Input[builtins.str] creation_source_database_id: The ID of the source database from which to create the new database. This should only be used for databases with `create_mode` values that use another database as reference. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] elastic_pool_id: Specifies the ID of the elastic pool containing this database.
        :param pulumi.Input[builtins.str] enclave_type: Specifies the type of enclave to be used by the elastic pool. When `enclave_type` is not specified (e.g., the default) enclaves are not enabled on the database. Once enabled (e.g., by specifying `Default` or `VBS`) removing the `enclave_type` field from the configuration file will force the creation of a new resource. Possible values are `Default` or `VBS`.
        ...
        :param pulumi.Input[builtins.bool] geo_backup_enabled: A boolean that specifies if the Geo Backup Policy is enabled. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.bool] ledger_enabled: A boolean that specifies if this is a ledger database. Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] license_type: Specifies the license type applied to this database. Possible values are `LicenseIncluded` and `BasePrice`.
        ...
        :param pulumi.Input[builtins.float] min_capacity: Minimal capacity that database will always have allocated, if not paused. This property is only settable for Serverless databases.
        :param pulumi.Input[builtins.str] name: The name of the MS SQL Database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] read_replica_count: The number of readonly secondary replicas associated with the database to which readonly application intent connections may be routed. This property is only settable for Hyperscale edition databases.
        :param pulumi.Input[builtins.bool] read_scale: If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica. This property is only settable for Premium and Business Critical databases.
        :param pulumi.Input[builtins.str] recover_database_id: The ID of the database to be recovered. This property is only applicable when the `create_mode` is `Recovery`.
        :param pulumi.Input[builtins.str] recovery_point_id: The ID of the Recovery Services Recovery Point Id to be restored. This property is only applicable when the `create_mode` is `Recovery`.
        :param pulumi.Input[builtins.str] restore_dropped_database_id: The ID of the database to be restored. This property is only applicable when the `create_mode` is `Restore`.
        :param pulumi.Input[builtins.str] restore_long_term_retention_backup_id: The ID of the long term retention backup to be restored. This property is only applicable when the `create_mode` is `RestoreLongTermRetentionBackup`.
        :param pulumi.Input[builtins.str] restore_point_in_time: Specifies the point in time (ISO8601 format) of the source database that will be restored to create the new database. This property is only settable for `create_mode`= `PointInTimeRestore` databases.
        :param pulumi.Input[builtins.str] sample_name: Specifies the name of the sample schema to apply when creating this database. Possible value is `AdventureWorksLT`.
        :param pulumi.Input[builtins.str] secondary_type: How do you want your replica to be made? Valid values include `Geo` and `Named`. Defaults to `Geo`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] sku_name: Specifies the name of the SKU used by the database. For example, `GP_S_Gen5_2`,`HS_Gen4_1`,`BC_Gen5_2`, `ElasticPool`, `Basic`,`S0`, `P2` ,`DW100c`, `DS100`. Changing this from the HyperScale service tier to another service tier will create a new resource.
        ...
        :param pulumi.Input[builtins.str] storage_account_type: Specifies the storage account type used to store backups for this database. Possible values are `Geo`, `GeoZone`, `Local` and `Zone`. Defaults to `Geo`.
        ...
        :param pulumi.Input[builtins.bool] transparent_data_encryption_enabled: If set to true, Transparent Data Encryption will be enabled on the database. Defaults to `true`.
               
               > **Note:** `transparent_data_encryption_enabled` can only be set to `false` on DW (e.g, DataWarehouse) server SKUs.
        :param pulumi.Input[builtins.bool] transparent_data_encryption_key_automatic_rotation_enabled: Boolean flag to specify whether TDE automatically rotates the encryption Key to latest version or not. Possible values are `true` or `false`. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.bool] zone_redundant: Whether or not this database is zone redundant, which means the replicas of this database will be spread across multiple availability zones. This property is only settable for Premium and Business Critical databases.
        """
    ...
    def auto_pause_delay_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def auto_pause_delay_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def creation_source_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def creation_source_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enclave_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @enclave_type.setter
    def enclave_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enclave_type", value)

    @property
    @pulumi.getter(name="geoBackupEnabled")
    def geo_backup_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def geo_backup_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ledger_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ledger_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def max_size_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @max_size_gb.setter
    def max_size_gb(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def read_scale(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @read_scale.setter
    def read_scale(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "read_scale", value)

    @property
    @pulumi.getter(name="recoverDatabaseId")
    def recover_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def recover_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recover_database_id", value)

    @property
    @pulumi.getter(name="recoveryPointId")
    def recovery_point_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def recovery_point_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recovery_point_id", value)

    @property
    @pulumi.getter(name="restoreDroppedDatabaseId")
    def restore_dropped_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_dropped_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restore_dropped_database_id", value)

    @property
    @pulumi.getter(name="restoreLongTermRetentionBackupId")
    def restore_long_term_retention_backup_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_long_term_retention_backup_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sample_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sample_name.setter
    def sample_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def transparent_data_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def transparent_data_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def transparent_data_encryption_key_automatic_rotation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def transparent_data_encryption_key_automatic_rotation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def transparent_data_encryption_key_vault_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def transparent_data_encryption_key_vault_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Database(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transparent_data_encryption_key_automatic_rotation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            transparent_data_encryption_key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
            zone_redundant: Optional[pulumi.Input[builtins.bool]] = None) -> 'Database':
        """
    ...
    @property
    @pulumi.getter(name="autoPauseDelayInMinutes")
    def auto_pause_delay_in_minutes(self) -> pulumi.Output[builtins.int]:
        """
        Time in minutes after which database is automatically paused. A value of `-1` means that automatic pause is disabled. This property is only settable for Serverless databases.
        """
        return pulumi.get(self, "auto_pause_delay_in_minutes")
    ...
    @property
    @pulumi.getter(name="creationSourceDatabaseId")
    def creation_source_database_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the source database from which to create the new database. This should only be used for databases with `create_mode` values that use another database as reference. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="enclaveType")
    def enclave_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the type of enclave to be used by the elastic pool. When `enclave_type` is not specified (e.g., the default) enclaves are not enabled on the database. Once enabled (e.g., by specifying `Default` or `VBS`) removing the `enclave_type` field from the configuration file will force the creation of a new resource. Possible values are `Default` or `VBS`.
    ...
    @property
    @pulumi.getter(name="geoBackupEnabled")
    def geo_backup_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean that specifies if the Geo Backup Policy is enabled. Defaults to `true`.
    ...
    @property
    @pulumi.getter(name="ledgerEnabled")
    def ledger_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        A boolean that specifies if this is a ledger database. Defaults to `false`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "ledger_enabled")
    ...
    @property
    @pulumi.getter(name="maintenanceConfigurationName")
    def maintenance_configuration_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Public Maintenance Configuration window to apply to the database. Valid values include `SQL_Default`, `SQL_EastUS_DB_1`, `SQL_EastUS2_DB_1`, `SQL_SoutheastAsia_DB_1`, `SQL_AustraliaEast_DB_1`, `SQL_NorthEurope_DB_1`, `SQL_SouthCentralUS_DB_1`, `SQL_WestUS2_DB_1`, `SQL_UKSouth_DB_1`, `SQL_WestEurope_DB_1`, `SQL_EastUS_DB_2`, `SQL_EastUS2_DB_2`, `SQL_WestUS2_DB_2`, `SQL_SoutheastAsia_DB_2`, `SQL_AustraliaEast_DB_2`, `SQL_NorthEurope_DB_2`, `SQL_SouthCentralUS_DB_2`, `SQL_UKSouth_DB_2`, `SQL_WestEurope_DB_2`, `SQL_AustraliaSoutheast_DB_1`, `SQL_BrazilSouth_DB_1`, `SQL_CanadaCentral_DB_1`, `SQL_CanadaEast_DB_1`, `SQL_CentralUS_DB_1`, `SQL_EastAsia_DB_1`, `SQL_FranceCentral_DB_1`, `SQL_GermanyWestCentral_DB_1`, `SQL_CentralIndia_DB_1`, `SQL_SouthIndia_DB_1`, `SQL_JapanEast_DB_1`, `SQL_JapanWest_DB_1`, `SQL_NorthCentralUS_DB_1`, `SQL_UKWest_DB_1`, `SQL_WestUS_DB_1`, `SQL_AustraliaSoutheast_DB_2`, `SQL_BrazilSouth_DB_2`, `SQL_CanadaCentral_DB_2`, `SQL_CanadaEast_DB_2`, `SQL_CentralUS_DB_2`, `SQL_EastAsia_DB_2`, `SQL_FranceCentral_DB_2`, `SQL_GermanyWestCentral_DB_2`, `SQL_CentralIndia_DB_2`, `SQL_SouthIndia_DB_2`, `SQL_JapanEast_DB_2`, `SQL_JapanWest_DB_2`, `SQL_NorthCentralUS_DB_2`, `SQL_UKWest_DB_2`, `SQL_WestUS_DB_2`, `SQL_WestCentralUS_DB_1`, `SQL_FranceSouth_DB_1`, `SQL_WestCentralUS_DB_2`, `SQL_FranceSouth_DB_2`, `SQL_SwitzerlandNorth_DB_1`, `SQL_SwitzerlandNorth_DB_2`, `SQL_BrazilSoutheast_DB_1`, `SQL_UAENorth_DB_1`, `SQL_BrazilSoutheast_DB_2`, `SQL_UAENorth_DB_2`, `SQL_SouthAfricaNorth_DB_1`, `SQL_SouthAfricaNorth_DB_2`, `SQL_WestUS3_DB_1`, `SQL_WestUS3_DB_2`, `SQL_SwedenCentral_DB_1`, `SQL_SwedenCentral_DB_2`. Defaults to `SQL_Default`.
    ...
    @property
    @pulumi.getter(name="maxSizeGb")
    def max_size_gb(self) -> pulumi.Output[builtins.int]:
        """
        The max size of the database in gigabytes.
    ...
    @property
    @pulumi.getter(name="minCapacity")
    def min_capacity(self) -> pulumi.Output[builtins.float]:
        """
        Minimal capacity that database will always have allocated, if not paused. This property is only settable for Serverless databases.
        """
        return pulumi.get(self, "min_capacity")
    ...
    @property
    @pulumi.getter(name="readReplicaCount")
    def read_replica_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of readonly secondary replicas associated with the database to which readonly application intent connections may be routed. This property is only settable for Hyperscale edition databases.
        """
        return pulumi.get(self, "read_replica_count")
    ...
    @property
    @pulumi.getter(name="readScale")
    def read_scale(self) -> pulumi.Output[builtins.bool]:
        """
        If enabled, connections that have application intent set to readonly in their connection string may be routed to a readonly secondary replica. This property is only settable for Premium and Business Critical databases.
        """
        return pulumi.get(self, "read_scale")
    ...
    @property
    @pulumi.getter(name="recoverDatabaseId")
    def recover_database_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the database to be recovered. This property is only applicable when the `create_mode` is `Recovery`.
        """
        return pulumi.get(self, "recover_database_id")
    ...
    @property
    @pulumi.getter(name="recoveryPointId")
    def recovery_point_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Recovery Services Recovery Point Id to be restored. This property is only applicable when the `create_mode` is `Recovery`.
        """
        return pulumi.get(self, "recovery_point_id")
    ...
    @property
    @pulumi.getter(name="restoreDroppedDatabaseId")
    def restore_dropped_database_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the database to be restored. This property is only applicable when the `create_mode` is `Restore`.
        """
        return pulumi.get(self, "restore_dropped_database_id")
    ...
    @property
    @pulumi.getter(name="restoreLongTermRetentionBackupId")
    def restore_long_term_retention_backup_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the long term retention backup to be restored. This property is only applicable when the `create_mode` is `RestoreLongTermRetentionBackup`.
        """
        return pulumi.get(self, "restore_long_term_retention_backup_id")
    ...
    @property
    @pulumi.getter(name="restorePointInTime")
    def restore_point_in_time(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the point in time (ISO8601 format) of the source database that will be restored to create the new database. This property is only settable for `create_mode`= `PointInTimeRestore` databases.
        """
        return pulumi.get(self, "restore_point_in_time")
    ...
    @property
    @pulumi.getter(name="sampleName")
    def sample_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the sample schema to apply when creating this database. Possible value is `AdventureWorksLT`.
        """
        return pulumi.get(self, "sample_name")
    ...
    @property
    @pulumi.getter(name="secondaryType")
    def secondary_type(self) -> pulumi.Output[builtins.str]:
        """
        How do you want your replica to be made? Valid values include `Geo` and `Named`. Defaults to `Geo`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "secondary_type")
    ...
    @property
    @pulumi.getter(name="transparentDataEncryptionEnabled")
    def transparent_data_encryption_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to true, Transparent Data Encryption will be enabled on the database. Defaults to `true`.
    ...
    @property
    @pulumi.getter(name="transparentDataEncryptionKeyAutomaticRotationEnabled")
    def transparent_data_encryption_key_automatic_rotation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean flag to specify whether TDE automatically rotates the encryption Key to latest version or not. Possible values are `true` or `false`. Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="transparentDataEncryptionKeyVaultKeyId")
    def transparent_data_encryption_key_vault_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The fully versioned `Key Vault` `Key` URL (e.g. `'https://<YourVaultName>.vault.azure.net/keys/<YourKeyName>/<YourKeyVersion>`) to be used as the `Customer Managed Key`(CMK/BYOK) for the `Transparent Data Encryption`(TDE) layer.
    ...
    @property
    @pulumi.getter(name="zoneRedundant")
    def zone_redundant(self) -> pulumi.Output[builtins.bool]:
        """
        Whether or not this database is zone redundant, which means the replicas of this database will be spread across multiple availability zones. This property is only settable for Premium and Business Critical databases.
        """
        return pulumi.get(self, "zone_redundant")
