...
class JobScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] end_time: The end time of the schedule. Must be in RFC3339 format.
        :param pulumi.Input[_builtins.str] interval: The interval between job executions. Must be in ISO8601 duration format.
        :param pulumi.Input[_builtins.str] start_time: The start time of the schedule. Must be in RFC3339 format.
        """
...
class JobSchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            job_id: Optional[pulumi.Input[_builtins.str]] = None,
            start_time: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'JobSchedule':
        """
