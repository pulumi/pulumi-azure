...
class GetManagedInstanceResult:
    ...
    def customer_managed_key_id(self) -> _builtins.str:
    ...
    def dns_zone_partner_id(self) -> _builtins.str:
        """
    ...
    def proxy_override(self) -> _builtins.str:
        """
    ...
    def public_data_endpoint_enabled(self) -> _builtins.bool:
        """
    ...
    def storage_size_in_gb(self) -> _builtins.int:
        """
...
def get_managed_instance(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Sql` - 2023-08-01-preview
    ...
    :param _builtins.str resource_group_name: The name of the resource group where the SQL Managed Instance exists.
    """
    __args__ = dict()
    __args__['name'] = name
