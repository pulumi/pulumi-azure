...
class VirtualMachineArgs:
    def __init__(__self__, *,
                 ...
                 assessment: pulumi.Input[Optional['VirtualMachineAssessmentArgs']] = None,
                 auto_backup: pulumi.Input[Optional['VirtualMachineAutoBackupArgs']] = None,
                 auto_patching: pulumi.Input[Optional['VirtualMachineAutoPatchingArgs']] = None,
                 key_vault_credential: pulumi.Input[Optional['VirtualMachineKeyVaultCredentialArgs']] = None,
                 r_services_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 sql_connectivity_port: pulumi.Input[Optional[_builtins.int]] = None,
                 sql_connectivity_type: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_connectivity_update_password: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_connectivity_update_username: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_instance: pulumi.Input[Optional['VirtualMachineSqlInstanceArgs']] = None,
                 sql_license_type: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_virtual_machine_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_configuration: pulumi.Input[Optional['VirtualMachineStorageConfigurationArgs']] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 wsfc_domain_credential: pulumi.Input[Optional['VirtualMachineWsfcDomainCredentialArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] r_services_enabled: Should R Services be enabled?
        :param pulumi.Input[_builtins.int] sql_connectivity_port: The SQL Server port. Defaults to `1433`.
        :param pulumi.Input[_builtins.str] sql_connectivity_type: The connectivity type used for this SQL Server. Possible values are `LOCAL`, `PRIVATE` and `PUBLIC`. Defaults to `PRIVATE`.
        :param pulumi.Input[_builtins.str] sql_connectivity_update_password: The SQL Server sysadmin login password.
        :param pulumi.Input[_builtins.str] sql_connectivity_update_username: The SQL Server sysadmin login to create.
        :param pulumi.Input['VirtualMachineSqlInstanceArgs'] sql_instance: A `sql_instance` block as defined below.
        :param pulumi.Input[_builtins.str] sql_license_type: The SQL Server license type. Possible values are `AHUB` (Azure Hybrid Benefit), `DR` (Disaster Recovery), and `PAYG` (Pay-As-You-Go). Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] sql_virtual_machine_group_id: The ID of the SQL Virtual Machine Group that the SQL Virtual Machine belongs to.
    ...
    @_builtins.property
    @pulumi.getter
    def assessment(self) -> pulumi.Input[Optional['VirtualMachineAssessmentArgs']]:
        """
    ...
    @assessment.setter
    def assessment(self, value: pulumi.Input[Optional['VirtualMachineAssessmentArgs']]):
        pulumi.set(self, "assessment", value)

    @_builtins.property
    @pulumi.getter(name="autoBackup")
    def auto_backup(self) -> pulumi.Input[Optional['VirtualMachineAutoBackupArgs']]:
        """
    ...
    @auto_backup.setter
    def auto_backup(self, value: pulumi.Input[Optional['VirtualMachineAutoBackupArgs']]):
        pulumi.set(self, "auto_backup", value)

    @_builtins.property
    @pulumi.getter(name="autoPatching")
    def auto_patching(self) -> pulumi.Input[Optional['VirtualMachineAutoPatchingArgs']]:
        """
    ...
    def auto_patching(self, value: pulumi.Input[Optional['VirtualMachineAutoPatchingArgs']]):
        pulumi.set(self, "auto_patching", value)

    @_builtins.property
    @pulumi.getter(name="keyVaultCredential")
    def key_vault_credential(self) -> pulumi.Input[Optional['VirtualMachineKeyVaultCredentialArgs']]:
        """
    ...
    def key_vault_credential(self, value: pulumi.Input[Optional['VirtualMachineKeyVaultCredentialArgs']]):
        pulumi.set(self, "key_vault_credential", value)

    @_builtins.property
    @pulumi.getter(name="rServicesEnabled")
    def r_services_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def r_services_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "r_services_enabled", value)

    @_builtins.property
    @pulumi.getter(name="sqlConnectivityPort")
    def sql_connectivity_port(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def sql_connectivity_port(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "sql_connectivity_port", value)

    @_builtins.property
    @pulumi.getter(name="sqlConnectivityType")
    def sql_connectivity_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def sql_connectivity_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sql_connectivity_type", value)

    @_builtins.property
    @pulumi.getter(name="sqlConnectivityUpdatePassword")
    def sql_connectivity_update_password(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def sql_connectivity_update_password(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sql_connectivity_update_password", value)

    @_builtins.property
    @pulumi.getter(name="sqlConnectivityUpdateUsername")
    def sql_connectivity_update_username(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def sql_connectivity_update_username(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sql_connectivity_update_username", value)

    @_builtins.property
    @pulumi.getter(name="sqlInstance")
    def sql_instance(self) -> pulumi.Input[Optional['VirtualMachineSqlInstanceArgs']]:
        """
    ...
    @sql_instance.setter
    def sql_instance(self, value: pulumi.Input[Optional['VirtualMachineSqlInstanceArgs']]):
        pulumi.set(self, "sql_instance", value)

    @_builtins.property
    @pulumi.getter(name="sqlLicenseType")
    def sql_license_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def sql_license_type(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def storage_configuration(self) -> pulumi.Input[Optional['VirtualMachineStorageConfigurationArgs']]:
        """
    ...
    def storage_configuration(self, value: pulumi.Input[Optional['VirtualMachineStorageConfigurationArgs']]):
    ...
    def wsfc_domain_credential(self) -> pulumi.Input[Optional['VirtualMachineWsfcDomainCredentialArgs']]:
        """
    ...
    def wsfc_domain_credential(self, value: pulumi.Input[Optional['VirtualMachineWsfcDomainCredentialArgs']]):
...
class VirtualMachine(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 assessment: pulumi.Input[Optional[Union['VirtualMachineAssessmentArgs', 'VirtualMachineAssessmentArgsDict', 'outputs.VirtualMachineAssessment']]] = None,
                 auto_backup: pulumi.Input[Optional[Union['VirtualMachineAutoBackupArgs', 'VirtualMachineAutoBackupArgsDict', 'outputs.VirtualMachineAutoBackup']]] = None,
                 auto_patching: pulumi.Input[Optional[Union['VirtualMachineAutoPatchingArgs', 'VirtualMachineAutoPatchingArgsDict', 'outputs.VirtualMachineAutoPatching']]] = None,
                 key_vault_credential: pulumi.Input[Optional[Union['VirtualMachineKeyVaultCredentialArgs', 'VirtualMachineKeyVaultCredentialArgsDict', 'outputs.VirtualMachineKeyVaultCredential']]] = None,
                 r_services_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 sql_connectivity_port: pulumi.Input[Optional[_builtins.int]] = None,
                 sql_connectivity_type: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_connectivity_update_password: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_connectivity_update_username: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_instance: pulumi.Input[Optional[Union['VirtualMachineSqlInstanceArgs', 'VirtualMachineSqlInstanceArgsDict', 'outputs.VirtualMachineSqlInstance']]] = None,
                 sql_license_type: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_virtual_machine_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_configuration: pulumi.Input[Optional[Union['VirtualMachineStorageConfigurationArgs', 'VirtualMachineStorageConfigurationArgsDict', 'outputs.VirtualMachineStorageConfiguration']]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 virtual_machine_id: pulumi.Input[Optional[_builtins.str]] = None,
                 wsfc_domain_credential: pulumi.Input[Optional[Union['VirtualMachineWsfcDomainCredentialArgs', 'VirtualMachineWsfcDomainCredentialArgsDict', 'outputs.VirtualMachineWsfcDomainCredential']]] = None,
                 __props__=None):
        """
        ...
        * `Microsoft.SqlVirtualMachine` - 2023-10-01
        ...
        :param pulumi.Input[Union['VirtualMachineAssessmentArgs', 'VirtualMachineAssessmentArgsDict', 'outputs.VirtualMachineAssessment']] assessment: An `assessment` block as defined below.
        :param pulumi.Input[Union['VirtualMachineAutoBackupArgs', 'VirtualMachineAutoBackupArgsDict', 'outputs.VirtualMachineAutoBackup']] auto_backup: An `auto_backup` block as defined below. This block can be added to an existing resource, but removing this block forces a new resource to be created.
        :param pulumi.Input[Union['VirtualMachineAutoPatchingArgs', 'VirtualMachineAutoPatchingArgsDict', 'outputs.VirtualMachineAutoPatching']] auto_patching: An `auto_patching` block as defined below.
        :param pulumi.Input[Union['VirtualMachineKeyVaultCredentialArgs', 'VirtualMachineKeyVaultCredentialArgsDict', 'outputs.VirtualMachineKeyVaultCredential']] key_vault_credential: An `key_vault_credential` block as defined below.
        :param pulumi.Input[_builtins.bool] r_services_enabled: Should R Services be enabled?
        :param pulumi.Input[_builtins.int] sql_connectivity_port: The SQL Server port. Defaults to `1433`.
        :param pulumi.Input[_builtins.str] sql_connectivity_type: The connectivity type used for this SQL Server. Possible values are `LOCAL`, `PRIVATE` and `PUBLIC`. Defaults to `PRIVATE`.
        :param pulumi.Input[_builtins.str] sql_connectivity_update_password: The SQL Server sysadmin login password.
        :param pulumi.Input[_builtins.str] sql_connectivity_update_username: The SQL Server sysadmin login to create.
        :param pulumi.Input[Union['VirtualMachineSqlInstanceArgs', 'VirtualMachineSqlInstanceArgsDict', 'outputs.VirtualMachineSqlInstance']] sql_instance: A `sql_instance` block as defined below.
        :param pulumi.Input[_builtins.str] sql_license_type: The SQL Server license type. Possible values are `AHUB` (Azure Hybrid Benefit), `DR` (Disaster Recovery), and `PAYG` (Pay-As-You-Go). Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] sql_virtual_machine_group_id: The ID of the SQL Virtual Machine Group that the SQL Virtual Machine belongs to.
        :param pulumi.Input[Union['VirtualMachineStorageConfigurationArgs', 'VirtualMachineStorageConfigurationArgsDict', 'outputs.VirtualMachineStorageConfiguration']] storage_configuration: An `storage_configuration` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[_builtins.str] virtual_machine_id: The ID of the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['VirtualMachineWsfcDomainCredentialArgs', 'VirtualMachineWsfcDomainCredentialArgsDict', 'outputs.VirtualMachineWsfcDomainCredential']] wsfc_domain_credential: A `wsfc_domain_credential` block as defined below
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            virtual_machine_id: pulumi.Input[Optional[_builtins.str]] = None,
            wsfc_domain_credential: pulumi.Input[Optional[Union['VirtualMachineWsfcDomainCredentialArgs', 'VirtualMachineWsfcDomainCredentialArgsDict', 'outputs.VirtualMachineWsfcDomainCredential']]] = None) -> 'VirtualMachine':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="rServicesEnabled")
    def r_services_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Should R Services be enabled?
        """
        return pulumi.get(self, "r_services_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlConnectivityPort")
    def sql_connectivity_port(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The SQL Server port. Defaults to `1433`.
        """
        return pulumi.get(self, "sql_connectivity_port")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlConnectivityType")
    def sql_connectivity_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The connectivity type used for this SQL Server. Possible values are `LOCAL`, `PRIVATE` and `PUBLIC`. Defaults to `PRIVATE`.
        """
        return pulumi.get(self, "sql_connectivity_type")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlConnectivityUpdatePassword")
    def sql_connectivity_update_password(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The SQL Server sysadmin login password.
        """
        return pulumi.get(self, "sql_connectivity_update_password")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlConnectivityUpdateUsername")
    def sql_connectivity_update_username(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The SQL Server sysadmin login to create.
        """
        return pulumi.get(self, "sql_connectivity_update_username")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlLicenseType")
    def sql_license_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The SQL Server license type. Possible values are `AHUB` (Azure Hybrid Benefit), `DR` (Disaster Recovery), and `PAYG` (Pay-As-You-Go). Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sql_license_type")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlVirtualMachineGroupId")
    def sql_virtual_machine_group_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the SQL Virtual Machine Group that the SQL Virtual Machine belongs to.
        """
        return pulumi.get(self, "sql_virtual_machine_group_id")
