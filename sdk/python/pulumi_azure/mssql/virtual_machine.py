...
class VirtualMachineArgs:
    def __init__(__self__, *,
                 ...
                 r_services_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sql_connectivity_port: Optional[pulumi.Input[builtins.int]] = None,
                 sql_connectivity_type: Optional[pulumi.Input[builtins.str]] = None,
                 sql_connectivity_update_password: Optional[pulumi.Input[builtins.str]] = None,
                 sql_connectivity_update_username: Optional[pulumi.Input[builtins.str]] = None,
                 sql_instance: Optional[pulumi.Input['VirtualMachineSqlInstanceArgs']] = None,
                 sql_license_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] r_services_enabled: Should R Services be enabled?
        :param pulumi.Input[builtins.int] sql_connectivity_port: The SQL Server port. Defaults to `1433`.
        :param pulumi.Input[builtins.str] sql_connectivity_type: The connectivity type used for this SQL Server. Possible values are `LOCAL`, `PRIVATE` and `PUBLIC`. Defaults to `PRIVATE`.
        :param pulumi.Input[builtins.str] sql_connectivity_update_password: The SQL Server sysadmin login password.
        :param pulumi.Input[builtins.str] sql_connectivity_update_username: The SQL Server sysadmin login to create.
        :param pulumi.Input['VirtualMachineSqlInstanceArgs'] sql_instance: A `sql_instance` block as defined below.
        :param pulumi.Input[builtins.str] sql_license_type: The SQL Server license type. Possible values are `AHUB` (Azure Hybrid Benefit), `DR` (Disaster Recovery), and `PAYG` (Pay-As-You-Go). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sql_virtual_machine_group_id: The ID of the SQL Virtual Machine Group that the SQL Virtual Machine belongs to.
    ...
    def r_services_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def r_services_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "r_services_enabled", value)

    @property
    @pulumi.getter(name="sqlConnectivityPort")
    def sql_connectivity_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def sql_connectivity_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "sql_connectivity_port", value)

    @property
    @pulumi.getter(name="sqlConnectivityType")
    def sql_connectivity_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sql_connectivity_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sql_connectivity_type", value)

    @property
    @pulumi.getter(name="sqlConnectivityUpdatePassword")
    def sql_connectivity_update_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sql_connectivity_update_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sql_connectivity_update_password", value)

    @property
    @pulumi.getter(name="sqlConnectivityUpdateUsername")
    def sql_connectivity_update_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sql_connectivity_update_username(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sql_license_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sql_license_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VirtualMachine(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="rServicesEnabled")
    def r_services_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should R Services be enabled?
        """
        return pulumi.get(self, "r_services_enabled")
    ...
    @property
    @pulumi.getter(name="sqlConnectivityPort")
    def sql_connectivity_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The SQL Server port. Defaults to `1433`.
        """
        return pulumi.get(self, "sql_connectivity_port")
    ...
    @property
    @pulumi.getter(name="sqlConnectivityType")
    def sql_connectivity_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The connectivity type used for this SQL Server. Possible values are `LOCAL`, `PRIVATE` and `PUBLIC`. Defaults to `PRIVATE`.
        """
        return pulumi.get(self, "sql_connectivity_type")
    ...
    @property
    @pulumi.getter(name="sqlConnectivityUpdatePassword")
    def sql_connectivity_update_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SQL Server sysadmin login password.
        """
        return pulumi.get(self, "sql_connectivity_update_password")
    ...
    @property
    @pulumi.getter(name="sqlConnectivityUpdateUsername")
    def sql_connectivity_update_username(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SQL Server sysadmin login to create.
        """
        return pulumi.get(self, "sql_connectivity_update_username")
    ...
    @property
    @pulumi.getter(name="sqlLicenseType")
    def sql_license_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SQL Server license type. Possible values are `AHUB` (Azure Hybrid Benefit), `DR` (Disaster Recovery), and `PAYG` (Pay-As-You-Go). Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sql_license_type")
    ...
    @property
    @pulumi.getter(name="sqlVirtualMachineGroupId")
    def sql_virtual_machine_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the SQL Virtual Machine Group that the SQL Virtual Machine belongs to.
        """
        return pulumi.get(self, "sql_virtual_machine_group_id")
