...
class GetElasticPoolResult:
    ...
    def max_size_gb(self) -> _builtins.float:
        """
    ...
    def per_db_max_capacity(self) -> _builtins.int:
        """
    ...
    def per_db_min_capacity(self) -> _builtins.int:
        """
...
def get_elastic_pool(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Sql` - 2023-08-01-preview
    ...
    :param _builtins.str resource_group_name: The name of the resource group which contains the elastic pool.
    :param _builtins.str server_name: The name of the SQL Server which contains the elastic pool.
    """
    __args__ = dict()
    __args__['name'] = name
