...
class JobStepArgs:
    def __init__(__self__, *,
                 job_credential_id: pulumi.Input[builtins.str],
                 job_id: pulumi.Input[builtins.str],
                 job_step_index: pulumi.Input[builtins.int],
                 job_target_group_id: pulumi.Input[builtins.str],
                 sql_script: pulumi.Input[builtins.str],
                 initial_retry_interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_retry_interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 output_target: Optional[pulumi.Input['JobStepOutputTargetArgs']] = None,
                 retry_attempts: Optional[pulumi.Input[builtins.int]] = None,
                 retry_interval_backoff_multiplier: Optional[pulumi.Input[builtins.float]] = None,
                 timeout_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a JobStep resource.
        :param pulumi.Input[builtins.str] job_credential_id: The ID of the Elastic Job Credential to use when executing this Elastic Job Step.
        :param pulumi.Input[builtins.str] job_id: The ID of the Elastic Job. Changing this forces a new Elastic Job Step to be created.
        :param pulumi.Input[builtins.int] job_step_index: The index at which to insert this Elastic Job Step into the Elastic Job.
               
               > **Note:** This value must be greater than or equal to 1 and less than or equal to the number of job steps in the Elastic Job.
        :param pulumi.Input[builtins.str] job_target_group_id: The ID of the Elastic Job Target Group.
        :param pulumi.Input[builtins.str] sql_script: The T-SQL script to be executed by this Elastic Job Step.
               
               > **Note:** While Azure places no restrictions on the script provided here, it is recommended to ensure the script is idempotent.
        :param pulumi.Input[builtins.int] initial_retry_interval_seconds: The initial retry interval in seconds. Defaults to `1`.
        :param pulumi.Input[builtins.int] maximum_retry_interval_seconds: The maximum retry interval in seconds. Defaults to `120`.
               
               > **Note:** `maximum_retry_interval_seconds` must be greater than `initial_retry_interval_seconds`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Elastic Job Step. Changing this forces a new Elastic Job Step to be created.
        :param pulumi.Input['JobStepOutputTargetArgs'] output_target: An `output_target` block as defined below.
        :param pulumi.Input[builtins.int] retry_attempts: The number of retry attempts. Defaults to `10`.
        :param pulumi.Input[builtins.float] retry_interval_backoff_multiplier: The multiplier for time between retries. Defaults to `2`.
        :param pulumi.Input[builtins.int] timeout_seconds: The execution timeout in seconds for this Elastic Job Step. Defaults to `43200`.
        """
    ...
    def job_credential_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def job_credential_id(self, value: pulumi.Input[builtins.str]):
    ...
    def job_step_index(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def job_step_index(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "job_step_index", value)

    @property
    @pulumi.getter(name="jobTargetGroupId")
    def job_target_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def job_target_group_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "job_target_group_id", value)

    @property
    @pulumi.getter(name="sqlScript")
    def sql_script(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sql_script.setter
    def sql_script(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sql_script", value)

    @property
    @pulumi.getter(name="initialRetryIntervalSeconds")
    def initial_retry_interval_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def initial_retry_interval_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "initial_retry_interval_seconds", value)

    @property
    @pulumi.getter(name="maximumRetryIntervalSeconds")
    def maximum_retry_interval_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_retry_interval_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def retry_attempts(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def retry_attempts(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retry_attempts", value)

    @property
    @pulumi.getter(name="retryIntervalBackoffMultiplier")
    def retry_interval_backoff_multiplier(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def retry_interval_backoff_multiplier(self, value: Optional[pulumi.Input[builtins.float]]):
...
class _JobStepState:
    def __init__(__self__, *,
                 initial_retry_interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 job_credential_id: Optional[pulumi.Input[builtins.str]] = None,
                 job_id: Optional[pulumi.Input[builtins.str]] = None,
                 job_step_index: Optional[pulumi.Input[builtins.int]] = None,
                 job_target_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 maximum_retry_interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 output_target: Optional[pulumi.Input['JobStepOutputTargetArgs']] = None,
                 retry_attempts: Optional[pulumi.Input[builtins.int]] = None,
                 retry_interval_backoff_multiplier: Optional[pulumi.Input[builtins.float]] = None,
                 sql_script: Optional[pulumi.Input[builtins.str]] = None,
                 timeout_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="jobCredentialId")
    def job_credential_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Elastic Job Credential to use when executing this Elastic Job Step.
        """
        return pulumi.get(self, "job_credential_id")
    ...
    @job_credential_id.setter
    def job_credential_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "job_credential_id", value)
    ...
    @property
    @pulumi.getter(name="jobStepIndex")
    def job_step_index(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The index at which to insert this Elastic Job Step into the Elastic Job.
    ...
    @job_step_index.setter
    def job_step_index(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "job_step_index", value)

    @property
    @pulumi.getter(name="jobTargetGroupId")
    def job_target_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Elastic Job Target Group.
        """
        return pulumi.get(self, "job_target_group_id")
    ...
    @job_target_group_id.setter
    def job_target_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "job_target_group_id", value)
    ...
    @property
    @pulumi.getter(name="sqlScript")
    def sql_script(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The T-SQL script to be executed by this Elastic Job Step.
    ...
    @sql_script.setter
    def sql_script(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sql_script", value)
...
class JobStep(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retry_interval_backoff_multiplier: Optional[pulumi.Input[builtins.float]] = None,
            sql_script: Optional[pulumi.Input[builtins.str]] = None,
            timeout_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'JobStep':
        """
    ...
    @property
    @pulumi.getter(name="initialRetryIntervalSeconds")
    def initial_retry_interval_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The initial retry interval in seconds. Defaults to `1`.
        """
        return pulumi.get(self, "initial_retry_interval_seconds")
    ...
    @property
    @pulumi.getter(name="jobCredentialId")
    def job_credential_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Elastic Job Credential to use when executing this Elastic Job Step.
        """
        return pulumi.get(self, "job_credential_id")
    ...
    @property
    @pulumi.getter(name="jobStepIndex")
    def job_step_index(self) -> pulumi.Output[builtins.int]:
        """
        The index at which to insert this Elastic Job Step into the Elastic Job.
    ...
    @property
    @pulumi.getter(name="jobTargetGroupId")
    def job_target_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Elastic Job Target Group.
        """
        return pulumi.get(self, "job_target_group_id")
    ...
    @property
    @pulumi.getter(name="maximumRetryIntervalSeconds")
    def maximum_retry_interval_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum retry interval in seconds. Defaults to `120`.
    ...
    @property
    @pulumi.getter(name="retryAttempts")
    def retry_attempts(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of retry attempts. Defaults to `10`.
        """
        return pulumi.get(self, "retry_attempts")
    ...
    @property
    @pulumi.getter(name="retryIntervalBackoffMultiplier")
    def retry_interval_backoff_multiplier(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The multiplier for time between retries. Defaults to `2`.
        """
        return pulumi.get(self, "retry_interval_backoff_multiplier")
    ...
    @property
    @pulumi.getter(name="sqlScript")
    def sql_script(self) -> pulumi.Output[builtins.str]:
        """
        The T-SQL script to be executed by this Elastic Job Step.
