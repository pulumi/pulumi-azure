...
class ManagedInstanceSecurityAlertPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] managed_instance_name: Specifies the name of the MS SQL Managed Instance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group that contains the MS SQL Managed Instance. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disabled_alerts: Specifies an array of alerts that are disabled. Possible values are `Sql_Injection`, `Sql_Injection_Vulnerability`, `Access_Anomaly`, `Data_Exfiltration`, `Unsafe_Action` and `Brute_Force`.
        ...
        :param pulumi.Input[builtins.bool] enabled: Specifies the state of the Security Alert Policy, whether it is enabled or disabled. Possible values are `true`, `false`.
...
class ManagedInstanceSecurityAlertPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "azure:mssql/managedInstanceSecurityAlertPolicy:ManagedInstanceSecurityAlertPolicy"
    ...
    def get(resource_name: str,
            ...
            retention_days: Optional[pulumi.Input[builtins.int]] = None,
            storage_account_access_key: Optional[pulumi.Input[builtins.str]] = None,
            storage_endpoint: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedInstanceSecurityAlertPolicy':
        """
    ...
    @property
    @pulumi.getter(name="managedInstanceName")
    def managed_instance_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the MS SQL Managed Instance. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "managed_instance_name")
