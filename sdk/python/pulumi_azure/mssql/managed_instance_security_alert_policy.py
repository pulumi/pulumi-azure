...
class ManagedInstanceSecurityAlertPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_managed_instance_security_alert_policy = azure.mssql.managed_instance_security_alert_policy.ManagedInstanceSecurityAlertPolicy("example",
            resource_group_name=example.name,
            managed_instance_name=example_managed_instance.name,
            enabled=True,
            storage_endpoint=example_azurerm_storage_account.primary_blob_endpoint,
            storage_account_access_key=example_azurerm_storage_account.primary_access_key,
            disabled_alerts=[
                Sql_Injection,
                Data_Exfiltration,
            ],
