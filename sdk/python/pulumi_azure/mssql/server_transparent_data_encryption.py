...
class ServerTransparentDataEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_id: Specifies the name of the MS SQL Server. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] auto_rotation_enabled: When enabled, the server will continuously check the key vault for any new versions of the key being used as the TDE protector. If a new version of the key is detected, the TDE protector on the server will be automatically rotated to the latest key version within 60 minutes.
...
class ServerTransparentDataEncryption(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
            managed_hsm_key_id: Optional[pulumi.Input[builtins.str]] = None,
            server_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerTransparentDataEncryption':
        """
