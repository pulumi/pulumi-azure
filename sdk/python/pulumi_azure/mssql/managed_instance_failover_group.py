...
class ManagedInstanceFailoverGroupArgs:
    def __init__(__self__, *,
                 ...
                 readonly_endpoint_failover_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 secondary_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ManagedInstanceFailoverGroup resource.
        :param pulumi.Input[builtins.str] managed_instance_id: The ID of the Azure SQL Managed Instance which will be replicated using a Managed Instance Failover Group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] partner_managed_instance_id: The ID of the Azure SQL Managed Instance which will be replicated to. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Managed Instance Failover Group should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Managed Instance Failover Group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] readonly_endpoint_failover_policy_enabled: Failover policy for the read-only endpoint. Defaults to `true`.
        :param pulumi.Input[builtins.str] secondary_type: The type of the secondary Managed Instance. Possible values are `Geo`, `Standby`. Defaults to `Geo`.
        """
    ...
    def readonly_endpoint_failover_policy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def readonly_endpoint_failover_policy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "readonly_endpoint_failover_policy_enabled", value)

    @property
    @pulumi.getter(name="secondaryType")
    def secondary_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secondary_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ManagedInstanceFailoverGroupState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 partner_managed_instance_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['ManagedInstanceFailoverGroupReadWriteEndpointFailoverPolicyArgs'] read_write_endpoint_failover_policy: A `read_write_endpoint_failover_policy` block as defined below.
        :param pulumi.Input[builtins.bool] readonly_endpoint_failover_policy_enabled: Failover policy for the read-only endpoint. Defaults to `true`.
        :param pulumi.Input[builtins.str] role: The partner replication role of the Managed Instance Failover Group.
        :param pulumi.Input[builtins.str] secondary_type: The type of the secondary Managed Instance. Possible values are `Geo`, `Standby`. Defaults to `Geo`.
        """
        if location is not None:
            pulumi.set(__self__, "location", location)
    ...
    @property
    @pulumi.getter(name="partnerManagedInstanceId")
    def partner_managed_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Azure SQL Managed Instance which will be replicated to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "partner_managed_instance_id")
    ...
    @partner_managed_instance_id.setter
    def partner_managed_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partner_managed_instance_id", value)
...
class ManagedInstanceFailoverGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            readonly_endpoint_failover_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None,
            secondary_type: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedInstanceFailoverGroup':
        """
    ...
    @property
    @pulumi.getter(name="partnerManagedInstanceId")
    def partner_managed_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Azure SQL Managed Instance which will be replicated to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "partner_managed_instance_id")
    ...
    @property
    @pulumi.getter(name="readonlyEndpointFailoverPolicyEnabled")
    def readonly_endpoint_failover_policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Failover policy for the read-only endpoint. Defaults to `true`.
        """
        return pulumi.get(self, "readonly_endpoint_failover_policy_enabled")
