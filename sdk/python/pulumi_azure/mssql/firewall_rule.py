...
class FirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] server_id: The resource ID of the SQL Server on which to create the Firewall Rule. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:mssql/firewallRule:FirewallRule")
class FirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="azure:sql/firewallRule:FirewallRule")])
