...
class ServerExtendedAuditingPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_access_key_is_secondary: Optional[pulumi.Input[builtins.bool]] = None,
            storage_account_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_endpoint: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerExtendedAuditingPolicy':
        """
    ...
    @property
    @pulumi.getter(name="auditActionsAndGroups")
    def audit_actions_and_groups(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Actions-Groups and Actions to audit.
        """
        return pulumi.get(self, "audit_actions_and_groups")
