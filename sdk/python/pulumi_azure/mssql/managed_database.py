...
class ManagedDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 short_term_retention_days: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ManagedDatabase resource.
        :param pulumi.Input[builtins.str] managed_instance_id: The ID of the Azure SQL Managed Instance on which to create this Managed Database. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Managed Database to create. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.int] short_term_retention_days: The backup retention period in days. This is how many days Point-in-Time Restore will be supported.
    ...
    def short_term_retention_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def short_term_retention_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ManagedDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            point_in_time_restore: Optional[pulumi.Input[Union['ManagedDatabasePointInTimeRestoreArgs', 'ManagedDatabasePointInTimeRestoreArgsDict']]] = None,
            short_term_retention_days: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ManagedDatabase':
        """
    ...
    @property
    @pulumi.getter(name="shortTermRetentionDays")
    def short_term_retention_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The backup retention period in days. This is how many days Point-in-Time Restore will be supported.
        """
        return pulumi.get(self, "short_term_retention_days")
