...
async def get_elasticpool(name=None,resource_group_name=None,server_name=None,opts=None):
    """
    ...
    __ret__ = await pulumi.runtime.invoke('azure:mssql/getElasticpool:getElasticpool', __args__, opts=opts)
