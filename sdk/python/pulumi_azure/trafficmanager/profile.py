...
class Profile(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if dns_config is not None and not isinstance(dns_config, ProfileDnsConfigArgs):
                dns_config = dns_config or {}
                def _setter(key, value):
                    dns_config[key] = value
                ProfileDnsConfigArgs._configure(_setter, **dns_config)
            ...
            if monitor_config is not None and not isinstance(monitor_config, ProfileMonitorConfigArgs):
                monitor_config = monitor_config or {}
                def _setter(key, value):
                    monitor_config[key] = value
                ProfileMonitorConfigArgs._configure(_setter, **monitor_config)
