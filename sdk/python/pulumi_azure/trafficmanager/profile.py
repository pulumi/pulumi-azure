...
warnings.warn("azure.Profile has been deprecated in favour of azure.TrafficManagerProfile", DeprecationWarning)
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, dns_config=None, monitor_config=None, name=None, profile_status=None, resource_group_name=None, tags=None, traffic_routing_method=None, __props__=None, __name__=None, __opts__=None):
        ...
        """
        pulumi.log.warn("Profile is deprecated: azure.Profile has been deprecated in favour of azure.TrafficManagerProfile")
