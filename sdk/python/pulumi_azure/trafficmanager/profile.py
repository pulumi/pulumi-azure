...
class _ProfileState:
    def __init__(__self__, *,
                 dns_config: pulumi.Input[Optional['ProfileDnsConfigArgs']] = None,
                 fqdn: pulumi.Input[Optional[_builtins.str]] = None,
                 max_return: pulumi.Input[Optional[_builtins.int]] = None,
                 monitor_config: pulumi.Input[Optional['ProfileMonitorConfigArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 profile_status: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="dnsConfig")
    def dns_config(self) -> pulumi.Input[Optional['ProfileDnsConfigArgs']]:
        """
        This block specifies the DNS configuration of the Profile. One `dns_config` block as defined below.
        """
        return pulumi.get(self, "dns_config")
    ...
    @dns_config.setter
    def dns_config(self, value: pulumi.Input[Optional['ProfileDnsConfigArgs']]):
        pulumi.set(self, "dns_config", value)
    ...
    @_builtins.property
    @pulumi.getter(name="monitorConfig")
    def monitor_config(self) -> pulumi.Input[Optional['ProfileMonitorConfigArgs']]:
        """
        This block specifies the Endpoint monitoring configuration for the Profile. One `monitor_config` block as defined below.
        """
        return pulumi.get(self, "monitor_config")
    ...
    @monitor_config.setter
    def monitor_config(self, value: pulumi.Input[Optional['ProfileMonitorConfigArgs']]):
        pulumi.set(self, "monitor_config", value)
...
@pulumi.type_token("azure:trafficmanager/profile:Profile")
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dns_config: pulumi.Input[Optional[Union['ProfileDnsConfigArgs', 'ProfileDnsConfigArgsDict', 'outputs.ProfileDnsConfig']]] = None,
                 max_return: pulumi.Input[Optional[_builtins.int]] = None,
                 monitor_config: pulumi.Input[Optional[Union['ProfileMonitorConfigArgs', 'ProfileMonitorConfigArgsDict', 'outputs.ProfileMonitorConfig']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 profile_status: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        * `Microsoft.Network` - 2022-04-01
        ...
        :param pulumi.Input[Union['ProfileDnsConfigArgs', 'ProfileDnsConfigArgsDict', 'outputs.ProfileDnsConfig']] dns_config: This block specifies the DNS configuration of the Profile. One `dns_config` block as defined below.
        :param pulumi.Input[_builtins.int] max_return: The amount of endpoints to return for DNS queries to this Profile. Possible values range from `1` to `8`.
               
               > **Note:** `max_return` must be set when the `traffic_routing_method` is `MultiValue`.
        :param pulumi.Input[Union['ProfileMonitorConfigArgs', 'ProfileMonitorConfigArgsDict', 'outputs.ProfileMonitorConfig']] monitor_config: This block specifies the Endpoint monitoring configuration for the Profile. One `monitor_config` block as defined below.
        :param pulumi.Input[_builtins.str] name: The name of the Traffic Manager profile. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] profile_status: The status of the profile, can be set to either `Enabled` or `Disabled`. Defaults to `Enabled`.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which to create the Traffic Manager profile. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            traffic_routing_method: pulumi.Input[Optional[_builtins.str]] = None,
            traffic_view_enabled: pulumi.Input[Optional[_builtins.bool]] = None) -> 'Profile':
        """
