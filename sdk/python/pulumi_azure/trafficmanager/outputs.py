...
class ProfileDnsConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ttl: builtins.int):
        """
        :param builtins.str relative_name: The relative domain name, this is combined with the domain name used by Traffic Manager to form the FQDN which is exported as documented below. Changing this forces a new resource to be created.
        :param builtins.int ttl: The TTL value of the Profile used by Local DNS resolvers and clients.
        """
...
class ProfileMonitorConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expected_status_code_ranges: Optional[Sequence[builtins.str]] = None,
                 interval_in_seconds: Optional[builtins.int] = None,
                 path: Optional[builtins.str] = None,
                 timeout_in_seconds: Optional[builtins.int] = None,
                 tolerated_number_of_failures: Optional[builtins.int] = None):
        """
        :param builtins.int port: The port number used by the monitoring checks.
        :param builtins.str protocol: The protocol used by the monitoring checks, supported values are `HTTP`, `HTTPS` and `TCP`.
        :param Sequence['ProfileMonitorConfigCustomHeaderArgs'] custom_headers: One or more `custom_header` blocks as defined below.
        :param Sequence[builtins.str] expected_status_code_ranges: A list of status code ranges in the format of `100-101`.
        :param builtins.int interval_in_seconds: The interval used to check the endpoint health from a Traffic Manager probing agent. You can specify two values here: `30` (normal probing) and `10` (fast probing). The default value is `30`.
        :param builtins.str path: The path used by the monitoring checks. Required when `protocol` is set to `HTTP` or `HTTPS` - cannot be set when `protocol` is set to `TCP`.
        :param builtins.int timeout_in_seconds: The amount of time the Traffic Manager probing agent should wait before considering that check a failure when a health check probe is sent to the endpoint. If `interval_in_seconds` is set to `30`, then `timeout_in_seconds` can be between `5` and `10`. The default value is `10`. If `interval_in_seconds` is set to `10`, then valid values are between `5` and `9` and `timeout_in_seconds` is required.
        :param builtins.int tolerated_number_of_failures: The number of failures a Traffic Manager probing agent tolerates before marking that endpoint as unhealthy. Valid values are between `0` and `9`. The default value is `3`
        """
    ...
    def expected_status_code_ranges(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def tolerated_number_of_failures(self) -> Optional[builtins.int]:
        """
...
class ProfileMonitorConfigCustomHeader(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str value: The value of custom header. Applicable for HTTP and HTTPS protocol.
        """
