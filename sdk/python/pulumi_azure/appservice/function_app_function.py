...
class FunctionAppFunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the function. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] test_data: The test data for the function.
        """
...
class _FunctionAppFunctionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] language: The language the Function is written in. Possible values are `CSharp`, `Custom`, `Java`, `Javascript`, `Python`, `PowerShell`, and `TypeScript`.
               ...
               > **Note:** when using `Custom` language, you must specify the code handler in the `host.json` file for your function. See the [official docs](https://docs.microsoft.com/azure/azure-functions/functions-custom-handlers#hostjson) for more information.
        :param pulumi.Input[_builtins.str] name: The name of the function. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] script_root_path_url: The Script root path URL.
        :param pulumi.Input[_builtins.str] script_url: The script URL.
        :param pulumi.Input[_builtins.str] secrets_file_url: The URL for the Secrets File.
        :param pulumi.Input[_builtins.str] test_data: The test data for the function.
        :param pulumi.Input[_builtins.str] test_data_url: The Test data URL.
        :param pulumi.Input[_builtins.str] url: The function URL.
        """
...
class FunctionAppFunction(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="configUrl")
    def config_url(self) -> pulumi.Output[_builtins.str]:
        """
        The URL of the configuration JSON.
        """
        return pulumi.get(self, "config_url")
    ...
    @_builtins.property
    @pulumi.getter(name="invocationUrl")
    def invocation_url(self) -> pulumi.Output[_builtins.str]:
        """
        The invocation URL.
        """
        return pulumi.get(self, "invocation_url")
    ...
    @_builtins.property
    @pulumi.getter(name="scriptRootPathUrl")
    def script_root_path_url(self) -> pulumi.Output[_builtins.str]:
        """
        The Script root path URL.
        """
        return pulumi.get(self, "script_root_path_url")
    ...
    @_builtins.property
    @pulumi.getter(name="scriptUrl")
    def script_url(self) -> pulumi.Output[_builtins.str]:
        """
        The script URL.
        """
        return pulumi.get(self, "script_url")
    ...
    @_builtins.property
    @pulumi.getter(name="secretsFileUrl")
    def secrets_file_url(self) -> pulumi.Output[_builtins.str]:
        """
        The URL for the Secrets File.
        """
        return pulumi.get(self, "secrets_file_url")
    ...
    @_builtins.property
    @pulumi.getter(name="testDataUrl")
    def test_data_url(self) -> pulumi.Output[_builtins.str]:
        """
        The Test data URL.
        """
        return pulumi.get(self, "test_data_url")
