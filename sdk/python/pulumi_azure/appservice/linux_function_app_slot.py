...
class LinuxFunctionAppSlotArgs:
    def __init__(__self__, *,
        ...
        """
        LinuxFunctionAppSlotArgs._configure(
...
class _LinuxFunctionAppSlotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: A mapping of tags which should be assigned to the Linux Function App.
        """
        _LinuxFunctionAppSlotState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            app_settings=app_settings,
            auth_settings=auth_settings,
            auth_settings_v2=auth_settings_v2,
...
class LinuxFunctionAppSlot(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            LinuxFunctionAppSlotArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if auth_settings is not None and not isinstance(auth_settings, LinuxFunctionAppSlotAuthSettingsArgs):
                auth_settings = auth_settings or {}
                def _setter(key, value):
                    auth_settings[key] = value
                LinuxFunctionAppSlotAuthSettingsArgs._configure(_setter, **auth_settings)
            __props__.__dict__["auth_settings"] = auth_settings
            if auth_settings_v2 is not None and not isinstance(auth_settings_v2, LinuxFunctionAppSlotAuthSettingsV2Args):
                auth_settings_v2 = auth_settings_v2 or {}
                def _setter(key, value):
                    auth_settings_v2[key] = value
                LinuxFunctionAppSlotAuthSettingsV2Args._configure(_setter, **auth_settings_v2)
            __props__.__dict__["auth_settings_v2"] = auth_settings_v2
            if backup is not None and not isinstance(backup, LinuxFunctionAppSlotBackupArgs):
                backup = backup or {}
                def _setter(key, value):
                    backup[key] = value
                LinuxFunctionAppSlotBackupArgs._configure(_setter, **backup)
            ...
            if identity is not None and not isinstance(identity, LinuxFunctionAppSlotIdentityArgs):
                identity = identity or {}
                def _setter(key, value):
                    identity[key] = value
                LinuxFunctionAppSlotIdentityArgs._configure(_setter, **identity)
            ...
            if site_config is not None and not isinstance(site_config, LinuxFunctionAppSlotSiteConfigArgs):
                site_config = site_config or {}
                def _setter(key, value):
                    site_config[key] = value
                LinuxFunctionAppSlotSiteConfigArgs._configure(_setter, **site_config)
