...
class LinuxFunctionAppSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] function_app_id: The ID of the Linux Function App this Slot is a member of. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] client_certificate_enabled: Should the Function App Slot use Client Certificates.
        ...
        :param pulumi.Input[builtins.str] client_certificate_mode: The mode of the Function App Slot's client certificates requirement for incoming requests. Possible values are `Required`, `Optional`, and `OptionalInteractiveUser`. Defaults to `Optional`.
        ...
        :param pulumi.Input[builtins.bool] content_share_force_disabled: Force disable the content share settings.
        :param pulumi.Input[builtins.int] daily_memory_time_quota: The amount of memory in gigabyte-seconds that your application is allowed to consume per day. Setting this value only affects function apps in Consumption Plans. Defaults to `0`.
        :param pulumi.Input[builtins.bool] enabled: Is the Linux Function App Slot enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Are the default FTP Basic Authentication publishing credentials enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] functions_extension_version: The runtime version associated with the Function App Slot. Defaults to `~4`.
        :param pulumi.Input[builtins.bool] https_only: Can the Function App Slot only be accessed via HTTPS?. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Function App Slot. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] service_plan_id: The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Linux Function App will be used.
        :param pulumi.Input[builtins.str] storage_account_access_key: The access key which will be used to access the storage account for the Function App Slot.
        :param pulumi.Input[builtins.str] storage_account_name: The backend storage account name which will be used by this Function App Slot.
        ...
        :param pulumi.Input[builtins.bool] storage_uses_managed_identity: Should the Function App Slot use its Managed Identity to access storage.
...
class _LinuxFunctionAppSlotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] daily_memory_time_quota: The amount of memory in gigabyte-seconds that your application is allowed to consume per day. Setting this value only affects function apps in Consumption Plans. Defaults to `0`.
        :param pulumi.Input[builtins.str] default_hostname: The default hostname of the Linux Function App Slot.
        :param pulumi.Input[builtins.bool] enabled: Is the Linux Function App Slot enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Are the default FTP Basic Authentication publishing credentials enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] function_app_id: The ID of the Linux Function App this Slot is a member of. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] functions_extension_version: The runtime version associated with the Function App Slot. Defaults to `~4`.
        :param pulumi.Input[builtins.str] hosting_environment_id: The ID of the App Service Environment used by Function App Slot.
        :param pulumi.Input[builtins.bool] https_only: Can the Function App Slot only be accessed via HTTPS?. Defaults to `false`.
        :param pulumi.Input['LinuxFunctionAppSlotIdentityArgs'] identity: An `identity` block as detailed below.
        :param pulumi.Input[builtins.str] key_vault_reference_identity_id: The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
        :param pulumi.Input[builtins.str] kind: The Kind value for this Linux Function App Slot.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Function App Slot. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] possible_outbound_ip_addresses: A comma separated list of possible outbound IP addresses as a string. For example `52.23.25.3,52.143.43.12,52.143.43.17`. This is a superset of `outbound_ip_addresses`. For example `["52.23.25.3", "52.143.43.12","52.143.43.17"]`.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Should public network access be enabled for the Function App. Defaults to `true`.
        :param pulumi.Input[builtins.str] service_plan_id: The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Linux Function App will be used.
        :param pulumi.Input['LinuxFunctionAppSlotSiteConfigArgs'] site_config: a `site_config` block as detailed below.
...
class LinuxFunctionAppSlot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_network_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            vnet_image_pull_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            webdeploy_publish_basic_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'LinuxFunctionAppSlot':
        """
    ...
    @property
    @pulumi.getter(name="servicePlanId")
    def service_plan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Linux Function App will be used.
        """
        return pulumi.get(self, "service_plan_id")
