...
class LinuxFunctionAppSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            auth_settings = _utilities.configure(auth_settings, LinuxFunctionAppSlotAuthSettingsArgs, True)
            __props__.__dict__["auth_settings"] = auth_settings
            auth_settings_v2 = _utilities.configure(auth_settings_v2, LinuxFunctionAppSlotAuthSettingsV2Args, True)
            __props__.__dict__["auth_settings_v2"] = auth_settings_v2
            backup = _utilities.configure(backup, LinuxFunctionAppSlotBackupArgs, True)
            ...
            identity = _utilities.configure(identity, LinuxFunctionAppSlotIdentityArgs, True)
            ...
            site_config = _utilities.configure(site_config, LinuxFunctionAppSlotSiteConfigArgs, True)
