...
class CertificateBindingArgs:
    def __init__(__self__, *,
                 ...
                 hostname_binding_id: pulumi.Input[builtins.str],
                 ssl_state: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a CertificateBinding resource.
        :param pulumi.Input[builtins.str] certificate_id: The ID of the certificate to bind to the custom domain. Changing this forces a new App Service Certificate Binding to be created.
        :param pulumi.Input[builtins.str] hostname_binding_id: The ID of the Custom Domain/Hostname Binding. Changing this forces a new App Service Certificate Binding to be created.
        :param pulumi.Input[builtins.str] ssl_state: The type of certificate binding. Allowed values are `IpBasedEnabled` or `SniEnabled`. Changing this forces a new App Service Certificate Binding to be created.
        """
    ...
    def hostname_binding_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def hostname_binding_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "hostname_binding_id", value)

    @property
    @pulumi.getter(name="sslState")
    def ssl_state(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ssl_state.setter
    def ssl_state(self, value: pulumi.Input[builtins.str]):
...
class _CertificateBindingState:
    def __init__(__self__, *,
                 ...
                 hostname_binding_id: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_service_name: The name of the App Service to which the certificate was bound.
        :param pulumi.Input[builtins.str] certificate_id: The ID of the certificate to bind to the custom domain. Changing this forces a new App Service Certificate Binding to be created.
        :param pulumi.Input[builtins.str] hostname: The hostname of the bound certificate.
        :param pulumi.Input[builtins.str] hostname_binding_id: The ID of the Custom Domain/Hostname Binding. Changing this forces a new App Service Certificate Binding to be created.
        :param pulumi.Input[builtins.str] ssl_state: The type of certificate binding. Allowed values are `IpBasedEnabled` or `SniEnabled`. Changing this forces a new App Service Certificate Binding to be created.
    ...
    @property
    @pulumi.getter(name="hostnameBindingId")
    def hostname_binding_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Custom Domain/Hostname Binding. Changing this forces a new App Service Certificate Binding to be created.
        """
        return pulumi.get(self, "hostname_binding_id")
    ...
    @hostname_binding_id.setter
    def hostname_binding_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hostname_binding_id", value)

    @property
    @pulumi.getter(name="sslState")
    def ssl_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of certificate binding. Allowed values are `IpBasedEnabled` or `SniEnabled`. Changing this forces a new App Service Certificate Binding to be created.
        """
        return pulumi.get(self, "ssl_state")
    ...
    @ssl_state.setter
    def ssl_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssl_state", value)
...
class CertificateBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hostname_binding_id: Optional[pulumi.Input[builtins.str]] = None,
            ssl_state: Optional[pulumi.Input[builtins.str]] = None,
            thumbprint: Optional[pulumi.Input[builtins.str]] = None) -> 'CertificateBinding':
        """
    ...
    @property
    @pulumi.getter(name="hostnameBindingId")
    def hostname_binding_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Custom Domain/Hostname Binding. Changing this forces a new App Service Certificate Binding to be created.
        """
        return pulumi.get(self, "hostname_binding_id")
    ...
    @property
    @pulumi.getter(name="sslState")
    def ssl_state(self) -> pulumi.Output[builtins.str]:
        """
        The type of certificate binding. Allowed values are `IpBasedEnabled` or `SniEnabled`. Changing this forces a new App Service Certificate Binding to be created.
        """
        return pulumi.get(self, "ssl_state")
