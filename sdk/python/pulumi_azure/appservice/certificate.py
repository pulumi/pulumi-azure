...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] app_service_plan_id: The ID of the associated App Service plan. Must be specified when the certificate is used inside an App Service Environment hosted App Service or with Basic and Premium App Service plans. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] key_vault_secret_id: The ID of the Key Vault secret. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] password: The password to access the certificate's private key. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] pfx_blob: The base64-encoded contents of the certificate. Changing this forces a new resource to be created.
...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 hosting_environment_profile_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] friendly_name: The friendly name of the certificate.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] host_names: List of host names the certificate applies to.
        :param pulumi.Input[_builtins.str] hosting_environment_profile_id: The ID of the App Service Environment where the certificate is in use.
        :param pulumi.Input[_builtins.str] issue_date: The issue date for the certificate.
        :param pulumi.Input[_builtins.str] issuer: The name of the certificate issuer.
        :param pulumi.Input[_builtins.str] key_vault_secret_id: The ID of the Key Vault secret. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which to create the certificate. Changing this forces a new resource to be created.
               ...
               > **NOTE:** The resource group must be the same as that which the app service plan is defined in - otherwise the certificate will not show as available for the app services.
        :param pulumi.Input[_builtins.str] subject_name: The subject name of the certificate.
    ...
    def hosting_environment_profile_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def hosting_environment_profile_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class Certificate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="appServicePlanId")
    def app_service_plan_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the associated App Service plan. Must be specified when the certificate is used inside an App Service Environment hosted App Service or with Basic and Premium App Service plans. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "app_service_plan_id")
    ...
    @_builtins.property
    @pulumi.getter(name="hostingEnvironmentProfileId")
    def hosting_environment_profile_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the App Service Environment where the certificate is in use.
        """
        return pulumi.get(self, "hosting_environment_profile_id")
