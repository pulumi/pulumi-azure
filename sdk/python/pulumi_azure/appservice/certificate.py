...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 hosting_environment_profile_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] friendly_name: The friendly name of the certificate.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] host_names: List of host names the certificate applies to.
        :param pulumi.Input[builtins.str] hosting_environment_profile_id: The ID of the App Service Environment where the certificate is in use.
        :param pulumi.Input[builtins.str] issue_date: The issue date for the certificate.
    ...
    def hosting_environment_profile_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hosting_environment_profile_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Certificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subject_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            thumbprint: Optional[pulumi.Input[builtins.str]] = None) -> 'Certificate':
        """
    ...
    @property
    @pulumi.getter(name="appServicePlanId")
    def app_service_plan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the associated App Service plan. Must be specified when the certificate is used inside an App Service Environment hosted App Service or with Basic and Premium App Service plans. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "app_service_plan_id")
    ...
    @property
    @pulumi.getter(name="hostingEnvironmentProfileId")
    def hosting_environment_profile_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the App Service Environment where the certificate is in use.
        """
        return pulumi.get(self, "hosting_environment_profile_id")
    ...
    @property
    @pulumi.getter(name="keyVaultSecretId")
    def key_vault_secret_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Key Vault secret. Changing this forces a new resource to be created.
