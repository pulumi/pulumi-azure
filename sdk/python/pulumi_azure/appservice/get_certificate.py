...
def get_certificate(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Specifies the name of the certificate.
    :param builtins.str resource_group_name: The name of the resource group in which to create the certificate.
    """
    __args__ = dict()
    __args__['name'] = name
