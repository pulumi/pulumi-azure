...
class ManagedCertificateArgs:
    ...
    def custom_hostname_binding_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def custom_hostname_binding_id(self, value: pulumi.Input[_builtins.str]):
...
class _ManagedCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] host_names: The list of Host Names for the Certificate.
        :param pulumi.Input[_builtins.str] issue_date: The Start date for the Certificate.
...
class ManagedCertificate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="customHostnameBindingId")
    def custom_hostname_binding_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the App Service Custom Hostname Binding for the Certificate. Changing this forces a new App Service Managed Certificate to be created.
        """
        return pulumi.get(self, "custom_hostname_binding_id")
