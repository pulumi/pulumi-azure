...
class LinuxWebAppSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_service_id: The ID of the Linux Web App this Deployment Slot will be part of.
        ...
        :param pulumi.Input[builtins.str] service_plan_id: The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Linux Web App will be used.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags that should be assigned to the Linux Web App.
...
class _LinuxWebAppSlotState:
    def __init__(__self__, *,
                 app_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] app_metadata: A `app_metadata`.
        :param pulumi.Input[builtins.str] app_service_id: The ID of the Linux Web App this Deployment Slot will be part of.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] app_settings: A map of key-value pairs of App Settings.
        :param pulumi.Input['LinuxWebAppSlotAuthSettingsArgs'] auth_settings: An `auth_settings` block as defined below.
        :param pulumi.Input['LinuxWebAppSlotAuthSettingsV2Args'] auth_settings_v2: An `auth_settings_v2` block as defined below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] possible_outbound_ip_address_lists: A `possible_outbound_ip_address_list`.
    ...
    def app_metadata(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A `app_metadata`.
        """
    ...
    @app_metadata.setter
    def app_metadata(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class LinuxWebAppSlot(pulumi.CustomResource):
    ...
    pulumi_type = "azure:appservice/linuxWebAppSlot:LinuxWebAppSlot"
    ...
    def get(resource_name: str,
            ...
            virtual_network_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            webdeploy_publish_basic_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zip_deploy_file: Optional[pulumi.Input[builtins.str]] = None) -> 'LinuxWebAppSlot':
        """
    ...
    @property
    @pulumi.getter(name="appMetadata")
    def app_metadata(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        A `app_metadata`.
        """
        return pulumi.get(self, "app_metadata")
