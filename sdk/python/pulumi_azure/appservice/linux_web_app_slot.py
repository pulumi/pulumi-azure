...
class LinuxWebAppSlot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            auth_settings = _utilities.configure(auth_settings, LinuxWebAppSlotAuthSettingsArgs, True)
            __props__.__dict__["auth_settings"] = auth_settings
            auth_settings_v2 = _utilities.configure(auth_settings_v2, LinuxWebAppSlotAuthSettingsV2Args, True)
            __props__.__dict__["auth_settings_v2"] = auth_settings_v2
            backup = _utilities.configure(backup, LinuxWebAppSlotBackupArgs, True)
            ...
            identity = _utilities.configure(identity, LinuxWebAppSlotIdentityArgs, True)
            __props__.__dict__["identity"] = identity
            __props__.__dict__["key_vault_reference_identity_id"] = key_vault_reference_identity_id
            logs = _utilities.configure(logs, LinuxWebAppSlotLogsArgs, True)
            __props__.__dict__["logs"] = logs
            __props__.__dict__["name"] = name
            __props__.__dict__["public_network_access_enabled"] = public_network_access_enabled
            __props__.__dict__["service_plan_id"] = service_plan_id
            site_config = _utilities.configure(site_config, LinuxWebAppSlotSiteConfigArgs, True)
