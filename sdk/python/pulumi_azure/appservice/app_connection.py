...
class AppConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] function_app_id: The ID of the data source function app. Changing this forces a new resource to be created.
...
class AppConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_store: Optional[pulumi.Input[Union['AppConnectionSecretStoreArgs', 'AppConnectionSecretStoreArgsDict']]] = None,
            target_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            vnet_solution: Optional[pulumi.Input[builtins.str]] = None) -> 'AppConnection':
        """
