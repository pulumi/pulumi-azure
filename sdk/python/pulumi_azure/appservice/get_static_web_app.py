...
class GetStaticWebAppResult:
    ...
    def configuration_file_changes_enabled(self) -> builtins.bool:
    ...
    def preview_environments_enabled(self) -> builtins.bool:
...
def get_static_web_app(name: Optional[builtins.str] = None,
...
def get_static_web_app_output(name: Optional[pulumi.Input[builtins.str]] = None,
