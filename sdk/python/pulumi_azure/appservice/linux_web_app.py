...
class LinuxWebAppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Linux Web App should exist. Changing this forces a new Linux Web App to be created.
        :param pulumi.Input[builtins.str] service_plan_id: The ID of the Service Plan that this Linux App Service will be created in.
        :param pulumi.Input['LinuxWebAppSiteConfigArgs'] site_config: A `site_config` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] app_settings: A map of key-value pairs of App Settings.
        ...
        :param pulumi.Input[builtins.bool] client_affinity_enabled: Should Client Affinity be enabled?
        :param pulumi.Input[builtins.bool] client_certificate_enabled: Should Client Certificates be enabled?
        ...
        :param pulumi.Input[builtins.str] client_certificate_mode: The Client Certificate mode. Possible values are `Required`, `Optional`, and `OptionalInteractiveUser`. This property has no effect when `client_certificate_enabled` is `false`. Defaults to `Required`.
        ...
        :param pulumi.Input[builtins.bool] enabled: Should the Linux Web App be enabled? Defaults to `true`.
        ...
        :param pulumi.Input[builtins.bool] https_only: Should the Linux Web App require HTTPS connections. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Linux Web App should exist. Changing this forces a new Linux Web App to be created.
        :param pulumi.Input['LinuxWebAppLogsArgs'] logs: A `logs` block as defined below.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Should public network access be enabled for the Web App. Defaults to `true`.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Linux Web App.
        ...
        :param pulumi.Input[builtins.str] zip_deploy_file: The local path and filename of the Zip packaged application to deploy to this Linux Web App.
...
class _LinuxWebAppState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_hostname: The default hostname of the Linux Web App.
        :param pulumi.Input[builtins.bool] enabled: Should the Linux Web App be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Should the default FTP Basic Authentication publishing profile be enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] hosting_environment_id: The ID of the App Service Environment used by App Service.
        :param pulumi.Input[builtins.bool] https_only: Should the Linux Web App require HTTPS connections. Defaults to `false`.
        :param pulumi.Input['LinuxWebAppIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] key_vault_reference_identity_id: The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity).
        :param pulumi.Input[builtins.str] kind: The Kind value for this Linux Web App.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Linux Web App should exist. Changing this forces a new Linux Web App to be created.
        :param pulumi.Input['LinuxWebAppLogsArgs'] logs: A `logs` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outbound_ip_address_lists: A list of outbound IP addresses - such as `["52.23.25.3", "52.143.43.12"]`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] possible_outbound_ip_address_lists: A list of possible outbound ip address.
...
class LinuxWebApp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_network_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            webdeploy_publish_basic_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zip_deploy_file: Optional[pulumi.Input[builtins.str]] = None) -> 'LinuxWebApp':
        """
