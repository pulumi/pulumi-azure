...
class WindowsWebAppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Windows Web App should exist. Changing this forces a new Windows Web App to be created.
        :param pulumi.Input[builtins.str] service_plan_id: The ID of the Service Plan that this Windows App Service will be created in.
        ...
        :param pulumi.Input[builtins.bool] enabled: Should the Windows Web App be enabled? Defaults to `true`.
        ...
        :param pulumi.Input[builtins.bool] https_only: Should the Windows Web App require HTTPS connections. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Windows Web App should exist. Changing this forces a new Windows Web App to be created.
        :param pulumi.Input['WindowsWebAppLogsArgs'] logs: A `logs` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Windows Web App. Changing this forces a new Windows Web App to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Windows Web App.
...
class _WindowsWebAppState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_hostname: The default hostname of the Windows Web App.
        :param pulumi.Input[builtins.bool] enabled: Should the Windows Web App be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Should the default FTP Basic Authentication publishing profile be enabled. Defaults to `true`.
        ...
        :param pulumi.Input['WindowsWebAppIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] key_vault_reference_identity_id: The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
        :param pulumi.Input[builtins.str] kind: The Kind value for this Windows Web App.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Windows Web App should exist. Changing this forces a new Windows Web App to be created.
        :param pulumi.Input['WindowsWebAppLogsArgs'] logs: A `logs` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Windows Web App. Changing this forces a new Windows Web App to be created.
...
class WindowsWebApp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_network_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            webdeploy_publish_basic_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zip_deploy_file: Optional[pulumi.Input[builtins.str]] = None) -> 'WindowsWebApp':
        """
