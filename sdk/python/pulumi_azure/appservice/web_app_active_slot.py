...
class WebAppActiveSlotArgs:
    def __init__(__self__, *,
                 slot_id: pulumi.Input[builtins.str],
                 overwrite_network_config: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a WebAppActiveSlot resource.
        :param pulumi.Input[builtins.str] slot_id: The ID of the Slot to swap with `Production`.
        :param pulumi.Input[builtins.bool] overwrite_network_config: The swap action should overwrite the Production slot's network configuration with the configuration from this slot. Defaults to `true`. Changing this forces a new resource to be created.
        """
    ...
    def slot_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @slot_id.setter
    def slot_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "slot_id", value)

    @property
    @pulumi.getter(name="overwriteNetworkConfig")
    def overwrite_network_config(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def overwrite_network_config(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _WebAppActiveSlotState:
    def __init__(__self__, *,
                 last_successful_swap: Optional[pulumi.Input[builtins.str]] = None,
                 overwrite_network_config: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] last_successful_swap: The timestamp of the last successful swap with `Production`.
        :param pulumi.Input[builtins.bool] overwrite_network_config: The swap action should overwrite the Production slot's network configuration with the configuration from this slot. Defaults to `true`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] slot_id: The ID of the Slot to swap with `Production`.
        """
    ...
    def last_successful_swap(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_successful_swap(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @slot_id.setter
    def slot_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "slot_id", value)


class WebAppActiveSlot(pulumi.CustomResource):

    pulumi_type = "azure:appservice/webAppActiveSlot:WebAppActiveSlot"
    ...
    def get(resource_name: str,
            ...
            last_successful_swap: Optional[pulumi.Input[builtins.str]] = None,
            overwrite_network_config: Optional[pulumi.Input[builtins.bool]] = None,
            slot_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WebAppActiveSlot':
        """
    ...
    @property
    @pulumi.getter(name="lastSuccessfulSwap")
    def last_successful_swap(self) -> pulumi.Output[builtins.str]:
        """
        The timestamp of the last successful swap with `Production`.
        """
        return pulumi.get(self, "last_successful_swap")
    ...
    @property
    @pulumi.getter(name="overwriteNetworkConfig")
    def overwrite_network_config(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The swap action should overwrite the Production slot's network configuration with the configuration from this slot. Defaults to `true`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "overwrite_network_config")
    ...
    @property
    @pulumi.getter(name="slotId")
    def slot_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Slot to swap with `Production`.
        """
        return pulumi.get(self, "slot_id")
