...
class WindowsWebAppSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_service_id: The ID of the Windows Web App this Deployment Slot will be part of. Changing this forces a new Windows Web App to be created.
        ...
        :param pulumi.Input[builtins.str] client_certificate_mode: The Client Certificate mode. Possible values are `Required`, `Optional`, and `OptionalInteractiveUser`. This property has no effect when `client_cert_enabled` is `false`. Defaults to `Required`.
        ...
        :param pulumi.Input[builtins.bool] enabled: Should the Windows Web App Slot be enabled? Defaults to `true`.
        ...
        :param pulumi.Input[builtins.bool] https_only: Should the Windows Web App Slot require HTTPS connections. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] service_plan_id: The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Windows Web App will be used.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Windows Web App Slot.
        ...
        :param pulumi.Input[builtins.str] zip_deploy_file: The local path and filename of the Zip packaged application to deploy to this Windows Web App.
        """
...
class _WindowsWebAppSlotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_hostname: The default hostname of the Windows Web App Slot.
        :param pulumi.Input[builtins.bool] enabled: Should the Windows Web App Slot be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Should the default FTP Basic Authentication publishing profile be enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] hosting_environment_id: The ID of the App Service Environment used by App Service Slot.
        :param pulumi.Input[builtins.bool] https_only: Should the Windows Web App Slot require HTTPS connections. Defaults to `false`.
        :param pulumi.Input['WindowsWebAppSlotIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] key_vault_reference_identity_id: The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
        :param pulumi.Input[builtins.str] kind: The Kind value for this Windows Web App Slot.
        :param pulumi.Input['WindowsWebAppSlotLogsArgs'] logs: A `logs` block as defined below.
...
class WindowsWebAppSlot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_network_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            webdeploy_publish_basic_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zip_deploy_file: Optional[pulumi.Input[builtins.str]] = None) -> 'WindowsWebAppSlot':
        """
