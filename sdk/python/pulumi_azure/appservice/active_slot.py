...
class ActiveSlotArgs:
    def __init__(__self__, *,
                 ...
                 app_service_slot_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ActiveSlot resource.
        :param pulumi.Input[builtins.str] app_service_name: The name of the App Service within which the Slot exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] app_service_slot_name: The name of the App Service Slot which should be promoted to the Production Slot within the App Service.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the App Service exists. Changing this forces a new resource to be created.
        """
    ...
    def app_service_slot_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def app_service_slot_name(self, value: pulumi.Input[builtins.str]):
...
class _ActiveSlotState:
    def __init__(__self__, *,
                 ...
                 app_service_slot_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="appServiceSlotName")
    def app_service_slot_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the App Service Slot which should be promoted to the Production Slot within the App Service.
        """
        return pulumi.get(self, "app_service_slot_name")
    ...
    @app_service_slot_name.setter
    def app_service_slot_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_service_slot_name", value)
...
class ActiveSlot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            app_service_name: Optional[pulumi.Input[builtins.str]] = None,
            app_service_slot_name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ActiveSlot':
        """
    ...
    @property
    @pulumi.getter(name="appServiceSlotName")
    def app_service_slot_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the App Service Slot which should be promoted to the Production Slot within the App Service.
        """
        return pulumi.get(self, "app_service_slot_name")
