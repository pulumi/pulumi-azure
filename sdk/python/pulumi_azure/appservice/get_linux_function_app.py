...
class GetLinuxFunctionAppResult:
    ...
    def builtin_logging_enabled(self) -> _builtins.bool:
        """
    ...
    def client_certificate_enabled(self) -> _builtins.bool:
        """
    ...
    def client_certificate_exclusion_paths(self) -> _builtins.str:
        """
    ...
    def content_share_force_disabled(self) -> _builtins.bool:
        """
    ...
    def daily_memory_time_quota(self) -> _builtins.int:
        """
    ...
    def functions_extension_version(self) -> _builtins.str:
        """
    ...
    def hosting_environment_id(self) -> _builtins.str:
        """
    ...
    def service_plan_id(self) -> _builtins.str:
        """
    ...
    def storage_uses_managed_identity(self) -> _builtins.bool:
        """
    ...
    def virtual_network_backup_restore_enabled(self) -> _builtins.bool:
        """
    ...
    def webdeploy_publish_basic_authentication_enabled(self) -> _builtins.bool:
        """
...
def get_linux_function_app(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Web` - 2023-12-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Linux Function App should exist.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_linux_function_app_output(name: Optional[pulumi.Input[_builtins.str]] = None,
                                  resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetLinuxFunctionAppResult]:
    """
    Use this data source to access information about an existing Linux Function App.
    ...
    * `Microsoft.Web` - 2023-12-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:appservice/getLinuxFunctionApp:getLinuxFunctionApp', __args__, opts=opts, typ=GetLinuxFunctionAppResult)
    return __ret__.apply(lambda __response__: GetLinuxFunctionAppResult(
