...
def get_function_app(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Function App resource.
...
def get_function_app_output(name: Optional[pulumi.Input[builtins.str]] = None,
