...
class GetLinuxWebAppResult:
    ...
    def app_metadata(self) -> Mapping[str, _builtins.str]:
        """
    ...
    def key_vault_reference_identity_id(self) -> _builtins.str:
...
def get_linux_web_app(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Web` - 2023-12-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Linux Web App exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_linux_web_app_output(name: Optional[pulumi.Input[_builtins.str]] = None,
