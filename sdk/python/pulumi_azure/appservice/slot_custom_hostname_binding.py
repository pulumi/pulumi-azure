...
class SlotCustomHostnameBindingArgs:
    def __init__(__self__, *,
                 app_service_slot_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] app_service_slot_id: The ID of the App Service Slot. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] hostname: Specifies the Custom Hostname to use for the App Service, example `www.example.com`. Changing this forces a new resource to be created.
               
               > **Note:** A CNAME needs to be configured from this Hostname to the Azure Website - otherwise Azure will reject the Hostname Binding.
        :param pulumi.Input[builtins.str] ssl_state: The SSL type. Possible values are `IpBasedEnabled` and `SniEnabled`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] thumbprint: The SSL certificate thumbprint. Changing this forces a new resource to be created.
    ...
    def app_service_slot_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def app_service_slot_id(self, value: pulumi.Input[builtins.str]):
...
class _SlotCustomHostnameBindingState:
    def __init__(__self__, *,
                 app_service_slot_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] thumbprint: The SSL certificate thumbprint. Changing this forces a new resource to be created.
               ...
               > **Note:** `thumbprint` must be specified when `ssl_state` is set.
        :param pulumi.Input[builtins.str] virtual_ip: The virtual IP address assigned to the hostname if IP based SSL is enabled.
        """
    ...
    @property
    @pulumi.getter(name="appServiceSlotId")
    def app_service_slot_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the App Service Slot. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "app_service_slot_id")
    ...
    @app_service_slot_id.setter
    def app_service_slot_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_service_slot_id", value)
...
class SlotCustomHostnameBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl_state: Optional[pulumi.Input[builtins.str]] = None,
            thumbprint: Optional[pulumi.Input[builtins.str]] = None,
            virtual_ip: Optional[pulumi.Input[builtins.str]] = None) -> 'SlotCustomHostnameBinding':
        """
    ...
    @property
    @pulumi.getter(name="appServiceSlotId")
    def app_service_slot_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the App Service Slot. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "app_service_slot_id")
