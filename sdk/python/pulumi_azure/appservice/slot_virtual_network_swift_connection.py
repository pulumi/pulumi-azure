...
class SlotVirtualNetworkSwiftConnection(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, app_service_id=None, slot_name=None, subnet_id=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        :param pulumi.Input[str] slot_name: The name of the App Service Slot. Changing this forces a new resource to be created.
    ...
    @staticmethod
    def get(resource_name, id, opts=None, app_service_id=None, slot_name=None, subnet_id=None):
        """
