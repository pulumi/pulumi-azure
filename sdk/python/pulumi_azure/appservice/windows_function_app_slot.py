...
class WindowsFunctionAppSlotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] function_app_id: The name of the Windows Function App this Slot is a member of. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] enabled: Is the Windows Function App Slot enabled. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Windows Function App Slot. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] service_plan_id: The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Windows Function App will be used.
        ...
        :param pulumi.Input[builtins.str] storage_key_vault_secret_id: The Key Vault Secret ID, optionally including version, that contains the Connection String to connect to the storage account for this Function App Slot.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Windows Function App Slot.
...
class _WindowsFunctionAppSlotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] daily_memory_time_quota: The amount of memory in gigabyte-seconds that your application is allowed to consume per day. Setting this value only affects function apps in Consumption Plans. Defaults to `0`.
        :param pulumi.Input[builtins.str] default_hostname: The default hostname of the Windows Function App Slot.
        :param pulumi.Input[builtins.bool] enabled: Is the Windows Function App Slot enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Should the default FTP Basic Authentication publishing profile be enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] function_app_id: The name of the Windows Function App this Slot is a member of. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] functions_extension_version: The runtime version associated with the Function App Slot. Defaults to `~4`.
        ...
        :param pulumi.Input['WindowsFunctionAppSlotIdentityArgs'] identity: an `identity` block as detailed below.
        :param pulumi.Input[builtins.str] key_vault_reference_identity_id: The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
        :param pulumi.Input[builtins.str] kind: The Kind value for this Windows Function App Slot.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Windows Function App Slot. Changing this forces a new resource to be created.
...
class WindowsFunctionAppSlot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_network_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            vnet_image_pull_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            webdeploy_publish_basic_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'WindowsFunctionAppSlot':
        """
