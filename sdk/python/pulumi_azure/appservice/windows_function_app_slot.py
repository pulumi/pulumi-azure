...
class WindowsFunctionAppSlotArgs:
    def __init__(__self__, *,
                 ...
                 auth_settings: pulumi.Input[Optional['WindowsFunctionAppSlotAuthSettingsArgs']] = None,
                 auth_settings_v2: pulumi.Input[Optional['WindowsFunctionAppSlotAuthSettingsV2Args']] = None,
                 backup: pulumi.Input[Optional['WindowsFunctionAppSlotBackupArgs']] = None,
                 ...
                 connection_strings: pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotConnectionStringArgs']]]] = None,
                 ...
                 identity: pulumi.Input[Optional['WindowsFunctionAppSlotIdentityArgs']] = None,
                 ...
                 storage_accounts: pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotStorageAccountArgs']]]] = None,
    ...
    def auth_settings(self) -> pulumi.Input[Optional['WindowsFunctionAppSlotAuthSettingsArgs']]:
        """
    ...
    def auth_settings(self, value: pulumi.Input[Optional['WindowsFunctionAppSlotAuthSettingsArgs']]):
        pulumi.set(self, "auth_settings", value)

    @_builtins.property
    @pulumi.getter(name="authSettingsV2")
    def auth_settings_v2(self) -> pulumi.Input[Optional['WindowsFunctionAppSlotAuthSettingsV2Args']]:
        """
    ...
    def auth_settings_v2(self, value: pulumi.Input[Optional['WindowsFunctionAppSlotAuthSettingsV2Args']]):
        pulumi.set(self, "auth_settings_v2", value)

    @_builtins.property
    @pulumi.getter
    def backup(self) -> pulumi.Input[Optional['WindowsFunctionAppSlotBackupArgs']]:
        """
    ...
    @backup.setter
    def backup(self, value: pulumi.Input[Optional['WindowsFunctionAppSlotBackupArgs']]):
    ...
    def connection_strings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotConnectionStringArgs']]]]:
        """
    ...
    def connection_strings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotConnectionStringArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['WindowsFunctionAppSlotIdentityArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['WindowsFunctionAppSlotIdentityArgs']]):
    ...
    def storage_accounts(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotStorageAccountArgs']]]]:
        """
    ...
    def storage_accounts(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotStorageAccountArgs']]]]):
...
class _WindowsFunctionAppSlotState:
    def __init__(__self__, *,
                 ...
                 public_network_access_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 service_plan_id: pulumi.Input[Optional[_builtins.str]] = None,
                 site_config: pulumi.Input[Optional['WindowsFunctionAppSlotSiteConfigArgs']] = None,
                 site_credentials: pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotSiteCredentialArgs']]]] = None,
                 storage_account_access_key: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_accounts: pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotStorageAccountArgs']]]] = None,
                 storage_key_vault_secret_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="siteConfig")
    def site_config(self) -> pulumi.Input[Optional['WindowsFunctionAppSlotSiteConfigArgs']]:
        """
        a `site_config` block as detailed below.
        """
        return pulumi.get(self, "site_config")
    ...
    @site_config.setter
    def site_config(self, value: pulumi.Input[Optional['WindowsFunctionAppSlotSiteConfigArgs']]):
        pulumi.set(self, "site_config", value)

    @_builtins.property
    @pulumi.getter(name="siteCredentials")
    def site_credentials(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotSiteCredentialArgs']]]]:
        """
    ...
    def site_credentials(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WindowsFunctionAppSlotSiteCredentialArgs']]]]):
...
class WindowsFunctionAppSlot(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 app_settings: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 auth_settings: pulumi.Input[Optional[Union['WindowsFunctionAppSlotAuthSettingsArgs', 'WindowsFunctionAppSlotAuthSettingsArgsDict', 'outputs.WindowsFunctionAppSlotAuthSettings']]] = None,
                 auth_settings_v2: pulumi.Input[Optional[Union['WindowsFunctionAppSlotAuthSettingsV2Args', 'WindowsFunctionAppSlotAuthSettingsV2ArgsDict', 'outputs.WindowsFunctionAppSlotAuthSettingsV2']]] = None,
                 backup: pulumi.Input[Optional[Union['WindowsFunctionAppSlotBackupArgs', 'WindowsFunctionAppSlotBackupArgsDict', 'outputs.WindowsFunctionAppSlotBackup']]] = None,
                 builtin_logging_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 client_certificate_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 client_certificate_exclusion_paths: pulumi.Input[Optional[_builtins.str]] = None,
                 client_certificate_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 connection_strings: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotConnectionStringArgs', 'WindowsFunctionAppSlotConnectionStringArgsDict', 'outputs.WindowsFunctionAppSlotConnectionString']]]]] = None,
                 content_share_force_disabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 daily_memory_time_quota: pulumi.Input[Optional[_builtins.int]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 ftp_publish_basic_authentication_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 functions_extension_version: pulumi.Input[Optional[_builtins.str]] = None,
                 https_only: pulumi.Input[Optional[_builtins.bool]] = None,
                 identity: pulumi.Input[Optional[Union['WindowsFunctionAppSlotIdentityArgs', 'WindowsFunctionAppSlotIdentityArgsDict', 'outputs.WindowsFunctionAppSlotIdentity']]] = None,
                 key_vault_reference_identity_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 public_network_access_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 service_plan_id: pulumi.Input[Optional[_builtins.str]] = None,
                 site_config: pulumi.Input[Optional[Union['WindowsFunctionAppSlotSiteConfigArgs', 'WindowsFunctionAppSlotSiteConfigArgsDict', 'outputs.WindowsFunctionAppSlotSiteConfig']]] = None,
                 storage_account_access_key: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_accounts: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotStorageAccountArgs', 'WindowsFunctionAppSlotStorageAccountArgsDict', 'outputs.WindowsFunctionAppSlotStorageAccount']]]]] = None,
                 storage_key_vault_secret_id: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_uses_managed_identity: pulumi.Input[Optional[_builtins.bool]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 virtual_network_backup_restore_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        * `Microsoft.Web` - 2023-12-01, 2023-01-01
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] app_settings: A map of key-value pairs for [App Settings](https://docs.microsoft.com/azure/azure-functions/functions-app-settings) and custom values.
        :param pulumi.Input[Union['WindowsFunctionAppSlotAuthSettingsArgs', 'WindowsFunctionAppSlotAuthSettingsArgsDict', 'outputs.WindowsFunctionAppSlotAuthSettings']] auth_settings: an `auth_settings` block as detailed below.
        :param pulumi.Input[Union['WindowsFunctionAppSlotAuthSettingsV2Args', 'WindowsFunctionAppSlotAuthSettingsV2ArgsDict', 'outputs.WindowsFunctionAppSlotAuthSettingsV2']] auth_settings_v2: an `auth_settings_v2` block as detailed below.
        :param pulumi.Input[Union['WindowsFunctionAppSlotBackupArgs', 'WindowsFunctionAppSlotBackupArgsDict', 'outputs.WindowsFunctionAppSlotBackup']] backup: a `backup` block as detailed below.
        :param pulumi.Input[_builtins.bool] builtin_logging_enabled: Should built-in logging be enabled. Configures `AzureWebJobsDashboard` app setting based on the configured storage setting. Defaults to `true`.
        :param pulumi.Input[_builtins.bool] client_certificate_enabled: Should the Function App Slot use Client Certificates.
        :param pulumi.Input[_builtins.str] client_certificate_exclusion_paths: Paths to exclude when using client certificates, separated by ;
               ...
               > **Note:** TLS 1.3 and HTTP 2.0 don't support TLS renegotiation. These protocols will not work if your app is configured with client certificate settings that use TLS renegotiation. Either set `client_certificate_enabled` to `false`, or set `client_certificate_mode` to `Optional` or `Required` and remove all `client_certificate_exclusion_paths`.
        :param pulumi.Input[_builtins.str] client_certificate_mode: The mode of the Function App Slot's client certificates requirement for incoming requests. Possible values are `Required`, `Optional`, and `OptionalInteractiveUser`. Defaults to `Optional`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotConnectionStringArgs', 'WindowsFunctionAppSlotConnectionStringArgsDict', 'outputs.WindowsFunctionAppSlotConnectionString']]]] connection_strings: a `connection_string` block as detailed below.
        :param pulumi.Input[_builtins.bool] content_share_force_disabled: Force disable the content share settings.
        :param pulumi.Input[_builtins.int] daily_memory_time_quota: The amount of memory in gigabyte-seconds that your application is allowed to consume per day. Setting this value only affects function apps in Consumption Plans. Defaults to `0`.
        :param pulumi.Input[_builtins.bool] enabled: Is the Windows Function App Slot enabled. Defaults to `true`.
        :param pulumi.Input[_builtins.bool] ftp_publish_basic_authentication_enabled: Should the default FTP Basic Authentication publishing profile be enabled. Defaults to `true`.
        ...
        :param pulumi.Input[_builtins.str] functions_extension_version: The runtime version associated with the Function App Slot. Defaults to `~4`.
        :param pulumi.Input[_builtins.bool] https_only: Can the Function App Slot only be accessed via HTTPS?. Defaults to `false`.
        :param pulumi.Input[Union['WindowsFunctionAppSlotIdentityArgs', 'WindowsFunctionAppSlotIdentityArgsDict', 'outputs.WindowsFunctionAppSlotIdentity']] identity: an `identity` block as detailed below.
        :param pulumi.Input[_builtins.str] key_vault_reference_identity_id: The User Assigned Identity ID used for accessing KeyVault secrets. The identity must be assigned to the application in the `identity` block. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Windows Function App Slot. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.bool] public_network_access_enabled: Should public network access be enabled for the Function App. Defaults to `true`.
        :param pulumi.Input[_builtins.str] service_plan_id: The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Windows Function App will be used.
        :param pulumi.Input[Union['WindowsFunctionAppSlotSiteConfigArgs', 'WindowsFunctionAppSlotSiteConfigArgsDict', 'outputs.WindowsFunctionAppSlotSiteConfig']] site_config: a `site_config` block as detailed below.
        :param pulumi.Input[_builtins.str] storage_account_access_key: The access key which will be used to access the storage account for the Function App Slot.
        :param pulumi.Input[_builtins.str] storage_account_name: The backend storage account name which will be used by this Function App Slot.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotStorageAccountArgs', 'WindowsFunctionAppSlotStorageAccountArgsDict', 'outputs.WindowsFunctionAppSlotStorageAccount']]]] storage_accounts: One or more `storage_account` blocks as defined below.
        :param pulumi.Input[_builtins.str] storage_key_vault_secret_id: The Key Vault Secret ID, optionally including version, that contains the Connection String to connect to the storage account for this Function App Slot.
    ...
    def get(resource_name: str,
            ...
            service_plan_id: pulumi.Input[Optional[_builtins.str]] = None,
            site_config: pulumi.Input[Optional[Union['WindowsFunctionAppSlotSiteConfigArgs', 'WindowsFunctionAppSlotSiteConfigArgsDict', 'outputs.WindowsFunctionAppSlotSiteConfig']]] = None,
            site_credentials: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotSiteCredentialArgs', 'WindowsFunctionAppSlotSiteCredentialArgsDict', 'outputs.WindowsFunctionAppSlotSiteCredential']]]]] = None,
            storage_account_access_key: pulumi.Input[Optional[_builtins.str]] = None,
            storage_account_name: pulumi.Input[Optional[_builtins.str]] = None,
            storage_accounts: pulumi.Input[Optional[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotStorageAccountArgs', 'WindowsFunctionAppSlotStorageAccountArgsDict', 'outputs.WindowsFunctionAppSlotStorageAccount']]]]] = None,
            storage_key_vault_secret_id: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            virtual_network_subnet_id: pulumi.Input[Optional[_builtins.str]] = None,
            vnet_image_pull_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            webdeploy_publish_basic_authentication_enabled: pulumi.Input[Optional[_builtins.bool]] = None) -> 'WindowsFunctionAppSlot':
        """
        ...
        :param pulumi.Input[_builtins.str] service_plan_id: The ID of the Service Plan in which to run this slot. If not specified the same Service Plan as the Windows Function App will be used.
        :param pulumi.Input[Union['WindowsFunctionAppSlotSiteConfigArgs', 'WindowsFunctionAppSlotSiteConfigArgsDict', 'outputs.WindowsFunctionAppSlotSiteConfig']] site_config: a `site_config` block as detailed below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotSiteCredentialArgs', 'WindowsFunctionAppSlotSiteCredentialArgsDict', 'outputs.WindowsFunctionAppSlotSiteCredential']]]] site_credentials: A `site_credential` block as defined below.
        :param pulumi.Input[_builtins.str] storage_account_access_key: The access key which will be used to access the storage account for the Function App Slot.
        :param pulumi.Input[_builtins.str] storage_account_name: The backend storage account name which will be used by this Function App Slot.
        :param pulumi.Input[Sequence[pulumi.Input[Union['WindowsFunctionAppSlotStorageAccountArgs', 'WindowsFunctionAppSlotStorageAccountArgsDict', 'outputs.WindowsFunctionAppSlotStorageAccount']]]] storage_accounts: One or more `storage_account` blocks as defined below.
        :param pulumi.Input[_builtins.str] storage_key_vault_secret_id: The Key Vault Secret ID, optionally including version, that contains the Connection String to connect to the storage account for this Function App Slot.
