...
class LinuxFunctionApp(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            auth_settings = _utilities.configure(auth_settings, LinuxFunctionAppAuthSettingsArgs, True)
            __props__.__dict__["auth_settings"] = auth_settings
            auth_settings_v2 = _utilities.configure(auth_settings_v2, LinuxFunctionAppAuthSettingsV2Args, True)
            __props__.__dict__["auth_settings_v2"] = auth_settings_v2
            backup = _utilities.configure(backup, LinuxFunctionAppBackupArgs, True)
            ...
            identity = _utilities.configure(identity, LinuxFunctionAppIdentityArgs, True)
            ...
            site_config = _utilities.configure(site_config, LinuxFunctionAppSiteConfigArgs, True)
            ...
            sticky_settings = _utilities.configure(sticky_settings, LinuxFunctionAppStickySettingsArgs, True)
