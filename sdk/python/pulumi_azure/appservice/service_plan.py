...
class ServicePlanArgs:
    def __init__(__self__, *,
                 ...
                 app_service_environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 maximum_elastic_worker_count: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 per_site_scaling_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 premium_plan_auto_scale_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 worker_count: Optional[pulumi.Input[builtins.int]] = None,
                 zone_balancing_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a ServicePlan resource.
        :param pulumi.Input[builtins.str] os_type: The O/S type for the App Services to be hosted in this plan. Possible values include `Windows`, `Linux`, and `WindowsContainer`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Service Plan should exist. Changing this forces a new Service Plan to be created.
        :param pulumi.Input[builtins.str] sku_name: The SKU for the plan. Possible values include `B1`, `B2`, `B3`, `D1`, `F1`, `I1`, `I2`, `I3`, `I1v2`, `I1mv2`, `I2v2`, `I2mv2`, `I3v2`, `I3mv2`, `I4v2`, `I4mv2`, `I5v2`, `I5mv2`, `I6v2`, `P1v2`, `P2v2`, `P3v2`, `P0v3`, `P1v3`, `P2v3`, `P3v3`, `P1mv3`, `P2mv3`, `P3mv3`, `P4mv3`, `P5mv3`, `S1`, `S2`, `S3`, `SHARED`, `EP1`, `EP2`, `EP3`, `FC1`, `WS1`, `WS2`, `WS3`, and `Y1`.
        ...
        :param pulumi.Input[builtins.str] app_service_environment_id: The ID of the App Service Environment to create this Service Plan in.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Service Plan should exist. Changing this forces a new Service Plan to be created.
        :param pulumi.Input[builtins.int] maximum_elastic_worker_count: The maximum number of workers to use in an Elastic SKU Plan or Premium Plan that have `premium_plan_auto_scale_enabled` set to `true`. Cannot be set unless using an Elastic or Premium SKU.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Service Plan. Changing this forces a new Service Plan to be created.
        :param pulumi.Input[builtins.bool] per_site_scaling_enabled: Should Per Site Scaling be enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] premium_plan_auto_scale_enabled: Should automatic scaling be enabled for the Premium SKU Plan. Defaults to `false`. Cannot be set unless using a Premium SKU.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the AppService.
        :param pulumi.Input[builtins.int] worker_count: The number of Workers (instances) to be allocated.
        :param pulumi.Input[builtins.bool] zone_balancing_enabled: Should the Service Plan balance across Availability Zones in the region. Changing this forces a new resource to be created.
    ...
    def app_service_environment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def app_service_environment_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def per_site_scaling_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def per_site_scaling_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "per_site_scaling_enabled", value)

    @property
    @pulumi.getter(name="premiumPlanAutoScaleEnabled")
    def premium_plan_auto_scale_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def premium_plan_auto_scale_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def zone_balancing_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def zone_balancing_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ServicePlanState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_service_environment_id: The ID of the App Service Environment to create this Service Plan in.
               ...
               > **Note:** Requires an Isolated SKU for `appservice.EnvironmentV3`, supported values include `I1v2`, `I1mv2`, `I2v2`, `I2mv2`, `I3v2`, `I3mv2`, `I4v2`, `I4mv2`, `I5v2`, `I5mv2`, and `I6v2`.
        :param pulumi.Input[builtins.str] kind: A string representing the Kind of Service Plan.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Service Plan should exist. Changing this forces a new Service Plan to be created.
        :param pulumi.Input[builtins.int] maximum_elastic_worker_count: The maximum number of workers to use in an Elastic SKU Plan or Premium Plan that have `premium_plan_auto_scale_enabled` set to `true`. Cannot be set unless using an Elastic or Premium SKU.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Service Plan. Changing this forces a new Service Plan to be created.
        :param pulumi.Input[builtins.str] os_type: The O/S type for the App Services to be hosted in this plan. Possible values include `Windows`, `Linux`, and `WindowsContainer`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] per_site_scaling_enabled: Should Per Site Scaling be enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] premium_plan_auto_scale_enabled: Should automatic scaling be enabled for the Premium SKU Plan. Defaults to `false`. Cannot be set unless using a Premium SKU.
        :param pulumi.Input[builtins.bool] reserved: Whether this is a reserved Service Plan Type. `true` if `os_type` is `Linux`, otherwise `false`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Service Plan should exist. Changing this forces a new Service Plan to be created.
        :param pulumi.Input[builtins.str] sku_name: The SKU for the plan. Possible values include `B1`, `B2`, `B3`, `D1`, `F1`, `I1`, `I2`, `I3`, `I1v2`, `I1mv2`, `I2v2`, `I2mv2`, `I3v2`, `I3mv2`, `I4v2`, `I4mv2`, `I5v2`, `I5mv2`, `I6v2`, `P1v2`, `P2v2`, `P3v2`, `P0v3`, `P1v3`, `P2v3`, `P3v3`, `P1mv3`, `P2mv3`, `P3mv3`, `P4mv3`, `P5mv3`, `S1`, `S2`, `S3`, `SHARED`, `EP1`, `EP2`, `EP3`, `FC1`, `WS1`, `WS2`, `WS3`, and `Y1`.
...
class ServicePlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            worker_count: Optional[pulumi.Input[builtins.int]] = None,
            zone_balancing_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'ServicePlan':
        """
    ...
    @property
    @pulumi.getter(name="appServiceEnvironmentId")
    def app_service_environment_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the App Service Environment to create this Service Plan in.
    ...
    @property
    @pulumi.getter(name="maximumElasticWorkerCount")
    def maximum_elastic_worker_count(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of workers to use in an Elastic SKU Plan or Premium Plan that have `premium_plan_auto_scale_enabled` set to `true`. Cannot be set unless using an Elastic or Premium SKU.
        """
        return pulumi.get(self, "maximum_elastic_worker_count")
    ...
    @property
    @pulumi.getter(name="perSiteScalingEnabled")
    def per_site_scaling_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should Per Site Scaling be enabled. Defaults to `false`.
        """
        return pulumi.get(self, "per_site_scaling_enabled")
    ...
    @property
    @pulumi.getter(name="premiumPlanAutoScaleEnabled")
    def premium_plan_auto_scale_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should automatic scaling be enabled for the Premium SKU Plan. Defaults to `false`. Cannot be set unless using a Premium SKU.
        """
        return pulumi.get(self, "premium_plan_auto_scale_enabled")
    ...
    @property
    @pulumi.getter(name="zoneBalancingEnabled")
    def zone_balancing_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Service Plan balance across Availability Zones in the region. Changing this forces a new resource to be created.
