...
class _WebAppHybridConnectionState:
    ...
    @property
    @pulumi.getter(name="webAppId")
    def web_app_id(self) -> Optional[pulumi.Input[str]]:
        """
        The ID of the Web App for this Hybrid Connection. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "web_app_id")
    ...
    @web_app_id.setter
    def web_app_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "web_app_id", value)
...
class WebAppHybridConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_windows_web_app = azure.appservice.windows_web_app.WindowsWebApp("example",
            ...
            site_config={})
        example_web_app_hybrid_connection = azure.appservice.web_app_hybrid_connection.WebAppHybridConnection("example",
    ...
    def get(resource_name: str,
            ...
            service_bus_namespace: Optional[pulumi.Input[str]] = None,
            service_bus_suffix: Optional[pulumi.Input[str]] = None,
            web_app_id: Optional[pulumi.Input[str]] = None) -> 'WebAppHybridConnection':
        """
