...
class WebAppHybridConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] web_app_id: The ID of the Web App for this Hybrid Connection. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] send_key_name: The name of the Relay key with `Send` permission to use. Defaults to `RootManageSharedAccessKey`
        """
...
class _WebAppHybridConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] port: The port to use for the endpoint.
        :param pulumi.Input[_builtins.str] relay_id: The ID of the Relay Hybrid Connection to use. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] relay_name: The name of the Relay in use.
        :param pulumi.Input[_builtins.str] send_key_name: The name of the Relay key with `Send` permission to use. Defaults to `RootManageSharedAccessKey`
        :param pulumi.Input[_builtins.str] send_key_value: The Primary Access Key for the `send_key_name`
        :param pulumi.Input[_builtins.str] service_bus_namespace: The Service Bus Namespace.
        :param pulumi.Input[_builtins.str] service_bus_suffix: The suffix for the endpoint.
        :param pulumi.Input[_builtins.str] web_app_id: The ID of the Web App for this Hybrid Connection. Changing this forces a new resource to be created.
        """
    ...
    @web_app_id.setter
    def web_app_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "web_app_id", value)
...
class WebAppHybridConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_bus_namespace: pulumi.Input[Optional[_builtins.str]] = None,
            service_bus_suffix: pulumi.Input[Optional[_builtins.str]] = None,
            web_app_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'WebAppHybridConnection':
        """
