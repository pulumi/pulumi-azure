...
class PublicCertificateArgs:
    def __init__(__self__, *,
                 ...
                 blob: pulumi.Input[_builtins.str],
                 certificate_location: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] certificate_name: The name of the public certificate. Changing this forces a new App Service Public Certificate to be created.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the App Service Public Certificate should exist. Changing this forces a new App Service Public Certificate to be created.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def blob(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @blob.setter
    def blob(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "blob", value)

    @_builtins.property
    @pulumi.getter(name="certificateLocation")
    def certificate_location(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def certificate_location(self, value: pulumi.Input[_builtins.str]):
...
class _PublicCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] certificate_name: The name of the public certificate. Changing this forces a new App Service Public Certificate to be created.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the App Service Public Certificate should exist. Changing this forces a new App Service Public Certificate to be created.
        :param pulumi.Input[_builtins.str] thumbprint: The thumbprint of the public certificate.
        """
...
class PublicCertificate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def blob(self) -> pulumi.Output[_builtins.str]:
        """
        The base64-encoded contents of the certificate. Changing this forces a new App Service Public Certificate to be created.
        """
        return pulumi.get(self, "blob")
