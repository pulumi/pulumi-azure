...
class EnvironmentV3Args:
    def __init__(__self__, *,
                 ...
                 dedicated_host_count: Optional[pulumi.Input[builtins.int]] = None,
                 internal_load_balancing_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the App Service Environment exists. Defaults to the Resource Group of the Subnet (specified by `subnet_id`). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet which the App Service Environment should be connected to. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] allow_new_private_endpoint_connections: Should new Private Endpoint Connections be allowed. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.int] dedicated_host_count: This ASEv3 should use dedicated Hosts. Possible values are `2`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] internal_load_balancing_mode: Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment. Possible values are `None` (for an External VIP Type), and `"Web, Publishing"` (for an Internal VIP Type). Defaults to `None`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the App Service Environment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] remote_debugging_enabled: Whether to enable remote debug. Defaults to `false`.
        :param pulumi.Input[builtins.bool] zone_redundant: Set to `true` to deploy the ASEv3 with availability zones supported. Zonal ASEs can be deployed in some regions, you can refer to [Availability Zone support for App Service Environments](https://docs.microsoft.com/azure/app-service/environment/zone-redundancy). You can only set either `dedicated_host_count` or `zone_redundant` but not both. Changing this forces a new resource to be created.
    ...
    def dedicated_host_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def dedicated_host_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "dedicated_host_count", value)

    @property
    @pulumi.getter(name="internalLoadBalancingMode")
    def internal_load_balancing_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def internal_load_balancing_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnvironmentV3State:
    def __init__(__self__, *,
                 ...
                 external_inbound_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inbound_network_dependencies: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentV3InboundNetworkDependencyArgs']]]] = None,
                 internal_inbound_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 internal_load_balancing_mode: Optional[pulumi.Input[builtins.str]] = None,
                 ip_ssl_address_count: Optional[pulumi.Input[builtins.int]] = None,
                 linux_outbound_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 windows_outbound_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 zone_redundant: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentV3ClusterSettingArgs']]] cluster_settings: Zero or more `cluster_setting` blocks as defined below.
        :param pulumi.Input[builtins.int] dedicated_host_count: This ASEv3 should use dedicated Hosts. Possible values are `2`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] dns_suffix: the DNS suffix for this App Service Environment V3.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_inbound_ip_addresses: The external inbound IP addresses of the App Service Environment V3.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] internal_inbound_ip_addresses: The internal inbound IP addresses of the App Service Environment V3.
        :param pulumi.Input[builtins.str] internal_load_balancing_mode: Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment. Possible values are `None` (for an External VIP Type), and `"Web, Publishing"` (for an Internal VIP Type). Defaults to `None`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] ip_ssl_address_count: The number of IP SSL addresses reserved for the App Service Environment V3.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] linux_outbound_ip_addresses: Outbound addresses of Linux based Apps in this App Service Environment V3
        :param pulumi.Input[builtins.str] location: The location where the App Service Environment exists.
        :param pulumi.Input[builtins.str] name: The name of the App Service Environment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] pricing_tier: Pricing tier for the front end instances.
        :param pulumi.Input[builtins.bool] remote_debugging_enabled: Whether to enable remote debug. Defaults to `false`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the App Service Environment exists. Defaults to the Resource Group of the Subnet (specified by `subnet_id`). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet which the App Service Environment should be connected to. Changing this forces a new resource to be created.
               ...
               > **Note:** This Subnet requires a delegation to `Microsoft.Web/hostingEnvironments` as detailed in the example above.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] windows_outbound_ip_addresses: Outbound addresses of Windows based Apps in this App Service Environment V3.
        :param pulumi.Input[builtins.bool] zone_redundant: Set to `true` to deploy the ASEv3 with availability zones supported. Zonal ASEs can be deployed in some regions, you can refer to [Availability Zone support for App Service Environments](https://docs.microsoft.com/azure/app-service/environment/zone-redundancy). You can only set either `dedicated_host_count` or `zone_redundant` but not both. Changing this forces a new resource to be created.
    ...
    def external_inbound_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def external_inbound_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def internal_inbound_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def internal_inbound_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def ip_ssl_address_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ip_ssl_address_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ip_ssl_address_count", value)

    @property
    @pulumi.getter(name="linuxOutboundIpAddresses")
    def linux_outbound_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def linux_outbound_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def windows_outbound_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def windows_outbound_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class EnvironmentV3(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            windows_outbound_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone_redundant: Optional[pulumi.Input[builtins.bool]] = None) -> 'EnvironmentV3':
        """
    ...
    @property
    @pulumi.getter(name="allowNewPrivateEndpointConnections")
    def allow_new_private_endpoint_connections(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should new Private Endpoint Connections be allowed. Defaults to `true`.
        """
        return pulumi.get(self, "allow_new_private_endpoint_connections")
    ...
    @property
    @pulumi.getter(name="dedicatedHostCount")
    def dedicated_host_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        This ASEv3 should use dedicated Hosts. Possible values are `2`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "dedicated_host_count")
    ...
    @property
    @pulumi.getter(name="externalInboundIpAddresses")
    def external_inbound_ip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The external inbound IP addresses of the App Service Environment V3.
        """
        return pulumi.get(self, "external_inbound_ip_addresses")
    ...
    @property
    @pulumi.getter(name="internalInboundIpAddresses")
    def internal_inbound_ip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The internal inbound IP addresses of the App Service Environment V3.
        """
        return pulumi.get(self, "internal_inbound_ip_addresses")
    ...
    @property
    @pulumi.getter(name="internalLoadBalancingMode")
    def internal_load_balancing_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies which endpoints to serve internally in the Virtual Network for the App Service Environment. Possible values are `None` (for an External VIP Type), and `"Web, Publishing"` (for an Internal VIP Type). Defaults to `None`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "internal_load_balancing_mode")
    ...
    @property
    @pulumi.getter(name="ipSslAddressCount")
    def ip_ssl_address_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of IP SSL addresses reserved for the App Service Environment V3.
        """
        return pulumi.get(self, "ip_ssl_address_count")
    ...
    @property
    @pulumi.getter(name="linuxOutboundIpAddresses")
    def linux_outbound_ip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Outbound addresses of Linux based Apps in this App Service Environment V3
        """
        return pulumi.get(self, "linux_outbound_ip_addresses")
    ...
    @property
    @pulumi.getter(name="remoteDebuggingEnabled")
    def remote_debugging_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable remote debug. Defaults to `false`.
        """
        return pulumi.get(self, "remote_debugging_enabled")
    ...
    @property
    @pulumi.getter(name="windowsOutboundIpAddresses")
    def windows_outbound_ip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Outbound addresses of Windows based Apps in this App Service Environment V3.
        """
        return pulumi.get(self, "windows_outbound_ip_addresses")
