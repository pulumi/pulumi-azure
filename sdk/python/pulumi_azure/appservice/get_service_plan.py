...
class GetServicePlanResult:
    ...
    def maximum_elastic_worker_count(self) -> builtins.int:
        """
    ...
    def per_site_scaling_enabled(self) -> builtins.bool:
        """
    ...
    def zone_balancing_enabled(self) -> builtins.bool:
        """
...
def get_service_plan(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Web`: 2023-12-01
    ...
    :param builtins.str name: The name of this Service Plan.
    :param builtins.str resource_group_name: The name of the Resource Group where the Service Plan exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_service_plan_output(name: Optional[pulumi.Input[builtins.str]] = None,
