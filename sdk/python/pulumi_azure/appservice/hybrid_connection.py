...
class HybridConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_service_name: Specifies the name of the App Service. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] relay_id: The ID of the Service Bus Relay. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the App Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] send_key_name: The name of the Service Bus key which has Send permissions. Defaults to `RootManageSharedAccessKey`.
        """
...
class _HybridConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the App Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] send_key_name: The name of the Service Bus key which has Send permissions. Defaults to `RootManageSharedAccessKey`.
        :param pulumi.Input[builtins.str] send_key_value: The value of the Service Bus Primary Access key.
        :param pulumi.Input[builtins.str] service_bus_namespace: The name of the Service Bus namespace.
        :param pulumi.Input[builtins.str] service_bus_suffix: The suffix for the service bus endpoint.
        """
...
class HybridConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            send_key_value: Optional[pulumi.Input[builtins.str]] = None,
            service_bus_namespace: Optional[pulumi.Input[builtins.str]] = None,
            service_bus_suffix: Optional[pulumi.Input[builtins.str]] = None) -> 'HybridConnection':
        """
