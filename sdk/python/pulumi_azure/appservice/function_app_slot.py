...
class FunctionAppSlotArgs:
    def __init__(__self__, *,
                 ...
                 function_app_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] function_app_name: The name of the Function App within which to create the Function App Slot. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] enable_builtin_logging: Should the built-in logging of the Function App be enabled? Defaults to `true`.
    ...
    def function_app_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def function_app_name(self, value: pulumi.Input[builtins.str]):
...
class _FunctionAppSlotState:
    ...
    @property
    @pulumi.getter(name="functionAppName")
    def function_app_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Function App within which to create the Function App Slot. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "function_app_name")
    ...
    @function_app_name.setter
    def function_app_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "function_app_name", value)
...
class FunctionAppSlot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'FunctionAppSlot':
        """
    ...
    @property
    @pulumi.getter(name="functionAppName")
    def function_app_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Function App within which to create the Function App Slot. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "function_app_name")
