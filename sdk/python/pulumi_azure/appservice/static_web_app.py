...
class StaticWebAppArgs:
    def __init__(__self__, *,
                 ...
                 configuration_file_changes_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 identity: Optional[pulumi.Input['StaticWebAppIdentityArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 preview_environments_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Static Web App should exist. Changing this forces a new Static Web App to be created.
        ...
        :param pulumi.Input[builtins.bool] configuration_file_changes_enabled: Should changes to the configuration file be permitted. Defaults to `true`.
        :param pulumi.Input['StaticWebAppIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Static Web App should exist. Changing this forces a new Static Web App to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Static Web App. Changing this forces a new Static Web App to be created.
        :param pulumi.Input[builtins.bool] preview_environments_enabled: Are Preview (Staging) environments enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Should public network access be enabled for the Static Web App. Defaults to `true`.
        :param pulumi.Input[builtins.str] repository_branch: Repository branch to use for the Static Web App. `repository_url` and `repository_token` must also be set.
        :param pulumi.Input[builtins.str] repository_token: Repository Token with `admin` privileges to use for the Static Web App. `repository_branch` and `repository_url` must also be set.
        :param pulumi.Input[builtins.str] repository_url: Repository URL to use for the Static Web App. `repository_branch` and `repository_token` must also be set.
        :param pulumi.Input[builtins.str] sku_size: Specifies the SKU size of the Static Web App. Possible values are `Free` or `Standard`. Defaults to `Free`.
        :param pulumi.Input[builtins.str] sku_tier: Specifies the SKU tier of the Static Web App. Possible values are `Free` or `Standard`. Defaults to `Free`.
    ...
    def configuration_file_changes_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def configuration_file_changes_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def preview_environments_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def preview_environments_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _StaticWebAppState:
    def __init__(__self__, *,
                 ...
                 basic_auth: Optional[pulumi.Input['StaticWebAppBasicAuthArgs']] = None,
                 configuration_file_changes_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 default_host_name: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['StaticWebAppIdentityArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 preview_environments_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] api_key: The API key of this Static Web App, which is used for later interacting with this Static Web App from other clients, e.g. GitHub Action.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] app_settings: A key-value pair of App Settings.
        :param pulumi.Input['StaticWebAppBasicAuthArgs'] basic_auth: A `basic_auth` block as defined below.
        :param pulumi.Input[builtins.bool] configuration_file_changes_enabled: Should changes to the configuration file be permitted. Defaults to `true`.
        :param pulumi.Input[builtins.str] default_host_name: The default host name of the Static Web App.
        :param pulumi.Input['StaticWebAppIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Static Web App should exist. Changing this forces a new Static Web App to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Static Web App. Changing this forces a new Static Web App to be created.
        :param pulumi.Input[builtins.bool] preview_environments_enabled: Are Preview (Staging) environments enabled. Defaults to `true`.
    ...
    def default_host_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_host_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StaticWebApp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sku_size: Optional[pulumi.Input[builtins.str]] = None,
            sku_tier: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'StaticWebApp':
        """
    ...
    @property
    @pulumi.getter(name="configurationFileChangesEnabled")
    def configuration_file_changes_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should changes to the configuration file be permitted. Defaults to `true`.
        """
        return pulumi.get(self, "configuration_file_changes_enabled")
    ...
    @property
    @pulumi.getter(name="defaultHostName")
    def default_host_name(self) -> pulumi.Output[builtins.str]:
        """
        The default host name of the Static Web App.
        """
        return pulumi.get(self, "default_host_name")
    ...
    @property
    @pulumi.getter(name="previewEnvironmentsEnabled")
    def preview_environments_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Are Preview (Staging) environments enabled. Defaults to `true`.
        """
        return pulumi.get(self, "preview_environments_enabled")
