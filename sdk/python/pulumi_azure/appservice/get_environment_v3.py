...
class GetEnvironmentV3Result:
    ...
    def allow_new_private_endpoint_connections(self) -> _builtins.bool:
        """
    ...
    def dedicated_host_count(self) -> _builtins.int:
        """
    ...
    def internal_load_balancing_mode(self) -> _builtins.str:
        """
    ...
    def ip_ssl_address_count(self) -> _builtins.int:
        """
    ...
    def remote_debugging_enabled(self) -> _builtins.bool:
...
def get_environment_v3(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Web` - 2023-01-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the v3 App Service Environment exists.
    """
    __args__ = dict()
    __args__['name'] = name
