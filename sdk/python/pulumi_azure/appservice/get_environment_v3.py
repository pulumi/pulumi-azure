...
class GetEnvironmentV3Result:
    ...
    def allow_new_private_endpoint_connections(self) -> builtins.bool:
        """
    ...
    def dedicated_host_count(self) -> builtins.int:
        """
    ...
    def ip_ssl_address_count(self) -> builtins.int:
        """
    ...
    def remote_debugging_enabled(self) -> builtins.bool:
...
def get_environment_v3(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Web`: 2023-01-01
    ...
    :param builtins.str name: The name of this v3 App Service Environment.
    :param builtins.str resource_group_name: The name of the Resource Group where the v3 App Service Environment exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_environment_v3_output(name: Optional[pulumi.Input[builtins.str]] = None,
