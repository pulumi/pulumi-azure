...
class StaticWebAppCustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] static_web_app_id: The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        """
...
class StaticWebAppCustomDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            static_web_app_id: Optional[pulumi.Input[str]] = None,
            validation_token: Optional[pulumi.Input[str]] = None,
            validation_type: Optional[pulumi.Input[str]] = None) -> 'StaticWebAppCustomDomain':
        """
