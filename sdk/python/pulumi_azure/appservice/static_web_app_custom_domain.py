...
class StaticWebAppCustomDomainArgs:
    def __init__(__self__, *,
                 ...
                 static_web_app_id: pulumi.Input[builtins.str],
                 validation_type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a StaticWebAppCustomDomain resource.
        :param pulumi.Input[builtins.str] domain_name: The Domain Name which should be associated with this Static Site. Changing this forces a new Static Site Custom Domain to be created.
        :param pulumi.Input[builtins.str] static_web_app_id: The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        """
    ...
    def static_web_app_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def static_web_app_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "static_web_app_id", value)

    @property
    @pulumi.getter(name="validationType")
    def validation_type(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "validation_type")

    @validation_type.setter
    def validation_type(self, value: pulumi.Input[builtins.str]):
...
class _StaticWebAppCustomDomainState:
    def __init__(__self__, *,
                 ...
                 static_web_app_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_name: The Domain Name which should be associated with this Static Site. Changing this forces a new Static Site Custom Domain to be created.
        :param pulumi.Input[builtins.str] static_web_app_id: The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        :param pulumi.Input[builtins.str] validation_token: Token to be used with `dns-txt-token` validation.
        """
    ...
    @property
    @pulumi.getter(name="staticWebAppId")
    def static_web_app_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        """
        return pulumi.get(self, "static_web_app_id")
    ...
    @static_web_app_id.setter
    def static_web_app_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "static_web_app_id", value)
...
class StaticWebAppCustomDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            static_web_app_id: Optional[pulumi.Input[builtins.str]] = None,
            validation_token: Optional[pulumi.Input[builtins.str]] = None,
            validation_type: Optional[pulumi.Input[builtins.str]] = None) -> 'StaticWebAppCustomDomain':
        """
    ...
    @property
    @pulumi.getter(name="staticWebAppId")
    def static_web_app_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        """
        return pulumi.get(self, "static_web_app_id")
