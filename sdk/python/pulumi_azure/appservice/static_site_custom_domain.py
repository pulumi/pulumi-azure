...
class StaticSiteCustomDomainArgs:
    def __init__(__self__, *,
                 ...
                 static_site_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] static_site_id: The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        :param pulumi.Input[builtins.str] validation_type: One of `cname-delegation` or `dns-txt-token`. Changing this forces a new Static Site Custom Domain to be created.
        """
    ...
    def static_site_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def static_site_id(self, value: pulumi.Input[builtins.str]):
...
class _StaticSiteCustomDomainState:
    def __init__(__self__, *,
                 ...
                 static_site_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="staticSiteId")
    def static_site_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        """
        return pulumi.get(self, "static_site_id")
    ...
    @static_site_id.setter
    def static_site_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "static_site_id", value)
...
@pulumi.type_token("azure:appservice/staticSiteCustomDomain:StaticSiteCustomDomain")
class StaticSiteCustomDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            static_site_id: Optional[pulumi.Input[builtins.str]] = None,
            validation_token: Optional[pulumi.Input[builtins.str]] = None,
            validation_type: Optional[pulumi.Input[builtins.str]] = None) -> 'StaticSiteCustomDomain':
        """
    ...
    @property
    @pulumi.getter(name="staticSiteId")
    def static_site_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Static Site. Changing this forces a new Static Site Custom Domain to be created.
        """
        return pulumi.get(self, "static_site_id")
    ...
    @property
    @pulumi.getter(name="validationType")
    def validation_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        One of `cname-delegation` or `dns-txt-token`. Changing this forces a new Static Site Custom Domain to be created.
        """
        return pulumi.get(self, "validation_type")
