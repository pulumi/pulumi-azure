...
class AppServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_service_plan_id: The ID of the App Service Plan within which to create this App Service.
        ...
        :param pulumi.Input[builtins.bool] client_affinity_enabled: Should the App Service send session affinity cookies, which route client requests in the same session to the same instance?
        :param pulumi.Input[builtins.bool] client_cert_enabled: Does the App Service require client certificates for incoming requests? Defaults to `false`.
        :param pulumi.Input[builtins.str] client_cert_mode: Mode of client certificates for this App Service. Possible values are `Required`, `Optional` and `OptionalInteractiveUser`. If this parameter is set, `client_cert_enabled` must be set to `true`, otherwise this parameter is ignored.
        ...
        :param pulumi.Input[builtins.bool] enabled: Is the App Service Enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] https_only: Can the App Service only be accessed via HTTPS? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the App Service. Changing this forces a new resource to be created.
...
class _AppServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_site_hostname: The Default Hostname associated with the App Service - such as `mysite.azurewebsites.net`
        :param pulumi.Input[builtins.bool] enabled: Is the App Service Enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] https_only: Can the App Service only be accessed via HTTPS? Defaults to `false`.
        :param pulumi.Input['AppServiceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] key_vault_reference_identity_id: The User Assigned Identity Id used for looking up KeyVault secrets. The identity must be assigned to the application. [For more information see - Access vaults with a user-assigned identity](https://docs.microsoft.com/azure/app-service/app-service-key-vault-references#access-vaults-with-a-user-assigned-identity)
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] possible_outbound_ip_address_lists: A list of outbound IP addresses - such as `["52.23.25.3", "52.143.43.12", "52.143.43.17"]` - not all of which are necessarily in use. Superset of `outbound_ip_address_list`.
...
class AppService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_control: Optional[pulumi.Input[Union['AppServiceSourceControlArgs', 'AppServiceSourceControlArgsDict']]] = None,
            storage_accounts: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AppServiceStorageAccountArgs', 'AppServiceStorageAccountArgsDict']]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'AppService':
        """
    ...
    @property
    @pulumi.getter(name="clientCertMode")
    def client_cert_mode(self) -> pulumi.Output[builtins.str]:
        """
        Mode of client certificates for this App Service. Possible values are `Required`, `Optional` and `OptionalInteractiveUser`. If this parameter is set, `client_cert_enabled` must be set to `true`, otherwise this parameter is ignored.
        """
        return pulumi.get(self, "client_cert_mode")
