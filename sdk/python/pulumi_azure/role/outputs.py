...
class DefinitionPermission(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] not_data_actions: One or more Disallowed Data Actions, such as `*`, `Microsoft.Resources/subscriptions/resourceGroups/read`. See ['Azure Resource Manager resource provider operations'](https://docs.microsoft.com/azure/role-based-access-control/resource-provider-operations) for details.
        """
...
class GetRoleDefinitionPermissionResult(dict):
    def __init__(__self__, *,
                 ...
                 not_data_actions: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] actions: A list of actions supported by this role.
        :param builtins.str condition: The conditions on this role definition, which limits the resources it can be assigned to.
        :param builtins.str condition_version: The version of the condition.
        :param Sequence[builtins.str] not_actions: A list of actions which are denied by this role.
        :param Sequence[builtins.str] data_actions: A list of data actions allowed by this role.
        :param Sequence[builtins.str] not_data_actions: A list of data actions which are denied by this role.
        """
        pulumi.set(__self__, "actions", actions)
