...
class FallbackRouteArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_names: pulumi.Input[builtins.str],
                 iothub_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.bool] enabled: Used to specify whether the fallback route is enabled.
        :param pulumi.Input[builtins.str] endpoint_names: The endpoints to which messages that satisfy the condition are routed. Currently only 1 endpoint is allowed.
        :param pulumi.Input[builtins.str] iothub_name: The name of the IoTHub to which this Fallback Route belongs. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group under which the IotHub Storage Container Endpoint resource has to be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] condition: The condition that is evaluated to apply the routing rule. For grammar, see: <https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language>. Defaults to `true`.
        :param pulumi.Input[builtins.str] source: The source that the routing rule is to be applied to. Possible values include: `DeviceConnectionStateEvents`, `DeviceJobLifecycleEvents`, `DeviceLifecycleEvents`, `DeviceMessages`, `DigitalTwinChangeEvents`, `Invalid`, `TwinChangeEvents`. Defaults to `DeviceMessages`.
        """
    ...
    def endpoint_names(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def endpoint_names(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "endpoint_names", value)

    @property
    @pulumi.getter(name="iothubName")
    def iothub_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @iothub_name.setter
    def iothub_name(self, value: pulumi.Input[builtins.str]):
...
class _FallbackRouteState:
    def __init__(__self__, *,
                 ...
                 endpoint_names: Optional[pulumi.Input[builtins.str]] = None,
                 iothub_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="endpointNames")
    def endpoint_names(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The endpoints to which messages that satisfy the condition are routed. Currently only 1 endpoint is allowed.
        """
        return pulumi.get(self, "endpoint_names")
    ...
    @endpoint_names.setter
    def endpoint_names(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_names", value)

    @property
    @pulumi.getter(name="iothubName")
    def iothub_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the IoTHub to which this Fallback Route belongs. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "iothub_name")
    ...
    @iothub_name.setter
    def iothub_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "iothub_name", value)
...
class FallbackRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            iothub_name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[builtins.str]] = None) -> 'FallbackRoute':
        """
    ...
    @property
    @pulumi.getter(name="endpointNames")
    def endpoint_names(self) -> pulumi.Output[builtins.str]:
        """
        The endpoints to which messages that satisfy the condition are routed. Currently only 1 endpoint is allowed.
        """
        return pulumi.get(self, "endpoint_names")
    ...
    @property
    @pulumi.getter(name="iothubName")
    def iothub_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the IoTHub to which this Fallback Route belongs. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "iothub_name")
