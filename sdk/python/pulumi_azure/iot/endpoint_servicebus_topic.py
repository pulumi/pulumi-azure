...
class EndpointServicebusTopicArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group under which the Service Bus Topic has been created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] authentication_type: Type used to authenticate against the Service Bus Topic endpoint. Possible values are `keyBased` and `identityBased`. Defaults to `keyBased`.
        ...
        :param pulumi.Input[builtins.str] endpoint_uri: URI of the Service Bus endpoint. This attribute can only be specified and is mandatory when `authentication_type` is `identityBased`.
        :param pulumi.Input[builtins.str] entity_path: Name of the Service Bus Topic. This attribute can only be specified and is mandatory when `authentication_type` is `identityBased`.
        :param pulumi.Input[builtins.str] identity_id: ID of the User Managed Identity used to authenticate against the Service Bus Topic endpoint.
...
class EndpointServicebusTopic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            iothub_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EndpointServicebusTopic':
        """
    ...
    @property
    @pulumi.getter(name="entityPath")
    def entity_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the Service Bus Topic. This attribute can only be specified and is mandatory when `authentication_type` is `identityBased`.
        """
        return pulumi.get(self, "entity_path")
