...
class IoTHubArgs:
    def __init__(__self__, *,
                 ...
                 event_hub_partition_count: Optional[pulumi.Input[builtins.int]] = None,
                 event_hub_retention_in_days: Optional[pulumi.Input[builtins.int]] = None,
    ...
    def event_hub_partition_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def event_hub_partition_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "event_hub_partition_count", value)

    @property
    @pulumi.getter(name="eventHubRetentionInDays")
    def event_hub_retention_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def event_hub_retention_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _IoTHubState:
    def __init__(__self__, *,
                 ...
                 endpoints: Optional[pulumi.Input[Sequence[pulumi.Input['IoTHubEndpointArgs']]]] = None,
                 enrichments: Optional[pulumi.Input[Sequence[pulumi.Input['IoTHubEnrichmentArgs']]]] = None,
                 event_hub_events_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 event_hub_events_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 event_hub_events_path: Optional[pulumi.Input[builtins.str]] = None,
                 event_hub_operations_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 event_hub_operations_path: Optional[pulumi.Input[builtins.str]] = None,
                 event_hub_partition_count: Optional[pulumi.Input[builtins.int]] = None,
                 event_hub_retention_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 fallback_route: Optional[pulumi.Input['IoTHubFallbackRouteArgs']] = None,
                 file_upload: Optional[pulumi.Input['IoTHubFileUploadArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] event_hub_operations_endpoint: The EventHub compatible endpoint for operational data
        :param pulumi.Input[builtins.str] event_hub_operations_path: The EventHub compatible path for operational data
        :param pulumi.Input[builtins.int] event_hub_partition_count: The number of device-to-cloud partitions used by backing event hubs. Must be between `2` and `128`. Defaults to `4`.
        :param pulumi.Input[builtins.int] event_hub_retention_in_days: The event hub retention to use in days. Must be between `1` and `7`. Defaults to `1`.
        :param pulumi.Input['IoTHubFallbackRouteArgs'] fallback_route: A `fallback_route` block as defined below. If the fallback route is enabled, messages that don't match any of the supplied routes are automatically sent to this route. Defaults to messages/events.
    ...
    def event_hub_events_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_hub_events_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_hub_events_endpoint", value)

    @property
    @pulumi.getter(name="eventHubEventsNamespace")
    def event_hub_events_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_hub_events_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_hub_events_namespace", value)

    @property
    @pulumi.getter(name="eventHubEventsPath")
    def event_hub_events_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_hub_events_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_hub_events_path", value)

    @property
    @pulumi.getter(name="eventHubOperationsEndpoint")
    def event_hub_operations_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_hub_operations_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_hub_operations_endpoint", value)

    @property
    @pulumi.getter(name="eventHubOperationsPath")
    def event_hub_operations_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_hub_operations_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IoTHub(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sku: Optional[pulumi.Input[Union['IoTHubSkuArgs', 'IoTHubSkuArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'IoTHub':
        """
    ...
    @property
    @pulumi.getter(name="eventHubEventsEndpoint")
    def event_hub_events_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The EventHub compatible endpoint for events data
        """
        return pulumi.get(self, "event_hub_events_endpoint")
    ...
    @property
    @pulumi.getter(name="eventHubEventsNamespace")
    def event_hub_events_namespace(self) -> pulumi.Output[builtins.str]:
        """
        The EventHub namespace for events data
        """
        return pulumi.get(self, "event_hub_events_namespace")
    ...
    @property
    @pulumi.getter(name="eventHubEventsPath")
    def event_hub_events_path(self) -> pulumi.Output[builtins.str]:
        """
        The EventHub compatible path for events data
        """
        return pulumi.get(self, "event_hub_events_path")
    ...
    @property
    @pulumi.getter(name="eventHubOperationsEndpoint")
    def event_hub_operations_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The EventHub compatible endpoint for operational data
        """
        return pulumi.get(self, "event_hub_operations_endpoint")
    ...
    @property
    @pulumi.getter(name="eventHubOperationsPath")
    def event_hub_operations_path(self) -> pulumi.Output[builtins.str]:
        """
        The EventHub compatible path for operational data
        """
        return pulumi.get(self, "event_hub_operations_path")
    ...
    @property
    @pulumi.getter(name="eventHubPartitionCount")
    def event_hub_partition_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of device-to-cloud partitions used by backing event hubs. Must be between `2` and `128`. Defaults to `4`.
        """
        return pulumi.get(self, "event_hub_partition_count")
    ...
    @property
    @pulumi.getter(name="eventHubRetentionInDays")
    def event_hub_retention_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The event hub retention to use in days. Must be between `1` and `7`. Defaults to `1`.
        """
        return pulumi.get(self, "event_hub_retention_in_days")
