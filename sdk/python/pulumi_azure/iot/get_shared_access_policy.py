...
def get_shared_access_policy(iothub_name: Optional[builtins.str] = None,
    ...
    :param builtins.str iothub_name: The name of the IoTHub to which this Shared Access Policy belongs.
    :param builtins.str name: Specifies the name of the IotHub Shared Access Policy resource.
    :param builtins.str resource_group_name: The name of the resource group under which the IotHub Shared Access Policy resource has to be created.
    """
    __args__ = dict()
...
def get_shared_access_policy_output(iothub_name: Optional[pulumi.Input[builtins.str]] = None,
