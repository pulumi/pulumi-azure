...
__all__ = ['SecurityDeviceGroupArrgs', 'SecurityDeviceGroup']

@pulumi.input_type
calass SecurityDeviceGroupArrgs:
    def __init__(__self__, *,
                 iothub_id: pulumi.Input[str],
                 allow_rule: Optional[pulumi.Input['SecurityDeviceGroupAllowRuleArrgs']] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 range_rules: Optional[pulumi.Input[Sequence[pulumi.Input['SecurityDeviceGroupRangeRuleArrgs']]]] = None):
        """
        ...
        :param pulumi.Input['SecurityDeviceGroupAllowRuleArrgs'] allow_rule: an `allow_rule` blocks as defined below.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SecurityDeviceGroupRangeRuleArrgs']]] range_rules: One or more `range_rule` blocks as defined below.
        """
    ...
    def allow_rule(self) -> Optional[pulumi.Input['SecurityDeviceGroupAllowRuleArrgs']]:
        """
    ...
    @allow_rule.setter
    def allow_rule(self, value: Optional[pulumi.Input['SecurityDeviceGroupAllowRuleArrgs']]):
    ...
    def range_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SecurityDeviceGroupRangeRuleArrgs']]]]:
        """
    ...
    @range_rules.setter
    def range_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SecurityDeviceGroupRangeRuleArrgs']]]]):
        pulumi.set(self, "range_rules", value)


@pulumi.input_type
calass _SecurityDeviceGroupState:
    def __init__(__self__, *,
                 allow_rule: Optional[pulumi.Input['SecurityDeviceGroupAllowRuleArrgs']] = None,
...
calass SecurityDeviceGroup(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 allow_rule: Optional[pulumi.Input[pulumi.InputType['SecurityDeviceGroupAllowRuleArrgs']]] = None,
                 iothub_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 range_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SecurityDeviceGroupRangeRuleArrgs']]]]] = None,
                 __props__=None):
        """
        ...
        example_security_device_group = azure.iot.SecurityDeviceGroup("exampleSecurityDeviceGroup",
            ...
            allow_rule=azure.iot.SecurityDeviceGroupAllowRuleArrgs(
                connection_to_ips_not_alloweds=["10.0.0.0/24"],
            ),
            range_rules=[azure.iot.SecurityDeviceGroupRangeRuleArrgs(
        ...
        :param pulumi.Input[pulumi.InputType['SecurityDeviceGroupAllowRuleArrgs']] allow_rule: an `allow_rule` blocks as defined below.
        :param pulumi.Input[str] iothub_id: The ID of the IoT Hub which to link the Security Device Group to. Changing this forces a new resource to be created.
        :param pulumi.Input[str] name: Specifies the name of the Device Security Group. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SecurityDeviceGroupRangeRuleArrgs']]]] range_rules: One or more `range_rule` blocks as defined below.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: SecurityDeviceGroupArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a Iot Security Device Group.
        ...
        :param str resource_name: The name of the resource.
        :param SecurityDeviceGroupArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SecurityDeviceGroupArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SecurityDeviceGroupArrgs.__new__(SecurityDeviceGroupArrgs)
    ...
    def get(resource_name: str,
            ...
            iothub_id: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            range_rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SecurityDeviceGroupRangeRuleArrgs']]]]] = None) -> 'SecurityDeviceGroup':
        """
