...
class ConsumerGroupArgs:
    ...
    def eventhub_endpoint_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def eventhub_endpoint_name(self, value: pulumi.Input[_builtins.str]):
...
class ConsumerGroup(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="eventhubEndpointName")
    def eventhub_endpoint_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Event Hub-compatible endpoint in the IoT hub. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "eventhub_endpoint_name")
