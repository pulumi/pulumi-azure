...
def get_dps_shared_access_policy(iothub_dps_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Devices`: 2022-02-05
    ...
    :param builtins.str resource_group_name: Specifies the name of the resource group under which the IotHub Shared Access Policy resource exists.
    """
    __args__ = dict()
...
def get_dps_shared_access_policy_output(iothub_dps_name: Optional[pulumi.Input[builtins.str]] = None,
