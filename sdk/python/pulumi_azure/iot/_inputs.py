...
class IoTHubCloudToDeviceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] default_ttl: The default time to live for cloud-to-device messages, specified as an [ISO 8601 timespan duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). This value must be between 1 minute and 48 hours. Defaults to `PT1H`.
        :param pulumi.Input[Sequence[pulumi.Input['IoTHubCloudToDeviceFeedbackArgs']]] feedbacks: A `feedback` block as defined below.
        :param pulumi.Input[builtins.int] max_delivery_count: The maximum delivery count for cloud-to-device per-device queues. This value must be between `1` and `100`. Defaults to `10`.
        """
...
if not MYPY:
    class IoTHubCloudToDeviceFeedbackArgsDict(TypedDict):
        lock_duration: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IoTHubCloudToDeviceFeedbackArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] lock_duration: The lock duration for the feedback queue, specified as an [ISO 8601 timespan duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). This value must be between 5 and 300 seconds. Defaults to `PT60S`.
        :param pulumi.Input[builtins.int] max_delivery_count: The maximum delivery count for the feedback queue. This value must be between `1` and `100`. Defaults to `10`.
        :param pulumi.Input[builtins.str] time_to_live: The retention time for service-bound feedback messages, specified as an [ISO 8601 timespan duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). This value must be between 1 minute and 48 hours. Defaults to `PT1H`.
        """
...
class IoTHubEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the endpoint. The name must be unique across endpoint types. The following names are reserved: `events`, `operationsMonitoringEvents`, `fileNotifications` and `$default`.
        :param pulumi.Input[builtins.str] type: The type of the endpoint. Possible values are `AzureIotHub.StorageContainer`, `AzureIotHub.ServiceBusQueue`, `AzureIotHub.ServiceBusTopic` or `AzureIotHub.EventHub`.
        :param pulumi.Input[builtins.str] authentication_type: The type used to authenticate against the endpoint. Possible values are `keyBased` and `identityBased`. Defaults to `keyBased`.
        :param pulumi.Input[builtins.int] batch_frequency_in_seconds: Time interval at which blobs are written to storage. Value should be between 60 and 720 seconds. Default value is 300 seconds. This attribute is applicable for endpoint type `AzureIotHub.StorageContainer`.
        :param pulumi.Input[builtins.str] connection_string: The connection string for the endpoint. This attribute is mandatory and can only be specified when `authentication_type` is `keyBased`.
        :param pulumi.Input[builtins.str] container_name: The name of storage container in the storage account. This attribute is mandatory for endpoint type `AzureIotHub.StorageContainer`.
        :param pulumi.Input[builtins.str] encoding: Encoding that is used to serialize messages to blobs. Supported values are `Avro`, `AvroDeflate` and `JSON`. Default value is `Avro`. This attribute is applicable for endpoint type `AzureIotHub.StorageContainer`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] endpoint_uri: URI of the Service Bus or Event Hubs Namespace endpoint. This attribute can only be specified and is mandatory when `authentication_type` is `identityBased` for endpoint type `AzureIotHub.ServiceBusQueue`, `AzureIotHub.ServiceBusTopic` or `AzureIotHub.EventHub`.
        :param pulumi.Input[builtins.str] entity_path: Name of the Service Bus Queue/Topic or Event Hub. This attribute can only be specified and is mandatory when `authentication_type` is `identityBased` for endpoint type `AzureIotHub.ServiceBusQueue`, `AzureIotHub.ServiceBusTopic` or `AzureIotHub.EventHub`.
        :param pulumi.Input[builtins.str] file_name_format: File name format for the blob. All parameters are mandatory but can be reordered. This attribute is applicable for endpoint type `AzureIotHub.StorageContainer`. Defaults to `{iothub}/{partition}/{YYYY}/{MM}/{DD}/{HH}/{mm}`.
        :param pulumi.Input[builtins.str] identity_id: The ID of the User Managed Identity used to authenticate against the endpoint.
               
               > **Note:** `identity_id` can only be specified when `authentication_type` is `identityBased`. It must be one of the `identity_ids` of the IoT Hub. If `identity_id` is omitted when `authentication_type` is `identityBased`, then the System-Assigned Managed Identity of the IoT Hub will be used.
               
               > **Note:** An IoT Hub can only be updated to use the System-Assigned Managed Identity for `endpoint` since it is not possible to grant access to the endpoint until after creation. The extracted resources `azurerm_iothub_endpoint_*` can be used to configure Endpoints with the IoT Hub's System-Assigned Managed Identity without the need for an update.
        :param pulumi.Input[builtins.int] max_chunk_size_in_bytes: Maximum number of bytes for each blob written to storage. Value should be between 10485760(10MB) and 524288000(500MB). Default value is 314572800(300MB). This attribute is applicable for endpoint type `AzureIotHub.StorageContainer`.
        :param pulumi.Input[builtins.str] resource_group_name: The resource group in which the endpoint will be created.
        """
...
class IoTHubEnrichmentArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_names: The list of endpoints which will be enriched.
        :param pulumi.Input[builtins.str] key: The key of the enrichment.
        :param pulumi.Input[builtins.str] value: The value of the enrichment. Value can be any static string, the name of the IoT Hub sending the message (use `$iothubname`) or information from the device twin (ex: `$twin.tags.latitude`)
        """
...
if not MYPY:
    class IoTHubFallbackRouteArgsDict(TypedDict):
        ...
        """
        endpoint_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class IoTHubFallbackRouteArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] condition: The condition that is evaluated to apply the routing rule. Defaults to `true`. For grammar, see: <https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language>.
        :param pulumi.Input[builtins.bool] enabled: Used to specify whether the fallback route is enabled. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_names: The endpoints to which messages that satisfy the condition are routed. Currently only 1 endpoint is allowed.
        :param pulumi.Input[builtins.str] source: The source that the routing rule is to be applied to, such as `DeviceMessages`. Possible values include: `Invalid`, `DeviceMessages`, `TwinChangeEvents`, `DeviceLifecycleEvents`, `DeviceConnectionStateEvents`, `DeviceJobLifecycleEvents` and `DigitalTwinChangeEvents`. Defaults to `DeviceMessages`.
        """
    ...
    @property
    @pulumi.getter(name="endpointNames")
    def endpoint_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The endpoints to which messages that satisfy the condition are routed. Currently only 1 endpoint is allowed.
        """
        return pulumi.get(self, "endpoint_names")
    ...
    @endpoint_names.setter
    def endpoint_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "endpoint_names", value)
...
if not MYPY:
    class IoTHubFileUploadArgsDict(TypedDict):
        ...
        """
        notifications: NotRequired[pulumi.Input[builtins.bool]]
        """
        Used to specify whether file notifications are sent to IoT Hub on upload. Defaults to `false`.
        """
        sas_ttl: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IoTHubFileUploadArgs:
    def __init__(__self__, *,
                 ...
                 lock_duration: Optional[pulumi.Input[builtins.str]] = None,
                 max_delivery_count: Optional[pulumi.Input[builtins.int]] = None,
                 notifications: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] notifications: Used to specify whether file notifications are sent to IoT Hub on upload. Defaults to `false`.
    ...
    @property
    @pulumi.getter
    def notifications(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Used to specify whether file notifications are sent to IoT Hub on upload. Defaults to `false`.
        """
    ...
    def notifications(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IoTHubIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this IoT Hub. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this IoT Hub.
...
if not MYPY:
    class IoTHubNetworkRuleSetArgsDict(TypedDict):
        apply_to_builtin_eventhub_endpoint: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class IoTHubNetworkRuleSetArgs:
    def __init__(__self__, *,
                 apply_to_builtin_eventhub_endpoint: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] apply_to_builtin_eventhub_endpoint: Determines if Network Rule Set is also applied to the BuiltIn EventHub EndPoint of the IotHub. Defaults to `false`.
        :param pulumi.Input[builtins.str] default_action: Default Action for Network Rule Set. Possible values are `DefaultActionDeny`, `DefaultActionAllow`. Defaults to `DefaultActionDeny`.
    ...
    def apply_to_builtin_eventhub_endpoint(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Determines if Network Rule Set is also applied to the BuiltIn EventHub EndPoint of the IotHub. Defaults to `false`.
        """
    ...
    def apply_to_builtin_eventhub_endpoint(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IoTHubNetworkRuleSetIpRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The desired action for requests captured by this rule. Possible values are `Allow`. Defaults to `Allow`.
        """
...
class IoTHubRouteArgs:
    def __init__(__self__, *,
                 ...
                 condition: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Used to specify whether a route is enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoint_names: The list of endpoints to which messages that satisfy the condition are routed.
        :param pulumi.Input[builtins.str] name: The name of the route.
        :param pulumi.Input[builtins.str] source: The source that the routing rule is to be applied to, such as `DeviceMessages`. Possible values include: `Invalid`, `DeviceMessages`, `TwinChangeEvents`, `DeviceLifecycleEvents`, `DeviceConnectionStateEvents`, `DeviceJobLifecycleEvents` and `DigitalTwinChangeEvents`.
        :param pulumi.Input[builtins.str] condition: The condition that is evaluated to apply the routing rule. Defaults to `true`. For grammar, see: <https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language>.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "endpoint_names", endpoint_names)
...
class IoTHubSharedAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] permissions: The permissions assigned to the shared access policy.
...
class IoTHubSkuArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] capacity: The number of provisioned IoT Hub units.
               
               > **Note:** Only one IotHub can be on the `Free` tier per subscription.
        :param pulumi.Input[builtins.str] name: The name of the sku. Possible values are `B1`, `B2`, `B3`, `F1`, `S1`, `S2`, and `S3`.
...
class IotHubDeviceUpdateAccountIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this IoT Hub Device Update Account. Possible values are `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this IoT Hub Device Update Account.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this IoT Hub Device Update Account.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this IoT Hub Device Update Account.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class IotHubDeviceUpdateInstanceDiagnosticStorageAccountArgs:
    def __init__(__self__, *,
                 ...
                 id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] connection_string: Connection String of the Diagnostic Storage Account.
        :param pulumi.Input[builtins.str] id: Resource ID of the Diagnostic Storage Account.
        """
        pulumi.set(__self__, "connection_string", connection_string)
...
class IotHubDpsIpFilterRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The desired action for requests captured by this rule. Possible values are `Accept`, `Reject`
        :param pulumi.Input[builtins.str] ip_mask: The IP address range in CIDR notation for the rule.
        :param pulumi.Input[builtins.str] name: The name of the filter.
        :param pulumi.Input[builtins.str] target: Target for requests captured by this rule. Possible values are `all`, `deviceApi` and `serviceApi`.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "ip_mask", ip_mask)
        pulumi.set(__self__, "name", name)
...
class IotHubDpsLinkedHubArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] connection_string: The connection string to connect to the IoT Hub.
        :param pulumi.Input[builtins.str] location: The location of the IoT hub.
        :param pulumi.Input[builtins.int] allocation_weight: The weight applied to the IoT Hub. Defaults to `1`.
        :param pulumi.Input[builtins.bool] apply_allocation_policy: Determines whether to apply allocation policies to the IoT Hub. Defaults to `true`.
        :param pulumi.Input[builtins.str] hostname: The IoT Hub hostname.
        """
        pulumi.set(__self__, "connection_string", connection_string)
...
class IotHubDpsSkuArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] capacity: The number of provisioned IoT Device Provisioning Service units.
        :param pulumi.Input[builtins.str] name: The name of the sku. Currently can only be set to `S1`.
        """
        pulumi.set(__self__, "capacity", capacity)
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class SecurityDeviceGroupAllowRuleArgsDict(TypedDict):
        connection_from_ips_not_alloweds: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies which IP is not allowed to be connected to in current device group for inbound connection.
        """
        connection_to_ips_not_alloweds: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies which IP is not allowed to be connected to in current device group for outbound connection.
        """
        local_users_not_alloweds: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies which local user is not allowed to login in current device group.
        """
        processes_not_alloweds: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class SecurityDeviceGroupAllowRuleArgs:
    def __init__(__self__, *,
                 connection_from_ips_not_alloweds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 connection_to_ips_not_alloweds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 local_users_not_alloweds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 processes_not_alloweds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] connection_from_ips_not_alloweds: Specifies which IP is not allowed to be connected to in current device group for inbound connection.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] connection_to_ips_not_alloweds: Specifies which IP is not allowed to be connected to in current device group for outbound connection.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_users_not_alloweds: Specifies which local user is not allowed to login in current device group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] processes_not_alloweds: Specifies which process is not allowed to be executed in current device group.
        """
    ...
    def connection_from_ips_not_alloweds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies which IP is not allowed to be connected to in current device group for inbound connection.
        """
    ...
    def connection_from_ips_not_alloweds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "connection_from_ips_not_alloweds", value)

    @property
    @pulumi.getter(name="connectionToIpsNotAlloweds")
    def connection_to_ips_not_alloweds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies which IP is not allowed to be connected to in current device group for outbound connection.
        """
    ...
    def connection_to_ips_not_alloweds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "connection_to_ips_not_alloweds", value)

    @property
    @pulumi.getter(name="localUsersNotAlloweds")
    def local_users_not_alloweds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies which local user is not allowed to login in current device group.
        """
    ...
    def local_users_not_alloweds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "local_users_not_alloweds", value)

    @property
    @pulumi.getter(name="processesNotAlloweds")
    def processes_not_alloweds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies which process is not allowed to be executed in current device group.
        """
    ...
    def processes_not_alloweds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class SecurityDeviceGroupRangeRuleArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] duration: Specifies the time range. represented in ISO 8601 duration format.
        :param pulumi.Input[builtins.int] max: The maximum threshold in the given time window.
        :param pulumi.Input[builtins.int] min: The minimum threshold in the given time window.
        :param pulumi.Input[builtins.str] type: The type of supported rule type. Possible Values are `ActiveConnectionsNotInAllowedRange`, `AmqpC2DMessagesNotInAllowedRange`, `MqttC2DMessagesNotInAllowedRange`, `HttpC2DMessagesNotInAllowedRange`, `AmqpC2DRejectedMessagesNotInAllowedRange`, `MqttC2DRejectedMessagesNotInAllowedRange`, `HttpC2DRejectedMessagesNotInAllowedRange`, `AmqpD2CMessagesNotInAllowedRange`, `MqttD2CMessagesNotInAllowedRange`, `HttpD2CMessagesNotInAllowedRange`, `DirectMethodInvokesNotInAllowedRange`, `FailedLocalLoginsNotInAllowedRange`, `FileUploadsNotInAllowedRange`, `QueuePurgesNotInAllowedRange`, `TwinUpdatesNotInAllowedRange` and `UnauthorizedOperationsNotInAllowedRange`.
        """
...
if not MYPY:
    class SecuritySolutionAdditionalWorkspaceArgsDict(TypedDict):
        data_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class SecuritySolutionAdditionalWorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 workspace_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_types: A list of data types which sent to workspace. Possible values are `Alerts` and `RawEvents`.
        :param pulumi.Input[builtins.str] workspace_id: The resource ID of the Log Analytics Workspace.
        """
    ...
    def data_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of data types which sent to workspace. Possible values are `Alerts` and `RawEvents`.
        """
    ...
    @data_types.setter
    def data_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class SecuritySolutionRecommendationsEnabledArgsDict(TypedDict):
        acr_authentication: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is Principal Authentication enabled for the ACR repository? Defaults to `true`.
        """
        agent_send_unutilized_msg: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        edge_hub_mem_optimize: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is IoT Edge Hub memory optimized? Defaults to `true`.
        """
        edge_logging_option: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is logging configured for IoT Edge module? Defaults to `true`.
        """
        inconsistent_module_settings: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is inconsistent module settings enabled for SecurityGroup? Defaults to `true`.
        """
        install_agent: NotRequired[pulumi.Input[builtins.bool]]
        """
        is Azure IoT Security agent installed? Defaults to `true`.
        """
        ip_filter_deny_all: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is Default IP filter policy denied? Defaults to `true`.
        """
        ip_filter_permissive_rule: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is IP filter rule source allowable IP range too large? Defaults to `true`.
        """
        open_ports: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is any ports open on the device? Defaults to `true`.
        """
        permissive_firewall_policy: NotRequired[pulumi.Input[builtins.bool]]
        """
        Does firewall policy exist which allow necessary communication to/from the device? Defaults to `true`.
        """
        permissive_input_firewall_rules: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is only necessary addresses or ports are permitted in? Defaults to `true`.
        """
        permissive_output_firewall_rules: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is only necessary addresses or ports are permitted out? Defaults to `true`.
        """
        privileged_docker_options: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is high level permissions are needed for the module? Defaults to `true`.
        """
        shared_credentials: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is any credentials shared among devices? Defaults to `true`.
        """
        vulnerable_tls_cipher_suite: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SecuritySolutionRecommendationsEnabledArgs:
    def __init__(__self__, *,
                 acr_authentication: Optional[pulumi.Input[builtins.bool]] = None,
                 agent_send_unutilized_msg: Optional[pulumi.Input[builtins.bool]] = None,
                 baseline: Optional[pulumi.Input[builtins.bool]] = None,
                 edge_hub_mem_optimize: Optional[pulumi.Input[builtins.bool]] = None,
                 edge_logging_option: Optional[pulumi.Input[builtins.bool]] = None,
                 inconsistent_module_settings: Optional[pulumi.Input[builtins.bool]] = None,
                 install_agent: Optional[pulumi.Input[builtins.bool]] = None,
                 ip_filter_deny_all: Optional[pulumi.Input[builtins.bool]] = None,
                 ip_filter_permissive_rule: Optional[pulumi.Input[builtins.bool]] = None,
                 open_ports: Optional[pulumi.Input[builtins.bool]] = None,
                 permissive_firewall_policy: Optional[pulumi.Input[builtins.bool]] = None,
                 permissive_input_firewall_rules: Optional[pulumi.Input[builtins.bool]] = None,
                 permissive_output_firewall_rules: Optional[pulumi.Input[builtins.bool]] = None,
                 privileged_docker_options: Optional[pulumi.Input[builtins.bool]] = None,
                 shared_credentials: Optional[pulumi.Input[builtins.bool]] = None,
                 vulnerable_tls_cipher_suite: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] acr_authentication: Is Principal Authentication enabled for the ACR repository? Defaults to `true`.
        :param pulumi.Input[builtins.bool] agent_send_unutilized_msg: Is Agent send underutilized messages enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] baseline: Is Security related system configuration issues identified? Defaults to `true`.
        :param pulumi.Input[builtins.bool] edge_hub_mem_optimize: Is IoT Edge Hub memory optimized? Defaults to `true`.
        :param pulumi.Input[builtins.bool] edge_logging_option: Is logging configured for IoT Edge module? Defaults to `true`.
        :param pulumi.Input[builtins.bool] inconsistent_module_settings: Is inconsistent module settings enabled for SecurityGroup? Defaults to `true`.
        :param pulumi.Input[builtins.bool] install_agent: is Azure IoT Security agent installed? Defaults to `true`.
        :param pulumi.Input[builtins.bool] ip_filter_deny_all: Is Default IP filter policy denied? Defaults to `true`.
        :param pulumi.Input[builtins.bool] ip_filter_permissive_rule: Is IP filter rule source allowable IP range too large? Defaults to `true`.
        :param pulumi.Input[builtins.bool] open_ports: Is any ports open on the device? Defaults to `true`.
        :param pulumi.Input[builtins.bool] permissive_firewall_policy: Does firewall policy exist which allow necessary communication to/from the device? Defaults to `true`.
        :param pulumi.Input[builtins.bool] permissive_input_firewall_rules: Is only necessary addresses or ports are permitted in? Defaults to `true`.
        :param pulumi.Input[builtins.bool] permissive_output_firewall_rules: Is only necessary addresses or ports are permitted out? Defaults to `true`.
        :param pulumi.Input[builtins.bool] privileged_docker_options: Is high level permissions are needed for the module? Defaults to `true`.
        :param pulumi.Input[builtins.bool] shared_credentials: Is any credentials shared among devices? Defaults to `true`.
        :param pulumi.Input[builtins.bool] vulnerable_tls_cipher_suite: Does TLS cipher suite need to be updated? Defaults to `true`.
        """
    ...
    def acr_authentication(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is Principal Authentication enabled for the ACR repository? Defaults to `true`.
        """
    ...
    def acr_authentication(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "acr_authentication", value)

    @property
    @pulumi.getter(name="agentSendUnutilizedMsg")
    def agent_send_unutilized_msg(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is Agent send underutilized messages enabled? Defaults to `true`.
        """
    ...
    def agent_send_unutilized_msg(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def edge_hub_mem_optimize(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is IoT Edge Hub memory optimized? Defaults to `true`.
        """
    ...
    def edge_hub_mem_optimize(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "edge_hub_mem_optimize", value)

    @property
    @pulumi.getter(name="edgeLoggingOption")
    def edge_logging_option(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is logging configured for IoT Edge module? Defaults to `true`.
        """
    ...
    def edge_logging_option(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "edge_logging_option", value)

    @property
    @pulumi.getter(name="inconsistentModuleSettings")
    def inconsistent_module_settings(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is inconsistent module settings enabled for SecurityGroup? Defaults to `true`.
        """
    ...
    def inconsistent_module_settings(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "inconsistent_module_settings", value)

    @property
    @pulumi.getter(name="installAgent")
    def install_agent(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        is Azure IoT Security agent installed? Defaults to `true`.
        """
    ...
    def install_agent(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "install_agent", value)

    @property
    @pulumi.getter(name="ipFilterDenyAll")
    def ip_filter_deny_all(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is Default IP filter policy denied? Defaults to `true`.
        """
    ...
    def ip_filter_deny_all(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ip_filter_deny_all", value)

    @property
    @pulumi.getter(name="ipFilterPermissiveRule")
    def ip_filter_permissive_rule(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is IP filter rule source allowable IP range too large? Defaults to `true`.
        """
    ...
    def ip_filter_permissive_rule(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ip_filter_permissive_rule", value)

    @property
    @pulumi.getter(name="openPorts")
    def open_ports(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is any ports open on the device? Defaults to `true`.
        """
    ...
    @open_ports.setter
    def open_ports(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "open_ports", value)

    @property
    @pulumi.getter(name="permissiveFirewallPolicy")
    def permissive_firewall_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Does firewall policy exist which allow necessary communication to/from the device? Defaults to `true`.
        """
    ...
    def permissive_firewall_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "permissive_firewall_policy", value)

    @property
    @pulumi.getter(name="permissiveInputFirewallRules")
    def permissive_input_firewall_rules(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is only necessary addresses or ports are permitted in? Defaults to `true`.
        """
    ...
    def permissive_input_firewall_rules(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "permissive_input_firewall_rules", value)

    @property
    @pulumi.getter(name="permissiveOutputFirewallRules")
    def permissive_output_firewall_rules(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is only necessary addresses or ports are permitted out? Defaults to `true`.
        """
    ...
    def permissive_output_firewall_rules(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "permissive_output_firewall_rules", value)

    @property
    @pulumi.getter(name="privilegedDockerOptions")
    def privileged_docker_options(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is high level permissions are needed for the module? Defaults to `true`.
        """
    ...
    def privileged_docker_options(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "privileged_docker_options", value)

    @property
    @pulumi.getter(name="sharedCredentials")
    def shared_credentials(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is any credentials shared among devices? Defaults to `true`.
        """
    ...
    def shared_credentials(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "shared_credentials", value)

    @property
    @pulumi.getter(name="vulnerableTlsCipherSuite")
    def vulnerable_tls_cipher_suite(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Does TLS cipher suite need to be updated? Defaults to `true`.
        """
    ...
    def vulnerable_tls_cipher_suite(self, value: Optional[pulumi.Input[builtins.bool]]):
