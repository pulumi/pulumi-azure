...
def get_iot_hub(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of this IoTHub.
    :param _builtins.str resource_group_name: The name of the Resource Group where the IoTHub exists.
    :param Mapping[str, _builtins.str] tags: A mapping of tags which should be assigned to the IoTHub.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_iot_hub_output(name: Optional[pulumi.Input[_builtins.str]] = None,
