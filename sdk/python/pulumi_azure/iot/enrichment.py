...
class EnrichmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] iothub_name: The IoTHub name of the enrichment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] key: The key of the enrichment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group under which the IoTHub resource is created. Changing this forces a new resource to be created.
...
class Enrichment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'Enrichment':
        """
    ...
    @property
    @pulumi.getter(name="endpointNames")
    def endpoint_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of endpoints which will be enriched.
        """
        return pulumi.get(self, "endpoint_names")
