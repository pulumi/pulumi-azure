...
class IotHubDpsArgs:
    def __init__(__self__, *,
                 ...
                 data_residency_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Iot Device Provisioning Service resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether requests from Public Network are allowed. Defaults to `true`.
    ...
    def data_residency_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _IotHubDpsState:
    def __init__(__self__, *,
                 allocation_policy: Optional[pulumi.Input[builtins.str]] = None,
                 data_residency_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 device_provisioning_host_name: Optional[pulumi.Input[builtins.str]] = None,
                 id_scope: Optional[pulumi.Input[builtins.str]] = None,
                 ip_filter_rules: Optional[pulumi.Input[Sequence[pulumi.Input['IotHubDpsIpFilterRuleArgs']]]] = None,
                 linked_hubs: Optional[pulumi.Input[Sequence[pulumi.Input['IotHubDpsLinkedHubArgs']]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_operations_host_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether requests from Public Network are allowed. Defaults to `true`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group under which the Iot Device Provisioning Service resource has to be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] service_operations_host_name: The service endpoint of the IoT Device Provisioning Service.
        :param pulumi.Input['IotHubDpsSkuArgs'] sku: A `sku` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        """
        if allocation_policy is not None:
    ...
    def device_provisioning_host_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def device_provisioning_host_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "device_provisioning_host_name", value)

    @property
    @pulumi.getter(name="idScope")
    def id_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @id_scope.setter
    def id_scope(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_operations_host_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_operations_host_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IotHubDps(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_operations_host_name: Optional[pulumi.Input[builtins.str]] = None,
            sku: Optional[pulumi.Input[Union['IotHubDpsSkuArgs', 'IotHubDpsSkuArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'IotHubDps':
        """
    ...
    @property
    @pulumi.getter(name="allocationPolicy")
    def allocation_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The allocation policy of the IoT Device Provisioning Service (`Hashed`, `GeoLatency` or `Static`). Defaults to `Hashed`.
        """
        return pulumi.get(self, "allocation_policy")
    ...
    @property
    @pulumi.getter(name="deviceProvisioningHostName")
    def device_provisioning_host_name(self) -> pulumi.Output[builtins.str]:
        """
        The device endpoint of the IoT Device Provisioning Service.
        """
        return pulumi.get(self, "device_provisioning_host_name")
    ...
    @property
    @pulumi.getter(name="idScope")
    def id_scope(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the IoT Device Provisioning Service.
        """
        return pulumi.get(self, "id_scope")
    ...
    @property
    @pulumi.getter(name="serviceOperationsHostName")
    def service_operations_host_name(self) -> pulumi.Output[builtins.str]:
        """
        The service endpoint of the IoT Device Provisioning Service.
        """
        return pulumi.get(self, "service_operations_host_name")
