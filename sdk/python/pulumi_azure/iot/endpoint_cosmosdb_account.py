...
class EndpointCosmosdbAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_name: The name of the Cosmos DB Container in the Cosmos DB Database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] database_name: The name of the Cosmos DB Database in the Cosmos DB Account. Changing this forces a new resource to be created.
...
class EndpointCosmosdbAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            primary_key: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            secondary_key: Optional[pulumi.Input[builtins.str]] = None) -> 'EndpointCosmosdbAccount':
        """
    ...
    @property
    @pulumi.getter(name="partitionKeyName")
    def partition_key_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the partition key associated with the Cosmos DB Container.
        """
        return pulumi.get(self, "partition_key_name")
    ...
    @property
    @pulumi.getter(name="partitionKeyTemplate")
    def partition_key_template(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The template for generating a synthetic partition key value for use within the Cosmos DB Container.
        """
        return pulumi.get(self, "partition_key_template")
