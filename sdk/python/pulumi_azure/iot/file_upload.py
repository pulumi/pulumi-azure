...
class FileUploadArgs:
    def __init__(__self__, *,
                 ...
                 sas_ttl: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] container_name: The name of the root container where the files should be uploaded to. The container need not exist but should be creatable using the `connection_string` specified.
        :param pulumi.Input[builtins.str] iothub_id: The ID of the IoT Hub. Changing this forces a new IoT Hub to be created.
        :param pulumi.Input[builtins.str] authentication_type: The type used to authenticate against the storage account. Possible values are `keyBased` and `identityBased`. Defaults to `keyBased`.
        ...
        :param pulumi.Input[builtins.str] sas_ttl: The period of time for which the SAS URI generated by IoT Hub for file upload is valid, specified as an [ISO 8601 timespan duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). This value must be between 1 minute and 24 hours. Defaults to `PT1H`.
        """
    ...
    def sas_ttl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sas_ttl.setter
    def sas_ttl(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FileUpload(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_delivery_count: Optional[pulumi.Input[builtins.int]] = None,
            notifications_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            sas_ttl: Optional[pulumi.Input[builtins.str]] = None) -> 'FileUpload':
        """
    ...
    @property
    @pulumi.getter(name="defaultTtl")
    def default_ttl(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The period of time for which a file upload notification message is available to consume before it expires, specified as an [ISO 8601 timespan duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). This value must be between 1 minute and 48 hours. Defaults to `PT1H`.
        """
        return pulumi.get(self, "default_ttl")
    ...
    @property
    @pulumi.getter(name="notificationsEnabled")
    def notifications_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Used to specify whether file notifications are sent to IoT Hub on upload. Defaults to `false`.
        """
        return pulumi.get(self, "notifications_enabled")
    ...
    @property
    @pulumi.getter(name="sasTtl")
    def sas_ttl(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The period of time for which the SAS URI generated by IoT Hub for file upload is valid, specified as an [ISO 8601 timespan duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). This value must be between 1 minute and 24 hours. Defaults to `PT1H`.
        """
        return pulumi.get(self, "sas_ttl")
