...
class GetDicomServiceResult:
    ...
    def data_partitions_enabled(self) -> builtins.bool:
        """
...
def get_dicom_service(name: Optional[builtins.str] = None,
...
def get_dicom_service_output(name: Optional[pulumi.Input[builtins.str]] = None,
