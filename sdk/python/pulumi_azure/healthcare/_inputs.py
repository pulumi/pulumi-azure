...
class DicomServiceAuthenticationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: The intended audience to receive authentication tokens for the service. The default value is <https://dicom.azurehealthcareapis.azure.com>
        """
...
class DicomServiceCorsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] allow_credentials: Whether to allow credentials in CORS. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: A list of allowed headers for CORS.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: A list of allowed methods for CORS.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: A list of allowed origins for CORS.
        :param pulumi.Input[builtins.int] max_age_in_seconds: The maximum age in seconds for the CORS configuration (must be between 0 and 99998 inclusive).
        """
...
class DicomServiceIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of identity used for the Healthcare DICOM service. Possible values are `UserAssigned`, `SystemAssigned` and `SystemAssigned, UserAssigned`. If `UserAssigned` is set, an `identity_ids` must be set as well.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Assigned Identity IDs which should be assigned to this Healthcare DICOM service.
        """
...
class DicomServicePrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of the Healthcare DICOM Service.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Healthcare DICOM Service. Changing this forces a new Healthcare DICOM Service to be created.
        """
        if id is not None:
...
class DicomServiceStorageArgs:
    def __init__(__self__, *,
                 ...
                 storage_account_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] file_system_name: The filesystem name of connected storage account. Changing this forces a new Healthcare DICOM Service to be created.
        :param pulumi.Input[builtins.str] storage_account_id: The resource ID of connected storage account. Changing this forces a new Healthcare DICOM Service to be created.
...
class FhirServiceAuthenticationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] audience: The intended audience to receive authentication tokens for the service.
        :param pulumi.Input[builtins.bool] smart_proxy_enabled: Whether smart proxy is enabled.
        """
...
if not MYPY:
    class FhirServiceCorsArgsDict(TypedDict):
        ...
        """
        credentials_allowed: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FhirServiceCorsArgs:
    def __init__(__self__, *,
                 ...
                 allowed_methods: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 allowed_origins: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 credentials_allowed: Optional[pulumi.Input[builtins.bool]] = None,
                 max_age_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: A set of headers to be allowed via CORS.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: The methods to be allowed via CORS. Possible values are `DELETE`, `GET`, `HEAD`, `MERGE`, `POST`, `OPTIONS`, `PATCH` and `PUT`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: A set of origins to be allowed via CORS.
        :param pulumi.Input[builtins.bool] credentials_allowed: If credentials are allowed via CORS.
        :param pulumi.Input[builtins.int] max_age_in_seconds: The max age to be allowed via CORS.
        """
        pulumi.set(__self__, "allowed_headers", allowed_headers)
        pulumi.set(__self__, "allowed_methods", allowed_methods)
        pulumi.set(__self__, "allowed_origins", allowed_origins)
    ...
    def credentials_allowed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If credentials are allowed via CORS.
        """
    ...
    def credentials_allowed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class FhirServiceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of managed identity to assign. Possible values are `UserAssigned` and `SystemAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of one or more Resource IDs for User Assigned Managed identities to assign. Required when `type` is set to `UserAssigned`.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class FhirServiceOciArtifactArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] login_server: An Azure container registry used for export operations of the service instance.
        :param pulumi.Input[builtins.str] digest: A digest of an image within Azure container registry used for export operations of the service instance to narrow the artifacts down.
        :param pulumi.Input[builtins.str] image_name: An image within Azure container registry used for export operations of the service instance.
        """
...
class MedtechServiceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Healthcare Med Tech Service. Possible values are `SystemAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Healthcare Med Tech Service.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID associated with this System Assigned Managed Service Identity.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID associated with this System Assigned Managed Service Identity.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ServiceAuthenticationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 smart_proxy_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] audience: The intended audience to receive authentication tokens for the service. The default value is https://azurehealthcareapis.com
        :param pulumi.Input[builtins.str] authority: The Azure Active Directory (tenant) that serves as the authentication authority to access the service. The default authority is the Directory defined in the authentication scheme in use when running this provider.
               Authority must be registered to Azure AD and in the following format: https://{Azure-AD-endpoint}/{tenant-id}.
        :param pulumi.Input[builtins.bool] smart_proxy_enabled: (Boolean) Enables the 'SMART on FHIR' option for mobile and web implementations.
        """
...
class ServiceCorsConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 max_age_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] allow_credentials: (Boolean) If credentials are allowed via CORS.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: A set of headers to be allowed via CORS.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: The methods to be allowed via CORS. Possible values are `DELETE`, `GET`, `HEAD`, `MERGE`, `POST`, `OPTIONS`, `PATCH` and `PUT`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: A set of origins to be allowed via CORS.
        :param pulumi.Input[builtins.int] max_age_in_seconds: The max age to be allowed via CORS.
...
class ServiceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of managed identity to assign. The only possible value is `SystemAssigned`.
        """
        pulumi.set(__self__, "type", type)
        if principal_id is not None:
            pulumi.set(__self__, "principal_id", principal_id)
...
class WorkspacePrivateEndpointConnectionArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: The ID of the Healthcare Workspace.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Healthcare Workspace. Changing this forces a new Healthcare Workspace to be created.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
