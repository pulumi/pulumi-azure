...
class DicomServiceArgs:
    def __init__(__self__, *,
                 ...
                 data_partitions_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption_key_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] workspace_id: Specifies the ID of the Healthcare Workspace where the Healthcare DICOM Service should exist. Changing this forces a new Healthcare DICOM Service to be created.
        :param pulumi.Input['DicomServiceCorsArgs'] cors: A `cors` block as defined below.
        :param pulumi.Input[builtins.bool] data_partitions_enabled: If data partitions are enabled or not. Defaults to `false`. Changing this forces a new Healthcare DICOM Service to be created.
        :param pulumi.Input[builtins.str] encryption_key_url: The URL of the key to use for encryption as part of the customer-managed key encryption settings. For more details, refer to the [Azure Customer-Managed Keys Overview](https://learn.microsoft.com/en-us/azure/storage/common/customer-managed-keys-overview).
        :param pulumi.Input['DicomServiceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Healthcare DICOM Service should be created. Changing this forces a new Healthcare DICOM Service to be created.
        ...
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether to enabled public networks when data plane traffic coming from public networks while private endpoint is enabled. Defaults to `true`.
        :param pulumi.Input['DicomServiceStorageArgs'] storage: A `storage` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Healthcare DICOM Service.
        """
    ...
    def data_partitions_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def data_partitions_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "data_partitions_enabled", value)

    @property
    @pulumi.getter(name="encryptionKeyUrl")
    def encryption_key_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encryption_key_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DicomServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Healthcare DICOM Service. Changing this forces a new Healthcare DICOM Service to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether to enabled public networks when data plane traffic coming from public networks while private endpoint is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] service_url: The url of the Healthcare DICOM Services.
        :param pulumi.Input['DicomServiceStorageArgs'] storage: A `storage` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Healthcare DICOM Service.
        :param pulumi.Input[builtins.str] workspace_id: Specifies the ID of the Healthcare Workspace where the Healthcare DICOM Service should exist. Changing this forces a new Healthcare DICOM Service to be created.
        """
...
class DicomService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage: Optional[pulumi.Input[Union['DicomServiceStorageArgs', 'DicomServiceStorageArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DicomService':
        """
    ...
    @property
    @pulumi.getter(name="dataPartitionsEnabled")
    def data_partitions_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If data partitions are enabled or not. Defaults to `false`. Changing this forces a new Healthcare DICOM Service to be created.
        """
        return pulumi.get(self, "data_partitions_enabled")
    ...
    @property
    @pulumi.getter(name="encryptionKeyUrl")
    def encryption_key_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL of the key to use for encryption as part of the customer-managed key encryption settings. For more details, refer to the [Azure Customer-Managed Keys Overview](https://learn.microsoft.com/en-us/azure/storage/common/customer-managed-keys-overview).
        """
        return pulumi.get(self, "encryption_key_url")
