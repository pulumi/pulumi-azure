...
class GetServiceResult:
    ...
    def cosmosdb_key_vault_key_versionless_id(self) -> _builtins.str:
        """
    ...
    def cosmosdb_throughput(self) -> _builtins.int:
        """
...
def get_service(location: Optional[_builtins.str] = None,
    ...
    * `Microsoft.HealthcareApis` - 2022-12-01
    ...
    :param _builtins.str name: Specifies the name of the Healthcare Service.
    :param _builtins.str resource_group_name: The name of the Resource Group in which the Healthcare Service exists.
    """
    __args__ = dict()
