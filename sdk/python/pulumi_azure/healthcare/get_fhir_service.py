...
class GetFhirServiceResult:
    ...
    def access_policy_object_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    def configuration_export_storage_account_name(self) -> _builtins.str:
        """
    ...
    def container_registry_login_server_urls(self) -> Sequence[_builtins.str]:
        """
...
def get_fhir_service(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the Healthcare FHIR Service.
    :param Mapping[str, _builtins.str] tags: The map of tags assigned to the Healthcare FHIR Service.
    :param _builtins.str workspace_id: The id of the Healthcare Workspace in which the Healthcare FHIR Service exists.
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['tags'] = tags
...
def get_fhir_service_output(name: Optional[pulumi.Input[_builtins.str]] = None,
