...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 access_policy_object_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 authentication_configuration: Optional[pulumi.Input['ServiceAuthenticationConfigurationArgs']] = None,
                 configuration_export_storage_account_name: Optional[pulumi.Input[builtins.str]] = None,
                 cors_configuration: Optional[pulumi.Input['ServiceCorsConfigurationArgs']] = None,
                 cosmosdb_key_vault_key_versionless_id: Optional[pulumi.Input[builtins.str]] = None,
                 cosmosdb_throughput: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which to create the Service. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] configuration_export_storage_account_name: Specifies the name of the storage account which the operation configuration information is exported to.
        :param pulumi.Input['ServiceCorsConfigurationArgs'] cors_configuration: A `cors_configuration` block as defined below.
        :param pulumi.Input[builtins.str] cosmosdb_key_vault_key_versionless_id: A versionless Key Vault Key ID for CMK encryption of the backing database. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.int] cosmosdb_throughput: The provisioned throughput for the backing database. Range of `400`-`100000`. Defaults to `1000`.
        :param pulumi.Input['ServiceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] kind: The type of the service. Values at time of publication are: `fhir`, `fhir-Stu3` and `fhir-R4`. Default value is `fhir`.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure Region where the Service should be created. Changing this forces a new resource to be created.
               
               > **Note:** Not all locations support this resource. Some are `West US 2`, `North Central US`, and `UK West`.
        :param pulumi.Input[builtins.str] name: The name of the service instance. Used for service endpoint, must be unique within the audience. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether public network access is enabled or disabled for this service instance. Defaults to `true`.
    ...
    def access_policy_object_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "access_policy_object_ids")

    @access_policy_object_ids.setter
    def access_policy_object_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def configuration_export_storage_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configuration_export_storage_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def cosmosdb_key_vault_key_versionless_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cosmosdb_key_vault_key_versionless_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cosmosdb_key_vault_key_versionless_id", value)

    @property
    @pulumi.getter(name="cosmosdbThroughput")
    def cosmosdb_throughput(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cosmosdb_throughput(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Service(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accessPolicyObjectIds")
    def access_policy_object_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "access_policy_object_ids")
    ...
    @property
    @pulumi.getter(name="configurationExportStorageAccountName")
    def configuration_export_storage_account_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the name of the storage account which the operation configuration information is exported to.
        """
        return pulumi.get(self, "configuration_export_storage_account_name")
    ...
    @property
    @pulumi.getter(name="cosmosdbKeyVaultKeyVersionlessId")
    def cosmosdb_key_vault_key_versionless_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A versionless Key Vault Key ID for CMK encryption of the backing database. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="cosmosdbThroughput")
    def cosmosdb_throughput(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The provisioned throughput for the backing database. Range of `400`-`100000`. Defaults to `1000`.
        """
        return pulumi.get(self, "cosmosdb_throughput")
