...
class MedtechServiceFhirDestinationArgs:
    def __init__(__self__, *,
                 destination_fhir_mapping_json: pulumi.Input[builtins.str],
                 destination_fhir_service_id: pulumi.Input[builtins.str],
                 destination_identity_resolution_type: pulumi.Input[builtins.str],
                 medtech_service_id: pulumi.Input[builtins.str],
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MedtechServiceFhirDestination resource.
        :param pulumi.Input[builtins.str] destination_fhir_mapping_json: Specifies the destination Fhir mappings of the Med Tech Service Fhir Destination.
        :param pulumi.Input[builtins.str] destination_fhir_service_id: Specifies the destination fhir service id of the Med Tech Service Fhir Destination.
        :param pulumi.Input[builtins.str] destination_identity_resolution_type: Specifies the destination identity resolution type where the Healthcare Med Tech Service Fhir Destination should be created. Possible values are `Create`, `Lookup`.
        :param pulumi.Input[builtins.str] medtech_service_id: Specifies the name of the Healthcare Med Tech Service where the Healthcare Med Tech Service Fhir Destination should exist. Changing this forces a new Healthcare Med Tech Service Fhir Destination to be created.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Healthcare Med Tech Service Fhir Destination should be created. Changing this forces a new Healthcare Med Tech Service Fhir Destination to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Healthcare Med Tech Service Fhir Destination. Changing this forces a new Healthcare Med Tech Service Fhir Destination to be created.
        """
    ...
    def destination_fhir_mapping_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_fhir_mapping_json(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_fhir_mapping_json", value)

    @property
    @pulumi.getter(name="destinationFhirServiceId")
    def destination_fhir_service_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_fhir_service_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_fhir_service_id", value)

    @property
    @pulumi.getter(name="destinationIdentityResolutionType")
    def destination_identity_resolution_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_identity_resolution_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_identity_resolution_type", value)

    @property
    @pulumi.getter(name="medtechServiceId")
    def medtech_service_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def medtech_service_id(self, value: pulumi.Input[builtins.str]):
...
class _MedtechServiceFhirDestinationState:
    def __init__(__self__, *,
                 destination_fhir_mapping_json: Optional[pulumi.Input[builtins.str]] = None,
                 destination_fhir_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 destination_identity_resolution_type: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 medtech_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="destinationFhirMappingJson")
    def destination_fhir_mapping_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the destination Fhir mappings of the Med Tech Service Fhir Destination.
        """
        return pulumi.get(self, "destination_fhir_mapping_json")
    ...
    @destination_fhir_mapping_json.setter
    def destination_fhir_mapping_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_fhir_mapping_json", value)

    @property
    @pulumi.getter(name="destinationFhirServiceId")
    def destination_fhir_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the destination fhir service id of the Med Tech Service Fhir Destination.
        """
        return pulumi.get(self, "destination_fhir_service_id")
    ...
    @destination_fhir_service_id.setter
    def destination_fhir_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_fhir_service_id", value)

    @property
    @pulumi.getter(name="destinationIdentityResolutionType")
    def destination_identity_resolution_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the destination identity resolution type where the Healthcare Med Tech Service Fhir Destination should be created. Possible values are `Create`, `Lookup`.
        """
        return pulumi.get(self, "destination_identity_resolution_type")
    ...
    @destination_identity_resolution_type.setter
    def destination_identity_resolution_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_identity_resolution_type", value)
    ...
    @property
    @pulumi.getter(name="medtechServiceId")
    def medtech_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the name of the Healthcare Med Tech Service where the Healthcare Med Tech Service Fhir Destination should exist. Changing this forces a new Healthcare Med Tech Service Fhir Destination to be created.
        """
        return pulumi.get(self, "medtech_service_id")
    ...
    @medtech_service_id.setter
    def medtech_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "medtech_service_id", value)
...
class MedtechServiceFhirDestination(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[builtins.str]] = None,
            medtech_service_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'MedtechServiceFhirDestination':
        """
    ...
    @property
    @pulumi.getter(name="destinationFhirMappingJson")
    def destination_fhir_mapping_json(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the destination Fhir mappings of the Med Tech Service Fhir Destination.
        """
        return pulumi.get(self, "destination_fhir_mapping_json")
    ...
    @property
    @pulumi.getter(name="destinationFhirServiceId")
    def destination_fhir_service_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the destination fhir service id of the Med Tech Service Fhir Destination.
        """
        return pulumi.get(self, "destination_fhir_service_id")
    ...
    @property
    @pulumi.getter(name="destinationIdentityResolutionType")
    def destination_identity_resolution_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the destination identity resolution type where the Healthcare Med Tech Service Fhir Destination should be created. Possible values are `Create`, `Lookup`.
        """
        return pulumi.get(self, "destination_identity_resolution_type")
    ...
    @property
    @pulumi.getter(name="medtechServiceId")
    def medtech_service_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the Healthcare Med Tech Service where the Healthcare Med Tech Service Fhir Destination should exist. Changing this forces a new Healthcare Med Tech Service Fhir Destination to be created.
        """
        return pulumi.get(self, "medtech_service_id")
