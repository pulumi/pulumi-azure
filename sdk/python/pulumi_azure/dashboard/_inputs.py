...
class GrafanaAzureMonitorWorkspaceIntegrationArgs:
    def __init__(__self__, *,
                 resource_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] resource_id: Specifies the resource ID of the connected Azure Monitor Workspace.
        """
...
class GrafanaIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity. Possible values are `SystemAssigned`, `UserAssigned`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies the list of User Assigned Managed Service Identity IDs which should be assigned to this Dashboard Grafana. Changing this forces a new resource to be created.
...
if not MYPY:
    class GrafanaSmtpArgsDict(TypedDict):
        ...
        """
        start_tls_policy: pulumi.Input[builtins.str]
        """
        ...
        """
        verification_skip_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class GrafanaSmtpArgs:
    def __init__(__self__, *,
                 ...
                 verification_skip_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] from_address: Address used when sending emails.
        :param pulumi.Input[builtins.str] host: SMTP server hostname with port, e.g. test.email.net:587
        :param pulumi.Input[builtins.str] password: Password of SMTP authentication.
        :param pulumi.Input[builtins.str] start_tls_policy: Whether to use TLS when connecting to SMTP server. Possible values are `OpportunisticStartTLS`, `NoStartTLS`, `MandatoryStartTLS`.
        :param pulumi.Input[builtins.str] user: User of SMTP authentication.
        :param pulumi.Input[builtins.bool] enabled: Whether to enable the smtp setting of the Grafana instance. Defaults to `false`.
        :param pulumi.Input[builtins.str] from_name: Name used when sending emails. Defaults to `Azure Managed Grafana Notification`.
        :param pulumi.Input[builtins.bool] verification_skip_enabled: Whether verify SSL for SMTP server. Defaults to `false`.
        """
    ...
    def start_tls_policy(self) -> pulumi.Input[builtins.str]:
        """
        Whether to use TLS when connecting to SMTP server. Possible values are `OpportunisticStartTLS`, `NoStartTLS`, `MandatoryStartTLS`.
        """
    ...
    def start_tls_policy(self, value: pulumi.Input[builtins.str]):
    ...
    def verification_skip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether verify SSL for SMTP server. Defaults to `false`.
        """
    ...
    def verification_skip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
