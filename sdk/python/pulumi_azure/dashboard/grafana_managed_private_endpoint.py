...
class GrafanaManagedPrivateEndpointArgs:
    def __init__(__self__, *,
                 grafana_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] grafana_id: The id of the associated managed Grafana. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_ids: Specifies a list of private link group IDs. The value of this will depend on the private link resource to which you are connecting. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.
    ...
    def grafana_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @grafana_id.setter
    def grafana_id(self, value: pulumi.Input[builtins.str]):
...
class _GrafanaManagedPrivateEndpointState:
    def __init__(__self__, *,
                 grafana_id: Optional[pulumi.Input[builtins.str]] = None,
                 group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="grafanaId")
    def grafana_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The id of the associated managed Grafana. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.
        """
        return pulumi.get(self, "grafana_id")
    ...
    @grafana_id.setter
    def grafana_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grafana_id", value)
...
class GrafanaManagedPrivateEndpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="grafanaId")
    def grafana_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the associated managed Grafana. Changing this forces a new Dashboard Grafana Managed Private Endpoint to be created.
        """
        return pulumi.get(self, "grafana_id")
