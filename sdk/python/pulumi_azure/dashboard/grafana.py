...
class GrafanaArgs:
    ...
    def _configure(
        ...
        if api_key_enabled is None and 'apiKeyEnabled' in kwargs:
            api_key_enabled = kwargs['apiKeyEnabled']
        ...
        if deterministic_outbound_ip_enabled is None and 'deterministicOutboundIpEnabled' in kwargs:
            deterministic_outbound_ip_enabled = kwargs['deterministicOutboundIpEnabled']
...
class Grafana(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            identity = _utilities.configure(identity, GrafanaIdentityArgs, True)
