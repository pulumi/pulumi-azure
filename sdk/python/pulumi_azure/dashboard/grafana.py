...
class GrafanaArgs:
    def __init__(__self__, *,
                 grafana_major_version: pulumi.Input[builtins.str],
                 ...
                 deterministic_outbound_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] grafana_major_version: Which major version of Grafana to deploy. Possible values are `10`, `11`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Dashboard Grafana should exist. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input[builtins.bool] api_key_enabled: Whether to enable the api key setting of the Grafana instance. Defaults to `false`.
        :param pulumi.Input[builtins.str] auto_generated_domain_name_label_scope: Scope for dns deterministic name hash calculation. The only possible value is `TenantReuse`. Defaults to `TenantReuse`.
        ...
        :param pulumi.Input[builtins.bool] deterministic_outbound_ip_enabled: Whether to enable the Grafana instance to use deterministic outbound IPs. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Dashboard Grafana should exist. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Dashboard Grafana. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether to enable traffic over the public interface. Defaults to `true`.
        :param pulumi.Input[builtins.str] sku: The name of the SKU used for the Grafana instance. Possible values are `Standard` and `Essential`. Defaults to `Standard`. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input['GrafanaSmtpArgs'] smtp: A `smtp` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Dashboard Grafana.
        :param pulumi.Input[builtins.bool] zone_redundancy_enabled: Whether to enable the zone redundancy setting of the Grafana instance. Defaults to `false`. Changing this forces a new Dashboard Grafana to be created.
        """
    ...
    def grafana_major_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def grafana_major_version(self, value: pulumi.Input[builtins.str]):
    ...
    def deterministic_outbound_ip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def deterministic_outbound_ip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _GrafanaState:
    def __init__(__self__, *,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 outbound_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 public_network_access_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GrafanaAzureMonitorWorkspaceIntegrationArgs']]] azure_monitor_workspace_integrations: A `azure_monitor_workspace_integrations` block as defined below.
        :param pulumi.Input[builtins.bool] deterministic_outbound_ip_enabled: Whether to enable the Grafana instance to use deterministic outbound IPs. Defaults to `false`.
        :param pulumi.Input[builtins.str] endpoint: The endpoint of the Grafana instance.
        :param pulumi.Input[builtins.str] grafana_major_version: Which major version of Grafana to deploy. Possible values are `10`, `11`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] grafana_version: The full Grafana software semantic version deployed.
        :param pulumi.Input['GrafanaIdentityArgs'] identity: An `identity` block as defined below. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Dashboard Grafana should exist. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Dashboard Grafana. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outbound_ips: List of outbound IPs if deterministicOutboundIP is enabled.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether to enable traffic over the public interface. Defaults to `true`.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Dashboard Grafana should exist. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input[builtins.str] sku: The name of the SKU used for the Grafana instance. Possible values are `Standard` and `Essential`. Defaults to `Standard`. Changing this forces a new Dashboard Grafana to be created.
        :param pulumi.Input['GrafanaSmtpArgs'] smtp: A `smtp` block as defined below.
    ...
    def outbound_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @outbound_ips.setter
    def outbound_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Grafana(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            smtp: Optional[pulumi.Input[Union['GrafanaSmtpArgs', 'GrafanaSmtpArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zone_redundancy_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Grafana':
        """
    ...
    @property
    @pulumi.getter(name="apiKeyEnabled")
    def api_key_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the api key setting of the Grafana instance. Defaults to `false`.
        """
        return pulumi.get(self, "api_key_enabled")
    ...
    @property
    @pulumi.getter(name="deterministicOutboundIpEnabled")
    def deterministic_outbound_ip_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the Grafana instance to use deterministic outbound IPs. Defaults to `false`.
        """
        return pulumi.get(self, "deterministic_outbound_ip_enabled")
    ...
    @property
    @pulumi.getter(name="grafanaMajorVersion")
    def grafana_major_version(self) -> pulumi.Output[builtins.str]:
        """
        Which major version of Grafana to deploy. Possible values are `10`, `11`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "grafana_major_version")
    ...
    @property
    @pulumi.getter(name="outboundIps")
    def outbound_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of outbound IPs if deterministicOutboundIP is enabled.
        """
        return pulumi.get(self, "outbound_ips")
