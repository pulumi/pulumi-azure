...
class SingleNodeVirtualInstanceArgs:
    def __init__(__self__, *,
                 app_location: pulumi.Input[builtins.str],
                 environment: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 sap_fqdn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] app_location: The Geo-Location where the SAP system is to be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] environment: The environment type for the SAP Single Node Virtual Instance. Possible values are `NonProd` and `Prod`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the SAP Single Node Virtual Instance should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sap_fqdn: The fully qualified domain name for the SAP system. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sap_product: The SAP Product type for the SAP Single Node Virtual Instance. Possible values are `ECC`, `Other` and `S4HANA`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the SAP Single Node Virtual Instance should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] managed_resource_group_name: The name of the managed Resource Group for the SAP Single Node Virtual Instance. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of this SAP Single Node Virtual Instance. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the SAP Single Node Virtual Instance.
        """
    ...
    def app_location(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @app_location.setter
    def app_location(self, value: pulumi.Input[builtins.str]):
    ...
    def sap_fqdn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sap_fqdn.setter
    def sap_fqdn(self, value: pulumi.Input[builtins.str]):
...
class _SingleNodeVirtualInstanceState:
    def __init__(__self__, *,
                 ...
                 sap_fqdn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="sapFqdn")
    def sap_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The fully qualified domain name for the SAP system. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sap_fqdn")
    ...
    @sap_fqdn.setter
    def sap_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sap_fqdn", value)
...
class SingleNodeVirtualInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sap_product: Optional[pulumi.Input[builtins.str]] = None,
            single_server_configuration: Optional[pulumi.Input[Union['SingleNodeVirtualInstanceSingleServerConfigurationArgs', 'SingleNodeVirtualInstanceSingleServerConfigurationArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'SingleNodeVirtualInstance':
        """
    ...
    @property
    @pulumi.getter(name="appLocation")
    def app_location(self) -> pulumi.Output[builtins.str]:
        """
        The Geo-Location where the SAP system is to be created. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "app_location")
    ...
    @property
    @pulumi.getter(name="sapFqdn")
    def sap_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The fully qualified domain name for the SAP system. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sap_fqdn")
