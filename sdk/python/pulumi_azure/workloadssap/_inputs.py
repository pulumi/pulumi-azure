...
class DiscoveryVirtualInstanceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Discovery Virtual Instance.
        :param pulumi.Input[_builtins.str] type: The type of Managed Service Identity that should be configured on this SAP Discovery Virtual Instance. The only possible value is `UserAssigned`.
        """
...
class SingleNodeVirtualInstanceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Single Node Virtual Instance.
        :param pulumi.Input[_builtins.str] type: The type of Managed Service Identity that should be configured on this SAP Single Node Virtual Instance. The only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class SingleNodeVirtualInstanceSingleServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] secondary_ip_enabled: Specifies whether a secondary IP address should be added to the network interface on all VMs of the SAP system being deployed. Defaults to `false`. Changing this forces a new resource to be created.
    ...
    def app_resource_group_name(self, value: pulumi.Input[_builtins.str]):
...
class SingleNodeVirtualInstanceSingleServerConfigurationDiskVolumeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 volume_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] number_of_disks: The total number of disks required for the concerned volume. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.int] size_in_gb: The size of the Disk in GB. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] sku_name: The name of the Disk SKU. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] volume_name: Specifies the volumn name of the database disk. Possible values are `backup`, `hana/data`, `hana/log`, `hana/shared`, `os` and `usr/sap`. Changing this forces a new resource to be created.
        """
    ...
    def number_of_disks(self) -> pulumi.Input[_builtins.int]:
        """
        The total number of disks required for the concerned volume. Possible values are at least `1`. Changing this forces a new resource to be created.
        """
    ...
    def number_of_disks(self, value: pulumi.Input[_builtins.int]):
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] virtual_machine_size: The size of the Virtual Machine. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] offer: Specifies the offer of the platform image or marketplace image used to create the virtual machine. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] publisher: The publisher of the Image. Possible values are `RedHat` and `SUSE`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] sku: The SKU of the Image. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] version: Specifies the version of the platform image or marketplace image used to create the virtual machine. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationOsProfileArgs:
    def __init__(__self__, *,
                 ...
                 ssh_public_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] admin_username: The name of the administrator account. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] ssh_private_key: The SSH public key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] ssh_public_key: The SSH private key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def ssh_public_key(self) -> pulumi.Input[_builtins.str]:
        """
        The SSH private key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def ssh_public_key(self, value: pulumi.Input[_builtins.str]):
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] network_interface_names: A list of full names for the Network Interface of the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] os_disk_name: The full name of the OS Disk attached to the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] virtual_machine_name: The full name of the Virtual Machine in a single server SAP system. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDiskArgs:
    def __init__(__self__, *,
                 ...
                 volume_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] names: A list of full names of Data Disks per Volume. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] volume_name: The name of the Volume. The only possible value is `default`. Changing this forces a new resource to be created.
        """
...
class ThreeTierVirtualInstanceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Three Tier Virtual Instance.
        :param pulumi.Input[_builtins.str] type: The type of Managed Service Identity that should be configured on this SAP Three Tier Virtual Instance. Only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class ThreeTierVirtualInstanceThreeTierConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] high_availability_type: The high availability type for the three tier configuration. Possible values are `AvailabilitySet` and `AvailabilityZone`. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationApplicationServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] instance_count: The number of instances for the Application Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] subnet_id: The resource ID of the Subnet for the Application Server. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationCentralServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] instance_count: The number of instances for the Central Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] subnet_id: The resource ID of the Subnet for the Central Server. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationDatabaseServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_type: The database type for the Database Server. Possible values are `DB2` and `HANA`. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServerVirtualMachineDataDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] names: A list of full names of Data Disks per Volume. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] volume_name: The name of the Volume. Possible values are `default`, `hanaData`, `hanaLog`, `hanaShared` and `usrSap`. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] health_probe_names: A list of Health Probe names. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: The full resource name of the Load Balancer. Changing this forces a new resource to be created.
        """
