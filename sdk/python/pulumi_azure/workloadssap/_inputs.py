...
class DiscoveryVirtualInstanceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Discovery Virtual Instance.
        :param pulumi.Input[builtins.str] type: The type of Managed Service Identity that should be configured on this SAP Discovery Virtual Instance. The only possible value is `UserAssigned`.
        """
...
class SingleNodeVirtualInstanceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Single Node Virtual Instance.
        :param pulumi.Input[builtins.str] type: The type of Managed Service Identity that should be configured on this SAP Single Node Virtual Instance. The only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class SingleNodeVirtualInstanceSingleServerConfigurationArgsDict(TypedDict):
        app_resource_group_name: pulumi.Input[builtins.str]
        ...
        """
        database_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        secondary_ip_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 secondary_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] subnet_id: The resource ID of the Subnet for the SAP Single Node Virtual Instance. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] database_type: The supported SAP database type. Possible values are `DB2` and `HANA`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] secondary_ip_enabled: Specifies whether a secondary IP address should be added to the network interface on all VMs of the SAP system being deployed. Defaults to `false`. Changing this forces a new resource to be created.
    ...
    def app_resource_group_name(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "app_resource_group_name")

    @app_resource_group_name.setter
    def app_resource_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def secondary_ip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether a secondary IP address should be added to the network interface on all VMs of the SAP system being deployed. Defaults to `false`. Changing this forces a new resource to be created.
        """
    ...
    def secondary_ip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class SingleNodeVirtualInstanceSingleServerConfigurationDiskVolumeConfigurationArgsDict(TypedDict):
        number_of_disks: pulumi.Input[builtins.int]
        """
        ...
        """
        size_in_gb: pulumi.Input[builtins.int]
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationDiskVolumeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 volume_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] number_of_disks: The total number of disks required for the concerned volume. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] size_in_gb: The size of the Disk in GB. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: The name of the Disk SKU. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] volume_name: Specifies the volumn name of the database disk. Possible values are `backup`, `hana/data`, `hana/log`, `hana/shared`, `os` and `usr/sap`. Changing this forces a new resource to be created.
        """
    ...
    def number_of_disks(self) -> pulumi.Input[builtins.int]:
        """
        The total number of disks required for the concerned volume. Possible values are at least `1`. Changing this forces a new resource to be created.
        """
    ...
    def number_of_disks(self, value: pulumi.Input[builtins.int]):
    ...
    @size_in_gb.setter
    def size_in_gb(self, value: pulumi.Input[builtins.int]):
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_machine_size: The size of the Virtual Machine. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] offer: Specifies the offer of the platform image or marketplace image used to create the virtual machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher: The publisher of the Image. Possible values are `RedHat` and `SUSE`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku: The SKU of the Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] version: Specifies the version of the platform image or marketplace image used to create the virtual machine. Changing this forces a new resource to be created.
        """
...
if not MYPY:
    class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationOsProfileArgsDict(TypedDict):
        ...
        """
        ssh_private_key: pulumi.Input[builtins.str]
        """
        ...
        """
        ssh_public_key: pulumi.Input[builtins.str]
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationOsProfileArgs:
    def __init__(__self__, *,
                 ...
                 ssh_public_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] admin_username: The name of the administrator account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] ssh_private_key: The SSH public key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] ssh_public_key: The SSH private key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def ssh_private_key(self) -> pulumi.Input[builtins.str]:
        """
        The SSH public key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def ssh_private_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ssh_private_key", value)

    @property
    @pulumi.getter(name="sshPublicKey")
    def ssh_public_key(self) -> pulumi.Input[builtins.str]:
        """
        The SSH private key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def ssh_public_key(self, value: pulumi.Input[builtins.str]):
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesArgs:
    def __init__(__self__, *,
                 ...
                 network_interface_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 os_disk_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] host_name: The full name of the host of the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_interface_names: A list of full names for the Network Interface of the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] os_disk_name: The full name of the OS Disk attached to the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] virtual_machine_name: The full name of the Virtual Machine in a single server SAP system. Changing this forces a new resource to be created.
        """
    ...
    def network_interface_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of full names for the Network Interface of the Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def network_interface_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "network_interface_names", value)

    @property
    @pulumi.getter(name="osDiskName")
    def os_disk_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The full name of the OS Disk attached to the Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    @os_disk_name.setter
    def os_disk_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDiskArgsDict(TypedDict):
        names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDiskArgs:
    def __init__(__self__, *,
                 ...
                 volume_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] names: A list of full names of Data Disks per Volume. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] volume_name: The name of the Volume. The only possible value is `default`. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def names(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of full names of Data Disks per Volume. Changing this forces a new resource to be created.
        """
    ...
    @names.setter
    def names(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ThreeTierVirtualInstanceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Three Tier Virtual Instance.
        :param pulumi.Input[builtins.str] type: The type of Managed Service Identity that should be configured on this SAP Three Tier Virtual Instance. Only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class ThreeTierVirtualInstanceThreeTierConfigurationArgsDict(TypedDict):
        ...
        """
        high_availability_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 high_availability_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] high_availability_type: The high availability type for the three tier configuration. Possible values are `AvailabilitySet` and `AvailabilityZone`. Changing this forces a new resource to be created.
    ...
    def high_availability_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The high availability type for the three tier configuration. Possible values are `AvailabilitySet` and `AvailabilityZone`. Changing this forces a new resource to be created.
        """
    ...
    def high_availability_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ThreeTierVirtualInstanceThreeTierConfigurationApplicationServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] instance_count: The number of instances for the Application Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: The resource ID of the Subnet for the Application Server. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationCentralServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] instance_count: The number of instances for the Central Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: The resource ID of the Subnet for the Central Server. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationDatabaseServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] instance_count: The number of instances for the Database Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: The resource ID of the Subnet for the Database Server. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] database_type: The database type for the Database Server. Possible values are `DB2` and `HANA`. Changing this forces a new resource to be created.
...
if not MYPY:
    class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServerArgsDict(TypedDict):
        availability_set_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] availability_set_name: The full name for the availability set. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServerVirtualMachineDataDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] names: A list of full names of Data Disks per Volume. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] volume_name: The name of the Volume. Changing this forces a new resource to be created.
...
if not MYPY:
    class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerLoadBalancerArgsDict(TypedDict):
        backend_pool_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of Backend Pool names for the Load Balancer. Changing this forces a new resource to be created.
        """
        frontend_ip_configuration_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of Frontend IP Configuration names. Changing this forces a new resource to be created.
        """
        health_probe_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerLoadBalancerArgs:
    def __init__(__self__, *,
                 backend_pool_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 frontend_ip_configuration_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 health_probe_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backend_pool_names: A list of Backend Pool names for the Load Balancer. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] frontend_ip_configuration_names: A list of Frontend IP Configuration names. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] health_probe_names: A list of Health Probe names. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The full resource name of the Load Balancer. Changing this forces a new resource to be created.
        """
    ...
    def backend_pool_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Backend Pool names for the Load Balancer. Changing this forces a new resource to be created.
        """
    ...
    def backend_pool_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "backend_pool_names", value)

    @property
    @pulumi.getter(name="frontendIpConfigurationNames")
    def frontend_ip_configuration_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Frontend IP Configuration names. Changing this forces a new resource to be created.
        """
    ...
    def frontend_ip_configuration_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "frontend_ip_configuration_names", value)

    @property
    @pulumi.getter(name="healthProbeNames")
    def health_probe_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Health Probe names. Changing this forces a new resource to be created.
        """
    ...
    def health_probe_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesSharedStorageArgsDict(TypedDict):
        ...
        """
        private_endpoint_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesSharedStorageArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] account_name: The full name of the Shared Storage Account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_endpoint_name: The full name of Private Endpoint for the Shared Storage Account. Changing this forces a new resource to be created.
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationTransportCreateAndMountArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] resource_group_id: The ID of the Resource Group of the transport File Share. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_name: The name of the Storage Account of the File Share. Changing this forces a new resource to be created.
        """
