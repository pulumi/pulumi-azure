...
class DiscoveryVirtualInstanceIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Discovery Virtual Instance.
        :param builtins.str type: The type of Managed Service Identity that should be configured on this SAP Discovery Virtual Instance. The only possible value is `UserAssigned`.
        """
...
class SingleNodeVirtualInstanceIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Single Node Virtual Instance.
        :param builtins.str type: The type of Managed Service Identity that should be configured on this SAP Single Node Virtual Instance. The only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class SingleNodeVirtualInstanceSingleServerConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secondary_ip_enabled: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.str subnet_id: The resource ID of the Subnet for the SAP Single Node Virtual Instance. Changing this forces a new resource to be created.
        ...
        :param builtins.str database_type: The supported SAP database type. Possible values are `DB2` and `HANA`. Changing this forces a new resource to be created.
        ...
        :param builtins.bool secondary_ip_enabled: Specifies whether a secondary IP address should be added to the network interface on all VMs of the SAP system being deployed. Defaults to `false`. Changing this forces a new resource to be created.
    ...
    def secondary_ip_enabled(self) -> Optional[builtins.bool]:
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationDiskVolumeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int number_of_disks: The total number of disks required for the concerned volume. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param builtins.int size_in_gb: The size of the Disk in GB. Changing this forces a new resource to be created.
        :param builtins.str sku_name: The name of the Disk SKU. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param builtins.str volume_name: Specifies the volumn name of the database disk. Possible values are `backup`, `hana/data`, `hana/log`, `hana/shared`, `os` and `usr/sap`. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str virtual_machine_size: The size of the Virtual Machine. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImage(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str offer: Specifies the offer of the platform image or marketplace image used to create the virtual machine. Changing this forces a new resource to be created.
        :param builtins.str publisher: The publisher of the Image. Possible values are `RedHat` and `SUSE`. Changing this forces a new resource to be created.
        :param builtins.str sku: The SKU of the Image. Changing this forces a new resource to be created.
        :param builtins.str version: Specifies the version of the platform image or marketplace image used to create the virtual machine. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationOsProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str admin_username: The name of the administrator account. Changing this forces a new resource to be created.
        :param builtins.str ssh_private_key: The SSH public key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        :param builtins.str ssh_public_key: The SSH private key that is used to authenticate with the Virtual Machine. Changing this forces a new resource to be created.
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNames(dict):
    ...
    def __init__(__self__, *,
                 ...
                 network_interface_names: Optional[Sequence[builtins.str]] = None,
        ...
        :param builtins.str host_name: The full name of the host of the Virtual Machine. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] network_interface_names: A list of full names for the Network Interface of the Virtual Machine. Changing this forces a new resource to be created.
        :param builtins.str os_disk_name: The full name of the OS Disk attached to the Virtual Machine. Changing this forces a new resource to be created.
        :param builtins.str virtual_machine_name: The full name of the Virtual Machine in a single server SAP system. Changing this forces a new resource to be created.
        """
    ...
    def network_interface_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def virtual_machine_name(self) -> Optional[builtins.str]:
        """
...
class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineResourceNamesDataDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 volume_name: builtins.str):
        """
        :param Sequence[builtins.str] names: A list of full names of Data Disks per Volume. Changing this forces a new resource to be created.
        :param builtins.str volume_name: The name of the Volume. The only possible value is `default`. Changing this forces a new resource to be created.
        """
...
class ThreeTierVirtualInstanceIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this SAP Three Tier Virtual Instance.
        :param builtins.str type: The type of Managed Service Identity that should be configured on this SAP Three Tier Virtual Instance. Only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class ThreeTierVirtualInstanceThreeTierConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 high_availability_type: Optional[builtins.str] = None,
        ...
        :param builtins.str high_availability_type: The high availability type for the three tier configuration. Possible values are `AvailabilitySet` and `AvailabilityZone`. Changing this forces a new resource to be created.
    ...
    def high_availability_type(self) -> Optional[builtins.str]:
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationApplicationServerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int instance_count: The number of instances for the Application Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param builtins.str subnet_id: The resource ID of the Subnet for the Application Server. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationCentralServerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int instance_count: The number of instances for the Central Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param builtins.str subnet_id: The resource ID of the Subnet for the Central Server. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationDatabaseServerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int instance_count: The number of instances for the Database Server. Possible values are at least `1`. Changing this forces a new resource to be created.
        :param builtins.str subnet_id: The resource ID of the Subnet for the Database Server. Changing this forces a new resource to be created.
        ...
        :param builtins.str database_type: The database type for the Database Server. Possible values are `DB2` and `HANA`. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str availability_set_name: The full name for the availability set. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesApplicationServerVirtualMachineDataDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] names: A list of full names of Data Disks per Volume. Changing this forces a new resource to be created.
        :param builtins.str volume_name: The name of the Volume. Changing this forces a new resource to be created.
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerLoadBalancer(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] backend_pool_names: A list of Backend Pool names for the Load Balancer. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] frontend_ip_configuration_names: A list of Frontend IP Configuration names. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] health_probe_names: A list of Health Probe names. Changing this forces a new resource to be created.
        :param builtins.str name: The full resource name of the Load Balancer. Changing this forces a new resource to be created.
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesSharedStorage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_name: The full name of the Shared Storage Account. Changing this forces a new resource to be created.
        :param builtins.str private_endpoint_name: The full name of Private Endpoint for the Shared Storage Account. Changing this forces a new resource to be created.
        """
    ...
    def private_endpoint_name(self) -> Optional[builtins.str]:
        """
...
class ThreeTierVirtualInstanceThreeTierConfigurationTransportCreateAndMount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_group_id: The ID of the Resource Group of the transport File Share. Changing this forces a new resource to be created.
        :param builtins.str storage_account_name: The name of the Storage Account of the File Share. Changing this forces a new resource to be created.
        """
