...
class DiscoveryVirtualInstanceArgs:
    def __init__(__self__, *,
                 central_server_virtual_machine_id: pulumi.Input[builtins.str],
                 environment: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 sap_product: pulumi.Input[builtins.str],
                 ...
                 managed_resources_network_access_type: Optional[pulumi.Input[builtins.str]] = None,
                 managed_storage_account_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a DiscoveryVirtualInstance resource.
        :param pulumi.Input[builtins.str] central_server_virtual_machine_id: The ID of the Virtual Machine of the Central Server. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] environment: The environment type for the SAP Discovery Virtual Instance. Possible values are `NonProd` and `Prod`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the SAP Discovery Virtual Instance should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sap_product: The SAP Product type for the SAP Discovery Virtual Instance. Possible values are `ECC`, `Other` and `S4HANA`. Changing this forces a new resource to be created.
        :param pulumi.Input['DiscoveryVirtualInstanceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure Region where the SAP Discovery Virtual Instance should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] managed_resource_group_name: The name of the managed Resource Group for the SAP Discovery Virtual Instance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] managed_resources_network_access_type: The network access type for managed resources. Possible values are `Private` and `Public`. Defaults to `Public`.
        :param pulumi.Input[builtins.str] managed_storage_account_name: The name of the custom Storage Account created by the service in the managed Resource Group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the SAP Discovery Virtual Instance. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the SAP Discovery Virtual Instance.
        """
    ...
    def central_server_virtual_machine_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def central_server_virtual_machine_id(self, value: pulumi.Input[builtins.str]):
    ...
    def sap_product(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sap_product.setter
    def sap_product(self, value: pulumi.Input[builtins.str]):
    ...
    def managed_resources_network_access_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_resources_network_access_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_resources_network_access_type", value)

    @property
    @pulumi.getter(name="managedStorageAccountName")
    def managed_storage_account_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_storage_account_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DiscoveryVirtualInstanceState:
    def __init__(__self__, *,
                 central_server_virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 sap_product: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="centralServerVirtualMachineId")
    def central_server_virtual_machine_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Virtual Machine of the Central Server. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "central_server_virtual_machine_id")
    ...
    @central_server_virtual_machine_id.setter
    def central_server_virtual_machine_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "central_server_virtual_machine_id", value)
    ...
    @property
    @pulumi.getter(name="sapProduct")
    def sap_product(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The SAP Product type for the SAP Discovery Virtual Instance. Possible values are `ECC`, `Other` and `S4HANA`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sap_product")
    ...
    @sap_product.setter
    def sap_product(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sap_product", value)
...
class DiscoveryVirtualInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            sap_product: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DiscoveryVirtualInstance':
        """
    ...
    @property
    @pulumi.getter(name="centralServerVirtualMachineId")
    def central_server_virtual_machine_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Virtual Machine of the Central Server. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "central_server_virtual_machine_id")
    ...
    @property
    @pulumi.getter(name="managedStorageAccountName")
    def managed_storage_account_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the custom Storage Account created by the service in the managed Resource Group. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "managed_storage_account_name")
