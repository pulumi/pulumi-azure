...
class ZoneArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the DNS Zone. Must be a valid domain name. Changing this forces a new resource to be created.
...
class _ZoneState:
    def __init__(__self__, *,
                 max_number_of_record_sets: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 name_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 number_of_record_sets: Optional[pulumi.Input[builtins.int]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 soa_record: Optional[pulumi.Input['ZoneSoaRecordArgs']] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering Zone resources.
        :param pulumi.Input[builtins.int] max_number_of_record_sets: (Optional) Maximum number of Records in the zone. Defaults to `1000`.
        :param pulumi.Input[builtins.str] name: The name of the DNS Zone. Must be a valid domain name. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] name_servers: (Optional) A list of values that make up the NS record for the zone.
        :param pulumi.Input[builtins.int] number_of_record_sets: (Optional) The number of records already in the zone.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input['ZoneSoaRecordArgs'] soa_record: An `soa_record` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        """
    ...
    def max_number_of_record_sets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_number_of_record_sets(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def number_of_record_sets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_record_sets(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Zone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            soa_record: Optional[pulumi.Input[Union['ZoneSoaRecordArgs', 'ZoneSoaRecordArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Zone':
        """
    ...
    @property
    @pulumi.getter(name="maxNumberOfRecordSets")
    def max_number_of_record_sets(self) -> pulumi.Output[builtins.int]:
        """
        (Optional) Maximum number of Records in the zone. Defaults to `1000`.
        """
        return pulumi.get(self, "max_number_of_record_sets")
    ...
    @property
    @pulumi.getter(name="numberOfRecordSets")
    def number_of_record_sets(self) -> pulumi.Output[builtins.int]:
        """
        (Optional) The number of records already in the zone.
        """
        return pulumi.get(self, "number_of_record_sets")
