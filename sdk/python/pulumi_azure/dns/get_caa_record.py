...
__all__ = [
    'GetCAARecordResult',
    'AwaitableGetCAARecordResult',
    'get_caa_record',
    'get_caa_record_output',
]
...
class GetCAARecordResult:
    ...
    @property
    @pulumi.getter
    def records(self) -> Sequence['outputs.GetCAARecordRecordResult']:
        """
...
class AwaitableGetCAARecordResult(GetCAARecordResult):
...
def get_caa_record(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    :param builtins.str name: The name of the DNS CAA Record.
    :param builtins.str resource_group_name: Specifies the resource group where the DNS Zone (parent resource) exists.
    :param builtins.str zone_name: Specifies the DNS Zone where the resource exists.
    """
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure:dns/getCAARecord:getCAARecord', __args__, opts=opts, typ=GetCAARecordResult).value

    return AwaitableGetCAARecordResult(
...
def get_caa_record_output(name: Optional[pulumi.Input[builtins.str]] = None,
                          resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                          zone_name: Optional[pulumi.Input[builtins.str]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCAARecordResult]:
    """
    ## Example Usage
