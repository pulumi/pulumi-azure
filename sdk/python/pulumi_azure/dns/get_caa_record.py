...
def get_caa_record(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2018-05-01
    ...
    :param _builtins.str name: The name of the DNS CAA Record.
...
def get_caa_record_output(name: Optional[pulumi.Input[_builtins.str]] = None,
