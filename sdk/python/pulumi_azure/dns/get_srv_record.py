...
def get_srv_record(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2018-05-01
    ...
    :param _builtins.str name: The name of the DNS SRV Record.
    ...
    __ret__ = pulumi.runtime.invoke('azure:dns/getSrvRecord:getSrvRecord', __args__, opts=opts, typ=GetSrvRecordResult).value
...
def get_srv_record_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.Network` - 2018-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:dns/getSrvRecord:getSrvRecord', __args__, opts=opts, typ=GetSrvRecordResult)
