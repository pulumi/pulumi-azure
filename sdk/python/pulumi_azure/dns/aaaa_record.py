...
class AaaaRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the DNS AAAA Record. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] records: List of IPv6 Addresses. Conflicts with `target_resource_id`.
