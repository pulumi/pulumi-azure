...
class SrvRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the DNS SRV Record. Changing this forces a new resource to be created.
...
class _SrvRecordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the DNS SRV Record.
        :param pulumi.Input[builtins.str] name: The name of the DNS SRV Record. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input['SrvRecordRecordArgs']]] records: A list of values that make up the SRV record. Each `record` block supports fields documented below.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the DNS Zone (parent resource) exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
...
class SrvRecord(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `Microsoft.Network`: 2018-05-01
        ...
        :param pulumi.Input[builtins.str] name: The name of the DNS SRV Record. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['SrvRecordRecordArgs', 'SrvRecordRecordArgsDict']]]] records: A list of values that make up the SRV record. Each `record` block supports fields documented below.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the DNS Zone (parent resource) exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] ttl: The Time To Live (TTL) of the DNS record in seconds.
        :param pulumi.Input[builtins.str] zone_name: Specifies the DNS Zone where the resource exists. Changing this forces a new resource to be created.
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            zone_name: Optional[pulumi.Input[builtins.str]] = None) -> 'SrvRecord':
        """
