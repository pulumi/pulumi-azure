...
def get_ptr_record(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    :param builtins.str name: The name of the DNS PTR Record.
...
def get_ptr_record_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:dns/getPtrRecord:getPtrRecord', __args__, opts=opts, typ=GetPtrRecordResult)
