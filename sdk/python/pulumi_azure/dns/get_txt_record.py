...
def get_txt_record(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2018-05-01
    ...
    :param _builtins.str name: The name of the DNS TXT Record.
...
def get_txt_record_output(name: Optional[pulumi.Input[_builtins.str]] = None,
