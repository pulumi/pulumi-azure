...
def get_txt_record(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    :param builtins.str name: The name of the DNS TXT Record.
...
def get_txt_record_output(name: Optional[pulumi.Input[builtins.str]] = None,
                          resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                          zone_name: Optional[pulumi.Input[builtins.str]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetTxtRecordResult]:
    """
    ## Example Usage
