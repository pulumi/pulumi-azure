...
def get_a_record(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2018-05-01
    ...
    :param _builtins.str name: The name of the DNS A Record.
    ...
    __ret__ = pulumi.runtime.invoke('azure:dns/getARecord:getARecord', __args__, opts=opts, typ=GetARecordResult).value
...
def get_a_record_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.Network` - 2018-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:dns/getARecord:getARecord', __args__, opts=opts, typ=GetARecordResult)
