...
class CNameRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_resource_id: The Azure resource id of the target object. Conflicts with `record`.
        """
...
class CNameRecord(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def record(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The target of the CNAME.
        """
        return pulumi.get(self, "record")
