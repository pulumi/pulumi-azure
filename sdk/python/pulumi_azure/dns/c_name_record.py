...
class CNameRecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_resource_id: The Azure resource id of the target object. Conflicts with `record`.
        """
...
class CNameRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_resource_id: Optional[pulumi.Input[_builtins.str]] = None,
            ttl: Optional[pulumi.Input[_builtins.int]] = None,
            zone_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'CNameRecord':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def record(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The target of the CNAME.
        """
        return pulumi.get(self, "record")
