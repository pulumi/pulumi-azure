...
__all__ = [
    'GetNsRecordResult',
    'AwaitableGetNsRecordResult',
    'get_ns_record',
    'get_ns_record_output',
]
...
class AwaitableGetNsRecordResult(GetNsRecordResult):
...
def get_ns_record(name: Optional[builtins.str] = None,
                  resource_group_name: Optional[builtins.str] = None,
                  zone_name: Optional[builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNsRecordResult:
    """
    ## Example Usage
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    :param builtins.str name: The name of the DNS NS Record.
    ...
    __ret__ = pulumi.runtime.invoke('azure:dns/getNsRecord:getNsRecord', __args__, opts=opts, typ=GetNsRecordResult).value

    return AwaitableGetNsRecordResult(
...
def get_ns_record_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:dns/getNsRecord:getNsRecord', __args__, opts=opts, typ=GetNsRecordResult)
    return __ret__.apply(lambda __response__: GetNsRecordResult(
