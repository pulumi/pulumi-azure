...
class GetAAAARecordResult:
    ...
    """
    def __init__(__self__, fqdn=None, id=None, name=None, records=None, resource_group_name=None, tags=None, target_resource_id=None, ttl=None, zone_name=None):
...
def get_aaaa_record(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    :param builtins.str name: The name of the DNS AAAA Record.
...
def get_aaaa_record_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    * `Microsoft.Network`: 2018-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:dns/getAAAARecord:getAAAARecord', __args__, opts=opts, typ=GetAAAARecordResult)
