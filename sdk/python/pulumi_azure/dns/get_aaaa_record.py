...
def get_aaaa_record(name: Optional[str] = None,
    ...
    :param str name: The name of the DNS AAAA Record.
...
def get_aaaa_record_output(name: Optional[pulumi.Input[str]] = None,
