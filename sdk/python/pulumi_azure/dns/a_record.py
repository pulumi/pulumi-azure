...
class ARecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the DNS Zone (parent resource) exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] ttl: The Time To Live (TTL) of the DNS record in seconds.
        :param pulumi.Input[builtins.str] zone_name: Specifies the DNS Zone where the resource exists. Changing this forces a new resource to be created.
               
               > **Note:** The `zone_name` should be the name of resource `dns.Zone` instead of `privatedns.Zone`.
        :param pulumi.Input[builtins.str] name: The name of the DNS A Record. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] records: List of IPv4 Addresses. Conflicts with `target_resource_id`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
               
               > **Note:** either `records` OR `target_resource_id` must be specified, but not both.
        :param pulumi.Input[builtins.str] target_resource_id: The Azure resource id of the target object. Conflicts with `records`.
        """
...
class _ARecordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the DNS A Record.
        :param pulumi.Input[builtins.str] name: The name of the DNS A Record. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] records: List of IPv4 Addresses. Conflicts with `target_resource_id`.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the DNS Zone (parent resource) exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
...
class ARecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            zone_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ARecord':
        """
