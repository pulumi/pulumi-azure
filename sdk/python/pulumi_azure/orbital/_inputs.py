...
if not MYPY:
    class ContactProfileLinkArgsDict(TypedDict):
        ...
        Name of the link.
        """
        polarization: pulumi.Input[builtins.str]
        """
...
class ContactProfileLinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] direction: Direction of the link. Possible values are `Uplink` and `Downlink`.
        :param pulumi.Input[builtins.str] name: Name of the link.
        :param pulumi.Input[builtins.str] polarization: Polarization of the link. Possible values are `LHCP`, `RHCP`, `linearVertical` and `linearHorizontal`.
        """
    ...
    @property
    @pulumi.getter
    def polarization(self) -> pulumi.Input[builtins.str]:
        """
        Polarization of the link. Possible values are `LHCP`, `RHCP`, `linearVertical` and `linearHorizontal`.
        """
    ...
    @polarization.setter
    def polarization(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "polarization", value)


if not MYPY:
    class ContactProfileLinkChannelArgsDict(TypedDict):
        bandwidth_mhz: pulumi.Input[builtins.float]
        """
        Bandwidth in MHz.
        """
        center_frequency_mhz: pulumi.Input[builtins.float]
        """
        ...
        Name of the channel.
        """
        demodulation_configuration: NotRequired[pulumi.Input[builtins.str]]
        """
        Copy of the modem configuration file such as Kratos QRadio or Kratos QuantumRx. Only valid for downlink directions. If provided, the modem connects to the customer endpoint and sends demodulated data instead of a VITA.49 stream.
        """
        modulation_configuration: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ContactProfileLinkChannelArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str],
                 demodulation_configuration: Optional[pulumi.Input[builtins.str]] = None,
                 modulation_configuration: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.float] bandwidth_mhz: Bandwidth in MHz.
        :param pulumi.Input[builtins.float] center_frequency_mhz: Center frequency in MHz.
        ...
        :param pulumi.Input[builtins.str] demodulation_configuration: Copy of the modem configuration file such as Kratos QRadio or Kratos QuantumRx. Only valid for downlink directions. If provided, the modem connects to the customer endpoint and sends demodulated data instead of a VITA.49 stream.
        :param pulumi.Input[builtins.str] modulation_configuration: Copy of the modem configuration file such as Kratos QRadio. Only valid for uplink directions. If provided, the modem connects to the customer endpoint and accepts commands from the customer instead of a VITA.49 stream.
        """
    ...
    def bandwidth_mhz(self) -> pulumi.Input[builtins.float]:
        """
        Bandwidth in MHz.
        """
    ...
    def bandwidth_mhz(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "bandwidth_mhz", value)

    @property
    @pulumi.getter(name="centerFrequencyMhz")
    def center_frequency_mhz(self) -> pulumi.Input[builtins.float]:
        """
        Center frequency in MHz.
        """
    ...
    def center_frequency_mhz(self, value: pulumi.Input[builtins.float]):
    ...
    def demodulation_configuration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Copy of the modem configuration file such as Kratos QRadio or Kratos QuantumRx. Only valid for downlink directions. If provided, the modem connects to the customer endpoint and sends demodulated data instead of a VITA.49 stream.
        """
    ...
    def demodulation_configuration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "demodulation_configuration", value)

    @property
    @pulumi.getter(name="modulationConfiguration")
    def modulation_configuration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Copy of the modem configuration file such as Kratos QRadio. Only valid for uplink directions. If provided, the modem connects to the customer endpoint and accepts commands from the customer instead of a VITA.49 stream.
        """
    ...
    def modulation_configuration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "modulation_configuration", value)


if not MYPY:
    class ContactProfileLinkChannelEndPointArgsDict(TypedDict):
        end_point_name: pulumi.Input[builtins.str]
        """
...
class ContactProfileLinkChannelEndPointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] end_point_name: Name of an end point.
        :param pulumi.Input[builtins.str] port: TCP port to listen on to receive data.
        :param pulumi.Input[builtins.str] protocol: Protocol of an end point. Possible values are `TCP` and `UDP`.
        :param pulumi.Input[builtins.str] ip_address: IP address of an end point.
        """
    ...
    def end_point_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of an end point.
        """
    ...
    def end_point_name(self, value: pulumi.Input[builtins.str]):
...
class SpacecraftLinkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] center_frequency_mhz: Center frequency in Mhz.
               ...
               > **Note:** The value of `center_frequency_mhz +/- bandwidth_mhz / 2` should fall in one of these ranges: `Uplink/LHCP`: [2025, 2120]; `Uplink/Linear`: [399, 403],[435, 438],[449, 451]; `Uplink/RHCP`: [399, 403],[435, 438],[449, 451],[2025, 2120]; `Downlink/LHCP`: [2200, 2300], [7500, 8400]; `Downlink/Linear`: [399, 403], [435, 438], [449, 451]; Downlink/Linear`: [399, 403], [435, 438], [449, 451], [2200, 2300], [7500, 8400]
        :param pulumi.Input[builtins.str] direction: Direction if the communication. Possible values are `Uplink` and `Downlink`.
        :param pulumi.Input[builtins.str] name: Name of the link.
        :param pulumi.Input[builtins.str] polarization: Polarization. Possible values are `RHCP`, `LHCP`, `linearVertical` and `linearHorizontal`.
        """
        pulumi.set(__self__, "bandwidth_mhz", bandwidth_mhz)
        pulumi.set(__self__, "center_frequency_mhz", center_frequency_mhz)
        pulumi.set(__self__, "direction", direction)
