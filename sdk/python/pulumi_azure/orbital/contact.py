...
class ContactArgs:
    def __init__(__self__, *,
                 contact_profile_id: pulumi.Input[builtins.str],
                 ground_station_name: pulumi.Input[builtins.str],
                 reservation_end_time: pulumi.Input[builtins.str],
                 reservation_start_time: pulumi.Input[builtins.str],
                 spacecraft_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Contact resource.
        :param pulumi.Input[builtins.str] contact_profile_id: ID of the orbital contact profile. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] ground_station_name: Name of the Azure ground station. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] reservation_end_time: Reservation end time of the Contact. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] reservation_start_time: Reservation start time of the Contact. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] spacecraft_id: The ID of the spacecraft which the contact will be made to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Contact. Changing this forces a new resource to be created.
        """
    ...
    def contact_profile_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def contact_profile_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "contact_profile_id", value)

    @property
    @pulumi.getter(name="groundStationName")
    def ground_station_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ground_station_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ground_station_name", value)

    @property
    @pulumi.getter(name="reservationEndTime")
    def reservation_end_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def reservation_end_time(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "reservation_end_time", value)

    @property
    @pulumi.getter(name="reservationStartTime")
    def reservation_start_time(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def reservation_start_time(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "reservation_start_time", value)

    @property
    @pulumi.getter(name="spacecraftId")
    def spacecraft_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def spacecraft_id(self, value: pulumi.Input[builtins.str]):
...
class _ContactState:
    def __init__(__self__, *,
                 contact_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                 ground_station_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 spacecraft_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="contactProfileId")
    def contact_profile_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the orbital contact profile. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "contact_profile_id")
    ...
    @contact_profile_id.setter
    def contact_profile_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "contact_profile_id", value)
    ...
    @property
    @pulumi.getter(name="reservationEndTime")
    def reservation_end_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Reservation end time of the Contact. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "reservation_end_time")
    ...
    @reservation_end_time.setter
    def reservation_end_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reservation_end_time", value)

    @property
    @pulumi.getter(name="reservationStartTime")
    def reservation_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Reservation start time of the Contact. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "reservation_start_time")
    ...
    @reservation_start_time.setter
    def reservation_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reservation_start_time", value)

    @property
    @pulumi.getter(name="spacecraftId")
    def spacecraft_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the spacecraft which the contact will be made to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "spacecraft_id")
    ...
    @spacecraft_id.setter
    def spacecraft_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spacecraft_id", value)
...
class Contact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reservation_end_time: Optional[pulumi.Input[builtins.str]] = None,
            reservation_start_time: Optional[pulumi.Input[builtins.str]] = None,
            spacecraft_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Contact':
        """
    ...
    @property
    @pulumi.getter(name="contactProfileId")
    def contact_profile_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the orbital contact profile. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "contact_profile_id")
    ...
    @property
    @pulumi.getter(name="groundStationName")
    def ground_station_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the Azure ground station. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "ground_station_name")
    ...
    @property
    @pulumi.getter(name="reservationEndTime")
    def reservation_end_time(self) -> pulumi.Output[builtins.str]:
        """
        Reservation end time of the Contact. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "reservation_end_time")
    ...
    @property
    @pulumi.getter(name="reservationStartTime")
    def reservation_start_time(self) -> pulumi.Output[builtins.str]:
        """
        Reservation start time of the Contact. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "reservation_start_time")
    ...
    @property
    @pulumi.getter(name="spacecraftId")
    def spacecraft_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the spacecraft which the contact will be made to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "spacecraft_id")
