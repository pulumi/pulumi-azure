...
class ContactProfileLink(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str direction: Direction of the link. Possible values are `Uplink` and `Downlink`.
        :param builtins.str name: Name of the link.
        :param builtins.str polarization: Polarization of the link. Possible values are `LHCP`, `RHCP`, `linearVertical` and `linearHorizontal`.
        """
...
class ContactProfileLinkChannel(dict):
    ...
    def __init__(__self__, *,
                 bandwidth_mhz: builtins.float,
                 center_frequency_mhz: builtins.float,
                 end_points: Sequence['outputs.ContactProfileLinkChannelEndPoint'],
                 name: builtins.str,
                 demodulation_configuration: Optional[builtins.str] = None,
                 modulation_configuration: Optional[builtins.str] = None):
        """
        :param builtins.float bandwidth_mhz: Bandwidth in MHz.
        :param builtins.float center_frequency_mhz: Center frequency in MHz.
        ...
        :param builtins.str demodulation_configuration: Copy of the modem configuration file such as Kratos QRadio or Kratos QuantumRx. Only valid for downlink directions. If provided, the modem connects to the customer endpoint and sends demodulated data instead of a VITA.49 stream.
        :param builtins.str modulation_configuration: Copy of the modem configuration file such as Kratos QRadio. Only valid for uplink directions. If provided, the modem connects to the customer endpoint and accepts commands from the customer instead of a VITA.49 stream.
        """
    ...
    def bandwidth_mhz(self) -> builtins.float:
        """
        Bandwidth in MHz.
        """
    ...
    def center_frequency_mhz(self) -> builtins.float:
        """
    ...
    def demodulation_configuration(self) -> Optional[builtins.str]:
        """
    ...
    def modulation_configuration(self) -> Optional[builtins.str]:
        """
...
class ContactProfileLinkChannelEndPoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str end_point_name: Name of an end point.
        :param builtins.str port: TCP port to listen on to receive data.
        :param builtins.str protocol: Protocol of an end point. Possible values are `TCP` and `UDP`.
        :param builtins.str ip_address: IP address of an end point.
        """
...
class SpacecraftLink(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str direction: Direction if the communication. Possible values are `Uplink` and `Downlink`.
        :param builtins.str name: Name of the link.
        :param builtins.str polarization: Polarization. Possible values are `RHCP`, `LHCP`, `linearVertical` and `linearHorizontal`.
        """
        pulumi.set(__self__, "bandwidth_mhz", bandwidth_mhz)
        pulumi.set(__self__, "center_frequency_mhz", center_frequency_mhz)
        pulumi.set(__self__, "direction", direction)
