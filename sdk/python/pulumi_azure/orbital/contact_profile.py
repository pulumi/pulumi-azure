...
class ContactProfileArgs:
    def __init__(__self__, *,
                 auto_tracking: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] network_configuration_subnet_id: ARM resource identifier of the subnet delegated to the Microsoft.Orbital/orbitalGateways. Needs to be at least a class C subnet, and should not have any IP created in it. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the contact profile exists. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the contact profile. Changing this forces a new resource to be created.
    ...
    def auto_tracking(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def auto_tracking(self, value: pulumi.Input[_builtins.str]):
    ...
    def minimum_variable_contact_duration(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def minimum_variable_contact_duration(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "minimum_variable_contact_duration", value)

    @_builtins.property
    @pulumi.getter(name="networkConfigurationSubnetId")
    def network_configuration_subnet_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def network_configuration_subnet_id(self, value: pulumi.Input[_builtins.str]):
...
class ContactProfile(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="autoTracking")
    def auto_tracking(self) -> pulumi.Output[_builtins.str]:
        """
        Auto-tracking configurations for a spacecraft. Possible values are `disabled`, `xBand` and `sBand`.
        """
        return pulumi.get(self, "auto_tracking")
    ...
    @_builtins.property
    @pulumi.getter(name="minimumVariableContactDuration")
    def minimum_variable_contact_duration(self) -> pulumi.Output[_builtins.str]:
        """
        Minimum viable contact duration in ISO 8601 format. Used for listing the available contacts with a spacecraft at a given ground station.
        """
        return pulumi.get(self, "minimum_variable_contact_duration")
    ...
    @_builtins.property
    @pulumi.getter(name="networkConfigurationSubnetId")
    def network_configuration_subnet_id(self) -> pulumi.Output[_builtins.str]:
        """
        ARM resource identifier of the subnet delegated to the Microsoft.Orbital/orbitalGateways. Needs to be at least a class C subnet, and should not have any IP created in it. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "network_configuration_subnet_id")
