...
class ApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether public network access is allowed for the IoT Central Application. Defaults to `true`.
        :param pulumi.Input[builtins.str] sku: A `sku` name. Possible values is `ST0`, `ST1`, `ST2`, Default value is `ST1`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] template: A `template` name. IoT Central application template name. Defaults to `iotc-pnp-preview@1.0.0`. Changing this forces a new resource to be created.
        """
...
class Application(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sub_domain: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            template: Optional[pulumi.Input[builtins.str]] = None) -> 'Application':
        """
