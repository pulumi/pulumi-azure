...
class HciClusterArgs:
    def __init__(__self__, *,
                 ...
                 automanage_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] automanage_configuration_id: The ID of the Automanage Configuration assigned to the Azure Stack HCI Cluster.
        :param pulumi.Input[builtins.str] client_id: The Client ID of the Azure Active Directory Application which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input['HciClusterIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure Stack HCI Cluster. Changing this forces a new resource to be created.
    ...
    def automanage_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def automanage_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _HciClusterState:
    def __init__(__self__, *,
                 ...
                 resource_provider_object_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] automanage_configuration_id: The ID of the Automanage Configuration assigned to the Azure Stack HCI Cluster.
        :param pulumi.Input[builtins.str] client_id: The Client ID of the Azure Active Directory Application which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] cloud_id: An immutable UUID for the Azure Stack HCI Cluster.
        :param pulumi.Input['HciClusterIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure Stack HCI Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Azure Stack HCI Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_provider_object_id: The object ID of the Resource Provider Service Principal.
        :param pulumi.Input[builtins.str] service_endpoint: The region specific Data Path Endpoint of the Azure Stack HCI Cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Azure Stack HCI Cluster.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID of the Azure Active Directory which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created.
    ...
    def resource_provider_object_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_provider_object_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HciCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HciCluster':
        """
    ...
    @property
    @pulumi.getter(name="automanageConfigurationId")
    def automanage_configuration_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Automanage Configuration assigned to the Azure Stack HCI Cluster.
        """
        return pulumi.get(self, "automanage_configuration_id")
    ...
    @property
    @pulumi.getter(name="resourceProviderObjectId")
    def resource_provider_object_id(self) -> pulumi.Output[builtins.str]:
        """
        The object ID of the Resource Provider Service Principal.
        """
        return pulumi.get(self, "resource_provider_object_id")
