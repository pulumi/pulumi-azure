...
class HciClusterIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on the Azure Stack HCI Cluster. Possible value is `SystemAssigned`.
        :param builtins.str principal_id: The Principal ID associated with this Managed Service Identity.
        :param builtins.str tenant_id: The Tenant ID of the Azure Active Directory which is used by the Azure Stack HCI Cluster. Changing this forces a new resource to be created.
...
class HciDeploymentSettingScaleUnit(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bitlocker_boot_volume_enabled: Optional[builtins.bool] = None,
                 bitlocker_data_volume_enabled: Optional[builtins.bool] = None,
                 credential_guard_enabled: Optional[builtins.bool] = None,
                 drift_control_enabled: Optional[builtins.bool] = None,
                 drtm_protection_enabled: Optional[builtins.bool] = None,
                 episodic_data_upload_enabled: Optional[builtins.bool] = None,
                 eu_location_enabled: Optional[builtins.bool] = None,
                 hvci_protection_enabled: Optional[builtins.bool] = None,
                 side_channel_mitigation_enabled: Optional[builtins.bool] = None,
                 smb_cluster_encryption_enabled: Optional[builtins.bool] = None,
                 smb_signing_enabled: Optional[builtins.bool] = None,
                 streaming_data_client_enabled: Optional[builtins.bool] = None,
                 wdac_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str active_directory_organizational_unit_path: Specify the full name of the Active Directory Organizational Unit container object prepared for the deployment, including the domain components. For example:`OU=HCI01,DC=contoso,DC=com`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.str domain_fqdn: Specifies the FQDN for deploying cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.str name_prefix: Specifies the name prefix to deploy cluster. It must be 1-8 characters long and contain only letters, numbers and hyphens Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.str secrets_location: The URI to the Key Vault or secret store. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.bool bitlocker_boot_volume_enabled: Whether to enable BitLocker for boot volume. Possible values are `true` and `false`. When set to `true`, BitLocker XTS_AES 256-bit encryption is enabled for all data-at-rest on the OS volume of your Azure Stack HCI cluster. This setting is TPM-hardware dependent. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool bitlocker_data_volume_enabled: Whether to enable BitLocker for data volume. Possible values are `true` and `false`. When set to `true`, BitLocker XTS-AES 256-bit encryption is enabled for all data-at-rest on your Azure Stack HCI cluster shared volumes. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool credential_guard_enabled: Whether to enable credential guard. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool drift_control_enabled: Whether to enable drift control. Possible values are `true` and `false`. When set to `true`, the security baseline is re-applied regularly. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool drtm_protection_enabled: Whether to enable DRTM protection. Possible values are `true` and `false`. When set to `true`, Secure Boot is enabled on your Azure HCI cluster. This setting is hardware dependent. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool episodic_data_upload_enabled: Whether to collect log data to facilitate quicker issue resolution. Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool eu_location_enabled: Whether to store data sent to Microsoft in EU. The log and diagnostic data is sent to the appropriate diagnostics servers depending upon where your cluster resides. Setting this to `false` results in all data sent to Microsoft to be stored outside of the EU. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool hvci_protection_enabled: Whether to enable HVCI protection. Possible values are `true` and `false`. When set to `true`, Hypervisor-protected Code Integrity is enabled on your Azure HCI cluster. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool side_channel_mitigation_enabled: Whether to enable side channel mitigation. Possible values are `true` and `false`. When set to `true`, all side channel mitigations are enabled on your Azure HCI cluster. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool smb_cluster_encryption_enabled: Whether to enable SMB cluster encryption. Possible values are `true` and `false`. When set to `true`, cluster east-west traffic is encrypted. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool smb_signing_enabled: Whether to enable SMB signing. Possible values are `true` and `false`. When set to `true`, the SMB default instance requires sign in for the client and server services. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool streaming_data_client_enabled: Whether the telemetry data will be sent to Microsoft. Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool wdac_enabled: Whether to enable WDAC. Possible values are `true` and `false`. When set to `true`, applications and the code that you can run on your Azure Stack HCI cluster are limited. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def bitlocker_boot_volume_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def bitlocker_data_volume_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def credential_guard_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def drift_control_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def drtm_protection_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def episodic_data_upload_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def eu_location_enabled(self) -> Optional[builtins.bool]:
        """
        Whether to store data sent to Microsoft in EU. The log and diagnostic data is sent to the appropriate diagnostics servers depending upon where your cluster resides. Setting this to `false` results in all data sent to Microsoft to be stored outside of the EU. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def hvci_protection_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def side_channel_mitigation_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def smb_cluster_encryption_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def smb_signing_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def streaming_data_client_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def wdac_enabled(self) -> Optional[builtins.bool]:
        """
...
class HciDeploymentSettingScaleUnitCluster(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str azure_service_endpoint: Specifies the Azure blob service endpoint, for example, `core.windows.net`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str cloud_account_name: Specifies the Azure Storage account name of the cloud witness for the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str name: Specifies the name of the cluster. It must be 3-15 characters long and contain only letters, numbers and hyphens. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str witness_path: Specifies the fileshare path of the local witness for the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str witness_type: Specifies the type of the witness. Possible values are `Cloud`, `FileShare`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciDeploymentSettingScaleUnitHostNetwork(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_auto_ip_enabled: Optional[builtins.bool] = None,
                 storage_connectivity_switchless_enabled: Optional[builtins.bool] = None):
        """
    ...
    def storage_auto_ip_enabled(self) -> Optional[builtins.bool]:
        """
        Whether allows users to specify IPs and Mask for Storage NICs when Network ATC is not assigning the IPs for storage automatically. Optional parameter required only for [3 nodes switchless deployments](https://learn.microsoft.com/azure-stack/hci/concepts/physical-network-requirements?tabs=overview%2C23H2reqs#using-switchless). Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def storage_connectivity_switchless_enabled(self) -> Optional[builtins.bool]:
        """
...
class HciDeploymentSettingScaleUnitHostNetworkIntent(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtual_switch_configuration_override_enabled: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] adapters: Specifies a list of ID of network interfaces used for the network intent. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str name: Specifies the name of the intent. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param Sequence[builtins.str] traffic_types: Specifies a list of network traffic types. Possible values are `Compute`, `Storage`, `Management`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.bool adapter_property_override_enabled: Whether to override adapter properties. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.bool qos_policy_override_enabled: Whether to override QoS policy. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.bool virtual_switch_configuration_override_enabled: Whether to override virtual switch configuration. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    @property
    @pulumi.getter
    def adapters(self) -> Sequence[builtins.str]:
        """
    ...
    def traffic_types(self) -> Sequence[builtins.str]:
        """
    ...
    def adapter_property_override_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def qos_policy_override_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def virtual_switch_configuration_override_enabled(self) -> Optional[builtins.bool]:
        """
...
class HciDeploymentSettingScaleUnitHostNetworkIntentAdapterPropertyOverride(dict):
    ...
    def __init__(__self__, *,
                 jumbo_packet: Optional[builtins.str] = None,
                 network_direct: Optional[builtins.str] = None,
                 network_direct_technology: Optional[builtins.str] = None):
        """
        :param builtins.str jumbo_packet: The jumbo frame size of the adapter. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str network_direct: The network direct of the adapter. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str network_direct_technology: The network direct technology of the adapter. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def jumbo_packet(self) -> Optional[builtins.str]:
        """
    ...
    def network_direct(self) -> Optional[builtins.str]:
        """
    ...
    def network_direct_technology(self) -> Optional[builtins.str]:
        """
...
class HciDeploymentSettingScaleUnitHostNetworkIntentQosPolicyOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bandwidth_percentage_smb: Specifies the percentage of the allocated storage traffic bandwidth. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str priority_value8021_action_cluster: Specifies the Cluster traffic priority. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str priority_value8021_action_smb: Specifies the Priority Flow Control where Data Center Bridging (DCB) is used. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciDeploymentSettingScaleUnitHostNetworkIntentVirtualSwitchConfigurationOverride(dict):
    ...
    def __init__(__self__, *,
                 enable_iov: Optional[builtins.str] = None,
                 load_balancing_algorithm: Optional[builtins.str] = None):
        """
        :param builtins.str enable_iov: Specifies the IoV enable status for Virtual Switch. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str load_balancing_algorithm: Specifies the load balancing algorithm for Virtual Switch. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def enable_iov(self) -> Optional[builtins.str]:
        """
    ...
    def load_balancing_algorithm(self) -> Optional[builtins.str]:
        """
...
class HciDeploymentSettingScaleUnitHostNetworkStorageNetwork(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the storage network. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str network_adapter_name: The name of the network adapter. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str vlan_id: Specifies the ID for the VLAN storage network. This setting is applied to the network interfaces that route the storage and VM migration traffic. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
        pulumi.set(__self__, "name", name)
...
class HciDeploymentSettingScaleUnitInfrastructureNetwork(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] dns_servers: Specifies a list of IPv4 addresses of the DNS servers in your environment. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str gateway: Specifies the default gateway that should be used for the provided IP address space. It should be in the format of an IPv4 IP address. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param builtins.str subnet_mask: Specifies the subnet mask that matches the provided IP address space. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.bool dhcp_enabled: Whether DHCP is enabled for hosts and cluster IPs. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
...
class HciDeploymentSettingScaleUnitInfrastructureNetworkIpPool(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ending_address: Specifies starting IP address for the management network. A minimum of six free, contiguous IPv4 addresses (excluding your host IPs) are needed for infrastructure services such as clustering. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str starting_address: Specifies ending IP address for the management network. A minimum of six free, contiguous IPv4 addresses (excluding your host IPs) are needed for infrastructure services such as clustering. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciDeploymentSettingScaleUnitOptionalService(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str custom_location: Specifies the name of custom location. A custom location will be created after the deployment is completed. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciDeploymentSettingScaleUnitPhysicalNode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str ipv4_address: Specifies the IPv4 address assigned to each physical server on your Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param builtins.str name: The NETBIOS name of each physical server on your Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciDeploymentSettingScaleUnitStorage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str configuration_mode: The configuration mode of storage. If set to `Express` and your storage is configured as per best practices based on the number of nodes in the cluster. Possible values are `Express`, `InfraOnly` and `KeepStorage`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciLogicalNetworkSubnet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ip_allocation_method: The IP address allocation method for the subnet. Possible values are `Dynamic` and `Static`. Changing this forces a new resource to be created.
        :param builtins.str address_prefix: The address prefix in CIDR notation. Changing this forces a new resource to be created.
        ...
        :param builtins.int vlan_id: The VLAN ID for the Logical Network. Changing this forces a new resource to be created.
        """
...
class HciLogicalNetworkSubnetIpPool(dict):
    def __init__(__self__, *,
                 ...
                 start: builtins.str):
        """
        :param builtins.str end: The IPv4 address of the end of the IP address pool. Changing this forces a new resource to be created.
        :param builtins.str start: The IPv4 address of the start of the IP address pool. Changing this forces a new resource to be created.
        """
...
class HciLogicalNetworkSubnetRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address_prefix: The Address in CIDR notation. Changing this forces a new resource to be created.
        :param builtins.str next_hop_ip_address: The IPv4 address of the next hop. Changing this forces a new resource to be created.
        :param builtins.str name: The name of the route. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "address_prefix", address_prefix)
...
class HciMarketplaceGalleryImageIdentifier(dict):
    def __init__(__self__, *,
                 ...
                 sku: builtins.str):
        """
        :param builtins.str offer: The offer of the Azure Stack HCI Marketplace Gallery Image. Changing this forces a new Azure Stack HCI Marketplace Gallery Image to be created.
        :param builtins.str publisher: The publisher of the Azure Stack HCI Marketplace Gallery Image. Changing this forces a new Azure Stack HCI Marketplace Gallery Image to be created.
        :param builtins.str sku: The sku of the Azure Stack HCI Marketplace Gallery Image. Changing this forces a new Azure Stack HCI Marketplace Gallery Image to be created.
        """
...
class HciNetworkInterfaceIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 prefix_length: Optional[builtins.str] = None,
                 private_ip_address: Optional[builtins.str] = None):
        """
        :param builtins.str subnet_id: The resource ID of the Stack HCI Logical Network bound to the IP configuration. Changing this forces a new resource to be created.
        :param builtins.str gateway: The IPv4 address of the gateway for the Network Interface.
        :param builtins.str prefix_length: The prefix length for the address of the Network Interface.
        :param builtins.str private_ip_address: The IPv4 address of the IP configuration. Changing this forces a new resource to be created.
        """
    ...
    def prefix_length(self) -> Optional[builtins.str]:
        """
...
class GetHciClusterIdentityResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: (Required) The type of Managed Service Identity configured on the Azure Stack HCI Cluster.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
        pulumi.set(__self__, "type", type)
