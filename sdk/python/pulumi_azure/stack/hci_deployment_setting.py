...
class HciDeploymentSettingArgs:
    def __init__(__self__, *,
                 arc_resource_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 scale_units: pulumi.Input[Sequence[pulumi.Input['HciDeploymentSettingScaleUnitArgs']]],
                 stack_hci_cluster_id: pulumi.Input[builtins.str],
                 version: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a HciDeploymentSetting resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] arc_resource_ids: Specifies a list of IDs of Azure ARC machine resource to be part of cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.str] stack_hci_cluster_id: The ID of the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] version: The deployment template version. The format must be a set of numbers separated by dots such as `10.0.0.0`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def arc_resource_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def arc_resource_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def stack_hci_cluster_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def stack_hci_cluster_id(self, value: pulumi.Input[builtins.str]):
...
class _HciDeploymentSettingState:
    def __init__(__self__, *,
                 arc_resource_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="arcResourceIds")
    def arc_resource_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of IDs of Azure ARC machine resource to be part of cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
        return pulumi.get(self, "arc_resource_ids")
    ...
    @arc_resource_ids.setter
    def arc_resource_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "arc_resource_ids", value)
...
class HciDeploymentSetting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scale_units: Optional[pulumi.Input[Sequence[pulumi.Input[Union['HciDeploymentSettingScaleUnitArgs', 'HciDeploymentSettingScaleUnitArgsDict']]]]] = None,
            stack_hci_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'HciDeploymentSetting':
        """
    ...
    @property
    @pulumi.getter(name="arcResourceIds")
    def arc_resource_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies a list of IDs of Azure ARC machine resource to be part of cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
        return pulumi.get(self, "arc_resource_ids")
    ...
    @property
    @pulumi.getter(name="stackHciClusterId")
    def stack_hci_cluster_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
        return pulumi.get(self, "stack_hci_cluster_id")
