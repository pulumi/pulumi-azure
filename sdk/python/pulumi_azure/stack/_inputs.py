...
class HciClusterIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on the Azure Stack HCI Cluster. Possible value is `SystemAssigned`.
...
if not MYPY:
    class HciDeploymentSettingScaleUnitArgsDict(TypedDict):
        active_directory_organizational_unit_path: pulumi.Input[builtins.str]
        """
        ...
        """
        domain_fqdn: pulumi.Input[builtins.str]
        """
        ...
        """
        secrets_location: pulumi.Input[builtins.str]
        """
        ...
        """
        bitlocker_boot_volume_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        bitlocker_data_volume_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        credential_guard_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        drift_control_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        drtm_protection_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        episodic_data_upload_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        eu_location_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        hvci_protection_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        side_channel_mitigation_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        smb_cluster_encryption_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        smb_signing_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        streaming_data_client_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        wdac_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class HciDeploymentSettingScaleUnitArgs:
    def __init__(__self__, *,
                 ...
                 bitlocker_boot_volume_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 bitlocker_data_volume_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 credential_guard_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 drift_control_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 drtm_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 episodic_data_upload_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 eu_location_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 hvci_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 side_channel_mitigation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 smb_cluster_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 smb_signing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 streaming_data_client_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 wdac_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] active_directory_organizational_unit_path: Specify the full name of the Active Directory Organizational Unit container object prepared for the deployment, including the domain components. For example:`OU=HCI01,DC=contoso,DC=com`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.str] domain_fqdn: Specifies the FQDN for deploying cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.str] name_prefix: Specifies the name prefix to deploy cluster. It must be 1-8 characters long and contain only letters, numbers and hyphens Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.str] secrets_location: The URI to the Key Vault or secret store. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.bool] bitlocker_boot_volume_enabled: Whether to enable BitLocker for boot volume. Possible values are `true` and `false`. When set to `true`, BitLocker XTS_AES 256-bit encryption is enabled for all data-at-rest on the OS volume of your Azure Stack HCI cluster. This setting is TPM-hardware dependent. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] bitlocker_data_volume_enabled: Whether to enable BitLocker for data volume. Possible values are `true` and `false`. When set to `true`, BitLocker XTS-AES 256-bit encryption is enabled for all data-at-rest on your Azure Stack HCI cluster shared volumes. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] credential_guard_enabled: Whether to enable credential guard. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] drift_control_enabled: Whether to enable drift control. Possible values are `true` and `false`. When set to `true`, the security baseline is re-applied regularly. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] drtm_protection_enabled: Whether to enable DRTM protection. Possible values are `true` and `false`. When set to `true`, Secure Boot is enabled on your Azure HCI cluster. This setting is hardware dependent. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] episodic_data_upload_enabled: Whether to collect log data to facilitate quicker issue resolution. Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] eu_location_enabled: Whether to store data sent to Microsoft in EU. The log and diagnostic data is sent to the appropriate diagnostics servers depending upon where your cluster resides. Setting this to `false` results in all data sent to Microsoft to be stored outside of the EU. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] hvci_protection_enabled: Whether to enable HVCI protection. Possible values are `true` and `false`. When set to `true`, Hypervisor-protected Code Integrity is enabled on your Azure HCI cluster. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] side_channel_mitigation_enabled: Whether to enable side channel mitigation. Possible values are `true` and `false`. When set to `true`, all side channel mitigations are enabled on your Azure HCI cluster. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] smb_cluster_encryption_enabled: Whether to enable SMB cluster encryption. Possible values are `true` and `false`. When set to `true`, cluster east-west traffic is encrypted. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] smb_signing_enabled: Whether to enable SMB signing. Possible values are `true` and `false`. When set to `true`, the SMB default instance requires sign in for the client and server services. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] streaming_data_client_enabled: Whether the telemetry data will be sent to Microsoft. Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] wdac_enabled: Whether to enable WDAC. Possible values are `true` and `false`. When set to `true`, applications and the code that you can run on your Azure Stack HCI cluster are limited. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def active_directory_organizational_unit_path(self) -> pulumi.Input[builtins.str]:
        """
        Specify the full name of the Active Directory Organizational Unit container object prepared for the deployment, including the domain components. For example:`OU=HCI01,DC=contoso,DC=com`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def active_directory_organizational_unit_path(self, value: pulumi.Input[builtins.str]):
    ...
    def domain_fqdn(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the FQDN for deploying cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    @domain_fqdn.setter
    def domain_fqdn(self, value: pulumi.Input[builtins.str]):
    ...
    def secrets_location(self) -> pulumi.Input[builtins.str]:
        """
        The URI to the Key Vault or secret store. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def secrets_location(self, value: pulumi.Input[builtins.str]):
    ...
    def bitlocker_boot_volume_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable BitLocker for boot volume. Possible values are `true` and `false`. When set to `true`, BitLocker XTS_AES 256-bit encryption is enabled for all data-at-rest on the OS volume of your Azure Stack HCI cluster. This setting is TPM-hardware dependent. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def bitlocker_boot_volume_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "bitlocker_boot_volume_enabled", value)

    @property
    @pulumi.getter(name="bitlockerDataVolumeEnabled")
    def bitlocker_data_volume_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable BitLocker for data volume. Possible values are `true` and `false`. When set to `true`, BitLocker XTS-AES 256-bit encryption is enabled for all data-at-rest on your Azure Stack HCI cluster shared volumes. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def bitlocker_data_volume_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "bitlocker_data_volume_enabled", value)

    @property
    @pulumi.getter(name="credentialGuardEnabled")
    def credential_guard_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable credential guard. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def credential_guard_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "credential_guard_enabled", value)

    @property
    @pulumi.getter(name="driftControlEnabled")
    def drift_control_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable drift control. Possible values are `true` and `false`. When set to `true`, the security baseline is re-applied regularly. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def drift_control_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "drift_control_enabled", value)

    @property
    @pulumi.getter(name="drtmProtectionEnabled")
    def drtm_protection_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable DRTM protection. Possible values are `true` and `false`. When set to `true`, Secure Boot is enabled on your Azure HCI cluster. This setting is hardware dependent. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def drtm_protection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "drtm_protection_enabled", value)

    @property
    @pulumi.getter(name="episodicDataUploadEnabled")
    def episodic_data_upload_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to collect log data to facilitate quicker issue resolution. Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def episodic_data_upload_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "episodic_data_upload_enabled", value)

    @property
    @pulumi.getter(name="euLocationEnabled")
    def eu_location_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to store data sent to Microsoft in EU. The log and diagnostic data is sent to the appropriate diagnostics servers depending upon where your cluster resides. Setting this to `false` results in all data sent to Microsoft to be stored outside of the EU. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def eu_location_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "eu_location_enabled", value)

    @property
    @pulumi.getter(name="hvciProtectionEnabled")
    def hvci_protection_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable HVCI protection. Possible values are `true` and `false`. When set to `true`, Hypervisor-protected Code Integrity is enabled on your Azure HCI cluster. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def hvci_protection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "hvci_protection_enabled", value)

    @property
    @pulumi.getter(name="sideChannelMitigationEnabled")
    def side_channel_mitigation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable side channel mitigation. Possible values are `true` and `false`. When set to `true`, all side channel mitigations are enabled on your Azure HCI cluster. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def side_channel_mitigation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "side_channel_mitigation_enabled", value)

    @property
    @pulumi.getter(name="smbClusterEncryptionEnabled")
    def smb_cluster_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable SMB cluster encryption. Possible values are `true` and `false`. When set to `true`, cluster east-west traffic is encrypted. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def smb_cluster_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "smb_cluster_encryption_enabled", value)

    @property
    @pulumi.getter(name="smbSigningEnabled")
    def smb_signing_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable SMB signing. Possible values are `true` and `false`. When set to `true`, the SMB default instance requires sign in for the client and server services. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def smb_signing_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "smb_signing_enabled", value)

    @property
    @pulumi.getter(name="streamingDataClientEnabled")
    def streaming_data_client_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the telemetry data will be sent to Microsoft. Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def streaming_data_client_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "streaming_data_client_enabled", value)

    @property
    @pulumi.getter(name="wdacEnabled")
    def wdac_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable WDAC. Possible values are `true` and `false`. When set to `true`, applications and the code that you can run on your Azure Stack HCI cluster are limited. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    @wdac_enabled.setter
    def wdac_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "wdac_enabled", value)


if not MYPY:
    class HciDeploymentSettingScaleUnitClusterArgsDict(TypedDict):
        azure_service_endpoint: pulumi.Input[builtins.str]
        """
        ...
        """
        cloud_account_name: pulumi.Input[builtins.str]
        """
        ...
        """
        witness_path: pulumi.Input[builtins.str]
        """
        ...
        """
        witness_type: pulumi.Input[builtins.str]
        """
...
class HciDeploymentSettingScaleUnitClusterArgs:
    def __init__(__self__, *,
                 ...
                 witness_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] azure_service_endpoint: Specifies the Azure blob service endpoint, for example, `core.windows.net`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] cloud_account_name: Specifies the Azure Storage account name of the cloud witness for the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the cluster. It must be 3-15 characters long and contain only letters, numbers and hyphens. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] witness_path: Specifies the fileshare path of the local witness for the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] witness_type: Specifies the type of the witness. Possible values are `Cloud`, `FileShare`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def azure_service_endpoint(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the Azure blob service endpoint, for example, `core.windows.net`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def azure_service_endpoint(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "azure_service_endpoint", value)

    @property
    @pulumi.getter(name="cloudAccountName")
    def cloud_account_name(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the Azure Storage account name of the cloud witness for the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def cloud_account_name(self, value: pulumi.Input[builtins.str]):
    ...
    def witness_path(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the fileshare path of the local witness for the Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    @witness_path.setter
    def witness_path(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "witness_path", value)

    @property
    @pulumi.getter(name="witnessType")
    def witness_type(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the type of the witness. Possible values are `Cloud`, `FileShare`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    @witness_type.setter
    def witness_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class HciDeploymentSettingScaleUnitHostNetworkArgsDict(TypedDict):
        ...
        """
        storage_auto_ip_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        storage_connectivity_switchless_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class HciDeploymentSettingScaleUnitHostNetworkArgs:
    def __init__(__self__, *,
                 ...
                 storage_auto_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 storage_connectivity_switchless_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] storage_auto_ip_enabled: Whether allows users to specify IPs and Mask for Storage NICs when Network ATC is not assigning the IPs for storage automatically. Optional parameter required only for [3 nodes switchless deployments](https://learn.microsoft.com/azure-stack/hci/concepts/physical-network-requirements?tabs=overview%2C23H2reqs#using-switchless). Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.bool] storage_connectivity_switchless_enabled: Defines how the storage adapters between nodes are connected either switch or switch less. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def storage_auto_ip_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether allows users to specify IPs and Mask for Storage NICs when Network ATC is not assigning the IPs for storage automatically. Optional parameter required only for [3 nodes switchless deployments](https://learn.microsoft.com/azure-stack/hci/concepts/physical-network-requirements?tabs=overview%2C23H2reqs#using-switchless). Possible values are `true` and `false`. Defaults to `true`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def storage_auto_ip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "storage_auto_ip_enabled", value)

    @property
    @pulumi.getter(name="storageConnectivitySwitchlessEnabled")
    def storage_connectivity_switchless_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Defines how the storage adapters between nodes are connected either switch or switch less. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def storage_connectivity_switchless_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class HciDeploymentSettingScaleUnitHostNetworkIntentArgsDict(TypedDict):
        adapters: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        traffic_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        adapter_property_override_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        qos_policy_override_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        virtual_switch_configuration_override_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class HciDeploymentSettingScaleUnitHostNetworkIntentArgs:
    def __init__(__self__, *,
                 ...
                 adapter_property_override_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 qos_policy_override: Optional[pulumi.Input['HciDeploymentSettingScaleUnitHostNetworkIntentQosPolicyOverrideArgs']] = None,
                 qos_policy_override_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 virtual_switch_configuration_override_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] adapters: Specifies a list of ID of network interfaces used for the network intent. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the intent. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] traffic_types: Specifies a list of network traffic types. Possible values are `Compute`, `Storage`, `Management`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.bool] adapter_property_override_enabled: Whether to override adapter properties. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.bool] qos_policy_override_enabled: Whether to override QoS policy. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        ...
        :param pulumi.Input[builtins.bool] virtual_switch_configuration_override_enabled: Whether to override virtual switch configuration. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    @property
    @pulumi.getter
    def adapters(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of ID of network interfaces used for the network intent. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    @adapters.setter
    def adapters(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def traffic_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of network traffic types. Possible values are `Compute`, `Storage`, `Management`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def traffic_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def adapter_property_override_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to override adapter properties. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def adapter_property_override_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def qos_policy_override_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to override QoS policy. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def qos_policy_override_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def virtual_switch_configuration_override_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to override virtual switch configuration. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def virtual_switch_configuration_override_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class HciDeploymentSettingScaleUnitHostNetworkIntentAdapterPropertyOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] jumbo_packet: The jumbo frame size of the adapter. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] network_direct: The network direct of the adapter. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] network_direct_technology: The network direct technology of the adapter. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciDeploymentSettingScaleUnitHostNetworkIntentQosPolicyOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bandwidth_percentage_smb: Specifies the percentage of the allocated storage traffic bandwidth. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] priority_value8021_action_cluster: Specifies the Cluster traffic priority. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] priority_value8021_action_smb: Specifies the Priority Flow Control where Data Center Bridging (DCB) is used. This parameter should only be modified based on your OEM guidance. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
class HciDeploymentSettingScaleUnitHostNetworkIntentVirtualSwitchConfigurationOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] enable_iov: Specifies the IoV enable status for Virtual Switch. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] load_balancing_algorithm: Specifies the load balancing algorithm for Virtual Switch. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
if not MYPY:
    class HciDeploymentSettingScaleUnitHostNetworkStorageNetworkArgsDict(TypedDict):
        ...
        """
        network_adapter_name: pulumi.Input[builtins.str]
        """
...
class HciDeploymentSettingScaleUnitHostNetworkStorageNetworkArgs:
    def __init__(__self__, *,
                 ...
                 vlan_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the storage network. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] network_adapter_name: The name of the network adapter. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] vlan_id: Specifies the ID for the VLAN storage network. This setting is applied to the network interfaces that route the storage and VM migration traffic. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
        pulumi.set(__self__, "name", name)
    ...
    def network_adapter_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the network adapter. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def network_adapter_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class HciDeploymentSettingScaleUnitInfrastructureNetworkArgsDict(TypedDict):
        ...
        """
        dhcp_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class HciDeploymentSettingScaleUnitInfrastructureNetworkArgs:
    def __init__(__self__, *,
                 ...
                 subnet_mask: pulumi.Input[builtins.str],
                 dhcp_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: Specifies a list of IPv4 addresses of the DNS servers in your environment. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] gateway: Specifies the default gateway that should be used for the provided IP address space. It should be in the format of an IPv4 IP address. Changing this forces a new Stack HCI Deployment Setting to be created.
    ...
    def dhcp_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether DHCP is enabled for hosts and cluster IPs. Possible values are `true` and `false`. defaults to `false`. Changing this forces a new Stack HCI Deployment Setting to be created.
...
class HciDeploymentSettingScaleUnitInfrastructureNetworkIpPoolArgs:
    def __init__(__self__, *,
                 ...
                 starting_address: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] ending_address: Specifies starting IP address for the management network. A minimum of six free, contiguous IPv4 addresses (excluding your host IPs) are needed for infrastructure services such as clustering. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] starting_address: Specifies ending IP address for the management network. A minimum of six free, contiguous IPv4 addresses (excluding your host IPs) are needed for infrastructure services such as clustering. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def ending_address(self) -> pulumi.Input[builtins.str]:
        """
        Specifies starting IP address for the management network. A minimum of six free, contiguous IPv4 addresses (excluding your host IPs) are needed for infrastructure services such as clustering. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def ending_address(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class HciDeploymentSettingScaleUnitOptionalServiceArgsDict(TypedDict):
        custom_location: pulumi.Input[builtins.str]
        """
...
class HciDeploymentSettingScaleUnitOptionalServiceArgs:
    def __init__(__self__, *,
                 custom_location: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] custom_location: Specifies the name of custom location. A custom location will be created after the deployment is completed. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
        pulumi.set(__self__, "custom_location", custom_location)

    @property
    @pulumi.getter(name="customLocation")
    def custom_location(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the name of custom location. A custom location will be created after the deployment is completed. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def custom_location(self, value: pulumi.Input[builtins.str]):
...
class HciDeploymentSettingScaleUnitPhysicalNodeArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] ipv4_address: Specifies the IPv4 address assigned to each physical server on your Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        :param pulumi.Input[builtins.str] name: The NETBIOS name of each physical server on your Azure Stack HCI cluster. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
...
if not MYPY:
    class HciDeploymentSettingScaleUnitStorageArgsDict(TypedDict):
        configuration_mode: pulumi.Input[builtins.str]
        """
...
class HciDeploymentSettingScaleUnitStorageArgs:
    def __init__(__self__, *,
                 configuration_mode: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] configuration_mode: The configuration mode of storage. If set to `Express` and your storage is configured as per best practices based on the number of nodes in the cluster. Possible values are `Express`, `InfraOnly` and `KeepStorage`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
        pulumi.set(__self__, "configuration_mode", configuration_mode)

    @property
    @pulumi.getter(name="configurationMode")
    def configuration_mode(self) -> pulumi.Input[builtins.str]:
        """
        The configuration mode of storage. If set to `Express` and your storage is configured as per best practices based on the number of nodes in the cluster. Possible values are `Express`, `InfraOnly` and `KeepStorage`. Changing this forces a new Stack HCI Deployment Setting to be created.
        """
    ...
    def configuration_mode(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "configuration_mode", value)


if not MYPY:
    class HciLogicalNetworkSubnetArgsDict(TypedDict):
        ip_allocation_method: pulumi.Input[builtins.str]
        """
...
class HciLogicalNetworkSubnetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] ip_allocation_method: The IP address allocation method for the subnet. Possible values are `Dynamic` and `Static`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] address_prefix: The address prefix in CIDR notation. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.int] vlan_id: The VLAN ID for the Logical Network. Changing this forces a new resource to be created.
        """
    ...
    def ip_allocation_method(self) -> pulumi.Input[builtins.str]:
        """
        The IP address allocation method for the subnet. Possible values are `Dynamic` and `Static`. Changing this forces a new resource to be created.
        """
    ...
    def ip_allocation_method(self, value: pulumi.Input[builtins.str]):
...
class HciLogicalNetworkSubnetIpPoolArgs:
    def __init__(__self__, *,
                 ...
                 start: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] end: The IPv4 address of the end of the IP address pool. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] start: The IPv4 address of the start of the IP address pool. Changing this forces a new resource to be created.
        """
...
class HciLogicalNetworkSubnetRouteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] address_prefix: The Address in CIDR notation. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] next_hop_ip_address: The IPv4 address of the next hop. Changing this forces a new resource to be created.
...
class HciMarketplaceGalleryImageIdentifierArgs:
    def __init__(__self__, *,
                 ...
                 sku: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] offer: The offer of the Azure Stack HCI Marketplace Gallery Image. Changing this forces a new Azure Stack HCI Marketplace Gallery Image to be created.
        :param pulumi.Input[builtins.str] publisher: The publisher of the Azure Stack HCI Marketplace Gallery Image. Changing this forces a new Azure Stack HCI Marketplace Gallery Image to be created.
        :param pulumi.Input[builtins.str] sku: The sku of the Azure Stack HCI Marketplace Gallery Image. Changing this forces a new Azure Stack HCI Marketplace Gallery Image to be created.
        """
...
if not MYPY:
    class HciNetworkInterfaceIpConfigurationArgsDict(TypedDict):
        ...
        """
        prefix_length: NotRequired[pulumi.Input[builtins.str]]
        """
...
class HciNetworkInterfaceIpConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 prefix_length: Optional[pulumi.Input[builtins.str]] = None,
                 private_ip_address: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] subnet_id: The resource ID of the Stack HCI Logical Network bound to the IP configuration. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] gateway: The IPv4 address of the gateway for the Network Interface.
        :param pulumi.Input[builtins.str] prefix_length: The prefix length for the address of the Network Interface.
        :param pulumi.Input[builtins.str] private_ip_address: The IPv4 address of the IP configuration. Changing this forces a new resource to be created.
        """
    ...
    def prefix_length(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The prefix length for the address of the Network Interface.
        """
    ...
    def prefix_length(self, value: Optional[pulumi.Input[builtins.str]]):
