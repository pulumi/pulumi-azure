...
class HciVirtualHardDiskArgs:
    def __init__(__self__, *,
                 ...
                 disk_size_in_gb: pulumi.Input[builtins.int],
                 resource_group_name: pulumi.Input[builtins.str],
                 block_size_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 disk_file_format: Optional[pulumi.Input[builtins.str]] = None,
                 dynamic_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 hyperv_generation: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 logical_sector_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 physical_sector_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 storage_path_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a HciVirtualHardDisk resource.
        :param pulumi.Input[builtins.str] custom_location_id: The ID of the Custom Location where the Azure Stack HCI Virtual Hard Disk should exist. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.int] disk_size_in_gb: The size of the disk in GB. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Azure Stack HCI Virtual Hard Disk should exist. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.int] block_size_in_bytes: The block size of the disk in bytes. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.str] disk_file_format: The format of the disk file. Possible values are `vhdx` and `vhd`. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.bool] dynamic_enabled: Whether to enable dynamic sizing for the Azure Stack HCI Virtual Hard Disk. Defaults to `false`. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.str] hyperv_generation: The hypervisor generation of the Azure Stack HCI Virtual Hard Disk. Possible values are `V1` and `V2`. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Azure Stack HCI Virtual Hard Disk should exist. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.int] logical_sector_in_bytes: The logical sector size of the disk in bytes. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure Stack HCI Virtual Hard Disk. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.int] physical_sector_in_bytes: The physical sector size of the disk in bytes. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        :param pulumi.Input[builtins.str] storage_path_id: The ID of the Azure Stack HCI Storage Path used for this Virtual Hard Disk. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Azure Stack HCI Virtual Hard Disk.
        """
    ...
    def disk_size_in_gb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def disk_size_in_gb(self, value: pulumi.Input[builtins.int]):
    ...
    def block_size_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def block_size_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "block_size_in_bytes", value)

    @property
    @pulumi.getter(name="diskFileFormat")
    def disk_file_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disk_file_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "disk_file_format", value)

    @property
    @pulumi.getter(name="dynamicEnabled")
    def dynamic_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def dynamic_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "dynamic_enabled", value)

    @property
    @pulumi.getter(name="hypervGeneration")
    def hyperv_generation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hyperv_generation(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def logical_sector_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def logical_sector_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def physical_sector_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def physical_sector_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "physical_sector_in_bytes", value)

    @property
    @pulumi.getter(name="storagePathId")
    def storage_path_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_path_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HciVirtualHardDisk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            storage_path_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'HciVirtualHardDisk':
        """
    ...
    @property
    @pulumi.getter(name="blockSizeInBytes")
    def block_size_in_bytes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The block size of the disk in bytes. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        """
        return pulumi.get(self, "block_size_in_bytes")
    ...
    @property
    @pulumi.getter(name="diskSizeInGb")
    def disk_size_in_gb(self) -> pulumi.Output[builtins.int]:
        """
        The size of the disk in GB. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        """
        return pulumi.get(self, "disk_size_in_gb")
    ...
    @property
    @pulumi.getter(name="dynamicEnabled")
    def dynamic_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable dynamic sizing for the Azure Stack HCI Virtual Hard Disk. Defaults to `false`. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        """
        return pulumi.get(self, "dynamic_enabled")
    ...
    @property
    @pulumi.getter(name="hypervGeneration")
    def hyperv_generation(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The hypervisor generation of the Azure Stack HCI Virtual Hard Disk. Possible values are `V1` and `V2`. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        """
        return pulumi.get(self, "hyperv_generation")
    ...
    @property
    @pulumi.getter(name="logicalSectorInBytes")
    def logical_sector_in_bytes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The logical sector size of the disk in bytes. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        """
        return pulumi.get(self, "logical_sector_in_bytes")
    ...
    @property
    @pulumi.getter(name="physicalSectorInBytes")
    def physical_sector_in_bytes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The physical sector size of the disk in bytes. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
        """
        return pulumi.get(self, "physical_sector_in_bytes")
    ...
    @property
    @pulumi.getter(name="storagePathId")
    def storage_path_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Azure Stack HCI Storage Path used for this Virtual Hard Disk. Changing this forces a new Azure Stack HCI Virtual Hard Disk to be created.
