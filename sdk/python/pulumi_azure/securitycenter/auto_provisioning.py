...
class AutoProvisioningArgs:
    def __init__(__self__, *,
                 auto_provision: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a AutoProvisioning resource.
        :param pulumi.Input[builtins.str] auto_provision: Should the security agent be automatically provisioned on Virtual Machines in this subscription? Possible values are `On` (to install the security agent automatically, if it's missing) or `Off` (to not install the security agent automatically).
        """
        pulumi.set(__self__, "auto_provision", auto_provision)

    @property
    @pulumi.getter(name="autoProvision")
    def auto_provision(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def auto_provision(self, value: pulumi.Input[builtins.str]):
...
class _AutoProvisioningState:
    def __init__(__self__, *,
                 auto_provision: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="autoProvision")
    def auto_provision(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Should the security agent be automatically provisioned on Virtual Machines in this subscription? Possible values are `On` (to install the security agent automatically, if it's missing) or `Off` (to not install the security agent automatically).
        """
        return pulumi.get(self, "auto_provision")
    ...
    @auto_provision.setter
    def auto_provision(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_provision", value)
...
class AutoProvisioning(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            auto_provision: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoProvisioning':
        """
    ...
    @property
    @pulumi.getter(name="autoProvision")
    def auto_provision(self) -> pulumi.Output[builtins.str]:
        """
        Should the security agent be automatically provisioned on Virtual Machines in this subscription? Possible values are `On` (to install the security agent automatically, if it's missing) or `Off` (to not install the security agent automatically).
        """
        return pulumi.get(self, "auto_provision")
