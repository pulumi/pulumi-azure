...
class StorageDefenderArgs:
    def __init__(__self__, *,
                 ...
                 malware_scanning_on_upload_cap_gb_per_month: Optional[pulumi.Input[builtins.int]] = None,
                 malware_scanning_on_upload_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 override_subscription_settings_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 scan_results_event_grid_topic_id: Optional[pulumi.Input[builtins.str]] = None,
                 sensitive_data_discovery_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a StorageDefender resource.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the storage account the defender applied to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] malware_scanning_on_upload_cap_gb_per_month: The max GB to be scanned per Month. Must be `-1` or above `0`. Omit this property or set to `-1` if no capping is needed. Defaults to `-1`.
        :param pulumi.Input[builtins.bool] malware_scanning_on_upload_enabled: Whether On Upload malware scanning should be enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] override_subscription_settings_enabled: Whether the settings defined for this storage account should override the settings defined for the subscription. Defaults to `false`.
        :param pulumi.Input[builtins.str] scan_results_event_grid_topic_id: The Event Grid Topic where every scan result will be sent to. When you set an Event Grid custom topic, you must set `override_subscription_settings_enabled` to `true` to override the subscription-level settings.
        :param pulumi.Input[builtins.bool] sensitive_data_discovery_enabled: Whether Sensitive Data Discovery should be enabled. Defaults to `false`.
        """
    ...
    def malware_scanning_on_upload_cap_gb_per_month(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def malware_scanning_on_upload_cap_gb_per_month(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "malware_scanning_on_upload_cap_gb_per_month", value)

    @property
    @pulumi.getter(name="malwareScanningOnUploadEnabled")
    def malware_scanning_on_upload_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def malware_scanning_on_upload_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "malware_scanning_on_upload_enabled", value)

    @property
    @pulumi.getter(name="overrideSubscriptionSettingsEnabled")
    def override_subscription_settings_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def override_subscription_settings_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "override_subscription_settings_enabled", value)

    @property
    @pulumi.getter(name="scanResultsEventGridTopicId")
    def scan_results_event_grid_topic_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scan_results_event_grid_topic_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scan_results_event_grid_topic_id", value)

    @property
    @pulumi.getter(name="sensitiveDataDiscoveryEnabled")
    def sensitive_data_discovery_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sensitive_data_discovery_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class StorageDefender(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scan_results_event_grid_topic_id: Optional[pulumi.Input[builtins.str]] = None,
            sensitive_data_discovery_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'StorageDefender':
        """
    ...
    @property
    @pulumi.getter(name="malwareScanningOnUploadCapGbPerMonth")
    def malware_scanning_on_upload_cap_gb_per_month(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The max GB to be scanned per Month. Must be `-1` or above `0`. Omit this property or set to `-1` if no capping is needed. Defaults to `-1`.
        """
        return pulumi.get(self, "malware_scanning_on_upload_cap_gb_per_month")
    ...
    @property
    @pulumi.getter(name="malwareScanningOnUploadEnabled")
    def malware_scanning_on_upload_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether On Upload malware scanning should be enabled. Defaults to `false`.
        """
        return pulumi.get(self, "malware_scanning_on_upload_enabled")
    ...
    @property
    @pulumi.getter(name="overrideSubscriptionSettingsEnabled")
    def override_subscription_settings_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the settings defined for this storage account should override the settings defined for the subscription. Defaults to `false`.
        """
        return pulumi.get(self, "override_subscription_settings_enabled")
    ...
    @property
    @pulumi.getter(name="scanResultsEventGridTopicId")
    def scan_results_event_grid_topic_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Event Grid Topic where every scan result will be sent to. When you set an Event Grid custom topic, you must set `override_subscription_settings_enabled` to `true` to override the subscription-level settings.
        """
        return pulumi.get(self, "scan_results_event_grid_topic_id")
    ...
    @property
    @pulumi.getter(name="sensitiveDataDiscoveryEnabled")
    def sensitive_data_discovery_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether Sensitive Data Discovery should be enabled. Defaults to `false`.
        """
        return pulumi.get(self, "sensitive_data_discovery_enabled")
