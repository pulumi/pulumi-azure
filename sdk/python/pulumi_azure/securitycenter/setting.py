...
class SettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] setting_name: The setting to manage. Possible values are `MCAS` , `WDATP`, `WDATP_EXCLUDE_LINUX_PUBLIC_PREVIEW`, `WDATP_UNIFIED_SOLUTION` and `Sentinel`. Changing this forces a new resource to be created.
        """
...
class Setting(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = azure.securitycenter.setting.Setting("example",
            setting_name=MCAS,
            enabled=True)
        ```
