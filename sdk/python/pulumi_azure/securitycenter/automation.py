...
class AutomationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description for the Security Center Automation.
        :param pulumi.Input[builtins.bool] enabled: Boolean to enable or disable this Security Center Automation. Defaults to `true`.
...
class Automation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            sources: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutomationSourceArgs', 'AutomationSourceArgsDict']]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Automation':
        """
