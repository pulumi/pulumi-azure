...
class AssessmentStatusArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] code: Specifies the programmatic code of the assessment status. Possible values are `Healthy`, `Unhealthy` and `NotApplicable`.
        :param pulumi.Input[builtins.str] cause: Specifies the cause of the assessment status.
        :param pulumi.Input[builtins.str] description: Specifies the human readable description of the assessment status.
        """
...
if not MYPY:
    class AutomationActionArgsDict(TypedDict):
        ...
        """
        trigger_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AutomationActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] resource_id: The resource id of the target Logic App, Event Hub namespace or Log Analytics workspace.
        :param pulumi.Input[builtins.str] type: Type of Azure resource to send data to. Must be set to one of: `logicapp`, `eventhub` or `loganalytics`.
        :param pulumi.Input[builtins.str] connection_string: (Optional, but required when `type` is `eventhub`) A connection string to send data to the target Event Hub namespace, this should include a key with send permissions.
        :param pulumi.Input[builtins.str] trigger_url: (Optional, but required when `type` is `logicapp`) The callback URL to trigger the Logic App that will receive and process data sent by this automation. This can be found in the Azure Portal under "See trigger history"
        """
...
if not MYPY:
    class AutomationSourceRuleSetRuleArgsDict(TypedDict):
        expected_value: pulumi.Input[builtins.str]
        """
        ...
        """
        property_path: pulumi.Input[builtins.str]
        """
        The JPath of the entity model property that should be checked.
        """
        property_type: pulumi.Input[builtins.str]
        """
...
class AutomationSourceRuleSetRuleArgs:
    def __init__(__self__, *,
                 ...
                 property_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] expected_value: A value that will be compared with the value in `property_path`.
        :param pulumi.Input[builtins.str] operator: The comparison operator to use, must be one of: `Contains`, `EndsWith`, `Equals`, `GreaterThan`, `GreaterThanOrEqualTo`, `LesserThan`, `LesserThanOrEqualTo`, `NotEquals`, `StartsWith`
    ...
    def expected_value(self) -> pulumi.Input[builtins.str]:
        """
        A value that will be compared with the value in `property_path`.
        """
    ...
    def expected_value(self, value: pulumi.Input[builtins.str]):
    ...
    def property_path(self) -> pulumi.Input[builtins.str]:
        """
        The JPath of the entity model property that should be checked.
        """
    ...
    def property_path(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "property_path", value)

    @property
    @pulumi.getter(name="propertyType")
    def property_type(self) -> pulumi.Input[builtins.str]:
        """
        The data type of the compared operands, must be one of: `Integer`, `String`, `Boolean` or `Number`.
    ...
    def property_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class SubscriptionPricingExtensionArgsDict(TypedDict):
        ...
        """
        additional_extension_properties: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class SubscriptionPricingExtensionArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 additional_extension_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    def additional_extension_properties(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Key/Value pairs that are required for some extensions.
    ...
    def additional_extension_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
