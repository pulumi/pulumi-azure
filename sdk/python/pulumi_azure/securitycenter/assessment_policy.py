...
class AssessmentPolicyArgs:
    def __init__(__self__, *,
                 ...
                 implementation_effort: Optional[pulumi.Input[builtins.str]] = None,
                 remediation_description: Optional[pulumi.Input[builtins.str]] = None,
                 severity: Optional[pulumi.Input[builtins.str]] = None,
                 threats: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 user_impact: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AssessmentPolicy resource.
        :param pulumi.Input[builtins.str] description: The description of the Security Center Assessment.
        :param pulumi.Input[builtins.str] display_name: The user-friendly display name of the Security Center Assessment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] categories: A list of the categories of resource that is at risk when the Security Center Assessment is unhealthy. Possible values are `Unknown`, `Compute`, `Data`, `IdentityAndAccess`, `IoT` and `Networking`.
        :param pulumi.Input[builtins.str] implementation_effort: The implementation effort which is used to remediate the Security Center Assessment. Possible values are `Low`, `Moderate` and `High`.
        :param pulumi.Input[builtins.str] remediation_description: The description which is used to mitigate the security issue.
        :param pulumi.Input[builtins.str] severity: The severity level of the Security Center Assessment. Possible values are `Low`, `Medium` and `High`. Defaults to `Medium`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] threats: A list of the threat impacts for the Security Center Assessment. Possible values are `AccountBreach`, `DataExfiltration`, `DataSpillage`, `DenialOfService`, `ElevationOfPrivilege`, `MaliciousInsider`, `MissingCoverage` and `ThreatResistance`.
        :param pulumi.Input[builtins.str] user_impact: The user impact of the Security Center Assessment. Possible values are `Low`, `Moderate` and `High`.
        """
    ...
    def implementation_effort(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def implementation_effort(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def threats(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @threats.setter
    def threats(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "threats", value)

    @property
    @pulumi.getter(name="userImpact")
    def user_impact(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @user_impact.setter
    def user_impact(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AssessmentPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly display name of the Security Center Assessment.
        :param pulumi.Input[builtins.str] implementation_effort: The implementation effort which is used to remediate the Security Center Assessment. Possible values are `Low`, `Moderate` and `High`.
        :param pulumi.Input[builtins.str] name: The GUID as the name of the Security Center Assessment Policy.
        :param pulumi.Input[builtins.str] remediation_description: The description which is used to mitigate the security issue.
        :param pulumi.Input[builtins.str] severity: The severity level of the Security Center Assessment. Possible values are `Low`, `Medium` and `High`. Defaults to `Medium`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] threats: A list of the threat impacts for the Security Center Assessment. Possible values are `AccountBreach`, `DataExfiltration`, `DataSpillage`, `DenialOfService`, `ElevationOfPrivilege`, `MaliciousInsider`, `MissingCoverage` and `ThreatResistance`.
        :param pulumi.Input[builtins.str] user_impact: The user impact of the Security Center Assessment. Possible values are `Low`, `Moderate` and `High`.
...
class AssessmentPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "azure:securitycenter/assessmentPolicy:AssessmentPolicy"
    ...
    def get(resource_name: str,
            ...
            severity: Optional[pulumi.Input[builtins.str]] = None,
            threats: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user_impact: Optional[pulumi.Input[builtins.str]] = None) -> 'AssessmentPolicy':
        """
