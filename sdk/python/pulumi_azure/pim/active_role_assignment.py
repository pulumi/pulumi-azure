...
class ActiveRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] principal_id: Object ID of the principal for this role assignment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] role_definition_id: The role definition ID for this role assignment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] scope: The scope for this role assignment, should be a valid resource ID. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] justification: The justification for the role assignment. Changing this forces a new resource to be created.
