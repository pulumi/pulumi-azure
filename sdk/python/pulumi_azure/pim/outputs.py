...
class ActiveRoleAssignmentSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str start_date_time: The start date/time of the role assignment. Changing this forces a new resource to be created.
        """
...
class ActiveRoleAssignmentScheduleExpiration(dict):
    ...
    def __init__(__self__, *,
                 duration_days: Optional[_builtins.int] = None,
                 duration_hours: Optional[_builtins.int] = None,
                 end_date_time: Optional[_builtins.str] = None):
        """
        :param _builtins.int duration_days: The duration of the role assignment in days. Changing this forces a new resource to be created.
        :param _builtins.int duration_hours: The duration of the role assignment in hours. Changing this forces a new resource to be created.
        :param _builtins.str end_date_time: The end date/time of the role assignment. Changing this forces a new resource to be created.
    ...
    def duration_days(self) -> Optional[_builtins.int]:
        """
...
class ActiveRoleAssignmentTicket(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str number: User-supplied ticket number to be included with the request. Changing this forces a new resource to be created.
        :param _builtins.str system: User-supplied ticket system name to be included with the request. Changing this forces a new resource to be created.
        """
...
class RoleManagementPolicyActivationRules(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str required_conditional_access_authentication_context: The Entra ID Conditional Access context that must be present for activation. Conflicts with `require_multifactor_authentication`.
        """
...
class RoleManagementPolicyActivationRulesApprovalStage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['RoleManagementPolicyActivationRulesApprovalStagePrimaryApproverArgs'] primary_approvers: One or more `primary_approver` blocks as defined below.
        """
...
class RoleManagementPolicyActivationRulesApprovalStagePrimaryApprover(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The type of object acting as an approver. Possible options are `User` and `Group`.
        """
...
class GetRoleAssignmentsRoleAssignmentResult(dict):
    def __init__(__self__, *,
                 ...
                 delegated_managed_identity_resource_id: _builtins.str,
                 description: _builtins.str,
                 principal_id: _builtins.str,
                 principal_type: _builtins.str,
                 role_assignment_id: _builtins.str,
                 role_assignment_name: _builtins.str,
                 role_assignment_scope: _builtins.str,
                 role_definition_id: _builtins.str):
        """
        :param _builtins.str condition: The condition that limits the resource the role can be assigned to.
        :param _builtins.str condition_version: The version of the condition.
        :param _builtins.str delegated_managed_identity_resource_id: The ID of the delegated managed identity resource.
        :param _builtins.str description: The description for this Role Assignment.
        :param _builtins.str principal_id: The principal ID to filter the list of Role Assignments against.
        :param _builtins.str principal_type: The type of the `principal_id`.
        :param _builtins.str role_assignment_id: The ID of the Role Assignment.
        :param _builtins.str role_assignment_name: The name of the Role Assignment.
        :param _builtins.str role_assignment_scope: The scope of the Role Assignment.
    ...
    def delegated_managed_identity_resource_id(self) -> _builtins.str:
        """
    ...
    def role_assignment_id(self) -> _builtins.str:
        """
    ...
    def role_assignment_name(self) -> _builtins.str:
        """
    ...
    def role_assignment_scope(self) -> _builtins.str:
        """
...
class GetRoleManagementPolicyActivationRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 maximum_duration: _builtins.str,
                 require_approval: _builtins.bool,
                 require_justification: _builtins.bool,
                 require_multifactor_authentication: _builtins.bool,
                 require_ticket_info: _builtins.bool,
                 required_conditional_access_authentication_context: _builtins.str):
        """
        ...
        :param _builtins.str maximum_duration: (String) The maximum length of time an activated role can be valid, in an ISO8601 Duration format.
        :param _builtins.bool require_approval: (Boolean) Is approval required for activation.
        :param _builtins.bool require_justification: (Boolean) Is a justification required to create new assignments.
        :param _builtins.bool require_multifactor_authentication: (Boolean) Is multi-factor authentication required to create new assignments.
        :param _builtins.bool require_ticket_info: (Boolean) Is ticket information required to create new assignments.
        :param _builtins.str required_conditional_access_authentication_context: (String) The Entra ID Conditional Access context that must be present for activation.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="maximumDuration")
    def maximum_duration(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requireApproval")
    def require_approval(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requireJustification")
    def require_justification(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requireMultifactorAuthentication")
    def require_multifactor_authentication(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requireTicketInfo")
    def require_ticket_info(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requiredConditionalAccessAuthenticationContext")
    def required_conditional_access_authentication_context(self) -> _builtins.str:
        """
...
class GetRoleManagementPolicyActivationRuleApprovalStagePrimaryApproverResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.str object_id: (String) The ID of the object which will act as an approver.
        :param _builtins.str type: (String) The type of object acting as an approver. Either `User` or `Group`.
        """
        pulumi.set(__self__, "object_id", object_id)
        pulumi.set(__self__, "type", type)
...
class GetRoleManagementPolicyActiveAssignmentRuleResult(dict):
    def __init__(__self__, *,
                 expiration_required: _builtins.bool,
                 expire_after: _builtins.str,
                 require_justification: _builtins.bool,
                 require_multifactor_authentication: _builtins.bool,
                 require_ticket_info: _builtins.bool):
        """
        :param _builtins.bool expiration_required: (Boolean) Must an assignment have an expiry date.
        :param _builtins.str expire_after: (String) The maximum length of time an assignment can be valid, as an ISO8601 duration.
        :param _builtins.bool require_justification: (Boolean) Is a justification required to create new assignments.
        :param _builtins.bool require_multifactor_authentication: (Boolean) Is multi-factor authentication required to create new assignments.
        :param _builtins.bool require_ticket_info: (Boolean) Is ticket information required to create new assignments.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="expirationRequired")
    def expiration_required(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="expireAfter")
    def expire_after(self) -> _builtins.str:
        """
...
class GetRoleManagementPolicyNotificationRuleActiveAssignmentAdminNotificationResult(dict):
    def __init__(__self__, *,
                 ...
                 notification_level: _builtins.str):
        """
        :param Sequence[_builtins.str] additional_recipients: A list of additional email addresses that will receive these notifications.
        :param _builtins.bool default_recipients: (Boolean) Should the default recipients receive these notifications.
        :param _builtins.str notification_level: (String) What level of notifications should be sent. Either `All` or `Critical`.
        """
        pulumi.set(__self__, "additional_recipients", additional_recipients)
        pulumi.set(__self__, "default_recipients", default_recipients)
        pulumi.set(__self__, "notification_level", notification_level)
