...
class EligibleRoleAssignment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            schedule = _utilities.configure(schedule, EligibleRoleAssignmentScheduleArgs, True)
            __props__.__dict__["schedule"] = schedule
            if scope is None and not opts.urn:
                raise TypeError("Missing required property 'scope'")
            __props__.__dict__["scope"] = scope
            ticket = _utilities.configure(ticket, EligibleRoleAssignmentTicketArgs, True)
