...
def get_role_management_policy(role_definition_id: Optional[builtins.str] = None,
...
def get_role_management_policy_output(role_definition_id: Optional[pulumi.Input[builtins.str]] = None,
