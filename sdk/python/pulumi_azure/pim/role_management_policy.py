...
class RoleManagementPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_definition_id: The scoped Role Definition ID of the role for which this policy will apply. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] scope: The scope to which this Role Management Policy will apply. Can refer to a management group, a subscription, a resource group or a resource. Changing this forces a new resource to be created.
...
class _RoleManagementPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RoleManagementPolicyEligibleAssignmentRulesArgs'] eligible_assignment_rules: An `eligible_assignment_rules` block as defined below.
        :param pulumi.Input[builtins.str] name: (String) The name of this policy, which is typically a UUID and may change over time.
        :param pulumi.Input['RoleManagementPolicyNotificationRulesArgs'] notification_rules: A `notification_rules` block as defined below.
        :param pulumi.Input[builtins.str] role_definition_id: The scoped Role Definition ID of the role for which this policy will apply. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] scope: The scope to which this Role Management Policy will apply. Can refer to a management group, a subscription, a resource group or a resource. Changing this forces a new resource to be created.
        """
...
class RoleManagementPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            notification_rules: Optional[pulumi.Input[Union['RoleManagementPolicyNotificationRulesArgs', 'RoleManagementPolicyNotificationRulesArgsDict']]] = None,
            role_definition_id: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'RoleManagementPolicy':
        """
