...
class MonitorTagRuleArgs:
    def __init__(__self__, *,
                 datadog_monitor_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] datadog_monitor_id: The Datadog Monitor Id which should be used for this Datadog Monitor Tag Rule. Changing this forces a new Datadog Monitor Tag Rule to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Tag Rules configuration. The allowed value is `default`. Defaults to `default`.
        """
    ...
    def datadog_monitor_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def datadog_monitor_id(self, value: pulumi.Input[builtins.str]):
...
class _MonitorTagRuleState:
    def __init__(__self__, *,
                 datadog_monitor_id: Optional[pulumi.Input[builtins.str]] = None,
                 logs: Optional[pulumi.Input[Sequence[pulumi.Input['MonitorTagRuleLogArgs']]]] = None,
                 metrics: Optional[pulumi.Input[Sequence[pulumi.Input['MonitorTagRuleMetricArgs']]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="datadogMonitorId")
    def datadog_monitor_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Datadog Monitor Id which should be used for this Datadog Monitor Tag Rule. Changing this forces a new Datadog Monitor Tag Rule to be created.
        """
        return pulumi.get(self, "datadog_monitor_id")
    ...
    @datadog_monitor_id.setter
    def datadog_monitor_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "datadog_monitor_id", value)
...
class MonitorTagRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            logs: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MonitorTagRuleLogArgs', 'MonitorTagRuleLogArgsDict']]]]] = None,
            metrics: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MonitorTagRuleMetricArgs', 'MonitorTagRuleMetricArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'MonitorTagRule':
        """
    ...
    @property
    @pulumi.getter(name="datadogMonitorId")
    def datadog_monitor_id(self) -> pulumi.Output[builtins.str]:
        """
        The Datadog Monitor Id which should be used for this Datadog Monitor Tag Rule. Changing this forces a new Datadog Monitor Tag Rule to be created.
        """
        return pulumi.get(self, "datadog_monitor_id")
