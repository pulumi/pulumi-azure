...
class MonitorDatadogOrganizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] enterprise_app_id: The ID of the enterprise_app. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] id: The ID of the Datadog Monitor.
        :param pulumi.Input[_builtins.str] linking_auth_code: The auth code used to linking to an existing Datadog organization. Changing this forces a new Datadog Monitor to be created.
        :param pulumi.Input[_builtins.str] linking_client_id: The ID of the linking_client. Changing this forces a new Datadog Monitor to be created.
        ...
        :param pulumi.Input[_builtins.str] redirect_uri: The redirect uri for linking. Changing this forces a new Datadog Monitor to be created.
        """
...
class MonitorIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Specifies the identity type of the Datadog Monitor. At this time the only allowed value is `SystemAssigned`.
               ...
               > **Note:** The assigned `principal_id` and `tenant_id` can be retrieved after the identity `type` has been set to `SystemAssigned` and the Datadog Monitor has been created. More details are available below.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID for the Service Principal associated with the Identity of this Datadog Monitor.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Datadog Monitor.
        """
...
class MonitorTagRuleLogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MonitorTagRuleLogFilterArgs']]] filters: A `filter` block as defined below.
               ...
               > **Note:** List of filtering tags to be used for capturing logs. This only takes effect if `resource_log_enabled` flag is enabled. If empty, all resources will be captured. If only Exclude action is specified, the rules will apply to the list of all available resources. If Include actions are specified, the rules will only include resources with the associated tags.
        :param pulumi.Input[_builtins.bool] resource_log_enabled: Whether Azure resource logs should be sent for the Monitor resource?
        :param pulumi.Input[_builtins.bool] subscription_log_enabled: Whether Azure subscription logs should be sent for the Monitor resource?
        """
...
class MonitorTagRuleLogFilterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] action: Allowed values Include or Exclude.
        :param pulumi.Input[_builtins.str] name: Name of the Tag.
...
class MonitorUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] phone_number: Phone number of the user used by Datadog for contacting them if needed. Changing this forces a new resource to be created.
        """
