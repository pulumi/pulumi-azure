...
class GetFrontdoorFirewallPolicyResult:
    ...
    def frontend_endpoint_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def js_challenge_cookie_expiration_in_minutes(self) -> builtins.int:
        """
...
def get_frontdoor_firewall_policy(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Front Door Firewall Policy.
...
def get_frontdoor_firewall_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
