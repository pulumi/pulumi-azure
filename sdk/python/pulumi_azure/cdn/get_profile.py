...
def get_profile(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the CDN Profile.
    :param _builtins.str resource_group_name: The name of the resource group in which the CDN Profile exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_profile_output(name: pulumi.Input[Optional[_builtins.str]] = None,
