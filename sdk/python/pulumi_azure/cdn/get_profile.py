...
def get_profile(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the CDN Profile.
    :param builtins.str resource_group_name: The name of the resource group in which the CDN Profile exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_profile_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:cdn/getProfile:getProfile', __args__, opts=opts, typ=GetProfileResult)
