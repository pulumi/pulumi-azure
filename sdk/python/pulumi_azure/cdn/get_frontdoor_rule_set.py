...
def get_frontdoor_rule_set(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Cdn`: 2024-02-01
    ...
    :param builtins.str resource_group_name: Specifies the name of the Resource Group where the Front Door Profile exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_frontdoor_rule_set_output(name: Optional[pulumi.Input[builtins.str]] = None,
