...
class EndpointCustomDomainArgs:
    def __init__(__self__, *,
                 cdn_endpoint_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] cdn_endpoint_id: The ID of the CDN Endpoint. Changing this forces a new CDN Endpoint Custom Domain to be created.
        :param pulumi.Input[builtins.str] host_name: The host name of the custom domain. Changing this forces a new CDN Endpoint Custom Domain to be created.
    ...
    def cdn_endpoint_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cdn_endpoint_id(self, value: pulumi.Input[builtins.str]):
...
class _EndpointCustomDomainState:
    def __init__(__self__, *,
                 cdn_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                 cdn_managed_https: Optional[pulumi.Input['EndpointCustomDomainCdnManagedHttpsArgs']] = None,
    ...
    @property
    @pulumi.getter(name="cdnEndpointId")
    def cdn_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the CDN Endpoint. Changing this forces a new CDN Endpoint Custom Domain to be created.
        """
        return pulumi.get(self, "cdn_endpoint_id")
    ...
    @cdn_endpoint_id.setter
    def cdn_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cdn_endpoint_id", value)
...
class EndpointCustomDomain(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cdnEndpointId")
    def cdn_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the CDN Endpoint. Changing this forces a new CDN Endpoint Custom Domain to be created.
        """
        return pulumi.get(self, "cdn_endpoint_id")
