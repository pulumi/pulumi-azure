...
class EndpointCustomDomainCdnManagedHttps(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_type: The type of HTTPS certificate. Possible values are `Shared` and `Dedicated`.
        :param builtins.str protocol_type: The type of protocol. Possible values are `ServerNameIndication` and `IPBased`.
        :param builtins.str tls_version: The minimum TLS protocol version that is used for HTTPS. Possible values are `TLS10` (representing TLS 1.0/1.1), `TLS12` (representing TLS 1.2) and `None` (representing no minimums). Defaults to `TLS12`.
...
class EndpointCustomDomainUserManagedHttps(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tls_version: Optional[builtins.str] = None):
        """
        :param builtins.str key_vault_secret_id: The ID of the Key Vault Secret that contains the HTTPS certificate.
        :param builtins.str tls_version: The minimum TLS protocol version that is used for HTTPS. Possible values are `TLS10` (representing TLS 1.0/1.1), `TLS12` (representing TLS 1.2) and `None` (representing no minimums). Defaults to `TLS12`.
...
class EndpointDeliveryRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The Name which should be used for this Delivery Rule.
        :param builtins.int order: The order used for this rule. The order values should be sequential and begin at `1`.
...
class EndpointDeliveryRuleCacheExpirationAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str behavior: The behavior of the cache. Valid values are `BypassCache`, `Override` and `SetIfMissing`.
        :param builtins.str duration: Duration of the cache. Only allowed when `behavior` is set to `Override` or `SetIfMissing`. Format: `[d.]hh:mm:ss`
        """
...
class EndpointDeliveryRuleCacheKeyQueryStringAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str behavior: The behavior of the cache key for query strings. Valid values are `Exclude`, `ExcludeAll`, `Include` and `IncludeAll`.
        :param builtins.str parameters: Comma separated list of parameter values.
        """
        pulumi.set(__self__, "behavior", behavior)
...
class EndpointDeliveryRuleCookiesCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        :param builtins.str selector: Name of the cookie.
        :param Sequence[builtins.str] match_values: List of values for the cookie. This is required if `operator` is not `Any`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param Sequence[builtins.str] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
...
class EndpointDeliveryRuleDeviceCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] match_values: Valid values are `Desktop` and `Mobile`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param builtins.str operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
        if negate_condition is not None:
            pulumi.set(__self__, "negate_condition", negate_condition)
...
class EndpointDeliveryRuleHttpVersionCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: Valid values are `0.9`, `1.0`, `1.1` and `2.0`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param builtins.str operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class EndpointDeliveryRuleModifyRequestHeaderAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: Action to be executed on a header value. Valid values are `Append`, `Delete` and `Overwrite`.
        :param builtins.str name: The header name.
        :param builtins.str value: The value of the header. Only needed when `action` is set to `Append` or `overwrite`.
        """
...
class EndpointDeliveryRulePostArgCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        :param builtins.str selector: Name of the post arg.
        :param Sequence[builtins.str] match_values: List of string values. This is required if `operator` is not `Any`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param Sequence[builtins.str] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
        pulumi.set(__self__, "operator", operator)
...
class EndpointDeliveryRuleRemoteAddressCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 negate_condition: Optional[builtins.bool] = None):
        """
        :param builtins.str operator: Valid values are `Any`, `GeoMatch` and `IPMatch`.
        :param Sequence[builtins.str] match_values: List of string values. For `GeoMatch` `operator` this should be a list of country codes (e.g. `US` or `DE`). List of IP address if `operator` equals to `IPMatch`. This is required if `operator` is not `Any`.
        :param builtins.bool negate_condition: Defaults to `false`.
        """
        pulumi.set(__self__, "operator", operator)
        if match_values is not None:
...
class EndpointDeliveryRuleRequestHeaderCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        :param builtins.str selector: Header name.
        :param Sequence[builtins.str] match_values: List of header values. This is required if `operator` is not `Any`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param Sequence[builtins.str] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
        pulumi.set(__self__, "operator", operator)
...
class EndpointDeliveryRuleRequestMethodCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: Valid values are `DELETE`, `GET`, `HEAD`, `OPTIONS`, `POST` and `PUT`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param builtins.str operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class EndpointDeliveryRuleRequestSchemeCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: Valid values are `HTTP` and `HTTPS`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param builtins.str operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class EndpointDeliveryRuleUrlPathCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan`, `LessThanOrEqual`, `RegEx` and `Wildcard`.
        :param Sequence[builtins.str] match_values: List of string values. This is required if `operator` is not `Any`.
        :param builtins.bool negate_condition: Defaults to `false`.
        :param Sequence[builtins.str] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
...
class EndpointDeliveryRuleUrlRedirectAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fragment: Optional[builtins.str] = None,
                 hostname: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None,
                 protocol: Optional[builtins.str] = None,
                 query_string: Optional[builtins.str] = None):
        """
        :param builtins.str redirect_type: Type of the redirect. Valid values are `Found`, `Moved`, `PermanentRedirect` and `TemporaryRedirect`.
        :param builtins.str fragment: Specifies the fragment part of the URL. This value must not start with a `#`.
        :param builtins.str hostname: Specifies the hostname part of the URL.
        :param builtins.str path: Specifies the path part of the URL. This value must begin with a `/`.
        :param builtins.str protocol: Specifies the protocol part of the URL. Valid values are `MatchRequest`, `Http` and `Https`. Defaults to `MatchRequest`.
        :param builtins.str query_string: Specifies the query string part of the URL. This value must not start with a `?` or `&` and must be in `<key>=<value>` format separated by `&`.
        """
    ...
    @property
    @pulumi.getter
    def fragment(self) -> Optional[builtins.str]:
        """
...
class EndpointDeliveryRuleUrlRewriteAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str destination: This value must start with a `/` and can't be longer than 260 characters.
        :param builtins.str source_pattern: This value must start with a `/` and can't be longer than 260 characters.
        :param builtins.bool preserve_unmatched_path: Whether preserve an unmatched path. Defaults to `true`.
        """
...
class EndpointGeoFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The Action of the Geo Filter. Possible values include `Allow` and `Block`.
        :param Sequence[builtins.str] country_codes: A List of two letter country codes (e.g. `US`, `GB`) to be associated with this Geo Filter.
        :param builtins.str relative_path: The relative path applicable to geo filter.
        """
        pulumi.set(__self__, "action", action)
...
class EndpointOrigin(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host_name: A string that determines the hostname/IP address of the origin server. This string can be a domain name, Storage Account endpoint, Web App endpoint, IPv4 address or IPv6 address. Changing this forces a new resource to be created.
        :param builtins.str name: The name of the origin. This is an arbitrary value. However, this value needs to be unique under the endpoint. Changing this forces a new resource to be created.
        :param builtins.int http_port: The HTTP port of the origin. Defaults to `80`. Changing this forces a new resource to be created.
        :param builtins.int https_port: The HTTPS port of the origin. Defaults to `443`. Changing this forces a new resource to be created.
        """
...
class FrontdoorCustomDomainTls(dict):
    ...
    def __init__(__self__, *,
                 cdn_frontdoor_secret_id: Optional[builtins.str] = None,
                 certificate_type: Optional[builtins.str] = None,
                 minimum_tls_version: Optional[builtins.str] = None):
        """
        :param builtins.str cdn_frontdoor_secret_id: Resource ID of the Front Door Secret.
        :param builtins.str certificate_type: Defines the source of the SSL certificate. Possible values include `CustomerCertificate` and `ManagedCertificate`. Defaults to `ManagedCertificate`.
               
               > **Note:** It may take up to 15 minutes for the Front Door Service to validate the state and Domain ownership of the Custom Domain.
        :param builtins.str minimum_tls_version: TLS protocol version that will be used for Https. Possible values are `TLS12`. Defaults to `TLS12`.
    ...
    def cdn_frontdoor_secret_id(self) -> Optional[builtins.str]:
        """
...
class FrontdoorFirewallPolicyCustomRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to perform when the rule is matched. Possible values are `Allow`, `Block`, `Log`, `Redirect`, or `JSChallenge`.
...
class FrontdoorFirewallPolicyCustomRuleMatchCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] match_values: Up to `600` possible values to match. Limit is in total across all `match_condition` blocks and `match_values` arguments. String value itself can be up to `256` characters in length.
...
class FrontdoorFirewallPolicyLogScrubbing(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enabled: Is log scrubbing enabled? Possible values are `true` or `false`. Defaults to `true`.
        """
...
class FrontdoorFirewallPolicyLogScrubbingScrubbingRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 selector: Optional[builtins.str] = None):
        """
        :param builtins.str match_variable: The variable to be scrubbed from the logs. Possible values include `QueryStringArgNames`, `RequestBodyJsonArgNames`, `RequestBodyPostArgNames`, `RequestCookieNames`, `RequestHeaderNames`, `RequestIPAddress`, or `RequestUri`.
               
               > **Note:** `RequestIPAddress` and `RequestUri` must use the `EqualsAny` `operator`.
        :param builtins.bool enabled: Is this `scrubbing_rule` enabled? Defaults to `true`.
        :param builtins.str operator: When the `match_variable` is a collection, operate on the `selector` to specify which elements in the collection this `scrubbing_rule` applies to. Possible values are `Equals` or `EqualsAny`. Defaults to `Equals`.
        :param builtins.str selector: When the `match_variable` is a collection, the `operator` is used to specify which elements in the collection this `scrubbing_rule` applies to.
...
class FrontdoorFirewallPolicyManagedRule(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to perform for all default rule set rules when the managed rule is matched or when the anomaly score is 5 or greater depending on which version of the default rule set you are using. Possible values include `Allow`, `Log`, `Block`, or `Redirect`.
        :param builtins.str type: The name of the managed rule to use with this resource. Possible values include `DefaultRuleSet`, `Microsoft_DefaultRuleSet`, `BotProtection`, or `Microsoft_BotManagerRuleSet`.
        :param builtins.str version: The version of the managed rule to use with this resource. Possible values depends on which default rule set type you are using, for the `DefaultRuleSet` type the possible values include `1.0` or `preview-0.1`. For `Microsoft_DefaultRuleSet` the possible values include `1.1`, `2.0`, or `2.1`. For `BotProtection` the value must be `preview-0.1` and for `Microsoft_BotManagerRuleSet` the possible values include `1.0` and `1.1`.
...
class FrontdoorFirewallPolicyManagedRuleExclusion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 selector: builtins.str):
        """
        :param builtins.str match_variable: The variable type to be excluded. Possible values are `QueryStringArgNames`, `RequestBodyPostArgNames`, `RequestCookieNames`, `RequestHeaderNames`, `RequestBodyJsonArgNames`
               
               > **Note:** `RequestBodyJsonArgNames` is only available on Default Rule Set (DRS) 2.0 or later
        :param builtins.str operator: Comparison operator to apply to the selector when specifying which elements in the collection this exclusion applies to. Possible values are: `Equals`, `Contains`, `StartsWith`, `EndsWith`, or `EqualsAny`.
...
class FrontdoorFirewallPolicyManagedRuleOverrideRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to be applied when the managed rule matches or when the anomaly score is 5 or greater. Possible values for `DefaultRuleSet 1.1` and below are `Allow`, `Log`, `Block`, or `Redirect`. Possible values for `DefaultRuleSet 2.0` and above are `Log` or `AnomalyScoring`. Possible values for `Microsoft_BotManagerRuleSet` are `Allow`, `Log`, `Block`, `Redirect`, or `JSChallenge`.
...
class FrontdoorOriginGroupHealthProbe(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int interval_in_seconds: Specifies the number of seconds between health probes. Possible values are between `1` and `255` seconds (inclusive).
        :param builtins.str protocol: Specifies the protocol to use for health probe. Possible values are `Http` and `Https`.
        :param builtins.str path: Specifies the path relative to the origin that is used to determine the health of the origin. Defaults to `/`.
        ...
        :param builtins.str request_type: Specifies the type of health probe request that is made. Possible values are `GET` and `HEAD`. Defaults to `HEAD`.
        """
...
class FrontdoorOriginGroupLoadBalancing(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int additional_latency_in_milliseconds: Specifies the additional latency in milliseconds for probes to fall into the lowest latency bucket. Possible values are between `0` and `1000` milliseconds (inclusive). Defaults to `50`.
        :param builtins.int sample_size: Specifies the number of samples to consider for load balancing decisions. Possible values are between `0` and `255` (inclusive). Defaults to `4`.
        :param builtins.int successful_samples_required: Specifies the number of samples within the sample period that must succeed. Possible values are between `0` and `255` (inclusive). Defaults to `3`.
        """
...
class FrontdoorOriginPrivateLink(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str location: Specifies the location where the Private Link resource should exist. Changing this forces a new resource to be created.
        :param builtins.str private_link_target_id: The ID of the Azure Resource to connect to via the Private Link.
        ...
        :param builtins.str request_message: Specifies the request message that will be submitted to the `private_link_target_id` when requesting the private link endpoint connection. Values must be between `1` and `140` characters in length. Defaults to `Access request for CDN FrontDoor Private Link Origin`.
        :param builtins.str target_type: Specifies the type of target for this Private Link Endpoint. Possible values are `blob`, `blob_secondary`, `Gateway`, `managedEnvironments`, `sites`, `web` and `web_secondary`.
...
class FrontdoorProfileIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of managed identity to assign. Possible values are `SystemAssigned`, `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param Sequence[builtins.str] identity_ids: A list of one or more Resource IDs for User Assigned Managed identities to assign. Required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        """
        pulumi.set(__self__, "type", type)
...
class FrontdoorRouteCache(dict):
    ...
    def __init__(__self__, *,
                 ...
                 content_types_to_compresses: Optional[Sequence[builtins.str]] = None,
                 query_string_caching_behavior: Optional[builtins.str] = None,
                 query_strings: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool compression_enabled: Is content compression enabled? Possible values are `true` or `false`. Defaults to `false`.
               
               > **Note:** Content won't be compressed when the requested content is smaller than `1 KB` or larger than `8 MB`(inclusive).
        :param Sequence[builtins.str] content_types_to_compresses: A list of one or more `Content types` (formerly known as `MIME types`) to compress. Possible values include `application/eot`, `application/font`, `application/font-sfnt`, `application/javascript`, `application/json`, `application/opentype`, `application/otf`, `application/pkcs7-mime`, `application/truetype`, `application/ttf`, `application/vnd.ms-fontobject`, `application/xhtml+xml`, `application/xml`, `application/xml+rss`, `application/x-font-opentype`, `application/x-font-truetype`, `application/x-font-ttf`, `application/x-httpd-cgi`, `application/x-mpegurl`, `application/x-opentype`, `application/x-otf`, `application/x-perl`, `application/x-ttf`, `application/x-javascript`, `font/eot`, `font/ttf`, `font/otf`, `font/opentype`, `image/svg+xml`, `text/css`, `text/csv`, `text/html`, `text/javascript`, `text/js`, `text/plain`, `text/richtext`, `text/tab-separated-values`, `text/xml`, `text/x-script`, `text/x-component` or `text/x-java-source`.
        :param builtins.str query_string_caching_behavior: Defines how the Front Door Route will cache requests that include query strings. Possible values include `IgnoreQueryString`, `IgnoreSpecifiedQueryStrings`, `IncludeSpecifiedQueryStrings` or `UseQueryString`. Defaults to `IgnoreQueryString`.
        ...
        :param Sequence[builtins.str] query_strings: Query strings to include or ignore.
        """
    ...
    def content_types_to_compresses(self) -> Optional[Sequence[builtins.str]]:
        """
        A list of one or more `Content types` (formerly known as `MIME types`) to compress. Possible values include `application/eot`, `application/font`, `application/font-sfnt`, `application/javascript`, `application/json`, `application/opentype`, `application/otf`, `application/pkcs7-mime`, `application/truetype`, `application/ttf`, `application/vnd.ms-fontobject`, `application/xhtml+xml`, `application/xml`, `application/xml+rss`, `application/x-font-opentype`, `application/x-font-truetype`, `application/x-font-ttf`, `application/x-httpd-cgi`, `application/x-mpegurl`, `application/x-opentype`, `application/x-otf`, `application/x-perl`, `application/x-ttf`, `application/x-javascript`, `font/eot`, `font/ttf`, `font/otf`, `font/opentype`, `image/svg+xml`, `text/css`, `text/csv`, `text/html`, `text/javascript`, `text/js`, `text/plain`, `text/richtext`, `text/tab-separated-values`, `text/xml`, `text/x-script`, `text/x-component` or `text/x-java-source`.
        """
...
class FrontdoorRuleActionsRequestHeaderAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str header_action: The action to be taken on the specified `header_name`. Possible values include `Append`, `Overwrite` or `Delete`.
        ...
        :param builtins.str header_name: The name of the header to modify.
        :param builtins.str value: The value to append or overwrite.
...
class FrontdoorRuleActionsRouteConfigurationOverrideAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cdn_frontdoor_origin_group_id: Optional[builtins.str] = None,
                 compression_enabled: Optional[builtins.bool] = None,
                 forwarding_protocol: Optional[builtins.str] = None,
                 query_string_caching_behavior: Optional[builtins.str] = None,
                 query_string_parameters: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str cache_behavior: `HonorOrigin` the Front Door will always honor origin response header directive. If the origin directive is missing, Front Door will cache contents anywhere from `1` to `3` days. `OverrideAlways` the TTL value returned from your Front Door Origin is overwritten with the value specified in the action. This behavior will only be applied if the response is cacheable. `OverrideIfOriginMissing` if no TTL value gets returned from your Front Door Origin, the rule sets the TTL to the value specified in the action. This behavior will only be applied if the response is cacheable. `Disabled` the Front Door will not cache the response contents, irrespective of Front Door Origin response directives. Possible values include `HonorOrigin`, `OverrideAlways`, `OverrideIfOriginMissing` or `Disabled`.
        :param builtins.str cache_duration: When Cache behavior is set to `Override` or `SetIfMissing`, this field specifies the cache duration to use. The maximum duration is 366 days specified in the `d.HH:MM:SS` format(e.g. `365.23:59:59`). If the desired maximum cache duration is less than 1 day then the maximum cache duration should be specified in the `HH:MM:SS` format(e.g. `23:59:59`).
        :param builtins.str cdn_frontdoor_origin_group_id: The Front Door Origin Group resource ID that the request should be routed to. This overrides the configuration specified in the Front Door Endpoint route.
        :param builtins.bool compression_enabled: Should the Front Door dynamically compress the content? Possible values include `true` or `false`.
               
               > **Note:** Content won't be compressed on AzureFrontDoor when requested content is smaller than `1 byte` or larger than `1 MB`.
        :param builtins.str forwarding_protocol: The forwarding protocol the request will be redirected as. This overrides the configuration specified in the route to be associated with. Possible values include `MatchRequest`, `HttpOnly` or `HttpsOnly`.
               
               > **Note:** If the `cdn_frontdoor_origin_group_id` is not defined you cannot set the `forwarding_protocol`.
        :param builtins.str query_string_caching_behavior: `IncludeSpecifiedQueryStrings` query strings specified in the `query_string_parameters` field get included when the cache key gets generated. `UseQueryString` cache every unique URL, each unique URL will have its own cache key. `IgnoreSpecifiedQueryStrings` query strings specified in the `query_string_parameters` field get excluded when the cache key gets generated. `IgnoreQueryString` query strings aren't considered when the cache key gets generated. Possible values include `IgnoreQueryString`, `UseQueryString`, `IgnoreSpecifiedQueryStrings` or `IncludeSpecifiedQueryStrings`.
        :param Sequence[builtins.str] query_string_parameters: A list of query string parameter names.
    ...
    def cdn_frontdoor_origin_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def query_string_parameters(self) -> Optional[Sequence[builtins.str]]:
        """
...
class FrontdoorRuleActionsUrlRedirectAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 redirect_type: builtins.str,
                 destination_fragment: Optional[builtins.str] = None,
                 destination_path: Optional[builtins.str] = None,
                 query_string: Optional[builtins.str] = None,
                 redirect_protocol: Optional[builtins.str] = None):
        """
        :param builtins.str destination_hostname: The host name you want the request to be redirected to. The value must be a string between `0` and `2048` characters in length, leave blank to preserve the incoming host.
        :param builtins.str redirect_type: The response type to return to the requestor. Possible values include `Moved`, `Found` , `TemporaryRedirect` or `PermanentRedirect`.
        :param builtins.str destination_fragment: The fragment to use in the redirect. The value must be a string between `0` and `1024` characters in length, leave blank to preserve the incoming fragment. Defaults to `""`.
        :param builtins.str destination_path: The path to use in the redirect. The value must be a string and include the leading `/`, leave blank to preserve the incoming path. Defaults to `""`.
        :param builtins.str query_string: The query string used in the redirect URL. The value must be in the &lt;key>=&lt;value> or &lt;key>={`action_server_variable`} format and must not include the leading `?`, leave blank to preserve the incoming query string. Maximum allowed length for this field is `2048` characters. Defaults to `""`.
        :param builtins.str redirect_protocol: The protocol the request will be redirected as. Possible values include `MatchRequest`, `Http` or `Https`. Defaults to `MatchRequest`.
        """
    ...
    def destination_fragment(self) -> Optional[builtins.str]:
        """
...
class FrontdoorRuleActionsUrlRewriteAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 preserve_unmatched_path: Optional[builtins.bool] = None):
        """
        :param builtins.str destination: The destination path to use in the rewrite. The destination path overwrites the source pattern.
        :param builtins.str source_pattern: The source pattern in the URL path to replace. This uses prefix-based matching. For example, to match all URL paths use a forward slash `"/"` as the source pattern value.
        :param builtins.bool preserve_unmatched_path: Append the remaining path after the source pattern to the new destination path? Possible values `true` or `false`. Defaults to `false`.
        """
        pulumi.set(__self__, "destination", destination)
        pulumi.set(__self__, "source_pattern", source_pattern)
        if preserve_unmatched_path is not None:
...
class FrontdoorRuleConditionsClientPortCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 negate_condition: Optional[builtins.bool] = None):
        """
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: One or more integer values(e.g. "1") representing the value of the client port to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        """
        pulumi.set(__self__, "operator", operator)
        if match_values is not None:
            pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsCookiesCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str cookie_name: A string value representing the name of the cookie.
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: One or more string or integer values(e.g. "1") representing the value of the request header to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
...
class FrontdoorRuleConditionsHostNameCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: A list of one or more string values representing the value of the request hostname to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorRuleConditionsHttpVersionCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: What HTTP version should this condition match? Possible values `2.0`, `1.1`, `1.0` or `0.9`.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param builtins.str operator: Possible value `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
        if negate_condition is not None:
            pulumi.set(__self__, "negate_condition", negate_condition)
...
class FrontdoorRuleConditionsIsDeviceCondition(dict):
    ...
    def __init__(__self__, *,
                 match_values: Optional[builtins.str] = None,
                 negate_condition: Optional[builtins.bool] = None,
                 operator: Optional[builtins.str] = None):
        """
        :param builtins.str match_values: Which device should this rule match on? Possible values `Mobile` or `Desktop`.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param builtins.str operator: Possible value `Equal`. Defaults to `Equal`.
        """
        if match_values is not None:
    ...
    @property
    @pulumi.getter(name="matchValues")
    def match_values(self) -> Optional[builtins.str]:
        """
...
class FrontdoorRuleConditionsPostArgsCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param builtins.str post_args_name: A string value representing the name of the `POST` argument.
        :param Sequence[builtins.str] match_values: One or more string or integer values(e.g. "1") representing the value of the `POST` argument to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorRuleConditionsQueryStringCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: One or more string or integer values(e.g. "1") representing the value of the query string to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorRuleConditionsRemoteAddressCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: For the IP Match or IP Not Match operators: specify one or more IP address ranges. If multiple IP address ranges are specified, they're evaluated using `OR` logic. For the Geo Match or Geo Not Match operators: specify one or more locations using their country code.
               
               > **Note:** See the `Specifying IP Address Ranges` section below on how to correctly define the `match_values` field.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param builtins.str operator: The type of the remote address to match. Possible values include `Any`, `GeoMatch` or `IPMatch`. Use the `negate_condition` to specify Not `GeoMatch` or Not `IPMatch`. Defaults to `IPMatch`.
        """
        if match_values is not None:
            pulumi.set(__self__, "match_values", match_values)
        if negate_condition is not None:
...
class FrontdoorRuleConditionsRequestBodyCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] match_values: A list of one or more string or integer values(e.g. "1") representing the value of the request body text to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
...
class FrontdoorRuleConditionsRequestHeaderCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str header_name: A string value representing the name of the `POST` argument.
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: One or more string or integer values(e.g. "1") representing the value of the request header to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
...
class FrontdoorRuleConditionsRequestMethodCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: A list of one or more HTTP methods. Possible values include `GET`, `POST`, `PUT`, `DELETE`, `HEAD`, `OPTIONS` or `TRACE`. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param builtins.str operator: Possible value `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsRequestSchemeCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param builtins.str match_values: The requests protocol to match. Possible values include `HTTP` or `HTTPS`.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param builtins.str operator: Possible value `Equal`. Defaults to `Equal`.
        """
        if match_values is not None:
...
class FrontdoorRuleConditionsRequestUriCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: One or more string or integer values(e.g. "1") representing the value of the request URL to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorRuleConditionsServerPortCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 negate_condition: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] match_values: A list of one or more integer values(e.g. "1") representing the value of the client port to match. Possible values include `80` or `443`. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsSocketAddressCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: Specify one or more IP address ranges. If multiple IP address ranges are specified, they're evaluated using `OR` logic.
               
               > **Note:** See the `Specifying IP Address Ranges` section below on how to correctly define the `match_values` field.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param builtins.str operator: The type of match. The Possible values are `IpMatch` or `Any`. Defaults to `IPMatch`.
...
class FrontdoorRuleConditionsSslProtocolCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] match_values: A list of one or more HTTP methods. Possible values are `TLSv1`, `TLSv1.1` and `TLSv1.2` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param builtins.str operator: Possible value `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsUrlFileExtensionCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] match_values: A list of one or more string or integer values(e.g. "1") representing the value of the request file extension to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
...
class FrontdoorRuleConditionsUrlFilenameCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: A list of one or more string or integer values(e.g. "1") representing the value of the request file name to match. If multiple values are specified, they're evaluated using `OR` logic.
...
class FrontdoorRuleConditionsUrlPathCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual`, `RegEx` or `Wildcard`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] match_values: One or more string or integer values(e.g. "1") representing the value of the request path to match. Don't include the leading slash (`/`). If multiple values are specified, they're evaluated using `OR` logic.
        :param builtins.bool negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param Sequence[builtins.str] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorSecretSecretCustomerCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_vault_certificate_id: The ID of the Key Vault certificate resource to use. Changing this forces a new Front Door Secret to be created.
        ...
        :param Sequence[builtins.str] subject_alternative_names: One or more `subject alternative names` contained within the key vault certificate.
        """
...
class FrontdoorSecurityPolicySecurityPoliciesFirewall(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str cdn_frontdoor_firewall_policy_id: The Resource Id of the Front Door Firewall Policy that should be linked to this Front Door Security Policy. Changing this forces a new Front Door Security Policy to be created.
        """
...
class FrontdoorSecurityPolicySecurityPoliciesFirewallAssociation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 patterns_to_match: builtins.str):
        """
        ...
        :param builtins.str patterns_to_match: The list of paths to match for this firewall policy. Possible value includes `/*`. Changing this forces a new Front Door Security Policy to be created.
        """
    ...
    def patterns_to_match(self) -> builtins.str:
        """
...
class FrontdoorSecurityPolicySecurityPoliciesFirewallAssociationDomain(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cdn_frontdoor_domain_id: The Resource Id of the **Front Door Custom Domain** or **Front Door Endpoint** that should be bound to this Front Door Security Policy. Changing this forces a new Front Door Security Policy to be created.
        :param builtins.bool active: Is the Front Door Custom Domain/Endpoint activated?
        """
...
class GetFrontdoorCustomDomainTlResult(dict):
    def __init__(__self__, *,
                 cdn_frontdoor_secret_id: builtins.str,
                 certificate_type: builtins.str,
                 minimum_tls_version: builtins.str):
        """
        :param builtins.str cdn_frontdoor_secret_id: The Resource ID of the Front Door Secret.
        :param builtins.str certificate_type: The SSL certificate type.
        :param builtins.str minimum_tls_version: The TLS protocol version that will be used for Https connections.
        """
        pulumi.set(__self__, "cdn_frontdoor_secret_id", cdn_frontdoor_secret_id)
        pulumi.set(__self__, "certificate_type", certificate_type)
        pulumi.set(__self__, "minimum_tls_version", minimum_tls_version)
...
class GetFrontdoorOriginGroupHealthProbeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int interval_in_seconds: Specifies the number of seconds between health probes.
        :param builtins.str path: Specifies the path relative to the origin that is used to determine the health of the origin.
        :param builtins.str protocol: Specifies the protocol to use for health probe.
        :param builtins.str request_type: Specifies the type of health probe request that is made.
        """
        pulumi.set(__self__, "interval_in_seconds", interval_in_seconds)
        pulumi.set(__self__, "path", path)
        pulumi.set(__self__, "protocol", protocol)
...
class GetFrontdoorOriginGroupLoadBalancingResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int additional_latency_in_milliseconds: Specifies the additional latency in milliseconds for probes to fall into the lowest latency bucket.
        :param builtins.int sample_size: Specifies the number of samples to consider for load balancing decisions.
        :param builtins.int successful_samples_required: Specifies the number of samples within the sample period that must succeed.
        """
        pulumi.set(__self__, "additional_latency_in_milliseconds", additional_latency_in_milliseconds)
        pulumi.set(__self__, "sample_size", sample_size)
        pulumi.set(__self__, "successful_samples_required", successful_samples_required)
    ...
    @property
    @pulumi.getter(name="additionalLatencyInMilliseconds")
    def additional_latency_in_milliseconds(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="successfulSamplesRequired")
    def successful_samples_required(self) -> builtins.int:
        """
...
class GetFrontdoorSecretSecretCustomerCertificateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expiration_date: The key vault certificate expiration date.
        :param builtins.str key_vault_certificate_id: The key vault certificate ID.
        :param Sequence[builtins.str] subject_alternative_names: One or more `subject alternative names` contained within the key vault certificate.
        """
