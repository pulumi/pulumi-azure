...
class EndpointCustomDomainCdnManagedHttpsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_type: The type of HTTPS certificate. Possible values are `Shared` and `Dedicated`.
        :param pulumi.Input[builtins.str] protocol_type: The type of protocol. Possible values are `ServerNameIndication` and `IPBased`.
        :param pulumi.Input[builtins.str] tls_version: The minimum TLS protocol version that is used for HTTPS. Possible values are `TLS10` (representing TLS 1.0/1.1), `TLS12` (representing TLS 1.2) and `None` (representing no minimums). Defaults to `TLS12`.
...
class EndpointCustomDomainUserManagedHttpsArgs:
    def __init__(__self__, *,
                 ...
                 tls_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key_vault_secret_id: The ID of the Key Vault Secret that contains the HTTPS certificate.
        :param pulumi.Input[builtins.str] tls_version: The minimum TLS protocol version that is used for HTTPS. Possible values are `TLS10` (representing TLS 1.0/1.1), `TLS12` (representing TLS 1.2) and `None` (representing no minimums). Defaults to `TLS12`.
...
class EndpointDeliveryRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The Name which should be used for this Delivery Rule.
        :param pulumi.Input[builtins.int] order: The order used for this rule. The order values should be sequential and begin at `1`.
...
class EndpointDeliveryRuleCacheExpirationActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] behavior: The behavior of the cache. Valid values are `BypassCache`, `Override` and `SetIfMissing`.
        :param pulumi.Input[builtins.str] duration: Duration of the cache. Only allowed when `behavior` is set to `Override` or `SetIfMissing`. Format: `[d.]hh:mm:ss`
        """
...
class EndpointDeliveryRuleCacheKeyQueryStringActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] behavior: The behavior of the cache key for query strings. Valid values are `Exclude`, `ExcludeAll`, `Include` and `IncludeAll`.
        :param pulumi.Input[builtins.str] parameters: Comma separated list of parameter values.
        """
        pulumi.set(__self__, "behavior", behavior)
...
class EndpointDeliveryRuleCookiesConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        :param pulumi.Input[builtins.str] selector: Name of the cookie.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: List of values for the cookie. This is required if `operator` is not `Any`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
...
class EndpointDeliveryRuleDeviceConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: Valid values are `Desktop` and `Mobile`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[builtins.str] operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
        if negate_condition is not None:
            pulumi.set(__self__, "negate_condition", negate_condition)
...
class EndpointDeliveryRuleHttpVersionConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: Valid values are `0.9`, `1.0`, `1.1` and `2.0`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[builtins.str] operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class EndpointDeliveryRuleModifyRequestHeaderActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: Action to be executed on a header value. Valid values are `Append`, `Delete` and `Overwrite`.
        :param pulumi.Input[builtins.str] name: The header name.
        :param pulumi.Input[builtins.str] value: The value of the header. Only needed when `action` is set to `Append` or `overwrite`.
        """
...
class EndpointDeliveryRulePostArgConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        :param pulumi.Input[builtins.str] selector: Name of the post arg.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: List of string values. This is required if `operator` is not `Any`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
        pulumi.set(__self__, "operator", operator)
...
class EndpointDeliveryRuleRemoteAddressConditionArgs:
    def __init__(__self__, *,
                 ...
                 negate_condition: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] operator: Valid values are `Any`, `GeoMatch` and `IPMatch`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: List of string values. For `GeoMatch` `operator` this should be a list of country codes (e.g. `US` or `DE`). List of IP address if `operator` equals to `IPMatch`. This is required if `operator` is not `Any`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        """
        pulumi.set(__self__, "operator", operator)
        if match_values is not None:
...
class EndpointDeliveryRuleRequestHeaderConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        :param pulumi.Input[builtins.str] selector: Header name.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: List of header values. This is required if `operator` is not `Any`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
        pulumi.set(__self__, "operator", operator)
...
class EndpointDeliveryRuleRequestMethodConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: Valid values are `DELETE`, `GET`, `HEAD`, `OPTIONS`, `POST` and `PUT`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[builtins.str] operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class EndpointDeliveryRuleRequestSchemeConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: Valid values are `HTTP` and `HTTPS`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[builtins.str] operator: Valid values are `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class EndpointDeliveryRuleUrlPathConditionArgs:
    def __init__(__self__, *,
                 ...
                 transforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] operator: Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan`, `LessThanOrEqual`, `RegEx` and `Wildcard`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: List of string values. This is required if `operator` is not `Any`.
        :param pulumi.Input[builtins.bool] negate_condition: Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A list of transforms. Valid values are `Lowercase` and `Uppercase`.
        """
...
if not MYPY:
    class EndpointDeliveryRuleUrlRedirectActionArgsDict(TypedDict):
        ...
        """
        fragment: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EndpointDeliveryRuleUrlRedirectActionArgs:
    def __init__(__self__, *,
                 redirect_type: pulumi.Input[builtins.str],
                 fragment: Optional[pulumi.Input[builtins.str]] = None,
                 hostname: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 protocol: Optional[pulumi.Input[builtins.str]] = None,
                 query_string: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] redirect_type: Type of the redirect. Valid values are `Found`, `Moved`, `PermanentRedirect` and `TemporaryRedirect`.
        :param pulumi.Input[builtins.str] fragment: Specifies the fragment part of the URL. This value must not start with a `#`.
        :param pulumi.Input[builtins.str] hostname: Specifies the hostname part of the URL.
        :param pulumi.Input[builtins.str] path: Specifies the path part of the URL. This value must begin with a `/`.
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol part of the URL. Valid values are `MatchRequest`, `Http` and `Https`. Defaults to `MatchRequest`.
        :param pulumi.Input[builtins.str] query_string: Specifies the query string part of the URL. This value must not start with a `?` or `&` and must be in `<key>=<value>` format separated by `&`.
        """
    ...
    @property
    @pulumi.getter
    def fragment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the fragment part of the URL. This value must not start with a `#`.
        """
    ...
    @fragment.setter
    def fragment(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EndpointDeliveryRuleUrlRewriteActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination: This value must start with a `/` and can't be longer than 260 characters.
        :param pulumi.Input[builtins.str] source_pattern: This value must start with a `/` and can't be longer than 260 characters.
        :param pulumi.Input[builtins.bool] preserve_unmatched_path: Whether preserve an unmatched path. Defaults to `true`.
        """
...
class EndpointGeoFilterArgs:
    def __init__(__self__, *,
                 ...
                 relative_path: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] action: The Action of the Geo Filter. Possible values include `Allow` and `Block`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] country_codes: A List of two letter country codes (e.g. `US`, `GB`) to be associated with this Geo Filter.
        :param pulumi.Input[builtins.str] relative_path: The relative path applicable to geo filter.
        """
        pulumi.set(__self__, "action", action)
...
class EndpointOriginArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host_name: A string that determines the hostname/IP address of the origin server. This string can be a domain name, Storage Account endpoint, Web App endpoint, IPv4 address or IPv6 address. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the origin. This is an arbitrary value. However, this value needs to be unique under the endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] http_port: The HTTP port of the origin. Defaults to `80`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] https_port: The HTTPS port of the origin. Defaults to `443`. Changing this forces a new resource to be created.
        """
...
if not MYPY:
    class FrontdoorCustomDomainTlsArgsDict(TypedDict):
        cdn_frontdoor_secret_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FrontdoorCustomDomainTlsArgs:
    def __init__(__self__, *,
                 cdn_frontdoor_secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_type: Optional[pulumi.Input[builtins.str]] = None,
                 minimum_tls_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cdn_frontdoor_secret_id: Resource ID of the Front Door Secret.
        :param pulumi.Input[builtins.str] certificate_type: Defines the source of the SSL certificate. Possible values include `CustomerCertificate` and `ManagedCertificate`. Defaults to `ManagedCertificate`.
               
               > **Note:** It may take up to 15 minutes for the Front Door Service to validate the state and Domain ownership of the Custom Domain.
        :param pulumi.Input[builtins.str] minimum_tls_version: TLS protocol version that will be used for Https. Possible values are `TLS12`. Defaults to `TLS12`.
    ...
    def cdn_frontdoor_secret_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Resource ID of the Front Door Secret.
        """
    ...
    def cdn_frontdoor_secret_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FrontdoorFirewallPolicyCustomRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The action to perform when the rule is matched. Possible values are `Allow`, `Block`, `Log`, `Redirect`, or `JSChallenge`.
...
class FrontdoorFirewallPolicyCustomRuleMatchConditionArgs:
    def __init__(__self__, *,
                 ...
                 transforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: Up to `600` possible values to match. Limit is in total across all `match_condition` blocks and `match_values` arguments. String value itself can be up to `256` characters in length.
...
if not MYPY:
    ...
    FrontdoorFirewallPolicyLogScrubbingArgsDict: TypeAlias = Mapping[str, Any]
...
class FrontdoorFirewallPolicyLogScrubbingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FrontdoorFirewallPolicyLogScrubbingScrubbingRuleArgs']]] scrubbing_rules: One or more `scrubbing_rule` blocks as defined below.
               ...
               > **Note:** For more information on masking sensitive data in Azure Front Door please see the [product documentation](https://learn.microsoft.com/azure/web-application-firewall/afds/waf-sensitive-data-protection-configure-frontdoor).
        :param pulumi.Input[builtins.bool] enabled: Is log scrubbing enabled? Possible values are `true` or `false`. Defaults to `true`.
        """
...
if not MYPY:
    ...
    FrontdoorFirewallPolicyLogScrubbingScrubbingRuleArgsDict: TypeAlias = Mapping[str, Any]
...
class FrontdoorFirewallPolicyLogScrubbingScrubbingRuleArgs:
    def __init__(__self__, *,
                 ...
                 selector: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] match_variable: The variable to be scrubbed from the logs. Possible values include `QueryStringArgNames`, `RequestBodyJsonArgNames`, `RequestBodyPostArgNames`, `RequestCookieNames`, `RequestHeaderNames`, `RequestIPAddress`, or `RequestUri`.
               
               > **Note:** `RequestIPAddress` and `RequestUri` must use the `EqualsAny` `operator`.
        :param pulumi.Input[builtins.bool] enabled: Is this `scrubbing_rule` enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] operator: When the `match_variable` is a collection, operate on the `selector` to specify which elements in the collection this `scrubbing_rule` applies to. Possible values are `Equals` or `EqualsAny`. Defaults to `Equals`.
        :param pulumi.Input[builtins.str] selector: When the `match_variable` is a collection, the `operator` is used to specify which elements in the collection this `scrubbing_rule` applies to.
...
class FrontdoorFirewallPolicyManagedRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The action to perform for all default rule set rules when the managed rule is matched or when the anomaly score is 5 or greater depending on which version of the default rule set you are using. Possible values include `Allow`, `Log`, `Block`, or `Redirect`.
        :param pulumi.Input[builtins.str] type: The name of the managed rule to use with this resource. Possible values include `DefaultRuleSet`, `Microsoft_DefaultRuleSet`, `BotProtection`, or `Microsoft_BotManagerRuleSet`.
        :param pulumi.Input[builtins.str] version: The version of the managed rule to use with this resource. Possible values depends on which default rule set type you are using, for the `DefaultRuleSet` type the possible values include `1.0` or `preview-0.1`. For `Microsoft_DefaultRuleSet` the possible values include `1.1`, `2.0`, or `2.1`. For `BotProtection` the value must be `preview-0.1` and for `Microsoft_BotManagerRuleSet` the possible values include `1.0` and `1.1`.
...
class FrontdoorFirewallPolicyManagedRuleExclusionArgs:
    def __init__(__self__, *,
                 ...
                 selector: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] match_variable: The variable type to be excluded. Possible values are `QueryStringArgNames`, `RequestBodyPostArgNames`, `RequestCookieNames`, `RequestHeaderNames`, `RequestBodyJsonArgNames`
               
               > **Note:** `RequestBodyJsonArgNames` is only available on Default Rule Set (DRS) 2.0 or later
        :param pulumi.Input[builtins.str] operator: Comparison operator to apply to the selector when specifying which elements in the collection this exclusion applies to. Possible values are: `Equals`, `Contains`, `StartsWith`, `EndsWith`, or `EqualsAny`.
...
class FrontdoorFirewallPolicyManagedRuleOverrideRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The action to be applied when the managed rule matches or when the anomaly score is 5 or greater. Possible values for `DefaultRuleSet 1.1` and below are `Allow`, `Log`, `Block`, or `Redirect`. Possible values for `DefaultRuleSet 2.0` and above are `Log` or `AnomalyScoring`. Possible values for `Microsoft_BotManagerRuleSet` are `Allow`, `Log`, `Block`, `Redirect`, or `JSChallenge`.
...
class FrontdoorOriginGroupHealthProbeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] interval_in_seconds: Specifies the number of seconds between health probes. Possible values are between `1` and `255` seconds (inclusive).
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol to use for health probe. Possible values are `Http` and `Https`.
        :param pulumi.Input[builtins.str] path: Specifies the path relative to the origin that is used to determine the health of the origin. Defaults to `/`.
               
               > **Note:** Health probes can only be disabled if there is a single enabled origin in a single enabled origin group. For more information about the `health_probe` settings please see the [product documentation](https://docs.microsoft.com/azure/frontdoor/health-probes).
        :param pulumi.Input[builtins.str] request_type: Specifies the type of health probe request that is made. Possible values are `GET` and `HEAD`. Defaults to `HEAD`.
        """
...
class FrontdoorOriginGroupLoadBalancingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] additional_latency_in_milliseconds: Specifies the additional latency in milliseconds for probes to fall into the lowest latency bucket. Possible values are between `0` and `1000` milliseconds (inclusive). Defaults to `50`.
        :param pulumi.Input[builtins.int] sample_size: Specifies the number of samples to consider for load balancing decisions. Possible values are between `0` and `255` (inclusive). Defaults to `4`.
        :param pulumi.Input[builtins.int] successful_samples_required: Specifies the number of samples within the sample period that must succeed. Possible values are between `0` and `255` (inclusive). Defaults to `3`.
        """
...
if not MYPY:
    class FrontdoorOriginPrivateLinkArgsDict(TypedDict):
        ...
        """
        private_link_target_id: pulumi.Input[builtins.str]
        """
...
class FrontdoorOriginPrivateLinkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] location: Specifies the location where the Private Link resource should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_link_target_id: The ID of the Azure Resource to connect to via the Private Link.
               
               > **Note:** the `private_link_target_id` property must specify the Resource ID of the Private Link Service when using Load Balancer as an Origin.
        :param pulumi.Input[builtins.str] request_message: Specifies the request message that will be submitted to the `private_link_target_id` when requesting the private link endpoint connection. Values must be between `1` and `140` characters in length. Defaults to `Access request for CDN FrontDoor Private Link Origin`.
        :param pulumi.Input[builtins.str] target_type: Specifies the type of target for this Private Link Endpoint. Possible values are `blob`, `blob_secondary`, `Gateway`, `managedEnvironments`, `sites`, `web` and `web_secondary`.
    ...
    def private_link_target_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Azure Resource to connect to via the Private Link.
    ...
    def private_link_target_id(self, value: pulumi.Input[builtins.str]):
...
class FrontdoorProfileIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of managed identity to assign. Possible values are `SystemAssigned`, `UserAssigned` or `SystemAssigned, UserAssigned`.
...
if not MYPY:
    class FrontdoorRouteCacheArgsDict(TypedDict):
        ...
        """
        content_types_to_compresses: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        query_string_caching_behavior: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FrontdoorRouteCacheArgs:
    def __init__(__self__, *,
                 ...
                 query_string_caching_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 query_strings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] compression_enabled: Is content compression enabled? Possible values are `true` or `false`. Defaults to `false`.
               
               > **Note:** Content won't be compressed when the requested content is smaller than `1 KB` or larger than `8 MB`(inclusive).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] content_types_to_compresses: A list of one or more `Content types` (formerly known as `MIME types`) to compress. Possible values include `application/eot`, `application/font`, `application/font-sfnt`, `application/javascript`, `application/json`, `application/opentype`, `application/otf`, `application/pkcs7-mime`, `application/truetype`, `application/ttf`, `application/vnd.ms-fontobject`, `application/xhtml+xml`, `application/xml`, `application/xml+rss`, `application/x-font-opentype`, `application/x-font-truetype`, `application/x-font-ttf`, `application/x-httpd-cgi`, `application/x-mpegurl`, `application/x-opentype`, `application/x-otf`, `application/x-perl`, `application/x-ttf`, `application/x-javascript`, `font/eot`, `font/ttf`, `font/otf`, `font/opentype`, `image/svg+xml`, `text/css`, `text/csv`, `text/html`, `text/javascript`, `text/js`, `text/plain`, `text/richtext`, `text/tab-separated-values`, `text/xml`, `text/x-script`, `text/x-component` or `text/x-java-source`.
        :param pulumi.Input[builtins.str] query_string_caching_behavior: Defines how the Front Door Route will cache requests that include query strings. Possible values include `IgnoreQueryString`, `IgnoreSpecifiedQueryStrings`, `IncludeSpecifiedQueryStrings` or `UseQueryString`. Defaults to `IgnoreQueryString`.
               
               > **Note:** The value of the `query_string_caching_behavior` determines if the `query_strings` field will be used as an include list or an ignore list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_strings: Query strings to include or ignore.
        """
    ...
    def query_string_caching_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines how the Front Door Route will cache requests that include query strings. Possible values include `IgnoreQueryString`, `IgnoreSpecifiedQueryStrings`, `IncludeSpecifiedQueryStrings` or `UseQueryString`. Defaults to `IgnoreQueryString`.
    ...
    def query_string_caching_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FrontdoorRuleActionsRequestHeaderActionArgsDict(TypedDict):
        header_action: pulumi.Input[builtins.str]
        """
...
class FrontdoorRuleActionsRequestHeaderActionArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] header_action: The action to be taken on the specified `header_name`. Possible values include `Append`, `Overwrite` or `Delete`.
               
               > **Note:** `Append` causes the specified header to be added to the request with the specified value. If the header is already present, the value is appended to the existing header value using string concatenation. No delimiters are added. `Overwrite` causes specified header to be added to the request with the specified value. If the header is already present, the specified value overwrites the existing value. `Delete` causes the header to be deleted from the request.
        :param pulumi.Input[builtins.str] header_name: The name of the header to modify.
        :param pulumi.Input[builtins.str] value: The value to append or overwrite.
    ...
    def header_action(self) -> pulumi.Input[builtins.str]:
        """
        The action to be taken on the specified `header_name`. Possible values include `Append`, `Overwrite` or `Delete`.
    ...
    def header_action(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class FrontdoorRuleActionsRouteConfigurationOverrideActionArgsDict(TypedDict):
        cache_behavior: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        cdn_frontdoor_origin_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        query_string_parameters: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class FrontdoorRuleActionsRouteConfigurationOverrideActionArgs:
    def __init__(__self__, *,
                 cache_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 query_string_caching_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 query_string_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] cache_behavior: `HonorOrigin` the Front Door will always honor origin response header directive. If the origin directive is missing, Front Door will cache contents anywhere from `1` to `3` days. `OverrideAlways` the TTL value returned from your Front Door Origin is overwritten with the value specified in the action. This behavior will only be applied if the response is cacheable. `OverrideIfOriginMissing` if no TTL value gets returned from your Front Door Origin, the rule sets the TTL to the value specified in the action. This behavior will only be applied if the response is cacheable. `Disabled` the Front Door will not cache the response contents, irrespective of Front Door Origin response directives. Possible values include `HonorOrigin`, `OverrideAlways`, `OverrideIfOriginMissing` or `Disabled`.
        :param pulumi.Input[builtins.str] cache_duration: When Cache behavior is set to `Override` or `SetIfMissing`, this field specifies the cache duration to use. The maximum duration is 366 days specified in the `d.HH:MM:SS` format(e.g. `365.23:59:59`). If the desired maximum cache duration is less than 1 day then the maximum cache duration should be specified in the `HH:MM:SS` format(e.g. `23:59:59`).
        :param pulumi.Input[builtins.str] cdn_frontdoor_origin_group_id: The Front Door Origin Group resource ID that the request should be routed to. This overrides the configuration specified in the Front Door Endpoint route.
        :param pulumi.Input[builtins.bool] compression_enabled: Should the Front Door dynamically compress the content? Possible values include `true` or `false`.
               
               > **Note:** Content won't be compressed on AzureFrontDoor when requested content is smaller than `1 byte` or larger than `1 MB`.
        :param pulumi.Input[builtins.str] forwarding_protocol: The forwarding protocol the request will be redirected as. This overrides the configuration specified in the route to be associated with. Possible values include `MatchRequest`, `HttpOnly` or `HttpsOnly`.
               
               > **Note:** If the `cdn_frontdoor_origin_group_id` is not defined you cannot set the `forwarding_protocol`.
        :param pulumi.Input[builtins.str] query_string_caching_behavior: `IncludeSpecifiedQueryStrings` query strings specified in the `query_string_parameters` field get included when the cache key gets generated. `UseQueryString` cache every unique URL, each unique URL will have its own cache key. `IgnoreSpecifiedQueryStrings` query strings specified in the `query_string_parameters` field get excluded when the cache key gets generated. `IgnoreQueryString` query strings aren't considered when the cache key gets generated. Possible values include `IgnoreQueryString`, `UseQueryString`, `IgnoreSpecifiedQueryStrings` or `IncludeSpecifiedQueryStrings`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_string_parameters: A list of query string parameter names.
    ...
    def cache_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        `HonorOrigin` the Front Door will always honor origin response header directive. If the origin directive is missing, Front Door will cache contents anywhere from `1` to `3` days. `OverrideAlways` the TTL value returned from your Front Door Origin is overwritten with the value specified in the action. This behavior will only be applied if the response is cacheable. `OverrideIfOriginMissing` if no TTL value gets returned from your Front Door Origin, the rule sets the TTL to the value specified in the action. This behavior will only be applied if the response is cacheable. `Disabled` the Front Door will not cache the response contents, irrespective of Front Door Origin response directives. Possible values include `HonorOrigin`, `OverrideAlways`, `OverrideIfOriginMissing` or `Disabled`.
        """
    ...
    def cache_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def query_string_parameters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of query string parameter names.
    ...
    def query_string_parameters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "query_string_parameters", value)


if not MYPY:
    class FrontdoorRuleActionsUrlRedirectActionArgsDict(TypedDict):
        destination_hostname: pulumi.Input[builtins.str]
        """
        ...
        """
        destination_fragment: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FrontdoorRuleActionsUrlRedirectActionArgs:
    def __init__(__self__, *,
                 destination_hostname: pulumi.Input[builtins.str],
                 redirect_type: pulumi.Input[builtins.str],
                 destination_fragment: Optional[pulumi.Input[builtins.str]] = None,
                 destination_path: Optional[pulumi.Input[builtins.str]] = None,
                 query_string: Optional[pulumi.Input[builtins.str]] = None,
                 redirect_protocol: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] destination_hostname: The host name you want the request to be redirected to. The value must be a string between `0` and `2048` characters in length, leave blank to preserve the incoming host.
        :param pulumi.Input[builtins.str] redirect_type: The response type to return to the requestor. Possible values include `Moved`, `Found` , `TemporaryRedirect` or `PermanentRedirect`.
        :param pulumi.Input[builtins.str] destination_fragment: The fragment to use in the redirect. The value must be a string between `0` and `1024` characters in length, leave blank to preserve the incoming fragment. Defaults to `""`.
        :param pulumi.Input[builtins.str] destination_path: The path to use in the redirect. The value must be a string and include the leading `/`, leave blank to preserve the incoming path. Defaults to `""`.
        :param pulumi.Input[builtins.str] query_string: The query string used in the redirect URL. The value must be in the &lt;key>=&lt;value> or &lt;key>={`action_server_variable`} format and must not include the leading `?`, leave blank to preserve the incoming query string. Maximum allowed length for this field is `2048` characters. Defaults to `""`.
        :param pulumi.Input[builtins.str] redirect_protocol: The protocol the request will be redirected as. Possible values include `MatchRequest`, `Http` or `Https`. Defaults to `MatchRequest`.
        """
    ...
    def destination_hostname(self) -> pulumi.Input[builtins.str]:
        """
        The host name you want the request to be redirected to. The value must be a string between `0` and `2048` characters in length, leave blank to preserve the incoming host.
        """
    ...
    def destination_hostname(self, value: pulumi.Input[builtins.str]):
    ...
    def destination_fragment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The fragment to use in the redirect. The value must be a string between `0` and `1024` characters in length, leave blank to preserve the incoming fragment. Defaults to `""`.
        """
    ...
    def destination_fragment(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FrontdoorRuleActionsUrlRewriteActionArgs:
    def __init__(__self__, *,
                 ...
                 preserve_unmatched_path: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] destination: The destination path to use in the rewrite. The destination path overwrites the source pattern.
        :param pulumi.Input[builtins.str] source_pattern: The source pattern in the URL path to replace. This uses prefix-based matching. For example, to match all URL paths use a forward slash `"/"` as the source pattern value.
        :param pulumi.Input[builtins.bool] preserve_unmatched_path: Append the remaining path after the source pattern to the new destination path? Possible values `true` or `false`. Defaults to `false`.
        """
        pulumi.set(__self__, "destination", destination)
        pulumi.set(__self__, "source_pattern", source_pattern)
        if preserve_unmatched_path is not None:
...
class FrontdoorRuleConditionsClientPortConditionArgs:
    def __init__(__self__, *,
                 ...
                 negate_condition: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: One or more integer values(e.g. "1") representing the value of the client port to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        """
        pulumi.set(__self__, "operator", operator)
        if match_values is not None:
            pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsCookiesConditionArgs:
    def __init__(__self__, *,
                 ...
                 transforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] cookie_name: A string value representing the name of the cookie.
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: One or more string or integer values(e.g. "1") representing the value of the request header to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
...
class FrontdoorRuleConditionsHostNameConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of one or more string values representing the value of the request hostname to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorRuleConditionsHttpVersionConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: What HTTP version should this condition match? Possible values `2.0`, `1.1`, `1.0` or `0.9`.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] operator: Possible value `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
        if negate_condition is not None:
            pulumi.set(__self__, "negate_condition", negate_condition)
...
if not MYPY:
    class FrontdoorRuleConditionsIsDeviceConditionArgsDict(TypedDict):
        match_values: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FrontdoorRuleConditionsIsDeviceConditionArgs:
    def __init__(__self__, *,
                 match_values: Optional[pulumi.Input[builtins.str]] = None,
                 negate_condition: Optional[pulumi.Input[builtins.bool]] = None,
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] match_values: Which device should this rule match on? Possible values `Mobile` or `Desktop`.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] operator: Possible value `Equal`. Defaults to `Equal`.
        """
        if match_values is not None:
    ...
    @property
    @pulumi.getter(name="matchValues")
    def match_values(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Which device should this rule match on? Possible values `Mobile` or `Desktop`.
        """
        return pulumi.get(self, "match_values")
    ...
    @match_values.setter
    def match_values(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "match_values", value)
...
if not MYPY:
    class FrontdoorRuleConditionsPostArgsConditionArgsDict(TypedDict):
        ...
        A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        """
        post_args_name: pulumi.Input[builtins.str]
        """
...
class FrontdoorRuleConditionsPostArgsConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] post_args_name: A string value representing the name of the `POST` argument.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: One or more string or integer values(e.g. "1") representing the value of the `POST` argument to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
    ...
    def post_args_name(self) -> pulumi.Input[builtins.str]:
        """
        A string value representing the name of the `POST` argument.
        """
    ...
    def post_args_name(self, value: pulumi.Input[builtins.str]):
...
class FrontdoorRuleConditionsQueryStringConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: One or more string or integer values(e.g. "1") representing the value of the query string to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorRuleConditionsRemoteAddressConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: For the IP Match or IP Not Match operators: specify one or more IP address ranges. If multiple IP address ranges are specified, they're evaluated using `OR` logic. For the Geo Match or Geo Not Match operators: specify one or more locations using their country code.
               
               > **Note:** See the `Specifying IP Address Ranges` section below on how to correctly define the `match_values` field.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] operator: The type of the remote address to match. Possible values include `Any`, `GeoMatch` or `IPMatch`. Use the `negate_condition` to specify Not `GeoMatch` or Not `IPMatch`. Defaults to `IPMatch`.
        """
        if match_values is not None:
            pulumi.set(__self__, "match_values", match_values)
        if negate_condition is not None:
...
class FrontdoorRuleConditionsRequestBodyConditionArgs:
    def __init__(__self__, *,
                 ...
                 transforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of one or more string or integer values(e.g. "1") representing the value of the request body text to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
...
class FrontdoorRuleConditionsRequestHeaderConditionArgs:
    def __init__(__self__, *,
                 ...
                 transforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] header_name: A string value representing the name of the `POST` argument.
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: One or more string or integer values(e.g. "1") representing the value of the request header to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
...
class FrontdoorRuleConditionsRequestMethodConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of one or more HTTP methods. Possible values include `GET`, `POST`, `PUT`, `DELETE`, `HEAD`, `OPTIONS` or `TRACE`. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] operator: Possible value `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsRequestSchemeConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] match_values: The requests protocol to match. Possible values include `HTTP` or `HTTPS`.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] operator: Possible value `Equal`. Defaults to `Equal`.
        """
        if match_values is not None:
...
class FrontdoorRuleConditionsRequestUriConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: One or more string or integer values(e.g. "1") representing the value of the request URL to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
class FrontdoorRuleConditionsServerPortConditionArgs:
    def __init__(__self__, *,
                 ...
                 negate_condition: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of one or more integer values(e.g. "1") representing the value of the client port to match. Possible values include `80` or `443`. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsSocketAddressConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: Specify one or more IP address ranges. If multiple IP address ranges are specified, they're evaluated using `OR` logic.
               
               > **Note:** See the `Specifying IP Address Ranges` section below on how to correctly define the `match_values` field.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] operator: The type of match. The Possible values are `IpMatch` or `Any`. Defaults to `IPMatch`.
...
class FrontdoorRuleConditionsSslProtocolConditionArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of one or more HTTP methods. Possible values are `TLSv1`, `TLSv1.1` and `TLSv1.2` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.str] operator: Possible value `Equal`. Defaults to `Equal`.
        """
        pulumi.set(__self__, "match_values", match_values)
...
class FrontdoorRuleConditionsUrlFileExtensionConditionArgs:
    def __init__(__self__, *,
                 ...
                 transforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of one or more string or integer values(e.g. "1") representing the value of the request file extension to match. If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
...
class FrontdoorRuleConditionsUrlFilenameConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual` or `RegEx`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of one or more string or integer values(e.g. "1") representing the value of the request file name to match. If multiple values are specified, they're evaluated using `OR` logic.
...
class FrontdoorRuleConditionsUrlPathConditionArgs:
    def __init__(__self__, *,
                 ...
                 transforms: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] operator: A Conditional operator. Possible values include `Any`, `Equal`, `Contains`, `BeginsWith`, `EndsWith`, `LessThan`, `LessThanOrEqual`, `GreaterThan`, `GreaterThanOrEqual`, `RegEx` or `Wildcard`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: One or more string or integer values(e.g. "1") representing the value of the request path to match. Don't include the leading slash (`/`). If multiple values are specified, they're evaluated using `OR` logic.
        :param pulumi.Input[builtins.bool] negate_condition: If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A Conditional operator. Possible values include `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` or `UrlEncode`. Details can be found in the `Condition Transform List` below.
        """
        pulumi.set(__self__, "operator", operator)
...
if not MYPY:
    class FrontdoorSecretSecretCustomerCertificateArgsDict(TypedDict):
        key_vault_certificate_id: pulumi.Input[builtins.str]
        """
...
class FrontdoorSecretSecretCustomerCertificateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key_vault_certificate_id: The ID of the Key Vault certificate resource to use. Changing this forces a new Front Door Secret to be created.
               
               > **Note:** If you would like to use the **latest version** of the Key Vault Certificate use the Key Vault Certificates `versionless_id` attribute as the `key_vault_certificate_id` fields value(e.g. `key_vault_certificate_id = azurerm_key_vault_certificate.example.versionless_id`).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subject_alternative_names: One or more `subject alternative names` contained within the key vault certificate.
        """
    ...
    def key_vault_certificate_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Key Vault certificate resource to use. Changing this forces a new Front Door Secret to be created.
    ...
    def key_vault_certificate_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class FrontdoorSecurityPolicySecurityPoliciesFirewallArgsDict(TypedDict):
        ...
        """
        cdn_frontdoor_firewall_policy_id: pulumi.Input[builtins.str]
        """
...
class FrontdoorSecurityPolicySecurityPoliciesFirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cdn_frontdoor_firewall_policy_id: The Resource Id of the Front Door Firewall Policy that should be linked to this Front Door Security Policy. Changing this forces a new Front Door Security Policy to be created.
        """
    ...
    def cdn_frontdoor_firewall_policy_id(self) -> pulumi.Input[builtins.str]:
        """
        The Resource Id of the Front Door Firewall Policy that should be linked to this Front Door Security Policy. Changing this forces a new Front Door Security Policy to be created.
        """
    ...
    def cdn_frontdoor_firewall_policy_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class FrontdoorSecurityPolicySecurityPoliciesFirewallAssociationArgsDict(TypedDict):
        ...
        """
        patterns_to_match: pulumi.Input[builtins.str]
        """
...
class FrontdoorSecurityPolicySecurityPoliciesFirewallAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] patterns_to_match: The list of paths to match for this firewall policy. Possible value includes `/*`. Changing this forces a new Front Door Security Policy to be created.
        """
    ...
    def patterns_to_match(self) -> pulumi.Input[builtins.str]:
        """
        The list of paths to match for this firewall policy. Possible value includes `/*`. Changing this forces a new Front Door Security Policy to be created.
        """
    ...
    def patterns_to_match(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class FrontdoorSecurityPolicySecurityPoliciesFirewallAssociationDomainArgsDict(TypedDict):
        cdn_frontdoor_domain_id: pulumi.Input[builtins.str]
        """
...
class FrontdoorSecurityPolicySecurityPoliciesFirewallAssociationDomainArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cdn_frontdoor_domain_id: The Resource Id of the **Front Door Custom Domain** or **Front Door Endpoint** that should be bound to this Front Door Security Policy. Changing this forces a new Front Door Security Policy to be created.
        :param pulumi.Input[builtins.bool] active: Is the Front Door Custom Domain/Endpoint activated?
        """
    ...
    def cdn_frontdoor_domain_id(self) -> pulumi.Input[builtins.str]:
        """
        The Resource Id of the **Front Door Custom Domain** or **Front Door Endpoint** that should be bound to this Front Door Security Policy. Changing this forces a new Front Door Security Policy to be created.
        """
    ...
    def cdn_frontdoor_domain_id(self, value: pulumi.Input[builtins.str]):
...
class GetFrontdoorProfileIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of Managed Service Identity that is configured on this Front Door Profile.
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Front Door Profile.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
        pulumi.set(__self__, "type", type)
