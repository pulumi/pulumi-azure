...
def get_frontdoor_secret(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Specifies the name of the Front Door Secret.
    :param builtins.str profile_name: The name of the Front Door Profile within which the Front Door Secret exists.
...
def get_frontdoor_secret_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:cdn/getFrontdoorSecret:getFrontdoorSecret', __args__, opts=opts, typ=GetFrontdoorSecretResult)
    return __ret__.apply(lambda __response__: GetFrontdoorSecretResult(
