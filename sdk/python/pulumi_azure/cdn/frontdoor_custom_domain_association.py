...
class FrontdoorCustomDomainAssociationArgs:
    def __init__(__self__, *,
                 cdn_frontdoor_custom_domain_id: pulumi.Input[_builtins.str],
    ...
    def cdn_frontdoor_custom_domain_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def cdn_frontdoor_custom_domain_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "cdn_frontdoor_custom_domain_id", value)

    @_builtins.property
    @pulumi.getter(name="cdnFrontdoorRouteIds")
    def cdn_frontdoor_route_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def cdn_frontdoor_route_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class FrontdoorCustomDomainAssociation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="cdnFrontdoorCustomDomainId")
    def cdn_frontdoor_custom_domain_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the Front Door Custom Domain that should be managed by the association resource. Changing this forces a new association resource to be created.
        """
        return pulumi.get(self, "cdn_frontdoor_custom_domain_id")
    ...
    @_builtins.property
    @pulumi.getter(name="cdnFrontdoorRouteIds")
    def cdn_frontdoor_route_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        One or more IDs of the Front Door Route to which the Front Door Custom Domain is associated with.
