...
class FrontdoorFirewallPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] request_body_check_enabled: Should policy managed rules inspect the request body content? Defaults to `true`.
...
class FrontdoorFirewallPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="requestBodyCheckEnabled")
    def request_body_check_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Should policy managed rules inspect the request body content? Defaults to `true`.
