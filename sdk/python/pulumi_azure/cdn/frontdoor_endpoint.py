...
class FrontdoorEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cdn_frontdoor_profile_id: The ID of the Front Door Profile within which this Front Door Endpoint should exist. Changing this forces a new Front Door Endpoint to be created.
        :param pulumi.Input[builtins.bool] enabled: Specifies if this Front Door Endpoint is enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Front Door Endpoint. Changing this forces a new Front Door Endpoint to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies a mapping of tags which should be assigned to the Front Door Endpoint.
        """
...
class _FrontdoorEndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cdn_frontdoor_profile_id: The ID of the Front Door Profile within which this Front Door Endpoint should exist. Changing this forces a new Front Door Endpoint to be created.
        :param pulumi.Input[builtins.bool] enabled: Specifies if this Front Door Endpoint is enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] host_name: The host name of the Front Door Endpoint, in the format `{endpointName}.{dnsZone}` (for example, `contoso.azureedge.net`).
        :param pulumi.Input[builtins.str] name: The name which should be used for this Front Door Endpoint. Changing this forces a new Front Door Endpoint to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Specifies a mapping of tags which should be assigned to the Front Door Endpoint.
        """
...
class FrontdoorEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            host_name: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'FrontdoorEndpoint':
        """
