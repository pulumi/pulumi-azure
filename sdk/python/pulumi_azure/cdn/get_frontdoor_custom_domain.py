...
def get_frontdoor_custom_domain(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The name of the Front Door Custom Domain.
    :param builtins.str profile_name: The name of the Front Door Profile which the Front Door Custom Domain is bound to.
...
def get_frontdoor_custom_domain_output(name: Optional[pulumi.Input[builtins.str]] = None,
