...
class FrontdoorSecurityPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_frontdoor_firewall_policy = azure.cdn.frontdoor_firewall_policy.FrontdoorFirewallPolicy("example",
            name=exampleWAF,
            resource_group_name=example.name,
        ...
        example_frontdoor_security_policy = azure.cdn.frontdoor_security_policy.FrontdoorSecurityPolicy("example",
