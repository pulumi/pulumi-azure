...
class FrontdoorSecurityPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cdn_frontdoor_profile_id: The Front Door Profile Resource Id that is linked to this Front Door Security Policy. Changing this forces a new Front Door Security Policy to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Front Door Security Policy. Possible values must not be an empty string. Changing this forces a new Front Door Security Policy to be created.
        """
...
class FrontdoorSecurityPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "azure:cdn/frontdoorSecurityPolicy:FrontdoorSecurityPolicy"
