...
class GetFrontdoorOriginGroupResult:
    ...
    def restore_traffic_time_to_healed_or_new_endpoint_in_minutes(self) -> _builtins.int:
    ...
    def session_affinity_enabled(self) -> _builtins.bool:
        """
...
def get_frontdoor_origin_group(name: Optional[_builtins.str] = None,
