...
class FrontdoorRuleArgs:
    def __init__(__self__, *,
                 ...
                 cdn_frontdoor_rule_set_id: pulumi.Input[builtins.str],
                 order: pulumi.Input[builtins.int],
                 behavior_on_match: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def cdn_frontdoor_rule_set_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cdn_frontdoor_rule_set_id(self, value: pulumi.Input[builtins.str]):
    ...
    def behavior_on_match(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def behavior_on_match(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FrontdoorRuleState:
    def __init__(__self__, *,
                 ...
                 behavior_on_match: Optional[pulumi.Input[builtins.str]] = None,
                 cdn_frontdoor_rule_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 cdn_frontdoor_rule_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 conditions: Optional[pulumi.Input['FrontdoorRuleConditionsArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] behavior_on_match: If this rule is a match should the rules engine continue processing the remaining rules or stop? Possible values are `Continue` and `Stop`. Defaults to `Continue`.
        :param pulumi.Input[builtins.str] cdn_frontdoor_rule_set_id: The resource ID of the Front Door Rule Set for this Front Door Rule. Changing this forces a new Front Door Rule to be created.
        :param pulumi.Input[builtins.str] cdn_frontdoor_rule_set_name: The name of the Front Door Rule Set containing this Front Door Rule.
        :param pulumi.Input['FrontdoorRuleConditionsArgs'] conditions: A `conditions` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Front Door Rule. Possible values must be between 1 and 260 characters in length, begin with a letter and may contain only letters and numbers. Changing this forces a new Front Door Rule to be created.
        :param pulumi.Input[builtins.int] order: The order in which the rules will be applied for the Front Door Endpoint. The order value should be sequential and begin at `1`(e.g. `1`, `2`, `3`...). A Front Door Rule with a lesser order value will be applied before a rule with a greater order value.
    ...
    @property
    @pulumi.getter(name="cdnFrontdoorRuleSetId")
    def cdn_frontdoor_rule_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource ID of the Front Door Rule Set for this Front Door Rule. Changing this forces a new Front Door Rule to be created.
        """
        return pulumi.get(self, "cdn_frontdoor_rule_set_id")
    ...
    @cdn_frontdoor_rule_set_id.setter
    def cdn_frontdoor_rule_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cdn_frontdoor_rule_set_id", value)

    @property
    @pulumi.getter(name="cdnFrontdoorRuleSetName")
    def cdn_frontdoor_rule_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cdn_frontdoor_rule_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FrontdoorRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            conditions: Optional[pulumi.Input[Union['FrontdoorRuleConditionsArgs', 'FrontdoorRuleConditionsArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            order: Optional[pulumi.Input[builtins.int]] = None) -> 'FrontdoorRule':
        """
    ...
    @property
    @pulumi.getter(name="behaviorOnMatch")
    def behavior_on_match(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If this rule is a match should the rules engine continue processing the remaining rules or stop? Possible values are `Continue` and `Stop`. Defaults to `Continue`.
        """
        return pulumi.get(self, "behavior_on_match")
    ...
    @property
    @pulumi.getter(name="cdnFrontdoorRuleSetId")
    def cdn_frontdoor_rule_set_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the Front Door Rule Set for this Front Door Rule. Changing this forces a new Front Door Rule to be created.
        """
        return pulumi.get(self, "cdn_frontdoor_rule_set_id")
    ...
    @property
    @pulumi.getter(name="cdnFrontdoorRuleSetName")
    def cdn_frontdoor_rule_set_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Front Door Rule Set containing this Front Door Rule.
        """
        return pulumi.get(self, "cdn_frontdoor_rule_set_name")
