...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 diagnostics: pulumi.Input[Optional['GroupDiagnosticsArgs']] = None,
                 dns_config: pulumi.Input[Optional['GroupDnsConfigArgs']] = None,
                 dns_name_label: pulumi.Input[Optional[_builtins.str]] = None,
                 dns_name_label_reuse_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 exposed_ports: pulumi.Input[Optional[Sequence[pulumi.Input['GroupExposedPortArgs']]]] = None,
                 identity: pulumi.Input[Optional['GroupIdentityArgs']] = None,
                 image_registry_credentials: pulumi.Input[Optional[Sequence[pulumi.Input['GroupImageRegistryCredentialArgs']]]] = None,
                 init_containers: pulumi.Input[Optional[Sequence[pulumi.Input['GroupInitContainerArgs']]]] = None,
                 ip_address_type: pulumi.Input[Optional[_builtins.str]] = None,
                 key_vault_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 key_vault_user_assigned_identity_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] os_type: The OS for the container group. Allowed values are `Linux` and `Windows`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which to create the Container Group. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] dns_name_label: The DNS label/name for the container group's IP. Changing this forces a new resource to be created.
               
               > **Note:** DNS label/name is not supported when deploying to virtual networks.
        :param pulumi.Input[_builtins.str] dns_name_label_reuse_policy: The value representing the security enum. `Noreuse`, `ResourceGroupReuse`, `SubscriptionReuse`, `TenantReuse` or `Unsecure`. Defaults to `Unsecure`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] ip_address_type: Specifies the IP address type of the container. `Public`, `Private` or `None`. Changing this forces a new resource to be created. If set to `Private`, `subnet_ids` also needs to be set. Defaults to `Public`.
               
               > **Note:** `dns_name_label` and `os_type` set to `windows` are not compatible with `Private` `ip_address_type`
        :param pulumi.Input[_builtins.str] key_vault_key_id: The Key Vault key URI for CMK encryption. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] key_vault_user_assigned_identity_id: The user assigned identity that has access to the Key Vault Key. If not specified, the RP principal named "Azure Container Instance Service" will be used instead. Make sure the identity has the proper `key_permissions` set, at least with `Get`, `UnwrapKey`, `WrapKey` and `GetRotationPolicy`.
        :param pulumi.Input[_builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Container Group. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] priority: The priority of the Container Group. Possible values are `Regular` and `Spot`. Changing this forces a new resource to be created.
               
               > **Note:** When `priority` is set to `Spot`, the `ip_address_type` has to be `None`.
        :param pulumi.Input[_builtins.str] restart_policy: Restart policy for the container group. Allowed values are `Always`, `Never`, `OnFailure`. Defaults to `Always`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] sku: Specifies the sku of the Container Group. Possible values are `Confidential`, `Dedicated` and `Standard`. Defaults to `Standard`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] subnet_ids: The subnet resource IDs for a container group. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] zones: A list of Availability Zones in which this Container Group is located. Changing this forces a new resource to be created.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def diagnostics(self) -> pulumi.Input[Optional['GroupDiagnosticsArgs']]:
        """
    ...
    @diagnostics.setter
    def diagnostics(self, value: pulumi.Input[Optional['GroupDiagnosticsArgs']]):
        pulumi.set(self, "diagnostics", value)

    @_builtins.property
    @pulumi.getter(name="dnsConfig")
    def dns_config(self) -> pulumi.Input[Optional['GroupDnsConfigArgs']]:
        """
    ...
    @dns_config.setter
    def dns_config(self, value: pulumi.Input[Optional['GroupDnsConfigArgs']]):
    ...
    def dns_name_label_reuse_policy(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def dns_name_label_reuse_policy(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "dns_name_label_reuse_policy", value)

    @_builtins.property
    @pulumi.getter(name="exposedPorts")
    def exposed_ports(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['GroupExposedPortArgs']]]]:
        """
    ...
    def exposed_ports(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['GroupExposedPortArgs']]]]):
        pulumi.set(self, "exposed_ports", value)

    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['GroupIdentityArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['GroupIdentityArgs']]):
        pulumi.set(self, "identity", value)

    @_builtins.property
    @pulumi.getter(name="imageRegistryCredentials")
    def image_registry_credentials(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['GroupImageRegistryCredentialArgs']]]]:
        """
    ...
    def image_registry_credentials(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['GroupImageRegistryCredentialArgs']]]]):
        pulumi.set(self, "image_registry_credentials", value)

    @_builtins.property
    @pulumi.getter(name="initContainers")
    def init_containers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['GroupInitContainerArgs']]]]:
        """
    ...
    def init_containers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['GroupInitContainerArgs']]]]):
    ...
    def key_vault_user_assigned_identity_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def key_vault_user_assigned_identity_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _GroupState:
    def __init__(__self__, *,
                 containers: pulumi.Input[Optional[Sequence[pulumi.Input['GroupContainerArgs']]]] = None,
                 diagnostics: pulumi.Input[Optional['GroupDiagnosticsArgs']] = None,
                 dns_config: pulumi.Input[Optional['GroupDnsConfigArgs']] = None,
                 dns_name_label: pulumi.Input[Optional[_builtins.str]] = None,
                 dns_name_label_reuse_policy: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GroupExposedPortArgs']]] exposed_ports: Zero or more `exposed_port` blocks as defined below. Changing this forces a new resource to be created.
               ...
               > **Note:** The `exposed_port` can only contain ports that are also exposed on one or more containers in the group.
        :param pulumi.Input[_builtins.str] fqdn: The FQDN of the container group derived from `dns_name_label`.
        :param pulumi.Input['GroupIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input['GroupImageRegistryCredentialArgs']]] image_registry_credentials: An `image_registry_credential` block as documented below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input['GroupInitContainerArgs']]] init_containers: The definition of an init container that is part of the group as documented in the `init_container` block below. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] ip_address: The IP address allocated to the container group.
        :param pulumi.Input[_builtins.str] ip_address_type: Specifies the IP address type of the container. `Public`, `Private` or `None`. Changing this forces a new resource to be created. If set to `Private`, `subnet_ids` also needs to be set. Defaults to `Public`.
    ...
    @_builtins.property
    @pulumi.getter
    def containers(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['GroupContainerArgs']]]]:
        """
        The definition of a container that is part of the group as documented in the `container` block below. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "containers")
    ...
    @containers.setter
    def containers(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['GroupContainerArgs']]]]):
        pulumi.set(self, "containers", value)
...
class Group(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 containers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['GroupContainerArgs', 'GroupContainerArgsDict', 'outputs.GroupContainer']]]]] = None,
                 diagnostics: pulumi.Input[Optional[Union['GroupDiagnosticsArgs', 'GroupDiagnosticsArgsDict', 'outputs.GroupDiagnostics']]] = None,
                 dns_config: pulumi.Input[Optional[Union['GroupDnsConfigArgs', 'GroupDnsConfigArgsDict', 'outputs.GroupDnsConfig']]] = None,
                 dns_name_label: pulumi.Input[Optional[_builtins.str]] = None,
                 dns_name_label_reuse_policy: pulumi.Input[Optional[_builtins.str]] = None,
                 exposed_ports: pulumi.Input[Optional[Sequence[pulumi.Input[Union['GroupExposedPortArgs', 'GroupExposedPortArgsDict', 'outputs.GroupExposedPort']]]]] = None,
                 identity: pulumi.Input[Optional[Union['GroupIdentityArgs', 'GroupIdentityArgsDict', 'outputs.GroupIdentity']]] = None,
                 image_registry_credentials: pulumi.Input[Optional[Sequence[pulumi.Input[Union['GroupImageRegistryCredentialArgs', 'GroupImageRegistryCredentialArgsDict', 'outputs.GroupImageRegistryCredential']]]]] = None,
                 init_containers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['GroupInitContainerArgs', 'GroupInitContainerArgsDict', 'outputs.GroupInitContainer']]]]] = None,
                 ip_address_type: pulumi.Input[Optional[_builtins.str]] = None,
                 key_vault_key_id: pulumi.Input[Optional[_builtins.str]] = None,
                 key_vault_user_assigned_identity_id: pulumi.Input[Optional[_builtins.str]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `Microsoft.ContainerInstance` - 2025-09-01
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['GroupContainerArgs', 'GroupContainerArgsDict', 'outputs.GroupContainer']]]] containers: The definition of a container that is part of the group as documented in the `container` block below. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['GroupDiagnosticsArgs', 'GroupDiagnosticsArgsDict', 'outputs.GroupDiagnostics']] diagnostics: A `diagnostics` block as documented below. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['GroupDnsConfigArgs', 'GroupDnsConfigArgsDict', 'outputs.GroupDnsConfig']] dns_config: A `dns_config` block as documented below. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] dns_name_label: The DNS label/name for the container group's IP. Changing this forces a new resource to be created.
               
               > **Note:** DNS label/name is not supported when deploying to virtual networks.
        :param pulumi.Input[_builtins.str] dns_name_label_reuse_policy: The value representing the security enum. `Noreuse`, `ResourceGroupReuse`, `SubscriptionReuse`, `TenantReuse` or `Unsecure`. Defaults to `Unsecure`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['GroupExposedPortArgs', 'GroupExposedPortArgsDict', 'outputs.GroupExposedPort']]]] exposed_ports: Zero or more `exposed_port` blocks as defined below. Changing this forces a new resource to be created.
               
               > **Note:** The `exposed_port` can only contain ports that are also exposed on one or more containers in the group.
        :param pulumi.Input[Union['GroupIdentityArgs', 'GroupIdentityArgsDict', 'outputs.GroupIdentity']] identity: An `identity` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['GroupImageRegistryCredentialArgs', 'GroupImageRegistryCredentialArgsDict', 'outputs.GroupImageRegistryCredential']]]] image_registry_credentials: An `image_registry_credential` block as documented below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['GroupInitContainerArgs', 'GroupInitContainerArgsDict', 'outputs.GroupInitContainer']]]] init_containers: The definition of an init container that is part of the group as documented in the `init_container` block below. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] ip_address_type: Specifies the IP address type of the container. `Public`, `Private` or `None`. Changing this forces a new resource to be created. If set to `Private`, `subnet_ids` also needs to be set. Defaults to `Public`.
    ...
    def get(resource_name: str,
            ...
            subnet_ids: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            zones: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'Group':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dnsNameLabel")
    def dns_name_label(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The DNS label/name for the container group's IP. Changing this forces a new resource to be created.
    ...
    @_builtins.property
    @pulumi.getter(name="dnsNameLabelReusePolicy")
    def dns_name_label_reuse_policy(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The value representing the security enum. `Noreuse`, `ResourceGroupReuse`, `SubscriptionReuse`, `TenantReuse` or `Unsecure`. Defaults to `Unsecure`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "dns_name_label_reuse_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="keyVaultUserAssignedIdentityId")
    def key_vault_user_assigned_identity_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The user assigned identity that has access to the Key Vault Key. If not specified, the RP principal named "Azure Container Instance Service" will be used instead. Make sure the identity has the proper `key_permissions` set, at least with `Get`, `UnwrapKey`, `WrapKey` and `GetRotationPolicy`.
        """
        return pulumi.get(self, "key_vault_user_assigned_identity_id")
    ...
    @_builtins.property
    @pulumi.getter(name="subnetIds")
    def subnet_ids(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The subnet resource IDs for a container group. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "subnet_ids")
