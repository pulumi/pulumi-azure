...
class ClusterTrustedAccessRoleBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] kubernetes_cluster_id: Specifies the Kubernetes Cluster Id within which this Kubernetes Cluster Trusted Access Role Binding should exist. Changing this forces a new Kubernetes Cluster Trusted Access Role Binding to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: A list of roles to bind, each item is a resource type qualified role name.
        :param pulumi.Input[builtins.str] source_resource_id: The ARM resource ID of source resource that trusted access is configured for. Changing this forces a new Kubernetes Cluster Trusted Access Role Binding to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Kubernetes Cluster Trusted Access Role Binding. Changing this forces a new Kubernetes Cluster Trusted Access Role Binding to be created.
        """
...
class ClusterTrustedAccessRoleBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            source_resource_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterTrustedAccessRoleBinding':
        """
