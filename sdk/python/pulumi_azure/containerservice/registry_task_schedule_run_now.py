...
class RegistryTaskScheduleRunNowArgs:
    def __init__(__self__, *,
                 container_registry_task_id: pulumi.Input[builtins.str]):
        """
    ...
    def container_registry_task_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def container_registry_task_id(self, value: pulumi.Input[builtins.str]):
...
class _RegistryTaskScheduleRunNowState:
    def __init__(__self__, *,
                 container_registry_task_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="containerRegistryTaskId")
    def container_registry_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Container Registry Task that to be scheduled. Changing this forces a new Container Registry Task Schedule to be created.
        """
        return pulumi.get(self, "container_registry_task_id")
    ...
    @container_registry_task_id.setter
    def container_registry_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_registry_task_id", value)
...
class RegistryTaskScheduleRunNow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            container_registry_task_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RegistryTaskScheduleRunNow':
        """
    ...
    @property
    @pulumi.getter(name="containerRegistryTaskId")
    def container_registry_task_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Container Registry Task that to be scheduled. Changing this forces a new Container Registry Task Schedule to be created.
        """
        return pulumi.get(self, "container_registry_task_id")
