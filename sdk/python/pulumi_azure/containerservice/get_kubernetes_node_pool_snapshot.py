...
def get_kubernetes_node_pool_snapshot(name: Optional[builtins.str] = None,
...
def get_kubernetes_node_pool_snapshot_output(name: Optional[pulumi.Input[builtins.str]] = None,
