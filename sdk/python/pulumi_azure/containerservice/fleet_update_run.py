...
class FleetUpdateRunArgs:
    def __init__(__self__, *,
                 ...
                 fleet_update_strategy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kubernetes_fleet_manager_id: The ID of the Fleet Manager. Changing this forces a new Kubernetes Fleet Update Run to be created.
        ...
        :param pulumi.Input[builtins.str] fleet_update_strategy_id: The ID of the Fleet Update Strategy. Only one of `fleet_update_strategy_id` or `stage` can be specified.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Kubernetes Fleet Update Run. Changing this forces a new Kubernetes Fleet Update Run to be created.
    ...
    def fleet_update_strategy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fleet_update_strategy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FleetUpdateRun(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="fleetUpdateStrategyId")
    def fleet_update_strategy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Fleet Update Strategy. Only one of `fleet_update_strategy_id` or `stage` can be specified.
        """
        return pulumi.get(self, "fleet_update_strategy_id")
