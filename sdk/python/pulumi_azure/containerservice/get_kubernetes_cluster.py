...
class GetKubernetesClusterResult:
    ...
    def api_server_authorized_ip_ranges(self) -> Sequence[builtins.str]:
        """
    ...
    def azure_policy_enabled(self) -> builtins.bool:
        """
    ...
    def http_application_routing_enabled(self) -> builtins.bool:
        """
    ...
    def oidc_issuer_enabled(self) -> builtins.bool:
        """
    ...
    def open_service_mesh_enabled(self) -> builtins.bool:
        """
    ...
    def private_cluster_enabled(self) -> builtins.bool:
        """
    ...
    def role_based_access_control_enabled(self) -> builtins.bool:
        """
...
def get_kubernetes_cluster(name: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_group_name: The name of the Resource Group in which the managed Kubernetes Cluster exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_kubernetes_cluster_output(name: Optional[pulumi.Input[builtins.str]] = None,
