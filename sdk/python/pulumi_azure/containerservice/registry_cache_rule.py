...
class RegistryCacheRuleArgs:
    ...
    def source_repo(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @source_repo.setter
    def source_repo(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "source_repo", value)

    @_builtins.property
    @pulumi.getter(name="targetRepo")
    def target_repo(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @target_repo.setter
    def target_repo(self, value: pulumi.Input[_builtins.str]):
...
class RegistryCacheRule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="credentialSetId")
    def credential_set_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ARM resource ID of the Credential Store which is associated with the Cache Rule.
        """
        return pulumi.get(self, "credential_set_id")
    ...
    @_builtins.property
    @pulumi.getter(name="targetRepo")
    def target_repo(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the new repository path to store artifacts. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "target_repo")
