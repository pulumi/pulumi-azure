...
class GetRegistryCacheRuleResult:
    ...
    def credential_set_id(self) -> _builtins.str:
        """
    ...
    def source_repo(self) -> _builtins.str:
        """
    ...
    def target_repo(self) -> _builtins.str:
        """
...
def get_registry_cache_rule(container_registry_id: Optional[_builtins.str] = None,
