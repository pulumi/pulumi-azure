...
def get_registry_token(container_registry_name: Optional[builtins.str] = None,
...
def get_registry_token_output(container_registry_name: Optional[pulumi.Input[builtins.str]] = None,
