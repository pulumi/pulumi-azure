...
class RegistryTokenArgs:
    def __init__(__self__, *,
                 container_registry_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 scope_map_id: pulumi.Input[builtins.str],
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RegistryToken resource.
        :param pulumi.Input[builtins.str] container_registry_name: The name of the Container Registry. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Container Registry token. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] scope_map_id: The ID of the Container Registry Scope Map associated with the token.
        :param pulumi.Input[builtins.bool] enabled: Should the Container Registry token be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the token. Changing this forces a new resource to be created.
        """
    ...
    def container_registry_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def container_registry_name(self, value: pulumi.Input[builtins.str]):
    ...
    def scope_map_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @scope_map_id.setter
    def scope_map_id(self, value: pulumi.Input[builtins.str]):
...
class _RegistryTokenState:
    def __init__(__self__, *,
                 container_registry_name: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 scope_map_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="containerRegistryName")
    def container_registry_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Container Registry. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "container_registry_name")
    ...
    @container_registry_name.setter
    def container_registry_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_registry_name", value)
    ...
    @property
    @pulumi.getter(name="scopeMapId")
    def scope_map_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Container Registry Scope Map associated with the token.
        """
        return pulumi.get(self, "scope_map_id")
    ...
    @scope_map_id.setter
    def scope_map_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scope_map_id", value)
...
class RegistryToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            scope_map_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RegistryToken':
        """
    ...
    @property
    @pulumi.getter(name="containerRegistryName")
    def container_registry_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Container Registry. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "container_registry_name")
    ...
    @property
    @pulumi.getter(name="scopeMapId")
    def scope_map_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Container Registry Scope Map associated with the token.
        """
        return pulumi.get(self, "scope_map_id")
