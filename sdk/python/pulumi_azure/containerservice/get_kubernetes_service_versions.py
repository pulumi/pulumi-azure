...
class GetKubernetesServiceVersionsResult:
    ...
    def include_preview(self) -> Optional[builtins.bool]:
...
def get_kubernetes_service_versions(include_preview: Optional[builtins.bool] = None,
    ...
    * `Microsoft.ContainerService`: 2019-08-01
    ...
    :param builtins.str version_prefix: A prefix filter for the versions of Kubernetes which should be returned; for example `1.` will return `1.9` to `1.14`, whereas `1.12` will return `1.12.2`.
    """
    __args__ = dict()
...
def get_kubernetes_service_versions_output(include_preview: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
