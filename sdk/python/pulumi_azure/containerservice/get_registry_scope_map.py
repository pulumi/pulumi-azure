...
def get_registry_scope_map(container_registry_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.ContainerRegistry`: 2023-11-01-preview
    ...
    :param builtins.str resource_group_name: The Name of the Resource Group where this Container Registry token exists.
    """
    __args__ = dict()
...
def get_registry_scope_map_output(container_registry_name: Optional[pulumi.Input[builtins.str]] = None,
