...
class GetRegistryScopeMapResult:
    ...
    def container_registry_name(self) -> _builtins.str:
...
def get_registry_scope_map(container_registry_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ContainerRegistry` - 2025-04-01
    ...
    :param _builtins.str name: The name of the Container Registry token.
    :param _builtins.str resource_group_name: The Name of the Resource Group where this Container Registry token exists.
    """
    __args__ = dict()
...
def get_registry_scope_map_output(container_registry_name: Optional[pulumi.Input[_builtins.str]] = None,
                                  name: Optional[pulumi.Input[_builtins.str]] = None,
                                  resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRegistryScopeMapResult]:
    """
    Use this data source to access information about an existing Container Registry scope map.
