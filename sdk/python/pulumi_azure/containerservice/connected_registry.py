...
class ConnectedRegistryArgs:
    def __init__(__self__, *,
                 ...
                 sync_token_id: pulumi.Input[builtins.str],
                 audit_log_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 parent_registry_id: Optional[pulumi.Input[builtins.str]] = None,
                 sync_message_ttl: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] parent_registry_id: The ID of the parent registry. This can be either a Container Registry ID or a Connected Registry ID. Changing this forces a new Container Connected Registry to be created.
        :param pulumi.Input[builtins.str] sync_message_ttl: The period of time (in form of ISO8601) for which a message is available to sync before it is expired. Allowed range is from `P1D` to `P90D`. Defaults to `P1D`.
        :param pulumi.Input[builtins.str] sync_schedule: The cron expression indicating the schedule that the Connected Registry will sync with its parent. Defaults to `* * * * *`.
        :param pulumi.Input[builtins.str] sync_window: The time window (in form of ISO8601) during which sync is enabled for each schedule occurrence. Allowed range is from `PT3H` to `P7D`.
        """
    ...
    def sync_token_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sync_token_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sync_token_id", value)

    @property
    @pulumi.getter(name="auditLogEnabled")
    def audit_log_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def audit_log_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def parent_registry_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_registry_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_registry_id", value)

    @property
    @pulumi.getter(name="syncMessageTtl")
    def sync_message_ttl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_message_ttl(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ConnectedRegistryState:
    def __init__(__self__, *,
                 ...
                 sync_message_ttl: Optional[pulumi.Input[builtins.str]] = None,
                 sync_schedule: Optional[pulumi.Input[builtins.str]] = None,
                 sync_token_id: Optional[pulumi.Input[builtins.str]] = None,
                 sync_window: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="syncTokenId")
    def sync_token_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Container Registry Token which is used for synchronizing the Connected Registry. Changing this forces a new Container Connected Registry to be created.
        """
        return pulumi.get(self, "sync_token_id")
    ...
    @sync_token_id.setter
    def sync_token_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sync_token_id", value)
...
class ConnectedRegistry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sync_schedule: Optional[pulumi.Input[builtins.str]] = None,
            sync_token_id: Optional[pulumi.Input[builtins.str]] = None,
            sync_window: Optional[pulumi.Input[builtins.str]] = None) -> 'ConnectedRegistry':
        """
    ...
    @property
    @pulumi.getter(name="auditLogEnabled")
    def audit_log_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the log auditing be enabled?
        """
        return pulumi.get(self, "audit_log_enabled")
    ...
    @property
    @pulumi.getter(name="parentRegistryId")
    def parent_registry_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the parent registry. This can be either a Container Registry ID or a Connected Registry ID. Changing this forces a new Container Connected Registry to be created.
        """
        return pulumi.get(self, "parent_registry_id")
    ...
    @property
    @pulumi.getter(name="syncMessageTtl")
    def sync_message_ttl(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The period of time (in form of ISO8601) for which a message is available to sync before it is expired. Allowed range is from `P1D` to `P90D`. Defaults to `P1D`.
        """
        return pulumi.get(self, "sync_message_ttl")
    ...
    @property
    @pulumi.getter(name="syncTokenId")
    def sync_token_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Container Registry Token which is used for synchronizing the Connected Registry. Changing this forces a new Container Connected Registry to be created.
        """
        return pulumi.get(self, "sync_token_id")
    ...
    @property
    @pulumi.getter(name="syncWindow")
    def sync_window(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time window (in form of ISO8601) during which sync is enabled for each schedule occurrence. Allowed range is from `PT3H` to `P7D`.
        """
        return pulumi.get(self, "sync_window")
