...
class ConnectedRegistryArgs:
    def __init__(__self__, *,
                 ...
                 audit_log_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 notifications: pulumi.Input[Optional[Sequence[pulumi.Input['ConnectedRegistryNotificationArgs']]]] = None,
                 parent_registry_id: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_message_ttl: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def audit_log_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def audit_log_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    @_builtins.property
    @pulumi.getter
    def notifications(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ConnectedRegistryNotificationArgs']]]]:
        """
    ...
    def notifications(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ConnectedRegistryNotificationArgs']]]]):
        pulumi.set(self, "notifications", value)

    @_builtins.property
    @pulumi.getter(name="parentRegistryId")
    def parent_registry_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def parent_registry_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "parent_registry_id", value)

    @_builtins.property
    @pulumi.getter(name="syncMessageTtl")
    def sync_message_ttl(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def sync_message_ttl(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _ConnectedRegistryState:
    def __init__(__self__, *,
                 ...
                 sync_message_ttl: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_schedule: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_token_id: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_window: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="syncTokenId")
    def sync_token_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ID of the Container Registry Token which is used for synchronizing the Connected Registry. Changing this forces a new Container Connected Registry to be created.
        """
        return pulumi.get(self, "sync_token_id")
    ...
    @sync_token_id.setter
    def sync_token_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sync_token_id", value)
...
class ConnectedRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 mode: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 notifications: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ConnectedRegistryNotificationArgs', 'ConnectedRegistryNotificationArgsDict', 'outputs.ConnectedRegistryNotification']]]]] = None,
                 parent_registry_id: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_message_ttl: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_schedule: pulumi.Input[Optional[_builtins.str]] = None,
                 sync_token_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `Microsoft.ContainerRegistry` - 2025-11-01
        ...
        :param pulumi.Input[_builtins.str] mode: The mode of the Connected Registry. Possible values are `Mirror`, `ReadOnly`, `ReadWrite` and `Registry`. Changing this forces a new Container Connected Registry to be created. Defaults to `ReadWrite`.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Container Connected Registry. Changing this forces a new Container Connected Registry to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ConnectedRegistryNotificationArgs', 'ConnectedRegistryNotificationArgsDict', 'outputs.ConnectedRegistryNotification']]]] notifications: One or more `notification` blocks as defined below.
        :param pulumi.Input[_builtins.str] parent_registry_id: The ID of the parent registry. This can be either a Container Registry ID or a Connected Registry ID. Changing this forces a new Container Connected Registry to be created.
        :param pulumi.Input[_builtins.str] sync_message_ttl: The period of time (in form of ISO8601) for which a message is available to sync before it is expired. Allowed range is from `P1D` to `P90D`. Defaults to `P1D`.
        :param pulumi.Input[_builtins.str] sync_schedule: The cron expression indicating the schedule that the Connected Registry will sync with its parent. Defaults to `* * * * *`.
        :param pulumi.Input[_builtins.str] sync_token_id: The ID of the Container Registry Token which is used for synchronizing the Connected Registry. Changing this forces a new Container Connected Registry to be created.
    ...
    def get(resource_name: str,
            ...
            sync_schedule: pulumi.Input[Optional[_builtins.str]] = None,
            sync_token_id: pulumi.Input[Optional[_builtins.str]] = None,
            sync_window: pulumi.Input[Optional[_builtins.str]] = None) -> 'ConnectedRegistry':
        """
