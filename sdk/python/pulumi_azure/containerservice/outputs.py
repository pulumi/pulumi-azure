...
class ConnectedRegistryNotification(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action of the artifact that wants to be subscribed for the Connected Registry. Possible values are `push`, `delete` and `*` (i.e. any).
...
class FleetUpdateRunManagedClusterUpdateNodeImageSelection(dict):
    def __init__(__self__, *,
                 type: builtins.str):
        """
        :param builtins.str type: Specifies the node image upgrade type. Possible values are `Latest` and `Consistent`.
        """
...
class FleetUpdateRunManagedClusterUpdateUpgrade(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of upgrade to perform. Possible values are `Full` and `NodeImageOnly`.
        :param builtins.str kubernetes_version: Specifies the Kubernetes version to upgrade the member clusters to. This is required if `type` is set to `Full`.
        """
        pulumi.set(__self__, "type", type)
...
class FleetUpdateRunStage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 after_stage_wait_in_seconds: Optional[builtins.int] = None):
        """
        :param Sequence['FleetUpdateRunStageGroupArgs'] groups: One or more `group` blocks as defined below.
        :param builtins.str name: The name which should be used for this stage.
        :param builtins.int after_stage_wait_in_seconds: Specifies the time in seconds to wait at the end of this stage before starting the next one.
        """
    ...
    def after_stage_wait_in_seconds(self) -> Optional[builtins.int]:
        """
...
class FleetUpdateRunStageGroup(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: The name which should be used for this group.
        """
        pulumi.set(__self__, "name", name)
...
class FluxConfigurationBlobStorage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 local_auth_reference: Optional[builtins.str] = None,
                 ...
                 sync_interval_in_seconds: Optional[builtins.int] = None,
                 timeout_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.str container_id: Specifies the Azure Blob container ID.
        :param builtins.str account_key: Specifies the account key (shared key) to access the storage account.
        :param builtins.str local_auth_reference: Specifies the name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets.
        :param 'FluxConfigurationBlobStorageManagedIdentityArgs' managed_identity: A `managed_identity` block as defined below.
        :param builtins.str sas_token: Specifies the shared access token to access the storage container.
        :param 'FluxConfigurationBlobStorageServicePrincipalArgs' service_principal: A `service_principal` block as defined below.
        :param builtins.int sync_interval_in_seconds: Specifies the interval at which to re-reconcile the cluster Azure Blob source with the remote.
        :param builtins.int timeout_in_seconds: Specifies the maximum time to attempt to reconcile the cluster Azure Blob source with the remote.
        """
    ...
    def local_auth_reference(self) -> Optional[builtins.str]:
        """
    ...
    def sync_interval_in_seconds(self) -> Optional[builtins.int]:
        """
...
class FluxConfigurationBlobStorageManagedIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_id: Specifies the client ID for authenticating a Managed Identity.
        """
...
class FluxConfigurationBlobStorageServicePrincipal(dict):
    ...
    def __init__(__self__, *,
                 ...
                 client_certificate_base64: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str client_id: Specifies the client ID for authenticating a Service Principal.
        :param builtins.str tenant_id: Specifies the tenant ID for authenticating a Service Principal.
        :param builtins.str client_certificate_base64: Base64-encoded certificate used to authenticate a Service Principal .
        :param builtins.str client_certificate_password: Specifies the password for the certificate used to authenticate a Service Principal .
        ...
        :param builtins.str client_secret: Specifies the client secret for authenticating a Service Principal.
        """
        pulumi.set(__self__, "client_id", client_id)
    ...
    def client_certificate_base64(self) -> Optional[builtins.str]:
        """
...
class FluxConfigurationBucket(dict):
    ...
    def __init__(__self__, *,
                 ...
                 local_auth_reference: Optional[builtins.str] = None,
                 secret_key_base64: Optional[builtins.str] = None,
                 sync_interval_in_seconds: Optional[builtins.int] = None,
                 timeout_in_seconds: Optional[builtins.int] = None,
                 tls_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str bucket_name: Specifies the bucket name to sync from the url endpoint for the flux configuration.
        :param builtins.str url: Specifies the URL to sync for the flux configuration S3 bucket. It must start with `http://` or `https://`.
        :param builtins.str access_key: Specifies the plaintext access key used to securely access the S3 bucket.
        :param builtins.str local_auth_reference: Specifies the name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets. It must be between 1 and 63 characters. It can contain only lowercase letters, numbers, and hyphens (-). It must start and end with a lowercase letter or number.
        :param builtins.str secret_key_base64: Specifies the Base64-encoded secret key used to authenticate with the bucket source.
        :param builtins.int sync_interval_in_seconds: Specifies the interval at which to re-reconcile the cluster git repository source with the remote. Defaults to `600`.
        :param builtins.int timeout_in_seconds: Specifies the maximum time to attempt to reconcile the cluster git repository source with the remote. Defaults to `600`.
        :param builtins.bool tls_enabled: Specify whether to communicate with a bucket using TLS is enabled. Defaults to `true`.
        """
    ...
    def secret_key_base64(self) -> Optional[builtins.str]:
        """
...
class FluxConfigurationGitRepository(dict):
    ...
    def __init__(__self__, *,
                 ...
                 url: builtins.str,
                 https_ca_cert_base64: Optional[builtins.str] = None,
                 https_key_base64: Optional[builtins.str] = None,
                 https_user: Optional[builtins.str] = None,
                 local_auth_reference: Optional[builtins.str] = None,
                 ssh_known_hosts_base64: Optional[builtins.str] = None,
                 ssh_private_key_base64: Optional[builtins.str] = None,
                 sync_interval_in_seconds: Optional[builtins.int] = None,
                 timeout_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.str reference_type: Specifies the source reference type for the GitRepository object. Possible values are `branch`, `commit`, `semver` and `tag`.
        :param builtins.str reference_value: Specifies the source reference value for the GitRepository object.
        :param builtins.str url: Specifies the URL to sync for the flux configuration git repository. It must start with `http://`, `https://`, `git@` or `ssh://`.
        :param builtins.str https_ca_cert_base64: Specifies the Base64-encoded HTTPS certificate authority contents used to access git private git repositories over HTTPS.
        :param builtins.str https_key_base64: Specifies the Base64-encoded HTTPS personal access token or password that will be used to access the repository.
        :param builtins.str https_user: Specifies the plaintext HTTPS username used to access private git repositories over HTTPS.
        :param builtins.str local_auth_reference: Specifies the name of a local secret on the Kubernetes cluster to use as the authentication secret rather than the managed or user-provided configuration secrets. It must be between 1 and 63 characters. It can contain only lowercase letters, numbers, and hyphens (-). It must start and end with a lowercase letter or number.
        :param builtins.str ssh_known_hosts_base64: Specifies the Base64-encoded known_hosts value containing public SSH keys required to access private git repositories over SSH.
        :param builtins.str ssh_private_key_base64: Specifies the Base64-encoded SSH private key in PEM format.
        :param builtins.int sync_interval_in_seconds: Specifies the interval at which to re-reconcile the cluster git repository source with the remote. Defaults to `600`.
        :param builtins.int timeout_in_seconds: Specifies the maximum time to attempt to reconcile the cluster git repository source with the remote. Defaults to `600`.
        """
    ...
    def https_ca_cert_base64(self) -> Optional[builtins.str]:
        """
    ...
    def https_key_base64(self) -> Optional[builtins.str]:
        """
    ...
    def ssh_known_hosts_base64(self) -> Optional[builtins.str]:
        """
    ...
    def ssh_private_key_base64(self) -> Optional[builtins.str]:
        """
...
class FluxConfigurationKustomization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 garbage_collection_enabled: Optional[builtins.bool] = None,
                 path: Optional[builtins.str] = None,
                 post_build: Optional['outputs.FluxConfigurationKustomizationPostBuild'] = None,
                 recreating_enabled: Optional[builtins.bool] = None,
                 retry_interval_in_seconds: Optional[builtins.int] = None,
                 sync_interval_in_seconds: Optional[builtins.int] = None,
                 timeout_in_seconds: Optional[builtins.int] = None,
                 wait: Optional[builtins.bool] = None):
        """
        :param builtins.str name: Specifies the name of the kustomization.
        :param Sequence[builtins.str] depends_ons: Specifies other kustomizations that this kustomization depends on. This kustomization will not reconcile until all dependencies have completed their reconciliation.
        :param builtins.bool garbage_collection_enabled: Whether garbage collections of Kubernetes objects created by this kustomization is enabled. Defaults to `false`.
        :param builtins.str path: Specifies the path in the source reference to reconcile on the cluster.
        :param 'FluxConfigurationKustomizationPostBuildArgs' post_build: A `post_build` block as defined below.
        :param builtins.bool recreating_enabled: Whether re-creating Kubernetes resources on the cluster is enabled when patching fails due to an immutable field change. Defaults to `false`.
        :param builtins.int retry_interval_in_seconds: The interval at which to re-reconcile the kustomization on the cluster in the event of failure on reconciliation. Defaults to `600`.
        :param builtins.int sync_interval_in_seconds: The interval at which to re-reconcile the kustomization on the cluster. Defaults to `600`.
        :param builtins.int timeout_in_seconds: The maximum time to attempt to reconcile the kustomization on the cluster. Defaults to `600`.
        :param builtins.bool wait: Whether to enable health check for all Kubernetes objects created by this Kustomization. Defaults to `true`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def garbage_collection_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def recreating_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def retry_interval_in_seconds(self) -> Optional[builtins.int]:
        """
...
class FluxConfigurationKustomizationPostBuild(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] substitute: Specifies the key/value pairs holding the variables to be substituted in this Kustomization.
...
class FluxConfigurationKustomizationPostBuildSubstituteFrom(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kind: Specifies the source kind to hold the variables to be used in substitution. Possible values are `ConfigMap` and `Secret`.
        :param builtins.str name: Specifies the name of the ConfigMap/Secret that holds the variables to be used in substitution.
        :param builtins.bool optional: Whether to proceed without ConfigMap/Secret if it is not present. Defaults to `false`.
        """
...
class GroupContainer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cpu_limit: Optional[builtins.float] = None,
                 ...
                 memory_limit: Optional[builtins.float] = None,
                 ...
                 secure_environment_variables: Optional[Mapping[str, builtins.str]] = None,
        ...
        """
        :param builtins.float cpu: The required number of CPU cores of the containers. Changing this forces a new resource to be created.
        :param builtins.str image: The container image name. Changing this forces a new resource to be created.
        :param builtins.float memory: The required memory of the containers in GB. Changing this forces a new resource to be created.
        :param builtins.str name: Specifies the name of the Container. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] commands: A list of commands which should be run on the container. Changing this forces a new resource to be created.
        :param builtins.float cpu_limit: The upper limit of the number of CPU cores of the containers.
        :param Mapping[str, builtins.str] environment_variables: A list of environment variables to be set on the container. Specified as a map of name/value pairs. Changing this forces a new resource to be created.
        ...
        :param builtins.float memory_limit: The upper limit of the memory of the containers in GB.
        ...
        :param Mapping[str, builtins.str] secure_environment_variables: A list of sensitive environment variables to be set on the container. Specified as a map of name/value pairs. Changing this forces a new resource to be created.
    ...
    def cpu_limit(self) -> Optional[builtins.float]:
        """
    ...
    def memory_limit(self) -> Optional[builtins.float]:
        """
    ...
    def secure_environment_variables(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class GroupContainerLivenessProbe(dict):
    ...
    def __init__(__self__, *,
                 execs: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param Sequence[builtins.str] execs: Commands to be run to validate container readiness. Changing this forces a new resource to be created.
        :param builtins.int failure_threshold: How many times to try the probe before restarting the container (liveness probe) or marking the container as unhealthy (readiness probe). Changing this forces a new resource to be created.
        ...
        :param builtins.int initial_delay_seconds: Number of seconds after the container has started before liveness or readiness probes are initiated. Changing this forces a new resource to be created.
        :param builtins.int period_seconds: How often (in seconds) to perform the probe. Changing this forces a new resource to be created.
        :param builtins.int success_threshold: Minimum consecutive successes for the probe to be considered successful after having failed. Changing this forces a new resource to be created.
        :param builtins.int timeout_seconds: Number of seconds after which the probe times out. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def execs(self) -> Optional[Sequence[builtins.str]]:
        """
...
class GroupContainerLivenessProbeHttpGet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] http_headers: A map of HTTP headers used to access on the container. Changing this forces a new resource to be created.
        :param builtins.str path: Path to access on the HTTP server. Changing this forces a new resource to be created.
        :param builtins.int port: Number of the port to access on the container. Changing this forces a new resource to be created.
        :param builtins.str scheme: Scheme to use for connecting to the host. Possible values are `Http` and `Https`. Changing this forces a new resource to be created.
        """
...
class GroupContainerPort(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int port: The port number the container will expose. Changing this forces a new resource to be created.
        :param builtins.str protocol: The network protocol associated with port. Possible values are `TCP` & `UDP`. Changing this forces a new resource to be created. Defaults to `TCP`.
...
class GroupContainerSecurity(dict):
    ...
    def __init__(__self__, *,
                 privilege_enabled: builtins.bool):
        """
    ...
    def privilege_enabled(self) -> builtins.bool:
        """
...
class GroupContainerVolume(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 empty_dir: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.str mount_path: The path on which this volume is to be mounted. Changing this forces a new resource to be created.
        :param builtins.str name: The name of the volume mount. Changing this forces a new resource to be created.
    ...
    def empty_dir(self) -> Optional[builtins.bool]:
        """
...
class GroupContainerVolumeGitRepo(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str url: Specifies the Git repository to be cloned. Changing this forces a new resource to be created.
        :param builtins.str directory: Specifies the directory into which the repository should be cloned. Changing this forces a new resource to be created.
        :param builtins.str revision: Specifies the commit hash of the revision to be cloned. If unspecified, the HEAD revision is cloned. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "url", url)
...
class GroupDiagnosticsLogAnalytics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str workspace_id: The Workspace ID of the Log Analytics Workspace. Changing this forces a new resource to be created.
        :param builtins.str workspace_key: The Workspace Key of the Log Analytics Workspace. Changing this forces a new resource to be created.
        :param builtins.str log_type: The log type which should be used. Possible values are `ContainerInsights` and `ContainerInstanceLogs`. Changing this forces a new resource to be created.
        :param Mapping[str, builtins.str] metadata: Any metadata required for Log Analytics. Changing this forces a new resource to be created.
        """
...
class GroupDnsConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 search_domains: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] nameservers: A list of nameservers the containers will search out to resolve requests. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] options: A list of [resolver configuration options](https://man7.org/linux/man-pages/man5/resolv.conf.5.html). Changing this forces a new resource to be created.
        :param Sequence[builtins.str] search_domains: A list of search domains that DNS requests will search along. Changing this forces a new resource to be created.
        """
    ...
    def search_domains(self) -> Optional[Sequence[builtins.str]]:
        """
...
class GroupImageRegistryCredential(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str server: The address to use to connect to the registry without protocol ("https"/"http"). For example: "myacr.acr.io". Changing this forces a new resource to be created.
        :param builtins.str password: The password with which to connect to the registry. Changing this forces a new resource to be created.
        :param builtins.str user_assigned_identity_id: The identity ID for the private registry. Changing this forces a new resource to be created.
        :param builtins.str username: The username with which to connect to the registry. Changing this forces a new resource to be created.
        """
...
class KubernetesClusterAciConnectorLinux(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str subnet_name: The subnet name for the virtual nodes to run.
...
class KubernetesClusterAciConnectorLinuxConnectorIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_assigned_identity_id: Optional[builtins.str] = None):
        """
        :param builtins.str client_id: The Client ID of the user-defined Managed Identity used for Web App Routing.
        :param builtins.str object_id: The Object ID of the user-defined Managed Identity used for Web App Routing
        :param builtins.str user_assigned_identity_id: The ID of the User Assigned Identity used for Web App Routing.
        """
...
class KubernetesClusterApiServerAccessProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] authorized_ip_ranges: Set of authorized IP ranges to allow access to API server, e.g. ["198.51.100.0/24"].
        """
...
class KubernetesClusterAutoScalerProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 daemonset_eviction_for_empty_nodes_enabled: Optional[builtins.bool] = None,
                 daemonset_eviction_for_occupied_nodes_enabled: Optional[builtins.bool] = None,
                 empty_bulk_delete_max: Optional[builtins.str] = None,
                 expander: Optional[builtins.str] = None,
                 ignore_daemonsets_utilization_enabled: Optional[builtins.bool] = None,
                 max_graceful_termination_sec: Optional[builtins.str] = None,
                 max_node_provisioning_time: Optional[builtins.str] = None,
                 max_unready_nodes: Optional[builtins.int] = None,
                 max_unready_percentage: Optional[builtins.float] = None,
                 new_pod_scale_up_delay: Optional[builtins.str] = None,
                 scale_down_delay_after_add: Optional[builtins.str] = None,
                 scale_down_delay_after_delete: Optional[builtins.str] = None,
                 scale_down_delay_after_failure: Optional[builtins.str] = None,
                 scale_down_unneeded: Optional[builtins.str] = None,
                 scale_down_unready: Optional[builtins.str] = None,
                 scale_down_utilization_threshold: Optional[builtins.str] = None,
                 scan_interval: Optional[builtins.str] = None,
                 skip_nodes_with_local_storage: Optional[builtins.bool] = None,
                 skip_nodes_with_system_pods: Optional[builtins.bool] = None):
        """
        :param builtins.bool balance_similar_node_groups: Detect similar node groups and balance the number of nodes between them. Defaults to `false`.
        :param builtins.bool daemonset_eviction_for_empty_nodes_enabled: Whether DaemonSet pods will be gracefully terminated from empty nodes. Defaults to `false`.
        :param builtins.bool daemonset_eviction_for_occupied_nodes_enabled: Whether DaemonSet pods will be gracefully terminated from non-empty nodes. Defaults to `true`.
        :param builtins.str empty_bulk_delete_max: Maximum number of empty nodes that can be deleted at the same time. Defaults to `10`.
        :param builtins.str expander: Expander to use. Possible values are `least-waste`, `priority`, `most-pods` and `random`. Defaults to `random`.
        :param builtins.bool ignore_daemonsets_utilization_enabled: Whether DaemonSet pods will be ignored when calculating resource utilization for scale down. Defaults to `false`.
        :param builtins.str max_graceful_termination_sec: Maximum number of seconds the cluster autoscaler waits for pod termination when trying to scale down a node. Defaults to `600`.
        :param builtins.str max_node_provisioning_time: Maximum time the autoscaler waits for a node to be provisioned. Defaults to `15m`.
        :param builtins.int max_unready_nodes: Maximum Number of allowed unready nodes. Defaults to `3`.
        :param builtins.float max_unready_percentage: Maximum percentage of unready nodes the cluster autoscaler will stop if the percentage is exceeded. Defaults to `45`.
        :param builtins.str new_pod_scale_up_delay: For scenarios like burst/batch scale where you don't want CA to act before the kubernetes scheduler could schedule all the pods, you can tell CA to ignore unscheduled pods before they're a certain age. Defaults to `10s`.
        :param builtins.str scale_down_delay_after_add: How long after the scale up of AKS nodes the scale down evaluation resumes. Defaults to `10m`.
        :param builtins.str scale_down_delay_after_delete: How long after node deletion that scale down evaluation resumes. Defaults to the value used for `scan_interval`.
        :param builtins.str scale_down_delay_after_failure: How long after scale down failure that scale down evaluation resumes. Defaults to `3m`.
        :param builtins.str scale_down_unneeded: How long a node should be unneeded before it is eligible for scale down. Defaults to `10m`.
        :param builtins.str scale_down_unready: How long an unready node should be unneeded before it is eligible for scale down. Defaults to `20m`.
        :param builtins.str scale_down_utilization_threshold: Node utilization level, defined as sum of requested resources divided by capacity, below which a node can be considered for scale down. Defaults to `0.5`.
        :param builtins.str scan_interval: How often the AKS Cluster should be re-evaluated for scale up/down. Defaults to `10s`.
        :param builtins.bool skip_nodes_with_local_storage: If `true` cluster autoscaler will never delete nodes with pods with local storage, for example, EmptyDir or HostPath. Defaults to `true`.
        :param builtins.bool skip_nodes_with_system_pods: If `true` cluster autoscaler will never delete nodes with pods from kube-system (except for DaemonSet or mirror pods). Defaults to `true`.
        """
    ...
    def daemonset_eviction_for_empty_nodes_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def daemonset_eviction_for_occupied_nodes_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def empty_bulk_delete_max(self) -> Optional[builtins.str]:
        """
    ...
    def ignore_daemonsets_utilization_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def max_graceful_termination_sec(self) -> Optional[builtins.str]:
        """
    ...
    def max_node_provisioning_time(self) -> Optional[builtins.str]:
        """
    ...
    def max_unready_nodes(self) -> Optional[builtins.int]:
        """
    ...
    def max_unready_percentage(self) -> Optional[builtins.float]:
        """
    ...
    def new_pod_scale_up_delay(self) -> Optional[builtins.str]:
        """
    ...
    def scale_down_delay_after_delete(self) -> Optional[builtins.str]:
        """
    ...
    def scale_down_delay_after_failure(self) -> Optional[builtins.str]:
        """
    ...
    def scale_down_unneeded(self) -> Optional[builtins.str]:
        """
    ...
    def scale_down_unready(self) -> Optional[builtins.str]:
        """
    ...
    def scale_down_utilization_threshold(self) -> Optional[builtins.str]:
        """
    ...
    def scan_interval(self) -> Optional[builtins.str]:
        """
    ...
    def skip_nodes_with_local_storage(self) -> Optional[builtins.bool]:
        """
    ...
    def skip_nodes_with_system_pods(self) -> Optional[builtins.bool]:
        """
...
class KubernetesClusterAzureActiveDirectoryRoleBasedAccessControl(dict):
    ...
    def __init__(__self__, *,
                 ...
                 azure_rbac_enabled: Optional[builtins.bool] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] admin_group_object_ids: A list of Object IDs of Azure Active Directory Groups which should have Admin Role on the Cluster.
        :param builtins.bool azure_rbac_enabled: Is Role Based Access Control based on Azure AD enabled?
        :param builtins.str tenant_id: The Tenant ID used for Azure Active Directory Application. If this isn't specified the Tenant ID of the current Subscription is used.
        """
    ...
    def azure_rbac_enabled(self) -> Optional[builtins.bool]:
        """
...
class KubernetesClusterConfidentialComputing(dict):
    ...
    def __init__(__self__, *,
                 sgx_quote_helper_enabled: builtins.bool):
        """
        :param builtins.bool sgx_quote_helper_enabled: Should the SGX quote helper be enabled?
        """
        pulumi.set(__self__, "sgx_quote_helper_enabled", sgx_quote_helper_enabled)

    @property
    @pulumi.getter(name="sgxQuoteHelperEnabled")
    def sgx_quote_helper_enabled(self) -> builtins.bool:
        """
...
class KubernetesClusterDefaultNodePool(dict):
    ...
    def __init__(__self__, *,
                 ...
                 gpu_instance: Optional[builtins.str] = None,
                 host_encryption_enabled: Optional[builtins.bool] = None,
                 ...
                 kubelet_disk_type: Optional[builtins.str] = None,
                 ...
                 node_public_ip_enabled: Optional[builtins.bool] = None,
                 node_public_ip_prefix_id: Optional[builtins.str] = None,
                 only_critical_addons_enabled: Optional[builtins.bool] = None,
                 ...
                 pod_subnet_id: Optional[builtins.str] = None,
                 proximity_placement_group_id: Optional[builtins.str] = None,
                 scale_down_mode: Optional[builtins.str] = None,
                 snapshot_id: Optional[builtins.str] = None,
                 tags: Optional[Mapping[str, builtins.str]] = None,
                 temporary_name_for_rotation: Optional[builtins.str] = None,
        ...
        :param builtins.bool host_encryption_enabled: Should the nodes in the Default Node Pool have host encryption enabled? `temporary_name_for_rotation` must be specified when changing this property.
        ...
        :param builtins.str host_group_id: Specifies the ID of the Host Group within which this AKS Cluster should be created. Changing this forces a new resource to be created.
        ...
        :param builtins.str kubelet_disk_type: The type of disk used by kubelet. Possible values are `OS` and `Temporary`. `temporary_name_for_rotation` must be specified when changing this block.
        ...
        :param builtins.int max_pods: The maximum number of pods that can run on each agent. `temporary_name_for_rotation` must be specified when changing this property.
        :param Mapping[str, builtins.str] node_labels: A map of Kubernetes labels which should be applied to nodes in the Default Node Pool.
        ...
        :param builtins.bool node_public_ip_enabled: Should nodes in this Node Pool have a Public IP Address? `temporary_name_for_rotation` must be specified when changing this property.
        :param builtins.str node_public_ip_prefix_id: Resource ID for the Public IP Addresses Prefix for the nodes in this Node Pool. `node_public_ip_enabled` should be `true`. Changing this forces a new resource to be created.
        :param builtins.bool only_critical_addons_enabled: Enabling this option will taint default node pool with `CriticalAddonsOnly=true:NoSchedule` taint. `temporary_name_for_rotation` must be specified when changing this property.
        :param builtins.str orchestrator_version: Version of Kubernetes used for the Agents. If not specified, the default node pool will be created with the version specified by `kubernetes_version`. If both are unspecified, the latest recommended version will be used at provisioning time (but won't auto-upgrade). AKS does not require an exact patch version to be specified, minor version aliases such as `1.22` are also supported. - The minor version's latest GA patch is automatically chosen in that case. More details can be found in [the documentation](https://docs.microsoft.com/en-us/azure/aks/supported-kubernetes-versions?tabs=azure-cli#alias-minor-version).
               
               > **Note:** This version must be supported by the Kubernetes Cluster - as such the version of Kubernetes used on the Cluster/Control Plane may need to be upgraded first.
        :param builtins.int os_disk_size_gb: The size of the OS Disk which should be used for each agent in the Node Pool. `temporary_name_for_rotation` must be specified when attempting a change.
        :param builtins.str os_disk_type: The type of disk which should be used for the Operating System. Possible values are `Ephemeral` and `Managed`. Defaults to `Managed`. `temporary_name_for_rotation` must be specified when attempting a change.
        :param builtins.str os_sku: Specifies the OS SKU used by the agent pool. Possible values are `AzureLinux`, `Ubuntu`, `Windows2019` and `Windows2022`. If not specified, the default is `Ubuntu` if OSType=Linux or `Windows2019` if OSType=Windows. And the default Windows OSSKU will be changed to `Windows2022` after Windows2019 is deprecated. Changing this from `AzureLinux` or `Ubuntu` to `AzureLinux` or `Ubuntu` will not replace the resource, otherwise `temporary_name_for_rotation` must be specified when attempting a change.
        :param builtins.str pod_subnet_id: The ID of the Subnet where the pods in the default Node Pool should exist.
        ...
        :param builtins.str workload_runtime: Specifies the workload runtime used by the node pool. Possible value is `OCIContainer`.
        :param Sequence[builtins.str] zones: Specifies a list of Availability Zones in which this Kubernetes Cluster should be located. `temporary_name_for_rotation` must be specified when changing this property.
    ...
    def gpu_instance(self) -> Optional[builtins.str]:
        """
    ...
    def host_encryption_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def node_public_ip_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def only_critical_addons_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def temporary_name_for_rotation(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterDefaultNodePoolKubeletConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 container_log_max_line: Optional[builtins.int] = None,
                 container_log_max_size_mb: Optional[builtins.int] = None,
                 cpu_cfs_quota_enabled: Optional[builtins.bool] = None,
                 cpu_cfs_quota_period: Optional[builtins.str] = None,
                 cpu_manager_policy: Optional[builtins.str] = None,
                 image_gc_high_threshold: Optional[builtins.int] = None,
                 image_gc_low_threshold: Optional[builtins.int] = None,
                 pod_max_pid: Optional[builtins.int] = None,
                 topology_manager_policy: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] allowed_unsafe_sysctls: Specifies the allow list of unsafe sysctls command or patterns (ending in `*`).
        :param builtins.int container_log_max_line: Specifies the maximum number of container log files that can be present for a container. must be at least 2.
        :param builtins.int container_log_max_size_mb: Specifies the maximum size (e.g. 10MB) of container log file before it is rotated.
        :param builtins.bool cpu_cfs_quota_enabled: Is CPU CFS quota enforcement for containers enabled? Defaults to `true`.
        :param builtins.str cpu_cfs_quota_period: Specifies the CPU CFS quota period value.
        :param builtins.str cpu_manager_policy: Specifies the CPU Manager policy to use. Possible values are `none` and `static`,.
        :param builtins.int image_gc_high_threshold: Specifies the percent of disk usage above which image garbage collection is always run. Must be between `0` and `100`.
        :param builtins.int image_gc_low_threshold: Specifies the percent of disk usage lower than which image garbage collection is never run. Must be between `0` and `100`.
        :param builtins.int pod_max_pid: Specifies the maximum number of processes per pod.
        :param builtins.str topology_manager_policy: Specifies the Topology Manager policy to use. Possible values are `none`, `best-effort`, `restricted` or `single-numa-node`.
        """
    ...
    def container_log_max_line(self) -> Optional[builtins.int]:
        """
    ...
    def container_log_max_size_mb(self) -> Optional[builtins.int]:
        """
    ...
    def cpu_cfs_quota_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def image_gc_high_threshold(self) -> Optional[builtins.int]:
        """
    ...
    def image_gc_low_threshold(self) -> Optional[builtins.int]:
        """
    ...
    def pod_max_pid(self) -> Optional[builtins.int]:
        """
...
class KubernetesClusterDefaultNodePoolLinuxOsConfig(dict):
    ...
    def __init__(__self__, *,
                 swap_file_size_mb: Optional[builtins.int] = None,
                 sysctl_config: Optional['outputs.KubernetesClusterDefaultNodePoolLinuxOsConfigSysctlConfig'] = None,
                 transparent_huge_page_defrag: Optional[builtins.str] = None,
                 transparent_huge_page_enabled: Optional[builtins.str] = None):
        """
        :param builtins.int swap_file_size_mb: Specifies the size of the swap file on each node in MB.
        :param 'KubernetesClusterDefaultNodePoolLinuxOsConfigSysctlConfigArgs' sysctl_config: A `sysctl_config` block as defined below.
        :param builtins.str transparent_huge_page_defrag: specifies the defrag configuration for Transparent Huge Page. Possible values are `always`, `defer`, `defer+madvise`, `madvise` and `never`.
        :param builtins.str transparent_huge_page_enabled: Specifies the Transparent Huge Page enabled configuration. Possible values are `always`, `madvise` and `never`.
        """
    ...
    def swap_file_size_mb(self) -> Optional[builtins.int]:
        """
    ...
    def transparent_huge_page_defrag(self) -> Optional[builtins.str]:
        """
    ...
    def transparent_huge_page_enabled(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterDefaultNodePoolLinuxOsConfigSysctlConfig(dict):
    ...
    def __init__(__self__, *,
                 fs_aio_max_nr: Optional[builtins.int] = None,
                 fs_file_max: Optional[builtins.int] = None,
                 fs_inotify_max_user_watches: Optional[builtins.int] = None,
                 fs_nr_open: Optional[builtins.int] = None,
                 kernel_threads_max: Optional[builtins.int] = None,
                 net_core_netdev_max_backlog: Optional[builtins.int] = None,
                 net_core_optmem_max: Optional[builtins.int] = None,
                 net_core_rmem_default: Optional[builtins.int] = None,
                 net_core_rmem_max: Optional[builtins.int] = None,
                 net_core_somaxconn: Optional[builtins.int] = None,
                 net_core_wmem_default: Optional[builtins.int] = None,
                 net_core_wmem_max: Optional[builtins.int] = None,
                 net_ipv4_ip_local_port_range_max: Optional[builtins.int] = None,
                 net_ipv4_ip_local_port_range_min: Optional[builtins.int] = None,
                 net_ipv4_neigh_default_gc_thresh1: Optional[builtins.int] = None,
                 net_ipv4_neigh_default_gc_thresh2: Optional[builtins.int] = None,
                 net_ipv4_neigh_default_gc_thresh3: Optional[builtins.int] = None,
                 net_ipv4_tcp_fin_timeout: Optional[builtins.int] = None,
                 net_ipv4_tcp_keepalive_intvl: Optional[builtins.int] = None,
                 net_ipv4_tcp_keepalive_probes: Optional[builtins.int] = None,
                 net_ipv4_tcp_keepalive_time: Optional[builtins.int] = None,
                 net_ipv4_tcp_max_syn_backlog: Optional[builtins.int] = None,
                 net_ipv4_tcp_max_tw_buckets: Optional[builtins.int] = None,
                 net_ipv4_tcp_tw_reuse: Optional[builtins.bool] = None,
                 net_netfilter_nf_conntrack_buckets: Optional[builtins.int] = None,
                 net_netfilter_nf_conntrack_max: Optional[builtins.int] = None,
                 vm_max_map_count: Optional[builtins.int] = None,
                 vm_swappiness: Optional[builtins.int] = None,
                 vm_vfs_cache_pressure: Optional[builtins.int] = None):
        """
        :param builtins.int fs_aio_max_nr: The sysctl setting fs.aio-max-nr. Must be between `65536` and `6553500`.
        :param builtins.int fs_file_max: The sysctl setting fs.file-max. Must be between `8192` and `12000500`.
        :param builtins.int fs_inotify_max_user_watches: The sysctl setting fs.inotify.max_user_watches. Must be between `781250` and `2097152`.
        :param builtins.int fs_nr_open: The sysctl setting fs.nr_open. Must be between `8192` and `20000500`.
        :param builtins.int kernel_threads_max: The sysctl setting kernel.threads-max. Must be between `20` and `513785`.
        :param builtins.int net_core_netdev_max_backlog: The sysctl setting net.core.netdev_max_backlog. Must be between `1000` and `3240000`.
        :param builtins.int net_core_optmem_max: The sysctl setting net.core.optmem_max. Must be between `20480` and `4194304`.
        :param builtins.int net_core_rmem_default: The sysctl setting net.core.rmem_default. Must be between `212992` and `134217728`.
        :param builtins.int net_core_rmem_max: The sysctl setting net.core.rmem_max. Must be between `212992` and `134217728`.
        :param builtins.int net_core_somaxconn: The sysctl setting net.core.somaxconn. Must be between `4096` and `3240000`.
        :param builtins.int net_core_wmem_default: The sysctl setting net.core.wmem_default. Must be between `212992` and `134217728`.
        :param builtins.int net_core_wmem_max: The sysctl setting net.core.wmem_max. Must be between `212992` and `134217728`.
        :param builtins.int net_ipv4_ip_local_port_range_max: The sysctl setting net.ipv4.ip_local_port_range max value. Must be between `32768` and `65535`.
        :param builtins.int net_ipv4_ip_local_port_range_min: The sysctl setting net.ipv4.ip_local_port_range min value. Must be between `1024` and `60999`.
        :param builtins.int net_ipv4_neigh_default_gc_thresh1: The sysctl setting net.ipv4.neigh.default.gc_thresh1. Must be between `128` and `80000`.
        :param builtins.int net_ipv4_neigh_default_gc_thresh2: The sysctl setting net.ipv4.neigh.default.gc_thresh2. Must be between `512` and `90000`.
        :param builtins.int net_ipv4_neigh_default_gc_thresh3: The sysctl setting net.ipv4.neigh.default.gc_thresh3. Must be between `1024` and `100000`.
        :param builtins.int net_ipv4_tcp_fin_timeout: The sysctl setting net.ipv4.tcp_fin_timeout. Must be between `5` and `120`.
        :param builtins.int net_ipv4_tcp_keepalive_intvl: The sysctl setting net.ipv4.tcp_keepalive_intvl. Must be between `10` and `90`.
        :param builtins.int net_ipv4_tcp_keepalive_probes: The sysctl setting net.ipv4.tcp_keepalive_probes. Must be between `1` and `15`.
        :param builtins.int net_ipv4_tcp_keepalive_time: The sysctl setting net.ipv4.tcp_keepalive_time. Must be between `30` and `432000`.
        :param builtins.int net_ipv4_tcp_max_syn_backlog: The sysctl setting net.ipv4.tcp_max_syn_backlog. Must be between `128` and `3240000`.
        :param builtins.int net_ipv4_tcp_max_tw_buckets: The sysctl setting net.ipv4.tcp_max_tw_buckets. Must be between `8000` and `1440000`.
        :param builtins.bool net_ipv4_tcp_tw_reuse: The sysctl setting net.ipv4.tcp_tw_reuse.
        :param builtins.int net_netfilter_nf_conntrack_buckets: The sysctl setting net.netfilter.nf_conntrack_buckets. Must be between `65536` and `524288`.
        :param builtins.int net_netfilter_nf_conntrack_max: The sysctl setting net.netfilter.nf_conntrack_max. Must be between `131072` and `2097152`.
        :param builtins.int vm_max_map_count: The sysctl setting vm.max_map_count. Must be between `65530` and `262144`.
        :param builtins.int vm_swappiness: The sysctl setting vm.swappiness. Must be between `0` and `100`.
        :param builtins.int vm_vfs_cache_pressure: The sysctl setting vm.vfs_cache_pressure. Must be between `0` and `100`.
        """
    ...
    def fs_aio_max_nr(self) -> Optional[builtins.int]:
        """
    ...
    def fs_file_max(self) -> Optional[builtins.int]:
        """
    ...
    def fs_inotify_max_user_watches(self) -> Optional[builtins.int]:
        """
    ...
    def kernel_threads_max(self) -> Optional[builtins.int]:
        """
    ...
    def net_core_netdev_max_backlog(self) -> Optional[builtins.int]:
        """
    ...
    def net_core_optmem_max(self) -> Optional[builtins.int]:
        """
    ...
    def net_core_somaxconn(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_ip_local_port_range_max(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_ip_local_port_range_min(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_neigh_default_gc_thresh1(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_neigh_default_gc_thresh2(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_neigh_default_gc_thresh3(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_tcp_fin_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_tcp_keepalive_intvl(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_tcp_keepalive_probes(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_tcp_keepalive_time(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_tcp_max_syn_backlog(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_tcp_max_tw_buckets(self) -> Optional[builtins.int]:
        """
    ...
    def net_ipv4_tcp_tw_reuse(self) -> Optional[builtins.bool]:
        """
    ...
    def net_netfilter_nf_conntrack_buckets(self) -> Optional[builtins.int]:
        """
    ...
    def net_netfilter_nf_conntrack_max(self) -> Optional[builtins.int]:
        """
    ...
    def vm_vfs_cache_pressure(self) -> Optional[builtins.int]:
        """
...
class KubernetesClusterDefaultNodePoolNodeNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 node_public_ip_tags: Optional[Mapping[str, builtins.str]] = None):
        """
        ...
        :param Sequence[builtins.str] application_security_group_ids: A list of Application Security Group IDs which should be associated with this Node Pool.
        :param Mapping[str, builtins.str] node_public_ip_tags: Specifies a mapping of tags to the instance-level public IPs. Changing this forces a new resource to be created.
        """
    ...
    def node_public_ip_tags(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class KubernetesClusterDefaultNodePoolNodeNetworkProfileAllowedHostPort(dict):
    ...
    def __init__(__self__, *,
                 ...
                 protocol: Optional[builtins.str] = None):
        """
        :param builtins.int port_end: Specifies the end of the port range.
        :param builtins.int port_start: Specifies the start of the port range.
        :param builtins.str protocol: Specifies the protocol of the port range. Possible values are `TCP` and `UDP`.
        """
...
class KubernetesClusterDefaultNodePoolUpgradeSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 drain_timeout_in_minutes: Optional[builtins.int] = None,
                 node_soak_duration_in_minutes: Optional[builtins.int] = None):
        """
        :param builtins.str max_surge: The maximum number or percentage of nodes which will be added to the Node Pool size during an upgrade.
    ...
    def drain_timeout_in_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def node_soak_duration_in_minutes(self) -> Optional[builtins.int]:
        """
...
class KubernetesClusterExtensionPlan(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies the name of the plan from the marketplace. Changing this forces a new Kubernetes Cluster Extension to be created.
        :param builtins.str product: Specifies the product of the plan from the marketplace. Changing this forces a new Kubernetes Cluster Extension to be created.
        :param builtins.str publisher: Specifies the publisher of the plan. Changing this forces a new Kubernetes Cluster Extension to be created.
...
class KubernetesClusterHttpProxyConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str http_proxy: The proxy address to be used when communicating over HTTP.
        :param builtins.str https_proxy: The proxy address to be used when communicating over HTTPS.
        :param builtins.str trusted_ca: The base64 encoded alternative CA certificate content in PEM format.
        """
...
class KubernetesClusterIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Kubernetes Cluster. Possible values are `SystemAssigned` or `UserAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Kubernetes Cluster.
...
class KubernetesClusterIngressApplicationGateway(dict):
    ...
    def __init__(__self__, *,
                 effective_gateway_id: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str effective_gateway_id: The ID of the Application Gateway associated with the ingress controller deployed to this Kubernetes Cluster.
        :param builtins.str gateway_id: The ID of the Application Gateway to integrate with the ingress controller of this Kubernetes Cluster. See [this](https://docs.microsoft.com/azure/application-gateway/tutorial-ingress-controller-add-on-existing) page for further details.
        :param builtins.str gateway_name: The name of the Application Gateway to be used or created in the Nodepool Resource Group, which in turn will be integrated with the ingress controller of this Kubernetes Cluster. See [this](https://docs.microsoft.com/azure/application-gateway/tutorial-ingress-controller-add-on-new) page for further details.
    ...
    def effective_gateway_id(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterKeyManagementService(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_vault_network_access: Optional[builtins.str] = None):
        """
        :param builtins.str key_vault_key_id: Identifier of Azure Key Vault key. See [key identifier format](https://learn.microsoft.com/en-us/azure/key-vault/general/about-keys-secrets-certificates#vault-name-and-object-name) for more details.
        :param builtins.str key_vault_network_access: Network access of the key vault Network access of key vault. The possible values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private` means the key vault disables public access and enables private link. Defaults to `Public`.
        """
    ...
    def key_vault_network_access(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterKeyVaultSecretsProvider(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret_rotation_enabled: Optional[builtins.bool] = None,
                 secret_rotation_interval: Optional[builtins.str] = None):
        """
        ...
        :param builtins.bool secret_rotation_enabled: Should the secret store CSI driver on the AKS cluster be enabled?
        :param builtins.str secret_rotation_interval: The interval to poll for secret rotation. This attribute is only set when `secret_rotation_enabled` is true. Defaults to `2m`.
    ...
    def secret_rotation_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def secret_rotation_interval(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterKubeAdminConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username: Optional[builtins.str] = None):
        """
        :param builtins.str client_certificate: Base64 encoded public certificate used by clients to authenticate to the Kubernetes cluster.
        :param builtins.str client_key: Base64 encoded private key used by clients to authenticate to the Kubernetes cluster.
        :param builtins.str cluster_ca_certificate: Base64 encoded public CA certificate used as the root of trust for the Kubernetes cluster.
        :param builtins.str host: The Kubernetes cluster server host.
        :param builtins.str password: A password or token used to authenticate to the Kubernetes cluster.
        :param builtins.str username: A username used to authenticate to the Kubernetes cluster.
        """
...
class KubernetesClusterKubeletIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_assigned_identity_id: Optional[builtins.str] = None):
        """
        :param builtins.str client_id: The Client ID of the user-defined Managed Identity to be assigned to the Kubelets. If not specified a Managed Identity is created automatically. Changing this forces a new resource to be created.
        :param builtins.str object_id: The Object ID of the user-defined Managed Identity assigned to the Kubelets.If not specified a Managed Identity is created automatically. Changing this forces a new resource to be created.
        :param builtins.str user_assigned_identity_id: The ID of the User Assigned Identity assigned to the Kubelets. If not specified a Managed Identity is created automatically. Changing this forces a new resource to be created.
        """
        if client_id is not None:
            pulumi.set(__self__, "client_id", client_id)
        if object_id is not None:
...
class KubernetesClusterLinuxProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str admin_username: The Admin Username for the Cluster. Changing this forces a new resource to be created.
...
class KubernetesClusterLinuxProfileSshKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_data: The Public SSH Key used to access the cluster. Changing this forces a new resource to be created.
        """
...
class KubernetesClusterMaintenanceWindowAllowed(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day: A day in a week. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday` and `Saturday`.
        :param Sequence[builtins.int] hours: An array of hour slots in a day. For example, specifying `1` will allow maintenance from 1:00am to 2:00am. Specifying `1`, `2` will allow maintenance from 1:00am to 3:00m. Possible values are between `0` and `23`.
        """
...
class KubernetesClusterMaintenanceWindowAutoUpgrade(dict):
    ...
    def __init__(__self__, *,
                 ...
                 utc_offset: Optional[builtins.str] = None,
                 week_index: Optional[builtins.str] = None):
        """
        :param builtins.int duration: The duration of the window for maintenance to run in hours. Possible options are between `4` to `24`.
        :param builtins.str frequency: Frequency of maintenance. Possible options are `Weekly`, `AbsoluteMonthly` and `RelativeMonthly`.
        :param builtins.int interval: The interval for maintenance runs. Depending on the frequency this interval is week or month based.
        :param builtins.int day_of_month: The day of the month for the maintenance run. Required in combination with AbsoluteMonthly frequency. Value between 0 and 31 (inclusive).
        :param builtins.str day_of_week: The day of the week for the maintenance run. Required in combination with weekly frequency. Possible values are `Friday`, `Monday`, `Saturday`, `Sunday`, `Thursday`, `Tuesday` and `Wednesday`.
        ...
        :param builtins.str start_date: The date on which the maintenance window begins to take effect.
        :param builtins.str start_time: The time for maintenance to begin, based on the timezone determined by `utc_offset`. Format is `HH:mm`.
        :param builtins.str utc_offset: Used to determine the timezone for cluster maintenance.
        :param builtins.str week_index: Specifies on which instance of the allowed days specified in `day_of_week` the maintenance occurs. Options are `First`, `Second`, `Third`, `Fourth`, and `Last`.
    ...
    def utc_offset(self) -> Optional[builtins.str]:
        """
    ...
    def week_index(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterMaintenanceWindowAutoUpgradeNotAllowed(dict):
    def __init__(__self__, *,
                 ...
                 start: builtins.str):
        """
        :param builtins.str end: The end of a time span, formatted as an RFC3339 string.
        :param builtins.str start: The start of a time span, formatted as an RFC3339 string.
        """
...
class KubernetesClusterMaintenanceWindowNodeOs(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int duration: The duration of the window for maintenance to run in hours. Possible options are between `4` to `24`.
        :param builtins.str frequency: Frequency of maintenance. Possible options are `Daily`, `Weekly`, `AbsoluteMonthly` and `RelativeMonthly`.
        :param builtins.int interval: The interval for maintenance runs. Depending on the frequency this interval is week or month based.
        :param builtins.int day_of_month: The day of the month for the maintenance run. Required in combination with AbsoluteMonthly frequency. Value between 0 and 31 (inclusive).
        :param builtins.str day_of_week: The day of the week for the maintenance run. Required in combination with weekly frequency. Possible values are `Friday`, `Monday`, `Saturday`, `Sunday`, `Thursday`, `Tuesday` and `Wednesday`.
        ...
        :param builtins.str start_time: The time for maintenance to begin, based on the timezone determined by `utc_offset`. Format is `HH:mm`.
        :param builtins.str utc_offset: Used to determine the timezone for cluster maintenance.
        :param builtins.str week_index: The week in the month used for the maintenance run. Options are `First`, `Second`, `Third`, `Fourth`, and `Last`.
        """
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "frequency", frequency)
        pulumi.set(__self__, "interval", interval)
...
class KubernetesClusterMicrosoftDefender(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_analytics_workspace_id: Specifies the ID of the Log Analytics Workspace where the audit logs collected by Microsoft Defender should be sent to.
        """
...
class KubernetesClusterMonitorMetrics(dict):
    ...
    def __init__(__self__, *,
                 annotations_allowed: Optional[builtins.str] = None,
                 labels_allowed: Optional[builtins.str] = None):
        """
        :param builtins.str annotations_allowed: Specifies a comma-separated list of Kubernetes annotation keys that will be used in the resource's labels metric.
        :param builtins.str labels_allowed: Specifies a Comma-separated list of additional Kubernetes label keys that will be used in the resource's labels metric.
    ...
    def annotations_allowed(self) -> Optional[builtins.str]:
        """
    ...
    def labels_allowed(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_versions: Optional[Sequence[builtins.str]] = None,
                 ...
                 network_data_plane: Optional[builtins.str] = None,
                 network_mode: Optional[builtins.str] = None,
                 network_plugin_mode: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str network_plugin: Network plugin to use for networking. Currently supported values are `azure`, `kubenet` and `none`. Changing this forces a new resource to be created.
        ...
        :param builtins.str network_data_plane: Specifies the data plane used for building the Kubernetes network. Possible values are `azure` and `cilium`. Defaults to `azure`. Disabling this forces a new resource to be created.
        ...
        :param builtins.str network_mode: Network mode to be used with Azure CNI. Possible values are `bridge` and `transparent`. Changing this forces a new resource to be created.
        ...
        :param builtins.str network_plugin_mode: Specifies the network plugin mode used for building the Kubernetes network. Possible value is `overlay`.
        ...
        :param builtins.str network_policy: Sets up network policy to be used with Azure CNI. [Network policy allows us to control the traffic flow between pods](https://docs.microsoft.com/azure/aks/use-network-policies). Currently supported values are `calico`, `azure` and `cilium`.
               
               > **Note:** When `network_policy` is set to `azure`, the `network_plugin` field can only be set to `azure`.
               
               > **Note:** When `network_policy` is set to `cilium`, the `network_data_plane` field must be set to `cilium`.
        :param builtins.str outbound_type: The outbound (egress) routing method which should be used for this Kubernetes Cluster. Possible values are `loadBalancer`, `userDefinedRouting`, `managedNATGateway` and `userAssignedNATGateway`. Defaults to `loadBalancer`. More information on supported migration paths for `outbound_type` can be found in [this documentation](https://learn.microsoft.com/azure/aks/egress-outboundtype#updating-outboundtype-after-cluster-creation).
        :param builtins.str pod_cidr: The CIDR to use for pod IP addresses. This field can only be set when `network_plugin` is set to `kubenet` or `network_plugin_mode` is set to `overlay`. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] pod_cidrs: A list of CIDRs to use for pod IP addresses. For single-stack networking a single IPv4 CIDR is expected. For dual-stack networking an IPv4 and IPv6 CIDR are expected. Changing this forces a new resource to be created.
        :param builtins.str service_cidr: The Network Range used by the Kubernetes service. Changing this forces a new resource to be created.
    ...
    def ip_versions(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def network_data_plane(self) -> Optional[builtins.str]:
        """
    ...
    def network_plugin_mode(self) -> Optional[builtins.str]:
        """
...
class KubernetesClusterNetworkProfileLoadBalancerProfile(dict):
    ...
    def __init__(__self__, *,
                 backend_pool_type: Optional[builtins.str] = None,
                 effective_outbound_ips: Optional[Sequence[builtins.str]] = None,
                 idle_timeout_in_minutes: Optional[builtins.int] = None,
                 managed_outbound_ip_count: Optional[builtins.int] = None,
                 managed_outbound_ipv6_count: Optional[builtins.int] = None,
                 outbound_ip_address_ids: Optional[Sequence[builtins.str]] = None,
                 outbound_ip_prefix_ids: Optional[Sequence[builtins.str]] = None,
                 outbound_ports_allocated: Optional[builtins.int] = None):
        """
        :param builtins.str backend_pool_type: The type of the managed inbound Load Balancer Backend Pool. Possible values are `NodeIP` and `NodeIPConfiguration`. Defaults to `NodeIPConfiguration`. See [the documentation](https://learn.microsoft.com/en-us/azure/aks/load-balancer-standard#change-the-inbound-pool-type) for more information.
        :param Sequence[builtins.str] effective_outbound_ips: The outcome (resource IDs) of the specified arguments.
        :param builtins.int idle_timeout_in_minutes: Desired outbound flow idle timeout in minutes for the cluster load balancer. Must be between `4` and `100` inclusive. Defaults to `30`.
        :param builtins.int managed_outbound_ip_count: Count of desired managed outbound IPs for the cluster load balancer. Must be between `1` and `100` inclusive.
        :param builtins.int managed_outbound_ipv6_count: The desired number of IPv6 outbound IPs created and managed by Azure for the cluster load balancer. Must be in the range of 1 to 100 (inclusive). The default value is 0 for single-stack and 1 for dual-stack.
        ...
        :param Sequence[builtins.str] outbound_ip_address_ids: The ID of the Public IP Addresses which should be used for outbound communication for the cluster load balancer.
        ...
        :param Sequence[builtins.str] outbound_ip_prefix_ids: The ID of the outbound Public IP Address Prefixes which should be used for the cluster load balancer.
        ...
        :param builtins.int outbound_ports_allocated: Number of desired SNAT port for each VM in the clusters load balancer. Must be between `0` and `64000` inclusive. Defaults to `0`.
        """
    ...
    def backend_pool_type(self) -> Optional[builtins.str]:
        """
    ...
    def effective_outbound_ips(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def managed_outbound_ip_count(self) -> Optional[builtins.int]:
        """
    ...
    def managed_outbound_ipv6_count(self) -> Optional[builtins.int]:
        """
    ...
    def outbound_ip_address_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def outbound_ip_prefix_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def outbound_ports_allocated(self) -> Optional[builtins.int]:
        """
...
class KubernetesClusterNetworkProfileNatGatewayProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] effective_outbound_ips: The outcome (resource IDs) of the specified arguments.
        :param builtins.int idle_timeout_in_minutes: Desired outbound flow idle timeout in minutes for the managed nat gateway. Must be between `4` and `120` inclusive. Defaults to `4`.
        :param builtins.int managed_outbound_ip_count: Count of desired managed outbound IPs for the managed nat gateway. Must be between `1` and `16` inclusive.
        """
        if effective_outbound_ips is not None:
            pulumi.set(__self__, "effective_outbound_ips", effective_outbound_ips)
        if idle_timeout_in_minutes is not None:
...
class KubernetesClusterNodePoolLinuxOsConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 transparent_huge_page_enabled: Optional[builtins.str] = None):
        """
        :param builtins.int swap_file_size_mb: Specifies the size of swap file on each node in MB.
...
class KubernetesClusterNodePoolLinuxOsConfigSysctlConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int net_ipv4_tcp_max_syn_backlog: The sysctl setting net.ipv4.tcp_max_syn_backlog. Must be between `128` and `3240000`.
        :param builtins.int net_ipv4_tcp_max_tw_buckets: The sysctl setting net.ipv4.tcp_max_tw_buckets. Must be between `8000` and `1440000`.
        :param builtins.bool net_ipv4_tcp_tw_reuse: Is sysctl setting net.ipv4.tcp_tw_reuse enabled?
        :param builtins.int net_netfilter_nf_conntrack_buckets: The sysctl setting net.netfilter.nf_conntrack_buckets. Must be between `65536` and `524288`.
        :param builtins.int net_netfilter_nf_conntrack_max: The sysctl setting net.netfilter.nf_conntrack_max. Must be between `131072` and `2097152`.
        :param builtins.int vm_max_map_count: The sysctl setting vm.max_map_count. Must be between `65530` and `262144`.
        :param builtins.int vm_swappiness: The sysctl setting vm.swappiness. Must be between `0` and `100`.
...
class KubernetesClusterNodePoolUpgradeSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int node_soak_duration_in_minutes: The amount of time in minutes to wait after draining a node and before reimaging and moving on to next node.
        """
        pulumi.set(__self__, "max_surge", max_surge)
        if drain_timeout_in_minutes is not None:
            pulumi.set(__self__, "drain_timeout_in_minutes", drain_timeout_in_minutes)
...
class KubernetesClusterNodePoolWindowsProfile(dict):
    ...
    def __init__(__self__, *,
                 outbound_nat_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool outbound_nat_enabled: Should the Windows nodes in this Node Pool have outbound NAT enabled? Defaults to `true`. Changing this forces a new resource to be created.
    ...
    def outbound_nat_enabled(self) -> Optional[builtins.bool]:
        """
...
class KubernetesClusterOmsAgent(dict):
    ...
    def __init__(__self__, *,
                 log_analytics_workspace_id: builtins.str,
                 msi_auth_for_monitoring_enabled: Optional[builtins.bool] = None,
                 oms_agent_identities: Optional[Sequence['outputs.KubernetesClusterOmsAgentOmsAgentIdentity']] = None):
        """
        :param builtins.str log_analytics_workspace_id: The ID of the Log Analytics Workspace which the OMS Agent should send data to.
        :param builtins.bool msi_auth_for_monitoring_enabled: Is managed identity authentication for monitoring enabled?
    ...
    def msi_auth_for_monitoring_enabled(self) -> Optional[builtins.bool]:
        """
...
class KubernetesClusterServiceMeshProfile(dict):
    ...
    def __init__(__self__, *,
                 mode: builtins.str,
                 revisions: Sequence[builtins.str],
                 certificate_authority: Optional['outputs.KubernetesClusterServiceMeshProfileCertificateAuthority'] = None,
                 external_ingress_gateway_enabled: Optional[builtins.bool] = None,
                 internal_ingress_gateway_enabled: Optional[builtins.bool] = None):
        """
    ...
    @property
    @pulumi.getter
    def revisions(self) -> Sequence[builtins.str]:
        """
    ...
    def external_ingress_gateway_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def internal_ingress_gateway_enabled(self) -> Optional[builtins.bool]:
        """
...
class KubernetesClusterServiceMeshProfileCertificateAuthority(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cert_chain_object_name: The certificate chain object name in Azure Key Vault.
        :param builtins.str cert_object_name: The intermediate certificate object name in Azure Key Vault.
        :param builtins.str key_object_name: The intermediate certificate private key object name in Azure Key Vault.
        ...
        :param builtins.str key_vault_id: The resource ID of the Key Vault.
        :param builtins.str root_cert_object_name: The root certificate object name in Azure Key Vault.
        """
...
class KubernetesClusterStorageProfile(dict):
    ...
    def __init__(__self__, *,
                 blob_driver_enabled: Optional[builtins.bool] = None,
                 disk_driver_enabled: Optional[builtins.bool] = None,
                 file_driver_enabled: Optional[builtins.bool] = None,
                 snapshot_controller_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool blob_driver_enabled: Is the Blob CSI driver enabled? Defaults to `false`.
        :param builtins.bool disk_driver_enabled: Is the Disk CSI driver enabled? Defaults to `true`.
        :param builtins.bool file_driver_enabled: Is the File CSI driver enabled? Defaults to `true`.
        :param builtins.bool snapshot_controller_enabled: Is the Snapshot Controller enabled? Defaults to `true`.
        """
    ...
    def blob_driver_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def disk_driver_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def file_driver_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def snapshot_controller_enabled(self) -> Optional[builtins.bool]:
        """
...
class KubernetesClusterUpgradeOverride(dict):
    ...
    def __init__(__self__, *,
                 force_upgrade_enabled: builtins.bool,
                 effective_until: Optional[builtins.str] = None):
        """
        :param builtins.bool force_upgrade_enabled: Whether to force upgrade the cluster. Possible values are `true` or `false`.
        ...
        :param builtins.str effective_until: Specifies the duration, in RFC 3339 format (e.g., `2025-10-01T13:00:00Z`), the `upgrade_override` values are effective. This field must be set for the `upgrade_override` values to take effect. The date-time must be within the next 30 days.
    ...
    def force_upgrade_enabled(self) -> builtins.bool:
        """
...
class KubernetesClusterWebAppRouting(dict):
    ...
    def __init__(__self__, *,
                 dns_zone_ids: Sequence[builtins.str],
                 web_app_routing_identities: Optional[Sequence['outputs.KubernetesClusterWebAppRoutingWebAppRoutingIdentity']] = None):
        """
        :param Sequence[builtins.str] dns_zone_ids: Specifies the list of the DNS Zone IDs in which DNS entries are created for applications deployed to the cluster when Web App Routing is enabled. If not using Bring-Your-Own DNS zones this property should be set to an empty list.
    ...
    def dns_zone_ids(self) -> Sequence[builtins.str]:
        """
...
class KubernetesClusterWindowsProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str admin_password: The Admin Password for Windows VMs. Length must be between 14 and 123 characters.
        :param builtins.str admin_username: The Admin Username for Windows VMs. Changing this forces a new resource to be created.
        :param 'KubernetesClusterWindowsProfileGmsaArgs' gmsa: A `gmsa` block as defined below.
        :param builtins.str license: Specifies the type of on-premise license which should be used for Node Pool Windows Virtual Machine. At this time the only possible value is `Windows_Server`.
        """
...
class KubernetesClusterWindowsProfileGmsa(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dns_server: Specifies the DNS server for Windows gMSA. Set this to an empty string if you have configured the DNS server in the VNet which was used to create the managed cluster.
        :param builtins.str root_domain: Specifies the root domain name for Windows gMSA. Set this to an empty string if you have configured the DNS server in the VNet which was used to create the managed cluster.
...
class KubernetesClusterWorkloadAutoscalerProfile(dict):
    ...
    def __init__(__self__, *,
                 keda_enabled: Optional[builtins.bool] = None,
                 vertical_pod_autoscaler_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool keda_enabled: Specifies whether KEDA Autoscaler can be used for workloads.
        :param builtins.bool vertical_pod_autoscaler_enabled: Specifies whether Vertical Pod Autoscaler should be enabled.
    ...
    def keda_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def vertical_pod_autoscaler_enabled(self) -> Optional[builtins.bool]:
        """
...
class RegistryCredentialSetIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type of Managed Service Identity that is configured on for the Container Registry Credential Set. Currently the only possible value is `SystemAssigned`.
...
class RegistryEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_vault_key_id: builtins.str):
        """
        :param builtins.str identity_client_id: The client ID of the managed identity associated with the encryption key.
...
class RegistryGeoreplication(dict):
    ...
    def __init__(__self__, *,
                 ...
                 regional_endpoint_enabled: Optional[builtins.bool] = None,
                 tags: Optional[Mapping[str, builtins.str]] = None,
                 zone_redundancy_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str location: A location where the container registry should be geo-replicated.
        :param builtins.bool regional_endpoint_enabled: Whether regional endpoint is enabled for this Container Registry?
    ...
    def regional_endpoint_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def zone_redundancy_enabled(self) -> Optional[builtins.bool]:
        """
...
class RegistryNetworkRuleSetIpRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The behaviour for requests matching this rule. At this time the only supported value is `Allow`
        :param builtins.str ip_range: The CIDR block from which requests will match the rule.
        """
        pulumi.set(__self__, "action", action)
...
class RegistryTaskAgentSetting(dict):
    def __init__(__self__, *,
                 cpu: builtins.int):
        """
        :param builtins.int cpu: The number of cores required for the Container Registry Task. Possible value is `2`.
        """
        pulumi.set(__self__, "cpu", cpu)
...
class RegistryTaskBaseImageTrigger(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name which should be used for this trigger.
        :param builtins.str type: The type of the trigger. Possible values are `All` and `Runtime`.
        :param builtins.bool enabled: Should the trigger be enabled? Defaults to `true`.
        :param builtins.str update_trigger_endpoint: The endpoint URL for receiving the trigger.
        :param builtins.str update_trigger_payload_type: Type of payload body for the trigger. Possible values are `Default` and `Token`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class RegistryTaskDockerStep(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache_enabled: Optional[builtins.bool] = None,
                 image_names: Optional[Sequence[builtins.str]] = None,
                 push_enabled: Optional[builtins.bool] = None,
                 secret_arguments: Optional[Mapping[str, builtins.str]] = None,
                 target: Optional[builtins.str] = None):
        """
        :param builtins.str context_access_token: The token (Git PAT or SAS token of storage account blob) associated with the context for this step.
        :param builtins.str context_path: The URL (absolute or relative) of the source context for this step. If the context is an url you can reference a specific branch or folder via `#branch:folder`.
        :param builtins.str dockerfile_path: The Dockerfile path relative to the source context.
        :param Mapping[str, builtins.str] arguments: Specifies a map of arguments to be used when executing this step.
        :param builtins.bool cache_enabled: Should the image cache be enabled? Defaults to `true`.
        :param Sequence[builtins.str] image_names: Specifies a list of fully qualified image names including the repository and tag.
        :param builtins.bool push_enabled: Should the image built be pushed to the registry or not? Defaults to `true`.
        :param Mapping[str, builtins.str] secret_arguments: Specifies a map of *secret* arguments to be used when executing this step.
    ...
    def cache_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def push_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def secret_arguments(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class RegistryTaskEncodedStep(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret_values: Optional[Mapping[str, builtins.str]] = None,
                 value_content: Optional[builtins.str] = None,
                 values: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str task_content: The (optionally base64 encoded) content of the build template.
        :param builtins.str context_access_token: The token (Git PAT or SAS token of storage account blob) associated with the context for this step.
        :param builtins.str context_path: The URL (absolute or relative) of the source context for this step.
        :param Mapping[str, builtins.str] secret_values: Specifies a map of secret values that can be passed when running a task.
        :param builtins.str value_content: The (optionally base64 encoded) content of the build parameters.
        :param Mapping[str, builtins.str] values: Specifies a map of values that can be passed when running a task.
        """
    ...
    def secret_values(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def value_content(self) -> Optional[builtins.str]:
        """
...
class RegistryTaskFileStep(dict):
    ...
    def __init__(__self__, *,
                 ...
                 context_path: Optional[builtins.str] = None,
                 secret_values: Optional[Mapping[str, builtins.str]] = None,
                 value_file_path: Optional[builtins.str] = None,
                 values: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str task_file_path: The task template file path relative to the source context.
        :param builtins.str context_access_token: The token (Git PAT or SAS token of storage account blob) associated with the context for this step.
        :param builtins.str context_path: The URL (absolute or relative) of the source context for this step.
        :param Mapping[str, builtins.str] secret_values: Specifies a map of secret values that can be passed when running a task.
        :param builtins.str value_file_path: The parameters file path relative to the source context.
        :param Mapping[str, builtins.str] values: Specifies a map of values that can be passed when running a task.
        """
    ...
    def value_file_path(self) -> Optional[builtins.str]:
        """
...
class RegistryTaskPlatform(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str os: The operating system type required for the task. Possible values are `Windows` and `Linux`.
        :param builtins.str architecture: The OS architecture. Possible values are `amd64`, `x86`, `386`, `arm` and `arm64`.
        :param builtins.str variant: The variant of the CPU. Possible values are `v6`, `v7`, `v8`.
        """
...
class RegistryTaskRegistryCredentialCustom(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username: Optional[builtins.str] = None):
        """
        :param builtins.str login_server: The login server of the custom Container Registry.
        :param builtins.str identity: The managed identity assigned to this custom credential. For user assigned identity, the value is the client ID of the identity. For system assigned identity, the value is `[system]`.
        :param builtins.str password: The password for logging into the custom Container Registry. It can be either a plain text of password, or a Keyvault Secret ID.
        :param builtins.str username: The username for logging into the custom Container Registry. It can be either a plain text of username, or a Keyvault Secret ID.
        """
...
class RegistryTaskRegistryCredentialSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str login_mode: The login mode for the source registry. Possible values are `None` and `Default`.
        """
...
class RegistryTaskSourceTrigger(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] events: Specifies a list of source events corresponding to the trigger. Possible values are `commit` and `pullrequest`.
        :param builtins.str name: The name which should be used for this trigger.
        :param builtins.str repository_url: The full URL to the source code repository.
        :param builtins.str source_type: The type of the source control service. Possible values are `Github` and `VisualStudioTeamService`.
...
class RegistryTaskSourceTriggerAuthentication(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expire_in_seconds: Optional[builtins.int] = None,
        ...
        :param builtins.str token_type: The type of the token. Possible values are `PAT` (personal access token) and `OAuth`.
        :param builtins.int expire_in_seconds: Time in seconds that the token remains valid.
    ...
    def expire_in_seconds(self) -> Optional[builtins.int]:
        """
...
class TokenPasswordPassword1(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str expiry: The expiration date of the password in RFC3339 format. If not specified, the password never expires. Changing this forces a new resource to be created.
        :param builtins.str value: The value of the password (Sensitive).
        """
...
class GetClusterNodePoolUpgradeSettingResult(dict):
    def __init__(__self__, *,
                 drain_timeout_in_minutes: builtins.int,
                 max_surge: builtins.str,
                 node_soak_duration_in_minutes: builtins.int):
        """
        :param builtins.int drain_timeout_in_minutes: The amount of time in minutes to wait on eviction of pods and graceful termination per node. This eviction wait time honors waiting on pod disruption budgets. If this time is exceeded, the upgrade fails.
        :param builtins.str max_surge: The maximum number or percentage of nodes which will be added to the Node Pool size during an upgrade.
        :param builtins.int node_soak_duration_in_minutes: The amount of time in minutes to wait after draining a node and before reimaging it and moving on to next node.
        """
        pulumi.set(__self__, "drain_timeout_in_minutes", drain_timeout_in_minutes)
        pulumi.set(__self__, "max_surge", max_surge)
        pulumi.set(__self__, "node_soak_duration_in_minutes", node_soak_duration_in_minutes)
    ...
    @property
    @pulumi.getter(name="drainTimeoutInMinutes")
    def drain_timeout_in_minutes(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="nodeSoakDurationInMinutes")
    def node_soak_duration_in_minutes(self) -> builtins.int:
        """
...
class GetGroupIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Container Group.
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Container Group.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Container Group.
        :param builtins.str type: Type of Managed Service Identity configured on this Container Group.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetKubernetesClusterAgentPoolProfileResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 node_labels: Mapping[str, builtins.str],
                 node_public_ip_enabled: builtins.bool,
                 node_public_ip_prefix_id: builtins.str,
                 node_taints: Sequence[builtins.str],
        ...
        """
        :param builtins.bool auto_scaling_enabled: If the auto-scaler is enabled.
        :param builtins.int count: The number of Agents (VMs) in the Pool.
        :param builtins.int max_count: Maximum number of nodes for auto-scaling
        :param builtins.int max_pods: The maximum number of pods that can run on each agent.
        :param builtins.int min_count: Minimum number of nodes for auto-scaling
        :param builtins.str name: The name of the managed Kubernetes Cluster.
        :param builtins.bool node_public_ip_enabled: If the Public IPs for the nodes in this Agent Pool are enabled.
        :param builtins.str node_public_ip_prefix_id: Resource ID for the Public IP Addresses Prefix for the nodes in this Agent Pool.
        :param builtins.str orchestrator_version: Kubernetes version used for the Agents.
        :param builtins.int os_disk_size_gb: The size of the Agent VM's Operating System Disk in GB.
        :param builtins.str os_type: The Operating System used for the Agents.
        :param Mapping[str, builtins.str] tags: A mapping of tags to assign to the resource.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Kubernetes Cluster.
        ...
        :param builtins.str vm_size: The size of each VM in the Agent Pool (e.g. `Standard_F1`).
        :param builtins.str vnet_subnet_id: The ID of the Subnet where the Agents in the Pool are provisioned.
        :param Sequence[builtins.str] zones: A list of Availability Zones in which this Kubernetes Cluster is located.
        """
        pulumi.set(__self__, "auto_scaling_enabled", auto_scaling_enabled)
    ...
    @property
    @pulumi.getter(name="autoScalingEnabled")
    def auto_scaling_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="nodePublicIpEnabled")
    def node_public_ip_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="osDiskSizeGb")
    def os_disk_size_gb(self) -> builtins.int:
        """
...
class GetKubernetesClusterAgentPoolProfileUpgradeSettingResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int drain_timeout_in_minutes: The amount of time in minutes to wait on eviction of pods and graceful termination per node. This eviction wait time honors waiting on pod disruption budgets. If this time is exceeded, the upgrade fails.
        :param builtins.str max_surge: The maximum number or percentage of nodes that will be added to the Node Pool size during an upgrade.
        :param builtins.int node_soak_duration_in_minutes: The amount of time in minutes to wait after draining a node and before reimaging it and moving on to next node.
        """
        pulumi.set(__self__, "drain_timeout_in_minutes", drain_timeout_in_minutes)
        pulumi.set(__self__, "max_surge", max_surge)
...
class GetKubernetesClusterAzureActiveDirectoryRoleBasedAccessControlResult(dict):
    def __init__(__self__, *,
                 ...
                 azure_rbac_enabled: builtins.bool,
                 tenant_id: builtins.str):
        """
        :param Sequence[builtins.str] admin_group_object_ids: A list of Object IDs of Azure Active Directory Groups which should have Admin Role on the Cluster.
        :param builtins.bool azure_rbac_enabled: Is Role Based Access Control based on Azure AD enabled?
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Kubernetes Cluster.
        """
        pulumi.set(__self__, "admin_group_object_ids", admin_group_object_ids)
        pulumi.set(__self__, "azure_rbac_enabled", azure_rbac_enabled)
        pulumi.set(__self__, "tenant_id", tenant_id)
    ...
    @property
    @pulumi.getter(name="azureRbacEnabled")
    def azure_rbac_enabled(self) -> builtins.bool:
        """
        Is Role Based Access Control based on Azure AD enabled?
        """
        return pulumi.get(self, "azure_rbac_enabled")
...
class GetKubernetesClusterIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Kubernetes Cluster.
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Kubernetes Cluster.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Kubernetes Cluster.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Kubernetes Cluster.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
...
class GetKubernetesClusterIngressApplicationGatewayResult(dict):
    def __init__(__self__, *,
                 effective_gateway_id: builtins.str,
        ...
        """
        :param builtins.str effective_gateway_id: The ID of the Application Gateway associated with the ingress controller deployed to this Kubernetes Cluster.
        :param builtins.str gateway_id: The ID of the Application Gateway integrated with the ingress controller of this Kubernetes Cluster. This attribute is only set when gateway_id is specified when configuring the `ingress_application_gateway` addon.
        ...
        :param builtins.str subnet_cidr: The subnet CIDR used to create an Application Gateway, which in turn will be integrated with the ingress controller of this Kubernetes Cluster. This attribute is only set when `subnet_cidr` is specified when configuring the `ingress_application_gateway` addon.
        :param builtins.str subnet_id: The ID of the subnet on which to create an Application Gateway, which in turn will be integrated with the ingress controller of this Kubernetes Cluster. This attribute is only set when `subnet_id` is specified when configuring the `ingress_application_gateway` addon.
        """
        pulumi.set(__self__, "effective_gateway_id", effective_gateway_id)
        pulumi.set(__self__, "gateway_id", gateway_id)
        pulumi.set(__self__, "gateway_name", gateway_name)
...
class GetKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentityResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_id: The Client ID of the user-defined Managed Identity assigned to the Kubelets.
        :param builtins.str object_id: The Object ID of the user-defined Managed Identity assigned to the Kubelets.
        :param builtins.str user_assigned_identity_id: The ID of the User Assigned Identity assigned to the Kubelets.
        """
        pulumi.set(__self__, "client_id", client_id)
        pulumi.set(__self__, "object_id", object_id)
        pulumi.set(__self__, "user_assigned_identity_id", user_assigned_identity_id)
...
class GetKubernetesClusterKeyManagementServiceResult(dict):
    def __init__(__self__, *,
                 key_vault_key_id: builtins.str,
                 key_vault_network_access: builtins.str):
        """
        :param builtins.str key_vault_key_id: Identifier of Azure Key Vault key. See [key identifier format](https://learn.microsoft.com/en-us/azure/key-vault/general/about-keys-secrets-certificates#vault-name-and-object-name) for more details.
        :param builtins.str key_vault_network_access: Network access of the key vault. The possible values are `Public` and `Private`. `Public` means the key vault allows public access from all networks. `Private` means the key vault disables public access and enables private link.
        """
        pulumi.set(__self__, "key_vault_key_id", key_vault_key_id)
        pulumi.set(__self__, "key_vault_network_access", key_vault_network_access)
...
class GetKubernetesClusterKeyVaultSecretsProviderResult(dict):
    def __init__(__self__, *,
                 ...
                 secret_rotation_enabled: builtins.bool,
                 secret_rotation_interval: builtins.str):
        """
        ...
        :param builtins.bool secret_rotation_enabled: Is secret rotation enabled?
        :param builtins.str secret_rotation_interval: The interval to poll for secret rotation.
        """
        pulumi.set(__self__, "secret_identities", secret_identities)
        pulumi.set(__self__, "secret_rotation_enabled", secret_rotation_enabled)
        pulumi.set(__self__, "secret_rotation_interval", secret_rotation_interval)
    ...
    @property
    @pulumi.getter(name="secretRotationEnabled")
    def secret_rotation_enabled(self) -> builtins.bool:
        """
...
class GetKubernetesClusterLinuxProfileResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str admin_username: The username associated with the administrator account of the Windows VMs.
...
class GetKubernetesClusterLinuxProfileSshKeyResult(dict):
    def __init__(__self__, *,
                 key_data: builtins.str):
        """
        :param builtins.str key_data: The Public SSH Key used to access the cluster.
        """
        pulumi.set(__self__, "key_data", key_data)
...
class GetKubernetesClusterMicrosoftDefenderResult(dict):
    def __init__(__self__, *,
                 log_analytics_workspace_id: builtins.str):
        """
        :param builtins.str log_analytics_workspace_id: The ID of the Log Analytics Workspace to which the OMS Agent should send data.
        """
        pulumi.set(__self__, "log_analytics_workspace_id", log_analytics_workspace_id)
...
class GetKubernetesClusterNetworkProfileResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dns_service_ip: IP address within the Kubernetes service address range used by cluster service discovery (kube-dns).
        :param builtins.str docker_bridge_cidr: IP address (in CIDR notation) used as the Docker bridge IP address on nodes.
        :param builtins.str network_plugin: Network plugin used such as `azure` or `kubenet`.
        :param builtins.str network_policy: Network policy to be used with Azure CNI. e.g. `calico` or `azure`
        :param builtins.str pod_cidr: The CIDR used for pod IP addresses.
        :param builtins.str service_cidr: Network range used by the Kubernetes service.
        """
        pulumi.set(__self__, "dns_service_ip", dns_service_ip)
...
class GetKubernetesClusterOmsAgentResult(dict):
    def __init__(__self__, *,
                 log_analytics_workspace_id: builtins.str,
                 msi_auth_for_monitoring_enabled: builtins.bool,
    ...
    @property
    @pulumi.getter(name="msiAuthForMonitoringEnabled")
    def msi_auth_for_monitoring_enabled(self) -> builtins.bool:
        """
        Is managed identity authentication for monitoring enabled?
        """
        return pulumi.get(self, "msi_auth_for_monitoring_enabled")
...
class GetKubernetesClusterServiceMeshProfileResult(dict):
    def __init__(__self__, *,
                 ...
                 external_ingress_gateway_enabled: builtins.bool,
                 internal_ingress_gateway_enabled: builtins.bool,
                 mode: builtins.str,
                 revisions: Sequence[builtins.str]):
        """
        ...
        :param builtins.bool external_ingress_gateway_enabled: Is Istio External Ingress Gateway enabled?
        :param builtins.bool internal_ingress_gateway_enabled: Is Istio Internal Ingress Gateway enabled?
        :param builtins.str mode: The mode of the service mesh.
        :param Sequence[builtins.str] revisions: List of revisions of the Istio control plane. When an upgrade is not in progress, this holds one value. When canary upgrade is in progress, this can only hold two consecutive values. Learn More.
        """
    ...
    @property
    @pulumi.getter(name="externalIngressGatewayEnabled")
    def external_ingress_gateway_enabled(self) -> builtins.bool:
        """
        Is Istio External Ingress Gateway enabled?
        """
        return pulumi.get(self, "external_ingress_gateway_enabled")
    ...
    @property
    @pulumi.getter(name="internalIngressGatewayEnabled")
    def internal_ingress_gateway_enabled(self) -> builtins.bool:
        """
        Is Istio Internal Ingress Gateway enabled?
        """
        return pulumi.get(self, "internal_ingress_gateway_enabled")
...
class GetKubernetesClusterStorageProfileResult(dict):
    def __init__(__self__, *,
                 blob_driver_enabled: builtins.bool,
                 disk_driver_enabled: builtins.bool,
                 file_driver_enabled: builtins.bool,
                 snapshot_controller_enabled: builtins.bool):
        """
        :param builtins.bool blob_driver_enabled: Is the Blob CSI driver enabled?
        :param builtins.bool disk_driver_enabled: Is the Disk CSI driver enabled?
        :param builtins.bool file_driver_enabled: Is the File CSI driver enabled?
        :param builtins.bool snapshot_controller_enabled: Is the Snapshot Controller enabled?
        """
        pulumi.set(__self__, "blob_driver_enabled", blob_driver_enabled)
        pulumi.set(__self__, "disk_driver_enabled", disk_driver_enabled)
        pulumi.set(__self__, "file_driver_enabled", file_driver_enabled)
    ...
    @property
    @pulumi.getter(name="blobDriverEnabled")
    def blob_driver_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="diskDriverEnabled")
    def disk_driver_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="fileDriverEnabled")
    def file_driver_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="snapshotControllerEnabled")
    def snapshot_controller_enabled(self) -> builtins.bool:
        """
