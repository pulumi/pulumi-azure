...
class RegistryArgs:
    def __init__(__self__, *,
                 ...
                 anonymous_pull_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 data_endpoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption: Optional[pulumi.Input['RegistryEncryptionArgs']] = None,
                 export_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 quarantine_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 retention_policy_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 trust_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] retention_policy_in_days: The number of days to retain and untagged manifest after which it gets purged. Defaults to `7`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.bool] trust_policy_enabled: Boolean value that indicated whether trust policy is enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] zone_redundancy_enabled: Whether zone redundancy is enabled for this Container Registry? Changing this forces a new resource to be created. Defaults to `false`.
        """
    ...
    def anonymous_pull_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "anonymous_pull_enabled", value)

    @property
    @pulumi.getter(name="dataEndpointEnabled")
    def data_endpoint_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def data_endpoint_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def export_policy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def export_policy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def quarantine_policy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def quarantine_policy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "quarantine_policy_enabled", value)

    @property
    @pulumi.getter(name="retentionPolicyInDays")
    def retention_policy_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def retention_policy_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def trust_policy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def trust_policy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Registry(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            trust_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zone_redundancy_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Registry':
        """
    ...
    @property
    @pulumi.getter(name="dataEndpointEnabled")
    def data_endpoint_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable dedicated data endpoints for this Container Registry? This is only supported on resources with the `Premium` SKU.
        """
        return pulumi.get(self, "data_endpoint_enabled")
    ...
    @property
    @pulumi.getter(name="exportPolicyEnabled")
    def export_policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value that indicates whether export policy is enabled. Defaults to `true`. In order to set it to `false`, make sure the `public_network_access_enabled` is also set to `false`.
    ...
    @property
    @pulumi.getter(name="quarantinePolicyEnabled")
    def quarantine_policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value that indicates whether quarantine policy is enabled.
        """
        return pulumi.get(self, "quarantine_policy_enabled")
    ...
    @property
    @pulumi.getter(name="retentionPolicyInDays")
    def retention_policy_in_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of days to retain and untagged manifest after which it gets purged. Defaults to `7`.
        """
        return pulumi.get(self, "retention_policy_in_days")
    ...
    @property
    @pulumi.getter(name="trustPolicyEnabled")
    def trust_policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value that indicated whether trust policy is enabled. Defaults to `false`.
        """
        return pulumi.get(self, "trust_policy_enabled")
