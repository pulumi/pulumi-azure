...
class KubernetesClusterArgs:
    def __init__(__self__, *,
                 ...
                 automatic_upgrade_channel: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 azure_policy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 confidential_computing: Optional[pulumi.Input['KubernetesClusterConfidentialComputingArgs']] = None,
                 cost_analysis_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 dns_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 dns_prefix_private_cluster: Optional[pulumi.Input[builtins.str]] = None,
                 edge_zone: Optional[pulumi.Input[builtins.str]] = None,
                 http_application_routing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 image_cleaner_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 image_cleaner_interval_hours: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 local_account_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 node_os_upgrade_channel: Optional[pulumi.Input[builtins.str]] = None,
                 node_resource_group: Optional[pulumi.Input[builtins.str]] = None,
                 oidc_issuer_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 oms_agent: Optional[pulumi.Input['KubernetesClusterOmsAgentArgs']] = None,
                 open_service_mesh_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 private_cluster_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 private_cluster_public_fqdn_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 private_dns_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 role_based_access_control_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 run_command_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 support_plan: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 workload_identity_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the Resource Group where the Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] automatic_upgrade_channel: The upgrade channel for this Kubernetes Cluster. Possible values are `patch`, `rapid`, `node-image` and `stable`. Omitting this field sets this value to `none`.
        ...
        :param pulumi.Input[builtins.bool] azure_policy_enabled: Should the Azure Policy Add-On be enabled? For more details please visit [Understand Azure Policy for Azure Kubernetes Service](https://docs.microsoft.com/en-ie/azure/governance/policy/concepts/rego-for-aks)
        ...
        :param pulumi.Input[builtins.bool] cost_analysis_enabled: Should cost analysis be enabled for this Kubernetes Cluster? Defaults to `false`. The `sku_tier` must be set to `Standard` or `Premium` to enable this feature. Enabling this will add Kubernetes Namespace and Deployment details to the Cost Analysis views in the Azure portal.
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used for the Nodes and Volumes. More information [can be found in the documentation](https://docs.microsoft.com/azure/aks/azure-disk-customer-managed-keys). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] dns_prefix: DNS prefix specified when creating the managed cluster. Possible values must begin and end with a letter or number, contain only letters, numbers, and hyphens and be between 1 and 54 characters in length. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] dns_prefix_private_cluster: Specifies the DNS prefix to use with private clusters. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] edge_zone: Specifies the Extended Zone (formerly called Edge Zone) within the Azure Region where this Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] http_application_routing_enabled: Should HTTP Application Routing be enabled?
        ...
        :param pulumi.Input[builtins.bool] image_cleaner_enabled: Specifies whether Image Cleaner is enabled.
        :param pulumi.Input[builtins.int] image_cleaner_interval_hours: Specifies the interval in hours when images should be cleaned up. Defaults to `0`.
        ...
        :param pulumi.Input[builtins.str] kubernetes_version: Version of Kubernetes specified when creating the AKS managed cluster. If not specified, the latest recommended version will be used at provisioning time (but won't auto-upgrade). AKS does not require an exact patch version to be specified, minor version aliases such as `1.22` are also supported. - The minor version's latest GA patch is automatically chosen in that case. More details can be found in [the documentation](https://docs.microsoft.com/en-us/azure/aks/supported-kubernetes-versions?tabs=azure-cli#alias-minor-version).
               
               > **Note:** Upgrading your cluster may take up to 10 minutes per node.
        :param pulumi.Input['KubernetesClusterLinuxProfileArgs'] linux_profile: A `linux_profile` block as defined below.
        :param pulumi.Input[builtins.bool] local_account_disabled: If `true` local accounts will be disabled. See [the documentation](https://docs.microsoft.com/azure/aks/managed-aad#disable-local-accounts) for more information.
        ...
        :param pulumi.Input[builtins.str] location: The location where the Managed Kubernetes Cluster should be created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Managed Kubernetes Cluster to create. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] node_os_upgrade_channel: The upgrade channel for this Kubernetes Cluster Nodes' OS Image. Possible values are `Unmanaged`, `SecurityPatch`, `NodeImage` and `None`. Defaults to `NodeImage`.
               
               > **Note:** `node_os_upgrade_channel` must be set to `NodeImage` if `automatic_upgrade_channel` has been set to `node-image`
        :param pulumi.Input[builtins.str] node_resource_group: The name of the Resource Group where the Kubernetes Nodes should exist. Changing this forces a new resource to be created.
               
               > **Note:** Azure requires that a new, non-existent Resource Group is used, as otherwise, the provisioning of the Kubernetes Service will fail.
        :param pulumi.Input[builtins.bool] oidc_issuer_enabled: Enable or Disable the [OIDC issuer URL](https://learn.microsoft.com/en-gb/azure/aks/use-oidc-issuer)
        :param pulumi.Input['KubernetesClusterOmsAgentArgs'] oms_agent: A `oms_agent` block as defined below.
        :param pulumi.Input[builtins.bool] open_service_mesh_enabled: Is Open Service Mesh enabled? For more details, please visit [Open Service Mesh for AKS](https://docs.microsoft.com/azure/aks/open-service-mesh-about).
        :param pulumi.Input[builtins.bool] private_cluster_enabled: Should this Kubernetes Cluster have its API server only exposed on internal IP addresses? This provides a Private IP Address for the Kubernetes API on the Virtual Network where the Kubernetes Cluster is located. Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] private_cluster_public_fqdn_enabled: Specifies whether a Public FQDN for this Private Cluster should be added. Defaults to `false`.
               ...
               ```
        :param pulumi.Input[builtins.str] private_dns_zone_id: Either the ID of Private DNS Zone which should be delegated to this Cluster, `System` to have AKS manage this or `None`. In case of `None` you will need to bring your own DNS server and set up resolving, otherwise, the cluster will have issues after provisioning. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] role_based_access_control_enabled: Whether Role Based Access Control for the Kubernetes Cluster should be enabled. Defaults to `true`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] run_command_enabled: Whether to enable run command for the cluster or not. Defaults to `true`.
        ...
        :param pulumi.Input['KubernetesClusterServicePrincipalArgs'] service_principal: A `service_principal` block as documented below. One of either `identity` or `service_principal` must be specified.
               ...
               !> **Note:** A migration scenario from `service_principal` to `identity` is supported. When upgrading `service_principal` to `identity`, your cluster's control plane and addon pods will switch to use managed identity, but the kubelets will keep using your configured `service_principal` until you upgrade your Node Pool.
        :param pulumi.Input[builtins.str] sku_tier: The SKU Tier that should be used for this Kubernetes Cluster. Possible values are `Free`, `Standard` (which includes the Uptime SLA) and `Premium`. Defaults to `Free`.
        ...
        :param pulumi.Input[builtins.str] support_plan: Specifies the support plan which should be used for this Kubernetes Cluster. Possible values are `KubernetesOfficial` and `AKSLongTermSupport`. Defaults to `KubernetesOfficial`.
        ...
        :param pulumi.Input[builtins.bool] workload_identity_enabled: Specifies whether Azure AD Workload Identity should be enabled for the Cluster. Defaults to `false`.
    ...
    def automatic_upgrade_channel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def automatic_upgrade_channel(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def azure_policy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def azure_policy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def cost_analysis_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cost_analysis_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def dns_prefix_private_cluster(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_prefix_private_cluster(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def http_application_routing_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def http_application_routing_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def image_cleaner_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def image_cleaner_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "image_cleaner_enabled", value)

    @property
    @pulumi.getter(name="imageCleanerIntervalHours")
    def image_cleaner_interval_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def image_cleaner_interval_hours(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def local_account_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def local_account_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def node_os_upgrade_channel(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def node_os_upgrade_channel(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def oidc_issuer_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def oidc_issuer_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def open_service_mesh_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def open_service_mesh_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "open_service_mesh_enabled", value)

    @property
    @pulumi.getter(name="privateClusterEnabled")
    def private_cluster_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def private_cluster_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "private_cluster_enabled", value)

    @property
    @pulumi.getter(name="privateClusterPublicFqdnEnabled")
    def private_cluster_public_fqdn_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def private_cluster_public_fqdn_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def role_based_access_control_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def role_based_access_control_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "role_based_access_control_enabled", value)

    @property
    @pulumi.getter(name="runCommandEnabled")
    def run_command_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def run_command_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def support_plan(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @support_plan.setter
    def support_plan(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def workload_identity_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def workload_identity_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _KubernetesClusterState:
    def __init__(__self__, *,
                 ...
                 confidential_computing: Optional[pulumi.Input['KubernetesClusterConfidentialComputingArgs']] = None,
                 cost_analysis_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 current_kubernetes_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 http_application_routing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 http_application_routing_zone_name: Optional[pulumi.Input[builtins.str]] = None,
                 http_proxy_config: Optional[pulumi.Input['KubernetesClusterHttpProxyConfigArgs']] = None,
                 identity: Optional[pulumi.Input['KubernetesClusterIdentityArgs']] = None,
                 image_cleaner_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 image_cleaner_interval_hours: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 key_management_service: Optional[pulumi.Input['KubernetesClusterKeyManagementServiceArgs']] = None,
                 key_vault_secrets_provider: Optional[pulumi.Input['KubernetesClusterKeyVaultSecretsProviderArgs']] = None,
                 kube_admin_config_raw: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 node_os_upgrade_channel: Optional[pulumi.Input[builtins.str]] = None,
                 node_resource_group: Optional[pulumi.Input[builtins.str]] = None,
                 node_resource_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 oidc_issuer_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 oidc_issuer_url: Optional[pulumi.Input[builtins.str]] = None,
                 oms_agent: Optional[pulumi.Input['KubernetesClusterOmsAgentArgs']] = None,
                 open_service_mesh_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 portal_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 private_cluster_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 private_cluster_public_fqdn_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 private_dns_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 private_fqdn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['KubernetesClusterConfidentialComputingArgs'] confidential_computing: A `confidential_computing` block as defined below. For more details please [the documentation](https://learn.microsoft.com/en-us/azure/confidential-computing/confidential-nodes-aks-overview)
        :param pulumi.Input[builtins.bool] cost_analysis_enabled: Should cost analysis be enabled for this Kubernetes Cluster? Defaults to `false`. The `sku_tier` must be set to `Standard` or `Premium` to enable this feature. Enabling this will add Kubernetes Namespace and Deployment details to the Cost Analysis views in the Azure portal.
        :param pulumi.Input[builtins.str] current_kubernetes_version: The current version running on the Azure Kubernetes Managed Cluster.
        :param pulumi.Input['KubernetesClusterDefaultNodePoolArgs'] default_node_pool: Specifies configuration for "System" mode node pool. A `default_node_pool` block as defined below.
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used for the Nodes and Volumes. More information [can be found in the documentation](https://docs.microsoft.com/azure/aks/azure-disk-customer-managed-keys). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] dns_prefix: DNS prefix specified when creating the managed cluster. Possible values must begin and end with a letter or number, contain only letters, numbers, and hyphens and be between 1 and 54 characters in length. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] dns_prefix_private_cluster: Specifies the DNS prefix to use with private clusters. Changing this forces a new resource to be created.
               ...
               In addition, one of either `identity` or `service_principal` blocks must be specified.
        :param pulumi.Input[builtins.str] edge_zone: Specifies the Extended Zone (formerly called Edge Zone) within the Azure Region where this Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the Azure Kubernetes Managed Cluster.
        :param pulumi.Input[builtins.bool] http_application_routing_enabled: Should HTTP Application Routing be enabled?
               
               > **Note:** At this time HTTP Application Routing is not supported in Azure China or Azure US Government.
        :param pulumi.Input[builtins.str] http_application_routing_zone_name: The Zone Name of the HTTP Application Routing.
        :param pulumi.Input['KubernetesClusterHttpProxyConfigArgs'] http_proxy_config: A `http_proxy_config` block as defined below.
        :param pulumi.Input['KubernetesClusterIdentityArgs'] identity: An `identity` block as defined below. One of either `identity` or `service_principal` must be specified.
        ...
        :param pulumi.Input[builtins.str] kube_config_raw: Raw Kubernetes config to be used by [kubectl](https://kubernetes.io/docs/reference/kubectl/overview/) and other compatible tools.
        ...
        :param pulumi.Input[builtins.str] node_resource_group: The name of the Resource Group where the Kubernetes Nodes should exist. Changing this forces a new resource to be created.
               ...
               > **Note:** Azure requires that a new, non-existent Resource Group is used, as otherwise, the provisioning of the Kubernetes Service will fail.
        :param pulumi.Input[builtins.str] node_resource_group_id: The ID of the Resource Group containing the resources for this Managed Kubernetes Cluster.
        :param pulumi.Input[builtins.bool] oidc_issuer_enabled: Enable or Disable the [OIDC issuer URL](https://learn.microsoft.com/en-gb/azure/aks/use-oidc-issuer)
        :param pulumi.Input[builtins.str] oidc_issuer_url: The OIDC issuer URL that is associated with the cluster.
        :param pulumi.Input['KubernetesClusterOmsAgentArgs'] oms_agent: A `oms_agent` block as defined below.
        :param pulumi.Input[builtins.bool] open_service_mesh_enabled: Is Open Service Mesh enabled? For more details, please visit [Open Service Mesh for AKS](https://docs.microsoft.com/azure/aks/open-service-mesh-about).
        :param pulumi.Input[builtins.str] portal_fqdn: The FQDN for the Azure Portal resources when private link has been enabled, which is only resolvable inside the Virtual Network used by the Kubernetes Cluster.
        :param pulumi.Input[builtins.bool] private_cluster_enabled: Should this Kubernetes Cluster have its API server only exposed on internal IP addresses? This provides a Private IP Address for the Kubernetes API on the Virtual Network where the Kubernetes Cluster is located. Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] private_cluster_public_fqdn_enabled: Specifies whether a Public FQDN for this Private Cluster should be added. Defaults to `false`.
               ...
               ```
        :param pulumi.Input[builtins.str] private_dns_zone_id: Either the ID of Private DNS Zone which should be delegated to this Cluster, `System` to have AKS manage this or `None`. In case of `None` you will need to bring your own DNS server and set up resolving, otherwise, the cluster will have issues after provisioning. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_fqdn: The FQDN for the Kubernetes Cluster when private link has been enabled, which is only resolvable inside the Virtual Network used by the Kubernetes Cluster.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the Resource Group where the Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] role_based_access_control_enabled: Whether Role Based Access Control for the Kubernetes Cluster should be enabled. Defaults to `true`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] run_command_enabled: Whether to enable run command for the cluster or not. Defaults to `true`.
        :param pulumi.Input['KubernetesClusterServiceMeshProfileArgs'] service_mesh_profile: A `service_mesh_profile` block as defined below.
    ...
    def current_kubernetes_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_kubernetes_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def http_application_routing_zone_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def http_application_routing_zone_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def kube_admin_config_raw(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kube_admin_config_raw(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def node_resource_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def node_resource_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def portal_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @portal_fqdn.setter
    def portal_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def private_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @private_fqdn.setter
    def private_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KubernetesCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            windows_profile: Optional[pulumi.Input[Union['KubernetesClusterWindowsProfileArgs', 'KubernetesClusterWindowsProfileArgsDict']]] = None,
            workload_autoscaler_profile: Optional[pulumi.Input[Union['KubernetesClusterWorkloadAutoscalerProfileArgs', 'KubernetesClusterWorkloadAutoscalerProfileArgsDict']]] = None,
            workload_identity_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'KubernetesCluster':
        """
    ...
    @property
    @pulumi.getter(name="automaticUpgradeChannel")
    def automatic_upgrade_channel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The upgrade channel for this Kubernetes Cluster. Possible values are `patch`, `rapid`, `node-image` and `stable`. Omitting this field sets this value to `none`.
    ...
    @property
    @pulumi.getter(name="azurePolicyEnabled")
    def azure_policy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Azure Policy Add-On be enabled? For more details please visit [Understand Azure Policy for Azure Kubernetes Service](https://docs.microsoft.com/en-ie/azure/governance/policy/concepts/rego-for-aks)
        """
        return pulumi.get(self, "azure_policy_enabled")
    ...
    @property
    @pulumi.getter(name="costAnalysisEnabled")
    def cost_analysis_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should cost analysis be enabled for this Kubernetes Cluster? Defaults to `false`. The `sku_tier` must be set to `Standard` or `Premium` to enable this feature. Enabling this will add Kubernetes Namespace and Deployment details to the Cost Analysis views in the Azure portal.
        """
        return pulumi.get(self, "cost_analysis_enabled")
    ...
    @property
    @pulumi.getter(name="dnsPrefixPrivateCluster")
    def dns_prefix_private_cluster(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the DNS prefix to use with private clusters. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="httpApplicationRoutingEnabled")
    def http_application_routing_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should HTTP Application Routing be enabled?
    ...
    @property
    @pulumi.getter(name="httpApplicationRoutingZoneName")
    def http_application_routing_zone_name(self) -> pulumi.Output[builtins.str]:
        """
        The Zone Name of the HTTP Application Routing.
        """
        return pulumi.get(self, "http_application_routing_zone_name")
    ...
    @property
    @pulumi.getter(name="imageCleanerEnabled")
    def image_cleaner_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether Image Cleaner is enabled.
        """
        return pulumi.get(self, "image_cleaner_enabled")
    ...
    @property
    @pulumi.getter(name="imageCleanerIntervalHours")
    def image_cleaner_interval_hours(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the interval in hours when images should be cleaned up. Defaults to `0`.
        """
        return pulumi.get(self, "image_cleaner_interval_hours")
    ...
    @property
    @pulumi.getter(name="kubeAdminConfigRaw")
    def kube_admin_config_raw(self) -> pulumi.Output[builtins.str]:
        """
        Raw Kubernetes config for the admin account to be used by [kubectl](https://kubernetes.io/docs/reference/kubectl/overview/) and other compatible tools. This is only available when Role Based Access Control with Azure Active Directory is enabled and local accounts enabled.
        """
        return pulumi.get(self, "kube_admin_config_raw")
    ...
    @property
    @pulumi.getter(name="localAccountDisabled")
    def local_account_disabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true` local accounts will be disabled. See [the documentation](https://docs.microsoft.com/azure/aks/managed-aad#disable-local-accounts) for more information.
    ...
    @property
    @pulumi.getter(name="nodeOsUpgradeChannel")
    def node_os_upgrade_channel(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The upgrade channel for this Kubernetes Cluster Nodes' OS Image. Possible values are `Unmanaged`, `SecurityPatch`, `NodeImage` and `None`. Defaults to `NodeImage`.
    ...
    @property
    @pulumi.getter(name="nodeResourceGroup")
    def node_resource_group(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Resource Group where the Kubernetes Nodes should exist. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="nodeResourceGroupId")
    def node_resource_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Resource Group containing the resources for this Managed Kubernetes Cluster.
        """
        return pulumi.get(self, "node_resource_group_id")
    ...
    @property
    @pulumi.getter(name="oidcIssuerEnabled")
    def oidc_issuer_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable or Disable the [OIDC issuer URL](https://learn.microsoft.com/en-gb/azure/aks/use-oidc-issuer)
        """
        return pulumi.get(self, "oidc_issuer_enabled")
    ...
    @property
    @pulumi.getter(name="openServiceMeshEnabled")
    def open_service_mesh_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is Open Service Mesh enabled? For more details, please visit [Open Service Mesh for AKS](https://docs.microsoft.com/azure/aks/open-service-mesh-about).
        """
        return pulumi.get(self, "open_service_mesh_enabled")
    ...
    @property
    @pulumi.getter(name="portalFqdn")
    def portal_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The FQDN for the Azure Portal resources when private link has been enabled, which is only resolvable inside the Virtual Network used by the Kubernetes Cluster.
        """
        return pulumi.get(self, "portal_fqdn")
    ...
    @property
    @pulumi.getter(name="privateClusterEnabled")
    def private_cluster_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should this Kubernetes Cluster have its API server only exposed on internal IP addresses? This provides a Private IP Address for the Kubernetes API on the Virtual Network where the Kubernetes Cluster is located. Defaults to `false`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "private_cluster_enabled")
    ...
    @property
    @pulumi.getter(name="privateClusterPublicFqdnEnabled")
    def private_cluster_public_fqdn_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether a Public FQDN for this Private Cluster should be added. Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="roleBasedAccessControlEnabled")
    def role_based_access_control_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether Role Based Access Control for the Kubernetes Cluster should be enabled. Defaults to `true`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "role_based_access_control_enabled")
    ...
    @property
    @pulumi.getter(name="runCommandEnabled")
    def run_command_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable run command for the cluster or not. Defaults to `true`.
        """
        return pulumi.get(self, "run_command_enabled")
    ...
    @property
    @pulumi.getter(name="workloadIdentityEnabled")
    def workload_identity_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether Azure AD Workload Identity should be enabled for the Cluster. Defaults to `false`.
