...
class _SnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_account_id: Specifies the ID of an storage account. Used with `source_uri` to allow authorization during import of unmanaged blobs from a different subscription. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[_builtins.bool] trusted_launch_enabled: Whether Trusted Launch is enabled for the Snapshot.
        """
...
class Snapshot(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="incrementalEnabled")
    def incremental_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies if the Snapshot is incremental. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "incremental_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="trustedLaunchEnabled")
    def trusted_launch_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether Trusted Launch is enabled for the Snapshot.
        """
        return pulumi.get(self, "trusted_launch_enabled")
