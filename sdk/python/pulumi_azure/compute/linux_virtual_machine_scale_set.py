...
class LinuxVirtualMachineScaleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the Linux Virtual Machine Scale Set should be exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] edge_zone: Specifies the Edge Zone within the Azure Region where this Linux Virtual Machine Scale Set should exist. Changing this forces a new Linux Virtual Machine Scale Set to be created.
        ...
        :param pulumi.Input[builtins.bool] extension_operations_enabled: Should extension operations be allowed on the Virtual Machine Scale Set? Possible values are `true` or `false`. Defaults to `true`. Changing this forces a new Linux Virtual Machine Scale Set to be created.
        ...
        :param pulumi.Input[builtins.float] max_bid_price: The maximum price you're willing to pay for each Virtual Machine in this Scale Set, in US Dollars; which must be greater than the current spot price. If this bid price falls below the current spot price the Virtual Machines in the Scale Set will be evicted using the `eviction_policy`. Defaults to `-1`, which means that each Virtual Machine in this Scale Set should not be evicted for price reasons.
               ...
               > **Note:** This can only be configured when `priority` is set to `Spot`.
        :param pulumi.Input[builtins.str] name: The name of the Linux Virtual Machine Scale Set. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Specifies a list of Availability Zones in which this Linux Virtual Machine Scale Set should be located.
...
class _LinuxVirtualMachineScaleSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to this Virtual Machine Scale Set.
        :param pulumi.Input['LinuxVirtualMachineScaleSetTerminationNotificationArgs'] termination_notification: A `termination_notification` block as defined below.
        :param pulumi.Input[builtins.str] unique_id: The Unique ID for this Linux Virtual Machine Scale Set.
        :param pulumi.Input[builtins.str] user_data: The Base64-Encoded User Data which should be used for this Virtual Machine Scale Set.
        :param pulumi.Input[builtins.bool] vtpm_enabled: Specifies whether vTPM should be enabled on the virtual machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] zone_balance: Should the Virtual Machines in this Scale Set be strictly evenly distributed across Availability Zones? Defaults to `false`. Changing this forces a new resource to be created.
...
class LinuxVirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vtpm_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            zone_balance: Optional[pulumi.Input[builtins.bool]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'LinuxVirtualMachineScaleSet':
        """
