...
class DiskEncryptionSetArgs:
    def __init__(__self__, *,
                 ...
                 auto_key_rotation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Disk Encryption Set should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] encryption_type: The type of key used to encrypt the data of the disk. Possible values are `EncryptionAtRestWithCustomerKey`, `EncryptionAtRestWithPlatformAndCustomerKeys` and `ConfidentialVmEncryptedWithCustomerKey`. Defaults to `EncryptionAtRestWithCustomerKey`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Disk Encryption Set. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Disk Encryption Set.
        """
    ...
    def auto_key_rotation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "auto_key_rotation_enabled")

    @auto_key_rotation_enabled.setter
    def auto_key_rotation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DiskEncryptionSetState:
    def __init__(__self__, *,
                 ...
                 key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 key_vault_key_url: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 managed_hsm_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def key_vault_key_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def key_vault_key_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DiskEncryptionSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DiskEncryptionSet':
        """
    ...
    @property
    @pulumi.getter(name="autoKeyRotationEnabled")
    def auto_key_rotation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "auto_key_rotation_enabled")
    ...
    @property
    @pulumi.getter(name="keyVaultKeyUrl")
    def key_vault_key_url(self) -> pulumi.Output[builtins.str]:
        """
        The URL for the Key Vault Key or Key Vault Secret that is currently being used by the service.
        """
        return pulumi.get(self, "key_vault_key_url")
