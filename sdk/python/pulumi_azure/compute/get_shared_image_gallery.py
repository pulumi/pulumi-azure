...
class GetSharedImageGalleryResult:
    ...
    def image_names(self) -> Sequence[builtins.str]:
        """
...
def get_shared_image_gallery(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Compute`: 2022-03-03
    ...
    :param builtins.str name: The name of the Shared Image Gallery.
...
def get_shared_image_gallery_output(name: Optional[pulumi.Input[builtins.str]] = None,
