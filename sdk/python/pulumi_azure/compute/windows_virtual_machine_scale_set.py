...
class WindowsVirtualMachineScaleSetArgs:
    def __init__(__self__, *,
                 ...
                 do_not_run_extensions_on_overprovisioned_machines: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 extension_operations_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 health_probe_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] sku: The Virtual Machine SKU for the Scale Set, such as `Standard_F2`.
        ...
        :param pulumi.Input[builtins.str] capacity_reservation_group_id: Specifies the ID of the Capacity Reservation Group which the Virtual Machine Scale Set should be allocated to. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] edge_zone: Specifies the Edge Zone within the Azure Region where this Windows Virtual Machine Scale Set should exist. Changing this forces a new Windows Virtual Machine Scale Set to be created.
        ...
        :param pulumi.Input[builtins.bool] extension_operations_enabled: Should extension operations be allowed on the Virtual Machine Scale Set? Possible values are `true` or `false`. Defaults to `true`. Changing this forces a new Windows Virtual Machine Scale Set to be created.
        ...
        :param pulumi.Input[builtins.float] max_bid_price: The maximum price you're willing to pay for each Virtual Machine in this Scale Set, in US Dollars; which must be greater than the current spot price. If this bid price falls below the current spot price the Virtual Machines in the Scale Set will be evicted using the `eviction_policy`. Defaults to `-1`, which means that each Virtual Machine in the Scale Set should not be evicted for price reasons.
               ...
               > **Note:** This can only be configured when `priority` is set to `Spot`.
        :param pulumi.Input[builtins.str] name: The name of the Windows Virtual Machine Scale Set. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] overprovision: Should Azure over-provision Virtual Machines in this Scale Set? This means that multiple Virtual Machines will be provisioned and Azure will keep the instances which become available first - which improves provisioning success rates and improves deployment time. You're not billed for these over-provisioned VM's and they don't count towards the Subscription Quota. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.int] platform_fault_domain_count: Specifies the number of fault domains that are used by this Linux Virtual Machine Scale Set. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] proximity_placement_group_id: The ID of the Proximity Placement Group in which the Virtual Machine Scale Set should be assigned to. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] single_placement_group: Should this Virtual Machine Scale Set be limited to a Single Placement Group, which means the number of instances will be capped at 100 Virtual Machines. Defaults to `true`.
        :param pulumi.Input[builtins.str] source_image_id: The ID of an Image which each Virtual Machine in this Scale Set should be based on. Possible Image ID types include `Image ID`, `Shared Image ID`, `Shared Image Version ID`, `Community Gallery Image ID`, `Community Gallery Image Version ID`, `Shared Gallery Image ID` and `Shared Gallery Image Version ID`.
        ...
        :param pulumi.Input[builtins.str] user_data: The Base64-Encoded User Data which should be used for this Virtual Machine Scale Set.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Specifies a list of Availability Zones in which this Windows Virtual Machine Scale Set should be located.
    ...
    def do_not_run_extensions_on_overprovisioned_machines(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def do_not_run_extensions_on_overprovisioned_machines(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def extension_operations_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def extension_operations_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def gallery_applications(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['WindowsVirtualMachineScaleSetGalleryApplicationArgs']]]]):
        pulumi.set(self, "gallery_applications", value)

    @property
    @pulumi.getter(name="healthProbeId")
    def health_probe_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def health_probe_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scale_in(self) -> Optional[pulumi.Input['WindowsVirtualMachineScaleSetScaleInArgs']]:
        """
    ...
    @scale_in.setter
    def scale_in(self, value: Optional[pulumi.Input['WindowsVirtualMachineScaleSetScaleInArgs']]):
    ...
    def spot_restore(self) -> Optional[pulumi.Input['WindowsVirtualMachineScaleSetSpotRestoreArgs']]:
        """
    ...
    @spot_restore.setter
    def spot_restore(self, value: Optional[pulumi.Input['WindowsVirtualMachineScaleSetSpotRestoreArgs']]):
...
class _WindowsVirtualMachineScaleSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['WindowsVirtualMachineScaleSetTerminationNotificationArgs'] termination_notification: A `termination_notification` block as defined below.
        :param pulumi.Input[builtins.str] timezone: Specifies the time zone of the virtual machine, [the possible values are defined here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/).
        :param pulumi.Input[builtins.str] unique_id: The Unique ID for this Windows Virtual Machine Scale Set.
        :param pulumi.Input[builtins.str] user_data: The Base64-Encoded User Data which should be used for this Virtual Machine Scale Set.
        :param pulumi.Input[builtins.bool] vtpm_enabled: Specifies if vTPM (Virtual Trusted Platform Module) and Trusted Launch is enabled for the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input['WindowsVirtualMachineScaleSetWinrmListenerArgs']]] winrm_listeners: One or more `winrm_listener` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] zone_balance: Should the Virtual Machines in this Scale Set be strictly evenly distributed across Availability Zones? Defaults to `false`. Changing this forces a new resource to be created.
...
class WindowsVirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            winrm_listeners: Optional[pulumi.Input[Sequence[pulumi.Input[Union['WindowsVirtualMachineScaleSetWinrmListenerArgs', 'WindowsVirtualMachineScaleSetWinrmListenerArgsDict']]]]] = None,
            zone_balance: Optional[pulumi.Input[builtins.bool]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'WindowsVirtualMachineScaleSet':
        """
    ...
    @property
    @pulumi.getter(name="computerNamePrefix")
    def computer_name_prefix(self) -> pulumi.Output[builtins.str]:
        """
        The prefix which should be used for the name of the Virtual Machines in this Scale Set. If unspecified this defaults to the value for the `name` field. If the value of the `name` field is not a valid `computer_name_prefix`, then you must specify `computer_name_prefix`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "computer_name_prefix")
    ...
    @property
    @pulumi.getter(name="doNotRunExtensionsOnOverprovisionedMachines")
    def do_not_run_extensions_on_overprovisioned_machines(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should Virtual Machine Extensions be run on Overprovisioned Virtual Machines in the Scale Set? Defaults to `false`.
        """
        return pulumi.get(self, "do_not_run_extensions_on_overprovisioned_machines")
    ...
    @property
    @pulumi.getter(name="extensionOperationsEnabled")
    def extension_operations_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should extension operations be allowed on the Virtual Machine Scale Set? Possible values are `true` or `false`. Defaults to `true`. Changing this forces a new Windows Virtual Machine Scale Set to be created.
    ...
    @property
    @pulumi.getter(name="healthProbeId")
    def health_probe_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of a Load Balancer Probe which should be used to determine the health of an instance. This is Required and can only be specified when `upgrade_mode` is set to `Automatic` or `Rolling`.
        """
        return pulumi.get(self, "health_probe_id")
