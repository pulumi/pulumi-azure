...
class ScaleSetStandbyPoolArgs:
    def __init__(__self__, *,
                 attached_virtual_machine_scale_set_id: pulumi.Input[builtins.str],
                 elasticity_profile: pulumi.Input['ScaleSetStandbyPoolElasticityProfileArgs'],
                 resource_group_name: pulumi.Input[builtins.str],
                 virtual_machine_state: pulumi.Input[builtins.str],
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ScaleSetStandbyPool resource.
        :param pulumi.Input[builtins.str] attached_virtual_machine_scale_set_id: Specifies the fully qualified resource ID of a virtual machine scale set the pool is attached to.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Standby Pool should exist. Changing this forces a new Standby Pool to be created.
        :param pulumi.Input[builtins.str] virtual_machine_state: Specifies the desired state of virtual machines in the pool. Possible values are `Running` and `Deallocated`.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Standby Pool should exist. Changing this forces a new Standby Pool to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Standby Pool. Changing this forces a new Standby Pool to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Standby Pool.
        """
    ...
    def attached_virtual_machine_scale_set_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def attached_virtual_machine_scale_set_id(self, value: pulumi.Input[builtins.str]):
    ...
    def virtual_machine_state(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def virtual_machine_state(self, value: pulumi.Input[builtins.str]):
...
class _ScaleSetStandbyPoolState:
    def __init__(__self__, *,
                 attached_virtual_machine_scale_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 elasticity_profile: Optional[pulumi.Input['ScaleSetStandbyPoolElasticityProfileArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 virtual_machine_state: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="attachedVirtualMachineScaleSetId")
    def attached_virtual_machine_scale_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the fully qualified resource ID of a virtual machine scale set the pool is attached to.
        """
        return pulumi.get(self, "attached_virtual_machine_scale_set_id")
    ...
    @attached_virtual_machine_scale_set_id.setter
    def attached_virtual_machine_scale_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "attached_virtual_machine_scale_set_id", value)
    ...
    @property
    @pulumi.getter(name="virtualMachineState")
    def virtual_machine_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the desired state of virtual machines in the pool. Possible values are `Running` and `Deallocated`.
        """
        return pulumi.get(self, "virtual_machine_state")
    ...
    @virtual_machine_state.setter
    def virtual_machine_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "virtual_machine_state", value)
...
class ScaleSetStandbyPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_machine_state: Optional[pulumi.Input[builtins.str]] = None) -> 'ScaleSetStandbyPool':
        """
    ...
    @property
    @pulumi.getter(name="attachedVirtualMachineScaleSetId")
    def attached_virtual_machine_scale_set_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the fully qualified resource ID of a virtual machine scale set the pool is attached to.
        """
        return pulumi.get(self, "attached_virtual_machine_scale_set_id")
    ...
    @property
    @pulumi.getter(name="virtualMachineState")
    def virtual_machine_state(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the desired state of virtual machines in the pool. Possible values are `Running` and `Deallocated`.
        """
        return pulumi.get(self, "virtual_machine_state")
