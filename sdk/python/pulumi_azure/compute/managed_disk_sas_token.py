...
class ManagedDiskSasTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] duration_in_seconds: The duration for which the export should be allowed. Should be between 30 & 4294967295 seconds. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] managed_disk_id: The ID of an existing Managed Disk which should be exported. Changing this forces a new resource to be created.
        """
...
class _ManagedDiskSasTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] duration_in_seconds: The duration for which the export should be allowed. Should be between 30 & 4294967295 seconds. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] managed_disk_id: The ID of an existing Managed Disk which should be exported. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] sas_url: The computed Shared Access Signature (SAS) of the Managed Disk.
        """
...
class ManagedDiskSasToken(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sasUrl")
    def sas_url(self) -> pulumi.Output[_builtins.str]:
        """
        The computed Shared Access Signature (SAS) of the Managed Disk.
        """
        return pulumi.get(self, "sas_url")
