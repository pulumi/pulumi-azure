...
class ScaleSetPacketCaptureArgs:
    def __init__(__self__, *,
                 ...
                 maximum_bytes_per_packet: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_bytes_per_session: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_capture_duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ScaleSetPacketCapture resource.
        :param pulumi.Input[builtins.str] network_watcher_id: The resource ID of the Network Watcher. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] virtual_machine_scale_set_id: The resource ID of the Virtual Machine Scale Set to capture packets from. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.int] maximum_bytes_per_packet: The number of bytes captured per packet. The remaining bytes are truncated. Defaults to `0` (Entire Packet Captured). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] maximum_bytes_per_session: Maximum size of the capture in Bytes. Defaults to `1073741824` (1GB). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] maximum_capture_duration_in_seconds: The maximum duration of the capture session in seconds. Defaults to `18000` (5 hours). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name to use for this Network Packet Capture. Changing this forces a new resource to be created.
        """
    ...
    def maximum_bytes_per_packet(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_bytes_per_packet(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_bytes_per_packet", value)

    @property
    @pulumi.getter(name="maximumBytesPerSession")
    def maximum_bytes_per_session(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_bytes_per_session(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_bytes_per_session", value)

    @property
    @pulumi.getter(name="maximumCaptureDurationInSeconds")
    def maximum_capture_duration_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_capture_duration_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ScaleSetPacketCapture(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_watcher_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_location: Optional[pulumi.Input[Union['ScaleSetPacketCaptureStorageLocationArgs', 'ScaleSetPacketCaptureStorageLocationArgsDict']]] = None,
            virtual_machine_scale_set_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ScaleSetPacketCapture':
        """
    ...
    @property
    @pulumi.getter(name="maximumBytesPerPacket")
    def maximum_bytes_per_packet(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of bytes captured per packet. The remaining bytes are truncated. Defaults to `0` (Entire Packet Captured). Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "maximum_bytes_per_packet")
    ...
    @property
    @pulumi.getter(name="maximumBytesPerSession")
    def maximum_bytes_per_session(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum size of the capture in Bytes. Defaults to `1073741824` (1GB). Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "maximum_bytes_per_session")
    ...
    @property
    @pulumi.getter(name="maximumCaptureDurationInSeconds")
    def maximum_capture_duration_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum duration of the capture session in seconds. Defaults to `18000` (5 hours). Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "maximum_capture_duration_in_seconds")
