...
class ImageDataDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] storage_type: The type of Storage Disk to use. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this disk. Changing this forces a new resource to be created.
...
class LinuxVirtualMachineScaleSetAutomaticInstanceRepairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] action: The repair action that will be used for repairing unhealthy virtual machines in the scale set. Possible values include `Replace`, `Restart`, `Reimage`.
               
               > **Note:**  Once the `action` field has been set it will always return the last value it was assigned if it is removed from the configuration file.
               
               > **Note:**  If you wish to update the repair `action` of an existing `automatic_instance_repair` policy, you must first `disable` the `automatic_instance_repair` policy before you can re-enable the `automatic_instance_repair` policy with the new repair `action` defined.
        :param pulumi.Input[str] grace_period: Amount of time for which automatic repairs will be delayed. The grace period starts right after the VM is found unhealthy. Possible values are between `10` and `90` minutes. The time duration should be specified in `ISO 8601` format (e.g. `PT10M` to `PT90M`).
...
class LinuxVirtualMachineScaleSetGalleryApplicationArgs:
    def __init__(__self__, *,
                 ...
                 tag: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[str] version_id: Specifies the Gallery Application Version resource ID. Changing this forces a new resource to be created.
...
class OrchestratedVirtualMachineScaleSetAutomaticInstanceRepairArgs:
    def __init__(__self__, *,
                 ...
                 grace_period: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[bool] enabled: Should the automatic instance repair be enabled on this Virtual Machine Scale Set? Possible values are `true` and `false`.
        :param pulumi.Input[str] action: The repair action that will be used for repairing unhealthy virtual machines in the scale set. Possible values include `Replace`, `Restart`, `Reimage`.
...
class OrchestratedVirtualMachineScaleSetExtensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] extensions_to_provision_after_vm_creations: An ordered list of Extension names which Virtual Machine Scale Set should provision after VM creation.
...
class OrchestratedVirtualMachineScaleSetIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[str]]] identity_ids: Specifies a list of User Managed Identity IDs to be assigned to this Windows Virtual Machine Scale Set.
        :param pulumi.Input[str] type: The type of Managed Identity that should be configured on this Windows Virtual Machine Scale Set. Only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] name: The Name which should be used for this IP Configuration.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] application_gateway_backend_address_pool_ids: A list of Backend Address Pools IDs from a Application Gateway which this Virtual Machine Scale Set should be connected to.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] application_security_group_ids: A list of Application Security Group IDs which this Virtual Machine Scale Set should be connected to.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] load_balancer_backend_address_pool_ids: A list of Backend Address Pools IDs from a Load Balancer which this Virtual Machine Scale Set should be connected to.
...
if not MYPY:
    class ScaleSetStandbyPoolElasticityProfileArgsDict(TypedDict):
        max_ready_capacity: pulumi.Input[int]
        """
        Specifies the maximum number of virtual machines in the standby pool.
        """
        min_ready_capacity: pulumi.Input[int]
        """
...
class ScaleSetStandbyPoolElasticityProfileArgs:
    def __init__(__self__, *,
                 ...
                 min_ready_capacity: pulumi.Input[int]):
        """
        :param pulumi.Input[int] max_ready_capacity: Specifies the maximum number of virtual machines in the standby pool.
        :param pulumi.Input[int] min_ready_capacity: Specifies the desired minimum number of virtual machines in the standby pool.
    ...
    def max_ready_capacity(self) -> pulumi.Input[int]:
        """
        Specifies the maximum number of virtual machines in the standby pool.
        """
    ...
    def max_ready_capacity(self, value: pulumi.Input[int]):
        pulumi.set(self, "max_ready_capacity", value)

    @property
    @pulumi.getter(name="minReadyCapacity")
    def min_ready_capacity(self) -> pulumi.Input[int]:
        """
        Specifies the desired minimum number of virtual machines in the standby pool.
    ...
    def min_ready_capacity(self, value: pulumi.Input[int]):
