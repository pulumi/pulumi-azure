...
class BastionHostIpConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 subnet_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the IP configuration. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] public_ip_address_id: Reference to a Public IP Address to associate with this Bastion Host. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: Reference to a subnet in which this Bastion Host has been created. Changing this forces a new resource to be created.
...
class CapacityReservationSkuArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] capacity: Specifies the number of instances to be reserved. It must be greater than or equal to `0` and not exceed the quota in the subscription.
        :param pulumi.Input[builtins.str] name: Name of the sku, such as `Standard_F2`. Changing this forces a new resource to be created.
        """
...
class ExtensionProtectedSettingsFromKeyVaultArgs:
    def __init__(__self__, *,
                 ...
                 source_vault_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] secret_url: The URL to the Key Vault Secret which stores the protected settings.
        :param pulumi.Input[builtins.str] source_vault_id: The ID of the source Key Vault.
        """
...
class GalleryApplicationVersionManageActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] install: The command to install the Gallery Application. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] remove: The command to remove the Gallery Application. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] update: The command to update the Gallery Application. Changing this forces a new resource to be created.
        """
...
class GalleryApplicationVersionSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] media_link: The Storage Blob URI of the source application package. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] default_configuration_link: The Storage Blob URI of the default configuration. Changing this forces a new resource to be created.
        """
...
if not MYPY:
    class GalleryApplicationVersionTargetRegionArgsDict(TypedDict):
        ...
        """
        regional_replica_count: pulumi.Input[builtins.int]
        """
...
class GalleryApplicationVersionTargetRegionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The Azure Region in which the Gallery Application Version exists.
        :param pulumi.Input[builtins.int] regional_replica_count: The number of replicas of the Gallery Application Version to be created per region. Possible values are between `1` and `10`.
        :param pulumi.Input[builtins.bool] exclude_from_latest: Specifies whether this Gallery Application Version should be excluded from the `latest` filter. If set to `true`, this Gallery Application Version won't be returned for the `latest` version. Defaults to `false`.
        :param pulumi.Input[builtins.str] storage_account_type: The storage account type for the Gallery Application Version. Possible values are `Standard_LRS`, `Premium_LRS` and `Standard_ZRS`. Defaults to `Standard_LRS`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def regional_replica_count(self) -> pulumi.Input[builtins.int]:
        """
        The number of replicas of the Gallery Application Version to be created per region. Possible values are between `1` and `10`.
        """
    ...
    def regional_replica_count(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ImageDataDiskArgsDict(TypedDict):
        ...
        """
        managed_disk_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ImageDataDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] storage_type: The type of Storage Disk to use. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] blob_uri: Specifies the URI in Azure storage of the blob that you want to use to create the image.
        :param pulumi.Input[builtins.str] caching: Specifies the caching mode as `ReadWrite`, `ReadOnly`, or `None`. Defaults to `None`.
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this disk. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] lun: Specifies the logical unit number of the data disk.
        :param pulumi.Input[builtins.str] managed_disk_id: Specifies the ID of the managed disk resource that you want to use to create the image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] size_gb: Specifies the size of the image to be created. The target size can't be smaller than the source size.
        """
...
if not MYPY:
    class ImageOsDiskArgsDict(TypedDict):
        ...
        """
        os_state: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ImageOsDiskArgs:
    def __init__(__self__, *,
                 ...
                 disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 managed_disk_id: Optional[pulumi.Input[builtins.str]] = None,
                 os_state: Optional[pulumi.Input[builtins.str]] = None,
                 os_type: Optional[pulumi.Input[builtins.str]] = None,
                 size_gb: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] storage_type: The type of Storage Disk to use. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] blob_uri: Specifies the URI in Azure storage of the blob that you want to use to create the image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] caching: Specifies the caching mode as `ReadWrite`, `ReadOnly`, or `None`. The default is `None`.
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this disk. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] managed_disk_id: Specifies the ID of the managed disk resource that you want to use to create the image.
        :param pulumi.Input[builtins.str] os_state: Specifies the state of the operating system contained in the blob. Currently, the only value is Generalized. Possible values are `Generalized` and `Specialized`.
        :param pulumi.Input[builtins.str] os_type: Specifies the type of operating system contained in the virtual machine image. Possible values are: `Windows` or `Linux`.
        :param pulumi.Input[builtins.int] size_gb: Specifies the size of the image to be created. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "storage_type", storage_type)
        if blob_uri is not None:
            pulumi.set(__self__, "blob_uri", blob_uri)
    ...
    def os_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the state of the operating system contained in the blob. Currently, the only value is Generalized. Possible values are `Generalized` and `Specialized`.
        """
    ...
    @os_state.setter
    def os_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LinuxVirtualMachineAdditionalCapabilitiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] hibernation_enabled: Whether to enable the hibernation capability or not.
        :param pulumi.Input[builtins.bool] ultra_ssd_enabled: Should the capacity to enable Data Disks of the `UltraSSD_LRS` storage account type be supported on this Virtual Machine? Defaults to `false`.
        """
...
class LinuxVirtualMachineAdminSshKeyArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] public_key: The Public Key which should be used for authentication, which needs to be in `ssh-rsa` format with at least 2048-bit or in `ssh-ed25519` format. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] username: The Username for which this Public SSH Key should be configured. Changing this forces a new resource to be created.
...
if not MYPY:
    class LinuxVirtualMachineBootDiagnosticsArgsDict(TypedDict):
        storage_account_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LinuxVirtualMachineBootDiagnosticsArgs:
    def __init__(__self__, *,
                 storage_account_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] storage_account_uri: The Primary/Secondary Endpoint for the Azure Storage Account which should be used to store Boot Diagnostics, including Console Output and Screenshots from the Hypervisor.
    ...
    def storage_account_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Primary/Secondary Endpoint for the Azure Storage Account which should be used to store Boot Diagnostics, including Console Output and Screenshots from the Hypervisor.
    ...
    def storage_account_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class LinuxVirtualMachineGalleryApplicationArgsDict(TypedDict):
        ...
        """
        configuration_blob_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        treat_failure_as_deployment_failure_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class LinuxVirtualMachineGalleryApplicationArgs:
    def __init__(__self__, *,
                 ...
                 configuration_blob_uri: Optional[pulumi.Input[builtins.str]] = None,
                 order: Optional[pulumi.Input[builtins.int]] = None,
                 tag: Optional[pulumi.Input[builtins.str]] = None,
                 treat_failure_as_deployment_failure_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] version_id: Specifies the Gallery Application Version resource ID.
        :param pulumi.Input[builtins.bool] automatic_upgrade_enabled: Specifies whether the version will be automatically updated for the VM when a new Gallery Application version is available in PIR/SIG. Defaults to `false`.
        :param pulumi.Input[builtins.str] configuration_blob_uri: Specifies the URI to an Azure Blob that will replace the default configuration for the package if provided.
        :param pulumi.Input[builtins.int] order: Specifies the order in which the packages have to be installed. Possible values are between `0` and `2147483647`. Defaults to `0`.
        :param pulumi.Input[builtins.str] tag: Specifies a passthrough value for more generic context. This field can be any valid `string` value.
        :param pulumi.Input[builtins.bool] treat_failure_as_deployment_failure_enabled: Specifies whether any failure for any operation in the VmApplication will fail the deployment of the VM. Defaults to `false`.
        """
    ...
    def configuration_blob_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the URI to an Azure Blob that will replace the default configuration for the package if provided.
        """
    ...
    def configuration_blob_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def treat_failure_as_deployment_failure_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether any failure for any operation in the VmApplication will fail the deployment of the VM. Defaults to `false`.
        """
    ...
    def treat_failure_as_deployment_failure_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LinuxVirtualMachineIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Linux Virtual Machine. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Linux Virtual Machine.
...
if not MYPY:
    class LinuxVirtualMachineOsDiskArgsDict(TypedDict):
        caching: pulumi.Input[builtins.str]
        """
        ...
        """
        security_encryption_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LinuxVirtualMachineOsDiskArgs:
    def __init__(__self__, *,
                 ...
                 security_encryption_type: Optional[pulumi.Input[builtins.str]] = None,
                 write_accelerator_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] caching: The Type of Caching which should be used for the Internal OS Disk. Possible values are `None`, `ReadOnly` and `ReadWrite`.
        :param pulumi.Input[builtins.str] storage_account_type: The Type of Storage Account which should back this the Internal OS Disk. Possible values are `Standard_LRS`, `StandardSSD_LRS`, `Premium_LRS`, `StandardSSD_ZRS` and `Premium_ZRS`. Changing this forces a new resource to be created.
        :param pulumi.Input['LinuxVirtualMachineOsDiskDiffDiskSettingsArgs'] diff_disk_settings: A `diff_disk_settings` block as defined above. Changing this forces a new resource to be created.
               ...
               > **NOTE:** `diff_disk_settings` can only be set when `caching` is set to `ReadOnly`. More information can be found [here](https://docs.microsoft.com/azure/virtual-machines/ephemeral-os-disks-deploy#vm-template-deployment)
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to Encrypt this OS Disk. Conflicts with `secure_vm_disk_encryption_set_id`.
               
               > **NOTE:** The Disk Encryption Set must have the `Reader` Role Assignment scoped on the Key Vault - in addition to an Access Policy to the Key Vault
        :param pulumi.Input[builtins.int] disk_size_gb: The Size of the Internal OS Disk in GB, if you wish to vary from the size used in the image this Virtual Machine is sourced from.
               
               > **NOTE:** If specified this must be equal to or larger than the size of the Image the Virtual Machine is based on. When creating a larger disk than exists in the image you'll need to repartition the disk to use the remaining space.
        :param pulumi.Input[builtins.str] id: The ID of the OS disk.
        :param pulumi.Input[builtins.str] name: The name which should be used for the Internal OS Disk. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] secure_vm_disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to Encrypt this OS Disk when the Virtual Machine is a Confidential VM. Conflicts with `disk_encryption_set_id`. Changing this forces a new resource to be created.
               
               > **NOTE:** `secure_vm_disk_encryption_set_id` can only be specified when `security_encryption_type` is set to `DiskWithVMGuestState`.
        :param pulumi.Input[builtins.str] security_encryption_type: Encryption Type when the Virtual Machine is a Confidential VM. Possible values are `VMGuestStateOnly` and `DiskWithVMGuestState`. Changing this forces a new resource to be created.
               
               > **NOTE:** `vtpm_enabled` must be set to `true` when `security_encryption_type` is specified.
               
               > **NOTE:** `encryption_at_host_enabled` cannot be set to `true` when `security_encryption_type` is set to `DiskWithVMGuestState`.
        :param pulumi.Input[builtins.bool] write_accelerator_enabled: Should Write Accelerator be Enabled for this OS Disk? Defaults to `false`.
    ...
    @property
    @pulumi.getter
    def caching(self) -> pulumi.Input[builtins.str]:
        """
        The Type of Caching which should be used for the Internal OS Disk. Possible values are `None`, `ReadOnly` and `ReadWrite`.
        """
        return pulumi.get(self, "caching")
    ...
    @caching.setter
    def caching(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "caching", value)
    ...
    def security_encryption_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Encryption Type when the Virtual Machine is a Confidential VM. Possible values are `VMGuestStateOnly` and `DiskWithVMGuestState`. Changing this forces a new resource to be created.
    ...
    def security_encryption_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class LinuxVirtualMachineOsDiskDiffDiskSettingsArgsDict(TypedDict):
        option: pulumi.Input[builtins.str]
        """
...
class LinuxVirtualMachineOsDiskDiffDiskSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] option: Specifies the Ephemeral Disk Settings for the OS Disk. At this time the only possible value is `Local`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] placement: Specifies where to store the Ephemeral Disk. Possible values are `CacheDisk` and `ResourceDisk`. Defaults to `CacheDisk`. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def option(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the Ephemeral Disk Settings for the OS Disk. At this time the only possible value is `Local`. Changing this forces a new resource to be created.
        """
    ...
    @option.setter
    def option(self, value: pulumi.Input[builtins.str]):
...
class LinuxVirtualMachineOsImageNotificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] timeout: Length of time a notification to be sent to the VM on the instance metadata server till the VM gets OS upgraded. The only possible value is `PT15M`. Defaults to `PT15M`.
        """
...
class LinuxVirtualMachinePlanArgs:
    def __init__(__self__, *,
                 ...
                 publisher: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Specifies the Name of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] product: Specifies the Product of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher: Specifies the Publisher of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
...
class LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs:
    def __init__(__self__, *,
                 ultra_ssd_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] ultra_ssd_enabled: Should the capacity to enable Data Disks of the `UltraSSD_LRS` storage account type be supported on this Virtual Machine Scale Set? Possible values are `true` or `false`. Defaults to `false`. Changing this forces a new resource to be created.
        """
        if ultra_ssd_enabled is not None:
            pulumi.set(__self__, "ultra_ssd_enabled", ultra_ssd_enabled)
...
class LinuxVirtualMachineScaleSetAdminSshKeyArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] public_key: The Public Key which should be used for authentication, which needs to be in `ssh-rsa` format with at least 2048-bit or in `ssh-ed25519` format.
        :param pulumi.Input[builtins.str] username: The Username for which this Public SSH Key should be configured.
...
if not MYPY:
    class LinuxVirtualMachineScaleSetAutomaticOsUpgradePolicyArgsDict(TypedDict):
        disable_automatic_rollback: pulumi.Input[builtins.bool]
        """
        Should automatic rollbacks be disabled?
        """
        enable_automatic_os_upgrade: pulumi.Input[builtins.bool]
        """
...
class LinuxVirtualMachineScaleSetAutomaticOsUpgradePolicyArgs:
    def __init__(__self__, *,
                 ...
                 enable_automatic_os_upgrade: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] disable_automatic_rollback: Should automatic rollbacks be disabled?
        :param pulumi.Input[builtins.bool] enable_automatic_os_upgrade: Should OS Upgrades automatically be applied to Scale Set instances in a rolling fashion when a newer version of the OS Image becomes available?
        """
    ...
    def disable_automatic_rollback(self) -> pulumi.Input[builtins.bool]:
        """
        Should automatic rollbacks be disabled?
        """
    ...
    def disable_automatic_rollback(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "disable_automatic_rollback", value)

    @property
    @pulumi.getter(name="enableAutomaticOsUpgrade")
    def enable_automatic_os_upgrade(self) -> pulumi.Input[builtins.bool]:
        """
        Should OS Upgrades automatically be applied to Scale Set instances in a rolling fashion when a newer version of the OS Image becomes available?
        """
    ...
    def enable_automatic_os_upgrade(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class LinuxVirtualMachineScaleSetDataDiskArgsDict(TypedDict):
        ...
        """
        create_option: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ultra_ssd_disk_iops_read_write: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        ultra_ssd_disk_mbps_read_write: NotRequired[pulumi.Input[builtins.int]]
        """
...
class LinuxVirtualMachineScaleSetDataDiskArgs:
    def __init__(__self__, *,
                 ...
                 disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 ultra_ssd_disk_iops_read_write: Optional[pulumi.Input[builtins.int]] = None,
                 ultra_ssd_disk_mbps_read_write: Optional[pulumi.Input[builtins.int]] = None,
                 write_accelerator_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] caching: The type of Caching which should be used for this Data Disk. Possible values are `None`, `ReadOnly` and `ReadWrite`.
        :param pulumi.Input[builtins.int] disk_size_gb: The size of the Data Disk which should be created.
        :param pulumi.Input[builtins.int] lun: The Logical Unit Number of the Data Disk, which must be unique within the Virtual Machine.
        :param pulumi.Input[builtins.str] storage_account_type: The Type of Storage Account which should back this Data Disk. Possible values include `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS`, `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS` and `UltraSSD_LRS`.
               
               > **Note:** `UltraSSD_LRS` is only supported when `ultra_ssd_enabled` within the `additional_capabilities` block is enabled.
        :param pulumi.Input[builtins.str] create_option: The create option which should be used for this Data Disk. Possible values are `Empty` and `FromImage`. Defaults to `Empty`. (`FromImage` should only be used if the source image includes data disks).
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this Data Disk. Changing this forces a new resource to be created.
               
               > **Note:** The Disk Encryption Set must have the `Reader` Role Assignment scoped on the Key Vault - in addition to an Access Policy to the Key Vault
               
               > **Note:** Disk Encryption Sets are in Public Preview in a limited set of regions
        :param pulumi.Input[builtins.str] name: The name of the Data Disk.
        :param pulumi.Input[builtins.int] ultra_ssd_disk_iops_read_write: Specifies the Read-Write IOPS for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param pulumi.Input[builtins.int] ultra_ssd_disk_mbps_read_write: Specifies the bandwidth in MB per second for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param pulumi.Input[builtins.bool] write_accelerator_enabled: Should Write Accelerator be enabled for this Data Disk? Defaults to `false`.
    ...
    def ultra_ssd_disk_iops_read_write(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the Read-Write IOPS for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        """
    ...
    def ultra_ssd_disk_iops_read_write(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ultra_ssd_disk_iops_read_write", value)

    @property
    @pulumi.getter(name="ultraSsdDiskMbpsReadWrite")
    def ultra_ssd_disk_mbps_read_write(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the bandwidth in MB per second for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        """
    ...
    def ultra_ssd_disk_mbps_read_write(self, value: Optional[pulumi.Input[builtins.int]]):
...
class LinuxVirtualMachineScaleSetExtensionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name for the Virtual Machine Scale Set Extension.
        :param pulumi.Input[builtins.str] publisher: Specifies the Publisher of the Extension.
        :param pulumi.Input[builtins.str] type: Specifies the Type of the Extension.
        :param pulumi.Input[builtins.str] type_handler_version: Specifies the version of the extension to use, available versions can be found using the Azure CLI.
        :param pulumi.Input[builtins.bool] auto_upgrade_minor_version: Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] force_update_tag: A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
        :param pulumi.Input[builtins.str] protected_settings: A JSON String which specifies Sensitive Settings (such as Passwords) for the Extension.
        ...
        :param pulumi.Input['LinuxVirtualMachineScaleSetExtensionProtectedSettingsFromKeyVaultArgs'] protected_settings_from_key_vault: A `protected_settings_from_key_vault` block as defined below.
               ...
               > **Note:** `protected_settings_from_key_vault` cannot be used with `protected_settings`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] provision_after_extensions: An ordered list of Extension names which this should be provisioned after.
        :param pulumi.Input[builtins.str] settings: A JSON String which specifies Settings for the Extension.
...
class LinuxVirtualMachineScaleSetGalleryApplicationArgs:
    def __init__(__self__, *,
                 ...
                 tag: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] version_id: Specifies the Gallery Application Version resource ID. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] configuration_blob_uri: Specifies the URI to an Azure Blob that will replace the default configuration for the package if provided. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] order: Specifies the order in which the packages have to be installed. Possible values are between `0` and `2147483647`. Defaults to `0`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] tag: Specifies a passthrough value for more generic context. This field can be any valid `string` value. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "version_id", version_id)
        if configuration_blob_uri is not None:
            pulumi.set(__self__, "configuration_blob_uri", configuration_blob_uri)
...
class LinuxVirtualMachineScaleSetIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Linux Virtual Machine Scale Set. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Linux Virtual Machine Scale Set.
...
class LinuxVirtualMachineScaleSetNetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The Name which should be used for this Network Interface. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: A list of IP Addresses of DNS Servers which should be assigned to the Network Interface.
        :param pulumi.Input[builtins.bool] enable_accelerated_networking: Does this Network Interface support Accelerated Networking? Defaults to `false`.
        :param pulumi.Input[builtins.bool] enable_ip_forwarding: Does this Network Interface support IP Forwarding? Defaults to `false`.
        :param pulumi.Input[builtins.str] network_security_group_id: The ID of a Network Security Group which should be assigned to this Network Interface.
        :param pulumi.Input[builtins.bool] primary: Is this the Primary IP Configuration?
...
if not MYPY:
    class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationArgsDict(TypedDict):
        ...
        """
        application_gateway_backend_address_pool_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        load_balancer_backend_address_pool_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        load_balancer_inbound_nat_rules_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 application_gateway_backend_address_pool_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 application_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 load_balancer_backend_address_pool_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 load_balancer_inbound_nat_rules_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 primary: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] name: The Name which should be used for this IP Configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_gateway_backend_address_pool_ids: A list of Backend Address Pools ID's from a Application Gateway which this Virtual Machine Scale Set should be connected to.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancer_inbound_nat_rules_ids: A list of NAT Rule ID's from a Load Balancer which this Virtual Machine Scale Set should be connected to.
               ...
               > **Note:** When using this field you'll also need to configure a Rule for the Load Balancer, and use a `depends_on` between this resource and the Load Balancer Rule.
        :param pulumi.Input[builtins.bool] primary: Is this the Primary IP Configuration for this Network Interface? Defaults to `false`.
    ...
    def application_gateway_backend_address_pool_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Backend Address Pools ID's from a Application Gateway which this Virtual Machine Scale Set should be connected to.
        """
    ...
    def application_gateway_backend_address_pool_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def load_balancer_backend_address_pool_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Backend Address Pools ID's from a Load Balancer which this Virtual Machine Scale Set should be connected to.
    ...
    def load_balancer_backend_address_pool_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "load_balancer_backend_address_pool_ids", value)

    @property
    @pulumi.getter(name="loadBalancerInboundNatRulesIds")
    def load_balancer_inbound_nat_rules_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of NAT Rule ID's from a Load Balancer which this Virtual Machine Scale Set should be connected to.
    ...
    def load_balancer_inbound_nat_rules_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The Name of the Public IP Address Configuration.
        :param pulumi.Input[builtins.str] domain_name_label: The Prefix which should be used for the Domain Name Label for each Virtual Machine Instance. Azure concatenates the Domain Name Label and Virtual Machine Index to create a unique Domain Name Label for each Virtual Machine.
        :param pulumi.Input[builtins.int] idle_timeout_in_minutes: The Idle Timeout in Minutes for the Public IP Address. Possible values are in the range `4` to `32`.
        ...
        :param pulumi.Input[builtins.str] public_ip_prefix_id: The ID of the Public IP Address Prefix from where Public IP Addresses should be allocated. Changing this forces a new resource to be created.
               
               > **Note:** This functionality is in Preview and must be opted into via `az feature register --namespace Microsoft.Network --name AllowBringYourOwnPublicIpAddress` and then `az provider register -n Microsoft.Network`.
        :param pulumi.Input[builtins.str] version: The Internet Protocol Version which should be used for this public IP address. Possible values are `IPv4` and `IPv6`. Defaults to `IPv4`. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTagArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] tag: The IP Tag associated with the Public IP, such as `SQL` or `Storage`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] type: The Type of IP Tag, such as `FirstPartyUsage`. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "tag", tag)
        pulumi.set(__self__, "type", type)
...
class LinuxVirtualMachineScaleSetOsDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] caching: The Type of Caching which should be used for the Internal OS Disk. Possible values are `None`, `ReadOnly` and `ReadWrite`.
        :param pulumi.Input[builtins.str] storage_account_type: The Type of Storage Account which should back this the Internal OS Disk. Possible values include `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS`, `Premium_LRS` and `Premium_ZRS`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this OS Disk. Conflicts with `secure_vm_disk_encryption_set_id`. Changing this forces a new resource to be created.
               
               > **Note:** The Disk Encryption Set must have the `Reader` Role Assignment scoped on the Key Vault - in addition to an Access Policy to the Key Vault
               
               > **Note:** Disk Encryption Sets are in Public Preview in a limited set of regions
        :param pulumi.Input[builtins.int] disk_size_gb: The Size of the Internal OS Disk in GB, if you wish to vary from the size used in the image this Virtual Machine Scale Set is sourced from.
               
               > **Note:** If specified this must be equal to or larger than the size of the Image the VM Scale Set is based on. When creating a larger disk than exists in the image you'll need to repartition the disk to use the remaining space.
        :param pulumi.Input[builtins.str] secure_vm_disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to Encrypt the OS Disk when the Virtual Machine Scale Set is Confidential VMSS. Conflicts with `disk_encryption_set_id`. Changing this forces a new resource to be created.
               
               > **Note:** `secure_vm_disk_encryption_set_id` can only be specified when `security_encryption_type` is set to `DiskWithVMGuestState`.
        :param pulumi.Input[builtins.str] security_encryption_type: Encryption Type when the Virtual Machine Scale Set is Confidential VMSS. Possible values are `VMGuestStateOnly` and `DiskWithVMGuestState`. Changing this forces a new resource to be created.
...
class LinuxVirtualMachineScaleSetPlanArgs:
    def __init__(__self__, *,
                 ...
                 publisher: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the image from the marketplace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] product: Specifies the product of the image from the marketplace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher: Specifies the publisher of the image. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "product", product)
        pulumi.set(__self__, "publisher", publisher)
...
class LinuxVirtualMachineScaleSetRollingUpgradePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pause_time_between_batches: The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 format.
...
if not MYPY:
    class LinuxVirtualMachineScaleSetScaleInArgsDict(TypedDict):
        force_deletion_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class LinuxVirtualMachineScaleSetScaleInArgs:
    def __init__(__self__, *,
                 force_deletion_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 rule: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] force_deletion_enabled: Should the virtual machines chosen for removal be force deleted when the virtual machine scale set is being scaled-in? Possible values are `true` or `false`. Defaults to `false`.
        :param pulumi.Input[builtins.str] rule: The scale-in policy rule that decides which virtual machines are chosen for removal when a Virtual Machine Scale Set is scaled in. Possible values for the scale-in policy rules are `Default`, `NewestVM` and `OldestVM`, defaults to `Default`. For more information about scale in policy, please [refer to this doc](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-scale-in-policy).
        """
    ...
    def force_deletion_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should the virtual machines chosen for removal be force deleted when the virtual machine scale set is being scaled-in? Possible values are `true` or `false`. Defaults to `false`.
        """
    ...
    def force_deletion_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LinuxVirtualMachineScaleSetSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_vault_id: The ID of the Key Vault from which all Secrets should be sourced.
        """
...
class LinuxVirtualMachineScaleSetSecretCertificateArgs:
    def __init__(__self__, *,
                 url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] url: The Secret URL of a Key Vault Certificate.
...
class LinuxVirtualMachineScaleSetSourceImageReferenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] sku: Specifies the SKU of the image used to create the virtual machines.
        :param pulumi.Input[builtins.str] version: Specifies the version of the image used to create the virtual machines.
        """
...
class LinuxVirtualMachineScaleSetSpotRestoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] timeout: The length of time that the Virtual Machine Scale Set should attempt to restore the Spot VM instances which have been evicted. The time duration should be between `15` minutes and `120` minutes (inclusive). The time duration should be specified in the ISO 8601 format. Defaults to `PT1H`. Changing this forces a new resource to be created.
        """
...
class LinuxVirtualMachineScaleSetTerminationNotificationArgs:
    def __init__(__self__, *,
                 ...
                 timeout: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Should the termination notification be enabled on this Virtual Machine Scale Set?
        :param pulumi.Input[builtins.str] timeout: Length of time (in minutes, between 5 and 15) a notification to be sent to the VM on the instance metadata server till the VM gets deleted. The time duration should be specified in ISO 8601 format. Defaults to `PT5M`.
...
class LinuxVirtualMachineTerminationNotificationArgs:
    def __init__(__self__, *,
                 ...
                 timeout: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Should the termination notification be enabled on this Virtual Machine?
        :param pulumi.Input[builtins.str] timeout: Length of time (in minutes, between `5` and `15`) a notification to be sent to the VM on the instance metadata server till the VM gets deleted. The time duration should be specified in ISO 8601 format. Defaults to `PT5M`.
...
class ManagedDiskEncryptionSettingsDiskEncryptionKeyArgs:
    def __init__(__self__, *,
                 ...
                 source_vault_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] secret_url: The URL to the Key Vault Secret used as the Disk Encryption Key. This can be found as `id` on the `keyvault.Secret` resource.
...
class ManagedDiskEncryptionSettingsKeyEncryptionKeyArgs:
    def __init__(__self__, *,
                 ...
                 source_vault_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_url: The URL to the Key Vault Key used as the Key Encryption Key. This can be found as `id` on the `keyvault.Key` resource.
        :param pulumi.Input[builtins.str] source_vault_id: The ID of the source Key Vault. This can be found as `id` on the `keyvault.KeyVault` resource.
        """
...
class OrchestratedVirtualMachineScaleSetAdditionalCapabilitiesArgs:
    def __init__(__self__, *,
                 ultra_ssd_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] ultra_ssd_enabled: Should the capacity to enable Data Disks of the `UltraSSD_LRS` storage account type be supported on this Virtual Machine Scale Set? Defaults to `false`. Changing this forces a new resource to be created.
        """
        if ultra_ssd_enabled is not None:
            pulumi.set(__self__, "ultra_ssd_enabled", ultra_ssd_enabled)
...
class OrchestratedVirtualMachineScaleSetBootDiagnosticsArgs:
    def __init__(__self__, *,
                 storage_account_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] storage_account_uri: The Primary/Secondary Endpoint for the Azure Storage Account which should be used to store Boot Diagnostics, including Console Output and Screenshots from the Hypervisor. By including a `boot_diagnostics` block without passing the `storage_account_uri` field will cause the API to utilize a Managed Storage Account to store the Boot Diagnostics output.
        """
        if storage_account_uri is not None:
            pulumi.set(__self__, "storage_account_uri", storage_account_uri)
...
class OrchestratedVirtualMachineScaleSetDataDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] storage_account_type: The Type of Storage Account which should back this Data Disk. Possible values include `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS`, `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS` and `UltraSSD_LRS`.
        :param pulumi.Input[builtins.str] create_option: The create option which should be used for this Data Disk. Possible values are Empty and FromImage. Defaults to `Empty`. (FromImage should only be used if the source image includes data disks).
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt the Data Disk. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] disk_size_gb: The size of the Data Disk which should be created. Required if `create_option` is specified as `Empty`.
        :param pulumi.Input[builtins.int] lun: The Logical Unit Number of the Data Disk, which must be unique within the Virtual Machine. Required if `create_option` is specified as `Empty`.
        :param pulumi.Input[builtins.int] ultra_ssd_disk_iops_read_write: Specifies the Read-Write IOPS for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param pulumi.Input[builtins.int] ultra_ssd_disk_mbps_read_write: Specifies the bandwidth in MB per second for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param pulumi.Input[builtins.bool] write_accelerator_enabled: Specifies if Write Accelerator is enabled on the Data Disk. Defaults to `false`.
        """
        pulumi.set(__self__, "caching", caching)
        pulumi.set(__self__, "storage_account_type", storage_account_type)
        if create_option is not None:
...
if not MYPY:
    class OrchestratedVirtualMachineScaleSetExtensionArgsDict(TypedDict):
        ...
        Specifies the version of the extension to use, available versions can be found using the Azure CLI.
        """
        auto_upgrade_minor_version_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
        """
        extensions_to_provision_after_vm_creations: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        An ordered list of Extension names which Virtual Machine Scale Set should provision after VM creation.
        """
        failure_suppression_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Should failures from the extension be suppressed? Possible values are `true` or `false`.

        > **Note:** Operational failures such as not connecting to the VM will not be suppressed regardless of the `failure_suppression_enabled` value.
        """
        force_extension_execution_on_change: NotRequired[pulumi.Input[builtins.str]]
        """
        A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
        """
        protected_settings: NotRequired[pulumi.Input[builtins.str]]
...
class OrchestratedVirtualMachineScaleSetExtensionArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str],
                 type_handler_version: pulumi.Input[builtins.str],
                 auto_upgrade_minor_version_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 extensions_to_provision_after_vm_creations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 failure_suppression_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 force_extension_execution_on_change: Optional[pulumi.Input[builtins.str]] = None,
                 protected_settings: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] type: Specifies the Type of the Extension.
        :param pulumi.Input[builtins.str] type_handler_version: Specifies the version of the extension to use, available versions can be found using the Azure CLI.
        :param pulumi.Input[builtins.bool] auto_upgrade_minor_version_enabled: Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] extensions_to_provision_after_vm_creations: An ordered list of Extension names which Virtual Machine Scale Set should provision after VM creation.
        :param pulumi.Input[builtins.bool] failure_suppression_enabled: Should failures from the extension be suppressed? Possible values are `true` or `false`.
               
               > **Note:** Operational failures such as not connecting to the VM will not be suppressed regardless of the `failure_suppression_enabled` value.
        :param pulumi.Input[builtins.str] force_extension_execution_on_change: A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
        :param pulumi.Input[builtins.str] protected_settings: A JSON String which specifies Sensitive Settings (such as Passwords) for the Extension.
    ...
    def auto_upgrade_minor_version_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
        """
    ...
    def auto_upgrade_minor_version_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_upgrade_minor_version_enabled", value)

    @property
    @pulumi.getter(name="extensionsToProvisionAfterVmCreations")
    def extensions_to_provision_after_vm_creations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An ordered list of Extension names which Virtual Machine Scale Set should provision after VM creation.
        """
    ...
    def extensions_to_provision_after_vm_creations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "extensions_to_provision_after_vm_creations", value)

    @property
    @pulumi.getter(name="failureSuppressionEnabled")
    def failure_suppression_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should failures from the extension be suppressed? Possible values are `true` or `false`.
    ...
    def failure_suppression_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "failure_suppression_enabled", value)

    @property
    @pulumi.getter(name="forceExtensionExecutionOnChange")
    def force_extension_execution_on_change(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
        """
    ...
    def force_extension_execution_on_change(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OrchestratedVirtualMachineScaleSetIdentityArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Managed Identity IDs to be assigned to this Windows Virtual Machine Scale Set.
        :param pulumi.Input[builtins.str] type: The type of Managed Identity that should be configured on this Windows Virtual Machine Scale Set. Only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class OrchestratedVirtualMachineScaleSetNetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The Name which should be used for this Network Interface. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: A list of IP Addresses of DNS Servers which should be assigned to the Network Interface.
        :param pulumi.Input[builtins.bool] enable_accelerated_networking: Does this Network Interface support Accelerated Networking? Possible values are `true` and `false`. Defaults to `false`.
        :param pulumi.Input[builtins.bool] enable_ip_forwarding: Does this Network Interface support IP Forwarding? Possible values are `true` and `false`. Defaults to `false`.
        :param pulumi.Input[builtins.str] network_security_group_id: The ID of a Network Security Group which should be assigned to this Network Interface.
        :param pulumi.Input[builtins.bool] primary: Is this the Primary IP Configuration? Possible values are `true` and `false`. Defaults to `false`.
...
class OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The Name which should be used for this IP Configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_gateway_backend_address_pool_ids: A list of Backend Address Pools IDs from a Application Gateway which this Virtual Machine Scale Set should be connected to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_security_group_ids: A list of Application Security Group IDs which this Virtual Machine Scale Set should be connected to.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancer_backend_address_pool_ids: A list of Backend Address Pools IDs from a Load Balancer which this Virtual Machine Scale Set should be connected to.
               
               > **Note:** When using this field you'll also need to configure a Rule for the Load Balancer, and use a depends_on between this resource and the Load Balancer Rule.
        :param pulumi.Input[builtins.bool] primary: Is this the Primary IP Configuration for this Network Interface? Possible values are `true` and `false`. Defaults to `false`.
...
class OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The Name of the Public IP Address Configuration.
        :param pulumi.Input[builtins.str] domain_name_label: The Prefix which should be used for the Domain Name Label for each Virtual Machine Instance. Azure concatenates the Domain Name Label and Virtual Machine Index to create a unique Domain Name Label for each Virtual Machine. Valid values must be between `1` and `26` characters long, start with a lower case letter, end with a lower case letter or number and contains only `a-z`, `0-9` and `hyphens`.
        :param pulumi.Input[builtins.int] idle_timeout_in_minutes: The Idle Timeout in Minutes for the Public IP Address. Possible values are in the range `4` to `32`.
        ...
        :param pulumi.Input[builtins.str] public_ip_prefix_id: The ID of the Public IP Address Prefix from where Public IP Addresses should be allocated. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: Specifies what Public IP Address SKU the Public IP Address should be provisioned as. Possible vaules include `Basic_Regional`, `Basic_Global`, `Standard_Regional` or `Standard_Global`. For more information about Public IP Address SKU's and their capabilities, please see the [product documentation](https://docs.microsoft.com/azure/virtual-network/ip-services/public-ip-addresses#sku). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] version: The Internet Protocol Version which should be used for this public IP address. Possible values are `IPv4` and `IPv6`. Defaults to `IPv4`. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
        if domain_name_label is not None:
...
class OrchestratedVirtualMachineScaleSetOsDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this OS Disk. Changing this forces a new resource to be created.
               
               > **Note:** Disk Encryption Sets are in Public Preview in a limited set of regions
        :param pulumi.Input[builtins.int] disk_size_gb: The Size of the Internal OS Disk in GB, if you wish to vary from the size used in the image this Virtual Machine Scale Set is sourced from.
        :param pulumi.Input[builtins.bool] write_accelerator_enabled: Specifies if Write Accelerator is enabled on the OS Disk. Defaults to `false`.
        """
        pulumi.set(__self__, "caching", caching)
        pulumi.set(__self__, "storage_account_type", storage_account_type)
        if diff_disk_settings is not None:
...
class OrchestratedVirtualMachineScaleSetOsProfileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] custom_data: The Base64-Encoded Custom Data which should be used for this Virtual Machine Scale Set.
...
if not MYPY:
    class OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationArgsDict(TypedDict):
        ...
        """
        patch_assessment_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] computer_name_prefix: The prefix which should be used for the name of the Virtual Machines in this Scale Set. If unspecified this defaults to the value for the name field. If the value of the name field is not a valid `computer_name_prefix`, then you must specify `computer_name_prefix`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] disable_password_authentication: When an `admin_password` is specified `disable_password_authentication` must be set to `false`. Defaults to `true`.
               
               > **Note:** Either `admin_password` or `admin_ssh_key` must be specified.
        :param pulumi.Input[builtins.str] patch_assessment_mode: Specifies the mode of VM Guest Patching for the virtual machines that are associated to the Virtual Machine Scale Set. Possible values are `AutomaticByPlatform` or `ImageDefault`. Defaults to `ImageDefault`.
               
               > **Note:** If the `patch_assessment_mode` is set to `AutomaticByPlatform` then the `provision_vm_agent` field must be set to `true`.
        :param pulumi.Input[builtins.str] patch_mode: Specifies the mode of in-guest patching of this Windows Virtual Machine. Possible values are `ImageDefault` or `AutomaticByPlatform`. Defaults to `ImageDefault`. For more information on patch modes please see the [product documentation](https://docs.microsoft.com/azure/virtual-machines/automatic-vm-guest-patching#patch-orchestration-modes).
               
               > **Note:** If `patch_mode` is set to `AutomaticByPlatform` the `provision_vm_agent` must be set to `true` and the `extension` must contain at least one application health extension.  An example of how to correctly configure a Virtual Machine Scale Set to provision a Linux Virtual Machine with Automatic VM Guest Patching enabled can be found in the `./examples/orchestrated-vm-scale-set/automatic-vm-guest-patching` directory within the GitHub Repository.
        :param pulumi.Input[builtins.bool] provision_vm_agent: Should the Azure VM Agent be provisioned on each Virtual Machine in the Scale Set? Defaults to `true`. Changing this value forces a new resource to be created.
...
if not MYPY:
    class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationArgsDict(TypedDict):
        ...
        """
        hotpatching_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationArgs:
    def __init__(__self__, *,
                 admin_password: pulumi.Input[builtins.str],
                 admin_username: pulumi.Input[builtins.str],
                 additional_unattend_contents: Optional[pulumi.Input[Sequence[pulumi.Input['OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationAdditionalUnattendContentArgs']]]] = None,
                 computer_name_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] computer_name_prefix: The prefix which should be used for the name of the Virtual Machines in this Scale Set. If unspecified this defaults to the value for the `name` field. If the value of the `name` field is not a valid `computer_name_prefix`, then you must specify `computer_name_prefix`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] enable_automatic_updates: Are automatic updates enabled for this Virtual Machine? Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] patch_assessment_mode: Specifies the mode of VM Guest Patching for the virtual machines that are associated to the Virtual Machine Scale Set. Possible values are `AutomaticByPlatform` or `ImageDefault`. Defaults to `ImageDefault`.
               ...
               > **Note:** If the `patch_assessment_mode` is set to `AutomaticByPlatform` then the `provision_vm_agent` field must be set to `true`.
        :param pulumi.Input[builtins.str] patch_mode: Specifies the mode of in-guest patching of this Windows Virtual Machine. Possible values are `Manual`, `AutomaticByOS` and `AutomaticByPlatform`. Defaults to `AutomaticByOS`. For more information on patch modes please see the [product documentation](https://docs.microsoft.com/azure/virtual-machines/automatic-vm-guest-patching#patch-orchestration-modes).
        ...
        :param pulumi.Input[builtins.str] timezone: Specifies the time zone of the virtual machine, the possible values are defined [here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/).
    ...
    def additional_unattend_contents(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationAdditionalUnattendContentArgs']]]]:
        """
        One or more `additional_unattend_content` blocks as defined below. Changing this forces a new resource to be created.
        """
    ...
    def additional_unattend_contents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationAdditionalUnattendContentArgs']]]]):
...
if not MYPY:
    class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationAdditionalUnattendContentArgsDict(TypedDict):
        ...
        """
        setting: pulumi.Input[builtins.str]
        """
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationAdditionalUnattendContentArgs:
    def __init__(__self__, *,
                 ...
                 setting: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] content: The XML formatted content that is added to the unattend.xml file for the specified path and component. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] setting: The name of the setting to which the content applies. Possible values are `AutoLogon` and `FirstLogonCommands`. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def setting(self) -> pulumi.Input[builtins.str]:
        """
        The name of the setting to which the content applies. Possible values are `AutoLogon` and `FirstLogonCommands`. Changing this forces a new resource to be created.
        """
    ...
    @setting.setter
    def setting(self, value: pulumi.Input[builtins.str]):
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretCertificateArgs:
    def __init__(__self__, *,
                 ...
                 url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] store: The certificate store on the Virtual Machine where the certificate should be added.
        :param pulumi.Input[builtins.str] url: The Secret URL of a Key Vault Certificate.
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationWinrmListenerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol of listener. Possible values are `Http` or `Https`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] certificate_url: The Secret URL of a Key Vault Certificate, which must be specified when protocol is set to `Https`. Changing this forces a new resource to be created.
...
if not MYPY:
    class OrchestratedVirtualMachineScaleSetPriorityMixArgsDict(TypedDict):
        base_regular_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        regular_percentage_above_base: NotRequired[pulumi.Input[builtins.int]]
        """
...
class OrchestratedVirtualMachineScaleSetPriorityMixArgs:
    def __init__(__self__, *,
                 base_regular_count: Optional[pulumi.Input[builtins.int]] = None,
                 regular_percentage_above_base: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] base_regular_count: Specifies the base number of VMs of `Regular` priority that will be created before any VMs of priority `Spot` are created. Possible values are integers between `0` and `1000`. Defaults to `0`.
        :param pulumi.Input[builtins.int] regular_percentage_above_base: Specifies the desired percentage of VM instances that are of `Regular` priority after the base count has been reached. Possible values are integers between `0` and `100`. Defaults to `0`.
        """
    ...
    def base_regular_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the base number of VMs of `Regular` priority that will be created before any VMs of priority `Spot` are created. Possible values are integers between `0` and `1000`. Defaults to `0`.
        """
    ...
    def base_regular_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "base_regular_count", value)

    @property
    @pulumi.getter(name="regularPercentageAboveBase")
    def regular_percentage_above_base(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the desired percentage of VM instances that are of `Regular` priority after the base count has been reached. Possible values are integers between `0` and `100`. Defaults to `0`.
        """
    ...
    def regular_percentage_above_base(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class OrchestratedVirtualMachineScaleSetSkuProfileArgsDict(TypedDict):
        ...
        """
        vm_sizes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class OrchestratedVirtualMachineScaleSetSkuProfileArgs:
    def __init__(__self__, *,
                 ...
                 vm_sizes: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] allocation_strategy: Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated. Possible values are `LowestPrice` and `CapacityOptimized`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vm_sizes: Specifies the VM sizes for the virtual machine scale set.
        """
    ...
    def vm_sizes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies the VM sizes for the virtual machine scale set.
        """
    ...
    @vm_sizes.setter
    def vm_sizes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class OrchestratedVirtualMachineScaleSetTerminationNotificationArgs:
    def __init__(__self__, *,
                 ...
                 timeout: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Should the termination notification be enabled on this Virtual Machine Scale Set? Possible values `true` or `false`.
        :param pulumi.Input[builtins.str] timeout: Length of time (in minutes, between `5` and `15`) a notification to be sent to the VM on the instance metadata server till the VM gets deleted. The time duration should be specified in `ISO 8601` format. Defaults to `PT5M`.
        """
        pulumi.set(__self__, "enabled", enabled)
        if timeout is not None:
...
if not MYPY:
    class PacketCaptureFilterArgsDict(TypedDict):
        ...
        """
        remote_ip_address: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        remote_port: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PacketCaptureFilterArgs:
    def __init__(__self__, *,
                 ...
                 remote_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 remote_port: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] protocol: The Protocol to be filtered on. Possible values include `Any`, `TCP` and `UDP`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] local_ip_address: The local IP Address to be filtered on. Specify `127.0.0.1` for a single address entry, `127.0.0.1-127.0.0.255` for a range and `127.0.0.1;127.0.0.5` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] local_port: The local port to be filtered on. Specify `80` for single port entry, `80-85` for a range and `80;443;` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] remote_ip_address: The remote IP Address to be filtered on. Specify `127.0.0.1` for a single address entry, `127.0.0.1-127.0.0.255` for a range and `127.0.0.1;127.0.0.5` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] remote_port: The remote port to be filtered on. Specify `80` for single port entry, `80-85` for a range and `80;443;` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "protocol", protocol)
    ...
    def remote_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The remote IP Address to be filtered on. Specify `127.0.0.1` for a single address entry, `127.0.0.1-127.0.0.255` for a range and `127.0.0.1;127.0.0.5` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        """
    ...
    def remote_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_ip_address", value)

    @property
    @pulumi.getter(name="remotePort")
    def remote_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The remote port to be filtered on. Specify `80` for single port entry, `80-85` for a range and `80;443;` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        """
    ...
    @remote_port.setter
    def remote_port(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PacketCaptureStorageLocationArgs:
    def __init__(__self__, *,
                 ...
                 storage_path: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def storage_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URI of the storage path where the packet capture sessions are saved to.
        """
    ...
    @storage_path.setter
    def storage_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RunCommandErrorBlobManagedIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] client_id: The client ID of the managed identity.
        :param pulumi.Input[builtins.str] object_id: The object ID of the managed identity.
        """
...
if not MYPY:
    class RunCommandInstanceViewArgsDict(TypedDict):
        ...
        execution_message: NotRequired[pulumi.Input[builtins.str]]
        execution_state: NotRequired[pulumi.Input[builtins.str]]
...
class RunCommandInstanceViewArgs:
    def __init__(__self__, *,
                 ...
                 execution_message: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def execution_message(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "execution_message")

    @execution_message.setter
    def execution_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RunCommandParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The run parameter name.
        :param pulumi.Input[builtins.str] value: The run parameter value.
        """
        pulumi.set(__self__, "name", name)
...
class ScaleSetBootDiagnosticsArgs:
    def __init__(__self__, *,
                 ...
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] storage_uri: Blob endpoint for the storage account to hold the virtual machine's diagnostic files. This must be the root of a storage account, and not a storage container.
        :param pulumi.Input[builtins.bool] enabled: Whether to enable boot diagnostics for the virtual machine. Defaults to `true`.
        """
...
class ScaleSetExtensionArgs:
    def __init__(__self__, *,
                 ...
                 settings: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the extension.
        :param pulumi.Input[builtins.str] publisher: The publisher of the extension, available publishers can be found by using the Azure CLI.
        ...
        :param pulumi.Input[builtins.str] type_handler_version: Specifies the version of the extension to use, available versions can be found using the Azure CLI.
        :param pulumi.Input[builtins.bool] auto_upgrade_minor_version: Specifies whether or not to use the latest minor version available.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] provision_after_extensions: Specifies a dependency array of extensions required to be executed before, the array stores the name of each extension.
...
class ScaleSetIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the identity type to be assigned to the scale set. Allowable values are `SystemAssigned` and `UserAssigned`. For the `SystemAssigned` identity the scale set's Service Principal ID (SPN) can be retrieved after the scale set has been created. See [documentation](https://docs.microsoft.com/azure/active-directory/managed-service-identity/overview) for more information. Possible values are `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of user managed identity ids to be assigned to the VMSS. Required if `type` is `UserAssigned`.
...
if not MYPY:
    class ScaleSetNetworkProfileArgsDict(TypedDict):
        ...
        """
        accelerated_networking: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        ip_forwarding: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ScaleSetNetworkProfileArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str],
                 primary: pulumi.Input[builtins.bool],
                 accelerated_networking: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the network interface configuration.
        :param pulumi.Input[builtins.bool] primary: Indicates whether network interfaces created from the network interface configuration will be the primary NIC of the VM.
        :param pulumi.Input[builtins.bool] accelerated_networking: Specifies whether to enable accelerated networking or not.
        :param pulumi.Input['ScaleSetNetworkProfileDnsSettingsArgs'] dns_settings: A `dns_settings` block as documented below.
        :param pulumi.Input[builtins.bool] ip_forwarding: Whether IP forwarding is enabled on this NIC. Defaults to `false`.
        :param pulumi.Input[builtins.str] network_security_group_id: Specifies the identifier for the network security group.
        """
        pulumi.set(__self__, "ip_configurations", ip_configurations)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "primary", primary)
    ...
    def accelerated_networking(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to enable accelerated networking or not.
        """
    ...
    def accelerated_networking(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ScaleSetNetworkProfileDnsSettingsArgs:
    def __init__(__self__, *,
                 dns_servers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: Specifies an array of DNS servers.
        """
        pulumi.set(__self__, "dns_servers", dns_servers)
...
class ScaleSetNetworkProfileIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Specifies name of the IP configuration.
        :param pulumi.Input[builtins.bool] primary: Specifies if this ip_configuration is the primary one.
        :param pulumi.Input[builtins.str] subnet_id: Specifies the identifier of the subnet.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_gateway_backend_address_pool_ids: Specifies an array of references to backend address pools of application gateways. A scale set can reference backend address pools of multiple application gateways. Multiple scale sets can use the same application gateway.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_security_group_ids: Specifies up to `20` application security group IDs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancer_backend_address_pool_ids: Specifies an array of references to backend address pools of load balancers. A scale set can reference backend address pools of one public and one internal load balancer. Multiple scale sets cannot use the same load balancer.
               
               > **NOTE:** When using this field you'll also need to configure a Rule for the Load Balancer, and use a `depends_on` between this resource and the Load Balancer Rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancer_inbound_nat_rules_ids: Specifies an array of references to inbound NAT pools for load balancers. A scale set can reference inbound NAT pools of one public and one internal load balancer. Multiple scale sets cannot use the same load balancer.
...
if not MYPY:
    class ScaleSetNetworkProfileIpConfigurationPublicIpAddressConfigurationArgsDict(TypedDict):
        ...
        """
        idle_timeout: pulumi.Input[builtins.int]
        """
...
class ScaleSetNetworkProfileIpConfigurationPublicIpAddressConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] domain_name_label: The domain name label for the DNS settings.
        :param pulumi.Input[builtins.int] idle_timeout: The idle timeout in minutes. This value must be between 4 and 30.
        :param pulumi.Input[builtins.str] name: The name of the public IP address configuration
        """
        pulumi.set(__self__, "domain_name_label", domain_name_label)
    ...
    def idle_timeout(self) -> pulumi.Input[builtins.int]:
        """
        The idle timeout in minutes. This value must be between 4 and 30.
        """
    ...
    @idle_timeout.setter
    def idle_timeout(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ScaleSetOsProfileArgsDict(TypedDict):
        ...
        """
        computer_name_prefix: pulumi.Input[builtins.str]
        """
...
class ScaleSetOsProfileArgs:
    def __init__(__self__, *,
                 ...
                 custom_data: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] admin_username: Specifies the administrator account name to use for all the instances of virtual machines in the scale set.
        :param pulumi.Input[builtins.str] computer_name_prefix: Specifies the computer name prefix for all of the virtual machines in the scale set. Computer name prefixes must be 1 to 9 characters long for windows images and 1 - 58 for Linux. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] admin_password: Specifies the administrator password to use for all the instances of virtual machines in a scale set.
        :param pulumi.Input[builtins.str] custom_data: Specifies custom data to supply to the machine. On Linux-based systems, this can be used as a cloud-init script. On other systems, this will be copied as a file on disk. Internally, this provider will base64 encode this value before sending it to the API. The maximum length of the binary array is 65535 bytes.
        """
        pulumi.set(__self__, "admin_username", admin_username)
        pulumi.set(__self__, "computer_name_prefix", computer_name_prefix)
        if admin_password is not None:
    ...
    @property
    @pulumi.getter(name="computerNamePrefix")
    def computer_name_prefix(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the computer name prefix for all of the virtual machines in the scale set. Computer name prefixes must be 1 to 9 characters long for windows images and 1 - 58 for Linux. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "computer_name_prefix")
    ...
    @computer_name_prefix.setter
    def computer_name_prefix(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "computer_name_prefix", value)
...
class ScaleSetOsProfileLinuxConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] disable_password_authentication: Specifies whether password authentication should be disabled. Defaults to `false`. Changing this forces a new resource to be created.
...
class ScaleSetOsProfileLinuxConfigSshKeyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] path: The path of the destination file on the virtual machine
               
               > **NOTE:** Due to a limitation in the Azure VM Agent the only allowed `path` is `/home/{username}/.ssh/authorized_keys`.
        :param pulumi.Input[builtins.str] key_data: The Public SSH Key which should be written to the `path` defined above.
...
class ScaleSetOsProfileSecretArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source_vault_id: Specifies the key vault to use.
...
class ScaleSetOsProfileSecretVaultCertificateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_url: It is the Base64 encoding of a JSON Object that which is encoded in UTF-8 of which the contents need to be `data`, `dataType` and `password`.
        :param pulumi.Input[builtins.str] certificate_store: (Required, on windows machines) Specifies the certificate store on the Virtual Machine where the certificate should be added to.
        """
        pulumi.set(__self__, "certificate_url", certificate_url)
...
if not MYPY:
    class ScaleSetOsProfileWindowsConfigArgsDict(TypedDict):
        ...
        """
        enable_automatic_upgrades: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ScaleSetOsProfileWindowsConfigArgs:
    def __init__(__self__, *,
                 ...
                 enable_automatic_upgrades: Optional[pulumi.Input[builtins.bool]] = None,
                 provision_vm_agent: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] enable_automatic_upgrades: Indicates whether virtual machines in the scale set are enabled for automatic updates.
        :param pulumi.Input[builtins.bool] provision_vm_agent: Indicates whether virtual machine agent should be provisioned on the virtual machines in the scale set.
    ...
    def enable_automatic_upgrades(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether virtual machines in the scale set are enabled for automatic updates.
        """
    ...
    def enable_automatic_upgrades(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ScaleSetOsProfileWindowsConfigAdditionalUnattendConfigArgsDict(TypedDict):
        ...
        """
        pass_: pulumi.Input[builtins.str]
        """
...
class ScaleSetOsProfileWindowsConfigAdditionalUnattendConfigArgs:
    def __init__(__self__, *,
                 ...
                 setting_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] component: Specifies the name of the component to configure with the added content. The only allowable value is `Microsoft-Windows-Shell-Setup`.
        :param pulumi.Input[builtins.str] content: Specifies the base-64 encoded XML formatted content that is added to the unattend.xml file for the specified path and component.
        :param pulumi.Input[builtins.str] pass_: Specifies the name of the pass that the content applies to. The only allowable value is `oobeSystem`.
        :param pulumi.Input[builtins.str] setting_name: Specifies the name of the setting to which the content applies. Possible values are: `FirstLogonCommands` and `AutoLogon`.
        """
    ...
    def pass_(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the name of the pass that the content applies to. The only allowable value is `oobeSystem`.
        """
    ...
    @pass_.setter
    def pass_(self, value: pulumi.Input[builtins.str]):
...
class ScaleSetOsProfileWindowsConfigWinrmArgs:
    def __init__(__self__, *,
                 ...
                 certificate_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol of listener
        :param pulumi.Input[builtins.str] certificate_url: Specifies URL of the certificate with which new Virtual Machines is provisioned.
        """
        pulumi.set(__self__, "protocol", protocol)
        if certificate_url is not None:
            pulumi.set(__self__, "certificate_url", certificate_url)
...
if not MYPY:
    class ScaleSetPacketCaptureMachineScopeArgsDict(TypedDict):
        exclude_instance_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        include_instance_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ScaleSetPacketCaptureMachineScopeArgs:
    def __init__(__self__, *,
                 exclude_instance_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_instance_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_instance_ids: A list of Virtual Machine Scale Set instance IDs which should be excluded from running Packet Capture, e.g. `["0", "2"]`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_instance_ids: A list of Virtual Machine Scale Set instance IDs which should be included for Packet Capture, e.g. `["1", "3"]`. Changing this forces a new resource to be created.
        """
    ...
    def exclude_instance_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Virtual Machine Scale Set instance IDs which should be excluded from running Packet Capture, e.g. `["0", "2"]`. Changing this forces a new resource to be created.
        """
    ...
    def exclude_instance_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclude_instance_ids", value)

    @property
    @pulumi.getter(name="includeInstanceIds")
    def include_instance_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Virtual Machine Scale Set instance IDs which should be included for Packet Capture, e.g. `["1", "3"]`. Changing this forces a new resource to be created.
        """
    ...
    def include_instance_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ScaleSetPlanArgs:
    def __init__(__self__, *,
                 ...
                 publisher: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the image from the marketplace.
        :param pulumi.Input[builtins.str] product: Specifies the product of the image from the marketplace.
        :param pulumi.Input[builtins.str] publisher: Specifies the publisher of the image.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "product", product)
        pulumi.set(__self__, "publisher", publisher)
...
class ScaleSetRollingUpgradePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] pause_time_between_batches: The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 format for duration (<https://en.wikipedia.org/wiki/ISO_8601#Durations>). Defaults to `PT0S` seconds represented as `PT0S`.
        """
...
class ScaleSetSkuArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] capacity: Specifies the number of virtual machines in the scale set.
        :param pulumi.Input[builtins.str] name: Specifies the size of virtual machines in a scale set.
        :param pulumi.Input[builtins.str] tier: Specifies the tier of virtual machines in a scale set. Possible values, `standard` or `basic`.
        """
        pulumi.set(__self__, "capacity", capacity)
        pulumi.set(__self__, "name", name)
        if tier is not None:
...
if not MYPY:
    class ScaleSetStandbyPoolElasticityProfileArgsDict(TypedDict):
        max_ready_capacity: pulumi.Input[builtins.int]
        """
        Specifies the maximum number of virtual machines in the standby pool.
        """
        min_ready_capacity: pulumi.Input[builtins.int]
        """
...
class ScaleSetStandbyPoolElasticityProfileArgs:
    ...
    def max_ready_capacity(self) -> pulumi.Input[builtins.int]:
        """
        Specifies the maximum number of virtual machines in the standby pool.
        """
    ...
    def max_ready_capacity(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "max_ready_capacity", value)

    @property
    @pulumi.getter(name="minReadyCapacity")
    def min_ready_capacity(self) -> pulumi.Input[builtins.int]:
        """
        Specifies the desired minimum number of virtual machines in the standby pool.
    ...
    def min_ready_capacity(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ScaleSetStorageProfileDataDiskArgsDict(TypedDict):
        ...
        """
        managed_disk_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ScaleSetStorageProfileDataDiskArgs:
    def __init__(__self__, *,
                 ...
                 caching: Optional[pulumi.Input[builtins.str]] = None,
                 disk_size_gb: Optional[pulumi.Input[builtins.int]] = None,
                 managed_disk_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] create_option: Specifies how the data disk should be created. The only possible options are `FromImage` and `Empty`.
        :param pulumi.Input[builtins.int] lun: Specifies the Logical Unit Number of the disk in each virtual machine in the scale set.
        :param pulumi.Input[builtins.str] caching: Specifies the caching requirements. Possible values include: `None` (default), `ReadOnly`, `ReadWrite`.
        :param pulumi.Input[builtins.int] disk_size_gb: Specifies the size of the disk in GB. This element is required when creating an empty disk.
        :param pulumi.Input[builtins.str] managed_disk_type: Specifies the type of managed disk to create. Value must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`.
        """
        pulumi.set(__self__, "create_option", create_option)
        pulumi.set(__self__, "lun", lun)
        if caching is not None:
    ...
    def managed_disk_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the type of managed disk to create. Value must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`.
        """
    ...
    def managed_disk_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScaleSetStorageProfileImageReferenceArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: Specifies the ID of the (custom) image to use to create the virtual machine scale set, as in the example below.
        :param pulumi.Input[builtins.str] offer: Specifies the offer of the image used to create the virtual machines.
        :param pulumi.Input[builtins.str] publisher: Specifies the publisher of the image used to create the virtual machines.
        :param pulumi.Input[builtins.str] sku: Specifies the SKU of the image used to create the virtual machines.
        :param pulumi.Input[builtins.str] version: Specifies the version of the image used to create the virtual machines.
        """
        if id is not None:
...
class ScaleSetStorageProfileOsDiskArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] create_option: Specifies how the virtual machine should be created. The only possible option is `FromImage`.
        :param pulumi.Input[builtins.str] caching: Specifies the caching requirements. Possible values include: `None` (default), `ReadOnly`, `ReadWrite`.
        :param pulumi.Input[builtins.str] image: Specifies the blob URI for user image. A virtual machine scale set creates an os disk in the same container as the user image.
               Updating the osDisk image causes the existing disk to be deleted and a new one created with the new image. If the VM scale set is in Manual upgrade mode then the virtual machines are not updated until they have manualUpgrade applied to them.
               When setting this field `os_type` needs to be specified. Cannot be used when `vhd_containers`, `managed_disk_type` or `storage_profile_image_reference` are specified.
        :param pulumi.Input[builtins.str] managed_disk_type: Specifies the type of managed disk to create. Value you must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`. Cannot be used when `vhd_containers` or `image` is specified.
        :param pulumi.Input[builtins.str] name: Specifies the disk name. Must be specified when using unmanaged disk ('managed_disk_type' property not set).
        :param pulumi.Input[builtins.str] os_type: Specifies the operating system Type, valid values are windows, Linux.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vhd_containers: Specifies the VHD URI. Cannot be used when `image` or `managed_disk_type` is specified.
        """
        pulumi.set(__self__, "create_option", create_option)
        if caching is not None:
            pulumi.set(__self__, "caching", caching)
...
class SharedImageGallerySharingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] permission: The permission of the Shared Image Gallery when sharing. Possible values are `Community`, `Groups` and `Private`. Changing this forces a new resource to be created.
...
if not MYPY:
    class SharedImageGallerySharingCommunityGalleryArgsDict(TypedDict):
        eula: pulumi.Input[builtins.str]
        """
        ...
        """
        publisher_uri: pulumi.Input[builtins.str]
        """
...
class SharedImageGallerySharingCommunityGalleryArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] eula: The End User Licence Agreement for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] prefix: Prefix of the community public name for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher_email: Email of the publisher for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher_uri: URI of the publisher for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Shared Image Gallery. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def eula(self) -> pulumi.Input[builtins.str]:
        """
        The End User Licence Agreement for the Shared Image Gallery. Changing this forces a new resource to be created.
        """
    ...
    @eula.setter
    def eula(self, value: pulumi.Input[builtins.str]):
    ...
    def publisher_uri(self) -> pulumi.Input[builtins.str]:
        """
        URI of the publisher for the Shared Image Gallery. Changing this forces a new resource to be created.
        """
    ...
    def publisher_uri(self, value: pulumi.Input[builtins.str]):
...
class SharedImageIdentifierArgs:
    def __init__(__self__, *,
                 ...
                 sku: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] offer: The Offer Name for this Shared Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher: The Publisher Name for this Gallery Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku: The Name of the SKU for this Gallery Image. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "offer", offer)
        pulumi.set(__self__, "publisher", publisher)
        pulumi.set(__self__, "sku", sku)
...
class SharedImagePurchasePlanArgs:
    def __init__(__self__, *,
                 ...
                 publisher: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The Purchase Plan Name for this Shared Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] product: The Purchase Plan Product for this Gallery Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher: The Purchase Plan Publisher for this Gallery Image. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class SharedImageVersionTargetRegionArgsDict(TypedDict):
        ...
        """
        exclude_from_latest_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SharedImageVersionTargetRegionArgs:
    def __init__(__self__, *,
                 ...
                 regional_replica_count: pulumi.Input[builtins.int],
                 disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 exclude_from_latest_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 storage_account_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The Azure Region in which this Image Version should exist.
        :param pulumi.Input[builtins.int] regional_replica_count: The number of replicas of the Image Version to be created per region.
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of the Disk Encryption Set to encrypt the Image Version in the target region. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] exclude_from_latest_enabled: Specifies whether this Shared Image Version should be excluded when querying for the `latest` version. Defaults to `false`.
        :param pulumi.Input[builtins.str] storage_account_type: The storage account type for the image version. Possible values are `Standard_LRS`, `Premium_LRS` and `Standard_ZRS`. Defaults to `Standard_LRS`. You can store all of your image version replicas in Zone Redundant Storage by specifying `Standard_ZRS`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "regional_replica_count", regional_replica_count)
        if disk_encryption_set_id is not None:
    ...
    def exclude_from_latest_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether this Shared Image Version should be excluded when querying for the `latest` version. Defaults to `false`.
        """
    ...
    def exclude_from_latest_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class VirtualMachineAdditionalCapabilitiesArgsDict(TypedDict):
        ultra_ssd_enabled: pulumi.Input[builtins.bool]
        """
...
class VirtualMachineAdditionalCapabilitiesArgs:
    def __init__(__self__, *,
                 ultra_ssd_enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] ultra_ssd_enabled: Should Ultra SSD disk be enabled for this Virtual Machine? Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="ultraSsdEnabled")
    def ultra_ssd_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Should Ultra SSD disk be enabled for this Virtual Machine? Changing this forces a new resource to be created.
    ...
    @ultra_ssd_enabled.setter
    def ultra_ssd_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "ultra_ssd_enabled", value)
...
class VirtualMachineBootDiagnosticsArgs:
    def __init__(__self__, *,
                 ...
                 storage_uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.bool] enabled: Should Boot Diagnostics be enabled for this Virtual Machine?
        :param pulumi.Input[builtins.str] storage_uri: The Storage Account's Blob Endpoint which should hold the virtual machine's diagnostic files.
...
class VirtualMachineIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Virtual Machine. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
               
               > **NOTE:** Managed Service Identity previously required the installation of a VM Extension, but this information [is now available via the Azure Instance Metadata Service](https://docs.microsoft.com/azure/active-directory/managed-service-identity/overview#how-does-it-work).
               
               > **NOTE:** When `type` is set to `SystemAssigned`, identity the Principal ID can be retrieved after the virtual machine has been created. More details are available below. See [documentation](https://docs.microsoft.com/azure/active-directory/managed-service-identity/overview) for additional information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Virtual Machine.
...
class VirtualMachineOsProfileArgs:
    def __init__(__self__, *,
                 ...
                 custom_data: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] admin_username: Specifies the name of the local administrator account.
        :param pulumi.Input[builtins.str] computer_name: Specifies the name of the Virtual Machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] admin_password: (Optional for Windows, Optional for Linux) The password associated with the local administrator account.
...
if not MYPY:
    class VirtualMachineOsProfileLinuxConfigArgsDict(TypedDict):
        disable_password_authentication: pulumi.Input[builtins.bool]
        """
...
class VirtualMachineOsProfileLinuxConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] disable_password_authentication: Specifies whether password authentication should be disabled. If set to `false`, an `admin_password` must be specified.
    ...
    @property
    @pulumi.getter(name="disablePasswordAuthentication")
    def disable_password_authentication(self) -> pulumi.Input[builtins.bool]:
        """
        Specifies whether password authentication should be disabled. If set to `false`, an `admin_password` must be specified.
        """
        return pulumi.get(self, "disable_password_authentication")
    ...
    @disable_password_authentication.setter
    def disable_password_authentication(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "disable_password_authentication", value)
...
class VirtualMachineOsProfileSecretArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source_vault_id: Specifies the ID of the Key Vault to use.
...
class VirtualMachineOsProfileSecretVaultCertificateArgs:
    def __init__(__self__, *,
                 ...
                 certificate_store: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] certificate_url: The ID of the Key Vault Secret. Stored secret is the Base64 encoding of a JSON Object that which is encoded in UTF-8 of which the contents need to be:
               ...
               > **NOTE:** If your certificate is stored in Azure Key Vault - this can be sourced from the `secret_id` property on the `keyvault.Certificate` resource.
        :param pulumi.Input[builtins.str] certificate_store: (Required, on windows machines) Specifies the certificate store on the Virtual Machine where the certificate should be added to, such as `My`.
        """
        pulumi.set(__self__, "certificate_url", certificate_url)
        if certificate_store is not None:
            pulumi.set(__self__, "certificate_store", certificate_store)
...
class VirtualMachineOsProfileWindowsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable_automatic_upgrades: Are automatic updates enabled on this Virtual Machine? Defaults to `false`.
        :param pulumi.Input[builtins.bool] provision_vm_agent: Should the Azure Virtual Machine Guest Agent be installed on this Virtual Machine? Defaults to `false`.
               
               > **NOTE:** This is different from the Default value used for this field within Azure.
        :param pulumi.Input[builtins.str] timezone: Specifies the time zone of the virtual machine, [the possible values are defined here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/). Changing this forces a new resource to be created.
...
class VirtualMachineOsProfileWindowsConfigWinrmArgs:
    def __init__(__self__, *,
                 ...
                 certificate_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol of listener. Possible values are `HTTP` or `HTTPS`.
        :param pulumi.Input[builtins.str] certificate_url: The ID of the Key Vault Secret which contains the encrypted Certificate which should be installed on the Virtual Machine. This certificate must also be specified in the `vault_certificates` block within the `os_profile_secrets` block.
...
if not MYPY:
    class VirtualMachineStorageDataDiskArgsDict(TypedDict):
        ...
        """
        vhd_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualMachineStorageDataDiskArgs:
    def __init__(__self__, *,
                 ...
                 managed_disk_id: Optional[pulumi.Input[builtins.str]] = None,
                 managed_disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 vhd_uri: Optional[pulumi.Input[builtins.str]] = None,
                 write_accelerator_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] create_option: Specifies how the data disk should be created. Possible values are `Attach`, `FromImage` and `Empty`.
               
               > **NOTE:** If using an image that does not have data to be written to the Data Disk, use `Empty` as the create option in order to create the desired disk without any data.
        :param pulumi.Input[builtins.int] lun: Specifies the logical unit number of the data disk. This needs to be unique within all the Data Disks on the Virtual Machine.
        :param pulumi.Input[builtins.str] name: The name of the Data Disk.
        :param pulumi.Input[builtins.str] caching: Specifies the caching requirements for the Data Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
        :param pulumi.Input[builtins.int] disk_size_gb: Specifies the size of the data disk in gigabytes.
        :param pulumi.Input[builtins.str] managed_disk_id: Specifies the ID of an Existing Managed Disk which should be attached to this Virtual Machine. When this field is set `create_option` must be set to `Attach`.
               
               The following properties apply when using Unmanaged Disks:
        :param pulumi.Input[builtins.str] managed_disk_type: Specifies the type of managed disk to create. Possible values are either `Standard_LRS`, `StandardSSD_LRS`, `Premium_LRS` or `UltraSSD_LRS`.
               
               > **Note:** `managed_disk_type` of type `UltraSSD_LRS` is currently in preview and are not available to subscriptions that have not [requested](https://aka.ms/UltraSSDPreviewSignUp) onboarding to `Azure Ultra Disk Storage` preview. `Azure Ultra Disk Storage` is only available in `East US 2`, `North Europe`, and `Southeast Asia` regions. For more information see the `Azure Ultra Disk Storage` [product documentation](https://docs.microsoft.com/azure/virtual-machines/windows/disks-enable-ultra-ssd), [product blog](https://azure.microsoft.com/en-us/blog/announcing-the-general-availability-of-azure-ultra-disk-storage/) and [FAQ](https://docs.microsoft.com/azure/virtual-machines/windows/faq-for-disks#ultra-disks). You must also set `additional_capabilities.ultra_ssd_enabled` to `true`.
        :param pulumi.Input[builtins.str] vhd_uri: Specifies the URI of the VHD file backing this Unmanaged Data Disk.
    ...
    def vhd_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the URI of the VHD file backing this Unmanaged Data Disk.
        """
    ...
    @vhd_uri.setter
    def vhd_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VirtualMachineStorageImageReferenceArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: Specifies the ID of the Custom Image which the Virtual Machine should be created from. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] offer: Specifies the offer of the image used to create the virtual machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher: Specifies the publisher of the image used to create the virtual machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku: Specifies the SKU of the image used to create the virtual machine. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] version: Specifies the version of the image used to create the virtual machine. Changing this forces a new resource to be created.
...
class VirtualMachineStorageOsDiskArgs:
    def __init__(__self__, *,
                 ...
                 write_accelerator_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] create_option: Specifies how the OS Disk should be created. Possible values are `Attach` (managed disks only) and `FromImage`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the OS Disk.
        :param pulumi.Input[builtins.str] caching: Specifies the caching requirements for the OS Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
        :param pulumi.Input[builtins.int] disk_size_gb: Specifies the size of the OS Disk in gigabytes.
        :param pulumi.Input[builtins.str] image_uri: Specifies the Image URI in the format `publisherName:offer:skus:version`. This field can also specify the [VHD URI](https://docs.microsoft.com/azure/virtual-machines/linux/tutorial-custom-images) of a custom VM image to clone. When cloning a Custom (Unmanaged) Disk Image the `os_type` field must be set.
        :param pulumi.Input[builtins.str] managed_disk_id: Specifies the ID of an existing Managed Disk which should be attached as the OS Disk of this Virtual Machine. If this is set then the `create_option` must be set to `Attach`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] managed_disk_type: Specifies the type of Managed Disk which should be created. Possible values are `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`.
               
               The following properties apply when using Unmanaged Disks:
        :param pulumi.Input[builtins.str] os_type: Specifies the Operating System on the OS Disk. Possible values are `Linux` and `Windows`.
        :param pulumi.Input[builtins.str] vhd_uri: Specifies the URI of the VHD file backing this Unmanaged OS Disk. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] write_accelerator_enabled: Specifies if Write Accelerator is enabled on the disk. This can only be enabled on `Premium_LRS` managed disks with no caching and [M-Series VMs](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/how-to-enable-write-accelerator). Defaults to `false`.
...
class WindowsVirtualMachineIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Windows Virtual Machine. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Windows Virtual Machine.
...
class WindowsVirtualMachineScaleSetIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Windows Virtual Machine Scale Set. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Windows Virtual Machine Scale Set.
...
class WindowsVirtualMachineScaleSetWinrmListenerArgs:
    def __init__(__self__, *,
                 ...
                 certificate_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] protocol: The Protocol of the WinRM Listener. Possible values are `Http` and `Https`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] certificate_url: The Secret URL of a Key Vault Certificate, which must be specified when `protocol` is set to `Https`. Changing this forces a new resource to be created.
