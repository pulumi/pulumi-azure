...
class SharedImageArgs:
    def __init__(__self__, *,
                 ...
                 accelerated_network_support_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 architecture: Optional[pulumi.Input[builtins.str]] = None,
                 confidential_vm_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 confidential_vm_supported: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 disk_controller_type_nvme_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 disk_types_not_alloweds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 max_recommended_memory_in_gb: Optional[pulumi.Input[builtins.int]] = None,
                 max_recommended_vcpu_count: Optional[pulumi.Input[builtins.int]] = None,
                 min_recommended_memory_in_gb: Optional[pulumi.Input[builtins.int]] = None,
                 min_recommended_vcpu_count: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 specialized: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 trusted_launch_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 trusted_launch_supported: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SharedImage resource.
        :param pulumi.Input[builtins.str] gallery_name: Specifies the name of the Shared Image Gallery in which this Shared Image should exist. Changing this forces a new resource to be created.
        :param pulumi.Input['SharedImageIdentifierArgs'] identifier: An `identifier` block as defined below.
        :param pulumi.Input[builtins.str] os_type: The type of Operating System present in this Shared Image. Possible values are `Linux` and `Windows`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] accelerated_network_support_enabled: Specifies if the Shared Image supports Accelerated Network. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disk_types_not_alloweds: One or more Disk Types not allowed for the Image. Possible values include `Standard_LRS` and `Premium_LRS`.
        :param pulumi.Input[builtins.str] end_of_life_date: The end of life date in RFC3339 format of the Image.
        :param pulumi.Input[builtins.str] eula: The End User Licence Agreement for the Shared Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] hibernation_enabled: Specifies if the Shared Image supports hibernation. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] hyper_v_generation: The generation of HyperV that the Virtual Machine used to create the Shared Image is based on. Possible values are `V1` and `V2`. Defaults to `V1`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the Shared Image Gallery exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] max_recommended_memory_in_gb: Maximum memory in GB recommended for the Image.
        :param pulumi.Input[builtins.int] max_recommended_vcpu_count: Maximum count of vCPUs recommended for the Image.
        :param pulumi.Input[builtins.int] min_recommended_memory_in_gb: Minimum memory in GB recommended for the Image.
        :param pulumi.Input[builtins.int] min_recommended_vcpu_count: Minimum count of vCPUs recommended for the Image.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Shared Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] privacy_statement_uri: The URI containing the Privacy Statement associated with this Shared Image. Changing this forces a new resource to be created.
        :param pulumi.Input['SharedImagePurchasePlanArgs'] purchase_plan: A `purchase_plan` block as defined below.
        :param pulumi.Input[builtins.str] release_note_uri: The URI containing the Release Notes associated with this Shared Image.
        :param pulumi.Input[builtins.bool] specialized: Specifies that the Operating System used inside this Image has not been Generalized (for example, `sysprep` on Windows has not been run). Changing this forces a new resource to be created.
               
               !> **Note:** It's recommended to Generalize images where possible - Specialized Images reuse the same UUID internally within each Virtual Machine, which can have unintended side-effects.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Shared Image.
        :param pulumi.Input[builtins.bool] trusted_launch_enabled: Specifies if Trusted Launch has to be enabled for the Virtual Machine created from the Shared Image. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] trusted_launch_supported: Specifies if supports creation of both Trusted Launch virtual machines and Gen2 virtual machines with standard security created from the Shared Image. Changing this forces a new resource to be created.
        """
    ...
    def accelerated_network_support_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def accelerated_network_support_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def confidential_vm_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def confidential_vm_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "confidential_vm_enabled", value)

    @property
    @pulumi.getter(name="confidentialVmSupported")
    def confidential_vm_supported(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def confidential_vm_supported(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def disk_controller_type_nvme_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disk_controller_type_nvme_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disk_controller_type_nvme_enabled", value)

    @property
    @pulumi.getter(name="diskTypesNotAlloweds")
    def disk_types_not_alloweds(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def disk_types_not_alloweds(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def max_recommended_memory_in_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_recommended_memory_in_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_recommended_memory_in_gb", value)

    @property
    @pulumi.getter(name="maxRecommendedVcpuCount")
    def max_recommended_vcpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_recommended_vcpu_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_recommended_vcpu_count", value)

    @property
    @pulumi.getter(name="minRecommendedMemoryInGb")
    def min_recommended_memory_in_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_recommended_memory_in_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "min_recommended_memory_in_gb", value)

    @property
    @pulumi.getter(name="minRecommendedVcpuCount")
    def min_recommended_vcpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_recommended_vcpu_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter
    def specialized(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @specialized.setter
    def specialized(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def trusted_launch_supported(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def trusted_launch_supported(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SharedImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            trusted_launch_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            trusted_launch_supported: Optional[pulumi.Input[builtins.bool]] = None) -> 'SharedImage':
        """
    ...
    @property
    @pulumi.getter(name="acceleratedNetworkSupportEnabled")
    def accelerated_network_support_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the Shared Image supports Accelerated Network. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "accelerated_network_support_enabled")
    ...
    @property
    @pulumi.getter(name="confidentialVmEnabled")
    def confidential_vm_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if Confidential Virtual Machines enabled. It will enable all the features of trusted, with higher confidentiality features for isolate machines or encrypted data. Available for Gen2 machines. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="confidentialVmSupported")
    def confidential_vm_supported(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if supports creation of both Confidential virtual machines and Gen2 virtual machines with standard security from a compatible Gen2 OS disk VHD or Gen2 Managed image. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "confidential_vm_supported")
    ...
    @property
    @pulumi.getter(name="diskControllerTypeNvmeEnabled")
    def disk_controller_type_nvme_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the Shared Image supports NVMe disks. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "disk_controller_type_nvme_enabled")
    ...
    @property
    @pulumi.getter(name="diskTypesNotAlloweds")
    def disk_types_not_alloweds(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        One or more Disk Types not allowed for the Image. Possible values include `Standard_LRS` and `Premium_LRS`.
        """
        return pulumi.get(self, "disk_types_not_alloweds")
    ...
    @property
    @pulumi.getter(name="hibernationEnabled")
    def hibernation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the Shared Image supports hibernation. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "hibernation_enabled")
    ...
    @property
    @pulumi.getter(name="maxRecommendedMemoryInGb")
    def max_recommended_memory_in_gb(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum memory in GB recommended for the Image.
        """
        return pulumi.get(self, "max_recommended_memory_in_gb")
    ...
    @property
    @pulumi.getter(name="maxRecommendedVcpuCount")
    def max_recommended_vcpu_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum count of vCPUs recommended for the Image.
        """
        return pulumi.get(self, "max_recommended_vcpu_count")
    ...
    @property
    @pulumi.getter(name="minRecommendedMemoryInGb")
    def min_recommended_memory_in_gb(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Minimum memory in GB recommended for the Image.
        """
        return pulumi.get(self, "min_recommended_memory_in_gb")
    ...
    @property
    @pulumi.getter(name="minRecommendedVcpuCount")
    def min_recommended_vcpu_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Minimum count of vCPUs recommended for the Image.
        """
        return pulumi.get(self, "min_recommended_vcpu_count")
    ...
    @property
    @pulumi.getter
    def specialized(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies that the Operating System used inside this Image has not been Generalized (for example, `sysprep` on Windows has not been run). Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="trustedLaunchSupported")
    def trusted_launch_supported(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if supports creation of both Trusted Launch virtual machines and Gen2 virtual machines with standard security created from the Shared Image. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "trusted_launch_supported")
