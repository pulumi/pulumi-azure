...
class GalleryApplicationVersionArgs:
    def __init__(__self__, *,
                 gallery_application_id: pulumi.Input[builtins.str],
                 ...
                 package_file: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a GalleryApplicationVersion resource.
        :param pulumi.Input[builtins.str] gallery_application_id: The ID of the Gallery Application. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] config_file: Specifies the name of the config file on the VM. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] enable_health_check: Should the Gallery Application reports health. Defaults to `false`.
        :param pulumi.Input[builtins.str] end_of_life_date: The end of life date in RFC3339 format of the Gallery Application Version.
        :param pulumi.Input[builtins.bool] exclude_from_latest: Should the Gallery Application Version be excluded from the `latest` filter? If set to `true` this Gallery Application Version won't be returned for the `latest` version. Defaults to `false`.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Gallery Application Version exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The version name of the Gallery Application Version, such as `1.0.0`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] package_file: Specifies the name of the package file on the VM. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Gallery Application Version.
        """
    ...
    def gallery_application_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def gallery_application_id(self, value: pulumi.Input[builtins.str]):
    ...
    def package_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @package_file.setter
    def package_file(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GalleryApplicationVersionState:
    def __init__(__self__, *,
                 ...
                 end_of_life_date: Optional[pulumi.Input[builtins.str]] = None,
                 exclude_from_latest: Optional[pulumi.Input[builtins.bool]] = None,
                 gallery_application_id: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="galleryApplicationId")
    def gallery_application_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Gallery Application. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "gallery_application_id")
    ...
    @gallery_application_id.setter
    def gallery_application_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "gallery_application_id", value)
...
class GalleryApplicationVersion(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableHealthCheck")
    def enable_health_check(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Gallery Application reports health. Defaults to `false`.
        """
        return pulumi.get(self, "enable_health_check")
    ...
    @property
    @pulumi.getter(name="galleryApplicationId")
    def gallery_application_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Gallery Application. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "gallery_application_id")
    ...
    @property
    @pulumi.getter(name="packageFile")
    def package_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the name of the package file on the VM. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "package_file")
