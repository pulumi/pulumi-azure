...
def get_disk_access(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Compute` - 2022-03-02
    ...
    :param _builtins.str name: The name of this Disk Access.
    :param _builtins.str resource_group_name: The name of the Resource Group where the Disk Access exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_disk_access_output(name: Optional[pulumi.Input[_builtins.str]] = None,
