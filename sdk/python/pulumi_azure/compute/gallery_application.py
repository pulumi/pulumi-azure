...
class GalleryApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: The Azure Region where the Gallery Application exists. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: The name of the Gallery Application. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] privacy_statement_uri: The URI containing the Privacy Statement associated with the Gallery Application.
        :param pulumi.Input[_builtins.str] release_note_uri: The URI containing the Release Notes associated with the Gallery Application.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the Gallery Application.
        """
    ...
    def gallery_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @gallery_id.setter
    def gallery_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "gallery_id", value)

    @_builtins.property
    @pulumi.getter(name="supportedOsType")
    def supported_os_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def supported_os_type(self, value: pulumi.Input[_builtins.str]):
...
class GalleryApplication(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="galleryId")
    def gallery_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the Shared Image Gallery. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "gallery_id")
