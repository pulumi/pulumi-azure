...
class GetDiskEncryptionSetResult:
    ...
    def auto_key_rotation_enabled(self) -> _builtins.bool:
        """
...
def get_disk_encryption_set(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Compute` - 2022-03-02
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Disk Encryption Set exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_disk_encryption_set_output(name: Optional[pulumi.Input[_builtins.str]] = None,
