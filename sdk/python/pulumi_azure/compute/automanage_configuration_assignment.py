...
class AutomanageConfigurationAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_machine_id: The ARM resource ID of the Virtual Machine to assign the Automanage Configuration to. Changing this forces a new resource to be created.
        """
...
@pulumi.type_token("azure:compute/automanageConfigurationAssignment:AutomanageConfigurationAssignment")
class AutomanageConfigurationAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            configuration_id: Optional[pulumi.Input[builtins.str]] = None,
            virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AutomanageConfigurationAssignment':
        """
