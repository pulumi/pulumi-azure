...
class DataDiskAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] caching: Specifies the caching requirements for this Data Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
        ...
        :param pulumi.Input[builtins.str] managed_disk_id: The ID of an existing Managed Disk which should be attached. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] create_option: The Create Option of the Data Disk, such as `Empty` or `Attach`. Defaults to `Attach`. Changing this forces a new resource to be created.
...
class DataDiskAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > **Note:** only Managed Disks are supported via this separate resource, Unmanaged Disks can be attached using the `storage_data_disk` block in the `compute.VirtualMachine` resource.
    ...
    def get(resource_name: str,
            ...
            managed_disk_id: Optional[pulumi.Input[builtins.str]] = None,
            virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None,
            write_accelerator_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'DataDiskAttachment':
        """
    ...
    @property
    @pulumi.getter
    def caching(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the caching requirements for this Data Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
        """
        return pulumi.get(self, "caching")
