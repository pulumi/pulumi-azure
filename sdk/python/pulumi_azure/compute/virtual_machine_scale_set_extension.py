...
class VirtualMachineScaleSetExtensionArgs:
    def __init__(__self__, *,
                 ...
                 virtual_machine_scale_set_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] publisher: Specifies the Publisher of the Extension. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] type: Specifies the Type of the Extension. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] type_handler_version: Specifies the version of the extension to use, available versions can be found using the Azure CLI.
               ...
               ```
        :param pulumi.Input[builtins.str] virtual_machine_scale_set_id: The ID of the Virtual Machine Scale Set. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name for the Virtual Machine Scale Set Extension. Changing this forces a new resource to be created.
    ...
    def virtual_machine_scale_set_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def virtual_machine_scale_set_id(self, value: pulumi.Input[builtins.str]):
...
class VirtualMachineScaleSetExtension(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            type_handler_version: Optional[pulumi.Input[builtins.str]] = None,
            virtual_machine_scale_set_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualMachineScaleSetExtension':
        """
    ...
    @property
    @pulumi.getter(name="automaticUpgradeEnabled")
    def automatic_upgrade_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Extension be automatically updated whenever the Publisher releases a new version of this VM Extension?
        """
        return pulumi.get(self, "automatic_upgrade_enabled")
    ...
    @property
    @pulumi.getter(name="failureSuppressionEnabled")
    def failure_suppression_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should failures from the extension be suppressed? Possible values are `true` or `false`. Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="protectedSettings")
    def protected_settings(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A JSON String which specifies Sensitive Settings (such as Passwords) for the Extension.
    ...
    @property
    @pulumi.getter
    def publisher(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Publisher of the Extension. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "publisher")
    ...
    @property
    @pulumi.getter(name="typeHandlerVersion")
    def type_handler_version(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the version of the extension to use, available versions can be found using the Azure CLI.
    ...
    @property
    @pulumi.getter(name="virtualMachineScaleSetId")
    def virtual_machine_scale_set_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Virtual Machine Scale Set. Changing this forces a new resource to be created.
