...
def get_shared_image_versions(gallery_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Compute`: 2023-07-03
    ...
    :param builtins.str gallery_name: The name of the Shared Image in which the Shared Image exists.
...
def get_shared_image_versions_output(gallery_name: Optional[pulumi.Input[builtins.str]] = None,
