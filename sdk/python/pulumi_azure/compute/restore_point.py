...
class RestorePointArgs:
    def __init__(__self__, *,
                 virtual_machine_restore_point_collection_id: pulumi.Input[builtins.str],
                 crash_consistency_mode_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 excluded_disks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RestorePoint resource.
        :param pulumi.Input[builtins.str] virtual_machine_restore_point_collection_id: Specifies the ID of the Virtual Machine Restore Point Collection the Virtual Machine Restore Point will be associated with. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] crash_consistency_mode_enabled: Whether the Consistency Mode of the Virtual Machine Restore Point is set to `CrashConsistent`. Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_disks: A list of disks that will be excluded from the Virtual Machine Restore Point. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Virtual Machine Restore Point. Changing this forces a new resource to be created.
        """
    ...
    def virtual_machine_restore_point_collection_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def virtual_machine_restore_point_collection_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "virtual_machine_restore_point_collection_id", value)

    @property
    @pulumi.getter(name="crashConsistencyModeEnabled")
    def crash_consistency_mode_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def crash_consistency_mode_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "crash_consistency_mode_enabled", value)

    @property
    @pulumi.getter(name="excludedDisks")
    def excluded_disks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def excluded_disks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _RestorePointState:
    def __init__(__self__, *,
                 ...
                 excluded_disks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_machine_restore_point_collection_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="virtualMachineRestorePointCollectionId")
    def virtual_machine_restore_point_collection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the ID of the Virtual Machine Restore Point Collection the Virtual Machine Restore Point will be associated with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "virtual_machine_restore_point_collection_id")
    ...
    @virtual_machine_restore_point_collection_id.setter
    def virtual_machine_restore_point_collection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "virtual_machine_restore_point_collection_id", value)
...
class RestorePoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            excluded_disks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            virtual_machine_restore_point_collection_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RestorePoint':
        """
    ...
    @property
    @pulumi.getter(name="crashConsistencyModeEnabled")
    def crash_consistency_mode_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the Consistency Mode of the Virtual Machine Restore Point is set to `CrashConsistent`. Defaults to `false`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "crash_consistency_mode_enabled")
    ...
    @property
    @pulumi.getter(name="excludedDisks")
    def excluded_disks(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of disks that will be excluded from the Virtual Machine Restore Point. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "excluded_disks")
    ...
    @property
    @pulumi.getter(name="virtualMachineRestorePointCollectionId")
    def virtual_machine_restore_point_collection_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the ID of the Virtual Machine Restore Point Collection the Virtual Machine Restore Point will be associated with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "virtual_machine_restore_point_collection_id")
