...
class BastionHostIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the IP configuration. Changing this forces a new resource to be created.
        :param builtins.str public_ip_address_id: Reference to a Public IP Address to associate with this Bastion Host. Changing this forces a new resource to be created.
        :param builtins.str subnet_id: Reference to a subnet in which this Bastion Host has been created. Changing this forces a new resource to be created.
...
class CapacityReservationSku(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.int capacity: Specifies the number of instances to be reserved. It must be greater than or equal to `0` and not exceed the quota in the subscription.
        :param builtins.str name: Name of the sku, such as `Standard_F2`. Changing this forces a new resource to be created.
        """
...
class DiskEncryptionSetIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of Managed Service Identity that is configured on this Disk Encryption Set. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Disk Encryption Set.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param builtins.str principal_id: The (Client) ID of the Service Principal.
        :param builtins.str tenant_id: The ID of the Tenant the Service Principal is assigned in.
        """
...
class ExtensionProtectedSettingsFromKeyVault(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str secret_url: The URL to the Key Vault Secret which stores the protected settings.
        :param builtins.str source_vault_id: The ID of the source Key Vault.
        """
...
class GalleryApplicationVersionManageAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str install: The command to install the Gallery Application. Changing this forces a new resource to be created.
        :param builtins.str remove: The command to remove the Gallery Application. Changing this forces a new resource to be created.
        :param builtins.str update: The command to update the Gallery Application. Changing this forces a new resource to be created.
        """
...
class GalleryApplicationVersionSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str media_link: The Storage Blob URI of the source application package. Changing this forces a new resource to be created.
        :param builtins.str default_configuration_link: The Storage Blob URI of the default configuration. Changing this forces a new resource to be created.
        """
...
class GalleryApplicationVersionTargetRegion(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 regional_replica_count: builtins.int,
                 exclude_from_latest: Optional[builtins.bool] = None,
                 storage_account_type: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Azure Region in which the Gallery Application Version exists.
        :param builtins.int regional_replica_count: The number of replicas of the Gallery Application Version to be created per region. Possible values are between `1` and `10`.
        :param builtins.bool exclude_from_latest: Specifies whether this Gallery Application Version should be excluded from the `latest` filter. If set to `true`, this Gallery Application Version won't be returned for the `latest` version. Defaults to `false`.
        :param builtins.str storage_account_type: The storage account type for the Gallery Application Version. Possible values are `Standard_LRS`, `Premium_LRS` and `Standard_ZRS`. Defaults to `Standard_LRS`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def regional_replica_count(self) -> builtins.int:
        """
...
class ImageDataDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str storage_type: The type of Storage Disk to use. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param builtins.str blob_uri: Specifies the URI in Azure storage of the blob that you want to use to create the image.
        :param builtins.str caching: Specifies the caching mode as `ReadWrite`, `ReadOnly`, or `None`. Defaults to `None`.
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this disk. Changing this forces a new resource to be created.
        :param builtins.int lun: Specifies the logical unit number of the data disk.
        :param builtins.str managed_disk_id: Specifies the ID of the managed disk resource that you want to use to create the image. Changing this forces a new resource to be created.
        :param builtins.int size_gb: Specifies the size of the image to be created. The target size can't be smaller than the source size.
        """
...
class ImageOsDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disk_encryption_set_id: Optional[builtins.str] = None,
                 managed_disk_id: Optional[builtins.str] = None,
                 os_state: Optional[builtins.str] = None,
                 os_type: Optional[builtins.str] = None,
                 size_gb: Optional[builtins.int] = None):
        """
        :param builtins.str storage_type: The type of Storage Disk to use. Possible values are `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS`, `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param builtins.str blob_uri: Specifies the URI in Azure storage of the blob that you want to use to create the image. Changing this forces a new resource to be created.
        :param builtins.str caching: Specifies the caching mode as `ReadWrite`, `ReadOnly`, or `None`. The default is `None`.
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this disk. Changing this forces a new resource to be created.
        :param builtins.str managed_disk_id: Specifies the ID of the managed disk resource that you want to use to create the image.
        :param builtins.str os_state: Specifies the state of the operating system contained in the blob. Currently, the only value is Generalized. Possible values are `Generalized` and `Specialized`.
        :param builtins.str os_type: Specifies the type of operating system contained in the virtual machine image. Possible values are: `Windows` or `Linux`.
        :param builtins.int size_gb: Specifies the size of the image to be created. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "storage_type", storage_type)
        if blob_uri is not None:
            pulumi.set(__self__, "blob_uri", blob_uri)
    ...
    def os_state(self) -> Optional[builtins.str]:
        """
...
class LinuxVirtualMachineAdditionalCapabilities(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool hibernation_enabled: Whether to enable the hibernation capability or not.
        :param builtins.bool ultra_ssd_enabled: Should the capacity to enable Data Disks of the `UltraSSD_LRS` storage account type be supported on this Virtual Machine? Defaults to `false`.
        """
...
class LinuxVirtualMachineAdminSshKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str public_key: The Public Key which should be used for authentication, which needs to be in `ssh-rsa` format with at least 2048-bit or in `ssh-ed25519` format. Changing this forces a new resource to be created.
        :param builtins.str username: The Username for which this Public SSH Key should be configured. Changing this forces a new resource to be created.
...
class LinuxVirtualMachineBootDiagnostics(dict):
    ...
    def __init__(__self__, *,
                 storage_account_uri: Optional[builtins.str] = None):
        """
        :param builtins.str storage_account_uri: The Primary/Secondary Endpoint for the Azure Storage Account which should be used to store Boot Diagnostics, including Console Output and Screenshots from the Hypervisor.
    ...
    def storage_account_uri(self) -> Optional[builtins.str]:
        """
...
class LinuxVirtualMachineGalleryApplication(dict):
    ...
    def __init__(__self__, *,
                 ...
                 automatic_upgrade_enabled: Optional[builtins.bool] = None,
                 configuration_blob_uri: Optional[builtins.str] = None,
                 order: Optional[builtins.int] = None,
                 tag: Optional[builtins.str] = None,
                 treat_failure_as_deployment_failure_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str version_id: Specifies the Gallery Application Version resource ID.
        :param builtins.bool automatic_upgrade_enabled: Specifies whether the version will be automatically updated for the VM when a new Gallery Application version is available in PIR/SIG. Defaults to `false`.
        :param builtins.str configuration_blob_uri: Specifies the URI to an Azure Blob that will replace the default configuration for the package if provided.
        :param builtins.int order: Specifies the order in which the packages have to be installed. Possible values are between `0` and `2147483647`. Defaults to `0`.
        :param builtins.str tag: Specifies a passthrough value for more generic context. This field can be any valid `string` value.
        :param builtins.bool treat_failure_as_deployment_failure_enabled: Specifies whether any failure for any operation in the VmApplication will fail the deployment of the VM. Defaults to `false`.
        """
    ...
    def automatic_upgrade_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def configuration_blob_uri(self) -> Optional[builtins.str]:
        """
    ...
    def treat_failure_as_deployment_failure_enabled(self) -> Optional[builtins.bool]:
        """
...
class LinuxVirtualMachineIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Linux Virtual Machine. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Linux Virtual Machine.
...
class LinuxVirtualMachineOsDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str caching: The Type of Caching which should be used for the Internal OS Disk. Possible values are `None`, `ReadOnly` and `ReadWrite`.
        :param builtins.str storage_account_type: The Type of Storage Account which should back this the Internal OS Disk. Possible values are `Standard_LRS`, `StandardSSD_LRS`, `Premium_LRS`, `StandardSSD_ZRS` and `Premium_ZRS`. Changing this forces a new resource to be created.
        ...
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to Encrypt this OS Disk. Conflicts with `secure_vm_disk_encryption_set_id`.
               
               > **NOTE:** The Disk Encryption Set must have the `Reader` Role Assignment scoped on the Key Vault - in addition to an Access Policy to the Key Vault
        :param builtins.int disk_size_gb: The Size of the Internal OS Disk in GB, if you wish to vary from the size used in the image this Virtual Machine is sourced from.
               
               > **NOTE:** If specified this must be equal to or larger than the size of the Image the Virtual Machine is based on. When creating a larger disk than exists in the image you'll need to repartition the disk to use the remaining space.
        :param builtins.str id: The ID of the OS disk.
        :param builtins.str name: The name which should be used for the Internal OS Disk. Changing this forces a new resource to be created.
        :param builtins.str secure_vm_disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to Encrypt this OS Disk when the Virtual Machine is a Confidential VM. Conflicts with `disk_encryption_set_id`. Changing this forces a new resource to be created.
               
               > **NOTE:** `secure_vm_disk_encryption_set_id` can only be specified when `security_encryption_type` is set to `DiskWithVMGuestState`.
        :param builtins.str security_encryption_type: Encryption Type when the Virtual Machine is a Confidential VM. Possible values are `VMGuestStateOnly` and `DiskWithVMGuestState`. Changing this forces a new resource to be created.
               
               > **NOTE:** `vtpm_enabled` must be set to `true` when `security_encryption_type` is specified.
               
               > **NOTE:** `encryption_at_host_enabled` cannot be set to `true` when `security_encryption_type` is set to `DiskWithVMGuestState`.
        :param builtins.bool write_accelerator_enabled: Should Write Accelerator be Enabled for this OS Disk? Defaults to `false`.
...
class LinuxVirtualMachineOsDiskDiffDiskSettings(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str option: Specifies the Ephemeral Disk Settings for the OS Disk. At this time the only possible value is `Local`. Changing this forces a new resource to be created.
        :param builtins.str placement: Specifies where to store the Ephemeral Disk. Possible values are `CacheDisk` and `ResourceDisk`. Defaults to `CacheDisk`. Changing this forces a new resource to be created.
        """
...
class LinuxVirtualMachineOsImageNotification(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str timeout: Length of time a notification to be sent to the VM on the instance metadata server till the VM gets OS upgraded. The only possible value is `PT15M`. Defaults to `PT15M`.
        """
...
class LinuxVirtualMachinePlan(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies the Name of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created.
        :param builtins.str product: Specifies the Product of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created.
        :param builtins.str publisher: Specifies the Publisher of the Marketplace Image this Virtual Machine should be created from. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
...
class LinuxVirtualMachineScaleSetAdditionalCapabilities(dict):
    ...
    def __init__(__self__, *,
                 ultra_ssd_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool ultra_ssd_enabled: Should the capacity to enable Data Disks of the `UltraSSD_LRS` storage account type be supported on this Virtual Machine Scale Set? Possible values are `true` or `false`. Defaults to `false`. Changing this forces a new resource to be created.
        """
        if ultra_ssd_enabled is not None:
            pulumi.set(__self__, "ultra_ssd_enabled", ultra_ssd_enabled)
...
class LinuxVirtualMachineScaleSetAdminSshKey(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username: builtins.str):
        """
        :param builtins.str public_key: The Public Key which should be used for authentication, which needs to be in `ssh-rsa` format with at least 2048-bit or in `ssh-ed25519` format.
        :param builtins.str username: The Username for which this Public SSH Key should be configured.
...
class LinuxVirtualMachineScaleSetAutomaticInstanceRepair(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Should the automatic instance repair be enabled on this Virtual Machine Scale Set?
        :param builtins.str action: The repair action that will be used for repairing unhealthy virtual machines in the scale set. Possible values include `Replace`, `Restart`, `Reimage`.
        ...
        :param builtins.str grace_period: Amount of time for which automatic repairs will be delayed. The grace period starts right after the VM is found unhealthy. Possible values are between `10` and `90` minutes. The time duration should be specified in `ISO 8601` format (e.g. `PT10M` to `PT90M`).
...
class LinuxVirtualMachineScaleSetAutomaticOsUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool disable_automatic_rollback: Should automatic rollbacks be disabled?
        :param builtins.bool enable_automatic_os_upgrade: Should OS Upgrades automatically be applied to Scale Set instances in a rolling fashion when a newer version of the OS Image becomes available?
        """
    ...
    def disable_automatic_rollback(self) -> builtins.bool:
        """
    ...
    def enable_automatic_os_upgrade(self) -> builtins.bool:
        """
...
class LinuxVirtualMachineScaleSetDataDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disk_encryption_set_id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 ultra_ssd_disk_iops_read_write: Optional[builtins.int] = None,
                 ultra_ssd_disk_mbps_read_write: Optional[builtins.int] = None,
                 write_accelerator_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str caching: The type of Caching which should be used for this Data Disk. Possible values are `None`, `ReadOnly` and `ReadWrite`.
        :param builtins.int disk_size_gb: The size of the Data Disk which should be created.
        :param builtins.int lun: The Logical Unit Number of the Data Disk, which must be unique within the Virtual Machine.
        :param builtins.str storage_account_type: The Type of Storage Account which should back this Data Disk. Possible values include `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS`, `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS` and `UltraSSD_LRS`.
               
               > **Note:** `UltraSSD_LRS` is only supported when `ultra_ssd_enabled` within the `additional_capabilities` block is enabled.
        :param builtins.str create_option: The create option which should be used for this Data Disk. Possible values are `Empty` and `FromImage`. Defaults to `Empty`. (`FromImage` should only be used if the source image includes data disks).
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this Data Disk. Changing this forces a new resource to be created.
               
               > **Note:** The Disk Encryption Set must have the `Reader` Role Assignment scoped on the Key Vault - in addition to an Access Policy to the Key Vault
               
               > **Note:** Disk Encryption Sets are in Public Preview in a limited set of regions
        :param builtins.str name: The name of the Data Disk.
        :param builtins.int ultra_ssd_disk_iops_read_write: Specifies the Read-Write IOPS for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param builtins.int ultra_ssd_disk_mbps_read_write: Specifies the bandwidth in MB per second for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param builtins.bool write_accelerator_enabled: Should Write Accelerator be enabled for this Data Disk? Defaults to `false`.
    ...
    def ultra_ssd_disk_iops_read_write(self) -> Optional[builtins.int]:
        """
    ...
    def ultra_ssd_disk_mbps_read_write(self) -> Optional[builtins.int]:
        """
...
class LinuxVirtualMachineScaleSetExtension(dict):
    ...
    def __init__(__self__, *,
                 ...
                 protected_settings: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str name: The name for the Virtual Machine Scale Set Extension.
        :param builtins.str publisher: Specifies the Publisher of the Extension.
        :param builtins.str type: Specifies the Type of the Extension.
        :param builtins.str type_handler_version: Specifies the version of the extension to use, available versions can be found using the Azure CLI.
        :param builtins.bool auto_upgrade_minor_version: Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
        :param builtins.bool automatic_upgrade_enabled: Should the Extension be automatically updated whenever the Publisher releases a new version of this VM Extension?
        :param builtins.str force_update_tag: A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
        :param builtins.str protected_settings: A JSON String which specifies Sensitive Settings (such as Passwords) for the Extension.
        ...
        :param Sequence[builtins.str] provision_after_extensions: An ordered list of Extension names which this should be provisioned after.
        :param builtins.str settings: A JSON String which specifies Settings for the Extension.
    ...
    def protected_settings(self) -> Optional[builtins.str]:
        """
...
class LinuxVirtualMachineScaleSetGalleryApplication(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tag: Optional[builtins.str] = None):
        """
        :param builtins.str version_id: Specifies the Gallery Application Version resource ID. Changing this forces a new resource to be created.
        :param builtins.str configuration_blob_uri: Specifies the URI to an Azure Blob that will replace the default configuration for the package if provided. Changing this forces a new resource to be created.
        :param builtins.int order: Specifies the order in which the packages have to be installed. Possible values are between `0` and `2147483647`. Defaults to `0`. Changing this forces a new resource to be created.
        :param builtins.str tag: Specifies a passthrough value for more generic context. This field can be any valid `string` value. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "version_id", version_id)
        if configuration_blob_uri is not None:
            pulumi.set(__self__, "configuration_blob_uri", configuration_blob_uri)
...
class LinuxVirtualMachineScaleSetIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Linux Virtual Machine Scale Set. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Linux Virtual Machine Scale Set.
...
class LinuxVirtualMachineScaleSetNetworkInterface(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The Name which should be used for this Network Interface. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] dns_servers: A list of IP Addresses of DNS Servers which should be assigned to the Network Interface.
        :param builtins.bool enable_accelerated_networking: Does this Network Interface support Accelerated Networking? Defaults to `false`.
        :param builtins.bool enable_ip_forwarding: Does this Network Interface support IP Forwarding? Defaults to `false`.
        :param builtins.str network_security_group_id: The ID of a Network Security Group which should be assigned to this Network Interface.
        :param builtins.bool primary: Is this the Primary IP Configuration?
...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 application_gateway_backend_address_pool_ids: Optional[Sequence[builtins.str]] = None,
                 application_security_group_ids: Optional[Sequence[builtins.str]] = None,
                 load_balancer_backend_address_pool_ids: Optional[Sequence[builtins.str]] = None,
                 load_balancer_inbound_nat_rules_ids: Optional[Sequence[builtins.str]] = None,
                 primary: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.str name: The Name which should be used for this IP Configuration.
        :param Sequence[builtins.str] application_gateway_backend_address_pool_ids: A list of Backend Address Pools ID's from a Application Gateway which this Virtual Machine Scale Set should be connected to.
        :param Sequence[builtins.str] application_security_group_ids: A list of Application Security Group ID's which this Virtual Machine Scale Set should be connected to.
        :param Sequence[builtins.str] load_balancer_backend_address_pool_ids: A list of Backend Address Pools ID's from a Load Balancer which this Virtual Machine Scale Set should be connected to.
        ...
        :param Sequence[builtins.str] load_balancer_inbound_nat_rules_ids: A list of NAT Rule ID's from a Load Balancer which this Virtual Machine Scale Set should be connected to.
               
               > **Note:** When using this field you'll also need to configure a Rule for the Load Balancer, and use a `depends_on` between this resource and the Load Balancer Rule.
        :param builtins.bool primary: Is this the Primary IP Configuration for this Network Interface? Defaults to `false`.
        ...
        :param builtins.str subnet_id: The ID of the Subnet which this IP Configuration should be connected to.
               
               > **Note:** `subnet_id` is required if `version` is set to `IPv4`.
        :param builtins.str version: The Internet Protocol Version which should be used for this IP Configuration. Possible values are `IPv4` and `IPv6`. Defaults to `IPv4`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def application_gateway_backend_address_pool_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def application_security_group_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def load_balancer_backend_address_pool_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def load_balancer_inbound_nat_rules_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Name of the Public IP Address Configuration.
        :param builtins.str domain_name_label: The Prefix which should be used for the Domain Name Label for each Virtual Machine Instance. Azure concatenates the Domain Name Label and Virtual Machine Index to create a unique Domain Name Label for each Virtual Machine.
        :param builtins.int idle_timeout_in_minutes: The Idle Timeout in Minutes for the Public IP Address. Possible values are in the range `4` to `32`.
        ...
        :param builtins.str public_ip_prefix_id: The ID of the Public IP Address Prefix from where Public IP Addresses should be allocated. Changing this forces a new resource to be created.
        ...
        :param builtins.str version: The Internet Protocol Version which should be used for this public IP address. Possible values are `IPv4` and `IPv6`. Defaults to `IPv4`. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
...
class LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTag(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str tag: The IP Tag associated with the Public IP, such as `SQL` or `Storage`. Changing this forces a new resource to be created.
        :param builtins.str type: The Type of IP Tag, such as `FirstPartyUsage`. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "tag", tag)
        pulumi.set(__self__, "type", type)
...
class LinuxVirtualMachineScaleSetOsDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str caching: The Type of Caching which should be used for the Internal OS Disk. Possible values are `None`, `ReadOnly` and `ReadWrite`.
        :param builtins.str storage_account_type: The Type of Storage Account which should back this the Internal OS Disk. Possible values include `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS`, `Premium_LRS` and `Premium_ZRS`. Changing this forces a new resource to be created.
        ...
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this OS Disk. Conflicts with `secure_vm_disk_encryption_set_id`. Changing this forces a new resource to be created.
               
               > **Note:** The Disk Encryption Set must have the `Reader` Role Assignment scoped on the Key Vault - in addition to an Access Policy to the Key Vault
               
               > **Note:** Disk Encryption Sets are in Public Preview in a limited set of regions
        :param builtins.int disk_size_gb: The Size of the Internal OS Disk in GB, if you wish to vary from the size used in the image this Virtual Machine Scale Set is sourced from.
        ...
        :param builtins.str secure_vm_disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to Encrypt the OS Disk when the Virtual Machine Scale Set is Confidential VMSS. Conflicts with `disk_encryption_set_id`. Changing this forces a new resource to be created.
               
               > **Note:** `secure_vm_disk_encryption_set_id` can only be specified when `security_encryption_type` is set to `DiskWithVMGuestState`.
        :param builtins.str security_encryption_type: Encryption Type when the Virtual Machine Scale Set is Confidential VMSS. Possible values are `VMGuestStateOnly` and `DiskWithVMGuestState`. Changing this forces a new resource to be created.
...
class LinuxVirtualMachineScaleSetPlan(dict):
    def __init__(__self__, *,
                 ...
                 publisher: builtins.str):
        """
        :param builtins.str name: Specifies the name of the image from the marketplace. Changing this forces a new resource to be created.
        :param builtins.str product: Specifies the product of the image from the marketplace. Changing this forces a new resource to be created.
        :param builtins.str publisher: Specifies the publisher of the image. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "product", product)
        pulumi.set(__self__, "publisher", publisher)
...
class LinuxVirtualMachineScaleSetRollingUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cross_zone_upgrades_enabled: Optional[builtins.bool] = None,
                 maximum_surge_instances_enabled: Optional[builtins.bool] = None,
                 prioritize_unhealthy_instances_enabled: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.int max_unhealthy_upgraded_instance_percent: The maximum percentage of upgraded virtual machine instances that can be found to be in an unhealthy state. This check will happen after each batch is upgraded. If this percentage is ever exceeded, the rolling update aborts.
        ...
        :param builtins.bool cross_zone_upgrades_enabled: Should the Virtual Machine Scale Set ignore the Azure Zone boundaries when constructing upgrade batches? Possible values are `true` or `false`.
        :param builtins.bool maximum_surge_instances_enabled: Create new virtual machines to upgrade the scale set, rather than updating the existing virtual machines. Existing virtual machines will be deleted once the new virtual machines are created for each batch. Possible values are `true` or `false`.
               
               > **Note:** `overprovision` must be set to `false` when `maximum_surge_instances_enabled` is specified.
        :param builtins.bool prioritize_unhealthy_instances_enabled: Upgrade all unhealthy instances in a scale set before any healthy instances. Possible values are `true` or `false`.
        """
    ...
    def max_batch_instance_percent(self) -> builtins.int:
        """
    ...
    def max_unhealthy_instance_percent(self) -> builtins.int:
        """
    ...
    def max_unhealthy_upgraded_instance_percent(self) -> builtins.int:
        """
    ...
    def cross_zone_upgrades_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def maximum_surge_instances_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def prioritize_unhealthy_instances_enabled(self) -> Optional[builtins.bool]:
        """
...
class LinuxVirtualMachineScaleSetScaleIn(dict):
    ...
    def __init__(__self__, *,
                 force_deletion_enabled: Optional[builtins.bool] = None,
                 rule: Optional[builtins.str] = None):
        """
        :param builtins.bool force_deletion_enabled: Should the virtual machines chosen for removal be force deleted when the virtual machine scale set is being scaled-in? Possible values are `true` or `false`. Defaults to `false`.
        :param builtins.str rule: The scale-in policy rule that decides which virtual machines are chosen for removal when a Virtual Machine Scale Set is scaled in. Possible values for the scale-in policy rules are `Default`, `NewestVM` and `OldestVM`, defaults to `Default`. For more information about scale in policy, please [refer to this doc](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-scale-in-policy).
        """
    ...
    def force_deletion_enabled(self) -> Optional[builtins.bool]:
        """
...
class LinuxVirtualMachineScaleSetSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key_vault_id: The ID of the Key Vault from which all Secrets should be sourced.
        """
...
class LinuxVirtualMachineScaleSetSecretCertificate(dict):
    def __init__(__self__, *,
                 url: builtins.str):
        """
        :param builtins.str url: The Secret URL of a Key Vault Certificate.
...
class LinuxVirtualMachineScaleSetSourceImageReference(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str offer: Specifies the offer of the image used to create the virtual machines. Changing this forces a new resource to be created.
        :param builtins.str publisher: Specifies the publisher of the image used to create the virtual machines. Changing this forces a new resource to be created.
        :param builtins.str sku: Specifies the SKU of the image used to create the virtual machines.
        :param builtins.str version: Specifies the version of the image used to create the virtual machines.
        """
...
class LinuxVirtualMachineScaleSetTerminationNotification(dict):
    def __init__(__self__, *,
                 ...
                 timeout: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Should the termination notification be enabled on this Virtual Machine Scale Set?
        :param builtins.str timeout: Length of time (in minutes, between 5 and 15) a notification to be sent to the VM on the instance metadata server till the VM gets deleted. The time duration should be specified in ISO 8601 format. Defaults to `PT5M`.
...
class LinuxVirtualMachineSourceImageReference(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str offer: Specifies the offer of the image used to create the virtual machines. Changing this forces a new resource to be created.
        :param builtins.str publisher: Specifies the publisher of the image used to create the virtual machines. Changing this forces a new resource to be created.
        :param builtins.str sku: Specifies the SKU of the image used to create the virtual machines. Changing this forces a new resource to be created.
        :param builtins.str version: Specifies the version of the image used to create the virtual machines. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "offer", offer)
        pulumi.set(__self__, "publisher", publisher)
        pulumi.set(__self__, "sku", sku)
...
class LinuxVirtualMachineTerminationNotification(dict):
    def __init__(__self__, *,
                 ...
                 timeout: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Should the termination notification be enabled on this Virtual Machine?
        :param builtins.str timeout: Length of time (in minutes, between `5` and `15`) a notification to be sent to the VM on the instance metadata server till the VM gets deleted. The time duration should be specified in ISO 8601 format. Defaults to `PT5M`.
...
class ManagedDiskEncryptionSettingsDiskEncryptionKey(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_vault_id: builtins.str):
        """
        :param builtins.str secret_url: The URL to the Key Vault Secret used as the Disk Encryption Key. This can be found as `id` on the `keyvault.Secret` resource.
...
class ManagedDiskEncryptionSettingsKeyEncryptionKey(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_vault_id: builtins.str):
        """
        :param builtins.str key_url: The URL to the Key Vault Key used as the Key Encryption Key. This can be found as `id` on the `keyvault.Key` resource.
        :param builtins.str source_vault_id: The ID of the source Key Vault. This can be found as `id` on the `keyvault.KeyVault` resource.
        """
...
class OrchestratedVirtualMachineScaleSetAdditionalCapabilities(dict):
    ...
    def __init__(__self__, *,
                 ultra_ssd_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool ultra_ssd_enabled: Should the capacity to enable Data Disks of the `UltraSSD_LRS` storage account type be supported on this Virtual Machine Scale Set? Defaults to `false`. Changing this forces a new resource to be created.
        """
        if ultra_ssd_enabled is not None:
            pulumi.set(__self__, "ultra_ssd_enabled", ultra_ssd_enabled)
...
class OrchestratedVirtualMachineScaleSetAutomaticInstanceRepair(dict):
    ...
    def __init__(__self__, *,
                 ...
                 grace_period: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Should the automatic instance repair be enabled on this Virtual Machine Scale Set? Possible values are `true` and `false`.
        :param builtins.str action: The repair action that will be used for repairing unhealthy virtual machines in the scale set. Possible values include `Replace`, `Restart`, `Reimage`.
...
class OrchestratedVirtualMachineScaleSetBootDiagnostics(dict):
    ...
    def __init__(__self__, *,
                 storage_account_uri: Optional[builtins.str] = None):
        """
        :param builtins.str storage_account_uri: The Primary/Secondary Endpoint for the Azure Storage Account which should be used to store Boot Diagnostics, including Console Output and Screenshots from the Hypervisor. By including a `boot_diagnostics` block without passing the `storage_account_uri` field will cause the API to utilize a Managed Storage Account to store the Boot Diagnostics output.
        """
        if storage_account_uri is not None:
            pulumi.set(__self__, "storage_account_uri", storage_account_uri)
...
class OrchestratedVirtualMachineScaleSetDataDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str storage_account_type: The Type of Storage Account which should back this Data Disk. Possible values include `Standard_LRS`, `StandardSSD_LRS`, `StandardSSD_ZRS`, `Premium_LRS`, `PremiumV2_LRS`, `Premium_ZRS` and `UltraSSD_LRS`.
        :param builtins.str create_option: The create option which should be used for this Data Disk. Possible values are Empty and FromImage. Defaults to `Empty`. (FromImage should only be used if the source image includes data disks).
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt the Data Disk. Changing this forces a new resource to be created.
        :param builtins.int disk_size_gb: The size of the Data Disk which should be created. Required if `create_option` is specified as `Empty`.
        :param builtins.int lun: The Logical Unit Number of the Data Disk, which must be unique within the Virtual Machine. Required if `create_option` is specified as `Empty`.
        :param builtins.int ultra_ssd_disk_iops_read_write: Specifies the Read-Write IOPS for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param builtins.int ultra_ssd_disk_mbps_read_write: Specifies the bandwidth in MB per second for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param builtins.bool write_accelerator_enabled: Specifies if Write Accelerator is enabled on the Data Disk. Defaults to `false`.
        """
        pulumi.set(__self__, "caching", caching)
        pulumi.set(__self__, "storage_account_type", storage_account_type)
        if create_option is not None:
...
class OrchestratedVirtualMachineScaleSetExtension(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str,
                 type_handler_version: builtins.str,
                 auto_upgrade_minor_version_enabled: Optional[builtins.bool] = None,
                 extensions_to_provision_after_vm_creations: Optional[Sequence[builtins.str]] = None,
                 failure_suppression_enabled: Optional[builtins.bool] = None,
                 force_extension_execution_on_change: Optional[builtins.str] = None,
                 protected_settings: Optional[builtins.str] = None,
        ...
        :param builtins.str type: Specifies the Type of the Extension.
        :param builtins.str type_handler_version: Specifies the version of the extension to use, available versions can be found using the Azure CLI.
        :param builtins.bool auto_upgrade_minor_version_enabled: Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
        :param Sequence[builtins.str] extensions_to_provision_after_vm_creations: An ordered list of Extension names which Virtual Machine Scale Set should provision after VM creation.
        :param builtins.bool failure_suppression_enabled: Should failures from the extension be suppressed? Possible values are `true` or `false`.
               
               > **Note:** Operational failures such as not connecting to the VM will not be suppressed regardless of the `failure_suppression_enabled` value.
        :param builtins.str force_extension_execution_on_change: A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
        :param builtins.str protected_settings: A JSON String which specifies Sensitive Settings (such as Passwords) for the Extension.
    ...
    def auto_upgrade_minor_version_enabled(self) -> Optional[builtins.bool]:
        """
        Should the latest version of the Extension be used at Deployment Time, if one is available? This won't auto-update the extension on existing installation. Defaults to `true`.
        """
    ...
    def extensions_to_provision_after_vm_creations(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def failure_suppression_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def force_extension_execution_on_change(self) -> Optional[builtins.str]:
        """
        A value which, when different to the previous value can be used to force-run the Extension even if the Extension Configuration hasn't changed.
        """
...
class OrchestratedVirtualMachineScaleSetIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Managed Identity IDs to be assigned to this Windows Virtual Machine Scale Set.
        :param builtins.str type: The type of Managed Identity that should be configured on this Windows Virtual Machine Scale Set. Only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class OrchestratedVirtualMachineScaleSetNetworkInterface(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The Name which should be used for this Network Interface. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] dns_servers: A list of IP Addresses of DNS Servers which should be assigned to the Network Interface.
        :param builtins.bool enable_accelerated_networking: Does this Network Interface support Accelerated Networking? Possible values are `true` and `false`. Defaults to `false`.
        :param builtins.bool enable_ip_forwarding: Does this Network Interface support IP Forwarding? Possible values are `true` and `false`. Defaults to `false`.
        :param builtins.str network_security_group_id: The ID of a Network Security Group which should be assigned to this Network Interface.
        :param builtins.bool primary: Is this the Primary IP Configuration? Possible values are `true` and `false`. Defaults to `false`.
...
class OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The Name which should be used for this IP Configuration.
        :param Sequence[builtins.str] application_gateway_backend_address_pool_ids: A list of Backend Address Pools IDs from a Application Gateway which this Virtual Machine Scale Set should be connected to.
        :param Sequence[builtins.str] application_security_group_ids: A list of Application Security Group IDs which this Virtual Machine Scale Set should be connected to.
        :param Sequence[builtins.str] load_balancer_backend_address_pool_ids: A list of Backend Address Pools IDs from a Load Balancer which this Virtual Machine Scale Set should be connected to.
               
               > **Note:** When using this field you'll also need to configure a Rule for the Load Balancer, and use a depends_on between this resource and the Load Balancer Rule.
        :param builtins.bool primary: Is this the Primary IP Configuration for this Network Interface? Possible values are `true` and `false`. Defaults to `false`.
...
class OrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddress(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The Name of the Public IP Address Configuration.
        :param builtins.str domain_name_label: The Prefix which should be used for the Domain Name Label for each Virtual Machine Instance. Azure concatenates the Domain Name Label and Virtual Machine Index to create a unique Domain Name Label for each Virtual Machine. Valid values must be between `1` and `26` characters long, start with a lower case letter, end with a lower case letter or number and contains only `a-z`, `0-9` and `hyphens`.
        :param builtins.int idle_timeout_in_minutes: The Idle Timeout in Minutes for the Public IP Address. Possible values are in the range `4` to `32`.
...
class OrchestratedVirtualMachineScaleSetOsDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set which should be used to encrypt this OS Disk. Changing this forces a new resource to be created.
               
               > **Note:** Disk Encryption Sets are in Public Preview in a limited set of regions
        :param builtins.int disk_size_gb: The Size of the Internal OS Disk in GB, if you wish to vary from the size used in the image this Virtual Machine Scale Set is sourced from.
        :param builtins.bool write_accelerator_enabled: Specifies if Write Accelerator is enabled on the OS Disk. Defaults to `false`.
        """
        pulumi.set(__self__, "caching", caching)
        pulumi.set(__self__, "storage_account_type", storage_account_type)
        if diff_disk_settings is not None:
...
class OrchestratedVirtualMachineScaleSetOsProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str custom_data: The Base64-Encoded Custom Data which should be used for this Virtual Machine Scale Set.
...
class OrchestratedVirtualMachineScaleSetOsProfileLinuxConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 patch_assessment_mode: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str admin_username: The username of the local administrator on each Virtual Machine Scale Set instance. Changing this forces a new resource to be created.
        :param builtins.str admin_password: The Password which should be used for the local-administrator on this Virtual Machine. Changing this forces a new resource to be created.
        ...
        :param builtins.str computer_name_prefix: The prefix which should be used for the name of the Virtual Machines in this Scale Set. If unspecified this defaults to the value for the name field. If the value of the name field is not a valid `computer_name_prefix`, then you must specify `computer_name_prefix`. Changing this forces a new resource to be created.
        :param builtins.bool disable_password_authentication: When an `admin_password` is specified `disable_password_authentication` must be set to `false`. Defaults to `true`.
               
               > **Note:** Either `admin_password` or `admin_ssh_key` must be specified.
        :param builtins.str patch_assessment_mode: Specifies the mode of VM Guest Patching for the virtual machines that are associated to the Virtual Machine Scale Set. Possible values are `AutomaticByPlatform` or `ImageDefault`. Defaults to `ImageDefault`.
               
               > **Note:** If the `patch_assessment_mode` is set to `AutomaticByPlatform` then the `provision_vm_agent` field must be set to `true`.
        :param builtins.str patch_mode: Specifies the mode of in-guest patching of this Windows Virtual Machine. Possible values are `ImageDefault` or `AutomaticByPlatform`. Defaults to `ImageDefault`. For more information on patch modes please see the [product documentation](https://docs.microsoft.com/azure/virtual-machines/automatic-vm-guest-patching#patch-orchestration-modes).
        ...
        :param builtins.bool provision_vm_agent: Should the Azure VM Agent be provisioned on each Virtual Machine in the Scale Set? Defaults to `true`. Changing this value forces a new resource to be created.
    ...
    def patch_assessment_mode(self) -> Optional[builtins.str]:
        """
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 hotpatching_enabled: Optional[builtins.bool] = None,
                 patch_assessment_mode: Optional[builtins.str] = None,
                 patch_mode: Optional[builtins.str] = None,
                 provision_vm_agent: Optional[builtins.bool] = None,
        ...
        :param builtins.str computer_name_prefix: The prefix which should be used for the name of the Virtual Machines in this Scale Set. If unspecified this defaults to the value for the `name` field. If the value of the `name` field is not a valid `computer_name_prefix`, then you must specify `computer_name_prefix`. Changing this forces a new resource to be created.
        :param builtins.bool enable_automatic_updates: Are automatic updates enabled for this Virtual Machine? Defaults to `true`.
        :param builtins.bool hotpatching_enabled: Should the VM be patched without requiring a reboot? Possible values are `true` or `false`. Defaults to `false`. For more information about hot patching please see the [product documentation](https://docs.microsoft.com/azure/automanage/automanage-hotpatch).
        ...
        :param builtins.str patch_assessment_mode: Specifies the mode of VM Guest Patching for the virtual machines that are associated to the Virtual Machine Scale Set. Possible values are `AutomaticByPlatform` or `ImageDefault`. Defaults to `ImageDefault`.
               ...
               > **Note:** If the `patch_assessment_mode` is set to `AutomaticByPlatform` then the `provision_vm_agent` field must be set to `true`.
        :param builtins.str patch_mode: Specifies the mode of in-guest patching of this Windows Virtual Machine. Possible values are `Manual`, `AutomaticByOS` and `AutomaticByPlatform`. Defaults to `AutomaticByOS`. For more information on patch modes please see the [product documentation](https://docs.microsoft.com/azure/virtual-machines/automatic-vm-guest-patching#patch-orchestration-modes).
        ...
        :param builtins.str timezone: Specifies the time zone of the virtual machine, the possible values are defined [here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/).
    ...
    def hotpatching_enabled(self) -> Optional[builtins.bool]:
        """
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationAdditionalUnattendContent(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content: The XML formatted content that is added to the unattend.xml file for the specified path and component. Changing this forces a new resource to be created.
        :param builtins.str setting: The name of the setting to which the content applies. Possible values are `AutoLogon` and `FirstLogonCommands`. Changing this forces a new resource to be created.
        """
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationSecretCertificate(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str store: The certificate store on the Virtual Machine where the certificate should be added.
        :param builtins.str url: The Secret URL of a Key Vault Certificate.
...
class OrchestratedVirtualMachineScaleSetOsProfileWindowsConfigurationWinrmListener(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str protocol: Specifies the protocol of listener. Possible values are `Http` or `Https`. Changing this forces a new resource to be created.
        :param builtins.str certificate_url: The Secret URL of a Key Vault Certificate, which must be specified when protocol is set to `Https`. Changing this forces a new resource to be created.
...
class OrchestratedVirtualMachineScaleSetPriorityMix(dict):
    ...
    def __init__(__self__, *,
                 base_regular_count: Optional[builtins.int] = None,
                 regular_percentage_above_base: Optional[builtins.int] = None):
        """
        :param builtins.int base_regular_count: Specifies the base number of VMs of `Regular` priority that will be created before any VMs of priority `Spot` are created. Possible values are integers between `0` and `1000`. Defaults to `0`.
        :param builtins.int regular_percentage_above_base: Specifies the desired percentage of VM instances that are of `Regular` priority after the base count has been reached. Possible values are integers between `0` and `100`. Defaults to `0`.
        """
    ...
    def base_regular_count(self) -> Optional[builtins.int]:
        """
    ...
    def regular_percentage_above_base(self) -> Optional[builtins.int]:
        """
...
class OrchestratedVirtualMachineScaleSetRollingUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int max_unhealthy_instance_percent: The maximum percentage of the total virtual machine instances in the scale set that can be simultaneously unhealthy, either as a result of being upgraded, or by being found in an unhealthy state by the virtual machine health checks before the rolling upgrade aborts. This constraint will be checked prior to starting any batch.
        :param builtins.int max_unhealthy_upgraded_instance_percent: The maximum percentage of upgraded virtual machine instances that can be found to be in an unhealthy state. This check will happen after each batch is upgraded. If this percentage is ever exceeded, the rolling update aborts.
        :param builtins.str pause_time_between_batches: The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 duration format.
        :param builtins.bool cross_zone_upgrades_enabled: Should the Virtual Machine Scale Set ignore the Azure Zone boundaries when constructing upgrade batches? Possible values are `true` or `false`.
        :param builtins.bool maximum_surge_instances_enabled: Create new virtual machines to upgrade the scale set, rather than updating the existing virtual machines. Existing virtual machines will be deleted once the new virtual machines are created for each batch. Possible values are `true` or `false`.
        :param builtins.bool prioritize_unhealthy_instances_enabled: Upgrade all unhealthy instances in a scale set before any healthy instances. Possible values are `true` or `false`.
        """
...
class OrchestratedVirtualMachineScaleSetSkuProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vm_sizes: Sequence[builtins.str]):
        """
        :param builtins.str allocation_strategy: Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated. Possible values are `LowestPrice` and `CapacityOptimized`.
        :param Sequence[builtins.str] vm_sizes: Specifies the VM sizes for the virtual machine scale set.
        """
    ...
    def vm_sizes(self) -> Sequence[builtins.str]:
        """
...
class OrchestratedVirtualMachineScaleSetTerminationNotification(dict):
    def __init__(__self__, *,
                 ...
                 timeout: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Should the termination notification be enabled on this Virtual Machine Scale Set? Possible values `true` or `false`.
        :param builtins.str timeout: Length of time (in minutes, between `5` and `15`) a notification to be sent to the VM on the instance metadata server till the VM gets deleted. The time duration should be specified in `ISO 8601` format. Defaults to `PT5M`.
        """
        pulumi.set(__self__, "enabled", enabled)
        if timeout is not None:
...
class PacketCaptureFilter(dict):
    ...
    def __init__(__self__, *,
                 protocol: builtins.str,
                 local_ip_address: Optional[builtins.str] = None,
                 local_port: Optional[builtins.str] = None,
                 remote_ip_address: Optional[builtins.str] = None,
                 remote_port: Optional[builtins.str] = None):
        """
        :param builtins.str protocol: The Protocol to be filtered on. Possible values include `Any`, `TCP` and `UDP`. Changing this forces a new resource to be created.
        :param builtins.str local_ip_address: The local IP Address to be filtered on. Specify `127.0.0.1` for a single address entry, `127.0.0.1-127.0.0.255` for a range and `127.0.0.1;127.0.0.5` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        :param builtins.str local_port: The local port to be filtered on. Specify `80` for single port entry, `80-85` for a range and `80;443;` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        :param builtins.str remote_ip_address: The remote IP Address to be filtered on. Specify `127.0.0.1` for a single address entry, `127.0.0.1-127.0.0.255` for a range and `127.0.0.1;127.0.0.5` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        :param builtins.str remote_port: The remote port to be filtered on. Specify `80` for single port entry, `80-85` for a range and `80;443;` for multiple entries. Multiple ranges and mixing ranges with multiple entries are currently not supported. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "protocol", protocol)
    ...
    def local_ip_address(self) -> Optional[builtins.str]:
        """
    ...
    def remote_ip_address(self) -> Optional[builtins.str]:
        """
...
class PacketCaptureStorageLocation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_path: Optional[builtins.str] = None):
        """
        :param builtins.str file_path: A valid local path on the target Virtual Machine. Must include the name of the capture file (*.cap). For Linux Virtual Machines it must start with `/var/captures`.
        :param builtins.str storage_account_id: The ID of the storage account where the packet capture sessions should be saved to.
               
               > **Note:** At least one of `file_path` or `storage_account_id` must be specified.
        :param builtins.str storage_path: The URI of the storage path where the packet capture sessions are saved to.
        """
    ...
    def storage_path(self) -> Optional[builtins.str]:
        """
...
class RunCommandParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The run parameter name.
        :param builtins.str value: The run parameter value.
        """
        pulumi.set(__self__, "name", name)
...
class ScaleSetBootDiagnostics(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str storage_uri: Blob endpoint for the storage account to hold the virtual machine's diagnostic files. This must be the root of a storage account, and not a storage container.
        :param builtins.bool enabled: Whether to enable boot diagnostics for the virtual machine. Defaults to `true`.
        """
...
class ScaleSetExtension(dict):
    ...
    def __init__(__self__, *,
                 ...
                 settings: Optional[builtins.str] = None):
        """
        :param builtins.str name: Specifies the name of the extension.
        :param builtins.str publisher: The publisher of the extension, available publishers can be found by using the Azure CLI.
        :param builtins.str type: The type of extension, available types for a publisher can be found using the Azure CLI.
        :param builtins.str type_handler_version: Specifies the version of the extension to use, available versions can be found using the Azure CLI.
        :param builtins.bool auto_upgrade_minor_version: Specifies whether or not to use the latest minor version available.
        :param builtins.str protected_settings: The protected_settings passed to the extension, like settings, these are specified as a JSON object in a string.
        :param Sequence[builtins.str] provision_after_extensions: Specifies a dependency array of extensions required to be executed before, the array stores the name of each extension.
        :param builtins.str settings: The settings passed to the extension, these are specified as a JSON object in a string.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "publisher", publisher)
        pulumi.set(__self__, "type", type)
...
class ScaleSetIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the identity type to be assigned to the scale set. Allowable values are `SystemAssigned` and `UserAssigned`. For the `SystemAssigned` identity the scale set's Service Principal ID (SPN) can be retrieved after the scale set has been created. See [documentation](https://docs.microsoft.com/azure/active-directory/managed-service-identity/overview) for more information. Possible values are `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of user managed identity ids to be assigned to the VMSS. Required if `type` is `UserAssigned`.
...
class ScaleSetNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_forwarding: Optional[builtins.bool] = None,
                 network_security_group_id: Optional[builtins.str] = None):
        """
        :param Sequence['ScaleSetNetworkProfileIpConfigurationArgs'] ip_configurations: An `ip_configuration` block as documented below.
        :param builtins.str name: Specifies the name of the network interface configuration.
        :param builtins.bool primary: Indicates whether network interfaces created from the network interface configuration will be the primary NIC of the VM.
        :param builtins.bool accelerated_networking: Specifies whether to enable accelerated networking or not.
        :param 'ScaleSetNetworkProfileDnsSettingsArgs' dns_settings: A `dns_settings` block as documented below.
        :param builtins.bool ip_forwarding: Whether IP forwarding is enabled on this NIC. Defaults to `false`.
        :param builtins.str network_security_group_id: Specifies the identifier for the network security group.
        """
        pulumi.set(__self__, "ip_configurations", ip_configurations)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "primary", primary)
    ...
    def ip_forwarding(self) -> Optional[builtins.bool]:
        """
...
class ScaleSetNetworkProfileDnsSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] dns_servers: Specifies an array of DNS servers.
        """
        pulumi.set(__self__, "dns_servers", dns_servers)
...
class ScaleSetNetworkProfileIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies name of the IP configuration.
        :param builtins.bool primary: Specifies if this ip_configuration is the primary one.
        :param builtins.str subnet_id: Specifies the identifier of the subnet.
        :param Sequence[builtins.str] application_gateway_backend_address_pool_ids: Specifies an array of references to backend address pools of application gateways. A scale set can reference backend address pools of multiple application gateways. Multiple scale sets can use the same application gateway.
        :param Sequence[builtins.str] application_security_group_ids: Specifies up to `20` application security group IDs.
        :param Sequence[builtins.str] load_balancer_backend_address_pool_ids: Specifies an array of references to backend address pools of load balancers. A scale set can reference backend address pools of one public and one internal load balancer. Multiple scale sets cannot use the same load balancer.
               
               > **NOTE:** When using this field you'll also need to configure a Rule for the Load Balancer, and use a `depends_on` between this resource and the Load Balancer Rule.
        :param Sequence[builtins.str] load_balancer_inbound_nat_rules_ids: Specifies an array of references to inbound NAT pools for load balancers. A scale set can reference inbound NAT pools of one public and one internal load balancer. Multiple scale sets cannot use the same load balancer.
...
class ScaleSetNetworkProfileIpConfigurationPublicIpAddressConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str domain_name_label: The domain name label for the DNS settings.
        :param builtins.int idle_timeout: The idle timeout in minutes. This value must be between 4 and 30.
        :param builtins.str name: The name of the public IP address configuration
        """
        pulumi.set(__self__, "domain_name_label", domain_name_label)
...
class ScaleSetOsProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_data: Optional[builtins.str] = None):
        """
        :param builtins.str admin_username: Specifies the administrator account name to use for all the instances of virtual machines in the scale set.
        :param builtins.str computer_name_prefix: Specifies the computer name prefix for all of the virtual machines in the scale set. Computer name prefixes must be 1 to 9 characters long for windows images and 1 - 58 for Linux. Changing this forces a new resource to be created.
        :param builtins.str admin_password: Specifies the administrator password to use for all the instances of virtual machines in a scale set.
        :param builtins.str custom_data: Specifies custom data to supply to the machine. On Linux-based systems, this can be used as a cloud-init script. On other systems, this will be copied as a file on disk. Internally, this provider will base64 encode this value before sending it to the API. The maximum length of the binary array is 65535 bytes.
        """
        pulumi.set(__self__, "admin_username", admin_username)
        pulumi.set(__self__, "computer_name_prefix", computer_name_prefix)
        if admin_password is not None:
...
class ScaleSetOsProfileLinuxConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool disable_password_authentication: Specifies whether password authentication should be disabled. Defaults to `false`. Changing this forces a new resource to be created.
...
class ScaleSetOsProfileLinuxConfigSshKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str path: The path of the destination file on the virtual machine
               
               > **NOTE:** Due to a limitation in the Azure VM Agent the only allowed `path` is `/home/{username}/.ssh/authorized_keys`.
        :param builtins.str key_data: The Public SSH Key which should be written to the `path` defined above.
...
class ScaleSetOsProfileSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str source_vault_id: Specifies the key vault to use.
...
class ScaleSetOsProfileSecretVaultCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_url: It is the Base64 encoding of a JSON Object that which is encoded in UTF-8 of which the contents need to be `data`, `dataType` and `password`.
        :param builtins.str certificate_store: (Required, on windows machines) Specifies the certificate store on the Virtual Machine where the certificate should be added to.
        """
        pulumi.set(__self__, "certificate_url", certificate_url)
...
class ScaleSetOsProfileWindowsConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_automatic_upgrades: Optional[builtins.bool] = None,
                 provision_vm_agent: Optional[builtins.bool] = None,
        ...
        :param builtins.bool enable_automatic_upgrades: Indicates whether virtual machines in the scale set are enabled for automatic updates.
        :param builtins.bool provision_vm_agent: Indicates whether virtual machine agent should be provisioned on the virtual machines in the scale set.
    ...
    def enable_automatic_upgrades(self) -> Optional[builtins.bool]:
        """
...
class ScaleSetOsProfileWindowsConfigAdditionalUnattendConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str component: Specifies the name of the component to configure with the added content. The only allowable value is `Microsoft-Windows-Shell-Setup`.
        :param builtins.str content: Specifies the base-64 encoded XML formatted content that is added to the unattend.xml file for the specified path and component.
        :param builtins.str pass_: Specifies the name of the pass that the content applies to. The only allowable value is `oobeSystem`.
...
class ScaleSetOsProfileWindowsConfigWinrm(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_url: Optional[builtins.str] = None):
        """
        :param builtins.str protocol: Specifies the protocol of listener
        :param builtins.str certificate_url: Specifies URL of the certificate with which new Virtual Machines is provisioned.
        """
        pulumi.set(__self__, "protocol", protocol)
        if certificate_url is not None:
            pulumi.set(__self__, "certificate_url", certificate_url)
...
class ScaleSetPacketCaptureMachineScope(dict):
    ...
    def __init__(__self__, *,
                 exclude_instance_ids: Optional[Sequence[builtins.str]] = None,
                 include_instance_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] exclude_instance_ids: A list of Virtual Machine Scale Set instance IDs which should be excluded from running Packet Capture, e.g. `["0", "2"]`. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] include_instance_ids: A list of Virtual Machine Scale Set instance IDs which should be included for Packet Capture, e.g. `["1", "3"]`. Changing this forces a new resource to be created.
        """
    ...
    def exclude_instance_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def include_instance_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ScaleSetPacketCaptureStorageLocation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_path: Optional[builtins.str] = None):
        """
        :param builtins.str file_path: A valid local path on the targeting VM. Must include the name of the capture file (*.cap). For Linux virtual machine it must start with `/var/captures`.
        :param builtins.str storage_account_id: The ID of the storage account to save the packet capture session
...
class ScaleSetPlan(dict):
    def __init__(__self__, *,
                 ...
                 publisher: builtins.str):
        """
        :param builtins.str name: Specifies the name of the image from the marketplace.
        :param builtins.str product: Specifies the product of the image from the marketplace.
        :param builtins.str publisher: Specifies the publisher of the image.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "product", product)
        pulumi.set(__self__, "publisher", publisher)
...
class ScaleSetRollingUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int max_unhealthy_upgraded_instance_percent: The maximum percentage of upgraded virtual machine instances that can be found to be in an unhealthy state. This check will happen after each batch is upgraded. If this percentage is ever exceeded, the rolling update aborts. Defaults to `20`.
        :param builtins.str pause_time_between_batches: The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 format for duration (<https://en.wikipedia.org/wiki/ISO_8601#Durations>). Defaults to `PT0S` seconds represented as `PT0S`.
        """
...
class ScaleSetSku(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int capacity: Specifies the number of virtual machines in the scale set.
        :param builtins.str name: Specifies the size of virtual machines in a scale set.
        :param builtins.str tier: Specifies the tier of virtual machines in a scale set. Possible values, `standard` or `basic`.
        """
        pulumi.set(__self__, "capacity", capacity)
        pulumi.set(__self__, "name", name)
        if tier is not None:
...
class ScaleSetStandbyPoolElasticityProfile(dict):
    ...
    def __init__(__self__, *,
                 max_ready_capacity: builtins.int,
                 min_ready_capacity: builtins.int):
        """
        :param builtins.int max_ready_capacity: Specifies the maximum number of virtual machines in the standby pool.
        :param builtins.int min_ready_capacity: Specifies the desired minimum number of virtual machines in the standby pool.
    ...
    def max_ready_capacity(self) -> builtins.int:
        """
    ...
    def min_ready_capacity(self) -> builtins.int:
        """
...
class ScaleSetStorageProfileDataDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 caching: Optional[builtins.str] = None,
                 disk_size_gb: Optional[builtins.int] = None,
                 managed_disk_type: Optional[builtins.str] = None):
        """
        :param builtins.str create_option: Specifies how the data disk should be created. The only possible options are `FromImage` and `Empty`.
        :param builtins.int lun: Specifies the Logical Unit Number of the disk in each virtual machine in the scale set.
        :param builtins.str caching: Specifies the caching requirements. Possible values include: `None` (default), `ReadOnly`, `ReadWrite`.
        :param builtins.int disk_size_gb: Specifies the size of the disk in GB. This element is required when creating an empty disk.
        :param builtins.str managed_disk_type: Specifies the type of managed disk to create. Value must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`.
        """
        pulumi.set(__self__, "create_option", create_option)
        pulumi.set(__self__, "lun", lun)
        if caching is not None:
    ...
    def managed_disk_type(self) -> Optional[builtins.str]:
        """
...
class ScaleSetStorageProfileImageReference(dict):
    def __init__(__self__, *,
                 ...
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str id: Specifies the ID of the (custom) image to use to create the virtual machine scale set, as in the example below.
        :param builtins.str offer: Specifies the offer of the image used to create the virtual machines.
        :param builtins.str publisher: Specifies the publisher of the image used to create the virtual machines.
        :param builtins.str sku: Specifies the SKU of the image used to create the virtual machines.
        :param builtins.str version: Specifies the version of the image used to create the virtual machines.
        """
        if id is not None:
...
class ScaleSetStorageProfileOsDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str create_option: Specifies how the virtual machine should be created. The only possible option is `FromImage`.
        :param builtins.str caching: Specifies the caching requirements. Possible values include: `None` (default), `ReadOnly`, `ReadWrite`.
        :param builtins.str image: Specifies the blob URI for user image. A virtual machine scale set creates an os disk in the same container as the user image.
               Updating the osDisk image causes the existing disk to be deleted and a new one created with the new image. If the VM scale set is in Manual upgrade mode then the virtual machines are not updated until they have manualUpgrade applied to them.
               When setting this field `os_type` needs to be specified. Cannot be used when `vhd_containers`, `managed_disk_type` or `storage_profile_image_reference` are specified.
        :param builtins.str managed_disk_type: Specifies the type of managed disk to create. Value you must be either `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`. Cannot be used when `vhd_containers` or `image` is specified.
        :param builtins.str name: Specifies the disk name. Must be specified when using unmanaged disk ('managed_disk_type' property not set).
        :param builtins.str os_type: Specifies the operating system Type, valid values are windows, Linux.
        :param Sequence[builtins.str] vhd_containers: Specifies the VHD URI. Cannot be used when `image` or `managed_disk_type` is specified.
        """
        pulumi.set(__self__, "create_option", create_option)
        if caching is not None:
            pulumi.set(__self__, "caching", caching)
...
class SharedImageGallerySharing(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str permission: The permission of the Shared Image Gallery when sharing. Possible values are `Community`, `Groups` and `Private`. Changing this forces a new resource to be created.
...
class SharedImageGallerySharingCommunityGallery(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str eula: The End User Licence Agreement for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param builtins.str prefix: Prefix of the community public name for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param builtins.str publisher_email: Email of the publisher for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param builtins.str publisher_uri: URI of the publisher for the Shared Image Gallery. Changing this forces a new resource to be created.
        :param builtins.str name: Specifies the name of the Shared Image Gallery. Changing this forces a new resource to be created.
        """
...
class SharedImageIdentifier(dict):
    def __init__(__self__, *,
                 ...
                 sku: builtins.str):
        """
        :param builtins.str offer: The Offer Name for this Shared Image. Changing this forces a new resource to be created.
        :param builtins.str publisher: The Publisher Name for this Gallery Image. Changing this forces a new resource to be created.
        :param builtins.str sku: The Name of the SKU for this Gallery Image. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "offer", offer)
        pulumi.set(__self__, "publisher", publisher)
        pulumi.set(__self__, "sku", sku)
...
class SharedImagePurchasePlan(dict):
    def __init__(__self__, *,
                 ...
                 publisher: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Purchase Plan Name for this Shared Image. Changing this forces a new resource to be created.
        :param builtins.str product: The Purchase Plan Product for this Gallery Image. Changing this forces a new resource to be created.
        :param builtins.str publisher: The Purchase Plan Publisher for this Gallery Image. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
...
class SharedImageVersionTargetRegion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 regional_replica_count: builtins.int,
                 disk_encryption_set_id: Optional[builtins.str] = None,
                 exclude_from_latest_enabled: Optional[builtins.bool] = None,
                 storage_account_type: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Azure Region in which this Image Version should exist.
        :param builtins.int regional_replica_count: The number of replicas of the Image Version to be created per region.
        :param builtins.str disk_encryption_set_id: The ID of the Disk Encryption Set to encrypt the Image Version in the target region. Changing this forces a new resource to be created.
        :param builtins.bool exclude_from_latest_enabled: Specifies whether this Shared Image Version should be excluded when querying for the `latest` version. Defaults to `false`.
        :param builtins.str storage_account_type: The storage account type for the image version. Possible values are `Standard_LRS`, `Premium_LRS` and `Standard_ZRS`. Defaults to `Standard_LRS`. You can store all of your image version replicas in Zone Redundant Storage by specifying `Standard_ZRS`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "regional_replica_count", regional_replica_count)
        if disk_encryption_set_id is not None:
    ...
    def exclude_from_latest_enabled(self) -> Optional[builtins.bool]:
        """
...
class VirtualMachineAdditionalCapabilities(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool ultra_ssd_enabled: Should Ultra SSD disk be enabled for this Virtual Machine? Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="ultraSsdEnabled")
    def ultra_ssd_enabled(self) -> builtins.bool:
        """
...
class VirtualMachineBootDiagnostics(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_uri: builtins.str):
        """
        :param builtins.bool enabled: Should Boot Diagnostics be enabled for this Virtual Machine?
        :param builtins.str storage_uri: The Storage Account's Blob Endpoint which should hold the virtual machine's diagnostic files.
...
class VirtualMachineIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Virtual Machine. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        ...
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Virtual Machine.
...
class VirtualMachineOsProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_data: Optional[builtins.str] = None):
        """
        :param builtins.str admin_username: Specifies the name of the local administrator account.
        :param builtins.str computer_name: Specifies the name of the Virtual Machine. Changing this forces a new resource to be created.
        :param builtins.str admin_password: (Optional for Windows, Optional for Linux) The password associated with the local administrator account.
...
class VirtualMachineOsProfileLinuxConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool disable_password_authentication: Specifies whether password authentication should be disabled. If set to `false`, an `admin_password` must be specified.
    ...
    @property
    @pulumi.getter(name="disablePasswordAuthentication")
    def disable_password_authentication(self) -> builtins.bool:
        """
...
class VirtualMachineOsProfileSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str source_vault_id: Specifies the ID of the Key Vault to use.
...
class VirtualMachineOsProfileSecretVaultCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_store: Optional[builtins.str] = None):
        """
        :param builtins.str certificate_url: The ID of the Key Vault Secret. Stored secret is the Base64 encoding of a JSON Object that which is encoded in UTF-8 of which the contents need to be:
        ...
        :param builtins.str certificate_store: (Required, on windows machines) Specifies the certificate store on the Virtual Machine where the certificate should be added to, such as `My`.
        """
        pulumi.set(__self__, "certificate_url", certificate_url)
        if certificate_store is not None:
            pulumi.set(__self__, "certificate_store", certificate_store)
...
class VirtualMachineOsProfileWindowsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enable_automatic_upgrades: Are automatic updates enabled on this Virtual Machine? Defaults to `false`.
        :param builtins.bool provision_vm_agent: Should the Azure Virtual Machine Guest Agent be installed on this Virtual Machine? Defaults to `false`.
               
               > **NOTE:** This is different from the Default value used for this field within Azure.
        :param builtins.str timezone: Specifies the time zone of the virtual machine, [the possible values are defined here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/). Changing this forces a new resource to be created.
...
class VirtualMachineOsProfileWindowsConfigWinrm(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_url: Optional[builtins.str] = None):
        """
        :param builtins.str protocol: Specifies the protocol of listener. Possible values are `HTTP` or `HTTPS`.
        :param builtins.str certificate_url: The ID of the Key Vault Secret which contains the encrypted Certificate which should be installed on the Virtual Machine. This certificate must also be specified in the `vault_certificates` block within the `os_profile_secrets` block.
...
class VirtualMachineStorageDataDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 managed_disk_id: Optional[builtins.str] = None,
                 managed_disk_type: Optional[builtins.str] = None,
                 vhd_uri: Optional[builtins.str] = None,
                 write_accelerator_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str create_option: Specifies how the data disk should be created. Possible values are `Attach`, `FromImage` and `Empty`.
        ...
        :param builtins.int lun: Specifies the logical unit number of the data disk. This needs to be unique within all the Data Disks on the Virtual Machine.
        :param builtins.str name: The name of the Data Disk.
        :param builtins.str caching: Specifies the caching requirements for the Data Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
        :param builtins.int disk_size_gb: Specifies the size of the data disk in gigabytes.
        :param builtins.str managed_disk_id: Specifies the ID of an Existing Managed Disk which should be attached to this Virtual Machine. When this field is set `create_option` must be set to `Attach`.
               
               The following properties apply when using Unmanaged Disks:
        :param builtins.str managed_disk_type: Specifies the type of managed disk to create. Possible values are either `Standard_LRS`, `StandardSSD_LRS`, `Premium_LRS` or `UltraSSD_LRS`.
        ...
        :param builtins.str vhd_uri: Specifies the URI of the VHD file backing this Unmanaged Data Disk.
        :param builtins.bool write_accelerator_enabled: Specifies if Write Accelerator is enabled on the disk. This can only be enabled on `Premium_LRS` managed disks with no caching and [M-Series VMs](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/how-to-enable-write-accelerator). Defaults to `false`.
    ...
    def vhd_uri(self) -> Optional[builtins.str]:
        """
...
class VirtualMachineStorageImageReference(dict):
    def __init__(__self__, *,
                 ...
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str id: Specifies the ID of the Custom Image which the Virtual Machine should be created from. Changing this forces a new resource to be created.
        :param builtins.str offer: Specifies the offer of the image used to create the virtual machine. Changing this forces a new resource to be created.
        :param builtins.str publisher: Specifies the publisher of the image used to create the virtual machine. Changing this forces a new resource to be created.
        :param builtins.str sku: Specifies the SKU of the image used to create the virtual machine. Changing this forces a new resource to be created.
        :param builtins.str version: Specifies the version of the image used to create the virtual machine. Changing this forces a new resource to be created.
...
class VirtualMachineStorageOsDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 write_accelerator_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str create_option: Specifies how the OS Disk should be created. Possible values are `Attach` (managed disks only) and `FromImage`.
        :param builtins.str name: Specifies the name of the OS Disk.
        :param builtins.str caching: Specifies the caching requirements for the OS Disk. Possible values include `None`, `ReadOnly` and `ReadWrite`.
        :param builtins.int disk_size_gb: Specifies the size of the OS Disk in gigabytes.
        :param builtins.str image_uri: Specifies the Image URI in the format `publisherName:offer:skus:version`. This field can also specify the [VHD URI](https://docs.microsoft.com/azure/virtual-machines/linux/tutorial-custom-images) of a custom VM image to clone. When cloning a Custom (Unmanaged) Disk Image the `os_type` field must be set.
        :param builtins.str managed_disk_id: Specifies the ID of an existing Managed Disk which should be attached as the OS Disk of this Virtual Machine. If this is set then the `create_option` must be set to `Attach`. Changing this forces a new resource to be created.
        :param builtins.str managed_disk_type: Specifies the type of Managed Disk which should be created. Possible values are `Standard_LRS`, `StandardSSD_LRS` or `Premium_LRS`.
               
               The following properties apply when using Unmanaged Disks:
        :param builtins.str os_type: Specifies the Operating System on the OS Disk. Possible values are `Linux` and `Windows`.
        :param builtins.str vhd_uri: Specifies the URI of the VHD file backing this Unmanaged OS Disk. Changing this forces a new resource to be created.
        :param builtins.bool write_accelerator_enabled: Specifies if Write Accelerator is enabled on the disk. This can only be enabled on `Premium_LRS` managed disks with no caching and [M-Series VMs](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/how-to-enable-write-accelerator). Defaults to `false`.
...
class WindowsVirtualMachineIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Windows Virtual Machine. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Windows Virtual Machine.
...
class WindowsVirtualMachineScaleSetIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Windows Virtual Machine Scale Set. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Windows Virtual Machine Scale Set.
...
class WindowsVirtualMachineScaleSetWinrmListener(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_url: Optional[builtins.str] = None):
        """
        :param builtins.str protocol: The Protocol of the WinRM Listener. Possible values are `Http` and `Https`. Changing this forces a new resource to be created.
        :param builtins.str certificate_url: The Secret URL of a Key Vault Certificate, which must be specified when `protocol` is set to `Https`. Changing this forces a new resource to be created.
...
class GetBastionHostIpConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str public_ip_address_id: Reference to a Public IP Address associated to this Bastion Host.
        :param builtins.str subnet_id: Reference to the subnet in which this Bastion Host has been created.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "public_ip_address_id", public_ip_address_id)
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class GetConfidentialLedgerAzureadBasedServicePrincipalResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ledger_role_name: The Ledger Role to grant this Certificate Security Principal.
        :param builtins.str principal_id: The Principal ID of the AzureAD Service Principal.
        :param builtins.str tenant_id: The Tenant ID for this AzureAD Service Principal.
        """
...
class GetDiskEncryptionSetIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Managed Identity IDs assigned to this Disk Encryption Set.
        :param builtins.str principal_id: The (Client) ID of the Service Principal.
        :param builtins.str tenant_id: The ID of the Tenant the Service Principal is assigned in.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Disk Encryption Set.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetImageDataDiskResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str blob_uri: the URI in Azure storage of the blob used to create the image.
        :param builtins.str caching: the caching mode for the Data Disk, such as `ReadWrite`, `ReadOnly`, or `None`.
        :param builtins.int lun: the logical unit number of the data disk.
        :param builtins.str managed_disk_id: the ID of the Managed Disk used as the Data Disk Image.
        :param builtins.int size_gb: the size of this Data Disk in GB.
        """
        pulumi.set(__self__, "blob_uri", blob_uri)
        pulumi.set(__self__, "caching", caching)
        pulumi.set(__self__, "lun", lun)
...
class GetImageOsDiskResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str caching: the caching mode for the Data Disk, such as `ReadWrite`, `ReadOnly`, or `None`.
        :param builtins.str managed_disk_id: the ID of the Managed Disk used as the Data Disk Image.
        :param builtins.str os_state: the State of the OS used in the Image, such as `Generalized`.
        :param builtins.str os_type: the type of Operating System used on the OS Disk. such as `Linux` or `Windows`.
        :param builtins.int size_gb: the size of this Data Disk in GB.
        """
        pulumi.set(__self__, "blob_uri", blob_uri)
        pulumi.set(__self__, "caching", caching)
...
class GetImagesImageResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str location: The supported Azure location where the Image exists.
        ...
        :param Mapping[str, builtins.str] tags: A mapping of tags assigned to the Image.
        :param builtins.bool zone_resilient: Is zone resiliency enabled?
        """
    ...
    def zone_resilient(self) -> builtins.bool:
        """
...
class GetImagesImageDataDiskResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str blob_uri: the URI in Azure storage of the blob used to create the image.
        :param builtins.str caching: the caching mode for the Data Disk.
        :param builtins.int lun: the logical unit number of the data disk.
        :param builtins.str managed_disk_id: the ID of the Managed Disk used as the Data Disk Image.
        :param builtins.int size_gb: the size of this Data Disk in GB.
        """
...
class GetImagesImageOsDiskResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str blob_uri: the URI in Azure storage of the blob used to create the image.
        :param builtins.str caching: the caching mode for the Data Disk.
        :param builtins.str disk_encryption_set_id: the ID of the Disk Encryption Set used to encrypt this image.
        :param builtins.str managed_disk_id: the ID of the Managed Disk used as the Data Disk Image.
        :param builtins.str os_state: the State of the OS used in the Image.
        :param builtins.str os_type: the type of Operating System used on the OS Disk.
        :param builtins.int size_gb: the size of this Data Disk in GB.
        """
        pulumi.set(__self__, "blob_uri", blob_uri)
        pulumi.set(__self__, "caching", caching)
...
class GetManagedDiskEncryptionSettingDiskEncryptionKeyResult(dict):
    def __init__(__self__, *,
                 ...
                 source_vault_id: builtins.str):
        """
        :param builtins.str secret_url: The URL to the Key Vault Secret used as the Disk Encryption Key.
        :param builtins.str source_vault_id: The ID of the source Key Vault.
        """
        pulumi.set(__self__, "secret_url", secret_url)
        pulumi.set(__self__, "source_vault_id", source_vault_id)
...
class GetManagedDiskEncryptionSettingKeyEncryptionKeyResult(dict):
    def __init__(__self__, *,
                 ...
                 source_vault_id: builtins.str):
        """
        :param builtins.str key_url: The URL to the Key Vault Key used as the Key Encryption Key.
        :param builtins.str source_vault_id: The ID of the source Key Vault.
        """
        pulumi.set(__self__, "key_url", key_url)
        pulumi.set(__self__, "source_vault_id", source_vault_id)
...
class GetOrchestratedVirtualMachineScaleSetIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Orchestrated Virtual Machine Scale Set.
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Orchestrated Virtual Machine Scale Set.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Orchestrated Virtual Machine Scale Set.
        :param builtins.str type: The Type of IP Tag.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetOrchestratedVirtualMachineScaleSetNetworkInterfaceResult(dict):
    def __init__(__self__, *,
                 accelerated_networking_enabled: builtins.bool,
                 dns_servers: Sequence[builtins.str],
                 ip_configurations: Sequence['outputs.GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationResult'],
                 ip_forwarding_enabled: builtins.bool,
                 name: builtins.str,
                 network_security_group_id: builtins.str,
                 primary: builtins.bool):
        """
        :param builtins.bool accelerated_networking_enabled: Is accelerated networking enabled?
        :param Sequence[builtins.str] dns_servers: An array of the DNS servers in use.
        ...
        :param builtins.bool ip_forwarding_enabled: Is IP forwarding enabled?
        :param builtins.str name: The name of this Orchestrated Virtual Machine Scale Set.
        :param builtins.str network_security_group_id: The identifier for the network security group.
        :param builtins.bool primary: If this ip_configuration is the primary one.
        """
    ...
    def accelerated_networking_enabled(self) -> builtins.bool:
        """
    ...
    def ip_forwarding_enabled(self) -> builtins.bool:
        """
...
class GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationResult(dict):
    def __init__(__self__, *,
                 application_gateway_backend_address_pool_ids: Sequence[builtins.str],
                 application_security_group_ids: Sequence[builtins.str],
                 load_balancer_backend_address_pool_ids: Sequence[builtins.str],
                 load_balancer_inbound_nat_rules_ids: Sequence[builtins.str],
                 name: builtins.str,
                 primary: builtins.bool,
                 ...
                 version: builtins.str):
        """
        :param Sequence[builtins.str] application_gateway_backend_address_pool_ids: An array of references to backend address pools of application gateways.
        :param Sequence[builtins.str] application_security_group_ids: The application security group IDs to use.
        :param Sequence[builtins.str] load_balancer_backend_address_pool_ids: An array of references to backend address pools of load balancers.
        :param Sequence[builtins.str] load_balancer_inbound_nat_rules_ids: An array of references to inbound NAT pools for load balancers.
        :param builtins.str name: The name of this Orchestrated Virtual Machine Scale Set.
        :param builtins.bool primary: If this ip_configuration is the primary one.
        ...
        :param builtins.str subnet_id: The identifier of the subnet.
        :param builtins.str version: The Internet Protocol Version of the public IP address.
        """
        pulumi.set(__self__, "application_gateway_backend_address_pool_ids", application_gateway_backend_address_pool_ids)
        pulumi.set(__self__, "application_security_group_ids", application_security_group_ids)
        pulumi.set(__self__, "load_balancer_backend_address_pool_ids", load_balancer_backend_address_pool_ids)
    ...
    @property
    @pulumi.getter(name="applicationGatewayBackendAddressPoolIds")
    def application_gateway_backend_address_pool_ids(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="applicationSecurityGroupIds")
    def application_security_group_ids(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="loadBalancerBackendAddressPoolIds")
    def load_balancer_backend_address_pool_ids(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="loadBalancerInboundNatRulesIds")
    def load_balancer_inbound_nat_rules_ids(self) -> Sequence[builtins.str]:
        """
...
class GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str domain_name_label: The domain name label for the DNS settings.
        :param builtins.int idle_timeout_in_minutes: The idle timeout in minutes.
        ...
        :param builtins.str name: The name of this Orchestrated Virtual Machine Scale Set.
        :param builtins.str public_ip_prefix_id: The ID of the public IP prefix.
        :param builtins.str version: The Internet Protocol Version of the public IP address.
        """
        pulumi.set(__self__, "domain_name_label", domain_name_label)
        pulumi.set(__self__, "idle_timeout_in_minutes", idle_timeout_in_minutes)
...
class GetOrchestratedVirtualMachineScaleSetNetworkInterfaceIpConfigurationPublicIpAddressIpTagResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str tag: The IP Tag associated with the Public IP.
        :param builtins.str type: The Type of IP Tag.
        """
        pulumi.set(__self__, "tag", tag)
        pulumi.set(__self__, "type", type)
...
class GetSharedImageIdentifierResult(dict):
    def __init__(__self__, *,
                 ...
                 sku: builtins.str):
        """
        :param builtins.str offer: The Offer Name for this Shared Image.
        :param builtins.str publisher: (Optional) The Purchase Plan Publisher for this Gallery Image.
        :param builtins.str sku: The Name of the SKU for this Gallery Image.
        """
        pulumi.set(__self__, "offer", offer)
        pulumi.set(__self__, "publisher", publisher)
        pulumi.set(__self__, "sku", sku)
...
class GetSharedImagePurchasePlanResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str product: (Optional) The Purchase Plan Product for this Gallery Image.
        :param builtins.str publisher: (Optional) The Purchase Plan Publisher for this Gallery Image.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "product", product)
...
class GetSharedImageVersionTargetRegionResult(dict):
    def __init__(__self__, *,
                 ...
                 storage_account_type: builtins.str):
        """
        :param builtins.str name: The name of the Image Version.
        ...
        :param builtins.int regional_replica_count: The number of replicas of the Image Version to be created per region.
        :param builtins.str storage_account_type: The storage account type for the image version.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "regional_replica_count", regional_replica_count)
        pulumi.set(__self__, "storage_account_type", storage_account_type)
...
class GetSharedImageVersionsImageResult(dict):
    def __init__(__self__, *,
                 exclude_from_latest: builtins.bool,
                 id: builtins.str,
                 location: builtins.str,
                 managed_image_id: builtins.str,
                 name: builtins.str,
                 tags: Mapping[str, builtins.str],
                 target_regions: Sequence['outputs.GetSharedImageVersionsImageTargetRegionResult']):
        """
        :param builtins.bool exclude_from_latest: Is this Image Version excluded from the `latest` filter?
        :param builtins.str id: The ID of this Shared Image Version.
        :param builtins.str location: The supported Azure location where the Shared Image Gallery exists.
        :param builtins.str managed_image_id: The ID of the Managed Image which was the source of this Shared Image Version.
        :param builtins.str name: The Azure Region in which this Image Version exists.
        :param Mapping[str, builtins.str] tags: A mapping of tags assigned to the Shared Image.
    ...
    @property
    @pulumi.getter(name="excludeFromLatest")
    def exclude_from_latest(self) -> builtins.bool:
        """
...
class GetVirtualMachineScaleSetIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Virtual Machine Scale Set.
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Virtual Machine Scale Set.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Virtual Machine Scale Set.
        :param builtins.str type: The Type of IP Tag.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
...
class GetVirtualMachineScaleSetInstanceResult(dict):
    def __init__(__self__, *,
                 ...
                 latest_model_applied: builtins.bool,
                 name: builtins.str,
                 ...
                 zone: builtins.str):
        """
        :param builtins.str computer_name: The Hostname of this Virtual Machine.
        :param builtins.str instance_id: The Instance ID of this Virtual Machine.
        :param builtins.bool latest_model_applied: Whether the latest model has been applied to this Virtual Machine.
        ...
        :param builtins.str private_ip_address: The Primary Private IP Address assigned to this Virtual Machine.
        :param Sequence[builtins.str] private_ip_addresses: A list of Private IP Addresses assigned to this Virtual Machine.
        :param builtins.str public_ip_address: The virtual machines scale set IP Configuration's PublicIPAddress configuration. The `public_ip_address` is documented below.
        :param Sequence[builtins.str] public_ip_addresses: A list of the Public IP Addresses assigned to this Virtual Machine.
        :param builtins.str virtual_machine_id: The unique ID of the virtual machine.
        :param builtins.str zone: The zones of the virtual machine.
        """
        pulumi.set(__self__, "computer_name", computer_name)
...
class GetVirtualMachineScaleSetNetworkInterfaceResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] dns_servers: An array of the DNS servers in use.
        :param builtins.bool enable_accelerated_networking: Whether to enable accelerated networking or not.
        :param builtins.bool enable_ip_forwarding: Whether IP forwarding is enabled on this NIC.
    ...
    @property
    @pulumi.getter(name="enableAcceleratedNetworking")
    def enable_accelerated_networking(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="enableIpForwarding")
    def enable_ip_forwarding(self) -> builtins.bool:
        """
