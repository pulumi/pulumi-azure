...
class CapacityReservationSku(dict):
    def __init__(__self__, *,
                 ...
                 name: str):
        """
        :param int capacity: Specifies the number of instances to be reserved. It must be greater than or equal to `0` and not exceed the quota in the subscription.
...
class LinuxVirtualMachineAdditionalCapabilities(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param bool hibernation_enabled: Whether to enable the hibernation capability or not.
...
class LinuxVirtualMachineGalleryApplication(dict):
    ...
    def __init__(__self__, *,
                 ...
                 treat_failure_as_deployment_failure_enabled: Optional[bool] = None):
        """
        :param str version_id: Specifies the Gallery Application Version resource ID.
        :param bool automatic_upgrade_enabled: Specifies whether the version will be automatically updated for the VM when a new Gallery Application version is available in PIR/SIG. Defaults to `false`.
        ...
        :param int order: Specifies the order in which the packages have to be installed. Possible values are between `0` and `2147483647`. Defaults to `0`.
        :param str tag: Specifies a passthrough value for more generic context. This field can be any valid `string` value.
        :param bool treat_failure_as_deployment_failure_enabled: Specifies whether any failure for any operation in the VmApplication will fail the deployment of the VM. Defaults to `false`.
        """
    ...
    def treat_failure_as_deployment_failure_enabled(self) -> Optional[bool]:
        """
...
class LinuxVirtualMachineOsImageNotification(dict):
    def __init__(__self__, *,
        ...
        """
        :param str timeout: Length of time a notification to be sent to the VM on the instance metadata server till the VM gets OS upgraded. The only possible value is `PT15M`. Defaults to `PT15M`.
        """
...
class LinuxVirtualMachineScaleSetAutomaticInstanceRepair(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str action: The repair action that will be used for repairing unhealthy virtual machines in the scale set. Possible values include `Replace`, `Restart`, `Reimage`.
        ...
        :param str grace_period: Amount of time for which automatic repairs will be delayed. The grace period starts right after the VM is found unhealthy. Possible values are between `10` and `90` minutes. The time duration should be specified in `ISO 8601` format (e.g. `PT10M` to `PT90M`).
...
class LinuxVirtualMachineScaleSetRollingUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 maximum_surge_instances_enabled: Optional[bool] = None,
        ...
        :param bool maximum_surge_instances_enabled: Create new virtual machines to upgrade the scale set, rather than updating the existing virtual machines. Existing virtual machines will be deleted once the new virtual machines are created for each batch. Possible values are `true` or `false`.
    ...
    def maximum_surge_instances_enabled(self) -> Optional[bool]:
        """
...
class OrchestratedVirtualMachineScaleSetDataDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        :param int disk_size_gb: The size of the Data Disk which should be created. Required if `create_option` is specified as `Empty`.
        :param int lun: The Logical Unit Number of the Data Disk, which must be unique within the Virtual Machine. Required if `create_option` is specified as `Empty`.
        :param int ultra_ssd_disk_iops_read_write: Specifies the Read-Write IOPS for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
        :param int ultra_ssd_disk_mbps_read_write: Specifies the bandwidth in MB per second for this Data Disk. Only settable when `storage_account_type` is `PremiumV2_LRS` or `UltraSSD_LRS`.
...
class OrchestratedVirtualMachineScaleSetSkuProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str allocation_strategy: Specifies the allocation strategy for the virtual machine scale set based on which the VMs will be allocated. Possible values are `LowestPrice` and `CapacityOptimized`.
        :param Sequence[str] vm_sizes: Specifies the VM sizes for the virtual machine scale set.
        """
    ...
    def vm_sizes(self) -> Sequence[str]:
        """
...
class ScaleSetRollingUpgradePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str pause_time_between_batches: The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 format for duration (<https://en.wikipedia.org/wiki/ISO_8601#Durations>). Defaults to `PT0S` seconds represented as `PT0S`.
        """
