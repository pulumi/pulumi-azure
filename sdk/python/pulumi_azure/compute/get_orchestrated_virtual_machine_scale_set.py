...
def get_orchestrated_virtual_machine_scale_set(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Compute` - 2024-11-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Orchestrated Virtual Machine Scale Set exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_orchestrated_virtual_machine_scale_set_output(name: Optional[pulumi.Input[_builtins.str]] = None,
