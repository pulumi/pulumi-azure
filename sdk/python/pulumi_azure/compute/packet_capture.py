...
class PacketCaptureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_machine_id: The resource ID of the target Virtual Machine to capture packets from. Changing this forces a new resource to be created.
...
class PacketCapture(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_watcher_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_location: Optional[pulumi.Input[Union['PacketCaptureStorageLocationArgs', 'PacketCaptureStorageLocationArgsDict']]] = None,
            virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PacketCapture':
        """
