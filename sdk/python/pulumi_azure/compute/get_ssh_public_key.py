...
def get_ssh_public_key(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Compute`: 2024-03-01
    ...
    :param builtins.str name: The name of this SSH Public Key.
    :param builtins.str resource_group_name: The name of the Resource Group where the SSH Public Key exists.
    :param Mapping[str, builtins.str] tags: A mapping of tags which should be assigned to the SSH Public Key.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_ssh_public_key_output(name: Optional[pulumi.Input[builtins.str]] = None,
