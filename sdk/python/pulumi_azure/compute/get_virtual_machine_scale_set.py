...
def get_virtual_machine_scale_set(name: Optional[builtins.str] = None,
...
def get_virtual_machine_scale_set_output(name: Optional[pulumi.Input[builtins.str]] = None,
