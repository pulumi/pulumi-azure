...
class ExtensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_upgrade_minor_version: Specifies if the platform deploys the latest minor version update to the `type_handler_version` specified.
...
class Extension(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            type_handler_version: Optional[pulumi.Input[builtins.str]] = None,
            virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Extension':
        """
