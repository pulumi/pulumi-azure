...
class GetImagesResult:
    ...
    def tags_filter(self) -> Optional[Mapping[str, builtins.str]]:
...
def get_images(resource_group_name: Optional[builtins.str] = None,
               tags_filter: Optional[Mapping[str, builtins.str]] = None,
...
def get_images_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                      tags_filter: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
