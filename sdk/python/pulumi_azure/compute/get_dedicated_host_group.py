...
class GetDedicatedHostGroupResult:
    ...
    def automatic_placement_enabled(self) -> builtins.bool:
        """
...
def get_dedicated_host_group(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Compute`: 2024-03-01
    ...
    :param builtins.str name: Specifies the name of the Dedicated Host Group.
    :param builtins.str resource_group_name: Specifies the name of the resource group the Dedicated Host Group is located in.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_dedicated_host_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
