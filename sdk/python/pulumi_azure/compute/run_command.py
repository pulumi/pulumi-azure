...
class RunCommandArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_machine_id: Specifies the Virtual Machine ID within which this Virtual Machine Run Command should exist. Changing this forces a new Virtual Machine Run Command to be created.
        ...
        :param pulumi.Input[builtins.str] error_blob_uri: Specifies the Azure storage blob where script error stream will be uploaded.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Virtual Machine Run Command should exist. Changing this forces a new Virtual Machine Run Command to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Virtual Machine Run Command. Changing this forces a new Virtual Machine Run Command to be created.
        ...
        :param pulumi.Input[builtins.str] output_blob_uri: Specifies the Azure storage blob where script output stream will be uploaded. It can be basic blob URI with SAS token.
        ...
        :param pulumi.Input[builtins.str] run_as_password: Specifies the user account password on the VM when executing the Virtual Machine Run Command.
        :param pulumi.Input[builtins.str] run_as_user: Specifies the user account on the VM when executing the Virtual Machine Run Command.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Virtual Machine Run Command.
        """
...
class RunCommand(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[Union['RunCommandSourceArgs', 'RunCommandSourceArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RunCommand':
        """
