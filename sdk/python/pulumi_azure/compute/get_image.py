...
class GetImageResult:
    ...
    def sort_descending(self) -> Optional[builtins.bool]:
...
def get_image(name: Optional[builtins.str] = None,
              ...
              sort_descending: Optional[builtins.bool] = None,
    ...
    * `Microsoft.Compute`: 2022-03-01
    ...
    :param builtins.str resource_group_name: The Name of the Resource Group where this Image exists.
    :param builtins.bool sort_descending: By default when matching by regex, images are sorted by name in ascending order and the first match is chosen, to sort descending, set this flag.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_image_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     name_regex: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                     sort_descending: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
