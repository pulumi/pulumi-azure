...
if not MYPY:
    class ModuleManagementNetworkProfileArgsDict(TypedDict):
        network_interface_private_ip_addresses: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ModuleManagementNetworkProfileArgs:
    def __init__(__self__, *,
                 ...
                 subnet_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_interface_private_ip_addresses: The private IPv4 address of the network interface. Changing this forces a new Dedicated Hardware Security Module to be created.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet. Changing this forces a new Dedicated Hardware Security Module to be created.
        """
    ...
    def network_interface_private_ip_addresses(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The private IPv4 address of the network interface. Changing this forces a new Dedicated Hardware Security Module to be created.
        """
    ...
    def network_interface_private_ip_addresses(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
