...
class ModuleManagementNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 network_interface_private_ip_addresses: Sequence[builtins.str],
                 subnet_id: builtins.str):
        """
        :param Sequence[builtins.str] network_interface_private_ip_addresses: The private IPv4 address of the network interface. Changing this forces a new Dedicated Hardware Security Module to be created.
        :param builtins.str subnet_id: The ID of the subnet. Changing this forces a new Dedicated Hardware Security Module to be created.
        """
    ...
    def network_interface_private_ip_addresses(self) -> Sequence[builtins.str]:
        """
