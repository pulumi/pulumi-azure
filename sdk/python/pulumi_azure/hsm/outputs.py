...
class ModuleNetworkProfile(dict):
    def __init__(__self__, *,
                 network_interface_private_ip_addresses: List[str],
                 subnet_id: str):
        """
        :param List[str] network_interface_private_ip_addresses: The private IPv4 address of the network interface. Changing this forces a new Dedicated Hardware Security Module to be created.
