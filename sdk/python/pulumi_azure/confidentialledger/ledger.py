...
class LedgerArgs:
    def __init__(__self__, *,
                 ...
                 ledger_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ledger_type: Specifies the type of Confidential Ledger. Possible values are `Private` and `Public`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Confidential Ledger exists. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the Confidential Ledger exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Confidential Ledger. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Confidential Ledger.
        """
    ...
    def ledger_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ledger_type.setter
    def ledger_type(self, value: pulumi.Input[builtins.str]):
...
class _LedgerState:
    def __init__(__self__, *,
                 ...
                 certificate_based_security_principals: Optional[pulumi.Input[Sequence[pulumi.Input['LedgerCertificateBasedSecurityPrincipalArgs']]]] = None,
                 identity_service_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 ledger_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 ledger_type: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LedgerAzureadBasedServicePrincipalArgs']]] azuread_based_service_principals: A list of `azuread_based_service_principal` blocks as defined below.
        :param pulumi.Input[Sequence[pulumi.Input['LedgerCertificateBasedSecurityPrincipalArgs']]] certificate_based_security_principals: A list of `certificate_based_security_principal` blocks as defined below.
        :param pulumi.Input[builtins.str] identity_service_endpoint: The Identity Service Endpoint for this Confidential Ledger.
        :param pulumi.Input[builtins.str] ledger_endpoint: The Endpoint for this Confidential Ledger.
        :param pulumi.Input[builtins.str] ledger_type: Specifies the type of Confidential Ledger. Possible values are `Private` and `Public`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the Confidential Ledger exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Confidential Ledger. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Confidential Ledger exists. Changing this forces a new resource to be created.
    ...
    def identity_service_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_service_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_service_endpoint", value)

    @property
    @pulumi.getter(name="ledgerEndpoint")
    def ledger_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ledger_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ledger_endpoint", value)

    @property
    @pulumi.getter(name="ledgerType")
    def ledger_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the type of Confidential Ledger. Possible values are `Private` and `Public`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "ledger_type")
    ...
    @ledger_type.setter
    def ledger_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ledger_type", value)
...
class Ledger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Ledger':
        """
    ...
    @property
    @pulumi.getter(name="identityServiceEndpoint")
    def identity_service_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The Identity Service Endpoint for this Confidential Ledger.
        """
        return pulumi.get(self, "identity_service_endpoint")
    ...
    @property
    @pulumi.getter(name="ledgerEndpoint")
    def ledger_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The Endpoint for this Confidential Ledger.
        """
        return pulumi.get(self, "ledger_endpoint")
    ...
    @property
    @pulumi.getter(name="ledgerType")
    def ledger_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the type of Confidential Ledger. Possible values are `Private` and `Public`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "ledger_type")
