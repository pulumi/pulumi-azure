...
class LedgerAzureadBasedServicePrincipal(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ledger_role_name: Specifies the Ledger Role to grant this AzureAD Service Principal. Possible values are `Administrator`, `Contributor` and `Reader`.
        :param _builtins.str principal_id: Specifies the Principal ID of the AzureAD Service Principal.
        :param _builtins.str tenant_id: Specifies the Tenant ID for this AzureAD Service Principal.
        """
...
class LedgerCertificateBasedSecurityPrincipal(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ledger_role_name: Specifies the Ledger Role to grant this Certificate Security Principal. Possible values are `Administrator`, `Contributor` and `Reader`.
