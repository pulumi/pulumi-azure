...
class LedgerAzureadBasedServicePrincipal(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ledger_role_name: Specifies the Ledger Role to grant this AzureAD Service Principal. Possible values are `Administrator`, `Contributor` and `Reader`.
        :param builtins.str principal_id: Specifies the Principal ID of the AzureAD Service Principal.
        :param builtins.str tenant_id: Specifies the Tenant ID for this AzureAD Service Principal.
        """
...
class LedgerCertificateBasedSecurityPrincipal(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ledger_role_name: Specifies the Ledger Role to grant this Certificate Security Principal. Possible values are `Administrator`, `Contributor` and `Reader`.
        :param builtins.str pem_public_key: The public key, in PEM format, of the certificate used by this identity to authenticate with the Confidential Ledger.
        """
        pulumi.set(__self__, "ledger_role_name", ledger_role_name)
