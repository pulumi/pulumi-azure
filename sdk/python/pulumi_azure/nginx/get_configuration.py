...
def get_configuration(nginx_deployment_id: Optional[builtins.str] = None,
...
def get_configuration_output(nginx_deployment_id: Optional[pulumi.Input[builtins.str]] = None,
