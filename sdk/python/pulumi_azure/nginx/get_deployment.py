...
class GetDeploymentResult:
    ...
    def diagnose_support_enabled(self) -> builtins.bool:
        """
...
def get_deployment(name: Optional[builtins.str] = None,
    ...
    * `Nginx.NginxPlus`: 2024-11-01-preview
    ...
    :param builtins.str resource_group_name: The name of the Resource Group where the NGINX Deployment exists.
    """
    __args__ = dict()
    __args__['name'] = name
