...
class ConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 root_file: pulumi.Input[builtins.str],
                 config_files: Optional[pulumi.Input[Sequence[pulumi.Input['ConfigurationConfigFileArgs']]]] = None,
                 package_data: Optional[pulumi.Input[builtins.str]] = None,
                 protected_files: Optional[pulumi.Input[Sequence[pulumi.Input['ConfigurationProtectedFileArgs']]]] = None):
        """
        The set of arguments for constructing a Configuration resource.
        :param pulumi.Input[builtins.str] nginx_deployment_id: The ID of the Nginx Deployment. Changing this forces a new Nginx Configuration to be created.
        :param pulumi.Input[builtins.str] root_file: Specifies the root file path of this Nginx Configuration.
        ...
        :param pulumi.Input[builtins.str] package_data: Specifies the package data for this configuration.
    ...
    def root_file(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @root_file.setter
    def root_file(self, value: pulumi.Input[builtins.str]):
    ...
    def package_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @package_data.setter
    def package_data(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ConfigurationState:
    def __init__(__self__, *,
                 ...
                 package_data: Optional[pulumi.Input[builtins.str]] = None,
                 protected_files: Optional[pulumi.Input[Sequence[pulumi.Input['ConfigurationProtectedFileArgs']]]] = None,
                 root_file: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="rootFile")
    def root_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the root file path of this Nginx Configuration.
        """
        return pulumi.get(self, "root_file")
    ...
    @root_file.setter
    def root_file(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "root_file", value)
...
class Configuration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            package_data: Optional[pulumi.Input[builtins.str]] = None,
            protected_files: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ConfigurationProtectedFileArgs', 'ConfigurationProtectedFileArgsDict']]]]] = None,
            root_file: Optional[pulumi.Input[builtins.str]] = None) -> 'Configuration':
        """
    ...
    @property
    @pulumi.getter(name="packageData")
    def package_data(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the package data for this configuration.
        """
        return pulumi.get(self, "package_data")
    ...
    @property
    @pulumi.getter(name="rootFile")
    def root_file(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the root file path of this Nginx Configuration.
        """
        return pulumi.get(self, "root_file")
