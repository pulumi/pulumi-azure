...
class DeploymentArgs:
    def __init__(__self__, *,
                 ...
                 diagnose_support_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def diagnose_support_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def diagnose_support_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def managed_resource_group(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "managed_resource_group")

    @managed_resource_group.setter
    def managed_resource_group(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DeploymentState:
    def __init__(__self__, *,
                 ...
                 automatic_upgrade_channel: Optional[pulumi.Input[builtins.str]] = None,
                 capacity: Optional[pulumi.Input[builtins.int]] = None,
                 dataplane_api_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 diagnose_support_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 email: Optional[pulumi.Input[builtins.str]] = None,
                 frontend_privates: Optional[pulumi.Input[Sequence[pulumi.Input['DeploymentFrontendPrivateArgs']]]] = None,
                 frontend_public: Optional[pulumi.Input['DeploymentFrontendPublicArgs']] = None,
    ...
    def dataplane_api_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dataplane_api_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nginx_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nginx_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Deployment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataplaneApiEndpoint")
    def dataplane_api_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The dataplane API endpoint of the NGINX Deployment.
        """
        return pulumi.get(self, "dataplane_api_endpoint")
    ...
    @property
    @pulumi.getter(name="diagnoseSupportEnabled")
    def diagnose_support_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the metrics be exported to Azure Monitor?
        """
        return pulumi.get(self, "diagnose_support_enabled")
    ...
    @pulumi.getter(name="managedResourceGroup")
    @_utilities.deprecated("""The `managed_resource_group` field isn't supported by the API anymore and has been deprecated and will be removed in v5.0 of the AzureRM Provider.""")
    def managed_resource_group(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "managed_resource_group")
    ...
    @property
    @pulumi.getter(name="nginxVersion")
    def nginx_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of the NGINX Deployment.
        """
        return pulumi.get(self, "nginx_version")
