...
class VolumeArgs:
    def __init__(__self__, *,
                 ...
                 volume_group_id: pulumi.Input[builtins.str],
    ...
    def volume_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def volume_group_id(self, value: pulumi.Input[builtins.str]):
...
class _VolumeState:
    def __init__(__self__, *,
                 create_source: Optional[pulumi.Input['VolumeCreateSourceArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 size_in_gib: Optional[pulumi.Input[builtins.int]] = None,
                 target_iqn: Optional[pulumi.Input[builtins.str]] = None,
                 target_portal_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 target_portal_port: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] volume_group_id: Specifies the Volume Group ID within which this Elastic SAN Volume should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] volume_id: The UUID of the Elastic SAN Volume.
        """
        if create_source is not None:
            pulumi.set(__self__, "create_source", create_source)
        if name is not None:
    ...
    @property
    @pulumi.getter(name="sizeInGib")
    def size_in_gib(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the size of the Elastic SAN Volume in GiB. The size should be within the remaining capacity of the parent Elastic SAN. Possible values are between `1` and `65536` (16 TiB).
    ...
    @size_in_gib.setter
    def size_in_gib(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "size_in_gib", value)
    ...
    def target_portal_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_portal_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_portal_hostname", value)

    @property
    @pulumi.getter(name="targetPortalPort")
    def target_portal_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def target_portal_port(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Volume(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="sizeInGib")
    def size_in_gib(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the size of the Elastic SAN Volume in GiB. The size should be within the remaining capacity of the parent Elastic SAN. Possible values are between `1` and `65536` (16 TiB).
    ...
    @property
    @pulumi.getter(name="targetPortalHostname")
    def target_portal_hostname(self) -> pulumi.Output[builtins.str]:
        """
        The iSCSI Target Portal Host Name of the Elastic SAN Volume.
        """
        return pulumi.get(self, "target_portal_hostname")
    ...
    @property
    @pulumi.getter(name="targetPortalPort")
    def target_portal_port(self) -> pulumi.Output[builtins.int]:
        """
        The iSCSI Target Portal Port of the Elastic SAN Volume.
        """
        return pulumi.get(self, "target_portal_port")
