...
class VolumeGroupArgs:
    def __init__(__self__, *,
                 elastic_san_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] protocol_type: Specifies the type of the storage target. The only possible value is `Iscsi`. Defaults to `Iscsi`.
        """
    ...
    def elastic_san_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def elastic_san_id(self, value: pulumi.Input[builtins.str]):
...
class _VolumeGroupState:
    def __init__(__self__, *,
                 elastic_san_id: Optional[pulumi.Input[builtins.str]] = None,
                 encryption: Optional[pulumi.Input['VolumeGroupEncryptionArgs']] = None,
                 encryption_type: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['VolumeGroupIdentityArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="elasticSanId")
    def elastic_san_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Elastic SAN ID within which this Elastic SAN Volume Group should exist. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "elastic_san_id")
    ...
    @elastic_san_id.setter
    def elastic_san_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "elastic_san_id", value)
...
class VolumeGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            network_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VolumeGroupNetworkRuleArgs', 'VolumeGroupNetworkRuleArgsDict']]]]] = None,
            protocol_type: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeGroup':
        """
    ...
    @property
    @pulumi.getter(name="elasticSanId")
    def elastic_san_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Elastic SAN ID within which this Elastic SAN Volume Group should exist. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "elastic_san_id")
