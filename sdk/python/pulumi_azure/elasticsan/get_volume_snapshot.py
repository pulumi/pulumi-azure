...
class GetVolumeSnapshotResult:
    ...
    def source_volume_size_in_gib(self) -> builtins.int:
        """
...
def get_volume_snapshot(name: Optional[builtins.str] = None,
...
def get_volume_snapshot_output(name: Optional[pulumi.Input[builtins.str]] = None,
