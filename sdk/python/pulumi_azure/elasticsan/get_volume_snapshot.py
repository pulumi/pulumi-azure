...
class GetVolumeSnapshotResult:
    ...
    def source_volume_size_in_gib(self) -> _builtins.int:
        """
...
def get_volume_snapshot(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ElasticSan` - 2023-01-01
    ...
    :param _builtins.str volume_group_id: The Elastic SAN Volume Group ID within which the Elastic SAN Volume Snapshot exists.
    """
    __args__ = dict()
    __args__['name'] = name
