...
class GetResult:
    ...
    def base_size_in_tib(self) -> _builtins.int:
        """
    ...
    def extended_size_in_tib(self) -> _builtins.int:
        """
        The base size of the Elastic SAN resource in TiB.
        """
    ...
    def total_iops(self) -> _builtins.int:
        """
    ...
    def total_mbps(self) -> _builtins.int:
        """
    ...
    def total_size_in_tib(self) -> _builtins.int:
        """
    ...
    def total_volume_size_in_gib(self) -> _builtins.int:
        """
    ...
    def volume_group_count(self) -> _builtins.int:
        """
...
def get(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ElasticSan` - 2023-01-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Elastic SAN exists.
    """
    __args__ = dict()
    __args__['name'] = name
