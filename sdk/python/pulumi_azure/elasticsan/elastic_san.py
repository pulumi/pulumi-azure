...
class ElasticSanArgs:
    def __init__(__self__, *,
                 base_size_in_tib: pulumi.Input[builtins.int],
                 resource_group_name: pulumi.Input[builtins.str],
                 sku: pulumi.Input['ElasticSanSkuArgs'],
                 extended_size_in_tib: Optional[pulumi.Input[builtins.int]] = None,
    ...
    def base_size_in_tib(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def base_size_in_tib(self, value: pulumi.Input[builtins.int]):
    ...
    def extended_size_in_tib(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def extended_size_in_tib(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ElasticSanState:
    def __init__(__self__, *,
                 base_size_in_tib: Optional[pulumi.Input[builtins.int]] = None,
                 extended_size_in_tib: Optional[pulumi.Input[builtins.int]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 total_iops: Optional[pulumi.Input[builtins.int]] = None,
                 total_mbps: Optional[pulumi.Input[builtins.int]] = None,
                 total_size_in_tib: Optional[pulumi.Input[builtins.int]] = None,
                 total_volume_size_in_gib: Optional[pulumi.Input[builtins.int]] = None,
                 volume_group_count: Optional[pulumi.Input[builtins.int]] = None,
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input['ElasticSanSkuArgs'] sku: A `sku` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Elastic SAN resource.
        :param pulumi.Input[builtins.int] total_iops: Total Provisioned IOps of the Elastic SAN resource.
        :param pulumi.Input[builtins.int] total_mbps: Total Provisioned MBps Elastic SAN resource.
        :param pulumi.Input[builtins.int] total_size_in_tib: Total size of the Elastic SAN resource in TB.
        :param pulumi.Input[builtins.int] total_volume_size_in_gib: Total size of the provisioned Volumes in GiB.
    ...
    @property
    @pulumi.getter(name="baseSizeInTib")
    def base_size_in_tib(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the base size of the Elastic SAN resource in TiB. Possible values are between `1` and `100`.
    ...
    @base_size_in_tib.setter
    def base_size_in_tib(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "base_size_in_tib", value)
    ...
    def total_iops(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @total_iops.setter
    def total_iops(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_iops", value)

    @property
    @pulumi.getter(name="totalMbps")
    def total_mbps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @total_mbps.setter
    def total_mbps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_mbps", value)

    @property
    @pulumi.getter(name="totalSizeInTib")
    def total_size_in_tib(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_size_in_tib(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_size_in_tib", value)

    @property
    @pulumi.getter(name="totalVolumeSizeInGib")
    def total_volume_size_in_gib(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_volume_size_in_gib(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_volume_size_in_gib", value)

    @property
    @pulumi.getter(name="volumeGroupCount")
    def volume_group_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def volume_group_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ElasticSan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            total_volume_size_in_gib: Optional[pulumi.Input[builtins.int]] = None,
            volume_group_count: Optional[pulumi.Input[builtins.int]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ElasticSan':
        """
    ...
    @property
    @pulumi.getter(name="baseSizeInTib")
    def base_size_in_tib(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the base size of the Elastic SAN resource in TiB. Possible values are between `1` and `100`.
    ...
    @property
    @pulumi.getter(name="extendedSizeInTib")
    def extended_size_in_tib(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the extended size of the Elastic SAN resource in TiB. Possible values are between `1` and `100`.
    ...
    @property
    @pulumi.getter(name="totalIops")
    def total_iops(self) -> pulumi.Output[builtins.int]:
        """
        Total Provisioned IOps of the Elastic SAN resource.
        """
        return pulumi.get(self, "total_iops")
    ...
    @property
    @pulumi.getter(name="totalMbps")
    def total_mbps(self) -> pulumi.Output[builtins.int]:
        """
        Total Provisioned MBps Elastic SAN resource.
        """
        return pulumi.get(self, "total_mbps")
    ...
    @property
    @pulumi.getter(name="totalSizeInTib")
    def total_size_in_tib(self) -> pulumi.Output[builtins.int]:
        """
        Total size of the Elastic SAN resource in TB.
        """
        return pulumi.get(self, "total_size_in_tib")
    ...
    @property
    @pulumi.getter(name="totalVolumeSizeInGib")
    def total_volume_size_in_gib(self) -> pulumi.Output[builtins.int]:
        """
        Total size of the provisioned Volumes in GiB.
        """
        return pulumi.get(self, "total_volume_size_in_gib")
    ...
    @property
    @pulumi.getter(name="volumeGroupCount")
    def volume_group_count(self) -> pulumi.Output[builtins.int]:
        """
        Total number of volume groups in this Elastic SAN resource.
        """
        return pulumi.get(self, "volume_group_count")
