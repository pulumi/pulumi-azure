...
class GetRecommendationsResult:
    ...
    def filter_by_categories(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "filter_by_categories")

    @property
    @pulumi.getter(name="filterByResourceGroups")
    def filter_by_resource_groups(self) -> Optional[Sequence[builtins.str]]:
...
def get_recommendations(filter_by_categories: Optional[Sequence[builtins.str]] = None,
                        filter_by_resource_groups: Optional[Sequence[builtins.str]] = None,
...
def get_recommendations_output(filter_by_categories: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                               filter_by_resource_groups: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
