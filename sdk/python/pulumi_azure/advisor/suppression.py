...
class SuppressionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] ttl: A optional time to live value. If omitted, the suppression will not expire. Changing this forces a new Advisor suppression to be created.
        """
...
class Suppression(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="suppressionId")
    def suppression_id(self) -> pulumi.Output[_builtins.str]:
        """
        The GUID of the suppression.
        """
        return pulumi.get(self, "suppression_id")
