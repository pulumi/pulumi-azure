...
class PipelineArgs:
    def __init__(__self__, *,
                 ...
                 activities_json: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 moniter_metrics_after_duration: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] activities_json: A JSON object that contains the activities that will be associated with the Data Factory Pipeline.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] annotations: List of tags that can be used for describing the Data Factory Pipeline.
        :param pulumi.Input[builtins.int] concurrency: The max number of concurrent runs for the Data Factory Pipeline. Must be between `1` and `50`.
        :param pulumi.Input[builtins.str] description: The description for the Data Factory Pipeline.
        :param pulumi.Input[builtins.str] folder: The folder that this Pipeline is in. If not specified, the Pipeline will appear at the root level.
        :param pulumi.Input[builtins.str] moniter_metrics_after_duration: The TimeSpan value after which an Azure Monitoring Metric is fired.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Data Factory Pipeline. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the Data Factory Pipeline.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variables: A map of variables to associate with the Data Factory Pipeline.
        """
    ...
    def activities_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def activities_json(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def moniter_metrics_after_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def moniter_metrics_after_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure:datafactory/pipeline:Pipeline")
class Pipeline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Pipeline':
        """
    ...
    @property
    @pulumi.getter(name="activitiesJson")
    def activities_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A JSON object that contains the activities that will be associated with the Data Factory Pipeline.
        """
        return pulumi.get(self, "activities_json")
    ...
    @property
    @pulumi.getter(name="moniterMetricsAfterDuration")
    def moniter_metrics_after_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The TimeSpan value after which an Azure Monitoring Metric is fired.
        """
        return pulumi.get(self, "moniter_metrics_after_duration")
