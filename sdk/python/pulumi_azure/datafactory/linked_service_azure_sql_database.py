...
class LinkedServiceAzureSqlDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 key_vault_connection_string: pulumi.Input[Optional['LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgs']] = None,
                 key_vault_password: pulumi.Input[Optional['LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] credential_name: The name of a User-assigned Managed Identity. Use this argument to authenticate against the linked resource using a User-assigned Managed Identity.
        :param pulumi.Input[_builtins.str] description: The description for the Data Factory Linked Service Azure SQL Database.
        :param pulumi.Input[_builtins.str] integration_runtime_name: The integration runtime reference to associate with the Data Factory Linked Service Azure SQL Database.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: A map of parameters to associate with the Data Factory Linked Service Azure SQL Database.
        :param pulumi.Input[_builtins.str] service_principal_id: The service principal id in which to authenticate against the Azure SQL Database. Required if `service_principal_key` is set.
        :param pulumi.Input[_builtins.str] service_principal_key: The service principal key in which to authenticate against the Azure SQL Database. Required if `service_principal_id` is set.
        :param pulumi.Input[_builtins.str] tenant_id: The tenant id or name in which to authenticate against the Azure SQL Database.
        :param pulumi.Input[_builtins.bool] use_managed_identity: Whether to use the Data Factory's managed identity to authenticate against the Azure SQL Database. Incompatible with `service_principal_id` and `service_principal_key`
        """
    ...
    def key_vault_connection_string(self) -> pulumi.Input[Optional['LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgs']]:
        """
    ...
    def key_vault_connection_string(self, value: pulumi.Input[Optional['LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgs']]):
        pulumi.set(self, "key_vault_connection_string", value)

    @_builtins.property
    @pulumi.getter(name="keyVaultPassword")
    def key_vault_password(self) -> pulumi.Input[Optional['LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgs']]:
        """
    ...
    def key_vault_password(self, value: pulumi.Input[Optional['LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgs']]):
...
class LinkedServiceAzureSqlDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 integration_runtime_name: pulumi.Input[Optional[_builtins.str]] = None,
                 key_vault_connection_string: pulumi.Input[Optional[Union['LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgs', 'LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgsDict', 'outputs.LinkedServiceAzureSqlDatabaseKeyVaultConnectionString']]] = None,
                 key_vault_password: pulumi.Input[Optional[Union['LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgs', 'LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgsDict', 'outputs.LinkedServiceAzureSqlDatabaseKeyVaultPassword']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 service_principal_id: pulumi.Input[Optional[_builtins.str]] = None,
                 service_principal_key: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: The description for the Data Factory Linked Service Azure SQL Database.
        :param pulumi.Input[_builtins.str] integration_runtime_name: The integration runtime reference to associate with the Data Factory Linked Service Azure SQL Database.
        :param pulumi.Input[Union['LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgs', 'LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgsDict', 'outputs.LinkedServiceAzureSqlDatabaseKeyVaultConnectionString']] key_vault_connection_string: A `key_vault_connection_string` block as defined below. Use this argument to store Azure SQL Database connection string in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service. Exactly one of either `connection_string` or `key_vault_connection_string` is required.
        :param pulumi.Input[Union['LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgs', 'LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgsDict', 'outputs.LinkedServiceAzureSqlDatabaseKeyVaultPassword']] key_vault_password: A `key_vault_password` block as defined below. Use this argument to store SQL Server password in an existing Key Vault. It needs an existing Key Vault Data Factory Linked Service.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Data Factory Linked Service Azure SQL Database. Changing this forces a new resource to be created. Must be unique within a data factory. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: A map of parameters to associate with the Data Factory Linked Service Azure SQL Database.
        :param pulumi.Input[_builtins.str] service_principal_id: The service principal id in which to authenticate against the Azure SQL Database. Required if `service_principal_key` is set.
        :param pulumi.Input[_builtins.str] service_principal_key: The service principal key in which to authenticate against the Azure SQL Database. Required if `service_principal_id` is set.
    ...
    def get(resource_name: str,
            ...
            service_principal_key: pulumi.Input[Optional[_builtins.str]] = None,
            tenant_id: pulumi.Input[Optional[_builtins.str]] = None,
            use_managed_identity: pulumi.Input[Optional[_builtins.bool]] = None) -> 'LinkedServiceAzureSqlDatabase':
        """
