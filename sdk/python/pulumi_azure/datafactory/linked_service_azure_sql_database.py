...
class LinkedServiceAzureSqlDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 integration_runtime_name: pulumi.Input[Optional[_builtins.str]] = None,
                 key_vault_connection_string: pulumi.Input[Optional[Union['LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgs', 'LinkedServiceAzureSqlDatabaseKeyVaultConnectionStringArgsDict']]] = None,
                 key_vault_password: pulumi.Input[Optional[Union['LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgs', 'LinkedServiceAzureSqlDatabaseKeyVaultPasswordArgsDict']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 service_principal_id: pulumi.Input[Optional[_builtins.str]] = None,
                 service_principal_key: pulumi.Input[Optional[_builtins.str]] = None,
