...
class LinkedServiceWebArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] authentication_type: The type of authentication used to connect to the web table source. Valid options are `Anonymous`, `Basic` and `ClientCertificate`.
        ...
        :param pulumi.Input[_builtins.str] url: The URL of the web service endpoint (e.g. <https://www.microsoft.com>).
        ...
        :param pulumi.Input[_builtins.str] password: The password for Basic authentication. Required if `authentication_type` sets to `Basic`.
        :param pulumi.Input[_builtins.str] username: The username for Basic authentication. Required if `authentication_type` sets to `Basic`.
        """
...
@pulumi.type_token("azure:datafactory/linkedServiceWeb:LinkedServiceWeb")
class LinkedServiceWeb(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password: Optional[pulumi.Input[_builtins.str]] = None,
            url: Optional[pulumi.Input[_builtins.str]] = None,
            username: Optional[pulumi.Input[_builtins.str]] = None) -> 'LinkedServiceWeb':
        """
