...
class DatasetParquetArgs:
    def __init__(__self__, *,
                 ...
                 compression_level: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compression_codec: The compression codec used to read/write text files. Valid values are `bzip2`, `gzip`, `deflate`, `ZipDeflate`, `TarGzip`, `Tar`, `snappy`, or `lz4`. Please note these values are case-sensitive.
        :param pulumi.Input[builtins.str] compression_level: Specifies the compression level. Possible values are `Optimal` and `Fastest`,
    ...
    def compression_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compression_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatasetParquet(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="compressionCodec")
    def compression_codec(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The compression codec used to read/write text files. Valid values are `bzip2`, `gzip`, `deflate`, `ZipDeflate`, `TarGzip`, `Tar`, `snappy`, or `lz4`. Please note these values are case-sensitive.
        """
        return pulumi.get(self, "compression_codec")
    ...
    @property
    @pulumi.getter(name="compressionLevel")
    def compression_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the compression level. Possible values are `Optimal` and `Fastest`,
        """
        return pulumi.get(self, "compression_level")
