...
class IntegrationRuntimeRuleArgs:
    def __init__(__self__, *,
                 ...
                 cleanup_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 virtual_network_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] cleanup_enabled: Cluster will not be recycled and it will be used in next data flow activity run until TTL (time to live) is reached if this is set as `false`. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Use `AutoResolve` to create an auto-resolve integration runtime. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Managed Integration Runtime. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        ...
        :param pulumi.Input[builtins.bool] virtual_network_enabled: Is Integration Runtime compute provisioned within Managed Virtual Network? Changing this forces a new resource to be created.
        """
    ...
    def cleanup_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cleanup_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def virtual_network_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def virtual_network_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class IntegrationRuntimeRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            time_to_live_min: Optional[pulumi.Input[builtins.int]] = None,
            virtual_network_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'IntegrationRuntimeRule':
        """
    ...
    @property
    @pulumi.getter(name="cleanupEnabled")
    def cleanup_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Cluster will not be recycled and it will be used in next data flow activity run until TTL (time to live) is reached if this is set as `false`. Defaults to `true`.
        """
        return pulumi.get(self, "cleanup_enabled")
    ...
    @property
    @pulumi.getter(name="virtualNetworkEnabled")
    def virtual_network_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is Integration Runtime compute provisioned within Managed Virtual Network? Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "virtual_network_enabled")
