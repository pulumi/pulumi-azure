...
class GetFactoryResult:
    ...
    """
    def __init__(__self__, github_configurations=None, identities=None, location=None, name=None, resource_group_name=None, tags=None, vsts_configurations=None, id=None):
