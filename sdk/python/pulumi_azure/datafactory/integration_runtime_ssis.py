...
class IntegrationRuntimeSsisArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] node_size: The size of the nodes on which the Azure-SSIS Integration Runtime runs. Valid values are: `Standard_D2_v3`, `Standard_D4_v3`, `Standard_D8_v3`, `Standard_D16_v3`, `Standard_D32_v3`, `Standard_D64_v3`, `Standard_E2_v3`, `Standard_E4_v3`, `Standard_E8_v3`, `Standard_E16_v3`, `Standard_E32_v3`, `Standard_E64_v3`, `Standard_D1_v2`, `Standard_D2_v2`, `Standard_D3_v2`, `Standard_D4_v2`, `Standard_A4_v2` and `Standard_A8_v2`
        ...
        :param pulumi.Input[builtins.str] license_type: The type of the license that is used. Valid values are `LicenseIncluded` and `BasePrice`. Defaults to `LicenseIncluded`.
        ...
        :param pulumi.Input[builtins.int] max_parallel_executions_per_node: Defines the maximum parallel executions per node. Defaults to `1`. Max is `1`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Azure-SSIS Integration Runtime. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[builtins.int] number_of_nodes: Number of nodes for the Azure-SSIS Integration Runtime. Max is `10`. Defaults to `1`.
...
class IntegrationRuntimeSsis(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="maxParallelExecutionsPerNode")
    def max_parallel_executions_per_node(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Defines the maximum parallel executions per node. Defaults to `1`. Max is `1`.
        """
        return pulumi.get(self, "max_parallel_executions_per_node")
