...
class _LinkedServiceKustoState:
    def __init__(__self__, *,
                 ...
                 kusto_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 service_principal_id: pulumi.Input[Optional[_builtins.str]] = None,
                 service_principal_key: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="kustoEndpoint")
    def kusto_endpoint(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The URI of the Kusto Cluster endpoint.
        """
        return pulumi.get(self, "kusto_endpoint")
    ...
    @kusto_endpoint.setter
    def kusto_endpoint(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "kusto_endpoint", value)
...
class LinkedServiceKusto(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_principal_key: pulumi.Input[Optional[_builtins.str]] = None,
            tenant: pulumi.Input[Optional[_builtins.str]] = None,
            use_managed_identity: pulumi.Input[Optional[_builtins.bool]] = None) -> 'LinkedServiceKusto':
        """
