...
class TriggerBlobEventArgs:
    def __init__(__self__, *,
                 ...
                 blob_path_begins_with: Optional[pulumi.Input[builtins.str]] = None,
                 blob_path_ends_with: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_empty_blobs: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: List of events that will fire this trigger. Possible values are `Microsoft.Storage.BlobCreated` and `Microsoft.Storage.BlobDeleted`.
        ...
        :param pulumi.Input[builtins.str] storage_account_id: The ID of Storage Account in which blob event will be listened. Changing this forces a new resource.
        :param pulumi.Input[builtins.bool] activated: Specifies if the Data Factory Blob Event Trigger is activated. Defaults to `true`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_properties: A map of additional properties to associate with the Data Factory Blob Event Trigger.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] annotations: List of tags that can be used for describing the Data Factory Blob Event Trigger.
        :param pulumi.Input[builtins.str] blob_path_begins_with: The pattern that blob path starts with for trigger to fire.
        :param pulumi.Input[builtins.str] blob_path_ends_with: The pattern that blob path ends with for trigger to fire.
               
               > **Note:** At least one of `blob_path_begins_with` and `blob_path_ends_with` must be set.
        :param pulumi.Input[builtins.str] description: The description for the Data Factory Blob Event Trigger.
        :param pulumi.Input[builtins.bool] ignore_empty_blobs: are blobs with zero bytes ignored?
        :param pulumi.Input[builtins.str] name: Specifies the name of the Data Factory Blob Event Trigger. Changing this forces a new resource to be created.
        """
    ...
    def blob_path_begins_with(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blob_path_begins_with(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "blob_path_begins_with", value)

    @property
    @pulumi.getter(name="blobPathEndsWith")
    def blob_path_ends_with(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blob_path_ends_with(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ignore_empty_blobs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_empty_blobs(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TriggerBlobEvent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            pipelines: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TriggerBlobEventPipelineArgs', 'TriggerBlobEventPipelineArgsDict']]]]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TriggerBlobEvent':
        """
    ...
    @property
    @pulumi.getter(name="blobPathBeginsWith")
    def blob_path_begins_with(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The pattern that blob path starts with for trigger to fire.
        """
        return pulumi.get(self, "blob_path_begins_with")
    ...
    @property
    @pulumi.getter(name="blobPathEndsWith")
    def blob_path_ends_with(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The pattern that blob path ends with for trigger to fire.
    ...
    @property
    @pulumi.getter(name="ignoreEmptyBlobs")
    def ignore_empty_blobs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        are blobs with zero bytes ignored?
        """
        return pulumi.get(self, "ignore_empty_blobs")
