...
class CredentialServicePrincipalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_principal_id: The Client ID of the Service Principal.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID of the Service Principal.
...
class CredentialServicePrincipal(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_principal_id: Optional[pulumi.Input[builtins.str]] = None,
            service_principal_key: Optional[pulumi.Input[Union['CredentialServicePrincipalServicePrincipalKeyArgs', 'CredentialServicePrincipalServicePrincipalKeyArgsDict']]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CredentialServicePrincipal':
        """
