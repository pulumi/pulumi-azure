...
def get_trigger_schedules(data_factory_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_factory_id: The ID of the Azure Data Factory to fetch trigger schedules from.
    """
    __args__ = dict()
...
def get_trigger_schedules_output(data_factory_id: Optional[pulumi.Input[builtins.str]] = None,
