...
class LinkedServiceAzureTableStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection_string: The connection string to an Azure Storage Account.
...
class LinkedServiceAzureTableStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            integration_runtime_name: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'LinkedServiceAzureTableStorage':
        """
