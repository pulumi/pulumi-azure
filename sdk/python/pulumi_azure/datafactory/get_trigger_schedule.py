...
class GetTriggerScheduleResult:
    ...
    @property
    @pulumi.getter
    def annotations(self) -> Sequence[builtins.str]:
        """
...
def get_trigger_schedule(data_factory_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_factory_id: The ID of the Azure Data Factory to fetch trigger schedule from.
    :param builtins.str name: The name of the trigger schedule.
    """
    __args__ = dict()
...
def get_trigger_schedule_output(data_factory_id: Optional[pulumi.Input[builtins.str]] = None,
