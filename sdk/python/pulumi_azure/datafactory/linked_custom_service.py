...
class LinkedCustomServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: The type of data stores that will be connected to Data Factory. For full list of supported data stores, please refer to Azure Data Factory connector for the type values syntax. Changing this forces a new resource to be created.
