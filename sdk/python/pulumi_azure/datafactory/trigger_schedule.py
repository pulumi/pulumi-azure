...
class TriggerScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: The Schedule Trigger's description.
        :param pulumi.Input[_builtins.str] end_time: The time the Schedule Trigger should end. The time will be represented in UTC.
        :param pulumi.Input[_builtins.str] frequency: The trigger frequency. Valid values include `Minute`, `Hour`, `Day`, `Week`, `Month`. Defaults to `Minute`.
        :param pulumi.Input[_builtins.int] interval: The interval for how often the trigger occurs. This defaults to `1`.
...
class TriggerSchedule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="pipelineParameters")
    def pipeline_parameters(self) -> pulumi.Output[Mapping[str, _builtins.str]]:
        """
        The pipeline parameters that the trigger will act upon.
        """
        return pulumi.get(self, "pipeline_parameters")
