...
class LinkedServiceCosmosDbArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection_string: The connection string. Required if `account_endpoint`, `account_key`, and `database` are unspecified.
        :param pulumi.Input[_builtins.str] database: The name of the database. Required if `connection_string` is unspecified.
...
class LinkedServiceCosmosDb(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            integration_runtime_name: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'LinkedServiceCosmosDb':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="accountEndpoint")
    def account_endpoint(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The endpoint of the Azure CosmosDB account. Required if `connection_string` is unspecified.
        """
        return pulumi.get(self, "account_endpoint")
