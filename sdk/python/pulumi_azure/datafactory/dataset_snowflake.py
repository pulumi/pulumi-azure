...
class DatasetSnowflakeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_properties: A map of additional properties to associate with the Data Factory Dataset Snowflake.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] annotations: List of tags that can be used for describing the Data Factory Dataset Snowflake.
        :param pulumi.Input[builtins.str] description: The description for the Data Factory Dataset Snowflake.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Data Factory Dataset Snowflake. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the Data Factory Dataset Snowflake.
        ...
        :param pulumi.Input[builtins.str] schema_name: The schema name of the Data Factory Dataset Snowflake.
        :param pulumi.Input[builtins.str] table_name: The table name of the Data Factory Dataset Snowflake.
        """
...
class DatasetSnowflake(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schema_columns: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatasetSnowflakeSchemaColumnArgs', 'DatasetSnowflakeSchemaColumnArgsDict']]]]] = None,
            schema_name: Optional[pulumi.Input[builtins.str]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DatasetSnowflake':
        """
