...
class LinkedServiceAzureBlobStorageArgs:
    def __init__(__self__, *,
                 ...
                 connection_string_insecure: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 storage_kind: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connection_string: The connection string. Conflicts with `connection_string_insecure`, `sas_uri` and `service_endpoint`.
        :param pulumi.Input[builtins.str] connection_string_insecure: The connection string sent insecurely. Conflicts with `connection_string`, `sas_uri` and `service_endpoint`.
        ...
        :param pulumi.Input[builtins.str] sas_uri: The SAS URI. Conflicts with `connection_string_insecure`, `connection_string` and `service_endpoint`.
        """
    ...
    def connection_string_insecure(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connection_string_insecure(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_kind(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "storage_kind")

    @storage_kind.setter
    def storage_kind(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LinkedServiceAzureBlobStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_kind: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            use_managed_identity: Optional[pulumi.Input[builtins.bool]] = None) -> 'LinkedServiceAzureBlobStorage':
        """
    ...
    @property
    @pulumi.getter(name="connectionStringInsecure")
    def connection_string_insecure(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The connection string sent insecurely. Conflicts with `connection_string`, `sas_uri` and `service_endpoint`.
    ...
    @property
    @pulumi.getter(name="sasUri")
    def sas_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SAS URI. Conflicts with `connection_string_insecure`, `connection_string` and `service_endpoint`.
        """
        return pulumi.get(self, "sas_uri")
    ...
    @property
    @pulumi.getter(name="serviceEndpoint")
    def service_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "service_endpoint")
    ...
    @property
    @pulumi.getter(name="storageKind")
    def storage_kind(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "storage_kind")
