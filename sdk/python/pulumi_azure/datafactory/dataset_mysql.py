...
class DatasetMysql(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 schema_columns: Optional[pulumi.Input[List[pulumi.Input[pulumi.InputType['DatasetMysqlSchemaColumnArgs']]]]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[str]]] annotations: List of tags that can be used for describing the Data Factory Dataset MySQL.
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['DatasetMysqlSchemaColumnArgs']]]] schema_columns: A `schema_column` block as defined below.
    ...
    def schema_columns(self) -> pulumi.Output[Optional[List['outputs.DatasetMysqlSchemaColumn']]]:
        """
