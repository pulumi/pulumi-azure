...
class DatasetMysqlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_properties: A map of additional properties to associate with the Data Factory Dataset MySQL.
               
               The following supported arguments are specific to MySQL Dataset:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] annotations: List of tags that can be used for describing the Data Factory Dataset MySQL.
        :param pulumi.Input[builtins.str] description: The description for the Data Factory Dataset MySQL.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Data Factory Dataset MySQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the Data Factory Dataset MySQL.
        ...
        :param pulumi.Input[builtins.str] table_name: The table name of the Data Factory Dataset MySQL.
        """
...
class DatasetMysql(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Data Factory Dataset MySQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the Data Factory Dataset MySQL.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DatasetMysqlSchemaColumnArgs', 'DatasetMysqlSchemaColumnArgsDict']]]] schema_columns: A `schema_column` block as defined below.
        :param pulumi.Input[builtins.str] table_name: The table name of the Data Factory Dataset MySQL.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            schema_columns: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatasetMysqlSchemaColumnArgs', 'DatasetMysqlSchemaColumnArgsDict']]]]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DatasetMysql':
        """
