...
class LinkedServiceAzureSearchArgs:
    def __init__(__self__, *,
                 ...
                 search_service_key: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] search_service_key: The key of the Azure Search Service.
        :param pulumi.Input[builtins.str] url: The URL of the Search Service endpoint (e.g. <https://{searchServiceName}.search.windows.net>).
    ...
    def search_service_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def search_service_key(self, value: pulumi.Input[builtins.str]):
...
class _LinkedServiceAzureSearchState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 search_service_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] data_factory_id: The Data Factory ID in which to associate the Linked Service with. Changing this forces a new resource.
        :param pulumi.Input[builtins.str] description: The description for the Data Factory Linked Service.
        :param pulumi.Input[builtins.str] encrypted_credential: The encrypted credential to connect to Azure Search Service.
        :param pulumi.Input[builtins.str] integration_runtime_name: The integration runtime reference to associate with the Data Factory Linked Service.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Data Factory Linked Service. Changing this forces a new resource to be created. Must be unique within a data factory. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the Data Factory Linked Service.
        :param pulumi.Input[builtins.str] search_service_key: The key of the Azure Search Service.
    ...
    @property
    @pulumi.getter(name="searchServiceKey")
    def search_service_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The key of the Azure Search Service.
        """
        return pulumi.get(self, "search_service_key")
    ...
    @search_service_key.setter
    def search_service_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "search_service_key", value)
...
class LinkedServiceAzureSearch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            search_service_key: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'LinkedServiceAzureSearch':
        """
    ...
    @property
    @pulumi.getter(name="searchServiceKey")
    def search_service_key(self) -> pulumi.Output[builtins.str]:
        """
        The key of the Azure Search Service.
        """
        return pulumi.get(self, "search_service_key")
