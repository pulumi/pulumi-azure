...
class LinkedServiceAzureSearchArgs:
    def __init__(__self__, *,
                 ...
                 search_service_key: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] search_service_key: The key of the Azure Search Service.
        :param pulumi.Input[_builtins.str] url: The URL of the Search Service endpoint (e.g. <https://{searchServiceName}.search.windows.net>).
    ...
    def search_service_key(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def search_service_key(self, value: pulumi.Input[_builtins.str]):
...
class _LinkedServiceAzureSearchState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 search_service_key: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] data_factory_id: The Data Factory ID in which to associate the Linked Service with. Changing this forces a new resource.
        :param pulumi.Input[_builtins.str] description: The description for the Data Factory Linked Service.
        :param pulumi.Input[_builtins.str] encrypted_credential: The encrypted credential to connect to Azure Search Service.
        :param pulumi.Input[_builtins.str] integration_runtime_name: The integration runtime reference to associate with the Data Factory Linked Service.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Data Factory Linked Service. Changing this forces a new resource to be created. Must be unique within a data factory. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: A map of parameters to associate with the Data Factory Linked Service.
        :param pulumi.Input[_builtins.str] search_service_key: The key of the Azure Search Service.
    ...
    @_builtins.property
    @pulumi.getter(name="searchServiceKey")
    def search_service_key(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The key of the Azure Search Service.
        """
        return pulumi.get(self, "search_service_key")
    ...
    @search_service_key.setter
    def search_service_key(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "search_service_key", value)
...
@pulumi.type_token("azure:datafactory/linkedServiceAzureSearch:LinkedServiceAzureSearch")
class LinkedServiceAzureSearch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            search_service_key: Optional[pulumi.Input[_builtins.str]] = None,
            url: Optional[pulumi.Input[_builtins.str]] = None) -> 'LinkedServiceAzureSearch':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="searchServiceKey")
    def search_service_key(self) -> pulumi.Output[_builtins.str]:
        """
        The key of the Azure Search Service.
        """
        return pulumi.get(self, "search_service_key")
