...
class DatasetAzureBlobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] filename: The filename of the Azure Blob.
...
class DatasetAzureBlob(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dynamicFilenameEnabled")
    def dynamic_filename_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Is the `filename` using dynamic expression, function or system variables? Defaults to `false`.
        """
        return pulumi.get(self, "dynamic_filename_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="dynamicPathEnabled")
    def dynamic_path_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Is the `path` using dynamic expression, function or system variables? Defaults to `false`.
        """
        return pulumi.get(self, "dynamic_path_enabled")
