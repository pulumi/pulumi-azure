...
class IntegrationRuntimeSelfHostedArgs:
    def __init__(__self__, *,
                 ...
                 self_contained_interactive_authoring_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Data Factory. Changing this forces a new Data Factory Self-hosted Integration Runtime to be created.
        ...
        :param pulumi.Input[builtins.bool] self_contained_interactive_authoring_enabled: Specifies whether enable interactive authoring function when your self-hosted integration runtime is unable to establish a connection with Azure Relay.
        """
    ...
    def self_contained_interactive_authoring_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def self_contained_interactive_authoring_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _IntegrationRuntimeSelfHostedState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 primary_authorization_key: Optional[pulumi.Input[builtins.str]] = None,
                 rbac_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input['IntegrationRuntimeSelfHostedRbacAuthorizationArgs']]]] = None,
                 secondary_authorization_key: Optional[pulumi.Input[builtins.str]] = None,
                 self_contained_interactive_authoring_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] description: Integration runtime description.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Data Factory. Changing this forces a new Data Factory Self-hosted Integration Runtime to be created.
        :param pulumi.Input[builtins.str] primary_authorization_key: The primary integration runtime authentication key.
        :param pulumi.Input[Sequence[pulumi.Input['IntegrationRuntimeSelfHostedRbacAuthorizationArgs']]] rbac_authorizations: A `rbac_authorization` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] secondary_authorization_key: The secondary integration runtime authentication key.
        :param pulumi.Input[builtins.bool] self_contained_interactive_authoring_enabled: Specifies whether enable interactive authoring function when your self-hosted integration runtime is unable to establish a connection with Azure Relay.
        """
    ...
    def primary_authorization_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_authorization_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secondary_authorization_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secondary_authorization_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IntegrationRuntimeSelfHosted(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rbac_authorizations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IntegrationRuntimeSelfHostedRbacAuthorizationArgs', 'IntegrationRuntimeSelfHostedRbacAuthorizationArgsDict']]]]] = None,
            secondary_authorization_key: Optional[pulumi.Input[builtins.str]] = None,
            self_contained_interactive_authoring_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'IntegrationRuntimeSelfHosted':
        """
    ...
    @property
    @pulumi.getter(name="primaryAuthorizationKey")
    def primary_authorization_key(self) -> pulumi.Output[builtins.str]:
        """
        The primary integration runtime authentication key.
        """
        return pulumi.get(self, "primary_authorization_key")
    ...
    @property
    @pulumi.getter(name="secondaryAuthorizationKey")
    def secondary_authorization_key(self) -> pulumi.Output[builtins.str]:
        """
        The secondary integration runtime authentication key.
        """
        return pulumi.get(self, "secondary_authorization_key")
    ...
    @property
    @pulumi.getter(name="selfContainedInteractiveAuthoringEnabled")
    def self_contained_interactive_authoring_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether enable interactive authoring function when your self-hosted integration runtime is unable to establish a connection with Azure Relay.
        """
        return pulumi.get(self, "self_contained_interactive_authoring_enabled")
