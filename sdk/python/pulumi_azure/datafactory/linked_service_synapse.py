...
class LinkedServiceSynapseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_string: The connection string in which to authenticate with the Synapse.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_properties: A map of additional properties to associate with the Data Factory Linked Service Synapse.
               
               The following supported arguments are specific to Data Factory Synapse Linked Service:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] annotations: List of tags that can be used for describing the Data Factory Linked Service Synapse.
        :param pulumi.Input[builtins.str] description: The description for the Data Factory Linked Service Synapse.
        :param pulumi.Input[builtins.str] integration_runtime_name: The integration runtime reference to associate with the Data Factory Linked Service Synapse.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Data Factory Linked Service Synapse. Changing this forces a new resource to be created. Must be unique within a data factory. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A map of parameters to associate with the Data Factory Linked Service Synapse.
        """
...
class LinkedServiceSynapse(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_vault_password: Optional[pulumi.Input[Union['LinkedServiceSynapseKeyVaultPasswordArgs', 'LinkedServiceSynapseKeyVaultPasswordArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'LinkedServiceSynapse':
        """
