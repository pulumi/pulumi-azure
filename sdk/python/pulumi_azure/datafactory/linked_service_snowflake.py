...
class LinkedServiceSnowflakeArgs:
    def __init__(__self__, *,
        ...
        """
        LinkedServiceSnowflakeArgs._configure(
...
class _LinkedServiceSnowflakeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] parameters: A map of parameters to associate with the Data Factory Linked Service.
        """
        _LinkedServiceSnowflakeState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            additional_properties=additional_properties,
            annotations=annotations,
            connection_string=connection_string,
...
class LinkedServiceSnowflake(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            LinkedServiceSnowflakeArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if key_vault_password is not None and not isinstance(key_vault_password, LinkedServiceSnowflakeKeyVaultPasswordArgs):
                key_vault_password = key_vault_password or {}
                def _setter(key, value):
                    key_vault_password[key] = value
                LinkedServiceSnowflakeKeyVaultPasswordArgs._configure(_setter, **key_vault_password)
