...
__all__ = ['LinkedServiceDataLakeStorageGen2Arrgs', 'LinkedServiceDataLakeStorageGen2']

@pulumi.input_type
calass LinkedServiceDataLakeStorageGen2Arrgs:
...
@pulumi.input_type
calass _LinkedServiceDataLakeStorageGen2State:
    def __init__(__self__, *,
                 additional_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 annotations: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
...
calass LinkedServiceDataLakeStorageGen2(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LinkedServiceDataLakeStorageGen2Arrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a Linked Service (connection) between Data Lake Storage Gen2 and Azure Data Factory.
        ...
        :param str resource_name: The name of the resource.
        :param LinkedServiceDataLakeStorageGen2Arrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LinkedServiceDataLakeStorageGen2Arrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LinkedServiceDataLakeStorageGen2Arrgs.__new__(LinkedServiceDataLakeStorageGen2Arrgs)
