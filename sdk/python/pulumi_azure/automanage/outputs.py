...
class ConfigurationAntimalware(dict):
    ...
    def __init__(__self__, *,
                 ...
                 real_time_protection_enabled: Optional[builtins.bool] = None,
                 scheduled_scan_day: Optional[builtins.int] = None,
                 scheduled_scan_enabled: Optional[builtins.bool] = None,
                 scheduled_scan_time_in_minutes: Optional[builtins.int] = None,
                 scheduled_scan_type: Optional[builtins.str] = None):
        """
        :param 'ConfigurationAntimalwareExclusionsArgs' exclusions: A `exclusions` block as defined below.
        :param builtins.bool real_time_protection_enabled: Whether the real time protection is enabled. Defaults to `false`.
        :param builtins.int scheduled_scan_day: The day of the scheduled scan. Possible values are `0` to `8` where `0` is daily, `1` to `7` are the days of the week and `8` is Disabled. Defaults to `8`.
        :param builtins.bool scheduled_scan_enabled: Whether the scheduled scan is enabled. Defaults to `false`.
        :param builtins.int scheduled_scan_time_in_minutes: The time of the scheduled scan in minutes. Possible values are `0` to `1439` where `0` is 12:00 AM and `1439` is 11:59 PM.
        :param builtins.str scheduled_scan_type: The type of the scheduled scan. Possible values are `Quick` and `Full`. Defaults to `Quick`.
        """
    ...
    def real_time_protection_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def scheduled_scan_day(self) -> Optional[builtins.int]:
        """
    ...
    def scheduled_scan_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def scheduled_scan_time_in_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def scheduled_scan_type(self) -> Optional[builtins.str]:
        """
...
class ConfigurationAntimalwareExclusions(dict):
    def __init__(__self__, *,
                 extensions: Optional[builtins.str] = None,
                 paths: Optional[builtins.str] = None,
                 processes: Optional[builtins.str] = None):
        """
        :param builtins.str extensions: The extensions to exclude from the antimalware scan, separated by `;`. For example `.ext1;.ext2`.
        :param builtins.str paths: The paths to exclude from the antimalware scan, separated by `;`. For example `C:\\\\Windows\\\\Temp;D:\\\\Temp`.
        :param builtins.str processes: The processes to exclude from the antimalware scan, separated by `;`. For example `svchost.exe;notepad.exe`.
        """
    ...
    @property
    @pulumi.getter
    def extensions(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def paths(self) -> Optional[builtins.str]:
        """
...
class ConfigurationAzureSecurityBaseline(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str assignment_type: The assignment type of the azure security baseline. Possible values are `ApplyAndAutoCorrect`, `ApplyAndMonitor`, `Audit` and `DeployAndAutoCorrect`. Defaults to `ApplyAndAutoCorrect`.
        """
...
class ConfigurationBackup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int instant_rp_retention_range_in_days: The retention range in days of the backup policy. Defaults to `5`.
        :param builtins.str policy_name: The name of the backup policy.
        ...
        :param builtins.str time_zone: The timezone of the backup policy. Defaults to `UTC`.
        """
...
class ConfigurationBackupRetentionPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retention_policy_type: Optional[builtins.str] = None,
        ...
        :param builtins.str retention_policy_type: The retention policy type of the backup policy. Possible value is `LongTermRetentionPolicy`. Defaults to `LongTermRetentionPolicy`.
    ...
    def retention_policy_type(self) -> Optional[builtins.str]:
        """
...
class ConfigurationBackupRetentionPolicyDailySchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] retention_times: The retention times of the backup policy.
        """
...
class ConfigurationBackupRetentionPolicyDailyScheduleRetentionDuration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The count of the retention duration of the backup policy. Valid value inside `daily_schedule` is `7` to `9999` and inside `weekly_schedule` is `1` to `5163`.
        :param builtins.str duration_type: The duration type of the retention duration of the backup policy. Valid value inside `daily_schedule` is `Days` and inside `weekly_schedule` is `Weeks`. Defaults to `Days`.
        """
...
class ConfigurationBackupSchedulePolicy(dict):
    ...
    def __init__(__self__, *,
                 schedule_policy_type: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str schedule_policy_type: The schedule policy type of the backup policy. Possible value is `SimpleSchedulePolicy`. Defaults to `SimpleSchedulePolicy`.
        :param Sequence[builtins.str] schedule_run_days: The schedule run days of the backup policy. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday` and `Saturday`.
        :param builtins.str schedule_run_frequency: The schedule run frequency of the backup policy. Possible values are `Daily` and `Weekly`. Defaults to `Daily`.
        :param Sequence[builtins.str] schedule_run_times: The schedule run times of the backup policy.
        """
    ...
    def schedule_policy_type(self) -> Optional[builtins.str]:
        """
