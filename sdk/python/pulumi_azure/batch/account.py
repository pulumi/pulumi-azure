...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_account_authentication_mode: Specifies the storage account authentication mode. Possible values include `StorageKeys`, `BatchAccountManagedIdentity`.
               
               > **NOTE:** When using `BatchAccountManagedIdentity` mod, the `identity.type` must set to `UserAssigned` or `SystemAssigned`.
        :param pulumi.Input[_builtins.str] storage_account_id: Specifies the storage account to use for the Batch account. If not specified, Azure Batch will manage the storage.
               
               > **NOTE:** When using `storage_account_id`, the `storage_account_authentication_mode` must be specified as well.
        :param pulumi.Input[_builtins.str] storage_account_node_identity: Specifies the user assigned identity for the storage account.
...
class _AccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which to create the Batch account. Changing this forces a new resource to be created.
               ...
               > **NOTE:** To work around [a bug in the Azure API](https://github.com/Azure/azure-rest-api-specs/issues/5574) this property is currently treated as case-insensitive. A future version of this provider will require that the casing is correct.
        :param pulumi.Input[_builtins.str] secondary_access_key: The Batch account secondary access key.
        :param pulumi.Input[_builtins.str] storage_account_authentication_mode: Specifies the storage account authentication mode. Possible values include `StorageKeys`, `BatchAccountManagedIdentity`.
...
class Account(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="poolAllocationMode")
    def pool_allocation_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the mode to use for pool allocation. Possible values are `BatchService` or `UserSubscription`. Defaults to `BatchService`.
        """
        return pulumi.get(self, "pool_allocation_mode")
    ...
    @_builtins.property
    @pulumi.getter(name="storageAccountAuthenticationMode")
    def storage_account_authentication_mode(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the storage account authentication mode. Possible values include `StorageKeys`, `BatchAccountManagedIdentity`.
    ...
    @_builtins.property
    @pulumi.getter(name="storageAccountNodeIdentity")
    def storage_account_node_identity(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the user assigned identity for the storage account.
        """
        return pulumi.get(self, "storage_account_node_identity")
