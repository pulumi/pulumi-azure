...
class AccountEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_vault_key_id: The full URL path to the Azure key vault key id that should be used to encrypt data, as documented [here](https://docs.microsoft.com/azure/batch/batch-customer-managed-key). Both versioned and versionless keys are supported.
        """
...
class AccountIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Batch Account. Possible values are `SystemAssigned` or `UserAssigned`.
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Batch Account.
...
class AccountKeyVaultReference(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str id: The Azure identifier of the Azure KeyVault to use.
        :param builtins.str url: The HTTPS URL of the Azure KeyVault to use.
        """
...
class AccountNetworkProfileAccountAccess(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_action: Specifies the default action for the account access. Possible values are `Allow` and `Deny`. Defaults to `Deny`.
...
class AccountNetworkProfileAccountAccessIpRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str action: Specifies the action of the ip rule. The only possible value is `Allow`. Defaults to `Allow`.
        """
...
class AccountNetworkProfileNodeManagementAccess(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_action: Specifies the default action for the node management access. Possible values are `Allow` and `Deny`. Defaults to `Deny`.
...
class PoolAutoScale(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str formula: The autoscale formula that needs to be used for scaling the Batch pool.
        :param builtins.str evaluation_interval: The interval to wait before evaluating if the pool needs to be scaled. Defaults to `PT15M`.
        """
...
class PoolCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 visibilities: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str id: The ID of the Batch Certificate to install on the Batch Pool, which must be inside the same Batch Account.
        :param builtins.str store_location: The location of the certificate store on the compute node into which to install the certificate. Possible values are `CurrentUser` or `LocalMachine`.
               
               > **Note:** This property is applicable only for pools configured with Windows nodes (that is, created with cloudServiceConfiguration, or with virtualMachineConfiguration using a Windows image reference). For Linux compute nodes, the certificates are stored in a directory inside the task working directory and an environment variable `AZ_BATCH_CERTIFICATES_DIR` is supplied to the task to query for this location. For certificates with visibility of `remoteUser`, a 'certs' directory is created in the user's home directory (e.g., `/home/{user-name}/certs`) and certificates are placed in that directory.
        :param builtins.str store_name: The name of the certificate store on the compute node into which to install the certificate. This property is applicable only for pools configured with Windows nodes (that is, created with cloudServiceConfiguration, or with virtualMachineConfiguration using a Windows image reference). Common store names include: `My`, `Root`, `CA`, `Trust`, `Disallowed`, `TrustedPeople`, `TrustedPublisher`, `AuthRoot`, `AddressBook`, but any custom store name can also be used.
        :param Sequence[builtins.str] visibilities: Which user accounts on the compute node should have access to the private data of the certificate. Possible values are `StartTask`, `Task` and `RemoteUser`.
        """
        pulumi.set(__self__, "id", id)
    ...
    @property
    @pulumi.getter
    def visibilities(self) -> Optional[Sequence[builtins.str]]:
        """
...
class PoolContainerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] container_image_names: A list of container image names to use, as would be specified by `docker pull`. Changing this forces a new resource to be created.
        ...
        :param builtins.str type: The type of container configuration. Possible value is `DockerCompatible`.
        """
...
class PoolContainerConfigurationContainerRegistry(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str registry_server: The container registry URL. Changing this forces a new resource to be created.
        :param builtins.str password: The password to log into the registry server. Changing this forces a new resource to be created.
        :param builtins.str user_assigned_identity_id: The reference to the user assigned identity to use to access an Azure Container Registry instead of username and password. Changing this forces a new resource to be created.
        :param builtins.str user_name: The user name to log into the registry server. Changing this forces a new resource to be created.
        """
...
class PoolDataDisk(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int disk_size_gb: The initial disk size in GB when creating new data disk.
        ...
        :param builtins.str caching: Values are: "none" - The caching mode for the disk is not enabled. "readOnly" - The caching mode for the disk is read only. "readWrite" - The caching mode for the disk is read and write. For information about the caching options see: <https://blogs.msdn.microsoft.com/windowsazurestorage/2012/06/27/exploring-windows-azure-drives-disks-and-images/>. Possible values are `None`, `ReadOnly` and `ReadWrite`. Defaults to `ReadOnly`.
        :param builtins.str storage_account_type: The storage account type to be used for the data disk. Values are: Possible values are `Standard_LRS` - The data disk should use standard locally redundant storage. `Premium_LRS` - The data disk should use premium locally redundant storage. Defaults to `Standard_LRS`.
        """
...
class PoolDiskEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str disk_encryption_target: On Linux pool, only \\"TemporaryDisk\\" is supported; on Windows pool, \\"OsDisk\\" and \\"TemporaryDisk\\" must be specified.
        """
...
class PoolExtension(dict):
    ...
    def __init__(__self__, *,
                 ...
                 settings_json: Optional[builtins.str] = None,
                 type_handler_version: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the virtual machine extension.
        :param builtins.str publisher: The name of the extension handler publisher.The name of the extension handler publisher.
        :param builtins.str type: The type of the extensions.
        ...
        :param builtins.bool automatic_upgrade_enabled: Indicates whether the extension should be automatically upgraded by the platform if there is a newer version available. Supported values are `true` and `false`.
        ...
        :param builtins.str protected_settings: JSON formatted protected settings for the extension, the value should be encoded with `jsonencode` function. The extension can contain either `protected_settings` or `provision_after_extensions` or no protected settings at all.
        :param Sequence[builtins.str] provision_after_extensions: The collection of extension names. Collection of extension names after which this extension needs to be provisioned.
        :param builtins.str settings_json: JSON formatted public settings for the extension, the value should be encoded with `jsonencode` function.
        :param builtins.str type_handler_version: The version of script handler.
        """
    ...
    def settings_json(self) -> Optional[builtins.str]:
        """
...
class PoolFixedScale(dict):
    ...
    def __init__(__self__, *,
                 node_deallocation_method: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str node_deallocation_method: It determines what to do with a node and its running task(s) if the pool size is decreasing. Values are `Requeue`, `RetainedData`, `TaskCompletion` and `Terminate`.
        :param builtins.str resize_timeout: The timeout for resize operations. Defaults to `PT15M`.
        :param builtins.int target_dedicated_nodes: The number of nodes in the Batch pool. Defaults to `1`.
        :param builtins.int target_low_priority_nodes: The number of low priority nodes in the Batch pool. Defaults to `0`.
        """
    ...
    def node_deallocation_method(self) -> Optional[builtins.str]:
        """
...
class PoolIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Batch Account.
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Batch Account. Only possible value is `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "type", type)
...
class PoolMountAzureBlobFileSystem(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str container_name: The Azure Blob Storage Container name.
        :param builtins.str relative_mount_path: The relative path on compute node where the file system will be mounted All file systems are mounted relative to the Batch mounts directory, accessible via the `AZ_BATCH_NODE_MOUNTS_DIR` environment variable.
        :param builtins.str account_key: The Azure Storage Account key. This property is mutually exclusive with both `sas_key` and `identity_id`; exactly one must be specified.
        :param builtins.str blobfuse_options: Additional command line options to pass to the mount command. These are 'net use' options in Windows and 'mount' options in Linux.
        :param builtins.str identity_id: The ARM resource id of the user assigned identity. This property is mutually exclusive with both `account_key` and `sas_key`; exactly one must be specified.
        :param builtins.str sas_key: The Azure Storage SAS token. This property is mutually exclusive with both `account_key` and `identity_id`; exactly one must be specified.
        """
...
class PoolMountAzureFileShare(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_key: The Azure Storage Account key.
        :param builtins.str account_name: The Azure Storage Account name.
        :param builtins.str azure_file_url: The Azure Files URL. This is of the form 'https://{account}.file.core.windows.net/'.
        :param builtins.str relative_mount_path: The relative path on compute node where the file system will be mounted All file systems are mounted relative to the Batch mounts directory, accessible via the `AZ_BATCH_NODE_MOUNTS_DIR` environment variable.
        :param builtins.str mount_options: Additional command line options to pass to the mount command. These are 'net use' options in Windows and 'mount' options in Linux.
        """
        pulumi.set(__self__, "account_key", account_key)
        pulumi.set(__self__, "account_name", account_name)
...
class PoolMountCifsMount(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mount_options: Optional[builtins.str] = None):
        """
        :param builtins.str password: The password to use for authentication against the CIFS file system.
        :param builtins.str relative_mount_path: The relative path on compute node where the file system will be mounted All file systems are mounted relative to the Batch mounts directory, accessible via the `AZ_BATCH_NODE_MOUNTS_DIR` environment variable.
        :param builtins.str source: The URI of the file system to mount.
        :param builtins.str user_name: The user to use for authentication against the CIFS file system.
        :param builtins.str mount_options: Additional command line options to pass to the mount command. These are 'net use' options in Windows and 'mount' options in Linux.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "relative_mount_path", relative_mount_path)
...
class PoolNetworkConfiguration(dict):
    ...
    def __init__(__self__, *,
                 accelerated_networking_enabled: Optional[builtins.bool] = None,
                 ...
                 public_address_provisioning_type: Optional[builtins.str] = None,
                 public_ips: Optional[Sequence[builtins.str]] = None,
                 subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.bool accelerated_networking_enabled: Whether to enable accelerated networking. Possible values are `true` and `false`. Defaults to `false`. Changing this forces a new resource to be created.
        :param builtins.str dynamic_vnet_assignment_scope: The scope of dynamic vnet assignment. Allowed values: `none`, `job`. Changing this forces a new resource to be created. Defaults to `none`.
        ...
        :param builtins.str public_address_provisioning_type: Type of public IP address provisioning. Supported values are `BatchManaged`, `UserManaged` and `NoPublicIPAddresses`.
        :param Sequence[builtins.str] public_ips: A list of public IP ids that will be allocated to nodes. Changing this forces a new resource to be created.
        :param builtins.str subnet_id: The ARM resource identifier of the virtual network subnet which the compute nodes of the pool will join. Changing this forces a new resource to be created.
        """
    ...
    def accelerated_networking_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def public_address_provisioning_type(self) -> Optional[builtins.str]:
        """
...
class PoolNetworkConfigurationEndpointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int backend_port: The port number on the compute node. Acceptable values are between `1` and `65535` except for `29876`, `29877` as these are reserved. Changing this forces a new resource to be created.
        :param builtins.str frontend_port_range: The range of external ports that will be used to provide inbound access to the backendPort on individual compute nodes in the format of `1000-1100`. Acceptable values range between `1` and `65534` except ports from `50000` to `55000` which are reserved by the Batch service. All ranges within a pool must be distinct and cannot overlap. Values must be a range of at least `100` nodes. Changing this forces a new resource to be created.
        :param builtins.str name: The name of the endpoint. The name must be unique within a Batch pool, can contain letters, numbers, underscores, periods, and hyphens. Names must start with a letter or number, must end with a letter, number, or underscore, and cannot exceed 77 characters. Changing this forces a new resource to be created.
        :param builtins.str protocol: The protocol of the endpoint. Acceptable values are `TCP` and `UDP`. Changing this forces a new resource to be created.
...
class PoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access: The action that should be taken for a specified IP address, subnet range or tag. Acceptable values are `Allow` and `Deny`. Changing this forces a new resource to be created.
        :param builtins.int priority: The priority for this rule. The value must be at least `150`. Changing this forces a new resource to be created.
        :param builtins.str source_address_prefix: The source address prefix or tag to match for the rule. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] source_port_ranges: The source port ranges to match for the rule. Valid values are `*` (for all ports 0 - 65535) or arrays of ports or port ranges (i.e. `100-200`). The ports should in the range of 0 to 65535 and the port ranges or ports can't overlap. If any other values are provided the request fails with HTTP status code 400. Default value will be `*`. Changing this forces a new resource to be created.
        """
...
class PoolNodePlacement(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy: The placement policy for allocating nodes in the pool. Values are: "Regional": All nodes in the pool will be allocated in the same region; "Zonal": Nodes in the pool will be spread across different zones with the best effort balancing. Defaults to `Regional`.
        """
...
class PoolSecurityProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool host_encryption_enabled: Whether to enable host encryption for the Virtual Machine or Virtual Machine Scale Set. This will enable the encryption for all the disks including Resource/Temp disk at host itself. Possible values are `true` and `false`. Changing this forces a new resource to be created.
        :param builtins.bool secure_boot_enabled: Whether to enable secure boot for the Virtual Machine or Virtual Machine Scale Set. Possible values are `true` and `false`. Changing this forces a new resource to be created.
        :param builtins.str security_type: The security type of the Virtual Machine. Possible values are `confidentialVM` and `trustedLaunch`. Changing this forces a new resource to be created.
        :param builtins.bool vtpm_enabled: Whether to enable virtual trusted platform module (vTPM) for the Virtual Machine or Virtual Machine Scale Set. Possible values are `true` and `false`. Changing this forces a new resource to be created.
...
class PoolStartTask(dict):
    ...
    def __init__(__self__, *,
                 ...
                 common_environment_properties: Optional[Mapping[str, builtins.str]] = None,
                 ...
                 task_retry_maximum: Optional[builtins.int] = None,
                 wait_for_success: Optional[builtins.bool] = None):
        """
        :param builtins.str command_line: The command line executed by the start task.
        ...
        :param Mapping[str, builtins.str] common_environment_properties: A map of strings (key,value) that represents the environment variables to set in the start task.
        ...
        :param builtins.int task_retry_maximum: The number of retry count.
        :param builtins.bool wait_for_success: A flag that indicates if the Batch pool should wait for the start task to be completed. Default to `false`.
        """
    ...
    def common_environment_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def task_retry_maximum(self) -> Optional[builtins.int]:
        """
...
class PoolStartTaskContainer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 run_options: Optional[builtins.str] = None,
                 working_directory: Optional[builtins.str] = None):
        """
        :param builtins.str image_name: The image to use to create the container in which the task will run. This is the full image reference, as would be specified to "docker pull". If no tag is provided as part of the image name, the tag ":latest" is used as a default.
        :param Sequence['PoolStartTaskContainerRegistryArgs'] registries: The `container_registries` block defined as below.
        :param builtins.str run_options: Additional options to the container create command. These additional options are supplied as arguments to the "docker create" command, in addition to those controlled by the Batch Service.
        :param builtins.str working_directory: A flag to indicate where the container task working directory is. Possible values are `TaskWorkingDirectory` and `ContainerImageDefault`.
        """
    ...
    def run_options(self) -> Optional[builtins.str]:
        """
...
class PoolStartTaskContainerRegistry(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str registry_server: The container registry URL. Changing this forces a new resource to be created.
        :param builtins.str user_assigned_identity_id: The User Assigned Identity to use for Container Registry access.
        """
        pulumi.set(__self__, "registry_server", registry_server)
        if password is not None:
            pulumi.set(__self__, "password", password)
...
class PoolStartTaskResourceFile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_assigned_identity_id: Optional[builtins.str] = None):
        """
        :param builtins.str auto_storage_container_name: The storage container name in the auto storage account.
        :param builtins.str blob_prefix: The blob prefix to use when downloading blobs from an Azure Storage container. Only the blobs whose names begin with the specified prefix will be downloaded. The property is valid only when `auto_storage_container_name` or `storage_container_url` is used. This prefix can be a partial filename or a subdirectory. If a prefix is not specified, all the files in the container will be downloaded.
        :param builtins.str file_mode: The file permission mode represented as a string in octal format (e.g. `"0644"`). This property applies only to files being downloaded to Linux compute nodes. It will be ignored if it is specified for a `resource_file` which will be downloaded to a Windows node. If this property is not specified for a Linux node, then a default value of 0770 is applied to the file.
        :param builtins.str file_path: The location on the compute node to which to download the file, relative to the task's working directory. If the `http_url` property is specified, the `file_path` is required and describes the path which the file will be downloaded to, including the filename. Otherwise, if the `auto_storage_container_name` or `storage_container_url` property is specified, `file_path` is optional and is the directory to download the files to. In the case where `file_path` is used as a directory, any directory structure already associated with the input data will be retained in full and appended to the specified filePath directory. The specified relative path cannot break out of the task's working directory (for example by using '..').
        :param builtins.str http_url: The URL of the file to download. If the URL is Azure Blob Storage, it must be readable using anonymous access; that is, the Batch service does not present any credentials when downloading the blob. There are two ways to get such a URL for a blob in Azure storage: include a Shared Access Signature (SAS) granting read permissions on the blob, or set the ACL for the blob or its container to allow public access.
        :param builtins.str storage_container_url: The URL of the blob container within Azure Blob Storage. This URL must be readable and listable using anonymous access; that is, the Batch service does not present any credentials when downloading the blob. There are two ways to get such a URL for a blob in Azure storage: include a Shared Access Signature (SAS) granting read and list permissions on the blob, or set the ACL for the blob or its container to allow public access.
        :param builtins.str user_assigned_identity_id: An identity reference from pool's user assigned managed identity list.
...
class PoolStartTaskUserIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str user_name: The username to be used by the Batch pool start task.
        """
...
class PoolStartTaskUserIdentityAutoUser(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str elevation_level: The elevation level of the user identity under which the start task runs. Possible values are `Admin` or `NonAdmin`. Defaults to `NonAdmin`.
        :param builtins.str scope: The scope of the user identity under which the start task runs. Possible values are `Task` or `Pool`. Defaults to `Task`.
        """
...
class PoolStorageImageReference(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Specifies the ID of the Custom Image which the virtual machines should be created from. Changing this forces a new resource to be created. See [official documentation](https://docs.microsoft.com/azure/batch/batch-custom-images) for more details.
...
class PoolTaskSchedulingPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str node_fill_type: Supported values are "Pack" and "Spread". "Pack" means as many tasks as possible (taskSlotsPerNode) should be assigned to each node in the pool before any tasks are assigned to the next node in the pool. "Spread" means that tasks should be assigned evenly across all nodes in the pool.
        """
    ...
    def node_fill_type(self) -> Optional[builtins.str]:
        """
...
class PoolUserAccount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str elevation_level: The elevation level of the user account. "NonAdmin" - The auto user is a standard user without elevated access. "Admin" - The auto user is a user with elevated access and operates with full Administrator permissions. The default value is nonAdmin.
        :param builtins.str name: The name of the user account.
        :param builtins.str password: The password for the user account.
...
class PoolUserAccountLinuxUserConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int gid: The user ID of the user account. The `uid` and `gid` properties must be specified together or not at all. If not specified the underlying operating system picks the uid.
        :param builtins.str ssh_private_key: The SSH private key for the user account. The private key must not be password protected. The private key is used to automatically configure asymmetric-key based authentication for SSH between nodes in a Linux pool when the pool's enableInterNodeCommunication property is true (it is ignored if enableInterNodeCommunication is false). It does this by placing the key pair into the user's .ssh directory. If not specified, password-less SSH is not configured between nodes (no modification of the user's .ssh directory is done).
        :param builtins.int uid: The group ID for the user account. The `uid` and `gid` properties must be specified together or not at all. If not specified the underlying operating system picks the gid.
        """
        if gid is not None:
...
class PoolUserAccountWindowsUserConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str login_mode: Specifies login mode for the user. The default value for VirtualMachineConfiguration pools is interactive mode and for CloudServiceConfiguration pools is batch mode. Values supported are "Batch" and "Interactive".
        """
...
class PoolWindow(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_automatic_updates: Whether automatic updates are enabled on the virtual machine. Defaults to `true`.
        """
...
class GetAccountEncryptionResult(dict):
    def __init__(__self__, *,
                 key_vault_key_id: builtins.str):
        """
        :param builtins.str key_vault_key_id: The full URL path of the Key Vault Key used to encrypt data for this Batch account.
        """
        pulumi.set(__self__, "key_vault_key_id", key_vault_key_id)
...
class GetAccountKeyVaultReferenceResult(dict):
    def __init__(__self__, *,
                 ...
                 url: builtins.str):
        """
        :param builtins.str id: The Azure identifier of the Azure KeyVault reference.
        :param builtins.str url: The HTTPS URL of the Azure KeyVault reference.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "url", url)
...
class GetPoolAutoScaleResult(dict):
    def __init__(__self__, *,
                 ...
                 formula: builtins.str):
        """
        :param builtins.str evaluation_interval: The interval to wait before evaluating if the pool needs to be scaled.
        :param builtins.str formula: The autoscale formula that needs to be used for scaling the Batch pool.
        """
        pulumi.set(__self__, "evaluation_interval", evaluation_interval)
        pulumi.set(__self__, "formula", formula)
...
class GetPoolCertificateResult(dict):
    def __init__(__self__, *,
                 ...
                 visibilities: Sequence[builtins.str]):
        """
        :param builtins.str id: The fully qualified ID of the certificate installed on the pool.
        :param builtins.str store_location: The location of the certificate store on the compute node into which the certificate is installed, either `CurrentUser` or `LocalMachine`.
        :param builtins.str store_name: The name of the certificate store on the compute node into which the certificate is installed.
        :param Sequence[builtins.str] visibilities: Which user accounts on the compute node have access to the private data of the certificate.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "store_location", store_location)
        pulumi.set(__self__, "store_name", store_name)
    ...
    @property
    @pulumi.getter
    def visibilities(self) -> Sequence[builtins.str]:
        """
...
class GetPoolContainerConfigurationResult(dict):
    def __init__(__self__, *,
                 container_image_names: Sequence[builtins.str],
                 container_registries: Sequence['outputs.GetPoolContainerConfigurationContainerRegistryResult'],
                 type: builtins.str):
        """
        :param Sequence[builtins.str] container_image_names: A list of container image names to use, as would be specified by `docker pull`.
        ...
        :param builtins.str type: The type of container configuration.
        """
        pulumi.set(__self__, "container_image_names", container_image_names)
        pulumi.set(__self__, "container_registries", container_registries)
        pulumi.set(__self__, "type", type)
    ...
    @property
    @pulumi.getter(name="containerImageNames")
    def container_image_names(self) -> Sequence[builtins.str]:
        """
...
class GetPoolContainerConfigurationContainerRegistryResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: The password for the user account.
        :param builtins.str registry_server: The container registry URL. The default is "docker.io".
        :param builtins.str user_assigned_identity_id: The reference to the user assigned identity to use to access an Azure Container Registry instead of username and password.
        :param builtins.str user_name: The user to use for authentication against the CIFS file system.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "registry_server", registry_server)
...
class GetPoolDataDiskResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str caching: The caching mode of data disks.
        :param builtins.int disk_size_gb: The initial disk size in GB when creating new data disk.
        :param builtins.int lun: The lun is used to uniquely identify each data disk.
        :param builtins.str storage_account_type: The storage account type to be used for the data disk.
        """
        pulumi.set(__self__, "caching", caching)
        pulumi.set(__self__, "disk_size_gb", disk_size_gb)
        pulumi.set(__self__, "lun", lun)
...
class GetPoolExtensionResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 protected_settings: builtins.str,
                 provision_after_extensions: Sequence[builtins.str],
                 publisher: builtins.str,
        ...
        :param builtins.bool auto_upgrade_minor_version: Indicates whether the extension should use a newer minor version if one is available at deployment time. Once deployed, however, the extension will not upgrade minor versions unless redeployed, even with this property set to true.
        :param builtins.str name: The name of the user account.
        :param builtins.str protected_settings: The extension can contain either `protected_settings` or `provision_after_extensions` or no protected settings at all.
        :param Sequence[builtins.str] provision_after_extensions: The collection of extension names. Collection of extension names after which this extension needs to be provisioned.
        :param builtins.str publisher: The name of the extension handler publisher.The name of the extension handler publisher.
        :param builtins.str settings_json: JSON formatted public settings for the extension.
        :param builtins.str type: The type of container configuration.
        :param builtins.str type_handler_version: The version of script handler.
        """
        pulumi.set(__self__, "auto_upgrade_minor_version", auto_upgrade_minor_version)
    ...
    @property
    @pulumi.getter(name="autoUpgradeMinorVersion")
    def auto_upgrade_minor_version(self) -> builtins.bool:
        """
        Indicates whether the extension should use a newer minor version if one is available at deployment time. Once deployed, however, the extension will not upgrade minor versions unless redeployed, even with this property set to true.
        """
        return pulumi.get(self, "auto_upgrade_minor_version")
    ...
    @property
    @pulumi.getter(name="provisionAfterExtensions")
    def provision_after_extensions(self) -> Sequence[builtins.str]:
        """
        The collection of extension names. Collection of extension names after which this extension needs to be provisioned.
        """
        return pulumi.get(self, "provision_after_extensions")
...
class GetPoolFixedScaleResult(dict):
    def __init__(__self__, *,
                 resize_timeout: builtins.str,
                 target_dedicated_nodes: builtins.int,
                 target_low_priority_nodes: builtins.int):
        """
        :param builtins.str resize_timeout: The timeout for resize operations.
        :param builtins.int target_dedicated_nodes: The number of nodes in the Batch pool.
        :param builtins.int target_low_priority_nodes: The number of low priority nodes in the Batch pool.
        """
        pulumi.set(__self__, "resize_timeout", resize_timeout)
        pulumi.set(__self__, "target_dedicated_nodes", target_dedicated_nodes)
        pulumi.set(__self__, "target_low_priority_nodes", target_low_priority_nodes)
    ...
    @property
    @pulumi.getter(name="targetDedicatedNodes")
    def target_dedicated_nodes(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="targetLowPriorityNodes")
    def target_low_priority_nodes(self) -> builtins.int:
        """
...
class GetPoolMountAzureBlobFileSystemResult(dict):
    def __init__(__self__, *,
                 account_key: builtins.str,
                 account_name: builtins.str,
                 blobfuse_options: builtins.str,
                 container_name: builtins.str,
                 identity_id: builtins.str,
                 relative_mount_path: builtins.str,
                 sas_key: builtins.str):
        """
        :param builtins.str account_key: The Azure Storage Account key.
        :param builtins.str account_name: The Azure Storage Account name.
        :param builtins.str blobfuse_options: Additional command line options to pass to the mount command. These are 'net use' options in Windows and 'mount' options in Linux.
...
class GetPoolNetworkConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 dynamic_vnet_assignment_scope: builtins.str,
                 endpoint_configurations: Sequence['outputs.GetPoolNetworkConfigurationEndpointConfigurationResult'],
                 public_address_provisioning_type: builtins.str,
                 public_ips: Sequence[builtins.str],
                 subnet_id: builtins.str):
        """
        :param builtins.str dynamic_vnet_assignment_scope: The scope of dynamic vnet assignment.
        ...
        :param builtins.str public_address_provisioning_type: Type of public IP address provisioning.
        :param Sequence[builtins.str] public_ips: A list of public IP ids that will be allocated to nodes.
        :param builtins.str subnet_id: The ARM resource identifier of the virtual network subnet which the compute nodes of the pool are joined too.
        """
        pulumi.set(__self__, "accelerated_networking_enabled", accelerated_networking_enabled)
        pulumi.set(__self__, "dynamic_vnet_assignment_scope", dynamic_vnet_assignment_scope)
        pulumi.set(__self__, "endpoint_configurations", endpoint_configurations)
...
class GetPoolNetworkConfigurationEndpointConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 protocol: builtins.str):
        """
        :param builtins.int backend_port: The port number on the compute node.
        :param builtins.str frontend_port_range: The range of external ports that are used to provide inbound access to the backendPort on the individual compute nodes in the format of `1000-1100`.
        :param builtins.str name: The name of the user account.
...
class GetPoolNetworkConfigurationEndpointConfigurationNetworkSecurityGroupRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 priority: builtins.int,
                 source_address_prefix: builtins.str,
                 source_port_ranges: Sequence[builtins.str]):
        """
        :param builtins.str access: The action that should be taken for a specified IP address, subnet range or tag.
        :param builtins.int priority: The priority for this rule.
        :param builtins.str source_address_prefix: The source address prefix or tag to match for the rule.
        :param Sequence[builtins.str] source_port_ranges: The source port ranges to match for the rule.
        """
        pulumi.set(__self__, "access", access)
        pulumi.set(__self__, "priority", priority)
        pulumi.set(__self__, "source_address_prefix", source_address_prefix)
...
class GetPoolNodePlacementResult(dict):
    def __init__(__self__, *,
                 policy: builtins.str):
        """
        :param builtins.str policy: The placement policy for allocating nodes in the pool.
        """
        pulumi.set(__self__, "policy", policy)
...
class GetPoolStartTaskResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool wait_for_success: A flag that indicates if the Batch pool should wait for the start task to be completed.
        :param Mapping[str, builtins.str] common_environment_properties: A map of strings (key,value) that represents the environment variables to set in the start task.
        """
        pulumi.set(__self__, "command_line", command_line)
        pulumi.set(__self__, "containers", containers)
    ...
    @property
    @pulumi.getter(name="taskRetryMaximum")
    def task_retry_maximum(self) -> builtins.int:
        """
        The number of retry count
        """
        return pulumi.get(self, "task_retry_maximum")
    ...
    @property
    @pulumi.getter(name="waitForSuccess")
    def wait_for_success(self) -> builtins.bool:
        """
...
class GetPoolStartTaskContainerResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str image_name: The image to use to create the container in which the task will run.
        ...
        :param builtins.str run_options: Additional options to the container create command.
        :param builtins.str working_directory: A flag to indicate where the container task working directory is.
        """
        pulumi.set(__self__, "image_name", image_name)
        pulumi.set(__self__, "registries", registries)
        pulumi.set(__self__, "run_options", run_options)
...
class GetPoolStartTaskResourceFileResult(dict):
    def __init__(__self__, *,
                 auto_storage_container_name: builtins.str,
                 blob_prefix: builtins.str,
                 file_mode: builtins.str,
                 file_path: builtins.str,
                 http_url: builtins.str,
                 storage_container_url: builtins.str,
                 user_assigned_identity_id: builtins.str):
        """
        :param builtins.str auto_storage_container_name: The storage container name in the auto storage account.
        :param builtins.str blob_prefix: The blob prefix used when downloading blobs from an Azure Storage container.
        :param builtins.str file_mode: The file permission mode attribute represented as a string in octal format (e.g. `"0644"`).
        :param builtins.str file_path: The location on the compute node to which to download the file, relative to the task's working directory. If the `http_url` property is specified, the `file_path` is required and describes the path which the file will be downloaded to, including the filename. Otherwise, if the `auto_storage_container_name` or `storage_container_url` property is specified.
        :param builtins.str http_url: The URL of the file to download. If the URL is Azure Blob Storage, it must be readable using anonymous access.
        :param builtins.str storage_container_url: The URL of the blob container within Azure Blob Storage.
        :param builtins.str user_assigned_identity_id: The reference to the user assigned identity to use to access an Azure Container Registry instead of username and password.
        """
        pulumi.set(__self__, "auto_storage_container_name", auto_storage_container_name)
        pulumi.set(__self__, "blob_prefix", blob_prefix)
...
class GetPoolStartTaskUserIdentityAutoUserResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str elevation_level: The elevation level of the user account. "NonAdmin" - The auto user is a standard user without elevated access. "Admin" - The auto user is a user with elevated access and operates with full Administrator permissions. The default value is nonAdmin.
        :param builtins.str scope: The scope of the user identity under which the start task runs.
        """
        pulumi.set(__self__, "elevation_level", elevation_level)
        pulumi.set(__self__, "scope", scope)
...
class GetPoolUserAccountLinuxUserConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 uid: builtins.int):
        """
        :param builtins.int gid: The user ID of the user account.
        :param builtins.str ssh_private_key: The SSH private key for the user account.
        :param builtins.int uid: The group ID for the user account.
        """
        pulumi.set(__self__, "gid", gid)
        pulumi.set(__self__, "ssh_private_key", ssh_private_key)
        pulumi.set(__self__, "uid", uid)
...
class GetPoolUserAccountWindowsUserConfigurationResult(dict):
    def __init__(__self__, *,
                 login_mode: builtins.str):
        """
        :param builtins.str login_mode: Specifies login mode for the user.
        """
        pulumi.set(__self__, "login_mode", login_mode)
...
class GetPoolWindowResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_automatic_updates: Whether automatic updates are enabled on the virtual machine.
        """
        pulumi.set(__self__, "enable_automatic_updates", enable_automatic_updates)
