...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Batch Job. Changing this forces a new Batch Job to be created.
        :param pulumi.Input[_builtins.int] priority: The priority of this Batch Job, possible values can range from -1000 (lowest) to 1000 (highest). Defaults to `0`.
        :param pulumi.Input[_builtins.int] task_retry_maximum: The number of retries to each Batch Task belongs to this Batch Job. If this is set to `0`, the Batch service does not retry Tasks. If this is set to `-1`, the Batch service retries Batch Tasks without limit.
        """
    ...
    def batch_pool_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def batch_pool_id(self, value: pulumi.Input[_builtins.str]):
...
class Job(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="batchPoolId")
    def batch_pool_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the Batch Pool. Changing this forces a new Batch Job to be created.
        """
        return pulumi.get(self, "batch_pool_id")
    ...
    @_builtins.property
    @pulumi.getter(name="commonEnvironmentProperties")
    def common_environment_properties(self) -> pulumi.Output[Optional[Mapping[str, _builtins.str]]]:
        """
        Specifies a map of common environment settings applied to this Batch Job. Changing this forces a new Batch Job to be created.
        """
        return pulumi.get(self, "common_environment_properties")
    ...
    @_builtins.property
    @pulumi.getter(name="taskRetryMaximum")
    def task_retry_maximum(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The number of retries to each Batch Task belongs to this Batch Job. If this is set to `0`, the Batch service does not retry Tasks. If this is set to `-1`, the Batch service retries Batch Tasks without limit.
        """
        return pulumi.get(self, "task_retry_maximum")
