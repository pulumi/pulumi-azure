...
class PoolArgs:
    def __init__(__self__, *,
                 ...
                 inter_node_communication: Optional[pulumi.Input[builtins.str]] = None,
                 license_type: Optional[pulumi.Input[builtins.str]] = None,
                 max_tasks_per_node: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 os_disk_placement: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 stop_pending_resize_operation: Optional[pulumi.Input[builtins.bool]] = None,
                 target_node_communication_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] account_name: Specifies the name of the Batch account in which the pool will be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] node_agent_sku_id: Specifies the SKU of the node agents that will be created in the Batch pool. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Batch pool. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] vm_size: Specifies the size of the VM created in the Batch pool. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] display_name: Specifies the display name of the Batch pool. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] inter_node_communication: Whether the pool permits direct communication between nodes. This imposes restrictions on which nodes can be assigned to the pool. Enabling this value can reduce the chance of the requested number of nodes to be allocated in the pool. Values allowed are `Disabled` and `Enabled`. Defaults to `Enabled`.
        :param pulumi.Input[builtins.str] license_type: The type of on-premises license to be used when deploying the operating system. This only applies to images that contain the Windows operating system, and should only be used when you hold valid on-premises licenses for the nodes which will be deployed. If omitted, no on-premises licensing discount is applied. Values are: "Windows_Server" - The on-premises license is for Windows Server. "Windows_Client" - The on-premises license is for Windows Client.
        :param pulumi.Input[builtins.int] max_tasks_per_node: Specifies the maximum number of tasks that can run concurrently on a single compute node in the pool. Defaults to `1`. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: A map of custom batch pool metadata.
        :param pulumi.Input[Sequence[pulumi.Input['PoolMountArgs']]] mounts: A `mount` block defined as below.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Batch pool. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] stop_pending_resize_operation: Whether to stop if there is a pending resize operation on this pool.
        :param pulumi.Input[builtins.str] target_node_communication_mode: The desired node communication mode for the pool. Possible values are `Classic`, `Default` and `Simplified`.
    ...
    def inter_node_communication(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inter_node_communication(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def max_tasks_per_node(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_tasks_per_node(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def os_disk_placement(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def os_disk_placement(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stop_pending_resize_operation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def stop_pending_resize_operation(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "stop_pending_resize_operation", value)

    @property
    @pulumi.getter(name="targetNodeCommunicationMode")
    def target_node_communication_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_node_communication_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PoolState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_configuration: Optional[pulumi.Input['PoolNetworkConfigurationArgs']] = None,
                 node_agent_sku_id: Optional[pulumi.Input[builtins.str]] = None,
                 node_placements: Optional[pulumi.Input[Sequence[pulumi.Input['PoolNodePlacementArgs']]]] = None,
                 os_disk_placement: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="nodeAgentSkuId")
    def node_agent_sku_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the SKU of the node agents that will be created in the Batch pool. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "node_agent_sku_id")
    ...
    @node_agent_sku_id.setter
    def node_agent_sku_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_agent_sku_id", value)
...
class Pool(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="maxTasksPerNode")
    def max_tasks_per_node(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the maximum number of tasks that can run concurrently on a single compute node in the pool. Defaults to `1`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "max_tasks_per_node")
    ...
    @property
    @pulumi.getter(name="nodeAgentSkuId")
    def node_agent_sku_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the SKU of the node agents that will be created in the Batch pool. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "node_agent_sku_id")
    ...
    @property
    @pulumi.getter(name="osDiskPlacement")
    def os_disk_placement(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the ephemeral disk placement for operating system disk for all VMs in the pool. This property can be used by user in the request to choose which location the operating system should be in. e.g., cache disk space for Ephemeral OS disk provisioning. For more information on Ephemeral OS disk size requirements, please refer to Ephemeral OS disk size requirements for Windows VMs at <https://docs.microsoft.com/en-us/azure/virtual-machines/windows/ephemeral-os-disks#size-requirements> and Linux VMs at <https://docs.microsoft.com/en-us/azure/virtual-machines/linux/ephemeral-os-disks#size-requirements>. The only possible value is `CacheDisk`.
        """
        return pulumi.get(self, "os_disk_placement")
    ...
    @property
    @pulumi.getter(name="stopPendingResizeOperation")
    def stop_pending_resize_operation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to stop if there is a pending resize operation on this pool.
        """
        return pulumi.get(self, "stop_pending_resize_operation")
