...
class CertificateArgs:
    def __init__(__self__, *,
                 ...
                 thumbprint_algorithm: pulumi.Input[builtins.str],
                 password: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Certificate resource.
        :param pulumi.Input[builtins.str] account_name: Specifies the name of the Batch account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] certificate: The base64-encoded contents of the certificate.
        :param pulumi.Input[builtins.str] format: The format of the certificate. Possible values are `Cer` or `Pfx`.
        ...
        :param pulumi.Input[builtins.str] thumbprint: The thumbprint of the certificate. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] thumbprint_algorithm: The algorithm of the certificate thumbprint. At this time the only supported value is `SHA1`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] password: The password to access the certificate's private key. This can only be specified when `format` is `Pfx`.
        """
    ...
    def thumbprint_algorithm(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def thumbprint_algorithm(self, value: pulumi.Input[builtins.str]):
...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 public_data: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 thumbprint: Optional[pulumi.Input[builtins.str]] = None,
                 thumbprint_algorithm: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Certificate resources.
        :param pulumi.Input[builtins.str] account_name: Specifies the name of the Batch account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] certificate: The base64-encoded contents of the certificate.
        :param pulumi.Input[builtins.str] format: The format of the certificate. Possible values are `Cer` or `Pfx`.
        :param pulumi.Input[builtins.str] name: The generated name of the certificate.
        :param pulumi.Input[builtins.str] password: The password to access the certificate's private key. This can only be specified when `format` is `Pfx`.
        :param pulumi.Input[builtins.str] public_data: The public key of the certificate.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Batch account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] thumbprint: The thumbprint of the certificate. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] thumbprint_algorithm: The algorithm of the certificate thumbprint. At this time the only supported value is `SHA1`. Changing this forces a new resource to be created.
        """
    ...
    def public_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @public_data.setter
    def public_data(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="thumbprintAlgorithm")
    def thumbprint_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The algorithm of the certificate thumbprint. At this time the only supported value is `SHA1`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "thumbprint_algorithm")
    ...
    @thumbprint_algorithm.setter
    def thumbprint_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "thumbprint_algorithm", value)


@pulumi.type_token("azure:batch/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            thumbprint: Optional[pulumi.Input[builtins.str]] = None,
            thumbprint_algorithm: Optional[pulumi.Input[builtins.str]] = None) -> 'Certificate':
        """
    ...
    @property
    @pulumi.getter(name="publicData")
    def public_data(self) -> pulumi.Output[builtins.str]:
        """
        The public key of the certificate.
        """
        return pulumi.get(self, "public_data")
    ...
    @property
    @pulumi.getter(name="thumbprintAlgorithm")
    def thumbprint_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        The algorithm of the certificate thumbprint. At this time the only supported value is `SHA1`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "thumbprint_algorithm")
