...
class GremlinDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 autoscale_settings: pulumi.Input[Optional['GremlinDatabaseAutoscaleSettingsArgs']] = None,
        ...
        :param pulumi.Input[_builtins.int] throughput: The throughput of the Gremlin database (RU/s). Must be set in increments of `100`. The minimum value is `400`. This must be set upon database creation otherwise it cannot be updated without a manual resource destroy-apply.
    ...
    def autoscale_settings(self) -> pulumi.Input[Optional['GremlinDatabaseAutoscaleSettingsArgs']]:
        """
    ...
    def autoscale_settings(self, value: pulumi.Input[Optional['GremlinDatabaseAutoscaleSettingsArgs']]):
