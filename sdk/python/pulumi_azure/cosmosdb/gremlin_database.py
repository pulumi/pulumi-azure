...
class GremlinDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: The name of the CosmosDB Account to create the Gremlin Database within. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Cosmos DB Gremlin Database is created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Cosmos DB Gremlin Database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] throughput: The throughput of the Gremlin database (RU/s). Must be set in increments of `100`. The minimum value is `400`. This must be set upon database creation otherwise it cannot be updated without a manual resource destroy-apply.
...
@pulumi.type_token("azure:cosmosdb/gremlinDatabase:GremlinDatabase")
class GremlinDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_name: Optional[pulumi.Input[builtins.str]] = None,
                 autoscale_settings: Optional[pulumi.Input[Union['GremlinDatabaseAutoscaleSettingsArgs', 'GremlinDatabaseAutoscaleSettingsArgsDict']]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 throughput: Optional[pulumi.Input[builtins.int]] = None,
                 __props__=None):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            throughput: Optional[pulumi.Input[builtins.int]] = None) -> 'GremlinDatabase':
        """
