...
def get_sql_role_definition(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str account_name: The name of the Cosmos DB Account.
    :param builtins.str resource_group_name: The name of the Resource Group in which the Cosmos DB SQL Role Definition is created.
    :param builtins.str role_definition_id: The GUID as the name of the Cosmos DB SQL Role Definition.
    """
    __args__ = dict()
...
def get_sql_role_definition_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
