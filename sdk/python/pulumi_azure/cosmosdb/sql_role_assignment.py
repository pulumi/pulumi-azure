...
class SqlRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role_definition_id: The resource ID of the Cosmos DB SQL Role Definition.
        :param pulumi.Input[_builtins.str] scope: The data plane resource path for which access is being granted through this Cosmos DB SQL Role Assignment. Changing this forces a new resource to be created.
...
class SqlRoleAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
            role_definition_id: Optional[pulumi.Input[_builtins.str]] = None,
            scope: Optional[pulumi.Input[_builtins.str]] = None) -> 'SqlRoleAssignment':
        """
