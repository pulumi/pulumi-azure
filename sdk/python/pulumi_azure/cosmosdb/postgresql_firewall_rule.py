...
class PostgresqlFirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] end_ip_address: The end IP address of the Azure Cosmos DB for PostgreSQL Firewall Rule.
        :param pulumi.Input[builtins.str] start_ip_address: The start IP address of the Azure Cosmos DB for PostgreSQL Firewall Rule.
        :param pulumi.Input[builtins.str] name: The name which should be used for the Azure Cosmos DB for PostgreSQL Firewall Rule. Changing this forces a new resource to be created.
        """
...
@pulumi.type_token("azure:cosmosdb/postgresqlFirewallRule:PostgresqlFirewallRule")
class PostgresqlFirewallRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            end_ip_address: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            start_ip_address: Optional[pulumi.Input[builtins.str]] = None) -> 'PostgresqlFirewallRule':
        """
