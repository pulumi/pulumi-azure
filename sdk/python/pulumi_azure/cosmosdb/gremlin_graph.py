...
class GremlinGraphArgs:
    def __init__(__self__, *,
                 ...
                 partition_key_path: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] account_name: The name of the CosmosDB Account to create the Gremlin Graph within. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] database_name: The name of the Cosmos DB Graph Database in which the Cosmos DB Gremlin Graph is created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.int] analytical_storage_ttl: The time to live of Analytical Storage for this Cosmos DB Gremlin Graph. Possible values are between `-1` to `2147483647` not including `0`. If present and the value is set to `-1`, it means never expire.
        ...
        :param pulumi.Input[builtins.int] default_ttl: The default time to live (TTL) of the Gremlin graph. If the value is missing or set to "-1", items don’t expire.
    ...
    def partition_key_path(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def partition_key_path(self, value: pulumi.Input[builtins.str]):
...
class GremlinGraph(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="partitionKeyPath")
    def partition_key_path(self) -> pulumi.Output[builtins.str]:
        """
        Define a partition key. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "partition_key_path")
