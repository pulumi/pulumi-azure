...
def get_mongo_database(account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Cosmos DB Mongo Database exists.
    """
    __args__ = dict()
