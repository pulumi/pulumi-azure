...
class TableArgs:
    def __init__(__self__, *,
                 ...
                 autoscale_settings: pulumi.Input[Optional['TableAutoscaleSettingsArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which the Cosmos DB Table is created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.int] throughput: The throughput of Table (RU/s). Must be set in increments of `100`. The minimum value is `400`. This must be set upon database creation otherwise it cannot be updated without a manual resource destroy-apply.
    ...
    def autoscale_settings(self) -> pulumi.Input[Optional['TableAutoscaleSettingsArgs']]:
        """
    ...
    def autoscale_settings(self, value: pulumi.Input[Optional['TableAutoscaleSettingsArgs']]):
