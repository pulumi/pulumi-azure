...
class Table(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if autoscale_settings is not None and not isinstance(autoscale_settings, TableAutoscaleSettingsArgs):
                autoscale_settings = autoscale_settings or {}
                def _setter(key, value):
                    autoscale_settings[key] = value
                TableAutoscaleSettingsArgs._configure(_setter, **autoscale_settings)
