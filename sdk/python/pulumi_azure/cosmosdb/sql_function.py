...
class SqlFunctionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_id: The id of the Cosmos DB SQL Container to create the SQL User Defined Function within. Changing this forces a new SQL User Defined Function to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this SQL User Defined Function. Changing this forces a new SQL User Defined Function to be created.
        """
...
class SqlFunction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            body: Optional[pulumi.Input[builtins.str]] = None,
            container_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlFunction':
        """
