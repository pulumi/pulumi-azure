...
class SqlDedicatedGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cosmosdb_account_id: The resource ID of the CosmosDB Account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] instance_count: The instance count for the CosmosDB SQL Dedicated Gateway. Possible value is between `1` and `5`.
        :param pulumi.Input[builtins.str] instance_size: The instance size for the CosmosDB SQL Dedicated Gateway. Changing this forces a new resource to be created. Possible values are `Cosmos.D4s`, `Cosmos.D8s` and `Cosmos.D16s`.
        """
...
class SqlDedicatedGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cosmosdb_account_id: Optional[pulumi.Input[builtins.str]] = None,
            instance_count: Optional[pulumi.Input[builtins.int]] = None,
            instance_size: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlDedicatedGateway':
        """
    ...
    @property
    @pulumi.getter(name="instanceSize")
    def instance_size(self) -> pulumi.Output[builtins.str]:
        """
        The instance size for the CosmosDB SQL Dedicated Gateway. Changing this forces a new resource to be created. Possible values are `Cosmos.D4s`, `Cosmos.D8s` and `Cosmos.D16s`.
        """
        return pulumi.get(self, "instance_size")
