...
class MongoDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Cosmos DB Mongo Database. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.int] throughput: The throughput of the MongoDB collection (RU/s). Must be set in increments of `100`. The minimum value is `400`. This must be set upon database creation otherwise it cannot be updated without a manual resource destroy-apply.
...
class MongoDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_name: pulumi.Input[Optional[_builtins.str]] = None,
                 autoscale_settings: pulumi.Input[Optional[Union['MongoDatabaseAutoscaleSettingsArgs', 'MongoDatabaseAutoscaleSettingsArgsDict', 'outputs.MongoDatabaseAutoscaleSettings']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 throughput: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        ...
        * `Microsoft.DocumentDB` - 2024-08-15
        ...
        :param pulumi.Input[_builtins.str] account_name: The name of the Cosmos DB Mongo Database to create the table within. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['MongoDatabaseAutoscaleSettingsArgs', 'MongoDatabaseAutoscaleSettingsArgsDict', 'outputs.MongoDatabaseAutoscaleSettings']] autoscale_settings: An `autoscale_settings` block as defined below. This must be set upon database creation otherwise it cannot be updated without a manual destroy-apply.
