...
class CassandraTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CassandraTableAutoscaleSettingsArgs'] autoscale_settings: An `autoscale_settings` block as defined below. This must be set upon database creation otherwise it cannot be updated without a manual terraform destroy-apply.
    ...
    def cassandra_keyspace_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def cassandra_keyspace_id(self, value: pulumi.Input[_builtins.str]):
...
class CassandraTable(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="cassandraKeyspaceId")
    def cassandra_keyspace_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the Cosmos DB Cassandra Keyspace to create the table within. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "cassandra_keyspace_id")
