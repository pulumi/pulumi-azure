...
class CassandraClusterArgs:
    def __init__(__self__, *,
                 default_admin_password: pulumi.Input[builtins.str],
                 ...
                 client_certificate_pems: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 external_gossip_certificate_pems: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 external_seed_node_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] default_admin_password: The initial admin password for this Cassandra Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] delegated_management_subnet_id: The ID of the delegated management subnet for this Cassandra Cluster. Changing this forces a new Cassandra Cluster to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Cassandra Cluster should exist. Changing this forces a new Cassandra Cluster to be created.
        :param pulumi.Input[builtins.str] authentication_method: The authentication method that is used to authenticate clients. Possible values are `None` and `Cassandra`. Defaults to `Cassandra`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_certificate_pems: A list of TLS certificates that is used to authorize client connecting to the Cassandra Cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_gossip_certificate_pems: A list of TLS certificates that is used to authorize gossip from unmanaged Cassandra Data Center.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_seed_node_ip_addresses: A list of IP Addresses of the seed nodes in unmanaged the Cassandra Data Center which will be added to the seed node lists of all managed nodes.
        :param pulumi.Input[builtins.int] hours_between_backups: The number of hours to wait between taking a backup of the Cassandra Cluster. Defaults to `24`.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Cassandra Cluster should exist. Changing this forces a new Cassandra Cluster to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Cassandra Cluster. Changing this forces a new Cassandra Cluster to be created.
        :param pulumi.Input[builtins.bool] repair_enabled: Is the automatic repair enabled on the Cassandra Cluster? Defaults to `true`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags assigned to the resource.
        :param pulumi.Input[builtins.str] version: The version of Cassandra what the Cluster converges to run. Possible values are `3.11` and `4.0`. Defaults to `3.11`. Changing this forces a new Cassandra Cluster to be created.
        """
    ...
    def default_admin_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_admin_password(self, value: pulumi.Input[builtins.str]):
    ...
    def client_certificate_pems(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def client_certificate_pems(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "client_certificate_pems", value)

    @property
    @pulumi.getter(name="externalGossipCertificatePems")
    def external_gossip_certificate_pems(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def external_gossip_certificate_pems(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "external_gossip_certificate_pems", value)

    @property
    @pulumi.getter(name="externalSeedNodeIpAddresses")
    def external_seed_node_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def external_seed_node_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _CassandraClusterState:
    def __init__(__self__, *,
                 authentication_method: Optional[pulumi.Input[builtins.str]] = None,
                 client_certificate_pems: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 default_admin_password: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="defaultAdminPassword")
    def default_admin_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The initial admin password for this Cassandra Cluster. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "default_admin_password")
    ...
    @default_admin_password.setter
    def default_admin_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_admin_password", value)
...
class CassandraCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'CassandraCluster':
        """
    ...
    @property
    @pulumi.getter(name="authenticationMethod")
    def authentication_method(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The authentication method that is used to authenticate clients. Possible values are `None` and `Cassandra`. Defaults to `Cassandra`.
        """
        return pulumi.get(self, "authentication_method")
    ...
    @property
    @pulumi.getter(name="clientCertificatePems")
    def client_certificate_pems(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of TLS certificates that is used to authorize client connecting to the Cassandra Cluster.
        """
        return pulumi.get(self, "client_certificate_pems")
    ...
    @property
    @pulumi.getter(name="defaultAdminPassword")
    def default_admin_password(self) -> pulumi.Output[builtins.str]:
        """
        The initial admin password for this Cassandra Cluster. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "default_admin_password")
    ...
    @property
    @pulumi.getter(name="externalGossipCertificatePems")
    def external_gossip_certificate_pems(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of TLS certificates that is used to authorize gossip from unmanaged Cassandra Data Center.
        """
        return pulumi.get(self, "external_gossip_certificate_pems")
    ...
    @property
    @pulumi.getter(name="externalSeedNodeIpAddresses")
    def external_seed_node_ip_addresses(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of IP Addresses of the seed nodes in unmanaged the Cassandra Data Center which will be added to the seed node lists of all managed nodes.
        """
        return pulumi.get(self, "external_seed_node_ip_addresses")
    ...
    @property
    @pulumi.getter(name="hoursBetweenBackups")
    def hours_between_backups(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of hours to wait between taking a backup of the Cassandra Cluster. Defaults to `24`.
    ...
    @property
    @pulumi.getter(name="repairEnabled")
    def repair_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is the automatic repair enabled on the Cassandra Cluster? Defaults to `true`.
        """
        return pulumi.get(self, "repair_enabled")
