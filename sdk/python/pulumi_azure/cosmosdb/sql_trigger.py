...
class SqlTriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_id: The id of the Cosmos DB SQL Container to create the SQL Trigger within. Changing this forces a new SQL Trigger to be created.
        :param pulumi.Input[builtins.str] operation: The operation the trigger is associated with. Possible values are `All`, `Create`, `Update`, `Delete` and `Replace`.
        :param pulumi.Input[builtins.str] type: Type of the Trigger. Possible values are `Pre` and `Post`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this SQL Trigger. Changing this forces a new SQL Trigger to be created.
        """
...
class SqlTrigger(pulumi.CustomResource):
    ...
    pulumi_type = "azure:cosmosdb/sqlTrigger:SqlTrigger"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            operation: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlTrigger':
        """
