...
def get_sql_database(account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str account_name: The name of the Cosmos DB SQL Database to create the table within.
    :param builtins.str name: Specifies the name of the Cosmos DB SQL Database.
    :param builtins.str resource_group_name: The name of the resource group in which the Cosmos DB SQL Database is created.
    """
    __args__ = dict()
...
def get_sql_database_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
