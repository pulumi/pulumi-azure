...
class MongoClusterArgs:
    def __init__(__self__, *,
                 ...
                 administrator_username: Optional[pulumi.Input[builtins.str]] = None,
                 compute_tier: Optional[pulumi.Input[builtins.str]] = None,
                 create_mode: Optional[pulumi.Input[builtins.str]] = None,
                 high_availability_mode: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 preview_features: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the MongoDB Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] administrator_password: The Password associated with the `administrator_username` for the MongoDB Cluster.
        :param pulumi.Input[builtins.str] administrator_username: The administrator username of the MongoDB Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] compute_tier: The compute tier to assign to the MongoDB Cluster. Possible values are `Free`, `M10`, `M20`, `M25`, `M30`, `M40`, `M50`, `M60`, `M80`, and `M200`.
        :param pulumi.Input[builtins.str] create_mode: The creation mode for the MongoDB Cluster. Possibles values are `Default` and `GeoReplica`. Defaults to `Default`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] high_availability_mode: The high availability mode for the MongoDB Cluster. Possibles values are `Disabled` and `ZoneRedundantPreferred`.
        :param pulumi.Input[builtins.str] location: The supported Azure location where the MongoDB Cluster exists. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] preview_features: The preview features that can be enabled on the MongoDB Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] public_network_access: The Public Network Access setting for the MongoDB Cluster. Possibles values are `Disabled` and `Enabled`. Defaults to `Enabled`.
        :param pulumi.Input[builtins.int] shard_count: The Number of shards to provision on the MongoDB Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_location: The location of the source MongoDB Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_server_id: The ID of the replication source MongoDB Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] storage_size_in_gb: The size of the data disk space for the MongoDB Cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the MongoDB Cluster.
        :param pulumi.Input[builtins.str] version: The version for the MongoDB Cluster. Possibles values are `5.0`, `6.0` and `7.0`.
        """
    ...
    def administrator_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def administrator_username(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "administrator_username", value)

    @property
    @pulumi.getter(name="computeTier")
    def compute_tier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @compute_tier.setter
    def compute_tier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def high_availability_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def high_availability_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def preview_features(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def preview_features(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class MongoCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_size_in_gb: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'MongoCluster':
        """
    ...
    @property
    @pulumi.getter(name="administratorUsername")
    def administrator_username(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The administrator username of the MongoDB Cluster. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "administrator_username")
    ...
    @property
    @pulumi.getter(name="computeTier")
    def compute_tier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The compute tier to assign to the MongoDB Cluster. Possible values are `Free`, `M10`, `M20`, `M25`, `M30`, `M40`, `M50`, `M60`, `M80`, and `M200`.
        """
        return pulumi.get(self, "compute_tier")
    ...
    @property
    @pulumi.getter(name="highAvailabilityMode")
    def high_availability_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The high availability mode for the MongoDB Cluster. Possibles values are `Disabled` and `ZoneRedundantPreferred`.
        """
        return pulumi.get(self, "high_availability_mode")
    ...
    @property
    @pulumi.getter(name="previewFeatures")
    def preview_features(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The preview features that can be enabled on the MongoDB Cluster. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "preview_features")
