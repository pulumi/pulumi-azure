...
class PostgresqlNodeConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_postgresql_cluster = azure.cosmosdb.postgresql_cluster.PostgresqlCluster("example",
            name=examplecluster,
            ...
            node_vcores=2)
        example_postgresql_node_configuration = azure.cosmosdb.postgresql_node_configuration.PostgresqlNodeConfiguration("example",
            name=array_nulls,
