...
class SqlContainerArgs:
    def __init__(__self__, *,
                 ...
                 partition_key_paths: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 partition_key_kind: Optional[pulumi.Input[builtins.str]] = None,
                 partition_key_version: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Cosmos DB SQL Container. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] partition_key_kind: Define a partition key kind. Possible values are `Hash` and `MultiHash`. Defaults to `Hash`. Changing this forces a new resource to be created.
    ...
    def partition_key_paths(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def partition_key_paths(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def partition_key_kind(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def partition_key_kind(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "partition_key_kind", value)

    @property
    @pulumi.getter(name="partitionKeyVersion")
    def partition_key_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def partition_key_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _SqlContainerState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 partition_key_kind: Optional[pulumi.Input[builtins.str]] = None,
                 partition_key_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 partition_key_version: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="partitionKeyPaths")
    def partition_key_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of partition key paths. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "partition_key_paths")
    ...
    @partition_key_paths.setter
    def partition_key_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "partition_key_paths", value)
...
class SqlContainer(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="partitionKeyKind")
    def partition_key_kind(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Define a partition key kind. Possible values are `Hash` and `MultiHash`. Defaults to `Hash`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "partition_key_kind")
    ...
    @property
    @pulumi.getter(name="partitionKeyPaths")
    def partition_key_paths(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of partition key paths. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "partition_key_paths")
    ...
    @property
    @pulumi.getter(name="partitionKeyVersion")
    def partition_key_version(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Define a partition key version. Possible values are `1`and `2`. This should be set to `2` in order to use large partition keys.
