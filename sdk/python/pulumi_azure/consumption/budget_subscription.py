...
class BudgetSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subscription_id: The ID of the Subscription for which to create a Consumption Budget. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] etag: (Optional) The ETag of the Subscription Consumption Budget.
        :param pulumi.Input['BudgetSubscriptionFilterArgs'] filter: A `filter` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Subscription Consumption Budget. Changing this forces a new resource to be created.
