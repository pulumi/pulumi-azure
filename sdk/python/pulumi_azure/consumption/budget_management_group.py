...
class BudgetManagementGroupArgs:
    def __init__(__self__, *,
                 amount: pulumi.Input[builtins.float],
        ...
        :param pulumi.Input[builtins.str] management_group_id: The ID of the Management Group. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] etag: (Optional) The ETag of the Management Group Consumption Budget.
        :param pulumi.Input['BudgetManagementGroupFilterArgs'] filter: A `filter` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Management Group Consumption Budget. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] time_grain: The time covered by a budget. Tracking of the amount will be reset based on the time grain. Must be one of `BillingAnnual`, `BillingMonth`, `BillingQuarter`, `Annually`, `Monthly` and `Quarterly`. Defaults to `Monthly`. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def amount(self) -> pulumi.Input[builtins.float]:
        """
    ...
    @amount.setter
    def amount(self, value: pulumi.Input[builtins.float]):
...
class BudgetManagementGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def amount(self) -> pulumi.Output[builtins.float]:
        """
        The total amount of cost to track with the budget.
        """
        return pulumi.get(self, "amount")
    ...
    @property
    @pulumi.getter(name="timeGrain")
    def time_grain(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The time covered by a budget. Tracking of the amount will be reset based on the time grain. Must be one of `BillingAnnual`, `BillingMonth`, `BillingQuarter`, `Annually`, `Monthly` and `Quarterly`. Defaults to `Monthly`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "time_grain")
