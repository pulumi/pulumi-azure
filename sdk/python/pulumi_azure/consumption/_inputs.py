...
class BudgetManagementGroupFilterDimensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies a list of values for the column.
        :param pulumi.Input[builtins.str] operator: The operator to use for comparison. The allowed values are `In`. Defaults to `In`.
        """
...
class BudgetManagementGroupFilterTagArgs:
    def __init__(__self__, *,
                 ...
                 operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the tag to use for the filter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies a list of values for the tag.
        :param pulumi.Input[builtins.str] operator: The operator to use for comparison. The allowed values are `In`. Defaults to `In`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class BudgetManagementGroupNotificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_emails: Specifies a list of email addresses to send the budget notification to when the threshold is exceeded.
        :param pulumi.Input[builtins.str] operator: The comparison operator for the notification. Must be one of `EqualTo`, `GreaterThan`, or `GreaterThanOrEqualTo`.
        :param pulumi.Input[builtins.int] threshold: Threshold value associated with a notification. Notification is sent when the cost exceeded the threshold. It is always percent and has to be between 0 and 1000.
...
class BudgetManagementGroupTimePeriodArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] start_date: The start date for the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than twelve months. Past start date should be selected within the timegrain period. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] end_date: The end date for the budget. If not set this will be 10 years after the start date.
        """
...
if not MYPY:
    class BudgetResourceGroupNotificationArgsDict(TypedDict):
        ...
        Threshold value associated with a notification. Notification is sent when the cost exceeded the threshold. It is always percent and has to be between 0 and 1000.
        """
        contact_emails: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies a list of email addresses to send the budget notification to when the threshold is exceeded.
        """
...
class BudgetResourceGroupNotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] threshold: Threshold value associated with a notification. Notification is sent when the cost exceeded the threshold. It is always percent and has to be between 0 and 1000.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_emails: Specifies a list of email addresses to send the budget notification to when the threshold is exceeded.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] contact_groups: Specifies a list of Action Group IDs to send the budget notification to when the threshold is exceeded.
