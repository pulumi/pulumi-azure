...
class BudgetManagementGroupFilterDimension(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] values: Specifies a list of values for the column.
        :param builtins.str operator: The operator to use for comparison. The allowed values are `In`. Defaults to `In`.
        """
...
class BudgetManagementGroupFilterTag(dict):
    def __init__(__self__, *,
                 ...
                 operator: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the tag to use for the filter.
        :param Sequence[builtins.str] values: Specifies a list of values for the tag.
        :param builtins.str operator: The operator to use for comparison. The allowed values are `In`. Defaults to `In`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class BudgetManagementGroupNotification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] contact_emails: Specifies a list of email addresses to send the budget notification to when the threshold is exceeded.
        :param builtins.str operator: The comparison operator for the notification. Must be one of `EqualTo`, `GreaterThan`, or `GreaterThanOrEqualTo`.
        :param builtins.int threshold: Threshold value associated with a notification. Notification is sent when the cost exceeded the threshold. It is always percent and has to be between 0 and 1000.
        :param builtins.bool enabled: Should the notification be enabled? Defaults to `true`.
        :param builtins.str threshold_type: The type of threshold for the notification. This determines whether the notification is triggered by forecasted costs or actual costs. The allowed values are `Actual` and `Forecasted`. Default is `Actual`.
        """
...
class BudgetManagementGroupTimePeriod(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str start_date: The start date for the budget. The start date must be first of the month and should be less than the end date. Budget start date must be on or after June 1, 2017. Future start date should not be more than twelve months. Past start date should be selected within the timegrain period. Changing this forces a new resource to be created.
        :param builtins.str end_date: The end date for the budget. If not set this will be 10 years after the start date.
        """
...
class BudgetResourceGroupNotification(dict):
    ...
    def __init__(__self__, *,
                 operator: builtins.str,
                 threshold: builtins.int,
                 contact_emails: Optional[Sequence[builtins.str]] = None,
        ...
        :param builtins.int threshold: Threshold value associated with a notification. Notification is sent when the cost exceeded the threshold. It is always percent and has to be between 0 and 1000.
        :param Sequence[builtins.str] contact_emails: Specifies a list of email addresses to send the budget notification to when the threshold is exceeded.
        :param Sequence[builtins.str] contact_groups: Specifies a list of Action Group IDs to send the budget notification to when the threshold is exceeded.
        :param Sequence[builtins.str] contact_roles: Specifies a list of contact roles to send the budget notification to when the threshold is exceeded.
        :param builtins.bool enabled: Should the notification be enabled? Defaults to `true`.
    ...
    @property
    @pulumi.getter(name="contactEmails")
    def contact_emails(self) -> Optional[Sequence[builtins.str]]:
        """
        Specifies a list of email addresses to send the budget notification to when the threshold is exceeded.
        """
        return pulumi.get(self, "contact_emails")
...
class GetBudgetResourceGroupFilterDimensionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str operator: The operator used for comparison.
        :param Sequence[builtins.str] values: A list of values for the tag.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class GetBudgetResourceGroupNotificationResult(dict):
    def __init__(__self__, *,
                 ...
                 contact_roles: Sequence[builtins.str],
                 enabled: builtins.bool,
                 operator: builtins.str,
                 threshold: builtins.int,
                 threshold_type: builtins.str):
        """
        :param Sequence[builtins.str] contact_emails: A list of email addresses to send the budget notification to when the threshold is exceeded.
        :param Sequence[builtins.str] contact_groups: A list of Action Group IDs to send the budget notification to when the threshold is exceeded.
        :param Sequence[builtins.str] contact_roles: A list of contact roles to send the budget notification to when the threshold is exceeded.
        :param builtins.bool enabled: Whether the notification is enabled.
        :param builtins.str operator: The operator used for comparison.
        :param builtins.int threshold: Threshold value associated with the notification.
        """
        pulumi.set(__self__, "contact_emails", contact_emails)
        pulumi.set(__self__, "contact_groups", contact_groups)
        pulumi.set(__self__, "contact_roles", contact_roles)
    ...
    @property
    @pulumi.getter(name="contactRoles")
    def contact_roles(self) -> Sequence[builtins.str]:
        """
...
class GetBudgetSubscriptionFilterDimensionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of this Consumption Budget.
        :param builtins.str operator: The operator to used for comparison.
        :param Sequence[builtins.str] values: A list of values for the tag.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
