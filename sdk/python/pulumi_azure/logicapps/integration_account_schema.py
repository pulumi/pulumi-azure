...
class IntegrationAccountSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: The content of the Logic App Integration Account Schema.
        :param pulumi.Input[builtins.str] integration_account_name: The name of the Logic App Integration Account. Changing this forces a new Logic App Integration Account Schema to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Logic App Integration Account Schema should exist. Changing this forces a new Logic App Integration Account Schema to be created.
        :param pulumi.Input[builtins.str] file_name: The file name of the Logic App Integration Account Schema.
        :param pulumi.Input[builtins.str] metadata: The metadata of the Logic App Integration Account Schema.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Logic App Integration Account Schema. Changing this forces a new Logic App Integration Account Schema to be created.
        """
...
@pulumi.type_token("azure:logicapps/integrationAccountSchema:IntegrationAccountSchema")
class IntegrationAccountSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metadata: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationAccountSchema':
        """
