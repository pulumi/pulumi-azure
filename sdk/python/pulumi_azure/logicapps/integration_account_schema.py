...
class IntegrationAccountSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] metadata: The metadata of the Logic App Integration Account Schema.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Logic App Integration Account Schema. Changing this forces a new Logic App Integration Account Schema to be created.
        """
...
class IntegrationAccountSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metadata: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'IntegrationAccountSchema':
        """
