...
class StandardArgs:
    def __init__(__self__, *,
                 ...
                 bundle_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 scm_publish_basic_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 site_config: Optional[pulumi.Input['StandardSiteConfigArgs']] = None,
                 storage_account_share_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 use_extension_bundle: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] app_service_plan_id: The ID of the App Service Plan within which to create this Logic App.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Logic App. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_access_key: The access key which will be used to access the backend storage account for the Logic App.
        :param pulumi.Input[builtins.str] storage_account_name: The backend storage account name which will be used by this Logic App (e.g. for Stateful workflows data). Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] bundle_version: If `use_extension_bundle` is set to `true` this controls the allowed range for bundle versions. Defaults to `[1.*, 2.0.0)`.
        :param pulumi.Input[builtins.bool] client_affinity_enabled: Should the Logic App send session affinity cookies, which route client requests in the same session to the same instance?
        :param pulumi.Input[builtins.str] client_certificate_mode: The mode of the Logic App's client certificates requirement for incoming requests. Possible values are `Required` and `Optional`.
        ...
        :param pulumi.Input[builtins.bool] enabled: Is the Logic App enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Whether the FTP basic authentication publishing profile is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] https_only: Can the Logic App only be accessed via HTTPS? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Logic App. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] public_network_access: Whether Public Network Access should be enabled or not. Possible values are `Enabled` and `Disabled`. Defaults to `Enabled`.
               
               > **Note:** Setting this property will also set it in the Site Config.
        :param pulumi.Input[builtins.bool] scm_publish_basic_authentication_enabled: Whether the default SCM basic authentication publishing profile is enabled. Defaults to `true`.
        :param pulumi.Input['StandardSiteConfigArgs'] site_config: A `site_config` object as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.bool] use_extension_bundle: Should the logic app use the bundled extension package? If true, then application settings for `AzureFunctionsJobHost__extensionBundle__id` and `AzureFunctionsJobHost__extensionBundle__version` will be created. Defaults to `true`.
        :param pulumi.Input[builtins.str] version: The runtime version associated with the Logic App. Defaults to `~4`.
        :param pulumi.Input[builtins.bool] vnet_content_share_enabled: Specifies whether allow routing traffic between the Logic App and Storage Account content share through a virtual network. Defaults to `false`.
        """
    ...
    def bundle_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bundle_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scm_publish_basic_authentication_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def scm_publish_basic_authentication_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def storage_account_share_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "storage_account_share_name")

    @storage_account_share_name.setter
    def storage_account_share_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def use_extension_bundle(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_extension_bundle(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _StandardState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_hostname: The default hostname associated with the Logic App - such as `mysite.azurewebsites.net`.
        :param pulumi.Input[builtins.bool] enabled: Is the Logic App enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] ftp_publish_basic_authentication_enabled: Whether the FTP basic authentication publishing profile is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] https_only: Can the Logic App only be accessed via HTTPS? Defaults to `false`.
        :param pulumi.Input['StandardIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] kind: The Logic App kind.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Logic App. Changing this forces a new resource to be created.
...
class Standard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version: Optional[pulumi.Input[builtins.str]] = None,
            virtual_network_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            vnet_content_share_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Standard':
        """
    ...
    @property
    @pulumi.getter(name="bundleVersion")
    def bundle_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `use_extension_bundle` is set to `true` this controls the allowed range for bundle versions. Defaults to `[1.*, 2.0.0)`.
        """
        return pulumi.get(self, "bundle_version")
    ...
    @property
    @pulumi.getter(name="scmPublishBasicAuthenticationEnabled")
    def scm_publish_basic_authentication_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the default SCM basic authentication publishing profile is enabled. Defaults to `true`.
        """
        return pulumi.get(self, "scm_publish_basic_authentication_enabled")
    ...
    @property
    @pulumi.getter(name="storageAccountShareName")
    def storage_account_share_name(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "storage_account_share_name")
    ...
    @property
    @pulumi.getter(name="useExtensionBundle")
    def use_extension_bundle(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the logic app use the bundled extension package? If true, then application settings for `AzureFunctionsJobHost__extensionBundle__id` and `AzureFunctionsJobHost__extensionBundle__version` will be created. Defaults to `true`.
        """
        return pulumi.get(self, "use_extension_bundle")
