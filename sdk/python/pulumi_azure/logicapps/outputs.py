...
class ActionHttpRunAfter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action_name: Specifies the name of the precedent HTTP Action.
        :param builtins.str action_result: Specifies the expected result of the precedent HTTP Action, only after which the current HTTP Action will be triggered. Possible values include `Succeeded`, `Failed`, `Skipped` and `TimedOut`.
        """
...
class IntegrationAccountAgreementGuestIdentity(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str qualifier: The authenticating body that provides unique guest identities to organizations.
        :param builtins.str value: The value that identifies the documents that your logic apps receive.
        """
...
class IntegrationAccountAgreementHostIdentity(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str qualifier: The authenticating body that provides unique host identities to organizations.
        :param builtins.str value: The value that identifies the documents that your logic apps receive.
        """
        pulumi.set(__self__, "qualifier", qualifier)
        pulumi.set(__self__, "value", value)
...
class IntegrationAccountBatchConfigurationReleaseCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int batch_size: The batch size in bytes for the Logic App Integration Batch Configuration.
        :param builtins.int message_count: The message count for the Logic App Integration Batch Configuration.
...
class IntegrationAccountBatchConfigurationReleaseCriteriaRecurrence(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str frequency: The frequency of the schedule. Possible values are `Day`, `Hour`, `Minute`, `Month`, `NotSpecified`, `Second`, `Week` and `Year`.
        :param builtins.int interval: The number of `frequency`s between runs.
        :param builtins.str end_time: The end time of the schedule, formatted as an RFC3339 string.
        ...
        :param builtins.str start_time: The start time of the schedule, formatted as an RFC3339 string.
        :param builtins.str time_zone: The timezone of the start/end time.
        """
...
class IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.int] hours: A list containing a single item, which specifies the Hour interval at which this recurrence should be triggered.
        :param Sequence[builtins.int] minutes: A list containing a single item which specifies the Minute interval at which this recurrence should be triggered.
        :param Sequence[builtins.int] month_days: A list of days of the month that the job should execute on.
        ...
        :param Sequence[builtins.str] week_days: A list of days of the week that the job should execute on. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday` and `Saturday`.
        """
...
class IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleMonthly(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int week: The occurrence of the week within the month.
        :param builtins.str weekday: The day of the occurrence. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday` and `Saturday`.
        """
...
class IntegrationAccountCertificateKeyVaultKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_name: The name of Key Vault Key.
        :param builtins.str key_vault_id: The ID of the Key Vault.
        :param builtins.str key_version: The version of Key Vault Key.
        """
...
class IntegrationAccountPartnerBusinessIdentity(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str qualifier: The authenticating body that provides unique business identities to organizations.
        :param builtins.str value: The value that identifies the documents that your logic apps receive.
        """
        pulumi.set(__self__, "qualifier", qualifier)
        pulumi.set(__self__, "value", value)
...
class StandardConnectionString(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the Connection String.
        :param builtins.str type: The type of the Connection String. Possible values are `APIHub`, `Custom`, `DocDb`, `EventHub`, `MySQL`, `NotificationHub`, `PostgreSQL`, `RedisCache`, `ServiceBus`, `SQLAzure` and `SQLServer`.
        :param builtins.str value: The value for the Connection String.
        """
...
class StandardIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Logic App Standard. Possible values are `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned` (to enable both).
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Logic App Standard.
...
class StandardSiteConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 app_scale_limit: Optional[builtins.int] = None,
                 auto_swap_slot_name: Optional[builtins.str] = None,
                 cors: Optional['outputs.StandardSiteConfigCors'] = None,
                 dotnet_framework_version: Optional[builtins.str] = None,
                 elastic_instance_minimum: Optional[builtins.int] = None,
                 ...
                 public_network_access_enabled: Optional[builtins.bool] = None,
                 runtime_scale_monitoring_enabled: Optional[builtins.bool] = None,
                 ...
                 scm_use_main_ip_restriction: Optional[builtins.bool] = None,
                 use32_bit_worker_process: Optional[builtins.bool] = None,
                 vnet_route_all_enabled: Optional[builtins.bool] = None,
                 websockets_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool always_on: Should the Logic App be loaded at all times? Defaults to `false`.
        :param builtins.int app_scale_limit: The number of workers this Logic App can scale out to. Only applicable to apps on the Consumption and Premium plan.
        :param builtins.str auto_swap_slot_name: The Auto-swap slot name.
        ...
        :param builtins.int elastic_instance_minimum: The number of minimum instances for this Logic App Only affects apps on the Premium plan.
        :param builtins.str ftps_state: State of FTP / FTPS service for this Logic App. Possible values include: `AllAllowed`, `FtpsOnly` and `Disabled`. Defaults to `AllAllowed`.
        :param builtins.str health_check_path: Path which will be checked for this Logic App health.
        ...
        :param builtins.bool vnet_route_all_enabled: Should all outbound traffic to have Virtual Network Security Groups and User Defined Routes applied.
    ...
    def app_scale_limit(self) -> Optional[builtins.int]:
        """
    ...
    def dotnet_framework_version(self) -> Optional[builtins.str]:
        """
        The version of the .NET framework's CLR used in this Logic App Possible values are `v4.0` (including .NET Core 2.1 and 3.1), `v5.0`, `v6.0` and `v8.0`. [For more information on which .NET Framework version to use based on the runtime version you're targeting - please see this table](https://docs.microsoft.com/azure/azure-functions/functions-dotnet-class-library#supported-versions). Defaults to `v4.0`.
        """
    ...
    def elastic_instance_minimum(self) -> Optional[builtins.int]:
        """
    ...
    def public_network_access_enabled(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "public_network_access_enabled")

    @property
    @pulumi.getter(name="runtimeScaleMonitoringEnabled")
    def runtime_scale_monitoring_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def scm_use_main_ip_restriction(self) -> Optional[builtins.bool]:
        """
    ...
    def websockets_enabled(self) -> Optional[builtins.bool]:
        """
...
class StandardSiteConfigCors(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] allowed_origins: A list of origins which should be able to make cross-origin calls. `*` can be used to allow all calls.
        :param builtins.bool support_credentials: Are credentials supported?
        """
...
class StandardSiteConfigIpRestriction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtual_network_subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.str action: Does this restriction `Allow` or `Deny` access for this IP range. Defaults to `Allow`.
        ...
        :param builtins.str ip_address: The IP Address used for this IP Restriction in CIDR notation.
        :param builtins.str name: The name for this IP Restriction.
        :param builtins.int priority: The priority for this IP Restriction. Restrictions are enforced in priority order. By default, the priority is set to 65000 if not specified.
...
class StandardSiteConfigIpRestrictionHeaders(dict):
    ...
    def __init__(__self__, *,
                 x_azure_fdids: Optional[Sequence[builtins.str]] = None,
                 x_fd_health_probe: Optional[builtins.str] = None,
                 x_forwarded_fors: Optional[Sequence[builtins.str]] = None,
                 x_forwarded_hosts: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] x_azure_fdids: A list of allowed Azure FrontDoor IDs in UUID notation with a maximum of 8.
        :param builtins.str x_fd_health_probe: A list to allow the Azure FrontDoor health probe header. Only allowed value is `1`.
        :param Sequence[builtins.str] x_forwarded_fors: A list of allowed 'X-Forwarded-For' IPs in CIDR notation with a maximum of 8.
        :param Sequence[builtins.str] x_forwarded_hosts: A list of allowed 'X-Forwarded-Host' domains with a maximum of 8.
        """
    ...
    def x_azure_fdids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def x_fd_health_probe(self) -> Optional[builtins.str]:
        """
    ...
    def x_forwarded_fors(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def x_forwarded_hosts(self) -> Optional[Sequence[builtins.str]]:
        """
...
class StandardSiteCredential(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: The password associated with the username, which can be used to publish to this App Service.
        :param builtins.str username: The username which can be used to publish to this App Service.
        """
...
class TriggerRecurrenceSchedule(dict):
    ...
    def __init__(__self__, *,
                 at_these_hours: Optional[Sequence[builtins.int]] = None,
                 at_these_minutes: Optional[Sequence[builtins.int]] = None,
                 on_these_days: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.int] at_these_hours: Specifies a list of hours when the trigger should run. Valid values are between 0 and 23.
        :param Sequence[builtins.int] at_these_minutes: Specifies a list of minutes when the trigger should run. Valid values are between 0 and 59.
        :param Sequence[builtins.str] on_these_days: Specifies a list of days when the trigger should run. Valid values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`.
        """
    ...
    def at_these_hours(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    def at_these_minutes(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    def on_these_days(self) -> Optional[Sequence[builtins.str]]:
        """
...
class WorkflowAccessControlAction(dict):
    ...
    def __init__(__self__, *,
                 allowed_caller_ip_address_ranges: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] allowed_caller_ip_address_ranges: A list of the allowed caller IP address ranges.
        """
    ...
    def allowed_caller_ip_address_ranges(self) -> Sequence[builtins.str]:
        """
...
class WorkflowAccessControlTriggerOpenAuthenticationPolicy(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The OAuth policy name for the Logic App Workflow.
        """
...
class WorkflowAccessControlTriggerOpenAuthenticationPolicyClaim(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the OAuth policy claim for the Logic App Workflow.
        :param builtins.str value: The value of the OAuth policy claim for the Logic App Workflow.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class GetStandardConnectionStringResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the Logic App.
        :param builtins.str type: The Type of Managed Identity assigned to this Logic App Workflow.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class GetStandardSiteConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 public_network_access_enabled: builtins.bool,
        ...
        :param builtins.int elastic_instance_minimum: The number of minimum instances for this Logic App Only affects apps on the Premium plan.
        :param builtins.str ftps_state: The state of FTP / FTPS service for this Logic App.
        ...
        :param builtins.str linux_fx_version: Linux App Framework and version for the Logic App.
        :param builtins.str min_tls_version: The minimum supported TLS version for the Logic App.
        :param builtins.int pre_warmed_instance_count: The number of pre-warmed instances for this Logic App Only affects apps on the Premium plan.
        ...
        :param builtins.str scm_min_tls_version: The minimum version of TLS required for SSL requests to the SCM site.
        :param builtins.str scm_type: The type of Source Control used by the Logic App in use by the Windows Function App.
        :param builtins.bool vnet_route_all_enabled: Should all outbound traffic to have Virtual Network Security Groups and User Defined Routes applied.
        :param builtins.bool always_on: Should the Logic App be loaded at all times?
        :param builtins.str dotnet_framework_version: The version of the .NET framework's CLR used in this Logic App.
        :param builtins.str health_check_path: Path which will be checked for this Logic App health.
        :param builtins.bool http2_enabled: Specifies whether the HTTP2 protocol should be enabled.
        :param builtins.bool runtime_scale_monitoring_enabled: Should Runtime Scale Monitoring be enabled?. Only applicable to apps on the Premium plan.
        :param builtins.bool scm_use_main_ip_restriction: Should the Logic App `ip_restriction` configuration be used for the SCM too.
        :param builtins.bool use32_bit_worker_process: Should the Logic App run in 32 bit mode, rather than 64 bit mode?
        :param builtins.bool websockets_enabled: Should WebSockets be enabled?
        """
        pulumi.set(__self__, "app_scale_limit", app_scale_limit)
        pulumi.set(__self__, "auto_swap_slot_name", auto_swap_slot_name)
    ...
    @property
    @pulumi.getter(name="appScaleLimit")
    def app_scale_limit(self) -> builtins.int:
        """
        The number of workers this Logic App can scale out to. Only applicable to apps on the Consumption and Premium plan.
        """
        return pulumi.get(self, "app_scale_limit")
    ...
    @property
    @pulumi.getter(name="elasticInstanceMinimum")
    def elastic_instance_minimum(self) -> builtins.int:
        """
        The number of minimum instances for this Logic App Only affects apps on the Premium plan.
        """
        return pulumi.get(self, "elastic_instance_minimum")
    ...
    @property
    @pulumi.getter(name="preWarmedInstanceCount")
    def pre_warmed_instance_count(self) -> builtins.int:
        """
        The number of pre-warmed instances for this Logic App Only affects apps on the Premium plan.
        """
        return pulumi.get(self, "pre_warmed_instance_count")
    ...
    @property
    @pulumi.getter(name="vnetRouteAllEnabled")
    def vnet_route_all_enabled(self) -> builtins.bool:
        """
        Should all outbound traffic to have Virtual Network Security Groups and User Defined Routes applied.
        """
        return pulumi.get(self, "vnet_route_all_enabled")
...
class GetStandardSiteConfigCorsResult(dict):
    def __init__(__self__, *,
                 ...
                 support_credentials: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] allowed_origins: A list of origins which should be able to make cross-origin calls.
        :param builtins.bool support_credentials: Are credentials supported?
        """
        pulumi.set(__self__, "allowed_origins", allowed_origins)
        if support_credentials is not None:
...
class GetStandardSiteConfigIpRestrictionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the Logic App.
        :param builtins.str action: Does this restriction `Allow` or `Deny` access for this IP range.
        :param builtins.str ip_address: The IP Address used for this IP Restriction in CIDR notation.
        :param builtins.int priority: The priority for this IP Restriction. Restrictions are enforced in priority order.
        :param builtins.str service_tag: The Service Tag used for this IP Restriction.
        :param builtins.str virtual_network_subnet_id: The Virtual Network Subnet ID used for this IP Restriction.
        """
        pulumi.set(__self__, "headers", headers)
...
class GetStandardSiteConfigIpRestrictionHeadersResult(dict):
    def __init__(__self__, *,
                 ...
                 x_forwarded_hosts: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] x_azure_fdids: A list of allowed Azure FrontDoor IDs in UUID notation.
        :param builtins.str x_fd_health_probe: A list to allow the Azure FrontDoor health probe header.
        :param Sequence[builtins.str] x_forwarded_fors: A list of allowed 'X-Forwarded-For' IPs in CIDR notation.
        :param Sequence[builtins.str] x_forwarded_hosts: A list of allowed 'X-Forwarded-Host' domains.
        """
        if x_azure_fdids is not None:
            pulumi.set(__self__, "x_azure_fdids", x_azure_fdids)
        if x_fd_health_probe is not None:
...
class GetStandardSiteCredentialResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: The password associated with the username, which can be used to publish to this Logic App.
        :param builtins.str username: The username which can be used to publish to this Logic App.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class GetWorkflowIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Logic App Workflow.
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Logic App Workflow.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Logic App Workflow.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Logic App Workflow.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
