...
class IntegrationAccountAssemblyArgs:
    def __init__(__self__, *,
                 assembly_name: pulumi.Input[builtins.str],
                 integration_account_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 assembly_version: Optional[pulumi.Input[builtins.str]] = None,
                 content: Optional[pulumi.Input[builtins.str]] = None,
                 content_link_uri: Optional[pulumi.Input[builtins.str]] = None,
                 metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IntegrationAccountAssembly resource.
        :param pulumi.Input[builtins.str] assembly_name: The name of the Logic App Integration Account Assembly.
        :param pulumi.Input[builtins.str] integration_account_name: The name of the Logic App Integration Account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Logic App Integration Account Assembly Artifact should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] assembly_version: The version of the Logic App Integration Account Assembly. Defaults to `0.0.0.0`.
        :param pulumi.Input[builtins.str] content: The content of the Logic App Integration Account Assembly.
        :param pulumi.Input[builtins.str] content_link_uri: The content link URI of the Logic App Integration Account Assembly.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The metadata of the Logic App Integration Account Assembly.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Logic App Integration Account Assembly Artifact. Changing this forces a new resource to be created.
        """
    ...
    def assembly_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assembly_name(self, value: pulumi.Input[builtins.str]):
    ...
    def assembly_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assembly_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def content_link_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_link_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IntegrationAccountAssemblyState:
    def __init__(__self__, *,
                 assembly_name: Optional[pulumi.Input[builtins.str]] = None,
                 assembly_version: Optional[pulumi.Input[builtins.str]] = None,
                 content: Optional[pulumi.Input[builtins.str]] = None,
                 content_link_uri: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="assemblyName")
    def assembly_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Logic App Integration Account Assembly.
        """
        return pulumi.get(self, "assembly_name")
    ...
    @assembly_name.setter
    def assembly_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "assembly_name", value)
...
class IntegrationAccountAssembly(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationAccountAssembly':
        """
    ...
    @property
    @pulumi.getter(name="assemblyName")
    def assembly_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Logic App Integration Account Assembly.
        """
        return pulumi.get(self, "assembly_name")
    ...
    @property
    @pulumi.getter(name="assemblyVersion")
    def assembly_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the Logic App Integration Account Assembly. Defaults to `0.0.0.0`.
        """
        return pulumi.get(self, "assembly_version")
    ...
    @property
    @pulumi.getter(name="contentLinkUri")
    def content_link_uri(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The content link URI of the Logic App Integration Account Assembly.
        """
        return pulumi.get(self, "content_link_uri")
