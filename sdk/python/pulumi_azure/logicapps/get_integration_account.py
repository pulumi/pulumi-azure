...
def get_integration_account(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Logic` - 2019-05-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Logic App Integration Account exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_integration_account_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.Logic` - 2019-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:logicapps/getIntegrationAccount:getIntegrationAccount', __args__, opts=opts, typ=GetIntegrationAccountResult)
