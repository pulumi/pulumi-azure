...
if not MYPY:
    class ActionHttpRunAfterArgsDict(TypedDict):
        ...
        """
        action_result: pulumi.Input[_builtins.str]
        """
...
class ActionHttpRunAfterArgs:
    def __init__(__self__, *,
                 ...
                 action_result: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] action_name: Specifies the name of the precedent HTTP Action.
        :param pulumi.Input[_builtins.str] action_result: Specifies the expected result of the precedent HTTP Action, only after which the current HTTP Action will be triggered. Possible values include `Succeeded`, `Failed`, `Skipped` and `TimedOut`.
        """
    ...
    def action_result(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the expected result of the precedent HTTP Action, only after which the current HTTP Action will be triggered. Possible values include `Succeeded`, `Failed`, `Skipped` and `TimedOut`.
        """
    ...
    def action_result(self, value: pulumi.Input[_builtins.str]):
...
class IntegrationAccountAgreementGuestIdentityArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] qualifier: The authenticating body that provides unique guest identities to organizations.
        :param pulumi.Input[_builtins.str] value: The value that identifies the documents that your logic apps receive.
        """
...
class IntegrationAccountAgreementHostIdentityArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] qualifier: The authenticating body that provides unique host identities to organizations.
        :param pulumi.Input[_builtins.str] value: The value that identifies the documents that your logic apps receive.
        """
        pulumi.set(__self__, "qualifier", qualifier)
        pulumi.set(__self__, "value", value)
...
class IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] end_time: The end time of the schedule, formatted as an RFC3339 string.
        ...
        :param pulumi.Input[_builtins.str] start_time: The start time of the schedule, formatted as an RFC3339 string.
...
class IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] month_days: A list of days of the month that the job should execute on.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] week_days: A list of days of the week that the job should execute on. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday` and `Saturday`.
        """
...
class IntegrationAccountBatchConfigurationReleaseCriteriaRecurrenceScheduleMonthlyArgs:
    def __init__(__self__, *,
                 ...
                 weekday: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.int] week: The occurrence of the week within the month.
        :param pulumi.Input[_builtins.str] weekday: The day of the occurrence. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday` and `Saturday`.
        """
...
class IntegrationAccountCertificateKeyVaultKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] key_version: The version of Key Vault Key.
        """
...
class IntegrationAccountPartnerBusinessIdentityArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] qualifier: The authenticating body that provides unique business identities to organizations.
        :param pulumi.Input[_builtins.str] value: The value that identifies the documents that your logic apps receive.
        """
        pulumi.set(__self__, "qualifier", qualifier)
        pulumi.set(__self__, "value", value)
...
class StandardConnectionStringArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The name of the Connection String.
        :param pulumi.Input[_builtins.str] type: The type of the Connection String. Possible values are `APIHub`, `Custom`, `DocDb`, `EventHub`, `MySQL`, `NotificationHub`, `PostgreSQL`, `RedisCache`, `ServiceBus`, `SQLAzure` and `SQLServer`.
        :param pulumi.Input[_builtins.str] value: The value for the Connection String.
        """
...
class StandardIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Logic App Standard.
               ...
               > **Note:** The `identity_ids` is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this App Service.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this App Service.
        """
        pulumi.set(__self__, "type", type)
...
class StandardSiteConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auto_swap_slot_name: The Auto-swap slot name.
        :param pulumi.Input['StandardSiteConfigCorsArgs'] cors: A `cors` block as defined below.
        :param pulumi.Input[_builtins.str] dotnet_framework_version: The version of the .NET framework's CLR used in this Logic App Possible values are `v4.0` (including .NET Core 2.1 and 3.1), `v5.0`, `v6.0` and `v8.0`. [For more information on which .NET Framework version to use based on the runtime version you're targeting - please see this table](https://docs.microsoft.com/azure/azure-functions/functions-dotnet-class-library#supported-versions). Defaults to `v4.0`.
        :param pulumi.Input[_builtins.int] elastic_instance_minimum: The number of minimum instances for this Logic App Only affects apps on the Premium plan.
        ...
        :param pulumi.Input[_builtins.bool] scm_use_main_ip_restriction: Should the Logic App `ip_restriction` configuration be used for the SCM too. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] use32_bit_worker_process: Should the Logic App run in 32 bit mode, rather than 64 bit mode? Defaults to `true`.
               
               > **Note:** when using an App Service Plan in the `Free` or `Shared` Tiers `use_32_bit_worker_process` must be set to `true`.
        :param pulumi.Input[_builtins.bool] vnet_route_all_enabled: Should all outbound traffic to have Virtual Network Security Groups and User Defined Routes applied.
        :param pulumi.Input[_builtins.bool] websockets_enabled: Should WebSockets be enabled?
        """
...
class StandardSiteConfigIpRestrictionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] priority: The priority for this IP Restriction. Restrictions are enforced in priority order. By default, the priority is set to 65000 if not specified.
        :param pulumi.Input[_builtins.str] service_tag: The Service Tag used for this IP Restriction.
        :param pulumi.Input[_builtins.str] virtual_network_subnet_id: The Virtual Network Subnet ID used for this IP Restriction.
...
class StandardSiteConfigIpRestrictionHeadersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] x_forwarded_fors: A list of allowed 'X-Forwarded-For' IPs in CIDR notation with a maximum of 8.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] x_forwarded_hosts: A list of allowed 'X-Forwarded-Host' domains with a maximum of 8.
        """
...
class TriggerRecurrenceScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] on_these_days: Specifies a list of days when the trigger should run. Valid values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`.
        """
...
class WorkflowAccessControlTriggerOpenAuthenticationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The OAuth policy name for the Logic App Workflow.
        """
...
class WorkflowAccessControlTriggerOpenAuthenticationPolicyClaimArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The name of the OAuth policy claim for the Logic App Workflow.
        :param pulumi.Input[_builtins.str] value: The value of the OAuth policy claim for the Logic App Workflow.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class WorkflowIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Logic App Workflow.
               ...
               > **Note:** This is required when `type` is set to `UserAssigned`
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Logic App Workflow.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Logic App Workflow.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
