...
class TriggerHttpRequestArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the HTTP Request Trigger to be created within the Logic App Workflow. Changing this forces a new resource to be created.
               
               > **NOTE:** This name must be unique across all Triggers within the Logic App Workflow.
        :param pulumi.Input[_builtins.str] relative_path: Specifies the Relative Path used for this Request.
...
class TriggerHttpRequest(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="relativePath")
    def relative_path(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the Relative Path used for this Request.
