...
class IntegrationAccountCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] integration_account_name: The name of the Logic App Integration Account. Changing this forces a new Logic App Integration Account Certificate to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Logic App Integration Account Certificate should exist. Changing this forces a new Logic App Integration Account Certificate to be created.
        :param pulumi.Input['IntegrationAccountCertificateKeyVaultKeyArgs'] key_vault_key: A `key_vault_key` block as documented below.
        :param pulumi.Input[builtins.str] metadata: A JSON mapping of any Metadata for this Logic App Integration Account Certificate.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Logic App Integration Account Certificate. Changing this forces a new Logic App Integration Account Certificate to be created.
        :param pulumi.Input[builtins.str] public_certificate: The public certificate for the Logic App Integration Account Certificate.
        """
...
class IntegrationAccountCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            public_certificate: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationAccountCertificate':
        """
