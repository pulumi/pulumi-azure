...
class IntegrationAccountAgreementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agreement_type: The type of the Logic App Integration Account Agreement. Possible values are `AS2`, `X12` and `Edifact`.
        :param pulumi.Input[builtins.str] content: The content of the Logic App Integration Account Agreement.
        ...
        :param pulumi.Input[builtins.str] guest_partner_name: The name of the guest Logic App Integration Account Partner.
        :param pulumi.Input['IntegrationAccountAgreementHostIdentityArgs'] host_identity: A `host_identity` block as documented below.
        :param pulumi.Input[builtins.str] host_partner_name: The name of the host Logic App Integration Account Partner.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Logic App Integration Account Agreement should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: The metadata of the Logic App Integration Account Agreement.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Logic App Integration Account Agreement. Changing this forces a new resource to be created.
        """
    ...
    def agreement_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def agreement_type(self, value: pulumi.Input[builtins.str]):
    ...
    def guest_partner_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def guest_partner_name(self, value: pulumi.Input[builtins.str]):
    ...
    def host_partner_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def host_partner_name(self, value: pulumi.Input[builtins.str]):
...
class _IntegrationAccountAgreementState:
    def __init__(__self__, *,
                 agreement_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 guest_partner_name: Optional[pulumi.Input[builtins.str]] = None,
                 host_identity: Optional[pulumi.Input['IntegrationAccountAgreementHostIdentityArgs']] = None,
                 host_partner_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="agreementType")
    def agreement_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the Logic App Integration Account Agreement. Possible values are `AS2`, `X12` and `Edifact`.
        """
        return pulumi.get(self, "agreement_type")
    ...
    @agreement_type.setter
    def agreement_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agreement_type", value)
    ...
    @property
    @pulumi.getter(name="guestPartnerName")
    def guest_partner_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the guest Logic App Integration Account Partner.
        """
        return pulumi.get(self, "guest_partner_name")
    ...
    @guest_partner_name.setter
    def guest_partner_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "guest_partner_name", value)
    ...
    @property
    @pulumi.getter(name="hostPartnerName")
    def host_partner_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the host Logic App Integration Account Partner.
        """
        return pulumi.get(self, "host_partner_name")
    ...
    @host_partner_name.setter
    def host_partner_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "host_partner_name", value)
...
class IntegrationAccountAgreement(pulumi.CustomResource):
    ...
    pulumi_type = "azure:logicapps/integrationAccountAgreement:IntegrationAccountAgreement"
    ...
    def get(resource_name: str,
            ...
            metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IntegrationAccountAgreement':
        """
    ...
    @property
    @pulumi.getter(name="guestPartnerName")
    def guest_partner_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the guest Logic App Integration Account Partner.
        """
        return pulumi.get(self, "guest_partner_name")
    ...
    @property
    @pulumi.getter(name="hostPartnerName")
    def host_partner_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the host Logic App Integration Account Partner.
        """
        return pulumi.get(self, "host_partner_name")
