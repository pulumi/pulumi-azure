...
class IntegrationAccountMapArgs:
    def __init__(__self__, *,
                 ...
                 map_type: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Logic App Integration Account Map should exist. Changing this forces a new Logic App Integration Account Map to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: The metadata of the Logic App Integration Account Map.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this Logic App Integration Account Map. Changing this forces a new Logic App Integration Account Map to be created.
        """
    ...
    def map_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @map_type.setter
    def map_type(self, value: pulumi.Input[_builtins.str]):
...
class IntegrationAccountMap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'IntegrationAccountMap':
        """
