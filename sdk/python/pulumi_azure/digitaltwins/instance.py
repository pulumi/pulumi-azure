...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 identity: pulumi.Input[Optional['InstanceIdentityArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Digital Twins instance.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['InstanceIdentityArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['InstanceIdentityArgs']]):
