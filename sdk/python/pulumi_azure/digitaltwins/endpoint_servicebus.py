...
class EndpointServicebusArgs:
    def __init__(__self__, *,
                 digital_twins_id: pulumi.Input[builtins.str],
                 servicebus_primary_connection_string: pulumi.Input[builtins.str],
                 servicebus_secondary_connection_string: pulumi.Input[builtins.str],
                 dead_letter_storage_secret: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EndpointServicebus resource.
        :param pulumi.Input[builtins.str] digital_twins_id: The ID of the Digital Twins Instance. Changing this forces a new Digital Twins Service Bus Endpoint to be created.
        :param pulumi.Input[builtins.str] servicebus_primary_connection_string: The primary connection string of the Service Bus Topic Authorization Rule with a minimum of `send` permission. .
        :param pulumi.Input[builtins.str] servicebus_secondary_connection_string: The secondary connection string of the Service Bus Topic Authorization Rule with a minimum of `send` permission.
        :param pulumi.Input[builtins.str] dead_letter_storage_secret: The storage secret of the dead-lettering, whose format is `https://<storageAccountname>.blob.core.windows.net/<containerName>?<SASToken>`. When an endpoint can't deliver an event within a certain time period or after trying to deliver the event a certain number of times, it can send the undelivered event to a storage account.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Digital Twins Service Bus Endpoint. Changing this forces a new Digital Twins Service Bus Endpoint to be created.
        """
    ...
    def digital_twins_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def digital_twins_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "digital_twins_id", value)

    @property
    @pulumi.getter(name="servicebusPrimaryConnectionString")
    def servicebus_primary_connection_string(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def servicebus_primary_connection_string(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "servicebus_primary_connection_string", value)

    @property
    @pulumi.getter(name="servicebusSecondaryConnectionString")
    def servicebus_secondary_connection_string(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def servicebus_secondary_connection_string(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "servicebus_secondary_connection_string", value)

    @property
    @pulumi.getter(name="deadLetterStorageSecret")
    def dead_letter_storage_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dead_letter_storage_secret(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EndpointServicebusState:
    def __init__(__self__, *,
                 dead_letter_storage_secret: Optional[pulumi.Input[builtins.str]] = None,
                 digital_twins_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 servicebus_primary_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 servicebus_secondary_connection_string: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="digitalTwinsId")
    def digital_twins_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Digital Twins Instance. Changing this forces a new Digital Twins Service Bus Endpoint to be created.
        """
        return pulumi.get(self, "digital_twins_id")
    ...
    @digital_twins_id.setter
    def digital_twins_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "digital_twins_id", value)
    ...
    @property
    @pulumi.getter(name="servicebusPrimaryConnectionString")
    def servicebus_primary_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The primary connection string of the Service Bus Topic Authorization Rule with a minimum of `send` permission. .
        """
        return pulumi.get(self, "servicebus_primary_connection_string")
    ...
    @servicebus_primary_connection_string.setter
    def servicebus_primary_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "servicebus_primary_connection_string", value)

    @property
    @pulumi.getter(name="servicebusSecondaryConnectionString")
    def servicebus_secondary_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The secondary connection string of the Service Bus Topic Authorization Rule with a minimum of `send` permission.
        """
        return pulumi.get(self, "servicebus_secondary_connection_string")
    ...
    @servicebus_secondary_connection_string.setter
    def servicebus_secondary_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "servicebus_secondary_connection_string", value)
...
class EndpointServicebus(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            servicebus_primary_connection_string: Optional[pulumi.Input[builtins.str]] = None,
            servicebus_secondary_connection_string: Optional[pulumi.Input[builtins.str]] = None) -> 'EndpointServicebus':
        """
    ...
    @property
    @pulumi.getter(name="deadLetterStorageSecret")
    def dead_letter_storage_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The storage secret of the dead-lettering, whose format is `https://<storageAccountname>.blob.core.windows.net/<containerName>?<SASToken>`. When an endpoint can't deliver an event within a certain time period or after trying to deliver the event a certain number of times, it can send the undelivered event to a storage account.
        """
        return pulumi.get(self, "dead_letter_storage_secret")
    ...
    @property
    @pulumi.getter(name="digitalTwinsId")
    def digital_twins_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Digital Twins Instance. Changing this forces a new Digital Twins Service Bus Endpoint to be created.
        """
        return pulumi.get(self, "digital_twins_id")
    ...
    @property
    @pulumi.getter(name="servicebusPrimaryConnectionString")
    def servicebus_primary_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        The primary connection string of the Service Bus Topic Authorization Rule with a minimum of `send` permission. .
        """
        return pulumi.get(self, "servicebus_primary_connection_string")
    ...
    @property
    @pulumi.getter(name="servicebusSecondaryConnectionString")
    def servicebus_secondary_connection_string(self) -> pulumi.Output[builtins.str]:
        """
        The secondary connection string of the Service Bus Topic Authorization Rule with a minimum of `send` permission.
        """
        return pulumi.get(self, "servicebus_secondary_connection_string")
