...
__all__ = [
    ...
    'InstanceIdentityArgsDict',
]

MYPY = False

if not MYPY:
    class InstanceIdentityArgsDict(TypedDict):
    ...
    InstanceIdentityArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class InstanceIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Digital Twins instance. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Digital Twins instance.
