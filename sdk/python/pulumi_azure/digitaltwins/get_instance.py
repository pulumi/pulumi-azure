...
def get_instance(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.DigitalTwins`: 2023-01-31
    ...
    :param builtins.str name: The name of this Digital Twins instance.
    :param builtins.str resource_group_name: The name of the Resource Group where the Digital Twins instance exists.
    """
    __args__ = dict()
    __args__['name'] = name
