...
class AIServicesCustomerManagedKeyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] identity_client_id: The Client ID of the User Assigned Identity that has access to the key. This property only needs to be specified when there are multiple identities attached to the Azure AI Service.
        :param pulumi.Input[builtins.str] key_vault_key_id: The ID of the Key Vault Key which should be used to encrypt the data in this AI Services Account. Exactly one of `key_vault_key_id`, `managed_hsm_key_id` must be specified.
        :param pulumi.Input[builtins.str] managed_hsm_key_id: The ID of the managed HSM Key which should be used to encrypt the data in this AI Services Account. Exactly one of `key_vault_key_id`, `managed_hsm_key_id` must be specified.
        """
...
if not MYPY:
    class AIServicesNetworkAclsArgsDict(TypedDict):
        ...
        """
        bypass: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AIServicesNetworkAclsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bypass: Whether to allow trusted Azure Services to access the service. Possible values are `None` and `AzureServices`. Defaults to `AzureServices`.
               *
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_rules: One or more IP Addresses, or CIDR Blocks which should be able to access the AI Services Account.
...
class AIServicesNetworkAclsVirtualNetworkRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet which should be able to access this AI Services Account.
        :param pulumi.Input[builtins.bool] ignore_missing_vnet_service_endpoint: Whether to ignore a missing Virtual Network Service Endpoint or not. Default to `false`.
        """
...
class AIServicesStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] identity_client_id: The client ID of the Managed Identity associated with the Storage Account.
        """
...
class AccountNetworkAclsVirtualNetworkRuleArgs:
    def __init__(__self__, *,
                 ...
                 ignore_missing_vnet_service_endpoint: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet which should be able to access this Cognitive Account.
        :param pulumi.Input[builtins.bool] ignore_missing_vnet_service_endpoint: Whether ignore missing vnet service endpoint or not. Default to `false`.
        """
        pulumi.set(__self__, "subnet_id", subnet_id)
        if ignore_missing_vnet_service_endpoint is not None:
            pulumi.set(__self__, "ignore_missing_vnet_service_endpoint", ignore_missing_vnet_service_endpoint)
...
if not MYPY:
    class AccountRaiPolicyContentFilterArgsDict(TypedDict):
        block_enabled: pulumi.Input[builtins.bool]
        """
        Whether the filter should block content. Possible values are `true` or `false`.
        """
        filter_enabled: pulumi.Input[builtins.bool]
        """
        ...
        """
        severity_threshold: pulumi.Input[builtins.str]
        """
...
class AccountRaiPolicyContentFilterArgs:
    def __init__(__self__, *,
                 ...
                 source: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.bool] block_enabled: Whether the filter should block content. Possible values are `true` or `false`.
        :param pulumi.Input[builtins.bool] filter_enabled: Whether the filter is enabled. Possible values are `true` or `false`.
        :param pulumi.Input[builtins.str] name: The name of the content filter.
        :param pulumi.Input[builtins.str] severity_threshold: The severity threshold for the filter. Possible values are `Low`, `Medium` or `High`.
        :param pulumi.Input[builtins.str] source: Content source to apply the content filter. Possible values are `Prompt` or `Completion`.
        """
    ...
    def block_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Whether the filter should block content. Possible values are `true` or `false`.
        """
    ...
    def block_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "block_enabled", value)

    @property
    @pulumi.getter(name="filterEnabled")
    def filter_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Whether the filter is enabled. Possible values are `true` or `false`.
        """
    ...
    def filter_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def severity_threshold(self) -> pulumi.Input[builtins.str]:
        """
        The severity threshold for the filter. Possible values are `Low`, `Medium` or `High`.
        """
    ...
    def severity_threshold(self, value: pulumi.Input[builtins.str]):
...
class DeploymentSkuArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] capacity: Tokens-per-Minute (TPM). The unit of measure for this field is in the thousands of Tokens-per-Minute. Defaults to `1` which means that the limitation is `1000` tokens per minute. If the resources SKU supports scale in/out then the capacity field should be included in the resources' configuration. If the scale in/out is not supported by the resources SKU then this field can be safely omitted. For more information about TPM please see the [product documentation](https://learn.microsoft.com/azure/ai-services/openai/how-to/quota?tabs=rest).
        :param pulumi.Input[builtins.str] family: If the service has different generations of hardware, for the same SKU, then that can be captured here. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] size: The SKU size. When the name field is the combination of tier and some other value, this would be the standalone code. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] tier: Possible values are `Free`, `Basic`, `Standard`, `Premium`, `Enterprise`. This property is required only when multiple tiers are available with the SKU name. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "name", name)
