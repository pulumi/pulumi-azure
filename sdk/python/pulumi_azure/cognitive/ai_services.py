...
class AIServicesArgs:
    def __init__(__self__, *,
                 ...
                 custom_subdomain_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 outbound_network_access_restricted: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the AI Services Account is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: Specifies the SKU Name for this AI Services Account. Possible values are `F0`, `F1`, `S0`, `S`, `S1`, `S2`, `S3`, `S4`, `S5`, `S6`, `P0`, `P1`, `P2`, `E0` and `DC0`.
        ...
        :param pulumi.Input[builtins.str] custom_subdomain_name: The subdomain name used for token-based authentication. This property is required when `network_acls` is specified. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fqdns: List of FQDNs allowed for the AI Services Account.
        :param pulumi.Input['AIServicesIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.bool] local_authentication_enabled: Whether local authentication is enabled for the AI Services Account. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the AI Services Account. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] outbound_network_access_restricted: Whether outbound network access is restricted for the AI Services Account. Defaults to `false`.
        :param pulumi.Input[builtins.str] public_network_access: Whether public network access is allowed for the AI Services Account. Possible values are `Enabled` and `Disabled`. Defaults to `Enabled`.
    ...
    def custom_subdomain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_subdomain_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def outbound_network_access_restricted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def outbound_network_access_restricted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AIServicesState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] custom_subdomain_name: The subdomain name used for token-based authentication. This property is required when `network_acls` is specified. Changing this forces a new resource to be created.
               ...
               > **Note:** If you do not specify a `custom_subdomain_name` then you will not be able to attach a Private Endpoint to the resource.
        :param pulumi.Input['AIServicesCustomerManagedKeyArgs'] customer_managed_key: A `customer_managed_key` block as documented below.
        :param pulumi.Input[builtins.str] endpoint: The endpoint used to connect to the AI Services Account.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fqdns: List of FQDNs allowed for the AI Services Account.
        :param pulumi.Input['AIServicesIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.bool] local_authentication_enabled: Whether local authentication is enabled for the AI Services Account. Defaults to `true`.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input['AIServicesNetworkAclsArgs'] network_acls: A `network_acls` block as defined below. When this property is specified, `custom_subdomain_name` is also required to be set.
        :param pulumi.Input[builtins.bool] outbound_network_access_restricted: Whether outbound network access is restricted for the AI Services Account. Defaults to `false`.
        :param pulumi.Input[builtins.str] primary_access_key: A primary access key which can be used to connect to the AI Services Account.
        :param pulumi.Input[builtins.str] public_network_access: Whether public network access is allowed for the AI Services Account. Possible values are `Enabled` and `Disabled`. Defaults to `Enabled`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the AI Services Account is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] secondary_access_key: The secondary access key which can be used to connect to the AI Services Account.
        :param pulumi.Input[builtins.str] sku_name: Specifies the SKU Name for this AI Services Account. Possible values are `F0`, `F1`, `S0`, `S`, `S1`, `S2`, `S3`, `S4`, `S5`, `S6`, `P0`, `P1`, `P2`, `E0` and `DC0`.
...
class AIServices(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sku_name: Optional[pulumi.Input[builtins.str]] = None,
            storages: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AIServicesStorageArgs', 'AIServicesStorageArgsDict']]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'AIServices':
        """
    ...
    @property
    @pulumi.getter(name="customSubdomainName")
    def custom_subdomain_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The subdomain name used for token-based authentication. This property is required when `network_acls` is specified. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="outboundNetworkAccessRestricted")
    def outbound_network_access_restricted(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether outbound network access is restricted for the AI Services Account. Defaults to `false`.
        """
        return pulumi.get(self, "outbound_network_access_restricted")
