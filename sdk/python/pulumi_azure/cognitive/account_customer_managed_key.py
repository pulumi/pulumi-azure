...
class AccountCustomerManagedKeyInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cognitive_account_id: The ID of the Cognitive Account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] key_vault_key_id: The ID of the Key Vault Key which should be used to Encrypt the data in this Cognitive Account.
        :param pulumi.Input[builtins.str] identity_client_id: The Client ID of the User Assigned Identity that has access to the key. This property only needs to be specified when there're multiple identities attached to the Cognitive Account.
        """
...
class AccountCustomerManagedKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cognitive_account_id: Optional[pulumi.Input[builtins.str]] = None,
            identity_client_id: Optional[pulumi.Input[builtins.str]] = None,
            key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AccountCustomerManagedKey':
        """
    ...
    @property
    @pulumi.getter(name="identityClientId")
    def identity_client_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Client ID of the User Assigned Identity that has access to the key. This property only needs to be specified when there're multiple identities attached to the Cognitive Account.
        """
        return pulumi.get(self, "identity_client_id")
