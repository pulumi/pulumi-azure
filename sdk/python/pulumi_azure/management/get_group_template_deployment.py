...
def get_group_template_deployment(management_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str management_group_id: The ID of the Management Group to which this template was applied.
    :param builtins.str name: The name of this Management Group Template Deployment.
    """
    __args__ = dict()
...
def get_group_template_deployment_output(management_group_id: Optional[pulumi.Input[builtins.str]] = None,
