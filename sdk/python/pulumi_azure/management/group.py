...
class GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subscription_ids: A list of Subscription GUIDs which should be assigned to the Management Group.
...
class _GroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subscription_ids: A list of Subscription GUIDs which should be assigned to the Management Group.
               ...
               > **Note:** To clear all Subscriptions from the Management Group set `subscription_ids` to an empty list
        :param pulumi.Input[_builtins.str] tenant_scoped_id: The Management Group ID with the Tenant ID prefix.
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if name is not None:
...
class Group(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="parentManagementGroupId")
    def parent_management_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the Parent Management Group.
        """
        return pulumi.get(self, "parent_management_group_id")
    ...
    @_builtins.property
    @pulumi.getter(name="tenantScopedId")
    def tenant_scoped_id(self) -> pulumi.Output[_builtins.str]:
        """
        The Management Group ID with the Tenant ID prefix.
        """
        return pulumi.get(self, "tenant_scoped_id")
