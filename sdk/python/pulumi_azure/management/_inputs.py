...
class GroupPolicyAssignmentNonComplianceMessageArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content: The non-compliance message text. When assigning policy sets (initiatives), unless `policy_definition_reference_id` is specified then this message will be the default for all policies.
        :param pulumi.Input[builtins.str] policy_definition_reference_id: When assigning policy sets (initiatives), this is the ID of the policy definition that the non-compliance message applies to.
        """
...
class GroupPolicyAssignmentOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value: Specifies the value to override the policy property. Possible values for `policyEffect` override listed [policy effects](https://learn.microsoft.com/en-us/azure/governance/policy/concepts/effects).
...
class GroupPolicyAssignmentOverrideSelectorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kind: Specifies which characteristic will narrow down the set of evaluated resources. Possible values are `resourceLocation`, `resourceType` and `resourceWithoutLocation`.
        """
        if ins is not None:
...
class GroupPolicyAssignmentResourceSelectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies a name for the resource selector.
        """
        pulumi.set(__self__, "selectors", selectors)
        if name is not None:
