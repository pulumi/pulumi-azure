...
class GroupPolicyAssignmentOverrideArgs:
    def __init__(__self__, *,
                 value: pulumi.Input[_builtins.str],
                 selectors: pulumi.Input[Optional[Sequence[pulumi.Input['GroupPolicyAssignmentOverrideSelectorArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def selectors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['GroupPolicyAssignmentOverrideSelectorArgs']]]]:
        """
        One or more `override_selector` block as defined below.
        """
    ...
    @selectors.setter
    def selectors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['GroupPolicyAssignmentOverrideSelectorArgs']]]]):
