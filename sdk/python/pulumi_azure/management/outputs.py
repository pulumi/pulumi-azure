...
class GroupPolicyAssignmentIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        GroupPolicyAssignmentIdentity._configure(
...
class GroupPolicyAssignmentNonComplianceMessage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        GroupPolicyAssignmentNonComplianceMessage._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            content=content,
...
class GroupPolicyAssignmentOverride(dict):
    def __init__(__self__, *,
        ...
        """
        GroupPolicyAssignmentOverride._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            value=value,
            selectors=selectors,
        )
...
class GroupPolicyAssignmentOverrideSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        GroupPolicyAssignmentOverrideSelector._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            ins=ins,
            kind=kind,
            not_ins=not_ins,
...
class GroupPolicyAssignmentResourceSelector(dict):
    def __init__(__self__, *,
        ...
        """
        GroupPolicyAssignmentResourceSelector._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            selectors=selectors,
            name=name,
        )
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             selectors: Optional[Sequence['outputs.GroupPolicyAssignmentResourceSelectorSelector']] = None,
             name: Optional[str] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
...
class GroupPolicyAssignmentResourceSelectorSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[str] not_ins: Specify the list of policy reference id values to filter out. Cannot be used with `in`.
        """
        GroupPolicyAssignmentResourceSelectorSelector._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            kind=kind,
            ins=ins,
            not_ins=not_ins,
