...
class GroupPolicyRemediationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] management_group_id: The Management Group ID at which the Policy Remediation should be applied. Changing this forces a new resource to be created.
...
class GroupPolicyRemediation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_assignment_id: Optional[pulumi.Input[builtins.str]] = None,
            policy_definition_reference_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_count: Optional[pulumi.Input[builtins.int]] = None) -> 'GroupPolicyRemediation':
        """
