...
class GetServiceResult:
    ...
    def aad_auth_enabled(self) -> _builtins.bool:
    ...
    def tls_client_cert_enabled(self) -> _builtins.bool:
...
def get_service(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.SignalRService` - 2024-03-01
    ...
    :param _builtins.str name: Specifies the name of the Web Pubsub service.
    :param _builtins.str resource_group_name: Specifies the name of the resource group the Web Pubsub service is located in.
    """
    __args__ = dict()
    __args__['name'] = name
