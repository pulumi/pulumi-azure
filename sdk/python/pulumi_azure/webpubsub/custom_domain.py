...
class CustomDomainArgs:
    def __init__(__self__, *,
                 ...
                 web_pubsub_custom_certificate_id: pulumi.Input[builtins.str],
    ...
    def web_pubsub_custom_certificate_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def web_pubsub_custom_certificate_id(self, value: pulumi.Input[builtins.str]):
...
class _CustomDomainState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 web_pubsub_custom_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="webPubsubCustomCertificateId")
    def web_pubsub_custom_certificate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Web PubSub Custom Certificate ID of the Web PubSub Custom Domain. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "web_pubsub_custom_certificate_id")
    ...
    @web_pubsub_custom_certificate_id.setter
    def web_pubsub_custom_certificate_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "web_pubsub_custom_certificate_id", value)
...
class CustomDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            web_pubsub_custom_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
            web_pubsub_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomDomain':
        """
    ...
    @property
    @pulumi.getter(name="webPubsubCustomCertificateId")
    def web_pubsub_custom_certificate_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Web PubSub Custom Certificate ID of the Web PubSub Custom Domain. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "web_pubsub_custom_certificate_id")
