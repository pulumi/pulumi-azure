...
class CustomCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] web_pubsub_id: The Web PubSub ID of the Web PubSub Custom Certificate. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Web PubSub Custom Certificate. Changing this forces a new resource to be created.
        """
...
class CustomCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            custom_certificate_id: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            web_pubsub_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'CustomCertificate':
        """
