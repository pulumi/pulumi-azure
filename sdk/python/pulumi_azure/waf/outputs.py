...
class PolicyCustomRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 group_rate_limit_by: Optional[builtins.str] = None,
        ...
        :param builtins.str rule_type: Describes the type of rule. Possible values are `MatchRule`, `RateLimitRule` and `Invalid`.
        :param builtins.bool enabled: Describes if the policy is in enabled state or disabled state. Defaults to `true`.
        :param builtins.str group_rate_limit_by: Specifies what grouping the rate limit will count requests by. Possible values are `GeoLocation`, `ClientAddr` and `None`.
        ...
        :param builtins.str rate_limit_duration: Specifies the duration at which the rate limit policy will be applied. Should be used with `RateLimitRule` rule type. Possible values are `FiveMins` and `OneMin`.
        :param builtins.int rate_limit_threshold: Specifies the threshold value for the rate limit policy. Must be greater than or equal to 1 if provided.
        """
    ...
    def group_rate_limit_by(self) -> Optional[builtins.str]:
        """
    ...
    def rate_limit_duration(self) -> Optional[builtins.str]:
        """
...
class PolicyCustomRuleMatchCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str operator: Describes operator to be matched. Possible values are `Any`, `IPMatch`, `GeoMatch`, `Equal`, `Contains`, `LessThan`, `GreaterThan`, `LessThanOrEqual`, `GreaterThanOrEqual`, `BeginsWith`, `EndsWith` and `Regex`.
        :param Sequence[builtins.str] match_values: A list of match values. This is **Required** when the `operator` is not `Any`.
        :param builtins.bool negation_condition: Describes if this is negate condition or not
        :param Sequence[builtins.str] transforms: A list of transformations to do before the match is attempted. Possible values are `HtmlEntityDecode`, `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` and `UrlEncode`.
        """
...
class PolicyCustomRuleMatchConditionMatchVariable(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str variable_name: The name of the Match Variable. Possible values are `RemoteAddr`, `RequestMethod`, `QueryString`, `PostArgs`, `RequestUri`, `RequestHeaders`, `RequestBody` and `RequestCookies`.
        :param builtins.str selector: Describes field of the matchVariable collection
        """
...
class PolicyManagedRulesExclusion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str match_variable: The name of the Match Variable. Possible values: `RequestArgKeys`, `RequestArgNames`, `RequestArgValues`, `RequestCookieKeys`, `RequestCookieNames`, `RequestCookieValues`, `RequestHeaderKeys`, `RequestHeaderNames`, `RequestHeaderValues`.
        :param builtins.str selector: Describes field of the matchVariable collection.
        :param builtins.str selector_match_operator: Describes operator to be matched. Possible values: `Contains`, `EndsWith`, `Equals`, `EqualsAny`, `StartsWith`.
...
class PolicyManagedRulesExclusionExcludedRuleSet(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: The rule set type. Possible values are `Microsoft_DefaultRuleSet`, `Microsoft_BotManagerRuleSet` and `OWASP`. Defaults to `OWASP`.
        :param builtins.str version: The rule set version. Possible values are `1.0`, `1.1` (for rule set type `Microsoft_BotManagerRuleSet`), `2.1` (for rule set type `Microsoft_DefaultRuleSet`) and `3.2` (for rule set type `OWASP`). Defaults to `3.2`.
        """
...
class PolicyManagedRulesExclusionExcludedRuleSetRuleGroup(dict):
    ...
    def excluded_rules(self) -> Optional[Sequence[builtins.str]]:
        """
...
class PolicyManagedRulesManagedRuleSet(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str version: The rule set version. Possible values: `0.1`, `1.0`, `1.1`, `2.1`, `2.2.9`, `3.0`, `3.1` and `3.2`.
        ...
        :param builtins.str type: The rule set type. Possible values: `Microsoft_BotManagerRuleSet`, `Microsoft_DefaultRuleSet` and `OWASP`. Defaults to `OWASP`.
        """
        pulumi.set(__self__, "version", version)
...
class PolicyManagedRulesManagedRuleSetRuleGroupOverrideRule(dict):
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str id: Identifier for the managed rule.
        :param builtins.str action: Describes the override action to be applied when rule matches. Possible values are `Allow`, `AnomalyScoring`, `Block`, `JSChallenge` and `Log`. `JSChallenge` is only valid for rulesets of type `Microsoft_BotManagerRuleSet`.
        :param builtins.bool enabled: Describes if the managed rule is in enabled state or disabled state. Defaults to `false`.
        """
...
class PolicyPolicySettings(dict):
    ...
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None,
                 file_upload_enforcement: Optional[builtins.bool] = None,
                 file_upload_limit_in_mb: Optional[builtins.int] = None,
                 js_challenge_cookie_expiration_in_minutes: Optional[builtins.int] = None,
                 log_scrubbing: Optional['outputs.PolicyPolicySettingsLogScrubbing'] = None,
                 max_request_body_size_in_kb: Optional[builtins.int] = None,
                 mode: Optional[builtins.str] = None,
                 request_body_check: Optional[builtins.bool] = None,
                 request_body_enforcement: Optional[builtins.bool] = None,
                 request_body_inspect_limit_in_kb: Optional[builtins.int] = None):
        """
        :param builtins.bool enabled: Describes if the policy is in enabled state or disabled state. Defaults to `true`.
        :param builtins.bool file_upload_enforcement: Whether the firewall should block a request with upload size greater then `file_upload_limit_in_mb`.
        :param builtins.int file_upload_limit_in_mb: The File Upload Limit in MB. Accepted values are in the range `1` to `4000`. Defaults to `100`.
        :param builtins.int js_challenge_cookie_expiration_in_minutes: Specifies the JavaScript challenge cookie validity lifetime in minutes. The user is challenged after the lifetime expires. Accepted values are in the range `5` to `1440`. Defaults to `30`.
        :param 'PolicyPolicySettingsLogScrubbingArgs' log_scrubbing: One `log_scrubbing` block as defined below.
        :param builtins.int max_request_body_size_in_kb: The Maximum Request Body Size in KB. Accepted values are in the range `8` to `2000`. Defaults to `128`.
        :param builtins.str mode: Describes if it is in detection mode or prevention mode at the policy level. Valid values are `Detection` and `Prevention`. Defaults to `Prevention`.
        :param builtins.bool request_body_check: Is Request Body Inspection enabled? Defaults to `true`.
        :param builtins.bool request_body_enforcement: Whether the firewall should block a request with body size greater then `max_request_body_size_in_kb`. Defaults to `true`.
        :param builtins.int request_body_inspect_limit_in_kb: Specifies the maximum request body inspection limit in KB for the Web Application Firewall. Defaults to `128`.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def file_upload_enforcement(self) -> Optional[builtins.bool]:
        """
    ...
    def file_upload_limit_in_mb(self) -> Optional[builtins.int]:
        """
    ...
    def js_challenge_cookie_expiration_in_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def max_request_body_size_in_kb(self) -> Optional[builtins.int]:
        """
    ...
    def request_body_enforcement(self) -> Optional[builtins.bool]:
        """
    ...
    def request_body_inspect_limit_in_kb(self) -> Optional[builtins.int]:
        """
...
class PolicyPolicySettingsLogScrubbing(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether the log scrubbing is enabled or disabled. Defaults to `true`.
