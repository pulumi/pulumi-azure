...
def get_firewall_policy(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str name: The name of the Web Application Firewall Policy
    :param builtins.str resource_group_name: The name of the Resource Group where the Web Application Firewall Policy exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_firewall_policy_output(name: Optional[pulumi.Input[builtins.str]] = None,
