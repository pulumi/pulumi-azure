...
if not MYPY:
    class PolicyCustomRuleArgsDict(TypedDict):
        ...
        """
        group_rate_limit_by: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        rate_limit_duration: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicyCustomRuleArgs:
    def __init__(__self__, *,
                 ...
                 group_rate_limit_by: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] rule_type: Describes the type of rule. Possible values are `MatchRule`, `RateLimitRule` and `Invalid`.
        :param pulumi.Input[builtins.bool] enabled: Describes if the policy is in enabled state or disabled state. Defaults to `true`.
        :param pulumi.Input[builtins.str] group_rate_limit_by: Specifies what grouping the rate limit will count requests by. Possible values are `GeoLocation`, `ClientAddr` and `None`.
        ...
        :param pulumi.Input[builtins.str] rate_limit_duration: Specifies the duration at which the rate limit policy will be applied. Should be used with `RateLimitRule` rule type. Possible values are `FiveMins` and `OneMin`.
        :param pulumi.Input[builtins.int] rate_limit_threshold: Specifies the threshold value for the rate limit policy. Must be greater than or equal to 1 if provided.
        """
    ...
    def group_rate_limit_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies what grouping the rate limit will count requests by. Possible values are `GeoLocation`, `ClientAddr` and `None`.
        """
    ...
    def group_rate_limit_by(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def rate_limit_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the duration at which the rate limit policy will be applied. Should be used with `RateLimitRule` rule type. Possible values are `FiveMins` and `OneMin`.
        """
    ...
    def rate_limit_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyCustomRuleMatchConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operator: Describes operator to be matched. Possible values are `Any`, `IPMatch`, `GeoMatch`, `Equal`, `Contains`, `LessThan`, `GreaterThan`, `LessThanOrEqual`, `GreaterThanOrEqual`, `BeginsWith`, `EndsWith` and `Regex`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] match_values: A list of match values. This is **Required** when the `operator` is not `Any`.
        :param pulumi.Input[builtins.bool] negation_condition: Describes if this is negate condition or not
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] transforms: A list of transformations to do before the match is attempted. Possible values are `HtmlEntityDecode`, `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` and `UrlEncode`.
        """
...
class PolicyCustomRuleMatchConditionMatchVariableArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] variable_name: The name of the Match Variable. Possible values are `RemoteAddr`, `RequestMethod`, `QueryString`, `PostArgs`, `RequestUri`, `RequestHeaders`, `RequestBody` and `RequestCookies`.
        :param pulumi.Input[builtins.str] selector: Describes field of the matchVariable collection
        """
...
if not MYPY:
    class PolicyManagedRulesExclusionArgsDict(TypedDict):
        ...
        Describes field of the matchVariable collection.
        """
        selector_match_operator: pulumi.Input[builtins.str]
        """
...
class PolicyManagedRulesExclusionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] match_variable: The name of the Match Variable. Possible values: `RequestArgKeys`, `RequestArgNames`, `RequestArgValues`, `RequestCookieKeys`, `RequestCookieNames`, `RequestCookieValues`, `RequestHeaderKeys`, `RequestHeaderNames`, `RequestHeaderValues`.
        :param pulumi.Input[builtins.str] selector: Describes field of the matchVariable collection.
        :param pulumi.Input[builtins.str] selector_match_operator: Describes operator to be matched. Possible values: `Contains`, `EndsWith`, `Equals`, `EqualsAny`, `StartsWith`.
    ...
    def selector_match_operator(self) -> pulumi.Input[builtins.str]:
        """
        Describes operator to be matched. Possible values: `Contains`, `EndsWith`, `Equals`, `EqualsAny`, `StartsWith`.
        """
    ...
    def selector_match_operator(self, value: pulumi.Input[builtins.str]):
...
class PolicyManagedRulesExclusionExcludedRuleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The rule set type. Possible values are `Microsoft_DefaultRuleSet`, `Microsoft_BotManagerRuleSet` and `OWASP`. Defaults to `OWASP`.
        :param pulumi.Input[builtins.str] version: The rule set version. Possible values are `1.0`, `1.1` (for rule set type `Microsoft_BotManagerRuleSet`), `2.1` (for rule set type `Microsoft_DefaultRuleSet`) and `3.2` (for rule set type `OWASP`). Defaults to `3.2`.
        """
...
if not MYPY:
    class PolicyManagedRulesExclusionExcludedRuleSetRuleGroupArgsDict(TypedDict):
        ...
        """
        excluded_rules: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PolicyManagedRulesExclusionExcludedRuleSetRuleGroupArgs:
    def __init__(__self__, *,
                 rule_group_name: pulumi.Input[builtins.str],
                 excluded_rules: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] rule_group_name: The name of rule group for exclusion. Possible values are `BadBots`, `crs_20_protocol_violations`, `crs_21_protocol_anomalies`, `crs_23_request_limits`, `crs_30_http_policy`, `crs_35_bad_robots`, `crs_40_generic_attacks`, `crs_41_sql_injection_attacks`, `crs_41_xss_attacks`, `crs_42_tight_security`, `crs_45_trojans`, `crs_49_inbound_blocking`, `General`, `GoodBots`, `KnownBadBots`, `Known-CVEs`, `REQUEST-911-METHOD-ENFORCEMENT`, `REQUEST-913-SCANNER-DETECTION`, `REQUEST-920-PROTOCOL-ENFORCEMENT`, `REQUEST-921-PROTOCOL-ATTACK`, `REQUEST-930-APPLICATION-ATTACK-LFI`, `REQUEST-931-APPLICATION-ATTACK-RFI`, `REQUEST-932-APPLICATION-ATTACK-RCE`, `REQUEST-933-APPLICATION-ATTACK-PHP`, `REQUEST-941-APPLICATION-ATTACK-XSS`, `REQUEST-942-APPLICATION-ATTACK-SQLI`, `REQUEST-943-APPLICATION-ATTACK-SESSION-FIXATION`, `REQUEST-944-APPLICATION-ATTACK-JAVA`, `UnknownBots`, `METHOD-ENFORCEMENT`, `PROTOCOL-ENFORCEMENT`, `PROTOCOL-ATTACK`, `LFI`, `RFI`, `RCE`, `PHP`, `NODEJS`, `XSS`, `SQLI`, `FIX`, `JAVA`, `MS-ThreatIntel-WebShells`, `MS-ThreatIntel-AppSec`, `MS-ThreatIntel-SQLI` and `MS-ThreatIntel-CVEs`.
               `MS-ThreatIntel-AppSec`, `MS-ThreatIntel-SQLI` and `MS-ThreatIntel-CVEs`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_rules: One or more Rule IDs for exclusion.
        """
    ...
    def excluded_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more Rule IDs for exclusion.
        """
    ...
    def excluded_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class PolicyManagedRulesManagedRuleSetArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] version: The rule set version. Possible values: `0.1`, `1.0`, `1.1`, `2.1`, `2.2.9`, `3.0`, `3.1` and `3.2`.
        ...
        :param pulumi.Input[builtins.str] type: The rule set type. Possible values: `Microsoft_BotManagerRuleSet`, `Microsoft_DefaultRuleSet` and `OWASP`. Defaults to `OWASP`.
        """
        pulumi.set(__self__, "version", version)
...
class PolicyManagedRulesManagedRuleSetRuleGroupOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] rule_group_name: The name of the Rule Group. Possible values are `BadBots`, `crs_20_protocol_violations`, `crs_21_protocol_anomalies`, `crs_23_request_limits`, `crs_30_http_policy`, `crs_35_bad_robots`, `crs_40_generic_attacks`, `crs_41_sql_injection_attacks`, `crs_41_xss_attacks`, `crs_42_tight_security`, `crs_45_trojans`, `crs_49_inbound_blocking`, `General`, `GoodBots`, `KnownBadBots`, `Known-CVEs`, `REQUEST-911-METHOD-ENFORCEMENT`, `REQUEST-913-SCANNER-DETECTION`, `REQUEST-920-PROTOCOL-ENFORCEMENT`, `REQUEST-921-PROTOCOL-ATTACK`, `REQUEST-930-APPLICATION-ATTACK-LFI`, `REQUEST-931-APPLICATION-ATTACK-RFI`, `REQUEST-932-APPLICATION-ATTACK-RCE`, `REQUEST-933-APPLICATION-ATTACK-PHP`, `REQUEST-941-APPLICATION-ATTACK-XSS`, `REQUEST-942-APPLICATION-ATTACK-SQLI`, `REQUEST-943-APPLICATION-ATTACK-SESSION-FIXATION`, `REQUEST-944-APPLICATION-ATTACK-JAVA`, `UnknownBots`, `METHOD-ENFORCEMENT`, `PROTOCOL-ENFORCEMENT`, `PROTOCOL-ATTACK`, `LFI`, `RFI`, `RCE`, `PHP`, `NODEJS`, `XSS`, `SQLI`, `FIX`, `JAVA`, `MS-ThreatIntel-WebShells`, `MS-ThreatIntel-AppSec`, `MS-ThreatIntel-SQLI` and `MS-ThreatIntel-CVEs`MS-ThreatIntel-WebShells`,.
...
class PolicyManagedRulesManagedRuleSetRuleGroupOverrideRuleArgs:
    def __init__(__self__, *,
                 ...
                 enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] id: Identifier for the managed rule.
        :param pulumi.Input[builtins.str] action: Describes the override action to be applied when rule matches. Possible values are `Allow`, `AnomalyScoring`, `Block`, `JSChallenge` and `Log`. `JSChallenge` is only valid for rulesets of type `Microsoft_BotManagerRuleSet`.
        :param pulumi.Input[builtins.bool] enabled: Describes if the managed rule is in enabled state or disabled state. Defaults to `false`.
        """
...
if not MYPY:
    class PolicyPolicySettingsArgsDict(TypedDict):
        ...
        Describes if the policy is in enabled state or disabled state. Defaults to `true`.
        """
        file_upload_enforcement: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the firewall should block a request with upload size greater then `file_upload_limit_in_mb`.
        """
        file_upload_limit_in_mb: NotRequired[pulumi.Input[builtins.int]]
        """
        The File Upload Limit in MB. Accepted values are in the range `1` to `4000`. Defaults to `100`.
        """
        js_challenge_cookie_expiration_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        max_request_body_size_in_kb: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        request_body_check: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is Request Body Inspection enabled? Defaults to `true`.
        """
        request_body_enforcement: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the firewall should block a request with body size greater then `max_request_body_size_in_kb`. Defaults to `true`.
        """
        request_body_inspect_limit_in_kb: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PolicyPolicySettingsArgs:
    def __init__(__self__, *,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 file_upload_enforcement: Optional[pulumi.Input[builtins.bool]] = None,
                 file_upload_limit_in_mb: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 max_request_body_size_in_kb: Optional[pulumi.Input[builtins.int]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 request_body_check: Optional[pulumi.Input[builtins.bool]] = None,
                 request_body_enforcement: Optional[pulumi.Input[builtins.bool]] = None,
                 request_body_inspect_limit_in_kb: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Describes if the policy is in enabled state or disabled state. Defaults to `true`.
        :param pulumi.Input[builtins.bool] file_upload_enforcement: Whether the firewall should block a request with upload size greater then `file_upload_limit_in_mb`.
        :param pulumi.Input[builtins.int] file_upload_limit_in_mb: The File Upload Limit in MB. Accepted values are in the range `1` to `4000`. Defaults to `100`.
        :param pulumi.Input[builtins.int] js_challenge_cookie_expiration_in_minutes: Specifies the JavaScript challenge cookie validity lifetime in minutes. The user is challenged after the lifetime expires. Accepted values are in the range `5` to `1440`. Defaults to `30`.
        :param pulumi.Input['PolicyPolicySettingsLogScrubbingArgs'] log_scrubbing: One `log_scrubbing` block as defined below.
        :param pulumi.Input[builtins.int] max_request_body_size_in_kb: The Maximum Request Body Size in KB. Accepted values are in the range `8` to `2000`. Defaults to `128`.
        :param pulumi.Input[builtins.str] mode: Describes if it is in detection mode or prevention mode at the policy level. Valid values are `Detection` and `Prevention`. Defaults to `Prevention`.
        :param pulumi.Input[builtins.bool] request_body_check: Is Request Body Inspection enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] request_body_enforcement: Whether the firewall should block a request with body size greater then `max_request_body_size_in_kb`. Defaults to `true`.
        :param pulumi.Input[builtins.int] request_body_inspect_limit_in_kb: Specifies the maximum request body inspection limit in KB for the Web Application Firewall. Defaults to `128`.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
    ...
    def file_upload_enforcement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the firewall should block a request with upload size greater then `file_upload_limit_in_mb`.
        """
    ...
    def file_upload_enforcement(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "file_upload_enforcement", value)

    @property
    @pulumi.getter(name="fileUploadLimitInMb")
    def file_upload_limit_in_mb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The File Upload Limit in MB. Accepted values are in the range `1` to `4000`. Defaults to `100`.
        """
    ...
    def file_upload_limit_in_mb(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def max_request_body_size_in_kb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The Maximum Request Body Size in KB. Accepted values are in the range `8` to `2000`. Defaults to `128`.
        """
    ...
    def max_request_body_size_in_kb(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def request_body_check(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is Request Body Inspection enabled? Defaults to `true`.
        """
    ...
    def request_body_check(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "request_body_check", value)

    @property
    @pulumi.getter(name="requestBodyEnforcement")
    def request_body_enforcement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the firewall should block a request with body size greater then `max_request_body_size_in_kb`. Defaults to `true`.
        """
    ...
    def request_body_enforcement(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "request_body_enforcement", value)

    @property
    @pulumi.getter(name="requestBodyInspectLimitInKb")
    def request_body_inspect_limit_in_kb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the maximum request body inspection limit in KB for the Web Application Firewall. Defaults to `128`.
        """
    ...
    def request_body_inspect_limit_in_kb(self, value: Optional[pulumi.Input[builtins.int]]):
...
class PolicyPolicySettingsLogScrubbingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether the log scrubbing is enabled or disabled. Defaults to `true`.
...
if not MYPY:
    class PolicyPolicySettingsLogScrubbingRuleArgsDict(TypedDict):
        ...
        """
        selector_match_operator: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class PolicyPolicySettingsLogScrubbingRuleArgs:
    def __init__(__self__, *,
                 ...
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 selector: Optional[pulumi.Input[builtins.str]] = None,
                 selector_match_operator: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Describes if the managed rule is in enabled state or disabled state. Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="selectorMatchOperator")
    def selector_match_operator(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "selector_match_operator")

    @selector_match_operator.setter
    def selector_match_operator(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "selector_match_operator", value)
