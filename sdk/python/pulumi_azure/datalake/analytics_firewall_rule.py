...
@pulumi.input_type
class _AnalyticsFirewallRuleState:
    def __init__(__self__, *,
...
class AnalyticsFirewallRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AnalyticsFirewallRuleArgs.__new__(AnalyticsFirewallRuleArgs)
    ...
    def get(resource_name: str,
        ...
        __props__ = _AnalyticsFirewallRuleState.__new__(_AnalyticsFirewallRuleState)
