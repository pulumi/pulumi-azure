...
class FeaturesApiManagement(dict):
    def __init__(__self__, *,
                 purge_soft_delete_on_destroy: Optional[_builtins.bool] = None,
                 recover_soft_deleted: Optional[_builtins.bool] = None):
    ...
    def purge_soft_delete_on_destroy(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "purge_soft_delete_on_destroy")

    @_builtins.property
    @pulumi.getter(name="recoverSoftDeleted")
    def recover_soft_deleted(self) -> Optional[_builtins.bool]:
...
class FeaturesApplicationInsights(dict):
    def __init__(__self__, *,
                 disable_generated_rule: Optional[_builtins.bool] = None):
    ...
    def disable_generated_rule(self) -> Optional[_builtins.bool]:
...
class FeaturesDatabricksWorkspace(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool force_delete: When enabled, the managed resource group that contains the Unity Catalog data will be forcibly deleted when the workspace is destroyed, regardless of contents.
        """
...
class FeaturesKeyVault(dict):
    def __init__(__self__, *,
                 purge_soft_delete_on_destroy: Optional[_builtins.bool] = None,
                 purge_soft_deleted_certificates_on_destroy: Optional[_builtins.bool] = None,
                 purge_soft_deleted_hardware_security_module_keys_on_destroy: Optional[_builtins.bool] = None,
                 purge_soft_deleted_hardware_security_modules_on_destroy: Optional[_builtins.bool] = None,
                 purge_soft_deleted_keys_on_destroy: Optional[_builtins.bool] = None,
                 purge_soft_deleted_secrets_on_destroy: Optional[_builtins.bool] = None,
                 recover_soft_deleted_certificates: Optional[_builtins.bool] = None,
                 recover_soft_deleted_hardware_security_module_keys: Optional[_builtins.bool] = None,
                 recover_soft_deleted_key_vaults: Optional[_builtins.bool] = None,
                 recover_soft_deleted_keys: Optional[_builtins.bool] = None,
                 recover_soft_deleted_secrets: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool purge_soft_delete_on_destroy: When enabled soft-deleted `keyvault.KeyVault` resources will be permanently deleted (e.g purged), when destroyed
        :param _builtins.bool purge_soft_deleted_certificates_on_destroy: When enabled soft-deleted `keyvault.Certificate` resources will be permanently deleted (e.g purged), when destroyed
        :param _builtins.bool purge_soft_deleted_hardware_security_module_keys_on_destroy: When enabled soft-deleted `keyvault.ManagedHardwareSecurityModuleKey` resources will be permanently deleted (e.g purged), when destroyed
        :param _builtins.bool purge_soft_deleted_hardware_security_modules_on_destroy: When enabled soft-deleted `keyvault.ManagedHardwareSecurityModule` resources will be permanently deleted (e.g purged), when destroyed
        :param _builtins.bool purge_soft_deleted_keys_on_destroy: When enabled soft-deleted `keyvault.Key` resources will be permanently deleted (e.g purged), when destroyed
        :param _builtins.bool purge_soft_deleted_secrets_on_destroy: When enabled soft-deleted `keyvault.Secret` resources will be permanently deleted (e.g purged), when destroyed
        :param _builtins.bool recover_soft_deleted_certificates: When enabled soft-deleted `keyvault.Certificate` resources will be restored, instead of creating new ones
        :param _builtins.bool recover_soft_deleted_hardware_security_module_keys: When enabled soft-deleted `keyvault.ManagedHardwareSecurityModuleKey` resources will be restored, instead of creating new ones
        :param _builtins.bool recover_soft_deleted_key_vaults: When enabled soft-deleted `keyvault.KeyVault` resources will be restored, instead of creating new ones
        :param _builtins.bool recover_soft_deleted_keys: When enabled soft-deleted `keyvault.Key` resources will be restored, instead of creating new ones
        :param _builtins.bool recover_soft_deleted_secrets: When enabled soft-deleted `keyvault.Secret` resources will be restored, instead of creating new ones
        """
        if purge_soft_delete_on_destroy is not None:
            pulumi.set(__self__, "purge_soft_delete_on_destroy", purge_soft_delete_on_destroy)
    ...
    def purge_soft_deleted_certificates_on_destroy(self) -> Optional[_builtins.bool]:
        """
    ...
    def purge_soft_deleted_hardware_security_module_keys_on_destroy(self) -> Optional[_builtins.bool]:
        """
    ...
    def purge_soft_deleted_hardware_security_modules_on_destroy(self) -> Optional[_builtins.bool]:
        """
    ...
    def purge_soft_deleted_keys_on_destroy(self) -> Optional[_builtins.bool]:
        """
    ...
    def purge_soft_deleted_secrets_on_destroy(self) -> Optional[_builtins.bool]:
        """
    ...
    def recover_soft_deleted_certificates(self) -> Optional[_builtins.bool]:
        """
    ...
    def recover_soft_deleted_hardware_security_module_keys(self) -> Optional[_builtins.bool]:
        """
    ...
    def recover_soft_deleted_key_vaults(self) -> Optional[_builtins.bool]:
        """
    ...
    def recover_soft_deleted_keys(self) -> Optional[_builtins.bool]:
        """
    ...
    def recover_soft_deleted_secrets(self) -> Optional[_builtins.bool]:
        """
...
class FeaturesLogAnalyticsWorkspace(dict):
    def __init__(__self__, *,
                 permanently_delete_on_destroy: Optional[_builtins.bool] = None):
    ...
    def permanently_delete_on_destroy(self) -> Optional[_builtins.bool]:
...
class FeaturesMachineLearning(dict):
    def __init__(__self__, *,
                 purge_soft_deleted_workspace_on_destroy: Optional[_builtins.bool] = None):
    ...
    def purge_soft_deleted_workspace_on_destroy(self) -> Optional[_builtins.bool]:
...
class FeaturesManagedDisk(dict):
    def __init__(__self__, *,
                 expand_without_downtime: Optional[_builtins.bool] = None):
    ...
    def expand_without_downtime(self) -> Optional[_builtins.bool]:
...
class FeaturesNetapp(dict):
    def __init__(__self__, *,
                 delete_backups_on_backup_vault_destroy: Optional[_builtins.bool] = None,
                 prevent_volume_destruction: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool delete_backups_on_backup_vault_destroy: When enabled, backups will be deleted when the `netapp.BackupVault` resource is destroyed
        :param _builtins.bool prevent_volume_destruction: When enabled, the volume will not be destroyed, safeguarding from severe data loss
        """
    ...
    def delete_backups_on_backup_vault_destroy(self) -> Optional[_builtins.bool]:
        """
    ...
    def prevent_volume_destruction(self) -> Optional[_builtins.bool]:
        """
...
class FeaturesPostgresqlFlexibleServer(dict):
    def __init__(__self__, *,
                 restart_server_on_configuration_value_change: Optional[_builtins.bool] = None):
    ...
    def restart_server_on_configuration_value_change(self) -> Optional[_builtins.bool]:
...
class FeaturesRecoveryService(dict):
    def __init__(__self__, *,
                 purge_protected_items_from_vault_on_destroy: Optional[_builtins.bool] = None,
                 vm_backup_stop_protection_and_retain_data_on_destroy: Optional[_builtins.bool] = None,
                 vm_backup_suspend_protection_and_retain_data_on_destroy: Optional[_builtins.bool] = None):
    ...
    def purge_protected_items_from_vault_on_destroy(self) -> Optional[_builtins.bool]:
    ...
    def vm_backup_stop_protection_and_retain_data_on_destroy(self) -> Optional[_builtins.bool]:
    ...
    def vm_backup_suspend_protection_and_retain_data_on_destroy(self) -> Optional[_builtins.bool]:
...
class FeaturesRecoveryServicesVaults(dict):
    def __init__(__self__, *,
                 recover_soft_deleted_backup_protected_vm: Optional[_builtins.bool] = None):
    ...
    def recover_soft_deleted_backup_protected_vm(self) -> Optional[_builtins.bool]:
...
class FeaturesResourceGroup(dict):
    def __init__(__self__, *,
                 prevent_deletion_if_contains_resources: Optional[_builtins.bool] = None):
    ...
    def prevent_deletion_if_contains_resources(self) -> Optional[_builtins.bool]:
...
class FeaturesStorage(dict):
    ...
    def data_plane_available(self) -> Optional[_builtins.bool]:
...
class FeaturesSubscription(dict):
    def __init__(__self__, *,
                 prevent_cancellation_on_destroy: Optional[_builtins.bool] = None):
    ...
    def prevent_cancellation_on_destroy(self) -> Optional[_builtins.bool]:
...
class FeaturesTemplateDeployment(dict):
    def __init__(__self__, *,
                 delete_nested_items_during_deletion: _builtins.bool):
    ...
    def delete_nested_items_during_deletion(self) -> _builtins.bool:
...
class FeaturesVirtualMachine(dict):
    ...
    def delete_os_disk_on_deletion(self) -> Optional[_builtins.bool]:
    ...
    def skip_shutdown_and_force_delete(self) -> Optional[_builtins.bool]:
...
class FeaturesVirtualMachineScaleSet(dict):
    def __init__(__self__, *,
                 force_delete: Optional[_builtins.bool] = None,
                 reimage_on_manual_upgrade: Optional[_builtins.bool] = None,
                 roll_instances_when_required: Optional[_builtins.bool] = None,
                 scale_to_zero_before_deletion: Optional[_builtins.bool] = None):
        if force_delete is not None:
            pulumi.set(__self__, "force_delete", force_delete)
