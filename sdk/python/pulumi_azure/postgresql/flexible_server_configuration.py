...
class FlexibleServerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_id: The ID of the PostgreSQL Flexible Server where we want to change configuration. Changing this forces a new PostgreSQL Flexible Server Configuration resource.
        :param pulumi.Input[builtins.str] value: Specifies the value of the PostgreSQL Configuration. See the PostgreSQL documentation for valid values.
        :param pulumi.Input[builtins.str] name: Specifies the name of the PostgreSQL Configuration, which needs [to be a valid PostgreSQL configuration name](https://www.postgresql.org/docs/current/static/sql-syntax-lexical.html#SQL-SYNTAX-IDENTIFIER). Changing this forces a new resource to be created.
...
class FlexibleServerConfiguration(pulumi.CustomResource):
    ...
    pulumi_type = "azure:postgresql/flexibleServerConfiguration:FlexibleServerConfiguration"
