...
class FlexibleServerAuthentication(dict):
    ...
    def __init__(__self__, *,
                 active_directory_auth_enabled: Optional[builtins.bool] = None,
                 password_auth_enabled: Optional[builtins.bool] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.bool active_directory_auth_enabled: Whether Active Directory authentication is allowed to access the PostgreSQL Flexible Server. Defaults to `false`.
        :param builtins.bool password_auth_enabled: Whether password authentication is allowed to access the PostgreSQL Flexible Server. Defaults to `true`.
        :param builtins.str tenant_id: The Tenant ID of the Azure Active Directory which is used by the Active Directory authentication. `active_directory_auth_enabled` must be set to `true`.
    ...
    def active_directory_auth_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def password_auth_enabled(self) -> Optional[builtins.bool]:
        """
...
class FlexibleServerCustomerManagedKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_vault_key_id: The versioned/versionless ID of the Key Vault Key.
        :param builtins.str geo_backup_key_vault_key_id: The versioned ID of the geo backup Key Vault Key.
               
               > **Note:** The key vault in which this key exists must be in the same region as the geo-redundant backup.
        :param builtins.str geo_backup_user_assigned_identity_id: The geo backup user managed identity id for a Customer Managed Key. Must be added to `identity.identity_ids`.
        ...
        :param builtins.str primary_user_assigned_identity_id: Specifies the primary user managed identity id for a Customer Managed Key. Must be added to `identity.identity_ids`.
        """
...
class FlexibleServerHighAvailability(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str mode: The high availability mode for the PostgreSQL Flexible Server. Possible value are `SameZone` or `ZoneRedundant`.
        """
...
class FlexibleServerIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this PostgreSQL Flexible Server. Possible values are `UserAssigned`, `SystemAssigned` and `SystemAssigned, UserAssigned`.
...
class ServerIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this PostgreSQL Server. The only possible value is `SystemAssigned`.
        :param builtins.str principal_id: The Principal ID associated with this Managed Service Identity.
        :param builtins.str tenant_id: The Tenant ID associated with this Managed Service Identity.
        """
        pulumi.set(__self__, "type", type)
...
class ServerThreatDetectionPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 email_account_admins: Optional[builtins.bool] = None,
        ...
        """
        :param Sequence[builtins.str] disabled_alerts: Specifies a list of alerts which should be disabled. Possible values are `Sql_Injection`, `Sql_Injection_Vulnerability`, `Access_Anomaly`, `Data_Exfiltration` and `Unsafe_Action`.
        :param builtins.bool email_account_admins: Should the account administrators be emailed when this alert is triggered?
        :param Sequence[builtins.str] email_addresses: A list of email addresses which alerts should be sent to.
        :param builtins.bool enabled: Is the policy enabled?
        :param builtins.int retention_days: Specifies the number of days to keep in the Threat Detection audit logs.
        :param builtins.str storage_account_access_key: Specifies the identifier key of the Threat Detection audit storage account.
        :param builtins.str storage_endpoint: Specifies the blob storage endpoint (e.g. <https://example.blob.core.windows.net>). This blob storage will hold all Threat Detection audit logs.
        """
...
class GetServerIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str principal_id: The ID of the System Managed Service Principal assigned to the PostgreSQL Server.
        :param builtins.str tenant_id: The ID of the Tenant of the System Managed Service Principal assigned to the PostgreSQL Server.
        :param builtins.str type: The identity type of the Managed Identity assigned to the PostgreSQL Server.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
        pulumi.set(__self__, "type", type)
