...
class FlexibleServerFirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] end_ip_address: The End IP Address associated with this PostgreSQL Flexible Server Firewall Rule.
        :param pulumi.Input[builtins.str] server_id: The ID of the PostgreSQL Flexible Server from which to create this PostgreSQL Flexible Server Firewall Rule. Changing this forces a new PostgreSQL Flexible Server Firewall Rule to be created.
        :param pulumi.Input[builtins.str] start_ip_address: The Start IP Address associated with this PostgreSQL Flexible Server Firewall Rule.
        :param pulumi.Input[builtins.str] name: The name which should be used for this PostgreSQL Flexible Server Firewall Rule. Changing this forces a new PostgreSQL Flexible Server Firewall Rule to be created.
        """
