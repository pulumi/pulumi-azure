...
class ServerKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_vault_key_id: The URL to a Key Vault Key.
        :param pulumi.Input[builtins.str] server_id: The ID of the PostgreSQL Server. Changing this forces a new resource to be created.
        """
...
class ServerKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
            server_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServerKey':
        """
