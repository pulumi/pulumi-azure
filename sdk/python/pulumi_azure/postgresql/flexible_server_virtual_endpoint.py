...
class FlexibleServerVirtualEndpointArgs:
    def __init__(__self__, *,
                 replica_server_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] replica_server_id: The Resource ID of the *Replica* Postgres Flexible Server this should be associated with
        ...
        :param pulumi.Input[builtins.str] source_server_id: The Resource ID of the *Source* Postgres Flexible Server this should be associated with.
        :param pulumi.Input[builtins.str] type: The type of Virtual Endpoint. Currently only `ReadWrite` is supported.
        :param pulumi.Input[builtins.str] name: The name of the Virtual Endpoint
        """
    ...
    def replica_server_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replica_server_id(self, value: pulumi.Input[builtins.str]):
...
class _FlexibleServerVirtualEndpointState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 replica_server_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="replicaServerId")
    def replica_server_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Resource ID of the *Replica* Postgres Flexible Server this should be associated with
    ...
    @replica_server_id.setter
    def replica_server_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replica_server_id", value)
...
class FlexibleServerVirtualEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            replica_server_id: Optional[pulumi.Input[builtins.str]] = None,
            source_server_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'FlexibleServerVirtualEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="replicaServerId")
    def replica_server_id(self) -> pulumi.Output[builtins.str]:
        """
        The Resource ID of the *Replica* Postgres Flexible Server this should be associated with
    ...
    @property
    @pulumi.getter(name="sourceServerId")
    def source_server_id(self) -> pulumi.Output[builtins.str]:
        """
        The Resource ID of the *Source* Postgres Flexible Server this should be associated with.
        """
        return pulumi.get(self, "source_server_id")
