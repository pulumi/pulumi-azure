...
class FirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] end_ip_address: Specifies the End IP Address associated with this Firewall Rule. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] start_ip_address: Specifies the Start IP Address associated with this Firewall Rule. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the PostgreSQL Firewall Rule. Changing this forces a new resource to be created.
        """
...
@pulumi.type_token("azure:postgresql/firewallRule:FirewallRule")
class FirewallRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        > **Note:** The `postgresql.FirewallRule` resource is deprecated and will be removed in v5.0 of the AzureRM Provider. Azure Database for PostgreSQL Single Server and its sub resources have been retired as of 2025-03-28, please use the `postgresql.FlexibleServerFirewallRule` resource instead. For more information, see https://techcommunity.microsoft.com/blog/adforpostgresql/retiring-azure-database-for-postgresql-single-server-in-2025/3783783.
