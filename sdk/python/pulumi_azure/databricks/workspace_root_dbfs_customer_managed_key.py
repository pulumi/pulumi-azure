...
class WorkspaceRootDbfsCustomerManagedKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_vault_key_id: The resource ID of the Key Vault Key to be used.
        :param pulumi.Input[builtins.str] workspace_id: The resource ID of the Databricks Workspace.
        """
...
@pulumi.type_token("azure:databricks/workspaceRootDbfsCustomerManagedKey:WorkspaceRootDbfsCustomerManagedKey")
class WorkspaceRootDbfsCustomerManagedKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_vault_id: Optional[pulumi.Input[builtins.str]] = None,
            key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceRootDbfsCustomerManagedKey':
        """
