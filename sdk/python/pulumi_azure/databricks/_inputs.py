...
class AccessConnectorIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] type: Specifies the type of Managed Service Identity that should be configured on the Databricks Access Connector. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to the Databricks Access Connector. Only one User Assigned Managed Identity ID is supported per Databricks Access Connector resource.
               
               > **Note:** `identity_ids` are required when `type` is set to `UserAssigned`.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Access Connector.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Access Connector.
        """
...
class WorkspaceCustomParametersArgsDict(TypedDict):
    machine_learning_workspace_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    nat_gateway_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    private_subnet_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    private_subnet_network_security_group_association_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    public_ip_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    public_subnet_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    public_subnet_network_security_group_association_id: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    storage_account_sku_name: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    vnet_address_prefix: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class WorkspaceCustomParametersArgs:
    def __init__(__self__, *,
                 ...
                 private_subnet_name: pulumi.Input[Optional[_builtins.str]] = None,
                 private_subnet_network_security_group_association_id: pulumi.Input[Optional[_builtins.str]] = None,
                 public_ip_name: pulumi.Input[Optional[_builtins.str]] = None,
                 public_subnet_name: pulumi.Input[Optional[_builtins.str]] = None,
                 public_subnet_network_security_group_association_id: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_account_name: pulumi.Input[Optional[_builtins.str]] = None,
                 storage_account_sku_name: pulumi.Input[Optional[_builtins.str]] = None,
                 virtual_network_id: pulumi.Input[Optional[_builtins.str]] = None,
                 vnet_address_prefix: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] machine_learning_workspace_id: The ID of a Azure Machine Learning workspace to link with Databricks workspace. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] nat_gateway_name: Name of the NAT gateway for Secure Cluster Connectivity (No Public IP) workspace subnets (only for workspace with managed virtual network). Defaults to `nat-gateway`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.bool] no_public_ip: Are public IP Addresses not allowed? Possible values are `true` or `false`. Defaults to `true`.
               
               > **Note:** Updating `no_public_ip` parameter is only allowed if the value is changing from `false` to `true` and only for VNet-injected workspaces.
               
               > **Note:** In `v3.104.0` and higher of the provider the `no_public_ip` parameter will now default to `true` instead of `false`.
        :param pulumi.Input[_builtins.str] private_subnet_name: The name of the Private Subnet within the Virtual Network. Required if `virtual_network_id` is set. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] private_subnet_network_security_group_association_id: The resource ID of the `network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `private_subnet_name` field. This is the same as the ID of the subnet referred to by the `private_subnet_name` field. Required if `virtual_network_id` is set.
        :param pulumi.Input[_builtins.str] public_ip_name: Name of the Public IP for No Public IP workspace with managed virtual network. Defaults to `nat-gw-public-ip`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] public_subnet_name: The name of the Public Subnet within the Virtual Network. Required if `virtual_network_id` is set. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] public_subnet_network_security_group_association_id: The resource ID of the `network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `public_subnet_name` field. This is the same as the ID of the subnet referred to by the `public_subnet_name` field. Required if `virtual_network_id` is set.
        :param pulumi.Input[_builtins.str] storage_account_name: Default Databricks File Storage account name. Defaults to a randomized name(e.g. `dbstoragel6mfeghoe5kxu`). Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] storage_account_sku_name: Storage account SKU name. Possible values include `Standard_LRS`, `Standard_GRS`, `Standard_RAGRS`, `Standard_GZRS`, `Standard_RAGZRS`, `Standard_ZRS`, `Premium_LRS` or `Premium_ZRS`. Defaults to `Standard_GRS`.
        :param pulumi.Input[_builtins.str] virtual_network_id: The ID of a Virtual Network where this Databricks Cluster should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] vnet_address_prefix: Address prefix for Managed virtual network. Defaults to `10.139`. Changing this forces a new resource to be created.
    ...
    def private_subnet_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name of the Private Subnet within the Virtual Network. Required if `virtual_network_id` is set. Changing this forces a new resource to be created.
        """
    ...
    def private_subnet_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "private_subnet_name", value)

    @_builtins.property
    @pulumi.getter(name="privateSubnetNetworkSecurityGroupAssociationId")
    def private_subnet_network_security_group_association_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The resource ID of the `network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `private_subnet_name` field. This is the same as the ID of the subnet referred to by the `private_subnet_name` field. Required if `virtual_network_id` is set.
        """
    ...
    def private_subnet_network_security_group_association_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "private_subnet_network_security_group_association_id", value)

    @_builtins.property
    @pulumi.getter(name="publicIpName")
    def public_ip_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Name of the Public IP for No Public IP workspace with managed virtual network. Defaults to `nat-gw-public-ip`. Changing this forces a new resource to be created.
        """
    ...
    def public_ip_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "public_ip_name", value)

    @_builtins.property
    @pulumi.getter(name="publicSubnetName")
    def public_subnet_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name of the Public Subnet within the Virtual Network. Required if `virtual_network_id` is set. Changing this forces a new resource to be created.
        """
    ...
    def public_subnet_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "public_subnet_name", value)

    @_builtins.property
    @pulumi.getter(name="publicSubnetNetworkSecurityGroupAssociationId")
    def public_subnet_network_security_group_association_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The resource ID of the `network.SubnetNetworkSecurityGroupAssociation` resource which is referred to by the `public_subnet_name` field. This is the same as the ID of the subnet referred to by the `public_subnet_name` field. Required if `virtual_network_id` is set.
        """
    ...
    def public_subnet_network_security_group_association_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def storage_account_sku_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Storage account SKU name. Possible values include `Standard_LRS`, `Standard_GRS`, `Standard_RAGRS`, `Standard_GZRS`, `Standard_RAGZRS`, `Standard_ZRS`, `Premium_LRS` or `Premium_ZRS`. Defaults to `Standard_GRS`.
        """
    ...
    def storage_account_sku_name(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def vnet_address_prefix(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Address prefix for Managed virtual network. Defaults to `10.139`. Changing this forces a new resource to be created.
    ...
    def vnet_address_prefix(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "vnet_address_prefix", value)


class WorkspaceEnhancedSecurityComplianceArgsDict(TypedDict):
    automatic_cluster_update_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    Enables automatic cluster updates for this workspace. Defaults to `false`.
    """
    compliance_security_profile_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    compliance_security_profile_standards: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    ...
    """
    enhanced_security_monitoring_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class WorkspaceEnhancedSecurityComplianceArgs:
    def __init__(__self__, *,
                 automatic_cluster_update_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 compliance_security_profile_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 compliance_security_profile_standards: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 enhanced_security_monitoring_enabled: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        :param pulumi.Input[_builtins.bool] automatic_cluster_update_enabled: Enables automatic cluster updates for this workspace. Defaults to `false`.
        :param pulumi.Input[_builtins.bool] compliance_security_profile_enabled: Enables compliance security profile for this workspace. Defaults to `false`.
               
               > **Note:** Changing the value of `compliance_security_profile_enabled` from `true` to `false` forces a replacement of the Databricks workspace.
               
               > **Note:** The attributes `automatic_cluster_update_enabled` and `enhanced_security_monitoring_enabled` must be set to `true` in order to set `compliance_security_profile_enabled` to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] compliance_security_profile_standards: A list of standards to enforce on this workspace. Possible values include `HIPAA` and `PCI_DSS`.
               
               > **Note:** `compliance_security_profile_enabled` must be set to `true` in order to use `compliance_security_profile_standards`.
               
               > **Note:** Removing a standard from the `compliance_security_profile_standards` list forces a replacement of the Databricks workspace.
        :param pulumi.Input[_builtins.bool] enhanced_security_monitoring_enabled: Enables enhanced security monitoring for this workspace. Defaults to `false`.
        """
    ...
    def automatic_cluster_update_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enables automatic cluster updates for this workspace. Defaults to `false`.
        """
    ...
    def automatic_cluster_update_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "automatic_cluster_update_enabled", value)

    @_builtins.property
    @pulumi.getter(name="complianceSecurityProfileEnabled")
    def compliance_security_profile_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enables compliance security profile for this workspace. Defaults to `false`.
    ...
    def compliance_security_profile_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "compliance_security_profile_enabled", value)

    @_builtins.property
    @pulumi.getter(name="complianceSecurityProfileStandards")
    def compliance_security_profile_standards(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        A list of standards to enforce on this workspace. Possible values include `HIPAA` and `PCI_DSS`.
    ...
    def compliance_security_profile_standards(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "compliance_security_profile_standards", value)

    @_builtins.property
    @pulumi.getter(name="enhancedSecurityMonitoringEnabled")
    def enhanced_security_monitoring_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enables enhanced security monitoring for this workspace. Defaults to `false`.
        """
    ...
    def enhanced_security_monitoring_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class WorkspaceManagedDiskIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] principal_id: The principal UUID for the internal databricks storage account needed to provide access to the workspace for enabling Customer Managed Keys.
        :param pulumi.Input[_builtins.str] tenant_id: The UUID of the tenant where the internal databricks storage account was created.
        :param pulumi.Input[_builtins.str] type: The type of the internal databricks storage account.
        """
        if principal_id is not None:
            pulumi.set(__self__, "principal_id", principal_id)
        if tenant_id is not None:
