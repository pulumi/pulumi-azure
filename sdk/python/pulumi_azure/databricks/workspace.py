...
class WorkspaceArgs:
    def __init__(__self__, *,
        ...
        if managed_disk_cmk_key_vault_id is not None:
            warnings.warn("""`managed_disk_cmk_key_vault_id` has been deprecated and will be removed in v6.0 of the AzureRM provider. This property is no longer required for cross-subscription scenarios.""", DeprecationWarning)
            pulumi.log.warn("""managed_disk_cmk_key_vault_id is deprecated: `managed_disk_cmk_key_vault_id` has been deprecated and will be removed in v6.0 of the AzureRM provider. This property is no longer required for cross-subscription scenarios.""")
        if managed_disk_cmk_key_vault_id is not None:
        ...
        if managed_services_cmk_key_vault_id is not None:
            warnings.warn("""`managed_services_cmk_key_vault_id` has been deprecated and will be removed in v6.0 of the AzureRM provider. This property is no longer required for cross-subscription scenarios.""", DeprecationWarning)
            pulumi.log.warn("""managed_services_cmk_key_vault_id is deprecated: `managed_services_cmk_key_vault_id` has been deprecated and will be removed in v6.0 of the AzureRM provider. This property is no longer required for cross-subscription scenarios.""")
        if managed_services_cmk_key_vault_id is not None:
    ...
    @_utilities.deprecated("""`managed_disk_cmk_key_vault_id` has been deprecated and will be removed in v6.0 of the AzureRM provider. This property is no longer required for cross-subscription scenarios.""")
    ...
    @_utilities.deprecated("""`managed_services_cmk_key_vault_id` has been deprecated and will be removed in v6.0 of the AzureRM provider. This property is no longer required for cross-subscription scenarios.""")
