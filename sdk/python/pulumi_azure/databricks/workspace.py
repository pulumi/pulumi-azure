...
class WorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 access_connector_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 default_storage_firewall_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 managed_disk_cmk_key_vault_id: Optional[pulumi.Input[builtins.str]] = None,
                 managed_disk_cmk_key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 managed_disk_cmk_rotation_to_latest_version_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 managed_resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 managed_services_cmk_key_vault_id: Optional[pulumi.Input[builtins.str]] = None,
                 managed_services_cmk_key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_security_group_rules_required: Optional[pulumi.Input[builtins.str]] = None,
                 public_network_access_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Workspace resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the Databricks Workspace should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku: The `sku` to use for the Databricks Workspace. Possible values are `standard`, `premium`, or `trial`.
               
               > **Note:** Downgrading to a `trial sku` from a `standard` or `premium sku` will force a new resource to be created.
        :param pulumi.Input[builtins.str] access_connector_id: Access Connector ID to use when default storage account firewall is enabled. 
        ...
        :param pulumi.Input[builtins.bool] customer_managed_key_enabled: Is the workspace enabled for customer managed key encryption? If `true` this enables the Managed Identity for the managed storage account. Possible values are `true` or `false`. Defaults to `false`. This field is only valid if the Databricks Workspace `sku` is set to `premium`.
        :param pulumi.Input[builtins.bool] default_storage_firewall_enabled: Disallow public access to default storage account. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.bool] infrastructure_encryption_enabled: Is the Databricks File System root file system enabled with a secondary layer of encryption with platform managed keys? Possible values are `true` or `false`. Defaults to `false`. This field is only valid if the Databricks Workspace `sku` is set to `premium`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] load_balancer_backend_address_pool_id: Resource ID of the Outbound Load balancer Backend Address Pool for Secure Cluster Connectivity (No Public IP) workspace with managed virtual network. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] managed_disk_cmk_key_vault_key_id: Customer managed encryption properties for the Databricks Workspace managed disks.
        :param pulumi.Input[builtins.bool] managed_disk_cmk_rotation_to_latest_version_enabled: Whether customer managed keys for disk encryption will automatically be rotated to the latest version.
        :param pulumi.Input[builtins.str] managed_resource_group_name: The name of the resource group where Azure should place the managed Databricks resources. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] managed_services_cmk_key_vault_key_id: Customer managed encryption properties for the Databricks Workspace managed resources(e.g. Notebooks and Artifacts).
        :param pulumi.Input[builtins.str] name: Specifies the name of the Databricks Workspace resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] network_security_group_rules_required: Does the data plane (clusters) to control plane communication happen over private link endpoint only or publicly? Possible values `AllRules`, `NoAzureDatabricksRules` or `NoAzureServiceRules`. Required when `public_network_access_enabled` is set to `false`.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Allow public access for accessing workspace. Set value to `false` to access workspace only via private link endpoint. Possible values include `true` or `false`. Defaults to `true`.
    ...
    def access_connector_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_connector_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_storage_firewall_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def default_storage_firewall_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def managed_disk_cmk_key_vault_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "managed_disk_cmk_key_vault_id")

    @managed_disk_cmk_key_vault_id.setter
    def managed_disk_cmk_key_vault_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_disk_cmk_key_vault_id", value)

    @property
    @pulumi.getter(name="managedDiskCmkKeyVaultKeyId")
    def managed_disk_cmk_key_vault_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_disk_cmk_key_vault_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_disk_cmk_key_vault_key_id", value)

    @property
    @pulumi.getter(name="managedDiskCmkRotationToLatestVersionEnabled")
    def managed_disk_cmk_rotation_to_latest_version_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def managed_disk_cmk_rotation_to_latest_version_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def managed_services_cmk_key_vault_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "managed_services_cmk_key_vault_id")

    @managed_services_cmk_key_vault_id.setter
    def managed_services_cmk_key_vault_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_services_cmk_key_vault_id", value)

    @property
    @pulumi.getter(name="managedServicesCmkKeyVaultKeyId")
    def managed_services_cmk_key_vault_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_services_cmk_key_vault_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def network_security_group_rules_required(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_security_group_rules_required(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WorkspaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] customer_managed_key_enabled: Is the workspace enabled for customer managed key encryption? If `true` this enables the Managed Identity for the managed storage account. Possible values are `true` or `false`. Defaults to `false`. This field is only valid if the Databricks Workspace `sku` is set to `premium`.
        :param pulumi.Input[builtins.bool] default_storage_firewall_enabled: Disallow public access to default storage account. Defaults to `false`.
        :param pulumi.Input[builtins.str] disk_encryption_set_id: The ID of Managed Disk Encryption Set created by the Databricks Workspace.
        :param pulumi.Input['WorkspaceEnhancedSecurityComplianceArgs'] enhanced_security_compliance: An `enhanced_security_compliance` block as documented below. This feature is only valid if `sku` is set to `premium`.
        :param pulumi.Input[builtins.bool] infrastructure_encryption_enabled: Is the Databricks File System root file system enabled with a secondary layer of encryption with platform managed keys? Possible values are `true` or `false`. Defaults to `false`. This field is only valid if the Databricks Workspace `sku` is set to `premium`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] load_balancer_backend_address_pool_id: Resource ID of the Outbound Load balancer Backend Address Pool for Secure Cluster Connectivity (No Public IP) workspace with managed virtual network. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource has to be created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] managed_resource_group_id: The ID of the Managed Resource Group created by the Databricks Workspace.
        :param pulumi.Input[builtins.str] managed_resource_group_name: The name of the resource group where Azure should place the managed Databricks resources. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] workspace_id: The unique identifier of the databricks workspace in Databricks control plane.
        :param pulumi.Input[builtins.str] workspace_url: The workspace URL which is of the format 'adb-{workspaceId}.{random}.azuredatabricks.net'
        """
        if access_connector_id is not None:
            pulumi.set(__self__, "access_connector_id", access_connector_id)
        if custom_parameters is not None:
    ...
    def managed_resource_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_resource_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Workspace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None,
            workspace_url: Optional[pulumi.Input[builtins.str]] = None) -> 'Workspace':
        """
    ...
    @property
    @pulumi.getter(name="accessConnectorId")
    def access_connector_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Access Connector ID to use when default storage account firewall is enabled. 
    ...
    @property
    @pulumi.getter(name="customerManagedKeyEnabled")
    def customer_managed_key_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is the workspace enabled for customer managed key encryption? If `true` this enables the Managed Identity for the managed storage account. Possible values are `true` or `false`. Defaults to `false`. This field is only valid if the Databricks Workspace `sku` is set to `premium`.
        """
        return pulumi.get(self, "customer_managed_key_enabled")
    ...
    @property
    @pulumi.getter(name="defaultStorageFirewallEnabled")
    def default_storage_firewall_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Disallow public access to default storage account. Defaults to `false`.
        """
        return pulumi.get(self, "default_storage_firewall_enabled")
    ...
    @property
    @pulumi.getter(name="loadBalancerBackendAddressPoolId")
    def load_balancer_backend_address_pool_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Resource ID of the Outbound Load balancer Backend Address Pool for Secure Cluster Connectivity (No Public IP) workspace with managed virtual network. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "load_balancer_backend_address_pool_id")
    ...
    @property
    @pulumi.getter(name="managedDiskCmkKeyVaultId")
    def managed_disk_cmk_key_vault_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "managed_disk_cmk_key_vault_id")

    @property
    @pulumi.getter(name="managedDiskCmkKeyVaultKeyId")
    def managed_disk_cmk_key_vault_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Customer managed encryption properties for the Databricks Workspace managed disks.
        """
        return pulumi.get(self, "managed_disk_cmk_key_vault_key_id")
    ...
    @property
    @pulumi.getter(name="managedDiskCmkRotationToLatestVersionEnabled")
    def managed_disk_cmk_rotation_to_latest_version_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether customer managed keys for disk encryption will automatically be rotated to the latest version.
        """
        return pulumi.get(self, "managed_disk_cmk_rotation_to_latest_version_enabled")
    ...
    @property
    @pulumi.getter(name="managedServicesCmkKeyVaultId")
    def managed_services_cmk_key_vault_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "managed_services_cmk_key_vault_id")

    @property
    @pulumi.getter(name="managedServicesCmkKeyVaultKeyId")
    def managed_services_cmk_key_vault_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Customer managed encryption properties for the Databricks Workspace managed resources(e.g. Notebooks and Artifacts).
        """
        return pulumi.get(self, "managed_services_cmk_key_vault_key_id")
    ...
    @property
    @pulumi.getter(name="networkSecurityGroupRulesRequired")
    def network_security_group_rules_required(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Does the data plane (clusters) to control plane communication happen over private link endpoint only or publicly? Possible values `AllRules`, `NoAzureDatabricksRules` or `NoAzureServiceRules`. Required when `public_network_access_enabled` is set to `false`.
        """
        return pulumi.get(self, "network_security_group_rules_required")
