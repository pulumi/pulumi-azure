...
class GetAccessConnectorResult:
    ...
    @_builtins.property
    @pulumi.getter
    def identities(self) -> Sequence['outputs.GetAccessConnectorIdentityResult']:
        """
...
def get_access_connector(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Databricks` - 2022-10-01-preview
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Databricks Access Connector exists. Changing this forces a new Databricks Access Connector to be created.
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure:databricks/getAccessConnector:getAccessConnector', __args__, opts=opts, typ=GetAccessConnectorResult).value
...
def get_access_connector_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.Databricks` - 2022-10-01-preview
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:databricks/getAccessConnector:getAccessConnector', __args__, opts=opts, typ=GetAccessConnectorResult)
