...
def get_workspace_private_endpoint_connection(private_endpoint_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Databricks` - 2024-05-01
    ...
    :param _builtins.str workspace_id: The resource ID of the Databricks Workspace.
    """
    __args__ = dict()
...
def get_workspace_private_endpoint_connection_output(private_endpoint_id: Optional[pulumi.Input[_builtins.str]] = None,
