...
def get_workspace_private_endpoint_connection(private_endpoint_id: Optional[builtins.str] = None,
...
def get_workspace_private_endpoint_connection_output(private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
