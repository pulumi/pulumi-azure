...
class DataConnectorOfficeAtp(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_office_atp = azure.sentinel.DataConnectorOfficeAtp("exampleDataConnectorOfficeAtp", log_analytics_workspace_id=example_analytics_solution.workspace_resource_id)
        ```
