...
class DataConnectorOfficeAtpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace that this Office ATP Data Connector resides in. Changing this forces a new Office ATP Data Connector to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Office ATP Data Connector. Changing this forces a new Office ATP Data Connector to be created.
        :param pulumi.Input[builtins.str] tenant_id: The ID of the tenant that this Office ATP Data Connector connects to. Changing this forces a new Office ATP Data Connector to be created.
...
@pulumi.type_token("azure:sentinel/dataConnectorOfficeAtp:DataConnectorOfficeAtp")
class DataConnectorOfficeAtp(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            log_analytics_workspace_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DataConnectorOfficeAtp':
        """
