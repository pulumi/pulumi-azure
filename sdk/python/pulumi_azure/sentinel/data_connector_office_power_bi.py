...
class DataConnectorOfficePowerBiArgs:
    def __init__(__self__, *,
        ...
        """
        DataConnectorOfficePowerBiArgs._configure(
...
class _DataConnectorOfficePowerBiState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tenant_id: The ID of the tenant that this Office Power BI Data Connector connects to. Changing this forces a new Office Power BI Data Connector to be created.
               ...
               > **NOTE** Currently, only the same tenant as the running account is allowed. Cross-tenant scenario is not supported yet.
        """
        _DataConnectorOfficePowerBiState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            log_analytics_workspace_id=log_analytics_workspace_id,
            name=name,
            tenant_id=tenant_id,
...
class DataConnectorOfficePowerBi(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_office_power_bi = azure.sentinel.DataConnectorOfficePowerBi("exampleDataConnectorOfficePowerBi", log_analytics_workspace_id=example_log_analytics_workspace_onboarding.workspace_id)
        ```
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DataConnectorOfficePowerBiArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            log_analytics_workspace_id: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            tenant_id: Optional[pulumi.Input[str]] = None) -> 'DataConnectorOfficePowerBi':
        """
