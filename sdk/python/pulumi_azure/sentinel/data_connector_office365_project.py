...
__all__ = ['DataConnectorOffice365ProjectArgs', 'DataConnectorOffice365Project']
...
class DataConnectorOffice365ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] log_analytics_workspace_id: The ID of the Log Analytics Workspace that this Office 365 Project Data Connector resides in. Changing this forces a new Office 365 Project Data Connector to be created.
        :param pulumi.Input[str] name: The name which should be used for this Office 365 Project Data Connector. Changing this forces a new Office 365 Project Data Connector to be created.
        :param pulumi.Input[str] tenant_id: The ID of the tenant that this Office 365 Project Data Connector connects to. Changing this forces a new Office 365 Project Data Connector to be created.
               
               > **NOTE** Currently, only the same tenant as the running account is allowed. Cross-tenant scenario is not supported yet.
        """
        DataConnectorOffice365ProjectArgs._configure(
...
@pulumi.input_type
class _DataConnectorOffice365ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tenant_id: The ID of the tenant that this Office 365 Project Data Connector connects to. Changing this forces a new Office 365 Project Data Connector to be created.
               ...
               > **NOTE** Currently, only the same tenant as the running account is allowed. Cross-tenant scenario is not supported yet.
        """
        _DataConnectorOffice365ProjectState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            log_analytics_workspace_id=log_analytics_workspace_id,
            name=name,
            tenant_id=tenant_id,
...
class DataConnectorOffice365Project(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
        ...
        example_data_connector_office365_project = azure.sentinel.DataConnectorOffice365Project("exampleDataConnectorOffice365Project", log_analytics_workspace_id=example_log_analytics_workspace_onboarding.workspace_id)
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DataConnectorOffice365ProjectArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataConnectorOffice365ProjectArgs, pulumi.ResourceOptions, *args, **kwargs)
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DataConnectorOffice365ProjectArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataConnectorOffice365ProjectArgs.__new__(DataConnectorOffice365ProjectArgs)
        ...
        super(DataConnectorOffice365Project, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            log_analytics_workspace_id: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            tenant_id: Optional[pulumi.Input[str]] = None) -> 'DataConnectorOffice365Project':
        """
        ...
        __props__ = _DataConnectorOffice365ProjectState.__new__(_DataConnectorOffice365ProjectState)

        __props__.__dict__["log_analytics_workspace_id"] = log_analytics_workspace_id
        __props__.__dict__["name"] = name
        __props__.__dict__["tenant_id"] = tenant_id
        return DataConnectorOffice365Project(resource_name, opts=opts, __props__=__props__)
