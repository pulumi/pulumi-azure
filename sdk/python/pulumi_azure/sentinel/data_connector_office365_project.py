...
class DataConnectorOffice365Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_office365_project = azure.sentinel.DataConnectorOffice365Project("exampleDataConnectorOffice365Project", log_analytics_workspace_id=example_analytics_solution.workspace_resource_id)
        ```
