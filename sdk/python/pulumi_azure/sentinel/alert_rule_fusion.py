...
class AlertRuleFusionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alert_rule_template_guid: The GUID of the alert rule template which is used for this Sentinel Fusion Alert Rule. Changing this forces a new Sentinel Fusion Alert Rule to be created.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace this Sentinel Fusion Alert Rule belongs to. Changing this forces a new Sentinel Fusion Alert Rule to be created.
        :param pulumi.Input[builtins.bool] enabled: Should this Sentinel Fusion Alert Rule be enabled? Defaults to `true`.
