...
class DataConnectorMicrosoftThreatProtection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_microsoft_threat_protection = azure.sentinel.DataConnectorMicrosoftThreatProtection("exampleDataConnectorMicrosoftThreatProtection", log_analytics_workspace_id=example_analytics_solution.workspace_resource_id)
        ```
