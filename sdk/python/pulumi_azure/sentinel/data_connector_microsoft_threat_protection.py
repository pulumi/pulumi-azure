...
class DataConnectorMicrosoftThreatProtection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_microsoft_threat_protection = azure.sentinel.data_connector_microsoft_threat_protection.DataConnectorMicrosoftThreatProtection("example",
            name=example,
