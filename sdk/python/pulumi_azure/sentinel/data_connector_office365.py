...
class DataConnectorOffice365Args:
    def __init__(__self__, *,
                 ...
                 exchange_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sharepoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace that this Office 365 Data Connector resides in. Changing this forces a new Office 365 Data Connector to be created.
        :param pulumi.Input[builtins.bool] exchange_enabled: Should the Exchange data connector be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Office 365 Data Connector. Changing this forces a new Office 365 Data Connector to be created.
    ...
    def exchange_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def exchange_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def sharepoint_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sharepoint_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DataConnectorOffice365(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sharepoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            teams_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DataConnectorOffice365':
        """
    ...
    @property
    @pulumi.getter(name="exchangeEnabled")
    def exchange_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Exchange data connector be enabled? Defaults to `true`.
        """
        return pulumi.get(self, "exchange_enabled")
    ...
    @property
    @pulumi.getter(name="sharepointEnabled")
    def sharepoint_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the SharePoint data connector be enabled? Defaults to `true`.
        """
        return pulumi.get(self, "sharepoint_enabled")
    ...
    @property
    @pulumi.getter(name="teamsEnabled")
    def teams_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Microsoft Teams data connector be enabled? Defaults to `true`.
