...
class DataConnectorAzureAdvancedThreadProtection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_azure_advanced_thread_protection = azure.sentinel.data_connector_azure_advanced_thread_protection.DataConnectorAzureAdvancedThreadProtection("example",
            name=example,
