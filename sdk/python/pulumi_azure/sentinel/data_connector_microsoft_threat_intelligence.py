...
class DataConnectorMicrosoftThreatIntelligenceArgs:
    def __init__(__self__, *,
                 ...
                 microsoft_emerging_threat_feed_lookback_date: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DataConnectorMicrosoftThreatIntelligence resource.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace. Changing this forces a new Data Connector to be created.
        :param pulumi.Input[builtins.str] microsoft_emerging_threat_feed_lookback_date: The lookback date for the Microsoft Emerging Threat Feed in RFC3339. Changing this forces a new Data Connector to be created.
    ...
    def microsoft_emerging_threat_feed_lookback_date(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def microsoft_emerging_threat_feed_lookback_date(self, value: pulumi.Input[builtins.str]):
...
class _DataConnectorMicrosoftThreatIntelligenceState:
    def __init__(__self__, *,
                 ...
                 microsoft_emerging_threat_feed_lookback_date: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="microsoftEmergingThreatFeedLookbackDate")
    def microsoft_emerging_threat_feed_lookback_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The lookback date for the Microsoft Emerging Threat Feed in RFC3339. Changing this forces a new Data Connector to be created.
        """
        return pulumi.get(self, "microsoft_emerging_threat_feed_lookback_date")
    ...
    @microsoft_emerging_threat_feed_lookback_date.setter
    def microsoft_emerging_threat_feed_lookback_date(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "microsoft_emerging_threat_feed_lookback_date", value)
...
@pulumi.type_token("azure:sentinel/dataConnectorMicrosoftThreatIntelligence:DataConnectorMicrosoftThreatIntelligence")
class DataConnectorMicrosoftThreatIntelligence(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            microsoft_emerging_threat_feed_lookback_date: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DataConnectorMicrosoftThreatIntelligence':
        """
    ...
    @property
    @pulumi.getter(name="microsoftEmergingThreatFeedLookbackDate")
    def microsoft_emerging_threat_feed_lookback_date(self) -> pulumi.Output[builtins.str]:
        """
        The lookback date for the Microsoft Emerging Threat Feed in RFC3339. Changing this forces a new Data Connector to be created.
        """
        return pulumi.get(self, "microsoft_emerging_threat_feed_lookback_date")
