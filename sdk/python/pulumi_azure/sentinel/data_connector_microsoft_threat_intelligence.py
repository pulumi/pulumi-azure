...
class DataConnectorMicrosoftThreatIntelligenceArgs:
    def __init__(__self__, *,
                 ...
                 microsoft_emerging_threat_feed_lookback_date: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] tenant_id: The ID of the tenant that this Microsoft Threat Intelligence Data Connector connects to. Changing this forces a new Microsoft Threat Intelligence Data Connector to be created.
    ...
    def microsoft_emerging_threat_feed_lookback_date(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def microsoft_emerging_threat_feed_lookback_date(self, value: pulumi.Input[_builtins.str]):
...
class _DataConnectorMicrosoftThreatIntelligenceState:
    def __init__(__self__, *,
                 ...
                 microsoft_emerging_threat_feed_lookback_date: Optional[pulumi.Input[_builtins.str]] = None,
                 name: Optional[pulumi.Input[_builtins.str]] = None,
                 tenant_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="microsoftEmergingThreatFeedLookbackDate")
    def microsoft_emerging_threat_feed_lookback_date(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The lookback date for the Microsoft Emerging Threat Feed in RFC3339. Changing this forces a new Data Connector to be created.
        """
        return pulumi.get(self, "microsoft_emerging_threat_feed_lookback_date")
    ...
    @microsoft_emerging_threat_feed_lookback_date.setter
    def microsoft_emerging_threat_feed_lookback_date(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "microsoft_emerging_threat_feed_lookback_date", value)
...
class DataConnectorMicrosoftThreatIntelligence(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            microsoft_emerging_threat_feed_lookback_date: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'DataConnectorMicrosoftThreatIntelligence':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="microsoftEmergingThreatFeedLookbackDate")
    def microsoft_emerging_threat_feed_lookback_date(self) -> pulumi.Output[_builtins.str]:
        """
        The lookback date for the Microsoft Emerging Threat Feed in RFC3339. Changing this forces a new Data Connector to be created.
        """
        return pulumi.get(self, "microsoft_emerging_threat_feed_lookback_date")
