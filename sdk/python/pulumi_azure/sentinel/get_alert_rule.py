...
def get_alert_rule(log_analytics_workspace_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.OperationalInsights` - 2023-12-01-preview
    ...
    :param _builtins.str name: The name which should be used for this Sentinel Alert Rule.
    """
    __args__ = dict()
