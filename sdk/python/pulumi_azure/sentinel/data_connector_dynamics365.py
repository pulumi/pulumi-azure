...
__all__ = ['DataConnectorDynamics365Args', 'DataConnectorDynamics365']
...
class DataConnectorDynamics365Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] log_analytics_workspace_id: The ID of the Log Analytics Workspace that this Dynamics 365 Data Connector resides in. Changing this forces a new Dynamics 365 Data Connector to be created.
        :param pulumi.Input[str] name: The name which should be used for this Dynamics 365 Data Connector. Changing this forces a new Dynamics 365 Data Connector to be created.
        :param pulumi.Input[str] tenant_id: The ID of the tenant that this Dynamics 365 Data Connector connects to. Changing this forces a new Dynamics 365 Data Connector to be created.
        """
...
@pulumi.input_type
class _DataConnectorDynamics365State:
    def __init__(__self__, *,
...
class DataConnectorDynamics365(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_dynamics365 = azure.sentinel.DataConnectorDynamics365("exampleDataConnectorDynamics365", log_analytics_workspace_id=example_analytics_solution.workspace_resource_id)
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DataConnectorDynamics365Args args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DataConnectorDynamics365Args, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DataConnectorDynamics365Args.__new__(DataConnectorDynamics365Args)
        ...
        super(DataConnectorDynamics365, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            log_analytics_workspace_id: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            tenant_id: Optional[pulumi.Input[str]] = None) -> 'DataConnectorDynamics365':
        """
        ...
        __props__ = _DataConnectorDynamics365State.__new__(_DataConnectorDynamics365State)

        __props__.__dict__["log_analytics_workspace_id"] = log_analytics_workspace_id
        __props__.__dict__["name"] = name
        __props__.__dict__["tenant_id"] = tenant_id
        return DataConnectorDynamics365(resource_name, opts=opts, __props__=__props__)
