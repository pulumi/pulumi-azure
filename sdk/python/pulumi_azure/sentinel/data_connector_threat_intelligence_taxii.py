...
class DataConnectorThreatIntelligenceTaxiiArgs:
    def __init__(__self__, *,
                 api_root_url: pulumi.Input[builtins.str],
                 collection_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 log_analytics_workspace_id: pulumi.Input[builtins.str],
                 lookback_date: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 polling_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DataConnectorThreatIntelligenceTaxii resource.
        :param pulumi.Input[builtins.str] api_root_url: The API root URI of the TAXII server.
        :param pulumi.Input[builtins.str] collection_id: The collection ID of the TAXII server.
        :param pulumi.Input[builtins.str] display_name: The friendly name which should be used for this Threat Intelligence TAXII Data Connector.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace that this Threat Intelligence TAXII Data Connector resides in. Changing this forces a new Threat Intelligence TAXII Data Connector to be created.
        :param pulumi.Input[builtins.str] lookback_date: The lookback date for the TAXII server in RFC3339. Defaults to `1970-01-01T00:00:00Z`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Threat Intelligence TAXII Data Connector. Changing this forces a new Threat Intelligence TAXII Data Connector to be created.
        :param pulumi.Input[builtins.str] password: The password for the TAXII server.
    ...
    def api_root_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @api_root_url.setter
    def api_root_url(self, value: pulumi.Input[builtins.str]):
    ...
    def lookback_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def lookback_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def polling_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def polling_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DataConnectorThreatIntelligenceTaxiiState:
    def __init__(__self__, *,
                 api_root_url: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="apiRootUrl")
    def api_root_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The API root URI of the TAXII server.
        """
        return pulumi.get(self, "api_root_url")
    ...
    @api_root_url.setter
    def api_root_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_root_url", value)
...
class DataConnectorThreatIntelligenceTaxii(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            polling_frequency: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DataConnectorThreatIntelligenceTaxii':
        """
    ...
    @property
    @pulumi.getter(name="apiRootUrl")
    def api_root_url(self) -> pulumi.Output[builtins.str]:
        """
        The API root URI of the TAXII server.
        """
        return pulumi.get(self, "api_root_url")
    ...
    @property
    @pulumi.getter(name="lookbackDate")
    def lookback_date(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The lookback date for the TAXII server in RFC3339. Defaults to `1970-01-01T00:00:00Z`.
        """
        return pulumi.get(self, "lookback_date")
    ...
    @property
    @pulumi.getter(name="pollingFrequency")
    def polling_frequency(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The polling frequency for the TAXII server. Possible values are `OnceAMinute`, `OnceAnHour` and `OnceADay`. Defaults to `OnceAnHour`.
        """
        return pulumi.get(self, "polling_frequency")
