...
class AlertRuleScheduledArgs:
    def __init__(__self__, *,
                 ...
                 trigger_operator: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The friendly name of this Sentinel Scheduled Alert Rule.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace this Sentinel Scheduled Alert Rule belongs to. Changing this forces a new Sentinel Scheduled Alert Rule to be created.
        :param pulumi.Input[builtins.str] query: The query of this Sentinel Scheduled Alert Rule.
        ...
        :param pulumi.Input[builtins.str] alert_rule_template_guid: The GUID of the alert rule template which is used for this Sentinel Scheduled Alert Rule. Changing this forces a new Sentinel Scheduled Alert Rule to be created.
        :param pulumi.Input[builtins.str] alert_rule_template_version: The version of the alert rule template which is used for this Sentinel Scheduled Alert Rule.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] custom_details: A map of string key-value pairs of columns to be attached to this Sentinel Scheduled Alert Rule. The key will appear as the field name in alerts and the value is the event parameter you wish to surface in the alerts.
        :param pulumi.Input[builtins.str] description: The description of this Sentinel Scheduled Alert Rule.
        :param pulumi.Input[builtins.bool] enabled: Should the Sentinel Scheduled Alert Rule be enabled? Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Sentinel Scheduled Alert Rule. Changing this forces a new Sentinel Scheduled Alert Rule to be created.
        ...
        :param pulumi.Input[builtins.str] trigger_operator: The alert trigger operator, combined with `trigger_threshold`, setting alert threshold of this Sentinel Scheduled Alert Rule. Possible values are `Equal`, `GreaterThan`, `LessThan`, `NotEqual`. Defaults to `GreaterThan`.
        :param pulumi.Input[builtins.int] trigger_threshold: The baseline number of query results generated, combined with `trigger_operator`, setting alert threshold of this Sentinel Scheduled Alert Rule. Defaults to `0`.
        """
    ...
    def alert_rule_template_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_rule_template_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def query_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def query_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "query_frequency", value)

    @property
    @pulumi.getter(name="queryPeriod")
    def query_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @query_period.setter
    def query_period(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def suppression_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def suppression_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "suppression_duration", value)

    @property
    @pulumi.getter(name="suppressionEnabled")
    def suppression_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def suppression_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def trigger_operator(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trigger_operator(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AlertRuleScheduled(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            techniques: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            trigger_operator: Optional[pulumi.Input[builtins.str]] = None,
            trigger_threshold: Optional[pulumi.Input[builtins.int]] = None) -> 'AlertRuleScheduled':
        """
    ...
    @property
    @pulumi.getter(name="alertRuleTemplateVersion")
    def alert_rule_template_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of the alert rule template which is used for this Sentinel Scheduled Alert Rule.
        """
        return pulumi.get(self, "alert_rule_template_version")
    ...
    @property
    @pulumi.getter(name="queryFrequency")
    def query_frequency(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ISO 8601 timespan duration between two consecutive queries. Defaults to `PT5H`.
        """
        return pulumi.get(self, "query_frequency")
    ...
    @property
    @pulumi.getter(name="queryPeriod")
    def query_period(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ISO 8601 timespan duration, which determine the time period of the data covered by the query. For example, it can query the past 10 minutes of data, or the past 6 hours of data. Defaults to `PT5H`.
    ...
    @property
    @pulumi.getter(name="suppressionDuration")
    def suppression_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `suppression_enabled` is `true`, this is ISO 8601 timespan duration, which specifies the amount of time the query should stop running after alert is generated. Defaults to `PT5H`.
    ...
    @property
    @pulumi.getter(name="suppressionEnabled")
    def suppression_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Sentinel Scheduled Alert Rulea stop running query after alert is generated? Defaults to `false`.
        """
        return pulumi.get(self, "suppression_enabled")
    ...
    @property
    @pulumi.getter(name="triggerOperator")
    def trigger_operator(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The alert trigger operator, combined with `trigger_threshold`, setting alert threshold of this Sentinel Scheduled Alert Rule. Possible values are `Equal`, `GreaterThan`, `LessThan`, `NotEqual`. Defaults to `GreaterThan`.
        """
        return pulumi.get(self, "trigger_operator")
    ...
    @property
    @pulumi.getter(name="triggerThreshold")
    def trigger_threshold(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The baseline number of query results generated, combined with `trigger_operator`, setting alert threshold of this Sentinel Scheduled Alert Rule. Defaults to `0`.
        """
        return pulumi.get(self, "trigger_threshold")
