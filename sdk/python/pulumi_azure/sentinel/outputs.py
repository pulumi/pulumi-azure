...
class AlertRuleAnomalyBuiltInMultiSelectObservation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 supported_values: Optional[Sequence[builtins.str]] = None,
                 values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str description: The description of the threshold observation.
        :param builtins.str name: The Name of the built-in Anomaly Alert Rule.
        :param Sequence[builtins.str] supported_values: A list of supported values of the single select observation.
        :param Sequence[builtins.str] values: A list of values of the single select observation.
        """
    ...
    def supported_values(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AlertRuleAnomalyBuiltInPrioritizedExcludeObservation(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None,
                 prioritize: Optional[builtins.str] = None):
        """
        :param builtins.str description: The description of the threshold observation.
        :param builtins.str exclude: The excluded value per `description`.
        :param builtins.str name: The Name of the built-in Anomaly Alert Rule.
        :param builtins.str prioritize: The prioritized value per `description`.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter
    def prioritize(self) -> Optional[builtins.str]:
        """
...
class AlertRuleAnomalyBuiltInRequiredDataConnector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connector_id: The ID of the required Data Connector.
        :param Sequence[builtins.str] data_types: A list of data types of the required Data Connector.
        """
...
class AlertRuleAnomalyBuiltInSingleSelectObservation(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The Name of the built-in Anomaly Alert Rule.
        :param Sequence[builtins.str] supported_values: A list of supported values of the single select observation.
        :param builtins.str value: The value of the threshold observation.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if name is not None:
...
class AlertRuleAnomalyBuiltInThresholdObservation(dict):
    def __init__(__self__, *,
                 description: Optional[builtins.str] = None,
                 max: Optional[builtins.str] = None,
                 min: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str description: The description of the threshold observation.
        :param builtins.str max: The max value of the threshold observation.
        :param builtins.str min: The min value of the threshold observation.
        :param builtins.str name: The Name of the built-in Anomaly Alert Rule.
        :param builtins.str value: The value of the threshold observation.
        """
        if description is not None:
    ...
    @property
    @pulumi.getter
    def max(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def min(self) -> Optional[builtins.str]:
        """
...
class AlertRuleAnomalyDuplicateMultiSelectObservation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 supported_values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str name: The name of the multi select observation.
        :param Sequence[builtins.str] values: A list of values of the multi select observation.
        :param builtins.str description: The description of the multi select observation.
        :param Sequence[builtins.str] supported_values: A list of supported values of the multi select observation.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if description is not None:
...
class AlertRuleAnomalyDuplicatePrioritizedExcludeObservation(dict):
    def __init__(__self__, *,
                 ...
                 prioritize: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the prioritized exclude observation.
        :param builtins.str description: The description of the prioritized exclude observation.
        :param builtins.str exclude: The excluded value per `description`.
        :param builtins.str prioritize: The prioritized value per `description`.
        """
        pulumi.set(__self__, "name", name)
...
class AlertRuleAnomalyDuplicateSingleSelectObservation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 supported_values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str name: The name of the single select observation.
        :param builtins.str value: The value of the multi select observation.
        :param builtins.str description: The description of the single select observation.
        :param Sequence[builtins.str] supported_values: A list of supported values of the single select observation.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class AlertRuleAnomalyDuplicateThresholdObservation(dict):
    def __init__(__self__, *,
                 ...
                 min: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the threshold observation.
        :param builtins.str value: The value of the threshold observation.
        :param builtins.str description: The description of the threshold observation.
        :param builtins.str max: The max value of the threshold observation.
        :param builtins.str min: The min value of the threshold observation.
...
class AlertRuleFusionSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the Fusion source signal. Refer to Fusion alert rule template for supported values.
        :param builtins.bool enabled: Whether this source signal is enabled or disabled in Fusion detection? Defaults to `true`.
...
class AlertRuleFusionSourceSubType(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 severities_alloweds: Sequence[builtins.str],
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The Name of the source subtype under a given source signal in Fusion detection. Refer to Fusion alert rule template for supported values.
        :param Sequence[builtins.str] severities_alloweds: A list of severities that are enabled for this source subtype consumed in Fusion detection. Possible values for each element are `High`, `Medium`, `Low`, `Informational`.
        :param builtins.bool enabled: Whether this source subtype under source signal is enabled or disabled in Fusion detection. Defaults to `true`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def severities_alloweds(self) -> Sequence[builtins.str]:
        """
...
class AlertRuleNrtAlertDetailsOverride(dict):
    ...
    def __init__(__self__, *,
                 description_format: Optional[builtins.str] = None,
                 display_name_format: Optional[builtins.str] = None,
                 dynamic_properties: Optional[Sequence['outputs.AlertRuleNrtAlertDetailsOverrideDynamicProperty']] = None,
                 severity_column_name: Optional[builtins.str] = None,
                 tactics_column_name: Optional[builtins.str] = None):
        """
        :param builtins.str description_format: The format containing columns name(s) to override the description of this Sentinel Alert Rule.
        :param builtins.str display_name_format: The format containing columns name(s) to override the name of this Sentinel Alert Rule.
        ...
        :param builtins.str severity_column_name: The column name to take the alert severity from.
        :param builtins.str tactics_column_name: The column name to take the alert tactics from.
        """
    ...
    def description_format(self) -> Optional[builtins.str]:
        """
    ...
    def display_name_format(self) -> Optional[builtins.str]:
        """
    ...
    def severity_column_name(self) -> Optional[builtins.str]:
        """
    ...
    def tactics_column_name(self) -> Optional[builtins.str]:
        """
...
class AlertRuleNrtAlertDetailsOverrideDynamicProperty(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the dynamic property. Possible Values are `AlertLink`, `ConfidenceLevel`, `ConfidenceScore`, `ExtendedLinks`, `ProductComponentName`, `ProductName`, `ProviderName`, `RemediationSteps` and `Techniques`.
        :param builtins.str value: The value of the dynamic property. Pssible Values are `Caller`, `dcount_ResourceId` and `EventSubmissionTimestamp`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class AlertRuleNrtEntityMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str entity_type: The type of the entity. Possible values are `Account`, `AzureResource`, `CloudApplication`, `DNS`, `File`, `FileHash`, `Host`, `IP`, `Mailbox`, `MailCluster`, `MailMessage`, `Malware`, `Process`, `RegistryKey`, `RegistryValue`, `SecurityGroup`, `SubmissionMail`, `URL`.
...
class AlertRuleNrtEntityMappingFieldMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str identifier: The identifier of the entity.
        """
...
class AlertRuleNrtEventGrouping(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str aggregation_method: The aggregation type of grouping the events. Possible values are `AlertPerResult` and `SingleAlert`.
        """
...
class AlertRuleNrtIncident(dict):
    ...
    def __init__(__self__, *,
                 create_incident_enabled: builtins.bool,
                 grouping: 'outputs.AlertRuleNrtIncidentGrouping'):
        """
        :param builtins.bool create_incident_enabled: Whether to create an incident from alerts triggered by this Sentinel NRT Alert Rule?
    ...
    def create_incident_enabled(self) -> builtins.bool:
        """
...
class AlertRuleNrtIncidentGrouping(dict):
    ...
    def __init__(__self__, *,
                 by_alert_details: Optional[Sequence[builtins.str]] = None,
                 by_custom_details: Optional[Sequence[builtins.str]] = None,
                 by_entities: Optional[Sequence[builtins.str]] = None,
                 enabled: Optional[builtins.bool] = None,
                 entity_matching_method: Optional[builtins.str] = None,
                 lookback_duration: Optional[builtins.str] = None,
                 reopen_closed_incidents: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] by_alert_details: A list of alert details to group by, only when the `entity_matching_method` is `Selected`. Possible values are `DisplayName` and `Severity`.
        :param Sequence[builtins.str] by_custom_details: A list of custom details keys to group by, only when the `entity_matching_method` is `Selected`. Only keys defined in the `custom_details` may be used.
        :param Sequence[builtins.str] by_entities: A list of entity types to group by, only when the `entity_matching_method` is `Selected`. Possible values are `Account`, `AzureResource`, `CloudApplication`, `DNS`, `File`, `FileHash`, `Host`, `IP`, `Mailbox`, `MailCluster`, `MailMessage`, `Malware`, `Process`, `RegistryKey`, `RegistryValue`, `SecurityGroup`, `SubmissionMail`, `URL`.
        :param builtins.bool enabled: Enable grouping incidents created from alerts triggered by this Sentinel NRT Alert Rule. Defaults to `true`.
        :param builtins.str entity_matching_method: The method used to group incidents. Possible values are `AnyAlert`, `Selected` and `AllEntities`. Defaults to `AnyAlert`.
        :param builtins.str lookback_duration: Limit the group to alerts created within the lookback duration (in ISO 8601 duration format). Defaults to `PT5M`.
        :param builtins.bool reopen_closed_incidents: Whether to re-open closed matching incidents? Defaults to `false`.
        """
    ...
    def by_alert_details(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def by_custom_details(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def by_entities(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def entity_matching_method(self) -> Optional[builtins.str]:
        """
    ...
    def lookback_duration(self) -> Optional[builtins.str]:
        """
    ...
    def reopen_closed_incidents(self) -> Optional[builtins.bool]:
        """
...
class AlertRuleScheduledIncident(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool create_incident_enabled: Whether to create an incident from alerts triggered by this Sentinel Scheduled Alert Rule?
...
class AlertRuleScheduledIncidentGrouping(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] by_custom_details: A list of custom details keys to group by, only when the `entity_matching_method` is `Selected`. Only keys defined in the `custom_details` may be used.
        :param Sequence[builtins.str] by_entities: A list of entity types to group by, only when the `entity_matching_method` is `Selected`. Possible values are `Account`, `AzureResource`, `CloudApplication`, `DNS`, `File`, `FileHash`, `Host`, `IP`, `Mailbox`, `MailCluster`, `MailMessage`, `Malware`, `Process`, `RegistryKey`, `RegistryValue`, `SecurityGroup`, `SubmissionMail`, `URL`.
        :param builtins.bool enabled: Enable grouping incidents created from alerts triggered by this Sentinel Scheduled Alert Rule. Defaults to `true`.
        :param builtins.str entity_matching_method: The method used to group incidents. Possible values are `AnyAlert`, `Selected` and `AllEntities`. Defaults to `AnyAlert`.
        :param builtins.str lookback_duration: Limit the group to alerts created within the lookback duration (in ISO 8601 duration format). Defaults to `PT5M`.
        :param builtins.bool reopen_closed_incidents: Whether to re-open closed matching incidents? Defaults to `false`.
        """
...
class AuthomationRuleActionIncident(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int order: The execution order of this action.
        :param builtins.str classification: The classification of the incident, when closing it. Possible values are: `BenignPositive_SuspiciousButExpected`, `FalsePositive_InaccurateData`, `FalsePositive_IncorrectAlertLogic`, `TruePositive_SuspiciousActivity` and `Undetermined`.
               
               > **Note:** The `classification` is required when `status` is `Closed`.
        :param builtins.str classification_comment: The comment why the incident is to be closed.
               
               > **Note:** The `classification_comment` is allowed to set only when `status` is `Closed`.
        :param Sequence[builtins.str] labels: Specifies a list of labels to add to the incident.
...
class AuthomationRuleActionPlaybook(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str logic_app_id: The ID of the Logic App that defines the playbook's logic.
        :param builtins.int order: The execution order of this action.
        :param builtins.str tenant_id: The ID of the Tenant that owns the playbook.
        """
...
class MetadataAuthor(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str email: The email address of the author contact.
        :param builtins.str link: The link for author/vendor page.
        :param builtins.str name: The name of the author, company or person.
        """
...
class MetadataCategory(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] domains: Specifies a list of domains for the solution content item.
        :param Sequence[builtins.str] verticals: Specifies a list of industry verticals for the solution content item.
        """
...
class MetadataSource(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str kind: The kind of the content source. Possible values are `Community`, `LocalWorkspace`, `Solution` and `SourceRepository`.
        :param builtins.str id: The id of the content source, the solution ID, Log Analytics Workspace name etc.
        :param builtins.str name: The name of the content source, repo name, solution name, Log Analytics Workspace name, etc.
        """
...
class MetadataSupport(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str tier: The type of support for content item. Possible values are `Microsoft`, `Partner` and `Community`.
        :param builtins.str email: The email address of the support contact.
        :param builtins.str link: The link for support help.
        :param builtins.str name: The name of the support contact.
        """
...
class ThreatIntelligenceIndicatorExternalReference(dict):
    ...
    def __init__(__self__, *,
                 description: Optional[builtins.str] = None,
                 hashes: Optional[Mapping[str, builtins.str]] = None,
                 id: Optional[builtins.str] = None,
                 source_name: Optional[builtins.str] = None,
                 url: Optional[builtins.str] = None):
        """
        :param builtins.str description: The description of the external reference of the Threat Intelligence Indicator.
        :param Mapping[str, builtins.str] hashes: The list of hashes of the external reference of the Threat Intelligence Indicator.
        :param builtins.str id: The ID of the Sentinel Threat Intelligence Indicator.
        :param builtins.str source_name: The source name of the external reference of the Threat Intelligence Indicator.
        :param builtins.str url: The url of the external reference of the Threat Intelligence Indicator.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter
    def hashes(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ThreatIntelligenceIndicatorGranularMarking(dict):
    ...
    def __init__(__self__, *,
                 ...
                 marking_ref: Optional[builtins.str] = None,
                 selectors: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str language: The language of granular marking of the Threat Intelligence Indicator.
        :param builtins.str marking_ref: The reference of the granular marking of the Threat Intelligence Indicator.
        :param Sequence[builtins.str] selectors: A list of selectors of the granular marking of the Threat Intelligence Indicator.
        """
    ...
    def marking_ref(self) -> Optional[builtins.str]:
        """
...
class ThreatIntelligenceIndicatorKillChainPhase(dict):
    def __init__(__self__, *,
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name which should be used for the Lockheed Martin cyber kill chain phase.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class ThreatIntelligenceIndicatorParsedPattern(dict):
    ...
    def __init__(__self__, *,
                 pattern_type_key: Optional[builtins.str] = None,
                 pattern_type_values: Optional[Sequence['outputs.ThreatIntelligenceIndicatorParsedPatternPatternTypeValue']] = None):
        """
        :param builtins.str pattern_type_key: The type key of parsed pattern.
    ...
    def pattern_type_key(self) -> Optional[builtins.str]:
        """
...
class ThreatIntelligenceIndicatorParsedPatternPatternTypeValue(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str value: The value of the parsed pattern type.
        :param builtins.str value_type: The type of the value of the parsed pattern type value.
        """
        if value is not None:
            pulumi.set(__self__, "value", value)
...
class GetAlertRuleTemplateNrtTemplateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: The description of this Sentinel Scheduled Alert Rule Template.
        :param builtins.str query: The query of this Sentinel Scheduled Alert Rule Template.
        :param builtins.str severity: The alert severity of this Sentinel Scheduled Alert Rule Template.
        :param Sequence[builtins.str] tactics: A list of categories of attacks by which to classify the rule.
        """
        pulumi.set(__self__, "description", description)
...
class GetAlertRuleTemplateScheduledTemplateResult(dict):
    def __init__(__self__, *,
                 description: builtins.str,
                 query: builtins.str,
                 query_frequency: builtins.str,
                 query_period: builtins.str,
                 severity: builtins.str,
                 tactics: Sequence[builtins.str],
                 trigger_operator: builtins.str,
                 trigger_threshold: builtins.int):
        """
        :param builtins.str description: The description of this Sentinel Scheduled Alert Rule Template.
        :param builtins.str query: The query of this Sentinel Scheduled Alert Rule Template.
        :param builtins.str query_frequency: The ISO 8601 timespan duration between two consecutive queries.
        :param builtins.str query_period: The ISO 8601 timespan duration, which determine the time period of the data covered by the query.
        :param builtins.str severity: The alert severity of this Sentinel Scheduled Alert Rule Template.
        :param Sequence[builtins.str] tactics: A list of categories of attacks by which to classify the rule.
        :param builtins.str trigger_operator: The alert trigger operator, combined with `trigger_threshold`, setting alert threshold of this Sentinel Scheduled Alert Rule Template.
        :param builtins.int trigger_threshold: The baseline number of query results generated, combined with `trigger_operator`, setting alert threshold of this Sentinel Scheduled Alert Rule Template.
        """
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "query", query)
    ...
    def trigger_threshold(self) -> builtins.int:
        """
...
class GetAlertRuleTemplateSecurityIncidentTemplateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: The description of this Sentinel Scheduled Alert Rule Template.
        :param builtins.str product_filter: The Microsoft Security Service from where the alert will be generated.
        """
        pulumi.set(__self__, "description", description)
