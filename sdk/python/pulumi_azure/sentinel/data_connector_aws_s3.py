...
class DataConnectorAwsS3Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] aws_role_arn: The ARN of the AWS role, which is connected to this AWS CloudTrail Data Connector. See the [Azure document](https://docs.microsoft.com/azure/sentinel/connect-aws?tabs=s3#create-an-aws-assumed-role-and-grant-access-to-the-aws-sentinel-account) for details.
        :param pulumi.Input[_builtins.str] destination_table: The name of the Log Analytics table that will store the ingested data.
        :param pulumi.Input[_builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace that this AWS S3 Data Connector resides in. Changing this forces a new AWS S3 Data Connector to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sqs_urls: Specifies a list of AWS SQS urls for the AWS S3 Data Connector.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this AWS S3 Data Connector. Changing this forces a new AWS S3 Data Connector to be created.
        """
    ...
    def destination_table(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def destination_table(self, value: pulumi.Input[_builtins.str]):
    ...
    def sqs_urls(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    @sqs_urls.setter
    def sqs_urls(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class DataConnectorAwsS3(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="destinationTable")
    def destination_table(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Log Analytics table that will store the ingested data.
        """
        return pulumi.get(self, "destination_table")
    ...
    @_builtins.property
    @pulumi.getter(name="sqsUrls")
    def sqs_urls(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Specifies a list of AWS SQS urls for the AWS S3 Data Connector.
        """
        return pulumi.get(self, "sqs_urls")
