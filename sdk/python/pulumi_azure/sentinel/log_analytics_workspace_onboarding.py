...
class LogAnalyticsWorkspaceOnboardingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] workspace_id: Specifies the Workspace Id. Changing this forces the Log Analytics Workspace off the board and onboard again. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] customer_managed_key_enabled: Specifies if the Workspace is using Customer managed key. Defaults to `false`. Changing this forces a new resource to be created.
...
class LogAnalyticsWorkspaceOnboarding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            customer_managed_key_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LogAnalyticsWorkspaceOnboarding':
        """
