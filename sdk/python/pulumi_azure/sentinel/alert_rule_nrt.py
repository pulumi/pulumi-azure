...
class AlertRuleNrtArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The friendly name of this Sentinel NRT Alert Rule.
        :param pulumi.Input['AlertRuleNrtEventGroupingArgs'] event_grouping: A `event_grouping` block as defined below.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace this Sentinel NRT Alert Rule belongs to. Changing this forces a new Sentinel NRT Alert Rule to be created.
        ...
        :param pulumi.Input[builtins.str] alert_rule_template_guid: The GUID of the alert rule template which is used for this Sentinel NRT Alert Rule. Changing this forces a new Sentinel NRT Alert Rule to be created.
        :param pulumi.Input[builtins.str] alert_rule_template_version: The version of the alert rule template which is used for this Sentinel NRT Alert Rule. Changing this forces a new Sentinel NRT Alert Rule to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] custom_details: A map of string key-value pairs of columns to be attached to this Sentinel NRT Alert Rule. The key will appear as the field name in alerts and the value is the event parameter you wish to surface in the alerts.
        :param pulumi.Input[builtins.str] description: The description of this Sentinel NRT Alert Rule.
        :param pulumi.Input[builtins.bool] enabled: Should the Sentinel NRT Alert Rule be enabled? Defaults to `true`.
...
class AlertRuleNrt(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            suppression_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            tactics: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            techniques: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'AlertRuleNrt':
        """
