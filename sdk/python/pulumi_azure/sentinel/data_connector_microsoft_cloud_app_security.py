...
class DataConnectorMicrosoftCloudAppSecurity(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_microsoft_cloud_app_security = azure.sentinel.data_connector_microsoft_cloud_app_security.DataConnectorMicrosoftCloudAppSecurity("example",
            name=example,
