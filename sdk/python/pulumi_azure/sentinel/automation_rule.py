...
class AutomationRuleArgs:
    def __init__(__self__, *,
                 ...
                 action_incident_tasks: pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionIncidentTaskArgs']]]] = None,
                 action_incidents: pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionIncidentArgs']]]] = None,
                 action_playbooks: pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionPlaybookArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.bool] enabled: Whether this Sentinel Automation Rule is enabled? Defaults to `true`.
        :param pulumi.Input[_builtins.str] expiration: The time in RFC3339 format of kind `UTC` that determines when this Automation Rule should expire and be disabled.
        :param pulumi.Input[_builtins.str] name: The UUID which should be used for this Sentinel Automation Rule. Changing this forces a new Sentinel Automation Rule to be created.
    ...
    def action_incident_tasks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionIncidentTaskArgs']]]]:
        """
    ...
    def action_incident_tasks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionIncidentTaskArgs']]]]):
        pulumi.set(self, "action_incident_tasks", value)

    @_builtins.property
    @pulumi.getter(name="actionIncidents")
    def action_incidents(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionIncidentArgs']]]]:
        """
    ...
    def action_incidents(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionIncidentArgs']]]]):
        pulumi.set(self, "action_incidents", value)

    @_builtins.property
    @pulumi.getter(name="actionPlaybooks")
    def action_playbooks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionPlaybookArgs']]]]:
        """
    ...
    def action_playbooks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AutomationRuleActionPlaybookArgs']]]]):
...
class AutomationRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 action_incident_tasks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutomationRuleActionIncidentTaskArgs', 'AutomationRuleActionIncidentTaskArgsDict', 'outputs.AutomationRuleActionIncidentTask']]]]] = None,
                 action_incidents: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutomationRuleActionIncidentArgs', 'AutomationRuleActionIncidentArgsDict', 'outputs.AutomationRuleActionIncident']]]]] = None,
                 action_playbooks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AutomationRuleActionPlaybookArgs', 'AutomationRuleActionPlaybookArgsDict', 'outputs.AutomationRuleActionPlaybook']]]]] = None,
                 condition_json: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 expiration: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `Microsoft.OperationalInsights` - 2024-09-01
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutomationRuleActionIncidentTaskArgs', 'AutomationRuleActionIncidentTaskArgsDict', 'outputs.AutomationRuleActionIncidentTask']]]] action_incident_tasks: One or more `action_incident_task` blocks as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutomationRuleActionIncidentArgs', 'AutomationRuleActionIncidentArgsDict', 'outputs.AutomationRuleActionIncident']]]] action_incidents: One or more `action_incident` blocks as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AutomationRuleActionPlaybookArgs', 'AutomationRuleActionPlaybookArgsDict', 'outputs.AutomationRuleActionPlaybook']]]] action_playbooks: One or more `action_playbook` blocks as defined below.
    ...
    def get(resource_name: str,
            ...
            order: pulumi.Input[Optional[_builtins.int]] = None,
            triggers_on: pulumi.Input[Optional[_builtins.str]] = None,
            triggers_when: pulumi.Input[Optional[_builtins.str]] = None) -> 'AutomationRule':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="conditionJson")
    def condition_json(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A JSON array of one or more condition JSON objects as is defined [here](https://learn.microsoft.com/en-us/rest/api/securityinsights/preview/automation-rules/create-or-update?tabs=HTTP#automationruletriggeringlogic).
        """
        return pulumi.get(self, "condition_json")
    ...
    @_builtins.property
    @pulumi.getter(name="triggersOn")
    def triggers_on(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies what triggers this automation rule. Possible values are `Alerts` and `Incidents`. Defaults to `Incidents`.
        """
        return pulumi.get(self, "triggers_on")
    ...
    @_builtins.property
    @pulumi.getter(name="triggersWhen")
    def triggers_when(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies when will this automation rule be triggered. Possible values are `Created` and `Updated`. Defaults to `Created`.
        """
        return pulumi.get(self, "triggers_when")
