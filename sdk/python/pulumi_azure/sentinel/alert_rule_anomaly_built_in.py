...
class AlertRuleAnomalyBuiltInArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Should the Built-in Anomaly Alert Rule be enabled?
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace. Changing this forces a new Built-in Anomaly Alert Rule to be created.
        :param pulumi.Input[builtins.str] mode: mode of the Built-in Anomaly Alert Rule. Possible Values are `Production` and `Flighting`.
...
class _AlertRuleAnomalyBuiltInState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The Display Name of the built-in Anomaly Alert Rule.
               ...
               > **Note:** One of `name` or `display_name` block must be specified.
        :param pulumi.Input[builtins.bool] enabled: Should the Built-in Anomaly Alert Rule be enabled?
        :param pulumi.Input[builtins.str] frequency: The frequency the Anomaly Alert Rule will be run.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace. Changing this forces a new Built-in Anomaly Alert Rule to be created.
        :param pulumi.Input[builtins.str] mode: mode of the Built-in Anomaly Alert Rule. Possible Values are `Production` and `Flighting`.
...
class AlertRuleAnomalyBuiltIn(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            log_analytics_workspace_id: Optional[pulumi.Input[builtins.str]] = None,
            mode: Optional[pulumi.Input[builtins.str]] = None,
            multi_select_observations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlertRuleAnomalyBuiltInMultiSelectObservationArgs', 'AlertRuleAnomalyBuiltInMultiSelectObservationArgsDict']]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            prioritized_exclude_observations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlertRuleAnomalyBuiltInPrioritizedExcludeObservationArgs', 'AlertRuleAnomalyBuiltInPrioritizedExcludeObservationArgsDict']]]]] = None,
            required_data_connectors: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlertRuleAnomalyBuiltInRequiredDataConnectorArgs', 'AlertRuleAnomalyBuiltInRequiredDataConnectorArgsDict']]]]] = None,
            settings_definition_id: Optional[pulumi.Input[builtins.str]] = None,
            single_select_observations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlertRuleAnomalyBuiltInSingleSelectObservationArgs', 'AlertRuleAnomalyBuiltInSingleSelectObservationArgsDict']]]]] = None,
            tactics: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            techniques: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            threshold_observations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlertRuleAnomalyBuiltInThresholdObservationArgs', 'AlertRuleAnomalyBuiltInThresholdObservationArgsDict']]]]] = None) -> 'AlertRuleAnomalyBuiltIn':
        """
