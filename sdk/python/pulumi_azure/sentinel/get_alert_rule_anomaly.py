...
class GetAlertRuleAnomalyResult:
    ...
    def anomaly_settings_version(self) -> _builtins.int:
        """
    ...
    def settings_definition_id(self) -> _builtins.str:
        """
...
def get_alert_rule_anomaly(display_name: Optional[_builtins.str] = None,
