...
class DataConnectorAwsCloudTrailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_role_arn: The ARN of the AWS CloudTrail role, which is connected to this AWS CloudTrail Data Connector.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID of the Log Analytics Workspace that this AWS CloudTrail Data Connector resides in. Changing this forces a new AWS CloudTrail Data Connector to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this AWS CloudTrail Data Connector. Changing this forces a new AWS CloudTrail Data Connector to be created.
        """
...
class DataConnectorAwsCloudTrail(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            aws_role_arn: Optional[pulumi.Input[builtins.str]] = None,
            log_analytics_workspace_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'DataConnectorAwsCloudTrail':
        """
