...
class DataConnectorMicrosoftDefenderAdvancedThreatProtection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_data_connector_microsoft_defender_advanced_threat_protection = azure.sentinel.data_connector_microsoft_defender_advanced_threat_protection.DataConnectorMicrosoftDefenderAdvancedThreatProtection("example",
            name=example,
