...
def get_alert_rule_template(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str log_analytics_workspace_id: The ID of the Log Analytics Workspace.
    :param _builtins.str name: The name of this Sentinel Alert Rule Template. Either `display_name` or `name` have to be specified.
    """
    __args__ = dict()
