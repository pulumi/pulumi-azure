...
calass AwaitableGetElasticsearchResult(GetElasticsearchResult):
...
def get_elasticsearch(logs: Optional[Sequence[pulumi.InputType['GetElasticsearchLogArrgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetElasticsearchLogArrgs']] logs: A `logs` block as defined below.
...
def get_elasticsearch_output(logs: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetElasticsearchLogArrgs']]]]] = None,
