...
class ElasticsearchLogs(dict):
    ...
    def __init__(__self__, *,
                 ...
                 send_azuread_logs: Optional[builtins.bool] = None,
        ...
        :param builtins.bool send_activity_logs: Specifies if the Azure Activity Logs should be sent to the Elasticsearch cluster. Defaults to `false`.
        :param builtins.bool send_azuread_logs: Specifies if the AzureAD Logs should be sent to the Elasticsearch cluster. Defaults to `false`.
        :param builtins.bool send_subscription_logs: Specifies if the Azure Subscription Logs should be sent to the Elasticsearch cluster. Defaults to `false`.
        """
    ...
    def send_azuread_logs(self) -> Optional[builtins.bool]:
        """
...
class ElasticsearchLogsFilteringTag(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str action: Specifies the type of action which should be taken when the Tag matches the `name` and `value`. Possible values are `Exclude` and `Include`.
        :param builtins.str name: Specifies the name (key) of the Tag which should be filtered.
        :param builtins.str value: Specifies the value of the Tag which should be filtered.
        """
