...
if not MYPY:
    class AttachedDatabaseConfigurationSharingArgsDict(TypedDict):
        external_tables_to_excludes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of external tables exclude from the follower database.
        """
        external_tables_to_includes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of external tables to include in the follower database.
        """
        materialized_views_to_excludes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of materialized views exclude from the follower database.
        """
        materialized_views_to_includes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of materialized views to include in the follower database.
        """
        tables_to_excludes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of tables to exclude from the follower database.
        """
        tables_to_includes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AttachedDatabaseConfigurationSharingArgs:
    def __init__(__self__, *,
                 external_tables_to_excludes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 external_tables_to_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 materialized_views_to_excludes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 materialized_views_to_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tables_to_excludes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tables_to_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_tables_to_excludes: List of external tables exclude from the follower database.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] external_tables_to_includes: List of external tables to include in the follower database.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] materialized_views_to_excludes: List of materialized views exclude from the follower database.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] materialized_views_to_includes: List of materialized views to include in the follower database.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tables_to_excludes: List of tables to exclude from the follower database.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tables_to_includes: List of tables to include in the follower database.
        """
    ...
    def external_tables_to_excludes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of external tables exclude from the follower database.
        """
    ...
    def external_tables_to_excludes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "external_tables_to_excludes", value)

    @property
    @pulumi.getter(name="externalTablesToIncludes")
    def external_tables_to_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of external tables to include in the follower database.
        """
    ...
    def external_tables_to_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "external_tables_to_includes", value)

    @property
    @pulumi.getter(name="materializedViewsToExcludes")
    def materialized_views_to_excludes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of materialized views exclude from the follower database.
        """
    ...
    def materialized_views_to_excludes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "materialized_views_to_excludes", value)

    @property
    @pulumi.getter(name="materializedViewsToIncludes")
    def materialized_views_to_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of materialized views to include in the follower database.
        """
    ...
    def materialized_views_to_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "materialized_views_to_includes", value)

    @property
    @pulumi.getter(name="tablesToExcludes")
    def tables_to_excludes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of tables to exclude from the follower database.
        """
    ...
    def tables_to_excludes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "tables_to_excludes", value)

    @property
    @pulumi.getter(name="tablesToIncludes")
    def tables_to_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of tables to include in the follower database.
        """
    ...
    def tables_to_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ClusterIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that is configured on this Kusto Cluster. Possible values are: `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Kusto Cluster.
...
if not MYPY:
    class ClusterOptimizedAutoScaleArgsDict(TypedDict):
        maximum_instances: pulumi.Input[builtins.int]
        """
        The maximum number of allowed instances. Must between `0` and `1000`.
        """
        minimum_instances: pulumi.Input[builtins.int]
        """
...
class ClusterOptimizedAutoScaleArgs:
    def __init__(__self__, *,
                 ...
                 minimum_instances: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] maximum_instances: The maximum number of allowed instances. Must between `0` and `1000`.
        :param pulumi.Input[builtins.int] minimum_instances: The minimum number of allowed instances. Must between `0` and `1000`.
        """
    ...
    def maximum_instances(self) -> pulumi.Input[builtins.int]:
        """
        The maximum number of allowed instances. Must between `0` and `1000`.
        """
    ...
    def maximum_instances(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "maximum_instances", value)

    @property
    @pulumi.getter(name="minimumInstances")
    def minimum_instances(self) -> pulumi.Input[builtins.int]:
        """
        The minimum number of allowed instances. Must between `0` and `1000`.
        """
    ...
    def minimum_instances(self, value: pulumi.Input[builtins.int]):
...
class ClusterSkuArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the SKU. Possible values are `Dev(No SLA)_Standard_D11_v2`, `Dev(No SLA)_Standard_E2a_v4`, `Standard_D14_v2`, `Standard_D11_v2`, `Standard_D16d_v5`, `Standard_D13_v2`, `Standard_D12_v2`, `Standard_DS14_v2+4TB_PS`, `Standard_DS14_v2+3TB_PS`, `Standard_DS13_v2+1TB_PS`, `Standard_DS13_v2+2TB_PS`, `Standard_D32d_v5`, `Standard_D32d_v4`, `Standard_EC8ads_v5`, `Standard_EC8as_v5+1TB_PS`, `Standard_EC8as_v5+2TB_PS`, `Standard_EC16ads_v5`, `Standard_EC16as_v5+4TB_PS`, `Standard_EC16as_v5+3TB_PS`, `Standard_E80ids_v4`, `Standard_E8a_v4`, `Standard_E8ads_v5`, `Standard_E8as_v5+1TB_PS`, `Standard_E8as_v5+2TB_PS`, `Standard_E8as_v4+1TB_PS`, `Standard_E8as_v4+2TB_PS`, `Standard_E8d_v5`, `Standard_E8d_v4`, `Standard_E8s_v5+1TB_PS`, `Standard_E8s_v5+2TB_PS`, `Standard_E8s_v4+1TB_PS`, `Standard_E8s_v4+2TB_PS`, `Standard_E4a_v4`, `Standard_E4ads_v5`, `Standard_E4d_v5`, `Standard_E4d_v4`, `Standard_E16a_v4`, `Standard_E16ads_v5`, `Standard_E16as_v5+4TB_PS`, `Standard_E16as_v5+3TB_PS`, `Standard_E16as_v4+4TB_PS`, `Standard_E16as_v4+3TB_PS`, `Standard_E16d_v5`, `Standard_E16d_v4`, `Standard_E16s_v5+4TB_PS`, `Standard_E16s_v5+3TB_PS`, `Standard_E16s_v4+4TB_PS`, `Standard_E16s_v4+3TB_PS`, `Standard_E64i_v3`, `Standard_E2a_v4`, `Standard_E2ads_v5`, `Standard_E2d_v5`, `Standard_E2d_v4`, `Standard_L8as_v3`, `Standard_L8s`, `Standard_L8s_v3`, `Standard_L8s_v2`, `Standard_L4s`, `Standard_L16as_v3`, `Standard_L16s`, `Standard_L16s_v3`, `Standard_L16s_v2`, `Standard_L32as_v3` and `Standard_L32s_v3`.
        :param pulumi.Input[builtins.int] capacity: Specifies the node count for the cluster. Boundaries depend on the SKU name.
