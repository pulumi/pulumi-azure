...
class ClusterCustomerManagedKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The ID of the Kusto Cluster. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] user_identity: The user assigned identity that has access to the Key Vault Key. If not specified, system assigned identity will be used.
        """
...
class ClusterCustomerManagedKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_vault_id: Optional[pulumi.Input[builtins.str]] = None,
            key_version: Optional[pulumi.Input[builtins.str]] = None,
            user_identity: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterCustomerManagedKey':
        """
    ...
    @property
    @pulumi.getter(name="userIdentity")
    def user_identity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The user assigned identity that has access to the Key Vault Key. If not specified, system assigned identity will be used.
        """
        return pulumi.get(self, "user_identity")
