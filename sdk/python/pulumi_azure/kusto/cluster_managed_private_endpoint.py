...
class ClusterManagedPrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_name: The name of the Kusto Cluster. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] group_id: The group id in which the managed private endpoint is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_link_resource_id: The ARM resource ID of the resource for which the managed private endpoint is created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Managed Private Endpoints to create. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_link_resource_region: The region of the resource to which the managed private endpoint is created. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:kusto/clusterManagedPrivateEndpoint:ClusterManagedPrivateEndpoint")
class ClusterManagedPrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            private_link_resource_region: Optional[pulumi.Input[builtins.str]] = None,
            request_message: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterManagedPrivateEndpoint':
        """
