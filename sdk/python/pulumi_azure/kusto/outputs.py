...
class AttachedDatabaseConfigurationSharing(dict):
    ...
    def __init__(__self__, *,
                 external_tables_to_excludes: Optional[Sequence[builtins.str]] = None,
                 external_tables_to_includes: Optional[Sequence[builtins.str]] = None,
                 materialized_views_to_excludes: Optional[Sequence[builtins.str]] = None,
                 materialized_views_to_includes: Optional[Sequence[builtins.str]] = None,
                 tables_to_excludes: Optional[Sequence[builtins.str]] = None,
                 tables_to_includes: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] external_tables_to_excludes: List of external tables exclude from the follower database.
        :param Sequence[builtins.str] external_tables_to_includes: List of external tables to include in the follower database.
        :param Sequence[builtins.str] materialized_views_to_excludes: List of materialized views exclude from the follower database.
        :param Sequence[builtins.str] materialized_views_to_includes: List of materialized views to include in the follower database.
        :param Sequence[builtins.str] tables_to_excludes: List of tables to exclude from the follower database.
        :param Sequence[builtins.str] tables_to_includes: List of tables to include in the follower database.
        """
    ...
    def external_tables_to_excludes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def external_tables_to_includes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def materialized_views_to_excludes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def materialized_views_to_includes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def tables_to_excludes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def tables_to_includes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClusterIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that is configured on this Kusto Cluster. Possible values are: `SystemAssigned`, `UserAssigned` and `SystemAssigned, UserAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Kusto Cluster.
...
class ClusterLanguageExtension(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str name: The name of the Kusto Cluster to create. Only lowercase Alphanumeric characters allowed, starting with a letter. Changing this forces a new resource to be created.
        """
...
class ClusterOptimizedAutoScale(dict):
    ...
    def __init__(__self__, *,
                 maximum_instances: builtins.int,
                 minimum_instances: builtins.int):
        """
        :param builtins.int maximum_instances: The maximum number of allowed instances. Must between `0` and `1000`.
        :param builtins.int minimum_instances: The minimum number of allowed instances. Must between `0` and `1000`.
        """
    ...
    def maximum_instances(self) -> builtins.int:
        """
    ...
    def minimum_instances(self) -> builtins.int:
        """
...
class GetClusterIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Kusto Cluster.
        :param builtins.str principal_id: The Principal ID associated with this System Assigned Managed Service Identity.
        :param builtins.str tenant_id: The Tenant ID associated with this System Assigned Managed Service Identity.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Kusto Cluster.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
