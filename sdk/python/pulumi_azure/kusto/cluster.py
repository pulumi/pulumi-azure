...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 allowed_fqdns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 allowed_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 auto_stop_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 disk_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 double_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 public_ip_type: Optional[pulumi.Input[builtins.str]] = None,
                 public_network_access_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 purge_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 streaming_ingestion_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 trusted_external_tenants: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the Resource Group where the Kusto Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input['ClusterSkuArgs'] sku: A `sku` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_fqdns: List of allowed FQDNs(Fully Qualified Domain Name) for egress from Cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_ip_ranges: The list of ips in the format of CIDR allowed to connect to the cluster.
        :param pulumi.Input[builtins.bool] auto_stop_enabled: Specifies if the cluster could be automatically stopped (due to lack of data or no activity for many days). Defaults to `true`.
        :param pulumi.Input[builtins.bool] disk_encryption_enabled: Specifies if the cluster's disks are encrypted.
        :param pulumi.Input[builtins.bool] double_encryption_enabled: Is the cluster's double encryption enabled? Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] location: The location where the Kusto Cluster should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Kusto Cluster to create. Only lowercase Alphanumeric characters allowed, starting with a letter. Changing this forces a new resource to be created.
        :param pulumi.Input['ClusterOptimizedAutoScaleArgs'] optimized_auto_scale: An `optimized_auto_scale` block as defined below.
        :param pulumi.Input[builtins.bool] outbound_network_access_restricted: Whether to restrict outbound network access. Value is optional but if passed in, must be `true` or `false`, default is `false`.
        :param pulumi.Input[builtins.str] public_ip_type: Indicates what public IP type to create - IPv4 (default), or DualStack (both IPv4 and IPv6). Defaults to `IPv4`.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Is the public network access enabled? Defaults to `true`.
        :param pulumi.Input[builtins.bool] purge_enabled: Specifies if the purge operations are enabled.
        :param pulumi.Input[builtins.bool] streaming_ingestion_enabled: Specifies if the streaming ingest is enabled.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_external_tenants: Specifies a list of tenant IDs that are trusted by the cluster. Default setting trusts all other tenants. Use `trusted_external_tenants = ["*"]` to explicitly allow all other tenants, `trusted_external_tenants = ["MyTenantOnly"]` for only your tenant or `trusted_external_tenants = ["<tenantId1>", "<tenantIdx>"]` to allow specific other tenants.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Specifies a list of Availability Zones in which this Kusto Cluster should be located. Changing this forces a new Kusto Cluster to be created.
        """
    ...
    def allowed_fqdns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def allowed_fqdns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def auto_stop_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_stop_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_stop_enabled", value)

    @property
    @pulumi.getter(name="diskEncryptionEnabled")
    def disk_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def disk_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "disk_encryption_enabled", value)

    @property
    @pulumi.getter(name="doubleEncryptionEnabled")
    def double_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def double_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def public_ip_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_ip_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def purge_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def purge_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "purge_enabled", value)

    @property
    @pulumi.getter(name="streamingIngestionEnabled")
    def streaming_ingestion_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def streaming_ingestion_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def trusted_external_tenants(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def trusted_external_tenants(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 allowed_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 auto_stop_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 data_ingestion_uri: Optional[pulumi.Input[builtins.str]] = None,
                 disk_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 double_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 identity: Optional[pulumi.Input['ClusterIdentityArgs']] = None,
                 language_extensions: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterLanguageExtensionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_ip_ranges: The list of ips in the format of CIDR allowed to connect to the cluster.
        :param pulumi.Input[builtins.bool] auto_stop_enabled: Specifies if the cluster could be automatically stopped (due to lack of data or no activity for many days). Defaults to `true`.
        :param pulumi.Input[builtins.str] data_ingestion_uri: The Kusto Cluster URI to be used for data ingestion.
        :param pulumi.Input[builtins.bool] disk_encryption_enabled: Specifies if the cluster's disks are encrypted.
        :param pulumi.Input[builtins.bool] double_encryption_enabled: Is the cluster's double encryption enabled? Changing this forces a new resource to be created.
        :param pulumi.Input['ClusterIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterLanguageExtensionArgs']]] language_extensions: An list of `language_extensions` to enable. Valid values are: `PYTHON`, `PYTHON_3.10.8` and `R`. `PYTHON` is used to specify Python 3.6.5 image and `PYTHON_3.10.8` is used to specify Python 3.10.8 image. Note that `PYTHON_3.10.8` is only available in skus which support nested virtualization.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_external_tenants: Specifies a list of tenant IDs that are trusted by the cluster. Default setting trusts all other tenants. Use `trusted_external_tenants = ["*"]` to explicitly allow all other tenants, `trusted_external_tenants = ["MyTenantOnly"]` for only your tenant or `trusted_external_tenants = ["<tenantId1>", "<tenantIdx>"]` to allow specific other tenants.
               ...
               > **Note:** In v3.0 of `azurerm` a new or updated Kusto Cluster will only allow your own tenant by default. Explicit configuration of this setting will change from `trusted_external_tenants = ["MyTenantOnly"]` to `trusted_external_tenants = []`.
        :param pulumi.Input[builtins.str] uri: The FQDN of the Azure Kusto Cluster.
        :param pulumi.Input['ClusterVirtualNetworkConfigurationArgs'] virtual_network_configuration: A `virtual_network_configuration` block as defined below.
    ...
    def data_ingestion_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_ingestion_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            uri: Optional[pulumi.Input[builtins.str]] = None,
            virtual_network_configuration: Optional[pulumi.Input[Union['ClusterVirtualNetworkConfigurationArgs', 'ClusterVirtualNetworkConfigurationArgsDict']]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="allowedFqdns")
    def allowed_fqdns(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of allowed FQDNs(Fully Qualified Domain Name) for egress from Cluster.
        """
        return pulumi.get(self, "allowed_fqdns")
    ...
    @property
    @pulumi.getter(name="allowedIpRanges")
    def allowed_ip_ranges(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of ips in the format of CIDR allowed to connect to the cluster.
        """
        return pulumi.get(self, "allowed_ip_ranges")
    ...
    @property
    @pulumi.getter(name="autoStopEnabled")
    def auto_stop_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the cluster could be automatically stopped (due to lack of data or no activity for many days). Defaults to `true`.
        """
        return pulumi.get(self, "auto_stop_enabled")
    ...
    @property
    @pulumi.getter(name="diskEncryptionEnabled")
    def disk_encryption_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the cluster's disks are encrypted.
        """
        return pulumi.get(self, "disk_encryption_enabled")
    ...
    @property
    @pulumi.getter(name="doubleEncryptionEnabled")
    def double_encryption_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is the cluster's double encryption enabled? Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "double_encryption_enabled")
    ...
    @property
    @pulumi.getter(name="publicIpType")
    def public_ip_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates what public IP type to create - IPv4 (default), or DualStack (both IPv4 and IPv6). Defaults to `IPv4`.
        """
        return pulumi.get(self, "public_ip_type")
    ...
    @property
    @pulumi.getter(name="purgeEnabled")
    def purge_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the purge operations are enabled.
        """
        return pulumi.get(self, "purge_enabled")
    ...
    @property
    @pulumi.getter(name="streamingIngestionEnabled")
    def streaming_ingestion_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the streaming ingest is enabled.
        """
        return pulumi.get(self, "streaming_ingestion_enabled")
    ...
    @property
    @pulumi.getter(name="trustedExternalTenants")
    def trusted_external_tenants(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies a list of tenant IDs that are trusted by the cluster. Default setting trusts all other tenants. Use `trusted_external_tenants = ["*"]` to explicitly allow all other tenants, `trusted_external_tenants = ["MyTenantOnly"]` for only your tenant or `trusted_external_tenants = ["<tenantId1>", "<tenantIdx>"]` to allow specific other tenants.
