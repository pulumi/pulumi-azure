...
class IotHubDataConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] iothub_id: Specifies the resource id of the IotHub this data connection will use for ingestion. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_system_properties: Specifies the System Properties that each IoT Hub message should contain. Changing this forces a new resource to be created.
...
class IotHubDataConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retrieval_start_date: pulumi.Input[Optional[_builtins.str]] = None,
            shared_access_policy_name: pulumi.Input[Optional[_builtins.str]] = None,
            table_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'IotHubDataConnection':
        """
