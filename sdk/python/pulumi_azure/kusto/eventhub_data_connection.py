...
class EventhubDataConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] consumer_group: Specifies the EventHub consumer group this data connection will use for ingestion. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] eventhub_id: Specifies the resource id of the EventHub this data connection will use for ingestion. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] compression: Specifies compression type for the connection. Allowed values: `GZip` and `None`. Defaults to `None`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] data_format: Specifies the data format of the EventHub messages. Allowed values: `APACHEAVRO`, `AVRO`, `CSV`, `JSON`, `MULTIJSON`, `ORC`, `PARQUET`, `PSV`, `RAW`, `SCSV`, `SINGLEJSON`, `SOHSV`, `TSVE`, `TSV`, `TXT`, and `W3CLOGFILE`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_system_properties: Specifies a list of system properties for the Event Hub.
        :param pulumi.Input[builtins.str] identity_id: The resource ID of a managed identity (system or user assigned) to be used to authenticate with event hub.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Kusto EventHub Data Connection to create. Changing this forces a new resource to be created.
...
class EventhubDataConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EventhubDataConnection':
        """
    ...
    @property
    @pulumi.getter(name="eventSystemProperties")
    def event_system_properties(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Specifies a list of system properties for the Event Hub.
        """
        return pulumi.get(self, "event_system_properties")
    ...
    @property
    @pulumi.getter(name="identityId")
    def identity_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The resource ID of a managed identity (system or user assigned) to be used to authenticate with event hub.
        """
        return pulumi.get(self, "identity_id")
