...
class ScriptArgs:
    def __init__(__self__, *,
                 ...
                 continue_on_errors_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 force_an_update_when_value_changed: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_id: The ID of the Kusto Database. Changing this forces a new Kusto Script to be created.
        :param pulumi.Input[builtins.bool] continue_on_errors_enabled: Flag that indicates whether to continue if one of the command fails.
        :param pulumi.Input[builtins.str] force_an_update_when_value_changed: A unique string. If changed the script will be applied again.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Kusto Script. Changing this forces a new Kusto Script to be created.
        :param pulumi.Input[builtins.str] sas_token: The SAS token used to access the script. Must be provided when using scriptUrl property. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] script_content: The script content. This property should be used when the script is provide inline and not through file in a SA. Must not be used together with `url` and `sas_token` properties. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] url: The url to the KQL script blob file. Must not be used together with scriptContent property. Please reference [this documentation](https://docs.microsoft.com/azure/data-explorer/database-script) that describes the commands that are allowed in the script.
        """
    ...
    def continue_on_errors_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def continue_on_errors_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "continue_on_errors_enabled", value)

    @property
    @pulumi.getter(name="forceAnUpdateWhenValueChanged")
    def force_an_update_when_value_changed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def force_an_update_when_value_changed(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Script(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sas_token: Optional[pulumi.Input[builtins.str]] = None,
            script_content: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'Script':
        """
    ...
    @property
    @pulumi.getter(name="continueOnErrorsEnabled")
    def continue_on_errors_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag that indicates whether to continue if one of the command fails.
        """
        return pulumi.get(self, "continue_on_errors_enabled")
    ...
    @property
    @pulumi.getter(name="forceAnUpdateWhenValueChanged")
    def force_an_update_when_value_changed(self) -> pulumi.Output[builtins.str]:
        """
        A unique string. If changed the script will be applied again.
        """
        return pulumi.get(self, "force_an_update_when_value_changed")
    ...
    @property
    @pulumi.getter(name="sasToken")
    def sas_token(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SAS token used to access the script. Must be provided when using scriptUrl property. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sas_token")
