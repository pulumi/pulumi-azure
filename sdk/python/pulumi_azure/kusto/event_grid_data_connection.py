...
class EventGridDataConnectionArgs:
    def __init__(__self__, *,
                 ...
                 eventhub_consumer_group_name: pulumi.Input[builtins.str],
                 eventhub_id: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 storage_account_id: pulumi.Input[builtins.str],
                 blob_storage_event_type: Optional[pulumi.Input[builtins.str]] = None,
                 data_format: Optional[pulumi.Input[builtins.str]] = None,
                 database_routing_type: Optional[pulumi.Input[builtins.str]] = None,
                 eventgrid_event_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
                 eventgrid_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 managed_identity_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 skip_first_record: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_name: Specifies the name of the Kusto Cluster this data connection will be added to. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] eventhub_consumer_group_name: Specifies the Event Hub consumer group this data connection will use for ingestion. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] eventhub_id: Specifies the resource id of the Event Hub this data connection will use for ingestion. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the Resource Group where the Kusto Database should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_id: Specifies the resource id of the Storage Account this data connection will use for ingestion. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] blob_storage_event_type: Specifies the blob storage event type that needs to be processed. Possible Values are `Microsoft.Storage.BlobCreated` and `Microsoft.Storage.BlobRenamed`. Defaults to `Microsoft.Storage.BlobCreated`.
        :param pulumi.Input[builtins.str] data_format: Specifies the data format of the EventHub messages. Allowed values: `APACHEAVRO`, `AVRO`, `CSV`, `JSON`, `MULTIJSON`, `ORC`, `PARQUET`, `PSV`, `RAW`, `SCSV`, `SINGLEJSON`, `SOHSV`, `TSV`, `TSVE`, `TXT` and `W3CLOGFILE`.
        ...
        :param pulumi.Input[builtins.str] eventgrid_event_subscription_id: The resource ID of the event grid that is subscribed to the storage account events.
        ...
        :param pulumi.Input[builtins.str] managed_identity_id: Empty for non-managed identity based data connection. For system assigned identity, provide cluster resource Id. For user assigned identity (UAI) provide the UAI resource Id.
        :param pulumi.Input[builtins.str] mapping_rule_name: Specifies the mapping rule used for the message ingestion. Mapping rule must exist before resource is created.
        :param pulumi.Input[builtins.str] name: The name of the Kusto Event Grid Data Connection to create. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] skip_first_record: is the first record of every file ignored? Defaults to `false`.
        :param pulumi.Input[builtins.str] table_name: Specifies the target table name used for the message ingestion. Table must exist before resource is created.
        """
    ...
    def eventhub_consumer_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def eventhub_consumer_group_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "eventhub_consumer_group_name", value)

    @property
    @pulumi.getter(name="eventhubId")
    def eventhub_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @eventhub_id.setter
    def eventhub_id(self, value: pulumi.Input[builtins.str]):
    ...
    def blob_storage_event_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blob_storage_event_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def database_routing_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_routing_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_routing_type", value)

    @property
    @pulumi.getter(name="eventgridEventSubscriptionId")
    def eventgrid_event_subscription_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def eventgrid_event_subscription_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def eventgrid_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "eventgrid_resource_id")

    @eventgrid_resource_id.setter
    def eventgrid_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def managed_identity_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def managed_identity_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def skip_first_record(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def skip_first_record(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _EventGridDataConnectionState:
    def __init__(__self__, *,
                 ...
                 eventgrid_event_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
                 eventgrid_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 eventhub_consumer_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 eventhub_id: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 managed_identity_id: Optional[pulumi.Input[builtins.str]] = None,
                 managed_identity_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 mapping_rule_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="eventhubConsumerGroupName")
    def eventhub_consumer_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Event Hub consumer group this data connection will use for ingestion. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "eventhub_consumer_group_name")
    ...
    @eventhub_consumer_group_name.setter
    def eventhub_consumer_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "eventhub_consumer_group_name", value)

    @property
    @pulumi.getter(name="eventhubId")
    def eventhub_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the resource id of the Event Hub this data connection will use for ingestion. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "eventhub_id")
    ...
    @eventhub_id.setter
    def eventhub_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "eventhub_id", value)
...
class EventGridDataConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            skip_first_record: Optional[pulumi.Input[builtins.bool]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None) -> 'EventGridDataConnection':
        """
    ...
    @property
    @pulumi.getter(name="blobStorageEventType")
    def blob_storage_event_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the blob storage event type that needs to be processed. Possible Values are `Microsoft.Storage.BlobCreated` and `Microsoft.Storage.BlobRenamed`. Defaults to `Microsoft.Storage.BlobCreated`.
        """
        return pulumi.get(self, "blob_storage_event_type")
    ...
    @property
    @pulumi.getter(name="databaseRoutingType")
    def database_routing_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indication for database routing information from the data connection, by default only database routing information is allowed. Allowed values: `Single`, `Multi`. Changing this forces a new resource to be created. Defaults to `Single`.
        """
        return pulumi.get(self, "database_routing_type")
    ...
    @property
    @pulumi.getter(name="eventgridEventSubscriptionId")
    def eventgrid_event_subscription_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the event grid that is subscribed to the storage account events.
        """
        return pulumi.get(self, "eventgrid_event_subscription_id")
    ...
    @pulumi.getter(name="eventgridResourceId")
    @_utilities.deprecated("""`eventgrid_resource_id` has been deprecated in favour of the `eventgrid_event_subscription_id` property and will be removed in v5.0 of the AzureRM Provider.""")
    def eventgrid_resource_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "eventgrid_resource_id")

    @property
    @pulumi.getter(name="eventhubConsumerGroupName")
    def eventhub_consumer_group_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Event Hub consumer group this data connection will use for ingestion. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "eventhub_consumer_group_name")
    ...
    @property
    @pulumi.getter(name="eventhubId")
    def eventhub_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the resource id of the Event Hub this data connection will use for ingestion. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "eventhub_id")
    ...
    @property
    @pulumi.getter(name="managedIdentityId")
    def managed_identity_id(self) -> pulumi.Output[builtins.str]:
        """
        Empty for non-managed identity based data connection. For system assigned identity, provide cluster resource Id. For user assigned identity (UAI) provide the UAI resource Id.
        """
        return pulumi.get(self, "managed_identity_id")
    ...
    @pulumi.getter(name="managedIdentityResourceId")
    @_utilities.deprecated("""`managed_identity_resource_id` has been deprecated in favour of the `managed_identity_id` property and will be removed in v5.0 of the AzureRM Provider.""")
    def managed_identity_resource_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "managed_identity_resource_id")
    ...
    @property
    @pulumi.getter(name="skipFirstRecord")
    def skip_first_record(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        is the first record of every file ignored? Defaults to `false`.
        """
        return pulumi.get(self, "skip_first_record")
