...
class AttachedDatabaseConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 default_principal_modification_kind: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_name: Specifies the name of the Kusto Cluster for which the configuration will be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] database_name: The name of the database which you would like to attach, use * if you want to follow all current and future databases. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group of the Kusto Cluster for which the configuration will be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] cluster_id: The resource id of the cluster where the databases you would like to attach reside. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] default_principal_modification_kind: The default principals modification kind. Valid values are: `None` (default), `Replace` and `Union`. Defaults to `None`.
        :param pulumi.Input[builtins.str] location: Specifies the location of the Kusto Cluster for which the configuration will be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Kusto Attached Database Configuration to create. Changing this forces a new resource to be created.
    ...
    def default_principal_modification_kind(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_principal_modification_kind(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AttachedDatabaseConfigurationState:
    def __init__(__self__, *,
                 attached_database_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cluster_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] attached_database_names: The list of databases from the `cluster_resource_id` which are currently attached to the cluster.
        :param pulumi.Input[builtins.str] cluster_id: The resource id of the cluster where the databases you would like to attach reside. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] cluster_name: Specifies the name of the Kusto Cluster for which the configuration will be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] database_name: The name of the database which you would like to attach, use * if you want to follow all current and future databases. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] default_principal_modification_kind: The default principals modification kind. Valid values are: `None` (default), `Replace` and `Union`. Defaults to `None`.
    ...
    def attached_database_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def attached_database_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AttachedDatabaseConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultPrincipalModificationKind")
    def default_principal_modification_kind(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default principals modification kind. Valid values are: `None` (default), `Replace` and `Union`. Defaults to `None`.
        """
        return pulumi.get(self, "default_principal_modification_kind")
