...
class GatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_id: The ID of the API Management Resource in which the gateway will be created. Changing this forces a new API Management Gateway resource to be created.
        :param pulumi.Input['GatewayLocationDataArgs'] location_data: A `location_data` block as documented below.
        :param pulumi.Input[builtins.str] description: The description of the API Management Gateway.
        :param pulumi.Input[builtins.str] name: The name which should be used for the API Management Gateway. Changing this forces a new API Management Gateway to be created.
        """
...
@pulumi.type_token("azure:apimanagement/gateway:Gateway")
class Gateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            location_data: Optional[pulumi.Input[Union['GatewayLocationDataArgs', 'GatewayLocationDataArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'Gateway':
        """
