...
def get_user(api_management_name: Optional[builtins.str] = None,
    ...
    :param builtins.str api_management_name: The Name of the API Management Service in which this User exists.
    :param builtins.str resource_group_name: The Name of the Resource Group in which the API Management Service exists.
    :param builtins.str user_id: The Identifier for the User.
    """
    __args__ = dict()
...
def get_user_output(api_management_name: Optional[pulumi.Input[builtins.str]] = None,
