...
class RedisCacheArgs:
    def __init__(__self__, *,
                 ...
                 cache_location: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] api_management_id: The resource ID of the API Management Service from which to create this external cache. Changing this forces a new API Management Redis Cache to be created.
        :param pulumi.Input[builtins.str] connection_string: The connection string to the Cache for Redis.
        :param pulumi.Input[builtins.str] cache_location: The location where to use cache from. Possible values are `default` and valid Azure regions. Defaults to `default`.
        :param pulumi.Input[builtins.str] description: The description of the API Management Redis Cache.
        :param pulumi.Input[builtins.str] name: The name which should be used for this API Management Redis Cache. Changing this forces a new API Management Redis Cache to be created.
        :param pulumi.Input[builtins.str] redis_cache_id: The resource ID of the Cache for Redis.
        """
    ...
    def cache_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cache_location(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure:apimanagement/redisCache:RedisCache")
class RedisCache(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            redis_cache_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RedisCache':
        """
    ...
    @property
    @pulumi.getter(name="cacheLocation")
    def cache_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The location where to use cache from. Possible values are `default` and valid Azure regions. Defaults to `default`.
        """
        return pulumi.get(self, "cache_location")
    ...
    @property
    @pulumi.getter(name="redisCacheId")
    def redis_cache_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The resource ID of the Cache for Redis.
        """
        return pulumi.get(self, "redis_cache_id")
