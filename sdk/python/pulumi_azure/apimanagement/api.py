...
class ApiArgs:
    def __init__(__self__, *,
                 ...
                 revision_description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] api_management_name: The Name of the API Management Service where this API should be created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] api_type: Type of API. Possible values are `graphql`, `http`, `soap`, and `websocket`. Defaults to `http`.
        :param pulumi.Input['ApiContactArgs'] contact: A `contact` block as documented below.
        :param pulumi.Input[builtins.str] description: A description of the API Management API, which may include HTML formatting tags.
        ...
        :param pulumi.Input[builtins.str] terms_of_service_url: Absolute URL of the Terms of Service for the API.
        :param pulumi.Input[builtins.str] version: The Version number of this API, if this API is versioned.
    ...
    def revision_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def revision_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ApiState:
    def __init__(__self__, *,
                 ...
                 is_online: Optional[pulumi.Input[builtins.bool]] = None,
                 license: Optional[pulumi.Input['ApiLicenseArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 oauth2_authorization: Optional[pulumi.Input['ApiOauth2AuthorizationArgs']] = None,
                 openid_authentication: Optional[pulumi.Input['ApiOpenidAuthenticationArgs']] = None,
    ...
    def is_online(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_online.setter
    def is_online(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Api(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version: Optional[pulumi.Input[builtins.str]] = None,
            version_description: Optional[pulumi.Input[builtins.str]] = None,
            version_set_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Api':
        """
    ...
    @property
    @pulumi.getter(name="isCurrent")
    def is_current(self) -> pulumi.Output[builtins.bool]:
        """
        Is this the current API Revision?
        """
        return pulumi.get(self, "is_current")
    ...
    @property
    @pulumi.getter(name="revisionDescription")
    def revision_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description of the API Revision of the API Management API.
        """
        return pulumi.get(self, "revision_description")
    ...
    @property
    @pulumi.getter(name="versionSetId")
    def version_set_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Version Set which this API is associated with.
