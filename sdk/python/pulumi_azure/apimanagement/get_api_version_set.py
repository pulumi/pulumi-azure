...
def get_api_version_set(api_management_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.ApiManagement`: 2022-08-01
    ...
    :param builtins.str resource_group_name: The name of the Resource Group in which the parent API Management Service exists.
    """
    __args__ = dict()
...
def get_api_version_set_output(api_management_name: Optional[pulumi.Input[builtins.str]] = None,
