...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] last_name: The last name for this user.
        ...
        :param pulumi.Input[_builtins.str] user_id: The Identifier for this User, which must be unique within the API Management Service. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] note: A note about this user.
        :param pulumi.Input[_builtins.str] password: The password associated with this user.
        :param pulumi.Input[_builtins.str] state: The state of this user. Possible values are `active`, `blocked` and `pending`.
...
class User(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def confirmation(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The kind of confirmation email which will be sent to this user. Possible values are `invite` and `signup`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "confirmation")
