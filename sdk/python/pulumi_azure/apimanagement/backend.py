...
class BackendArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_name: The Name of the API Management Service where this backend should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] protocol: The protocol used by the backend host. Possible values are `http` or `soap`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the API Management backend. Changing this forces a new resource to be created.
        :param pulumi.Input['BackendProxyArgs'] proxy: A `proxy` block as documented below.
        :param pulumi.Input[builtins.str] resource_id: The management URI of the backend host in an external system. This URI can be the ARM Resource ID of Logic Apps, Function Apps or API Apps, or the management endpoint of a Service Fabric cluster.
        ...
        :param pulumi.Input[builtins.str] title: The title of the backend.
...
class Backend(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[builtins.str]] = None,
            tls: Optional[pulumi.Input[Union['BackendTlsArgs', 'BackendTlsArgsDict']]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'Backend':
        """
