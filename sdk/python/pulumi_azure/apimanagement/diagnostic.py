...
class DiagnosticArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_logger_id: The id of the target API Management Logger where the API Management Diagnostic should be saved.
        :param pulumi.Input[builtins.str] api_management_name: The Name of the API Management Service where this Diagnostic should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] identifier: The diagnostic identifier for the API Management Service. At this time the supported values are `applicationinsights` and `azuremonitor`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] operation_name_format: The format of the Operation Name for Application Insights telemetries. Possible values are `Name`, and `Url`.
...
class Diagnostic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            sampling_percentage: Optional[pulumi.Input[builtins.float]] = None,
            verbosity: Optional[pulumi.Input[builtins.str]] = None) -> 'Diagnostic':
        """
