...
class TagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_id: The ID of the API Management. Changing this forces a new API Management Tag to be created.
        :param pulumi.Input[builtins.str] display_name: The display name of the API Management Tag. Defaults to the `name`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this API Management Tag. Changing this forces a new API Management Tag to be created. The name must be unique in the API Management Service.
        """
...
@pulumi.type_token("azure:apimanagement/tag:Tag")
