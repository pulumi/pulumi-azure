...
class IdentityProviderGoogleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_name: The Name of the API Management Service where this Google Identity Provider should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] client_id: Client Id for Google Sign-in.
        :param pulumi.Input[builtins.str] client_secret: Client secret for Google Sign-in.
...
@pulumi.type_token("azure:apimanagement/identityProviderGoogle:IdentityProviderGoogle")
class IdentityProviderGoogle(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            client_id: Optional[pulumi.Input[builtins.str]] = None,
            client_secret: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IdentityProviderGoogle':
        """
