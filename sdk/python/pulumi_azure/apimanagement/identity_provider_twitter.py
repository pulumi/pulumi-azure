...
class IdentityProviderTwitterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_key: App Consumer API key for Twitter.
        :param pulumi.Input[builtins.str] api_management_name: The Name of the API Management Service where this Twitter Identity Provider should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] api_secret_key: App Consumer API secret key for Twitter.
...
class IdentityProviderTwitter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            api_management_name: Optional[pulumi.Input[builtins.str]] = None,
            api_secret_key: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'IdentityProviderTwitter':
        """
    ...
    @property
    @pulumi.getter(name="apiSecretKey")
    def api_secret_key(self) -> pulumi.Output[builtins.str]:
        """
        App Consumer API secret key for Twitter.
        """
        return pulumi.get(self, "api_secret_key")
