...
def get_subscription(api_management_id: Optional[builtins.str] = None,
...
def get_subscription_output(api_management_id: Optional[pulumi.Input[builtins.str]] = None,
