...
class ApiOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_name: The name of the API within the API Management Service where this API Operation should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] display_name: The Display Name for this API Management Operation.
        :param pulumi.Input[builtins.str] method: The HTTP Method used for this API Management Operation, like `GET`, `DELETE`, `PUT` or `POST` - but not limited to these values.
        :param pulumi.Input[builtins.str] operation_id: A unique identifier for this API Operation. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] url_template: The relative URL Template identifying the target resource for this operation, which may include parameters.
        :param pulumi.Input[builtins.str] description: A description for this API Operation, which may include HTML formatting tags.
...
class _ApiOperationState:
    ...
    @property
    @pulumi.getter(name="urlTemplate")
    def url_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The relative URL Template identifying the target resource for this operation, which may include parameters.
        """
        return pulumi.get(self, "url_template")
    ...
    @url_template.setter
    def url_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "url_template", value)
...
class ApiOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            responses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApiOperationResponseArgs', 'ApiOperationResponseArgsDict']]]]] = None,
            template_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApiOperationTemplateParameterArgs', 'ApiOperationTemplateParameterArgsDict']]]]] = None,
            url_template: Optional[pulumi.Input[builtins.str]] = None) -> 'ApiOperation':
        """
