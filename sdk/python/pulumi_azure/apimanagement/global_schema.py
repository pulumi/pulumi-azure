...
class GlobalSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_name: The Name of the API Management Service where the API exists. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] schema_id: A unique identifier for this Schema. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] type: The content type of the Schema. Possible values are `xml` and `json`.
        :param pulumi.Input[builtins.str] value: The string defining the document representing the Schema.
        :param pulumi.Input[builtins.str] description: The description of the schema.
        """
...
@pulumi.type_token("azure:apimanagement/globalSchema:GlobalSchema")
class GlobalSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schema_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'GlobalSchema':
        """
