...
class GlobalSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: The content type of the Schema. Possible values are `xml` and `json`.
        :param pulumi.Input[_builtins.str] value: The string defining the document representing the Schema.
...
class GlobalSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schema_id: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None,
            value: Optional[pulumi.Input[_builtins.str]] = None) -> 'GlobalSchema':
        """
