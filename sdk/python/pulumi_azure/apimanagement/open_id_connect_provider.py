...
class OpenIdConnectProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: A user-friendly name for this OpenID Connect Provider.
        :param pulumi.Input[_builtins.str] metadata_endpoint: The URI of the Metadata endpoint.
        ...
        :param pulumi.Input[_builtins.str] description: A description of this OpenID Connect Provider.
        :param pulumi.Input[_builtins.str] name: the Name of the OpenID Connect Provider which should be created within the API Management Service. Changing this forces a new resource to be created.
        """
...
class _OpenIdConnectProviderState:
    ...
    @_builtins.property
    @pulumi.getter(name="metadataEndpoint")
    def metadata_endpoint(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The URI of the Metadata endpoint.
        """
        return pulumi.get(self, "metadata_endpoint")
    ...
    @metadata_endpoint.setter
    def metadata_endpoint(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "metadata_endpoint", value)
...
class OpenIdConnectProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metadata_endpoint: Optional[pulumi.Input[_builtins.str]] = None,
            name: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'OpenIdConnectProvider':
        """
