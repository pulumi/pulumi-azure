...
class ProductGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] product_id: The ID of the API Management Product within the API Management Service. Changing this forces a new resource to be created.
...
class ProductGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            group_name: Optional[pulumi.Input[builtins.str]] = None,
            product_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ProductGroup':
        """
