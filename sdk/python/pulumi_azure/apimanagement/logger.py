...
class LoggerArgs:
    def __init__(__self__, *,
                 ...
                 buffered: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] buffered: Specifies whether records should be buffered in the Logger prior to publishing. Defaults to `true`.
        :param pulumi.Input[builtins.str] description: A description of this Logger.
        ...
        :param pulumi.Input[builtins.str] name: The name of this Logger, which must be unique within the API Management Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_id: The target resource id which will be linked in the API-Management portal page. Changing this forces a new resource to be created.
        """
    ...
    @property
    @pulumi.getter
    def buffered(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @buffered.setter
    def buffered(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Logger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            resource_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Logger':
        """
    ...
    @property
    @pulumi.getter
    def buffered(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether records should be buffered in the Logger prior to publishing. Defaults to `true`.
        """
        return pulumi.get(self, "buffered")
