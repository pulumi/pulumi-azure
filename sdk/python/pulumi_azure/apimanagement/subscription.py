...
class SubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] primary_key: The primary subscription key to use for the subscription.
        :param pulumi.Input[_builtins.str] product_id: The ID of the Product which should be assigned to this Subscription. Changing this forces a new resource to be created.
               
               > **Note:** Only one of `product_id` and `api_id` can be set. If both are missing `all_apis` scope is used for the subscription.
        :param pulumi.Input[_builtins.str] secondary_key: The secondary subscription key to use for the subscription.
        :param pulumi.Input[_builtins.str] state: The state of this Subscription. Possible values are `active`, `cancelled`, `expired`, `rejected`, `submitted` and `suspended`. Defaults to `submitted`.
        :param pulumi.Input[_builtins.str] subscription_id: An Identifier which should used as the ID of this Subscription. If not specified a new Subscription ID will be generated. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] user_id: The ID of the User which should be assigned to this Subscription. Changing this forces a new resource to be created.
        """
...
class Subscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[_builtins.str]] = None,
            subscription_id: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'Subscription':
        """
