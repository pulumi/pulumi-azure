...
def get_api(api_management_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.ApiManagement`: 2022-08-01
    ...
    :param builtins.str revision: The Revision of the API Management API.
    """
    __args__ = dict()
...
def get_api_output(api_management_name: Optional[pulumi.Input[builtins.str]] = None,
