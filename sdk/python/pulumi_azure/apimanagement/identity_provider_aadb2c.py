...
class IdentityProviderAadb2cArgs:
    def __init__(__self__, *,
                 allowed_tenant: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] client_id: Client ID of the Application in your B2C tenant.
        :param pulumi.Input[_builtins.str] client_secret: Client secret of the Application in your B2C tenant.
        ...
        :param pulumi.Input[_builtins.str] signin_policy: Signin Policy Name.
        :param pulumi.Input[_builtins.str] signin_tenant: The tenant to use instead of Common when logging into Active Directory, usually your B2C tenant domain.
        :param pulumi.Input[_builtins.str] signup_policy: Signup Policy Name.
        :param pulumi.Input[_builtins.str] client_library: The client library to be used in the Azure AD B2C Identity Provider.
        :param pulumi.Input[_builtins.str] password_reset_policy: Password reset Policy Name.
        :param pulumi.Input[_builtins.str] profile_editing_policy: Profile editing Policy Name.
        """
    ...
    def allowed_tenant(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def allowed_tenant(self, value: pulumi.Input[_builtins.str]):
    ...
    def signin_policy(self) -> pulumi.Input[_builtins.str]:
        """
        Signin Policy Name.
        """
    ...
    def signin_policy(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "signin_policy", value)

    @_builtins.property
    @pulumi.getter(name="signinTenant")
    def signin_tenant(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def signin_tenant(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "signin_tenant", value)

    @_builtins.property
    @pulumi.getter(name="signupPolicy")
    def signup_policy(self) -> pulumi.Input[_builtins.str]:
        """
        Signup Policy Name.
        """
    ...
    def signup_policy(self, value: pulumi.Input[_builtins.str]):
...
class IdentityProviderAadb2c(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowedTenant")
    def allowed_tenant(self) -> pulumi.Output[_builtins.str]:
        """
        The allowed AAD tenant, usually your B2C tenant domain.
        """
        return pulumi.get(self, "allowed_tenant")
    ...
    @_builtins.property
    @pulumi.getter(name="passwordResetPolicy")
    def password_reset_policy(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Password reset Policy Name.
        """
        return pulumi.get(self, "password_reset_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="profileEditingPolicy")
    def profile_editing_policy(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Profile editing Policy Name.
        """
        return pulumi.get(self, "profile_editing_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="signinPolicy")
    def signin_policy(self) -> pulumi.Output[_builtins.str]:
        """
        Signin Policy Name.
        """
        return pulumi.get(self, "signin_policy")
    ...
    @_builtins.property
    @pulumi.getter(name="signinTenant")
    def signin_tenant(self) -> pulumi.Output[_builtins.str]:
        """
        The tenant to use instead of Common when logging into Active Directory, usually your B2C tenant domain.
        """
        return pulumi.get(self, "signin_tenant")
    ...
    @_builtins.property
    @pulumi.getter(name="signupPolicy")
    def signup_policy(self) -> pulumi.Output[_builtins.str]:
        """
        Signup Policy Name.
        """
        return pulumi.get(self, "signup_policy")
