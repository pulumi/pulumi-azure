...
class GetGatewayHostNameConfigurationResult:
    ...
    def request_client_certificate_enabled(self) -> builtins.bool:
        """
    ...
    def tls10_enabled(self) -> builtins.bool:
        """
    ...
    def tls11_enabled(self) -> builtins.bool:
        """
...
def get_gateway_host_name_configuration(api_management_id: Optional[builtins.str] = None,
    ...
    * `Microsoft.ApiManagement`: 2022-08-01
    ...
    :param builtins.str gateway_name: The name of the API Management Gateway.
           *
    :param builtins.str name: The name of the API Management Gateway Host Name Configuration.
    """
    __args__ = dict()
...
def get_gateway_host_name_configuration_output(api_management_id: Optional[pulumi.Input[builtins.str]] = None,
