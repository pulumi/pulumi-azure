...
class ApiOperationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_name: The name of the API within the API Management Service where the Operation exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] operation_id: The operation identifier within an API. Must be unique in the current API Management service instance. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] xml_content: The XML Content for this Policy.
...
@pulumi.type_token("azure:apimanagement/apiOperationPolicy:ApiOperationPolicy")
class ApiOperationPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            xml_content: Optional[pulumi.Input[builtins.str]] = None,
            xml_link: Optional[pulumi.Input[builtins.str]] = None) -> 'ApiOperationPolicy':
        """
