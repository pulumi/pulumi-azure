...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 virtual_network_type: Optional[pulumi.Input[builtins.str]] = None,
                 zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Service resource.
        :param pulumi.Input[builtins.str] publisher_email: The email of publisher/company.
        :param pulumi.Input[builtins.str] publisher_name: The name of publisher/company.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the API Management Service should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: `sku_name` is a string consisting of two parts separated by an underscore(\\_). The first part is the `name`, valid values include: `Consumption`, `Developer`, `Basic`, `Standard` and `Premium`. The second part is the `capacity` (e.g. the number of deployed units of the `sku`), which must be a positive `integer` (e.g. `Developer_1`).
        ...
        :param pulumi.Input[builtins.bool] client_certificate_enabled: Enforce a client certificate to be presented on each request to the gateway? This is only supported when SKU type is `Consumption`.
        :param pulumi.Input['ServiceDelegationArgs'] delegation: A `delegation` block as defined below.
        :param pulumi.Input[builtins.bool] gateway_disabled: Disable the gateway in main region? This is only supported when `additional_location` is set.
        ...
        :param pulumi.Input[builtins.str] location: The Azure location where the API Management Service exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] min_api_version: The version which the control plane API calls to API Management service are limited with version equal to or newer than.
        :param pulumi.Input[builtins.str] name: The name of the API Management Service. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Is public access to the service allowed? Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] virtual_network_type: The type of virtual network you want to use, valid values include: `None`, `External`, `Internal`. Defaults to `None`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Specifies a list of Availability Zones in which this API Management service should be located.
    ...
    def virtual_network_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def virtual_network_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServiceState:
    def __init__(__self__, *,
                 ...
                 client_certificate_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 delegation: Optional[pulumi.Input['ServiceDelegationArgs']] = None,
                 developer_portal_url: Optional[pulumi.Input[builtins.str]] = None,
                 gateway_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 gateway_regional_url: Optional[pulumi.Input[builtins.str]] = None,
                 gateway_url: Optional[pulumi.Input[builtins.str]] = None,
                 hostname_configuration: Optional[pulumi.Input['ServiceHostnameConfigurationArgs']] = None,
                 identity: Optional[pulumi.Input['ServiceIdentityArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 management_api_url: Optional[pulumi.Input[builtins.str]] = None,
                 min_api_version: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notification_sender_email: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 scm_url: Optional[pulumi.Input[builtins.str]] = None,
                 security: Optional[pulumi.Input['ServiceSecurityArgs']] = None,
                 sign_in: Optional[pulumi.Input['ServiceSignInArgs']] = None,
                 sign_up: Optional[pulumi.Input['ServiceSignUpArgs']] = None,
        ...
        :param pulumi.Input[builtins.bool] client_certificate_enabled: Enforce a client certificate to be presented on each request to the gateway? This is only supported when SKU type is `Consumption`.
        :param pulumi.Input['ServiceDelegationArgs'] delegation: A `delegation` block as defined below.
        :param pulumi.Input[builtins.str] developer_portal_url: The URL for the Developer Portal associated with this API Management service.
        :param pulumi.Input[builtins.bool] gateway_disabled: Disable the gateway in main region? This is only supported when `additional_location` is set.
        ...
        :param pulumi.Input[builtins.str] gateway_url: The URL of the Gateway for the API Management Service.
        :param pulumi.Input['ServiceHostnameConfigurationArgs'] hostname_configuration: A `hostname_configuration` block as defined below.
        :param pulumi.Input['ServiceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure location where the API Management Service exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] management_api_url: The URL for the Management API associated with this API Management service.
        :param pulumi.Input[builtins.str] min_api_version: The version which the control plane API calls to API Management service are limited with version equal to or newer than.
        :param pulumi.Input[builtins.str] name: The name of the API Management Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] notification_sender_email: Email address from which the notification will be sent.
        :param pulumi.Input[builtins.str] portal_url: The URL for the Publisher Portal associated with this API Management service.
        ...
        :param pulumi.Input[builtins.str] publisher_name: The name of publisher/company.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the API Management Service should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] scm_url: The URL for the SCM (Source Code Management) Endpoint associated with this API Management service.
        :param pulumi.Input['ServiceSecurityArgs'] security: A `security` block as defined below.
        :param pulumi.Input['ServiceSignInArgs'] sign_in: A `sign_in` block as defined below.
        :param pulumi.Input['ServiceSignUpArgs'] sign_up: A `sign_up` block as defined below.
        :param pulumi.Input[builtins.str] sku_name: `sku_name` is a string consisting of two parts separated by an underscore(\\_). The first part is the `name`, valid values include: `Consumption`, `Developer`, `Basic`, `Standard` and `Premium`. The second part is the `capacity` (e.g. the number of deployed units of the `sku`), which must be a positive `integer` (e.g. `Developer_1`).
    ...
    def developer_portal_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def developer_portal_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def gateway_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @gateway_url.setter
    def gateway_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def management_api_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def management_api_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="publisherEmail")
    def publisher_email(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The email of publisher/company.
        """
        return pulumi.get(self, "publisher_email")
    ...
    @publisher_email.setter
    def publisher_email(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "publisher_email", value)
    ...
    def scm_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @scm_url.setter
    def scm_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_network_configuration: Optional[pulumi.Input[Union['ServiceVirtualNetworkConfigurationArgs', 'ServiceVirtualNetworkConfigurationArgsDict']]] = None,
            virtual_network_type: Optional[pulumi.Input[builtins.str]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Service':
        """
    ...
    @property
    @pulumi.getter(name="gatewayDisabled")
    def gateway_disabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Disable the gateway in main region? This is only supported when `additional_location` is set.
        """
        return pulumi.get(self, "gateway_disabled")
    ...
    @property
    @pulumi.getter(name="minApiVersion")
    def min_api_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version which the control plane API calls to API Management service are limited with version equal to or newer than.
        """
        return pulumi.get(self, "min_api_version")
    ...
    @property
    @pulumi.getter(name="notificationSenderEmail")
    def notification_sender_email(self) -> pulumi.Output[builtins.str]:
        """
        Email address from which the notification will be sent.
        """
        return pulumi.get(self, "notification_sender_email")
