...
class AuthorizationServerArgs:
    def __init__(__self__, *,
                 ...
                 authorization_methods: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 client_id: pulumi.Input[builtins.str],
                 client_registration_endpoint: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 grant_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 resource_group_name: pulumi.Input[builtins.str],
                 bearer_token_sending_methods: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 client_authentication_methods: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 default_scope: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_owner_password: Optional[pulumi.Input[builtins.str]] = None,
                 resource_owner_username: Optional[pulumi.Input[builtins.str]] = None,
                 support_state: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] api_management_name: The name of the API Management Service in which this Authorization Server should be created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grant_types: Form of Authorization Grants required when requesting an Access Token. Possible values are `authorizationCode`, `clientCredentials`, `implicit` and `resourceOwnerPassword`.
        ...
        :param pulumi.Input[builtins.str] client_secret: The Client/App Secret registered with this Authorization Server.
        :param pulumi.Input[builtins.str] default_scope: The Default Scope used when requesting an Access Token, specified as a string containing space-delimited values.
        :param pulumi.Input[builtins.str] description: A description of the Authorization Server, which may contain HTML formatting tags.
    ...
    def authorization_methods(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def authorization_methods(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def client_registration_endpoint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def client_registration_endpoint(self, value: pulumi.Input[builtins.str]):
    ...
    def grant_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @grant_types.setter
    def grant_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def bearer_token_sending_methods(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def bearer_token_sending_methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "bearer_token_sending_methods", value)

    @property
    @pulumi.getter(name="clientAuthenticationMethods")
    def client_authentication_methods(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def client_authentication_methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def default_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_scope(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def resource_owner_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_owner_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_owner_password", value)

    @property
    @pulumi.getter(name="resourceOwnerUsername")
    def resource_owner_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_owner_username(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_owner_username", value)

    @property
    @pulumi.getter(name="supportState")
    def support_state(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def support_state(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AuthorizationServerState:
    def __init__(__self__, *,
                 ...
                 authorization_methods: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 bearer_token_sending_methods: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 client_authentication_methods: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 client_id: Optional[pulumi.Input[builtins.str]] = None,
                 client_registration_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 client_secret: Optional[pulumi.Input[builtins.str]] = None,
                 default_scope: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="authorizationMethods")
    def authorization_methods(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The HTTP Verbs supported by the Authorization Endpoint. Possible values are `DELETE`, `GET`, `HEAD`, `OPTIONS`, `PATCH`, `POST`, `PUT` and `TRACE`.
    ...
    @authorization_methods.setter
    def authorization_methods(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "authorization_methods", value)
    ...
    @property
    @pulumi.getter(name="clientRegistrationEndpoint")
    def client_registration_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URI of page where Client/App Registration is performed for this Authorization Server.
        """
        return pulumi.get(self, "client_registration_endpoint")
    ...
    @client_registration_endpoint.setter
    def client_registration_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_registration_endpoint", value)
...
class AuthorizationServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            support_state: Optional[pulumi.Input[builtins.bool]] = None,
            token_body_parameters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AuthorizationServerTokenBodyParameterArgs', 'AuthorizationServerTokenBodyParameterArgsDict']]]]] = None,
            token_endpoint: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthorizationServer':
        """
    ...
    @property
    @pulumi.getter(name="authorizationMethods")
    def authorization_methods(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The HTTP Verbs supported by the Authorization Endpoint. Possible values are `DELETE`, `GET`, `HEAD`, `OPTIONS`, `PATCH`, `POST`, `PUT` and `TRACE`.
    ...
    @property
    @pulumi.getter(name="bearerTokenSendingMethods")
    def bearer_token_sending_methods(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The mechanism by which Access Tokens are passed to the API. Possible values are `authorizationHeader` and `query`.
        """
        return pulumi.get(self, "bearer_token_sending_methods")
    ...
    @property
    @pulumi.getter(name="clientAuthenticationMethods")
    def client_authentication_methods(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The Authentication Methods supported by the Token endpoint of this Authorization Server.. Possible values are `Basic` and `Body`.
        """
        return pulumi.get(self, "client_authentication_methods")
    ...
    @property
    @pulumi.getter(name="clientRegistrationEndpoint")
    def client_registration_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The URI of page where Client/App Registration is performed for this Authorization Server.
        """
        return pulumi.get(self, "client_registration_endpoint")
    ...
    @property
    @pulumi.getter(name="defaultScope")
    def default_scope(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Default Scope used when requesting an Access Token, specified as a string containing space-delimited values.
        """
        return pulumi.get(self, "default_scope")
    ...
    @property
    @pulumi.getter(name="grantTypes")
    def grant_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Form of Authorization Grants required when requesting an Access Token. Possible values are `authorizationCode`, `clientCredentials`, `implicit` and `resourceOwnerPassword`.
        """
        return pulumi.get(self, "grant_types")
    ...
    @property
    @pulumi.getter(name="resourceOwnerPassword")
    def resource_owner_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The password associated with the Resource Owner.
    ...
    @property
    @pulumi.getter(name="resourceOwnerUsername")
    def resource_owner_username(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The username associated with the Resource Owner.
    ...
    @property
    @pulumi.getter(name="supportState")
    def support_state(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Does this Authorization Server support State? If this is set to `true` the client may use the state parameter to raise protocol security.
        """
        return pulumi.get(self, "support_state")
    ...
    @property
    @pulumi.getter(name="tokenEndpoint")
    def token_endpoint(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OAUTH Token Endpoint.
        """
        return pulumi.get(self, "token_endpoint")
