...
class ProductApiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_name: The Name of the API Management API within the API Management Service. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:apimanagement/productApi:ProductApi")
class ProductApi(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            api_name: Optional[pulumi.Input[builtins.str]] = None,
            product_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ProductApi':
        """
