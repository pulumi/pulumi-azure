...
class ApiPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] xml_content: The XML Content for this Policy as a string.
...
@pulumi.type_token("azure:apimanagement/apiPolicy:ApiPolicy")
class ApiPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
            xml_content: Optional[pulumi.Input[_builtins.str]] = None,
            xml_link: Optional[pulumi.Input[_builtins.str]] = None) -> 'ApiPolicy':
        """
