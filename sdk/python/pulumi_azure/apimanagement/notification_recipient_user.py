...
class NotificationRecipientUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_id: The ID of the API Management Service from which to create this Notification Recipient User. Changing this forces a new API Management Notification Recipient User to be created.
        :param pulumi.Input[builtins.str] notification_type: The Notification Name to be received. Changing this forces a new API Management Notification Recipient User to be created. Possible values are `AccountClosedPublisher`, `BCC`, `NewApplicationNotificationMessage`, `NewIssuePublisherNotificationMessage`, `PurchasePublisherNotificationMessage`, `QuotaLimitApproachingPublisherNotificationMessage`, and `RequestPublisherNotificationMessage`.
        :param pulumi.Input[builtins.str] user_id: The recipient user ID. Changing this forces a new API Management Notification Recipient User to be created.
        """
...
class NotificationRecipientUser(pulumi.CustomResource):
    ...
    pulumi_type = "azure:apimanagement/notificationRecipientUser:NotificationRecipientUser"
    ...
    def get(resource_name: str,
            ...
            api_management_id: Optional[pulumi.Input[builtins.str]] = None,
            notification_type: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NotificationRecipientUser':
        """
