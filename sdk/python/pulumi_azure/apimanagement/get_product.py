...
class GetProductResult:
    ...
    def subscriptions_limit(self) -> _builtins.int:
        """
...
def get_product(api_management_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ApiManagement` - 2022-08-01
    ...
    :param _builtins.str api_management_name: The Name of the API Management Service in which this Product exists.
    :param _builtins.str product_id: The Identifier for the API Management Product.
