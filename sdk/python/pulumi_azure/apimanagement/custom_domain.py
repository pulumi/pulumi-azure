...
class CustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_id: The ID of the API Management service for which to configure Custom Domains. Changing this forces a new API Management Custom Domain resource to be created.
