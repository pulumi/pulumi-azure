...
class CustomDomainDeveloperPortal(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str certificate: The Base64 Encoded Certificate. (Mutually exclusive with `key_vault_certificate_id`.)
        ...
        :param builtins.str ssl_keyvault_identity_client_id: System or User Assigned Managed identity clientId as generated by Azure AD, which has `GET` access to the key vault containing the SSL certificate.
