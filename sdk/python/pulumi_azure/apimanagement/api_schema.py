...
class ApiSchemaArgs:
    def __init__(__self__, *,
                 ...
                 definitions: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] api_name: The name of the API within the API Management Service where this API Schema should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] content_type: The content type of the API Schema.
        ...
        :param pulumi.Input[builtins.str] schema_id: A unique identifier for this API Schema. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] components: Types definitions. Used for Swagger/OpenAPI v2/v3 schemas only.
        :param pulumi.Input[builtins.str] definitions: Types definitions. Used for Swagger/OpenAPI v1 schemas only.
        :param pulumi.Input[builtins.str] value: The JSON escaped string defining the document representing the Schema.
        """
    ...
    @property
    @pulumi.getter
    def definitions(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @definitions.setter
    def definitions(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure:apimanagement/apiSchema:ApiSchema")
class ApiSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            schema_id: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'ApiSchema':
        """
    ...
    @property
    @pulumi.getter
    def components(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Types definitions. Used for Swagger/OpenAPI v2/v3 schemas only.
        """
        return pulumi.get(self, "components")
    ...
    @property
    @pulumi.getter
    def definitions(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Types definitions. Used for Swagger/OpenAPI v1 schemas only.
        """
        return pulumi.get(self, "definitions")
