...
class ProductArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] published: Is this Product Published?
        ...
        :param pulumi.Input[_builtins.str] description: A description of this Product, which may include HTML formatting tags.
        :param pulumi.Input[_builtins.bool] subscription_required: Is a Subscription required to access API's included in this Product? Defaults to `true`.
        :param pulumi.Input[_builtins.int] subscriptions_limit: The number of subscriptions a user can have to this Product at the same time.
               
               > **Note:** `subscriptions_limit` can only be set when `subscription_required` is set to `true`.
        :param pulumi.Input[_builtins.str] terms: The Terms and Conditions for this Product, which must be accepted by Developers before they can begin the Subscription process.
        """
