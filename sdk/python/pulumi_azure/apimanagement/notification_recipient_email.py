...
class NotificationRecipientEmailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] api_management_id: The ID of the API Management Service from which to create this Notification Recipient Email. Changing this forces a new API Management Notification Recipient Email to be created.
        :param pulumi.Input[builtins.str] email: The recipient email address. Changing this forces a new API Management Notification Recipient Email to be created.
        :param pulumi.Input[builtins.str] notification_type: The Notification Name to be received. Changing this forces a new API Management Notification Recipient Email to be created. Possible values are `AccountClosedPublisher`, `BCC`, `NewApplicationNotificationMessage`, `NewIssuePublisherNotificationMessage`, `PurchasePublisherNotificationMessage`, `QuotaLimitApproachingPublisherNotificationMessage`, and `RequestPublisherNotificationMessage`.
        """
...
class NotificationRecipientEmail(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            api_management_id: Optional[pulumi.Input[builtins.str]] = None,
            email: Optional[pulumi.Input[builtins.str]] = None,
            notification_type: Optional[pulumi.Input[builtins.str]] = None) -> 'NotificationRecipientEmail':
        """
