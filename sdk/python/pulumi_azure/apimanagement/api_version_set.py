...
class ApiVersionSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] versioning_scheme: Specifies where in an Inbound HTTP Request that the API Version should be read from. Possible values are `Header`, `Query` and `Segment`.
        :param pulumi.Input[_builtins.str] description: The description of API Version Set.
        :param pulumi.Input[_builtins.str] name: The name of the API Version Set. May only contain alphanumeric characters and dashes up to 80 characters in length. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] version_header_name: The name of the Header which should be read from Inbound Requests which defines the API Version.
               
               > **Note:** This must be specified when `versioning_scheme` is set to `Header`.
        :param pulumi.Input[_builtins.str] version_query_name: The name of the Query String which should be read from Inbound Requests which defines the API Version.
...
class ApiVersionSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version_header_name: Optional[pulumi.Input[_builtins.str]] = None,
            version_query_name: Optional[pulumi.Input[_builtins.str]] = None,
            versioning_scheme: Optional[pulumi.Input[_builtins.str]] = None) -> 'ApiVersionSet':
        """
