...
def get_service_endpoint_connections(resource_group_name: Optional[builtins.str] = None,
...
def get_service_endpoint_connections_output(resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
