...
class EndpointArgs:
    def __init__(__self__, *,
                 ...
                 custom_network_interface_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the Name of the Resource Group within which the Private Endpoint should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet from which Private IP Addresses will be allocated for this Private Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] custom_network_interface_name: The custom name of the network interface attached to the private endpoint. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the Name of the Private Endpoint. Changing this forces a new resource to be created.
    ...
    def custom_network_interface_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_network_interface_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Endpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="customNetworkInterfaceName")
    def custom_network_interface_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The custom name of the network interface attached to the private endpoint. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "custom_network_interface_name")
