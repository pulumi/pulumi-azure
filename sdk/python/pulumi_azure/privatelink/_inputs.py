...
class EndpointCustomDnsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] fqdn: The fully qualified domain name to the `private_dns_zone`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: A list of all IP Addresses that map to the `private_dns_zone` fqdn.
        """
        if fqdn is not None:
...
if not MYPY:
    class EndpointIpConfigurationArgsDict(TypedDict):
        ...
        """
        private_ip_address: pulumi.Input[builtins.str]
        """
...
class EndpointIpConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Specifies the Name of the IP Configuration. Changing this forces a new resource to be created.
    ...
    def private_ip_address(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the static IP address within the private endpoint's subnet to be used. Changing this forces a new resource to be created.
        """
    ...
    def private_ip_address(self, value: pulumi.Input[builtins.str]):
...
class EndpointNetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The ID of the Private DNS Zone Config.
...
if not MYPY:
    class EndpointPrivateDnsZoneConfigArgsDict(TypedDict):
        ...
        Specifies the Name of the Private Endpoint. Changing this forces a new resource to be created.
        """
        private_dns_zone_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EndpointPrivateDnsZoneConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] id: The ID of the Private DNS Zone Config.
        :param pulumi.Input[builtins.str] name: Specifies the Name of the Private Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_dns_zone_id: A list of IP Addresses
...
class EndpointPrivateDnsZoneConfigRecordSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: A list of all IP Addresses that map to the `private_dns_zone` fqdn.
        :param pulumi.Input[builtins.str] name: Specifies the Name of the Private Endpoint. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] ttl: The time to live for each connection to the `private_dns_zone`.
        :param pulumi.Input[builtins.str] type: The type of DNS record.
        """
        if fqdn is not None:
            pulumi.set(__self__, "fqdn", fqdn)
        if ip_addresses is not None:
...
if not MYPY:
    class EndpointPrivateDnsZoneGroupArgsDict(TypedDict):
        ...
        """
        private_dns_zone_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class EndpointPrivateDnsZoneGroupArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: Specifies the Name of the Private DNS Zone Group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_dns_zone_ids: Specifies the list of Private DNS Zones to include within the `private_dns_zone_group`.
        :param pulumi.Input[builtins.str] id: The ID of the Private DNS Zone Config.
        """
        pulumi.set(__self__, "name", name)
    ...
    def private_dns_zone_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies the list of Private DNS Zones to include within the `private_dns_zone_group`.
        """
    ...
    def private_dns_zone_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class EndpointPrivateServiceConnectionArgsDict(TypedDict):
        is_manual_connection: pulumi.Input[builtins.bool]
        """
        ...
        """
        private_connection_resource_alias: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        private_connection_resource_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EndpointPrivateServiceConnectionArgs:
    def __init__(__self__, *,
                 is_manual_connection: pulumi.Input[builtins.bool],
                 name: pulumi.Input[builtins.str],
                 private_connection_resource_alias: Optional[pulumi.Input[builtins.str]] = None,
                 private_connection_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 private_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 request_message: Optional[pulumi.Input[builtins.str]] = None,
                 subresource_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    def is_manual_connection(self) -> pulumi.Input[builtins.bool]:
        """
        Does the Private Endpoint require Manual Approval from the remote resource owner? Changing this forces a new resource to be created.
    ...
    def is_manual_connection(self, value: pulumi.Input[builtins.bool]):
    ...
    def private_connection_resource_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Service Alias of the Private Link Enabled Remote Resource which this Private Endpoint should be connected to. One of `private_connection_resource_id` or `private_connection_resource_alias` must be specified. Changing this forces a new resource to be created.
        """
    ...
    def private_connection_resource_alias(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_connection_resource_alias", value)

    @property
    @pulumi.getter(name="privateConnectionResourceId")
    def private_connection_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Private Link Enabled Remote Resource which this Private Endpoint should be connected to. One of `private_connection_resource_id` or `private_connection_resource_alias` must be specified. Changing this forces a new resource to be created. For a web app or function app slot, the parent web app should be used in this field instead of a reference to the slot itself.
        """
    ...
    def private_connection_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subresource_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of subresource names which the Private Endpoint is able to connect to. `subresource_names` corresponds to `group_id`. Possible values are detailed in the product [documentation](https://docs.microsoft.com/azure/private-link/private-endpoint-overview#private-link-resource) in the `Subresources` column. Changing this forces a new resource to be created. 
    ...
    def subresource_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
