...
class ProjectEnvironmentTypeArgs:
    def __init__(__self__, *,
                 deployment_target_id: pulumi.Input[builtins.str],
                 dev_center_project_id: pulumi.Input[builtins.str],
                 identity: pulumi.Input['ProjectEnvironmentTypeIdentityArgs'],
                 creator_role_assignment_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] deployment_target_id: The ID of the subscription that the Environment Type will be mapped to. The environment's resources will be deployed into this subscription.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] creator_role_assignment_roles: A list of roles to assign to the environment creator.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Dev Center Project Environment Type should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Dev Center Project Environment Type. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Dev Center Project Environment Type.
    ...
    def deployment_target_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def deployment_target_id(self, value: pulumi.Input[builtins.str]):
    ...
    def creator_role_assignment_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def creator_role_assignment_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ProjectEnvironmentType(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="creatorRoleAssignmentRoles")
    def creator_role_assignment_roles(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of roles to assign to the environment creator.
        """
        return pulumi.get(self, "creator_role_assignment_roles")
    ...
    @property
    @pulumi.getter(name="deploymentTargetId")
    def deployment_target_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the subscription that the Environment Type will be mapped to. The environment's resources will be deployed into this subscription.
        """
        return pulumi.get(self, "deployment_target_id")
