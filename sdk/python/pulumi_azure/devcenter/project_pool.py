...
class ProjectPoolArgs:
    def __init__(__self__, *,
                 ...
                 dev_center_attached_network_name: pulumi.Input[builtins.str],
                 dev_center_project_id: pulumi.Input[builtins.str],
                 local_administrator_enabled: pulumi.Input[builtins.bool],
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 stop_on_disconnect_grace_period_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ProjectPool resource.
        :param pulumi.Input[builtins.str] dev_box_definition_name: The name of the Dev Center Dev Box Definition.
        :param pulumi.Input[builtins.str] dev_center_attached_network_name: The name of the Dev Center Attached Network in parent Project of the Dev Center Project Pool.
        :param pulumi.Input[builtins.str] dev_center_project_id: The ID of the associated Dev Center Project. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] local_administrator_enabled: Specifies whether owners of Dev Boxes in the Dev Center Project Pool are added as local administrators on the Dev Box.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Dev Center Project Pool should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Dev Center Project Pool. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] stop_on_disconnect_grace_period_minutes: The specified time in minutes to wait before stopping a Dev Center Dev Box once disconnect is detected. Possible values are between `60` and `480`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Dev Center Project Pool.
        """
    ...
    def dev_center_attached_network_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dev_center_attached_network_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dev_center_attached_network_name", value)

    @property
    @pulumi.getter(name="devCenterProjectId")
    def dev_center_project_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dev_center_project_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dev_center_project_id", value)

    @property
    @pulumi.getter(name="localAdministratorEnabled")
    def local_administrator_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def local_administrator_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def stop_on_disconnect_grace_period_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def stop_on_disconnect_grace_period_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ProjectPoolState:
    def __init__(__self__, *,
                 ...
                 dev_center_attached_network_name: Optional[pulumi.Input[builtins.str]] = None,
                 dev_center_project_id: Optional[pulumi.Input[builtins.str]] = None,
                 local_administrator_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 stop_on_disconnect_grace_period_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
    ...
    @property
    @pulumi.getter(name="devCenterAttachedNetworkName")
    def dev_center_attached_network_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Dev Center Attached Network in parent Project of the Dev Center Project Pool.
        """
        return pulumi.get(self, "dev_center_attached_network_name")
    ...
    @dev_center_attached_network_name.setter
    def dev_center_attached_network_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dev_center_attached_network_name", value)

    @property
    @pulumi.getter(name="devCenterProjectId")
    def dev_center_project_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the associated Dev Center Project. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "dev_center_project_id")
    ...
    @dev_center_project_id.setter
    def dev_center_project_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dev_center_project_id", value)

    @property
    @pulumi.getter(name="localAdministratorEnabled")
    def local_administrator_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether owners of Dev Boxes in the Dev Center Project Pool are added as local administrators on the Dev Box.
        """
        return pulumi.get(self, "local_administrator_enabled")
    ...
    @local_administrator_enabled.setter
    def local_administrator_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "local_administrator_enabled", value)
...
class ProjectPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            stop_on_disconnect_grace_period_minutes: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ProjectPool':
        """
    ...
    @property
    @pulumi.getter(name="devCenterAttachedNetworkName")
    def dev_center_attached_network_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Dev Center Attached Network in parent Project of the Dev Center Project Pool.
        """
        return pulumi.get(self, "dev_center_attached_network_name")
    ...
    @property
    @pulumi.getter(name="devCenterProjectId")
    def dev_center_project_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the associated Dev Center Project. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "dev_center_project_id")
    ...
    @property
    @pulumi.getter(name="localAdministratorEnabled")
    def local_administrator_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether owners of Dev Boxes in the Dev Center Project Pool are added as local administrators on the Dev Box.
        """
        return pulumi.get(self, "local_administrator_enabled")
    ...
    @property
    @pulumi.getter(name="stopOnDisconnectGracePeriodMinutes")
    def stop_on_disconnect_grace_period_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The specified time in minutes to wait before stopping a Dev Center Dev Box once disconnect is detected. Possible values are between `60` and `480`.
        """
        return pulumi.get(self, "stop_on_disconnect_grace_period_minutes")
