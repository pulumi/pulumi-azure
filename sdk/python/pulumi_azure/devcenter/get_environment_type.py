...
class GetEnvironmentTypeResult:
    ...
    """
    def __init__(__self__, dev_center_id=None, id=None, name=None, tags=None):
...
def get_environment_type(dev_center_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.DevCenter` - 2025-02-01
    ...
    :param _builtins.str name: The name of this Dev Center Environment Type.
    """
    __args__ = dict()
    __args__['devCenterId'] = dev_center_id
    __args__['name'] = name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure:devcenter/getEnvironmentType:getEnvironmentType', __args__, opts=opts, typ=GetEnvironmentTypeResult).value
...
def get_environment_type_output(dev_center_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.DevCenter` - 2025-02-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:devcenter/getEnvironmentType:getEnvironmentType', __args__, opts=opts, typ=GetEnvironmentTypeResult)
