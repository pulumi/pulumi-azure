...
if not MYPY:
    class ProtectionContainerMappingAutomaticUpdateArgsDict(TypedDict):
        ...
        """
        automation_account_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProtectionContainerMappingAutomaticUpdateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authentication_type: The authentication type used for automation account. Possible values are `RunAsAccount` and `SystemAssignedIdentity`. Defaults to `SystemAssignedIdentity`.
               
               > **Note:** `RunAsAccount` of `authentication_type` is deprecated and will retire on September 30, 2023. Details could be found [here](https://learn.microsoft.com/en-us/azure/automation/whats-new#support-for-run-as-accounts).
        :param pulumi.Input[builtins.str] automation_account_id: The automation account ID which holds the automatic update runbook and authenticates to Azure resources.
               
               > **Note:** `automation_account_id` is required when `enabled` is specified.
        :param pulumi.Input[builtins.bool] enabled: Should the Mobility service installed on Azure virtual machines be automatically updated. Defaults to `false`.
...
if not MYPY:
    class ReplicatedVMManagedDiskArgsDict(TypedDict):
        ...
        """
        target_replica_disk_type: pulumi.Input[builtins.str]
        """
        ...
        """
        target_disk_encryption_set_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ReplicatedVMManagedDiskArgs:
    def __init__(__self__, *,
                 ...
                 target_disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] disk_id: Id of disk that should be replicated. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] staging_storage_account_id: Storage account that should be used for caching. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_disk_type: What type should the disk be when a failover is done. Possible values are `Standard_LRS`, `Premium_LRS`, `StandardSSD_LRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_replica_disk_type: What type should the disk be that holds the replication data. Possible values are `Standard_LRS`, `Premium_LRS`, `StandardSSD_LRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_resource_group_id: Resource group disk should belong to when a failover is done. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] target_disk_encryption_set_id: The Disk Encryption Set that the Managed Disk will be associated with. Changing this forces a new resource to be created.
    ...
    def staging_storage_account_id(self) -> pulumi.Input[builtins.str]:
        """
        Storage account that should be used for caching. Changing this forces a new resource to be created.
        """
    ...
    def staging_storage_account_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "staging_storage_account_id", value)

    @property
    @pulumi.getter(name="targetDiskType")
    def target_disk_type(self) -> pulumi.Input[builtins.str]:
        """
        What type should the disk be when a failover is done. Possible values are `Standard_LRS`, `Premium_LRS`, `StandardSSD_LRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        """
    ...
    def target_disk_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_disk_type", value)

    @property
    @pulumi.getter(name="targetReplicaDiskType")
    def target_replica_disk_type(self) -> pulumi.Input[builtins.str]:
        """
        What type should the disk be that holds the replication data. Possible values are `Standard_LRS`, `Premium_LRS`, `StandardSSD_LRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        """
    ...
    def target_replica_disk_type(self, value: pulumi.Input[builtins.str]):
    ...
    def target_disk_encryption_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Disk Encryption Set that the Managed Disk will be associated with. Changing this forces a new resource to be created.
    ...
    def target_disk_encryption_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReplicatedVMManagedDiskTargetDiskEncryptionDiskEncryptionKeyArgs:
    def __init__(__self__, *,
                 ...
                 vault_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] secret_url: The URL to the Key Vault Secret used as the Disk Encryption Key that the Managed Disk will be associated with. This can be found as `id` on the `keyvault.Secret` resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vault_id: The ID of the Key Vault. This can be found as `id` on the `keyvault.KeyVault` resource. Changing this forces a new resource to be created.
        """
...
class ReplicatedVMManagedDiskTargetDiskEncryptionKeyEncryptionKeyArgs:
    def __init__(__self__, *,
                 ...
                 vault_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_url: The URL to the Key Vault Key used as the Key Encryption Key that the Managed Disk will be associated with. This can be found as `id` on the `keyvault.Key` resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vault_id: The ID of the Key Vault. This can be found as `id` on the `keyvault.KeyVault` resource. Changing this forces a new resource to be created.
        """
...
if not MYPY:
    class ReplicatedVMNetworkInterfaceArgsDict(TypedDict):
        failover_test_public_ip_address_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Id of the public IP object to use when a test failover is done.
        """
        failover_test_static_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        Static IP to assign when a test failover is done.
        """
        failover_test_subnet_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Name of the subnet to use when a test failover is done.
        """
        recovery_load_balancer_backend_address_pool_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of IDs of Load Balancer Backend Address Pools to use when a failover is done.
        """
        recovery_public_ip_address_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Id of the public IP object to use when a failover is done.
        """
        source_network_interface_id: NotRequired[pulumi.Input[builtins.str]]
        """
        (Required if the network_interface block is specified) Id source network interface.
        """
        target_static_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        Static IP to assign when a failover is done.
        """
        target_subnet_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ReplicatedVMNetworkInterfaceArgs:
    def __init__(__self__, *,
                 failover_test_public_ip_address_id: Optional[pulumi.Input[builtins.str]] = None,
                 failover_test_static_ip: Optional[pulumi.Input[builtins.str]] = None,
                 failover_test_subnet_name: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_load_balancer_backend_address_pool_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 recovery_public_ip_address_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_network_interface_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_static_ip: Optional[pulumi.Input[builtins.str]] = None,
                 target_subnet_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] failover_test_public_ip_address_id: Id of the public IP object to use when a test failover is done.
        :param pulumi.Input[builtins.str] failover_test_static_ip: Static IP to assign when a test failover is done.
        :param pulumi.Input[builtins.str] failover_test_subnet_name: Name of the subnet to use when a test failover is done.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] recovery_load_balancer_backend_address_pool_ids: A list of IDs of Load Balancer Backend Address Pools to use when a failover is done.
        :param pulumi.Input[builtins.str] recovery_public_ip_address_id: Id of the public IP object to use when a failover is done.
        :param pulumi.Input[builtins.str] source_network_interface_id: (Required if the network_interface block is specified) Id source network interface.
        :param pulumi.Input[builtins.str] target_static_ip: Static IP to assign when a failover is done.
        :param pulumi.Input[builtins.str] target_subnet_name: Name of the subnet to use when a failover is done.
        """
    ...
    def failover_test_public_ip_address_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Id of the public IP object to use when a test failover is done.
        """
    ...
    def failover_test_public_ip_address_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "failover_test_public_ip_address_id", value)

    @property
    @pulumi.getter(name="failoverTestStaticIp")
    def failover_test_static_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Static IP to assign when a test failover is done.
        """
    ...
    def failover_test_static_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "failover_test_static_ip", value)

    @property
    @pulumi.getter(name="failoverTestSubnetName")
    def failover_test_subnet_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the subnet to use when a test failover is done.
        """
    ...
    def failover_test_subnet_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "failover_test_subnet_name", value)

    @property
    @pulumi.getter(name="recoveryLoadBalancerBackendAddressPoolIds")
    def recovery_load_balancer_backend_address_pool_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of IDs of Load Balancer Backend Address Pools to use when a failover is done.
        """
    ...
    def recovery_load_balancer_backend_address_pool_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "recovery_load_balancer_backend_address_pool_ids", value)

    @property
    @pulumi.getter(name="recoveryPublicIpAddressId")
    def recovery_public_ip_address_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Id of the public IP object to use when a failover is done.
        """
    ...
    def recovery_public_ip_address_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recovery_public_ip_address_id", value)

    @property
    @pulumi.getter(name="sourceNetworkInterfaceId")
    def source_network_interface_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Required if the network_interface block is specified) Id source network interface.
        """
    ...
    def source_network_interface_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_network_interface_id", value)

    @property
    @pulumi.getter(name="targetStaticIp")
    def target_static_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Static IP to assign when a failover is done.
        """
    ...
    def target_static_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_static_ip", value)

    @property
    @pulumi.getter(name="targetSubnetName")
    def target_subnet_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the subnet to use when a failover is done.
        """
    ...
    def target_subnet_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_subnet_name", value)


if not MYPY:
    class ReplicatedVMUnmanagedDiskArgsDict(TypedDict):
        disk_uri: pulumi.Input[builtins.str]
        """
        Id of disk that should be replicated. Changing this forces a new resource to be created.
        """
        staging_storage_account_id: pulumi.Input[builtins.str]
        ...
        Storage account that should be used for caching. Changing this forces a new resource to be created.
        """
        target_storage_account_id: pulumi.Input[builtins.str]
        """
...
class ReplicatedVMUnmanagedDiskArgs:
    def __init__(__self__, *,
                 ...
                 target_storage_account_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] disk_uri: Id of disk that should be replicated. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] staging_storage_account_id: Storage account that should be used for caching. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_storage_account_id: Storage account disk should belong to when a failover is done. Changing this forces a new resource to be created.
        """
    ...
    def disk_uri(self) -> pulumi.Input[builtins.str]:
        """
        Id of disk that should be replicated. Changing this forces a new resource to be created.
        """
    ...
    @disk_uri.setter
    def disk_uri(self, value: pulumi.Input[builtins.str]):
    ...
    def target_storage_account_id(self) -> pulumi.Input[builtins.str]:
        """
        Storage account disk should belong to when a failover is done. Changing this forces a new resource to be created.
        """
    ...
    def target_storage_account_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_storage_account_id", value)


if not MYPY:
    class ReplicationRecoveryPlanAzureToAzureSettingsArgsDict(TypedDict):
        primary_edge_zone: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        primary_zone: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        recovery_edge_zone: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        recovery_zone: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ReplicationRecoveryPlanAzureToAzureSettingsArgs:
    def __init__(__self__, *,
                 primary_edge_zone: Optional[pulumi.Input[builtins.str]] = None,
                 primary_zone: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_edge_zone: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_zone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] primary_edge_zone: The Edge Zone within the Azure Region where the VM exists. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
        :param pulumi.Input[builtins.str] primary_zone: The Availability Zone in which the VM is located. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
        :param pulumi.Input[builtins.str] recovery_edge_zone: The Edge Zone within the Azure Region where the VM is recovered. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
               
               > **Note:** `primary_edge_zone` and `recovery_edge_zone` must be specified together.
        :param pulumi.Input[builtins.str] recovery_zone: The Availability Zone in which the VM is recovered. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
    ...
    def primary_edge_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Edge Zone within the Azure Region where the VM exists. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
        """
    ...
    def primary_edge_zone(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def recovery_edge_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Edge Zone within the Azure Region where the VM is recovered. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
    ...
    def recovery_edge_zone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recovery_edge_zone", value)

    @property
    @pulumi.getter(name="recoveryZone")
    def recovery_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Availability Zone in which the VM is recovered. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
    ...
    def recovery_zone(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ReplicationRecoveryPlanBootRecoveryGroupArgsDict(TypedDict):
        ...
        """
        replicated_protected_items: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ReplicationRecoveryPlanBootRecoveryGroupArgs:
    def __init__(__self__, *,
                 ...
                 replicated_protected_items: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] replicated_protected_items: One or more protected VM IDs.
        """
    ...
    def replicated_protected_items(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        One or more protected VM IDs.
        """
    ...
    def replicated_protected_items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ReplicationRecoveryPlanBootRecoveryGroupPostActionArgsDict(TypedDict):
        fail_over_directions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Directions of fail over. Possible values are `PrimaryToRecovery` and `RecoveryToPrimary`
        """
        fail_over_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        fabric_location: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        manual_action_instruction: NotRequired[pulumi.Input[builtins.str]]
        """
        Instructions of manual action.

        > **Note:** This property is required when `type` is set to `ManualActionDetails`.
        """
        runbook_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Id of runbook.
...
class ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 fabric_location: Optional[pulumi.Input[builtins.str]] = None,
                 manual_action_instruction: Optional[pulumi.Input[builtins.str]] = None,
                 runbook_id: Optional[pulumi.Input[builtins.str]] = None,
                 script_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fail_over_directions: Directions of fail over. Possible values are `PrimaryToRecovery` and `RecoveryToPrimary`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fail_over_types: Types of fail over. Possible values are `TestFailover`, `PlannedFailover` and `UnplannedFailover`
        ...
        :param pulumi.Input[builtins.str] type: Type of the action detail. Possible values are `AutomationRunbookActionDetails`, `ManualActionDetails` and `ScriptActionDetails`.
        :param pulumi.Input[builtins.str] fabric_location: The fabric location of runbook or script. Possible values are `Primary` and `Recovery`. It must not be specified when `type` is `ManualActionDetails`.
               
               > **Note:** This is required when `type` is set to `AutomationRunbookActionDetails` or `ScriptActionDetails`.
        :param pulumi.Input[builtins.str] manual_action_instruction: Instructions of manual action.
               
               > **Note:** This property is required when `type` is set to `ManualActionDetails`.
        :param pulumi.Input[builtins.str] runbook_id: Id of runbook.
               
               > **Note:** This property is required when `type` is set to `AutomationRunbookActionDetails`.
        :param pulumi.Input[builtins.str] script_path: Path of action script.
    ...
    def fail_over_directions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Directions of fail over. Possible values are `PrimaryToRecovery` and `RecoveryToPrimary`
        """
    ...
    def fail_over_directions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "fail_over_directions", value)

    @property
    @pulumi.getter(name="failOverTypes")
    def fail_over_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Types of fail over. Possible values are `TestFailover`, `PlannedFailover` and `UnplannedFailover`
        """
    ...
    def fail_over_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def fabric_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The fabric location of runbook or script. Possible values are `Primary` and `Recovery`. It must not be specified when `type` is `ManualActionDetails`.
    ...
    def fabric_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fabric_location", value)

    @property
    @pulumi.getter(name="manualActionInstruction")
    def manual_action_instruction(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Instructions of manual action.
    ...
    def manual_action_instruction(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class VmwareReplicatedVmManagedDiskArgsDict(TypedDict):
        ...
        """
        log_storage_account_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VmwareReplicatedVmManagedDiskArgs:
    def __init__(__self__, *,
                 disk_id: pulumi.Input[builtins.str],
                 target_disk_type: pulumi.Input[builtins.str],
                 log_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] disk_id: The ID of the disk to be replicated.
        :param pulumi.Input[builtins.str] target_disk_type: The disk type of the disk to be created when a failover is done. Possible values are `Premium_LRS`, `Standard_LRS` and `StandardSSD_LRS`.
        :param pulumi.Input[builtins.str] log_storage_account_id: The ID of the storage account that should be used for logging during replication.
        :param pulumi.Input[builtins.str] target_disk_encryption_set_id: The ID of the Disk Encryption Set that should be used for the disks when a failover is done.
        """
        pulumi.set(__self__, "disk_id", disk_id)
        pulumi.set(__self__, "target_disk_type", target_disk_type)
    ...
    def log_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the storage account that should be used for logging during replication.
        """
    ...
    def log_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class VmwareReplicatedVmNetworkInterfaceArgsDict(TypedDict):
        ...
        """
        source_mac_address: pulumi.Input[builtins.str]
        """
        ...
        Name of the subnet to use when a failover is done.
        """
        test_subnet_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Name of the subnet to use when a test failover is done.
        """
elif False:
...
class VmwareReplicatedVmNetworkInterfaceArgs:
    def __init__(__self__, *,
                 ...
                 target_static_ip: Optional[pulumi.Input[builtins.str]] = None,
                 target_subnet_name: Optional[pulumi.Input[builtins.str]] = None,
                 test_subnet_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] is_primary: Whether this `network_interface` is primary for the replicated VM.
        :param pulumi.Input[builtins.str] source_mac_address: Mac address of the network interface of source VM.
        :param pulumi.Input[builtins.str] target_static_ip: Static IP to assign when a failover is done.
        :param pulumi.Input[builtins.str] target_subnet_name: Name of the subnet to use when a failover is done.
        :param pulumi.Input[builtins.str] test_subnet_name: Name of the subnet to use when a test failover is done.
        """
    ...
    def source_mac_address(self) -> pulumi.Input[builtins.str]:
        """
        Mac address of the network interface of source VM.
        """
    ...
    def source_mac_address(self, value: pulumi.Input[builtins.str]):
    ...
    def test_subnet_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the subnet to use when a test failover is done.
        """
    ...
    def test_subnet_name(self, value: Optional[pulumi.Input[builtins.str]]):
