...
class VMWareReplicationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] application_consistent_snapshot_frequency_in_minutes: Specifies the frequency at which to create application consistent recovery points. Must between `0` to `720`.
        :param pulumi.Input[builtins.int] recovery_point_retention_in_minutes: Specifies the period up to which the recovery points will be retained. Must between `0` to `21600`.
        :param pulumi.Input[builtins.str] recovery_vault_id: ID of the Recovery Services Vault. Changing this forces a new Replication Policy to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Classic Replication Policy. Changing this forces a new Replication Policy to be created.
        """
...
class VMWareReplicationPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            recovery_point_retention_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
            recovery_vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VMWareReplicationPolicy':
        """
