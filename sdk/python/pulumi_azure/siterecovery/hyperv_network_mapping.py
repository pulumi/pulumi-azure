...
class HypervNetworkMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] recovery_vault_id: The ID of the Recovery Services Vault where the network mapping should be created. Changing this forces a new resource to be created.
