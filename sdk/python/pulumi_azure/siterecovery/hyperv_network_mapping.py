...
class HypervNetworkMappingArgs:
    def __init__(__self__, *,
                 ...
                 source_network_name: pulumi.Input[builtins.str],
                 source_system_center_virtual_machine_manager_name: pulumi.Input[builtins.str],
                 target_network_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HypervNetworkMapping resource.
        :param pulumi.Input[builtins.str] recovery_vault_id: The ID of the Recovery Services Vault where the HyperV network mapping should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_network_name: The Name of the primary network. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] source_system_center_virtual_machine_manager_name: Specifies the name of source System Center Virtual Machine Manager where the source network exists. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name of the HyperV network mapping. Changing this forces a new resource to be created.
        """
    ...
    def source_network_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_network_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_network_name", value)

    @property
    @pulumi.getter(name="sourceSystemCenterVirtualMachineManagerName")
    def source_system_center_virtual_machine_manager_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_system_center_virtual_machine_manager_name(self, value: pulumi.Input[builtins.str]):
...
class _HypervNetworkMappingState:
    def __init__(__self__, *,
                 ...
                 source_network_name: Optional[pulumi.Input[builtins.str]] = None,
                 source_system_center_virtual_machine_manager_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="sourceNetworkName")
    def source_network_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Name of the primary network. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "source_network_name")
    ...
    @source_network_name.setter
    def source_network_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_network_name", value)

    @property
    @pulumi.getter(name="sourceSystemCenterVirtualMachineManagerName")
    def source_system_center_virtual_machine_manager_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the name of source System Center Virtual Machine Manager where the source network exists. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "source_system_center_virtual_machine_manager_name")
    ...
    @source_system_center_virtual_machine_manager_name.setter
    def source_system_center_virtual_machine_manager_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_system_center_virtual_machine_manager_name", value)
...
class HypervNetworkMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_network_name: Optional[pulumi.Input[builtins.str]] = None,
            source_system_center_virtual_machine_manager_name: Optional[pulumi.Input[builtins.str]] = None,
            target_network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HypervNetworkMapping':
        """
    ...
    @property
    @pulumi.getter(name="sourceNetworkName")
    def source_network_name(self) -> pulumi.Output[builtins.str]:
        """
        The Name of the primary network. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "source_network_name")
    ...
    @property
    @pulumi.getter(name="sourceSystemCenterVirtualMachineManagerName")
    def source_system_center_virtual_machine_manager_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of source System Center Virtual Machine Manager where the source network exists. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "source_system_center_virtual_machine_manager_name")
