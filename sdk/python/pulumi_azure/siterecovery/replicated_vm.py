...
class ReplicatedVMArgs:
    def __init__(__self__, *,
                 ...
                 source_recovery_protection_container_name: pulumi.Input[_builtins.str],
                 source_vm_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] source_recovery_fabric_name: Name of fabric that should contain this replication. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] source_recovery_protection_container_name: Name of the protection container to use. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] source_vm_id: Id of the VM to replicate Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] target_recovery_fabric_id: Id of fabric where the VM replication should be handled when a failover is done. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] target_recovery_protection_container_id: Id of protection container where the VM replication should be created when a failover is done. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] target_resource_group_id: Id of resource group where the VM should be created when a failover is done. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] target_availability_set_id: Id of availability set that the new VM should belong to when a failover is done.
        :param pulumi.Input[_builtins.str] target_boot_diagnostic_storage_account_id: Id of the storage account which the new VM should used for boot diagnostic when a failover is done.
        :param pulumi.Input[_builtins.str] target_capacity_reservation_group_id: Id of the Capacity reservation group where the new VM should belong to when a failover is done.
        :param pulumi.Input[_builtins.str] target_edge_zone: Specifies the Edge Zone within the Azure Region where this Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] target_network_id: Network to use when a failover is done (recommended to set if any network_interface is configured for failover).
        :param pulumi.Input[_builtins.str] target_proximity_placement_group_id: Id of Proximity Placement Group the new VM should belong to when a failover is done.
        :param pulumi.Input[_builtins.str] target_virtual_machine_scale_set_id: Id of the Virtual Machine Scale Set which the new Vm should belong to when a failover is done.
        :param pulumi.Input[_builtins.str] target_virtual_machine_size: Specifies the size the Virtual Machine should have.
        :param pulumi.Input[_builtins.str] target_zone: Specifies the Availability Zone where the Failover VM should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] test_network_id: Network to use when a test failover is done.
    ...
    def source_recovery_protection_container_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def source_recovery_protection_container_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "source_recovery_protection_container_name", value)

    @_builtins.property
    @pulumi.getter(name="sourceVmId")
    def source_vm_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @source_vm_id.setter
    def source_vm_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "source_vm_id", value)

    @_builtins.property
    @pulumi.getter(name="targetRecoveryFabricId")
    def target_recovery_fabric_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def target_recovery_fabric_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "target_recovery_fabric_id", value)

    @_builtins.property
    @pulumi.getter(name="targetRecoveryProtectionContainerId")
    def target_recovery_protection_container_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def target_recovery_protection_container_id(self, value: pulumi.Input[_builtins.str]):
...
class ReplicatedVM(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 managed_disks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReplicatedVMManagedDiskArgs', 'ReplicatedVMManagedDiskArgsDict', 'outputs.ReplicatedVMManagedDisk']]]]] = None,
                 multi_vm_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 network_interfaces: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReplicatedVMNetworkInterfaceArgs', 'ReplicatedVMNetworkInterfaceArgsDict', 'outputs.ReplicatedVMNetworkInterface']]]]] = None,
                 recovery_replication_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 recovery_vault_name: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 source_recovery_fabric_name: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 target_zone: pulumi.Input[Optional[_builtins.str]] = None,
                 test_network_id: pulumi.Input[Optional[_builtins.str]] = None,
                 unmanaged_disks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReplicatedVMUnmanagedDiskArgs', 'ReplicatedVMUnmanagedDiskArgsDict', 'outputs.ReplicatedVMUnmanagedDisk']]]]] = None,
                 __props__=None):
        """
        ...
        * `Microsoft.RecoveryServices` - 2024-04-01
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['ReplicatedVMManagedDiskArgs', 'ReplicatedVMManagedDiskArgsDict', 'outputs.ReplicatedVMManagedDisk']]]] managed_disks: One or more `managed_disk` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] multi_vm_group_name: Name of group in which all machines will replicate together and have shared crash consistent and app-consistent recovery points when failed over.
        :param pulumi.Input[_builtins.str] name: The name of the replication for the replicated VM. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ReplicatedVMNetworkInterfaceArgs', 'ReplicatedVMNetworkInterfaceArgsDict', 'outputs.ReplicatedVMNetworkInterface']]]] network_interfaces: One or more `network_interface` block as defined below.
        :param pulumi.Input[_builtins.str] recovery_replication_policy_id: Id of the policy to use for this replicated vm. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] recovery_vault_name: The name of the vault that should be updated. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] resource_group_name: Name of the resource group where the vault that should be updated is located. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] source_recovery_fabric_name: Name of fabric that should contain this replication. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] target_zone: Specifies the Availability Zone where the Failover VM should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] test_network_id: Network to use when a test failover is done.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ReplicatedVMUnmanagedDiskArgs', 'ReplicatedVMUnmanagedDiskArgsDict', 'outputs.ReplicatedVMUnmanagedDisk']]]] unmanaged_disks: One or more `unmanaged_disk` block as defined below. Changing this forces a new resource to be created.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            target_zone: pulumi.Input[Optional[_builtins.str]] = None,
            test_network_id: pulumi.Input[Optional[_builtins.str]] = None,
            unmanaged_disks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ReplicatedVMUnmanagedDiskArgs', 'ReplicatedVMUnmanagedDiskArgsDict', 'outputs.ReplicatedVMUnmanagedDisk']]]]] = None) -> 'ReplicatedVM':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sourceRecoveryProtectionContainerName")
    def source_recovery_protection_container_name(self) -> pulumi.Output[_builtins.str]:
        """
        Name of the protection container to use. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "source_recovery_protection_container_name")
    ...
    @_builtins.property
    @pulumi.getter(name="targetBootDiagnosticStorageAccountId")
    def target_boot_diagnostic_storage_account_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Id of the storage account which the new VM should used for boot diagnostic when a failover is done.
        """
        return pulumi.get(self, "target_boot_diagnostic_storage_account_id")
    ...
    @_builtins.property
    @pulumi.getter(name="targetCapacityReservationGroupId")
    def target_capacity_reservation_group_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Id of the Capacity reservation group where the new VM should belong to when a failover is done.
        """
        return pulumi.get(self, "target_capacity_reservation_group_id")
    ...
    @_builtins.property
    @pulumi.getter(name="targetEdgeZone")
    def target_edge_zone(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the Edge Zone within the Azure Region where this Managed Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "target_edge_zone")
    ...
    @_builtins.property
    @pulumi.getter(name="targetRecoveryFabricId")
    def target_recovery_fabric_id(self) -> pulumi.Output[_builtins.str]:
        """
        Id of fabric where the VM replication should be handled when a failover is done. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "target_recovery_fabric_id")
    ...
    @_builtins.property
    @pulumi.getter(name="targetRecoveryProtectionContainerId")
    def target_recovery_protection_container_id(self) -> pulumi.Output[_builtins.str]:
        """
        Id of protection container where the VM replication should be created when a failover is done. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "target_recovery_protection_container_id")
    ...
    @_builtins.property
    @pulumi.getter(name="targetVirtualMachineScaleSetId")
    def target_virtual_machine_scale_set_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Id of the Virtual Machine Scale Set which the new Vm should belong to when a failover is done.
        """
        return pulumi.get(self, "target_virtual_machine_scale_set_id")
    ...
    @_builtins.property
    @pulumi.getter(name="targetVirtualMachineSize")
    def target_virtual_machine_size(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the size the Virtual Machine should have.
        """
        return pulumi.get(self, "target_virtual_machine_size")
    ...
    @_builtins.property
    @pulumi.getter(name="testNetworkId")
    def test_network_id(self) -> pulumi.Output[_builtins.str]:
        """
        Network to use when a test failover is done.
        """
        return pulumi.get(self, "test_network_id")
