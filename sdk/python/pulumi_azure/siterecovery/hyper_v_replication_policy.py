...
class HyperVReplicationPolicyArgs:
    def __init__(__self__, *,
                 application_consistent_snapshot_frequency_in_hours: pulumi.Input[builtins.int],
                 recovery_point_retention_in_hours: pulumi.Input[builtins.int],
                 recovery_vault_id: pulumi.Input[builtins.str],
                 replication_interval_in_seconds: pulumi.Input[builtins.int],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HyperVReplicationPolicy resource.
        :param pulumi.Input[builtins.int] application_consistent_snapshot_frequency_in_hours: Specifies the frequency at which to create application consistent recovery points.
        :param pulumi.Input[builtins.int] recovery_point_retention_in_hours: The duration in hours for which the recovery points need to be stored.
        ...
        :param pulumi.Input[builtins.int] replication_interval_in_seconds: Specifies how frequently data should be synchronized between source and target locations. Possible values are `30` and `300`.
    ...
    def application_consistent_snapshot_frequency_in_hours(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def application_consistent_snapshot_frequency_in_hours(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "application_consistent_snapshot_frequency_in_hours", value)

    @property
    @pulumi.getter(name="recoveryPointRetentionInHours")
    def recovery_point_retention_in_hours(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def recovery_point_retention_in_hours(self, value: pulumi.Input[builtins.int]):
    ...
    def replication_interval_in_seconds(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def replication_interval_in_seconds(self, value: pulumi.Input[builtins.int]):
...
class _HyperVReplicationPolicyState:
    def __init__(__self__, *,
                 application_consistent_snapshot_frequency_in_hours: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 recovery_point_retention_in_hours: Optional[pulumi.Input[builtins.int]] = None,
                 recovery_vault_id: Optional[pulumi.Input[builtins.str]] = None,
                 replication_interval_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="applicationConsistentSnapshotFrequencyInHours")
    def application_consistent_snapshot_frequency_in_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the frequency at which to create application consistent recovery points.
        """
        return pulumi.get(self, "application_consistent_snapshot_frequency_in_hours")
    ...
    @application_consistent_snapshot_frequency_in_hours.setter
    def application_consistent_snapshot_frequency_in_hours(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "application_consistent_snapshot_frequency_in_hours", value)
    ...
    @property
    @pulumi.getter(name="recoveryPointRetentionInHours")
    def recovery_point_retention_in_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The duration in hours for which the recovery points need to be stored.
        """
        return pulumi.get(self, "recovery_point_retention_in_hours")
    ...
    @recovery_point_retention_in_hours.setter
    def recovery_point_retention_in_hours(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "recovery_point_retention_in_hours", value)
    ...
    @property
    @pulumi.getter(name="replicationIntervalInSeconds")
    def replication_interval_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies how frequently data should be synchronized between source and target locations. Possible values are `30` and `300`.
        """
        return pulumi.get(self, "replication_interval_in_seconds")
    ...
    @replication_interval_in_seconds.setter
    def replication_interval_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "replication_interval_in_seconds", value)
...
class HyperVReplicationPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            recovery_point_retention_in_hours: Optional[pulumi.Input[builtins.int]] = None,
            recovery_vault_id: Optional[pulumi.Input[builtins.str]] = None,
            replication_interval_in_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'HyperVReplicationPolicy':
        """
    ...
    @property
    @pulumi.getter(name="applicationConsistentSnapshotFrequencyInHours")
    def application_consistent_snapshot_frequency_in_hours(self) -> pulumi.Output[builtins.int]:
        """
        Specifies the frequency at which to create application consistent recovery points.
        """
        return pulumi.get(self, "application_consistent_snapshot_frequency_in_hours")
    ...
    @property
    @pulumi.getter(name="recoveryPointRetentionInHours")
    def recovery_point_retention_in_hours(self) -> pulumi.Output[builtins.int]:
        """
        The duration in hours for which the recovery points need to be stored.
        """
        return pulumi.get(self, "recovery_point_retention_in_hours")
    ...
    @property
    @pulumi.getter(name="replicationIntervalInSeconds")
    def replication_interval_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        Specifies how frequently data should be synchronized between source and target locations. Possible values are `30` and `300`.
        """
        return pulumi.get(self, "replication_interval_in_seconds")
