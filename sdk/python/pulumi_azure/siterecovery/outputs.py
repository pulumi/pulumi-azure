...
class ProtectionContainerMappingAutomaticUpdate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 automation_account_id: Optional[builtins.str] = None,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str authentication_type: The authentication type used for automation account. Possible values are `RunAsAccount` and `SystemAssignedIdentity`. Defaults to `SystemAssignedIdentity`.
        ...
        :param builtins.str automation_account_id: The automation account ID which holds the automatic update runbook and authenticates to Azure resources.
               
               > **Note:** `automation_account_id` is required when `enabled` is specified.
        :param builtins.bool enabled: Should the Mobility service installed on Azure virtual machines be automatically updated. Defaults to `false`.
    ...
    def automation_account_id(self) -> Optional[builtins.str]:
        """
...
class ReplicatedVMManagedDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 target_replica_disk_type: builtins.str,
                 ...
                 target_disk_encryption_set_id: Optional[builtins.str] = None):
        """
        :param builtins.str disk_id: Id of disk that should be replicated. Changing this forces a new resource to be created.
        :param builtins.str staging_storage_account_id: Storage account that should be used for caching. Changing this forces a new resource to be created.
        :param builtins.str target_disk_type: What type should the disk be when a failover is done. Possible values are `Standard_LRS`, `Premium_LRS`, `StandardSSD_LRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param builtins.str target_replica_disk_type: What type should the disk be that holds the replication data. Possible values are `Standard_LRS`, `Premium_LRS`, `StandardSSD_LRS` and `UltraSSD_LRS`. Changing this forces a new resource to be created.
        :param builtins.str target_resource_group_id: Resource group disk should belong to when a failover is done. Changing this forces a new resource to be created.
    ...
    def target_disk_encryption_set_id(self) -> Optional[builtins.str]:
        """
...
class ReplicatedVMManagedDiskTargetDiskEncryptionDiskEncryptionKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str secret_url: The URL to the Key Vault Secret used as the Disk Encryption Key that the Managed Disk will be associated with. This can be found as `id` on the `keyvault.Secret` resource. Changing this forces a new resource to be created.
        :param builtins.str vault_id: The ID of the Key Vault. This can be found as `id` on the `keyvault.KeyVault` resource. Changing this forces a new resource to be created.
        """
...
class ReplicatedVMManagedDiskTargetDiskEncryptionKeyEncryptionKey(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vault_id: builtins.str):
        """
        :param builtins.str key_url: The URL to the Key Vault Key used as the Key Encryption Key that the Managed Disk will be associated with. This can be found as `id` on the `keyvault.Key` resource. Changing this forces a new resource to be created.
        :param builtins.str vault_id: The ID of the Key Vault. This can be found as `id` on the `keyvault.KeyVault` resource. Changing this forces a new resource to be created.
        """
...
class ReplicatedVMNetworkInterface(dict):
    ...
    def __init__(__self__, *,
                 failover_test_public_ip_address_id: Optional[builtins.str] = None,
                 failover_test_static_ip: Optional[builtins.str] = None,
                 failover_test_subnet_name: Optional[builtins.str] = None,
                 recovery_load_balancer_backend_address_pool_ids: Optional[Sequence[builtins.str]] = None,
                 recovery_public_ip_address_id: Optional[builtins.str] = None,
                 source_network_interface_id: Optional[builtins.str] = None,
                 target_static_ip: Optional[builtins.str] = None,
                 target_subnet_name: Optional[builtins.str] = None):
        """
        :param builtins.str failover_test_public_ip_address_id: Id of the public IP object to use when a test failover is done.
        :param builtins.str failover_test_static_ip: Static IP to assign when a test failover is done.
        :param builtins.str failover_test_subnet_name: Name of the subnet to use when a test failover is done.
        :param Sequence[builtins.str] recovery_load_balancer_backend_address_pool_ids: A list of IDs of Load Balancer Backend Address Pools to use when a failover is done.
        :param builtins.str recovery_public_ip_address_id: Id of the public IP object to use when a failover is done.
        :param builtins.str source_network_interface_id: (Required if the network_interface block is specified) Id source network interface.
        :param builtins.str target_static_ip: Static IP to assign when a failover is done.
        :param builtins.str target_subnet_name: Name of the subnet to use when a failover is done.
        """
    ...
    def failover_test_public_ip_address_id(self) -> Optional[builtins.str]:
        """
    ...
    def failover_test_static_ip(self) -> Optional[builtins.str]:
        """
    ...
    def failover_test_subnet_name(self) -> Optional[builtins.str]:
        """
    ...
    def recovery_load_balancer_backend_address_pool_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def source_network_interface_id(self) -> Optional[builtins.str]:
        """
    ...
    def target_static_ip(self) -> Optional[builtins.str]:
        """
...
class ReplicatedVMUnmanagedDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 staging_storage_account_id: builtins.str,
                 target_storage_account_id: builtins.str):
        """
        :param builtins.str disk_uri: Id of disk that should be replicated. Changing this forces a new resource to be created.
        :param builtins.str staging_storage_account_id: Storage account that should be used for caching. Changing this forces a new resource to be created.
        :param builtins.str target_storage_account_id: Storage account disk should belong to when a failover is done. Changing this forces a new resource to be created.
        """
...
class ReplicationRecoveryPlanAzureToAzureSettings(dict):
    ...
    def __init__(__self__, *,
                 primary_edge_zone: Optional[builtins.str] = None,
                 primary_zone: Optional[builtins.str] = None,
                 recovery_edge_zone: Optional[builtins.str] = None,
                 recovery_zone: Optional[builtins.str] = None):
        """
        :param builtins.str primary_edge_zone: The Edge Zone within the Azure Region where the VM exists. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
        :param builtins.str primary_zone: The Availability Zone in which the VM is located. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
        :param builtins.str recovery_edge_zone: The Edge Zone within the Azure Region where the VM is recovered. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
               
               > **Note:** `primary_edge_zone` and `recovery_edge_zone` must be specified together.
        :param builtins.str recovery_zone: The Availability Zone in which the VM is recovered. Changing this forces a new Site Recovery Replication Recovery Plan to be created.
    ...
    def primary_edge_zone(self) -> Optional[builtins.str]:
        """
    ...
    def recovery_edge_zone(self) -> Optional[builtins.str]:
        """
...
class ReplicationRecoveryPlanBootRecoveryGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 replicated_protected_items: Optional[Sequence[builtins.str]] = None):
        """
        ...
        :param Sequence[builtins.str] replicated_protected_items: One or more protected VM IDs.
        """
    ...
    def replicated_protected_items(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ReplicationRecoveryPlanBootRecoveryGroupPostAction(dict):
    ...
    def __init__(__self__, *,
                 fail_over_directions: Sequence[builtins.str],
                 fail_over_types: Sequence[builtins.str],
                 name: builtins.str,
                 type: builtins.str,
                 fabric_location: Optional[builtins.str] = None,
                 manual_action_instruction: Optional[builtins.str] = None,
                 runbook_id: Optional[builtins.str] = None,
                 script_path: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] fail_over_directions: Directions of fail over. Possible values are `PrimaryToRecovery` and `RecoveryToPrimary`
        :param Sequence[builtins.str] fail_over_types: Types of fail over. Possible values are `TestFailover`, `PlannedFailover` and `UnplannedFailover`
        :param builtins.str name: The name of the Replication Plan. The name can contain only letters, numbers, and hyphens. It should start with a letter and end with a letter or a number. Can be a maximum of 63 characters. Changing this forces a new resource to be created.
    ...
    def fail_over_directions(self) -> Sequence[builtins.str]:
        """
    ...
    def fail_over_types(self) -> Sequence[builtins.str]:
        """
    ...
    def fabric_location(self) -> Optional[builtins.str]:
        """
    ...
    def manual_action_instruction(self) -> Optional[builtins.str]:
        """
...
class VmwareReplicatedVmManagedDisk(dict):
    ...
    def __init__(__self__, *,
                 disk_id: builtins.str,
                 target_disk_type: builtins.str,
                 log_storage_account_id: Optional[builtins.str] = None,
                 target_disk_encryption_set_id: Optional[builtins.str] = None):
        """
        :param builtins.str disk_id: The ID of the disk to be replicated.
        :param builtins.str target_disk_type: The disk type of the disk to be created when a failover is done. Possible values are `Premium_LRS`, `Standard_LRS` and `StandardSSD_LRS`.
        :param builtins.str log_storage_account_id: The ID of the storage account that should be used for logging during replication.
        :param builtins.str target_disk_encryption_set_id: The ID of the Disk Encryption Set that should be used for the disks when a failover is done.
        """
        pulumi.set(__self__, "disk_id", disk_id)
        pulumi.set(__self__, "target_disk_type", target_disk_type)
    ...
    def log_storage_account_id(self) -> Optional[builtins.str]:
        """
...
class VmwareReplicatedVmNetworkInterface(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_primary: Whether this `network_interface` is primary for the replicated VM.
        :param builtins.str source_mac_address: Mac address of the network interface of source VM.
        :param builtins.str target_static_ip: Static IP to assign when a failover is done.
        :param builtins.str target_subnet_name: Name of the subnet to use when a failover is done.
        :param builtins.str test_subnet_name: Name of the subnet to use when a test failover is done.
        """
...
class GetReplicationRecoveryPlanAzureToAzureSettingResult(dict):
    def __init__(__self__, *,
                 primary_edge_zone: builtins.str,
                 primary_zone: builtins.str,
                 recovery_edge_zone: builtins.str,
                 recovery_zone: builtins.str):
        pulumi.set(__self__, "primary_edge_zone", primary_edge_zone)
        pulumi.set(__self__, "primary_zone", primary_zone)
        pulumi.set(__self__, "recovery_edge_zone", recovery_edge_zone)
        pulumi.set(__self__, "recovery_zone", recovery_zone)
...
class GetReplicationRecoveryPlanRecoveryGroupResult(dict):
    def __init__(__self__, *,
                 ...
                 replicated_protected_items: Sequence[builtins.str],
                 type: builtins.str):
        """
        ...
        :param Sequence[builtins.str] replicated_protected_items: one or more id of protected VM.
        :param builtins.str type: Type of the action detail.
        """
        pulumi.set(__self__, "post_actions", post_actions)
        pulumi.set(__self__, "pre_actions", pre_actions)
        pulumi.set(__self__, "replicated_protected_items", replicated_protected_items)
    ...
    @property
    @pulumi.getter(name="replicatedProtectedItems")
    def replicated_protected_items(self) -> Sequence[builtins.str]:
        """
...
class GetReplicationRecoveryPlanRecoveryGroupPostActionResult(dict):
    def __init__(__self__, *,
                 ...
                 fail_over_directions: Sequence[builtins.str],
                 fail_over_types: Sequence[builtins.str],
                 manual_action_instruction: builtins.str,
                 name: builtins.str,
                 runbook_id: builtins.str,
                 script_path: builtins.str,
                 type: builtins.str):
        """
        :param builtins.str fabric_location: The fabric location of runbook or script.
        :param Sequence[builtins.str] fail_over_directions: Directions of fail over.
        :param Sequence[builtins.str] fail_over_types: Types of fail over.
        :param builtins.str manual_action_instruction: Instructions of manual action.
