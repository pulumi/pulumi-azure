...
class ProtectionContainerMappingArgs:
    def __init__(__self__, *,
                 ...
                 automatic_update: pulumi.Input[Optional['ProtectionContainerMappingAutomaticUpdateArgs']] = None,
    ...
    def automatic_update(self, value: pulumi.Input[Optional['ProtectionContainerMappingAutomaticUpdateArgs']]):
...
class _ProtectionContainerMappingState:
    def __init__(__self__, *,
                 ...
                 recovery_source_protection_container_name: pulumi.Input[Optional[_builtins.str]] = None,
                 recovery_target_protection_container_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @recovery_fabric_name.setter
    def recovery_fabric_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "recovery_fabric_name", value)
    ...
    @_builtins.property
    @pulumi.getter(name="recoverySourceProtectionContainerName")
    def recovery_source_protection_container_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Name of the source protection container to map. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "recovery_source_protection_container_name")
    ...
    @recovery_source_protection_container_name.setter
    def recovery_source_protection_container_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "recovery_source_protection_container_name", value)

    @_builtins.property
    @pulumi.getter(name="recoveryTargetProtectionContainerId")
    def recovery_target_protection_container_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Id of target protection container to map to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "recovery_target_protection_container_id")
    ...
    @recovery_target_protection_container_id.setter
    def recovery_target_protection_container_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "recovery_target_protection_container_id", value)
...
class ProtectionContainerMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            recovery_target_protection_container_id: pulumi.Input[Optional[_builtins.str]] = None,
            recovery_vault_name: pulumi.Input[Optional[_builtins.str]] = None,
            resource_group_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'ProtectionContainerMapping':
        """
