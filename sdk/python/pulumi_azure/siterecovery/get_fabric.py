...
def get_fabric(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.RecoveryServices`: 2024-04-01
    ...
    :param builtins.str resource_group_name: The name of the resource group in which the associated Recovery Services Vault resides.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_fabric_output(name: Optional[pulumi.Input[builtins.str]] = None,
