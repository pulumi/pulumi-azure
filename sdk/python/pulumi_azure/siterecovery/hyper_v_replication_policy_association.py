...
class HyperVReplicationPolicyAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] hyperv_site_id: The ID of the HyperV site to which the policy should be associated. Changing this forces a new association to be created.
        :param pulumi.Input[_builtins.str] policy_id: The ID of the HyperV replication policy which to be associated. Changing this forces a new association to be created.
    ...
    def hyperv_site_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def hyperv_site_id(self, value: pulumi.Input[_builtins.str]):
...
class HyperVReplicationPolicyAssociation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="hypervSiteId")
    def hyperv_site_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the HyperV site to which the policy should be associated. Changing this forces a new association to be created.
        """
        return pulumi.get(self, "hyperv_site_id")
