...
class VmwareReplicatedVmArgs:
    def __init__(__self__, *,
                 appliance_name: pulumi.Input[builtins.str],
                 physical_server_credential_name: pulumi.Input[builtins.str],
                 recovery_replication_policy_id: pulumi.Input[builtins.str],
                 recovery_vault_id: pulumi.Input[builtins.str],
                 source_vm_name: pulumi.Input[builtins.str],
                 target_resource_group_id: pulumi.Input[builtins.str],
                 target_vm_name: pulumi.Input[builtins.str],
                 default_log_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_recovery_disk_type: Optional[pulumi.Input[builtins.str]] = None,
                 default_target_disk_encryption_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 target_boot_diagnostics_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] appliance_name: The name of VMWare appliance which handles the replication. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] physical_server_credential_name: The name of the credential to access the source VM. Changing this forces a new resource to be created. More information about the credentials could be found [here](https://learn.microsoft.com/en-us/azure/site-recovery/deploy-vmware-azure-replication-appliance-modernized).
        :param pulumi.Input[builtins.str] recovery_replication_policy_id: The ID of the policy to use for this replicated VM.
        :param pulumi.Input[builtins.str] recovery_vault_id: The ID of the Recovery Services Vault where the replicated VM is created.
        :param pulumi.Input[builtins.str] source_vm_name: The name of the source VM in VMWare. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_resource_group_id: The ID of resource group where the VM should be created when a failover is done.
        :param pulumi.Input[builtins.str] target_vm_name: Name of the VM that should be created when a failover is done. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] default_log_storage_account_id: The ID of the stroage account that should be used for logging during replication. 
        ...
        :param pulumi.Input[builtins.str] default_recovery_disk_type: The type of storage account that should be used for recovery disks when a failover is done. Possible values are `Premium_LRS`, `Standard_LRS` and `StandardSSD_LRS`.
        ...
        :param pulumi.Input[builtins.str] default_target_disk_encryption_set_id: The ID of the default Disk Encryption Set that should be used for the disks when a failover is done.
        ...
        :param pulumi.Input[builtins.str] license_type: The license type of the VM. Possible values are `NoLicenseType`, `NotSpecified` and `WindowsServer`. Defaults to `NotSpecified`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the replicated VM. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] target_availability_set_id: The ID of availability set that the new VM should belong to when a failover is done.
        :param pulumi.Input[builtins.str] target_boot_diagnostics_storage_account_id: The ID of the storage account that should be used for boot diagnostics when a failover is done.
        :param pulumi.Input[builtins.str] target_network_id: The ID of network to use when a failover is done.
               
               > **Note:** `target_network_id` is required when `network_interface` is specified.
        :param pulumi.Input[builtins.str] target_proximity_placement_group_id: The ID of Proximity Placement Group the new VM should belong to when a failover is done.
               
               > **Note:** Only one of `target_availability_set_id` or `target_zone` can be specified.
        :param pulumi.Input[builtins.str] target_vm_size: Size of the VM that should be created when a failover is done, such as `Standard_F2`. If it's not specified, it will automatically be set by detecting the source VM size.
        :param pulumi.Input[builtins.str] target_zone: Specifies the Availability Zone where the Failover VM should exist.
        :param pulumi.Input[builtins.str] test_network_id: The ID of network to use when a test failover is done.
        """
    ...
    def appliance_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def appliance_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "appliance_name", value)

    @property
    @pulumi.getter(name="physicalServerCredentialName")
    def physical_server_credential_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the credential to access the source VM. Changing this forces a new resource to be created. More information about the credentials could be found [here](https://learn.microsoft.com/en-us/azure/site-recovery/deploy-vmware-azure-replication-appliance-modernized).
        """
    ...
    def physical_server_credential_name(self, value: pulumi.Input[builtins.str]):
    ...
    def source_vm_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_vm_name(self, value: pulumi.Input[builtins.str]):
    ...
    def target_vm_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_vm_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_vm_name", value)

    @property
    @pulumi.getter(name="defaultLogStorageAccountId")
    def default_log_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_log_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_log_storage_account_id", value)

    @property
    @pulumi.getter(name="defaultRecoveryDiskType")
    def default_recovery_disk_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_recovery_disk_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_recovery_disk_type", value)

    @property
    @pulumi.getter(name="defaultTargetDiskEncryptionSetId")
    def default_target_disk_encryption_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_target_disk_encryption_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_boot_diagnostics_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_boot_diagnostics_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VmwareReplicatedVmState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input['VmwareReplicatedVmNetworkInterfaceArgs']]]] = None,
                 physical_server_credential_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 source_vm_name: Optional[pulumi.Input[builtins.str]] = None,
                 target_availability_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_boot_diagnostics_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_network_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_proximity_placement_group_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="physicalServerCredentialName")
    def physical_server_credential_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the credential to access the source VM. Changing this forces a new resource to be created. More information about the credentials could be found [here](https://learn.microsoft.com/en-us/azure/site-recovery/deploy-vmware-azure-replication-appliance-modernized).
        """
        return pulumi.get(self, "physical_server_credential_name")
    ...
    @physical_server_credential_name.setter
    def physical_server_credential_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "physical_server_credential_name", value)
    ...
    @property
    @pulumi.getter(name="sourceVmName")
    def source_vm_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the source VM in VMWare. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "source_vm_name")
    ...
    @source_vm_name.setter
    def source_vm_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_vm_name", value)
...
class VmwareReplicatedVm(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_vm_size: Optional[pulumi.Input[builtins.str]] = None,
            target_zone: Optional[pulumi.Input[builtins.str]] = None,
            test_network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VmwareReplicatedVm':
        """
    ...
    @property
    @pulumi.getter(name="applianceName")
    def appliance_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of VMWare appliance which handles the replication. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "appliance_name")
    ...
    @property
    @pulumi.getter(name="defaultLogStorageAccountId")
    def default_log_storage_account_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the stroage account that should be used for logging during replication. 
    ...
    @property
    @pulumi.getter(name="defaultRecoveryDiskType")
    def default_recovery_disk_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of storage account that should be used for recovery disks when a failover is done. Possible values are `Premium_LRS`, `Standard_LRS` and `StandardSSD_LRS`.
    ...
    @property
    @pulumi.getter(name="defaultTargetDiskEncryptionSetId")
    def default_target_disk_encryption_set_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the default Disk Encryption Set that should be used for the disks when a failover is done.
    ...
    @property
    @pulumi.getter(name="physicalServerCredentialName")
    def physical_server_credential_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the credential to access the source VM. Changing this forces a new resource to be created. More information about the credentials could be found [here](https://learn.microsoft.com/en-us/azure/site-recovery/deploy-vmware-azure-replication-appliance-modernized).
        """
        return pulumi.get(self, "physical_server_credential_name")
    ...
    @property
    @pulumi.getter(name="sourceVmName")
    def source_vm_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the source VM in VMWare. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "source_vm_name")
    ...
    @property
    @pulumi.getter(name="targetBootDiagnosticsStorageAccountId")
    def target_boot_diagnostics_storage_account_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the storage account that should be used for boot diagnostics when a failover is done.
        """
        return pulumi.get(self, "target_boot_diagnostics_storage_account_id")
    ...
    @property
    @pulumi.getter(name="targetNetworkId")
    def target_network_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of network to use when a failover is done.
    ...
    @property
    @pulumi.getter(name="targetVmName")
    def target_vm_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the VM that should be created when a failover is done. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "target_vm_name")
    ...
    @property
    @pulumi.getter(name="targetVmSize")
    def target_vm_size(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Size of the VM that should be created when a failover is done, such as `Standard_F2`. If it's not specified, it will automatically be set by detecting the source VM size.
        """
        return pulumi.get(self, "target_vm_size")
    ...
    @property
    @pulumi.getter(name="testNetworkId")
    def test_network_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of network to use when a test failover is done.
        """
        return pulumi.get(self, "test_network_id")
