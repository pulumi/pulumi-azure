...
class GetReplicationRecoveryPlanResult:
    ...
    def failover_deployment_model(self) -> _builtins.str:
    ...
    def recovery_vault_id(self) -> _builtins.str:
        return pulumi.get(self, "recovery_vault_id")

    @_builtins.property
    @pulumi.getter(name="sourceRecoveryFabricId")
    def source_recovery_fabric_id(self) -> _builtins.str:
        """
    ...
    def target_recovery_fabric_id(self) -> _builtins.str:
        """
...
def get_replication_recovery_plan(name: Optional[_builtins.str] = None,
                                  recovery_vault_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.RecoveryServices` - 2024-04-01
    ...
    :param _builtins.str recovery_vault_id: The ID of the vault that should be updated.
    """
    __args__ = dict()
    __args__['name'] = name
