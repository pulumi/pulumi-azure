...
class ReplicationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] application_consistent_snapshot_frequency_in_minutes: Specifies the frequency(in minutes) at which to create application consistent recovery points.
        ...
        :param pulumi.Input[_builtins.int] recovery_point_retention_in_minutes: The duration in minutes for which the recovery points need to be stored.
    ...
    def application_consistent_snapshot_frequency_in_minutes(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def application_consistent_snapshot_frequency_in_minutes(self, value: pulumi.Input[_builtins.int]):
    ...
    def recovery_point_retention_in_minutes(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def recovery_point_retention_in_minutes(self, value: pulumi.Input[_builtins.int]):
...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="applicationConsistentSnapshotFrequencyInMinutes")
    def application_consistent_snapshot_frequency_in_minutes(self) -> pulumi.Output[_builtins.int]:
        """
        Specifies the frequency(in minutes) at which to create application consistent recovery points.
    ...
    @_builtins.property
    @pulumi.getter(name="recoveryPointRetentionInMinutes")
    def recovery_point_retention_in_minutes(self) -> pulumi.Output[_builtins.int]:
        """
        The duration in minutes for which the recovery points need to be stored.
        """
        return pulumi.get(self, "recovery_point_retention_in_minutes")
