...
class HyperVSiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] recovery_vault_id: The ID of the Recovery Services Vault where the Site created. Changing this forces a new Site to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Recovery Service. Changing this forces a new Site to be created.
        """
...
class HyperVSite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            recovery_vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'HyperVSite':
        """
