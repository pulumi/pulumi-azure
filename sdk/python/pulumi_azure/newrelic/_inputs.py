...
class MonitorIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the identity type of the Azure Native New Relic Monitor. The only possible value is `SystemAssigned`. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Identity of this Azure Native New Relic Monitor.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Azure Native New Relic Monitor.
        """
...
class MonitorPlanArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] effective_date: Specifies the date when plan was applied. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[builtins.str] billing_cycle: Specifies the billing cycles. Possible values are `MONTHLY`, `WEEKLY` and `YEARLY`. Defaults to `MONTHLY`. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[builtins.str] plan_id: Specifies the plan id published by NewRelic. The only possible value is `newrelic-pay-as-you-go-free-live`. Defaults to `newrelic-pay-as-you-go-free-live`. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[builtins.str] usage_type: Specifies the usage type. Possible values are `COMMITTED` and `PAYG`. Defaults to `PAYG`. Changing this forces a new Azure Native New Relic Monitor to be created.
        """
    ...
    def effective_date(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the date when plan was applied. Changing this forces a new Azure Native New Relic Monitor to be created.
        """
    ...
    def effective_date(self, value: pulumi.Input[builtins.str]):
...
class MonitorUserArgs:
    def __init__(__self__, *,
                 ...
                 phone_number: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] email: Specifies the user Email. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[builtins.str] first_name: Specifies the first name. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[builtins.str] last_name: Specifies the last name. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[builtins.str] phone_number: Specifies the contact phone number. Changing this forces a new Azure Native New Relic Monitor to be created.
        """
...
class TagRuleLogTagFilterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] action: Valid actions for a filtering tag. Possible values are `Exclude` and `Include`. Exclusion takes priority over inclusion.
        :param pulumi.Input[builtins.str] name: Specifies the name (also known as the key) of the tag.
        :param pulumi.Input[builtins.str] value: Specifies the value of the tag.
        """
