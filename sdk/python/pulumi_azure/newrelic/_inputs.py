...
class MonitorIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Azure Native New Relic Monitor.
        """
...
class MonitorPlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] plan_id: Specifies the plan id published by NewRelic. The only possible value is `newrelic-pay-as-you-go-free-live`. Defaults to `newrelic-pay-as-you-go-free-live`. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[_builtins.str] usage_type: Specifies the usage type. Possible values are `COMMITTED` and `PAYG`. Defaults to `PAYG`. Changing this forces a new Azure Native New Relic Monitor to be created.
        """
    ...
    def effective_date(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the date when plan was applied. Changing this forces a new Azure Native New Relic Monitor to be created.
        """
    ...
    def effective_date(self, value: pulumi.Input[_builtins.str]):
...
class MonitorUserArgs:
    def __init__(__self__, *,
                 ...
                 phone_number: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] email: Specifies the user Email. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[_builtins.str] first_name: Specifies the first name. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[_builtins.str] last_name: Specifies the last name. Changing this forces a new Azure Native New Relic Monitor to be created.
        :param pulumi.Input[_builtins.str] phone_number: Specifies the contact phone number. Changing this forces a new Azure Native New Relic Monitor to be created.
        """
...
class TagRuleLogTagFilterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] action: Valid actions for a filtering tag. Possible values are `Exclude` and `Include`. Exclusion takes priority over inclusion.
        :param pulumi.Input[_builtins.str] name: Specifies the name (also known as the key) of the tag.
        :param pulumi.Input[_builtins.str] value: Specifies the value of the tag.
        """
