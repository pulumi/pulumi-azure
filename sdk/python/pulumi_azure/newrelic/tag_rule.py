...
class TagRuleArgs:
    def __init__(__self__, *,
                 ...
                 azure_active_directory_log_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 log_tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input['TagRuleLogTagFilterArgs']]]] = None,
                 metric_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] monitor_id: Specifies the ID of the New Relic Monitor this Tag Rule should be created within. Changing this forces a new Azure Native New Relic Tag Rule to be created.
        :param pulumi.Input[builtins.bool] activity_log_enabled: Whether activity logs from Azure resources should be sent for the Monitor resource. Defaults to `false`.
        :param pulumi.Input[builtins.bool] azure_active_directory_log_enabled: Whether Azure Active Directory logs should be sent for the Monitor resource. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input['TagRuleLogTagFilterArgs']]] log_tag_filters: A `log_tag_filter` block as defined below.
        :param pulumi.Input[builtins.bool] metric_enabled: Whether metrics should be sent for the Monitor resource. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.bool] subscription_log_enabled: Whether subscription logs should be sent for the Monitor resource. Defaults to `false`.
        """
    ...
    def azure_active_directory_log_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def azure_active_directory_log_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def metric_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def metric_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TagRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            metric_tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TagRuleMetricTagFilterArgs', 'TagRuleMetricTagFilterArgsDict']]]]] = None,
            monitor_id: Optional[pulumi.Input[builtins.str]] = None,
            subscription_log_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'TagRule':
        """
    ...
    @property
    @pulumi.getter(name="azureActiveDirectoryLogEnabled")
    def azure_active_directory_log_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether Azure Active Directory logs should be sent for the Monitor resource. Defaults to `false`.
        """
        return pulumi.get(self, "azure_active_directory_log_enabled")
    ...
    @property
    @pulumi.getter(name="metricEnabled")
    def metric_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether metrics should be sent for the Monitor resource. Defaults to `false`.
        """
        return pulumi.get(self, "metric_enabled")
    ...
    @property
    @pulumi.getter(name="subscriptionLogEnabled")
    def subscription_log_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether subscription logs should be sent for the Monitor resource. Defaults to `false`.
        """
        return pulumi.get(self, "subscription_log_enabled")
