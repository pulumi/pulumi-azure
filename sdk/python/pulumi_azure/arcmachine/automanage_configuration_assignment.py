...
class AutomanageConfigurationAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] arc_machine_id: The ARM resource ID of the Arc Machine to assign the Automanage Configuration to. Changing this forces a new resource to be created.
    ...
    def arc_machine_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def arc_machine_id(self, value: pulumi.Input[_builtins.str]):
...
class AutomanageConfigurationAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            arc_machine_id: Optional[pulumi.Input[_builtins.str]] = None,
            configuration_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'AutomanageConfigurationAssignment':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="arcMachineId")
    def arc_machine_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ARM resource ID of the Arc Machine to assign the Automanage Configuration to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "arc_machine_id")
