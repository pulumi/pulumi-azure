...
class GetResult:
    ...
    def active_directory_fqdn(self) -> _builtins.str:
        """
    ...
    def client_public_key(self) -> _builtins.str:
        """
    ...
    def last_status_change_time(self) -> _builtins.str:
        """
    ...
    def mssql_discovered(self) -> _builtins.bool:
        """
    ...
    def parent_cluster_resource_id(self) -> _builtins.str:
        """
    ...
    def private_link_scope_resource_id(self) -> _builtins.str:
        """
        The resource id of the parent cluster (Azure HCI) this machine is assigned to, if any.
        """
...
def get(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.HybridCompute` - 2022-11-10
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Hybrid Compute exists.
    """
    __args__ = dict()
    __args__['name'] = name
