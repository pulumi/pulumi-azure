...
def get_placement_group(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Compute` - 2022-03-01
    ...
    :param _builtins.str resource_group_name: The name of the resource group in which the Proximity Placement Group exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_placement_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
