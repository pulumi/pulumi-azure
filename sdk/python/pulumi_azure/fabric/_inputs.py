...
class CapacitySkuArgs:
    def __init__(__self__, *,
                 ...
                 tier: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the SKU to use for the Fabric Capacity. Possible values are `F2`, `F4`, `F8`, `F16`, `F32`, `F64`, `F128`, `F256`, `F512`, `F1024`, `F2048`.
        :param pulumi.Input[builtins.str] tier: The tier of the SKU to use for the Fabric Capacity. The only possible value is `Fabric`.
        """
