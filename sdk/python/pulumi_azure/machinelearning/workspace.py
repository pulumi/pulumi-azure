...
class WorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 high_business_impact: Optional[pulumi.Input[builtins.bool]] = None,
                 image_build_compute_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 v1_legacy_mode_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Workspace resource.
        :param pulumi.Input[builtins.str] application_insights_id: The ID of the Application Insights associated with this Machine Learning Workspace. Changing this forces a new resource to be created.
        :param pulumi.Input['WorkspaceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] key_vault_id: The ID of key vault associated with this Machine Learning Workspace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group in which the Machine Learning Workspace should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account associated with this Machine Learning Workspace. Changing this forces a new resource to be created.
               
               > **Note:** The `account_tier` cannot be `Premium` in order to associate the Storage Account to this Machine Learning Workspace.
        :param pulumi.Input[builtins.str] container_registry_id: The ID of the container registry associated with this Machine Learning Workspace. Changing this forces a new resource to be created.
               
               > **Note:** The `admin_enabled` should be `true` in order to associate the Container Registry to this Machine Learning Workspace.
        :param pulumi.Input[builtins.str] description: The description of this Machine Learning Workspace.
        ...
        :param pulumi.Input[builtins.str] friendly_name: Display name for this Machine Learning Workspace.
        :param pulumi.Input[builtins.bool] high_business_impact: Flag to signal High Business Impact (HBI) data in the workspace and reduce diagnostic data collected by the service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] image_build_compute_name: The compute name for image build of the Machine Learning Workspace.
        :param pulumi.Input[builtins.str] kind: The type of the Workspace. Possible values are `Default`, `FeatureStore`. Defaults to `Default`
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the Machine Learning Workspace should exist. Changing this forces a new resource to be created.
        :param pulumi.Input['WorkspaceManagedNetworkArgs'] managed_network: A `managed_network` block as defined below.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Machine Learning Workspace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] primary_user_assigned_identity: The user assigned identity id that represents the workspace identity.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Enable public access when this Machine Learning Workspace is behind VNet. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] sku_name: SKU/edition of the Machine Learning Workspace, possible values are `Free`, `Basic`, `Standard` and `Premium`. Defaults to `Basic`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.bool] v1_legacy_mode_enabled: Enable V1 API features, enabling `v1_legacy_mode` may prevent you from using features provided by the v2 API. Defaults to `false`.
        """
    ...
    def high_business_impact(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def high_business_impact(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "high_business_impact", value)

    @property
    @pulumi.getter(name="imageBuildComputeName")
    def image_build_compute_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def image_build_compute_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def v1_legacy_mode_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def v1_legacy_mode_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _WorkspaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_registry_id: The ID of the container registry associated with this Machine Learning Workspace. Changing this forces a new resource to be created.
               ...
               > **Note:** The `admin_enabled` should be `true` in order to associate the Container Registry to this Machine Learning Workspace.
        :param pulumi.Input[builtins.str] description: The description of this Machine Learning Workspace.
        :param pulumi.Input[builtins.str] discovery_url: The url for the discovery service to identify regional endpoints for machine learning experimentation services.
        :param pulumi.Input['WorkspaceEncryptionArgs'] encryption: An `encryption` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input['WorkspaceFeatureStoreArgs'] feature_store: A `feature_store` block as defined below.
        :param pulumi.Input[builtins.str] friendly_name: Display name for this Machine Learning Workspace.
        :param pulumi.Input[builtins.bool] high_business_impact: Flag to signal High Business Impact (HBI) data in the workspace and reduce diagnostic data collected by the service. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.bool] v1_legacy_mode_enabled: Enable V1 API features, enabling `v1_legacy_mode` may prevent you from using features provided by the v2 API. Defaults to `false`.
        :param pulumi.Input[builtins.str] workspace_id: The immutable id associated with this workspace.
        """
...
class Workspace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="highBusinessImpact")
    def high_business_impact(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Flag to signal High Business Impact (HBI) data in the workspace and reduce diagnostic data collected by the service. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "high_business_impact")
    ...
    @property
    @pulumi.getter(name="imageBuildComputeName")
    def image_build_compute_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The compute name for image build of the Machine Learning Workspace.
        """
        return pulumi.get(self, "image_build_compute_name")
    ...
    @property
    @pulumi.getter(name="v1LegacyModeEnabled")
    def v1_legacy_mode_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable V1 API features, enabling `v1_legacy_mode` may prevent you from using features provided by the v2 API. Defaults to `false`.
        """
        return pulumi.get(self, "v1_legacy_mode_enabled")
