...
class WorkspaceNetworkOutboundRuleServiceTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Machine Learning Workspace Network Outbound Rule Service Tag. Changing this forces a new resource to be created.
        """
    ...
    def port_ranges(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @port_ranges.setter
    def port_ranges(self, value: pulumi.Input[_builtins.str]):
    ...
    def service_tag(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @service_tag.setter
    def service_tag(self, value: pulumi.Input[_builtins.str]):
...
class WorkspaceNetworkOutboundRuleServiceTag(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            protocol: Optional[pulumi.Input[_builtins.str]] = None,
            service_tag: Optional[pulumi.Input[_builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'WorkspaceNetworkOutboundRuleServiceTag':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="portRanges")
    def port_ranges(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies which ports traffic will be allowed by this rule. You can specify a single port (e.g. ` 80`) , a port range (e.g. `1024-655535`) or a comma-separated list of single ports and/or port ranges(e.g. `80,1024-655535`). `*` can be used to allow traffic on any port.
        """
        return pulumi.get(self, "port_ranges")
