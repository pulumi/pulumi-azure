...
class DatastoreBlobstorageArgs:
    def __init__(__self__, *,
                 ...
                 service_data_auth_identity: Optional[pulumi.Input[builtins.str]] = None,
                 shared_access_signature: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] account_key: The access key of the Storage Account. Conflicts with `shared_access_signature`.
        ...
        :param pulumi.Input[builtins.bool] is_default: Specifies whether this Machines Learning DataStore is the default for the Workspace. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] service_data_auth_identity: Specifies which identity to use when retrieving data from the specified source. Defaults to `None`. Possible values are `None`, `WorkspaceSystemAssignedIdentity` and `WorkspaceUserAssignedIdentity`.
        :param pulumi.Input[builtins.str] shared_access_signature: The Shared Access Signature of the Storage Account. Conflicts with `account_key`.
    ...
    def service_data_auth_identity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_data_auth_identity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_data_auth_identity", value)

    @property
    @pulumi.getter(name="sharedAccessSignature")
    def shared_access_signature(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shared_access_signature(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure:machinelearning/datastoreBlobstorage:DatastoreBlobstorage")
class DatastoreBlobstorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_container_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DatastoreBlobstorage':
        """
    ...
    @property
    @pulumi.getter(name="serviceDataAuthIdentity")
    def service_data_auth_identity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies which identity to use when retrieving data from the specified source. Defaults to `None`. Possible values are `None`, `WorkspaceSystemAssignedIdentity` and `WorkspaceUserAssignedIdentity`.
        """
        return pulumi.get(self, "service_data_auth_identity")
    ...
    @property
    @pulumi.getter(name="sharedAccessSignature")
    def shared_access_signature(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Shared Access Signature of the Storage Account. Conflicts with `account_key`.
