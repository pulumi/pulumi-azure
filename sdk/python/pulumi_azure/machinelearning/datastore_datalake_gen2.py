...
class DatastoreDatalakeGen2Args:
    def __init__(__self__, *,
                 ...
                 service_data_identity: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Machine Learning DataStore. Changing this forces a new Machine Learning DataStore to be created.
        :param pulumi.Input[_builtins.str] service_data_identity: Specifies which identity to use when retrieving data from the specified source. Defaults to `None`. Possible values are `None`, `WorkspaceSystemAssignedIdentity` and `WorkspaceUserAssignedIdentity`.
        ...
        :param pulumi.Input[_builtins.str] tenant_id: The ID of the Tenant which the Service Principal belongs to.
        """
    ...
    def service_data_identity(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def service_data_identity(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _DatastoreDatalakeGen2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] client_secret: The secret of the Service Principal.
        :param pulumi.Input[_builtins.str] description: Text used to describe the asset. Changing this forces a new Machine Learning DataStore to be created.
        :param pulumi.Input[_builtins.bool] is_default: Indicates whether this Machines Learning DataStore is the default for the Workspace.
        :param pulumi.Input[_builtins.str] name: The name of the Machine Learning DataStore. Changing this forces a new Machine Learning DataStore to be created.
        :param pulumi.Input[_builtins.str] service_data_identity: Specifies which identity to use when retrieving data from the specified source. Defaults to `None`. Possible values are `None`, `WorkspaceSystemAssignedIdentity` and `WorkspaceUserAssignedIdentity`.
        :param pulumi.Input[_builtins.str] storage_container_id: The ID of the Storage Account Container. Changing this forces a new Machine Learning DataStore to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Machine Learning DataStore. Changing this forces a new Machine Learning DataStore to be created.
...
class DatastoreDatalakeGen2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tenant_id: Optional[pulumi.Input[_builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'DatastoreDatalakeGen2':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="authorityUrl")
    def authority_url(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        An URL used for authentication.
        """
        return pulumi.get(self, "authority_url")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceDataIdentity")
    def service_data_identity(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies which identity to use when retrieving data from the specified source. Defaults to `None`. Possible values are `None`, `WorkspaceSystemAssignedIdentity` and `WorkspaceUserAssignedIdentity`.
        """
        return pulumi.get(self, "service_data_identity")
