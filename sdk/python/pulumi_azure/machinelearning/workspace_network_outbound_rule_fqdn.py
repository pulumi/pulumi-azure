...
class WorkspaceNetworkOutboundRuleFqdnArgs:
    def __init__(__self__, *,
                 destination_fqdn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] destination_fqdn: Specifies the fully qualified domain name to allow for outbound traffic.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Machine Learning Workspace FQDN Network Outbound Rule. Changing this forces a new resource to be created.
        """
    ...
    def destination_fqdn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_fqdn(self, value: pulumi.Input[builtins.str]):
...
class _WorkspaceNetworkOutboundRuleFqdnState:
    def __init__(__self__, *,
                 destination_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="destinationFqdn")
    def destination_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the fully qualified domain name to allow for outbound traffic.
        """
        return pulumi.get(self, "destination_fqdn")
    ...
    @destination_fqdn.setter
    def destination_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_fqdn", value)
...
class WorkspaceNetworkOutboundRuleFqdn(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            destination_fqdn: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceNetworkOutboundRuleFqdn':
        """
    ...
    @property
    @pulumi.getter(name="destinationFqdn")
    def destination_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the fully qualified domain name to allow for outbound traffic.
        """
        return pulumi.get(self, "destination_fqdn")
