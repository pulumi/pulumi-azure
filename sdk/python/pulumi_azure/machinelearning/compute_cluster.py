...
class ComputeClusterArgs:
    def __init__(__self__, *,
                 ...
                 vm_priority: pulumi.Input[builtins.str],
                 ...
                 ssh_public_access_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] machine_learning_workspace_id: The ID of the Machine Learning Workspace. Changing this forces a new Machine Learning Compute Cluster to be created.
        ...
        :param pulumi.Input[builtins.str] vm_priority: The priority of the VM. Changing this forces a new Machine Learning Compute Cluster to be created. Accepted values are `Dedicated` and `LowPriority`.
        :param pulumi.Input[builtins.str] vm_size: The size of the VM. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.str] description: The description of the Machine Learning compute. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input['ComputeClusterIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.bool] local_auth_enabled: Whether local authentication methods is enabled. Defaults to `true`. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Machine Learning Compute Cluster should exist. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Machine Learning Compute Cluster. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.bool] node_public_ip_enabled: Whether the compute cluster will have a public ip. Defaults to `true`. Changing this forces a new Machine Learning Compute Cluster to be created.
        ...
        :param pulumi.Input[builtins.bool] ssh_public_access_enabled: A boolean value indicating whether enable the public SSH port. Defaults to `false`. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.str] subnet_resource_id: The ID of the Subnet that the Compute Cluster should reside in. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Machine Learning Compute Cluster. Changing this forces a new Machine Learning Compute Cluster to be created.
        """
    ...
    def vm_priority(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @vm_priority.setter
    def vm_priority(self, value: pulumi.Input[builtins.str]):
    ...
    def ssh_public_access_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ssh_public_access_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ComputeClusterState:
    def __init__(__self__, *,
                 ...
                 subnet_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 vm_priority: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="vmPriority")
    def vm_priority(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The priority of the VM. Changing this forces a new Machine Learning Compute Cluster to be created. Accepted values are `Dedicated` and `LowPriority`.
        """
        return pulumi.get(self, "vm_priority")
    ...
    @vm_priority.setter
    def vm_priority(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vm_priority", value)
...
class ComputeCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vm_priority: Optional[pulumi.Input[builtins.str]] = None,
            vm_size: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeCluster':
        """
    ...
    @property
    @pulumi.getter(name="sshPublicAccessEnabled")
    def ssh_public_access_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean value indicating whether enable the public SSH port. Defaults to `false`. Changing this forces a new Machine Learning Compute Cluster to be created.
        """
        return pulumi.get(self, "ssh_public_access_enabled")
    ...
    @property
    @pulumi.getter(name="subnetResourceId")
    def subnet_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Subnet that the Compute Cluster should reside in. Changing this forces a new Machine Learning Compute Cluster to be created.
        """
        return pulumi.get(self, "subnet_resource_id")
    ...
    @property
    @pulumi.getter(name="vmPriority")
    def vm_priority(self) -> pulumi.Output[builtins.str]:
        """
        The priority of the VM. Changing this forces a new Machine Learning Compute Cluster to be created. Accepted values are `Dedicated` and `LowPriority`.
        """
        return pulumi.get(self, "vm_priority")
