...
class DatastoreFileshareArgs:
    def __init__(__self__, *,
                 storage_fileshare_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] storage_fileshare_id: The ID of the Storage Account File Share. Changing this forces a new Machine Learning DataStore to be created.
    ...
    def storage_fileshare_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def storage_fileshare_id(self, value: pulumi.Input[builtins.str]):
...
class _DatastoreFileshareState:
    def __init__(__self__, *,
                 ...
                 service_data_identity: Optional[pulumi.Input[builtins.str]] = None,
                 shared_access_signature: Optional[pulumi.Input[builtins.str]] = None,
                 storage_fileshare_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] account_key: The access key of the Storage Account. Conflicts with `shared_access_signature`.
        :param pulumi.Input[builtins.str] description: Text used to describe the asset. Changing this forces a new Machine Learning DataStore to be created.
        :param pulumi.Input[builtins.bool] is_default: Indicate whether this Machines Learning DataStore is the default for the Workspace.
        :param pulumi.Input[builtins.str] name: The name of the Machine Learning DataStore. Changing this forces a new Machine Learning DataStore to be created.
        :param pulumi.Input[builtins.str] service_data_identity: Specifies which identity to use when retrieving data from the specified source. Defaults to `None`. Possible values are `None`, `WorkspaceSystemAssignedIdentity` and `WorkspaceUserAssignedIdentity`.
        :param pulumi.Input[builtins.str] shared_access_signature: The Shared Access Signature of the Storage Account. Conflicts with `account_key`.
        :param pulumi.Input[builtins.str] storage_fileshare_id: The ID of the Storage Account File Share. Changing this forces a new Machine Learning DataStore to be created.
    ...
    @property
    @pulumi.getter(name="storageFileshareId")
    def storage_fileshare_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Storage Account File Share. Changing this forces a new Machine Learning DataStore to be created.
        """
        return pulumi.get(self, "storage_fileshare_id")
    ...
    @storage_fileshare_id.setter
    def storage_fileshare_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_fileshare_id", value)
...
class DatastoreFileshare(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_fileshare_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DatastoreFileshare':
        """
    ...
    @property
    @pulumi.getter(name="storageFileshareId")
    def storage_fileshare_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Storage Account File Share. Changing this forces a new Machine Learning DataStore to be created.
        """
        return pulumi.get(self, "storage_fileshare_id")
