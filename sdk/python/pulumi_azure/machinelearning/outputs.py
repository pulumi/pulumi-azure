...
class ComputeClusterIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Compute Cluster. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Compute Cluster. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param builtins.str principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Cluster.
        :param builtins.str tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Cluster.
        """
...
class ComputeClusterScaleSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_node_count: Maximum node count. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param builtins.int min_node_count: Minimal node count. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param builtins.str scale_down_nodes_after_idle_duration: Node Idle Time Before Scale Down: defines the time until the compute is shutdown when it has gone into Idle state. Is defined according to W3C XML schema standard for duration. Changing this forces a new Machine Learning Compute Cluster to be created.
        """
...
class ComputeClusterSsh(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_value: Optional[builtins.str] = None):
        """
        :param builtins.str admin_username: Name of the administrator user account which can be used to SSH to nodes. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param builtins.str admin_password: Password of the administrator user account. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param builtins.str key_value: SSH public key of the administrator user account. Changing this forces a new Machine Learning Compute Cluster to be created.
    ...
    def key_value(self) -> Optional[builtins.str]:
        """
...
class ComputeInstanceAssignToUser(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str object_id: User’s AAD Object Id.
        :param builtins.str tenant_id: User’s AAD Tenant Id.
        """
...
class ComputeInstanceIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Compute Instance. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Compute Instance. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param builtins.str principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Instance.
        :param builtins.str tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Instance.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ComputeInstanceSsh(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str public_key: Specifies the SSH rsa public key file as a string. Use "ssh-keygen -t rsa -b 2048" to generate your SSH key pairs.
        :param builtins.int port: Describes the port for connecting through SSH.
        :param builtins.str username: The admin username of this Machine Learning Compute Instance.
        """
...
class InferenceClusterIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Inference Cluster. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Inference Cluster. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param builtins.str principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Inference Cluster.
        :param builtins.str tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Inference Cluster.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class InferenceClusterSsl(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cert: The certificate for the SSL configuration.Conflicts with `ssl[0].leaf_domain_label`,`ssl[0].overwrite_existing_domain`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param builtins.str cname: The cname of the SSL configuration.Conflicts with `ssl[0].leaf_domain_label`,`ssl[0].overwrite_existing_domain`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param builtins.str key: The key content for the SSL configuration.Conflicts with `ssl[0].leaf_domain_label`,`ssl[0].overwrite_existing_domain`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param builtins.str leaf_domain_label: The leaf domain label for the SSL configuration. Conflicts with `ssl[0].cert`,`ssl[0].key`,`ssl[0].cname`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param builtins.bool overwrite_existing_domain: Whether or not to overwrite existing leaf domain. Conflicts with `ssl[0].cert`,`ssl[0].key`,`ssl[0].cname` Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        """
        if cert is not None:
...
class SynapseSparkIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Synapse Spark. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Synapse Spark. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param builtins.str principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Synapse Spark.
        :param builtins.str tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Synapse Spark.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class WorkspaceEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_id: The Key Vault URI to access the encryption key.
        :param builtins.str key_vault_id: The ID of the keyVault where the customer owned encryption key is present.
        :param builtins.str user_assigned_identity_id: The Key Vault URI to access the encryption key.
...
class WorkspaceFeatureStore(dict):
    ...
    def __init__(__self__, *,
                 computer_spark_runtime_version: Optional[builtins.str] = None,
                 offline_connection_name: Optional[builtins.str] = None,
                 online_connection_name: Optional[builtins.str] = None):
        """
        :param builtins.str computer_spark_runtime_version: The version of Spark runtime.
        :param builtins.str offline_connection_name: The name of offline store connection.
        :param builtins.str online_connection_name: The name of online store connection.
    ...
    def computer_spark_runtime_version(self) -> Optional[builtins.str]:
        """
    ...
    def offline_connection_name(self) -> Optional[builtins.str]:
        """
    ...
    def online_connection_name(self) -> Optional[builtins.str]:
        """
...
class WorkspaceIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Workspace. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Workspace.
...
class WorkspaceManagedNetwork(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str isolation_mode: The isolation mode of the Machine Learning Workspace. Possible values are `Disabled`, `AllowOnlyApprovedOutbound`, and `AllowInternetOutbound`
        """
...
class WorkspaceServerlessCompute(dict):
    ...
    def __init__(__self__, *,
                 public_ip_enabled: Optional[builtins.bool] = None,
                 subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.bool public_ip_enabled: Should serverless compute nodes deployed in a custom Virtual Network have public IP addresses enabled for a workspace with private endpoint? Defaults to `false`.
        ...
        :param builtins.str subnet_id: The ID of an existing Virtual Network Subnet in which the serverless compute nodes should be deployed to.
        """
    ...
    def public_ip_enabled(self) -> Optional[builtins.bool]:
        """
...
class GetWorkspaceIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: A list of User Assigned Identity IDs assigned to this Machine Learning Workspace.
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Identity assigned to this Machine Learning Workspace.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Identity assigned to this Machine Learning Workspace.
        :param builtins.str type: The Type of Managed Identity assigned to this Machine Learning Workspace.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
