...
class WorkspaceNetworkOutboundRulePrivateEndpointArgs:
    def __init__(__self__, *,
                 service_resource_id: pulumi.Input[builtins.str],
                 sub_resource_target: pulumi.Input[builtins.str],
                 workspace_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 spark_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    def service_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "service_resource_id", value)

    @property
    @pulumi.getter(name="subResourceTarget")
    def sub_resource_target(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sub_resource_target(self, value: pulumi.Input[builtins.str]):
    ...
    def spark_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def spark_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _WorkspaceNetworkOutboundRulePrivateEndpointState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 service_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 spark_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sub_resource_target: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="serviceResourceId")
    def service_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Service Resource ID to connect. Changing this forces a new resource to be created.
    ...
    @service_resource_id.setter
    def service_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_resource_id", value)
    ...
    @property
    @pulumi.getter(name="subResourceTarget")
    def sub_resource_target(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Sub Resource of the service resource to connect to. Possible values are `vault`,`amlworkspace`,`blob`,`table`,`queue`,`file`,`web`,`dfs`, `redisCache`. Changing this forces a new resource to be created.
    ...
    @sub_resource_target.setter
    def sub_resource_target(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sub_resource_target", value)
...
@pulumi.type_token("azure:machinelearning/workspaceNetworkOutboundRulePrivateEndpoint:WorkspaceNetworkOutboundRulePrivateEndpoint")
class WorkspaceNetworkOutboundRulePrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            spark_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            sub_resource_target: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceNetworkOutboundRulePrivateEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="serviceResourceId")
    def service_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Service Resource ID to connect. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="sparkEnabled")
    def spark_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable an additional private endpoint to be used by jobs running on Spark. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "spark_enabled")
    ...
    @property
    @pulumi.getter(name="subResourceTarget")
    def sub_resource_target(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Sub Resource of the service resource to connect to. Possible values are `vault`,`amlworkspace`,`blob`,`table`,`queue`,`file`,`web`,`dfs`, `redisCache`. Changing this forces a new resource to be created.
