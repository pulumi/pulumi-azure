...
class InferenceClusterSslArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] overwrite_existing_domain: Whether or not to overwrite existing leaf domain. Conflicts with `ssl[0].cert`,`ssl[0].key`,`ssl[0].cname` Changing this forces a new Machine Learning Inference Cluster to be created.
        """
        if cert is not None:
