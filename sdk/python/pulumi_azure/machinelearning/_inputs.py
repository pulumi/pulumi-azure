...
class ComputeClusterIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Compute Cluster. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Compute Cluster. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Cluster.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Cluster.
        """
...
if not MYPY:
    class ComputeClusterScaleSettingsArgsDict(TypedDict):
        ...
        """
        scale_down_nodes_after_idle_duration: pulumi.Input[builtins.str]
        """
...
class ComputeClusterScaleSettingsArgs:
    def __init__(__self__, *,
                 ...
                 scale_down_nodes_after_idle_duration: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] max_node_count: Maximum node count. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.int] min_node_count: Minimal node count. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.str] scale_down_nodes_after_idle_duration: Node Idle Time Before Scale Down: defines the time until the compute is shutdown when it has gone into Idle state. Is defined according to W3C XML schema standard for duration. Changing this forces a new Machine Learning Compute Cluster to be created.
        """
    ...
    def scale_down_nodes_after_idle_duration(self) -> pulumi.Input[builtins.str]:
        """
        Node Idle Time Before Scale Down: defines the time until the compute is shutdown when it has gone into Idle state. Is defined according to W3C XML schema standard for duration. Changing this forces a new Machine Learning Compute Cluster to be created.
        """
    ...
    def scale_down_nodes_after_idle_duration(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ComputeClusterSshArgsDict(TypedDict):
        ...
        """
        key_value: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ComputeClusterSshArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] admin_username: Name of the administrator user account which can be used to SSH to nodes. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.str] admin_password: Password of the administrator user account. Changing this forces a new Machine Learning Compute Cluster to be created.
        :param pulumi.Input[builtins.str] key_value: SSH public key of the administrator user account. Changing this forces a new Machine Learning Compute Cluster to be created.
...
class ComputeInstanceAssignToUserArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] object_id: User’s AAD Object Id.
        :param pulumi.Input[builtins.str] tenant_id: User’s AAD Tenant Id.
        """
...
class ComputeInstanceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Compute Instance. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Compute Instance. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Instance.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Compute Instance.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ComputeInstanceSshArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] public_key: Specifies the SSH rsa public key file as a string. Use "ssh-keygen -t rsa -b 2048" to generate your SSH key pairs.
        :param pulumi.Input[builtins.int] port: Describes the port for connecting through SSH.
        :param pulumi.Input[builtins.str] username: The admin username of this Machine Learning Compute Instance.
        """
...
class InferenceClusterIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Inference Cluster. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Inference Cluster. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Inference Cluster.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Inference Cluster.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
if not MYPY:
    class InferenceClusterSslArgsDict(TypedDict):
        ...
        """
        leaf_domain_label: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        overwrite_existing_domain: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class InferenceClusterSslArgs:
    def __init__(__self__, *,
                 ...
                 leaf_domain_label: Optional[pulumi.Input[builtins.str]] = None,
                 overwrite_existing_domain: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] cert: The certificate for the SSL configuration.Conflicts with `ssl[0].leaf_domain_label`,`ssl[0].overwrite_existing_domain`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param pulumi.Input[builtins.str] cname: The cname of the SSL configuration.Conflicts with `ssl[0].leaf_domain_label`,`ssl[0].overwrite_existing_domain`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param pulumi.Input[builtins.str] key: The key content for the SSL configuration.Conflicts with `ssl[0].leaf_domain_label`,`ssl[0].overwrite_existing_domain`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param pulumi.Input[builtins.str] leaf_domain_label: The leaf domain label for the SSL configuration. Conflicts with `ssl[0].cert`,`ssl[0].key`,`ssl[0].cname`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        :param pulumi.Input[builtins.bool] overwrite_existing_domain: Whether or not to overwrite existing leaf domain. Conflicts with `ssl[0].cert`,`ssl[0].key`,`ssl[0].cname` Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        """
        if cert is not None:
    ...
    def leaf_domain_label(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The leaf domain label for the SSL configuration. Conflicts with `ssl[0].cert`,`ssl[0].key`,`ssl[0].cname`. Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        """
    ...
    def leaf_domain_label(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "leaf_domain_label", value)

    @property
    @pulumi.getter(name="overwriteExistingDomain")
    def overwrite_existing_domain(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether or not to overwrite existing leaf domain. Conflicts with `ssl[0].cert`,`ssl[0].key`,`ssl[0].cname` Changing this forces a new Machine Learning Inference Cluster to be created. Defaults to `""`.
        """
    ...
    def overwrite_existing_domain(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SynapseSparkIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Synapse Spark. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both). Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Synapse Spark. Changing this forces a new resource to be created.
               
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Synapse Spark.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Machine Learning Synapse Spark.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class WorkspaceEncryptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_vault_id: The ID of the keyVault where the customer owned encryption key is present.
        :param pulumi.Input[builtins.str] user_assigned_identity_id: The Key Vault URI to access the encryption key.
...
if not MYPY:
    class WorkspaceFeatureStoreArgsDict(TypedDict):
        computer_spark_runtime_version: NotRequired[pulumi.Input[builtins.str]]
        """
        The version of Spark runtime.
        """
        offline_connection_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of offline store connection.
        """
        online_connection_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class WorkspaceFeatureStoreArgs:
    def __init__(__self__, *,
                 computer_spark_runtime_version: Optional[pulumi.Input[builtins.str]] = None,
                 offline_connection_name: Optional[pulumi.Input[builtins.str]] = None,
                 online_connection_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] computer_spark_runtime_version: The version of Spark runtime.
        :param pulumi.Input[builtins.str] offline_connection_name: The name of offline store connection.
        :param pulumi.Input[builtins.str] online_connection_name: The name of online store connection.
    ...
    def computer_spark_runtime_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version of Spark runtime.
        """
    ...
    def computer_spark_runtime_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "computer_spark_runtime_version", value)

    @property
    @pulumi.getter(name="offlineConnectionName")
    def offline_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of offline store connection.
        """
    ...
    def offline_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "offline_connection_name", value)

    @property
    @pulumi.getter(name="onlineConnectionName")
    def online_connection_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of online store connection.
    ...
    def online_connection_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkspaceIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Machine Learning Workspace. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Machine Learning Workspace.
...
class WorkspaceManagedNetworkArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] isolation_mode: The isolation mode of the Machine Learning Workspace. Possible values are `Disabled`, `AllowOnlyApprovedOutbound`, and `AllowInternetOutbound`
        """
...
if not MYPY:
    class WorkspaceServerlessComputeArgsDict(TypedDict):
        public_ip_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class WorkspaceServerlessComputeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] public_ip_enabled: Should serverless compute nodes deployed in a custom Virtual Network have public IP addresses enabled for a workspace with private endpoint? Defaults to `false`.
               
               > **Note:** `public_ip_enabled` cannot be updated from `true` to `false` when `subnet_id` is not set. `public_ip_enabled` must be set to `true` if `subnet_id` is not set and when `public_network_access_enabled` is `false`.
        :param pulumi.Input[builtins.str] subnet_id: The ID of an existing Virtual Network Subnet in which the serverless compute nodes should be deployed to.
        """
