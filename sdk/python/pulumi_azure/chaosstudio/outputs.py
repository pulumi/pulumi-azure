...
class ExperimentSelector(dict):
    ...
    def __init__(__self__, *,
                 chaos_studio_target_ids: Sequence[builtins.str],
                 name: builtins.str):
        """
        :param Sequence[builtins.str] chaos_studio_target_ids: A list of Chaos Studio Target IDs that should be part of this Selector.
        :param builtins.str name: The name of this Selector.
        """
    ...
    def chaos_studio_target_ids(self) -> Sequence[builtins.str]:
        """
...
class ExperimentStep(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the Step.
        """
...
class ExperimentStepBranchAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 selector_name: Optional[builtins.str] = None,
                 urn: Optional[builtins.str] = None):
        """
        :param builtins.str action_type: The type of action that should be added to the experiment. Possible values are `continuous`, `delay` and `discrete`.
        :param builtins.str duration: An ISO8601 formatted string specifying the duration for a `delay` or `continuous` action.
        :param Mapping[str, builtins.str] parameters: A key-value map of additional parameters to configure the action. The values that are accepted by this depend on the `urn` i.e. the capability/fault that is applied. Possible parameter values can be found in this [documentation](https://learn.microsoft.com/azure/chaos-studio/chaos-studio-fault-library)
        :param builtins.str selector_name: The name of the Selector to which this action should apply to. This must be specified if the `action_type` is `continuous` or `discrete`.
        :param builtins.str urn: The Unique Resource Name of the action, this value is provided by the `chaosstudio.Capability` resource e.g. `azurerm_chaos_studio_capability.example.urn`. This must be specified if the `action_type` is `continuous` or `discrete`.
        """
    ...
    def selector_name(self) -> Optional[builtins.str]:
        """
