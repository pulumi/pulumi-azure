...
class CapabilityArgs:
    def __init__(__self__, *,
                 capability_type: pulumi.Input[builtins.str],
                 chaos_studio_target_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a Capability resource.
        :param pulumi.Input[builtins.str] capability_type: The capability that should be applied to the Chaos Studio Target. For supported values please see this Chaos Studio [Fault Library](https://learn.microsoft.com/azure/chaos-studio/chaos-studio-fault-library). Changing this forces a new Chaos Studio Capability to be created.
        :param pulumi.Input[builtins.str] chaos_studio_target_id: The Chaos Studio Target that the capability should be applied to. Changing this forces a new Chaos Studio Capability to be created.
        """
    ...
    def capability_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def capability_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "capability_type", value)

    @property
    @pulumi.getter(name="chaosStudioTargetId")
    def chaos_studio_target_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def chaos_studio_target_id(self, value: pulumi.Input[builtins.str]):
...
class _CapabilityState:
    def __init__(__self__, *,
                 capability_type: Optional[pulumi.Input[builtins.str]] = None,
                 capability_urn: Optional[pulumi.Input[builtins.str]] = None,
                 chaos_studio_target_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Capability resources.
        :param pulumi.Input[builtins.str] capability_type: The capability that should be applied to the Chaos Studio Target. For supported values please see this Chaos Studio [Fault Library](https://learn.microsoft.com/azure/chaos-studio/chaos-studio-fault-library). Changing this forces a new Chaos Studio Capability to be created.
        :param pulumi.Input[builtins.str] capability_urn: The Unique Resource Name of the Capability.
        :param pulumi.Input[builtins.str] chaos_studio_target_id: The Chaos Studio Target that the capability should be applied to. Changing this forces a new Chaos Studio Capability to be created.
        """
    ...
    @property
    @pulumi.getter(name="capabilityType")
    def capability_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The capability that should be applied to the Chaos Studio Target. For supported values please see this Chaos Studio [Fault Library](https://learn.microsoft.com/azure/chaos-studio/chaos-studio-fault-library). Changing this forces a new Chaos Studio Capability to be created.
        """
        return pulumi.get(self, "capability_type")
    ...
    @capability_type.setter
    def capability_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "capability_type", value)

    @property
    @pulumi.getter(name="capabilityUrn")
    def capability_urn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def capability_urn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "capability_urn", value)

    @property
    @pulumi.getter(name="chaosStudioTargetId")
    def chaos_studio_target_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Chaos Studio Target that the capability should be applied to. Changing this forces a new Chaos Studio Capability to be created.
        """
        return pulumi.get(self, "chaos_studio_target_id")
    ...
    @chaos_studio_target_id.setter
    def chaos_studio_target_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chaos_studio_target_id", value)
...
class Capability(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            capability_type: Optional[pulumi.Input[builtins.str]] = None,
            capability_urn: Optional[pulumi.Input[builtins.str]] = None,
            chaos_studio_target_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Capability':
        """
    ...
    @property
    @pulumi.getter(name="capabilityType")
    def capability_type(self) -> pulumi.Output[builtins.str]:
        """
        The capability that should be applied to the Chaos Studio Target. For supported values please see this Chaos Studio [Fault Library](https://learn.microsoft.com/azure/chaos-studio/chaos-studio-fault-library). Changing this forces a new Chaos Studio Capability to be created.
        """
        return pulumi.get(self, "capability_type")
    ...
    @property
    @pulumi.getter(name="capabilityUrn")
    def capability_urn(self) -> pulumi.Output[builtins.str]:
        """
        The Unique Resource Name of the Capability.
        """
        return pulumi.get(self, "capability_urn")
    ...
    @property
    @pulumi.getter(name="chaosStudioTargetId")
    def chaos_studio_target_id(self) -> pulumi.Output[builtins.str]:
        """
        The Chaos Studio Target that the capability should be applied to. Changing this forces a new Chaos Studio Capability to be created.
        """
        return pulumi.get(self, "chaos_studio_target_id")
