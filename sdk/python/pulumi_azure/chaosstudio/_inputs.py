...
if not MYPY:
    class ExperimentSelectorArgsDict(TypedDict):
        chaos_studio_target_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]
        """
...
class ExperimentSelectorArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] chaos_studio_target_ids: A list of Chaos Studio Target IDs that should be part of this Selector.
        :param pulumi.Input[_builtins.str] name: The name of this Selector.
        """
    ...
    def chaos_studio_target_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of Chaos Studio Target IDs that should be part of this Selector.
        """
    ...
    def chaos_studio_target_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class ExperimentStepArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Step.
        """
...
class ExperimentStepBranchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the branch.
        """
...
class ExperimentStepBranchActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] parameters: A key-value map of additional parameters to configure the action. The values that are accepted by this depend on the `urn` i.e. the capability/fault that is applied. Possible parameter values can be found in this [documentation](https://learn.microsoft.com/azure/chaos-studio/chaos-studio-fault-library)
        :param pulumi.Input[_builtins.str] selector_name: The name of the Selector to which this action should apply to. This must be specified if the `action_type` is `continuous` or `discrete`.
        :param pulumi.Input[_builtins.str] urn: The Unique Resource Name of the action, this value is provided by the `chaosstudio.Capability` resource e.g. `azurerm_chaos_studio_capability.example.urn`. This must be specified if the `action_type` is `continuous` or `discrete`.
        """
