...
if not MYPY:
    class ExperimentSelectorArgsDict(TypedDict):
        chaos_studio_target_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ExperimentSelectorArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] chaos_studio_target_ids: A list of Chaos Studio Target IDs that should be part of this Selector.
        :param pulumi.Input[builtins.str] name: The name of this Selector.
        """
    ...
    def chaos_studio_target_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of Chaos Studio Target IDs that should be part of this Selector.
        """
    ...
    def chaos_studio_target_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ExperimentStepArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Step.
        """
...
class ExperimentStepBranchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the branch.
        """
...
if not MYPY:
    class ExperimentStepBranchActionArgsDict(TypedDict):
        ...
        """
        selector_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExperimentStepBranchActionArgs:
    def __init__(__self__, *,
                 ...
                 selector_name: Optional[pulumi.Input[builtins.str]] = None,
                 urn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] action_type: The type of action that should be added to the experiment. Possible values are `continuous`, `delay` and `discrete`.
        :param pulumi.Input[builtins.str] duration: An ISO8601 formatted string specifying the duration for a `delay` or `continuous` action.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: A key-value map of additional parameters to configure the action. The values that are accepted by this depend on the `urn` i.e. the capability/fault that is applied. Possible parameter values can be found in this [documentation](https://learn.microsoft.com/azure/chaos-studio/chaos-studio-fault-library)
        :param pulumi.Input[builtins.str] selector_name: The name of the Selector to which this action should apply to. This must be specified if the `action_type` is `continuous` or `discrete`.
        :param pulumi.Input[builtins.str] urn: The Unique Resource Name of the action, this value is provided by the `chaosstudio.Capability` resource e.g. `azurerm_chaos_studio_capability.example.urn`. This must be specified if the `action_type` is `continuous` or `discrete`.
        """
    ...
    def selector_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Selector to which this action should apply to. This must be specified if the `action_type` is `continuous` or `discrete`.
        """
    ...
    def selector_name(self, value: Optional[pulumi.Input[builtins.str]]):
