...
class FirewallPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Is the policy a enabled state or disabled state. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] mode: The firewall policy mode. Possible values are `Detection`, `Prevention`. Defaults to `Prevention`.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Web Application Firewall Policy.
        """
...
class _FirewallPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyCustomRuleArgs']]] custom_rules: One or more `custom_rule` blocks as defined below.
        :param pulumi.Input[builtins.bool] enabled: Is the policy a enabled state or disabled state. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] frontend_endpoint_ids: The Frontend Endpoints associated with this Front Door Web Application Firewall policy.
        :param pulumi.Input[builtins.str] location: The Azure Region where this Front Door Firewall Policy exists.
        :param pulumi.Input[Sequence[pulumi.Input['FirewallPolicyManagedRuleArgs']]] managed_rules: One or more `managed_rule` blocks as defined below.
        :param pulumi.Input[builtins.str] mode: The firewall policy mode. Possible values are `Detection`, `Prevention`. Defaults to `Prevention`.
        :param pulumi.Input[builtins.str] name: The name of the policy. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] redirect_url: If action type is redirect, this field represents redirect URL for the client.
...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            redirect_url: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'FirewallPolicy':
        """
