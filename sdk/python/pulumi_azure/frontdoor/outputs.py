...
class CustomHttpsConfigurationCustomHttpsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 azure_key_vault_certificate_secret_name: Optional[builtins.str] = None,
                 azure_key_vault_certificate_secret_version: Optional[builtins.str] = None,
                 azure_key_vault_certificate_vault_id: Optional[builtins.str] = None,
                 ...
                 provisioning_substate: Optional[builtins.str] = None):
        """
        :param builtins.str azure_key_vault_certificate_secret_name: The name of the Key Vault secret representing the full certificate PFX.
        :param builtins.str azure_key_vault_certificate_secret_version: The version of the Key Vault secret representing the full certificate PFX.
        ...
        :param builtins.str azure_key_vault_certificate_vault_id: The ID of the Key Vault containing the SSL certificate.
        :param builtins.str certificate_source: Certificate source to encrypted `HTTPS` traffic with. Allowed values are `FrontDoor` or `AzureKeyVault`. Defaults to `FrontDoor`.
               
               The following attributes are only valid if `certificate_source` is set to `AzureKeyVault`:
        :param builtins.str minimum_tls_version: Minimum client TLS version supported.
        """
    ...
    def azure_key_vault_certificate_secret_name(self) -> Optional[builtins.str]:
        """
    ...
    def azure_key_vault_certificate_secret_version(self) -> Optional[builtins.str]:
        """
    ...
    def azure_key_vault_certificate_vault_id(self) -> Optional[builtins.str]:
        """
    ...
    def provisioning_substate(self) -> Optional[builtins.str]:
...
class FirewallPolicyCustomRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to perform when the rule is matched. Possible values are `Allow`, `Block`, `Log`, or `Redirect`.
        :param builtins.str name: Gets name of the resource that is unique within a policy. This name can be used to access the resource.
        :param builtins.str type: The type of rule. Possible values are `MatchRule` or `RateLimitRule`.
        :param builtins.bool enabled: Is the rule is enabled or disabled? Defaults to `true`.
        ...
        :param builtins.int priority: The priority of the rule. Rules with a lower value will be evaluated before rules with a higher value. Defaults to `1`.
        :param builtins.int rate_limit_duration_in_minutes: The rate limit duration in minutes. Defaults to `1`.
        :param builtins.int rate_limit_threshold: The rate limit threshold. Defaults to `10`.
        """
...
class FirewallPolicyCustomRuleMatchCondition(dict):
    ...
    def __init__(__self__, *,
                 match_values: Sequence[builtins.str],
                 match_variable: builtins.str,
                 operator: builtins.str,
                 negation_condition: Optional[builtins.bool] = None,
                 selector: Optional[builtins.str] = None,
                 transforms: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] match_values: Up to `600` possible values to match. Limit is in total across all `match_condition` blocks and `match_values` arguments. String value itself can be up to `256` characters long.
        :param builtins.str match_variable: The request variable to compare with. Possible values are `Cookies`, `PostArgs`, `QueryString`, `RemoteAddr`, `RequestBody`, `RequestHeader`, `RequestMethod`, `RequestUri`, or `SocketAddr`.
        :param builtins.str operator: Comparison type to use for matching with the variable value. Possible values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GeoMatch`, `GreaterThan`, `GreaterThanOrEqual`, `IPMatch`, `LessThan`, `LessThanOrEqual` or `RegEx`.
        :param builtins.bool negation_condition: Should the result of the condition be negated.
        :param builtins.str selector: Match against a specific key if the `match_variable` is `QueryString`, `PostArgs`, `RequestHeader` or `Cookies`.
        :param Sequence[builtins.str] transforms: Up to `5` transforms to apply. Possible values are `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `URLDecode` or`URLEncode`.
        """
    ...
    def match_values(self) -> Sequence[builtins.str]:
        """
    ...
    def negation_condition(self) -> Optional[builtins.bool]:
        """
...
class FirewallPolicyManagedRule(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The name of the managed rule to use with this resource.
        :param builtins.str version: The version on the managed rule to use with this resource.
...
class FirewallPolicyManagedRuleExclusion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str match_variable: The variable type to be excluded. Possible values are `QueryStringArgNames`, `RequestBodyPostArgNames`, `RequestCookieNames`, `RequestHeaderNames`.
        :param builtins.str operator: Comparison operator to apply to the selector when specifying which elements in the collection this exclusion applies to. Possible values are: `Equals`, `Contains`, `StartsWith`, `EndsWith`, `EqualsAny`.
        :param builtins.str selector: Selector for the value in the `match_variable` attribute this exclusion applies to.
        """
        pulumi.set(__self__, "match_variable", match_variable)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "selector", selector)
...
class FirewallPolicyManagedRuleOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str rule_group_name: The managed rule group to override.
...
class FirewallPolicyManagedRuleOverrideRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to be applied when the rule matches. Possible values are `Allow`, `Block`, `Log`, or `Redirect`.
        :param builtins.str rule_id: Identifier for the managed rule.
        :param builtins.bool enabled: Is the managed rule override enabled or disabled. Defaults to `false`
...
class FrontdoorBackendPool(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str health_probe_name: Specifies the name of the `backend_pool_health_probe` block within this resource to use for this `Backend Pool`.
        :param builtins.str load_balancing_name: Specifies the name of the `backend_pool_load_balancing` block within this resource to use for this `Backend Pool`.
        :param builtins.str name: Specifies the name of the Backend Pool.
        :param builtins.str id: The ID of the FrontDoor.
        """
...
class FrontdoorBackendPoolBackend(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str host_header: The value to use as the host header sent to the backend.
        :param builtins.int http_port: The HTTP TCP port number. Possible values are between `1` - `65535`.
        :param builtins.int https_port: The HTTPS TCP port number. Possible values are between `1` - `65535`.
        :param builtins.bool enabled: Specifies if the backend is enabled or not. Valid options are `true` or `false`. Defaults to `true`.
        :param builtins.int priority: Priority to use for load balancing. Higher priorities will not be used for load balancing if any lower priority backend is healthy. Defaults to `1`.
        :param builtins.int weight: Weight of this endpoint for load balancing purposes. Defaults to `50`.
        """
...
class FrontdoorBackendPoolHealthProbe(dict):
    ...
    def __init__(__self__, *,
                 ...
                 probe_method: Optional[builtins.str] = None,
                 protocol: Optional[builtins.str] = None):
        """
        :param builtins.str name: Specifies the name of the Health Probe.
        :param builtins.bool enabled: Is this health probe enabled? Defaults to `true`.
        :param builtins.str id: The ID of the FrontDoor.
        :param builtins.int interval_in_seconds: The number of seconds between each Health Probe. Defaults to `120`.
    ...
    def probe_method(self) -> Optional[builtins.str]:
        """
...
class FrontdoorBackendPoolLoadBalancing(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int additional_latency_milliseconds: The additional latency in milliseconds for probes to fall into the lowest latency bucket. Defaults to `0`.
        :param builtins.str id: The ID of the FrontDoor.
        :param builtins.int sample_size: The number of samples to consider for load balancing decisions. Defaults to `4`.
        :param builtins.int successful_samples_required: The number of samples within the sample period that must succeed. Defaults to `2`.
        """
        pulumi.set(__self__, "name", name)
...
class FrontdoorBackendPoolSetting(dict):
    ...
    def __init__(__self__, *,
                 enforce_backend_pools_certificate_name_check: builtins.bool,
                 backend_pools_send_receive_timeout_seconds: Optional[builtins.int] = None):
        """
    ...
    def enforce_backend_pools_certificate_name_check(self) -> builtins.bool:
        """
    ...
    def backend_pools_send_receive_timeout_seconds(self) -> Optional[builtins.int]:
        """
...
class FrontdoorExplicitResourceOrder(dict):
    ...
    def __init__(__self__, *,
                 backend_pool_health_probe_ids: Optional[Sequence[builtins.str]] = None,
                 backend_pool_ids: Optional[Sequence[builtins.str]] = None,
                 backend_pool_load_balancing_ids: Optional[Sequence[builtins.str]] = None,
                 frontend_endpoint_ids: Optional[Sequence[builtins.str]] = None,
                 routing_rule_ids: Optional[Sequence[builtins.str]] = None):
...
class FrontdoorFrontendEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 id: Optional[builtins.str] = None,
                 session_affinity_enabled: Optional[builtins.bool] = None,
                 session_affinity_ttl_seconds: Optional[builtins.int] = None,
                 web_application_firewall_policy_link_id: Optional[builtins.str] = None):
        """
        :param builtins.str host_name: Specifies the host name of the `frontend_endpoint`. Must be a domain name. In order to use a name.azurefd.net domain, the name value must match the Front Door name.
        :param builtins.str name: Specifies the name of the `frontend_endpoint`.
        :param builtins.str id: The ID of the FrontDoor.
        :param builtins.bool session_affinity_enabled: Whether to allow session affinity on this host. Valid options are `true` or `false` Defaults to `false`.
        :param builtins.int session_affinity_ttl_seconds: The TTL to use in seconds for session affinity, if applicable. Defaults to `0`.
        :param builtins.str web_application_firewall_policy_link_id: Defines the Web Application Firewall policy `ID` for each host.
        """
    ...
    def session_affinity_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def web_application_firewall_policy_link_id(self) -> Optional[builtins.str]:
        """
...
class FrontdoorRoutingRule(dict):
    ...
    def __init__(__self__, *,
                 accepted_protocols: Sequence[builtins.str],
                 frontend_endpoints: Sequence[builtins.str],
                 name: builtins.str,
                 patterns_to_matches: Sequence[builtins.str],
                 enabled: Optional[builtins.bool] = None,
        ...
        """
        :param Sequence[builtins.str] accepted_protocols: Protocol schemes to match for the Backend Routing Rule. Possible values are `Http` and `Https`.
        :param Sequence[builtins.str] frontend_endpoints: The names of the `frontend_endpoint` blocks within this resource to associate with this `routing_rule`.
        :param builtins.str name: Specifies the name of the Routing Rule.
        :param Sequence[builtins.str] patterns_to_matches: The route patterns for the Backend Routing Rule.
        :param builtins.bool enabled: `Enable` or `Disable` use of this Backend Routing Rule. Permitted values are `true` or `false`. Defaults to `true`.
    ...
    def accepted_protocols(self) -> Sequence[builtins.str]:
        """
    ...
    def frontend_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def patterns_to_matches(self) -> Sequence[builtins.str]:
        """
...
class FrontdoorRoutingRuleForwardingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cache_query_parameter_strip_directive: Optional[builtins.str] = None,
                 cache_query_parameters: Optional[Sequence[builtins.str]] = None,
                 cache_use_dynamic_compression: Optional[builtins.bool] = None,
                 custom_forwarding_path: Optional[builtins.str] = None,
                 forwarding_protocol: Optional[builtins.str] = None):
        """
        :param builtins.str backend_pool_name: Specifies the name of the Backend Pool to forward the incoming traffic to.
        :param builtins.str cache_duration: Specify the minimum caching duration (in ISO8601 notation e.g. `P1DT2H` for 1 day and 2 hours). Needs to be greater than 0 and smaller than 365 days. `cache_duration` works only in combination with `cache_enabled` set to `true`.
        :param builtins.bool cache_enabled: Specifies whether to Enable caching or not. Valid options are `true` or `false`. Defaults to `false`.
        :param builtins.str cache_query_parameter_strip_directive: Defines cache behaviour in relation to query string parameters. Valid options are `StripAll`, `StripAllExcept`, `StripOnly` or `StripNone`. Defaults to `StripAll`.
        :param Sequence[builtins.str] cache_query_parameters: Specify query parameters (array). Works only in combination with `cache_query_parameter_strip_directive` set to `StripAllExcept` or `StripOnly`.
        :param builtins.bool cache_use_dynamic_compression: Whether to use dynamic compression when caching. Valid options are `true` or `false`. Defaults to `false`.
        :param builtins.str custom_forwarding_path: Path to use when constructing the request to forward to the backend. This functions as a URL Rewrite. Default behaviour preserves the URL path.
        :param builtins.str forwarding_protocol: Protocol to use when redirecting. Valid options are `HttpOnly`, `HttpsOnly`, or `MatchRequest`. Defaults to `HttpsOnly`.
        """
    ...
    def cache_query_parameter_strip_directive(self) -> Optional[builtins.str]:
        """
    ...
    def cache_query_parameters(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def cache_use_dynamic_compression(self) -> Optional[builtins.bool]:
        """
...
class FrontdoorRoutingRuleRedirectConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str redirect_protocol: Protocol to use when redirecting. Valid options are `HttpOnly`, `HttpsOnly`, or `MatchRequest`.
        :param builtins.str redirect_type: Status code for the redirect. Valida options are `Moved`, `Found`, `TemporaryRedirect`, `PermanentRedirect`.
        :param builtins.str custom_fragment: The destination fragment in the portion of URL after '#'. Set this to add a fragment to the redirect URL.
        :param builtins.str custom_host: Set this to change the URL for the redirection.
        :param builtins.str custom_path: The path to retain as per the incoming request, or update in the URL for the redirection.
        :param builtins.str custom_query_string: Replace any existing query string from the incoming request URL.
        """
...
class RulesEngineRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int priority: Priority of the rule, must be unique per rules engine definition.
...
class RulesEngineRuleActionRequestHeader(dict):
    ...
    def __init__(__self__, *,
                 header_action_type: Optional[builtins.str] = None,
                 header_name: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str header_action_type: can be set to `Overwrite`, `Append` or `Delete`.
        :param builtins.str header_name: header name (string).
        :param builtins.str value: value name (string).
        """
    ...
    def header_action_type(self) -> Optional[builtins.str]:
        """
...
class RulesEngineRuleMatchCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str operator: can be set to `Any`, `IPMatch`, `GeoMatch`, `Equal`, `Contains`, `LessThan`, `GreaterThan`, `LessThanOrEqual`, `GreaterThanOrEqual`, `BeginsWith` or `EndsWith`
        :param builtins.bool negate_condition: can be set to `true` or `false` to negate the given condition. Defaults to `false`.
        :param builtins.str selector: match against a specific key when `variable` is set to `PostArgs` or `RequestHeader`. It cannot be used with `QueryString` and `RequestMethod`.
        :param Sequence[builtins.str] transforms: can be set to one or more values out of `Lowercase`, `RemoveNulls`, `Trim`, `Uppercase`, `UrlDecode` and `UrlEncode`
        :param Sequence[builtins.str] values: (array) can contain one or more strings.
        :param builtins.str variable: can be set to `IsMobile`, `RemoteAddr`, `RequestMethod`, `QueryString`, `PostArgs`, `RequestURI`, `RequestPath`, `RequestFilename`, `RequestFilenameExtension`,`RequestHeader`,`RequestBody` or `RequestScheme`.
        """
        pulumi.set(__self__, "operator", operator)
