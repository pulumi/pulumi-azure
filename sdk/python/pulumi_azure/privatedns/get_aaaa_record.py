...
__all__ = [
    'GetAAAARecordResult',
    'AwaitableGetAAAARecordResult',
    'get_aaaa_record',
    'get_aaaa_record_output',
]
...
class AwaitableGetAAAARecordResult(GetAAAARecordResult):
...
def get_aaaa_record(name: Optional[_builtins.str] = None,
                    resource_group_name: Optional[_builtins.str] = None,
                    zone_name: Optional[_builtins.str] = None,
                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAAAARecordResult:
    """
    ...
    example = azure.privatedns.get_aaaa_record(name="example",
        zone_name="example-zone",
        resource_group_name="example-rg")
    pulumi.export("privateDnsAaaaRecordId", example.id)
    ```
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    :param _builtins.str name: The name of the Private DNS AAAA Record.
    ...
    __ret__ = pulumi.runtime.invoke('azure:privatedns/getAAAARecord:getAAAARecord', __args__, opts=opts, typ=GetAAAARecordResult).value
...
def get_aaaa_record_output(name: pulumi.Input[Optional[_builtins.str]] = None,
                           resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                           zone_name: pulumi.Input[Optional[_builtins.str]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAAAARecordResult]:
    """
    Use this data source to access information about an existing Private DNS AAAA Record within Azure DNS.
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:privatedns/getAAAARecord:getAAAARecord', __args__, opts=opts, typ=GetAAAARecordResult)
    return __ret__.apply(lambda __response__: GetAAAARecordResult(
