...
def get_txt_record(name: Optional[_builtins.str] = None,
    ...
    example = azure.privatedns.get_txt_record(name="example",
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    :param _builtins.str name: The name of the Private DNS TXT Record.
    ...
    __ret__ = pulumi.runtime.invoke('azure:privatedns/getTxtRecord:getTxtRecord', __args__, opts=opts, typ=GetTxtRecordResult).value
...
def get_txt_record_output(name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:privatedns/getTxtRecord:getTxtRecord', __args__, opts=opts, typ=GetTxtRecordResult)
