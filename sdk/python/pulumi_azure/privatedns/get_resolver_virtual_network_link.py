...
def get_resolver_virtual_network_link(dns_forwarding_ruleset_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2022-07-01
    ...
    :param _builtins.str name: Name of the Private DNS Resolver Virtual Network Link.
    """
    __args__ = dict()
...
def get_resolver_virtual_network_link_output(dns_forwarding_ruleset_id: Optional[pulumi.Input[_builtins.str]] = None,
