...
class ResolverForwardingRuleArgs:
    def __init__(__self__, *,
                 dns_forwarding_ruleset_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] dns_forwarding_ruleset_id: Specifies the ID of the Private DNS Resolver Forwarding Ruleset. Changing this forces a new Private DNS Resolver Forwarding Rule to be created.
        :param pulumi.Input[builtins.str] domain_name: Specifies the domain name for the Private DNS Resolver Forwarding Rule. Changing this forces a new Private DNS Resolver Forwarding Rule to be created.
        ...
        :param pulumi.Input[builtins.bool] enabled: Specifies the state of the Private DNS Resolver Forwarding Rule. Defaults to `true`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata attached to the Private DNS Resolver Forwarding Rule.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Private DNS Resolver Forwarding Rule. Changing this forces a new Private DNS Resolver Forwarding Rule to be created.
        """
    ...
    def dns_forwarding_ruleset_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dns_forwarding_ruleset_id(self, value: pulumi.Input[builtins.str]):
...
class _ResolverForwardingRuleState:
    def __init__(__self__, *,
                 dns_forwarding_ruleset_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dnsForwardingRulesetId")
    def dns_forwarding_ruleset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the ID of the Private DNS Resolver Forwarding Ruleset. Changing this forces a new Private DNS Resolver Forwarding Rule to be created.
        """
        return pulumi.get(self, "dns_forwarding_ruleset_id")
    ...
    @dns_forwarding_ruleset_id.setter
    def dns_forwarding_ruleset_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_forwarding_ruleset_id", value)
...
class ResolverForwardingRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `Microsoft.Network`: 2022-07-01
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata attached to the Private DNS Resolver Forwarding Rule.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Private DNS Resolver Forwarding Rule. Changing this forces a new Private DNS Resolver Forwarding Rule to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ResolverForwardingRuleTargetDnsServerArgs', 'ResolverForwardingRuleTargetDnsServerArgsDict']]]] target_dns_servers: Can be specified multiple times to define multiple target DNS servers. Each `target_dns_servers` block as defined below.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="dnsForwardingRulesetId")
    def dns_forwarding_ruleset_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the ID of the Private DNS Resolver Forwarding Ruleset. Changing this forces a new Private DNS Resolver Forwarding Rule to be created.
        """
        return pulumi.get(self, "dns_forwarding_ruleset_id")
