...
__all__ = ['TxtRecordArgs', 'TxtRecord']

@pulumi.input_type
class TxtRecordArgs:
    def __init__(__self__, *,
                 records: pulumi.Input[Sequence[pulumi.Input['TxtRecordRecordArgs']]],
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] ttl: The Time To Live (TTL) of the DNS record in seconds.
        :param pulumi.Input[builtins.str] zone_name: Specifies the Private DNS Zone where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the DNS TXT Record. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter
    def records(self) -> pulumi.Input[Sequence[pulumi.Input['TxtRecordRecordArgs']]]:
        """
    ...
    @records.setter
    def records(self, value: pulumi.Input[Sequence[pulumi.Input['TxtRecordRecordArgs']]]):
...
class _TxtRecordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the DNS TXT Record.
        :param pulumi.Input[builtins.str] name: The name of the DNS TXT Record. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input['TxtRecordRecordArgs']]] records: One or more `record` blocks as defined below.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
    ...
    @property
    @pulumi.getter
    def records(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['TxtRecordRecordArgs']]]]:
        """
        One or more `record` blocks as defined below.
        """
        return pulumi.get(self, "records")
    ...
    @records.setter
    def records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['TxtRecordRecordArgs']]]]):
        pulumi.set(self, "records", value)
...
@pulumi.type_token("azure:privatedns/txtRecord:TxtRecord")
class TxtRecord(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TxtRecordArgs.__new__(TxtRecordArgs)
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            zone_name: Optional[pulumi.Input[builtins.str]] = None) -> 'TxtRecord':
        """
        ...
        __props__ = _TxtRecordState.__new__(_TxtRecordState)
