...
def get_resolver(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2022-07-01
    ...
    :param _builtins.str resource_group_name: Name of the Resource Group where the Private DNS Resolver exists.
    """
    __args__ = dict()
    __args__['name'] = name
