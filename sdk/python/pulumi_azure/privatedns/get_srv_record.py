...
__all__ = [
    'GetSrvRecordResult',
    'AwaitableGetSrvRecordResult',
    'get_srv_record',
    'get_srv_record_output',
]
...
class GetSrvRecordResult:
    ...
    @_builtins.property
    @pulumi.getter
    def records(self) -> Sequence['outputs.GetSrvRecordRecordResult']:
        """
...
def get_srv_record(name: Optional[_builtins.str] = None,
    ...
    example = azure.privatedns.get_srv_record(name="example",
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    :param _builtins.str name: The name of the Private DNS SRV Record.
    :param _builtins.str resource_group_name: Specifies the resource group where the Private DNS Zone (parent resource) exists.
    :param _builtins.str zone_name: Specifies the Private DNS Zone where the resource exists.
    """
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure:privatedns/getSrvRecord:getSrvRecord', __args__, opts=opts, typ=GetSrvRecordResult).value

    return AwaitableGetSrvRecordResult(
...
def get_srv_record_output(name: pulumi.Input[Optional[_builtins.str]] = None,
                          resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                          zone_name: pulumi.Input[Optional[_builtins.str]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSrvRecordResult]:
    """
    Use this data source to access information about an existing Private DNS SRV Record within Azure DNS.
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:privatedns/getSrvRecord:getSrvRecord', __args__, opts=opts, typ=GetSrvRecordResult)
    return __ret__.apply(lambda __response__: GetSrvRecordResult(
