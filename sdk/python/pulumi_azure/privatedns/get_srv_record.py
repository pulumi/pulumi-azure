...
def get_srv_record(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-06-01
    ...
    :param builtins.str name: The name of the Private DNS SRV Record.
    :param builtins.str resource_group_name: Specifies the resource group where the Private DNS Zone (parent resource) exists.
    :param builtins.str zone_name: Specifies the Private DNS Zone where the resource exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_srv_record_output(name: Optional[pulumi.Input[builtins.str]] = None,
