...
def get_ptr_record(name: Optional[_builtins.str] = None,
    ...
    example = azure.privatedns.get_ptr_record(name="example",
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    :param _builtins.str name: The name of the Private DNS PTR Record.
    ...
    __ret__ = pulumi.runtime.invoke('azure:privatedns/getPtrRecord:getPtrRecord', __args__, opts=opts, typ=GetPtrRecordResult).value
...
def get_ptr_record_output(name: pulumi.Input[Optional[_builtins.str]] = None,
                          resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                          zone_name: pulumi.Input[Optional[_builtins.str]] = None,
                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPtrRecordResult]:
    """
    Use this data source to access information about an existing Private DNS PTR Record within Azure DNS.
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:privatedns/getPtrRecord:getPtrRecord', __args__, opts=opts, typ=GetPtrRecordResult)
    return __ret__.apply(lambda __response__: GetPtrRecordResult(
