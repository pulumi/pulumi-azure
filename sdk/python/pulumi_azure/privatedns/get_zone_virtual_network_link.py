...
def get_zone_virtual_network_link(name: Optional[builtins.str] = None,
                                  private_dns_zone_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-06-01
    ...
    :param builtins.str resource_group_name: Specifies the resource group where the Private DNS Zone exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_zone_virtual_network_link_output(name: Optional[pulumi.Input[builtins.str]] = None,
