...
def get_a_record(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    :param _builtins.str name: The name of the Private DNS A Record.
...
def get_a_record_output(name: Optional[pulumi.Input[_builtins.str]] = None,
                        resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                        zone_name: Optional[pulumi.Input[_builtins.str]] = None,
                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetARecordResult]:
    """
    ## Example Usage
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:privatedns/getARecord:getARecord', __args__, opts=opts, typ=GetARecordResult)
    return __ret__.apply(lambda __response__: GetARecordResult(
