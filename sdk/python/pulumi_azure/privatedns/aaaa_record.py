...
class AAAARecordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] records: A list of IPv6 Addresses.
...
class _AAAARecordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the DNS AAAA Record.
        :param pulumi.Input[builtins.str] name: The name of the DNS A Record. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] records: A list of IPv6 Addresses.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
...
class AAAARecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            zone_name: Optional[pulumi.Input[builtins.str]] = None) -> 'AAAARecord':
        """
