...
class GetDnsZoneResult:
    ...
    def max_number_of_virtual_network_links(self) -> _builtins.int:
        """
    ...
    def max_number_of_virtual_network_links_with_registration(self) -> _builtins.int:
        """
...
def get_dns_zone(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: The name of the Private DNS Zone.
    :param _builtins.str resource_group_name: The Name of the Resource Group where the Private DNS Zone exists.
    ...
    :param Mapping[str, _builtins.str] tags: A mapping of tags for the zone.
    """
    __args__ = dict()
    __args__['name'] = name
