...
class LinkServiceNatIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies the name which should be used for the NAT IP Configuration. Changing this forces a new resource to be created.
...
class MxRecordRecord(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str exchange: The FQDN of the exchange to MX record points to.
        :param builtins.int preference: The preference of the MX record.
        """
...
class ResolverInboundEndpointIpConfigurations(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str subnet_id: The subnet ID of the IP configuration.
        :param builtins.str private_ip_address: Private IP address of the IP configuration.
        :param builtins.str private_ip_allocation_method: Private IP address allocation method. Allowed value is `Dynamic` and `Static`. Defaults to `Dynamic`.
        """
        pulumi.set(__self__, "subnet_id", subnet_id)
        if private_ip_address is not None:
            pulumi.set(__self__, "private_ip_address", private_ip_address)
...
class SRVRecordRecord(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.int port: The Port the service is listening on.
        :param builtins.int priority: The priority of the SRV record.
        :param builtins.str target: The FQDN of the service.
        :param builtins.int weight: The Weight of the SRV record.
        """
        pulumi.set(__self__, "port", port)
...
class TxtRecordRecord(dict):
    def __init__(__self__, *,
                 value: builtins.str):
        """
        :param builtins.str value: The value of the TXT record. Max length: 1024 characters
        """
...
class ZoneSoaRecord(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str fqdn: The fully qualified domain name of the Record Set.
        :param builtins.str host_name: The domain name of the authoritative name server for the SOA record.
        :param builtins.int minimum_ttl: The minimum Time To Live for the SOA record. By convention, it is used to determine the negative caching duration. Defaults to `10`.
        ...
        :param builtins.int serial_number: The serial number for the SOA record.
...
class GetMxRecordRecordResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int preference: String representing the "preference” value of the MX records. Records with lower preference value take priority.
        """
        pulumi.set(__self__, "exchange", exchange)
        pulumi.set(__self__, "preference", preference)
...
class GetResolverForwardingRuleTargetDnsServerResult(dict):
    def __init__(__self__, *,
                 ...
                 port: builtins.int):
        """
        :param builtins.str ip_address: The DNS server IP address.
        :param builtins.int port: The DNS server port.
        """
        pulumi.set(__self__, "ip_address", ip_address)
        pulumi.set(__self__, "port", port)
...
class GetResolverInboundEndpointIpConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 subnet_id: builtins.str):
        """
        :param builtins.str private_ip_address: The private IP address of the IP configuration.
        :param builtins.str private_ip_allocation_method: The private IP address allocation method.
        :param builtins.str subnet_id: The subnet ID of the IP configuration.
        """
        pulumi.set(__self__, "private_ip_address", private_ip_address)
        pulumi.set(__self__, "private_ip_allocation_method", private_ip_allocation_method)
