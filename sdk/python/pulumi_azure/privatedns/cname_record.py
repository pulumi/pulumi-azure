...
class CnameRecordArgs:
    def __init__(__self__, *,
                 record: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] record: The target of the CNAME.
        ...
        :param pulumi.Input[builtins.int] ttl: The Time To Live (TTL) of the DNS record in seconds. Possible values are between `0` and `2147483647`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the DNS CNAME Record. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter
    def record(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @record.setter
    def record(self, value: pulumi.Input[builtins.str]):
...
class _CnameRecordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the DNS CNAME Record.
        :param pulumi.Input[builtins.str] name: The name of the DNS CNAME Record. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] record: The target of the CNAME.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
...
class CnameRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            zone_name: Optional[pulumi.Input[builtins.str]] = None) -> 'CnameRecord':
        """
    ...
    @property
    @pulumi.getter
    def record(self) -> pulumi.Output[builtins.str]:
        """
        The target of the CNAME.
        """
        return pulumi.get(self, "record")
