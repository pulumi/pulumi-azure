...
def get_cname_record(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-06-01
    ...
    :param builtins.str name: The name of the Private DNS CNAME Record.
...
def get_cname_record_output(name: Optional[pulumi.Input[builtins.str]] = None,
