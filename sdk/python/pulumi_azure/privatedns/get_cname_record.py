...
def get_cname_record(name: Optional[_builtins.str] = None,
    ...
    example = azure.privatedns.get_cname_record(name="example",
        zone_name="example-zone",
        resource_group_name="example-rg")
    pulumi.export("privateDnsCnameRecordId", example.id)
    ```
    ...
    * `Microsoft.Network` - 2024-06-01
    ...
    :param _builtins.str name: The name of the Private DNS CNAME Record.
