...
def get_resolver_outbound_endpoint(name: Optional[builtins.str] = None,
...
def get_resolver_outbound_endpoint_output(name: Optional[pulumi.Input[builtins.str]] = None,
