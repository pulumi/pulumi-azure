...
class GetSoaRecordResult:
    ...
    def minimum_ttl(self) -> builtins.int:
        """
...
def get_soa_record(name: Optional[builtins.str] = None,
...
def get_soa_record_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
