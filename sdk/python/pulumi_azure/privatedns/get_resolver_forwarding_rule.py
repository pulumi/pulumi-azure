...
def get_resolver_forwarding_rule(dns_forwarding_ruleset_id: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2022-07-01
    ...
    :param builtins.str dns_forwarding_ruleset_id: ID of the Private DNS Resolver Forwarding Ruleset.
    :param builtins.str name: Name of the Private DNS Resolver Forwarding Rule.
    """
    __args__ = dict()
...
def get_resolver_forwarding_rule_output(dns_forwarding_ruleset_id: Optional[pulumi.Input[builtins.str]] = None,
