...
def get_mpa_account_scope(billing_account_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str billing_account_name: The Billing Account Name of the MPA account.
    :param _builtins.str customer_name: The Customer Name in the above Billing Account.
    """
    __args__ = dict()
