...
def get_mpa_account_scope(billing_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str billing_account_name: The Billing Account Name of the MPA account.
    :param builtins.str customer_name: The Customer Name in the above Billing Account.
    """
    __args__ = dict()
...
def get_mpa_account_scope_output(billing_account_name: Optional[pulumi.Input[builtins.str]] = None,
