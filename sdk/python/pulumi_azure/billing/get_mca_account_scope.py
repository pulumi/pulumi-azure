...
def get_mca_account_scope(billing_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str billing_account_name: The Billing Account Name of the MCA account.
    :param builtins.str billing_profile_name: The Billing Profile Name in the above Billing Account.
    :param builtins.str invoice_section_name: The Invoice Section Name in the above Billing Profile.
    """
    __args__ = dict()
...
def get_mca_account_scope_output(billing_account_name: Optional[pulumi.Input[builtins.str]] = None,
