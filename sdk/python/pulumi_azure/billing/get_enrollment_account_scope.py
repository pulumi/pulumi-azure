...
def get_enrollment_account_scope(billing_account_name: Optional[builtins.str] = None,
    ...
    :param builtins.str billing_account_name: The Billing Account Name of the Enterprise Account.
    :param builtins.str enrollment_account_name: The Enrollment Account Name in the above Enterprise Account.
    """
    __args__ = dict()
...
def get_enrollment_account_scope_output(billing_account_name: Optional[pulumi.Input[builtins.str]] = None,
