...
class FileSystemArgs:
    def __init__(__self__, *,
                 ...
                 storage_capacity_in_tb: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Azure Managed Lustre File System should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: The SKU name for the Azure Managed Lustre File System. Possible values are `AMLFS-Durable-Premium-40`, `AMLFS-Durable-Premium-125`, `AMLFS-Durable-Premium-250` and `AMLFS-Durable-Premium-500`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] storage_capacity_in_tb: The size of the Azure Managed Lustre File System in TiB. The valid values for this field are dependant on which `sku_name` has been defined in the configuration file. For more information on the valid values for this field please see the [product documentation](https://learn.microsoft.com/azure/azure-managed-lustre/create-file-system-resource-manager#file-system-type-and-size-options). Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure Managed Lustre File System. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Azure Managed Lustre File System.
        """
    ...
    def storage_capacity_in_tb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def storage_capacity_in_tb(self, value: pulumi.Input[builtins.int]):
...
class _FileSystemState:
    def __init__(__self__, *,
                 ...
                 mgs_address: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 sku_name: Optional[pulumi.Input[builtins.str]] = None,
                 storage_capacity_in_tb: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Azure Managed Lustre File System should exist. Changing this forces a new resource to be created.
        :param pulumi.Input['FileSystemMaintenanceWindowArgs'] maintenance_window: A `maintenance_window` block as defined below.
        :param pulumi.Input[builtins.str] mgs_address: IP Address of Managed Lustre File System Services.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure Managed Lustre File System. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Azure Managed Lustre File System should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: The SKU name for the Azure Managed Lustre File System. Possible values are `AMLFS-Durable-Premium-40`, `AMLFS-Durable-Premium-125`, `AMLFS-Durable-Premium-250` and `AMLFS-Durable-Premium-500`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] storage_capacity_in_tb: The size of the Azure Managed Lustre File System in TiB. The valid values for this field are dependant on which `sku_name` has been defined in the configuration file. For more information on the valid values for this field please see the [product documentation](https://learn.microsoft.com/azure/azure-managed-lustre/create-file-system-resource-manager#file-system-type-and-size-options). Changing this forces a new resource to be created.
    ...
    def mgs_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mgs_address.setter
    def mgs_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="storageCapacityInTb")
    def storage_capacity_in_tb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The size of the Azure Managed Lustre File System in TiB. The valid values for this field are dependant on which `sku_name` has been defined in the configuration file. For more information on the valid values for this field please see the [product documentation](https://learn.microsoft.com/azure/azure-managed-lustre/create-file-system-resource-manager#file-system-type-and-size-options). Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "storage_capacity_in_tb")
    ...
    @storage_capacity_in_tb.setter
    def storage_capacity_in_tb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "storage_capacity_in_tb", value)
...
class FileSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'FileSystem':
        """
    ...
    @property
    @pulumi.getter(name="mgsAddress")
    def mgs_address(self) -> pulumi.Output[builtins.str]:
        """
        IP Address of Managed Lustre File System Services.
        """
        return pulumi.get(self, "mgs_address")
    ...
    @property
    @pulumi.getter(name="storageCapacityInTb")
    def storage_capacity_in_tb(self) -> pulumi.Output[builtins.int]:
        """
        The size of the Azure Managed Lustre File System in TiB. The valid values for this field are dependant on which `sku_name` has been defined in the configuration file. For more information on the valid values for this field please see the [product documentation](https://learn.microsoft.com/azure/azure-managed-lustre/create-file-system-resource-manager#file-system-type-and-size-options). Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "storage_capacity_in_tb")
