...
def get_published_version(blueprint_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Blueprint`: 2018-11-01-preview
    ...
    :param builtins.str scope_id: The ID of the Management Group / Subscription where this Blueprint Definition is stored.
    :param builtins.str version: The Version name of the Published Version of the Blueprint Definition
    """
    __args__ = dict()
...
def get_published_version_output(blueprint_name: Optional[pulumi.Input[builtins.str]] = None,
