...
class SpringCloudDynatraceApplicationPerformanceMonitoringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_point: Specifies the endpoint to connect to the Dynatrace environment.
        ...
        :param pulumi.Input[builtins.str] tenant: Specifies the Dynatrace tenant.
        :param pulumi.Input[builtins.str] tenant_token: Specifies the internal token that is used for authentication when OneAgent connects to the Dynatrace cluster to send data.
        :param pulumi.Input[builtins.str] api_token: Specifies the API token of the Dynatrace environment.
        :param pulumi.Input[builtins.str] api_url: Specifies the API Url of the Dynatrace environment.
        :param pulumi.Input[builtins.str] environment_id: Specifies the Dynatrace environment ID.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Spring Cloud Application Performance Monitoring resource for Dynatrace. Changing this forces a new resource to be created.
        """
    ...
    def connection_point(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connection_point(self, value: pulumi.Input[builtins.str]):
    ...
    def tenant_token(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @tenant_token.setter
    def tenant_token(self, value: pulumi.Input[builtins.str]):
...
class _SpringCloudDynatraceApplicationPerformanceMonitoringState:
    def __init__(__self__, *,
                 api_token: Optional[pulumi.Input[builtins.str]] = None,
                 api_url: Optional[pulumi.Input[builtins.str]] = None,
                 connection_point: Optional[pulumi.Input[builtins.str]] = None,
                 environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 globally_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="connectionPoint")
    def connection_point(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the endpoint to connect to the Dynatrace environment.
        """
        return pulumi.get(self, "connection_point")
    ...
    @connection_point.setter
    def connection_point(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connection_point", value)
...
class SpringCloudDynatraceApplicationPerformanceMonitoring(pulumi.CustomResource):
    ...
    pulumi_type = "azure:appplatform/springCloudDynatraceApplicationPerformanceMonitoring:SpringCloudDynatraceApplicationPerformanceMonitoring"
    ...
    def get(resource_name: str,
            ...
            spring_cloud_service_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant: Optional[pulumi.Input[builtins.str]] = None,
            tenant_token: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudDynatraceApplicationPerformanceMonitoring':
        """
    ...
    @property
    @pulumi.getter(name="connectionPoint")
    def connection_point(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the endpoint to connect to the Dynatrace environment.
        """
        return pulumi.get(self, "connection_point")
