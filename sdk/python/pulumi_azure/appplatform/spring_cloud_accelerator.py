...
class SpringCloudAcceleratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] spring_cloud_service_id: The ID of the Spring Cloud Service. Changing this forces a new Spring Cloud Accelerator to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Spring Cloud Accelerator. Changing this forces a new Spring Cloud Accelerator to be created. The only possible value is `default`.
        """
...
@pulumi.type_token("azure:appplatform/springCloudAccelerator:SpringCloudAccelerator")
class SpringCloudAccelerator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            spring_cloud_service_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudAccelerator':
        """
