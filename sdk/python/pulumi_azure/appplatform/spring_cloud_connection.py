...
class SpringCloudConnectionArgs:
    def __init__(__self__, *,
                 ...
                 spring_cloud_id: pulumi.Input[builtins.str],
                 ...
                 vnet_solution: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] spring_cloud_id: The ID of the data source spring cloud. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_resource_id: The ID of the target resource. Changing this forces a new resource to be created. Possible target resources are `Postgres`, `PostgresFlexible`, `Mysql`, `Sql`, `Redis`, `RedisEnterprise`, `CosmosCassandra`, `CosmosGremlin`, `CosmosMongo`, `CosmosSql`, `CosmosTable`, `StorageBlob`, `StorageQueue`, `StorageFile`, `StorageTable`, `AppConfig`, `EventHub`, `ServiceBus`, `SignalR`, `WebPubSub`, `ConfluentKafka`. The integration guide can be found [here](https://learn.microsoft.com/en-us/azure/service-connector/how-to-integrate-postgres).
        :param pulumi.Input[builtins.str] name: The name of the service connection. Changing this forces a new resource to be created.
        """
    ...
    def spring_cloud_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def spring_cloud_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vnet_solution(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "vnet_solution")

    @vnet_solution.setter
    def vnet_solution(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SpringCloudConnectionState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 secret_store: Optional[pulumi.Input['SpringCloudConnectionSecretStoreArgs']] = None,
                 spring_cloud_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="springCloudId")
    def spring_cloud_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the data source spring cloud. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "spring_cloud_id")
    ...
    @spring_cloud_id.setter
    def spring_cloud_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spring_cloud_id", value)
...
class SpringCloudConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            spring_cloud_id: Optional[pulumi.Input[builtins.str]] = None,
            target_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            vnet_solution: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudConnection':
        """
    ...
    @property
    @pulumi.getter(name="springCloudId")
    def spring_cloud_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the data source spring cloud. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "spring_cloud_id")
    ...
    @property
    @pulumi.getter(name="vnetSolution")
    def vnet_solution(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "vnet_solution")
