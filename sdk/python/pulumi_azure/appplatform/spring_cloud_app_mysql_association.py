...
class SpringCloudAppMysqlAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_database = azure.mysql.database.Database("example",
            name=exampledb,
            resource_group_name=example.name,
            server_name=example_server.name,
            charset=utf8,
            collation=utf8_unicode_ci)
        example_spring_cloud_app_mysql_association = azure.appplatform.spring_cloud_app_mysql_association.SpringCloudAppMysqlAssociation("example",
            name=example-bind,
