...
class SpringCloudStorageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] spring_cloud_service_id: The ID of the Spring Cloud Service where the Spring Cloud Storage should exist. Changing this forces a new Spring Cloud Storage to be created.
        :param pulumi.Input[builtins.str] storage_account_key: The access key of the Azure Storage Account.
        :param pulumi.Input[builtins.str] storage_account_name: The account name of the Azure Storage Account.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Spring Cloud Storage. Changing this forces a new Spring Cloud Storage to be created.
        """
...
class SpringCloudStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            spring_cloud_service_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_key: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_name: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudStorage':
        """
