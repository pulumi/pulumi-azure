...
class SpringCloudApplicationInsightsApplicationPerformanceMonitoringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role_instance: Specifies the cloud role instance.
        :param pulumi.Input[_builtins.str] role_name: Specifies the cloud role name used to label the component on the application map.
        :param pulumi.Input[_builtins.int] sampling_percentage: Specifies the percentage for fixed-percentage sampling.
        :param pulumi.Input[_builtins.int] sampling_requests_per_second: Specifies the number of requests per second for the rate-limited sampling.
        """
...
class SpringCloudApplicationInsightsApplicationPerformanceMonitoring(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="roleInstance")
    def role_instance(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the cloud role instance.
        """
        return pulumi.get(self, "role_instance")
    ...
    @_builtins.property
    @pulumi.getter(name="samplingRequestsPerSecond")
    def sampling_requests_per_second(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Specifies the number of requests per second for the rate-limited sampling.
        """
        return pulumi.get(self, "sampling_requests_per_second")
