...
class SpringCloudGatewayArgs:
    def __init__(__self__, *,
                 ...
                 application_performance_monitoring_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 sensitive_environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] spring_cloud_service_id: The ID of the Spring Cloud Service. Changing this forces a new Spring Cloud Gateway to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_performance_monitoring_types: Specifies a list of application performance monitoring types used in the Spring Cloud Gateway. The allowed values are `AppDynamics`, `ApplicationInsights`, `Dynatrace`, `ElasticAPM` and `NewRelic`.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment_variables: Specifies the environment variables of the Spring Cloud Gateway as a map of key-value pairs.
        :param pulumi.Input[builtins.bool] https_only: is only https is allowed?
        :param pulumi.Input[builtins.int] instance_count: Specifies the required instance count of the Spring Cloud Gateway. Possible Values are between `1` and `500`. Defaults to `1` if not specified.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Spring Cloud Gateway. Changing this forces a new Spring Cloud Gateway to be created. The only possible value is `default`.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Indicates whether the Spring Cloud Gateway exposes endpoint.
        :param pulumi.Input['SpringCloudGatewayQuotaArgs'] quota: A `quota` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] sensitive_environment_variables: Specifies the sensitive environment variables of the Spring Cloud Gateway as a map of key-value pairs.
    ...
    def application_performance_monitoring_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def application_performance_monitoring_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def sensitive_environment_variables(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def sensitive_environment_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _SpringCloudGatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] spring_cloud_service_id: The ID of the Spring Cloud Service. Changing this forces a new Spring Cloud Gateway to be created.
        :param pulumi.Input['SpringCloudGatewaySsoArgs'] sso: A `sso` block as defined below.
        :param pulumi.Input[builtins.str] url: URL of the Spring Cloud Gateway, exposed when 'public_network_access_enabled' is true.
        """
        if api_metadata is not None:
            pulumi.set(__self__, "api_metadata", api_metadata)
        if application_performance_monitoring_ids is not None:
...
class SpringCloudGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            spring_cloud_service_id: Optional[pulumi.Input[builtins.str]] = None,
            sso: Optional[pulumi.Input[Union['SpringCloudGatewaySsoArgs', 'SpringCloudGatewaySsoArgsDict']]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudGateway':
        """
    ...
    @property
    @pulumi.getter(name="applicationPerformanceMonitoringTypes")
    def application_performance_monitoring_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a list of application performance monitoring types used in the Spring Cloud Gateway. The allowed values are `AppDynamics`, `ApplicationInsights`, `Dynatrace`, `ElasticAPM` and `NewRelic`.
        """
        return pulumi.get(self, "application_performance_monitoring_types")
    ...
    @property
    @pulumi.getter(name="sensitiveEnvironmentVariables")
    def sensitive_environment_variables(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Specifies the sensitive environment variables of the Spring Cloud Gateway as a map of key-value pairs.
        """
        return pulumi.get(self, "sensitive_environment_variables")
