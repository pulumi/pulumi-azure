...
class SpringCloudContainerDeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image: Container image of the custom container. This should be in the form of `<repository>:<tag>` without the server name of the registry.
        :param pulumi.Input[builtins.str] server: The name of the registry that contains the container image.
        :param pulumi.Input[builtins.str] spring_cloud_app_id: The ID of the Spring Cloud Service. Changing this forces a new Spring Cloud Container Deployment to be created.
        :param pulumi.Input[builtins.str] addon_json: A JSON object that contains the addon configurations of the Spring Cloud Container Deployment.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] arguments: Specifies the arguments to the entrypoint. The docker image's `CMD` is used if not specified.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commands: Specifies the entrypoint array. It will not be executed within a shell. The docker image's `ENTRYPOINT` is used if not specified.
        ...
        :param pulumi.Input[builtins.str] language_framework: Specifies the language framework of the container image. The only possible value is `springboot`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Spring Cloud Container Deployment. Changing this forces a new Spring Cloud Container Deployment to be created.
...
class SpringCloudContainerDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            quota: Optional[pulumi.Input[Union['SpringCloudContainerDeploymentQuotaArgs', 'SpringCloudContainerDeploymentQuotaArgsDict']]] = None,
            server: Optional[pulumi.Input[builtins.str]] = None,
            spring_cloud_app_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudContainerDeployment':
        """
    ...
    @property
    @pulumi.getter
    def arguments(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies the arguments to the entrypoint. The docker image's `CMD` is used if not specified.
        """
        return pulumi.get(self, "arguments")
    ...
    @property
    @pulumi.getter(name="languageFramework")
    def language_framework(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the language framework of the container image. The only possible value is `springboot`.
        """
        return pulumi.get(self, "language_framework")
