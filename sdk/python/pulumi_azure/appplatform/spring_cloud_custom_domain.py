...
class SpringCloudCustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] spring_cloud_app_id: Specifies the resource ID of the Spring Cloud Application. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] certificate_name: Specifies the name of the Spring Cloud Certificate that binds to the Spring Cloud Custom Domain. Required when `thumbprint` is specified
        :param pulumi.Input[builtins.str] name: Specifies the name of the Spring Cloud Custom Domain. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] thumbprint: Specifies the thumbprint of the Spring Cloud Certificate that binds to the Spring Cloud Custom Domain. Required when `certificate_name` is specified. Changing this forces a new resource to be created.
        """
...
class SpringCloudCustomDomain(pulumi.CustomResource):
    ...
    pulumi_type = "azure:appplatform/springCloudCustomDomain:SpringCloudCustomDomain"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            spring_cloud_app_id: Optional[pulumi.Input[builtins.str]] = None,
            thumbprint: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudCustomDomain':
        """
