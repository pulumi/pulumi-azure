...
def get_spring_cloud_service(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str resource_group_name: Specifies the name of the Resource Group where the Spring Cloud Service exists.
    """
    __args__ = dict()
    __args__['name'] = name
