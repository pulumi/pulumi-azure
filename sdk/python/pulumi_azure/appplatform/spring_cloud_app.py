...
class SpringCloudAppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the resource group in which to create the Spring Cloud Application. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] service_name: Specifies the name of the Spring Cloud Service resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] addon_json: A JSON object that contains the addon configurations of the Spring Cloud Service.
        ...
        :param pulumi.Input[builtins.bool] https_only: Is only HTTPS allowed? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.bool] is_public: Does the Spring Cloud Application have public endpoint? Defaults to `false`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Spring Cloud Application. Changing this forces a new resource to be created.
        :param pulumi.Input['SpringCloudAppPersistentDiskArgs'] persistent_disk: An `persistent_disk` block as defined below.
        :param pulumi.Input[builtins.bool] public_endpoint_enabled: Should the App in vnet injection instance exposes endpoint which could be accessed from Internet?
        :param pulumi.Input[builtins.bool] tls_enabled: Is End to End TLS Enabled? Defaults to `false`.
        """
...
class _SpringCloudAppState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] addon_json: A JSON object that contains the addon configurations of the Spring Cloud Service.
        :param pulumi.Input[Sequence[pulumi.Input['SpringCloudAppCustomPersistentDiskArgs']]] custom_persistent_disks: A `custom_persistent_disk` block as defined below.
        :param pulumi.Input[builtins.str] fqdn: The Fully Qualified DNS Name of the Spring Application in the service.
        :param pulumi.Input[builtins.bool] https_only: Is only HTTPS allowed? Defaults to `false`.
        :param pulumi.Input['SpringCloudAppIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input['SpringCloudAppIngressSettingsArgs'] ingress_settings: An `ingress_settings` block as defined below.
        :param pulumi.Input[builtins.bool] is_public: Does the Spring Cloud Application have public endpoint? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] service_name: Specifies the name of the Spring Cloud Service resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] tls_enabled: Is End to End TLS Enabled? Defaults to `false`.
        :param pulumi.Input[builtins.str] url: The public endpoint of the Spring Cloud Application.
        """
        if addon_json is not None:
            pulumi.set(__self__, "addon_json", addon_json)
        if custom_persistent_disks is not None:
...
class SpringCloudApp(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 addon_json: Optional[pulumi.Input[builtins.str]] = None,
                 custom_persistent_disks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SpringCloudAppCustomPersistentDiskArgs', 'SpringCloudAppCustomPersistentDiskArgsDict']]]]] = None,
                 https_only: Optional[pulumi.Input[builtins.bool]] = None,
                 identity: Optional[pulumi.Input[Union['SpringCloudAppIdentityArgs', 'SpringCloudAppIdentityArgsDict']]] = None,
                 ingress_settings: Optional[pulumi.Input[Union['SpringCloudAppIngressSettingsArgs', 'SpringCloudAppIngressSettingsArgsDict']]] = None,
                 is_public: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 persistent_disk: Optional[pulumi.Input[Union['SpringCloudAppPersistentDiskArgs', 'SpringCloudAppPersistentDiskArgsDict']]] = None,
                 public_endpoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 service_name: Optional[pulumi.Input[builtins.str]] = None,
                 tls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def get(resource_name: str,
            ...
            service_name: Optional[pulumi.Input[builtins.str]] = None,
            tls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudApp':
        """
