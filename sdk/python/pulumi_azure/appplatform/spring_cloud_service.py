...
class SpringCloudServiceArgs:
    def __init__(__self__, *,
                 ...
                 build_agent_pool_size: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 log_stream_public_endpoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 service_registry_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies The name of the resource group in which to create the Spring Cloud Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] build_agent_pool_size: Specifies the size for this Spring Cloud Service's default build agent pool. Possible values are `S1`, `S2`, `S3`, `S4` and `S5`. This field is applicable only for Spring Cloud Service with enterprise tier.
        ...
        :param pulumi.Input[builtins.bool] log_stream_public_endpoint_enabled: Should the log stream in vnet injection instance could be accessed from Internet?
        :param pulumi.Input[builtins.str] managed_environment_id: The resource Id of the Managed Environment that the Spring Apps instance builds on. Can only be specified when `sku_tier` is set to `StandardGen2`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Spring Cloud Service resource. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] service_registry_enabled: Whether enable the default Service Registry. This field is applicable only for Spring Cloud Service with enterprise tier.
        :param pulumi.Input[builtins.str] sku_name: Specifies the SKU Name for this Spring Cloud Service. Possible values are `B0`, `S0` and `E0`. Defaults to `S0`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_tier: Specifies the SKU Tier for this Spring Cloud Service. Possible values are `Basic`, `Enterprise`, `Standard` and `StandardGen2`. The attribute is automatically computed from API response except when `managed_environment_id` is defined. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input['SpringCloudServiceTraceArgs'] trace: A `trace` block as defined below.
        :param pulumi.Input[builtins.bool] zone_redundant: Whether zone redundancy is enabled for this Spring Cloud Service. Defaults to `false`.
        """
    ...
    def build_agent_pool_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def build_agent_pool_size(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def log_stream_public_endpoint_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def log_stream_public_endpoint_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def service_registry_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def service_registry_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SpringCloudServiceState:
    def __init__(__self__, *,
                 ...
                 service_registry_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 service_registry_id: Optional[pulumi.Input[builtins.str]] = None,
                 sku_name: Optional[pulumi.Input[builtins.str]] = None,
                 sku_tier: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 trace: Optional[pulumi.Input['SpringCloudServiceTraceArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Spring Cloud Service resource. Changing this forces a new resource to be created.
        :param pulumi.Input['SpringCloudServiceNetworkArgs'] network: A `network` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outbound_public_ip_addresses: A list of the outbound Public IP Addresses used by this Spring Cloud Service.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies The name of the resource group in which to create the Spring Cloud Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] service_registry_enabled: Whether enable the default Service Registry. This field is applicable only for Spring Cloud Service with enterprise tier.
        :param pulumi.Input[builtins.str] service_registry_id: The ID of the Spring Cloud Service Registry.
        :param pulumi.Input[builtins.str] sku_name: Specifies the SKU Name for this Spring Cloud Service. Possible values are `B0`, `S0` and `E0`. Defaults to `S0`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_tier: Specifies the SKU Tier for this Spring Cloud Service. Possible values are `Basic`, `Enterprise`, `Standard` and `StandardGen2`. The attribute is automatically computed from API response except when `managed_environment_id` is defined. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input['SpringCloudServiceTraceArgs'] trace: A `trace` block as defined below.
    ...
    def service_registry_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_registry_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SpringCloudService(pulumi.CustomResource):
    ...
    pulumi_type = "azure:appplatform/springCloudService:SpringCloudService"
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            trace: Optional[pulumi.Input[Union['SpringCloudServiceTraceArgs', 'SpringCloudServiceTraceArgsDict']]] = None,
            zone_redundant: Optional[pulumi.Input[builtins.bool]] = None) -> 'SpringCloudService':
        """
    ...
    @property
    @pulumi.getter(name="buildAgentPoolSize")
    def build_agent_pool_size(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the size for this Spring Cloud Service's default build agent pool. Possible values are `S1`, `S2`, `S3`, `S4` and `S5`. This field is applicable only for Spring Cloud Service with enterprise tier.
        """
        return pulumi.get(self, "build_agent_pool_size")
    ...
    @property
    @pulumi.getter(name="logStreamPublicEndpointEnabled")
    def log_stream_public_endpoint_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the log stream in vnet injection instance could be accessed from Internet?
        """
        return pulumi.get(self, "log_stream_public_endpoint_enabled")
    ...
    @property
    @pulumi.getter(name="serviceRegistryEnabled")
    def service_registry_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether enable the default Service Registry. This field is applicable only for Spring Cloud Service with enterprise tier.
        """
        return pulumi.get(self, "service_registry_enabled")
    ...
    @property
    @pulumi.getter(name="serviceRegistryId")
    def service_registry_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Spring Cloud Service Registry.
        """
        return pulumi.get(self, "service_registry_id")
