...
class SpringCloudNewRelicApplicationPerformanceMonitoringArgs:
    def __init__(__self__, *,
                 ...
                 agent_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 app_server_port: Optional[pulumi.Input[builtins.int]] = None,
                 audit_mode_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_app_naming_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_transaction_naming_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 custom_tracing_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] app_name: Specifies the application name used to report data to New Relic.
        :param pulumi.Input[builtins.str] license_key: Specifies the license key associated with the New Relic account. This key binds your agent's data to your account in New Relic service.
        ...
        :param pulumi.Input[builtins.bool] agent_enabled: Specifies whether enable the agent. Defaults to `true`.
        :param pulumi.Input[builtins.int] app_server_port: Specifies the port number to differentiate JVMs for the same app on the same machine.
        :param pulumi.Input[builtins.bool] audit_mode_enabled: Specifies whether enable plain text logging of all data sent to New Relic to the agent logfile. Defaults to `false`.
        :param pulumi.Input[builtins.bool] auto_app_naming_enabled: Specifies whether enable the reporting of data separately for each web app. Defaults to `false`.
        :param pulumi.Input[builtins.bool] auto_transaction_naming_enabled: Specifies whether enable the component-based transaction naming. Defaults to `true`.
        :param pulumi.Input[builtins.bool] custom_tracing_enabled: Specifies whether enable all instrumentation using an `@Trace` annotation. Disabling this causes `@Trace` annotations to be ignored. Defaults to `true`.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Specifies a mapping of labels to be added to the New Relic application.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Spring Cloud Application Performance Monitoring resource for New Relic. Changing this forces a new resource to be created.
        """
    ...
    def agent_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def agent_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "agent_enabled", value)

    @property
    @pulumi.getter(name="appServerPort")
    def app_server_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def app_server_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "app_server_port", value)

    @property
    @pulumi.getter(name="auditModeEnabled")
    def audit_mode_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def audit_mode_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "audit_mode_enabled", value)

    @property
    @pulumi.getter(name="autoAppNamingEnabled")
    def auto_app_naming_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_app_naming_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_app_naming_enabled", value)

    @property
    @pulumi.getter(name="autoTransactionNamingEnabled")
    def auto_transaction_naming_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_transaction_naming_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_transaction_naming_enabled", value)

    @property
    @pulumi.getter(name="customTracingEnabled")
    def custom_tracing_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def custom_tracing_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SpringCloudNewRelicApplicationPerformanceMonitoring(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            license_key: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            spring_cloud_service_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudNewRelicApplicationPerformanceMonitoring':
        """
    ...
    @property
    @pulumi.getter(name="agentEnabled")
    def agent_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether enable the agent. Defaults to `true`.
        """
        return pulumi.get(self, "agent_enabled")
    ...
    @property
    @pulumi.getter(name="appServerPort")
    def app_server_port(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the port number to differentiate JVMs for the same app on the same machine.
        """
        return pulumi.get(self, "app_server_port")
    ...
    @property
    @pulumi.getter(name="auditModeEnabled")
    def audit_mode_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether enable plain text logging of all data sent to New Relic to the agent logfile. Defaults to `false`.
        """
        return pulumi.get(self, "audit_mode_enabled")
    ...
    @property
    @pulumi.getter(name="autoAppNamingEnabled")
    def auto_app_naming_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether enable the reporting of data separately for each web app. Defaults to `false`.
        """
        return pulumi.get(self, "auto_app_naming_enabled")
    ...
    @property
    @pulumi.getter(name="autoTransactionNamingEnabled")
    def auto_transaction_naming_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether enable the component-based transaction naming. Defaults to `true`.
        """
        return pulumi.get(self, "auto_transaction_naming_enabled")
    ...
    @property
    @pulumi.getter(name="customTracingEnabled")
    def custom_tracing_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether enable all instrumentation using an `@Trace` annotation. Disabling this causes `@Trace` annotations to be ignored. Defaults to `true`.
        """
        return pulumi.get(self, "custom_tracing_enabled")
