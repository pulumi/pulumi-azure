...
class SpringCloudBuildPackBindingArgs:
    def __init__(__self__, *,
                 spring_cloud_builder_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] spring_cloud_builder_id: The ID of the Spring Cloud Builder. Changing this forces a new Spring Cloud Build Pack Binding to be created.
        :param pulumi.Input[builtins.str] binding_type: Specifies the Build Pack Binding Type. Allowed values are `ApacheSkyWalking`, `AppDynamics`, `ApplicationInsights`, `Dynatrace`, `ElasticAPM` and `NewRelic`.
        :param pulumi.Input['SpringCloudBuildPackBindingLaunchArgs'] launch: A `launch` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Spring Cloud Build Pack Binding. Changing this forces a new Spring Cloud Build Pack Binding to be created.
        """
    ...
    def spring_cloud_builder_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def spring_cloud_builder_id(self, value: pulumi.Input[builtins.str]):
...
class _SpringCloudBuildPackBindingState:
    def __init__(__self__, *,
                 ...
                 launch: Optional[pulumi.Input['SpringCloudBuildPackBindingLaunchArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 spring_cloud_builder_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="springCloudBuilderId")
    def spring_cloud_builder_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Spring Cloud Builder. Changing this forces a new Spring Cloud Build Pack Binding to be created.
        """
        return pulumi.get(self, "spring_cloud_builder_id")
    ...
    @spring_cloud_builder_id.setter
    def spring_cloud_builder_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spring_cloud_builder_id", value)
...
class SpringCloudBuildPackBinding(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            launch: Optional[pulumi.Input[Union['SpringCloudBuildPackBindingLaunchArgs', 'SpringCloudBuildPackBindingLaunchArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            spring_cloud_builder_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SpringCloudBuildPackBinding':
        """
    ...
    @property
    @pulumi.getter(name="springCloudBuilderId")
    def spring_cloud_builder_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Spring Cloud Builder. Changing this forces a new Spring Cloud Build Pack Binding to be created.
        """
        return pulumi.get(self, "spring_cloud_builder_id")
