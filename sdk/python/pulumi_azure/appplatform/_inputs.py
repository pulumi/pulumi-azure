...
class SpringCloudAppCustomPersistentDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] storage_name: The name of the Spring Cloud Storage.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] mount_options: These are the mount options for a persistent disk.
        :param pulumi.Input[_builtins.bool] read_only_enabled: Indicates whether the persistent disk is a readOnly one.
        """
...
class SpringCloudAppIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Spring Cloud Application.
               ...
               > **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        :param pulumi.Input[_builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this Spring Cloud Application.
        :param pulumi.Input[_builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this Spring Cloud Application.
        """
...
class SpringCloudAppIngressSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] send_timeout_in_seconds: Specifies the ingress send time out in seconds. Defaults to `60`.
        :param pulumi.Input[_builtins.str] session_affinity: Specifies the type of the affinity, set this to `Cookie` to enable session affinity. Allowed values are `Cookie` and `None`. Defaults to `None`.
        :param pulumi.Input[_builtins.int] session_cookie_max_age: Specifies the time in seconds until the cookie expires.
        """
...
class SpringCloudBuildDeploymentQuotaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cpu: Specifies the required cpu of the Spring Cloud Deployment. Possible Values are `500m`, `1`, `2`, `3` and `4`. Defaults to `1` if not specified.
               ...
               > **Note:** `cpu` supports `500m` and `1` for Basic tier, `500m`, `1`, `2`, `3` and `4` for Standard tier.
        :param pulumi.Input[_builtins.str] memory: Specifies the required memory size of the Spring Cloud Deployment. Possible Values are `512Mi`, `1Gi`, `2Gi`, `3Gi`, `4Gi`, `5Gi`, `6Gi`, `7Gi`, and `8Gi`. Defaults to `1Gi` if not specified.
...
class SpringCloudBuilderStackArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] id: Specifies the ID of the ClusterStack.
        :param pulumi.Input[_builtins.str] version: Specifies the version of the ClusterStack
        """
...
class SpringCloudConfigurationServiceRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] patterns: Specifies the collection of patterns of the repository.
        :param pulumi.Input[_builtins.str] uri: Specifies the URI of the repository.
        :param pulumi.Input[_builtins.str] ca_certificate_id: Specifies the ID of the Certificate Authority used when retrieving the Git Repository via HTTPS.
        :param pulumi.Input[_builtins.str] host_key: Specifies the SSH public key of git repository.
        :param pulumi.Input[_builtins.str] host_key_algorithm: Specifies the SSH key algorithm of git repository.
        :param pulumi.Input[_builtins.str] password: Specifies the password of git repository basic auth.
        :param pulumi.Input[_builtins.str] private_key: Specifies the SSH private key of git repository.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] search_paths: Specifies a list of searching path of the repository
        :param pulumi.Input[_builtins.bool] strict_host_key_checking: Specifies whether enable the strict host key checking.
        :param pulumi.Input[_builtins.str] username: Specifies the username of git repository basic auth.
        """
...
class SpringCloudConnectionAuthenticationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Username or account name for secret auth. `name` and `secret` should be either both specified or both not specified when `type` is set to `secret`.
        :param pulumi.Input[_builtins.str] principal_id: Principal ID for `servicePrincipal` auth. Should be specified when `type` is set to `servicePrincipalSecret` or `servicePrincipalCertificate`.
        :param pulumi.Input[_builtins.str] secret: Password or account key for secret auth. `secret` and `name` should be either both specified or both not specified when `type` is set to `secret`.
        :param pulumi.Input[_builtins.str] subscription_id: Subscription ID for `userAssignedIdentity`. `subscription_id` and `client_id` should be either both specified or both not specified.
        """
        pulumi.set(__self__, "type", type)
...
class SpringCloudCustomizedAcceleratorGitRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] branch: Specifies the Git repository branch to be used.
        :param pulumi.Input[_builtins.str] ca_certificate_id: Specifies the ID of the CA Spring Cloud Certificate for https URL of Git repository.
        :param pulumi.Input[_builtins.str] commit: Specifies the Git repository commit to be used.
        :param pulumi.Input[_builtins.str] git_tag: Specifies the Git repository tag to be used.
        :param pulumi.Input[_builtins.int] interval_in_seconds: Specifies the interval for checking for updates to Git or image repository. It should be greater than 10.
        :param pulumi.Input[_builtins.str] path: Specifies the path under the git repository to be treated as the root directory of the accelerator or the fragment (depending on `accelerator_type`).
...
class SpringCloudCustomizedAcceleratorGitRepositorySshAuthArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] host_key_algorithm: Specifies the SSH Key algorithm of git repository basic auth.
        """
        pulumi.set(__self__, "private_key", private_key)
        if host_key is not None:
            pulumi.set(__self__, "host_key", host_key)
...
class SpringCloudDevToolPortalSsoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] metadata_url: Specifies the URI of a JSON file with generic OIDC provider configuration.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] scopes: Specifies a list of specific actions applications can be allowed to do on a user's behalf.
        """
        if client_id is not None:
            pulumi.set(__self__, "client_id", client_id)
        if client_secret is not None:
...
class SpringCloudGatewayApiMetadataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] title: Specifies the title describing the context of the APIs available on the Gateway instance.
        :param pulumi.Input[_builtins.str] version: Specifies the version of APIs available on this Gateway instance.
        """
...
class SpringCloudGatewayCorsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] credentials_allowed: is user credentials are supported on cross-site requests?
        ...
        :param pulumi.Input[_builtins.int] max_age_seconds: How long, in seconds, the response from a pre-flight request can be cached by clients.
        """
...
class SpringCloudGatewayQuotaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] cpu: Specifies the required cpu of the Spring Cloud Deployment. Possible Values are `500m`, `1`, `2`, `3` and `4`. Defaults to `1` if not specified.
               ...
               > **Note:** `cpu` supports `500m` and `1` for Basic tier, `500m`, `1`, `2`, `3` and `4` for Standard tier.
        :param pulumi.Input[_builtins.str] memory: Specifies the required memory size of the Spring Cloud Deployment. Possible Values are `512Mi`, `1Gi`, `2Gi`, `3Gi`, `4Gi`, `5Gi`, `6Gi`, `7Gi`, and `8Gi`. Defaults to `2Gi` if not specified.
...
class SpringCloudGatewayRouteConfigRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Specifies the description which will be applied to methods in the generated OpenAPI documentation.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] filters: Specifies a list of filters which are used to modify the request before sending it to the target endpoint, or the received response.
        ...
        :param pulumi.Input[_builtins.bool] sso_validation_enabled: Should the sso validation be enabled?
        :param pulumi.Input[_builtins.str] title: Specifies the title which will be applied to methods in the generated OpenAPI documentation.
        :param pulumi.Input[_builtins.bool] token_relay: Should pass currently-authenticated user's identity token to application service?
        :param pulumi.Input[_builtins.str] uri: Specifies the full uri which will override `appName`.
        """
...
class SpringCloudServiceConfigServerGitSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] label: The default label of the Git repository, should be the branch name, tag name, or commit-id of the repository.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] search_paths: An array of strings used to search subdirectories of the Git repository.
...
class SpringCloudServiceConfigServerGitSettingHttpBasicAuthArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: The password used to access the Git repository server, required when the Git repository server supports HTTP Basic Authentication.
        :param pulumi.Input[_builtins.str] username: The username that's used to access the Git repository server, required when the Git repository server supports HTTP Basic Authentication.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
...
class SpringCloudServiceConfigServerGitSettingRepositoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] label: The default label of the Git repository, should be the branch name, tag name, or commit-id of the repository.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] patterns: An array of strings used to match an application name. For each pattern, use the `{application}/{profile}` format with wildcards.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] search_paths: An array of strings used to search subdirectories of the Git repository.
...
class SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] host_key_algorithm: The host key algorithm, should be `ssh-dss`, `ssh-rsa`, `ecdsa-sha2-nistp256`, `ecdsa-sha2-nistp384`, or `ecdsa-sha2-nistp521`. Required only if `host-key` exists.
        :param pulumi.Input[_builtins.bool] strict_host_key_checking_enabled: Indicates whether the Config Server instance will fail to start if the host_key does not match. Defaults to `true`.
        """
        pulumi.set(__self__, "private_key", private_key)
        if host_key is not None:
            pulumi.set(__self__, "host_key", host_key)
...
class SpringCloudServiceContainerRegistryArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: Specifies the name of the container registry.
        :param pulumi.Input[_builtins.str] password: Specifies the password of the container registry.
        :param pulumi.Input[_builtins.str] server: Specifies the login server of the container registry.
        :param pulumi.Input[_builtins.str] username: Specifies the username of the container registry.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "password", password)
...
class SpringCloudServiceMarketplaceArgs:
    def __init__(__self__, *,
                 ...
                 publisher: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] plan: Specifies the plan ID of the 3rd Party Artifact that is being procured.
        :param pulumi.Input[_builtins.str] product: Specifies the 3rd Party artifact that is being procured.
        :param pulumi.Input[_builtins.str] publisher: Specifies the publisher ID of the 3rd Party Artifact that is being procured.
        """
...
class SpringCloudServiceNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] service_runtime_subnet_id: Specifies the ID of the Subnet where the Service Runtime components of the Spring Cloud Service will exist. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] app_network_resource_group: Specifies the Name of the resource group containing network resources of Azure Spring Cloud Apps. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] outbound_type: Specifies the egress traffic type of the Spring Cloud Service. Possible values are `loadBalancer` and `userDefinedRouting`. Defaults to `loadBalancer`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.int] read_timeout_seconds: Ingress read time out in seconds.
        :param pulumi.Input[_builtins.str] service_runtime_network_resource_group: Specifies the Name of the resource group containing network resources of Azure Spring Cloud Service Runtime. Changing this forces a new resource to be created.
        """
    ...
    def app_subnet_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the ID of the Subnet which should host the Spring Boot Applications deployed in this Spring Cloud Service. Changing this forces a new resource to be created.
        """
    ...
    def app_subnet_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def service_runtime_subnet_id(self) -> pulumi.Input[_builtins.str]:
        """
        Specifies the ID of the Subnet where the Service Runtime components of the Spring Cloud Service will exist. Changing this forces a new resource to be created.
        """
    ...
    def service_runtime_subnet_id(self, value: pulumi.Input[_builtins.str]):
...
class SpringCloudServiceRequiredNetworkTrafficRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_addresses: The IP list of required traffic.
        :param pulumi.Input[_builtins.int] port: The port of required traffic.
        :param pulumi.Input[_builtins.str] protocol: The protocol of required traffic.
        """
