...
class SharedPrivateLinkResourceArgs:
    def __init__(__self__, *,
                 signalr_service_id: pulumi.Input[builtins.str],
                 sub_resource_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] signalr_service_id: The id of the Signalr Service. Changing this forces a new resource to be created.
    ...
    def signalr_service_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def signalr_service_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "signalr_service_id", value)

    @property
    @pulumi.getter(name="subResourceName")
    def sub_resource_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sub_resource_name(self, value: pulumi.Input[builtins.str]):
...
class _SharedPrivateLinkResourceState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 request_message: Optional[pulumi.Input[builtins.str]] = None,
                 signalr_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 sub_resource_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] request_message: The request message for requesting approval of the Shared Private Link Enabled Remote Resource.
        :param pulumi.Input[builtins.str] signalr_service_id: The id of the Signalr Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] status: The status of a private endpoint connection. Possible values are `Pending`, `Approved`, `Rejected` or `Disconnected`.
        :param pulumi.Input[builtins.str] sub_resource_name: The sub resource name which the Signalr Private Endpoint can connect to. Possible values are `sites`, `vault`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_resource_id: The ID of the Shared Private Link Enabled Remote Resource which this Signalr Private Endpoint should be connected to. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="signalrServiceId")
    def signalr_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The id of the Signalr Service. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "signalr_service_id")
    ...
    @signalr_service_id.setter
    def signalr_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signalr_service_id", value)
    ...
    @property
    @pulumi.getter(name="subResourceName")
    def sub_resource_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The sub resource name which the Signalr Private Endpoint can connect to. Possible values are `sites`, `vault`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sub_resource_name")
    ...
    @sub_resource_name.setter
    def sub_resource_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sub_resource_name", value)
...
class SharedPrivateLinkResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            sub_resource_name: Optional[pulumi.Input[builtins.str]] = None,
            target_resource_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SharedPrivateLinkResource':
        """
    ...
    @property
    @pulumi.getter(name="signalrServiceId")
    def signalr_service_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the Signalr Service. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "signalr_service_id")
    ...
    @property
    @pulumi.getter(name="subResourceName")
    def sub_resource_name(self) -> pulumi.Output[builtins.str]:
        """
        The sub resource name which the Signalr Private Endpoint can connect to. Possible values are `sites`, `vault`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "sub_resource_name")
