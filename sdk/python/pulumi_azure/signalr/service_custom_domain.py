...
class ServiceCustomDomainArgs:
    def __init__(__self__, *,
                 ...
                 signalr_custom_certificate_id: pulumi.Input[builtins.str],
    ...
    def signalr_custom_certificate_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def signalr_custom_certificate_id(self, value: pulumi.Input[builtins.str]):
...
class _ServiceCustomDomainState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 signalr_custom_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="signalrCustomCertificateId")
    def signalr_custom_certificate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the SignalR Custom Certificate ID of the SignalR Custom Domain. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "signalr_custom_certificate_id")
    ...
    @signalr_custom_certificate_id.setter
    def signalr_custom_certificate_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signalr_custom_certificate_id", value)
...
class ServiceCustomDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            signalr_custom_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
            signalr_service_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ServiceCustomDomain':
        """
    ...
    @property
    @pulumi.getter(name="signalrCustomCertificateId")
    def signalr_custom_certificate_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the SignalR Custom Certificate ID of the SignalR Custom Domain. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "signalr_custom_certificate_id")
