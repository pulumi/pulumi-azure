...
def get_network_sim_group(mobile_network_id: Optional[builtins.str] = None,
    ...
    * `Microsoft.MobileNetwork`: 2022-11-01
    ...
    :param builtins.str mobile_network_id: The ID of Mobile Network which the Mobile Network Sim Group belongs to.
    :param builtins.str name: Specifies the name which should be used for this Mobile Network Sim Groups.
    """
    __args__ = dict()
...
def get_network_sim_group_output(mobile_network_id: Optional[pulumi.Input[builtins.str]] = None,
                                 name: Optional[pulumi.Input[builtins.str]] = None,
                                 opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNetworkSimGroupResult]:
    """
    Get information about a Mobile Network Sim Group.
