...
def get_network_packet_core_data_plane(mobile_network_packet_core_control_plane_id: Optional[builtins.str] = None,
...
def get_network_packet_core_data_plane_output(mobile_network_packet_core_control_plane_id: Optional[pulumi.Input[builtins.str]] = None,
