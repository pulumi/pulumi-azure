...
def get_network_service(mobile_network_id: Optional[builtins.str] = None,
    ...
    * `Microsoft.MobileNetwork`: 2022-11-01
    ...
    :param builtins.str mobile_network_id: Specifies the ID of the Mobile Network Service.
...
def get_network_service_output(mobile_network_id: Optional[pulumi.Input[builtins.str]] = None,
