...
@pulumi.output_type
calass GetNetworkDataNetworkResult:
    """
...
calass AwaitableGetNetworkDataNetworkResult(GetNetworkDataNetworkResult):
...
def get_network_data_network(mobile_network_id: Optional[str] = None,
    ...
    example_network_data_network = azure.mobile.get_network_data_network(name="example-mndn",
