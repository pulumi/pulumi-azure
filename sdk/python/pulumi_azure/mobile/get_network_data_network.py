...
def get_network_data_network(mobile_network_id: Optional[builtins.str] = None,
...
def get_network_data_network_output(mobile_network_id: Optional[pulumi.Input[builtins.str]] = None,
