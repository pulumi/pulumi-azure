...
def get_network_sim(mobile_network_sim_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str mobile_network_sim_group_id: The ID of the Mobile Network which the Mobile Network Sim belongs to.
    :param builtins.str name: The name which should be used for this Mobile Network Sim.
    """
    __args__ = dict()
...
def get_network_sim_output(mobile_network_sim_group_id: Optional[pulumi.Input[builtins.str]] = None,
