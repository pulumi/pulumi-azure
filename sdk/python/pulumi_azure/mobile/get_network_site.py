...
class GetNetworkSiteResult:
    ...
    def network_function_ids(self) -> Sequence[_builtins.str]:
        """
...
def get_network_site(mobile_network_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.MobileNetwork`: 2022-11-01
    ...
    :param _builtins.str mobile_network_id: the ID of the Mobile Network which the Mobile Network Site belongs to.
    :param _builtins.str name: The name which should be used for this Mobile Network Site.
    """
    __args__ = dict()
...
def get_network_site_output(mobile_network_id: Optional[pulumi.Input[_builtins.str]] = None,
