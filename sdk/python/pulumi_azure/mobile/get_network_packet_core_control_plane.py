...
class GetNetworkPacketCoreControlPlaneResult:
    ...
    def site_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def user_equipment_mtu_in_bytes(self) -> builtins.int:
        """
...
def get_network_packet_core_control_plane(name: Optional[builtins.str] = None,
...
def get_network_packet_core_control_plane_output(name: Optional[pulumi.Input[builtins.str]] = None,
