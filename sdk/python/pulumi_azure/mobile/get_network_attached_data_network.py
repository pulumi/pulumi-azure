...
class GetNetworkAttachedDataNetworkResult:
    ...
    def user_equipment_address_pool_prefixes(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "user_equipment_address_pool_prefixes")

    @property
    @pulumi.getter(name="userEquipmentStaticAddressPoolPrefixes")
    def user_equipment_static_address_pool_prefixes(self) -> Sequence[builtins.str]:
...
def get_network_attached_data_network(mobile_network_data_network_name: Optional[builtins.str] = None,
                                      mobile_network_packet_core_data_plane_id: Optional[builtins.str] = None,
...
def get_network_attached_data_network_output(mobile_network_data_network_name: Optional[pulumi.Input[builtins.str]] = None,
