...
class GetNetworkResult:
    ...
    def mobile_network_code(self) -> _builtins.str:
        """
...
def get_network(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.MobileNetwork`: 2022-11-01
    ...
    :param _builtins.str resource_group_name: Specifies the name of the Resource Group where the Mobile Network should exist.
    """
    __args__ = dict()
    __args__['name'] = name
