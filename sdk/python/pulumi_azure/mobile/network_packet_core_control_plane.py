...
class NetworkPacketCoreControlPlaneArgs:
    def __init__(__self__, *,
                 ...
                 site_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 sku: pulumi.Input[builtins.str],
                 control_plane_access_ipv4_address: Optional[pulumi.Input[builtins.str]] = None,
                 control_plane_access_ipv4_gateway: Optional[pulumi.Input[builtins.str]] = None,
                 control_plane_access_ipv4_subnet: Optional[pulumi.Input[builtins.str]] = None,
                 control_plane_access_name: Optional[pulumi.Input[builtins.str]] = None,
                 core_network_technology: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['NetworkPacketCoreControlPlaneIdentityArgs']] = None,
                 interoperability_settings_json: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 user_equipment_mtu_in_bytes: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Mobile Network Packet Core Control Plane should exist. Changing this forces a new Mobile Network Packet Core Control Plane to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] site_ids: A list of Mobile Network Site IDs in which this packet core control plane should be deployed. The Sites must be in the same location as the packet core control plane.
        :param pulumi.Input[builtins.str] sku: The SKU defining the throughput and SIM allowances for this packet core control plane deployment. Possible values are `G0`, `G1`, `G2`, `G3`, `G4`, `G5` and `G10`.
        :param pulumi.Input[builtins.str] control_plane_access_ipv4_address: The IPv4 address for the control plane interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        :param pulumi.Input[builtins.str] control_plane_access_ipv4_gateway: The default IPv4 gateway for the control plane interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        :param pulumi.Input[builtins.str] control_plane_access_ipv4_subnet: The IPv4 subnet for the control plane interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        :param pulumi.Input[builtins.str] control_plane_access_name: Specifies the logical name for this interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        :param pulumi.Input[builtins.str] core_network_technology: The core network technology generation. Possible values are `5GC` and `EPC`.
        :param pulumi.Input['NetworkPacketCoreControlPlaneIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] interoperability_settings_json: Settings in JSON format to allow interoperability with third party components e.g. RANs and UEs.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Mobile Network Packet Core Control Plane should exist. Changing this forces a new Mobile Network Packet Core Control Plane to be created.
        :param pulumi.Input[builtins.str] name: Specifies The name of the Mobile Network Packet Core Control Plane. Changing this forces a new Mobile Network Packet Core Control Plane to be created.
        :param pulumi.Input['NetworkPacketCoreControlPlanePlatformArgs'] platform: A `platform` block as defined below.
        :param pulumi.Input[builtins.str] software_version: Specifies the version of the packet core software that is deployed.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Mobile Network Packet Core Control Plane.
        :param pulumi.Input[builtins.int] user_equipment_mtu_in_bytes: Specifies the MTU in bytes that can be sent to the user equipment. The same MTU is set on the user plane data links for all data networks. The MTU set on the user plane access link will be 60 bytes greater than this value to allow for GTP encapsulation.
        """
    ...
    def site_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @site_ids.setter
    def site_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def control_plane_access_ipv4_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def control_plane_access_ipv4_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "control_plane_access_ipv4_address", value)

    @property
    @pulumi.getter(name="controlPlaneAccessIpv4Gateway")
    def control_plane_access_ipv4_gateway(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def control_plane_access_ipv4_gateway(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "control_plane_access_ipv4_gateway", value)

    @property
    @pulumi.getter(name="controlPlaneAccessIpv4Subnet")
    def control_plane_access_ipv4_subnet(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def control_plane_access_ipv4_subnet(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "control_plane_access_ipv4_subnet", value)

    @property
    @pulumi.getter(name="controlPlaneAccessName")
    def control_plane_access_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def control_plane_access_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "control_plane_access_name", value)

    @property
    @pulumi.getter(name="coreNetworkTechnology")
    def core_network_technology(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def core_network_technology(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def interoperability_settings_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def interoperability_settings_json(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_equipment_mtu_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def user_equipment_mtu_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class NetworkPacketCoreControlPlane(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            software_version: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            user_equipment_mtu_in_bytes: Optional[pulumi.Input[builtins.int]] = None) -> 'NetworkPacketCoreControlPlane':
        """
    ...
    @property
    @pulumi.getter(name="controlPlaneAccessIpv4Address")
    def control_plane_access_ipv4_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv4 address for the control plane interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        """
        return pulumi.get(self, "control_plane_access_ipv4_address")
    ...
    @property
    @pulumi.getter(name="controlPlaneAccessIpv4Gateway")
    def control_plane_access_ipv4_gateway(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default IPv4 gateway for the control plane interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        """
        return pulumi.get(self, "control_plane_access_ipv4_gateway")
    ...
    @property
    @pulumi.getter(name="controlPlaneAccessIpv4Subnet")
    def control_plane_access_ipv4_subnet(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv4 subnet for the control plane interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        """
        return pulumi.get(self, "control_plane_access_ipv4_subnet")
    ...
    @property
    @pulumi.getter(name="controlPlaneAccessName")
    def control_plane_access_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the logical name for this interface. This should match one of the interfaces configured on your Azure Stack Edge device.
        """
        return pulumi.get(self, "control_plane_access_name")
    ...
    @property
    @pulumi.getter(name="interoperabilitySettingsJson")
    def interoperability_settings_json(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Settings in JSON format to allow interoperability with third party components e.g. RANs and UEs.
        """
        return pulumi.get(self, "interoperability_settings_json")
    ...
    @property
    @pulumi.getter(name="siteIds")
    def site_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Mobile Network Site IDs in which this packet core control plane should be deployed. The Sites must be in the same location as the packet core control plane.
        """
        return pulumi.get(self, "site_ids")
    ...
    @property
    @pulumi.getter(name="userEquipmentMtuInBytes")
    def user_equipment_mtu_in_bytes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the MTU in bytes that can be sent to the user equipment. The same MTU is set on the user plane data links for all data networks. The MTU set on the user plane access link will be 60 bytes greater than this value to allow for GTP encapsulation.
        """
        return pulumi.get(self, "user_equipment_mtu_in_bytes")
