...
def get_network_slice(mobile_network_id: Optional[builtins.str] = None,
...
def get_network_slice_output(mobile_network_id: Optional[pulumi.Input[builtins.str]] = None,
