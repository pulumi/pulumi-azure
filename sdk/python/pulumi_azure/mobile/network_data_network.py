...
class NetworkDataNetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] mobile_network_id: Specifies the ID of the Mobile Network. Changing this forces a new Mobile Network Data Network to be created.
        :param pulumi.Input[builtins.str] description: A description of this Mobile Network Data Network.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Mobile Network Data Network should exist. Changing this forces a new Mobile Network Data Network to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Mobile Network Data Network. Changing this forces a new Mobile Network Data Network to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Mobile Network Data Network.
        """
...
class NetworkDataNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            mobile_network_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'NetworkDataNetwork':
        """
