...
class GetLBOutboundRuleResult:
    ...
    def allocated_outbound_ports(self) -> builtins.int:
        """
    ...
    def tcp_reset_enabled(self) -> builtins.bool:
        """
...
def get_lb_outbound_rule(loadbalancer_id: Optional[builtins.str] = None,
...
def get_lb_outbound_rule_output(loadbalancer_id: Optional[pulumi.Input[builtins.str]] = None,
