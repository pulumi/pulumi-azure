...
class BackendAddressPoolAddressArgs:
    def __init__(__self__, *,
                 ...
                 backend_address_ip_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] backend_address_pool_id: The ID of the Backend Address Pool. Changing this forces a new Backend Address Pool Address to be created.
        :param pulumi.Input[builtins.str] backend_address_ip_configuration_id: The ip config ID of the regional load balancer that's added to the global load balancer's backend address pool.
        ...
        :param pulumi.Input[builtins.str] ip_address: The Static IP Address which should be allocated to this Backend Address Pool.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Backend Address Pool Address. Changing this forces a new Backend Address Pool Address to be created.
    ...
    def backend_address_ip_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backend_address_ip_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackendAddressPoolAddress(pulumi.CustomResource):
    ...
    pulumi_type = "azure:lb/backendAddressPoolAddress:BackendAddressPoolAddress"
    ...
    def get(resource_name: str,
            ...
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            virtual_network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackendAddressPoolAddress':
        """
    ...
    @property
    @pulumi.getter(name="backendAddressIpConfigurationId")
    def backend_address_ip_configuration_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ip config ID of the regional load balancer that's added to the global load balancer's backend address pool.
