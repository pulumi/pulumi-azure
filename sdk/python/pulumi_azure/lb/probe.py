...
class ProbeArgs:
    def __init__(__self__, *,
                 ...
                 number_of_probes: Optional[pulumi.Input[builtins.int]] = None,
                 probe_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 protocol: Optional[pulumi.Input[builtins.str]] = None,
                 request_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Probe resource.
        :param pulumi.Input[builtins.str] loadbalancer_id: The ID of the LoadBalancer in which to create the Probe. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] port: Port on which the Probe queries the backend endpoint. Possible values range from 1 to 65535, inclusive.
        :param pulumi.Input[builtins.int] interval_in_seconds: The interval, in seconds between probes to the backend endpoint for health status. The default value is 15, the minimum value is 5.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Probe. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] number_of_probes: The number of failed probe attempts after which the backend endpoint is removed from rotation. Default to `2`. NumberOfProbes multiplied by intervalInSeconds value must be greater or equal to 10.Endpoints are returned to rotation when at least one probe is successful.
        :param pulumi.Input[builtins.int] probe_threshold: The number of consecutive successful or failed probes that allow or deny traffic to this endpoint. Possible values range from `1` to `100`. The default value is `1`.
        :param pulumi.Input[builtins.str] protocol: Specifies the protocol of the end point. Possible values are `Http`, `Https` or `Tcp`. If TCP is specified, a received ACK is required for the probe to be successful. If HTTP is specified, a 200 OK response from the specified URI is required for the probe to be successful. Defaults to `Tcp`.
        :param pulumi.Input[builtins.str] request_path: The URI used for requesting health status from the backend endpoint. Required if protocol is set to `Http` or `Https`. Otherwise, it is not allowed.
        """
    ...
    def number_of_probes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_probes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "number_of_probes", value)

    @property
    @pulumi.getter(name="probeThreshold")
    def probe_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def probe_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Probe(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            probe_threshold: Optional[pulumi.Input[builtins.int]] = None,
            protocol: Optional[pulumi.Input[builtins.str]] = None,
            request_path: Optional[pulumi.Input[builtins.str]] = None) -> 'Probe':
        """
    ...
    @property
    @pulumi.getter(name="intervalInSeconds")
    def interval_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The interval, in seconds between probes to the backend endpoint for health status. The default value is 15, the minimum value is 5.
        """
        return pulumi.get(self, "interval_in_seconds")
    ...
    @property
    @pulumi.getter(name="loadBalancerRules")
    def load_balancer_rules(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "load_balancer_rules")
    ...
    @property
    @pulumi.getter(name="numberOfProbes")
    def number_of_probes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of failed probe attempts after which the backend endpoint is removed from rotation. Default to `2`. NumberOfProbes multiplied by intervalInSeconds value must be greater or equal to 10.Endpoints are returned to rotation when at least one probe is successful.
        """
        return pulumi.get(self, "number_of_probes")
    ...
    @property
    @pulumi.getter(name="probeThreshold")
    def probe_threshold(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of consecutive successful or failed probes that allow or deny traffic to this endpoint. Possible values range from `1` to `100`. The default value is `1`.
        """
        return pulumi.get(self, "probe_threshold")
