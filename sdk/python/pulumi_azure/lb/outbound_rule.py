...
class OutboundRuleArgs:
    def __init__(__self__, *,
                 backend_address_pool_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] backend_address_pool_id: The ID of the Backend Address Pool. Outbound traffic is randomly load balanced across IPs in the backend IPs.
        :param pulumi.Input[builtins.str] loadbalancer_id: The ID of the Load Balancer in which to create the Outbound Rule. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.int] allocated_outbound_ports: The number of outbound ports to be used for NAT. Defaults to `1024`.
        ...
        :param pulumi.Input[builtins.int] idle_timeout_in_minutes: The timeout for the TCP idle connection Defaults to `4`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Outbound Rule. Changing this forces a new resource to be created.
        """
    ...
    def backend_address_pool_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def backend_address_pool_id(self, value: pulumi.Input[builtins.str]):
...
class OutboundRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            loadbalancer_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            protocol: Optional[pulumi.Input[builtins.str]] = None) -> 'OutboundRule':
        """
    ...
    @property
    @pulumi.getter(name="allocatedOutboundPorts")
    def allocated_outbound_ports(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of outbound ports to be used for NAT. Defaults to `1024`.
        """
        return pulumi.get(self, "allocated_outbound_ports")
    ...
    @property
    @pulumi.getter(name="backendAddressPoolId")
    def backend_address_pool_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Backend Address Pool. Outbound traffic is randomly load balanced across IPs in the backend IPs.
        """
        return pulumi.get(self, "backend_address_pool_id")
