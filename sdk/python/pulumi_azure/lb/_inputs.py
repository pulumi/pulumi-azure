...
if not MYPY:
    class BackendAddressPoolAddressInboundNatRulePortMappingArgsDict(TypedDict):
        ...
        """
        inbound_nat_rule_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BackendAddressPoolAddressInboundNatRulePortMappingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] backend_port: The Backend Port of the Load Balancing Inbound NAT Rules associated with this Backend Address Pool Address.
        :param pulumi.Input[builtins.int] frontend_port: The Frontend Port of the Load Balancing Inbound NAT Rules associated with this Backend Address Pool Address.
        :param pulumi.Input[builtins.str] inbound_nat_rule_name: The name of the Load Balancing Inbound NAT Rules associated with this Backend Address Pool Address.
        """
...
if not MYPY:
    class BackendAddressPoolTunnelInterfaceArgsDict(TypedDict):
        identifier: pulumi.Input[builtins.int]
        """
...
class BackendAddressPoolTunnelInterfaceArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] identifier: The unique identifier of this Gateway Load Balancer Tunnel Interface.
        :param pulumi.Input[builtins.int] port: The port number that this Gateway Load Balancer Tunnel Interface listens to.
        :param pulumi.Input[builtins.str] protocol: The protocol used for this Gateway Load Balancer Tunnel Interface. Possible values are `None`, `Native` and `VXLAN`.
        :param pulumi.Input[builtins.str] type: The traffic type of this Gateway Load Balancer Tunnel Interface. Possible values are `None`, `Internal` and `External`.
        """
    ...
    @property
    @pulumi.getter
    def identifier(self) -> pulumi.Input[builtins.int]:
        """
        The unique identifier of this Gateway Load Balancer Tunnel Interface.
        """
    ...
    @identifier.setter
    def identifier(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class LoadBalancerFrontendIpConfigurationArgsDict(TypedDict):
        ...
        """
        gateway_load_balancer_frontend_ip_configuration_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        inbound_nat_rules: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of IDs of inbound rules that use this frontend IP.
        """
        load_balancer_rules: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The list of IDs of load balancing rules that use this frontend IP.
        """
        outbound_rules: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        private_ip_address_allocation: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        public_ip_prefix_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LoadBalancerFrontendIpConfigurationArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 gateway_load_balancer_frontend_ip_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 inbound_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 load_balancer_rules: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 private_ip_address_allocation: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the frontend IP configuration.
        :param pulumi.Input[builtins.str] gateway_load_balancer_frontend_ip_configuration_id: The Frontend IP Configuration ID of a Gateway SKU Load Balancer.
        :param pulumi.Input[builtins.str] id: The id of the Frontend IP Configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inbound_nat_rules: The list of IDs of inbound rules that use this frontend IP.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancer_rules: The list of IDs of load balancing rules that use this frontend IP.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outbound_rules: The list of IDs outbound rules that use this frontend IP.
        :param pulumi.Input[builtins.str] private_ip_address: Private IP Address to assign to the Load Balancer. The last one and first four IPs in any range are reserved and cannot be manually assigned.
        :param pulumi.Input[builtins.str] private_ip_address_allocation: The allocation method for the Private IP Address used by this Load Balancer. Possible values as `Dynamic` and `Static`.
        :param pulumi.Input[builtins.str] private_ip_address_version: The version of IP that the Private IP Address is. Possible values are `IPv4` or `IPv6`.
        :param pulumi.Input[builtins.str] public_ip_address_id: The ID of a Public IP Address which should be associated with the Load Balancer.
        :param pulumi.Input[builtins.str] public_ip_prefix_id: The ID of a Public IP Prefix which should be associated with the Load Balancer. Public IP Prefix can only be used with outbound rules.
    ...
    def gateway_load_balancer_frontend_ip_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Frontend IP Configuration ID of a Gateway SKU Load Balancer.
        """
    ...
    def gateway_load_balancer_frontend_ip_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def inbound_nat_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of IDs of inbound rules that use this frontend IP.
        """
    ...
    def inbound_nat_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "inbound_nat_rules", value)

    @property
    @pulumi.getter(name="loadBalancerRules")
    def load_balancer_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of IDs of load balancing rules that use this frontend IP.
        """
    ...
    def load_balancer_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def private_ip_address_allocation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The allocation method for the Private IP Address used by this Load Balancer. Possible values as `Dynamic` and `Static`.
        """
    ...
    def private_ip_address_allocation(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OutboundRuleFrontendIpConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the Frontend IP Configuration.
        :param pulumi.Input[builtins.str] id: The ID of the Load Balancer Outbound Rule.
        """
        pulumi.set(__self__, "name", name)
        if id is not None:
            pulumi.set(__self__, "id", id)
