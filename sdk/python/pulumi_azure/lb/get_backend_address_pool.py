...
class GetBackendAddressPoolResult:
    ...
    def inbound_nat_rules(self) -> Sequence[builtins.str]:
        """
    ...
    def load_balancing_rules(self) -> Sequence[builtins.str]:
        """
    ...
    def outbound_rules(self) -> Sequence[builtins.str]:
        """
...
def get_backend_address_pool(loadbalancer_id: Optional[builtins.str] = None,
...
def get_backend_address_pool_output(loadbalancer_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    * `Microsoft.Network`: 2023-09-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:lb/getBackendAddressPool:getBackendAddressPool', __args__, opts=opts, typ=GetBackendAddressPoolResult)
    return __ret__.apply(lambda __response__: GetBackendAddressPoolResult(
        backend_addresses=pulumi.get(__response__, 'backend_addresses'),
