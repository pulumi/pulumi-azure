...
class BackendAddressPoolArgs:
    def __init__(__self__, *,
                 ...
                 synchronous_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] loadbalancer_id: The ID of the Load Balancer in which to create the Backend Address Pool. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Backend Address Pool. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] synchronous_mode: The backend address synchronous mode for the Backend Address Pool. Possible values are `Automatic` and `Manual`. This is required with `virtual_network_id`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] virtual_network_id: The ID of the Virtual Network within which the Backend Address Pool should exist.
        """
    ...
    def synchronous_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def synchronous_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BackendAddressPoolState:
    def __init__(__self__, *,
                 backend_ip_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inbound_nat_rules: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 load_balancing_rules: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backend_ip_configurations: The Backend IP Configurations associated with this Backend Address Pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inbound_nat_rules: An array of the Load Balancing Inbound NAT Rules associated with this Backend Address Pool.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancing_rules: The Load Balancing Rules associated with this Backend Address Pool.
        :param pulumi.Input[builtins.str] loadbalancer_id: The ID of the Load Balancer in which to create the Backend Address Pool. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Backend Address Pool. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] outbound_rules: An array of the Load Balancing Outbound Rules associated with this Backend Address Pool.
        :param pulumi.Input[builtins.str] synchronous_mode: The backend address synchronous mode for the Backend Address Pool. Possible values are `Automatic` and `Manual`. This is required with `virtual_network_id`. Changing this forces a new resource to be created.
    ...
    def backend_ip_configurations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def backend_ip_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def load_balancing_rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def load_balancing_rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BackendAddressPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            synchronous_mode: Optional[pulumi.Input[builtins.str]] = None,
            tunnel_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[Union['BackendAddressPoolTunnelInterfaceArgs', 'BackendAddressPoolTunnelInterfaceArgsDict']]]]] = None,
            virtual_network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackendAddressPool':
        """
    ...
    @property
    @pulumi.getter(name="backendIpConfigurations")
    def backend_ip_configurations(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The Backend IP Configurations associated with this Backend Address Pool.
        """
        return pulumi.get(self, "backend_ip_configurations")
    ...
    @property
    @pulumi.getter(name="inboundNatRules")
    def inbound_nat_rules(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        An array of the Load Balancing Inbound NAT Rules associated with this Backend Address Pool.
        """
        return pulumi.get(self, "inbound_nat_rules")
    ...
    @property
    @pulumi.getter(name="loadBalancingRules")
    def load_balancing_rules(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The Load Balancing Rules associated with this Backend Address Pool.
        """
        return pulumi.get(self, "load_balancing_rules")
    ...
    @property
    @pulumi.getter(name="outboundRules")
    def outbound_rules(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        An array of the Load Balancing Outbound Rules associated with this Backend Address Pool.
        """
        return pulumi.get(self, "outbound_rules")
    ...
    @property
    @pulumi.getter(name="synchronousMode")
    def synchronous_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The backend address synchronous mode for the Backend Address Pool. Possible values are `Automatic` and `Manual`. This is required with `virtual_network_id`. Changing this forces a new resource to be created.
