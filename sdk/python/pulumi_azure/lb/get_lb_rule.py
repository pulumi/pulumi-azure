...
class GetLBRuleResult:
    ...
    def disable_outbound_snat(self) -> builtins.bool:
        """
    ...
    def enable_floating_ip(self) -> builtins.bool:
        """
    ...
    def enable_tcp_reset(self) -> builtins.bool:
        """
...
def get_lb_rule(loadbalancer_id: Optional[builtins.str] = None,
    ...
    :param builtins.str loadbalancer_id: The ID of the Load Balancer Rule.
    :param builtins.str name: The name of this Load Balancer Rule.
    """
    __args__ = dict()
...
def get_lb_rule_output(loadbalancer_id: Optional[pulumi.Input[builtins.str]] = None,
