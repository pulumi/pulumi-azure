...
class ActivityLogAlertArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the activity log alert instance. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: The Scope at which the Activity Log should be applied. A list of strings which could be a resource group , or a subscription, or a resource ID (such as a Storage Account).
        :param pulumi.Input[Sequence[pulumi.Input['ActivityLogAlertActionArgs']]] actions: One or more `action` blocks as defined below.
        :param pulumi.Input[builtins.str] description: The description of this activity log alert.
        :param pulumi.Input[builtins.bool] enabled: Should this Activity Log Alert be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] location: The Azure Region where the activity log alert rule should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the activity log alert. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:monitoring/activityLogAlert:ActivityLogAlert")
class ActivityLogAlert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ActivityLogAlert':
        """
