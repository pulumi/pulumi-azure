...
class GetScheduledQueryRulesAlertResult:
    ...
    @property
    @pulumi.getter
    def throttling(self) -> builtins.int:
        """
...
def get_scheduled_query_rules_alert(name: Optional[builtins.str] = None,
    ...
    example = azure.monitoring.get_scheduled_query_rules_alert(resource_group_name="terraform-example-rg",
        name="tfex-queryrule")
...
def get_scheduled_query_rules_alert_output(name: Optional[pulumi.Input[builtins.str]] = None,
