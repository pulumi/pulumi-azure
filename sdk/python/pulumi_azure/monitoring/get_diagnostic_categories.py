...
class GetDiagnosticCategoriesResult:
    ...
    def log_category_groups(self) -> Sequence[builtins.str]:
        """
    ...
    def log_category_types(self) -> Sequence[builtins.str]:
        """
...
def get_diagnostic_categories(resource_id: Optional[builtins.str] = None,
...
def get_diagnostic_categories_output(resource_id: Optional[pulumi.Input[builtins.str]] = None,
