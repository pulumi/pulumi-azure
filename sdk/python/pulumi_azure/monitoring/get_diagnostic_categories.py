...
class GetDiagnosticCategoriesResult:
    ...
    def log_category_groups(self) -> Sequence[_builtins.str]:
        """
    ...
    def log_category_types(self) -> Sequence[_builtins.str]:
        """
...
def get_diagnostic_categories(resource_id: Optional[_builtins.str] = None,
