...
class AlertPrometheusRuleGroupArgs:
    def __init__(__self__, *,
                 ...
                 rule_group_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a AlertPrometheusRuleGroup resource.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Alert Management Prometheus Rule Group should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input['AlertPrometheusRuleGroupRuleArgs']]] rules: One or more `rule` blocks as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: Specifies the resource ID of the Azure Monitor Workspace.
        :param pulumi.Input[builtins.str] cluster_name: Specifies the name of the Managed Kubernetes Cluster.
        :param pulumi.Input[builtins.str] description: The description of the Alert Management Prometheus Rule Group.
        :param pulumi.Input[builtins.str] interval: Specifies the interval in which to run the Alert Management Prometheus Rule Group represented in ISO 8601 duration format. Possible values are between `PT1M` and `PT15M`.
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Alert Management Prometheus Rule Group should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Alert Management Prometheus Rule Group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] rule_group_enabled: Is this Alert Management Prometheus Rule Group enabled? Possible values are `true` and `false`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Alert Management Prometheus Rule Group.
        """
    ...
    def rule_group_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def rule_group_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AlertPrometheusRuleGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AlertPrometheusRuleGroupRuleArgs', 'AlertPrometheusRuleGroupRuleArgsDict']]]]] = None,
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'AlertPrometheusRuleGroup':
        """
    ...
    @property
    @pulumi.getter(name="ruleGroupEnabled")
    def rule_group_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is this Alert Management Prometheus Rule Group enabled? Possible values are `true` and `false`.
        """
        return pulumi.get(self, "rule_group_enabled")
