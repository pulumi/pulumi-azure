...
class MetricAlertArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Metric Alert instance. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scopes: A set of strings of resource IDs at which the metric criteria should be applied.
        ...
        :param pulumi.Input[builtins.int] severity: The severity of this Metric Alert. Possible values are `0`, `1`, `2`, `3` and `4`. Defaults to `3`.
...
class MetricAlert(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_resource_location: Optional[pulumi.Input[builtins.str]] = None,
            target_resource_type: Optional[pulumi.Input[builtins.str]] = None,
            window_size: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricAlert':
        """
    ...
    @property
    @pulumi.getter(name="targetResourceLocation")
    def target_resource_location(self) -> pulumi.Output[builtins.str]:
        """
        The location of the target resource.
