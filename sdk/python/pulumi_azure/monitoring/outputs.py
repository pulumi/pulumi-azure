...
class ActionGroupArmRoleReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the ARM role receiver.
        :param _builtins.str role_id: The arm role id.
        :param _builtins.bool use_common_alert_schema: Enables or disables the common alert schema.
        """
...
class ActionGroupAutomationRunbookReceiver(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_common_alert_schema: Optional[_builtins.bool] = None):
        """
        :param _builtins.str automation_account_id: The automation account ID which holds this runbook and authenticates to Azure resources.
        :param _builtins.bool is_global_runbook: Indicates whether this instance is global runbook.
        :param _builtins.str name: The name of the automation runbook receiver.
...
class ActionGroupAzureAppPushReceiver(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str email_address: The email address of the user signed into the mobile app who will receive push notifications from this receiver.
        :param _builtins.str name: The name of the Azure app push receiver.
        """
...
class ActionGroupAzureFunctionReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the Azure Function receiver.
        :param _builtins.bool use_common_alert_schema: Enables or disables the common alert schema.
        """
...
class ActionGroupEmailReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the email receiver. Names must be unique (case-insensitive) across all receivers within an action group.
        :param _builtins.bool use_common_alert_schema: Enables or disables the common alert schema.
        """
        pulumi.set(__self__, "email_address", email_address)
        pulumi.set(__self__, "name", name)
...
class ActionGroupEventHubReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str event_hub_namespace: The namespace name of the Event Hub.
        :param _builtins.str name: The name of the EventHub Receiver, must be unique within action group.
        :param _builtins.str subscription_id: The ID for the subscription containing this Event Hub. Default to the subscription ID of the Action Group.
...
class ActionGroupItsmReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str connection_id: The unique connection identifier of the ITSM connection.
        :param _builtins.str name: The name of the ITSM receiver.
        :param _builtins.str region: The region of the workspace.
        ...
        :param _builtins.str ticket_configuration: A JSON blob for the configurations of the ITSM action. CreateMultipleWorkItems option will be part of this blob as well.
        :param _builtins.str workspace_id: The Azure Log Analytics workspace ID where this connection is defined. Format is `<subscription id>|<workspace id>`, for example `00000000-0000-0000-0000-000000000000|00000000-0000-0000-0000-000000000000`.
        """
...
class ActionGroupLogicAppReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the logic app receiver.
        :param _builtins.str resource_id: The Azure resource ID of the logic app.
        :param _builtins.bool use_common_alert_schema: Enables or disables the common alert schema.
        """
...
class ActionGroupSmsReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the SMS receiver. Names must be unique (case-insensitive) across all receivers within an action group.
...
class ActionGroupVoiceReceiver(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name of the voice receiver.
...
class ActionGroupWebhookReceiver(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_common_alert_schema: Optional[_builtins.bool] = None):
        """
        :param _builtins.str name: The name of the webhook receiver. Names must be unique (case-insensitive) across all receivers within an action group.
        :param _builtins.str service_uri: The URI where webhooks should be sent.
...
class ActionGroupWebhookReceiverAadAuth(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str object_id: The webhook application object Id for AAD auth.
        :param _builtins.str identifier_uri: The identifier URI for AAD auth.
        :param _builtins.str tenant_id: The tenant id for AAD auth.
        """
...
class ActivityLogAlertAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action_group_id: The ID of the Action Group can be sourced from the `monitoring.ActionGroup` resource.
        :param Mapping[str, _builtins.str] webhook_properties: The map of custom string properties to include with the post operation. These data are appended to the webhook payload.
        """
...
class ActivityLogAlertCriteria(dict):
    ...
    def __init__(__self__, *,
                 category: _builtins.str,
                 caller: Optional[_builtins.str] = None,
                 level: Optional[_builtins.str] = None,
                 levels: Optional[Sequence[_builtins.str]] = None,
                 operation_name: Optional[_builtins.str] = None,
                 recommendation_category: Optional[_builtins.str] = None,
                 recommendation_impact: Optional[_builtins.str] = None,
                 recommendation_type: Optional[_builtins.str] = None,
                 ...
                 resource_providers: Optional[Sequence[_builtins.str]] = None,
                 ...
                 sub_status: Optional[_builtins.str] = None,
                 sub_statuses: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str category: The category of the operation. Possible values are `Administrative`, `Autoscale`, `Policy`, `Recommendation`, `ResourceHealth`, `Security` and `ServiceHealth`.
        :param _builtins.str caller: The email address or Azure Active Directory identifier of the user who performed the operation.
        :param _builtins.str level: The severity level of the event. Possible values are `Verbose`, `Informational`, `Warning`, `Error`, and `Critical`.
        :param Sequence[_builtins.str] levels: A list of severity level of the event. Possible values are `Verbose`, `Informational`, `Warning`, `Error`, and `Critical`.
        ...
        :param _builtins.str resource_id: The specific resource monitored by the activity log alert. It should be within one of the `scopes`.
        :param Sequence[_builtins.str] resource_ids: A list of specific resources monitored by the activity log alert. It should be within one of the `scopes`.
               
               > **Note:** `resource_id` and `resource_ids` are mutually exclusive.
        :param _builtins.str resource_provider: The name of the resource provider monitored by the activity log alert.
        :param Sequence[_builtins.str] resource_providers: A list of names of resource providers monitored by the activity log alert.
               
               > **Note:** `resource_provider` and `resource_providers` are mutually exclusive.
        :param _builtins.str resource_type: The resource type monitored by the activity log alert.
        :param Sequence[_builtins.str] resource_types: A list of resource types monitored by the activity log alert.
        ...
        :param _builtins.str status: The status of the event. For example, `Started`, `Failed`, or `Succeeded`.
        :param Sequence[_builtins.str] statuses: A list of status of the event. For example, `Started`, `Failed`, or `Succeeded`.
               
               > **Note:** `status` and `statuses` are mutually exclusive.
        :param _builtins.str sub_status: The sub status of the event.
        :param Sequence[_builtins.str] sub_statuses: A list of sub status of the event.
    ...
    def resource_providers(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def sub_status(self) -> Optional[_builtins.str]:
        """
    ...
    def sub_statuses(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ActivityLogAlertCriteriaResourceHealth(dict):
    def __init__(__self__, *,
                 currents: Optional[Sequence[_builtins.str]] = None,
                 previouses: Optional[Sequence[_builtins.str]] = None,
                 reasons: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] currents: The current resource health statuses that will log an alert. Possible values are `Available`, `Degraded`, `Unavailable` and `Unknown`.
        :param Sequence[_builtins.str] previouses: The previous resource health statuses that will log an alert. Possible values are `Available`, `Degraded`, `Unavailable` and `Unknown`.
        :param Sequence[_builtins.str] reasons: The reason that will log an alert. Possible values are `PlatformInitiated` (such as a problem with the resource in an affected region of an Azure incident), `UserInitiated` (such as a shutdown request of a VM) and `Unknown`.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def currents(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def previouses(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ActivityLogAlertCriteriaServiceHealth(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] events: Events this alert will monitor Possible values are `Incident`, `Maintenance`, `Informational`, `ActionRequired` and `Security`.
        :param Sequence[_builtins.str] locations: Locations this alert will monitor. For example, `West Europe`.
        :param Sequence[_builtins.str] services: Services this alert will monitor. For example, `Activity Logs & Alerts`, `Action Groups`. Defaults to all Services.
        """
...
class AlertProcessingRuleActionGroupConditionAlertContext(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param Sequence[_builtins.str] values: Specifies a list of values to match for a given condition.
        """
...
class AlertProcessingRuleActionGroupConditionMonitorCondition(dict):
    def __init__(__self__, *,
                 ...
                 values: Sequence[_builtins.str]):
        """
        :param _builtins.str operator: The operator for a given condition. Possible values are `Equals` and `NotEquals`.
        :param Sequence[_builtins.str] values: Specifies a list of values to match for a given condition. Possible values are `Fired` and `Resolved`.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionSeverity(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str operator: The operator for a given condition. Possible values are `Equals` and `NotEquals`.
        :param Sequence[_builtins.str] values: Specifies list of values to match for a given condition. Possible values are `Sev0`, `Sev1`, `Sev2`, `Sev3`, and `Sev4`.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionSignalType(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str operator: The operator for a given condition. Possible values are `Equals` and `NotEquals`.
        :param Sequence[_builtins.str] values: Specifies a list of values to match for a given condition. Possible values are `Metric`, `Log`, `Unknown`, and `Health`.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionTargetResource(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param Sequence[_builtins.str] values: A list of values to match for a given condition. The values should be valid resource IDs.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionTargetResourceGroup(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param Sequence[_builtins.str] values: A list of values to match for a given condition. The values should be valid resource group IDs.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionTargetResourceType(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param Sequence[_builtins.str] values: A list of values to match for a given condition. The values should be valid resource types. (e.g. Microsoft.Compute/VirtualMachines)
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupSchedule(dict):
    ...
    def __init__(__self__, *,
                 effective_from: Optional[_builtins.str] = None,
...
class AlertProcessingRuleActionGroupScheduleRecurrenceDaily(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str end_time: Specifies the recurrence end time (H:M:S).
        :param _builtins.str start_time: Specifies the recurrence start time (H:M:S).
        """
...
class AlertProcessingRuleActionGroupScheduleRecurrenceMonthly(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.int] days_of_months: Specifies a list of dayOfMonth to recurrence. Possible values are integers between `1` - `31`.
        :param _builtins.str end_time: Specifies the recurrence end time (H:M:S).
        :param _builtins.str start_time: Specifies the recurrence start time (H:M:S).
        """
...
class AlertProcessingRuleActionGroupScheduleRecurrenceWeekly(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_time: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] days_of_weeks: Specifies a list of dayOfWeek to recurrence. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, and `Saturday`.
        :param _builtins.str end_time: Specifies the recurrence end time (H:M:S).
        :param _builtins.str start_time: Specifies the recurrence start time (H:M:S).
        """
...
class AlertPrometheusRuleGroupRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str alert: Specifies the Alert rule name.
        :param 'AlertPrometheusRuleGroupRuleAlertResolutionArgs' alert_resolution: An `alert_resolution` block as defined below.
        :param Mapping[str, _builtins.str] annotations: Specifies a set of informational labels that can be used to store longer additional information such as alert descriptions or runbook links.
        :param _builtins.bool enabled: Is this rule enabled? Possible values are `true` and `false`.
        :param _builtins.str for_: Specifies the amount of time alert must be active before firing, represented in ISO 8601 duration format.
        :param Mapping[str, _builtins.str] labels: Specifies the labels to add or overwrite before storing the result.
        :param _builtins.str record: Specifies the recorded metrics name.
        :param _builtins.int severity: Specifies the severity of the alerts fired by the rule. Possible values are between 0 and 4.
        """
...
class AlertPrometheusRuleGroupRuleAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action_group_id: Specifies the resource id of the monitor action group.
        :param Mapping[str, _builtins.str] action_properties: Specifies the properties of an action group object.
...
class AlertPrometheusRuleGroupRuleAlertResolution(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool auto_resolved: Is the alert auto-resolution? Possible values are `true` and `false`.
        :param _builtins.str time_to_resolve: Specifies the alert auto-resolution interval, represented in ISO 8601 duration format.
        """
...
class AutoscaleSettingNotificationEmail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 send_to_subscription_co_administrator: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] custom_emails: Specifies a list of custom email addresses to which the email notifications will be sent.
        :param _builtins.bool send_to_subscription_administrator: Should email notifications be sent to the subscription administrator? Defaults to `false`.
        :param _builtins.bool send_to_subscription_co_administrator: Should email notifications be sent to the subscription co-administrator? Defaults to `false`.
        """
    ...
    def send_to_subscription_co_administrator(self) -> Optional[_builtins.bool]:
        """
...
class AutoscaleSettingNotificationWebhook(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str service_uri: The HTTPS URI which should receive scale notifications.
        :param Mapping[str, _builtins.str] properties: A map of settings.
        """
        pulumi.set(__self__, "service_uri", service_uri)
...
class AutoscaleSettingPredictive(dict):
    ...
    def __init__(__self__, *,
                 ...
                 look_ahead_time: Optional[_builtins.str] = None):
        """
        :param _builtins.str scale_mode: Specifies the predictive scale mode. Possible values are `Enabled` or `ForecastOnly`.
        :param _builtins.str look_ahead_time: Specifies the amount of time by which instances are launched in advance. It must be between `PT1M` and `PT1H` in ISO 8601 format.
        """
    ...
    def look_ahead_time(self) -> Optional[_builtins.str]:
        """
...
class AutoscaleSettingProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Specifies the name of the profile.
...
class AutoscaleSettingProfileCapacity(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int default: The number of instances that are available for scaling if metrics are not available for evaluation. The default is only used if the current instance count is lower than the default. Valid values are between `0` and `1000`.
        :param _builtins.int maximum: The maximum number of instances for this resource. Valid values are between `0` and `1000`.
               
               > **Note:** The maximum number of instances is also limited by the amount of Cores available in the subscription.
        :param _builtins.int minimum: The minimum number of instances for this resource. Valid values are between `0` and `1000`.
        """
...
class AutoscaleSettingProfileFixedDate(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str end: Specifies the end date for the profile, formatted as an RFC3339 date string.
        :param _builtins.str start: Specifies the start date for the profile, formatted as an RFC3339 date string.
        :param _builtins.str timezone: The Time Zone of the `start` and `end` times. A list of [possible values can be found here](https://learn.microsoft.com/en-us/rest/api/monitor/autoscale-settings/create-or-update?view=rest-monitor-2022-10-01&tabs=HTTP#recurrentschedule). Defaults to `UTC`.
        """
...
class AutoscaleSettingProfileRecurrence(dict):
    def __init__(__self__, *,
                 ...
                 timezone: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] days: A list of days that this profile takes effect on. Possible values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`.
        :param _builtins.int hours: A list containing a single item, which specifies the Hour interval at which this recurrence should be triggered (in 24-hour time). Possible values are from `0` to `23`.
        :param _builtins.int minutes: A list containing a single item which specifies the Minute interval at which this recurrence should be triggered.
        :param _builtins.str timezone: The Time Zone used for the `hours` field. A list of possible values can be found here). Defaults to `UTC`.
        """
        pulumi.set(__self__, "days", days)
...
class AutoscaleSettingProfileRuleMetricTrigger(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metric_resource_id: _builtins.str,
                 operator: _builtins.str,
                 ...
                 divide_by_instance_count: Optional[_builtins.bool] = None,
                 metric_namespace: Optional[_builtins.str] = None):
        """
        :param _builtins.str metric_name: The name of the metric that defines what the rule monitors, such as `Percentage CPU` for `Virtual Machine Scale Sets` and `CpuPercentage` for `App Service Plan`.
        ...
        :param _builtins.str metric_resource_id: The ID of the Resource which the Rule monitors.
        :param _builtins.str operator: Specifies the operator used to compare the metric data and threshold. Possible values are: `Equals`, `NotEquals`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan`, `LessThanOrEqual`.
        :param _builtins.str statistic: Specifies how the metrics from multiple instances are combined. Possible values are `Average`, `Max`, `Min` and `Sum`.
        :param _builtins.float threshold: Specifies the threshold of the metric that triggers the scale action.
        :param _builtins.str time_aggregation: Specifies how the data that's collected should be combined over time. Possible values include `Average`, `Count`, `Maximum`, `Minimum`, `Last` and `Total`.
        :param _builtins.str time_grain: Specifies the granularity of metrics that the rule monitors, which must be one of the pre-defined values returned from the metric definitions for the metric. This value must be between 1 minute and 12 hours an be formatted as an ISO 8601 string.
        :param _builtins.str time_window: Specifies the time range for which data is collected, which must be greater than the delay in metric collection (which varies from resource to resource). This value must be between 5 minutes and 12 hours and be formatted as an ISO 8601 string.
        ...
        :param _builtins.bool divide_by_instance_count: Whether to enable metric divide by instance count.
        :param _builtins.str metric_namespace: The namespace of the metric that defines what the rule monitors, such as `microsoft.compute/virtualmachinescalesets` for `Virtual Machine Scale Sets`.
        """
    ...
    def divide_by_instance_count(self) -> Optional[_builtins.bool]:
        """
...
class AutoscaleSettingProfileRuleMetricTriggerDimension(dict):
    def __init__(__self__, *,
                 ...
                 values: Sequence[_builtins.str]):
        """
        :param _builtins.str name: The name of the dimension.
        :param _builtins.str operator: The dimension operator. Possible values are `Equals` and `NotEquals`. `Equals` means being equal to any of the values. `NotEquals` means being not equal to any of the values.
        :param Sequence[_builtins.str] values: A list of dimension values.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AutoscaleSettingProfileRuleScaleAction(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.int):
        """
        :param _builtins.str cooldown: The amount of time to wait since the last scaling action before this action occurs. Must be between 1 minute and 1 week and formatted as a ISO 8601 string.
        :param _builtins.str direction: The scale direction. Possible values are `Increase` and `Decrease`.
        :param _builtins.str type: The type of action that should occur. Possible values are `ChangeCount`, `ExactCount`, `PercentChangeCount` and `ServiceAllowedNextValue`.
        :param _builtins.int value: The number of instances involved in the scaling action.
        """
...
class DataCollectionRuleDataFlow(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] destinations: Specifies a list of destination names. A `azure_monitor_metrics` data source only allows for stream of kind `Microsoft-InsightsMetrics`.
        :param Sequence[_builtins.str] streams: Specifies a list of streams. Possible values include but not limited to `Microsoft-Event`, `Microsoft-InsightsMetrics`, `Microsoft-Perf`, `Microsoft-Syslog`, `Microsoft-WindowsEvent`, and `Microsoft-PrometheusMetrics`.
        :param _builtins.str built_in_transform: The built-in transform to transform stream data.
        :param _builtins.str output_stream: The output stream of the transform. Only required if the data flow changes data to a different stream.
...
class DataCollectionRuleDataSourcesDataImportEventHubDataSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param _builtins.str stream: The stream to collect from Event Hub. Possible value should be a custom stream name.
        :param _builtins.str consumer_group: The Event Hub consumer group name.
        """
        pulumi.set(__self__, "name", name)
...
class DataCollectionRuleDataSourcesExtension(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str,
                 streams: Sequence[_builtins.str],
                 extension_json: Optional[_builtins.str] = None,
                 input_data_sources: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str extension_name: The name of the VM extension.
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible values include but not limited to `Microsoft-Event`, `Microsoft-InsightsMetrics`, `Microsoft-Perf`, `Microsoft-Syslog`, `Microsoft-WindowsEvent`.
        :param _builtins.str extension_json: A JSON String which specifies the extension setting.
        :param Sequence[_builtins.str] input_data_sources: Specifies a list of data sources this extension needs data from. An item should be a name of a supported data source which produces only one stream. Supported data sources type: `performance_counter`, `windows_event_log`,and `syslog`.
        """
    ...
    def extension_json(self) -> Optional[_builtins.str]:
        """
...
class DataCollectionRuleDataSourcesIisLog(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible value is `Microsoft-W3CIISLog`.
        :param Sequence[_builtins.str] log_directories: Specifies a list of absolute paths where the log files are located.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "streams", streams)
...
class DataCollectionRuleDataSourcesLogFile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] file_patterns: Specifies a list of file patterns where the log files are located. For example, `C:\\\\JavaLogs\\\\*.log`.
        :param _builtins.str format: The data format of the log files. Possible values are `text` and `json`.
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible value should be custom stream names.
...
class DataCollectionRuleDataSourcesLogFileSettingsText(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str record_start_timestamp_format: The timestamp format of the text log files. Possible values are `ISO 8601`, `YYYY-MM-DD HH:MM:SS`, `M/D/YYYY HH:MM:SS AM/PM`, `Mon DD, YYYY HH:MM:SS`, `yyMMdd HH:mm:ss`, `ddMMyy HH:mm:ss`, `MMM d hh:mm:ss`, `dd/MMM/yyyy:HH:mm:ss zzz`,and `yyyy-MM-ddTHH:mm:ssK`.
        """
...
class DataCollectionRuleDataSourcesPerformanceCounter(dict):
    ...
    def __init__(__self__, *,
                 counter_specifiers: Sequence[_builtins.str],
                 name: _builtins.str,
                 sampling_frequency_in_seconds: _builtins.int,
                 streams: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] counter_specifiers: Specifies a list of specifier names of the performance counters you want to collect. To get a list of performance counters on Windows, run the command `typeperf`. Please see [this document](https://learn.microsoft.com/en-us/azure/azure-monitor/agents/data-sources-performance-counters#configure-performance-counters) for more information.
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param _builtins.int sampling_frequency_in_seconds: The number of seconds between consecutive counter measurements (samples). The value should be integer between `1` and `1800` inclusive. `sampling_frequency_in_seconds` must be equal to `60` seconds for counters collected with `Microsoft-InsightsMetrics` stream.
    ...
    def counter_specifiers(self) -> Sequence[_builtins.str]:
        """
    ...
    def sampling_frequency_in_seconds(self) -> _builtins.int:
        """
...
class DataCollectionRuleDataSourcesPrometheusForwarder(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible value is `Microsoft-PrometheusMetrics`.
...
class DataCollectionRuleDataSourcesPrometheusForwarderLabelIncludeFilter(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str label: The label of the filter. This label should be unique across all `label_include_fileter` block. Possible value is `microsoft_metrics_include_label`.
...
class DataCollectionRuleDataSourcesSyslog(dict):
    ...
    def __init__(__self__, *,
                 facility_names: Sequence[_builtins.str],
                 log_levels: Sequence[_builtins.str],
                 name: _builtins.str,
                 streams: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] facility_names: Specifies a list of facility names. Use a wildcard `*` to collect logs for all facility names. Possible values are `alert`, `*`, `audit`, `auth`, `authpriv`, `clock`, `cron`, `daemon`, `ftp`, `kern`, `local5`, `local4`, `local1`, `local7`, `local6`, `local3`, `local2`, `local0`, `lpr`, `mail`, `mark`, `news`, `nopri`, `ntp`, `syslog`, `user` and `uucp`.
        :param Sequence[_builtins.str] log_levels: Specifies a list of log levels. Use a wildcard `*` to collect logs for all log levels. Possible values are `Debug`, `Info`, `Notice`, `Warning`, `Error`, `Critical`, `Alert`, `Emergency`,and `*`.
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
    ...
    def facility_names(self) -> Sequence[_builtins.str]:
        """
    ...
    def log_levels(self) -> Sequence[_builtins.str]:
        """
...
class DataCollectionRuleDataSourcesWindowsEventLog(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 streams: Sequence[_builtins.str],
                 x_path_queries: Sequence[_builtins.str]):
        """
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        ...
        :param Sequence[_builtins.str] x_path_queries: Specifies a list of Windows Event Log queries in XPath expression. Please see [this document](https://learn.microsoft.com/en-us/azure/azure-monitor/agents/data-collection-rule-azure-monitor-agent?tabs=cli#filter-events-using-xpath-queries) for more information.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "streams", streams)
    ...
    def x_path_queries(self) -> Sequence[_builtins.str]:
        """
...
class DataCollectionRuleDataSourcesWindowsFirewallLog(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "streams", streams)
...
class DataCollectionRuleDestinationsAzureMonitorMetrics(dict):
    def __init__(__self__, *,
                 name: _builtins.str):
        """
        :param _builtins.str name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        """
        pulumi.set(__self__, "name", name)
...
class DataCollectionRuleDestinationsEventHub(dict):
    ...
    def __init__(__self__, *,
                 event_hub_id: _builtins.str,
                 name: _builtins.str):
        """
        :param _builtins.str event_hub_id: The resource ID of the Event Hub.
        :param _builtins.str name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        """
    ...
    def event_hub_id(self) -> _builtins.str:
        """
...
class DataCollectionRuleDestinationsLogAnalytic(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 workspace_resource_id: _builtins.str):
        """
        :param _builtins.str name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        :param _builtins.str workspace_resource_id: The ID of a Log Analytic Workspace resource.
        """
        pulumi.set(__self__, "name", name)
...
class DataCollectionRuleDestinationsMonitorAccount(dict):
    ...
    def __init__(__self__, *,
                 monitor_account_id: _builtins.str,
                 name: _builtins.str):
        """
        :param _builtins.str monitor_account_id: The resource ID of the Monitor Account.
        :param _builtins.str name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        """
    ...
    def monitor_account_id(self) -> _builtins.str:
        """
...
class DataCollectionRuleDestinationsStorageBlob(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str container_name: The Storage Container name.
        :param _builtins.str name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        :param _builtins.str storage_account_id: The resource ID of the Storage Account.
        """
...
class DataCollectionRuleDestinationsStorageTableDirect(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        :param _builtins.str storage_account_id: The resource ID of the Storage Account.
        :param _builtins.str table_name: The Storage Table name.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "storage_account_id", storage_account_id)
...
class DataCollectionRuleIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Data Collection Rule. Possible values are `SystemAssigned` and `UserAssigned`.
        :param Sequence[_builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Data Collection Rule. Currently, up to 1 identity is supported.
...
class DataCollectionRuleStreamDeclaration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str stream_name: The name of the custom stream. This name should be unique across all `stream_declaration` blocks and must begin with a prefix of `Custom-`.
        """
...
class DataCollectionRuleStreamDeclarationColumn(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The type of the column data. Possible values are `string`, `int`, `long`, `real`, `boolean`, `datetime`,and `dynamic`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class DiagnosticSettingEnabledLog(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str category_group: The name of a Diagnostic Log Category Group for this Resource.
...
class DiagnosticSettingEnabledMetric(dict):
    def __init__(__self__, *,
                 category: _builtins.str):
        """
        :param _builtins.str category: The name of a Diagnostic Metric Category for this Resource.
...
class MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failed_location_count: _builtins.int,
                 web_test_id: _builtins.str):
        """
        :param _builtins.str component_id: The ID of the Application Insights Resource.
        :param _builtins.int failed_location_count: The number of failed locations.
        :param _builtins.str web_test_id: The ID of the Application Insights Web Test.
        """
    ...
    def failed_location_count(self) -> _builtins.int:
        """
...
class MetricAlertCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str aggregation: The statistic that runs over the metric values. Possible values are `Average`, `Count`, `Minimum`, `Maximum` and `Total`.
        :param _builtins.str metric_name: One of the metric names to be monitored.
        :param _builtins.str metric_namespace: One of the metric namespaces to be monitored.
        :param _builtins.str operator: The criteria operator. Possible values are `Equals`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        ...
        :param _builtins.bool skip_metric_validation: Skip the metric validation to allow creating an alert rule on a custom metric that isn't yet emitted? Defaults to `false`.
        """
...
class MetricAlertCriteriaDimension(dict):
    def __init__(__self__, *,
                 ...
                 values: Sequence[_builtins.str]):
        """
        :param _builtins.str name: One of the dimension names.
        :param _builtins.str operator: The dimension operator. Possible values are `Include`, `Exclude` and `StartsWith`.
        :param Sequence[_builtins.str] values: The list of dimension values.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class MetricAlertDynamicCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 evaluation_failure_count: Optional[_builtins.int] = None,
                 evaluation_total_count: Optional[_builtins.int] = None,
                 ignore_data_before: Optional[_builtins.str] = None,
                 skip_metric_validation: Optional[_builtins.bool] = None):
        """
        :param _builtins.str aggregation: The statistic that runs over the metric values. Possible values are `Average`, `Count`, `Minimum`, `Maximum` and `Total`.
        :param _builtins.str alert_sensitivity: The extent of deviation required to trigger an alert. Possible values are `Low`, `Medium` and `High`.
        :param _builtins.str metric_name: One of the metric names to be monitored.
        :param _builtins.str metric_namespace: One of the metric namespaces to be monitored.
        :param _builtins.str operator: The criteria operator. Possible values are `LessThan`, `GreaterThan` and `GreaterOrLessThan`.
        :param Sequence['MetricAlertDynamicCriteriaDimensionArgs'] dimensions: One or more `dimension` blocks as defined below.
        :param _builtins.int evaluation_failure_count: The number of violations to trigger an alert. Should be smaller or equal to `evaluation_total_count`. Defaults to `4`.
        :param _builtins.int evaluation_total_count: The number of aggregated lookback points. The lookback time window is calculated based on the aggregation granularity (`window_size`) and the selected number of aggregated points. Defaults to `4`.
        :param _builtins.str ignore_data_before: The [ISO8601](https://en.wikipedia.org/wiki/ISO_8601) date from which to start learning the metric historical data and calculate the dynamic thresholds.
        :param _builtins.bool skip_metric_validation: Skip the metric validation to allow creating an alert rule on a custom metric that isn't yet emitted?
        """
        pulumi.set(__self__, "aggregation", aggregation)
    ...
    def evaluation_failure_count(self) -> Optional[_builtins.int]:
        """
    ...
    def evaluation_total_count(self) -> Optional[_builtins.int]:
        """
...
class ScheduledQueryRulesAlertAction(dict):
    ...
    def __init__(__self__, *,
                 action_groups: Sequence[_builtins.str],
                 custom_webhook_payload: Optional[_builtins.str] = None,
                 email_subject: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] action_groups: List of action group reference resource IDs.
        :param _builtins.str custom_webhook_payload: Custom payload to be sent for all webhook payloads in alerting action.
    ...
    def action_groups(self) -> Sequence[_builtins.str]:
        """
...
class ScheduledQueryRulesAlertTrigger(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str operator: Evaluation operation for rule - 'GreaterThan', GreaterThanOrEqual', 'LessThan', or 'LessThanOrEqual'.
        :param _builtins.float threshold: Result or count threshold based on which rule should be triggered. Values must be between 0 and 10000 inclusive.
...
class ScheduledQueryRulesAlertTriggerMetricTrigger(dict):
    ...
    def __init__(__self__, *,
                 metric_trigger_type: _builtins.str,
                 operator: _builtins.str,
                 threshold: _builtins.float,
                 metric_column: Optional[_builtins.str] = None):
        """
        :param _builtins.str metric_trigger_type: Metric Trigger Type - 'Consecutive' or 'Total'.
        :param _builtins.str operator: Evaluation operation for rule - 'Equal', 'GreaterThan', GreaterThanOrEqual', 'LessThan', or 'LessThanOrEqual'.
        :param _builtins.float threshold: The threshold of the metric trigger. Values must be between 0 and 10000 inclusive.
        :param _builtins.str metric_column: Evaluation of metric on a particular column.
        """
    ...
    def metric_trigger_type(self) -> _builtins.str:
        """
    ...
    def metric_column(self) -> Optional[_builtins.str]:
        """
...
class ScheduledQueryRulesAlertV2Criteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 query: _builtins.str,
                 threshold: _builtins.float,
                 time_aggregation_method: _builtins.str,
        ...
        """
        :param _builtins.str operator: Specifies the criteria operator. Possible values are `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan`,and `LessThanOrEqual`.
        :param _builtins.str query: The query to run on logs. The results returned by this query are used to populate the alert.
        :param _builtins.float threshold: Specifies the criteria threshold value that activates the alert.
        :param _builtins.str time_aggregation_method: The type of aggregation to apply to the data points in aggregation granularity. Possible values are `Average`, `Count`, `Maximum`, `Minimum`,and `Total`.
        ...
        :param _builtins.str metric_measure_column: Specifies the column containing the metric measure number.
        ...
        :param _builtins.str resource_id_column: Specifies the column containing the resource ID. The content of the column must be an uri formatted as resource ID.
        """
        pulumi.set(__self__, "operator", operator)
    ...
    def time_aggregation_method(self) -> _builtins.str:
        """
...
class ScheduledQueryRulesAlertV2CriteriaDimension(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Operator for dimension values. Possible values are `Exclude`,and `Include`.
        :param Sequence[_builtins.str] values: List of dimension values. Use a wildcard `*` to collect all.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class ScheduledQueryRulesAlertV2CriteriaFailingPeriods(dict):
    ...
    def __init__(__self__, *,
                 minimum_failing_periods_to_trigger_alert: _builtins.int,
                 number_of_evaluation_periods: _builtins.int):
        """
        :param _builtins.int minimum_failing_periods_to_trigger_alert: Specifies the number of violations to trigger an alert. Should be smaller or equal to `number_of_evaluation_periods`. Possible value is integer between 1 and 6.
        :param _builtins.int number_of_evaluation_periods: Specifies the number of aggregated look-back points. The look-back time window is calculated based on the aggregation granularity `window_duration` and the selected number of aggregated points. Possible value is integer between 1 and 6.
    ...
    def minimum_failing_periods_to_trigger_alert(self) -> _builtins.int:
        """
    ...
    def number_of_evaluation_periods(self) -> _builtins.int:
        """
...
class ScheduledQueryRulesAlertV2Identity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Scheduled Query Rule. Possible values are `SystemAssigned`, `UserAssigned`.
        :param Sequence[_builtins.str] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Scheduled Query Rule.
        ...
        :param _builtins.str principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this App Service slot.
        :param _builtins.str tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this App Service slot.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ScheduledQueryRulesLogCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str metric_name: Name of the metric. Supported metrics are listed in the Azure Monitor [Microsoft.OperationalInsights/workspaces](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported#microsoftoperationalinsightsworkspaces) metrics namespace.
        """
        pulumi.set(__self__, "dimensions", dimensions)
        pulumi.set(__self__, "metric_name", metric_name)
...
class ScheduledQueryRulesLogCriteriaDimension(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str operator: Operator for dimension values, - 'Include'. Defaults to `Include`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class SmartDetectorAlertRuleActionGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 email_subject: Optional[_builtins.str] = None,
                 webhook_payload: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] ids: Specifies the action group ids.
        :param _builtins.str email_subject: Specifies a custom email subject if Email Receiver is specified in Monitor Action Group resource.
        :param _builtins.str webhook_payload: A JSON String which Specifies the custom webhook payload if Webhook Receiver is specified in Monitor Action Group resource.
        """
    ...
    def webhook_payload(self) -> Optional[_builtins.str]:
        """
...
class GetActionGroupArmRoleReceiverResult(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 role_id: _builtins.str,
                 use_common_alert_schema: _builtins.bool):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="useCommonAlertSchema")
    def use_common_alert_schema(self) -> _builtins.bool:
        """
        Indicates whether to use common alert schema.
        """
        return pulumi.get(self, "use_common_alert_schema")
...
class GetActionGroupItsmReceiverResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str region: The region of the workspace.
        :param _builtins.str ticket_configuration: A JSON blob for the configurations of the ITSM action. CreateMultipleWorkItems option will be part of this blob as well.
        :param _builtins.str workspace_id: The Azure Log Analytics workspace ID where this connection is defined.
        """
        pulumi.set(__self__, "connection_id", connection_id)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "region", region)
...
class GetDataCollectionRuleDataFlowResult(dict):
    def __init__(__self__, *,
                 built_in_transform: _builtins.str,
                 destinations: Sequence[_builtins.str],
                 output_stream: _builtins.str,
                 streams: Sequence[_builtins.str],
                 transform_kql: _builtins.str):
        """
        :param _builtins.str built_in_transform: The built-in transform to transform stream data.
        :param Sequence[_builtins.str] destinations: Specifies a list of destination names. A `azure_monitor_metrics` data source only allows for stream of kind `Microsoft-InsightsMetrics`.
        :param _builtins.str output_stream: The output stream of the transform. Only required if the data flow changes data to a different stream.
    ...
    @_builtins.property
    @pulumi.getter(name="builtInTransform")
    def built_in_transform(self) -> _builtins.str:
        """
        The built-in transform to transform stream data.
        """
        return pulumi.get(self, "built_in_transform")
    ...
    @_builtins.property
    @pulumi.getter(name="outputStream")
    def output_stream(self) -> _builtins.str:
        """
        The output stream of the transform. Only required if the data flow changes data to a different stream.
        """
        return pulumi.get(self, "output_stream")
    ...
    @_builtins.property
    @pulumi.getter(name="transformKql")
    def transform_kql(self) -> _builtins.str:
        """
        The KQL query to transform stream data.
        """
        return pulumi.get(self, "transform_kql")
...
class GetDataCollectionRuleDataSourceExtensionResult(dict):
    def __init__(__self__, *,
                 extension_json: _builtins.str,
                 extension_name: _builtins.str,
                 input_data_sources: Sequence[_builtins.str],
                 name: _builtins.str,
                 streams: Sequence[_builtins.str]):
        """
        :param _builtins.str extension_json: A JSON String which specifies the extension setting.
    ...
    @_builtins.property
    @pulumi.getter(name="extensionJson")
    def extension_json(self) -> _builtins.str:
        """
        A JSON String which specifies the extension setting.
        """
        return pulumi.get(self, "extension_json")
    ...
    @_builtins.property
    @pulumi.getter(name="inputDataSources")
    def input_data_sources(self) -> Sequence[_builtins.str]:
        """
        Specifies a list of data sources this extension needs data from. An item should be a name of a supported data source which produces only one stream. Supported data sources type: `performance_counter`, `windows_event_log`,and `syslog`.
        """
        return pulumi.get(self, "input_data_sources")
...
class GetDataCollectionRuleDataSourceIisLogResult(dict):
    def __init__(__self__, *,
                 log_directories: Sequence[_builtins.str],
                 name: _builtins.str,
                 streams: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] log_directories: Specifies a list of absolute paths where the log files are located.
    ...
    @_builtins.property
    @pulumi.getter(name="logDirectories")
    def log_directories(self) -> Sequence[_builtins.str]:
        """
        Specifies a list of absolute paths where the log files are located.
        """
        return pulumi.get(self, "log_directories")
...
class GetDataCollectionRuleDataSourceLogFileResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] file_patterns: Specifies a list of file patterns where the log files are located. For example, `C:\\\\JavaLogs\\\\*.log`.
        :param _builtins.str format: The data format of the log files. possible value is `text`.
        :param _builtins.str name: Specifies the name of the Data Collection Rule.
...
class GetDataCollectionRuleDataSourcePerformanceCounterResult(dict):
    def __init__(__self__, *,
                 ...
                 streams: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] counter_specifiers: Specifies a list of specifier names of the performance counters you want to collect. Use a wildcard `*` to collect counters for all instances. To get a list of performance counters on Windows, run the command `typeperf`.
        :param _builtins.str name: Specifies the name of the Data Collection Rule.
        :param _builtins.int sampling_frequency_in_seconds: The number of seconds between consecutive counter measurements (samples). The value should be integer between `1` and `1800` inclusive.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        """
        pulumi.set(__self__, "counter_specifiers", counter_specifiers)
        pulumi.set(__self__, "name", name)
...
class GetDataCollectionRuleDataSourceSyslogResult(dict):
    def __init__(__self__, *,
                 ...
                 streams: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] facility_names: Specifies a list of facility names. Use a wildcard `*` to collect logs for all facility names. Possible values are `auth`, `authpriv`, `cron`, `daemon`, `kern`, `lpr`, `mail`, `mark`, `news`, `syslog`, `user`, `uucp`, `local0`, `local1`, `local2`, `local3`, `local4`, `local5`, `local6`, `local7`,and `*`.
        :param Sequence[_builtins.str] log_levels: Specifies a list of log levels. Use a wildcard `*` to collect logs for all log levels. Possible values are `Debug`,  `Info`, `Notice`, `Warning`, `Error`, `Critical`, `Alert`, `Emergency`,and `*`.
        :param _builtins.str name: Specifies the name of the Data Collection Rule.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        """
...
class GetDataCollectionRuleDataSourceWindowsEventLogResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str name: Specifies the name of the Data Collection Rule.
        :param Sequence[_builtins.str] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        :param Sequence[_builtins.str] x_path_queries: Specifies a list of Windows Event Log queries in XPath expression.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "streams", streams)
        pulumi.set(__self__, "x_path_queries", x_path_queries)
...
class GetDataCollectionRuleIdentityResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str principal_id: The Principal ID associated with this Managed Service Identity.
        :param _builtins.str tenant_id: The Tenant ID associated with this Managed Service Identity.
        :param _builtins.str type: cSpecifies the type of Managed Service Identity that should be configured on this Data Collection Rule. Possible values are `SystemAssigned` and `UserAssigned`.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetDataCollectionRuleStreamDeclarationResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str stream_name: The name of the custom stream. This name should be unique across all `stream_declaration` blocks.
        """
        pulumi.set(__self__, "columns", columns)
        pulumi.set(__self__, "stream_name", stream_name)
...
class GetScheduledQueryRulesAlertActionResult(dict):
    def __init__(__self__, *,
                 action_groups: Sequence[_builtins.str],
                 custom_webhook_payload: _builtins.str,
                 email_subject: _builtins.str):
        """
        :param Sequence[_builtins.str] action_groups: List of action group reference resource IDs.
        :param _builtins.str custom_webhook_payload: Custom payload to be sent for all webhook URI in Azure action group.
        :param _builtins.str email_subject: Custom subject override for all email IDs in Azure action group.
        """
        pulumi.set(__self__, "action_groups", action_groups)
        pulumi.set(__self__, "custom_webhook_payload", custom_webhook_payload)
    ...
    @_builtins.property
    @pulumi.getter(name="customWebhookPayload")
    def custom_webhook_payload(self) -> _builtins.str:
        """
...
class GetScheduledQueryRulesAlertTriggerResult(dict):
    def __init__(__self__, *,
                 ...
                 threshold: _builtins.float):
        """
        :param _builtins.str operator: Evaluation operation for rule.
        :param _builtins.float threshold: Result or count threshold based on which rule should be triggered.
        """
...
class GetScheduledQueryRulesAlertTriggerMetricTriggerResult(dict):
    ...
    @_builtins.property
    @pulumi.getter(name="metricColumn")
    def metric_column(self) -> _builtins.str:
        return pulumi.get(self, "metric_column")
