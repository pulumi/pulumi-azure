...
class AadDiagnosticSettingEnabledLogArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] category: The log category for the Azure Active Directory Diagnostic.
        """
...
class ActionGroupArmRoleReceiverArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the ARM role receiver.
        :param pulumi.Input[builtins.str] role_id: The arm role id.
        :param pulumi.Input[builtins.bool] use_common_alert_schema: Enables or disables the common alert schema.
        """
...
class ActionGroupAutomationRunbookReceiverArgs:
    def __init__(__self__, *,
                 ...
                 use_common_alert_schema: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] automation_account_id: The automation account ID which holds this runbook and authenticates to Azure resources.
        :param pulumi.Input[builtins.bool] is_global_runbook: Indicates whether this instance is global runbook.
        :param pulumi.Input[builtins.str] name: The name of the automation runbook receiver.
...
class ActionGroupAzureAppPushReceiverArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] email_address: The email address of the user signed into the mobile app who will receive push notifications from this receiver.
        :param pulumi.Input[builtins.str] name: The name of the Azure app push receiver.
        """
...
class ActionGroupAzureFunctionReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Azure Function receiver.
        :param pulumi.Input[builtins.bool] use_common_alert_schema: Enables or disables the common alert schema.
        """
...
class ActionGroupEmailReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the email receiver. Names must be unique (case-insensitive) across all receivers within an action group.
        :param pulumi.Input[builtins.bool] use_common_alert_schema: Enables or disables the common alert schema.
        """
        pulumi.set(__self__, "email_address", email_address)
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class ActionGroupEventHubReceiverArgsDict(TypedDict):
        ...
        """
        event_hub_namespace: pulumi.Input[builtins.str]
        """
...
class ActionGroupEventHubReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] event_hub_namespace: The namespace name of the Event Hub.
        :param pulumi.Input[builtins.str] name: The name of the EventHub Receiver, must be unique within action group.
        :param pulumi.Input[builtins.str] subscription_id: The ID for the subscription containing this Event Hub. Default to the subscription ID of the Action Group.
    ...
    def event_hub_namespace(self) -> pulumi.Input[builtins.str]:
        """
        The namespace name of the Event Hub.
        """
    ...
    def event_hub_namespace(self, value: pulumi.Input[builtins.str]):
...
class ActionGroupItsmReceiverArgs:
    def __init__(__self__, *,
                 ...
                 workspace_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] connection_id: The unique connection identifier of the ITSM connection.
        :param pulumi.Input[builtins.str] name: The name of the ITSM receiver.
        :param pulumi.Input[builtins.str] region: The region of the workspace.
               
               > **Note:** `ticket_configuration` should be JSON blob with `PayloadRevision` and `WorkItemType` keys (e.g., `ticket_configuration="{\\"PayloadRevision\\":0,\\"WorkItemType\\":\\"Incident\\"}"`), and `ticket_configuration="{}"` will return an error, see more at this [REST API issue](https://github.com/Azure/azure-rest-api-specs/issues/20488)
        :param pulumi.Input[builtins.str] ticket_configuration: A JSON blob for the configurations of the ITSM action. CreateMultipleWorkItems option will be part of this blob as well.
        :param pulumi.Input[builtins.str] workspace_id: The Azure Log Analytics workspace ID where this connection is defined. Format is `<subscription id>|<workspace id>`, for example `00000000-0000-0000-0000-000000000000|00000000-0000-0000-0000-000000000000`.
        """
...
class ActionGroupLogicAppReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the logic app receiver.
        :param pulumi.Input[builtins.str] resource_id: The Azure resource ID of the logic app.
        :param pulumi.Input[builtins.bool] use_common_alert_schema: Enables or disables the common alert schema.
        """
...
class ActionGroupSmsReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the SMS receiver. Names must be unique (case-insensitive) across all receivers within an action group.
...
class ActionGroupVoiceReceiverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the voice receiver.
...
class ActionGroupWebhookReceiverArgs:
    def __init__(__self__, *,
                 ...
                 use_common_alert_schema: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the webhook receiver. Names must be unique (case-insensitive) across all receivers within an action group.
        :param pulumi.Input[builtins.str] service_uri: The URI where webhooks should be sent.
...
class ActionGroupWebhookReceiverAadAuthArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] object_id: The webhook application object Id for AAD auth.
        :param pulumi.Input[builtins.str] identifier_uri: The identifier URI for AAD auth.
        :param pulumi.Input[builtins.str] tenant_id: The tenant id for AAD auth.
        """
...
class ActivityLogAlertActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action_group_id: The ID of the Action Group can be sourced from the `monitoring.ActionGroup` resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] webhook_properties: The map of custom string properties to include with the post operation. These data are appended to the webhook payload.
        """
...
if not MYPY:
    class ActivityLogAlertCriteriaArgsDict(TypedDict):
        ...
        """
        levels: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        recommendation_category: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        recommendation_impact: NotRequired[pulumi.Input[builtins.str]]
        """
        The recommendation impact of the event. Possible values are `High`, `Medium` and `Low`. It is only allowed when `category` is `Recommendation`.
        """
        recommendation_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        resource_providers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        sub_status: NotRequired[pulumi.Input[builtins.str]]
        """
        The sub status of the event.
        """
        sub_statuses: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ActivityLogAlertCriteriaArgs:
    def __init__(__self__, *,
                 ...
                 levels: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 operation_name: Optional[pulumi.Input[builtins.str]] = None,
                 recommendation_category: Optional[pulumi.Input[builtins.str]] = None,
                 recommendation_impact: Optional[pulumi.Input[builtins.str]] = None,
                 recommendation_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 resource_providers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 sub_statuses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] category: The category of the operation. Possible values are `Administrative`, `Autoscale`, `Policy`, `Recommendation`, `ResourceHealth`, `Security` and `ServiceHealth`.
        :param pulumi.Input[builtins.str] caller: The email address or Azure Active Directory identifier of the user who performed the operation.
        :param pulumi.Input[builtins.str] level: The severity level of the event. Possible values are `Verbose`, `Informational`, `Warning`, `Error`, and `Critical`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] levels: A list of severity level of the event. Possible values are `Verbose`, `Informational`, `Warning`, `Error`, and `Critical`.
               
               > **Note:** `level` and `levels` are mutually exclusive.
        :param pulumi.Input[builtins.str] operation_name: The Resource Manager Role-Based Access Control operation name. Supported operation should be of the form: `<resourceProvider>/<resourceType>/<operation>`.
        :param pulumi.Input[builtins.str] recommendation_category: The recommendation category of the event. Possible values are `Cost`, `Reliability`, `OperationalExcellence`, `HighAvailability` and `Performance`. It is only allowed when `category` is `Recommendation`.
        :param pulumi.Input[builtins.str] recommendation_impact: The recommendation impact of the event. Possible values are `High`, `Medium` and `Low`. It is only allowed when `category` is `Recommendation`.
        :param pulumi.Input[builtins.str] recommendation_type: The recommendation type of the event. It is only allowed when `category` is `Recommendation`.
        :param pulumi.Input[builtins.str] resource_group: The name of resource group monitored by the activity log alert.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_groups: A list of names of resource groups monitored by the activity log alert.
        ...
        :param pulumi.Input[builtins.str] resource_id: The specific resource monitored by the activity log alert. It should be within one of the `scopes`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_ids: A list of specific resources monitored by the activity log alert. It should be within one of the `scopes`.
               
               > **Note:** `resource_id` and `resource_ids` are mutually exclusive.
        :param pulumi.Input[builtins.str] resource_provider: The name of the resource provider monitored by the activity log alert.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_providers: A list of names of resource providers monitored by the activity log alert.
               
               > **Note:** `resource_provider` and `resource_providers` are mutually exclusive.
        :param pulumi.Input[builtins.str] resource_type: The resource type monitored by the activity log alert.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types: A list of resource types monitored by the activity log alert.
        ...
        :param pulumi.Input[builtins.str] status: The status of the event. For example, `Started`, `Failed`, or `Succeeded`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] statuses: A list of status of the event. For example, `Started`, `Failed`, or `Succeeded`.
               
               > **Note:** `status` and `statuses` are mutually exclusive.
        :param pulumi.Input[builtins.str] sub_status: The sub status of the event.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sub_statuses: A list of sub status of the event.
    ...
    @property
    @pulumi.getter
    def levels(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of severity level of the event. Possible values are `Verbose`, `Informational`, `Warning`, `Error`, and `Critical`.
    ...
    @levels.setter
    def levels(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def recommendation_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The recommendation category of the event. Possible values are `Cost`, `Reliability`, `OperationalExcellence`, `HighAvailability` and `Performance`. It is only allowed when `category` is `Recommendation`.
        """
    ...
    def recommendation_category(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recommendation_category", value)

    @property
    @pulumi.getter(name="recommendationImpact")
    def recommendation_impact(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The recommendation impact of the event. Possible values are `High`, `Medium` and `Low`. It is only allowed when `category` is `Recommendation`.
        """
    ...
    def recommendation_impact(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recommendation_impact", value)

    @property
    @pulumi.getter(name="recommendationType")
    def recommendation_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The recommendation type of the event. It is only allowed when `category` is `Recommendation`.
        """
    ...
    def recommendation_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def resource_providers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of names of resource providers monitored by the activity log alert.
    ...
    def resource_providers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def sub_statuses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of sub status of the event.
    ...
    @sub_statuses.setter
    def sub_statuses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "sub_statuses", value)


if not MYPY:
    class ActivityLogAlertCriteriaResourceHealthArgsDict(TypedDict):
        currents: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        previouses: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ActivityLogAlertCriteriaResourceHealthArgs:
    def __init__(__self__, *,
                 currents: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 previouses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 reasons: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] currents: The current resource health statuses that will log an alert. Possible values are `Available`, `Degraded`, `Unavailable` and `Unknown`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] previouses: The previous resource health statuses that will log an alert. Possible values are `Available`, `Degraded`, `Unavailable` and `Unknown`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] reasons: The reason that will log an alert. Possible values are `PlatformInitiated` (such as a problem with the resource in an affected region of an Azure incident), `UserInitiated` (such as a shutdown request of a VM) and `Unknown`.
        """
    ...
    @property
    @pulumi.getter
    def currents(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The current resource health statuses that will log an alert. Possible values are `Available`, `Degraded`, `Unavailable` and `Unknown`.
        """
    ...
    @currents.setter
    def currents(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "currents", value)

    @property
    @pulumi.getter
    def previouses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The previous resource health statuses that will log an alert. Possible values are `Available`, `Degraded`, `Unavailable` and `Unknown`.
        """
    ...
    @previouses.setter
    def previouses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ActivityLogAlertCriteriaServiceHealthArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: Events this alert will monitor Possible values are `Incident`, `Maintenance`, `Informational`, `ActionRequired` and `Security`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: Locations this alert will monitor. For example, `West Europe`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: Services this alert will monitor. For example, `Activity Logs & Alerts`, `Action Groups`. Defaults to all Services.
        """
...
class AlertProcessingRuleActionGroupConditionAlertContextArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies a list of values to match for a given condition.
        """
...
class AlertProcessingRuleActionGroupConditionMonitorConditionArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals` and `NotEquals`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies a list of values to match for a given condition. Possible values are `Fired` and `Resolved`.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionMonitorServiceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals` and `NotEquals`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: A list of values to match for a given condition. Possible values are `ActivityLog Administrative`, `ActivityLog Autoscale`, `ActivityLog Policy`, `ActivityLog Recommendation`, `ActivityLog Security`, `Application Insights`, `Azure Backup`, `Azure Stack Edge`, `Azure Stack Hub`, `Custom`, `Data Box Gateway`, `Health Platform`, `Log Alerts V2`, `Log Analytics`, `Platform`, `Prometheus`, `Resource Health`, `Smart Detector`, and `VM Insights - Health`.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionSeverityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals` and `NotEquals`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies list of values to match for a given condition. Possible values are `Sev0`, `Sev1`, `Sev2`, `Sev3`, and `Sev4`.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionSignalTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals` and `NotEquals`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies a list of values to match for a given condition. Possible values are `Metric`, `Log`, `Unknown`, and `Health`.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionTargetResourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: A list of values to match for a given condition. The values should be valid resource IDs.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionTargetResourceGroupArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: A list of values to match for a given condition. The values should be valid resource group IDs.
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupConditionTargetResourceTypeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: The operator for a given condition. Possible values are `Equals`, `NotEquals`, `Contains`, and `DoesNotContain`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: A list of values to match for a given condition. The values should be valid resource types. (e.g. Microsoft.Compute/VirtualMachines)
        """
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AlertProcessingRuleActionGroupScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] effective_from: Specifies the Alert Processing Rule effective start time (Y-m-d'T'H:M:S).
        :param pulumi.Input[builtins.str] effective_until: Specifies the Alert Processing Rule effective end time (Y-m-d'T'H:M:S).
        :param pulumi.Input['AlertProcessingRuleActionGroupScheduleRecurrenceArgs'] recurrence: A `recurrence` block as defined above.
        :param pulumi.Input[builtins.str] time_zone: The time zone (e.g. Pacific Standard time, Eastern Standard Time). Defaults to `UTC`. [possible values are defined here](https://docs.microsoft.com/en-us/previous-versions/windows/embedded/ms912391(v=winembedded.11)).
        """
...
class AlertProcessingRuleActionGroupScheduleRecurrenceDailyArgs:
    def __init__(__self__, *,
                 ...
                 start_time: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] end_time: Specifies the recurrence end time (H:M:S).
        :param pulumi.Input[builtins.str] start_time: Specifies the recurrence start time (H:M:S).
        """
...
class AlertProcessingRuleActionGroupScheduleRecurrenceMonthlyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] days_of_months: Specifies a list of dayOfMonth to recurrence. Possible values are integers between `1` - `31`.
        :param pulumi.Input[builtins.str] end_time: Specifies the recurrence end time (H:M:S).
        :param pulumi.Input[builtins.str] start_time: Specifies the recurrence start time (H:M:S).
        """
...
class AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs:
    def __init__(__self__, *,
                 ...
                 start_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days_of_weeks: Specifies a list of dayOfWeek to recurrence. Possible values are `Sunday`, `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, and `Saturday`.
        :param pulumi.Input[builtins.str] end_time: Specifies the recurrence end time (H:M:S).
        :param pulumi.Input[builtins.str] start_time: Specifies the recurrence start time (H:M:S).
        """
...
class AlertPrometheusRuleGroupRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alert: Specifies the Alert rule name.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] annotations: Specifies a set of informational labels that can be used to store longer additional information such as alert descriptions or runbook links.
        :param pulumi.Input[builtins.bool] enabled: Is this rule enabled? Possible values are `true` and `false`.
        :param pulumi.Input[builtins.str] for_: Specifies the amount of time alert must be active before firing, represented in ISO 8601 duration format.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] labels: Specifies the labels to add or overwrite before storing the result.
        :param pulumi.Input[builtins.str] record: Specifies the recorded metrics name.
        :param pulumi.Input[builtins.int] severity: Specifies the severity of the alerts fired by the rule. Possible values are between 0 and 4.
        """
...
class AlertPrometheusRuleGroupRuleActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action_group_id: Specifies the resource id of the monitor action group.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] action_properties: Specifies the properties of an action group object.
...
class AlertPrometheusRuleGroupRuleAlertResolutionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] auto_resolved: Is the alert auto-resolution? Possible values are `true` and `false`.
        :param pulumi.Input[builtins.str] time_to_resolve: Specifies the alert auto-resolution interval, represented in ISO 8601 duration format.
        """
...
if not MYPY:
    class AutoscaleSettingNotificationEmailArgsDict(TypedDict):
        ...
        """
        send_to_subscription_co_administrator: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AutoscaleSettingNotificationEmailArgs:
    def __init__(__self__, *,
                 ...
                 send_to_subscription_co_administrator: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_emails: Specifies a list of custom email addresses to which the email notifications will be sent.
        :param pulumi.Input[builtins.bool] send_to_subscription_administrator: Should email notifications be sent to the subscription administrator? Defaults to `false`.
        :param pulumi.Input[builtins.bool] send_to_subscription_co_administrator: Should email notifications be sent to the subscription co-administrator? Defaults to `false`.
        """
    ...
    def send_to_subscription_co_administrator(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should email notifications be sent to the subscription co-administrator? Defaults to `false`.
        """
    ...
    def send_to_subscription_co_administrator(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AutoscaleSettingNotificationWebhookArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] service_uri: The HTTPS URI which should receive scale notifications.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A map of settings.
        """
        pulumi.set(__self__, "service_uri", service_uri)
...
if not MYPY:
    class AutoscaleSettingPredictiveArgsDict(TypedDict):
        scale_mode: pulumi.Input[builtins.str]
        """
        Specifies the predictive scale mode. Possible values are `Enabled` or `ForecastOnly`.
        """
        look_ahead_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AutoscaleSettingPredictiveArgs:
    def __init__(__self__, *,
                 scale_mode: pulumi.Input[builtins.str],
                 look_ahead_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] scale_mode: Specifies the predictive scale mode. Possible values are `Enabled` or `ForecastOnly`.
        :param pulumi.Input[builtins.str] look_ahead_time: Specifies the amount of time by which instances are launched in advance. It must be between `PT1M` and `PT1H` in ISO 8601 format.
        """
    ...
    def scale_mode(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the predictive scale mode. Possible values are `Enabled` or `ForecastOnly`.
        """
    ...
    @scale_mode.setter
    def scale_mode(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "scale_mode", value)

    @property
    @pulumi.getter(name="lookAheadTime")
    def look_ahead_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the amount of time by which instances are launched in advance. It must be between `PT1M` and `PT1H` in ISO 8601 format.
        """
    ...
    def look_ahead_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutoscaleSettingProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the profile.
...
if not MYPY:
    class AutoscaleSettingProfileCapacityArgsDict(TypedDict):
        default: pulumi.Input[builtins.int]
        """
...
class AutoscaleSettingProfileCapacityArgs:
    def __init__(__self__, *,
                 ...
                 minimum: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] default: The number of instances that are available for scaling if metrics are not available for evaluation. The default is only used if the current instance count is lower than the default. Valid values are between `0` and `1000`.
        :param pulumi.Input[builtins.int] maximum: The maximum number of instances for this resource. Valid values are between `0` and `1000`.
               
               > **Note:** The maximum number of instances is also limited by the amount of Cores available in the subscription.
        :param pulumi.Input[builtins.int] minimum: The minimum number of instances for this resource. Valid values are between `0` and `1000`.
        """
    ...
    @property
    @pulumi.getter
    def default(self) -> pulumi.Input[builtins.int]:
        """
        The number of instances that are available for scaling if metrics are not available for evaluation. The default is only used if the current instance count is lower than the default. Valid values are between `0` and `1000`.
        """
    ...
    @default.setter
    def default(self, value: pulumi.Input[builtins.int]):
...
class AutoscaleSettingProfileFixedDateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] end: Specifies the end date for the profile, formatted as an RFC3339 date string.
        :param pulumi.Input[builtins.str] start: Specifies the start date for the profile, formatted as an RFC3339 date string.
        :param pulumi.Input[builtins.str] timezone: The Time Zone of the `start` and `end` times. A list of [possible values can be found here](https://learn.microsoft.com/en-us/rest/api/monitor/autoscale-settings/create-or-update?view=rest-monitor-2022-10-01&tabs=HTTP#recurrentschedule). Defaults to `UTC`.
        """
...
class AutoscaleSettingProfileRecurrenceArgs:
    def __init__(__self__, *,
                 ...
                 timezone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days: A list of days that this profile takes effect on. Possible values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`.
        :param pulumi.Input[builtins.int] hours: A list containing a single item, which specifies the Hour interval at which this recurrence should be triggered (in 24-hour time). Possible values are from `0` to `23`.
        :param pulumi.Input[builtins.int] minutes: A list containing a single item which specifies the Minute interval at which this recurrence should be triggered.
        :param pulumi.Input[builtins.str] timezone: The Time Zone used for the `hours` field. A list of possible values can be found here). Defaults to `UTC`.
        """
        pulumi.set(__self__, "days", days)
...
if not MYPY:
    class AutoscaleSettingProfileRuleMetricTriggerArgsDict(TypedDict):
        ...
        """
        metric_resource_id: pulumi.Input[builtins.str]
        """
        ...
        """
        time_aggregation: pulumi.Input[builtins.str]
        """
        ...
        """
        divide_by_instance_count: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AutoscaleSettingProfileRuleMetricTriggerArgs:
    def __init__(__self__, *,
                 ...
                 divide_by_instance_count: Optional[pulumi.Input[builtins.bool]] = None,
                 metric_namespace: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] metric_name: The name of the metric that defines what the rule monitors, such as `Percentage CPU` for `Virtual Machine Scale Sets` and `CpuPercentage` for `App Service Plan`.
               
               > **Note:** The allowed value of `metric_name` highly depends on the targeting resource type, please visit [Supported metrics with Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported) for more details.
        :param pulumi.Input[builtins.str] metric_resource_id: The ID of the Resource which the Rule monitors.
        :param pulumi.Input[builtins.str] operator: Specifies the operator used to compare the metric data and threshold. Possible values are: `Equals`, `NotEquals`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan`, `LessThanOrEqual`.
        :param pulumi.Input[builtins.str] statistic: Specifies how the metrics from multiple instances are combined. Possible values are `Average`, `Max`, `Min` and `Sum`.
        :param pulumi.Input[builtins.float] threshold: Specifies the threshold of the metric that triggers the scale action.
        :param pulumi.Input[builtins.str] time_aggregation: Specifies how the data that's collected should be combined over time. Possible values include `Average`, `Count`, `Maximum`, `Minimum`, `Last` and `Total`.
        :param pulumi.Input[builtins.str] time_grain: Specifies the granularity of metrics that the rule monitors, which must be one of the pre-defined values returned from the metric definitions for the metric. This value must be between 1 minute and 12 hours an be formatted as an ISO 8601 string.
        :param pulumi.Input[builtins.str] time_window: Specifies the time range for which data is collected, which must be greater than the delay in metric collection (which varies from resource to resource). This value must be between 5 minutes and 12 hours and be formatted as an ISO 8601 string.
        ...
        :param pulumi.Input[builtins.bool] divide_by_instance_count: Whether to enable metric divide by instance count.
        :param pulumi.Input[builtins.str] metric_namespace: The namespace of the metric that defines what the rule monitors, such as `microsoft.compute/virtualmachinescalesets` for `Virtual Machine Scale Sets`.
        """
    ...
    def metric_resource_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Resource which the Rule monitors.
        """
    ...
    def metric_resource_id(self, value: pulumi.Input[builtins.str]):
    ...
    def time_aggregation(self) -> pulumi.Input[builtins.str]:
        """
        Specifies how the data that's collected should be combined over time. Possible values include `Average`, `Count`, `Maximum`, `Minimum`, `Last` and `Total`.
        """
    ...
    def time_aggregation(self, value: pulumi.Input[builtins.str]):
    ...
    def divide_by_instance_count(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable metric divide by instance count.
        """
    ...
    def divide_by_instance_count(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AutoscaleSettingProfileRuleMetricTriggerDimensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operator: The dimension operator. Possible values are `Equals` and `NotEquals`. `Equals` means being equal to any of the values. `NotEquals` means being not equal to any of the values.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: A list of dimension values.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
class AutoscaleSettingProfileRuleScaleActionArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] cooldown: The amount of time to wait since the last scaling action before this action occurs. Must be between 1 minute and 1 week and formatted as a ISO 8601 string.
        :param pulumi.Input[builtins.str] direction: The scale direction. Possible values are `Increase` and `Decrease`.
        :param pulumi.Input[builtins.str] type: The type of action that should occur. Possible values are `ChangeCount`, `ExactCount`, `PercentChangeCount` and `ServiceAllowedNextValue`.
        :param pulumi.Input[builtins.int] value: The number of instances involved in the scaling action.
        """
...
class DataCollectionRuleDataFlowArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destinations: Specifies a list of destination names. A `azure_monitor_metrics` data source only allows for stream of kind `Microsoft-InsightsMetrics`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] streams: Specifies a list of streams. Possible values include but not limited to `Microsoft-Event`, `Microsoft-InsightsMetrics`, `Microsoft-Perf`, `Microsoft-Syslog`, `Microsoft-WindowsEvent`, and `Microsoft-PrometheusMetrics`.
        :param pulumi.Input[builtins.str] built_in_transform: The built-in transform to transform stream data.
        :param pulumi.Input[builtins.str] output_stream: The output stream of the transform. Only required if the data flow changes data to a different stream.
...
class DataCollectionRuleDataSourcesDataImportEventHubDataSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[builtins.str] stream: The stream to collect from Event Hub. Possible value should be a custom stream name.
        :param pulumi.Input[builtins.str] consumer_group: The Event Hub consumer group name.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class DataCollectionRuleDataSourcesExtensionArgsDict(TypedDict):
        ...
        """
        extension_json: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DataCollectionRuleDataSourcesExtensionArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str],
                 streams: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 extension_json: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible values include but not limited to `Microsoft-Event`, `Microsoft-InsightsMetrics`, `Microsoft-Perf`, `Microsoft-Syslog`, `Microsoft-WindowsEvent`.
        :param pulumi.Input[builtins.str] extension_json: A JSON String which specifies the extension setting.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] input_data_sources: Specifies a list of data sources this extension needs data from. An item should be a name of a supported data source which produces only one stream. Supported data sources type: `performance_counter`, `windows_event_log`,and `syslog`.
        """
    ...
    def extension_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A JSON String which specifies the extension setting.
        """
    ...
    def extension_json(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataCollectionRuleDataSourcesIisLogArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible value is `Microsoft-W3CIISLog`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_directories: Specifies a list of absolute paths where the log files are located.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "streams", streams)
...
class DataCollectionRuleDataSourcesLogFileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_patterns: Specifies a list of file patterns where the log files are located. For example, `C:\\\\JavaLogs\\\\*.log`.
        :param pulumi.Input[builtins.str] format: The data format of the log files. Possible values are `text` and `json`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible value should be custom stream names.
...
if not MYPY:
    class DataCollectionRuleDataSourcesLogFileSettingsTextArgsDict(TypedDict):
        record_start_timestamp_format: pulumi.Input[builtins.str]
        """
...
class DataCollectionRuleDataSourcesLogFileSettingsTextArgs:
    def __init__(__self__, *,
                 record_start_timestamp_format: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] record_start_timestamp_format: The timestamp format of the text log files. Possible values are `ISO 8601`, `YYYY-MM-DD HH:MM:SS`, `M/D/YYYY HH:MM:SS AM/PM`, `Mon DD, YYYY HH:MM:SS`, `yyMMdd HH:mm:ss`, `ddMMyy HH:mm:ss`, `MMM d hh:mm:ss`, `dd/MMM/yyyy:HH:mm:ss zzz`,and `yyyy-MM-ddTHH:mm:ssK`.
        """
    ...
    def record_start_timestamp_format(self) -> pulumi.Input[builtins.str]:
        """
        The timestamp format of the text log files. Possible values are `ISO 8601`, `YYYY-MM-DD HH:MM:SS`, `M/D/YYYY HH:MM:SS AM/PM`, `Mon DD, YYYY HH:MM:SS`, `yyMMdd HH:mm:ss`, `ddMMyy HH:mm:ss`, `MMM d hh:mm:ss`, `dd/MMM/yyyy:HH:mm:ss zzz`,and `yyyy-MM-ddTHH:mm:ssK`.
        """
    ...
    def record_start_timestamp_format(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DataCollectionRuleDataSourcesPerformanceCounterArgsDict(TypedDict):
        counter_specifiers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        """
        sampling_frequency_in_seconds: pulumi.Input[builtins.int]
        """
...
class DataCollectionRuleDataSourcesPerformanceCounterArgs:
    def __init__(__self__, *,
                 ...
                 streams: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] counter_specifiers: Specifies a list of specifier names of the performance counters you want to collect. To get a list of performance counters on Windows, run the command `typeperf`. Please see [this document](https://learn.microsoft.com/en-us/azure/azure-monitor/agents/data-sources-performance-counters#configure-performance-counters) for more information.
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[builtins.int] sampling_frequency_in_seconds: The number of seconds between consecutive counter measurements (samples). The value should be integer between `1` and `1800` inclusive. `sampling_frequency_in_seconds` must be equal to `60` seconds for counters collected with `Microsoft-InsightsMetrics` stream.
    ...
    def counter_specifiers(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of specifier names of the performance counters you want to collect. To get a list of performance counters on Windows, run the command `typeperf`. Please see [this document](https://learn.microsoft.com/en-us/azure/azure-monitor/agents/data-sources-performance-counters#configure-performance-counters) for more information.
        """
    ...
    def counter_specifiers(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def sampling_frequency_in_seconds(self) -> pulumi.Input[builtins.int]:
        """
        The number of seconds between consecutive counter measurements (samples). The value should be integer between `1` and `1800` inclusive. `sampling_frequency_in_seconds` must be equal to `60` seconds for counters collected with `Microsoft-InsightsMetrics` stream.
        """
    ...
    def sampling_frequency_in_seconds(self, value: pulumi.Input[builtins.int]):
...
class DataCollectionRuleDataSourcesPrometheusForwarderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible value is `Microsoft-PrometheusMetrics`.
...
class DataCollectionRuleDataSourcesPrometheusForwarderLabelIncludeFilterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] label: The label of the filter. This label should be unique across all `label_include_fileter` block. Possible value is `microsoft_metrics_include_label`.
...
if not MYPY:
    class DataCollectionRuleDataSourcesSyslogArgsDict(TypedDict):
        facility_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        log_levels: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class DataCollectionRuleDataSourcesSyslogArgs:
    def __init__(__self__, *,
                 ...
                 streams: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] facility_names: Specifies a list of facility names. Use a wildcard `*` to collect logs for all facility names. Possible values are `alert`, `*`, `audit`, `auth`, `authpriv`, `clock`, `cron`, `daemon`, `ftp`, `kern`, `local5`, `local4`, `local1`, `local7`, `local6`, `local3`, `local2`, `local0`, `lpr`, `mail`, `mark`, `news`, `nopri`, `ntp`, `syslog`, `user` and `uucp`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_levels: Specifies a list of log levels. Use a wildcard `*` to collect logs for all log levels. Possible values are `Debug`, `Info`, `Notice`, `Warning`, `Error`, `Critical`, `Alert`, `Emergency`,and `*`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to. Possible values include but not limited to `Microsoft-Syslog`,and `Microsoft-CiscoAsa`, and `Microsoft-CommonSecurityLog`.
        """
    ...
    def facility_names(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of facility names. Use a wildcard `*` to collect logs for all facility names. Possible values are `alert`, `*`, `audit`, `auth`, `authpriv`, `clock`, `cron`, `daemon`, `ftp`, `kern`, `local5`, `local4`, `local1`, `local7`, `local6`, `local3`, `local2`, `local0`, `lpr`, `mail`, `mark`, `news`, `nopri`, `ntp`, `syslog`, `user` and `uucp`.
        """
    ...
    def facility_names(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "facility_names", value)

    @property
    @pulumi.getter(name="logLevels")
    def log_levels(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of log levels. Use a wildcard `*` to collect logs for all log levels. Possible values are `Debug`, `Info`, `Notice`, `Warning`, `Error`, `Critical`, `Alert`, `Emergency`,and `*`.
        """
    ...
    @log_levels.setter
    def log_levels(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class DataCollectionRuleDataSourcesWindowsEventLogArgsDict(TypedDict):
        ...
        """
        x_path_queries: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class DataCollectionRuleDataSourcesWindowsEventLogArgs:
    ...
    def x_path_queries(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of Windows Event Log queries in XPath expression. Please see [this document](https://learn.microsoft.com/en-us/azure/azure-monitor/agents/data-collection-rule-azure-monitor-agent?tabs=cli#filter-events-using-xpath-queries) for more information.
        """
    ...
    def x_path_queries(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class DataCollectionRuleDataSourcesWindowsFirewallLogArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this data source. This name should be unique across all data sources regardless of type within the Data Collection Rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] streams: Specifies a list of streams that this data source will be sent to. A stream indicates what schema will be used for this data and usually what table in Log Analytics the data will be sent to.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "streams", streams)
...
class DataCollectionRuleDestinationsAzureMonitorMetricsArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class DataCollectionRuleDestinationsEventHubArgsDict(TypedDict):
        event_hub_id: pulumi.Input[builtins.str]
        """
...
class DataCollectionRuleDestinationsEventHubArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] event_hub_id: The resource ID of the Event Hub.
        :param pulumi.Input[builtins.str] name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        """
    ...
    def event_hub_id(self) -> pulumi.Input[builtins.str]:
        """
        The resource ID of the Event Hub.
        """
    ...
    @event_hub_id.setter
    def event_hub_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DataCollectionRuleDestinationsLogAnalyticArgsDict(TypedDict):
        ...
        The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        """
        workspace_resource_id: pulumi.Input[builtins.str]
        """
...
class DataCollectionRuleDestinationsLogAnalyticArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        :param pulumi.Input[builtins.str] workspace_resource_id: The ID of a Log Analytic Workspace resource.
        """
        pulumi.set(__self__, "name", name)
    ...
    def workspace_resource_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of a Log Analytic Workspace resource.
        """
    ...
    def workspace_resource_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "workspace_resource_id", value)


if not MYPY:
    class DataCollectionRuleDestinationsMonitorAccountArgsDict(TypedDict):
        monitor_account_id: pulumi.Input[builtins.str]
        """
...
class DataCollectionRuleDestinationsMonitorAccountArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] monitor_account_id: The resource ID of the Monitor Account.
        :param pulumi.Input[builtins.str] name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        """
    ...
    def monitor_account_id(self) -> pulumi.Input[builtins.str]:
        """
        The resource ID of the Monitor Account.
        """
    ...
    def monitor_account_id(self, value: pulumi.Input[builtins.str]):
...
class DataCollectionRuleDestinationsStorageBlobArgs:
    def __init__(__self__, *,
                 ...
                 storage_account_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] container_name: The Storage Container name.
        :param pulumi.Input[builtins.str] name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        :param pulumi.Input[builtins.str] storage_account_id: The resource ID of the Storage Account.
        """
...
class DataCollectionRuleDestinationsStorageTableDirectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this destination. This name should be unique across all destinations regardless of type within the Data Collection Rule.
        :param pulumi.Input[builtins.str] storage_account_id: The resource ID of the Storage Account.
        :param pulumi.Input[builtins.str] table_name: The Storage Table name.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "storage_account_id", storage_account_id)
...
class DataCollectionRuleIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Data Collection Rule. Possible values are `SystemAssigned` and `UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Data Collection Rule. Currently, up to 1 identity is supported.
...
class DataCollectionRuleStreamDeclarationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] stream_name: The name of the custom stream. This name should be unique across all `stream_declaration` blocks and must begin with a prefix of `Custom-`.
        """
...
class DataCollectionRuleStreamDeclarationColumnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of the column data. Possible values are `string`, `int`, `long`, `real`, `boolean`, `datetime`,and `dynamic`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class DiagnosticSettingEnabledLogArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] category: The name of a Diagnostic Log Category for this Resource.
               
               > **NOTE:** The Log Categories available vary depending on the Resource being used. You may wish to use the `monitoring_get_diagnostic_categories` Data Source or [list of service specific schemas](https://docs.microsoft.com/azure/azure-monitor/platform/resource-logs-schema#service-specific-schemas) to identify which categories are available for a given Resource.
        :param pulumi.Input[builtins.str] category_group: The name of a Diagnostic Log Category Group for this Resource.
...
if not MYPY:
    class MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteriaArgsDict(TypedDict):
        ...
        """
        failed_location_count: pulumi.Input[builtins.int]
        """
...
class MetricAlertApplicationInsightsWebTestLocationAvailabilityCriteriaArgs:
    def __init__(__self__, *,
                 ...
                 web_test_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] component_id: The ID of the Application Insights Resource.
        :param pulumi.Input[builtins.int] failed_location_count: The number of failed locations.
        :param pulumi.Input[builtins.str] web_test_id: The ID of the Application Insights Web Test.
        """
    ...
    def failed_location_count(self) -> pulumi.Input[builtins.int]:
        """
        The number of failed locations.
        """
    ...
    def failed_location_count(self, value: pulumi.Input[builtins.int]):
...
class MetricAlertCriteriaArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] aggregation: The statistic that runs over the metric values. Possible values are `Average`, `Count`, `Minimum`, `Maximum` and `Total`.
        :param pulumi.Input[builtins.str] metric_name: One of the metric names to be monitored.
        :param pulumi.Input[builtins.str] metric_namespace: One of the metric namespaces to be monitored.
        :param pulumi.Input[builtins.str] operator: The criteria operator. Possible values are `Equals`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan` and `LessThanOrEqual`.
        ...
        :param pulumi.Input[builtins.bool] skip_metric_validation: Skip the metric validation to allow creating an alert rule on a custom metric that isn't yet emitted? Defaults to `false`.
        """
...
class MetricAlertCriteriaDimensionArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] name: One of the dimension names.
        :param pulumi.Input[builtins.str] operator: The dimension operator. Possible values are `Include`, `Exclude` and `StartsWith`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The list of dimension values.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
if not MYPY:
    class MetricAlertDynamicCriteriaArgsDict(TypedDict):
        ...
        The statistic that runs over the metric values. Possible values are `Average`, `Count`, `Minimum`, `Maximum` and `Total`.
        """
        alert_sensitivity: pulumi.Input[builtins.str]
        """
        ...
        One or more `dimension` blocks as defined below.
        """
        evaluation_failure_count: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of violations to trigger an alert. Should be smaller or equal to `evaluation_total_count`. Defaults to `4`.
        """
        evaluation_total_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class MetricAlertDynamicCriteriaArgs:
    def __init__(__self__, *,
                 ...
                 evaluation_failure_count: Optional[pulumi.Input[builtins.int]] = None,
                 evaluation_total_count: Optional[pulumi.Input[builtins.int]] = None,
                 ignore_data_before: Optional[pulumi.Input[builtins.str]] = None,
                 skip_metric_validation: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] aggregation: The statistic that runs over the metric values. Possible values are `Average`, `Count`, `Minimum`, `Maximum` and `Total`.
        :param pulumi.Input[builtins.str] alert_sensitivity: The extent of deviation required to trigger an alert. Possible values are `Low`, `Medium` and `High`.
        :param pulumi.Input[builtins.str] metric_name: One of the metric names to be monitored.
        :param pulumi.Input[builtins.str] metric_namespace: One of the metric namespaces to be monitored.
        :param pulumi.Input[builtins.str] operator: The criteria operator. Possible values are `LessThan`, `GreaterThan` and `GreaterOrLessThan`.
        ...
        :param pulumi.Input[builtins.int] evaluation_failure_count: The number of violations to trigger an alert. Should be smaller or equal to `evaluation_total_count`. Defaults to `4`.
        :param pulumi.Input[builtins.int] evaluation_total_count: The number of aggregated lookback points. The lookback time window is calculated based on the aggregation granularity (`window_size`) and the selected number of aggregated points. Defaults to `4`.
        :param pulumi.Input[builtins.str] ignore_data_before: The [ISO8601](https://en.wikipedia.org/wiki/ISO_8601) date from which to start learning the metric historical data and calculate the dynamic thresholds.
        :param pulumi.Input[builtins.bool] skip_metric_validation: Skip the metric validation to allow creating an alert rule on a custom metric that isn't yet emitted?
        """
        pulumi.set(__self__, "aggregation", aggregation)
    ...
    def alert_sensitivity(self) -> pulumi.Input[builtins.str]:
        """
        The extent of deviation required to trigger an alert. Possible values are `Low`, `Medium` and `High`.
        """
    ...
    def alert_sensitivity(self, value: pulumi.Input[builtins.str]):
    ...
    def evaluation_failure_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of violations to trigger an alert. Should be smaller or equal to `evaluation_total_count`. Defaults to `4`.
        """
    ...
    def evaluation_failure_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "evaluation_failure_count", value)

    @property
    @pulumi.getter(name="evaluationTotalCount")
    def evaluation_total_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of aggregated lookback points. The lookback time window is calculated based on the aggregation granularity (`window_size`) and the selected number of aggregated points. Defaults to `4`.
        """
    ...
    def evaluation_total_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ScheduledQueryRulesAlertActionArgsDict(TypedDict):
        action_groups: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ScheduledQueryRulesAlertActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] action_groups: List of action group reference resource IDs.
        :param pulumi.Input[builtins.str] custom_webhook_payload: Custom payload to be sent for all webhook payloads in alerting action.
        :param pulumi.Input[builtins.str] email_subject: Custom subject override for all email ids in Azure action group.
        """
    ...
    def action_groups(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        List of action group reference resource IDs.
        """
    ...
    def action_groups(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ScheduledQueryRulesAlertTriggerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: Evaluation operation for rule - 'GreaterThan', GreaterThanOrEqual', 'LessThan', or 'LessThanOrEqual'.
        :param pulumi.Input[builtins.float] threshold: Result or count threshold based on which rule should be triggered. Values must be between 0 and 10000 inclusive.
...
if not MYPY:
    class ScheduledQueryRulesAlertTriggerMetricTriggerArgsDict(TypedDict):
        metric_trigger_type: pulumi.Input[builtins.str]
        """
        ...
        """
        metric_column: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ScheduledQueryRulesAlertTriggerMetricTriggerArgs:
    def __init__(__self__, *,
                 ...
                 operator: pulumi.Input[builtins.str],
                 threshold: pulumi.Input[builtins.float],
                 metric_column: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] metric_trigger_type: Metric Trigger Type - 'Consecutive' or 'Total'.
        :param pulumi.Input[builtins.str] operator: Evaluation operation for rule - 'Equal', 'GreaterThan', GreaterThanOrEqual', 'LessThan', or 'LessThanOrEqual'.
        :param pulumi.Input[builtins.float] threshold: The threshold of the metric trigger. Values must be between 0 and 10000 inclusive.
        :param pulumi.Input[builtins.str] metric_column: Evaluation of metric on a particular column.
        """
    ...
    def metric_trigger_type(self) -> pulumi.Input[builtins.str]:
        """
        Metric Trigger Type - 'Consecutive' or 'Total'.
        """
    ...
    def metric_trigger_type(self, value: pulumi.Input[builtins.str]):
    ...
    def metric_column(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Evaluation of metric on a particular column.
        """
    ...
    def metric_column(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ScheduledQueryRulesAlertV2ActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] action_groups: List of Action Group resource IDs to invoke when the alert fires.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] custom_properties: Specifies the properties of an alert payload.
        """
...
if not MYPY:
    class ScheduledQueryRulesAlertV2CriteriaArgsDict(TypedDict):
        ...
        """
        time_aggregation_method: pulumi.Input[builtins.str]
        """
...
class ScheduledQueryRulesAlertV2CriteriaArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operator: Specifies the criteria operator. Possible values are `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan`,and `LessThanOrEqual`.
        :param pulumi.Input[builtins.str] query: The query to run on logs. The results returned by this query are used to populate the alert.
        :param pulumi.Input[builtins.float] threshold: Specifies the criteria threshold value that activates the alert.
        :param pulumi.Input[builtins.str] time_aggregation_method: The type of aggregation to apply to the data points in aggregation granularity. Possible values are `Average`, `Count`, `Maximum`, `Minimum`,and `Total`.
        ...
        :param pulumi.Input[builtins.str] metric_measure_column: Specifies the column containing the metric measure number.
               
               > **Note:** `metric_measure_column` is required if `time_aggregation_method` is `Average`, `Maximum`, `Minimum`, or `Total`. And `metric_measure_column` can not be specified if `time_aggregation_method` is `Count`.
        :param pulumi.Input[builtins.str] resource_id_column: Specifies the column containing the resource ID. The content of the column must be an uri formatted as resource ID.
        """
        pulumi.set(__self__, "operator", operator)
    ...
    def time_aggregation_method(self) -> pulumi.Input[builtins.str]:
        """
        The type of aggregation to apply to the data points in aggregation granularity. Possible values are `Average`, `Count`, `Maximum`, `Minimum`,and `Total`.
        """
    ...
    def time_aggregation_method(self, value: pulumi.Input[builtins.str]):
...
class ScheduledQueryRulesAlertV2CriteriaDimensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operator: Operator for dimension values. Possible values are `Exclude`,and `Include`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: List of dimension values. Use a wildcard `*` to collect all.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "values", values)
...
if not MYPY:
    class ScheduledQueryRulesAlertV2CriteriaFailingPeriodsArgsDict(TypedDict):
        minimum_failing_periods_to_trigger_alert: pulumi.Input[builtins.int]
        """
        ...
        """
        number_of_evaluation_periods: pulumi.Input[builtins.int]
        """
...
class ScheduledQueryRulesAlertV2CriteriaFailingPeriodsArgs:
    def __init__(__self__, *,
                 ...
                 number_of_evaluation_periods: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] minimum_failing_periods_to_trigger_alert: Specifies the number of violations to trigger an alert. Should be smaller or equal to `number_of_evaluation_periods`. Possible value is integer between 1 and 6.
        :param pulumi.Input[builtins.int] number_of_evaluation_periods: Specifies the number of aggregated look-back points. The look-back time window is calculated based on the aggregation granularity `window_duration` and the selected number of aggregated points. Possible value is integer between 1 and 6.
    ...
    def minimum_failing_periods_to_trigger_alert(self) -> pulumi.Input[builtins.int]:
        """
        Specifies the number of violations to trigger an alert. Should be smaller or equal to `number_of_evaluation_periods`. Possible value is integer between 1 and 6.
        """
    ...
    def minimum_failing_periods_to_trigger_alert(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "minimum_failing_periods_to_trigger_alert", value)

    @property
    @pulumi.getter(name="numberOfEvaluationPeriods")
    def number_of_evaluation_periods(self) -> pulumi.Input[builtins.int]:
        """
        Specifies the number of aggregated look-back points. The look-back time window is calculated based on the aggregation granularity `window_duration` and the selected number of aggregated points. Possible value is integer between 1 and 6.
    ...
    def number_of_evaluation_periods(self, value: pulumi.Input[builtins.int]):
...
class ScheduledQueryRulesAlertV2IdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Scheduled Query Rule. Possible values are `SystemAssigned`, `UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of User Assigned Managed Identity IDs to be assigned to this Scheduled Query Rule.
               
               > **Note:** This is required when `type` is set to `UserAssigned`. The identity associated must have required roles, read the [Azure documentation](https://learn.microsoft.com/en-us/azure/azure-monitor/alerts/alerts-create-log-alert-rule#configure-the-alert-rule-details) for more information.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Managed Service Identity of this App Service slot.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Managed Service Identity of this App Service slot.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ScheduledQueryRulesLogCriteriaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] metric_name: Name of the metric. Supported metrics are listed in the Azure Monitor [Microsoft.OperationalInsights/workspaces](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported#microsoftoperationalinsightsworkspaces) metrics namespace.
        """
        pulumi.set(__self__, "dimensions", dimensions)
        pulumi.set(__self__, "metric_name", metric_name)
...
class ScheduledQueryRulesLogCriteriaDimensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] operator: Operator for dimension values, - 'Include'. Defaults to `Include`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
if not MYPY:
    class SmartDetectorAlertRuleActionGroupArgsDict(TypedDict):
        ...
        """
        webhook_payload: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SmartDetectorAlertRuleActionGroupArgs:
    def __init__(__self__, *,
                 ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 email_subject: Optional[pulumi.Input[builtins.str]] = None,
                 webhook_payload: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ids: Specifies the action group ids.
        :param pulumi.Input[builtins.str] email_subject: Specifies a custom email subject if Email Receiver is specified in Monitor Action Group resource.
        :param pulumi.Input[builtins.str] webhook_payload: A JSON String which Specifies the custom webhook payload if Webhook Receiver is specified in Monitor Action Group resource.
        """
    ...
    def webhook_payload(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A JSON String which Specifies the custom webhook payload if Webhook Receiver is specified in Monitor Action Group resource.
        """
    ...
    def webhook_payload(self, value: Optional[pulumi.Input[builtins.str]]):
