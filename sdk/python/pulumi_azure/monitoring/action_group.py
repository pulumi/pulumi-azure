...
class ActionGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Action Group instance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] short_name: The short name of the action group. This will be used in SMS messages.
        ...
        :param pulumi.Input[builtins.bool] enabled: Whether this action group is enabled. If an action group is not enabled, then none of its receivers will receive communications. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Action Group should exist. Changing this forces a new Action Group to be created. Defaults to `global`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Action Group. Changing this forces a new resource to be created.
