...
class DataCollectionRuleAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example1 = azure.monitoring.data_collection_rule_association.DataCollectionRuleAssociation("example1",
            name=example1-dcra,
            target_resource_id=example_linux_virtual_machine.id,
            data_collection_rule_id=example_data_collection_rule.id,
            description=example)
        # associate to a Data Collection Endpoint
        example2 = azure.monitoring.data_collection_rule_association.DataCollectionRuleAssociation("example2",
            target_resource_id=example_linux_virtual_machine.id,
