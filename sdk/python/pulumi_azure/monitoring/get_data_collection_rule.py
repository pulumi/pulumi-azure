...
def get_data_collection_rule(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Insights` - 2023-03-11
    ...
    :param _builtins.str resource_group_name: Specifies the name of the resource group the Data Collection Rule is located in.
    """
    __args__ = dict()
    __args__['name'] = name
