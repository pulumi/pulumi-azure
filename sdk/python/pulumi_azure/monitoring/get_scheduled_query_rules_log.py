...
class GetScheduledQueryRulesLogResult:
    ...
    def authorized_resource_ids(self) -> Sequence[builtins.str]:
        """
...
def get_scheduled_query_rules_log(name: Optional[builtins.str] = None,
...
def get_scheduled_query_rules_log_output(name: Optional[pulumi.Input[builtins.str]] = None,
