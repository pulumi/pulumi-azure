...
def get_action_group(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Insights` - 2023-01-01
    ...
    :param _builtins.str resource_group_name: Specifies the name of the resource group the Action Group is located in.
    """
    __args__ = dict()
    __args__['name'] = name
