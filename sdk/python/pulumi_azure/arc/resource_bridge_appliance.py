...
class ResourceBridgeApplianceArgs:
    def __init__(__self__, *,
                 distro: pulumi.Input[builtins.str],
                 identity: pulumi.Input['ResourceBridgeApplianceIdentityArgs'],
                 infrastructure_provider: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 public_key_base64: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ResourceBridgeAppliance resource.
        :param pulumi.Input[builtins.str] distro: Specifies a supported Fabric/Infrastructure for this Arc Resource Bridge Appliance. The possible value is `AKSEdge`.
        ...
        :param pulumi.Input[builtins.str] infrastructure_provider: The infrastructure provider about the connected Arc Resource Bridge Appliance. Possible values are `HCI`,`SCVMM` and `VMWare`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the resource group where the Arc Resource Bridge Appliance exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Arc Resource Bridge Appliance should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The Name which should be used for this Arc Resource Bridge Appliance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] public_key_base64: The `public_key_base64` is an RSA public key in PKCS1 format encoded in base64. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Arc Resource Bridge Appliance.
        """
    ...
    @property
    @pulumi.getter
    def distro(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @distro.setter
    def distro(self, value: pulumi.Input[builtins.str]):
    ...
    def infrastructure_provider(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def infrastructure_provider(self, value: pulumi.Input[builtins.str]):
    ...
    def public_key_base64(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_base64(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ResourceBridgeApplianceState:
    def __init__(__self__, *,
                 distro: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['ResourceBridgeApplianceIdentityArgs']] = None,
                 infrastructure_provider: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 public_key_base64: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def distro(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies a supported Fabric/Infrastructure for this Arc Resource Bridge Appliance. The possible value is `AKSEdge`.
        """
        return pulumi.get(self, "distro")
    ...
    @distro.setter
    def distro(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "distro", value)
    ...
    @property
    @pulumi.getter(name="infrastructureProvider")
    def infrastructure_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The infrastructure provider about the connected Arc Resource Bridge Appliance. Possible values are `HCI`,`SCVMM` and `VMWare`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "infrastructure_provider")
    ...
    @infrastructure_provider.setter
    def infrastructure_provider(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "infrastructure_provider", value)
...
class ResourceBridgeAppliance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            public_key_base64: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ResourceBridgeAppliance':
        """
    ...
    @property
    @pulumi.getter
    def distro(self) -> pulumi.Output[builtins.str]:
        """
        Specifies a supported Fabric/Infrastructure for this Arc Resource Bridge Appliance. The possible value is `AKSEdge`.
        """
        return pulumi.get(self, "distro")
    ...
    @property
    @pulumi.getter(name="infrastructureProvider")
    def infrastructure_provider(self) -> pulumi.Output[builtins.str]:
        """
        The infrastructure provider about the connected Arc Resource Bridge Appliance. Possible values are `HCI`,`SCVMM` and `VMWare`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "infrastructure_provider")
    ...
    @property
    @pulumi.getter(name="publicKeyBase64")
    def public_key_base64(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The `public_key_base64` is an RSA public key in PKCS1 format encoded in base64. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "public_key_base64")
