...
__all__ = [
    ...
    'ResourceBridgeApplianceIdentityArgsDict',
]

MYPY = False

if not MYPY:
    class ResourceBridgeApplianceIdentityArgsDict(TypedDict):
    ...
    ResourceBridgeApplianceIdentityArgsDict: TypeAlias = Mapping[str, Any]
...
class ResourceBridgeApplianceIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Arc Resource Bridge Appliance. The only possible value is `SystemAssigned`. Changing this forces a new resource to be created.
