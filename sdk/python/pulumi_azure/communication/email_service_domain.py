...
class EmailServiceDomainArgs:
    def __init__(__self__, *,
                 domain_management: pulumi.Input[builtins.str],
                 email_service_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 user_engagement_tracking_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a EmailServiceDomain resource.
        :param pulumi.Input[builtins.str] domain_management: Describes how a Domains resource is being managed. Possible values are `AzureManaged`, `CustomerManaged`, `CustomerManagedInExchangeOnline`. Changing this forces a new Email Communication Service to be created.
        :param pulumi.Input[builtins.str] email_service_id: The resource ID of the Email Communication Service where the Domain belongs to. Changing this forces a new Email Communication Service to be created.
        :param pulumi.Input[builtins.str] name: The name of the Email Communication Service resource. If `domain_management` is `AzureManaged`, the name must be `AzureManagedDomain`. Changing this forces a new Email Communication Service to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Email Communication Service.
        :param pulumi.Input[builtins.bool] user_engagement_tracking_enabled: Describes user engagement tracking is enabled or disabled. Defaults to `false`.
        """
    ...
    def domain_management(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def domain_management(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "domain_management", value)

    @property
    @pulumi.getter(name="emailServiceId")
    def email_service_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def email_service_id(self, value: pulumi.Input[builtins.str]):
    ...
    def user_engagement_tracking_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def user_engagement_tracking_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _EmailServiceDomainState:
    def __init__(__self__, *,
                 domain_management: Optional[pulumi.Input[builtins.str]] = None,
                 email_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 from_sender_domain: Optional[pulumi.Input[builtins.str]] = None,
                 mail_from_sender_domain: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 user_engagement_tracking_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_management: Describes how a Domains resource is being managed. Possible values are `AzureManaged`, `CustomerManaged`, `CustomerManagedInExchangeOnline`. Changing this forces a new Email Communication Service to be created.
        :param pulumi.Input[builtins.str] email_service_id: The resource ID of the Email Communication Service where the Domain belongs to. Changing this forces a new Email Communication Service to be created.
        :param pulumi.Input[builtins.str] from_sender_domain: P2 sender domain that is displayed to the email recipients [RFC 5322].
        :param pulumi.Input[builtins.str] mail_from_sender_domain: P1 sender domain that is present on the email envelope [RFC 5321].
        :param pulumi.Input[builtins.str] name: The name of the Email Communication Service resource. If `domain_management` is `AzureManaged`, the name must be `AzureManagedDomain`. Changing this forces a new Email Communication Service to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Email Communication Service.
        :param pulumi.Input[builtins.bool] user_engagement_tracking_enabled: Describes user engagement tracking is enabled or disabled. Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="domainManagement")
    def domain_management(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Describes how a Domains resource is being managed. Possible values are `AzureManaged`, `CustomerManaged`, `CustomerManagedInExchangeOnline`. Changing this forces a new Email Communication Service to be created.
        """
        return pulumi.get(self, "domain_management")
    ...
    @domain_management.setter
    def domain_management(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_management", value)

    @property
    @pulumi.getter(name="emailServiceId")
    def email_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The resource ID of the Email Communication Service where the Domain belongs to. Changing this forces a new Email Communication Service to be created.
        """
        return pulumi.get(self, "email_service_id")
    ...
    @email_service_id.setter
    def email_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "email_service_id", value)

    @property
    @pulumi.getter(name="fromSenderDomain")
    def from_sender_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def from_sender_domain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "from_sender_domain", value)

    @property
    @pulumi.getter(name="mailFromSenderDomain")
    def mail_from_sender_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mail_from_sender_domain(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EmailServiceDomain(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="domainManagement")
    def domain_management(self) -> pulumi.Output[builtins.str]:
        """
        Describes how a Domains resource is being managed. Possible values are `AzureManaged`, `CustomerManaged`, `CustomerManagedInExchangeOnline`. Changing this forces a new Email Communication Service to be created.
        """
        return pulumi.get(self, "domain_management")
    ...
    @property
    @pulumi.getter(name="emailServiceId")
    def email_service_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the Email Communication Service where the Domain belongs to. Changing this forces a new Email Communication Service to be created.
        """
        return pulumi.get(self, "email_service_id")
    ...
    @property
    @pulumi.getter(name="fromSenderDomain")
    def from_sender_domain(self) -> pulumi.Output[builtins.str]:
        """
        P2 sender domain that is displayed to the email recipients [RFC 5322].
        """
        return pulumi.get(self, "from_sender_domain")
    ...
    @property
    @pulumi.getter(name="mailFromSenderDomain")
    def mail_from_sender_domain(self) -> pulumi.Output[builtins.str]:
        """
        P1 sender domain that is present on the email envelope [RFC 5321].
        """
        return pulumi.get(self, "mail_from_sender_domain")
    ...
    @property
    @pulumi.getter(name="userEngagementTrackingEnabled")
    def user_engagement_tracking_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Describes user engagement tracking is enabled or disabled. Defaults to `false`.
        """
        return pulumi.get(self, "user_engagement_tracking_enabled")
