...
class EmailServiceDomainVerificationRecordDkim2(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the Email Communication Service resource. If `domain_management` is `AzureManaged`, the name must be `AzureManagedDomain`. Changing this forces a new Email Communication Service to be created.
        :param builtins.int ttl: Represents an expiry time in seconds to represent how long this entry can be cached by the resolver, default = 3600sec.
        :param builtins.str type: Type of the DNS record. Example: TXT
