...
class EmailServiceDomainVerificationRecordDkim2Args:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] ttl: Represents an expiry time in seconds to represent how long this entry can be cached by the resolver, default = 3600sec.
        :param pulumi.Input[builtins.str] type: Type of the DNS record. Example: TXT
