...
def get_db_servers(cloud_exadata_infrastructure_name: Optional[builtins.str] = None,
...
def get_db_servers_output(cloud_exadata_infrastructure_name: Optional[pulumi.Input[builtins.str]] = None,
