...
def get_adbs_national_character_sets(location: Optional[builtins.str] = None,
...
def get_adbs_national_character_sets_output(location: Optional[pulumi.Input[builtins.str]] = None,
