...
class GetExadataInfrastructureResult:
    ...
    def customer_contacts(self) -> Sequence[builtins.str]:
        """
    ...
    def max_db_node_storage_size_in_gbs(self) -> builtins.int:
        """
...
def get_exadata_infrastructure(name: Optional[builtins.str] = None,
    ...
    * `Oracle.Database`: 2024-06-01
    ...
    :param builtins.str name: The name of this Cloud Exadata Infrastructure.
    :param builtins.str resource_group_name: The name of the Resource Group where the Cloud Exadata Infrastructure exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_exadata_infrastructure_output(name: Optional[pulumi.Input[builtins.str]] = None,
