...
class ExascaleDatabaseStorageVaultHighCapacityDatabaseStorageArgsDict(TypedDict):
    ...
    """
    available_size_in_gb: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class ExascaleDatabaseStorageVaultHighCapacityDatabaseStorageArgs:
    def __init__(__self__, *,
                 total_size_in_gb: pulumi.Input[_builtins.int],
                 available_size_in_gb: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def available_size_in_gb(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Available size in gigabytes.
        """
    ...
    def available_size_in_gb(self, value: pulumi.Input[Optional[_builtins.int]]):
