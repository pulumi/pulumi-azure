...
class GetAutonomousDatabaseResult:
    ...
    def allowed_ips(self) -> Sequence[_builtins.int]:
        """
    ...
    def data_storage_size_in_gbs(self) -> _builtins.int:
        """
    ...
    def time_local_data_guard_enabled_on(self) -> _builtins.str:
        """
...
def get_autonomous_database(name: Optional[_builtins.str] = None,
    ...
    * `Oracle.Database` - 2025-09-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Autonomous Database exists.
    """
    __args__ = dict()
    __args__['name'] = name
