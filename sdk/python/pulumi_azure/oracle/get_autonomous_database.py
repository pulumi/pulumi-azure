...
class GetAutonomousDatabaseResult:
    ...
    def allowed_ips(self) -> Sequence[builtins.int]:
        """
    ...
    def auto_scaling_for_storage_enabled(self) -> builtins.bool:
        """
    ...
    def data_storage_size_in_gbs(self) -> builtins.int:
        """
    ...
    def local_data_guard_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def preview(self) -> builtins.bool:
        """
    ...
    def preview_version_with_service_terms_accepted(self) -> builtins.bool:
        """
    ...
    def provisionable_cpuses(self) -> Sequence[builtins.int]:
        """
    ...
    def remote_data_guard_enabled(self) -> builtins.bool:
        """
...
def get_autonomous_database(name: Optional[builtins.str] = None,
    ...
    * `Oracle.Database`: 2024-06-01
    ...
    :param builtins.str name: The name of this Autonomous Database.
    :param builtins.str resource_group_name: The name of the Resource Group where the Autonomous Database exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_autonomous_database_output(name: Optional[pulumi.Input[builtins.str]] = None,
