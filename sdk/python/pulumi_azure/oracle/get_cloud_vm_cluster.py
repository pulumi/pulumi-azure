...
class GetCloudVmClusterResult:
    ...
    def hostname_actual(self) -> _builtins.str:
        """
    ...
    def nsg_url(self) -> _builtins.str:
        """
    ...
    def subnet_ocid(self) -> _builtins.str:
        """
    ...
    def vip_ods(self) -> Sequence[_builtins.str]:
        """
...
def get_cloud_vm_cluster(name: Optional[_builtins.str] = None,
    ...
    * `Oracle.Database` - 2025-09-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Cloud VM Cluster exists.
    """
    __args__ = dict()
    __args__['name'] = name
