...
class GetCloudVmClusterResult:
    ...
    def compute_nodes(self) -> Sequence[builtins.str]:
        """
    ...
    def vip_ods(self) -> Sequence[builtins.str]:
        """
...
def get_cloud_vm_cluster(name: Optional[builtins.str] = None,
...
def get_cloud_vm_cluster_output(name: Optional[pulumi.Input[builtins.str]] = None,
