...
class SharedPrivateLinkServiceArgs:
    def __init__(__self__, *,
                 search_service_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] search_service_id: Specify the id of the Azure Search Service. Changing this forces a new resource to be created.
    ...
    def search_service_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def search_service_id(self, value: pulumi.Input[builtins.str]):
...
class _SharedPrivateLinkServiceState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 request_message: Optional[pulumi.Input[builtins.str]] = None,
                 search_service_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="searchServiceId")
    def search_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specify the id of the Azure Search Service. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "search_service_id")
    ...
    @search_service_id.setter
    def search_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "search_service_id", value)
...
class SharedPrivateLinkService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            subresource_name: Optional[pulumi.Input[builtins.str]] = None,
            target_resource_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SharedPrivateLinkService':
        """
    ...
    @property
    @pulumi.getter(name="searchServiceId")
    def search_service_id(self) -> pulumi.Output[builtins.str]:
        """
        Specify the id of the Azure Search Service. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "search_service_id")
