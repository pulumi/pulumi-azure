...
class HubApnsCredentialArgs:
    def __init__(__self__, *,
                 ...
                 token: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] application_mode: The Application Mode which defines which server the APNS Messages should be sent to. Possible values are `Production` and `Sandbox`.
        :param pulumi.Input[_builtins.str] bundle_id: The Bundle ID of the iOS/macOS application to send push notifications for, such as `com.org.example`.
        :param pulumi.Input[_builtins.str] key_id: The Apple Push Notifications Service (APNS) Key.
        :param pulumi.Input[_builtins.str] team_id: The ID of the team the Token.
        :param pulumi.Input[_builtins.str] token: The Push Token associated with the Apple Developer Account. This is the contents of the `key` downloaded from [the Apple Developer Portal](https://developer.apple.com/account/ios/authkey/) between the `-----BEGIN PRIVATE KEY-----` and `-----END PRIVATE KEY-----` blocks.
        """
    ...
    def application_mode(self) -> pulumi.Input[_builtins.str]:
        """
        The Application Mode which defines which server the APNS Messages should be sent to. Possible values are `Production` and `Sandbox`.
        """
    ...
    def application_mode(self, value: pulumi.Input[_builtins.str]):
...
class HubBrowserCredentialArgs:
    def __init__(__self__, *,
                 ...
                 vapid_public_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] subject: The subject name of web push.
        :param pulumi.Input[_builtins.str] vapid_private_key: The Voluntary Application Server Identification (VAPID) private key.
        :param pulumi.Input[_builtins.str] vapid_public_key: The Voluntary Application Server Identification (VAPID) public key.
        """
...
class HubGcmCredentialArgs:
    def __init__(__self__, *,
                 api_key: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] api_key: The API Key associated with the Google Cloud Messaging service.
        """
