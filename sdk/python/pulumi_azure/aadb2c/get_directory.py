...
class GetDirectoryResult:
    ...
    def data_residency_location(self) -> _builtins.str:
        """
    ...
    def effective_start_date(self) -> _builtins.str:
        """
...
def get_directory(domain_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.AzureActiveDirectory` - 2021-04-01-preview
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the AAD B2C Directory exists.
    """
    __args__ = dict()
...
def get_directory_output(domain_name: Optional[pulumi.Input[_builtins.str]] = None,
