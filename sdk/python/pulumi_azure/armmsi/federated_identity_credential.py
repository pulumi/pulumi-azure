...
class FederatedIdentityCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] audience: Specifies the audience for this Federated Identity Credential.
        :param pulumi.Input[builtins.str] issuer: Specifies the issuer of this Federated Identity Credential.
        :param pulumi.Input[builtins.str] parent_id: Specifies parent ID of User Assigned Identity for this Federated Identity Credential. Changing this forces a new Federated Identity Credential to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group within which this Federated Identity Credential should exist. Changing this forces a new Federated Identity Credential to be created.
        :param pulumi.Input[builtins.str] subject: Specifies the subject for this Federated Identity Credential.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Federated Identity Credential. Changing this forces a new resource to be created.
        """
...
class FederatedIdentityCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            subject: Optional[pulumi.Input[builtins.str]] = None) -> 'FederatedIdentityCredential':
        """
