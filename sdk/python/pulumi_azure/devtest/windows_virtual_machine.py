...
class WindowsVirtualMachine(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, __name__, __opts__=None, allow_claim=None, disallow_public_ip_address=None, gallery_image_reference=None, inbound_nat_rules=None, lab_name=None, lab_subnet_name=None, lab_virtual_network_id=None, location=None, name=None, notes=None, password=None, resource_group_name=None, size=None, storage_type=None, tags=None, username=None):
