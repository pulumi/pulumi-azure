...
class WindowsVirtualMachineArgs:
    def __init__(__self__, *,
                 ...
                 lab_subnet_name: pulumi.Input[builtins.str],
                 lab_virtual_network_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.bool] allow_claim: Can this Virtual Machine be claimed by users? Defaults to `true`.
    ...
    def lab_subnet_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def lab_subnet_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "lab_subnet_name", value)

    @property
    @pulumi.getter(name="labVirtualNetworkId")
    def lab_virtual_network_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def lab_virtual_network_id(self, value: pulumi.Input[builtins.str]):
...
class _WindowsVirtualMachineState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] allow_claim: Can this Virtual Machine be claimed by users? Defaults to `true`.
        :param pulumi.Input[builtins.bool] disallow_public_ip_address: Should the Virtual Machine be created without a Public IP Address? Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the Virtual Machine.
        :param pulumi.Input['WindowsVirtualMachineGalleryImageReferenceArgs'] gallery_image_reference: A `gallery_image_reference` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input['WindowsVirtualMachineInboundNatRuleArgs']]] inbound_nat_rules: One or more `inbound_nat_rule` blocks as defined below. Changing this forces a new resource to be created.
...
class WindowsVirtualMachine(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            unique_identifier: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'WindowsVirtualMachine':
        """
    ...
    @property
    @pulumi.getter(name="labSubnetName")
    def lab_subnet_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of a Subnet within the Dev Test Virtual Network where this machine should exist. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "lab_subnet_name")
    ...
    @property
    @pulumi.getter(name="labVirtualNetworkId")
    def lab_virtual_network_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Dev Test Virtual Network where this Virtual Machine should be created. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "lab_virtual_network_id")
