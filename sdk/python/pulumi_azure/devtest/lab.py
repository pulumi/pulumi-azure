...
class LabArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group under which the Dev Test Lab resource has to be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the Dev Test Lab should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Dev Test Lab. Changing this forces a new resource to be created.
...
class _LabState:
    def __init__(__self__, *,
                 artifacts_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_premium_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 key_vault_id: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 premium_data_disk_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] artifacts_storage_account_id: The ID of the Storage Account used for Artifact Storage.
        :param pulumi.Input[builtins.str] default_premium_storage_account_id: The ID of the Default Premium Storage Account for this Dev Test Lab.
        :param pulumi.Input[builtins.str] default_storage_account_id: The ID of the Default Storage Account for this Dev Test Lab.
        :param pulumi.Input[builtins.str] key_vault_id: The ID of the Key used for this Dev Test Lab.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the Dev Test Lab should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Dev Test Lab. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] premium_data_disk_storage_account_id: The ID of the Storage Account used for Storage of Premium Data Disk.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group under which the Dev Test Lab resource has to be created. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] unique_identifier: The unique immutable identifier of the Dev Test Lab.
        """
    ...
    def artifacts_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def artifacts_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "artifacts_storage_account_id", value)

    @property
    @pulumi.getter(name="defaultPremiumStorageAccountId")
    def default_premium_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_premium_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_premium_storage_account_id", value)

    @property
    @pulumi.getter(name="defaultStorageAccountId")
    def default_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def premium_data_disk_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def premium_data_disk_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Lab(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            unique_identifier: Optional[pulumi.Input[builtins.str]] = None) -> 'Lab':
        """
    ...
    @property
    @pulumi.getter(name="artifactsStorageAccountId")
    def artifacts_storage_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Storage Account used for Artifact Storage.
        """
        return pulumi.get(self, "artifacts_storage_account_id")
    ...
    @property
    @pulumi.getter(name="defaultPremiumStorageAccountId")
    def default_premium_storage_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Default Premium Storage Account for this Dev Test Lab.
        """
        return pulumi.get(self, "default_premium_storage_account_id")
    ...
    @property
    @pulumi.getter(name="defaultStorageAccountId")
    def default_storage_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Default Storage Account for this Dev Test Lab.
        """
        return pulumi.get(self, "default_storage_account_id")
    ...
    @property
    @pulumi.getter(name="premiumDataDiskStorageAccountId")
    def premium_data_disk_storage_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Storage Account used for Storage of Premium Data Disk.
        """
        return pulumi.get(self, "premium_data_disk_storage_account_id")
