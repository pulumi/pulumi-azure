...
class ScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] lab_name: The name of the dev test lab. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the dev test lab schedule. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] task_type: The task type of the schedule. Possible values include `LabVmsShutdownTask` and `LabVmAutoStart`.
        :param pulumi.Input[builtins.str] time_zone_id: The time zone ID (e.g. Pacific Standard time).
        ...
        :param pulumi.Input[builtins.str] name: The name of the dev test lab schedule. Valid value for name depends on the `task_type`. For instance for task_type `LabVmsStartupTask` the name needs to be `LabVmAutoStart`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] status: The status of this schedule. Possible values are `Enabled` and `Disabled`. Defaults to `Disabled`.
...
class Schedule(pulumi.CustomResource):
    ...
    pulumi_type = "azure:devtest/schedule:Schedule"
