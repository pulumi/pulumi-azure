...
def get_virtual_network(lab_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.DevTestLab`: 2018-09-15
    ...
    :param builtins.str resource_group_name: Specifies the name of the resource group that contains the Virtual Network.
    """
    __args__ = dict()
...
def get_virtual_network_output(lab_name: Optional[pulumi.Input[builtins.str]] = None,
