...
class LinkedServiceArgs:
    def __init__(__self__, *,
                 ...
                 read_access_id: Optional[pulumi.Input[builtins.str]] = None,
                 write_access_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LinkedService resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Log Analytics Linked Service is created. Changing this forces a new resource to be created.
    ...
    def read_access_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def read_access_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "read_access_id", value)

    @property
    @pulumi.getter(name="writeAccessId")
    def write_access_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def write_access_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LinkedServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The generated name of the Linked Service. The format for this attribute is always `<workspace name>/<linked service type>`(e.g. `workspace1/Automation` or `workspace1/Cluster`)
        :param pulumi.Input[builtins.str] read_access_id: The ID of the readable Resource that will be linked to the workspace. This should be used for linking to an Automation Account resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Log Analytics Linked Service is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] workspace_id: The ID of the Log Analytics Workspace that will contain the Log Analytics Linked Service resource.
        :param pulumi.Input[builtins.str] write_access_id: The ID of the writable Resource that will be linked to the workspace. This should be used for linking to a Log Analytics Cluster resource.
...
class LinkedService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None,
            write_access_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LinkedService':
        """
    ...
    @property
    @pulumi.getter(name="readAccessId")
    def read_access_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the readable Resource that will be linked to the workspace. This should be used for linking to an Automation Account resource.
        """
        return pulumi.get(self, "read_access_id")
    ...
    @property
    @pulumi.getter(name="writeAccessId")
    def write_access_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the writable Resource that will be linked to the workspace. This should be used for linking to a Log Analytics Cluster resource.
