...
class WorkspaceTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] workspace_id: The object ID of the Log Analytics Workspace that contains the table.
        :param pulumi.Input[builtins.str] name: Specifies the name of a table in a Log Analytics Workspace.
        :param pulumi.Input[builtins.str] plan: Specify the system how to handle and charge the logs ingested to the table. Possible values are `Analytics` and `Basic`. Defaults to `Analytics`.
        ...
        :param pulumi.Input[builtins.int] retention_in_days: The table's retention in days. Possible values are either `8` (Basic Tier only) or range between `4` and `730`.
        :param pulumi.Input[builtins.int] total_retention_in_days: The table's total retention in days. Possible values range between `4` and `730`; or `1095`, `1460`, `1826`, `2191`, `2556`, `2922`, `3288`, `3653`, `4018`, or `4383`.
...
class WorkspaceTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_in_days: Optional[pulumi.Input[builtins.int]] = None,
            total_retention_in_days: Optional[pulumi.Input[builtins.int]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceTable':
        """
