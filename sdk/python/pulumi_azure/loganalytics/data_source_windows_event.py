...
class DataSourceWindowsEventArgs:
    def __init__(__self__, *,
                 event_log_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] event_log_name: Specifies the name of the Windows Event Log to collect events from.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_types: Specifies an array of event types applied to the specified event log. Possible values include `Error`, `Warning` and `Information`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Log Analytics Windows Event DataSource should exist. Changing this forces a new Log Analytics Windows Event DataSource to be created.
        :param pulumi.Input[builtins.str] workspace_name: The name of the Log Analytics Workspace where the Log Analytics Windows Event DataSource should exist. Changing this forces a new Log Analytics Windows Event DataSource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Log Analytics Windows Event DataSource. Changing this forces a new Log Analytics Windows Event DataSource to be created.
        """
    ...
    def event_log_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def event_log_name(self, value: pulumi.Input[builtins.str]):
...
class _DataSourceWindowsEventState:
    def __init__(__self__, *,
                 event_log_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="eventLogName")
    def event_log_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the name of the Windows Event Log to collect events from.
        """
        return pulumi.get(self, "event_log_name")
    ...
    @event_log_name.setter
    def event_log_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_log_name", value)
...
class DataSourceWindowsEvent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            workspace_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DataSourceWindowsEvent':
        """
    ...
    @property
    @pulumi.getter(name="eventLogName")
    def event_log_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the Windows Event Log to collect events from.
        """
        return pulumi.get(self, "event_log_name")
