...
class LinkedStorageAccountArgs:
    def __init__(__self__, *,
                 ...
                 storage_account_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 workspace_resource_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a LinkedStorageAccount resource.
        :param pulumi.Input[builtins.str] data_source_type: The data source type which should be used for this Log Analytics Linked Storage Account. Possible values are `CustomLogs`, `AzureWatson`, `Query`, `Ingestion` and `Alerts`. Changing this forces a new Log Analytics Linked Storage Account to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Log Analytics Linked Storage Account should exist. Changing this forces a new Log Analytics Linked Storage Account to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] storage_account_ids: The storage account resource ids to be linked.
        :param pulumi.Input[builtins.str] workspace_resource_id: The resource ID of the Log Analytics Workspace. Changing this forces a new Log Analytics Linked Storage Account to be created.
        """
    ...
    def storage_account_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def storage_account_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class LinkedStorageAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            workspace_resource_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LinkedStorageAccount':
        """
    ...
    @property
    @pulumi.getter(name="storageAccountIds")
    def storage_account_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The storage account resource ids to be linked.
        """
        return pulumi.get(self, "storage_account_ids")
    ...
    @property
    @pulumi.getter(name="workspaceResourceId")
    def workspace_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The resource ID of the Log Analytics Workspace. Changing this forces a new Log Analytics Linked Storage Account to be created.
        """
        return pulumi.get(self, "workspace_resource_id")
