...
class DataSourceWindowsPerformanceCounterArgs:
    def __init__(__self__, *,
                 counter_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] object_name: The object name of the Log Analytics Windows Performance Counter DataSource.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the Log Analytics Windows Performance Counter DataSource should exist. Changing this forces a new Log Analytics Windows Performance Counter DataSource to be created.
        :param pulumi.Input[_builtins.str] workspace_name: The name of the Log Analytics Workspace where the Log Analytics Windows Performance Counter DataSource should exist. Changing this forces a new Log Analytics Windows Performance Counter DataSource to be created.
        :param pulumi.Input[_builtins.str] name: The Name which should be used for this Log Analytics Windows Performance Counter DataSource. Changing this forces a new Log Analytics Windows Performance Counter DataSource to be created.
        """
    ...
    def counter_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @counter_name.setter
    def counter_name(self, value: pulumi.Input[_builtins.str]):
...
class DataSourceWindowsPerformanceCounter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            object_name: Optional[pulumi.Input[_builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
            workspace_name: Optional[pulumi.Input[_builtins.str]] = None) -> 'DataSourceWindowsPerformanceCounter':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="counterName")
    def counter_name(self) -> pulumi.Output[_builtins.str]:
        """
        The friendly name of the performance counter.
        """
        return pulumi.get(self, "counter_name")
