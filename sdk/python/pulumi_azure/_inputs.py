...
if not MYPY:
    class ProviderFeaturesApiManagementArgsDict(TypedDict):
        purge_soft_delete_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        recover_soft_deleted: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesApiManagementArgs:
    def __init__(__self__, *,
                 purge_soft_delete_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 recover_soft_deleted: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def purge_soft_delete_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
    ...
    def recover_soft_deleted(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "recover_soft_deleted")

    @recover_soft_deleted.setter
    def recover_soft_deleted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ProviderFeaturesApplicationInsightsArgsDict(TypedDict):
        disable_generated_rule: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesApplicationInsightsArgs:
    def __init__(__self__, *,
                 disable_generated_rule: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def disable_generated_rule(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "disable_generated_rule")

    @disable_generated_rule.setter
    def disable_generated_rule(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ProviderFeaturesKeyVaultArgsDict(TypedDict):
        ...
        """
        purge_soft_deleted_certificates_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        """
        When enabled soft-deleted `keyvault.Certificate` resources will be permanently deleted (e.g purged), when destroyed
        """
        purge_soft_deleted_hardware_security_module_keys_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        purge_soft_deleted_hardware_security_modules_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        purge_soft_deleted_keys_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        """
        When enabled soft-deleted `keyvault.Key` resources will be permanently deleted (e.g purged), when destroyed
        """
        purge_soft_deleted_secrets_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        """
        When enabled soft-deleted `keyvault.Secret` resources will be permanently deleted (e.g purged), when destroyed
        """
        recover_soft_deleted_certificates: NotRequired[pulumi.Input[builtins.bool]]
        """
        When enabled soft-deleted `keyvault.Certificate` resources will be restored, instead of creating new ones
        """
        recover_soft_deleted_hardware_security_module_keys: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        recover_soft_deleted_key_vaults: NotRequired[pulumi.Input[builtins.bool]]
        """
        When enabled soft-deleted `keyvault.KeyVault` resources will be restored, instead of creating new ones
        """
        recover_soft_deleted_keys: NotRequired[pulumi.Input[builtins.bool]]
        """
        When enabled soft-deleted `keyvault.Key` resources will be restored, instead of creating new ones
        """
        recover_soft_deleted_secrets: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ProviderFeaturesKeyVaultArgs:
    def __init__(__self__, *,
                 purge_soft_delete_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 purge_soft_deleted_certificates_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 purge_soft_deleted_hardware_security_module_keys_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 purge_soft_deleted_hardware_security_modules_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 purge_soft_deleted_keys_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 purge_soft_deleted_secrets_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 recover_soft_deleted_certificates: Optional[pulumi.Input[builtins.bool]] = None,
                 recover_soft_deleted_hardware_security_module_keys: Optional[pulumi.Input[builtins.bool]] = None,
                 recover_soft_deleted_key_vaults: Optional[pulumi.Input[builtins.bool]] = None,
                 recover_soft_deleted_keys: Optional[pulumi.Input[builtins.bool]] = None,
                 recover_soft_deleted_secrets: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] purge_soft_delete_on_destroy: When enabled soft-deleted `keyvault.KeyVault` resources will be permanently deleted (e.g purged), when destroyed
        :param pulumi.Input[builtins.bool] purge_soft_deleted_certificates_on_destroy: When enabled soft-deleted `keyvault.Certificate` resources will be permanently deleted (e.g purged), when destroyed
        :param pulumi.Input[builtins.bool] purge_soft_deleted_hardware_security_module_keys_on_destroy: When enabled soft-deleted `keyvault.ManagedHardwareSecurityModuleKey` resources will be permanently deleted (e.g purged), when destroyed
        :param pulumi.Input[builtins.bool] purge_soft_deleted_hardware_security_modules_on_destroy: When enabled soft-deleted `keyvault.ManagedHardwareSecurityModule` resources will be permanently deleted (e.g purged), when destroyed
        :param pulumi.Input[builtins.bool] purge_soft_deleted_keys_on_destroy: When enabled soft-deleted `keyvault.Key` resources will be permanently deleted (e.g purged), when destroyed
        :param pulumi.Input[builtins.bool] purge_soft_deleted_secrets_on_destroy: When enabled soft-deleted `keyvault.Secret` resources will be permanently deleted (e.g purged), when destroyed
        :param pulumi.Input[builtins.bool] recover_soft_deleted_certificates: When enabled soft-deleted `keyvault.Certificate` resources will be restored, instead of creating new ones
        :param pulumi.Input[builtins.bool] recover_soft_deleted_hardware_security_module_keys: When enabled soft-deleted `keyvault.ManagedHardwareSecurityModuleKey` resources will be restored, instead of creating new ones
        :param pulumi.Input[builtins.bool] recover_soft_deleted_key_vaults: When enabled soft-deleted `keyvault.KeyVault` resources will be restored, instead of creating new ones
        :param pulumi.Input[builtins.bool] recover_soft_deleted_keys: When enabled soft-deleted `keyvault.Key` resources will be restored, instead of creating new ones
        :param pulumi.Input[builtins.bool] recover_soft_deleted_secrets: When enabled soft-deleted `keyvault.Secret` resources will be restored, instead of creating new ones
        """
        if purge_soft_delete_on_destroy is not None:
            pulumi.set(__self__, "purge_soft_delete_on_destroy", purge_soft_delete_on_destroy)
    ...
    def purge_soft_deleted_certificates_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.Certificate` resources will be permanently deleted (e.g purged), when destroyed
        """
    ...
    def purge_soft_deleted_certificates_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def purge_soft_deleted_hardware_security_module_keys_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.ManagedHardwareSecurityModuleKey` resources will be permanently deleted (e.g purged), when destroyed
        """
    ...
    def purge_soft_deleted_hardware_security_module_keys_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def purge_soft_deleted_hardware_security_modules_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.ManagedHardwareSecurityModule` resources will be permanently deleted (e.g purged), when destroyed
        """
    ...
    def purge_soft_deleted_hardware_security_modules_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def purge_soft_deleted_keys_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.Key` resources will be permanently deleted (e.g purged), when destroyed
        """
    ...
    def purge_soft_deleted_keys_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "purge_soft_deleted_keys_on_destroy", value)

    @property
    @pulumi.getter(name="purgeSoftDeletedSecretsOnDestroy")
    def purge_soft_deleted_secrets_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.Secret` resources will be permanently deleted (e.g purged), when destroyed
        """
    ...
    def purge_soft_deleted_secrets_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "purge_soft_deleted_secrets_on_destroy", value)

    @property
    @pulumi.getter(name="recoverSoftDeletedCertificates")
    def recover_soft_deleted_certificates(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.Certificate` resources will be restored, instead of creating new ones
        """
    ...
    def recover_soft_deleted_certificates(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "recover_soft_deleted_certificates", value)

    @property
    @pulumi.getter(name="recoverSoftDeletedHardwareSecurityModuleKeys")
    def recover_soft_deleted_hardware_security_module_keys(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.ManagedHardwareSecurityModuleKey` resources will be restored, instead of creating new ones
        """
    ...
    def recover_soft_deleted_hardware_security_module_keys(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "recover_soft_deleted_hardware_security_module_keys", value)

    @property
    @pulumi.getter(name="recoverSoftDeletedKeyVaults")
    def recover_soft_deleted_key_vaults(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.KeyVault` resources will be restored, instead of creating new ones
        """
    ...
    def recover_soft_deleted_key_vaults(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "recover_soft_deleted_key_vaults", value)

    @property
    @pulumi.getter(name="recoverSoftDeletedKeys")
    def recover_soft_deleted_keys(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.Key` resources will be restored, instead of creating new ones
        """
    ...
    def recover_soft_deleted_keys(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "recover_soft_deleted_keys", value)

    @property
    @pulumi.getter(name="recoverSoftDeletedSecrets")
    def recover_soft_deleted_secrets(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled soft-deleted `keyvault.Secret` resources will be restored, instead of creating new ones
        """
    ...
    def recover_soft_deleted_secrets(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "recover_soft_deleted_secrets", value)


if not MYPY:
    class ProviderFeaturesLogAnalyticsWorkspaceArgsDict(TypedDict):
        permanently_delete_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
if not MYPY:
    class ProviderFeaturesMachineLearningArgsDict(TypedDict):
        purge_soft_deleted_workspace_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesMachineLearningArgs:
    def __init__(__self__, *,
                 purge_soft_deleted_workspace_on_destroy: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def purge_soft_deleted_workspace_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "purge_soft_deleted_workspace_on_destroy")

    @purge_soft_deleted_workspace_on_destroy.setter
    def purge_soft_deleted_workspace_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "purge_soft_deleted_workspace_on_destroy", value)


if not MYPY:
    class ProviderFeaturesManagedDiskArgsDict(TypedDict):
        expand_without_downtime: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesManagedDiskArgs:
    def __init__(__self__, *,
                 expand_without_downtime: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def expand_without_downtime(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "expand_without_downtime")

    @expand_without_downtime.setter
    def expand_without_downtime(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "expand_without_downtime", value)


if not MYPY:
    class ProviderFeaturesNetappArgsDict(TypedDict):
        delete_backups_on_backup_vault_destroy: NotRequired[pulumi.Input[builtins.bool]]
        """
        When enabled, backups will be deleted when the `netapp.BackupVault` resource is destroyed
        """
        prevent_volume_destruction: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ProviderFeaturesNetappArgs:
    def __init__(__self__, *,
                 delete_backups_on_backup_vault_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 prevent_volume_destruction: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] delete_backups_on_backup_vault_destroy: When enabled, backups will be deleted when the `netapp.BackupVault` resource is destroyed
        :param pulumi.Input[builtins.bool] prevent_volume_destruction: When enabled, the volume will not be destroyed, safeguarding from severe data loss
        """
    ...
    def delete_backups_on_backup_vault_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, backups will be deleted when the `netapp.BackupVault` resource is destroyed
        """
    ...
    def delete_backups_on_backup_vault_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "delete_backups_on_backup_vault_destroy", value)

    @property
    @pulumi.getter(name="preventVolumeDestruction")
    def prevent_volume_destruction(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        When enabled, the volume will not be destroyed, safeguarding from severe data loss
        """
    ...
    def prevent_volume_destruction(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "prevent_volume_destruction", value)


if not MYPY:
    class ProviderFeaturesPostgresqlFlexibleServerArgsDict(TypedDict):
        restart_server_on_configuration_value_change: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesPostgresqlFlexibleServerArgs:
    def __init__(__self__, *,
                 restart_server_on_configuration_value_change: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def restart_server_on_configuration_value_change(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "restart_server_on_configuration_value_change")

    @restart_server_on_configuration_value_change.setter
    def restart_server_on_configuration_value_change(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ProviderFeaturesRecoveryServiceArgsDict(TypedDict):
        purge_protected_items_from_vault_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        vm_backup_stop_protection_and_retain_data_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
        vm_backup_suspend_protection_and_retain_data_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesRecoveryServiceArgs:
    def __init__(__self__, *,
                 purge_protected_items_from_vault_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 vm_backup_stop_protection_and_retain_data_on_destroy: Optional[pulumi.Input[builtins.bool]] = None,
                 vm_backup_suspend_protection_and_retain_data_on_destroy: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def purge_protected_items_from_vault_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "purge_protected_items_from_vault_on_destroy")

    @purge_protected_items_from_vault_on_destroy.setter
    def purge_protected_items_from_vault_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vm_backup_stop_protection_and_retain_data_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
    ...
    def vm_backup_stop_protection_and_retain_data_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vm_backup_suspend_protection_and_retain_data_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
    ...
    def vm_backup_suspend_protection_and_retain_data_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ProviderFeaturesRecoveryServicesVaultsArgsDict(TypedDict):
        recover_soft_deleted_backup_protected_vm: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesRecoveryServicesVaultsArgs:
    def __init__(__self__, *,
                 recover_soft_deleted_backup_protected_vm: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def recover_soft_deleted_backup_protected_vm(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "recover_soft_deleted_backup_protected_vm")

    @recover_soft_deleted_backup_protected_vm.setter
    def recover_soft_deleted_backup_protected_vm(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "recover_soft_deleted_backup_protected_vm", value)


if not MYPY:
    class ProviderFeaturesResourceGroupArgsDict(TypedDict):
        prevent_deletion_if_contains_resources: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesResourceGroupArgs:
    def __init__(__self__, *,
                 prevent_deletion_if_contains_resources: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def prevent_deletion_if_contains_resources(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "prevent_deletion_if_contains_resources")

    @prevent_deletion_if_contains_resources.setter
    def prevent_deletion_if_contains_resources(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "prevent_deletion_if_contains_resources", value)


if not MYPY:
    class ProviderFeaturesStorageArgsDict(TypedDict):
        data_plane_available: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesStorageArgs:
    def __init__(__self__, *,
                 data_plane_available: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def data_plane_available(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "data_plane_available")

    @data_plane_available.setter
    def data_plane_available(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "data_plane_available", value)


if not MYPY:
    class ProviderFeaturesSubscriptionArgsDict(TypedDict):
        prevent_cancellation_on_destroy: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesSubscriptionArgs:
    def __init__(__self__, *,
                 prevent_cancellation_on_destroy: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def prevent_cancellation_on_destroy(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "prevent_cancellation_on_destroy")

    @prevent_cancellation_on_destroy.setter
    def prevent_cancellation_on_destroy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "prevent_cancellation_on_destroy", value)


if not MYPY:
    class ProviderFeaturesTemplateDeploymentArgsDict(TypedDict):
        delete_nested_items_during_deletion: pulumi.Input[builtins.bool]
elif False:
...
class ProviderFeaturesTemplateDeploymentArgs:
    ...
    def delete_nested_items_during_deletion(self) -> pulumi.Input[builtins.bool]:
        return pulumi.get(self, "delete_nested_items_during_deletion")

    @delete_nested_items_during_deletion.setter
    def delete_nested_items_during_deletion(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "delete_nested_items_during_deletion", value)


if not MYPY:
    class ProviderFeaturesVirtualMachineArgsDict(TypedDict):
        delete_os_disk_on_deletion: NotRequired[pulumi.Input[builtins.bool]]
        detach_implicit_data_disk_on_deletion: NotRequired[pulumi.Input[builtins.bool]]
        graceful_shutdown: NotRequired[pulumi.Input[builtins.bool]]
        skip_shutdown_and_force_delete: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesVirtualMachineArgs:
    def __init__(__self__, *,
                 delete_os_disk_on_deletion: Optional[pulumi.Input[builtins.bool]] = None,
                 detach_implicit_data_disk_on_deletion: Optional[pulumi.Input[builtins.bool]] = None,
                 graceful_shutdown: Optional[pulumi.Input[builtins.bool]] = None,
                 skip_shutdown_and_force_delete: Optional[pulumi.Input[builtins.bool]] = None):
    ...
    def delete_os_disk_on_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "delete_os_disk_on_deletion")

    @delete_os_disk_on_deletion.setter
    def delete_os_disk_on_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "delete_os_disk_on_deletion", value)

    @property
    @pulumi.getter(name="detachImplicitDataDiskOnDeletion")
    def detach_implicit_data_disk_on_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "detach_implicit_data_disk_on_deletion")

    @detach_implicit_data_disk_on_deletion.setter
    def detach_implicit_data_disk_on_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def skip_shutdown_and_force_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "skip_shutdown_and_force_delete")

    @skip_shutdown_and_force_delete.setter
    def skip_shutdown_and_force_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ProviderFeaturesVirtualMachineScaleSetArgsDict(TypedDict):
        force_delete: NotRequired[pulumi.Input[builtins.bool]]
        reimage_on_manual_upgrade: NotRequired[pulumi.Input[builtins.bool]]
        roll_instances_when_required: NotRequired[pulumi.Input[builtins.bool]]
        scale_to_zero_before_deletion: NotRequired[pulumi.Input[builtins.bool]]
elif False:
...
class ProviderFeaturesVirtualMachineScaleSetArgs:
    def __init__(__self__, *,
                 force_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 reimage_on_manual_upgrade: Optional[pulumi.Input[builtins.bool]] = None,
                 roll_instances_when_required: Optional[pulumi.Input[builtins.bool]] = None,
                 scale_to_zero_before_deletion: Optional[pulumi.Input[builtins.bool]] = None):
        if force_delete is not None:
            pulumi.set(__self__, "force_delete", force_delete)
    ...
    def reimage_on_manual_upgrade(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "reimage_on_manual_upgrade")

    @reimage_on_manual_upgrade.setter
    def reimage_on_manual_upgrade(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "reimage_on_manual_upgrade", value)

    @property
    @pulumi.getter(name="rollInstancesWhenRequired")
    def roll_instances_when_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "roll_instances_when_required")

    @roll_instances_when_required.setter
    def roll_instances_when_required(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "roll_instances_when_required", value)

    @property
    @pulumi.getter(name="scaleToZeroBeforeDeletion")
    def scale_to_zero_before_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "scale_to_zero_before_deletion")

    @scale_to_zero_before_deletion.setter
    def scale_to_zero_before_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
