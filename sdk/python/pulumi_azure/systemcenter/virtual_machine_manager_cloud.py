...
__all__ = ['VirtualMachineManagerCloudArgs', 'VirtualMachineManagerCloud']
...
class VirtualMachineManagerCloudArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] custom_location_id: The ID of the Custom Location for the System Center Virtual Machine Manager Cloud. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the Resource Group where the System Center Virtual Machine Cloud should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] location: The Azure Region where the System Center Virtual Machine Manager Cloud should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: The name of the System Center Virtual Machine Manager Cloud. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the System Center Virtual Machine Manager Cloud.
        """
...
@pulumi.input_type
class _VirtualMachineManagerCloudState:
    def __init__(__self__, *,
...
class VirtualMachineManagerCloud(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `Microsoft.ScVmm` - 2023-10-07
        ...
        :param str resource_name: The name of the resource.
        :param VirtualMachineManagerCloudArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(VirtualMachineManagerCloudArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = VirtualMachineManagerCloudArgs.__new__(VirtualMachineManagerCloudArgs)
        ...
        super(VirtualMachineManagerCloud, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
            system_center_virtual_machine_manager_server_inventory_item_id: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'VirtualMachineManagerCloud':
        """
        ...
        __props__ = _VirtualMachineManagerCloudState.__new__(_VirtualMachineManagerCloudState)
        ...
        __props__.__dict__["system_center_virtual_machine_manager_server_inventory_item_id"] = system_center_virtual_machine_manager_server_inventory_item_id
        __props__.__dict__["tags"] = tags
        return VirtualMachineManagerCloud(resource_name, opts=opts, __props__=__props__)
