...
class GetVirtualMachineManagerInventoryItemsResult:
    ...
    def system_center_virtual_machine_manager_server_id(self) -> _builtins.str:
...
def get_virtual_machine_manager_inventory_items(inventory_type: Optional[_builtins.str] = None,
                                                system_center_virtual_machine_manager_server_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ScVmm` - 2023-10-07
    ...
    :param _builtins.str system_center_virtual_machine_manager_server_id: The ID of the System Center Virtual Machine Manager Server.
    """
    __args__ = dict()
