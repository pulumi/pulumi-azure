...
class VirtualMachineManagerVirtualMachineInstanceHardware(dict):
    ...
    def __init__(__self__, *,
                 ...
                 dynamic_memory_max_in_mb: Optional[int] = None,
                 dynamic_memory_min_in_mb: Optional[int] = None,
                 limit_cpu_for_migration_enabled: Optional[bool] = None,
                 memory_in_mb: Optional[int] = None):
        """
        :param int cpu_count: The number of vCPUs for the Virtual Machine. Possible values are between `1` and `64`.
        :param int dynamic_memory_max_in_mb: The max dynamic memory for the Virtual Machine. Possible values are between `32` and `1048576`.
        :param int dynamic_memory_min_in_mb: The min dynamic memory for the Virtual Machine. Possible values are between `32` and `1048576`.
        :param bool limit_cpu_for_migration_enabled: Whether processor compatibility mode for live migration of Virtual Machines is enabled.
        :param int memory_in_mb: The size of a Virtual Machine's memory. Possible values are between `32` and `1048576`.
        """
    ...
    def dynamic_memory_max_in_mb(self) -> Optional[int]:
        """
    ...
    def dynamic_memory_min_in_mb(self) -> Optional[int]:
        """
    ...
    def limit_cpu_for_migration_enabled(self) -> Optional[bool]:
        """
...
class VirtualMachineManagerVirtualMachineInstanceInfrastructure(dict):
    ...
    def __init__(__self__, *,
                 ...
                 system_center_virtual_machine_manager_cloud_id: Optional[str] = None,
                 system_center_virtual_machine_manager_inventory_item_id: Optional[str] = None,
                 system_center_virtual_machine_manager_template_id: Optional[str] = None,
                 system_center_virtual_machine_manager_virtual_machine_server_id: Optional[str] = None):
        """
        :param str checkpoint_type: The type of checkpoint supported for the Virtual Machine. Possible values are `Disabled`, `Production`, `ProductionOnly` and `Standard`.
        :param str system_center_virtual_machine_manager_cloud_id: The ID of the System Center Virtual Machine Manager Cloud resource to use for deploying the Virtual Machine. Changing this forces a new resource to be created.
        :param str system_center_virtual_machine_manager_inventory_item_id: The ID of the System Center Virtual Machine Manager Inventory Item for System Center Virtual Machine Manager Virtual Machine Instance. Changing this forces a new resource to be created.
        :param str system_center_virtual_machine_manager_template_id: The ID of the System Center Virtual Machine Manager Virtual Machine Template to use for deploying the Virtual Machine. Changing this forces a new resource to be created.
        :param str system_center_virtual_machine_manager_virtual_machine_server_id: The ID of the System Center Virtual Machine Manager Virtual Machine. Changing this forces a new resource to be created.
        """
    ...
    def system_center_virtual_machine_manager_cloud_id(self) -> Optional[str]:
        """
    ...
    def system_center_virtual_machine_manager_inventory_item_id(self) -> Optional[str]:
        """
    ...
    def system_center_virtual_machine_manager_template_id(self) -> Optional[str]:
        """
    ...
    def system_center_virtual_machine_manager_virtual_machine_server_id(self) -> Optional[str]:
        """
...
class VirtualMachineManagerVirtualMachineInstanceNetworkInterface(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str name: The name of the Virtual Network in System Center Virtual Machine Manager Server that the Network Interface is connected to.
        :param str ipv4_address_type: The IPv4 address type. Possible values are `Dynamic` and `Static`.
        :param str ipv6_address_type: The IPv6 address type. Possible values are `Dynamic` and `Static`.
        :param str mac_address_type: The MAC address type. Possible values are `Dynamic` and `Static`.
        :param str virtual_network_id: The ID of the System Center Virtual Machine Manager Virtual Network to connect the Network Interface.
        """
...
class VirtualMachineManagerVirtualMachineInstanceOperatingSystem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str computer_name: The computer name of the Virtual Machine. Changing this forces a new resource to be created.
        :param str admin_password: The admin password of the Virtual Machine. Changing this forces a new resource to be created.
        """
...
class VirtualMachineManagerVirtualMachineInstanceStorageDisk(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_qos_policy_name: Optional[str] = None,
                 template_disk_id: Optional[str] = None,
                 vhd_type: Optional[str] = None):
        """
        :param int bus: The disk bus. Possible values are between `0` and `3`.
        :param str bus_type: The disk bus type. Possible values are `IDE` and `SCSI`.
        :param int disk_size_gb: The disk total size.
        :param int lun: The disk lun. Possible values are between `0` and `63`.
        :param str name: The name of the disk.
        :param str storage_qos_policy_name: The name of the Storage QoS policy.
        :param str template_disk_id: The disk ID in the System Center Virtual Machine Manager Virtual Machine Template. Changing this forces a new resource to be created.
        :param str vhd_type: The disk vhd type. Possible values are `Dynamic` and `Fixed`.
        """
        if bus is not None:
    ...
    def storage_qos_policy_name(self) -> Optional[str]:
        """
