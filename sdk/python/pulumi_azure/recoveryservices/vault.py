...
class VaultArgs:
    def __init__(__self__, *,
                 ...
                 classic_vmware_replication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 cross_region_restore_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 encryption: Optional[pulumi.Input['VaultEncryptionArgs']] = None,
                 identity: Optional[pulumi.Input['VaultIdentityArgs']] = None,
                 immutability: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 soft_delete_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 storage_mode_type: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Vault resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Recovery Services Vault. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku: Sets the vault's SKU. Possible values include: `Standard`, `RS0`.
        :param pulumi.Input[builtins.bool] classic_vmware_replication_enabled: Whether to enable the Classic experience for VMware replication. If set to `false` VMware machines will be protected using the new stateless ASR replication appliance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] cross_region_restore_enabled: Is cross region restore enabled for this Vault? Only can be `true`, when `storage_mode_type` is `GeoRedundant`. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] immutability: Immutability Settings of vault, possible values include: `Locked`, `Unlocked` and `Disabled`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Recovery Services Vault. Recovery Service Vault name must be 2 - 50 characters long, start with a letter, contain only letters, numbers and hyphens. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Is it enabled to access the vault from public networks. Defaults to `true`.
        :param pulumi.Input[builtins.bool] soft_delete_enabled: Is soft delete enable for this Vault? Defaults to `true`.
        :param pulumi.Input[builtins.str] storage_mode_type: The storage type of the Recovery Services Vault. Possible values are `GeoRedundant`, `LocallyRedundant` and `ZoneRedundant`. Defaults to `GeoRedundant`.
    ...
    def classic_vmware_replication_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def classic_vmware_replication_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "classic_vmware_replication_enabled", value)

    @property
    @pulumi.getter(name="crossRegionRestoreEnabled")
    def cross_region_restore_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cross_region_restore_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def immutability(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @immutability.setter
    def immutability(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def soft_delete_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def soft_delete_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "soft_delete_enabled", value)

    @property
    @pulumi.getter(name="storageModeType")
    def storage_mode_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_mode_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Vault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            soft_delete_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            storage_mode_type: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Vault':
        """
    ...
    @property
    @pulumi.getter(name="classicVmwareReplicationEnabled")
    def classic_vmware_replication_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable the Classic experience for VMware replication. If set to `false` VMware machines will be protected using the new stateless ASR replication appliance. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "classic_vmware_replication_enabled")
    ...
    @property
    @pulumi.getter(name="crossRegionRestoreEnabled")
    def cross_region_restore_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is cross region restore enabled for this Vault? Only can be `true`, when `storage_mode_type` is `GeoRedundant`. Defaults to `false`.
    ...
    @property
    @pulumi.getter
    def immutability(self) -> pulumi.Output[builtins.str]:
        """
        Immutability Settings of vault, possible values include: `Locked`, `Unlocked` and `Disabled`.
    ...
    @property
    @pulumi.getter(name="softDeleteEnabled")
    def soft_delete_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is soft delete enable for this Vault? Defaults to `true`.
        """
        return pulumi.get(self, "soft_delete_enabled")
    ...
    @property
    @pulumi.getter(name="storageModeType")
    def storage_mode_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The storage type of the Recovery Services Vault. Possible values are `GeoRedundant`, `LocallyRedundant` and `ZoneRedundant`. Defaults to `GeoRedundant`.
        """
        return pulumi.get(self, "storage_mode_type")
