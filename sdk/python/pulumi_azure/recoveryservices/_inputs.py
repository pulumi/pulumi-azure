...
if not MYPY:
    class VaultEncryptionArgsDict(TypedDict):
        infrastructure_encryption_enabled: pulumi.Input[builtins.bool]
        """
...
class VaultEncryptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] infrastructure_encryption_enabled: Enabling/Disabling the Double Encryption state.
        :param pulumi.Input[builtins.str] key_id: The Key Vault key id used to encrypt this vault. Key managed by Vault Managed Hardware Security Module is also supported.
        :param pulumi.Input[builtins.bool] use_system_assigned_identity: Indicate that system assigned identity should be used or not. Defaults to `true`. Must be set to `false` when `user_assigned_identity_id` is set.
               
               !> **Note:** `use_system_assigned_identity` only be able to set to `false` for **new** vaults. Any vaults containing existing items registered or attempted to be registered to it are not supported. Details can be found in [the document](https://learn.microsoft.com/en-us/azure/backup/encryption-at-rest-with-cmk?tabs=portal#before-you-start)
               
               !> **Note:** Once `infrastructure_encryption_enabled` has been set it's not possible to change it.
        :param pulumi.Input[builtins.str] user_assigned_identity_id: Specifies the user assigned identity ID to be used.
        """
    ...
    def infrastructure_encryption_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        Enabling/Disabling the Double Encryption state.
        """
    ...
    def infrastructure_encryption_enabled(self, value: pulumi.Input[builtins.bool]):
...
class VaultIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Recovery Services Vault. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
...
if not MYPY:
    class VaultMonitoringArgsDict(TypedDict):
        alerts_for_all_job_failures_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enabling/Disabling built-in Azure Monitor alerts for security scenarios and job failure scenarios. Defaults to `true`.
        """
        alerts_for_critical_operation_failures_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VaultMonitoringArgs:
    def __init__(__self__, *,
                 alerts_for_all_job_failures_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 alerts_for_critical_operation_failures_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] alerts_for_all_job_failures_enabled: Enabling/Disabling built-in Azure Monitor alerts for security scenarios and job failure scenarios. Defaults to `true`.
        :param pulumi.Input[builtins.bool] alerts_for_critical_operation_failures_enabled: Enabling/Disabling alerts from the older (classic alerts) solution. Defaults to `true`. More details could be found [here](https://learn.microsoft.com/en-us/azure/backup/monitoring-and-alerts-overview).
        """
    ...
    def alerts_for_all_job_failures_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enabling/Disabling built-in Azure Monitor alerts for security scenarios and job failure scenarios. Defaults to `true`.
        """
    ...
    def alerts_for_all_job_failures_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "alerts_for_all_job_failures_enabled", value)

    @property
    @pulumi.getter(name="alertsForCriticalOperationFailuresEnabled")
    def alerts_for_critical_operation_failures_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enabling/Disabling alerts from the older (classic alerts) solution. Defaults to `true`. More details could be found [here](https://learn.microsoft.com/en-us/azure/backup/monitoring-and-alerts-overview).
        """
    ...
    def alerts_for_critical_operation_failures_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
