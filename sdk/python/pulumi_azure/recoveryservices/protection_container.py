...
class ProtectionContainer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, name=None, recovery_fabric_name=None, recovery_vault_name=None, resource_group_name=None, __props__=None, __name__=None, __opts__=None):
        ...
        super(ProtectionContainer, __self__).__init__(
            'azure:recoveryservices/protectionContainer:ProtectionContainer',
            resource_name,
            __props__,
            opts)

    @staticmethod
    def get(resource_name, id, opts=None, name=None, recovery_fabric_name=None, recovery_vault_name=None, resource_group_name=None):
        """
