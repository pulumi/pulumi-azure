...
class VaultResourceGuardAssociationArgs:
    def __init__(__self__, *,
                 resource_guard_id: pulumi.Input[builtins.str],
                 vault_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a VaultResourceGuardAssociation resource.
        :param pulumi.Input[builtins.str] resource_guard_id: ID of the Resource Guard which should be associated with. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vault_id: ID of the Recovery Services Vault which should be associated with. Changing this forces a new resource to be created.
        """
    ...
    def resource_guard_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_guard_id(self, value: pulumi.Input[builtins.str]):
...
class _VaultResourceGuardAssociationState:
    def __init__(__self__, *,
                 resource_guard_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="resourceGuardId")
    def resource_guard_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the Resource Guard which should be associated with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "resource_guard_id")
    ...
    @resource_guard_id.setter
    def resource_guard_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_guard_id", value)
...
class VaultResourceGuardAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            resource_guard_id: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VaultResourceGuardAssociation':
        """
    ...
    @property
    @pulumi.getter(name="resourceGuardId")
    def resource_guard_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the Resource Guard which should be associated with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "resource_guard_id")
