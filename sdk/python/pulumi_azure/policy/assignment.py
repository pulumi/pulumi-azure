...
class Assignment(pulumi.CustomResource):
    ...
    def __init__(__self__, __name__, __opts__=None, description=None, display_name=None, identity=None, location=None, name=None, not_scopes=None, parameters=None, policy_definition_id=None, scope=None):
        """
