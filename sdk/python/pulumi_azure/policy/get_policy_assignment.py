...
class GetPolicyAssignmentResult:
    ...
    def not_scopes(self) -> Sequence[_builtins.str]:
        """
...
def get_policy_assignment(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Authorization` - 2022-06-01
    ...
    :param _builtins.str scope_id: The ID of the scope this Policy Assignment is assigned to. The `scope_id` can be a subscription id, a resource group id, a management group id, or an ID of any resource that is assigned with a policy. Changing this forces a new Policy Assignment to be created.
    """
    __args__ = dict()
    __args__['name'] = name
