...
def get_policy_set_definition(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str management_group_name: Only retrieve Policy Set Definitions from this Management Group.
...
def get_policy_set_definition_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
