...
class GetPolicySetDefinitionResult:
    ...
    def policy_definitions(self) -> _builtins.str:
        """
...
def get_policy_set_definition(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str management_group_name: Only retrieve Policy Set Definitions from this Management Group.
