...
if not MYPY:
    class PolicySetDefinitionPolicyDefinitionGroupArgsDict(TypedDict):
        ...
        """
        additional_metadata_resource_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicySetDefinitionPolicyDefinitionGroupArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 additional_metadata_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 category: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of this policy definition group.
        :param pulumi.Input[builtins.str] additional_metadata_resource_id: The ID of a resource that contains additional metadata about this policy definition group.
        :param pulumi.Input[builtins.str] category: The category of this policy definition group.
        :param pulumi.Input[builtins.str] description: The description of this policy definition group.
        :param pulumi.Input[builtins.str] display_name: The display name of this policy definition group.
        """
    ...
    def additional_metadata_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of a resource that contains additional metadata about this policy definition group.
        """
    ...
    def additional_metadata_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PolicySetDefinitionPolicyDefinitionReferenceArgsDict(TypedDict):
        ...
        """
        policy_group_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PolicySetDefinitionPolicyDefinitionReferenceArgs:
    def __init__(__self__, *,
                 ...
                 policy_group_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 reference_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] policy_definition_id: The ID of the policy definition that will be included in this policy set definition.
        :param pulumi.Input[builtins.str] parameter_values: Parameter values for the referenced policy rule. This field is a JSON string that allows you to assign parameters to this policy rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policy_group_names: A list of names of the policy definition groups that this policy definition reference belongs to.
        :param pulumi.Input[builtins.str] reference_id: A unique ID within this policy set definition for this policy definition reference.
        """
    ...
    def policy_group_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of names of the policy definition groups that this policy definition reference belongs to.
        """
    ...
    def policy_group_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class VirtualMachineConfigurationAssignmentConfigurationArgsDict(TypedDict):
        assignment_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VirtualMachineConfigurationAssignmentConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] assignment_type: The assignment type for the Guest Configuration Assignment. Possible values are `Audit`, `ApplyAndAutoCorrect`, `ApplyAndMonitor` and `DeployAndAutoCorrect`.
        :param pulumi.Input[builtins.str] content_hash: The content hash for the Guest Configuration package.
        :param pulumi.Input[builtins.str] content_uri: The content URI where the Guest Configuration package is stored.
        ...
        :param pulumi.Input[builtins.str] version: The version of the Guest Configuration that will be assigned in this Guest Configuration Assignment.
        """
...
class VirtualMachineConfigurationAssignmentConfigurationParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the configuration parameter to check.
        :param pulumi.Input[builtins.str] value: The value to check the configuration parameter with.
        """
        pulumi.set(__self__, "name", name)
