...
class GetPolicyDefintionResult:
    ...
    def management_group_name(self) -> Optional[builtins.str]:
    ...
    def role_definition_ids(self) -> Sequence[builtins.str]:
        """
...
def get_policy_defintion(display_name: Optional[builtins.str] = None,
...
def get_policy_defintion_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                management_group_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
