...
def get_policy_defintion(display_name: Optional[_builtins.str] = None,
...
def get_policy_defintion_output(display_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
