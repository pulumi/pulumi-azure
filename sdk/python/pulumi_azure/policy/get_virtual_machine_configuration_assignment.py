...
def get_virtual_machine_configuration_assignment(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Compute`: 2020-06-25
    ...
    :param builtins.str virtual_machine_name: Only retrieve Policy Set Definitions from this Management Group.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_virtual_machine_configuration_assignment_output(name: Optional[pulumi.Input[builtins.str]] = None,
