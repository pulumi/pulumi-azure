...
def get_policy_defintion_built_in(display_name: Optional[builtins.str] = None,
...
def get_policy_defintion_built_in_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
