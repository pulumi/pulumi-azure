...
class AnalyticsSolutionPlan(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str product: The product name of the solution. For example `OMSGallery/Containers`. Changing this forces a new resource to be created.
        :param builtins.str publisher: The publisher of the solution. For example `Microsoft`. Changing this forces a new resource to be created.
        :param builtins.str promotion_code: A promotion code to be used with the solution. Changing this forces a new resource to be created.
        """
...
class AnalyticsWorkspaceIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the identity type of the Log Analytics Workspace. Possible values are `SystemAssigned` (where Azure will generate a Service Principal for you) and `UserAssigned` where you can specify the Service Principal IDs in the `identity_ids` field.
