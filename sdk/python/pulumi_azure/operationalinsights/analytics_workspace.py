...
class AnalyticsWorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 allow_resource_only_permissions: Optional[pulumi.Input[builtins.bool]] = None,
                 cmk_for_query_forced: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 immediate_data_purge_on30_days_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 reservation_capacity_in_gb_per_day: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Log Analytics workspace is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] allow_resource_only_permissions: Specifies if the log Analytics Workspace allow users accessing to data associated with resources they have permission to view, without permission to workspace. Defaults to `true`.
        :param pulumi.Input[builtins.bool] cmk_for_query_forced: Is Customer Managed Storage mandatory for query management?
        :param pulumi.Input[builtins.float] daily_quota_gb: The workspace daily quota for ingestion in GB. Defaults to `-1` (unlimited) if omitted.
        :param pulumi.Input[builtins.str] data_collection_rule_id: The ID of the Data Collection Rule to use for this workspace.
        :param pulumi.Input['AnalyticsWorkspaceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.bool] immediate_data_purge_on30_days_enabled: Whether to remove the data in the Log Analytics Workspace immediately after 30 days.
        :param pulumi.Input[builtins.bool] internet_ingestion_enabled: Should the Log Analytics Workspace support ingestion over the Public Internet? Defaults to `true`.
        :param pulumi.Input[builtins.bool] internet_query_enabled: Should the Log Analytics Workspace support querying over the Public Internet? Defaults to `true`.
        :param pulumi.Input[builtins.bool] local_authentication_disabled: Specifies if the log Analytics workspace should enforce authentication using Azure AD. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Log Analytics Workspace. Workspace name should include 4-63 letters, digits or '-'. The '-' shouldn't be the first or the last symbol. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] reservation_capacity_in_gb_per_day: The capacity reservation level in GB for this workspace. Possible values are `100`, `200`, `300`, `400`, `500`, `1000`, `2000` and `5000`.
               
               > **Note:** `reservation_capacity_in_gb_per_day` can only be used when the `sku` is set to `CapacityReservation`.
        :param pulumi.Input[builtins.int] retention_in_days: The workspace data retention in days. Possible values are between `30` and `730`.
        :param pulumi.Input[builtins.str] sku: Specifies the SKU of the Log Analytics Workspace. Possible values are `PerNode`, `Premium`, `Standard`, `Standalone`, `Unlimited`, `CapacityReservation`, `PerGB2018`, and `LACluster`. Defaults to `PerGB2018`.
    ...
    def allow_resource_only_permissions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_resource_only_permissions(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_resource_only_permissions", value)

    @property
    @pulumi.getter(name="cmkForQueryForced")
    def cmk_for_query_forced(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cmk_for_query_forced(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def immediate_data_purge_on30_days_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def immediate_data_purge_on30_days_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def reservation_capacity_in_gb_per_day(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def reservation_capacity_in_gb_per_day(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _AnalyticsWorkspaceState:
    def __init__(__self__, *,
                 ...
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 primary_shared_key: Optional[pulumi.Input[builtins.str]] = None,
                 reservation_capacity_in_gb_per_day: Optional[pulumi.Input[builtins.int]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 retention_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 secondary_shared_key: Optional[pulumi.Input[builtins.str]] = None,
                 sku: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Log Analytics Workspace. Workspace name should include 4-63 letters, digits or '-'. The '-' shouldn't be the first or the last symbol. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] primary_shared_key: The Primary shared key for the Log Analytics Workspace.
        :param pulumi.Input[builtins.int] reservation_capacity_in_gb_per_day: The capacity reservation level in GB for this workspace. Possible values are `100`, `200`, `300`, `400`, `500`, `1000`, `2000` and `5000`.
               
               > **Note:** `reservation_capacity_in_gb_per_day` can only be used when the `sku` is set to `CapacityReservation`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Log Analytics workspace is created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] retention_in_days: The workspace data retention in days. Possible values are between `30` and `730`.
        :param pulumi.Input[builtins.str] secondary_shared_key: The Secondary shared key for the Log Analytics Workspace.
        :param pulumi.Input[builtins.str] sku: Specifies the SKU of the Log Analytics Workspace. Possible values are `PerNode`, `Premium`, `Standard`, `Standalone`, `Unlimited`, `CapacityReservation`, `PerGB2018`, and `LACluster`. Defaults to `PerGB2018`.
               ...
               > **Note:** A new pricing model took effect on `2018-04-03`, which requires the SKU `PerGB2018`. If you've provisioned resources before this date you have the option of remaining with the previous Pricing SKU and using the other SKUs defined above. More information about [the Pricing SKUs is available at the following URI](https://aka.ms/PricingTierWarning).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] workspace_id: The Workspace (or Customer) ID for the Log Analytics Workspace.
        """
        if allow_resource_only_permissions is not None:
            pulumi.set(__self__, "allow_resource_only_permissions", allow_resource_only_permissions)
        if cmk_for_query_forced is not None:
    ...
    def primary_shared_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_shared_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secondary_shared_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secondary_shared_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AnalyticsWorkspace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sku: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AnalyticsWorkspace':
        """
    ...
    @property
    @pulumi.getter(name="allowResourceOnlyPermissions")
    def allow_resource_only_permissions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies if the log Analytics Workspace allow users accessing to data associated with resources they have permission to view, without permission to workspace. Defaults to `true`.
        """
        return pulumi.get(self, "allow_resource_only_permissions")
    ...
    @property
    @pulumi.getter(name="cmkForQueryForced")
    def cmk_for_query_forced(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is Customer Managed Storage mandatory for query management?
        """
        return pulumi.get(self, "cmk_for_query_forced")
    ...
    @property
    @pulumi.getter(name="dailyQuotaGb")
    def daily_quota_gb(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The workspace daily quota for ingestion in GB. Defaults to `-1` (unlimited) if omitted.
        """
        return pulumi.get(self, "daily_quota_gb")
    ...
    @property
    @pulumi.getter(name="immediateDataPurgeOn30DaysEnabled")
    def immediate_data_purge_on30_days_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to remove the data in the Log Analytics Workspace immediately after 30 days.
        """
        return pulumi.get(self, "immediate_data_purge_on30_days_enabled")
    ...
    @property
    @pulumi.getter(name="primarySharedKey")
    def primary_shared_key(self) -> pulumi.Output[builtins.str]:
        """
        The Primary shared key for the Log Analytics Workspace.
        """
        return pulumi.get(self, "primary_shared_key")
    ...
    @property
    @pulumi.getter(name="reservationCapacityInGbPerDay")
    def reservation_capacity_in_gb_per_day(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The capacity reservation level in GB for this workspace. Possible values are `100`, `200`, `300`, `400`, `500`, `1000`, `2000` and `5000`.
    ...
    @property
    @pulumi.getter(name="secondarySharedKey")
    def secondary_shared_key(self) -> pulumi.Output[builtins.str]:
        """
        The Secondary shared key for the Log Analytics Workspace.
        """
        return pulumi.get(self, "secondary_shared_key")
