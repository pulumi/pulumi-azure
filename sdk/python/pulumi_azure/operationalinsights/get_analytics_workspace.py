...
class GetAnalyticsWorkspaceResult:
    ...
    def daily_quota_gb(self) -> builtins.float:
        """
...
def get_analytics_workspace(name: Optional[builtins.str] = None,
...
def get_analytics_workspace_output(name: Optional[pulumi.Input[builtins.str]] = None,
