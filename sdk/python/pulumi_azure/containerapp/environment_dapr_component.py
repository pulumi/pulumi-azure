...
class EnvironmentDaprComponentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] component_type: The Dapr Component Type. For example `state.azure.blobstorage`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] container_app_environment_id: The ID of the Container App Managed Environment for this Dapr Component. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] version: The version of the component.
        :param pulumi.Input[builtins.bool] ignore_errors: Should the Dapr sidecar to continue initialisation if the component fails to load. Defaults to `false`
        :param pulumi.Input[builtins.str] init_timeout: The timeout for component initialisation as a `ISO8601` formatted string. e.g. `5s`, `2h`, `1m`. Defaults to `5s`.
...
class EnvironmentDaprComponent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scopes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            secrets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentDaprComponentSecretArgs', 'EnvironmentDaprComponentSecretArgsDict']]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'EnvironmentDaprComponent':
        """
