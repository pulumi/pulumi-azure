...
class AppDaprArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] app_id: The Dapr Application Identifier.
        :param pulumi.Input[builtins.int] app_port: The port which the application is listening on. This is the same as the `ingress` port.
        :param pulumi.Input[builtins.str] app_protocol: The protocol for the app. Possible values include `http` and `grpc`. Defaults to `http`.
        """
...
class AppIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of managed identity to assign. Possible values are `SystemAssigned`, `UserAssigned`, and `SystemAssigned, UserAssigned` (to enable both).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of one or more Resource IDs for User Assigned Managed identities to assign. Required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
        """
...
if not MYPY:
    class AppIngressArgsDict(TypedDict):
        ...
        """
        allow_insecure_connections: NotRequired[pulumi.Input[builtins.bool]]
        """
        Should this ingress allow insecure connections?
        """
        client_certificate_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppIngressArgs:
    def __init__(__self__, *,
                 ...
                 allow_insecure_connections: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] target_port: The target port on the container for the Ingress traffic.
        ...
        :param pulumi.Input[builtins.bool] allow_insecure_connections: Should this ingress allow insecure connections?
        :param pulumi.Input[builtins.str] client_certificate_mode: The client certificate mode for the Ingress. Possible values are `require`, `accept`, and `ignore`.
        ...
        :param pulumi.Input[builtins.int] exposed_port: The exposed port on the container for the Ingress traffic.
               
               > **Note:** `exposed_port` can only be specified when `transport` is set to `tcp`.
        :param pulumi.Input[builtins.bool] external_enabled: Are connections to this Ingress from outside the Container App Environment enabled? Defaults to `false`.
        :param pulumi.Input[builtins.str] fqdn: The FQDN of the ingress.
        ...
        :param pulumi.Input[builtins.str] transport: The transport method for the Ingress. Possible values are `auto`, `http`, `http2` and `tcp`. Defaults to `auto`.
    ...
    def allow_insecure_connections(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should this ingress allow insecure connections?
        """
    ...
    def allow_insecure_connections(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class AppIngressCustomDomainArgsDict(TypedDict):
        certificate_binding_type: NotRequired[pulumi.Input[builtins.str]]
        """
        The Binding type.
        """
...
class AppIngressCustomDomainArgs:
    def __init__(__self__, *,
                 certificate_binding_type: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] certificate_binding_type: The Binding type.
        :param pulumi.Input[builtins.str] certificate_id: The ID of the Container App Environment Certificate.
    ...
    def certificate_binding_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Binding type.
        """
    ...
    def certificate_binding_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AppIngressIpSecurityRestrictionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The IP-filter action. `Allow` or `Deny`.
               
               > **Note:** The `action` types in an all `ip_security_restriction` blocks must be the same for the `ingress`, mixing `Allow` and `Deny` rules is not currently supported by the service.
        :param pulumi.Input[builtins.str] ip_address_range: The incoming IP address or range of IP addresses (in CIDR notation).
        :param pulumi.Input[builtins.str] name: Name for the IP restriction rule.
        :param pulumi.Input[builtins.str] description: Describe the IP restriction rule that is being sent to the container-app.
        """
...
class AppIngressTrafficWeightArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] percentage: The percentage of traffic which should be sent this revision.
               
               > **Note:** The cumulative values for `weight` must equal 100 exactly and explicitly, no default weights are assumed.
        :param pulumi.Input[builtins.str] label: The label to apply to the revision as a name prefix for routing traffic.
        :param pulumi.Input[builtins.bool] latest_revision: This traffic Weight applies to the latest stable Container Revision. At most only one `traffic_weight` block can have the `latest_revision` set to `true`.
        :param pulumi.Input[builtins.str] revision_suffix: The suffix string to which this `traffic_weight` applies.
...
if not MYPY:
    class AppRegistryArgsDict(TypedDict):
        ...
        """
        password_secret_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppRegistryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] server: The hostname for the Container Registry.
               
               The authentication details must also be supplied, `identity` and `username`/`password_secret_name` are mutually exclusive.
        :param pulumi.Input[builtins.str] identity: Resource ID for the User Assigned Managed identity to use when pulling from the Container Registry.
               
               > **Note:** The Resource ID must be of a User Assigned Managed identity defined in an `identity` block.
        :param pulumi.Input[builtins.str] password_secret_name: The name of the Secret Reference containing the password value for this user on the Container Registry, `username` must also be supplied.
        :param pulumi.Input[builtins.str] username: The username to use for this Container Registry, `password_secret_name` must also be supplied..
        """
...
if not MYPY:
    class AppSecretArgsDict(TypedDict):
        ...
        """
        key_vault_secret_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppSecretArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 identity: Optional[pulumi.Input[builtins.str]] = None,
                 key_vault_secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The secret name.
        :param pulumi.Input[builtins.str] identity: The identity to use for accessing the Key Vault secret reference. This can either be the Resource ID of a User Assigned Identity, or `System` for the System Assigned Identity.
               
               !> **Note:** `identity` must be used together with `key_vault_secret_id`
        :param pulumi.Input[builtins.str] key_vault_secret_id: The ID of a Key Vault secret. This can be a versioned or version-less ID.
               
               !> **Note:** When using `key_vault_secret_id`, `ignore_changes` should be used to ignore any changes to `value`.
        :param pulumi.Input[builtins.str] value: The value for this secret.
    ...
    def key_vault_secret_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of a Key Vault secret. This can be a versioned or version-less ID.
    ...
    def key_vault_secret_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AppTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] max_replicas: The maximum number of replicas for this container.
        :param pulumi.Input[builtins.int] min_replicas: The minimum number of replicas for this container.
        :param pulumi.Input[builtins.str] revision_suffix: The suffix for the revision. This value must be unique for the lifetime of the Resource. If omitted the service will use a hash function to create one.
        ...
        :param pulumi.Input[builtins.int] termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
...
if not MYPY:
    class AppTemplateAzureQueueScaleRuleArgsDict(TypedDict):
        ...
        """
        queue_length: pulumi.Input[builtins.int]
        """
...
class AppTemplateAzureQueueScaleRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Scaling Rule
        :param pulumi.Input[builtins.int] queue_length: The value of the length of the queue to trigger scaling actions.
        :param pulumi.Input[builtins.str] queue_name: The name of the Azure Queue
        """
    ...
    def queue_length(self) -> pulumi.Input[builtins.int]:
        """
        The value of the length of the queue to trigger scaling actions.
        """
    ...
    @queue_length.setter
    def queue_length(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class AppTemplateAzureQueueScaleRuleAuthenticationArgsDict(TypedDict):
        ...
        """
        trigger_parameter: pulumi.Input[builtins.str]
        """
...
class AppTemplateAzureQueueScaleRuleAuthenticationArgs:
    def __init__(__self__, *,
                 ...
                 trigger_parameter: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] secret_name: The name of the Container App Secret to use for this Scale Rule Authentication.
        :param pulumi.Input[builtins.str] trigger_parameter: The Trigger Parameter name to use the supply the value retrieved from the `secret_name`.
        """
    ...
    def trigger_parameter(self) -> pulumi.Input[builtins.str]:
        """
        The Trigger Parameter name to use the supply the value retrieved from the `secret_name`.
        """
    ...
    def trigger_parameter(self, value: pulumi.Input[builtins.str]):
...
class AppTemplateContainerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] cpu: The amount of vCPU to allocate to the container. Possible values include `0.25`, `0.5`, `0.75`, `1.0`, `1.25`, `1.5`, `1.75`, and `2.0`. When there's a workload profile specified, there's no such constraint.
               
               > **Note:** `cpu` and `memory` must be specified in `0.25'/'0.5Gi` combination increments. e.g. `1.0` / `2.0` or `0.5` / `1.0`
        :param pulumi.Input[builtins.str] image: The image to use to create the container.
        :param pulumi.Input[builtins.str] memory: The amount of memory to allocate to the container. Possible values are `0.5Gi`, `1Gi`, `1.5Gi`, `2Gi`, `2.5Gi`, `3Gi`, `3.5Gi` and `4Gi`. When there's a workload profile specified, there's no such constraint.
               
               > **Note:** `cpu` and `memory` must be specified in `0.25'/'0.5Gi` combination increments. e.g. `1.25` / `2.5Gi` or `0.75` / `1.5Gi`
        :param pulumi.Input[builtins.str] name: The name of the container
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: A list of extra arguments to pass to the container.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commands: A command to pass to the container to override the default. This is provided as a list of command line elements without spaces.
        :param pulumi.Input[Sequence[pulumi.Input['AppTemplateContainerEnvArgs']]] envs: One or more `env` blocks as detailed below.
        :param pulumi.Input[builtins.str] ephemeral_storage: The amount of ephemeral storage available to the Container App.
...
class AppTemplateContainerEnvArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the environment variable for the container.
        :param pulumi.Input[builtins.str] secret_name: The name of the secret that contains the value for this environment variable.
        :param pulumi.Input[builtins.str] value: The value for this environment variable.
...
if not MYPY:
    class AppTemplateContainerLivenessProbeArgsDict(TypedDict):
        ...
        """
        transport: pulumi.Input[builtins.str]
        """
        Type of probe. Possible values are `TCP`, `HTTP`, and `HTTPS`.
        """
        failure_count_threshold: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        initial_delay: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AppTemplateContainerLivenessProbeArgs:
    def __init__(__self__, *,
                 port: pulumi.Input[builtins.int],
                 transport: pulumi.Input[builtins.str],
                 failure_count_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 headers: Optional[pulumi.Input[Sequence[pulumi.Input['AppTemplateContainerLivenessProbeHeaderArgs']]]] = None,
                 host: Optional[pulumi.Input[builtins.str]] = None,
                 initial_delay: Optional[pulumi.Input[builtins.int]] = None,
                 interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 termination_grace_period_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] port: The port number on which to connect. Possible values are between `1` and `65535`.
        :param pulumi.Input[builtins.str] transport: Type of probe. Possible values are `TCP`, `HTTP`, and `HTTPS`.
        :param pulumi.Input[builtins.int] failure_count_threshold: The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `10`. Defaults to `3`.
        ...
        :param pulumi.Input[builtins.str] host: The probe hostname. Defaults to the pod IP address. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param pulumi.Input[builtins.int] initial_delay: The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `1` seconds.
        :param pulumi.Input[builtins.int] interval_seconds: How often, in seconds, the probe should run. Possible values are in the range `1` - `240`. Defaults to `10`.
        :param pulumi.Input[builtins.str] path: The URI to use with the `host` for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param pulumi.Input[builtins.int] termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
        :param pulumi.Input[builtins.int] timeout: Time in seconds after which the probe times out. Possible values are in the range `1` - `240`. Defaults to `1`.
        """
    ...
    @property
    @pulumi.getter
    def transport(self) -> pulumi.Input[builtins.str]:
        """
        Type of probe. Possible values are `TCP`, `HTTP`, and `HTTPS`.
        """
        return pulumi.get(self, "transport")
    ...
    @transport.setter
    def transport(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "transport", value)

    @property
    @pulumi.getter(name="failureCountThreshold")
    def failure_count_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `10`. Defaults to `3`.
        """
    ...
    def failure_count_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def initial_delay(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `1` seconds.
        """
    ...
    def initial_delay(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AppTemplateContainerLivenessProbeHeaderArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The HTTP Header Name.
        :param pulumi.Input[builtins.str] value: The HTTP Header value.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class AppTemplateContainerReadinessProbeArgsDict(TypedDict):
        ...
        """
        success_count_threshold: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AppTemplateContainerReadinessProbeArgs:
    def __init__(__self__, *,
                 ...
                 interval_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 success_count_threshold: Optional[pulumi.Input[builtins.int]] = None,
                 timeout: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] port: The port number on which to connect. Possible values are between `1` and `65535`.
        :param pulumi.Input[builtins.str] transport: Type of probe. Possible values are `TCP`, `HTTP`, and `HTTPS`.
        :param pulumi.Input[builtins.int] failure_count_threshold: The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `30`. Defaults to `3`.
        ...
        :param pulumi.Input[builtins.str] host: The probe hostname. Defaults to the pod IP address. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param pulumi.Input[builtins.int] initial_delay: The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `0` seconds.
        :param pulumi.Input[builtins.int] interval_seconds: How often, in seconds, the probe should run. Possible values are between `1` and `240`. Defaults to `10`
        :param pulumi.Input[builtins.str] path: The URI to use for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param pulumi.Input[builtins.int] success_count_threshold: The number of consecutive successful responses required to consider this probe as successful. Possible values are between `1` and `10`. Defaults to `3`.
        :param pulumi.Input[builtins.int] timeout: Time in seconds after which the probe times out. Possible values are in the range `1` - `240`. Defaults to `1`.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "transport", transport)
    ...
    def success_count_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of consecutive successful responses required to consider this probe as successful. Possible values are between `1` and `10`. Defaults to `3`.
        """
    ...
    def success_count_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AppTemplateContainerStartupProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] host: The value for the host header which should be sent with this probe. If unspecified, the IP Address of the Pod is used as the host header. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param pulumi.Input[builtins.int] initial_delay: The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `0` seconds.
        :param pulumi.Input[builtins.int] interval_seconds: How often, in seconds, the probe should run. Possible values are between `1` and `240`. Defaults to `10`
        :param pulumi.Input[builtins.str] path: The URI to use with the `host` for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param pulumi.Input[builtins.int] termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
...
class AppTemplateContainerVolumeMountArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the Volume to be mounted in the container.
        :param pulumi.Input[builtins.str] path: The path in the container at which to mount this volume.
        :param pulumi.Input[builtins.str] sub_path: The sub path of the volume to be mounted in the container.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "path", path)
...
if not MYPY:
    class AppTemplateCustomScaleRuleArgsDict(TypedDict):
        custom_rule_type: pulumi.Input[builtins.str]
        """
        ...
        """
        metadata: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
...
class AppTemplateCustomScaleRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] custom_rule_type: The Custom rule type. Possible values include: `activemq`, `artemis-queue`, `kafka`, `pulsar`, `aws-cloudwatch`, `aws-dynamodb`, `aws-dynamodb-streams`, `aws-kinesis-stream`, `aws-sqs-queue`, `azure-app-insights`, `azure-blob`, `azure-data-explorer`, `azure-eventhub`, `azure-log-analytics`, `azure-monitor`, `azure-pipelines`, `azure-servicebus`, `azure-queue`, `cassandra`, `cpu`, `cron`, `datadog`, `elasticsearch`, `external`, `external-push`, `gcp-stackdriver`, `gcp-storage`, `gcp-pubsub`, `graphite`, `http`, `huawei-cloudeye`, `ibmmq`, `influxdb`, `kubernetes-workload`, `liiklus`, `memory`, `metrics-api`, `mongodb`, `mssql`, `mysql`, `nats-jetstream`, `stan`, `tcp`, `new-relic`, `openstack-metric`, `openstack-swift`, `postgresql`, `predictkube`, `prometheus`, `rabbitmq`, `redis`, `redis-cluster`, `redis-sentinel`, `redis-streams`, `redis-cluster-streams`, `redis-sentinel-streams`, `selenium-grid`,`solace-event-queue`, and `github-runner`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: A map of string key-value pairs to configure the Custom Scale Rule.
        :param pulumi.Input[builtins.str] name: The name of the Scaling Rule
    ...
    def custom_rule_type(self) -> pulumi.Input[builtins.str]:
        """
        The Custom rule type. Possible values include: `activemq`, `artemis-queue`, `kafka`, `pulsar`, `aws-cloudwatch`, `aws-dynamodb`, `aws-dynamodb-streams`, `aws-kinesis-stream`, `aws-sqs-queue`, `azure-app-insights`, `azure-blob`, `azure-data-explorer`, `azure-eventhub`, `azure-log-analytics`, `azure-monitor`, `azure-pipelines`, `azure-servicebus`, `azure-queue`, `cassandra`, `cpu`, `cron`, `datadog`, `elasticsearch`, `external`, `external-push`, `gcp-stackdriver`, `gcp-storage`, `gcp-pubsub`, `graphite`, `http`, `huawei-cloudeye`, `ibmmq`, `influxdb`, `kubernetes-workload`, `liiklus`, `memory`, `metrics-api`, `mongodb`, `mssql`, `mysql`, `nats-jetstream`, `stan`, `tcp`, `new-relic`, `openstack-metric`, `openstack-swift`, `postgresql`, `predictkube`, `prometheus`, `rabbitmq`, `redis`, `redis-cluster`, `redis-sentinel`, `redis-streams`, `redis-cluster-streams`, `redis-sentinel-streams`, `selenium-grid`,`solace-event-queue`, and `github-runner`.
        """
    ...
    def custom_rule_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "custom_rule_type", value)

    @property
    @pulumi.getter
    def metadata(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        A map of string key-value pairs to configure the Custom Scale Rule.
        """
    ...
    @metadata.setter
    def metadata(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class AppTemplateHttpScaleRuleArgsDict(TypedDict):
        concurrent_requests: pulumi.Input[builtins.str]
        """
...
class AppTemplateHttpScaleRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] concurrent_requests: The number of concurrent requests to trigger scaling.
        :param pulumi.Input[builtins.str] name: The name of the Scaling Rule
    ...
    def concurrent_requests(self) -> pulumi.Input[builtins.str]:
        """
        The number of concurrent requests to trigger scaling.
        """
    ...
    def concurrent_requests(self, value: pulumi.Input[builtins.str]):
...
class AppTemplateVolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] mount_options: Mount options used while mounting the AzureFile. Must be a comma-separated string e.g. `dir_mode=0751,file_mode=0751`.
        :param pulumi.Input[builtins.str] storage_name: The name of the `AzureFile` storage.
        :param pulumi.Input[builtins.str] storage_type: The type of storage volume. Possible values are `AzureFile`, `EmptyDir` and `Secret`. Defaults to `EmptyDir`.
        """
        pulumi.set(__self__, "name", name)
...
class EnvironmentDaprComponentMetadataArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the Metadata configuration item.
        :param pulumi.Input[builtins.str] secret_name: The name of a secret specified in the `secrets` block that contains the value for this metadata configuration item.
        :param pulumi.Input[builtins.str] value: The value for this metadata configuration item.
        """
        pulumi.set(__self__, "name", name)
        if secret_name is not None:
            pulumi.set(__self__, "secret_name", secret_name)
...
class EnvironmentDaprComponentSecretArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The Secret name.
        :param pulumi.Input[builtins.str] identity: The identity to use for accessing key vault reference.
        :param pulumi.Input[builtins.str] key_vault_secret_id: The Key Vault Secret ID. Could be either one of `id` or `versionless_id`.
        :param pulumi.Input[builtins.str] value: The value for this secret.
        """
        pulumi.set(__self__, "name", name)
        if identity is not None:
...
class EnvironmentWorkloadProfileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the workload profile.
        :param pulumi.Input[builtins.str] workload_profile_type: Workload profile type for the workloads to run on. Possible values include `Consumption`, `D4`, `D8`, `D16`, `D32`, `E4`, `E8`, `E16` and `E32`.
               
               > **Note:** A `Consumption` type must have a name of `Consumption` and an environment may only have one `Consumption` Workload Profile.
               
               > **Note:** Defining a `Consumption` profile is optional, however, Environments created without an initial Workload Profile cannot have them added at a later time and must be recreated. Similarly, an environment created with Profiles must always have at least one defined Profile, removing all profiles will force a recreation of the resource.
        :param pulumi.Input[builtins.int] maximum_count: The maximum number of instances of workload profile that can be deployed in the Container App Environment.
        :param pulumi.Input[builtins.int] minimum_count: The minimum number of instances of workload profile that can be deployed in the Container App Environment.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class JobEventTriggerConfigScaleArgsDict(TypedDict):
        ...
        """
        polling_interval_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class JobEventTriggerConfigScaleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max_executions: Maximum number of job executions that are created for a trigger.
        :param pulumi.Input[builtins.int] min_executions: Minimum number of job executions that are created for a trigger.
        :param pulumi.Input[builtins.int] polling_interval_in_seconds: Interval to check each event source in seconds.
...
class JobEventTriggerConfigScaleRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] custom_rule_type: Type of the scale rule.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Metadata properties to describe the scale rule.
        :param pulumi.Input[builtins.str] name: Name of the scale rule.
...
class JobEventTriggerConfigScaleRuleAuthenticationArgs:
    def __init__(__self__, *,
                 ...
                 trigger_parameter: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] secret_name: Name of the secret from which to pull the auth params.
...
class JobIdentityArgs:
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of identity used for the Container App Job. Possible values are `SystemAssigned`, `UserAssigned` and `None`. Defaults to `None`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: A list of Managed Identity IDs to assign to the Container App Job.
...
class JobRegistryArgs:
    def __init__(__self__, *,
                 ...
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] server: The URL of the Azure Container Registry server.
        :param pulumi.Input[builtins.str] identity: A Managed Identity to use to authenticate with Azure Container Registry.
        :param pulumi.Input[builtins.str] password_secret_name: The name of the Secret that contains the registry login password.
        :param pulumi.Input[builtins.str] username: The username to use to authenticate with Azure Container Registry.
        """
        pulumi.set(__self__, "server", server)
        if identity is not None:
            pulumi.set(__self__, "identity", identity)
...
class JobTemplateContainerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] cpu: The amount of vCPU to allocate to the container. Possible values include `0.25`, `0.5`, `0.75`, `1.0`, `1.25`, `1.5`, `1.75`, and `2.0`.
               
               > **Note:** `cpu` and `memory` must be specified in `0.25'/'0.5Gi` combination increments. e.g. `1.0` / `2.0` or `0.5` / `1.0`
        :param pulumi.Input[builtins.str] image: The image to use to create the container.
        :param pulumi.Input[builtins.str] memory: The amount of memory to allocate to the container. Possible values are `0.5Gi`, `1Gi`, `1.5Gi`, `2Gi`, `2.5Gi`, `3Gi`, `3.5Gi` and `4Gi`.
...
class JobTemplateContainerEnvArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret_name: Name of the Container App secret from which to pull the environment variable value.
...
class JobTemplateContainerLivenessProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] host: The probe hostname. Defaults to the pod IP address. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param pulumi.Input[builtins.int] initial_delay: The time in seconds to wait after the container has started before the probe is started.
        :param pulumi.Input[builtins.int] interval_seconds: How often, in seconds, the probe should run. Possible values are in the range `1` - `240`. Defaults to `10`.
        :param pulumi.Input[builtins.str] path: The URI to use with the `host` for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param pulumi.Input[builtins.int] termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
        :param pulumi.Input[builtins.int] timeout: Time in seconds after which the probe times out. Possible values are in the range `1` - `240`. Defaults to `1`.
...
class JobTemplateContainerVolumeMountArgs:
    def __init__(__self__, *,
                 ...
                 sub_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the volume to mount. This must match the name of a volume defined in the `volume` block.
        :param pulumi.Input[builtins.str] path: The path within the container at which the volume should be mounted. Must not contain `:`.
        :param pulumi.Input[builtins.str] sub_path: The sub path of the volume to be mounted in the container.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "path", path)
...
class JobTemplateVolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the volume.
        :param pulumi.Input[builtins.str] mount_options: Mount options used while mounting the AzureFile. Must be a comma-separated string e.g. `dir_mode=0751,file_mode=0751`.
        :param pulumi.Input[builtins.str] storage_name: The name of the storage to use for the volume.
        :param pulumi.Input[builtins.str] storage_type: The type of storage to use for the volume. Possible values are `AzureFile`, `EmptyDir` and `Secret`.
        """
        pulumi.set(__self__, "name", name)
        if mount_options is not None:
            pulumi.set(__self__, "mount_options", mount_options)
