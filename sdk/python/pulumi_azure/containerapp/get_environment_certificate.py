...
def get_environment_certificate(container_app_environment_id: Optional[builtins.str] = None,
...
def get_environment_certificate_output(container_app_environment_id: Optional[pulumi.Input[builtins.str]] = None,
