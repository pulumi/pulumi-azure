...
class EnvironmentCustomDomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_blob_base64: The bundle of Private Key and Certificate for the Custom DNS Suffix as a base64 encoded PFX or PEM.
        :param pulumi.Input[builtins.str] certificate_password: The password for the Certificate bundle.
        :param pulumi.Input[builtins.str] container_app_environment_id: The ID of the Container Apps Managed Environment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] dns_suffix: Custom DNS Suffix for the Container App Environment.
        """
...
class EnvironmentCustomDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            certificate_password: Optional[pulumi.Input[builtins.str]] = None,
            container_app_environment_id: Optional[pulumi.Input[builtins.str]] = None,
            dns_suffix: Optional[pulumi.Input[builtins.str]] = None) -> 'EnvironmentCustomDomain':
        """
