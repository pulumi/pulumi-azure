...
class AppDapr(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str app_id: The Dapr Application Identifier.
        :param builtins.int app_port: The port which the application is listening on. This is the same as the `ingress` port.
        :param builtins.str app_protocol: The protocol for the app. Possible values include `http` and `grpc`. Defaults to `http`.
        """
...
class AppIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of managed identity to assign. Possible values are `SystemAssigned`, `UserAssigned`, and `SystemAssigned, UserAssigned` (to enable both).
...
class AppIngress(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allow_insecure_connections: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.int target_port: The target port on the container for the Ingress traffic.
        :param Sequence['AppIngressTrafficWeightArgs'] traffic_weights: One or more `traffic_weight` blocks as detailed below.
        :param builtins.bool allow_insecure_connections: Should this ingress allow insecure connections?
        :param builtins.str client_certificate_mode: The client certificate mode for the Ingress. Possible values are `require`, `accept`, and `ignore`.
        :param Sequence['AppIngressCustomDomainArgs'] custom_domains: One or more `custom_domain` block as detailed below.
        :param builtins.int exposed_port: The exposed port on the container for the Ingress traffic.
               
               > **Note:** `exposed_port` can only be specified when `transport` is set to `tcp`.
        :param builtins.bool external_enabled: Are connections to this Ingress from outside the Container App Environment enabled? Defaults to `false`.
        :param builtins.str fqdn: The FQDN of the ingress.
    ...
    def allow_insecure_connections(self) -> Optional[builtins.bool]:
        """
...
class AppIngressCustomDomain(dict):
    ...
    def __init__(__self__, *,
                 certificate_binding_type: Optional[builtins.str] = None,
                 certificate_id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str certificate_binding_type: The Binding type.
        :param builtins.str certificate_id: The ID of the Container App Environment Certificate.
        :param builtins.str name: The name for this Container App. Changing this forces a new resource to be created.
        """
    ...
    def certificate_binding_type(self) -> Optional[builtins.str]:
        """
        The Binding type.
        """
...
class AppIngressTrafficWeight(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int percentage: The percentage of traffic which should be sent this revision.
               
               > **Note:** The cumulative values for `weight` must equal 100 exactly and explicitly, no default weights are assumed.
        :param builtins.str label: The label to apply to the revision as a name prefix for routing traffic.
        :param builtins.bool latest_revision: This traffic Weight applies to the latest stable Container Revision. At most only one `traffic_weight` block can have the `latest_revision` set to `true`.
        :param builtins.str revision_suffix: The suffix string to which this `traffic_weight` applies.
...
class AppRegistry(dict):
    ...
    def __init__(__self__, *,
                 ...
                 password_secret_name: Optional[builtins.str] = None,
                 username: Optional[builtins.str] = None):
        """
        :param builtins.str server: The hostname for the Container Registry.
               
               The authentication details must also be supplied, `identity` and `username`/`password_secret_name` are mutually exclusive.
        :param builtins.str identity: Resource ID for the User Assigned Managed identity to use when pulling from the Container Registry.
               
               > **Note:** The Resource ID must be of a User Assigned Managed identity defined in an `identity` block.
        :param builtins.str password_secret_name: The name of the Secret Reference containing the password value for this user on the Container Registry, `username` must also be supplied.
        :param builtins.str username: The username to use for this Container Registry, `password_secret_name` must also be supplied..
        """
    ...
    def password_secret_name(self) -> Optional[builtins.str]:
        """
...
class AppSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str identity: The identity to use for accessing the Key Vault secret reference. This can either be the Resource ID of a User Assigned Identity, or `System` for the System Assigned Identity.
               
               !> **Note:** `identity` must be used together with `key_vault_secret_id`
        :param builtins.str key_vault_secret_id: The ID of a Key Vault secret. This can be a versioned or version-less ID.
               
               !> **Note:** When using `key_vault_secret_id`, `ignore_changes` should be used to ignore any changes to `value`.
        :param builtins.str value: The value for this secret.
...
class AppTemplate(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int max_replicas: The maximum number of replicas for this container.
        :param builtins.int min_replicas: The minimum number of replicas for this container.
        :param builtins.str revision_suffix: The suffix for the revision. This value must be unique for the lifetime of the Resource. If omitted the service will use a hash function to create one.
        :param Sequence['AppTemplateTcpScaleRuleArgs'] tcp_scale_rules: One or more `tcp_scale_rule` blocks as defined below.
        :param builtins.int termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
...
class AppTemplateAzureQueueScaleRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the Scaling Rule
        :param builtins.int queue_length: The value of the length of the queue to trigger scaling actions.
        :param builtins.str queue_name: The name of the Azure Queue
        """
    ...
    def queue_length(self) -> builtins.int:
        """
...
class AppTemplateAzureQueueScaleRuleAuthentication(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str secret_name: The name of the Container App Secret to use for this Scale Rule Authentication.
        :param builtins.str trigger_parameter: The Trigger Parameter name to use the supply the value retrieved from the `secret_name`.
        """
...
class AppTemplateContainerEnv(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the environment variable for the container.
...
class AppTemplateContainerLivenessProbe(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failure_count_threshold: Optional[builtins.int] = None,
                 headers: Optional[Sequence['outputs.AppTemplateContainerLivenessProbeHeader']] = None,
                 host: Optional[builtins.str] = None,
                 initial_delay: Optional[builtins.int] = None,
                 interval_seconds: Optional[builtins.int] = None,
                 path: Optional[builtins.str] = None,
                 termination_grace_period_seconds: Optional[builtins.int] = None,
                 timeout: Optional[builtins.int] = None):
        """
        :param builtins.int port: The port number on which to connect. Possible values are between `1` and `65535`.
        :param builtins.str transport: Type of probe. Possible values are `TCP`, `HTTP`, and `HTTPS`.
        :param builtins.int failure_count_threshold: The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `10`. Defaults to `3`.
        :param Sequence['AppTemplateContainerLivenessProbeHeaderArgs'] headers: A `header` block as detailed below.
        :param builtins.str host: The probe hostname. Defaults to the pod IP address. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param builtins.int initial_delay: The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `1` seconds.
        :param builtins.int interval_seconds: How often, in seconds, the probe should run. Possible values are in the range `1` - `240`. Defaults to `10`.
        :param builtins.str path: The URI to use with the `host` for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param builtins.int termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
        :param builtins.int timeout: Time in seconds after which the probe times out. Possible values are in the range `1` - `240`. Defaults to `1`.
        """
    ...
    def failure_count_threshold(self) -> Optional[builtins.int]:
        """
    ...
    def initial_delay(self) -> Optional[builtins.int]:
        """
...
class AppTemplateContainerLivenessProbeHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The HTTP Header Name.
        :param builtins.str value: The HTTP Header value.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class AppTemplateContainerReadinessProbe(dict):
    ...
    def __init__(__self__, *,
                 ...
                 interval_seconds: Optional[builtins.int] = None,
                 path: Optional[builtins.str] = None,
                 success_count_threshold: Optional[builtins.int] = None,
                 timeout: Optional[builtins.int] = None):
        """
        :param builtins.int port: The port number on which to connect. Possible values are between `1` and `65535`.
        :param builtins.str transport: Type of probe. Possible values are `TCP`, `HTTP`, and `HTTPS`.
        :param builtins.int failure_count_threshold: The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `30`. Defaults to `3`.
        :param Sequence['AppTemplateContainerReadinessProbeHeaderArgs'] headers: A `header` block as detailed below.
        :param builtins.str host: The probe hostname. Defaults to the pod IP address. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param builtins.int initial_delay: The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `0` seconds.
        :param builtins.int interval_seconds: How often, in seconds, the probe should run. Possible values are between `1` and `240`. Defaults to `10`
        :param builtins.str path: The URI to use for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param builtins.int success_count_threshold: The number of consecutive successful responses required to consider this probe as successful. Possible values are between `1` and `10`. Defaults to `3`.
        :param builtins.int timeout: Time in seconds after which the probe times out. Possible values are in the range `1` - `240`. Defaults to `1`.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "transport", transport)
    ...
    def success_count_threshold(self) -> Optional[builtins.int]:
        """
...
class AppTemplateContainerStartupProbe(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str host: The value for the host header which should be sent with this probe. If unspecified, the IP Address of the Pod is used as the host header. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param builtins.int initial_delay: The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `0` seconds.
        :param builtins.int interval_seconds: How often, in seconds, the probe should run. Possible values are between `1` and `240`. Defaults to `10`
        :param builtins.str path: The URI to use with the `host` for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param builtins.int termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
...
class AppTemplateContainerVolumeMount(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the Volume to be mounted in the container.
        :param builtins.str path: The path in the container at which to mount this volume.
        :param builtins.str sub_path: The sub path of the volume to be mounted in the container.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "path", path)
...
class AppTemplateCustomScaleRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str custom_rule_type: The Custom rule type. Possible values include: `activemq`, `artemis-queue`, `kafka`, `pulsar`, `aws-cloudwatch`, `aws-dynamodb`, `aws-dynamodb-streams`, `aws-kinesis-stream`, `aws-sqs-queue`, `azure-app-insights`, `azure-blob`, `azure-data-explorer`, `azure-eventhub`, `azure-log-analytics`, `azure-monitor`, `azure-pipelines`, `azure-servicebus`, `azure-queue`, `cassandra`, `cpu`, `cron`, `datadog`, `elasticsearch`, `external`, `external-push`, `gcp-stackdriver`, `gcp-storage`, `gcp-pubsub`, `graphite`, `http`, `huawei-cloudeye`, `ibmmq`, `influxdb`, `kubernetes-workload`, `liiklus`, `memory`, `metrics-api`, `mongodb`, `mssql`, `mysql`, `nats-jetstream`, `stan`, `tcp`, `new-relic`, `openstack-metric`, `openstack-swift`, `postgresql`, `predictkube`, `prometheus`, `rabbitmq`, `redis`, `redis-cluster`, `redis-sentinel`, `redis-streams`, `redis-cluster-streams`, `redis-sentinel-streams`, `selenium-grid`,`solace-event-queue`, and `github-runner`.
        :param Mapping[str, builtins.str] metadata: A map of string key-value pairs to configure the Custom Scale Rule.
        :param builtins.str name: The name of the Scaling Rule
...
class AppTemplateHttpScaleRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str concurrent_requests: The number of concurrent requests to trigger scaling.
        :param builtins.str name: The name of the Scaling Rule
...
class AppTemplateVolume(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str mount_options: Mount options used while mounting the AzureFile. Must be a comma-separated string e.g. `dir_mode=0751,file_mode=0751`.
        :param builtins.str storage_name: The name of the `AzureFile` storage.
        :param builtins.str storage_type: The type of storage volume. Possible values are `AzureFile`, `EmptyDir` and `Secret`. Defaults to `EmptyDir`.
        """
        pulumi.set(__self__, "name", name)
...
class EnvironmentDaprComponentMetadata(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the Metadata configuration item.
        :param builtins.str secret_name: The name of a secret specified in the `secrets` block that contains the value for this metadata configuration item.
        :param builtins.str value: The value for this metadata configuration item.
        """
        pulumi.set(__self__, "name", name)
        if secret_name is not None:
            pulumi.set(__self__, "secret_name", secret_name)
...
class EnvironmentDaprComponentSecret(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The Secret name.
        :param builtins.str identity: The identity to use for accessing key vault reference.
        :param builtins.str key_vault_secret_id: The Key Vault Secret ID. Could be either one of `id` or `versionless_id`.
        :param builtins.str value: The value for this secret.
        """
        pulumi.set(__self__, "name", name)
        if identity is not None:
...
class EnvironmentWorkloadProfile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the workload profile.
        :param builtins.str workload_profile_type: Workload profile type for the workloads to run on. Possible values include `Consumption`, `D4`, `D8`, `D16`, `D32`, `E4`, `E8`, `E16` and `E32`.
        ...
        :param builtins.int maximum_count: The maximum number of instances of workload profile that can be deployed in the Container App Environment.
        :param builtins.int minimum_count: The minimum number of instances of workload profile that can be deployed in the Container App Environment.
        """
        pulumi.set(__self__, "name", name)
...
class JobEventTriggerConfigScale(dict):
    ...
    def __init__(__self__, *,
                 ...
                 polling_interval_in_seconds: Optional[builtins.int] = None,
                 rules: Optional[Sequence['outputs.JobEventTriggerConfigScaleRule']] = None):
        """
        :param builtins.int max_executions: Maximum number of job executions that are created for a trigger.
        :param builtins.int min_executions: Minimum number of job executions that are created for a trigger.
        :param builtins.int polling_interval_in_seconds: Interval to check each event source in seconds.
...
class JobEventTriggerConfigScaleRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str custom_rule_type: Type of the scale rule.
        :param Mapping[str, builtins.str] metadata: Metadata properties to describe the scale rule.
        :param builtins.str name: Name of the scale rule.
...
class JobEventTriggerConfigScaleRuleAuthentication(dict):
    ...
    def __init__(__self__, *,
                 ...
                 trigger_parameter: builtins.str):
        """
        :param builtins.str secret_name: Name of the secret from which to pull the auth params.
...
class JobRegistry(dict):
    ...
    def __init__(__self__, *,
                 ...
                 username: Optional[builtins.str] = None):
        """
        :param builtins.str server: The URL of the Azure Container Registry server.
        :param builtins.str identity: A Managed Identity to use to authenticate with Azure Container Registry.
        :param builtins.str password_secret_name: The name of the Secret that contains the registry login password.
        :param builtins.str username: The username to use to authenticate with Azure Container Registry.
        """
        pulumi.set(__self__, "server", server)
        if identity is not None:
            pulumi.set(__self__, "identity", identity)
...
class JobTemplateContainerEnv(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str secret_name: Name of the Container App secret from which to pull the environment variable value.
...
class JobTemplateContainerLivenessProbe(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str host: The probe hostname. Defaults to the pod IP address. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
        :param builtins.int initial_delay: The time in seconds to wait after the container has started before the probe is started.
        :param builtins.int interval_seconds: How often, in seconds, the probe should run. Possible values are in the range `1` - `240`. Defaults to `10`.
        :param builtins.str path: The URI to use with the `host` for http type probes. Not valid for `TCP` type probes. Defaults to `/`.
        :param builtins.int termination_grace_period_seconds: The time in seconds after the container is sent the termination signal before the process if forcibly killed.
        :param builtins.int timeout: Time in seconds after which the probe times out. Possible values are in the range `1` - `240`. Defaults to `1`.
...
class JobTemplateContainerVolumeMount(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sub_path: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the volume to mount. This must match the name of a volume defined in the `volume` block.
        :param builtins.str path: The path within the container at which the volume should be mounted. Must not contain `:`.
        :param builtins.str sub_path: The sub path of the volume to be mounted in the container.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "path", path)
...
class JobTemplateVolume(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the volume.
        :param builtins.str mount_options: Mount options used while mounting the AzureFile. Must be a comma-separated string e.g. `dir_mode=0751,file_mode=0751`.
        :param builtins.str storage_name: The name of the storage to use for the volume.
        :param builtins.str storage_type: The type of storage to use for the volume. Possible values are `AzureFile`, `EmptyDir` and `Secret`.
        """
        pulumi.set(__self__, "name", name)
        if mount_options is not None:
            pulumi.set(__self__, "mount_options", mount_options)
...
class GetAppDaprResult(dict):
    ...
    @property
    @pulumi.getter(name="appPort")
    def app_port(self) -> builtins.int:
        """
        The port which the application is listening on. This is the same as the `ingress` port.
        """
        return pulumi.get(self, "app_port")
...
class GetAppIngressResult(dict):
    def __init__(__self__, *,
                 allow_insecure_connections: builtins.bool,
                 client_certificate_mode: builtins.str,
                 custom_domains: Sequence['outputs.GetAppIngressCustomDomainResult'],
                 exposed_port: builtins.int,
                 external_enabled: builtins.bool,
                 fqdn: builtins.str,
        ...
        """
        :param builtins.bool allow_insecure_connections: Should this ingress allow insecure connections?
        :param builtins.str client_certificate_mode: The client certificate mode for the Ingress.
        :param Sequence['GetAppIngressCustomDomainArgs'] custom_domains: One or more `custom_domain` block as detailed below.
        :param builtins.int exposed_port: The exposed port on the container for the Ingress traffic.
        :param builtins.bool external_enabled: Is this an external Ingress.
        :param builtins.str fqdn: The FQDN of the ingress.
        ...
        :param builtins.str transport: The transport method for the Ingress. Possible values include `auto`, `http`, and `http2`. Defaults to `auto`
        """
        pulumi.set(__self__, "allow_insecure_connections", allow_insecure_connections)
        pulumi.set(__self__, "client_certificate_mode", client_certificate_mode)
        pulumi.set(__self__, "custom_domains", custom_domains)
    ...
    @property
    @pulumi.getter(name="allowInsecureConnections")
    def allow_insecure_connections(self) -> builtins.bool:
        """
        Should this ingress allow insecure connections?
        """
        return pulumi.get(self, "allow_insecure_connections")
    ...
    @property
    @pulumi.getter(name="exposedPort")
    def exposed_port(self) -> builtins.int:
        """
        The exposed port on the container for the Ingress traffic.
        """
        return pulumi.get(self, "exposed_port")
    ...
    @property
    @pulumi.getter(name="externalEnabled")
    def external_enabled(self) -> builtins.bool:
        """
...
class GetAppIngressCustomDomainResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str certificate_binding_type: The Binding type. Possible values include `Disabled` and `SniEnabled`. Defaults to `Disabled`.
        :param builtins.str certificate_id: The ID of the Container App Environment Certificate.
...
class GetAppIngressIpSecurityRestrictionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str description: Description of the IP restriction rule that is being sent to the container-app.
        :param builtins.str ip_address_range: CIDR notation that matches the incoming IP address.
        :param builtins.str name: The name of the Container App.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "description", description)
...
class GetAppIngressTrafficWeightResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str label: The label to apply to the revision as a name prefix for routing traffic.
        :param builtins.bool latest_revision: This traffic Weight relates to the latest stable Container Revision.
        :param builtins.int percentage: The percentage of traffic which should be sent this revision.
        :param builtins.str revision_suffix: The suffix string to which this `traffic_weight` applies.
        """
        pulumi.set(__self__, "label", label)
...
class GetAppSecretResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str identity: Resource ID for the User Assigned Managed identity to use when pulling from the Container Registry.
        :param builtins.str key_vault_secret_id: The ID of a Key Vault secret.
        :param builtins.str name: The name of the Container App.
        :param builtins.str value: The HTTP Header value.
        """
        pulumi.set(__self__, "identity", identity)
...
class GetAppTemplateContainerResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str memory: The amount of memory to allocate to the container. Possible values include `0.5Gi`, `1Gi`, `1.5Gi`, `2Gi`, `2.5Gi`, `3Gi`, `3.5Gi`, and `4Gi`.
        :param builtins.str name: The name of the Container App.
...
class GetAppTemplateContainerLivenessProbeResult(dict):
    ...
    @property
    @pulumi.getter(name="failureCountThreshold")
    def failure_count_threshold(self) -> builtins.int:
        """
        The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `30`. Defaults to `3`.
        """
        return pulumi.get(self, "failure_count_threshold")
    ...
    @property
    @pulumi.getter(name="initialDelay")
    def initial_delay(self) -> builtins.int:
        """
        The number of seconds elapsed after the container has started before the probe is initiated. Possible values are between `0` and `60`. Defaults to `0` seconds.
        """
        return pulumi.get(self, "initial_delay")
    ...
    @property
    @pulumi.getter(name="intervalSeconds")
    def interval_seconds(self) -> builtins.int:
        """
        How often, in seconds, the probe should run. Possible values are between `1` and `240`. Defaults to `10`
        """
        return pulumi.get(self, "interval_seconds")
...
class GetAppTemplateContainerReadinessProbeResult(dict):
    def __init__(__self__, *,
                 ...
                 path: builtins.str,
                 port: builtins.int,
                 success_count_threshold: builtins.int,
                 timeout: builtins.int,
                 transport: builtins.str):
        """
        :param builtins.int failure_count_threshold: The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `30`. Defaults to `3`.
    ...
    @property
    @pulumi.getter(name="successCountThreshold")
    def success_count_threshold(self) -> builtins.int:
        """
        The number of consecutive successful responses required to consider this probe as successful. Possible values are between `1` and `10`. Defaults to `3`.
        """
        return pulumi.get(self, "success_count_threshold")
...
class GetAppTemplateVolumeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str mount_options: Mount options used while mounting the AzureFile.
        :param builtins.str name: The name of the Container App.
        :param builtins.str storage_name: The name of the `AzureFile` storage.
        :param builtins.str storage_type: The type of storage volume. Possible values include `AzureFile` and `EmptyDir`. Defaults to `EmptyDir`.
        """
        pulumi.set(__self__, "mount_options", mount_options)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "storage_name", storage_name)
