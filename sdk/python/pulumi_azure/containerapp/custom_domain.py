...
class CustomDomainArgs:
    def __init__(__self__, *,
                 container_app_id: pulumi.Input[builtins.str],
                 certificate_binding_type: Optional[pulumi.Input[builtins.str]] = None,
                 container_app_environment_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def container_app_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def container_app_id(self, value: pulumi.Input[builtins.str]):
    ...
    def container_app_environment_certificate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_app_environment_certificate_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CustomDomainState:
    def __init__(__self__, *,
                 certificate_binding_type: Optional[pulumi.Input[builtins.str]] = None,
                 container_app_environment_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
                 container_app_environment_managed_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
                 container_app_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def container_app_environment_managed_certificate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_app_environment_managed_certificate_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_app_environment_managed_certificate_id", value)

    @property
    @pulumi.getter(name="containerAppId")
    def container_app_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Container App to which this Custom Domain should be bound. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "container_app_id")
    ...
    @container_app_id.setter
    def container_app_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_app_id", value)
...
class CustomDomain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            container_app_environment_managed_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
            container_app_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomDomain':
        """
    ...
    @property
    @pulumi.getter(name="certificateBindingType")
    def certificate_binding_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Binding type. Possible values include `Disabled` and `SniEnabled`.
        """
        return pulumi.get(self, "certificate_binding_type")
    ...
    @property
    @pulumi.getter(name="containerAppEnvironmentCertificateId")
    def container_app_environment_certificate_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Container App Environment Certificate to use. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="containerAppEnvironmentManagedCertificateId")
    def container_app_environment_managed_certificate_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Container App Environment Managed Certificate to use.
        """
        return pulumi.get(self, "container_app_environment_managed_certificate_id")
    ...
    @property
    @pulumi.getter(name="containerAppId")
    def container_app_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Container App to which this Custom Domain should be bound. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "container_app_id")
