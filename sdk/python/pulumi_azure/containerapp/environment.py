...
class EnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 dapr_application_insights_connection_string: Optional[pulumi.Input[builtins.str]] = None,
                 infrastructure_resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 logs_destination: Optional[pulumi.Input[builtins.str]] = None,
                 mutual_tls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] dapr_application_insights_connection_string: Application Insights connection string used by Dapr to export Service to Service communication telemetry. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] infrastructure_resource_group_name: Name of the platform-managed resource group created for the Managed Environment to host infrastructure resources. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] infrastructure_subnet_id: The existing Subnet to use for the Container Apps Control Plane. Changing this forces a new resource to be created. 
               
               > **Note:** The Subnet must have a `/21` or larger address space.
        :param pulumi.Input[builtins.bool] internal_load_balancer_enabled: Should the Container Environment operate in Internal Load Balancing Mode? Defaults to `false`. Changing this forces a new resource to be created.
               
               > **Note:** can only be set to `true` if `infrastructure_subnet_id` is specified.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the Container App Environment is to exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] log_analytics_workspace_id: The ID for the Log Analytics Workspace to link this Container Apps Managed Environment to. 
               
               > **Note:** required if `logs_destination` is set to `log-analytics`. Cannot be set if `logs_destination` is set to `azure-monitor`.
        :param pulumi.Input[builtins.str] logs_destination: Where the application logs will be saved for this Container Apps Managed Environment. Possible values include `log-analytics` and `azure-monitor`. Omitting this value will result in logs being streamed only.
        :param pulumi.Input[builtins.bool] mutual_tls_enabled: Should mutual transport layer security (mTLS) be enabled? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Container Apps Managed Environment. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] zone_redundancy_enabled: Should the Container App Environment be created with Zone Redundancy enabled? Defaults to `false`. Changing this forces a new resource to be created.
    ...
    def dapr_application_insights_connection_string(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dapr_application_insights_connection_string(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dapr_application_insights_connection_string", value)

    @property
    @pulumi.getter(name="infrastructureResourceGroupName")
    def infrastructure_resource_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def infrastructure_resource_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def logs_destination(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def logs_destination(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "logs_destination", value)

    @property
    @pulumi.getter(name="mutualTlsEnabled")
    def mutual_tls_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def mutual_tls_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _EnvironmentState:
    def __init__(__self__, *,
                 ...
                 platform_reserved_dns_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 static_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 workload_profiles: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentWorkloadProfileArgs']]]] = None,
                 zone_redundancy_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        Input properties used for looking up and filtering Environment resources.
        :param pulumi.Input[builtins.str] custom_domain_verification_id: The ID of the Custom Domain Verification for this Container App Environment.
        :param pulumi.Input[builtins.str] dapr_application_insights_connection_string: Application Insights connection string used by Dapr to export Service to Service communication telemetry. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] default_domain: The default, publicly resolvable, name of this Container App Environment.
        :param pulumi.Input[builtins.str] docker_bridge_cidr: The network addressing in which the Container Apps in this Container App Environment will reside in CIDR notation.
        :param pulumi.Input[builtins.str] infrastructure_resource_group_name: Name of the platform-managed resource group created for the Managed Environment to host infrastructure resources. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] mutual_tls_enabled: Should mutual transport layer security (mTLS) be enabled? Defaults to `false`.
               ...
               > **Note:** This feature is in public preview. Enabling mTLS for your applications may increase response latency and reduce maximum throughput in high-load scenarios.
        :param pulumi.Input[builtins.str] name: The name of the Container Apps Managed Environment. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] platform_reserved_cidr: The IP range, in CIDR notation, that is reserved for environment infrastructure IP addresses.
        :param pulumi.Input[builtins.str] platform_reserved_dns_ip_address: The IP address from the IP range defined by `platform_reserved_cidr` that is reserved for the internal DNS server.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Container App Environment is to be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] static_ip_address: The Static IP address of the Environment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentWorkloadProfileArgs']]] workload_profiles: One or more `workload_profile` blocks as defined below.
        :param pulumi.Input[builtins.bool] zone_redundancy_enabled: Should the Container App Environment be created with Zone Redundancy enabled? Defaults to `false`. Changing this forces a new resource to be created.
    ...
    def platform_reserved_dns_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def platform_reserved_dns_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def static_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def static_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Environment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workload_profiles: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentWorkloadProfileArgs', 'EnvironmentWorkloadProfileArgsDict']]]]] = None,
            zone_redundancy_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Environment':
        """
    ...
    @property
    @pulumi.getter(name="daprApplicationInsightsConnectionString")
    def dapr_application_insights_connection_string(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Application Insights connection string used by Dapr to export Service to Service communication telemetry. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "dapr_application_insights_connection_string")
    ...
    @property
    @pulumi.getter(name="dockerBridgeCidr")
    def docker_bridge_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The network addressing in which the Container Apps in this Container App Environment will reside in CIDR notation.
        """
        return pulumi.get(self, "docker_bridge_cidr")
    ...
    @property
    @pulumi.getter(name="infrastructureResourceGroupName")
    def infrastructure_resource_group_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the platform-managed resource group created for the Managed Environment to host infrastructure resources. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="infrastructureSubnetId")
    def infrastructure_subnet_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The existing Subnet to use for the Container Apps Control Plane. Changing this forces a new resource to be created. 
    ...
    @property
    @pulumi.getter(name="logsDestination")
    def logs_destination(self) -> pulumi.Output[builtins.str]:
        """
        Where the application logs will be saved for this Container Apps Managed Environment. Possible values include `log-analytics` and `azure-monitor`. Omitting this value will result in logs being streamed only.
        """
        return pulumi.get(self, "logs_destination")
    ...
    @property
    @pulumi.getter(name="mutualTlsEnabled")
    def mutual_tls_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should mutual transport layer security (mTLS) be enabled? Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="platformReservedCidr")
    def platform_reserved_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The IP range, in CIDR notation, that is reserved for environment infrastructure IP addresses.
        """
        return pulumi.get(self, "platform_reserved_cidr")
    ...
    @property
    @pulumi.getter(name="platformReservedDnsIpAddress")
    def platform_reserved_dns_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The IP address from the IP range defined by `platform_reserved_cidr` that is reserved for the internal DNS server.
        """
        return pulumi.get(self, "platform_reserved_dns_ip_address")
    ...
    @property
    @pulumi.getter(name="staticIpAddress")
    def static_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The Static IP address of the Environment.
        """
        return pulumi.get(self, "static_ip_address")
    ...
    @property
    @pulumi.getter(name="zoneRedundancyEnabled")
    def zone_redundancy_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should the Container App Environment be created with Zone Redundancy enabled? Defaults to `false`. Changing this forces a new resource to be created.
