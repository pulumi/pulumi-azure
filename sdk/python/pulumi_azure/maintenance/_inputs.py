...
class AssignmentDynamicScopeFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] os_types: Specifies a list of allowed operating systems.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_groups: Specifies a list of allowed resource groups.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types: Specifies a list of allowed resources.
        :param pulumi.Input[builtins.str] tag_filter: Filter VMs by `Any` or `All` specified tags. Defaults to `Any`.
...
class AssignmentDynamicScopeFilterTagArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] tag: Specifies the tag to filter by.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: Specifies a list of values the defined tag can have.
        """
...
class ConfigurationInstallPatchesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] reboot: Possible reboot preference as defined by the user based on which it would be decided to reboot the machine or not after the patch operation is completed. Possible values are `Always`, `IfRequired` and `Never`. This property only applies when `scope` is set to `InGuestPatch`.
...
if not MYPY:
    class ConfigurationInstallPatchesLinuxArgsDict(TypedDict):
        classifications_to_includes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of Classification category of patches to be patched. Possible values are `Critical`, `Security` and `Other`.
        """
        package_names_mask_to_excludes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of package names to be excluded from patching.
        """
        package_names_mask_to_includes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConfigurationInstallPatchesLinuxArgs:
    def __init__(__self__, *,
                 classifications_to_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 package_names_mask_to_excludes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 package_names_mask_to_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] classifications_to_includes: List of Classification category of patches to be patched. Possible values are `Critical`, `Security` and `Other`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] package_names_mask_to_excludes: List of package names to be excluded from patching.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] package_names_mask_to_includes: List of package names to be included for patching.
        """
    ...
    def classifications_to_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of Classification category of patches to be patched. Possible values are `Critical`, `Security` and `Other`.
        """
    ...
    def classifications_to_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "classifications_to_includes", value)

    @property
    @pulumi.getter(name="packageNamesMaskToExcludes")
    def package_names_mask_to_excludes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of package names to be excluded from patching.
        """
    ...
    def package_names_mask_to_excludes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "package_names_mask_to_excludes", value)

    @property
    @pulumi.getter(name="packageNamesMaskToIncludes")
    def package_names_mask_to_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of package names to be included for patching.
        """
    ...
    def package_names_mask_to_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ConfigurationInstallPatchesWindowArgsDict(TypedDict):
        ...
        """
        kb_numbers_to_excludes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of KB numbers to be excluded from patching.
        """
        kb_numbers_to_includes: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ConfigurationInstallPatchesWindowArgs:
    def __init__(__self__, *,
                 classifications_to_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 kb_numbers_to_excludes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 kb_numbers_to_includes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] classifications_to_includes: List of Classification category of patches to be patched. Possible values are `Critical`, `Security`, `UpdateRollup`, `FeaturePack`, `ServicePack`, `Definition`, `Tools` and `Updates`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] kb_numbers_to_excludes: List of KB numbers to be excluded from patching.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] kb_numbers_to_includes: List of KB numbers to be included for patching.
        """
        if classifications_to_includes is not None:
            pulumi.set(__self__, "classifications_to_includes", classifications_to_includes)
    ...
    def kb_numbers_to_excludes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of KB numbers to be excluded from patching.
        """
    ...
    def kb_numbers_to_excludes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "kb_numbers_to_excludes", value)

    @property
    @pulumi.getter(name="kbNumbersToIncludes")
    def kb_numbers_to_includes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of KB numbers to be included for patching.
        """
    ...
    def kb_numbers_to_includes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ConfigurationWindowArgsDict(TypedDict):
        ...
        """
        expiration_date_time: NotRequired[pulumi.Input[builtins.str]]
        """
        Effective expiration date of the maintenance window in YYYY-MM-DD hh:mm format.
        """
        recur_every: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConfigurationWindowArgs:
    def __init__(__self__, *,
                 ...
                 expiration_date_time: Optional[pulumi.Input[builtins.str]] = None,
                 recur_every: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] start_date_time: Effective start date of the maintenance window in YYYY-MM-DD hh:mm format.
        :param pulumi.Input[builtins.str] time_zone: The time zone for the maintenance window. A list of timezones can be obtained by executing [System.TimeZoneInfo]::GetSystemTimeZones() in PowerShell.
        :param pulumi.Input[builtins.str] duration: The duration of the maintenance window in HH:mm format.
        :param pulumi.Input[builtins.str] expiration_date_time: Effective expiration date of the maintenance window in YYYY-MM-DD hh:mm format.
        :param pulumi.Input[builtins.str] recur_every: The rate at which a maintenance window is expected to recur. The rate can be expressed as daily, weekly, or monthly schedules.
        """
    ...
    def expiration_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Effective expiration date of the maintenance window in YYYY-MM-DD hh:mm format.
        """
    ...
    def expiration_date_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "expiration_date_time", value)

    @property
    @pulumi.getter(name="recurEvery")
    def recur_every(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The rate at which a maintenance window is expected to recur. The rate can be expressed as daily, weekly, or monthly schedules.
        """
    ...
    @recur_every.setter
    def recur_every(self, value: Optional[pulumi.Input[builtins.str]]):
