...
class AssignmentVirtualMachineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] virtual_machine_id: Specifies the Virtual Machine ID to which the Maintenance Configuration will be assigned. Changing this forces a new resource to be created.
...
class AssignmentVirtualMachine(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[_builtins.str]] = None,
            maintenance_configuration_id: Optional[pulumi.Input[_builtins.str]] = None,
            virtual_machine_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'AssignmentVirtualMachine':
        """
