...
class GetConfigurationResult:
    ...
    def in_guest_user_patch_mode(self) -> _builtins.str:
        """
...
def get_configuration(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Maintenance` - 2023-04-01
    ...
    :param _builtins.str resource_group_name: Specifies the name of the Resource Group where this Maintenance Configuration exists.
    """
    __args__ = dict()
    __args__['name'] = name
