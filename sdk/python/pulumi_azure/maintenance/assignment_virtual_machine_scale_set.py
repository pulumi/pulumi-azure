...
class AssignmentVirtualMachineScaleSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_machine_scale_set_id: Specifies the Virtual Machine Scale Set ID to which the Maintenance Configuration will be assigned. Changing this forces a new resource to be created.
...
class AssignmentVirtualMachineScaleSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[builtins.str]] = None,
            maintenance_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
            virtual_machine_scale_set_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AssignmentVirtualMachineScaleSet':
        """
