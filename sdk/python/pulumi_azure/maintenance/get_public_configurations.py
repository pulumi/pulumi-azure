...
def get_public_configurations(location: Optional[builtins.str] = None,
    ...
    * `Microsoft.Maintenance`: 2023-04-01
    ...
    :param builtins.str scope: The scope to filter the list of Public Maintenance Configurations against. Possible values are `Extension`, `Host`, `InGuestPatch`, `OSImage`, `SQLDB` and `SQLManagedInstance`.
    """
    __args__ = dict()
...
def get_public_configurations_output(location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     recur_every: Optional[pulumi.Input[Optional[builtins.str]]] = None,
