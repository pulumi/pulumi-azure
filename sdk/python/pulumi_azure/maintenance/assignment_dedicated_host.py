...
class AssignmentDedicatedHostArgs:
    def __init__(__self__, *,
                 dedicated_host_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] dedicated_host_id: Specifies the Dedicated Host ID to which the Maintenance Configuration will be assigned. Changing this forces a new resource to be created.
    ...
    def dedicated_host_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dedicated_host_id(self, value: pulumi.Input[builtins.str]):
...
class AssignmentDedicatedHost(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dedicated_host_id: Optional[pulumi.Input[builtins.str]] = None,
            location: Optional[pulumi.Input[builtins.str]] = None,
            maintenance_configuration_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AssignmentDedicatedHost':
        """
    ...
    @property
    @pulumi.getter(name="dedicatedHostId")
    def dedicated_host_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Dedicated Host ID to which the Maintenance Configuration will be assigned. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "dedicated_host_id")
