...
class UserAssignedIdentityArgs:
    def __init__(__self__, *,
                 ...
                 isolation_scope: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def isolation_scope(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def isolation_scope(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _UserAssignedIdentityState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_group_name: Specifies the name of the Resource Group within which this User Assigned Identity should exist. Changing this forces a new User Assigned Identity to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the User Assigned Identity.
        :param pulumi.Input[_builtins.str] tenant_id: The ID of the Tenant which the Identity belongs to.
        """
...
class UserAssignedIdentity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tenant_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'UserAssignedIdentity':
        """
