...
class UserAssignedIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group within which this User Assigned Identity should exist. Changing this forces a new User Assigned Identity to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the User Assigned Identity should exist. Changing this forces a new User Assigned Identity to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this User Assigned Identity. Changing this forces a new User Assigned Identity to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the User Assigned Identity.
        """
...
class _UserAssignedIdentityState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] client_id: The ID of the app associated with the Identity.
        :param pulumi.Input[builtins.str] location: The Azure Region where the User Assigned Identity should exist. Changing this forces a new User Assigned Identity to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this User Assigned Identity. Changing this forces a new User Assigned Identity to be created.
        :param pulumi.Input[builtins.str] principal_id: The ID of the Service Principal object associated with the created Identity.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group within which this User Assigned Identity should exist. Changing this forces a new User Assigned Identity to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the User Assigned Identity.
        :param pulumi.Input[builtins.str] tenant_id: The ID of the Tenant which the Identity belongs to.
        """
...
class UserAssignedIdentity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UserAssignedIdentity':
        """
