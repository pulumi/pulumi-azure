...
if not MYPY:
    class ServerCustomerManagedKeyArgsDict(TypedDict):
        ...
        """
        user_assigned_identity_id: pulumi.Input[builtins.str]
        """
...
class ServerCustomerManagedKeyArgs:
    def __init__(__self__, *,
                 ...
                 user_assigned_identity_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_vault_key_id: The Key Vault Key Id that will be used to encrypt the Fluid Relay Server.
    ...
    def user_assigned_identity_id(self) -> pulumi.Input[builtins.str]:
        """
        The User Assigned Managed Identity ID to be used for accessing the Customer Managed Key for encryption.
        """
    ...
    def user_assigned_identity_id(self, value: pulumi.Input[builtins.str]):
...
class ServerIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Fluid Relay Service. Possible values are `SystemAssigned`,`UserAssigned` and `SystemAssigned, UserAssigned`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Fluid Relay Service.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Identity of this Fluid Relay Server.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Fluid Relay Server.
        """
