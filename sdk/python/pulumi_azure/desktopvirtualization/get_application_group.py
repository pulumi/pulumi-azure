...
def get_application_group(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.DesktopVirtualization` - 2024-04-03
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Application Group exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_application_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
