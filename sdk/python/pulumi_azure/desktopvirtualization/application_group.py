...
class ApplicationGroupArgs:
    def __init__(__self__, *,
                 ...
                 default_desktop_display_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] host_pool_id: Resource ID for a Virtual Desktop Host Pool to associate with the Virtual Desktop Application Group. Changing the name forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Virtual Desktop Application Group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] type: Type of Virtual Desktop Application Group. Valid options are `RemoteApp` or `Desktop` application groups. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] default_desktop_display_name: Option to set the display name for the default sessionDesktop desktop when `type` is set to `Desktop`. A value here is mandatory for connections to the desktop using the Windows 365 portal. Without it the connection will hang at 'Loading Client'.
        :param pulumi.Input[builtins.str] description: Option to set a description for the Virtual Desktop Application Group.
        :param pulumi.Input[builtins.str] friendly_name: Option to set a friendly name for the Virtual Desktop Application Group.
        :param pulumi.Input[builtins.str] location: The location/region where the Virtual Desktop Application Group is located. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Virtual Desktop Application Group. Changing the name forces a new resource to be created.
    ...
    def default_desktop_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_desktop_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApplicationGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ApplicationGroup':
        """
    ...
    @property
    @pulumi.getter(name="defaultDesktopDisplayName")
    def default_desktop_display_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Option to set the display name for the default sessionDesktop desktop when `type` is set to `Desktop`. A value here is mandatory for connections to the desktop using the Windows 365 portal. Without it the connection will hang at 'Loading Client'.
        """
        return pulumi.get(self, "default_desktop_display_name")
