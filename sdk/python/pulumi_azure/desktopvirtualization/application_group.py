...
class ApplicationGroupArgs:
    def __init__(__self__, *,
                 ...
                 default_desktop_display_name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The location/region where the Virtual Desktop Application Group is located. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: The name of the Virtual Desktop Application Group. Changing the name forces a new resource to be created.
    ...
    def default_desktop_display_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def default_desktop_display_name(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class ApplicationGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'ApplicationGroup':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultDesktopDisplayName")
    def default_desktop_display_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Option to set the display name for the default sessionDesktop desktop when `type` is set to `Desktop`. A value here is mandatory for connections to the desktop using the Windows 365 portal. Without it the connection will hang at 'Loading Client'.
        """
        return pulumi.get(self, "default_desktop_display_name")
