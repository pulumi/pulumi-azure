...
class WorkspaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Virtual Desktop Workspace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] description: A description for the Virtual Desktop Workspace.
        :param pulumi.Input[builtins.str] friendly_name: A friendly name for the Virtual Desktop Workspace.
        :param pulumi.Input[builtins.str] location: The location/region where the Virtual Desktop Workspace is located. Changing the location/region forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Virtual Desktop Workspace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether public network access is allowed for this Virtual Desktop Workspace. Defaults to `true`.
...
@pulumi.type_token("azure:desktopvirtualization/workspace:Workspace")
