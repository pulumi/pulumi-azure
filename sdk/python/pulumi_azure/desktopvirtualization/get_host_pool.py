...
class GetHostPoolResult:
    ...
    def maximum_sessions_allowed(self) -> builtins.int:
        """
    ...
    def start_vm_on_connect(self) -> builtins.bool:
        """
    ...
    def validate_environment(self) -> builtins.bool:
        """
...
def get_host_pool(name: Optional[builtins.str] = None,
...
def get_host_pool_output(name: Optional[pulumi.Input[builtins.str]] = None,
