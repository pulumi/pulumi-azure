...
class HostPoolArgs:
    def __init__(__self__, *,
                 ...
                 custom_rdp_properties: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 friendly_name: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 maximum_sessions_allowed: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 personal_desktop_assignment_type: Optional[pulumi.Input[builtins.str]] = None,
                 preferred_app_group_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 validate_environment: Optional[pulumi.Input[builtins.bool]] = None,
                 vm_template: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a HostPool resource.
        :param pulumi.Input[builtins.str] load_balancer_type: `BreadthFirst` load balancing distributes new user sessions across all available session hosts in the host pool. Possible values are `BreadthFirst`, `DepthFirst` and `Persistent`.
        ...
        :param pulumi.Input[builtins.str] type: The type of the Virtual Desktop Host Pool. Valid options are `Personal` or `Pooled`. Changing the type forces a new resource to be created.
        :param pulumi.Input[builtins.str] custom_rdp_properties: A valid custom RDP properties string for the Virtual Desktop Host Pool, available properties can be [found in this article](https://docs.microsoft.com/windows-server/remote/remote-desktop-services/clients/rdp-files).
        :param pulumi.Input[builtins.str] description: A description for the Virtual Desktop Host Pool.
        :param pulumi.Input[builtins.str] friendly_name: A friendly name for the Virtual Desktop Host Pool.
        :param pulumi.Input[builtins.str] location: The location/region where the Virtual Desktop Host Pool is located. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] maximum_sessions_allowed: A valid integer value from 0 to 999999 for the maximum number of users that have concurrent sessions on a session host.
        ...
        :param pulumi.Input[builtins.bool] start_vm_on_connect: Enables or disables the Start VM on Connection Feature. Defaults to `false`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.bool] validate_environment: Allows you to test service changes before they are deployed to production. Defaults to `false`.
        :param pulumi.Input[builtins.str] vm_template: A VM template for session hosts configuration within hostpool. This is a JSON string.
        """
    ...
    def custom_rdp_properties(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_rdp_properties(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def maximum_sessions_allowed(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_sessions_allowed(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def personal_desktop_assignment_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def personal_desktop_assignment_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "personal_desktop_assignment_type", value)

    @property
    @pulumi.getter(name="preferredAppGroupType")
    def preferred_app_group_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def preferred_app_group_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def validate_environment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def validate_environment(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class HostPool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            validate_environment: Optional[pulumi.Input[builtins.bool]] = None,
            vm_template: Optional[pulumi.Input[builtins.str]] = None) -> 'HostPool':
        """
    ...
    @property
    @pulumi.getter(name="customRdpProperties")
    def custom_rdp_properties(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A valid custom RDP properties string for the Virtual Desktop Host Pool, available properties can be [found in this article](https://docs.microsoft.com/windows-server/remote/remote-desktop-services/clients/rdp-files).
        """
        return pulumi.get(self, "custom_rdp_properties")
    ...
    @property
    @pulumi.getter(name="maximumSessionsAllowed")
    def maximum_sessions_allowed(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        A valid integer value from 0 to 999999 for the maximum number of users that have concurrent sessions on a session host.
        Should only be set if the `type` of your Virtual Desktop Host Pool is `Pooled`.
        """
    ...
    @property
    @pulumi.getter(name="preferredAppGroupType")
    def preferred_app_group_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Option to specify the preferred Application Group type for the Virtual Desktop Host Pool. Valid options are `None`, `Desktop` or `RailApplications`. Default is `Desktop`.
        """
        return pulumi.get(self, "preferred_app_group_type")
    ...
    @property
    @pulumi.getter(name="validateEnvironment")
    def validate_environment(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allows you to test service changes before they are deployed to production. Defaults to `false`.
        """
        return pulumi.get(self, "validate_environment")
