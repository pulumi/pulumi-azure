...
class HostPoolScheduledAgentUpdates(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_session_host_timezone: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Enables or disables scheduled updates of the AVD agent components (RDAgent, Geneva Monitoring agent, and side-by-side stack) on session hosts. If this is enabled then up to two `schedule` blocks must be defined. Default is `false`.
        ...
        :param builtins.str timezone: Specifies the time zone in which the agent update schedule will apply, [the possible values are defined here](https://jackstromberg.com/2017/01/list-of-time-zones-consumed-by-azure/). If `use_session_host_timezone` is enabled then it will override this setting. Default is `UTC`
        :param builtins.bool use_session_host_timezone: Specifies whether scheduled agent updates should be applied based on the timezone of the affected session host. If configured then this setting overrides `timezone`. Default is `false`.
        """
    ...
    def use_session_host_timezone(self) -> Optional[builtins.bool]:
        """
...
class HostPoolScheduledAgentUpdatesSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day_of_week: The day of the week on which agent updates should be performed. Possible values are `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`
        :param builtins.int hour_of_day: The hour of day the update window should start. The update is a 2 hour period following the hour provided. The value should be provided as a number between 0 and 23, with 0 being midnight and 23 being 11pm. A leading zero should not be used.
        """
...
class ScalingPlanHostPool(dict):
    ...
    def __init__(__self__, *,
                 ...
                 scaling_plan_enabled: builtins.bool):
        """
        :param builtins.str hostpool_id: The ID of the HostPool to assign the Scaling Plan to.
        :param builtins.bool scaling_plan_enabled: Specifies if the scaling plan is enabled or disabled for the HostPool.
        """
    ...
    def scaling_plan_enabled(self) -> builtins.bool:
        """
...
class ScalingPlanSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ramp_down_capacity_threshold_percent: builtins.int,
                 ramp_down_force_logoff_users: builtins.bool,
                 ramp_down_load_balancing_algorithm: builtins.str,
                 ramp_down_minimum_hosts_percent: builtins.int,
                 ramp_down_notification_message: builtins.str,
                 ramp_down_start_time: builtins.str,
                 ramp_down_stop_hosts_when: builtins.str,
                 ramp_down_wait_time_minutes: builtins.int,
                 ramp_up_load_balancing_algorithm: builtins.str,
                 ramp_up_start_time: builtins.str,
                 ramp_up_capacity_threshold_percent: Optional[builtins.int] = None,
                 ramp_up_minimum_hosts_percent: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] days_of_weeks: A list of Days of the Week on which this schedule will be used. Possible values are `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`
        :param builtins.str name: The name of the schedule.
        :param builtins.str off_peak_load_balancing_algorithm: The load Balancing Algorithm to use during Off-Peak Hours. Possible values are `DepthFirst` and `BreadthFirst`.
        :param builtins.str off_peak_start_time: The time at which Off-Peak scaling will begin. This is also the end-time for the Ramp-Down period. The time must be specified in "HH:MM" format.
        :param builtins.str peak_load_balancing_algorithm: The load Balancing Algorithm to use during Peak Hours. Possible values are `DepthFirst` and `BreadthFirst`.
        :param builtins.str peak_start_time: The time at which Peak scaling will begin. This is also the end-time for the Ramp-Up period. The time must be specified in "HH:MM" format.
        :param builtins.int ramp_down_capacity_threshold_percent: This is the value in percentage of used host pool capacity that will be considered to evaluate whether to turn on/off virtual machines during the ramp-down and off-peak hours. For example, if capacity threshold is specified as 60% and your total host pool capacity is 100 sessions, autoscale will turn on additional session hosts once the host pool exceeds a load of 60 sessions.
        :param builtins.bool ramp_down_force_logoff_users: Whether users will be forced to log-off session hosts once the `ramp_down_wait_time_minutes` value has been exceeded during the Ramp-Down period. Possible values are `true` and `false`.
        :param builtins.str ramp_down_load_balancing_algorithm: The load Balancing Algorithm to use during the Ramp-Down period. Possible values are `DepthFirst` and `BreadthFirst`.
        :param builtins.int ramp_down_minimum_hosts_percent: The minimum percentage of session host virtual machines that you would like to get to for ramp-down and off-peak hours. For example, if Minimum percentage of hosts is specified as 10% and total number of session hosts in your host pool is 10, autoscale will ensure a minimum of 1 session host is available to take user connections.
        :param builtins.str ramp_down_notification_message: The notification message to send to users during Ramp-Down period when they are required to log-off.
        :param builtins.str ramp_down_start_time: The time at which Ramp-Down scaling will begin. This is also the end-time for the Ramp-Up period. The time must be specified in "HH:MM" format.
        :param builtins.str ramp_down_stop_hosts_when: Controls Session Host shutdown behaviour during Ramp-Down period. Session Hosts can either be shutdown when all sessions on the Session Host have ended, or when there are no Active sessions left on the Session Host. Possible values are `ZeroSessions` and `ZeroActiveSessions`.
        :param builtins.int ramp_down_wait_time_minutes: The number of minutes during Ramp-Down period that autoscale will wait after setting the session host VMs to drain mode, notifying any currently signed in users to save their work before forcing the users to logoff. Once all user sessions on the session host VM have been logged off, Autoscale will shut down the VM.
        :param builtins.str ramp_up_load_balancing_algorithm: The load Balancing Algorithm to use during the Ramp-Up period. Possible values are `DepthFirst` and `BreadthFirst`.
        :param builtins.str ramp_up_start_time: The time at which Ramp-Up scaling will begin. This is also the end-time for the Ramp-Up period. The time must be specified in "HH:MM" format.
        :param builtins.int ramp_up_capacity_threshold_percent: This is the value of percentage of used host pool capacity that will be considered to evaluate whether to turn on/off virtual machines during the ramp-up and peak hours. For example, if capacity threshold is specified as `60%` and your total host pool capacity is `100` sessions, autoscale will turn on additional session hosts once the host pool exceeds a load of `60` sessions.
        :param builtins.int ramp_up_minimum_hosts_percent: Specifies the minimum percentage of session host virtual machines to start during ramp-up for peak hours. For example, if Minimum percentage of hosts is specified as `10%` and total number of session hosts in your host pool is `10`, autoscale will ensure a minimum of `1` session host is available to take user connections.
        """
    ...
    def ramp_down_capacity_threshold_percent(self) -> builtins.int:
        """
        This is the value in percentage of used host pool capacity that will be considered to evaluate whether to turn on/off virtual machines during the ramp-down and off-peak hours. For example, if capacity threshold is specified as 60% and your total host pool capacity is 100 sessions, autoscale will turn on additional session hosts once the host pool exceeds a load of 60 sessions.
        """
    ...
    def ramp_down_force_logoff_users(self) -> builtins.bool:
        """
    ...
    def ramp_down_minimum_hosts_percent(self) -> builtins.int:
        """
        The minimum percentage of session host virtual machines that you would like to get to for ramp-down and off-peak hours. For example, if Minimum percentage of hosts is specified as 10% and total number of session hosts in your host pool is 10, autoscale will ensure a minimum of 1 session host is available to take user connections.
        """
    ...
    def ramp_down_wait_time_minutes(self) -> builtins.int:
        """
    ...
    def ramp_up_capacity_threshold_percent(self) -> Optional[builtins.int]:
        """
    ...
    def ramp_up_minimum_hosts_percent(self) -> Optional[builtins.int]:
        """
        Specifies the minimum percentage of session host virtual machines to start during ramp-up for peak hours. For example, if Minimum percentage of hosts is specified as `10%` and total number of session hosts in your host pool is `10`, autoscale will ensure a minimum of `1` session host is available to take user connections.
        """
...
class GetHostPoolScheduledAgentUpdateResult(dict):
    def __init__(__self__, *,
                 ...
                 use_session_host_timezone: builtins.bool):
        """
        :param builtins.bool enabled: Are scheduled updates of the AVD agent components (RDAgent, Geneva Monitoring agent, and side-by-side stack) enabled on session hosts.
        :param Sequence['GetHostPoolScheduledAgentUpdateScheduleArgs'] schedules: A `schedule` block as defined below.
        :param builtins.str timezone: The time zone in which the agent update schedule will apply.
        :param builtins.bool use_session_host_timezone: Specifies whether scheduled agent updates should be applied based on the timezone of the affected session host.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "schedules", schedules)
        pulumi.set(__self__, "timezone", timezone)
    ...
    @property
    @pulumi.getter(name="useSessionHostTimezone")
    def use_session_host_timezone(self) -> builtins.bool:
        """
...
class GetHostPoolScheduledAgentUpdateScheduleResult(dict):
    def __init__(__self__, *,
                 ...
                 hour_of_day: builtins.int):
        """
        :param builtins.str day_of_week: The day of the week on which agent updates should be performed.
        :param builtins.int hour_of_day: The hour of day the update window should start.
        """
        pulumi.set(__self__, "day_of_week", day_of_week)
        pulumi.set(__self__, "hour_of_day", hour_of_day)
