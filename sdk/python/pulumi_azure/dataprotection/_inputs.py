...
__all__ = [
    ...
    'BackupPolicyDataLakeStorageRetentionRuleArgsDict',
...
class BackupInstanceKubernetesClusterBackupDatasourceParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] excluded_resource_types: Specifies the resource types to be excluded during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] included_namespaces: Specifies the namespaces to be included during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] included_resource_types: Specifies the resource types to be included during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] label_selectors: Specifies the resources with such label selectors to be included during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.bool] volume_snapshot_enabled: Whether to take volume snapshots during backup. Default to `false`. Changing this forces a new resource to be created.
        """
...
class BackupPolicyBlobStorageRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this retention rule. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[_builtins.int] priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new Backup Policy Blob Storage to be created.
        """
...
class BackupPolicyBlobStorageRetentionRuleLifeCycleArgs:
    def __init__(__self__, *,
                 ...
                 duration: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] data_store_type: The type of data store. The only possible value is `VaultStore`. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[_builtins.str] duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Blob Storage to be created.
        """
    ...
    def data_store_type(self) -> pulumi.Input[_builtins.str]:
        """
        The type of data store. The only possible value is `VaultStore`. Changing this forces a new Backup Policy Blob Storage to be created.
        """
    ...
    def data_store_type(self, value: pulumi.Input[_builtins.str]):
...
class BackupPolicyDataLakeStorageRetentionRuleArgsDict(TypedDict):
    duration: pulumi.Input[_builtins.str]
    """
...
@pulumi.input_type
class BackupPolicyDataLakeStorageRetentionRuleArgs:
    def __init__(__self__, *,
                 duration: pulumi.Input[_builtins.str],
                 name: pulumi.Input[_builtins.str],
                 absolute_criteria: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] absolute_criteria: Specifies the absolute criteria for the retention rule. Possible values include `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth`, and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] days_of_weeks: Specifies a list of days of the week on which the retention rule applies. Possible values include `Monday`, `Tuesday`, `Wednesday`, `Thursday`, `Friday`, `Saturday`, and `Sunday`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] months_of_years: Specifies a list of months of the year on which the retention rule applies. Possible values include `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November`, and `December`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] scheduled_backup_times: Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new resource to be created.
               ...
               > **Note:** At least one of `absolute_criteria` or `days_of_week` must be specified. `weeks_of_month` and `months_of_year` are optional and can be supplied together. Multiple intervals may be set using multiple `retention_rule` blocks.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] weeks_of_months: Specifies a list of weeks of the month on which the retention rule applies. Possible values include `First`, `Second`, `Third`, `Fourth`, and `Last`. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "name", name)
        if absolute_criteria is not None:
...
class BackupPolicyDiskRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] duration: Duration of deletion after given timespan. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Disk to be created.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this retention rule. Changing this forces a new Backup Policy Disk to be created.
        :param pulumi.Input[_builtins.int] priority: Retention Tag priority. Changing this forces a new Backup Policy Disk to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycleArgs:
    def __init__(__self__, *,
                 ...
                 duration: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] data_store_type: The type of data store. The only possible value is `OperationalStore`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "data_store_type", data_store_type)
        pulumi.set(__self__, "duration", duration)
...
class BackupPolicyKubernetesClusterRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name which should be used for this retention rule. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.int] priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "life_cycles", life_cycles)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyMysqlFlexibleServerDefaultRetentionRuleLifeCycleArgs:
    def __init__(__self__, *,
                 ...
                 duration: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] data_store_type: The type of data store. The only possible value is `VaultStore`. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "data_store_type", data_store_type)
        pulumi.set(__self__, "duration", duration)
...
class BackupPolicyPostgresqlRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] duration: Duration after which the backup is deleted. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[_builtins.str] name: The name which should be used for this retention rule. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[_builtins.int] priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "name", name)
