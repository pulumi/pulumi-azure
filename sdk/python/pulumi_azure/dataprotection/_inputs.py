...
__all__ = [
    ...
    'BackupInstanceKubernetesClusterBackupDatasourceParametersArgsDict',
    'BackupPolicyBlobStorageRetentionRuleArgs',
    'BackupPolicyBlobStorageRetentionRuleArgsDict',
    'BackupPolicyBlobStorageRetentionRuleCriteriaArgs',
    'BackupPolicyBlobStorageRetentionRuleCriteriaArgsDict',
    'BackupPolicyBlobStorageRetentionRuleLifeCycleArgs',
    'BackupPolicyBlobStorageRetentionRuleLifeCycleArgsDict',
    'BackupPolicyDiskRetentionRuleArgs',
    'BackupPolicyDiskRetentionRuleArgsDict',
    'BackupPolicyDiskRetentionRuleCriteriaArgs',
    'BackupPolicyDiskRetentionRuleCriteriaArgsDict',
    'BackupPolicyKubernetesClusterDefaultRetentionRuleArgs',
    'BackupPolicyKubernetesClusterDefaultRetentionRuleArgsDict',
    'BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycleArgs',
    'BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycleArgsDict',
    'BackupPolicyKubernetesClusterRetentionRuleArgs',
    'BackupPolicyKubernetesClusterRetentionRuleArgsDict',
    'BackupPolicyKubernetesClusterRetentionRuleCriteriaArgs',
    'BackupPolicyKubernetesClusterRetentionRuleCriteriaArgsDict',
    'BackupPolicyKubernetesClusterRetentionRuleLifeCycleArgs',
    'BackupPolicyKubernetesClusterRetentionRuleLifeCycleArgsDict',
    'BackupPolicyMysqlFlexibleServerDefaultRetentionRuleArgs',
    'BackupPolicyMysqlFlexibleServerDefaultRetentionRuleArgsDict',
    ...
    'BackupPolicyMysqlFlexibleServerRetentionRuleArgsDict',
    'BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaArgs',
    'BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaArgsDict',
    'BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs',
    'BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgsDict',
    'BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleArgs',
    'BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleArgsDict',
    'BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleLifeCycleArgs',
    'BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleLifeCycleArgsDict',
    'BackupPolicyPostgresqlFlexibleServerRetentionRuleArgs',
    'BackupPolicyPostgresqlFlexibleServerRetentionRuleArgsDict',
    'BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteriaArgs',
    'BackupPolicyPostgresqlFlexibleServerRetentionRuleCriteriaArgsDict',
    'BackupPolicyPostgresqlFlexibleServerRetentionRuleLifeCycleArgs',
    'BackupPolicyPostgresqlFlexibleServerRetentionRuleLifeCycleArgsDict',
    'BackupPolicyPostgresqlRetentionRuleArgs',
    'BackupPolicyPostgresqlRetentionRuleArgsDict',
    'BackupPolicyPostgresqlRetentionRuleCriteriaArgs',
    'BackupPolicyPostgresqlRetentionRuleCriteriaArgsDict',
...
if not MYPY:
    class BackupInstanceKubernetesClusterBackupDatasourceParametersArgsDict(TypedDict):
        cluster_scoped_resources_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        volume_snapshot_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BackupInstanceKubernetesClusterBackupDatasourceParametersArgs:
    def __init__(__self__, *,
                 cluster_scoped_resources_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 volume_snapshot_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] cluster_scoped_resources_enabled: Whether to include cluster scope resources during backup. Default to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_namespaces: Specifies the namespaces to be excluded during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_resource_types: Specifies the resource types to be excluded during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_namespaces: Specifies the namespaces to be included during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] included_resource_types: Specifies the resource types to be included during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] label_selectors: Specifies the resources with such label selectors to be included during backup. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] volume_snapshot_enabled: Whether to take volume snapshots during backup. Default to `false`. Changing this forces a new resource to be created.
        """
    ...
    def cluster_scoped_resources_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to include cluster scope resources during backup. Default to `false`. Changing this forces a new resource to be created.
        """
    ...
    def cluster_scoped_resources_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def volume_snapshot_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to take volume snapshots during backup. Default to `false`. Changing this forces a new resource to be created.
        """
    ...
    def volume_snapshot_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BackupPolicyBlobStorageRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this retention rule. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[builtins.int] priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new Backup Policy Blob Storage to be created.
        """
...
if not MYPY:
    class BackupPolicyBlobStorageRetentionRuleCriteriaArgsDict(TypedDict):
        absolute_criteria: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        months_of_years: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        scheduled_backup_times: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        weeks_of_months: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BackupPolicyBlobStorageRetentionRuleCriteriaArgs:
    def __init__(__self__, *,
                 absolute_criteria: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 months_of_years: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 scheduled_backup_times: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 weeks_of_months: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] absolute_criteria: Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] days_of_months: Must be between `0` and `28`. `0` for last day within the month. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days_of_weeks: Possible values are `Monday`, `Tuesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] months_of_years: Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scheduled_backup_times: Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] weeks_of_months: Possible values are `First`, `Second`, `Third`, `Fourth` and `Last`. Changing this forces a new Backup Policy Blob Storage to be created.
        """
    ...
    def absolute_criteria(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new Backup Policy Blob Storage to be created.
        """
    ...
    def absolute_criteria(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def months_of_years(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new Backup Policy Blob Storage to be created.
        """
    ...
    def months_of_years(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "months_of_years", value)

    @property
    @pulumi.getter(name="scheduledBackupTimes")
    def scheduled_backup_times(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new Backup Policy Blob Storage to be created.
        """
    ...
    def scheduled_backup_times(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BackupPolicyBlobStorageRetentionRuleLifeCycleArgs:
    def __init__(__self__, *,
                 ...
                 duration: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] data_store_type: The type of data store. The only possible value is `VaultStore`. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[builtins.str] duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Blob Storage to be created.
        """
...
class BackupPolicyDiskRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] duration: Duration of deletion after given timespan. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Disk to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this retention rule. Changing this forces a new Backup Policy Disk to be created.
        :param pulumi.Input[builtins.int] priority: Retention Tag priority. Changing this forces a new Backup Policy Disk to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyDiskRetentionRuleCriteriaArgs:
    def __init__(__self__, *,
                 absolute_criteria: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] absolute_criteria: Possible values are `FirstOfDay` and `FirstOfWeek`. Changing this forces a new Backup Policy Disk to be created.
        """
        if absolute_criteria is not None:
            pulumi.set(__self__, "absolute_criteria", absolute_criteria)
...
class BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycleArgs:
    def __init__(__self__, *,
                 ...
                 duration: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] data_store_type: The type of data store. The only possible value is `OperationalStore`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "data_store_type", data_store_type)
        pulumi.set(__self__, "duration", duration)
...
class BackupPolicyKubernetesClusterRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this retention rule. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "life_cycles", life_cycles)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyKubernetesClusterRetentionRuleCriteriaArgs:
    def __init__(__self__, *,
                 ...
                 weeks_of_months: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] absolute_criteria: Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days_of_weeks: Possible values are `Monday`, `Tuesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] months_of_years: Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scheduled_backup_times: Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] weeks_of_months: Possible values are `First`, `Second`, `Third`, `Fourth` and `Last`. Changing this forces a new resource to be created.
        """
        if absolute_criteria is not None:
            pulumi.set(__self__, "absolute_criteria", absolute_criteria)
        if days_of_weeks is not None:
...
class BackupPolicyMysqlFlexibleServerDefaultRetentionRuleArgs:
    def __init__(__self__, *,
                 life_cycles: pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerDefaultRetentionRuleLifeCycleArgs']]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerDefaultRetentionRuleLifeCycleArgs']]] life_cycles: A `life_cycle` block as defined below. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "life_cycles", life_cycles)

    @property
    @pulumi.getter(name="lifeCycles")
    def life_cycles(self) -> pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerDefaultRetentionRuleLifeCycleArgs']]]:
        """
        A `life_cycle` block as defined below. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "life_cycles")
    ...
    @life_cycles.setter
    def life_cycles(self, value: pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerDefaultRetentionRuleLifeCycleArgs']]]):
        pulumi.set(self, "life_cycles", value)
...
class BackupPolicyMysqlFlexibleServerDefaultRetentionRuleLifeCycleArgs:
    def __init__(__self__, *,
                 ...
                 duration: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] data_store_type: The type of data store. The only possible value is `VaultStore`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "data_store_type", data_store_type)
        pulumi.set(__self__, "duration", duration)
...
class BackupPolicyMysqlFlexibleServerRetentionRuleArgs:
    def __init__(__self__, *,
                 criteria: pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaArgs'],
                 life_cycles: pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs']]],
                 name: pulumi.Input[builtins.str],
                 priority: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaArgs'] criteria: A `criteria` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs']]] life_cycles: A `life_cycle` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the retention rule. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "life_cycles", life_cycles)
    ...
    @property
    @pulumi.getter
    def criteria(self) -> pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaArgs']:
        """
        A `criteria` block as defined below. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "criteria")
    ...
    @criteria.setter
    def criteria(self, value: pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleCriteriaArgs']):
        pulumi.set(self, "criteria", value)

    @property
    @pulumi.getter(name="lifeCycles")
    def life_cycles(self) -> pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs']]]:
        """
        A `life_cycle` block as defined below. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "life_cycles")
    ...
    @life_cycles.setter
    def life_cycles(self, value: pulumi.Input[Sequence[pulumi.Input['BackupPolicyMysqlFlexibleServerRetentionRuleLifeCycleArgs']]]):
        pulumi.set(self, "life_cycles", value)
...
class BackupPolicyPostgresqlRetentionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] duration: Duration after which the backup is deleted. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this retention rule. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[builtins.int] priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyPostgresqlRetentionRuleCriteriaArgs:
    def __init__(__self__, *,
                 ...
                 weeks_of_months: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] absolute_criteria: Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] days_of_weeks: Possible values are `Monday`, `Tuesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] months_of_years: Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scheduled_backup_times: Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] weeks_of_months: Possible values are `First`, `Second`, `Third`, `Fourth` and `Last`. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
        if absolute_criteria is not None:
            pulumi.set(__self__, "absolute_criteria", absolute_criteria)
        if days_of_weeks is not None:
...
class BackupVaultIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the type of Managed Service Identity that should be configured on this Backup Vault. The only possible value is `SystemAssigned`.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID for the Service Principal associated with the Identity of this Backup Vault.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Backup Vault.
        """
