...
class BackupPolicyDiskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backup_repeating_time_intervals: Specifies a list of repeating time interval. It should follow `ISO 8601` repeating time interval . Changing this forces a new Backup Policy Disk to be created.
        :param pulumi.Input[builtins.str] default_retention_duration: The duration of default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Disk to be created.
        :param pulumi.Input[builtins.str] vault_id: The ID of the Backup Vault within which the Backup Policy Disk should exist. Changing this forces a new Backup Policy Disk to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Backup Policy Disk. Changing this forces a new Backup Policy Disk to be created.
        ...
        :param pulumi.Input[builtins.str] time_zone: Specifies the Time Zone which should be used by the backup schedule. Changing this forces a new Backup Policy Disk to be created.
        """
...
class BackupPolicyDisk(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['BackupPolicyDiskRetentionRuleArgs', 'BackupPolicyDiskRetentionRuleArgsDict']]]]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPolicyDisk':
        """
