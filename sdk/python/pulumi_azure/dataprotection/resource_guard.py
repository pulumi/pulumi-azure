...
class ResourceGuardArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] resource_group_name: The name of the Resource Group where the Resource Guard should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[str] location: The Azure Region where the Resource Guard should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[str] name: The name of the Resource Guard. Changing this forces a new resource to be created.
    ...
    def vault_critical_operation_exclusion_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def vault_critical_operation_exclusion_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class ResourceGuard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            vault_critical_operation_exclusion_lists: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'ResourceGuard':
        """
    ...
    @property
    @pulumi.getter(name="vaultCriticalOperationExclusionLists")
    def vault_critical_operation_exclusion_lists(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        A list of the critical operations which are not protected by this Resource Guard.
        """
        return pulumi.get(self, "vault_critical_operation_exclusion_lists")
