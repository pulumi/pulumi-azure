...
class ResourceGuardArgs:
    def __init__(__self__, *,
                 ...
                 vault_critical_operation_exclusion_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ResourceGuard resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Resource Guard should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Resource Guard should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Resource Guard. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Resource Guard.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vault_critical_operation_exclusion_lists: A list of the critical operations which are not protected by this Resource Guard.
        """
    ...
    @property
    @pulumi.getter(name="vaultCriticalOperationExclusionLists")
    def vault_critical_operation_exclusion_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of the critical operations which are not protected by this Resource Guard.
        """
        return pulumi.get(self, "vault_critical_operation_exclusion_lists")

    @vault_critical_operation_exclusion_lists.setter
    def vault_critical_operation_exclusion_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ResourceGuard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["vault_critical_operation_exclusion_lists"] = vault_critical_operation_exclusion_lists
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vault_critical_operation_exclusion_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ResourceGuard':
        """
        ...
        __props__ = _ResourceGuardState.__new__(_ResourceGuardState)
    ...
    @property
    @pulumi.getter(name="vaultCriticalOperationExclusionLists")
    def vault_critical_operation_exclusion_lists(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of the critical operations which are not protected by this Resource Guard.
        """
        return pulumi.get(self, "vault_critical_operation_exclusion_lists")
