...
class BackupVaultArgs:
    def __init__(__self__, *,
                 ...
                 redundancy: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] datastore_type: Specifies the type of the data store. Possible values are `ArchiveStore`, `OperationalStore`, `SnapshotStore` and `VaultStore`. Changing this forces a new resource to be created.
               
               > **Note:** The `SnapshotStore` will be removed in version 4.0 as it has been replaced by `OperationalStore`.
        :param pulumi.Input[builtins.str] redundancy: Specifies the backup storage redundancy. Possible values are `GeoRedundant`, `LocallyRedundant` and `ZoneRedundant`. Changing this forces a new Backup Vault to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Backup Vault should exist. Changing this forces a new Backup Vault to be created.
        :param pulumi.Input[builtins.bool] cross_region_restore_enabled: Whether to enable cross-region restore for the Backup Vault.
        ...
        :param pulumi.Input[builtins.str] immutability: The state of immutability for this Backup Vault. Possible values are `Disabled`, `Locked`, and `Unlocked`. Defaults to `Disabled`. Changing this from `Locked` to anything else forces a new Backup Vault to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Backup Vault should exist. Changing this forces a new Backup Vault to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Backup Vault. Changing this forces a new Backup Vault to be created.
        :param pulumi.Input[builtins.float] retention_duration_in_days: The soft delete retention duration for this Backup Vault. Possible values are between `14` and `180`. Defaults to `14`.
        ...
        :param pulumi.Input[builtins.str] soft_delete: The state of soft delete for this Backup Vault. Possible values are `AlwaysOn`, `Off`, and `On`. Defaults to `On`.
               
               > **Note:** Once the `soft_delete` is set to `AlwaysOn`, the setting cannot be changed.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Backup Vault.
        """
    ...
    @property
    @pulumi.getter
    def redundancy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @redundancy.setter
    def redundancy(self, value: pulumi.Input[builtins.str]):
...
class _BackupVaultState:
    def __init__(__self__, *,
                 cross_region_restore_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 datastore_type: Optional[pulumi.Input[builtins.str]] = None,
                 identity: Optional[pulumi.Input['BackupVaultIdentityArgs']] = None,
                 immutability: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="datastoreType")
    def datastore_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the type of the data store. Possible values are `ArchiveStore`, `OperationalStore`, `SnapshotStore` and `VaultStore`. Changing this forces a new resource to be created.
    ...
    @datastore_type.setter
    def datastore_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "datastore_type", value)
...
class BackupVault(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="datastoreType")
    def datastore_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the type of the data store. Possible values are `ArchiveStore`, `OperationalStore`, `SnapshotStore` and `VaultStore`. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter
    def immutability(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The state of immutability for this Backup Vault. Possible values are `Disabled`, `Locked`, and `Unlocked`. Defaults to `Disabled`. Changing this from `Locked` to anything else forces a new Backup Vault to be created.
        """
        return pulumi.get(self, "immutability")
    ...
    @property
    @pulumi.getter
    def redundancy(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the backup storage redundancy. Possible values are `GeoRedundant`, `LocallyRedundant` and `ZoneRedundant`. Changing this forces a new Backup Vault to be created.
        """
        return pulumi.get(self, "redundancy")
    ...
    @property
    @pulumi.getter(name="retentionDurationInDays")
    def retention_duration_in_days(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The soft delete retention duration for this Backup Vault. Possible values are between `14` and `180`. Defaults to `14`.
    ...
    @property
    @pulumi.getter(name="softDelete")
    def soft_delete(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The state of soft delete for this Backup Vault. Possible values are `AlwaysOn`, `Off`, and `On`. Defaults to `On`.
