...
class BackupInstanceMysqlFlexibleServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] vault_id: The ID of the Backup Vault within which the MySQL Flexible Server Backup Instance should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[str] location: The location of the source database. Changing this forces a new resource to be created.
        :param pulumi.Input[str] name: Specifies the name of the Backup Instance for the MySQL Flexible Server. Changing this forces a new resource to be created.
        """
...
class BackupInstanceMysqlFlexibleServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            server_id: Optional[pulumi.Input[str]] = None,
            vault_id: Optional[pulumi.Input[str]] = None) -> 'BackupInstanceMysqlFlexibleServer':
        """
