...
__all__ = ['BackupInstanceMysqlFlexibleServerArgs', 'BackupInstanceMysqlFlexibleServer']
...
class BackupInstanceMysqlFlexibleServerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] server_id: The ID of the source server. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vault_id: The ID of the Backup Vault within which the MySQL Flexible Server Backup Instance should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: The location of the source database. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Backup Instance for the MySQL Flexible Server. Changing this forces a new resource to be created.
        """
...
@pulumi.input_type
class _BackupInstanceMysqlFlexibleServerState:
    def __init__(__self__, *,
...
class BackupInstanceMysqlFlexibleServer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `Microsoft.DataProtection`: 2024-04-01
        ...
        :param str resource_name: The name of the resource.
        :param BackupInstanceMysqlFlexibleServerArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BackupInstanceMysqlFlexibleServerArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BackupInstanceMysqlFlexibleServerArgs.__new__(BackupInstanceMysqlFlexibleServerArgs)
        ...
        super(BackupInstanceMysqlFlexibleServer, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            server_id: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupInstanceMysqlFlexibleServer':
        """
        ...
        __props__ = _BackupInstanceMysqlFlexibleServerState.__new__(_BackupInstanceMysqlFlexibleServerState)
        ...
        __props__.__dict__["server_id"] = server_id
        __props__.__dict__["vault_id"] = vault_id
        return BackupInstanceMysqlFlexibleServer(resource_name, opts=opts, __props__=__props__)
