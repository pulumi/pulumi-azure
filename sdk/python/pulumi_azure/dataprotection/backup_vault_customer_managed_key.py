...
class BackupVaultCustomerManagedKeyArgs:
    def __init__(__self__, *,
                 data_protection_backup_vault_id: pulumi.Input[builtins.str],
                 key_vault_key_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a BackupVaultCustomerManagedKey resource.
        :param pulumi.Input[builtins.str] data_protection_backup_vault_id: The ID of the Backup Vault. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] key_vault_key_id: The ID of the Key Vault Key which should be used to Encrypt the data in this Backup Vault.
        """
    ...
    def data_protection_backup_vault_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_protection_backup_vault_id(self, value: pulumi.Input[builtins.str]):
...
class _BackupVaultCustomerManagedKeyState:
    def __init__(__self__, *,
                 data_protection_backup_vault_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="dataProtectionBackupVaultId")
    def data_protection_backup_vault_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Backup Vault. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "data_protection_backup_vault_id")
    ...
    @data_protection_backup_vault_id.setter
    def data_protection_backup_vault_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_protection_backup_vault_id", value)
...
class BackupVaultCustomerManagedKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            data_protection_backup_vault_id: Optional[pulumi.Input[builtins.str]] = None,
            key_vault_key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupVaultCustomerManagedKey':
        """
    ...
    @property
    @pulumi.getter(name="dataProtectionBackupVaultId")
    def data_protection_backup_vault_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Backup Vault. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "data_protection_backup_vault_id")
