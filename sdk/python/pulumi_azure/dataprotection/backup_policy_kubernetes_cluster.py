...
class BackupPolicyKubernetesClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backup_repeating_time_intervals: Specifies a list of repeating time interval. It supports weekly back. It should follow `ISO 8601` repeating time interval. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Backup Policy Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vault_name: The name of the Backup Vault where the Backup Policy Kubernetes Cluster should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for the Backup Policy Kubernetes Cluster. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:dataprotection/backupPolicyKubernetesCluster:BackupPolicyKubernetesCluster")
class BackupPolicyKubernetesCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['BackupPolicyKubernetesClusterRetentionRuleArgs', 'BackupPolicyKubernetesClusterRetentionRuleArgsDict']]]]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            vault_name: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPolicyKubernetesCluster':
        """
