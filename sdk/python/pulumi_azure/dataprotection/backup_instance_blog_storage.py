...
class BackupInstanceBlogStorageArgs:
    def __init__(__self__, *,
                 ...
                 storage_account_container_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a BackupInstanceBlogStorage resource.
        :param pulumi.Input[builtins.str] backup_policy_id: The ID of the Backup Policy.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the source Storage Account. Changing this forces a new Backup Instance Blob Storage to be created.
        :param pulumi.Input[builtins.str] vault_id: The ID of the Backup Vault within which the Backup Instance Blob Storage should exist. Changing this forces a new Backup Instance Blob Storage to be created.
        :param pulumi.Input[builtins.str] location: The location of the source Storage Account. Changing this forces a new Backup Instance Blob Storage to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Backup Instance Blob Storage. Changing this forces a new Backup Instance Blob Storage to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] storage_account_container_names: The list of the container names of the source Storage Account.
    ...
    def storage_account_container_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def storage_account_container_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class BackupInstanceBlogStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_container_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupInstanceBlogStorage':
        """
    ...
    @property
    @pulumi.getter(name="storageAccountContainerNames")
    def storage_account_container_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of the container names of the source Storage Account.
