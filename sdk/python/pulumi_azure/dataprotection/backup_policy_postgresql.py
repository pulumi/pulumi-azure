...
class BackupPolicyPostgresqlArgs:
    def __init__(__self__, *,
                 ...
                 default_retention_duration: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backup_repeating_time_intervals: Specifies a list of repeating time interval. It supports weekly back. It should follow `ISO 8601` repeating time interval. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[builtins.str] default_retention_duration: The duration of default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Backup Policy PostgreSQL should exist. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[builtins.str] vault_name: The name of the Backup Vault where the Backup Policy PostgreSQL should exist. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Backup Policy PostgreSQL. Changing this forces a new Backup Policy PostgreSQL to be created.
        ...
        :param pulumi.Input[builtins.str] time_zone: Specifies the Time Zone which should be used by the backup schedule. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
    ...
    def default_retention_duration(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_retention_duration(self, value: pulumi.Input[builtins.str]):
...
class _BackupPolicyPostgresqlState:
    def __init__(__self__, *,
                 ...
                 default_retention_duration: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="defaultRetentionDuration")
    def default_retention_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The duration of default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
        return pulumi.get(self, "default_retention_duration")
    ...
    @default_retention_duration.setter
    def default_retention_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_retention_duration", value)
...
class BackupPolicyPostgresql(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            retention_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['BackupPolicyPostgresqlRetentionRuleArgs', 'BackupPolicyPostgresqlRetentionRuleArgsDict']]]]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            vault_name: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPolicyPostgresql':
        """
    ...
    @property
    @pulumi.getter(name="defaultRetentionDuration")
    def default_retention_duration(self) -> pulumi.Output[builtins.str]:
        """
        The duration of default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
        return pulumi.get(self, "default_retention_duration")
