...
class BackupInstanceKubernetesClusterBackupDatasourceParameters(dict):
    ...
    def __init__(__self__, *,
                 cluster_scoped_resources_enabled: Optional[builtins.bool] = None,
                 excluded_namespaces: Optional[Sequence[builtins.str]] = None,
                 excluded_resource_types: Optional[Sequence[builtins.str]] = None,
                 included_namespaces: Optional[Sequence[builtins.str]] = None,
                 included_resource_types: Optional[Sequence[builtins.str]] = None,
                 label_selectors: Optional[Sequence[builtins.str]] = None,
                 volume_snapshot_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool cluster_scoped_resources_enabled: Whether to include cluster scope resources during backup. Default to `false`. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] excluded_namespaces: Specifies the namespaces to be excluded during backup. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] excluded_resource_types: Specifies the resource types to be excluded during backup. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] included_namespaces: Specifies the namespaces to be included during backup. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] included_resource_types: Specifies the resource types to be included during backup. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] label_selectors: Specifies the resources with such label selectors to be included during backup. Changing this forces a new resource to be created.
        :param builtins.bool volume_snapshot_enabled: Whether to take volume snapshots during backup. Default to `false`. Changing this forces a new resource to be created.
        """
    ...
    def cluster_scoped_resources_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def excluded_resource_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_namespaces(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_resource_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def label_selectors(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def volume_snapshot_enabled(self) -> Optional[builtins.bool]:
        """
...
class BackupPolicyBlobStorageRetentionRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name which should be used for this retention rule. Changing this forces a new Backup Policy Blob Storage to be created.
        :param builtins.int priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new Backup Policy Blob Storage to be created.
        """
...
class BackupPolicyBlobStorageRetentionRuleCriteria(dict):
    ...
    def __init__(__self__, *,
                 absolute_criteria: Optional[builtins.str] = None,
                 days_of_months: Optional[Sequence[builtins.int]] = None,
                 days_of_weeks: Optional[Sequence[builtins.str]] = None,
                 months_of_years: Optional[Sequence[builtins.str]] = None,
                 scheduled_backup_times: Optional[Sequence[builtins.str]] = None,
                 weeks_of_months: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str absolute_criteria: Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new Backup Policy Blob Storage to be created.
        :param Sequence[builtins.int] days_of_months: Must be between `0` and `28`. `0` for last day within the month. Changing this forces a new Backup Policy Blob Storage to be created.
        :param Sequence[builtins.str] days_of_weeks: Possible values are `Monday`, `Tuesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`. Changing this forces a new Backup Policy Blob Storage to be created.
        :param Sequence[builtins.str] months_of_years: Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new Backup Policy Blob Storage to be created.
        :param Sequence[builtins.str] scheduled_backup_times: Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new Backup Policy Blob Storage to be created.
        :param Sequence[builtins.str] weeks_of_months: Possible values are `First`, `Second`, `Third`, `Fourth` and `Last`. Changing this forces a new Backup Policy Blob Storage to be created.
        """
    ...
    def absolute_criteria(self) -> Optional[builtins.str]:
        """
    ...
    def months_of_years(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def scheduled_backup_times(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def weeks_of_months(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BackupPolicyBlobStorageRetentionRuleLifeCycle(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_store_type: The type of data store. The only possible value is `VaultStore`. Changing this forces a new Backup Policy Blob Storage to be created.
        :param builtins.str duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Blob Storage to be created.
        """
...
class BackupPolicyDiskRetentionRule(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str duration: Duration of deletion after given timespan. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Disk to be created.
        :param builtins.str name: The name which should be used for this retention rule. Changing this forces a new Backup Policy Disk to be created.
        :param builtins.int priority: Retention Tag priority. Changing this forces a new Backup Policy Disk to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyDiskRetentionRuleCriteria(dict):
    ...
    def __init__(__self__, *,
                 absolute_criteria: Optional[builtins.str] = None):
        """
        :param builtins.str absolute_criteria: Possible values are `FirstOfDay` and `FirstOfWeek`. Changing this forces a new Backup Policy Disk to be created.
        """
        if absolute_criteria is not None:
            pulumi.set(__self__, "absolute_criteria", absolute_criteria)
...
class BackupPolicyKubernetesClusterDefaultRetentionRuleLifeCycle(dict):
    ...
    def __init__(__self__, *,
                 ...
                 duration: builtins.str):
        """
        :param builtins.str data_store_type: The type of data store. The only possible value is `OperationalStore`. Changing this forces a new resource to be created.
        :param builtins.str duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "data_store_type", data_store_type)
        pulumi.set(__self__, "duration", duration)
...
class BackupPolicyKubernetesClusterRetentionRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name which should be used for this retention rule. Changing this forces a new resource to be created.
        :param builtins.int priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "life_cycles", life_cycles)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyKubernetesClusterRetentionRuleCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weeks_of_months: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str absolute_criteria: Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] days_of_weeks: Possible values are `Monday`, `Tuesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] months_of_years: Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] scheduled_backup_times: Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new resource to be created.
        :param Sequence[builtins.str] weeks_of_months: Possible values are `First`, `Second`, `Third`, `Fourth` and `Last`. Changing this forces a new resource to be created.
        """
        if absolute_criteria is not None:
            pulumi.set(__self__, "absolute_criteria", absolute_criteria)
        if days_of_weeks is not None:
...
class BackupPolicyMysqlFlexibleServerDefaultRetentionRuleLifeCycle(dict):
    ...
    def __init__(__self__, *,
                 ...
                 duration: builtins.str):
        """
        :param builtins.str data_store_type: The type of data store. The only possible value is `VaultStore`. Changing this forces a new resource to be created.
        :param builtins.str duration: The retention duration up to which the backups are to be retained in the data stores. It should follow `ISO 8601` duration format. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "data_store_type", data_store_type)
        pulumi.set(__self__, "duration", duration)
...
class BackupPolicyMysqlFlexibleServerRetentionRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Specifies the name of the retention rule. Changing this forces a new resource to be created.
        :param builtins.int priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new resource to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "life_cycles", life_cycles)
...
class BackupPolicyPostgresqlRetentionRule(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str duration: Duration after which the backup is deleted. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param builtins.str name: The name which should be used for this retention rule. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param builtins.int priority: Specifies the priority of the rule. The priority number must be unique for each rule. The lower the priority number, the higher the priority of the rule. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
        pulumi.set(__self__, "criteria", criteria)
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "name", name)
...
class BackupPolicyPostgresqlRetentionRuleCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weeks_of_months: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str absolute_criteria: Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param Sequence[builtins.str] days_of_weeks: Possible values are `Monday`, `Tuesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param Sequence[builtins.str] months_of_years: Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param Sequence[builtins.str] scheduled_backup_times: Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new Backup Policy PostgreSQL to be created.
        :param Sequence[builtins.str] weeks_of_months: Possible values are `First`, `Second`, `Third`, `Fourth` and `Last`. Changing this forces a new Backup Policy PostgreSQL to be created.
        """
        if absolute_criteria is not None:
            pulumi.set(__self__, "absolute_criteria", absolute_criteria)
        if days_of_weeks is not None:
...
class BackupVaultIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Backup Vault. The only possible value is `SystemAssigned`.
        :param builtins.str principal_id: The Principal ID for the Service Principal associated with the Identity of this Backup Vault.
        :param builtins.str tenant_id: The Tenant ID for the Service Principal associated with the Identity of this Backup Vault.
        """
...
class GetBackupVaultIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Backup Vault.
        :param builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Backup Vault.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Backup Vault.
        """
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
        pulumi.set(__self__, "type", type)
