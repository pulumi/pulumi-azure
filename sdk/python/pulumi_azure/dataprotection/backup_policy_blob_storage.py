...
class BackupPolicyBlobStorageArgs:
    def __init__(__self__, *,
                 ...
                 operational_default_retention_duration: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vault_default_retention_duration: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BackupPolicyBlobStorage resource.
        :param pulumi.Input[builtins.str] vault_id: The ID of the Backup Vault within which the Backup Policy Blob Storage should exist. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backup_repeating_time_intervals: Specifies a list of repeating time interval. It should follow `ISO 8601` repeating time interval. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Backup Policy Blob Storage. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[builtins.str] operational_default_retention_duration: The duration of operational default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Blob Storage to be created.
        ...
        :param pulumi.Input[builtins.str] time_zone: Specifies the Time Zone which should be used by the backup schedule. Changing this forces a new Backup Policy Blob Storage to be created.
        :param pulumi.Input[builtins.str] vault_default_retention_duration: The duration of vault default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Blob Storage to be created.
    ...
    def operational_default_retention_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def operational_default_retention_duration(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vault_default_retention_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vault_default_retention_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackupPolicyBlobStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            vault_default_retention_duration: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupPolicyBlobStorage':
        """
    ...
    @property
    @pulumi.getter(name="backupRepeatingTimeIntervals")
    def backup_repeating_time_intervals(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a list of repeating time interval. It should follow `ISO 8601` repeating time interval. Changing this forces a new Backup Policy Blob Storage to be created.
        """
        return pulumi.get(self, "backup_repeating_time_intervals")
    ...
    @property
    @pulumi.getter(name="operationalDefaultRetentionDuration")
    def operational_default_retention_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The duration of operational default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Blob Storage to be created.
        """
        return pulumi.get(self, "operational_default_retention_duration")
    ...
    @property
    @pulumi.getter(name="vaultDefaultRetentionDuration")
    def vault_default_retention_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The duration of vault default retention rule. It should follow `ISO 8601` duration format. Changing this forces a new Backup Policy Blob Storage to be created.
