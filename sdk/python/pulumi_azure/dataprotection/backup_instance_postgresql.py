...
class BackupInstancePostgresqlArgs:
    def __init__(__self__, *,
                 ...
                 database_credential_key_vault_secret_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_id: The ID of the source database. Changing this forces a new Backup Instance PostgreSQL to be created.
        :param pulumi.Input[builtins.str] vault_id: The ID of the Backup Vault within which the PostgreSQL Backup Instance should exist. Changing this forces a new Backup Instance PostgreSQL to be created.
        :param pulumi.Input[builtins.str] database_credential_key_vault_secret_id: The ID or versionless ID of the key vault secret which stores the connection string of the database.
        :param pulumi.Input[builtins.str] location: The location of the source database. Changing this forces a new Backup Instance PostgreSQL to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Backup Instance PostgreSQL. Changing this forces a new Backup Instance PostgreSQL to be created.
        """
    ...
    def database_credential_key_vault_secret_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_credential_key_vault_secret_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BackupInstancePostgresql(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BackupInstancePostgresql':
        """
    ...
    @property
    @pulumi.getter(name="databaseCredentialKeyVaultSecretId")
    def database_credential_key_vault_secret_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID or versionless ID of the key vault secret which stores the connection string of the database.
        """
        return pulumi.get(self, "database_credential_key_vault_secret_id")
