...
if not MYPY:
    class StandardWebTestRequestArgsDict(TypedDict):
        ...
        """
        follow_redirects_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        parse_dependent_requests_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class StandardWebTestRequestArgs:
    def __init__(__self__, *,
                 ...
                 follow_redirects_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 parse_dependent_requests_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] url: The WebTest request URL.
        :param pulumi.Input[builtins.str] body: The WebTest request body.
        :param pulumi.Input[builtins.bool] follow_redirects_enabled: Should the following of redirects be enabled? Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] http_verb: Which HTTP verb to use for the call. Options are 'GET', 'POST', 'PUT', 'PATCH', 'DELETE', 'HEAD', and 'OPTIONS'. Defaults to `GET`.
        :param pulumi.Input[builtins.bool] parse_dependent_requests_enabled: Should the parsing of dependend requests be enabled? Defaults to `true`.
        """
    ...
    def follow_redirects_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should the following of redirects be enabled? Defaults to `true`.
        """
    ...
    def follow_redirects_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def parse_dependent_requests_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should the parsing of dependend requests be enabled? Defaults to `true`.
        """
    ...
    def parse_dependent_requests_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class StandardWebTestRequestHeaderArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for a header in the request.
        :param pulumi.Input[builtins.str] value: The value which should be used for a header in the request.
        """
...
if not MYPY:
    class StandardWebTestValidationRulesArgsDict(TypedDict):
        ...
        """
        expected_status_code: NotRequired[pulumi.Input[builtins.int]]
        """
        The expected status code of the response. Default is '200', '0' means 'response code < 400'
        """
        ssl_cert_remaining_lifetime: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        ssl_check_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class StandardWebTestValidationRulesArgs:
    def __init__(__self__, *,
                 ...
                 expected_status_code: Optional[pulumi.Input[builtins.int]] = None,
                 ssl_cert_remaining_lifetime: Optional[pulumi.Input[builtins.int]] = None,
                 ssl_check_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input['StandardWebTestValidationRulesContentArgs'] content: A `content` block as defined above.
        :param pulumi.Input[builtins.int] expected_status_code: The expected status code of the response. Default is '200', '0' means 'response code < 400'
        :param pulumi.Input[builtins.int] ssl_cert_remaining_lifetime: The number of days of SSL certificate validity remaining for the checked endpoint. If the certificate has a shorter remaining lifetime left, the test will fail. This number should be between 1 and 365.
        :param pulumi.Input[builtins.bool] ssl_check_enabled: Should the SSL check be enabled?
        """
    ...
    def expected_status_code(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The expected status code of the response. Default is '200', '0' means 'response code < 400'
        """
    ...
    def expected_status_code(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "expected_status_code", value)

    @property
    @pulumi.getter(name="sslCertRemainingLifetime")
    def ssl_cert_remaining_lifetime(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of days of SSL certificate validity remaining for the checked endpoint. If the certificate has a shorter remaining lifetime left, the test will fail. This number should be between 1 and 365.
        """
    ...
    def ssl_cert_remaining_lifetime(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ssl_cert_remaining_lifetime", value)

    @property
    @pulumi.getter(name="sslCheckEnabled")
    def ssl_check_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Should the SSL check be enabled?
        """
    ...
    def ssl_check_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ssl_check_enabled", value)


if not MYPY:
    class StandardWebTestValidationRulesContentArgsDict(TypedDict):
        content_match: pulumi.Input[builtins.str]
        """
...
class StandardWebTestValidationRulesContentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content_match: A string value containing the content to match on.
        :param pulumi.Input[builtins.bool] ignore_case: Ignore the casing in the `content_match` value.
        :param pulumi.Input[builtins.bool] pass_if_text_found: If the content of `content_match` is found, pass the test. If set to `false`, the WebTest is failing if the content of `content_match` is found.
        """
    ...
    def content_match(self) -> pulumi.Input[builtins.str]:
        """
        A string value containing the content to match on.
        """
    ...
    def content_match(self, value: pulumi.Input[builtins.str]):
...
class WorkbookIdentityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of Managed Service Identity that is configured on this Workbook. Possible values are `UserAssigned`, `SystemAssigned` and `SystemAssigned, UserAssigned`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Workbook. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Workbook.
        :param pulumi.Input[builtins.str] tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Workbook.
        """
...
class WorkbookTemplateGalleryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] order: Order of the template within the gallery. Defaults to `0`.
        :param pulumi.Input[builtins.str] resource_type: Azure resource type supported by the gallery. Defaults to `Azure Monitor`.
        :param pulumi.Input[builtins.str] type: Type of workbook supported by the workbook template. Defaults to `workbook`.
