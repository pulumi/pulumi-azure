...
class WebTestArgs:
    def __init__(__self__, *,
                 application_insights_id: pulumi.Input[builtins.str],
                 configuration: pulumi.Input[builtins.str],
                 geo_locations: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] application_insights_id: The ID of the Application Insights component on which the WebTest operates. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] configuration: An XML configuration specification for a WebTest ([see here for more information](https://docs.microsoft.com/rest/api/application-insights/webtests/createorupdate/)).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] geo_locations: A list of where to physically run the tests from to give global coverage for accessibility of your application.
               
               > **Note:** [Valid options for geo locations are described here](https://docs.microsoft.com/azure/azure-monitor/app/monitor-web-app-availability#location-population-tags)
        :param pulumi.Input[builtins.str] kind: The kind of web test that this web test watches. Choices are `ping` and `multistep`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Application Insights WebTest. Changing this forces a new resource
        :param pulumi.Input[builtins.str] description: Purpose/user defined descriptive test for this WebTest.
        :param pulumi.Input[builtins.bool] enabled: Is the test actively being monitored.
        :param pulumi.Input[builtins.int] frequency: Interval in seconds between test runs for this WebTest. Valid options are `300`, `600` and `900`. Defaults to `300`.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created. It needs to correlate with location of parent resource (azurerm_application_insights).
        :param pulumi.Input[builtins.str] name: Specifies the name of the Application Insights WebTest. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] retry_enabled: Allow for retries should this WebTest fail.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] timeout: Seconds until this WebTest will timeout and fail. Default is `30`.
        """
    ...
    def application_insights_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def application_insights_id(self, value: pulumi.Input[builtins.str]):
    ...
    def geo_locations(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def geo_locations(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _WebTestState:
    def __init__(__self__, *,
                 application_insights_id: Optional[pulumi.Input[builtins.str]] = None,
                 configuration: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 frequency: Optional[pulumi.Input[builtins.int]] = None,
                 geo_locations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="applicationInsightsId")
    def application_insights_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Application Insights component on which the WebTest operates. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "application_insights_id")
    ...
    @application_insights_id.setter
    def application_insights_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_insights_id", value)
    ...
    @property
    @pulumi.getter(name="geoLocations")
    def geo_locations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of where to physically run the tests from to give global coverage for accessibility of your application.
    ...
    @geo_locations.setter
    def geo_locations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "geo_locations", value)
    ...
    def synthetic_monitor_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "synthetic_monitor_id")

    @synthetic_monitor_id.setter
    def synthetic_monitor_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebTest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            synthetic_monitor_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None) -> 'WebTest':
        """
    ...
    @property
    @pulumi.getter(name="applicationInsightsId")
    def application_insights_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Application Insights component on which the WebTest operates. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "application_insights_id")
    ...
    @property
    @pulumi.getter(name="geoLocations")
    def geo_locations(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of where to physically run the tests from to give global coverage for accessibility of your application.
