...
class WorkbookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_json: Configuration of this particular workbook. Configuration data is a string containing valid JSON.
        :param pulumi.Input[builtins.str] display_name: Specifies the user-defined name (display name) of the workbook.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Workbook should exist. Changing this forces a new Workbook to be created.
        :param pulumi.Input[builtins.str] category: Workbook category, as defined by the user at creation time. There may be additional category types beyond the following: `workbook`, `sentinel`. Defaults to `workbook`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the workbook.
        ...
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Workbook should exist. Changing this forces a new Workbook to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of this Workbook as a UUID/GUID. It should not contain any uppercase letters. Changing this forces a new Workbook to be created.
        :param pulumi.Input[builtins.str] source_id: Resource ID for a source resource. It should not contain any uppercase letters. Defaults to `azure monitor`.
        :param pulumi.Input[builtins.str] storage_container_id: Specifies the Resource Manager ID of the Storage Container when bring your own storage is used. Changing this forces a new Workbook to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Workbook.
        """
...
class Workbook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_id: Optional[pulumi.Input[builtins.str]] = None,
            storage_container_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Workbook':
        """
    ...
    @property
    @pulumi.getter(name="storageContainerId")
    def storage_container_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the Resource Manager ID of the Storage Container when bring your own storage is used. Changing this forces a new Workbook to be created.
