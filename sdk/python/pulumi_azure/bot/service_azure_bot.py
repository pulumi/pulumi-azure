...
class ServiceAzureBotArgs:
    def __init__(__self__, *,
                 ...
                 cmk_key_vault_key_url: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 microsoft_app_msi_id: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_app_tenant_id: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_app_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] microsoft_app_id: The Microsoft Application ID for the Azure Bot Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Azure Bot Service should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku: The SKU of the Azure Bot Service. Accepted values are `F0` or `S1`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] cmk_key_vault_key_url: The CMK Key Vault Key URL that will be used to encrypt the Bot with the Customer Managed Encryption Key.
        ...
        :param pulumi.Input[builtins.str] developer_app_insights_api_key: The Application Insights API Key to associate with this Azure Bot Service.
        :param pulumi.Input[builtins.str] developer_app_insights_application_id: The resource ID of the Application Insights instance to associate with this Azure Bot Service.
        :param pulumi.Input[builtins.str] developer_app_insights_key: The Application Insight Key to associate with this Azure Bot Service.
        :param pulumi.Input[builtins.str] display_name: The name that the Azure Bot Service will be displayed as. This defaults to the value set for `name` if not specified.
        :param pulumi.Input[builtins.str] endpoint: The Azure Bot Service endpoint.
        :param pulumi.Input[builtins.str] icon_url: The Icon Url of the Azure Bot Service. Defaults to `https://docs.botframework.com/static/devportal/client/images/bot-framework-default.png`.
        :param pulumi.Input[builtins.bool] local_authentication_enabled: Is local authentication enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] location: The supported Azure location where the Azure Bot Service should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] luis_app_ids: A list of LUIS App IDs to associate with this Azure Bot Service.
        :param pulumi.Input[builtins.str] luis_key: The LUIS key to associate with this Azure Bot Service.
        :param pulumi.Input[builtins.str] microsoft_app_msi_id: The ID of the Microsoft App Managed Identity for this Azure Bot Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] microsoft_app_tenant_id: The Tenant ID of the Microsoft App for this Azure Bot Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] microsoft_app_type: The Microsoft App Type for this Azure Bot Service. Possible values are `MultiTenant`, `SingleTenant` and `UserAssignedMSI`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure Bot Service. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether public network access is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] streaming_endpoint_enabled: Is the streaming endpoint enabled for this Azure Bot Service. Defaults to `false`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to this Azure Bot Service.
        """
    ...
    def cmk_key_vault_key_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cmk_key_vault_key_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def microsoft_app_msi_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def microsoft_app_msi_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "microsoft_app_msi_id", value)

    @property
    @pulumi.getter(name="microsoftAppTenantId")
    def microsoft_app_tenant_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def microsoft_app_tenant_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "microsoft_app_tenant_id", value)

    @property
    @pulumi.getter(name="microsoftAppType")
    def microsoft_app_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def microsoft_app_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceAzureBot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sku: Optional[pulumi.Input[builtins.str]] = None,
            streaming_endpoint_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ServiceAzureBot':
        """
    ...
    @property
    @pulumi.getter(name="cmkKeyVaultKeyUrl")
    def cmk_key_vault_key_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The CMK Key Vault Key URL that will be used to encrypt the Bot with the Customer Managed Encryption Key.
    ...
    @property
    @pulumi.getter(name="microsoftAppMsiId")
    def microsoft_app_msi_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Microsoft App Managed Identity for this Azure Bot Service. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "microsoft_app_msi_id")
    ...
    @property
    @pulumi.getter(name="microsoftAppTenantId")
    def microsoft_app_tenant_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Tenant ID of the Microsoft App for this Azure Bot Service. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "microsoft_app_tenant_id")
    ...
    @property
    @pulumi.getter(name="microsoftAppType")
    def microsoft_app_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Microsoft App Type for this Azure Bot Service. Possible values are `MultiTenant`, `SingleTenant` and `UserAssignedMSI`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "microsoft_app_type")
