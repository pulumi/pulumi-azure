...
if not MYPY:
    class ChannelDirectLineSiteArgsDict(TypedDict):
        ...
        """
        endpoint_parameters_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is the endpoint parameters enabled for this site?
        """
        enhanced_authentication_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        key2: NotRequired[pulumi.Input[builtins.str]]
        """
        Secondary key for accessing this site
        """
        storage_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        user_upload_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Is the user upload enabled for this site? Defaults to `true`.
        """
        v1_allowed: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables v1 of the Directline protocol for this site. Defaults to `true`.
        """
        v3_allowed: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ChannelDirectLineSiteArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_parameters_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 enhanced_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 key2: Optional[pulumi.Input[builtins.str]] = None,
                 storage_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 trusted_origins: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 user_upload_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 v1_allowed: Optional[pulumi.Input[builtins.bool]] = None,
                 v3_allowed: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the site
        :param pulumi.Input[builtins.bool] enabled: Enables/Disables this site. Defaults to `true`.
        :param pulumi.Input[builtins.bool] endpoint_parameters_enabled: Is the endpoint parameters enabled for this site?
        :param pulumi.Input[builtins.bool] enhanced_authentication_enabled: Enables additional security measures for this site, see [Enhanced Directline Authentication Features](https://blog.botframework.com/2018/09/25/enhanced-direct-line-authentication-features). Disabled by default.
        :param pulumi.Input[builtins.str] id: Id for the site
        :param pulumi.Input[builtins.str] key: Primary key for accessing this site
        :param pulumi.Input[builtins.str] key2: Secondary key for accessing this site
        :param pulumi.Input[builtins.bool] storage_enabled: Is the storage site enabled for detailed logging? Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_origins: This field is required when `is_secure_site_enabled` is enabled. Determines which origins can establish a Directline conversation for this site.
        :param pulumi.Input[builtins.bool] user_upload_enabled: Is the user upload enabled for this site? Defaults to `true`.
        :param pulumi.Input[builtins.bool] v1_allowed: Enables v1 of the Directline protocol for this site. Defaults to `true`.
        :param pulumi.Input[builtins.bool] v3_allowed: Enables v3 of the Directline protocol for this site. Defaults to `true`.
        """
    ...
    def endpoint_parameters_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is the endpoint parameters enabled for this site?
        """
    ...
    def endpoint_parameters_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "endpoint_parameters_enabled", value)

    @property
    @pulumi.getter(name="enhancedAuthenticationEnabled")
    def enhanced_authentication_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables additional security measures for this site, see [Enhanced Directline Authentication Features](https://blog.botframework.com/2018/09/25/enhanced-direct-line-authentication-features). Disabled by default.
        """
    ...
    def enhanced_authentication_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def storage_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is the storage site enabled for detailed logging? Defaults to `true`.
        """
    ...
    def storage_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_upload_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Is the user upload enabled for this site? Defaults to `true`.
        """
    ...
    def user_upload_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "user_upload_enabled", value)

    @property
    @pulumi.getter(name="v1Allowed")
    def v1_allowed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables v1 of the Directline protocol for this site. Defaults to `true`.
        """
    ...
    @v1_allowed.setter
    def v1_allowed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "v1_allowed", value)

    @property
    @pulumi.getter(name="v3Allowed")
    def v3_allowed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables v3 of the Directline protocol for this site. Defaults to `true`.
        """
    ...
    @v3_allowed.setter
    def v3_allowed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ChannelFacebookPageArgs:
    def __init__(__self__, *,
                 ...
                 id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] access_token: The Facebook Page Access Token for the Facebook Channel.
        :param pulumi.Input[builtins.str] id: The Facebook Page ID for the Facebook Channel.
        """
...
class ChannelLineLineChannelArgs:
    def __init__(__self__, *,
                 ...
                 secret: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] access_token: The access token which is used to call the Line Channel API.
        :param pulumi.Input[builtins.str] secret: The secret which is used to access the Line Channel.
        """
        pulumi.set(__self__, "access_token", access_token)
