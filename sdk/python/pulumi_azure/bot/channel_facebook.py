...
class ChannelFacebookArgs:
    def __init__(__self__, *,
                 ...
                 facebook_application_id: pulumi.Input[builtins.str],
                 facebook_application_secret: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] facebook_application_id: The Facebook Application ID for the Facebook Channel.
        :param pulumi.Input[builtins.str] facebook_application_secret: The Facebook Application Secret for the Facebook Channel.
        :param pulumi.Input[Sequence[pulumi.Input['ChannelFacebookPageArgs']]] pages: One or more `page` blocks as defined below.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group where the Facebook Channel should be created. Changing this forces a new resource to be created.
    ...
    def facebook_application_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def facebook_application_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "facebook_application_id", value)

    @property
    @pulumi.getter(name="facebookApplicationSecret")
    def facebook_application_secret(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def facebook_application_secret(self, value: pulumi.Input[builtins.str]):
...
class _ChannelFacebookState:
    def __init__(__self__, *,
                 ...
                 facebook_application_id: Optional[pulumi.Input[builtins.str]] = None,
                 facebook_application_secret: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="facebookApplicationId")
    def facebook_application_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Facebook Application ID for the Facebook Channel.
        """
        return pulumi.get(self, "facebook_application_id")
    ...
    @facebook_application_id.setter
    def facebook_application_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "facebook_application_id", value)

    @property
    @pulumi.getter(name="facebookApplicationSecret")
    def facebook_application_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Facebook Application Secret for the Facebook Channel.
        """
        return pulumi.get(self, "facebook_application_secret")
    ...
    @facebook_application_secret.setter
    def facebook_application_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "facebook_application_secret", value)
...
class ChannelFacebook(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            location: Optional[pulumi.Input[builtins.str]] = None,
            pages: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ChannelFacebookPageArgs', 'ChannelFacebookPageArgsDict']]]]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ChannelFacebook':
        """
    ...
    @property
    @pulumi.getter(name="facebookApplicationId")
    def facebook_application_id(self) -> pulumi.Output[builtins.str]:
        """
        The Facebook Application ID for the Facebook Channel.
        """
        return pulumi.get(self, "facebook_application_id")
    ...
    @property
    @pulumi.getter(name="facebookApplicationSecret")
    def facebook_application_secret(self) -> pulumi.Output[builtins.str]:
        """
        The Facebook Application Secret for the Facebook Channel.
        """
        return pulumi.get(self, "facebook_application_secret")
