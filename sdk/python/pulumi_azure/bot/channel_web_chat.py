...
class ChannelWebChatArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group where the Web Chat Channel should be created. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:bot/channelWebChat:ChannelWebChat")
class ChannelWebChat(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def sites(self) -> pulumi.Output[Optional[Sequence['outputs.ChannelWebChatSite']]]:
        """
        A site represents a client application that you want to connect to your bot. One or more `site` blocks as defined below.
        """
        return pulumi.get(self, "sites")
