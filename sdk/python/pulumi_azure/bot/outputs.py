...
class ChannelDirectLineSite(dict):
    ...
    def __init__(__self__, *,
                 ...
                 endpoint_parameters_enabled: Optional[_builtins.bool] = None,
                 enhanced_authentication_enabled: Optional[_builtins.bool] = None,
                 id: Optional[_builtins.str] = None,
                 key: Optional[_builtins.str] = None,
                 key2: Optional[_builtins.str] = None,
                 storage_enabled: Optional[_builtins.bool] = None,
                 trusted_origins: Optional[Sequence[_builtins.str]] = None,
                 user_upload_enabled: Optional[_builtins.bool] = None,
                 v1_allowed: Optional[_builtins.bool] = None,
                 v3_allowed: Optional[_builtins.bool] = None):
        """
        :param _builtins.str name: The name of the site
        :param _builtins.bool enabled: Enables/Disables this site. Defaults to `true`.
        :param _builtins.bool endpoint_parameters_enabled: Is the endpoint parameters enabled for this site?
        :param _builtins.bool enhanced_authentication_enabled: Enables additional security measures for this site, see [Enhanced Directline Authentication Features](https://blog.botframework.com/2018/09/25/enhanced-direct-line-authentication-features). Disabled by default.
        :param _builtins.str id: Id for the site
        :param _builtins.str key: Primary key for accessing this site
        :param _builtins.str key2: Secondary key for accessing this site
        :param _builtins.bool storage_enabled: Is the storage site enabled for detailed logging? Defaults to `true`.
        :param Sequence[_builtins.str] trusted_origins: This field is required when `is_secure_site_enabled` is enabled. Determines which origins can establish a Directline conversation for this site.
        :param _builtins.bool user_upload_enabled: Is the user upload enabled for this site? Defaults to `true`.
        :param _builtins.bool v1_allowed: Enables v1 of the Directline protocol for this site. Defaults to `true`.
        :param _builtins.bool v3_allowed: Enables v3 of the Directline protocol for this site. Defaults to `true`.
        """
    ...
    def endpoint_parameters_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def enhanced_authentication_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def storage_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def user_upload_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def v1_allowed(self) -> Optional[_builtins.bool]:
        """
    ...
    def v3_allowed(self) -> Optional[_builtins.bool]:
        """
...
class ChannelFacebookPage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: _builtins.str):
        """
        :param _builtins.str access_token: The Facebook Page Access Token for the Facebook Channel.
        :param _builtins.str id: The Facebook Page ID for the Facebook Channel.
        """
...
class ChannelLineLineChannel(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str access_token: The access token which is used to call the Line Channel API.
        :param _builtins.str secret: The secret which is used to access the Line Channel.
        """
        pulumi.set(__self__, "access_token", access_token)
