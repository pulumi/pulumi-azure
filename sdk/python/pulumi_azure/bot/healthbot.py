...
class HealthbotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies The name of the Resource Group in which to create the Healthbot Service. changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: The name which should be used for the SKU of the service. Possible values are `C0`, `F0` and `S1`.
        :param pulumi.Input[builtins.str] location: Specifies The Azure Region where the resource exists. Changing this force a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies The name of the Healthbot Service resource. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the service.
        """
...
class _HealthbotState:
    def __init__(__self__, *,
                 bot_management_portal_url: Optional[pulumi.Input[builtins.str]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bot_management_portal_url: The management portal url.
        :param pulumi.Input[builtins.str] location: Specifies The Azure Region where the resource exists. Changing this force a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies The name of the Healthbot Service resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies The name of the Resource Group in which to create the Healthbot Service. changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: The name which should be used for the SKU of the service. Possible values are `C0`, `F0` and `S1`.
    ...
    def bot_management_portal_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bot_management_portal_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Healthbot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            sku_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Healthbot':
        """
    ...
    @property
    @pulumi.getter(name="botManagementPortalUrl")
    def bot_management_portal_url(self) -> pulumi.Output[builtins.str]:
        """
        The management portal url.
        """
        return pulumi.get(self, "bot_management_portal_url")
