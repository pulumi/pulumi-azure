...
class _HealthbotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: A mapping of tags which should be assigned to the service.
        """
        _HealthbotState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            bot_management_portal_url=bot_management_portal_url,
            location=location,
            name=name,
            resource_group_name=resource_group_name,
            sku_name=sku_name,
    ...
    def _configure(
        ...
        if bot_management_portal_url is not None:
            _setter("bot_management_portal_url", bot_management_portal_url)
        if location is not None:
            _setter("location", location)
        if name is not None:
            _setter("name", name)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            HealthbotArgs._configure(_setter, **kwargs)
