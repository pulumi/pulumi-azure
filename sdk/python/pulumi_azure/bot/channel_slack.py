...
class ChannelSlackArgs:
    def __init__(__self__, *,
                 ...
                 verification_token: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] client_id: The Client ID that will be used to authenticate with Slack.
        :param pulumi.Input[builtins.str] client_secret: The Client Secret that will be used to authenticate with Slack.
        ...
        :param pulumi.Input[builtins.str] verification_token: The Verification Token that will be used to authenticate with Slack.
        ...
        :param pulumi.Input[builtins.str] signing_secret: The Signing Secret that will be used to sign the requests.
        """
    ...
    def verification_token(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def verification_token(self, value: pulumi.Input[builtins.str]):
...
class ChannelSlack(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            signing_secret: Optional[pulumi.Input[builtins.str]] = None,
            verification_token: Optional[pulumi.Input[builtins.str]] = None) -> 'ChannelSlack':
        """
    ...
    @property
    @pulumi.getter(name="landingPageUrl")
    def landing_page_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Slack Landing Page URL.
        """
        return pulumi.get(self, "landing_page_url")
    ...
    @property
    @pulumi.getter(name="signingSecret")
    def signing_secret(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Signing Secret that will be used to sign the requests.
        """
        return pulumi.get(self, "signing_secret")
