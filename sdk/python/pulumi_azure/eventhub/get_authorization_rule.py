...
class GetAuthorizationRuleResult:
    ...
    @property
    @pulumi.getter
    def manage(self) -> Optional[builtins.bool]:
    ...
    @property
    @pulumi.getter
    def send(self) -> Optional[builtins.bool]:
...
def get_authorization_rule(eventhub_name: Optional[builtins.str] = None,
                           listen: Optional[builtins.bool] = None,
                           manage: Optional[builtins.bool] = None,
                           name: Optional[builtins.str] = None,
                           namespace_name: Optional[builtins.str] = None,
                           resource_group_name: Optional[builtins.str] = None,
                           send: Optional[builtins.bool] = None,
    ...
    * `Microsoft.EventHub`: 2024-01-01
    ...
    :param builtins.str namespace_name: Specifies the name of the grandparent EventHub Namespace.
    :param builtins.str resource_group_name: The name of the resource group in which the EventHub Authorization Rule's grandparent Namespace exists.
    """
    __args__ = dict()
...
def get_authorization_rule_output(eventhub_name: Optional[pulumi.Input[builtins.str]] = None,
                                  listen: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                  manage: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                  name: Optional[pulumi.Input[builtins.str]] = None,
                                  namespace_name: Optional[pulumi.Input[builtins.str]] = None,
                                  resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                                  send: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
