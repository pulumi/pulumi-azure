...
@pulumi.type_token("azure:eventhub/subscriptionRule:SubscriptionRule")
class SubscriptionRule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sqlFilter")
    def sql_filter(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Represents a filter written in SQL language-based syntax that to be evaluated against a BrokeredMessage. Required when `filter_type` is set to `SqlFilter`.
        """
        return pulumi.get(self, "sql_filter")
    ...
    @_builtins.property
    @pulumi.getter(name="sqlFilterCompatibilityLevel")
    def sql_filter_compatibility_level(self) -> pulumi.Output[_builtins.int]:
        return pulumi.get(self, "sql_filter_compatibility_level")
