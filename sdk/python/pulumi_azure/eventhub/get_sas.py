...
def get_sas(connection_string: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connection_string: The connection string for the Event Hub to which this SAS applies.
