...
class GetServiceBusNamespaceResult:
    ...
    def default_primary_connection_string(self) -> _builtins.str:
        """
    ...
    def default_primary_key(self) -> _builtins.str:
        """
    ...
    def default_secondary_connection_string(self) -> _builtins.str:
        """
    ...
    def default_secondary_key(self) -> _builtins.str:
        """
    ...
    def premium_messaging_partitions(self) -> _builtins.int:
        """
...
def get_service_bus_namespace(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ServiceBus` - 2024-01-01
    ...
    :param _builtins.str name: Specifies the name of the ServiceBus Namespace.
    :param _builtins.str resource_group_name: Specifies the name of the Resource Group where the ServiceBus Namespace exists.
    """
...
def get_service_bus_namespace_output(name: Optional[pulumi.Input[_builtins.str]] = None,
