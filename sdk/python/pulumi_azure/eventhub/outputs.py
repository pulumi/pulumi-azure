...
class EventHubCaptureDescription(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enabled: Specifies if the Capture Description is Enabled.
        :param builtins.str encoding: Specifies the Encoding used for the Capture Description. Possible values are `Avro` and `AvroDeflate`.
        :param builtins.int interval_in_seconds: Specifies the time interval in seconds at which the capture will happen. Values can be between `60` and `900` seconds. Defaults to `300` seconds.
        :param builtins.int size_limit_in_bytes: Specifies the amount of data built up in your EventHub before a Capture Operation occurs. Value should be between `10485760` and `524288000` bytes. Defaults to `314572800` bytes.
        :param builtins.bool skip_empty_archives: Specifies if empty files should not be emitted if no events occur during the Capture time window. Defaults to `false`.
        """
...
class EventHubCaptureDescriptionDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str archive_name_format: The Blob naming convention for archiving. e.g. `{Namespace}/{EventHub}/{PartitionId}/{Year}/{Month}/{Day}/{Hour}/{Minute}/{Second}`. Here all the parameters (Namespace,EventHub .. etc) are mandatory irrespective of order
        :param builtins.str blob_container_name: The name of the Container within the Blob Storage Account where messages should be archived.
        :param builtins.str name: The Name of the Destination where the capture should take place. At this time the only supported value is `EventHubArchive.AzureBlockBlob`.
        ...
        :param builtins.str storage_account_id: The ID of the Blob Storage Account where messages should be archived.
        """
...
class EventHubNamespaceIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Event Hub Namespace. Possible values are `SystemAssigned` or `UserAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this EventHub namespace.
...
class EventHubNamespaceNetworkRulesets(dict):
    ...
    def __init__(__self__, *,
                 ...
                 trusted_service_access_enabled: Optional[builtins.bool] = None,
                 virtual_network_rules: Optional[Sequence['outputs.EventHubNamespaceNetworkRulesetsVirtualNetworkRule']] = None):
        """
        :param builtins.str default_action: The default action to take when a rule is not matched. Possible values are `Allow` and `Deny`.
        :param Sequence['EventHubNamespaceNetworkRulesetsIpRuleArgs'] ip_rules: One or more `ip_rule` blocks as defined below.
        :param builtins.bool public_network_access_enabled: Is public network access enabled for the EventHub Namespace? Defaults to `true`.
               
               > **Note:** The public network access setting at the network rule sets level should be the same as it's at the namespace level.
        :param builtins.bool trusted_service_access_enabled: Whether Trusted Microsoft Services are allowed to bypass firewall.
...
class EventHubNamespaceNetworkRulesetsIpRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 action: Optional[builtins.str] = None):
        """
        :param builtins.str ip_mask: The IP mask to match on.
        :param builtins.str action: The action to take when the rule is matched. Possible values are `Allow`. Defaults to `Allow`.
        """
        pulumi.set(__self__, "ip_mask", ip_mask)
        if action is not None:
...
class EventHubNamespaceNetworkRulesetsVirtualNetworkRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ignore_missing_virtual_network_service_endpoint: Optional[builtins.bool] = None):
        """
        :param builtins.str subnet_id: The id of the subnet to match on.
        :param builtins.bool ignore_missing_virtual_network_service_endpoint: Are missing virtual network service endpoints ignored?
        """
    ...
    def ignore_missing_virtual_network_service_endpoint(self) -> Optional[builtins.bool]:
        """
