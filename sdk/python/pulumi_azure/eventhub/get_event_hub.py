...
class GetEventHubResult:
    ...
    def partition_count(self) -> builtins.int:
        """
...
def get_event_hub(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.EventHub`: 2024-01-01
    ...
    :param builtins.str name: The name of this EventHub.
    :param builtins.str namespace_name: The name of the EventHub Namespace where the EventHub exists.
    :param builtins.str resource_group_name: The name of the Resource Group where the EventHub exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_event_hub_output(name: Optional[pulumi.Input[builtins.str]] = None,
