...
class GetNamespaceResult:
    ...
    def auto_inflate_enabled(self) -> _builtins.bool:
        """
    ...
    def default_primary_connection_string_alias(self) -> _builtins.str:
        """
    ...
    def default_secondary_connection_string_alias(self) -> _builtins.str:
        """
    ...
    def kafka_enabled(self) -> _builtins.bool:
    ...
    def maximum_throughput_units(self) -> _builtins.int:
        """
...
def get_namespace(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.EventHub` - 2024-01-01
    ...
    :param _builtins.str name: The name of the EventHub Namespace.
    :param _builtins.str resource_group_name: The Name of the Resource Group where the EventHub Namespace exists.
    """
    __args__ = dict()
    __args__['name'] = name
