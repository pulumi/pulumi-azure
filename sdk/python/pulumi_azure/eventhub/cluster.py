...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the EventHub Cluster exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: The SKU name of the EventHub Cluster. The only supported value at this time is `Dedicated_1`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the EventHub Cluster resource. Changing this forces a new resource to be created.
