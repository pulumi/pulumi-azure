...
class QueueAuthorizationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] queue_id: Specifies the ID of the ServiceBus Queue. Changing this forces a new resource to be created.
               
               > **Note:** At least one of the 3 permissions below needs to be set.
        :param pulumi.Input[builtins.bool] listen: Does this Authorization Rule have Listen permissions to the ServiceBus Queue? Defaults to `false`.
        :param pulumi.Input[builtins.bool] manage: Does this Authorization Rule have Manage permissions to the ServiceBus Queue? When this property is `true` - both `listen` and `send` must be too. Defaults to `false`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Authorization Rule. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] send: Does this Authorization Rule have Send permissions to the ServiceBus Queue? Defaults to `false`.
        """
...
class _QueueAuthorizationRuleState:
    def __init__(__self__, *,
                 ...
                 primary_connection_string_alias: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 secondary_connection_string_alias: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] manage: Does this Authorization Rule have Manage permissions to the ServiceBus Queue? When this property is `true` - both `listen` and `send` must be too. Defaults to `false`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Authorization Rule. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] primary_connection_string: The Primary Connection String for the Authorization Rule.
        ...
        :param pulumi.Input[builtins.str] primary_key: The Primary Key for the Authorization Rule.
        :param pulumi.Input[builtins.str] queue_id: Specifies the ID of the ServiceBus Queue. Changing this forces a new resource to be created.
               
               > **Note:** At least one of the 3 permissions below needs to be set.
        :param pulumi.Input[builtins.str] secondary_connection_string: The Secondary Connection String for the Authorization Rule.
        ...
        :param pulumi.Input[builtins.str] secondary_key: The Secondary Key for the Authorization Rule.
        :param pulumi.Input[builtins.bool] send: Does this Authorization Rule have Send permissions to the ServiceBus Queue? Defaults to `false`.
        """
        if listen is not None:
            pulumi.set(__self__, "listen", listen)
    ...
    def primary_connection_string_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_connection_string_alias(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def secondary_connection_string_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def secondary_connection_string_alias(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("azure:eventhub/queueAuthorizationRule:QueueAuthorizationRule")
class QueueAuthorizationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_connection_string_alias: Optional[pulumi.Input[builtins.str]] = None,
            secondary_key: Optional[pulumi.Input[builtins.str]] = None,
            send: Optional[pulumi.Input[builtins.bool]] = None) -> 'QueueAuthorizationRule':
        """
    ...
    @property
    @pulumi.getter(name="primaryConnectionStringAlias")
    def primary_connection_string_alias(self) -> pulumi.Output[builtins.str]:
        """
        The alias Primary Connection String for the ServiceBus Namespace, if the namespace is Geo DR paired.
        """
        return pulumi.get(self, "primary_connection_string_alias")
    ...
    @property
    @pulumi.getter(name="secondaryConnectionStringAlias")
    def secondary_connection_string_alias(self) -> pulumi.Output[builtins.str]:
        """
        The alias Secondary Connection String for the ServiceBus Namespace
        """
        return pulumi.get(self, "secondary_connection_string_alias")
