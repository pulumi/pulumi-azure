...
class QueueAuthorizationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] send: Does this Authorization Rule have Send permissions to the ServiceBus Queue? Defaults to `false`.
        """
...
class _QueueAuthorizationRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] manage: Does this Authorization Rule have Manage permissions to the ServiceBus Queue? When this property is `true` - both `listen` and `send` must be too. Defaults to `false`.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Authorization Rule. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] primary_connection_string: The Primary Connection String for the Authorization Rule.
        ...
        :param pulumi.Input[_builtins.str] primary_key: The Primary Key for the Authorization Rule.
        :param pulumi.Input[_builtins.str] queue_id: Specifies the ID of the ServiceBus Queue. Changing this forces a new resource to be created.
               
               > **Note:** At least one of the 3 permissions below needs to be set.
        :param pulumi.Input[_builtins.str] secondary_connection_string: The Secondary Connection String for the Authorization Rule.
        ...
        :param pulumi.Input[_builtins.str] secondary_key: The Secondary Key for the Authorization Rule.
        :param pulumi.Input[_builtins.bool] send: Does this Authorization Rule have Send permissions to the ServiceBus Queue? Defaults to `false`.
        """
        if listen is not None:
            pulumi.set(__self__, "listen", listen)
...
class QueueAuthorizationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_connection_string_alias: Optional[pulumi.Input[_builtins.str]] = None,
            secondary_key: Optional[pulumi.Input[_builtins.str]] = None,
            send: Optional[pulumi.Input[_builtins.bool]] = None) -> 'QueueAuthorizationRule':
        """
