...
class NamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to Changing this forces a new resource to be created.
               create the namespace.
        :param pulumi.Input[builtins.str] sku: Defines which tier to use. Options are `Basic`, `Standard` or `Premium`. Please note that setting this field to `Premium` will force the creation of a new resource.
        :param pulumi.Input[builtins.int] capacity: Specifies the capacity. When `sku` is `Premium`, capacity can be `1`, `2`, `4`, `8` or `16`. When `sku` is `Basic` or `Standard`, capacity can be `0` only.
        ...
        :param pulumi.Input[builtins.bool] local_auth_enabled: Whether or not SAS authentication is enabled for the Service Bus namespace. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] minimum_tls_version: The minimum supported TLS version for this Service Bus Namespace. Valid values are: `1.0`, `1.1` and `1.2`. Defaults to `1.2`.
               
               > **Note:** Azure Services will require TLS 1.2+ by August 2025, please see this [announcement](https://azure.microsoft.com/en-us/updates/v2/update-retirement-tls1-0-tls1-1-versions-azure-services/) for more.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Service Bus Namespace resource . Changing this forces a new resource to be created.
        :param pulumi.Input['NamespaceNetworkRuleSetArgs'] network_rule_set: An `network_rule_set` block as defined below.
        :param pulumi.Input[builtins.int] premium_messaging_partitions: Specifies the number messaging partitions. Only valid when `sku` is `Premium` and the minimum number is `1`. Possible values include `0`, `1`, `2`, and `4`. Defaults to `0` for Standard, Basic namespace. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Is public network access enabled for the Service Bus Namespace? Defaults to `true`.
...
class _NamespaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint: The URL to access the Service Bus Namespace.
        :param pulumi.Input['NamespaceIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.bool] local_auth_enabled: Whether or not SAS authentication is enabled for the Service Bus namespace. Defaults to `true`.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] minimum_tls_version: The minimum supported TLS version for this Service Bus Namespace. Valid values are: `1.0`, `1.1` and `1.2`. Defaults to `1.2`.
...
@pulumi.type_token("azure:eventhub/namespace:Namespace")
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            sku: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Namespace':
        """
