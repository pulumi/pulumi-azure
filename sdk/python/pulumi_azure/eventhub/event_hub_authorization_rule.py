...
class EventHubAuthorizationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] listen: Does this Authorization Rule have permissions to Listen to the Event Hub? Defaults to `false`.
        :param pulumi.Input[_builtins.bool] manage: Does this Authorization Rule have permissions to Manage to the Event Hub? When this property is `true` - both `listen` and `send` must be too. Defaults to `false`.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the EventHub Authorization Rule resource. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.bool] send: Does this Authorization Rule have permissions to Send to the Event Hub? Defaults to `false`.
        """
...
class _EventHubAuthorizationRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the EventHub Authorization Rule resource. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] namespace_name: Specifies the name of the grandparent EventHub Namespace. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] primary_connection_string: The Primary Connection String for the Event Hubs authorization Rule.
        :param pulumi.Input[_builtins.str] primary_connection_string_alias: The alias of the Primary Connection String for the Event Hubs authorization Rule, which is generated when disaster recovery is enabled.
        :param pulumi.Input[_builtins.str] primary_key: The Primary Key for the Event Hubs authorization Rule.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which the EventHub Namespace exists. Changing this forces a new resource to be created.
               
               > **Note:** At least one of the 3 permissions below needs to be set.
        :param pulumi.Input[_builtins.str] secondary_connection_string: The Secondary Connection String for the Event Hubs Authorization Rule.
        :param pulumi.Input[_builtins.str] secondary_connection_string_alias: The alias of the Secondary Connection String for the Event Hubs Authorization Rule, which is generated when disaster recovery is enabled.
        :param pulumi.Input[_builtins.str] secondary_key: The Secondary Key for the Event Hubs Authorization Rule.
        :param pulumi.Input[_builtins.bool] send: Does this Authorization Rule have permissions to Send to the Event Hub? Defaults to `false`.
        """
...
class EventHubAuthorizationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_connection_string_alias: Optional[pulumi.Input[_builtins.str]] = None,
            secondary_key: Optional[pulumi.Input[_builtins.str]] = None,
            send: Optional[pulumi.Input[_builtins.bool]] = None) -> 'EventHubAuthorizationRule':
        """
