...
def get_cluster(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.EventHub`: 2024-01-01
    ...
    :param builtins.str name: The name of this EventHub Cluster.
    :param builtins.str resource_group_name: The name of the Resource Group where the EventHub Cluster exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_cluster_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    * `Microsoft.EventHub`: 2024-01-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:eventhub/getCluster:getCluster', __args__, opts=opts, typ=GetClusterResult)
