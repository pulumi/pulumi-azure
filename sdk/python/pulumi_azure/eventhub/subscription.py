...
class SubscriptionArgs:
    def __init__(__self__, *,
                 max_delivery_count: pulumi.Input[builtins.int],
                 ...
                 client_scoped_subscription_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 dead_lettering_on_filter_evaluation_error: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] max_delivery_count: The maximum number of deliveries.
        :param pulumi.Input[builtins.str] topic_id: The ID of the ServiceBus Topic to create this Subscription in. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] auto_delete_on_idle: The idle interval after which the topic is automatically deleted as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). The minimum duration is `5` minutes or `PT5M`. Defaults to `P10675199DT2H48M5.4775807S`.
        :param pulumi.Input[builtins.bool] batched_operations_enabled: Boolean flag which controls whether the Subscription supports batched operations.
        ...
        :param pulumi.Input[builtins.bool] client_scoped_subscription_enabled: whether the subscription is scoped to a client id. Defaults to `false`.
               
               > **Note:** Client Scoped Subscription can only be used for JMS subscription (Java Message Service).
        :param pulumi.Input[builtins.bool] dead_lettering_on_filter_evaluation_error: Boolean flag which controls whether the Subscription has dead letter support on filter evaluation exceptions. Defaults to `true`.
        :param pulumi.Input[builtins.bool] dead_lettering_on_message_expiration: Boolean flag which controls whether the Subscription has dead letter support when a message expires.
        :param pulumi.Input[builtins.str] default_message_ttl: The Default message timespan to live as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). This is the duration after which the message expires, starting from when the message is sent to Service Bus. This is the value used when TimeToLive is not set on a message itself. Defaults to `P10675199DT2H48M5.4775807S`.
        :param pulumi.Input[builtins.str] forward_dead_lettered_messages_to: The name of a Queue or Topic to automatically forward Dead Letter messages to.
        :param pulumi.Input[builtins.str] forward_to: The name of a Queue or Topic to automatically forward messages to.
        :param pulumi.Input[builtins.str] lock_duration: The lock duration for the subscription as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations). The default value is `1` minute or `P0DT0H1M0S` . The maximum value is `5` minutes or `P0DT0H5M0S` . Defaults to `PT1M`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the ServiceBus Subscription resource. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] requires_session: Boolean flag which controls whether this Subscription supports the concept of a session. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] status: The status of the Subscription. Possible values are `Active`,`ReceiveDisabled`, or `Disabled`. Defaults to `Active`.
        """
    ...
    def max_delivery_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def max_delivery_count(self, value: pulumi.Input[builtins.int]):
    ...
    def client_scoped_subscription_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def client_scoped_subscription_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "client_scoped_subscription_enabled", value)

    @property
    @pulumi.getter(name="deadLetteringOnFilterEvaluationError")
    def dead_lettering_on_filter_evaluation_error(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def dead_lettering_on_filter_evaluation_error(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Subscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            requires_session: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            topic_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Subscription':
        """
    ...
    @property
    @pulumi.getter(name="clientScopedSubscriptionEnabled")
    def client_scoped_subscription_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        whether the subscription is scoped to a client id. Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="deadLetteringOnFilterEvaluationError")
    def dead_lettering_on_filter_evaluation_error(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean flag which controls whether the Subscription has dead letter support on filter evaluation exceptions. Defaults to `true`.
        """
        return pulumi.get(self, "dead_lettering_on_filter_evaluation_error")
    ...
    @property
    @pulumi.getter(name="maxDeliveryCount")
    def max_delivery_count(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of deliveries.
        """
        return pulumi.get(self, "max_delivery_count")
