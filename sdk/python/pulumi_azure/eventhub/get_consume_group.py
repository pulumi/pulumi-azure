...
def get_consume_group(eventhub_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.EventHub` - 2024-01-01
    ...
    :param _builtins.str name: Specifies the name of the EventHub Consumer Group resource.
    :param _builtins.str namespace_name: Specifies the name of the grandparent EventHub Namespace.
    :param _builtins.str resource_group_name: The name of the resource group in which the EventHub Consumer Group's grandparent Namespace exists.
    """
    __args__ = dict()
...
def get_consume_group_output(eventhub_name: Optional[pulumi.Input[_builtins.str]] = None,
