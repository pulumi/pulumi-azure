...
def get_consume_group(eventhub_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.EventHub`: 2024-01-01
    ...
    :param builtins.str resource_group_name: The name of the resource group in which the EventHub Consumer Group's grandparent Namespace exists.
    """
    __args__ = dict()
...
def get_consume_group_output(eventhub_name: Optional[pulumi.Input[builtins.str]] = None,
