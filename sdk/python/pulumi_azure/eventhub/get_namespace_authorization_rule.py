...
def get_namespace_authorization_rule(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.EventHub`: 2024-01-01
    ...
    :param builtins.str resource_group_name: The name of the resource group in which the EventHub Namespace exists.
    """
    __args__ = dict()
    __args__['name'] = name
    ...
    __ret__ = pulumi.runtime.invoke('azure:eventhub/getNamespaceAuthorizationRule:getNamespaceAuthorizationRule', __args__, opts=opts, typ=GetNamespaceAuthorizationRuleResult).value
...
def get_namespace_authorization_rule_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    * `Microsoft.EventHub`: 2024-01-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:eventhub/getNamespaceAuthorizationRule:getNamespaceAuthorizationRule', __args__, opts=opts, typ=GetNamespaceAuthorizationRuleResult)
