...
def get_namespace_authorization_rule(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.EventHub` - 2024-01-01
    ...
    :param _builtins.str namespace_name: Specifies the name of the EventHub Namespace.
    :param _builtins.str resource_group_name: The name of the resource group in which the EventHub Namespace exists.
    """
    __args__ = dict()
    __args__['name'] = name
