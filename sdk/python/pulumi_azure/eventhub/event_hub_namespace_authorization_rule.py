...
class EventHubNamespaceAuthorizationRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace_name: Specifies the name of the EventHub Namespace. Changing this forces a new resource to be created.
...
class _EventHubNamespaceAuthorizationRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] primary_connection_string_alias: The alias of the Primary Connection String for the Authorization Rule, which is generated when disaster recovery is enabled.
        ...
        :param pulumi.Input[builtins.str] secondary_connection_string_alias: The alias of the Secondary Connection String for the Authorization Rule, which is generated when disaster recovery is enabled.
...
class EventHubNamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_connection_string_alias: Optional[pulumi.Input[builtins.str]] = None,
            secondary_key: Optional[pulumi.Input[builtins.str]] = None,
            send: Optional[pulumi.Input[builtins.bool]] = None) -> 'EventHubNamespaceAuthorizationRule':
        """
