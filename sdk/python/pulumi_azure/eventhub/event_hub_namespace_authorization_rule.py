...
class _EventHubNamespaceAuthorizationRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] primary_connection_string_alias: The alias of the Primary Connection String for the Authorization Rule, which is generated when disaster recovery is enabled.
        ...
        :param pulumi.Input[_builtins.str] secondary_connection_string_alias: The alias of the Secondary Connection String for the Authorization Rule, which is generated when disaster recovery is enabled.
...
class EventHubNamespaceAuthorizationRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secondary_connection_string_alias: Optional[pulumi.Input[_builtins.str]] = None,
            secondary_key: Optional[pulumi.Input[_builtins.str]] = None,
            send: Optional[pulumi.Input[_builtins.bool]] = None) -> 'EventHubNamespaceAuthorizationRule':
        """
