...
class EventHubNamespaceAuthorizationRuleArgs:
    def __init__(__self__, *,
        ...
        """
        EventHubNamespaceAuthorizationRuleArgs._configure(
...
class _EventHubNamespaceAuthorizationRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] send: Grants send access to this this Authorization Rule. Defaults to `false`.
        """
        _EventHubNamespaceAuthorizationRuleState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            listen=listen,
            manage=manage,
            name=name,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EventHubNamespaceAuthorizationRuleArgs._configure(_setter, **kwargs)
