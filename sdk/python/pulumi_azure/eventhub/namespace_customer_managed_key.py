...
class NamespaceCustomerManagedKeyInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] user_assigned_identity_id: The ID of a User Managed Identity that will be used to access Key Vaults that contain the encryption keys.
    ...
    def eventhub_namespace_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def eventhub_namespace_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "eventhub_namespace_id", value)

    @_builtins.property
    @pulumi.getter(name="keyVaultKeyIds")
    def key_vault_key_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def key_vault_key_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class NamespaceCustomerManagedKey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="eventhubNamespaceId")
    def eventhub_namespace_id(self) -> pulumi.Output[_builtins.str]:
        """
        The ID of the EventHub Namespace. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "eventhub_namespace_id")
    ...
    @_builtins.property
    @pulumi.getter(name="keyVaultKeyIds")
    def key_vault_key_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The list of keys of Key Vault.
        """
        return pulumi.get(self, "key_vault_key_ids")
