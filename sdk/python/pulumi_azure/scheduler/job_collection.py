...
class JobCollection(pulumi.CustomResource):
    ...
    """
    def __init__(__self__, resource_name, opts=None, location=None, name=None, quota=None, resource_group_name=None, sku=None, state=None, tags=None, __props__=None, __name__=None, __opts__=None):
        """
    ...
    @staticmethod
    def get(resource_name, id, opts=None, location=None, name=None, quota=None, resource_group_name=None, sku=None, state=None, tags=None):
        """
