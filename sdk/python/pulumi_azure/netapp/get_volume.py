...
class GetVolumeResult:
    ...
    """
    def __init__(__self__, account_name=None, location=None, name=None, pool_name=None, resource_group_name=None, service_level=None, storage_quota_in_gb=None, subnet_id=None, volume_path=None, id=None):
