...
class GetBackupPolicyResult:
    ...
    def daily_backups_to_keep(self) -> builtins.int:
        """
    ...
    def monthly_backups_to_keep(self) -> builtins.int:
        """
    ...
    def weekly_backups_to_keep(self) -> builtins.int:
        """
...
def get_backup_policy(account_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.NetApp`: 2025-01-01
    ...
    :param builtins.str resource_group_name: The name of the resource group where the NetApp Backup Policy exists.
    """
    __args__ = dict()
