...
class GetPoolResult:
    ...
    def size_in_tb(self) -> builtins.int:
        """
...
def get_pool(account_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.NetApp`: 2025-01-01
    ...
    :param builtins.str resource_group_name: The Name of the Resource Group where the NetApp Pool exists.
    """
    __args__ = dict()
...
def get_pool_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
