...
class BackupPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_name: The name of the NetApp account in which the NetApp Policy should be created under. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group where the NetApp Backup Policy should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] daily_backups_to_keep: Provides the number of daily backups to keep, defaults to `2` which is the minimum, maximum is 1019.
        :param pulumi.Input[builtins.bool] enabled: Whether the Backup Policy is enabled. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.int] monthly_backups_to_keep: Provides the number of monthly backups to keep, defaults to `1` which is the minimum, maximum is 1019.
               
               > **Note:** Currently, the combined (daily + weekly + monthy) retention counts cannot exceed 1019.
        :param pulumi.Input[builtins.str] name: The name of the NetApp Backup Policy. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.int] weekly_backups_to_keep: Provides the number of weekly backups to keep, defaults to `1` which is the minimum, maximum is 1019.
        """
...
class BackupPolicy(pulumi.CustomResource):
    ...
    pulumi_type = "azure:netapp/backupPolicy:BackupPolicy"
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            weekly_backups_to_keep: Optional[pulumi.Input[builtins.int]] = None) -> 'BackupPolicy':
        """
