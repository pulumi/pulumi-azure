...
def get_snapshot(account_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.NetApp`: 2025-01-01
    ...
    :param builtins.str pool_name: The name of the NetApp Pool where the NetApp Volume exists.
    :param builtins.str resource_group_name: The Name of the Resource Group where the NetApp Snapshot exists.
    :param builtins.str volume_name: The name of the NetApp Volume where the NetApp Snapshot exists.
    """
    __args__ = dict()
...
def get_snapshot_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
