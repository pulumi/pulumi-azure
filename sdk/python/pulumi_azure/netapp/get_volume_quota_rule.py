...
class GetVolumeQuotaRuleResult:
    ...
    def quota_size_in_kib(self) -> builtins.int:
        """
...
def get_volume_quota_rule(name: Optional[builtins.str] = None,
...
def get_volume_quota_rule_output(name: Optional[pulumi.Input[builtins.str]] = None,
