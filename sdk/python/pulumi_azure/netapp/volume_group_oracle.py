...
class VolumeGroupOracleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_identifier: The SAP System ID, maximum 3 characters, e.g. `OR1`. Changing this forces a new Application Volume Group to be created and data will be lost.
