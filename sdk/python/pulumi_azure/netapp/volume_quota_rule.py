...
class VolumeQuotaRuleArgs:
    def __init__(__self__, *,
                 quota_size_in_kib: pulumi.Input[builtins.int],
                 quota_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] quota_size_in_kib: Quota size in kibibytes.
        :param pulumi.Input[builtins.str] quota_type: Quota type. Possible values are `DefaultGroupQuota`, `DefaultUserQuota`, `IndividualGroupQuota` and `IndividualUserQuota`. Please note that `IndividualGroupQuota` and `DefaultGroupQuota` are not applicable to SMB and dual-protocol volumes. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] volume_id: The NetApp volume ID where the Volume Quota Rule is assigned to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Volume Quota Rule should exist. Changing this forces a new Volume Quota Rule to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Volume Quota Rule. Changing this forces a new Volume Quota Rule to be created.
        :param pulumi.Input[builtins.str] quota_target: Quota Target. This can be Unix UID/GID for NFSv3/NFSv4.1 volumes and Windows User SID for CIFS based volumes. Changing this forces a new resource to be created.
    ...
    def quota_size_in_kib(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def quota_size_in_kib(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "quota_size_in_kib", value)

    @property
    @pulumi.getter(name="quotaType")
    def quota_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @quota_type.setter
    def quota_type(self, value: pulumi.Input[builtins.str]):
...
class _VolumeQuotaRuleState:
    def __init__(__self__, *,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 quota_size_in_kib: Optional[pulumi.Input[builtins.int]] = None,
                 quota_target: Optional[pulumi.Input[builtins.str]] = None,
                 quota_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="quotaSizeInKib")
    def quota_size_in_kib(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Quota size in kibibytes.
        """
        return pulumi.get(self, "quota_size_in_kib")
    ...
    @quota_size_in_kib.setter
    def quota_size_in_kib(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "quota_size_in_kib", value)
    ...
    @property
    @pulumi.getter(name="quotaType")
    def quota_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Quota type. Possible values are `DefaultGroupQuota`, `DefaultUserQuota`, `IndividualGroupQuota` and `IndividualUserQuota`. Please note that `IndividualGroupQuota` and `DefaultGroupQuota` are not applicable to SMB and dual-protocol volumes. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "quota_type")
    ...
    @quota_type.setter
    def quota_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "quota_type", value)
...
class VolumeQuotaRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            quota_target: Optional[pulumi.Input[builtins.str]] = None,
            quota_type: Optional[pulumi.Input[builtins.str]] = None,
            volume_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeQuotaRule':
        """
    ...
    @property
    @pulumi.getter(name="quotaSizeInKib")
    def quota_size_in_kib(self) -> pulumi.Output[builtins.int]:
        """
        Quota size in kibibytes.
        """
        return pulumi.get(self, "quota_size_in_kib")
    ...
    @property
    @pulumi.getter(name="quotaType")
    def quota_type(self) -> pulumi.Output[builtins.str]:
        """
        Quota type. Possible values are `DefaultGroupQuota`, `DefaultUserQuota`, `IndividualGroupQuota` and `IndividualUserQuota`. Please note that `IndividualGroupQuota` and `DefaultGroupQuota` are not applicable to SMB and dual-protocol volumes. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "quota_type")
