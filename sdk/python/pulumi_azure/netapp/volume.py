...
class Volume(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            data_protection_replication = _utilities.configure(data_protection_replication, VolumeDataProtectionReplicationArgs, True)
            __props__.__dict__["data_protection_replication"] = data_protection_replication
            data_protection_snapshot_policy = _utilities.configure(data_protection_snapshot_policy, VolumeDataProtectionSnapshotPolicyArgs, True)
