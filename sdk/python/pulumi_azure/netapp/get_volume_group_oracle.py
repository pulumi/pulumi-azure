...
def get_volume_group_oracle(account_name: Optional[builtins.str] = None,
...
def get_volume_group_oracle_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
