...
__all__ = [
    ...
    'AwaitableGetVolumeGroupOracleResult',
    'get_volume_group_oracle',
    'get_volume_group_oracle_output',
]
...
class GetVolumeGroupOracleResult:
    ...
    @_builtins.property
    @pulumi.getter
    def volumes(self) -> Sequence['outputs.GetVolumeGroupOracleVolumeResult']:
        """
...
class AwaitableGetVolumeGroupOracleResult(GetVolumeGroupOracleResult):
...
def get_volume_group_oracle(account_name: Optional[_builtins.str] = None,
                            name: Optional[_builtins.str] = None,
                            resource_group_name: Optional[_builtins.str] = None,
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetVolumeGroupOracleResult:
    """
    ...
    * `Microsoft.NetApp` - 2025-06-01
    ...
    __ret__ = pulumi.runtime.invoke('azure:netapp/getVolumeGroupOracle:getVolumeGroupOracle', __args__, opts=opts, typ=GetVolumeGroupOracleResult).value

    return AwaitableGetVolumeGroupOracleResult(
...
def get_volume_group_oracle_output(account_name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.NetApp` - 2025-06-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:netapp/getVolumeGroupOracle:getVolumeGroupOracle', __args__, opts=opts, typ=GetVolumeGroupOracleResult)
    return __ret__.apply(lambda __response__: GetVolumeGroupOracleResult(
