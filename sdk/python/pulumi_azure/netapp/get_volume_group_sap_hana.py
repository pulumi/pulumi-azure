...
def get_volume_group_sap_hana(account_name: Optional[builtins.str] = None,
    ...
    * `Microsoft.NetApp`: 2025-01-01
    ...
    :param builtins.str resource_group_name: The name of the Resource Group where the Application Volume Group exists.
    """
    __args__ = dict()
...
def get_volume_group_sap_hana_output(account_name: Optional[pulumi.Input[builtins.str]] = None,
