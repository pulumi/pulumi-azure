...
class VolumeGroupSapHana(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = random.index.random_string.RandomString("example",
            length=12,
            special=True)
        ...
        example1 = azure.network.subnet.Subnet("example1",
        ...
        example_placement_group = azure.proximity.placement_group.PlacementGroup("example",
            ...
            location=example_resource_group.location,
            resource_group_name=example_resource_group.name)
        example_availability_set = azure.compute.availability_set.AvailabilitySet("example",
            name=f{prefix}-avset,
            location=example_resource_group.location,
            resource_group_name=example_resource_group.name,
        ...
        example_pool = azure.netapp.pool.Pool("example",
            ...
            size_in_tb=8,
            qos_type=Manual)
        example_volume_group_sap_hana = azure.netapp.volume_group_sap_hana.VolumeGroupSapHana("example",
