...
def get_backup_vault(account_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.NetApp` - 2025-06-01
    ...
    :param _builtins.str name: The name of the NetApp Backup Vault.
    :param _builtins.str resource_group_name: The name of the resource group where the NetApp Backup Vault exists.
    """
    __args__ = dict()
