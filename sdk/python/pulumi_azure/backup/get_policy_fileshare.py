...
def get_policy_fileshare(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Specifies the name of the File Share Backup Policy.
    :param builtins.str recovery_vault_name: Specifies the name of the Recovery Services Vault.
    :param builtins.str resource_group_name: The name of the resource group in which the File Share Backup Policy resides.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_policy_fileshare_output(name: Optional[pulumi.Input[builtins.str]] = None,
