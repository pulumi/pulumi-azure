...
class ContainerStorageAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] recovery_vault_name: The name of the vault where the storage account will be registered. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: Name of the resource group where the vault is located. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account to be registered Changing this forces a new resource to be created.
...
class ContainerStorageAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            recovery_vault_name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerStorageAccount':
        """
