...
class AccountCorsArgs:
    def __init__(__self__, *,
                 allowed_origins: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: A list of origins that should be allowed to make cross-origin calls.
        """
...
if not MYPY:
    class AccountDataStoreArgsDict(TypedDict):
        unique_name: pulumi.Input[builtins.str]
        """
...
class AccountDataStoreArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] unique_name: The name given to the linked Storage Account.
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account that should be linked to this Azure Maps Account.
        """
    ...
    def unique_name(self) -> pulumi.Input[builtins.str]:
        """
        The name given to the linked Storage Account.
        """
    ...
    @unique_name.setter
    def unique_name(self, value: pulumi.Input[builtins.str]):
