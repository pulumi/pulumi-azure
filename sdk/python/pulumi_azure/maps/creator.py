...
class CreatorArgs:
    def __init__(__self__, *,
                 maps_account_id: pulumi.Input[builtins.str],
                 storage_units: pulumi.Input[builtins.int],
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Creator resource.
        :param pulumi.Input[builtins.str] maps_account_id: The ID of the Azure Maps Creator. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] storage_units: The storage units to be allocated. Integer values from 1 to 100, inclusive.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Azure Maps Creator should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Azure Maps Creator. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Azure Maps Creator.
        """
    ...
    def maps_account_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def maps_account_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "maps_account_id", value)

    @property
    @pulumi.getter(name="storageUnits")
    def storage_units(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def storage_units(self, value: pulumi.Input[builtins.int]):
...
class _CreatorState:
    def __init__(__self__, *,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 maps_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 storage_units: Optional[pulumi.Input[builtins.int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="mapsAccountId")
    def maps_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Azure Maps Creator. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "maps_account_id")
    ...
    @maps_account_id.setter
    def maps_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "maps_account_id", value)
    ...
    @property
    @pulumi.getter(name="storageUnits")
    def storage_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The storage units to be allocated. Integer values from 1 to 100, inclusive.
        """
        return pulumi.get(self, "storage_units")
    ...
    @storage_units.setter
    def storage_units(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "storage_units", value)
...
class Creator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            storage_units: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Creator':
        """
    ...
    @property
    @pulumi.getter(name="mapsAccountId")
    def maps_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Azure Maps Creator. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "maps_account_id")
    ...
    @property
    @pulumi.getter(name="storageUnits")
    def storage_units(self) -> pulumi.Output[builtins.int]:
        """
        The storage units to be allocated. Integer values from 1 to 100, inclusive.
        """
        return pulumi.get(self, "storage_units")
