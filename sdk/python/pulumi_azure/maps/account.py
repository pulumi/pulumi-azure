...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the Azure Maps Account should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_name: The SKU of the Azure Maps Account. Possible values are `S0`, `S1` and `G2`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] local_authentication_enabled: Is local authentication enabled for this Azure Maps Account? When `false`, all authentication to the Azure Maps data-plane REST API is disabled, except Azure AD authentication. Defaults to `true`.
        :param pulumi.Input[builtins.str] location: The Location in which the Azure Maps Account should be provisioned. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Azure Maps Account. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Azure Maps Account.
        """
...
class _AccountState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 x_ms_client_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] location: The Location in which the Azure Maps Account should be provisioned. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Azure Maps Account. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] primary_access_key: The primary key used to authenticate and authorize access to the Maps REST APIs.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the Azure Maps Account should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] secondary_access_key: The secondary key used to authenticate and authorize access to the Maps REST APIs.
        :param pulumi.Input[builtins.str] sku_name: The SKU of the Azure Maps Account. Possible values are `S0`, `S1` and `G2`. Changing this forces a new resource to be created.
               
               > **Note:** Gen1 SKUs (`S0` and `S1`) are deprecated and can no longer be used for new deployments, which should instead use a Gen2 SKU (`G2`) - more information can be found [in the Azure documentation](https://learn.microsoft.com/azure/azure-maps/how-to-manage-pricing-tier).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Azure Maps Account.
        :param pulumi.Input[builtins.str] x_ms_client_id: A unique identifier for the Maps Account.
        """
        if cors is not None:
            pulumi.set(__self__, "cors", cors)
        if data_stores is not None:
    ...
    def x_ms_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def x_ms_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cors: Optional[pulumi.Input[Union['AccountCorsArgs', 'AccountCorsArgsDict']]] = None,
                 data_stores: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AccountDataStoreArgs', 'AccountDataStoreArgsDict']]]]] = None,
    ...
    def get(resource_name: str,
            ...
            sku_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            x_ms_client_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Account':
        """
    ...
    @property
    @pulumi.getter(name="xMsClientId")
    def x_ms_client_id(self) -> pulumi.Output[builtins.str]:
        """
        A unique identifier for the Maps Account.
        """
        return pulumi.get(self, "x_ms_client_id")
