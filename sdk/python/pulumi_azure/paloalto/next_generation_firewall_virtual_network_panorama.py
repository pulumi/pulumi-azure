...
class NextGenerationFirewallVirtualNetworkPanoramaArgs:
    def __init__(__self__, *,
                 ...
                 panorama_base64_config: pulumi.Input[builtins.str],
                 ...
                 marketplace_offer_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] panorama_base64_config: The base64 encoded configuration registration string as defined by your Panorama Server for your Cloud Device Group.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Palo Alto Next Generation Firewall Virtual Network Panorama should exist. Changing this forces a new Palo Alto Next Generation Firewall Virtual Network Panorama to be created.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Palo Alto Next Generation Firewall Virtual Network Panorama should exist. Changing this forces a new Palo Alto Next Generation Firewall Virtual Network Panorama to be created.
        :param pulumi.Input[builtins.str] marketplace_offer_id: The marketplace offer ID. Defaults to `pan_swfw_cloud_ngfw`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Palo Alto Next Generation Firewall Virtual Network Panorama. Changing this forces a new Palo Alto Next Generation Firewall Virtual Network Panorama to be created.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Palo Alto Next Generation Firewall Virtual Network Panorama.
        """
    ...
    def panorama_base64_config(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def panorama_base64_config(self, value: pulumi.Input[builtins.str]):
    ...
    def marketplace_offer_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def marketplace_offer_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NextGenerationFirewallVirtualNetworkPanoramaState:
    def __init__(__self__, *,
                 ...
                 panorama_base64_config: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="panoramaBase64Config")
    def panorama_base64_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The base64 encoded configuration registration string as defined by your Panorama Server for your Cloud Device Group.
        """
        return pulumi.get(self, "panorama_base64_config")
    ...
    @panorama_base64_config.setter
    def panorama_base64_config(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "panorama_base64_config", value)
...
class NextGenerationFirewallVirtualNetworkPanorama(pulumi.CustomResource):
    ...
    pulumi_type = "azure:paloalto/nextGenerationFirewallVirtualNetworkPanorama:NextGenerationFirewallVirtualNetworkPanorama"
    ...
    def get(resource_name: str,
            ...
            plan_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'NextGenerationFirewallVirtualNetworkPanorama':
        """
    ...
    @property
    @pulumi.getter(name="marketplaceOfferId")
    def marketplace_offer_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The marketplace offer ID. Defaults to `pan_swfw_cloud_ngfw`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "marketplace_offer_id")
    ...
    @property
    @pulumi.getter(name="panoramaBase64Config")
    def panorama_base64_config(self) -> pulumi.Output[builtins.str]:
        """
        The base64 encoded configuration registration string as defined by your Panorama Server for your Cloud Device Group.
        """
        return pulumi.get(self, "panorama_base64_config")
