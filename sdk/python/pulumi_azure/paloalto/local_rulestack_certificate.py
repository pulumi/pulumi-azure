...
class LocalRulestackCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rulestack_id: The ID of the TODO. Changing this forces a new Palo Alto Networks Rulestack Certificate to be created.
        :param pulumi.Input[builtins.str] audit_comment: The comment for Audit purposes.
        :param pulumi.Input[builtins.str] description: The description for the Certificate.
        :param pulumi.Input[builtins.str] key_vault_certificate_id: The `versionles_id` of the Key Vault Certificate to use. Changing this forces a new Palo Alto Networks Rulestack Certificate to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Palo Alto Networks Rulestack Certificate.
        :param pulumi.Input[builtins.bool] self_signed: Should a Self Signed Certificate be used. Defaults to `false`. Changing this forces a new Palo Alto Networks Rulestack Certificate to be created.
...
class LocalRulestackCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rulestack_id: Optional[pulumi.Input[builtins.str]] = None,
            self_signed: Optional[pulumi.Input[builtins.bool]] = None) -> 'LocalRulestackCertificate':
        """
