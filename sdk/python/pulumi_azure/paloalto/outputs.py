...
class LocalRulestackRuleCategory(dict):
    ...
    def custom_urls(self) -> Sequence[builtins.str]:
        """
...
class LocalRulestackRuleDestination(dict):
    ...
    def __init__(__self__, *,
                 ...
                 feeds: Optional[Sequence[builtins.str]] = None,
                 local_rulestack_fqdn_list_ids: Optional[Sequence[builtins.str]] = None,
                 local_rulestack_prefix_list_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] cidrs: Specifies a list of CIDR's.
        :param Sequence[builtins.str] countries: Specifies a list of ISO3361-1 Alpha-2 Country codes. Possible values include `AF`, `AX`, `AL`, `DZ`, `AS`, `AD`, `AO`, `AI`, `AQ`, `AG`, `AR`, `AM`, `AW`, `AU`, `AT`, `AZ`, `BS`, `BH`, `BD`, `BB`, `BY`, `BE`, `BZ`, `BJ`, `BM`, `BT`, `BO`, `BQ`, `BA`, `BW`, `BV`, `BR`, `IO`, `BN`, `BG`, `BF`, `BI`, `KH`, `CM`, `CA`, `CV`, `KY`, `CF`, `TD`, `CL`, `CN`, `CX`, `CC`, `CO`, `KM`, `CG`, `CD`, `CK`, `CR`, `CI`, `HR`, `CU`, `CW`, `CY`, `CZ`, `DK`, `DJ`, `DM`, `DO`, `EC`, `EG`, `SV`, `GQ`, `ER`, `EE`, `ET`, `FK`, `FO`, `FJ`, `FI`, `FR`, `GF`, `PF`, `TF`, `GA`, `GM`, `GE`, `DE`, `GH`, `GI`, `GR`, `GL`, `GD`, `GP`, `GU`, `GT`, `GG`, `GN`, `GW`, `GY`, `HT`, `HM`, `VA`, `HN`, `HK`, `HU`, `IS`, `IN`, `ID`, `IR`, `IQ`, `IE`, `IM`, `IL`, `IT`, `JM`, `JP`, `JE`, `JO`, `KZ`, `KE`, `KI`, `KP`, `KR`, `KW`, `KG`, `LA`, `LV`, `LB`, `LS`, `LR`, `LY`, `LI`, `LT`, `LU`, `MO`, `MK`, `MG`, `MW`, `MY`, `MV`, `ML`, `MT`, `MH`, `MQ`, `MR`, `MU`, `YT`, `MX`, `FM`, `MD`, `MC`, `MN`, `ME`, `MS`, `MA`, `MZ`, `MM`, `NA`, `NR`, `NP`, `NL`, `NC`, `NZ`, `NI`, `NE`, `NG`, `NU`, `NF`, `MP`, `NO`, `OM`, `PK`, `PW`, `PS`, `PA`, `PG`, `PY`, `PE`, `PH`, `PN`, `PL`, `PT`, `PR`, `QA`, `RE`, `RO`, `RU`, `RW`, `BL`, `SH`, `KN`, `LC`, `MF`, `PM`, `VC`, `WS`, `SM`, `ST`, `SA`, `SN`, `RS`, `SC`, `SL`, `SG`, `SX`, `SK`, `SI`, `SB`, `SO`, `ZA`, `GS`, `SS`, `ES`, `LK`, `SD`, `SR`, `SJ`, `SZ`, `SE`, `CH`, `SY`, `TW`, `TJ`, `TZ`, `TH`, `TL`, `TG`, `TK`, `TO`, `TT`, `TN`, `TR`, `TM`, `TC`, `TV`, `UG`, `UA`, `AE`, `GB`, `US`, `UM`, `UY`, `UZ`, `VU`, `VE`, `VN`, `VG`, `VI`, `WF`, `EH`, `YE`, `ZM`, `ZW`
        :param Sequence[builtins.str] feeds: Specifies a list of Feeds.
        :param Sequence[builtins.str] local_rulestack_fqdn_list_ids: Specifies a list of FQDN lists.
               
               > **Note:** This is a list of names of FQDN Lists configured on the same Local Rulestack as this Rule is being created.
        :param Sequence[builtins.str] local_rulestack_prefix_list_ids: Specifies a list of Prefix Lists.
    ...
    def local_rulestack_fqdn_list_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def local_rulestack_prefix_list_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class LocalRulestackRuleSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 local_rulestack_prefix_list_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] cidrs: Specifies a list of CIDRs.
        :param Sequence[builtins.str] countries: Specifies a list of ISO3361-1 Alpha-2 Country codes. Possible values include `AF`, `AX`, `AL`, `DZ`, `AS`, `AD`, `AO`, `AI`, `AQ`, `AG`, `AR`, `AM`, `AW`, `AU`, `AT`, `AZ`, `BS`, `BH`, `BD`, `BB`, `BY`, `BE`, `BZ`, `BJ`, `BM`, `BT`, `BO`, `BQ`, `BA`, `BW`, `BV`, `BR`, `IO`, `BN`, `BG`, `BF`, `BI`, `KH`, `CM`, `CA`, `CV`, `KY`, `CF`, `TD`, `CL`, `CN`, `CX`, `CC`, `CO`, `KM`, `CG`, `CD`, `CK`, `CR`, `CI`, `HR`, `CU`, `CW`, `CY`, `CZ`, `DK`, `DJ`, `DM`, `DO`, `EC`, `EG`, `SV`, `GQ`, `ER`, `EE`, `ET`, `FK`, `FO`, `FJ`, `FI`, `FR`, `GF`, `PF`, `TF`, `GA`, `GM`, `GE`, `DE`, `GH`, `GI`, `GR`, `GL`, `GD`, `GP`, `GU`, `GT`, `GG`, `GN`, `GW`, `GY`, `HT`, `HM`, `VA`, `HN`, `HK`, `HU`, `IS`, `IN`, `ID`, `IR`, `IQ`, `IE`, `IM`, `IL`, `IT`, `JM`, `JP`, `JE`, `JO`, `KZ`, `KE`, `KI`, `KP`, `KR`, `KW`, `KG`, `LA`, `LV`, `LB`, `LS`, `LR`, `LY`, `LI`, `LT`, `LU`, `MO`, `MK`, `MG`, `MW`, `MY`, `MV`, `ML`, `MT`, `MH`, `MQ`, `MR`, `MU`, `YT`, `MX`, `FM`, `MD`, `MC`, `MN`, `ME`, `MS`, `MA`, `MZ`, `MM`, `NA`, `NR`, `NP`, `NL`, `NC`, `NZ`, `NI`, `NE`, `NG`, `NU`, `NF`, `MP`, `NO`, `OM`, `PK`, `PW`, `PS`, `PA`, `PG`, `PY`, `PE`, `PH`, `PN`, `PL`, `PT`, `PR`, `QA`, `RE`, `RO`, `RU`, `RW`, `BL`, `SH`, `KN`, `LC`, `MF`, `PM`, `VC`, `WS`, `SM`, `ST`, `SA`, `SN`, `RS`, `SC`, `SL`, `SG`, `SX`, `SK`, `SI`, `SB`, `SO`, `ZA`, `GS`, `SS`, `ES`, `LK`, `SD`, `SR`, `SJ`, `SZ`, `SE`, `CH`, `SY`, `TW`, `TJ`, `TZ`, `TH`, `TL`, `TG`, `TK`, `TO`, `TT`, `TN`, `TR`, `TM`, `TC`, `TV`, `UG`, `UA`, `AE`, `GB`, `US`, `UM`, `UY`, `UZ`, `VU`, `VE`, `VN`, `VG`, `VI`, `WF`, `EH`, `YE`, `ZM`, `ZW`
        :param Sequence[builtins.str] feeds: Specifies a list of Feeds.
        :param Sequence[builtins.str] local_rulestack_prefix_list_ids: Specifies a list of Prefix Lists.
...
class NextGenerationFirewallVirtualHubLocalRulestackDestinationNat(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name which should be used for this NAT.
        :param builtins.str protocol: The protocol used for this Destination NAT. Possible values include `TCP` and `UDP`.
...
class NextGenerationFirewallVirtualHubLocalRulestackDestinationNatBackendConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int port: The port number to send traffic to.
        :param builtins.str public_ip_address: The Public IP Address to send the traffic to.
        """
...
class NextGenerationFirewallVirtualHubLocalRulestackDestinationNatFrontendConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int port: The port on which traffic will be receiveed.
        :param builtins.str public_ip_address_id: The ID of the Public IP Address resource the traffic will be received on.
        """
        pulumi.set(__self__, "port", port)
...
class NextGenerationFirewallVirtualHubLocalRulestackDnsSettings(dict):
    ...
    def __init__(__self__, *,
                 azure_dns_servers: Optional[Sequence[builtins.str]] = None,
                 dns_servers: Optional[Sequence[builtins.str]] = None,
                 use_azure_dns: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] dns_servers: Specifies a list of DNS servers to proxy. Conflicts with `dns_settings[0].use_azure_dns`.
        :param builtins.bool use_azure_dns: Should Azure DNS servers be used? Conflicts with `dns_settings[0].dns_servers`. Defaults to `false`.
        """
    ...
    def azure_dns_servers(self) -> Optional[Sequence[builtins.str]]:
    ...
    def use_azure_dns(self) -> Optional[builtins.bool]:
        """
...
class NextGenerationFirewallVirtualHubLocalRulestackNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 public_ip_address_ids: Sequence[builtins.str],
                 virtual_hub_id: builtins.str,
                 egress_nat_ip_address_ids: Optional[Sequence[builtins.str]] = None,
                 egress_nat_ip_addresses: Optional[Sequence[builtins.str]] = None,
                 ip_of_trust_for_user_defined_routes: Optional[builtins.str] = None,
                 public_ip_addresses: Optional[Sequence[builtins.str]] = None,
                 trusted_address_ranges: Optional[Sequence[builtins.str]] = None,
                 trusted_subnet_id: Optional[builtins.str] = None,
                 untrusted_subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.str network_virtual_appliance_id: The ID of the Palo Alto Network Virtual Appliance in the VHub. Changing this forces a new Palo Alto Next Generation Firewall VHub Local Rulestack to be created.
        :param Sequence[builtins.str] public_ip_address_ids: Specifies a list of Public IP IDs to use for this Next Generation Firewall.
        :param builtins.str virtual_hub_id: The ID of the Virtual Hub this Next generation Fireall will be deployed in. Changing this forces a new Palo Alto Next Generation Firewall VHub Local Rulestack to be created.
        :param Sequence[builtins.str] egress_nat_ip_address_ids: Specifies a list of Public IP IDs to use for Egress NAT.
        :param Sequence[builtins.str] trusted_address_ranges: Specifies a list of trusted ranges to use for the Network.
        """
    ...
    def public_ip_address_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def egress_nat_ip_address_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def egress_nat_ip_addresses(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "egress_nat_ip_addresses")

    @property
    @pulumi.getter(name="ipOfTrustForUserDefinedRoutes")
    def ip_of_trust_for_user_defined_routes(self) -> Optional[builtins.str]:
    ...
    def trusted_address_ranges(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def trusted_subnet_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "trusted_subnet_id")

    @property
    @pulumi.getter(name="untrustedSubnetId")
    def untrusted_subnet_id(self) -> Optional[builtins.str]:
...
class NextGenerationFirewallVirtualHubPanoramaNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 untrusted_subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.str network_virtual_appliance_id: The ID of the Palo Alto Network Virtual Appliance in the VHub. Changing this forces a new Palo Alto Next Generation Firewall VHub Panorama to be created.
        :param Sequence[builtins.str] public_ip_address_ids: Specifies a list of Public IP IDs to use for this Next Generation Firewall.
        :param builtins.str virtual_hub_id: The ID of the Virtual Hub this Next generation Fireall will be deployed in. Changing this forces a new Palo Alto Next Generation Firewall VHub Local Rulestack to be created.
        :param Sequence[builtins.str] egress_nat_ip_address_ids: Specifies a list of Public IP IDs to use for Egress NAT.
        :param Sequence[builtins.str] trusted_address_ranges: Specifies a list of trusted ranges to use for the Network.
...
class NextGenerationFirewallVirtualHubPanoramaPanorama(dict):
    ...
    def __init__(__self__, *,
                 ...
                 panorama_server1: Optional[builtins.str] = None,
                 panorama_server2: Optional[builtins.str] = None,
                 template_name: Optional[builtins.str] = None,
                 virtual_machine_ssh_key: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name which should be used for this Palo Alto Next Generation Firewall VHub Panorama. Changing this forces a new Palo Alto Next Generation Firewall VHub Panorama to be created.
        """
    ...
    def device_group_name(self) -> Optional[builtins.str]:
    ...
    def panorama_server1(self) -> Optional[builtins.str]:
        return pulumi.get(self, "panorama_server1")

    @property
    @pulumi.getter(name="panoramaServer2")
    def panorama_server2(self) -> Optional[builtins.str]:
    ...
    def virtual_machine_ssh_key(self) -> Optional[builtins.str]:
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNat(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name which should be used for this Destination NAT.
        :param builtins.str protocol: The Protocol for this Destination NAT configuration. Possible values include `TCP` and `UDP`.
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNatBackendConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int port: The port number to send traffic to.
        :param builtins.str public_ip_address: The IP Address to send the traffic to.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "public_ip_address", public_ip_address)
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNatFrontendConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 public_ip_address_id: builtins.str):
        """
        :param builtins.int port: The port on which to receive traffic.
        :param builtins.str public_ip_address_id: The ID of the Public IP Address on which to receive traffic. 
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 use_azure_dns: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] dns_servers: Specifies a list of DNS servers to use. Conflicts with `dns_settings[0].use_azure_dns`.
        :param builtins.bool use_azure_dns: Should the Firewall use Azure Supplied DNS servers. Conflicts with `dns_settings[0].dns_servers`. Defaults to `false`.
        """
        if azure_dns_servers is not None:
            pulumi.set(__self__, "azure_dns_servers", azure_dns_servers)
        if dns_servers is not None:
...
class NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 trusted_address_ranges: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] public_ip_address_ids: Specifies a list of Azure Public IP Address IDs.
        ...
        :param Sequence[builtins.str] egress_nat_ip_address_ids: Specifies a list of Azure Public IP Address IDs that can be used for Egress (Source) Network Address Translation.
        :param Sequence[builtins.str] trusted_address_ranges: Specifies a list of trusted ranges to use for the Network.
        """
        pulumi.set(__self__, "public_ip_address_ids", public_ip_address_ids)
...
class NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfileVnetConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 untrusted_subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.str virtual_network_id: The ID of the Virtual Network.
        :param builtins.str trusted_subnet_id: The ID of the Trust subnet.
        :param builtins.str untrusted_subnet_id: The ID of the UnTrust subnet.
        """
...
class NextGenerationFirewallVirtualNetworkPanoramaPanorama(dict):
    ...
    def __init__(__self__, *,
                 ...
                 virtual_machine_ssh_key: Optional[builtins.str] = None):
        """
        :param builtins.str device_group_name: The Device Group Name to which this Firewall Resource is registered.
        :param builtins.str host_name: The Host Name of this Firewall Resource.
        :param builtins.str name: The name which should be used for this Palo Alto Next Generation Firewall Virtual Network Panorama. Changing this forces a new Palo Alto Next Generation Firewall Virtual Network Panorama to be created.
        :param builtins.str panorama_server1: The name of the First Panorana server.
        :param builtins.str panorama_server2: The name of the Second Panorana server.
        :param builtins.str template_name: The name of the Panorama Template applied to this Firewall Resource.
        :param builtins.str virtual_machine_ssh_key: The SSH Key to connect to the Firewall Resource.
        """
        if device_group_name is not None:
            pulumi.set(__self__, "device_group_name", device_group_name)
        if host_name is not None:
