...
class LocalRulestackRuleArgs:
    def __init__(__self__, *,
                 ...
                 inspection_certificate_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 protocol_ports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a LocalRulestackRule resource.
        :param pulumi.Input[builtins.str] action: The action to take on the rule being triggered. Possible values are `Allow`, `DenyResetBoth`, `DenyResetServer` and `DenySilent`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] applications: Specifies a list of Applications.
        :param pulumi.Input['LocalRulestackRuleDestinationArgs'] destination: One or more `destination` blocks as defined below.
        :param pulumi.Input[builtins.int] priority: The Priority of this rule. Rules are executed in numerical order. Changing this forces a new Palo Alto Local Rulestack Rule to be created.
               
               > **Note:** This is the primary identifier of a rule, as such it is not possible to change the Priority of a rule once created.
        :param pulumi.Input[builtins.str] rulestack_id: The ID of the Local Rulestack in which to create this Rule. Changing this forces a new Palo Alto Local Rulestack Rule to be created.
        ...
        :param pulumi.Input[builtins.str] decryption_rule_type: The type of Decryption to perform on the rule. Possible values include `SSLInboundInspection`, `SSLOutboundInspection`, and `None`. Defaults to `None`.
        :param pulumi.Input[builtins.str] description: The description for the rule.
        :param pulumi.Input[builtins.bool] enabled: Should this Rule be enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] inspection_certificate_id: The ID of the certificate for inbound inspection. Only valid when `decryption_rule_type` is set to `SSLInboundInspection`.
        :param pulumi.Input[builtins.bool] logging_enabled: Should Logging be enabled? Defaults to `false`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Palo Alto Local Rulestack Rule.
        :param pulumi.Input[builtins.bool] negate_destination: Should the inverse of the Destination configuration be used. Defaults to `false`.
        :param pulumi.Input[builtins.bool] negate_source: Should the inverse of the Source configuration be used. Defaults to `false`.
        :param pulumi.Input[builtins.str] protocol: The Protocol and port to use in the form `[protocol]:[port_number]` e.g. `TCP:8080` or `UDP:53`. Conflicts with `protocol_ports`. Defaults to `application-default`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocol_ports: Specifies a list of Protocol:Port entries. E.g. `[ "TCP:80", "UDP:5431" ]`. Conflicts with `protocol`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Palo Alto Local Rulestack Rule.
        """
    ...
    def inspection_certificate_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inspection_certificate_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def protocol_ports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def protocol_ports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class LocalRulestackRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rulestack_id: Optional[pulumi.Input[builtins.str]] = None,
            source: Optional[pulumi.Input[Union['LocalRulestackRuleSourceArgs', 'LocalRulestackRuleSourceArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'LocalRulestackRule':
        """
    ...
    @property
    @pulumi.getter(name="inspectionCertificateId")
    def inspection_certificate_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the certificate for inbound inspection. Only valid when `decryption_rule_type` is set to `SSLInboundInspection`.
        """
        return pulumi.get(self, "inspection_certificate_id")
    ...
    @property
    @pulumi.getter(name="protocolPorts")
    def protocol_ports(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a list of Protocol:Port entries. E.g. `[ "TCP:80", "UDP:5431" ]`. Conflicts with `protocol`.
        """
        return pulumi.get(self, "protocol_ports")
