...
if not MYPY:
    class LocalRulestackRuleCategoryArgsDict(TypedDict):
        custom_urls: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class LocalRulestackRuleCategoryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_urls: Specifies a list of URL categories to match. Possible values include `abortion`, `abused-drugs`, `adult`, `alcohol-and-tobacco`, `auctions`, `business-and-economy`, `command-and-control`, `computer-and-internet-info`, `content-delivery-networks`, `copyright-infringement`, `cryptocurrency`, `dating`, `dynamic-dns`, `educational-institutions`, `entertainment-and-arts`, `extremism`, `financial-services`, `gambling`, `games`, `government`, `grayware`, `hacking`, `health-and-medicine`, `high-risk`, `home-and-garden`, `hunting-and-fishing`, `insufficient-content`, `internet-communications-and-telephony`, `internet-portals`, `job-search`, `legal`, `low-risk`, `malware`, `medium-risk`, `military`, `motor-vehicles`, `music`, `newly-registered-domain`, `news`, `not-resolved`, `nudity`, `online-storage-and-backup`, `parked`, `peer-to-peer`, `personal-sites-and-blogs`, `philosophy-and-political-advocacy`, `phishing`, `private-ip-addresses`, `proxy-avoidance-and-anonymizers`, `questionable`, `real-estate`, `real-time-detection`, `recreation-and-hobbies`, `reference-and-research`, `religion`, `search-engines`, `sex-education`, `shareware-and-freeware`, `shopping`, `social-networking`, `society`, `sports`, `stock-advice-and-tools`, `streaming-media`, `swimsuits-and-intimate-apparel`, `training-and-tools`, `translation`, `travel`, `unknown`, `weapons`, `web-advertisements`, `web-based-email`, and `web-hosting`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] feeds: Specifies a list of feeds to match.
        """
    ...
    def custom_urls(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies a list of URL categories to match. Possible values include `abortion`, `abused-drugs`, `adult`, `alcohol-and-tobacco`, `auctions`, `business-and-economy`, `command-and-control`, `computer-and-internet-info`, `content-delivery-networks`, `copyright-infringement`, `cryptocurrency`, `dating`, `dynamic-dns`, `educational-institutions`, `entertainment-and-arts`, `extremism`, `financial-services`, `gambling`, `games`, `government`, `grayware`, `hacking`, `health-and-medicine`, `high-risk`, `home-and-garden`, `hunting-and-fishing`, `insufficient-content`, `internet-communications-and-telephony`, `internet-portals`, `job-search`, `legal`, `low-risk`, `malware`, `medium-risk`, `military`, `motor-vehicles`, `music`, `newly-registered-domain`, `news`, `not-resolved`, `nudity`, `online-storage-and-backup`, `parked`, `peer-to-peer`, `personal-sites-and-blogs`, `philosophy-and-political-advocacy`, `phishing`, `private-ip-addresses`, `proxy-avoidance-and-anonymizers`, `questionable`, `real-estate`, `real-time-detection`, `recreation-and-hobbies`, `reference-and-research`, `religion`, `search-engines`, `sex-education`, `shareware-and-freeware`, `shopping`, `social-networking`, `society`, `sports`, `stock-advice-and-tools`, `streaming-media`, `swimsuits-and-intimate-apparel`, `training-and-tools`, `translation`, `travel`, `unknown`, `weapons`, `web-advertisements`, `web-based-email`, and `web-hosting`.
        """
    ...
    @custom_urls.setter
    def custom_urls(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class LocalRulestackRuleDestinationArgsDict(TypedDict):
        ...
        """
        local_rulestack_fqdn_list_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        local_rulestack_prefix_list_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class LocalRulestackRuleDestinationArgs:
    def __init__(__self__, *,
                 ...
                 feeds: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 local_rulestack_fqdn_list_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 local_rulestack_prefix_list_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidrs: Specifies a list of CIDR's.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] countries: Specifies a list of ISO3361-1 Alpha-2 Country codes. Possible values include `AF`, `AX`, `AL`, `DZ`, `AS`, `AD`, `AO`, `AI`, `AQ`, `AG`, `AR`, `AM`, `AW`, `AU`, `AT`, `AZ`, `BS`, `BH`, `BD`, `BB`, `BY`, `BE`, `BZ`, `BJ`, `BM`, `BT`, `BO`, `BQ`, `BA`, `BW`, `BV`, `BR`, `IO`, `BN`, `BG`, `BF`, `BI`, `KH`, `CM`, `CA`, `CV`, `KY`, `CF`, `TD`, `CL`, `CN`, `CX`, `CC`, `CO`, `KM`, `CG`, `CD`, `CK`, `CR`, `CI`, `HR`, `CU`, `CW`, `CY`, `CZ`, `DK`, `DJ`, `DM`, `DO`, `EC`, `EG`, `SV`, `GQ`, `ER`, `EE`, `ET`, `FK`, `FO`, `FJ`, `FI`, `FR`, `GF`, `PF`, `TF`, `GA`, `GM`, `GE`, `DE`, `GH`, `GI`, `GR`, `GL`, `GD`, `GP`, `GU`, `GT`, `GG`, `GN`, `GW`, `GY`, `HT`, `HM`, `VA`, `HN`, `HK`, `HU`, `IS`, `IN`, `ID`, `IR`, `IQ`, `IE`, `IM`, `IL`, `IT`, `JM`, `JP`, `JE`, `JO`, `KZ`, `KE`, `KI`, `KP`, `KR`, `KW`, `KG`, `LA`, `LV`, `LB`, `LS`, `LR`, `LY`, `LI`, `LT`, `LU`, `MO`, `MK`, `MG`, `MW`, `MY`, `MV`, `ML`, `MT`, `MH`, `MQ`, `MR`, `MU`, `YT`, `MX`, `FM`, `MD`, `MC`, `MN`, `ME`, `MS`, `MA`, `MZ`, `MM`, `NA`, `NR`, `NP`, `NL`, `NC`, `NZ`, `NI`, `NE`, `NG`, `NU`, `NF`, `MP`, `NO`, `OM`, `PK`, `PW`, `PS`, `PA`, `PG`, `PY`, `PE`, `PH`, `PN`, `PL`, `PT`, `PR`, `QA`, `RE`, `RO`, `RU`, `RW`, `BL`, `SH`, `KN`, `LC`, `MF`, `PM`, `VC`, `WS`, `SM`, `ST`, `SA`, `SN`, `RS`, `SC`, `SL`, `SG`, `SX`, `SK`, `SI`, `SB`, `SO`, `ZA`, `GS`, `SS`, `ES`, `LK`, `SD`, `SR`, `SJ`, `SZ`, `SE`, `CH`, `SY`, `TW`, `TJ`, `TZ`, `TH`, `TL`, `TG`, `TK`, `TO`, `TT`, `TN`, `TR`, `TM`, `TC`, `TV`, `UG`, `UA`, `AE`, `GB`, `US`, `UM`, `UY`, `UZ`, `VU`, `VE`, `VN`, `VG`, `VI`, `WF`, `EH`, `YE`, `ZM`, `ZW`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] feeds: Specifies a list of Feeds.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_rulestack_fqdn_list_ids: Specifies a list of FQDN lists.
               
               > **Note:** This is a list of names of FQDN Lists configured on the same Local Rulestack as this Rule is being created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_rulestack_prefix_list_ids: Specifies a list of Prefix Lists.
    ...
    def local_rulestack_fqdn_list_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of FQDN lists.
    ...
    def local_rulestack_fqdn_list_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "local_rulestack_fqdn_list_ids", value)

    @property
    @pulumi.getter(name="localRulestackPrefixListIds")
    def local_rulestack_prefix_list_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies a list of Prefix Lists.
    ...
    def local_rulestack_prefix_list_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class LocalRulestackRuleSourceArgs:
    def __init__(__self__, *,
                 ...
                 local_rulestack_prefix_list_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidrs: Specifies a list of CIDRs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] countries: Specifies a list of ISO3361-1 Alpha-2 Country codes. Possible values include `AF`, `AX`, `AL`, `DZ`, `AS`, `AD`, `AO`, `AI`, `AQ`, `AG`, `AR`, `AM`, `AW`, `AU`, `AT`, `AZ`, `BS`, `BH`, `BD`, `BB`, `BY`, `BE`, `BZ`, `BJ`, `BM`, `BT`, `BO`, `BQ`, `BA`, `BW`, `BV`, `BR`, `IO`, `BN`, `BG`, `BF`, `BI`, `KH`, `CM`, `CA`, `CV`, `KY`, `CF`, `TD`, `CL`, `CN`, `CX`, `CC`, `CO`, `KM`, `CG`, `CD`, `CK`, `CR`, `CI`, `HR`, `CU`, `CW`, `CY`, `CZ`, `DK`, `DJ`, `DM`, `DO`, `EC`, `EG`, `SV`, `GQ`, `ER`, `EE`, `ET`, `FK`, `FO`, `FJ`, `FI`, `FR`, `GF`, `PF`, `TF`, `GA`, `GM`, `GE`, `DE`, `GH`, `GI`, `GR`, `GL`, `GD`, `GP`, `GU`, `GT`, `GG`, `GN`, `GW`, `GY`, `HT`, `HM`, `VA`, `HN`, `HK`, `HU`, `IS`, `IN`, `ID`, `IR`, `IQ`, `IE`, `IM`, `IL`, `IT`, `JM`, `JP`, `JE`, `JO`, `KZ`, `KE`, `KI`, `KP`, `KR`, `KW`, `KG`, `LA`, `LV`, `LB`, `LS`, `LR`, `LY`, `LI`, `LT`, `LU`, `MO`, `MK`, `MG`, `MW`, `MY`, `MV`, `ML`, `MT`, `MH`, `MQ`, `MR`, `MU`, `YT`, `MX`, `FM`, `MD`, `MC`, `MN`, `ME`, `MS`, `MA`, `MZ`, `MM`, `NA`, `NR`, `NP`, `NL`, `NC`, `NZ`, `NI`, `NE`, `NG`, `NU`, `NF`, `MP`, `NO`, `OM`, `PK`, `PW`, `PS`, `PA`, `PG`, `PY`, `PE`, `PH`, `PN`, `PL`, `PT`, `PR`, `QA`, `RE`, `RO`, `RU`, `RW`, `BL`, `SH`, `KN`, `LC`, `MF`, `PM`, `VC`, `WS`, `SM`, `ST`, `SA`, `SN`, `RS`, `SC`, `SL`, `SG`, `SX`, `SK`, `SI`, `SB`, `SO`, `ZA`, `GS`, `SS`, `ES`, `LK`, `SD`, `SR`, `SJ`, `SZ`, `SE`, `CH`, `SY`, `TW`, `TJ`, `TZ`, `TH`, `TL`, `TG`, `TK`, `TO`, `TT`, `TN`, `TR`, `TM`, `TC`, `TV`, `UG`, `UA`, `AE`, `GB`, `US`, `UM`, `UY`, `UZ`, `VU`, `VE`, `VN`, `VG`, `VI`, `WF`, `EH`, `YE`, `ZM`, `ZW`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] feeds: Specifies a list of Feeds.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_rulestack_prefix_list_ids: Specifies a list of Prefix Lists.
...
class NextGenerationFirewallVirtualHubLocalRulestackDestinationNatBackendConfigArgs:
    ...
    def public_ip_address(self, value: pulumi.Input[builtins.str]):
...
class NextGenerationFirewallVirtualHubLocalRulestackDnsSettingsArgs:
    ...
    def azure_dns_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "azure_dns_servers")

    @azure_dns_servers.setter
    def azure_dns_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def use_azure_dns(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class NextGenerationFirewallVirtualHubLocalRulestackNetworkProfileArgs:
    def __init__(__self__, *,
                 ...
                 public_ip_address_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 virtual_hub_id: pulumi.Input[builtins.str],
                 egress_nat_ip_address_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 egress_nat_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ip_of_trust_for_user_defined_routes: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def network_virtual_appliance_id(self, value: pulumi.Input[builtins.str]):
    ...
    def public_ip_address_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def egress_nat_ip_address_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "egress_nat_ip_address_ids", value)

    @property
    @pulumi.getter(name="egressNatIpAddresses")
    def egress_nat_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "egress_nat_ip_addresses")

    @egress_nat_ip_addresses.setter
    def egress_nat_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "egress_nat_ip_addresses", value)

    @property
    @pulumi.getter(name="ipOfTrustForUserDefinedRoutes")
    def ip_of_trust_for_user_defined_routes(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "ip_of_trust_for_user_defined_routes")

    @ip_of_trust_for_user_defined_routes.setter
    def ip_of_trust_for_user_defined_routes(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def trusted_address_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "trusted_address_ranges", value)

    @property
    @pulumi.getter(name="trustedSubnetId")
    def trusted_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "trusted_subnet_id")

    @trusted_subnet_id.setter
    def trusted_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trusted_subnet_id", value)

    @property
    @pulumi.getter(name="untrustedSubnetId")
    def untrusted_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "untrusted_subnet_id")

    @untrusted_subnet_id.setter
    def untrusted_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class NextGenerationFirewallVirtualHubPanoramaPanoramaArgsDict(TypedDict):
        ...
        virtual_machine_ssh_key: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class NextGenerationFirewallVirtualHubPanoramaPanoramaArgs:
    def __init__(__self__, *,
                 ...
                 panorama_server1: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def panorama_server1(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "panorama_server1")

    @panorama_server1.setter
    def panorama_server1(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "panorama_server1", value)

    @property
    @pulumi.getter(name="panoramaServer2")
    def panorama_server2(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "panorama_server2")

    @panorama_server2.setter
    def panorama_server2(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def virtual_machine_ssh_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "virtual_machine_ssh_key")

    @virtual_machine_ssh_key.setter
    def virtual_machine_ssh_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNatArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name which should be used for this Destination NAT.
        :param pulumi.Input[builtins.str] protocol: The Protocol for this Destination NAT configuration. Possible values include `TCP` and `UDP`.
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNatBackendConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] port: The port number to send traffic to.
        :param pulumi.Input[builtins.str] public_ip_address: The IP Address to send the traffic to.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "public_ip_address", public_ip_address)
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDestinationNatFrontendConfigArgs:
    def __init__(__self__, *,
                 ...
                 public_ip_address_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] port: The port on which to receive traffic.
        :param pulumi.Input[builtins.str] public_ip_address_id: The ID of the Public IP Address on which to receive traffic. 
...
class NextGenerationFirewallVirtualNetworkLocalRulestackDnsSettingsArgs:
    def __init__(__self__, *,
                 ...
                 use_azure_dns: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: Specifies a list of DNS servers to use. Conflicts with `dns_settings[0].use_azure_dns`.
        :param pulumi.Input[builtins.bool] use_azure_dns: Should the Firewall use Azure Supplied DNS servers. Conflicts with `dns_settings[0].dns_servers`. Defaults to `false`.
        """
        if azure_dns_servers is not None:
            pulumi.set(__self__, "azure_dns_servers", azure_dns_servers)
        if dns_servers is not None:
...
class NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfileArgs:
    def __init__(__self__, *,
                 ...
                 trusted_address_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] public_ip_address_ids: Specifies a list of Azure Public IP Address IDs.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] egress_nat_ip_address_ids: Specifies a list of Azure Public IP Address IDs that can be used for Egress (Source) Network Address Translation.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_address_ranges: Specifies a list of trusted ranges to use for the Network.
        """
        pulumi.set(__self__, "public_ip_address_ids", public_ip_address_ids)
...
class NextGenerationFirewallVirtualNetworkLocalRulestackNetworkProfileVnetConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 untrusted_subnet_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] virtual_network_id: The ID of the Virtual Network.
        :param pulumi.Input[builtins.str] trusted_subnet_id: The ID of the Trust subnet.
        :param pulumi.Input[builtins.str] untrusted_subnet_id: The ID of the UnTrust subnet.
        """
...
class NextGenerationFirewallVirtualNetworkPanoramaPanoramaArgs:
    def __init__(__self__, *,
                 ...
                 virtual_machine_ssh_key: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] device_group_name: The Device Group Name to which this Firewall Resource is registered.
        :param pulumi.Input[builtins.str] host_name: The Host Name of this Firewall Resource.
        ...
        :param pulumi.Input[builtins.str] panorama_server1: The name of the First Panorana server.
        :param pulumi.Input[builtins.str] panorama_server2: The name of the Second Panorana server.
        :param pulumi.Input[builtins.str] template_name: The name of the Panorama Template applied to this Firewall Resource.
        :param pulumi.Input[builtins.str] virtual_machine_ssh_key: The SSH Key to connect to the Firewall Resource.
        """
        if device_group_name is not None:
            pulumi.set(__self__, "device_group_name", device_group_name)
        if host_name is not None:
