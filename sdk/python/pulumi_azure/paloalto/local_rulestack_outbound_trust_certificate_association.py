...
class LocalRulestackOutboundTrustCertificateAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_local_rulestack_certificate = azure.paloalto.local_rulestack_certificate.LocalRulestackCertificate("example",
            ...
            self_signed=True)
        example_local_rulestack_outbound_trust_certificate_association = azure.paloalto.local_rulestack_outbound_trust_certificate_association.LocalRulestackOutboundTrustCertificateAssociation("example", certificate_id=example_local_rulestack_certificate.id)
        ```
