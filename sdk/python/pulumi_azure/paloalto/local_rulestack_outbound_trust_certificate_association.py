...
class LocalRulestackOutboundTrustCertificateAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_id: The ID of the Certificate to use as the Outbound Trust Certificate. Changing this forces a new Palo Alto Networks Rulestack Outbound Trust Certificate Association to be created.
        """
...
@pulumi.type_token("azure:paloalto/localRulestackOutboundTrustCertificateAssociation:LocalRulestackOutboundTrustCertificateAssociation")
class LocalRulestackOutboundTrustCertificateAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            certificate_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LocalRulestackOutboundTrustCertificateAssociation':
        """
