...
class NextGenerationFirewallVirtualHubPanorama(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            dns_settings = _utilities.configure(dns_settings, NextGenerationFirewallVirtualHubPanoramaDnsSettingsArgs, True)
            __props__.__dict__["dns_settings"] = dns_settings
            __props__.__dict__["location"] = location
            __props__.__dict__["name"] = name
            network_profile = _utilities.configure(network_profile, NextGenerationFirewallVirtualHubPanoramaNetworkProfileArgs, True)
