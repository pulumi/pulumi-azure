...
class LocalRulestackPrefixListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix_lists: Specifies a list of Prefixes.
        :param pulumi.Input[builtins.str] rulestack_id: The ID of the Local Rulestack on which to create this Prefix List. Changing this forces a new Palo Alto Local Rulestack Prefix List to be created.
        :param pulumi.Input[builtins.str] audit_comment: The comment for Audit purposes.
        :param pulumi.Input[builtins.str] description: The description for the Prefix List.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Palo Alto Local Rulestack Prefix List.
        """
...
class LocalRulestackPrefixList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            prefix_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            rulestack_id: Optional[pulumi.Input[builtins.str]] = None) -> 'LocalRulestackPrefixList':
        """
