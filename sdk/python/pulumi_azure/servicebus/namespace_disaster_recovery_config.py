...
class NamespaceDisasterRecoveryConfigArgs:
    def __init__(__self__, *,
                 ...
                 primary_namespace_id: pulumi.Input[builtins.str],
                 alias_authorization_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a NamespaceDisasterRecoveryConfig resource.
        :param pulumi.Input[builtins.str] partner_namespace_id: The ID of the Service Bus Namespace to replicate to.
        :param pulumi.Input[builtins.str] primary_namespace_id: The ID of the primary Service Bus Namespace to replicate. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] alias_authorization_rule_id: The Shared access policies used to access the connection string for the alias.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Disaster Recovery Config. This is the alias DNS name that will be created. Changing this forces a new resource to be created.
        """
    ...
    def primary_namespace_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def primary_namespace_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "primary_namespace_id", value)

    @property
    @pulumi.getter(name="aliasAuthorizationRuleId")
    def alias_authorization_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alias_authorization_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NamespaceDisasterRecoveryConfigState:
    def __init__(__self__, *,
                 ...
                 primary_namespace_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Disaster Recovery Config. This is the alias DNS name that will be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] partner_namespace_id: The ID of the Service Bus Namespace to replicate to.
        :param pulumi.Input[builtins.str] primary_connection_string_alias: The alias Primary Connection String for the ServiceBus Namespace.
        :param pulumi.Input[builtins.str] primary_namespace_id: The ID of the primary Service Bus Namespace to replicate. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter(name="primaryNamespaceId")
    def primary_namespace_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the primary Service Bus Namespace to replicate. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "primary_namespace_id")
    ...
    @primary_namespace_id.setter
    def primary_namespace_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_namespace_id", value)
...
class NamespaceDisasterRecoveryConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            primary_connection_string_alias: Optional[pulumi.Input[builtins.str]] = None,
            primary_namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            secondary_connection_string_alias: Optional[pulumi.Input[builtins.str]] = None) -> 'NamespaceDisasterRecoveryConfig':
        """
    ...
    @property
    @pulumi.getter(name="aliasAuthorizationRuleId")
    def alias_authorization_rule_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Shared access policies used to access the connection string for the alias.
        """
        return pulumi.get(self, "alias_authorization_rule_id")
    ...
    @property
    @pulumi.getter(name="primaryNamespaceId")
    def primary_namespace_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the primary Service Bus Namespace to replicate. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "primary_namespace_id")
