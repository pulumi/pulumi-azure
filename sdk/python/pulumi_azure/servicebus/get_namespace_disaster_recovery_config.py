...
class GetNamespaceDisasterRecoveryConfigResult:
    ...
    def alias_authorization_rule_id(self) -> Optional[builtins.str]:
...
def get_namespace_disaster_recovery_config(alias_authorization_rule_id: Optional[builtins.str] = None,
    ...
    * `Microsoft.ServiceBus`: 2021-06-01-preview
    ...
    :param builtins.str namespace_id: The ID of the Service Bus Namespace.
    """
    __args__ = dict()
...
def get_namespace_disaster_recovery_config_output(alias_authorization_rule_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
