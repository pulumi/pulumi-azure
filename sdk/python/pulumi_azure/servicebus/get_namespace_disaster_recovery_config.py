...
class GetNamespaceDisasterRecoveryConfigResult:
    ...
    def alias_authorization_rule_id(self) -> Optional[_builtins.str]:
...
def get_namespace_disaster_recovery_config(alias_authorization_rule_id: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ServiceBus` - 2024-01-01
    ...
    :param _builtins.str alias_authorization_rule_id: The Shared access policies used to access the connection string for the alias.
    :param _builtins.str name: The name of this Service Bus Disaster Recovery Config.
    :param _builtins.str namespace_id: The ID of the Service Bus Namespace.
    """
    __args__ = dict()
