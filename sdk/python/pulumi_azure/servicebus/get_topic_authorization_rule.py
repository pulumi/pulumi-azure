...
def get_topic_authorization_rule(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ServiceBus` - 2024-01-01
    ...
    :param _builtins.str resource_group_name: The name of the resource group in which the ServiceBus Namespace exists.
    :param _builtins.str topic_name: The name of the ServiceBus Topic.
    """
    __args__ = dict()
    __args__['name'] = name
