...
def get_queue_authorization_rule(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.ServiceBus`: 2021-06-01-preview
    ...
    :param builtins.str queue_name: The name of the ServiceBus Queue.
    :param builtins.str resource_group_name: The name of the Resource Group where the ServiceBus Queue Authorisation Rule exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_queue_authorization_rule_output(name: Optional[pulumi.Input[builtins.str]] = None,
