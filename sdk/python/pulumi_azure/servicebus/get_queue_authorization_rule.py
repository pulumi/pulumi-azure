...
class GetQueueAuthorizationRuleResult:
    ...
    @_builtins.property
    @pulumi.getter
    def listen(self) -> _builtins.bool:
...
def get_queue_authorization_rule(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.ServiceBus` - 2024-01-01
    ...
    :param _builtins.str name: The name of this ServiceBus Queue Authorisation Rule.
    :param _builtins.str namespace_name: The name of the ServiceBus Namespace.
    :param _builtins.str queue_name: The name of the ServiceBus Queue.
    :param _builtins.str resource_group_name: The name of the Resource Group where the ServiceBus Queue Authorisation Rule exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_queue_authorization_rule_output(name: Optional[pulumi.Input[_builtins.str]] = None,
