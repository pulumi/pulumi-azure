...
class ServicesCommunicationsGatewayArgs:
    ...
    def _configure(
        ...
        if microsoft_teams_voicemail_pilot_number is None and 'microsoftTeamsVoicemailPilotNumber' in kwargs:
            microsoft_teams_voicemail_pilot_number = kwargs['microsoftTeamsVoicemailPilotNumber']
