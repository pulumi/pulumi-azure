...
class ServicesCommunicationsGatewayArgs:
    def __init__(__self__, *,
                 codecs: pulumi.Input[builtins.str],
                 connectivity: pulumi.Input[builtins.str],
                 e911_type: pulumi.Input[builtins.str],
                 ...
                 api_bridge: Optional[pulumi.Input[builtins.str]] = None,
                 auto_generated_domain_name_label_scope: Optional[pulumi.Input[builtins.str]] = None,
                 emergency_dial_strings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_teams_voicemail_pilot_number: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] codecs: The voice codecs expected for communication with Teams. Possible values are `PCMA`, `PCMU`,`G722`,`G722_2`,`SILK_8` and `SILK_16`.
        :param pulumi.Input[builtins.str] connectivity: How to connect back to the operator network, e.g. MAPS. Possible values is `PublicAddress`. Changing this forces a new Voice Services Communications Gateways to be created.
        :param pulumi.Input[builtins.str] e911_type: How to handle 911 calls. Possible values are `Standard` and `DirectToEsrp`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] platforms: The Voice Services Communications GatewaysAvailable supports platform types. Possible values are `OperatorConnect`, `TeamsPhoneMobile`.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Voice Services Communications Gateways should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] api_bridge: Details of API bridge functionality, if required.
        :param pulumi.Input[builtins.str] auto_generated_domain_name_label_scope: Specifies the scope at which the auto-generated domain name can be re-used. Possible values are `TenantReuse`, `SubscriptionReuse`, `ResourceGroupReuse` and `NoReuse` . Changing this forces a new resource to be created. Defaults to `TenantReuse`.
        ...
        :param pulumi.Input[builtins.str] location: Specifies the Azure Region where the Voice Services Communications Gateways should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] microsoft_teams_voicemail_pilot_number: This number is used in Teams Phone Mobile scenarios for access to the voicemail IVR from the native dialer.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Voice Services Communications Gateways. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] on_prem_mcp_enabled: Whether an on-premises Mobile Control Point is in use.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Voice Services Communications Gateways.
        """
    ...
    @property
    @pulumi.getter
    def codecs(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @codecs.setter
    def codecs(self, value: pulumi.Input[builtins.str]):
    ...
    def e911_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @e911_type.setter
    def e911_type(self, value: pulumi.Input[builtins.str]):
    ...
    def api_bridge(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @api_bridge.setter
    def api_bridge(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_bridge", value)

    @property
    @pulumi.getter(name="autoGeneratedDomainNameLabelScope")
    def auto_generated_domain_name_label_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_generated_domain_name_label_scope(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def microsoft_teams_voicemail_pilot_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def microsoft_teams_voicemail_pilot_number(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServicesCommunicationsGatewayState:
    def __init__(__self__, *,
                 api_bridge: Optional[pulumi.Input[builtins.str]] = None,
                 auto_generated_domain_name_label_scope: Optional[pulumi.Input[builtins.str]] = None,
                 codecs: Optional[pulumi.Input[builtins.str]] = None,
                 connectivity: Optional[pulumi.Input[builtins.str]] = None,
                 e911_type: Optional[pulumi.Input[builtins.str]] = None,
                 emergency_dial_strings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 microsoft_teams_voicemail_pilot_number: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def codecs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The voice codecs expected for communication with Teams. Possible values are `PCMA`, `PCMU`,`G722`,`G722_2`,`SILK_8` and `SILK_16`.
        """
        return pulumi.get(self, "codecs")
    ...
    @codecs.setter
    def codecs(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "codecs", value)
    ...
    @property
    @pulumi.getter(name="e911Type")
    def e911_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        How to handle 911 calls. Possible values are `Standard` and `DirectToEsrp`.
        """
        return pulumi.get(self, "e911_type")
    ...
    @e911_type.setter
    def e911_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "e911_type", value)
...
class ServicesCommunicationsGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            service_locations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ServicesCommunicationsGatewayServiceLocationArgs', 'ServicesCommunicationsGatewayServiceLocationArgsDict']]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ServicesCommunicationsGateway':
        """
    ...
    @property
    @pulumi.getter(name="apiBridge")
    def api_bridge(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Details of API bridge functionality, if required.
        """
        return pulumi.get(self, "api_bridge")
    ...
    @property
    @pulumi.getter
    def codecs(self) -> pulumi.Output[builtins.str]:
        """
        The voice codecs expected for communication with Teams. Possible values are `PCMA`, `PCMU`,`G722`,`G722_2`,`SILK_8` and `SILK_16`.
        """
        return pulumi.get(self, "codecs")
    ...
    @property
    @pulumi.getter(name="microsoftTeamsVoicemailPilotNumber")
    def microsoft_teams_voicemail_pilot_number(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        This number is used in Teams Phone Mobile scenarios for access to the voicemail IVR from the native dialer.
        """
        return pulumi.get(self, "microsoft_teams_voicemail_pilot_number")
