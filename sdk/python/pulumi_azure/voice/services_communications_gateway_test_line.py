...
class ServicesCommunicationsGatewayTestLineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Voice Services Communications Gateway Test Line.
        """
    ...
    def voice_services_communications_gateway_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def voice_services_communications_gateway_id(self, value: pulumi.Input[_builtins.str]):
...
class ServicesCommunicationsGatewayTestLine(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="voiceServicesCommunicationsGatewayId")
    def voice_services_communications_gateway_id(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the ID of the Voice Services Communications Gateway. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "voice_services_communications_gateway_id")
