...
class ServicesCommunicationsGatewayServiceLocation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str location: Specifies the region in which the resources needed for Teams Calling will be deployed.
        :param Sequence[builtins.str] operator_addresses: IP address to use to contact the operator network from this region.
        :param Sequence[builtins.str] allowed_media_source_address_prefixes: Specifies the allowed source IP address or CIDR ranges for media.
        :param Sequence[builtins.str] allowed_signaling_source_address_prefixes: Specifies the allowed source IP address or CIDR ranges for signaling.
