...
class ServicesCommunicationsGatewayServiceLocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_media_source_address_prefixes: Specifies the allowed source IP address or CIDR ranges for media.
