...
if not MYPY:
    class DeviceDevicePropertyArgsDict(TypedDict):
        ...
        """
        configured_role_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Type of compute roles configured.
        """
        culture: NotRequired[pulumi.Input[builtins.str]]
        """
        The Data Box Edge/Gateway device culture.
        """
        hcs_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeviceDevicePropertyArgs:
    def __init__(__self__, *,
                 ...
                 configured_role_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 culture: Optional[pulumi.Input[builtins.str]] = None,
                 hcs_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] capacity: The Data Box Edge/Gateway device local capacity in MB.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] configured_role_types: Type of compute roles configured.
        :param pulumi.Input[builtins.str] culture: The Data Box Edge/Gateway device culture.
        :param pulumi.Input[builtins.str] hcs_version: The device software version number of the device (e.g. 1.2.18105.6).
        :param pulumi.Input[builtins.str] model: The Data Box Edge/Gateway device model.
        :param pulumi.Input[builtins.int] node_count: The number of nodes in the cluster.
        :param pulumi.Input[builtins.str] serial_number: The Serial Number of Data Box Edge/Gateway device.
        :param pulumi.Input[builtins.str] software_version: The Data Box Edge/Gateway device software version.
        :param pulumi.Input[builtins.str] status: The status of the Data Box Edge/Gateway device.
        :param pulumi.Input[builtins.str] time_zone: The Data Box Edge/Gateway device timezone.
        :param pulumi.Input[builtins.str] type: The type of the Data Box Edge/Gateway device.
        """
    ...
    def configured_role_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Type of compute roles configured.
        """
    ...
    def configured_role_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "configured_role_types", value)

    @property
    @pulumi.getter
    def culture(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Data Box Edge/Gateway device culture.
        """
    ...
    @culture.setter
    def culture(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "culture", value)

    @property
    @pulumi.getter(name="hcsVersion")
    def hcs_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The device software version number of the device (e.g. 1.2.18105.6).
        """
    ...
    @hcs_version.setter
    def hcs_version(self, value: Optional[pulumi.Input[builtins.str]]):
