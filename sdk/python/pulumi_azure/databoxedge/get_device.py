...
def get_device(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.DataBoxEdge`: 2022-03-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Databox Edge Device should exist. Changing this forces a new Databox Edge Device to be created.
    """
    __args__ = dict()
    __args__['name'] = name
