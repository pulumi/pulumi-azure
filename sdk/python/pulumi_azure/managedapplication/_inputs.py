...
class ApplicationPlanArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the plan from the marketplace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] product: Specifies the product of the plan from the marketplace. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] publisher: Specifies the publisher of the plan. Changing this forces a new resource to be created.
...
class DefinitionAuthorizationArgs:
    def __init__(__self__, *,
                 ...
                 service_principal_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] role_definition_id: Specifies a role definition identifier for the provider. This role will define all the permissions that the provider must have on the managed application's container resource group. This role definition cannot have permission to delete the resource group.
        :param pulumi.Input[builtins.str] service_principal_id: Specifies a service principal identifier for the provider. This is the identity that the provider will use to call ARM to manage the managed application resources.
        """
