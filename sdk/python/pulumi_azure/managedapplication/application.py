...
class ApplicationArgs:
    def __init__(__self__, *,
                 ...
                 managed_resource_group_name: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 application_definition_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kind: The kind of the managed application to deploy. Possible values are `MarketPlace` and `ServiceCatalog`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] managed_resource_group_name: The name of the target resource group where all the resources deployed by the managed application will reside. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Managed Application should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] application_definition_id: The application definition ID to deploy.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Managed Application. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] parameter_values: The parameter values to pass to the Managed Application. This field is a JSON object that allows you to assign parameters to this Managed Application.
    ...
    def managed_resource_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def managed_resource_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def application_definition_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_definition_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] managed_resource_group_name: The name of the target resource group where all the resources deployed by the managed application will reside. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Managed Application. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] outputs: The name and value pairs that define the managed application outputs.
        :param pulumi.Input[builtins.str] parameter_values: The parameter values to pass to the Managed Application. This field is a JSON object that allows you to assign parameters to this Managed Application.
        :param pulumi.Input['ApplicationPlanArgs'] plan: One `plan` block as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Managed Application should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
...
class Application(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="applicationDefinitionId")
    def application_definition_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The application definition ID to deploy.
        """
        return pulumi.get(self, "application_definition_id")
    ...
    @property
    @pulumi.getter(name="parameterValues")
    def parameter_values(self) -> pulumi.Output[builtins.str]:
        """
        The parameter values to pass to the Managed Application. This field is a JSON object that allows you to assign parameters to this Managed Application.
        """
        return pulumi.get(self, "parameter_values")
