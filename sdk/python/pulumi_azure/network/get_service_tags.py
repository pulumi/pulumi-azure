...
class GetServiceTagsResult:
    ...
    def location_filter(self) -> Optional[builtins.str]:
...
def get_service_tags(location: Optional[builtins.str] = None,
                     location_filter: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str service: The type of the service for which address prefixes will be fetched. Available service tags can be found here: [Available service tags](https://docs.microsoft.com/azure/virtual-network/service-tags-overview#available-service-tags).
    """
    __args__ = dict()
...
def get_service_tags_output(location: Optional[pulumi.Input[builtins.str]] = None,
                            location_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
