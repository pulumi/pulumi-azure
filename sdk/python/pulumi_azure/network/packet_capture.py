...
class PacketCapture(pulumi.CustomResource):
    def __init__(__self__,
                 ...
                 maximum_bytes_per_session: Optional[pulumi.Input[float]] = None,
                 maximum_capture_duration: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[List[pulumi.Input[pulumi.InputType['PacketCaptureFilterArgs']]]] filters: One or more `filter` blocks as defined below. Changing this forces a new resource to be created.
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[List['outputs.PacketCaptureFilter']]:
        """
    ...
    def storage_location(self) -> 'outputs.PacketCaptureStorageLocation':
        """
