...
class FirewallPolicyRuleCollectionGroupArgs:
    def __init__(__self__, *,
                 firewall_policy_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] firewall_policy_id: The ID of the Firewall Policy where the Firewall Policy Rule Collection Group should exist. Changing this forces a new Firewall Policy Rule Collection Group to be created.
        :param pulumi.Input[builtins.int] priority: The priority of the Firewall Policy Rule Collection Group. The range is 100-65000.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Firewall Policy Rule Collection Group. Changing this forces a new Firewall Policy Rule Collection Group to be created.
    ...
    def firewall_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def firewall_policy_id(self, value: pulumi.Input[builtins.str]):
...
class FirewallPolicyRuleCollectionGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            nat_rule_collections: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FirewallPolicyRuleCollectionGroupNatRuleCollectionArgs', 'FirewallPolicyRuleCollectionGroupNatRuleCollectionArgsDict']]]]] = None,
            network_rule_collections: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FirewallPolicyRuleCollectionGroupNetworkRuleCollectionArgs', 'FirewallPolicyRuleCollectionGroupNetworkRuleCollectionArgsDict']]]]] = None,
            priority: Optional[pulumi.Input[builtins.int]] = None) -> 'FirewallPolicyRuleCollectionGroup':
        """
