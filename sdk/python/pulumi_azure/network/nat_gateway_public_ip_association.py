...
class NatGatewayPublicIpAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] nat_gateway_id: The ID of the NAT Gateway. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] public_ip_address_id: The ID of the Public IP which this NAT Gateway which should be connected to. Changing this forces a new resource to be created.
        """
...
@pulumi.type_token("azure:network/natGatewayPublicIpAssociation:NatGatewayPublicIpAssociation")
class NatGatewayPublicIpAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            nat_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            public_ip_address_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NatGatewayPublicIpAssociation':
        """
