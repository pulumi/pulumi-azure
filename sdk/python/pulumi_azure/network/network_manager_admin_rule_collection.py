...
class NetworkManagerAdminRuleCollectionArgs:
    def __init__(__self__, *,
                 network_group_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 security_admin_configuration_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a NetworkManagerAdminRuleCollection resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_group_ids: A list of Network Group ID which this Network Manager Admin Rule Collection applies to.
        :param pulumi.Input[builtins.str] security_admin_configuration_id: Specifies the ID of the Network Manager Security Admin Configuration. Changing this forces a new Network Manager Admin Rule Collection to be created.
        :param pulumi.Input[builtins.str] description: A description of the Network Manager Admin Rule Collection.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Manager Admin Rule Collection. Changing this forces a new Network Manager Admin Rule Collection to be created.
        """
    ...
    def network_group_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def network_group_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "network_group_ids", value)

    @property
    @pulumi.getter(name="securityAdminConfigurationId")
    def security_admin_configuration_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def security_admin_configuration_id(self, value: pulumi.Input[builtins.str]):
...
class _NetworkManagerAdminRuleCollectionState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 security_admin_configuration_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="networkGroupIds")
    def network_group_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Network Group ID which this Network Manager Admin Rule Collection applies to.
        """
        return pulumi.get(self, "network_group_ids")
    ...
    @network_group_ids.setter
    def network_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "network_group_ids", value)

    @property
    @pulumi.getter(name="securityAdminConfigurationId")
    def security_admin_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the ID of the Network Manager Security Admin Configuration. Changing this forces a new Network Manager Admin Rule Collection to be created.
        """
        return pulumi.get(self, "security_admin_configuration_id")
    ...
    @security_admin_configuration_id.setter
    def security_admin_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "security_admin_configuration_id", value)


class NetworkManagerAdminRuleCollection(pulumi.CustomResource):

    pulumi_type = "azure:network/networkManagerAdminRuleCollection:NetworkManagerAdminRuleCollection"
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            network_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            security_admin_configuration_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkManagerAdminRuleCollection':
        """
    ...
    @property
    @pulumi.getter(name="networkGroupIds")
    def network_group_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Network Group ID which this Network Manager Admin Rule Collection applies to.
        """
        return pulumi.get(self, "network_group_ids")
    ...
    @property
    @pulumi.getter(name="securityAdminConfigurationId")
    def security_admin_configuration_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the ID of the Network Manager Security Admin Configuration. Changing this forces a new Network Manager Admin Rule Collection to be created.
        """
        return pulumi.get(self, "security_admin_configuration_id")
