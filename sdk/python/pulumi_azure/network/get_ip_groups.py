...
def get_ip_groups(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param _builtins.str name: A substring to match some number of IP Groups.
    :param _builtins.str resource_group_name: The name of the Resource Group where the IP Groups exist.
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure:network/getIpGroups:getIpGroups', __args__, opts=opts, typ=GetIpGroupsResult).value
...
def get_ip_groups_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:network/getIpGroups:getIpGroups', __args__, opts=opts, typ=GetIpGroupsResult)
