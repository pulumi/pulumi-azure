...
class TrafficManagerAzureEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] profile_id: The ID of the Traffic Manager Profile that this Azure Endpoint should be created within. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] target_resource_id: The ID of the Azure Resource which should be used as a target.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Azure Endpoint. Changing this forces a new resource to be created.
...
class TrafficManagerAzureEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TrafficManagerAzureEndpointSubnetArgs', 'TrafficManagerAzureEndpointSubnetArgsDict']]]]] = None,
            target_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'TrafficManagerAzureEndpoint':
        """
