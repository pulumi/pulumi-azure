...
class NetworkManagerDeploymentArgs:
    def __init__(__self__, *,
                 configuration_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 network_manager_id: pulumi.Input[builtins.str],
                 scope_access: pulumi.Input[builtins.str],
    ...
    def configuration_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def configuration_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    @scope_access.setter
    def scope_access(self, value: pulumi.Input[builtins.str]):
...
class _NetworkManagerDeploymentState:
    def __init__(__self__, *,
                 configuration_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 network_manager_id: Optional[pulumi.Input[builtins.str]] = None,
                 scope_access: Optional[pulumi.Input[builtins.str]] = None,
                 triggers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="configurationIds")
    def configuration_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of Network Manager Configuration IDs which should be aligned with `scope_access`.
        """
        return pulumi.get(self, "configuration_ids")
    ...
    @configuration_ids.setter
    def configuration_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "configuration_ids", value)
    ...
    @scope_access.setter
    def scope_access(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scope_access", value)
...
class NetworkManagerDeployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_manager_id: Optional[pulumi.Input[builtins.str]] = None,
            scope_access: Optional[pulumi.Input[builtins.str]] = None,
            triggers: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'NetworkManagerDeployment':
        """
    ...
    @property
    @pulumi.getter(name="configurationIds")
    def configuration_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Network Manager Configuration IDs which should be aligned with `scope_access`.
        """
        return pulumi.get(self, "configuration_ids")
