...
def get_network_watcher(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str resource_group_name: Specifies the Name of the Resource Group within which the Network Watcher exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_network_watcher_output(name: Optional[pulumi.Input[_builtins.str]] = None,
