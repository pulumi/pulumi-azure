...
class TrafficManagerProfileArgs:
    def __init__(__self__, *,
                 ...
                 traffic_routing_method: pulumi.Input[_builtins.str],
                 max_return: pulumi.Input[Optional[_builtins.int]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 profile_status: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 traffic_view_enabled: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] traffic_routing_method: Specifies the algorithm used to route traffic. Possible values are `Geographic`, `Weighted`, `Performance`, `Priority`, `Subnet` and `MultiValue`.
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Traffic Manager profile. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] profile_status: The status of the profile, can be set to either `Enabled` or `Disabled`. Defaults to `Enabled`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[_builtins.bool] traffic_view_enabled: Indicates whether Traffic View is enabled for the Traffic Manager profile.
        """
    ...
    def traffic_routing_method(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def traffic_routing_method(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "traffic_routing_method", value)

    @_builtins.property
    @pulumi.getter(name="maxReturn")
    def max_return(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @max_return.setter
    def max_return(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def profile_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def profile_status(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def traffic_view_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def traffic_view_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _TrafficManagerProfileState:
    def __init__(__self__, *,
                 dns_config: pulumi.Input[Optional['TrafficManagerProfileDnsConfigArgs']] = None,
                 fqdn: pulumi.Input[Optional[_builtins.str]] = None,
                 max_return: pulumi.Input[Optional[_builtins.int]] = None,
                 monitor_config: pulumi.Input[Optional['TrafficManagerProfileMonitorConfigArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 profile_status: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 traffic_routing_method: pulumi.Input[Optional[_builtins.str]] = None,
                 traffic_view_enabled: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dnsConfig")
    def dns_config(self) -> pulumi.Input[Optional['TrafficManagerProfileDnsConfigArgs']]:
        """
        This block specifies the DNS configuration of the Profile. One `dns_config` block as defined below.
        """
        return pulumi.get(self, "dns_config")
    ...
    @dns_config.setter
    def dns_config(self, value: pulumi.Input[Optional['TrafficManagerProfileDnsConfigArgs']]):
        pulumi.set(self, "dns_config", value)
    ...
    @_builtins.property
    @pulumi.getter(name="monitorConfig")
    def monitor_config(self) -> pulumi.Input[Optional['TrafficManagerProfileMonitorConfigArgs']]:
        """
        This block specifies the Endpoint monitoring configuration for the Profile. One `monitor_config` block as defined below.
        """
        return pulumi.get(self, "monitor_config")
    ...
    @monitor_config.setter
    def monitor_config(self, value: pulumi.Input[Optional['TrafficManagerProfileMonitorConfigArgs']]):
        pulumi.set(self, "monitor_config", value)
    ...
    @_builtins.property
    @pulumi.getter(name="trafficRoutingMethod")
    def traffic_routing_method(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies the algorithm used to route traffic. Possible values are `Geographic`, `Weighted`, `Performance`, `Priority`, `Subnet` and `MultiValue`.
        * `Geographic` - Traffic is routed based on Geographic regions specified in the Endpoint.
        * `MultiValue` - All healthy Endpoints are returned.  MultiValue routing method works only if all the endpoints of type `External` and are specified as IPv4 or IPv6 addresses.
    ...
    @traffic_routing_method.setter
    def traffic_routing_method(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "traffic_routing_method", value)
...
class TrafficManagerProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 dns_config: pulumi.Input[Optional[Union['TrafficManagerProfileDnsConfigArgs', 'TrafficManagerProfileDnsConfigArgsDict', 'outputs.TrafficManagerProfileDnsConfig']]] = None,
                 max_return: pulumi.Input[Optional[_builtins.int]] = None,
                 monitor_config: pulumi.Input[Optional[Union['TrafficManagerProfileMonitorConfigArgs', 'TrafficManagerProfileMonitorConfigArgsDict', 'outputs.TrafficManagerProfileMonitorConfig']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 profile_status: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        * `Microsoft.Network` - 2022-04-01
        ...
        :param pulumi.Input[Union['TrafficManagerProfileDnsConfigArgs', 'TrafficManagerProfileDnsConfigArgsDict', 'outputs.TrafficManagerProfileDnsConfig']] dns_config: This block specifies the DNS configuration of the Profile. One `dns_config` block as defined below.
        :param pulumi.Input[_builtins.int] max_return: The amount of endpoints to return for DNS queries to this Profile. Possible values range from `1` to `8`.
               
               > **Note:** `max_return` must be set when the `traffic_routing_method` is `MultiValue`.
        :param pulumi.Input[Union['TrafficManagerProfileMonitorConfigArgs', 'TrafficManagerProfileMonitorConfigArgsDict', 'outputs.TrafficManagerProfileMonitorConfig']] monitor_config: This block specifies the Endpoint monitoring configuration for the Profile. One `monitor_config` block as defined below.
        :param pulumi.Input[_builtins.str] name: The name of the Traffic Manager profile. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] profile_status: The status of the profile, can be set to either `Enabled` or `Disabled`. Defaults to `Enabled`.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which to create the Traffic Manager profile. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            traffic_routing_method: pulumi.Input[Optional[_builtins.str]] = None,
            traffic_view_enabled: pulumi.Input[Optional[_builtins.bool]] = None) -> 'TrafficManagerProfile':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="maxReturn")
    def max_return(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        The amount of endpoints to return for DNS queries to this Profile. Possible values range from `1` to `8`.
    ...
    @_builtins.property
    @pulumi.getter(name="trafficRoutingMethod")
    def traffic_routing_method(self) -> pulumi.Output[_builtins.str]:
        """
        Specifies the algorithm used to route traffic. Possible values are `Geographic`, `Weighted`, `Performance`, `Priority`, `Subnet` and `MultiValue`.
        * `Geographic` - Traffic is routed based on Geographic regions specified in the Endpoint.
        * `MultiValue` - All healthy Endpoints are returned.  MultiValue routing method works only if all the endpoints of type `External` and are specified as IPv4 or IPv6 addresses.
    ...
    @_builtins.property
    @pulumi.getter(name="trafficViewEnabled")
    def traffic_view_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Indicates whether Traffic View is enabled for the Traffic Manager profile.
        """
        return pulumi.get(self, "traffic_view_enabled")
