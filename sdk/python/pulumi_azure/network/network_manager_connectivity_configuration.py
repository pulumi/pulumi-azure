...
class NetworkManagerConnectivityConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 connectivity_topology: pulumi.Input[builtins.str],
                 network_manager_id: pulumi.Input[builtins.str],
                 delete_existing_peering_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] connectivity_topology: Specifies the connectivity topology type. Possible values are `HubAndSpoke` and `Mesh`.
        :param pulumi.Input[builtins.str] network_manager_id: Specifies the ID of the Network Manager. Changing this forces a new Network Manager Connectivity Configuration to be created.
        :param pulumi.Input[builtins.bool] delete_existing_peering_enabled: Indicates whether to remove current existing Virtual Network Peering in the Connectivity Configuration affected scope. Possible values are `true` and `false`.
        :param pulumi.Input[builtins.str] description: A description of the Connectivity Configuration.
        :param pulumi.Input[builtins.bool] global_mesh_enabled: Indicates whether to global mesh is supported. Possible values are `true` and `false`.
        :param pulumi.Input['NetworkManagerConnectivityConfigurationHubArgs'] hub: A `hub` block as defined below.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Manager Connectivity Configuration. Changing this forces a new Network Manager Connectivity Configuration to be created.
        """
    ...
    def connectivity_topology(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connectivity_topology(self, value: pulumi.Input[builtins.str]):
    ...
    def delete_existing_peering_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_existing_peering_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NetworkManagerConnectivityConfigurationState:
    def __init__(__self__, *,
                 ...
                 connectivity_topology: Optional[pulumi.Input[builtins.str]] = None,
                 delete_existing_peering_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 global_mesh_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 hub: Optional[pulumi.Input['NetworkManagerConnectivityConfigurationHubArgs']] = None,
    ...
    @property
    @pulumi.getter(name="connectivityTopology")
    def connectivity_topology(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the connectivity topology type. Possible values are `HubAndSpoke` and `Mesh`.
        """
        return pulumi.get(self, "connectivity_topology")
    ...
    @connectivity_topology.setter
    def connectivity_topology(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connectivity_topology", value)
...
class NetworkManagerConnectivityConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hub: Optional[pulumi.Input[Union['NetworkManagerConnectivityConfigurationHubArgs', 'NetworkManagerConnectivityConfigurationHubArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            network_manager_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkManagerConnectivityConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="deleteExistingPeeringEnabled")
    def delete_existing_peering_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to remove current existing Virtual Network Peering in the Connectivity Configuration affected scope. Possible values are `true` and `false`.
        """
        return pulumi.get(self, "delete_existing_peering_enabled")
    ...
    @property
    @pulumi.getter(name="globalMeshEnabled")
    def global_mesh_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to global mesh is supported. Possible values are `true` and `false`.
        """
        return pulumi.get(self, "global_mesh_enabled")
