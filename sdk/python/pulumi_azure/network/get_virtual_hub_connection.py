...
class GetVirtualHubConnectionResult:
    ...
    def internet_security_enabled(self) -> builtins.bool:
        """
...
def get_virtual_hub_connection(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str virtual_hub_name: The name of the Virtual Hub where this Connection exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_virtual_hub_connection_output(name: Optional[pulumi.Input[builtins.str]] = None,
