...
class GetVirtualNetworkResult:
    ...
    def vnet_peerings(self) -> Mapping[str, _builtins.str]:
        """
    ...
    def vnet_peerings_addresses(self) -> Sequence[_builtins.str]:
        """
...
def get_virtual_network(name: Optional[_builtins.str] = None,
