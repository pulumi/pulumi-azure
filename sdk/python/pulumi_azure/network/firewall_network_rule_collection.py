...
class FirewallNetworkRuleCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: Specifies the action the rule will apply to matching traffic. Possible values are `Allow` and `Deny`.
        :param pulumi.Input[builtins.str] azure_firewall_name: Specifies the name of the Firewall in which the Network Rule Collection should be created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Network Rule Collection which must be unique within the Firewall. Changing this forces a new resource to be created.
        """
...
@pulumi.type_token("azure:network/firewallNetworkRuleCollection:FirewallNetworkRuleCollection")
