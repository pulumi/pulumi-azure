...
class GetVirtualHubResult:
    ...
    def virtual_router_asn(self) -> builtins.int:
        """
    ...
    def virtual_router_ips(self) -> Sequence[builtins.str]:
        """
...
def get_virtual_hub(name: Optional[builtins.str] = None,
...
def get_virtual_hub_output(name: Optional[pulumi.Input[builtins.str]] = None,
