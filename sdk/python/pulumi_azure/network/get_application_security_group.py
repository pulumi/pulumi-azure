...
def get_application_security_group(name: Optional[builtins.str] = None,
...
def get_application_security_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
