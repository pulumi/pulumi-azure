...
class GetPublicIPResult:
    ...
    def ip_tags(self) -> Mapping[str, builtins.str]:
        """
...
def get_public_ip(name: Optional[builtins.str] = None,
...
def get_public_ip_output(name: Optional[pulumi.Input[builtins.str]] = None,
