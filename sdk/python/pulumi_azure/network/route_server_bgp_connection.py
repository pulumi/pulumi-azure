...
class RouteServerBgpConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] peer_asn: The peer autonomous system number for the Route Server Bgp Connection. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] peer_ip: The peer ip address for the Route Server Bgp Connection. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] route_server_id: The ID of the Route Server within which this Bgp connection should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Route Server Bgp Connection. Changing this forces a new resource to be created.
        """
...
class RouteServerBgpConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            peer_asn: Optional[pulumi.Input[builtins.int]] = None,
            peer_ip: Optional[pulumi.Input[builtins.str]] = None,
            route_server_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RouteServerBgpConnection':
        """
