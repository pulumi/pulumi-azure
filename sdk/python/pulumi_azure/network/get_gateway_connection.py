...
class GetGatewayConnectionResult:
    ...
    def dpd_timeout_seconds(self) -> builtins.int:
        """
    ...
    def egress_bytes_transferred(self) -> builtins.int:
    ...
    def express_route_gateway_bypass(self) -> builtins.bool:
        """
    ...
    def ingress_bytes_transferred(self) -> builtins.int:
    ...
    def local_azure_ip_address_enabled(self) -> builtins.bool:
        """
    ...
    def private_link_fast_path_enabled(self) -> builtins.bool:
        """
    ...
    def routing_weight(self) -> builtins.int:
        """
        The routing weight.
        """
    ...
    def use_policy_based_traffic_selectors(self) -> builtins.bool:
        """
...
def get_gateway_connection(name: Optional[builtins.str] = None,
...
def get_gateway_connection_output(name: Optional[pulumi.Input[builtins.str]] = None,
