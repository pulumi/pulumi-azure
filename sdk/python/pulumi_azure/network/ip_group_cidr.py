...
class IPGroupCIDRArgs:
    def __init__(__self__, *,
                 ...
                 ip_group_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a IPGroupCIDR resource.
        :param pulumi.Input[builtins.str] ip_group_id: The ID of the destination IP Group.
    ...
    def ip_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ip_group_id.setter
    def ip_group_id(self, value: pulumi.Input[builtins.str]):
...
class _IPGroupCIDRState:
    def __init__(__self__, *,
                 ...
                 ip_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="ipGroupId")
    def ip_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the destination IP Group.
        Changing this forces a new IP Group CIDR to be created.
        """
    ...
    @ip_group_id.setter
    def ip_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ip_group_id", value)
...
class IPGroupCIDR(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            cidr: Optional[pulumi.Input[builtins.str]] = None,
            ip_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'IPGroupCIDR':
        """
    ...
    @property
    @pulumi.getter(name="ipGroupId")
    def ip_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the destination IP Group.
        Changing this forces a new IP Group CIDR to be created.
        """
