...
class RoutingIntentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_hub_id: The resource ID of the Virtual Hub. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Virtual Hub Routing Intent. Changing this forces a new resource to be created.
        """
...
class RoutingIntent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            routing_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RoutingIntentRoutingPolicyArgs', 'RoutingIntentRoutingPolicyArgsDict']]]]] = None,
            virtual_hub_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RoutingIntent':
        """
