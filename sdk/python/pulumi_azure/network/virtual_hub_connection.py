...
class VirtualHubConnectionArgs:
    def __init__(__self__, *,
                 ...
                 internet_security_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] remote_virtual_network_id: The ID of the Virtual Network which the Virtual Hub should be connected to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] virtual_hub_id: The ID of the Virtual Hub within which this connection should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] internet_security_enabled: Should Internet Security be enabled to secure internet traffic? Defaults to `false`.
        :param pulumi.Input[builtins.str] name: The Name which should be used for this Connection, which must be unique within the Virtual Hub. Changing this forces a new resource to be created.
    ...
    def internet_security_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def internet_security_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("azure:network/virtualHubConnection:VirtualHubConnection")
class VirtualHubConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] name: The Name which should be used for this Connection, which must be unique within the Virtual Hub. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] remote_virtual_network_id: The ID of the Virtual Network which the Virtual Hub should be connected to. Changing this forces a new resource to be created.
        :param pulumi.Input[Union['VirtualHubConnectionRoutingArgs', 'VirtualHubConnectionRoutingArgsDict']] routing: A `routing` block as defined below.
        :param pulumi.Input[builtins.str] virtual_hub_id: The ID of the Virtual Hub within which this connection should be created. Changing this forces a new resource to be created.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            remote_virtual_network_id: Optional[pulumi.Input[builtins.str]] = None,
            routing: Optional[pulumi.Input[Union['VirtualHubConnectionRoutingArgs', 'VirtualHubConnectionRoutingArgsDict']]] = None,
            virtual_hub_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualHubConnection':
        """
    ...
    @property
    @pulumi.getter(name="internetSecurityEnabled")
    def internet_security_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should Internet Security be enabled to secure internet traffic? Defaults to `false`.
        """
        return pulumi.get(self, "internet_security_enabled")
