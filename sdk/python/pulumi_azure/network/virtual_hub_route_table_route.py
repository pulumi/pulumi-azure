...
class VirtualHubRouteTableRouteInitArgs:
    def __init__(__self__, *,
                 ...
                 destinations_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destinations: A list of destination addresses for this route.
        :param pulumi.Input[builtins.str] destinations_type: The type of destinations. Possible values are `CIDR`, `ResourceId` and `Service`.
        :param pulumi.Input[builtins.str] next_hop: The next hop's resource ID.
        :param pulumi.Input[builtins.str] route_table_id: The ID of the Virtual Hub Route Table to link this route to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this route. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] next_hop_type: The type of next hop. Currently the only possible value is `ResourceId`. Defaults to `ResourceId`.
        """
    ...
    def destinations_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destinations_type(self, value: pulumi.Input[builtins.str]):
...
class _VirtualHubRouteTableRouteState:
    def __init__(__self__, *,
                 ...
                 destinations_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="destinationsType")
    def destinations_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of destinations. Possible values are `CIDR`, `ResourceId` and `Service`.
        """
        return pulumi.get(self, "destinations_type")
    ...
    @destinations_type.setter
    def destinations_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destinations_type", value)
...
class VirtualHubRouteTableRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            next_hop: Optional[pulumi.Input[builtins.str]] = None,
            next_hop_type: Optional[pulumi.Input[builtins.str]] = None,
            route_table_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualHubRouteTableRoute':
        """
    ...
    @property
    @pulumi.getter(name="destinationsType")
    def destinations_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of destinations. Possible values are `CIDR`, `ResourceId` and `Service`.
        """
        return pulumi.get(self, "destinations_type")
    ...
    @property
    @pulumi.getter(name="nextHopType")
    def next_hop_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of next hop. Currently the only possible value is `ResourceId`. Defaults to `ResourceId`.
        """
        return pulumi.get(self, "next_hop_type")
