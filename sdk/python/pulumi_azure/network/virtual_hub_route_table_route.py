...
class VirtualHubRouteTableRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_virtual_hub_route_table = azure.network.virtual_hub_route_table.VirtualHubRouteTable("example",
        ...
        example_virtual_hub_route_table_route = azure.network.virtual_hub_route_table_route.VirtualHubRouteTableRoute("example",
