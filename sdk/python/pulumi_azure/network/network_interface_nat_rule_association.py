...
class NetworkInterfaceNatRuleAssociationArgs:
    def __init__(__self__, *,
                 ...
                 nat_rule_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ip_configuration_name: The Name of the IP Configuration within the Network Interface which should be connected to the NAT Rule. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] nat_rule_id: The ID of the Load Balancer NAT Rule which this Network Interface which should be connected to. Changing this forces a new resource to be created.
    ...
    def nat_rule_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @nat_rule_id.setter
    def nat_rule_id(self, value: pulumi.Input[builtins.str]):
...
class _NetworkInterfaceNatRuleAssociationState:
    def __init__(__self__, *,
                 ...
                 nat_rule_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="natRuleId")
    def nat_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Load Balancer NAT Rule which this Network Interface which should be connected to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "nat_rule_id")
    ...
    @nat_rule_id.setter
    def nat_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nat_rule_id", value)
...
class NetworkInterfaceNatRuleAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_configuration_name: Optional[pulumi.Input[builtins.str]] = None,
            nat_rule_id: Optional[pulumi.Input[builtins.str]] = None,
            network_interface_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkInterfaceNatRuleAssociation':
        """
    ...
    @property
    @pulumi.getter(name="natRuleId")
    def nat_rule_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Load Balancer NAT Rule which this Network Interface which should be connected to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "nat_rule_id")
