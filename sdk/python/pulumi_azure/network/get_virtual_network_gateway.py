...
class GetVirtualNetworkGatewayResult:
    ...
    def active_active(self) -> builtins.bool:
        """
    ...
    def private_ip_address_enabled(self) -> builtins.bool:
        """
...
def get_virtual_network_gateway(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str name: Specifies the name of the Virtual Network Gateway.
    :param builtins.str resource_group_name: Specifies the name of the resource group the Virtual Network Gateway is located in.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_virtual_network_gateway_output(name: Optional[pulumi.Input[builtins.str]] = None,
