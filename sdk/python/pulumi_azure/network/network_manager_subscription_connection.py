...
class NetworkManagerSubscriptionConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_manager_id: Specifies the ID of the Network Manager which the Subscription is connected to.
        :param pulumi.Input[builtins.str] subscription_id: Specifies the ID of the target Subscription. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] description: A description of the Network Manager Subscription Connection.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Subscription Network Manager Connection. Changing this forces a new Network Subscription Network Manager Connection to be created.
        """
...
class _NetworkManagerSubscriptionConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_state: The Connection state of the Network Manager Subscription Connection.
        :param pulumi.Input[builtins.str] description: A description of the Network Manager Subscription Connection.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Subscription Network Manager Connection. Changing this forces a new Network Subscription Network Manager Connection to be created.
        :param pulumi.Input[builtins.str] network_manager_id: Specifies the ID of the Network Manager which the Subscription is connected to.
        :param pulumi.Input[builtins.str] subscription_id: Specifies the ID of the target Subscription. Changing this forces a new resource to be created.
...
@pulumi.type_token("azure:network/networkManagerSubscriptionConnection:NetworkManagerSubscriptionConnection")
class NetworkManagerSubscriptionConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            network_manager_id: Optional[pulumi.Input[builtins.str]] = None,
            subscription_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkManagerSubscriptionConnection':
        """
