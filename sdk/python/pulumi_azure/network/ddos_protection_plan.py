...
class DdosProtectionPlanArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Network DDoS Protection Plan. Changing this forces a new resource to be created.
...
class _DdosProtectionPlanState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 virtual_network_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the resource. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] virtual_network_ids: A list of Virtual Network IDs associated with the DDoS Protection Plan.
        """
        if location is not None:
            pulumi.set(__self__, "location", location)
        if name is not None:
    ...
    def virtual_network_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def virtual_network_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class DdosProtectionPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_network_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'DdosProtectionPlan':
        """
    ...
    @property
    @pulumi.getter(name="virtualNetworkIds")
    def virtual_network_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Virtual Network IDs associated with the DDoS Protection Plan.
        """
        return pulumi.get(self, "virtual_network_ids")
