...
class _DdosProtectionPlanState:
    def __init__(__self__, *,
        ...
        """
        _DdosProtectionPlanState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            location=location,
            name=name,
            resource_group_name=resource_group_name,
    ...
    def _configure(
        ...
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        if virtual_network_ids is None and 'virtualNetworkIds' in kwargs:
            virtual_network_ids = kwargs['virtualNetworkIds']
        ...
        if virtual_network_ids is not None:
            _setter("virtual_network_ids", virtual_network_ids)
