...
class LocalNetworkGatewayArgs:
    def __init__(__self__, *,
                 ...
                 gateway_fqdn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] address_spaces: The list of string CIDRs representing the address spaces the gateway exposes.
    ...
    def gateway_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @gateway_fqdn.setter
    def gateway_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LocalNetworkGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'LocalNetworkGateway':
        """
    ...
    @property
    @pulumi.getter(name="gatewayAddress")
    def gateway_address(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The gateway IP address to connect with.
        """
        return pulumi.get(self, "gateway_address")
    ...
    @property
    @pulumi.getter(name="gatewayFqdn")
    def gateway_fqdn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The gateway FQDN to connect with.
