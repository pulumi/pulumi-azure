...
class VirtualNetworkPeeringArgs:
    def __init__(__self__, *,
                 ...
                 only_ipv6_peering_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 peer_complete_virtual_networks_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] local_subnet_names: A list of local Subnet names that are Subnet peered with remote Virtual Network.
        :param pulumi.Input[_builtins.str] name: The name of the virtual network peering. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.bool] only_ipv6_peering_enabled: Specifies whether only IPv6 address space is peered for Subnet peering. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.bool] peer_complete_virtual_networks_enabled: Specifies whether complete Virtual Network address space is peered. Defaults to `true`. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] remote_subnet_names: A list of remote Subnet names from remote Virtual Network that are Subnet peered.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] triggers: A mapping of key values pairs that can be used to sync network routes from the remote virtual network to the local virtual network. See the trigger example for an example on how to set it up.
        :param pulumi.Input[_builtins.bool] use_remote_gateways: Controls if remote gateways can be used on the local virtual network. If the flag is set to `true`, and `allow_gateway_transit` on the remote peering is also `true`, virtual network will use gateways of remote virtual network for transit. Only one peering can have this flag set to `true`. This flag cannot be set if virtual network already has a gateway. Defaults to `false`.
    ...
    def only_ipv6_peering_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def only_ipv6_peering_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "only_ipv6_peering_enabled", value)

    @_builtins.property
    @pulumi.getter(name="peerCompleteVirtualNetworksEnabled")
    def peer_complete_virtual_networks_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def peer_complete_virtual_networks_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class VirtualNetworkPeering(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_1_virtual_network_peering = azure.network.VirtualNetworkPeering("example-1",
            ...
            remote_virtual_network_id=example_2.id,
            triggers={
                "remote_address_space": std.join(separator=",",
    ...
    def get(resource_name: str,
            ...
            triggers: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            use_remote_gateways: pulumi.Input[Optional[_builtins.bool]] = None,
            virtual_network_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'VirtualNetworkPeering':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="onlyIpv6PeeringEnabled")
    def only_ipv6_peering_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether only IPv6 address space is peered for Subnet peering. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "only_ipv6_peering_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="peerCompleteVirtualNetworksEnabled")
    def peer_complete_virtual_networks_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Specifies whether complete Virtual Network address space is peered. Defaults to `true`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "peer_complete_virtual_networks_enabled")
