...
class VirtualNetworkPeering(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_1 = azure.network.virtual_network.VirtualNetwork("example-1",
            name=peternetwork1,
            resource_group_name=example.name,
            address_spaces=[10.0.1.0/24],
            location=example.location)
        example_2 = azure.network.virtual_network.VirtualNetwork("example-2",
            name=peternetwork2,
            resource_group_name=example.name,
            address_spaces=[10.0.2.0/24],
            location=example.location)
        example_1_virtual_network_peering = azure.network.virtual_network_peering.VirtualNetworkPeering("example-1",
            name=peer1to2,
            resource_group_name=example.name,
            virtual_network_name=example_1.name,
            remote_virtual_network_id=example_2.id)
        example_2_virtual_network_peering = azure.network.virtual_network_peering.VirtualNetworkPeering("example-2",
            name=peer2to1,
            resource_group_name=example.name,
