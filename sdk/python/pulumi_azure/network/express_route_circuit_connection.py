...
class ExpressRouteCircuitConnectionArgs:
    def __init__(__self__, *,
                 address_prefix_ipv4: pulumi.Input[builtins.str],
                 peer_peering_id: pulumi.Input[builtins.str],
                 peering_id: pulumi.Input[builtins.str],
                 address_prefix_ipv6: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def address_prefix_ipv4(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def address_prefix_ipv4(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "address_prefix_ipv4", value)

    @property
    @pulumi.getter(name="peerPeeringId")
    def peer_peering_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def peer_peering_id(self, value: pulumi.Input[builtins.str]):
    ...
    def address_prefix_ipv6(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def address_prefix_ipv6(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ExpressRouteCircuitConnectionState:
    def __init__(__self__, *,
                 address_prefix_ipv4: Optional[pulumi.Input[builtins.str]] = None,
                 address_prefix_ipv6: Optional[pulumi.Input[builtins.str]] = None,
                 authorization_key: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 peer_peering_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="addressPrefixIpv4")
    def address_prefix_ipv4(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IPv4 address space from which to allocate customer address for global reach. Changing this forces a new Express Route Circuit Connection to be created.
        """
        return pulumi.get(self, "address_prefix_ipv4")
    ...
    @address_prefix_ipv4.setter
    def address_prefix_ipv4(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "address_prefix_ipv4", value)
    ...
    @property
    @pulumi.getter(name="peerPeeringId")
    def peer_peering_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the peered Express Route Circuit Private Peering. Changing this forces a new Express Route Circuit Connection to be created.
        """
        return pulumi.get(self, "peer_peering_id")
    ...
    @peer_peering_id.setter
    def peer_peering_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peer_peering_id", value)
...
class ExpressRouteCircuitConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            peer_peering_id: Optional[pulumi.Input[builtins.str]] = None,
            peering_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ExpressRouteCircuitConnection':
        """
    ...
    @property
    @pulumi.getter(name="addressPrefixIpv4")
    def address_prefix_ipv4(self) -> pulumi.Output[builtins.str]:
        """
        The IPv4 address space from which to allocate customer address for global reach. Changing this forces a new Express Route Circuit Connection to be created.
        """
        return pulumi.get(self, "address_prefix_ipv4")
    ...
    @property
    @pulumi.getter(name="addressPrefixIpv6")
    def address_prefix_ipv6(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IPv6 address space from which to allocate customer addresses for global reach.
    ...
    @property
    @pulumi.getter(name="peerPeeringId")
    def peer_peering_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the peered Express Route Circuit Private Peering. Changing this forces a new Express Route Circuit Connection to be created.
        """
        return pulumi.get(self, "peer_peering_id")
