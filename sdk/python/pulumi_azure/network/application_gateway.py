...
class ApplicationGatewayArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to the Application Gateway should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] enable_http2: Is HTTP2 enabled on the application gateway resource? Defaults to `false`.
        :param pulumi.Input[builtins.bool] fips_enabled: Is FIPS enabled on the Application Gateway?
        :param pulumi.Input[builtins.str] firewall_policy_id: The ID of the Web Application Firewall Policy.
        :param pulumi.Input[builtins.bool] force_firewall_policy_association: Is the Firewall Policy associated with the Application Gateway?
        ...
        :param pulumi.Input[builtins.str] location: The Azure region where the Application Gateway should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Specifies a list of Availability Zones in which this Application Gateway should be located. Changing this forces a new Application Gateway to be created.
...
class ApplicationGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            url_path_maps: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ApplicationGatewayUrlPathMapArgs', 'ApplicationGatewayUrlPathMapArgsDict']]]]] = None,
            waf_configuration: Optional[pulumi.Input[Union['ApplicationGatewayWafConfigurationArgs', 'ApplicationGatewayWafConfigurationArgsDict']]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ApplicationGateway':
        """
