...
class _ApplicationSecurityGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: A mapping of tags to assign to the resource.
        """
        _ApplicationSecurityGroupState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            location=location,
            name=name,
            resource_group_name=resource_group_name,
...
class ApplicationSecurityGroup(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ApplicationSecurityGroupArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            resource_group_name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None) -> 'ApplicationSecurityGroup':
        """
