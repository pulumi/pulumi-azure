...
class NetworkInterfaceArgs:
    def __init__(__self__, *,
                 ...
                 auxiliary_mode: Optional[pulumi.Input[builtins.str]] = None,
                 auxiliary_sku: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 internal_dns_name_label: Optional[pulumi.Input[builtins.str]] = None,
                 ip_forwarding_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which to create the Network Interface. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] accelerated_networking_enabled: Should Accelerated Networking be enabled? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] auxiliary_sku: Specifies the SKU used for the network high-performance feature on Network Virtual Appliances (NVAs). Possible values are `A8`, `A4`, `A1`, `A2` and `None`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: A list of IP Addresses defining the DNS Servers which should be used for this Network Interface.
               
               > **Note:** Configuring DNS Servers on the Network Interface will override the DNS Servers defined on the Virtual Network.
        :param pulumi.Input[builtins.str] edge_zone: Specifies the Edge Zone within the Azure Region where this Network Interface should exist. Changing this forces a new Network Interface to be created.
        :param pulumi.Input[builtins.str] internal_dns_name_label: The (relative) DNS Name used for internal communications between Virtual Machines in the same Virtual Network.
        :param pulumi.Input[builtins.bool] ip_forwarding_enabled: Should IP Forwarding be enabled? Defaults to `false`.
        :param pulumi.Input[builtins.str] location: The location where the Network Interface should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Network Interface. Changing this forces a new resource to be created.
    ...
    def auxiliary_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the auxiliary mode used to enable network high-performance feature on Network Virtual Appliances (NVAs). This feature offers competitive performance in Connections Per Second (CPS) optimization, along with improvements to handling large amounts of simultaneous connections. Possible values are `AcceleratedConnections`, `Floating`, `MaxConnections` and `None`.
    ...
    def auxiliary_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auxiliary_mode", value)

    @property
    @pulumi.getter(name="auxiliarySku")
    def auxiliary_sku(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auxiliary_sku(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def internal_dns_name_label(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def internal_dns_name_label(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "internal_dns_name_label", value)

    @property
    @pulumi.getter(name="ipForwardingEnabled")
    def ip_forwarding_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ip_forwarding_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NetworkInterfaceState:
    def __init__(__self__, *,
                 accelerated_networking_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 applied_dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 auxiliary_mode: Optional[pulumi.Input[builtins.str]] = None,
                 auxiliary_sku: Optional[pulumi.Input[builtins.str]] = None,
                 dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 edge_zone: Optional[pulumi.Input[builtins.str]] = None,
                 internal_dns_name_label: Optional[pulumi.Input[builtins.str]] = None,
                 internal_domain_name_suffix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] accelerated_networking_enabled: Should Accelerated Networking be enabled? Defaults to `false`.
               ...
               > **Note:** To use Accelerated Networking in an Availability Set, the Availability Set must be deployed onto an Accelerated Networking enabled cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] applied_dns_servers: If the Virtual Machine using this Network Interface is part of an Availability Set, then this list will have the union of all DNS servers from all Network Interfaces that are part of the Availability Set.
        :param pulumi.Input[builtins.str] auxiliary_mode: Specifies the auxiliary mode used to enable network high-performance feature on Network Virtual Appliances (NVAs). This feature offers competitive performance in Connections Per Second (CPS) optimization, along with improvements to handling large amounts of simultaneous connections. Possible values are `AcceleratedConnections`, `Floating`, `MaxConnections` and `None`.
        ...
        :param pulumi.Input[builtins.str] edge_zone: Specifies the Edge Zone within the Azure Region where this Network Interface should exist. Changing this forces a new Network Interface to be created.
        :param pulumi.Input[builtins.str] internal_dns_name_label: The (relative) DNS Name used for internal communications between Virtual Machines in the same Virtual Network.
        :param pulumi.Input[builtins.str] internal_domain_name_suffix: Even if `internal_dns_name_label` is not specified, a DNS entry is created for the primary NIC of the VM. This DNS name can be constructed by concatenating the VM name with the value of `internal_domain_name_suffix`.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkInterfaceIpConfigurationArgs']]] ip_configurations: One or more `ip_configuration` blocks as defined below.
        :param pulumi.Input[builtins.bool] ip_forwarding_enabled: Should IP Forwarding be enabled? Defaults to `false`.
        :param pulumi.Input[builtins.str] location: The location where the Network Interface should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] mac_address: The Media Access Control (MAC) Address of the Network Interface.
        :param pulumi.Input[builtins.str] name: The name of the Network Interface. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] private_ip_address: The first private IP address of the network interface.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ip_addresses: The private IP addresses of the network interface.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which to create the Network Interface. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] virtual_machine_id: The ID of the Virtual Machine which this Network Interface is connected to.
        """
        if accelerated_networking_enabled is not None:
            pulumi.set(__self__, "accelerated_networking_enabled", accelerated_networking_enabled)
    ...
    def applied_dns_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def applied_dns_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def internal_domain_name_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def internal_domain_name_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NetworkInterface(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkInterface':
        """
    ...
    @property
    @pulumi.getter(name="acceleratedNetworkingEnabled")
    def accelerated_networking_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should Accelerated Networking be enabled? Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="appliedDnsServers")
    def applied_dns_servers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        If the Virtual Machine using this Network Interface is part of an Availability Set, then this list will have the union of all DNS servers from all Network Interfaces that are part of the Availability Set.
        """
        return pulumi.get(self, "applied_dns_servers")
    ...
    @property
    @pulumi.getter(name="auxiliaryMode")
    def auxiliary_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the auxiliary mode used to enable network high-performance feature on Network Virtual Appliances (NVAs). This feature offers competitive performance in Connections Per Second (CPS) optimization, along with improvements to handling large amounts of simultaneous connections. Possible values are `AcceleratedConnections`, `Floating`, `MaxConnections` and `None`.
    ...
    @property
    @pulumi.getter(name="auxiliarySku")
    def auxiliary_sku(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the SKU used for the network high-performance feature on Network Virtual Appliances (NVAs). Possible values are `A8`, `A4`, `A1`, `A2` and `None`.
    ...
    @property
    @pulumi.getter(name="internalDnsNameLabel")
    def internal_dns_name_label(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The (relative) DNS Name used for internal communications between Virtual Machines in the same Virtual Network.
        """
        return pulumi.get(self, "internal_dns_name_label")
    ...
    @property
    @pulumi.getter(name="internalDomainNameSuffix")
    def internal_domain_name_suffix(self) -> pulumi.Output[builtins.str]:
        """
        Even if `internal_dns_name_label` is not specified, a DNS entry is created for the primary NIC of the VM. This DNS name can be constructed by concatenating the VM name with the value of `internal_domain_name_suffix`.
        """
        return pulumi.get(self, "internal_domain_name_suffix")
    ...
    @property
    @pulumi.getter(name="ipForwardingEnabled")
    def ip_forwarding_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should IP Forwarding be enabled? Defaults to `false`.
        """
        return pulumi.get(self, "ip_forwarding_enabled")
