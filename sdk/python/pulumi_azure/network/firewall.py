...
class FirewallArgs:
    def __init__(__self__, *,
                 ...
                 sku_tier: pulumi.Input[builtins.str],
                 dns_proxy_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 threat_intel_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] sku_name: SKU name of the Firewall. Possible values are `AZFW_Hub` and `AZFW_VNet`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku_tier: SKU tier of the Firewall. Possible values are `Premium`, `Standard` and `Basic`.
        :param pulumi.Input[builtins.bool] dns_proxy_enabled: Whether DNS proxy is enabled. It will forward DNS requests to the DNS servers when set to `true`. It will be set to `true` if `dns_servers` provided with a not empty list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: A list of DNS servers that the Azure Firewall will direct DNS traffic to the for name resolution.
        :param pulumi.Input[builtins.str] firewall_policy_id: The ID of the Firewall Policy applied to this Firewall.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Firewall. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ip_ranges: A list of SNAT private CIDR IP ranges, or the special string `IANAPrivateRanges`, which indicates Azure Firewall does not SNAT when the destination IP address is a private range per IANA RFC 1918.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] threat_intel_mode: The operation mode for threat intelligence-based filtering. Possible values are: `Off`, `Alert` and `Deny`. Defaults to `Alert`.
        :param pulumi.Input['FirewallVirtualHubArgs'] virtual_hub: A `virtual_hub` block as documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] zones: Specifies a list of Availability Zones in which this Azure Firewall should be located. Changing this forces a new Azure Firewall to be created.
    ...
    def sku_tier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sku_tier.setter
    def sku_tier(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sku_tier", value)

    @property
    @pulumi.getter(name="dnsProxyEnabled")
    def dns_proxy_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def dns_proxy_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def threat_intel_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def threat_intel_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Firewall(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            threat_intel_mode: Optional[pulumi.Input[builtins.str]] = None,
            virtual_hub: Optional[pulumi.Input[Union['FirewallVirtualHubArgs', 'FirewallVirtualHubArgsDict']]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Firewall':
        """
    ...
    @property
    @pulumi.getter(name="dnsProxyEnabled")
    def dns_proxy_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether DNS proxy is enabled. It will forward DNS requests to the DNS servers when set to `true`. It will be set to `true` if `dns_servers` provided with a not empty list.
        """
        return pulumi.get(self, "dns_proxy_enabled")
    ...
    @property
    @pulumi.getter(name="firewallPolicyId")
    def firewall_policy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Firewall Policy applied to this Firewall.
        """
        return pulumi.get(self, "firewall_policy_id")
    ...
    @property
    @pulumi.getter(name="skuTier")
    def sku_tier(self) -> pulumi.Output[builtins.str]:
        """
        SKU tier of the Firewall. Possible values are `Premium`, `Standard` and `Basic`.
        """
        return pulumi.get(self, "sku_tier")
    ...
    @property
    @pulumi.getter(name="threatIntelMode")
    def threat_intel_mode(self) -> pulumi.Output[builtins.str]:
        """
        The operation mode for threat intelligence-based filtering. Possible values are: `Off`, `Alert` and `Deny`. Defaults to `Alert`.
        """
        return pulumi.get(self, "threat_intel_mode")
