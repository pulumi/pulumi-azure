...
def get_ip_group(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str name: Specifies the Name of the IP Group.
    :param _builtins.str resource_group_name: Specifies the Name of the Resource Group within which the IP Group exists
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_ip_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
