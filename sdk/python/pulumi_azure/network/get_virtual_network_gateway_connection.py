...
async def get_virtual_network_gateway_connection(name=None,resource_group_name=None,opts=None):
    """
    ...
    __ret__ = await pulumi.runtime.invoke('azure:network/getVirtualNetworkGatewayConnection:getVirtualNetworkGatewayConnection', __args__, opts=opts)
