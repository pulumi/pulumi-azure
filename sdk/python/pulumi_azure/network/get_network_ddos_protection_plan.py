...
class GetNetworkDdosProtectionPlanResult:
    ...
    def virtual_network_ids(self) -> Sequence[_builtins.str]:
        """
...
def get_network_ddos_protection_plan(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str resource_group_name: The name of the resource group where the Network DDoS Protection Plan exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_network_ddos_protection_plan_output(name: Optional[pulumi.Input[_builtins.str]] = None,
                                            resource_group_name: Optional[pulumi.Input[_builtins.str]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetNetworkDdosProtectionPlanResult]:
    """
    Use this data source to access information about an existing Azure Network DDoS Protection Plan.
