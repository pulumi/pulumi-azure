...
class VpnServerConfigurationPolicyGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpn_server_configuration_id: The ID of the VPN Server Configuration that the VPN Server Configuration Policy Group belongs to. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] is_default: Is this a default VPN Server Configuration Policy Group? Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The Name which should be used for this VPN Server Configuration Policy Group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] priority: The priority of this VPN Server Configuration Policy Group. Defaults to `0`.
        """
...
class VpnServerConfigurationPolicyGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VpnServerConfigurationPolicyGroupPolicyArgs', 'VpnServerConfigurationPolicyGroupPolicyArgsDict']]]]] = None,
            priority: Optional[pulumi.Input[builtins.int]] = None,
            vpn_server_configuration_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpnServerConfigurationPolicyGroup':
        """
