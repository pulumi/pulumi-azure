...
class TrafficManagerExternalEndpointArgs:
    def __init__(__self__, *,
                 ...
                 always_serve_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] target: The FQDN DNS name of the target.
        :param pulumi.Input[builtins.bool] always_serve_enabled: If Always Serve is enabled, probing for endpoint health will be disabled and endpoints will be included in the traffic routing method. Defaults to `false`.
    ...
    def always_serve_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def always_serve_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TrafficManagerExternalEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TrafficManagerExternalEndpointSubnetArgs', 'TrafficManagerExternalEndpointSubnetArgsDict']]]]] = None,
            target: Optional[pulumi.Input[builtins.str]] = None,
            weight: Optional[pulumi.Input[builtins.int]] = None) -> 'TrafficManagerExternalEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="alwaysServeEnabled")
    def always_serve_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If Always Serve is enabled, probing for endpoint health will be disabled and endpoints will be included in the traffic routing method. Defaults to `false`.
        """
        return pulumi.get(self, "always_serve_enabled")
