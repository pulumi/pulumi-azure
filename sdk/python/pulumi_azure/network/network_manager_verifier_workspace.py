...
class NetworkManagerVerifierWorkspaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_manager_id: The ID of the Network Manager. Changing this forces a new Network Manager Verifier Workspace to be created.
        :param pulumi.Input[builtins.str] description: The Description of the Network Manager Verifier Workspace.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Network Manager Verifier Workspace should exist. Changing this forces a new Network Manager Verifier Workspace to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Network Manager Verifier Workspace. Changing this forces a new Network Manager Verifier Workspace to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Network Manager Verifier Workspace.
        """
...
class NetworkManagerVerifierWorkspace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            network_manager_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'NetworkManagerVerifierWorkspace':
        """
