...
class SubnetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SubnetIpAddressPoolArgs'] ip_address_pool: An `ip_address_pool` block as defined below.
...
class Subnet(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="defaultOutboundAccessEnabled")
    def default_outbound_access_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Enable default outbound access to the internet for the subnet. Defaults to `true`.
        """
        return pulumi.get(self, "default_outbound_access_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="ipAddressPool")
    def ip_address_pool(self) -> pulumi.Output[Optional['outputs.SubnetIpAddressPool']]:
        """
        An `ip_address_pool` block as defined below.
    ...
    @_builtins.property
    @pulumi.getter(name="privateLinkServiceNetworkPoliciesEnabled")
    def private_link_service_network_policies_enabled(self) -> pulumi.Output[Optional[_builtins.bool]]:
        """
        Enable or Disable network policies for the private link service on the subnet. Defaults to `true`.
