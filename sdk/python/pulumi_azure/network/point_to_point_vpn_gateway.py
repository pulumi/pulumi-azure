...
class PointToPointVpnGatewayArgs:
    def __init__(__self__, *,
                 ...
                 scale_unit: pulumi.Input[builtins.int],
                 virtual_hub_id: pulumi.Input[builtins.str],
                 vpn_server_configuration_id: pulumi.Input[builtins.str],
                 dns_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 routing_preference_internet_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Point-to-Site VPN Gateway. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] scale_unit: The [Scale Unit](https://docs.microsoft.com/azure/virtual-wan/virtual-wan-faq#what-is-a-virtual-wan-gateway-scale-unit) for this Point-to-Site VPN Gateway.
        :param pulumi.Input[builtins.str] virtual_hub_id: The ID of the Virtual Hub where this Point-to-Site VPN Gateway should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] vpn_server_configuration_id: The ID of the VPN Server Configuration which this Point-to-Site VPN Gateway should use. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: A list of IP Addresses of DNS Servers for the Point-to-Site VPN Gateway.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Point-to-Site VPN Gateway. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] routing_preference_internet_enabled: Is the Routing Preference for the Public IP Interface of the VPN Gateway enabled? Defaults to `false`. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the Point-to-Site VPN Gateway.
        """
    ...
    def scale_unit(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @scale_unit.setter
    def scale_unit(self, value: pulumi.Input[builtins.int]):
    ...
    def vpn_server_configuration_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vpn_server_configuration_id(self, value: pulumi.Input[builtins.str]):
    ...
    def routing_preference_internet_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def routing_preference_internet_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PointToPointVpnGatewayState:
    def __init__(__self__, *,
                 ...
                 vpn_server_configuration_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="vpnServerConfigurationId")
    def vpn_server_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the VPN Server Configuration which this Point-to-Site VPN Gateway should use. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "vpn_server_configuration_id")
    ...
    @vpn_server_configuration_id.setter
    def vpn_server_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpn_server_configuration_id", value)
...
class PointToPointVpnGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_hub_id: Optional[pulumi.Input[builtins.str]] = None,
            vpn_server_configuration_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PointToPointVpnGateway':
        """
    ...
    @property
    @pulumi.getter(name="routingPreferenceInternetEnabled")
    def routing_preference_internet_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is the Routing Preference for the Public IP Interface of the VPN Gateway enabled? Defaults to `false`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "routing_preference_internet_enabled")
    ...
    @property
    @pulumi.getter(name="scaleUnit")
    def scale_unit(self) -> pulumi.Output[builtins.int]:
        """
        The [Scale Unit](https://docs.microsoft.com/azure/virtual-wan/virtual-wan-faq#what-is-a-virtual-wan-gateway-scale-unit) for this Point-to-Site VPN Gateway.
        """
        return pulumi.get(self, "scale_unit")
    ...
    @property
    @pulumi.getter(name="vpnServerConfigurationId")
    def vpn_server_configuration_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VPN Server Configuration which this Point-to-Site VPN Gateway should use. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "vpn_server_configuration_id")
