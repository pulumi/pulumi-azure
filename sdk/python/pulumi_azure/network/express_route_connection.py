...
class ExpressRouteConnectionArgs:
    def __init__(__self__, *,
                 express_route_circuit_peering_id: pulumi.Input[builtins.str],
                 express_route_gateway_id: pulumi.Input[builtins.str],
                 ...
                 express_route_gateway_bypass_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_fast_path_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] express_route_circuit_peering_id: The ID of the Express Route Circuit Peering that this Express Route Connection connects with. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] express_route_gateway_id: The ID of the Express Route Gateway that this Express Route Connection connects with. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] authorization_key: The authorization key to establish the Express Route Connection.
        :param pulumi.Input[builtins.bool] enable_internet_security: Is Internet security enabled for this Express Route Connection?
        :param pulumi.Input[builtins.bool] express_route_gateway_bypass_enabled: Specified whether Fast Path is enabled for Virtual Wan Firewall Hub. Defaults to `false`.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Express Route Connection. Changing this forces a new resource to be created.
        :param pulumi.Input['ExpressRouteConnectionRoutingArgs'] routing: A `routing` block as defined below.
        :param pulumi.Input[builtins.int] routing_weight: The routing weight associated to the Express Route Connection. Possible value is between `0` and `32000`. Defaults to `0`.
        """
    ...
    def express_route_circuit_peering_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def express_route_circuit_peering_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "express_route_circuit_peering_id", value)

    @property
    @pulumi.getter(name="expressRouteGatewayId")
    def express_route_gateway_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def express_route_gateway_id(self, value: pulumi.Input[builtins.str]):
    ...
    def express_route_gateway_bypass_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def express_route_gateway_bypass_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def private_link_fast_path_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "private_link_fast_path_enabled")

    @private_link_fast_path_enabled.setter
    def private_link_fast_path_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ExpressRouteConnectionState:
    def __init__(__self__, *,
                 authorization_key: Optional[pulumi.Input[builtins.str]] = None,
                 enable_internet_security: Optional[pulumi.Input[builtins.bool]] = None,
                 express_route_circuit_peering_id: Optional[pulumi.Input[builtins.str]] = None,
                 express_route_gateway_bypass_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 express_route_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 private_link_fast_path_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 routing: Optional[pulumi.Input['ExpressRouteConnectionRoutingArgs']] = None,
                 routing_weight: Optional[pulumi.Input[builtins.int]] = None):
    ...
    @property
    @pulumi.getter(name="expressRouteCircuitPeeringId")
    def express_route_circuit_peering_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Express Route Circuit Peering that this Express Route Connection connects with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "express_route_circuit_peering_id")
    ...
    @express_route_circuit_peering_id.setter
    def express_route_circuit_peering_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "express_route_circuit_peering_id", value)
    ...
    @property
    @pulumi.getter(name="expressRouteGatewayId")
    def express_route_gateway_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Express Route Gateway that this Express Route Connection connects with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "express_route_gateway_id")
    ...
    @express_route_gateway_id.setter
    def express_route_gateway_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "express_route_gateway_id", value)
...
class ExpressRouteConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            private_link_fast_path_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            routing: Optional[pulumi.Input[Union['ExpressRouteConnectionRoutingArgs', 'ExpressRouteConnectionRoutingArgsDict']]] = None,
            routing_weight: Optional[pulumi.Input[builtins.int]] = None) -> 'ExpressRouteConnection':
        """
    ...
    @property
    @pulumi.getter(name="expressRouteCircuitPeeringId")
    def express_route_circuit_peering_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Express Route Circuit Peering that this Express Route Connection connects with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "express_route_circuit_peering_id")
    ...
    @property
    @pulumi.getter(name="expressRouteGatewayBypassEnabled")
    def express_route_gateway_bypass_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specified whether Fast Path is enabled for Virtual Wan Firewall Hub. Defaults to `false`.
        """
        return pulumi.get(self, "express_route_gateway_bypass_enabled")
    ...
    @property
    @pulumi.getter(name="expressRouteGatewayId")
    def express_route_gateway_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Express Route Gateway that this Express Route Connection connects with. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "express_route_gateway_id")
    ...
    @pulumi.getter(name="privateLinkFastPathEnabled")
    @_utilities.deprecated("""'private_link_fast_path_enabled' has been deprecated as it is no longer supported by the resource and will be removed in v5.0 of the AzureRM Provider""")
    def private_link_fast_path_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "private_link_fast_path_enabled")
