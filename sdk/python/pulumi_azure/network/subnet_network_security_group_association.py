...
class SubnetNetworkSecurityGroupAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] network_security_group_id: The ID of the Network Security Group which should be associated with the Subnet. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the Subnet. Changing this forces a new resource to be created.
        """
...
class SubnetNetworkSecurityGroupAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            network_security_group_id: Optional[pulumi.Input[builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SubnetNetworkSecurityGroupAssociation':
        """
