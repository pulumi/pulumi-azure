...
class RouteTable(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name, opts=None, disable_bgp_route_propagation=None, location=None, name=None, resource_group_name=None, routes=None, tags=None, __name__=None, __opts__=None):
        ...
        :param pulumi.Input[str] name: The name of the route table. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[list] routes: Can be specified multiple times to define multiple routes. Each `route` block supports fields documented below.
