...
def get_local_network_gateway(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str name: The name of the Local Network Gateway.
    :param builtins.str resource_group_name: The name of the Resource Group where the Local Network Gateway exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_local_network_gateway_output(name: Optional[pulumi.Input[builtins.str]] = None,
