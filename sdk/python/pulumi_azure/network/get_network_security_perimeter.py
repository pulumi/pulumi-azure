...
def get_network_security_perimeter(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str name: The name of this Network Security Perimeter.
    :param _builtins.str resource_group_name: The name of the Resource Group where the Network Security Perimeter exists.
    """
    __args__ = dict()
    __args__['name'] = name
    __args__['resourceGroupName'] = resource_group_name
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('azure:network/getNetworkSecurityPerimeter:getNetworkSecurityPerimeter', __args__, opts=opts, typ=GetNetworkSecurityPerimeterResult).value
...
def get_network_security_perimeter_output(name: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:network/getNetworkSecurityPerimeter:getNetworkSecurityPerimeter', __args__, opts=opts, typ=GetNetworkSecurityPerimeterResult)
