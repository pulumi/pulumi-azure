...
def get_network_manager_network_group(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str name: Specifies the name of the Network Manager Network Group.
    :param builtins.str network_manager_id: Specifies the ID of the Network Manager.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_network_manager_network_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
