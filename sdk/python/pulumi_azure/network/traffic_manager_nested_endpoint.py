...
class TrafficManagerNestedEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_resource_id: The resource id of an Azure resource to target.
        ...
        :param pulumi.Input[_builtins.int] minimum_required_child_endpoints_ipv4: This argument specifies the minimum number of IPv4 (DNS record type A) endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This argument only applies to Endpoints of type `nestedEndpoints` and
        :param pulumi.Input[_builtins.int] minimum_required_child_endpoints_ipv6: This argument specifies the minimum number of IPv6 (DNS record type AAAA) endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This argument only applies to Endpoints of type `nestedEndpoints` and
    ...
    def minimum_child_endpoints(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    def minimum_child_endpoints(self, value: pulumi.Input[_builtins.int]):
...
class TrafficManagerNestedEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 custom_headers: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TrafficManagerNestedEndpointCustomHeaderArgs', 'TrafficManagerNestedEndpointCustomHeaderArgsDict', 'outputs.TrafficManagerNestedEndpointCustomHeader']]]]] = None,
                 enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 endpoint_location: pulumi.Input[Optional[_builtins.str]] = None,
                 geo_mappings: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 minimum_child_endpoints: pulumi.Input[Optional[_builtins.int]] = None,
                 ...
                 priority: pulumi.Input[Optional[_builtins.int]] = None,
                 profile_id: pulumi.Input[Optional[_builtins.str]] = None,
                 subnets: pulumi.Input[Optional[Sequence[pulumi.Input[Union['TrafficManagerNestedEndpointSubnetArgs', 'TrafficManagerNestedEndpointSubnetArgsDict', 'outputs.TrafficManagerNestedEndpointSubnet']]]]] = None,
                 target_resource_id: pulumi.Input[Optional[_builtins.str]] = None,
                 weight: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        """
        ...
        * `Microsoft.Network` - 2022-04-01
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['TrafficManagerNestedEndpointCustomHeaderArgs', 'TrafficManagerNestedEndpointCustomHeaderArgsDict', 'outputs.TrafficManagerNestedEndpointCustomHeader']]]] custom_headers: One or more `custom_header` blocks as defined below.
        :param pulumi.Input[_builtins.bool] enabled: Is the endpoint enabled? Defaults to `true`.
        :param pulumi.Input[_builtins.str] endpoint_location: Specifies the Azure location of the Endpoint, this must be specified for Profiles using the `Performance` routing method.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] geo_mappings: A list of Geographic Regions used to distribute traffic, such as `WORLD`, `UK` or `DE`. The same location can't be specified in two endpoints. [See the Geographic Hierarchies documentation for more information](https://docs.microsoft.com/rest/api/trafficmanager/geographichierarchies/getdefault).
        :param pulumi.Input[_builtins.int] minimum_child_endpoints: This argument specifies the minimum number of endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This value must be larger than `0`.
        ...
        :param pulumi.Input[_builtins.int] priority: Specifies the priority of this Endpoint, this must be specified for Profiles using the `Priority` traffic routing method. Supports values between 1 and 1000, with no Endpoints sharing the same value. If omitted the value will be computed in order of creation.
        :param pulumi.Input[_builtins.str] profile_id: The ID of the Traffic Manager Profile that this External Endpoint should be created within. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['TrafficManagerNestedEndpointSubnetArgs', 'TrafficManagerNestedEndpointSubnetArgsDict', 'outputs.TrafficManagerNestedEndpointSubnet']]]] subnets: One or more `subnet` blocks as defined below. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] target_resource_id: The resource id of an Azure resource to target.
        :param pulumi.Input[_builtins.int] weight: Specifies how much traffic should be distributed to this endpoint, this must be specified for Profiles using the Weighted traffic routing method. Valid values are between `1` and `1000`. Defaults to `1`.
        """
        ...
    ...
    @_builtins.property
    @pulumi.getter(name="minimumChildEndpoints")
    def minimum_child_endpoints(self) -> pulumi.Output[_builtins.int]:
        """
        This argument specifies the minimum number of endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This value must be larger than `0`.
    ...
    @_builtins.property
    @pulumi.getter(name="minimumRequiredChildEndpointsIpv4")
    def minimum_required_child_endpoints_ipv4(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        This argument specifies the minimum number of IPv4 (DNS record type A) endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This argument only applies to Endpoints of type `nestedEndpoints` and
        """
        return pulumi.get(self, "minimum_required_child_endpoints_ipv4")
    ...
    @_builtins.property
    @pulumi.getter(name="minimumRequiredChildEndpointsIpv6")
    def minimum_required_child_endpoints_ipv6(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        This argument specifies the minimum number of IPv6 (DNS record type AAAA) endpoints that must be ‘online’ in the child profile in order for the parent profile to direct traffic to any of the endpoints in that child profile. This argument only applies to Endpoints of type `nestedEndpoints` and
        """
        return pulumi.get(self, "minimum_required_child_endpoints_ipv6")
