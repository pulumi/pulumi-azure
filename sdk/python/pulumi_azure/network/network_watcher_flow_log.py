...
class NetworkWatcherFlowLogArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Should Network Flow Logging be Enabled?
        :param pulumi.Input[builtins.str] network_watcher_name: The name of the Network Watcher. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which the Network Watcher was deployed. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] storage_account_id: The ID of the Storage Account where flow logs are stored.
        :param pulumi.Input[builtins.str] location: The location where the Network Watcher Flow Log resides. Changing this forces a new resource to be created. Defaults to the `location` of the Network Watcher.
        :param pulumi.Input[builtins.str] name: The name of the Network Watcher Flow Log. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Network Watcher Flow Log.
        :param pulumi.Input[builtins.str] target_resource_id: The ID of the Resource for which to enable flow logs for. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.int] version: The version (revision) of the flow log. Possible values are `1` and `2`. Defaults to `1`.
        """
...
class _NetworkWatcherFlowLogState:
    ...
    @property
    @pulumi.getter(name="networkWatcherName")
    def network_watcher_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Network Watcher. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "network_watcher_name")
    ...
    @network_watcher_name.setter
    def network_watcher_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_watcher_name", value)
...
class NetworkWatcherFlowLog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            traffic_analytics: Optional[pulumi.Input[Union['NetworkWatcherFlowLogTrafficAnalyticsArgs', 'NetworkWatcherFlowLogTrafficAnalyticsArgsDict']]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'NetworkWatcherFlowLog':
        """
    ...
    @property
    @pulumi.getter(name="networkWatcherName")
    def network_watcher_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Network Watcher. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "network_watcher_name")
