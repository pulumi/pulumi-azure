...
class NetworkInterfaceApplicationSecurityGroupAssociationArgs:
    def __init__(__self__, *,
                 application_security_group_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] application_security_group_id: The ID of the Application Security Group which this Network Interface which should be connected to. Changing this forces a new resource to be created.
    ...
    def application_security_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def application_security_group_id(self, value: pulumi.Input[builtins.str]):
...
class _NetworkInterfaceApplicationSecurityGroupAssociationState:
    def __init__(__self__, *,
                 application_security_group_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="applicationSecurityGroupId")
    def application_security_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Application Security Group which this Network Interface which should be connected to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "application_security_group_id")
    ...
    @application_security_group_id.setter
    def application_security_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_security_group_id", value)
...
@pulumi.type_token("azure:network/networkInterfaceApplicationSecurityGroupAssociation:NetworkInterfaceApplicationSecurityGroupAssociation")
class NetworkInterfaceApplicationSecurityGroupAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            application_security_group_id: Optional[pulumi.Input[builtins.str]] = None,
            network_interface_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkInterfaceApplicationSecurityGroupAssociation':
        """
    ...
    @property
    @pulumi.getter(name="applicationSecurityGroupId")
    def application_security_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Application Security Group which this Network Interface which should be connected to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "application_security_group_id")
