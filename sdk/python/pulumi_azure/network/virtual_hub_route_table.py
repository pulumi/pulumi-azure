...
class VirtualHubRouteTableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] virtual_hub_id: The ID of the Virtual Hub within which this route table should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] labels: List of labels associated with this route table.
        :param pulumi.Input[builtins.str] name: The name which should be used for Virtual Hub Route Table. Changing this forces a new resource to be created.
...
class VirtualHubRouteTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            routes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['VirtualHubRouteTableRouteArgs', 'VirtualHubRouteTableRouteArgsDict']]]]] = None,
            virtual_hub_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualHubRouteTable':
        """
