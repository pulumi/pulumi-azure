...
class FirewallPolicyArgs:
    def __init__(__self__, *,
                 ...
                 auto_learn_private_ranges_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 base_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 private_ip_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 sku: Optional[pulumi.Input[builtins.str]] = None,
                 sql_redirect_allowed: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 threat_intelligence_allowlist: Optional[pulumi.Input['FirewallPolicyThreatIntelligenceAllowlistArgs']] = None,
                 threat_intelligence_mode: Optional[pulumi.Input[builtins.str]] = None,
                 tls_certificate: Optional[pulumi.Input['FirewallPolicyTlsCertificateArgs']] = None):
        """
        The set of arguments for constructing a FirewallPolicy resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Firewall Policy should exist. Changing this forces a new Firewall Policy to be created.
        :param pulumi.Input[builtins.bool] auto_learn_private_ranges_enabled: Whether enable auto learn private ip range.
        :param pulumi.Input[builtins.str] base_policy_id: The ID of the base Firewall Policy.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Firewall Policy should exist. Changing this forces a new Firewall Policy to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Firewall Policy. Changing this forces a new Firewall Policy to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ip_ranges: A list of private IP ranges to which traffic will not be SNAT.
        :param pulumi.Input[builtins.str] sku: The SKU Tier of the Firewall Policy. Possible values are `Standard`, `Premium` and `Basic`. Defaults to `Standard`. Changing this forces a new Firewall Policy to be created.
        :param pulumi.Input[builtins.bool] sql_redirect_allowed: Whether SQL Redirect traffic filtering is allowed. Enabling this flag requires no rule using ports between `11000`-`11999`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Firewall Policy.
        ...
        :param pulumi.Input[builtins.str] threat_intelligence_mode: The operation mode for Threat Intelligence. Possible values are `Alert`, `Deny` and `Off`. Defaults to `Alert`.
    ...
    def auto_learn_private_ranges_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_learn_private_ranges_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_learn_private_ranges_enabled", value)

    @property
    @pulumi.getter(name="basePolicyId")
    def base_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def base_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def private_ip_ranges(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def private_ip_ranges(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def sql_redirect_allowed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sql_redirect_allowed(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def threat_intelligence_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def threat_intelligence_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FirewallPolicyState:
    def __init__(__self__, *,
                 auto_learn_private_ranges_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 base_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 child_policies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 dns: Optional[pulumi.Input['FirewallPolicyDnsArgs']] = None,
                 explicit_proxy: Optional[pulumi.Input['FirewallPolicyExplicitProxyArgs']] = None,
                 firewalls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 identity: Optional[pulumi.Input['FirewallPolicyIdentityArgs']] = None,
                 insights: Optional[pulumi.Input['FirewallPolicyInsightsArgs']] = None,
                 intrusion_detection: Optional[pulumi.Input['FirewallPolicyIntrusionDetectionArgs']] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 rule_collection_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 sku: Optional[pulumi.Input[builtins.str]] = None,
                 sql_redirect_allowed: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 threat_intelligence_allowlist: Optional[pulumi.Input['FirewallPolicyThreatIntelligenceAllowlistArgs']] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_learn_private_ranges_enabled: Whether enable auto learn private ip range.
        :param pulumi.Input[builtins.str] base_policy_id: The ID of the base Firewall Policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] child_policies: A list of reference to child Firewall Policies of this Firewall Policy.
        :param pulumi.Input['FirewallPolicyDnsArgs'] dns: A `dns` block as defined below.
        :param pulumi.Input['FirewallPolicyExplicitProxyArgs'] explicit_proxy: A `explicit_proxy` block as defined below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] firewalls: A list of references to Azure Firewalls that this Firewall Policy is associated with.
        :param pulumi.Input['FirewallPolicyIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input['FirewallPolicyInsightsArgs'] insights: An `insights` block as defined below.
        :param pulumi.Input['FirewallPolicyIntrusionDetectionArgs'] intrusion_detection: A `intrusion_detection` block as defined below.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Firewall Policy should exist. Changing this forces a new Firewall Policy to be created.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] private_ip_ranges: A list of private IP ranges to which traffic will not be SNAT.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Firewall Policy should exist. Changing this forces a new Firewall Policy to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rule_collection_groups: A list of references to Firewall Policy Rule Collection Groups that belongs to this Firewall Policy.
        :param pulumi.Input[builtins.str] sku: The SKU Tier of the Firewall Policy. Possible values are `Standard`, `Premium` and `Basic`. Defaults to `Standard`. Changing this forces a new Firewall Policy to be created.
        :param pulumi.Input[builtins.bool] sql_redirect_allowed: Whether SQL Redirect traffic filtering is allowed. Enabling this flag requires no rule using ports between `11000`-`11999`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Firewall Policy.
        :param pulumi.Input['FirewallPolicyThreatIntelligenceAllowlistArgs'] threat_intelligence_allowlist: A `threat_intelligence_allowlist` block as defined below.
    ...
    def child_policies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def child_policies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter
    def firewalls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @firewalls.setter
    def firewalls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def rule_collection_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def rule_collection_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class FirewallPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoLearnPrivateRangesEnabled")
    def auto_learn_private_ranges_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether enable auto learn private ip range.
        """
        return pulumi.get(self, "auto_learn_private_ranges_enabled")
    ...
    @property
    @pulumi.getter(name="basePolicyId")
    def base_policy_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the base Firewall Policy.
        """
        return pulumi.get(self, "base_policy_id")
    ...
    @property
    @pulumi.getter(name="childPolicies")
    def child_policies(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of reference to child Firewall Policies of this Firewall Policy.
        """
        return pulumi.get(self, "child_policies")
    ...
    @property
    @pulumi.getter
    def firewalls(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of references to Azure Firewalls that this Firewall Policy is associated with.
        """
        return pulumi.get(self, "firewalls")
    ...
    @property
    @pulumi.getter(name="privateIpRanges")
    def private_ip_ranges(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of private IP ranges to which traffic will not be SNAT.
        """
        return pulumi.get(self, "private_ip_ranges")
    ...
    @property
    @pulumi.getter(name="ruleCollectionGroups")
    def rule_collection_groups(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of references to Firewall Policy Rule Collection Groups that belongs to this Firewall Policy.
        """
        return pulumi.get(self, "rule_collection_groups")
    ...
    @property
    @pulumi.getter(name="sqlRedirectAllowed")
    def sql_redirect_allowed(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether SQL Redirect traffic filtering is allowed. Enabling this flag requires no rule using ports between `11000`-`11999`.
        """
        return pulumi.get(self, "sql_redirect_allowed")
    ...
    @property
    @pulumi.getter(name="threatIntelligenceMode")
    def threat_intelligence_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The operation mode for Threat Intelligence. Possible values are `Alert`, `Deny` and `Off`. Defaults to `Alert`.
        """
        return pulumi.get(self, "threat_intelligence_mode")
