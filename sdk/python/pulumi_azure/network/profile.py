...
class ProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Network Profile. Changing this forces a new resource to be created.
...
class _ProfileState:
    def __init__(__self__, *,
                 ...
                 container_network_interface_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['ProfileContainerNetworkInterfaceArgs'] container_network_interface: A `container_network_interface` block as documented below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_network_interface_ids: A list of Container Network Interface IDs.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Network Profile. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the resource. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags assigned to the resource.
    ...
    def container_network_interface_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def container_network_interface_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Profile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Profile':
        """
    ...
    @property
    @pulumi.getter(name="containerNetworkInterfaceIds")
    def container_network_interface_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of Container Network Interface IDs.
        """
        return pulumi.get(self, "container_network_interface_ids")
