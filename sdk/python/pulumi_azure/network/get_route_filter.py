...
def get_route_filter(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str name: The Name of this Route Filter.
    :param builtins.str resource_group_name: The name of the Resource Group where the Route Filter exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_route_filter_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    __ret__ = pulumi.runtime.invoke_output('azure:network/getRouteFilter:getRouteFilter', __args__, opts=opts, typ=GetRouteFilterResult)
