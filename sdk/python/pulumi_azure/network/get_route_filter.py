...
def get_route_filter(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the Route Filter exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_route_filter_output(name: Optional[pulumi.Input[_builtins.str]] = None,
