...
def get_virtual_hub_route_table(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str virtual_hub_name: The name which should be used for Virtual Hub Route Table.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_virtual_hub_route_table_output(name: Optional[pulumi.Input[builtins.str]] = None,
