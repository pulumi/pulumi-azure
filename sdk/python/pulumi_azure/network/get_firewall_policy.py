...
class GetFirewallPolicyResult:
    ...
    def base_policy_id(self) -> _builtins.str:
        return pulumi.get(self, "base_policy_id")

    @_builtins.property
    @pulumi.getter(name="childPolicies")
    def child_policies(self) -> Sequence[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter
    def firewalls(self) -> Sequence[_builtins.str]:
    ...
    def rule_collection_groups(self) -> Sequence[_builtins.str]:
    ...
    def threat_intelligence_mode(self) -> _builtins.str:
...
def get_firewall_policy(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str name: The name of this Firewall Policy.
    :param _builtins.str resource_group_name: The name of the Resource Group where the Firewall Policy exists.
    """
    __args__ = dict()
    __args__['name'] = name
