...
class VirtualHubArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] virtual_wan_id: The ID of a Virtual WAN within which the Virtual Hub should be created. Changing this forces a new resource to be created.
        """
...
class _VirtualHubState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] virtual_router_auto_scale_min_capacity: Minimum instance capacity for the scaling configuration of the Virtual Hub Router. Defaults to `2`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] virtual_router_ips: The IP addresses of the Virtual Hub BGP router.
        :param pulumi.Input[_builtins.str] virtual_wan_id: The ID of a Virtual WAN within which the Virtual Hub should be created. Changing this forces a new resource to be created.
        """
        if address_prefix is not None:
            pulumi.set(__self__, "address_prefix", address_prefix)
...
class VirtualHub(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="virtualRouterAutoScaleMinCapacity")
    def virtual_router_auto_scale_min_capacity(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        Minimum instance capacity for the scaling configuration of the Virtual Hub Router. Defaults to `2`.
        """
        return pulumi.get(self, "virtual_router_auto_scale_min_capacity")
    ...
    @_builtins.property
    @pulumi.getter(name="virtualWanId")
    def virtual_wan_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of a Virtual WAN within which the Virtual Hub should be created. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "virtual_wan_id")
