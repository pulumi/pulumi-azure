...
class NetworkInterfaceSecurityGroupAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_network_interface_security_group_association = azure.network.network_interface_security_group_association.NetworkInterfaceSecurityGroupAssociation("example",
