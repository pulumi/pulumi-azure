...
__all__ = ['FirewallNatRuleCollectionArrgs', 'FirewallNatRuleCollection']

@pulumi.input_type
calass FirewallNatRuleCollectionArrgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FirewallNatRuleCollectionRuleArrgs']]] rules: One or more `rule` blocks as defined below.
...
@pulumi.input_type
calass _FirewallNatRuleCollectionState:
    def __init__(__self__, *,
                 ...
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['FirewallNatRuleCollectionRuleArrgs']]]] = None):
        """
...
calass FirewallNatRuleCollection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 priority: Optional[pulumi.Input[int]] = None,
                 resource_group_name: Optional[pulumi.Input[str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallNatRuleCollectionRuleArrgs']]]]] = None,
                 __props__=None):
        """
        ...
        example_firewall = azure.network.Firewall("exampleFirewall",
            ...
            sku_name="AZFW_VNet",
            sku_tier="Standard",
            ip_configurations=[azure.network.FirewallIpConfigurationArrgs(
                name="configuration",
        ...
        example_firewall_nat_rule_collection = azure.network.FirewallNatRuleCollection("exampleFirewallNatRuleCollection",
            ...
            priority=100,
            action="Dnat",
            rules=[azure.network.FirewallNatRuleCollectionRuleArrgs(
                name="testrule",
        ...
        :param pulumi.Input[int] priority: Specifies the priority of the rule collection. Possible values are between `100` - `65000`.
        :param pulumi.Input[str] resource_group_name: Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FirewallNatRuleCollectionRuleArrgs']]]] rules: One or more `rule` blocks as defined below.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: FirewallNatRuleCollectionArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Manages a NAT Rule Collection within an Azure Firewall.
        ...
        :param str resource_name: The name of the resource.
        :param FirewallNatRuleCollectionArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(FirewallNatRuleCollectionArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = FirewallNatRuleCollectionArrgs.__new__(FirewallNatRuleCollectionArrgs)
