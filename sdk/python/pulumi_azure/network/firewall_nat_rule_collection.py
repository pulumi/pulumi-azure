...
class FirewallNatRuleCollectionArgs:
    def __init__(__self__, *,
                 ...
                 azure_firewall_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] action: Specifies the action the rule will apply to matching traffic. Possible values are `Dnat` and `Snat`.
        :param pulumi.Input[builtins.str] azure_firewall_name: Specifies the name of the Firewall in which the NAT Rule Collection should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] priority: Specifies the priority of the rule collection. Possible values are between `100` - `65000`.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the NAT Rule Collection which must be unique within the Firewall. Changing this forces a new resource to be created.
        """
    ...
    def azure_firewall_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def azure_firewall_name(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("azure:network/firewallNatRuleCollection:FirewallNatRuleCollection")
class FirewallNatRuleCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FirewallNatRuleCollectionRuleArgs', 'FirewallNatRuleCollectionRuleArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        * `Microsoft.Network`: 2024-05-01
        ...
        :param pulumi.Input[builtins.int] priority: Specifies the priority of the rule collection. Possible values are between `100` - `65000`.
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FirewallNatRuleCollectionRuleArgs', 'FirewallNatRuleCollectionRuleArgsDict']]]] rules: One or more `rule` blocks as defined below.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.int]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['FirewallNatRuleCollectionRuleArgs', 'FirewallNatRuleCollectionRuleArgsDict']]]]] = None) -> 'FirewallNatRuleCollection':
        """
    ...
    @property
    @pulumi.getter(name="azureFirewallName")
    def azure_firewall_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the Firewall in which the NAT Rule Collection should be created. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "azure_firewall_name")
