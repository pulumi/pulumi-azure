...
class _FirewallNatRuleCollectionState:
    def __init__(__self__, *,
                 ...
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['FirewallNatRuleCollectionRuleArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FirewallNatRuleCollectionRuleArgs']]]]:
        """
        One or more `rule` blocks as defined below.
        """
        return pulumi.get(self, "rules")
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FirewallNatRuleCollectionRuleArgs']]]]):
        pulumi.set(self, "rules", value)
...
class FirewallNatRuleCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 priority: pulumi.Input[Optional[_builtins.int]] = None,
                 resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FirewallNatRuleCollectionRuleArgs', 'FirewallNatRuleCollectionRuleArgsDict', 'outputs.FirewallNatRuleCollectionRule']]]]] = None,
                 __props__=None):
        """
        ...
        * `Microsoft.Network` - 2025-01-01
        ...
        :param pulumi.Input[_builtins.int] priority: Specifies the priority of the rule collection. Possible values are between `100` - `65000`.
        :param pulumi.Input[_builtins.str] resource_group_name: Specifies the name of the Resource Group in which the Firewall exists. Changing this forces a new resource to be created.
        :param pulumi.Input[Sequence[pulumi.Input[Union['FirewallNatRuleCollectionRuleArgs', 'FirewallNatRuleCollectionRuleArgsDict', 'outputs.FirewallNatRuleCollectionRule']]]] rules: One or more `rule` blocks as defined below.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            priority: pulumi.Input[Optional[_builtins.int]] = None,
            resource_group_name: pulumi.Input[Optional[_builtins.str]] = None,
            rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FirewallNatRuleCollectionRuleArgs', 'FirewallNatRuleCollectionRuleArgsDict', 'outputs.FirewallNatRuleCollectionRule']]]]] = None) -> 'FirewallNatRuleCollection':
        """
