...
class GetNetworkManagerResult:
    ...
    def scope_accesses(self) -> Sequence[builtins.str]:
        """
...
def get_network_manager(name: Optional[builtins.str] = None,
...
def get_network_manager_output(name: Optional[pulumi.Input[builtins.str]] = None,
