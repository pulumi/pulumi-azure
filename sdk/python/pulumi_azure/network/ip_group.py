...
class IPGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the IP group. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the IP group. Changing this forces a new resource to be created.
...
class _IPGroupState:
    def __init__(__self__, *,
                 cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 firewall_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 firewall_policy_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] firewall_ids: A list of ID of Firewall.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] firewall_policy_ids: A list of ID of Firewall Policy`.
        :param pulumi.Input[builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name of the IP group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the IP group. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
    ...
    def firewall_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @firewall_ids.setter
    def firewall_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "firewall_ids", value)

    @property
    @pulumi.getter(name="firewallPolicyIds")
    def firewall_policy_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def firewall_policy_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class IPGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'IPGroup':
        """
    ...
    @property
    @pulumi.getter(name="firewallIds")
    def firewall_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of ID of Firewall.
        """
        return pulumi.get(self, "firewall_ids")
    ...
    @property
    @pulumi.getter(name="firewallPolicyIds")
    def firewall_policy_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of ID of Firewall Policy`.
        """
        return pulumi.get(self, "firewall_policy_ids")
