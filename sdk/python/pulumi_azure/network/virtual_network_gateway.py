...
class VirtualNetworkGatewayArgs:
    def __init__(__self__, *,
                 ...
                 active_active: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 default_local_network_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
                 dns_forwarding_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 ip_sec_replay_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 policy_groups: Optional[pulumi.Input[Sequence[pulumi.Input['VirtualNetworkGatewayPolicyGroupArgs']]]] = None,
                 private_ip_address_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 remote_vnet_traffic_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 virtual_wan_traffic_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] type: The type of the Virtual Network Gateway. Valid options are `Vpn` or `ExpressRoute`. Changing the type forces a new resource to be created.
        :param pulumi.Input[builtins.bool] active_active: If `true`, an active-active Virtual Network Gateway will be created. An active-active gateway requires a `HighPerformance` or an `UltraPerformance` SKU. If `false`, an active-standby gateway will be created. Defaults to `false`.
        :param pulumi.Input[builtins.bool] bgp_route_translation_for_nat_enabled: Is BGP Route Translation for NAT enabled? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] default_local_network_gateway_id: The ID of the local network gateway through which outbound Internet traffic from the virtual network in which the gateway is created will be routed (*forced tunnelling*). Refer to the [Azure documentation on forced tunnelling](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-forced-tunneling-rm). If not specified, forced tunnelling is disabled.
        :param pulumi.Input[builtins.bool] dns_forwarding_enabled: Is DNS forwarding enabled?
        :param pulumi.Input[builtins.str] edge_zone: Specifies the Edge Zone within the Azure Region where this Virtual Network Gateway should exist. Changing this forces a new Virtual Network Gateway to be created.
        :param pulumi.Input[builtins.bool] enable_bgp: If `true`, BGP (Border Gateway Protocol) will be enabled for this Virtual Network Gateway. Defaults to `false`.
        :param pulumi.Input[builtins.str] generation: The Generation of the Virtual Network gateway. Possible values include `Generation1`, `Generation2` or `None`. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] ip_sec_replay_protection_enabled: Is IP Sec Replay Protection enabled? Defaults to `true`.
        :param pulumi.Input[builtins.str] location: The location/region where the Virtual Network Gateway is located. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Virtual Network Gateway. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.bool] private_ip_address_enabled: Should private IP be enabled on this gateway for connections? Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] remote_vnet_traffic_enabled: Is remote vnet traffic that is used to configure this gateway to accept traffic from other Azure Virtual Networks enabled? Defaults to `false`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.bool] virtual_wan_traffic_enabled: Is remote vnet traffic that is used to configure this gateway to accept traffic from remote Virtual WAN networks enabled? Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] vpn_type: The routing type of the Virtual Network Gateway. Valid options are `RouteBased` or `PolicyBased`. Defaults to `RouteBased`. Changing this forces a new resource to be created.
        """
    ...
    def active_active(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def active_active(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def default_local_network_gateway_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_local_network_gateway_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_local_network_gateway_id", value)

    @property
    @pulumi.getter(name="dnsForwardingEnabled")
    def dns_forwarding_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def dns_forwarding_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ip_sec_replay_protection_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ip_sec_replay_protection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def private_ip_address_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def private_ip_address_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "private_ip_address_enabled", value)

    @property
    @pulumi.getter(name="remoteVnetTrafficEnabled")
    def remote_vnet_traffic_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def remote_vnet_traffic_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def virtual_wan_traffic_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def virtual_wan_traffic_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class VirtualNetworkGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            virtual_wan_traffic_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            vpn_client_configuration: Optional[pulumi.Input[Union['VirtualNetworkGatewayVpnClientConfigurationArgs', 'VirtualNetworkGatewayVpnClientConfigurationArgsDict']]] = None,
            vpn_type: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualNetworkGateway':
        """
    ...
    @property
    @pulumi.getter(name="activeActive")
    def active_active(self) -> pulumi.Output[builtins.bool]:
        """
        If `true`, an active-active Virtual Network Gateway will be created. An active-active gateway requires a `HighPerformance` or an `UltraPerformance` SKU. If `false`, an active-standby gateway will be created. Defaults to `false`.
        """
        return pulumi.get(self, "active_active")
    ...
    @property
    @pulumi.getter(name="defaultLocalNetworkGatewayId")
    def default_local_network_gateway_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the local network gateway through which outbound Internet traffic from the virtual network in which the gateway is created will be routed (*forced tunnelling*). Refer to the [Azure documentation on forced tunnelling](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-forced-tunneling-rm). If not specified, forced tunnelling is disabled.
        """
        return pulumi.get(self, "default_local_network_gateway_id")
    ...
    @property
    @pulumi.getter(name="dnsForwardingEnabled")
    def dns_forwarding_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is DNS forwarding enabled?
        """
        return pulumi.get(self, "dns_forwarding_enabled")
    ...
    @property
    @pulumi.getter(name="enableBgp")
    def enable_bgp(self) -> pulumi.Output[builtins.bool]:
        """
        If `true`, BGP (Border Gateway Protocol) will be enabled for this Virtual Network Gateway. Defaults to `false`.
        """
        return pulumi.get(self, "enable_bgp")
    ...
    @property
    @pulumi.getter(name="ipSecReplayProtectionEnabled")
    def ip_sec_replay_protection_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is IP Sec Replay Protection enabled? Defaults to `true`.
        """
        return pulumi.get(self, "ip_sec_replay_protection_enabled")
    ...
    @property
    @pulumi.getter(name="privateIpAddressEnabled")
    def private_ip_address_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Should private IP be enabled on this gateway for connections? Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "private_ip_address_enabled")
    ...
    @property
    @pulumi.getter(name="remoteVnetTrafficEnabled")
    def remote_vnet_traffic_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is remote vnet traffic that is used to configure this gateway to accept traffic from other Azure Virtual Networks enabled? Defaults to `false`.
        """
        return pulumi.get(self, "remote_vnet_traffic_enabled")
    ...
    @property
    @pulumi.getter(name="virtualWanTrafficEnabled")
    def virtual_wan_traffic_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Is remote vnet traffic that is used to configure this gateway to accept traffic from remote Virtual WAN networks enabled? Defaults to `false`.
        """
        return pulumi.get(self, "virtual_wan_traffic_enabled")
