...
class VpnSiteArgs:
    def __init__(__self__, *,
                 ...
                 virtual_wan_id: pulumi.Input[builtins.str],
                 address_cidrs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 device_model: Optional[pulumi.Input[builtins.str]] = None,
                 device_vendor: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the VPN Site should exist. Changing this forces a new VPN Site to be created.
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the VPN Site should exist. Changing this forces a new VPN Site to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this VPN Site. Changing this forces a new VPN Site to be created.
        :param pulumi.Input['VpnSiteO365PolicyArgs'] o365_policy: An `o365_policy` block as defined below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the VPN Site.
        """
    ...
    def virtual_wan_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def virtual_wan_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "virtual_wan_id", value)

    @property
    @pulumi.getter(name="addressCidrs")
    def address_cidrs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def address_cidrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "address_cidrs", value)

    @property
    @pulumi.getter(name="deviceModel")
    def device_model(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @device_model.setter
    def device_model(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "device_model", value)

    @property
    @pulumi.getter(name="deviceVendor")
    def device_vendor(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def device_vendor(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VpnSite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_wan_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpnSite':
        """
    ...
    @property
    @pulumi.getter(name="addressCidrs")
    def address_cidrs(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a list of IP address CIDRs that are located on your on-premises site. Traffic destined for these address spaces is routed to your local site.
    ...
    @property
    @pulumi.getter(name="deviceModel")
    def device_model(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The model of the VPN device.
        """
        return pulumi.get(self, "device_model")
    ...
    @property
    @pulumi.getter(name="deviceVendor")
    def device_vendor(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the VPN device vendor.
        """
        return pulumi.get(self, "device_vendor")
    ...
    @property
    @pulumi.getter(name="virtualWanId")
    def virtual_wan_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Virtual Wan where this VPN site resides in. Changing this forces a new VPN Site to be created.
        """
        return pulumi.get(self, "virtual_wan_id")
