...
class ExpressRouteGatewayArgs:
    def __init__(__self__, *,
                 ...
                 allow_non_virtual_wan_traffic: Optional[pulumi.Input[builtins.bool]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ExpressRouteGateway resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the ExpressRoute gateway. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.int] scale_units: The number of scale units with which to provision the ExpressRoute gateway. Each scale unit is equal to 2Gbps, with support for up to 10 scale units (20Gbps).
        :param pulumi.Input[builtins.str] virtual_hub_id: The ID of a Virtual HUB within which the ExpressRoute gateway should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] allow_non_virtual_wan_traffic: Specified whether this gateway accept traffic from non-Virtual WAN networks. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the ExpressRoute gateway. Changing this forces a new resource to be created.
    ...
    def allow_non_virtual_wan_traffic(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_non_virtual_wan_traffic(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ExpressRouteGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scale_units: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_hub_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ExpressRouteGateway':
        """
    ...
    @property
    @pulumi.getter(name="allowNonVirtualWanTraffic")
    def allow_non_virtual_wan_traffic(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specified whether this gateway accept traffic from non-Virtual WAN networks. Defaults to `false`.
        """
        return pulumi.get(self, "allow_non_virtual_wan_traffic")
