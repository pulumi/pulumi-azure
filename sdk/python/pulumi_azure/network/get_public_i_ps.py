...
class GetPublicIPsResult:
    ...
    def attachment_status(self) -> Optional[builtins.str]:
...
def get_public_i_ps(allocation_type: Optional[builtins.str] = None,
                    attachment_status: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str name_prefix: A prefix match used for the IP Addresses `name` field, case sensitive.
...
def get_public_i_ps_output(allocation_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           attachment_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
