...
class ApplicationGatewayAuthenticationCertificate(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data: The contents of the Authentication Certificate which should be used.
        :param builtins.str name: The Name of the Authentication Certificate to use.
...
class ApplicationGatewayAutoscaleConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int min_capacity: Minimum capacity for autoscaling. Accepted values are in the range `0` to `100`.
        :param builtins.int max_capacity: Maximum capacity for autoscaling. Accepted values are in the range `2` to `125`.
        """
...
class ApplicationGatewayBackendAddressPool(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the Backend Address Pool.
        :param Sequence[builtins.str] fqdns: A list of FQDN's which should be part of the Backend Address Pool.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param Sequence[builtins.str] ip_addresses: A list of IP Addresses which should be part of the Backend Address Pool.
        """
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayBackendHttpSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 affinity_cookie_name: Optional[builtins.str] = None,
                 ...
                 pick_host_name_from_backend_address: Optional[builtins.bool] = None,
                 probe_id: Optional[builtins.str] = None,
                 probe_name: Optional[builtins.str] = None,
                 request_timeout: Optional[builtins.int] = None,
                 trusted_root_certificate_names: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str cookie_based_affinity: Is Cookie-Based Affinity enabled? Possible values are `Enabled` and `Disabled`.
        :param builtins.str name: The name of the Authentication Certificate.
        :param builtins.int port: The port which should be used for this Backend HTTP Settings Collection.
        :param builtins.str protocol: The Protocol which should be used. Possible values are `Http` and `Https`.
        :param builtins.str affinity_cookie_name: The name of the affinity cookie.
        ...
        :param builtins.str host_name: Host header to be sent to the backend servers. Cannot be set if `pick_host_name_from_backend_address` is set to `true`.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str path: The Path which should be used as a prefix for all HTTP requests.
        :param builtins.bool pick_host_name_from_backend_address: Whether host header should be picked from the host name of the backend server. Defaults to `false`.
        :param builtins.str probe_id: The ID of the associated Probe.
        :param builtins.str probe_name: The name of an associated HTTP Probe.
        :param builtins.int request_timeout: The request timeout in seconds, which must be between 1 and 86400 seconds. Defaults to `30`.
        :param Sequence[builtins.str] trusted_root_certificate_names: A list of `trusted_root_certificate` names.
        """
    ...
    def affinity_cookie_name(self) -> Optional[builtins.str]:
        """
    ...
    def pick_host_name_from_backend_address(self) -> Optional[builtins.bool]:
        """
    ...
    def probe_id(self) -> Optional[builtins.str]:
        """
    ...
    def probe_name(self) -> Optional[builtins.str]:
        """
    ...
    def trusted_root_certificate_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ApplicationGatewayBackendHttpSettingConnectionDraining(dict):
    ...
    def __init__(__self__, *,
                 drain_timeout_sec: builtins.int,
                 enabled: builtins.bool):
        """
        :param builtins.int drain_timeout_sec: The number of seconds connection draining is active. Acceptable values are from `1` second to `3600` seconds.
        :param builtins.bool enabled: If connection draining is enabled or not.
        """
    ...
    def drain_timeout_sec(self) -> builtins.int:
        """
...
class ApplicationGatewayCustomErrorConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str custom_error_page_url: Error page URL of the application gateway customer error.
        :param builtins.str status_code: Status code of the application gateway customer error. Possible values are `HttpStatus400`, `HttpStatus403`, `HttpStatus404`, `HttpStatus405`, `HttpStatus408`, `HttpStatus500`, `HttpStatus502`, `HttpStatus503` and `HttpStatus504`
        :param builtins.str id: The ID of the Rewrite Rule Set
        """
...
class ApplicationGatewayFrontendIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_link_configuration_id: Optional[builtins.str] = None,
                 private_link_configuration_name: Optional[builtins.str] = None,
        ...
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str private_ip_address: The Private IP Address to use for the Application Gateway.
        :param builtins.str private_ip_address_allocation: The Allocation Method for the Private IP Address. Possible values are `Dynamic` and `Static`. Defaults to `Dynamic`.
        :param builtins.str private_link_configuration_id: The ID of the associated private link configuration.
        :param builtins.str private_link_configuration_name: The name of the private link configuration to use for this frontend IP configuration.
        :param builtins.str public_ip_address_id: The ID of a Public IP Address which the Application Gateway should use. The allocation method for the Public IP Address depends on the `sku` of this Application Gateway. Please refer to the [Azure documentation for public IP addresses](https://docs.microsoft.com/azure/virtual-network/public-ip-addresses#application-gateways) for details.
    ...
    def private_link_configuration_id(self) -> Optional[builtins.str]:
        """
    ...
    def private_link_configuration_name(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewayFrontendPort(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the Frontend Port.
        :param builtins.int port: The port used for this Frontend Port.
        :param builtins.str id: The ID of the Rewrite Rule Set
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "port", port)
...
class ApplicationGatewayGatewayIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Name of this Gateway IP Configuration.
        :param builtins.str subnet_id: The ID of the Subnet which the Application Gateway should be connected to.
        :param builtins.str id: The ID of the Rewrite Rule Set
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class ApplicationGatewayGlobal(dict):
    ...
    def __init__(__self__, *,
                 request_buffering_enabled: builtins.bool,
                 response_buffering_enabled: builtins.bool):
        """
        :param builtins.bool request_buffering_enabled: Whether Application Gateway's Request buffer is enabled.
        :param builtins.bool response_buffering_enabled: Whether Application Gateway's Response buffer is enabled.
        """
    ...
    def request_buffering_enabled(self) -> builtins.bool:
        """
    ...
    def response_buffering_enabled(self) -> builtins.bool:
        """
...
class ApplicationGatewayHttpListener(dict):
    ...
    def __init__(__self__, *,
                 ...
                 firewall_policy_id: Optional[builtins.str] = None,
                 frontend_ip_configuration_id: Optional[builtins.str] = None,
                 frontend_port_id: Optional[builtins.str] = None,
                 host_name: Optional[builtins.str] = None,
                 host_names: Optional[Sequence[builtins.str]] = None,
                 id: Optional[builtins.str] = None,
                 require_sni: Optional[builtins.bool] = None,
                 ssl_certificate_id: Optional[builtins.str] = None,
                 ssl_certificate_name: Optional[builtins.str] = None,
                 ssl_profile_id: Optional[builtins.str] = None,
                 ssl_profile_name: Optional[builtins.str] = None):
        """
        :param builtins.str frontend_ip_configuration_name: The Name of the Frontend IP Configuration used for this HTTP Listener.
        :param builtins.str frontend_port_name: The Name of the Frontend Port use for this HTTP Listener.
        :param builtins.str name: The Name of the HTTP Listener.
        :param builtins.str protocol: The Protocol to use for this HTTP Listener. Possible values are `Http` and `Https`.
        ...
        :param builtins.str firewall_policy_id: The ID of the Web Application Firewall Policy which should be used for this HTTP Listener.
        :param builtins.str frontend_ip_configuration_id: The ID of the associated Frontend Configuration.
        :param builtins.str frontend_port_id: The ID of the associated Frontend Port.
        ...
        :param builtins.str ssl_certificate_name: The name of the associated SSL Certificate which should be used for this HTTP Listener.
        :param builtins.str ssl_profile_id: The ID of the associated SSL Profile.
        :param builtins.str ssl_profile_name: The name of the associated SSL Profile which should be used for this HTTP Listener.
        """
    ...
    def frontend_ip_configuration_id(self) -> Optional[builtins.str]:
        """
    ...
    def frontend_port_id(self) -> Optional[builtins.str]:
        """
    ...
    def require_sni(self) -> Optional[builtins.bool]:
        """
    ...
    def ssl_certificate_name(self) -> Optional[builtins.str]:
        """
    ...
    def ssl_profile_id(self) -> Optional[builtins.str]:
        """
    ...
    def ssl_profile_name(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewayIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Application Gateway. Only possible value is `UserAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Application Gateway.
        """
...
class ApplicationGatewayPrivateEndpointConnection(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of the Application Gateway. Changing this forces a new resource to be created.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
class ApplicationGatewayPrivateLinkConfigurationIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_ip_address: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the IP configuration.
        :param builtins.bool primary: Is this the Primary IP Configuration?
        :param builtins.str private_ip_address_allocation: The allocation method used for the Private IP Address. Possible values are `Dynamic` and `Static`.
        :param builtins.str subnet_id: The ID of the subnet the private link configuration should connect to.
        :param builtins.str private_ip_address: The Static IP Address which should be used.
        """
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayProbe(dict):
    ...
    def __init__(__self__, *,
                 ...
                 minimum_servers: Optional[builtins.int] = None,
                 pick_host_name_from_backend_http_settings: Optional[builtins.bool] = None,
                 port: Optional[builtins.int] = None):
        """
        :param builtins.int interval: The Interval between two consecutive probes in seconds. Possible values range from 1 second to a maximum of 86,400 seconds.
        :param builtins.str name: The Name of the Probe.
        :param builtins.str path: The Path used for this Probe.
        :param builtins.str protocol: The Protocol used for this Probe. Possible values are `Http` and `Https`.
        :param builtins.int timeout: The Timeout used for this Probe, which indicates when a probe becomes unhealthy. Possible values range from 1 second to a maximum of 86,400 seconds.
        :param builtins.int unhealthy_threshold: The Unhealthy Threshold for this Probe, which indicates the amount of retries which should be attempted before a node is deemed unhealthy. Possible values are from 1 to 20.
        :param builtins.str host: The Hostname used for this Probe. If the Application Gateway is configured for a single site, by default the Host name should be specified as `127.0.0.1`, unless otherwise configured in custom probe. Cannot be set if `pick_host_name_from_backend_http_settings` is set to `true`.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param 'ApplicationGatewayProbeMatchArgs' match: A `match` block as defined above.
        :param builtins.int minimum_servers: The minimum number of servers that are always marked as healthy. Defaults to `0`.
        :param builtins.bool pick_host_name_from_backend_http_settings: Whether the host header should be picked from the backend HTTP settings. Defaults to `false`.
        :param builtins.int port: Custom port which will be used for probing the backend servers. The valid value ranges from 1 to 65535. In case not set, port from HTTP settings will be used. This property is valid for Basic, Standard_v2 and WAF_v2 only.
        """
    ...
    def minimum_servers(self) -> Optional[builtins.int]:
        """
    ...
    def pick_host_name_from_backend_http_settings(self) -> Optional[builtins.bool]:
        """
...
class ApplicationGatewayProbeMatch(dict):
    ...
    def __init__(__self__, *,
                 status_codes: Sequence[builtins.str],
                 body: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] status_codes: A list of allowed status codes for this Health Probe.
        :param builtins.str body: A snippet from the Response Body which must be present in the Response.
        """
    ...
    def status_codes(self) -> Sequence[builtins.str]:
        """
...
class ApplicationGatewayRedirectConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None,
                 include_path: Optional[builtins.bool] = None,
                 include_query_string: Optional[builtins.bool] = None,
                 target_listener_id: Optional[builtins.str] = None,
                 target_listener_name: Optional[builtins.str] = None,
                 target_url: Optional[builtins.str] = None):
        """
        :param builtins.str name: Unique name of the redirect configuration block
        :param builtins.str redirect_type: The type of redirect. Possible values are `Permanent`, `Temporary`, `Found` and `SeeOther`
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.bool include_path: Whether to include the path in the redirected URL. Defaults to `false`
        :param builtins.bool include_query_string: Whether to include the query string in the redirected URL. Default to `false`
        :param builtins.str target_listener_name: The name of the listener to redirect to. Cannot be set if `target_url` is set.
        :param builtins.str target_url: The URL to redirect the request to. Cannot be set if `target_listener_name` is set.
        """
        pulumi.set(__self__, "name", name)
    ...
    def include_path(self) -> Optional[builtins.bool]:
        """
    ...
    def include_query_string(self) -> Optional[builtins.bool]:
        """
    ...
    def target_listener_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "target_listener_id")

    @property
    @pulumi.getter(name="targetListenerName")
    def target_listener_name(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewayRequestRoutingRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 backend_address_pool_id: Optional[builtins.str] = None,
                 backend_address_pool_name: Optional[builtins.str] = None,
                 backend_http_settings_id: Optional[builtins.str] = None,
                 backend_http_settings_name: Optional[builtins.str] = None,
                 http_listener_id: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 priority: Optional[builtins.int] = None,
                 redirect_configuration_id: Optional[builtins.str] = None,
                 redirect_configuration_name: Optional[builtins.str] = None,
                 rewrite_rule_set_id: Optional[builtins.str] = None,
                 rewrite_rule_set_name: Optional[builtins.str] = None,
                 url_path_map_id: Optional[builtins.str] = None,
                 url_path_map_name: Optional[builtins.str] = None):
        """
        :param builtins.str http_listener_name: The Name of the HTTP Listener which should be used for this Routing Rule.
        :param builtins.str name: The Name of this Request Routing Rule.
        :param builtins.str rule_type: The Type of Routing that should be used for this Rule. Possible values are `Basic` and `PathBasedRouting`.
        :param builtins.str backend_address_pool_id: The ID of the associated Backend Address Pool.
        :param builtins.str backend_address_pool_name: The Name of the Backend Address Pool which should be used for this Routing Rule. Cannot be set if `redirect_configuration_name` is set.
        :param builtins.str backend_http_settings_id: The ID of the associated Backend HTTP Settings Configuration.
        :param builtins.str backend_http_settings_name: The Name of the Backend HTTP Settings Collection which should be used for this Routing Rule. Cannot be set if `redirect_configuration_name` is set.
        :param builtins.str http_listener_id: The ID of the associated HTTP Listener.
        :param builtins.str id: The ID of the Rewrite Rule Set
    ...
    def backend_address_pool_id(self) -> Optional[builtins.str]:
        """
    ...
    def backend_address_pool_name(self) -> Optional[builtins.str]:
        """
    ...
    def backend_http_settings_id(self) -> Optional[builtins.str]:
        """
    ...
    def backend_http_settings_name(self) -> Optional[builtins.str]:
        """
    ...
    def http_listener_id(self) -> Optional[builtins.str]:
        """
    ...
    def redirect_configuration_id(self) -> Optional[builtins.str]:
        """
    ...
    def redirect_configuration_name(self) -> Optional[builtins.str]:
        """
    ...
    def rewrite_rule_set_id(self) -> Optional[builtins.str]:
        """
    ...
    def rewrite_rule_set_name(self) -> Optional[builtins.str]:
        """
    ...
    def url_path_map_id(self) -> Optional[builtins.str]:
        """
    ...
    def url_path_map_name(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewayRewriteRuleSet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Unique name of the rewrite rule set block
        :param builtins.str id: The ID of the Rewrite Rule Set
...
class ApplicationGatewayRewriteRuleSetRewriteRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Unique name of the rewrite rule block
        :param builtins.int rule_sequence: Rule sequence of the rewrite rule that determines the order of execution in a set.
    ...
    def rule_sequence(self) -> builtins.int:
        """
...
class ApplicationGatewayRewriteRuleSetRewriteRuleCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str pattern: The pattern, either fixed string or regular expression, that evaluates the truthfulness of the condition.
        :param builtins.str variable: The [variable](https://docs.microsoft.com/azure/application-gateway/rewrite-http-headers#server-variables) of the condition.
        :param builtins.bool ignore_case: Perform a case in-sensitive comparison. Defaults to `false`
        :param builtins.bool negate: Negate the result of the condition evaluation. Defaults to `false`
        """
...
class ApplicationGatewayRewriteRuleSetRewriteRuleRequestHeaderConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str header_name: Header name of the header configuration.
        :param builtins.str header_value: Header value of the header configuration. To delete a request header set this property to an empty string.
        """
...
class ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str header_name: Header name of the header configuration.
        :param builtins.str header_value: Header value of the header configuration. To delete a response header set this property to an empty string.
        """
        pulumi.set(__self__, "header_name", header_name)
        pulumi.set(__self__, "header_value", header_value)
...
class ApplicationGatewayRewriteRuleSetRewriteRuleUrl(dict):
    ...
    def __init__(__self__, *,
                 components: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None,
                 query_string: Optional[builtins.str] = None,
                 reroute: Optional[builtins.bool] = None):
        """
        :param builtins.str components: The components used to rewrite the URL. Possible values are `path_only` and `query_string_only` to limit the rewrite to the URL Path or URL Query String only.
        ...
        :param builtins.str path: The URL path to rewrite.
        :param builtins.str query_string: The query string to rewrite.
        :param builtins.bool reroute: Whether the URL path map should be reevaluated after this rewrite has been applied. [More info on rewrite configuration](https://docs.microsoft.com/azure/application-gateway/rewrite-http-headers-url#rewrite-configuration)
        """
    ...
    @property
    @pulumi.getter
    def components(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def reroute(self) -> Optional[builtins.bool]:
        """
...
class ApplicationGatewaySku(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The Name of the SKU to use for this Application Gateway. Possible values are `Basic`, `Standard_v2`, and `WAF_v2`.
        :param builtins.str tier: The Tier of the SKU to use for this Application Gateway. Possible values are `Basic`, `Standard_v2`, and `WAF_v2`.
        :param builtins.int capacity: The Capacity of the SKU to use for this Application Gateway. When using a V1 SKU this value must be between `1` and `32`, and `1` to `125` for a V2 SKU. When using a `Basic` SKU this property must be between `1` and `2`. This property is optional if `autoscale_configuration` is set.
        """
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewaySslCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None,
                 key_vault_secret_id: Optional[builtins.str] = None,
                 password: Optional[builtins.str] = None,
                 public_cert_data: Optional[builtins.str] = None):
        """
    ...
    def key_vault_secret_id(self) -> Optional[builtins.str]:
        """
    ...
    def public_cert_data(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewaySslPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disabled_protocols: Optional[Sequence[builtins.str]] = None,
    ...
    def disabled_protocols(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ApplicationGatewaySslProfile(dict):
    ...
    def __init__(__self__, *,
                 ...
                 trusted_client_certificate_names: Optional[Sequence[builtins.str]] = None,
                 verify_client_cert_issuer_dn: Optional[builtins.bool] = None,
                 verify_client_certificate_revocation: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the SSL Profile that is unique within this Application Gateway.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param 'ApplicationGatewaySslProfileSslPolicyArgs' ssl_policy: a `ssl_policy` block as defined below.
        :param Sequence[builtins.str] trusted_client_certificate_names: The name of the Trusted Client Certificate that will be used to authenticate requests from clients.
        :param builtins.bool verify_client_cert_issuer_dn: Should client certificate issuer DN be verified? Defaults to `false`.
        :param builtins.str verify_client_certificate_revocation: Specify the method to check client certificate revocation status. Possible value is `OCSP`.
        """
        pulumi.set(__self__, "name", name)
        if id is not None:
            pulumi.set(__self__, "id", id)
    ...
    def trusted_client_certificate_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def verify_client_cert_issuer_dn(self) -> Optional[builtins.bool]:
        """
    ...
    def verify_client_certificate_revocation(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewayTrustedClientCertificate(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str data: The base-64 encoded certificate.
        :param builtins.str name: The name of the Trusted Client Certificate that is unique within this Application Gateway.
        :param builtins.str id: The ID of the Rewrite Rule Set
        """
        pulumi.set(__self__, "data", data)
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayTrustedRootCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_vault_secret_id: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Name of the Trusted Root Certificate to use.
        :param builtins.str data: The contents of the Trusted Root Certificate which should be used. Required if `key_vault_secret_id` is not set.
        :param builtins.str id: The ID of the Rewrite Rule Set
...
class ApplicationGatewayUrlPathMap(dict):
    ...
    def __init__(__self__, *,
                 ...
                 default_backend_address_pool_id: Optional[builtins.str] = None,
                 default_backend_address_pool_name: Optional[builtins.str] = None,
                 default_backend_http_settings_id: Optional[builtins.str] = None,
                 default_backend_http_settings_name: Optional[builtins.str] = None,
                 default_redirect_configuration_id: Optional[builtins.str] = None,
                 default_redirect_configuration_name: Optional[builtins.str] = None,
                 default_rewrite_rule_set_id: Optional[builtins.str] = None,
                 default_rewrite_rule_set_name: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Name of the URL Path Map.
        :param Sequence['ApplicationGatewayUrlPathMapPathRuleArgs'] path_rules: One or more `path_rule` blocks as defined above.
        :param builtins.str default_backend_address_pool_id: The ID of the Default Backend Address Pool.
        :param builtins.str default_backend_address_pool_name: The Name of the Default Backend Address Pool which should be used for this URL Path Map. Cannot be set if `default_redirect_configuration_name` is set.
        :param builtins.str default_backend_http_settings_id: The ID of the Default Backend HTTP Settings Collection.
        :param builtins.str default_backend_http_settings_name: The Name of the Default Backend HTTP Settings Collection which should be used for this URL Path Map. Cannot be set if `default_redirect_configuration_name` is set.
    ...
    def default_backend_address_pool_id(self) -> Optional[builtins.str]:
        """
    ...
    def default_backend_address_pool_name(self) -> Optional[builtins.str]:
        """
    ...
    def default_backend_http_settings_id(self) -> Optional[builtins.str]:
        """
    ...
    def default_backend_http_settings_name(self) -> Optional[builtins.str]:
        """
    ...
    def default_redirect_configuration_id(self) -> Optional[builtins.str]:
        """
    ...
    def default_redirect_configuration_name(self) -> Optional[builtins.str]:
        """
    ...
    def default_rewrite_rule_set_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "default_rewrite_rule_set_id")

    @property
    @pulumi.getter(name="defaultRewriteRuleSetName")
    def default_rewrite_rule_set_name(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewayUrlPathMapPathRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rewrite_rule_set_name: Optional[builtins.str] = None):
        """
        :param builtins.str name: The Name of the Path Rule.
        :param Sequence[builtins.str] paths: A list of Paths used in this Path Rule.
        :param builtins.str backend_address_pool_id: The ID of the associated Backend Address Pool.
        :param builtins.str backend_address_pool_name: The Name of the Backend Address Pool to use for this Path Rule. Cannot be set if `redirect_configuration_name` is set.
        :param builtins.str backend_http_settings_id: The ID of the associated Backend HTTP Settings Configuration.
        :param builtins.str backend_http_settings_name: The Name of the Backend HTTP Settings Collection to use for this Path Rule. Cannot be set if `redirect_configuration_name` is set.
        :param builtins.str firewall_policy_id: The ID of the Web Application Firewall Policy which should be used as an HTTP Listener.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str redirect_configuration_id: The ID of the associated Redirect Configuration.
        :param builtins.str redirect_configuration_name: The Name of a Redirect Configuration to use for this Path Rule. Cannot be set if `backend_address_pool_name` or `backend_http_settings_name` is set.
        :param builtins.str rewrite_rule_set_id: The ID of the associated Rewrite Rule Set.
        :param builtins.str rewrite_rule_set_name: The Name of the Rewrite Rule Set which should be used for this URL Path Map. Only valid for v2 SKUs.
        """
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayWafConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 file_upload_limit_mb: Optional[builtins.int] = None,
                 max_request_body_size_kb: Optional[builtins.int] = None,
                 request_body_check: Optional[builtins.bool] = None,
                 rule_set_type: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Is the Web Application Firewall enabled?
        :param builtins.str firewall_mode: The Web Application Firewall Mode. Possible values are `Detection` and `Prevention`.
        :param builtins.str rule_set_version: The Version of the Rule Set used for this Web Application Firewall. Possible values are `0.1`, `1.0`, `1.1`, `2.1`, `2.2.9`, `3.0`, `3.1` and `3.2`.
        ...
        :param builtins.int file_upload_limit_mb: The File Upload Limit in MB. Accepted values are in the range `1`MB to `750`MB for the `WAF_v2` SKU, and `1`MB to `500`MB for all other SKUs. Defaults to `100`MB.
        :param builtins.int max_request_body_size_kb: The Maximum Request Body Size in KB. Accepted values are in the range `1`KB to `128`KB. Defaults to `128`KB.
        :param builtins.bool request_body_check: Is Request Body Inspection enabled? Defaults to `true`.
        :param builtins.str rule_set_type: The Type of the Rule Set used for this Web Application Firewall. Possible values are `OWASP`, `Microsoft_BotManagerRuleSet` and `Microsoft_DefaultRuleSet`. Defaults to `OWASP`.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def file_upload_limit_mb(self) -> Optional[builtins.int]:
        """
    ...
    def max_request_body_size_kb(self) -> Optional[builtins.int]:
        """
    ...
    def request_body_check(self) -> Optional[builtins.bool]:
        """
    ...
    def rule_set_type(self) -> Optional[builtins.str]:
        """
...
class ApplicationGatewayWafConfigurationDisabledRuleGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rules: Optional[Sequence[builtins.int]] = None):
        """
        :param builtins.str rule_group_name: The rule group where specific rules should be disabled. Possible values are `BadBots`, `crs_20_protocol_violations`, `crs_21_protocol_anomalies`, `crs_23_request_limits`, `crs_30_http_policy`, `crs_35_bad_robots`, `crs_40_generic_attacks`, `crs_41_sql_injection_attacks`, `crs_41_xss_attacks`, `crs_42_tight_security`, `crs_45_trojans`, `crs_49_inbound_blocking`, `General`, `GoodBots`, `KnownBadBots`, `Known-CVEs`, `REQUEST-911-METHOD-ENFORCEMENT`, `REQUEST-913-SCANNER-DETECTION`, `REQUEST-920-PROTOCOL-ENFORCEMENT`, `REQUEST-921-PROTOCOL-ATTACK`, `REQUEST-930-APPLICATION-ATTACK-LFI`, `REQUEST-931-APPLICATION-ATTACK-RFI`, `REQUEST-932-APPLICATION-ATTACK-RCE`, `REQUEST-933-APPLICATION-ATTACK-PHP`, `REQUEST-941-APPLICATION-ATTACK-XSS`, `REQUEST-942-APPLICATION-ATTACK-SQLI`, `REQUEST-943-APPLICATION-ATTACK-SESSION-FIXATION`, `REQUEST-944-APPLICATION-ATTACK-JAVA`, `UnknownBots`, `METHOD-ENFORCEMENT`, `PROTOCOL-ENFORCEMENT`, `PROTOCOL-ATTACK`, `LFI`, `RFI`, `RCE`, `PHP`, `NODEJS`, `XSS`, `SQLI`, `FIX`, `JAVA`, `MS-ThreatIntel-WebShells`, `MS-ThreatIntel-AppSec`, `MS-ThreatIntel-SQLI` and `MS-ThreatIntel-CVEs`.
        :param Sequence[builtins.int] rules: A list of rules which should be disabled in that group. Disables all rules in the specified group if `rules` is not specified.
        """
    ...
    @property
    @pulumi.getter
    def rules(self) -> Optional[Sequence[builtins.int]]:
        """
...
class ApplicationGatewayWafConfigurationExclusion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 selector_match_operator: Optional[builtins.str] = None):
        """
        :param builtins.str match_variable: Match variable of the exclusion rule to exclude header, cookie or GET arguments. Possible values are `RequestArgKeys`, `RequestArgNames`, `RequestArgValues`, `RequestCookieKeys`, `RequestCookieNames`, `RequestCookieValues`, `RequestHeaderKeys`, `RequestHeaderNames` and `RequestHeaderValues`
        :param builtins.str selector: String value which will be used for the filter operation. If empty will exclude all traffic on this `match_variable`
        :param builtins.str selector_match_operator: Operator which will be used to search in the variable content. Possible values are `Contains`, `EndsWith`, `Equals`, `EqualsAny` and `StartsWith`. If empty will exclude all traffic on this `match_variable`
        """
    ...
    def selector_match_operator(self) -> Optional[builtins.str]:
        """
...
class ExpressRouteCircuitPeeringIpv6(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_filter_id: Optional[builtins.str] = None):
        """
        :param builtins.str primary_peer_address_prefix: A subnet for the primary link.
        :param builtins.str secondary_peer_address_prefix: A subnet for the secondary link.
        :param builtins.bool enabled: A boolean value indicating whether the IPv6 peering is enabled. Defaults to `true`.
    ...
    def route_filter_id(self) -> Optional[builtins.str]:
        """
...
class ExpressRouteCircuitPeeringIpv6MicrosoftPeering(dict):
    ...
    def __init__(__self__, *,
                 advertised_communities: Optional[Sequence[builtins.str]] = None,
                 advertised_public_prefixes: Optional[Sequence[builtins.str]] = None,
                 customer_asn: Optional[builtins.int] = None,
                 routing_registry_name: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] advertised_communities: The communities of Bgp Peering specified for microsoft peering.
        :param Sequence[builtins.str] advertised_public_prefixes: A list of Advertised Public Prefixes.
        :param builtins.int customer_asn: The CustomerASN of the peering. Defaults to `0`.
        :param builtins.str routing_registry_name: The Routing Registry against which the AS number and prefixes are registered. For example: `ARIN`, `RIPE`, `AFRINIC` etc. Defaults to `NONE`.
        """
    ...
    def advertised_communities(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def advertised_public_prefixes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def routing_registry_name(self) -> Optional[builtins.str]:
        """
...
class ExpressRouteCircuitPeeringMicrosoftPeeringConfig(dict):
    ...
    def __init__(__self__, *,
                 advertised_public_prefixes: Sequence[builtins.str],
                 advertised_communities: Optional[Sequence[builtins.str]] = None,
                 customer_asn: Optional[builtins.int] = None,
                 routing_registry_name: Optional[builtins.str] = None):
        """
    ...
    @property
    @pulumi.getter(name="advertisedPublicPrefixes")
    def advertised_public_prefixes(self) -> Sequence[builtins.str]:
        """
        A list of Advertised Public Prefixes.
        """
        return pulumi.get(self, "advertised_public_prefixes")
...
class ExpressRouteConnectionRouting(dict):
    ...
    def __init__(__self__, *,
                 associated_route_table_id: Optional[builtins.str] = None,
                 inbound_route_map_id: Optional[builtins.str] = None,
                 outbound_route_map_id: Optional[builtins.str] = None,
                 propagated_route_table: Optional['outputs.ExpressRouteConnectionRoutingPropagatedRouteTable'] = None):
        """
        :param builtins.str associated_route_table_id: The ID of the Virtual Hub Route Table associated with this Express Route Connection.
        :param builtins.str inbound_route_map_id: The ID of the Route Map associated with this Express Route Connection for inbound routes.
        :param builtins.str outbound_route_map_id: The ID of the Route Map associated with this Express Route Connection for outbound routes.
    ...
    def associated_route_table_id(self) -> Optional[builtins.str]:
        """
    ...
    def inbound_route_map_id(self) -> Optional[builtins.str]:
        """
    ...
    def outbound_route_map_id(self) -> Optional[builtins.str]:
        """
...
class ExpressRouteConnectionRoutingPropagatedRouteTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_table_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] labels: The list of labels to logically group route tables.
        :param Sequence[builtins.str] route_table_ids: A list of IDs of the Virtual Hub Route Table to propagate routes from Express Route Connection to the route table.
        """
...
class ExpressRoutePortIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Express Route Port. Only possible value is `UserAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Express Route Port.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ExpressRoutePortLink1(dict):
    ...
    def __init__(__self__, *,
                 ...
                 macsec_cak_keyvault_secret_id: Optional[builtins.str] = None,
                 macsec_cipher: Optional[builtins.str] = None,
                 macsec_ckn_keyvault_secret_id: Optional[builtins.str] = None,
                 macsec_sci_enabled: Optional[builtins.bool] = None,
                 patch_panel_id: Optional[builtins.str] = None,
                 rack_id: Optional[builtins.str] = None,
                 router_name: Optional[builtins.str] = None):
        """
        :param builtins.bool admin_enabled: Whether enable administration state on the Express Route Port Link? Defaults to `false`.
        :param builtins.str connector_type: The connector type of the Express Route Port Link.
        :param builtins.str id: The ID of this Express Route Port Link.
        :param builtins.str interface_name: The interface name of the Azure router associated with the Express Route Port Link.
        :param builtins.str macsec_cak_keyvault_secret_id: The ID of the Key Vault Secret that contains the Mac security CAK key for this Express Route Port Link.
        :param builtins.str macsec_cipher: The MACSec cipher used for this Express Route Port Link. Possible values are `GcmAes128` and `GcmAes256`. Defaults to `GcmAes128`.
    ...
    def macsec_cak_keyvault_secret_id(self) -> Optional[builtins.str]:
        """
    ...
    def macsec_cipher(self) -> Optional[builtins.str]:
        """
    ...
    def macsec_ckn_keyvault_secret_id(self) -> Optional[builtins.str]:
        """
    ...
    def macsec_sci_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def patch_panel_id(self) -> Optional[builtins.str]:
        """
    ...
    def rack_id(self) -> Optional[builtins.str]:
        """
    ...
    def router_name(self) -> Optional[builtins.str]:
        """
...
class FirewallApplicationRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fqdn_tags: Optional[Sequence[builtins.str]] = None,
                 ...
                 source_ip_groups: Optional[Sequence[builtins.str]] = None,
                 target_fqdns: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str name: Specifies the name of the rule.
        :param builtins.str description: Specifies a description for the rule.
        :param Sequence[builtins.str] fqdn_tags: A list of FQDN tags. Possible values are `AppServiceEnvironment`, `AzureBackup`, `AzureKubernetesService`, `HDInsight`, `MicrosoftActiveProtectionService`, `WindowsDiagnostics`, `WindowsUpdate` and `WindowsVirtualDesktop`.
    ...
    def fqdn_tags(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def source_ip_groups(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def target_fqdns(self) -> Optional[Sequence[builtins.str]]:
        """
        A list of FQDNs.
        """
...
class FirewallApplicationRuleCollectionRuleProtocol(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.int port: Specify a port for the connection.
        :param builtins.str type: Specifies the type of connection. Possible values are `Http`, `Https` and `Mssql`.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "type", type)
...
class FirewallNatRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_ip_groups: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] destination_addresses: A list of destination IP addresses and/or IP ranges.
        :param Sequence[builtins.str] destination_ports: A list of destination ports.
        :param builtins.str name: Specifies the name of the rule.
        :param Sequence[builtins.str] protocols: A list of protocols. Possible values are `Any`, `ICMP`, `TCP` and `UDP`. If `action` is `Dnat`, protocols can only be `TCP` and `UDP`.
        :param builtins.str translated_address: The address of the service behind the Firewall.
        :param builtins.str translated_port: The port of the service behind the Firewall.
        :param builtins.str description: Specifies a description for the rule.
        :param Sequence[builtins.str] source_addresses: A list of source IP addresses and/or IP ranges.
        :param Sequence[builtins.str] source_ip_groups: A list of source IP Group IDs for the rule.
...
class FirewallNetworkRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_fqdns: Optional[Sequence[builtins.str]] = None,
                 destination_ip_groups: Optional[Sequence[builtins.str]] = None,
                 source_addresses: Optional[Sequence[builtins.str]] = None,
                 source_ip_groups: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] destination_ports: A list of destination ports.
        :param builtins.str name: Specifies the name of the rule.
        :param Sequence[builtins.str] protocols: A list of protocols. Possible values are `Any`, `ICMP`, `TCP` and `UDP`.
        :param builtins.str description: Specifies a description for the rule.
    ...
    def destination_fqdns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def destination_ip_groups(self) -> Optional[Sequence[builtins.str]]:
        """
...
class FirewallPolicyDns(dict):
    ...
    def __init__(__self__, *,
                 proxy_enabled: Optional[builtins.bool] = None,
                 servers: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.bool proxy_enabled: Whether to enable DNS proxy on Firewalls attached to this Firewall Policy? Defaults to `false`.
        :param Sequence[builtins.str] servers: A list of custom DNS servers' IP addresses.
        """
    ...
    def proxy_enabled(self) -> Optional[builtins.bool]:
        """
...
class FirewallPolicyExplicitProxy(dict):
    ...
    def __init__(__self__, *,
                 enable_pac_file: Optional[builtins.bool] = None,
                 enabled: Optional[builtins.bool] = None,
                 http_port: Optional[builtins.int] = None,
                 https_port: Optional[builtins.int] = None,
                 pac_file: Optional[builtins.str] = None,
                 pac_file_port: Optional[builtins.int] = None):
        """
        :param builtins.bool enable_pac_file: Whether the pac file port and url need to be provided.
        :param builtins.bool enabled: Whether the explicit proxy is enabled for this Firewall Policy.
        :param builtins.int http_port: The port number for explicit http protocol.
        :param builtins.int https_port: The port number for explicit proxy https protocol.
        :param builtins.str pac_file: Specifies a SAS URL for PAC file.
        :param builtins.int pac_file_port: Specifies a port number for firewall to serve PAC file.
        """
    ...
    def enable_pac_file(self) -> Optional[builtins.bool]:
        """
    ...
    def pac_file(self) -> Optional[builtins.str]:
        """
    ...
    def pac_file_port(self) -> Optional[builtins.int]:
        """
...
class FirewallPolicyIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[builtins.str] = None):
        """
        :param builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Firewall Policy. Only possible value is `UserAssigned`.
        :param Sequence[builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Firewall Policy.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class FirewallPolicyInsights(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_log_analytics_workspace_id: The ID of the default Log Analytics Workspace that the Firewalls associated with this Firewall Policy will send their logs to, when there is no location matches in the `log_analytics_workspace`.
        :param builtins.bool enabled: Whether the insights functionality is enabled for this Firewall Policy.
        ...
        :param builtins.int retention_in_days: The log retention period in days.
        """
...
class FirewallPolicyInsightsLogAnalyticsWorkspace(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: builtins.str):
        """
        :param builtins.str firewall_location: The location of the Firewalls, that when matches this Log Analytics Workspace will be used to consume their logs.
        :param builtins.str id: The ID of the Log Analytics Workspace that the Firewalls associated with this Firewall Policy will send their logs to when their locations match the `firewall_location`.
        """
...
class FirewallPolicyIntrusionDetection(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_ranges: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param builtins.str mode: In which mode you want to run intrusion detection: `Off`, `Alert` or `Deny`.
        :param Sequence[builtins.str] private_ranges: A list of Private IP address ranges to identify traffic direction. By default, only ranges defined by IANA RFC 1918 are considered private IP addresses.
    ...
    def private_ranges(self) -> Optional[Sequence[builtins.str]]:
        """
...
class FirewallPolicyIntrusionDetectionSignatureOverride(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: 12-digit number (id) which identifies your signature.
        :param builtins.str state: state can be any of `Off`, `Alert` or `Deny`.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class FirewallPolicyIntrusionDetectionTrafficBypass(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_ip_groups: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str name: The name which should be used for this bypass traffic setting.
        :param builtins.str protocol: The protocols any of `ANY`, `TCP`, `ICMP`, `UDP` that shall be bypassed by intrusion detection.
        :param builtins.str description: The description for this bypass traffic setting.
        :param Sequence[builtins.str] destination_addresses: Specifies a list of destination IP addresses that shall be bypassed by intrusion detection.
        :param Sequence[builtins.str] destination_ip_groups: Specifies a list of destination IP groups that shall be bypassed by intrusion detection.
        :param Sequence[builtins.str] destination_ports: Specifies a list of destination IP ports that shall be bypassed by intrusion detection.
        :param Sequence[builtins.str] source_addresses: Specifies a list of source addresses that shall be bypassed by intrusion detection.
        :param Sequence[builtins.str] source_ip_groups: Specifies a list of source IP groups that shall be bypassed by intrusion detection.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "protocol", protocol)
        if description is not None:
...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollection(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to take for the application rules in this collection. Possible values are `Allow` and `Deny`.
        :param builtins.str name: The name which should be used for this application rule collection.
        :param builtins.int priority: The priority of the application rule collection. The range is `100` - `65000`.
...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None,
                 destination_addresses: Optional[Sequence[builtins.str]] = None,
                 destination_fqdn_tags: Optional[Sequence[builtins.str]] = None,
                 destination_fqdns: Optional[Sequence[builtins.str]] = None,
                 destination_urls: Optional[Sequence[builtins.str]] = None,
                 ...
                 source_addresses: Optional[Sequence[builtins.str]] = None,
                 source_ip_groups: Optional[Sequence[builtins.str]] = None,
                 terminate_tls: Optional[builtins.bool] = None,
                 web_categories: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str name: The name which should be used for this Firewall Policy Rule Collection Group. Changing this forces a new Firewall Policy Rule Collection Group to be created.
        :param Sequence[builtins.str] destination_fqdn_tags: Specifies a list of destination FQDN tags.
        :param Sequence[builtins.str] destination_urls: Specifies a list of destination URLs for which policy should hold. Needs Premium SKU for Firewall Policy. Conflicts with `destination_fqdns`.
        ...
        :param builtins.bool terminate_tls: Boolean specifying if TLS shall be terminated (true) or not (false). Must be `true` when using `destination_urls`. Needs Premium SKU for Firewall Policy.
        :param Sequence[builtins.str] web_categories: Specifies a list of web categories to which access is denied or allowed depending on the value of `action` above. Needs Premium SKU for Firewall Policy.
        """
        pulumi.set(__self__, "name", name)
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    def destination_fqdn_tags(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def destination_urls(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def terminate_tls(self) -> Optional[builtins.bool]:
        """
    ...
    def web_categories(self) -> Optional[Sequence[builtins.str]]:
        """
...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: Specifies the name of the header.
        :param builtins.str value: Specifies the value of the value.
        """
        pulumi.set(__self__, "name", name)
...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleProtocol(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.int port: Port number of the protocol. Range is 0-64000.
        :param builtins.str type: Protocol type. Possible values are `Http` and `Https`.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "type", type)
...
class FirewallPolicyRuleCollectionGroupNatRuleCollection(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to take for the NAT rules in this collection. Currently, the only possible value is `Dnat`.
        :param builtins.str name: The name which should be used for this NAT rule collection.
        :param builtins.int priority: The priority of the NAT rule collection. The range is `100` - `65000`.
...
class FirewallPolicyRuleCollectionGroupNatRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 protocols: Sequence[builtins.str],
                 translated_port: builtins.int,
                 description: Optional[builtins.str] = None,
                 destination_address: Optional[builtins.str] = None,
                 destination_ports: Optional[builtins.str] = None,
                 source_addresses: Optional[Sequence[builtins.str]] = None,
                 source_ip_groups: Optional[Sequence[builtins.str]] = None,
                 translated_address: Optional[builtins.str] = None,
                 translated_fqdn: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name which should be used for this Firewall Policy Rule Collection Group. Changing this forces a new Firewall Policy Rule Collection Group to be created.
        :param builtins.int translated_port: Specifies the translated port.
        :param builtins.str destination_address: The destination IP address (including CIDR).
    ...
    @property
    @pulumi.getter(name="translatedPort")
    def translated_port(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="destinationPorts")
    def destination_ports(self) -> Optional[builtins.str]:
        return pulumi.get(self, "destination_ports")
    ...
    @property
    @pulumi.getter(name="translatedAddress")
    def translated_address(self) -> Optional[builtins.str]:
        """
    ...
    def translated_fqdn(self) -> Optional[builtins.str]:
        """
...
class FirewallPolicyRuleCollectionGroupNetworkRuleCollection(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to take for the network rules in this collection. Possible values are `Allow` and `Deny`.
        :param builtins.str name: The name which should be used for this network rule collection.
        :param builtins.int priority: The priority of the network rule collection. The range is `100` - `65000`.
...
class FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name which should be used for this Firewall Policy Rule Collection Group. Changing this forces a new Firewall Policy Rule Collection Group to be created.
        :param Sequence[builtins.str] destination_ip_groups: Specifies a list of destination IP groups.
        """
        pulumi.set(__self__, "destination_ports", destination_ports)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "protocols", protocols)
...
class FirewallPolicyThreatIntelligenceAllowlist(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_addresses: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] fqdns: A list of FQDNs that will be skipped for threat detection.
        :param Sequence[builtins.str] ip_addresses: A list of IP addresses or CIDR ranges that will be skipped for threat detection.
        """
        if fqdns is not None:
            pulumi.set(__self__, "fqdns", fqdns)
        if ip_addresses is not None:
...
class FirewallPolicyTlsCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str key_vault_secret_id: The Secret Identifier (URI) of the certificate stored in Azure Key Vault, either as a secret or certificate.
...
class FirewallVirtualHub(dict):
    ...
    def __init__(__self__, *,
                 ...
                 public_ip_count: Optional[builtins.int] = None):
        """
        :param builtins.str virtual_hub_id: Specifies the ID of the Virtual Hub where the Firewall resides in.
        :param builtins.str private_ip_address: The private IP address associated with the Firewall.
        :param Sequence[builtins.str] public_ip_addresses: The list of public IP addresses associated with the Firewall.
        :param builtins.int public_ip_count: Specifies the number of public IPs to assign to the Firewall. Defaults to `1`.
        """
    ...
    def public_ip_count(self) -> Optional[builtins.int]:
        """
...
class LocalNetworkGatewayBgpSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 peer_weight: Optional[builtins.int] = None):
        """
        :param builtins.int asn: The BGP speaker's ASN.
        :param builtins.str bgp_peering_address: The BGP peering address and BGP identifier of this BGP speaker.
        :param builtins.int peer_weight: The weight added to routes learned from this BGP speaker.
        """
    ...
    def peer_weight(self) -> Optional[builtins.int]:
        """
...
class NetworkConnectionMonitorEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 coverage_level: Optional[builtins.str] = None,
                 excluded_ip_addresses: Optional[Sequence[builtins.str]] = None,
                 filter: Optional['outputs.NetworkConnectionMonitorEndpointFilter'] = None,
                 included_ip_addresses: Optional[Sequence[builtins.str]] = None,
                 target_resource_id: Optional[builtins.str] = None,
                 target_resource_type: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the endpoint for the Network Connection Monitor .
        :param builtins.str address: The IP address or domain name of the Network Connection Monitor endpoint.
        :param builtins.str coverage_level: The test coverage for the Network Connection Monitor endpoint. Possible values are `AboveAverage`, `Average`, `BelowAverage`, `Default`, `Full` and `Low`.
        :param Sequence[builtins.str] excluded_ip_addresses: A list of IPv4/IPv6 subnet masks or IPv4/IPv6 IP addresses to be excluded to the Network Connection Monitor endpoint.
        :param 'NetworkConnectionMonitorEndpointFilterArgs' filter: A `filter` block as defined below.
        :param Sequence[builtins.str] included_ip_addresses: A list of IPv4/IPv6 subnet masks or IPv4/IPv6 IP addresses to be included to the Network Connection Monitor endpoint.
        :param builtins.str target_resource_id: The resource ID which is used as the endpoint by the Network Connection Monitor.
        :param builtins.str target_resource_type: The endpoint type of the Network Connection Monitor. Possible values are `AzureArcVM`, `AzureSubnet`, `AzureVM`, `AzureVNet`, `ExternalAddress`, `MMAWorkspaceMachine` and `MMAWorkspaceNetwork`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def coverage_level(self) -> Optional[builtins.str]:
        """
    ...
    def excluded_ip_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def included_ip_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkConnectionMonitorEndpointFilter(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: The behaviour type of this endpoint filter. Currently the only allowed value is `Include`. Defaults to `Include`.
        """
...
class NetworkConnectionMonitorEndpointFilterItem(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str address: The address of the filter item.
        :param builtins.str type: The type of items included in the filter. Possible values are `AgentAddress`. Defaults to `AgentAddress`.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
        if type is not None:
...
class NetworkConnectionMonitorTestConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 preferred_ip_version: Optional[builtins.str] = None,
                 ...
                 test_frequency_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.str name: The name of test configuration for the Network Connection Monitor.
        :param builtins.str protocol: The protocol used to evaluate tests. Possible values are `Tcp`, `Http` and `Icmp`.
        ...
        :param builtins.str preferred_ip_version: The preferred IP version which is used in the test evaluation. Possible values are `IPv4` and `IPv6`.
        ...
        :param builtins.int test_frequency_in_seconds: The time interval in seconds at which the test evaluation will happen. Defaults to `60`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "protocol", protocol)
    ...
    def preferred_ip_version(self) -> Optional[builtins.str]:
        """
    ...
    def test_frequency_in_seconds(self) -> Optional[builtins.int]:
        """
...
class NetworkConnectionMonitorTestConfigurationHttpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path: Optional[builtins.str] = None,
                 port: Optional[builtins.int] = None,
                 prefer_https: Optional[builtins.bool] = None,
                 request_headers: Optional[Sequence['outputs.NetworkConnectionMonitorTestConfigurationHttpConfigurationRequestHeader']] = None,
                 valid_status_code_ranges: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str method: The HTTP method for the HTTP request. Possible values are `Get` and `Post`. Defaults to `Get`.
        :param builtins.str path: The path component of the URI. It only accepts the absolute path.
        :param builtins.int port: The port for the HTTP connection.
        :param builtins.bool prefer_https: Should HTTPS be preferred over HTTP in cases where the choice is not explicit? Defaults to `false`.
        ...
        :param Sequence[builtins.str] valid_status_code_ranges: The HTTP status codes to consider successful. For instance, `2xx`, `301-304` and `418`.
        """
    ...
    def prefer_https(self) -> Optional[builtins.bool]:
        """
    ...
    def valid_status_code_ranges(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkConnectionMonitorTestConfigurationHttpConfigurationRequestHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the HTTP header.
...
class NetworkConnectionMonitorTestConfigurationIcmpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 trace_route_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool trace_route_enabled: Should path evaluation with trace route be enabled? Defaults to `true`.
        """
    ...
    def trace_route_enabled(self) -> Optional[builtins.bool]:
        """
...
class NetworkConnectionMonitorTestConfigurationSuccessThreshold(dict):
    ...
    def __init__(__self__, *,
                 checks_failed_percent: Optional[builtins.int] = None,
                 round_trip_time_ms: Optional[builtins.float] = None):
        """
        :param builtins.int checks_failed_percent: The maximum percentage of failed checks permitted for a test to be successful.
        :param builtins.float round_trip_time_ms: The maximum round-trip time in milliseconds permitted for a test to be successful.
        """
    ...
    def checks_failed_percent(self) -> Optional[builtins.int]:
        """
    ...
    def round_trip_time_ms(self) -> Optional[builtins.float]:
        """
...
class NetworkConnectionMonitorTestConfigurationTcpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 port: builtins.int,
                 destination_port_behavior: Optional[builtins.str] = None,
                 trace_route_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.int port: The port for the TCP connection.
        :param builtins.str destination_port_behavior: The destination port behavior for the TCP connection. Possible values are `None` and `ListenIfAvailable`.
        :param builtins.bool trace_route_enabled: Should path evaluation with trace route be enabled? Defaults to `true`.
        """
        pulumi.set(__self__, "port", port)
    ...
    def destination_port_behavior(self) -> Optional[builtins.str]:
        """
...
class NetworkConnectionMonitorTestGroup(dict):
    ...
    def __init__(__self__, *,
                 destination_endpoints: Sequence[builtins.str],
                 name: builtins.str,
                 source_endpoints: Sequence[builtins.str],
                 test_configuration_names: Sequence[builtins.str],
                 enabled: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] destination_endpoints: A list of destination endpoint names.
        :param builtins.str name: The name of the test group for the Network Connection Monitor.
        :param Sequence[builtins.str] source_endpoints: A list of source endpoint names.
        :param Sequence[builtins.str] test_configuration_names: A list of test configuration names.
        :param builtins.bool enabled: Should the test group be enabled? Defaults to `true`.
        """
    ...
    def destination_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def source_endpoints(self) -> Sequence[builtins.str]:
        """
    ...
    def test_configuration_names(self) -> Sequence[builtins.str]:
        """
...
class NetworkInterfaceIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subnet_id: Optional[builtins.str] = None):
        """
        :param builtins.str name: A name used for this IP Configuration.
        :param builtins.str private_ip_address_allocation: The allocation method used for the Private IP Address. Possible values are `Dynamic` and `Static`.
        ...
        :param builtins.bool primary: Is this the Primary IP Configuration? Must be `true` for the first `ip_configuration` when multiple are specified. Defaults to `false`.
        :param builtins.str private_ip_address: The first private IP address of the network interface.
        :param builtins.str private_ip_address_version: The IP Version to use. Possible values are `IPv4` or `IPv6`. Defaults to `IPv4`.
        :param builtins.str public_ip_address_id: Reference to a Public IP Address to associate with this NIC
        :param builtins.str subnet_id: The ID of the Subnet where this Network Interface should be located in.
...
class NetworkManagerAdminRuleDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address_prefix: Specifies the address prefix.
        :param builtins.str address_prefix_type: Specifies the address prefix type. Possible values are `IPPrefix` and `ServiceTag`. For more information, please see [this document](https://learn.microsoft.com/en-us/azure/virtual-network-manager/concept-security-admins#source-and-destination-types).
        """
...
class NetworkManagerConnectivityConfigurationAppliesToGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 global_mesh_enabled: Optional[builtins.bool] = None,
                 use_hub_gateway: Optional[builtins.bool] = None):
        """
        :param builtins.str group_connectivity: Specifies the group connectivity type. Possible values are `None` and `DirectlyConnected`.
    ...
    def global_mesh_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def use_hub_gateway(self) -> Optional[builtins.bool]:
        """
...
class NetworkManagerConnectivityConfigurationHub(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_id: Specifies the resource ID used as hub in Hub And Spoke topology.
        :param builtins.str resource_type: Specifies the resource Type used as hub in Hub And Spoke topology.
        """
...
class NetworkManagerCrossTenantScope(dict):
    ...
    def __init__(__self__, *,
                 management_groups: Optional[Sequence[builtins.str]] = None,
                 subscriptions: Optional[Sequence[builtins.str]] = None,
                 tenant_id: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] management_groups: List of management groups.
        :param Sequence[builtins.str] subscriptions: List of subscriptions.
    ...
    def management_groups(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def subscriptions(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkManagerScope(dict):
    ...
    def __init__(__self__, *,
                 management_group_ids: Optional[Sequence[builtins.str]] = None,
    ...
    def management_group_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkSecurityGroupSecurityRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_application_security_group_ids: Optional[Sequence[builtins.str]] = None,
                 ...
                 source_application_security_group_ids: Optional[Sequence[builtins.str]] = None,
                 source_port_range: Optional[builtins.str] = None,
                 source_port_ranges: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str access: Specifies whether network traffic is allowed or denied. Possible values are `Allow` and `Deny`.
        :param builtins.str direction: The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are `Inbound` and `Outbound`.
        :param builtins.str name: The name of the security rule.
        :param builtins.int priority: Specifies the priority of the rule. The value can be between 100 and 4096. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
        :param builtins.str protocol: Network protocol this rule applies to. Possible values include `Tcp`, `Udp`, `Icmp`, `Esp`, `Ah` or `*` (which matches all).
        :param builtins.str description: A description for this rule. Restricted to 140 characters.
        :param builtins.str destination_address_prefix: CIDR or destination IP range or * to match any IP. Tags such as `VirtualNetwork`, `AzureLoadBalancer` and `Internet` can also be used. This is required if `destination_address_prefixes` is not specified.
        :param Sequence[builtins.str] destination_address_prefixes: List of destination address prefixes. Tags may not be used. This is required if `destination_address_prefix` is not specified.
        :param Sequence[builtins.str] destination_application_security_group_ids: A List of destination Application Security Group IDs
        :param builtins.str destination_port_range: Destination Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `destination_port_ranges` is not specified.
        :param Sequence[builtins.str] destination_port_ranges: List of destination ports or port ranges. This is required if `destination_port_range` is not specified.
        :param builtins.str source_address_prefix: CIDR or source IP range or * to match any IP. Tags such as `VirtualNetwork`, `AzureLoadBalancer` and `Internet` can also be used. This is required if `source_address_prefixes` is not specified.
        :param Sequence[builtins.str] source_address_prefixes: List of source address prefixes. Tags may not be used. This is required if `source_address_prefix` is not specified.
        :param Sequence[builtins.str] source_application_security_group_ids: A List of source Application Security Group IDs
        :param builtins.str source_port_range: Source Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `source_port_ranges` is not specified.
        :param Sequence[builtins.str] source_port_ranges: List of source ports or port ranges. This is required if `source_port_range` is not specified.
        """
    ...
    def destination_application_security_group_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def source_application_security_group_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkWatcherFlowLogRetentionPolicy(dict):
    def __init__(__self__, *,
                 ...
                 enabled: builtins.bool):
        """
        :param builtins.int days: The number of days to retain flow log records.
        :param builtins.bool enabled: Boolean flag to enable/disable retention.
        """
...
class NetworkWatcherFlowLogTrafficAnalytics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Boolean flag to enable/disable traffic analytics.
        :param builtins.str workspace_id: The resource GUID of the attached workspace.
        :param builtins.str workspace_region: The location of the attached workspace.
        :param builtins.str workspace_resource_id: The resource ID of the attached workspace.
        :param builtins.int interval_in_minutes: How frequently service should do flow analytics in minutes. Defaults to `60`.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class PointToPointVpnGatewayConnectionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 internet_security_enabled: Optional[builtins.bool] = None,
                 route: Optional['outputs.PointToPointVpnGatewayConnectionConfigurationRoute'] = None):
        """
        :param builtins.str name: The Name which should be used for this Connection Configuration.
        ...
        :param builtins.bool internet_security_enabled: Should Internet Security be enabled to secure internet traffic? Changing this forces a new resource to be created. Defaults to `false`.
    ...
    def internet_security_enabled(self) -> Optional[builtins.bool]:
        """
...
class PointToPointVpnGatewayConnectionConfigurationRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str associated_route_table_id: The Virtual Hub Route Table resource id associated with this Routing Configuration.
        :param builtins.str inbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param builtins.str outbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
...
class PointToPointVpnGatewayConnectionConfigurationRoutePropagatedRouteTable(dict):
    def __init__(__self__, *,
                 ...
                 labels: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] ids: The list of Virtual Hub Route Table resource id which the routes will be propagated to.
        :param Sequence[builtins.str] labels: The list of labels to logically group Virtual Hub Route Tables which the routes will be propagated to.
        """
...
class PointToPointVpnGatewayConnectionConfigurationVpnClientAddressPool(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] address_prefixes: A list of CIDR Ranges which should be used as Address Prefixes.
        """
...
class ProfileContainerNetworkInterfaceIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies the name of the IP Configuration.
        :param builtins.str subnet_id: Reference to the subnet associated with the IP Configuration.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class RouteFilterRule(dict):
    ...
    def __init__(__self__, *,
                 access: builtins.str,
                 communities: Sequence[builtins.str],
                 name: builtins.str,
                 rule_type: builtins.str):
        """
        :param builtins.str access: The access type of the rule. The only possible value is `Allow`.
        :param Sequence[builtins.str] communities: The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].
        :param builtins.str name: The name of the route filter rule.
        :param builtins.str rule_type: The rule type of the rule. The only possible value is `Community`.
        """
        pulumi.set(__self__, "access", access)
...
class RouteMapRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 next_step_if_matched: Optional[builtins.str] = None):
        """
        :param builtins.str name: The unique name for the rule.
        ...
        :param builtins.str next_step_if_matched: The next step after the rule is evaluated. Possible values are `Continue`, `Terminate` and `Unknown`. Defaults to `Unknown`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def next_step_if_matched(self) -> Optional[builtins.str]:
        """
...
class RouteMapRuleAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of the action to be taken. Possible values are `Add`, `Drop`, `Remove`, `Replace` and `Unknown`.
...
class RouteMapRuleActionParameter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_prefixes: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] as_paths: A list of AS paths.
        :param Sequence[builtins.str] communities: A list of BGP communities.
        :param Sequence[builtins.str] route_prefixes: A list of route prefixes.
        """
    ...
    def route_prefixes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RouteMapRuleMatchCriterion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_prefixes: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str match_condition: The match condition to apply the rule of the Route Map. Possible values are `Contains`, `Equals`, `NotContains`, `NotEquals` and `Unknown`.
        :param Sequence[builtins.str] as_paths: A list of AS paths which this criterion matches.
        :param Sequence[builtins.str] communities: A list of BGP communities which this criterion matches.
        :param Sequence[builtins.str] route_prefixes: A list of route prefixes which this criterion matches.
        """
...
class RouteTableRoute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 next_hop_in_ip_address: Optional[builtins.str] = None):
        """
        :param builtins.str address_prefix: The destination to which the route applies. Can be CIDR (such as `10.1.0.0/16`) or [Azure Service Tag](https://docs.microsoft.com/azure/virtual-network/service-tags-overview) (such as `ApiManagement`, `AzureBackup` or `AzureMonitor`) format.
        :param builtins.str name: The name of the route.
        :param builtins.str next_hop_type: The type of Azure hop the packet should be sent to. Possible values are `VirtualNetworkGateway`, `VnetLocal`, `Internet`, `VirtualAppliance` and `None`.
        :param builtins.str next_hop_in_ip_address: Contains the IP address packets should be forwarded to. Next hop values are only allowed in routes where the next hop type is `VirtualAppliance`.
        """
        pulumi.set(__self__, "address_prefix", address_prefix)
        pulumi.set(__self__, "name", name)
    ...
    def next_hop_in_ip_address(self) -> Optional[builtins.str]:
        """
...
class RoutingIntentRoutingPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] destinations: A list of destinations which this routing policy is applicable to. Possible values are `Internet` and `PrivateTraffic`.
        :param builtins.str name: The unique name for the routing policy.
        :param builtins.str next_hop: The resource ID of the next hop on which this routing policy is applicable to.
        """
...
class SubnetDelegation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: A name for this delegation.
...
class SubnetServiceEndpointStoragePolicyDefinition(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 service_resources: Sequence[builtins.str],
                 description: Optional[builtins.str] = None,
    ...
    def service_resources(self) -> Sequence[builtins.str]:
        """
...
class TrafficManagerAzureEndpointSubnet(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str first: The first IP Address in this subnet.
        :param builtins.str last: The last IP Address in this subnet.
        :param builtins.int scope: The block size (number of leading bits in the subnet mask).
        """
...
class VirtualHubConnectionRouting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 static_vnet_local_route_override_criteria: Optional[builtins.str] = None,
                 static_vnet_propagate_static_routes_enabled: Optional[builtins.bool] = None,
                 static_vnet_routes: Optional[Sequence['outputs.VirtualHubConnectionRoutingStaticVnetRoute']] = None):
        """
        :param builtins.str associated_route_table_id: The ID of the route table associated with this Virtual Hub connection.
        :param builtins.str inbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param builtins.str outbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
        ...
        :param builtins.str static_vnet_local_route_override_criteria: The static VNet local route override criteria that is used to determine whether NVA in spoke VNet is bypassed for traffic with destination in spoke VNet. Possible values are `Contains` and `Equal`. Defaults to `Contains`. Changing this forces a new resource to be created.
        :param builtins.bool static_vnet_propagate_static_routes_enabled: Whether the static routes should be propagated to the Virtual Hub. Defaults to `true`.
    ...
    def static_vnet_local_route_override_criteria(self) -> Optional[builtins.str]:
        """
    ...
    def static_vnet_propagate_static_routes_enabled(self) -> Optional[builtins.bool]:
        """
...
class VirtualHubConnectionRoutingPropagatedRouteTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_table_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] labels: The list of labels to assign to this route table.
        :param Sequence[builtins.str] route_table_ids: A list of Route Table IDs to associated with this Virtual Hub Connection.
        """
        if labels is not None:
            pulumi.set(__self__, "labels", labels)
        if route_table_ids is not None:
...
class VirtualHubConnectionRoutingStaticVnetRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] address_prefixes: A list of CIDR Ranges which should be used as Address Prefixes.
        :param builtins.str name: The name which should be used for this Static Route.
        :param builtins.str next_hop_ip_address: The IP Address which should be used for the Next Hop.
        """
...
class VirtualHubRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] address_prefixes: A list of Address Prefixes.
        :param builtins.str next_hop_ip_address: The IP Address that Packets should be forwarded to as the Next Hop.
        """
        pulumi.set(__self__, "address_prefixes", address_prefixes)
        pulumi.set(__self__, "next_hop_ip_address", next_hop_ip_address)
...
class VirtualHubRouteTableRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] destinations: A list of destination addresses for this route.
        :param builtins.str destinations_type: The type of destinations. Possible values are `CIDR`, `ResourceId` and `Service`.
        :param builtins.str name: The name which should be used for this route.
        :param builtins.str next_hop: The next hop's resource ID.
        :param builtins.str next_hop_type: The type of next hop. Currently the only possible value is `ResourceId`. Defaults to `ResourceId`.
...
class VirtualNetworkDdosProtectionPlan(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str):
        """
        :param builtins.bool enable: Enable/disable DDoS Protection Plan on Virtual Network.
        :param builtins.str id: The ID of DDoS Protection Plan.
        """
...
class VirtualNetworkGatewayBgpSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int asn: The Autonomous System Number (ASN) to use as part of the BGP.
        :param builtins.int peer_weight: The weight added to routes which have been learned through BGP peering. Valid values can be between `0` and `100`.
...
class VirtualNetworkGatewayBgpSettingsPeeringAddress(dict):
    ...
    def __init__(__self__, *,
                 apipa_addresses: Optional[Sequence[builtins.str]] = None,
                 default_addresses: Optional[Sequence[builtins.str]] = None,
                 ip_configuration_name: Optional[builtins.str] = None,
                 tunnel_ip_addresses: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] apipa_addresses: A list of Azure custom APIPA addresses assigned to the BGP peer of the Virtual Network Gateway.
               
               > **Note:** The valid range for the reserved APIPA address in Azure Public is from `169.254.21.0` to `169.254.22.255`.
        :param Sequence[builtins.str] default_addresses: A list of peering address assigned to the BGP peer of the Virtual Network Gateway.
        :param builtins.str ip_configuration_name: The name of the IP configuration of this Virtual Network Gateway. In case there are multiple `ip_configuration` blocks defined, this property is **required** to specify.
        :param Sequence[builtins.str] tunnel_ip_addresses: A list of tunnel IP addresses assigned to the BGP peer of the Virtual Network Gateway.
        """
    ...
    def apipa_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def default_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def ip_configuration_name(self) -> Optional[builtins.str]:
        """
    ...
    def tunnel_ip_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
...
class VirtualNetworkGatewayConnectionCustomBgpAddresses(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str primary: single IP address that is part of the `network.VirtualNetworkGateway` ip_configuration (first one)
        :param builtins.str secondary: single IP address that is part of the `network.VirtualNetworkGateway` ip_configuration (second one)
        """
        pulumi.set(__self__, "primary", primary)
...
class VirtualNetworkGatewayConnectionIpsecPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sa_datasize: Optional[builtins.int] = None,
                 sa_lifetime: Optional[builtins.int] = None):
        """
        :param builtins.str dh_group: The DH group used in IKE phase 1 for initial SA. Valid options are `DHGroup1`, `DHGroup14`, `DHGroup2`, `DHGroup2048`, `DHGroup24`, `ECP256`, `ECP384`, or `None`.
        :param builtins.str ike_encryption: The IKE encryption algorithm. Valid options are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, or `GCMAES256`.
        :param builtins.str ike_integrity: The IKE integrity algorithm. Valid options are `GCMAES128`, `GCMAES256`, `MD5`, `SHA1`, `SHA256`, or `SHA384`.
        :param builtins.str ipsec_encryption: The IPSec encryption algorithm. Valid options are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256`, or `None`.
        :param builtins.str ipsec_integrity: The IPSec integrity algorithm. Valid options are `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1`, or `SHA256`.
        :param builtins.str pfs_group: The DH group used in IKE phase 2 for new child SA.
               Valid options are `ECP256`, `ECP384`, `PFS1`, `PFS14`, `PFS2`, `PFS2048`, `PFS24`, `PFSMM`,
               or `None`.
        :param builtins.int sa_datasize: The IPSec SA payload size in KB. Must be at least `1024` KB. Defaults to `102400000` KB.
        :param builtins.int sa_lifetime: The IPSec SA lifetime in seconds. Must be at least `300` seconds. Defaults to `27000` seconds.
        """
    ...
    def sa_datasize(self) -> Optional[builtins.int]:
        """
    ...
    def sa_lifetime(self) -> Optional[builtins.int]:
        """
...
class VirtualNetworkGatewayConnectionTrafficSelectorPolicy(dict):
    ...
    def __init__(__self__, *,
                 local_address_cidrs: Sequence[builtins.str],
                 remote_address_cidrs: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] local_address_cidrs: List of local CIDRs.
        :param Sequence[builtins.str] remote_address_cidrs: List of remote CIDRs.
        """
    ...
    def local_address_cidrs(self) -> Sequence[builtins.str]:
        """
        List of local CIDRs.
        """
    ...
    def remote_address_cidrs(self) -> Sequence[builtins.str]:
        """
...
class VirtualNetworkGatewayIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_ip_address_allocation: Optional[builtins.str] = None):
        """
        :param builtins.str public_ip_address_id: The ID of the public IP address to associate with the Virtual Network Gateway.
        :param builtins.str subnet_id: The ID of the gateway subnet of a virtual network in which the virtual network gateway will be created. It is mandatory that the associated subnet is named `GatewaySubnet`. Therefore, each virtual network can contain at most a single Virtual Network Gateway.
        :param builtins.str name: A user-defined name of the IP configuration. Defaults to `vnetGatewayConfig`.
        :param builtins.str private_ip_address_allocation: Defines how the private IP address of the gateways virtual interface is assigned. The only valid value is `Dynamic` for Virtual Network Gateway (`Static` is not supported by the service yet). Defaults to `Dynamic`.
        """
        pulumi.set(__self__, "public_ip_address_id", public_ip_address_id)
        pulumi.set(__self__, "subnet_id", subnet_id)
        if name is not None:
...
class VirtualNetworkGatewayNatRuleExternalMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address_space: The string CIDR representing the address space for the Virtual Network Gateway Nat Rule external mapping.
        :param builtins.str port_range: The single port range for the Virtual Network Gateway Nat Rule external mapping.
        """
...
class VirtualNetworkGatewayNatRuleInternalMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port_range: Optional[builtins.str] = None):
        """
        :param builtins.str address_space: The string CIDR representing the address space for the Virtual Network Gateway Nat Rule internal mapping.
        :param builtins.str port_range: The single port range for the Virtual Network Gateway Nat Rule internal mapping.
        """
        pulumi.set(__self__, "address_space", address_space)
        if port_range is not None:
            pulumi.set(__self__, "port_range", port_range)
...
class VirtualNetworkGatewayPolicyGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 priority: Optional[builtins.int] = None):
        """
        :param builtins.str name: The name of the Virtual Network Gateway Policy Group.
        ...
        :param builtins.bool is_default: Is this a Default Virtual Network Gateway Policy Group? Defaults to `false`.
        :param builtins.int priority: The priority for the Virtual Network Gateway Policy Group. Defaults to `0`.
        """
        pulumi.set(__self__, "name", name)
...
class VirtualNetworkGatewayPolicyGroupPolicyMember(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the Virtual Network Gateway Policy Group Member.
        :param builtins.str type: The VPN Policy Member attribute type. Possible values are `AADGroupId`, `CertificateGroupId` and `RadiusAzureGroupId`.
        :param builtins.str value: The value of attribute that is used for this Virtual Network Gateway Policy Group Member.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class VirtualNetworkGatewayVpnClientConfiguration(dict):
    ...
    def __init__(__self__, *,
                 address_spaces: Sequence[builtins.str],
                 aad_audience: Optional[builtins.str] = None,
                 aad_issuer: Optional[builtins.str] = None,
                 aad_tenant: Optional[builtins.str] = None,
                 ...
                 vpn_auth_types: Optional[Sequence[builtins.str]] = None,
                 vpn_client_protocols: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] address_spaces: The address space out of which IP addresses for vpn clients will be taken. You can provide more than one address space, e.g. in CIDR notation.
        :param builtins.str aad_audience: The client id of the Azure VPN application.
               See [Create an Active Directory (AD) tenant for P2S OpenVPN protocol connections](https://docs.microsoft.com/en-gb/azure/vpn-gateway/openvpn-azure-ad-tenant-multi-app) for values
        :param builtins.str aad_issuer: The STS url for your tenant
        :param builtins.str aad_tenant: AzureAD Tenant URL
        :param 'VirtualNetworkGatewayVpnClientConfigurationIpsecPolicyArgs' ipsec_policy: An `ipsec_policy` block as defined below.
        :param builtins.str radius_server_address: The address of the Radius server.
        :param builtins.str radius_server_secret: The secret used by the Radius server.
    ...
    def aad_audience(self) -> Optional[builtins.str]:
        """
    ...
    def aad_issuer(self) -> Optional[builtins.str]:
        """
    ...
    def aad_tenant(self) -> Optional[builtins.str]:
        """
        AzureAD Tenant URL
        """
    ...
    def vpn_auth_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def vpn_client_protocols(self) -> Optional[Sequence[builtins.str]]:
        """
...
class VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ipsec_integrity: builtins.str,
                 pfs_group: builtins.str,
                 sa_data_size_in_kilobytes: builtins.int,
                 sa_lifetime_in_seconds: builtins.int):
        """
        :param builtins.str dh_group: The DH Group, used in IKE Phase 1. Possible values are `DHGroup1`, `DHGroup2`, `DHGroup14`, `DHGroup24`, `DHGroup2048`, `ECP256`, `ECP384` and `None`.
        :param builtins.str ike_encryption: The IKE encryption algorithm, used for IKE Phase 2. Possible values are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128` and `GCMAES256`.
        :param builtins.str ike_integrity: The IKE encryption integrity algorithm, used for IKE Phase 2. Possible values are `GCMAES128`, `GCMAES256`, `MD5`, `SHA1`, `SHA256` and `SHA384`.
        :param builtins.str ipsec_encryption: The IPSec encryption algorithm, used for IKE phase 1. Possible values are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256` and `None`.
        :param builtins.str ipsec_integrity: The IPSec integrity algorithm, used for IKE phase 1. Possible values are `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1` and `SHA256`.
        :param builtins.str pfs_group: The Pfs Group, used in IKE Phase 2. Possible values are `ECP256`, `ECP384`, `PFS1`, `PFS2`, `PFS14`, `PFS24`, `PFS2048`, `PFSMM` and `None`.
        :param builtins.int sa_data_size_in_kilobytes: The IPSec Security Association payload size in KB for a Site-to-Site VPN tunnel. Possible values are between `1024` and `2147483647`.
        :param builtins.int sa_lifetime_in_seconds: The IPSec Security Association lifetime in seconds for a Site-to-Site VPN tunnel. Possible values are between `300` and `172799`.
        """
        pulumi.set(__self__, "dh_group", dh_group)
        pulumi.set(__self__, "ike_encryption", ike_encryption)
        pulumi.set(__self__, "ike_integrity", ike_integrity)
    ...
    def sa_data_size_in_kilobytes(self) -> builtins.int:
        """
    ...
    def sa_lifetime_in_seconds(self) -> builtins.int:
        """
...
class VirtualNetworkGatewayVpnClientConfigurationRadiusServer(dict):
    def __init__(__self__, *,
                 ...
                 secret: builtins.str):
        """
        :param builtins.str address: The address of the Radius Server.
        :param builtins.int score: The score of the Radius Server determines the priority of the server. Possible values are between `1` and `30`.
        :param builtins.str secret: The secret that is used to communicate with the Radius Server.
        """
        pulumi.set(__self__, "address", address)
...
class VirtualNetworkGatewayVpnClientConfigurationRevokedCertificate(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies the name of the certificate resource.
        :param builtins.str thumbprint: Specifies the public data of the certificate.
        """
        pulumi.set(__self__, "name", name)
...
class VirtualNetworkGatewayVpnClientConfigurationRootCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: A user-defined name of the root certificate.
        :param builtins.str public_cert_data: The public certificate of the root certificate authority. The certificate must be provided in Base-64 encoded X.509 format (PEM). In particular, this argument *must not* include the `-----BEGIN CERTIFICATE-----` or `-----END CERTIFICATE-----` markers, nor any newlines.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "public_cert_data", public_cert_data)
...
class VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] address_prefixes: A list of address prefixes for P2S VPN Client.
        :param builtins.str name: The name of the Virtual Network Gateway Client Connection.
        :param Sequence[builtins.str] policy_group_names: A list of names of Virtual Network Gateway Policy Groups.
        """
        pulumi.set(__self__, "address_prefixes", address_prefixes)
        pulumi.set(__self__, "name", name)
...
class VirtualNetworkIpAddressPool(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allocated_ip_address_prefixes: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str id: The ID of the Network Manager IP Address Management (IPAM) Pool.
        :param builtins.str number_of_ip_addresses: The number of IP addresses to allocated to the Virtual Network. The value must be a string that represents a positive number, e.g., `"100"`.
        :param Sequence[builtins.str] allocated_ip_address_prefixes: The list of IP address prefixes allocated to the Virtual Network.
        """
        pulumi.set(__self__, "id", id)
    ...
    def allocated_ip_address_prefixes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class VirtualNetworkSubnet(dict):
    ...
    def __init__(__self__, *,
                 address_prefixes: Sequence[builtins.str],
                 name: builtins.str,
                 default_outbound_access_enabled: Optional[builtins.bool] = None,
                 ...
                 private_link_service_network_policies_enabled: Optional[builtins.bool] = None,
                 route_table_id: Optional[builtins.str] = None,
                 security_group: Optional[builtins.str] = None,
                 service_endpoint_policy_ids: Optional[Sequence[builtins.str]] = None,
                 service_endpoints: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] address_prefixes: The address prefixes to use for the subnet.
        :param builtins.str name: The name of the subnet.
        :param builtins.bool default_outbound_access_enabled: Enable default outbound access to the internet for the subnet. Defaults to `true`.
    ...
    def default_outbound_access_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def private_link_service_network_policies_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def service_endpoint_policy_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def service_endpoints(self) -> Optional[Sequence[builtins.str]]:
        """
...
class VnpGatewayNatRuleExternalMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port_range: Optional[builtins.str] = None):
        """
        :param builtins.str address_space: The string CIDR representing the address space for the VPN Gateway Nat Rule external mapping.
        :param builtins.str port_range: The single port range for the VPN Gateway Nat Rule external mapping.
        """
        pulumi.set(__self__, "address_space", address_space)
        if port_range is not None:
            pulumi.set(__self__, "port_range", port_range)
...
class VnpGatewayNatRuleInternalMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port_range: Optional[builtins.str] = None):
        """
        :param builtins.str address_space: The string CIDR representing the address space for the VPN Gateway Nat Rule internal mapping.
        :param builtins.str port_range: The single port range for the VPN Gateway Nat Rule internal mapping.
        """
        pulumi.set(__self__, "address_space", address_space)
        if port_range is not None:
            pulumi.set(__self__, "port_range", port_range)
...
class VpnGatewayBgpSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bgp_peering_address: Optional[builtins.str] = None,
        ...
        """
        :param builtins.int asn: The ASN of the BGP Speaker. Changing this forces a new resource to be created.
        :param builtins.int peer_weight: The weight added to Routes learned from this BGP Speaker. Changing this forces a new resource to be created.
        :param builtins.str bgp_peering_address: The Address which should be used for the BGP Peering.
    ...
    @property
    @pulumi.getter(name="peerWeight")
    def peer_weight(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="bgpPeeringAddress")
    def bgp_peering_address(self) -> Optional[builtins.str]:
        """
...
class VpnGatewayBgpSettingsInstance0BgpPeeringAddress(dict):
    ...
    def __init__(__self__, *,
                 custom_ips: Sequence[builtins.str],
                 default_ips: Optional[Sequence[builtins.str]] = None,
                 ip_configuration_id: Optional[builtins.str] = None,
                 tunnel_ips: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] custom_ips: A list of custom BGP peering addresses to assign to this instance.
        :param Sequence[builtins.str] default_ips: The list of default BGP peering addresses which belong to the pre-defined VPN Gateway IP configuration.
        :param builtins.str ip_configuration_id: The pre-defined id of VPN Gateway IP Configuration.
        :param Sequence[builtins.str] tunnel_ips: The list of tunnel public IP addresses which belong to the pre-defined VPN Gateway IP configuration.
        """
    ...
    def custom_ips(self) -> Sequence[builtins.str]:
        """
    ...
    def default_ips(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def tunnel_ips(self) -> Optional[Sequence[builtins.str]]:
        """
...
class VpnGatewayConnectionRouting(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str associated_route_table: The ID of the Route Table associated with this VPN Connection.
        :param builtins.str inbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param builtins.str outbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
...
class VpnGatewayConnectionRoutingPropagatedRouteTable(dict):
    ...
    def __init__(__self__, *,
                 route_table_ids: Sequence[builtins.str],
                 labels: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] route_table_ids: A list of Route Table IDs to associated with this VPN Gateway Connection.
        :param Sequence[builtins.str] labels: A list of labels to assign to this route table.
        """
        pulumi.set(__self__, "route_table_ids", route_table_ids)
        if labels is not None:
            pulumi.set(__self__, "labels", labels)
...
class VpnGatewayConnectionTrafficSelectorPolicy(dict):
    ...
    def __init__(__self__, *,
                 local_address_ranges: Sequence[builtins.str],
                 remote_address_ranges: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] local_address_ranges: A list of local address spaces in CIDR format for this VPN Gateway Connection.
        :param Sequence[builtins.str] remote_address_ranges: A list of remote address spaces in CIDR format for this VPN Gateway Connection.
        """
    ...
    def local_address_ranges(self) -> Sequence[builtins.str]:
        """
    ...
    def remote_address_ranges(self) -> Sequence[builtins.str]:
        """
...
class VpnGatewayConnectionVpnLink(dict):
    ...
    def __init__(__self__, *,
                 ...
                 bgp_enabled: Optional[builtins.bool] = None,
                 ...
                 egress_nat_rule_ids: Optional[Sequence[builtins.str]] = None,
                 ingress_nat_rule_ids: Optional[Sequence[builtins.str]] = None,
                 ipsec_policies: Optional[Sequence['outputs.VpnGatewayConnectionVpnLinkIpsecPolicy']] = None,
                 local_azure_ip_address_enabled: Optional[builtins.bool] = None,
                 policy_based_traffic_selector_enabled: Optional[builtins.bool] = None,
                 protocol: Optional[builtins.str] = None,
                 ratelimit_enabled: Optional[builtins.bool] = None,
                 route_weight: Optional[builtins.int] = None,
                 shared_key: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name which should be used for this VPN Link Connection.
        :param builtins.str vpn_site_link_id: The ID of the connected VPN Site Link. Changing this forces a new VPN Gateway Connection to be created.
        :param builtins.int bandwidth_mbps: The expected connection bandwidth in MBPS. Defaults to `10`.
        :param builtins.bool bgp_enabled: Should the BGP be enabled? Defaults to `false`. Changing this forces a new VPN Gateway Connection to be created.
        :param builtins.str connection_mode: The connection mode of this VPN Link. Possible values are `Default`, `InitiatorOnly` and `ResponderOnly`. Defaults to `Default`.
        ...
        :param Sequence[builtins.str] egress_nat_rule_ids: A list of the egress NAT Rule Ids.
        :param Sequence[builtins.str] ingress_nat_rule_ids: A list of the ingress NAT Rule Ids.
        ...
        :param builtins.bool local_azure_ip_address_enabled: Whether to use local Azure IP to initiate connection? Defaults to `false`.
        :param builtins.bool policy_based_traffic_selector_enabled: Whether to enable policy-based traffic selectors? Defaults to `false`.
        :param builtins.str protocol: The protocol used for this VPN Link Connection. Possible values are `IKEv1` and `IKEv2`. Defaults to `IKEv2`.
        :param builtins.bool ratelimit_enabled: Should the rate limit be enabled? Defaults to `false`.
        :param builtins.int route_weight: Routing weight for this VPN Link Connection. Defaults to `0`.
        :param builtins.str shared_key: SharedKey for this VPN Link Connection.
        """
        pulumi.set(__self__, "name", name)
    ...
    def bgp_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def egress_nat_rule_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def ingress_nat_rule_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def local_azure_ip_address_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def policy_based_traffic_selector_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def ratelimit_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def route_weight(self) -> Optional[builtins.int]:
        """
...
class VpnGatewayConnectionVpnLinkCustomBgpAddress(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ip_address: The custom bgp ip address which belongs to the IP Configuration.
        :param builtins.str ip_configuration_id: The ID of the IP Configuration which belongs to the VPN Gateway.
        """
...
class VpnGatewayConnectionVpnLinkIpsecPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pfs_group: builtins.str,
                 sa_data_size_kb: builtins.int,
                 sa_lifetime_sec: builtins.int):
        """
        :param builtins.str dh_group: The DH Group used in IKE Phase 1 for initial SA. Possible values are `None`, `DHGroup1`, `DHGroup2`, `DHGroup14`, `DHGroup24`, `DHGroup2048`, `ECP256`, `ECP384`.
        :param builtins.str encryption_algorithm: The IPSec encryption algorithm (IKE phase 1). Possible values are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256`, `None`.
        :param builtins.str ike_encryption_algorithm: The IKE encryption algorithm (IKE phase 2). Possible values are `DES`, `DES3`, `AES128`, `AES192`, `AES256`, `GCMAES128`, `GCMAES256`.
        :param builtins.str ike_integrity_algorithm: The IKE integrity algorithm (IKE phase 2). Possible values are `MD5`, `SHA1`, `SHA256`, `SHA384`, `GCMAES128`, `GCMAES256`.
        :param builtins.str integrity_algorithm: The IPSec integrity algorithm (IKE phase 1). Possible values are `MD5`, `SHA1`, `SHA256`, `GCMAES128`, `GCMAES192`, `GCMAES256`.
        :param builtins.str pfs_group: The Pfs Group used in IKE Phase 2 for the new child SA. Possible values are `None`, `PFS1`, `PFS2`, `PFS14`, `PFS24`, `PFS2048`, `PFSMM`, `ECP256`, `ECP384`.
        :param builtins.int sa_data_size_kb: The IPSec Security Association (also called Quick Mode or Phase 2 SA) payload size in KB for the site to site VPN tunnel.
        :param builtins.int sa_lifetime_sec: The IPSec Security Association (also called Quick Mode or Phase 2 SA) lifetime in seconds for the site to site VPN tunnel.
        """
        pulumi.set(__self__, "dh_group", dh_group)
    ...
    def sa_data_size_kb(self) -> builtins.int:
        """
    ...
    def sa_lifetime_sec(self) -> builtins.int:
        """
...
class VpnGatewayIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The identifier of the IP configuration for the VPN Gateway.
        :param builtins.str private_ip_address: The private IP address of this IP configuration.
        :param builtins.str public_ip_address: The public IP address of this IP configuration.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if private_ip_address is not None:
...
class VpnServerConfigurationAzureActiveDirectoryAuthentication(dict):
    def __init__(__self__, *,
                 ...
                 tenant: builtins.str):
        """
        :param builtins.str audience: The Audience which should be used for authentication.
        :param builtins.str issuer: The Issuer which should be used for authentication.
        :param builtins.str tenant: The Tenant which should be used for authentication.
        """
...
class VpnServerConfigurationClientRevokedCertificate(dict):
    def __init__(__self__, *,
                 ...
                 thumbprint: builtins.str):
        """
        :param builtins.str name: A name used to uniquely identify this certificate.
...
class VpnServerConfigurationClientRootCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: A name used to uniquely identify this certificate.
        :param builtins.str public_cert_data: The Public Key Data associated with the Certificate.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "public_cert_data", public_cert_data)
...
class VpnServerConfigurationIpsecPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sa_lifetime_seconds: builtins.int):
        """
        :param builtins.str dh_group: The DH Group, used in IKE Phase 1. Possible values include `DHGroup1`, `DHGroup2`, `DHGroup14`, `DHGroup24`, `DHGroup2048`, `ECP256`, `ECP384` and `None`.
        :param builtins.str ike_encryption: The IKE encryption algorithm, used for IKE Phase 2. Possible values include `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128` and `GCMAES256`.
        :param builtins.str ike_integrity: The IKE encryption integrity algorithm, used for IKE Phase 2. Possible values include `GCMAES128`, `GCMAES256`, `MD5`, `SHA1`, `SHA256` and `SHA384`.
        :param builtins.str ipsec_encryption: The IPSec encryption algorithm, used for IKE phase 1. Possible values include `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256` and `None`.
        :param builtins.str ipsec_integrity: The IPSec integrity algorithm, used for IKE phase 1. Possible values include `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1` and `SHA256`.
        :param builtins.str pfs_group: The Pfs Group, used in IKE Phase 2. Possible values include `ECP256`, `ECP384`, `PFS1`, `PFS2`, `PFS14`, `PFS24`, `PFS2048`, `PFSMM` and `None`.
        :param builtins.int sa_data_size_kilobytes: The IPSec Security Association payload size in KB for a Site-to-Site VPN tunnel.
        :param builtins.int sa_lifetime_seconds: The IPSec Security Association lifetime in seconds for a Site-to-Site VPN tunnel.
        """
        pulumi.set(__self__, "dh_group", dh_group)
        pulumi.set(__self__, "ike_encryption", ike_encryption)
        pulumi.set(__self__, "ike_integrity", ike_integrity)
    ...
    def sa_lifetime_seconds(self) -> builtins.int:
        """
...
class VpnServerConfigurationPolicyGroupPolicy(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the VPN Server Configuration Policy member.
        :param builtins.str type: The attribute type of the VPN Server Configuration Policy member. Possible values are `AADGroupId`, `CertificateGroupId` and `RadiusAzureGroupId`.
        :param builtins.str value: The value of the attribute that is used for the VPN Server Configuration Policy member.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class VpnServerConfigurationRadiusServer(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address: The Address of the Radius Server.
        :param builtins.int score: The Score of the Radius Server determines the priority of the server. Ranges from 1 to 30.
        :param builtins.str secret: The Secret used to communicate with the Radius Server.
        """
        pulumi.set(__self__, "address", address)
        pulumi.set(__self__, "score", score)
        pulumi.set(__self__, "secret", secret)
...
class VpnSiteLink(dict):
    ...
    def __init__(__self__, *,
                 ...
                 speed_in_mbps: Optional[builtins.int] = None):
        """
    ...
    def speed_in_mbps(self) -> Optional[builtins.int]:
        """
...
class VpnSiteLinkBgp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int asn: The BGP speaker's ASN.
        :param builtins.str peering_address: The BGP peering IP address.
        """
        pulumi.set(__self__, "asn", asn)
...
class VpnSiteO365PolicyTrafficCategory(dict):
    ...
    def __init__(__self__, *,
                 allow_endpoint_enabled: Optional[builtins.bool] = None,
                 default_endpoint_enabled: Optional[builtins.bool] = None,
                 optimize_endpoint_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool allow_endpoint_enabled: Is allow endpoint enabled? The `Allow` endpoint is required for connectivity to specific O365 services and features, but are not as sensitive to network performance and latency as other endpoint types. Defaults to `false`.
        :param builtins.bool default_endpoint_enabled: Is default endpoint enabled? The `Default` endpoint represents O365 services and dependencies that do not require any optimization, and can be treated by customer networks as normal Internet bound traffic. Defaults to `false`.
        :param builtins.bool optimize_endpoint_enabled: Is optimize endpoint enabled? The `Optimize` endpoint is required for connectivity to every O365 service and represents the O365 scenario that is the most sensitive to network performance, latency, and availability. Defaults to `false`.
        """
    ...
    def allow_endpoint_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def default_endpoint_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def optimize_endpoint_enabled(self) -> Optional[builtins.bool]:
        """
...
class GetApplicationGatewayAutoscaleConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 min_capacity: builtins.int):
        """
        :param builtins.int max_capacity: Maximum capacity for autoscaling.
        :param builtins.int min_capacity: Minimum capacity for autoscaling.
        """
        pulumi.set(__self__, "max_capacity", max_capacity)
        pulumi.set(__self__, "min_capacity", min_capacity)
...
class GetApplicationGatewayBackendAddressPoolResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param Sequence[builtins.str] fqdns: A list of FQDNs which are part of the Backend Address Pool.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param Sequence[builtins.str] ip_addresses: A list of IP Addresses which are part of the Backend Address Pool.
        :param builtins.str name: The name of this Application Gateway.
        """
        pulumi.set(__self__, "fqdns", fqdns)
        pulumi.set(__self__, "id", id)
...
class GetApplicationGatewayBackendHttpSettingResult(dict):
    def __init__(__self__, *,
                 ...
                 port: builtins.int,
                 probe_id: builtins.str,
                 probe_name: builtins.str,
                 protocol: builtins.str,
                 request_timeout: builtins.int,
                 trusted_root_certificate_names: Sequence[builtins.str]):
        """
        :param builtins.str affinity_cookie_name: The name of the affinity cookie.
        ...
        :param builtins.str cookie_based_affinity: Is Cookie-Based Affinity enabled?
        :param builtins.str host_name: The Hostname which is used for this HTTP Listener.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.str path: The URL path to rewrite.
        :param builtins.bool pick_host_name_from_backend_address: Whether host header will be picked from the host name of the backend server.
        :param builtins.int port: Custom port which is used for probing the backend servers.
        :param builtins.str probe_id: The ID of the associated Probe.
        :param builtins.str probe_name: The name of the associated HTTP Probe.
        :param builtins.str protocol: The Protocol used for this Probe.
        :param builtins.int request_timeout: The request timeout in seconds.
        :param Sequence[builtins.str] trusted_root_certificate_names: A list of `trusted_root_certificate` names.
        """
        pulumi.set(__self__, "affinity_cookie_name", affinity_cookie_name)
        pulumi.set(__self__, "authentication_certificates", authentication_certificates)
    ...
    @property
    @pulumi.getter(name="pickHostNameFromBackendAddress")
    def pick_host_name_from_backend_address(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="trustedRootCertificateNames")
    def trusted_root_certificate_names(self) -> Sequence[builtins.str]:
        """
        A list of `trusted_root_certificate` names.
        """
        return pulumi.get(self, "trusted_root_certificate_names")
...
class GetApplicationGatewayBackendHttpSettingConnectionDrainingResult(dict):
    def __init__(__self__, *,
                 ...
                 enabled: builtins.bool):
        """
        :param builtins.int drain_timeout_sec: The number of seconds connection draining is active.
        :param builtins.bool enabled: Is the Web Application Firewall enabled?
        """
        pulumi.set(__self__, "drain_timeout_sec", drain_timeout_sec)
        pulumi.set(__self__, "enabled", enabled)
...
class GetApplicationGatewayCustomErrorConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 status_code: builtins.str):
        """
        :param builtins.str custom_error_page_url: Error page URL of the application gateway custom error.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str status_code: Status code of the application gateway custom error.
        """
        pulumi.set(__self__, "custom_error_page_url", custom_error_page_url)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "status_code", status_code)
...
class GetApplicationGatewayFrontendIpConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 private_ip_address_allocation: builtins.str,
                 private_link_configuration_id: builtins.str,
                 private_link_configuration_name: builtins.str,
                 public_ip_address_id: builtins.str,
                 subnet_id: builtins.str):
        """
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.str private_ip_address: The Static IP Address which is used.
        :param builtins.str private_ip_address_allocation: The allocation method used for the Private IP Address.
        :param builtins.str private_link_configuration_id: The ID of the associated Private Link configuration.
        :param builtins.str private_link_configuration_name: The name of the Private Link configuration in use by this Frontend IP Configuration.
        :param builtins.str public_ip_address_id: The ID of the Public IP Address which the Application Gateway will use.
        :param builtins.str subnet_id: The ID of the subnet the private link configuration is connected to.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "private_ip_address", private_ip_address)
...
class GetApplicationGatewayHttpListenerResult(dict):
    def __init__(__self__, *,
                 ...
                 frontend_ip_configuration_id: builtins.str,
                 frontend_ip_configuration_name: builtins.str,
                 frontend_port_id: builtins.str,
                 frontend_port_name: builtins.str,
                 host_name: builtins.str,
                 ...
                 name: builtins.str,
                 protocol: builtins.str,
                 require_sni: builtins.bool,
                 ssl_certificate_id: builtins.str,
                 ssl_certificate_name: builtins.str,
                 ssl_profile_id: builtins.str,
                 ssl_profile_name: builtins.str):
        """
        ...
        :param builtins.str firewall_policy_id: The ID of the Web Application Firewall Policy which is used as an HTTP Listener for this Path Rule.
        :param builtins.str frontend_ip_configuration_id: The ID of the associated Frontend Configuration.
        :param builtins.str frontend_ip_configuration_name: The Name of the Frontend IP Configuration used for this HTTP Listener.
        :param builtins.str frontend_port_id: The ID of the associated Frontend Port.
        :param builtins.str frontend_port_name: The Name of the Frontend Port used for this HTTP Listener.
        :param builtins.str host_name: The Hostname which is used for this HTTP Listener.
        :param Sequence[builtins.str] host_names: A list of Hostname(s) used for this HTTP Listener. It allows special wildcard characters.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.str protocol: The Protocol used for this Probe.
        :param builtins.bool require_sni: Is Server Name Indication required?
        :param builtins.str ssl_certificate_id: The ID of the associated SSL Certificate.
        :param builtins.str ssl_certificate_name: The name of the associated SSL Certificate which is used for this HTTP Listener.
        :param builtins.str ssl_profile_id: The ID of the associated SSL Profile.
        :param builtins.str ssl_profile_name: The name of the associated SSL Profile which is used for this HTTP Listener.
        """
        pulumi.set(__self__, "custom_error_configurations", custom_error_configurations)
        pulumi.set(__self__, "firewall_policy_id", firewall_policy_id)
        pulumi.set(__self__, "frontend_ip_configuration_id", frontend_ip_configuration_id)
    ...
    @property
    @pulumi.getter(name="requireSni")
    def require_sni(self) -> builtins.bool:
        """
...
class GetApplicationGatewayIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Application Gateway.
        :param builtins.str type: The type of Managed Service Identity that is configured on this Application Gateway.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetApplicationGatewayProbeResult(dict):
    def __init__(__self__, *,
                 ...
                 unhealthy_threshold: builtins.int):
        """
        :param builtins.str host: The Hostname used for this Probe.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.int interval: The Interval between two consecutive probes in seconds.
        :param Sequence['GetApplicationGatewayProbeMatchArgs'] matches: A `match` block as defined above.
        :param builtins.int minimum_servers: The minimum number of servers that are always marked as healthy.
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.str path: The URL path to rewrite.
        :param builtins.bool pick_host_name_from_backend_http_settings: Whether the host header is picked from the backend HTTP settings.
        :param builtins.int port: Custom port which is used for probing the backend servers.
        :param builtins.str protocol: The Protocol used for this Probe.
        :param builtins.int timeout: The Timeout used for this Probe, indicating when a probe becomes unhealthy.
        :param builtins.int unhealthy_threshold: The Unhealthy Threshold for this Probe, which indicates the amount of retries which will be attempted before a node is deemed unhealthy.
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "interval", interval)
    ...
    @property
    @pulumi.getter(name="minimumServers")
    def minimum_servers(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="pickHostNameFromBackendHttpSettings")
    def pick_host_name_from_backend_http_settings(self) -> builtins.bool:
        """
...
class GetApplicationGatewayProbeMatchResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str body: A snippet from the Response Body which must be present in the Response.
        :param Sequence[builtins.str] status_codes: Status code of the application gateway custom error.
        """
        pulumi.set(__self__, "body", body)
        pulumi.set(__self__, "status_codes", status_codes)
...
class GetApplicationGatewayRedirectConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 redirect_type: builtins.str,
                 target_listener_id: builtins.str,
                 target_listener_name: builtins.str,
                 target_url: builtins.str):
        """
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.bool include_path: Whether the path is included in the redirected URL.
        :param builtins.bool include_query_string: Whether to include the query string in the redirected URL.
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.str redirect_type: The type of redirect.
        :param builtins.str target_listener_name: The name of the listener to redirect to.
        :param builtins.str target_url: The URL to redirect the request to.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "include_path", include_path)
        pulumi.set(__self__, "include_query_string", include_query_string)
    ...
    @property
    @pulumi.getter(name="includePath")
    def include_path(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="includeQueryString")
    def include_query_string(self) -> builtins.bool:
        """
...
class GetApplicationGatewayRequestRoutingRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 backend_address_pool_name: builtins.str,
                 backend_http_settings_id: builtins.str,
                 backend_http_settings_name: builtins.str,
                 http_listener_id: builtins.str,
                 http_listener_name: builtins.str,
                 id: builtins.str,
                 name: builtins.str,
                 priority: builtins.int,
                 redirect_configuration_id: builtins.str,
                 redirect_configuration_name: builtins.str,
                 rewrite_rule_set_id: builtins.str,
                 rewrite_rule_set_name: builtins.str,
                 rule_type: builtins.str,
                 url_path_map_id: builtins.str,
                 url_path_map_name: builtins.str):
        """
        :param builtins.str backend_address_pool_id: The ID of the associated Backend Address Pool.
        :param builtins.str backend_address_pool_name: The Name of the Backend Address Pool which is used for this Routing Rule.
        :param builtins.str backend_http_settings_id: The ID of the associated Backend HTTP Settings Configuration.
        :param builtins.str backend_http_settings_name: The Name of the Backend HTTP Settings Collection which is used for this Routing Rule.
        :param builtins.str http_listener_id: The ID of the associated HTTP Listener.
        :param builtins.str http_listener_name: The Name of the HTTP Listener which is used for this Routing Rule.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.int priority: The Priority of this Routing Rule.
        :param builtins.str redirect_configuration_id: The ID of the associated Redirect Configuration.
        :param builtins.str redirect_configuration_name: The Name of the Redirect Configuration which is used for this Routing Rule.
        :param builtins.str rewrite_rule_set_id: The ID of the associated Rewrite Rule Set.
        :param builtins.str rewrite_rule_set_name: The Name of the Rewrite Rule Set which is used for this Routing Rule.
        :param builtins.str rule_type: The Type of Routing that is used for this Rule.
        :param builtins.str url_path_map_id: The ID of the associated URL Path Map.
        :param builtins.str url_path_map_name: The Name of the URL Path Map which is associated with this Routing Rule.
        """
        pulumi.set(__self__, "backend_address_pool_id", backend_address_pool_id)
        pulumi.set(__self__, "backend_address_pool_name", backend_address_pool_name)
        pulumi.set(__self__, "backend_http_settings_id", backend_http_settings_id)
...
class GetApplicationGatewayRewriteRuleSetRewriteRuleConditionResult(dict):
    def __init__(__self__, *,
                 ...
                 variable: builtins.str):
        """
        :param builtins.bool ignore_case: Whether a case insensitive comparison is performed.
        :param builtins.bool negate: Whether the result of the condition evaluation is negated.
        :param builtins.str pattern: The pattern, either fixed string or regular expression, that evaluates the truthfulness of the condition.
        :param builtins.str variable: The [variable](https://docs.microsoft.com/azure/application-gateway/rewrite-http-headers#server-variables) of the condition.
        """
        pulumi.set(__self__, "ignore_case", ignore_case)
...
class GetApplicationGatewayRewriteRuleSetRewriteRuleRequestHeaderConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str header_name: Header name of the header configuration.
        :param builtins.str header_value: Header value of the header configuration.
        """
        pulumi.set(__self__, "header_name", header_name)
        pulumi.set(__self__, "header_value", header_value)
...
class GetApplicationGatewayRewriteRuleSetRewriteRuleUrlResult(dict):
    def __init__(__self__, *,
                 components: builtins.str,
                 path: builtins.str,
                 query_string: builtins.str,
                 reroute: builtins.bool):
        """
        :param builtins.str components: The components used to rewrite the URL.
        :param builtins.str path: The URL path to rewrite.
        :param builtins.str query_string: The query string to rewrite.
        :param builtins.bool reroute: Whether the URL path map is reevaluated after this rewrite has been applied.
        """
        pulumi.set(__self__, "components", components)
        pulumi.set(__self__, "path", path)
        pulumi.set(__self__, "query_string", query_string)
    ...
    @property
    @pulumi.getter
    def reroute(self) -> builtins.bool:
        """
...
class GetApplicationGatewaySkusResult(dict):
    def __init__(__self__, *,
                 ...
                 tier: builtins.str):
        """
        :param builtins.int capacity: The Capacity of the SKU in use for this Application Gateway.
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.str tier: The Tier of the SKU in use for this Application Gateway.
        """
        pulumi.set(__self__, "capacity", capacity)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "tier", tier)
...
class GetApplicationGatewaySslCertificateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str key_vault_secret_id: The Secret ID of (base-64 encoded unencrypted pfx) the `Secret` or `Certificate` object stored in Azure KeyVault.
        :param builtins.str name: The name of this Application Gateway.
        :param builtins.str public_cert_data: The Public Certificate Data associated with the SSL Certificate.
        """
        pulumi.set(__self__, "id", id)
...
class GetApplicationGatewaySslPolicyResult(dict):
    def __init__(__self__, *,
                 cipher_suites: Sequence[builtins.str],
                 disabled_protocols: Sequence[builtins.str],
                 min_protocol_version: builtins.str,
                 policy_name: builtins.str,
                 policy_type: builtins.str):
        """
        :param Sequence[builtins.str] cipher_suites: A List of accepted cipher suites.
        :param Sequence[builtins.str] disabled_protocols: A list of SSL Protocols which are disabled on this Application Gateway.
        :param builtins.str min_protocol_version: The minimum TLS version.
        :param builtins.str policy_name: The Name of the Policy.
        :param builtins.str policy_type: The Type of the Policy.
        """
        pulumi.set(__self__, "cipher_suites", cipher_suites)
        pulumi.set(__self__, "disabled_protocols", disabled_protocols)
        pulumi.set(__self__, "min_protocol_version", min_protocol_version)
    ...
    @property
    @pulumi.getter(name="cipherSuites")
    def cipher_suites(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="disabledProtocols")
    def disabled_protocols(self) -> Sequence[builtins.str]:
        """
...
class GetApplicationGatewaySslProfileResult(dict):
    def __init__(__self__, *,
                 ...
                 trusted_client_certificate_names: Sequence[builtins.str],
                 verify_client_certificate_issuer_dn: builtins.bool,
                 verify_client_certificate_revocation: builtins.str):
        """
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of this Application Gateway.
        :param Sequence['GetApplicationGatewaySslProfileSslPolicyArgs'] ssl_policies: a `ssl_policy` block as defined below.
        :param Sequence[builtins.str] trusted_client_certificate_names: The name of the Trusted Client Certificate that will be used to authenticate requests from clients.
        :param builtins.str verify_client_certificate_revocation: The method used to check client certificate revocation status.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter(name="trustedClientCertificateNames")
    def trusted_client_certificate_names(self) -> Sequence[builtins.str]:
        """
        The name of the Trusted Client Certificate that will be used to authenticate requests from clients.
        """
        return pulumi.get(self, "trusted_client_certificate_names")
    ...
    def verify_client_certificate_issuer_dn(self) -> builtins.bool:
...
class GetApplicationGatewayTrustedClientCertificateResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str data: The content of the Trusted Client Certificate in use.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of this Application Gateway.
        """
        pulumi.set(__self__, "data", data)
...
class GetApplicationGatewayUrlPathMapResult(dict):
    def __init__(__self__, *,
                 default_backend_address_pool_id: builtins.str,
                 default_backend_address_pool_name: builtins.str,
                 default_backend_http_settings_id: builtins.str,
                 default_backend_http_settings_name: builtins.str,
                 default_redirect_configuration_id: builtins.str,
                 default_redirect_configuration_name: builtins.str,
                 default_rewrite_rule_set_id: builtins.str,
                 default_rewrite_rule_set_name: builtins.str,
                 id: builtins.str,
                 name: builtins.str,
                 path_rules: Sequence['outputs.GetApplicationGatewayUrlPathMapPathRuleResult']):
        """
        :param builtins.str default_backend_address_pool_id: The ID of the Default Backend Address Pool.
        :param builtins.str default_backend_address_pool_name: The Name of the Default Backend Address Pool which is used for this URL Path Map.
        :param builtins.str default_backend_http_settings_id: The ID of the Default Backend HTTP Settings Collection.
        :param builtins.str default_backend_http_settings_name: The Name of the Default Backend HTTP Settings Collection which is used for this URL Path Map.
        :param builtins.str default_redirect_configuration_id: The ID of the Default Redirect Configuration.
        :param builtins.str default_redirect_configuration_name: The Name of the Default Redirect Configuration which is used for this URL Path Map.
        :param builtins.str default_rewrite_rule_set_name: The Name of the Default Rewrite Rule Set which is used for this URL Path Map.
        :param builtins.str id: The ID of the Rewrite Rule Set
        :param builtins.str name: The name of this Application Gateway.
...
class GetApplicationGatewayWafConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 file_upload_limit_mb: builtins.int,
                 firewall_mode: builtins.str,
                 max_request_body_size_kb: builtins.int,
        ...
        :param builtins.int file_upload_limit_mb: The File Upload Limit in MB.
        :param builtins.str firewall_mode: The Web Application Firewall Mode.
        :param builtins.int max_request_body_size_kb: The Maximum Request Body Size in KB.
        :param builtins.bool request_body_check: Is Request Body Inspection enabled?
        :param builtins.str rule_set_type: The Type of the Rule Set used for this Web Application Firewall.
        :param builtins.str rule_set_version: The Version of the Rule Set used for this Web Application Firewall.
        """
        pulumi.set(__self__, "disabled_rule_groups", disabled_rule_groups)
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "exclusions", exclusions)
    ...
    @property
    @pulumi.getter(name="fileUploadLimitMb")
    def file_upload_limit_mb(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxRequestBodySizeKb")
    def max_request_body_size_kb(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="requestBodyCheck")
    def request_body_check(self) -> builtins.bool:
        """
...
class GetApplicationGatewayWafConfigurationDisabledRuleGroupResult(dict):
    def __init__(__self__, *,
                 rule_group_name: builtins.str,
                 rules: Sequence[builtins.int]):
        """
        :param builtins.str rule_group_name: The rule group where specific rules are disabled.
        :param Sequence[builtins.int] rules: A list of rules which will be disabled in that group.
        """
        pulumi.set(__self__, "rule_group_name", rule_group_name)
        pulumi.set(__self__, "rules", rules)
    ...
    @property
    @pulumi.getter
    def rules(self) -> Sequence[builtins.int]:
        """
...
class GetApplicationGatewayWafConfigurationExclusionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str match_variable: Match variable of the exclusion rule.
        :param builtins.str selector: String value which will be used for the filter operation.
        :param builtins.str selector_match_operator: Operator which will be used to search in the variable content.
        """
        pulumi.set(__self__, "match_variable", match_variable)
        pulumi.set(__self__, "selector", selector)
        pulumi.set(__self__, "selector_match_operator", selector_match_operator)
...
class GetExpressRouteCircuitPeeringResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int azure_asn: The Either a 16-bit or a 32-bit ASN for Azure.
        :param builtins.int peer_asn: The Either a 16-bit or a 32-bit ASN. Can either be public or private.
        :param builtins.str peering_type: The type of the ExpressRoute Circuit Peering. Acceptable values include `AzurePrivatePeering`, `AzurePublicPeering` and `MicrosoftPeering`. Changing this forces a new resource to be created.
        :param builtins.str primary_peer_address_prefix: A `/30` subnet for the primary link.
        :param builtins.str secondary_peer_address_prefix: A `/30` subnet for the secondary link.
        :param builtins.str shared_key: The shared key. Can be a maximum of 25 characters.
        :param builtins.int vlan_id: A valid VLAN ID to establish this peering on.
        """
...
class GetExpressRouteCircuitServiceProviderPropertyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int bandwidth_in_mbps: The bandwidth in Mbps of the ExpressRoute circuit.
        :param builtins.str peering_location: The name of the peering location and **not** the Azure resource location.
        :param builtins.str service_provider_name: The name of the ExpressRoute Service Provider.
        """
    ...
    def bandwidth_in_mbps(self) -> builtins.int:
        """
...
class GetFirewallIpConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str private_ip_address: The private IP address associated with the Azure Firewall.
        :param builtins.str public_ip_address_id: The ID of the Public IP address of the Azure Firewall.
        :param builtins.str subnet_id: The ID of the Subnet where the Azure Firewall is deployed.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "private_ip_address", private_ip_address)
        pulumi.set(__self__, "public_ip_address_id", public_ip_address_id)
...
class GetFirewallPolicyDnResult(dict):
    def __init__(__self__, *,
                 network_rule_fqdn_enabled: builtins.bool,
    ...
    def network_rule_fqdn_enabled(self) -> builtins.bool:
...
class GetFirewallVirtualHubResult(dict):
    def __init__(__self__, *,
                 ...
                 public_ip_count: builtins.int,
                 virtual_hub_id: builtins.str):
        """
        :param builtins.str private_ip_address: The private IP address associated with the Azure Firewall.
        :param Sequence[builtins.str] public_ip_addresses: The list of public IP addresses associated with the Azure Firewall.
        :param builtins.int public_ip_count: The number of public IPs assigned to the Azure Firewall.
        :param builtins.str virtual_hub_id: The ID of the Virtual Hub where the Azure Firewall resides in.
        """
        pulumi.set(__self__, "private_ip_address", private_ip_address)
        pulumi.set(__self__, "public_ip_addresses", public_ip_addresses)
        pulumi.set(__self__, "public_ip_count", public_ip_count)
    ...
    @property
    @pulumi.getter(name="publicIpCount")
    def public_ip_count(self) -> builtins.int:
        """
...
class GetGatewayConnectionIpsecPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 ipsec_integrity: builtins.str,
                 pfs_group: builtins.str,
                 sa_datasize: builtins.int,
                 sa_lifetime: builtins.int):
        """
        :param builtins.str dh_group: The DH group used in IKE phase 1 for initial SA. Valid
               options are `DHGroup1`, `DHGroup14`, `DHGroup2`, `DHGroup2048`, `DHGroup24`,
               `ECP256`, `ECP384`, or `None`.
        :param builtins.str ike_encryption: The IKE encryption algorithm. Valid
               options are `AES128`, `AES192`, `AES256`, `DES`, or `DES3`.
        :param builtins.str ike_integrity: The IKE integrity algorithm. Valid
               options are `MD5`, `SHA1`, `SHA256`, or `SHA384`.
        :param builtins.str ipsec_encryption: The IPSec encryption algorithm. Valid
               options are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256`, or `None`.
        :param builtins.str ipsec_integrity: The IPSec integrity algorithm. Valid
               options are `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1`, or `SHA256`.
        :param builtins.str pfs_group: The DH group used in IKE phase 2 for new child SA.
               Valid options are `ECP256`, `ECP384`, `PFS1`, `PFS2`, `PFS2048`, `PFS24`,
               or `None`.
        :param builtins.int sa_datasize: The IPSec SA payload size in KB. Must be at least
               `1024` KB.
        :param builtins.int sa_lifetime: The IPSec SA lifetime in seconds. Must be at least
               `300` seconds.
        """
        pulumi.set(__self__, "dh_group", dh_group)
        pulumi.set(__self__, "ike_encryption", ike_encryption)
    ...
    @property
    @pulumi.getter(name="saDatasize")
    def sa_datasize(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="saLifetime")
    def sa_lifetime(self) -> builtins.int:
        """
...
class GetNetworkInterfaceIpConfigurationResult(dict):
    def __init__(__self__, *,
                 application_gateway_backend_address_pools_ids: Sequence[builtins.str],
                 application_security_group_ids: Sequence[builtins.str],
                 gateway_load_balancer_frontend_ip_configuration_id: builtins.str,
                 load_balancer_backend_address_pools_ids: Sequence[builtins.str],
                 ...
                 subnet_id: builtins.str):
        """
        :param Sequence[builtins.str] application_gateway_backend_address_pools_ids: A list of Backend Address Pool IDs within a Application Gateway that this Network Interface is connected to.
        :param builtins.str gateway_load_balancer_frontend_ip_configuration_id: The Frontend IP Configuration ID of a Gateway SKU Load Balancer the Network Interface is consuming.
        :param Sequence[builtins.str] load_balancer_backend_address_pools_ids: A list of Backend Address Pool IDs within a Load Balancer that this Network Interface is connected to.
        :param Sequence[builtins.str] load_balancer_inbound_nat_rules_ids: A list of Inbound NAT Rule IDs within a Load Balancer that this Network Interface is connected to.
        :param builtins.str name: Specifies the name of the Network Interface.
        :param builtins.bool primary: is this the Primary IP Configuration for this Network Interface?
        :param builtins.str private_ip_address: The Private IP Address assigned to this Network Interface.
        :param builtins.str private_ip_address_allocation: The IP Address allocation type for the Private address, such as `Dynamic` or `Static`.
        :param builtins.str public_ip_address_id: The ID of the Public IP Address which is connected to this Network Interface.
        :param builtins.str subnet_id: The ID of the Subnet which the Network Interface is connected to.
        """
    ...
    def application_gateway_backend_address_pools_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def load_balancer_backend_address_pools_ids(self) -> Sequence[builtins.str]:
        """
...
class GetNetworkManagerConnectivityConfigurationAppliesToGroupResult(dict):
    def __init__(__self__, *,
                 global_mesh_enabled: builtins.bool,
                 group_connectivity: builtins.str,
                 network_group_id: builtins.str,
                 use_hub_gateway: builtins.bool):
        """
        :param builtins.bool global_mesh_enabled: Whether global mesh is supported.
        :param builtins.str group_connectivity: The group connectivity type.
        :param builtins.str network_group_id: The ID of the Network Manager Network Group.
        :param builtins.bool use_hub_gateway: Whether hub gateway is used.
        """
        pulumi.set(__self__, "global_mesh_enabled", global_mesh_enabled)
        pulumi.set(__self__, "group_connectivity", group_connectivity)
        pulumi.set(__self__, "network_group_id", network_group_id)
    ...
    @property
    @pulumi.getter(name="useHubGateway")
    def use_hub_gateway(self) -> builtins.bool:
        """
...
class GetNetworkManagerConnectivityConfigurationHubResult(dict):
    def __init__(__self__, *,
                 ...
                 resource_type: builtins.str):
        """
        :param builtins.str resource_id: The resource ID used as hub in Hub and Spoke topology.
        :param builtins.str resource_type: The resource type used as hub in Hub and Spoke topology.
        """
        pulumi.set(__self__, "resource_id", resource_id)
        pulumi.set(__self__, "resource_type", resource_type)
...
class GetNetworkManagerCrossTenantScopeResult(dict):
    def __init__(__self__, *,
                 management_groups: Sequence[builtins.str],
                 subscriptions: Sequence[builtins.str],
                 tenant_id: builtins.str):
        """
        :param Sequence[builtins.str] management_groups: A list of management groups used as cross tenant scope for the Network Manager.
        :param Sequence[builtins.str] subscriptions: A list of subscriptions used as cross tenant scope for the Network Manager.
        :param builtins.str tenant_id: The tenant ID of the cross tenant scope.
        """
        pulumi.set(__self__, "management_groups", management_groups)
        pulumi.set(__self__, "subscriptions", subscriptions)
        pulumi.set(__self__, "tenant_id", tenant_id)
    ...
    @property
    @pulumi.getter(name="managementGroups")
    def management_groups(self) -> Sequence[builtins.str]:
        """
...
class GetNetworkManagerScopeResult(dict):
    def __init__(__self__, *,
                 management_group_ids: Sequence[builtins.str],
                 subscription_ids: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] management_group_ids: A list of management group IDs used a scope for the Network Manager.
        :param Sequence[builtins.str] subscription_ids: A list of subscription IDs used as the scope for the Network Manager.
        """
        pulumi.set(__self__, "management_group_ids", management_group_ids)
        pulumi.set(__self__, "subscription_ids", subscription_ids)
...
class GetNetworkSecurityGroupSecurityRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 destination_address_prefixes: Sequence[builtins.str],
                 destination_port_range: builtins.str,
                 destination_port_ranges: Sequence[builtins.str],
                 direction: builtins.str,
                 name: builtins.str,
                 priority: builtins.int,
                 protocol: builtins.str,
                 source_address_prefix: builtins.str,
                 source_address_prefixes: Sequence[builtins.str],
                 source_port_range: builtins.str,
                 source_port_ranges: Sequence[builtins.str],
                 destination_application_security_group_ids: Optional[Sequence[builtins.str]] = None,
                 source_application_security_group_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str access: Is network traffic is allowed or denied?
        :param builtins.str description: The description for this rule.
        :param builtins.str destination_address_prefix: CIDR or destination IP range or * to match any IP.
        :param Sequence[builtins.str] destination_address_prefixes: A list of CIDRs or destination IP ranges.
        :param builtins.str destination_port_range: The Destination Port or Range.
        :param builtins.str direction: The direction specifies if rule will be evaluated on incoming or outgoing traffic.
        ...
        :param builtins.str protocol: The network protocol this rule applies to.
        :param builtins.str source_address_prefix: CIDR or source IP range or * to match any IP.
        :param Sequence[builtins.str] source_address_prefixes: A list of CIDRs or source IP ranges.
        :param builtins.str source_port_range: The Source Port or Range.
        :param Sequence[builtins.str] destination_application_security_group_ids: A List of destination Application Security Group IDs
        :param Sequence[builtins.str] source_application_security_group_ids: A List of source Application Security Group IDs
        """
        pulumi.set(__self__, "access", access)
    ...
    @property
    @pulumi.getter(name="destinationAddressPrefixes")
    def destination_address_prefixes(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="sourceAddressPrefixes")
    def source_address_prefixes(self) -> Sequence[builtins.str]:
        """
...
class GetPublicIPsPublicIpResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str domain_name_label: The Domain Name Label of the Public IP Address
        :param builtins.str fqdn: The FQDN of the Public IP Address
        :param builtins.str id: The ID of the Public IP Address
        :param builtins.str ip_address: The IP address of the Public IP Address
        :param builtins.str name: The Name of the Public IP Address
        """
...
class GetRouteFilterRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 rule_type: builtins.str):
        """
        :param builtins.str access: The access type of the rule
        :param Sequence[builtins.str] communities: The collection for bgp community values.
        :param builtins.str name: The Name of this Route Filter.
        :param builtins.str rule_type: The Route Filter Rule Type.
        """
        pulumi.set(__self__, "access", access)
        pulumi.set(__self__, "communities", communities)
        pulumi.set(__self__, "name", name)
...
class GetRouteTableRouteResult(dict):
    def __init__(__self__, *,
                 address_prefix: builtins.str,
                 name: builtins.str,
                 next_hop_in_ip_address: builtins.str,
                 next_hop_type: builtins.str):
        """
        ...
        :param builtins.str next_hop_in_ip_address: Contains the IP address packets should be forwarded to.
        :param builtins.str next_hop_type: The type of Azure hop the packet should be sent to.
        """
        pulumi.set(__self__, "address_prefix", address_prefix)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "next_hop_in_ip_address", next_hop_in_ip_address)
...
class GetTrafficManagerProfileDnsConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 ttl: builtins.int):
        """
        :param builtins.str relative_name: The relative domain name, this is combined with the domain name used by Traffic Manager to form the FQDN which is exported as documented below.
        :param builtins.int ttl: The TTL value of the Profile used by Local DNS resolvers and clients.
        """
        pulumi.set(__self__, "relative_name", relative_name)
        pulumi.set(__self__, "ttl", ttl)
...
class GetTrafficManagerProfileMonitorConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 expected_status_code_ranges: Sequence[builtins.str],
        ...
        :param Sequence[builtins.str] expected_status_code_ranges: A list of status code ranges.
        :param builtins.int interval_in_seconds: The interval used to check the endpoint health from a Traffic Manager probing agent.
        :param builtins.str path: The path used by the monitoring checks.
        :param builtins.int port: The port number used by the monitoring checks.
        :param builtins.str protocol: The protocol used by the monitoring checks.
        :param builtins.int timeout_in_seconds: The amount of time the Traffic Manager probing agent should wait before considering that check a failure when a health check probe is sent to the endpoint.
        :param builtins.int tolerated_number_of_failures: The number of failures a Traffic Manager probing agent tolerates before marking that endpoint as unhealthy.
        """
        pulumi.set(__self__, "custom_headers", custom_headers)
        pulumi.set(__self__, "expected_status_code_ranges", expected_status_code_ranges)
        pulumi.set(__self__, "interval_in_seconds", interval_in_seconds)
    ...
    @property
    @pulumi.getter(name="expectedStatusCodeRanges")
    def expected_status_code_ranges(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="toleratedNumberOfFailures")
    def tolerated_number_of_failures(self) -> builtins.int:
        """
...
class GetVirtualHubConnectionRoutingResult(dict):
    def __init__(__self__, *,
                 associated_route_table_id: builtins.str,
                 inbound_route_map_id: builtins.str,
                 outbound_route_map_id: builtins.str,
                 propagated_route_tables: Sequence['outputs.GetVirtualHubConnectionRoutingPropagatedRouteTableResult'],
                 static_vnet_local_route_override_criteria: builtins.str,
                 static_vnet_propagate_static_routes_enabled: builtins.bool,
                 static_vnet_routes: Sequence['outputs.GetVirtualHubConnectionRoutingStaticVnetRouteResult']):
        """
        :param builtins.str associated_route_table_id: The ID of the route table associated with this Virtual Hub connection.
        :param builtins.str inbound_route_map_id: The ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param builtins.str outbound_route_map_id: The ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
        ...
        :param builtins.str static_vnet_local_route_override_criteria: The static VNet local route override criteria that is used to determine whether NVA in spoke VNet is bypassed for traffic with destination in spoke VNet.
        :param builtins.bool static_vnet_propagate_static_routes_enabled: Whether the static routes should be propagated to the Virtual Hub or not.
    ...
    @property
    @pulumi.getter(name="staticVnetPropagateStaticRoutesEnabled")
    def static_vnet_propagate_static_routes_enabled(self) -> builtins.bool:
        """
...
class GetVirtualHubConnectionRoutingPropagatedRouteTableResult(dict):
    def __init__(__self__, *,
                 ...
                 route_table_ids: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] labels: The list of labels assigned to this route table.
        :param Sequence[builtins.str] route_table_ids: A list of Route Table IDs associated with this Virtual Hub Connection.
        """
        pulumi.set(__self__, "labels", labels)
        pulumi.set(__self__, "route_table_ids", route_table_ids)
...
class GetVirtualHubConnectionRoutingStaticVnetRouteResult(dict):
    def __init__(__self__, *,
                 ...
                 next_hop_ip_address: builtins.str):
        """
        :param Sequence[builtins.str] address_prefixes: A list of CIDR Ranges which is used as Address Prefixes.
        :param builtins.str name: The name of the Connection which should be retrieved.
        :param builtins.str next_hop_ip_address: The IP Address which is used for the Next Hop.
        """
        pulumi.set(__self__, "address_prefixes", address_prefixes)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "next_hop_ip_address", next_hop_ip_address)
...
class GetVirtualHubRouteTableRouteResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] destinations: A list of destination addresses for this route.
        :param builtins.str destinations_type: The type of destinations.
        :param builtins.str name: The name of the Virtual Hub Route Table.
        :param builtins.str next_hop: The next hop's resource ID.
        :param builtins.str next_hop_type: The type of next hop.
        """
        pulumi.set(__self__, "destinations", destinations)
        pulumi.set(__self__, "destinations_type", destinations_type)
        pulumi.set(__self__, "name", name)
...
class GetVirtualNetworkGatewayBgpSettingResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int asn: The Autonomous System Number (ASN) to use as part of the BGP.
        :param builtins.int peer_weight: The weight added to routes which have been learned
               through BGP peering.
        :param builtins.str peering_address: The BGP peer IP address of the virtual network
...
class GetVirtualNetworkGatewayIpConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 subnet_id: builtins.str):
        """
        :param builtins.str id: The resource ID of the IP configuration.
        :param builtins.str name: Specifies the name of the Virtual Network Gateway.
        :param builtins.str private_ip_address: The Private IP Address associated with the Virtual Network Gateway.
        :param builtins.str private_ip_address_allocation: Defines how the private IP address
               of the gateways virtual interface is assigned.
        :param builtins.str public_ip_address_id: The ID of the Public IP Address associated
               with the Virtual Network Gateway.
        :param builtins.str subnet_id: The ID of the gateway subnet of a virtual network in
...
class GetVirtualNetworkGatewayVpnClientConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 vpn_client_protocols: Sequence[builtins.str]):
        """
        :param builtins.str aad_audience: The client id of the Azure VPN application.
               See [Create an Active Directory (AD) tenant for P2S OpenVPN protocol connections](https://docs.microsoft.com/en-gb/azure/vpn-gateway/openvpn-azure-ad-tenant-multi-app) for values
        ...
        :param builtins.str aad_tenant: AzureAD Tenant URL
               This setting is incompatible with the use of
               `root_certificate` and `revoked_certificate`, `radius_server_address`, and `radius_server_secret`.
        :param Sequence[builtins.str] address_spaces: The address space out of which IP addresses for
    ...
    @property
    @pulumi.getter(name="vpnClientProtocols")
    def vpn_client_protocols(self) -> Sequence[builtins.str]:
        """
        List of the protocols supported by the vpn client.
        The supported values are `SSTP`, `IkeV2` and `OpenVPN`.
        """
...
class GetVirtualNetworkGatewayVpnClientConfigurationRootCertificateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Specifies the name of the Virtual Network Gateway.
        :param builtins.str public_cert_data: The public certificate of the root certificate
...
class GetVpnGatewayBgpSettingResult(dict):
    def __init__(__self__, *,
                 ...
                 peer_weight: builtins.int):
        """
        :param builtins.int asn: The ASN of the BGP Speaker.
        :param builtins.str bgp_peering_address: The Address which should be used for the BGP Peering.
...
class GetVpnGatewayBgpSettingInstance0BgpPeeringAddressResult(dict):
    def __init__(__self__, *,
                 custom_ips: Sequence[builtins.str],
                 default_ips: Sequence[builtins.str],
                 ip_configuration_id: builtins.str,
                 tunnel_ips: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] custom_ips: A list of custom BGP peering addresses to assigned to this instance.
        :param Sequence[builtins.str] default_ips: The list of default BGP peering addresses which belong to the pre-defined VPN Gateway IP configuration.
        :param builtins.str ip_configuration_id: The pre-defined id of VPN Gateway IP Configuration.
        :param Sequence[builtins.str] tunnel_ips: The list of tunnel public IP addresses which belong to the pre-defined VPN Gateway IP configuration.
        """
    ...
    @property
    @pulumi.getter(name="defaultIps")
    def default_ips(self) -> Sequence[builtins.str]:
        """
        The list of default BGP peering addresses which belong to the pre-defined VPN Gateway IP configuration.
        """
        return pulumi.get(self, "default_ips")
    ...
    @property
    @pulumi.getter(name="tunnelIps")
    def tunnel_ips(self) -> Sequence[builtins.str]:
        """
        The list of tunnel public IP addresses which belong to the pre-defined VPN Gateway IP configuration.
        """
        return pulumi.get(self, "tunnel_ips")
...
class GetVpnServerConfigurationIpsecPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 sa_lifetime_seconds: builtins.int):
        """
        :param builtins.str dh_group: The DH Group, used in IKE Phase 1.
        :param builtins.str ike_encryption: The IKE encryption algorithm, used for IKE Phase 2.
        :param builtins.str ike_integrity: The IKE encryption integrity algorithm, used for IKE Phase 2.
        :param builtins.str ipsec_encryption: The IPSec encryption algorithm, used for IKE phase 1.
        :param builtins.str ipsec_integrity: The IPSec integrity algorithm, used for IKE phase 1.
        :param builtins.str pfs_group: The Pfs Group, used in IKE Phase 2.
        :param builtins.int sa_data_size_kilobytes: The IPSec Security Association payload size in KB for a Site-to-Site VPN tunnel.
        :param builtins.int sa_lifetime_seconds: The IPSec Security Association lifetime in seconds for a Site-to-Site VPN tunnel.
        """
        pulumi.set(__self__, "dh_group", dh_group)
...
class GetVpnServerConfigurationRadiusServerResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address: The Address of the Radius Server.
        :param builtins.int score: The Score of the Radius Server determines the priority of the server.
        :param builtins.str secret: The Secret used to communicate with the Radius Server.
        """
        pulumi.set(__self__, "address", address)
        pulumi.set(__self__, "score", score)
