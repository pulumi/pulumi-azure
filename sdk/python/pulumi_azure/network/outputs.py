...
__all__ = [
    ...
    'GetApplicationGatewayBackendResult',
    ...
    'GetApplicationGatewayListenerResult',
    ...
    'GetApplicationGatewayRoutingRuleResult',
    ...
    'GetSubnetServiceEndpointResult',
    ...
    'GetVpnGatewayIpConfigurationResult',
...
class ApplicationGatewayAutoscaleConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int min_capacity: Minimum capacity for autoscaling. Accepted values are in the range `0` to `100`.
        :param _builtins.int max_capacity: Maximum capacity for autoscaling. Accepted values are in the range `2` to `125`.
        """
...
@pulumi.output_type
class ApplicationGatewayBackend(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ApplicationGatewayBackend. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ApplicationGatewayBackend.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the Backend Settings Collection.
        :param _builtins.int port: The port which should be used for this Backend Settings Collection.
        :param _builtins.str protocol: The Protocol which should be used. Possible values are `Tcp` and `Tls`.
        :param _builtins.bool client_ip_preservation_enabled: Whether client IP preservation is enabled for this Backend Settings Collection. Defaults to `false`.
        :param _builtins.str host_name: Host header to be sent to the backend servers. Can only be set when `protocol` is `Tls`.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str probe_id: The ID of the associated Probe.
        :param _builtins.str probe_name: The name of an associated Probe.
        :param _builtins.int timeout_in_seconds: The connection timeout in seconds. Possible values range between `1` and `86400`. Defaults to `30`.
    ...
    def probe_id(self) -> Optional[_builtins.str]:
        """
    ...
    def probe_name(self) -> Optional[_builtins.str]:
        """
    ...
    def trusted_root_certificate_names(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ApplicationGatewayBackendAddressPool(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the Backend Address Pool.
        :param Sequence[_builtins.str] fqdns: A list of FQDN's which should be part of the Backend Address Pool.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param Sequence[_builtins.str] ip_addresses: A list of IP Addresses which should be part of the Backend Address Pool.
        """
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayBackendHttpSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pick_host_name_from_backend_address: Optional[_builtins.bool] = None,
                 probe_id: Optional[_builtins.str] = None,
                 probe_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str name: The name of the Backend HTTP Settings Collection.
        :param _builtins.int port: The port which should be used for this Backend HTTP Settings Collection.
        ...
        :param _builtins.bool pick_host_name_from_backend_address: Whether host header should be picked from the host name of the backend server. Defaults to `false`.
        :param _builtins.str probe_id: The ID of the associated Probe.
...
class ApplicationGatewayBackendHttpSettingConnectionDraining(dict):
    ...
    def __init__(__self__, *,
                 drain_timeout_sec: _builtins.int,
                 enabled: _builtins.bool):
        """
        :param _builtins.int drain_timeout_sec: The number of seconds connection draining is active. Acceptable values are from `1` second to `3600` seconds.
        :param _builtins.bool enabled: If connection draining is enabled or not.
        """
    ...
    def drain_timeout_sec(self) -> _builtins.int:
        """
...
class ApplicationGatewayCustomErrorConfiguration(dict):
    ...
    def __init__(__self__, *,
                 custom_error_page_url: _builtins.str,
                 status_code: _builtins.str,
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.str custom_error_page_url: Error page URL of the application gateway customer error.
        :param _builtins.str status_code: Status code of the application gateway customer error. Possible values are `HttpStatus400`, `HttpStatus403`, `HttpStatus404`, `HttpStatus405`, `HttpStatus408`, `HttpStatus500`, `HttpStatus502`, `HttpStatus503` and `HttpStatus504`
        :param _builtins.str id: The ID of the Rewrite Rule Set
        """
    ...
    def custom_error_page_url(self) -> _builtins.str:
        """
...
class ApplicationGatewayFrontendIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 private_link_configuration_id: Optional[_builtins.str] = None,
                 private_link_configuration_name: Optional[_builtins.str] = None,
        ...
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str private_ip_address: The Private IP Address to use for the Application Gateway.
        :param _builtins.str private_ip_address_allocation: The Allocation Method for the Private IP Address. Possible values are `Dynamic` and `Static`. Defaults to `Dynamic`.
        :param _builtins.str private_link_configuration_id: The ID of the associated private link configuration.
        :param _builtins.str private_link_configuration_name: The name of the private link configuration to use for this frontend IP configuration.
        :param _builtins.str public_ip_address_id: The ID of a Public IP Address which the Application Gateway should use. The allocation method for the Public IP Address depends on the `sku` of this Application Gateway. Please refer to the [Azure documentation for public IP addresses](https://docs.microsoft.com/azure/virtual-network/public-ip-addresses#application-gateways) for details.
    ...
    def private_link_configuration_id(self) -> Optional[_builtins.str]:
        """
    ...
    def private_link_configuration_name(self) -> Optional[_builtins.str]:
        """
...
class ApplicationGatewayFrontendPort(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name of the Frontend Port.
        :param _builtins.int port: The port used for this Frontend Port.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "port", port)
...
class ApplicationGatewayGatewayIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The Name of this Gateway IP Configuration.
        :param _builtins.str subnet_id: The ID of the Subnet which the Application Gateway should be connected to.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class ApplicationGatewayGlobal(dict):
    ...
    def __init__(__self__, *,
                 request_buffering_enabled: _builtins.bool,
                 response_buffering_enabled: _builtins.bool):
        """
        :param _builtins.bool request_buffering_enabled: Whether Application Gateway's Request buffer is enabled.
        :param _builtins.bool response_buffering_enabled: Whether Application Gateway's Response buffer is enabled.
        """
    ...
    def request_buffering_enabled(self) -> _builtins.bool:
        """
    ...
    def response_buffering_enabled(self) -> _builtins.bool:
        """
...
class ApplicationGatewayHttpListener(dict):
    ...
    def __init__(__self__, *,
                 frontend_ip_configuration_name: _builtins.str,
                 frontend_port_name: _builtins.str,
                 name: _builtins.str,
                 protocol: _builtins.str,
                 custom_error_configurations: Optional[Sequence['outputs.ApplicationGatewayHttpListenerCustomErrorConfiguration']] = None,
                 firewall_policy_id: Optional[_builtins.str] = None,
                 frontend_ip_configuration_id: Optional[_builtins.str] = None,
                 frontend_port_id: Optional[_builtins.str] = None,
                 host_name: Optional[_builtins.str] = None,
                 host_names: Optional[Sequence[_builtins.str]] = None,
                 id: Optional[_builtins.str] = None,
                 require_sni: Optional[_builtins.bool] = None,
                 ssl_certificate_id: Optional[_builtins.str] = None,
                 ssl_certificate_name: Optional[_builtins.str] = None,
                 ssl_profile_id: Optional[_builtins.str] = None,
                 ssl_profile_name: Optional[_builtins.str] = None):
        """
        :param _builtins.str frontend_ip_configuration_name: The Name of the Frontend IP Configuration used for this HTTP Listener.
        :param _builtins.str frontend_port_name: The Name of the Frontend Port use for this HTTP Listener.
        :param _builtins.str name: The Name of the HTTP Listener.
        :param _builtins.str protocol: The Protocol to use for this HTTP Listener. Possible values are `Http` and `Https`.
        ...
        :param _builtins.str firewall_policy_id: The ID of the Web Application Firewall Policy which should be used for this HTTP Listener.
        :param _builtins.str frontend_ip_configuration_id: The ID of the associated Frontend Configuration.
        :param _builtins.str frontend_port_id: The ID of the associated Frontend Port.
        :param _builtins.str host_name: The Hostname which should be used for this HTTP Listener. Setting this value changes Listener Type to 'Multi site'.
        :param Sequence[_builtins.str] host_names: A list of Hostname(s) should be used for this HTTP Listener. It allows special wildcard characters.
               
               > **Note:** The `host_names` and `host_name` are mutually exclusive and cannot both be set.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.bool require_sni: Should Server Name Indication be Required? Defaults to `false`.
        :param _builtins.str ssl_certificate_id: The ID of the associated SSL Certificate.
        :param _builtins.str ssl_certificate_name: The name of the associated SSL Certificate which should be used for this HTTP Listener.
        :param _builtins.str ssl_profile_id: The ID of the associated SSL Profile.
        :param _builtins.str ssl_profile_name: The name of the associated SSL Profile which should be used for this HTTP Listener.
        """
    ...
    def frontend_port_name(self) -> _builtins.str:
        """
    ...
    def frontend_ip_configuration_id(self) -> Optional[_builtins.str]:
        """
    ...
    def frontend_port_id(self) -> Optional[_builtins.str]:
        """
    ...
    def require_sni(self) -> Optional[_builtins.bool]:
        """
    ...
    def ssl_certificate_name(self) -> Optional[_builtins.str]:
        """
    ...
    def ssl_profile_id(self) -> Optional[_builtins.str]:
        """
    ...
    def ssl_profile_name(self) -> Optional[_builtins.str]:
        """
...
class ApplicationGatewayIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Application Gateway. Only possible value is `UserAssigned`.
        :param Sequence[_builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Application Gateway.
        """
...
@pulumi.output_type
class ApplicationGatewayListener(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "frontendIpConfigurationName":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ApplicationGatewayListener. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ApplicationGatewayListener.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 ssl_profile_name: Optional[_builtins.str] = None):
        """
        :param _builtins.str frontend_ip_configuration_name: The Name of the Frontend IP Configuration used for this Listener.
        :param _builtins.str frontend_port_name: The Name of the Frontend Port use for this Listener.
        :param _builtins.str name: The Name of the Listener.
        :param _builtins.str protocol: The Protocol to use for this Listener. Possible values are `Tcp`, and `Tls`.
        :param _builtins.str frontend_ip_configuration_id: The ID of the associated Frontend Configuration.
        :param _builtins.str frontend_port_id: The ID of the associated Frontend Port.
        :param Sequence[_builtins.str] host_names: A list of Hostname(s) should be used for this Listener. It allows special wildcard characters.
               
               > **Note:** `host_names` cannot be set when `protocol` is set to `Tcp`.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str ssl_certificate_id: The ID of the associated SSL Certificate.
        :param _builtins.str ssl_certificate_name: The name of the associated SSL Certificate which should be used for this Listener.
               
               > **Note:** `ssl_certificate_name` must be set when `protocol` is set to `Tls`.
        :param _builtins.str ssl_profile_id: The ID of the associated SSL Profile.
        :param _builtins.str ssl_profile_name: The name of the associated SSL Profile which should be used for this Listener.
        """
        pulumi.set(__self__, "frontend_ip_configuration_name", frontend_ip_configuration_name)
        pulumi.set(__self__, "frontend_port_name", frontend_port_name)
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayPrivateEndpointConnection(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str name: The name of the Application Gateway. Changing this forces a new resource to be created.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if name is not None:
...
class ApplicationGatewayPrivateLinkConfigurationIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str private_ip_address_allocation: The allocation method used for the Private IP Address. Possible values are `Dynamic` and `Static`.
        :param _builtins.str subnet_id: The ID of the subnet the private link configuration should connect to.
        :param _builtins.str private_ip_address: The Static IP Address which should be used.
        """
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayProbe(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "proxyProtocolHeaderEnabled":
            suggest = "proxy_protocol_header_enabled"
    ...
    def __init__(__self__, *,
                 ...
                 minimum_servers: Optional[_builtins.int] = None,
                 path: Optional[_builtins.str] = None,
                 pick_host_name_from_backend_http_settings: Optional[_builtins.bool] = None,
                 port: Optional[_builtins.int] = None,
                 proxy_protocol_header_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.int interval: The interval between two consecutive probes in seconds. Possible values range from `1` to `86400`.
        :param _builtins.str name: The name of the Probe.
        :param _builtins.str protocol: The protocol used for this Probe. Possible values are `Http`, `Https`, `Tcp`, and `Tls`.
        :param _builtins.int timeout: The timeout in seconds used for this Probe, which indicates when a Probe becomes unhealthy. Possible values range from `1` to `86400`.
        ...
        :param _builtins.int minimum_servers: The minimum number of servers that are always marked as healthy. Defaults to `0`.
        :param _builtins.str path: The relative URL path of the Probe. Valid value starts with `/`.
               
               > **Note:** `path` cannot be set when `protocol` is set to `Tcp` or `Tls`. `path` must be specified when `protocol` is `Http` or `Https`.
        :param _builtins.bool pick_host_name_from_backend_http_settings: Whether the host header should be picked from the backend HTTP settings. Defaults to `false`.
               
               > **Note:** `pick_host_name_from_backend_http_settings` cannot be set when `protocol` is set to `Tcp` or `Tls`.
        :param _builtins.int port: Custom port which will be used for probing the backend servers. Possible values range from `1` to `65535`.
        ...
        :param _builtins.bool proxy_protocol_header_enabled: Whether the proxy protocol header is enabled for this Probe. Defaults to `false`.
    ...
    def minimum_servers(self) -> Optional[_builtins.int]:
        """
    ...
    def proxy_protocol_header_enabled(self) -> Optional[_builtins.bool]:
        """
...
class ApplicationGatewayProbeMatch(dict):
    ...
    def __init__(__self__, *,
                 status_codes: Sequence[_builtins.str],
                 body: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] status_codes: A list of allowed status codes for this Health Probe.
        :param _builtins.str body: A snippet from the Response Body which must be present in the Response.
        """
    ...
    def status_codes(self) -> Sequence[_builtins.str]:
        """
...
class ApplicationGatewayRedirectConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None,
                 include_path: Optional[_builtins.bool] = None,
                 include_query_string: Optional[_builtins.bool] = None,
                 target_listener_id: Optional[_builtins.str] = None,
                 target_listener_name: Optional[_builtins.str] = None,
                 target_url: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: Unique name of the redirect configuration block
        :param _builtins.str redirect_type: The type of redirect. Possible values are `Permanent`, `Temporary`, `Found` and `SeeOther`
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.bool include_path: Whether to include the path in the redirected URL. Defaults to `false`
        :param _builtins.bool include_query_string: Whether to include the query string in the redirected URL. Default to `false`
        :param _builtins.str target_listener_name: The name of the listener to redirect to. Cannot be set if `target_url` is set.
        :param _builtins.str target_url: The URL to redirect the request to. Cannot be set if `target_listener_name` is set.
        """
        pulumi.set(__self__, "name", name)
    ...
    def target_listener_name(self) -> Optional[_builtins.str]:
        """
...
class ApplicationGatewayRequestRoutingRule(dict):
    ...
    def __init__(__self__, *,
                 http_listener_name: _builtins.str,
                 name: _builtins.str,
                 rule_type: _builtins.str,
                 backend_address_pool_id: Optional[_builtins.str] = None,
                 backend_address_pool_name: Optional[_builtins.str] = None,
                 backend_http_settings_id: Optional[_builtins.str] = None,
                 backend_http_settings_name: Optional[_builtins.str] = None,
                 http_listener_id: Optional[_builtins.str] = None,
                 id: Optional[_builtins.str] = None,
                 priority: Optional[_builtins.int] = None,
                 redirect_configuration_id: Optional[_builtins.str] = None,
                 redirect_configuration_name: Optional[_builtins.str] = None,
                 rewrite_rule_set_id: Optional[_builtins.str] = None,
                 rewrite_rule_set_name: Optional[_builtins.str] = None,
                 url_path_map_id: Optional[_builtins.str] = None,
                 url_path_map_name: Optional[_builtins.str] = None):
        """
        :param _builtins.str http_listener_name: The Name of the HTTP Listener which should be used for this Routing Rule.
        :param _builtins.str name: The Name of this Request Routing Rule.
        :param _builtins.str rule_type: The Type of Routing that should be used for this Rule. Possible values are `Basic` and `PathBasedRouting`.
        :param _builtins.str backend_address_pool_id: The ID of the associated Backend Address Pool.
        :param _builtins.str backend_address_pool_name: The Name of the Backend Address Pool which should be used for this Routing Rule. Cannot be set if `redirect_configuration_name` is set.
        :param _builtins.str backend_http_settings_id: The ID of the associated Backend HTTP Settings Configuration.
        :param _builtins.str backend_http_settings_name: The Name of the Backend HTTP Settings Collection which should be used for this Routing Rule. Cannot be set if `redirect_configuration_name` is set.
        :param _builtins.str http_listener_id: The ID of the associated HTTP Listener.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.int priority: Rule evaluation order can be dictated by specifying an integer value from `1` to `20000` with `1` being the highest priority and `20000` being the lowest priority.
               
               > **Note:** `priority` is required when `sku[0].tier` is set to `*_v2`.
        :param _builtins.str redirect_configuration_id: The ID of the associated Redirect Configuration.
        :param _builtins.str redirect_configuration_name: The Name of the Redirect Configuration which should be used for this Routing Rule. Cannot be set if either `backend_address_pool_name` or `backend_http_settings_name` is set.
        :param _builtins.str rewrite_rule_set_id: The ID of the associated Rewrite Rule Set.
        :param _builtins.str rewrite_rule_set_name: The Name of the Rewrite Rule Set which should be used for this Routing Rule. Only valid for v2 SKUs.
        ...
        :param _builtins.str url_path_map_id: The ID of the associated URL Path Map.
        :param _builtins.str url_path_map_name: The Name of the URL Path Map which should be associated with this Routing Rule.
        """
    ...
    def http_listener_name(self) -> _builtins.str:
        """
    ...
    def backend_address_pool_id(self) -> Optional[_builtins.str]:
        """
    ...
    def backend_address_pool_name(self) -> Optional[_builtins.str]:
        """
    ...
    def backend_http_settings_id(self) -> Optional[_builtins.str]:
        """
    ...
    def backend_http_settings_name(self) -> Optional[_builtins.str]:
        """
    ...
    def http_listener_id(self) -> Optional[_builtins.str]:
        """
    ...
    def redirect_configuration_id(self) -> Optional[_builtins.str]:
        """
    ...
    def redirect_configuration_name(self) -> Optional[_builtins.str]:
        """
    ...
    def rewrite_rule_set_id(self) -> Optional[_builtins.str]:
        """
    ...
    def rewrite_rule_set_name(self) -> Optional[_builtins.str]:
        """
    ...
    def url_path_map_id(self) -> Optional[_builtins.str]:
        """
    ...
    def url_path_map_name(self) -> Optional[_builtins.str]:
        """
...
class ApplicationGatewayRewriteRuleSet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Unique name of the rewrite rule set block
        :param _builtins.str id: The ID of the Rewrite Rule Set
...
class ApplicationGatewayRewriteRuleSetRewriteRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Unique name of the rewrite rule block
        :param _builtins.int rule_sequence: Rule sequence of the rewrite rule that determines the order of execution in a set.
    ...
    def rule_sequence(self) -> _builtins.int:
        """
...
class ApplicationGatewayRewriteRuleSetRewriteRuleCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str variable: The [variable](https://docs.microsoft.com/azure/application-gateway/rewrite-http-headers#server-variables) of the condition.
        :param _builtins.bool ignore_case: Perform a case in-sensitive comparison. Defaults to `false`
        :param _builtins.bool negate: Negate the result of the condition evaluation. Defaults to `false`
        """
...
class ApplicationGatewayRewriteRuleSetRewriteRuleRequestHeaderConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str header_value: Header value of the header configuration. To delete a request header set this property to an empty string.
        """
...
class ApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str header_name: Header name of the header configuration.
        :param _builtins.str header_value: Header value of the header configuration. To delete a response header set this property to an empty string.
        """
        pulumi.set(__self__, "header_name", header_name)
        pulumi.set(__self__, "header_value", header_value)
...
class ApplicationGatewayRewriteRuleSetRewriteRuleUrl(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str components: The components used to rewrite the URL. Possible values are `path_only` and `query_string_only` to limit the rewrite to the URL Path or URL Query String only.
        ...
        :param _builtins.str query_string: The query string to rewrite.
        :param _builtins.bool reroute: Whether the URL path map should be reevaluated after this rewrite has been applied. [More info on rewrite configuration](https://docs.microsoft.com/azure/application-gateway/rewrite-http-headers-url#rewrite-configuration)
        """
...
@pulumi.output_type
class ApplicationGatewayRoutingRule(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "backendAddressPoolName":
            suggest = "backend_address_pool_name"
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ApplicationGatewayRoutingRule. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ApplicationGatewayRoutingRule.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 backend_address_pool_name: _builtins.str,
        ...
        """
        :param _builtins.str backend_address_pool_name: The Name of the Backend Address Pool which should be used for this Routing Rule.
        :param _builtins.str backend_name: The Name of the Backend Settings which should be used for this Routing Rule.
        :param _builtins.str listener_name: The Name of the Listener which should be used for this Routing Rule.
        :param _builtins.str name: The Name of this Routing Rule.
        :param _builtins.int priority: The routing rule priority, indicating the order in which rules are evaluated. Possible values range between `1` and `20000`, with `1` being the highest priority and `20000` being the lowest priority.
        :param _builtins.str backend_address_pool_id: The ID of the associated Backend Address Pool.
        :param _builtins.str backend_id: The ID of the associated Backend Settings.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str listener_id: The ID of the associated Listener.
        """
        pulumi.set(__self__, "backend_address_pool_name", backend_address_pool_name)
    ...
    @_builtins.property
    @pulumi.getter(name="backendAddressPoolName")
    def backend_address_pool_name(self) -> _builtins.str:
        """
...
class ApplicationGatewaySku(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str tier: The Tier of the SKU to use for this Application Gateway. Possible values are `Basic`, `Standard`, `Standard_v2`, `WAF`, and `WAF_v2`.
...
class ApplicationGatewaySslCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The Name of the SSL certificate that is unique within this Application Gateway
        :param _builtins.str data: The base64-encoded PFX certificate data. Required if `key_vault_secret_id` is not set.
               
               > **Note:** When specifying a file, use `data = filebase64("path/to/file")` to encode the contents of that file.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str key_vault_secret_id: The Secret ID of the (base-64 encoded unencrypted pfx) `Secret` or `Certificate` object stored in Azure KeyVault. You need to enable soft delete for Key Vault to use this feature. Required if `data` is not set.
        ...
        :param _builtins.str password: Password for the pfx file specified in data. Required if `data` is set.
        :param _builtins.str public_cert_data: The Public Certificate Data associated with the SSL Certificate.
        """
        pulumi.set(__self__, "name", name)
        if data is not None:
...
class ApplicationGatewaySslPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disabled_protocols: Optional[Sequence[_builtins.str]] = None,
        ...
        """
        :param Sequence[_builtins.str] disabled_protocols: A list of SSL Protocols which should be disabled on this Application Gateway. Possible values are `TLSv1_0`, `TLSv1_1`, `TLSv1_2` and `TLSv1_3`.
               
               > **Note:** `disabled_protocols` cannot be set when `policy_name` or `policy_type` are set.
        :param _builtins.str policy_type: The Type of the Policy. Possible values are `Predefined`, `Custom` and `CustomV2`.
    ...
    def disabled_protocols(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class ApplicationGatewaySslProfile(dict):
    ...
    def trusted_client_certificate_names(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def verify_client_certificate_revocation(self) -> Optional[_builtins.str]:
        """
...
class ApplicationGatewayTrustedClientCertificate(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.str data: The base-64 encoded certificate.
        :param _builtins.str name: The name of the Trusted Client Certificate that is unique within this Application Gateway.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        """
        pulumi.set(__self__, "data", data)
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayTrustedRootCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_vault_secret_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The Name of the Trusted Root Certificate to use.
        :param _builtins.str data: The contents of the Trusted Root Certificate which should be used. Required if `key_vault_secret_id` is not set.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str key_vault_secret_id: The Secret ID of the (base-64 encoded unencrypted pfx) `Secret` or `Certificate` object stored in Azure KeyVault. You need to enable soft delete for the Key Vault to use this feature. Required if `data` is not set.
...
class ApplicationGatewayUrlPathMap(dict):
    ...
    def __init__(__self__, *,
                 ...
                 default_backend_address_pool_id: Optional[_builtins.str] = None,
                 default_backend_address_pool_name: Optional[_builtins.str] = None,
                 default_backend_http_settings_id: Optional[_builtins.str] = None,
                 default_backend_http_settings_name: Optional[_builtins.str] = None,
                 default_redirect_configuration_id: Optional[_builtins.str] = None,
                 default_redirect_configuration_name: Optional[_builtins.str] = None,
                 default_rewrite_rule_set_id: Optional[_builtins.str] = None,
                 default_rewrite_rule_set_name: Optional[_builtins.str] = None,
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The Name of the URL Path Map.
        :param Sequence['ApplicationGatewayUrlPathMapPathRuleArgs'] path_rules: One or more `path_rule` blocks as defined above.
        :param _builtins.str default_backend_address_pool_id: The ID of the Default Backend Address Pool.
        :param _builtins.str default_backend_address_pool_name: The Name of the Default Backend Address Pool which should be used for this URL Path Map. Cannot be set if `default_redirect_configuration_name` is set.
        :param _builtins.str default_backend_http_settings_id: The ID of the Default Backend HTTP Settings Collection.
        :param _builtins.str default_backend_http_settings_name: The Name of the Default Backend HTTP Settings Collection which should be used for this URL Path Map. Cannot be set if `default_redirect_configuration_name` is set.
        :param _builtins.str default_redirect_configuration_id: The ID of the Default Redirect Configuration.
        :param _builtins.str default_redirect_configuration_name: The Name of the Default Redirect Configuration which should be used for this URL Path Map. Cannot be set if either `default_backend_address_pool_name` or `default_backend_http_settings_name` is set.
        ...
        :param _builtins.str default_rewrite_rule_set_name: The Name of the Default Rewrite Rule Set which should be used for this URL Path Map. Only valid for v2 SKUs.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        """
        pulumi.set(__self__, "name", name)
    ...
    def default_backend_address_pool_id(self) -> Optional[_builtins.str]:
        """
    ...
    def default_backend_address_pool_name(self) -> Optional[_builtins.str]:
        """
    ...
    def default_backend_http_settings_id(self) -> Optional[_builtins.str]:
        """
    ...
    def default_backend_http_settings_name(self) -> Optional[_builtins.str]:
        """
    ...
    def default_redirect_configuration_id(self) -> Optional[_builtins.str]:
        """
    ...
    def default_redirect_configuration_name(self) -> Optional[_builtins.str]:
        """
    ...
    def default_rewrite_rule_set_id(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "default_rewrite_rule_set_id")

    @_builtins.property
    @pulumi.getter(name="defaultRewriteRuleSetName")
    def default_rewrite_rule_set_name(self) -> Optional[_builtins.str]:
        """
...
class ApplicationGatewayUrlPathMapPathRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rewrite_rule_set_name: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The Name of the Path Rule.
        :param Sequence[_builtins.str] paths: A list of Paths used in this Path Rule.
        :param _builtins.str backend_address_pool_id: The ID of the associated Backend Address Pool.
        :param _builtins.str backend_address_pool_name: The Name of the Backend Address Pool to use for this Path Rule. Cannot be set if `redirect_configuration_name` is set.
        :param _builtins.str backend_http_settings_id: The ID of the associated Backend HTTP Settings Configuration.
        :param _builtins.str backend_http_settings_name: The Name of the Backend HTTP Settings Collection to use for this Path Rule. Cannot be set if `redirect_configuration_name` is set.
        :param _builtins.str firewall_policy_id: The ID of the Web Application Firewall Policy which should be used as an HTTP Listener.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str redirect_configuration_id: The ID of the associated Redirect Configuration.
        :param _builtins.str redirect_configuration_name: The Name of a Redirect Configuration to use for this Path Rule. Cannot be set if `backend_address_pool_name` or `backend_http_settings_name` is set.
        :param _builtins.str rewrite_rule_set_id: The ID of the associated Rewrite Rule Set.
        :param _builtins.str rewrite_rule_set_name: The Name of the Rewrite Rule Set which should be used for this URL Path Map. Only valid for v2 SKUs.
        """
        pulumi.set(__self__, "name", name)
...
class ApplicationGatewayWafConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 file_upload_limit_mb: Optional[_builtins.int] = None,
                 max_request_body_size_kb: Optional[_builtins.int] = None,
                 request_body_check: Optional[_builtins.bool] = None,
                 rule_set_type: Optional[_builtins.str] = None):
        """
        :param _builtins.bool enabled: Is the Web Application Firewall enabled?
        :param _builtins.str firewall_mode: The Web Application Firewall Mode. Possible values are `Detection` and `Prevention`.
        :param _builtins.str rule_set_version: The Version of the Rule Set used for this Web Application Firewall. Possible values are `0.1`, `1.0`, `1.1`, `2.1`, `2.2`, `2.2.9`, `3.0`, `3.1` and `3.2`.
        ...
        :param _builtins.int file_upload_limit_mb: The File Upload Limit in MB. Accepted values are in the range `1`MB to `750`MB for the `WAF_v2` SKU, and `1`MB to `500`MB for all other SKUs. Defaults to `100`MB.
        :param _builtins.int max_request_body_size_kb: The Maximum Request Body Size in KB. Accepted values are in the range `1`KB to `128`KB. Defaults to `128`KB.
        :param _builtins.bool request_body_check: Is Request Body Inspection enabled? Defaults to `true`.
        :param _builtins.str rule_set_type: The Type of the Rule Set used for this Web Application Firewall. Possible values are `OWASP`, `Microsoft_BotManagerRuleSet` and `Microsoft_DefaultRuleSet`. Defaults to `OWASP`.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def file_upload_limit_mb(self) -> Optional[_builtins.int]:
        """
    ...
    def max_request_body_size_kb(self) -> Optional[_builtins.int]:
        """
    ...
    def rule_set_type(self) -> Optional[_builtins.str]:
        """
...
class ApplicationGatewayWafConfigurationDisabledRuleGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str rule_group_name: The rule group where specific rules should be disabled. Possible values are `BadBots`, `crs_20_protocol_violations`, `crs_21_protocol_anomalies`, `crs_23_request_limits`, `crs_30_http_policy`, `crs_35_bad_robots`, `crs_40_generic_attacks`, `crs_41_sql_injection_attacks`, `crs_41_xss_attacks`, `crs_42_tight_security`, `crs_45_trojans`, `crs_49_inbound_blocking`, `General`, `GoodBots`, `KnownBadBots`, `Known-CVEs`, `REQUEST-911-METHOD-ENFORCEMENT`, `REQUEST-913-SCANNER-DETECTION`, `REQUEST-920-PROTOCOL-ENFORCEMENT`, `REQUEST-921-PROTOCOL-ATTACK`, `REQUEST-930-APPLICATION-ATTACK-LFI`, `REQUEST-931-APPLICATION-ATTACK-RFI`, `REQUEST-932-APPLICATION-ATTACK-RCE`, `REQUEST-933-APPLICATION-ATTACK-PHP`, `REQUEST-941-APPLICATION-ATTACK-XSS`, `REQUEST-942-APPLICATION-ATTACK-SQLI`, `REQUEST-943-APPLICATION-ATTACK-SESSION-FIXATION`, `REQUEST-944-APPLICATION-ATTACK-JAVA`, `UnknownBots`, `METHOD-ENFORCEMENT`, `PROTOCOL-ENFORCEMENT`, `PROTOCOL-ATTACK`, `LFI`, `RFI`, `RCE`, `PHP`, `NODEJS`, `XSS`, `SQLI`, `FIX`, `JAVA`, `MS-ThreatIntel-WebShells`, `MS-ThreatIntel-AppSec`, `MS-ThreatIntel-SQLI`, `MS-ThreatIntel-CVEs` and `MS-ThreatIntel-XSS`.
        :param Sequence[_builtins.int] rules: A list of rules which should be disabled in that group. Disables all rules in the specified group if `rules` is not specified.
        """
...
class ApplicationGatewayWafConfigurationExclusion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str match_variable: Match variable of the exclusion rule to exclude header, cookie or GET arguments. Possible values are `RequestArgKeys`, `RequestArgNames`, `RequestArgValues`, `RequestCookieKeys`, `RequestCookieNames`, `RequestCookieValues`, `RequestHeaderKeys`, `RequestHeaderNames` and `RequestHeaderValues`
        :param _builtins.str selector: String value which will be used for the filter operation. If empty will exclude all traffic on this `match_variable`
        :param _builtins.str selector_match_operator: Operator which will be used to search in the variable content. Possible values are `Contains`, `EndsWith`, `Equals`, `EqualsAny` and `StartsWith`. If empty will exclude all traffic on this `match_variable`
        """
...
class ExpressRouteCircuitPeeringIpv6(dict):
    ...
    def __init__(__self__, *,
                 primary_peer_address_prefix: _builtins.str,
                 secondary_peer_address_prefix: _builtins.str,
        ...
        """
        :param _builtins.str primary_peer_address_prefix: A subnet for the primary link.
        :param _builtins.str secondary_peer_address_prefix: A subnet for the secondary link.
        :param _builtins.bool enabled: A boolean value indicating whether the IPv6 peering is enabled. Defaults to `true`.
        :param 'ExpressRouteCircuitPeeringIpv6MicrosoftPeeringArgs' microsoft_peering: A `microsoft_peering` block as defined below.
        :param _builtins.str route_filter_id: The ID of the Route Filter. Only available when `peering_type` is set to `MicrosoftPeering`.
    ...
    def route_filter_id(self) -> Optional[_builtins.str]:
        """
...
class ExpressRouteCircuitPeeringIpv6MicrosoftPeering(dict):
    ...
    def __init__(__self__, *,
                 advertised_communities: Optional[Sequence[_builtins.str]] = None,
                 advertised_public_prefixes: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] advertised_public_prefixes: A list of Advertised Public Prefixes.
        :param _builtins.int customer_asn: The CustomerASN of the peering. Defaults to `0`.
        :param _builtins.str routing_registry_name: The Routing Registry against which the AS number and prefixes are registered. For example: `ARIN`, `RIPE`, `AFRINIC` etc. Defaults to `NONE`.
        """
...
class ExpressRouteCircuitPeeringMicrosoftPeeringConfig(dict):
    ...
    def __init__(__self__, *,
                 advertised_public_prefixes: Sequence[_builtins.str],
                 advertised_communities: Optional[Sequence[_builtins.str]] = None,
                 customer_asn: Optional[_builtins.int] = None,
                 routing_registry_name: Optional[_builtins.str] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="advertisedPublicPrefixes")
    def advertised_public_prefixes(self) -> Sequence[_builtins.str]:
        """
        A list of Advertised Public Prefixes.
        """
        return pulumi.get(self, "advertised_public_prefixes")
...
class ExpressRouteCircuitSku(dict):
    def __init__(__self__, *,
                 ...
                 tier: _builtins.str):
        """
        :param _builtins.str family: The billing mode for bandwidth. Possible values are `MeteredData` or `UnlimitedData`.
               
               > **Note:** You can migrate from `MeteredData` to `UnlimitedData`, but not the other way around.
        :param _builtins.str tier: The service tier. Possible values are `Basic`, `Local`, `Standard` or `Premium`.
        """
...
class ExpressRouteConnectionRouting(dict):
    ...
    def __init__(__self__, *,
                 associated_route_table_id: Optional[_builtins.str] = None,
                 inbound_route_map_id: Optional[_builtins.str] = None,
                 outbound_route_map_id: Optional[_builtins.str] = None,
                 propagated_route_table: Optional['outputs.ExpressRouteConnectionRoutingPropagatedRouteTable'] = None):
        """
        :param _builtins.str associated_route_table_id: The ID of the Virtual Hub Route Table associated with this Express Route Connection.
        :param _builtins.str inbound_route_map_id: The ID of the Route Map associated with this Express Route Connection for inbound routes.
        :param _builtins.str outbound_route_map_id: The ID of the Route Map associated with this Express Route Connection for outbound routes.
    ...
    def associated_route_table_id(self) -> Optional[_builtins.str]:
        """
    ...
    def inbound_route_map_id(self) -> Optional[_builtins.str]:
        """
    ...
    def outbound_route_map_id(self) -> Optional[_builtins.str]:
        """
...
class ExpressRouteConnectionRoutingPropagatedRouteTable(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] labels: The list of labels to logically group route tables.
        :param Sequence[_builtins.str] route_table_ids: A list of IDs of the Virtual Hub Route Table to propagate routes from Express Route Connection to the route table.
        """
...
class ExpressRoutePortIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Express Route Port. Only possible value is `UserAssigned`.
        :param Sequence[_builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Express Route Port.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class ExpressRoutePortLink1(dict):
    ...
    def __init__(__self__, *,
                 ...
                 macsec_cak_keyvault_secret_id: Optional[_builtins.str] = None,
                 macsec_cipher: Optional[_builtins.str] = None,
                 macsec_ckn_keyvault_secret_id: Optional[_builtins.str] = None,
                 macsec_sci_enabled: Optional[_builtins.bool] = None,
                 patch_panel_id: Optional[_builtins.str] = None,
                 rack_id: Optional[_builtins.str] = None,
                 router_name: Optional[_builtins.str] = None):
        """
        :param _builtins.bool admin_enabled: Whether enable administration state on the Express Route Port Link? Defaults to `false`.
        :param _builtins.str connector_type: The connector type of the Express Route Port Link.
        :param _builtins.str id: The ID of this Express Route Port Link.
        :param _builtins.str interface_name: The interface name of the Azure router associated with the Express Route Port Link.
        :param _builtins.str macsec_cak_keyvault_secret_id: The ID of the Key Vault Secret that contains the Mac security CAK key for this Express Route Port Link.
        :param _builtins.str macsec_cipher: The MACSec cipher used for this Express Route Port Link. Possible values are `GcmAes128`, `GcmAes256`, `GcmAesXpn128` and `GcmAesXpn256`. Defaults to `GcmAes128`.
        :param _builtins.str macsec_ckn_keyvault_secret_id: The ID of the Key Vault Secret that contains the MACSec CKN key for this Express Route Port Link.
        :param _builtins.bool macsec_sci_enabled: Should Secure Channel Identifier on the Express Route Port Link be enabled? Defaults to `false`.
        ...
        :param _builtins.str patch_panel_id: The ID that maps from the Express Route Port Link to the patch panel port.
        :param _builtins.str rack_id: The ID that maps from the patch panel port to the rack.
        :param _builtins.str router_name: The name of the Azure router associated with the Express Route Port Link.
        """
    ...
    def macsec_cak_keyvault_secret_id(self) -> Optional[_builtins.str]:
        """
    ...
    def macsec_cipher(self) -> Optional[_builtins.str]:
        """
    ...
    def macsec_ckn_keyvault_secret_id(self) -> Optional[_builtins.str]:
        """
    ...
    def macsec_sci_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def patch_panel_id(self) -> Optional[_builtins.str]:
        """
    ...
    def rack_id(self) -> Optional[_builtins.str]:
        """
    ...
    def router_name(self) -> Optional[_builtins.str]:
        """
...
class FirewallApplicationRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fqdn_tags: Optional[Sequence[_builtins.str]] = None,
        ...
        """
        :param _builtins.str name: Specifies the name of the rule.
        :param _builtins.str description: Specifies a description for the rule.
        :param Sequence[_builtins.str] fqdn_tags: A list of FQDN tags. Possible values are `AppServiceEnvironment`, `AzureBackup`, `AzureKubernetesService`, `HDInsight`, `MicrosoftActiveProtectionService`, `WindowsDiagnostics`, `WindowsUpdate` and `WindowsVirtualDesktop`.
        :param Sequence['FirewallApplicationRuleCollectionRuleProtocolArgs'] protocols: One or more `protocol` blocks as defined below.
        :param Sequence[_builtins.str] source_addresses: A list of source IP addresses and/or IP ranges.
        :param Sequence[_builtins.str] source_ip_groups: A list of source IP Group IDs for the rule.
               
               > **Note:** At least one of `source_addresses` and `source_ip_groups` must be specified for a rule.
        :param Sequence[_builtins.str] target_fqdns: A list of FQDNs.
        """
        pulumi.set(__self__, "name", name)
...
class FirewallApplicationRuleCollectionRuleProtocol(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.int port: Specify a port for the connection.
        :param _builtins.str type: Specifies the type of connection. Possible values are `Http`, `Https` and `Mssql`.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "type", type)
...
class FirewallIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subnet_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: Specifies the name of the IP Configuration.
        :param _builtins.str private_ip_address: The private IP address associated with the Firewall.
        :param _builtins.str public_ip_address_id: The ID of the Public IP Address associated with the firewall.
        ...
        :param _builtins.str subnet_id: Reference to the subnet associated with the IP Configuration. Changing this forces a new resource to be created.
...
class FirewallNatRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 translated_address: _builtins.str,
                 translated_port: _builtins.str,
                 description: Optional[_builtins.str] = None,
                 source_addresses: Optional[Sequence[_builtins.str]] = None,
                 source_ip_groups: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] destination_addresses: A list of destination IP addresses and/or IP ranges.
        :param Sequence[_builtins.str] destination_ports: A list of destination ports.
        :param _builtins.str name: Specifies the name of the rule.
        :param Sequence[_builtins.str] protocols: A list of protocols. Possible values are `Any`, `ICMP`, `TCP` and `UDP`. If `action` is `Dnat`, protocols can only be `TCP` and `UDP`.
        :param _builtins.str translated_address: The address of the service behind the Firewall.
        :param _builtins.str translated_port: The port of the service behind the Firewall.
        :param _builtins.str description: Specifies a description for the rule.
        :param Sequence[_builtins.str] source_addresses: A list of source IP addresses and/or IP ranges.
        :param Sequence[_builtins.str] source_ip_groups: A list of source IP Group IDs for the rule.
    ...
    def translated_address(self) -> _builtins.str:
        """
    ...
    def translated_port(self) -> _builtins.str:
        """
...
class FirewallNetworkRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_fqdns: Optional[Sequence[_builtins.str]] = None,
                 destination_ip_groups: Optional[Sequence[_builtins.str]] = None,
                 source_addresses: Optional[Sequence[_builtins.str]] = None,
                 source_ip_groups: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] destination_ports: A list of destination ports.
        :param _builtins.str name: Specifies the name of the rule.
        :param Sequence[_builtins.str] protocols: A list of protocols. Possible values are `Any`, `ICMP`, `TCP` and `UDP`.
        :param _builtins.str description: Specifies a description for the rule.
        :param Sequence[_builtins.str] destination_addresses: Either a list of destination IP addresses and/or IP ranges, or a list of destination [Service Tags](https://docs.microsoft.com/azure/virtual-network/service-tags-overview#available-service-tags).
        :param Sequence[_builtins.str] destination_fqdns: A list of destination FQDNS for the rule.
        ...
        :param Sequence[_builtins.str] destination_ip_groups: A list of destination IP Group IDs for the rule.
        :param Sequence[_builtins.str] source_addresses: A list of source IP addresses and/or IP ranges.
        :param Sequence[_builtins.str] source_ip_groups: A list of IP Group IDs for the rule.
...
class FirewallPolicyDns(dict):
    ...
    def __init__(__self__, *,
                 proxy_enabled: Optional[_builtins.bool] = None,
                 servers: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.bool proxy_enabled: Whether to enable DNS proxy on Firewalls attached to this Firewall Policy? Defaults to `false`.
        :param Sequence[_builtins.str] servers: A list of custom DNS servers' IP addresses.
        """
    ...
    def proxy_enabled(self) -> Optional[_builtins.bool]:
        """
...
class FirewallPolicyExplicitProxy(dict):
    ...
    def __init__(__self__, *,
                 enable_pac_file: Optional[_builtins.bool] = None,
                 enabled: Optional[_builtins.bool] = None,
                 http_port: Optional[_builtins.int] = None,
                 https_port: Optional[_builtins.int] = None,
                 pac_file: Optional[_builtins.str] = None,
                 pac_file_port: Optional[_builtins.int] = None):
        """
        :param _builtins.bool enable_pac_file: Whether the pac file port and url need to be provided.
        :param _builtins.bool enabled: Whether the explicit proxy is enabled for this Firewall Policy.
        :param _builtins.int http_port: The port number for explicit http protocol.
        :param _builtins.int https_port: The port number for explicit proxy https protocol.
        :param _builtins.str pac_file: Specifies a SAS URL for PAC file.
        :param _builtins.int pac_file_port: Specifies a port number for firewall to serve PAC file.
        """
...
class FirewallPolicyIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Firewall Policy. Only possible value is `UserAssigned`.
        :param Sequence[_builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Firewall Policy.
        """
        pulumi.set(__self__, "type", type)
        if identity_ids is not None:
            pulumi.set(__self__, "identity_ids", identity_ids)
...
class FirewallPolicyInsights(dict):
    ...
    def __init__(__self__, *,
                 default_log_analytics_workspace_id: _builtins.str,
                 enabled: _builtins.bool,
        ...
        """
        :param _builtins.str default_log_analytics_workspace_id: The ID of the default Log Analytics Workspace that the Firewalls associated with this Firewall Policy will send their logs to, when there is no location matches in the `log_analytics_workspace`.
        :param _builtins.bool enabled: Whether the insights functionality is enabled for this Firewall Policy.
        ...
        :param _builtins.int retention_in_days: The log retention period in days.
        """
    ...
    def default_log_analytics_workspace_id(self) -> _builtins.str:
        """
...
class FirewallPolicyInsightsLogAnalyticsWorkspace(dict):
    ...
    def __init__(__self__, *,
                 firewall_location: _builtins.str,
                 id: _builtins.str):
        """
        :param _builtins.str firewall_location: The location of the Firewalls, that when matches this Log Analytics Workspace will be used to consume their logs.
        :param _builtins.str id: The ID of the Log Analytics Workspace that the Firewalls associated with this Firewall Policy will send their logs to when their locations match the `firewall_location`.
        """
    ...
    def firewall_location(self) -> _builtins.str:
        """
...
class FirewallPolicyIntrusionDetection(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str mode: In which mode you want to run intrusion detection: `Off`, `Alert` or `Deny`.
        :param Sequence[_builtins.str] private_ranges: A list of Private IP address ranges to identify traffic direction. By default, only ranges defined by IANA RFC 1918 are considered private IP addresses.
...
class FirewallPolicyIntrusionDetectionSignatureOverride(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: 12-digit number (id) which identifies your signature.
        :param _builtins.str state: state can be any of `Off`, `Alert` or `Deny`.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class FirewallPolicyIntrusionDetectionTrafficBypass(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_ip_groups: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str name: The name which should be used for this bypass traffic setting.
        :param _builtins.str protocol: The protocols any of `ANY`, `TCP`, `ICMP`, `UDP` that shall be bypassed by intrusion detection.
        :param _builtins.str description: The description for this bypass traffic setting.
        :param Sequence[_builtins.str] destination_addresses: Specifies a list of destination IP addresses that shall be bypassed by intrusion detection.
        :param Sequence[_builtins.str] destination_ip_groups: Specifies a list of destination IP groups that shall be bypassed by intrusion detection.
        :param Sequence[_builtins.str] destination_ports: Specifies a list of destination IP ports that shall be bypassed by intrusion detection.
        :param Sequence[_builtins.str] source_addresses: Specifies a list of source addresses that shall be bypassed by intrusion detection.
        :param Sequence[_builtins.str] source_ip_groups: Specifies a list of source IP groups that shall be bypassed by intrusion detection.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "protocol", protocol)
        if description is not None:
...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollection(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: The action to take for the application rules in this collection. Possible values are `Allow` and `Deny`.
        :param _builtins.str name: The name which should be used for this application rule collection.
        :param _builtins.int priority: The priority of the application rule collection. The range is `100` - `65000`.
        :param Sequence['FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleArgs'] rules: One or more `application_rule` blocks as defined below.
        """
...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[_builtins.str] = None,
                 destination_addresses: Optional[Sequence[_builtins.str]] = None,
                 destination_fqdn_tags: Optional[Sequence[_builtins.str]] = None,
                 destination_fqdns: Optional[Sequence[_builtins.str]] = None,
                 destination_urls: Optional[Sequence[_builtins.str]] = None,
                 http_headers: Optional[Sequence['outputs.FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader']] = None,
                 protocols: Optional[Sequence['outputs.FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleProtocol']] = None,
                 source_addresses: Optional[Sequence[_builtins.str]] = None,
                 source_ip_groups: Optional[Sequence[_builtins.str]] = None,
                 terminate_tls: Optional[_builtins.bool] = None,
                 web_categories: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str name: The name which should be used for this Firewall Policy Rule Collection Group. Changing this forces a new Firewall Policy Rule Collection Group to be created.
        :param Sequence[_builtins.str] destination_fqdn_tags: Specifies a list of destination FQDN tags.
        :param Sequence[_builtins.str] destination_urls: Specifies a list of destination URLs for which policy should hold. Needs Premium SKU for Firewall Policy. Conflicts with `destination_fqdns`.
        ...
        :param _builtins.bool terminate_tls: Boolean specifying if TLS shall be terminated (true) or not (false). Must be `true` when using `destination_urls`. Needs Premium SKU for Firewall Policy.
        :param Sequence[_builtins.str] web_categories: Specifies a list of web categories to which access is denied or allowed depending on the value of `action` above. Needs Premium SKU for Firewall Policy.
        """
        pulumi.set(__self__, "name", name)
        if description is not None:
            pulumi.set(__self__, "description", description)
    ...
    def destination_fqdn_tags(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def destination_urls(self) -> Optional[Sequence[_builtins.str]]:
        """
...
@pulumi.output_type
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 value: _builtins.str):
        """
        :param _builtins.str name: Specifies the name of the header.
        :param _builtins.str value: Specifies the value of the value.
        """
        pulumi.set(__self__, "name", name)
...
class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleProtocol(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param _builtins.int port: Port number of the protocol. Range is 0-64000.
        :param _builtins.str type: Protocol type. Possible values are `Http` and `Https`.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "type", type)
...
class FirewallPolicyRuleCollectionGroupNatRuleCollection(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: The action to take for the NAT rules in this collection. Currently, the only possible value is `Dnat`.
        :param _builtins.str name: The name which should be used for this NAT rule collection.
        :param _builtins.int priority: The priority of the NAT rule collection. The range is `100` - `65000`.
        :param Sequence['FirewallPolicyRuleCollectionGroupNatRuleCollectionRuleArgs'] rules: A `nat_rule` block as defined below.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "priority", priority)
...
class FirewallPolicyRuleCollectionGroupNatRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_addresses: Optional[Sequence[_builtins.str]] = None,
                 source_ip_groups: Optional[Sequence[_builtins.str]] = None,
                 translated_address: Optional[_builtins.str] = None,
                 translated_fqdn: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name which should be used for this Firewall Policy Rule Collection Group. Changing this forces a new Firewall Policy Rule Collection Group to be created.
        :param _builtins.int translated_port: Specifies the translated port.
        :param _builtins.str destination_address: The destination IP address (including CIDR).
        :param _builtins.str translated_address: Specifies the translated address.
        :param _builtins.str translated_fqdn: Specifies the translated FQDN.
...
class FirewallPolicyRuleCollectionGroupNetworkRuleCollection(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action: The action to take for the network rules in this collection. Possible values are `Allow` and `Deny`.
        :param _builtins.str name: The name which should be used for this network rule collection.
        :param _builtins.int priority: The priority of the network rule collection. The range is `100` - `65000`.
        :param Sequence['FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRuleArgs'] rules: One or more `network_rule` blocks as defined below.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "priority", priority)
...
class FirewallPolicyRuleCollectionGroupNetworkRuleCollectionRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name which should be used for this Firewall Policy Rule Collection Group. Changing this forces a new Firewall Policy Rule Collection Group to be created.
        :param Sequence[_builtins.str] destination_ip_groups: Specifies a list of destination IP groups.
        """
        pulumi.set(__self__, "destination_ports", destination_ports)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "protocols", protocols)
...
class FirewallPolicyThreatIntelligenceAllowlist(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_addresses: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] fqdns: A list of FQDNs that will be skipped for threat detection.
        :param Sequence[_builtins.str] ip_addresses: A list of IP addresses or CIDR ranges that will be skipped for threat detection.
        """
        if fqdns is not None:
            pulumi.set(__self__, "fqdns", fqdns)
        if ip_addresses is not None:
...
class FirewallPolicyTlsCertificate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str key_vault_secret_id: The Secret Identifier (URI) of the certificate stored in Azure Key Vault, either as a secret or certificate.
...
class FirewallVirtualHub(dict):
    ...
    def __init__(__self__, *,
                 ...
                 public_ip_count: Optional[_builtins.int] = None):
        """
        :param _builtins.str virtual_hub_id: Specifies the ID of the Virtual Hub where the Firewall resides in.
        :param _builtins.str private_ip_address: The private IP address associated with the Firewall.
        :param Sequence[_builtins.str] public_ip_addresses: The list of public IP addresses associated with the Firewall.
        :param _builtins.int public_ip_count: Specifies the number of public IPs to assign to the Firewall. Defaults to `1`.
        """
    ...
    def public_ip_count(self) -> Optional[_builtins.int]:
        """
...
class LocalNetworkGatewayBgpSettings(dict):
    ...
    def __init__(__self__, *,
                 asn: _builtins.int,
                 bgp_peering_address: _builtins.str,
                 peer_weight: Optional[_builtins.int] = None):
        """
        :param _builtins.int asn: The BGP speaker's ASN.
        :param _builtins.str bgp_peering_address: The BGP peering address and BGP identifier of this BGP speaker.
        :param _builtins.int peer_weight: The weight added to routes learned from this BGP speaker.
        """
    ...
    def bgp_peering_address(self) -> _builtins.str:
        """
...
class NetworkConnectionMonitorEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 coverage_level: Optional[_builtins.str] = None,
                 excluded_ip_addresses: Optional[Sequence[_builtins.str]] = None,
                 filter: Optional['outputs.NetworkConnectionMonitorEndpointFilter'] = None,
                 included_ip_addresses: Optional[Sequence[_builtins.str]] = None,
                 target_resource_id: Optional[_builtins.str] = None,
                 target_resource_type: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name of the endpoint for the Network Connection Monitor .
        :param _builtins.str address: The IP address or domain name of the Network Connection Monitor endpoint.
        :param _builtins.str coverage_level: The test coverage for the Network Connection Monitor endpoint. Possible values are `AboveAverage`, `Average`, `BelowAverage`, `Default`, `Full` and `Low`.
        :param Sequence[_builtins.str] excluded_ip_addresses: A list of IPv4/IPv6 subnet masks or IPv4/IPv6 IP addresses to be excluded to the Network Connection Monitor endpoint.
        :param 'NetworkConnectionMonitorEndpointFilterArgs' filter: A `filter` block as defined below.
        :param Sequence[_builtins.str] included_ip_addresses: A list of IPv4/IPv6 subnet masks or IPv4/IPv6 IP addresses to be included to the Network Connection Monitor endpoint.
        :param _builtins.str target_resource_id: The resource ID which is used as the endpoint by the Network Connection Monitor.
        :param _builtins.str target_resource_type: The endpoint type of the Network Connection Monitor. Possible values are `AzureArcVM`, `AzureSubnet`, `AzureVM`, `AzureVNet`, `ExternalAddress`, `MMAWorkspaceMachine` and `MMAWorkspaceNetwork`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def excluded_ip_addresses(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def included_ip_addresses(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class NetworkConnectionMonitorEndpointFilter(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The behaviour type of this endpoint filter. Currently the only allowed value is `Include`. Defaults to `Include`.
        """
...
class NetworkConnectionMonitorEndpointFilterItem(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The type of items included in the filter. Possible values are `AgentAddress`. Defaults to `AgentAddress`.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
        if type is not None:
...
class NetworkConnectionMonitorTestConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 preferred_ip_version: Optional[_builtins.str] = None,
                 ...
                 test_frequency_in_seconds: Optional[_builtins.int] = None):
        """
        :param _builtins.str name: The name of test configuration for the Network Connection Monitor.
        :param _builtins.str protocol: The protocol used to evaluate tests. Possible values are `Tcp`, `Http` and `Icmp`.
        ...
        :param _builtins.str preferred_ip_version: The preferred IP version which is used in the test evaluation. Possible values are `IPv4` and `IPv6`.
        ...
        :param _builtins.int test_frequency_in_seconds: The time interval in seconds at which the test evaluation will happen. Defaults to `60`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "protocol", protocol)
    ...
    def test_frequency_in_seconds(self) -> Optional[_builtins.int]:
        """
...
class NetworkConnectionMonitorTestConfigurationHttpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path: Optional[_builtins.str] = None,
                 port: Optional[_builtins.int] = None,
                 prefer_https: Optional[_builtins.bool] = None,
        ...
        """
        :param _builtins.str method: The HTTP method for the HTTP request. Possible values are `Get` and `Post`. Defaults to `Get`.
        :param _builtins.str path: The path component of the URI. It only accepts the absolute path.
        :param _builtins.int port: The port for the HTTP connection.
        :param _builtins.bool prefer_https: Should HTTPS be preferred over HTTP in cases where the choice is not explicit? Defaults to `false`.
        ...
        :param Sequence[_builtins.str] valid_status_code_ranges: The HTTP status codes to consider successful. For instance, `2xx`, `301-304` and `418`.
        """
...
class NetworkConnectionMonitorTestConfigurationIcmpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 trace_route_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool trace_route_enabled: Should path evaluation with trace route be enabled? Defaults to `true`.
        """
    ...
    def trace_route_enabled(self) -> Optional[_builtins.bool]:
        """
...
class NetworkConnectionMonitorTestConfigurationSuccessThreshold(dict):
    ...
    def __init__(__self__, *,
                 checks_failed_percent: Optional[_builtins.int] = None,
                 round_trip_time_ms: Optional[_builtins.float] = None):
        """
        :param _builtins.int checks_failed_percent: The maximum percentage of failed checks permitted for a test to be successful.
        :param _builtins.float round_trip_time_ms: The maximum round-trip time in milliseconds permitted for a test to be successful.
        """
...
class NetworkConnectionMonitorTestConfigurationTcpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 port: _builtins.int,
                 destination_port_behavior: Optional[_builtins.str] = None,
                 trace_route_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.int port: The port for the TCP connection.
        :param _builtins.str destination_port_behavior: The destination port behavior for the TCP connection. Possible values are `None` and `ListenIfAvailable`.
        :param _builtins.bool trace_route_enabled: Should path evaluation with trace route be enabled? Defaults to `true`.
        """
        pulumi.set(__self__, "port", port)
...
class NetworkConnectionMonitorTestGroup(dict):
    ...
    def __init__(__self__, *,
                 destination_endpoints: Sequence[_builtins.str],
                 name: _builtins.str,
                 source_endpoints: Sequence[_builtins.str],
                 test_configuration_names: Sequence[_builtins.str],
                 enabled: Optional[_builtins.bool] = None):
        """
        :param Sequence[_builtins.str] destination_endpoints: A list of destination endpoint names.
        :param _builtins.str name: The name of the test group for the Network Connection Monitor.
        :param Sequence[_builtins.str] source_endpoints: A list of source endpoint names.
        :param Sequence[_builtins.str] test_configuration_names: A list of test configuration names.
        :param _builtins.bool enabled: Should the test group be enabled? Defaults to `true`.
        """
    ...
    def destination_endpoints(self) -> Sequence[_builtins.str]:
        """
    ...
    def source_endpoints(self) -> Sequence[_builtins.str]:
        """
    ...
    def test_configuration_names(self) -> Sequence[_builtins.str]:
        """
...
class NetworkInterfaceIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subnet_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: A name used for this IP Configuration.
        :param _builtins.str private_ip_address_allocation: The allocation method used for the Private IP Address. Possible values are `Dynamic` and `Static`.
        ...
        :param _builtins.bool primary: Is this the Primary IP Configuration? Must be `true` for the first `ip_configuration` when multiple are specified. Defaults to `false`.
        :param _builtins.str private_ip_address: The first private IP address of the network interface.
        :param _builtins.str private_ip_address_version: The IP Version to use. Possible values are `IPv4` or `IPv6`. Defaults to `IPv4`.
        :param _builtins.str public_ip_address_id: Reference to a Public IP Address to associate with this NIC
        :param _builtins.str subnet_id: The ID of the Subnet where this Network Interface should be located in.
...
class NetworkManagerAdminRuleDestination(dict):
    ...
    def __init__(__self__, *,
                 ...
                 address_prefix_type: _builtins.str):
        """
        :param _builtins.str address_prefix: Specifies the address prefix.
        :param _builtins.str address_prefix_type: Specifies the address prefix type. Possible values are `IPPrefix` and `ServiceTag`. For more information, please see [this document](https://learn.microsoft.com/en-us/azure/virtual-network-manager/concept-security-admins#source-and-destination-types).
        """
    ...
    def address_prefix_type(self) -> _builtins.str:
        """
...
class NetworkManagerConnectivityConfigurationAppliesToGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 global_mesh_enabled: Optional[_builtins.bool] = None,
                 use_hub_gateway: Optional[_builtins.bool] = None):
        """
        :param _builtins.str group_connectivity: Specifies the group connectivity type. Possible values are `None` and `DirectlyConnected`.
        :param _builtins.str network_group_id: Specifies the resource ID of Network Group which the configuration applies to.
        :param _builtins.bool global_mesh_enabled: Indicates whether to global mesh is supported for this group. Possible values are `true` and `false`.
               
               > **Note:** A group can be global only if the `group_connectivity` is `DirectlyConnected`.
        :param _builtins.bool use_hub_gateway: Indicates whether the hub gateway is used. Possible values are `true` and `false`.
        """
    ...
    def global_mesh_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def use_hub_gateway(self) -> Optional[_builtins.bool]:
        """
...
class NetworkManagerConnectivityConfigurationHub(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str resource_id: Specifies the resource ID used as hub in Hub And Spoke topology.
        :param _builtins.str resource_type: Specifies the resource Type used as hub in Hub And Spoke topology.
        """
...
class NetworkManagerCrossTenantScope(dict):
    ...
    def __init__(__self__, *,
                 management_groups: Optional[Sequence[_builtins.str]] = None,
...
class NetworkManagerScope(dict):
    ...
    def __init__(__self__, *,
                 management_group_ids: Optional[Sequence[_builtins.str]] = None,
                 subscription_ids: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] management_group_ids: A list of management group IDs.
        ...
        :param Sequence[_builtins.str] subscription_ids: A list of subscription IDs.
        """
    ...
    def management_group_ids(self) -> Optional[Sequence[_builtins.str]]:
        """
...
@pulumi.output_type
class NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentIpTraffic(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentIpTraffic. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        NetworkManagerVerifierWorkspaceReachabilityAnalysisIntentIpTraffic.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] destination_ips: Specifies a list of IPv4 or IPv6 addresses or ranges using CIDR notation of the source you want to verify. Changing this forces a new Network Manager Verifier Workspace Reachability Analysis Intent to be created.
        :param Sequence[_builtins.str] destination_ports: Specifies a list of ports or ranges of the destination you want to verify. To specify any port, use `["*"]`. Changing this forces a new Network Manager Verifier Workspace Reachability Analysis Intent to be created.
        :param Sequence[_builtins.str] protocols: Specifies a list of network protocols. Possible values are `Any`, `TCP`, `UDP` and `ICMP`. Changing this forces a new Network Manager Verifier Workspace Reachability Analysis Intent to be created.
        :param Sequence[_builtins.str] source_ips: Specifies a list of IPv4 or IPv6 addresses or ranges using CIDR notation of the source you want to verify. Changing this forces a new Network Manager Verifier Workspace Reachability Analysis Intent to be created.
        :param Sequence[_builtins.str] source_ports: Specifies a list of ports or ranges of the source you want to verify. To specify any port, use `["*"]`. Changing this forces a new Network Manager Verifier Workspace Reachability Analysis Intent to be created.
        """
...
class NetworkSecurityGroupSecurityRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_application_security_group_ids: Optional[Sequence[_builtins.str]] = None,
                 ...
                 source_application_security_group_ids: Optional[Sequence[_builtins.str]] = None,
                 source_port_range: Optional[_builtins.str] = None,
                 source_port_ranges: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str access: Specifies whether network traffic is allowed or denied. Possible values are `Allow` and `Deny`.
        :param _builtins.str direction: The direction specifies if rule will be evaluated on incoming or outgoing traffic. Possible values are `Inbound` and `Outbound`.
        :param _builtins.str name: The name of the security rule.
        :param _builtins.int priority: Specifies the priority of the rule. The value can be between 100 and 4096. The priority number must be unique for each rule in the collection. The lower the priority number, the higher the priority of the rule.
        :param _builtins.str protocol: Network protocol this rule applies to. Possible values include `Tcp`, `Udp`, `Icmp`, `Esp`, `Ah` or `*` (which matches all).
        :param _builtins.str description: A description for this rule. Restricted to 140 characters.
        :param _builtins.str destination_address_prefix: CIDR or destination IP range or * to match any IP. Tags such as `VirtualNetwork`, `AzureLoadBalancer` and `Internet` can also be used. This is required if `destination_address_prefixes` is not specified.
        :param Sequence[_builtins.str] destination_address_prefixes: List of destination address prefixes. Tags may not be used. This is required if `destination_address_prefix` is not specified.
        :param Sequence[_builtins.str] destination_application_security_group_ids: A List of destination Application Security Group IDs
        :param _builtins.str destination_port_range: Destination Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `destination_port_ranges` is not specified.
        :param Sequence[_builtins.str] destination_port_ranges: List of destination ports or port ranges. This is required if `destination_port_range` is not specified.
        :param _builtins.str source_address_prefix: CIDR or source IP range or * to match any IP. Tags such as `VirtualNetwork`, `AzureLoadBalancer` and `Internet` can also be used. This is required if `source_address_prefixes` is not specified.
        :param Sequence[_builtins.str] source_address_prefixes: List of source address prefixes. Tags may not be used. This is required if `source_address_prefix` is not specified.
        :param Sequence[_builtins.str] source_application_security_group_ids: A List of source Application Security Group IDs
        :param _builtins.str source_port_range: Source Port or Range. Integer or range between `0` and `65535` or `*` to match any. This is required if `source_port_ranges` is not specified.
        :param Sequence[_builtins.str] source_port_ranges: List of source ports or port ranges. This is required if `source_port_range` is not specified.
        """
    ...
    def destination_application_security_group_ids(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def source_application_security_group_ids(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class NetworkWatcherFlowLogRetentionPolicy(dict):
    def __init__(__self__, *,
                 ...
                 enabled: _builtins.bool):
        """
        :param _builtins.int days: The number of days to retain flow log records.
        :param _builtins.bool enabled: Boolean flag to enable/disable retention.
        """
...
class NetworkWatcherFlowLogTrafficAnalytics(dict):
    ...
    def __init__(__self__, *,
                 ...
                 workspace_region: _builtins.str,
                 workspace_resource_id: _builtins.str,
                 interval_in_minutes: Optional[_builtins.int] = None):
        """
        :param _builtins.bool enabled: Boolean flag to enable/disable traffic analytics.
        :param _builtins.str workspace_id: The resource GUID of the attached workspace.
        :param _builtins.str workspace_region: The location of the attached workspace.
        :param _builtins.str workspace_resource_id: The resource ID of the attached workspace.
        :param _builtins.int interval_in_minutes: How frequently service should do flow analytics in minutes. Defaults to `60`.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def workspace_region(self) -> _builtins.str:
        """
...
class PointToPointVpnGatewayConnectionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 internet_security_enabled: Optional[_builtins.bool] = None,
                 route: Optional['outputs.PointToPointVpnGatewayConnectionConfigurationRoute'] = None):
        """
        :param _builtins.str name: The Name which should be used for this Connection Configuration.
        ...
        :param _builtins.bool internet_security_enabled: Should Internet Security be enabled to secure internet traffic? Defaults to `false`.
    ...
    def internet_security_enabled(self) -> Optional[_builtins.bool]:
        """
...
class PointToPointVpnGatewayConnectionConfigurationRoute(dict):
    ...
    def __init__(__self__, *,
                 associated_route_table_id: _builtins.str,
                 inbound_route_map_id: Optional[_builtins.str] = None,
                 outbound_route_map_id: Optional[_builtins.str] = None,
                 propagated_route_table: Optional['outputs.PointToPointVpnGatewayConnectionConfigurationRoutePropagatedRouteTable'] = None):
        """
        :param _builtins.str associated_route_table_id: The Virtual Hub Route Table resource id associated with this Routing Configuration.
        :param _builtins.str inbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param _builtins.str outbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
    ...
    @_builtins.property
    @pulumi.getter(name="associatedRouteTableId")
    def associated_route_table_id(self) -> _builtins.str:
        """
...
class PointToPointVpnGatewayConnectionConfigurationRoutePropagatedRouteTable(dict):
    def __init__(__self__, *,
                 ...
                 labels: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] ids: The list of Virtual Hub Route Table resource id which the routes will be propagated to.
        :param Sequence[_builtins.str] labels: The list of labels to logically group Virtual Hub Route Tables which the routes will be propagated to.
        """
...
class PointToPointVpnGatewayConnectionConfigurationVpnClientAddressPool(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] address_prefixes: A list of CIDR Ranges which should be used as Address Prefixes.
        """
...
class ProfileContainerNetworkInterfaceIpConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Specifies the name of the IP Configuration.
        :param _builtins.str subnet_id: Reference to the subnet associated with the IP Configuration.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class RouteFilterRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rule_type: _builtins.str):
        """
        :param _builtins.str access: The access type of the rule. The only possible value is `Allow`.
        :param Sequence[_builtins.str] communities: The collection for bgp community values to filter on. e.g. ['12076:5010','12076:5020'].
        :param _builtins.str name: The name of the route filter rule.
        :param _builtins.str rule_type: The rule type of the rule. The only possible value is `Community`.
        """
        pulumi.set(__self__, "access", access)
...
class RouteMapRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str next_step_if_matched: The next step after the rule is evaluated. Possible values are `Continue`, `Terminate` and `Unknown`. Defaults to `Unknown`.
        """
        pulumi.set(__self__, "name", name)
...
class RouteMapRuleAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: The type of the action to be taken. Possible values are `Add`, `Drop`, `Remove`, `Replace` and `Unknown`.
...
class RouteMapRuleActionParameter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_prefixes: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] as_paths: A list of AS paths.
        :param Sequence[_builtins.str] communities: A list of BGP communities.
        :param Sequence[_builtins.str] route_prefixes: A list of route prefixes.
        """
    ...
    def route_prefixes(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class RouteMapRuleMatchCriterion(dict):
    ...
    def __init__(__self__, *,
                 match_condition: _builtins.str,
                 as_paths: Optional[Sequence[_builtins.str]] = None,
                 communities: Optional[Sequence[_builtins.str]] = None,
                 route_prefixes: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str match_condition: The match condition to apply the rule of the Route Map. Possible values are `Contains`, `Equals`, `NotContains`, `NotEquals` and `Unknown`.
        :param Sequence[_builtins.str] as_paths: A list of AS paths which this criterion matches.
        :param Sequence[_builtins.str] communities: A list of BGP communities which this criterion matches.
        :param Sequence[_builtins.str] route_prefixes: A list of route prefixes which this criterion matches.
        """
    ...
    def match_condition(self) -> _builtins.str:
        """
...
class RouteTableRoute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 next_hop_in_ip_address: Optional[_builtins.str] = None):
        """
        :param _builtins.str address_prefix: The destination to which the route applies. Can be CIDR (such as `10.1.0.0/16`) or [Azure Service Tag](https://docs.microsoft.com/azure/virtual-network/service-tags-overview) (such as `ApiManagement`, `AzureBackup` or `AzureMonitor`) format.
        :param _builtins.str name: The name of the route.
        :param _builtins.str next_hop_type: The type of Azure hop the packet should be sent to. Possible values are `VirtualNetworkGateway`, `VnetLocal`, `Internet`, `VirtualAppliance` and `None`.
        :param _builtins.str next_hop_in_ip_address: Contains the IP address packets should be forwarded to. Next hop values are only allowed in routes where the next hop type is `VirtualAppliance`.
        """
        pulumi.set(__self__, "address_prefix", address_prefix)
        pulumi.set(__self__, "name", name)
    ...
    def next_hop_in_ip_address(self) -> Optional[_builtins.str]:
        """
...
class RoutingIntentRoutingPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] destinations: A list of destinations which this routing policy is applicable to. Possible values are `Internet` and `PrivateTraffic`.
        :param _builtins.str name: The unique name for the routing policy.
        :param _builtins.str next_hop: The resource ID of the next hop on which this routing policy is applicable to.
        """
...
class SubnetDelegation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: A name for this delegation.
...
@pulumi.output_type
class SubnetIpAddressPool(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "numberOfIpAddresses":
            suggest = "number_of_ip_addresses"
        elif key == "allocatedIpAddressPrefixes":
            suggest = "allocated_ip_address_prefixes"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SubnetIpAddressPool. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SubnetIpAddressPool.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 id: _builtins.str,
                 number_of_ip_addresses: _builtins.str,
                 allocated_ip_address_prefixes: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str id: The ID of the Network Manager IP Address Management (IPAM) Pool.
        :param _builtins.str number_of_ip_addresses: The number of IP addresses to allocated to the subnet. The value must be a string that represents a positive number, e.g., `"100"`.
               
               > **Note:** `number_of_ip_addresses` cannot be decreased.
        :param Sequence[_builtins.str] allocated_ip_address_prefixes: The list of IP address prefixes allocated to the subnet.
        """
        pulumi.set(__self__, "id", id)
    ...
    def number_of_ip_addresses(self) -> _builtins.str:
        """
    ...
    def allocated_ip_address_prefixes(self) -> Optional[Sequence[_builtins.str]]:
        """
...
@pulumi.output_type
class SubnetServiceEndpoint(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "networkIdentifier":
            suggest = "network_identifier"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SubnetServiceEndpoint. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SubnetServiceEndpoint.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 network_identifier: Optional[_builtins.str] = None):
        """
        :param _builtins.str service: The name of the Service endpoint to associate with the subnet. Possible values are `Microsoft.AzureActiveDirectory`, `Microsoft.AzureCosmosDB`, `Microsoft.CognitiveService`, `Microsoft.ContainerRegistry`, `Microsoft.EventHub`, `Microsoft.KeyVault`, `Microsoft.ServiceBus`, `Microsoft.Sql`, `Microsoft.Storage`, `Microsoft.Storage.Global`, and `Microsoft.Web`.
        :param _builtins.str network_identifier: The ARM resource ID of the network identifier to associate with the service endpoint.
        """
    ...
    def network_identifier(self) -> Optional[_builtins.str]:
        """
...
class SubnetServiceEndpointStoragePolicyDefinition(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 service_resources: Sequence[_builtins.str],
                 description: Optional[_builtins.str] = None,
                 service: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name which should be used for this Subnet Service Endpoint Storage Policy Definition.
        :param Sequence[_builtins.str] service_resources: Specifies a list of resources or aliases that this Subnet Service Endpoint Storage Policy Definition applies to.
               
               > **Note:** The `service_resources` property must contain either Aliases or Resource IDs, but not both.
        :param _builtins.str description: The description of this Subnet Service Endpoint Storage Policy Definition.
        :param _builtins.str service: The type of service resources. Valid values are `Microsoft.Storage` or `Global`. When the `service_resources` property contains resource IDs, this property must be `Microsoft.Storage`. When the `service_resources` property contains Aliases, this property must be `Global`. Defaults to `Microsoft.Storage`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def service_resources(self) -> Sequence[_builtins.str]:
        """
...
class TrafficManagerAzureEndpointCustomHeader(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str value: The value of custom header. Applicable for HTTP and HTTPS protocol.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class TrafficManagerAzureEndpointSubnet(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str first: The first IP Address in this subnet.
        :param _builtins.str last: The last IP Address in this subnet.
        :param _builtins.int scope: The block size (number of leading bits in the subnet mask).
        """
...
class TrafficManagerProfileDnsConfig(dict):
    ...
    def __init__(__self__, *,
                 relative_name: _builtins.str,
                 ttl: _builtins.int):
        """
        :param _builtins.str relative_name: The relative domain name, this is combined with the domain name used by Traffic Manager to form the FQDN which is exported as documented below. Changing this forces a new resource to be created.
        :param _builtins.int ttl: The TTL value of the Profile used by Local DNS resolvers and clients.
        """
...
class TrafficManagerProfileMonitorConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expected_status_code_ranges: Optional[Sequence[_builtins.str]] = None,
                 interval_in_seconds: Optional[_builtins.int] = None,
                 path: Optional[_builtins.str] = None,
                 timeout_in_seconds: Optional[_builtins.int] = None,
                 tolerated_number_of_failures: Optional[_builtins.int] = None):
        """
        :param _builtins.int port: The port number used by the monitoring checks.
        :param _builtins.str protocol: The protocol used by the monitoring checks, supported values are `HTTP`, `HTTPS` and `TCP`.
        ...
        :param Sequence[_builtins.str] expected_status_code_ranges: A list of status code ranges in the format of `100-101`.
        :param _builtins.int interval_in_seconds: The interval used to check the endpoint health from a Traffic Manager probing agent. You can specify two values here: `30` (normal probing) and `10` (fast probing). The default value is `30`.
        :param _builtins.str path: The path used by the monitoring checks. Required when `protocol` is set to `HTTP` or `HTTPS` - cannot be set when `protocol` is set to `TCP`.
        :param _builtins.int timeout_in_seconds: The amount of time the Traffic Manager probing agent should wait before considering that check a failure when a health check probe is sent to the endpoint. If `interval_in_seconds` is set to `30`, then `timeout_in_seconds` can be between `5` and `10`. The default value is `10`. If `interval_in_seconds` is set to `10`, then valid values are between `5` and `9` and `timeout_in_seconds` is required.
        :param _builtins.int tolerated_number_of_failures: The number of failures a Traffic Manager probing agent tolerates before marking that endpoint as unhealthy. Valid values are between `0` and `9`. The default value is `3`
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "protocol", protocol)
    ...
    def expected_status_code_ranges(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def tolerated_number_of_failures(self) -> Optional[_builtins.int]:
        """
...
class VirtualHubConnectionRouting(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "staticVnetPropagateStaticRoutesEnabled":
            suggest = "static_vnet_propagate_static_routes_enabled"
    ...
    def __init__(__self__, *,
                 ...
                 static_vnet_local_route_override_criteria: Optional[_builtins.str] = None,
                 static_vnet_propagate_static_routes_enabled: Optional[_builtins.bool] = None,
                 static_vnet_routes: Optional[Sequence['outputs.VirtualHubConnectionRoutingStaticVnetRoute']] = None):
        """
        :param _builtins.str associated_route_table_id: The ID of the route table associated with this Virtual Hub connection.
        :param _builtins.str inbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param _builtins.str outbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
        ...
        :param _builtins.str static_vnet_local_route_override_criteria: The static VNet local route override criteria that is used to determine whether NVA in spoke VNet is bypassed for traffic with destination in spoke VNet. Possible values are `Contains` and `Equal`. Defaults to `Contains`. Changing this forces a new resource to be created.
        :param _builtins.bool static_vnet_propagate_static_routes_enabled: Whether the static routes should be propagated to the Virtual Hub. Defaults to `true`.
    ...
    def static_vnet_local_route_override_criteria(self) -> Optional[_builtins.str]:
        """
    ...
    def static_vnet_propagate_static_routes_enabled(self) -> Optional[_builtins.bool]:
        """
...
class VirtualHubConnectionRoutingPropagatedRouteTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 route_table_ids: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] labels: The list of labels to assign to this route table.
        :param Sequence[_builtins.str] route_table_ids: A list of Route Table IDs to associated with this Virtual Hub Connection.
        """
        if labels is not None:
            pulumi.set(__self__, "labels", labels)
        if route_table_ids is not None:
...
class VirtualHubConnectionRoutingStaticVnetRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] address_prefixes: A list of CIDR Ranges which should be used as Address Prefixes.
        :param _builtins.str name: The name which should be used for this Static Route.
        :param _builtins.str next_hop_ip_address: The IP Address which should be used for the Next Hop.
        """
...
class VirtualHubRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] address_prefixes: A list of Address Prefixes.
        :param _builtins.str next_hop_ip_address: The IP Address that Packets should be forwarded to as the Next Hop.
        """
        pulumi.set(__self__, "address_prefixes", address_prefixes)
        pulumi.set(__self__, "next_hop_ip_address", next_hop_ip_address)
...
class VirtualHubRouteTableRoute(dict):
    ...
    def __init__(__self__, *,
                 destinations: Sequence[_builtins.str],
                 destinations_type: _builtins.str,
                 name: _builtins.str,
                 next_hop: _builtins.str,
                 next_hop_type: Optional[_builtins.str] = None):
        """
        :param Sequence[_builtins.str] destinations: A list of destination addresses for this route.
        :param _builtins.str destinations_type: The type of destinations. Possible values are `CIDR`, `ResourceId` and `Service`.
        :param _builtins.str name: The name which should be used for this route.
        :param _builtins.str next_hop: The next hop's resource ID.
        :param _builtins.str next_hop_type: The type of next hop. Currently the only possible value is `ResourceId`. Defaults to `ResourceId`.
    ...
    def destinations_type(self) -> _builtins.str:
        """
...
class VirtualNetworkDdosProtectionPlan(dict):
    def __init__(__self__, *,
                 ...
                 id: _builtins.str):
        """
        :param _builtins.bool enable: Enable/disable DDoS Protection Plan on Virtual Network.
        :param _builtins.str id: The ID of DDoS Protection Plan.
        """
...
class VirtualNetworkEncryption(dict):
    def __init__(__self__, *,
                 enforcement: _builtins.str):
        """
        :param _builtins.str enforcement: Specifies if the encrypted Virtual Network allows VM that does not support encryption. Possible values are `DropUnencrypted` and `AllowUnencrypted`.
    ...
    @_builtins.property
    @pulumi.getter
    def enforcement(self) -> _builtins.str:
        """
...
class VirtualNetworkGatewayBgpSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int asn: The Autonomous System Number (ASN) to use as part of the BGP.
        :param _builtins.int peer_weight: The weight added to routes which have been learned through BGP peering. Valid values can be between `0` and `100`.
        :param Sequence['VirtualNetworkGatewayBgpSettingsPeeringAddressArgs'] peering_addresses: A list of `peering_addresses` blocks as defined below. Only one `peering_addresses` block can be specified except when `active_active` of this Virtual Network Gateway is `true`.
        """
        if asn is not None:
            pulumi.set(__self__, "asn", asn)
        if peer_weight is not None:
...
class VirtualNetworkGatewayBgpSettingsPeeringAddress(dict):
    ...
    def __init__(__self__, *,
                 apipa_addresses: Optional[Sequence[_builtins.str]] = None,
                 default_addresses: Optional[Sequence[_builtins.str]] = None,
                 ip_configuration_name: Optional[_builtins.str] = None,
                 tunnel_ip_addresses: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] apipa_addresses: A list of Azure custom APIPA addresses assigned to the BGP peer of the Virtual Network Gateway.
               
               > **Note:** The valid range for the reserved APIPA address in Azure Public is from `169.254.21.0` to `169.254.22.255`.
        :param Sequence[_builtins.str] default_addresses: A list of peering address assigned to the BGP peer of the Virtual Network Gateway.
        :param _builtins.str ip_configuration_name: The name of the IP configuration of this Virtual Network Gateway. In case there are multiple `ip_configuration` blocks defined, this property is **required** to specify.
        :param Sequence[_builtins.str] tunnel_ip_addresses: A list of tunnel IP addresses assigned to the BGP peer of the Virtual Network Gateway.
        """
    ...
    def apipa_addresses(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def default_addresses(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def ip_configuration_name(self) -> Optional[_builtins.str]:
        """
    ...
    def tunnel_ip_addresses(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class VirtualNetworkGatewayConnectionCustomBgpAddresses(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str primary: single IP address that is part of the `network.VirtualNetworkGateway` ip_configuration (first one)
        :param _builtins.str secondary: single IP address that is part of the `network.VirtualNetworkGateway` ip_configuration (second one)
        """
        pulumi.set(__self__, "primary", primary)
...
class VirtualNetworkGatewayConnectionIpsecPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sa_datasize: Optional[_builtins.int] = None,
                 sa_lifetime: Optional[_builtins.int] = None):
        """
        :param _builtins.str dh_group: The DH group used in IKE phase 1 for initial SA. Valid options are `DHGroup1`, `DHGroup14`, `DHGroup2`, `DHGroup2048`, `DHGroup24`, `ECP256`, `ECP384`, or `None`.
        :param _builtins.str ike_encryption: The IKE encryption algorithm. Valid options are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, or `GCMAES256`.
        :param _builtins.str ike_integrity: The IKE integrity algorithm. Valid options are `GCMAES128`, `GCMAES256`, `MD5`, `SHA1`, `SHA256`, or `SHA384`.
        :param _builtins.str ipsec_encryption: The IPSec encryption algorithm. Valid options are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256`, or `None`.
        :param _builtins.str ipsec_integrity: The IPSec integrity algorithm. Valid options are `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1`, or `SHA256`.
        :param _builtins.str pfs_group: The DH group used in IKE phase 2 for new child SA.
               Valid options are `ECP256`, `ECP384`, `PFS1`, `PFS14`, `PFS2`, `PFS2048`, `PFS24`, `PFSMM`,
               or `None`.
        :param _builtins.int sa_datasize: The IPSec SA payload size in KB. Must be at least `1024` KB. Defaults to `102400000` KB.
        :param _builtins.int sa_lifetime: The IPSec SA lifetime in seconds. Must be at least `300` seconds. Defaults to `27000` seconds.
        """
    ...
    def sa_datasize(self) -> Optional[_builtins.int]:
        """
    ...
    def sa_lifetime(self) -> Optional[_builtins.int]:
        """
...
class VirtualNetworkGatewayConnectionTrafficSelectorPolicy(dict):
    ...
    def __init__(__self__, *,
                 local_address_cidrs: Sequence[_builtins.str],
                 remote_address_cidrs: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] local_address_cidrs: List of local CIDRs.
        :param Sequence[_builtins.str] remote_address_cidrs: List of remote CIDRs.
        """
    ...
    def local_address_cidrs(self) -> Sequence[_builtins.str]:
        """
        List of local CIDRs.
        """
    ...
    def remote_address_cidrs(self) -> Sequence[_builtins.str]:
        """
...
class VirtualNetworkGatewayIpConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 public_ip_address_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str subnet_id: The ID of the gateway subnet of a virtual network in which the virtual network gateway will be created. It is mandatory that the associated subnet is named `GatewaySubnet`. Therefore, each virtual network can contain at most a single Virtual Network Gateway.
        :param _builtins.str name: A user-defined name of the IP configuration. Defaults to `vnetGatewayConfig`.
        :param _builtins.str private_ip_address_allocation: Defines how the private IP address of the gateways virtual interface is assigned. The only valid value is `Dynamic` for Virtual Network Gateway (`Static` is not supported by the service yet). Defaults to `Dynamic`.
        :param _builtins.str public_ip_address_id: The ID of the public IP address to associate with the Virtual Network Gateway.
...
class VirtualNetworkGatewayNatRuleExternalMapping(dict):
    ...
    def __init__(__self__, *,
                 address_space: _builtins.str,
                 port_range: Optional[_builtins.str] = None):
        """
        :param _builtins.str address_space: The string CIDR representing the address space for the Virtual Network Gateway Nat Rule external mapping.
        :param _builtins.str port_range: The single port range for the Virtual Network Gateway Nat Rule external mapping.
        """
    ...
    def address_space(self) -> _builtins.str:
        """
...
class VirtualNetworkGatewayNatRuleInternalMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port_range: Optional[_builtins.str] = None):
        """
        :param _builtins.str address_space: The string CIDR representing the address space for the Virtual Network Gateway Nat Rule internal mapping.
        :param _builtins.str port_range: The single port range for the Virtual Network Gateway Nat Rule internal mapping.
        """
        pulumi.set(__self__, "address_space", address_space)
        if port_range is not None:
            pulumi.set(__self__, "port_range", port_range)
...
@pulumi.output_type
class VirtualNetworkGatewayPolicyGroup(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "policyMembers":
            suggest = "policy_members"
        elif key == "isDefault":
            suggest = "is_default"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualNetworkGatewayPolicyGroup. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualNetworkGatewayPolicyGroup.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 policy_members: Sequence['outputs.VirtualNetworkGatewayPolicyGroupPolicyMember'],
                 is_default: Optional[_builtins.bool] = None,
                 priority: Optional[_builtins.int] = None):
        """
        :param _builtins.str name: The name of the Virtual Network Gateway Policy Group.
        :param Sequence['VirtualNetworkGatewayPolicyGroupPolicyMemberArgs'] policy_members: One or more `policy_member` blocks as defined below.
        :param _builtins.bool is_default: Is this a Default Virtual Network Gateway Policy Group? Defaults to `false`.
        :param _builtins.int priority: The priority for the Virtual Network Gateway Policy Group. Defaults to `0`.
        """
        pulumi.set(__self__, "name", name)
    ...
    def policy_members(self) -> Sequence['outputs.VirtualNetworkGatewayPolicyGroupPolicyMember']:
        """
...
@pulumi.output_type
class VirtualNetworkGatewayPolicyGroupPolicyMember(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 type: _builtins.str,
                 value: _builtins.str):
        """
        :param _builtins.str name: The name of the Virtual Network Gateway Policy Group Member.
        :param _builtins.str type: The VPN Policy Member attribute type. Possible values are `AADGroupId`, `CertificateGroupId` and `RadiusAzureGroupId`.
        :param _builtins.str value: The value of attribute that is used for this Virtual Network Gateway Policy Group Member.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class VirtualNetworkGatewayVpnClientConfiguration(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "addressSpaces":
            ...
            suggest = "aad_tenant"
        elif key == "ipsecPolicy":
            suggest = "ipsec_policy"
        ...
        elif key == "virtualNetworkGatewayClientConnections":
            suggest = "virtual_network_gateway_client_connections"
    ...
    def __init__(__self__, *,
                 address_spaces: Sequence[_builtins.str],
                 aad_audience: Optional[_builtins.str] = None,
                 aad_issuer: Optional[_builtins.str] = None,
                 aad_tenant: Optional[_builtins.str] = None,
                 ipsec_policy: Optional['outputs.VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy'] = None,
                 radius_server_address: Optional[_builtins.str] = None,
                 radius_server_secret: Optional[_builtins.str] = None,
                 radius_servers: Optional[Sequence['outputs.VirtualNetworkGatewayVpnClientConfigurationRadiusServer']] = None,
                 ...
                 virtual_network_gateway_client_connections: Optional[Sequence['outputs.VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection']] = None,
                 vpn_auth_types: Optional[Sequence[_builtins.str]] = None,
                 vpn_client_protocols: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] address_spaces: The address space out of which IP addresses for vpn clients will be taken. You can provide more than one address space, e.g. in CIDR notation.
        :param _builtins.str aad_audience: The client id of the Azure VPN application.
               See [Create an Active Directory (AD) tenant for P2S OpenVPN protocol connections](https://docs.microsoft.com/en-gb/azure/vpn-gateway/openvpn-azure-ad-tenant-multi-app) for values
        :param _builtins.str aad_issuer: The STS url for your tenant
        :param _builtins.str aad_tenant: AzureAD Tenant URL
        :param 'VirtualNetworkGatewayVpnClientConfigurationIpsecPolicyArgs' ipsec_policy: An `ipsec_policy` block as defined below.
        :param _builtins.str radius_server_address: The address of the Radius server.
        :param _builtins.str radius_server_secret: The secret used by the Radius server.
        :param Sequence['VirtualNetworkGatewayVpnClientConfigurationRadiusServerArgs'] radius_servers: One or more `radius_server` blocks as defined below.
        ...
        :param Sequence['VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnectionArgs'] virtual_network_gateway_client_connections: One or more `virtual_network_gateway_client_connection` blocks as defined below.
        :param Sequence[_builtins.str] vpn_auth_types: List of the vpn authentication types for the virtual network gateway.
               The supported values are `AAD`, `Radius` and `Certificate`.
               
               > **Note:** `vpn_auth_types` must be set when using multiple vpn authentication types.
        :param Sequence[_builtins.str] vpn_client_protocols: List of the protocols supported by the vpn client.
    ...
    def ipsec_policy(self) -> Optional['outputs.VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy']:
        """
    ...
    def radius_servers(self) -> Optional[Sequence['outputs.VirtualNetworkGatewayVpnClientConfigurationRadiusServer']]:
        """
    ...
    def virtual_network_gateway_client_connections(self) -> Optional[Sequence['outputs.VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection']]:
        """
    ...
    def vpn_auth_types(self) -> Optional[Sequence[_builtins.str]]:
        """
...
@pulumi.output_type
class VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "dhGroup":
            ...
            suggest = "pfs_group"
        elif key == "saDataSizeInKilobytes":
            suggest = "sa_data_size_in_kilobytes"
        elif key == "saLifetimeInSeconds":
            suggest = "sa_lifetime_in_seconds"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualNetworkGatewayVpnClientConfigurationIpsecPolicy.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 ipsec_integrity: _builtins.str,
                 pfs_group: _builtins.str,
                 sa_data_size_in_kilobytes: _builtins.int,
                 sa_lifetime_in_seconds: _builtins.int):
        """
        :param _builtins.str dh_group: The DH Group, used in IKE Phase 1. Possible values are `DHGroup1`, `DHGroup2`, `DHGroup14`, `DHGroup24`, `DHGroup2048`, `ECP256`, `ECP384` and `None`.
        :param _builtins.str ike_encryption: The IKE encryption algorithm, used for IKE Phase 2. Possible values are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128` and `GCMAES256`.
        :param _builtins.str ike_integrity: The IKE encryption integrity algorithm, used for IKE Phase 2. Possible values are `GCMAES128`, `GCMAES256`, `MD5`, `SHA1`, `SHA256` and `SHA384`.
        :param _builtins.str ipsec_encryption: The IPSec encryption algorithm, used for IKE phase 1. Possible values are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256` and `None`.
        :param _builtins.str ipsec_integrity: The IPSec integrity algorithm, used for IKE phase 1. Possible values are `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1` and `SHA256`.
        :param _builtins.str pfs_group: The Pfs Group, used in IKE Phase 2. Possible values are `ECP256`, `ECP384`, `PFS1`, `PFS2`, `PFS14`, `PFS24`, `PFS2048`, `PFSMM` and `None`.
        :param _builtins.int sa_data_size_in_kilobytes: The IPSec Security Association payload size in KB for a Site-to-Site VPN tunnel. Possible values are between `1024` and `2147483647`.
        :param _builtins.int sa_lifetime_in_seconds: The IPSec Security Association lifetime in seconds for a Site-to-Site VPN tunnel. Possible values are between `300` and `172799`.
        """
        pulumi.set(__self__, "dh_group", dh_group)
        pulumi.set(__self__, "ike_encryption", ike_encryption)
        pulumi.set(__self__, "ike_integrity", ike_integrity)
    ...
    def sa_data_size_in_kilobytes(self) -> _builtins.int:
        """
    ...
    def sa_lifetime_in_seconds(self) -> _builtins.int:
        """
...
@pulumi.output_type
class VirtualNetworkGatewayVpnClientConfigurationRadiusServer(dict):
    def __init__(__self__, *,
                 address: _builtins.str,
                 score: _builtins.int,
                 secret: _builtins.str):
        """
        :param _builtins.str address: The address of the Radius Server.
        :param _builtins.int score: The score of the Radius Server determines the priority of the server. Possible values are between `1` and `30`.
        :param _builtins.str secret: The secret that is used to communicate with the Radius Server.
        """
        pulumi.set(__self__, "address", address)
...
class VirtualNetworkGatewayVpnClientConfigurationRevokedCertificate(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Specifies the name of the certificate resource.
        :param _builtins.str thumbprint: Specifies the public data of the certificate.
        """
        pulumi.set(__self__, "name", name)
...
class VirtualNetworkGatewayVpnClientConfigurationRootCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: A user-defined name of the root certificate.
        :param _builtins.str public_cert_data: The public certificate of the root certificate authority. The certificate must be provided in Base-64 encoded X.509 format (PEM). In particular, this argument *must not* include the `-----BEGIN CERTIFICATE-----` or `-----END CERTIFICATE-----` markers, nor any newlines.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "public_cert_data", public_cert_data)
...
@pulumi.output_type
class VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "addressPrefixes":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualNetworkGatewayVpnClientConfigurationVirtualNetworkGatewayClientConnection.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] address_prefixes: A list of address prefixes for P2S VPN Client.
        :param _builtins.str name: The name of the Virtual Network Gateway Client Connection.
        :param Sequence[_builtins.str] policy_group_names: A list of names of Virtual Network Gateway Policy Groups.
        """
        pulumi.set(__self__, "address_prefixes", address_prefixes)
        pulumi.set(__self__, "name", name)
...
@pulumi.output_type
class VirtualNetworkIpAddressPool(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "numberOfIpAddresses":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualNetworkIpAddressPool. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualNetworkIpAddressPool.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: The ID of the Network Manager IP Address Management (IPAM) Pool.
        :param _builtins.str number_of_ip_addresses: The number of IP addresses to allocated to the Virtual Network. The value must be a string that represents a positive number, e.g., `"100"`.
               
               > **Note:** `number_of_ip_addresses` cannot be decreased.
        :param Sequence[_builtins.str] allocated_ip_address_prefixes: The list of IP address prefixes allocated to the Virtual Network.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "number_of_ip_addresses", number_of_ip_addresses)
        if allocated_ip_address_prefixes is not None:
...
class VirtualNetworkSubnet(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "addressPrefixes":
            suggest = "address_prefixes"
        elif key == "defaultOutboundAccessEnabled":
            suggest = "default_outbound_access_enabled"
        elif key == "privateEndpointNetworkPolicies":
            suggest = "private_endpoint_network_policies"
        elif key == "privateLinkServiceNetworkPoliciesEnabled":
            suggest = "private_link_service_network_policies_enabled"
        elif key == "routeTableId":
            suggest = "route_table_id"
        elif key == "securityGroup":
            suggest = "security_group"
        elif key == "serviceEndpointPolicyIds":
            suggest = "service_endpoint_policy_ids"
    ...
    def __init__(__self__, *,
                 address_prefixes: Sequence[_builtins.str],
                 name: _builtins.str,
                 default_outbound_access_enabled: Optional[_builtins.bool] = None,
                 delegation: Optional['outputs.VirtualNetworkSubnetDelegation'] = None,
                 id: Optional[_builtins.str] = None,
                 private_endpoint_network_policies: Optional[_builtins.str] = None,
                 private_link_service_network_policies_enabled: Optional[_builtins.bool] = None,
                 route_table_id: Optional[_builtins.str] = None,
                 security_group: Optional[_builtins.str] = None,
                 service_endpoint_policy_ids: Optional[Sequence[_builtins.str]] = None,
                 service_endpoints: Optional[Sequence['outputs.VirtualNetworkSubnetServiceEndpoint']] = None):
        """
        :param Sequence[_builtins.str] address_prefixes: The address prefixes to use for the subnet.
        :param _builtins.str name: The name of the subnet.
        :param _builtins.bool default_outbound_access_enabled: Enable default outbound access to the internet for the subnet. Defaults to `true`.
        :param 'VirtualNetworkSubnetDelegationArgs' delegation: One or more `delegation` blocks as defined below.
        :param _builtins.str id: The ID of this subnet.
        :param _builtins.str private_endpoint_network_policies: Enable or Disable network policies for the private endpoint on the subnet. Possible values are `Disabled`, `Enabled`, `NetworkSecurityGroupEnabled` and `RouteTableEnabled`. Defaults to `Disabled`.
        ...
        :param _builtins.bool private_link_service_network_policies_enabled: Enable or Disable network policies for the private link service on the subnet. Defaults to `true`.
        ...
        :param _builtins.str route_table_id: The ID of the Route Table that should be associated with this subnet.
        ...
        :param _builtins.str security_group: The Network Security Group to associate with the subnet. (Referenced by `id`, ie. `azurerm_network_security_group.example.id`)
        :param Sequence[_builtins.str] service_endpoint_policy_ids: The list of IDs of Service Endpoint Policies to associate with the subnet.
        :param Sequence['VirtualNetworkSubnetServiceEndpointArgs'] service_endpoints: A `service_endpoint` block as defined below.
        """
        pulumi.set(__self__, "address_prefixes", address_prefixes)
        pulumi.set(__self__, "name", name)
    ...
    def default_outbound_access_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def delegation(self) -> Optional['outputs.VirtualNetworkSubnetDelegation']:
        """
    ...
    def private_link_service_network_policies_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def service_endpoint_policy_ids(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def service_endpoints(self) -> Optional[Sequence['outputs.VirtualNetworkSubnetServiceEndpoint']]:
        """
...
@pulumi.output_type
class VirtualNetworkSubnetDelegation(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "serviceDelegation":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualNetworkSubnetDelegation. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualNetworkSubnetDelegation.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 service_delegation: 'outputs.VirtualNetworkSubnetDelegationServiceDelegation'):
        """
        :param _builtins.str name: A name for this delegation.
        :param 'VirtualNetworkSubnetDelegationServiceDelegationArgs' service_delegation: A `service_delegation` block as defined below.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "service_delegation", service_delegation)
    ...
    @_builtins.property
    @pulumi.getter(name="serviceDelegation")
    def service_delegation(self) -> 'outputs.VirtualNetworkSubnetDelegationServiceDelegation':
        """
        A `service_delegation` block as defined below.
        """
        return pulumi.get(self, "service_delegation")
...
@pulumi.output_type
class VirtualNetworkSubnetDelegationServiceDelegation(dict):
    def __init__(__self__, *,
                 name: _builtins.str,
                 actions: Optional[Sequence[_builtins.str]] = None):
        """
...
@pulumi.output_type
class VirtualNetworkSubnetServiceEndpoint(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "networkIdentifier":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VirtualNetworkSubnetServiceEndpoint. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VirtualNetworkSubnetServiceEndpoint.__key_warning(key)
        return super().__getitem__(key)
...
class VnpGatewayNatRuleExternalMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port_range: Optional[_builtins.str] = None):
        """
        :param _builtins.str address_space: The string CIDR representing the address space for the VPN Gateway Nat Rule external mapping.
        :param _builtins.str port_range: The single port range for the VPN Gateway Nat Rule external mapping.
        """
        pulumi.set(__self__, "address_space", address_space)
        if port_range is not None:
            pulumi.set(__self__, "port_range", port_range)
...
class VnpGatewayNatRuleInternalMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port_range: Optional[_builtins.str] = None):
        """
        :param _builtins.str address_space: The string CIDR representing the address space for the VPN Gateway Nat Rule internal mapping.
        :param _builtins.str port_range: The single port range for the VPN Gateway Nat Rule internal mapping.
        """
        pulumi.set(__self__, "address_space", address_space)
        if port_range is not None:
            pulumi.set(__self__, "port_range", port_range)
...
class VpnGatewayBgpSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int asn: The ASN of the BGP Speaker. Changing this forces a new resource to be created.
        :param _builtins.int peer_weight: The weight added to Routes learned from this BGP Speaker. Changing this forces a new resource to be created.
        :param _builtins.str bgp_peering_address: The Address which should be used for the BGP Peering.
    ...
    @_builtins.property
    @pulumi.getter(name="peerWeight")
    def peer_weight(self) -> _builtins.int:
        """
...
class VpnGatewayBgpSettingsInstance0BgpPeeringAddress(dict):
    ...
    def __init__(__self__, *,
                 custom_ips: Sequence[_builtins.str],
                 default_ips: Optional[Sequence[_builtins.str]] = None,
                 ip_configuration_id: Optional[_builtins.str] = None,
                 tunnel_ips: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] custom_ips: A list of custom BGP peering addresses to assign to this instance.
        :param Sequence[_builtins.str] default_ips: The list of default BGP peering addresses which belong to the pre-defined VPN Gateway IP configuration.
        :param _builtins.str ip_configuration_id: The pre-defined id of VPN Gateway IP Configuration.
        :param Sequence[_builtins.str] tunnel_ips: The list of tunnel public IP addresses which belong to the pre-defined VPN Gateway IP configuration.
        """
    ...
    def custom_ips(self) -> Sequence[_builtins.str]:
        """
    ...
    def default_ips(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def tunnel_ips(self) -> Optional[Sequence[_builtins.str]]:
        """
...
class VpnGatewayConnectionRouting(dict):
    ...
    def __init__(__self__, *,
                 associated_route_table: _builtins.str,
                 inbound_route_map_id: Optional[_builtins.str] = None,
                 outbound_route_map_id: Optional[_builtins.str] = None,
                 propagated_route_table: Optional['outputs.VpnGatewayConnectionRoutingPropagatedRouteTable'] = None):
        """
        :param _builtins.str associated_route_table: The ID of the Route Table associated with this VPN Connection.
        :param _builtins.str inbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param _builtins.str outbound_route_map_id: The resource ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
    ...
    def associated_route_table(self) -> _builtins.str:
        """
...
class VpnGatewayConnectionRoutingPropagatedRouteTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 labels: Optional[Sequence[_builtins.str]] = None):
        """
        :param Sequence[_builtins.str] route_table_ids: A list of Route Table IDs to associated with this VPN Gateway Connection.
        :param Sequence[_builtins.str] labels: A list of labels to assign to this route table.
        """
        pulumi.set(__self__, "route_table_ids", route_table_ids)
        if labels is not None:
            pulumi.set(__self__, "labels", labels)
...
class VpnGatewayConnectionTrafficSelectorPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] local_address_ranges: A list of local address spaces in CIDR format for this VPN Gateway Connection.
        :param Sequence[_builtins.str] remote_address_ranges: A list of remote address spaces in CIDR format for this VPN Gateway Connection.
        """
...
class VpnGatewayConnectionVpnLink(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 vpn_site_link_id: _builtins.str,
                 bandwidth_mbps: Optional[_builtins.int] = None,
                 bgp_enabled: Optional[_builtins.bool] = None,
                 ...
                 egress_nat_rule_ids: Optional[Sequence[_builtins.str]] = None,
                 ingress_nat_rule_ids: Optional[Sequence[_builtins.str]] = None,
                 ipsec_policies: Optional[Sequence['outputs.VpnGatewayConnectionVpnLinkIpsecPolicy']] = None,
                 local_azure_ip_address_enabled: Optional[_builtins.bool] = None,
                 policy_based_traffic_selector_enabled: Optional[_builtins.bool] = None,
                 protocol: Optional[_builtins.str] = None,
                 ratelimit_enabled: Optional[_builtins.bool] = None,
                 route_weight: Optional[_builtins.int] = None,
                 shared_key: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name which should be used for this VPN Link Connection.
        :param _builtins.str vpn_site_link_id: The ID of the connected VPN Site Link. Changing this forces a new VPN Gateway Connection to be created.
        :param _builtins.int bandwidth_mbps: The expected connection bandwidth in MBPS. Defaults to `10`.
        :param _builtins.bool bgp_enabled: Should the BGP be enabled? Defaults to `false`. Changing this forces a new VPN Gateway Connection to be created.
        :param _builtins.str connection_mode: The connection mode of this VPN Link. Possible values are `Default`, `InitiatorOnly` and `ResponderOnly`. Defaults to `Default`.
        ...
        :param _builtins.int dpd_timeout_seconds: The dead peer detection timeout of this connection in seconds. Possible values are between `9` and `3600`.
        :param Sequence[_builtins.str] egress_nat_rule_ids: A list of the egress NAT Rule Ids.
        :param Sequence[_builtins.str] ingress_nat_rule_ids: A list of the ingress NAT Rule Ids.
        ...
        :param _builtins.bool local_azure_ip_address_enabled: Whether to use local Azure IP to initiate connection? Defaults to `false`.
        :param _builtins.bool policy_based_traffic_selector_enabled: Whether to enable policy-based traffic selectors? Defaults to `false`.
        :param _builtins.str protocol: The protocol used for this VPN Link Connection. Possible values are `IKEv1` and `IKEv2`. Defaults to `IKEv2`.
        :param _builtins.bool ratelimit_enabled: Should the rate limit be enabled? Defaults to `false`.
        :param _builtins.int route_weight: Routing weight for this VPN Link Connection. Defaults to `0`.
        :param _builtins.str shared_key: SharedKey for this VPN Link Connection.
        """
        pulumi.set(__self__, "name", name)
    ...
    def vpn_site_link_id(self) -> _builtins.str:
        """
    ...
    def bgp_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def egress_nat_rule_ids(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def ingress_nat_rule_ids(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def local_azure_ip_address_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def policy_based_traffic_selector_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def ratelimit_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def route_weight(self) -> Optional[_builtins.int]:
        """
...
class VpnGatewayConnectionVpnLinkCustomBgpAddress(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str ip_address: The custom bgp ip address which belongs to the IP Configuration.
        :param _builtins.str ip_configuration_id: The ID of the IP Configuration which belongs to the VPN Gateway.
        """
...
class VpnGatewayConnectionVpnLinkIpsecPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ike_encryption_algorithm: _builtins.str,
                 ike_integrity_algorithm: _builtins.str,
                 integrity_algorithm: _builtins.str,
                 pfs_group: _builtins.str,
                 sa_data_size_kb: _builtins.int,
                 sa_lifetime_sec: _builtins.int):
        """
        :param _builtins.str dh_group: The DH Group used in IKE Phase 1 for initial SA. Possible values are `None`, `DHGroup1`, `DHGroup2`, `DHGroup14`, `DHGroup24`, `DHGroup2048`, `ECP256`, `ECP384`.
        :param _builtins.str encryption_algorithm: The IPSec encryption algorithm (IKE phase 1). Possible values are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256`, `None`.
        :param _builtins.str ike_encryption_algorithm: The IKE encryption algorithm (IKE phase 2). Possible values are `DES`, `DES3`, `AES128`, `AES192`, `AES256`, `GCMAES128`, `GCMAES256`.
        :param _builtins.str ike_integrity_algorithm: The IKE integrity algorithm (IKE phase 2). Possible values are `MD5`, `SHA1`, `SHA256`, `SHA384`, `GCMAES128`, `GCMAES256`.
        :param _builtins.str integrity_algorithm: The IPSec integrity algorithm (IKE phase 1). Possible values are `MD5`, `SHA1`, `SHA256`, `GCMAES128`, `GCMAES192`, `GCMAES256`.
        :param _builtins.str pfs_group: The Pfs Group used in IKE Phase 2 for the new child SA. Possible values are `None`, `PFS1`, `PFS2`, `PFS14`, `PFS24`, `PFS2048`, `PFSMM`, `ECP256`, `ECP384`.
        :param _builtins.int sa_data_size_kb: The IPSec Security Association (also called Quick Mode or Phase 2 SA) payload size in KB for the site to site VPN tunnel.
        :param _builtins.int sa_lifetime_sec: The IPSec Security Association (also called Quick Mode or Phase 2 SA) lifetime in seconds for the site to site VPN tunnel.
        """
        pulumi.set(__self__, "dh_group", dh_group)
    ...
    def ike_encryption_algorithm(self) -> _builtins.str:
        """
    ...
    def ike_integrity_algorithm(self) -> _builtins.str:
        """
    ...
    def sa_data_size_kb(self) -> _builtins.int:
        """
    ...
    def sa_lifetime_sec(self) -> _builtins.int:
        """
...
@pulumi.output_type
class VpnGatewayIpConfiguration(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "privateIpAddress":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in VpnGatewayIpConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        VpnGatewayIpConfiguration.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: The identifier of the IP configuration for the VPN Gateway.
...
class VpnServerConfigurationAzureActiveDirectoryAuthentication(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str audience: The Audience which should be used for authentication.
        :param _builtins.str issuer: The Issuer which should be used for authentication.
        :param _builtins.str tenant: The Tenant which should be used for authentication.
        """
...
class VpnServerConfigurationClientRevokedCertificate(dict):
    def __init__(__self__, *,
                 ...
                 thumbprint: _builtins.str):
        """
        :param _builtins.str name: A name used to uniquely identify this certificate.
...
class VpnServerConfigurationClientRootCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: A name used to uniquely identify this certificate.
        :param _builtins.str public_cert_data: The Public Key Data associated with the Certificate.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "public_cert_data", public_cert_data)
...
class VpnServerConfigurationIpsecPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sa_lifetime_seconds: _builtins.int):
        """
        :param _builtins.str dh_group: The DH Group, used in IKE Phase 1. Possible values include `DHGroup1`, `DHGroup2`, `DHGroup14`, `DHGroup24`, `DHGroup2048`, `ECP256`, `ECP384` and `None`.
        :param _builtins.str ike_encryption: The IKE encryption algorithm, used for IKE Phase 2. Possible values include `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128` and `GCMAES256`.
        :param _builtins.str ike_integrity: The IKE encryption integrity algorithm, used for IKE Phase 2. Possible values include `GCMAES128`, `GCMAES256`, `MD5`, `SHA1`, `SHA256` and `SHA384`.
        :param _builtins.str ipsec_encryption: The IPSec encryption algorithm, used for IKE phase 1. Possible values include `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256` and `None`.
        :param _builtins.str ipsec_integrity: The IPSec integrity algorithm, used for IKE phase 1. Possible values include `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1` and `SHA256`.
        :param _builtins.str pfs_group: The Pfs Group, used in IKE Phase 2. Possible values include `ECP256`, `ECP384`, `PFS1`, `PFS2`, `PFS14`, `PFS24`, `PFS2048`, `PFSMM` and `None`.
        :param _builtins.int sa_data_size_kilobytes: The IPSec Security Association payload size in KB for a Site-to-Site VPN tunnel.
        :param _builtins.int sa_lifetime_seconds: The IPSec Security Association lifetime in seconds for a Site-to-Site VPN tunnel.
        """
        pulumi.set(__self__, "dh_group", dh_group)
        pulumi.set(__self__, "ike_encryption", ike_encryption)
        pulumi.set(__self__, "ike_integrity", ike_integrity)
    ...
    def sa_lifetime_seconds(self) -> _builtins.int:
        """
...
class VpnServerConfigurationPolicyGroupPolicy(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str name: The name of the VPN Server Configuration Policy member.
        :param _builtins.str type: The attribute type of the VPN Server Configuration Policy member. Possible values are `AADGroupId`, `CertificateGroupId` and `RadiusAzureGroupId`.
        :param _builtins.str value: The value of the attribute that is used for the VPN Server Configuration Policy member.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class VpnServerConfigurationRadiusServer(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: The Address of the Radius Server.
        :param _builtins.int score: The Score of the Radius Server determines the priority of the server. Ranges from 1 to 30.
        :param _builtins.str secret: The Secret used to communicate with the Radius Server.
        """
        pulumi.set(__self__, "address", address)
        pulumi.set(__self__, "score", score)
        pulumi.set(__self__, "secret", secret)
...
class VpnSiteLink(dict):
    ...
    def __init__(__self__, *,
                 ...
                 speed_in_mbps: Optional[_builtins.int] = None):
        """
        :param _builtins.str name: The name which should be used for this VPN Site Link.
        ...
        :param _builtins.str fqdn: The FQDN of this VPN Site Link.
        :param _builtins.str id: The ID of the VPN Site Link.
        :param _builtins.str ip_address: The IP address of this VPN Site Link.
               
               > **Note:** Either `fqdn` or `ip_address` should be specified.
        :param _builtins.str provider_name: The name of the physical link at the VPN Site. Example: `ATT`, `Verizon`.
        :param _builtins.int speed_in_mbps: The speed of the VPN device at the branch location in unit of mbps. Defaults to `0`.
        """
        pulumi.set(__self__, "name", name)
        if bgp is not None:
    ...
    def speed_in_mbps(self) -> Optional[_builtins.int]:
        """
...
class VpnSiteLinkBgp(dict):
    ...
    def __init__(__self__, *,
                 asn: _builtins.int,
                 peering_address: _builtins.str):
        """
        :param _builtins.int asn: The BGP speaker's ASN.
        :param _builtins.str peering_address: The BGP peering IP address.
        """
        pulumi.set(__self__, "asn", asn)
    ...
    def peering_address(self) -> _builtins.str:
        """
...
class VpnSiteO365PolicyTrafficCategory(dict):
    ...
    def __init__(__self__, *,
                 allow_endpoint_enabled: Optional[_builtins.bool] = None,
                 default_endpoint_enabled: Optional[_builtins.bool] = None,
                 optimize_endpoint_enabled: Optional[_builtins.bool] = None):
        """
        :param _builtins.bool allow_endpoint_enabled: Is allow endpoint enabled? The `Allow` endpoint is required for connectivity to specific O365 services and features, but are not as sensitive to network performance and latency as other endpoint types. Defaults to `false`.
        :param _builtins.bool default_endpoint_enabled: Is default endpoint enabled? The `Default` endpoint represents O365 services and dependencies that do not require any optimization, and can be treated by customer networks as normal Internet bound traffic. Defaults to `false`.
        :param _builtins.bool optimize_endpoint_enabled: Is optimize endpoint enabled? The `Optimize` endpoint is required for connectivity to every O365 service and represents the O365 scenario that is the most sensitive to network performance, latency, and availability. Defaults to `false`.
        """
    ...
    def allow_endpoint_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def default_endpoint_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def optimize_endpoint_enabled(self) -> Optional[_builtins.bool]:
        """
...
class GetApplicationGatewayAutoscaleConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 min_capacity: _builtins.int):
        """
        :param _builtins.int max_capacity: Maximum capacity for autoscaling.
        :param _builtins.int min_capacity: Minimum capacity for autoscaling.
        """
        pulumi.set(__self__, "max_capacity", max_capacity)
        pulumi.set(__self__, "min_capacity", min_capacity)
...
@pulumi.output_type
class GetApplicationGatewayBackendResult(dict):
    def __init__(__self__, *,
                 client_ip_preservation_enabled: _builtins.bool,
                 host_name: _builtins.str,
                 id: _builtins.str,
                 name: _builtins.str,
                 port: _builtins.int,
                 probe_id: _builtins.str,
                 probe_name: _builtins.str,
                 protocol: _builtins.str,
                 timeout_in_seconds: _builtins.int,
                 trusted_root_certificate_names: Sequence[_builtins.str]):
        """
        :param _builtins.bool client_ip_preservation_enabled: Whether client IP preservation is enabled for the Backend Settings.
    ...
    @_builtins.property
    @pulumi.getter(name="clientIpPreservationEnabled")
    def client_ip_preservation_enabled(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="trustedRootCertificateNames")
    def trusted_root_certificate_names(self) -> Sequence[_builtins.str]:
        """
        A list of `trusted_root_certificate` names.
        """
        return pulumi.get(self, "trusted_root_certificate_names")
...
class GetApplicationGatewayBackendAddressPoolResult(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param Sequence[_builtins.str] fqdns: A list of FQDNs which are part of the Backend Address Pool.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param Sequence[_builtins.str] ip_addresses: A list of IP Addresses which are part of the Backend Address Pool.
        :param _builtins.str name: The name of this Application Gateway.
        """
        pulumi.set(__self__, "fqdns", fqdns)
        pulumi.set(__self__, "id", id)
...
class GetApplicationGatewayBackendHttpSettingResult(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str,
                 path: _builtins.str,
                 pick_host_name_from_backend_address: _builtins.bool,
                 port: _builtins.int,
                 probe_id: _builtins.str,
                 probe_name: _builtins.str,
                 protocol: _builtins.str,
    ...
    @_builtins.property
    @pulumi.getter(name="affinityCookieName")
    def affinity_cookie_name(self) -> _builtins.str:
        """
        The name of the affinity cookie.
        """
        return pulumi.get(self, "affinity_cookie_name")
...
class GetApplicationGatewayBackendHttpSettingConnectionDrainingResult(dict):
    def __init__(__self__, *,
                 ...
                 enabled: _builtins.bool):
        """
        :param _builtins.int drain_timeout_sec: The number of seconds connection draining is active.
        :param _builtins.bool enabled: Is the Web Application Firewall enabled?
        """
        pulumi.set(__self__, "drain_timeout_sec", drain_timeout_sec)
        pulumi.set(__self__, "enabled", enabled)
...
class GetApplicationGatewayFrontendIpConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 private_ip_address_allocation: _builtins.str,
                 private_link_configuration_id: _builtins.str,
                 private_link_configuration_name: _builtins.str,
                 public_ip_address_id: _builtins.str,
                 subnet_id: _builtins.str):
        """
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.str private_ip_address: The Static IP Address which is used.
        :param _builtins.str private_ip_address_allocation: The allocation method used for the Private IP Address.
        :param _builtins.str private_link_configuration_id: The ID of the associated Private Link configuration.
        :param _builtins.str private_link_configuration_name: The name of the Private Link configuration in use by this Frontend IP Configuration.
        :param _builtins.str public_ip_address_id: The ID of the Public IP Address which the Application Gateway will use.
        :param _builtins.str subnet_id: The ID of the subnet the private link configuration is connected to.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "private_ip_address", private_ip_address)
    ...
    @_builtins.property
    @pulumi.getter(name="privateLinkConfigurationId")
    def private_link_configuration_id(self) -> _builtins.str:
        """
        The ID of the associated Private Link configuration.
        """
        return pulumi.get(self, "private_link_configuration_id")
    ...
    @_builtins.property
    @pulumi.getter(name="privateLinkConfigurationName")
    def private_link_configuration_name(self) -> _builtins.str:
        """
...
class GetApplicationGatewayHttpListenerResult(dict):
    def __init__(__self__, *,
                 ...
                 firewall_policy_id: _builtins.str,
                 frontend_ip_configuration_id: _builtins.str,
                 frontend_ip_configuration_name: _builtins.str,
                 frontend_port_id: _builtins.str,
                 frontend_port_name: _builtins.str,
                 host_name: _builtins.str,
                 ...
                 name: _builtins.str,
                 protocol: _builtins.str,
                 require_sni: _builtins.bool,
                 ssl_certificate_id: _builtins.str,
                 ssl_certificate_name: _builtins.str,
                 ssl_profile_id: _builtins.str,
                 ssl_profile_name: _builtins.str):
        """
        ...
        :param _builtins.str firewall_policy_id: The ID of the Web Application Firewall Policy which is used as an HTTP Listener for this Path Rule.
        :param _builtins.str frontend_ip_configuration_id: The ID of the associated Frontend Configuration.
        :param _builtins.str frontend_ip_configuration_name: The Name of the Frontend IP Configuration used for this Listener.
        :param _builtins.str frontend_port_id: The ID of the associated Frontend Port.
        :param _builtins.str frontend_port_name: The Name of the Frontend Port used for this Listener.
        :param _builtins.str host_name: The Hostname which is used for this HTTP Listener.
        :param Sequence[_builtins.str] host_names: A list of Hostname(s) used for this Listener.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.str protocol: The Protocol used for this Probe.
        :param _builtins.bool require_sni: Is Server Name Indication required?
        :param _builtins.str ssl_certificate_id: The ID of the associated SSL Certificate.
        :param _builtins.str ssl_certificate_name: The name of the associated SSL Certificate which is used for this Listener.
        :param _builtins.str ssl_profile_id: The ID of the associated SSL Profile.
        :param _builtins.str ssl_profile_name: The name of the associated SSL Profile which is used for this Listener.
        """
        pulumi.set(__self__, "custom_error_configurations", custom_error_configurations)
        pulumi.set(__self__, "firewall_policy_id", firewall_policy_id)
        pulumi.set(__self__, "frontend_ip_configuration_id", frontend_ip_configuration_id)
    ...
    @_builtins.property
    @pulumi.getter(name="frontendIpConfigurationId")
    def frontend_ip_configuration_id(self) -> _builtins.str:
        """
        The ID of the associated Frontend Configuration.
        """
        return pulumi.get(self, "frontend_ip_configuration_id")
    ...
    @_builtins.property
    @pulumi.getter(name="frontendPortId")
    def frontend_port_id(self) -> _builtins.str:
        """
        The ID of the associated Frontend Port.
        """
        return pulumi.get(self, "frontend_port_id")
    ...
    @_builtins.property
    @pulumi.getter(name="requireSni")
    def require_sni(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sslCertificateName")
    def ssl_certificate_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sslProfileId")
    def ssl_profile_id(self) -> _builtins.str:
        """
        The ID of the associated SSL Profile.
        """
        return pulumi.get(self, "ssl_profile_id")
    ...
    @_builtins.property
    @pulumi.getter(name="sslProfileName")
    def ssl_profile_name(self) -> _builtins.str:
        """
...
class GetApplicationGatewayIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param Sequence[_builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Application Gateway.
        :param _builtins.str type: The type of Managed Service Identity that is configured on this Application Gateway.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
@pulumi.output_type
class GetApplicationGatewayListenerResult(dict):
    def __init__(__self__, *,
                 frontend_ip_configuration_id: _builtins.str,
                 frontend_ip_configuration_name: _builtins.str,
                 frontend_port_id: _builtins.str,
...
class GetApplicationGatewayProbeResult(dict):
    def __init__(__self__, *,
                 ...
                 minimum_servers: _builtins.int,
                 name: _builtins.str,
                 path: _builtins.str,
                 pick_host_name_from_backend_http_settings: _builtins.bool,
                 port: _builtins.int,
                 protocol: _builtins.str,
                 proxy_protocol_header_enabled: _builtins.bool,
                 timeout: _builtins.int,
                 unhealthy_threshold: _builtins.int):
        """
        :param _builtins.str host: The Hostname used for this Probe.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.int interval: The Interval between two consecutive probes in seconds.
        :param Sequence['GetApplicationGatewayProbeMatchArgs'] matches: A `match` block as defined above.
        :param _builtins.int minimum_servers: The minimum number of servers that are always marked as healthy.
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.str path: The URL path to rewrite.
        :param _builtins.bool pick_host_name_from_backend_http_settings: Whether the host header is picked from the backend HTTP settings.
        :param _builtins.int port: Custom port which is used for probing the backend servers.
        :param _builtins.str protocol: The Protocol used for this Probe.
        :param _builtins.bool proxy_protocol_header_enabled: Whether the proxy protocol header is enabled for this Probe.
        :param _builtins.int timeout: The Timeout used for this Probe, indicating when a probe becomes unhealthy.
        :param _builtins.int unhealthy_threshold: The Unhealthy Threshold for this Probe, which indicates the amount of retries which will be attempted before a node is deemed unhealthy.
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "interval", interval)
    ...
    @_builtins.property
    @pulumi.getter(name="minimumServers")
    def minimum_servers(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="pickHostNameFromBackendHttpSettings")
    def pick_host_name_from_backend_http_settings(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="proxyProtocolHeaderEnabled")
    def proxy_protocol_header_enabled(self) -> _builtins.bool:
        """
...
class GetApplicationGatewayProbeMatchResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str body: A snippet from the Response Body which must be present in the Response.
        :param Sequence[_builtins.str] status_codes: Status code of the application gateway custom error.
        """
        pulumi.set(__self__, "body", body)
        pulumi.set(__self__, "status_codes", status_codes)
...
class GetApplicationGatewayRedirectConfigurationResult(dict):
    def __init__(__self__, *,
                 id: _builtins.str,
                 include_path: _builtins.bool,
                 include_query_string: _builtins.bool,
                 name: _builtins.str,
                 redirect_type: _builtins.str,
                 target_listener_id: _builtins.str,
                 target_listener_name: _builtins.str,
                 target_url: _builtins.str):
        """
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.bool include_path: Whether the path is included in the redirected URL.
        :param _builtins.bool include_query_string: Whether to include the query string in the redirected URL.
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.str redirect_type: The type of redirect.
        :param _builtins.str target_listener_name: The name of the listener to redirect to.
        :param _builtins.str target_url: The URL to redirect the request to.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "include_path", include_path)
        pulumi.set(__self__, "include_query_string", include_query_string)
    ...
    @_builtins.property
    @pulumi.getter(name="includePath")
    def include_path(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="targetListenerName")
    def target_listener_name(self) -> _builtins.str:
        """
...
class GetApplicationGatewayRequestRoutingRuleResult(dict):
    def __init__(__self__, *,
                 backend_address_pool_id: _builtins.str,
                 backend_address_pool_name: _builtins.str,
                 backend_http_settings_id: _builtins.str,
                 backend_http_settings_name: _builtins.str,
                 http_listener_id: _builtins.str,
                 http_listener_name: _builtins.str,
                 id: _builtins.str,
                 name: _builtins.str,
                 priority: _builtins.int,
                 redirect_configuration_id: _builtins.str,
                 redirect_configuration_name: _builtins.str,
                 rewrite_rule_set_id: _builtins.str,
                 rewrite_rule_set_name: _builtins.str,
                 rule_type: _builtins.str,
                 url_path_map_id: _builtins.str,
                 url_path_map_name: _builtins.str):
        """
        :param _builtins.str backend_address_pool_id: The ID of the associated Backend Address Pool.
        :param _builtins.str backend_address_pool_name: The Name of the Backend Address Pool which is used for this Routing Rule.
        :param _builtins.str backend_http_settings_id: The ID of the associated Backend HTTP Settings Configuration.
        :param _builtins.str backend_http_settings_name: The Name of the Backend HTTP Settings Collection which is used for this Routing Rule.
        :param _builtins.str http_listener_id: The ID of the associated HTTP Listener.
        :param _builtins.str http_listener_name: The Name of the HTTP Listener which is used for this Routing Rule.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.int priority: The Priority of this Routing Rule.
        :param _builtins.str redirect_configuration_id: The ID of the associated Redirect Configuration.
        :param _builtins.str redirect_configuration_name: The Name of the Redirect Configuration which is used for this Routing Rule.
        :param _builtins.str rewrite_rule_set_id: The ID of the associated Rewrite Rule Set.
        :param _builtins.str rewrite_rule_set_name: The Name of the Rewrite Rule Set which is used for this Routing Rule.
        :param _builtins.str rule_type: The Type of Routing that is used for this Rule.
        :param _builtins.str url_path_map_id: The ID of the associated URL Path Map.
        :param _builtins.str url_path_map_name: The Name of the URL Path Map which is associated with this Routing Rule.
        """
        pulumi.set(__self__, "backend_address_pool_id", backend_address_pool_id)
        pulumi.set(__self__, "backend_address_pool_name", backend_address_pool_name)
        pulumi.set(__self__, "backend_http_settings_id", backend_http_settings_id)
    ...
    @_builtins.property
    @pulumi.getter(name="backendHttpSettingsId")
    def backend_http_settings_id(self) -> _builtins.str:
        """
        The ID of the associated Backend HTTP Settings Configuration.
        """
        return pulumi.get(self, "backend_http_settings_id")
    ...
    @_builtins.property
    @pulumi.getter(name="backendHttpSettingsName")
    def backend_http_settings_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="httpListenerId")
    def http_listener_id(self) -> _builtins.str:
        """
        The ID of the associated HTTP Listener.
        """
        return pulumi.get(self, "http_listener_id")
    ...
    @_builtins.property
    @pulumi.getter(name="redirectConfigurationId")
    def redirect_configuration_id(self) -> _builtins.str:
        """
        The ID of the associated Redirect Configuration.
        """
        return pulumi.get(self, "redirect_configuration_id")
    ...
    @_builtins.property
    @pulumi.getter(name="redirectConfigurationName")
    def redirect_configuration_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="rewriteRuleSetId")
    def rewrite_rule_set_id(self) -> _builtins.str:
        """
        The ID of the associated Rewrite Rule Set.
        """
        return pulumi.get(self, "rewrite_rule_set_id")
    ...
    @_builtins.property
    @pulumi.getter(name="rewriteRuleSetName")
    def rewrite_rule_set_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="urlPathMapId")
    def url_path_map_id(self) -> _builtins.str:
        """
        The ID of the associated URL Path Map.
        """
        return pulumi.get(self, "url_path_map_id")
    ...
    @_builtins.property
    @pulumi.getter(name="urlPathMapName")
    def url_path_map_name(self) -> _builtins.str:
        """
...
class GetApplicationGatewayRewriteRuleSetRewriteRuleConditionResult(dict):
    def __init__(__self__, *,
                 ...
                 variable: _builtins.str):
        """
        :param _builtins.bool ignore_case: Whether a case insensitive comparison is performed.
        :param _builtins.bool negate: Whether the result of the condition evaluation is negated.
        :param _builtins.str pattern: The pattern, either fixed string or regular expression, that evaluates the truthfulness of the condition.
        :param _builtins.str variable: The [variable](https://docs.microsoft.com/azure/application-gateway/rewrite-http-headers#server-variables) of the condition.
        """
        pulumi.set(__self__, "ignore_case", ignore_case)
...
class GetApplicationGatewayRewriteRuleSetRewriteRuleUrlResult(dict):
    def __init__(__self__, *,
                 ...
                 reroute: _builtins.bool):
        """
        :param _builtins.str components: The components used to rewrite the URL.
        :param _builtins.str path: The URL path to rewrite.
        :param _builtins.str query_string: The query string to rewrite.
        :param _builtins.bool reroute: Whether the URL path map is reevaluated after this rewrite has been applied.
        """
        pulumi.set(__self__, "components", components)
        pulumi.set(__self__, "path", path)
        pulumi.set(__self__, "query_string", query_string)
    ...
    @_builtins.property
    @pulumi.getter
    def reroute(self) -> _builtins.bool:
        """
...
@pulumi.output_type
class GetApplicationGatewayRoutingRuleResult(dict):
    def __init__(__self__, *,
                 backend_address_pool_id: _builtins.str,
                 backend_address_pool_name: _builtins.str,
        ...
        :param _builtins.str backend_address_pool_name: The Name of the Backend Address Pool which is used for this Routing Rule.
        :param _builtins.str backend_id: The ID of the associated Backend Settings.
        :param _builtins.str backend_name: The Name of the Backend Settings which is used for this Routing Rule.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str listener_id: The ID of the associated Listener.
        :param _builtins.str listener_name: The Name of the Listener which is used for this Routing Rule.
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.int priority: The Priority of this Routing Rule.
        """
        pulumi.set(__self__, "backend_address_pool_id", backend_address_pool_id)
...
class GetApplicationGatewaySkusResult(dict):
    def __init__(__self__, *,
                 ...
                 tier: _builtins.str):
        """
        :param _builtins.int capacity: The Capacity of the SKU in use for this Application Gateway.
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.str tier: The Tier of the SKU in use for this Application Gateway.
        """
        pulumi.set(__self__, "capacity", capacity)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "tier", tier)
...
class GetApplicationGatewaySslCertificateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str key_vault_secret_id: The Secret ID of (base-64 encoded unencrypted pfx) the `Secret` or `Certificate` object stored in Azure KeyVault.
        :param _builtins.str name: The name of this Application Gateway.
        :param _builtins.str public_cert_data: The Public Certificate Data associated with the SSL Certificate.
        """
        pulumi.set(__self__, "id", id)
...
class GetApplicationGatewaySslPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 disabled_protocols: Sequence[_builtins.str],
                 min_protocol_version: _builtins.str,
                 policy_name: _builtins.str,
                 policy_type: _builtins.str):
        """
        :param Sequence[_builtins.str] cipher_suites: A List of accepted cipher suites.
        :param Sequence[_builtins.str] disabled_protocols: A list of SSL Protocols which are disabled on this Application Gateway.
        :param _builtins.str min_protocol_version: The minimum TLS version.
        :param _builtins.str policy_name: The Name of the Policy.
        :param _builtins.str policy_type: The Type of the Policy.
        """
        pulumi.set(__self__, "cipher_suites", cipher_suites)
        pulumi.set(__self__, "disabled_protocols", disabled_protocols)
        pulumi.set(__self__, "min_protocol_version", min_protocol_version)
    ...
    @_builtins.property
    @pulumi.getter(name="disabledProtocols")
    def disabled_protocols(self) -> Sequence[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="minProtocolVersion")
    def min_protocol_version(self) -> _builtins.str:
        """
...
class GetApplicationGatewaySslProfileResult(dict):
    def __init__(__self__, *,
                 ...
                 trusted_client_certificate_names: Sequence[_builtins.str],
                 verify_client_certificate_issuer_dn: _builtins.bool,
                 verify_client_certificate_revocation: _builtins.str):
        """
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str name: The name of this Application Gateway.
        :param Sequence['GetApplicationGatewaySslProfileSslPolicyArgs'] ssl_policies: a `ssl_policy` block as defined below.
        :param Sequence[_builtins.str] trusted_client_certificate_names: The name of the Trusted Client Certificate that will be used to authenticate requests from clients.
        :param _builtins.bool verify_client_certificate_issuer_dn: Will the client certificate issuer DN be verified?
        :param _builtins.str verify_client_certificate_revocation: The method used to check client certificate revocation status.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
    ...
    @_builtins.property
    @pulumi.getter(name="trustedClientCertificateNames")
    def trusted_client_certificate_names(self) -> Sequence[_builtins.str]:
        """
        The name of the Trusted Client Certificate that will be used to authenticate requests from clients.
        """
        return pulumi.get(self, "trusted_client_certificate_names")
    ...
    @_builtins.property
    @pulumi.getter(name="verifyClientCertificateIssuerDn")
    def verify_client_certificate_issuer_dn(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="verifyClientCertificateRevocation")
    def verify_client_certificate_revocation(self) -> _builtins.str:
        """
...
class GetApplicationGatewayTrustedClientCertificateResult(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str data: The content of the Trusted Client Certificate in use.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str name: The name of this Application Gateway.
        """
        pulumi.set(__self__, "data", data)
...
class GetApplicationGatewayUrlPathMapResult(dict):
    def __init__(__self__, *,
                 default_backend_address_pool_id: _builtins.str,
                 default_backend_address_pool_name: _builtins.str,
                 default_backend_http_settings_id: _builtins.str,
                 default_backend_http_settings_name: _builtins.str,
                 default_redirect_configuration_id: _builtins.str,
                 default_redirect_configuration_name: _builtins.str,
                 default_rewrite_rule_set_id: _builtins.str,
                 default_rewrite_rule_set_name: _builtins.str,
                 id: _builtins.str,
                 name: _builtins.str,
                 path_rules: Sequence['outputs.GetApplicationGatewayUrlPathMapPathRuleResult']):
        """
        :param _builtins.str default_backend_address_pool_id: The ID of the Default Backend Address Pool.
        :param _builtins.str default_backend_address_pool_name: The Name of the Default Backend Address Pool which is used for this URL Path Map.
        :param _builtins.str default_backend_http_settings_id: The ID of the Default Backend HTTP Settings Collection.
        :param _builtins.str default_backend_http_settings_name: The Name of the Default Backend HTTP Settings Collection which is used for this URL Path Map.
        :param _builtins.str default_redirect_configuration_id: The ID of the Default Redirect Configuration.
        :param _builtins.str default_redirect_configuration_name: The Name of the Default Redirect Configuration which is used for this URL Path Map.
        :param _builtins.str default_rewrite_rule_set_name: The Name of the Default Rewrite Rule Set which is used for this URL Path Map.
        :param _builtins.str id: The ID of the Rewrite Rule Set
        :param _builtins.str name: The name of this Application Gateway.
    ...
    @_builtins.property
    @pulumi.getter(name="defaultBackendAddressPoolId")
    def default_backend_address_pool_id(self) -> _builtins.str:
        """
        The ID of the Default Backend Address Pool.
        """
        return pulumi.get(self, "default_backend_address_pool_id")
    ...
    @_builtins.property
    @pulumi.getter(name="defaultBackendAddressPoolName")
    def default_backend_address_pool_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultBackendHttpSettingsId")
    def default_backend_http_settings_id(self) -> _builtins.str:
        """
        The ID of the Default Backend HTTP Settings Collection.
        """
        return pulumi.get(self, "default_backend_http_settings_id")
    ...
    @_builtins.property
    @pulumi.getter(name="defaultBackendHttpSettingsName")
    def default_backend_http_settings_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultRedirectConfigurationId")
    def default_redirect_configuration_id(self) -> _builtins.str:
        """
        The ID of the Default Redirect Configuration.
        """
        return pulumi.get(self, "default_redirect_configuration_id")
    ...
    @_builtins.property
    @pulumi.getter(name="defaultRedirectConfigurationName")
    def default_redirect_configuration_name(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultRewriteRuleSetId")
    def default_rewrite_rule_set_id(self) -> _builtins.str:
        return pulumi.get(self, "default_rewrite_rule_set_id")

    @_builtins.property
    @pulumi.getter(name="defaultRewriteRuleSetName")
    def default_rewrite_rule_set_name(self) -> _builtins.str:
        """
...
class GetApplicationGatewayWafConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 file_upload_limit_mb: _builtins.int,
                 firewall_mode: _builtins.str,
                 max_request_body_size_kb: _builtins.int,
                 request_body_check: _builtins.bool,
        ...
        :param _builtins.int file_upload_limit_mb: The File Upload Limit in MB.
        :param _builtins.str firewall_mode: The Web Application Firewall Mode.
        :param _builtins.int max_request_body_size_kb: The Maximum Request Body Size in KB.
        :param _builtins.bool request_body_check: Is Request Body Inspection enabled?
        :param _builtins.str rule_set_type: The Type of the Rule Set used for this Web Application Firewall.
        :param _builtins.str rule_set_version: The Version of the Rule Set used for this Web Application Firewall.
        """
        pulumi.set(__self__, "disabled_rule_groups", disabled_rule_groups)
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "exclusions", exclusions)
    ...
    @_builtins.property
    @pulumi.getter(name="fileUploadLimitMb")
    def file_upload_limit_mb(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="maxRequestBodySizeKb")
    def max_request_body_size_kb(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requestBodyCheck")
    def request_body_check(self) -> _builtins.bool:
        """
...
class GetApplicationGatewayWafConfigurationDisabledRuleGroupResult(dict):
    def __init__(__self__, *,
                 rule_group_name: _builtins.str,
                 rules: Sequence[_builtins.int]):
        """
        :param _builtins.str rule_group_name: The rule group where specific rules are disabled.
        :param Sequence[_builtins.int] rules: A list of rules which will be disabled in that group.
        """
        pulumi.set(__self__, "rule_group_name", rule_group_name)
        pulumi.set(__self__, "rules", rules)
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> Sequence[_builtins.int]:
        """
...
class GetApplicationGatewayWafConfigurationExclusionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str match_variable: Match variable of the exclusion rule.
        :param _builtins.str selector: String value which will be used for the filter operation.
        :param _builtins.str selector_match_operator: Operator which will be used to search in the variable content.
        """
        pulumi.set(__self__, "match_variable", match_variable)
        pulumi.set(__self__, "selector", selector)
        pulumi.set(__self__, "selector_match_operator", selector_match_operator)
...
class GetExpressRouteCircuitPeeringResult(dict):
    def __init__(__self__, *,
                 azure_asn: _builtins.int,
                 peer_asn: _builtins.int,
                 peering_type: _builtins.str,
                 primary_peer_address_prefix: _builtins.str,
                 secondary_peer_address_prefix: _builtins.str,
                 shared_key: _builtins.str,
                 vlan_id: _builtins.int):
        """
        :param _builtins.int azure_asn: The Either a 16-bit or a 32-bit ASN for Azure.
        :param _builtins.int peer_asn: The Either a 16-bit or a 32-bit ASN. Can either be public or private.
        :param _builtins.str peering_type: The type of the ExpressRoute Circuit Peering. Acceptable values include `AzurePrivatePeering`, `AzurePublicPeering` and `MicrosoftPeering`. Changing this forces a new resource to be created.
        :param _builtins.str primary_peer_address_prefix: A `/30` subnet for the primary link.
        :param _builtins.str secondary_peer_address_prefix: A `/30` subnet for the secondary link.
        :param _builtins.str shared_key: The shared key. Can be a maximum of 25 characters.
        :param _builtins.int vlan_id: A valid VLAN ID to establish this peering on.
        """
...
class GetExpressRouteCircuitServiceProviderPropertyResult(dict):
    def __init__(__self__, *,
                 bandwidth_in_mbps: _builtins.int,
                 peering_location: _builtins.str,
                 service_provider_name: _builtins.str):
        """
        :param _builtins.int bandwidth_in_mbps: The bandwidth in Mbps of the ExpressRoute circuit.
        :param _builtins.str peering_location: The name of the peering location and **not** the Azure resource location.
        :param _builtins.str service_provider_name: The name of the ExpressRoute Service Provider.
        """
    ...
    def bandwidth_in_mbps(self) -> _builtins.int:
        """
...
class GetFirewallIpConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str private_ip_address: The private IP address associated with the Azure Firewall.
        :param _builtins.str public_ip_address_id: The ID of the Public IP address of the Azure Firewall.
        :param _builtins.str subnet_id: The ID of the Subnet where the Azure Firewall is deployed.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "private_ip_address", private_ip_address)
        pulumi.set(__self__, "public_ip_address_id", public_ip_address_id)
...
class GetFirewallPolicyDnResult(dict):
    def __init__(__self__, *,
                 network_rule_fqdn_enabled: _builtins.bool,
    ...
    def network_rule_fqdn_enabled(self) -> _builtins.bool:
...
class GetFirewallVirtualHubResult(dict):
    def __init__(__self__, *,
                 ...
                 public_ip_count: _builtins.int,
                 virtual_hub_id: _builtins.str):
        """
        :param _builtins.str private_ip_address: The private IP address associated with the Azure Firewall.
        :param Sequence[_builtins.str] public_ip_addresses: The list of public IP addresses associated with the Azure Firewall.
        :param _builtins.int public_ip_count: The number of public IPs assigned to the Azure Firewall.
        :param _builtins.str virtual_hub_id: The ID of the Virtual Hub where the Azure Firewall resides in.
        """
        pulumi.set(__self__, "private_ip_address", private_ip_address)
        pulumi.set(__self__, "public_ip_addresses", public_ip_addresses)
        pulumi.set(__self__, "public_ip_count", public_ip_count)
    ...
    @_builtins.property
    @pulumi.getter(name="publicIpCount")
    def public_ip_count(self) -> _builtins.int:
        """
...
class GetGatewayConnectionIpsecPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 ipsec_integrity: _builtins.str,
                 pfs_group: _builtins.str,
                 sa_datasize: _builtins.int,
                 sa_lifetime: _builtins.int):
        """
        :param _builtins.str dh_group: The DH group used in IKE phase 1 for initial SA. Valid
               options are `DHGroup1`, `DHGroup14`, `DHGroup2`, `DHGroup2048`, `DHGroup24`,
               `ECP256`, `ECP384`, or `None`.
        :param _builtins.str ike_encryption: The IKE encryption algorithm. Valid
               options are `AES128`, `AES192`, `AES256`, `DES`, or `DES3`.
        :param _builtins.str ike_integrity: The IKE integrity algorithm. Valid
               options are `MD5`, `SHA1`, `SHA256`, or `SHA384`.
        :param _builtins.str ipsec_encryption: The IPSec encryption algorithm. Valid
               options are `AES128`, `AES192`, `AES256`, `DES`, `DES3`, `GCMAES128`, `GCMAES192`, `GCMAES256`, or `None`.
        :param _builtins.str ipsec_integrity: The IPSec integrity algorithm. Valid
               options are `GCMAES128`, `GCMAES192`, `GCMAES256`, `MD5`, `SHA1`, or `SHA256`.
        :param _builtins.str pfs_group: The DH group used in IKE phase 2 for new child SA.
               Valid options are `ECP256`, `ECP384`, `PFS1`, `PFS2`, `PFS2048`, `PFS24`,
               or `None`.
        :param _builtins.int sa_datasize: The IPSec SA payload size in KB. Must be at least
               `1024` KB.
        :param _builtins.int sa_lifetime: The IPSec SA lifetime in seconds. Must be at least
               `300` seconds.
        """
        pulumi.set(__self__, "dh_group", dh_group)
        pulumi.set(__self__, "ike_encryption", ike_encryption)
    ...
    @_builtins.property
    @pulumi.getter(name="saDatasize")
    def sa_datasize(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="saLifetime")
    def sa_lifetime(self) -> _builtins.int:
        """
...
class GetNetworkInterfaceIpConfigurationResult(dict):
    def __init__(__self__, *,
                 application_gateway_backend_address_pools_ids: Sequence[_builtins.str],
                 application_security_group_ids: Sequence[_builtins.str],
                 gateway_load_balancer_frontend_ip_configuration_id: _builtins.str,
                 load_balancer_backend_address_pools_ids: Sequence[_builtins.str],
                 ...
                 subnet_id: _builtins.str):
        """
        :param Sequence[_builtins.str] application_gateway_backend_address_pools_ids: A list of Backend Address Pool IDs within a Application Gateway that this Network Interface is connected to.
        :param _builtins.str gateway_load_balancer_frontend_ip_configuration_id: The Frontend IP Configuration ID of a Gateway SKU Load Balancer the Network Interface is consuming.
        :param Sequence[_builtins.str] load_balancer_backend_address_pools_ids: A list of Backend Address Pool IDs within a Load Balancer that this Network Interface is connected to.
        :param Sequence[_builtins.str] load_balancer_inbound_nat_rules_ids: A list of Inbound NAT Rule IDs within a Load Balancer that this Network Interface is connected to.
        :param _builtins.str name: Specifies the name of the Network Interface.
        :param _builtins.bool primary: is this the Primary IP Configuration for this Network Interface?
        :param _builtins.str private_ip_address: The Private IP Address assigned to this Network Interface.
        :param _builtins.str private_ip_address_allocation: The IP Address allocation type for the Private address, such as `Dynamic` or `Static`.
        :param _builtins.str public_ip_address_id: The ID of the Public IP Address which is connected to this Network Interface.
        :param _builtins.str subnet_id: The ID of the Subnet which the Network Interface is connected to.
        """
    ...
    def application_gateway_backend_address_pools_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="gatewayLoadBalancerFrontendIpConfigurationId")
    def gateway_load_balancer_frontend_ip_configuration_id(self) -> _builtins.str:
        """
    ...
    def load_balancer_backend_address_pools_ids(self) -> Sequence[_builtins.str]:
        """
...
class GetNetworkManagerConnectivityConfigurationAppliesToGroupResult(dict):
    def __init__(__self__, *,
                 global_mesh_enabled: _builtins.bool,
                 group_connectivity: _builtins.str,
                 network_group_id: _builtins.str,
                 use_hub_gateway: _builtins.bool):
        """
        :param _builtins.bool global_mesh_enabled: Whether global mesh is supported.
        :param _builtins.str group_connectivity: The group connectivity type.
        :param _builtins.str network_group_id: The ID of the Network Manager Network Group.
        :param _builtins.bool use_hub_gateway: Whether hub gateway is used.
        """
        pulumi.set(__self__, "global_mesh_enabled", global_mesh_enabled)
        pulumi.set(__self__, "group_connectivity", group_connectivity)
        pulumi.set(__self__, "network_group_id", network_group_id)
    ...
    @_builtins.property
    @pulumi.getter(name="useHubGateway")
    def use_hub_gateway(self) -> _builtins.bool:
        """
...
class GetNetworkManagerConnectivityConfigurationHubResult(dict):
    def __init__(__self__, *,
                 ...
                 resource_type: _builtins.str):
        """
        :param _builtins.str resource_id: The resource ID used as hub in Hub and Spoke topology.
        :param _builtins.str resource_type: The resource type used as hub in Hub and Spoke topology.
        """
        pulumi.set(__self__, "resource_id", resource_id)
        pulumi.set(__self__, "resource_type", resource_type)
...
class GetNetworkManagerCrossTenantScopeResult(dict):
    def __init__(__self__, *,
                 ...
                 tenant_id: _builtins.str):
        """
        :param Sequence[_builtins.str] management_groups: A list of management groups used as cross tenant scope for the Network Manager.
        :param Sequence[_builtins.str] subscriptions: A list of subscriptions used as cross tenant scope for the Network Manager.
        :param _builtins.str tenant_id: The tenant ID of the cross tenant scope.
        """
        pulumi.set(__self__, "management_groups", management_groups)
        pulumi.set(__self__, "subscriptions", subscriptions)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetNetworkManagerScopeResult(dict):
    def __init__(__self__, *,
                 management_group_ids: Sequence[_builtins.str],
                 subscription_ids: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] management_group_ids: A list of management group IDs used a scope for the Network Manager.
        :param Sequence[_builtins.str] subscription_ids: A list of subscription IDs used as the scope for the Network Manager.
        """
        pulumi.set(__self__, "management_group_ids", management_group_ids)
        pulumi.set(__self__, "subscription_ids", subscription_ids)
...
class GetNetworkSecurityGroupSecurityRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 destination_address_prefix: _builtins.str,
                 destination_address_prefixes: Sequence[_builtins.str],
                 ...
                 source_address_prefixes: Sequence[_builtins.str],
                 source_port_range: _builtins.str,
                 source_port_ranges: Sequence[_builtins.str],
                 destination_application_security_group_ids: Optional[Sequence[_builtins.str]] = None,
                 source_application_security_group_ids: Optional[Sequence[_builtins.str]] = None):
        """
        :param _builtins.str access: Is network traffic is allowed or denied?
        :param _builtins.str description: The description for this rule.
        :param _builtins.str destination_address_prefix: CIDR or destination IP range or * to match any IP.
        :param Sequence[_builtins.str] destination_address_prefixes: A list of CIDRs or destination IP ranges.
        :param _builtins.str destination_port_range: The Destination Port or Range.
        :param _builtins.str direction: The direction specifies if rule will be evaluated on incoming or outgoing traffic.
        ...
        :param _builtins.str protocol: The network protocol this rule applies to.
        :param _builtins.str source_address_prefix: CIDR or source IP range or * to match any IP.
        :param Sequence[_builtins.str] source_address_prefixes: A list of CIDRs or source IP ranges.
        :param _builtins.str source_port_range: The Source Port or Range.
        :param Sequence[_builtins.str] destination_application_security_group_ids: A List of destination Application Security Group IDs
        :param Sequence[_builtins.str] source_application_security_group_ids: A List of source Application Security Group IDs
        """
        pulumi.set(__self__, "access", access)
    ...
    @_builtins.property
    @pulumi.getter(name="destinationAddressPrefix")
    def destination_address_prefix(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="destinationAddressPrefixes")
    def destination_address_prefixes(self) -> Sequence[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sourceAddressPrefixes")
    def source_address_prefixes(self) -> Sequence[_builtins.str]:
        """
...
class GetPublicIPsPublicIpResult(dict):
    def __init__(__self__, *,
                 ...
                 name: _builtins.str):
        """
        :param _builtins.str domain_name_label: The Domain Name Label of the Public IP Address
        :param _builtins.str fqdn: The FQDN of the Public IP Address
        :param _builtins.str id: The ID of the Public IP Address
        :param _builtins.str ip_address: The IP address of the Public IP Address
        :param _builtins.str name: The Name of the Public IP Address
        """
...
class GetRouteFilterRuleResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] communities: The collection for bgp community values.
        :param _builtins.str name: The Name of this Route Filter.
        :param _builtins.str rule_type: The Route Filter Rule Type.
        """
        pulumi.set(__self__, "access", access)
        pulumi.set(__self__, "communities", communities)
        pulumi.set(__self__, "name", name)
...
class GetRouteTableRouteResult(dict):
    def __init__(__self__, *,
                 address_prefix: _builtins.str,
                 name: _builtins.str,
                 next_hop_in_ip_address: _builtins.str,
                 next_hop_type: _builtins.str):
        """
        ...
        :param _builtins.str next_hop_in_ip_address: Contains the IP address packets should be forwarded to.
    ...
    @_builtins.property
    @pulumi.getter(name="nextHopInIpAddress")
    def next_hop_in_ip_address(self) -> _builtins.str:
        """
...
@pulumi.output_type
class GetSubnetServiceEndpointResult(dict):
    def __init__(__self__, *,
                 network_identifier: _builtins.str,
                 service: _builtins.str):
        """
        :param _builtins.str network_identifier: The ID of the network resource associated with the Service Endpoint.
        :param _builtins.str service: The type of the Service Endpoint.
        """
        pulumi.set(__self__, "network_identifier", network_identifier)
        pulumi.set(__self__, "service", service)
    ...
    @_builtins.property
    @pulumi.getter(name="networkIdentifier")
    def network_identifier(self) -> _builtins.str:
        """
...
class GetTrafficManagerProfileDnsConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 ttl: _builtins.int):
        """
        :param _builtins.str relative_name: The relative domain name, this is combined with the domain name used by Traffic Manager to form the FQDN which is exported as documented below.
        :param _builtins.int ttl: The TTL value of the Profile used by Local DNS resolvers and clients.
        """
        pulumi.set(__self__, "relative_name", relative_name)
        pulumi.set(__self__, "ttl", ttl)
...
class GetTrafficManagerProfileMonitorConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 expected_status_code_ranges: Sequence[_builtins.str],
                 interval_in_seconds: _builtins.int,
                 path: _builtins.str,
                 port: _builtins.int,
                 protocol: _builtins.str,
                 timeout_in_seconds: _builtins.int,
                 tolerated_number_of_failures: _builtins.int):
        """
        ...
        :param Sequence[_builtins.str] expected_status_code_ranges: A list of status code ranges.
        :param _builtins.int interval_in_seconds: The interval used to check the endpoint health from a Traffic Manager probing agent.
        :param _builtins.str path: The path used by the monitoring checks.
        :param _builtins.int port: The port number used by the monitoring checks.
        :param _builtins.str protocol: The protocol used by the monitoring checks.
        :param _builtins.int timeout_in_seconds: The amount of time the Traffic Manager probing agent should wait before considering that check a failure when a health check probe is sent to the endpoint.
        :param _builtins.int tolerated_number_of_failures: The number of failures a Traffic Manager probing agent tolerates before marking that endpoint as unhealthy.
        """
        pulumi.set(__self__, "custom_headers", custom_headers)
        pulumi.set(__self__, "expected_status_code_ranges", expected_status_code_ranges)
        pulumi.set(__self__, "interval_in_seconds", interval_in_seconds)
    ...
    @_builtins.property
    @pulumi.getter(name="expectedStatusCodeRanges")
    def expected_status_code_ranges(self) -> Sequence[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="toleratedNumberOfFailures")
    def tolerated_number_of_failures(self) -> _builtins.int:
        """
...
class GetTrafficManagerProfileMonitorConfigCustomHeaderResult(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str name: Specifies the name of the Traffic Manager Profile.
        :param _builtins.str value: The value of custom header. Applicable for HTTP and HTTPS protocol.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class GetVirtualHubConnectionRoutingResult(dict):
    def __init__(__self__, *,
                 associated_route_table_id: _builtins.str,
                 inbound_route_map_id: _builtins.str,
                 outbound_route_map_id: _builtins.str,
                 propagated_route_tables: Sequence['outputs.GetVirtualHubConnectionRoutingPropagatedRouteTableResult'],
                 static_vnet_local_route_override_criteria: _builtins.str,
                 static_vnet_propagate_static_routes_enabled: _builtins.bool,
                 static_vnet_routes: Sequence['outputs.GetVirtualHubConnectionRoutingStaticVnetRouteResult']):
        """
        :param _builtins.str associated_route_table_id: The ID of the route table associated with this Virtual Hub connection.
        :param _builtins.str inbound_route_map_id: The ID of the Route Map associated with this Routing Configuration for inbound learned routes.
        :param _builtins.str outbound_route_map_id: The ID of the Route Map associated with this Routing Configuration for outbound advertised routes.
        ...
        :param _builtins.str static_vnet_local_route_override_criteria: The static VNet local route override criteria that is used to determine whether NVA in spoke VNet is bypassed for traffic with destination in spoke VNet.
        :param _builtins.bool static_vnet_propagate_static_routes_enabled: Whether the static routes should be propagated to the Virtual Hub or not.
    ...
    @_builtins.property
    @pulumi.getter(name="inboundRouteMapId")
    def inbound_route_map_id(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="outboundRouteMapId")
    def outbound_route_map_id(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="staticVnetLocalRouteOverrideCriteria")
    def static_vnet_local_route_override_criteria(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="staticVnetPropagateStaticRoutesEnabled")
    def static_vnet_propagate_static_routes_enabled(self) -> _builtins.bool:
        """
...
class GetVirtualHubConnectionRoutingPropagatedRouteTableResult(dict):
    def __init__(__self__, *,
                 ...
                 route_table_ids: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] labels: The list of labels assigned to this route table.
        :param Sequence[_builtins.str] route_table_ids: A list of Route Table IDs associated with this Virtual Hub Connection.
        """
        pulumi.set(__self__, "labels", labels)
        pulumi.set(__self__, "route_table_ids", route_table_ids)
...
class GetVirtualHubConnectionRoutingStaticVnetRouteResult(dict):
    def __init__(__self__, *,
                 ...
                 next_hop_ip_address: _builtins.str):
        """
        :param Sequence[_builtins.str] address_prefixes: A list of CIDR Ranges which is used as Address Prefixes.
        :param _builtins.str name: The name of the Connection which should be retrieved.
        :param _builtins.str next_hop_ip_address: The IP Address which is used for the Next Hop.
        """
        pulumi.set(__self__, "address_prefixes", address_prefixes)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "next_hop_ip_address", next_hop_ip_address)
...
class GetVirtualHubRouteTableRouteResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] destinations: A list of destination addresses for this route.
        :param _builtins.str destinations_type: The type of destinations.
        :param _builtins.str name: The name of the Virtual Hub Route Table.
        :param _builtins.str next_hop: The next hop's resource ID.
        :param _builtins.str next_hop_type: The type of next hop.
        """
        pulumi.set(__self__, "destinations", destinations)
        pulumi.set(__self__, "destinations_type", destinations_type)
        pulumi.set(__self__, "name", name)
...
class GetVirtualNetworkGatewayBgpSettingResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int asn: The Autonomous System Number (ASN) to use as part of the BGP.
        :param _builtins.int peer_weight: The weight added to routes which have been learned
               through BGP peering.
        :param _builtins.str peering_address: The BGP peer IP address of the virtual network
...
class GetVirtualNetworkGatewayIpConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 subnet_id: _builtins.str):
        """
        :param _builtins.str id: The resource ID of the IP configuration.
        :param _builtins.str name: Specifies the name of the Virtual Network Gateway.
        :param _builtins.str private_ip_address: The Private IP Address associated with the Virtual Network Gateway.
        :param _builtins.str private_ip_address_allocation: Defines how the private IP address
               of the gateways virtual interface is assigned.
        :param _builtins.str public_ip_address_id: The ID of the Public IP Address associated
               with the Virtual Network Gateway.
        :param _builtins.str subnet_id: The ID of the gateway subnet of a virtual network in
...
class GetVirtualNetworkGatewayVpnClientConfigurationResult(dict):
    def __init__(__self__, *,
                 aad_audience: _builtins.str,
                 aad_issuer: _builtins.str,
                 aad_tenant: _builtins.str,
                 address_spaces: Sequence[_builtins.str],
                 ...
                 vpn_client_protocols: Sequence[_builtins.str]):
        """
        :param _builtins.str aad_audience: The client id of the Azure VPN application.
               See [Create an Active Directory (AD) tenant for P2S OpenVPN protocol connections](https://docs.microsoft.com/en-gb/azure/vpn-gateway/openvpn-azure-ad-tenant-multi-app) for values
        ...
        :param _builtins.str aad_tenant: AzureAD Tenant URL
               This setting is incompatible with the use of
               `root_certificate` and `revoked_certificate`, `radius_server_address`, and `radius_server_secret`.
        :param Sequence[_builtins.str] address_spaces: The address space out of which IP addresses for
    ...
    @_builtins.property
    @pulumi.getter(name="aadAudience")
    def aad_audience(self) -> _builtins.str:
        """
        The client id of the Azure VPN application.
        See [Create an Active Directory (AD) tenant for P2S OpenVPN protocol connections](https://docs.microsoft.com/en-gb/azure/vpn-gateway/openvpn-azure-ad-tenant-multi-app) for values
        This setting is incompatible with the use of
    ...
    @_builtins.property
    @pulumi.getter(name="aadIssuer")
    def aad_issuer(self) -> _builtins.str:
        """
        The STS url for your tenant
        This setting is incompatible with the use of
        `root_certificate` and `revoked_certificate`, `radius_server_address`, and `radius_server_secret`.
    ...
    @_builtins.property
    @pulumi.getter(name="aadTenant")
    def aad_tenant(self) -> _builtins.str:
        """
        AzureAD Tenant URL
        This setting is incompatible with the use of
        `root_certificate` and `revoked_certificate`, `radius_server_address`, and `radius_server_secret`.
    ...
    @_builtins.property
    @pulumi.getter(name="vpnClientProtocols")
    def vpn_client_protocols(self) -> Sequence[_builtins.str]:
        """
        List of the protocols supported by the vpn client.
        The supported values are `SSTP`, `IkeV2` and `OpenVPN`.
        """
...
class GetVirtualNetworkGatewayVpnClientConfigurationRootCertificateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: Specifies the name of the Virtual Network Gateway.
        :param _builtins.str public_cert_data: The public certificate of the root certificate
...
class GetVpnGatewayBgpSettingResult(dict):
    def __init__(__self__, *,
                 ...
                 peer_weight: _builtins.int):
        """
        :param _builtins.int asn: The ASN of the BGP Speaker.
        :param _builtins.str bgp_peering_address: The Address which should be used for the BGP Peering.
...
class GetVpnGatewayBgpSettingInstance0BgpPeeringAddressResult(dict):
    def __init__(__self__, *,
                 custom_ips: Sequence[_builtins.str],
                 default_ips: Sequence[_builtins.str],
                 ip_configuration_id: _builtins.str,
                 tunnel_ips: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] custom_ips: A list of custom BGP peering addresses to assigned to this instance.
        :param Sequence[_builtins.str] default_ips: The list of default BGP peering addresses which belong to the pre-defined VPN Gateway IP configuration.
        :param _builtins.str ip_configuration_id: The pre-defined id of VPN Gateway IP Configuration.
        :param Sequence[_builtins.str] tunnel_ips: The list of tunnel public IP addresses which belong to the pre-defined VPN Gateway IP configuration.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultIps")
    def default_ips(self) -> Sequence[_builtins.str]:
        """
        The list of default BGP peering addresses which belong to the pre-defined VPN Gateway IP configuration.
        """
        return pulumi.get(self, "default_ips")
...
@pulumi.output_type
class GetVpnGatewayIpConfigurationResult(dict):
    def __init__(__self__, *,
                 id: _builtins.str,
                 private_ip_address: _builtins.str,
...
class GetVpnServerConfigurationIpsecPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 sa_lifetime_seconds: _builtins.int):
        """
        :param _builtins.str dh_group: The DH Group, used in IKE Phase 1.
        :param _builtins.str ike_encryption: The IKE encryption algorithm, used for IKE Phase 2.
        :param _builtins.str ike_integrity: The IKE encryption integrity algorithm, used for IKE Phase 2.
        :param _builtins.str ipsec_encryption: The IPSec encryption algorithm, used for IKE phase 1.
        :param _builtins.str ipsec_integrity: The IPSec integrity algorithm, used for IKE phase 1.
        :param _builtins.str pfs_group: The Pfs Group, used in IKE Phase 2.
        :param _builtins.int sa_data_size_kilobytes: The IPSec Security Association payload size in KB for a Site-to-Site VPN tunnel.
        :param _builtins.int sa_lifetime_seconds: The IPSec Security Association lifetime in seconds for a Site-to-Site VPN tunnel.
        """
        pulumi.set(__self__, "dh_group", dh_group)
...
class GetVpnServerConfigurationRadiusServerResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str address: The Address of the Radius Server.
        :param _builtins.int score: The Score of the Radius Server determines the priority of the server.
        :param _builtins.str secret: The Secret used to communicate with the Radius Server.
        """
        pulumi.set(__self__, "address", address)
        pulumi.set(__self__, "score", score)
