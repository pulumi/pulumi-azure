...
class GetNetworkManagerConnectivityConfigurationResult:
    ...
    def delete_existing_peering_enabled(self) -> _builtins.bool:
        """
    ...
    def global_mesh_enabled(self) -> _builtins.bool:
        """
...
def get_network_manager_connectivity_configuration(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Network` - 2025-01-01
    ...
    :param _builtins.str network_manager_id: The ID of the Network Manager.
    """
    __args__ = dict()
    __args__['name'] = name
