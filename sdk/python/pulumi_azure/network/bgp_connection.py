...
class BgpConnectionArgs:
    def __init__(__self__, *,
                 ...
                 virtual_network_connection_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BgpConnection resource.
        :param pulumi.Input[builtins.int] peer_asn: The peer autonomous system number for the Virtual Hub Bgp Connection. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] peer_ip: The peer IP address for the Virtual Hub Bgp Connection. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] virtual_hub_id: The ID of the Virtual Hub within which this Bgp connection should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Virtual Hub Bgp Connection. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] virtual_network_connection_id: The ID of virtual network connection.
        """
    ...
    def virtual_network_connection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def virtual_network_connection_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BgpConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            peer_ip: Optional[pulumi.Input[builtins.str]] = None,
            virtual_hub_id: Optional[pulumi.Input[builtins.str]] = None,
            virtual_network_connection_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BgpConnection':
        """
    ...
    @property
    @pulumi.getter(name="virtualNetworkConnectionId")
    def virtual_network_connection_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of virtual network connection.
        """
        return pulumi.get(self, "virtual_network_connection_id")
