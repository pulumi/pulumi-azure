...
class NatGatewayPublicIpPrefixAssociationArgs:
    def __init__(__self__, *,
                 ...
                 public_ip_prefix_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] public_ip_prefix_id: The ID of the Public IP Prefix which this NAT Gateway which should be connected to. Changing this forces a new resource to be created.
        """
    ...
    def public_ip_prefix_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def public_ip_prefix_id(self, value: pulumi.Input[builtins.str]):
...
class NatGatewayPublicIpPrefixAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            nat_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            public_ip_prefix_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NatGatewayPublicIpPrefixAssociation':
        """
    ...
    @property
    @pulumi.getter(name="publicIpPrefixId")
    def public_ip_prefix_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Public IP Prefix which this NAT Gateway which should be connected to. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "public_ip_prefix_id")
