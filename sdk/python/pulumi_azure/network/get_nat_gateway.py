...
class GetNatGatewayResult:
    ...
    def public_ip_prefix_ids(self) -> Sequence[builtins.str]:
        """
...
def get_nat_gateway(name: Optional[builtins.str] = None,
                    public_ip_address_ids: Optional[Sequence[builtins.str]] = None,
                    public_ip_prefix_ids: Optional[Sequence[builtins.str]] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param Sequence[builtins.str] public_ip_prefix_ids: A list of existing Public IP Prefix resource IDs which the NAT Gateway is using.
    :param builtins.str resource_group_name: Specifies the name of the Resource Group where the NAT Gateway exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_nat_gateway_output(name: Optional[pulumi.Input[builtins.str]] = None,
                           public_ip_address_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                           public_ip_prefix_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
