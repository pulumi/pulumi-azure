...
class PublicIpArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sku: The SKU of the Public IP. Accepted values are `Basic` and `Standard`. Defaults to `Standard`. Changing this forces a new resource to be created.
