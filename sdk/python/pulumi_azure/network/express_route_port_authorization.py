...
class ExpressRoutePortAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] express_route_port_name: The name of the Express Route Port in which to create the Authorization. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the ExpressRoute Port. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the ExpressRoute Port. Changing this forces a new resource to be created.
        """
...
class _ExpressRoutePortAuthorizationState:
    def __init__(__self__, *,
                 ...
                 authorization_use_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] authorization_key: The Authorization Key.
        :param pulumi.Input[builtins.str] authorization_use_status: The authorization use status.
        :param pulumi.Input[builtins.str] express_route_port_name: The name of the Express Route Port in which to create the Authorization. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the ExpressRoute Port. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the ExpressRoute Port. Changing this forces a new resource to be created.
        """
    ...
    def authorization_use_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def authorization_use_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authorization_use_status", value)

    @property
    @pulumi.getter(name="expressRoutePortName")
    def express_route_port_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Express Route Port in which to create the Authorization. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "express_route_port_name")
    ...
    @express_route_port_name.setter
    def express_route_port_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "express_route_port_name", value)
...
class ExpressRoutePortAuthorization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            express_route_port_name: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ExpressRoutePortAuthorization':
        """
    ...
    @property
    @pulumi.getter(name="expressRoutePortName")
    def express_route_port_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Express Route Port in which to create the Authorization. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "express_route_port_name")
