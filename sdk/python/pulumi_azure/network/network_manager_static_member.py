...
class NetworkManagerStaticMemberArgs:
    def __init__(__self__, *,
                 network_group_id: pulumi.Input[builtins.str],
                 target_virtual_network_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a NetworkManagerStaticMember resource.
        :param pulumi.Input[builtins.str] network_group_id: Specifies the ID of the Network Manager Group. Changing this forces a new Network Manager Static Member to be created.
        :param pulumi.Input[builtins.str] target_virtual_network_id: Specifies the Resource ID of the Virtual Network using as the Static Member. Changing this forces a new Network Manager Static Member to be created.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Manager Static Member. Changing this forces a new Network Manager Static Member to be created.
        """
    ...
    def network_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_group_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "network_group_id", value)

    @property
    @pulumi.getter(name="targetVirtualNetworkId")
    def target_virtual_network_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_virtual_network_id(self, value: pulumi.Input[builtins.str]):
...
class _NetworkManagerStaticMemberState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 target_virtual_network_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering NetworkManagerStaticMember resources.
        :param pulumi.Input[builtins.str] name: Specifies the name which should be used for this Network Manager Static Member. Changing this forces a new Network Manager Static Member to be created.
        :param pulumi.Input[builtins.str] network_group_id: Specifies the ID of the Network Manager Group. Changing this forces a new Network Manager Static Member to be created.
        :param pulumi.Input[builtins.str] region: The region of the Network Manager Static Member.
        :param pulumi.Input[builtins.str] target_virtual_network_id: Specifies the Resource ID of the Virtual Network using as the Static Member. Changing this forces a new Network Manager Static Member to be created.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter(name="networkGroupId")
    def network_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the ID of the Network Manager Group. Changing this forces a new Network Manager Static Member to be created.
        """
        return pulumi.get(self, "network_group_id")
    ...
    @network_group_id.setter
    def network_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_group_id", value)
    ...
    @property
    @pulumi.getter(name="targetVirtualNetworkId")
    def target_virtual_network_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the Resource ID of the Virtual Network using as the Static Member. Changing this forces a new Network Manager Static Member to be created.
        """
        return pulumi.get(self, "target_virtual_network_id")
    ...
    @target_virtual_network_id.setter
    def target_virtual_network_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_virtual_network_id", value)
...
class NetworkManagerStaticMember(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_group_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            target_virtual_network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkManagerStaticMember':
        """
    ...
    @property
    @pulumi.getter(name="networkGroupId")
    def network_group_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the ID of the Network Manager Group. Changing this forces a new Network Manager Static Member to be created.
        """
        return pulumi.get(self, "network_group_id")
    ...
    @property
    @pulumi.getter(name="targetVirtualNetworkId")
    def target_virtual_network_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the Resource ID of the Virtual Network using as the Static Member. Changing this forces a new Network Manager Static Member to be created.
        """
        return pulumi.get(self, "target_virtual_network_id")
