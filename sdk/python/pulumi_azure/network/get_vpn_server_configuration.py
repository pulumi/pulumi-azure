...
class GetVpnServerConfigurationResult:
    ...
    def vpn_authentication_types(self) -> Sequence[builtins.str]:
        """
    ...
    def vpn_protocols(self) -> Sequence[builtins.str]:
        """
...
def get_vpn_server_configuration(name: Optional[builtins.str] = None,
...
def get_vpn_server_configuration_output(name: Optional[pulumi.Input[builtins.str]] = None,
