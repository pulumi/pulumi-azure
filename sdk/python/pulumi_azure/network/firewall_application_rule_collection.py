...
class FirewallApplicationRuleCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] azure_firewall_name: Specifies the name of the Firewall in which the Application Rule Collection should be created. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Application Rule Collection which must be unique within the Firewall. Changing this forces a new resource to be created.
        """
