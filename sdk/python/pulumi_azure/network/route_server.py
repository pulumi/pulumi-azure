...
class RouteServerArgs:
    def __init__(__self__, *,
                 ...
                 branch_to_branch_traffic_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: Specifies the name of the Resource Group where the Route Server should exist. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Route Server. Changing this forces a new resource to be created.
    ...
    def branch_to_branch_traffic_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def branch_to_branch_traffic_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RouteServerState:
    def __init__(__self__, *,
                 ...
                 routing_state: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def routing_state(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "routing_state")

    @routing_state.setter
    def routing_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RouteServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_router_asn: Optional[pulumi.Input[builtins.int]] = None,
            virtual_router_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'RouteServer':
        """
    ...
    @property
    @pulumi.getter(name="branchToBranchTrafficEnabled")
    def branch_to_branch_traffic_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable route exchange between Azure Route Server and the gateway(s).
        """
        return pulumi.get(self, "branch_to_branch_traffic_enabled")
