...
class GetSubnetResult:
    ...
    def default_outbound_access_enabled(self) -> builtins.bool:
        """
    ...
    def private_link_service_network_policies_enabled(self) -> builtins.bool:
        """
...
def get_subnet(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.Network`: 2024-05-01
    ...
    :param builtins.str name: Specifies the name of the Subnet.
    :param builtins.str resource_group_name: Specifies the name of the resource group the Virtual Network is located in.
    :param builtins.str virtual_network_name: Specifies the name of the Virtual Network this Subnet is located within.
    """
    __args__ = dict()
    __args__['name'] = name
