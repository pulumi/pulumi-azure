...
class ExpressRouteAuthorizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] private_cloud_id: The ID of the Azure VMware Solution Private Cloud in which to create this Azure VMware Solution ExpressRoute Circuit Authorization. Changing this forces a new Azure VMware Solution ExpressRoute Circuit Authorization to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure VMware Solution ExpressRoute Circuit Authorization. Changing this forces a new Azure VMware Solution ExpressRoute Circuit Authorization to be created.
        """
...
class _ExpressRouteAuthorizationState:
    def __init__(__self__, *,
                 express_route_authorization_id: Optional[pulumi.Input[builtins.str]] = None,
                 express_route_authorization_key: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] express_route_authorization_id: The ID of the Azure VMware Solution ExpressRoute Circuit Authorization.
        :param pulumi.Input[builtins.str] express_route_authorization_key: The key of the Azure VMware Solution ExpressRoute Circuit Authorization.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure VMware Solution ExpressRoute Circuit Authorization. Changing this forces a new Azure VMware Solution ExpressRoute Circuit Authorization to be created.
        :param pulumi.Input[builtins.str] private_cloud_id: The ID of the Azure VMware Solution Private Cloud in which to create this Azure VMware Solution ExpressRoute Circuit Authorization. Changing this forces a new Azure VMware Solution ExpressRoute Circuit Authorization to be created.
        """
    ...
    def express_route_authorization_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def express_route_authorization_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "express_route_authorization_id", value)

    @property
    @pulumi.getter(name="expressRouteAuthorizationKey")
    def express_route_authorization_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def express_route_authorization_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="privateCloudId")
    def private_cloud_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Azure VMware Solution Private Cloud in which to create this Azure VMware Solution ExpressRoute Circuit Authorization. Changing this forces a new Azure VMware Solution ExpressRoute Circuit Authorization to be created.
        """
        return pulumi.get(self, "private_cloud_id")
    ...
    @private_cloud_id.setter
    def private_cloud_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_cloud_id", value)
...
class ExpressRouteAuthorization(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            express_route_authorization_key: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            private_cloud_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ExpressRouteAuthorization':
        """
    ...
    @property
    @pulumi.getter(name="expressRouteAuthorizationId")
    def express_route_authorization_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Azure VMware Solution ExpressRoute Circuit Authorization.
        """
        return pulumi.get(self, "express_route_authorization_id")
    ...
    @property
    @pulumi.getter(name="expressRouteAuthorizationKey")
    def express_route_authorization_key(self) -> pulumi.Output[builtins.str]:
        """
        The key of the Azure VMware Solution ExpressRoute Circuit Authorization.
        """
        return pulumi.get(self, "express_route_authorization_key")
