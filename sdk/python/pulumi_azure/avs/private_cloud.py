...
class PrivateCloudArgs:
    def __init__(__self__, *,
                 ...
                 network_subnet_cidr: pulumi.Input[builtins.str],
                 resource_group_name: pulumi.Input[builtins.str],
                 sku_name: pulumi.Input[builtins.str],
                 internet_connection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Azure VMware Solution Private Cloud.
        :param pulumi.Input[builtins.str] vcenter_password: The password of the VMware vCenter Server cloudadmin. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        """
    ...
    def network_subnet_cidr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def network_subnet_cidr(self, value: pulumi.Input[builtins.str]):
    ...
    def internet_connection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PrivateCloudState:
    def __init__(__self__, *,
                 ...
                 hcx_cloud_manager_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 internet_connection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network_subnet_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 nsxt_certificate_thumbprint: Optional[pulumi.Input[builtins.str]] = None,
                 nsxt_manager_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 nsxt_password: Optional[pulumi.Input[builtins.str]] = None,
                 provisioning_subnet_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 sku_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 vcenter_certificate_thumbprint: Optional[pulumi.Input[builtins.str]] = None,
                 vcenter_password: Optional[pulumi.Input[builtins.str]] = None,
                 vcsa_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 vmotion_subnet_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure VMware Solution Private Cloud. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        :param pulumi.Input[builtins.str] network_subnet_cidr: The subnet which should be unique across virtual network in your subscription as well as on-premise. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        :param pulumi.Input[builtins.str] nsxt_certificate_thumbprint: The thumbprint of the VMware NSX Manager SSL certificate.
        :param pulumi.Input[builtins.str] nsxt_manager_endpoint: The endpoint for the VMware NSX Manager.
        :param pulumi.Input[builtins.str] nsxt_password: The password of the VMware NSX Manager cloudadmin. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        :param pulumi.Input[builtins.str] provisioning_subnet_cidr: The network which is used for virtual machine cold migration, cloning, and snapshot migration.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Azure VMware Solution Private Cloud should exist. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        :param pulumi.Input[builtins.str] sku_name: The Name of the SKU used for this Azure VMware Solution Private Cloud. Possible values are `av20`, `av36`, `av36t`, `av36p`, `av36pt`, `av48`, `av48t`, `av52`, `av52t`, and `av64`. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Azure VMware Solution Private Cloud.
        :param pulumi.Input[builtins.str] vcenter_certificate_thumbprint: The thumbprint of the VMware vCenter Server SSL certificate.
        :param pulumi.Input[builtins.str] vcenter_password: The password of the VMware vCenter Server cloudadmin. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        :param pulumi.Input[builtins.str] vcsa_endpoint: The endpoint for VMware vCenter Server Appliance.
        :param pulumi.Input[builtins.str] vmotion_subnet_cidr: The network which is used for live migration of virtual machines.
        """
    ...
    def hcx_cloud_manager_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hcx_cloud_manager_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="networkSubnetCidr")
    def network_subnet_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The subnet which should be unique across virtual network in your subscription as well as on-premise. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        """
        return pulumi.get(self, "network_subnet_cidr")
    ...
    @network_subnet_cidr.setter
    def network_subnet_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "network_subnet_cidr", value)

    @property
    @pulumi.getter(name="nsxtCertificateThumbprint")
    def nsxt_certificate_thumbprint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsxt_certificate_thumbprint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nsxt_certificate_thumbprint", value)

    @property
    @pulumi.getter(name="nsxtManagerEndpoint")
    def nsxt_manager_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsxt_manager_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provisioning_subnet_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioning_subnet_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vcenter_certificate_thumbprint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vcenter_certificate_thumbprint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vcsa_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vcsa_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vcsa_endpoint", value)

    @property
    @pulumi.getter(name="vmotionSubnetCidr")
    def vmotion_subnet_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vmotion_subnet_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrivateCloud(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vcenter_password: Optional[pulumi.Input[builtins.str]] = None,
            vcsa_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            vmotion_subnet_cidr: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateCloud':
        """
    ...
    @property
    @pulumi.getter(name="hcxCloudManagerEndpoint")
    def hcx_cloud_manager_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint for the VMware HCX Cloud Manager.
        """
        return pulumi.get(self, "hcx_cloud_manager_endpoint")
    ...
    @property
    @pulumi.getter(name="managementSubnetCidr")
    def management_subnet_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The network used to access VMware vCenter Server and NSX Manager.
        """
        return pulumi.get(self, "management_subnet_cidr")
    ...
    @property
    @pulumi.getter(name="networkSubnetCidr")
    def network_subnet_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The subnet which should be unique across virtual network in your subscription as well as on-premise. Changing this forces a new Azure VMware Solution Private Cloud to be created.
        """
        return pulumi.get(self, "network_subnet_cidr")
    ...
    @property
    @pulumi.getter(name="nsxtManagerEndpoint")
    def nsxt_manager_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint for the VMware NSX Manager.
        """
        return pulumi.get(self, "nsxt_manager_endpoint")
    ...
    @property
    @pulumi.getter(name="provisioningSubnetCidr")
    def provisioning_subnet_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The network which is used for virtual machine cold migration, cloning, and snapshot migration.
        """
        return pulumi.get(self, "provisioning_subnet_cidr")
    ...
    @property
    @pulumi.getter(name="vcsaEndpoint")
    def vcsa_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint for VMware vCenter Server Appliance.
        """
        return pulumi.get(self, "vcsa_endpoint")
    ...
    @property
    @pulumi.getter(name="vmotionSubnetCidr")
    def vmotion_subnet_cidr(self) -> pulumi.Output[builtins.str]:
        """
        The network which is used for live migration of virtual machines.
        """
        return pulumi.get(self, "vmotion_subnet_cidr")
