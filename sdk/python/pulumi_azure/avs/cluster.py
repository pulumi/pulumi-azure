...
class ClusterArgs:
    def __init__(__self__, *,
                 cluster_node_count: pulumi.Input[builtins.int],
                 sku_name: pulumi.Input[builtins.str],
                 vmware_cloud_id: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Cluster resource.
        :param pulumi.Input[builtins.int] cluster_node_count: The count of the Azure VMware Solution Cluster nodes.
        :param pulumi.Input[builtins.str] sku_name: The Cluster SKU to use. Possible values are `av20`, `av36`, `av36t`, `av36p`, `av48`, `av48t`, `av36pt`, `av52`, `av52t`, and `av64`. Changing this forces a new Azure VMware Solution Cluster to be created.
        :param pulumi.Input[builtins.str] vmware_cloud_id: The ID of the Azure VMware Solution Private Cloud in which to create this Cluster. Changing this forces a new Azure VMware Solution Cluster to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure VMware Solution Cluster. Changing this forces a new Azure VMware Solution Cluster to be created.
        """
    ...
    def cluster_node_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def cluster_node_count(self, value: pulumi.Input[builtins.int]):
    ...
    def vmware_cloud_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vmware_cloud_id(self, value: pulumi.Input[builtins.str]):
...
class _ClusterState:
    def __init__(__self__, *,
                 cluster_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 cluster_number: Optional[pulumi.Input[builtins.int]] = None,
                 hosts: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sku_name: Optional[pulumi.Input[builtins.str]] = None,
                 vmware_cloud_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Cluster resources.
        :param pulumi.Input[builtins.int] cluster_node_count: The count of the Azure VMware Solution Cluster nodes.
        :param pulumi.Input[builtins.int] cluster_number: A number that identifies this Cluster in its Azure VMware Solution Private Cloud.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hosts: A list of hosts in the Azure VMware Solution Cluster.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Azure VMware Solution Cluster. Changing this forces a new Azure VMware Solution Cluster to be created.
        :param pulumi.Input[builtins.str] sku_name: The Cluster SKU to use. Possible values are `av20`, `av36`, `av36t`, `av36p`, `av48`, `av48t`, `av36pt`, `av52`, `av52t`, and `av64`. Changing this forces a new Azure VMware Solution Cluster to be created.
        :param pulumi.Input[builtins.str] vmware_cloud_id: The ID of the Azure VMware Solution Private Cloud in which to create this Cluster. Changing this forces a new Azure VMware Solution Cluster to be created.
        """
    ...
    @property
    @pulumi.getter(name="clusterNodeCount")
    def cluster_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The count of the Azure VMware Solution Cluster nodes.
        """
        return pulumi.get(self, "cluster_node_count")
    ...
    @cluster_node_count.setter
    def cluster_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cluster_node_count", value)

    @property
    @pulumi.getter(name="clusterNumber")
    def cluster_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cluster_number(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="vmwareCloudId")
    def vmware_cloud_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Azure VMware Solution Private Cloud in which to create this Cluster. Changing this forces a new Azure VMware Solution Cluster to be created.
        """
        return pulumi.get(self, "vmware_cloud_id")
    ...
    @vmware_cloud_id.setter
    def vmware_cloud_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vmware_cloud_id", value)
...
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            sku_name: Optional[pulumi.Input[builtins.str]] = None,
            vmware_cloud_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="clusterNodeCount")
    def cluster_node_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of the Azure VMware Solution Cluster nodes.
        """
        return pulumi.get(self, "cluster_node_count")
    ...
    @property
    @pulumi.getter(name="clusterNumber")
    def cluster_number(self) -> pulumi.Output[builtins.int]:
        """
        A number that identifies this Cluster in its Azure VMware Solution Private Cloud.
        """
        return pulumi.get(self, "cluster_number")
    ...
    @property
    @pulumi.getter(name="vmwareCloudId")
    def vmware_cloud_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Azure VMware Solution Private Cloud in which to create this Cluster. Changing this forces a new Azure VMware Solution Cluster to be created.
        """
        return pulumi.get(self, "vmware_cloud_id")
