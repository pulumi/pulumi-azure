...
class GetPrivateCloudResult:
    ...
    def internet_connection_enabled(self) -> builtins.bool:
        """
...
def get_private_cloud(name: Optional[builtins.str] = None,
    ...
    * `Microsoft.AVS`: 2022-05-01
    ...
    :param builtins.str resource_group_name: The name of the Resource Group where the Azure VMware Solution Private Cloud exists.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_private_cloud_output(name: Optional[pulumi.Input[builtins.str]] = None,
