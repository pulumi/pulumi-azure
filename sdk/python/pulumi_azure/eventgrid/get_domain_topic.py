...
def get_domain_topic(domain_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.EventGrid` - 2025-02-15
    ...
    :param _builtins.str name: The name of the EventGrid Domain Topic resource.
    :param _builtins.str resource_group_name: The name of the resource group in which the EventGrid Domain Topic exists.
    """
    __args__ = dict()
