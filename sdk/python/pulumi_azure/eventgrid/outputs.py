...
class NamespaceIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tenant_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str type: Specifies the type of Managed Service Identity that should be configured on this Event Grid Namespace. Possible values are `SystemAssigned`, `UserAssigned`.
        :param Sequence[_builtins.str] identity_ids: Specifies a list of User Assigned Managed Identity IDs to be assigned to this Event Grid Namespace.
...
class NamespaceTopicSpacesConfiguration(dict):
    ...
    def __init__(__self__, *,
                 alternative_authentication_name_sources: Optional[Sequence[_builtins.str]] = None,
                 ...
                 route_topic_id: Optional[_builtins.str] = None,
                 static_routing_enrichments: Optional[Sequence['outputs.NamespaceTopicSpacesConfigurationStaticRoutingEnrichment']] = None):
        """
        :param Sequence[_builtins.str] alternative_authentication_name_sources: Specifies a list of alternative sources for the client authentication name from the client certificate. Possible values are `ClientCertificateDns`, `ClientCertificateEmail`, `ClientCertificateIp`, `ClientCertificateSubject` and `ClientCertificateUri`.
        ...
        :param _builtins.int maximum_client_sessions_per_authentication_name: Specifies the maximum number of client sessions per authentication name. Valid values can be between `1` and `100`.
        :param _builtins.int maximum_session_expiry_in_hours: Specifies the maximum session expiry interval allowed for all MQTT clients connecting to the Event Grid namespace. Valid values can be between `1` and `8`.
        :param _builtins.str route_topic_id: Specifies the Event Grid topic resource ID to route messages to.
    ...
    def alternative_authentication_name_sources(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def route_topic_id(self) -> Optional[_builtins.str]:
        """
...
class NamespaceTopicSpacesConfigurationDynamicRoutingEnrichment(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.str):
        """
        :param _builtins.str key: The enrichment key.
        :param _builtins.str value: The enrichment value.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class PartnerConfigurationPartnerAuthorization(dict):
    ...
    def __init__(__self__, *,
                 ...
                 partner_registration_id: _builtins.str,
                 authorization_expiration_time_in_utc: Optional[_builtins.str] = None):
        """
        :param _builtins.str partner_name: The partner name.
        :param _builtins.str partner_registration_id: The immutable id of the corresponding partner registration.
        :param _builtins.str authorization_expiration_time_in_utc: Expiration time of the partner authorization. Value should be in RFC 3339 format in UTC time zone, for example: "2025-02-04T00:00:00Z".
...
class SystemTopicEventSubscriptionDeliveryProperty(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str header_name: The name of the header to send on to the destination.
        :param _builtins.str type: Either `Static` or `Dynamic`.
        :param _builtins.bool secret: Set to `true` if the `value` is a secret and should be protected, otherwise `false`. If `true` then this value won't be returned from Azure API calls.
        :param _builtins.str source_field: If the `type` is `Dynamic`, then provide the payload field to be used as the value. Valid source fields differ by subscription type.
        :param _builtins.str value: If the `type` is `Static`, then provide the value to use.
        """
        pulumi.set(__self__, "header_name", header_name)
...
class GetDomainIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param Sequence[_builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this EventGrid Domain.
        :param _builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity.
        :param _builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity.
        :param _builtins.str type: The type of Managed Service Identity that is configured on this EventGrid Domain.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
...
class GetDomainInboundIpRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 ip_mask: _builtins.str):
        """
        :param _builtins.str action: The action to take when the rule is matched. Possible values are `Allow`.
        :param _builtins.str ip_mask: The IP mask (CIDR) to match on.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "ip_mask", ip_mask)
...
class GetDomainInputMappingDefaultValueResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str data_version: Specifies the default data version of the EventGrid Event associated with the domain.
        :param _builtins.str event_type: Specifies the default event type of the EventGrid Event associated with the domain.
        :param _builtins.str subject: Specifies the default subject of the EventGrid Event associated with the domain.
        """
        pulumi.set(__self__, "data_version", data_version)
        pulumi.set(__self__, "event_type", event_type)
        pulumi.set(__self__, "subject", subject)
    ...
    @_builtins.property
    @pulumi.getter(name="dataVersion")
    def data_version(self) -> _builtins.str:
        """
...
class GetDomainInputMappingFieldResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str data_version: Specifies the default data version of the EventGrid Event associated with the domain.
        :param _builtins.str event_time: Specifies the event time of the EventGrid Event associated with the domain.
        :param _builtins.str event_type: Specifies the default event type of the EventGrid Event associated with the domain.
        :param _builtins.str id: Specifies the id of the EventGrid Event associated with the domain.
        :param _builtins.str subject: Specifies the default subject of the EventGrid Event associated with the domain.
        :param _builtins.str topic: Specifies the topic of the EventGrid Event associated with the domain.
        """
        pulumi.set(__self__, "data_version", data_version)
        pulumi.set(__self__, "event_time", event_time)
        pulumi.set(__self__, "event_type", event_type)
...
class GetSystemTopicIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str):
        """
        :param Sequence[_builtins.str] identity_ids: The list of User Assigned Managed Identity IDs assigned to this Event Grid System Topic.
        :param _builtins.str principal_id: The Principal ID of the System Assigned Managed Service Identity that is configured on this Event Grid System Topic.
        :param _builtins.str tenant_id: The Tenant ID of the System Assigned Managed Service Identity that is configured on this Event Grid System Topic.
        :param _builtins.str type: The type of Managed Service Identity that is configured on this Event Grid System Topic.
        """
        pulumi.set(__self__, "identity_ids", identity_ids)
        pulumi.set(__self__, "principal_id", principal_id)
        pulumi.set(__self__, "tenant_id", tenant_id)
