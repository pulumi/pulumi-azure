...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 identity: pulumi.Input[Optional['DomainIdentityArgs']] = None,
                 inbound_ip_rules: pulumi.Input[Optional[Sequence[pulumi.Input['DomainInboundIpRuleArgs']]]] = None,
                 input_mapping_default_values: pulumi.Input[Optional['DomainInputMappingDefaultValuesArgs']] = None,
                 input_mapping_fields: pulumi.Input[Optional['DomainInputMappingFieldsArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the EventGrid Domain resource. Changing this forces a new resource to be created.
    ...
    def auto_create_topic_with_first_subscription(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def auto_create_topic_with_first_subscription(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "auto_create_topic_with_first_subscription", value)

    @_builtins.property
    @pulumi.getter(name="autoDeleteTopicWithLastSubscription")
    def auto_delete_topic_with_last_subscription(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def auto_delete_topic_with_last_subscription(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "auto_delete_topic_with_last_subscription", value)

    @_builtins.property
    @pulumi.getter
    def identity(self) -> pulumi.Input[Optional['DomainIdentityArgs']]:
        """
    ...
    @identity.setter
    def identity(self, value: pulumi.Input[Optional['DomainIdentityArgs']]):
        pulumi.set(self, "identity", value)

    @_builtins.property
    @pulumi.getter(name="inboundIpRules")
    def inbound_ip_rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainInboundIpRuleArgs']]]]:
        """
    ...
    def inbound_ip_rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainInboundIpRuleArgs']]]]):
        pulumi.set(self, "inbound_ip_rules", value)

    @_builtins.property
    @pulumi.getter(name="inputMappingDefaultValues")
    def input_mapping_default_values(self) -> pulumi.Input[Optional['DomainInputMappingDefaultValuesArgs']]:
        """
    ...
    def input_mapping_default_values(self, value: pulumi.Input[Optional['DomainInputMappingDefaultValuesArgs']]):
        pulumi.set(self, "input_mapping_default_values", value)

    @_builtins.property
    @pulumi.getter(name="inputMappingFields")
    def input_mapping_fields(self) -> pulumi.Input[Optional['DomainInputMappingFieldsArgs']]:
        """
    ...
    def input_mapping_fields(self, value: pulumi.Input[Optional['DomainInputMappingFieldsArgs']]):
...
class _DomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] location: Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the EventGrid Domain resource. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] primary_access_key: The Primary Shared Access Key associated with the EventGrid Domain.
        :param pulumi.Input[_builtins.bool] public_network_access_enabled: Whether or not public network access is allowed for this server. Defaults to `true`.
        :param pulumi.Input[_builtins.str] resource_group_name: The name of the resource group in which the EventGrid Domain exists. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] secondary_access_key: The Secondary Shared Access Key associated with the EventGrid Domain.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        """
        if auto_create_topic_with_first_subscription is not None:
            pulumi.set(__self__, "auto_create_topic_with_first_subscription", auto_create_topic_with_first_subscription)
