...
class GetEnterpriseDatabaseResult:
    ...
    def linked_database_group_nickname(self) -> _builtins.str:
        """
    ...
    def linked_database_ids(self) -> Sequence[_builtins.str]:
        """
...
def get_enterprise_database(cluster_id: Optional[_builtins.str] = None,
