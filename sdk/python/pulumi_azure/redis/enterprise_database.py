...
class EnterpriseDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 client_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 clustering_policy: Optional[pulumi.Input[builtins.str]] = None,
                 eviction_policy: Optional[pulumi.Input[builtins.str]] = None,
                 linked_database_group_nickname: Optional[pulumi.Input[builtins.str]] = None,
                 linked_database_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The resource id of the Redis Enterprise Cluster to deploy this Redis Enterprise Database. Changing this forces a new Redis Enterprise Database to be created.
        :param pulumi.Input[builtins.str] client_protocol: Specifies whether redis clients can connect using TLS-encrypted or plaintext redis protocols. Possible values are `Encrypted` and `Plaintext`. Defaults to `Encrypted`. Changing this forces a new Redis Enterprise Database to be created.
        :param pulumi.Input[builtins.str] clustering_policy: Clustering policy Specified at create time. Possible values are `EnterpriseCluster` and `OSSCluster`. Defaults to `OSSCluster`. Changing this forces a new Redis Enterprise Database to be created.
        :param pulumi.Input[builtins.str] eviction_policy: Redis eviction policy possible values are `AllKeysLFU`, `AllKeysLRU`, `AllKeysRandom`, `VolatileLRU`, `VolatileLFU`, `VolatileTTL`, `VolatileRandom` and `NoEviction`. Changing this forces a new Redis Enterprise Database to be created. Defaults to `VolatileLRU`.
        :param pulumi.Input[builtins.str] linked_database_group_nickname: Nickname of the group of linked databases. Changing this force a new Redis Enterprise Geo Database to be created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] linked_database_ids: A list of database resources to link with this database with a maximum of 5.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Redis Enterprise Database. Currently the acceptable value for this argument is `default`. Defaults to `default`. Changing this forces a new Redis Enterprise Database to be created.
        :param pulumi.Input[builtins.int] port: TCP port of the database endpoint. Specified at create time. Defaults to an available port. Changing this forces a new Redis Enterprise Database to be created. Defaults to `10000`.
        """
    ...
    def client_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_protocol", value)

    @property
    @pulumi.getter(name="clusteringPolicy")
    def clustering_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def clustering_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def linked_database_group_nickname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def linked_database_group_nickname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "linked_database_group_nickname", value)

    @property
    @pulumi.getter(name="linkedDatabaseIds")
    def linked_database_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def linked_database_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _EnterpriseDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Redis Enterprise Database. Currently the acceptable value for this argument is `default`. Defaults to `default`. Changing this forces a new Redis Enterprise Database to be created.
        :param pulumi.Input[builtins.int] port: TCP port of the database endpoint. Specified at create time. Defaults to an available port. Changing this forces a new Redis Enterprise Database to be created. Defaults to `10000`.
        :param pulumi.Input[builtins.str] primary_access_key: The Primary Access Key for the Redis Enterprise Database Instance.
        :param pulumi.Input[builtins.str] secondary_access_key: The Secondary Access Key for the Redis Enterprise Database Instance.
        """
        if client_protocol is not None:
            pulumi.set(__self__, "client_protocol", client_protocol)
...
class EnterpriseDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            port: Optional[pulumi.Input[builtins.int]] = None,
            primary_access_key: Optional[pulumi.Input[builtins.str]] = None,
            secondary_access_key: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseDatabase':
        """
    ...
    @property
    @pulumi.getter(name="linkedDatabaseGroupNickname")
    def linked_database_group_nickname(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Nickname of the group of linked databases. Changing this force a new Redis Enterprise Geo Database to be created.
        """
        return pulumi.get(self, "linked_database_group_nickname")
    ...
    @property
    @pulumi.getter(name="linkedDatabaseIds")
    def linked_database_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of database resources to link with this database with a maximum of 5.
