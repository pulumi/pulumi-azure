...
class LinkedServerArgs:
    def __init__(__self__, *,
                 ...
                 server_role: pulumi.Input[builtins.str],
                 target_redis_cache_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a LinkedServer resource.
        :param pulumi.Input[builtins.str] linked_redis_cache_id: The ID of the linked Redis cache. Changing this forces a new Redis to be created.
        :param pulumi.Input[builtins.str] linked_redis_cache_location: The location of the linked Redis cache. Changing this forces a new Redis to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Redis caches exists. Changing this forces a new Redis to be created.
        :param pulumi.Input[builtins.str] server_role: The role of the linked Redis cache (eg "Secondary"). Changing this forces a new Redis to be created. Possible values are `Primary` and `Secondary`.
        :param pulumi.Input[builtins.str] target_redis_cache_name: The name of Redis cache to link with. Changing this forces a new Redis to be created. (eg The primary role)
        """
    ...
    def server_role(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @server_role.setter
    def server_role(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "server_role", value)

    @property
    @pulumi.getter(name="targetRedisCacheName")
    def target_redis_cache_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_redis_cache_name(self, value: pulumi.Input[builtins.str]):
...
class _LinkedServerState:
    def __init__(__self__, *,
                 geo_replicated_primary_host_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 target_redis_cache_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering LinkedServer resources.
        :param pulumi.Input[builtins.str] geo_replicated_primary_host_name: The geo-replicated primary hostname for this linked server.
        :param pulumi.Input[builtins.str] linked_redis_cache_id: The ID of the linked Redis cache. Changing this forces a new Redis to be created.
        :param pulumi.Input[builtins.str] linked_redis_cache_location: The location of the linked Redis cache. Changing this forces a new Redis to be created.
        :param pulumi.Input[builtins.str] name: The name of the linked server.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the Redis caches exists. Changing this forces a new Redis to be created.
        :param pulumi.Input[builtins.str] server_role: The role of the linked Redis cache (eg "Secondary"). Changing this forces a new Redis to be created. Possible values are `Primary` and `Secondary`.
        :param pulumi.Input[builtins.str] target_redis_cache_name: The name of Redis cache to link with. Changing this forces a new Redis to be created. (eg The primary role)
        """
    ...
    def geo_replicated_primary_host_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def geo_replicated_primary_host_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "geo_replicated_primary_host_name", value)

    @property
    @pulumi.getter(name="linkedRedisCacheId")
    def linked_redis_cache_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the linked Redis cache. Changing this forces a new Redis to be created.
        """
        return pulumi.get(self, "linked_redis_cache_id")
    ...
    @linked_redis_cache_id.setter
    def linked_redis_cache_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "linked_redis_cache_id", value)

    @property
    @pulumi.getter(name="linkedRedisCacheLocation")
    def linked_redis_cache_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The location of the linked Redis cache. Changing this forces a new Redis to be created.
        """
        return pulumi.get(self, "linked_redis_cache_location")
    ...
    @linked_redis_cache_location.setter
    def linked_redis_cache_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "linked_redis_cache_location", value)
    ...
    @property
    @pulumi.getter(name="targetRedisCacheName")
    def target_redis_cache_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of Redis cache to link with. Changing this forces a new Redis to be created. (eg The primary role)
        """
        return pulumi.get(self, "target_redis_cache_name")
    ...
    @target_redis_cache_name.setter
    def target_redis_cache_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_redis_cache_name", value)
...
class LinkedServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            server_role: Optional[pulumi.Input[builtins.str]] = None,
            target_redis_cache_name: Optional[pulumi.Input[builtins.str]] = None) -> 'LinkedServer':
        """
    ...
    @property
    @pulumi.getter(name="targetRedisCacheName")
    def target_redis_cache_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of Redis cache to link with. Changing this forces a new Redis to be created. (eg The primary role)
        """
        return pulumi.get(self, "target_redis_cache_name")
