...
class CacheAccessPolicyAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_policy_name: The name of the Access Policy to be assigned. Changing this forces a new Redis Cache Access Policy Assignment to be created.
        :param pulumi.Input[builtins.str] object_id: The principal ID to be assigned the Access Policy. Changing this forces a new Redis Cache Access Policy Assignment to be created.
        :param pulumi.Input[builtins.str] object_id_alias: The alias of the principal ID. User-friendly name for object ID. Also represents username for token based authentication. Changing this forces a new Redis Cache Access Policy Assignment to be created.
        :param pulumi.Input[builtins.str] redis_cache_id: The ID of the Redis Cache. Changing this forces a new Redis Cache Access Policy Assignment to be created.
        :param pulumi.Input[builtins.str] name: The name of the Redis Cache Access Policy Assignment. Changing this forces a new Redis Cache Access Policy Assignment to be created.
        """
...
class _CacheAccessPolicyAssignmentState:
    ...
    @property
    @pulumi.getter(name="objectIdAlias")
    def object_id_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The alias of the principal ID. User-friendly name for object ID. Also represents username for token based authentication. Changing this forces a new Redis Cache Access Policy Assignment to be created.
        """
        return pulumi.get(self, "object_id_alias")
    ...
    @object_id_alias.setter
    def object_id_alias(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "object_id_alias", value)
...
class CacheAccessPolicyAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            object_id: Optional[pulumi.Input[builtins.str]] = None,
            object_id_alias: Optional[pulumi.Input[builtins.str]] = None,
            redis_cache_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CacheAccessPolicyAssignment':
        """
