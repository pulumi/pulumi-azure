...
class CachePatchScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] start_hour_utc: the Start Hour for maintenance in UTC - possible values range from `0 - 23`.
...
class CacheRedisConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] aof_backup_enabled: Enable or disable AOF persistence for this Redis Cache. Defaults to `false`.
               ...
               > **NOTE:** `aof_backup_enabled` can only be set when SKU is `Premium`.
        :param pulumi.Input[_builtins.str] aof_storage_connection_string0: First Storage Account connection string for AOF persistence.
        :param pulumi.Input[_builtins.str] aof_storage_connection_string1: Second Storage Account connection string for AOF persistence.
               
               Example usage:
        :param pulumi.Input[_builtins.bool] authentication_enabled: If set to `false`, the Redis instance will be accessible without authentication. Defaults to `true`.
               
               > **NOTE:** `authentication_enabled` can only be set to `false` if a `subnet_id` is specified; and only works if there aren't existing instances within the subnet with `authentication_enabled` set to `true`.
        :param pulumi.Input[_builtins.str] data_persistence_authentication_method: Preferred auth method to communicate to storage account used for data persistence. Possible values are `SAS` and `ManagedIdentity`.
        :param pulumi.Input[_builtins.int] maxclients: Returns the max number of connected clients at the same time.
        :param pulumi.Input[_builtins.int] maxfragmentationmemory_reserved: Value in megabytes reserved to accommodate for memory fragmentation. Defaults are shown below.
        :param pulumi.Input[_builtins.int] maxmemory_delta: The max-memory delta for this Redis instance. Defaults are shown below.
        :param pulumi.Input[_builtins.str] maxmemory_policy: How Redis will select what to remove when `maxmemory` is reached. Defaults to `volatile-lru`.
        :param pulumi.Input[_builtins.int] maxmemory_reserved: Value in megabytes reserved for non-cache usage e.g. failover. Defaults are shown below.
        :param pulumi.Input[_builtins.str] notify_keyspace_events: Keyspace notifications allows clients to subscribe to Pub/Sub channels in order to receive events affecting the Redis data set in some way. [Reference](https://redis.io/topics/notifications#configuration)
        :param pulumi.Input[_builtins.bool] rdb_backup_enabled: Is Backup Enabled? Only supported on Premium SKUs. Defaults to `false`.
               
               > **NOTE:** If `rdb_backup_enabled` set to `true`, `rdb_storage_connection_string` must also be set.
        :param pulumi.Input[_builtins.int] rdb_backup_frequency: The Backup Frequency in Minutes. Only supported on Premium SKUs. Possible values are: `15`, `30`, `60`, `360`, `720` and `1440`.
        :param pulumi.Input[_builtins.int] rdb_backup_max_snapshot_count: The maximum number of snapshots to create as a backup. Only supported for Premium SKUs.
        :param pulumi.Input[_builtins.str] rdb_storage_connection_string: The Connection String to the Storage Account. Only supported for Premium SKUs. In the format: `DefaultEndpointsProtocol=https;BlobEndpoint=${azurerm_storage_account.example.primary_blob_endpoint};AccountName=${azurerm_storage_account.example.name};AccountKey=${azurerm_storage_account.example.primary_access_key}`.
