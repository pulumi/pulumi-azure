...
class CacheAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] permissions: Permissions that are going to be assigned to this Redis Cache Access Policy.
        :param pulumi.Input[builtins.str] redis_cache_id: The ID of the Redis Cache. Changing this forces a new Redis Cache Access Policy to be created.
        :param pulumi.Input[builtins.str] name: The name of the Redis Cache Access Policy. Changing this forces a new Redis Cache Access Policy to be created.
        """
...
class CacheAccessPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            permissions: Optional[pulumi.Input[builtins.str]] = None,
            redis_cache_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CacheAccessPolicy':
        """
