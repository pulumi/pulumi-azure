...
class GetCacheResult:
    ...
    def access_keys_authentication_enabled(self) -> builtins.bool:
        """
    ...
    def non_ssl_port_enabled(self) -> builtins.bool:
...
def get_cache(name: Optional[builtins.str] = None,
...
def get_cache_output(name: Optional[pulumi.Input[builtins.str]] = None,
