...
class FirewallRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] start_ip: The lowest IP address included in the range
    ...
    def redis_cache_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def redis_cache_name(self, value: pulumi.Input[_builtins.str]):
...
class FirewallRule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="redisCacheName")
    def redis_cache_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the Redis Cache. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "redis_cache_name")
