...
class CacheArgs:
    def __init__(__self__, *,
                 ...
                 access_keys_authentication_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 non_ssl_port_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 patch_schedules: Optional[pulumi.Input[Sequence[pulumi.Input['CachePatchScheduleArgs']]]] = None,
                 private_static_ip_address: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] capacity: The size of the Redis cache to deploy. Valid values for a SKU `family` of C (Basic/Standard) are `0, 1, 2, 3, 4, 5, 6`, and for P (Premium) `family` are `1, 2, 3, 4, 5`.
        :param pulumi.Input[builtins.str] family: The SKU family/pricing group to use. Valid values are `C` (for Basic/Standard SKU family) and `P` (for `Premium`)
        ...
        :param pulumi.Input[builtins.str] private_static_ip_address: The Static IP Address to assign to the Redis Cache when hosted inside the Virtual Network. This argument implies the use of `subnet_id`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether or not public network access is allowed for this Redis Cache. `true` means this resource could be accessed by both public and private endpoint. `false` means only private endpoint access is allowed. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] redis_version: Redis version. Only major version needed. Possible values are `4` and `6`. Defaults to `6`.
        :param pulumi.Input[builtins.int] replicas_per_master: Amount of replicas to create per master for this Redis Cache.
        ...
        :param pulumi.Input[builtins.int] replicas_per_primary: Amount of replicas to create per primary for this Redis Cache. If both `replicas_per_primary` and `replicas_per_master` are set, they need to be equal.
    ...
    def access_keys_authentication_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def access_keys_authentication_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def non_ssl_port_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def non_ssl_port_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def private_static_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_static_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CacheState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] capacity: The size of the Redis cache to deploy. Valid values for a SKU `family` of C (Basic/Standard) are `0, 1, 2, 3, 4, 5, 6`, and for P (Premium) `family` are `1, 2, 3, 4, 5`.
        :param pulumi.Input[builtins.str] family: The SKU family/pricing group to use. Valid values are `C` (for Basic/Standard SKU family) and `P` (for `Premium`)
        :param pulumi.Input[builtins.str] hostname: The Hostname of the Redis Instance
        :param pulumi.Input['CacheIdentityArgs'] identity: An `identity` block as defined below.
        :param pulumi.Input[builtins.str] location: The location of the resource group. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] minimum_tls_version: The minimum TLS version. Possible values are `1.0`, `1.1` and `1.2`. Defaults to `1.0`.
        ...
        :param pulumi.Input[builtins.bool] non_ssl_port_enabled: Enable the non-SSL port (6379) - disabled by default.
        :param pulumi.Input[Sequence[pulumi.Input['CachePatchScheduleArgs']]] patch_schedules: A list of `patch_schedule` blocks as defined below.
        :param pulumi.Input[builtins.int] port: The non-SSL Port of the Redis Instance
        :param pulumi.Input[builtins.str] primary_access_key: The Primary Access Key for the Redis Instance
        :param pulumi.Input[builtins.str] primary_connection_string: The primary connection string of the Redis Instance.
        :param pulumi.Input[builtins.str] private_static_ip_address: The Static IP Address to assign to the Redis Cache when hosted inside the Virtual Network. This argument implies the use of `subnet_id`. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] public_network_access_enabled: Whether or not public network access is allowed for this Redis Cache. `true` means this resource could be accessed by both public and private endpoint. `false` means only private endpoint access is allowed. Defaults to `true`.
        :param pulumi.Input['CacheRedisConfigurationArgs'] redis_configuration: A `redis_configuration` block as defined below - with some limitations by SKU - defaults/details are shown below.
        :param pulumi.Input[builtins.str] redis_version: Redis version. Only major version needed. Possible values are `4` and `6`. Defaults to `6`.
        ...
        :param pulumi.Input[builtins.int] replicas_per_primary: Amount of replicas to create per primary for this Redis Cache. If both `replicas_per_primary` and `replicas_per_master` are set, they need to be equal.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the Redis instance. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] secondary_access_key: The Secondary Access Key for the Redis Instance
        :param pulumi.Input[builtins.str] secondary_connection_string: The secondary connection string of the Redis Instance.
        :param pulumi.Input[builtins.int] shard_count: *Only available when using the Premium SKU* The number of Shards to create on the Redis Cluster.
        :param pulumi.Input[builtins.str] sku_name: The SKU of Redis to use. Possible values are `Basic`, `Standard` and `Premium`.
...
class Cache(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tenant_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Cache':
        """
    ...
    @property
    @pulumi.getter(name="accessKeysAuthenticationEnabled")
    def access_keys_authentication_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether access key authentication is enabled? Defaults to `true`. `active_directory_authentication_enabled` must be set to `true` to disable access key authentication.
        """
        return pulumi.get(self, "access_keys_authentication_enabled")
    ...
    @property
    @pulumi.getter(name="nonSslPortEnabled")
    def non_ssl_port_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable the non-SSL port (6379) - disabled by default.
        """
        return pulumi.get(self, "non_ssl_port_enabled")
    ...
    @property
    @pulumi.getter(name="privateStaticIpAddress")
    def private_static_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The Static IP Address to assign to the Redis Cache when hosted inside the Virtual Network. This argument implies the use of `subnet_id`. Changing this forces a new resource to be created.
        """
        return pulumi.get(self, "private_static_ip_address")
    ...
    @property
    @pulumi.getter(name="replicasPerMaster")
    def replicas_per_master(self) -> pulumi.Output[builtins.int]:
        """
        Amount of replicas to create per master for this Redis Cache.
    ...
    @property
    @pulumi.getter(name="replicasPerPrimary")
    def replicas_per_primary(self) -> pulumi.Output[builtins.int]:
        """
        Amount of replicas to create per primary for this Redis Cache. If both `replicas_per_primary` and `replicas_per_master` are set, they need to be equal.
        """
        return pulumi.get(self, "replicas_per_primary")
