...
class GetKeyResult:
    ...
    def key_opts(self) -> Sequence[_builtins.str]:
        """
    ...
    def resource_versionless_id(self) -> _builtins.str:
        """
...
def get_key(key_vault_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Specifies the name of the Key Vault Key.
    """
    __args__ = dict()
