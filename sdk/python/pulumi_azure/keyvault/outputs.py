...
class CertifiateCertificateAttribute(dict):
    ...
    def __init__(__self__, *,
                 ...
                 recovery_level: Optional[builtins.str] = None,
                 updated: Optional[builtins.str] = None):
        """
        :param builtins.str created: The create time of the Key Vault Certificate.
        :param builtins.bool enabled: whether the Key Vault Certificate is enabled.
        :param builtins.str expires: The expires time of the Key Vault Certificate.
        :param builtins.str not_before: The not before valid time of the Key Vault Certificate.
        :param builtins.str recovery_level: The deletion recovery level of the Key Vault Certificate.
        :param builtins.str updated: The recent update time of the Key Vault Certificate.
        """
    ...
    def recovery_level(self) -> Optional[builtins.str]:
        """
...
class CertifiateCertificatePolicyIssuerParameters(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: The name of the Certificate Issuer. Possible values include `Self` (for self-signed certificate), or `Unknown` (for a certificate issuing authority like `Let's Encrypt` and Azure direct supported ones).
        """
...
class CertifiateCertificatePolicyKeyProperties(dict):
    ...
    def __init__(__self__, *,
                 ...
                 reuse_key: builtins.bool,
                 curve: Optional[builtins.str] = None,
                 key_size: Optional[builtins.int] = None):
        """
        :param builtins.bool exportable: Is this certificate exportable?
        :param builtins.str key_type: Specifies the type of key. Possible values are `EC`, `EC-HSM`, `RSA`, `RSA-HSM` and `oct`.
        :param builtins.bool reuse_key: Is the key reusable?
        :param builtins.str curve: Specifies the curve to use when creating an `EC` key. Possible values are `P-256`, `P-256K`, `P-384`, and `P-521`. This field will be required in a future release if `key_type` is `EC` or `EC-HSM`.
        :param builtins.int key_size: The size of the key used in the certificate. Possible values include `2048`, `3072`, and `4096` for `RSA` keys, or `256`, `384`, and `521` for `EC` keys. This property is required when using RSA keys.
        """
    ...
    @property
    @pulumi.getter
    def exportable(self) -> builtins.bool:
        """
    ...
    def reuse_key(self) -> builtins.bool:
        """
        Is the key reusable?
        """
...
class CertifiateCertificatePolicyLifetimeActionAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action_type: The Type of action to be performed when the lifetime trigger is triggerec. Possible values include `AutoRenew` and `EmailContacts`.
        """
...
class CertifiateCertificatePolicyLifetimeActionTrigger(dict):
    ...
    def __init__(__self__, *,
                 days_before_expiry: Optional[builtins.int] = None,
                 lifetime_percentage: Optional[builtins.int] = None):
        """
        :param builtins.int days_before_expiry: The number of days before the Certificate expires that the action associated with this Trigger should run. Conflicts with `lifetime_percentage`.
        :param builtins.int lifetime_percentage: The percentage at which during the Certificates Lifetime the action associated with this Trigger should run. Conflicts with `days_before_expiry`.
        """
    ...
    def days_before_expiry(self) -> Optional[builtins.int]:
        """
    ...
    def lifetime_percentage(self) -> Optional[builtins.int]:
        """
...
class CertifiateCertificatePolicySecretProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content_type: The Content-Type of the Certificate, such as `application/x-pkcs12` for a PFX or `application/x-pem-file` for a PEM.
        """
...
class CertifiateCertificatePolicyX509CertificateProperties(dict):
    ...
    def __init__(__self__, *,
                 key_usages: Sequence[builtins.str],
                 subject: builtins.str,
                 validity_in_months: builtins.int,
        ...
        """
        :param Sequence[builtins.str] key_usages: A list of uses associated with this Key. Possible values include `cRLSign`, `dataEncipherment`, `decipherOnly`, `digitalSignature`, `encipherOnly`, `keyAgreement`, `keyCertSign`, `keyEncipherment` and `nonRepudiation` and are case-sensitive.
        :param builtins.str subject: The Certificate's Subject.
        :param builtins.int validity_in_months: The Certificates Validity Period in Months.
        :param Sequence[builtins.str] extended_key_usages: A list of Extended/Enhanced Key Usages.
    ...
    def key_usages(self) -> Sequence[builtins.str]:
        """
    ...
    def validity_in_months(self) -> builtins.int:
        """
...
class CertifiateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNames(dict):
    ...
    def __init__(__self__, *,
                 ...
                 upns: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] dns_names: A list of alternative DNS names (FQDNs) identified by the Certificate.
        :param Sequence[builtins.str] emails: A list of email addresses identified by this Certificate.
        :param Sequence[builtins.str] upns: A list of User Principal Names identified by the Certificate.
        """
    ...
    @property
    @pulumi.getter
    def upns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CertificateContactsContact(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email: E-mail address of the contact.
        :param builtins.str name: Name of the contact.
        :param builtins.str phone: Phone number of the contact.
        """
...
class CertificateIssuerAdmin(dict):
    ...
    def __init__(__self__, *,
                 ...
                 phone: Optional[builtins.str] = None):
        """
        :param builtins.str email_address: E-mail address of the admin.
        :param builtins.str first_name: First name of the admin.
        :param builtins.str last_name: Last name of the admin.
        :param builtins.str phone: Phone number of the admin.
        """
...
class KeyRotationPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 notify_before_expiry: Optional[builtins.str] = None):
        """
        :param 'KeyRotationPolicyAutomaticArgs' automatic: An `automatic` block as defined below.
        :param builtins.str expire_after: Expire a Key Vault Key after given duration as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        :param builtins.str notify_before_expiry: Notify at a given duration before expiry as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        """
    ...
    def notify_before_expiry(self) -> Optional[builtins.str]:
        """
...
class KeyRotationPolicyAutomatic(dict):
    ...
    def __init__(__self__, *,
                 time_after_creation: Optional[builtins.str] = None,
                 time_before_expiry: Optional[builtins.str] = None):
        """
        :param builtins.str time_after_creation: Rotate automatically at a duration after create as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        :param builtins.str time_before_expiry: Rotate automatically at a duration before expiry as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        """
    ...
    def time_after_creation(self) -> Optional[builtins.str]:
        """
    ...
    def time_before_expiry(self) -> Optional[builtins.str]:
        """
...
class KeyVaultAccessPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_permissions: Optional[Sequence[builtins.str]] = None,
                 key_permissions: Optional[Sequence[builtins.str]] = None,
                 secret_permissions: Optional[Sequence[builtins.str]] = None,
                 storage_permissions: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str object_id: The object ID of a user, service principal or security group in the Azure Active Directory tenant for the vault. The object ID must be unique for the list of access policies.
        :param builtins.str tenant_id: The Azure Active Directory tenant ID that should be used for authenticating requests to the key vault. Must match the `tenant_id` used above.
        :param builtins.str application_id: The object ID of an Application in Azure Active Directory.
        :param Sequence[builtins.str] certificate_permissions: List of certificate permissions, must be one or more from the following: `Backup`, `Create`, `Delete`, `DeleteIssuers`, `Get`, `GetIssuers`, `Import`, `List`, `ListIssuers`, `ManageContacts`, `ManageIssuers`, `Purge`, `Recover`, `Restore`, `SetIssuers` and `Update`.
        :param Sequence[builtins.str] key_permissions: List of key permissions. Possible values are `Backup`, `Create`, `Decrypt`, `Delete`, `Encrypt`, `Get`, `Import`, `List`, `Purge`, `Recover`, `Restore`, `Sign`, `UnwrapKey`, `Update`, `Verify`, `WrapKey`, `Release`, `Rotate`, `GetRotationPolicy` and `SetRotationPolicy`.
        :param Sequence[builtins.str] secret_permissions: List of secret permissions, must be one or more from the following: `Backup`, `Delete`, `Get`, `List`, `Purge`, `Recover`, `Restore` and `Set`.
        :param Sequence[builtins.str] storage_permissions: List of storage permissions, must be one or more from the following: `Backup`, `Delete`, `DeleteSAS`, `Get`, `GetSAS`, `List`, `ListSAS`, `Purge`, `Recover`, `RegenerateKey`, `Restore`, `Set`, `SetSAS` and `Update`.
        """
    ...
    def certificate_permissions(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def key_permissions(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def secret_permissions(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def storage_permissions(self) -> Optional[Sequence[builtins.str]]:
        """
...
class KeyVaultNetworkAcls(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bypass: Specifies which traffic can bypass the network rules. Possible values are `AzureServices` and `None`.
        :param builtins.str default_action: The Default Action to use when no rules match from `ip_rules` / `virtual_network_subnet_ids`. Possible values are `Allow` and `Deny`.
        :param Sequence[builtins.str] ip_rules: One or more IP Addresses, or CIDR Blocks which should be able to access the Key Vault.
        :param Sequence[builtins.str] virtual_network_subnet_ids: One or more Subnet IDs which should be able to access this Key Vault.
        """
...
class ManagedHardwareSecurityModuleNetworkAcls(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bypass: Specifies which traffic can bypass the network rules. Possible values are `AzureServices` and `None`.
        :param builtins.str default_action: The Default Action to use. Possible values are `Allow` and `Deny`.
        """
        pulumi.set(__self__, "bypass", bypass)
        pulumi.set(__self__, "default_action", default_action)
...
class GetCertificateCertificatePolicyKeyPropertyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool exportable: Is this Certificate Exportable?
        :param builtins.int key_size: The size of the Key used in the Certificate.
        :param builtins.str key_type: Specifies the Type of Key, for example `RSA`.
        :param builtins.bool reuse_key: Is the key reusable?
        """
        pulumi.set(__self__, "curve", curve)
        pulumi.set(__self__, "exportable", exportable)
...
class GetCertificateCertificatePolicyLifetimeActionActionResult(dict):
    def __init__(__self__, *,
                 action_type: builtins.str):
        """
        :param builtins.str action_type: The Type of action to be performed when the lifetime trigger is triggerec.
        """
        pulumi.set(__self__, "action_type", action_type)
...
class GetCertificateCertificatePolicyLifetimeActionTriggerResult(dict):
    def __init__(__self__, *,
                 days_before_expiry: builtins.int,
                 lifetime_percentage: builtins.int):
        """
        :param builtins.int days_before_expiry: The number of days before the Certificate expires that the action associated with this Trigger should run.
        :param builtins.int lifetime_percentage: The percentage at which during the Certificates Lifetime the action associated with this Trigger should run.
        """
        pulumi.set(__self__, "days_before_expiry", days_before_expiry)
        pulumi.set(__self__, "lifetime_percentage", lifetime_percentage)
    ...
    @property
    @pulumi.getter(name="daysBeforeExpiry")
    def days_before_expiry(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="lifetimePercentage")
    def lifetime_percentage(self) -> builtins.int:
        """
...
class GetCertificateCertificatePolicySecretPropertyResult(dict):
    def __init__(__self__, *,
                 content_type: builtins.str):
        """
        :param builtins.str content_type: The Content-Type of the Certificate, for example `application/x-pkcs12` for a PFX or `application/x-pem-file` for a PEM.
        """
        pulumi.set(__self__, "content_type", content_type)
...
class GetCertificateCertificatePolicyX509CertificatePropertyResult(dict):
    def __init__(__self__, *,
                 extended_key_usages: Sequence[builtins.str],
                 key_usages: Sequence[builtins.str],
                 subject: builtins.str,
        ...
        """
        :param Sequence[builtins.str] extended_key_usages: A list of Extended/Enhanced Key Usages.
        :param Sequence[builtins.str] key_usages: A list of uses associated with this Key.
        :param builtins.str subject: The Certificate's Subject.
    ...
    @property
    @pulumi.getter(name="extendedKeyUsages")
    def extended_key_usages(self) -> Sequence[builtins.str]:
        """
        A list of Extended/Enhanced Key Usages.
        """
        return pulumi.get(self, "extended_key_usages")
...
class GetCertificateCertificatePolicyX509CertificatePropertySubjectAlternativeNameResult(dict):
    ...
    @property
    @pulumi.getter
    def upns(self) -> Sequence[builtins.str]:
        """
        A list of User Principal Names identified by the Certificate.
        """
        return pulumi.get(self, "upns")
...
class GetCertificatesCertificateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether this certificate is enabled.
        :param builtins.str id: The ID of this certificate.
        :param builtins.str name: The name of certificate.
        :param Mapping[str, builtins.str] tags: The tags of this certificate.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class GetKeyVaultAccessPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 certificate_permissions: Sequence[builtins.str],
                 key_permissions: Sequence[builtins.str],
                 object_id: builtins.str,
                 secret_permissions: Sequence[builtins.str],
                 storage_permissions: Sequence[builtins.str],
                 tenant_id: builtins.str):
        """
        :param builtins.str application_id: The Object ID of a Azure Active Directory Application.
        :param Sequence[builtins.str] certificate_permissions: A list of certificate permissions applicable to this Access Policy.
        :param Sequence[builtins.str] key_permissions: A list of key permissions applicable to this Access Policy.
        :param builtins.str object_id: An Object ID of a User, Service Principal or Security Group.
        :param Sequence[builtins.str] secret_permissions: A list of secret permissions applicable to this Access Policy.
        :param Sequence[builtins.str] storage_permissions: A list of storage permissions applicable to this Access Policy.
        :param builtins.str tenant_id: The Azure Active Directory Tenant ID used to authenticate requests for this Key Vault.
        """
        pulumi.set(__self__, "application_id", application_id)
        pulumi.set(__self__, "certificate_permissions", certificate_permissions)
        pulumi.set(__self__, "key_permissions", key_permissions)
    ...
    @property
    @pulumi.getter(name="certificatePermissions")
    def certificate_permissions(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="keyPermissions")
    def key_permissions(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="secretPermissions")
    def secret_permissions(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="storagePermissions")
    def storage_permissions(self) -> Sequence[builtins.str]:
        """
...
class GetKeyVaultNetworkAclResult(dict):
    def __init__(__self__, *,
                 bypass: builtins.str,
                 default_action: builtins.str,
                 ip_rules: Sequence[builtins.str],
                 virtual_network_subnet_ids: Sequence[builtins.str]):
        pulumi.set(__self__, "bypass", bypass)
        pulumi.set(__self__, "default_action", default_action)
        pulumi.set(__self__, "ip_rules", ip_rules)
        pulumi.set(__self__, "virtual_network_subnet_ids", virtual_network_subnet_ids)
    ...
    @property
    @pulumi.getter(name="ipRules")
    def ip_rules(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "ip_rules")

    @property
    @pulumi.getter(name="virtualNetworkSubnetIds")
    def virtual_network_subnet_ids(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "virtual_network_subnet_ids")
...
class GetManagedHardwareSecurityModuleRoleDefinitionPermissionResult(dict):
    def __init__(__self__, *,
                 ...
                 not_actions: Sequence[builtins.str],
                 not_data_actions: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] actions: A list of action permission granted.
        :param Sequence[builtins.str] data_actions: A list of data action permission granted.
        :param Sequence[builtins.str] not_actions: A list of action permission excluded (but not denied).
        :param Sequence[builtins.str] not_data_actions: A list of data action permission granted.
        """
        pulumi.set(__self__, "actions", actions)
        pulumi.set(__self__, "data_actions", data_actions)
        pulumi.set(__self__, "not_actions", not_actions)
    ...
    @property
    @pulumi.getter(name="notActions")
    def not_actions(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="notDataActions")
    def not_data_actions(self) -> Sequence[builtins.str]:
        """
        A list of data action permission granted.
        """
        return pulumi.get(self, "not_data_actions")
...
class GetSecretsSecretResult(dict):
    def __init__(__self__, *,
                 ...
                 tags: Mapping[str, builtins.str]):
        """
        :param builtins.bool enabled: Whether this secret is enabled.
        :param builtins.str id: The ID of this secret.
        :param builtins.str name: The name of secret.
        :param Mapping[str, builtins.str] tags: The tags of this secret.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
