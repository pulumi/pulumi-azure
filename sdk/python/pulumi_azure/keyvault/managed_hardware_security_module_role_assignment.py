...
class ManagedHardwareSecurityModuleRoleAssignmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] managed_hsm_id: The ID of a Managed Hardware Security Module resource. Changing this forces a new Managed Hardware Security Module to be created.
               *
        :param pulumi.Input[builtins.str] principal_id: The principal ID to be assigned to this role. It can point to a user, service principal, or security group. Changing this forces a new Managed Hardware Security Module to be created.
        :param pulumi.Input[builtins.str] role_definition_id: The resource ID of the role definition to assign. Changing this forces a new Managed Hardware Security Module to be created.
        :param pulumi.Input[builtins.str] scope: Specifies the scope to create the role assignment. Changing this forces a new Managed Hardware Security Module to be created.
        :param pulumi.Input[builtins.str] name: The name in GUID notation which should be used for this Managed Hardware Security Module Role Assignment. Changing this forces a new Managed Hardware Security Module to be created.
        """
...
class _ManagedHardwareSecurityModuleRoleAssignmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name in GUID notation which should be used for this Managed Hardware Security Module Role Assignment. Changing this forces a new Managed Hardware Security Module to be created.
        :param pulumi.Input[builtins.str] principal_id: The principal ID to be assigned to this role. It can point to a user, service principal, or security group. Changing this forces a new Managed Hardware Security Module to be created.
        :param pulumi.Input[builtins.str] resource_id: (Deprecated) The resource id of created assignment resource.
        :param pulumi.Input[builtins.str] role_definition_id: The resource ID of the role definition to assign. Changing this forces a new Managed Hardware Security Module to be created.
        :param pulumi.Input[builtins.str] scope: Specifies the scope to create the role assignment. Changing this forces a new Managed Hardware Security Module to be created.
        """
...
class ManagedHardwareSecurityModuleRoleAssignment(pulumi.CustomResource):
    ...
    pulumi_type = "azure:keyvault/managedHardwareSecurityModuleRoleAssignment:ManagedHardwareSecurityModuleRoleAssignment"
    ...
    def get(resource_name: str,
            ...
            resource_id: Optional[pulumi.Input[builtins.str]] = None,
            role_definition_id: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedHardwareSecurityModuleRoleAssignment':
        """
