...
class ManagedStorageAccountSasTokenDefinitionArgs:
    def __init__(__self__, *,
                 managed_storage_account_id: pulumi.Input[builtins.str],
                 sas_template_uri: pulumi.Input[builtins.str],
                 sas_type: pulumi.Input[builtins.str],
                 validity_period: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ManagedStorageAccountSasTokenDefinition resource.
        :param pulumi.Input[builtins.str] managed_storage_account_id: The ID of the Managed Storage Account.
        :param pulumi.Input[builtins.str] sas_template_uri: The SAS definition token template signed with an arbitrary key. Tokens created according to the SAS definition will have the same properties as the template, but regenerated with a new validity period.
        :param pulumi.Input[builtins.str] sas_type: The type of SAS token the SAS definition will create. Possible values are `account` and `service`.
        :param pulumi.Input[builtins.str] validity_period: Validity period of SAS token. Value needs to be in [ISO 8601 duration format](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        :param pulumi.Input[builtins.str] name: The name which should be used for this SAS Definition.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the SAS Definition. Changing this forces a new resource to be created.
        """
    ...
    def managed_storage_account_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def managed_storage_account_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "managed_storage_account_id", value)

    @property
    @pulumi.getter(name="sasTemplateUri")
    def sas_template_uri(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sas_template_uri(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sas_template_uri", value)

    @property
    @pulumi.getter(name="sasType")
    def sas_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @sas_type.setter
    def sas_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sas_type", value)

    @property
    @pulumi.getter(name="validityPeriod")
    def validity_period(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def validity_period(self, value: pulumi.Input[builtins.str]):
...
class _ManagedStorageAccountSasTokenDefinitionState:
    def __init__(__self__, *,
                 managed_storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 sas_template_uri: Optional[pulumi.Input[builtins.str]] = None,
                 sas_type: Optional[pulumi.Input[builtins.str]] = None,
                 secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 validity_period: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] sas_template_uri: The SAS definition token template signed with an arbitrary key. Tokens created according to the SAS definition will have the same properties as the template, but regenerated with a new validity period.
        :param pulumi.Input[builtins.str] sas_type: The type of SAS token the SAS definition will create. Possible values are `account` and `service`.
        :param pulumi.Input[builtins.str] secret_id: The ID of the Secret that is created by Managed Storage Account SAS Definition.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the SAS Definition. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] validity_period: Validity period of SAS token. Value needs to be in [ISO 8601 duration format](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        """
    ...
    @property
    @pulumi.getter(name="managedStorageAccountId")
    def managed_storage_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Managed Storage Account.
        """
        return pulumi.get(self, "managed_storage_account_id")
    ...
    @managed_storage_account_id.setter
    def managed_storage_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_storage_account_id", value)
    ...
    @property
    @pulumi.getter(name="sasTemplateUri")
    def sas_template_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The SAS definition token template signed with an arbitrary key. Tokens created according to the SAS definition will have the same properties as the template, but regenerated with a new validity period.
        """
        return pulumi.get(self, "sas_template_uri")
    ...
    @sas_template_uri.setter
    def sas_template_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sas_template_uri", value)

    @property
    @pulumi.getter(name="sasType")
    def sas_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of SAS token the SAS definition will create. Possible values are `account` and `service`.
        """
        return pulumi.get(self, "sas_type")
    ...
    @sas_type.setter
    def sas_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sas_type", value)
    ...
    @property
    @pulumi.getter(name="validityPeriod")
    def validity_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Validity period of SAS token. Value needs to be in [ISO 8601 duration format](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        """
        return pulumi.get(self, "validity_period")
    ...
    @validity_period.setter
    def validity_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "validity_period", value)
...
class ManagedStorageAccountSasTokenDefinition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            validity_period: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedStorageAccountSasTokenDefinition':
        """
    ...
    @property
    @pulumi.getter(name="managedStorageAccountId")
    def managed_storage_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Managed Storage Account.
        """
        return pulumi.get(self, "managed_storage_account_id")
    ...
    @property
    @pulumi.getter(name="sasTemplateUri")
    def sas_template_uri(self) -> pulumi.Output[builtins.str]:
        """
        The SAS definition token template signed with an arbitrary key. Tokens created according to the SAS definition will have the same properties as the template, but regenerated with a new validity period.
        """
        return pulumi.get(self, "sas_template_uri")
    ...
    @property
    @pulumi.getter(name="sasType")
    def sas_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of SAS token the SAS definition will create. Possible values are `account` and `service`.
        """
        return pulumi.get(self, "sas_type")
    ...
    @property
    @pulumi.getter(name="validityPeriod")
    def validity_period(self) -> pulumi.Output[builtins.str]:
        """
        Validity period of SAS token. Value needs to be in [ISO 8601 duration format](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        """
        return pulumi.get(self, "validity_period")
