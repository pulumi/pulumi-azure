...
class CertifiateCertificateAttributeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] expires: The expires time of the Key Vault Certificate.
        :param pulumi.Input[_builtins.str] not_before: The not before valid time of the Key Vault Certificate.
        :param pulumi.Input[_builtins.str] recovery_level: The deletion recovery level of the Key Vault Certificate.
        :param pulumi.Input[_builtins.str] updated: The recent update time of the Key Vault Certificate.
        """
...
class CertifiateCertificatePolicyIssuerParametersArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] name: The name of the Certificate Issuer. Possible values include `Self` (for self-signed certificate), or `Unknown` (for a certificate issuing authority like `Let's Encrypt` and Azure direct supported ones).
        """
...
class CertifiateCertificatePolicyKeyPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] reuse_key: Is the key reusable?
        :param pulumi.Input[_builtins.str] curve: Specifies the curve to use when creating an `EC` key. Possible values are `P-256`, `P-256K`, `P-384`, and `P-521`. This field will be required in a future release if `key_type` is `EC` or `EC-HSM`.
        :param pulumi.Input[_builtins.int] key_size: The size of the key used in the certificate. Possible values include `2048`, `3072`, and `4096` for `RSA` keys, or `256`, `384`, and `521` for `EC` keys. This property is required when using RSA keys.
        """
    ...
    def reuse_key(self) -> pulumi.Input[_builtins.bool]:
        """
        Is the key reusable?
        """
    ...
    @reuse_key.setter
    def reuse_key(self, value: pulumi.Input[_builtins.bool]):
...
class CertifiateCertificatePolicySecretPropertiesArgs:
    def __init__(__self__, *,
                 content_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] content_type: The Content-Type of the Certificate, such as `application/x-pkcs12` for a PFX or `application/x-pem-file` for a PEM.
        """
...
class CertifiateCertificatePolicyX509CertificatePropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] validity_in_months: The Certificates Validity Period in Months.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] extended_key_usages: A list of Extended/Enhanced Key Usages.
    ...
    def key_usages(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
        A list of uses associated with this Key. Possible values include `cRLSign`, `dataEncipherment`, `decipherOnly`, `digitalSignature`, `encipherOnly`, `keyAgreement`, `keyCertSign`, `keyEncipherment` and `nonRepudiation` and are case-sensitive.
        """
    ...
    @key_usages.setter
    def key_usages(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    def validity_in_months(self) -> pulumi.Input[_builtins.int]:
        """
        The Certificates Validity Period in Months.
        """
    ...
    def validity_in_months(self, value: pulumi.Input[_builtins.int]):
...
class CertifiateCertificatePolicyX509CertificatePropertiesSubjectAlternativeNamesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] upns: A list of User Principal Names identified by the Certificate.
        """
...
class CertificateIssuerAdminArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] last_name: Last name of the admin.
        :param pulumi.Input[_builtins.str] phone: Phone number of the admin.
        """
...
class KeyRotationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] notify_before_expiry: Notify at a given duration before expiry as an [ISO 8601 duration](https://en.wikipedia.org/wiki/ISO_8601#Durations).
        """
...
class KeyVaultAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] application_id: The object ID of an Application in Azure Active Directory.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] key_permissions: List of key permissions. Possible values are `Backup`, `Create`, `Decrypt`, `Delete`, `Encrypt`, `Get`, `Import`, `List`, `Purge`, `Recover`, `Restore`, `Sign`, `UnwrapKey`, `Update`, `Verify`, `WrapKey`, `Release`, `Rotate`, `GetRotationPolicy` and `SetRotationPolicy`.
...
class KeyVaultNetworkAclsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_rules: One or more IP Addresses, or CIDR Blocks which should be able to access the Key Vault.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] virtual_network_subnet_ids: One or more Subnet IDs which should be able to access this Key Vault.
        """
...
class ManagedHardwareSecurityModuleNetworkAclsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] bypass: Specifies which traffic can bypass the network rules. Possible values are `AzureServices` and `None`.
        :param pulumi.Input[_builtins.str] default_action: The Default Action to use. Possible values are `Allow` and `Deny`.
        """
        pulumi.set(__self__, "bypass", bypass)
        pulumi.set(__self__, "default_action", default_action)
...
class ManagedHardwareSecurityModuleRoleDefinitionPermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] not_data_actions: Specifies a list of data action permission not to grant. Possible values are `Microsoft.KeyVault/managedHsm/keys/read/action`, `Microsoft.KeyVault/managedHsm/keys/write/action`, `Microsoft.KeyVault/managedHsm/keys/deletedKeys/read/action`, `Microsoft.KeyVault/managedHsm/keys/deletedKeys/recover/action`, `Microsoft.KeyVault/managedHsm/keys/backup/action`, `Microsoft.KeyVault/managedHsm/keys/restore/action`, `Microsoft.KeyVault/managedHsm/roleAssignments/delete/action`, `Microsoft.KeyVault/managedHsm/roleAssignments/read/action`, `Microsoft.KeyVault/managedHsm/roleAssignments/write/action`, `Microsoft.KeyVault/managedHsm/roleDefinitions/read/action`, `Microsoft.KeyVault/managedHsm/roleDefinitions/write/action`, `Microsoft.KeyVault/managedHsm/roleDefinitions/delete/action`, `Microsoft.KeyVault/managedHsm/keys/encrypt/action`, `Microsoft.KeyVault/managedHsm/keys/decrypt/action`, `Microsoft.KeyVault/managedHsm/keys/wrap/action`, `Microsoft.KeyVault/managedHsm/keys/unwrap/action`, `Microsoft.KeyVault/managedHsm/keys/sign/action`, `Microsoft.KeyVault/managedHsm/keys/verify/action`, `Microsoft.KeyVault/managedHsm/keys/create`, `Microsoft.KeyVault/managedHsm/keys/delete`, `Microsoft.KeyVault/managedHsm/keys/export/action`, `Microsoft.KeyVault/managedHsm/keys/release/action`, `Microsoft.KeyVault/managedHsm/keys/import/action`, `Microsoft.KeyVault/managedHsm/keys/deletedKeys/delete`, `Microsoft.KeyVault/managedHsm/securitydomain/download/action`, `Microsoft.KeyVault/managedHsm/securitydomain/download/read`, `Microsoft.KeyVault/managedHsm/securitydomain/upload/action`, `Microsoft.KeyVault/managedHsm/securitydomain/upload/read`, `Microsoft.KeyVault/managedHsm/securitydomain/transferkey/read`, `Microsoft.KeyVault/managedHsm/backup/start/action`, `Microsoft.KeyVault/managedHsm/restore/start/action`, `Microsoft.KeyVault/managedHsm/backup/status/action`, `Microsoft.KeyVault/managedHsm/restore/status/action` and `Microsoft.KeyVault/managedHsm/rng/action`.
        """
