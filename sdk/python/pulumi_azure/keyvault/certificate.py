...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            certificate = _utilities.configure(certificate, CertificateCertificateArgs, True)
            __props__.__dict__["certificate"] = certificate
            certificate_policy = _utilities.configure(certificate_policy, CertificateCertificatePolicyArgs, True)
