...
class Certificate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if certificate is not None and not isinstance(certificate, CertificateCertificateArgs):
                certificate = certificate or {}
                def _setter(key, value):
                    certificate[key] = value
                CertificateCertificateArgs._configure(_setter, **certificate)
            __props__.__dict__["certificate"] = certificate
            if certificate_policy is not None and not isinstance(certificate_policy, CertificateCertificatePolicyArgs):
                certificate_policy = certificate_policy or {}
                def _setter(key, value):
                    certificate_policy[key] = value
                CertificateCertificatePolicyArgs._configure(_setter, **certificate_policy)
