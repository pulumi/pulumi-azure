...
class GetManagedHardwareSecurityModuleKeyResult:
    ...
    def versioned_id(self) -> _builtins.str:
        """
...
def get_managed_hardware_security_module_key(managed_hsm_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str managed_hsm_id: Specifies the ID of the Managed Hardware Security Module instance where the Secret resides, available on the `keyvault.ManagedHardwareSecurityModuleKey` Data Source / Resource.
    ...
    :param _builtins.str name: Specifies the name of the Managed Hardware Security Module Key.
    """
    __args__ = dict()
