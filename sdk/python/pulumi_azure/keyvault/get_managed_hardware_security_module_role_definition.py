...
def get_managed_hardware_security_module_role_definition(managed_hsm_id: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_hsm_id: The ID of the Key Vault Managed Hardware Security Module.
    :param builtins.str name: The name in UUID notation of this Key Vault Managed Hardware Security Module Role Definition.
    """
    __args__ = dict()
...
def get_managed_hardware_security_module_role_definition_output(managed_hsm_id: Optional[pulumi.Input[builtins.str]] = None,
