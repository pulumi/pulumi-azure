...
class GetCertificatesResult:
    ...
    def include_pending(self) -> Optional[builtins.bool]:
...
def get_certificates(include_pending: Optional[builtins.bool] = None,
    ...
    :param builtins.bool include_pending: Specifies whether to include certificates which are not completely provisioned. Defaults to true.
    :param builtins.str key_vault_id: Specifies the ID of the Key Vault instance to fetch certificate names from, available on the `keyvault.KeyVault` Data Source / Resource.
...
def get_certificates_output(include_pending: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
