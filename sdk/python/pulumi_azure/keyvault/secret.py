...
class SecretArgs:
    def __init__(__self__, *,
                 ...
                 value_wo_version: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Secret resource.
        :param pulumi.Input[builtins.str] key_vault_id: The ID of the Key Vault where the Secret should be created. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] content_type: Specifies the content type for the Key Vault Secret.
        :param pulumi.Input[builtins.str] expiration_date: Expiration UTC datetime (Y-m-d'T'H:M:S'Z').
        :param pulumi.Input[builtins.str] name: Specifies the name of the Key Vault Secret. Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[builtins.str] value: Specifies the value of the Key Vault Secret. Changing this will create a new version of the Key Vault Secret.
        :param pulumi.Input[builtins.int] value_wo_version: An integer value used to trigger an update for `value_wo`. This property should be incremented when updating `value_wo`.
    ...
    def value_wo_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def value_wo_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _SecretState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the Key Vault Secret. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] not_before_date: Key not usable before the provided UTC datetime (Y-m-d'T'H:M:S'Z').
        :param pulumi.Input[builtins.str] resource_id: The (Versioned) ID for this Key Vault Secret. This property points to a specific version of a Key Vault Secret, as such using this won't auto-rotate values if used in other Azure Services.
        :param pulumi.Input[builtins.str] resource_versionless_id: The Versionless ID of the Key Vault Secret. This property allows other Azure Services (that support it) to auto-rotate their value when the Key Vault Secret is updated.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[builtins.str] value: Specifies the value of the Key Vault Secret. Changing this will create a new version of the Key Vault Secret.
        :param pulumi.Input[builtins.int] value_wo_version: An integer value used to trigger an update for `value_wo`. This property should be incremented when updating `value_wo`.
               
               > **Note:** Key Vault strips newlines. To preserve newlines in multi-line secrets try replacing them with `\\n` or by base 64 encoding them with `replace(file("my_secret_file"), "/\\n/", "\\n")` or `base64encode(file("my_secret_file"))`, respectively.
        :param pulumi.Input[builtins.str] version: The current version of the Key Vault Secret.
        :param pulumi.Input[builtins.str] versionless_id: The Base ID of the Key Vault Secret.
        """
        if content_type is not None:
            pulumi.set(__self__, "content_type", content_type)
        if expiration_date is not None:
...
class Secret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            value_wo_version: Optional[pulumi.Input[builtins.int]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None,
            versionless_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Secret':
        """
    ...
    @property
    @pulumi.getter(name="valueWoVersion")
    def value_wo_version(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        An integer value used to trigger an update for `value_wo`. This property should be incremented when updating `value_wo`.
