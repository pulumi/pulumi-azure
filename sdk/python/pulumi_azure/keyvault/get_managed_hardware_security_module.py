...
class GetManagedHardwareSecurityModuleResult:
    ...
    def admin_object_ids(self) -> Sequence[builtins.str]:
        """
...
def get_managed_hardware_security_module(name: Optional[builtins.str] = None,
...
def get_managed_hardware_security_module_output(name: Optional[pulumi.Input[builtins.str]] = None,
