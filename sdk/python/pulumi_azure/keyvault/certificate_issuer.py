...
class CertificateIssuerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_vault_id: The ID of the Key Vault in which to create the Certificate Issuer. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] provider_name: The name of the third-party Certificate Issuer. Possible values are: `DigiCert`, `GlobalSign`, `OneCertV2-PrivateCA`, `OneCertV2-PublicCA` and `SslAdminV2`.
        :param pulumi.Input[builtins.str] account_id: The account number with the third-party Certificate Issuer.
        :param pulumi.Input[Sequence[pulumi.Input['CertificateIssuerAdminArgs']]] admins: One or more `admin` blocks as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Key Vault Certificate Issuer. Changing this forces a new Key Vault Certificate Issuer to be created.
        :param pulumi.Input[builtins.str] org_id: The ID of the organization as provided to the issuer.
        :param pulumi.Input[builtins.str] password: The password associated with the account and organization ID at the third-party Certificate Issuer. If not specified, will not overwrite any previous value.
        """
...
@pulumi.type_token("azure:keyvault/certificateIssuer:CertificateIssuer")
class CertificateIssuer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            org_id: Optional[pulumi.Input[builtins.str]] = None,
            password: Optional[pulumi.Input[builtins.str]] = None,
            provider_name: Optional[pulumi.Input[builtins.str]] = None) -> 'CertificateIssuer':
        """
