...
def get_certificate_issuer(key_vault_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key_vault_id: The ID of the Key Vault in which to locate the Certificate Issuer.
    :param _builtins.str name: The name of the Key Vault Certificate Issuer.
    """
    __args__ = dict()
