...
class StreamingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_content_key_policy = azure.media.content_key_policy.ContentKeyPolicy("example",
            name=example,
            resource_group_name=example.name,
        ...
        example_streaming_policy = azure.media.streaming_policy.StreamingPolicy("example",
            name=Policy-1,
            resource_group_name=example.name,
            media_services_account_name=example_service_account.name,
