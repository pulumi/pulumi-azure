...
class ServerArgs:
    def __init__(__self__, *,
                 ...
                 power_bi_service_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 querypool_connection_mode: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Server resource.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the Analysis Services Server should be exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] sku: SKU for the Analysis Services Server. Possible values are: `D1`, `B1`, `B2`, `S0`, `S1`, `S2`, `S4`, `S8`, `S9`, `S8v2` and `S9v2`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] admin_users: List of email addresses of admin users.
        :param pulumi.Input[builtins.str] backup_blob_container_uri: URI and SAS token for a blob container to store backups.
        ...
        :param pulumi.Input[builtins.str] location: The Azure location where the Analysis Services Server exists. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name of the Analysis Services Server. Only lowercase Alphanumeric characters allowed, starting with a letter. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.bool] power_bi_service_enabled: Indicates if the Power BI service is allowed to access or not.
        :param pulumi.Input[builtins.str] querypool_connection_mode: Controls how the read-write server is used in the query pool. If this value is set to `All` then read-write servers are also used for queries. Otherwise with `ReadOnly` these servers do not participate in query operations. Defaults to `All`.
    ...
    def power_bi_service_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def power_bi_service_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "power_bi_service_enabled", value)

    @property
    @pulumi.getter(name="querypoolConnectionMode")
    def querypool_connection_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def querypool_connection_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ServerState:
    def __init__(__self__, *,
                 ...
                 server_full_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] querypool_connection_mode: Controls how the read-write server is used in the query pool. If this value is set to `All` then read-write servers are also used for queries. Otherwise with `ReadOnly` these servers do not participate in query operations. Defaults to `All`.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group in which the Analysis Services Server should be exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] server_full_name: The full name of the Analysis Services Server.
        :param pulumi.Input[builtins.str] sku: SKU for the Analysis Services Server. Possible values are: `D1`, `B1`, `B2`, `S0`, `S1`, `S2`, `S4`, `S8`, `S9`, `S8v2` and `S9v2`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags to assign to the resource.
        """
        if admin_users is not None:
    ...
    def server_full_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_full_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Server(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            server_full_name: Optional[pulumi.Input[builtins.str]] = None,
            sku: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Server':
        """
    ...
    @property
    @pulumi.getter(name="adminUsers")
    def admin_users(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of email addresses of admin users.
        """
        return pulumi.get(self, "admin_users")
    ...
    @property
    @pulumi.getter(name="powerBiServiceEnabled")
    def power_bi_service_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates if the Power BI service is allowed to access or not.
        """
        return pulumi.get(self, "power_bi_service_enabled")
