...
if not MYPY:
    class ServerIpv4FirewallRuleArgsDict(TypedDict):
        ...
        """
        range_end: pulumi.Input[builtins.str]
        """
        End of the firewall rule range as IPv4 address.
        """
        range_start: pulumi.Input[builtins.str]
        """
...
class ServerIpv4FirewallRuleArgs:
    def __init__(__self__, *,
                 ...
                 range_start: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Specifies the name of the firewall rule.
        :param pulumi.Input[builtins.str] range_end: End of the firewall rule range as IPv4 address.
        :param pulumi.Input[builtins.str] range_start: Start of the firewall rule range as IPv4 address.
        """
    ...
    def range_end(self) -> pulumi.Input[builtins.str]:
        """
        End of the firewall rule range as IPv4 address.
        """
    ...
    @range_end.setter
    def range_end(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "range_end", value)

    @property
    @pulumi.getter(name="rangeStart")
    def range_start(self) -> pulumi.Input[builtins.str]:
        """
        Start of the firewall rule range as IPv4 address.
        """
    ...
    @range_start.setter
    def range_start(self, value: pulumi.Input[builtins.str]):
