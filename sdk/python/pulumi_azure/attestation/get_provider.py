...
class GetProviderResult:
    ...
    def attestation_uri(self) -> _builtins.str:
        """
    ...
    def trust_model(self) -> _builtins.str:
        """
...
def get_provider(name: Optional[_builtins.str] = None,
...
def get_provider_output(name: Optional[pulumi.Input[_builtins.str]] = None,
