...
class ProviderArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] open_enclave_policy_base64: Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        :param pulumi.Input[_builtins.str] policy_signing_certificate_data: A valid X.509 certificate (Section 4 of [RFC4648](https://tools.ietf.org/html/rfc4648)). Changing this forces a new resource to be created.
        ...
        :param pulumi.Input[_builtins.str] sev_snp_policy_base64: Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        ...
        :param pulumi.Input[_builtins.str] sgx_enclave_policy_base64: Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Attestation Provider.
        :param pulumi.Input[_builtins.str] tpm_policy_base64: Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        """
...
class _ProviderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags which should be assigned to the Attestation Provider.
        :param pulumi.Input[_builtins.str] tpm_policy_base64: Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        :param pulumi.Input[_builtins.str] trust_model: Trust model used for the Attestation Service.
        """
...
class Provider(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="attestationUri")
    def attestation_uri(self) -> pulumi.Output[_builtins.str]:
        """
        The URI of the Attestation Service.
        """
        return pulumi.get(self, "attestation_uri")
    ...
    @_builtins.property
    @pulumi.getter(name="openEnclavePolicyBase64")
    def open_enclave_policy_base64(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        """
        return pulumi.get(self, "open_enclave_policy_base64")
    ...
    @_builtins.property
    @pulumi.getter(name="policySigningCertificateData")
    def policy_signing_certificate_data(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        A valid X.509 certificate (Section 4 of [RFC4648](https://tools.ietf.org/html/rfc4648)). Changing this forces a new resource to be created.
    ...
    @_builtins.property
    @pulumi.getter(name="sevSnpPolicyBase64")
    def sev_snp_policy_base64(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
    ...
    @_builtins.property
    @pulumi.getter(name="sgxEnclavePolicyBase64")
    def sgx_enclave_policy_base64(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        """
        return pulumi.get(self, "sgx_enclave_policy_base64")
    ...
    @_builtins.property
    @pulumi.getter(name="tpmPolicyBase64")
    def tpm_policy_base64(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Specifies the base64 URI Encoded RFC 7519 JWT that should be used for the Attestation Policy.
        """
        return pulumi.get(self, "tpm_policy_base64")
    ...
    @_builtins.property
    @pulumi.getter(name="trustModel")
    def trust_model(self) -> pulumi.Output[_builtins.str]:
        """
        Trust model used for the Attestation Service.
        """
        return pulumi.get(self, "trust_model")
