...
class LicationLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        """
        LicationLoadBalancerArgs._configure(
...
class _LicationLoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: A mapping of tags which should be assigned to the Application Gateway for Containers (ALB).
        """
        _LicationLoadBalancerState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            location=location,
            name=name,
            primary_configuration_endpoint=primary_configuration_endpoint,
            resource_group_name=resource_group_name,
            tags=tags,
        )
    @staticmethod
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if primary_configuration_endpoint is None and 'primaryConfigurationEndpoint' in kwargs:
            primary_configuration_endpoint = kwargs['primaryConfigurationEndpoint']
        if resource_group_name is None and 'resourceGroupName' in kwargs:
            resource_group_name = kwargs['resourceGroupName']
        ...
        if primary_configuration_endpoint is not None:
            _setter("primary_configuration_endpoint", primary_configuration_endpoint)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            LicationLoadBalancerArgs._configure(_setter, **kwargs)
