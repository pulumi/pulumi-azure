...
class LicationLoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of Resource Group where the Application Gateway for Containers (ALB) should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] location: The Azure Region where the Application Gateway for Containers (ALB) should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Application Gateway for Containers (ALB). Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Application Gateway for Containers (ALB).
        """
...
class _LicationLoadBalancerState:
    def __init__(__self__, *,
                 location: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 primary_configuration_endpoint: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] location: The Azure Region where the Application Gateway for Containers (ALB) should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] name: The name which should be used for this Application Gateway for Containers (ALB). Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] primary_configuration_endpoint: The primary configuration endpoints of the Application Gateway for Containers (ALB).
        :param pulumi.Input[builtins.str] resource_group_name: The name of Resource Group where the Application Gateway for Containers (ALB) should exist. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Application Gateway for Containers (ALB).
        """
        if location is not None:
    ...
    def primary_configuration_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_configuration_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LicationLoadBalancer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            primary_configuration_endpoint: Optional[pulumi.Input[builtins.str]] = None,
            resource_group_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'LicationLoadBalancer':
        """
    ...
    @property
    @pulumi.getter(name="primaryConfigurationEndpoint")
    def primary_configuration_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The primary configuration endpoints of the Application Gateway for Containers (ALB).
        """
        return pulumi.get(self, "primary_configuration_endpoint")
