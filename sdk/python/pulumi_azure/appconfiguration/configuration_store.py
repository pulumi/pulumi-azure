...
class ConfigurationStoreArgs:
    def __init__(__self__, *,
                 ...
                 data_plane_proxy_authentication_mode: Optional[pulumi.Input[builtins.str]] = None,
                 data_plane_proxy_private_link_delegation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group_name: The name of the resource group in which to create the App Configuration. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] data_plane_proxy_authentication_mode: The data plane proxy authentication mode. Possible values are `Local` and `Pass-through`. Defaults to `Local`.
        :param pulumi.Input[builtins.bool] data_plane_proxy_private_link_delegation_enabled: Whether data plane proxy private link delegation is enabled. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.bool] local_auth_enabled: Whether local authentication methods is enabled. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the App Configuration. Changing this forces a new resource to be created.
        :param pulumi.Input[builtins.str] public_network_access: The Public Network Access setting of the App Configuration. Possible values are `Enabled` and `Disabled`.
        ...
        :param pulumi.Input[builtins.bool] purge_protection_enabled: Whether Purge Protection is enabled. This field only works for `standard` sku. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] sku: The SKU name of the App Configuration. Possible values are `free`, `developer`, `standard` and `premium`. Defaults to `free`.
        ...
        :param pulumi.Input[builtins.int] soft_delete_retention_days: The number of days that items should be retained for once soft-deleted. This field only works for `standard` sku. This value can be between `1` and `7` days. Defaults to `7`. Changing this forces a new resource to be created.
    ...
    def data_plane_proxy_authentication_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_plane_proxy_authentication_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_plane_proxy_authentication_mode", value)

    @property
    @pulumi.getter(name="dataPlaneProxyPrivateLinkDelegationEnabled")
    def data_plane_proxy_private_link_delegation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def data_plane_proxy_private_link_delegation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ConfigurationStore(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sku: Optional[pulumi.Input[builtins.str]] = None,
            soft_delete_retention_days: Optional[pulumi.Input[builtins.int]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ConfigurationStore':
        """
    ...
    @property
    @pulumi.getter(name="dataPlaneProxyAuthenticationMode")
    def data_plane_proxy_authentication_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The data plane proxy authentication mode. Possible values are `Local` and `Pass-through`. Defaults to `Local`.
        """
        return pulumi.get(self, "data_plane_proxy_authentication_mode")
    ...
    @property
    @pulumi.getter(name="dataPlaneProxyPrivateLinkDelegationEnabled")
    def data_plane_proxy_private_link_delegation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether data plane proxy private link delegation is enabled. Defaults to `false`.
