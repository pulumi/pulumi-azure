...
class LicationLoadBalancerSubnetAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet which the Application Gateway for Containers associated to.
        ...
        :param pulumi.Input[builtins.str] name: The name which should be used for this Application Gateway for Containers Association. Changing this forces a new resource to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the Application Gateway for Containers Association.
        """
...
class LicationLoadBalancerSubnetAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'LicationLoadBalancerSubnetAssociation':
        """
