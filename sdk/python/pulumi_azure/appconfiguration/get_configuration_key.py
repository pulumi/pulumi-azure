...
def get_configuration_key(configuration_store_id: Optional[builtins.str] = None,
    ...
    :param builtins.str key: The name of the App Configuration Key.
    :param builtins.str label: The label of the App Configuration Key.
    """
    __args__ = dict()
...
def get_configuration_key_output(configuration_store_id: Optional[pulumi.Input[builtins.str]] = None,
