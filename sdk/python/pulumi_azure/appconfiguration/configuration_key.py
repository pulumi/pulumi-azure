...
class ConfigurationKeyArgs:
    def __init__(__self__, *,
                 ...
                 vault_key_reference: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] label: The label of the App Configuration Key. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.bool] locked: Should this App Configuration Key be Locked to prevent changes?
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A mapping of tags to assign to the resource.
        :param pulumi.Input[_builtins.str] type: The type of the App Configuration Key. It can either be `kv` (simple [key/value](https://docs.microsoft.com/azure/azure-app-configuration/concept-key-value)) or `vault` (where the value is a reference to a [Key Vault Secret](https://azure.microsoft.com/en-gb/services/key-vault/). Defaults to `kv`.
        :param pulumi.Input[_builtins.str] value: The value of the App Configuration Key. This should only be set when type is set to `kv`.
               
               > **Note:** `value` and `vault_key_reference` are mutually exclusive.
        :param pulumi.Input[_builtins.str] vault_key_reference: The ID of the vault secret this App Configuration Key refers to. This should only be set when `type` is set to `vault`.
    ...
    def vault_key_reference(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def vault_key_reference(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ConfigurationKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: pulumi.Input[Optional[_builtins.str]] = None,
            value: pulumi.Input[Optional[_builtins.str]] = None,
            vault_key_reference: pulumi.Input[Optional[_builtins.str]] = None) -> 'ConfigurationKey':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="vaultKeyReference")
    def vault_key_reference(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the vault secret this App Configuration Key refers to. This should only be set when `type` is set to `vault`.
