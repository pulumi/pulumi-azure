...
class GetConfigurationStoreResult:
    ...
    def data_plane_proxy_authentication_mode(self) -> _builtins.str:
        """
    ...
    def data_plane_proxy_private_link_delegation_enabled(self) -> _builtins.bool:
        """
    ...
    def soft_delete_retention_days(self) -> _builtins.int:
        """
...
def get_configuration_store(name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.AppConfiguration` - 2024-05-01
    ...
    :param _builtins.str resource_group_name: The name of the Resource Group where the App Configuration exists.
    """
    __args__ = dict()
    __args__['name'] = name
