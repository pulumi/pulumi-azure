...
class ConfigurationFeatureTargetingFilter(dict):
    ...
    def default_rollout_percentage(self) -> _builtins.int:
        """
...
class ConfigurationFeatureTargetingFilterGroup(dict):
    ...
    def __init__(__self__, *,
                 name: _builtins.str,
                 rollout_percentage: _builtins.int):
        """
        :param _builtins.str name: The name of the group.
        :param _builtins.int rollout_percentage: Rollout percentage of the group.
        """
...
class ConfigurationFeatureTimewindowFilter(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str end: The latest timestamp the feature is enabled. The timestamp must be in RFC3339 format.
        :param _builtins.str start: The earliest timestamp the feature is enabled. The timestamp must be in RFC3339 format.
        """
        if end is not None:
...
class ConfigurationStoreEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_vault_key_identifier: Optional[_builtins.str] = None):
        """
        :param _builtins.str identity_client_id: Specifies the client ID of the identity which will be used to access key vault.
        :param _builtins.str key_vault_key_identifier: Specifies the URI of the key vault key used to encrypt data.
        """
    ...
    def key_vault_key_identifier(self) -> Optional[_builtins.str]:
        """
...
class ConfigurationStoreIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: Specifies the type of Managed Service Identity that should be configured on this App Configuration. Possible values are `SystemAssigned`, `UserAssigned`, and `SystemAssigned, UserAssigned` (to enable both).
...
class ConfigurationStorePrimaryReadKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str connection_string: The Connection String for this Access Key - consisting of the Endpoint, ID, and Secret.
        :param _builtins.str id: The ID of the Access Key.
        :param _builtins.str secret: The Secret of the Access Key.
        """
...
class ConfigurationStoreReplica(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[_builtins.str] = None):
        """
        :param _builtins.str location: Specifies the supported Azure location where the replica exists.
        :param _builtins.str name: Specifies the name of the replica.
        :param _builtins.str endpoint: The URL of the App Configuration Replica.
        :param _builtins.str id: The ID of the Access Key.
        """
...
class GetConfigurationKeysItemResult(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.str,
                 value: _builtins.str,
                 vault_key_reference: _builtins.str):
        """
        :param _builtins.str content_type: The content type of the App Configuration Key.
        :param _builtins.str etag: The ETag of the key.
        ...
        :param _builtins.bool locked: Is this App Configuration Key be Locked to prevent changes.
        :param Mapping[str, _builtins.str] tags: A mapping of tags assigned to the resource.
        :param _builtins.str type: The type of the App Configuration Key. It can either be `kv` (simple [key/value](https://docs.microsoft.com/azure/azure-app-configuration/concept-key-value)) or `vault` (where the value is a reference to a [Key Vault Secret](https://azure.microsoft.com/en-gb/services/key-vault/).
        :param _builtins.str value: The value of the App Configuration Key.
        :param _builtins.str vault_key_reference: The ID of the vault secret this App Configuration Key refers to, when `type` is `vault`.
        """
...
class GetConfigurationStoreEncryptionResult(dict):
    def __init__(__self__, *,
                 ...
                 key_vault_key_identifier: _builtins.str):
        pulumi.set(__self__, "identity_client_id", identity_client_id)
        pulumi.set(__self__, "key_vault_key_identifier", key_vault_key_identifier)
    ...
    @_builtins.property
    @pulumi.getter(name="keyVaultKeyIdentifier")
    def key_vault_key_identifier(self) -> _builtins.str:
        return pulumi.get(self, "key_vault_key_identifier")
...
class GetConfigurationStoreReplicaResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str endpoint: The URL of the App Configuration Replica.
        :param _builtins.str id: The ID of the Access Key.
        :param _builtins.str location: The supported Azure location where the App Configuration Replica exists.
