...
def get_configuration_keys(configuration_store_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key: The name of the App Configuration Keys to look up.
    :param _builtins.str label: The label of the App Configuration Keys tp look up.
    """
    __args__ = dict()
