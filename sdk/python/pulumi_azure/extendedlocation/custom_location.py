...
class CustomLocationArgs:
    def __init__(__self__, *,
                 cluster_extension_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
    ...
    def cluster_extension_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def cluster_extension_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    def host_resource_id(self, value: pulumi.Input[_builtins.str]):
...
class CustomLocation(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="clusterExtensionIds")
    def cluster_extension_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        Specifies the list of Cluster Extension IDs.
        """
        return pulumi.get(self, "cluster_extension_ids")
