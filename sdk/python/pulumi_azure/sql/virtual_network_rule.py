...
class VirtualNetworkRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        vnet = azure.network.virtual_network.VirtualNetwork("vnet",
            name=example-vnet,
            address_spaces=[10.7.29.0/29],
            location=example.location,
            resource_group_name=example.name)
        subnet = azure.network.subnet.Subnet("subnet",
            name=example-subnet,
            resource_group_name=example.name,
            virtual_network_name=vnet.name,
            address_prefixes=[10.7.29.0/29],
            service_endpoints=[Microsoft.Sql])
        sqlserver = azure.sql.sql_server.SqlServer("sqlserver",
        ...
        sqlvnetrule = azure.sql.virtual_network_rule.VirtualNetworkRule("sqlvnetrule",
            name=sql-vnet-rule,
            resource_group_name=example.name,
