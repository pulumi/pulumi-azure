...
class GetManagementGroupResult:
    ...
    def all_management_group_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    def all_subscription_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    def management_group_ids(self) -> Sequence[_builtins.str]:
        """
    ...
    def parent_management_group_id(self) -> _builtins.str:
        """
    ...
    def tenant_scoped_id(self) -> _builtins.str:
        """
...
def get_management_group(display_name: Optional[_builtins.str] = None,
    ...
    * `Microsoft.Management` - 2020-05-01
    ...
    :param _builtins.str name: Specifies the name or UUID of this Management Group.
    """
...
def get_management_group_output(display_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
