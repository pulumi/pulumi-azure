...
def get_agreement(offer: Optional[builtins.str] = None,
    ...
    * `Microsoft.MarketplaceOrdering`: 2015-06-01
    ...
    :param builtins.str publisher: The Publisher of the Marketplace Image.
    """
    __args__ = dict()
...
def get_agreement_output(offer: Optional[pulumi.Input[builtins.str]] = None,
