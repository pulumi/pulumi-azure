...
class HubArgs:
    def __init__(__self__, *,
                 ...
                 high_business_impact_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] key_vault_id: The Key Vault ID that should be used by this AI Foundry Hub. Changing this forces a new AI Foundry Hub to be created.
        :param pulumi.Input[builtins.str] resource_group_name: The name of the Resource Group where the AI Foundry Hub should exist. Changing this forces a new AI Foundry Hub to be created.
        :param pulumi.Input[builtins.str] storage_account_id: The Storage Account ID that should be used by this AI Foundry Hub. Changing this forces a new AI Foundry Hub to be created.
        :param pulumi.Input[builtins.str] application_insights_id: The Application Insights ID that should be used by this AI Foundry Hub.
        :param pulumi.Input[builtins.str] container_registry_id: The Container Registry ID that should be used by this AI Foundry Hub.
        :param pulumi.Input[builtins.str] description: The description of this AI Foundry Hub.
        ...
        :param pulumi.Input[builtins.str] friendly_name: The display name of this AI Foundry Hub.
        :param pulumi.Input[builtins.bool] high_business_impact_enabled: Whether High Business Impact (HBI) should be enabled or not. Enabling this setting will reduce diagnostic data collected by the service. Changing this forces a new AI Foundry Hub to be created. Defaults to `false`.
               
               > **Note:** `high_business_impact_enabled` will be enabled by default when creating an AI Foundry Hub with `encryption` enabled.
        :param pulumi.Input[builtins.str] location: The Azure Region where the AI Foundry Hub should exist. Changing this forces a new AI Foundry Hub to be created.
        :param pulumi.Input['HubManagedNetworkArgs'] managed_network: A `managed_network` block as defined below.
        :param pulumi.Input[builtins.str] name: The name which should be used for this AI Foundry Hub. Changing this forces a new AI Foundry Hub to be created.
        ...
        :param pulumi.Input[builtins.str] public_network_access: Whether public network access for this AI Service Hub should be enabled. Possible values include `Enabled` and `Disabled`. Defaults to `Enabled`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the AI Foundry Hub.
        """
    ...
    def high_business_impact_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def high_business_impact_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _HubState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] container_registry_id: The Container Registry ID that should be used by this AI Foundry Hub.
        :param pulumi.Input[builtins.str] description: The description of this AI Foundry Hub.
        :param pulumi.Input[builtins.str] discovery_url: The URL for the discovery service to identify regional endpoints for AI Foundry Hub services.
        :param pulumi.Input['HubEncryptionArgs'] encryption: An `encryption` block as defined below. Changing this forces a new AI Foundry Hub to be created.
        :param pulumi.Input[builtins.str] friendly_name: The display name of this AI Foundry Hub.
        :param pulumi.Input[builtins.bool] high_business_impact_enabled: Whether High Business Impact (HBI) should be enabled or not. Enabling this setting will reduce diagnostic data collected by the service. Changing this forces a new AI Foundry Hub to be created. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] storage_account_id: The Storage Account ID that should be used by this AI Foundry Hub. Changing this forces a new AI Foundry Hub to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A mapping of tags which should be assigned to the AI Foundry Hub.
        :param pulumi.Input[builtins.str] workspace_id: The immutable ID associated with this AI Foundry Hub.
        """
        if application_insights_id is not None:
            pulumi.set(__self__, "application_insights_id", application_insights_id)
        if container_registry_id is not None:
...
class Hub(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            storage_account_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Hub':
        """
    ...
    @property
    @pulumi.getter(name="applicationInsightsId")
    def application_insights_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Application Insights ID that should be used by this AI Foundry Hub.
        """
        return pulumi.get(self, "application_insights_id")
    ...
    @property
    @pulumi.getter(name="containerRegistryId")
    def container_registry_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Container Registry ID that should be used by this AI Foundry Hub.
        """
        return pulumi.get(self, "container_registry_id")
    ...
    @property
    @pulumi.getter(name="highBusinessImpactEnabled")
    def high_business_impact_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether High Business Impact (HBI) should be enabled or not. Enabling this setting will reduce diagnostic data collected by the service. Changing this forces a new AI Foundry Hub to be created. Defaults to `false`.
