...
public final class WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args Empty = new WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args();
    ...
    private WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args() {}

    private WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args(WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args", "clientId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args", "name");
            }
            if ($.openidConfigurationEndpoint == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2CustomOidcV2Args", "openidConfigurationEndpoint");
            }
            return $;
        }
    }
