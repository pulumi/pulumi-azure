...
public final class SrvRecordState extends com.pulumi.resources.ResourceArgs {

    public static final SrvRecordState Empty = new SrvRecordState();
     ...
     */
    @Import(name="records")
    private @Nullable Output<List<SrvRecordRecordArgs>> records;

    /**
     * @return A list of values that make up the SRV record. Each `record` block supports fields documented below.
     * 
     */
    public Optional<Output<List<SrvRecordRecordArgs>>> records() {
    ...
    private SrvRecordState() {}

    private SrvRecordState(SrvRecordState $) {
        this.fqdn = $.fqdn;
        this.name = $.name;
    ...
    public static Builder builder(SrvRecordState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SrvRecordState defaults) {
            $ = new SrvRecordState(Objects.requireNonNull(defaults));
        }

        /**
         * @param fqdn The FQDN of the DNS SRV Record.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder records(@Nullable Output<List<SrvRecordRecordArgs>> records) {
            $.records = records;
            return this;
        }
