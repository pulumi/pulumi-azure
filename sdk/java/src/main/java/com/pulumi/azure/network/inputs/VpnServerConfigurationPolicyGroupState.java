...
public final class VpnServerConfigurationPolicyGroupState extends com.pulumi.resources.ResourceArgs {

    public static final VpnServerConfigurationPolicyGroupState Empty = new VpnServerConfigurationPolicyGroupState();
    ...
    private @Nullable Output<List<VpnServerConfigurationPolicyGroupPolicyArgs>> policies;

    /**
     * @return One or more `policy` blocks as documented below.
     * 
     */
    public Optional<Output<List<VpnServerConfigurationPolicyGroupPolicyArgs>>> policies() {
    ...
    private VpnServerConfigurationPolicyGroupState() {}

    private VpnServerConfigurationPolicyGroupState(VpnServerConfigurationPolicyGroupState $) {
    ...
    public static Builder builder(VpnServerConfigurationPolicyGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpnServerConfigurationPolicyGroupState();
        }

        public Builder(VpnServerConfigurationPolicyGroupState defaults) {
            $ = new VpnServerConfigurationPolicyGroupState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder policies(@Nullable Output<List<VpnServerConfigurationPolicyGroupPolicyArgs>> policies) {
            $.policies = policies;
            return this;
        }
        ...
        public VpnServerConfigurationPolicyGroupState build() {
            return $;
        }
    }
