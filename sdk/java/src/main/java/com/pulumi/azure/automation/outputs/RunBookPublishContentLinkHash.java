...
public final class RunBookPublishContentLinkHash {
    ...
    public static final class Builder {
        ...
        public Builder algorithm(String algorithm) {
            if (algorithm == null) {
              throw new MissingRequiredPropertyException("RunBookPublishContentLinkHash", "algorithm");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("RunBookPublishContentLinkHash", "value");
            }
            this.value = value;
            return this;
        }
