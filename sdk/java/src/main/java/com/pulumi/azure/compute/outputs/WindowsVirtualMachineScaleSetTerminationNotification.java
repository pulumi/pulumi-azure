...
public final class WindowsVirtualMachineScaleSetTerminationNotification {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetTerminationNotification", "enabled");
            }
        ...
        public WindowsVirtualMachineScaleSetTerminationNotification build() {
            final var _resultValue = new WindowsVirtualMachineScaleSetTerminationNotification();
