...
@CustomType
public final class ExtensionProtectedSettingsFromKeyVault {
    /**
    ...
    private ExtensionProtectedSettingsFromKeyVault() {}
    /**
     * @return The URL to the Key Vault Secret which stores the protected settings.
     * 
     */
    ...
    public static Builder builder(ExtensionProtectedSettingsFromKeyVault defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceVaultId;
        public Builder() {}
        public Builder(ExtensionProtectedSettingsFromKeyVault defaults) {
        ...
        public Builder secretUrl(String secretUrl) {
            if (secretUrl == null) {
              throw new MissingRequiredPropertyException("ExtensionProtectedSettingsFromKeyVault", "secretUrl");
            }
        ...
        public Builder sourceVaultId(String sourceVaultId) {
            if (sourceVaultId == null) {
              throw new MissingRequiredPropertyException("ExtensionProtectedSettingsFromKeyVault", "sourceVaultId");
            }
