...
@CustomType
public final class DataFlowTransformationFlowlet {
    /**
    ...
    public static Builder builder(DataFlowTransformationFlowlet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> parameters;
        public Builder() {}
        public Builder(DataFlowTransformationFlowlet defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DataFlowTransformationFlowlet", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public DataFlowTransformationFlowlet build() {
            final var _resultValue = new DataFlowTransformationFlowlet();
