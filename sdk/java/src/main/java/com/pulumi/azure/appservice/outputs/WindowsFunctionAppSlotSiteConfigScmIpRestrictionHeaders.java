...
@CustomType
public final class WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders {
    /**
    ...
    public static Builder builder(WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        }        public WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders build() {
            return new WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
