...
@CustomType
public final class WindowsWebAppSiteConfigIpRestrictionHeaders {
    /**
    ...
    private WindowsWebAppSiteConfigIpRestrictionHeaders(
    ...
    public static Builder builder(WindowsWebAppSiteConfigIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsWebAppSiteConfigIpRestrictionHeaders defaults) {
        ...
        }        public WindowsWebAppSiteConfigIpRestrictionHeaders build() {
            return new WindowsWebAppSiteConfigIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
