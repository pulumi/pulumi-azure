...
@CustomType
public final class LinuxFunctionAppAuthSettingsGithub {
    /**
    ...
    private LinuxFunctionAppAuthSettingsGithub() {}
    /**
     * @return The ID of the GitHub app used for login.
     * 
     */
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(LinuxFunctionAppAuthSettingsGithub defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsGithub", "clientId");
            }
        ...
        public LinuxFunctionAppAuthSettingsGithub build() {
            final var _resultValue = new LinuxFunctionAppAuthSettingsGithub();
