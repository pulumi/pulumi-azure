...
import com.pulumi.azure.appservice.outputs.SlotSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class SlotSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable SlotSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private SlotSiteConfigIpRestriction(
        ...
        @CustomType.Parameter("headers") @Nullable SlotSiteConfigIpRestrictionHeaders headers,
    ...
    public static Builder builder(SlotSiteConfigIpRestriction defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SlotSiteConfigIpRestriction defaults) {
        ...
        public Builder headers(@Nullable SlotSiteConfigIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public SlotSiteConfigIpRestriction build() {
            return new SlotSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
