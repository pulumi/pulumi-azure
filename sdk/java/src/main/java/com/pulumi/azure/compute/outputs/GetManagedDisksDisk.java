...
import com.pulumi.azure.compute.outputs.GetManagedDisksDiskEncryptionSetting;
...
@CustomType
public final class GetManagedDisksDisk {
    ...
    public static Builder builder(GetManagedDisksDisk defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> zones;
        public Builder() {}
        public Builder(GetManagedDisksDisk defaults) {
        ...
        public Builder createOption(String createOption) {
            if (createOption == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "createOption");
            }
        ...
        public Builder diskAccessId(String diskAccessId) {
            if (diskAccessId == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "diskAccessId");
            }
        ...
        public Builder diskEncryptionSetId(String diskEncryptionSetId) {
            if (diskEncryptionSetId == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "diskEncryptionSetId");
            }
        ...
        public Builder diskIopsReadWrite(Integer diskIopsReadWrite) {
            if (diskIopsReadWrite == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "diskIopsReadWrite");
            }
        ...
        public Builder diskMbpsReadWrite(Integer diskMbpsReadWrite) {
            if (diskMbpsReadWrite == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "diskMbpsReadWrite");
            }
        ...
        public Builder diskSizeInGb(Integer diskSizeInGb) {
            if (diskSizeInGb == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "diskSizeInGb");
            }
            this.diskSizeInGb = diskSizeInGb;
            return this;
        }
        @CustomType.Setter
        public Builder encryptionSettings(List<GetManagedDisksDiskEncryptionSetting> encryptionSettings) {
            if (encryptionSettings == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "encryptionSettings");
            }
            this.encryptionSettings = encryptionSettings;
            return this;
        }
        public Builder encryptionSettings(GetManagedDisksDiskEncryptionSetting... encryptionSettings) {
            return encryptionSettings(List.of(encryptionSettings));
        }
        @CustomType.Setter
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder imageReferenceId(String imageReferenceId) {
            if (imageReferenceId == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "imageReferenceId");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "location");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder networkAccessPolicy(String networkAccessPolicy) {
            if (networkAccessPolicy == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "networkAccessPolicy");
            }
        ...
        public Builder osType(String osType) {
            if (osType == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "osType");
            }
            this.osType = osType;
            return this;
        }
        ...
        public Builder sourceResourceId(String sourceResourceId) {
            if (sourceResourceId == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "sourceResourceId");
            }
        ...
        public Builder sourceUri(String sourceUri) {
            if (sourceUri == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "sourceUri");
            }
        ...
        public Builder storageAccountId(String storageAccountId) {
            if (storageAccountId == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "storageAccountId");
            }
        ...
        public Builder storageAccountType(String storageAccountType) {
            if (storageAccountType == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "storageAccountType");
            }
        ...
        public Builder tags(Map<String,String> tags) {
            if (tags == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "tags");
            }
            this.tags = tags;
            return this;
        }
        ...
        public Builder zones(List<String> zones) {
            if (zones == null) {
              throw new MissingRequiredPropertyException("GetManagedDisksDisk", "zones");
            }
            this.zones = zones;
            return this;
        }
        ...
        public GetManagedDisksDisk build() {
            final var _resultValue = new GetManagedDisksDisk();
