...
@CustomType
public final class GetStandardSiteConfigIpRestrictionHeader {
    /**
    ...
    private GetStandardSiteConfigIpRestrictionHeader() {}
    /**
     * @return A list of allowed Azure FrontDoor IDs in UUID notation.
     * 
     */
    ...
    public static Builder builder(GetStandardSiteConfigIpRestrictionHeader defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> xForwardedHosts;
        public Builder() {}
        public Builder(GetStandardSiteConfigIpRestrictionHeader defaults) {
        ...
        public Builder xAzureFdids(List<String> xAzureFdids) {
            if (xAzureFdids == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigIpRestrictionHeader", "xAzureFdids");
            }
        ...
        public Builder xFdHealthProbes(List<String> xFdHealthProbes) {
            if (xFdHealthProbes == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigIpRestrictionHeader", "xFdHealthProbes");
            }
        ...
        public Builder xForwardedFors(List<String> xForwardedFors) {
            if (xForwardedFors == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigIpRestrictionHeader", "xForwardedFors");
            }
        ...
        public Builder xForwardedHosts(List<String> xForwardedHosts) {
            if (xForwardedHosts == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigIpRestrictionHeader", "xForwardedHosts");
            }
        ...
        public GetStandardSiteConfigIpRestrictionHeader build() {
            final var _resultValue = new GetStandardSiteConfigIpRestrictionHeader();
