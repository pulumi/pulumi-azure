...
public final class DiagnosticFrontendRequestDataMaskingQueryParam {
    ...
    public static final class Builder {
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("DiagnosticFrontendRequestDataMaskingQueryParam", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DiagnosticFrontendRequestDataMaskingQueryParam", "value");
            }
            this.value = value;
            return this;
        }
