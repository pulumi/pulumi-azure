...
public final class ExpressRouteConnectionState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> expressRouteCircuitPeeringId;
     ...
     * 
     */
    public Optional<Output<String>> expressRouteCircuitPeeringId() {
    ...
    private @Nullable Output<String> expressRouteGatewayId;
     ...
     * 
     */
    public Optional<Output<String>> expressRouteGatewayId() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder expressRouteCircuitPeeringId(@Nullable Output<String> expressRouteCircuitPeeringId) {
         ...
         * 
         */
        public Builder expressRouteGatewayId(@Nullable Output<String> expressRouteGatewayId) {
