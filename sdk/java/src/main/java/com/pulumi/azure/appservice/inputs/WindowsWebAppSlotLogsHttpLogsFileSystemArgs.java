...
public final class WindowsWebAppSlotLogsHttpLogsFileSystemArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotLogsHttpLogsFileSystemArgs Empty = new WindowsWebAppSlotLogsHttpLogsFileSystemArgs();
    ...
    private WindowsWebAppSlotLogsHttpLogsFileSystemArgs() {}

    private WindowsWebAppSlotLogsHttpLogsFileSystemArgs(WindowsWebAppSlotLogsHttpLogsFileSystemArgs $) {
    ...
    public static Builder builder(WindowsWebAppSlotLogsHttpLogsFileSystemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotLogsHttpLogsFileSystemArgs();
        }

        public Builder(WindowsWebAppSlotLogsHttpLogsFileSystemArgs defaults) {
            $ = new WindowsWebAppSlotLogsHttpLogsFileSystemArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotLogsHttpLogsFileSystemArgs build() {
            if ($.retentionInDays == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotLogsHttpLogsFileSystemArgs", "retentionInDays");
            }
            if ($.retentionInMb == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotLogsHttpLogsFileSystemArgs", "retentionInMb");
            }
            return $;
        }
    }
