...
@CustomType
public final class DiagnosticSettingLogRetentionPolicy {
    /**
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("DiagnosticSettingLogRetentionPolicy", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        public DiagnosticSettingLogRetentionPolicy build() {
            final var _resultValue = new DiagnosticSettingLogRetentionPolicy();
