...
public final class AppServiceAuthSettingsGoogleArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppServiceAuthSettingsGoogleArgs Empty = new AppServiceAuthSettingsGoogleArgs();
    ...
    private AppServiceAuthSettingsGoogleArgs() {}

    private AppServiceAuthSettingsGoogleArgs(AppServiceAuthSettingsGoogleArgs $) {
    ...
    public static Builder builder(AppServiceAuthSettingsGoogleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppServiceAuthSettingsGoogleArgs();
        }

        public Builder(AppServiceAuthSettingsGoogleArgs defaults) {
            $ = new AppServiceAuthSettingsGoogleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppServiceAuthSettingsGoogleArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppServiceAuthSettingsGoogleArgs", "clientId");
            }
            if ($.clientSecret == null) {
                throw new MissingRequiredPropertyException("AppServiceAuthSettingsGoogleArgs", "clientSecret");
            }
            return $;
        }
    }
