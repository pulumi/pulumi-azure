...
public final class GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder interval(String interval) {
            if (interval == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode", "interval");
            }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public Builder statusCodeRange(String statusCodeRange) {
            if (statusCodeRange == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode", "statusCodeRange");
            }
        ...
        public Builder subStatus(Integer subStatus) {
            if (subStatus == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode", "subStatus");
            }
        ...
        public Builder win32StatusCode(Integer win32StatusCode) {
            if (win32StatusCode == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigAutoHealSettingTriggerStatusCode", "win32StatusCode");
            }
