...
@CustomType
public final class SubnetIpAddressPool {
    /**
    ...
    public static Builder builder(SubnetIpAddressPool defaults) {
    ...
    public static final class Builder {
        ...
        private String numberOfIpAddresses;
        public Builder() {}
        public Builder(SubnetIpAddressPool defaults) {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("SubnetIpAddressPool", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder numberOfIpAddresses(String numberOfIpAddresses) {
            if (numberOfIpAddresses == null) {
              throw new MissingRequiredPropertyException("SubnetIpAddressPool", "numberOfIpAddresses");
            }
            this.numberOfIpAddresses = numberOfIpAddresses;
            return this;
        }
        public SubnetIpAddressPool build() {
            final var _resultValue = new SubnetIpAddressPool();
