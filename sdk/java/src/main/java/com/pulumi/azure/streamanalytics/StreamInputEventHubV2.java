...
public class StreamInputEventHubV2 extends com.pulumi.resources.CustomResource {
    ...
    private StreamInputEventHubV2(java.lang.String name, Output<java.lang.String> id, @Nullable StreamInputEventHubV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static StreamInputEventHubV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable StreamInputEventHubV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
