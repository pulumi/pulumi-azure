...
public final class LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args() {}

    private LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args(LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args $) {
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
