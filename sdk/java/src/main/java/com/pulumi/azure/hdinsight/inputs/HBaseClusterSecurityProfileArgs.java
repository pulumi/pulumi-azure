...
public final class HBaseClusterSecurityProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final HBaseClusterSecurityProfileArgs Empty = new HBaseClusterSecurityProfileArgs();
    ...
    private HBaseClusterSecurityProfileArgs() {}

    private HBaseClusterSecurityProfileArgs(HBaseClusterSecurityProfileArgs $) {
    ...
    public static Builder builder(HBaseClusterSecurityProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseClusterSecurityProfileArgs();
        }

        public Builder(HBaseClusterSecurityProfileArgs defaults) {
            $ = new HBaseClusterSecurityProfileArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HBaseClusterSecurityProfileArgs build() {
            if ($.aaddsResourceId == null) {
                throw new MissingRequiredPropertyException("HBaseClusterSecurityProfileArgs", "aaddsResourceId");
            }
            if ($.domainName == null) {
                throw new MissingRequiredPropertyException("HBaseClusterSecurityProfileArgs", "domainName");
            }
            if ($.domainUserPassword == null) {
                throw new MissingRequiredPropertyException("HBaseClusterSecurityProfileArgs", "domainUserPassword");
            }
            if ($.domainUsername == null) {
                throw new MissingRequiredPropertyException("HBaseClusterSecurityProfileArgs", "domainUsername");
            }
            if ($.ldapsUrls == null) {
                throw new MissingRequiredPropertyException("HBaseClusterSecurityProfileArgs", "ldapsUrls");
            }
            if ($.msiResourceId == null) {
                throw new MissingRequiredPropertyException("HBaseClusterSecurityProfileArgs", "msiResourceId");
            }
            return $;
        }
    }
