...
public final class WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2MicrosoftV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
