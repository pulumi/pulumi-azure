...
public class LogzSubAccountTagRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public LogzSubAccountTagRule(java.lang.String name) {
     ...
     */
    public LogzSubAccountTagRule(java.lang.String name, LogzSubAccountTagRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LogzSubAccountTagRule(java.lang.String name, LogzSubAccountTagRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:monitoring/logzSubAccountTagRule:LogzSubAccountTagRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LogzSubAccountTagRule(java.lang.String name, Output<java.lang.String> id, @Nullable LogzSubAccountTagRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:monitoring/logzSubAccountTagRule:LogzSubAccountTagRule", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LogzSubAccountTagRule get(java.lang.String name, Output<java.lang.String> id, @Nullable LogzSubAccountTagRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
