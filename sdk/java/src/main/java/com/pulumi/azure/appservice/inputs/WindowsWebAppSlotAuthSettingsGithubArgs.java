...
public final class WindowsWebAppSlotAuthSettingsGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsGithubArgs Empty = new WindowsWebAppSlotAuthSettingsGithubArgs();
    ...
    private WindowsWebAppSlotAuthSettingsGithubArgs() {}

    private WindowsWebAppSlotAuthSettingsGithubArgs(WindowsWebAppSlotAuthSettingsGithubArgs $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsGithubArgs();
        }

        public Builder(WindowsWebAppSlotAuthSettingsGithubArgs defaults) {
            $ = new WindowsWebAppSlotAuthSettingsGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsGithubArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsGithubArgs", "clientId");
            }
            return $;
        }
    }
