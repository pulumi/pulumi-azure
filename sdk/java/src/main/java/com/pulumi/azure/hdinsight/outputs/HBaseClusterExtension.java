...
@CustomType
public final class HBaseClusterExtension {
    /**
    ...
    public static Builder builder(HBaseClusterExtension defaults) {
    ...
    public static final class Builder {
        ...
        private String primaryKey;
        public Builder() {}
        public Builder(HBaseClusterExtension defaults) {
        ...
        public Builder logAnalyticsWorkspaceId(String logAnalyticsWorkspaceId) {
            if (logAnalyticsWorkspaceId == null) {
              throw new MissingRequiredPropertyException("HBaseClusterExtension", "logAnalyticsWorkspaceId");
            }
        ...
        public Builder primaryKey(String primaryKey) {
            if (primaryKey == null) {
              throw new MissingRequiredPropertyException("HBaseClusterExtension", "primaryKey");
            }
