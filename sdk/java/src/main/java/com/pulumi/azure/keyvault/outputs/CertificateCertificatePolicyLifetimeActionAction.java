...
public final class CertificateCertificatePolicyLifetimeActionAction {
    ...
    public static final class Builder {
        ...
        public Builder actionType(String actionType) {
            if (actionType == null) {
              throw new MissingRequiredPropertyException("CertificateCertificatePolicyLifetimeActionAction", "actionType");
            }
            this.actionType = actionType;
            return this;
        }
        public CertificateCertificatePolicyLifetimeActionAction build() {
            final var _resultValue = new CertificateCertificatePolicyLifetimeActionAction();
