...
public final class ConnectionTypeState extends com.pulumi.resources.ResourceArgs {

    public static final ConnectionTypeState Empty = new ConnectionTypeState();
     ...
     */
    @Import(name="fields")
    private @Nullable Output<List<ConnectionTypeFieldArgs>> fields;

    /**
     * @return One or more `field` blocks as defined below. Changing this forces a new Automation to be created.
     * 
     */
    public Optional<Output<List<ConnectionTypeFieldArgs>>> fields() {
    ...
    private ConnectionTypeState() {}

    private ConnectionTypeState(ConnectionTypeState $) {
    ...
    public static Builder builder(ConnectionTypeState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectionTypeState();
        }

        public Builder(ConnectionTypeState defaults) {
            $ = new ConnectionTypeState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder fields(@Nullable Output<List<ConnectionTypeFieldArgs>> fields) {
            $.fields = fields;
            return this;
        }
        ...
        public ConnectionTypeState build() {
            return $;
        }
    }
