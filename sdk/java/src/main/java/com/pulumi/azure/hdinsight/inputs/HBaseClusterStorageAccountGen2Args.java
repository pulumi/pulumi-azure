...
public final class HBaseClusterStorageAccountGen2Args extends com.pulumi.resources.ResourceArgs {

    public static final HBaseClusterStorageAccountGen2Args Empty = new HBaseClusterStorageAccountGen2Args();
    ...
    public static Builder builder(HBaseClusterStorageAccountGen2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseClusterStorageAccountGen2Args();
        }

        public Builder(HBaseClusterStorageAccountGen2Args defaults) {
            $ = new HBaseClusterStorageAccountGen2Args(Objects.requireNonNull(defaults));
        }
        ...
        public HBaseClusterStorageAccountGen2Args build() {
            if ($.filesystemId == null) {
                throw new MissingRequiredPropertyException("HBaseClusterStorageAccountGen2Args", "filesystemId");
            }
            if ($.isDefault == null) {
