...
@CustomType
public final class StreamInputBlobSerialization {
    /**
    ...
    public static Builder builder(StreamInputBlobSerialization defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(StreamInputBlobSerialization defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("StreamInputBlobSerialization", "type");
            }
            this.type = type;
            return this;
        }
