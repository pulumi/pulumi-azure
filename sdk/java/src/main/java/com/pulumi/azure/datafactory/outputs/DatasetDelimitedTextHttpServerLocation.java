...
@CustomType
public final class DatasetDelimitedTextHttpServerLocation {
    /**
    ...
    public static final class Builder {
        ...
        public Builder filename(String filename) {
            if (filename == null) {
              throw new MissingRequiredPropertyException("DatasetDelimitedTextHttpServerLocation", "filename");
            }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("DatasetDelimitedTextHttpServerLocation", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public Builder relativeUrl(String relativeUrl) {
            if (relativeUrl == null) {
              throw new MissingRequiredPropertyException("DatasetDelimitedTextHttpServerLocation", "relativeUrl");
            }
            this.relativeUrl = relativeUrl;
            return this;
        }
        public DatasetDelimitedTextHttpServerLocation build() {
            final var _resultValue = new DatasetDelimitedTextHttpServerLocation();
