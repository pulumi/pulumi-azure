...
public final class NsRecordState extends com.pulumi.resources.ResourceArgs {

    public static final NsRecordState Empty = new NsRecordState();
    ...
    private NsRecordState() {}

    private NsRecordState(NsRecordState $) {
        this.fqdn = $.fqdn;
        this.name = $.name;
    ...
    public static Builder builder(NsRecordState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(NsRecordState defaults) {
            $ = new NsRecordState(Objects.requireNonNull(defaults));
        }

        /**
         * @param fqdn The FQDN of the DNS NS Record.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param records A list of values that make up the NS record.
         * 
         * @return builder
         * 
         */
