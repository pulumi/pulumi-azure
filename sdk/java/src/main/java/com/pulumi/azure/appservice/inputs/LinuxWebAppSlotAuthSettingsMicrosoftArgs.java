...
public final class LinuxWebAppSlotAuthSettingsMicrosoftArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsMicrosoftArgs Empty = new LinuxWebAppSlotAuthSettingsMicrosoftArgs();
    ...
    private LinuxWebAppSlotAuthSettingsMicrosoftArgs() {}

    private LinuxWebAppSlotAuthSettingsMicrosoftArgs(LinuxWebAppSlotAuthSettingsMicrosoftArgs $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsMicrosoftArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsMicrosoftArgs();
        }

        public Builder(LinuxWebAppSlotAuthSettingsMicrosoftArgs defaults) {
            $ = new LinuxWebAppSlotAuthSettingsMicrosoftArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsMicrosoftArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsMicrosoftArgs", "clientId");
            }
            return $;
        }
    }
