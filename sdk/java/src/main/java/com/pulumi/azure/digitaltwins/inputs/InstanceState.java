...
public final class InstanceState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param hostName The API endpoint to work with this Digital Twins instance.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name The name which should be used for this Digital Twins instance. Changing this forces a new Digital Twins instance to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resourceGroupName The name of the Resource Group where the Digital Twins instance should exist. Changing this forces a new Digital Twins instance to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tags A mapping of tags which should be assigned to the Digital Twins instance.
         * 
         * @return builder
         * 
         */
