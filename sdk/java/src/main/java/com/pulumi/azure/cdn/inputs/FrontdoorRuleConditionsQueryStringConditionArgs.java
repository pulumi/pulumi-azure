...
public final class FrontdoorRuleConditionsQueryStringConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsQueryStringConditionArgs Empty = new FrontdoorRuleConditionsQueryStringConditionArgs();
    ...
    private FrontdoorRuleConditionsQueryStringConditionArgs() {}

    private FrontdoorRuleConditionsQueryStringConditionArgs(FrontdoorRuleConditionsQueryStringConditionArgs $) {
    ...
    public static Builder builder(FrontdoorRuleConditionsQueryStringConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsQueryStringConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsQueryStringConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsQueryStringConditionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param matchValues One or more string or integer values(e.g. &#34;1&#34;) representing the value of the query string to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
         * 
         * @return builder
         * 
         */
        ...
        public FrontdoorRuleConditionsQueryStringConditionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsQueryStringConditionArgs", "operator");
            }
            return $;
        }
    }
