    ...
    public static final class Builder {
        ...
        public Builder appSettingNames(List<String> appSettingNames) {
            if (appSettingNames == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStickySetting", "appSettingNames");
            }
        ...
        public Builder connectionStringNames(List<String> connectionStringNames) {
            if (connectionStringNames == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStickySetting", "connectionStringNames");
            }
