...
public class DataConnectorMicrosoftCloudAppSecurity extends com.pulumi.resources.CustomResource {
    ...
    public DataConnectorMicrosoftCloudAppSecurity(String name, DataConnectorMicrosoftCloudAppSecurityArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:sentinel/dataConnectorMicrosoftCloudAppSecurity:DataConnectorMicrosoftCloudAppSecurity", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
