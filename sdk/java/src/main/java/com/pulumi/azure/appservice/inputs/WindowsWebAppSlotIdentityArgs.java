...
public final class WindowsWebAppSlotIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotIdentityArgs Empty = new WindowsWebAppSlotIdentityArgs();
    ...
    private WindowsWebAppSlotIdentityArgs() {}

    private WindowsWebAppSlotIdentityArgs(WindowsWebAppSlotIdentityArgs $) {
    ...
    public static Builder builder(WindowsWebAppSlotIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotIdentityArgs();
        }

        public Builder(WindowsWebAppSlotIdentityArgs defaults) {
            $ = new WindowsWebAppSlotIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param type Specifies the type of Managed Service Identity that should be configured on this Windows Web App Slot. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
         * 
         * @return builder
         * 
         */
        ...
        public WindowsWebAppSlotIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotIdentityArgs", "type");
            }
            return $;
        }
    }
