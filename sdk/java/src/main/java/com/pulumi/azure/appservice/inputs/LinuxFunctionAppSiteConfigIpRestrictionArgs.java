...
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppSiteConfigIpRestrictionHeadersArgs;
...
public final class LinuxFunctionAppSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSiteConfigIpRestrictionArgs Empty = new LinuxFunctionAppSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxFunctionAppSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<LinuxFunctionAppSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxFunctionAppSiteConfigIpRestrictionArgs() {}

    private LinuxFunctionAppSiteConfigIpRestrictionArgs(LinuxFunctionAppSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxFunctionAppSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSiteConfigIpRestrictionArgs();
        }

        public Builder(LinuxFunctionAppSiteConfigIpRestrictionArgs defaults) {
            $ = new LinuxFunctionAppSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxFunctionAppSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxFunctionAppSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public LinuxFunctionAppSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
