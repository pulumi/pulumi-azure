...
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppSlotSiteConfigIpRestrictionHeadersArgs;
...
public final class LinuxFunctionAppSlotSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotSiteConfigIpRestrictionArgs Empty = new LinuxFunctionAppSlotSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxFunctionAppSlotSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return a `headers` block as detailed below.
     * 
     */
    public Optional<Output<LinuxFunctionAppSlotSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxFunctionAppSlotSiteConfigIpRestrictionArgs() {}

    private LinuxFunctionAppSlotSiteConfigIpRestrictionArgs(LinuxFunctionAppSlotSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxFunctionAppSlotSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotSiteConfigIpRestrictionArgs();
        }

        public Builder(LinuxFunctionAppSlotSiteConfigIpRestrictionArgs defaults) {
            $ = new LinuxFunctionAppSlotSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxFunctionAppSlotSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxFunctionAppSlotSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public LinuxFunctionAppSlotSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
