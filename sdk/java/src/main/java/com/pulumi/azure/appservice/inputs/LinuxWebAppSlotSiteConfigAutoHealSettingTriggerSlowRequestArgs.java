...
public final class LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs Empty = new LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs();
    ...
    private LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs() {}

    private LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs(LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs $) {
        this.count = $.count;
    ...
    public static Builder builder(LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs();
        }

        public Builder(LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs defaults) {
            $ = new LinuxWebAppSlotSiteConfigAutoHealSettingTriggerSlowRequestArgs(Objects.requireNonNull(defaults));
        }
