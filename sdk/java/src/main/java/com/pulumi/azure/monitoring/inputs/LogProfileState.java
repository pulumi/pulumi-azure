...
public final class LogProfileState extends com.pulumi.resources.ResourceArgs {

    public static final LogProfileState Empty = new LogProfileState();
    ...
    private @Nullable Output<LogProfileRetentionPolicyArgs> retentionPolicy;
     ...
     * 
     */
    public Optional<Output<LogProfileRetentionPolicyArgs>> retentionPolicy() {
    ...
    private LogProfileState() {}

    private LogProfileState(LogProfileState $) {
    ...
    public static Builder builder(LogProfileState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LogProfileState defaults) {
            $ = new LogProfileState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder retentionPolicy(@Nullable Output<LogProfileRetentionPolicyArgs> retentionPolicy) {
