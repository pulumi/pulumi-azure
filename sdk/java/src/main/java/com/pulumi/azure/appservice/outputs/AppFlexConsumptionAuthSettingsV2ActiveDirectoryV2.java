...
@CustomType
public final class AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2 {
    /**
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean wwwAuthenticationDisabled;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2", "clientId");
            }
        ...
        public Builder tenantAuthEndpoint(String tenantAuthEndpoint) {
            if (tenantAuthEndpoint == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2", "tenantAuthEndpoint");
            }
        ...
        public AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2 build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2();
