...
public final class FrontdoorRuleConditionsRequestBodyConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsRequestBodyConditionArgs Empty = new FrontdoorRuleConditionsRequestBodyConditionArgs();
    ...
    /**
     * @return A list of one or more string or integer values(e.g. &#34;1&#34;) representing the value of the request body text to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
     * 
     */
    ...
    private FrontdoorRuleConditionsRequestBodyConditionArgs() {}

    private FrontdoorRuleConditionsRequestBodyConditionArgs(FrontdoorRuleConditionsRequestBodyConditionArgs $) {
    ...
    public static Builder builder(FrontdoorRuleConditionsRequestBodyConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsRequestBodyConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsRequestBodyConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsRequestBodyConditionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param matchValues A list of one or more string or integer values(e.g. &#34;1&#34;) representing the value of the request body text to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
         * 
         * @return builder
         * 
         */
        ...
        public FrontdoorRuleConditionsRequestBodyConditionArgs build() {
            if ($.matchValues == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsRequestBodyConditionArgs", "matchValues");
            }
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsRequestBodyConditionArgs", "operator");
            }
            return $;
        }
    }
