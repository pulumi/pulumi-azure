...
public final class TxtRecordArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder records(Output<List<TxtRecordRecordArgs>> records) {
            $.records = records;
            return this;
        }
