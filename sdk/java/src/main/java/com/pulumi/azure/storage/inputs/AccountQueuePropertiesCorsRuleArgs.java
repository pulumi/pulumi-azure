...
public final class AccountQueuePropertiesCorsRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountQueuePropertiesCorsRuleArgs Empty = new AccountQueuePropertiesCorsRuleArgs();
    ...
    private AccountQueuePropertiesCorsRuleArgs() {}

    private AccountQueuePropertiesCorsRuleArgs(AccountQueuePropertiesCorsRuleArgs $) {
    ...
    public static Builder builder(AccountQueuePropertiesCorsRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountQueuePropertiesCorsRuleArgs();
        }

        public Builder(AccountQueuePropertiesCorsRuleArgs defaults) {
            $ = new AccountQueuePropertiesCorsRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountQueuePropertiesCorsRuleArgs build() {
            if ($.allowedHeaders == null) {
                throw new MissingRequiredPropertyException("AccountQueuePropertiesCorsRuleArgs", "allowedHeaders");
            }
            if ($.allowedMethods == null) {
                throw new MissingRequiredPropertyException("AccountQueuePropertiesCorsRuleArgs", "allowedMethods");
            }
            if ($.allowedOrigins == null) {
                throw new MissingRequiredPropertyException("AccountQueuePropertiesCorsRuleArgs", "allowedOrigins");
            }
            if ($.exposedHeaders == null) {
                throw new MissingRequiredPropertyException("AccountQueuePropertiesCorsRuleArgs", "exposedHeaders");
            }
            if ($.maxAgeInSeconds == null) {
                throw new MissingRequiredPropertyException("AccountQueuePropertiesCorsRuleArgs", "maxAgeInSeconds");
            }
            return $;
        }
    }
