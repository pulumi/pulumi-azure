...
public final class LinuxFunctionAppAuthSettingsTwitterArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsTwitterArgs Empty = new LinuxFunctionAppAuthSettingsTwitterArgs();
    ...
    private LinuxFunctionAppAuthSettingsTwitterArgs() {}

    private LinuxFunctionAppAuthSettingsTwitterArgs(LinuxFunctionAppAuthSettingsTwitterArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsTwitterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsTwitterArgs();
        }

        public Builder(LinuxFunctionAppAuthSettingsTwitterArgs defaults) {
            $ = new LinuxFunctionAppAuthSettingsTwitterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsTwitterArgs build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsTwitterArgs", "consumerKey");
            }
            return $;
        }
    }
