...
public final class AccountTablePropertiesLoggingArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountTablePropertiesLoggingArgs Empty = new AccountTablePropertiesLoggingArgs();
    ...
    private AccountTablePropertiesLoggingArgs() {}

    private AccountTablePropertiesLoggingArgs(AccountTablePropertiesLoggingArgs $) {
        this.delete = $.delete;
        this.read = $.read;
    ...
    public static Builder builder(AccountTablePropertiesLoggingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountTablePropertiesLoggingArgs();
        }

        public Builder(AccountTablePropertiesLoggingArgs defaults) {
            $ = new AccountTablePropertiesLoggingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountTablePropertiesLoggingArgs build() {
            if ($.delete == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesLoggingArgs", "delete");
            }
            if ($.read == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesLoggingArgs", "read");
            }
            if ($.version == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesLoggingArgs", "version");
            }
            if ($.write == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesLoggingArgs", "write");
            }
            return $;
        }
    }
