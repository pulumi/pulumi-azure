...
public final class RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs Empty = new RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs();
    ...
    private RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs() {}

    private RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs(RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs $) {
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs();
        }

        public Builder(RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs defaults) {
            $ = new RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
