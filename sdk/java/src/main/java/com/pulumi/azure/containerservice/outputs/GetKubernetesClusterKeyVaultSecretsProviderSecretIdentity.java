...
@CustomType
public final class GetKubernetesClusterKeyVaultSecretsProviderSecretIdentity {
    /**
    ...
    private GetKubernetesClusterKeyVaultSecretsProviderSecretIdentity() {}
    /**
     * @return The Client ID of the user-defined Managed Identity assigned to the Kubelets.
     * 
     */
    ...
    public static Builder builder(GetKubernetesClusterKeyVaultSecretsProviderSecretIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String userAssignedIdentityId;
        public Builder() {}
        public Builder(GetKubernetesClusterKeyVaultSecretsProviderSecretIdentity defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetKubernetesClusterKeyVaultSecretsProviderSecretIdentity", "clientId");
            }
        ...
        public Builder objectId(String objectId) {
            if (objectId == null) {
              throw new MissingRequiredPropertyException("GetKubernetesClusterKeyVaultSecretsProviderSecretIdentity", "objectId");
            }
        ...
        public Builder userAssignedIdentityId(String userAssignedIdentityId) {
            if (userAssignedIdentityId == null) {
              throw new MissingRequiredPropertyException("GetKubernetesClusterKeyVaultSecretsProviderSecretIdentity", "userAssignedIdentityId");
            }
