...
import com.pulumi.azure.appservice.outputs.FunctionAppSlotSiteConfigScmIpRestrictionHeaders;
...
@CustomType
public final class FunctionAppSlotSiteConfigScmIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable FunctionAppSlotSiteConfigScmIpRestrictionHeaders headers;
    /**
    ...
    private FunctionAppSlotSiteConfigScmIpRestriction(
        ...
        @CustomType.Parameter("headers") @Nullable FunctionAppSlotSiteConfigScmIpRestrictionHeaders headers,
    ...
    public static Builder builder(FunctionAppSlotSiteConfigScmIpRestriction defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FunctionAppSlotSiteConfigScmIpRestriction defaults) {
        ...
        public Builder headers(@Nullable FunctionAppSlotSiteConfigScmIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public FunctionAppSlotSiteConfigScmIpRestriction build() {
            return new FunctionAppSlotSiteConfigScmIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
