...
public final class ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs Empty = new ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs();
    ...
    private ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs() {}

    private ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs(ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs $) {
    ...
    public static Builder builder(ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs();
        }

        public Builder(ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs defaults) {
            $ = new ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs build() {
            if ($.failOverDirections == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs", "failOverDirections");
            }
            if ($.failOverTypes == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs", "failOverTypes");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPostActionArgs", "type");
            }
            return $;
        }
    }
