...
public final class DomainIdentity {
    ...
    public static Builder builder(DomainIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DomainIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DomainIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public DomainIdentity build() {
            final var _resultValue = new DomainIdentity();
