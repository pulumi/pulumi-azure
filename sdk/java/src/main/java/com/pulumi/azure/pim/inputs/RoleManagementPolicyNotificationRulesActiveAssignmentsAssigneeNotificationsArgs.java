...
public final class RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs Empty = new RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs();
    ...
    private RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs() {}

    private RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs(RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs $) {
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs();
        }

        public Builder(RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs defaults) {
            $ = new RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsAssigneeNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
