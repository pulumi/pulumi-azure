...
public final class BudgetManagementGroupState extends com.pulumi.resources.ResourceArgs {

    public static final BudgetManagementGroupState Empty = new BudgetManagementGroupState();
    ...
    private @Nullable Output<List<BudgetManagementGroupNotificationArgs>> notifications;

    /**
     * @return One or more `notification` blocks as defined below.
     * 
     */
    public Optional<Output<List<BudgetManagementGroupNotificationArgs>>> notifications() {
    ...
    private @Nullable Output<BudgetManagementGroupTimePeriodArgs> timePeriod;

    /**
     * @return A `time_period` block as defined below.
     * 
     */
    public Optional<Output<BudgetManagementGroupTimePeriodArgs>> timePeriod() {
        return Optional.ofNullable(this.timePeriod);
    }

    private BudgetManagementGroupState() {}

    private BudgetManagementGroupState(BudgetManagementGroupState $) {
        this.amount = $.amount;
        this.etag = $.etag;
        this.filter = $.filter;
    ...
    public static Builder builder(BudgetManagementGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetManagementGroupState();
        }

        public Builder(BudgetManagementGroupState defaults) {
            $ = new BudgetManagementGroupState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder notifications(@Nullable Output<List<BudgetManagementGroupNotificationArgs>> notifications) {
         ...
         * 
         */
        public Builder timePeriod(@Nullable Output<BudgetManagementGroupTimePeriodArgs> timePeriod) {
        ...
        public BudgetManagementGroupState build() {
            return $;
        }
    }
