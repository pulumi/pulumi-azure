...
public final class RestorePointCollectionArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="sourceVirtualMachineId", required=true)
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder sourceVirtualMachineId(Output<String> sourceVirtualMachineId) {
        ...
        public RestorePointCollectionArgs build() {
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("RestorePointCollectionArgs", "resourceGroupName");
            }
            if ($.sourceVirtualMachineId == null) {
                throw new MissingRequiredPropertyException("RestorePointCollectionArgs", "sourceVirtualMachineId");
            }
            return $;
        }
    }
