...
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionAuthSettingsActiveDirectory;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionAuthSettingsFacebook;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionAuthSettingsGithub;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionAuthSettingsGoogle;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionAuthSettingsMicrosoft;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionAuthSettingsTwitter;
...
public final class AppFlexConsumptionAuthSettings {
     ...
     * 
     */
    private @Nullable AppFlexConsumptionAuthSettingsFacebook facebook;
    /**
     * @return A `github` block as defined below.
     * 
     */
    private @Nullable AppFlexConsumptionAuthSettingsGithub github;
    /**
     * @return A `google` block as defined below.
     * 
     */
    private @Nullable AppFlexConsumptionAuthSettingsGoogle google;
    /**
     ...
     * 
     */
    private @Nullable AppFlexConsumptionAuthSettingsMicrosoft microsoft;
    /**
     ...
     * 
     */
    private @Nullable AppFlexConsumptionAuthSettingsTwitter twitter;
    /**
     ...
     * 
     */
    public Optional<AppFlexConsumptionAuthSettingsFacebook> facebook() {
     ...
     * 
     */
    public Optional<AppFlexConsumptionAuthSettingsGithub> github() {
     ...
     * 
     */
    public Optional<AppFlexConsumptionAuthSettingsGoogle> google() {
     ...
     * 
     */
    public Optional<AppFlexConsumptionAuthSettingsMicrosoft> microsoft() {
     ...
     * 
     */
    public Optional<AppFlexConsumptionAuthSettingsTwitter> twitter() {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unauthenticatedClientAction;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettings defaults) {
        ...
        @CustomType.Setter
        public Builder activeDirectory(@Nullable AppFlexConsumptionAuthSettingsActiveDirectory activeDirectory) {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettings", "enabled");
            }
            this.enabled = enabled;
            return this;
        }
        @CustomType.Setter
        public Builder facebook(@Nullable AppFlexConsumptionAuthSettingsFacebook facebook) {

            this.facebook = facebook;
            return this;
        }
        @CustomType.Setter
        public Builder github(@Nullable AppFlexConsumptionAuthSettingsGithub github) {

            this.github = github;
            return this;
        }
        @CustomType.Setter
        public Builder google(@Nullable AppFlexConsumptionAuthSettingsGoogle google) {
        ...
        @CustomType.Setter
        public Builder microsoft(@Nullable AppFlexConsumptionAuthSettingsMicrosoft microsoft) {
        ...
        @CustomType.Setter
        public Builder twitter(@Nullable AppFlexConsumptionAuthSettingsTwitter twitter) {
        ...
        public AppFlexConsumptionAuthSettings build() {
            final var _resultValue = new AppFlexConsumptionAuthSettings();
