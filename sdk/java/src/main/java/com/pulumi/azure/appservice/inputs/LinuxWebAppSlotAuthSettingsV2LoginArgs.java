...
public final class LinuxWebAppSlotAuthSettingsV2LoginArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsV2LoginArgs Empty = new LinuxWebAppSlotAuthSettingsV2LoginArgs();
    ...
    private LinuxWebAppSlotAuthSettingsV2LoginArgs() {}

    private LinuxWebAppSlotAuthSettingsV2LoginArgs(LinuxWebAppSlotAuthSettingsV2LoginArgs $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2LoginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsV2LoginArgs();
        }

        public Builder(LinuxWebAppSlotAuthSettingsV2LoginArgs defaults) {
            $ = new LinuxWebAppSlotAuthSettingsV2LoginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsV2LoginArgs build() {
            return $;
        }
    }
