...
@CustomType
public final class NextGenerationFirewallVirtualHubLocalRulestackDnsSettings {
    ...
    public static Builder builder(NextGenerationFirewallVirtualHubLocalRulestackDnsSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean useAzureDns;
        public Builder() {}
        public Builder(NextGenerationFirewallVirtualHubLocalRulestackDnsSettings defaults) {
        ...
        public NextGenerationFirewallVirtualHubLocalRulestackDnsSettings build() {
            final var _resultValue = new NextGenerationFirewallVirtualHubLocalRulestackDnsSettings();
