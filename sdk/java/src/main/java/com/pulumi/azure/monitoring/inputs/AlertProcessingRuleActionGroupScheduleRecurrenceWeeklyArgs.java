...
public final class AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs() {}

    private AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs(AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs $) {
    ...
    public static Builder builder(AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs();
        }

        public Builder(AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs defaults) {
            $ = new AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs build() {
            if ($.daysOfWeeks == null) {
                throw new MissingRequiredPropertyException("AlertProcessingRuleActionGroupScheduleRecurrenceWeeklyArgs", "daysOfWeeks");
            }
            return $;
        }
    }
