...
public final class NetworkPacketCoreControlPlaneIdentity {
    ...
    public static final class Builder {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("NetworkPacketCoreControlPlaneIdentity", "identityIds");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("NetworkPacketCoreControlPlaneIdentity", "type");
            }
            this.type = type;
            return this;
        }
