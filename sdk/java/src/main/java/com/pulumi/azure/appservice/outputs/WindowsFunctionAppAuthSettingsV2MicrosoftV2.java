...
@CustomType
public final class WindowsFunctionAppAuthSettingsV2MicrosoftV2 {
    /**
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2MicrosoftV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsFunctionAppAuthSettingsV2MicrosoftV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2MicrosoftV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2MicrosoftV2", "clientSecretSettingName");
            }
        ...
        public WindowsFunctionAppAuthSettingsV2MicrosoftV2 build() {
            final var _resultValue = new WindowsFunctionAppAuthSettingsV2MicrosoftV2();
