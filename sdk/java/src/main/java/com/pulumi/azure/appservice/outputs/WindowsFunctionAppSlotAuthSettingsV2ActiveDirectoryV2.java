...
@CustomType
public final class WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 {
    /**
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean wwwAuthenticationDisabled;
        public Builder() {}
        public Builder(WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2", "clientId");
            }
        ...
        public Builder tenantAuthEndpoint(String tenantAuthEndpoint) {
            if (tenantAuthEndpoint == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2", "tenantAuthEndpoint");
            }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 build() {
            final var _resultValue = new WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2();
