...
@CustomType
public final class GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification {
    /**
    ...
    private GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification() {}
    /**
     * @return A list of additional email addresses that will receive these notifications.
     * 
     */
    ...
    public static Builder builder(GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification defaults) {
        ...
        public Builder additionalRecipients(List<String> additionalRecipients) {
            if (additionalRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification", "additionalRecipients");
            }
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification build() {
            final var _resultValue = new GetRoleManagementPolicyNotificationRuleActiveAssignmentApproverNotification();
