...
public final class ShareAclAccessPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param expiry The time at which this Access Policy should be valid until, in RFC3339 format.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param start The time at which this Access Policy should be valid from, in RFC3339 format.
         * 
         * @return builder
         * 
         */
