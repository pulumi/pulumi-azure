...
@CustomType
public final class LinuxWebAppBackupSchedule {
    /**
    ...
    public static Builder builder(LinuxWebAppBackupSchedule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startTime;
        public Builder() {}
        public Builder(LinuxWebAppBackupSchedule defaults) {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppBackupSchedule", "frequencyInterval");
            }
        ...
        public Builder frequencyUnit(String frequencyUnit) {
            if (frequencyUnit == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppBackupSchedule", "frequencyUnit");
            }
        ...
        public LinuxWebAppBackupSchedule build() {
            final var _resultValue = new LinuxWebAppBackupSchedule();
