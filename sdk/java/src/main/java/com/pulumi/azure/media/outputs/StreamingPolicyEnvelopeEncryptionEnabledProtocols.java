...
@CustomType
public final class StreamingPolicyEnvelopeEncryptionEnabledProtocols {
    /**
    ...
    public static Builder builder(StreamingPolicyEnvelopeEncryptionEnabledProtocols defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean smoothStreaming;
        public Builder() {}
        public Builder(StreamingPolicyEnvelopeEncryptionEnabledProtocols defaults) {
        ...
        public StreamingPolicyEnvelopeEncryptionEnabledProtocols build() {
            final var _resultValue = new StreamingPolicyEnvelopeEncryptionEnabledProtocols();
