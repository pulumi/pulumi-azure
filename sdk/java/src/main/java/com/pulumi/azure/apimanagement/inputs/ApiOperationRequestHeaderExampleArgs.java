...
public final class ApiOperationRequestHeaderExampleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiOperationRequestHeaderExampleArgs Empty = new ApiOperationRequestHeaderExampleArgs();
    ...
    private ApiOperationRequestHeaderExampleArgs() {}

    private ApiOperationRequestHeaderExampleArgs(ApiOperationRequestHeaderExampleArgs $) {
    ...
    public static Builder builder(ApiOperationRequestHeaderExampleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiOperationRequestHeaderExampleArgs();
        }

        public Builder(ApiOperationRequestHeaderExampleArgs defaults) {
            $ = new ApiOperationRequestHeaderExampleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiOperationRequestHeaderExampleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationRequestHeaderExampleArgs", "name");
            }
            return $;
        }
    }
