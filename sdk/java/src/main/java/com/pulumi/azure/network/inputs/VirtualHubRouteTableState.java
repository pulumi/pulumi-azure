...
public final class VirtualHubRouteTableState extends com.pulumi.resources.ResourceArgs {

    public static final VirtualHubRouteTableState Empty = new VirtualHubRouteTableState();
    ...
    private VirtualHubRouteTableState() {}

    private VirtualHubRouteTableState(VirtualHubRouteTableState $) {
        this.labels = $.labels;
        this.name = $.name;
        this.routes = $.routes;
    ...
    public static Builder builder(VirtualHubRouteTableState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualHubRouteTableState();
        }

        public Builder(VirtualHubRouteTableState defaults) {
            $ = new VirtualHubRouteTableState(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualHubRouteTableState build() {
            return $;
        }
    }
