...
public final class FrontdoorRuleConditionsRequestUriConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsRequestUriConditionArgs Empty = new FrontdoorRuleConditionsRequestUriConditionArgs();
    ...
    /**
     * @return One or more string or integer values(e.g. &#34;1&#34;) representing the value of the request URL to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
     * 
     */
    ...
    private FrontdoorRuleConditionsRequestUriConditionArgs() {}

    private FrontdoorRuleConditionsRequestUriConditionArgs(FrontdoorRuleConditionsRequestUriConditionArgs $) {
    ...
    public static Builder builder(FrontdoorRuleConditionsRequestUriConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsRequestUriConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsRequestUriConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsRequestUriConditionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param matchValues One or more string or integer values(e.g. &#34;1&#34;) representing the value of the request URL to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
         * 
         * @return builder
         * 
         */
        ...
        public FrontdoorRuleConditionsRequestUriConditionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsRequestUriConditionArgs", "operator");
            }
            return $;
        }
    }
