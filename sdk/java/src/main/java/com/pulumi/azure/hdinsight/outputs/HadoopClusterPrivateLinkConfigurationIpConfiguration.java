...
@CustomType
public final class HadoopClusterPrivateLinkConfigurationIpConfiguration {
    /**
    ...
    public static Builder builder(HadoopClusterPrivateLinkConfigurationIpConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetId;
        public Builder() {}
        public Builder(HadoopClusterPrivateLinkConfigurationIpConfiguration defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("HadoopClusterPrivateLinkConfigurationIpConfiguration", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public HadoopClusterPrivateLinkConfigurationIpConfiguration build() {
            final var _resultValue = new HadoopClusterPrivateLinkConfigurationIpConfiguration();
