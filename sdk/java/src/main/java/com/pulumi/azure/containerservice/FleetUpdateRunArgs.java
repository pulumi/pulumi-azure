...
public final class FleetUpdateRunArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FleetUpdateRunArgs() {}

    private FleetUpdateRunArgs(FleetUpdateRunArgs $) {
    ...
    public static Builder builder(FleetUpdateRunArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FleetUpdateRunArgs();
        }

        public Builder(FleetUpdateRunArgs defaults) {
            $ = new FleetUpdateRunArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder managedClusterUpdate(Output<FleetUpdateRunManagedClusterUpdateArgs> managedClusterUpdate) {
        ...
        public FleetUpdateRunArgs build() {
            if ($.kubernetesFleetManagerId == null) {
                throw new MissingRequiredPropertyException("FleetUpdateRunArgs", "kubernetesFleetManagerId");
            }
            if ($.managedClusterUpdate == null) {
                throw new MissingRequiredPropertyException("FleetUpdateRunArgs", "managedClusterUpdate");
            }
            return $;
        }
    }
