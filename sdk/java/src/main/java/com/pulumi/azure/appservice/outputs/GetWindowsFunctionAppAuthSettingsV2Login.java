...
@CustomType
public final class GetWindowsFunctionAppAuthSettingsV2Login {
    /**
    ...
    private GetWindowsFunctionAppAuthSettingsV2Login() {}
    /**
     * @return External URLs that can be redirected to as part of logging in or logging out of the app.
     * 
     */
    ...
    public static Builder builder(GetWindowsFunctionAppAuthSettingsV2Login defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean validateNonce;
        public Builder() {}
        public Builder(GetWindowsFunctionAppAuthSettingsV2Login defaults) {
        ...
        public Builder allowedExternalRedirectUrls(List<String> allowedExternalRedirectUrls) {
            if (allowedExternalRedirectUrls == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "allowedExternalRedirectUrls");
            }
        ...
        public Builder cookieExpirationConvention(String cookieExpirationConvention) {
            if (cookieExpirationConvention == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "cookieExpirationConvention");
            }
        ...
        public Builder cookieExpirationTime(String cookieExpirationTime) {
            if (cookieExpirationTime == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "cookieExpirationTime");
            }
        ...
        public Builder logoutEndpoint(String logoutEndpoint) {
            if (logoutEndpoint == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "logoutEndpoint");
            }
        ...
        public Builder nonceExpirationTime(String nonceExpirationTime) {
            if (nonceExpirationTime == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "nonceExpirationTime");
            }
        ...
        public Builder preserveUrlFragmentsForLogins(Boolean preserveUrlFragmentsForLogins) {
            if (preserveUrlFragmentsForLogins == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "preserveUrlFragmentsForLogins");
            }
        ...
        public Builder tokenRefreshExtensionTime(Double tokenRefreshExtensionTime) {
            if (tokenRefreshExtensionTime == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "tokenRefreshExtensionTime");
            }
        ...
        public Builder tokenStoreEnabled(Boolean tokenStoreEnabled) {
            if (tokenStoreEnabled == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "tokenStoreEnabled");
            }
        ...
        public Builder tokenStorePath(String tokenStorePath) {
            if (tokenStorePath == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "tokenStorePath");
            }
        ...
        public Builder tokenStoreSasSettingName(String tokenStoreSasSettingName) {
            if (tokenStoreSasSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "tokenStoreSasSettingName");
            }
        ...
        public Builder validateNonce(Boolean validateNonce) {
            if (validateNonce == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2Login", "validateNonce");
            }
