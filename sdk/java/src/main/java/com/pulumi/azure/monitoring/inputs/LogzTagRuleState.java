...
public final class LogzTagRuleState extends com.pulumi.resources.ResourceArgs {

    public static final LogzTagRuleState Empty = new LogzTagRuleState();

    /**
     * The ID of the Logz Monitor. Changing this forces a new logz Tag Rule to be created.
     * 
     */
    @Import(name="logzMonitorId")
    private @Nullable Output<String> logzMonitorId;

    /**
     * @return The ID of the Logz Monitor. Changing this forces a new logz Tag Rule to be created.
     * 
     */
    public Optional<Output<String>> logzMonitorId() {
        return Optional.ofNullable(this.logzMonitorId);
    }
    ...
    private LogzTagRuleState() {}

    private LogzTagRuleState(LogzTagRuleState $) {
    ...
    public static Builder builder(LogzTagRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogzTagRuleState();
        }

        public Builder(LogzTagRuleState defaults) {
            $ = new LogzTagRuleState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder logzMonitorId(@Nullable Output<String> logzMonitorId) {
