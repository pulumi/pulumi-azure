...
public final class GroupIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupIdentityArgs Empty = new GroupIdentityArgs();
    ...
    private GroupIdentityArgs() {}

    private GroupIdentityArgs(GroupIdentityArgs $) {
    ...
    public static Builder builder(GroupIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupIdentityArgs();
        }

        public Builder(GroupIdentityArgs defaults) {
            $ = new GroupIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GroupIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("GroupIdentityArgs", "type");
            }
            return $;
        }
    }
