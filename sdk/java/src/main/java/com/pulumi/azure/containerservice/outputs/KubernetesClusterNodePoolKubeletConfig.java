...
public final class KubernetesClusterNodePoolKubeletConfig {
    ...
    public static final class Builder {
        ...
        public Builder topologyManagerPolicy(@Nullable String topologyManagerPolicy) {
            ...
            return new KubernetesClusterNodePoolKubeletConfig(allowedUnsafeSysctls, containerLogMaxLine, containerLogMaxSizeMb, cpuCfsQuotaEnabled, cpuCfsQuotaPeriod, cpuManagerPolicy, imageGcHighThreshold, imageGcLowThreshold, podMaxPid, topologyManagerPolicy);
        }
    }
}
