...
public final class GroupPolicySetDefinitionArgs extends com.pulumi.resources.ResourceArgs {

    public static final GroupPolicySetDefinitionArgs Empty = new GroupPolicySetDefinitionArgs();
    ...
    private Output<List<GroupPolicySetDefinitionPolicyDefinitionReferenceArgs>> policyDefinitionReferences;

    /**
     * @return One or more `policyDefinitionReference` blocks as defined below.
     * 
     */
    public Output<List<GroupPolicySetDefinitionPolicyDefinitionReferenceArgs>> policyDefinitionReferences() {
    ...
    private GroupPolicySetDefinitionArgs() {}

    private GroupPolicySetDefinitionArgs(GroupPolicySetDefinitionArgs $) {
    ...
    public static Builder builder(GroupPolicySetDefinitionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupPolicySetDefinitionArgs();
        }

        public Builder(GroupPolicySetDefinitionArgs defaults) {
            $ = new GroupPolicySetDefinitionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder policyDefinitionReferences(Output<List<GroupPolicySetDefinitionPolicyDefinitionReferenceArgs>> policyDefinitionReferences) {
        ...
        public GroupPolicySetDefinitionArgs build() {
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("GroupPolicySetDefinitionArgs", "displayName");
            }
            if ($.managementGroupId == null) {
                throw new MissingRequiredPropertyException("GroupPolicySetDefinitionArgs", "managementGroupId");
            }
            if ($.policyDefinitionReferences == null) {
                throw new MissingRequiredPropertyException("GroupPolicySetDefinitionArgs", "policyDefinitionReferences");
            }
            if ($.policyType == null) {
                throw new MissingRequiredPropertyException("GroupPolicySetDefinitionArgs", "policyType");
            }
            return $;
        }
    }
