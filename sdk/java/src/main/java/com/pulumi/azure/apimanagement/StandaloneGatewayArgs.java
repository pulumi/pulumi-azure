...
public final class StandaloneGatewayArgs extends com.pulumi.resources.ResourceArgs {

    public static final StandaloneGatewayArgs Empty = new StandaloneGatewayArgs();
    ...
    private Output<StandaloneGatewaySkuArgs> sku;

    /**
     * @return A `sku` block as defined below.
     * 
     */
    public Output<StandaloneGatewaySkuArgs> sku() {
        return this.sku;
    }
    ...
    private StandaloneGatewayArgs() {}

    private StandaloneGatewayArgs(StandaloneGatewayArgs $) {
    ...
    public static Builder builder(StandaloneGatewayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StandaloneGatewayArgs();
        }

        public Builder(StandaloneGatewayArgs defaults) {
            $ = new StandaloneGatewayArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sku(Output<StandaloneGatewaySkuArgs> sku) {
            $.sku = sku;
            return this;
        }
        ...
        public StandaloneGatewayArgs build() {
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("StandaloneGatewayArgs", "resourceGroupName");
            }
            if ($.sku == null) {
                throw new MissingRequiredPropertyException("StandaloneGatewayArgs", "sku");
            }
            return $;
        }
    }
