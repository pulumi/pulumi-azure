...
public final class ServiceAccountIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(ServiceAccountIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceAccountIdentityArgs();
        }
        ...
        public ServiceAccountIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ServiceAccountIdentityArgs", "type");
            }
            return $;
        }
    }
