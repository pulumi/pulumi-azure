...
@CustomType
public final class DataFlowSinkFlowlet {
    /**
    ...
    public static Builder builder(DataFlowSinkFlowlet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> parameters;
        public Builder() {}
        public Builder(DataFlowSinkFlowlet defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DataFlowSinkFlowlet", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public DataFlowSinkFlowlet build() {
            final var _resultValue = new DataFlowSinkFlowlet();
