    ...
    public static final class Builder {
        ...
        public Builder failOverDirections(List<String> failOverDirections) {
            if (failOverDirections == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPreAction", "failOverDirections");
            }
        ...
        public Builder failOverTypes(List<String> failOverTypes) {
            if (failOverTypes == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPreAction", "failOverTypes");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPreAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPreAction", "type");
            }
            this.type = type;
            return this;
        }
        public ReplicationRecoveryPlanShutdownRecoveryGroupPreAction build() {
            final var _resultValue = new ReplicationRecoveryPlanShutdownRecoveryGroupPreAction();
