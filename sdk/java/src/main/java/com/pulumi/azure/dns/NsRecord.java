...
public class NsRecord extends com.pulumi.resources.CustomResource {
     ...
     */
    public NsRecord(java.lang.String name) {
     ...
     */
    public NsRecord(java.lang.String name, NsRecordArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NsRecord(java.lang.String name, NsRecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:dns/nsRecord:NsRecord", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NsRecord(java.lang.String name, Output<java.lang.String> id, @Nullable NsRecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:dns/nsRecord:NsRecord", name, state, makeResourceOptions(options, id), false);
    }

    private static NsRecordArgs makeArgs(NsRecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? NsRecordArgs.Empty : args;
    }
     ...
     */
    public static NsRecord get(java.lang.String name, Output<java.lang.String> id, @Nullable NsRecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
