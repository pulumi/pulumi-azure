...
public final class FunctionAppSlotAuthSettingsGoogleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public FunctionAppSlotAuthSettingsGoogleArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("FunctionAppSlotAuthSettingsGoogleArgs", "clientId");
            }
            if ($.clientSecret == null) {
                throw new MissingRequiredPropertyException("FunctionAppSlotAuthSettingsGoogleArgs", "clientSecret");
            }
            return $;
        }
    }
