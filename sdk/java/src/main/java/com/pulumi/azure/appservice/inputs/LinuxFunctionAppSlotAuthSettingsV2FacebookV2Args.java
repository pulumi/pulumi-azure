...
public final class LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args Empty = new LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args();
    ...
    private LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args() {}

    private LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args(LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
