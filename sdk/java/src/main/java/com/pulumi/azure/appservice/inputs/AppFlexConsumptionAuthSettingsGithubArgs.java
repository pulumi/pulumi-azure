...
public final class AppFlexConsumptionAuthSettingsGithubArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsGithubArgs Empty = new AppFlexConsumptionAuthSettingsGithubArgs();
    ...
    private AppFlexConsumptionAuthSettingsGithubArgs() {}

    private AppFlexConsumptionAuthSettingsGithubArgs(AppFlexConsumptionAuthSettingsGithubArgs $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsGithubArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsGithubArgs();
        }

        public Builder(AppFlexConsumptionAuthSettingsGithubArgs defaults) {
            $ = new AppFlexConsumptionAuthSettingsGithubArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsGithubArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsGithubArgs", "clientId");
            }
            return $;
        }
    }
