...
@CustomType
public final class SubscriptionPolicyAssignmentResourceSelectorSelector {
    private @Nullable List<String> ins;
    private String kind;
    private @Nullable List<String> notIns;

    private SubscriptionPolicyAssignmentResourceSelectorSelector() {}
    ...
    public static Builder builder(SubscriptionPolicyAssignmentResourceSelectorSelector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> notIns;
        public Builder() {}
        public Builder(SubscriptionPolicyAssignmentResourceSelectorSelector defaults) {
        ...
        public SubscriptionPolicyAssignmentResourceSelectorSelector build() {
            final var _resultValue = new SubscriptionPolicyAssignmentResourceSelectorSelector();
