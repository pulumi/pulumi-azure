...
public class ScheduledQueryRulesAlertV2 extends com.pulumi.resources.CustomResource {
    ...
    public ScheduledQueryRulesAlertV2(String name, ScheduledQueryRulesAlertV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:monitoring/scheduledQueryRulesAlertV2:ScheduledQueryRulesAlertV2", name, args == null ? ScheduledQueryRulesAlertV2Args.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
