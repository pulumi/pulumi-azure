...
public final class GetBackupPolicyArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetBackupPolicyArgs build() {
            if ($.accountName == null) {
                throw new MissingRequiredPropertyException("GetBackupPolicyArgs", "accountName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetBackupPolicyArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetBackupPolicyArgs", "resourceGroupName");
            }
            return $;
        }
    }
