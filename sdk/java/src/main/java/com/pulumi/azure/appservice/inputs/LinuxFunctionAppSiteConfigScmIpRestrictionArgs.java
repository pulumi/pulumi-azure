...
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppSiteConfigScmIpRestrictionHeadersArgs;
...
public final class LinuxFunctionAppSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSiteConfigScmIpRestrictionArgs Empty = new LinuxFunctionAppSiteConfigScmIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxFunctionAppSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<LinuxFunctionAppSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxFunctionAppSiteConfigScmIpRestrictionArgs() {}

    private LinuxFunctionAppSiteConfigScmIpRestrictionArgs(LinuxFunctionAppSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxFunctionAppSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSiteConfigScmIpRestrictionArgs();
        }

        public Builder(LinuxFunctionAppSiteConfigScmIpRestrictionArgs defaults) {
            $ = new LinuxFunctionAppSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxFunctionAppSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxFunctionAppSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public LinuxFunctionAppSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
