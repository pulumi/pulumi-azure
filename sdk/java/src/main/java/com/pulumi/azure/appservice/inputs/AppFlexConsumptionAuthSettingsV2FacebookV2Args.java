...
public final class AppFlexConsumptionAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsV2FacebookV2Args Empty = new AppFlexConsumptionAuthSettingsV2FacebookV2Args();
    ...
    private AppFlexConsumptionAuthSettingsV2FacebookV2Args() {}

    private AppFlexConsumptionAuthSettingsV2FacebookV2Args(AppFlexConsumptionAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsV2FacebookV2Args();
        }

        public Builder(AppFlexConsumptionAuthSettingsV2FacebookV2Args defaults) {
            $ = new AppFlexConsumptionAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
