...
public final class HadoopClusterComputeIsolation {
    ...
    public static Builder builder(HadoopClusterComputeIsolation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String hostSku;
        public Builder() {}
        public Builder(HadoopClusterComputeIsolation defaults) {
        ...
        public HadoopClusterComputeIsolation build() {
            final var _resultValue = new HadoopClusterComputeIsolation();
