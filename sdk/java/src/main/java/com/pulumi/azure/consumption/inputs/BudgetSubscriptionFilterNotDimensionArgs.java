...
public final class BudgetSubscriptionFilterNotDimensionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BudgetSubscriptionFilterNotDimensionArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("BudgetSubscriptionFilterNotDimensionArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetSubscriptionFilterNotDimensionArgs", "values");
            }
            return $;
        }
    }
