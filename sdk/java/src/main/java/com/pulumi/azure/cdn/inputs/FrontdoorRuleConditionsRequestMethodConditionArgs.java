...
public final class FrontdoorRuleConditionsRequestMethodConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsRequestMethodConditionArgs Empty = new FrontdoorRuleConditionsRequestMethodConditionArgs();
    ...
    private FrontdoorRuleConditionsRequestMethodConditionArgs() {}

    private FrontdoorRuleConditionsRequestMethodConditionArgs(FrontdoorRuleConditionsRequestMethodConditionArgs $) {
    ...
    public static Builder builder(FrontdoorRuleConditionsRequestMethodConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsRequestMethodConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsRequestMethodConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsRequestMethodConditionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param matchValues A list of one or more HTTP methods. Possible values include `GET`, `POST`, `PUT`, `DELETE`, `HEAD`, `OPTIONS` or `TRACE`. If multiple values are specified, they&#39;re evaluated using `OR` logic.
         * 
         * @return builder
         * 
         */
        ...
        public FrontdoorRuleConditionsRequestMethodConditionArgs build() {
            if ($.matchValues == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsRequestMethodConditionArgs", "matchValues");
            }
            return $;
        }
    }
