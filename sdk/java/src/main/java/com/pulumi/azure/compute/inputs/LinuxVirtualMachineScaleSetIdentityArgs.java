...
public final class LinuxVirtualMachineScaleSetIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxVirtualMachineScaleSetIdentityArgs Empty = new LinuxVirtualMachineScaleSetIdentityArgs();
    ...
    private LinuxVirtualMachineScaleSetIdentityArgs() {}

    private LinuxVirtualMachineScaleSetIdentityArgs(LinuxVirtualMachineScaleSetIdentityArgs $) {
    ...
    public static Builder builder(LinuxVirtualMachineScaleSetIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxVirtualMachineScaleSetIdentityArgs();
        }

        public Builder(LinuxVirtualMachineScaleSetIdentityArgs defaults) {
            $ = new LinuxVirtualMachineScaleSetIdentityArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param identityIds Specifies a list of User Assigned Managed Identity IDs to be assigned to this Linux Virtual Machine Scale Set.
         * 
         * &gt; **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
         * 
         * @return builder
        ...
        /**
         * @param type Specifies the type of Managed Service Identity that should be configured on this Linux Virtual Machine Scale Set. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
         * 
         * @return builder
         * 
         */
        ...
        public LinuxVirtualMachineScaleSetIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("LinuxVirtualMachineScaleSetIdentityArgs", "type");
            }
            return $;
        }
    }
