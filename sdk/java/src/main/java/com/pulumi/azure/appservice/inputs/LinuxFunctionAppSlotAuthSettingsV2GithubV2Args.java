...
public final class LinuxFunctionAppSlotAuthSettingsV2GithubV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LinuxFunctionAppSlotAuthSettingsV2GithubV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2GithubV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2GithubV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
