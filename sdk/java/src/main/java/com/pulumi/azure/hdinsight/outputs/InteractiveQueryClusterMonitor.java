...
@CustomType
public final class InteractiveQueryClusterMonitor {
    /**
    ...
    private InteractiveQueryClusterMonitor() {}
    /**
     * @return The Operations Management Suite (OMS) workspace ID.
     * 
     */
    ...
    public static Builder builder(InteractiveQueryClusterMonitor defaults) {
    ...
    public static final class Builder {
        ...
        private String primaryKey;
        public Builder() {}
        public Builder(InteractiveQueryClusterMonitor defaults) {
        ...
        public Builder logAnalyticsWorkspaceId(String logAnalyticsWorkspaceId) {
            if (logAnalyticsWorkspaceId == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterMonitor", "logAnalyticsWorkspaceId");
            }
        ...
        public Builder primaryKey(String primaryKey) {
            if (primaryKey == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterMonitor", "primaryKey");
            }
