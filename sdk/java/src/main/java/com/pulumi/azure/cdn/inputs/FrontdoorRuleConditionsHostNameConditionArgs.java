...
public final class FrontdoorRuleConditionsHostNameConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsHostNameConditionArgs Empty = new FrontdoorRuleConditionsHostNameConditionArgs();
    ...
    private FrontdoorRuleConditionsHostNameConditionArgs() {}

    private FrontdoorRuleConditionsHostNameConditionArgs(FrontdoorRuleConditionsHostNameConditionArgs $) {
    ...
    public static Builder builder(FrontdoorRuleConditionsHostNameConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsHostNameConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsHostNameConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsHostNameConditionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param matchValues A list of one or more string values representing the value of the request hostname to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
         * 
         * @return builder
         * 
         */
        ...
        public FrontdoorRuleConditionsHostNameConditionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsHostNameConditionArgs", "operator");
            }
            return $;
        }
    }
