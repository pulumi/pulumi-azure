...
public final class LinuxWebAppSlotLogsApplicationLogsAzureBlobStorage {
    ...
    public static final class Builder {
        ...
        public Builder level(String level) {
            if (level == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotLogsApplicationLogsAzureBlobStorage", "level");
            }
            this.level = level;
            return this;
        }
        ...
        public Builder retentionInDays(Integer retentionInDays) {
            if (retentionInDays == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotLogsApplicationLogsAzureBlobStorage", "retentionInDays");
            }
        ...
        public Builder sasUrl(String sasUrl) {
            if (sasUrl == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotLogsApplicationLogsAzureBlobStorage", "sasUrl");
            }
            this.sasUrl = sasUrl;
            return this;
        }
        public LinuxWebAppSlotLogsApplicationLogsAzureBlobStorage build() {
            final var _resultValue = new LinuxWebAppSlotLogsApplicationLogsAzureBlobStorage();
