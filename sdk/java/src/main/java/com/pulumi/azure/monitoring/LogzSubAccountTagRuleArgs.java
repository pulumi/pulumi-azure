...
public final class LogzSubAccountTagRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final LogzSubAccountTagRuleArgs Empty = new LogzSubAccountTagRuleArgs();

    /**
     * The ID of the Logz Sub Account. Changing this forces a new Logz Sub Account Tag Rule to be created.
     * 
     */
    @Import(name="logzSubAccountId", required=true)
    ...
    private LogzSubAccountTagRuleArgs() {}

    private LogzSubAccountTagRuleArgs(LogzSubAccountTagRuleArgs $) {
    ...
    public static Builder builder(LogzSubAccountTagRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogzSubAccountTagRuleArgs();
        }

        public Builder(LogzSubAccountTagRuleArgs defaults) {
            $ = new LogzSubAccountTagRuleArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder logzSubAccountId(Output<String> logzSubAccountId) {
