...
public final class LinuxWebAppSlotAuthSettingsV2TwitterV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsV2TwitterV2Args Empty = new LinuxWebAppSlotAuthSettingsV2TwitterV2Args();
    ...
    private LinuxWebAppSlotAuthSettingsV2TwitterV2Args() {}

    private LinuxWebAppSlotAuthSettingsV2TwitterV2Args(LinuxWebAppSlotAuthSettingsV2TwitterV2Args $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2TwitterV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsV2TwitterV2Args();
        }

        public Builder(LinuxWebAppSlotAuthSettingsV2TwitterV2Args defaults) {
            $ = new LinuxWebAppSlotAuthSettingsV2TwitterV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsV2TwitterV2Args build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2TwitterV2Args", "consumerKey");
            }
            if ($.consumerSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2TwitterV2Args", "consumerSecretSettingName");
            }
            return $;
        }
    }
