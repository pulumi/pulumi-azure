...
public final class LogzSubAccountTagRuleTagFilter {
    ...
    public static final class Builder {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("LogzSubAccountTagRuleTagFilter", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("LogzSubAccountTagRuleTagFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public LogzSubAccountTagRuleTagFilter build() {
            final var _resultValue = new LogzSubAccountTagRuleTagFilter();
