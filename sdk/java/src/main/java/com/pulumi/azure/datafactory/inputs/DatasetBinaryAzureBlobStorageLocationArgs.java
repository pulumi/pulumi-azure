...
public final class DatasetBinaryAzureBlobStorageLocationArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetBinaryAzureBlobStorageLocationArgs Empty = new DatasetBinaryAzureBlobStorageLocationArgs();
    ...
    private DatasetBinaryAzureBlobStorageLocationArgs() {}

    private DatasetBinaryAzureBlobStorageLocationArgs(DatasetBinaryAzureBlobStorageLocationArgs $) {
    ...
    public static Builder builder(DatasetBinaryAzureBlobStorageLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetBinaryAzureBlobStorageLocationArgs();
        }

        public Builder(DatasetBinaryAzureBlobStorageLocationArgs defaults) {
            $ = new DatasetBinaryAzureBlobStorageLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param filename The filename of the file in the blob container.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param path The folder path to the file in the blob container.
         * 
         * @return builder
         * 
         */
        ...
        public DatasetBinaryAzureBlobStorageLocationArgs build() {
            if ($.container == null) {
                throw new MissingRequiredPropertyException("DatasetBinaryAzureBlobStorageLocationArgs", "container");
            }
            return $;
        }
    }
