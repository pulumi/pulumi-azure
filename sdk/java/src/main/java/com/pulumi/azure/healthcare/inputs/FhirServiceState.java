...
public final class FhirServiceState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<FhirServiceAuthenticationArgs> authentication;

    /**
     * @return An `authentication` block as defined below.
     * 
     */
    public Optional<Output<FhirServiceAuthenticationArgs>> authentication() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder authentication(@Nullable Output<FhirServiceAuthenticationArgs> authentication) {
