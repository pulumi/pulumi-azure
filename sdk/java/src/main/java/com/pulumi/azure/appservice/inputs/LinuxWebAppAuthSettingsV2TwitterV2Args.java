...
public final class LinuxWebAppAuthSettingsV2TwitterV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsV2TwitterV2Args Empty = new LinuxWebAppAuthSettingsV2TwitterV2Args();
    ...
    private LinuxWebAppAuthSettingsV2TwitterV2Args() {}

    private LinuxWebAppAuthSettingsV2TwitterV2Args(LinuxWebAppAuthSettingsV2TwitterV2Args $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2TwitterV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsV2TwitterV2Args();
        }

        public Builder(LinuxWebAppAuthSettingsV2TwitterV2Args defaults) {
            $ = new LinuxWebAppAuthSettingsV2TwitterV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsV2TwitterV2Args build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2TwitterV2Args", "consumerKey");
            }
            if ($.consumerSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2TwitterV2Args", "consumerSecretSettingName");
            }
            return $;
        }
    }
