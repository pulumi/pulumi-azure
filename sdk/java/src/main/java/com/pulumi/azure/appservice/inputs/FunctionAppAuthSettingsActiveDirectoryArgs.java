...
public final class FunctionAppAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppAuthSettingsActiveDirectoryArgs Empty = new FunctionAppAuthSettingsActiveDirectoryArgs();
    ...
    private FunctionAppAuthSettingsActiveDirectoryArgs() {}

    private FunctionAppAuthSettingsActiveDirectoryArgs(FunctionAppAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(FunctionAppAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppAuthSettingsActiveDirectoryArgs();
        }

        public Builder(FunctionAppAuthSettingsActiveDirectoryArgs defaults) {
            $ = new FunctionAppAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionAppAuthSettingsActiveDirectoryArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("FunctionAppAuthSettingsActiveDirectoryArgs", "clientId");
            }
            return $;
        }
    }
