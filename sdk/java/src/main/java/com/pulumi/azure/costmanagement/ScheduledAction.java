 ...
 *             .emailAddressSender("platformteam{@literal @}test.com")
 *             .emailSubject("Cost Management Report")
 *             .emailAddresses("example{@literal @}example.com")
...
public class ScheduledAction extends com.pulumi.resources.CustomResource {
    ...
    public ScheduledAction(String name, ScheduledActionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:costmanagement/scheduledAction:ScheduledAction", name, args == null ? ScheduledActionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ScheduledAction(String name, Output<String> id, @Nullable ScheduledActionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:costmanagement/scheduledAction:ScheduledAction", name, state, makeResourceOptions(options, id));
    }
