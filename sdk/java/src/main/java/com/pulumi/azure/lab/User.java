...
import com.pulumi.azure.lab.inputs.UserState;
 ...
 *             .labId(exampleLab.id())
 *             .email("terraform-acctest}{@literal @}{@code example.com")
 *             .build());
 * 
 *     }}{@code
 * }}{@code
 ...
 * 
 */
@ResourceType(type="azure:lab/user:User")
public class User extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<Optional<String>> additionalUsageQuota() {
        return Codegen.optional(this.additionalUsageQuota);
    }
    /**
    ...
    public User(java.lang.String name, UserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:lab/user:User", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private User(java.lang.String name, Output<java.lang.String> id, @Nullable UserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:lab/user:User", name, state, makeResourceOptions(options, id), false);
    }
