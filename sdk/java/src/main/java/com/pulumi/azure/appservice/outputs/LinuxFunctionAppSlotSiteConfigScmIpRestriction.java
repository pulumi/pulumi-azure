...
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders;
...
@CustomType
public final class LinuxFunctionAppSlotSiteConfigScmIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers;
    /**
    ...
    private LinuxFunctionAppSlotSiteConfigScmIpRestriction(
        ...
        @CustomType.Parameter("headers") @Nullable LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(LinuxFunctionAppSlotSiteConfigScmIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers;
        ...
        public Builder(LinuxFunctionAppSlotSiteConfigScmIpRestriction defaults) {
        ...
        public Builder headers(@Nullable LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public LinuxFunctionAppSlotSiteConfigScmIpRestriction build() {
            return new LinuxFunctionAppSlotSiteConfigScmIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
