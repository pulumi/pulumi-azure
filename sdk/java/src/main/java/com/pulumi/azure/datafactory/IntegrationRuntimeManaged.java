...
public class IntegrationRuntimeManaged extends com.pulumi.resources.CustomResource {
     ...
     */
    public IntegrationRuntimeManaged(java.lang.String name) {
     ...
     */
    public IntegrationRuntimeManaged(java.lang.String name, IntegrationRuntimeManagedArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IntegrationRuntimeManaged(java.lang.String name, IntegrationRuntimeManagedArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/integrationRuntimeManaged:IntegrationRuntimeManaged", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IntegrationRuntimeManaged(java.lang.String name, Output<java.lang.String> id, @Nullable IntegrationRuntimeManagedState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/integrationRuntimeManaged:IntegrationRuntimeManaged", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static IntegrationRuntimeManaged get(java.lang.String name, Output<java.lang.String> id, @Nullable IntegrationRuntimeManagedState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
