...
public final class OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs() {}

    private OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs(OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs $) {
    ...
    public static Builder builder(OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs();
        }

        public Builder(OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs defaults) {
            $ = new OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param pauseTimeBetweenBatches The wait time between completing the update for all virtual machines in one batch and starting the next batch. The time duration should be specified in ISO 8601 duration format.
         * 
         * @return builder
         * 
         */
        ...
        public OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs build() {
            if ($.maxBatchInstancePercent == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs", "maxBatchInstancePercent");
            }
            if ($.maxUnhealthyInstancePercent == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs", "maxUnhealthyInstancePercent");
            }
            if ($.maxUnhealthyUpgradedInstancePercent == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs", "maxUnhealthyUpgradedInstancePercent");
            }
            if ($.pauseTimeBetweenBatches == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetRollingUpgradePolicyArgs", "pauseTimeBetweenBatches");
            }
            return $;
        }
    }
