...
public final class InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs extends com.pulumi.resources.ResourceArgs {

    public static final InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs Empty = new InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs();
    ...
    private InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs() {}

    private InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs(InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs $) {
        this.days = $.days;
    ...
    public static Builder builder(InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs();
        }

        public Builder(InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs defaults) {
            $ = new InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs build() {
            if ($.days == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs", "days");
            }
            if ($.targetInstanceCount == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs", "targetInstanceCount");
            }
            if ($.time == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterRolesWorkerNodeAutoscaleRecurrenceScheduleArgs", "time");
            }
            return $;
        }
    }
