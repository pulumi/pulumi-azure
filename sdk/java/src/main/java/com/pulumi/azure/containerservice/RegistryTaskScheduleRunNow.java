...
public class RegistryTaskScheduleRunNow extends com.pulumi.resources.CustomResource {
    ...
    public RegistryTaskScheduleRunNow(String name, RegistryTaskScheduleRunNowArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:containerservice/registryTaskScheduleRunNow:RegistryTaskScheduleRunNow", name, args == null ? RegistryTaskScheduleRunNowArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
