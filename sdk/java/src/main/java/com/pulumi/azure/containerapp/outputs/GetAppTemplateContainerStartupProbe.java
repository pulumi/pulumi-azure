...
public final class GetAppTemplateContainerStartupProbe {
     ...
     * 
     */
    private List<GetAppTemplateContainerStartupProbeHeader> headers;
    /**
     ...
     * 
     */
    public List<GetAppTemplateContainerStartupProbeHeader> headers() {
        return this.headers;
    }
    /**
     * @return The value for the host header which should be sent with this probe. If unspecified, the IP Address of the Pod is used as the host header. Setting a value for `Host` in `headers` can be used to override this for `HTTP` and `HTTPS` type probes.
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder headers(List<GetAppTemplateContainerStartupProbeHeader> headers) {
            if (headers == null) {
        ...
        public Builder initialDelay(Integer initialDelay) {
            if (initialDelay == null) {
              throw new MissingRequiredPropertyException("GetAppTemplateContainerStartupProbe", "initialDelay");
            }
