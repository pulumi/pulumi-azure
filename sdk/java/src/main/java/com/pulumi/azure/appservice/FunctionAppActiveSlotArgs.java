...
public final class FunctionAppActiveSlotArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppActiveSlotArgs Empty = new FunctionAppActiveSlotArgs();
    ...
    private FunctionAppActiveSlotArgs() {}

    private FunctionAppActiveSlotArgs(FunctionAppActiveSlotArgs $) {
    ...
    public static Builder builder(FunctionAppActiveSlotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppActiveSlotArgs();
        }

        public Builder(FunctionAppActiveSlotArgs defaults) {
            $ = new FunctionAppActiveSlotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionAppActiveSlotArgs build() {
            if ($.slotId == null) {
                throw new MissingRequiredPropertyException("FunctionAppActiveSlotArgs", "slotId");
            }
            return $;
        }
    }
