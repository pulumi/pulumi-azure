...
@CustomType
public final class TransformOutputCustomPresetFilterFadeOut {
    /**
    ...
    private TransformOutputCustomPresetFilterFadeOut() {}
    /**
     * @return The duration of the fade effect in the video. The value can be in ISO 8601 format (For example, PT05S to fade In/Out a color during 5 seconds), or a frame count (For example, 10 to fade 10 frames from the start time), or a relative value to stream duration (For example, 10% to fade 10% of stream duration).
     * 
     */
    ...
    public static Builder builder(TransformOutputCustomPresetFilterFadeOut defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String start;
        public Builder() {}
        public Builder(TransformOutputCustomPresetFilterFadeOut defaults) {
        ...
        public Builder duration(String duration) {
            if (duration == null) {
              throw new MissingRequiredPropertyException("TransformOutputCustomPresetFilterFadeOut", "duration");
            }
        ...
        public Builder fadeColor(String fadeColor) {
            if (fadeColor == null) {
              throw new MissingRequiredPropertyException("TransformOutputCustomPresetFilterFadeOut", "fadeColor");
            }
