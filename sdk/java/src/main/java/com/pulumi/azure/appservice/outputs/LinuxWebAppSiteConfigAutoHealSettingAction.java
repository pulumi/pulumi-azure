...
@CustomType
public final class LinuxWebAppSiteConfigAutoHealSettingAction {
    /**
    ...
    public static Builder builder(LinuxWebAppSiteConfigAutoHealSettingAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String minimumProcessExecutionTime;
        public Builder() {}
        public Builder(LinuxWebAppSiteConfigAutoHealSettingAction defaults) {
        ...
        public Builder actionType(String actionType) {
            if (actionType == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSiteConfigAutoHealSettingAction", "actionType");
            }
