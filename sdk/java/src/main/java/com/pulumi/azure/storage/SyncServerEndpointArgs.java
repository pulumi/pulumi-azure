...
public final class SyncServerEndpointArgs extends com.pulumi.resources.ResourceArgs {

    public static final SyncServerEndpointArgs Empty = new SyncServerEndpointArgs();
     ...
     * 
     */
    @Import(name="registeredServerId", required=true)
     ...
     * 
     */
    @Import(name="serverLocalPath", required=true)
    ...
    private SyncServerEndpointArgs() {}

    private SyncServerEndpointArgs(SyncServerEndpointArgs $) {
    ...
    public static Builder builder(SyncServerEndpointArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SyncServerEndpointArgs();
        }

        public Builder(SyncServerEndpointArgs defaults) {
            $ = new SyncServerEndpointArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder registeredServerId(Output<String> registeredServerId) {
         ...
         * 
         */
        public Builder serverLocalPath(Output<String> serverLocalPath) {
        ...
        public SyncServerEndpointArgs build() {
            if ($.registeredServerId == null) {
                throw new MissingRequiredPropertyException("SyncServerEndpointArgs", "registeredServerId");
            }
            if ($.serverLocalPath == null) {
                throw new MissingRequiredPropertyException("SyncServerEndpointArgs", "serverLocalPath");
            }
            if ($.storageSyncGroupId == null) {
                throw new MissingRequiredPropertyException("SyncServerEndpointArgs", "storageSyncGroupId");
            }
            return $;
        }
    }
