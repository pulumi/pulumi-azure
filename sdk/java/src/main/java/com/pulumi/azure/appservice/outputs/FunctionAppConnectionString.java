...
public final class FunctionAppConnectionString {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("FunctionAppConnectionString", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("FunctionAppConnectionString", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("FunctionAppConnectionString", "value");
            }
            this.value = value;
            return this;
        }
        public FunctionAppConnectionString build() {
            final var _resultValue = new FunctionAppConnectionString();
