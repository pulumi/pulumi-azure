...
public final class WindowsWebAppSlotAuthSettingsV2TwitterV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsV2TwitterV2Args Empty = new WindowsWebAppSlotAuthSettingsV2TwitterV2Args();
    ...
    private WindowsWebAppSlotAuthSettingsV2TwitterV2Args() {}

    private WindowsWebAppSlotAuthSettingsV2TwitterV2Args(WindowsWebAppSlotAuthSettingsV2TwitterV2Args $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2TwitterV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsV2TwitterV2Args();
        }

        public Builder(WindowsWebAppSlotAuthSettingsV2TwitterV2Args defaults) {
            $ = new WindowsWebAppSlotAuthSettingsV2TwitterV2Args(Objects.requireNonNull(defaults));
        }
