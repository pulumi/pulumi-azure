...
public final class FunctionAppSlotAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppSlotAuthSettingsActiveDirectoryArgs Empty = new FunctionAppSlotAuthSettingsActiveDirectoryArgs();
    ...
    private FunctionAppSlotAuthSettingsActiveDirectoryArgs() {}

    private FunctionAppSlotAuthSettingsActiveDirectoryArgs(FunctionAppSlotAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(FunctionAppSlotAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppSlotAuthSettingsActiveDirectoryArgs();
        }

        public Builder(FunctionAppSlotAuthSettingsActiveDirectoryArgs defaults) {
            $ = new FunctionAppSlotAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionAppSlotAuthSettingsActiveDirectoryArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("FunctionAppSlotAuthSettingsActiveDirectoryArgs", "clientId");
            }
            return $;
        }
    }
