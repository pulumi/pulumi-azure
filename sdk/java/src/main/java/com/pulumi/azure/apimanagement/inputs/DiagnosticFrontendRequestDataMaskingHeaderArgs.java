...
public final class DiagnosticFrontendRequestDataMaskingHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DiagnosticFrontendRequestDataMaskingHeaderArgs build() {
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("DiagnosticFrontendRequestDataMaskingHeaderArgs", "mode");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DiagnosticFrontendRequestDataMaskingHeaderArgs", "value");
            }
            return $;
        }
    }
