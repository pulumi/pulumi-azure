...
@CustomType
public final class FunctionAppSlotSiteConfigCors {
    /**
    ...
    private FunctionAppSlotSiteConfigCors() {}
    /**
     * @return A list of origins which should be able to make cross-origin calls. `*` can be used to allow all calls.
     * 
     */
    ...
    public static Builder builder(FunctionAppSlotSiteConfigCors defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean supportCredentials;
        public Builder() {}
        public Builder(FunctionAppSlotSiteConfigCors defaults) {
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("FunctionAppSlotSiteConfigCors", "allowedOrigins");
            }
        ...
        public FunctionAppSlotSiteConfigCors build() {
            final var _resultValue = new FunctionAppSlotSiteConfigCors();
