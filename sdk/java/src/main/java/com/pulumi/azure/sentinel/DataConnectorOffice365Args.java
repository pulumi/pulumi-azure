...
public final class DataConnectorOffice365Args extends com.pulumi.resources.ResourceArgs {

    public static final DataConnectorOffice365Args Empty = new DataConnectorOffice365Args();
    ...
    private DataConnectorOffice365Args() {}

    private DataConnectorOffice365Args(DataConnectorOffice365Args $) {
    ...
    public static Builder builder(DataConnectorOffice365Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataConnectorOffice365Args();
        }

        public Builder(DataConnectorOffice365Args defaults) {
            $ = new DataConnectorOffice365Args(Objects.requireNonNull(defaults));
        }
        ...
        public DataConnectorOffice365Args build() {
            if ($.logAnalyticsWorkspaceId == null) {
                throw new MissingRequiredPropertyException("DataConnectorOffice365Args", "logAnalyticsWorkspaceId");
            }
            return $;
        }
    }
