...
import com.pulumi.azure.appservice.inputs.SlotAuthSettingsActiveDirectoryArgs;
import com.pulumi.azure.appservice.inputs.SlotAuthSettingsFacebookArgs;
import com.pulumi.azure.appservice.inputs.SlotAuthSettingsGoogleArgs;
import com.pulumi.azure.appservice.inputs.SlotAuthSettingsMicrosoftArgs;
...
public final class SlotAuthSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final SlotAuthSettingsArgs Empty = new SlotAuthSettingsArgs();
    ...
    private @Nullable Output<SlotAuthSettingsActiveDirectoryArgs> activeDirectory;

    /**
     * @return A `activeDirectory` block as defined below.
     * 
     */
    public Optional<Output<SlotAuthSettingsActiveDirectoryArgs>> activeDirectory() {
    ...
    private @Nullable Output<SlotAuthSettingsFacebookArgs> facebook;

    /**
     * @return A `facebook` block as defined below.
     * 
     */
    public Optional<Output<SlotAuthSettingsFacebookArgs>> facebook() {
     ...
     */
    @Import(name="google")
    private @Nullable Output<SlotAuthSettingsGoogleArgs> google;

    /**
     * @return A `google` block as defined below.
     * 
     */
    public Optional<Output<SlotAuthSettingsGoogleArgs>> google() {
    ...
    private @Nullable Output<SlotAuthSettingsMicrosoftArgs> microsoft;

    /**
     * @return A `microsoft` block as defined below.
     * 
     */
    public Optional<Output<SlotAuthSettingsMicrosoftArgs>> microsoft() {
     ...
     */
    @Import(name="twitter")
    private @Nullable Output<SlotAuthSettingsTwitterArgs> twitter;

    /**
     * @return A `twitter` block as defined below.
     * 
     */
    public Optional<Output<SlotAuthSettingsTwitterArgs>> twitter() {
    ...
    private SlotAuthSettingsArgs() {}

    private SlotAuthSettingsArgs(SlotAuthSettingsArgs $) {
    ...
    public static Builder builder(SlotAuthSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SlotAuthSettingsArgs();
        }

        public Builder(SlotAuthSettingsArgs defaults) {
            $ = new SlotAuthSettingsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder activeDirectory(@Nullable Output<SlotAuthSettingsActiveDirectoryArgs> activeDirectory) {
         ...
         * 
         */
        public Builder activeDirectory(SlotAuthSettingsActiveDirectoryArgs activeDirectory) {
         ...
         * 
         */
        public Builder facebook(@Nullable Output<SlotAuthSettingsFacebookArgs> facebook) {
            $.facebook = facebook;
            return this;
        }
         ...
         * 
         */
        public Builder facebook(SlotAuthSettingsFacebookArgs facebook) {
         ...
         * 
         */
        public Builder google(@Nullable Output<SlotAuthSettingsGoogleArgs> google) {
            $.google = google;
            return this;
        }
         ...
         * 
         */
        public Builder google(SlotAuthSettingsGoogleArgs google) {
         ...
         * 
         */
        public Builder microsoft(@Nullable Output<SlotAuthSettingsMicrosoftArgs> microsoft) {
            $.microsoft = microsoft;
            return this;
        }
         ...
         * 
         */
        public Builder microsoft(SlotAuthSettingsMicrosoftArgs microsoft) {
         ...
         * 
         */
        public Builder twitter(@Nullable Output<SlotAuthSettingsTwitterArgs> twitter) {
            $.twitter = twitter;
            return this;
        }
         ...
         * 
         */
        public Builder twitter(SlotAuthSettingsTwitterArgs twitter) {
