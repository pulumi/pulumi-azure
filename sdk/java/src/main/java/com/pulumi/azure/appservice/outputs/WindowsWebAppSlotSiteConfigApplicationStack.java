...
public final class WindowsWebAppSlotSiteConfigApplicationStack {
    /**
     * @return The Application Stack for the Windows Web App Slot. Possible values include `dotnet`, `dotnetcore`, `node`, `python`, `php`, and `java`.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder pythonVersion(@Nullable String pythonVersion) {
            ...
            return new WindowsWebAppSlotSiteConfigApplicationStack(currentStack, dockerContainerName, dockerContainerRegistry, dockerContainerTag, dotnetVersion, javaContainer, javaContainerVersion, javaVersion, nodeVersion, phpVersion, pythonVersion);
        }
    }
}
