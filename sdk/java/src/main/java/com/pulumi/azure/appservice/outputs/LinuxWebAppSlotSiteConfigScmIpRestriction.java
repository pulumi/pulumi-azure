...
import com.pulumi.azure.appservice.outputs.LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders;
...
@CustomType
public final class LinuxWebAppSlotSiteConfigScmIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders headers;
    /**
    ...
    private LinuxWebAppSlotSiteConfigScmIpRestriction(
        @CustomType.Parameter("action") @Nullable String action,
        @CustomType.Parameter("headers") @Nullable LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(LinuxWebAppSlotSiteConfigScmIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders headers;
        ...
        public Builder(LinuxWebAppSlotSiteConfigScmIpRestriction defaults) {
        ...
        public Builder headers(@Nullable LinuxWebAppSlotSiteConfigScmIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public LinuxWebAppSlotSiteConfigScmIpRestriction build() {
            return new LinuxWebAppSlotSiteConfigScmIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
