...
public final class GetNsRecordArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetNsRecordArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNsRecordArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetNsRecordArgs", "resourceGroupName");
            }
            if ($.zoneName == null) {
                throw new MissingRequiredPropertyException("GetNsRecordArgs", "zoneName");
            }
            return $;
        }
    }
