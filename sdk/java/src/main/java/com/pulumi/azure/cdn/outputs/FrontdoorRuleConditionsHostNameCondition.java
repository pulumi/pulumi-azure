...
@CustomType
public final class FrontdoorRuleConditionsHostNameCondition {
    /**
     * @return A list of one or more string values representing the value of the request hostname to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
     * 
     */
    ...
    public static Builder builder(FrontdoorRuleConditionsHostNameCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> transforms;
        public Builder() {}
        public Builder(FrontdoorRuleConditionsHostNameCondition defaults) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleConditionsHostNameCondition", "operator");
            }
