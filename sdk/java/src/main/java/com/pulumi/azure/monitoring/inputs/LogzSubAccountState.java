...
public final class LogzSubAccountState extends com.pulumi.resources.ResourceArgs {

    public static final LogzSubAccountState Empty = new LogzSubAccountState();
    ...
    private LogzSubAccountState() {}

    private LogzSubAccountState(LogzSubAccountState $) {
    ...
    public static Builder builder(LogzSubAccountState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogzSubAccountState();
        }

        public Builder(LogzSubAccountState defaults) {
            $ = new LogzSubAccountState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder user(@Nullable Output<LogzSubAccountUserArgs> user) {
            $.user = user;
            return this;
        }
        ...
        public LogzSubAccountState build() {
            return $;
        }
    }
