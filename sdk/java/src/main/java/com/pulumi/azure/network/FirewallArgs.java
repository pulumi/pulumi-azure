...
public final class FirewallArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder skuTier(Output<String> skuTier) {
            $.skuTier = skuTier;
            return this;
        }
        ...
        public FirewallArgs build() {
            ...
            if ($.skuName == null) {
                throw new MissingRequiredPropertyException("FirewallArgs", "skuName");
            }
            if ($.skuTier == null) {
                throw new MissingRequiredPropertyException("FirewallArgs", "skuTier");
            }
            return $;
        }
    }
