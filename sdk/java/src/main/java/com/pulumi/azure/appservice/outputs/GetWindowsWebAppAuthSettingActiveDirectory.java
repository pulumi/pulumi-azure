    ...
    public static final class Builder {
        ...
        public Builder allowedAudiences(List<String> allowedAudiences) {
            if (allowedAudiences == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingActiveDirectory", "allowedAudiences");
            }
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingActiveDirectory", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingActiveDirectory", "clientSecret");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingActiveDirectory", "clientSecretSettingName");
            }
            this.clientSecretSettingName = clientSecretSettingName;
            return this;
        }
        public GetWindowsWebAppAuthSettingActiveDirectory build() {
            final var _resultValue = new GetWindowsWebAppAuthSettingActiveDirectory();
