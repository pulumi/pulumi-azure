...
public final class AccountTablePropertiesMinuteMetricsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountTablePropertiesMinuteMetricsArgs Empty = new AccountTablePropertiesMinuteMetricsArgs();
    ...
    private AccountTablePropertiesMinuteMetricsArgs() {}

    private AccountTablePropertiesMinuteMetricsArgs(AccountTablePropertiesMinuteMetricsArgs $) {
    ...
    public static Builder builder(AccountTablePropertiesMinuteMetricsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountTablePropertiesMinuteMetricsArgs();
        }

        public Builder(AccountTablePropertiesMinuteMetricsArgs defaults) {
            $ = new AccountTablePropertiesMinuteMetricsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountTablePropertiesMinuteMetricsArgs build() {
            if ($.version == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesMinuteMetricsArgs", "version");
            }
            return $;
        }
    }
