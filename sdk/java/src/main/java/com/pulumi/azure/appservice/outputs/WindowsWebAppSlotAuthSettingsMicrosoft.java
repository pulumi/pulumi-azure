...
@CustomType
public final class WindowsWebAppSlotAuthSettingsMicrosoft {
    /**
    ...
    private WindowsWebAppSlotAuthSettingsMicrosoft() {}
    /**
     * @return The OAuth 2.0 client ID that was created for the app used for authentication.
     * 
     */
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsMicrosoft defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(WindowsWebAppSlotAuthSettingsMicrosoft defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsMicrosoft", "clientId");
            }
        ...
        public WindowsWebAppSlotAuthSettingsMicrosoft build() {
            final var _resultValue = new WindowsWebAppSlotAuthSettingsMicrosoft();
