...
import com.pulumi.azure.apimanagement.outputs.ApiOperationResponseRepresentationFormParameterExample;
...
public final class ApiOperationResponseRepresentationFormParameter {
     ...
     * 
     */
    private @Nullable List<ApiOperationResponseRepresentationFormParameterExample> examples;
    /**
     ...
     * 
     */
    public List<ApiOperationResponseRepresentationFormParameterExample> examples() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder examples(@Nullable List<ApiOperationResponseRepresentationFormParameterExample> examples) {

            this.examples = examples;
            return this;
        }
        public Builder examples(ApiOperationResponseRepresentationFormParameterExample... examples) {
            return examples(List.of(examples));
        }
        @CustomType.Setter
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ApiOperationResponseRepresentationFormParameter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder required(Boolean required) {
            if (required == null) {
              throw new MissingRequiredPropertyException("ApiOperationResponseRepresentationFormParameter", "required");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ApiOperationResponseRepresentationFormParameter", "type");
            }
            this.type = type;
            return this;
        }
