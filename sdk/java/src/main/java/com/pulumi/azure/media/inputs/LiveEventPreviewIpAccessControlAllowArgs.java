...
public final class LiveEventPreviewIpAccessControlAllowArgs extends com.pulumi.resources.ResourceArgs {

    public static final LiveEventPreviewIpAccessControlAllowArgs Empty = new LiveEventPreviewIpAccessControlAllowArgs();
    ...
    private LiveEventPreviewIpAccessControlAllowArgs() {}

    private LiveEventPreviewIpAccessControlAllowArgs(LiveEventPreviewIpAccessControlAllowArgs $) {
    ...
    public static Builder builder(LiveEventPreviewIpAccessControlAllowArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LiveEventPreviewIpAccessControlAllowArgs();
        }

        public Builder(LiveEventPreviewIpAccessControlAllowArgs defaults) {
            $ = new LiveEventPreviewIpAccessControlAllowArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param address The IP address or CIDR range.
         * 
         * @return builder
         * 
         */
        ...
        public LiveEventPreviewIpAccessControlAllowArgs build() {
            return $;
        }
    }
