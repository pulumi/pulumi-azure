...
public final class KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs Empty = new KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs();
    ...
    private KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs() {}

    private KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs(KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs $) {
    ...
    public static Builder builder(KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs();
        }

        public Builder(KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs defaults) {
            $ = new KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KubernetesClusterWebAppRoutingWebAppRoutingIdentityArgs build() {
            return $;
        }
    }
