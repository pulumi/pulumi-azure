...
public final class LinuxFunctionAppSlotAuthSettingsTwitterArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotAuthSettingsTwitterArgs Empty = new LinuxFunctionAppSlotAuthSettingsTwitterArgs();
    ...
    private LinuxFunctionAppSlotAuthSettingsTwitterArgs() {}

    private LinuxFunctionAppSlotAuthSettingsTwitterArgs(LinuxFunctionAppSlotAuthSettingsTwitterArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsTwitterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsTwitterArgs();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsTwitterArgs defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsTwitterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsTwitterArgs build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsTwitterArgs", "consumerKey");
            }
            return $;
        }
    }
