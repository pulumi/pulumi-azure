...
public final class GetPublicIpPrefixArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetPublicIpPrefixArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPublicIpPrefixArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetPublicIpPrefixArgs", "resourceGroupName");
            }
            return $;
        }
    }
