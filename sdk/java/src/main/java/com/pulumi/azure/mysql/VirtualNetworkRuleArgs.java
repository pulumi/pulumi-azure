...
public final class VirtualNetworkRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param resourceGroupName The name of the resource group where the MySQL server resides. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serverName The name of the SQL Server to which this MySQL virtual network rule will be applied to. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param subnetId The ID of the subnet that the MySQL server will be connected to.
         * 
         * @return builder
         * 
         */
