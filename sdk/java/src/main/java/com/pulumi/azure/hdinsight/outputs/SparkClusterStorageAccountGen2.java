    ...
    public static final class Builder {
        ...
        public Builder storageAccountId(String storageAccountId) {
            if (storageAccountId == null) {
              throw new MissingRequiredPropertyException("SparkClusterStorageAccountGen2", "storageAccountId");
            }
        ...
        public Builder userAssignedIdentityId(String userAssignedIdentityId) {
            if (userAssignedIdentityId == null) {
              throw new MissingRequiredPropertyException("SparkClusterStorageAccountGen2", "userAssignedIdentityId");
            }
