...
public final class LinuxWebAppSlotAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsActiveDirectoryArgs Empty = new LinuxWebAppSlotAuthSettingsActiveDirectoryArgs();
    ...
    private LinuxWebAppSlotAuthSettingsActiveDirectoryArgs() {}

    private LinuxWebAppSlotAuthSettingsActiveDirectoryArgs(LinuxWebAppSlotAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsActiveDirectoryArgs();
        }

        public Builder(LinuxWebAppSlotAuthSettingsActiveDirectoryArgs defaults) {
            $ = new LinuxWebAppSlotAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsActiveDirectoryArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsActiveDirectoryArgs", "clientId");
            }
            return $;
        }
    }
