...
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionSiteConfigScmIpRestrictionHeadersArgs;
...
public final class AppFlexConsumptionSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionSiteConfigScmIpRestrictionArgs Empty = new AppFlexConsumptionSiteConfigScmIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<AppFlexConsumptionSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<AppFlexConsumptionSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private AppFlexConsumptionSiteConfigScmIpRestrictionArgs() {}

    private AppFlexConsumptionSiteConfigScmIpRestrictionArgs(AppFlexConsumptionSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(AppFlexConsumptionSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionSiteConfigScmIpRestrictionArgs();
        }

        public Builder(AppFlexConsumptionSiteConfigScmIpRestrictionArgs defaults) {
            $ = new AppFlexConsumptionSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<AppFlexConsumptionSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(AppFlexConsumptionSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public AppFlexConsumptionSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
