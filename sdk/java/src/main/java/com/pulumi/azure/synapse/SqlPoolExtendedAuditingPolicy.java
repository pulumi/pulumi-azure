...
public class SqlPoolExtendedAuditingPolicy extends com.pulumi.resources.CustomResource {
    ...
    public SqlPoolExtendedAuditingPolicy(String name, SqlPoolExtendedAuditingPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:synapse/sqlPoolExtendedAuditingPolicy:SqlPoolExtendedAuditingPolicy", name, args == null ? SqlPoolExtendedAuditingPolicyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
