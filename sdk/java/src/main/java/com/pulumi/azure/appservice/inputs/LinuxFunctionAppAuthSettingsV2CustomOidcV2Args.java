...
public final class LinuxFunctionAppAuthSettingsV2CustomOidcV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsV2CustomOidcV2Args Empty = new LinuxFunctionAppAuthSettingsV2CustomOidcV2Args();
    ...
    private LinuxFunctionAppAuthSettingsV2CustomOidcV2Args() {}

    private LinuxFunctionAppAuthSettingsV2CustomOidcV2Args(LinuxFunctionAppAuthSettingsV2CustomOidcV2Args $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2CustomOidcV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsV2CustomOidcV2Args();
        }

        public Builder(LinuxFunctionAppAuthSettingsV2CustomOidcV2Args defaults) {
            $ = new LinuxFunctionAppAuthSettingsV2CustomOidcV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsV2CustomOidcV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2CustomOidcV2Args", "clientId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2CustomOidcV2Args", "name");
            }
            if ($.openidConfigurationEndpoint == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2CustomOidcV2Args", "openidConfigurationEndpoint");
            }
            return $;
        }
    }
