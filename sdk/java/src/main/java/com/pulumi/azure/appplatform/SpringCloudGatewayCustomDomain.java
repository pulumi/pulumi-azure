...
public class SpringCloudGatewayCustomDomain extends com.pulumi.resources.CustomResource {
    ...
    public SpringCloudGatewayCustomDomain(String name, SpringCloudGatewayCustomDomainArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:appplatform/springCloudGatewayCustomDomain:SpringCloudGatewayCustomDomain", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
