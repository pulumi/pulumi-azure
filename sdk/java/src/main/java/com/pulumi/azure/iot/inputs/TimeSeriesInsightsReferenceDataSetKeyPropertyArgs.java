...
public final class TimeSeriesInsightsReferenceDataSetKeyPropertyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TimeSeriesInsightsReferenceDataSetKeyPropertyArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("TimeSeriesInsightsReferenceDataSetKeyPropertyArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("TimeSeriesInsightsReferenceDataSetKeyPropertyArgs", "type");
            }
            return $;
        }
    }
