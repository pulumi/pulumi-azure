...
public final class DiagnosticBackendRequestDataMaskingQueryParam {
    ...
    public static final class Builder {
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("DiagnosticBackendRequestDataMaskingQueryParam", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DiagnosticBackendRequestDataMaskingQueryParam", "value");
            }
            this.value = value;
            return this;
        }
        public DiagnosticBackendRequestDataMaskingQueryParam build() {
            final var _resultValue = new DiagnosticBackendRequestDataMaskingQueryParam();
