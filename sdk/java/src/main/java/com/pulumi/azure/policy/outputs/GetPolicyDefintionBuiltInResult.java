...
@CustomType
public final class GetPolicyDefintionBuiltInResult {
    /**
    ...
    public static Builder builder(GetPolicyDefintionBuiltInResult defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetPolicyDefintionBuiltInResult defaults) {
        ...
        public GetPolicyDefintionBuiltInResult build() {
            final var _resultValue = new GetPolicyDefintionBuiltInResult();
