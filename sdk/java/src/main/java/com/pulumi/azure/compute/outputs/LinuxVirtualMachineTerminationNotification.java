...
public final class LinuxVirtualMachineTerminationNotification {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("LinuxVirtualMachineTerminationNotification", "enabled");
            }
        ...
        public LinuxVirtualMachineTerminationNotification build() {
            final var _resultValue = new LinuxVirtualMachineTerminationNotification();
