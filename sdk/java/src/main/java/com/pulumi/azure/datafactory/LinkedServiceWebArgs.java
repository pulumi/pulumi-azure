    ...
    public static final class Builder {
        ...
        public LinkedServiceWebArgs build() {
            if ($.authenticationType == null) {
                throw new MissingRequiredPropertyException("LinkedServiceWebArgs", "authenticationType");
            }
            if ($.dataFactoryId == null) {
                throw new MissingRequiredPropertyException("LinkedServiceWebArgs", "dataFactoryId");
            }
            if ($.url == null) {
                throw new MissingRequiredPropertyException("LinkedServiceWebArgs", "url");
            }
            return $;
        }
    }
