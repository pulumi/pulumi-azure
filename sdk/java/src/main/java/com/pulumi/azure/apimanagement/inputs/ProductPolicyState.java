...
public final class ProductPolicyState extends com.pulumi.resources.ResourceArgs {

    public static final ProductPolicyState Empty = new ProductPolicyState();
    ...
    private ProductPolicyState() {}

    private ProductPolicyState(ProductPolicyState $) {
    ...
    public static Builder builder(ProductPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProductPolicyState();
        }

        public Builder(ProductPolicyState defaults) {
            $ = new ProductPolicyState(Objects.requireNonNull(defaults));
        }
        ...
        public ProductPolicyState build() {
            return $;
        }
    }
