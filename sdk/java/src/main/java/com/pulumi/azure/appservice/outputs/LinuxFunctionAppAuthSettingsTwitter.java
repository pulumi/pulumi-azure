...
@CustomType
public final class LinuxFunctionAppAuthSettingsTwitter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder consumerKey(String consumerKey) {
            if (consumerKey == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsTwitter", "consumerKey");
            }
        ...
        public LinuxFunctionAppAuthSettingsTwitter build() {
            final var _resultValue = new LinuxFunctionAppAuthSettingsTwitter();
