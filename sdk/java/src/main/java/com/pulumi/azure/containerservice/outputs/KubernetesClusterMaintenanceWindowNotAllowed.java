...
public final class KubernetesClusterMaintenanceWindowNotAllowed {
    ...
    public static final class Builder {
        ...
        public Builder end(String end) {
            if (end == null) {
              throw new MissingRequiredPropertyException("KubernetesClusterMaintenanceWindowNotAllowed", "end");
            }
            this.end = end;
            return this;
        }
        ...
        public Builder start(String start) {
            if (start == null) {
              throw new MissingRequiredPropertyException("KubernetesClusterMaintenanceWindowNotAllowed", "start");
            }
            this.start = start;
            return this;
        }
