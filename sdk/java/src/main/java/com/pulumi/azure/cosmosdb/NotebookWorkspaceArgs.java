...
public final class NotebookWorkspaceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NotebookWorkspaceArgs build() {
            if ($.accountName == null) {
                throw new MissingRequiredPropertyException("NotebookWorkspaceArgs", "accountName");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("NotebookWorkspaceArgs", "resourceGroupName");
            }
            return $;
        }
    }
