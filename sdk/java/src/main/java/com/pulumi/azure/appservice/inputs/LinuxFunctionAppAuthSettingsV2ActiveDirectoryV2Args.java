...
public final class LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args Empty = new LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args();
    ...
    private LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args() {}

    private LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args(LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args();
        }

        public Builder(LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args defaults) {
            $ = new LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args", "clientId");
            }
            if ($.tenantAuthEndpoint == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args", "tenantAuthEndpoint");
            }
            return $;
        }
    }
