...
@CustomType
public final class GetWindowsWebAppAuthSettingsV2AppleV2 {
    /**
    ...
    private GetWindowsWebAppAuthSettingsV2AppleV2() {}
    /**
     * @return The OAuth 2.0 client ID used by the app for authentication.
     * 
     */
    ...
    public static Builder builder(GetWindowsWebAppAuthSettingsV2AppleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> loginScopes;
        public Builder() {}
        public Builder(GetWindowsWebAppAuthSettingsV2AppleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingsV2AppleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingsV2AppleV2", "clientSecretSettingName");
            }
        ...
        public Builder loginScopes(List<String> loginScopes) {
            if (loginScopes == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingsV2AppleV2", "loginScopes");
            }
        ...
        public GetWindowsWebAppAuthSettingsV2AppleV2 build() {
            final var _resultValue = new GetWindowsWebAppAuthSettingsV2AppleV2();
