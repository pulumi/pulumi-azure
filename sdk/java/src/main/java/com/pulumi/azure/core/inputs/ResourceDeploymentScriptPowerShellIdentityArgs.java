...
public final class ResourceDeploymentScriptPowerShellIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ResourceDeploymentScriptPowerShellIdentityArgs build() {
            if ($.identityIds == null) {
                throw new MissingRequiredPropertyException("ResourceDeploymentScriptPowerShellIdentityArgs", "identityIds");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ResourceDeploymentScriptPowerShellIdentityArgs", "type");
            }
            return $;
        }
    }
