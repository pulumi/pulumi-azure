...
@CustomType
public final class ApiOperationRequestQueryParameterExample {
    /**
    ...
    private ApiOperationRequestQueryParameterExample() {}
    /**
     * @return A long description for this example.
     * 
     */
    ...
    public static Builder builder(ApiOperationRequestQueryParameterExample defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(ApiOperationRequestQueryParameterExample defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ApiOperationRequestQueryParameterExample", "name");
            }
            this.name = name;
            return this;
        }
