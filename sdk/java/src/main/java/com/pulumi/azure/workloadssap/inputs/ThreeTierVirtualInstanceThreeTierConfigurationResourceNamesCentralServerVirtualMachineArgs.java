...
public final class ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs extends com.pulumi.resources.ResourceArgs {

    public static final ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs Empty = new ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs();
    ...
    private @Nullable Output<List<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDiskArgs>> dataDisks;

    /**
     * @return One or more `data_disk` blocks as defined below. Changing this forces a new resource to be created.
     * 
     */
    public Optional<Output<List<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDiskArgs>>> dataDisks() {
    ...
    private ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs() {}

    private ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs(ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs $) {
    ...
    public static Builder builder(ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs();
        }

        public Builder(ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs defaults) {
            $ = new ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dataDisks(@Nullable Output<List<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDiskArgs>> dataDisks) {
            $.dataDisks = dataDisks;
            return this;
        }
         ...
         * 
         */
        public Builder dataDisks(List<ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDiskArgs> dataDisks) {
         ...
         * 
         */
        public Builder dataDisks(ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineDataDiskArgs... dataDisks) {
        ...
        public ThreeTierVirtualInstanceThreeTierConfigurationResourceNamesCentralServerVirtualMachineArgs build() {
            return $;
        }
    }
