...
public final class WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args Empty = new WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args();
    ...
    private WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args() {}

    private WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args(WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args(Objects.requireNonNull(defaults));
        }
