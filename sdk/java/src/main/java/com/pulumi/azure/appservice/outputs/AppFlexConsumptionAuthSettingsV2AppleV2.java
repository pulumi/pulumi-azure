...
@CustomType
public final class AppFlexConsumptionAuthSettingsV2AppleV2 {
    /**
    ...
    private AppFlexConsumptionAuthSettingsV2AppleV2() {}
    /**
     * @return The OpenID Connect Client ID for the Apple web application.
     * 
     */
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2AppleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsV2AppleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2AppleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2AppleV2", "clientSecretSettingName");
            }
        ...
        public AppFlexConsumptionAuthSettingsV2AppleV2 build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsV2AppleV2();
