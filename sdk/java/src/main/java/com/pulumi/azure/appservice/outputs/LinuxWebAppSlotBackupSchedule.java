...
public final class LinuxWebAppSlotBackupSchedule {
    ...
    public static Builder builder(LinuxWebAppSlotBackupSchedule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxWebAppSlotBackupSchedule defaults) {
        ...
        public Builder startTime(@Nullable String startTime) {
            this.startTime = startTime;
            return this;
        }        public LinuxWebAppSlotBackupSchedule build() {
            return new LinuxWebAppSlotBackupSchedule(frequencyInterval, frequencyUnit, keepAtLeastOneBackup, lastExecutionTime, retentionPeriodDays, startTime);
        }
    }
}
