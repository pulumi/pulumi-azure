...
public final class EndpointGlobalDeliveryRuleModifyResponseHeaderAction {
    ...
    public static final class Builder {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("EndpointGlobalDeliveryRuleModifyResponseHeaderAction", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("EndpointGlobalDeliveryRuleModifyResponseHeaderAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public EndpointGlobalDeliveryRuleModifyResponseHeaderAction build() {
            final var _resultValue = new EndpointGlobalDeliveryRuleModifyResponseHeaderAction();
