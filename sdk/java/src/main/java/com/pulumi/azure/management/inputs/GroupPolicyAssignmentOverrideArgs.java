...
public final class GroupPolicyAssignmentOverrideArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GroupPolicyAssignmentOverrideArgs() {}

    private GroupPolicyAssignmentOverrideArgs(GroupPolicyAssignmentOverrideArgs $) {
    ...
    public static Builder builder(GroupPolicyAssignmentOverrideArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GroupPolicyAssignmentOverrideArgs();
        }

        public Builder(GroupPolicyAssignmentOverrideArgs defaults) {
            $ = new GroupPolicyAssignmentOverrideArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder selectors(@Nullable Output<List<GroupPolicyAssignmentOverrideSelectorArgs>> selectors) {
            $.selectors = selectors;
            return this;
        }
         ...
         * 
         */
        public Builder selectors(List<GroupPolicyAssignmentOverrideSelectorArgs> selectors) {
         ...
         * 
         */
        public Builder selectors(GroupPolicyAssignmentOverrideSelectorArgs... selectors) {
