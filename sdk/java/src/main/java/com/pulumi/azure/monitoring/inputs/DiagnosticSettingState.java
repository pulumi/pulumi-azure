...
public final class DiagnosticSettingState extends com.pulumi.resources.ResourceArgs {

    public static final DiagnosticSettingState Empty = new DiagnosticSettingState();
    ...
    private DiagnosticSettingState() {}
    ...
    public static Builder builder(DiagnosticSettingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DiagnosticSettingState();
        }

        public Builder(DiagnosticSettingState defaults) {
            $ = new DiagnosticSettingState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param logAnalyticsDestinationType Possible values are `AzureDiagnostics` and `Dedicated`, default to `AzureDiagnostics`. When set to `Dedicated`, logs sent to a Log Analytics workspace will go into resource specific tables, instead of the legacy AzureDiagnostics table.
         * 
         * @return builder
         * 
         */
        ...
        public DiagnosticSettingState build() {
            return $;
        }
    }
