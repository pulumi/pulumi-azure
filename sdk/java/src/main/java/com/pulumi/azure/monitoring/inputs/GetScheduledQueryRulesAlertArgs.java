...
public final class GetScheduledQueryRulesAlertArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetScheduledQueryRulesAlertArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetScheduledQueryRulesAlertArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetScheduledQueryRulesAlertArgs", "resourceGroupName");
            }
            return $;
        }
    }
