...
@CustomType
public final class HBaseClusterMetastoresAmbari {
    /**
    ...
    public static Builder builder(HBaseClusterMetastoresAmbari defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(HBaseClusterMetastoresAmbari defaults) {
        ...
        public Builder databaseName(String databaseName) {
            if (databaseName == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresAmbari", "databaseName");
            }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresAmbari", "password");
            }
        ...
        public Builder server(String server) {
            if (server == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresAmbari", "server");
            }
            this.server = server;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresAmbari", "username");
            }
