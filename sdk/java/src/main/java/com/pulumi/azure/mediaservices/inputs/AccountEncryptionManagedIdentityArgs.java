...
public final class AccountEncryptionManagedIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountEncryptionManagedIdentityArgs Empty = new AccountEncryptionManagedIdentityArgs();
    ...
    private AccountEncryptionManagedIdentityArgs() {}

    private AccountEncryptionManagedIdentityArgs(AccountEncryptionManagedIdentityArgs $) {
    ...
    public static Builder builder(AccountEncryptionManagedIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountEncryptionManagedIdentityArgs();
        }

        public Builder(AccountEncryptionManagedIdentityArgs defaults) {
            $ = new AccountEncryptionManagedIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountEncryptionManagedIdentityArgs build() {
            return $;
        }
    }
