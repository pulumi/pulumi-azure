...
public final class SystemTopicEventSubscriptionAdvancedFilterNumberNotInRange {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("SystemTopicEventSubscriptionAdvancedFilterNumberNotInRange", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<List<Double>> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("SystemTopicEventSubscriptionAdvancedFilterNumberNotInRange", "values");
            }
            this.values = values;
            return this;
        }
