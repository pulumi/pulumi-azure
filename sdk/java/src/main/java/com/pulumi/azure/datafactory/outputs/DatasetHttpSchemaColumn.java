...
@CustomType
public final class DatasetHttpSchemaColumn {
    /**
    ...
    private DatasetHttpSchemaColumn() {}
    /**
     * @return The description of the column.
     * 
     */
    ...
    public static Builder builder(DatasetHttpSchemaColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(DatasetHttpSchemaColumn defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DatasetHttpSchemaColumn", "name");
            }
            this.name = name;
            return this;
        }
