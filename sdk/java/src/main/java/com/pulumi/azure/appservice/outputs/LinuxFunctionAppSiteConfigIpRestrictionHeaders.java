...
@CustomType
public final class LinuxFunctionAppSiteConfigIpRestrictionHeaders {
    /**
    ...
    private LinuxFunctionAppSiteConfigIpRestrictionHeaders(
    ...
    public static Builder builder(LinuxFunctionAppSiteConfigIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxFunctionAppSiteConfigIpRestrictionHeaders defaults) {
        ...
        }        public LinuxFunctionAppSiteConfigIpRestrictionHeaders build() {
            return new LinuxFunctionAppSiteConfigIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
