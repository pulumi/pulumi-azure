...
import com.pulumi.azure.media.inputs.TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs;
...
public final class TransformOutputCustomPresetFilterOverlayVideoArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransformOutputCustomPresetFilterOverlayVideoArgs Empty = new TransformOutputCustomPresetFilterOverlayVideoArgs();
    ...
    private @Nullable Output<TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs> cropRectangle;

    /**
     * @return A `crop_rectangle` block as defined above.
     * 
     */
    public Optional<Output<TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs>> cropRectangle() {
    ...
    private @Nullable Output<TransformOutputCustomPresetFilterOverlayVideoPositionArgs> position;

    /**
     * @return A `position` block as defined above.
     * 
     */
    public Optional<Output<TransformOutputCustomPresetFilterOverlayVideoPositionArgs>> position() {
    ...
    private TransformOutputCustomPresetFilterOverlayVideoArgs() {}

    private TransformOutputCustomPresetFilterOverlayVideoArgs(TransformOutputCustomPresetFilterOverlayVideoArgs $) {
    ...
    public static Builder builder(TransformOutputCustomPresetFilterOverlayVideoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransformOutputCustomPresetFilterOverlayVideoArgs();
        }

        public Builder(TransformOutputCustomPresetFilterOverlayVideoArgs defaults) {
            $ = new TransformOutputCustomPresetFilterOverlayVideoArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param audioGainLevel The gain level of audio in the overlay. The value should be in range between `0` to `1.0`. The default is `1.0`.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder cropRectangle(@Nullable Output<TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs> cropRectangle) {
         ...
         * 
         */
        public Builder cropRectangle(TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs cropRectangle) {
        ...
        /**
         * @param opacity The opacity of the overlay. The value should be in the range between `0` to `1.0`. Default to `1.0`, which means the overlay is opaque.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param position A `position` block as defined above.
         * 
         * @return builder
         * 
         */
        public Builder position(@Nullable Output<TransformOutputCustomPresetFilterOverlayVideoPositionArgs> position) {
            $.position = position;
            return this;
        }
         ...
         * 
         */
        public Builder position(TransformOutputCustomPresetFilterOverlayVideoPositionArgs position) {
