...
@CustomType
public final class WindowsWebAppAuthSettingsMicrosoft {
    /**
    ...
    public static Builder builder(WindowsWebAppAuthSettingsMicrosoft defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(WindowsWebAppAuthSettingsMicrosoft defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsMicrosoft", "clientId");
            }
        ...
        public WindowsWebAppAuthSettingsMicrosoft build() {
            final var _resultValue = new WindowsWebAppAuthSettingsMicrosoft();
