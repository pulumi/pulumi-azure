...
public final class WindowsFunctionAppAuthSettingsMicrosoftArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsMicrosoftArgs Empty = new WindowsFunctionAppAuthSettingsMicrosoftArgs();
    ...
    private WindowsFunctionAppAuthSettingsMicrosoftArgs() {}

    private WindowsFunctionAppAuthSettingsMicrosoftArgs(WindowsFunctionAppAuthSettingsMicrosoftArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsMicrosoftArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsMicrosoftArgs();
        }

        public Builder(WindowsFunctionAppAuthSettingsMicrosoftArgs defaults) {
            $ = new WindowsFunctionAppAuthSettingsMicrosoftArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsMicrosoftArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsMicrosoftArgs", "clientId");
            }
            return $;
        }
    }
