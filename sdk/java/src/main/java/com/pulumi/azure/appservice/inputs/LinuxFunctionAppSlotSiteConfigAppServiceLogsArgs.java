...
public final class LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs Empty = new LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs();
    ...
    private LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs() {}

    private LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs(LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs();
        }

        public Builder(LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs defaults) {
            $ = new LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotSiteConfigAppServiceLogsArgs build() {
            return $;
        }
    }
