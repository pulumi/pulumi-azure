...
public final class ApiDiagnosticBackendResponseDataMaskingQueryParamArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ApiDiagnosticBackendResponseDataMaskingQueryParamArgs build() {
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("ApiDiagnosticBackendResponseDataMaskingQueryParamArgs", "mode");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("ApiDiagnosticBackendResponseDataMaskingQueryParamArgs", "value");
            }
            return $;
        }
    }
