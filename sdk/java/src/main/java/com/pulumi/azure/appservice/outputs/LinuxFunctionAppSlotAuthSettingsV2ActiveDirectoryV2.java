...
@CustomType
public final class LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 {
    /**
    ...
    private LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2() {}
    /**
     * @return The list of allowed Applications for the Default Authorisation Policy.
     * 
     */
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean wwwAuthenticationDisabled;
        public Builder() {}
        public Builder(LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2", "clientId");
            }
        ...
        public Builder tenantAuthEndpoint(String tenantAuthEndpoint) {
            if (tenantAuthEndpoint == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2", "tenantAuthEndpoint");
            }
        ...
        public LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2 build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2();
