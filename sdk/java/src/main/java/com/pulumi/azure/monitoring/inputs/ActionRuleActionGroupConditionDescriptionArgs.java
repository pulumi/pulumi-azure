...
public final class ActionRuleActionGroupConditionDescriptionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ActionRuleActionGroupConditionDescriptionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionDescriptionArgs", "operator");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionDescriptionArgs", "values");
            }
            return $;
        }
    }
