...
public final class FunctionAppSlotAuthSettingsMicrosoft {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("FunctionAppSlotAuthSettingsMicrosoft", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("FunctionAppSlotAuthSettingsMicrosoft", "clientSecret");
            }
        ...
        public FunctionAppSlotAuthSettingsMicrosoft build() {
            final var _resultValue = new FunctionAppSlotAuthSettingsMicrosoft();
