...
public final class HadoopClusterRolesEdgeNodeInstallScriptAction {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("HadoopClusterRolesEdgeNodeInstallScriptAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("HadoopClusterRolesEdgeNodeInstallScriptAction", "uri");
            }
            this.uri = uri;
            return this;
        }
        public HadoopClusterRolesEdgeNodeInstallScriptAction build() {
            final var _resultValue = new HadoopClusterRolesEdgeNodeInstallScriptAction();
