...
public final class FirewallNatRuleCollectionState extends com.pulumi.resources.ResourceArgs {

    public static final FirewallNatRuleCollectionState Empty = new FirewallNatRuleCollectionState();
     ...
     */
    @Import(name="rules")
    private @Nullable Output<List<FirewallNatRuleCollectionRuleArgs>> rules;

    /**
     * @return One or more `rule` blocks as defined below.
     * 
     */
    public Optional<Output<List<FirewallNatRuleCollectionRuleArgs>>> rules() {
        return Optional.ofNullable(this.rules);
    }

    private FirewallNatRuleCollectionState() {}

    private FirewallNatRuleCollectionState(FirewallNatRuleCollectionState $) {
        this.action = $.action;
    ...
    public static Builder builder(FirewallNatRuleCollectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirewallNatRuleCollectionState();
        }

        public Builder(FirewallNatRuleCollectionState defaults) {
            $ = new FirewallNatRuleCollectionState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder rules(@Nullable Output<List<FirewallNatRuleCollectionRuleArgs>> rules) {
            $.rules = rules;
            return this;
        }
        ...
        public FirewallNatRuleCollectionState build() {
            return $;
        }
    }
