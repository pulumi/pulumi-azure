...
public final class LinuxFunctionAppSlotAuthSettingsGoogle {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsGoogle", "clientId");
            }
        ...
        public LinuxFunctionAppSlotAuthSettingsGoogle build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsGoogle();
