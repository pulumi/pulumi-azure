...
public final class ApiOperationRequestRepresentationFormParameterExampleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiOperationRequestRepresentationFormParameterExampleArgs Empty = new ApiOperationRequestRepresentationFormParameterExampleArgs();
    ...
    private ApiOperationRequestRepresentationFormParameterExampleArgs() {}

    private ApiOperationRequestRepresentationFormParameterExampleArgs(ApiOperationRequestRepresentationFormParameterExampleArgs $) {
    ...
    public static Builder builder(ApiOperationRequestRepresentationFormParameterExampleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiOperationRequestRepresentationFormParameterExampleArgs();
        }

        public Builder(ApiOperationRequestRepresentationFormParameterExampleArgs defaults) {
            $ = new ApiOperationRequestRepresentationFormParameterExampleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiOperationRequestRepresentationFormParameterExampleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationRequestRepresentationFormParameterExampleArgs", "name");
            }
            return $;
        }
    }
