...
public final class ActionRuleActionGroupScope {
    ...
    public static final class Builder {
        ...
        public Builder resourceIds(List<String> resourceIds) {
            if (resourceIds == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupScope", "resourceIds");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupScope", "type");
            }
            this.type = type;
            return this;
        }
