...
public final class GetVolumeGroupSapHanaArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetVolumeGroupSapHanaArgs build() {
            if ($.accountName == null) {
                throw new MissingRequiredPropertyException("GetVolumeGroupSapHanaArgs", "accountName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVolumeGroupSapHanaArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetVolumeGroupSapHanaArgs", "resourceGroupName");
            }
            return $;
        }
    }
