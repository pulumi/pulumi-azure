...
public final class GetDataCollectionRuleArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetDataCollectionRuleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetDataCollectionRuleArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetDataCollectionRuleArgs", "resourceGroupName");
            }
            return $;
        }
    }
