...
public class DevBoxDefinition extends com.pulumi.resources.CustomResource {
     ...
     */
    public DevBoxDefinition(String name) {
     ...
     */
    public static DevBoxDefinition get(String name, Output<String> id, @Nullable DevBoxDefinitionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
