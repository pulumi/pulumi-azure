...
@CustomType
public final class RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications {
    /**
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications build() {
            final var _resultValue = new RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotifications();
