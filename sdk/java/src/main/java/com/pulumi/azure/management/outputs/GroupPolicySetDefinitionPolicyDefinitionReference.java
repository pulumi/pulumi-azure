...
@CustomType
public final class GroupPolicySetDefinitionPolicyDefinitionReference {
    /**
    ...
    public static Builder builder(GroupPolicySetDefinitionPolicyDefinitionReference defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(GroupPolicySetDefinitionPolicyDefinitionReference defaults) {
        ...
        public Builder policyDefinitionId(String policyDefinitionId) {
            if (policyDefinitionId == null) {
              throw new MissingRequiredPropertyException("GroupPolicySetDefinitionPolicyDefinitionReference", "policyDefinitionId");
            }
        ...
        public GroupPolicySetDefinitionPolicyDefinitionReference build() {
            final var _resultValue = new GroupPolicySetDefinitionPolicyDefinitionReference();
