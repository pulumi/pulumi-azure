...
public final class VirtualMachineAssessmentScheduleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return What day of the week the assessment will be run. Default value is `Monday`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param dayOfWeek What day of the week the assessment will be run. Default value is `Monday`.
         * 
         * @return builder
         * 
         */
