...
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionSiteConfigScmIpRestrictionHeaders;
...
@CustomType
public final class AppFlexConsumptionSiteConfigScmIpRestriction {
    /**
     ...
     * 
     */
    private @Nullable AppFlexConsumptionSiteConfigScmIpRestrictionHeaders headers;
    /**
    ...
    private AppFlexConsumptionSiteConfigScmIpRestriction() {}
    /**
     * @return The action to take. Possible values are `Allow` or `Deny`. Defaults to `Allow`.
     * 
     */
     ...
     * 
     */
    public Optional<AppFlexConsumptionSiteConfigScmIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(AppFlexConsumptionSiteConfigScmIpRestriction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String virtualNetworkSubnetId;
        public Builder() {}
        public Builder(AppFlexConsumptionSiteConfigScmIpRestriction defaults) {
        ...
        @CustomType.Setter
        public Builder headers(@Nullable AppFlexConsumptionSiteConfigScmIpRestrictionHeaders headers) {
        ...
        public AppFlexConsumptionSiteConfigScmIpRestriction build() {
            final var _resultValue = new AppFlexConsumptionSiteConfigScmIpRestriction();
