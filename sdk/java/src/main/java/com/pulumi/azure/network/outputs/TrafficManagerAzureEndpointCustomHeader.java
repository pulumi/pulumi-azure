...
@CustomType
public final class TrafficManagerAzureEndpointCustomHeader {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("TrafficManagerAzureEndpointCustomHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("TrafficManagerAzureEndpointCustomHeader", "value");
            }
            this.value = value;
            return this;
        }
