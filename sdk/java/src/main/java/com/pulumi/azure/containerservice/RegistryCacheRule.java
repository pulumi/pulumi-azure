...
public class RegistryCacheRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public RegistryCacheRule(String name) {
     ...
     */
    public RegistryCacheRule(String name, RegistryCacheRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:containerservice/registryCacheRule:RegistryCacheRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private RegistryCacheRule(String name, Output<String> id, @Nullable RegistryCacheRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:containerservice/registryCacheRule:RegistryCacheRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static RegistryCacheRule get(String name, Output<String> id, @Nullable RegistryCacheRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
