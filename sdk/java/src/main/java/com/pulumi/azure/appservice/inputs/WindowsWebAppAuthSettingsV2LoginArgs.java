...
public final class WindowsWebAppAuthSettingsV2LoginArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsV2LoginArgs Empty = new WindowsWebAppAuthSettingsV2LoginArgs();
    ...
    private WindowsWebAppAuthSettingsV2LoginArgs() {}

    private WindowsWebAppAuthSettingsV2LoginArgs(WindowsWebAppAuthSettingsV2LoginArgs $) {
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2LoginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsV2LoginArgs();
        }

        public Builder(WindowsWebAppAuthSettingsV2LoginArgs defaults) {
            $ = new WindowsWebAppAuthSettingsV2LoginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsV2LoginArgs build() {
            return $;
        }
    }
