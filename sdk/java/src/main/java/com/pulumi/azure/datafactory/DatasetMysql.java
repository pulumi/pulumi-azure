...
public class DatasetMysql extends com.pulumi.resources.CustomResource {
     ...
     */
    public DatasetMysql(java.lang.String name) {
     ...
     */
    public DatasetMysql(java.lang.String name, DatasetMysqlArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DatasetMysql(java.lang.String name, DatasetMysqlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/datasetMysql:DatasetMysql", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DatasetMysql(java.lang.String name, Output<java.lang.String> id, @Nullable DatasetMysqlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/datasetMysql:DatasetMysql", name, state, makeResourceOptions(options, id), false);
    }

    private static DatasetMysqlArgs makeArgs(DatasetMysqlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DatasetMysqlArgs.Empty : args;
    }
     ...
     */
    public static DatasetMysql get(java.lang.String name, Output<java.lang.String> id, @Nullable DatasetMysqlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
