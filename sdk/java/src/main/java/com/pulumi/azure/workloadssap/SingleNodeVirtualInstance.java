...
public class SingleNodeVirtualInstance extends com.pulumi.resources.CustomResource {
     ...
     */
    public SingleNodeVirtualInstance(String name) {
     ...
     */
    public SingleNodeVirtualInstance(String name, SingleNodeVirtualInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:workloadssap/singleNodeVirtualInstance:SingleNodeVirtualInstance", name, args == null ? SingleNodeVirtualInstanceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private SingleNodeVirtualInstance(String name, Output<String> id, @Nullable SingleNodeVirtualInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:workloadssap/singleNodeVirtualInstance:SingleNodeVirtualInstance", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static SingleNodeVirtualInstance get(String name, Output<String> id, @Nullable SingleNodeVirtualInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
