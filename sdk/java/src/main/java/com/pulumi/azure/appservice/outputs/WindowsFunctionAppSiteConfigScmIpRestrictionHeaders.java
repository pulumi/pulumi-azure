...
@CustomType
public final class WindowsFunctionAppSiteConfigScmIpRestrictionHeaders {
    /**
    ...
    public static Builder builder(WindowsFunctionAppSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsFunctionAppSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        }        public WindowsFunctionAppSiteConfigScmIpRestrictionHeaders build() {
            return new WindowsFunctionAppSiteConfigScmIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
