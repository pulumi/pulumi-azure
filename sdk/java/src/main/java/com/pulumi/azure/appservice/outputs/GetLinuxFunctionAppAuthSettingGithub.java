...
@CustomType
public final class GetLinuxFunctionAppAuthSettingGithub {
    /**
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingGithub", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingGithub", "clientSecret");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingGithub", "clientSecretSettingName");
            }
        ...
        public Builder oauthScopes(List<String> oauthScopes) {
            if (oauthScopes == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingGithub", "oauthScopes");
            }
        ...
        public GetLinuxFunctionAppAuthSettingGithub build() {
            final var _resultValue = new GetLinuxFunctionAppAuthSettingGithub();
