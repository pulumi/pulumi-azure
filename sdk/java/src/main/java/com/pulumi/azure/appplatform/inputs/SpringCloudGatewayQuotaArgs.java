...
public final class SpringCloudGatewayQuotaArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpringCloudGatewayQuotaArgs Empty = new SpringCloudGatewayQuotaArgs();
    ...
    /**
     * @return Specifies the required memory size of the Spring Cloud Deployment. Possible Values are `512Mi`, `1Gi`, `2Gi`, `3Gi`, `4Gi`, `5Gi`, `6Gi`, `7Gi`, and `8Gi`. Defaults to `2Gi` if not specified.
     * 
     * &gt; **Note:** `memory` supports `512Mi`, `1Gi` and `2Gi` for Basic tier, `512Mi`, `1Gi`, `2Gi`, `3Gi`, `4Gi`, `5Gi`, `6Gi`, `7Gi`, and `8Gi` for Standard tier.
     * 
     */
    ...
    private SpringCloudGatewayQuotaArgs() {}

    private SpringCloudGatewayQuotaArgs(SpringCloudGatewayQuotaArgs $) {
        this.cpu = $.cpu;
        this.memory = $.memory;
    }
    ...
    public static Builder builder(SpringCloudGatewayQuotaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpringCloudGatewayQuotaArgs();
        }

        public Builder(SpringCloudGatewayQuotaArgs defaults) {
            $ = new SpringCloudGatewayQuotaArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param memory Specifies the required memory size of the Spring Cloud Deployment. Possible Values are `512Mi`, `1Gi`, `2Gi`, `3Gi`, `4Gi`, `5Gi`, `6Gi`, `7Gi`, and `8Gi`. Defaults to `2Gi` if not specified.
         * 
         * &gt; **Note:** `memory` supports `512Mi`, `1Gi` and `2Gi` for Basic tier, `512Mi`, `1Gi`, `2Gi`, `3Gi`, `4Gi`, `5Gi`, `6Gi`, `7Gi`, and `8Gi` for Standard tier.
         * 
         * @return builder
        ...
        public SpringCloudGatewayQuotaArgs build() {
            return $;
        }
    }
