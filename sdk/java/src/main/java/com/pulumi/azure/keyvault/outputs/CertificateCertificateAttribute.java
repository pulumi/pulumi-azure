...
@CustomType
public final class CertificateCertificateAttribute {
    /**
    ...
    public static Builder builder(CertificateCertificateAttribute defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CertificateCertificateAttribute defaults) {
        ...
        public Builder updated(@Nullable String updated) {
            this.updated = updated;
            return this;
        }        public CertificateCertificateAttribute build() {
            return new CertificateCertificateAttribute(created, enabled, expires, notBefore, recoveryLevel, updated);
        }
    }
}
