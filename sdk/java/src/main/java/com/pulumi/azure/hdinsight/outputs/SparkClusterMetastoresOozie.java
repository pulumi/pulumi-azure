...
@CustomType
public final class SparkClusterMetastoresOozie {
    /**
    ...
    private SparkClusterMetastoresOozie() {}
    /**
     * @return The external Oozie metastore&#39;s existing SQL database. Changing this forces a new resource to be created.
     * 
     */
    ...
    public static Builder builder(SparkClusterMetastoresOozie defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(SparkClusterMetastoresOozie defaults) {
        ...
        public Builder databaseName(String databaseName) {
            if (databaseName == null) {
              throw new MissingRequiredPropertyException("SparkClusterMetastoresOozie", "databaseName");
            }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("SparkClusterMetastoresOozie", "password");
            }
        ...
        public Builder server(String server) {
            if (server == null) {
              throw new MissingRequiredPropertyException("SparkClusterMetastoresOozie", "server");
            }
            this.server = server;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("SparkClusterMetastoresOozie", "username");
            }
