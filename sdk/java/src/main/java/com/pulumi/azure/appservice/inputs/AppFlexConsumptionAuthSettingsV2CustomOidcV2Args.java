...
public final class AppFlexConsumptionAuthSettingsV2CustomOidcV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private AppFlexConsumptionAuthSettingsV2CustomOidcV2Args() {}

    private AppFlexConsumptionAuthSettingsV2CustomOidcV2Args(AppFlexConsumptionAuthSettingsV2CustomOidcV2Args $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2CustomOidcV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsV2CustomOidcV2Args();
        }

        public Builder(AppFlexConsumptionAuthSettingsV2CustomOidcV2Args defaults) {
            $ = new AppFlexConsumptionAuthSettingsV2CustomOidcV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsV2CustomOidcV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2CustomOidcV2Args", "clientId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2CustomOidcV2Args", "name");
            }
            if ($.openidConfigurationEndpoint == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2CustomOidcV2Args", "openidConfigurationEndpoint");
            }
            return $;
        }
    }
