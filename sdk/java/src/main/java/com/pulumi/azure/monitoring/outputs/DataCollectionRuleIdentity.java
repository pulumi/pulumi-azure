...
@CustomType
public final class DataCollectionRuleIdentity {
    /**
    ...
    public static Builder builder(DataCollectionRuleIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DataCollectionRuleIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DataCollectionRuleIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public DataCollectionRuleIdentity build() {
            final var _resultValue = new DataCollectionRuleIdentity();
