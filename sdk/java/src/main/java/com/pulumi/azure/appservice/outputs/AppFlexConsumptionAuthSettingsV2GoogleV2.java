...
@CustomType
public final class AppFlexConsumptionAuthSettingsV2GoogleV2 {
    /**
    ...
    private AppFlexConsumptionAuthSettingsV2GoogleV2() {}
    /**
     * @return Specifies a list of Allowed Audiences that should be requested as part of Google Sign-In authentication.
     * 
     */
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2GoogleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsV2GoogleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GoogleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GoogleV2", "clientSecretSettingName");
            }
        ...
        public AppFlexConsumptionAuthSettingsV2GoogleV2 build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsV2GoogleV2();
