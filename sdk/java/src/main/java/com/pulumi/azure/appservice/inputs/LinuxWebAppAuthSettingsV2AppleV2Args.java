...
public final class LinuxWebAppAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsV2AppleV2Args Empty = new LinuxWebAppAuthSettingsV2AppleV2Args();
    ...
    private LinuxWebAppAuthSettingsV2AppleV2Args() {}

    private LinuxWebAppAuthSettingsV2AppleV2Args(LinuxWebAppAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsV2AppleV2Args();
        }

        public Builder(LinuxWebAppAuthSettingsV2AppleV2Args defaults) {
            $ = new LinuxWebAppAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsV2AppleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2AppleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2AppleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
