...
public final class WindowsWebAppSlotSiteConfigCorsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotSiteConfigCorsArgs Empty = new WindowsWebAppSlotSiteConfigCorsArgs();
    ...
    private WindowsWebAppSlotSiteConfigCorsArgs() {}

    private WindowsWebAppSlotSiteConfigCorsArgs(WindowsWebAppSlotSiteConfigCorsArgs $) {
    ...
    public static Builder builder(WindowsWebAppSlotSiteConfigCorsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotSiteConfigCorsArgs();
        }

        public Builder(WindowsWebAppSlotSiteConfigCorsArgs defaults) {
            $ = new WindowsWebAppSlotSiteConfigCorsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotSiteConfigCorsArgs build() {
            return $;
        }
    }
