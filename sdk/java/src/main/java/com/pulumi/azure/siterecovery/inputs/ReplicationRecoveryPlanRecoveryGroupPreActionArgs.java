...
public final class ReplicationRecoveryPlanRecoveryGroupPreActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ReplicationRecoveryPlanRecoveryGroupPreActionArgs() {}

    private ReplicationRecoveryPlanRecoveryGroupPreActionArgs(ReplicationRecoveryPlanRecoveryGroupPreActionArgs $) {
    ...
    public static Builder builder(ReplicationRecoveryPlanRecoveryGroupPreActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReplicationRecoveryPlanRecoveryGroupPreActionArgs();
        }

        public Builder(ReplicationRecoveryPlanRecoveryGroupPreActionArgs defaults) {
            $ = new ReplicationRecoveryPlanRecoveryGroupPreActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReplicationRecoveryPlanRecoveryGroupPreActionArgs build() {
            if ($.failOverDirections == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreActionArgs", "failOverDirections");
            }
            if ($.failOverTypes == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreActionArgs", "failOverTypes");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreActionArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreActionArgs", "type");
            }
            return $;
        }
    }
