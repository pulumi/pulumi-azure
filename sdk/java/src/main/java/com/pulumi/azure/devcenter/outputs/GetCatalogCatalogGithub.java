...
@CustomType
public final class GetCatalogCatalogGithub {
    /**
    ...
    private GetCatalogCatalogGithub() {}
    /**
     * @return The Git branch of the Dev Center Catalog.
     * 
     */
    ...
    public static Builder builder(GetCatalogCatalogGithub defaults) {
    ...
    public static final class Builder {
        ...
        private String uri;
        public Builder() {}
        public Builder(GetCatalogCatalogGithub defaults) {
        ...
        public Builder branch(String branch) {
            if (branch == null) {
              throw new MissingRequiredPropertyException("GetCatalogCatalogGithub", "branch");
            }
            this.branch = branch;
            return this;
        }
        ...
        public Builder keyVaultKeyUrl(String keyVaultKeyUrl) {
            if (keyVaultKeyUrl == null) {
              throw new MissingRequiredPropertyException("GetCatalogCatalogGithub", "keyVaultKeyUrl");
            }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetCatalogCatalogGithub", "path");
            }
            this.path = path;
            return this;
        }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("GetCatalogCatalogGithub", "uri");
            }
            this.uri = uri;
            return this;
        }
        public GetCatalogCatalogGithub build() {
            final var _resultValue = new GetCatalogCatalogGithub();
