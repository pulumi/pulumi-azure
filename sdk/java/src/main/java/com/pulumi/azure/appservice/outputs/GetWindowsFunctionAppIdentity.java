...
@CustomType
public final class GetWindowsFunctionAppIdentity {
    /**
    ...
    public static final class Builder {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppIdentity", "identityIds");
            }
        ...
        public Builder principalId(String principalId) {
            if (principalId == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppIdentity", "principalId");
            }
        ...
        public Builder tenantId(String tenantId) {
            if (tenantId == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppIdentity", "tenantId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public GetWindowsFunctionAppIdentity build() {
            final var _resultValue = new GetWindowsFunctionAppIdentity();
