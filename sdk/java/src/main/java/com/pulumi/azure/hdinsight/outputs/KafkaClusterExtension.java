...
@CustomType
public final class KafkaClusterExtension {
    /**
    ...
    public static Builder builder(KafkaClusterExtension defaults) {
    ...
    public static final class Builder {
        ...
        private String primaryKey;
        public Builder() {}
        public Builder(KafkaClusterExtension defaults) {
        ...
        public Builder logAnalyticsWorkspaceId(String logAnalyticsWorkspaceId) {
            if (logAnalyticsWorkspaceId == null) {
              throw new MissingRequiredPropertyException("KafkaClusterExtension", "logAnalyticsWorkspaceId");
            }
        ...
        public Builder primaryKey(String primaryKey) {
            if (primaryKey == null) {
              throw new MissingRequiredPropertyException("KafkaClusterExtension", "primaryKey");
            }
