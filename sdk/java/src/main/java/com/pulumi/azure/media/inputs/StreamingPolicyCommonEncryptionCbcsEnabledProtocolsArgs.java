...
public final class StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs extends com.pulumi.resources.ResourceArgs {

    public static final StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs Empty = new StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs();
    ...
    private StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs() {}

    private StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs(StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs $) {
        this.dash = $.dash;
    ...
    public static Builder builder(StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs();
        }

        public Builder(StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs defaults) {
            $ = new StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StreamingPolicyCommonEncryptionCbcsEnabledProtocolsArgs build() {
            return $;
        }
    }
