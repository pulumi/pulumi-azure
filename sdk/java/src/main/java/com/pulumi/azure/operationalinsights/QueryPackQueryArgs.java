...
public final class QueryPackQueryArgs extends com.pulumi.resources.ResourceArgs {

    public static final QueryPackQueryArgs Empty = new QueryPackQueryArgs();
     ...
     * 
     */
    @Import(name="queryPackId", required=true)
    ...
    private QueryPackQueryArgs() {}

    private QueryPackQueryArgs(QueryPackQueryArgs $) {
    ...
    public static Builder builder(QueryPackQueryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new QueryPackQueryArgs();
        }

        public Builder(QueryPackQueryArgs defaults) {
            $ = new QueryPackQueryArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder queryPackId(Output<String> queryPackId) {
