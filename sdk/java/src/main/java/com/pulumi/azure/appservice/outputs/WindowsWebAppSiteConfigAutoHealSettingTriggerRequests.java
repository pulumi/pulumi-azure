...
public final class WindowsWebAppSiteConfigAutoHealSettingTriggerRequests {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSiteConfigAutoHealSettingTriggerRequests", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder interval(String interval) {
            if (interval == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSiteConfigAutoHealSettingTriggerRequests", "interval");
            }
            this.interval = interval;
            return this;
        }
        public WindowsWebAppSiteConfigAutoHealSettingTriggerRequests build() {
            final var _resultValue = new WindowsWebAppSiteConfigAutoHealSettingTriggerRequests();
