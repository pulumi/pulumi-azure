...
@CustomType
public final class LinuxWebAppSlotAuthSettingsV2MicrosoftV2 {
    /**
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2MicrosoftV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxWebAppSlotAuthSettingsV2MicrosoftV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2MicrosoftV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2MicrosoftV2", "clientSecretSettingName");
            }
        ...
        public LinuxWebAppSlotAuthSettingsV2MicrosoftV2 build() {
            final var _resultValue = new LinuxWebAppSlotAuthSettingsV2MicrosoftV2();
