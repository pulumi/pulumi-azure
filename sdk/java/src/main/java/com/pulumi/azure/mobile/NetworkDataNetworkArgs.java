...
public final class NetworkDataNetworkArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkDataNetworkArgs Empty = new NetworkDataNetworkArgs();
    ...
    private NetworkDataNetworkArgs() {}

    private NetworkDataNetworkArgs(NetworkDataNetworkArgs $) {
    ...
    public static Builder builder(NetworkDataNetworkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkDataNetworkArgs();
        }

        public Builder(NetworkDataNetworkArgs defaults) {
            $ = new NetworkDataNetworkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkDataNetworkArgs build() {
            if ($.mobileNetworkId == null) {
                throw new MissingRequiredPropertyException("NetworkDataNetworkArgs", "mobileNetworkId");
            }
            return $;
        }
    }
