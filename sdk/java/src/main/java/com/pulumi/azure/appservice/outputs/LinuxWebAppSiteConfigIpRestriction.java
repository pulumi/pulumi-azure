...
import com.pulumi.azure.appservice.outputs.LinuxWebAppSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class LinuxWebAppSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable LinuxWebAppSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private LinuxWebAppSiteConfigIpRestriction(
        @CustomType.Parameter("action") @Nullable String action,
        @CustomType.Parameter("headers") @Nullable LinuxWebAppSiteConfigIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<LinuxWebAppSiteConfigIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(LinuxWebAppSiteConfigIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable LinuxWebAppSiteConfigIpRestrictionHeaders headers;
        ...
        public Builder(LinuxWebAppSiteConfigIpRestriction defaults) {
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public LinuxWebAppSiteConfigIpRestriction build() {
            return new LinuxWebAppSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
