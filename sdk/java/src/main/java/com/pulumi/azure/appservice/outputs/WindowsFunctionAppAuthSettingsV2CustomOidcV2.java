...
@CustomType
public final class WindowsFunctionAppAuthSettingsV2CustomOidcV2 {
    /**
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2CustomOidcV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tokenEndpoint;
        public Builder() {}
        public Builder(WindowsFunctionAppAuthSettingsV2CustomOidcV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2CustomOidcV2", "clientId");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2CustomOidcV2", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder openidConfigurationEndpoint(String openidConfigurationEndpoint) {
            if (openidConfigurationEndpoint == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2CustomOidcV2", "openidConfigurationEndpoint");
            }
        ...
        public WindowsFunctionAppAuthSettingsV2CustomOidcV2 build() {
            final var _resultValue = new WindowsFunctionAppAuthSettingsV2CustomOidcV2();
