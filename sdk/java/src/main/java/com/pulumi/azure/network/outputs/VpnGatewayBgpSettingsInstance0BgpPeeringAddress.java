...
@CustomType
public final class VpnGatewayBgpSettingsInstance0BgpPeeringAddress {
    /**
    ...
    public static final class Builder {
        ...
        public Builder customIps(List<String> customIps) {
            if (customIps == null) {
              throw new MissingRequiredPropertyException("VpnGatewayBgpSettingsInstance0BgpPeeringAddress", "customIps");
            }
