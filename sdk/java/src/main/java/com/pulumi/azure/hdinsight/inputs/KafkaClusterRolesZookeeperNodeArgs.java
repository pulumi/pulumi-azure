...
public final class KafkaClusterRolesZookeeperNodeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public KafkaClusterRolesZookeeperNodeArgs build() {
            if ($.username == null) {
                throw new MissingRequiredPropertyException("KafkaClusterRolesZookeeperNodeArgs", "username");
            }
            if ($.vmSize == null) {
                throw new MissingRequiredPropertyException("KafkaClusterRolesZookeeperNodeArgs", "vmSize");
            }
            return $;
        }
    }
