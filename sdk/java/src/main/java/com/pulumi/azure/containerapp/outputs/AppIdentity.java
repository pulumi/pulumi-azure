...
public final class AppIdentity {
    ...
    public static Builder builder(AppIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(AppIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("AppIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public AppIdentity build() {
            final var _resultValue = new AppIdentity();
