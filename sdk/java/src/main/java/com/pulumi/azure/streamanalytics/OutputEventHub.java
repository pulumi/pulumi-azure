...
public class OutputEventHub extends com.pulumi.resources.CustomResource {
     ...
     */
    public OutputEventHub(String name) {
     ...
     */
    public OutputEventHub(String name, OutputEventHubArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:streamanalytics/outputEventHub:OutputEventHub", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private OutputEventHub(String name, Output<String> id, @Nullable OutputEventHubState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:streamanalytics/outputEventHub:OutputEventHub", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static OutputEventHub get(String name, Output<String> id, @Nullable OutputEventHubState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
