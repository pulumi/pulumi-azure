...
@CustomType
public final class FrontdoorRuleConditionsUrlFileExtensionCondition {
    /**
    ...
    private FrontdoorRuleConditionsUrlFileExtensionCondition() {}
    /**
     * @return A list of one or more string or integer values(e.g. &#34;1&#34;) representing the value of the request file extension to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
     * 
     */
    ...
    public static Builder builder(FrontdoorRuleConditionsUrlFileExtensionCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> transforms;
        public Builder() {}
        public Builder(FrontdoorRuleConditionsUrlFileExtensionCondition defaults) {
        ...
        public Builder matchValues(List<String> matchValues) {
            if (matchValues == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleConditionsUrlFileExtensionCondition", "matchValues");
            }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleConditionsUrlFileExtensionCondition", "operator");
            }
        ...
        public FrontdoorRuleConditionsUrlFileExtensionCondition build() {
            final var _resultValue = new FrontdoorRuleConditionsUrlFileExtensionCondition();
