...
@CustomType
public final class EmailServiceDomainVerificationRecordDkim2 {
    /**
    ...
    public static Builder builder(EmailServiceDomainVerificationRecordDkim2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(EmailServiceDomainVerificationRecordDkim2 defaults) {
        ...
        public EmailServiceDomainVerificationRecordDkim2 build() {
            final var _resultValue = new EmailServiceDomainVerificationRecordDkim2();
