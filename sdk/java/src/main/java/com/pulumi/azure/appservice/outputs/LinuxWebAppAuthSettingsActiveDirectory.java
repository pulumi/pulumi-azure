...
@CustomType
public final class LinuxWebAppAuthSettingsActiveDirectory {
    /**
    ...
    public static Builder builder(LinuxWebAppAuthSettingsActiveDirectory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String clientSecretSettingName;
        public Builder() {}
        public Builder(LinuxWebAppAuthSettingsActiveDirectory defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsActiveDirectory", "clientId");
            }
        ...
        public LinuxWebAppAuthSettingsActiveDirectory build() {
            final var _resultValue = new LinuxWebAppAuthSettingsActiveDirectory();
