...
public final class LabState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<LabSecurityArgs> security;

    /**
     * @return A `security` block as defined below.
     * 
     */
    public Optional<Output<LabSecurityArgs>> security() {
    ...
    private @Nullable Output<LabVirtualMachineArgs> virtualMachine;

    /**
     * @return A `virtual_machine` block as defined below.
     * 
     */
    public Optional<Output<LabVirtualMachineArgs>> virtualMachine() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder security(@Nullable Output<LabSecurityArgs> security) {
            $.security = security;
            return this;
        }
         ...
         * 
         */
        public Builder virtualMachine(@Nullable Output<LabVirtualMachineArgs> virtualMachine) {
