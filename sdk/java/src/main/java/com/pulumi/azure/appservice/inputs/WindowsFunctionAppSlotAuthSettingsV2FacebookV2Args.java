...
public final class WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args Empty = new WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args();
    ...
    private WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args() {}

    private WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args(WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
