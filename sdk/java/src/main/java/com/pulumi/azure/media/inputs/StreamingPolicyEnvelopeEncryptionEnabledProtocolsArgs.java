...
public final class StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs extends com.pulumi.resources.ResourceArgs {

    public static final StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs Empty = new StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs();
    ...
    private StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs() {}

    private StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs(StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs $) {
        this.dash = $.dash;
    ...
    public static Builder builder(StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs();
        }

        public Builder(StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs defaults) {
            $ = new StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StreamingPolicyEnvelopeEncryptionEnabledProtocolsArgs build() {
            return $;
        }
    }
