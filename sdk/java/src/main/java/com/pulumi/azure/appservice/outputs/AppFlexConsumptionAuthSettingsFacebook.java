...
@CustomType
public final class AppFlexConsumptionAuthSettingsFacebook {
    /**
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsFacebook defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsFacebook defaults) {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsFacebook", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public AppFlexConsumptionAuthSettingsFacebook build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsFacebook();
