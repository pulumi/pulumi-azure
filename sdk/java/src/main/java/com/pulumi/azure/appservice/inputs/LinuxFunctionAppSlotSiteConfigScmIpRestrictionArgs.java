...
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs;
...
public final class LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs Empty = new LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return a `headers` block as detailed below.
     * 
     */
    public Optional<Output<LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs() {}

    private LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs(LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs();
        }

        public Builder(LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs defaults) {
            $ = new LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public LinuxFunctionAppSlotSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
