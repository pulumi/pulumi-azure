...
@CustomType
public final class KafkaClusterRolesWorkerNodeScriptAction {
    /**
    ...
    public static Builder builder(KafkaClusterRolesWorkerNodeScriptAction defaults) {
    ...
    public static final class Builder {
        ...
        private String uri;
        public Builder() {}
        public Builder(KafkaClusterRolesWorkerNodeScriptAction defaults) {
        ...
        public KafkaClusterRolesWorkerNodeScriptAction build() {
            final var _resultValue = new KafkaClusterRolesWorkerNodeScriptAction();
