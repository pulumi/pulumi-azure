...
public final class WindowsWebAppSlotAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsV2AppleV2Args Empty = new WindowsWebAppSlotAuthSettingsV2AppleV2Args();
    ...
    private WindowsWebAppSlotAuthSettingsV2AppleV2Args() {}

    private WindowsWebAppSlotAuthSettingsV2AppleV2Args(WindowsWebAppSlotAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsV2AppleV2Args();
        }

        public Builder(WindowsWebAppSlotAuthSettingsV2AppleV2Args defaults) {
            $ = new WindowsWebAppSlotAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsV2AppleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2AppleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2AppleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
