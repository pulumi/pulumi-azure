...
@CustomType
public final class RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications {
    /**
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications build() {
            final var _resultValue = new RoleManagementPolicyNotificationRulesEligibleAssignmentsApproverNotifications();
