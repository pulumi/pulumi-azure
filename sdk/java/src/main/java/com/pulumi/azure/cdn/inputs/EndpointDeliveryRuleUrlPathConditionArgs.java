...
public final class EndpointDeliveryRuleUrlPathConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final EndpointDeliveryRuleUrlPathConditionArgs Empty = new EndpointDeliveryRuleUrlPathConditionArgs();
    ...
    private EndpointDeliveryRuleUrlPathConditionArgs() {}

    private EndpointDeliveryRuleUrlPathConditionArgs(EndpointDeliveryRuleUrlPathConditionArgs $) {
    ...
    public static Builder builder(EndpointDeliveryRuleUrlPathConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EndpointDeliveryRuleUrlPathConditionArgs();
        }

        public Builder(EndpointDeliveryRuleUrlPathConditionArgs defaults) {
            $ = new EndpointDeliveryRuleUrlPathConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param operator Valid values are `Any`, `BeginsWith`, `Contains`, `EndsWith`, `Equal`, `GreaterThan`, `GreaterThanOrEqual`, `LessThan`, `LessThanOrEqual`, `RegEx` and `Wildcard`.
         * 
         * @return builder
         * 
         */
        ...
        public EndpointDeliveryRuleUrlPathConditionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("EndpointDeliveryRuleUrlPathConditionArgs", "operator");
            }
            return $;
        }
    }
