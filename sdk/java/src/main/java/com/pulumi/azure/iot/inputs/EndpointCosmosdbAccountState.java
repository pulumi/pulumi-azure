...
public final class EndpointCosmosdbAccountState extends com.pulumi.resources.ResourceArgs {

    public static final EndpointCosmosdbAccountState Empty = new EndpointCosmosdbAccountState();
    ...
    public static Builder builder(EndpointCosmosdbAccountState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EndpointCosmosdbAccountState();
        }

        public Builder(EndpointCosmosdbAccountState defaults) {
            $ = new EndpointCosmosdbAccountState(Objects.requireNonNull(defaults));
        }
