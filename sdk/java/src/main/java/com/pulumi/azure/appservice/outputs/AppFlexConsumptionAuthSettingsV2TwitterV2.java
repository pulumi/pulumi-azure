...
@CustomType
public final class AppFlexConsumptionAuthSettingsV2TwitterV2 {
    /**
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2TwitterV2 defaults) {
    ...
    public static final class Builder {
        ...
        private String consumerSecretSettingName;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsV2TwitterV2 defaults) {
        ...
        public Builder consumerKey(String consumerKey) {
            if (consumerKey == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2TwitterV2", "consumerKey");
            }
        ...
        public Builder consumerSecretSettingName(String consumerSecretSettingName) {
            if (consumerSecretSettingName == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2TwitterV2", "consumerSecretSettingName");
            }
            this.consumerSecretSettingName = consumerSecretSettingName;
            return this;
        }
        public AppFlexConsumptionAuthSettingsV2TwitterV2 build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsV2TwitterV2();
