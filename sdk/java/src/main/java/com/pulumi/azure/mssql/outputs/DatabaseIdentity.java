...
public final class DatabaseIdentity {
    ...
    public static Builder builder(DatabaseIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DatabaseIdentity defaults) {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("DatabaseIdentity", "identityIds");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DatabaseIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public DatabaseIdentity build() {
            final var _resultValue = new DatabaseIdentity();
