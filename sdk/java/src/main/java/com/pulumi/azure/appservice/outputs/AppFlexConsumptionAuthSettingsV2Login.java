...
@CustomType
public final class AppFlexConsumptionAuthSettingsV2Login {
    /**
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2Login defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validateNonce;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsV2Login defaults) {
        ...
        public AppFlexConsumptionAuthSettingsV2Login build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsV2Login();
