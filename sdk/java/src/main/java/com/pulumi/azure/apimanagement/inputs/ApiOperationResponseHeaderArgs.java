...
import com.pulumi.azure.apimanagement.inputs.ApiOperationResponseHeaderExampleArgs;
...
public final class ApiOperationResponseHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiOperationResponseHeaderArgs Empty = new ApiOperationResponseHeaderArgs();
    ...
    private ApiOperationResponseHeaderArgs() {}

    private ApiOperationResponseHeaderArgs(ApiOperationResponseHeaderArgs $) {
    ...
    public static Builder builder(ApiOperationResponseHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiOperationResponseHeaderArgs();
        }

        public Builder(ApiOperationResponseHeaderArgs defaults) {
            $ = new ApiOperationResponseHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder examples(@Nullable Output<List<ApiOperationResponseHeaderExampleArgs>> examples) {
            $.examples = examples;
            return this;
        }
         ...
         * 
         */
        public Builder examples(List<ApiOperationResponseHeaderExampleArgs> examples) {
         ...
         * 
         */
        public Builder examples(ApiOperationResponseHeaderExampleArgs... examples) {
        ...
        public ApiOperationResponseHeaderArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationResponseHeaderArgs", "name");
            }
            if ($.required == null) {
                throw new MissingRequiredPropertyException("ApiOperationResponseHeaderArgs", "required");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ApiOperationResponseHeaderArgs", "type");
            }
            return $;
        }
    }
