...
public final class EmailServiceDomainVerificationRecordDmarc {
    ...
    public static Builder builder(EmailServiceDomainVerificationRecordDmarc defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(EmailServiceDomainVerificationRecordDmarc defaults) {
        ...
        public EmailServiceDomainVerificationRecordDmarc build() {
            final var _resultValue = new EmailServiceDomainVerificationRecordDmarc();
