...
public class DiskPool extends com.pulumi.resources.CustomResource {
    ...
    public DiskPool(java.lang.String name, DiskPoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:compute/diskPool:DiskPool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DiskPool(java.lang.String name, Output<java.lang.String> id, @Nullable DiskPoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:compute/diskPool:DiskPool", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static DiskPool get(java.lang.String name, Output<java.lang.String> id, @Nullable DiskPoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
