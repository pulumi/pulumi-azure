...
@CustomType
public final class LinuxVirtualMachineScaleSetScaleIn {
    /**
    ...
    public static Builder builder(LinuxVirtualMachineScaleSetScaleIn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rule;
        public Builder() {}
        public Builder(LinuxVirtualMachineScaleSetScaleIn defaults) {
