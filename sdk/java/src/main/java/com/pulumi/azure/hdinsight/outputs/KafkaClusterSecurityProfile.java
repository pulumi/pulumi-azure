...
@CustomType
public final class KafkaClusterSecurityProfile {
    /**
    ...
    public static final class Builder {
        ...
        public Builder aaddsResourceId(String aaddsResourceId) {
            if (aaddsResourceId == null) {
              throw new MissingRequiredPropertyException("KafkaClusterSecurityProfile", "aaddsResourceId");
            }
        ...
        public Builder domainName(String domainName) {
            if (domainName == null) {
              throw new MissingRequiredPropertyException("KafkaClusterSecurityProfile", "domainName");
            }
        ...
        public Builder domainUserPassword(String domainUserPassword) {
            if (domainUserPassword == null) {
              throw new MissingRequiredPropertyException("KafkaClusterSecurityProfile", "domainUserPassword");
            }
        ...
        public Builder domainUsername(String domainUsername) {
            if (domainUsername == null) {
              throw new MissingRequiredPropertyException("KafkaClusterSecurityProfile", "domainUsername");
            }
        ...
        public Builder ldapsUrls(List<String> ldapsUrls) {
            if (ldapsUrls == null) {
              throw new MissingRequiredPropertyException("KafkaClusterSecurityProfile", "ldapsUrls");
            }
        ...
        public Builder msiResourceId(String msiResourceId) {
            if (msiResourceId == null) {
              throw new MissingRequiredPropertyException("KafkaClusterSecurityProfile", "msiResourceId");
            }
