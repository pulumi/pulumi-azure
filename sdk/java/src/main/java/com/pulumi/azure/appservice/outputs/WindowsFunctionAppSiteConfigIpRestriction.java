...
import com.pulumi.azure.appservice.outputs.WindowsFunctionAppSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class WindowsFunctionAppSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable WindowsFunctionAppSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private WindowsFunctionAppSiteConfigIpRestriction(
        @CustomType.Parameter("action") @Nullable String action,
        @CustomType.Parameter("headers") @Nullable WindowsFunctionAppSiteConfigIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<WindowsFunctionAppSiteConfigIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(WindowsFunctionAppSiteConfigIpRestriction defaults) {
    ...
    public static final class Builder {
        ...
        public Builder headers(@Nullable WindowsFunctionAppSiteConfigIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            ...
            return new WindowsFunctionAppSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
