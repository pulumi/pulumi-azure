...
public class FirewallApplicationRuleCollection extends com.pulumi.resources.CustomResource {
    ...
    public FirewallApplicationRuleCollection(String name, FirewallApplicationRuleCollectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:network/firewallApplicationRuleCollection:FirewallApplicationRuleCollection", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
