...
@CustomType
public final class ConfigurationBackupRetentionPolicyWeeklyScheduleRetentionDuration {
    /**
    ...
    public static Builder builder(ConfigurationBackupRetentionPolicyWeeklyScheduleRetentionDuration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String durationType;
        public Builder() {}
        public Builder(ConfigurationBackupRetentionPolicyWeeklyScheduleRetentionDuration defaults) {
