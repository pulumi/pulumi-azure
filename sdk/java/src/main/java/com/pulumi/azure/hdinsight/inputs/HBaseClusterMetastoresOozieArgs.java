...
public final class HBaseClusterMetastoresOozieArgs extends com.pulumi.resources.ResourceArgs {

    public static final HBaseClusterMetastoresOozieArgs Empty = new HBaseClusterMetastoresOozieArgs();
    ...
    private HBaseClusterMetastoresOozieArgs() {}

    private HBaseClusterMetastoresOozieArgs(HBaseClusterMetastoresOozieArgs $) {
    ...
    public static Builder builder(HBaseClusterMetastoresOozieArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseClusterMetastoresOozieArgs();
        }

        public Builder(HBaseClusterMetastoresOozieArgs defaults) {
            $ = new HBaseClusterMetastoresOozieArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HBaseClusterMetastoresOozieArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresOozieArgs", "databaseName");
            }
            if ($.password == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresOozieArgs", "password");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresOozieArgs", "server");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresOozieArgs", "username");
            }
            return $;
        }
    }
