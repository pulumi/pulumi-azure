...
public final class GetAppServiceEnvironmentPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppServiceEnvironmentPlainArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAppServiceEnvironmentPlainArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetAppServiceEnvironmentPlainArgs", "resourceGroupName");
            }
            return $;
        }
    }
