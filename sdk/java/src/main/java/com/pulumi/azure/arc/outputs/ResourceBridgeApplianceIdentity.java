...
public final class ResourceBridgeApplianceIdentity {
    ...
    public static Builder builder(ResourceBridgeApplianceIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ResourceBridgeApplianceIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ResourceBridgeApplianceIdentity", "type");
            }
            this.type = type;
            return this;
        }
