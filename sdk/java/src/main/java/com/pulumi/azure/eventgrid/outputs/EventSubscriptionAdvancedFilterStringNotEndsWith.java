...
public final class EventSubscriptionAdvancedFilterStringNotEndsWith {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("EventSubscriptionAdvancedFilterStringNotEndsWith", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("EventSubscriptionAdvancedFilterStringNotEndsWith", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public EventSubscriptionAdvancedFilterStringNotEndsWith build() {
            final var _resultValue = new EventSubscriptionAdvancedFilterStringNotEndsWith();
