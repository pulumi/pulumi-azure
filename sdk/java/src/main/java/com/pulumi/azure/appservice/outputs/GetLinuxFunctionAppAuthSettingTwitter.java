...
@CustomType
public final class GetLinuxFunctionAppAuthSettingTwitter {
    /**
    ...
    private GetLinuxFunctionAppAuthSettingTwitter() {}
    /**
     * @return The OAuth 1.0a consumer key of the Twitter application used for sign-in.
     * 
     */
    ...
    public static Builder builder(GetLinuxFunctionAppAuthSettingTwitter defaults) {
    ...
    public static final class Builder {
        ...
        private String consumerSecretSettingName;
        public Builder() {}
        public Builder(GetLinuxFunctionAppAuthSettingTwitter defaults) {
        ...
        public Builder consumerKey(String consumerKey) {
            if (consumerKey == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingTwitter", "consumerKey");
            }
        ...
        public Builder consumerSecret(String consumerSecret) {
            if (consumerSecret == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingTwitter", "consumerSecret");
            }
        ...
        public Builder consumerSecretSettingName(String consumerSecretSettingName) {
            if (consumerSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingTwitter", "consumerSecretSettingName");
            }
