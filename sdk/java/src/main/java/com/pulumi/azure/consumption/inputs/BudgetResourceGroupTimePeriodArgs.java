...
public final class BudgetResourceGroupTimePeriodArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetResourceGroupTimePeriodArgs Empty = new BudgetResourceGroupTimePeriodArgs();
    ...
    private BudgetResourceGroupTimePeriodArgs() {}

    private BudgetResourceGroupTimePeriodArgs(BudgetResourceGroupTimePeriodArgs $) {
    ...
    public static Builder builder(BudgetResourceGroupTimePeriodArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetResourceGroupTimePeriodArgs();
        }

        public Builder(BudgetResourceGroupTimePeriodArgs defaults) {
            $ = new BudgetResourceGroupTimePeriodArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetResourceGroupTimePeriodArgs build() {
            if ($.startDate == null) {
                throw new MissingRequiredPropertyException("BudgetResourceGroupTimePeriodArgs", "startDate");
            }
            return $;
        }
    }
