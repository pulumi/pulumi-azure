...
public final class ClusterExtensionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder identity(Output<ClusterExtensionIdentityArgs> identity) {
            $.identity = identity;
            return this;
        }
