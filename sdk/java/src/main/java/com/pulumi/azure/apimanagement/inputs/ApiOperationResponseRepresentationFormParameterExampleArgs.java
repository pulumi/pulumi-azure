...
public final class ApiOperationResponseRepresentationFormParameterExampleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiOperationResponseRepresentationFormParameterExampleArgs Empty = new ApiOperationResponseRepresentationFormParameterExampleArgs();
    ...
    private ApiOperationResponseRepresentationFormParameterExampleArgs() {}

    private ApiOperationResponseRepresentationFormParameterExampleArgs(ApiOperationResponseRepresentationFormParameterExampleArgs $) {
    ...
    public static Builder builder(ApiOperationResponseRepresentationFormParameterExampleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiOperationResponseRepresentationFormParameterExampleArgs();
        }

        public Builder(ApiOperationResponseRepresentationFormParameterExampleArgs defaults) {
            $ = new ApiOperationResponseRepresentationFormParameterExampleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiOperationResponseRepresentationFormParameterExampleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationResponseRepresentationFormParameterExampleArgs", "name");
            }
            return $;
        }
    }
