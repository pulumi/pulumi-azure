...
public final class HypervNetworkMappingState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The ID of the Recovery Services Vault where the network mapping should be created. Changing this forces a new resource to be created.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param recoveryVaultId The ID of the Recovery Services Vault where the network mapping should be created. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
