...
public final class WorkbookState extends com.pulumi.resources.ResourceArgs {

    public static final WorkbookState Empty = new WorkbookState();
    ...
    public static Builder builder(WorkbookState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WorkbookState defaults) {
            $ = new WorkbookState(Objects.requireNonNull(defaults));
        }
