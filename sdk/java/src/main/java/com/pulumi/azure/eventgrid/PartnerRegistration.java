...
import com.pulumi.azure.eventgrid.inputs.PartnerRegistrationState;
 ...
 * 
 */
@ResourceType(type="azure:eventgrid/partnerRegistration:PartnerRegistration")
public class PartnerRegistration extends com.pulumi.resources.CustomResource {
     ...
     */
    public PartnerRegistration(java.lang.String name) {
     ...
     */
    public PartnerRegistration(java.lang.String name, PartnerRegistrationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PartnerRegistration(java.lang.String name, PartnerRegistrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:eventgrid/partnerRegistration:PartnerRegistration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PartnerRegistration(java.lang.String name, Output<java.lang.String> id, @Nullable PartnerRegistrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:eventgrid/partnerRegistration:PartnerRegistration", name, state, makeResourceOptions(options, id), false);
    }

    private static PartnerRegistrationArgs makeArgs(PartnerRegistrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PartnerRegistrationArgs.Empty : args;
    }
     ...
     */
    public static PartnerRegistration get(java.lang.String name, Output<java.lang.String> id, @Nullable PartnerRegistrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
