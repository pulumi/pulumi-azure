...
public final class ModuleModuleLinkHash {
    ...
    public static Builder builder(ModuleModuleLinkHash defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(ModuleModuleLinkHash defaults) {
        ...
        public Builder algorithm(String algorithm) {
            if (algorithm == null) {
              throw new MissingRequiredPropertyException("ModuleModuleLinkHash", "algorithm");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("ModuleModuleLinkHash", "value");
            }
            this.value = value;
            return this;
        }
