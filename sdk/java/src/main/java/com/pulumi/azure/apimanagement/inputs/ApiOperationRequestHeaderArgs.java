...
import com.pulumi.azure.apimanagement.inputs.ApiOperationRequestHeaderExampleArgs;
...
public final class ApiOperationRequestHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ApiOperationRequestHeaderExampleArgs>> examples;

    /**
     * @return One or more `example` blocks as defined above.
     * 
     */
    public Optional<Output<List<ApiOperationRequestHeaderExampleArgs>>> examples() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder examples(@Nullable Output<List<ApiOperationRequestHeaderExampleArgs>> examples) {
            $.examples = examples;
            return this;
        }
         ...
         * 
         */
        public Builder examples(List<ApiOperationRequestHeaderExampleArgs> examples) {
         ...
         * 
         */
        public Builder examples(ApiOperationRequestHeaderExampleArgs... examples) {
        ...
        public ApiOperationRequestHeaderArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationRequestHeaderArgs", "name");
            }
            if ($.required == null) {
                throw new MissingRequiredPropertyException("ApiOperationRequestHeaderArgs", "required");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ApiOperationRequestHeaderArgs", "type");
            }
            return $;
        }
    }
