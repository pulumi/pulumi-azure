...
@CustomType
public final class SpringCloudGatewayQuota {
    /**
    ...
    public static Builder builder(SpringCloudGatewayQuota defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SpringCloudGatewayQuota defaults) {
        ...
        public Builder memory(@Nullable String memory) {
            ...
            return new SpringCloudGatewayQuota(cpu, memory);
        }
    }
}
