...
public final class WindowsFunctionAppSlotBackupArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotBackupArgs Empty = new WindowsFunctionAppSlotBackupArgs();
    ...
    private Output<WindowsFunctionAppSlotBackupScheduleArgs> schedule;

    /**
     * @return a `schedule` block as detailed below.
     * 
     */
    public Output<WindowsFunctionAppSlotBackupScheduleArgs> schedule() {
    ...
    private WindowsFunctionAppSlotBackupArgs() {}

    private WindowsFunctionAppSlotBackupArgs(WindowsFunctionAppSlotBackupArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotBackupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotBackupArgs();
        }

        public Builder(WindowsFunctionAppSlotBackupArgs defaults) {
            $ = new WindowsFunctionAppSlotBackupArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder schedule(Output<WindowsFunctionAppSlotBackupScheduleArgs> schedule) {
            $.schedule = schedule;
            return this;
        }
         ...
         * 
         */
        public Builder schedule(WindowsFunctionAppSlotBackupScheduleArgs schedule) {
