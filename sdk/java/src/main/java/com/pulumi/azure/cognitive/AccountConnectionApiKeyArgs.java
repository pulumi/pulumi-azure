...
public final class AccountConnectionApiKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountConnectionApiKeyArgs Empty = new AccountConnectionApiKeyArgs();
    ...
    private AccountConnectionApiKeyArgs() {}

    private AccountConnectionApiKeyArgs(AccountConnectionApiKeyArgs $) {
        this.apiKey = $.apiKey;
    ...
    public static Builder builder(AccountConnectionApiKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountConnectionApiKeyArgs();
        }

        public Builder(AccountConnectionApiKeyArgs defaults) {
            $ = new AccountConnectionApiKeyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountConnectionApiKeyArgs build() {
            if ($.apiKey == null) {
                throw new MissingRequiredPropertyException("AccountConnectionApiKeyArgs", "apiKey");
            }
            if ($.category == null) {
                throw new MissingRequiredPropertyException("AccountConnectionApiKeyArgs", "category");
            }
            if ($.cognitiveAccountId == null) {
                throw new MissingRequiredPropertyException("AccountConnectionApiKeyArgs", "cognitiveAccountId");
            }
            return $;
        }
    }
