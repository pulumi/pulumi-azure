...
public final class DatasetJsonHttpServerLocationArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetJsonHttpServerLocationArgs Empty = new DatasetJsonHttpServerLocationArgs();
    ...
    private DatasetJsonHttpServerLocationArgs() {}

    private DatasetJsonHttpServerLocationArgs(DatasetJsonHttpServerLocationArgs $) {
    ...
    public static Builder builder(DatasetJsonHttpServerLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetJsonHttpServerLocationArgs();
        }

        public Builder(DatasetJsonHttpServerLocationArgs defaults) {
            $ = new DatasetJsonHttpServerLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatasetJsonHttpServerLocationArgs build() {
            if ($.filename == null) {
                throw new MissingRequiredPropertyException("DatasetJsonHttpServerLocationArgs", "filename");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("DatasetJsonHttpServerLocationArgs", "path");
            }
            if ($.relativeUrl == null) {
                throw new MissingRequiredPropertyException("DatasetJsonHttpServerLocationArgs", "relativeUrl");
            }
            return $;
        }
    }
