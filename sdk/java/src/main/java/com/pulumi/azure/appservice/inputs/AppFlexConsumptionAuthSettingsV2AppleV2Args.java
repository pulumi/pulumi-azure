...
public final class AppFlexConsumptionAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsV2AppleV2Args Empty = new AppFlexConsumptionAuthSettingsV2AppleV2Args();
    ...
    private AppFlexConsumptionAuthSettingsV2AppleV2Args() {}

    private AppFlexConsumptionAuthSettingsV2AppleV2Args(AppFlexConsumptionAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsV2AppleV2Args();
        }

        public Builder(AppFlexConsumptionAuthSettingsV2AppleV2Args defaults) {
            $ = new AppFlexConsumptionAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsV2AppleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2AppleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2AppleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
