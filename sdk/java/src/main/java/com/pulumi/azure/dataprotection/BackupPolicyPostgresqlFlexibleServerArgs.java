...
public final class BackupPolicyPostgresqlFlexibleServerArgs extends com.pulumi.resources.ResourceArgs {

    public static final BackupPolicyPostgresqlFlexibleServerArgs Empty = new BackupPolicyPostgresqlFlexibleServerArgs();
    ...
    private Output<BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleArgs> defaultRetentionRule;

    /**
     * @return A `default_retention_rule` block as defined below. Changing this forces a new resource to be created.
     * 
     */
    public Output<BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleArgs> defaultRetentionRule() {
    ...
    private BackupPolicyPostgresqlFlexibleServerArgs() {}

    private BackupPolicyPostgresqlFlexibleServerArgs(BackupPolicyPostgresqlFlexibleServerArgs $) {
    ...
    public static Builder builder(BackupPolicyPostgresqlFlexibleServerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BackupPolicyPostgresqlFlexibleServerArgs();
        }

        public Builder(BackupPolicyPostgresqlFlexibleServerArgs defaults) {
            $ = new BackupPolicyPostgresqlFlexibleServerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder defaultRetentionRule(Output<BackupPolicyPostgresqlFlexibleServerDefaultRetentionRuleArgs> defaultRetentionRule) {
        ...
        public BackupPolicyPostgresqlFlexibleServerArgs build() {
            if ($.backupRepeatingTimeIntervals == null) {
                throw new MissingRequiredPropertyException("BackupPolicyPostgresqlFlexibleServerArgs", "backupRepeatingTimeIntervals");
            }
            if ($.defaultRetentionRule == null) {
                throw new MissingRequiredPropertyException("BackupPolicyPostgresqlFlexibleServerArgs", "defaultRetentionRule");
            }
            if ($.vaultId == null) {
                throw new MissingRequiredPropertyException("BackupPolicyPostgresqlFlexibleServerArgs", "vaultId");
            }
            return $;
        }
    }
