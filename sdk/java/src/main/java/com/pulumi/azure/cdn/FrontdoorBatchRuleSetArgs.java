...
public final class FrontdoorBatchRuleSetArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorBatchRuleSetArgs Empty = new FrontdoorBatchRuleSetArgs();
    ...
    private Output<List<FrontdoorBatchRuleSetRuleArgs>> rules;
     ...
     * 
     */
    public Output<List<FrontdoorBatchRuleSetRuleArgs>> rules() {
        return this.rules;
    }

    private FrontdoorBatchRuleSetArgs() {}

    private FrontdoorBatchRuleSetArgs(FrontdoorBatchRuleSetArgs $) {
    ...
    public static Builder builder(FrontdoorBatchRuleSetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorBatchRuleSetArgs();
        }

        public Builder(FrontdoorBatchRuleSetArgs defaults) {
            $ = new FrontdoorBatchRuleSetArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder rules(Output<List<FrontdoorBatchRuleSetRuleArgs>> rules) {
            $.rules = rules;
            return this;
        }
        ...
        public FrontdoorBatchRuleSetArgs build() {
            if ($.cdnFrontdoorProfileId == null) {
                throw new MissingRequiredPropertyException("FrontdoorBatchRuleSetArgs", "cdnFrontdoorProfileId");
            }
            if ($.rules == null) {
                throw new MissingRequiredPropertyException("FrontdoorBatchRuleSetArgs", "rules");
            }
            return $;
        }
    }
