...
public final class OrchestratedVirtualMachineScaleSetIdentity {
    ...
    public static final class Builder {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetIdentity", "identityIds");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetIdentity", "type");
            }
            this.type = type;
            return this;
        }
