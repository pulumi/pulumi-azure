...
@CustomType
public final class ResourceGroupPolicyAssignmentOverrideSelector {
    private @Nullable List<String> ins;
    private @Nullable String kind;
    private @Nullable List<String> notIns;

    private ResourceGroupPolicyAssignmentOverrideSelector() {}
    ...
    public static Builder builder(ResourceGroupPolicyAssignmentOverrideSelector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> notIns;
        public Builder() {}
        public Builder(ResourceGroupPolicyAssignmentOverrideSelector defaults) {
        ...
        public ResourceGroupPolicyAssignmentOverrideSelector build() {
            final var _resultValue = new ResourceGroupPolicyAssignmentOverrideSelector();
