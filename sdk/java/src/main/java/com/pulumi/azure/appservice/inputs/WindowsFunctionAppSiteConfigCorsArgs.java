...
public final class WindowsFunctionAppSiteConfigCorsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSiteConfigCorsArgs Empty = new WindowsFunctionAppSiteConfigCorsArgs();
    ...
    private WindowsFunctionAppSiteConfigCorsArgs() {}

    private WindowsFunctionAppSiteConfigCorsArgs(WindowsFunctionAppSiteConfigCorsArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppSiteConfigCorsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSiteConfigCorsArgs();
        }

        public Builder(WindowsFunctionAppSiteConfigCorsArgs defaults) {
            $ = new WindowsFunctionAppSiteConfigCorsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSiteConfigCorsArgs build() {
            return $;
        }
    }
