...
public final class LinuxWebAppAuthSettingsTwitterArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsTwitterArgs Empty = new LinuxWebAppAuthSettingsTwitterArgs();
    ...
    private LinuxWebAppAuthSettingsTwitterArgs() {}

    private LinuxWebAppAuthSettingsTwitterArgs(LinuxWebAppAuthSettingsTwitterArgs $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsTwitterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsTwitterArgs();
        }

        public Builder(LinuxWebAppAuthSettingsTwitterArgs defaults) {
            $ = new LinuxWebAppAuthSettingsTwitterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsTwitterArgs build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsTwitterArgs", "consumerKey");
            }
            return $;
        }
    }
