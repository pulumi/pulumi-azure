...
public final class TransformOutputCustomPresetFilterFadeOutArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransformOutputCustomPresetFilterFadeOutArgs Empty = new TransformOutputCustomPresetFilterFadeOutArgs();
    ...
    private TransformOutputCustomPresetFilterFadeOutArgs() {}

    private TransformOutputCustomPresetFilterFadeOutArgs(TransformOutputCustomPresetFilterFadeOutArgs $) {
    ...
    public static Builder builder(TransformOutputCustomPresetFilterFadeOutArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransformOutputCustomPresetFilterFadeOutArgs();
        }

        public Builder(TransformOutputCustomPresetFilterFadeOutArgs defaults) {
            $ = new TransformOutputCustomPresetFilterFadeOutArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransformOutputCustomPresetFilterFadeOutArgs build() {
            if ($.duration == null) {
                throw new MissingRequiredPropertyException("TransformOutputCustomPresetFilterFadeOutArgs", "duration");
            }
            if ($.fadeColor == null) {
                throw new MissingRequiredPropertyException("TransformOutputCustomPresetFilterFadeOutArgs", "fadeColor");
            }
            return $;
        }
    }
