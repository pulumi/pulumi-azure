...
public final class StreamInputEventHubState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<StreamInputEventHubSerializationArgs> serialization;

    /**
     * @return A `serialization` block as defined below.
     * 
     */
    public Optional<Output<StreamInputEventHubSerializationArgs>> serialization() {
    ...
    public static Builder builder(StreamInputEventHubState defaults) {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder serialization(@Nullable Output<StreamInputEventHubSerializationArgs> serialization) {
        ...
        public StreamInputEventHubState build() {
            return $;
        }
    }
