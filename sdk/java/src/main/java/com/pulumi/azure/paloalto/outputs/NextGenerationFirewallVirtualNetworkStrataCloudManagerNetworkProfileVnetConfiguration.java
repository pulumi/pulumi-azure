...
@CustomType
public final class NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfileVnetConfiguration {
    /**
    ...
    public static Builder builder(NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfileVnetConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private String virtualNetworkId;
        public Builder() {}
        public Builder(NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfileVnetConfiguration defaults) {
        ...
        public Builder virtualNetworkId(String virtualNetworkId) {
            if (virtualNetworkId == null) {
              throw new MissingRequiredPropertyException("NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfileVnetConfiguration", "virtualNetworkId");
            }
            this.virtualNetworkId = virtualNetworkId;
            return this;
        }
        public NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfileVnetConfiguration build() {
            final var _resultValue = new NextGenerationFirewallVirtualNetworkStrataCloudManagerNetworkProfileVnetConfiguration();
