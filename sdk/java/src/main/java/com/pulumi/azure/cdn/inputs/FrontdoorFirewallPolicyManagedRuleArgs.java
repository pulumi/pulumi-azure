...
public final class FrontdoorFirewallPolicyManagedRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The action to perform for all DRS rules when the managed rule is matched or when the anomaly score is 5 or greater depending on which version of the DRS you are using. Possible values include `Allow`, `Log`, `Block`, and `Redirect`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param action The action to perform for all DRS rules when the managed rule is matched or when the anomaly score is 5 or greater depending on which version of the DRS you are using. Possible values include `Allow`, `Log`, `Block`, and `Redirect`.
         * 
         * @return builder
         * 
         */
