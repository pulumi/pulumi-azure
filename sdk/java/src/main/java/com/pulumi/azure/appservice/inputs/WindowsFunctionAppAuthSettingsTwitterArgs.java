...
public final class WindowsFunctionAppAuthSettingsTwitterArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsTwitterArgs Empty = new WindowsFunctionAppAuthSettingsTwitterArgs();
    ...
    private WindowsFunctionAppAuthSettingsTwitterArgs() {}

    private WindowsFunctionAppAuthSettingsTwitterArgs(WindowsFunctionAppAuthSettingsTwitterArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsTwitterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsTwitterArgs();
        }

        public Builder(WindowsFunctionAppAuthSettingsTwitterArgs defaults) {
            $ = new WindowsFunctionAppAuthSettingsTwitterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsTwitterArgs build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsTwitterArgs", "consumerKey");
            }
            return $;
        }
    }
