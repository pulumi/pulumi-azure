...
@CustomType
public final class GetWindowsWebAppSiteConfigScmIpRestrictionHeader {
    /**
    ...
    private GetWindowsWebAppSiteConfigScmIpRestrictionHeader() {}
    /**
     * @return The list of Azure Front Door IDs.
     * 
     */
    ...
    public static Builder builder(GetWindowsWebAppSiteConfigScmIpRestrictionHeader defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> xForwardedHosts;
        public Builder() {}
        public Builder(GetWindowsWebAppSiteConfigScmIpRestrictionHeader defaults) {
        ...
        public Builder xAzureFdids(List<String> xAzureFdids) {
            if (xAzureFdids == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigScmIpRestrictionHeader", "xAzureFdids");
            }
        ...
        public Builder xFdHealthProbes(List<String> xFdHealthProbes) {
            if (xFdHealthProbes == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigScmIpRestrictionHeader", "xFdHealthProbes");
            }
        ...
        public Builder xForwardedFors(List<String> xForwardedFors) {
            if (xForwardedFors == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigScmIpRestrictionHeader", "xForwardedFors");
            }
        ...
        public Builder xForwardedHosts(List<String> xForwardedHosts) {
            if (xForwardedHosts == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigScmIpRestrictionHeader", "xForwardedHosts");
            }
        ...
        public GetWindowsWebAppSiteConfigScmIpRestrictionHeader build() {
            final var _resultValue = new GetWindowsWebAppSiteConfigScmIpRestrictionHeader();
