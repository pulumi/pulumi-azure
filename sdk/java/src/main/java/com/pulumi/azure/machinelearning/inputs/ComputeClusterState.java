...
public final class ComputeClusterState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> vmPriority;
     ...
     * 
     */
    public Optional<Output<String>> vmPriority() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder scaleSettings(@Nullable Output<ComputeClusterScaleSettingsArgs> scaleSettings) {
         ...
         * 
         */
        public Builder vmPriority(@Nullable Output<String> vmPriority) {
