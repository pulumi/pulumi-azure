...
public class EnvironmentDaprComponent extends com.pulumi.resources.CustomResource {
    ...
    public EnvironmentDaprComponent(String name, EnvironmentDaprComponentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:containerapp/environmentDaprComponent:EnvironmentDaprComponent", name, args == null ? EnvironmentDaprComponentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
