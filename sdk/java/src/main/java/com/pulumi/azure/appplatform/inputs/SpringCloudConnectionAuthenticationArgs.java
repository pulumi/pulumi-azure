...
public final class SpringCloudConnectionAuthenticationArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpringCloudConnectionAuthenticationArgs Empty = new SpringCloudConnectionAuthenticationArgs();
    ...
    private SpringCloudConnectionAuthenticationArgs() {}

    private SpringCloudConnectionAuthenticationArgs(SpringCloudConnectionAuthenticationArgs $) {
    ...
    public static Builder builder(SpringCloudConnectionAuthenticationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpringCloudConnectionAuthenticationArgs();
        }

        public Builder(SpringCloudConnectionAuthenticationArgs defaults) {
            $ = new SpringCloudConnectionAuthenticationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param clientId Client ID for `userAssignedIdentity` or `servicePrincipal` auth. Should be specified when `type` is set to `servicePrincipalSecret` or `servicePrincipalCertificate`. When `type` is set to `userAssignedIdentity`, `clientId` and `subscriptionId` should be either both specified or both not specified.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param subscriptionId Subscription ID for `userAssignedIdentity`. `subscriptionId` and `clientId` should be either both specified or both not specified.
         * 
         * @return builder
         * 
         */
        ...
        public SpringCloudConnectionAuthenticationArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("SpringCloudConnectionAuthenticationArgs", "type");
            }
            return $;
        }
    }
