...
import com.pulumi.azure.paloalto.inputs.NextGenerationFirewallVirtualHubLocalRulestackDestinationNatBackendConfigArgs;
import com.pulumi.azure.paloalto.inputs.NextGenerationFirewallVirtualHubLocalRulestackDestinationNatFrontendConfigArgs;
...
public final class NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs() {}

    private NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs(NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs $) {
    ...
    public static Builder builder(NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs();
        }

        public Builder(NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs defaults) {
        ...
        public NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs", "name");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("NextGenerationFirewallVirtualHubLocalRulestackDestinationNatArgs", "protocol");
            }
            return $;
        }
    }
