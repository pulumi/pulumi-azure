...
public final class WindowsWebAppSlotAuthSettingsTwitterArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsTwitterArgs Empty = new WindowsWebAppSlotAuthSettingsTwitterArgs();
    ...
    private WindowsWebAppSlotAuthSettingsTwitterArgs() {}

    private WindowsWebAppSlotAuthSettingsTwitterArgs(WindowsWebAppSlotAuthSettingsTwitterArgs $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsTwitterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsTwitterArgs();
        }

        public Builder(WindowsWebAppSlotAuthSettingsTwitterArgs defaults) {
            $ = new WindowsWebAppSlotAuthSettingsTwitterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsTwitterArgs build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsTwitterArgs", "consumerKey");
            }
            return $;
        }
    }
