...
public class VirtualMachineAvailabilityGroupListener extends com.pulumi.resources.CustomResource {
     ...
     */
    public VirtualMachineAvailabilityGroupListener(String name) {
     ...
     */
    public static VirtualMachineAvailabilityGroupListener get(String name, Output<String> id, @Nullable VirtualMachineAvailabilityGroupListenerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
