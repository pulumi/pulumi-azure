...
public final class AccountTablePropertiesHourMetricsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountTablePropertiesHourMetricsArgs Empty = new AccountTablePropertiesHourMetricsArgs();
    ...
    private AccountTablePropertiesHourMetricsArgs() {}

    private AccountTablePropertiesHourMetricsArgs(AccountTablePropertiesHourMetricsArgs $) {
    ...
    public static Builder builder(AccountTablePropertiesHourMetricsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountTablePropertiesHourMetricsArgs();
        }

        public Builder(AccountTablePropertiesHourMetricsArgs defaults) {
            $ = new AccountTablePropertiesHourMetricsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountTablePropertiesHourMetricsArgs build() {
            if ($.version == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesHourMetricsArgs", "version");
            }
            return $;
        }
    }
