...
public final class FunctionAppSiteConfigCorsArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppSiteConfigCorsArgs Empty = new FunctionAppSiteConfigCorsArgs();
    ...
    private FunctionAppSiteConfigCorsArgs() {}

    private FunctionAppSiteConfigCorsArgs(FunctionAppSiteConfigCorsArgs $) {
    ...
    public static Builder builder(FunctionAppSiteConfigCorsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FunctionAppSiteConfigCorsArgs defaults) {
            $ = new FunctionAppSiteConfigCorsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionAppSiteConfigCorsArgs build() {
            if ($.allowedOrigins == null) {
                throw new MissingRequiredPropertyException("FunctionAppSiteConfigCorsArgs", "allowedOrigins");
            }
            return $;
        }
    }
