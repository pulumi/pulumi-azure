...
public final class GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2 {
    ...
    private GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2() {}
    /**
     * @return The list of allowed Applications for the Default Authorisation Policy.
     * 
     */
    ...
    public static Builder builder(GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2 defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean wwwAuthenticationDisabled;
        public Builder() {}
        public Builder(GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2 defaults) {
        ...
        public Builder allowedApplications(List<String> allowedApplications) {
            if (allowedApplications == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "allowedApplications");
            }
        ...
        public Builder allowedAudiences(List<String> allowedAudiences) {
            if (allowedAudiences == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "allowedAudiences");
            }
        ...
        public Builder allowedGroups(List<String> allowedGroups) {
            if (allowedGroups == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "allowedGroups");
            }
        ...
        public Builder allowedIdentities(List<String> allowedIdentities) {
            if (allowedIdentities == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "allowedIdentities");
            }
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "clientId");
            }
        ...
        public Builder clientSecretCertificateThumbprint(String clientSecretCertificateThumbprint) {
            if (clientSecretCertificateThumbprint == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "clientSecretCertificateThumbprint");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "clientSecretSettingName");
            }
        ...
        public Builder jwtAllowedClientApplications(List<String> jwtAllowedClientApplications) {
            if (jwtAllowedClientApplications == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "jwtAllowedClientApplications");
            }
        ...
        public Builder jwtAllowedGroups(List<String> jwtAllowedGroups) {
            if (jwtAllowedGroups == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "jwtAllowedGroups");
            }
        ...
        public Builder loginParameters(Map<String,String> loginParameters) {
            if (loginParameters == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "loginParameters");
            }
        ...
        public Builder tenantAuthEndpoint(String tenantAuthEndpoint) {
            if (tenantAuthEndpoint == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "tenantAuthEndpoint");
            }
        ...
        public Builder wwwAuthenticationDisabled(Boolean wwwAuthenticationDisabled) {
            if (wwwAuthenticationDisabled == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2", "wwwAuthenticationDisabled");
            }
            this.wwwAuthenticationDisabled = wwwAuthenticationDisabled;
            return this;
        }
        public GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2 build() {
            final var _resultValue = new GetLinuxWebAppAuthSettingsV2ActiveDirectoryV2();
