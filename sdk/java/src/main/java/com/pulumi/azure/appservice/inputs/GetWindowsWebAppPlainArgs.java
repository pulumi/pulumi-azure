...
public final class GetWindowsWebAppPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetWindowsWebAppPlainArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetWindowsWebAppPlainArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetWindowsWebAppPlainArgs", "resourceGroupName");
            }
            return $;
        }
    }
