...
public final class EndpointDeliveryRuleUrlPathCondition {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRuleUrlPathCondition", "operator");
            }
        ...
        public EndpointDeliveryRuleUrlPathCondition build() {
            final var _resultValue = new EndpointDeliveryRuleUrlPathCondition();
