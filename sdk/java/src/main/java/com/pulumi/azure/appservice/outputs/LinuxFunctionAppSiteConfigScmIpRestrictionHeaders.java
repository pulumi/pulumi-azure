...
@CustomType
public final class LinuxFunctionAppSiteConfigScmIpRestrictionHeaders {
    /**
    ...
    public static Builder builder(LinuxFunctionAppSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxFunctionAppSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        }        public LinuxFunctionAppSiteConfigScmIpRestrictionHeaders build() {
            return new LinuxFunctionAppSiteConfigScmIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
