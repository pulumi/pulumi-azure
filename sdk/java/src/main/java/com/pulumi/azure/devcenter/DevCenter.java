...
public class DevCenter extends com.pulumi.resources.CustomResource {
     ...
     */
    public static DevCenter get(String name, Output<String> id, @Nullable DevCenterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
