...
public final class WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args Empty = new WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args();
    ...
    private WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args() {}

    private WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args(WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args $) {
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args();
        }

        public Builder(WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args defaults) {
            $ = new WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args", "clientId");
            }
            if ($.tenantAuthEndpoint == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2ActiveDirectoryV2Args", "tenantAuthEndpoint");
            }
            return $;
        }
    }
