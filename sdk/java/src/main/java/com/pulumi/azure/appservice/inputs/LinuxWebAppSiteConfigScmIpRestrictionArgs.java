...
import com.pulumi.azure.appservice.inputs.LinuxWebAppSiteConfigScmIpRestrictionHeadersArgs;
...
public final class LinuxWebAppSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSiteConfigScmIpRestrictionArgs Empty = new LinuxWebAppSiteConfigScmIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxWebAppSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<LinuxWebAppSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxWebAppSiteConfigScmIpRestrictionArgs() {}

    private LinuxWebAppSiteConfigScmIpRestrictionArgs(LinuxWebAppSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxWebAppSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSiteConfigScmIpRestrictionArgs();
        }

        public Builder(LinuxWebAppSiteConfigScmIpRestrictionArgs defaults) {
            $ = new LinuxWebAppSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxWebAppSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxWebAppSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public LinuxWebAppSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
