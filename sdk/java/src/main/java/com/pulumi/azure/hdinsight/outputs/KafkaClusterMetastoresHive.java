...
@CustomType
public final class KafkaClusterMetastoresHive {
    /**
    ...
    public static final class Builder {
        ...
        public Builder databaseName(String databaseName) {
            if (databaseName == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresHive", "databaseName");
            }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresHive", "password");
            }
        ...
        public Builder server(String server) {
            if (server == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresHive", "server");
            }
            this.server = server;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresHive", "username");
            }
            this.username = username;
            return this;
        }
        public KafkaClusterMetastoresHive build() {
            final var _resultValue = new KafkaClusterMetastoresHive();
