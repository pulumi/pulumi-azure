...
public final class DataLakeGen2FilesystemAce {
    ...
    public static final class Builder {
        ...
        public Builder permissions(String permissions) {
            if (permissions == null) {
              throw new MissingRequiredPropertyException("DataLakeGen2FilesystemAce", "permissions");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DataLakeGen2FilesystemAce", "type");
            }
            this.type = type;
            return this;
        }
