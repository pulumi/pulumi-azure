...
public class PrivateLink extends com.pulumi.resources.CustomResource {
     ...
     */
    public PrivateLink(String name) {
     ...
     */
    public PrivateLink(String name, PrivateLinkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:management/privateLink:PrivateLink", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private PrivateLink(String name, Output<String> id, @Nullable PrivateLinkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:management/privateLink:PrivateLink", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static PrivateLink get(String name, Output<String> id, @Nullable PrivateLinkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
