...
public final class FrontdoorRuleConditionsPostArgsConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsPostArgsConditionArgs Empty = new FrontdoorRuleConditionsPostArgsConditionArgs();
    ...
    /**
     * @return One or more string or integer values(e.g. &#34;1&#34;) representing the value of the `POST` argument to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
     * 
     */
     ...
     * 
     */
    @Import(name="postArgsName", required=true)
    private Output<String> postArgsName;

    /**
     * @return A string value representing the name of the `POST` argument.
     * 
     */
    public Output<String> postArgsName() {
    ...
    private FrontdoorRuleConditionsPostArgsConditionArgs() {}

    private FrontdoorRuleConditionsPostArgsConditionArgs(FrontdoorRuleConditionsPostArgsConditionArgs $) {
        this.matchValues = $.matchValues;
        this.negateCondition = $.negateCondition;
        this.operator = $.operator;
        this.postArgsName = $.postArgsName;
    ...
    public static Builder builder(FrontdoorRuleConditionsPostArgsConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsPostArgsConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsPostArgsConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsPostArgsConditionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param matchValues One or more string or integer values(e.g. &#34;1&#34;) representing the value of the `POST` argument to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param postArgsName A string value representing the name of the `POST` argument.
         * 
         * @return builder
         * 
         */
        public Builder postArgsName(Output<String> postArgsName) {
         ...
         * 
         */
        public Builder postArgsName(String postArgsName) {
            return postArgsName(Output.of(postArgsName));
        }
        ...
        public FrontdoorRuleConditionsPostArgsConditionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsPostArgsConditionArgs", "operator");
            }
            if ($.postArgsName == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsPostArgsConditionArgs", "postArgsName");
            }
            return $;
        }
    }
