...
public final class DatasetDelimitedTextHttpServerLocationArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetDelimitedTextHttpServerLocationArgs Empty = new DatasetDelimitedTextHttpServerLocationArgs();
    ...
    private DatasetDelimitedTextHttpServerLocationArgs() {}

    private DatasetDelimitedTextHttpServerLocationArgs(DatasetDelimitedTextHttpServerLocationArgs $) {
    ...
    public static Builder builder(DatasetDelimitedTextHttpServerLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetDelimitedTextHttpServerLocationArgs();
        }

        public Builder(DatasetDelimitedTextHttpServerLocationArgs defaults) {
            $ = new DatasetDelimitedTextHttpServerLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatasetDelimitedTextHttpServerLocationArgs build() {
            if ($.filename == null) {
                throw new MissingRequiredPropertyException("DatasetDelimitedTextHttpServerLocationArgs", "filename");
            }
            if ($.path == null) {
                throw new MissingRequiredPropertyException("DatasetDelimitedTextHttpServerLocationArgs", "path");
            }
            if ($.relativeUrl == null) {
                throw new MissingRequiredPropertyException("DatasetDelimitedTextHttpServerLocationArgs", "relativeUrl");
            }
            return $;
        }
    }
