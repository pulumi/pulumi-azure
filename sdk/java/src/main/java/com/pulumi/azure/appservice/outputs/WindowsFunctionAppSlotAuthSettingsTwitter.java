...
@CustomType
public final class WindowsFunctionAppSlotAuthSettingsTwitter {
    /**
    ...
    private WindowsFunctionAppSlotAuthSettingsTwitter(
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsTwitter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(WindowsFunctionAppSlotAuthSettingsTwitter defaults) {
        ...
        public Builder consumerSecretSettingName(@Nullable String consumerSecretSettingName) {
            this.consumerSecretSettingName = consumerSecretSettingName;
            return this;
        }        public WindowsFunctionAppSlotAuthSettingsTwitter build() {
            return new WindowsFunctionAppSlotAuthSettingsTwitter(consumerKey, consumerSecret, consumerSecretSettingName);
        }
    }
}
