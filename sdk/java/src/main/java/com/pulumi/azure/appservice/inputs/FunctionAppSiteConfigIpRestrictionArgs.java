...
import com.pulumi.azure.appservice.inputs.FunctionAppSiteConfigIpRestrictionHeadersArgs;
...
public final class FunctionAppSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppSiteConfigIpRestrictionArgs Empty = new FunctionAppSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<FunctionAppSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return The `headers` block for this specific `ipRestriction` as defined below.
     * 
     */
    public Optional<Output<FunctionAppSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private FunctionAppSiteConfigIpRestrictionArgs() {}

    private FunctionAppSiteConfigIpRestrictionArgs(FunctionAppSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(FunctionAppSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FunctionAppSiteConfigIpRestrictionArgs defaults) {
            $ = new FunctionAppSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<FunctionAppSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(FunctionAppSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public FunctionAppSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
