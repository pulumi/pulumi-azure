...
@CustomType
public final class GetStandardSiteConfigScmIpRestrictionHeader {
    /**
    ...
    private GetStandardSiteConfigScmIpRestrictionHeader() {}
    /**
     * @return A list of allowed Azure FrontDoor IDs in UUID notation.
     * 
     */
    ...
    public static Builder builder(GetStandardSiteConfigScmIpRestrictionHeader defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> xForwardedHosts;
        public Builder() {}
        public Builder(GetStandardSiteConfigScmIpRestrictionHeader defaults) {
        ...
        public Builder xAzureFdids(List<String> xAzureFdids) {
            if (xAzureFdids == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigScmIpRestrictionHeader", "xAzureFdids");
            }
        ...
        public Builder xFdHealthProbes(List<String> xFdHealthProbes) {
            if (xFdHealthProbes == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigScmIpRestrictionHeader", "xFdHealthProbes");
            }
        ...
        public Builder xForwardedFors(List<String> xForwardedFors) {
            if (xForwardedFors == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigScmIpRestrictionHeader", "xForwardedFors");
            }
        ...
        public Builder xForwardedHosts(List<String> xForwardedHosts) {
            if (xForwardedHosts == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigScmIpRestrictionHeader", "xForwardedHosts");
            }
        ...
        public GetStandardSiteConfigScmIpRestrictionHeader build() {
            final var _resultValue = new GetStandardSiteConfigScmIpRestrictionHeader();
