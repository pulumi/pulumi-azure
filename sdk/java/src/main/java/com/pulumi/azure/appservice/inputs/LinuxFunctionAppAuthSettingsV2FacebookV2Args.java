...
public final class LinuxFunctionAppAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsV2FacebookV2Args Empty = new LinuxFunctionAppAuthSettingsV2FacebookV2Args();
    ...
    private LinuxFunctionAppAuthSettingsV2FacebookV2Args() {}

    private LinuxFunctionAppAuthSettingsV2FacebookV2Args(LinuxFunctionAppAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsV2FacebookV2Args();
        }

        public Builder(LinuxFunctionAppAuthSettingsV2FacebookV2Args defaults) {
            $ = new LinuxFunctionAppAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
