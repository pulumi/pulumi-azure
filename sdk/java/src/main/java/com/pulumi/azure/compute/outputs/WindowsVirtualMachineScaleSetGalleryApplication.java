...
@CustomType
public final class WindowsVirtualMachineScaleSetGalleryApplication {
    /**
    ...
    public static Builder builder(WindowsVirtualMachineScaleSetGalleryApplication defaults) {
    ...
    public static final class Builder {
        ...
        private String versionId;
        public Builder() {}
        public Builder(WindowsVirtualMachineScaleSetGalleryApplication defaults) {
        ...
        public Builder versionId(String versionId) {
            if (versionId == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetGalleryApplication", "versionId");
            }
