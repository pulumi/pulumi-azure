...
public final class KafkaClusterRolesZookeeperNode {
    ...
    public static final class Builder {
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("KafkaClusterRolesZookeeperNode", "username");
            }
        ...
        public Builder vmSize(String vmSize) {
            if (vmSize == null) {
              throw new MissingRequiredPropertyException("KafkaClusterRolesZookeeperNode", "vmSize");
            }
            this.vmSize = vmSize;
            return this;
        }
