...
public final class EndpointDeliveryRuleUrlFileExtensionCondition {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRuleUrlFileExtensionCondition", "operator");
            }
        ...
        public EndpointDeliveryRuleUrlFileExtensionCondition build() {
            final var _resultValue = new EndpointDeliveryRuleUrlFileExtensionCondition();
