...
@CustomType
public final class LinuxWebAppSlotAuthSettingsV2AppleV2 {
    /**
    ...
    private LinuxWebAppSlotAuthSettingsV2AppleV2() {}
    /**
     * @return The OpenID Connect Client ID for the Apple web application.
     * 
     */
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2AppleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxWebAppSlotAuthSettingsV2AppleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2AppleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2AppleV2", "clientSecretSettingName");
            }
        ...
        public LinuxWebAppSlotAuthSettingsV2AppleV2 build() {
            final var _resultValue = new LinuxWebAppSlotAuthSettingsV2AppleV2();
