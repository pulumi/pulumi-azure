...
public final class WindowsWebAppAuthSettingsV2TwitterV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WindowsWebAppAuthSettingsV2TwitterV2Args build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2TwitterV2Args", "consumerKey");
            }
            if ($.consumerSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2TwitterV2Args", "consumerSecretSettingName");
            }
            return $;
        }
    }
