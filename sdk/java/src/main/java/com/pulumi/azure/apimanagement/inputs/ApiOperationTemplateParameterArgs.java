...
import com.pulumi.azure.apimanagement.inputs.ApiOperationTemplateParameterExampleArgs;
...
public final class ApiOperationTemplateParameterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ApiOperationTemplateParameterExampleArgs>> examples;

    /**
     * @return One or more `example` blocks as defined above.
     * 
     */
    public Optional<Output<List<ApiOperationTemplateParameterExampleArgs>>> examples() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder examples(@Nullable Output<List<ApiOperationTemplateParameterExampleArgs>> examples) {
            $.examples = examples;
            return this;
        }
         ...
         * 
         */
        public Builder examples(List<ApiOperationTemplateParameterExampleArgs> examples) {
         ...
         * 
         */
        public Builder examples(ApiOperationTemplateParameterExampleArgs... examples) {
        ...
        public ApiOperationTemplateParameterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationTemplateParameterArgs", "name");
            }
            if ($.required == null) {
                throw new MissingRequiredPropertyException("ApiOperationTemplateParameterArgs", "required");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ApiOperationTemplateParameterArgs", "type");
            }
            return $;
        }
    }
