...
@CustomType
public final class LinuxWebAppLogsApplicationLogsAzureBlobStorage {
    /**
    ...
    public static final class Builder {
        ...
        public Builder level(String level) {
            if (level == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppLogsApplicationLogsAzureBlobStorage", "level");
            }
            this.level = level;
            return this;
        }
        ...
        public Builder retentionInDays(Integer retentionInDays) {
            if (retentionInDays == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppLogsApplicationLogsAzureBlobStorage", "retentionInDays");
            }
        ...
        public Builder sasUrl(String sasUrl) {
            if (sasUrl == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppLogsApplicationLogsAzureBlobStorage", "sasUrl");
            }
            this.sasUrl = sasUrl;
            return this;
        }
        public LinuxWebAppLogsApplicationLogsAzureBlobStorage build() {
            final var _resultValue = new LinuxWebAppLogsApplicationLogsAzureBlobStorage();
