...
public final class FirewallPolicyIdentity {
    ...
    public static Builder builder(FirewallPolicyIdentity defaults) {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("FirewallPolicyIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public FirewallPolicyIdentity build() {
            final var _resultValue = new FirewallPolicyIdentity();
