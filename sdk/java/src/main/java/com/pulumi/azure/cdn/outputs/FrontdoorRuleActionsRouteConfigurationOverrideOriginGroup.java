...
@CustomType
public final class FrontdoorRuleActionsRouteConfigurationOverrideOriginGroup {
    /**
    ...
    public static Builder builder(FrontdoorRuleActionsRouteConfigurationOverrideOriginGroup defaults) {
    ...
    public static final class Builder {
        ...
        private String forwardingProtocol;
        public Builder() {}
        public Builder(FrontdoorRuleActionsRouteConfigurationOverrideOriginGroup defaults) {
        ...
        public Builder cdnFrontdoorOriginGroupId(String cdnFrontdoorOriginGroupId) {
            if (cdnFrontdoorOriginGroupId == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleActionsRouteConfigurationOverrideOriginGroup", "cdnFrontdoorOriginGroupId");
            }
        ...
        public Builder forwardingProtocol(String forwardingProtocol) {
            if (forwardingProtocol == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleActionsRouteConfigurationOverrideOriginGroup", "forwardingProtocol");
            }
            this.forwardingProtocol = forwardingProtocol;
            return this;
        }
        public FrontdoorRuleActionsRouteConfigurationOverrideOriginGroup build() {
            final var _resultValue = new FrontdoorRuleActionsRouteConfigurationOverrideOriginGroup();
