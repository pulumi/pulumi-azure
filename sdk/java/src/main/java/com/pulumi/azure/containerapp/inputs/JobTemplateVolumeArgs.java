...
public final class JobTemplateVolumeArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTemplateVolumeArgs Empty = new JobTemplateVolumeArgs();
    ...
    private JobTemplateVolumeArgs() {}

    private JobTemplateVolumeArgs(JobTemplateVolumeArgs $) {
    ...
    public static Builder builder(JobTemplateVolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTemplateVolumeArgs();
        }

        public Builder(JobTemplateVolumeArgs defaults) {
            $ = new JobTemplateVolumeArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param storageName The name of the storage to use for the volume.
         * 
         * @return builder
         * 
         */
        ...
        public JobTemplateVolumeArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("JobTemplateVolumeArgs", "name");
            }
            return $;
        }
    }
