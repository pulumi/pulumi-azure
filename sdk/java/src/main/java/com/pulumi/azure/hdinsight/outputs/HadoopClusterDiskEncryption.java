...
@CustomType
public final class HadoopClusterDiskEncryption {
    /**
    ...
    public static Builder builder(HadoopClusterDiskEncryption defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyVaultManagedIdentityId;
        public Builder() {}
        public Builder(HadoopClusterDiskEncryption defaults) {
        ...
        public HadoopClusterDiskEncryption build() {
            final var _resultValue = new HadoopClusterDiskEncryption();
