...
public final class LinuxWebAppSlotAuthSettings {
     ...
     * 
     */
    private final @Nullable LinuxWebAppSlotAuthSettingsActiveDirectory activeDirectory;
    /**
     ...
     * 
     */
    private final @Nullable LinuxWebAppSlotAuthSettingsFacebook facebook;
    /**
     * @return A `github` block as defined below.
     * 
     */
    private final @Nullable LinuxWebAppSlotAuthSettingsGithub github;
    /**
     * @return A `google` block as defined below.
     * 
     */
    private final @Nullable LinuxWebAppSlotAuthSettingsGoogle google;
    /**
     ...
     * 
     */
    private final @Nullable LinuxWebAppSlotAuthSettingsMicrosoft microsoft;
    /**
     ...
     * 
     */
    private final @Nullable LinuxWebAppSlotAuthSettingsTwitter twitter;
    /**
    ...
    private LinuxWebAppSlotAuthSettings(
        @CustomType.Parameter("activeDirectory") @Nullable LinuxWebAppSlotAuthSettingsActiveDirectory activeDirectory,
        ...
        @CustomType.Parameter("facebook") @Nullable LinuxWebAppSlotAuthSettingsFacebook facebook,
        @CustomType.Parameter("github") @Nullable LinuxWebAppSlotAuthSettingsGithub github,
        @CustomType.Parameter("google") @Nullable LinuxWebAppSlotAuthSettingsGoogle google,
        @CustomType.Parameter("issuer") @Nullable String issuer,
        @CustomType.Parameter("microsoft") @Nullable LinuxWebAppSlotAuthSettingsMicrosoft microsoft,
        ...
        @CustomType.Parameter("twitter") @Nullable LinuxWebAppSlotAuthSettingsTwitter twitter,
    ...
    public static final class Builder {
        ...
        public Builder unauthenticatedClientAction(@Nullable String unauthenticatedClientAction) {
            ...
            return new LinuxWebAppSlotAuthSettings(activeDirectory, additionalLoginParameters, allowedExternalRedirectUrls, defaultProvider, enabled, facebook, github, google, issuer, microsoft, runtimeVersion, tokenRefreshExtensionHours, tokenStoreEnabled, twitter, unauthenticatedClientAction);
        }
    }
}
