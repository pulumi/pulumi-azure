...
public final class WindowsFunctionAppAuthSettingsV2TwitterV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsV2TwitterV2Args Empty = new WindowsFunctionAppAuthSettingsV2TwitterV2Args();
    ...
    private WindowsFunctionAppAuthSettingsV2TwitterV2Args() {}

    private WindowsFunctionAppAuthSettingsV2TwitterV2Args(WindowsFunctionAppAuthSettingsV2TwitterV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2TwitterV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsV2TwitterV2Args();
        }

        public Builder(WindowsFunctionAppAuthSettingsV2TwitterV2Args defaults) {
            $ = new WindowsFunctionAppAuthSettingsV2TwitterV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsV2TwitterV2Args build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2TwitterV2Args", "consumerKey");
            }
            if ($.consumerSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2TwitterV2Args", "consumerSecretSettingName");
            }
            return $;
        }
    }
