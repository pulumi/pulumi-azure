...
public final class AppIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AppIdentityArgs() {}

    private AppIdentityArgs(AppIdentityArgs $) {
    ...
    public static Builder builder(AppIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(AppIdentityArgs defaults) {
        ...
        public AppIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("AppIdentityArgs", "type");
            }
            return $;
        }
    }
