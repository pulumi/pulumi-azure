...
public class TxtRecord extends com.pulumi.resources.CustomResource {
    ...
    public TxtRecord(java.lang.String name, TxtRecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:privatedns/txtRecord:TxtRecord", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private TxtRecord(java.lang.String name, Output<java.lang.String> id, @Nullable TxtRecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:privatedns/txtRecord:TxtRecord", name, state, makeResourceOptions(options, id), false);
    }
