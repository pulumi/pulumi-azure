...
public final class HadoopClusterMonitorArgs extends com.pulumi.resources.ResourceArgs {

    public static final HadoopClusterMonitorArgs Empty = new HadoopClusterMonitorArgs();
    ...
    private HadoopClusterMonitorArgs() {}

    private HadoopClusterMonitorArgs(HadoopClusterMonitorArgs $) {
    ...
    public static Builder builder(HadoopClusterMonitorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HadoopClusterMonitorArgs();
        }

        public Builder(HadoopClusterMonitorArgs defaults) {
            $ = new HadoopClusterMonitorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HadoopClusterMonitorArgs build() {
            if ($.logAnalyticsWorkspaceId == null) {
                throw new MissingRequiredPropertyException("HadoopClusterMonitorArgs", "logAnalyticsWorkspaceId");
            }
            if ($.primaryKey == null) {
                throw new MissingRequiredPropertyException("HadoopClusterMonitorArgs", "primaryKey");
            }
            return $;
        }
    }
