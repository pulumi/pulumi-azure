...
@CustomType
public final class FrontdoorRuleConditionsQueryStringCondition {
    /**
     * @return One or more string or integer values(e.g. &#34;1&#34;) representing the value of the query string to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
     * 
     */
    ...
    private FrontdoorRuleConditionsQueryStringCondition() {}
    /**
     * @return One or more string or integer values(e.g. &#34;1&#34;) representing the value of the query string to match. If multiple values are specified, they&#39;re evaluated using `OR` logic.
     * 
     */
    ...
    public static Builder builder(FrontdoorRuleConditionsQueryStringCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> transforms;
        public Builder() {}
        public Builder(FrontdoorRuleConditionsQueryStringCondition defaults) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleConditionsQueryStringCondition", "operator");
            }
        ...
        public FrontdoorRuleConditionsQueryStringCondition build() {
            final var _resultValue = new FrontdoorRuleConditionsQueryStringCondition();
