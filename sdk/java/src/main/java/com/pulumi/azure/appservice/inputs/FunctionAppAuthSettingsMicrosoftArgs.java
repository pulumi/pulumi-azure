...
public final class FunctionAppAuthSettingsMicrosoftArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppAuthSettingsMicrosoftArgs Empty = new FunctionAppAuthSettingsMicrosoftArgs();
    ...
    private FunctionAppAuthSettingsMicrosoftArgs() {}

    private FunctionAppAuthSettingsMicrosoftArgs(FunctionAppAuthSettingsMicrosoftArgs $) {
    ...
    public static Builder builder(FunctionAppAuthSettingsMicrosoftArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppAuthSettingsMicrosoftArgs();
        }

        public Builder(FunctionAppAuthSettingsMicrosoftArgs defaults) {
            $ = new FunctionAppAuthSettingsMicrosoftArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionAppAuthSettingsMicrosoftArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("FunctionAppAuthSettingsMicrosoftArgs", "clientId");
            }
            if ($.clientSecret == null) {
                throw new MissingRequiredPropertyException("FunctionAppAuthSettingsMicrosoftArgs", "clientSecret");
            }
            return $;
        }
    }
