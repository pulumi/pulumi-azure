...
public final class PartnerNamespaceState extends com.pulumi.resources.ResourceArgs {

    public static final PartnerNamespaceState Empty = new PartnerNamespaceState();
    ...
    private PartnerNamespaceState() {}

    private PartnerNamespaceState(PartnerNamespaceState $) {
    ...
    public static Builder builder(PartnerNamespaceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PartnerNamespaceState();
        }

        public Builder(PartnerNamespaceState defaults) {
            $ = new PartnerNamespaceState(Objects.requireNonNull(defaults));
        }

        /**
         * @param endpoint The endpoint for the Event Grid Partner Namespace.
         * 
         * @return builder
         * 
         */
        ...
        public PartnerNamespaceState build() {
            return $;
        }
    }
