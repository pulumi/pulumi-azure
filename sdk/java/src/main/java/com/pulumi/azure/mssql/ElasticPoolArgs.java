...
public final class ElasticPoolArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="perDatabaseSettings", required=true)
    private Output<ElasticPoolPerDatabaseSettingsArgs> perDatabaseSettings;
    ...
    private Output<ElasticPoolSkuArgs> sku;

    /**
     * @return A `sku` block as defined below.
     * 
     */
    public Output<ElasticPoolSkuArgs> sku() {
        return this.sku;
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param enclaveType Specifies the type of enclave to be used by the elastic pool. When `enclave_type` is not specified (e.g., the default) enclaves are not enabled on the elastic pool. &lt;!-- TODO: Uncomment in 4.0: Once enabled (e.g., by specifying `Default` or `VBS`) removing the `enclave_type` field from the configuration file will force the creation of a new resource.-&gt; Possible values are `Default` or `VBS`.
         * 
         * &gt; **NOTE:** All databases that are added to the elastic pool must have the same `enclave_type` as the elastic pool.
         * 
         * &gt; **NOTE:** `enclave_type` is not supported for DC-series SKUs.
         ...
         * 
         */
        public Builder perDatabaseSettings(Output<ElasticPoolPerDatabaseSettingsArgs> perDatabaseSettings) {
         ...
         * 
         */
        public Builder sku(Output<ElasticPoolSkuArgs> sku) {
            $.sku = sku;
            return this;
        }
