...
@CustomType
public final class GetApplicationGatewaySslPolicy {
    /**
    ...
    private GetApplicationGatewaySslPolicy() {}
    /**
     * @return A List of accepted cipher suites.
     * 
     */
    ...
    public static Builder builder(GetApplicationGatewaySslPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private String policyType;
        public Builder() {}
        public Builder(GetApplicationGatewaySslPolicy defaults) {
        ...
        public GetApplicationGatewaySslPolicy build() {
            final var _resultValue = new GetApplicationGatewaySslPolicy();
