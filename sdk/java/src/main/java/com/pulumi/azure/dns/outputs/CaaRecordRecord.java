...
public final class CaaRecordRecord {
    ...
    public static final class Builder {
        ...
        public Builder flags(Integer flags) {
            if (flags == null) {
              throw new MissingRequiredPropertyException("CaaRecordRecord", "flags");
            }
            this.flags = flags;
            return this;
        }
        ...
        public Builder tag(String tag) {
            if (tag == null) {
              throw new MissingRequiredPropertyException("CaaRecordRecord", "tag");
            }
            this.tag = tag;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("CaaRecordRecord", "value");
            }
            this.value = value;
            return this;
        }
