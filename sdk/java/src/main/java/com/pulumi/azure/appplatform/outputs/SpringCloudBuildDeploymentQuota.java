...
@CustomType
public final class SpringCloudBuildDeploymentQuota {
    /**
    ...
    public static Builder builder(SpringCloudBuildDeploymentQuota defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String memory;
        public Builder() {}
        public Builder(SpringCloudBuildDeploymentQuota defaults) {
        ...
        public SpringCloudBuildDeploymentQuota build() {
            final var _resultValue = new SpringCloudBuildDeploymentQuota();
