...
public class TimeSeriesInsightsReferenceDataSet extends com.pulumi.resources.CustomResource {
     ...
     */
    public TimeSeriesInsightsReferenceDataSet(java.lang.String name) {
     ...
     */
    public TimeSeriesInsightsReferenceDataSet(java.lang.String name, TimeSeriesInsightsReferenceDataSetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TimeSeriesInsightsReferenceDataSet(java.lang.String name, TimeSeriesInsightsReferenceDataSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/timeSeriesInsightsReferenceDataSet:TimeSeriesInsightsReferenceDataSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TimeSeriesInsightsReferenceDataSet(java.lang.String name, Output<java.lang.String> id, @Nullable TimeSeriesInsightsReferenceDataSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/timeSeriesInsightsReferenceDataSet:TimeSeriesInsightsReferenceDataSet", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TimeSeriesInsightsReferenceDataSet get(java.lang.String name, Output<java.lang.String> id, @Nullable TimeSeriesInsightsReferenceDataSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
