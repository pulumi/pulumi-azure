...
public final class JobStepState extends com.pulumi.resources.ResourceArgs {

    public static final JobStepState Empty = new JobStepState();
    ...
    /**
     * @return The ID of the Elastic Job Credential to use when executing this Elastic Job Step.
     * 
     */
     ...
     * 
     */
    @Import(name="jobStepIndex")
    private @Nullable Output<Integer> jobStepIndex;
     ...
     * 
     */
    public Optional<Output<Integer>> jobStepIndex() {
        return Optional.ofNullable(this.jobStepIndex);
    }
     ...
     * 
     */
    @Import(name="jobTargetGroupId")
    private @Nullable Output<String> jobTargetGroupId;

    /**
     * @return The ID of the Elastic Job Target Group.
     * 
     */
    public Optional<Output<String>> jobTargetGroupId() {
        return Optional.ofNullable(this.jobTargetGroupId);
    }
    ...
    public static Builder builder(JobStepState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JobStepState defaults) {
            $ = new JobStepState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param jobCredentialId The ID of the Elastic Job Credential to use when executing this Elastic Job Step.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder jobStepIndex(@Nullable Output<Integer> jobStepIndex) {
         ...
         * 
         */
        public Builder jobTargetGroupId(@Nullable Output<String> jobTargetGroupId) {
