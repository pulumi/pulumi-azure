...
public final class ProfileMonitorConfig {
     ...
     * 
     */
    private final @Nullable List<ProfileMonitorConfigCustomHeader> customHeaders;
    /**
    ...
    private ProfileMonitorConfig(
        @CustomType.Parameter("customHeaders") @Nullable List<ProfileMonitorConfigCustomHeader> customHeaders,
    ...
    public static final class Builder {
        ...
        public Builder toleratedNumberOfFailures(@Nullable Integer toleratedNumberOfFailures) {
            ...
            return new ProfileMonitorConfig(customHeaders, expectedStatusCodeRanges, intervalInSeconds, path, port, protocol, timeoutInSeconds, toleratedNumberOfFailures);
        }
    }
}
