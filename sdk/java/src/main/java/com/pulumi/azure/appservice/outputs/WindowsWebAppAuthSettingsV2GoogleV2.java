...
public final class WindowsWebAppAuthSettingsV2GoogleV2 {
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2GoogleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsWebAppAuthSettingsV2GoogleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2GoogleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2GoogleV2", "clientSecretSettingName");
            }
        ...
        public WindowsWebAppAuthSettingsV2GoogleV2 build() {
            final var _resultValue = new WindowsWebAppAuthSettingsV2GoogleV2();
