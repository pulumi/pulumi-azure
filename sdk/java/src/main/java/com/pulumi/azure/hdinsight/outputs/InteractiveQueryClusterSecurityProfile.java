...
@CustomType
public final class InteractiveQueryClusterSecurityProfile {
    /**
    ...
    public static Builder builder(InteractiveQueryClusterSecurityProfile defaults) {
    ...
    public static final class Builder {
        ...
        private String msiResourceId;
        public Builder() {}
        public Builder(InteractiveQueryClusterSecurityProfile defaults) {
        ...
        public Builder aaddsResourceId(String aaddsResourceId) {
            if (aaddsResourceId == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterSecurityProfile", "aaddsResourceId");
            }
        ...
        public Builder domainName(String domainName) {
            if (domainName == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterSecurityProfile", "domainName");
            }
        ...
        public Builder domainUserPassword(String domainUserPassword) {
            if (domainUserPassword == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterSecurityProfile", "domainUserPassword");
            }
        ...
        public Builder domainUsername(String domainUsername) {
            if (domainUsername == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterSecurityProfile", "domainUsername");
            }
        ...
        public Builder ldapsUrls(List<String> ldapsUrls) {
            if (ldapsUrls == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterSecurityProfile", "ldapsUrls");
            }
        ...
        public Builder msiResourceId(String msiResourceId) {
            if (msiResourceId == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterSecurityProfile", "msiResourceId");
            }
            this.msiResourceId = msiResourceId;
            return this;
        }
        public InteractiveQueryClusterSecurityProfile build() {
            final var _resultValue = new InteractiveQueryClusterSecurityProfile();
