...
public final class FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("FirewallPolicyRuleCollectionGroupApplicationRuleCollectionRuleHttpHeader", "value");
            }
            this.value = value;
            return this;
        }
