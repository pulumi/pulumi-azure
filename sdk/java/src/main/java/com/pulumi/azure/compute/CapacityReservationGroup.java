...
public class CapacityReservationGroup extends com.pulumi.resources.CustomResource {
    ...
    public CapacityReservationGroup(java.lang.String name, CapacityReservationGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:compute/capacityReservationGroup:CapacityReservationGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CapacityReservationGroup(java.lang.String name, Output<java.lang.String> id, @Nullable CapacityReservationGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:compute/capacityReservationGroup:CapacityReservationGroup", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CapacityReservationGroup get(java.lang.String name, Output<java.lang.String> id, @Nullable CapacityReservationGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
