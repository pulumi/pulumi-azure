...
public final class VirtualMachineRestorePointCollectionState extends com.pulumi.resources.ResourceArgs {

    public static final VirtualMachineRestorePointCollectionState Empty = new VirtualMachineRestorePointCollectionState();
    ...
    private VirtualMachineRestorePointCollectionState() {}

    private VirtualMachineRestorePointCollectionState(VirtualMachineRestorePointCollectionState $) {
    ...
    public static Builder builder(VirtualMachineRestorePointCollectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualMachineRestorePointCollectionState();
        }

        public Builder(VirtualMachineRestorePointCollectionState defaults) {
            $ = new VirtualMachineRestorePointCollectionState(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualMachineRestorePointCollectionState build() {
            return $;
        }
    }
