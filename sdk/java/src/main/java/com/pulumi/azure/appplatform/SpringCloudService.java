...
public class SpringCloudService extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="containerRegistries", type=List.class, parameters={SpringCloudServiceContainerRegistry.class})
     ...
     * 
     */
    @Export(name="defaultBuildService", type=SpringCloudServiceDefaultBuildService.class, parameters={})
     ...
     * 
     */
    @Export(name="marketplace", type=SpringCloudServiceMarketplace.class, parameters={})
