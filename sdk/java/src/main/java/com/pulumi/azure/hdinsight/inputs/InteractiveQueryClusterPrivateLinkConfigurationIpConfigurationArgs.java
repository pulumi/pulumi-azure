...
public final class InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs Empty = new InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs();
    ...
    private InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs() {}

    private InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs(InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs();
        }

        public Builder(InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs defaults) {
            $ = new InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterPrivateLinkConfigurationIpConfigurationArgs", "name");
            }
            return $;
        }
    }
