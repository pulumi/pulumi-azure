...
@CustomType
public final class KafkaClusterComputeIsolation {
    /**
    ...
    public static Builder builder(KafkaClusterComputeIsolation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String hostSku;
        public Builder() {}
        public Builder(KafkaClusterComputeIsolation defaults) {
