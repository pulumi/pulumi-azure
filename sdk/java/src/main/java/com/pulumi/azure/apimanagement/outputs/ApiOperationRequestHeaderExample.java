...
@CustomType
public final class ApiOperationRequestHeaderExample {
    /**
    ...
    private ApiOperationRequestHeaderExample() {}
    /**
     * @return A long description for this example.
     * 
     */
    ...
    public static Builder builder(ApiOperationRequestHeaderExample defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(ApiOperationRequestHeaderExample defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ApiOperationRequestHeaderExample", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public ApiOperationRequestHeaderExample build() {
            final var _resultValue = new ApiOperationRequestHeaderExample();
