...
public final class LogzSubAccountUser {
    ...
    public static final class Builder {
        ...
        public Builder email(String email) {
            if (email == null) {
              throw new MissingRequiredPropertyException("LogzSubAccountUser", "email");
            }
            this.email = email;
            return this;
        }
        ...
        public Builder firstName(String firstName) {
            if (firstName == null) {
              throw new MissingRequiredPropertyException("LogzSubAccountUser", "firstName");
            }
        ...
        public Builder lastName(String lastName) {
            if (lastName == null) {
              throw new MissingRequiredPropertyException("LogzSubAccountUser", "lastName");
            }
        ...
        public Builder phoneNumber(String phoneNumber) {
            if (phoneNumber == null) {
              throw new MissingRequiredPropertyException("LogzSubAccountUser", "phoneNumber");
            }
