...
public final class ApiOperationTemplateParameterExampleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiOperationTemplateParameterExampleArgs Empty = new ApiOperationTemplateParameterExampleArgs();
    ...
    private ApiOperationTemplateParameterExampleArgs() {}

    private ApiOperationTemplateParameterExampleArgs(ApiOperationTemplateParameterExampleArgs $) {
    ...
    public static Builder builder(ApiOperationTemplateParameterExampleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiOperationTemplateParameterExampleArgs();
        }

        public Builder(ApiOperationTemplateParameterExampleArgs defaults) {
            $ = new ApiOperationTemplateParameterExampleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiOperationTemplateParameterExampleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationTemplateParameterExampleArgs", "name");
            }
            return $;
        }
    }
