...
import com.pulumi.azure.appservice.outputs.WindowsWebAppSlotSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class WindowsWebAppSlotSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable WindowsWebAppSlotSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private WindowsWebAppSlotSiteConfigIpRestriction(
        @CustomType.Parameter("action") @Nullable String action,
        @CustomType.Parameter("headers") @Nullable WindowsWebAppSlotSiteConfigIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<WindowsWebAppSlotSiteConfigIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(WindowsWebAppSlotSiteConfigIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable WindowsWebAppSlotSiteConfigIpRestrictionHeaders headers;
        ...
        public Builder(WindowsWebAppSlotSiteConfigIpRestriction defaults) {
        ...
        public Builder headers(@Nullable WindowsWebAppSlotSiteConfigIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public WindowsWebAppSlotSiteConfigIpRestriction build() {
            return new WindowsWebAppSlotSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
