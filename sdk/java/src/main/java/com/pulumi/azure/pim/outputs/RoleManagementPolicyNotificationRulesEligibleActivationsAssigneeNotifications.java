...
@CustomType
public final class RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications {
    /**
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications build() {
            final var _resultValue = new RoleManagementPolicyNotificationRulesEligibleActivationsAssigneeNotifications();
