...
public final class LinuxWebAppAuthSettingsV2CustomOidcV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsV2CustomOidcV2Args Empty = new LinuxWebAppAuthSettingsV2CustomOidcV2Args();
    ...
    private LinuxWebAppAuthSettingsV2CustomOidcV2Args() {}

    private LinuxWebAppAuthSettingsV2CustomOidcV2Args(LinuxWebAppAuthSettingsV2CustomOidcV2Args $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2CustomOidcV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsV2CustomOidcV2Args();
        }

        public Builder(LinuxWebAppAuthSettingsV2CustomOidcV2Args defaults) {
            $ = new LinuxWebAppAuthSettingsV2CustomOidcV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsV2CustomOidcV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2CustomOidcV2Args", "clientId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2CustomOidcV2Args", "name");
            }
            if ($.openidConfigurationEndpoint == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2CustomOidcV2Args", "openidConfigurationEndpoint");
            }
            return $;
        }
    }
