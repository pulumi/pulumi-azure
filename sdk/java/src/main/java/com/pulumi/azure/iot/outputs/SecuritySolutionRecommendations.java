...
@CustomType
public final class SecuritySolutionRecommendations {
    /**
    ...
    public static Builder builder(SecuritySolutionRecommendations defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean vulnerableTlsCipherSuite;
        public Builder() {}
        public Builder(SecuritySolutionRecommendations defaults) {
        ...
        public SecuritySolutionRecommendations build() {
            final var _resultValue = new SecuritySolutionRecommendations();
