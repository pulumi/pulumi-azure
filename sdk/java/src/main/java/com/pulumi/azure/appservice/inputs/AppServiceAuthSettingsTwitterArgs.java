...
public final class AppServiceAuthSettingsTwitterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AppServiceAuthSettingsTwitterArgs() {}

    private AppServiceAuthSettingsTwitterArgs(AppServiceAuthSettingsTwitterArgs $) {
    ...
    public static Builder builder(AppServiceAuthSettingsTwitterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppServiceAuthSettingsTwitterArgs();
        }

        public Builder(AppServiceAuthSettingsTwitterArgs defaults) {
        ...
        public AppServiceAuthSettingsTwitterArgs build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("AppServiceAuthSettingsTwitterArgs", "consumerKey");
            }
            if ($.consumerSecret == null) {
                throw new MissingRequiredPropertyException("AppServiceAuthSettingsTwitterArgs", "consumerSecret");
            }
            return $;
        }
    }
