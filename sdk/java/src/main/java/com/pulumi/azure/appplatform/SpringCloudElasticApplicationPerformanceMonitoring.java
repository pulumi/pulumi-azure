...
public class SpringCloudElasticApplicationPerformanceMonitoring extends com.pulumi.resources.CustomResource {
     ...
     */
    public SpringCloudElasticApplicationPerformanceMonitoring(String name) {
     ...
     */
    public static SpringCloudElasticApplicationPerformanceMonitoring get(String name, Output<String> id, @Nullable SpringCloudElasticApplicationPerformanceMonitoringState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
