...
public class NetworkManagerSecurityAdminConfiguration extends com.pulumi.resources.CustomResource {
    ...
    public NetworkManagerSecurityAdminConfiguration(String name, NetworkManagerSecurityAdminConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:network/networkManagerSecurityAdminConfiguration:NetworkManagerSecurityAdminConfiguration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
