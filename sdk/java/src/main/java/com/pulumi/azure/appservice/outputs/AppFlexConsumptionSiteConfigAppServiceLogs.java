...
@CustomType
public final class AppFlexConsumptionSiteConfigAppServiceLogs {
    /**
    ...
    private AppFlexConsumptionSiteConfigAppServiceLogs() {}
    /**
     * @return The amount of disk space to use for logs. Valid values are between `25` and `100`. Defaults to `35`.
     * 
     */
    ...
    public static Builder builder(AppFlexConsumptionSiteConfigAppServiceLogs defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer retentionPeriodDays;
        public Builder() {}
        public Builder(AppFlexConsumptionSiteConfigAppServiceLogs defaults) {
        ...
        public AppFlexConsumptionSiteConfigAppServiceLogs build() {
            final var _resultValue = new AppFlexConsumptionSiteConfigAppServiceLogs();
