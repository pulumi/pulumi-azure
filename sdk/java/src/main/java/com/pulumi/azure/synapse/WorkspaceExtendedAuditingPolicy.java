...
public class WorkspaceExtendedAuditingPolicy extends com.pulumi.resources.CustomResource {
    ...
    public WorkspaceExtendedAuditingPolicy(String name, WorkspaceExtendedAuditingPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:synapse/workspaceExtendedAuditingPolicy:WorkspaceExtendedAuditingPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
