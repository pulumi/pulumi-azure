...
public final class LinuxWebAppSlotSiteConfigApplicationStack {
    ...
    public static final class Builder {
        ...
        public Builder rubyVersion(@Nullable String rubyVersion) {
            ...
            return new LinuxWebAppSlotSiteConfigApplicationStack(dockerImage, dockerImageTag, dotnetVersion, javaServer, javaServerVersion, javaVersion, nodeVersion, phpVersion, pythonVersion, rubyVersion);
        }
    }
}
