...
public final class VaultIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(VaultIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public VaultIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("VaultIdentityArgs", "type");
            }
            return $;
        }
    }
