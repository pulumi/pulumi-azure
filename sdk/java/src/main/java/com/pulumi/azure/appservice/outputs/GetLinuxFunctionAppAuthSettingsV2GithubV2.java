...
@CustomType
public final class GetLinuxFunctionAppAuthSettingsV2GithubV2 {
    /**
    ...
    private GetLinuxFunctionAppAuthSettingsV2GithubV2() {}
    /**
     * @return The OAuth 2.0 client ID that was created for the app used for authentication.
     * 
     */
    ...
    public static Builder builder(GetLinuxFunctionAppAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> loginScopes;
        public Builder() {}
        public Builder(GetLinuxFunctionAppAuthSettingsV2GithubV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2GithubV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2GithubV2", "clientSecretSettingName");
            }
        ...
        public Builder loginScopes(List<String> loginScopes) {
            if (loginScopes == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2GithubV2", "loginScopes");
            }
        ...
        public GetLinuxFunctionAppAuthSettingsV2GithubV2 build() {
            final var _resultValue = new GetLinuxFunctionAppAuthSettingsV2GithubV2();
