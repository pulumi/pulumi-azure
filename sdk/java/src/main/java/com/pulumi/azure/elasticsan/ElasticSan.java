...
public class ElasticSan extends com.pulumi.resources.CustomResource {
    ...
    public ElasticSan(String name, ElasticSanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:elasticsan/elasticSan:ElasticSan", name, args == null ? ElasticSanArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private ElasticSan(String name, Output<String> id, @Nullable ElasticSanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:elasticsan/elasticSan:ElasticSan", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ElasticSan get(String name, Output<String> id, @Nullable ElasticSanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
