...
public final class TransformOutputCustomPresetFilterCropRectangleArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransformOutputCustomPresetFilterCropRectangleArgs Empty = new TransformOutputCustomPresetFilterCropRectangleArgs();
    ...
    private TransformOutputCustomPresetFilterCropRectangleArgs() {}

    private TransformOutputCustomPresetFilterCropRectangleArgs(TransformOutputCustomPresetFilterCropRectangleArgs $) {
        this.height = $.height;
        this.left = $.left;
        this.top = $.top;
        this.width = $.width;
    ...
    public static Builder builder(TransformOutputCustomPresetFilterCropRectangleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransformOutputCustomPresetFilterCropRectangleArgs();
        }

        public Builder(TransformOutputCustomPresetFilterCropRectangleArgs defaults) {
            $ = new TransformOutputCustomPresetFilterCropRectangleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransformOutputCustomPresetFilterCropRectangleArgs build() {
            return $;
        }
    }
