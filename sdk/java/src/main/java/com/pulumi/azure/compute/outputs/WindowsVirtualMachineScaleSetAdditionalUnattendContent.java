...
@CustomType
public final class WindowsVirtualMachineScaleSetAdditionalUnattendContent {
    /**
    ...
    public static final class Builder {
        ...
        public Builder content(String content) {
            if (content == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetAdditionalUnattendContent", "content");
            }
        ...
        public Builder setting(String setting) {
            if (setting == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetAdditionalUnattendContent", "setting");
            }
