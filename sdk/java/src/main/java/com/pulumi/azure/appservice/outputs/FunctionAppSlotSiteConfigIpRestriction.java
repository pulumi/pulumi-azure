...
import com.pulumi.azure.appservice.outputs.FunctionAppSlotSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class FunctionAppSlotSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable FunctionAppSlotSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private FunctionAppSlotSiteConfigIpRestriction(
        @CustomType.Parameter("action") @Nullable String action,
        @CustomType.Parameter("headers") @Nullable FunctionAppSlotSiteConfigIpRestrictionHeaders headers,
    ...
    public static Builder builder(FunctionAppSlotSiteConfigIpRestriction defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FunctionAppSlotSiteConfigIpRestriction defaults) {
        ...
        public Builder headers(@Nullable FunctionAppSlotSiteConfigIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public FunctionAppSlotSiteConfigIpRestriction build() {
            return new FunctionAppSlotSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
