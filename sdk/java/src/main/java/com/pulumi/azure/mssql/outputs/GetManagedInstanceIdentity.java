...
public final class GetManagedInstanceIdentity {
    ...
    public static final class Builder {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceIdentity", "identityIds");
            }
        ...
        public Builder principalId(String principalId) {
            if (principalId == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceIdentity", "principalId");
            }
        ...
        public Builder tenantId(String tenantId) {
            if (tenantId == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceIdentity", "tenantId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public GetManagedInstanceIdentity build() {
            final var _resultValue = new GetManagedInstanceIdentity();
