...
@CustomType
public final class FunctionAppSiteConfigCors {
    /**
    ...
    public static Builder builder(FunctionAppSiteConfigCors defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean supportCredentials;
        public Builder() {}
        public Builder(FunctionAppSiteConfigCors defaults) {
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("FunctionAppSiteConfigCors", "allowedOrigins");
            }
