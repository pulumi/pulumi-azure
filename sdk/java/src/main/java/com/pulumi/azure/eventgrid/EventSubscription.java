...
public class EventSubscription extends com.pulumi.resources.CustomResource {
    ...
    public EventSubscription(java.lang.String name, EventSubscriptionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:eventgrid/eventSubscription:EventSubscription", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private EventSubscription(java.lang.String name, Output<java.lang.String> id, @Nullable EventSubscriptionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:eventgrid/eventSubscription:EventSubscription", name, state, makeResourceOptions(options, id), false);
    }
