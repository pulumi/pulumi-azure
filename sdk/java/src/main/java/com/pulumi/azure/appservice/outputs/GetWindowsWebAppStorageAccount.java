...
public final class GetWindowsWebAppStorageAccount {
    ...
    public static final class Builder {
        ...
        public Builder accessKey(String accessKey) {
            if (accessKey == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStorageAccount", "accessKey");
            }
        ...
        public Builder accountName(String accountName) {
            if (accountName == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStorageAccount", "accountName");
            }
        ...
        public Builder mountPath(String mountPath) {
            if (mountPath == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStorageAccount", "mountPath");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStorageAccount", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder shareName(String shareName) {
            if (shareName == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStorageAccount", "shareName");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppStorageAccount", "type");
            }
            this.type = type;
            return this;
        }
