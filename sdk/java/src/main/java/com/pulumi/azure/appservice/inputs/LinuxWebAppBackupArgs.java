...
public final class LinuxWebAppBackupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<LinuxWebAppBackupScheduleArgs> schedule;

    /**
     * @return A `schedule` block as defined below.
     * 
     */
    public Output<LinuxWebAppBackupScheduleArgs> schedule() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder schedule(Output<LinuxWebAppBackupScheduleArgs> schedule) {
            $.schedule = schedule;
            return this;
        }
