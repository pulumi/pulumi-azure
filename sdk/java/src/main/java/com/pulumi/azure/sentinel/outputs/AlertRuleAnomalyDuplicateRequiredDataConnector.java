...
@CustomType
public final class AlertRuleAnomalyDuplicateRequiredDataConnector {
    /**
    ...
    private AlertRuleAnomalyDuplicateRequiredDataConnector() {}
    /**
     * @return The ID of the required Data Connector.
     * 
     */
    ...
    public static Builder builder(AlertRuleAnomalyDuplicateRequiredDataConnector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> dataTypes;
        public Builder() {}
        public Builder(AlertRuleAnomalyDuplicateRequiredDataConnector defaults) {
