...
public final class ManangementLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManangementLockArgs Empty = new ManangementLockArgs();
    ...
    private ManangementLockArgs() {}

    private ManangementLockArgs(ManangementLockArgs $) {
    ...
    public static Builder builder(ManangementLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManangementLockArgs();
        }

        public Builder(ManangementLockArgs defaults) {
            $ = new ManangementLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ManangementLockArgs build() {
            if ($.lockLevel == null) {
                throw new MissingRequiredPropertyException("ManangementLockArgs", "lockLevel");
            }
            if ($.scope == null) {
                throw new MissingRequiredPropertyException("ManangementLockArgs", "scope");
            }
            return $;
        }
    }
