    ...
    public static final class Builder {
        ...
        public Builder allowedExternalRedirectUrls(List<String> allowedExternalRedirectUrls) {
            if (allowedExternalRedirectUrls == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "allowedExternalRedirectUrls");
            }
        ...
        public Builder cookieExpirationConvention(String cookieExpirationConvention) {
            if (cookieExpirationConvention == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "cookieExpirationConvention");
            }
        ...
        public Builder cookieExpirationTime(String cookieExpirationTime) {
            if (cookieExpirationTime == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "cookieExpirationTime");
            }
        ...
        public Builder logoutEndpoint(String logoutEndpoint) {
            if (logoutEndpoint == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "logoutEndpoint");
            }
        ...
        public Builder nonceExpirationTime(String nonceExpirationTime) {
            if (nonceExpirationTime == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "nonceExpirationTime");
            }
        ...
        public Builder preserveUrlFragmentsForLogins(Boolean preserveUrlFragmentsForLogins) {
            if (preserveUrlFragmentsForLogins == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "preserveUrlFragmentsForLogins");
            }
        ...
        public Builder tokenRefreshExtensionTime(Double tokenRefreshExtensionTime) {
            if (tokenRefreshExtensionTime == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "tokenRefreshExtensionTime");
            }
        ...
        public Builder tokenStoreEnabled(Boolean tokenStoreEnabled) {
            if (tokenStoreEnabled == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "tokenStoreEnabled");
            }
        ...
        public Builder tokenStorePath(String tokenStorePath) {
            if (tokenStorePath == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "tokenStorePath");
            }
        ...
        public Builder tokenStoreSasSettingName(String tokenStoreSasSettingName) {
            if (tokenStoreSasSettingName == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "tokenStoreSasSettingName");
            }
        ...
        public Builder validateNonce(Boolean validateNonce) {
            if (validateNonce == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppAuthSettingsV2Login", "validateNonce");
            }
