    ...
    public static final class Builder {
        ...
        public KafkaClusterStorageAccountGen2Args build() {
            ...
            if ($.storageAccountId == null) {
                throw new MissingRequiredPropertyException("KafkaClusterStorageAccountGen2Args", "storageAccountId");
            }
            if ($.userAssignedIdentityId == null) {
                throw new MissingRequiredPropertyException("KafkaClusterStorageAccountGen2Args", "userAssignedIdentityId");
            }
            return $;
        }
    }
