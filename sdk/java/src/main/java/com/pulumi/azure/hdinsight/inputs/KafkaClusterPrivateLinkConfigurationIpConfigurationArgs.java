...
public final class KafkaClusterPrivateLinkConfigurationIpConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final KafkaClusterPrivateLinkConfigurationIpConfigurationArgs Empty = new KafkaClusterPrivateLinkConfigurationIpConfigurationArgs();
    ...
    private KafkaClusterPrivateLinkConfigurationIpConfigurationArgs() {}

    private KafkaClusterPrivateLinkConfigurationIpConfigurationArgs(KafkaClusterPrivateLinkConfigurationIpConfigurationArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(KafkaClusterPrivateLinkConfigurationIpConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KafkaClusterPrivateLinkConfigurationIpConfigurationArgs();
        }

        public Builder(KafkaClusterPrivateLinkConfigurationIpConfigurationArgs defaults) {
            $ = new KafkaClusterPrivateLinkConfigurationIpConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaClusterPrivateLinkConfigurationIpConfigurationArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("KafkaClusterPrivateLinkConfigurationIpConfigurationArgs", "name");
            }
            return $;
        }
    }
