...
@CustomType
public final class VolumeGroupOracleVolumeDataProtectionReplication {
    /**
    ...
    public static Builder builder(VolumeGroupOracleVolumeDataProtectionReplication defaults) {
    ...
    public static final class Builder {
        ...
        private String replicationFrequency;
        public Builder() {}
        public Builder(VolumeGroupOracleVolumeDataProtectionReplication defaults) {
        ...
        public Builder remoteVolumeLocation(String remoteVolumeLocation) {
            if (remoteVolumeLocation == null) {
              throw new MissingRequiredPropertyException("VolumeGroupOracleVolumeDataProtectionReplication", "remoteVolumeLocation");
            }
        ...
        public Builder remoteVolumeResourceId(String remoteVolumeResourceId) {
            if (remoteVolumeResourceId == null) {
              throw new MissingRequiredPropertyException("VolumeGroupOracleVolumeDataProtectionReplication", "remoteVolumeResourceId");
            }
        ...
        public Builder replicationFrequency(String replicationFrequency) {
            if (replicationFrequency == null) {
              throw new MissingRequiredPropertyException("VolumeGroupOracleVolumeDataProtectionReplication", "replicationFrequency");
            }
            this.replicationFrequency = replicationFrequency;
            return this;
        }
        public VolumeGroupOracleVolumeDataProtectionReplication build() {
            final var _resultValue = new VolumeGroupOracleVolumeDataProtectionReplication();
