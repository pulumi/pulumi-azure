...
public final class TxtRecordState extends com.pulumi.resources.ResourceArgs {

    public static final TxtRecordState Empty = new TxtRecordState();
     ...
     */
    @Import(name="records")
    private @Nullable Output<List<TxtRecordRecordArgs>> records;
    ...
    public static Builder builder(TxtRecordState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TxtRecordState defaults) {
            $ = new TxtRecordState(Objects.requireNonNull(defaults));
        }

        /**
         * @param fqdn The FQDN of the DNS TXT Record.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder records(@Nullable Output<List<TxtRecordRecordArgs>> records) {
            $.records = records;
            return this;
        }
         ...
         * 
         */
        public Builder records(List<TxtRecordRecordArgs> records) {
