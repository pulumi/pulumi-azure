...
public final class LinuxVirtualMachineState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<LinuxVirtualMachineGalleryImageReferenceArgs> galleryImageReference;

    /**
     * @return A `gallery_image_reference` block as defined below.
     * 
     */
    public Optional<Output<LinuxVirtualMachineGalleryImageReferenceArgs>> galleryImageReference() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder galleryImageReference(@Nullable Output<LinuxVirtualMachineGalleryImageReferenceArgs> galleryImageReference) {
         ...
         * 
         */
        public Builder galleryImageReference(LinuxVirtualMachineGalleryImageReferenceArgs galleryImageReference) {
         ...
         * 
         */
        public Builder inboundNatRules(@Nullable Output<List<LinuxVirtualMachineInboundNatRuleArgs>> inboundNatRules) {
         ...
         * 
         */
        public Builder inboundNatRules(List<LinuxVirtualMachineInboundNatRuleArgs> inboundNatRules) {
         ...
         * 
         */
        public Builder inboundNatRules(LinuxVirtualMachineInboundNatRuleArgs... inboundNatRules) {
