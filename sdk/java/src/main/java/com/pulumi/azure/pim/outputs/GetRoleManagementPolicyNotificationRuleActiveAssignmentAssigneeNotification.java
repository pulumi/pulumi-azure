...
@CustomType
public final class GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification {
    /**
    ...
    private GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification() {}
    /**
     * @return A list of additional email addresses that will receive these notifications.
     * 
     */
    ...
    public static Builder builder(GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification defaults) {
        ...
        public Builder additionalRecipients(List<String> additionalRecipients) {
            if (additionalRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification", "additionalRecipients");
            }
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification build() {
            final var _resultValue = new GetRoleManagementPolicyNotificationRuleActiveAssignmentAssigneeNotification();
