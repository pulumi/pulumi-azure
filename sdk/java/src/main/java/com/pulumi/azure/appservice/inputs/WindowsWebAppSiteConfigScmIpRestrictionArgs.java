...
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigScmIpRestrictionHeadersArgs;
...
public final class WindowsWebAppSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSiteConfigScmIpRestrictionArgs Empty = new WindowsWebAppSiteConfigScmIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<WindowsWebAppSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<WindowsWebAppSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private WindowsWebAppSiteConfigScmIpRestrictionArgs() {}

    private WindowsWebAppSiteConfigScmIpRestrictionArgs(WindowsWebAppSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(WindowsWebAppSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSiteConfigScmIpRestrictionArgs();
        }

        public Builder(WindowsWebAppSiteConfigScmIpRestrictionArgs defaults) {
            $ = new WindowsWebAppSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<WindowsWebAppSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(WindowsWebAppSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public WindowsWebAppSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
