...
public final class LinuxWebAppSlotAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsV2FacebookV2Args Empty = new LinuxWebAppSlotAuthSettingsV2FacebookV2Args();
    ...
    private LinuxWebAppSlotAuthSettingsV2FacebookV2Args() {}

    private LinuxWebAppSlotAuthSettingsV2FacebookV2Args(LinuxWebAppSlotAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsV2FacebookV2Args();
        }

        public Builder(LinuxWebAppSlotAuthSettingsV2FacebookV2Args defaults) {
            $ = new LinuxWebAppSlotAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
