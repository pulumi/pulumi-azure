...
public class HciLogicalNetwork extends com.pulumi.resources.CustomResource {
     ...
     */
    public HciLogicalNetwork(String name) {
     ...
     */
    public HciLogicalNetwork(String name, HciLogicalNetworkArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:stack/hciLogicalNetwork:HciLogicalNetwork", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private HciLogicalNetwork(String name, Output<String> id, @Nullable HciLogicalNetworkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:stack/hciLogicalNetwork:HciLogicalNetwork", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static HciLogicalNetwork get(String name, Output<String> id, @Nullable HciLogicalNetworkState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
