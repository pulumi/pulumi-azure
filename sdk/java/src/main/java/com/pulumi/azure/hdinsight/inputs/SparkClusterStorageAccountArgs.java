...
public final class SparkClusterStorageAccountArgs extends com.pulumi.resources.ResourceArgs {

    public static final SparkClusterStorageAccountArgs Empty = new SparkClusterStorageAccountArgs();
    ...
    private SparkClusterStorageAccountArgs() {}

    private SparkClusterStorageAccountArgs(SparkClusterStorageAccountArgs $) {
    ...
    public static Builder builder(SparkClusterStorageAccountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SparkClusterStorageAccountArgs();
        }

        public Builder(SparkClusterStorageAccountArgs defaults) {
            $ = new SparkClusterStorageAccountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SparkClusterStorageAccountArgs build() {
            if ($.isDefault == null) {
                throw new MissingRequiredPropertyException("SparkClusterStorageAccountArgs", "isDefault");
            }
            if ($.storageAccountKey == null) {
                throw new MissingRequiredPropertyException("SparkClusterStorageAccountArgs", "storageAccountKey");
            }
            if ($.storageContainerUrl == null) {
                throw new MissingRequiredPropertyException("SparkClusterStorageAccountArgs", "storageContainerUrl");
            }
            return $;
        }
    }
