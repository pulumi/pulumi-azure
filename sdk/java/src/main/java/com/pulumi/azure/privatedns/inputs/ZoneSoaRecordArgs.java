...
public final class ZoneSoaRecordArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param fqdn The fully qualified domain name of the Record Set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param minimumTtl The minimum Time To Live for the SOA record. By convention, it is used to determine the negative caching duration. Defaults to `10`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param serialNumber The serial number for the SOA record.
         * 
         * @return builder
         * 
         */
