...
public final class LiveEventState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="input")
    private @Nullable Output<LiveEventInputArgs> input;

    /**
     * @return A `input` block as defined below.
     * 
     */
    public Optional<Output<LiveEventInputArgs>> input() {
    ...
    private LiveEventState() {}

    private LiveEventState(LiveEventState $) {
    ...
    public static Builder builder(LiveEventState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LiveEventState defaults) {
            $ = new LiveEventState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder input(@Nullable Output<LiveEventInputArgs> input) {
            $.input = input;
            return this;
        }
