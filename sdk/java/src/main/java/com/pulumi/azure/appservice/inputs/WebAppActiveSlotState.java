...
public final class WebAppActiveSlotState extends com.pulumi.resources.ResourceArgs {

    public static final WebAppActiveSlotState Empty = new WebAppActiveSlotState();
    ...
    private WebAppActiveSlotState() {}

    private WebAppActiveSlotState(WebAppActiveSlotState $) {
    ...
    public static Builder builder(WebAppActiveSlotState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAppActiveSlotState();
        }

        public Builder(WebAppActiveSlotState defaults) {
            $ = new WebAppActiveSlotState(Objects.requireNonNull(defaults));
        }
        ...
        public WebAppActiveSlotState build() {
            return $;
        }
    }
