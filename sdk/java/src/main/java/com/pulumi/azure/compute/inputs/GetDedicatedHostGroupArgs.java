...
public final class GetDedicatedHostGroupArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetDedicatedHostGroupArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetDedicatedHostGroupArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetDedicatedHostGroupArgs", "resourceGroupName");
            }
            return $;
        }
    }
