...
import com.pulumi.azure.containerapp.inputs.JobTemplateContainerStartupProbeHeaderArgs;
...
public final class JobTemplateContainerStartupProbeArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobTemplateContainerStartupProbeArgs Empty = new JobTemplateContainerStartupProbeArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<List<JobTemplateContainerStartupProbeHeaderArgs>> headers;

    /**
     * @return A `header` block as detailed below.
     * 
     */
    public Optional<Output<List<JobTemplateContainerStartupProbeHeaderArgs>>> headers() {
    ...
    private JobTemplateContainerStartupProbeArgs() {}

    private JobTemplateContainerStartupProbeArgs(JobTemplateContainerStartupProbeArgs $) {
    ...
    public static Builder builder(JobTemplateContainerStartupProbeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTemplateContainerStartupProbeArgs();
        }

        public Builder(JobTemplateContainerStartupProbeArgs defaults) {
            $ = new JobTemplateContainerStartupProbeArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<List<JobTemplateContainerStartupProbeHeaderArgs>> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(List<JobTemplateContainerStartupProbeHeaderArgs> headers) {
         ...
         * 
         */
        public Builder headers(JobTemplateContainerStartupProbeHeaderArgs... headers) {
        ...
        public JobTemplateContainerStartupProbeArgs build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("JobTemplateContainerStartupProbeArgs", "port");
            }
            if ($.transport == null) {
                throw new MissingRequiredPropertyException("JobTemplateContainerStartupProbeArgs", "transport");
            }
            return $;
        }
    }
