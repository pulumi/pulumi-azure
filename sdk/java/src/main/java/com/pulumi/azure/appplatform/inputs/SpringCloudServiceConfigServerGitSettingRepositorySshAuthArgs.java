...
public final class SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs Empty = new SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs();
    ...
    private SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs() {}

    private SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs(SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs $) {
    ...
    public static Builder builder(SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs();
        }

        public Builder(SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs defaults) {
            $ = new SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs build() {
            if ($.privateKey == null) {
                throw new MissingRequiredPropertyException("SpringCloudServiceConfigServerGitSettingRepositorySshAuthArgs", "privateKey");
            }
            return $;
        }
    }
