...
public final class FunctionAppAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public FunctionAppAuthSettingsFacebookArgs build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("FunctionAppAuthSettingsFacebookArgs", "appId");
            }
            if ($.appSecret == null) {
                throw new MissingRequiredPropertyException("FunctionAppAuthSettingsFacebookArgs", "appSecret");
            }
            return $;
        }
    }
