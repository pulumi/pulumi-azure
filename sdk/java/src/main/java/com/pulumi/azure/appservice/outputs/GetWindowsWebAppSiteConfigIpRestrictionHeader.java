...
@CustomType
public final class GetWindowsWebAppSiteConfigIpRestrictionHeader {
    /**
    ...
    private GetWindowsWebAppSiteConfigIpRestrictionHeader() {}
    /**
     * @return The list of Azure Front Door IDs.
     * 
     */
    ...
    public static Builder builder(GetWindowsWebAppSiteConfigIpRestrictionHeader defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> xForwardedHosts;
        public Builder() {}
        public Builder(GetWindowsWebAppSiteConfigIpRestrictionHeader defaults) {
        ...
        public Builder xAzureFdids(List<String> xAzureFdids) {
            if (xAzureFdids == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigIpRestrictionHeader", "xAzureFdids");
            }
        ...
        public Builder xFdHealthProbes(List<String> xFdHealthProbes) {
            if (xFdHealthProbes == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigIpRestrictionHeader", "xFdHealthProbes");
            }
        ...
        public Builder xForwardedFors(List<String> xForwardedFors) {
            if (xForwardedFors == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigIpRestrictionHeader", "xForwardedFors");
            }
        ...
        public Builder xForwardedHosts(List<String> xForwardedHosts) {
            if (xForwardedHosts == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigIpRestrictionHeader", "xForwardedHosts");
            }
        ...
        public GetWindowsWebAppSiteConfigIpRestrictionHeader build() {
            final var _resultValue = new GetWindowsWebAppSiteConfigIpRestrictionHeader();
