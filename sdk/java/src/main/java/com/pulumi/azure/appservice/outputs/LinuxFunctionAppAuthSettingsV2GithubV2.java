...
@CustomType
public final class LinuxFunctionAppAuthSettingsV2GithubV2 {
    /**
    ...
    private LinuxFunctionAppAuthSettingsV2GithubV2() {}
    /**
     * @return The ID of the GitHub app used for login..
     * 
     */
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxFunctionAppAuthSettingsV2GithubV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2GithubV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2GithubV2", "clientSecretSettingName");
            }
        ...
        public LinuxFunctionAppAuthSettingsV2GithubV2 build() {
            final var _resultValue = new LinuxFunctionAppAuthSettingsV2GithubV2();
