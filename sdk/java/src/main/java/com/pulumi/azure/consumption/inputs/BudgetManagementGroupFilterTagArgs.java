...
public final class BudgetManagementGroupFilterTagArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public BudgetManagementGroupFilterTagArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("BudgetManagementGroupFilterTagArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetManagementGroupFilterTagArgs", "values");
            }
            return $;
        }
    }
