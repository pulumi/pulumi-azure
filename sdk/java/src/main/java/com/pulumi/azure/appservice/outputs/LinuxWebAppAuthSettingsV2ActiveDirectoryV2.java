...
@CustomType
public final class LinuxWebAppAuthSettingsV2ActiveDirectoryV2 {
    /**
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2ActiveDirectoryV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean wwwAuthenticationDisabled;
        public Builder() {}
        public Builder(LinuxWebAppAuthSettingsV2ActiveDirectoryV2 defaults) {
        ...
        public LinuxWebAppAuthSettingsV2ActiveDirectoryV2 build() {
            final var _resultValue = new LinuxWebAppAuthSettingsV2ActiveDirectoryV2();
