...
@CustomType
public final class WindowsFunctionAppAuthSettingsV2Login {
    /**
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2Login defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validateNonce;
        public Builder() {}
        public Builder(WindowsFunctionAppAuthSettingsV2Login defaults) {
        ...
        public WindowsFunctionAppAuthSettingsV2Login build() {
            final var _resultValue = new WindowsFunctionAppAuthSettingsV2Login();
