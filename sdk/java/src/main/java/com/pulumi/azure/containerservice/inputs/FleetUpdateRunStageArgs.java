...
public final class FleetUpdateRunStageArgs extends com.pulumi.resources.ResourceArgs {

    public static final FleetUpdateRunStageArgs Empty = new FleetUpdateRunStageArgs();
    ...
    private Output<List<FleetUpdateRunStageGroupArgs>> groups;

    /**
     * @return One or more `group` blocks as defined below.
     * 
     */
    public Output<List<FleetUpdateRunStageGroupArgs>> groups() {
        return this.groups;
    }
    ...
    private FleetUpdateRunStageArgs() {}

    private FleetUpdateRunStageArgs(FleetUpdateRunStageArgs $) {
    ...
    public static Builder builder(FleetUpdateRunStageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FleetUpdateRunStageArgs();
        }

        public Builder(FleetUpdateRunStageArgs defaults) {
            $ = new FleetUpdateRunStageArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder groups(Output<List<FleetUpdateRunStageGroupArgs>> groups) {
            $.groups = groups;
            return this;
        }
         ...
         * 
         */
        public Builder groups(List<FleetUpdateRunStageGroupArgs> groups) {
         ...
         * 
         */
        public Builder groups(FleetUpdateRunStageGroupArgs... groups) {
        ...
        public FleetUpdateRunStageArgs build() {
            if ($.groups == null) {
                throw new MissingRequiredPropertyException("FleetUpdateRunStageArgs", "groups");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("FleetUpdateRunStageArgs", "name");
            }
            return $;
        }
    }
