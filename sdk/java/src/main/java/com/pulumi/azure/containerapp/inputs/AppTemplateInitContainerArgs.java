...
import com.pulumi.azure.containerapp.inputs.AppTemplateInitContainerEnvArgs;
...
public final class AppTemplateInitContainerArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppTemplateInitContainerArgs Empty = new AppTemplateInitContainerArgs();
     ...
     */
    @Import(name="envs")
    private @Nullable Output<List<AppTemplateInitContainerEnvArgs>> envs;

    /**
     * @return One or more `env` blocks as detailed below.
     * 
     */
    public Optional<Output<List<AppTemplateInitContainerEnvArgs>>> envs() {
    ...
    private AppTemplateInitContainerArgs() {}

    private AppTemplateInitContainerArgs(AppTemplateInitContainerArgs $) {
        this.args = $.args;
    ...
    public static Builder builder(AppTemplateInitContainerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppTemplateInitContainerArgs();
        }

        public Builder(AppTemplateInitContainerArgs defaults) {
            $ = new AppTemplateInitContainerArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder envs(@Nullable Output<List<AppTemplateInitContainerEnvArgs>> envs) {
            $.envs = envs;
            return this;
        }
         ...
         * 
         */
        public Builder envs(List<AppTemplateInitContainerEnvArgs> envs) {
         ...
         * 
         */
        public Builder envs(AppTemplateInitContainerEnvArgs... envs) {
         ...
         * 
         */
        public Builder volumeMounts(@Nullable Output<List<AppTemplateInitContainerVolumeMountArgs>> volumeMounts) {
         ...
         * 
         */
        public Builder volumeMounts(List<AppTemplateInitContainerVolumeMountArgs> volumeMounts) {
         ...
         * 
         */
        public Builder volumeMounts(AppTemplateInitContainerVolumeMountArgs... volumeMounts) {
