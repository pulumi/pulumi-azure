...
public final class WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args Empty = new WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args();
    ...
    private WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args() {}

    private WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args(WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args", "consumerKey");
            }
            if ($.consumerSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2TwitterV2Args", "consumerSecretSettingName");
            }
            return $;
        }
    }
