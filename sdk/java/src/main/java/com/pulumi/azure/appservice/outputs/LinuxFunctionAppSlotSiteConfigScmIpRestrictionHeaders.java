...
@CustomType
public final class LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders {
    /**
    ...
    public static Builder builder(LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        }        public LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders build() {
            return new LinuxFunctionAppSlotSiteConfigScmIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
