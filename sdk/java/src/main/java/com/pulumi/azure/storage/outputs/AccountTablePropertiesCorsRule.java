...
@CustomType
public final class AccountTablePropertiesCorsRule {
    /**
    ...
    public static Builder builder(AccountTablePropertiesCorsRule defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maxAgeInSeconds;
        public Builder() {}
        public Builder(AccountTablePropertiesCorsRule defaults) {
        ...
        public Builder allowedHeaders(List<String> allowedHeaders) {
            if (allowedHeaders == null) {
              throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRule", "allowedHeaders");
            }
        ...
        public Builder allowedMethods(List<String> allowedMethods) {
            if (allowedMethods == null) {
              throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRule", "allowedMethods");
            }
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRule", "allowedOrigins");
            }
        ...
        public Builder exposedHeaders(List<String> exposedHeaders) {
            if (exposedHeaders == null) {
              throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRule", "exposedHeaders");
            }
        ...
        public Builder maxAgeInSeconds(Integer maxAgeInSeconds) {
            if (maxAgeInSeconds == null) {
              throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRule", "maxAgeInSeconds");
            }
            this.maxAgeInSeconds = maxAgeInSeconds;
            return this;
        }
        public AccountTablePropertiesCorsRule build() {
            final var _resultValue = new AccountTablePropertiesCorsRule();
