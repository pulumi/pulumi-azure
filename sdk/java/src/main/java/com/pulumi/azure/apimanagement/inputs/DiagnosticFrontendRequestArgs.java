...
import com.pulumi.azure.apimanagement.inputs.DiagnosticFrontendRequestDataMaskingArgs;
...
public final class DiagnosticFrontendRequestArgs extends com.pulumi.resources.ResourceArgs {

    public static final DiagnosticFrontendRequestArgs Empty = new DiagnosticFrontendRequestArgs();
    ...
    private @Nullable Output<DiagnosticFrontendRequestDataMaskingArgs> dataMasking;

    /**
     * @return A `data_masking` block as defined below.
     * 
     */
    public Optional<Output<DiagnosticFrontendRequestDataMaskingArgs>> dataMasking() {
    ...
    private DiagnosticFrontendRequestArgs() {}

    private DiagnosticFrontendRequestArgs(DiagnosticFrontendRequestArgs $) {
    ...
    public static Builder builder(DiagnosticFrontendRequestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DiagnosticFrontendRequestArgs();
        }

        public Builder(DiagnosticFrontendRequestArgs defaults) {
            $ = new DiagnosticFrontendRequestArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dataMasking(@Nullable Output<DiagnosticFrontendRequestDataMaskingArgs> dataMasking) {
         ...
         * 
         */
        public Builder dataMasking(DiagnosticFrontendRequestDataMaskingArgs dataMasking) {
        ...
        public DiagnosticFrontendRequestArgs build() {
            return $;
        }
    }
