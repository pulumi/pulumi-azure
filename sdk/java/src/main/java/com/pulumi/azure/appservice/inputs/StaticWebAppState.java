...
public final class StaticWebAppState extends com.pulumi.resources.ResourceArgs {

    public static final StaticWebAppState Empty = new StaticWebAppState();
    ...
    private StaticWebAppState() {}

    private StaticWebAppState(StaticWebAppState $) {
        this.apiKey = $.apiKey;
    ...
    public static Builder builder(StaticWebAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticWebAppState();
        }

        public Builder(StaticWebAppState defaults) {
            $ = new StaticWebAppState(Objects.requireNonNull(defaults));
        }
        ...
        public StaticWebAppState build() {
            return $;
        }
    }
