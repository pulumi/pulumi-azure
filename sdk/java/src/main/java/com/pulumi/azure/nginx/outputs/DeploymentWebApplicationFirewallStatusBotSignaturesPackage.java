...
public final class DeploymentWebApplicationFirewallStatusBotSignaturesPackage {
    ...
    public static Builder builder(DeploymentWebApplicationFirewallStatusBotSignaturesPackage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DeploymentWebApplicationFirewallStatusBotSignaturesPackage defaults) {
        ...
        public DeploymentWebApplicationFirewallStatusBotSignaturesPackage build() {
            final var _resultValue = new DeploymentWebApplicationFirewallStatusBotSignaturesPackage();
