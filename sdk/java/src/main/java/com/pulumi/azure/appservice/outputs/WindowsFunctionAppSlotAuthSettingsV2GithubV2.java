...
@CustomType
public final class WindowsFunctionAppSlotAuthSettingsV2GithubV2 {
    /**
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsFunctionAppSlotAuthSettingsV2GithubV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2GithubV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2GithubV2", "clientSecretSettingName");
            }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2GithubV2 build() {
            final var _resultValue = new WindowsFunctionAppSlotAuthSettingsV2GithubV2();
