...
@CustomType
public final class AppFlexConsumptionAuthSettingsV2GithubV2 {
    /**
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsV2GithubV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GithubV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GithubV2", "clientSecretSettingName");
            }
        ...
        public AppFlexConsumptionAuthSettingsV2GithubV2 build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsV2GithubV2();
