...
@CustomType
public final class LinuxFunctionAppSlotAuthSettingsV2TwitterV2 {
    /**
    ...
    private LinuxFunctionAppSlotAuthSettingsV2TwitterV2() {}
    /**
     * @return The OAuth 1.0a consumer key of the Twitter application used for sign-in.
     * 
     */
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2TwitterV2 defaults) {
    ...
    public static final class Builder {
        ...
        private String consumerSecretSettingName;
        public Builder() {}
        public Builder(LinuxFunctionAppSlotAuthSettingsV2TwitterV2 defaults) {
        ...
        public Builder consumerKey(String consumerKey) {
            if (consumerKey == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2TwitterV2", "consumerKey");
            }
        ...
        public Builder consumerSecretSettingName(String consumerSecretSettingName) {
            if (consumerSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2TwitterV2", "consumerSecretSettingName");
            }
            this.consumerSecretSettingName = consumerSecretSettingName;
            return this;
        }
        public LinuxFunctionAppSlotAuthSettingsV2TwitterV2 build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsV2TwitterV2();
