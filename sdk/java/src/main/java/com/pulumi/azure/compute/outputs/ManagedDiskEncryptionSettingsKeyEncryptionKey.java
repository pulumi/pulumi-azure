...
public final class ManagedDiskEncryptionSettingsKeyEncryptionKey {
    ...
    public static final class Builder {
        ...
        public Builder keyUrl(String keyUrl) {
            if (keyUrl == null) {
              throw new MissingRequiredPropertyException("ManagedDiskEncryptionSettingsKeyEncryptionKey", "keyUrl");
            }
            this.keyUrl = keyUrl;
            return this;
        }
        ...
        public Builder sourceVaultId(String sourceVaultId) {
            if (sourceVaultId == null) {
              throw new MissingRequiredPropertyException("ManagedDiskEncryptionSettingsKeyEncryptionKey", "sourceVaultId");
            }
            this.sourceVaultId = sourceVaultId;
            return this;
        }
        public ManagedDiskEncryptionSettingsKeyEncryptionKey build() {
            final var _resultValue = new ManagedDiskEncryptionSettingsKeyEncryptionKey();
