...
@CustomType
public final class SparkClusterComputeIsolation {
    /**
    ...
    public static Builder builder(SparkClusterComputeIsolation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String hostSku;
        public Builder() {}
        public Builder(SparkClusterComputeIsolation defaults) {
