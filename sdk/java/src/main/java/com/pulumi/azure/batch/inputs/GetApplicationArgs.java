...
public final class GetApplicationArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetApplicationArgs build() {
            if ($.accountName == null) {
                throw new MissingRequiredPropertyException("GetApplicationArgs", "accountName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetApplicationArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetApplicationArgs", "resourceGroupName");
            }
            return $;
        }
    }
