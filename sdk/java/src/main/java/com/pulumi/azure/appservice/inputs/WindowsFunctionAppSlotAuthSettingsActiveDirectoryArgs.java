...
public final class WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs Empty = new WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs();
    ...
    private WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs() {}

    private WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs(WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsActiveDirectoryArgs", "clientId");
            }
            return $;
        }
    }
