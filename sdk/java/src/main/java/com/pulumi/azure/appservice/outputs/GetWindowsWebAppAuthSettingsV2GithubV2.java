...
@CustomType
public final class GetWindowsWebAppAuthSettingsV2GithubV2 {
    /**
    ...
    private GetWindowsWebAppAuthSettingsV2GithubV2() {}
    /**
     * @return The OAuth 2.0 client ID used by the app for authentication.
     * 
     */
    ...
    public static Builder builder(GetWindowsWebAppAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> loginScopes;
        public Builder() {}
        public Builder(GetWindowsWebAppAuthSettingsV2GithubV2 defaults) {
