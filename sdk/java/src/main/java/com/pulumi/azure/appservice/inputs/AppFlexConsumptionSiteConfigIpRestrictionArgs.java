...
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionSiteConfigIpRestrictionHeadersArgs;
...
public final class AppFlexConsumptionSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionSiteConfigIpRestrictionArgs Empty = new AppFlexConsumptionSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<AppFlexConsumptionSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<AppFlexConsumptionSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private AppFlexConsumptionSiteConfigIpRestrictionArgs() {}

    private AppFlexConsumptionSiteConfigIpRestrictionArgs(AppFlexConsumptionSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(AppFlexConsumptionSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionSiteConfigIpRestrictionArgs();
        }

        public Builder(AppFlexConsumptionSiteConfigIpRestrictionArgs defaults) {
            $ = new AppFlexConsumptionSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<AppFlexConsumptionSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(AppFlexConsumptionSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public AppFlexConsumptionSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
