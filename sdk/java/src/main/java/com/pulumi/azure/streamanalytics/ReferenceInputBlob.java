...
public class ReferenceInputBlob extends com.pulumi.resources.CustomResource {
     ...
     */
    public ReferenceInputBlob(java.lang.String name) {
     ...
     */
    public ReferenceInputBlob(java.lang.String name, ReferenceInputBlobArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ReferenceInputBlob(java.lang.String name, ReferenceInputBlobArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:streamanalytics/referenceInputBlob:ReferenceInputBlob", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ReferenceInputBlob(java.lang.String name, Output<java.lang.String> id, @Nullable ReferenceInputBlobState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:streamanalytics/referenceInputBlob:ReferenceInputBlob", name, state, makeResourceOptions(options, id), false);
    }

    private static ReferenceInputBlobArgs makeArgs(ReferenceInputBlobArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ReferenceInputBlobArgs.Empty : args;
    }
     ...
     */
    public static ReferenceInputBlob get(java.lang.String name, Output<java.lang.String> id, @Nullable ReferenceInputBlobState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
