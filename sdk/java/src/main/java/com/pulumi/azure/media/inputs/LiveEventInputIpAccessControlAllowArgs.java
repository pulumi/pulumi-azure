...
public final class LiveEventInputIpAccessControlAllowArgs extends com.pulumi.resources.ResourceArgs {

    public static final LiveEventInputIpAccessControlAllowArgs Empty = new LiveEventInputIpAccessControlAllowArgs();
    ...
    private LiveEventInputIpAccessControlAllowArgs() {}

    private LiveEventInputIpAccessControlAllowArgs(LiveEventInputIpAccessControlAllowArgs $) {
    ...
    public static Builder builder(LiveEventInputIpAccessControlAllowArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LiveEventInputIpAccessControlAllowArgs();
        }

        public Builder(LiveEventInputIpAccessControlAllowArgs defaults) {
            $ = new LiveEventInputIpAccessControlAllowArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LiveEventInputIpAccessControlAllowArgs build() {
            return $;
        }
    }
