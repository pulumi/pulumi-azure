...
public final class ServiceAccountStorageAccountManagedIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceAccountStorageAccountManagedIdentityArgs Empty = new ServiceAccountStorageAccountManagedIdentityArgs();
    ...
    private ServiceAccountStorageAccountManagedIdentityArgs() {}

    private ServiceAccountStorageAccountManagedIdentityArgs(ServiceAccountStorageAccountManagedIdentityArgs $) {
    ...
    public static Builder builder(ServiceAccountStorageAccountManagedIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceAccountStorageAccountManagedIdentityArgs();
        }

        public Builder(ServiceAccountStorageAccountManagedIdentityArgs defaults) {
            $ = new ServiceAccountStorageAccountManagedIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceAccountStorageAccountManagedIdentityArgs build() {
            return $;
        }
    }
