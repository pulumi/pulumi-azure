...
@CustomType
public final class WindowsWebAppSlotAuthSettingsTwitter {
    /**
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsTwitter defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String consumerSecretSettingName;
        public Builder() {}
        public Builder(WindowsWebAppSlotAuthSettingsTwitter defaults) {
        ...
        public Builder consumerKey(String consumerKey) {
            if (consumerKey == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsTwitter", "consumerKey");
            }
        ...
        public WindowsWebAppSlotAuthSettingsTwitter build() {
            final var _resultValue = new WindowsWebAppSlotAuthSettingsTwitter();
