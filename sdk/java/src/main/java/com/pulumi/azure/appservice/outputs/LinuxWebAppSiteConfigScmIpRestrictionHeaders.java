...
@CustomType
public final class LinuxWebAppSiteConfigScmIpRestrictionHeaders {
    /**
    ...
    private LinuxWebAppSiteConfigScmIpRestrictionHeaders(
    ...
    public static Builder builder(LinuxWebAppSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxWebAppSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        }        public LinuxWebAppSiteConfigScmIpRestrictionHeaders build() {
            return new LinuxWebAppSiteConfigScmIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
