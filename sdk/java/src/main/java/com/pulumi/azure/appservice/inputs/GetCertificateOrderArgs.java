...
public final class GetCertificateOrderArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetCertificateOrderArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetCertificateOrderArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetCertificateOrderArgs", "resourceGroupName");
            }
            return $;
        }
    }
