...
public final class WindowsWebAppSlotAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsActiveDirectoryArgs Empty = new WindowsWebAppSlotAuthSettingsActiveDirectoryArgs();
    ...
    private WindowsWebAppSlotAuthSettingsActiveDirectoryArgs() {}

    private WindowsWebAppSlotAuthSettingsActiveDirectoryArgs(WindowsWebAppSlotAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsActiveDirectoryArgs();
        }

        public Builder(WindowsWebAppSlotAuthSettingsActiveDirectoryArgs defaults) {
            $ = new WindowsWebAppSlotAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsActiveDirectoryArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsActiveDirectoryArgs", "clientId");
            }
            return $;
        }
    }
