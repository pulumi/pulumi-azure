...
import com.pulumi.azure.appservice.outputs.WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class WindowsFunctionAppSlotSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private WindowsFunctionAppSlotSiteConfigIpRestriction(
        ...
        @CustomType.Parameter("headers") @Nullable WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(WindowsFunctionAppSlotSiteConfigIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders headers;
        ...
        public Builder(WindowsFunctionAppSlotSiteConfigIpRestriction defaults) {
        ...
        public Builder headers(@Nullable WindowsFunctionAppSlotSiteConfigIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public WindowsFunctionAppSlotSiteConfigIpRestriction build() {
            return new WindowsFunctionAppSlotSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
