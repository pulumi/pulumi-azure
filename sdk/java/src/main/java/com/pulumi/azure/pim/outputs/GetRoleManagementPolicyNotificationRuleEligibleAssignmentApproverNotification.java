...
@CustomType
public final class GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification {
    /**
    ...
    private GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification() {}
    /**
     * @return A list of additional email addresses that will receive these notifications.
     * 
     */
    ...
    public static Builder builder(GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification defaults) {
        ...
        public Builder additionalRecipients(List<String> additionalRecipients) {
            if (additionalRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification", "additionalRecipients");
            }
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification build() {
            final var _resultValue = new GetRoleManagementPolicyNotificationRuleEligibleAssignmentApproverNotification();
