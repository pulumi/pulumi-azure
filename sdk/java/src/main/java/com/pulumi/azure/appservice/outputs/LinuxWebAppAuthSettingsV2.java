...
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2ActiveDirectoryV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2AppleV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2AzureStaticWebAppV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2CustomOidcV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2FacebookV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2GithubV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2GoogleV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2Login;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2MicrosoftV2;
import com.pulumi.azure.appservice.outputs.LinuxWebAppAuthSettingsV2TwitterV2;
...
public final class LinuxWebAppAuthSettingsV2 {
     ...
     * 
     */
    public LinuxWebAppAuthSettingsV2Login login() {
        return this.login;
    }
    /**
     * @return A `microsoftV2` block as defined below.
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String unauthenticatedAction;
        public Builder() {}
        public Builder(LinuxWebAppAuthSettingsV2 defaults) {
        ...
        @CustomType.Setter
        public Builder activeDirectoryV2(@Nullable LinuxWebAppAuthSettingsV2ActiveDirectoryV2 activeDirectoryV2) {

            this.activeDirectoryV2 = activeDirectoryV2;
            return this;
        }
        @CustomType.Setter
        public Builder appleV2(@Nullable LinuxWebAppAuthSettingsV2AppleV2 appleV2) {
        ...
        @CustomType.Setter
        public Builder azureStaticWebAppV2(@Nullable LinuxWebAppAuthSettingsV2AzureStaticWebAppV2 azureStaticWebAppV2) {
        ...
        @CustomType.Setter
        public Builder customOidcV2s(@Nullable List<LinuxWebAppAuthSettingsV2CustomOidcV2> customOidcV2s) {

            this.customOidcV2s = customOidcV2s;
            return this;
        }
        public Builder customOidcV2s(LinuxWebAppAuthSettingsV2CustomOidcV2... customOidcV2s) {
        ...
        @CustomType.Setter
        public Builder facebookV2(@Nullable LinuxWebAppAuthSettingsV2FacebookV2 facebookV2) {
        ...
        @CustomType.Setter
        public Builder githubV2(@Nullable LinuxWebAppAuthSettingsV2GithubV2 githubV2) {

            this.githubV2 = githubV2;
            return this;
        }
        @CustomType.Setter
        public Builder googleV2(@Nullable LinuxWebAppAuthSettingsV2GoogleV2 googleV2) {
        ...
        @CustomType.Setter
        public Builder login(LinuxWebAppAuthSettingsV2Login login) {
            if (login == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2", "login");
            }
            this.login = login;
            return this;
        }
        @CustomType.Setter
        public Builder microsoftV2(@Nullable LinuxWebAppAuthSettingsV2MicrosoftV2 microsoftV2) {
        ...
        @CustomType.Setter
        public Builder twitterV2(@Nullable LinuxWebAppAuthSettingsV2TwitterV2 twitterV2) {
        ...
        public LinuxWebAppAuthSettingsV2 build() {
            final var _resultValue = new LinuxWebAppAuthSettingsV2();
