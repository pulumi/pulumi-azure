...
@CustomType
public final class HBaseClusterMetastoresHive {
    /**
    ...
    public static Builder builder(HBaseClusterMetastoresHive defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(HBaseClusterMetastoresHive defaults) {
        ...
        public Builder databaseName(String databaseName) {
            if (databaseName == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresHive", "databaseName");
            }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresHive", "password");
            }
        ...
        public Builder server(String server) {
            if (server == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresHive", "server");
            }
            this.server = server;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMetastoresHive", "username");
            }
            this.username = username;
            return this;
        }
        public HBaseClusterMetastoresHive build() {
            final var _resultValue = new HBaseClusterMetastoresHive();
