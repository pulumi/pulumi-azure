...
public final class FirewallPolicyManagedRuleExclusionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirewallPolicyManagedRuleExclusionArgs Empty = new FirewallPolicyManagedRuleExclusionArgs();
    ...
    private FirewallPolicyManagedRuleExclusionArgs() {}

    private FirewallPolicyManagedRuleExclusionArgs(FirewallPolicyManagedRuleExclusionArgs $) {
    ...
    public static Builder builder(FirewallPolicyManagedRuleExclusionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirewallPolicyManagedRuleExclusionArgs();
        }

        public Builder(FirewallPolicyManagedRuleExclusionArgs defaults) {
            $ = new FirewallPolicyManagedRuleExclusionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FirewallPolicyManagedRuleExclusionArgs build() {
            if ($.matchVariable == null) {
                throw new MissingRequiredPropertyException("FirewallPolicyManagedRuleExclusionArgs", "matchVariable");
            }
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FirewallPolicyManagedRuleExclusionArgs", "operator");
            }
            if ($.selector == null) {
                throw new MissingRequiredPropertyException("FirewallPolicyManagedRuleExclusionArgs", "selector");
            }
            return $;
        }
    }
