...
public final class OrchestratedVirtualMachineScaleSetPlanArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public OrchestratedVirtualMachineScaleSetPlanArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetPlanArgs", "name");
            }
            if ($.product == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetPlanArgs", "product");
            }
            if ($.publisher == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetPlanArgs", "publisher");
            }
            return $;
        }
    }
