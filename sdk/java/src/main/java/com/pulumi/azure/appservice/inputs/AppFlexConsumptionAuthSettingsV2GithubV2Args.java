...
public final class AppFlexConsumptionAuthSettingsV2GithubV2Args extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsV2GithubV2Args Empty = new AppFlexConsumptionAuthSettingsV2GithubV2Args();
    ...
    private AppFlexConsumptionAuthSettingsV2GithubV2Args() {}

    private AppFlexConsumptionAuthSettingsV2GithubV2Args(AppFlexConsumptionAuthSettingsV2GithubV2Args $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2GithubV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsV2GithubV2Args();
        }

        public Builder(AppFlexConsumptionAuthSettingsV2GithubV2Args defaults) {
            $ = new AppFlexConsumptionAuthSettingsV2GithubV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsV2GithubV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GithubV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GithubV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
