...
public final class ApiDiagnosticFrontendRequestDataMaskingHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ApiDiagnosticFrontendRequestDataMaskingHeaderArgs build() {
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("ApiDiagnosticFrontendRequestDataMaskingHeaderArgs", "mode");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("ApiDiagnosticFrontendRequestDataMaskingHeaderArgs", "value");
            }
            return $;
        }
    }
