...
@CustomType
public final class LinuxWebAppAuthSettingsV2GithubV2 {
    /**
    ...
    private LinuxWebAppAuthSettingsV2GithubV2() {}
    /**
     * @return The ID of the GitHub app used for login..
     * 
     */
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxWebAppAuthSettingsV2GithubV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2GithubV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2GithubV2", "clientSecretSettingName");
            }
        ...
        public LinuxWebAppAuthSettingsV2GithubV2 build() {
            final var _resultValue = new LinuxWebAppAuthSettingsV2GithubV2();
