...
public final class LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args Empty = new LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args();
    ...
    private LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args() {}

    private LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args(LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args();
        }

        public Builder(LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args defaults) {
            $ = new LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2MicrosoftV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
