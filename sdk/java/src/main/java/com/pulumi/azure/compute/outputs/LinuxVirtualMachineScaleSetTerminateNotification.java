...
public final class LinuxVirtualMachineScaleSetTerminateNotification {
    ...
    public static final class Builder {
        ...
        public Builder enabled(Boolean enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("LinuxVirtualMachineScaleSetTerminateNotification", "enabled");
            }
        ...
        public LinuxVirtualMachineScaleSetTerminateNotification build() {
            final var _resultValue = new LinuxVirtualMachineScaleSetTerminateNotification();
