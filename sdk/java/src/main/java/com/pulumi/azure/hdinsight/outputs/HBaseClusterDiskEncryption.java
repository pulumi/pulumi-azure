...
@CustomType
public final class HBaseClusterDiskEncryption {
    /**
    ...
    private HBaseClusterDiskEncryption() {}
    /**
     * @return This is an algorithm identifier for encryption. Possible values are `RSA1_5`, `RSA-OAEP`, `RSA-OAEP-256`.
     * 
     */
    ...
    public static Builder builder(HBaseClusterDiskEncryption defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyVaultManagedIdentityId;
        public Builder() {}
        public Builder(HBaseClusterDiskEncryption defaults) {
        ...
        public HBaseClusterDiskEncryption build() {
            final var _resultValue = new HBaseClusterDiskEncryption();
