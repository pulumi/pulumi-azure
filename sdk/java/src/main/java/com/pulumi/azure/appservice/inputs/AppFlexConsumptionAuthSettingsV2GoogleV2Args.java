...
public final class AppFlexConsumptionAuthSettingsV2GoogleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsV2GoogleV2Args Empty = new AppFlexConsumptionAuthSettingsV2GoogleV2Args();
    ...
    private AppFlexConsumptionAuthSettingsV2GoogleV2Args() {}

    private AppFlexConsumptionAuthSettingsV2GoogleV2Args(AppFlexConsumptionAuthSettingsV2GoogleV2Args $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2GoogleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsV2GoogleV2Args();
        }

        public Builder(AppFlexConsumptionAuthSettingsV2GoogleV2Args defaults) {
            $ = new AppFlexConsumptionAuthSettingsV2GoogleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsV2GoogleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GoogleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2GoogleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
