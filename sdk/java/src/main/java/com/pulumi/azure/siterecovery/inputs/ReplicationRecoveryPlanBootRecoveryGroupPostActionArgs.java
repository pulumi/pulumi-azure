...
public final class ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs Empty = new ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs();
    ...
    private ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs() {}

    private ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs(ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs $) {
    ...
    public static Builder builder(ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs();
        }

        public Builder(ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs defaults) {
            $ = new ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs build() {
            if ($.failOverDirections == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs", "failOverDirections");
            }
            if ($.failOverTypes == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs", "failOverTypes");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanBootRecoveryGroupPostActionArgs", "type");
            }
            return $;
        }
    }
