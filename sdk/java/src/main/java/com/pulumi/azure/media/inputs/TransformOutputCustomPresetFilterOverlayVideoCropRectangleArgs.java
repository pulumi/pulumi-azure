...
public final class TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs Empty = new TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs();
    ...
    private TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs() {}

    private TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs(TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs $) {
        this.height = $.height;
        this.left = $.left;
        this.top = $.top;
        this.width = $.width;
    ...
    public static Builder builder(TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs();
        }

        public Builder(TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs defaults) {
            $ = new TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TransformOutputCustomPresetFilterOverlayVideoCropRectangleArgs build() {
            return $;
        }
    }
