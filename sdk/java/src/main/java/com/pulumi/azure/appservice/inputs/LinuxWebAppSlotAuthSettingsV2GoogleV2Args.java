...
public final class LinuxWebAppSlotAuthSettingsV2GoogleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsV2GoogleV2Args Empty = new LinuxWebAppSlotAuthSettingsV2GoogleV2Args();
    ...
    private LinuxWebAppSlotAuthSettingsV2GoogleV2Args() {}

    private LinuxWebAppSlotAuthSettingsV2GoogleV2Args(LinuxWebAppSlotAuthSettingsV2GoogleV2Args $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2GoogleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsV2GoogleV2Args();
        }

        public Builder(LinuxWebAppSlotAuthSettingsV2GoogleV2Args defaults) {
            $ = new LinuxWebAppSlotAuthSettingsV2GoogleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsV2GoogleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2GoogleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2GoogleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
