...
@CustomType
public final class LinuxWebAppSlotAuthSettingsActiveDirectory {
    /**
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsActiveDirectory defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxWebAppSlotAuthSettingsActiveDirectory defaults) {
        ...
        public Builder clientSecretSettingName(@Nullable String clientSecretSettingName) {
            ...
            return new LinuxWebAppSlotAuthSettingsActiveDirectory(allowedAudiences, clientId, clientSecret, clientSecretSettingName);
        }
    }
}
