...
public final class VolumeArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="acceptGrowCapacityPoolForShortTermCloneSplit")
    private @Nullable Output<String> acceptGrowCapacityPoolForShortTermCloneSplit;
     ...
     * 
     */
    public Optional<Output<String>> acceptGrowCapacityPoolForShortTermCloneSplit() {
        return Optional.ofNullable(this.acceptGrowCapacityPoolForShortTermCloneSplit);
    }
    ...
    public static final class Builder {
        ...
        /**
         * @param acceptGrowCapacityPoolForShortTermCloneSplit While auto splitting the short term clone volume, if the parent pool does not have enough space to accommodate the volume after split, it will be automatically resized, which will lead to increased billing. To accept capacity pool size auto grow and create a short term clone volume, set the property as `Accepted`. If `Declined`, the short term clone volume creation operation will fail. This property can only be used in conjunction with `createFromSnapshotResourceId`. Changing this forces a new resource to be created.
         * 
         * &gt; **Note:** Short-term clones are not supported on large volumes or volumes enabled for cool access. Short-term clones automatically convert to regular volumes after 32 days. For more information, please refer to [Create a short-term clone volume in Azure NetApp Files](https://learn.microsoft.com/en-us/azure/azure-netapp-files/create-short-term-clone)
         * 
         * @return builder
         * 
         */
        public Builder acceptGrowCapacityPoolForShortTermCloneSplit(@Nullable Output<String> acceptGrowCapacityPoolForShortTermCloneSplit) {
        ...
        public Builder acceptGrowCapacityPoolForShortTermCloneSplit(String acceptGrowCapacityPoolForShortTermCloneSplit) {
            return acceptGrowCapacityPoolForShortTermCloneSplit(Output.of(acceptGrowCapacityPoolForShortTermCloneSplit));
        }
        ...
        /**
         * @param createFromSnapshotResourceId Creates volume from snapshot. Following properties must be the same as the original volume where the snapshot was taken from: `protocols`, `subnetId`, `location`, `serviceLevel`, `resourceGroupName` and `accountName`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param kerberosEnabled Enable to allow Kerberos secured volumes. Requires appropriate export rules. Changing this forces a new resource to be created.
         * 
         * &gt; **Note:** `kerberosEnabled` requires that the parent `azure.netapp.Account` has a *valid* AD connection defined. If the configuration is invalid, the volume will still be created but in a failed state. This requires manually deleting the volume and recreating it again via Terraform once the AD configuration has been corrected.
         * 
         * @return builder
        ...
        /**
         * @param serviceLevel The target performance of the file system. Possible values are `Premium`, `Standard`, `Ultra` and `Flexible`.
         * 
         * &gt; **Note:** When updating `serviceLevel` by migrating it to another Capacity Pool, both `serviceLevel` and `poolName` must be changed, otherwise the volume will be recreated with the specified `serviceLevel`.
         * 
         * &gt; **Note:** After updating `serviceLevel` the `id` for the volume will change to include the new Capacity Pool so any resources referencing the Volume will be silently removed from state. They will still exist in Azure but need to reimported into Terraform.
