...
public final class GremlinGraphConflictResolutionPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final GremlinGraphConflictResolutionPolicyArgs Empty = new GremlinGraphConflictResolutionPolicyArgs();
    ...
    private GremlinGraphConflictResolutionPolicyArgs() {}

    private GremlinGraphConflictResolutionPolicyArgs(GremlinGraphConflictResolutionPolicyArgs $) {
    ...
    public static Builder builder(GremlinGraphConflictResolutionPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GremlinGraphConflictResolutionPolicyArgs();
        }

        public Builder(GremlinGraphConflictResolutionPolicyArgs defaults) {
            $ = new GremlinGraphConflictResolutionPolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GremlinGraphConflictResolutionPolicyArgs build() {
            if ($.mode == null) {
                throw new MissingRequiredPropertyException("GremlinGraphConflictResolutionPolicyArgs", "mode");
            }
            return $;
        }
    }
