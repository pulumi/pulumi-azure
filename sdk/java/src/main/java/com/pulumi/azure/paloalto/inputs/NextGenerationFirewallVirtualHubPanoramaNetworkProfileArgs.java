...
public final class NextGenerationFirewallVirtualHubPanoramaNetworkProfileArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param networkVirtualApplianceId The ID of the Palo Alto Network Virtual Appliance in the VHub. Changing this forces a new Palo Alto Next Generation Firewall VHub Panorama to be created.
         * 
         * @return builder
         * 
         */
