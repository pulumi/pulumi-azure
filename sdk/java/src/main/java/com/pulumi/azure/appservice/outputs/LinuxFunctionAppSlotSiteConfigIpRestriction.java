...
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class LinuxFunctionAppSlotSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private LinuxFunctionAppSlotSiteConfigIpRestriction(
        ...
        @CustomType.Parameter("headers") @Nullable LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(LinuxFunctionAppSlotSiteConfigIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders headers;
        ...
        public Builder(LinuxFunctionAppSlotSiteConfigIpRestriction defaults) {
        ...
        public Builder headers(@Nullable LinuxFunctionAppSlotSiteConfigIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public LinuxFunctionAppSlotSiteConfigIpRestriction build() {
            return new LinuxFunctionAppSlotSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
