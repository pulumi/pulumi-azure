...
public final class WindowsWebAppAuthSettingsV2CustomOidcV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsV2CustomOidcV2Args Empty = new WindowsWebAppAuthSettingsV2CustomOidcV2Args();
    ...
    private WindowsWebAppAuthSettingsV2CustomOidcV2Args() {}

    private WindowsWebAppAuthSettingsV2CustomOidcV2Args(WindowsWebAppAuthSettingsV2CustomOidcV2Args $) {
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2CustomOidcV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsV2CustomOidcV2Args();
        }

        public Builder(WindowsWebAppAuthSettingsV2CustomOidcV2Args defaults) {
            $ = new WindowsWebAppAuthSettingsV2CustomOidcV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsV2CustomOidcV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2CustomOidcV2Args", "clientId");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2CustomOidcV2Args", "name");
            }
            if ($.openidConfigurationEndpoint == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2CustomOidcV2Args", "openidConfigurationEndpoint");
            }
            return $;
        }
    }
