...
public final class GetApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder headerName(String headerName) {
            if (headerName == null) {
              throw new MissingRequiredPropertyException("GetApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfiguration", "headerName");
            }
        ...
        public Builder headerValue(String headerValue) {
            if (headerValue == null) {
              throw new MissingRequiredPropertyException("GetApplicationGatewayRewriteRuleSetRewriteRuleResponseHeaderConfiguration", "headerValue");
            }
