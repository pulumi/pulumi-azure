...
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class AppFlexConsumptionSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private @Nullable AppFlexConsumptionSiteConfigIpRestrictionHeaders headers;
    /**
     ...
     * 
     */
    public Optional<AppFlexConsumptionSiteConfigIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(AppFlexConsumptionSiteConfigIpRestriction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String virtualNetworkSubnetId;
        public Builder() {}
        public Builder(AppFlexConsumptionSiteConfigIpRestriction defaults) {
        ...
        @CustomType.Setter
        public Builder headers(@Nullable AppFlexConsumptionSiteConfigIpRestrictionHeaders headers) {
        ...
        public AppFlexConsumptionSiteConfigIpRestriction build() {
            final var _resultValue = new AppFlexConsumptionSiteConfigIpRestriction();
