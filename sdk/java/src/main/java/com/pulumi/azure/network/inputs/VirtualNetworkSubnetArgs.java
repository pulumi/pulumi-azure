...
public final class VirtualNetworkSubnetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The Network Security Group to associate with the subnet. (Referenced by `id`, i.e. `azurerm_network_security_group.example.id`)
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param securityGroup The Network Security Group to associate with the subnet. (Referenced by `id`, i.e. `azurerm_network_security_group.example.id`)
         * 
         * @return builder
         * 
         */
