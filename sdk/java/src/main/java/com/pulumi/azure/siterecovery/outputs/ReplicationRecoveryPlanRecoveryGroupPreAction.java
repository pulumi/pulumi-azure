    ...
    public static final class Builder {
        ...
        public Builder failOverDirections(List<String> failOverDirections) {
            if (failOverDirections == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreAction", "failOverDirections");
            }
        ...
        public Builder failOverTypes(List<String> failOverTypes) {
            if (failOverTypes == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreAction", "failOverTypes");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPreAction", "type");
            }
            this.type = type;
            return this;
        }
        public ReplicationRecoveryPlanRecoveryGroupPreAction build() {
            final var _resultValue = new ReplicationRecoveryPlanRecoveryGroupPreAction();
