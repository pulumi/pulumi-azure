...
public final class VolumeGroupOracleArgs extends com.pulumi.resources.ResourceArgs {

    public static final VolumeGroupOracleArgs Empty = new VolumeGroupOracleArgs();
    ...
    private Output<List<VolumeGroupOracleVolumeArgs>> volumes;

    /**
     * @return One or more `volume` blocks as defined below.
     * 
     */
    public Output<List<VolumeGroupOracleVolumeArgs>> volumes() {
        return this.volumes;
    }

    private VolumeGroupOracleArgs() {}

    private VolumeGroupOracleArgs(VolumeGroupOracleArgs $) {
    ...
    public static Builder builder(VolumeGroupOracleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VolumeGroupOracleArgs();
        }

        public Builder(VolumeGroupOracleArgs defaults) {
            $ = new VolumeGroupOracleArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder volumes(Output<List<VolumeGroupOracleVolumeArgs>> volumes) {
            $.volumes = volumes;
            return this;
        }
        ...
        public VolumeGroupOracleArgs build() {
            if ($.accountName == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleArgs", "accountName");
            }
            if ($.applicationIdentifier == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleArgs", "applicationIdentifier");
            }
            if ($.groupDescription == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleArgs", "groupDescription");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleArgs", "resourceGroupName");
            }
            if ($.volumes == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleArgs", "volumes");
            }
            return $;
        }
    }
