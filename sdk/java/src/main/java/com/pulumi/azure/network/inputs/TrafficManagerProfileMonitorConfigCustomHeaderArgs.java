...
public final class TrafficManagerProfileMonitorConfigCustomHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TrafficManagerProfileMonitorConfigCustomHeaderArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("TrafficManagerProfileMonitorConfigCustomHeaderArgs", "name");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("TrafficManagerProfileMonitorConfigCustomHeaderArgs", "value");
            }
            return $;
        }
    }
