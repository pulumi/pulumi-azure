...
@CustomType
public final class RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications {
    /**
    ...
    private RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications() {}
    /**
     * @return The additional recipients to notify
     * 
     */
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications build() {
            final var _resultValue = new RoleManagementPolicyNotificationRulesEligibleActivationsApproverNotifications();
