...
public final class EventGridTopicIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final EventGridTopicIdentityArgs Empty = new EventGridTopicIdentityArgs();
    ...
    private EventGridTopicIdentityArgs() {}

    private EventGridTopicIdentityArgs(EventGridTopicIdentityArgs $) {
    ...
    public static Builder builder(EventGridTopicIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EventGridTopicIdentityArgs();
        }

        public Builder(EventGridTopicIdentityArgs defaults) {
            $ = new EventGridTopicIdentityArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param identityIds Specifies a list of User Assigned Managed Identity IDs to be assigned to this Event Grid Topic.
         * 
         * &gt; **Note:** This is required when `type` is set to `UserAssigned`
         * 
         * &gt; **Note:** When `type` is set to `SystemAssigned`, The assigned `principalId` and `tenantId` can be retrieved after the Event Grid Topic has been created. More details are available below.
        ...
        /**
         * @param type Specifies the type of Managed Service Identity that should be configured on this Event Grid Topic. Possible values are `SystemAssigned`, `UserAssigned`.
         * 
         * @return builder
         * 
         */
