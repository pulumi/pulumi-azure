...
public final class StreamInputBlobState extends com.pulumi.resources.ResourceArgs {

    public static final StreamInputBlobState Empty = new StreamInputBlobState();
    ...
    private @Nullable Output<StreamInputBlobSerializationArgs> serialization;

    /**
     * @return A `serialization` block as defined below.
     * 
     */
    public Optional<Output<StreamInputBlobSerializationArgs>> serialization() {
    ...
    private StreamInputBlobState() {}

    private StreamInputBlobState(StreamInputBlobState $) {
    ...
    public static Builder builder(StreamInputBlobState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamInputBlobState();
        }

        public Builder(StreamInputBlobState defaults) {
            $ = new StreamInputBlobState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder serialization(@Nullable Output<StreamInputBlobSerializationArgs> serialization) {
        ...
        public StreamInputBlobState build() {
            return $;
        }
    }
