...
public final class NamespaceInboundIpRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final NamespaceInboundIpRuleArgs Empty = new NamespaceInboundIpRuleArgs();
    ...
    private NamespaceInboundIpRuleArgs(NamespaceInboundIpRuleArgs $) {
        this.action = $.action;
        this.ipMask = $.ipMask;
    }
    ...
    public static Builder builder(NamespaceInboundIpRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NamespaceInboundIpRuleArgs();
        }

        public Builder(NamespaceInboundIpRuleArgs defaults) {
            $ = new NamespaceInboundIpRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NamespaceInboundIpRuleArgs build() {
            if ($.ipMask == null) {
                throw new MissingRequiredPropertyException("NamespaceInboundIpRuleArgs", "ipMask");
            }
            return $;
        }
    }
