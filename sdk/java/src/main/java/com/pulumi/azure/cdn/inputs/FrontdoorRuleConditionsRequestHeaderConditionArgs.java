...
public final class FrontdoorRuleConditionsRequestHeaderConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsRequestHeaderConditionArgs Empty = new FrontdoorRuleConditionsRequestHeaderConditionArgs();
    ...
    private FrontdoorRuleConditionsRequestHeaderConditionArgs() {}

    private FrontdoorRuleConditionsRequestHeaderConditionArgs(FrontdoorRuleConditionsRequestHeaderConditionArgs $) {
    ...
    public static Builder builder(FrontdoorRuleConditionsRequestHeaderConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsRequestHeaderConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsRequestHeaderConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsRequestHeaderConditionArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param headerName A string value representing the name of the `POST` argument.
         * 
         * @return builder
         * 
         */
        ...
        public FrontdoorRuleConditionsRequestHeaderConditionArgs build() {
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsRequestHeaderConditionArgs", "headerName");
            }
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsRequestHeaderConditionArgs", "operator");
            }
            return $;
        }
    }
