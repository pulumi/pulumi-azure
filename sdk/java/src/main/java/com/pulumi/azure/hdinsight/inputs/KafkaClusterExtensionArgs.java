...
public final class KafkaClusterExtensionArgs extends com.pulumi.resources.ResourceArgs {

    public static final KafkaClusterExtensionArgs Empty = new KafkaClusterExtensionArgs();
    ...
    private KafkaClusterExtensionArgs() {}

    private KafkaClusterExtensionArgs(KafkaClusterExtensionArgs $) {
    ...
    public static Builder builder(KafkaClusterExtensionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KafkaClusterExtensionArgs();
        }

        public Builder(KafkaClusterExtensionArgs defaults) {
            $ = new KafkaClusterExtensionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaClusterExtensionArgs build() {
            if ($.logAnalyticsWorkspaceId == null) {
                throw new MissingRequiredPropertyException("KafkaClusterExtensionArgs", "logAnalyticsWorkspaceId");
            }
            if ($.primaryKey == null) {
                throw new MissingRequiredPropertyException("KafkaClusterExtensionArgs", "primaryKey");
            }
            return $;
        }
    }
