...
@CustomType
public final class GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification {
    /**
    ...
    private GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification() {}
    /**
     * @return A list of additional email addresses that will receive these notifications.
     * 
     */
    ...
    public static Builder builder(GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification defaults) {
        ...
        public Builder additionalRecipients(List<String> additionalRecipients) {
            if (additionalRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification", "additionalRecipients");
            }
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification build() {
            final var _resultValue = new GetRoleManagementPolicyNotificationRuleEligibleAssignmentAssigneeNotification();
