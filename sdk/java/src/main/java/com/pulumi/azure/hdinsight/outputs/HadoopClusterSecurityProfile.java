...
@CustomType
public final class HadoopClusterSecurityProfile {
    /**
    ...
    public static Builder builder(HadoopClusterSecurityProfile defaults) {
    ...
    public static final class Builder {
        ...
        private String msiResourceId;
        public Builder() {}
        public Builder(HadoopClusterSecurityProfile defaults) {
        ...
        public Builder aaddsResourceId(String aaddsResourceId) {
            if (aaddsResourceId == null) {
              throw new MissingRequiredPropertyException("HadoopClusterSecurityProfile", "aaddsResourceId");
            }
        ...
        public Builder domainName(String domainName) {
            if (domainName == null) {
              throw new MissingRequiredPropertyException("HadoopClusterSecurityProfile", "domainName");
            }
        ...
        public Builder domainUserPassword(String domainUserPassword) {
            if (domainUserPassword == null) {
              throw new MissingRequiredPropertyException("HadoopClusterSecurityProfile", "domainUserPassword");
            }
        ...
        public Builder domainUsername(String domainUsername) {
            if (domainUsername == null) {
              throw new MissingRequiredPropertyException("HadoopClusterSecurityProfile", "domainUsername");
            }
        ...
        public Builder ldapsUrls(List<String> ldapsUrls) {
            if (ldapsUrls == null) {
              throw new MissingRequiredPropertyException("HadoopClusterSecurityProfile", "ldapsUrls");
            }
        ...
        public Builder msiResourceId(String msiResourceId) {
            if (msiResourceId == null) {
              throw new MissingRequiredPropertyException("HadoopClusterSecurityProfile", "msiResourceId");
            }
