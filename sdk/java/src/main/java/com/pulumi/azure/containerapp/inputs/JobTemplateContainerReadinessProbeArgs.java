...
import com.pulumi.azure.containerapp.inputs.JobTemplateContainerReadinessProbeHeaderArgs;
...
public final class JobTemplateContainerReadinessProbeArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="headers")
    private @Nullable Output<List<JobTemplateContainerReadinessProbeHeaderArgs>> headers;

    /**
     * @return A `header` block as detailed below.
     * 
     */
    public Optional<Output<List<JobTemplateContainerReadinessProbeHeaderArgs>>> headers() {
    ...
    private JobTemplateContainerReadinessProbeArgs() {}

    private JobTemplateContainerReadinessProbeArgs(JobTemplateContainerReadinessProbeArgs $) {
    ...
    public static Builder builder(JobTemplateContainerReadinessProbeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobTemplateContainerReadinessProbeArgs();
        }

        public Builder(JobTemplateContainerReadinessProbeArgs defaults) {
            $ = new JobTemplateContainerReadinessProbeArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<List<JobTemplateContainerReadinessProbeHeaderArgs>> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(List<JobTemplateContainerReadinessProbeHeaderArgs> headers) {
         ...
         * 
         */
        public Builder headers(JobTemplateContainerReadinessProbeHeaderArgs... headers) {
        ...
        public JobTemplateContainerReadinessProbeArgs build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("JobTemplateContainerReadinessProbeArgs", "port");
            }
            if ($.transport == null) {
                throw new MissingRequiredPropertyException("JobTemplateContainerReadinessProbeArgs", "transport");
            }
            return $;
        }
    }
