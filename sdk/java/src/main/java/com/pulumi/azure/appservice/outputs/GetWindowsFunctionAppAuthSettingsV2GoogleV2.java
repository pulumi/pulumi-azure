...
@CustomType
public final class GetWindowsFunctionAppAuthSettingsV2GoogleV2 {
    /**
    ...
    private GetWindowsFunctionAppAuthSettingsV2GoogleV2() {}
    /**
     * @return The list of Allowed Audiences that are be requested as part of Microsoft Sign-In authentication.
     * 
     */
    ...
    public static Builder builder(GetWindowsFunctionAppAuthSettingsV2GoogleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> loginScopes;
        public Builder() {}
        public Builder(GetWindowsFunctionAppAuthSettingsV2GoogleV2 defaults) {
        ...
        public Builder allowedAudiences(List<String> allowedAudiences) {
            if (allowedAudiences == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2GoogleV2", "allowedAudiences");
            }
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2GoogleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2GoogleV2", "clientSecretSettingName");
            }
        ...
        public Builder loginScopes(List<String> loginScopes) {
            if (loginScopes == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2GoogleV2", "loginScopes");
            }
        ...
        public GetWindowsFunctionAppAuthSettingsV2GoogleV2 build() {
            final var _resultValue = new GetWindowsFunctionAppAuthSettingsV2GoogleV2();
