...
@CustomType
public final class GetWindowsWebAppAuthSettingsV2MicrosoftV2 {
    /**
    ...
    private GetWindowsWebAppAuthSettingsV2MicrosoftV2() {}
    /**
     * @return The list of Allowed Audiences that are be requested as part of Microsoft Sign-In authentication.
     * 
     */
    ...
    public static Builder builder(GetWindowsWebAppAuthSettingsV2MicrosoftV2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> loginScopes;
        public Builder() {}
        public Builder(GetWindowsWebAppAuthSettingsV2MicrosoftV2 defaults) {
        ...
        public Builder allowedAudiences(List<String> allowedAudiences) {
            if (allowedAudiences == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingsV2MicrosoftV2", "allowedAudiences");
            }
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingsV2MicrosoftV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingsV2MicrosoftV2", "clientSecretSettingName");
            }
        ...
        public Builder loginScopes(List<String> loginScopes) {
            if (loginScopes == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingsV2MicrosoftV2", "loginScopes");
            }
        ...
        public GetWindowsWebAppAuthSettingsV2MicrosoftV2 build() {
            final var _resultValue = new GetWindowsWebAppAuthSettingsV2MicrosoftV2();
