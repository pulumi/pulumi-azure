...
public final class PlanState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<Integer> maximumNumberOfWorkers;

    /**
     * @return The maximum number of workers supported with the App Service Plan&#39;s sku.
     * 
     */
    public Optional<Output<Integer>> maximumNumberOfWorkers() {
     ...
     */
    @Import(name="sku")
    private @Nullable Output<PlanSkuArgs> sku;

    /**
     * @return A `sku` block as documented below.
     * 
     */
    public Optional<Output<PlanSkuArgs>> sku() {
    ...
    public static final class Builder {
        ...
        /**
         * @param kind The kind of the App Service Plan to create. Possible values are `Windows` (also available as `App`), `Linux`, `elastic` (for Premium Consumption) and `FunctionApp` (for a Consumption Plan). Defaults to `Windows`. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder maximumNumberOfWorkers(@Nullable Output<Integer> maximumNumberOfWorkers) {
         ...
         * 
         */
        public Builder sku(@Nullable Output<PlanSkuArgs> sku) {
            $.sku = sku;
            return this;
        }
