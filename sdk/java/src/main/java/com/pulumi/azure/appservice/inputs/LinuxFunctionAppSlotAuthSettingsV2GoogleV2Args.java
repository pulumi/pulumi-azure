...
public final class LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args() {}

    private LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args(LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args $) {
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2GoogleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
