...
public class ThreeTierVirtualInstance extends com.pulumi.resources.CustomResource {
    ...
    public ThreeTierVirtualInstance(String name, ThreeTierVirtualInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:workloadssap/threeTierVirtualInstance:ThreeTierVirtualInstance", name, args == null ? ThreeTierVirtualInstanceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
