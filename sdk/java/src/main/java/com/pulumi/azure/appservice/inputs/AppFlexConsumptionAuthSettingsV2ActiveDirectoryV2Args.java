...
public final class AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args Empty = new AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args();
    ...
    private AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args() {}

    private AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args(AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args();
        }

        public Builder(AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args defaults) {
            $ = new AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args", "clientId");
            }
            if ($.tenantAuthEndpoint == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2ActiveDirectoryV2Args", "tenantAuthEndpoint");
            }
            return $;
        }
    }
