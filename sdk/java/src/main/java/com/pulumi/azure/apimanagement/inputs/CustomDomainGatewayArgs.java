...
public final class CustomDomainGatewayArgs extends com.pulumi.resources.ResourceArgs {

    public static final CustomDomainGatewayArgs Empty = new CustomDomainGatewayArgs();
    ...
    private CustomDomainGatewayArgs() {}
    ...
    public static Builder builder(CustomDomainGatewayArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CustomDomainGatewayArgs();
        }

        public Builder(CustomDomainGatewayArgs defaults) {
            $ = new CustomDomainGatewayArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CustomDomainGatewayArgs build() {
            if ($.hostName == null) {
                throw new MissingRequiredPropertyException("CustomDomainGatewayArgs", "hostName");
            }
            return $;
        }
    }
