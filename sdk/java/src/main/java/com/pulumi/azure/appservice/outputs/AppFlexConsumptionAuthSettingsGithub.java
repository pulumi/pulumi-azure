...
@CustomType
public final class AppFlexConsumptionAuthSettingsGithub {
    /**
    ...
    private AppFlexConsumptionAuthSettingsGithub() {}
    /**
     * @return The ID of the GitHub app used for login.
     * 
     */
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsGithub defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsGithub", "clientId");
            }
        ...
        public AppFlexConsumptionAuthSettingsGithub build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsGithub();
