...
@CustomType
public final class AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentity {
    /**
    ...
    private AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentity() {}
    /**
     * @return The Client ID of the user-defined Managed Identity used for Web App Routing.
     * 
     */
    ...
    public static Builder builder(AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userAssignedIdentityId;
        public Builder() {}
        public Builder(AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentity defaults) {
        ...
        public AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentity build() {
            final var _resultValue = new AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentity();
