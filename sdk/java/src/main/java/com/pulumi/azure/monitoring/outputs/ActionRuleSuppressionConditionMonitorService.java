...
public final class ActionRuleSuppressionConditionMonitorService {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("ActionRuleSuppressionConditionMonitorService", "operator");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("ActionRuleSuppressionConditionMonitorService", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public ActionRuleSuppressionConditionMonitorService build() {
            final var _resultValue = new ActionRuleSuppressionConditionMonitorService();
