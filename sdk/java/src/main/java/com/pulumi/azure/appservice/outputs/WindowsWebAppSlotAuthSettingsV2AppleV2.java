...
public final class WindowsWebAppSlotAuthSettingsV2AppleV2 {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2AppleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsWebAppSlotAuthSettingsV2AppleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2AppleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2AppleV2", "clientSecretSettingName");
            }
        ...
        public WindowsWebAppSlotAuthSettingsV2AppleV2 build() {
            final var _resultValue = new WindowsWebAppSlotAuthSettingsV2AppleV2();
