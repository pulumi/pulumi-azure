...
public final class StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs extends com.pulumi.resources.ResourceArgs {

    public static final StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs Empty = new StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs();
    ...
    private StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs() {}

    private StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs(StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs $) {
        this.dash = $.dash;
    ...
    public static Builder builder(StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs();
        }

        public Builder(StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs defaults) {
            $ = new StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StreamingPolicyCommonEncryptionCencEnabledProtocolsArgs build() {
            return $;
        }
    }
