...
public final class TrafficManagerProfileMonitorConfigCustomHeader {
    ...
    public static Builder builder(TrafficManagerProfileMonitorConfigCustomHeader defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(TrafficManagerProfileMonitorConfigCustomHeader defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("TrafficManagerProfileMonitorConfigCustomHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("TrafficManagerProfileMonitorConfigCustomHeader", "value");
            }
            this.value = value;
            return this;
        }
