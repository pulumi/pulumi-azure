...
public final class LinuxFunctionAppAuthSettingsV2GithubV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LinuxFunctionAppAuthSettingsV2GithubV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2GithubV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2GithubV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
