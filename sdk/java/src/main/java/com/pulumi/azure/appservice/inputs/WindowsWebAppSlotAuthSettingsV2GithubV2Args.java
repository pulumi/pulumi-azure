...
public final class WindowsWebAppSlotAuthSettingsV2GithubV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsV2GithubV2Args Empty = new WindowsWebAppSlotAuthSettingsV2GithubV2Args();
    ...
    private WindowsWebAppSlotAuthSettingsV2GithubV2Args() {}

    private WindowsWebAppSlotAuthSettingsV2GithubV2Args(WindowsWebAppSlotAuthSettingsV2GithubV2Args $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2GithubV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsV2GithubV2Args();
        }

        public Builder(WindowsWebAppSlotAuthSettingsV2GithubV2Args defaults) {
            $ = new WindowsWebAppSlotAuthSettingsV2GithubV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsV2GithubV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GithubV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GithubV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
