...
package com.pulumi.azure.powerbi.inputs;
...
public final class EmbeddedState extends com.pulumi.resources.ResourceArgs {

    public static final EmbeddedState Empty = new EmbeddedState();
    ...
    private EmbeddedState(EmbeddedState $) {
    ...
    public static Builder builder(EmbeddedState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EmbeddedState defaults) {
            $ = new EmbeddedState(Objects.requireNonNull(defaults));
        }
