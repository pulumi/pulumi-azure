...
public class LinkedServiceCosmosDb extends com.pulumi.resources.CustomResource {
    ...
    private LinkedServiceCosmosDb(java.lang.String name, Output<java.lang.String> id, @Nullable LinkedServiceCosmosDbState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static LinkedServiceCosmosDb get(java.lang.String name, Output<java.lang.String> id, @Nullable LinkedServiceCosmosDbState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
