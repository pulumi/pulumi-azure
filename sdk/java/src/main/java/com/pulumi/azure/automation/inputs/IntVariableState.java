...
public final class IntVariableState extends com.pulumi.resources.ResourceArgs {

    public static final IntVariableState Empty = new IntVariableState();
    ...
    private IntVariableState() {}

    private IntVariableState(IntVariableState $) {
    ...
    public static Builder builder(IntVariableState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntVariableState();
        }

        public Builder(IntVariableState defaults) {
            $ = new IntVariableState(Objects.requireNonNull(defaults));
        }
