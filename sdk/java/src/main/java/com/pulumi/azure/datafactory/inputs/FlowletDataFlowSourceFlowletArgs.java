...
public final class FlowletDataFlowSourceFlowletArgs extends com.pulumi.resources.ResourceArgs {

    public static final FlowletDataFlowSourceFlowletArgs Empty = new FlowletDataFlowSourceFlowletArgs();
    ...
    private FlowletDataFlowSourceFlowletArgs() {}

    private FlowletDataFlowSourceFlowletArgs(FlowletDataFlowSourceFlowletArgs $) {
    ...
    public static Builder builder(FlowletDataFlowSourceFlowletArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlowletDataFlowSourceFlowletArgs();
        }

        public Builder(FlowletDataFlowSourceFlowletArgs defaults) {
            $ = new FlowletDataFlowSourceFlowletArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FlowletDataFlowSourceFlowletArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("FlowletDataFlowSourceFlowletArgs", "name");
            }
            return $;
        }
    }
