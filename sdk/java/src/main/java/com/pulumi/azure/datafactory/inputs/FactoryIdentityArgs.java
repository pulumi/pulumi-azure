...
public final class FactoryIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param identityIds Specifies a list of User Assigned Managed Identity IDs to be assigned to this Data Factory.
         * 
         * &gt; **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
         * 
         * @return builder
        ...
        /**
         * @param type Specifies the type of Managed Service Identity that should be configured on this Data Factory. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
         * 
         * @return builder
         * 
         */
        ...
        public FactoryIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("FactoryIdentityArgs", "type");
            }
            return $;
        }
    }
