...
public final class LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs Empty = new LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs();
    ...
    private LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs(LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs $) {
        this.count = $.count;
    ...
    public static Builder builder(LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs();
        }

        public Builder(LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs defaults) {
            $ = new LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs build() {
            if ($.count == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs", "count");
            }
            if ($.interval == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs", "interval");
            }
            if ($.statusCodeRange == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCodeArgs", "statusCodeRange");
            }
            return $;
        }
    }
