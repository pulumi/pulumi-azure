...
public final class WindowsWebAppAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsV2FacebookV2Args Empty = new WindowsWebAppAuthSettingsV2FacebookV2Args();
    ...
    private WindowsWebAppAuthSettingsV2FacebookV2Args() {}

    private WindowsWebAppAuthSettingsV2FacebookV2Args(WindowsWebAppAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsV2FacebookV2Args();
        }

        public Builder(WindowsWebAppAuthSettingsV2FacebookV2Args defaults) {
            $ = new WindowsWebAppAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
