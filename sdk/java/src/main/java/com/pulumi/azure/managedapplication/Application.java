 ...
 *                 .roleDefinitionId(builtin.apply(getRoleDefinitionResult -&gt; getRoleDefinitionResult.id()).split(&#34;/&#34;)[builtin.apply(getRoleDefinitionResult -&gt; getRoleDefinitionResult.id()).split(&#34;/&#34;).length() - 1])
 *                 .build())
 *             .build());
 * 
