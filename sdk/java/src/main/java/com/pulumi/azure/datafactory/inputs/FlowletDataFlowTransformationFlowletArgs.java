...
public final class FlowletDataFlowTransformationFlowletArgs extends com.pulumi.resources.ResourceArgs {

    public static final FlowletDataFlowTransformationFlowletArgs Empty = new FlowletDataFlowTransformationFlowletArgs();
    ...
    private FlowletDataFlowTransformationFlowletArgs() {}

    private FlowletDataFlowTransformationFlowletArgs(FlowletDataFlowTransformationFlowletArgs $) {
    ...
    public static Builder builder(FlowletDataFlowTransformationFlowletArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlowletDataFlowTransformationFlowletArgs();
        }

        public Builder(FlowletDataFlowTransformationFlowletArgs defaults) {
            $ = new FlowletDataFlowTransformationFlowletArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FlowletDataFlowTransformationFlowletArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("FlowletDataFlowTransformationFlowletArgs", "name");
            }
            return $;
        }
    }
