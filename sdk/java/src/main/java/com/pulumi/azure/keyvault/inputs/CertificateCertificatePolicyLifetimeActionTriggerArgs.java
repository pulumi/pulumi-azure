...
public final class CertificateCertificatePolicyLifetimeActionTriggerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CertificateCertificatePolicyLifetimeActionTriggerArgs() {}

    private CertificateCertificatePolicyLifetimeActionTriggerArgs(CertificateCertificatePolicyLifetimeActionTriggerArgs $) {
    ...
    public static Builder builder(CertificateCertificatePolicyLifetimeActionTriggerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateCertificatePolicyLifetimeActionTriggerArgs();
        }

        public Builder(CertificateCertificatePolicyLifetimeActionTriggerArgs defaults) {
            $ = new CertificateCertificatePolicyLifetimeActionTriggerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CertificateCertificatePolicyLifetimeActionTriggerArgs build() {
            return $;
        }
    }
