...
public final class EventHubNamespaceState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The minimum supported TLS version for this EventHub Namespace. The only possible value is `1.2`. Defaults to `1.2`.
     * 
     * &gt; **Note:** Azure Services will require TLS 1.2+ by August 2025, please see this [announcement](https://azure.microsoft.com/en-us/updates/v2/update-retirement-tls1-0-tls1-1-versions-azure-services/) for more.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param minimumTlsVersion The minimum supported TLS version for this EventHub Namespace. The only possible value is `1.2`. Defaults to `1.2`.
         * 
         * &gt; **Note:** Azure Services will require TLS 1.2+ by August 2025, please see this [announcement](https://azure.microsoft.com/en-us/updates/v2/update-retirement-tls1-0-tls1-1-versions-azure-services/) for more.
         * 
         * @return builder
