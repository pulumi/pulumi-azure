...
@CustomType
public final class WindowsWebAppSlotAuthSettingsV2MicrosoftV2 {
    /**
    ...
    private WindowsWebAppSlotAuthSettingsV2MicrosoftV2() {}
    /**
     * @return Specifies a list of Allowed Audiences that will be requested as part of Microsoft Sign-In authentication.
     * 
     */
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2MicrosoftV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsWebAppSlotAuthSettingsV2MicrosoftV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2MicrosoftV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2MicrosoftV2", "clientSecretSettingName");
            }
        ...
        public WindowsWebAppSlotAuthSettingsV2MicrosoftV2 build() {
            final var _resultValue = new WindowsWebAppSlotAuthSettingsV2MicrosoftV2();
