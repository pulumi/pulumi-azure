...
public final class WindowsFunctionAppAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsV2AppleV2Args Empty = new WindowsFunctionAppAuthSettingsV2AppleV2Args();
    ...
    private WindowsFunctionAppAuthSettingsV2AppleV2Args() {}

    private WindowsFunctionAppAuthSettingsV2AppleV2Args(WindowsFunctionAppAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsV2AppleV2Args();
        }

        public Builder(WindowsFunctionAppAuthSettingsV2AppleV2Args defaults) {
            $ = new WindowsFunctionAppAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsV2AppleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2AppleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2AppleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
