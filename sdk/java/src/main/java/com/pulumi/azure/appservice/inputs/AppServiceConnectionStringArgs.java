...
public final class AppServiceConnectionStringArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AppServiceConnectionStringArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("AppServiceConnectionStringArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("AppServiceConnectionStringArgs", "type");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("AppServiceConnectionStringArgs", "value");
            }
            return $;
        }
    }
