...
public class TriggerSchedule extends com.pulumi.resources.CustomResource {
     ...
     */
    public TriggerSchedule(String name) {
     ...
     */
    public static TriggerSchedule get(String name, Output<String> id, @Nullable TriggerScheduleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
