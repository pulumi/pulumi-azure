...
public final class LinuxFunctionAppSiteConfigApplicationStackDockerArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSiteConfigApplicationStackDockerArgs Empty = new LinuxFunctionAppSiteConfigApplicationStackDockerArgs();
    ...
    private LinuxFunctionAppSiteConfigApplicationStackDockerArgs() {}

    private LinuxFunctionAppSiteConfigApplicationStackDockerArgs(LinuxFunctionAppSiteConfigApplicationStackDockerArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppSiteConfigApplicationStackDockerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSiteConfigApplicationStackDockerArgs();
        }

        public Builder(LinuxFunctionAppSiteConfigApplicationStackDockerArgs defaults) {
            $ = new LinuxFunctionAppSiteConfigApplicationStackDockerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSiteConfigApplicationStackDockerArgs build() {
            if ($.imageName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSiteConfigApplicationStackDockerArgs", "imageName");
            }
            if ($.imageTag == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSiteConfigApplicationStackDockerArgs", "imageTag");
            }
            if ($.registryUrl == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSiteConfigApplicationStackDockerArgs", "registryUrl");
            }
            return $;
        }
    }
