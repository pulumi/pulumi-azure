...
public final class LinuxWebAppSlotLogsHttpLogsAzureBlobStorage {
    ...
    public static final class Builder {
        ...
        public Builder sasUrl(String sasUrl) {
            if (sasUrl == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotLogsHttpLogsAzureBlobStorage", "sasUrl");
            }
            this.sasUrl = sasUrl;
            return this;
        }
        public LinuxWebAppSlotLogsHttpLogsAzureBlobStorage build() {
            final var _resultValue = new LinuxWebAppSlotLogsHttpLogsAzureBlobStorage();
