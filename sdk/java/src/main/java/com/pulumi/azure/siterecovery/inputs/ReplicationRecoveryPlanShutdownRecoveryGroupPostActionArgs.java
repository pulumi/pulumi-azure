...
public final class ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs() {}

    private ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs(ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs $) {
    ...
    public static Builder builder(ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs();
        }

        public Builder(ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs defaults) {
        ...
        public ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs build() {
            if ($.failOverDirections == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs", "failOverDirections");
            }
            if ($.failOverTypes == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs", "failOverTypes");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanShutdownRecoveryGroupPostActionArgs", "type");
            }
            return $;
        }
    }
