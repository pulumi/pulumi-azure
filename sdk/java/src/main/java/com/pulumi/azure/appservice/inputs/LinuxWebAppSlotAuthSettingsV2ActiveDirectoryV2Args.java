...
public final class LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args Empty = new LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args();
    ...
    private LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args() {}

    private LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args(LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args();
        }

        public Builder(LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
            $ = new LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args", "clientId");
            }
            if ($.tenantAuthEndpoint == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2ActiveDirectoryV2Args", "tenantAuthEndpoint");
            }
            return $;
        }
    }
