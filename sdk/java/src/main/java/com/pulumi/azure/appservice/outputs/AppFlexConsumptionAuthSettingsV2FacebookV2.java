...
@CustomType
public final class AppFlexConsumptionAuthSettingsV2FacebookV2 {
    /**
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsV2FacebookV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsV2FacebookV2 defaults) {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2FacebookV2", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder appSecretSettingName(String appSecretSettingName) {
            if (appSecretSettingName == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsV2FacebookV2", "appSecretSettingName");
            }
        ...
        public AppFlexConsumptionAuthSettingsV2FacebookV2 build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsV2FacebookV2();
