...
public final class EnvironmentIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final EnvironmentIdentityArgs Empty = new EnvironmentIdentityArgs();
    ...
    private EnvironmentIdentityArgs() {}

    private EnvironmentIdentityArgs(EnvironmentIdentityArgs $) {
    ...
    public static Builder builder(EnvironmentIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentIdentityArgs();
        }

        public Builder(EnvironmentIdentityArgs defaults) {
            $ = new EnvironmentIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EnvironmentIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("EnvironmentIdentityArgs", "type");
            }
            return $;
        }
    }
