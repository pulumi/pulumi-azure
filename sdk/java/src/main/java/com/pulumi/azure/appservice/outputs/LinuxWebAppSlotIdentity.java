...
@CustomType
public final class LinuxWebAppSlotIdentity {
    /**
    ...
    private LinuxWebAppSlotIdentity() {}
    /**
     * @return A list of User Assigned Managed Identity IDs to be assigned to this Linux Web App Slot.
     * 
     * &gt; **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
    ...
    public static Builder builder(LinuxWebAppSlotIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(LinuxWebAppSlotIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public LinuxWebAppSlotIdentity build() {
            final var _resultValue = new LinuxWebAppSlotIdentity();
