...
public final class BudgetResourceGroupState extends com.pulumi.resources.ResourceArgs {

    public static final BudgetResourceGroupState Empty = new BudgetResourceGroupState();
    ...
    private @Nullable Output<List<BudgetResourceGroupNotificationArgs>> notifications;

    /**
     * @return One or more `notification` blocks as defined below.
     * 
     */
    public Optional<Output<List<BudgetResourceGroupNotificationArgs>>> notifications() {
    ...
    private @Nullable Output<BudgetResourceGroupTimePeriodArgs> timePeriod;

    /**
     * @return A `timePeriod` block as defined below.
     * 
     */
    public Optional<Output<BudgetResourceGroupTimePeriodArgs>> timePeriod() {
        return Optional.ofNullable(this.timePeriod);
    }

    private BudgetResourceGroupState() {}

    private BudgetResourceGroupState(BudgetResourceGroupState $) {
        this.amount = $.amount;
        this.etag = $.etag;
        this.filter = $.filter;
        this.name = $.name;
    ...
    public static Builder builder(BudgetResourceGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetResourceGroupState();
        }

        public Builder(BudgetResourceGroupState defaults) {
            $ = new BudgetResourceGroupState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder notifications(@Nullable Output<List<BudgetResourceGroupNotificationArgs>> notifications) {
         ...
         * 
         */
        public Builder timePeriod(@Nullable Output<BudgetResourceGroupTimePeriodArgs> timePeriod) {
        ...
        public BudgetResourceGroupState build() {
            return $;
        }
    }
