...
public final class WindowsWebAppAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsV2AppleV2Args Empty = new WindowsWebAppAuthSettingsV2AppleV2Args();
    ...
    private WindowsWebAppAuthSettingsV2AppleV2Args() {}

    private WindowsWebAppAuthSettingsV2AppleV2Args(WindowsWebAppAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsV2AppleV2Args();
        }

        public Builder(WindowsWebAppAuthSettingsV2AppleV2Args defaults) {
            $ = new WindowsWebAppAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsV2AppleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2AppleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2AppleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
