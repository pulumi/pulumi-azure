...
public final class GetNetworkDdosProtectionPlanArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetNetworkDdosProtectionPlanArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetNetworkDdosProtectionPlanArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetNetworkDdosProtectionPlanArgs", "resourceGroupName");
            }
            return $;
        }
    }
