...
public final class AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs Empty = new AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs();
    ...
    private AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs() {}

    private AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs(AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs $) {
    ...
    public static Builder builder(AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs();
        }

        public Builder(AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs defaults) {
            $ = new AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutomaticClusterWebAppRoutingIngressWebAppRoutingIdentityArgs build() {
            return $;
        }
    }
