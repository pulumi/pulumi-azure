...
public final class ActionRuleActionGroupConditionTargetResourceType {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionTargetResourceType", "operator");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionTargetResourceType", "values");
            }
            this.values = values;
            return this;
        }
