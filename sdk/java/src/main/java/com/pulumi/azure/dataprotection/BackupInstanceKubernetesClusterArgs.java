...
public final class BackupInstanceKubernetesClusterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BackupInstanceKubernetesClusterArgs() {}

    private BackupInstanceKubernetesClusterArgs(BackupInstanceKubernetesClusterArgs $) {
    ...
    public static Builder builder(BackupInstanceKubernetesClusterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BackupInstanceKubernetesClusterArgs();
        }

        public Builder(BackupInstanceKubernetesClusterArgs defaults) {
            $ = new BackupInstanceKubernetesClusterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BackupInstanceKubernetesClusterArgs build() {
            if ($.backupPolicyId == null) {
                throw new MissingRequiredPropertyException("BackupInstanceKubernetesClusterArgs", "backupPolicyId");
            }
            if ($.kubernetesClusterId == null) {
                throw new MissingRequiredPropertyException("BackupInstanceKubernetesClusterArgs", "kubernetesClusterId");
            }
            if ($.snapshotResourceGroupName == null) {
                throw new MissingRequiredPropertyException("BackupInstanceKubernetesClusterArgs", "snapshotResourceGroupName");
            }
            if ($.vaultId == null) {
                throw new MissingRequiredPropertyException("BackupInstanceKubernetesClusterArgs", "vaultId");
            }
            return $;
        }
    }
