...
public final class EndpointDeliveryRuleQueryStringCondition {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRuleQueryStringCondition", "operator");
            }
        ...
        public EndpointDeliveryRuleQueryStringCondition build() {
            final var _resultValue = new EndpointDeliveryRuleQueryStringCondition();
