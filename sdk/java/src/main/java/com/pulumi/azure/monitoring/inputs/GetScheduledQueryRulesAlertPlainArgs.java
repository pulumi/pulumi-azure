...
public final class GetScheduledQueryRulesAlertPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetScheduledQueryRulesAlertPlainArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetScheduledQueryRulesAlertPlainArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetScheduledQueryRulesAlertPlainArgs", "resourceGroupName");
            }
            return $;
        }
    }
