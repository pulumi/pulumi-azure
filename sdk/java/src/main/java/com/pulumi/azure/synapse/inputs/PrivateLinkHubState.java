...
public final class PrivateLinkHubState extends com.pulumi.resources.ResourceArgs {

    public static final PrivateLinkHubState Empty = new PrivateLinkHubState();
    ...
    private PrivateLinkHubState() {}

    private PrivateLinkHubState(PrivateLinkHubState $) {
    ...
    public static Builder builder(PrivateLinkHubState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PrivateLinkHubState();
        }

        public Builder(PrivateLinkHubState defaults) {
            $ = new PrivateLinkHubState(Objects.requireNonNull(defaults));
        }
        ...
        public PrivateLinkHubState build() {
            return $;
        }
    }
