...
@CustomType
public final class TopicIdentity {
    /**
    ...
    public static Builder builder(TopicIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(TopicIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("TopicIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public TopicIdentity build() {
            final var _resultValue = new TopicIdentity();
