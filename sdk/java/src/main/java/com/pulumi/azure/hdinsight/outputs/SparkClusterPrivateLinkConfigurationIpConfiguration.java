...
public final class SparkClusterPrivateLinkConfigurationIpConfiguration {
    ...
    public static Builder builder(SparkClusterPrivateLinkConfigurationIpConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetId;
        public Builder() {}
        public Builder(SparkClusterPrivateLinkConfigurationIpConfiguration defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("SparkClusterPrivateLinkConfigurationIpConfiguration", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public SparkClusterPrivateLinkConfigurationIpConfiguration build() {
            final var _resultValue = new SparkClusterPrivateLinkConfigurationIpConfiguration();
