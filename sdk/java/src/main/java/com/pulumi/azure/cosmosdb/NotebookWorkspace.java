...
public class NotebookWorkspace extends com.pulumi.resources.CustomResource {
     ...
     */
    public NotebookWorkspace(java.lang.String name) {
     ...
     */
    public NotebookWorkspace(java.lang.String name, NotebookWorkspaceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NotebookWorkspace(java.lang.String name, NotebookWorkspaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:cosmosdb/notebookWorkspace:NotebookWorkspace", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NotebookWorkspace(java.lang.String name, Output<java.lang.String> id, @Nullable NotebookWorkspaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:cosmosdb/notebookWorkspace:NotebookWorkspace", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static NotebookWorkspace get(java.lang.String name, Output<java.lang.String> id, @Nullable NotebookWorkspaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
