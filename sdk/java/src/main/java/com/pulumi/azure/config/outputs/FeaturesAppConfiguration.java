...
public final class FeaturesAppConfiguration {
    ...
    public static Builder builder(FeaturesAppConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean recoverSoftDeleted;
        public Builder() {}
        public Builder(FeaturesAppConfiguration defaults) {
