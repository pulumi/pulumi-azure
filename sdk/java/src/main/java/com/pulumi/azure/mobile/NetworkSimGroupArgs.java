...
public final class NetworkSimGroupArgs extends com.pulumi.resources.ResourceArgs {

    public static final NetworkSimGroupArgs Empty = new NetworkSimGroupArgs();
    ...
    private NetworkSimGroupArgs() {}

    private NetworkSimGroupArgs(NetworkSimGroupArgs $) {
    ...
    public static Builder builder(NetworkSimGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkSimGroupArgs();
        }

        public Builder(NetworkSimGroupArgs defaults) {
            $ = new NetworkSimGroupArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NetworkSimGroupArgs build() {
            if ($.mobileNetworkId == null) {
                throw new MissingRequiredPropertyException("NetworkSimGroupArgs", "mobileNetworkId");
            }
            return $;
        }
    }
