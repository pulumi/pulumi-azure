...
@CustomType
public final class LinuxFunctionAppAuthSettingsV2Login {
    /**
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2Login defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validateNonce;
        public Builder() {}
        public Builder(LinuxFunctionAppAuthSettingsV2Login defaults) {
        ...
        public LinuxFunctionAppAuthSettingsV2Login build() {
            final var _resultValue = new LinuxFunctionAppAuthSettingsV2Login();
