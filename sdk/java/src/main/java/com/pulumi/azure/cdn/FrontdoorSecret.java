 ...
 * 
 *         final var frontdoor = AzureadFunctions.ServicePrincipal(Map.of("displayName", "Microsoft.AzurefrontDoor-Cdn"));
 * 
 ...
 *                 .contents(StdFunctions.filebase64(Map.of("input", "my-certificate.pfx")).result())
 *                 .build())
 *             .build());
 * 
