...
public final class WindowsVirtualMachineSourceImageReference {
    ...
    public static final class Builder {
        ...
        public Builder offer(String offer) {
            if (offer == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineSourceImageReference", "offer");
            }
            this.offer = offer;
            return this;
        }
        ...
        public Builder publisher(String publisher) {
            if (publisher == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineSourceImageReference", "publisher");
            }
        ...
        public Builder sku(String sku) {
            if (sku == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineSourceImageReference", "sku");
            }
            this.sku = sku;
            return this;
        }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineSourceImageReference", "version");
            }
