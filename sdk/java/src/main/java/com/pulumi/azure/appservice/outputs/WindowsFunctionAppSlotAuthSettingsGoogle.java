...
public final class WindowsFunctionAppSlotAuthSettingsGoogle {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsGoogle", "clientId");
            }
        ...
        public WindowsFunctionAppSlotAuthSettingsGoogle build() {
            final var _resultValue = new WindowsFunctionAppSlotAuthSettingsGoogle();
