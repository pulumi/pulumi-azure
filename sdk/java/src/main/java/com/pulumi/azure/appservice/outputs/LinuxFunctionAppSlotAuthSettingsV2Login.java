...
@CustomType
public final class LinuxFunctionAppSlotAuthSettingsV2Login {
    /**
    ...
    private LinuxFunctionAppSlotAuthSettingsV2Login() {}
    /**
     * @return External URLs that can be redirected to as part of logging in or logging out of the app. This is an advanced setting typically only needed by Windows Store application backends.
     * 
     * &gt; **Note:** URLs within the current domain are always implicitly allowed.
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2Login defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validateNonce;
        public Builder() {}
        public Builder(LinuxFunctionAppSlotAuthSettingsV2Login defaults) {
        ...
        public LinuxFunctionAppSlotAuthSettingsV2Login build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsV2Login();
