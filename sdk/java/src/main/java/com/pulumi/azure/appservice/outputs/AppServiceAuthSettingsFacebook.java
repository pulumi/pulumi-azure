...
public final class AppServiceAuthSettingsFacebook {
    ...
    public static final class Builder {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("AppServiceAuthSettingsFacebook", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder appSecret(String appSecret) {
            if (appSecret == null) {
              throw new MissingRequiredPropertyException("AppServiceAuthSettingsFacebook", "appSecret");
            }
