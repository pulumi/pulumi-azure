...
public final class TopicIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final TopicIdentityArgs Empty = new TopicIdentityArgs();
    ...
    private TopicIdentityArgs() {}

    private TopicIdentityArgs(TopicIdentityArgs $) {
    ...
    public static Builder builder(TopicIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicIdentityArgs();
        }

        public Builder(TopicIdentityArgs defaults) {
            $ = new TopicIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TopicIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("TopicIdentityArgs", "type");
            }
            return $;
        }
    }
