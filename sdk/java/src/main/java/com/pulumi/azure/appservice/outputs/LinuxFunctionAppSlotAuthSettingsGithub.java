...
public final class LinuxFunctionAppSlotAuthSettingsGithub {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsGithub", "clientId");
            }
        ...
        public LinuxFunctionAppSlotAuthSettingsGithub build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsGithub();
