...
@CustomType
public final class LinuxWebAppSiteConfigIpRestrictionHeaders {
    /**
    ...
    private LinuxWebAppSiteConfigIpRestrictionHeaders(
    ...
    public static Builder builder(LinuxWebAppSiteConfigIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxWebAppSiteConfigIpRestrictionHeaders defaults) {
        ...
        }        public LinuxWebAppSiteConfigIpRestrictionHeaders build() {
            return new LinuxWebAppSiteConfigIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
