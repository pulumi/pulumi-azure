...
public final class EndpointDeliveryRulePostArgCondition {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRulePostArgCondition", "operator");
            }
        ...
        public Builder selector(String selector) {
            if (selector == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRulePostArgCondition", "selector");
            }
        ...
        public EndpointDeliveryRulePostArgCondition build() {
            final var _resultValue = new EndpointDeliveryRulePostArgCondition();
