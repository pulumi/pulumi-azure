    ...
    public static final class Builder {
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppSiteConfigCor", "allowedOrigins");
            }
        ...
        public Builder supportCredentials(Boolean supportCredentials) {
            if (supportCredentials == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppSiteConfigCor", "supportCredentials");
            }
