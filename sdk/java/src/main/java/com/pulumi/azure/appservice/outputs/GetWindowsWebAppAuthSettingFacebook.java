...
public final class GetWindowsWebAppAuthSettingFacebook {
    ...
    public static final class Builder {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingFacebook", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder appSecret(String appSecret) {
            if (appSecret == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingFacebook", "appSecret");
            }
        ...
        public Builder appSecretSettingName(String appSecretSettingName) {
            if (appSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingFacebook", "appSecretSettingName");
            }
        ...
        public Builder oauthScopes(List<String> oauthScopes) {
            if (oauthScopes == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppAuthSettingFacebook", "oauthScopes");
            }
        ...
        public GetWindowsWebAppAuthSettingFacebook build() {
            final var _resultValue = new GetWindowsWebAppAuthSettingFacebook();
