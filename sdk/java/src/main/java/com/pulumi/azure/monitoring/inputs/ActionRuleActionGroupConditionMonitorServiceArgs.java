...
public final class ActionRuleActionGroupConditionMonitorServiceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ActionRuleActionGroupConditionMonitorServiceArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionMonitorServiceArgs", "operator");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionMonitorServiceArgs", "values");
            }
            return $;
        }
    }
