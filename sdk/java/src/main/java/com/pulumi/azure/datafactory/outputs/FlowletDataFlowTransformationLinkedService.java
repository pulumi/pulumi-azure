...
@CustomType
public final class FlowletDataFlowTransformationLinkedService {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("FlowletDataFlowTransformationLinkedService", "name");
            }
            this.name = name;
            return this;
        }
