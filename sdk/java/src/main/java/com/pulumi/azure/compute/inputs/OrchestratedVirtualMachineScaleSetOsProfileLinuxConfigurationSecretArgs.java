    ...
    public static final class Builder {
        ...
        public OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecretArgs build() {
            if ($.certificates == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecretArgs", "certificates");
            }
            if ($.keyVaultId == null) {
                throw new MissingRequiredPropertyException("OrchestratedVirtualMachineScaleSetOsProfileLinuxConfigurationSecretArgs", "keyVaultId");
            }
            return $;
        }
    }
