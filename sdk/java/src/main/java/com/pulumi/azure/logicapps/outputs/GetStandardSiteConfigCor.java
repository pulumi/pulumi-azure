...
@CustomType
public final class GetStandardSiteConfigCor {
    /**
    ...
    private GetStandardSiteConfigCor() {}
    /**
     * @return A list of origins which should be able to make cross-origin calls.
     * 
     */
    ...
    public static Builder builder(GetStandardSiteConfigCor defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean supportCredentials;
        public Builder() {}
        public Builder(GetStandardSiteConfigCor defaults) {
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigCor", "allowedOrigins");
            }
        ...
        public Builder supportCredentials(Boolean supportCredentials) {
            if (supportCredentials == null) {
              throw new MissingRequiredPropertyException("GetStandardSiteConfigCor", "supportCredentials");
            }
            this.supportCredentials = supportCredentials;
            return this;
        }
        public GetStandardSiteConfigCor build() {
            final var _resultValue = new GetStandardSiteConfigCor();
