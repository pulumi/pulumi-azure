...
public final class KafkaClusterSecurityProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final KafkaClusterSecurityProfileArgs Empty = new KafkaClusterSecurityProfileArgs();
    ...
    private KafkaClusterSecurityProfileArgs() {}

    private KafkaClusterSecurityProfileArgs(KafkaClusterSecurityProfileArgs $) {
    ...
    public static Builder builder(KafkaClusterSecurityProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KafkaClusterSecurityProfileArgs();
        }

        public Builder(KafkaClusterSecurityProfileArgs defaults) {
            $ = new KafkaClusterSecurityProfileArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaClusterSecurityProfileArgs build() {
            if ($.aaddsResourceId == null) {
                throw new MissingRequiredPropertyException("KafkaClusterSecurityProfileArgs", "aaddsResourceId");
            }
            if ($.domainName == null) {
                throw new MissingRequiredPropertyException("KafkaClusterSecurityProfileArgs", "domainName");
            }
            if ($.domainUserPassword == null) {
                throw new MissingRequiredPropertyException("KafkaClusterSecurityProfileArgs", "domainUserPassword");
            }
            if ($.domainUsername == null) {
                throw new MissingRequiredPropertyException("KafkaClusterSecurityProfileArgs", "domainUsername");
            }
            if ($.ldapsUrls == null) {
                throw new MissingRequiredPropertyException("KafkaClusterSecurityProfileArgs", "ldapsUrls");
            }
            if ($.msiResourceId == null) {
                throw new MissingRequiredPropertyException("KafkaClusterSecurityProfileArgs", "msiResourceId");
            }
            return $;
        }
    }
