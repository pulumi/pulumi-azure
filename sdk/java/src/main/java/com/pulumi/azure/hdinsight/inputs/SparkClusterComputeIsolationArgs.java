...
public final class SparkClusterComputeIsolationArgs extends com.pulumi.resources.ResourceArgs {

    public static final SparkClusterComputeIsolationArgs Empty = new SparkClusterComputeIsolationArgs();
    ...
    private SparkClusterComputeIsolationArgs() {}

    private SparkClusterComputeIsolationArgs(SparkClusterComputeIsolationArgs $) {
    ...
    public static Builder builder(SparkClusterComputeIsolationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SparkClusterComputeIsolationArgs();
        }

        public Builder(SparkClusterComputeIsolationArgs defaults) {
            $ = new SparkClusterComputeIsolationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SparkClusterComputeIsolationArgs build() {
            return $;
        }
    }
