...
import com.pulumi.azure.cognitive.inputs.AccountConnectionEntraIdState;
 ...
 * 
 */
@ResourceType(type="azure:cognitive/accountConnectionEntraId:AccountConnectionEntraId")
public class AccountConnectionEntraId extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public AccountConnectionEntraId(java.lang.String name) {
        this(name, AccountConnectionEntraIdArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public AccountConnectionEntraId(java.lang.String name, AccountConnectionEntraIdArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccountConnectionEntraId(java.lang.String name, AccountConnectionEntraIdArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:cognitive/accountConnectionEntraId:AccountConnectionEntraId", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AccountConnectionEntraId(java.lang.String name, Output<java.lang.String> id, @Nullable AccountConnectionEntraIdState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:cognitive/accountConnectionEntraId:AccountConnectionEntraId", name, state, makeResourceOptions(options, id), false);
    }

    private static AccountConnectionEntraIdArgs makeArgs(AccountConnectionEntraIdArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AccountConnectionEntraIdArgs.Empty : args;
    }
     ...
     */
    public static AccountConnectionEntraId get(java.lang.String name, Output<java.lang.String> id, @Nullable AccountConnectionEntraIdState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
