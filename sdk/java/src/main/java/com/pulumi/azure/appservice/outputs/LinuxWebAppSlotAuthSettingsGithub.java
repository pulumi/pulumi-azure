...
@CustomType
public final class LinuxWebAppSlotAuthSettingsGithub {
    /**
    ...
    private LinuxWebAppSlotAuthSettingsGithub() {}
    /**
     * @return The ID of the GitHub app used for login.
     * 
     */
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsGithub defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(LinuxWebAppSlotAuthSettingsGithub defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsGithub", "clientId");
            }
        ...
        public LinuxWebAppSlotAuthSettingsGithub build() {
            final var _resultValue = new LinuxWebAppSlotAuthSettingsGithub();
