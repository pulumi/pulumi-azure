...
@CustomType
public final class AccountTablePropertiesMinuteMetrics {
    /**
    ...
    public static Builder builder(AccountTablePropertiesMinuteMetrics defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(AccountTablePropertiesMinuteMetrics defaults) {
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("AccountTablePropertiesMinuteMetrics", "version");
            }
            this.version = version;
            return this;
        }
        public AccountTablePropertiesMinuteMetrics build() {
            final var _resultValue = new AccountTablePropertiesMinuteMetrics();
