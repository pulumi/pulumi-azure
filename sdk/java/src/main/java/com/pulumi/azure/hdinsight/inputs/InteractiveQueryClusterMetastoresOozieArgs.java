...
public final class InteractiveQueryClusterMetastoresOozieArgs extends com.pulumi.resources.ResourceArgs {

    public static final InteractiveQueryClusterMetastoresOozieArgs Empty = new InteractiveQueryClusterMetastoresOozieArgs();
    ...
    private InteractiveQueryClusterMetastoresOozieArgs() {}

    private InteractiveQueryClusterMetastoresOozieArgs(InteractiveQueryClusterMetastoresOozieArgs $) {
    ...
    public static Builder builder(InteractiveQueryClusterMetastoresOozieArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InteractiveQueryClusterMetastoresOozieArgs();
        }

        public Builder(InteractiveQueryClusterMetastoresOozieArgs defaults) {
            $ = new InteractiveQueryClusterMetastoresOozieArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InteractiveQueryClusterMetastoresOozieArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterMetastoresOozieArgs", "databaseName");
            }
            if ($.password == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterMetastoresOozieArgs", "password");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterMetastoresOozieArgs", "server");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterMetastoresOozieArgs", "username");
            }
            return $;
        }
    }
