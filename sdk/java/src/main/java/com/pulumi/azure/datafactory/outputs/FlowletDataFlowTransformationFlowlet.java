...
@CustomType
public final class FlowletDataFlowTransformationFlowlet {
    /**
    ...
    private FlowletDataFlowTransformationFlowlet() {}
    /**
     * @return Specifies the reference data flow parameters from dataset.
     * 
     */
    ...
    public static Builder builder(FlowletDataFlowTransformationFlowlet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> parameters;
        public Builder() {}
        public Builder(FlowletDataFlowTransformationFlowlet defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("FlowletDataFlowTransformationFlowlet", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public FlowletDataFlowTransformationFlowlet build() {
            final var _resultValue = new FlowletDataFlowTransformationFlowlet();
