...
public final class RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs Empty = new RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs();
    ...
    private RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs() {}

    private RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs(RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs $) {
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs();
        }

        public Builder(RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs defaults) {
            $ = new RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsApproverNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
