...
public final class RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs Empty = new RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs();
    ...
    private RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs() {}

    private RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs(RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs $) {
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs();
        }

        public Builder(RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs defaults) {
            $ = new RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
