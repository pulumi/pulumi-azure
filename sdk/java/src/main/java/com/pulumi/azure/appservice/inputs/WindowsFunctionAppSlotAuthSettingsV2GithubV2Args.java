...
public final class WindowsFunctionAppSlotAuthSettingsV2GithubV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotAuthSettingsV2GithubV2Args Empty = new WindowsFunctionAppSlotAuthSettingsV2GithubV2Args();
    ...
    private WindowsFunctionAppSlotAuthSettingsV2GithubV2Args() {}

    private WindowsFunctionAppSlotAuthSettingsV2GithubV2Args(WindowsFunctionAppSlotAuthSettingsV2GithubV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2GithubV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2GithubV2Args();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2GithubV2Args defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2GithubV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2GithubV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2GithubV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2GithubV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
