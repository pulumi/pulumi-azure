...
public final class CustomDomainScmArgs extends com.pulumi.resources.ResourceArgs {

    public static final CustomDomainScmArgs Empty = new CustomDomainScmArgs();
    ...
    private CustomDomainScmArgs() {}

    private CustomDomainScmArgs(CustomDomainScmArgs $) {
    ...
    public static Builder builder(CustomDomainScmArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CustomDomainScmArgs();
        }

        public Builder(CustomDomainScmArgs defaults) {
            $ = new CustomDomainScmArgs(Objects.requireNonNull(defaults));
        }
