...
@CustomType
public final class WindowsWebAppSlotAuthSettingsV2GithubV2 {
    /**
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsWebAppSlotAuthSettingsV2GithubV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GithubV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GithubV2", "clientSecretSettingName");
            }
        ...
        public WindowsWebAppSlotAuthSettingsV2GithubV2 build() {
            final var _resultValue = new WindowsWebAppSlotAuthSettingsV2GithubV2();
