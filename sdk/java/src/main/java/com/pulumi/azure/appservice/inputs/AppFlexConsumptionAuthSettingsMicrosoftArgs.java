...
public final class AppFlexConsumptionAuthSettingsMicrosoftArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsMicrosoftArgs Empty = new AppFlexConsumptionAuthSettingsMicrosoftArgs();
    ...
    private AppFlexConsumptionAuthSettingsMicrosoftArgs() {}

    private AppFlexConsumptionAuthSettingsMicrosoftArgs(AppFlexConsumptionAuthSettingsMicrosoftArgs $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsMicrosoftArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsMicrosoftArgs();
        }

        public Builder(AppFlexConsumptionAuthSettingsMicrosoftArgs defaults) {
            $ = new AppFlexConsumptionAuthSettingsMicrosoftArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsMicrosoftArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsMicrosoftArgs", "clientId");
            }
            return $;
        }
    }
