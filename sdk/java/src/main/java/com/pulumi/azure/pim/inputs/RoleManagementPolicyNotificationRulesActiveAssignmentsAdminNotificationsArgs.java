...
public final class RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs Empty = new RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs();
    ...
    private RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs() {}

    private RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs(RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs $) {
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs();
        }

        public Builder(RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs defaults) {
            $ = new RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesActiveAssignmentsAdminNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
