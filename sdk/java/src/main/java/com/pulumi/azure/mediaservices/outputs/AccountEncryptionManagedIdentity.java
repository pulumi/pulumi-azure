...
@CustomType
public final class AccountEncryptionManagedIdentity {
    /**
    ...
    public static Builder builder(AccountEncryptionManagedIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userAssignedIdentityId;
        public Builder() {}
        public Builder(AccountEncryptionManagedIdentity defaults) {
        ...
        public AccountEncryptionManagedIdentity build() {
            final var _resultValue = new AccountEncryptionManagedIdentity();
