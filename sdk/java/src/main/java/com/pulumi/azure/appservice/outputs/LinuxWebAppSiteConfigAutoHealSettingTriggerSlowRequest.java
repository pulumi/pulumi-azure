...
public final class LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequest {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequest", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder interval(String interval) {
            if (interval == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSiteConfigAutoHealSettingTriggerSlowRequest", "interval");
            }
