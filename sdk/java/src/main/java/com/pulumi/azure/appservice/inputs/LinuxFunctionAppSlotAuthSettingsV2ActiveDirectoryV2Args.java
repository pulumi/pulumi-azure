...
public final class LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args Empty = new LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args();
    ...
    private LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args() {}

    private LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args(LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args $) {
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args", "clientId");
            }
            if ($.tenantAuthEndpoint == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2ActiveDirectoryV2Args", "tenantAuthEndpoint");
            }
            return $;
        }
    }
