...
@CustomType
public final class GroupPolicyAssignmentResourceSelectorSelector {
    ...
    public static Builder builder(GroupPolicyAssignmentResourceSelectorSelector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> notIns;
        public Builder() {}
        public Builder(GroupPolicyAssignmentResourceSelectorSelector defaults) {
        ...
        public Builder kind(String kind) {
            if (kind == null) {
              throw new MissingRequiredPropertyException("GroupPolicyAssignmentResourceSelectorSelector", "kind");
            }
            this.kind = kind;
            return this;
        }
        ...
        public GroupPolicyAssignmentResourceSelectorSelector build() {
            final var _resultValue = new GroupPolicyAssignmentResourceSelectorSelector();
