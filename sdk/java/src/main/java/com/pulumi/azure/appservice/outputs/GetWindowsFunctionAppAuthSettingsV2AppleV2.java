...
@CustomType
public final class GetWindowsFunctionAppAuthSettingsV2AppleV2 {
    /**
    ...
    private GetWindowsFunctionAppAuthSettingsV2AppleV2() {}
    /**
     * @return The OAuth 2.0 client ID that was created for the app used for authentication.
     * 
     */
    ...
    public static Builder builder(GetWindowsFunctionAppAuthSettingsV2AppleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> loginScopes;
        public Builder() {}
        public Builder(GetWindowsFunctionAppAuthSettingsV2AppleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2AppleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2AppleV2", "clientSecretSettingName");
            }
        ...
        public Builder loginScopes(List<String> loginScopes) {
            if (loginScopes == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingsV2AppleV2", "loginScopes");
            }
        ...
        public GetWindowsFunctionAppAuthSettingsV2AppleV2 build() {
            final var _resultValue = new GetWindowsFunctionAppAuthSettingsV2AppleV2();
