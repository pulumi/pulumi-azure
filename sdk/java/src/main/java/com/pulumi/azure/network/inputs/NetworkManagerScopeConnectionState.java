...
public final class NetworkManagerScopeConnectionState extends com.pulumi.resources.ResourceArgs {

    public static final NetworkManagerScopeConnectionState Empty = new NetworkManagerScopeConnectionState();
     ...
     * 
     */
    @Import(name="targetScopeId")
    private @Nullable Output<String> targetScopeId;
     ...
     * 
     */
    public Optional<Output<String>> targetScopeId() {
        return Optional.ofNullable(this.targetScopeId);
    }
    ...
    private NetworkManagerScopeConnectionState() {}

    private NetworkManagerScopeConnectionState(NetworkManagerScopeConnectionState $) {
    ...
    public static Builder builder(NetworkManagerScopeConnectionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkManagerScopeConnectionState();
        }

        public Builder(NetworkManagerScopeConnectionState defaults) {
            $ = new NetworkManagerScopeConnectionState(Objects.requireNonNull(defaults));
        }

        /**
         * @param connectionState The Connection state of the Network Manager Scope Connection.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder targetScopeId(@Nullable Output<String> targetScopeId) {
        ...
        public NetworkManagerScopeConnectionState build() {
            return $;
        }
    }
