...
@CustomType
public final class KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort {
    /**
    ...
    public static Builder builder(KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String protocol;
        public Builder() {}
        public Builder(KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort defaults) {
        ...
        public KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort build() {
            final var _resultValue = new KubernetesClusterNodePoolNodeNetworkProfileAllowedHostPort();
