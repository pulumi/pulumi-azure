...
public final class GetWorkflowIdentity {
    ...
    public static Builder builder(GetWorkflowIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetWorkflowIdentity defaults) {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("GetWorkflowIdentity", "identityIds");
            }
        ...
        public Builder principalId(String principalId) {
            if (principalId == null) {
              throw new MissingRequiredPropertyException("GetWorkflowIdentity", "principalId");
            }
        ...
        public Builder tenantId(String tenantId) {
            if (tenantId == null) {
              throw new MissingRequiredPropertyException("GetWorkflowIdentity", "tenantId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWorkflowIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public GetWorkflowIdentity build() {
            final var _resultValue = new GetWorkflowIdentity();
