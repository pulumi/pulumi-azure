...
public final class LinkedServiceOdataBasicAuthentication {
    ...
    public static final class Builder {
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("LinkedServiceOdataBasicAuthentication", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("LinkedServiceOdataBasicAuthentication", "username");
            }
            this.username = username;
            return this;
        }
        public LinkedServiceOdataBasicAuthentication build() {
            final var _resultValue = new LinkedServiceOdataBasicAuthentication();
