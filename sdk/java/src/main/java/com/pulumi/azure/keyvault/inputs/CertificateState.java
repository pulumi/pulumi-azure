...
public final class CertificateState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<CertificateCertificateAttributeArgs>> certificateAttributes;

    /**
     * @return A `certificateAttribute` block as defined below.
     * 
     */
    public Optional<Output<List<CertificateCertificateAttributeArgs>>> certificateAttributes() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder certificateAttributes(@Nullable Output<List<CertificateCertificateAttributeArgs>> certificateAttributes) {
         ...
         * 
         */
        public Builder certificateAttributes(List<CertificateCertificateAttributeArgs> certificateAttributes) {
