    ...
    public static final class Builder {
        ...
        public SparkClusterMetastoresOozieArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("SparkClusterMetastoresOozieArgs", "databaseName");
            }
            if ($.password == null) {
                throw new MissingRequiredPropertyException("SparkClusterMetastoresOozieArgs", "password");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("SparkClusterMetastoresOozieArgs", "server");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("SparkClusterMetastoresOozieArgs", "username");
            }
            return $;
        }
    }
