...
public final class ActionRuleSuppressionConditionMonitorArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ActionRuleSuppressionConditionMonitorArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("ActionRuleSuppressionConditionMonitorArgs", "operator");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("ActionRuleSuppressionConditionMonitorArgs", "values");
            }
            return $;
        }
    }
