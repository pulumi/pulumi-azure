...
import com.pulumi.azure.appservice.inputs.WindowsFunctionAppSiteConfigScmIpRestrictionHeadersArgs;
...
public final class WindowsFunctionAppSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSiteConfigScmIpRestrictionArgs Empty = new WindowsFunctionAppSiteConfigScmIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<WindowsFunctionAppSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<WindowsFunctionAppSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private WindowsFunctionAppSiteConfigScmIpRestrictionArgs() {}

    private WindowsFunctionAppSiteConfigScmIpRestrictionArgs(WindowsFunctionAppSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(WindowsFunctionAppSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSiteConfigScmIpRestrictionArgs();
        }

        public Builder(WindowsFunctionAppSiteConfigScmIpRestrictionArgs defaults) {
            $ = new WindowsFunctionAppSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<WindowsFunctionAppSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(WindowsFunctionAppSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public WindowsFunctionAppSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
