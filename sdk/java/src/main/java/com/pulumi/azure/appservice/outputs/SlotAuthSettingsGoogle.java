...
@CustomType
public final class SlotAuthSettingsGoogle {
    /**
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("SlotAuthSettingsGoogle", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("SlotAuthSettingsGoogle", "clientSecret");
            }
