    ...
    public static final class Builder {
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigCor", "allowedOrigins");
            }
        ...
        public Builder supportCredentials(Boolean supportCredentials) {
            if (supportCredentials == null) {
              throw new MissingRequiredPropertyException("GetWindowsWebAppSiteConfigCor", "supportCredentials");
            }
            this.supportCredentials = supportCredentials;
            return this;
        }
        public GetWindowsWebAppSiteConfigCor build() {
            final var _resultValue = new GetWindowsWebAppSiteConfigCor();
