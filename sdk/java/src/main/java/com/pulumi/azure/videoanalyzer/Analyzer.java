...
public class Analyzer extends com.pulumi.resources.CustomResource {
    ...
    public Analyzer(java.lang.String name, AnalyzerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:videoanalyzer/analyzer:Analyzer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Analyzer(java.lang.String name, Output<java.lang.String> id, @Nullable AnalyzerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:videoanalyzer/analyzer:Analyzer", name, state, makeResourceOptions(options, id), false);
    }
