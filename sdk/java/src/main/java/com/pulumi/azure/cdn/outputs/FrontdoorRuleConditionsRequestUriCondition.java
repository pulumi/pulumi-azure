...
@CustomType
public final class FrontdoorRuleConditionsRequestUriCondition {
    /**
    ...
    public static Builder builder(FrontdoorRuleConditionsRequestUriCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> transforms;
        public Builder() {}
        public Builder(FrontdoorRuleConditionsRequestUriCondition defaults) {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleConditionsRequestUriCondition", "operator");
            }
        ...
        public FrontdoorRuleConditionsRequestUriCondition build() {
            final var _resultValue = new FrontdoorRuleConditionsRequestUriCondition();
