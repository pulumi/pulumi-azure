...
@CustomType
public final class DatasetAzureBlobSchemaColumn {
    /**
    ...
    private DatasetAzureBlobSchemaColumn() {}
    /**
     * @return The description of the column.
     * 
     */
    ...
    public static Builder builder(DatasetAzureBlobSchemaColumn defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(DatasetAzureBlobSchemaColumn defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DatasetAzureBlobSchemaColumn", "name");
            }
            this.name = name;
            return this;
        }
