...
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigApplicationStackArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigAutoHealSettingArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigCorsArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigHandlerMappingArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigIpRestrictionArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigScmIpRestrictionArgs;
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigVirtualApplicationArgs;
...
public final class WindowsWebAppSiteConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSiteConfigArgs Empty = new WindowsWebAppSiteConfigArgs();
     ...
     */
    @Import(name="cors")
    private @Nullable Output<WindowsWebAppSiteConfigCorsArgs> cors;

    /**
     * @return A `cors` block as defined above.
     * 
     */
    public Optional<Output<WindowsWebAppSiteConfigCorsArgs>> cors() {
    ...
    private WindowsWebAppSiteConfigArgs() {}

    private WindowsWebAppSiteConfigArgs(WindowsWebAppSiteConfigArgs $) {
    ...
    public static Builder builder(WindowsWebAppSiteConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSiteConfigArgs();
        }

        public Builder(WindowsWebAppSiteConfigArgs defaults) {
            $ = new WindowsWebAppSiteConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param apiManagementApiId The API Management API ID this Windows Web App Slot is associated with.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder applicationStack(@Nullable Output<WindowsWebAppSiteConfigApplicationStackArgs> applicationStack) {
         ...
         * 
         */
        public Builder applicationStack(WindowsWebAppSiteConfigApplicationStackArgs applicationStack) {
         ...
         * 
         */
        public Builder autoHealSetting(@Nullable Output<WindowsWebAppSiteConfigAutoHealSettingArgs> autoHealSetting) {
         ...
         * 
         */
        public Builder autoHealSetting(WindowsWebAppSiteConfigAutoHealSettingArgs autoHealSetting) {
         ...
         * 
         */
        public Builder cors(@Nullable Output<WindowsWebAppSiteConfigCorsArgs> cors) {
            $.cors = cors;
            return this;
        }
         ...
         * 
         */
        public Builder cors(WindowsWebAppSiteConfigCorsArgs cors) {
        ...
        /**
         * @param ftpsState The State of FTP / FTPS service. Possible values include: `AllAllowed`, `FtpsOnly`, `Disabled`. Defaults to `Disabled`.
         * 
         * &gt; **Note:** Azure defaults this value to `AllAllowed`, however, in the interests of security Terraform will default this to `Disabled` to ensure the user makes a conscious choice to enable it.
         * 
         * @return builder
         ...
         * 
         */
        public Builder handlerMappings(@Nullable Output<List<WindowsWebAppSiteConfigHandlerMappingArgs>> handlerMappings) {
         ...
         * 
         */
        public Builder handlerMappings(List<WindowsWebAppSiteConfigHandlerMappingArgs> handlerMappings) {
         ...
         * 
         */
        public Builder handlerMappings(WindowsWebAppSiteConfigHandlerMappingArgs... handlerMappings) {
         ...
         * 
         */
        public Builder ipRestrictions(@Nullable Output<List<WindowsWebAppSiteConfigIpRestrictionArgs>> ipRestrictions) {
         ...
         * 
         */
        public Builder ipRestrictions(List<WindowsWebAppSiteConfigIpRestrictionArgs> ipRestrictions) {
         ...
         * 
         */
        public Builder ipRestrictions(WindowsWebAppSiteConfigIpRestrictionArgs... ipRestrictions) {
         ...
         * 
         */
        public Builder scmIpRestrictions(@Nullable Output<List<WindowsWebAppSiteConfigScmIpRestrictionArgs>> scmIpRestrictions) {
         ...
         * 
         */
        public Builder scmIpRestrictions(List<WindowsWebAppSiteConfigScmIpRestrictionArgs> scmIpRestrictions) {
         ...
         * 
         */
        public Builder scmIpRestrictions(WindowsWebAppSiteConfigScmIpRestrictionArgs... scmIpRestrictions) {
            return scmIpRestrictions(List.of(scmIpRestrictions));
        }

        /**
         * @param scmMinimumTlsVersion The configures the minimum version of TLS required for SSL requests to the SCM site Possible values are `1.0`, `1.1`, `1.2` and `1.3`. Defaults to `1.2`.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder virtualApplications(@Nullable Output<List<WindowsWebAppSiteConfigVirtualApplicationArgs>> virtualApplications) {
         ...
         * 
         */
        public Builder virtualApplications(List<WindowsWebAppSiteConfigVirtualApplicationArgs> virtualApplications) {
         ...
         * 
         */
        public Builder virtualApplications(WindowsWebAppSiteConfigVirtualApplicationArgs... virtualApplications) {
        ...
        /**
         * @param workerCount The number of Workers for this Windows App Service.
         * 
         * @return builder
         * 
         */
        ...
        public WindowsWebAppSiteConfigArgs build() {
            return $;
        }
    }
