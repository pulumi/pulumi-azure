...
@CustomType
public final class GetAutomaticClusterKubeConfig {
    /**
    ...
    private GetAutomaticClusterKubeConfig() {}
    /**
     * @return Base64 encoded public certificate used by clients to authenticate to the Kubernetes cluster.
     * 
     */
    ...
    public static Builder builder(GetAutomaticClusterKubeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(GetAutomaticClusterKubeConfig defaults) {
        ...
        public Builder clientCertificate(String clientCertificate) {
            if (clientCertificate == null) {
              throw new MissingRequiredPropertyException("GetAutomaticClusterKubeConfig", "clientCertificate");
            }
        ...
        public Builder clientKey(String clientKey) {
            if (clientKey == null) {
              throw new MissingRequiredPropertyException("GetAutomaticClusterKubeConfig", "clientKey");
            }
        ...
        public Builder clusterCaCertificate(String clusterCaCertificate) {
            if (clusterCaCertificate == null) {
              throw new MissingRequiredPropertyException("GetAutomaticClusterKubeConfig", "clusterCaCertificate");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetAutomaticClusterKubeConfig", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("GetAutomaticClusterKubeConfig", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetAutomaticClusterKubeConfig", "username");
            }
            this.username = username;
            return this;
        }
        public GetAutomaticClusterKubeConfig build() {
            final var _resultValue = new GetAutomaticClusterKubeConfig();
