    ...
    public static final class Builder {
        ...
        public GetRegistryScopeMapArgs build() {
            if ($.containerRegistryName == null) {
                throw new MissingRequiredPropertyException("GetRegistryScopeMapArgs", "containerRegistryName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetRegistryScopeMapArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetRegistryScopeMapArgs", "resourceGroupName");
            }
            return $;
        }
    }
