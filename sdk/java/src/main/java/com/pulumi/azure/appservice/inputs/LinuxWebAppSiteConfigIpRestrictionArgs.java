...
import com.pulumi.azure.appservice.inputs.LinuxWebAppSiteConfigIpRestrictionHeadersArgs;
...
public final class LinuxWebAppSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSiteConfigIpRestrictionArgs Empty = new LinuxWebAppSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxWebAppSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<LinuxWebAppSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxWebAppSiteConfigIpRestrictionArgs() {}

    private LinuxWebAppSiteConfigIpRestrictionArgs(LinuxWebAppSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxWebAppSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSiteConfigIpRestrictionArgs();
        }

        public Builder(LinuxWebAppSiteConfigIpRestrictionArgs defaults) {
            $ = new LinuxWebAppSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxWebAppSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxWebAppSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public LinuxWebAppSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
