...
public final class AccountTablePropertiesCorsRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountTablePropertiesCorsRuleArgs Empty = new AccountTablePropertiesCorsRuleArgs();
    ...
    /**
     * @return A list of HTTP methods that are allowed to be executed by the origin. Valid options are `DELETE`, `GET`, `HEAD`, `MERGE`, `POST`, `OPTIONS` or `PUT`.
     * 
     */
    ...
    private AccountTablePropertiesCorsRuleArgs() {}

    private AccountTablePropertiesCorsRuleArgs(AccountTablePropertiesCorsRuleArgs $) {
    ...
    public static Builder builder(AccountTablePropertiesCorsRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountTablePropertiesCorsRuleArgs();
        }

        public Builder(AccountTablePropertiesCorsRuleArgs defaults) {
            $ = new AccountTablePropertiesCorsRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param allowedMethods A list of HTTP methods that are allowed to be executed by the origin. Valid options are `DELETE`, `GET`, `HEAD`, `MERGE`, `POST`, `OPTIONS` or `PUT`.
         * 
         * @return builder
         * 
         */
        ...
        public AccountTablePropertiesCorsRuleArgs build() {
            if ($.allowedHeaders == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRuleArgs", "allowedHeaders");
            }
            if ($.allowedMethods == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRuleArgs", "allowedMethods");
            }
            if ($.allowedOrigins == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRuleArgs", "allowedOrigins");
            }
            if ($.exposedHeaders == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRuleArgs", "exposedHeaders");
            }
            if ($.maxAgeInSeconds == null) {
                throw new MissingRequiredPropertyException("AccountTablePropertiesCorsRuleArgs", "maxAgeInSeconds");
            }
            return $;
        }
    }
