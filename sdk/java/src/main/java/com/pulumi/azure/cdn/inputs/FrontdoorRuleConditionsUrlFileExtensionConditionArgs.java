...
public final class FrontdoorRuleConditionsUrlFileExtensionConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public FrontdoorRuleConditionsUrlFileExtensionConditionArgs build() {
            if ($.matchValues == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsUrlFileExtensionConditionArgs", "matchValues");
            }
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsUrlFileExtensionConditionArgs", "operator");
            }
            return $;
        }
    }
