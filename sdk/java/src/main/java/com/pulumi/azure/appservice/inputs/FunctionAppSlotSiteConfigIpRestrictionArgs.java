...
import com.pulumi.azure.appservice.inputs.FunctionAppSlotSiteConfigIpRestrictionHeadersArgs;
...
public final class FunctionAppSlotSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppSlotSiteConfigIpRestrictionArgs Empty = new FunctionAppSlotSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<FunctionAppSlotSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return The `headers` block for this specific `ipRestriction` as defined below.
     * 
     */
    public Optional<Output<FunctionAppSlotSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private FunctionAppSlotSiteConfigIpRestrictionArgs() {}

    private FunctionAppSlotSiteConfigIpRestrictionArgs(FunctionAppSlotSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(FunctionAppSlotSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppSlotSiteConfigIpRestrictionArgs();
        }

        public Builder(FunctionAppSlotSiteConfigIpRestrictionArgs defaults) {
            $ = new FunctionAppSlotSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<FunctionAppSlotSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(FunctionAppSlotSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public FunctionAppSlotSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
