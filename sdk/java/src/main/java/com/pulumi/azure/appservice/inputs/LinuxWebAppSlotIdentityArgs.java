...
public final class LinuxWebAppSlotIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotIdentityArgs Empty = new LinuxWebAppSlotIdentityArgs();
    ...
    /**
     * @return A list of User Assigned Managed Identity IDs to be assigned to this Linux Web App Slot.
     * 
     * &gt; **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
     * 
     */
    ...
    private LinuxWebAppSlotIdentityArgs() {}

    private LinuxWebAppSlotIdentityArgs(LinuxWebAppSlotIdentityArgs $) {
    ...
    public static Builder builder(LinuxWebAppSlotIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotIdentityArgs();
        }

        public Builder(LinuxWebAppSlotIdentityArgs defaults) {
            $ = new LinuxWebAppSlotIdentityArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param identityIds A list of User Assigned Managed Identity IDs to be assigned to this Linux Web App Slot.
         * 
         * &gt; **Note:** This is required when `type` is set to `UserAssigned` or `SystemAssigned, UserAssigned`.
         * 
         * @return builder
        ...
        public LinuxWebAppSlotIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotIdentityArgs", "type");
            }
            return $;
        }
    }
