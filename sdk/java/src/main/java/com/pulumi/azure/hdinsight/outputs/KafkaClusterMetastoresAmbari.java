    ...
    public static final class Builder {
        ...
        public Builder databaseName(String databaseName) {
            if (databaseName == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresAmbari", "databaseName");
            }
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresAmbari", "password");
            }
        ...
        public Builder server(String server) {
            if (server == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresAmbari", "server");
            }
            this.server = server;
            return this;
        }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("KafkaClusterMetastoresAmbari", "username");
            }
            this.username = username;
            return this;
        }
        public KafkaClusterMetastoresAmbari build() {
            final var _resultValue = new KafkaClusterMetastoresAmbari();
