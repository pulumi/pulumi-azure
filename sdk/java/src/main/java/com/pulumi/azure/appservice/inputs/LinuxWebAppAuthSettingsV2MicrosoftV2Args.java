...
public final class LinuxWebAppAuthSettingsV2MicrosoftV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsV2MicrosoftV2Args Empty = new LinuxWebAppAuthSettingsV2MicrosoftV2Args();
    ...
    private LinuxWebAppAuthSettingsV2MicrosoftV2Args() {}

    private LinuxWebAppAuthSettingsV2MicrosoftV2Args(LinuxWebAppAuthSettingsV2MicrosoftV2Args $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2MicrosoftV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsV2MicrosoftV2Args();
        }

        public Builder(LinuxWebAppAuthSettingsV2MicrosoftV2Args defaults) {
            $ = new LinuxWebAppAuthSettingsV2MicrosoftV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsV2MicrosoftV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2MicrosoftV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2MicrosoftV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
