...
public final class ResourcePolicyAssignmentNonComplianceMessageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ResourcePolicyAssignmentNonComplianceMessageArgs() {}

    private ResourcePolicyAssignmentNonComplianceMessageArgs(ResourcePolicyAssignmentNonComplianceMessageArgs $) {
    ...
    public static Builder builder(ResourcePolicyAssignmentNonComplianceMessageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ResourcePolicyAssignmentNonComplianceMessageArgs();
        }

        public Builder(ResourcePolicyAssignmentNonComplianceMessageArgs defaults) {
            $ = new ResourcePolicyAssignmentNonComplianceMessageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ResourcePolicyAssignmentNonComplianceMessageArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("ResourcePolicyAssignmentNonComplianceMessageArgs", "content");
            }
            return $;
        }
    }
