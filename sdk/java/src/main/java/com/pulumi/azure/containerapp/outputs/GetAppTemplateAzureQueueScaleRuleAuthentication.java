...
public final class GetAppTemplateAzureQueueScaleRuleAuthentication {
    ...
    public static final class Builder {
        ...
        public Builder secretName(String secretName) {
            if (secretName == null) {
              throw new MissingRequiredPropertyException("GetAppTemplateAzureQueueScaleRuleAuthentication", "secretName");
            }
        ...
        public Builder triggerParameter(String triggerParameter) {
            if (triggerParameter == null) {
              throw new MissingRequiredPropertyException("GetAppTemplateAzureQueueScaleRuleAuthentication", "triggerParameter");
            }
