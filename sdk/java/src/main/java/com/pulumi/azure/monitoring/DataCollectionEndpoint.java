...
public class DataCollectionEndpoint extends com.pulumi.resources.CustomResource {
    ...
    public DataCollectionEndpoint(String name, DataCollectionEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:monitoring/dataCollectionEndpoint:DataCollectionEndpoint", name, args == null ? DataCollectionEndpointArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DataCollectionEndpoint(String name, Output<String> id, @Nullable DataCollectionEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:monitoring/dataCollectionEndpoint:DataCollectionEndpoint", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DataCollectionEndpoint get(String name, Output<String> id, @Nullable DataCollectionEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
