...
public final class LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs() {}

    private LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs(LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs $) {
    ...
    public static Builder builder(LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs();
        }

        public Builder(LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs defaults) {
            $ = new LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxVirtualMachineScaleSetAdditionalCapabilitiesArgs build() {
            return $;
        }
    }
