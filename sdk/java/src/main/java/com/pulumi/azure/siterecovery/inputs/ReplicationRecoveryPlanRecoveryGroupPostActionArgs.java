...
public final class ReplicationRecoveryPlanRecoveryGroupPostActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReplicationRecoveryPlanRecoveryGroupPostActionArgs Empty = new ReplicationRecoveryPlanRecoveryGroupPostActionArgs();
    ...
    private ReplicationRecoveryPlanRecoveryGroupPostActionArgs() {}

    private ReplicationRecoveryPlanRecoveryGroupPostActionArgs(ReplicationRecoveryPlanRecoveryGroupPostActionArgs $) {
    ...
    public static Builder builder(ReplicationRecoveryPlanRecoveryGroupPostActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReplicationRecoveryPlanRecoveryGroupPostActionArgs();
        }

        public Builder(ReplicationRecoveryPlanRecoveryGroupPostActionArgs defaults) {
            $ = new ReplicationRecoveryPlanRecoveryGroupPostActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReplicationRecoveryPlanRecoveryGroupPostActionArgs build() {
            if ($.failOverDirections == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostActionArgs", "failOverDirections");
            }
            if ($.failOverTypes == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostActionArgs", "failOverTypes");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostActionArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostActionArgs", "type");
            }
            return $;
        }
    }
