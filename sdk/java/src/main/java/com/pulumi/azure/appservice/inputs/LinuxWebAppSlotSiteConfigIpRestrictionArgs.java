...
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotSiteConfigIpRestrictionHeadersArgs;
...
public final class LinuxWebAppSlotSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotSiteConfigIpRestrictionArgs Empty = new LinuxWebAppSlotSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxWebAppSlotSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<LinuxWebAppSlotSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxWebAppSlotSiteConfigIpRestrictionArgs() {}

    private LinuxWebAppSlotSiteConfigIpRestrictionArgs(LinuxWebAppSlotSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxWebAppSlotSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotSiteConfigIpRestrictionArgs();
        }

        public Builder(LinuxWebAppSlotSiteConfigIpRestrictionArgs defaults) {
            $ = new LinuxWebAppSlotSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxWebAppSlotSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxWebAppSlotSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public LinuxWebAppSlotSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
