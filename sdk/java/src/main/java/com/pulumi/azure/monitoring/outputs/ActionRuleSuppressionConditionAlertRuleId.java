...
@CustomType
public final class ActionRuleSuppressionConditionAlertRuleId {
    /**
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("ActionRuleSuppressionConditionAlertRuleId", "operator");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("ActionRuleSuppressionConditionAlertRuleId", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public ActionRuleSuppressionConditionAlertRuleId build() {
            final var _resultValue = new ActionRuleSuppressionConditionAlertRuleId();
