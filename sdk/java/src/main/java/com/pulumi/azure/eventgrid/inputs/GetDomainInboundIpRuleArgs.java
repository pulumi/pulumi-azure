...
public final class GetDomainInboundIpRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetDomainInboundIpRuleArgs Empty = new GetDomainInboundIpRuleArgs();
    ...
    private GetDomainInboundIpRuleArgs() {}

    private GetDomainInboundIpRuleArgs(GetDomainInboundIpRuleArgs $) {
        this.action = $.action;
        this.ipMask = $.ipMask;
    }
    ...
    public static Builder builder(GetDomainInboundIpRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainInboundIpRuleArgs();
        }

        public Builder(GetDomainInboundIpRuleArgs defaults) {
            $ = new GetDomainInboundIpRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDomainInboundIpRuleArgs build() {
