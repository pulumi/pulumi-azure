...
public final class ManagedHardwareSecurityModuleKeyState extends com.pulumi.resources.ResourceArgs {

    public static final ManagedHardwareSecurityModuleKeyState Empty = new ManagedHardwareSecurityModuleKeyState();
     ...
     * 
     */
    @Import(name="versionedId")
    private @Nullable Output<String> versionedId;

    /**
     * @return The versioned Key Vault Secret Managed Hardware Security Module Key ID.
     * 
     */
    public Optional<Output<String>> versionedId() {
        return Optional.ofNullable(this.versionedId);
    }

    private ManagedHardwareSecurityModuleKeyState() {}

    private ManagedHardwareSecurityModuleKeyState(ManagedHardwareSecurityModuleKeyState $) {
        this.curve = $.curve;
    ...
    public static Builder builder(ManagedHardwareSecurityModuleKeyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedHardwareSecurityModuleKeyState();
        }

        public Builder(ManagedHardwareSecurityModuleKeyState defaults) {
            $ = new ManagedHardwareSecurityModuleKeyState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param versionedId The versioned Key Vault Secret Managed Hardware Security Module Key ID.
         * 
         * @return builder
         * 
         */
        public Builder versionedId(@Nullable Output<String> versionedId) {
        ...
        public Builder versionedId(String versionedId) {
            return versionedId(Output.of(versionedId));
        }

        public ManagedHardwareSecurityModuleKeyState build() {
            return $;
        }
    }
