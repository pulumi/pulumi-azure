...
public final class WindowsWebAppSlotSiteConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param minimumTlsVersion The configures the minimum version of TLS required for SSL requests. Possible values are `1.1`, `1.3`, `1.2` and `1.0`. Defaults to `1.2`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param scmMinimumTlsVersion The configures the minimum version of TLS required for SSL requests to the SCM site Possible values are `1.1`, `1.3`, `1.2` and `1.0`. Defaults to `1.2`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param scmUseMainIpRestriction Should the Windows Web App Slot `ipRestriction` configuration be used for the SCM also.
         * 
         * @return builder
         * 
         */
