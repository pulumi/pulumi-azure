    ...
    public static final class Builder {
        ...
        public Builder authorisationEndpoint(String authorisationEndpoint) {
            if (authorisationEndpoint == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "authorisationEndpoint");
            }
        ...
        public Builder certificationUri(String certificationUri) {
            if (certificationUri == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "certificationUri");
            }
        ...
        public Builder clientCredentialMethod(String clientCredentialMethod) {
            if (clientCredentialMethod == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "clientCredentialMethod");
            }
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "clientSecretSettingName");
            }
        ...
        public Builder issuerEndpoint(String issuerEndpoint) {
            if (issuerEndpoint == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "issuerEndpoint");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder nameClaimType(String nameClaimType) {
            if (nameClaimType == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "nameClaimType");
            }
        ...
        public Builder openidConfigurationEndpoint(String openidConfigurationEndpoint) {
            if (openidConfigurationEndpoint == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "openidConfigurationEndpoint");
            }
        ...
        public Builder scopes(List<String> scopes) {
            if (scopes == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "scopes");
            }
            this.scopes = scopes;
            return this;
        }
        ...
        public Builder tokenEndpoint(String tokenEndpoint) {
            if (tokenEndpoint == null) {
              throw new MissingRequiredPropertyException("GetLinuxFunctionAppAuthSettingsV2CustomOidcV2", "tokenEndpoint");
            }
