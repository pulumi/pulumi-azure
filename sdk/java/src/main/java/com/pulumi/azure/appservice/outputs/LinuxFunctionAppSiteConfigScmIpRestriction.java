...
import com.pulumi.azure.appservice.outputs.LinuxFunctionAppSiteConfigScmIpRestrictionHeaders;
...
@CustomType
public final class LinuxFunctionAppSiteConfigScmIpRestriction {
    /**
     ...
     * 
     */
    public Optional<LinuxFunctionAppSiteConfigScmIpRestrictionHeaders> headers() {
    ...
    public static final class Builder {
        ...
        public LinuxFunctionAppSiteConfigScmIpRestriction build() {
            final var _resultValue = new LinuxFunctionAppSiteConfigScmIpRestriction();
