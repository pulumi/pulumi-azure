...
public final class DatasetBlobStorageState extends com.pulumi.resources.ResourceArgs {

    public static final DatasetBlobStorageState Empty = new DatasetBlobStorageState();
     ...
     * 
     */
    @Import(name="dataShareId")
    private @Nullable Output<String> dataShareId;
     ...
     * 
     */
    public Optional<Output<String>> dataShareId() {
        return Optional.ofNullable(this.dataShareId);
    }
    ...
    private @Nullable Output<DatasetBlobStorageStorageAccountArgs> storageAccount;

    /**
     * @return A `storageAccount` block as defined below. Changing this forces a new resource to be created.
     * 
     */
    public Optional<Output<DatasetBlobStorageStorageAccountArgs>> storageAccount() {
        return Optional.ofNullable(this.storageAccount);
    }

    private DatasetBlobStorageState() {}

    private DatasetBlobStorageState(DatasetBlobStorageState $) {
    ...
    public static Builder builder(DatasetBlobStorageState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetBlobStorageState();
        }

        public Builder(DatasetBlobStorageState defaults) {
            $ = new DatasetBlobStorageState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dataShareId(@Nullable Output<String> dataShareId) {
         ...
         * 
         */
        public Builder storageAccount(@Nullable Output<DatasetBlobStorageStorageAccountArgs> storageAccount) {
        ...
        public DatasetBlobStorageState build() {
            return $;
        }
    }
