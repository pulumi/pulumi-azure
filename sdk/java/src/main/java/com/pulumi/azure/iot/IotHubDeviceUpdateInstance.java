...
public class IotHubDeviceUpdateInstance extends com.pulumi.resources.CustomResource {
    ...
    public IotHubDeviceUpdateInstance(String name, IotHubDeviceUpdateInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/iotHubDeviceUpdateInstance:IotHubDeviceUpdateInstance", name, args == null ? IotHubDeviceUpdateInstanceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
