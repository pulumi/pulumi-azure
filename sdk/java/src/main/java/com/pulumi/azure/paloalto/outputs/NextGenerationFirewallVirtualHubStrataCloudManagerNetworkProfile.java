...
@CustomType
public final class NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile {
    /**
    ...
    public static Builder builder(NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile defaults) {
    ...
    public static final class Builder {
        ...
        private String virtualHubId;
        public Builder() {}
        public Builder(NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile defaults) {
        ...
        public Builder networkVirtualApplianceId(String networkVirtualApplianceId) {
            if (networkVirtualApplianceId == null) {
              throw new MissingRequiredPropertyException("NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile", "networkVirtualApplianceId");
            }
        ...
        public Builder publicIpAddressIds(List<String> publicIpAddressIds) {
            if (publicIpAddressIds == null) {
              throw new MissingRequiredPropertyException("NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile", "publicIpAddressIds");
            }
        ...
        public Builder virtualHubId(String virtualHubId) {
            if (virtualHubId == null) {
              throw new MissingRequiredPropertyException("NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile", "virtualHubId");
            }
            this.virtualHubId = virtualHubId;
            return this;
        }
        public NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile build() {
            final var _resultValue = new NextGenerationFirewallVirtualHubStrataCloudManagerNetworkProfile();
