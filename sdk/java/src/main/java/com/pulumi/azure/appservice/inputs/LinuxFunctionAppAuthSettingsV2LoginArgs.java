...
public final class LinuxFunctionAppAuthSettingsV2LoginArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsV2LoginArgs Empty = new LinuxFunctionAppAuthSettingsV2LoginArgs();
    ...
    private LinuxFunctionAppAuthSettingsV2LoginArgs() {}

    private LinuxFunctionAppAuthSettingsV2LoginArgs(LinuxFunctionAppAuthSettingsV2LoginArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2LoginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsV2LoginArgs();
        }

        public Builder(LinuxFunctionAppAuthSettingsV2LoginArgs defaults) {
            $ = new LinuxFunctionAppAuthSettingsV2LoginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsV2LoginArgs build() {
            return $;
        }
    }
