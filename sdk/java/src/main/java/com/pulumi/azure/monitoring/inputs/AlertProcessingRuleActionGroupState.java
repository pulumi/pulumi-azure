...
public final class AlertProcessingRuleActionGroupState extends com.pulumi.resources.ResourceArgs {

    public static final AlertProcessingRuleActionGroupState Empty = new AlertProcessingRuleActionGroupState();

    /**
     * Specifies a list of Action Group IDs.
     * 
     */
    @Import(name="addActionGroupIds")
    private @Nullable Output<List<String>> addActionGroupIds;

    /**
     * @return Specifies a list of Action Group IDs.
     * 
     */
    public Optional<Output<List<String>>> addActionGroupIds() {
        return Optional.ofNullable(this.addActionGroupIds);
    }
    ...
    private @Nullable Output<AlertProcessingRuleActionGroupConditionArgs> condition;

    /**
     * @return A `condition` block as defined below.
     * 
     */
    public Optional<Output<AlertProcessingRuleActionGroupConditionArgs>> condition() {
    ...
    private @Nullable Output<AlertProcessingRuleActionGroupScheduleArgs> schedule;

    /**
     * @return A `schedule` block as defined below.
     * 
     */
    public Optional<Output<AlertProcessingRuleActionGroupScheduleArgs>> schedule() {
    ...
    private AlertProcessingRuleActionGroupState() {}

    private AlertProcessingRuleActionGroupState(AlertProcessingRuleActionGroupState $) {
        this.addActionGroupIds = $.addActionGroupIds;
    ...
    public static Builder builder(AlertProcessingRuleActionGroupState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertProcessingRuleActionGroupState();
        }

        public Builder(AlertProcessingRuleActionGroupState defaults) {
            $ = new AlertProcessingRuleActionGroupState(Objects.requireNonNull(defaults));
        }

        /**
         * @param addActionGroupIds Specifies a list of Action Group IDs.
         * 
         * @return builder
         * 
         */
        public Builder addActionGroupIds(@Nullable Output<List<String>> addActionGroupIds) {
         ...
         * 
         */
        public Builder addActionGroupIds(List<String> addActionGroupIds) {
            return addActionGroupIds(Output.of(addActionGroupIds));
        }
         ...
         * 
         */
        public Builder addActionGroupIds(String... addActionGroupIds) {
            return addActionGroupIds(List.of(addActionGroupIds));
        }
         ...
         * 
         */
        public Builder condition(@Nullable Output<AlertProcessingRuleActionGroupConditionArgs> condition) {
            $.condition = condition;
            return this;
        }
         ...
         * 
         */
        public Builder condition(AlertProcessingRuleActionGroupConditionArgs condition) {
         ...
         * 
         */
        public Builder schedule(@Nullable Output<AlertProcessingRuleActionGroupScheduleArgs> schedule) {
            $.schedule = schedule;
            return this;
        }
         ...
         * 
         */
        public Builder schedule(AlertProcessingRuleActionGroupScheduleArgs schedule) {
        ...
        public AlertProcessingRuleActionGroupState build() {
            return $;
        }
    }
