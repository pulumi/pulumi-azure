...
public final class SparkClusterRolesZookeeperNodeScriptAction {
    ...
    public static Builder builder(SparkClusterRolesZookeeperNodeScriptAction defaults) {
    ...
    public static final class Builder {
        ...
        private String uri;
        public Builder() {}
        public Builder(SparkClusterRolesZookeeperNodeScriptAction defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("SparkClusterRolesZookeeperNodeScriptAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("SparkClusterRolesZookeeperNodeScriptAction", "uri");
            }
            this.uri = uri;
            return this;
        }
