...
public final class ScalingPlanState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ScalingPlanScheduleArgs>> schedules;

    /**
     * @return One or more `schedule` blocks as defined below.
     * 
     */
    public Optional<Output<List<ScalingPlanScheduleArgs>>> schedules() {
    ...
    public static final class Builder {
        ...
        /**
         * @param hostPools One or more `host_pool` blocks as defined below.`host_pool` - (Optional) One or more `host_pool` blocks as defined below.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder schedules(@Nullable Output<List<ScalingPlanScheduleArgs>> schedules) {
            $.schedules = schedules;
            return this;
        }
