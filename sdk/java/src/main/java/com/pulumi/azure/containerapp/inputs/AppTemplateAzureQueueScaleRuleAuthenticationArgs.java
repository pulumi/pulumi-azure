...
public final class AppTemplateAzureQueueScaleRuleAuthenticationArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppTemplateAzureQueueScaleRuleAuthenticationArgs Empty = new AppTemplateAzureQueueScaleRuleAuthenticationArgs();
    ...
    private AppTemplateAzureQueueScaleRuleAuthenticationArgs() {}

    private AppTemplateAzureQueueScaleRuleAuthenticationArgs(AppTemplateAzureQueueScaleRuleAuthenticationArgs $) {
    ...
    public static Builder builder(AppTemplateAzureQueueScaleRuleAuthenticationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppTemplateAzureQueueScaleRuleAuthenticationArgs();
        }

        public Builder(AppTemplateAzureQueueScaleRuleAuthenticationArgs defaults) {
            $ = new AppTemplateAzureQueueScaleRuleAuthenticationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppTemplateAzureQueueScaleRuleAuthenticationArgs build() {
            if ($.secretName == null) {
                throw new MissingRequiredPropertyException("AppTemplateAzureQueueScaleRuleAuthenticationArgs", "secretName");
            }
            if ($.triggerParameter == null) {
                throw new MissingRequiredPropertyException("AppTemplateAzureQueueScaleRuleAuthenticationArgs", "triggerParameter");
            }
            return $;
        }
    }
