...
@CustomType
public final class FunctionAppAuthSettingsMicrosoft {
    /**
    ...
    public static Builder builder(FunctionAppAuthSettingsMicrosoft defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(FunctionAppAuthSettingsMicrosoft defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("FunctionAppAuthSettingsMicrosoft", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("FunctionAppAuthSettingsMicrosoft", "clientSecret");
            }
        ...
        public FunctionAppAuthSettingsMicrosoft build() {
            final var _resultValue = new FunctionAppAuthSettingsMicrosoft();
