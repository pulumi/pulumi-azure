 ...
 * 
 */
@ResourceType(type="azure:arc/resourceBridgeAppliance:ResourceBridgeAppliance")
public class ResourceBridgeAppliance extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    public Output<ResourceBridgeApplianceIdentity> identity() {
    ...
    public Output<Optional<String>> publicKeyBase64() {
        return Codegen.optional(this.publicKeyBase64);
    }
    /**
    ...
    public ResourceBridgeAppliance(String name, ResourceBridgeApplianceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:arc/resourceBridgeAppliance:ResourceBridgeAppliance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
