...
public final class LinuxWebAppSlotAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppSlotAuthSettingsV2AppleV2Args Empty = new LinuxWebAppSlotAuthSettingsV2AppleV2Args();
    ...
    private LinuxWebAppSlotAuthSettingsV2AppleV2Args() {}

    private LinuxWebAppSlotAuthSettingsV2AppleV2Args(LinuxWebAppSlotAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotAuthSettingsV2AppleV2Args();
        }

        public Builder(LinuxWebAppSlotAuthSettingsV2AppleV2Args defaults) {
            $ = new LinuxWebAppSlotAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppSlotAuthSettingsV2AppleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2AppleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2AppleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
