...
public final class ServerIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param identityIds Specifies a list of User Assigned Managed Identity IDs to be assigned to this Fluid Relay Service.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param principalId The Principal ID for the Service Principal associated with the Identity of this Fluid Relay Server.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tenantId The Tenant ID for the Service Principal associated with the Identity of this Fluid Relay Server.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param type Specifies the type of Managed Service Identity that should be configured on this Fluid Relay Service. Possible values are `SystemAssigned`,`UserAssigned` and `SystemAssigned, UserAssigned`.
         * 
         * @return builder
         * 
         */
