...
public final class WindowsWebAppAuthSettingsV2MicrosoftV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppAuthSettingsV2MicrosoftV2Args Empty = new WindowsWebAppAuthSettingsV2MicrosoftV2Args();
    ...
    private WindowsWebAppAuthSettingsV2MicrosoftV2Args() {}

    private WindowsWebAppAuthSettingsV2MicrosoftV2Args(WindowsWebAppAuthSettingsV2MicrosoftV2Args $) {
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2MicrosoftV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppAuthSettingsV2MicrosoftV2Args();
        }

        public Builder(WindowsWebAppAuthSettingsV2MicrosoftV2Args defaults) {
            $ = new WindowsWebAppAuthSettingsV2MicrosoftV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppAuthSettingsV2MicrosoftV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2MicrosoftV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2MicrosoftV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
