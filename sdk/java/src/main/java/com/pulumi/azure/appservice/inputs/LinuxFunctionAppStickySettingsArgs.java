...
public final class LinuxFunctionAppStickySettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppStickySettingsArgs Empty = new LinuxFunctionAppStickySettingsArgs();
    ...
    private LinuxFunctionAppStickySettingsArgs() {}

    private LinuxFunctionAppStickySettingsArgs(LinuxFunctionAppStickySettingsArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppStickySettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppStickySettingsArgs();
        }

        public Builder(LinuxFunctionAppStickySettingsArgs defaults) {
            $ = new LinuxFunctionAppStickySettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppStickySettingsArgs build() {
            return $;
        }
    }
