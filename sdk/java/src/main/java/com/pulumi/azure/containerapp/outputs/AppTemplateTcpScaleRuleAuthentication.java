...
public final class AppTemplateTcpScaleRuleAuthentication {
    ...
    public static final class Builder {
        ...
        public Builder secretName(String secretName) {
            if (secretName == null) {
              throw new MissingRequiredPropertyException("AppTemplateTcpScaleRuleAuthentication", "secretName");
            }
        ...
        public AppTemplateTcpScaleRuleAuthentication build() {
            final var _resultValue = new AppTemplateTcpScaleRuleAuthentication();
