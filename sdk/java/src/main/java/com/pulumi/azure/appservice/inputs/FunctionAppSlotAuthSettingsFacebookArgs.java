...
public final class FunctionAppSlotAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppSlotAuthSettingsFacebookArgs Empty = new FunctionAppSlotAuthSettingsFacebookArgs();
    ...
    private FunctionAppSlotAuthSettingsFacebookArgs() {}

    private FunctionAppSlotAuthSettingsFacebookArgs(FunctionAppSlotAuthSettingsFacebookArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(FunctionAppSlotAuthSettingsFacebookArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppSlotAuthSettingsFacebookArgs();
        }

        public Builder(FunctionAppSlotAuthSettingsFacebookArgs defaults) {
            $ = new FunctionAppSlotAuthSettingsFacebookArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FunctionAppSlotAuthSettingsFacebookArgs build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("FunctionAppSlotAuthSettingsFacebookArgs", "appId");
            }
            if ($.appSecret == null) {
                throw new MissingRequiredPropertyException("FunctionAppSlotAuthSettingsFacebookArgs", "appSecret");
            }
            return $;
        }
    }
