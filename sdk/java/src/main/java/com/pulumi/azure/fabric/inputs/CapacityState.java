...
public final class CapacityState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="sku")
    private @Nullable Output<CapacitySkuArgs> sku;

    /**
     * @return A `sku` block as defined below.
     * 
     */
    public Optional<Output<CapacitySkuArgs>> sku() {
    ...
    public static Builder builder(CapacityState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CapacityState defaults) {
            $ = new CapacityState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder sku(@Nullable Output<CapacitySkuArgs> sku) {
            $.sku = sku;
            return this;
        }
