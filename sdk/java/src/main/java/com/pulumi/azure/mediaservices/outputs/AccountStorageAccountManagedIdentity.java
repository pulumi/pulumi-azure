...
@CustomType
public final class AccountStorageAccountManagedIdentity {
    /**
    ...
    public static Builder builder(AccountStorageAccountManagedIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userAssignedIdentityId;
        public Builder() {}
        public Builder(AccountStorageAccountManagedIdentity defaults) {
        ...
        public AccountStorageAccountManagedIdentity build() {
            final var _resultValue = new AccountStorageAccountManagedIdentity();
