...
@CustomType
public final class ResourcePolicyAssignmentNonComplianceMessage {
    /**
    ...
    private ResourcePolicyAssignmentNonComplianceMessage() {}
    /**
     * @return The non-compliance message text. When assigning policy sets (initiatives), unless `policyDefinitionReferenceId` is specified then this message will be the default for all policies.
     * 
     */
    ...
    public static Builder builder(ResourcePolicyAssignmentNonComplianceMessage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String policyDefinitionReferenceId;
        public Builder() {}
        public Builder(ResourcePolicyAssignmentNonComplianceMessage defaults) {
        ...
        public Builder content(String content) {
            if (content == null) {
              throw new MissingRequiredPropertyException("ResourcePolicyAssignmentNonComplianceMessage", "content");
            }
