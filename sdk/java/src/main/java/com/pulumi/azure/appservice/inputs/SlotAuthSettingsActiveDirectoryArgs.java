...
public final class SlotAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final SlotAuthSettingsActiveDirectoryArgs Empty = new SlotAuthSettingsActiveDirectoryArgs();
    ...
    private SlotAuthSettingsActiveDirectoryArgs() {}

    private SlotAuthSettingsActiveDirectoryArgs(SlotAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(SlotAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SlotAuthSettingsActiveDirectoryArgs();
        }

        public Builder(SlotAuthSettingsActiveDirectoryArgs defaults) {
            $ = new SlotAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SlotAuthSettingsActiveDirectoryArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("SlotAuthSettingsActiveDirectoryArgs", "clientId");
            }
            return $;
        }
    }
