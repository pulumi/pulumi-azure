...
public final class WindowsFunctionAppAuthSettingsGoogle {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsGoogle", "clientId");
            }
        ...
        public WindowsFunctionAppAuthSettingsGoogle build() {
            final var _resultValue = new WindowsFunctionAppAuthSettingsGoogle();
