...
public final class WindowsFunctionAppSlotAuthSettingsV2LoginArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppSlotAuthSettingsV2LoginArgs Empty = new WindowsFunctionAppSlotAuthSettingsV2LoginArgs();
    ...
    private WindowsFunctionAppSlotAuthSettingsV2LoginArgs() {}

    private WindowsFunctionAppSlotAuthSettingsV2LoginArgs(WindowsFunctionAppSlotAuthSettingsV2LoginArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2LoginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2LoginArgs();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2LoginArgs defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2LoginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2LoginArgs build() {
            return $;
        }
    }
