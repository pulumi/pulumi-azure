...
public final class WindowsWebAppSlotAuthSettingsV2GoogleV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsV2GoogleV2Args Empty = new WindowsWebAppSlotAuthSettingsV2GoogleV2Args();
    ...
    private WindowsWebAppSlotAuthSettingsV2GoogleV2Args() {}

    private WindowsWebAppSlotAuthSettingsV2GoogleV2Args(WindowsWebAppSlotAuthSettingsV2GoogleV2Args $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2GoogleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsV2GoogleV2Args();
        }

        public Builder(WindowsWebAppSlotAuthSettingsV2GoogleV2Args defaults) {
            $ = new WindowsWebAppSlotAuthSettingsV2GoogleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsV2GoogleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GoogleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GoogleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
