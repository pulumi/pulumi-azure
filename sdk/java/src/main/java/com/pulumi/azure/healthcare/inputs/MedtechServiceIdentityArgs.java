...
public final class MedtechServiceIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private MedtechServiceIdentityArgs() {}

    private MedtechServiceIdentityArgs(MedtechServiceIdentityArgs $) {
    ...
    public static Builder builder(MedtechServiceIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MedtechServiceIdentityArgs();
        }

        public Builder(MedtechServiceIdentityArgs defaults) {
        ...
        /**
         * @param principalId The Principal ID associated with this System Assigned Managed Service Identity.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tenantId The Tenant ID associated with this System Assigned Managed Service Identity.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param type Specifies the type of Managed Service Identity that should be configured on this Healthcare Med Tech Service. Possible values are `SystemAssigned`.
         * 
         * @return builder
         * 
         */
        ...
        public MedtechServiceIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("MedtechServiceIdentityArgs", "type");
            }
            return $;
        }
    }
