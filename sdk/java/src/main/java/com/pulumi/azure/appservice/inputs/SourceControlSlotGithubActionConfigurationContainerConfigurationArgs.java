...
public final class SourceControlSlotGithubActionConfigurationContainerConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final SourceControlSlotGithubActionConfigurationContainerConfigurationArgs Empty = new SourceControlSlotGithubActionConfigurationContainerConfigurationArgs();
    ...
    private SourceControlSlotGithubActionConfigurationContainerConfigurationArgs() {}

    private SourceControlSlotGithubActionConfigurationContainerConfigurationArgs(SourceControlSlotGithubActionConfigurationContainerConfigurationArgs $) {
    ...
    public static Builder builder(SourceControlSlotGithubActionConfigurationContainerConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SourceControlSlotGithubActionConfigurationContainerConfigurationArgs();
        }

        public Builder(SourceControlSlotGithubActionConfigurationContainerConfigurationArgs defaults) {
            $ = new SourceControlSlotGithubActionConfigurationContainerConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SourceControlSlotGithubActionConfigurationContainerConfigurationArgs build() {
            if ($.imageName == null) {
                throw new MissingRequiredPropertyException("SourceControlSlotGithubActionConfigurationContainerConfigurationArgs", "imageName");
            }
            if ($.registryUrl == null) {
                throw new MissingRequiredPropertyException("SourceControlSlotGithubActionConfigurationContainerConfigurationArgs", "registryUrl");
            }
            return $;
        }
    }
