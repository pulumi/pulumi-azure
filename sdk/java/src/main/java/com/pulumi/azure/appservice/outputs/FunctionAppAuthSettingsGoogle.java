...
@CustomType
public final class FunctionAppAuthSettingsGoogle {
    /**
    ...
    public static Builder builder(FunctionAppAuthSettingsGoogle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(FunctionAppAuthSettingsGoogle defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("FunctionAppAuthSettingsGoogle", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("FunctionAppAuthSettingsGoogle", "clientSecret");
            }
        ...
        public FunctionAppAuthSettingsGoogle build() {
            final var _resultValue = new FunctionAppAuthSettingsGoogle();
