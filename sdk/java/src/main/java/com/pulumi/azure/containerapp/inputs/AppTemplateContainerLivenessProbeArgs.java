...
import com.pulumi.azure.containerapp.inputs.AppTemplateContainerLivenessProbeHeaderArgs;
...
public final class AppTemplateContainerLivenessProbeArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppTemplateContainerLivenessProbeArgs Empty = new AppTemplateContainerLivenessProbeArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<List<AppTemplateContainerLivenessProbeHeaderArgs>> headers;

    /**
     * @return A `header` block as detailed below.
     * 
     */
    public Optional<Output<List<AppTemplateContainerLivenessProbeHeaderArgs>>> headers() {
    ...
    private AppTemplateContainerLivenessProbeArgs() {}

    private AppTemplateContainerLivenessProbeArgs(AppTemplateContainerLivenessProbeArgs $) {
    ...
    public static Builder builder(AppTemplateContainerLivenessProbeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppTemplateContainerLivenessProbeArgs();
        }

        public Builder(AppTemplateContainerLivenessProbeArgs defaults) {
            $ = new AppTemplateContainerLivenessProbeArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<List<AppTemplateContainerLivenessProbeHeaderArgs>> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(List<AppTemplateContainerLivenessProbeHeaderArgs> headers) {
         ...
         * 
         */
        public Builder headers(AppTemplateContainerLivenessProbeHeaderArgs... headers) {
        ...
        public AppTemplateContainerLivenessProbeArgs build() {
            if ($.port == null) {
                throw new MissingRequiredPropertyException("AppTemplateContainerLivenessProbeArgs", "port");
            }
            if ($.transport == null) {
                throw new MissingRequiredPropertyException("AppTemplateContainerLivenessProbeArgs", "transport");
            }
            return $;
        }
    }
