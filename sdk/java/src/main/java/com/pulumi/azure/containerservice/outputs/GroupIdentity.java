...
public final class GroupIdentity {
    ...
    public static Builder builder(GroupIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GroupIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GroupIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public GroupIdentity build() {
            final var _resultValue = new GroupIdentity();
