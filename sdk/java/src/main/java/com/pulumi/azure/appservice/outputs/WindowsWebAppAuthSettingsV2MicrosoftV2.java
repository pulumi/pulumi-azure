...
@CustomType
public final class WindowsWebAppAuthSettingsV2MicrosoftV2 {
    /**
    ...
    private WindowsWebAppAuthSettingsV2MicrosoftV2() {}
    /**
     * @return Specifies a list of Allowed Audiences that will be requested as part of Microsoft Sign-In authentication.
     * 
     */
    ...
    public static Builder builder(WindowsWebAppAuthSettingsV2MicrosoftV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsWebAppAuthSettingsV2MicrosoftV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2MicrosoftV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppAuthSettingsV2MicrosoftV2", "clientSecretSettingName");
            }
        ...
        public WindowsWebAppAuthSettingsV2MicrosoftV2 build() {
            final var _resultValue = new WindowsWebAppAuthSettingsV2MicrosoftV2();
