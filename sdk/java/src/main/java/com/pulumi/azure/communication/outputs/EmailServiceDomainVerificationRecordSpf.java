...
@CustomType
public final class EmailServiceDomainVerificationRecordSpf {
    /**
    ...
    private EmailServiceDomainVerificationRecordSpf() {}
    /**
     * @return The name of the Email Communication Service resource. If `domain_management` is `AzureManaged`, the name must be `AzureManagedDomain`. Changing this forces a new Email Communication Service to be created.
     * 
     */
    ...
    public static Builder builder(EmailServiceDomainVerificationRecordSpf defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(EmailServiceDomainVerificationRecordSpf defaults) {
        ...
        public EmailServiceDomainVerificationRecordSpf build() {
            final var _resultValue = new EmailServiceDomainVerificationRecordSpf();
