...
@CustomType
public final class DataFlowSinkDataset {
    /**
    ...
    public static Builder builder(DataFlowSinkDataset defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> parameters;
        public Builder() {}
        public Builder(DataFlowSinkDataset defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DataFlowSinkDataset", "name");
            }
            this.name = name;
            return this;
        }
