...
public final class LinkedCustomServiceState extends com.pulumi.resources.ResourceArgs {

    public static final LinkedCustomServiceState Empty = new LinkedCustomServiceState();
    ...
    private LinkedCustomServiceState() {}

    private LinkedCustomServiceState(LinkedCustomServiceState $) {
    ...
    public static Builder builder(LinkedCustomServiceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinkedCustomServiceState();
        }

        public Builder(LinkedCustomServiceState defaults) {
            $ = new LinkedCustomServiceState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param type The type of data stores that will be connected to Data Factory. For full list of supported data stores, please refer to [Azure Data Factory connector](https://docs.microsoft.com/azure/data-factory/connector-overview).
         * 
         * @return builder
         * 
         */
        ...
        public LinkedCustomServiceState build() {
            return $;
        }
    }
