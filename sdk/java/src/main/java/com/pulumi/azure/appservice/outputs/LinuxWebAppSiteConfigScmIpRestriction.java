...
import com.pulumi.azure.appservice.outputs.LinuxWebAppSiteConfigScmIpRestrictionHeaders;
...
@CustomType
public final class LinuxWebAppSiteConfigScmIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable LinuxWebAppSiteConfigScmIpRestrictionHeaders headers;
    /**
    ...
    private LinuxWebAppSiteConfigScmIpRestriction(
        @CustomType.Parameter("action") @Nullable String action,
        @CustomType.Parameter("headers") @Nullable LinuxWebAppSiteConfigScmIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<LinuxWebAppSiteConfigScmIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(LinuxWebAppSiteConfigScmIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable LinuxWebAppSiteConfigScmIpRestrictionHeaders headers;
        ...
        public Builder(LinuxWebAppSiteConfigScmIpRestriction defaults) {
        ...
        public Builder headers(@Nullable LinuxWebAppSiteConfigScmIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            ...
            return new LinuxWebAppSiteConfigScmIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
