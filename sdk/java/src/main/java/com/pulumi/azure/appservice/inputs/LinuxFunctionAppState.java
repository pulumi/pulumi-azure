...
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppSiteCredentialArgs;
...
public final class LinuxFunctionAppState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<LinuxFunctionAppSiteConfigArgs> siteConfig;

    /**
     * @return A `siteConfig` block as defined below.
     * 
     */
    public Optional<Output<LinuxFunctionAppSiteConfigArgs>> siteConfig() {
    ...
    private @Nullable Output<List<LinuxFunctionAppSiteCredentialArgs>> siteCredentials;

    /**
     * @return A `siteCredential` block as defined below.
     * 
     */
    public Optional<Output<List<LinuxFunctionAppSiteCredentialArgs>>> siteCredentials() {
    ...
    public static Builder builder(LinuxFunctionAppState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppState();
        }

        public Builder(LinuxFunctionAppState defaults) {
            $ = new LinuxFunctionAppState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder siteConfig(@Nullable Output<LinuxFunctionAppSiteConfigArgs> siteConfig) {
         ...
         * 
         */
        public Builder siteCredentials(@Nullable Output<List<LinuxFunctionAppSiteCredentialArgs>> siteCredentials) {
         ...
         * 
         */
        public Builder siteCredentials(List<LinuxFunctionAppSiteCredentialArgs> siteCredentials) {
         ...
         * 
         */
        public Builder siteCredentials(LinuxFunctionAppSiteCredentialArgs... siteCredentials) {
