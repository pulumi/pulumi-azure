...
public final class LinuxWebAppAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsActiveDirectoryArgs Empty = new LinuxWebAppAuthSettingsActiveDirectoryArgs();
    ...
    private LinuxWebAppAuthSettingsActiveDirectoryArgs() {}

    private LinuxWebAppAuthSettingsActiveDirectoryArgs(LinuxWebAppAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsActiveDirectoryArgs();
        }

        public Builder(LinuxWebAppAuthSettingsActiveDirectoryArgs defaults) {
            $ = new LinuxWebAppAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
