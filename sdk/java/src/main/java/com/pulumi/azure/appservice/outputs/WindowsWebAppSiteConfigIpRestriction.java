...
import com.pulumi.azure.appservice.outputs.WindowsWebAppSiteConfigIpRestrictionHeaders;
...
@CustomType
public final class WindowsWebAppSiteConfigIpRestriction {
    /**
     ...
     * 
     */
    private final @Nullable WindowsWebAppSiteConfigIpRestrictionHeaders headers;
    /**
    ...
    private WindowsWebAppSiteConfigIpRestriction(
        ...
        @CustomType.Parameter("headers") @Nullable WindowsWebAppSiteConfigIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<WindowsWebAppSiteConfigIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(WindowsWebAppSiteConfigIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable WindowsWebAppSiteConfigIpRestrictionHeaders headers;
        ...
        public Builder(WindowsWebAppSiteConfigIpRestriction defaults) {
        ...
        public Builder headers(@Nullable WindowsWebAppSiteConfigIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public WindowsWebAppSiteConfigIpRestriction build() {
            return new WindowsWebAppSiteConfigIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
