...
public final class ActionRuleActionGroupConditionSeverity {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionSeverity", "operator");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionSeverity", "values");
            }
            this.values = values;
            return this;
        }
