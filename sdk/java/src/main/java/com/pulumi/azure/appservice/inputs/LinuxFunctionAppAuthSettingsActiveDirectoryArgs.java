...
public final class LinuxFunctionAppAuthSettingsActiveDirectoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppAuthSettingsActiveDirectoryArgs Empty = new LinuxFunctionAppAuthSettingsActiveDirectoryArgs();
    ...
    private LinuxFunctionAppAuthSettingsActiveDirectoryArgs() {}

    private LinuxFunctionAppAuthSettingsActiveDirectoryArgs(LinuxFunctionAppAuthSettingsActiveDirectoryArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsActiveDirectoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsActiveDirectoryArgs();
        }

        public Builder(LinuxFunctionAppAuthSettingsActiveDirectoryArgs defaults) {
            $ = new LinuxFunctionAppAuthSettingsActiveDirectoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsActiveDirectoryArgs build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsActiveDirectoryArgs", "clientId");
            }
            return $;
        }
    }
