...
public final class SpringCloudServiceConfigServerGitSettingRepositorySshAuth {
    ...
    public static final class Builder {
        ...
        public Builder privateKey(String privateKey) {
            if (privateKey == null) {
              throw new MissingRequiredPropertyException("SpringCloudServiceConfigServerGitSettingRepositorySshAuth", "privateKey");
            }
        ...
        public SpringCloudServiceConfigServerGitSettingRepositorySshAuth build() {
            final var _resultValue = new SpringCloudServiceConfigServerGitSettingRepositorySshAuth();
