...
public final class DatasetDelimitedTextAzureBlobStorageLocationArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetDelimitedTextAzureBlobStorageLocationArgs Empty = new DatasetDelimitedTextAzureBlobStorageLocationArgs();
    ...
    private DatasetDelimitedTextAzureBlobStorageLocationArgs() {}

    private DatasetDelimitedTextAzureBlobStorageLocationArgs(DatasetDelimitedTextAzureBlobStorageLocationArgs $) {
    ...
    public static Builder builder(DatasetDelimitedTextAzureBlobStorageLocationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetDelimitedTextAzureBlobStorageLocationArgs();
        }

        public Builder(DatasetDelimitedTextAzureBlobStorageLocationArgs defaults) {
            $ = new DatasetDelimitedTextAzureBlobStorageLocationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param path The folder path to the file. This can be an empty string.
         * 
         * @return builder
         * 
         */
        ...
        public DatasetDelimitedTextAzureBlobStorageLocationArgs build() {
            if ($.container == null) {
                throw new MissingRequiredPropertyException("DatasetDelimitedTextAzureBlobStorageLocationArgs", "container");
            }
            return $;
        }
    }
