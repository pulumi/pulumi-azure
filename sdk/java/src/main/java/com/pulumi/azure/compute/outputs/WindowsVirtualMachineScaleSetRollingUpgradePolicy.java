    ...
    public static final class Builder {
        ...
        public Builder maxBatchInstancePercent(Integer maxBatchInstancePercent) {
            if (maxBatchInstancePercent == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetRollingUpgradePolicy", "maxBatchInstancePercent");
            }
        ...
        public Builder maxUnhealthyInstancePercent(Integer maxUnhealthyInstancePercent) {
            if (maxUnhealthyInstancePercent == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetRollingUpgradePolicy", "maxUnhealthyInstancePercent");
            }
        ...
        public Builder maxUnhealthyUpgradedInstancePercent(Integer maxUnhealthyUpgradedInstancePercent) {
            if (maxUnhealthyUpgradedInstancePercent == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetRollingUpgradePolicy", "maxUnhealthyUpgradedInstancePercent");
            }
        ...
        public Builder pauseTimeBetweenBatches(String pauseTimeBetweenBatches) {
            if (pauseTimeBetweenBatches == null) {
              throw new MissingRequiredPropertyException("WindowsVirtualMachineScaleSetRollingUpgradePolicy", "pauseTimeBetweenBatches");
            }
