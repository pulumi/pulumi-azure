...
public final class WindowsFunctionAppAuthSettingsV2LoginArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsV2LoginArgs Empty = new WindowsFunctionAppAuthSettingsV2LoginArgs();
    ...
    private WindowsFunctionAppAuthSettingsV2LoginArgs() {}

    private WindowsFunctionAppAuthSettingsV2LoginArgs(WindowsFunctionAppAuthSettingsV2LoginArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2LoginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsV2LoginArgs();
        }

        public Builder(WindowsFunctionAppAuthSettingsV2LoginArgs defaults) {
            $ = new WindowsFunctionAppAuthSettingsV2LoginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsV2LoginArgs build() {
            return $;
        }
    }
