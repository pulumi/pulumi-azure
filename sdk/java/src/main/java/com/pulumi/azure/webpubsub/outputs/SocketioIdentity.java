...
@CustomType
public final class SocketioIdentity {
    /**
    ...
    public static Builder builder(SocketioIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(SocketioIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("SocketioIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public SocketioIdentity build() {
            final var _resultValue = new SocketioIdentity();
