...
public final class HBaseClusterRolesZookeeperNode {
    ...
    public static final class Builder {
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("HBaseClusterRolesZookeeperNode", "username");
            }
        ...
        public Builder vmSize(String vmSize) {
            if (vmSize == null) {
              throw new MissingRequiredPropertyException("HBaseClusterRolesZookeeperNode", "vmSize");
            }
            this.vmSize = vmSize;
            return this;
        }
        public HBaseClusterRolesZookeeperNode build() {
            final var _resultValue = new HBaseClusterRolesZookeeperNode();
