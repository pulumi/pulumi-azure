...
public final class FrontdoorRuleConditionsUrlFilenameConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FrontdoorRuleConditionsUrlFilenameConditionArgs Empty = new FrontdoorRuleConditionsUrlFilenameConditionArgs();
    ...
    private FrontdoorRuleConditionsUrlFilenameConditionArgs() {}

    private FrontdoorRuleConditionsUrlFilenameConditionArgs(FrontdoorRuleConditionsUrlFilenameConditionArgs $) {
    ...
    public static Builder builder(FrontdoorRuleConditionsUrlFilenameConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FrontdoorRuleConditionsUrlFilenameConditionArgs();
        }

        public Builder(FrontdoorRuleConditionsUrlFilenameConditionArgs defaults) {
            $ = new FrontdoorRuleConditionsUrlFilenameConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FrontdoorRuleConditionsUrlFilenameConditionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("FrontdoorRuleConditionsUrlFilenameConditionArgs", "operator");
            }
            return $;
        }
    }
