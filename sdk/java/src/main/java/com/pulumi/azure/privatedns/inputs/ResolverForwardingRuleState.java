...
public final class ResolverForwardingRuleState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> dnsForwardingRulesetId;
     ...
     * 
     */
    public Optional<Output<String>> dnsForwardingRulesetId() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder dnsForwardingRulesetId(@Nullable Output<String> dnsForwardingRulesetId) {
         ...
         * 
         */
        public Builder targetDnsServers(@Nullable Output<List<ResolverForwardingRuleTargetDnsServerArgs>> targetDnsServers) {
