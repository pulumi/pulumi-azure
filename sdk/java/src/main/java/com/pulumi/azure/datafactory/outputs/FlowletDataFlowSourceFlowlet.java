...
public final class FlowletDataFlowSourceFlowlet {
    ...
    public static Builder builder(FlowletDataFlowSourceFlowlet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> parameters;
        public Builder() {}
        public Builder(FlowletDataFlowSourceFlowlet defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("FlowletDataFlowSourceFlowlet", "name");
            }
            this.name = name;
            return this;
        }
