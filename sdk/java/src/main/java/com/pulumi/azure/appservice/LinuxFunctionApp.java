...
public class LinuxFunctionApp extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="backup", refs={LinuxFunctionAppBackup.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="identity", refs={LinuxFunctionAppIdentity.class}, tree="[0]")
     ...
     */
    public LinuxFunctionApp(java.lang.String name) {
     ...
     */
    public LinuxFunctionApp(java.lang.String name, LinuxFunctionAppArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LinuxFunctionApp(java.lang.String name, LinuxFunctionAppArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:appservice/linuxFunctionApp:LinuxFunctionApp", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LinuxFunctionApp(java.lang.String name, Output<java.lang.String> id, @Nullable LinuxFunctionAppState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:appservice/linuxFunctionApp:LinuxFunctionApp", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LinuxFunctionApp get(java.lang.String name, Output<java.lang.String> id, @Nullable LinuxFunctionAppState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
