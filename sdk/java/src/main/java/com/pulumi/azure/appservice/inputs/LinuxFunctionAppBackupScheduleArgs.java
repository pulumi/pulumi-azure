    ...
    public static final class Builder {
        ...
        public LinuxFunctionAppBackupScheduleArgs build() {
            if ($.frequencyInterval == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppBackupScheduleArgs", "frequencyInterval");
            }
            if ($.frequencyUnit == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppBackupScheduleArgs", "frequencyUnit");
            }
            return $;
        }
    }
