...
public final class DataFlowTransformationFlowletArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DataFlowTransformationFlowletArgs() {}

    private DataFlowTransformationFlowletArgs(DataFlowTransformationFlowletArgs $) {
    ...
    public static Builder builder(DataFlowTransformationFlowletArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataFlowTransformationFlowletArgs();
        }

        public Builder(DataFlowTransformationFlowletArgs defaults) {
        ...
        public DataFlowTransformationFlowletArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DataFlowTransformationFlowletArgs", "name");
            }
            return $;
        }
    }
