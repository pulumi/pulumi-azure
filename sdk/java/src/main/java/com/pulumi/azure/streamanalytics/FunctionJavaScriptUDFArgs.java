...
public final class FunctionJavaScriptUDFArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<List<FunctionJavaScriptUDFInputArgs>> inputs;

    /**
     * @return One or more `input` blocks as defined below.
     * 
     */
    public Output<List<FunctionJavaScriptUDFInputArgs>> inputs() {
        return this.inputs;
    }
    ...
    private Output<FunctionJavaScriptUDFOutputArgs> output;

    /**
     * @return An `output` blocks as defined below.
     * 
     */
    public Output<FunctionJavaScriptUDFOutputArgs> output() {
        return this.output;
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder inputs(Output<List<FunctionJavaScriptUDFInputArgs>> inputs) {
            $.inputs = inputs;
            return this;
        }
         ...
         * 
         */
        public Builder output(Output<FunctionJavaScriptUDFOutputArgs> output) {
            $.output = output;
            return this;
        }
