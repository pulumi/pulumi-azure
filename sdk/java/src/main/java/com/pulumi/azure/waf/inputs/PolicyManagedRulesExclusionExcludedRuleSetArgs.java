...
public final class PolicyManagedRulesExclusionExcludedRuleSetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param type The rule set type. The only possible value is `OWASP` . Defaults to `OWASP`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param version The rule set version. The only possible value is `3.2` . Defaults to `3.2`.
         * 
         * @return builder
         * 
         */
