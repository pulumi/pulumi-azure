...
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotSiteConfigScmIpRestrictionHeadersArgs;
...
public final class WindowsWebAppSlotSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="headers")
    private @Nullable Output<WindowsWebAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<WindowsWebAppSlotSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private WindowsWebAppSlotSiteConfigScmIpRestrictionArgs() {}

    private WindowsWebAppSlotSiteConfigScmIpRestrictionArgs(WindowsWebAppSlotSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(WindowsWebAppSlotSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotSiteConfigScmIpRestrictionArgs();
        }

        public Builder(WindowsWebAppSlotSiteConfigScmIpRestrictionArgs defaults) {
            $ = new WindowsWebAppSlotSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<WindowsWebAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(WindowsWebAppSlotSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public WindowsWebAppSlotSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
