...
import com.pulumi.azure.datafactory.inputs.DatasetMysqlSchemaColumnArgs;
...
public final class DatasetMysqlArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatasetMysqlArgs Empty = new DatasetMysqlArgs();
    ...
    private DatasetMysqlArgs() {}

    private DatasetMysqlArgs(DatasetMysqlArgs $) {
    ...
    public static Builder builder(DatasetMysqlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatasetMysqlArgs();
        }

        public Builder(DatasetMysqlArgs defaults) {
            $ = new DatasetMysqlArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param annotations List of tags that can be used for describing the Data Factory Dataset MySQL.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param description The description for the Data Factory Dataset MySQL.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param name Specifies the name of the Data Factory Dataset MySQL. Changing this forces a new resource to be created. Must be globally unique. See the [Microsoft documentation](https://docs.microsoft.com/azure/data-factory/naming-rules) for all restrictions.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param parameters A map of parameters to associate with the Data Factory Dataset MySQL.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder schemaColumns(@Nullable Output<List<DatasetMysqlSchemaColumnArgs>> schemaColumns) {
         ...
         * 
         */
        public Builder schemaColumns(List<DatasetMysqlSchemaColumnArgs> schemaColumns) {
         ...
         * 
         */
        public Builder schemaColumns(DatasetMysqlSchemaColumnArgs... schemaColumns) {
            return schemaColumns(List.of(schemaColumns));
        }

        /**
         * @param tableName The table name of the Data Factory Dataset MySQL.
         * 
         * @return builder
         * 
         */
        ...
        public DatasetMysqlArgs build() {
            if ($.dataFactoryId == null) {
                throw new MissingRequiredPropertyException("DatasetMysqlArgs", "dataFactoryId");
            }
            if ($.linkedServiceName == null) {
                throw new MissingRequiredPropertyException("DatasetMysqlArgs", "linkedServiceName");
            }
            return $;
        }
    }
