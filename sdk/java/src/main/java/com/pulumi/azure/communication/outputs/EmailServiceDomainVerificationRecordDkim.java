...
@CustomType
public final class EmailServiceDomainVerificationRecordDkim {
    /**
    ...
    private EmailServiceDomainVerificationRecordDkim() {}
    /**
     * @return The name of the Email Communication Service resource. If `domainManagement` is `AzureManaged`, the name must be `AzureManagedDomain`. Changing this forces a new Email Communication Service to be created.
     * 
     */
    ...
    public static Builder builder(EmailServiceDomainVerificationRecordDkim defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(EmailServiceDomainVerificationRecordDkim defaults) {
        ...
        public EmailServiceDomainVerificationRecordDkim build() {
            final var _resultValue = new EmailServiceDomainVerificationRecordDkim();
