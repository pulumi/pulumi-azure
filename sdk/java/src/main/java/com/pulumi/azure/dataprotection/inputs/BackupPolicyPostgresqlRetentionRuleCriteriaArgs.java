...
public final class BackupPolicyPostgresqlRetentionRuleCriteriaArgs extends com.pulumi.resources.ResourceArgs {

    public static final BackupPolicyPostgresqlRetentionRuleCriteriaArgs Empty = new BackupPolicyPostgresqlRetentionRuleCriteriaArgs();
    ...
    private BackupPolicyPostgresqlRetentionRuleCriteriaArgs() {}

    private BackupPolicyPostgresqlRetentionRuleCriteriaArgs(BackupPolicyPostgresqlRetentionRuleCriteriaArgs $) {
    ...
    public static Builder builder(BackupPolicyPostgresqlRetentionRuleCriteriaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BackupPolicyPostgresqlRetentionRuleCriteriaArgs();
        }

        public Builder(BackupPolicyPostgresqlRetentionRuleCriteriaArgs defaults) {
            $ = new BackupPolicyPostgresqlRetentionRuleCriteriaArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param absoluteCriteria Possible values are `AllBackup`, `FirstOfDay`, `FirstOfWeek`, `FirstOfMonth` and `FirstOfYear`. These values mean the first successful backup of the day/week/month/year. Changing this forces a new Backup Policy PostgreSQL to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param daysOfWeeks Possible values are `Monday`, `Tuesday`, `Thursday`, `Friday`, `Saturday` and `Sunday`. Changing this forces a new Backup Policy PostgreSQL to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param monthsOfYears Possible values are `January`, `February`, `March`, `April`, `May`, `June`, `July`, `August`, `September`, `October`, `November` and `December`. Changing this forces a new Backup Policy PostgreSQL to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param scheduledBackupTimes Specifies a list of backup times for backup in the `RFC3339` format. Changing this forces a new Backup Policy PostgreSQL to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param weeksOfMonths Possible values are `First`, `Second`, `Third`, `Fourth` and `Last`. Changing this forces a new Backup Policy PostgreSQL to be created.
         * 
         * &gt; **Note:** When not using `absolute_criteria`, you must use exactly one of `days_of_month` or `days_of_week`. Regarding the remaining two properties, `weeks_of_month` and `months_of_year`, you may use either, both, or neither. If you would like to set multiple intervals, you may do so by using multiple `retention_rule` blocks.
         * 
         * @return builder
        ...
        public BackupPolicyPostgresqlRetentionRuleCriteriaArgs build() {
            return $;
        }
    }
