...
@CustomType
public final class LinuxWebAppAuthSettingsMicrosoft {
    /**
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsMicrosoft", "clientId");
            }
        ...
        public LinuxWebAppAuthSettingsMicrosoft build() {
            final var _resultValue = new LinuxWebAppAuthSettingsMicrosoft();
