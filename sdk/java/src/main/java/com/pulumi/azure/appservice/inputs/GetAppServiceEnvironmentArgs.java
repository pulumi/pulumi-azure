...
public final class GetAppServiceEnvironmentArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppServiceEnvironmentArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAppServiceEnvironmentArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetAppServiceEnvironmentArgs", "resourceGroupName");
            }
            return $;
        }
    }
