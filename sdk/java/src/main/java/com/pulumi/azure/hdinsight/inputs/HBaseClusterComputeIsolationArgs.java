...
public final class HBaseClusterComputeIsolationArgs extends com.pulumi.resources.ResourceArgs {

    public static final HBaseClusterComputeIsolationArgs Empty = new HBaseClusterComputeIsolationArgs();
    ...
    private HBaseClusterComputeIsolationArgs() {}

    private HBaseClusterComputeIsolationArgs(HBaseClusterComputeIsolationArgs $) {
    ...
    public static Builder builder(HBaseClusterComputeIsolationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseClusterComputeIsolationArgs();
        }

        public Builder(HBaseClusterComputeIsolationArgs defaults) {
            $ = new HBaseClusterComputeIsolationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HBaseClusterComputeIsolationArgs build() {
            return $;
        }
    }
