...
public final class VolumeGroupOracleVolumeExportPolicyRuleArgs extends com.pulumi.resources.ResourceArgs {

    public static final VolumeGroupOracleVolumeExportPolicyRuleArgs Empty = new VolumeGroupOracleVolumeExportPolicyRuleArgs();
    ...
    private VolumeGroupOracleVolumeExportPolicyRuleArgs() {}

    private VolumeGroupOracleVolumeExportPolicyRuleArgs(VolumeGroupOracleVolumeExportPolicyRuleArgs $) {
    ...
    public static Builder builder(VolumeGroupOracleVolumeExportPolicyRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VolumeGroupOracleVolumeExportPolicyRuleArgs();
        }

        public Builder(VolumeGroupOracleVolumeExportPolicyRuleArgs defaults) {
            $ = new VolumeGroupOracleVolumeExportPolicyRuleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VolumeGroupOracleVolumeExportPolicyRuleArgs build() {
            if ($.allowedClients == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleVolumeExportPolicyRuleArgs", "allowedClients");
            }
            if ($.nfsv3Enabled == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleVolumeExportPolicyRuleArgs", "nfsv3Enabled");
            }
            if ($.nfsv41Enabled == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleVolumeExportPolicyRuleArgs", "nfsv41Enabled");
            }
            if ($.ruleIndex == null) {
                throw new MissingRequiredPropertyException("VolumeGroupOracleVolumeExportPolicyRuleArgs", "ruleIndex");
            }
            return $;
        }
    }
