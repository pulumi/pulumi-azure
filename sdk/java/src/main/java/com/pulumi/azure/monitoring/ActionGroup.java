 ...
 *                 .workspaceId(exampleAnalyticsWorkspace.workspaceId().apply(workspaceId -&gt; String.format(&#34;%s|%s&#34;, current.apply(getClientConfigResult -&gt; getClientConfigResult.subscriptionId()),workspaceId)))
