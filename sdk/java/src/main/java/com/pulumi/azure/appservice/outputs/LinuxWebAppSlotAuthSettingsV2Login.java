...
@CustomType
public final class LinuxWebAppSlotAuthSettingsV2Login {
    /**
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2Login defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validateNonce;
        public Builder() {}
        public Builder(LinuxWebAppSlotAuthSettingsV2Login defaults) {
        ...
        public LinuxWebAppSlotAuthSettingsV2Login build() {
            final var _resultValue = new LinuxWebAppSlotAuthSettingsV2Login();
