...
public final class SubscriptionCostManagementViewDatasetSorting {
    ...
    public static final class Builder {
        ...
        public Builder direction(String direction) {
            if (direction == null) {
              throw new MissingRequiredPropertyException("SubscriptionCostManagementViewDatasetSorting", "direction");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("SubscriptionCostManagementViewDatasetSorting", "name");
            }
            this.name = name;
            return this;
        }
