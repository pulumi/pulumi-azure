...
public final class HBaseClusterMetastoresHiveArgs extends com.pulumi.resources.ResourceArgs {

    public static final HBaseClusterMetastoresHiveArgs Empty = new HBaseClusterMetastoresHiveArgs();
    ...
    private HBaseClusterMetastoresHiveArgs() {}

    private HBaseClusterMetastoresHiveArgs(HBaseClusterMetastoresHiveArgs $) {
    ...
    public static Builder builder(HBaseClusterMetastoresHiveArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HBaseClusterMetastoresHiveArgs();
        }

        public Builder(HBaseClusterMetastoresHiveArgs defaults) {
            $ = new HBaseClusterMetastoresHiveArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HBaseClusterMetastoresHiveArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresHiveArgs", "databaseName");
            }
            if ($.password == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresHiveArgs", "password");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresHiveArgs", "server");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("HBaseClusterMetastoresHiveArgs", "username");
            }
            return $;
        }
    }
