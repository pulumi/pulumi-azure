...
@CustomType
public final class FlowletDataFlowSinkSchemaLinkedService {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("FlowletDataFlowSinkSchemaLinkedService", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public FlowletDataFlowSinkSchemaLinkedService build() {
            final var _resultValue = new FlowletDataFlowSinkSchemaLinkedService();
