...
@CustomType
public final class StandardSiteConfigScmIpRestrictionHeaders {
    /**
    ...
    private StandardSiteConfigScmIpRestrictionHeaders() {}
    /**
     * @return A list of allowed Azure FrontDoor IDs in UUID notation with a maximum of 8.
     * 
     */
    ...
    public static Builder builder(StandardSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> xForwardedHosts;
        public Builder() {}
        public Builder(StandardSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        public StandardSiteConfigScmIpRestrictionHeaders build() {
            final var _resultValue = new StandardSiteConfigScmIpRestrictionHeaders();
