...
public final class RegistryTaskState extends com.pulumi.resources.ResourceArgs {

    public static final RegistryTaskState Empty = new RegistryTaskState();
    ...
    private RegistryTaskState() {}

    private RegistryTaskState(RegistryTaskState $) {
    ...
    public static Builder builder(RegistryTaskState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryTaskState();
        }

        public Builder(RegistryTaskState defaults) {
            $ = new RegistryTaskState(Objects.requireNonNull(defaults));
        }
        ...
        public RegistryTaskState build() {
            return $;
        }
    }
