...
@CustomType
public final class SparkClusterDiskEncryption {
    /**
    ...
    private SparkClusterDiskEncryption() {}
    /**
     * @return This is an algorithm identifier for encryption. Possible values are `RSA1_5`, `RSA-OAEP`, `RSA-OAEP-256`.
     * 
     */
    ...
    public static Builder builder(SparkClusterDiskEncryption defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String keyVaultManagedIdentityId;
        public Builder() {}
        public Builder(SparkClusterDiskEncryption defaults) {
        ...
        public SparkClusterDiskEncryption build() {
            final var _resultValue = new SparkClusterDiskEncryption();
