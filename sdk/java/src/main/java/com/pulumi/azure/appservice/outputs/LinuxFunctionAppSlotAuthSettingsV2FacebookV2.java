...
@CustomType
public final class LinuxFunctionAppSlotAuthSettingsV2FacebookV2 {
    /**
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2FacebookV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxFunctionAppSlotAuthSettingsV2FacebookV2 defaults) {
        ...
        public LinuxFunctionAppSlotAuthSettingsV2FacebookV2 build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsV2FacebookV2();
