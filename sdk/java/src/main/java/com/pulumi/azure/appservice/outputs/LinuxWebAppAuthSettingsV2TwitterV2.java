...
@CustomType
public final class LinuxWebAppAuthSettingsV2TwitterV2 {
    /**
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2TwitterV2 defaults) {
    ...
    public static final class Builder {
        ...
        private String consumerSecretSettingName;
        public Builder() {}
        public Builder(LinuxWebAppAuthSettingsV2TwitterV2 defaults) {
