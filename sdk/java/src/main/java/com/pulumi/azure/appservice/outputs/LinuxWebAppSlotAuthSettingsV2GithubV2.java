...
public final class LinuxWebAppSlotAuthSettingsV2GithubV2 {
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2GithubV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxWebAppSlotAuthSettingsV2GithubV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2GithubV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2GithubV2", "clientSecretSettingName");
            }
        ...
        public LinuxWebAppSlotAuthSettingsV2GithubV2 build() {
            final var _resultValue = new LinuxWebAppSlotAuthSettingsV2GithubV2();
