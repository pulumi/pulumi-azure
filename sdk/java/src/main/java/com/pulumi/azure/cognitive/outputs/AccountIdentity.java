...
public final class AccountIdentity {
    /**
     * @return Specifies a list of User Assigned Managed Identity IDs to be assigned to this Cognitive Account.
     * 
     */
    ...
    /**
     * @return Specifies the type of Managed Service Identity that should be configured on this Cognitive Account. Possible values are `SystemAssigned`, `UserAssigned`, `SystemAssigned, UserAssigned` (to enable both).
     * 
     */
