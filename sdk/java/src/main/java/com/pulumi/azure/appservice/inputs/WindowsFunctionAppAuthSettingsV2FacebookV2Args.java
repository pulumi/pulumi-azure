...
public final class WindowsFunctionAppAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsV2FacebookV2Args Empty = new WindowsFunctionAppAuthSettingsV2FacebookV2Args();
    ...
    private WindowsFunctionAppAuthSettingsV2FacebookV2Args() {}

    private WindowsFunctionAppAuthSettingsV2FacebookV2Args(WindowsFunctionAppAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsV2FacebookV2Args();
        }

        public Builder(WindowsFunctionAppAuthSettingsV2FacebookV2Args defaults) {
            $ = new WindowsFunctionAppAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
