...
public final class DataConnectorIotArgs extends com.pulumi.resources.ResourceArgs {

    public static final DataConnectorIotArgs Empty = new DataConnectorIotArgs();
    ...
    private DataConnectorIotArgs() {}

    private DataConnectorIotArgs(DataConnectorIotArgs $) {
    ...
    public static Builder builder(DataConnectorIotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataConnectorIotArgs();
        }

        public Builder(DataConnectorIotArgs defaults) {
            $ = new DataConnectorIotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DataConnectorIotArgs build() {
            if ($.logAnalyticsWorkspaceId == null) {
                throw new MissingRequiredPropertyException("DataConnectorIotArgs", "logAnalyticsWorkspaceId");
            }
            return $;
        }
    }
