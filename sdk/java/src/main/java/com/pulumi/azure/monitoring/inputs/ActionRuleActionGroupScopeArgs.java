...
public final class ActionRuleActionGroupScopeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ActionRuleActionGroupScopeArgs build() {
            if ($.resourceIds == null) {
                throw new MissingRequiredPropertyException("ActionRuleActionGroupScopeArgs", "resourceIds");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ActionRuleActionGroupScopeArgs", "type");
            }
            return $;
        }
    }
