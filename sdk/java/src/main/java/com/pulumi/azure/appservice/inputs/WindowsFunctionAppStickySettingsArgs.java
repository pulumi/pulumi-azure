...
public final class WindowsFunctionAppStickySettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param appSettingNames A list of `appSetting` names that the Windows Function App will not swap between Slots when a swap operation is triggered.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param connectionStringNames A list of `connectionString` names that the Windows Function App will not swap between Slots when a swap operation is triggered.
         * 
         * @return builder
         * 
         */
