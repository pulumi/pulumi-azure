...
public final class WindowsFunctionAppStickySettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppStickySettingsArgs Empty = new WindowsFunctionAppStickySettingsArgs();
    ...
    private WindowsFunctionAppStickySettingsArgs() {}

    private WindowsFunctionAppStickySettingsArgs(WindowsFunctionAppStickySettingsArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppStickySettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppStickySettingsArgs();
        }

        public Builder(WindowsFunctionAppStickySettingsArgs defaults) {
            $ = new WindowsFunctionAppStickySettingsArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param appSettingNames A list of `app_setting` names that the Windows Function App will not swap between Slots when a swap operation is triggered.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param connectionStringNames A list of `connection_string` names that the Windows Function App will not swap between Slots when a swap operation is triggered.
         * 
         * @return builder
         * 
         */
        ...
        public WindowsFunctionAppStickySettingsArgs build() {
            return $;
        }
    }
