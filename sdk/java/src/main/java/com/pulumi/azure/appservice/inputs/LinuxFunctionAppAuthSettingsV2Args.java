...
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2AppleV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2AzureStaticWebAppV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2CustomOidcV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2FacebookV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2GithubV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2GoogleV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2LoginArgs;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2MicrosoftV2Args;
import com.pulumi.azure.appservice.inputs.LinuxFunctionAppAuthSettingsV2TwitterV2Args;
...
public final class LinuxFunctionAppAuthSettingsV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private Output<LinuxFunctionAppAuthSettingsV2LoginArgs> login;

    /**
     * @return A `login` block as defined below.
     * 
     */
    public Output<LinuxFunctionAppAuthSettingsV2LoginArgs> login() {
        return this.login;
    }
    ...
    private LinuxFunctionAppAuthSettingsV2Args() {}

    private LinuxFunctionAppAuthSettingsV2Args(LinuxFunctionAppAuthSettingsV2Args $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsV2Args();
        }

        public Builder(LinuxFunctionAppAuthSettingsV2Args defaults) {
            $ = new LinuxFunctionAppAuthSettingsV2Args(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder activeDirectoryV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args> activeDirectoryV2) {
         ...
         * 
         */
        public Builder activeDirectoryV2(LinuxFunctionAppAuthSettingsV2ActiveDirectoryV2Args activeDirectoryV2) {
         ...
         * 
         */
        public Builder appleV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2AppleV2Args> appleV2) {
            $.appleV2 = appleV2;
            return this;
        }
         ...
         * 
         */
        public Builder appleV2(LinuxFunctionAppAuthSettingsV2AppleV2Args appleV2) {
         ...
         * 
         */
        public Builder azureStaticWebAppV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2AzureStaticWebAppV2Args> azureStaticWebAppV2) {
         ...
         * 
         */
        public Builder azureStaticWebAppV2(LinuxFunctionAppAuthSettingsV2AzureStaticWebAppV2Args azureStaticWebAppV2) {
         ...
         * 
         */
        public Builder customOidcV2s(@Nullable Output<List<LinuxFunctionAppAuthSettingsV2CustomOidcV2Args>> customOidcV2s) {
         ...
         * 
         */
        public Builder customOidcV2s(List<LinuxFunctionAppAuthSettingsV2CustomOidcV2Args> customOidcV2s) {
         ...
         * 
         */
        public Builder customOidcV2s(LinuxFunctionAppAuthSettingsV2CustomOidcV2Args... customOidcV2s) {
         ...
         * 
         */
        public Builder facebookV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2FacebookV2Args> facebookV2) {
         ...
         * 
         */
        public Builder facebookV2(LinuxFunctionAppAuthSettingsV2FacebookV2Args facebookV2) {
         ...
         * 
         */
        public Builder githubV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2GithubV2Args> githubV2) {
            $.githubV2 = githubV2;
            return this;
        }
         ...
         * 
         */
        public Builder githubV2(LinuxFunctionAppAuthSettingsV2GithubV2Args githubV2) {
         ...
         * 
         */
        public Builder googleV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2GoogleV2Args> googleV2) {
            $.googleV2 = googleV2;
            return this;
        }
         ...
         * 
         */
        public Builder googleV2(LinuxFunctionAppAuthSettingsV2GoogleV2Args googleV2) {
         ...
         * 
         */
        public Builder login(Output<LinuxFunctionAppAuthSettingsV2LoginArgs> login) {
            $.login = login;
            return this;
        }
         ...
         * 
         */
        public Builder login(LinuxFunctionAppAuthSettingsV2LoginArgs login) {
         ...
         * 
         */
        public Builder microsoftV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2MicrosoftV2Args> microsoftV2) {
         ...
         * 
         */
        public Builder microsoftV2(LinuxFunctionAppAuthSettingsV2MicrosoftV2Args microsoftV2) {
         ...
         * 
         */
        public Builder twitterV2(@Nullable Output<LinuxFunctionAppAuthSettingsV2TwitterV2Args> twitterV2) {
            $.twitterV2 = twitterV2;
            return this;
        }
         ...
         * 
         */
        public Builder twitterV2(LinuxFunctionAppAuthSettingsV2TwitterV2Args twitterV2) {
        ...
        public LinuxFunctionAppAuthSettingsV2Args build() {
            if ($.login == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2Args", "login");
            }
            return $;
        }
    }
