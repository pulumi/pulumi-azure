...
public final class SlotLogsHttpLogsFileSystemArgs extends com.pulumi.resources.ResourceArgs {

    public static final SlotLogsHttpLogsFileSystemArgs Empty = new SlotLogsHttpLogsFileSystemArgs();
    ...
    private SlotLogsHttpLogsFileSystemArgs() {}

    private SlotLogsHttpLogsFileSystemArgs(SlotLogsHttpLogsFileSystemArgs $) {
    ...
    public static Builder builder(SlotLogsHttpLogsFileSystemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SlotLogsHttpLogsFileSystemArgs();
        }

        public Builder(SlotLogsHttpLogsFileSystemArgs defaults) {
            $ = new SlotLogsHttpLogsFileSystemArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SlotLogsHttpLogsFileSystemArgs build() {
            if ($.retentionInDays == null) {
                throw new MissingRequiredPropertyException("SlotLogsHttpLogsFileSystemArgs", "retentionInDays");
            }
            if ($.retentionInMb == null) {
                throw new MissingRequiredPropertyException("SlotLogsHttpLogsFileSystemArgs", "retentionInMb");
            }
            return $;
        }
    }
