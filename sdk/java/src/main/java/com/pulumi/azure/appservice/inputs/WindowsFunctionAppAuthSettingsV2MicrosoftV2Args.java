...
public final class WindowsFunctionAppAuthSettingsV2MicrosoftV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsFunctionAppAuthSettingsV2MicrosoftV2Args Empty = new WindowsFunctionAppAuthSettingsV2MicrosoftV2Args();
    ...
    private WindowsFunctionAppAuthSettingsV2MicrosoftV2Args() {}

    private WindowsFunctionAppAuthSettingsV2MicrosoftV2Args(WindowsFunctionAppAuthSettingsV2MicrosoftV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppAuthSettingsV2MicrosoftV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppAuthSettingsV2MicrosoftV2Args();
        }

        public Builder(WindowsFunctionAppAuthSettingsV2MicrosoftV2Args defaults) {
            $ = new WindowsFunctionAppAuthSettingsV2MicrosoftV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppAuthSettingsV2MicrosoftV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2MicrosoftV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2MicrosoftV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
