...
@CustomType
public final class LinuxWebAppSlotAuthSettingsV2GoogleV2 {
    /**
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2GoogleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxWebAppSlotAuthSettingsV2GoogleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2GoogleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2GoogleV2", "clientSecretSettingName");
            }
        ...
        public LinuxWebAppSlotAuthSettingsV2GoogleV2 build() {
            final var _resultValue = new LinuxWebAppSlotAuthSettingsV2GoogleV2();
