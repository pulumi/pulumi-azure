...
@CustomType
public final class LinuxWebAppSlotSiteConfigCors {
    /**
    ...
    private LinuxWebAppSlotSiteConfigCors(
    ...
    public static Builder builder(LinuxWebAppSlotSiteConfigCors defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LinuxWebAppSlotSiteConfigCors defaults) {
        ...
        public Builder supportCredentials(@Nullable Boolean supportCredentials) {
            ...
            return new LinuxWebAppSlotSiteConfigCors(allowedOrigins, supportCredentials);
        }
    }
}
