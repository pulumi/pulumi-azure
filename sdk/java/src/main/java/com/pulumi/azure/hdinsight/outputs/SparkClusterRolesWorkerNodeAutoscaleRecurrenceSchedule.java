...
public final class SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule {
    ...
    public static final class Builder {
        ...
        public Builder days(List<String> days) {
            if (days == null) {
              throw new MissingRequiredPropertyException("SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule", "days");
            }
            this.days = days;
            return this;
        }
        ...
        public Builder targetInstanceCount(Integer targetInstanceCount) {
            if (targetInstanceCount == null) {
              throw new MissingRequiredPropertyException("SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule", "targetInstanceCount");
            }
        ...
        public Builder time(String time) {
            if (time == null) {
              throw new MissingRequiredPropertyException("SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule", "time");
            }
            this.time = time;
            return this;
        }
        public SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule build() {
            final var _resultValue = new SparkClusterRolesWorkerNodeAutoscaleRecurrenceSchedule();
