...
public final class CertificateCertificatePolicyIssuerParameters {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("CertificateCertificatePolicyIssuerParameters", "name");
            }
            this.name = name;
            return this;
        }
        public CertificateCertificatePolicyIssuerParameters build() {
            final var _resultValue = new CertificateCertificatePolicyIssuerParameters();
