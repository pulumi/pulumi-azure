...
public final class EndpointDeliveryRuleUrlRewriteAction {
    ...
    public static final class Builder {
        ...
        public Builder destination(String destination) {
            if (destination == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRuleUrlRewriteAction", "destination");
            }
        ...
        public Builder sourcePattern(String sourcePattern) {
            if (sourcePattern == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRuleUrlRewriteAction", "sourcePattern");
            }
