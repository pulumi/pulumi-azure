    ...
    public static final class Builder {
        ...
        public ResourceDeploymentScriptAzureCliArgs build() {
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("ResourceDeploymentScriptAzureCliArgs", "resourceGroupName");
            }
            if ($.retentionInterval == null) {
                throw new MissingRequiredPropertyException("ResourceDeploymentScriptAzureCliArgs", "retentionInterval");
            }
            if ($.version == null) {
                throw new MissingRequiredPropertyException("ResourceDeploymentScriptAzureCliArgs", "version");
            }
            return $;
        }
    }
