    ...
    public static final class Builder {
        ...
        public Builder linkedServiceName(String linkedServiceName) {
            if (linkedServiceName == null) {
              throw new MissingRequiredPropertyException("LinkedServiceSqlServerKeyVaultConnectionString", "linkedServiceName");
            }
        ...
        public Builder secretName(String secretName) {
            if (secretName == null) {
              throw new MissingRequiredPropertyException("LinkedServiceSqlServerKeyVaultConnectionString", "secretName");
            }
