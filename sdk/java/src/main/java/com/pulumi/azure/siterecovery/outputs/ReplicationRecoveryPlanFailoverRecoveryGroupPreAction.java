...
@CustomType
public final class ReplicationRecoveryPlanFailoverRecoveryGroupPreAction {
    /**
    ...
    private ReplicationRecoveryPlanFailoverRecoveryGroupPreAction() {}
    /**
     * @return The fabric location of runbook or script. Possible values are `Primary` and `Recovery`. It must not be specified when `type` is `ManualActionDetails`.
     * 
     * &gt; **Note:** This is required when `type` is set to `AutomationRunbookActionDetails` or `ScriptActionDetails`.
    ...
    public static Builder builder(ReplicationRecoveryPlanFailoverRecoveryGroupPreAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ReplicationRecoveryPlanFailoverRecoveryGroupPreAction defaults) {
        ...
        public Builder failOverDirections(List<String> failOverDirections) {
            if (failOverDirections == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPreAction", "failOverDirections");
            }
        ...
        public Builder failOverTypes(List<String> failOverTypes) {
            if (failOverTypes == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPreAction", "failOverTypes");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPreAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanFailoverRecoveryGroupPreAction", "type");
            }
            this.type = type;
            return this;
        }
        public ReplicationRecoveryPlanFailoverRecoveryGroupPreAction build() {
            final var _resultValue = new ReplicationRecoveryPlanFailoverRecoveryGroupPreAction();
