...
public final class AnalyzerState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<AnalyzerIdentityArgs> identity;

    /**
     * @return An `identity` block as defined below.
     * 
     */
    public Optional<Output<AnalyzerIdentityArgs>> identity() {
    ...
    private @Nullable Output<AnalyzerStorageAccountArgs> storageAccount;

    /**
     * @return A `storage_account` block as defined below.
     * 
     */
    public Optional<Output<AnalyzerStorageAccountArgs>> storageAccount() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder identity(@Nullable Output<AnalyzerIdentityArgs> identity) {
            $.identity = identity;
            return this;
        }
         ...
         * 
         */
        public Builder identity(AnalyzerIdentityArgs identity) {
        ...
        /**
         * @param name Specifies the name of the Video Analyzer. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resourceGroupName The name of the resource group in which to create the Video Analyzer. Changing this forces a new resource to be created.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder storageAccount(@Nullable Output<AnalyzerStorageAccountArgs> storageAccount) {
         ...
         * 
         */
        public Builder storageAccount(AnalyzerStorageAccountArgs storageAccount) {
