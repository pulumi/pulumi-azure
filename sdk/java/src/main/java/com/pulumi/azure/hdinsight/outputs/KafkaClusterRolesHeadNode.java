...
public final class KafkaClusterRolesHeadNode {
    ...
    public static final class Builder {
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("KafkaClusterRolesHeadNode", "username");
            }
        ...
        public Builder vmSize(String vmSize) {
            if (vmSize == null) {
              throw new MissingRequiredPropertyException("KafkaClusterRolesHeadNode", "vmSize");
            }
            this.vmSize = vmSize;
            return this;
        }
        public KafkaClusterRolesHeadNode build() {
            final var _resultValue = new KafkaClusterRolesHeadNode();
