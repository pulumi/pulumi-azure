    ...
    public static final class Builder {
        ...
        public Builder retentionInDays(Integer retentionInDays) {
            if (retentionInDays == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppLogsHttpLogsFileSystem", "retentionInDays");
            }
        ...
        public Builder retentionInMb(Integer retentionInMb) {
            if (retentionInMb == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppLogsHttpLogsFileSystem", "retentionInMb");
            }
