...
public final class ActionRuleActionGroupConditionAlertRuleId {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionAlertRuleId", "operator");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("ActionRuleActionGroupConditionAlertRuleId", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public ActionRuleActionGroupConditionAlertRuleId build() {
            final var _resultValue = new ActionRuleActionGroupConditionAlertRuleId();
