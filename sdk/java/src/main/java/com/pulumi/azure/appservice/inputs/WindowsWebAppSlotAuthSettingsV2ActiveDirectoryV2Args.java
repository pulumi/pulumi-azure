...
public final class WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args Empty = new WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args();
    ...
    private WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args() {}

    private WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args(WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args $) {
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args();
        }

        public Builder(WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args defaults) {
            $ = new WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args", "clientId");
            }
            if ($.tenantAuthEndpoint == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2ActiveDirectoryV2Args", "tenantAuthEndpoint");
            }
            return $;
        }
    }
