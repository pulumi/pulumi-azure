...
@CustomType
public final class LinuxFunctionAppAuthSettingsV2AppleV2 {
    /**
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2AppleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxFunctionAppAuthSettingsV2AppleV2 defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2AppleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2AppleV2", "clientSecretSettingName");
            }
        ...
        public LinuxFunctionAppAuthSettingsV2AppleV2 build() {
            final var _resultValue = new LinuxFunctionAppAuthSettingsV2AppleV2();
