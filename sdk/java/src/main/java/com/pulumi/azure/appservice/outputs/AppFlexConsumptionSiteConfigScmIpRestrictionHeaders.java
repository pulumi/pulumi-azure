...
@CustomType
public final class AppFlexConsumptionSiteConfigScmIpRestrictionHeaders {
    /**
    ...
    public static Builder builder(AppFlexConsumptionSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> xForwardedHosts;
        public Builder() {}
        public Builder(AppFlexConsumptionSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        public AppFlexConsumptionSiteConfigScmIpRestrictionHeaders build() {
            final var _resultValue = new AppFlexConsumptionSiteConfigScmIpRestrictionHeaders();
