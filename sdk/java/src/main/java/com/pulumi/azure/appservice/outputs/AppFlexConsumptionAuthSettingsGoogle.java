...
@CustomType
public final class AppFlexConsumptionAuthSettingsGoogle {
    /**
    ...
    private AppFlexConsumptionAuthSettingsGoogle() {}
    /**
     * @return The OpenID Connect Client ID for the Google web application.
     * 
     */
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsGoogle defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(AppFlexConsumptionAuthSettingsGoogle defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsGoogle", "clientId");
            }
        ...
        public AppFlexConsumptionAuthSettingsGoogle build() {
            final var _resultValue = new AppFlexConsumptionAuthSettingsGoogle();
