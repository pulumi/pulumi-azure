...
@CustomType
public final class InteractiveQueryClusterStorageAccountGen2 {
    /**
    ...
    public static Builder builder(InteractiveQueryClusterStorageAccountGen2 defaults) {
    ...
    public static final class Builder {
        ...
        private String storageResourceId;
        public Builder() {}
        public Builder(InteractiveQueryClusterStorageAccountGen2 defaults) {
        ...
        public Builder filesystemId(String filesystemId) {
            if (filesystemId == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2", "filesystemId");
            }
        ...
        public Builder isDefault(Boolean isDefault) {
            if (isDefault == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2", "isDefault");
            }
        ...
        public Builder managedIdentityResourceId(String managedIdentityResourceId) {
            if (managedIdentityResourceId == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2", "managedIdentityResourceId");
            }
        ...
        public Builder storageResourceId(String storageResourceId) {
            if (storageResourceId == null) {
              throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2", "storageResourceId");
            }
            this.storageResourceId = storageResourceId;
            return this;
        }
        public InteractiveQueryClusterStorageAccountGen2 build() {
            final var _resultValue = new InteractiveQueryClusterStorageAccountGen2();
