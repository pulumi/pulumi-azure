...
public final class AccountStorageAccountManagedIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountStorageAccountManagedIdentityArgs Empty = new AccountStorageAccountManagedIdentityArgs();
    ...
    private AccountStorageAccountManagedIdentityArgs() {}

    private AccountStorageAccountManagedIdentityArgs(AccountStorageAccountManagedIdentityArgs $) {
    ...
    public static Builder builder(AccountStorageAccountManagedIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountStorageAccountManagedIdentityArgs();
        }

        public Builder(AccountStorageAccountManagedIdentityArgs defaults) {
            $ = new AccountStorageAccountManagedIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountStorageAccountManagedIdentityArgs build() {
            return $;
        }
    }
