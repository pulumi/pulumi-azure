...
public final class SlotStorageAccount {
    ...
    public static final class Builder {
        ...
        public Builder accessKey(String accessKey) {
            if (accessKey == null) {
              throw new MissingRequiredPropertyException("SlotStorageAccount", "accessKey");
            }
        ...
        public Builder accountName(String accountName) {
            if (accountName == null) {
              throw new MissingRequiredPropertyException("SlotStorageAccount", "accountName");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("SlotStorageAccount", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder shareName(String shareName) {
            if (shareName == null) {
              throw new MissingRequiredPropertyException("SlotStorageAccount", "shareName");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("SlotStorageAccount", "type");
            }
            this.type = type;
            return this;
        }
        public SlotStorageAccount build() {
            final var _resultValue = new SlotStorageAccount();
