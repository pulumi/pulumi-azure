...
public class ServicesCommunicationsGateway extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="apiBridge", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="autoGeneratedDomainNameLabelScope", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="codecs", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="connectivity", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="e911Type", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="emergencyDialStrings", type=List.class, parameters={String.class})
     ...
     * 
     */
    @Export(name="microsoftTeamsVoicemailPilotNumber", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="onPremMcpEnabled", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="serviceLocations", type=List.class, parameters={ServicesCommunicationsGatewayServiceLocation.class})
