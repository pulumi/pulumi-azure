...
import com.pulumi.azure.appservice.inputs.LinuxWebAppSlotSiteConfigScmIpRestrictionHeadersArgs;
...
public final class LinuxWebAppSlotSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="headers")
    private @Nullable Output<LinuxWebAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<LinuxWebAppSlotSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private LinuxWebAppSlotSiteConfigScmIpRestrictionArgs() {}

    private LinuxWebAppSlotSiteConfigScmIpRestrictionArgs(LinuxWebAppSlotSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(LinuxWebAppSlotSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppSlotSiteConfigScmIpRestrictionArgs();
        }

        public Builder(LinuxWebAppSlotSiteConfigScmIpRestrictionArgs defaults) {
            $ = new LinuxWebAppSlotSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<LinuxWebAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(LinuxWebAppSlotSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public LinuxWebAppSlotSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
