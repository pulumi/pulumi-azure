...
import com.pulumi.azure.apimanagement.inputs.ApiDiagnosticBackendResponseDataMaskingArgs;
...
public final class ApiDiagnosticBackendResponseArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiDiagnosticBackendResponseArgs Empty = new ApiDiagnosticBackendResponseArgs();
    ...
    private @Nullable Output<ApiDiagnosticBackendResponseDataMaskingArgs> dataMasking;

    /**
     * @return A `dataMasking` block as defined below.
     * 
     */
    public Optional<Output<ApiDiagnosticBackendResponseDataMaskingArgs>> dataMasking() {
    ...
    private ApiDiagnosticBackendResponseArgs() {}

    private ApiDiagnosticBackendResponseArgs(ApiDiagnosticBackendResponseArgs $) {
    ...
    public static Builder builder(ApiDiagnosticBackendResponseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiDiagnosticBackendResponseArgs();
        }

        public Builder(ApiDiagnosticBackendResponseArgs defaults) {
            $ = new ApiDiagnosticBackendResponseArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder dataMasking(@Nullable Output<ApiDiagnosticBackendResponseDataMaskingArgs> dataMasking) {
         ...
         * 
         */
        public Builder dataMasking(ApiDiagnosticBackendResponseDataMaskingArgs dataMasking) {
        ...
        public ApiDiagnosticBackendResponseArgs build() {
            return $;
        }
    }
