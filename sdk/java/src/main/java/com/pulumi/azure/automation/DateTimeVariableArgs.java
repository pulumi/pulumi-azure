...
public final class DateTimeVariableArgs extends com.pulumi.resources.ResourceArgs {

    public static final DateTimeVariableArgs Empty = new DateTimeVariableArgs();
    ...
    private DateTimeVariableArgs() {}

    private DateTimeVariableArgs(DateTimeVariableArgs $) {
    ...
    public static Builder builder(DateTimeVariableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DateTimeVariableArgs();
        }

        public Builder(DateTimeVariableArgs defaults) {
            $ = new DateTimeVariableArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param value The value of the Automation Variable in the [RFC3339 Section 5.6 Internet Date/Time Format](https://tools.ietf.org/html/rfc3339#section-5.6).
         * 
         * @return builder
         * 
         */
        ...
        public DateTimeVariableArgs build() {
            if ($.automationAccountName == null) {
                throw new MissingRequiredPropertyException("DateTimeVariableArgs", "automationAccountName");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("DateTimeVariableArgs", "resourceGroupName");
            }
            return $;
        }
    }
