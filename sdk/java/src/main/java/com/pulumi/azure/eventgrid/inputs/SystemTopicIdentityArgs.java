...
public final class SystemTopicIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final SystemTopicIdentityArgs Empty = new SystemTopicIdentityArgs();
    ...
    private SystemTopicIdentityArgs() {}

    private SystemTopicIdentityArgs(SystemTopicIdentityArgs $) {
    ...
    public static Builder builder(SystemTopicIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SystemTopicIdentityArgs();
        }

        public Builder(SystemTopicIdentityArgs defaults) {
            $ = new SystemTopicIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param type Specifies the type of Managed Service Identity that should be configured on this Event Grid System Topic. Possible values are `SystemAssigned`, `UserAssigned`, and `SystemAssigned, UserAssigned`.
         * 
         * @return builder
         * 
         */
        ...
        public SystemTopicIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("SystemTopicIdentityArgs", "type");
            }
            return $;
        }
    }
