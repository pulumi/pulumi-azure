...
@CustomType
public final class LinuxWebAppSlotAuthSettingsV2FacebookV2 {
    /**
    ...
    private LinuxWebAppSlotAuthSettingsV2FacebookV2() {}
    /**
     * @return The App ID of the Facebook app used for login.
     * 
     */
    ...
    public static Builder builder(LinuxWebAppSlotAuthSettingsV2FacebookV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(LinuxWebAppSlotAuthSettingsV2FacebookV2 defaults) {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2FacebookV2", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder appSecretSettingName(String appSecretSettingName) {
            if (appSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotAuthSettingsV2FacebookV2", "appSecretSettingName");
            }
        ...
        public LinuxWebAppSlotAuthSettingsV2FacebookV2 build() {
            final var _resultValue = new LinuxWebAppSlotAuthSettingsV2FacebookV2();
