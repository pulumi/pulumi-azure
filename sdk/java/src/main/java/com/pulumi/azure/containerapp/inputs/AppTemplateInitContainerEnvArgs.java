...
public final class AppTemplateInitContainerEnvArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private AppTemplateInitContainerEnvArgs() {}

    private AppTemplateInitContainerEnvArgs(AppTemplateInitContainerEnvArgs $) {
        this.name = $.name;
    ...
    public static Builder builder(AppTemplateInitContainerEnvArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppTemplateInitContainerEnvArgs();
        }

        public Builder(AppTemplateInitContainerEnvArgs defaults) {
            $ = new AppTemplateInitContainerEnvArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppTemplateInitContainerEnvArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("AppTemplateInitContainerEnvArgs", "name");
            }
            return $;
        }
    }
