...
public final class AssetFilterState extends com.pulumi.resources.ResourceArgs {

    public static final AssetFilterState Empty = new AssetFilterState();
    ...
    private AssetFilterState() {}

    private AssetFilterState(AssetFilterState $) {
    ...
    public static Builder builder(AssetFilterState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AssetFilterState();
        }

        public Builder(AssetFilterState defaults) {
            $ = new AssetFilterState(Objects.requireNonNull(defaults));
        }
