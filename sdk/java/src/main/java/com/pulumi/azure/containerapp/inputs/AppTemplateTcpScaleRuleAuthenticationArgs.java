...
public final class AppTemplateTcpScaleRuleAuthenticationArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppTemplateTcpScaleRuleAuthenticationArgs Empty = new AppTemplateTcpScaleRuleAuthenticationArgs();
    ...
    private AppTemplateTcpScaleRuleAuthenticationArgs() {}

    private AppTemplateTcpScaleRuleAuthenticationArgs(AppTemplateTcpScaleRuleAuthenticationArgs $) {
    ...
    public static Builder builder(AppTemplateTcpScaleRuleAuthenticationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppTemplateTcpScaleRuleAuthenticationArgs();
        }

        public Builder(AppTemplateTcpScaleRuleAuthenticationArgs defaults) {
            $ = new AppTemplateTcpScaleRuleAuthenticationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppTemplateTcpScaleRuleAuthenticationArgs build() {
            if ($.secretName == null) {
                throw new MissingRequiredPropertyException("AppTemplateTcpScaleRuleAuthenticationArgs", "secretName");
            }
            return $;
        }
    }
