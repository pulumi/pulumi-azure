...
public final class RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs Empty = new RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs();
    ...
    private RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs() {}

    private RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs(RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs $) {
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs();
        }

        public Builder(RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs defaults) {
            $ = new RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs build() {
            if ($.defaultRecipients == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs", "defaultRecipients");
            }
            if ($.notificationLevel == null) {
                throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleAssignmentsAdminNotificationsArgs", "notificationLevel");
            }
            return $;
        }
    }
