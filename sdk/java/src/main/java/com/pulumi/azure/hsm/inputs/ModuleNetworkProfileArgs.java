...
public final class ModuleNetworkProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModuleNetworkProfileArgs Empty = new ModuleNetworkProfileArgs();
    ...
    private ModuleNetworkProfileArgs() {}

    private ModuleNetworkProfileArgs(ModuleNetworkProfileArgs $) {
    ...
    public static Builder builder(ModuleNetworkProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModuleNetworkProfileArgs();
        }

        public Builder(ModuleNetworkProfileArgs defaults) {
            $ = new ModuleNetworkProfileArgs(Objects.requireNonNull(defaults));
        }
