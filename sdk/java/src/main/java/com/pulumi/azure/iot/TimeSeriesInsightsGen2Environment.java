...
public class TimeSeriesInsightsGen2Environment extends com.pulumi.resources.CustomResource {
     ...
     */
    public TimeSeriesInsightsGen2Environment(java.lang.String name) {
     ...
     */
    public TimeSeriesInsightsGen2Environment(java.lang.String name, TimeSeriesInsightsGen2EnvironmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public TimeSeriesInsightsGen2Environment(java.lang.String name, TimeSeriesInsightsGen2EnvironmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/timeSeriesInsightsGen2Environment:TimeSeriesInsightsGen2Environment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TimeSeriesInsightsGen2Environment(java.lang.String name, Output<java.lang.String> id, @Nullable TimeSeriesInsightsGen2EnvironmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:iot/timeSeriesInsightsGen2Environment:TimeSeriesInsightsGen2Environment", name, state, makeResourceOptions(options, id), false);
    }

    private static TimeSeriesInsightsGen2EnvironmentArgs makeArgs(TimeSeriesInsightsGen2EnvironmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? TimeSeriesInsightsGen2EnvironmentArgs.Empty : args;
    }
     ...
     */
    public static TimeSeriesInsightsGen2Environment get(java.lang.String name, Output<java.lang.String> id, @Nullable TimeSeriesInsightsGen2EnvironmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
