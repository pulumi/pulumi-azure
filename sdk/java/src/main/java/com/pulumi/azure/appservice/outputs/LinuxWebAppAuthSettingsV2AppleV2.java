...
public final class LinuxWebAppAuthSettingsV2AppleV2 {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2AppleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2AppleV2", "clientSecretSettingName");
            }
        ...
        public LinuxWebAppAuthSettingsV2AppleV2 build() {
            final var _resultValue = new LinuxWebAppAuthSettingsV2AppleV2();
