...
public final class LinuxWebAppAuthSettingsV2GoogleV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private LinuxWebAppAuthSettingsV2GoogleV2Args() {}

    private LinuxWebAppAuthSettingsV2GoogleV2Args(LinuxWebAppAuthSettingsV2GoogleV2Args $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2GoogleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsV2GoogleV2Args();
        }

        public Builder(LinuxWebAppAuthSettingsV2GoogleV2Args defaults) {
            $ = new LinuxWebAppAuthSettingsV2GoogleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsV2GoogleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2GoogleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2GoogleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
