...
@CustomType
public final class AlertRuleScheduledIncidentGrouping {
    /**
    ...
    private AlertRuleScheduledIncidentGrouping() {}
    /**
     * @return A list of alert details to group by, only when the `entity_matching_method` is `Selected`. Possible values are `DisplayName` and `Severity`.
     * 
     */
    ...
    public static Builder builder(AlertRuleScheduledIncidentGrouping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean reopenClosedIncidents;
        public Builder() {}
        public Builder(AlertRuleScheduledIncidentGrouping defaults) {
        ...
        public AlertRuleScheduledIncidentGrouping build() {
            final var _resultValue = new AlertRuleScheduledIncidentGrouping();
