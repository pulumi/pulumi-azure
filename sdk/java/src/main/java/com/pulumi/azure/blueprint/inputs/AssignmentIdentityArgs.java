...
public final class AssignmentIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final AssignmentIdentityArgs Empty = new AssignmentIdentityArgs();
    ...
    private AssignmentIdentityArgs() {}

    private AssignmentIdentityArgs(AssignmentIdentityArgs $) {
    ...
    public static Builder builder(AssignmentIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AssignmentIdentityArgs();
        }

        public Builder(AssignmentIdentityArgs defaults) {
            $ = new AssignmentIdentityArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param identityIds Specifies a list of User Assigned Managed Identity IDs to be assigned to this Blueprint.
         * 
         * @return builder
         * 
         */
        ...
        public AssignmentIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("AssignmentIdentityArgs", "type");
            }
            return $;
        }
    }
