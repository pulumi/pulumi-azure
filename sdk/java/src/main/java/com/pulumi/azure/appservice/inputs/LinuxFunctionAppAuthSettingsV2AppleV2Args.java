...
public final class LinuxFunctionAppAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private LinuxFunctionAppAuthSettingsV2AppleV2Args() {}

    private LinuxFunctionAppAuthSettingsV2AppleV2Args(LinuxFunctionAppAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppAuthSettingsV2AppleV2Args();
        }

        public Builder(LinuxFunctionAppAuthSettingsV2AppleV2Args defaults) {
            $ = new LinuxFunctionAppAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppAuthSettingsV2AppleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2AppleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2AppleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
