...
public final class LinuxFunctionAppAuthSettingsV2MicrosoftV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public LinuxFunctionAppAuthSettingsV2MicrosoftV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2MicrosoftV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsV2MicrosoftV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
