...
import com.pulumi.azure.appservice.outputs.WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders;
...
public final class WindowsFunctionAppSlotSiteConfigScmIpRestriction {
     ...
     * 
     */
    private final @Nullable WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers;
    /**
    ...
    private WindowsFunctionAppSlotSiteConfigScmIpRestriction(
        ...
        @CustomType.Parameter("headers") @Nullable WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers,
     ...
     * 
     */
    public Optional<WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders> headers() {
    ...
    public static Builder builder(WindowsFunctionAppSlotSiteConfigScmIpRestriction defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable String action;
        private @Nullable WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers;
        ...
        public Builder(WindowsFunctionAppSlotSiteConfigScmIpRestriction defaults) {
        ...
        public Builder headers(@Nullable WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeaders headers) {
            this.headers = headers;
            return this;
        }
        ...
        public Builder virtualNetworkSubnetId(@Nullable String virtualNetworkSubnetId) {
            this.virtualNetworkSubnetId = virtualNetworkSubnetId;
            return this;
        }        public WindowsFunctionAppSlotSiteConfigScmIpRestriction build() {
            return new WindowsFunctionAppSlotSiteConfigScmIpRestriction(action, headers, ipAddress, name, priority, serviceTag, virtualNetworkSubnetId);
        }
    }
}
