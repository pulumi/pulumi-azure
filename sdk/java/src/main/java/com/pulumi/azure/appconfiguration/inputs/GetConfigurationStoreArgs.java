...
public final class GetConfigurationStoreArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetConfigurationStoreArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetConfigurationStoreArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetConfigurationStoreArgs", "resourceGroupName");
            }
            return $;
        }
    }
