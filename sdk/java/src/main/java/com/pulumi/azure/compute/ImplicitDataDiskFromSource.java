...
public class ImplicitDataDiskFromSource extends com.pulumi.resources.CustomResource {
    ...
    public ImplicitDataDiskFromSource(String name, ImplicitDataDiskFromSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:compute/implicitDataDiskFromSource:ImplicitDataDiskFromSource", name, args == null ? ImplicitDataDiskFromSourceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
