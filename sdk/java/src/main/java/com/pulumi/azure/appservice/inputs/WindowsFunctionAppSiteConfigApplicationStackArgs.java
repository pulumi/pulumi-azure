...
public final class WindowsFunctionAppSiteConfigApplicationStackArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param javaVersion The Version of Java to use. Supported versions include `1.8`, `11`, `17`, `21`, `25` (In-Preview).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param powershellCoreVersion The version of PowerShell Core to run. Possible values are `7`, `7.2`, `7.4`, and `7.6`.
         * 
         * &gt; **Note:** A value of `7` will provide the latest stable version. `7.2` is in preview at the time of writing.
         * 
         * @return builder
