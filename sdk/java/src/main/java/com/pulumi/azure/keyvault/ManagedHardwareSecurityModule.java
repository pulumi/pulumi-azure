...
public class ManagedHardwareSecurityModule extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="securityDomainEncryptedData", type=String.class, parameters={})
     ...
     * 
     */
    @Export(name="securityDomainKeyVaultCertificateIds", type=List.class, parameters={String.class})
     ...
     * 
     */
    @Export(name="securityDomainQuorum", type=Integer.class, parameters={})
