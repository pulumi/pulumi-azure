...
public final class GetWorkspacePlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return The name of this Synapse Workspace.
     * 
     */
    public String name() {
        return this.name;
    ...
    /**
     * @return The name of the Resource Group where the Synapse Workspace exists.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param name The name of this Synapse Workspace.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resourceGroupName The name of the Resource Group where the Synapse Workspace exists.
         * 
         * @return builder
         * 
         */
