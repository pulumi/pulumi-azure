...
public final class AccountCostManagementExportExportDataOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccountCostManagementExportExportDataOptionsArgs Empty = new AccountCostManagementExportExportDataOptionsArgs();
    ...
    private AccountCostManagementExportExportDataOptionsArgs() {}

    private AccountCostManagementExportExportDataOptionsArgs(AccountCostManagementExportExportDataOptionsArgs $) {
    ...
    public static Builder builder(AccountCostManagementExportExportDataOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccountCostManagementExportExportDataOptionsArgs();
        }

        public Builder(AccountCostManagementExportExportDataOptionsArgs defaults) {
            $ = new AccountCostManagementExportExportDataOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AccountCostManagementExportExportDataOptionsArgs build() {
            if ($.timeFrame == null) {
                throw new MissingRequiredPropertyException("AccountCostManagementExportExportDataOptionsArgs", "timeFrame");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("AccountCostManagementExportExportDataOptionsArgs", "type");
            }
            return $;
        }
    }
