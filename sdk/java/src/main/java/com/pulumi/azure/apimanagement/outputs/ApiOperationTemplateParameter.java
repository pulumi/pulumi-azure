...
import com.pulumi.azure.apimanagement.outputs.ApiOperationTemplateParameterExample;
...
@CustomType
public final class ApiOperationTemplateParameter {
    /**
     ...
     * 
     */
    private @Nullable List<ApiOperationTemplateParameterExample> examples;
    /**
     ...
     * 
     */
    public List<ApiOperationTemplateParameterExample> examples() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder examples(@Nullable List<ApiOperationTemplateParameterExample> examples) {

            this.examples = examples;
            return this;
        }
        public Builder examples(ApiOperationTemplateParameterExample... examples) {
            return examples(List.of(examples));
        }
        @CustomType.Setter
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ApiOperationTemplateParameter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder required(Boolean required) {
            if (required == null) {
              throw new MissingRequiredPropertyException("ApiOperationTemplateParameter", "required");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ApiOperationTemplateParameter", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public ApiOperationTemplateParameter build() {
            final var _resultValue = new ApiOperationTemplateParameter();
