...
@CustomType
public final class GetDataCollectionRuleDataSourceIisLog {
    /**
    ...
    private GetDataCollectionRuleDataSourceIisLog() {}
    /**
     * @return Specifies a list of absolute paths where the log files are located.
     * 
     */
    ...
    public static Builder builder(GetDataCollectionRuleDataSourceIisLog defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> streams;
        public Builder() {}
        public Builder(GetDataCollectionRuleDataSourceIisLog defaults) {
        ...
        public Builder logDirectories(List<String> logDirectories) {
            if (logDirectories == null) {
              throw new MissingRequiredPropertyException("GetDataCollectionRuleDataSourceIisLog", "logDirectories");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDataCollectionRuleDataSourceIisLog", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder streams(List<String> streams) {
            if (streams == null) {
              throw new MissingRequiredPropertyException("GetDataCollectionRuleDataSourceIisLog", "streams");
            }
        ...
        public GetDataCollectionRuleDataSourceIisLog build() {
            final var _resultValue = new GetDataCollectionRuleDataSourceIisLog();
