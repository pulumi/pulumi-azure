    ...
    public static final class Builder {
        ...
        public InteractiveQueryClusterStorageAccountGen2Args build() {
            ...
            if ($.storageAccountId == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2Args", "storageAccountId");
            }
            if ($.userAssignedIdentityId == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2Args", "userAssignedIdentityId");
            }
            return $;
        }
    }
