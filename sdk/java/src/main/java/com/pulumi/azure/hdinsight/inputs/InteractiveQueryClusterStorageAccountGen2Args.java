...
public final class InteractiveQueryClusterStorageAccountGen2Args extends com.pulumi.resources.ResourceArgs {

    public static final InteractiveQueryClusterStorageAccountGen2Args Empty = new InteractiveQueryClusterStorageAccountGen2Args();
    ...
    private InteractiveQueryClusterStorageAccountGen2Args() {}

    private InteractiveQueryClusterStorageAccountGen2Args(InteractiveQueryClusterStorageAccountGen2Args $) {
    ...
    public static Builder builder(InteractiveQueryClusterStorageAccountGen2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InteractiveQueryClusterStorageAccountGen2Args();
        }

        public Builder(InteractiveQueryClusterStorageAccountGen2Args defaults) {
            $ = new InteractiveQueryClusterStorageAccountGen2Args(Objects.requireNonNull(defaults));
        }
        ...
        public InteractiveQueryClusterStorageAccountGen2Args build() {
            if ($.filesystemId == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2Args", "filesystemId");
            }
            if ($.isDefault == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2Args", "isDefault");
            }
            if ($.managedIdentityResourceId == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2Args", "managedIdentityResourceId");
            }
            if ($.storageResourceId == null) {
                throw new MissingRequiredPropertyException("InteractiveQueryClusterStorageAccountGen2Args", "storageResourceId");
            }
            return $;
        }
    }
