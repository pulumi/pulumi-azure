...
public final class CreatorState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<Integer> storageUnits;

    /**
     * @return The storage units to be allocated. Integer values from 1 to 100, inclusive.
     * 
     */
    public Optional<Output<Integer>> storageUnits() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder mapsAccountId(@Nullable Output<String> mapsAccountId) {
         ...
         * 
         */
        public Builder storageUnits(@Nullable Output<Integer> storageUnits) {
