...
public final class IoTHubFileUploadArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder notifications(@Nullable Output<Boolean> notifications) {
