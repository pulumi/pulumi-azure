...
public final class KafkaClusterMetastoresHiveArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private KafkaClusterMetastoresHiveArgs() {}

    private KafkaClusterMetastoresHiveArgs(KafkaClusterMetastoresHiveArgs $) {
    ...
    public static Builder builder(KafkaClusterMetastoresHiveArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new KafkaClusterMetastoresHiveArgs();
        }

        public Builder(KafkaClusterMetastoresHiveArgs defaults) {
            $ = new KafkaClusterMetastoresHiveArgs(Objects.requireNonNull(defaults));
        }
        ...
        public KafkaClusterMetastoresHiveArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("KafkaClusterMetastoresHiveArgs", "databaseName");
            }
            if ($.password == null) {
                throw new MissingRequiredPropertyException("KafkaClusterMetastoresHiveArgs", "password");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("KafkaClusterMetastoresHiveArgs", "server");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("KafkaClusterMetastoresHiveArgs", "username");
            }
            return $;
        }
    }
