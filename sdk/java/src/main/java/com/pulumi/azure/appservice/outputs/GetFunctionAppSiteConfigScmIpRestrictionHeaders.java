...
@CustomType
public final class GetFunctionAppSiteConfigScmIpRestrictionHeaders {
    ...
    private GetFunctionAppSiteConfigScmIpRestrictionHeaders() {}
    ...
    public static Builder builder(GetFunctionAppSiteConfigScmIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> xForwardedHosts;
        public Builder() {}
        public Builder(GetFunctionAppSiteConfigScmIpRestrictionHeaders defaults) {
        ...
        public Builder xAzureFdids(List<String> xAzureFdids) {
            if (xAzureFdids == null) {
              throw new MissingRequiredPropertyException("GetFunctionAppSiteConfigScmIpRestrictionHeaders", "xAzureFdids");
            }
        ...
        public Builder xFdHealthProbes(List<String> xFdHealthProbes) {
            if (xFdHealthProbes == null) {
              throw new MissingRequiredPropertyException("GetFunctionAppSiteConfigScmIpRestrictionHeaders", "xFdHealthProbes");
            }
        ...
        public Builder xForwardedFors(List<String> xForwardedFors) {
            if (xForwardedFors == null) {
              throw new MissingRequiredPropertyException("GetFunctionAppSiteConfigScmIpRestrictionHeaders", "xForwardedFors");
            }
        ...
        public Builder xForwardedHosts(List<String> xForwardedHosts) {
            if (xForwardedHosts == null) {
              throw new MissingRequiredPropertyException("GetFunctionAppSiteConfigScmIpRestrictionHeaders", "xForwardedHosts");
            }
        ...
        public GetFunctionAppSiteConfigScmIpRestrictionHeaders build() {
            final var _resultValue = new GetFunctionAppSiteConfigScmIpRestrictionHeaders();
