...
public final class LinuxFunctionAppSlotAuthSettingsV2LoginArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSlotAuthSettingsV2LoginArgs Empty = new LinuxFunctionAppSlotAuthSettingsV2LoginArgs();
    ...
    private LinuxFunctionAppSlotAuthSettingsV2LoginArgs() {}

    private LinuxFunctionAppSlotAuthSettingsV2LoginArgs(LinuxFunctionAppSlotAuthSettingsV2LoginArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppSlotAuthSettingsV2LoginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSlotAuthSettingsV2LoginArgs();
        }

        public Builder(LinuxFunctionAppSlotAuthSettingsV2LoginArgs defaults) {
            $ = new LinuxFunctionAppSlotAuthSettingsV2LoginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSlotAuthSettingsV2LoginArgs build() {
            return $;
        }
    }
