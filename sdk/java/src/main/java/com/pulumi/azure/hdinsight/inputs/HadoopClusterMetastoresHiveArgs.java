...
public final class HadoopClusterMetastoresHiveArgs extends com.pulumi.resources.ResourceArgs {

    public static final HadoopClusterMetastoresHiveArgs Empty = new HadoopClusterMetastoresHiveArgs();
    ...
    private HadoopClusterMetastoresHiveArgs() {}

    private HadoopClusterMetastoresHiveArgs(HadoopClusterMetastoresHiveArgs $) {
    ...
    public static Builder builder(HadoopClusterMetastoresHiveArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HadoopClusterMetastoresHiveArgs();
        }

        public Builder(HadoopClusterMetastoresHiveArgs defaults) {
            $ = new HadoopClusterMetastoresHiveArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HadoopClusterMetastoresHiveArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("HadoopClusterMetastoresHiveArgs", "databaseName");
            }
            if ($.password == null) {
                throw new MissingRequiredPropertyException("HadoopClusterMetastoresHiveArgs", "password");
            }
            if ($.server == null) {
                throw new MissingRequiredPropertyException("HadoopClusterMetastoresHiveArgs", "server");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("HadoopClusterMetastoresHiveArgs", "username");
            }
            return $;
        }
    }
