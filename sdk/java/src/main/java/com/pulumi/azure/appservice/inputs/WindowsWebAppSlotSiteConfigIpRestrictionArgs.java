...
import com.pulumi.azure.appservice.inputs.WindowsWebAppSlotSiteConfigIpRestrictionHeadersArgs;
...
public final class WindowsWebAppSlotSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotSiteConfigIpRestrictionArgs Empty = new WindowsWebAppSlotSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<WindowsWebAppSlotSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<WindowsWebAppSlotSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private WindowsWebAppSlotSiteConfigIpRestrictionArgs() {}

    private WindowsWebAppSlotSiteConfigIpRestrictionArgs(WindowsWebAppSlotSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(WindowsWebAppSlotSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotSiteConfigIpRestrictionArgs();
        }

        public Builder(WindowsWebAppSlotSiteConfigIpRestrictionArgs defaults) {
            $ = new WindowsWebAppSlotSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<WindowsWebAppSlotSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(WindowsWebAppSlotSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public WindowsWebAppSlotSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
