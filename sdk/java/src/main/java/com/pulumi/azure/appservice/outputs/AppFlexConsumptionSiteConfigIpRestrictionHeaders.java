...
@CustomType
public final class AppFlexConsumptionSiteConfigIpRestrictionHeaders {
    /**
    ...
    public static Builder builder(AppFlexConsumptionSiteConfigIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> xForwardedHosts;
        public Builder() {}
        public Builder(AppFlexConsumptionSiteConfigIpRestrictionHeaders defaults) {
        ...
        public AppFlexConsumptionSiteConfigIpRestrictionHeaders build() {
            final var _resultValue = new AppFlexConsumptionSiteConfigIpRestrictionHeaders();
