...
public final class LabAutoShutdownArgs extends com.pulumi.resources.ResourceArgs {

    public static final LabAutoShutdownArgs Empty = new LabAutoShutdownArgs();
    ...
    private LabAutoShutdownArgs() {}

    private LabAutoShutdownArgs(LabAutoShutdownArgs $) {
    ...
    public static Builder builder(LabAutoShutdownArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LabAutoShutdownArgs();
        }

        public Builder(LabAutoShutdownArgs defaults) {
            $ = new LabAutoShutdownArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LabAutoShutdownArgs build() {
            return $;
        }
    }
