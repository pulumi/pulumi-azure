...
public final class WindowsWebAppSlotAuthSettingsV2FacebookV2Args extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSlotAuthSettingsV2FacebookV2Args Empty = new WindowsWebAppSlotAuthSettingsV2FacebookV2Args();
    ...
    private WindowsWebAppSlotAuthSettingsV2FacebookV2Args() {}

    private WindowsWebAppSlotAuthSettingsV2FacebookV2Args(WindowsWebAppSlotAuthSettingsV2FacebookV2Args $) {
        this.appId = $.appId;
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2FacebookV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSlotAuthSettingsV2FacebookV2Args();
        }

        public Builder(WindowsWebAppSlotAuthSettingsV2FacebookV2Args defaults) {
            $ = new WindowsWebAppSlotAuthSettingsV2FacebookV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsWebAppSlotAuthSettingsV2FacebookV2Args build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2FacebookV2Args", "appId");
            }
            if ($.appSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2FacebookV2Args", "appSecretSettingName");
            }
            return $;
        }
    }
