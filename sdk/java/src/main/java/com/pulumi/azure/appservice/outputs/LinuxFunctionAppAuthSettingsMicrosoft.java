...
@CustomType
public final class LinuxFunctionAppAuthSettingsMicrosoft {
    /**
    ...
    private LinuxFunctionAppAuthSettingsMicrosoft() {}
    /**
     * @return The OAuth 2.0 client ID that was created for the app used for authentication.
     * 
     */
    ...
    public static Builder builder(LinuxFunctionAppAuthSettingsMicrosoft defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> oauthScopes;
        public Builder() {}
        public Builder(LinuxFunctionAppAuthSettingsMicrosoft defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppAuthSettingsMicrosoft", "clientId");
            }
        ...
        public LinuxFunctionAppAuthSettingsMicrosoft build() {
            final var _resultValue = new LinuxFunctionAppAuthSettingsMicrosoft();
