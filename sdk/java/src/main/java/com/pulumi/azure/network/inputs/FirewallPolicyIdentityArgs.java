...
public final class FirewallPolicyIdentityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final FirewallPolicyIdentityArgs Empty = new FirewallPolicyIdentityArgs();
    ...
    private FirewallPolicyIdentityArgs() {}
    ...
    public static Builder builder(FirewallPolicyIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirewallPolicyIdentityArgs();
        }

        public Builder(FirewallPolicyIdentityArgs defaults) {
            $ = new FirewallPolicyIdentityArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param identityIds Specifies a list of User Assigned Managed Identity IDs to be assigned to this Firewall Policy.
         * 
         * @return builder
         * 
         */
        ...
        public FirewallPolicyIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("FirewallPolicyIdentityArgs", "type");
            }
            return $;
        }
    }
