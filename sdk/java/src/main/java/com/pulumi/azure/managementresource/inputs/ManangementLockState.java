...
package com.pulumi.azure.managementresource.inputs;
...
public final class ManangementLockState extends com.pulumi.resources.ResourceArgs {

    public static final ManangementLockState Empty = new ManangementLockState();
    ...
    private ManangementLockState() {}

    private ManangementLockState(ManangementLockState $) {
    ...
    public static Builder builder(ManangementLockState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManangementLockState();
        }

        public Builder(ManangementLockState defaults) {
            $ = new ManangementLockState(Objects.requireNonNull(defaults));
        }
        ...
        public ManangementLockState build() {
            return $;
        }
    }
