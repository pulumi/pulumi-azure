...
@CustomType
public final class GetKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentity {
    /**
    ...
    private GetKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentity(
    ...
    public static Builder builder(GetKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentity defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentity defaults) {
        ...
        public Builder userAssignedIdentityId(String userAssignedIdentityId) {
            ...
            return new GetKubernetesClusterIngressApplicationGatewayIngressApplicationGatewayIdentity(clientId, objectId, userAssignedIdentityId);
        }
    }
}
