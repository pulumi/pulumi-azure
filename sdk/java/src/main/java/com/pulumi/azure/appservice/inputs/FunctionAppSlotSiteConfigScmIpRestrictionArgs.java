...
import com.pulumi.azure.appservice.inputs.FunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs;
...
public final class FunctionAppSlotSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionAppSlotSiteConfigScmIpRestrictionArgs Empty = new FunctionAppSlotSiteConfigScmIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<FunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return The `headers` block for this specific `scm_ip_restriction` as defined below.
     * 
     */
    public Optional<Output<FunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    private FunctionAppSlotSiteConfigScmIpRestrictionArgs() {}

    private FunctionAppSlotSiteConfigScmIpRestrictionArgs(FunctionAppSlotSiteConfigScmIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(FunctionAppSlotSiteConfigScmIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionAppSlotSiteConfigScmIpRestrictionArgs();
        }

        public Builder(FunctionAppSlotSiteConfigScmIpRestrictionArgs defaults) {
            $ = new FunctionAppSlotSiteConfigScmIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<FunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(FunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs headers) {
        ...
        public FunctionAppSlotSiteConfigScmIpRestrictionArgs build() {
            return $;
        }
    }
