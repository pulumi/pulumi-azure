...
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionSiteConfigAppServiceLogs;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionSiteConfigCors;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionSiteConfigIpRestriction;
import com.pulumi.azure.appservice.outputs.AppFlexConsumptionSiteConfigScmIpRestriction;
...
@CustomType
public final class AppFlexConsumptionSiteConfig {
    /**
     ...
     * 
     */
    private @Nullable AppFlexConsumptionSiteConfigCors cors;
    /**
     ...
     * 
     */
    public Optional<AppFlexConsumptionSiteConfigCors> cors() {
    ...
    public static Builder builder(AppFlexConsumptionSiteConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer workerCount;
        public Builder() {}
        public Builder(AppFlexConsumptionSiteConfig defaults) {
        ...
        @CustomType.Setter
        public Builder appServiceLogs(@Nullable AppFlexConsumptionSiteConfigAppServiceLogs appServiceLogs) {
        ...
        @CustomType.Setter
        public Builder cors(@Nullable AppFlexConsumptionSiteConfigCors cors) {
        ...
        @CustomType.Setter
        public Builder ipRestrictions(@Nullable List<AppFlexConsumptionSiteConfigIpRestriction> ipRestrictions) {

            this.ipRestrictions = ipRestrictions;
            return this;
        }
        public Builder ipRestrictions(AppFlexConsumptionSiteConfigIpRestriction... ipRestrictions) {
        ...
        @CustomType.Setter
        public Builder scmIpRestrictions(@Nullable List<AppFlexConsumptionSiteConfigScmIpRestriction> scmIpRestrictions) {

            this.scmIpRestrictions = scmIpRestrictions;
            return this;
        }
        public Builder scmIpRestrictions(AppFlexConsumptionSiteConfigScmIpRestriction... scmIpRestrictions) {
        ...
        public AppFlexConsumptionSiteConfig build() {
            final var _resultValue = new AppFlexConsumptionSiteConfig();
