...
@CustomType
public final class StandardSiteConfigIpRestrictionHeaders {
    /**
    ...
    public static Builder builder(StandardSiteConfigIpRestrictionHeaders defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(StandardSiteConfigIpRestrictionHeaders defaults) {
        ...
        }        public StandardSiteConfigIpRestrictionHeaders build() {
            return new StandardSiteConfigIpRestrictionHeaders(xAzureFdids, xFdHealthProbe, xForwardedFors, xForwardedHosts);
        }
    }
}
