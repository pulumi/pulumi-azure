...
public class CredentialUserManagedIdentity extends com.pulumi.resources.CustomResource {
    ...
    public CredentialUserManagedIdentity(String name, CredentialUserManagedIdentityArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/credentialUserManagedIdentity:CredentialUserManagedIdentity", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
