...
@CustomType
public final class ActiveRoleAssignmentTicket {
    /**
    ...
    public static Builder builder(ActiveRoleAssignmentTicket defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String system;
        public Builder() {}
        public Builder(ActiveRoleAssignmentTicket defaults) {
