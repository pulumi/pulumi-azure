...
public final class GetEnvironmentV3ClusterSetting {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetEnvironmentV3ClusterSetting", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetEnvironmentV3ClusterSetting", "value");
            }
            this.value = value;
            return this;
        }
