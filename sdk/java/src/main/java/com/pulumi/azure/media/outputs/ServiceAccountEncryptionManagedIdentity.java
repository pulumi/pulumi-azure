...
@CustomType
public final class ServiceAccountEncryptionManagedIdentity {
    /**
    ...
    private ServiceAccountEncryptionManagedIdentity() {}
    /**
     * @return Whether to use System Assigned Identity. Possible Values are `true` and `false`.
     * 
     */
    ...
    public static Builder builder(ServiceAccountEncryptionManagedIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String userAssignedIdentityId;
        public Builder() {}
        public Builder(ServiceAccountEncryptionManagedIdentity defaults) {
