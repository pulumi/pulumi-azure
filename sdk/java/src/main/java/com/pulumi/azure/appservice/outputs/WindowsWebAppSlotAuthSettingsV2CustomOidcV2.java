...
@CustomType
public final class WindowsWebAppSlotAuthSettingsV2CustomOidcV2 {
    /**
    ...
    private WindowsWebAppSlotAuthSettingsV2CustomOidcV2() {}
    /**
     * @return The endpoint to make the Authorisation Request as supplied by `openid_configuration_endpoint` response.
     * 
     */
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2CustomOidcV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tokenEndpoint;
        public Builder() {}
        public Builder(WindowsWebAppSlotAuthSettingsV2CustomOidcV2 defaults) {
        ...
        public WindowsWebAppSlotAuthSettingsV2CustomOidcV2 build() {
            final var _resultValue = new WindowsWebAppSlotAuthSettingsV2CustomOidcV2();
