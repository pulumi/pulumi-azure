...
public final class LocalRulestackRuleState extends com.pulumi.resources.ResourceArgs {

    public static final LocalRulestackRuleState Empty = new LocalRulestackRuleState();
    ...
    private @Nullable Output<LocalRulestackRuleDestinationArgs> destination;

    /**
     * @return One or more `destination` blocks as defined below.
     * 
     */
    public Optional<Output<LocalRulestackRuleDestinationArgs>> destination() {
     ...
     */
    @Import(name="source")
    private @Nullable Output<LocalRulestackRuleSourceArgs> source;

    /**
     * @return One or more `source` blocks as defined below.
     * 
     */
    public Optional<Output<LocalRulestackRuleSourceArgs>> source() {
    ...
    private LocalRulestackRuleState() {}

    private LocalRulestackRuleState(LocalRulestackRuleState $) {
        this.action = $.action;
    ...
    public static Builder builder(LocalRulestackRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LocalRulestackRuleState();
        }

        public Builder(LocalRulestackRuleState defaults) {
            $ = new LocalRulestackRuleState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder destination(@Nullable Output<LocalRulestackRuleDestinationArgs> destination) {
        ...
        /**
         * @param protocol The Protocol and port to use in the form `[protocol]:[portNumber]` e.g. `TCP:8080` or `UDP:53`. Conflicts with `protocolPorts`.
         * 
         * &gt; **Note:** In 4.0 or later versions, the default of `protocol` will no longer be set by provider, exactly one of `protocol` and `protocolPorts` must be specified. You need to explicitly specify `protocol=&#34;application-default&#34;` to keep the the current default of the `protocol`.
         * 
         * @return builder
         ...
         * 
         */
        public Builder source(@Nullable Output<LocalRulestackRuleSourceArgs> source) {
            $.source = source;
            return this;
        }
        ...
        public LocalRulestackRuleState build() {
            return $;
        }
    }
