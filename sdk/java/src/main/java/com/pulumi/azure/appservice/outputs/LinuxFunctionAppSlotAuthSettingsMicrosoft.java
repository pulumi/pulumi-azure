...
public final class LinuxFunctionAppSlotAuthSettingsMicrosoft {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsMicrosoft", "clientId");
            }
        ...
        public LinuxFunctionAppSlotAuthSettingsMicrosoft build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsMicrosoft();
