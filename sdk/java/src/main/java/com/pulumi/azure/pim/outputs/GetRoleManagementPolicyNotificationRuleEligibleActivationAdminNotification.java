...
@CustomType
public final class GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification {
    /**
    ...
    private GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification() {}
    /**
     * @return A list of additional email addresses that will receive these notifications.
     * 
     */
    ...
    public static Builder builder(GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification defaults) {
        ...
        public Builder additionalRecipients(List<String> additionalRecipients) {
            if (additionalRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification", "additionalRecipients");
            }
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification build() {
            final var _resultValue = new GetRoleManagementPolicyNotificationRuleEligibleActivationAdminNotification();
