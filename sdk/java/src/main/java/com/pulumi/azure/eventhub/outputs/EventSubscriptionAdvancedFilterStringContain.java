...
@CustomType
public final class EventSubscriptionAdvancedFilterStringContain {
    /**
    ...
    public static Builder builder(EventSubscriptionAdvancedFilterStringContain defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(EventSubscriptionAdvancedFilterStringContain defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("EventSubscriptionAdvancedFilterStringContain", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("EventSubscriptionAdvancedFilterStringContain", "values");
            }
            this.values = values;
            return this;
        }
