...
import com.pulumi.azure.appservice.inputs.WindowsWebAppSiteConfigIpRestrictionHeadersArgs;
...
public final class WindowsWebAppSiteConfigIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {

    public static final WindowsWebAppSiteConfigIpRestrictionArgs Empty = new WindowsWebAppSiteConfigIpRestrictionArgs();
     ...
     */
    @Import(name="headers")
    private @Nullable Output<WindowsWebAppSiteConfigIpRestrictionHeadersArgs> headers;

    /**
     * @return A `headers` block as defined above.
     * 
     */
    public Optional<Output<WindowsWebAppSiteConfigIpRestrictionHeadersArgs>> headers() {
    ...
    private WindowsWebAppSiteConfigIpRestrictionArgs() {}

    private WindowsWebAppSiteConfigIpRestrictionArgs(WindowsWebAppSiteConfigIpRestrictionArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(WindowsWebAppSiteConfigIpRestrictionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsWebAppSiteConfigIpRestrictionArgs();
        }

        public Builder(WindowsWebAppSiteConfigIpRestrictionArgs defaults) {
            $ = new WindowsWebAppSiteConfigIpRestrictionArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder headers(@Nullable Output<WindowsWebAppSiteConfigIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
         ...
         * 
         */
        public Builder headers(WindowsWebAppSiteConfigIpRestrictionHeadersArgs headers) {
        ...
        public WindowsWebAppSiteConfigIpRestrictionArgs build() {
            return $;
        }
    }
