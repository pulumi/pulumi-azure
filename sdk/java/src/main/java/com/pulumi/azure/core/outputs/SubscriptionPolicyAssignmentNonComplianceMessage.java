...
public final class SubscriptionPolicyAssignmentNonComplianceMessage {
    ...
    public static Builder builder(SubscriptionPolicyAssignmentNonComplianceMessage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String policyDefinitionReferenceId;
        public Builder() {}
        public Builder(SubscriptionPolicyAssignmentNonComplianceMessage defaults) {
        ...
        public Builder content(String content) {
            if (content == null) {
              throw new MissingRequiredPropertyException("SubscriptionPolicyAssignmentNonComplianceMessage", "content");
            }
