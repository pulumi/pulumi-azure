...
public final class WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args() {}

    private WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args(WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2GoogleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
