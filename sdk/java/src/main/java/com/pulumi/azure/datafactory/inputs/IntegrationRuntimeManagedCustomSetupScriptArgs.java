    ...
    public static final class Builder {
        ...
        public IntegrationRuntimeManagedCustomSetupScriptArgs build() {
            if ($.blobContainerUri == null) {
                throw new MissingRequiredPropertyException("IntegrationRuntimeManagedCustomSetupScriptArgs", "blobContainerUri");
            }
            if ($.sasToken == null) {
                throw new MissingRequiredPropertyException("IntegrationRuntimeManagedCustomSetupScriptArgs", "sasToken");
            }
            return $;
        }
    }
