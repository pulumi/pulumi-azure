...
public final class EnvironmentIdentity {
    ...
    public static Builder builder(EnvironmentIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(EnvironmentIdentity defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("EnvironmentIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public EnvironmentIdentity build() {
            final var _resultValue = new EnvironmentIdentity();
