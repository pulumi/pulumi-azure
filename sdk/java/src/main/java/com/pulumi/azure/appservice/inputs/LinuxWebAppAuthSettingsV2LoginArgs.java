...
public final class LinuxWebAppAuthSettingsV2LoginArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsV2LoginArgs Empty = new LinuxWebAppAuthSettingsV2LoginArgs();
    ...
    private LinuxWebAppAuthSettingsV2LoginArgs() {}

    private LinuxWebAppAuthSettingsV2LoginArgs(LinuxWebAppAuthSettingsV2LoginArgs $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2LoginArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsV2LoginArgs();
        }

        public Builder(LinuxWebAppAuthSettingsV2LoginArgs defaults) {
            $ = new LinuxWebAppAuthSettingsV2LoginArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsV2LoginArgs build() {
            return $;
        }
    }
