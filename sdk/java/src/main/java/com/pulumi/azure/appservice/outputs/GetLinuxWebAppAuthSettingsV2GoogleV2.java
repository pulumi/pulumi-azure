...
@CustomType
public final class GetLinuxWebAppAuthSettingsV2GoogleV2 {
    /**
    ...
    private GetLinuxWebAppAuthSettingsV2GoogleV2() {}
    /**
     * @return The list of Allowed Audiences that are be requested as part of Microsoft Sign-In authentication.
     * 
     */
    ...
    public static Builder builder(GetLinuxWebAppAuthSettingsV2GoogleV2 defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> loginScopes;
        public Builder() {}
        public Builder(GetLinuxWebAppAuthSettingsV2GoogleV2 defaults) {
        ...
        public GetLinuxWebAppAuthSettingsV2GoogleV2 build() {
            final var _resultValue = new GetLinuxWebAppAuthSettingsV2GoogleV2();
