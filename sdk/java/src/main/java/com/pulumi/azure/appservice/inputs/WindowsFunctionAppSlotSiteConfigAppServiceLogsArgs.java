...
public final class WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs() {}

    private WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs(WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs();
        }

        public Builder(WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs defaults) {
            $ = new WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WindowsFunctionAppSlotSiteConfigAppServiceLogsArgs build() {
            return $;
        }
    }
