...
public final class ResourceGroupPolicyAssignmentNonComplianceMessage {
    ...
    public static final class Builder {
        ...
        public Builder content(String content) {
            if (content == null) {
              throw new MissingRequiredPropertyException("ResourceGroupPolicyAssignmentNonComplianceMessage", "content");
            }
        ...
        public ResourceGroupPolicyAssignmentNonComplianceMessage build() {
            final var _resultValue = new ResourceGroupPolicyAssignmentNonComplianceMessage();
