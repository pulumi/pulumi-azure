...
public final class ApiOperationResponseHeaderExampleArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiOperationResponseHeaderExampleArgs Empty = new ApiOperationResponseHeaderExampleArgs();
    ...
    private ApiOperationResponseHeaderExampleArgs() {}

    private ApiOperationResponseHeaderExampleArgs(ApiOperationResponseHeaderExampleArgs $) {
    ...
    public static Builder builder(ApiOperationResponseHeaderExampleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApiOperationResponseHeaderExampleArgs();
        }

        public Builder(ApiOperationResponseHeaderExampleArgs defaults) {
            $ = new ApiOperationResponseHeaderExampleArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiOperationResponseHeaderExampleArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ApiOperationResponseHeaderExampleArgs", "name");
            }
            return $;
        }
    }
