...
public final class DiagnosticFrontendResponseDataMaskingQueryParam {
    ...
    public static final class Builder {
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("DiagnosticFrontendResponseDataMaskingQueryParam", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DiagnosticFrontendResponseDataMaskingQueryParam", "value");
            }
            this.value = value;
            return this;
        }
        public DiagnosticFrontendResponseDataMaskingQueryParam build() {
            final var _resultValue = new DiagnosticFrontendResponseDataMaskingQueryParam();
