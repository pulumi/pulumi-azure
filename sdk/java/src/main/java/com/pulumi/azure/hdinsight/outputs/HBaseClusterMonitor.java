    ...
    public static final class Builder {
        ...
        public Builder logAnalyticsWorkspaceId(String logAnalyticsWorkspaceId) {
            if (logAnalyticsWorkspaceId == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMonitor", "logAnalyticsWorkspaceId");
            }
        ...
        public Builder primaryKey(String primaryKey) {
            if (primaryKey == null) {
              throw new MissingRequiredPropertyException("HBaseClusterMonitor", "primaryKey");
            }
