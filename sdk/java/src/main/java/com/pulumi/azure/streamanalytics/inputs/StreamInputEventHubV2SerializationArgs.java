...
public final class StreamInputEventHubV2SerializationArgs extends com.pulumi.resources.ResourceArgs {

    public static final StreamInputEventHubV2SerializationArgs Empty = new StreamInputEventHubV2SerializationArgs();
    ...
    private StreamInputEventHubV2SerializationArgs() {}

    private StreamInputEventHubV2SerializationArgs(StreamInputEventHubV2SerializationArgs $) {
    ...
    public static Builder builder(StreamInputEventHubV2SerializationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamInputEventHubV2SerializationArgs();
        }

        public Builder(StreamInputEventHubV2SerializationArgs defaults) {
            $ = new StreamInputEventHubV2SerializationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StreamInputEventHubV2SerializationArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("StreamInputEventHubV2SerializationArgs", "type");
            }
            return $;
        }
    }
