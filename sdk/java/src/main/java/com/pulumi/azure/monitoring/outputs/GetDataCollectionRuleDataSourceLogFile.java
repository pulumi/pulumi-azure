...
@CustomType
public final class GetDataCollectionRuleDataSourceLogFile {
    /**
     ...
     * 
     */
    private List<GetDataCollectionRuleDataSourceLogFileSetting> settings;
    /**
    ...
    private GetDataCollectionRuleDataSourceLogFile() {}
    /**
     * @return Specifies a list of file patterns where the log files are located. For example, `C:\\JavaLogs\\*.log`.
     * 
     */
     ...
     * 
     */
    public List<GetDataCollectionRuleDataSourceLogFileSetting> settings() {
    ...
    public static Builder builder(GetDataCollectionRuleDataSourceLogFile defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> streams;
        public Builder() {}
        public Builder(GetDataCollectionRuleDataSourceLogFile defaults) {
        ...
        public GetDataCollectionRuleDataSourceLogFile build() {
            final var _resultValue = new GetDataCollectionRuleDataSourceLogFile();
