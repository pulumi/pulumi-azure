...
public class Grafana extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="apiKeyEnabled", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="azureMonitorWorkspaceIntegrations", type=List.class, parameters={GrafanaAzureMonitorWorkspaceIntegration.class})
     ...
     * 
     */
    @Export(name="deterministicOutboundIpEnabled", type=Boolean.class, parameters={})
     ...
     * 
     */
    @Export(name="identity", type=GrafanaIdentity.class, parameters={})
     ...
     * 
     */
    @Export(name="outboundIps", type=List.class, parameters={String.class})
