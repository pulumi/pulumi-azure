...
public class VmwareReplicationPolicyAssociation extends com.pulumi.resources.CustomResource {
    ...
    public VmwareReplicationPolicyAssociation(String name, VmwareReplicationPolicyAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:siterecovery/vmwareReplicationPolicyAssociation:VmwareReplicationPolicyAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
