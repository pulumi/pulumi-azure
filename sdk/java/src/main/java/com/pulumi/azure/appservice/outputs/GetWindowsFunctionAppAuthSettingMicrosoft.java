...
@CustomType
public final class GetWindowsFunctionAppAuthSettingMicrosoft {
    /**
    ...
    private GetWindowsFunctionAppAuthSettingMicrosoft() {}
    /**
     * @return The OAuth 2.0 client ID that was created for the app used for authentication.
     * 
     */
    ...
    public static Builder builder(GetWindowsFunctionAppAuthSettingMicrosoft defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> oauthScopes;
        public Builder() {}
        public Builder(GetWindowsFunctionAppAuthSettingMicrosoft defaults) {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingMicrosoft", "clientId");
            }
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingMicrosoft", "clientSecret");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingMicrosoft", "clientSecretSettingName");
            }
        ...
        public Builder oauthScopes(List<String> oauthScopes) {
            if (oauthScopes == null) {
              throw new MissingRequiredPropertyException("GetWindowsFunctionAppAuthSettingMicrosoft", "oauthScopes");
            }
