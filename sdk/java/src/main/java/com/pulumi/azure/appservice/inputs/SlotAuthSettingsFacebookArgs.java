...
public final class SlotAuthSettingsFacebookArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SlotAuthSettingsFacebookArgs build() {
            if ($.appId == null) {
                throw new MissingRequiredPropertyException("SlotAuthSettingsFacebookArgs", "appId");
            }
            if ($.appSecret == null) {
                throw new MissingRequiredPropertyException("SlotAuthSettingsFacebookArgs", "appSecret");
            }
            return $;
        }
    }
