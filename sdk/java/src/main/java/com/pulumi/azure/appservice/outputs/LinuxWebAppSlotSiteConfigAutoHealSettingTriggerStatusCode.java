...
public final class LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode {
    ...
    public static final class Builder {
        ...
        public Builder count(Integer count) {
            if (count == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode", "count");
            }
            this.count = count;
            return this;
        }
        ...
        public Builder interval(String interval) {
            if (interval == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode", "interval");
            }
        ...
        public Builder statusCodeRange(String statusCodeRange) {
            if (statusCodeRange == null) {
              throw new MissingRequiredPropertyException("LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode", "statusCodeRange");
            }
        ...
        public LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode build() {
            final var _resultValue = new LinuxWebAppSlotSiteConfigAutoHealSettingTriggerStatusCode();
