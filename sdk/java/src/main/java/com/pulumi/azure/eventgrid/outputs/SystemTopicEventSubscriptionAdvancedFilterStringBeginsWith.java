...
@CustomType
public final class SystemTopicEventSubscriptionAdvancedFilterStringBeginsWith {
    /**
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("SystemTopicEventSubscriptionAdvancedFilterStringBeginsWith", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("SystemTopicEventSubscriptionAdvancedFilterStringBeginsWith", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public SystemTopicEventSubscriptionAdvancedFilterStringBeginsWith build() {
            final var _resultValue = new SystemTopicEventSubscriptionAdvancedFilterStringBeginsWith();
