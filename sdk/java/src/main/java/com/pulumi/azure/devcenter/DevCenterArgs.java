...
public final class DevCenterArgs extends com.pulumi.resources.ResourceArgs {

    public static final DevCenterArgs Empty = new DevCenterArgs();
    ...
    private DevCenterArgs() {}

    private DevCenterArgs(DevCenterArgs $) {
    ...
    public static Builder builder(DevCenterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DevCenterArgs defaults) {
            $ = new DevCenterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DevCenterArgs build() {
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("DevCenterArgs", "resourceGroupName");
            }
            return $;
        }
    }
