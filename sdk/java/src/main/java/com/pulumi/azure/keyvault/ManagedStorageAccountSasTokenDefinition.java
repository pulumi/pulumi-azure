 ...
 *             .sasTemplateUri(exampleAccountSAS.apply(getAccountSASResult -&gt; getAccountSASResult).apply(exampleAccountSAS -&gt; exampleAccountSAS.apply(getAccountSASResult -&gt; getAccountSASResult.sas())))
 *             .sasType(&#34;account&#34;)
 *             .build());
 * 
 *     }
