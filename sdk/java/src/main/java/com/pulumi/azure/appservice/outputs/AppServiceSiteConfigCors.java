...
@CustomType
public final class AppServiceSiteConfigCors {
    /**
    ...
    public static Builder builder(AppServiceSiteConfigCors defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean supportCredentials;
        public Builder() {}
        public Builder(AppServiceSiteConfigCors defaults) {
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("AppServiceSiteConfigCors", "allowedOrigins");
            }
        ...
        public AppServiceSiteConfigCors build() {
            final var _resultValue = new AppServiceSiteConfigCors();
