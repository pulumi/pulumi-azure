...
public class ResolverDnsForwardingRuleset extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResolverDnsForwardingRuleset(String name) {
     ...
     */
    public ResolverDnsForwardingRuleset(String name, ResolverDnsForwardingRulesetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResolverDnsForwardingRuleset(String name, ResolverDnsForwardingRulesetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:privatedns/resolverDnsForwardingRuleset:ResolverDnsForwardingRuleset", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private ResolverDnsForwardingRuleset(String name, Output<String> id, @Nullable ResolverDnsForwardingRulesetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:privatedns/resolverDnsForwardingRuleset:ResolverDnsForwardingRuleset", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ResolverDnsForwardingRuleset get(String name, Output<String> id, @Nullable ResolverDnsForwardingRulesetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
