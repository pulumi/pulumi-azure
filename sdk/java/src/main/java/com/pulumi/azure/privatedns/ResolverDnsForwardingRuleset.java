...
public class ResolverDnsForwardingRuleset extends com.pulumi.resources.CustomResource {
    ...
    public ResolverDnsForwardingRuleset(String name, ResolverDnsForwardingRulesetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:privatedns/resolverDnsForwardingRuleset:ResolverDnsForwardingRuleset", name, args == null ? ResolverDnsForwardingRulesetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
