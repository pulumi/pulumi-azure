...
public final class LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2 {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2", "clientSecretSettingName");
            }
        ...
        public LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2 build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsV2MicrosoftV2();
