...
public final class HciVirtualHardDiskState extends com.pulumi.resources.ResourceArgs {

    public static final HciVirtualHardDiskState Empty = new HciVirtualHardDiskState();
    ...
    private HciVirtualHardDiskState(HciVirtualHardDiskState $) {
    ...
    public static Builder builder(HciVirtualHardDiskState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HciVirtualHardDiskState();
        }

        public Builder(HciVirtualHardDiskState defaults) {
            $ = new HciVirtualHardDiskState(Objects.requireNonNull(defaults));
        }
        ...
        public HciVirtualHardDiskState build() {
            return $;
        }
    }
