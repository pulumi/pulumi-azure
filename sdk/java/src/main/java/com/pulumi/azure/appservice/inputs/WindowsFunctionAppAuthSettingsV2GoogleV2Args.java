...
public final class WindowsFunctionAppAuthSettingsV2GoogleV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WindowsFunctionAppAuthSettingsV2GoogleV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2GoogleV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("WindowsFunctionAppAuthSettingsV2GoogleV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
