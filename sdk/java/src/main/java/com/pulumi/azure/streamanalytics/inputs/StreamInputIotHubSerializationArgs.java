...
public final class StreamInputIotHubSerializationArgs extends com.pulumi.resources.ResourceArgs {

    public static final StreamInputIotHubSerializationArgs Empty = new StreamInputIotHubSerializationArgs();
    ...
    private StreamInputIotHubSerializationArgs() {}

    private StreamInputIotHubSerializationArgs(StreamInputIotHubSerializationArgs $) {
    ...
    public static Builder builder(StreamInputIotHubSerializationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamInputIotHubSerializationArgs();
        }

        public Builder(StreamInputIotHubSerializationArgs defaults) {
            $ = new StreamInputIotHubSerializationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StreamInputIotHubSerializationArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("StreamInputIotHubSerializationArgs", "type");
            }
            return $;
        }
    }
