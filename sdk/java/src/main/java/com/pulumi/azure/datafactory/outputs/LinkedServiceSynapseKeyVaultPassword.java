...
@CustomType
public final class LinkedServiceSynapseKeyVaultPassword {
    /**
    ...
    public static final class Builder {
        ...
        public Builder linkedServiceName(String linkedServiceName) {
            if (linkedServiceName == null) {
              throw new MissingRequiredPropertyException("LinkedServiceSynapseKeyVaultPassword", "linkedServiceName");
            }
        ...
        public Builder secretName(String secretName) {
            if (secretName == null) {
              throw new MissingRequiredPropertyException("LinkedServiceSynapseKeyVaultPassword", "secretName");
            }
