...
@CustomType
public final class GetLinuxWebAppSiteConfigScmIpRestrictionHeader {
    /**
    ...
    private GetLinuxWebAppSiteConfigScmIpRestrictionHeader() {}
    /**
     * @return The list of Azure Front Door IDs.
     * 
     */
    ...
    public static Builder builder(GetLinuxWebAppSiteConfigScmIpRestrictionHeader defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> xForwardedHosts;
        public Builder() {}
        public Builder(GetLinuxWebAppSiteConfigScmIpRestrictionHeader defaults) {
        ...
        public Builder xAzureFdids(List<String> xAzureFdids) {
            if (xAzureFdids == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppSiteConfigScmIpRestrictionHeader", "xAzureFdids");
            }
        ...
        public Builder xFdHealthProbes(List<String> xFdHealthProbes) {
            if (xFdHealthProbes == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppSiteConfigScmIpRestrictionHeader", "xFdHealthProbes");
            }
        ...
        public Builder xForwardedFors(List<String> xForwardedFors) {
            if (xForwardedFors == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppSiteConfigScmIpRestrictionHeader", "xForwardedFors");
            }
        ...
        public Builder xForwardedHosts(List<String> xForwardedHosts) {
            if (xForwardedHosts == null) {
              throw new MissingRequiredPropertyException("GetLinuxWebAppSiteConfigScmIpRestrictionHeader", "xForwardedHosts");
            }
        ...
        public GetLinuxWebAppSiteConfigScmIpRestrictionHeader build() {
            final var _resultValue = new GetLinuxWebAppSiteConfigScmIpRestrictionHeader();
