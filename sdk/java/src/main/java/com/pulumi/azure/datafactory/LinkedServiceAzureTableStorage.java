...
public class LinkedServiceAzureTableStorage extends com.pulumi.resources.CustomResource {
    ...
    public LinkedServiceAzureTableStorage(String name, LinkedServiceAzureTableStorageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:datafactory/linkedServiceAzureTableStorage:LinkedServiceAzureTableStorage", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
