...
public final class WindowsFunctionAppSlotAuthSettingsV2AppleV2Args extends com.pulumi.resources.ResourceArgs {
    ...
    private WindowsFunctionAppSlotAuthSettingsV2AppleV2Args() {}

    private WindowsFunctionAppSlotAuthSettingsV2AppleV2Args(WindowsFunctionAppSlotAuthSettingsV2AppleV2Args $) {
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2AppleV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WindowsFunctionAppSlotAuthSettingsV2AppleV2Args();
        }

        public Builder(WindowsFunctionAppSlotAuthSettingsV2AppleV2Args defaults) {
            $ = new WindowsFunctionAppSlotAuthSettingsV2AppleV2Args(Objects.requireNonNull(defaults));
        }
