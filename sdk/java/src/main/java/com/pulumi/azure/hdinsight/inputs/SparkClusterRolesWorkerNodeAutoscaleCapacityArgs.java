...
public final class SparkClusterRolesWorkerNodeAutoscaleCapacityArgs extends com.pulumi.resources.ResourceArgs {

    public static final SparkClusterRolesWorkerNodeAutoscaleCapacityArgs Empty = new SparkClusterRolesWorkerNodeAutoscaleCapacityArgs();
    ...
    private SparkClusterRolesWorkerNodeAutoscaleCapacityArgs() {}

    private SparkClusterRolesWorkerNodeAutoscaleCapacityArgs(SparkClusterRolesWorkerNodeAutoscaleCapacityArgs $) {
    ...
    public static Builder builder(SparkClusterRolesWorkerNodeAutoscaleCapacityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SparkClusterRolesWorkerNodeAutoscaleCapacityArgs();
        }

        public Builder(SparkClusterRolesWorkerNodeAutoscaleCapacityArgs defaults) {
            $ = new SparkClusterRolesWorkerNodeAutoscaleCapacityArgs(Objects.requireNonNull(defaults));
        }
