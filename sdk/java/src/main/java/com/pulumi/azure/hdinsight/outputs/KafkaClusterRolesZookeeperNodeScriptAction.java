...
public final class KafkaClusterRolesZookeeperNodeScriptAction {
    ...
    public static Builder builder(KafkaClusterRolesZookeeperNodeScriptAction defaults) {
    ...
    public static final class Builder {
        ...
        private String uri;
        public Builder() {}
        public Builder(KafkaClusterRolesZookeeperNodeScriptAction defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("KafkaClusterRolesZookeeperNodeScriptAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("KafkaClusterRolesZookeeperNodeScriptAction", "uri");
            }
            this.uri = uri;
            return this;
        }
