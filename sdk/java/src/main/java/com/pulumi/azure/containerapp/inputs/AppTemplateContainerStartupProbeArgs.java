...
public final class AppTemplateContainerStartupProbeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param failureCountThreshold The number of consecutive failures required to consider this probe as failed. Possible values are between `1` and `240`. Defaults to `3`.
         * 
         * @return builder
         * 
         */
