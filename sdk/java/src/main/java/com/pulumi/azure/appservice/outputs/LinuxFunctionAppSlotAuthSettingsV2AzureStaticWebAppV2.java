...
public final class LinuxFunctionAppSlotAuthSettingsV2AzureStaticWebAppV2 {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppSlotAuthSettingsV2AzureStaticWebAppV2", "clientId");
            }
            this.clientId = clientId;
            return this;
        }
        public LinuxFunctionAppSlotAuthSettingsV2AzureStaticWebAppV2 build() {
            final var _resultValue = new LinuxFunctionAppSlotAuthSettingsV2AzureStaticWebAppV2();
