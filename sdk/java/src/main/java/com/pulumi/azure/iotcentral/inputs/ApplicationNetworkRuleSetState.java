...
public final class ApplicationNetworkRuleSetState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<String> iotcentralApplicationId;

    /**
     * @return The ID of the IoT Central Application. Changing this forces a new resource to be created.
     * 
     */
    public Optional<Output<String>> iotcentralApplicationId() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder iotcentralApplicationId(@Nullable Output<String> iotcentralApplicationId) {
