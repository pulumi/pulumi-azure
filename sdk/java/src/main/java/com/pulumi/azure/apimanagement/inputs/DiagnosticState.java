...
public final class DiagnosticState extends com.pulumi.resources.ResourceArgs {

    public static final DiagnosticState Empty = new DiagnosticState();
    ...
    public static Builder builder(DiagnosticState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DiagnosticState defaults) {
            $ = new DiagnosticState(Objects.requireNonNull(defaults));
        }
