...
public final class GetAccessConnectorIdentity {
    ...
    public static Builder builder(GetAccessConnectorIdentity defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetAccessConnectorIdentity defaults) {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("GetAccessConnectorIdentity", "identityIds");
            }
        ...
        public Builder principalId(String principalId) {
            if (principalId == null) {
              throw new MissingRequiredPropertyException("GetAccessConnectorIdentity", "principalId");
            }
        ...
        public Builder tenantId(String tenantId) {
            if (tenantId == null) {
              throw new MissingRequiredPropertyException("GetAccessConnectorIdentity", "tenantId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetAccessConnectorIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public GetAccessConnectorIdentity build() {
            final var _resultValue = new GetAccessConnectorIdentity();
