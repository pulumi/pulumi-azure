...
@CustomType
public final class WindowsWebAppSlotAuthSettingsV2Login {
    /**
    ...
    private WindowsWebAppSlotAuthSettingsV2Login() {}
    /**
     * @return External URLs that can be redirected to as part of logging in or logging out of the app. This is an advanced setting typically only needed by Windows Store application backends.
     * 
     * &gt; **Note:** URLs within the current domain are always implicitly allowed.
    ...
    public static Builder builder(WindowsWebAppSlotAuthSettingsV2Login defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean validateNonce;
        public Builder() {}
        public Builder(WindowsWebAppSlotAuthSettingsV2Login defaults) {
        ...
        public WindowsWebAppSlotAuthSettingsV2Login build() {
            final var _resultValue = new WindowsWebAppSlotAuthSettingsV2Login();
