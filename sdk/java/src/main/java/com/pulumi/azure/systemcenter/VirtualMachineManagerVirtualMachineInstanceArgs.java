...
public final class VirtualMachineManagerVirtualMachineInstanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final VirtualMachineManagerVirtualMachineInstanceArgs Empty = new VirtualMachineManagerVirtualMachineInstanceArgs();
    ...
    private Output<VirtualMachineManagerVirtualMachineInstanceInfrastructureArgs> infrastructure;

    /**
     * @return An `infrastructure` block as defined below.
     * 
     */
    public Output<VirtualMachineManagerVirtualMachineInstanceInfrastructureArgs> infrastructure() {
    ...
    private VirtualMachineManagerVirtualMachineInstanceArgs() {}

    private VirtualMachineManagerVirtualMachineInstanceArgs(VirtualMachineManagerVirtualMachineInstanceArgs $) {
    ...
    public static Builder builder(VirtualMachineManagerVirtualMachineInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualMachineManagerVirtualMachineInstanceArgs();
        }

        public Builder(VirtualMachineManagerVirtualMachineInstanceArgs defaults) {
            $ = new VirtualMachineManagerVirtualMachineInstanceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder infrastructure(Output<VirtualMachineManagerVirtualMachineInstanceInfrastructureArgs> infrastructure) {
        ...
        public VirtualMachineManagerVirtualMachineInstanceArgs build() {
            if ($.customLocationId == null) {
                throw new MissingRequiredPropertyException("VirtualMachineManagerVirtualMachineInstanceArgs", "customLocationId");
            }
            if ($.infrastructure == null) {
                throw new MissingRequiredPropertyException("VirtualMachineManagerVirtualMachineInstanceArgs", "infrastructure");
            }
            if ($.scopedResourceId == null) {
                throw new MissingRequiredPropertyException("VirtualMachineManagerVirtualMachineInstanceArgs", "scopedResourceId");
            }
            return $;
        }
    }
