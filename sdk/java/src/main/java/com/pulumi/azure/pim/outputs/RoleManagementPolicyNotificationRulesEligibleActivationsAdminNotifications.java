...
@CustomType
public final class RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications {
    /**
    ...
    public static Builder builder(RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications defaults) {
    ...
    public static final class Builder {
        ...
        private String notificationLevel;
        public Builder() {}
        public Builder(RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications defaults) {
        ...
        public Builder defaultRecipients(Boolean defaultRecipients) {
            if (defaultRecipients == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications", "defaultRecipients");
            }
        ...
        public Builder notificationLevel(String notificationLevel) {
            if (notificationLevel == null) {
              throw new MissingRequiredPropertyException("RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications", "notificationLevel");
            }
            this.notificationLevel = notificationLevel;
            return this;
        }
        public RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications build() {
            final var _resultValue = new RoleManagementPolicyNotificationRulesEligibleActivationsAdminNotifications();
