...
public final class LinuxFunctionAppSiteConfigCorsArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxFunctionAppSiteConfigCorsArgs Empty = new LinuxFunctionAppSiteConfigCorsArgs();
    ...
    private LinuxFunctionAppSiteConfigCorsArgs() {}

    private LinuxFunctionAppSiteConfigCorsArgs(LinuxFunctionAppSiteConfigCorsArgs $) {
    ...
    public static Builder builder(LinuxFunctionAppSiteConfigCorsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxFunctionAppSiteConfigCorsArgs();
        }

        public Builder(LinuxFunctionAppSiteConfigCorsArgs defaults) {
            $ = new LinuxFunctionAppSiteConfigCorsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxFunctionAppSiteConfigCorsArgs build() {
            return $;
        }
    }
