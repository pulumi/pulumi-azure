...
@CustomType
public final class LinuxFunctionAppBackupSchedule {
    /**
    ...
    private LinuxFunctionAppBackupSchedule() {}
    /**
     * @return How often the backup should be executed (e.g. for weekly backup, this should be set to `7` and `frequency_unit` should be set to `Day`).
     * 
     * &gt; **Note:** Not all intervals are supported on all Linux Function App SKUs. Please refer to the official documentation for appropriate values.
    ...
    public static Builder builder(LinuxFunctionAppBackupSchedule defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startTime;
        public Builder() {}
        public Builder(LinuxFunctionAppBackupSchedule defaults) {
        ...
        public Builder frequencyInterval(Integer frequencyInterval) {
            if (frequencyInterval == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppBackupSchedule", "frequencyInterval");
            }
        ...
        public Builder frequencyUnit(String frequencyUnit) {
            if (frequencyUnit == null) {
              throw new MissingRequiredPropertyException("LinuxFunctionAppBackupSchedule", "frequencyUnit");
            }
        ...
        public LinuxFunctionAppBackupSchedule build() {
            final var _resultValue = new LinuxFunctionAppBackupSchedule();
