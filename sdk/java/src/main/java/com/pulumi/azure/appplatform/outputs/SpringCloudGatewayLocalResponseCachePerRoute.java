...
@CustomType
public final class SpringCloudGatewayLocalResponseCachePerRoute {
    /**
    ...
    private SpringCloudGatewayLocalResponseCachePerRoute() {}
    /**
     * @return Specifies the maximum size of cache (10MB, 900KB, 1GB...) to determine if the cache needs to evict some entries.
     * 
     */
    ...
    public static Builder builder(SpringCloudGatewayLocalResponseCachePerRoute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeToLive;
        public Builder() {}
        public Builder(SpringCloudGatewayLocalResponseCachePerRoute defaults) {
        ...
        public SpringCloudGatewayLocalResponseCachePerRoute build() {
            final var _resultValue = new SpringCloudGatewayLocalResponseCachePerRoute();
