...
public final class EndpointDeliveryRuleRequestBodyConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final EndpointDeliveryRuleRequestBodyConditionArgs Empty = new EndpointDeliveryRuleRequestBodyConditionArgs();
    ...
    private EndpointDeliveryRuleRequestBodyConditionArgs() {}

    private EndpointDeliveryRuleRequestBodyConditionArgs(EndpointDeliveryRuleRequestBodyConditionArgs $) {
    ...
    public static Builder builder(EndpointDeliveryRuleRequestBodyConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EndpointDeliveryRuleRequestBodyConditionArgs();
        }

        public Builder(EndpointDeliveryRuleRequestBodyConditionArgs defaults) {
            $ = new EndpointDeliveryRuleRequestBodyConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EndpointDeliveryRuleRequestBodyConditionArgs build() {
            if ($.operator == null) {
                throw new MissingRequiredPropertyException("EndpointDeliveryRuleRequestBodyConditionArgs", "operator");
            }
            return $;
        }
    }
