...
public final class TransformOutputCustomPresetCodecH264VideoLayerArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransformOutputCustomPresetCodecH264VideoLayerArgs Empty = new TransformOutputCustomPresetCodecH264VideoLayerArgs();
    ...
    private @Nullable Output<String> entropyMode;
     ...
     * 
     */
    public Optional<Output<String>> entropyMode() {
    ...
    private TransformOutputCustomPresetCodecH264VideoLayerArgs() {}

    private TransformOutputCustomPresetCodecH264VideoLayerArgs(TransformOutputCustomPresetCodecH264VideoLayerArgs $) {
    ...
    public static Builder builder(TransformOutputCustomPresetCodecH264VideoLayerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransformOutputCustomPresetCodecH264VideoLayerArgs();
        }

        public Builder(TransformOutputCustomPresetCodecH264VideoLayerArgs defaults) {
            $ = new TransformOutputCustomPresetCodecH264VideoLayerArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param entropyMode The entropy mode to be used for this layer. Possible values are `Cabac` or `Cavlc`. If not specified, the encoder chooses the mode that is appropriate for the profile and level.`entropy_mode` - (Optional) The entropy mode to be used for this layer. Possible values are `Cabac` or `Cavlc`. If not specified, the encoder chooses the mode that is appropriate for the profile and level.
         * 
         * @return builder
         * 
         */
        public Builder entropyMode(@Nullable Output<String> entropyMode) {
        ...
        public TransformOutputCustomPresetCodecH264VideoLayerArgs build() {
