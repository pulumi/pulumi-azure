...
public final class TransformOutputCustomPresetCodecH264VideoLayerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param entropyMode The entropy mode to be used for this layer. Possible values are `Cabac` or `Cavlc`. If not specified, the encoder chooses the mode that is appropriate for the profile and level.
         * 
         * @return builder
         * 
         */
        ...
        public TransformOutputCustomPresetCodecH264VideoLayerArgs build() {
            if ($.bitrate == null) {
                throw new MissingRequiredPropertyException("TransformOutputCustomPresetCodecH264VideoLayerArgs", "bitrate");
            }
            return $;
        }
    }
