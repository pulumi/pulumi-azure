...
public class VirtualMachineManagerServer extends com.pulumi.resources.CustomResource {
    ...
    public VirtualMachineManagerServer(String name, VirtualMachineManagerServerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:systemcenter/virtualMachineManagerServer:VirtualMachineManagerServer", name, args == null ? VirtualMachineManagerServerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
