...
public final class AppFlexConsumptionAuthSettingsTwitterArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsTwitterArgs Empty = new AppFlexConsumptionAuthSettingsTwitterArgs();
    ...
    private AppFlexConsumptionAuthSettingsTwitterArgs() {}

    private AppFlexConsumptionAuthSettingsTwitterArgs(AppFlexConsumptionAuthSettingsTwitterArgs $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsTwitterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsTwitterArgs();
        }

        public Builder(AppFlexConsumptionAuthSettingsTwitterArgs defaults) {
            $ = new AppFlexConsumptionAuthSettingsTwitterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppFlexConsumptionAuthSettingsTwitterArgs build() {
            if ($.consumerKey == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsTwitterArgs", "consumerKey");
            }
            return $;
        }
    }
