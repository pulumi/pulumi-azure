...
public final class EndpointDeliveryRuleCacheExpirationAction {
    ...
    public static final class Builder {
        ...
        public Builder behavior(String behavior) {
            if (behavior == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRuleCacheExpirationAction", "behavior");
            }
        ...
        public EndpointDeliveryRuleCacheExpirationAction build() {
            final var _resultValue = new EndpointDeliveryRuleCacheExpirationAction();
