...
public final class ServiceHostnameConfigurationDeveloperPortal {
    ...
    public static final class Builder {
        ...
        public Builder hostName(String hostName) {
            if (hostName == null) {
              throw new MissingRequiredPropertyException("ServiceHostnameConfigurationDeveloperPortal", "hostName");
            }
        ...
        public ServiceHostnameConfigurationDeveloperPortal build() {
            final var _resultValue = new ServiceHostnameConfigurationDeveloperPortal();
