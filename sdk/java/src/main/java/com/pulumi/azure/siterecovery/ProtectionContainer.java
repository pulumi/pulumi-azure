...
import com.pulumi.azure.siterecovery.inputs.ProtectionContainerState;
...
public class ProtectionContainer extends com.pulumi.resources.CustomResource {
    ...
    public ProtectionContainer(java.lang.String name, ProtectionContainerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:siterecovery/protectionContainer:ProtectionContainer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ProtectionContainer(java.lang.String name, Output<java.lang.String> id, @Nullable ProtectionContainerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("azure:siterecovery/protectionContainer:ProtectionContainer", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ProtectionContainer get(java.lang.String name, Output<java.lang.String> id, @Nullable ProtectionContainerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
