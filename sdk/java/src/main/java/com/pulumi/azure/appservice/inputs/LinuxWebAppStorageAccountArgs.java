...
public final class LinuxWebAppStorageAccountArgs extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppStorageAccountArgs Empty = new LinuxWebAppStorageAccountArgs();
    ...
    private LinuxWebAppStorageAccountArgs() {}

    private LinuxWebAppStorageAccountArgs(LinuxWebAppStorageAccountArgs $) {
    ...
    public static Builder builder(LinuxWebAppStorageAccountArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppStorageAccountArgs();
        }

        public Builder(LinuxWebAppStorageAccountArgs defaults) {
            $ = new LinuxWebAppStorageAccountArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppStorageAccountArgs build() {
            if ($.accessKey == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppStorageAccountArgs", "accessKey");
            }
            if ($.accountName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppStorageAccountArgs", "accountName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppStorageAccountArgs", "name");
            }
            if ($.shareName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppStorageAccountArgs", "shareName");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppStorageAccountArgs", "type");
            }
            return $;
        }
    }
