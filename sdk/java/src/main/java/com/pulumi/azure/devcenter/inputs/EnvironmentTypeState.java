...
public final class EnvironmentTypeState extends com.pulumi.resources.ResourceArgs {

    public static final EnvironmentTypeState Empty = new EnvironmentTypeState();
    ...
    private EnvironmentTypeState() {}

    private EnvironmentTypeState(EnvironmentTypeState $) {
    ...
    public static Builder builder(EnvironmentTypeState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentTypeState();
        }

        public Builder(EnvironmentTypeState defaults) {
            $ = new EnvironmentTypeState(Objects.requireNonNull(defaults));
        }
        ...
        public EnvironmentTypeState build() {
            return $;
        }
    }
