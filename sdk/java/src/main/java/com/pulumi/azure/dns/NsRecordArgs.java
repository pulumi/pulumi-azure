...
public final class NsRecordArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NsRecordArgs build() {
            if ($.records == null) {
                throw new MissingRequiredPropertyException("NsRecordArgs", "records");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("NsRecordArgs", "resourceGroupName");
            }
            if ($.ttl == null) {
                throw new MissingRequiredPropertyException("NsRecordArgs", "ttl");
            }
            if ($.zoneName == null) {
                throw new MissingRequiredPropertyException("NsRecordArgs", "zoneName");
            }
            return $;
        }
    }
