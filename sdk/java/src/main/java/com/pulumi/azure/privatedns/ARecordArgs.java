...
public final class ARecordArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param records List of IPv4 Addresses.
         * 
         * @return builder
         * 
         */
        ...
        public ARecordArgs build() {
            if ($.privateDnsZoneId == null) {
                throw new MissingRequiredPropertyException("ARecordArgs", "privateDnsZoneId");
            }
            if ($.records == null) {
                throw new MissingRequiredPropertyException("ARecordArgs", "records");
            }
            if ($.ttl == null) {
