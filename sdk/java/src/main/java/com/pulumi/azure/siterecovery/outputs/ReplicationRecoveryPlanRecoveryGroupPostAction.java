    ...
    public static final class Builder {
        ...
        public Builder failOverDirections(List<String> failOverDirections) {
            if (failOverDirections == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostAction", "failOverDirections");
            }
        ...
        public Builder failOverTypes(List<String> failOverTypes) {
            if (failOverTypes == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostAction", "failOverTypes");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostAction", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ReplicationRecoveryPlanRecoveryGroupPostAction", "type");
            }
            this.type = type;
            return this;
        }
        public ReplicationRecoveryPlanRecoveryGroupPostAction build() {
            final var _resultValue = new ReplicationRecoveryPlanRecoveryGroupPostAction();
