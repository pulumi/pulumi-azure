...
public final class EndpointDeliveryRuleRequestBodyCondition {
    ...
    public static final class Builder {
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("EndpointDeliveryRuleRequestBodyCondition", "operator");
            }
        ...
        public EndpointDeliveryRuleRequestBodyCondition build() {
            final var _resultValue = new EndpointDeliveryRuleRequestBodyCondition();
