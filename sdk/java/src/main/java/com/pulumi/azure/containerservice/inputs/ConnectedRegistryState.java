...
public final class ConnectedRegistryState extends com.pulumi.resources.ResourceArgs {

    public static final ConnectedRegistryState Empty = new ConnectedRegistryState();
     ...
     * 
     */
    @Import(name="syncTokenId")
    private @Nullable Output<String> syncTokenId;
     ...
     * 
     */
    public Optional<Output<String>> syncTokenId() {
        return Optional.ofNullable(this.syncTokenId);
    }
    ...
    private ConnectedRegistryState() {}

    private ConnectedRegistryState(ConnectedRegistryState $) {
    ...
    public static Builder builder(ConnectedRegistryState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectedRegistryState();
        }

        public Builder(ConnectedRegistryState defaults) {
            $ = new ConnectedRegistryState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder syncTokenId(@Nullable Output<String> syncTokenId) {
        ...
        public ConnectedRegistryState build() {
            return $;
        }
    }
