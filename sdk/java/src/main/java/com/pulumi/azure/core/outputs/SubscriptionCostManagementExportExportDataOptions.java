...
public final class SubscriptionCostManagementExportExportDataOptions {
    ...
    public static Builder builder(SubscriptionCostManagementExportExportDataOptions defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(SubscriptionCostManagementExportExportDataOptions defaults) {
        ...
        public Builder timeFrame(String timeFrame) {
            if (timeFrame == null) {
              throw new MissingRequiredPropertyException("SubscriptionCostManagementExportExportDataOptions", "timeFrame");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("SubscriptionCostManagementExportExportDataOptions", "type");
            }
            this.type = type;
            return this;
        }
