...
public final class SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs Empty = new SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs();
    ...
    private SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs() {}

    private SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs(SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs $) {
        this.offer = $.offer;
    ...
    public static Builder builder(SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs();
        }

        public Builder(SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs defaults) {
            $ = new SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs build() {
            if ($.offer == null) {
                throw new MissingRequiredPropertyException("SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs", "offer");
            }
            if ($.publisher == null) {
                throw new MissingRequiredPropertyException("SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs", "publisher");
            }
            if ($.sku == null) {
                throw new MissingRequiredPropertyException("SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs", "sku");
            }
            if ($.version == null) {
                throw new MissingRequiredPropertyException("SingleNodeVirtualInstanceSingleServerConfigurationVirtualMachineConfigurationImageArgs", "version");
            }
            return $;
        }
    }
