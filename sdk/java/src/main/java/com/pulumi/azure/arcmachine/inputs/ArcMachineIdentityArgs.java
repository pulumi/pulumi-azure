...
public final class ArcMachineIdentityArgs extends com.pulumi.resources.ResourceArgs {

    public static final ArcMachineIdentityArgs Empty = new ArcMachineIdentityArgs();
    ...
    private ArcMachineIdentityArgs(ArcMachineIdentityArgs $) {
    ...
    public static Builder builder(ArcMachineIdentityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ArcMachineIdentityArgs();
        }

        public Builder(ArcMachineIdentityArgs defaults) {
            $ = new ArcMachineIdentityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ArcMachineIdentityArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ArcMachineIdentityArgs", "type");
            }
            return $;
        }
    }
