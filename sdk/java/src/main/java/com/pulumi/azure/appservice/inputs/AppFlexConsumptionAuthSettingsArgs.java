...
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionAuthSettingsActiveDirectoryArgs;
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionAuthSettingsFacebookArgs;
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionAuthSettingsGithubArgs;
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionAuthSettingsGoogleArgs;
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionAuthSettingsMicrosoftArgs;
import com.pulumi.azure.appservice.inputs.AppFlexConsumptionAuthSettingsTwitterArgs;
...
public final class AppFlexConsumptionAuthSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFlexConsumptionAuthSettingsArgs Empty = new AppFlexConsumptionAuthSettingsArgs();
    ...
    private @Nullable Output<AppFlexConsumptionAuthSettingsActiveDirectoryArgs> activeDirectory;

    /**
     * @return An `active_directory` block as defined above.
     * 
     */
    public Optional<Output<AppFlexConsumptionAuthSettingsActiveDirectoryArgs>> activeDirectory() {
    ...
    private @Nullable Output<AppFlexConsumptionAuthSettingsFacebookArgs> facebook;

    /**
     * @return A `facebook` block as defined below.
     * 
     */
    public Optional<Output<AppFlexConsumptionAuthSettingsFacebookArgs>> facebook() {
     ...
     */
    @Import(name="github")
    private @Nullable Output<AppFlexConsumptionAuthSettingsGithubArgs> github;

    /**
     * @return A `github` block as defined below.
     * 
     */
    public Optional<Output<AppFlexConsumptionAuthSettingsGithubArgs>> github() {
     ...
     */
    @Import(name="google")
    private @Nullable Output<AppFlexConsumptionAuthSettingsGoogleArgs> google;

    /**
     * @return A `google` block as defined below.
     * 
     */
    public Optional<Output<AppFlexConsumptionAuthSettingsGoogleArgs>> google() {
    ...
    private @Nullable Output<AppFlexConsumptionAuthSettingsMicrosoftArgs> microsoft;

    /**
     * @return A `microsoft` block as defined below.
     * 
     */
    public Optional<Output<AppFlexConsumptionAuthSettingsMicrosoftArgs>> microsoft() {
     ...
     */
    @Import(name="twitter")
    private @Nullable Output<AppFlexConsumptionAuthSettingsTwitterArgs> twitter;

    /**
     * @return A `twitter` block as defined below.
     * 
     */
    public Optional<Output<AppFlexConsumptionAuthSettingsTwitterArgs>> twitter() {
    ...
    private AppFlexConsumptionAuthSettingsArgs() {}

    private AppFlexConsumptionAuthSettingsArgs(AppFlexConsumptionAuthSettingsArgs $) {
    ...
    public static Builder builder(AppFlexConsumptionAuthSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFlexConsumptionAuthSettingsArgs();
        }

        public Builder(AppFlexConsumptionAuthSettingsArgs defaults) {
            $ = new AppFlexConsumptionAuthSettingsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder activeDirectory(@Nullable Output<AppFlexConsumptionAuthSettingsActiveDirectoryArgs> activeDirectory) {
         ...
         * 
         */
        public Builder activeDirectory(AppFlexConsumptionAuthSettingsActiveDirectoryArgs activeDirectory) {
         ...
         * 
         */
        public Builder facebook(@Nullable Output<AppFlexConsumptionAuthSettingsFacebookArgs> facebook) {
            $.facebook = facebook;
            return this;
        }
         ...
         * 
         */
        public Builder facebook(AppFlexConsumptionAuthSettingsFacebookArgs facebook) {
         ...
         * 
         */
        public Builder github(@Nullable Output<AppFlexConsumptionAuthSettingsGithubArgs> github) {
            $.github = github;
            return this;
        }
         ...
         * 
         */
        public Builder github(AppFlexConsumptionAuthSettingsGithubArgs github) {
         ...
         * 
         */
        public Builder google(@Nullable Output<AppFlexConsumptionAuthSettingsGoogleArgs> google) {
            $.google = google;
            return this;
        }
         ...
         * 
         */
        public Builder google(AppFlexConsumptionAuthSettingsGoogleArgs google) {
         ...
         * 
         */
        public Builder microsoft(@Nullable Output<AppFlexConsumptionAuthSettingsMicrosoftArgs> microsoft) {
            $.microsoft = microsoft;
            return this;
        }
         ...
         * 
         */
        public Builder microsoft(AppFlexConsumptionAuthSettingsMicrosoftArgs microsoft) {
         ...
         * 
         */
        public Builder twitter(@Nullable Output<AppFlexConsumptionAuthSettingsTwitterArgs> twitter) {
            $.twitter = twitter;
            return this;
        }
         ...
         * 
         */
        public Builder twitter(AppFlexConsumptionAuthSettingsTwitterArgs twitter) {
        ...
        public AppFlexConsumptionAuthSettingsArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("AppFlexConsumptionAuthSettingsArgs", "enabled");
            }
            return $;
        }
    }
