...
public final class LinuxWebAppAuthSettingsV2GithubV2Args extends com.pulumi.resources.ResourceArgs {

    public static final LinuxWebAppAuthSettingsV2GithubV2Args Empty = new LinuxWebAppAuthSettingsV2GithubV2Args();
    ...
    private LinuxWebAppAuthSettingsV2GithubV2Args() {}

    private LinuxWebAppAuthSettingsV2GithubV2Args(LinuxWebAppAuthSettingsV2GithubV2Args $) {
    ...
    public static Builder builder(LinuxWebAppAuthSettingsV2GithubV2Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LinuxWebAppAuthSettingsV2GithubV2Args();
        }

        public Builder(LinuxWebAppAuthSettingsV2GithubV2Args defaults) {
            $ = new LinuxWebAppAuthSettingsV2GithubV2Args(Objects.requireNonNull(defaults));
        }
        ...
        public LinuxWebAppAuthSettingsV2GithubV2Args build() {
            if ($.clientId == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2GithubV2Args", "clientId");
            }
            if ($.clientSecretSettingName == null) {
                throw new MissingRequiredPropertyException("LinuxWebAppAuthSettingsV2GithubV2Args", "clientSecretSettingName");
            }
            return $;
        }
    }
