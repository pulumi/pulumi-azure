...
public final class GetVirtualMachineIdentity {
    ...
    public static final class Builder {
        ...
        public Builder identityIds(List<String> identityIds) {
            if (identityIds == null) {
              throw new MissingRequiredPropertyException("GetVirtualMachineIdentity", "identityIds");
            }
        ...
        public Builder principalId(String principalId) {
            if (principalId == null) {
              throw new MissingRequiredPropertyException("GetVirtualMachineIdentity", "principalId");
            }
        ...
        public Builder tenantId(String tenantId) {
            if (tenantId == null) {
              throw new MissingRequiredPropertyException("GetVirtualMachineIdentity", "tenantId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetVirtualMachineIdentity", "type");
            }
            this.type = type;
            return this;
        }
        public GetVirtualMachineIdentity build() {
            final var _resultValue = new GetVirtualMachineIdentity();
