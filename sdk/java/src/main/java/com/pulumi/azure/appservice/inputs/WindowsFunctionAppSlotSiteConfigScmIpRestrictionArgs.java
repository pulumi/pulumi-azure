...
public final class WindowsFunctionAppSlotSiteConfigScmIpRestrictionArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="headers")
    private @Nullable Output<WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers;

    /**
     * @return a `headers` block as detailed below.
     * 
     */
    public Optional<Output<WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs>> headers() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder headers(@Nullable Output<WindowsFunctionAppSlotSiteConfigScmIpRestrictionHeadersArgs> headers) {
            $.headers = headers;
            return this;
        }
