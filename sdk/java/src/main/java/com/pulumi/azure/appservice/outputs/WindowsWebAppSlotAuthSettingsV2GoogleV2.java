...
public final class WindowsWebAppSlotAuthSettingsV2GoogleV2 {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GoogleV2", "clientId");
            }
        ...
        public Builder clientSecretSettingName(String clientSecretSettingName) {
            if (clientSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsWebAppSlotAuthSettingsV2GoogleV2", "clientSecretSettingName");
            }
