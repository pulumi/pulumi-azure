...
@CustomType
public final class WindowsFunctionAppSlotAuthSettingsV2FacebookV2 {
    /**
    ...
    private WindowsFunctionAppSlotAuthSettingsV2FacebookV2() {}
    /**
     * @return The App ID of the Facebook app used for login.
     * 
     */
    ...
    public static Builder builder(WindowsFunctionAppSlotAuthSettingsV2FacebookV2 defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> loginScopes;
        public Builder() {}
        public Builder(WindowsFunctionAppSlotAuthSettingsV2FacebookV2 defaults) {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2FacebookV2", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder appSecretSettingName(String appSecretSettingName) {
            if (appSecretSettingName == null) {
              throw new MissingRequiredPropertyException("WindowsFunctionAppSlotAuthSettingsV2FacebookV2", "appSecretSettingName");
            }
        ...
        public WindowsFunctionAppSlotAuthSettingsV2FacebookV2 build() {
            final var _resultValue = new WindowsFunctionAppSlotAuthSettingsV2FacebookV2();
