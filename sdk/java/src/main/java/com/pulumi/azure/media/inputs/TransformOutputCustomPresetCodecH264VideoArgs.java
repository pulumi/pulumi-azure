...
import com.pulumi.azure.media.inputs.TransformOutputCustomPresetCodecH264VideoLayerArgs;
...
public final class TransformOutputCustomPresetCodecH264VideoArgs extends com.pulumi.resources.ResourceArgs {

    public static final TransformOutputCustomPresetCodecH264VideoArgs Empty = new TransformOutputCustomPresetCodecH264VideoArgs();
     ...
     */
    @Import(name="layers")
    private @Nullable Output<List<TransformOutputCustomPresetCodecH264VideoLayerArgs>> layers;

    /**
     * @return One or more `layer` blocks as defined below.
     * 
     */
    public Optional<Output<List<TransformOutputCustomPresetCodecH264VideoLayerArgs>>> layers() {
    ...
    private TransformOutputCustomPresetCodecH264VideoArgs() {}

    private TransformOutputCustomPresetCodecH264VideoArgs(TransformOutputCustomPresetCodecH264VideoArgs $) {
    ...
    public static Builder builder(TransformOutputCustomPresetCodecH264VideoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TransformOutputCustomPresetCodecH264VideoArgs();
        }

        public Builder(TransformOutputCustomPresetCodecH264VideoArgs defaults) {
            $ = new TransformOutputCustomPresetCodecH264VideoArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder layers(@Nullable Output<List<TransformOutputCustomPresetCodecH264VideoLayerArgs>> layers) {
            $.layers = layers;
            return this;
        }
         ...
         * 
         */
        public Builder layers(List<TransformOutputCustomPresetCodecH264VideoLayerArgs> layers) {
         ...
         * 
         */
        public Builder layers(TransformOutputCustomPresetCodecH264VideoLayerArgs... layers) {
            return layers(List.of(layers));
        }

        /**
         * @param rateControlMode The rate control mode. Possible values are `ABR`, `CBR` or `CRF`. Default to `ABR`.
         * 
         * @return builder
         * 
         */
        ...
        public TransformOutputCustomPresetCodecH264VideoArgs build() {
            return $;
        }
    }
