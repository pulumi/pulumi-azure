...
public final class GetPlacementGroupArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetPlacementGroupArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPlacementGroupArgs", "name");
            }
            if ($.resourceGroupName == null) {
                throw new MissingRequiredPropertyException("GetPlacementGroupArgs", "resourceGroupName");
            }
            return $;
        }
    }
