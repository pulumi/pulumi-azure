...
public final class FrontdoorRuleConditionsSslProtocolCondition {
    ...
    public static Builder builder(FrontdoorRuleConditionsSslProtocolCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operator;
        public Builder() {}
        public Builder(FrontdoorRuleConditionsSslProtocolCondition defaults) {
        ...
        public Builder matchValues(List<String> matchValues) {
            if (matchValues == null) {
              throw new MissingRequiredPropertyException("FrontdoorRuleConditionsSslProtocolCondition", "matchValues");
            }
