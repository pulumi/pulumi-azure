...
public final class InsightsArgs extends com.pulumi.resources.ResourceArgs {

    public static final InsightsArgs Empty = new InsightsArgs();
    ...
    private InsightsArgs() {}

    private InsightsArgs(InsightsArgs $) {
    ...
    public static Builder builder(InsightsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(InsightsArgs defaults) {
            $ = new InsightsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name Specifies the name of the Application Insights component. Changing this forces a
         * new resource to be created.
         * 
         * @return builder
         * 
