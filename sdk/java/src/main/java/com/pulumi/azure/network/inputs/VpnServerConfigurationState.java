...
public final class VpnServerConfigurationState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<String>> vpnAuthenticationTypes;
     ...
     * 
     */
    public Optional<Output<List<String>>> vpnAuthenticationTypes() {
    ...
    private VpnServerConfigurationState() {}

    private VpnServerConfigurationState(VpnServerConfigurationState $) {
    ...
    public static Builder builder(VpnServerConfigurationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpnServerConfigurationState();
        }

        public Builder(VpnServerConfigurationState defaults) {
         ...
         * 
         */
        public Builder vpnAuthenticationTypes(@Nullable Output<List<String>> vpnAuthenticationTypes) {
        ...
        public VpnServerConfigurationState build() {
            return $;
        }
    }
