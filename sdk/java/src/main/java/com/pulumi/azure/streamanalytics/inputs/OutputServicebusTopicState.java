...
public final class OutputServicebusTopicState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<OutputServicebusTopicSerializationArgs> serialization;

    /**
     * @return A `serialization` block as defined below.
     * 
     */
    public Optional<Output<OutputServicebusTopicSerializationArgs>> serialization() {
    ...
    public static Builder builder(OutputServicebusTopicState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OutputServicebusTopicState();
        }
         ...
         * 
         */
        public Builder serialization(@Nullable Output<OutputServicebusTopicSerializationArgs> serialization) {
        ...
        public OutputServicebusTopicState build() {
            return $;
        }
    }
