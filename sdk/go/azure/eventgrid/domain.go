...
func NewDomain(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:eventgrid/domain:Domain", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetDomain(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:eventgrid/domain:Domain", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Domain{s: s}, nil
