...
func NewEventGridTopic(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:eventgrid/eventGridTopic:EventGridTopic", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetEventGridTopic(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:eventgrid/eventGridTopic:EventGridTopic", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &EventGridTopic{s: s}, nil
