// nolint: lll
// Package azure offers support for all Microsoft Azure services and their properties.
...
// > anything, please consult the source [`terraform-providers/terraform-provider-azure` repo](https://github.com/terraform-providers/terraform-provider-azure/issues).
package azure
