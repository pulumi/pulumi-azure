...
func (o LookupGroupTemplateDeploymentResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupGroupTemplateDeploymentResult] {
	return pulumix.Output[LookupGroupTemplateDeploymentResult]{
