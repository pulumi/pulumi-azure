...
//
// > **Note:** This is not applicable for filter types such as `Jailbreak`, `Indirect Attack`, `Protected Material Text`, and `Protected Material Code`.
func (o AccountRaiPolicyContentFilterOutput) SeverityThreshold() pulumi.StringPtrOutput {
	return o.ApplyT(func(v AccountRaiPolicyContentFilter) *string { return v.SeverityThreshold }).(pulumi.StringPtrOutput)
}
