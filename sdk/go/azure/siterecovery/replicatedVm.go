...
func NewReplicatedVM(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:siterecovery/replicatedVM:ReplicatedVM", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetReplicatedVM(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:siterecovery/replicatedVM:ReplicatedVM", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ReplicatedVM{s: s}, nil
