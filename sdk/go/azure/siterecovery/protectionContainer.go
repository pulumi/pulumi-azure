...
func NewProtectionContainer(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:siterecovery/protectionContainer:ProtectionContainer", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetProtectionContainer(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:siterecovery/protectionContainer:ProtectionContainer", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ProtectionContainer{s: s}, nil
