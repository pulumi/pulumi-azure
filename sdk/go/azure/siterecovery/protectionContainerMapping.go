...
func NewProtectionContainerMapping(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:siterecovery/protectionContainerMapping:ProtectionContainerMapping", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetProtectionContainerMapping(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:siterecovery/protectionContainerMapping:ProtectionContainerMapping", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ProtectionContainerMapping{s: s}, nil
