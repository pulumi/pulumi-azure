...
func NewReplicationPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:siterecovery/replicationPolicy:ReplicationPolicy", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetReplicationPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:siterecovery/replicationPolicy:ReplicationPolicy", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ReplicationPolicy{s: s}, nil
