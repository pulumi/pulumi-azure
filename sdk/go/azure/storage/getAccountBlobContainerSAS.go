...
func LookupAccountBlobContainerSAS(ctx *pulumi.Context, args *GetAccountBlobContainerSASArgs, opts ...pulumi.InvokeOption) (*GetAccountBlobContainerSASResult, error) {
...
type GetAccountBlobContainerSASArgs struct {
	...
	Permissions GetAccountBlobContainerSASPermissionsArgs `pulumi:"permissions"`
...
type GetAccountBlobContainerSASResult struct {
	...
	HttpsOnly *bool `pulumi:"httpsOnly"`
	IpAddress *string `pulumi:"ipAddress"`
	Permissions GetAccountBlobContainerSASPermissionsResult `pulumi:"permissions"`
...
type GetAccountBlobContainerSASPermissionsResult struct {
	Add bool `pulumi:"add"`
	Create bool `pulumi:"create"`
	Delete bool `pulumi:"delete"`
	List bool `pulumi:"list"`
