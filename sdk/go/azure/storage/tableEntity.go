...
func NewTableEntity(ctx *pulumi.Context,
	...
	if args != nil {
		if i := args.Entity; i != nil { inputs["entity"] = i.ToStringMapOutput() }
		if i := args.PartitionKey; i != nil { inputs["partitionKey"] = i.ToStringOutput() }
		if i := args.RowKey; i != nil { inputs["rowKey"] = i.ToStringOutput() }
	...
	err := ctx.RegisterResource("azure:storage/tableEntity:TableEntity", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTableEntity(ctx *pulumi.Context,
	...
	inputs := map[string]pulumi.Input{}
	if state != nil {
		if i := state.Entity; i != nil { inputs["entity"] = i.ToStringMapOutput() }
		if i := state.PartitionKey; i != nil { inputs["partitionKey"] = i.ToStringOutput() }
		if i := state.RowKey; i != nil { inputs["rowKey"] = i.ToStringOutput() }
	...
	var resource TableEntity
	err := ctx.ReadResource("azure:storage/tableEntity:TableEntity", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type TableEntityState struct {
	// A map of key/value pairs that describe the entity to be inserted/merged in to the storage table.
	Entity pulumi.StringMapInput `pulumi:"entity"`
	// The key for the partition where the entity will be inserted/merged. Changing this forces a new resource.
