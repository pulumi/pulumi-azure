...
//				Scope:              pulumi.String(pulumi.String(example.Id)),
...
//				TargetSubscriptionId: pulumi.String(pulumi.String(example.Id)),
//				VersionId:            pulumi.String(pulumi.String(exampleGetPublishedVersion.Id)),
//				Location:             exampleResourceGroup.Location,
