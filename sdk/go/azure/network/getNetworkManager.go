...
func LookupNetworkManagerOutput(ctx *pulumi.Context, args LookupNetworkManagerOutputArgs, opts ...pulumi.InvokeOption) LookupNetworkManagerResultOutput {
	...
	return ctx.InvokeOutput("azure:network/getNetworkManager:getNetworkManager", args, LookupNetworkManagerResultOutput{}, options).(LookupNetworkManagerResultOutput)
}
