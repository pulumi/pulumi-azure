...
func LookupVirtualNetworkGatewayConnection(ctx *pulumi.Context, args *GetVirtualNetworkGatewayConnectionArgs) (*GetVirtualNetworkGatewayConnectionResult, error) {
	inputs := make(map[string]interface{})
	if args != nil {
		inputs["name"] = args.Name
		inputs["resourceGroupName"] = args.ResourceGroupName
	}
	outputs, err := ctx.Invoke("azure:network/getVirtualNetworkGatewayConnection:getVirtualNetworkGatewayConnection", inputs)
	if err != nil {
		return nil, err
	}
...
type GetVirtualNetworkGatewayConnectionArgs struct {
...
type GetVirtualNetworkGatewayConnectionResult struct {
