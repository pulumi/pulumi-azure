...
func (o LookupVirtualHubConnectionResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupVirtualHubConnectionResult] {
	return pulumix.Output[LookupVirtualHubConnectionResult]{
