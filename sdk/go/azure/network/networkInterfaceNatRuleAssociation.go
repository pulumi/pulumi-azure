...
func NewNetworkInterfaceNatRuleAssociation(ctx *pulumi.Context,
	...
	if args != nil {
		...
		if i := args.NatRuleId; i != nil { inputs["natRuleId"] = i.ToStringOutput() }
	...
	err := ctx.RegisterResource("azure:network/networkInterfaceNatRuleAssociation:NetworkInterfaceNatRuleAssociation", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkInterfaceNatRuleAssociation(ctx *pulumi.Context,
	...
	if state != nil {
		...
		if i := state.NatRuleId; i != nil { inputs["natRuleId"] = i.ToStringOutput() }
		if i := state.NetworkInterfaceId; i != nil { inputs["networkInterfaceId"] = i.ToStringOutput() }
	}
	var resource NetworkInterfaceNatRuleAssociation
	err := ctx.ReadResource("azure:network/networkInterfaceNatRuleAssociation:NetworkInterfaceNatRuleAssociation", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type NetworkInterfaceNatRuleAssociationState struct {
	...
	// The ID of the Load Balancer NAT Rule which this Network Interface which should be connected to. Changing this forces a new resource to be created.
	NatRuleId pulumi.StringInput `pulumi:"natRuleId"`
	// The ID of the Network Interface. Changing this forces a new resource to be created.
