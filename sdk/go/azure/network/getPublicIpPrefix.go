...
func LookupPublicIpPrefixOutput(ctx *pulumi.Context, args LookupPublicIpPrefixOutputArgs, opts ...pulumi.InvokeOption) LookupPublicIpPrefixResultOutput {
	...
	return ctx.InvokeOutput("azure:network/getPublicIpPrefix:getPublicIpPrefix", args, LookupPublicIpPrefixResultOutput{}, options).(LookupPublicIpPrefixResultOutput)
}
