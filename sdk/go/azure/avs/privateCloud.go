...
func NewPrivateCloud(ctx *pulumi.Context,
	...
	if args.NsxtPassword != nil {
		args.NsxtPassword = pulumi.ToSecret(args.NsxtPassword).(pulumi.StringPtrOutput)
	}
	if args.VcenterPassword != nil {
		args.VcenterPassword = pulumi.ToSecret(args.VcenterPassword).(pulumi.StringPtrOutput)
	}
