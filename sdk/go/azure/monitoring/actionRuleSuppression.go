...
func (o ActionRuleSuppressionOutput) Condition() ActionRuleSuppressionConditionPtrOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) ActionRuleSuppressionConditionPtrOutput { return v.Condition }).(ActionRuleSuppressionConditionPtrOutput)
}

// Specifies a description for the Action Rule.
func (o ActionRuleSuppressionOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) pulumi.StringPtrOutput { return v.Description }).(pulumi.StringPtrOutput)
}

// Is the Action Rule enabled? Defaults to `true`.
func (o ActionRuleSuppressionOutput) Enabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) pulumi.BoolPtrOutput { return v.Enabled }).(pulumi.BoolPtrOutput)
}

// Specifies the name of the Monitor Action Rule. Changing this forces a new resource to be created.
func (o ActionRuleSuppressionOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// Specifies the name of the resource group in which the Monitor Action Rule should exist. Changing this forces a new resource to be created.
func (o ActionRuleSuppressionOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) pulumi.StringOutput { return v.ResourceGroupName }).(pulumi.StringOutput)
}

// A `scope` block as defined below.
func (o ActionRuleSuppressionOutput) Scope() ActionRuleSuppressionScopePtrOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) ActionRuleSuppressionScopePtrOutput { return v.Scope }).(ActionRuleSuppressionScopePtrOutput)
}

// A `suppression` block as defined below.
func (o ActionRuleSuppressionOutput) Suppression() ActionRuleSuppressionSuppressionOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) ActionRuleSuppressionSuppressionOutput { return v.Suppression }).(ActionRuleSuppressionSuppressionOutput)
}

// A mapping of tags to assign to the resource.
func (o ActionRuleSuppressionOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ActionRuleSuppression) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}
