...
// return err
// }
// _, err = sql/database.NewDatabase(ctx, "example", &sql/database.DatabaseArgs{
...
func (o DatabaseOutput) ElasticPoolName() pulumi.StringOutput {
	return o.ApplyT(func(v *Database) pulumi.StringOutput { return v.ElasticPoolName }).(pulumi.StringOutput)
}
...
func (o DatabaseOutput) ReadScale() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Database) pulumi.BoolPtrOutput { return v.ReadScale }).(pulumi.BoolPtrOutput)
}

// A GUID/UUID corresponding to a configured Service Level Objective for the Azure SQL database which can be used to configure a performance level.
// .
func (o DatabaseOutput) RequestedServiceObjectiveId() pulumi.StringOutput {
	return o.ApplyT(func(v *Database) pulumi.StringOutput { return v.RequestedServiceObjectiveId }).(pulumi.StringOutput)
}
...
func (o DatabaseOutput) SourceDatabaseDeletionDate() pulumi.StringOutput {
	return o.ApplyT(func(v *Database) pulumi.StringOutput { return v.SourceDatabaseDeletionDate }).(pulumi.StringOutput)
}

// The URI of the source database if `createMode` value is not `Default`.
func (o DatabaseOutput) SourceDatabaseId() pulumi.StringOutput {
	return o.ApplyT(func(v *Database) pulumi.StringOutput { return v.SourceDatabaseId }).(pulumi.StringOutput)
}
