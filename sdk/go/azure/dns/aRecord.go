...
func NewARecord(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:dns/aRecord:ARecord", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetARecord(ctx *pulumi.Context,
	...
	var resource ARecord
	err := ctx.ReadResource("azure:dns/aRecord:ARecord", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
