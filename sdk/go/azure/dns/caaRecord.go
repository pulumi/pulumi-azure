...
func NewCaaRecord(ctx *pulumi.Context,
	name string, args *CaaRecordArgs, opts ...pulumi.ResourceOpt) (*CaaRecord, error) {
...
func GetCaaRecord(ctx *pulumi.Context,
	name string, id pulumi.ID, state *CaaRecordState, opts ...pulumi.ResourceOpt) (*CaaRecord, error) {
	inputs := make(map[string]interface{})
	if state != nil {
...
func (r *CaaRecord) Fqdn() pulumi.StringOutput {
