...
func NewManagementGroup(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:managementresource/managementGroup:ManagementGroup", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetManagementGroup(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:managementresource/managementGroup:ManagementGroup", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ManagementGroup{s: s}, nil
