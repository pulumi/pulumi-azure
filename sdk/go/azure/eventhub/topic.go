...
func NewTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.RegisterResource("azure:eventhub/topic:Topic", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTopic(ctx *pulumi.Context,
	...
	var resource Topic
	err := ctx.ReadResource("azure:eventhub/topic:Topic", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
