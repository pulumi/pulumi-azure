...
func NewAuthorizationRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:eventhub/authorizationRule:AuthorizationRule", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAuthorizationRule(ctx *pulumi.Context,
	...
	var resource AuthorizationRule
	err := ctx.ReadResource("azure:eventhub/authorizationRule:AuthorizationRule", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
