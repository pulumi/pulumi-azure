...
func NewSubscriptionRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:eventhub/subscriptionRule:SubscriptionRule", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscriptionRule(ctx *pulumi.Context,
	...
	var resource SubscriptionRule
	err := ctx.ReadResource("azure:eventhub/subscriptionRule:SubscriptionRule", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
