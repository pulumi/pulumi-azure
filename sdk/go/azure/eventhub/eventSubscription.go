...
func NewEventSubscription(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:eventhub/eventSubscription:EventSubscription", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetEventSubscription(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:eventhub/eventSubscription:EventSubscription", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &EventSubscription{s: s}, nil
