...
func NewServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:mssql/serverSecurityAlertPolicy:ServerSecurityAlertPolicy", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetServerSecurityAlertPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:mssql/serverSecurityAlertPolicy:ServerSecurityAlertPolicy", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ServerSecurityAlertPolicy{s: s}, nil
