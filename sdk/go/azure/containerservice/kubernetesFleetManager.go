...
// return err
// }
// _, err = containerservice/kubernetesFleetManager.NewKubernetesFleetManager(ctx, "example", &containerservice/kubernetesFleetManager.KubernetesFleetManagerArgs{
