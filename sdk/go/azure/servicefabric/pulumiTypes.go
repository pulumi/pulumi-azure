...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*MeshApplicationServiceCodePackageArrayInput)(nil)).Elem(), MeshApplicationServiceCodePackageArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*MeshApplicationServiceCodePackageResourcesInput)(nil)).Elem(), MeshApplicationServiceCodePackageResourcesArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MeshApplicationServiceCodePackageResourcesLimitsInput)(nil)).Elem(), MeshApplicationServiceCodePackageResourcesLimitsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MeshApplicationServiceCodePackageResourcesLimitsPtrInput)(nil)).Elem(), MeshApplicationServiceCodePackageResourcesLimitsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*MeshApplicationServiceCodePackageResourcesRequestsInput)(nil)).Elem(), MeshApplicationServiceCodePackageResourcesRequestsArgs{})
