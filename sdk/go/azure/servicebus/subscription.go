...
func NewSubscription(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:servicebus/subscription:Subscription", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubscription(ctx *pulumi.Context,
	...
	var resource Subscription
	err := ctx.ReadResource("azure:servicebus/subscription:Subscription", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
