...
func NewSubscription(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:servicebus/subscription:Subscription", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetSubscription(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:servicebus/subscription:Subscription", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Subscription{s: s}, nil
