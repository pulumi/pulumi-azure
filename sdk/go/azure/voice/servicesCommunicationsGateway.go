...
//	voice/servicesCommunicationsGateway "github.com/pulumi/pulumi-azure/sdk/v1/go/azure/voice/servicesCommunicationsGateway"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
// func main() {
...
// return err
// }
// _, err = voice/servicesCommunicationsGateway.NewServicesCommunicationsGateway(ctx, "example", &voice/servicesCommunicationsGateway.ServicesCommunicationsGatewayArgs{
// Name: "example-vcg",
// Location: "West Europe",
...
// ApiBridge: %!v(PANIC=Format method: fatal: An assertion has failed: unlowered function toJSON),
