...
func LookupBuiltinRoleDefinition(ctx *pulumi.Context, args *GetBuiltinRoleDefinitionArgs, opts ...pulumi.InvokeOption) (*GetBuiltinRoleDefinitionResult, error) {
	var rv GetBuiltinRoleDefinitionResult
	err := ctx.Invoke("azure:role/getBuiltinRoleDefinition:getBuiltinRoleDefinition", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetBuiltinRoleDefinitionResult struct {
	...
	Permissions []GetBuiltinRoleDefinitionPermissionsResult `pulumi:"permissions"`
	// the Type of the Role.
	Type string `pulumi:"type"`
	// id is the provider-assigned unique ID for this managed resource.
	Id string `pulumi:"id"`
}
type GetBuiltinRoleDefinitionPermissionsResult struct {
