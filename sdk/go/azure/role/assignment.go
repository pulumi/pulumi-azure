...
func NewAssignment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:role/assignment:Assignment", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAssignment(ctx *pulumi.Context,
	...
	var resource Assignment
	err := ctx.ReadResource("azure:role/assignment:Assignment", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
