...
func NewAccount(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:azureMaps/account:Account", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetAccount(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:azureMaps/account:Account", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Account{s: s}, nil
