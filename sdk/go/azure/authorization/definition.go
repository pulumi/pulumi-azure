...
func NewDefinition(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:authorization/definition:Definition", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetDefinition(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:authorization/definition:Definition", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Definition{s: s}, nil
