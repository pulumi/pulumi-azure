...
func NewUserAssignedIdentity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:authorization/userAssignedIdentity:UserAssignedIdentity", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUserAssignedIdentity(ctx *pulumi.Context,
	...
	var resource UserAssignedIdentity
	err := ctx.ReadResource("azure:authorization/userAssignedIdentity:UserAssignedIdentity", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
