...
//	"github.com/pulumi/pulumi-azure/sdk/v7/go/azure/lighthouse"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func (o DefinitionOutput) LighthouseDefinitionId() pulumi.StringOutput {
	return o.ApplyT(func(v *Definition) pulumi.StringOutput { return v.LighthouseDefinitionId }).(pulumi.StringOutput)
}

// The ID of the managing tenant. Changing this forces a new resource to be created.
func (o DefinitionOutput) ManagingTenantId() pulumi.StringOutput {
	return o.ApplyT(func(v *Definition) pulumi.StringOutput { return v.ManagingTenantId }).(pulumi.StringOutput)
}
...
func (o DefinitionOutput) Plan() DefinitionPlanPtrOutput {
	return o.ApplyT(func(v *Definition) DefinitionPlanPtrOutput { return v.Plan }).(DefinitionPlanPtrOutput)
}
