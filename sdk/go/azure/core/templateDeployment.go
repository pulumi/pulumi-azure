...
func (o TemplateDeploymentOutput) Outputs() pulumi.StringMapOutput {
	return o.ApplyT(func(v *TemplateDeployment) pulumi.StringMapOutput { return v.Outputs }).(pulumi.StringMapOutput)
}

// Specifies the name and value pairs that define the deployment parameters for the template.
func (o TemplateDeploymentOutput) Parameters() pulumi.StringMapOutput {
	return o.ApplyT(func(v *TemplateDeployment) pulumi.StringMapOutput { return v.Parameters }).(pulumi.StringMapOutput)
}
...
func (o TemplateDeploymentOutput) TemplateBody() pulumi.StringOutput {
	return o.ApplyT(func(v *TemplateDeployment) pulumi.StringOutput { return v.TemplateBody }).(pulumi.StringOutput)
}
