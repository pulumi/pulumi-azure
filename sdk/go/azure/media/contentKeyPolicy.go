...
// return err
// }
// _, err = media/contentKeyPolicy.NewContentKeyPolicy(ctx, "example", &media/contentKeyPolicy.ContentKeyPolicyArgs{
// Name: "example",
// ResourceGroupName: example.Name,
// MediaServicesAccountName: exampleServiceAccount.Name,
// PolicyOptions: tmpJSON0, err := json.Marshal(map[string]interface{}{
...
// map[string]interface{}{
// "name": "playReady",
// "playreadyConfigurationLicenses": []map[string]interface{}{
// map[string]interface{}{
// "allowTestDevices": true,
// "beginDate": "2017-10-16T18:22:53Z",
// "securityLevel": "SL150",
// "playRight": map[string]interface{}{
// "scmsRestriction": 2,
...
// "explicitAnalogTelevisionOutputRestriction": map[string]interface{}{
...
// map[string]interface{}{
// "name": "widevine",
// "widevineConfigurationTemplate": json0,
// "openRestrictionEnabled": true,
// },
// },
// })
...
func (o ContentKeyPolicyOutput) MediaServicesAccountName() pulumi.StringOutput {
	return o.ApplyT(func(v *ContentKeyPolicy) pulumi.StringOutput { return v.MediaServicesAccountName }).(pulumi.StringOutput)
}
...
func (o ContentKeyPolicyOutput) PolicyOptions() ContentKeyPolicyPolicyOptionArrayOutput {
	return o.ApplyT(func(v *ContentKeyPolicy) ContentKeyPolicyPolicyOptionArrayOutput { return v.PolicyOptions }).(ContentKeyPolicyPolicyOptionArrayOutput)
}

// The name of the Resource Group where the Content Key Policy should exist. Changing this forces a new Content Key Policy to be created.
func (o ContentKeyPolicyOutput) ResourceGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v *ContentKeyPolicy) pulumi.StringOutput { return v.ResourceGroupName }).(pulumi.StringOutput)
}
