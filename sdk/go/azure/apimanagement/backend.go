...
// import (
//
//	apimanagement/backend "github.com/pulumi/pulumi-azure/sdk/v1/go/azure/apimanagement/backend"
...
// return err
// }
// _, err = apimanagement/backend.NewBackend(ctx, "example", &apimanagement/backend.BackendArgs{
