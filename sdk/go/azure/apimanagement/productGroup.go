...
//				ProductId:         pulumi.String(pulumi.String(exampleGetProduct.ProductId)),
//				GroupName:         pulumi.String(pulumi.String(exampleGetGroup.Name)),
//				ApiManagementName: pulumi.String(pulumi.String(example.Name)),
