...
func LookupApiVersionSet(ctx *pulumi.Context, args *LookupApiVersionSetArgs, opts ...pulumi.InvokeOption) (*LookupApiVersionSetResult, error) {
	...
	if optsErr != nil {
		return &LookupApiVersionSetResult{}, optsErr
	}
	if len(invokeOpts.DependsOn) > 0 {
		return &LookupApiVersionSetResult{}, errors.New("DependsOn is not supported for direct form invoke LookupApiVersionSet, use LookupApiVersionSetOutput instead")
	}
	if len(invokeOpts.DependsOnInputs) > 0 {
		return &LookupApiVersionSetResult{}, errors.New("DependsOnInputs is not supported for direct form invoke LookupApiVersionSet, use LookupApiVersionSetOutput instead")
	}
