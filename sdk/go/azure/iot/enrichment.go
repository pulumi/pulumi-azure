...
//	iot/enrichment "github.com/pulumi/pulumi-azure/sdk/v1/go/azure/iot/enrichment"
//	iot/ioTHub "github.com/pulumi/pulumi-azure/sdk/v1/go/azure/iot/ioTHub"
//	iot/route "github.com/pulumi/pulumi-azure/sdk/v1/go/azure/iot/route"
...
// return err
// }
// exampleEndpointStorageContainer, err := iot/endpointStorageContainer.NewEndpointStorageContainer(ctx, "example", &iot/endpointStorageContainer.EndpointStorageContainerArgs{
// ResourceGroupName: example.Name,
...
// return err
// }
// _, err = iot/route.NewRoute(ctx, "example", &iot/route.RouteArgs{
// ResourceGroupName: example.Name,
...
// return err
// }
// _, err = iot/enrichment.NewEnrichment(ctx, "example", &iot/enrichment.EnrichmentArgs{
// ResourceGroupName: example.Name,
// IothubName: exampleIoTHub.Name,
// Key: "example",
// Value: "my value",
