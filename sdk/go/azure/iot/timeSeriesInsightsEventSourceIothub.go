...
func (i *TimeSeriesInsightsEventSourceIothub) ToOutput(ctx context.Context) pulumix.Output[*TimeSeriesInsightsEventSourceIothub] {
	return pulumix.Output[*TimeSeriesInsightsEventSourceIothub]{
		OutputState: i.ToTimeSeriesInsightsEventSourceIothubOutputWithContext(ctx).OutputState,
	}
}
...
func (i TimeSeriesInsightsEventSourceIothubArray) ToOutput(ctx context.Context) pulumix.Output[[]*TimeSeriesInsightsEventSourceIothub] {
	return pulumix.Output[[]*TimeSeriesInsightsEventSourceIothub]{
		OutputState: i.ToTimeSeriesInsightsEventSourceIothubArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i TimeSeriesInsightsEventSourceIothubMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*TimeSeriesInsightsEventSourceIothub] {
	return pulumix.Output[map[string]*TimeSeriesInsightsEventSourceIothub]{
		OutputState: i.ToTimeSeriesInsightsEventSourceIothubMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o TimeSeriesInsightsEventSourceIothubOutput) ToOutput(ctx context.Context) pulumix.Output[*TimeSeriesInsightsEventSourceIothub] {
	return pulumix.Output[*TimeSeriesInsightsEventSourceIothub]{
...
// Specifies the name of the IotHub Consumer Group that holds the partitions from which events will be read.
func (o TimeSeriesInsightsEventSourceIothubOutput) ConsumerGroupName() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.ConsumerGroupName }).(pulumi.StringOutput)
}

// Specifies the id of the IoT Time Series Insights Environment that the Event Source should be associated with. Changing this forces a new resource to created.
func (o TimeSeriesInsightsEventSourceIothubOutput) EnvironmentId() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.EnvironmentId }).(pulumi.StringOutput)
}

// Specifies the resource id where events will be coming from.
func (o TimeSeriesInsightsEventSourceIothubOutput) EventSourceResourceId() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.EventSourceResourceId }).(pulumi.StringOutput)
}

// Specifies the name of the IotHub which will be associated with this resource.
func (o TimeSeriesInsightsEventSourceIothubOutput) IothubName() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.IothubName }).(pulumi.StringOutput)
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (o TimeSeriesInsightsEventSourceIothubOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}

// Specifies the name of the Azure IoT Time Series Insights IoTHub Event Source. Changing this forces a new resource to be created. Must be globally unique.
func (o TimeSeriesInsightsEventSourceIothubOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// Specifies the value of the Shared Access Policy key that grants the Time Series Insights service read access to the IotHub.
func (o TimeSeriesInsightsEventSourceIothubOutput) SharedAccessKey() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.SharedAccessKey }).(pulumi.StringOutput)
}

// Specifies the name of the Shared Access key that grants the Event Source access to the IotHub.
func (o TimeSeriesInsightsEventSourceIothubOutput) SharedAccessKeyName() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.SharedAccessKeyName }).(pulumi.StringOutput)
}

// A mapping of tags to assign to the resource.
func (o TimeSeriesInsightsEventSourceIothubOutput) Tags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringMapOutput { return v.Tags }).(pulumi.StringMapOutput)
}

// Specifies the value that will be used as the event source's timestamp. This value defaults to the event creation time.
func (o TimeSeriesInsightsEventSourceIothubOutput) TimestampPropertyName() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsEventSourceIothub) pulumi.StringOutput { return v.TimestampPropertyName }).(pulumi.StringOutput)
}
...
func (o TimeSeriesInsightsEventSourceIothubArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*TimeSeriesInsightsEventSourceIothub] {
	return pulumix.Output[[]*TimeSeriesInsightsEventSourceIothub]{
		OutputState: o.OutputState,
	}
}
...
func (o TimeSeriesInsightsEventSourceIothubMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*TimeSeriesInsightsEventSourceIothub] {
	return pulumix.Output[map[string]*TimeSeriesInsightsEventSourceIothub]{
		OutputState: o.OutputState,
	}
}
