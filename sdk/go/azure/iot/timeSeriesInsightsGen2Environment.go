...
// The FQDN used to access the environment data.
func (o TimeSeriesInsightsGen2EnvironmentOutput) DataAccessFqdn() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsGen2Environment) pulumi.StringOutput { return v.DataAccessFqdn }).(pulumi.StringOutput)
}

// A list of property ids for the Azure IoT Time Series Insights Gen2 Environment. Changing this forces a new resource to be created.
func (o TimeSeriesInsightsGen2EnvironmentOutput) IdProperties() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsGen2Environment) pulumi.StringArrayOutput { return v.IdProperties }).(pulumi.StringArrayOutput)
}

// Specifies the supported Azure location where the resource exists. Changing this forces a new resource to be created.
func (o TimeSeriesInsightsGen2EnvironmentOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsGen2Environment) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}

// Specifies the name of the Azure IoT Time Series Insights Gen2 Environment. Changing this forces a new resource to be created. Must be globally unique.
func (o TimeSeriesInsightsGen2EnvironmentOutput) Name() pulumi.StringOutput {
...
// A `storage` block as defined below.
func (o TimeSeriesInsightsGen2EnvironmentOutput) Storage() TimeSeriesInsightsGen2EnvironmentStorageOutput {
	return o.ApplyT(func(v *TimeSeriesInsightsGen2Environment) TimeSeriesInsightsGen2EnvironmentStorageOutput {
		return v.Storage
	}).(TimeSeriesInsightsGen2EnvironmentStorageOutput)
}

// A mapping of tags to assign to the resource.
func (o TimeSeriesInsightsGen2EnvironmentOutput) Tags() pulumi.StringMapOutput {
