...
func NewProtectionContainerMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:recoveryservices/protectionContainerMapping:ProtectionContainerMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectionContainerMapping(ctx *pulumi.Context,
	...
	var resource ProtectionContainerMapping
	err := ctx.ReadResource("azure:recoveryservices/protectionContainerMapping:ProtectionContainerMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
