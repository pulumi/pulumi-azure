...
func NewNetworkMapping(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:recoveryservices/networkMapping:NetworkMapping", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkMapping(ctx *pulumi.Context,
	...
	var resource NetworkMapping
	err := ctx.ReadResource("azure:recoveryservices/networkMapping:NetworkMapping", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
