...
func NewProtectedVM(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:recoveryservices/protectedVM:ProtectedVM", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProtectedVM(ctx *pulumi.Context,
	...
	var resource ProtectedVM
	err := ctx.ReadResource("azure:recoveryservices/protectedVM:ProtectedVM", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
