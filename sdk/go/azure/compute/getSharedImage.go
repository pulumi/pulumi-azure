...
func LookupSharedImage(ctx *pulumi.Context, args *GetSharedImageArgs, opts ...pulumi.InvokeOption) (*GetSharedImageResult, error) {
	var rv GetSharedImageResult
...
type GetSharedImageResult struct {
	...
	Identifiers []GetSharedImageIdentifiersResult `pulumi:"identifiers"`
...
type GetSharedImageIdentifiersResult struct {
