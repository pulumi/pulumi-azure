...
//	"github.com/pulumi/pulumi-azure/sdk/v7/go/azure/desktopvirtualization"
...
//					exampleResourceGroup.ID().ToIDOutput().ToStringOutput(),
//				},
//			})
//			if err != nil {
//				return err
...
//				PrincipalId:                  pulumi.Any(example.Id),
