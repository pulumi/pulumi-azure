...
func LookupFlexibleServerOutput(ctx *pulumi.Context, args LookupFlexibleServerOutputArgs, opts ...pulumi.InvokeOption) LookupFlexibleServerResultOutput {
	...
	return ctx.InvokeOutput("azure:mysql/getFlexibleServer:getFlexibleServer", args, LookupFlexibleServerResultOutput{}, options).(LookupFlexibleServerResultOutput)
}
