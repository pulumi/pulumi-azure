...
// return err
// }
// _, err = mysql/server.NewServer(ctx, "example", &mysql/server.ServerArgs{
...
func (o ServerOutput) GeoRedundantBackupEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *Server) pulumi.BoolOutput { return v.GeoRedundantBackupEnabled }).(pulumi.BoolOutput)
}
