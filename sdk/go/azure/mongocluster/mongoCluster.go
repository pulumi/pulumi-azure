...
func NewMongoCluster(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:mongocluster/mongoCluster:MongoCluster", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetMongoCluster(ctx *pulumi.Context,
	...
	var resource MongoCluster
	err := ctx.ReadResource("azure:mongocluster/mongoCluster:MongoCluster", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The storage type for the MongoDB Cluster. Possible values are `PremiumSSD` and `PremiumSSDv2`. Defaults to `PremiumSSD`. Changing this forces a new resource to be created.
func (o MongoClusterOutput) StorageType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *MongoCluster) pulumi.StringPtrOutput { return v.StorageType }).(pulumi.StringPtrOutput)
}
