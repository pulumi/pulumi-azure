...
func NewConfiguration(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:mariadb/configuration:Configuration", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetConfiguration(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:mariadb/configuration:Configuration", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &Configuration{s: s}, nil
