...
func NewVirtualNetworkRule(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:mariadb/virtualNetworkRule:VirtualNetworkRule", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetVirtualNetworkRule(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:mariadb/virtualNetworkRule:VirtualNetworkRule", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &VirtualNetworkRule{s: s}, nil
