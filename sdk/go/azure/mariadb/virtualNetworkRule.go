...
func NewVirtualNetworkRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:mariadb/virtualNetworkRule:VirtualNetworkRule", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVirtualNetworkRule(ctx *pulumi.Context,
	...
	var resource VirtualNetworkRule
	err := ctx.ReadResource("azure:mariadb/virtualNetworkRule:VirtualNetworkRule", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
