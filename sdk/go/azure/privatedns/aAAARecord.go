...
func NewAAAARecord(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("azure:privatedns/aAAARecord:AAAARecord", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAAAARecord(ctx *pulumi.Context,
	...
	var resource AAAARecord
	err := ctx.ReadResource("azure:privatedns/aAAARecord:AAAARecord", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
