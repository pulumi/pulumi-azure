...
//
// > **Note:** To target a Virtual Machine Scale Set, set `frontendPortStart`, `frontendPortEnd` and `backendAddressPoolId` to create an Inbound NAT rule v2. The legacy `lb.NatPool` resource maps to Inbound NAT rule v1, which Azure has scheduled for retirement on September 30, 2027.
//
...
// Is TCP Reset enabled for this Load Balancer Rule?
func (o NatRuleOutput) TcpResetEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *NatRule) pulumi.BoolPtrOutput { return v.TcpResetEnabled }).(pulumi.BoolPtrOutput)
}
