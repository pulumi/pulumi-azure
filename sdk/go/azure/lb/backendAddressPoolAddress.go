...
//				BackendAddressPoolId: pulumi.String(pulumi.String(exampleGetBackendAddressPool.Id)),
//				VirtualNetworkId:     pulumi.String(pulumi.String(example.Id)),
...
//				BackendAddressPoolId:            pulumi.String(pulumi.String(backend_pool_cr.Id)),
