...
//				return err
//			}
//			frontdoor, err := azuread.ServicePrincipal(ctx, map[string]string{
...
//						TenantId: pulumi.String(current.TenantId),
//						ObjectId: pulumi.Any(frontdoor.ObjectId),
...
//							KeyVaultCertificateId: exampleCertificate.ID().ToIDOutput().ToStringOutput(),
//						},
//					},
//				},
//			})
