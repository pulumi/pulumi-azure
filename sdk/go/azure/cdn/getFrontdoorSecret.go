...
func LookupFrontdoorSecret(ctx *pulumi.Context, args *LookupFrontdoorSecretArgs, opts ...pulumi.InvokeOption) (*LookupFrontdoorSecretResult, error) {
	...
	if optsErr != nil {
		return &LookupFrontdoorSecretResult{}, optsErr
	}
	if len(invokeOpts.DependsOn) > 0 {
		return &LookupFrontdoorSecretResult{}, errors.New("DependsOn is not supported for direct form invoke LookupFrontdoorSecret, use LookupFrontdoorSecretOutput instead")
	}
	if len(invokeOpts.DependsOnInputs) > 0 {
		return &LookupFrontdoorSecretResult{}, errors.New("DependsOnInputs is not supported for direct form invoke LookupFrontdoorSecret, use LookupFrontdoorSecretOutput instead")
	}
