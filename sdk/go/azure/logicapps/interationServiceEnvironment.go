...
// The type of access endpoint to use for the Integration Service Environment. Possible Values are `Internal` and `External`. Changing this forces a new Integration Service Environment to be created.
func (o InterationServiceEnvironmentOutput) AccessEndpointType() pulumi.StringOutput {
	return o.ApplyT(func(v *InterationServiceEnvironment) pulumi.StringOutput { return v.AccessEndpointType }).(pulumi.StringOutput)
}

// The list of access endpoint IP addresses of connector.
func (o InterationServiceEnvironmentOutput) ConnectorEndpointIpAddresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InterationServiceEnvironment) pulumi.StringArrayOutput { return v.ConnectorEndpointIpAddresses }).(pulumi.StringArrayOutput)
}

// The list of outgoing IP addresses of connector.
func (o InterationServiceEnvironmentOutput) ConnectorOutboundIpAddresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InterationServiceEnvironment) pulumi.StringArrayOutput { return v.ConnectorOutboundIpAddresses }).(pulumi.StringArrayOutput)
}

// The Azure Region where the Integration Service Environment should exist. Changing this forces a new Integration Service Environment to be created.
func (o InterationServiceEnvironmentOutput) Location() pulumi.StringOutput {
	return o.ApplyT(func(v *InterationServiceEnvironment) pulumi.StringOutput { return v.Location }).(pulumi.StringOutput)
}

// The name of the Integration Service Environment. Changing this forces a new Integration Service Environment to be created.
func (o InterationServiceEnvironmentOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v *InterationServiceEnvironment) pulumi.StringOutput { return v.Name }).(pulumi.StringOutput)
}

// The name of the Resource Group where the Integration Service Environment should exist. Changing this forces a new Integration Service Environment to be created.
func (o InterationServiceEnvironmentOutput) ResourceGroupName() pulumi.StringOutput {
...
// A mapping of tags which should be assigned to the Integration Service Environment.
func (o InterationServiceEnvironmentOutput) Tags() pulumi.StringMapOutput {
...
// The list of access endpoint IP addresses of workflow.
func (o InterationServiceEnvironmentOutput) WorkflowEndpointIpAddresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InterationServiceEnvironment) pulumi.StringArrayOutput { return v.WorkflowEndpointIpAddresses }).(pulumi.StringArrayOutput)
}

// The list of outgoing IP addresses of workflow.
func (o InterationServiceEnvironmentOutput) WorkflowOutboundIpAddresses() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *InterationServiceEnvironment) pulumi.StringArrayOutput { return v.WorkflowOutboundIpAddresses }).(pulumi.StringArrayOutput)
}
