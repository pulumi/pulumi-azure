...
func NewProtectedVM(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("azure:backup/protectedVM:ProtectedVM", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetProtectedVM(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("azure:backup/protectedVM:ProtectedVM", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ProtectedVM{s: s}, nil
