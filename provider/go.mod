...
require (
	...
	github.com/hashicorp/go-azure-helpers v0.28.0 // indirect
...
replace (
	...
	github.com/hashicorp/terraform-provider-azurerm => github.com/pulumi/terraform-provider-azurerm v1.41.1-0.20220419115246-0aed2864989a
