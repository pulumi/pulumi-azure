...
replace (
	github.com/hashicorp/terraform-exec => github.com/hashicorp/terraform-exec v0.23.2-0.20250903143921-c05687bce503
...
require (
	...
	github.com/hashicorp/go-azure-sdk/resource-manager v0.20250924.1155608 // indirect
