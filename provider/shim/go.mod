...
replace github.com/hashicorp/terraform-provider-azurerm => github.com/pulumi/terraform-provider-azurerm v1.41.1-0.20221107202514-ccb4aeb44eaf
...
require (
	...
	github.com/hashicorp/go-azure-helpers v0.45.0 // indirect
