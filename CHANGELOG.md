...
- Add retries on host key retrieval for Function Apps
...
- Several modules have been renamed to better align with their terraform equivalents. The existing modules are still
  ...
  azure.role._ -> azure.authorization._
  azure.msi._ -> azure.authorization._
  azure.managementgroups._ -> azure.management._
  azure.managementresource._ -> azure.management._
