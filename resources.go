...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			// Traffic Manager
			"azurerm_traffic_manager_endpoint": {Tok: azureResource(azureNetwork, "TrafficManagerEndpoint")},
			"azurerm_traffic_manager_profile":  {Tok: azureResource(azureNetwork, "TrafficeManagerProfile")},
